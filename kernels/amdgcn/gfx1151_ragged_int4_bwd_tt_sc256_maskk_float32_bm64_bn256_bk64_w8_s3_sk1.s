...
; %bb.4:                                ; %.preheader.lr.ph
	...
	s_mov_b32 s48, s30
	s_lshr_b32 s53, s19, 7
	s_sub_i32 s54, s3, 32
	s_lshl_b32 s55, s34, 7
...
.LBB0_5:                                ; %._crit_edge
	...
	v_dual_mul_f32 v39, v183, v33 :: v_dual_add_nc_u32 v66, 0x80, v66
	v_dual_mul_f32 v38, v184, v33 :: v_dual_add_nc_u32 v67, 0x80, v67
	v_dual_mul_f32 v41, v181, v33 :: v_dual_add_nc_u32 v144, s55, v144
	v_dual_mul_f32 v54, v167, v34 :: v_dual_add_nc_u32 v145, 0x80, v145
	v_dual_mul_f32 v43, v179, v33 :: v_dual_add_nc_u32 v152, 0x80, v152
	v_dual_mul_f32 v45, v177, v33 :: v_dual_add_nc_u32 v146, 0x80, v146
...
.LBB0_8:                                ; %.lr.ph
	...
	v_cmp_gt_i32_e32 vcc_lo, 0x80, v154
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 204
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 56
