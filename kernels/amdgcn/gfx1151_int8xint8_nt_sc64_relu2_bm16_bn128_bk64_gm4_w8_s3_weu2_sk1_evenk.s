	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp17:
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v37, v7, v6, s3
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_add_i32 s21, s22, s2
.Ltmp19:
	...
	s_clause 0x1
	buffer_load_b128 v[13:16], v8, s[16:19], 0 offen
	buffer_load_b128 v[17:20], v6, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v30, v2, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v38, v8, v10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v39, v5, v6
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_lshl_or_b32 v28, v1, 6, v13
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshl_or_b32 v33, v2, 5, v28
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_3:                                ; %Flow19
	...
	v_or_b32_e32 v15, s20, v1
	s_ashr_i32 s31, s21, 6
	v_or_b32_e32 v26, s28, v4
	v_or_b32_e32 v25, s28, v8
	v_or_b32_e32 v24, s28, v10
	v_mul_lo_u32 v27, v15, s31
	v_or_b32_e32 v22, s28, v11
	v_or_b32_e32 v20, s28, v12
	v_or_b32_e32 v23, s28, v5
	v_or_b32_e32 v21, s28, v6
	v_or_b32_e32 v19, s28, v7
	s_and_not1_b32 vcc_lo, exec_lo, s10
	s_cbranch_vccnz .LBB0_6
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v3, 48, v3
	s_mov_b32 s23, 0x31027000
	s_mov_b32 s22, 0x7ffffffe
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_max_i32 s36, s31, 3
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v28, v1, 6, v3
	...
	v_xor_b32_e32 v29, 32, v28
	v_xor_b32_e32 v30, 48, v28
	v_dual_mov_b32 v2, v1 :: v_dual_mov_b32 v13, 0
	v_xor_b32_e32 v35, 16, v33
	v_xor_b32_e32 v32, 32, v33
	v_xor_b32_e32 v34, 48, v33
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s40, s39, s29
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v40, v27, s39, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cmp_lt_i32 s39, s31
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v41, v26, s40, 1
	v_add_lshl_u32 v42, v25, s40, 1
	v_add_lshl_u32 v43, v24, s40, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v44, v22, s40, 1
	v_add_lshl_u32 v45, v20, s40, 1
	v_add_lshl_u32 v46, v23, s40, 1
	v_add_lshl_u32 v47, v21, s40, 1
	v_add_lshl_u32 v48, v19, s40, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v89, v40, s[20:23], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v40, s41, v9
	v_add_nc_u32_e32 v41, s41, v36
	...
	s_mov_b32 s10, s33
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v40, s39, v28
	v_add_nc_u32_e32 v41, s39, v31
	s_mov_b32 s33, s15
	v_add_nc_u32_e32 v42, s39, v29
	v_add_nc_u32_e32 v43, s39, v30
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v44, s33, v33
	v_add_nc_u32_e32 v45, s33, v35
	v_add_nc_u32_e32 v46, s33, v32
	v_add_nc_u32_e32 v47, s33, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v17, v62, v45 :: v_dual_add_nc_u32 v98, s40, v38
	v_dual_fmac_f32 v12, v58, v41 :: v_dual_add_nc_u32 v99, s34, v39
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v10, v57, v40 :: v_dual_fmac_f32 v13, v59, v42
	v_fmac_f32_e32 v16, v61, v44
	v_dual_fmac_f32 v18, v63, v46 :: v_dual_fmac_f32 v11, v56, v47
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.8:
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v2, s15, v35
	v_add_nc_u32_e32 v6, s15, v33
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v37, s10, v31
	v_add_nc_u32_e32 v38, s10, v28
	v_add_nc_u32_e32 v40, s10, v30
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
...
.LBB0_9:
	...
	v_add_lshl_u32 v39, v25, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v37, 0x80000000, v37, vcc_lo
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v40, v24, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_and_b32 s9, s9, 0xffff
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v42, v23, s4, 1
	v_add_lshl_u32 v41, v20, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v44, v37, s[8:11], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	v_add_lshl_u32 v40, v22, s4, 1
	v_add_lshl_u32 v43, v21, s4, 1
	v_add_lshl_u32 v45, v19, s4, 1
	...
	buffer_load_u16 v48, v40, s[12:15], 0 offen
	buffer_load_u16 v49, v41, s[12:15], 0 offen
	buffer_load_u16 v50, v42, s[12:15], 0 offen
	buffer_load_u16 v51, v43, s[12:15], 0 offen
...
; %bb.10:
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v31, v28 :: v_dual_add_nc_u32 v30, s33, v30
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[65:68], v34
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[28:35], v[53:56], v[61:64], v[28:35] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[28:35], v[37:40], v[57:60], v[28:35] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[28:35], v[69:72], v[77:80], v[28:35] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[28:35], v[65:68], v[73:76], v[28:35] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_11:
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_mov_b32 v45, 0x5410 :: v_dual_mul_f32 v30, v28, v30
	v_dual_mov_b32 v46, 0x7632 :: v_dual_mul_f32 v29, v28, v29
	v_mov_b16_e32 v47.h, v28.l
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v6, v32, v6, v16
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v14, 16, v22
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v2, v35, v2, v12
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v11, v12, v37, v2
	v_fma_f32 v12, v13, v38, v3
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v13, v14, v39, v5
	v_fma_f32 v14, v16, v40, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v3, v3, v3 :: v_dual_mul_f32 v18, v10, v18
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v16, v17, v41, v7
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v10, v10, v19 :: v_dual_max_f32 v1, 0, v1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v4, v5, v13, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v17, v18, v42, v8
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v4, v4, v4 :: v_dual_and_b32 v11, 1, v47
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b32_e32 v10, 0x1054, v45, vcc_lo
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 100
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
