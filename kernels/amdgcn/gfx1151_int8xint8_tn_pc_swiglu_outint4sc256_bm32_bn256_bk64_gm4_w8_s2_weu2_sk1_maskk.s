...
.Ltmp0:
	...
	v_lshrrev_b32_e32 v134, 2, v0
	v_or_b32_e32 v137, 0x3f0, v0
	v_or_b32_e32 v138, 0x7f0, v0
	v_and_b32_e32 v139, 8, v0
	v_lshrrev_b32_e32 v135, 2, v255
...
.Ltmp13:
	...
	v_mul_lo_u32 v2, s30, v134
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_mad_u64_u32 v[106:107], null, s23, v135, v[105:106]
	v_mad_u64_u32 v[107:108], null, s31, 6, v[106:107]
	v_lshl_add_u32 v136, s31, 2, v106
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v108, v2, v1, s34
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v4, s2, v106
	v_add_nc_u32_e32 v1, s2, v136
	v_add_nc_u32_e32 v2, s2, v107
	...
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v15, s2, v107
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e64 s2, s22, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[6:9], v1, s[16:19], 0 offen
	buffer_load_b128 v[10:13], v2, s[16:19], 0 offen
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[1:2], null, s30, s8, v[108:109]
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	v_cndmask_b32_e32 v18, 0x80000000, v15, vcc_lo
	s_clause 0x1
	buffer_load_b128 v[14:17], v2, s[16:19], 0 offen
	...
	buffer_load_b128 v[26:29], v3, s[16:19], 0 offen
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v3, s31, v4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	buffer_load_b128 v[34:37], v4, s[16:19], 0 offen
	...
	v_add_nc_u32_e32 v143, 0, v38
	v_add_nc_u32_e32 v144, 0, v39
	v_add_nc_u32_e32 v145, 0, v40
	v_add_nc_u32_e32 v146, 0, v41
	v_add_nc_u32_e32 v147, 0, v42
	v_add_nc_u32_e32 v148, 0, v3
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v3, 0x4000, v142
	v_add_nc_u32_e32 v38, 0x4000, v143
	v_add_nc_u32_e32 v39, 0x4000, v144
	v_add_nc_u32_e32 v40, 0x4000, v145
	v_add_nc_u32_e32 v41, 0x4000, v146
	v_add_nc_u32_e32 v42, 0x4000, v147
	v_add_nc_u32_e32 v43, 0x4000, v148
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	v_perm_b32 v44, v10, v6, 0x4000501
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(4)
	ds_store_b64 v141, v[1:2] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v1, v26, v22, 0x4000501
	v_perm_b32 v2, v26, v22, 0x6020703
	...
	v_perm_b32 v26, v29, v25, 0x4000501
	v_perm_b32 v25, v29, v25, 0x6020703
	v_perm_b32 v27, v44, v1, 0x7060302
	v_perm_b32 v1, v44, v1, 0x5040100
	v_perm_b32 v28, v6, v2, 0x7060302
	v_perm_b32 v2, v6, v2, 0x5040100
	v_perm_b32 v6, v10, v21, 0x7060302
	...
	v_perm_b32 v23, v8, v24, 0x7060302
	v_perm_b32 v8, v8, v24, 0x5040100
	v_perm_b32 v24, v12, v26, 0x7060302
	v_perm_b32 v12, v12, v26, 0x5040100
	v_perm_b32 v26, v9, v25, 0x7060302
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v142, v27, v1 offset1:16
	ds_store_2addr_b32 v143, v28, v2 offset1:16
	ds_store_2addr_b32 v144, v6, v10 offset1:16
	ds_store_2addr_b32 v145, v21, v7 offset1:16
	ds_store_2addr_b32 v146, v22, v11 offset1:16
	ds_store_2addr_b32 v142, v23, v8 offset0:160 offset1:176
	ds_store_2addr_b32 v147, v24, v12 offset1:16
	ds_store_2addr_b32 v148, v26, v9 offset1:16
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v1, v13, v25, 0x7060302
	v_perm_b32 v2, v13, v25, 0x5040100
	v_perm_b32 v6, v14, v29, 0x7060302
	v_perm_b32 v7, v14, v29, 0x5040100
	v_perm_b32 v8, v18, v30, 0x7060302
	v_perm_b32 v9, v18, v30, 0x5040100
	v_perm_b32 v10, v15, v31, 0x7060302
	v_perm_b32 v11, v15, v31, 0x5040100
	v_perm_b32 v12, v19, v34, 0x7060302
	v_perm_b32 v13, v19, v34, 0x5040100
	v_perm_b32 v14, v16, v32, 0x7060302
	v_perm_b32 v15, v16, v32, 0x5040100
	v_perm_b32 v16, v20, v35, 0x7060302
	v_perm_b32 v18, v20, v35, 0x5040100
...
.Ltmp14:
	...
	v_and_b32_e32 v133, 0x1800, v5
	v_bfe_i32 v4, v0, 5, 1
	v_add_nc_u32_e32 v150, 0, v137
	v_xor_b32_e32 v1, v1, v2
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v149, s23, v106
	v_dual_mov_b32 v122, 0 :: v_dual_add_nc_u32 v151, 0, v138
	v_and_b32_e32 v2, 0x420, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_or3_b32 v1, v3, v1, v133
	v_add_nc_u32_e32 v152, 0x4000, v142
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v157, 0x4000, v143
	v_dual_mov_b32 v119, 0 :: v_dual_add_nc_u32 v158, 0x4000, v144
	...
	v_dual_mov_b32 v7, s10 :: v_dual_add_nc_u32 v154, 0, v10
	v_dual_mov_b32 v8, s11 :: v_dual_add_nc_u32 v153, 0, v9
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v155, 0, v11
	v_mov_b32_e32 v118, 0
	v_dual_mov_b32 v121, 0 :: v_dual_add_nc_u32 v156, 0, v12
	v_dual_mov_b32 v124, 0 :: v_dual_add_nc_u32 v159, 0x4000, v145
	v_dual_mov_b32 v117, 0 :: v_dual_add_nc_u32 v160, 0x4000, v146
	v_dual_mov_b32 v126, 0 :: v_dual_add_nc_u32 v161, 0x4000, v147
	v_dual_mov_b32 v125, 0 :: v_dual_add_nc_u32 v162, 0x4000, v148
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v11, s2, v134
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[9:10], null, s2, s30, v[108:109]
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	ds_load_b128 v[21:24], v154
	ds_load_b128 v[163:166], v153 offset:8192
	ds_load_b128 v[167:170], v154 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[179:182], v153 offset:16384
	ds_load_b128 v[183:186], v154 offset:16384
	ds_load_b128 v[187:190], v153 offset:24576
	ds_load_b128 v[191:194], v154 offset:24576
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	ds_load_u8 v10, v132 offset:33216
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v10, v11, 0xc0c0004
	ds_load_u8 v11, v132 offset:33056
	ds_load_u8 v12, v132 offset:33024
	...
	v_wmma_i32_16x16x16_iu8 v[171:178], v[187:190], v[89:92], v[1:8] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[171:178], v[191:194], v[93:96], v[171:178] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[33:40], v[163:166], v[97:100], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	ds_load_u8 v10, v150 offset:32768
	...
	v_wmma_i32_16x16x16_iu8 v[33:40], v[167:170], v[101:104], v[33:40] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[9:16], v[21:24], v[101:104], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[17:24], v[163:166], v[89:92], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[17:24], v[167:170], v[93:96], v[17:24] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[163:170], v[179:182], v[89:92], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[163:170], v[183:186], v[93:96], v[163:170] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[89:96], v[179:182], v[97:100], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[89:96], v[183:186], v[101:104], v[89:96] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[179:186], v[187:190], v[97:100], v[1:8] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v97, v132 offset:34208
	ds_load_u8 v98, v132 offset:34176
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[187:190], v155
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[179:186], v[191:194], v[101:104], v[179:186] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[191:194], v155 offset:24576
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu8 v[25:32], v[187:190], v[97:100], v[25:32] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[171:178], v[191:194], v[97:100], v[171:178] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[9:16], v[187:190], v[101:104], v[9:16] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[187:190], v155 offset:8192
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[179:186], v[191:194], v[101:104], v[179:186] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[191:194], v156 offset:24576
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[17:24], v[187:190], v[97:100], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[33:40], v[187:190], v[101:104], v[33:40] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[187:190], v155 offset:16384
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[163:170], v[187:190], v[97:100], v[163:170] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v97, v132 offset:34720
	ds_load_u8 v98, v132 offset:34688
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[89:96], v[187:190], v[101:104], v[89:96] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[187:190], v156
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v97, v98, v97, 0xc0c0004
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_cvt_f32_i32_e32 v113, v173
	v_cvt_f32_i32_e32 v114, v174
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v75, v75, v27 :: v_dual_add_f32 v76, v76, v28
	v_add_f32_e32 v72, v72, v32
	v_add_f32_e32 v74, v74, v26
	v_dual_add_f32 v70, v70, v30 :: v_dual_add_f32 v73, v73, v25
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v104, v111, v104, 0xc0c0004
	ds_load_u8 v111, v151 offset:32768
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_cvt_f32_i32_e32 v111, v171
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[9:16], v[187:190], v[101:104], v[9:16] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[187:190], v156 offset:8192
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[179:186], v[191:194], v[101:104], v[179:186] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v65, v65, v171 :: v_dual_add_f32 v66, v66, v172
	...
	v_wmma_i32_16x16x16_iu8 v[33:40], v[187:190], v[101:104], v[33:40] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[187:190], v156 offset:16384
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v9, s2, v106
	v_add_nc_u32_e32 v10, s2, v149
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_cvt_f32_i32_e32 v103, v169
	v_cvt_f32_i32_e32 v104, v170
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_cvt_f32_i32_e32 v99, v165
	v_cvt_f32_i32_e32 v100, v166
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_add_f32_e32 v79, v79, v20
	v_dual_add_f32 v77, v77, v18 :: v_dual_add_f32 v86, v86, v35
	v_dual_add_f32 v125, v125, v22 :: v_dual_add_f32 v130, v130, v39
	v_dual_add_f32 v127, v127, v24 :: v_dual_add_f32 v50, v50, v98
	v_dual_add_f32 v83, v83, v169 :: v_dual_add_f32 v52, v52, v100
	v_dual_add_f32 v81, v81, v167 :: v_dual_add_f32 v48, v48, v104
	v_dual_add_f32 v67, v67, v173 :: v_dual_add_f32 v46, v46, v102
	v_dual_add_f32 v88, v88, v37 :: v_dual_add_f32 v87, v87, v36
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v56, v56, v163 :: v_dual_add_f32 v85, v85, v34
	v_dual_add_f32 v122, v122, v164 :: v_dual_add_f32 v129, v129, v38
	v_add_f32_e32 v60, v60, v92
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v131, v131, v40 :: v_dual_add_f32 v120, v120, v166
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v51, v51, v99 :: v_dual_add_f32 v58, v58, v90
	v_dual_add_f32 v49, v49, v97 :: v_dual_add_f32 v44, v44, v96
	v_dual_add_f32 v47, v47, v103 :: v_dual_add_f32 v42, v42, v94
	v_dual_add_f32 v45, v45, v101 :: v_dual_add_f32 v64, v64, v179
	v_dual_add_f32 v115, v115, v111 :: v_dual_add_f32 v62, v62, v177
	v_dual_add_f32 v55, v55, v114 :: v_dual_add_f32 v118, v118, v180
	v_dual_add_f32 v53, v53, v112 :: v_dual_add_f32 v116, v116, v182
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v183, v13, v9, 0x4000501
	v_perm_b32 v184, v13, v9, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v9, s2, v136
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v185, v14, v10, 0x4000501
	v_perm_b32 v186, v14, v10, 0x6020703
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v10, s2, v107
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v187, v15, v11, 0x4000501
	v_cndmask_b32_e32 v9, 0x80000000, v9, vcc_lo
	v_perm_b32 v188, v15, v11, 0x6020703
	v_perm_b32 v189, v16, v12, 0x4000501
	v_cndmask_b32_e32 v13, 0x80000000, v10, vcc_lo
	v_perm_b32 v190, v16, v12, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[9:12], v9, s[16:19], 0 offen
	buffer_load_b128 v[13:16], v13, s[16:19], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v191, v13, v9, 0x4000501
	v_perm_b32 v192, v13, v9, 0x6020703
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v9, s2, v106
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v193, v14, v10, 0x4000501
	v_perm_b32 v194, v14, v10, 0x6020703
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v10, s2, v149
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v195, v15, v11, 0x4000501
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e32 v9, 0x80000000, v9, vcc_lo
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v196, v15, v11, 0x6020703
	v_perm_b32 v197, v16, v12, 0x4000501
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e32 v13, 0x80000000, v10, vcc_lo
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v198, v16, v12, 0x6020703
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_clause 0x1
	buffer_load_b128 v[9:12], v9, s[16:19], 0 offen
	buffer_load_b128 v[13:16], v13, s[16:19], 0 offen
	s_waitcnt vmcnt(0)
	v_perm_b32 v199, v13, v9, 0x4000501
	v_perm_b32 v200, v13, v9, 0x6020703
	.loc	1 414 39 is_stmt 0              ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v9, s2, v136
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v201, v14, v10, 0x4000501
	v_perm_b32 v202, v14, v10, 0x6020703
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v10, s2, v107
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v203, v15, v11, 0x4000501
	v_cndmask_b32_e32 v9, 0x80000000, v9, vcc_lo
	v_perm_b32 v204, v15, v11, 0x6020703
	v_perm_b32 v205, v16, v12, 0x4000501
	v_cndmask_b32_e32 v13, 0x80000000, v10, vcc_lo
	v_perm_b32 v206, v16, v12, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[9:12], v9, s[16:19], 0 offen
	buffer_load_b128 v[13:16], v13, s[16:19], 0 offen
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b64 v141, v[109:110] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v109, v191, v183, 0x5040100
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v207, v13, v9, 0x4000501
	v_perm_b32 v9, v13, v9, 0x6020703
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v16, v191, v183, 0x7060302
	ds_store_2addr_b32 v142, v16, v109 offset1:16
	v_perm_b32 v16, v192, v184, 0x7060302
	v_perm_b32 v109, v192, v184, 0x5040100
	ds_store_2addr_b32 v143, v16, v109 offset1:16
	v_perm_b32 v16, v193, v185, 0x7060302
	v_perm_b32 v109, v193, v185, 0x5040100
	ds_store_2addr_b32 v144, v16, v109 offset1:16
	v_perm_b32 v16, v194, v186, 0x7060302
	v_perm_b32 v109, v194, v186, 0x5040100
	ds_store_2addr_b32 v145, v16, v109 offset1:16
	v_perm_b32 v16, v195, v187, 0x7060302
	v_perm_b32 v109, v195, v187, 0x5040100
	ds_store_2addr_b32 v146, v16, v109 offset1:16
	v_perm_b32 v16, v196, v188, 0x7060302
	v_perm_b32 v109, v196, v188, 0x5040100
	ds_store_2addr_b32 v142, v16, v109 offset0:160 offset1:176
	v_perm_b32 v16, v197, v189, 0x7060302
	v_perm_b32 v109, v197, v189, 0x5040100
	ds_store_2addr_b32 v147, v16, v109 offset1:16
	v_perm_b32 v16, v198, v190, 0x7060302
	v_perm_b32 v109, v198, v190, 0x5040100
	ds_store_2addr_b32 v148, v16, v109 offset1:16
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v16, v207, v199, 0x7060302
	v_perm_b32 v109, v207, v199, 0x5040100
	ds_store_2addr_b32 v152, v16, v109 offset1:16
	v_perm_b32 v16, v9, v200, 0x7060302
	v_perm_b32 v9, v9, v200, 0x5040100
	ds_store_2addr_b32 v157, v16, v9 offset1:16
	v_perm_b32 v9, v13, v201, 0x7060302
	v_perm_b32 v13, v13, v201, 0x5040100
	ds_store_2addr_b32 v158, v9, v13 offset1:16
	v_perm_b32 v9, v10, v202, 0x7060302
	v_perm_b32 v10, v10, v202, 0x5040100
	ds_store_2addr_b32 v159, v9, v10 offset1:16
	v_perm_b32 v9, v14, v203, 0x7060302
	v_perm_b32 v10, v14, v203, 0x5040100
	ds_store_2addr_b32 v160, v9, v10 offset1:16
	v_perm_b32 v9, v11, v204, 0x7060302
	v_perm_b32 v10, v11, v204, 0x5040100
	v_perm_b32 v11, v12, v206, 0x7060302
	v_perm_b32 v12, v12, v206, 0x5040100
	ds_store_2addr_b32 v152, v9, v10 offset0:160 offset1:176
	v_perm_b32 v9, v15, v205, 0x7060302
	v_perm_b32 v10, v15, v205, 0x5040100
	ds_store_2addr_b32 v161, v9, v10 offset1:16
	ds_store_2addr_b32 v162, v11, v12 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v3, v137 :: v_dual_mov_b32 v90, v139
	v_dual_mov_b32 v1, v138 :: v_dual_mov_b32 v2, v140
	s_branch .LBB0_8
.LBB0_7:
	v_mov_b32_e32 v41, 0
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_maskk.private_seg_size, 0
