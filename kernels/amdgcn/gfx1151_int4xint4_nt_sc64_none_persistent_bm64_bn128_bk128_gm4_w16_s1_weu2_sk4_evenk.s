	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph4
	...
	v_and_b32_e32 v18, 24, v33
	v_lshlrev_b32_e32 v20, 4, v34
	v_lshlrev_b32_e32 v17, 5, v26
	v_and_b32_e32 v21, 24, v16
	v_lshrrev_b32_e32 v19, 1, v0
	v_xor_b32_e32 v28, v2, v18
	v_and_b32_e32 v18, 0x78, v2
	v_and_or_b32 v27, 0x218, v16, v17
	v_or3_b32 v29, v20, v21, v17
...
.Ltmp20:
	...
	v_xor_b32_e32 v47, 8, v29
	v_xor_b32_e32 v48, 16, v29
	v_xor_b32_e32 v49, 24, v29
	v_xor_b32_e32 v6, 8, v35
	v_xor_b32_e32 v51, 16, v35
	v_xor_b32_e32 v52, 24, v35
	v_xor_b32_e32 v0, 32, v35
	v_xor_b32_e32 v5, 40, v35
	v_xor_b32_e32 v55, 48, v35
	v_xor_b32_e32 v56, 56, v35
	v_xor_b32_e32 v57, 0x2010, v36
	v_xor_b32_e32 v58, 0x4020, v36
	v_xor_b32_e32 v59, 0x6030, v36
	v_mad_u64_u32 v[22:23], null, s29, v9, v[1:2]
	s_cvt_u32_f32 s0, s0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_or_b32_e32 v37, v15, v26
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	...
	v_and_or_b32 v25, v2, 28, s3
	v_and_or_b32 v26, v4, 24, s3
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_nc_u32_e32 v62, s52, v27
	.loc	1 259 31                        ; generate_amdgcn.py:259:31
	v_cmp_gt_i32_e64 s1, s35, v29
	v_cmp_gt_i32_e64 s3, s35, v61
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	v_add_nc_u32_e32 v63, s52, v28
	s_mov_b32 s6, s22
	s_mov_b32 s7, s23
	...
	.loc	1 265 30                        ; generate_amdgcn.py:265:30
	buffer_load_b32 v29, v29, s[20:23], 0 offen
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	buffer_load_b64 v[61:62], v61, s[4:7], 0 offen
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_add_nc_u32_e32 v63, v38, v30
	s_mov_b32 s26, s22
	s_mov_b32 s27, s23
	.loc	1 265 30                        ; generate_amdgcn.py:265:30
	s_waitcnt lgkmcnt(0)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[77:80], v41 offset1:2
	ds_load_2addr_stride64_b64 v[81:84], v42 offset1:2
	ds_load_2addr_stride64_b64 v[85:88], v43 offset1:2
	ds_load_2addr_stride64_b64 v[89:92], v44 offset1:2
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v45, v[61:62]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 272 22                        ; generate_amdgcn.py:272:22
	s_clause 0x1
	buffer_load_u16 v29, v60, s[8:11], 0 offen
	buffer_load_u16 v101, v31, s[8:11], 0 offen
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	buffer_load_u16 v102, v63, s[24:27], 0 offen
	buffer_load_u16 v103, v63, s[24:27], 0 offen offset:4
	buffer_load_u16 v104, v63, s[24:27], 0 offen offset:8
	buffer_load_u16 v105, v63, s[24:27], 0 offen offset:12
	buffer_load_u16 v106, v63, s[24:27], 0 offen offset:16
	buffer_load_u16 v107, v63, s[24:27], 0 offen offset:20
	buffer_load_u16 v108, v63, s[24:27], 0 offen offset:24
	buffer_load_u16 v109, v63, s[24:27], 0 offen offset:28
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	ds_load_b64 v[93:94], v46
	ds_load_b64 v[95:96], v47
	ds_load_b64 v[97:98], v48
	ds_load_b64 v[99:100], v49
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v69, v69, v29 :: v_dual_lshlrev_b32 v80, 16, v104
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	v_wmma_i32_16x16x16_iu4 v[61:68], v[95:96], v[83:84], v[61:68] neg_lo:[1,1,0]
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v84, 16, v108
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v14, v69, v78 :: v_dual_add_nc_u32 v31, 2, v31
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v72, v72, v29 :: v_dual_lshlrev_b32 v79, 16, v103
	.loc	1 272 22                        ; generate_amdgcn.py:272:22
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v75, v75, v29 :: v_dual_fmac_f32 v12, v70, v79
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v71, v71, v29 :: v_dual_fmac_f32 v4, v74, v83
	...
	v_dual_fmac_f32 v10, v71, v80 :: v_dual_lshlrev_b32 v81, 16, v105
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v73, v73, v29 :: v_dual_fmac_f32 v2, v75, v84
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v85, 16, v109
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v29, v76, v29
	v_dual_mul_f32 v62, v62, v77 :: v_dual_fmac_f32 v15, v61, v78
	...
	v_mul_f32_e32 v68, v68, v77
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v6, v73, v82
	v_dual_fmac_f32 v0, v29, v85 :: v_dual_fmac_f32 v13, v62, v79
	v_dual_fmac_f32 v11, v63, v80 :: v_dual_fmac_f32 v8, v72, v81
	v_fmac_f32_e32 v5, v66, v83
	v_fmac_f32_e32 v9, v64, v81
	v_fmac_f32_e32 v7, v65, v82
	v_fmac_f32_e32 v3, v67, v84
	v_fmac_f32_e32 v1, v68, v85
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_load_2addr_b64 v[8:11], v57 offset1:16
	ds_load_2addr_b64 v[4:7], v58 offset1:16
	ds_load_2addr_b64 v[0:3], v59 offset1:16
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
...
.Ltmp21:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_vgpr, 110
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.numbered_sgpr, 54
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     56
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.kd
