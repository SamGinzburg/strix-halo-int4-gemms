...
.Ltmp19:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:883:29 ]
	v_permlanex16_b32 v143, v66, s64, 0xfedcba98 op_sel:[1,0]
...
.Ltmp41:
	...
	v_permlanex16_b32 v74, v83, s64, 0xfedcba98 op_sel:[1,0]
	v_add3_u32 v69, v126, v69, 0x7fff
	v_cndmask_b16 v187.h, 0x7fff, v72.h, s7
	v_permlanex16_b32 v72, v84, s64, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v70, v132, s64, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b16 v183.l, 0x7fff, v69.h, s4
	v_permlanex16_b32 v180, v68, s64, 0xfedcba98 op_sel:[1,0]
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt vmcnt(1)
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v182, v181, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v184, v183, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v186, v185, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v190, v187, s64, 0xfedcba98 op_sel:[1,0]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 191
