...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[108:109], null, s69, v37, v[33:34]
	.loc	1 758 19                        ; attention.py:758:19
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v152, 0, v38
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v154, 0, v40
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v151, 0, v36
	v_mov_b32_e32 v21, v25
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v153, 0, v39
	v_mov_b32_e32 v23, v25
	v_mov_b32_e32 v9, v25
	v_dual_mov_b32 v10, v25 :: v_dual_and_b32 v109, 0x5040504, v33
	v_mov_b32_e32 v11, v25
	v_dual_mov_b32 v12, v25 :: v_dual_and_b32 v111, 0x7060706, v34
	...
	v_dual_mov_b32 v16, v25 :: v_dual_mov_b32 v175, v170
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_and_b32 s3, s7, s8
	s_and_b32 s100, s9, s10
	s_and_b32 s7, s11, s12
	s_and_b32 s10, s5, s6
	s_and_b32 s11, s15, s16
	s_and_b32 s12, s17, s18
...
.LBB0_7:                                ; %._crit_edge
	...
	v_div_scale_f32 v49, s3, v28, v150, v28
	...
	v_div_scale_f32 v34, s4, v29, v150, v29
	...
	v_div_scale_f32 v36, s3, v31, v150, v31
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v46, s5, v32, v150, v32
	...
	v_div_scale_f32 v44, s3, v18, v150, v18
	...
	v_div_scale_f32 v38, s4, v19, v150, v19
	...
	v_div_scale_f32 v42, s3, v21, v150, v21
	...
	v_div_scale_f32 v38, s5, v22, v150, v22
	...
	v_div_scale_f32 v40, s3, v24, v150, v24
	...
	v_div_scale_f32 v32, s4, v9, v150, v9
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v45, s5, v11, v150, v11
	s_mov_b32 vcc_lo, s3
	...
	v_div_scale_f32 v36, s3, v12, v150, v12
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_div_scale_f32 v35, s4, v14, v150, v14
	...
	v_div_scale_f32 v49, s5, v2, v150, v2
	...
	v_fmac_f32_e32 v39, v45, v39
	v_div_scale_f32 v45, s3, v6, v150, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v49, v32, v36
	v_fmac_f32_e32 v41, v48, v41
	v_div_scale_f32 v48, s4, v7, v150, v7
	...
	v_div_scale_f32 v50, s5, v8, v150, v8
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 226
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 101
