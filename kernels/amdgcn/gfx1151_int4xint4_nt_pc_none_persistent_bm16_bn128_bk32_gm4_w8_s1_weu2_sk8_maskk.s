...
.Ltmp18:
	...
	s_sub_i32 s7, 0, s28
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mad_u64_u32 v[10:11], null, s21, v4, v[1:2]
	s_mul_i32 s7, s7, s6
	.loc	1 222 36                        ; generate_amdgcn.py:222:36
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s7, s7, s38
	s_mul_i32 s40, s6, s28
	v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v4, 0
	s_sub_i32 s1, s1, s40
	s_add_i32 s40, s6, 1
	s_sub_i32 s41, s1, s28
	s_cmp_ge_u32 s1, s28
	...
	s_xor_b32 s1, s43, s40
	s_mul_hi_u32 s41, s42, s41
	s_ashr_i32 s1, s1, 31
	s_mul_i32 s44, s41, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s42, s42, s44
	s_add_i32 s44, s41, 1
	s_sub_i32 s45, s42, s6
	s_cmp_ge_u32 s42, s6
	s_cselect_b32 s41, s44, s41
	s_cselect_b32 s42, s45, s42
	s_add_i32 s44, s41, 1
	s_cmp_ge_u32 s42, s6
	s_cselect_b32 s6, s44, s41
...
; %bb.3:                                ; %.lr.ph
	...
	s_mov_b32 s43, s37
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[11:12], null, s26, v2, v[8:9]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[12:13], null, s26, v3, v[9:10]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_nc_u32_e32 v13, s42, v9
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	v_add_nc_u32_e32 v47, s42, v12
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	v_add_nc_u32_e32 v46, s42, v11
	.loc	1 229 27                        ; generate_amdgcn.py:229:27
	v_cmp_lt_i32_e32 vcc_lo, s42, v24
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	s_mov_b32 s6, s14
	...
	s_addk_i32 s42, 0x80
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	v_cndmask_b32_e64 v13, 0x80000000, v47, s1
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	s_cmp_lg_u32 s43, 0
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	buffer_load_b64 v[46:47], v13, s[4:7], 0 offen
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	buffer_load_u8 v13, v48, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	s_waitcnt vmcnt(1)
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v0, s40, v8
	.loc	1 222 18                        ; generate_amdgcn.py:222:18
	s_lshl_b32 s1, s41, 7
	.loc	1 279 27                        ; generate_amdgcn.py:279:27
	s_mul_i32 s40, s40, s21
	.loc	1 243 26                        ; generate_amdgcn.py:243:26
	v_or_b32_e32 v1, s1, v16
	v_or_b32_e32 v2, s1, v17
	.loc	1 242 18                        ; generate_amdgcn.py:242:18
	v_lshlrev_b32_e32 v0, 1, v0
	.loc	1 243 26                        ; generate_amdgcn.py:243:26
	v_or_b32_e32 v6, s1, v18
	v_or_b32_e32 v7, s1, v19
	v_or_b32_e32 v48, s1, v20
	v_or_b32_e32 v49, s1, v21
	.loc	1 242 18                        ; generate_amdgcn.py:242:18
	buffer_load_u16 v51, v0, s[16:19], 0 offen
	.loc	1 243 26                        ; generate_amdgcn.py:243:26
	v_or_b32_e32 v50, s1, v22
	v_or_b32_e32 v0, s1, v23
	...
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v50, v51, v50 :: v_dual_lshlrev_b32 v49, 16, v49
	v_dual_mul_f32 v7, v51, v7 :: v_dual_lshlrev_b32 v6, 16, v6
	v_mul_f32_e32 v48, v51, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v4, v50, v4 :: v_dual_mul_f32 v49, v51, v49
	...
	v_dual_mul_f32 v6, v51, v6 :: v_dual_mul_f32 v11, v48, v11
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v5, v49, v5 :: v_dual_mul_f32 v52, v51, v52
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v51, v51, v54 :: v_dual_mul_f32 v6, v6, v13
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 46
