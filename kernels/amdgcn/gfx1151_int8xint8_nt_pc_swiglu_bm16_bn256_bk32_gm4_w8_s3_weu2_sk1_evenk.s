	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	s_lshl_b32 s28, s2, 4
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_mul_i32 s34, s18, s9
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	s_mul_i32 s2, s28, s9
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmp_gt_i32 s6, 31
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v48, v1, v3, s2
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	...
	s_cmp_gt_i32 s6, 63
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v2, s2, v44
	v_add_nc_u32_e32 v3, s2, v47
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v1, s36, v48
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v4, s4, v44
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s2, -1, 0
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s36, s36, 32
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v5, s4, v47
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v6, s36, v48
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	v_cndmask_b32_e64 v32, 0x80000000, v21, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_u16 v36, v22, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[20:23], v2, s[24:27], 0 offen
	buffer_load_b128 v[24:27], v3, s[24:27], 0 offen
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_and_b32_e32 v39, 0xf70, v2
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v50, v3, v38
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v51, v37, v39
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_and_b32_e32 v46, 0x160, v3
	v_and_b32_e32 v1, 4, v0
	s_mov_b32 s4, 0
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_and_or_b32 v45, 0xe00, v2, v46
	s_branch .LBB0_3
.LBB0_2:
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v1, v0, 2, 1
	v_dual_mov_b32 v9, 0 :: v_dual_and_b32 v46, 0x160, v3
.Ltmp14:
	...
	s_mov_b32 s10, s4
	s_mov_b32 s11, s4
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v1, 0x90, v1
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v26, 0
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v12, 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_or_b32_e32 v52, v1, v46
	v_or_b32_e32 v53, v45, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s6, s36, s6
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v61, s8, v55
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s7, s6, s34
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v56, s6, v48
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	s_add_i32 s6, s6, s35
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v57, s7, v44
	v_add_nc_u32_e32 v58, s7, v47
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v59, s6, v44
	...
	buffer_load_b128 v[92:95], v58, s[24:27], 0 offen
	buffer_load_b128 v[96:99], v59, s[24:27], 0 offen
	buffer_load_b128 v[100:103], v60, s[24:27], 0 offen
	s_mov_b32 s6, s0
	s_mov_b32 s7, s4
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v58, s7, v53
	v_add_nc_u32_e32 v59, s7, v55
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v60, s8, v53
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[104:107], v56
	ds_load_b128 v[108:111], v57
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[64:67], v58
	ds_load_b128 v[72:75], v58 offset:4096
	ds_load_b128 v[112:115], v59
	ds_load_b128 v[116:119], v59 offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[80:83], v60
	ds_load_b128 v[120:123], v60 offset:4096
	ds_load_b128 v[124:127], v61
	ds_load_b128 v[128:131], v61 offset:4096
	s_mov_b32 s33, s1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s1, s38, 1
	s_mov_b32 s4, s30
	...
	s_waitcnt lgkmcnt(7)
	v_wmma_i32_16x16x16_iu8 v[56:63], v[64:67], v[104:107], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[64:71], v[72:75], v[104:107], v[1:8] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[72:79], v[80:83], v[104:107], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[80:87], v[120:123], v[104:107], v[1:8] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[56:63], v[112:115], v[108:111], v[56:63] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[72:79], v[124:127], v[108:111], v[72:79] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[64:71], v[116:119], v[108:111], v[64:71] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[80:87], v[128:131], v[108:111], v[80:87] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_dual_add_f32 v30, v30, v63 :: v_dual_add_nc_u32 v133, s1, v50
	v_dual_add_f32 v23, v23, v68 :: v_dual_add_nc_u32 v134, s30, v51
	v_dual_add_f32 v26, v26, v57 :: v_dual_add_f32 v25, v25, v56
	...
	v_dual_add_f32 v31, v31, v64 :: v_dual_add_f32 v40, v40, v67
	v_add_f32_e32 v33, v33, v70
	v_dual_add_f32 v39, v39, v66 :: v_dual_add_f32 v24, v24, v69
	v_dual_add_f32 v34, v34, v71 :: v_dual_add_f32 v9, v9, v72
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_add_f32 v10, v10, v73 :: v_dual_add_f32 v27, v27, v74
	v_dual_add_f32 v28, v28, v75 :: v_dual_add_f32 v11, v11, v76
	v_dual_add_f32 v12, v12, v77 :: v_dual_add_f32 v19, v19, v78
	v_dual_add_f32 v20, v20, v79 :: v_dual_add_f32 v21, v21, v80
	v_dual_add_f32 v22, v22, v81 :: v_dual_add_f32 v35, v35, v82
	v_dual_add_f32 v36, v36, v83 :: v_dual_add_f32 v13, v13, v84
	v_dual_add_f32 v14, v14, v85 :: v_dual_add_f32 v17, v17, v86
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b16 v133, v132 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v134, v[88:91]
	s_waitcnt vmcnt(2)
	ds_store_b128 v134, v[92:95] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v134, v[96:99] offset:16384
	s_waitcnt vmcnt(0)
	ds_store_b128 v134, v[100:103] offset:20480
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v48, s33, v44
	v_add_nc_u32_e32 v49, s33, v45
	ds_load_b128 v[64:67], v48
	ds_load_b128 v[68:71], v48 offset:4096
	ds_load_b128 v[73:76], v49
	ds_load_b128 v[77:80], v49 offset:4096
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v69, s11 :: v_dual_add_nc_u32 v46, s30, v44
	v_dual_mov_b32 v67, s9 :: v_dual_add_nc_u32 v60, s30, v45
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
...
; %bb.15:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v87, s11 :: v_dual_add_nc_u32 v44, s1, v44
	v_dual_mov_b32 v86, s10 :: v_dual_add_nc_u32 v45, s1, v45
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[67:70], v44
	ds_load_b128 v[73:76], v44 offset:4096
	ds_load_b128 v[96:99], v45
	ds_load_b128 v[100:103], v45 offset:4096
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
...
.LBB0_16:
	...
	s_mov_b32 s20, s12
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v52, v16, v49 :: v_dual_lshlrev_b32 v3, 5, v42
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	s_barrier
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v57, v37, v48 :: v_dual_add_f32 v48, v31, v53
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_add_f32_e32 v49, v30, v55
	v_dual_add_f32 v51, v29, v50 :: v_dual_add_f32 v44, v40, v65
	v_dual_add_f32 v45, v39, v62 :: v_dual_add_f32 v42, v24, v63
	v_dual_add_f32 v43, v23, v58 :: v_dual_add_f32 v8, v33, v64
	v_add_f32_e32 v7, v34, v66
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_add_f32 v70, v10, v68 :: v_dual_add_f32 v71, v9, v47
	v_dual_add_f32 v69, v27, v69 :: v_dual_add_f32 v62, v22, v79
	v_dual_add_f32 v66, v12, v73 :: v_dual_add_f32 v67, v11, v67
	v_dual_add_f32 v64, v20, v77 :: v_dual_add_f32 v65, v19, v74
	v_dual_add_f32 v63, v21, v76 :: v_dual_add_f32 v58, v36, v83
	v_dual_add_f32 v55, v13, v78 :: v_dual_and_b32 v0, 16, v0
	v_dual_add_f32 v47, v18, v84 :: v_dual_add_f32 v50, v17, v82
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_add_f32 v60, v35, v80 :: v_dual_add_f32 v53, v14, v81
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 141
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.kd
