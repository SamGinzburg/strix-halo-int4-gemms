	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8,@function
amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8:                                 ; @amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 800 18                        ; attention.py:800:18
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v52, 0xff800000 :: v_dual_add_nc_u32 v51, 0, v55
	...
	s_mov_b32 s23, s19
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v8, v1 :: v_dual_lshlrev_b32 v53, 16, v53
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 928 41                        ; attention.py:928:41
	v_dual_mul_f32 v53, s1, v53 :: v_dual_add_nc_u32 v48, 0, v23
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mov_b32 v56, v53 :: v_dual_and_b32 v55, 0x7060706, v55
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v60, v53, v60 :: v_dual_mul_f32 v65, v56, v65
	v_cvt_f32_i32_e32 v64, v64
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v66, v57, v66 :: v_dual_mul_f32 v67, v58, v67
	.loc	1 970 25                        ; attention.py:970:25
	v_cmp_neq_f32_e64 s4, 0xff800000, v76
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v62, v57, v62 :: v_dual_mul_f32 v61, v56, v61
	v_dual_mul_f32 v64, v53, v64 :: v_dual_mul_f32 v63, v58, v63
	.loc	1 923 37                        ; attention.py:923:37
	s_waitcnt vmcnt(6)
	...
	v_dual_mul_f32 v60, v61, v68 :: v_dual_mul_f32 v61, v62, v69
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v62, v63, v70 :: v_dual_lshlrev_b32 v69, 16, v72
	...
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v65, v65, v69 :: v_dual_lshlrev_b32 v70, 16, v71
	.loc	1 967 26                        ; attention.py:967:26
...
.Ltmp3:
	...
	v_dual_sub_f32 v68, v68, v52 :: v_dual_mul_f32 v63, v81, v63
...
.Ltmp9:
	...
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v62, 0, v65, s1
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v6, v6, v60 :: v_dual_and_b32 v69, 1, v73
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cmp_o_f32_e64 s4, v62, v62
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp10:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v64, v63, v62 :: v_dual_and_b32 v65, 1, v65
.Ltmp11:
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v69.l, 0x7fff, v65.h, s4
	.loc	1 971 33                        ; attention.py:971:33
...
.Ltmp18:
	...
	v_permlanex16_b32 v64, v62, s39, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp19:
	.loc	1 1019 30                       ; attention.py:1019:30
...
.Ltmp21:
	...
	v_cndmask_b16 v71.l, 0x7fff, v64.h, s1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.Ltmp98:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.num_vgpr, 84
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn16_w4_s1_ds8.kd
