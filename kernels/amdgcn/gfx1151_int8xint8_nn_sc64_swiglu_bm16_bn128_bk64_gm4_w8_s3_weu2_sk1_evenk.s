	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[28:31], v11, s[28:31], 0 offen
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_clause 0x1
	buffer_load_b128 v[36:39], v7, s[28:31], 0 offen
	buffer_load_b128 v[40:43], v8, s[28:31], 0 offen
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_cndmask_b32_e64 v48, 0x80000000, v7, s3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_clause 0x1
	buffer_load_b128 v[44:47], v7, s[28:31], 0 offen
	buffer_load_b128 v[52:55], v8, s[28:31], 0 offen
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v7, s33, v3
	...
	buffer_load_b32 v79, v48, s[4:7], 0 offen
	v_lshlrev_b32_e32 v8, 2, v0
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e64 v7, 0x80000000, v7, s3
	s_clause 0x1
	buffer_load_b128 v[56:59], v3, s[28:31], 0 offen
	buffer_load_b128 v[60:63], v7, s[28:31], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v78, v5, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v5, v0, 0, 1
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	...
	v_xor_b32_e32 v50, 0x330, v12
	v_add_nc_u32_e32 v26, 0, v14
	v_xor_b32_e32 v51, 0x3a0, v12
	v_add_nc_u32_e32 v25, 0, v15
	v_add_nc_u32_e32 v23, 0, v16
	...
	s_waitcnt vmcnt(8)
	v_perm_b32 v48, v32, v28, 0x5010400
	v_perm_b32 v32, v32, v28, 0x7030602
	v_perm_b32 v49, v33, v29, 0x5010400
	v_perm_b32 v33, v33, v29, 0x7030602
	v_perm_b32 v64, v34, v30, 0x5010400
	v_perm_b32 v34, v34, v30, 0x7030602
	v_perm_b32 v65, v35, v31, 0x5010400
	v_perm_b32 v66, v35, v31, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(6)
	v_perm_b32 v67, v40, v36, 0x5010400
	v_perm_b32 v40, v40, v36, 0x7030602
	v_perm_b32 v68, v41, v37, 0x5010400
	v_perm_b32 v41, v41, v37, 0x7030602
	v_perm_b32 v69, v42, v38, 0x5010400
	v_perm_b32 v42, v42, v38, 0x7030602
	v_perm_b32 v70, v43, v39, 0x5010400
	v_perm_b32 v71, v43, v39, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_and_b16 v30.l, 0xff, v49.l
	v_lshrrev_b32_e32 v75, 8, v49
	v_lshrrev_b32_e32 v76, 24, v49
	v_and_b16 v30.h, 0xff, v49.h
	v_and_b16 v31.l, 0xff, v33.l
	v_lshrrev_b32_e32 v49, 8, v33
	v_lshrrev_b32_e32 v77, 24, v33
	v_and_b16 v31.h, 0xff, v33.h
	v_and_b16 v32.l, 0xff, v64.l
	v_lshrrev_b32_e32 v80, 8, v64
	v_lshrrev_b32_e32 v81, 24, v64
	v_and_b16 v32.h, 0xff, v64.h
	v_and_b16 v33.l, 0xff, v34.l
	v_lshrrev_b32_e32 v64, 8, v34
	v_lshrrev_b32_e32 v82, 24, v34
	v_and_b16 v33.h, 0xff, v34.h
	v_and_b16 v34.l, 0xff, v65.l
	v_lshrrev_b32_e32 v83, 8, v65
	v_lshrrev_b32_e32 v84, 24, v65
	v_and_b16 v34.h, 0xff, v65.h
	v_and_b16 v35.l, 0xff, v66.l
	v_lshrrev_b32_e32 v65, 8, v66
	v_lshrrev_b32_e32 v85, 24, v66
	v_and_b16 v35.h, 0xff, v66.h
	s_waitcnt vmcnt(4)
	v_perm_b32 v66, v52, v44, 0x5010400
	v_perm_b32 v86, v52, v44, 0x7030602
	v_perm_b32 v87, v53, v45, 0x5010400
	v_perm_b32 v88, v53, v45, 0x7030602
	v_perm_b32 v89, v54, v46, 0x5010400
	v_perm_b32 v90, v54, v46, 0x7030602
	v_perm_b32 v91, v55, v47, 0x5010400
	v_perm_b32 v92, v55, v47, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	v_lshrrev_b32_e32 v67, 8, v40
	v_lshrrev_b32_e32 v95, 24, v40
	v_and_b16 v37.h, 0xff, v40.h
	v_and_b16 v38.l, 0xff, v68.l
	v_lshrrev_b32_e32 v96, 8, v68
	v_lshrrev_b32_e32 v97, 24, v68
	v_and_b16 v38.h, 0xff, v68.h
	v_and_b16 v39.l, 0xff, v41.l
	v_lshrrev_b32_e32 v68, 8, v41
	v_lshrrev_b32_e32 v98, 24, v41
	v_and_b16 v39.h, 0xff, v41.h
	v_and_b16 v40.l, 0xff, v69.l
	v_lshrrev_b32_e32 v99, 8, v69
	v_lshrrev_b32_e32 v100, 24, v69
	v_and_b16 v40.h, 0xff, v69.h
	v_and_b16 v41.l, 0xff, v42.l
	v_lshrrev_b32_e32 v69, 8, v42
	v_lshrrev_b32_e32 v101, 24, v42
	v_and_b16 v41.h, 0xff, v42.h
	v_and_b16 v42.l, 0xff, v70.l
	v_lshrrev_b32_e32 v102, 8, v70
	v_lshrrev_b32_e32 v103, 24, v70
	v_and_b16 v42.h, 0xff, v70.h
	v_and_b16 v43.l, 0xff, v71.l
	v_lshrrev_b32_e32 v70, 8, v71
	v_lshrrev_b32_e32 v104, 24, v71
	v_and_b16 v43.h, 0xff, v71.h
	s_waitcnt vmcnt(1)
	v_perm_b32 v71, v60, v56, 0x5010400
	v_perm_b32 v105, v60, v56, 0x7030602
	v_perm_b32 v106, v61, v57, 0x5010400
	v_perm_b32 v107, v61, v57, 0x7030602
	v_perm_b32 v108, v62, v58, 0x5010400
	v_perm_b32 v109, v62, v58, 0x7030602
	v_perm_b32 v110, v63, v59, 0x5010400
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v44.l, 8, v72.l
	v_lshlrev_b16 v45.l, 8, v48.l
	v_lshlrev_b16 v48.l, 8, v80.l
	v_lshrrev_b32_e32 v80, 8, v66
	v_lshlrev_b16 v44.h, 8, v73.l
	v_lshlrev_b16 v48.h, 8, v81.l
	v_lshrrev_b32_e32 v81, 24, v66
	v_lshlrev_b16 v49.h, 8, v82.l
	v_lshrrev_b32_e32 v82, 8, v86
	v_lshlrev_b16 v45.h, 8, v74.l
	v_lshlrev_b16 v52.l, 8, v83.l
	v_lshrrev_b32_e32 v83, 24, v86
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v111, v63, v59, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v46.l, 8, v75.l
	v_lshlrev_b16 v52.h, 8, v84.l
	v_lshrrev_b32_e32 v84, 8, v87
	v_lshlrev_b16 v46.h, 8, v76.l
	v_lshlrev_b16 v47.l, 8, v49.l
	v_lshlrev_b16 v47.h, 8, v77.l
	v_lshlrev_b16 v49.l, 8, v64.l
	v_lshlrev_b16 v53.l, 8, v65.l
	v_lshlrev_b16 v53.h, 8, v85.l
	v_and_b16 v54.l, 0xff, v66.l
	v_and_b16 v54.h, 0xff, v66.h
	v_and_b16 v55.l, 0xff, v86.l
	v_and_b16 v55.h, 0xff, v86.h
	v_and_b16 v56.l, 0xff, v87.l
	v_lshrrev_b32_e32 v85, 24, v87
	v_and_b16 v56.h, 0xff, v87.h
	v_and_b16 v57.l, 0xff, v88.l
	v_lshrrev_b32_e32 v86, 8, v88
	v_lshrrev_b32_e32 v87, 24, v88
	v_and_b16 v57.h, 0xff, v88.h
	v_and_b16 v58.l, 0xff, v89.l
	v_lshrrev_b32_e32 v88, 8, v89
	v_lshrrev_b32_e32 v112, 24, v89
	v_and_b16 v58.h, 0xff, v89.h
	v_and_b16 v59.l, 0xff, v90.l
	v_lshrrev_b32_e32 v89, 8, v90
	v_lshrrev_b32_e32 v113, 24, v90
	v_and_b16 v59.h, 0xff, v90.h
	v_and_b16 v60.l, 0xff, v91.l
	v_lshrrev_b32_e32 v90, 8, v91
	v_lshrrev_b32_e32 v114, 24, v91
	v_and_b16 v60.h, 0xff, v91.h
	v_and_b16 v61.l, 0xff, v92.l
	v_lshrrev_b32_e32 v91, 8, v92
	v_lshrrev_b32_e32 v115, 24, v92
	v_and_b16 v61.h, 0xff, v92.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v62.l, 8, v93.l
	v_lshlrev_b16 v62.h, 8, v94.l
	v_lshlrev_b16 v63.l, 8, v67.l
	v_lshlrev_b16 v63.h, 8, v95.l
	v_lshlrev_b16 v64.l, 8, v96.l
	v_lshlrev_b16 v64.h, 8, v97.l
	v_lshlrev_b16 v65.l, 8, v68.l
	v_lshlrev_b16 v65.h, 8, v98.l
	v_lshlrev_b16 v66.l, 8, v99.l
	v_lshlrev_b16 v66.h, 8, v100.l
	v_lshlrev_b16 v67.l, 8, v69.l
	v_lshlrev_b16 v67.h, 8, v101.l
	v_lshlrev_b16 v68.l, 8, v102.l
	v_lshlrev_b16 v68.h, 8, v103.l
	v_lshlrev_b16 v69.h, 8, v104.l
	...
	v_lshlrev_b16 v44.h, 8, v81.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v69.l, 8, v70.l
	v_and_b16 v70.l, 0xff, v71.l
	v_and_b16 v70.h, 0xff, v71.h
	v_and_b16 v71.l, 0xff, v105.l
	v_and_b16 v71.h, 0xff, v105.h
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v72.l, 0xff, v106.l
	v_and_b16 v72.h, 0xff, v106.h
	v_lshrrev_b32_e32 v106, 8, v111
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v30.l, v30.l, v46.l
	v_lshlrev_b16 v46.l, 8, v84.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v73.l, 0xff, v107.l
	v_and_b16 v73.h, 0xff, v107.h
	v_and_b16 v74.l, 0xff, v108.l
	v_and_b16 v74.h, 0xff, v108.h
	v_and_b16 v75.l, 0xff, v109.l
	v_and_b16 v75.h, 0xff, v109.h
	v_and_b16 v76.l, 0xff, v110.l
	...
	v_or_b16 v34.l, v34.l, v52.l
	v_or_b16 v34.h, v34.h, v52.h
	v_lshlrev_b16 v46.h, 8, v85.l
	v_lshlrev_b16 v47.l, 8, v86.l
	v_lshlrev_b16 v47.h, 8, v87.l
	v_lshlrev_b16 v48.l, 8, v88.l
	v_lshlrev_b16 v48.h, 8, v112.l
	v_lshlrev_b16 v49.l, 8, v89.l
	v_lshlrev_b16 v49.h, 8, v113.l
	v_lshlrev_b16 v52.l, 8, v90.l
	v_lshlrev_b16 v52.h, 8, v114.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v36.l, v36.l, v62.l
	v_or_b16 v36.h, v36.h, v62.h
	v_or_b16 v37.l, v37.l, v63.l
	v_or_b16 v37.h, v37.h, v63.h
	v_or_b16 v38.l, v38.l, v64.l
	v_or_b16 v38.h, v38.h, v64.h
	v_or_b16 v39.l, v39.l, v65.l
	v_or_b16 v39.h, v39.h, v65.h
	v_or_b16 v40.l, v40.l, v66.l
	v_or_b16 v40.h, v40.h, v66.h
	v_or_b16 v41.l, v41.l, v67.l
	v_or_b16 v41.h, v41.h, v67.h
	v_or_b16 v42.l, v42.l, v68.l
	v_lshlrev_b16 v62.l, 8, v92.l
	v_lshlrev_b16 v62.h, 8, v93.l
	v_lshlrev_b16 v63.l, 8, v94.l
	v_lshlrev_b16 v63.h, 8, v95.l
	v_lshlrev_b16 v64.l, 8, v96.l
	v_lshlrev_b16 v64.h, 8, v97.l
	v_lshlrev_b16 v65.l, 8, v98.l
	v_lshlrev_b16 v65.h, 8, v99.l
	v_lshlrev_b16 v66.l, 8, v100.l
	v_lshlrev_b16 v66.h, 8, v101.l
	v_lshlrev_b16 v67.l, 8, v102.l
	v_lshlrev_b16 v67.h, 8, v103.l
	v_lshlrev_b16 v68.l, 8, v104.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v20, v28
	ds_store_b16_d16_hi v20, v28 offset:64
	ds_store_b16 v27, v29
	ds_store_b16_d16_hi v27, v29 offset:64
	ds_store_b16 v26, v30
	ds_store_b16_d16_hi v26, v30 offset:64
	ds_store_b16 v25, v31
	ds_store_b16_d16_hi v25, v31 offset:64
	ds_store_b16 v23, v32
	ds_store_b16_d16_hi v23, v32 offset:64
	v_or_b16 v28.l, v54.l, v44.l
	v_or_b16 v35.l, v35.l, v53.l
	v_lshlrev_b16 v53.l, 8, v91.l
	v_or_b16 v28.h, v54.h, v44.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v76.h, 0xff, v110.h
	v_or_b16 v42.h, v42.h, v68.h
	v_lshlrev_b16 v68.h, 8, v105.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v29.l, v55.l, v45.l
	v_or_b16 v35.h, v35.h, v53.h
	v_lshlrev_b16 v53.h, 8, v115.l
	v_or_b16 v29.h, v55.h, v45.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v77.l, 0xff, v111.l
	v_or_b16 v43.l, v43.l, v69.l
	v_lshlrev_b16 v69.l, 8, v106.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v30.l, v56.l, v46.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v77.h, 0xff, v111.h
	v_or_b16 v43.h, v43.h, v69.h
	v_lshlrev_b16 v69.h, 8, v107.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v30.h, v56.h, v46.h
	v_or_b16 v31.l, v57.l, v47.l
	v_or_b16 v31.h, v57.h, v47.h
	v_or_b16 v32.l, v58.l, v48.l
	v_or_b16 v32.h, v58.h, v48.h
	v_or_b16 v44.l, v59.l, v49.l
	v_or_b16 v44.h, v59.h, v49.h
	v_or_b16 v45.l, v60.l, v52.l
	v_or_b16 v45.h, v60.h, v52.h
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b32 v24, v78 offset:32768
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v20, v36 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v20, v33 offset:640
	ds_store_b16_d16_hi v20, v33 offset:704
	ds_store_b16 v22, v34
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v20, v36 offset:16448
	ds_store_b16 v27, v37 offset:16384
	ds_store_b16_d16_hi v27, v37 offset:16448
	ds_store_b16 v26, v38 offset:16384
	ds_store_b16_d16_hi v26, v38 offset:16448
	ds_store_b16 v25, v39 offset:16384
	ds_store_b16_d16_hi v25, v39 offset:16448
	ds_store_b16 v23, v40 offset:16384
	ds_store_b16_d16_hi v23, v40 offset:16448
	ds_store_b16 v20, v41 offset:17024
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v22, v34 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v20, v41 offset:17088
	ds_store_b16 v22, v42 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v21, v35
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v22, v42 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v21, v35 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v21, v43 offset:16384
	ds_store_b16_d16_hi v21, v43 offset:16448
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v33.l, v70.l, v62.l
	v_or_b16 v33.h, v70.h, v62.h
	v_or_b16 v34.l, v71.l, v63.l
	v_or_b16 v34.h, v71.h, v63.h
	v_or_b16 v35.l, v72.l, v64.l
	v_or_b16 v35.h, v72.h, v64.h
	v_or_b16 v36.l, v73.l, v65.l
	v_or_b16 v36.h, v73.h, v65.h
	v_or_b16 v37.l, v74.l, v66.l
	v_or_b16 v37.h, v74.h, v66.h
	v_or_b16 v38.l, v75.l, v67.l
	v_or_b16 v38.h, v75.h, v67.h
	v_or_b16 v39.l, v76.l, v68.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v20, v28 offset:8192
	ds_store_b16_d16_hi v20, v28 offset:8256
	ds_store_b16 v27, v29 offset:8192
	ds_store_b16_d16_hi v27, v29 offset:8256
	ds_store_b16 v26, v30 offset:8192
	ds_store_b16_d16_hi v26, v30 offset:8256
	ds_store_b16 v25, v31 offset:8192
	ds_store_b16_d16_hi v25, v31 offset:8256
	ds_store_b16 v23, v32 offset:8192
	ds_store_b16_d16_hi v23, v32 offset:8256
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b32 v24, v79 offset:33792
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v20, v33 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v20, v44 offset:8832
	ds_store_b16_d16_hi v20, v44 offset:8896
	ds_store_b16 v22, v45 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v20, v33 offset:24640
	ds_store_b16 v27, v34 offset:24576
	ds_store_b16_d16_hi v27, v34 offset:24640
	ds_store_b16 v26, v35 offset:24576
	ds_store_b16_d16_hi v26, v35 offset:24640
	ds_store_b16 v25, v36 offset:24576
	ds_store_b16_d16_hi v25, v36 offset:24640
	ds_store_b16 v23, v37 offset:24576
	ds_store_b16_d16_hi v23, v37 offset:24640
	ds_store_b16 v20, v38 offset:25216
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v22, v45 offset:8256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v20, v38 offset:25280
	v_lshlrev_b32_e32 v58, 6, v2
	v_lshlrev_b32_e32 v20, 5, v0
	v_and_b32_e32 v59, 8, v0
	v_and_b32_e32 v60, 32, v0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v46.l, v61.l, v53.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v39.h, v76.h, v68.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v46.h, v61.h, v53.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v40.l, v77.l, v69.l
	v_or_b16 v40.h, v77.h, v69.h
	ds_store_b16 v22, v39 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v21, v46 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v22, v39 offset:24640
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v21, v46 offset:8256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v21, v40 offset:24576
	ds_store_b16_d16_hi v21, v40 offset:24640
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v87, v115, v143 :: v_dual_lshlrev_b32 v138, 16, v150
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_dual_mul_f32 v89, v115, v145 :: v_dual_fmac_f32 v32, v82, v100
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v116, v115, v133 :: v_dual_fmac_f32 v29, v84, v104
	v_mul_f32_e32 v119, v115, v134
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fmac_f32_e32 v24, v87, v109
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v122, v115, v139 :: v_dual_fmac_f32 v25, v86, v108
	v_mul_f32_e32 v123, v115, v138
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_fmac_f32 v19, v123, v111 :: v_dual_add_nc_u32 v166, s44, v50
	v_dual_fmac_f32 v18, v122, v110 :: v_dual_add_nc_u32 v167, s44, v51
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v31, v116, v98 :: v_dual_fmac_f32 v20, v89, v113
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
...
.LBB0_8:                                ; %Flow163
	...
	v_dual_mov_b32 v63, 0 :: v_dual_add_nc_u32 v50, s0, v56
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.9:
	v_dual_mov_b32 v62, 0 :: v_dual_add_nc_u32 v51, s12, v98
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v50, s12, v96
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v64, v62 :: v_dual_add_nc_u32 v63, s12, v97
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[57:60], v50
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v65, v62 :: v_dual_add_nc_u32 v50, s12, v99
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_16:
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v6, v3, v6 :: v_dual_lshlrev_b32 v35, 16, v36
	.loc	1 426 31                        ; generate_amdgcn.py:426:31
	s_waitcnt vmcnt(4)
	...
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_dual_mul_f32 v13, v3, v13 :: v_dual_lshlrev_b32 v12, 16, v12
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v22, 0xbfb8aa3b, v13 :: v_dual_fmac_f32 v19, 0xbfb8aa3b, v16
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 168
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
