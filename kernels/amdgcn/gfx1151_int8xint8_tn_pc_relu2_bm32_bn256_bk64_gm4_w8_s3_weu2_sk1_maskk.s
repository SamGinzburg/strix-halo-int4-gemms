...
.Ltmp13:
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[30:31], v10, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	...
	buffer_load_b128 v[40:43], v32, s[24:27], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	s_waitcnt vmcnt(5)
	ds_store_b128 v38, v[6:9] offset:12288
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	ds_store_b64 v32, v[30:31] offset:32768
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	ds_store_b128 v38, v[10:13]
	ds_store_b128 v38, v[14:17] offset:4096
	ds_store_b128 v38, v[2:5] offset:8192
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	...
	s_waitcnt vmcnt(2)
	ds_store_b128 v38, v[22:25] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v38, v[26:29] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v38, v[40:43] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s0, s5, 6
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v83, s1, v39
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s0, s36, s0
	s_mov_b32 s3, s4
	v_or_b32_e32 v11, s0, v73
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[9:10], null, s0, s14, v[35:36]
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v84, s3, v78, v39
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	v_dual_add_f32 v41, v41, v107 :: v_dual_add_f32 v38, v38, v109
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s0, s5, 1
	s_mov_b32 s1, s33
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
...
; %bb.10:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v36, s11 :: v_dual_add_nc_u32 v5, s33, v39
	ds_load_u8 v6, v5 offset:416
	ds_load_u8 v7, v5 offset:384
	ds_load_u8 v8, v5 offset:480
	ds_load_u8 v9, v5 offset:448
...
.LBB0_11:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v5, v64, v5 :: v_dual_lshlrev_b32 v2, 1, v2
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v70, v6 :: v_dual_lshlrev_b32 v37, 1, v3
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_or_b32_e32 v4, 32, v2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_mov_b32 v76, 0x7632 :: v_dual_lshlrev_b32 v71, 1, v0
	v_dual_mov_b32 v75, 0x5410 :: v_dual_lshlrev_b32 v72, 5, v0
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	...
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v4, v37, s[4:7], 0 offen
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v64, v64, v5, s2
	v_cndmask_b32_e64 v70, v70, v6, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v69, v7 :: v_dual_add_f32 v8, v68, v8
	v_dual_add_f32 v9, v67, v9 :: v_dual_add_f32 v10, v66, v10
	v_dual_add_f32 v11, v65, v11 :: v_dual_add_f32 v12, v63, v12
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_lshl_add_u32 v74, v1, 1, 0
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v69, v69, v7, s2
	v_cndmask_b32_e64 v68, v68, v8, s2
	v_cndmask_b32_e64 v67, v67, v9, s2
	v_cndmask_b32_e64 v66, v66, v10, s2
	v_cndmask_b32_e64 v65, v65, v11, s2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v13, v62, v13 :: v_dual_add_f32 v14, v61, v14
	v_dual_add_f32 v15, v60, v15 :: v_dual_add_f32 v16, v59, v16
	v_dual_add_f32 v17, v58, v17 :: v_dual_add_f32 v18, v57, v18
	v_dual_add_f32 v19, v56, v19 :: v_dual_add_f32 v20, v55, v20
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v63, v63, v12, s2
	v_cndmask_b32_e64 v62, v62, v13, s2
	v_cndmask_b32_e64 v61, v61, v14, s2
	v_cndmask_b32_e64 v60, v60, v15, s2
	v_cndmask_b32_e64 v59, v59, v16, s2
	v_cndmask_b32_e64 v58, v58, v17, s2
	v_cndmask_b32_e64 v57, v57, v18, s2
	v_cndmask_b32_e64 v56, v56, v19, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_mul_lo_u32 v39, s15, v39
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_lshrrev_b32_e32 v37, 1, v1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v21, v54, v21 :: v_dual_add_f32 v22, v53, v22
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_mul_i32 s30, s30, s15
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v25, v50, v25 :: v_dual_add_f32 v26, v49, v26
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v37, s30, s29, v37
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v22, v53, v22, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v27, v48, v27 :: v_dual_add_f32 v28, v47, v28
	v_dual_add_f32 v35, v40, v35 :: v_dual_add_f32 v36, v38, v36
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v20, v55, v20, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v23, v52, v23 :: v_dual_add_f32 v24, v51, v24
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v33, v42, v33 :: v_dual_add_f32 v34, v41, v34
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v23, v52, v23, s2
	v_cndmask_b32_e64 v24, v51, v24, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v31, v44, v31 :: v_dual_add_f32 v32, v43, v32
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v1.h, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v25, v50, v25, s2
	v_cndmask_b32_e64 v34, v41, v34, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v29, v46, v29 :: v_dual_add_f32 v30, v45, v30
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v28, v47, v28, s2
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v29, v46, v29, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v41.h, v1.h
	v_mov_b16_e32 v40.h, v1.h
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v30, v45, v30, s2
	v_cndmask_b32_e64 v31, v44, v31, s2
	v_cndmask_b32_e64 v33, v42, v33, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_and_b32_e32 v5, 28, v71
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_lshlrev_b32_e32 v3, 16, v3
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_and_b32_e32 v6, 32, v72
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v4, 16, v4
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_add3_u32 v5, v73, v6, v5
	ds_store_b32 v5, v4
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_dual_mul_f32 v2, v19, v2 :: v_dual_mul_f32 v19, v64, v53
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v53, v70, v71 :: v_dual_mul_f32 v64, v69, v72
	v_dual_mul_f32 v68, v68, v73 :: v_dual_mul_f32 v67, v67, v74
	v_dual_mul_f32 v63, v63, v79 :: v_dual_mul_f32 v62, v62, v80
	v_dual_mul_f32 v3, v20, v3 :: v_dual_mul_f32 v4, v21, v4
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v20, 0, v53 :: v_dual_max_f32 v21, 0, v64
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v66, v66, v77 :: v_dual_mul_f32 v65, v65, v78
	v_dual_mul_f32 v5, v22, v5 :: v_dual_mul_f32 v6, v23, v6
	v_dual_mul_f32 v9, v26, v9 :: v_dual_mul_f32 v10, v27, v10
	v_dual_mul_f32 v2, v36, v2 :: v_dual_max_f32 v19, 0, v19
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v22, 0, v68 :: v_dual_max_f32 v23, 0, v67
	v_dual_max_f32 v26, 0, v63 :: v_dual_max_f32 v27, 0, v62
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v20, v20, v20 :: v_dual_mul_f32 v21, v21, v21
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v7, v24, v7 :: v_dual_mul_f32 v8, v25, v8
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v24, 0, v66 :: v_dual_max_f32 v25, 0, v65
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v61, v61, v81 :: v_dual_mul_f32 v60, v60, v82
	v_dual_mul_f32 v17, v34, v17 :: v_dual_mul_f32 v18, v35, v18
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v24, v24, v24 :: v_dual_mul_f32 v25, v25, v25
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v11, v28, v11 :: v_dual_mul_f32 v12, v29, v12
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v28, 0, v61 :: v_dual_max_f32 v29, 0, v60
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v28, v28, v28 :: v_dual_mul_f32 v29, v29, v29
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v59, v59, v83 :: v_dual_mul_f32 v58, v58, v84
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_and_b32_e32 v20, 1, v1
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v57, v57, v85 :: v_dual_mul_f32 v56, v56, v86
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add3_u32 v0, v26, v20, 0x7fff
	v_and_b32_e32 v36, 1, v40
	v_and_b32_e32 v20, 1, v1
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v13, v30, v13 :: v_dual_mul_f32 v14, v31, v14
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v30, 0, v59 :: v_dual_max_f32 v31, 0, v58
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v32, 0, v57 :: v_dual_max_f32 v33, 0, v56
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v32, v32, v32 :: v_dual_mul_f32 v33, v33, v33
	...
	v_dual_cndmask_b32 v23, 0x3276, v76 :: v_dual_and_b32 v24, 1, v1
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v7, v7, v7 :: v_dual_and_b32 v42, 1, v44
	...
	v_dual_cndmask_b32 v10, v26, v23 :: v_dual_and_b32 v51, 1, v54
	...
	v_dual_cndmask_b32 v18, v14, v13 :: v_dual_cndmask_b32 v1, v1, v15
	...
	s_clause 0x3
	buffer_store_b128 v[2:5], v39, s[12:15], 0 offen
	buffer_store_b128 v[6:9], v39, s[12:15], 0 offen offset:256
	buffer_store_b128 v[10:13], v37, s[12:15], 0 offen
	buffer_store_b128 v[14:17], v37, s[12:15], 0 offen offset:256
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 222
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 39
