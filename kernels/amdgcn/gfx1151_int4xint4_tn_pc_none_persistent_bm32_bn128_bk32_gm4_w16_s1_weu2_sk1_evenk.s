	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp16:
	...
	v_and_b32_e32 v21, 0x5040504, v7
	s_cvt_u32_f32 s4, s4
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v29, s10, v14
	v_or_b32_e32 v31, s10, v15
	v_or_b32_e32 v32, s10, v16
	v_or_b32_e32 v33, s10, v17
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	buffer_load_u16 v30, v30, s[24:27], 0 offen
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v34, s10, v18
	v_or_b32_e32 v35, s10, v19
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_mov_b16_e32 v37.h, v36.h
	.loc	1 269 18                        ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v33, 1, v33
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_mov_b16_e32 v38.h, v36.h
	...
	v_dual_mul_f32 v33, v30, v33 :: v_dual_lshlrev_b32 v34, 16, v34
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v3, v33, v3 :: v_dual_lshlrev_b32 v32, 16, v32
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v35, v30, v35
	v_dual_mul_f32 v6, v30, v6 :: v_dual_lshlrev_b32 v31, 16, v31
	...
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v0, v35, v0 :: v_dual_mul_f32 v31, v30, v31
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v7, 16, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v4, v32, v4 :: v_dual_lshlrev_b32 v29, 16, v29
	v_mul_f32_e32 v6, v6, v28
	v_dual_mul_f32 v2, v31, v2 :: v_dual_mul_f32 v7, v30, v7
	...
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v7, v7, v27 :: v_dual_mul_f32 v26, v29, v26
	...
	v_cndmask_b16 v1.l, 0x7fff, v26.h, s5
	...
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_permlanex16_b32 v2, v2, s43, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_permlanex16_b32 v4, v4, s43, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v0, v2, v3, v21
	v_perm_b32 v1, v2, v3, v22
	s_delay_alu instid0(VALU_DEP_3)
	v_perm_b32 v2, v4, v6, v21
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v1, s6, 7, v20
	v_mov_b32_e32 v0, 0
	s_lshl_b32 s5, s5, 7
	v_add_nc_u32_e32 v26, s4, v8
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	buffer_load_u8 v28, v26, s[16:19], 0 offen
	...
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b32 v29, v27, s[20:23], 0 offen
	.loc	1 258 26                        ; generate_amdgcn.py:258:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	ds_load_u8 v28, v23
	ds_load_u8 v30, v23 offset:32
	ds_load_u8 v31, v23 offset:96
	ds_load_u8 v32, v23 offset:224
	ds_load_u8 v33, v23 offset:192
	ds_load_u8 v34, v23 offset:160
	ds_load_u8 v35, v23 offset:128
	ds_load_u8 v36, v23 offset:64
	ds_load_u8 v37, v23 offset:352
	ds_load_u8 v38, v23 offset:480
	ds_load_u8 v39, v23 offset:448
	ds_load_u8 v40, v23 offset:416
	ds_load_u8 v41, v23 offset:384
	ds_load_u8 v42, v23 offset:320
	ds_load_u8 v43, v23 offset:288
	ds_load_u8 v44, v23 offset:256
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b32 v24, v29
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 266 27                        ; generate_amdgcn.py:266:27
	ds_load_u8 v29, v25 offset:640
	ds_load_u8 v45, v25 offset:896
	ds_load_u8 v46, v25 offset:768
	ds_load_u8 v47, v25 offset:512
	ds_load_u8 v48, v25 offset:128
	ds_load_u8 v49, v25 offset:384
	ds_load_u8 v50, v25 offset:256
	ds_load_u8 v51, v25
	ds_load_u8 v52, v25 offset:1664
	ds_load_u8 v53, v25 offset:1920
	ds_load_u8 v54, v25 offset:1792
	ds_load_u8 v55, v25 offset:1536
	ds_load_u8 v56, v25 offset:1152
	ds_load_u8 v57, v25 offset:1280
	ds_load_u8 v58, v25 offset:1024
	ds_load_u8 v59, v25 offset:1408
	v_perm_b32 v28, v28, v30, 0xc0c0004
	v_perm_b32 v32, v33, v32, 0xc0c0004
	v_perm_b32 v34, v35, v34, 0xc0c0004
	v_perm_b32 v31, v36, v31, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v30, v47, v29, 0xc0c0004
	v_perm_b32 v35, v39, v38, 0xc0c0004
	v_perm_b32 v38, v46, v45, 0xc0c0004
	v_perm_b32 v33, v41, v40, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v39, v51, v48, 0xc0c0004
	v_perm_b32 v40, v50, v49, 0xc0c0004
	v_perm_b32 v36, v44, v43, 0xc0c0004
	v_perm_b32 v37, v42, v37, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v41, v55, v52, 0xc0c0004
	v_perm_b32 v42, v54, v53, 0xc0c0004
	v_lshl_or_b32 v29, v32, 16, v34
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v43, v58, v56, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v57, v59, 0xc0c0004
	v_lshl_or_b32 v28, v31, 16, v28
	v_lshl_or_b32 v31, v38, 16, v30
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[30:31], v[28:29], v[0:7] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[34:35], v[32:33], v[0:7] neg_lo:[1,1,0]
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 60
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.kd
