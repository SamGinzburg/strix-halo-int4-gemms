	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp23:
	...
	v_add_nc_u32_e32 v30, 0, v25
	v_dual_mov_b32 v2, s13 :: v_dual_mov_b32 v3, s14
	v_dual_mov_b32 v4, s15 :: v_dual_mov_b32 v5, s16
	v_dual_mov_b32 v6, s17 :: v_dual_mov_b32 v7, s18
	v_mov_b32_e32 v8, s19
	v_add_nc_u32_e32 v32, v27, v26
	v_add_nc_u32_e32 v34, v28, v26
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(5)
	ds_store_b16 v20, v59 offset:16384
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(4)
	ds_store_b128 v21, v[43:46]
	s_waitcnt vmcnt(3)
	ds_store_b128 v21, v[47:50] offset:4096
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b16 v20, v60 offset:16896
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(1)
	ds_store_b128 v21, v[51:54] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v21, v[55:58] offset:12288
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	s_cmp_lt_i32 s0, s29
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v45, v17, s16, 1
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v44, v16, s0, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[59:62], v22 offset:16384
	ds_load_b128 v[63:66], v23 offset:16384
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[51:54], v24
	ds_load_b128 v[67:70], v24 offset:4096
	ds_load_b128 v[71:74], v30
	ds_load_b128 v[75:78], v30 offset:4096
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s1, s1, -1
	s_add_i32 s3, s3, 64
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	s_waitcnt vmcnt(0)
	ds_store_b16 v32, v43 offset:17408
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	...
	v_cvt_f32_i32_e32 v93, v54
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	ds_load_b128 v[43:46], v18 offset:17408
	ds_load_b128 v[47:50], v18 offset:17424
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[59:62], v22 offset:16896
	ds_load_b128 v[63:66], v23 offset:16896
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[51:54], v24 offset:8192
	ds_load_b128 v[67:70], v24 offset:12288
	ds_load_b128 v[71:74], v30 offset:8192
	ds_load_b128 v[75:78], v30 offset:12288
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	...
	v_fmac_f32_e32 v38, v87, v102
	.loc	1 362 24 is_stmt 0              ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v83, v83, v79
	v_mul_f32_e32 v85, v85, v79
	...
	v_dual_mul_f32 v91, v91, v79 :: v_dual_and_b32 v106, 0xffff0000, v44
	v_mul_f32_e32 v92, v92, v79
	v_dual_mul_f32 v93, v93, v79 :: v_dual_and_b32 v108, 0xffff0000, v46
	v_mul_f32_e32 v94, v55, v79
	v_dual_mul_f32 v95, v56, v79 :: v_dual_and_b32 v110, 0xffff0000, v48
	v_dual_mul_f32 v96, v57, v79 :: v_dual_and_b32 v107, 0xffff0000, v45
	v_dual_mul_f32 v79, v58, v79 :: v_dual_and_b32 v112, 0xffff0000, v50
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v36, v89, v104 :: v_dual_lshlrev_b32 v97, 16, v43
	v_dual_fmac_f32 v42, v83, v98 :: v_dual_and_b32 v111, 0xffff0000, v49
	v_dual_fmac_f32 v40, v85, v100 :: v_dual_and_b32 v105, 0xffff0000, v43
	...
	v_wmma_i32_16x16x16_iu8 v[51:58], v[67:70], v[59:62], v[1:8] neg_lo:[1,1,0]
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v13, v82, v97
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_wmma_i32_16x16x16_iu8 v[43:50], v[71:74], v[63:66], v[43:50] neg_lo:[1,1,0]
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v41, v84, v99
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_wmma_i32_16x16x16_iu8 v[51:58], v[75:78], v[63:66], v[51:58] neg_lo:[1,1,0]
	...
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v72, v72, v75 :: v_dual_lshlrev_b32 v43, 16, v80
	ds_store_b32 v34, v43 offset:17408
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[43:46], v18 offset:17408
	ds_load_b128 v[47:50], v18 offset:17424
	v_mul_f32_e32 v60, v60, v75
	ds_load_b128 v[51:54], v18 offset:17920
	ds_load_b128 v[55:58], v18 offset:17936
	v_mul_f32_e32 v64, v64, v75
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v26, v96, v111
	s_waitcnt lgkmcnt(3)
	v_dual_fmac_f32 v42, v60, v44 :: v_dual_fmac_f32 v35, v90, v105
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v38, v64, v48 :: v_dual_fmac_f32 v33, v91, v106
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v62, v62, v75 :: v_dual_fmac_f32 v29, v93, v108
	v_mul_f32_e32 v66, v66, v75
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v37, v88, v103
	v_dual_fmac_f32 v27, v95, v110 :: v_dual_mul_f32 v68, v68, v75
	v_dual_fmac_f32 v25, v79, v112 :: v_dual_mul_f32 v70, v70, v75
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v31, v92, v107
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v74, v74, v75 :: v_dual_fmac_f32 v41, v61, v45
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v40, v62, v46
	v_fmac_f32_e32 v28, v94, v109
	v_fmac_f32_e32 v39, v86, v101
	v_dual_fmac_f32 v13, v59, v43 :: v_dual_fmac_f32 v36, v66, v50
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v37, v65, v49 :: v_dual_fmac_f32 v28, v71, v55
	v_fmac_f32_e32 v39, v63, v47
	v_fmac_f32_e32 v35, v67, v51
	v_fmac_f32_e32 v33, v68, v52
	v_fmac_f32_e32 v29, v70, v54
	v_dual_fmac_f32 v27, v72, v56 :: v_dual_fmac_f32 v26, v73, v57
	v_fmac_f32_e32 v31, v69, v53
	v_fmac_f32_e32 v25, v74, v58
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.3:                                ; %._crit_edge.loopexit
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v3, v41, v41 :: v_dual_max_f32 v4, v40, v40
	v_dual_max_f32 v7, v37, v37 :: v_dual_max_f32 v8, v36, v36
	v_dual_max_f32 v9, v35, v35 :: v_dual_max_f32 v10, v33, v33
	v_max_f32_e32 v11, v31, v31
	v_dual_max_f32 v1, v13, v13 :: v_dual_max_f32 v2, v42, v42
	...
	v_dual_max_f32 v10, v28, v28 :: v_dual_max_f32 v21, 0, v11
	v_dual_max_f32 v12, v26, v26 :: v_dual_max_f32 v11, v27, v27
	v_max_f32_e32 v9, v29, v29
	v_dual_max_f32 v13, v25, v25 :: v_dual_mul_f32 v16, v3, v3
...
.LBB0_4:                                ; %._crit_edge
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v15, s22, s2, v15
	.loc	1 416 9 is_stmt 0               ; generate_amdgcn.py:416:9
	v_cndmask_b32_e32 v6, v12, v17, vcc_lo
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 113
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
