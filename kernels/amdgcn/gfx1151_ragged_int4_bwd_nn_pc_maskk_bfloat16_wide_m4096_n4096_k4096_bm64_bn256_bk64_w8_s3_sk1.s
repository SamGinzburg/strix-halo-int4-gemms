...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v41, 0 :: v_dual_lshlrev_b32 v10, 4, v0
	v_lshlrev_b32_e32 v1, 1, v0
	.loc	1 1046 23                       ; ragged.py:1046:23
	v_add3_u32 v4, s36, s35, v90
	s_mul_i32 s11, s11, s34
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v46, v41 :: v_dual_and_b32 v3, 24, v97
	v_dual_mov_b32 v42, v41 :: v_dual_and_b32 v1, 24, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v44, v41 :: v_dual_add_nc_u32 v7, 16, v4
	v_mov_b32_e32 v48, v41
	s_sub_i32 s11, s13, s11
	v_lshl_or_b32 v1, v103, 5, v1
	v_add3_u32 v2, s33, s40, v91
	...
	v_dual_mov_b32 v58, v41 :: v_dual_and_b32 v9, 0x70, v97
	s_lshl_b32 s10, s10, 8
	s_lshl_b32 s2, s2, 8
	v_mad_u64_u32 v[86:87], null, v2, s37, v[85:86]
	s_add_i32 s2, s2, s10
	v_add3_u32 v92, 0, v103, v9
	v_add3_u32 v93, s2, v4, v89
	v_add3_u32 v94, s2, v7, v89
	v_dual_mov_b32 v60, v41 :: v_dual_add_nc_u32 v87, 0, v3
	v_dual_mov_b32 v62, v41 :: v_dual_add_nc_u32 v95, 0, v1
	v_dual_mov_b32 v43, v41 :: v_dual_add_nc_u32 v96, 0, v5
	v_dual_mov_b32 v45, v41 :: v_dual_add_nc_u32 v98, 0, v6
	v_dual_mov_b32 v64, v41 :: v_dual_add_nc_u32 v99, 0, v8
	v_dual_mov_b32 v47, v41 :: v_dual_add_nc_u32 v100, 0, v10
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v65, s35, v86
	.loc	1 1057 34                       ; ragged.py:1057:34
	v_cndmask_b32_e64 v66, 0x80000000, v93, s0
	v_cndmask_b32_e64 v67, 0x80000000, v94, s0
	.loc	1 1046 23                       ; ragged.py:1046:23
	v_add_nc_u32_e32 v93, s2, v93
	v_add_nc_u32_e32 v94, s2, v94
	...
	.loc	1 1057 34                       ; ragged.py:1057:34
	s_clause 0x1
	buffer_load_b128 v[105:108], v66, s[8:11], 0 offen
	buffer_load_b128 v[109:112], v67, s[8:11], 0 offen
	.loc	1 1056 34                       ; ragged.py:1056:34
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[113:116], v95 offset1:1
	ds_load_2addr_stride64_b64 v[117:120], v95 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[121:124], v96 offset1:1
	ds_load_2addr_stride64_b64 v[81:84], v96 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[77:80], v98 offset1:1
	ds_load_2addr_stride64_b64 v[73:76], v98 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[69:72], v99 offset1:1
	ds_load_2addr_stride64_b64 v[65:68], v99 offset0:2 offset1:3
	.loc	1 1057 34                       ; ragged.py:1057:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b128 v100, v[105:108]
	ds_store_b128 v100, v[109:112] offset:4096
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1058 31                       ; ragged.py:1058:31
	ds_load_u8 v101, v92 offset:1280
	ds_load_u8 v102, v92 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	ds_load_u8 v102, v92 offset:1792
	ds_load_u8 v105, v92 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v105, v102, 0xc0c0004
	ds_load_u8 v105, v92 offset:256
	ds_load_u8 v106, v92
	v_lshl_or_b32 v102, v102, 16, v101
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	ds_load_u8 v106, v92 offset:768
	ds_load_u8 v107, v92 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v101, v106, 16, v105
	ds_load_u8 v105, v92 offset:1408
	ds_load_u8 v106, v92 offset:1152
	v_wmma_i32_16x16x16_iu4 v[41:48], v[101:102], v[113:114], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[101:102], v[115:116], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[101:102], v[117:118], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[101:102], v[119:120], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v101, v92 offset:3840
	ds_load_u8 v102, v92 offset:3584
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	ds_load_u8 v106, v92 offset:1920
	ds_load_u8 v107, v92 offset:1664
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	ds_load_u8 v107, v92 offset:384
	ds_load_u8 v108, v92 offset:128
	v_lshl_or_b32 v106, v106, 16, v105
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	ds_load_u8 v108, v92 offset:896
	ds_load_u8 v109, v92 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v108, v109, v108, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v105, v108, 16, v107
	ds_load_u8 v107, v92 offset:3328
	ds_load_u8 v108, v92 offset:3072
	v_wmma_i32_16x16x16_iu4 v[57:64], v[105:106], v[113:114], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[105:106], v[115:116], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[105:106], v[117:118], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[105:106], v[119:120], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v105, v92 offset:2304
	ds_load_u8 v106, v92 offset:2048
	ds_load_u8 v109, v92 offset:2816
	ds_load_u8 v110, v92 offset:2560
	ds_load_u8 v111, v92 offset:3968
	ds_load_u8 v112, v92 offset:3712
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	ds_load_u8 v108, v92 offset:3456
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	v_lshl_or_b32 v102, v101, 16, v107
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v109, v110, v109, 0xc0c0004
	ds_load_u8 v106, v92 offset:2432
	ds_load_u8 v110, v92 offset:2176
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	ds_load_u8 v112, v92 offset:5120
	v_lshl_or_b32 v101, v109, 16, v105
	ds_load_u8 v105, v92 offset:2944
	ds_load_u8 v107, v92 offset:2688
	ds_load_u8 v109, v92 offset:5376
	v_wmma_i32_16x16x16_iu4 v[41:48], v[101:102], v[121:122], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[101:102], v[123:124], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[101:102], v[81:82], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[101:102], v[83:84], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v110, v110, v106, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v105, v107, v105, 0xc0c0004
	ds_load_u8 v107, v92 offset:5632
	ds_load_u8 v117, v92 offset:4480
	ds_load_u8 v113, v92 offset:3200
	v_lshl_or_b32 v105, v105, 16, v110
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v108, v113, v108, 0xc0c0004
	ds_load_u8 v113, v92 offset:5888
	v_lshl_or_b32 v106, v111, 16, v108
	ds_load_u8 v108, v92 offset:4352
	ds_load_u8 v110, v92 offset:4096
	ds_load_u8 v111, v92 offset:4864
	ds_load_u8 v114, v92 offset:4608
	ds_load_u8 v115, v92 offset:6016
	ds_load_u8 v116, v92 offset:5760
	v_wmma_i32_16x16x16_iu4 v[57:64], v[105:106], v[121:122], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[105:106], v[123:124], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[105:106], v[81:82], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[105:106], v[83:84], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v107, v107, v113, 0xc0c0004
	ds_load_u8 v113, v92 offset:5248
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v111, v114, v111, 0xc0c0004
	v_perm_b32 v110, v110, v108, 0xc0c0004
	ds_load_u8 v114, v92 offset:4224
	v_perm_b32 v109, v112, v109, 0xc0c0004
	ds_load_u8 v112, v92 offset:5504
	v_lshl_or_b32 v108, v107, 16, v109
	v_lshl_or_b32 v107, v111, 16, v110
	ds_load_u8 v109, v92 offset:4992
	ds_load_u8 v110, v92 offset:4736
	v_wmma_i32_16x16x16_iu4 v[41:48], v[107:108], v[77:78], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[107:108], v[79:80], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[107:108], v[73:74], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[107:108], v[75:76], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v114, v114, v117, 0xc0c0004
	ds_load_u8 v117, v92 offset:7680
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v109, v110, v109, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v109, v109, 16, v114
	ds_load_u8 v114, v92 offset:6912
	v_perm_b32 v111, v113, v112, 0xc0c0004
	ds_load_u8 v112, v92 offset:7424
	v_perm_b32 v113, v116, v115, 0xc0c0004
	ds_load_u8 v116, v92 offset:7936
	ds_load_u8 v115, v92 offset:7168
	v_lshl_or_b32 v110, v113, 16, v111
	ds_load_u8 v111, v92 offset:6400
	ds_load_u8 v113, v92 offset:6144
	v_wmma_i32_16x16x16_iu4 v[57:64], v[109:110], v[77:78], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[109:110], v[79:80], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[109:110], v[73:74], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[109:110], v[75:76], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v112, v115, v112, 0xc0c0004
	v_perm_b32 v115, v117, v116, 0xc0c0004
	ds_load_u8 v116, v92 offset:6656
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v111, v113, v111, 0xc0c0004
	ds_load_u8 v113, v92 offset:7552
	v_lshl_or_b32 v112, v115, 16, v112
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v114, v116, v114, 0xc0c0004
	ds_load_u8 v116, v92 offset:7296
	v_lshl_or_b32 v111, v114, 16, v111
	ds_load_u8 v114, v92 offset:8064
	ds_load_u8 v115, v92 offset:7808
	v_wmma_i32_16x16x16_iu4 v[41:48], v[111:112], v[69:70], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[111:112], v[71:72], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[111:112], v[65:66], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[111:112], v[67:68], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v113, v116, v113, 0xc0c0004
	ds_load_u8 v116, v92 offset:6528
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v114, v115, v114, 0xc0c0004
	ds_load_u8 v115, v92 offset:6272
	v_lshl_or_b32 v114, v114, 16, v113
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v115, v115, v116, 0xc0c0004
	ds_load_u8 v116, v92 offset:7040
	ds_load_u8 v117, v92 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v116, v117, v116, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v113, v116, 16, v115
	v_wmma_i32_16x16x16_iu4 v[57:64], v[113:114], v[69:70], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[113:114], v[71:72], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[113:114], v[65:66], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[113:114], v[67:68], v[1:8] neg_lo:[1,1,0]
	.loc	1 1046 23                       ; ragged.py:1046:23
...
.LBB0_8:
	...
	v_or_b32_e32 v72, 5, v67
	v_or_b32_e32 v73, 6, v67
	v_or_b32_e32 v74, 7, v67
	.loc	1 1079 30                       ; ragged.py:1079:30
	v_cmp_gt_i32_e32 vcc_lo, s11, v67
	v_cmp_gt_i32_e64 s2, s11, v68
	v_cmp_gt_i32_e64 s3, s11, v69
	v_cmp_gt_i32_e64 s4, s11, v70
	v_cmp_gt_i32_e64 s5, s11, v71
	v_cmp_gt_i32_e64 s6, s11, v72
	v_cmp_gt_i32_e64 s7, s11, v73
	v_cmp_gt_i32_e64 s8, s11, v74
	.loc	1 1080 63                       ; ragged.py:1080:63
	s_add_i32 s20, s11, -1
	.loc	1 1070 26                       ; ragged.py:1070:26
	v_or_b32_e32 v66, 16, v65
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s12, s20, v68
	.loc	1 1079 30                       ; ragged.py:1079:30
	v_cmp_gt_i32_e64 s9, s11, v65
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s19, s20, v65
	.loc	1 1081 42                       ; ragged.py:1081:42
	v_mul_lo_u32 v65, s37, v91
	...
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s13, s20, v69
	.loc	1 1081 42                       ; ragged.py:1081:42
	s_add_i32 s12, s35, s12
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s14, s20, v70
	.loc	1 1081 42                       ; ragged.py:1081:42
	v_add3_u32 v65, s12, v65, v85
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s15, s20, v71
	.loc	1 1079 30                       ; ragged.py:1079:30
	v_cmp_gt_i32_e64 s10, s11, v66
	.loc	1 1080 56                       ; ragged.py:1080:56
	v_cmp_eq_u32_e64 s11, s20, v67
	v_cmp_eq_u32_e64 s16, s20, v72
	v_cmp_eq_u32_e64 s17, s20, v73
	v_cmp_eq_u32_e64 s18, s20, v74
	v_cmp_eq_u32_e64 s20, s20, v66
	.loc	1 1081 42                       ; ragged.py:1081:42
	v_add_nc_u32_e32 v66, 1, v65
	v_add_nc_u32_e32 v67, 2, v65
	v_add_nc_u32_e32 v68, 3, v65
	v_add_nc_u32_e32 v69, 4, v65
	v_add_nc_u32_e32 v70, 5, v65
	v_add_nc_u32_e32 v71, 6, v65
	v_add_nc_u32_e32 v72, 7, v65
	...
	.loc	1 1081 34                       ; ragged.py:1081:34
	buffer_load_u8 v77, v65, s[12:15], 0 offen
	...
	.loc	1 1081 34                       ; ragged.py:1081:34
	buffer_load_u8 v78, v65, s[12:15], 0 offen
	...
	.loc	1 1081 34                       ; ragged.py:1081:34
	buffer_load_u8 v79, v65, s[12:15], 0 offen
	v_cndmask_b32_e64 v65, 0x80000000, v68, s4
	.loc	1 1082 42                       ; ragged.py:1082:42
	s_lshl_b32 s4, s23, 4
	.loc	1 1081 34                       ; ragged.py:1081:34
	buffer_load_u8 v80, v65, s[12:15], 0 offen
	v_cndmask_b32_e64 v65, 0x80000000, v69, s5
	buffer_load_u8 v81, v65, s[12:15], 0 offen
	v_cndmask_b32_e64 v65, 0x80000000, v70, s6
	buffer_load_u8 v82, v65, s[12:15], 0 offen
	v_cndmask_b32_e64 v65, 0x80000000, v71, s7
	buffer_load_u8 v83, v65, s[12:15], 0 offen
	v_cndmask_b32_e64 v65, 0x80000000, v72, s1
	.loc	1 1082 42                       ; ragged.py:1082:42
	s_add_i32 s1, s35, s36
	s_delay_alu instid0(SALU_CYCLE_1)
	s_mul_i32 s1, s1, s23
	.loc	1 1081 34                       ; ragged.py:1081:34
	buffer_load_u8 v84, v65, s[12:15], 0 offen
	.loc	1 1082 42                       ; ragged.py:1082:42
	v_mul_lo_u32 v65, s23, v90
	s_add_i32 s1, s1, s21
	...
	.loc	1 1082 34 is_stmt 1             ; ragged.py:1082:34
	s_waitcnt vmcnt(1)
	...
	v_cndmask_b16 v100.h, v107.l, v81.h, s16
	v_cndmask_b16 v107.l, v67.h, v82.l, s16
	.loc	1 1083 34 is_stmt 1             ; ragged.py:1083:34
	v_xad_u32 v67, v88, v65, 0
	...
	.loc	1 1084 34 is_stmt 0             ; ragged.py:1084:34
	v_cndmask_b16 v106.l, v66.h, v80.l, s16
	.loc	1 1083 34 is_stmt 1             ; ragged.py:1083:34
	...
	.loc	1 1084 34 is_stmt 0             ; ragged.py:1084:34
	v_cndmask_b16 v106.h, v101.l, v80.h, s16
	.loc	1 1083 34 is_stmt 1             ; ragged.py:1083:34
	...
	.loc	1 1083 34                       ; ragged.py:1083:34
	v_lshl_or_b32 v65, v103, 5, v65
	.loc	1 1084 34                       ; ragged.py:1084:34
	v_cndmask_b16 v102.h, v94.l, v78.h, s16
	v_cndmask_b16 v107.h, v95.l, v82.h, s16
	...
	v_and_b16 v91.h, v115.l, 15
	v_and_b16 v92.l, v72.l, 15
	v_and_b16 v92.h, v116.l, 15
	...
	v_lshlrev_b16 v100.h, 8, v107.h
	v_and_b16 v107.l, 0xff, v107.l
	v_or_b16 v99.l, v99.l, v99.h
	v_lshlrev_b16 v99.h, 8, v106.h
	v_and_b16 v106.l, 0xff, v106.l
	...
	v_and_b16 v89.l, v70.h, 15
	v_and_b16 v89.h, v113.l, 15
	v_and_b16 v90.l, v71.l, 15
	v_and_b16 v90.h, v114.l, 15
	v_and_b16 v91.l, v71.h, 15
	...
	v_cndmask_b16 v114.h, v115.l, v91.h, s11
	v_cndmask_b16 v115.l, v72.l, v92.l, s11
	v_cndmask_b16 v115.h, v116.l, v92.h, s11
	...
	v_or_b16 v100.h, v107.l, v100.h
	v_or_b16 v99.h, v106.l, v99.h
	v_or_b16 v98.h, v102.l, v98.h
	v_cndmask_b16 v112.l, v70.h, v89.l, s11
	v_cndmask_b16 v112.h, v113.l, v89.h, s11
	v_cndmask_b16 v113.l, v71.l, v90.l, s11
	v_cndmask_b16 v113.h, v114.l, v90.h, s11
	v_cndmask_b16 v114.l, v71.h, v91.l, s11
	...
	ds_load_u8 v97, v106 offset:1280
	ds_load_u8 v98, v106 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v97, v98, v97, 0xc0c0004
	ds_load_u8 v98, v106 offset:1792
	ds_load_u8 v99, v106 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v98, v99, v98, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v98, v98, 16, v97
	ds_load_u8 v97, v106 offset:256
	ds_load_u8 v99, v106
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v97, v99, v97, 0xc0c0004
	ds_load_u8 v99, v106 offset:768
	ds_load_u8 v100, v106 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v99, v100, v99, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v97, v99, 16, v97
	ds_load_u8 v99, v106 offset:3328
	ds_load_u8 v100, v106 offset:3072
	v_wmma_i32_16x16x16_iu4 v[41:48], v[97:98], v[81:82], v[41:48] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v99, v100, v99, 0xc0c0004
	ds_load_u8 v100, v106 offset:3840
	ds_load_u8 v101, v106 offset:3584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v100, v101, v100, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v100, v100, 16, v99
	ds_load_u8 v99, v106 offset:2304
	ds_load_u8 v101, v106 offset:2048
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v99, v101, v99, 0xc0c0004
	ds_load_u8 v101, v106 offset:2816
	ds_load_u8 v102, v106 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v99, v101, 16, v99
	ds_load_u8 v101, v106 offset:5376
	ds_load_u8 v102, v106 offset:5120
	v_wmma_i32_16x16x16_iu4 v[41:48], v[99:100], v[85:86], v[41:48] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	ds_load_u8 v102, v106 offset:5888
	ds_load_u8 v107, v106 offset:5632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v107, v102, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v102, v102, 16, v101
	ds_load_u8 v101, v106 offset:4352
	ds_load_u8 v107, v106 offset:4096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v107, v101, 0xc0c0004
	ds_load_u8 v107, v106 offset:4864
	ds_load_u8 v108, v106 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v101, v107, 16, v101
	ds_load_u8 v107, v106 offset:7424
	ds_load_u8 v108, v106 offset:7168
	v_wmma_i32_16x16x16_iu4 v[41:48], v[101:102], v[89:90], v[41:48] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	ds_load_u8 v108, v106 offset:7936
	ds_load_u8 v109, v106 offset:7680
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v108, v109, v108, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v108, v108, 16, v107
	ds_load_u8 v107, v106 offset:6400
	ds_load_u8 v109, v106 offset:6144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v109, v107, 0xc0c0004
	ds_load_u8 v109, v106 offset:6912
	ds_load_u8 v110, v106 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v109, v110, v109, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v107, v109, 16, v107
	ds_load_u8 v109, v106 offset:1408
	ds_load_u8 v110, v106 offset:1152
	v_wmma_i32_16x16x16_iu4 v[41:48], v[107:108], v[93:94], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[107:108], v[95:96], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[107:108], v[65:66], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[107:108], v[67:68], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v109, v110, v109, 0xc0c0004
	ds_load_u8 v110, v106 offset:1920
	ds_load_u8 v111, v106 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v110, v111, v110, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v110, v110, 16, v109
	ds_load_u8 v109, v106 offset:384
	ds_load_u8 v111, v106 offset:128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v109, v111, v109, 0xc0c0004
	ds_load_u8 v111, v106 offset:896
	ds_load_u8 v112, v106 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v109, v111, 16, v109
	v_wmma_i32_16x16x16_iu4 v[57:64], v[109:110], v[81:82], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v81, v106 offset:3456
	ds_load_u8 v82, v106 offset:3200
	v_wmma_i32_16x16x16_iu4 v[33:40], v[109:110], v[83:84], v[33:40] neg_lo:[1,1,0]
	...
	ds_load_u8 v82, v106 offset:3968
	ds_load_u8 v111, v106 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v82, v111, v82, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v82, v82, 16, v81
	ds_load_u8 v81, v106 offset:2432
	ds_load_u8 v111, v106 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v81, v111, v81, 0xc0c0004
	ds_load_u8 v111, v106 offset:2944
	ds_load_u8 v112, v106 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v81, v111, 16, v81
	v_wmma_i32_16x16x16_iu4 v[57:64], v[81:82], v[85:86], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v85, v106 offset:5504
	ds_load_u8 v86, v106 offset:5248
	v_wmma_i32_16x16x16_iu4 v[33:40], v[81:82], v[87:88], v[33:40] neg_lo:[1,1,0]
	...
	ds_load_u8 v86, v106 offset:6016
	ds_load_u8 v111, v106 offset:5760
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v86, v111, v86, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v86, v86, 16, v85
	ds_load_u8 v85, v106 offset:4480
	ds_load_u8 v111, v106 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v85, v111, v85, 0xc0c0004
	ds_load_u8 v111, v106 offset:4992
	ds_load_u8 v112, v106 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v85, v111, 16, v85
	v_wmma_i32_16x16x16_iu4 v[57:64], v[85:86], v[89:90], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v89, v106 offset:7552
	ds_load_u8 v90, v106 offset:7296
	v_wmma_i32_16x16x16_iu4 v[33:40], v[85:86], v[91:92], v[33:40] neg_lo:[1,1,0]
	...
	ds_load_u8 v90, v106 offset:8064
	ds_load_u8 v111, v106 offset:7808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v111, v90, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v90, v90, 16, v89
	ds_load_u8 v89, v106 offset:6528
	ds_load_u8 v111, v106 offset:6272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v111, v89, 0xc0c0004
	ds_load_u8 v111, v106 offset:7040
	ds_load_u8 v106, v106 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v106, v111, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v89, v106, 16, v89
	v_wmma_i32_16x16x16_iu4 v[57:64], v[89:90], v[93:94], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[89:90], v[95:96], v[33:40] neg_lo:[1,1,0]
...
.LBB0_9:
	.loc	1 1003 18                       ; ragged.py:1003:18
	v_or_b32_e32 v65, s33, v103
	.loc	1 1098 21                       ; ragged.py:1098:21
	v_add_lshl_u32 v66, s8, v103, 1
	...
	.loc	1 1109 17                       ; ragged.py:1109:17
	v_lshl_add_u32 v8, v105, 2, 0
	.loc	1 1095 19                       ; ragged.py:1095:19
	v_cvt_f32_i32_e32 v80, v3
	.loc	1 1239 26                       ; ragged.py:1239:26
	v_mul_lo_u32 v3, s23, v103
	.loc	1 1095 19                       ; ragged.py:1095:19
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mul_f32 v47, v47, v8 :: v_dual_add_nc_u32 v6, s4, v3
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v46, v46, v8 :: v_dual_lshlrev_b32 v65, 16, v66
	v_mul_f32_e32 v41, v41, v8
	v_mul_f32_e32 v42, v42, v8
	v_mul_f32_e32 v43, v43, v8
	v_mul_f32_e32 v44, v44, v8
	v_mul_f32_e32 v45, v45, v8
	v_dual_mul_f32 v48, v48, v8 :: v_dual_mul_f32 v53, v53, v9
	...
	v_dual_mul_f32 v60, v60, v8 :: v_dual_mul_f32 v33, v33, v9
	v_dual_mul_f32 v61, v61, v8 :: v_dual_mul_f32 v54, v54, v9
	v_dual_mul_f32 v62, v62, v8 :: v_dual_mul_f32 v35, v35, v9
	v_dual_mul_f32 v63, v63, v8 :: v_dual_mul_f32 v56, v56, v9
	v_dual_mul_f32 v64, v64, v8 :: v_dual_mul_f32 v37, v37, v9
	.loc	1 1104 36                       ; ragged.py:1104:36
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v34, v34, v9 :: v_dual_mul_f32 v27, v27, v10
	v_dual_mul_f32 v36, v36, v9 :: v_dual_mul_f32 v29, v29, v10
	v_dual_mul_f32 v38, v38, v9 :: v_dual_mul_f32 v31, v31, v10
	v_dual_mul_f32 v39, v39, v9 :: v_dual_mul_f32 v26, v26, v10
	v_dual_mul_f32 v40, v40, v9 :: v_dual_mul_f32 v67, v18, v10
	...
	.loc	1 1109 17                       ; ragged.py:1109:17
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v50, v50, v8 :: v_dual_mul_f32 v33, v33, v15
	v_dual_mul_f32 v34, v34, v16 :: v_dual_mul_f32 v25, v25, v7
	v_dual_mul_f32 v36, v36, v18 :: v_dual_mul_f32 v27, v27, v9
	v_dual_mul_f32 v41, v41, v7 :: v_dual_mul_f32 v42, v42, v8
	v_dual_mul_f32 v52, v52, v10 :: v_dual_mul_f32 v35, v35, v17
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v54, v54, v12 :: v_dual_mul_f32 v37, v37, v19
	v_dual_mul_f32 v38, v38, v20 :: v_dual_mul_f32 v29, v29, v11
	.loc	1 1239 17                       ; ragged.py:1239:17
	v_bfe_u32 v95, v33, 16, 1
	v_bfe_u32 v96, v34, 16, 1
	v_bfe_u32 v98, v36, 16, 1
	.loc	1 1109 17                       ; ragged.py:1109:17
	v_dual_mul_f32 v43, v43, v9 :: v_dual_mul_f32 v44, v44, v10
	v_dual_mul_f32 v64, v64, v22 :: v_dual_mul_f32 v55, v55, v13
	v_dual_mul_f32 v49, v49, v7 :: v_dual_mul_f32 v56, v56, v14
	v_dual_mul_f32 v39, v39, v21 :: v_dual_mul_f32 v40, v40, v22
	...
	.loc	1 1109 17                       ; ragged.py:1109:17
	v_dual_mul_f32 v45, v45, v11 :: v_dual_mul_f32 v26, v26, v8
	...
	v_add3_u32 v41, v41, v65, 0x7fff
	v_add3_u32 v42, v42, v71, 0x7fff
	v_add3_u32 v35, v35, v97, 0x7fff
	v_add3_u32 v37, v37, v99, 0x7fff
	v_add3_u32 v38, v38, v100, 0x7fff
	v_cndmask_b16 v33.l, 0x7fff, v33.h, s29
	v_cndmask_b16 v33.h, 0x7fff, v34.h, s30
	...
	v_cndmask_b16 v35.l, 0x7fff, v37.h, s34
	v_cndmask_b16 v35.h, 0x7fff, v38.h, s35
	v_bfe_u32 v37, v25, 16, 1
	v_add3_u32 v38, v39, v101, 0x7fff
	...
	.loc	1 1239 17                       ; ragged.py:1239:17
	v_cndmask_b16 v37.h, 0x7fff, v38.h, s5
	...
	.loc	1 1109 17                       ; ragged.py:1109:17
	v_dual_mul_f32 v46, v46, v12 :: v_dual_mul_f32 v47, v47, v13
	...
	v_add3_u32 v44, v44, v73, 0x7fff
	v_add3_u32 v45, v45, v74, 0x7fff
	v_add3_u32 v46, v46, v75, 0x7fff
	v_add3_u32 v47, v47, v76, 0x7fff
	v_add3_u32 v48, v48, v77, 0x7fff
	...
	v_cndmask_b16 v42.h, 0x7fff, v44.h, s8
	v_cndmask_b16 v43.l, 0x7fff, v45.h, s9
	v_cndmask_b16 v43.h, 0x7fff, v46.h, s10
	v_cndmask_b16 v44.l, 0x7fff, v47.h, s11
	v_cndmask_b16 v44.h, 0x7fff, v48.h, s12
	...
	v_cndmask_b32_e64 v14, v43, v41, s5
	v_cndmask_b32_e64 v15, v41, v43, s5
	v_cndmask_b32_e64 v16, v44, v42, s5
	v_cndmask_b32_e64 v17, v42, v44, s5
	...
	v_cndmask_b16 v45.l, 0x7fff, v57.h, s13
	v_cndmask_b16 v45.h, 0x7fff, v58.h, s14
	v_cndmask_b16 v46.l, 0x7fff, v59.h, s15
	v_cndmask_b16 v46.h, 0x7fff, v60.h, s16
	v_cndmask_b16 v47.l, 0x7fff, v61.h, s17
	v_cndmask_b16 v47.h, 0x7fff, v62.h, s18
	v_cndmask_b16 v48.l, 0x7fff, v63.h, s19
	v_cndmask_b16 v48.h, 0x7fff, v64.h, s20
	...
	v_cndmask_b32_e64 v19, v45, v47, s5
	v_cndmask_b32_e64 v21, v46, v48, s5
	v_cndmask_b32_e64 v24, v49, v51, s5
	v_cndmask_b32_e64 v38, v35, v33, s5
	v_cndmask_b32_e64 v33, v33, v35, s5
	v_lshl_or_b32 v10, v10, 4, v10
	v_lshl_or_b32 v11, v11, 4, v11
	s_mov_b32 s6, 0x76543210
	v_cndmask_b32_e64 v18, v47, v45, s5
	v_cndmask_b32_e64 v20, v48, v46, s5
	v_cndmask_b32_e64 v22, v51, v49, s5
	v_cndmask_b32_e64 v36, v50, v52, s5
	v_cndmask_b32_e64 v35, v25, v34, s5
	v_cndmask_b32_e64 v25, v34, v25, s5
	v_cndmask_b32_e64 v34, v28, v37, s5
	v_cndmask_b32_e64 v28, v37, v28, s5
	v_cndmask_b32_e64 v37, v27, v26, s5
	...
	v_permlanex16_b32 v24, v33, s6, 0xfedcba98 op_sel:[1,0]
	v_and_b32_e32 v44, 0x5040504, v10
	v_and_b32_e32 v45, 0x7060706, v11
	v_cndmask_b32_e64 v32, v52, v50, s5
	v_permlanex16_b32 v21, v36, s6, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v36, v8, s6, 0xfedcba98 op_sel:[1,0]
	...
	v_perm_b32 v19, v24, v38, v44
	v_perm_b32 v20, v24, v38, v45
	...
	v_perm_b32 v21, v25, v35, v44
	v_perm_b32 v22, v25, v35, v45
	v_perm_b32 v23, v28, v34, v44
	v_perm_b32 v24, v28, v34, v45
	v_perm_b32 v25, v26, v37, v44
	v_perm_b32 v26, v26, v37, v45
	...
	.loc	1 1239 17                       ; ragged.py:1239:17
	v_perm_b32 v33, v36, v41, v44
	v_perm_b32 v34, v36, v41, v45
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_pc_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 125
