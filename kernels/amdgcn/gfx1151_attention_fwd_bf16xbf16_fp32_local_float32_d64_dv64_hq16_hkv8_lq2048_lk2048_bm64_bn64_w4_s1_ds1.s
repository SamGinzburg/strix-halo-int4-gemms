...
.Ltmp0:
	...
	.loc	1 787 26                        ; attention.py:787:26
	v_mad_u64_u32 v[142:143], null, s82, 48, v[130:131]
	v_lshl_add_u32 v143, s82, 4, v130
	...
	v_add_lshl_u32 v3, v131, s8, 1
	v_add_lshl_u32 v4, v142, s8, 1
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshr_b32 s8, s4, 28
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v4, s14, v25
	s_add_i32 s15, s3, s8
	...
	v_dual_mov_b32 v58, v57 :: v_dual_add_nc_u32 v157, s13, v4
	v_dual_mov_b32 v61, v57 :: v_dual_lshlrev_b32 v4, 7, v28
	v_dual_mov_b32 v60, v57 :: v_dual_lshlrev_b32 v5, 6, v70
	v_dual_mov_b32 v63, v57 :: v_dual_lshlrev_b32 v6, 4, v65
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v2, 32, v25
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v154, s12, v1
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v158, s13, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v4, v5, v6
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, 48, v25
	v_dual_mov_b32 v59, v57 :: v_dual_add_nc_u32 v2, s14, v2
	...
	v_dual_mov_b32 v19, v57 :: v_dual_add_nc_u32 v160, s13, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v64, v57 :: v_dual_add_nc_u32 v1, 0, v1
	v_or_b32_e32 v161, v6, v4
	v_lshl_add_u32 v4, s11, 4, v7
	...
	v_dual_mov_b32 v23, v57 :: v_dual_add_nc_u32 v2, v4, v129
	v_or_b32_e32 v9, 2, v129
	v_lshl_add_u32 v5, s11, 5, v7
	v_dual_mov_b32 v21, v57 :: v_dual_add_nc_u32 v162, v7, v129
	...
	s_and_b32 s0, s15, -16
	v_xor_b32_e32 v3, 16, v161
	s_sub_i32 s0, s3, s0
	.loc	1 818 13                        ; attention.py:818:13
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v2, off offset:8
	scratch_store_b32 off, v68, off offset:200
	v_dual_mov_b32 v151, 0xff800000 :: v_dual_add_nc_u32 v2, v4, v13
	...
	v_dual_mov_b32 v149, 0xff800000 :: v_dual_add_nc_u32 v2, v4, v15
	...
	v_dual_mov_b32 v147, 0xff800000 :: v_dual_add_nc_u32 v2, v4, v16
	...
	v_add_nc_u32_e32 v2, v5, v129
	v_and_b32_e32 v10, 0x180, v4
	v_and_b32_e32 v4, 0x630, v67
	...
	v_cndmask_b32_e64 v2, 0x1054, v4, s0
	v_mov_b32_e32 v148, 0xff800000
	v_cndmask_b32_e64 v4, 0x3276, v8, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s103, s97, s83
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s66, s99, s83
	.loc	1 853 32                        ; attention.py:853:32
	s_mul_i32 s0, s103, s82
	.loc	1 881 25                        ; attention.py:881:25
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 854 32                        ; attention.py:854:32
	v_add_lshl_u32 v66, s0, v143, 1
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 104
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 220
