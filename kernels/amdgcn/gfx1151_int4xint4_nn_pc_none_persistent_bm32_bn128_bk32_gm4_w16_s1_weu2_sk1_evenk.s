	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp15:
	...
	s_cmp_gt_i32 s15, 1
	v_dual_mov_b32 v8, 0x7632 :: v_dual_add_nc_u32 v25, 0, v7
...
.Ltmp16:
	...
	v_and_b32_e32 v24, 0x7060706, v8
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_or_b32_e32 v22, 14, v13
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_mad_u64_u32 v[8:9], null, s35, v2, v[1:2]
	s_mul_i32 s6, s6, s5
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v31, s10, v17
	v_or_b32_e32 v33, s10, v18
	v_or_b32_e32 v34, s10, v19
	...
	v_dual_mul_f32 v35, v32, v35 :: v_dual_lshlrev_b32 v36, 16, v36
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v3, v35, v3 :: v_dual_lshlrev_b32 v34, 16, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v37, v32, v37
	v_dual_mul_f32 v6, v32, v6 :: v_dual_lshlrev_b32 v33, 16, v33
	...
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v0, v37, v0 :: v_dual_mul_f32 v33, v32, v33
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v7, 16, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v4, v34, v4 :: v_dual_lshlrev_b32 v31, 16, v31
	v_mul_f32_e32 v6, v6, v30
	v_dual_mul_f32 v2, v33, v2 :: v_dual_mul_f32 v7, v32, v7
	...
	v_dual_mul_f32 v10, v31, v10 :: v_dual_mul_f32 v1, v32, v1
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	...
	v_perm_b32 v0, v2, v3, v23
	v_perm_b32 v1, v2, v3, v24
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v1, s6, 7, v8
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s4, v12
	s_lshl_b32 s5, s5, 7
	s_delay_alu instid0(VALU_DEP_3) | instid1(SALU_CYCLE_1)
	v_subrev_nc_u32_e32 v30, s5, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b32 v35, v30, s[20:23], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b32 v28, v35
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 266 27                        ; generate_amdgcn.py:266:27
	ds_load_u8 v11, v29 offset:640
	ds_load_u8 v35, v29 offset:896
	ds_load_u8 v36, v29 offset:768
	ds_load_u8 v37, v29 offset:512
	ds_load_u8 v38, v29 offset:128
	ds_load_u8 v39, v29 offset:384
	ds_load_u8 v40, v29 offset:256
	ds_load_u8 v41, v29
	ds_load_u8 v42, v29 offset:1664
	ds_load_u8 v43, v29 offset:1920
	ds_load_u8 v44, v29 offset:1792
	ds_load_u8 v45, v29 offset:1536
	ds_load_u8 v46, v29 offset:1152
	ds_load_u8 v47, v29 offset:1280
	ds_load_u8 v48, v29 offset:1024
	ds_load_u8 v49, v29 offset:1408
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v11, v37, v11, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v37, v41, v38, 0xc0c0004
	v_perm_b32 v38, v40, v39, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v36, v35, 16, v11
	s_waitcnt lgkmcnt(5)
	...
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v41, v48, v46, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v47, v49, 0xc0c0004
	v_lshl_or_b32 v38, v40, 16, v39
	v_wmma_i32_16x16x16_iu4 v[0:7], v[35:36], v[31:32], v[0:7] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 50
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.kd
