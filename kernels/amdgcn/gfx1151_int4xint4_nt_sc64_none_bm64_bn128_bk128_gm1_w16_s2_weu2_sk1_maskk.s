	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow88
	...
	v_dual_mov_b32 v21, 0 :: v_dual_and_b32 v28, 0xe0, v0
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v34, 16, v5
	v_bfe_u32 v29, v0, 4, 1
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v30, 5, v33
	v_dual_mov_b32 v20, 0 :: v_dual_lshlrev_b32 v31, 1, v0
	v_dual_mov_b32 v15, 0 :: v_dual_lshlrev_b32 v32, 4, v28
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v43, 0, v6
	v_add_nc_u32_e32 v44, 0, v7
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v45, 0, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v66, v92, v66 :: v_dual_mul_f32 v51, v91, v51
	v_mul_f32_e32 v52, v91, v52
	v_mul_f32_e32 v53, v91, v53
	v_mul_f32_e32 v55, v91, v55
	v_dual_mul_f32 v57, v91, v57 :: v_dual_mul_f32 v64, v92, v64
	v_dual_mul_f32 v58, v91, v58 :: v_dual_mul_f32 v59, v92, v59
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v63, v92, v63 :: v_dual_fmac_f32 v26, v59, v68
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v74, 16, v74
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v22, v54, v71
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v18, v56, v73 :: v_dual_lshlrev_b32 v67, 16, v67
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v65, v92, v65
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v11, v51, v68 :: v_dual_fmac_f32 v24, v60, v69
	v_dual_fmac_f32 v25, v52, v69 :: v_dual_fmac_f32 v20, v62, v71
	v_dual_fmac_f32 v23, v53, v70 :: v_dual_fmac_f32 v16, v64, v73
	v_dual_fmac_f32 v19, v55, v72 :: v_dual_fmac_f32 v12, v66, v67
	v_dual_fmac_f32 v15, v57, v74 :: v_dual_fmac_f32 v14, v58, v67
	v_fmac_f32_e32 v21, v61, v70
	v_fmac_f32_e32 v17, v63, v72
...
; %bb.7:
	...
	v_dual_mov_b32 v50, s11 :: v_dual_and_b32 v1, 24, v31
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[30:33], v3 offset0:8 offset1:10
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	...
	ds_load_2addr_stride64_b64 v[34:37], v7 offset0:8 offset1:10
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	v_xad_u32 v1, v1, 24, 0
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v2, v2, 24, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v45, s6 :: v_dual_mov_b32 v44, s5
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[61:62], v[30:31], v[43:50] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[43:50], v[61:62], v[32:33], v[43:50] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[59:60], v[34:35], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[43:50], v[59:60], v[36:37], v[43:50] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[9:10], v[51:52], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[43:50], v[9:10], v[53:54], v[43:50] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[63:64], v[55:56], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[43:50], v[63:64], v[57:58], v[43:50] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
...
.LBB0_8:
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v37, v37, v46 :: v_dual_add_nc_u32 v32, 12, v28
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v9, v9, v46 :: v_dual_add_nc_u32 v44, 20, v28
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	buffer_load_u16 v30, v30, s[20:23], 0 offen
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v36, v36, v46 :: v_dual_add_nc_u32 v43, 16, v28
	v_dual_mul_f32 v10, v10, v46 :: v_dual_add_nc_u32 v45, 24, v28
	v_dual_mul_f32 v33, v33, v46 :: v_dual_add_nc_u32 v28, 28, v28
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	v_dual_mul_f32 v3, v3, v41 :: v_dual_mul_f32 v38, v38, v46
	...
	v_fma_f32 v5, v5, v40, v19
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v50.l, v11.h
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v3, v3, v31, v23
	v_fma_f32 v26, v37, v31, v21
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e64 s0, v10, v10
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v7, v7, v41, v15
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_bfe_u32 v19, v5, 16, 1
	v_cmp_o_f32_e64 s7, v5, v5
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v9, v9, v40, v17
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v30, v36, v30, v24
	v_fma_f32 v8, v8, v28, v14
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_bfe_u32 v22, v7, 16, 1
	v_cmp_o_f32_e64 s11, v7, v7
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v29, v33, v32, v16
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_dual_cndmask_b32 v10, 0x1054, v42 :: v_dual_and_b32 v19, 1, v53
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 94
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
