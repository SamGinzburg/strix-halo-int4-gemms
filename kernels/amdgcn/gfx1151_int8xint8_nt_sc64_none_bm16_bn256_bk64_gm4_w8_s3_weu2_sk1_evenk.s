	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e64 v26, 0x80000000, v6, s3
	v_cndmask_b32_e64 v2, 0x80000000, v2, s2
	v_cndmask_b32_e64 v34, 0x80000000, v8, s2
	s_clause 0x1
	buffer_load_b128 v[5:8], v12, s[4:7], 0 offen
	buffer_load_b128 v[18:21], v4, s[4:7], 0 offen
	v_cndmask_b32_e64 v4, 0x80000000, v11, s2
	v_cndmask_b32_e64 v11, 0x80000000, v30, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v1, v1, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[22:25], v13, s[4:7], 0 offen
	buffer_load_b128 v[26:29], v26, s[4:7], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v12, v31, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[30:33], v2, s[4:7], 0 offen
	buffer_load_b128 v[34:37], v34, s[4:7], 0 offen
	buffer_load_b128 v[38:41], v4, s[4:7], 0 offen
	buffer_load_b128 v[48:51], v11, s[4:7], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v46, v11, v4
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v47, v3, v13
	v_lshlrev_b32_e32 v4, 3, v0
	v_lshlrev_b32_e32 v3, 6, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v11, 0, v46
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v13, 0, v47
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(7)
	ds_store_b32 v11, v1 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v11, v12 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v13, v[30:33] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v13, v[34:37] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v13, v[38:41] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v13, v[48:51] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_and_b32_e32 v6, 0x1c00, v1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_or_b32_e32 v37, v3, v5
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_or3_b32 v41, v5, v6, v3
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s22, s16
	s_mov_b32 s23, s16
	v_and_b32_e32 v2, 0x1c00, v45
	v_or_b32_e32 v37, v3, v1
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v49, 0, v11
	v_dual_mov_b32 v21, 0 :: v_dual_mov_b32 v22, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v41, v1, v2, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	buffer_load_u16 v127, v51, s[40:43], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v128, v50, s[36:39], 0 offen
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v50, s20, v9
	v_add_nc_u32_e32 v51, s20, v14
	.loc	1 376 22 is_stmt 0              ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[66:69], v50, s[4:7], 0 offen
	buffer_load_b128 v[70:73], v51, s[4:7], 0 offen
	buffer_load_b128 v[74:77], v52, s[4:7], 0 offen
	buffer_load_b128 v[78:81], v53, s[4:7], 0 offen
	s_mov_b32 s18, s14
	s_mov_b32 s14, s1
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	...
	v_add_nc_u32_e32 v53, s18, v38
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v54, s1, v41
	v_add_nc_u32_e32 v55, s1, v42
	v_add_nc_u32_e32 v56, s1, v43
	v_add_nc_u32_e32 v57, s1, v44
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_add_i32 s18, s17, 1
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_lshl_b32 s19, s44, 14
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_lshl_b32 s1, s44, 10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_add_i32 s35, s19, 0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_add_i32 s20, s1, 0
	s_delay_alu instid0(SALU_CYCLE_1)
	v_add_nc_u32_e32 v129, s20, v46
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v65, v65, v98 :: v_dual_add_nc_u32 v130, s35, v47
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v18, v50, v82
	v_dual_fmac_f32 v20, v52, v84 :: v_dual_fmac_f32 v21, v53, v85
	v_dual_fmac_f32 v23, v55, v87 :: v_dual_fmac_f32 v22, v54, v86
	v_dual_fmac_f32 v25, v57, v89 :: v_dual_fmac_f32 v24, v56, v88
	v_dual_fmac_f32 v27, v59, v91 :: v_dual_fmac_f32 v26, v58, v90
	v_dual_fmac_f32 v29, v61, v93 :: v_dual_fmac_f32 v28, v60, v92
	v_dual_fmac_f32 v31, v63, v95 :: v_dual_fmac_f32 v30, v62, v94
	v_dual_fmac_f32 v33, v64, v96 :: v_dual_fmac_f32 v32, v65, v97
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
...
; %bb.9:
	...
	v_add_nc_u32_e32 v4, s16, v41
	ds_load_b128 v[46:49], v2 offset:8192
	ds_load_b128 v[58:61], v2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v2, s14, v40
	v_add_nc_u32_e32 v5, s14, v37
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v3, s16, v42
	ds_load_b128 v[62:65], v4 offset:8192
	...
	ds_load_b128 v[98:101], v10 offset:8192
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[50:57], v[66:69], v[74:77], v[2:9] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[62:65], v[74:77], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[50:57], v[82:85], v[70:73], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[78:81], v[70:73], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[50:57], v[58:61], v[86:89], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[46:49], v[86:89], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[50:57], v[94:97], v[90:93], v[50:57] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[2:9], v[98:101], v[90:93], v[2:9] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.LBB0_10:
	...
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v62, 0, v11
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	v_dual_mov_b32 v72, 0 :: v_dual_add_nc_u32 v63, v1, v13
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v44, v4, v48, v21
	v_fma_f32 v48, v1, v50, v18
	v_fma_f32 v41, v7, v52, v24
	v_fma_f32 v42, v6, v51, v23
	v_fma_f32 v43, v5, v49, v22
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
