	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp17:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:301:26 ]
	s_add_i32 s1, s0, s1
	v_lshl_or_b32 v9, v7, 9, v11
	s_ashr_i32 s42, s1, 5
	s_cmp_gt_i32 s0, 31
	v_xor_b32_e32 v17, v12, v2
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
	ds_store_2addr_b32 v3, v91, v98 offset1:32
	ds_store_2addr_b32 v3, v86, v68 offset0:64 offset1:96
	ds_store_2addr_b32 v18, v97, v96 offset1:32
	ds_store_2addr_b32 v18, v75, v65 offset0:64 offset1:96
	ds_store_2addr_b32 v19, v95, v94 offset1:32
	ds_store_2addr_b32 v19, v66, v62 offset0:64 offset1:96
	ds_store_2addr_b32 v20, v93, v92 offset1:32
	ds_store_2addr_b32 v20, v63, v59 offset0:64 offset1:96
	ds_store_2addr_b32 v21, v90, v89 offset1:32
	ds_store_2addr_b32 v21, v61, v57 offset0:64 offset1:96
	ds_store_2addr_b32 v22, v88, v87 offset1:32
	ds_store_2addr_b32 v22, v58, v55 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v24, v53, v49 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v26, v50, v45 offset0:64 offset1:96
	ds_store_2addr_b32 v27, v77, v76 offset1:32
	ds_store_2addr_b32 v27, v48, v42 offset0:64 offset1:96
	ds_store_2addr_b32 v28, v74, v73 offset1:32
	ds_store_2addr_b32 v28, v46, v40 offset0:64 offset1:96
	ds_store_2addr_b32 v29, v72, v70 offset1:32
	ds_store_2addr_b32 v29, v44, v39 offset0:64 offset1:96
	ds_store_2addr_b32 v30, v71, v67 offset1:32
	ds_store_2addr_b32 v30, v43, v37 offset0:64 offset1:96
	ds_store_2addr_b32 v31, v69, v64 offset1:32
	ds_store_2addr_b32 v31, v41, v36 offset0:64 offset1:96
	v_add_nc_u32_e32 v3, 0, v10
	ds_store_2addr_b32 v32, v60, v54 offset1:32
	ds_store_2addr_b32 v32, v38, v5 offset0:64 offset1:96
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v3, v3
	ds_load_b32 v4, v33
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	v_dual_mov_b32 v72, 0 :: v_dual_mov_b32 v93, 0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v91, 0 :: v_dual_add_nc_u32 v4, s49, v7
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v95, v156, v145 :: v_dual_fmac_f32 v88, v159, v148
	v_dual_fmac_f32 v93, v157, v146 :: v_dual_mul_f32 v162, v187, v143
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x5
	...
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v160, v185, v143 :: v_dual_lshlrev_b32 v149, 16, v149
	v_mul_f32_e32 v163, v188, v143
	v_mul_f32_e32 v164, v189, v143
	v_mul_f32_e32 v161, v186, v143
	...
	s_waitcnt vmcnt(13)
	v_dual_mul_f32 v139, v139, v143 :: v_dual_lshlrev_b32 v152, 16, v152
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(12)
	...
	v_dual_fmac_f32 v79, v163, v152 :: v_dual_lshlrev_b32 v146, 16, v146
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	v_lshlrev_b32_e32 v151, 16, v151
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(8)
	v_dual_fmac_f32 v77, v164, v153 :: v_dual_lshlrev_b32 v158, 16, v158
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(7)
	v_lshlrev_b32_e32 v154, 16, v154
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(6)
	v_dual_fmac_f32 v60, v170, v146 :: v_dual_lshlrev_b32 v155, 16, v155
	v_fmac_f32_e32 v81, v162, v151
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x1
	...
	v_dual_fmac_f32 v83, v161, v150 :: v_dual_fmac_f32 v72, v167, v155
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x3
	...
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v169, v193, v143 :: v_dual_lshlrev_b32 v148, 16, v148
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_fmac_f32_e32 v71, v168, v145
	.loc	1 328 22 is_stmt 1              ; generate_amdgcn.py:328:22
	v_lshlrev_b32_e32 v149, 16, v149
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v165, v190, v143 :: v_dual_lshlrev_b32 v160, 16, v160
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_fmac_f32_e32 v98, v171, v157
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v179, v203, v143 :: v_dual_fmac_f32 v92, v174, v148
	.loc	1 328 22 is_stmt 1              ; generate_amdgcn.py:328:22
	s_clause 0x1
	buffer_load_u16 v148, v103, s[36:39], 0 offen offset:192
	buffer_load_u16 v174, v103, s[36:39], 0 offen offset:196
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_fmac_f32_e32 v74, v165, v154
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x2
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(20)
	v_dual_fmac_f32 v82, v178, v150 :: v_dual_lshlrev_b32 v153, 16, v153
	v_dual_fmac_f32 v80, v179, v161 :: v_dual_lshlrev_b32 v147, 16, v147
	v_fmac_f32_e32 v84, v177, v160
	v_fmac_f32_e32 v69, v169, v156
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x3
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_fmac_f32_e32 v76, v104, v162
	v_fmac_f32_e32 v78, v144, v151
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x3
	...
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v122, v122, v143 :: v_dual_fmac_f32 v73, v105, v152
	v_dual_mul_f32 v124, v124, v143 :: v_dual_fmac_f32 v67, v107, v153
	v_dual_mul_f32 v126, v126, v143 :: v_dual_fmac_f32 v75, v111, v166
	v_dual_mul_f32 v128, v128, v143 :: v_dual_fmac_f32 v61, v114, v145
	v_dual_mul_f32 v132, v132, v143 :: v_dual_fmac_f32 v51, v118, v146
	v_dual_mul_f32 v136, v136, v143 :: v_dual_fmac_f32 v65, v127, v174
	v_dual_mul_f32 v138, v138, v143 :: v_dual_fmac_f32 v41, v124, v158
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v64, v108, v164 :: v_dual_add_nc_u32 v99, s46, v99
	v_fmac_f32_e32 v54, v109, v165
	v_dual_fmac_f32 v70, v106, v163 :: v_dual_fmac_f32 v55, v131, v176
	v_fmac_f32_e32 v86, v110, v154
	v_dual_fmac_f32 v58, v115, v168 :: v_dual_fmac_f32 v63, v113, v167
	v_fmac_f32_e32 v50, v119, v170
	v_fmac_f32_e32 v48, v120, v157
	v_fmac_f32_e32 v38, v125, v173
	v_fmac_f32_e32 v68, v126, v148
	.loc	1 328 22 is_stmt 1              ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(15)
	v_lshlrev_b32_e32 v156, 16, v156
	s_waitcnt vmcnt(14)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(2)
	v_dual_fmac_f32 v52, v132, v160 :: v_dual_lshlrev_b32 v151, 16, v151
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v42, v136, v161 :: v_dual_lshlrev_b32 v103, 16, v103
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v142, 16, v142
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v130, v130, v143 :: v_dual_fmac_f32 v53, v117, v169
	v_dual_mul_f32 v134, v134, v143 :: v_dual_fmac_f32 v43, v123, v172
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v140, v140, v143 :: v_dual_fmac_f32 v57, v130, v149
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v66, v112, v155 :: v_dual_fmac_f32 v49, v133, v177
	v_fmac_f32_e32 v56, v116, v156
	v_dual_fmac_f32 v46, v121, v171 :: v_dual_fmac_f32 v47, v134, v150
	v_dual_fmac_f32 v44, v122, v147 :: v_dual_fmac_f32 v45, v135, v178
	v_dual_fmac_f32 v62, v128, v159 :: v_dual_fmac_f32 v39, v138, v144
	v_fmac_f32_e32 v59, v129, v175
	v_fmac_f32_e32 v40, v137, v179
	v_fmac_f32_e32 v37, v139, v151
	v_dual_fmac_f32 v36, v140, v103 :: v_dual_fmac_f32 v5, v141, v142
	.loc	1 307 13 is_stmt 1              ; generate_amdgcn.py:307:13
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_vgpr, 204
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     55
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.kd
