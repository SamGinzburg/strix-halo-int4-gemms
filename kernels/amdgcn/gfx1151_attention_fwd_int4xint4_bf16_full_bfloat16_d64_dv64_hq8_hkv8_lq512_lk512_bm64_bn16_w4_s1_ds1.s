...
.Ltmp0:
	...
	v_lshl_or_b32 v38, v44, 4, v44
	.loc	1 585 26                        ; attention.py:585:26
	v_cmp_eq_u32_e64 s0, 0, v55
	v_mov_b32_e32 v0, v24
	v_add3_u32 v78, s6, v78, v39
	v_and_b32_e32 v81, 0x7050301, v40
	v_and_b32_e32 v82, 0x7050301, v38
	...
	ds_bpermute_b32 v39, v59, v35
	ds_bpermute_b32 v35, v67, v35
	ds_bpermute_b32 v38, v59, v36
	...
	v_dual_mov_b32 v6, v24 :: v_dual_and_b32 v51, 0x5040504, v33
	v_and_b32_e32 v52, 0x7060706, v34
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 717 33                        ; attention.py:717:33
	v_dual_mov_b32 v34, v32 :: v_dual_add_nc_u32 v95, s33, v56
	.loc	1 771 36                        ; attention.py:771:36
	s_lshr_b32 s5, s33, 1
	.loc	1 717 33                        ; attention.py:717:33
	v_mov_b32_e32 v39, v32
	v_dual_mov_b32 v33, v32 :: v_dual_add_nc_u32 v106, s5, v58
	v_mov_b32_e32 v35, v32
	v_mov_b32_e32 v37, v32
	v_mov_b32_e32 v38, v32
	.loc	1 761 36                        ; attention.py:761:36
	v_add_lshl_u32 v105, v78, s33, 1
	.loc	1 717 33                        ; attention.py:717:33
	...
	s_barrier
	.loc	1 727 37                        ; attention.py:727:37
	v_add_lshl_u32 v93, s33, v60, 1
	v_add_lshl_u32 v94, s33, v61, 1
	.loc	1 797 41                        ; attention.py:797:41
	v_cndmask_b32_e64 v107, 0x80000000, v38, s4
	.loc	1 727 37                        ; attention.py:727:37
	v_add_lshl_u32 v40, s33, v62, 1
	v_add_lshl_u32 v88, s33, v63, 1
	v_add_lshl_u32 v89, s33, v64, 1
	v_add_lshl_u32 v90, s33, v65, 1
	v_add_lshl_u32 v91, s33, v66, 1
	...
	v_or_b16 v33.l, v34.l, -16
	.loc	1 762 35                        ; attention.py:762:35
	ds_bpermute_b32 v99, v59, v105
	ds_bpermute_b32 v98, v67, v98
	ds_bpermute_b32 v100, v59, v101
	ds_bpermute_b32 v95, v67, v95
	.loc	1 787 30                        ; attention.py:787:30
	...
	v_dual_fmac_f32 v105, s38, v92 :: v_dual_mul_f32 v92, 0x3fb8aa3b, v38
	.loc	1 761 36                        ; attention.py:761:36
	v_lshlrev_b32_e32 v38, 16, v99
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v99.h, v53.l
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v92, s38, v93
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 762 35                        ; attention.py:762:35
	v_dual_mul_f32 v93, 0x3fb8aa3b, v39 :: v_dual_fmac_f32 v98, s38, v89
	v_dual_mul_f32 v89, 0x3fb8aa3b, v40 :: v_dual_fmac_f32 v94, s38, v103
	.loc	1 814 30                        ; attention.py:814:30
	v_cndmask_b16 v103.h, 0x7fff, v111.h, s14
	v_cndmask_b16 v103.l, 0x7fff, v109.h, s13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v93, s38, v104
	v_dual_fmac_f32 v89, s38, v90 :: v_dual_and_b32 v90, 0xffff0000, v95
	...
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v95, s38, v91
	.loc	1 763 25                        ; attention.py:763:25
	ds_bpermute_b32 v90, v59, v90
	ds_bpermute_b32 v37, v67, v37
	.loc	1 814 30                        ; attention.py:814:30
	...
	ds_store_2addr_b32 v71, v103, v96 offset1:8
	ds_store_2addr_b32 v71, v33, v88 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 763 25                        ; attention.py:763:25
