	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
.Lfunc_begin0:
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v147, s34, v166 :: v_dual_mul_f32 v148, s34, v167
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v158, s34, v173
	v_mul_f32_e32 v159, s34, v65
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v65, s2, v91, 1
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v161, s34, v70 :: v_dual_mul_f32 v162, s34, v71
	v_mul_f32_e32 v160, s34, v69
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v163, s34, v72 :: v_dual_mul_f32 v164, s34, v73
	v_dual_mul_f32 v165, s34, v74 :: v_dual_mul_f32 v166, s34, v75
	v_mul_f32_e32 v167, s34, v76
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[81:88], v[150:157], v[57:64], v[81:88]
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v153, s34, v66
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v66, s2, v146, 1
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v156, s34, v67
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v67, s2, v92, 1
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v157, s34, v68
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v68, s2, v145, 1
	v_cndmask_b32_e64 v66, 0x80000000, v66, s1
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v150, s34, v168
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v67, 0x80000000, v67, s1
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v151, s34, v169 :: v_dual_mul_f32 v152, s34, v170
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v70, 0x80000000, v68, s1
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v154, s34, v171 :: v_dual_mul_f32 v155, s34, v172
	v_dual_mul_f32 v168, s34, v77 :: v_dual_mul_f32 v169, s34, v78
	v_dual_mul_f32 v170, s34, v79 :: v_dual_mul_f32 v171, s34, v80
	v_mul_f32_e32 v172, s34, v81
	.loc	1 890 30                        ; attention.py:890:30
	s_clause 0x3
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v173, s34, v82 :: v_dual_mul_f32 v174, s34, v83
	.loc	1 890 30                        ; attention.py:890:30
	v_add_nc_u32_e32 v65, 0, v100
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v175, s34, v86 :: v_dual_mul_f32 v176, s34, v87
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v154, 0xff800000, v154, s0
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v84, s34, v84 :: v_dual_mul_f32 v85, s34, v85
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt vmcnt(3)
...
.Ltmp22:
	...
	v_permlanex16_b32 v150, v147, s33, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp23:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v166, v148, s33, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1)
...
.Ltmp59:
	...
	v_permlanex16_b32 v150, v149, s33, 0xfedcba98 op_sel:[1,0]
.Ltmp60:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp62:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 177
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.kd
