...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v20, v48, v69 :: v_dual_fmac_f32 v11, v57, v58
	v_fmac_f32_e32 v26, v50, v59
...
.LBB0_8:
	...
	buffer_load_u16 v47, v30, s[4:7], 0 offen
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v35, v35, v27 :: v_dual_lshlrev_b32 v30, 2, v0
	...
	v_lshlrev_b32_e32 v29, 6, v49
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v39, v39, v27 :: v_dual_and_b32 v0, 0x840, v0
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[28:29], null, s35, 24, v[27:28]
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[29:30], null, s35, 40, v[27:28]
	v_mad_u64_u32 v[30:31], null, s35, 48, v[27:28]
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_add_nc_u32_e32 v67, 0, v0
	v_xad_u32 v68, 0x2010, v0, 0
	v_xad_u32 v69, 0x4020, v0, 0
	v_xad_u32 v70, 0x6030, v0, 0
	v_add_nc_u32_e32 v31, 0, v9
	v_xad_u32 v51, v9, 8, 0
	v_xad_u32 v52, v9, 16, 0
	v_xad_u32 v61, v9, 24, 0
	v_xad_u32 v62, v9, 32, 0
	v_xad_u32 v64, v9, 40, 0
	v_xad_u32 v65, v9, 48, 0
	v_xad_u32 v66, v9, 56, 0
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v59, s35, v59
	v_mul_lo_u32 v58, s35, v58
	v_mul_lo_u32 v57, s35, v57
	v_mul_lo_u32 v56, s35, v56
	v_lshl_add_u32 v60, s35, 3, v27
	v_mul_lo_u32 v55, s35, v55
	v_lshl_add_u32 v63, s35, 4, v27
	v_mul_lo_u32 v54, s35, v54
	v_lshl_add_u32 v50, s35, 5, v27
	v_mul_lo_u32 v53, s35, v53
	.loc	1 247 9 is_stmt 0               ; generate_amdgcn.py:247:9
	s_and_b32 s21, s21, 0xffff
	s_mov_b32 s22, s6
	s_mov_b32 s23, s7
	v_add_lshl_u32 v29, v49, v29, 2
	v_add_lshl_u32 v30, v49, v30, 2
	...
	v_fma_f32 v4, v4, v13, v24
	v_fma_f32 v5, v5, v41, v23
	v_fma_f32 v34, v35, v13, v17
	v_fma_f32 v7, v7, v43, v21
	v_fma_f32 v35, v36, v41, v16
	v_fma_f32 v46, v6, v42, v22
	v_fma_f32 v48, v1, v45, v19
	v_fma_f32 v36, v37, v42, v15
	v_fma_f32 v37, v38, v43, v14
	v_fma_f32 v38, v39, v44, v12
	v_fma_f32 v39, v40, v45, v11
	v_fma_f32 v47, v8, v44, v20
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_cndmask_b32_e64 v5, v17, v34, s2
	v_cndmask_b32_e64 v13, v21, v7, s2
	v_cndmask_b32_e64 v7, v16, v35, s2
	v_cndmask_b32_e64 v8, v22, v46, s2
	v_cndmask_b32_e64 v10, v19, v48, s2
	v_cndmask_b32_e64 v9, v15, v36, s2
	v_cndmask_b32_e64 v14, v14, v37, s2
	v_cndmask_b32_e64 v11, v11, v39, s2
	v_cndmask_b32_e64 v20, v20, v47, s2
	v_cndmask_b32_e64 v21, v12, v38, s2
	ds_store_b64 v31, v[0:1]
	ds_store_b64 v51, v[2:3]
	ds_store_b64 v52, v[4:5]
	ds_store_b64 v61, v[6:7]
	ds_store_b64 v62, v[8:9]
	ds_store_b64 v64, v[13:14]
	ds_store_b64 v65, v[20:21]
	ds_store_b64 v66, v[10:11]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[0:3], v67 offset1:16
	ds_load_2addr_b64 v[4:7], v68 offset1:16
	ds_load_2addr_b64 v[8:11], v69 offset1:16
	ds_load_2addr_b64 v[12:15], v70 offset1:16
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[16:17], null, s35, 56, v[27:28]
	.loc	1 247 9 is_stmt 0               ; generate_amdgcn.py:247:9
	v_add_lshl_u32 v17, v49, v27, 2
	v_add_lshl_u32 v18, v49, v32, 2
	v_add_lshl_u32 v19, v49, v60, 2
	v_add_lshl_u32 v20, v49, v59, 2
	v_add_lshl_u32 v21, v49, v63, 2
	v_add_lshl_u32 v22, v49, v58, 2
	v_add_lshl_u32 v23, v49, v57, 2
	v_add_lshl_u32 v24, v49, v50, 2
	v_add_lshl_u32 v25, v49, v56, 2
	v_add_lshl_u32 v28, v49, v28, 2
	s_waitcnt lgkmcnt(3)
	...
	v_add_lshl_u32 v26, v49, v55, 2
	v_add_lshl_u32 v27, v49, v54, 2
	v_add_lshl_u32 v16, v49, v16, 2
	v_add_lshl_u32 v0, v49, v53, 2
	s_clause 0x4
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.numbered_sgpr, 47
