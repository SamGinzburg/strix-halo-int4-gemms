...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s7, v34, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s18, s18
	s_mul_i32 s22, s22, s18
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_lshl_add_u32 v37, s7, 5, v9
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp15:
	...
	v_or_b32_e32 v1, s18, v35
	v_or_b32_e32 v4, s18, v34
	v_or_b32_e32 v5, s18, v36
.Ltmp16:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_lshr_b32 s4, s4, 26
.Ltmp17:
...
.LBB0_3:                                ; %Flow19
	...
	s_ashr_i32 s1, s24, 6
	v_or_b32_e32 v26, s6, v2
	v_or_b32_e32 v25, s6, v6
	v_or_b32_e32 v24, s6, v7
	v_mul_lo_u32 v27, v18, s1
	v_or_b32_e32 v22, s6, v8
	v_or_b32_e32 v20, s6, v10
	v_or_b32_e32 v23, s6, v3
	v_or_b32_e32 v21, s6, v4
	v_or_b32_e32 v19, s6, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v16, v63, v46 :: v_dual_mul_f32 v59, v57, v59
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v17, v64, v47 :: v_dual_mul_f32 v60, v57, v60
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v57, v57, v65
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v10, v58, v41 :: v_dual_add_nc_u32 v139, s40, v40
	v_dual_fmac_f32 v13, v60, v43 :: v_dual_add_nc_u32 v140, s35, v33
	v_dual_fmac_f32 v12, v59, v42 :: v_dual_fmac_f32 v15, v62, v45
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v11, v57, v48
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.8:
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v7, s36, v42
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v51, s14, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
.LBB0_9:
	...
	v_add_lshl_u32 v38, v20, s0, 1
	v_add_lshl_u32 v39, v23, s0, 1
	v_add_lshl_u32 v40, v21, s0, 1
	v_add_lshl_u32 v41, v19, s0, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
...
; %bb.10:
	...
	v_mov_b32_e32 v42, 0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v50, s34, v30
	v_add_nc_u32_e32 v54, s34, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v44, v49, v46, 0xc0c0004
	v_perm_b32 v46, v48, v47, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v58, s34, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[42:49], v[50:53], v[28:31], v[42:49] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v8, v31, v8, v16
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v12, v10, v12 :: v_dual_lshlrev_b32 v19, 16, v19
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v14, v10, v14 :: v_dual_max_f32 v3, v3, v3
	...
	v_dual_mul_f32 v10, v10, v19 :: v_dual_mul_f32 v5, v5, v5
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v6, v6, v6 :: v_dual_max_f32 v7, v7, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v17, v20, v48, v9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v8, v9, v17, s2
	...
	v_dual_mul_f32 v4, v4, v4 :: v_dual_and_b32 v13, 1, v51
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v9, v9, v9 :: v_dual_mul_f32 v8, v8, v8
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add3_u32 v6, v6, v11, 0x7fff
	v_cndmask_b32_e32 v11, 0x1054, v38, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_cndmask_b32_e32 v12, 0x3276, v39, vcc_lo
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_perm_b32 v0, v3, v10, v2
	v_perm_b32 v1, v3, v10, v4
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 141
