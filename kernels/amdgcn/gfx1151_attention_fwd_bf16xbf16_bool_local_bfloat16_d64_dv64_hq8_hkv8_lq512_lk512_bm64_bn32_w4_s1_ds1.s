	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_and_b32_e32 v97, 16, v98
	.loc	1 759 31                        ; attention.py:759:31
	v_and_b32_e32 v99, 15, v98
	v_and_b32_e32 v100, 0x60, v98
	v_lshlrev_b32_e32 v101, 2, v98
...
; %bb.1:                                ; %.lr.ph
	.loc	1 759 31                        ; attention.py:759:31
	v_lshrrev_b32_e32 v65, 5, v100
	s_clause 0x2
	s_load_b128 s[4:7], s[0:1], 0x64
	s_load_b128 s[52:55], s[0:1], 0x8
	s_load_b64 s[56:57], s[0:1], 0x30
	v_dual_mov_b32 v93, 0 :: v_dual_lshlrev_b32 v22, 7, v99
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v23, 6, v100
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_dual_mov_b32 v86, 0 :: v_dual_add_nc_u32 v11, s10, v11
	v_dual_mov_b32 v82, 0 :: v_dual_add_nc_u32 v7, s10, v7
	v_dual_mov_b32 v87, 0 :: v_dual_add_nc_u32 v12, s10, v12
	...
	v_lshrrev_b32_e32 v23, 3, v100
	v_lshl_or_b32 v4, v100, 4, v4
	v_dual_mov_b32 v84, 0 :: v_dual_and_b32 v5, 0x78, v98
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v6, s58, v66
	v_dual_mov_b32 v124, 0xff800000 :: v_dual_lshlrev_b32 v25, 6, v98
	...
	v_lshrrev_b32_e32 v24, 2, v97
	v_and_b32_e32 v97, 31, v98
	v_bfe_i32 v4, v98, 3, 1
	.loc	1 892 65                        ; attention.py:892:65
	v_cmp_gt_i32_e64 s1, s47, v1
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[106:107], null, s47, v5, v[1:2]
	v_or3_b32 v143, v24, v22, v29
	v_dual_mov_b32 v31, v25 :: v_dual_lshlrev_b32 v22, 3, v98
	...
	v_dual_mov_b32 v96, 0 :: v_dual_add_nc_u32 v17, s10, v17
	...
	v_dual_mov_b32 v94, 0 :: v_dual_add_nc_u32 v19, s10, v19
	...
	v_dual_mov_b32 v85, 0 :: v_dual_add_nc_u32 v14, s10, v14
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s4, s4, 29
	v_dual_mov_b32 v83, 0 :: v_dual_add_nc_u32 v8, s10, v8
	s_add_i32 s4, s3, s4
	v_dual_mov_b32 v88, 0 :: v_dual_add_nc_u32 v9, s10, v9
	v_dual_mov_b32 v81, 0 :: v_dual_add_nc_u32 v10, s10, v10
	v_dual_mov_b32 v92, 0 :: v_dual_add_nc_u32 v13, s10, v13
	v_dual_mov_b32 v90, 0 :: v_dual_add_nc_u32 v15, s10, v15
	v_dual_mov_b32 v91, 0 :: v_dual_add_nc_u32 v16, s10, v16
	v_dual_mov_b32 v89, 0 :: v_dual_add_nc_u32 v18, s10, v18
	v_dual_mov_b32 v95, 0 :: v_dual_add_nc_u32 v20, s10, v20
...
.LBB0_37:                               ; %._crit_edge
	...
	v_lshrrev_b32_e32 v34, 2, v98
	v_and_b32_e32 v36, 12, v98
	v_add_nc_u32_e32 v35, 0, v100
	...
	v_dual_mul_f32 v54, v39, v46 :: v_dual_mul_f32 v55, v41, v47
	...
	v_dual_fmac_f32 v54, v60, v46 :: v_dual_mul_f32 v59, v51, v57
...
.Ltmp314:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 66
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.private_seg_size, 164
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
    .private_segment_fixed_size: 164
    .sgpr_count:     68
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.kd
