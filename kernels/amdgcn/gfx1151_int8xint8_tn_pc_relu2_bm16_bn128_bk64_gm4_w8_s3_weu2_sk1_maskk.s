...
; %bb.4:                                ; %.lr.ph
	...
	v_mul_lo_u32 v4, s7, v31
	v_mul_lo_u32 v5, s6, v32
...
.Ltmp15:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_subrev_nc_u32_e32 v35, s3, v3
	v_subrev_nc_u32_e32 v36, s3, v1
	v_mov_b32_e32 v1, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v14, v14, v43 :: v_dual_add_nc_u32 v129, s0, v18
	v_dual_add_f32 v11, v11, v46 :: v_dual_add_nc_u32 v32, 64, v32
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v9, v9, v40 :: v_dual_add_nc_u32 v34, s25, v34
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.9:
	...
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v21, s3, v2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.11:
	...
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v5, s6, v5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 137
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 30
