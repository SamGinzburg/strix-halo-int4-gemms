	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v28, 0 :: v_dual_and_b32 v9, 0x100, v0
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v31, 15, v0
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	v_lshlrev_b32_e32 v7, 1, v0
	v_dual_mov_b32 v29, 0 :: v_dual_and_b32 v12, 0xe0, v0
	v_dual_mov_b32 v15, 0 :: v_dual_mov_b32 v20, 0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v32, 0, v7
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v30, 0 :: v_dual_lshlrev_b32 v35, 1, v17
	v_mov_b32_e32 v28, 0
	v_dual_mov_b32 v25, 0 :: v_dual_lshlrev_b32 v38, 1, v4
	v_dual_mov_b32 v22, 0 :: v_dual_mov_b32 v23, 0
	v_dual_mov_b32 v20, 0 :: v_dual_lshlrev_b32 v37, 1, v7
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	ds_load_u8 v42, v19 offset:2368
	ds_load_u8 v43, v19 offset:2304
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v19 offset:2496
	ds_load_u8 v44, v19 offset:2432
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v43, 16, v42
	ds_load_u8 v42, v19 offset:2112
	ds_load_u8 v43, v19 offset:2048
	ds_load_u8 v52, v19 offset:2080
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v19 offset:2240
	ds_load_u8 v44, v19 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	ds_load_u8 v50, v19 offset:2880
	ds_load_u8 v51, v19 offset:2816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v19 offset:3008
	ds_load_u8 v53, v19 offset:2944
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v53, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v19 offset:2624
	ds_load_u8 v53, v19 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v53, v50, 0xc0c0004
	ds_load_u8 v53, v19 offset:2752
	ds_load_u8 v54, v19 offset:2688
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v50, v19 offset:2400
	ds_load_u8 v51, v19 offset:2336
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v19 offset:2528
	ds_load_u8 v53, v19 offset:2464
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v53, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v63, v51, 16, v50
	ds_load_u8 v50, v19 offset:2144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v51, v19 offset:2272
	ds_load_u8 v52, v19 offset:2208
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v58, v19 offset:2912
	ds_load_u8 v59, v19 offset:2848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	ds_load_u8 v59, v19 offset:3040
	ds_load_u8 v62, v19 offset:2976
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v59, v62, v59, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v59, v59, 16, v58
	ds_load_u8 v58, v19 offset:2656
	ds_load_u8 v62, v19 offset:2592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v62, v58, 0xc0c0004
	ds_load_u8 v62, v19 offset:2784
	ds_load_u8 v63, v19 offset:2720
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mul_f32 v56, v56, v59 :: v_dual_fmac_f32 v23, v50, v61
	v_dual_mul_f32 v57, v57, v59 :: v_dual_fmac_f32 v10, v42, v61
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v30, v43, v62 :: v_dual_fmac_f32 v29, v44, v63
	v_dual_fmac_f32 v28, v45, v66 :: v_dual_fmac_f32 v27, v46, v67
	v_dual_fmac_f32 v26, v47, v68 :: v_dual_fmac_f32 v21, v52, v63
	v_dual_fmac_f32 v25, v48, v69 :: v_dual_fmac_f32 v24, v49, v60
	v_dual_fmac_f32 v15, v54, v67 :: v_dual_fmac_f32 v22, v51, v62
	v_dual_fmac_f32 v13, v56, v69 :: v_dual_fmac_f32 v20, v53, v66
...
; %bb.4:
	...
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	ds_load_u8 v2, v19 offset:2368
	ds_load_u8 v3, v19 offset:2304
	ds_load_u8 v4, v19 offset:2496
	ds_load_u8 v5, v19 offset:2432
	ds_load_u8 v6, v19 offset:2112
	ds_load_u8 v7, v19 offset:2048
	ds_load_u8 v8, v19 offset:2240
	ds_load_u8 v31, v19 offset:2176
	...
	ds_load_u8 v39, v1
	ds_load_u8 v44, v19 offset:2528
	ds_load_u8 v45, v19 offset:2464
	ds_load_u8 v46, v19 offset:2400
	ds_load_u8 v47, v19 offset:2336
	ds_load_u8 v48, v19 offset:2272
	ds_load_u8 v49, v19 offset:2208
	ds_load_u8 v50, v19 offset:2144
	ds_load_u8 v51, v19 offset:2080
	...
	ds_load_u8 v4, v19 offset:2880
	ds_load_u8 v5, v19 offset:2816
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v3, v38, v37, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v2, v39, v36, 0xc0c0004
	v_lshl_or_b32 v43, v7, 16, v6
	ds_load_u8 v6, v19 offset:3008
	ds_load_u8 v7, v19 offset:2944
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	v_lshl_or_b32 v42, v3, 16, v2
	ds_load_u8 v2, v19 offset:2624
	ds_load_u8 v3, v19 offset:2560
	ds_load_u8 v8, v19 offset:2752
	ds_load_u8 v31, v19 offset:2688
	ds_load_u8 v52, v1 offset:1664
	ds_load_u8 v53, v1 offset:1920
	ds_load_u8 v54, v1 offset:1792
	ds_load_u8 v55, v1 offset:1536
	ds_load_u8 v56, v19 offset:3040
	ds_load_u8 v57, v19 offset:2976
	ds_load_u8 v58, v19 offset:2912
	ds_load_u8 v59, v19 offset:2848
	ds_load_u8 v66, v19 offset:2784
	ds_load_u8 v67, v19 offset:2720
	ds_load_u8 v68, v19 offset:2656
	ds_load_u8 v19, v19 offset:2592
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
	s_mov_b32 s18, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	...
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v69, v3, v2, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v31, v31, v8, 0xc0c0004
	...
	v_lshl_or_b32 v40, v31, 16, v69
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v31, v55, v52, 0xc0c0004
	v_perm_b32 v52, v54, v53, 0xc0c0004
	v_perm_b32 v46, v47, v46, 0xc0c0004
	v_perm_b32 v44, v45, v44, 0xc0c0004
	v_perm_b32 v50, v51, v50, 0xc0c0004
	v_perm_b32 v48, v49, v48, 0xc0c0004
	v_lshl_or_b32 v45, v52, 16, v31
	v_perm_b32 v31, v64, v61, 0xc0c0004
	v_perm_b32 v49, v63, v62, 0xc0c0004
	v_lshl_or_b32 v47, v44, 16, v46
	v_lshl_or_b32 v46, v48, 16, v50
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v48, v59, v58, 0xc0c0004
	v_perm_b32 v50, v57, v56, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v19, v19, v68, 0xc0c0004
	v_perm_b32 v51, v67, v66, 0xc0c0004
	v_lshl_or_b32 v41, v65, 16, v60
	v_lshl_or_b32 v44, v49, 16, v31
	v_wmma_i32_16x16x16_iu4 v[32:39], v[42:43], v[46:47], v[32:39] neg_lo:[1,1,0]
	v_lshl_or_b32 v43, v50, 16, v48
	v_lshl_or_b32 v42, v51, 16, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[44:45], v[40:41], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[44:45], v[42:43], v[32:39] neg_lo:[1,1,0]
...
.LBB0_5:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v8, v8, v40 :: v_dual_add_nc_u32 v43, 20, v17
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v19, 0x80000000, v31, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v6, v6, v40 :: v_dual_add_nc_u32 v31, 12, v17
	v_dual_mul_f32 v3, v3, v40 :: v_dual_add_nc_u32 v44, 24, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v46, v19, s[20:23], 0 offen
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v40 :: v_dual_lshlrev_b32 v52, 11, v50
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_and_b32_e32 v19, 0x78, v16
	v_and_b32_e32 v51, 0x840, v18
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_add3_u32 v16, s42, s33, v17
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_lshl_or_b32 v12, v12, 3, v19
	v_lshrrev_b32_e32 v19, 1, v9
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_mad_u64_u32 v[17:18], null, s35, v31, v[16:17]
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v7, v7, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_xor_b32_e32 v12, v12, v51
	v_or3_b32 v12, v52, v19, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_ashrrev_i32_e32 v18, 31, v17
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v51, 0, v12
	v_xad_u32 v52, v12, 8, 0
	v_xad_u32 v53, v12, 16, 0
	v_xad_u32 v54, v12, 24, 0
	v_xad_u32 v55, v12, 32, 0
	v_xad_u32 v56, v12, 40, 0
	v_xad_u32 v57, v12, 48, 0
	v_xad_u32 v58, v12, 56, 0
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(8)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v6, v6, v43, v26
	v_fma_f32 v49, v7, v44, v25
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v2, v2, v41, v30
	v_fma_f32 v32, v32, v12, v23
	v_fma_f32 v4, v4, v46, v28
	v_fma_f32 v33, v33, v41, v22
	v_fma_f32 v40, v3, v45, v29
	v_fma_f32 v34, v34, v45, v21
	v_fma_f32 v35, v35, v46, v20
	v_fma_f32 v48, v5, v42, v27
	v_fma_f32 v36, v36, v42, v15
	v_fma_f32 v37, v37, v43, v14
	v_fma_f32 v38, v38, v44, v13
	v_fma_f32 v39, v39, v47, v11
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v3, v30, v2, s2
	v_cndmask_b32_e64 v2, v23, v32, s2
	v_cndmask_b32_e64 v7, v28, v4, s2
	v_cndmask_b32_e64 v4, v22, v33, s2
	v_cndmask_b32_e64 v5, v29, v40, s2
	v_cndmask_b32_e64 v29, v26, v6, s2
	v_cndmask_b32_e64 v6, v21, v34, s2
	v_cndmask_b32_e64 v10, v24, v8, s2
	v_cndmask_b32_e64 v8, v20, v35, s2
	v_cndmask_b32_e64 v27, v27, v48, s2
	v_cndmask_b32_e64 v28, v15, v36, s2
	v_cndmask_b32_e64 v12, v25, v49, s2
	v_cndmask_b32_e64 v30, v14, v37, s2
	...
	ds_store_b64 v55, v[27:28]
	ds_store_b64 v56, v[29:30]
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_vgpr, 70
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.kd
