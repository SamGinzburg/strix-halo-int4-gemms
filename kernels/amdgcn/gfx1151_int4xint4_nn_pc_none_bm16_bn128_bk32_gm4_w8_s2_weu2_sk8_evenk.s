...
.Ltmp11:
	...
	v_mad_u64_u32 v[1:2], null, s24, v17, v[9:10]
	.loc	1 92 28                         ; generate_amdgcn.py:92:28
	s_sub_i32 s2, s2, s4
	...
	s_lshl_b32 s21, s5, 7
	.loc	1 113 30                        ; generate_amdgcn.py:113:30
	v_add3_u32 v18, s16, s3, v1
	.loc	1 117 30                        ; generate_amdgcn.py:117:30
	v_add3_u32 v19, s2, s21, v2
	...
	v_cndmask_b32_e64 v1, 0x80000000, v18, s3
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	v_cndmask_b32_e64 v2, 0x80000000, v19, s3
	s_mov_b32 s15, s11
	s_and_b32 s13, s13, 0xffff
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	buffer_load_u8 v4, v1, s[8:11], 0 offen
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
...
; %bb.4:                                ; %.lr.ph
	...
	buffer_load_u8 v29, v18, s[8:11], 0 offen offset:128
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	buffer_load_b64 v[21:22], v1, s[12:15], 0 offen
	v_lshlrev_b32_e32 v1, 4, v0
	v_bfe_i32 v3, v0, 3, 1
	v_add_nc_u32_e32 v2, 0, v13
.Ltmp12:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:105:32 ]
	s_add_i32 s1, s24, 0x7f
...
; %bb.9:
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_cndmask_b32_e64 v15, 0x88, 0, s0
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
...
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_dual_mul_f32 v19, v9, v19 :: v_dual_lshlrev_b32 v20, 16, v20
	v_dual_mul_f32 v18, v9, v18 :: v_dual_lshlrev_b32 v13, 16, v13
	.loc	1 129 14 is_stmt 1              ; generate_amdgcn.py:129:14
	v_lshlrev_b32_e32 v15, 16, v15
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_dual_mul_f32 v20, v9, v20 :: v_dual_add_nc_u32 v11, 0, v10
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 130 9 is_stmt 0               ; generate_amdgcn.py:130:9
	...
	v_cndmask_b32_e64 v7, 0x204, 0, s2
	v_lshlrev_b32_e32 v0, 5, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v4, 28, v4
	v_and_or_b32 v4, 0x1c0, v6, v4
