	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:154:22 ]
	s_add_i32 s2, s2, s0
	v_dual_mov_b32 v68, 0 :: v_dual_add_nc_u32 v17, 64, v15
...
.Ltmp21:
	...
	v_dual_mov_b32 v64, 0 :: v_dual_add_nc_u32 v19, 32, v18
	v_subrev_nc_u32_e32 v39, s16, v15
	s_mov_b32 s16, s12
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
	...
	v_dual_mov_b32 v56, 0 :: v_dual_add_nc_u32 v47, 0, v7
	v_dual_mov_b32 v61, 0 :: v_dual_add_nc_u32 v48, 0, v8
	...
	v_mov_b32_e32 v65, 0
	v_dual_mov_b32 v62, 0 :: v_dual_lshlrev_b32 v41, 1, v18
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[29:30], null, s13, v3, v[1:2]
	s_mov_b32 s13, s12
	v_lshlrev_b32_e32 v5, 3, v0
	v_and_b32_e32 v6, 56, v32
	v_dual_mov_b32 v54, 0 :: v_dual_add_nc_u32 v49, 0, v9
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v50, 0, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v5, v5, v6
	v_lshlrev_b32_e32 v6, 4, v0
	v_add_nc_u32_e32 v51, 0, v11
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v52, 0, v12
	v_dual_mov_b32 v58, 0 :: v_dual_add_nc_u32 v45, 0, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v63, 0 :: v_dual_add_nc_u32 v46, 0, v6
	v_mov_b32_e32 v1, s12
	v_add_nc_u32_e32 v53, 0, v13
	v_dual_mov_b32 v2, s13 :: v_dual_add_nc_u32 v59, 0, v16
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x1
	buffer_load_u16 v70, v41, s[24:27], 0 offen
	buffer_load_u16 v71, v40, s[24:27], 0 offen
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	s_add_i32 s29, s29, -1
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	ds_load_u8 v22, v35 offset:1408
	ds_load_u8 v23, v35 offset:1024
	ds_load_u8 v24, v35 offset:1280
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v47 offset0:16 offset1:20
	ds_load_2addr_stride64_b64 v[76:79], v48 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v84, v35 offset:2688
	ds_load_u8 v85, v35 offset:2944
	ds_load_u8 v86, v35 offset:2816
	ds_load_u8 v87, v35 offset:2560
	ds_load_u8 v88, v35 offset:2176
	ds_load_u8 v89, v35 offset:2432
	ds_load_u8 v90, v35 offset:2304
	ds_load_u8 v91, v35 offset:2048
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v78, v35 offset:3712
	ds_load_u8 v79, v35 offset:3968
	ds_load_u8 v80, v35 offset:3840
	ds_load_u8 v81, v35 offset:3584
	...
	ds_load_u8 v82, v35 offset:3200
	ds_load_u8 v83, v35 offset:3456
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v50 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v84, v35 offset:4736
	ds_load_u8 v86, v35 offset:4992
	...
	ds_load_u8 v78, v35 offset:4224
	ds_load_u8 v79, v35 offset:4480
	ds_load_u8 v81, v35 offset:4096
	ds_load_u8 v87, v35 offset:3328
	ds_load_u8 v85, v35 offset:3072
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v51 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v80, v35 offset:5760
	ds_load_u8 v82, v35 offset:6016
	ds_load_u8 v85, v35 offset:5888
	ds_load_u8 v87, v35 offset:5632
	v_perm_b32 v76, v89, v84, 0xc0c0004
	ds_load_u8 v84, v35 offset:5248
	v_perm_b32 v77, v88, v86, 0xc0c0004
	ds_load_u8 v86, v35 offset:5504
	ds_load_u8 v88, v35 offset:6784
	ds_load_u8 v81, v35 offset:5120
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v83, v79, 0xc0c0004
	ds_load_u8 v83, v35 offset:5376
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v52 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v89, v35 offset:7040
	ds_load_u8 v90, v35 offset:6912
	ds_load_u8 v91, v35 offset:6656
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v76, v87, v80, 0xc0c0004
	ds_load_u8 v80, v35 offset:6272
	v_perm_b32 v77, v85, v82, 0xc0c0004
	ds_load_u8 v82, v35 offset:6528
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v78, v81, v84, 0xc0c0004
	ds_load_u8 v81, v35 offset:6400
	ds_load_u8 v84, v35 offset:7808
	ds_load_u8 v85, v35 offset:8064
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v83, v86, 0xc0c0004
	ds_load_u8 v83, v35 offset:6144
	v_lshl_or_b32 v76, v79, 16, v78
	s_waitcnt lgkmcnt(9)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[17:24], v[76:77], v[72:73], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v86, v35 offset:7936
	ds_load_u8 v87, v35 offset:7680
	ds_load_u8 v92, v35 offset:7296
	ds_load_u8 v93, v35 offset:7168
	ds_load_u8 v94, v35 offset:7552
	ds_load_u8 v95, v35 offset:7424
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v53 offset0:16 offset1:20
	ds_load_2addr_stride64_b64 v[76:79], v59 offset0:16 offset1:20
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	...
	ds_load_u8 v79, v35 offset:2944
	s_waitcnt lgkmcnt(5)
	...
	ds_load_u8 v78, v35 offset:3968
	s_waitcnt lgkmcnt(3)
	...
	ds_load_u8 v79, v35 offset:4992
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v73, v71, 0xc0c0004
	...
	ds_load_u8 v78, v35 offset:6016
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v72, v71, 0xc0c0004
	...
	ds_load_u8 v79, v35 offset:7040
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v73, v71, 0xc0c0004
	...
	v_dual_mul_f32 v20, v92, v20 :: v_dual_add_nc_u32 v85, v38, v39
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v80, v85, s[8:11], 0 offen
	buffer_load_u16 v81, v85, s[8:11], 0 offen offset:4
	buffer_load_u16 v87, v85, s[8:11], 0 offen offset:8
	buffer_load_u16 v88, v85, s[8:11], 0 offen offset:12
	buffer_load_u16 v89, v85, s[8:11], 0 offen offset:16
	buffer_load_u16 v90, v85, s[8:11], 0 offen offset:20
	buffer_load_u16 v91, v85, s[8:11], 0 offen offset:24
	buffer_load_u16 v85, v85, s[8:11], 0 offen offset:28
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v21, v92, v21 :: v_dual_add_nc_u32 v44, s33, v44
	v_cvt_f32_i32_e32 v14, v14
	v_mul_f32_e32 v18, v92, v18
	v_dual_mul_f32 v17, v92, v17 :: v_dual_add_nc_u32 v40, 2, v40
	...
	v_dual_mul_f32 v22, v92, v22 :: v_dual_add_nc_u32 v39, s30, v39
	v_dual_mul_f32 v24, v92, v24 :: v_dual_add_nc_u32 v41, 2, v41
	v_dual_mul_f32 v19, v92, v19 :: v_dual_add_nc_u32 v42, s33, v42
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(7)
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v43, v17, v25 :: v_dual_lshlrev_b32 v70, 16, v91
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v68, v19, v27 :: v_dual_lshlrev_b32 v71, 16, v85
	v_fmac_f32_e32 v66, v21, v30
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v14, v93, v14 :: v_dual_mul_f32 v23, v92, v23
	v_mul_f32_e32 v10, v93, v10
	v_mul_f32_e32 v11, v93, v11
	v_mul_f32_e32 v12, v93, v12
	v_mul_f32_e32 v13, v93, v13
	v_dual_mul_f32 v15, v93, v15 :: v_dual_fmac_f32 v64, v23, v70
	v_dual_mul_f32 v16, v93, v16 :: v_dual_fmac_f32 v69, v18, v26
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v67, v20, v28 :: v_dual_fmac_f32 v62, v9, v25
	v_dual_fmac_f32 v65, v22, v31 :: v_dual_fmac_f32 v58, v12, v28
	v_fmac_f32_e32 v63, v24, v71
	v_dual_fmac_f32 v61, v10, v26 :: v_dual_fmac_f32 v60, v11, v27
	v_dual_fmac_f32 v57, v13, v30 :: v_dual_fmac_f32 v56, v14, v31
	v_dual_fmac_f32 v55, v15, v70 :: v_dual_fmac_f32 v54, v16, v71
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 96
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.kd
