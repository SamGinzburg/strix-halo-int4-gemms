	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_dual_mov_b32 v83, 0 :: v_dual_and_b32 v38, 64, v0
...
; %bb.1:                                ; %.preheader.lr.ph
	...
	v_dual_mov_b32 v85, 0 :: v_dual_lshlrev_b32 v6, 4, v0
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s20, s35, v2
	s_cmp_lt_i32 s3, 64
	v_dual_mov_b32 v86, 0 :: v_dual_and_b32 v1, 16, v6
	...
	v_dual_mov_b32 v83, 0 :: v_dual_lshlrev_b32 v2, 1, v0
	v_dual_mov_b32 v65, 0 :: v_dual_and_b32 v4, 24, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v67, 0 :: v_dual_and_b32 v2, 24, v2
	s_add_i32 s42, s42, s48
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v7, s44, v3
	v_xor_b32_e32 v4, v6, v4
	v_dual_mov_b32 v84, 0 :: v_dual_add_nc_u32 v5, s49, v5
	v_mad_u64_u32 v[33:34], null, s49, s40, v[1:2]
	v_lshl_or_b32 v2, v37, 5, v2
	v_dual_mov_b32 v82, 0 :: v_dual_add_nc_u32 v3, s49, v3
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v64, 2, v62
	v_or_b32_e32 v66, 4, v62
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v6, v38, 3, v2
	v_mad_u64_u32 v[34:35], null, s42, s40, v[1:2]
	v_lshl_or_b32 v2, v39, 4, v2
	...
	v_dual_mov_b32 v74, 0 :: v_dual_add_nc_u32 v89, 0, v4
	v_dual_mov_b32 v63, 0 :: v_dual_add_nc_u32 v90, 0, v1
	v_dual_mov_b32 v60, 0 :: v_dual_add_nc_u32 v91, 0, v6
	v_dual_mov_b32 v61, 0 :: v_dual_add_nc_u32 v92, 0, v7
	v_dual_mov_b32 v58, 0 :: v_dual_add_nc_u32 v93, 0, v8
	v_dual_mov_b32 v59, 0 :: v_dual_add_nc_u32 v94, 0, v9
	v_dual_mov_b32 v56, 0 :: v_dual_add_nc_u32 v95, 0, v2
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v96, 0, v10
	v_dual_mov_b32 v54, 0 :: v_dual_add_nc_u32 v97, 0, v11
...
.LBB0_2:                                ; %._crit_edge
	...
	v_add_lshl_u32 v112, v77, s26, 1
	v_add_lshl_u32 v20, v69, s26, 1
	v_add_lshl_u32 v21, v70, s26, 1
	v_add_lshl_u32 v22, v71, s26, 1
	v_add_lshl_u32 v23, v72, s26, 1
	v_add_lshl_u32 v113, v78, s26, 1
	v_add_lshl_u32 v114, v79, s26, 1
	v_add_lshl_u32 v115, v80, s26, 1
	v_add_lshl_u32 v116, v81, s26, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	s_clause 0x1
	...
	v_dual_mul_f32 v110, v110, v14 :: v_dual_lshlrev_b32 v15, 16, v15
	...
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v106, v106, v14 :: v_dual_lshlrev_b32 v19, 16, v19
	.loc	1 1519 40                       ; ragged.py:1519:40
	s_waitcnt vmcnt(11)
	v_lshlrev_b32_e32 v20, 16, v20
	.loc	1 1517 21                       ; ragged.py:1517:21
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v104, v104, v14 :: v_dual_lshlrev_b32 v21, 16, v21
	s_waitcnt vmcnt(9)
	v_dual_mul_f32 v13, v13, v15 :: v_dual_lshlrev_b32 v22, 16, v22
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v102, v102, v14 :: v_dual_lshlrev_b32 v23, 16, v23
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v107, v107, v14 :: v_dual_lshlrev_b32 v24, 16, v24
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v100, v100, v14 :: v_dual_lshlrev_b32 v31, 16, v31
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v105, v105, v14 :: v_dual_lshlrev_b32 v32, 16, v32
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v103, v103, v14 :: v_dual_lshlrev_b32 v112, 16, v112
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v30, v30, v14 :: v_dual_lshlrev_b32 v113, 16, v113
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v11, v11, v15 :: v_dual_lshlrev_b32 v114, 16, v114
	.loc	1 1525 17                       ; ragged.py:1525:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v86, v110, v18 :: v_dual_lshlrev_b32 v115, 16, v115
	.loc	1 1517 21                       ; ragged.py:1517:21
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v101, v101, v14 :: v_dual_lshlrev_b32 v116, 16, v116
	v_mul_f32_e32 v99, v99, v14
	v_mul_f32_e32 v29, v29, v14
	v_dual_mul_f32 v1, v1, v14 :: v_dual_mul_f32 v26, v26, v15
	v_mul_f32_e32 v14, v28, v15
	v_dual_mul_f32 v12, v12, v15 :: v_dual_fmac_f32 v85, v111, v17
	v_dual_mul_f32 v10, v10, v15 :: v_dual_fmac_f32 v83, v108, v20
	v_dual_mul_f32 v9, v9, v15 :: v_dual_fmac_f32 v82, v107, v21
	v_dual_mul_f32 v8, v8, v15 :: v_dual_fmac_f32 v61, v102, v32
	v_dual_mul_f32 v7, v7, v15 :: v_dual_fmac_f32 v74, v106, v22
	v_dual_mul_f32 v6, v6, v15 :: v_dual_fmac_f32 v65, v104, v24
	v_dual_mul_f32 v5, v5, v15 :: v_dual_fmac_f32 v58, v99, v114
	v_dual_mul_f32 v4, v4, v15 :: v_dual_fmac_f32 v51, v1, v16
	v_dual_mul_f32 v3, v3, v15 :: v_dual_fmac_f32 v60, v101, v112
	.loc	1 1525 17                       ; ragged.py:1525:17
	v_dual_fmac_f32 v84, v109, v19 :: v_dual_fmac_f32 v59, v100, v113
	v_dual_fmac_f32 v67, v105, v23 :: v_dual_fmac_f32 v52, v2, v16
	v_dual_fmac_f32 v63, v103, v31 :: v_dual_fmac_f32 v56, v29, v116
	v_dual_fmac_f32 v57, v30, v115 :: v_dual_fmac_f32 v54, v27, v18
	v_dual_fmac_f32 v55, v14, v17 :: v_dual_fmac_f32 v50, v25, v20
	v_dual_fmac_f32 v53, v26, v19 :: v_dual_fmac_f32 v48, v12, v22
	v_dual_fmac_f32 v49, v13, v21 :: v_dual_fmac_f32 v46, v10, v24
	v_dual_fmac_f32 v47, v11, v23 :: v_dual_fmac_f32 v44, v8, v32
	v_dual_fmac_f32 v45, v9, v31 :: v_dual_fmac_f32 v42, v6, v113
	v_dual_fmac_f32 v43, v7, v112 :: v_dual_fmac_f32 v40, v4, v115
	v_fmac_f32_e32 v41, v5, v114
	v_fmac_f32_e32 v35, v3, v116
	.loc	1 1421 19                       ; ragged.py:1421:19
...
.LBB0_5:                                ; %.lr.ph
	...
	s_mov_b32 s26, s38
	v_add_nc_u32_e32 v99, s51, v33
	v_add_nc_u32_e32 v100, s51, v34
	s_mov_b32 s27, s39
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1436 38                       ; ragged.py:1436:38
	v_cndmask_b32_e64 v99, 0x80000000, v99, s0
	.loc	1 1437 38                       ; ragged.py:1437:38
	v_cndmask_b32_e64 v103, 0x80000000, v100, s20
	.loc	1 1436 38                       ; ragged.py:1436:38
	buffer_load_b128 v[99:102], v99, s[36:39], 0 offen
	.loc	1 1437 38                       ; ragged.py:1437:38
	...
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt vmcnt(1)
	ds_store_b64 v89, v[99:100]
	ds_store_b64 v90, v[101:102]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[99:102], v91 offset1:2
	ds_load_2addr_stride64_b64 v[107:110], v92 offset1:2
	ds_load_2addr_stride64_b64 v[111:114], v93 offset1:2
	ds_load_2addr_stride64_b64 v[115:118], v94 offset1:2
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v89, v[103:104]
	...
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[103:104], v[99:100], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[105:106], v[99:100], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[103:104], v[101:102], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[105:106], v[101:102], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[119:120], v[107:108], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[121:122], v[107:108], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[119:120], v[109:110], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[121:122], v[109:110], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[123:124], v[111:112], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[125:126], v[111:112], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[123:124], v[113:114], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[125:126], v[113:114], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[127:128], v[115:116], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[129:130], v[115:116], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[127:128], v[117:118], v[9:16] neg_lo:[1,1,0]
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 131
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 52
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
    .private_segment_fixed_size: 0
    .sgpr_count:     54
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.kd
