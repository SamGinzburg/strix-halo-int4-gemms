	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[2:3], null, s6, v1, v[5:6]
	...
	v_mad_u64_u32 v[6:7], null, s5, v1, v[4:5]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v10, v2, s[16:19], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v7, v7, s[20:23], 0 offen
	buffer_load_b32 v11, v9, s[20:23], 0 offen
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	...
	s_waitcnt vmcnt(3)
	ds_store_2addr_stride64_b32 v13, v3, v6 offset1:16
	v_or_b32_e32 v9, v35, v2
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s23, s24, 7
.Ltmp12:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:106:32 ]
	s_add_i32 s1, s1, 15
	v_mov_b32_e32 v10, v1
	v_dual_mov_b32 v3, v1 :: v_dual_add_nc_u32 v6, 0x41, v2
	v_dual_mov_b32 v11, v1 :: v_dual_add_nc_u32 v2, 64, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp13:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add3_u32 v19, v8, s5, v5
	...
	v_add3_u32 v6, v6, s22, v4
	v_mov_b32_e32 v15, v1
	v_add3_u32 v7, v7, s22, v4
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v16, v1
	v_subrev_nc_u32_e32 v20, s23, v6
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v38, v19, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v39, v21, s[20:23], 0 offen
	buffer_load_b32 v40, v20, s[20:23], 0 offen
	s_mov_b32 s29, s0
	s_mov_b32 s0, s24
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v22, s29, v37
	s_mov_b32 s24, s26
	s_mov_b32 s26, s3
	s_mov_b32 s3, s11
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v23, s24, v9
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v24, s3, v9
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v25, v22 offset:160
	ds_load_u8 v26, v22 offset:224
	ds_load_u8 v27, v22 offset:192
	ds_load_u8 v28, v22 offset:128
	ds_load_u8 v29, v22 offset:96
	ds_load_u8 v30, v22 offset:64
	ds_load_u8 v31, v22
	ds_load_u8 v32, v22 offset:32
	ds_load_u8 v33, v23 offset:640
	ds_load_u8 v41, v23 offset:896
	ds_load_u8 v42, v23 offset:768
	ds_load_u8 v43, v23 offset:512
	ds_load_u8 v44, v23 offset:128
	ds_load_u8 v45, v23 offset:384
	ds_load_u8 v46, v23 offset:256
	ds_load_u8 v47, v23
	ds_load_u8 v48, v22 offset:416
	ds_load_u8 v49, v22 offset:480
	ds_load_u8 v50, v22 offset:448
	ds_load_u8 v51, v22 offset:384
	ds_load_u8 v52, v22 offset:288
	ds_load_u8 v53, v22 offset:352
	ds_load_u8 v54, v22 offset:320
	ds_load_u8 v22, v22 offset:256
	ds_load_u8 v55, v23 offset:1664
	ds_load_u8 v56, v23 offset:1920
	ds_load_u8 v57, v23 offset:1792
	ds_load_u8 v58, v23 offset:1536
	ds_load_u8 v59, v23 offset:1152
	ds_load_u8 v60, v23 offset:1408
	ds_load_u8 v61, v23 offset:1280
	ds_load_u8 v23, v23 offset:1024
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v62, v24 offset:640
	ds_load_u8 v63, v24 offset:896
	ds_load_u8 v64, v24 offset:768
	ds_load_u8 v65, v24 offset:512
	ds_load_u8 v66, v24 offset:128
	ds_load_u8 v67, v24 offset:384
	ds_load_u8 v68, v24 offset:256
	ds_load_u8 v69, v24
	ds_load_u8 v70, v24 offset:1664
	ds_load_u8 v71, v24 offset:1920
	ds_load_u8 v72, v24 offset:1792
	ds_load_u8 v73, v24 offset:1536
	ds_load_u8 v74, v24 offset:1152
	ds_load_u8 v75, v24 offset:1408
	ds_load_u8 v76, v24 offset:1280
	...
	v_perm_b32 v28, v31, v32, 0xc0c0004
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v29, v43, v33, 0xc0c0004
	v_perm_b32 v30, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v31, v47, v44, 0xc0c0004
	...
	s_add_i32 s1, s28, 1
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_perm_b32 v42, v22, v52, 0xc0c0004
	v_perm_b32 v43, v54, v53, 0xc0c0004
	v_perm_b32 v44, v58, v55, 0xc0c0004
	v_perm_b32 v45, v57, v56, 0xc0c0004
	v_perm_b32 v46, v23, v59, 0xc0c0004
	v_perm_b32 v47, v61, v60, 0xc0c0004
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v52, v73, v70, 0xc0c0004
	v_perm_b32 v53, v72, v71, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v24, v74, 0xc0c0004
	v_perm_b32 v55, v76, v75, 0xc0c0004
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v23, v26, 16, v25
	v_lshl_or_b32 v22, v27, 16, v28
	v_lshl_or_b32 v25, v30, 16, v29
	v_lshl_or_b32 v24, v32, 16, v31
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_lshl_or_b32 v31, v49, 16, v48
	v_lshl_or_b32 v30, v51, 16, v50
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lt_i32 s1, 2
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v27, v41, 16, v33
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cselect_b32 s28, s1, 0
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v26, v43, 16, v42
	v_lshl_or_b32 v29, v45, 16, v44
	v_lshl_or_b32 v28, v47, 16, v46
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_lshl_or_b32 v33, v53, 16, v52
	v_lshl_or_b32 v32, v55, 16, v54
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[10:17], v[24:25], v[22:23], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[30:31], v[22:23], v[1:8] neg_lo:[1,1,0]
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_lshl_b32 s1, s28, 9
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[10:17], v[28:29], v[26:27], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[32:33], v[26:27], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s6, s6, -1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v23, s3, v18
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_add_i32 s24, s1, 0x2000
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v22, v38 offset:8192
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v23, v39, v40 offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
; %bb.9:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v22, s22, v48
	v_add_nc_u32_e32 v23, s22, v47
	v_add_nc_u32_e32 v20, s22, v50
	v_add_nc_u32_e32 v61, s22, v44
	v_add_nc_u32_e32 v21, s22, v49
	v_add_nc_u32_e32 v24, s22, v46
	v_add_nc_u32_e32 v25, s22, v45
	v_add_nc_u32_e32 v62, s22, v51
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v22, v22
	ds_load_u8 v23, v23
	ds_load_u8 v20, v20
	...
	ds_load_u8 v21, v21
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v63, s22, v43
	v_add_nc_u32_e32 v64, s22, v42
	v_add_nc_u32_e32 v18, s22, v53
	v_add_nc_u32_e32 v67, s22, v39
	v_add_nc_u32_e32 v65, s22, v41
	v_add_nc_u32_e32 v66, s22, v40
	v_add_nc_u32_e32 v68, s22, v38
	v_add_nc_u32_e32 v19, s22, v52
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v69, v63
	ds_load_u8 v70, v64
	ds_load_u8 v71, v18
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v14, s11, v48
	v_add_nc_u32_e32 v15, s11, v47
	v_add_nc_u32_e32 v12, s11, v50
	v_add_nc_u32_e32 v61, s11, v44
	v_add_nc_u32_e32 v13, s11, v49
	v_add_nc_u32_e32 v16, s11, v46
	v_add_nc_u32_e32 v17, s11, v45
	v_add_nc_u32_e32 v62, s11, v51
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v14, v14
	ds_load_u8 v15, v15
	ds_load_u8 v12, v12
	...
	ds_load_u8 v13, v13
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v63, s11, v43
	v_add_nc_u32_e32 v64, s11, v42
	v_add_nc_u32_e32 v10, s11, v53
	v_add_nc_u32_e32 v67, s11, v38
	v_add_nc_u32_e32 v65, s11, v41
	v_add_nc_u32_e32 v66, s11, v40
	v_add_nc_u32_e32 v68, s11, v39
	v_add_nc_u32_e32 v11, s11, v52
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v63, v63
	ds_load_u8 v64, v64
	ds_load_u8 v69, v10
...
.LBB0_12:                               ; %._crit_edge54
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v29, v13 :: v_dual_add_nc_u32 v26, s24, v37
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 81
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
