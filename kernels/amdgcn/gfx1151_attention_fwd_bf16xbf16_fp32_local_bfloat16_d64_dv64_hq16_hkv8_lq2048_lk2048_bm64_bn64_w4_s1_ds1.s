	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 787 26                        ; attention.py:787:26
	v_mad_u64_u32 v[142:143], null, s83, 48, v[130:131]
	v_lshl_add_u32 v143, s83, 4, v130
	v_lshl_add_u32 v131, s83, 5, v130
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_add_lshl_u32 v2, v143, s2, 1
	v_add_lshl_u32 v3, v131, s2, 1
	v_add_lshl_u32 v4, v142, s2, 1
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v4, s5, v25
	...
	v_dual_mov_b32 v58, v57 :: v_dual_add_nc_u32 v157, s7, v4
	v_dual_mov_b32 v61, v57 :: v_dual_lshlrev_b32 v4, 7, v28
	v_dual_mov_b32 v60, v57 :: v_dual_lshlrev_b32 v5, 6, v69
	...
	v_add_nc_u32_e32 v158, s7, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v4, v5, v6
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, 48, v25
	v_dual_mov_b32 v59, v57 :: v_dual_add_nc_u32 v2, s5, v2
	...
	v_dual_mov_b32 v19, v57 :: v_dual_add_nc_u32 v160, s7, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v135, v57 :: v_dual_add_nc_u32 v196, 0, v3
	...
	.loc	1 756 22                        ; attention.py:756:22
	s_sub_i32 s0, s3, s0
	v_dual_mov_b32 v139, 0xff800000 :: v_dual_add_nc_u32 v200, 0, v3
	...
	v_cndmask_b32_e64 v2, 0x1054, v4, s2
	v_mov_b32_e32 v148, 0xff800000
	v_cndmask_b32_e64 v4, 0x3276, v8, s2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s104, s98, s96
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s67, s100, s96
	.loc	1 853 32                        ; attention.py:853:32
	...
	s_and_b32 s20, s68, s13
	s_and_b32 s22, s68, s14
	.loc	1 879 36                        ; attention.py:879:36
	...
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s23, s61, s62
	s_and_b32 s39, s52, s53
	s_and_b32 s19, s68, s23
...
.Ltmp129:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 105
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 220
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
    .private_segment_fixed_size: 220
    .sgpr_count:     107
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.kd
