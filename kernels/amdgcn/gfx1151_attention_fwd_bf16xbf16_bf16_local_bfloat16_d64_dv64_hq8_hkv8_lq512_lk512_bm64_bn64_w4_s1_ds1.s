...
.Ltmp0:
	...
	v_lshl_add_u32 v193, s82, 5, v130
	.loc	1 788 26                        ; attention.py:788:26
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v0, s5, v0
	...
	v_dual_mov_b32 v60, v57 :: v_dual_add_nc_u32 v159, s7, v0
	v_dual_mov_b32 v63, v57 :: v_dual_lshlrev_b32 v0, 6, v69
	...
	v_dual_mov_b32 v62, v57 :: v_dual_add_nc_u32 v161, s7, v2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v0, v1, v0, v3
	scratch_store_b32 off, v28, off offset:192 ; 4-byte Folded Spill
	v_mov_b32_e32 v17, v57
	v_or_b32_e32 v162, v3, v1
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v7, 1, v129
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v2, 0x70, v0, 0
	v_xad_u32 v4, 0x60, v0, 0
	...
	v_xad_u32 v2, v0, 48, 0
	v_xad_u32 v4, v0, 32, 0
	...
	v_lshl_add_u32 v4, s15, 4, v0
	v_mad_u64_u32 v[1:2], null, s15, 48, v[0:1]
	v_lshl_add_u32 v5, s15, 5, v0
	v_dual_mov_b32 v20, v57 :: v_dual_add_nc_u32 v163, v0, v129
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v0, v4, v129
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_dual_mov_b32 v149, 0xff800000 :: v_dual_add_nc_u32 v0, v4, v11
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s0, s3, s0
	...
	v_dual_mov_b32 v147, 0xff800000 :: v_dual_add_nc_u32 v0, v4, v12
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s0, s0, 3
	...
	v_dual_mov_b32 v16, v57 :: v_dual_and_b32 v7, 0x1b8, v71
	...
	v_dual_mov_b32 v148, 0xff800000 :: v_dual_add_nc_u32 v1, v1, v14
	...
	v_cndmask_b32_e64 v4, 0x3276, v4, s2
	v_add_nc_u32_e32 v9, v5, v11
	v_xor_b32_e32 v8, v2, v8
	v_xor_b32_e32 v2, v3, v70
	v_lshl_or_b32 v1, v1, 8, v1
	v_lshl_or_b32 v3, v4, 8, v4
	v_and_b32_e32 v4, 0x410, v6
	...
	v_dual_mov_b32 v9, v57 :: v_dual_add_nc_u32 v196, 0, v1
	v_xor_b32_e32 v1, 48, v162
	v_mov_b32_e32 v10, v57
	v_mov_b32_e32 v11, v57
	v_mov_b32_e32 v12, v57
	v_dual_mov_b32 v7, v57 :: v_dual_add_nc_u32 v198, 0, v1
	v_xor_b32_e32 v1, 8, v184
	v_dual_mov_b32 v137, 0xff800000 :: v_dual_mov_b32 v6, v57
...
.Ltmp7:
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[176:179], v131
	ds_load_b128 v[121:124], v141
	.loc	1 896 23                        ; attention.py:896:23
	s_waitcnt lgkmcnt(4)
	v_wmma_f32_16x16x16_bf16 v[9:16], v[164:171], v[65:72], v[9:16]
	.loc	1 890 30                        ; attention.py:890:30
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 104
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 220
