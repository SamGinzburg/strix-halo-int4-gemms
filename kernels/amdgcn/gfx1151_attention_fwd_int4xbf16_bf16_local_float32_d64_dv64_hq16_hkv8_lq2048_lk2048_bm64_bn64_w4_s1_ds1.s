...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v192, 0xff800000 :: v_dual_and_b32 v45, 16, v0
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 779 31 is_stmt 1              ; attention.py:779:31
	v_cndmask_b32_e64 v1, 0x80000000, v1, s2
	v_dual_mov_b32 v53, 0x5410 :: v_dual_lshlrev_b32 v14, 4, v0
	...
	v_dual_mov_b32 v20, v17 :: v_dual_and_b32 v7, 0x7c, v48
	.loc	1 774 26                        ; attention.py:774:26
	...
	v_dual_mov_b32 v194, 0xff800000 :: v_dual_lshlrev_b32 v1, 3, v0
	v_bfe_i32 v12, v0, 2, 1
	v_dual_mov_b32 v233, 0xff800000 :: v_dual_and_b32 v52, 8, v0
	v_xor_b32_e32 v195, v14, v2
	v_dual_mov_b32 v23, v17 :: v_dual_lshlrev_b32 v62, 6, v45
	...
	v_dual_mov_b32 v22, v17 :: v_dual_lshlrev_b32 v9, 2, v43
	v_dual_mov_b32 v227, 0xff800000 :: v_dual_and_b32 v142, 56, v1
	v_dual_mov_b32 v28, v17 :: v_dual_lshlrev_b32 v57, 5, v45
	v_lshl_or_b32 v43, v43, 4, v7
	...
	v_xor_b32_e32 v205, v43, v49
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[48:49], null, s96, v46, v[142:143]
	v_dual_mov_b32 v220, 0xff800000 :: v_dual_and_b32 v3, 24, v47
	v_dual_mov_b32 v32, v17 :: v_dual_and_b32 v61, 0x2040, v10
	...
	v_dual_mov_b32 v24, v17 :: v_dual_and_b32 v13, 4, v0
	.loc	1 758 19                        ; attention.py:758:19
	s_bfe_u32 s20, s3, 0x10007
	v_xor_b32_e32 v33, v56, v44
	s_add_i32 s1, s3, s20
	...
	v_dual_mov_b32 v26, v17 :: v_dual_and_b32 v47, 0x80, v47
	v_lshl_add_u32 v65, v13, 9, 0
	v_xor_b32_e32 v34, v34, v59
	s_sext_i32_i16 s1, s1
	v_dual_mov_b32 v6, v17 :: v_dual_add_nc_u32 v213, 0, v33
	...
	v_dual_mov_b32 v9, v17 :: v_dual_and_b32 v36, 0x760076, v36
	scratch_store_b32 off, v37, off offset:56 ; 4-byte Folded Spill
	v_xor_b32_e32 v37, 32, v208
	v_dual_mov_b32 v15, v17 :: v_dual_add_nc_u32 v238, v34, v45
	v_lshl_or_b32 v40, v35, 4, v35
	v_mad_u64_u32 v[34:35], null, s15, 48, v[33:34]
	v_dual_mov_b32 v25, v17 :: v_dual_add_nc_u32 v44, s19, v66
	v_dual_mov_b32 v27, v17 :: v_dual_add_nc_u32 v48, s19, v67
	v_dual_mov_b32 v14, v17 :: v_dual_add_nc_u32 v49, s19, v68
	.loc	1 759 31                        ; attention.py:759:31
	...
	s_mul_i32 s9, s13, s9
	v_dual_mov_b32 v11, v17 :: v_dual_add_nc_u32 v232, 0, v56
	v_dual_mov_b32 v13, v17 :: v_dual_add_nc_u32 v236, 0, v58
	v_dual_mov_b32 v16, v17 :: v_dual_add_nc_u32 v207, s17, v69
	v_dual_mov_b32 v1, v17 :: v_dual_add_nc_u32 v240, 0, v38
	v_dual_mov_b32 v3, v17 :: v_dual_and_b32 v244, 0x7060706, v36
	v_dual_mov_b32 v5, v17 :: v_dual_add_nc_u32 v246, v35, v0
	v_dual_mov_b32 v7, v17 :: v_dual_add_nc_u32 v248, v35, v71
	v_dual_mov_b32 v8, v17 :: v_dual_add_nc_u32 v215, s17, v44
	v_dual_mov_b32 v138, v17 :: v_dual_add_nc_u32 v217, s17, v48
	v_dual_mov_b32 v139, v17 :: v_dual_add_nc_u32 v250, v35, v73
	v_dual_mov_b32 v140, v17 :: v_dual_add_nc_u32 v219, s17, v49
	v_dual_mov_b32 v141, v17 :: v_dual_add_nc_u32 v252, v35, v75
	.loc	1 892 65                        ; attention.py:892:65
	v_cmp_gt_i32_e64 s0, s96, v142
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v152, s16, v69
	v_subrev_nc_u32_e32 v214, s16, v44
	v_subrev_nc_u32_e32 v216, s16, v48
	v_subrev_nc_u32_e32 v218, s16, v49
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 822 32                        ; attention.py:822:32
	v_mad_u64_u32 v[33:34], null, s104, s78, v[234:235]
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 vcc_hi, s103, s79
	v_or_b32_e32 v102, s102, v169
	v_or_b32_e32 v98, s102, v180
	v_or_b32_e32 v99, s102, v179
	v_or_b32_e32 v100, s102, v178
	v_or_b32_e32 v101, s102, v176
	.loc	1 823 32                        ; attention.py:823:32
	...
	v_or_b32_e32 v90, s102, v151
	v_or_b32_e32 v91, s102, v137
	.loc	1 847 25                        ; attention.py:847:25
	...
	v_or_b32_e32 v78, s102, v167
	v_or_b32_e32 v79, s102, v226
	v_or_b32_e32 v80, s102, v222
	s_waitcnt vmcnt(7)
	...
	v_or_b32_e32 v78, s102, v231
	v_or_b32_e32 v79, s102, v225
	v_or_b32_e32 v80, s102, v221
	...
	v_or_b32_e32 v78, s102, v230
	v_or_b32_e32 v79, s102, v224
	v_or_b32_e32 v80, s102, v94
	v_or_b32_e32 v94, s102, v177
	...
	v_or_b32_e32 v78, s102, v228
	v_or_b32_e32 v79, s102, v223
	v_or_b32_e32 v80, s102, v209
	v_or_b32_e32 v94, s102, v183
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_lshl_u32 v78, v78, s79, 1
	v_add_lshl_u32 v79, v79, s79, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	.loc	1 881 25                        ; attention.py:881:25
	ds_store_2addr_b32 v229, v121, v122 offset1:32
	ds_store_2addr_b32 v229, v123, v124 offset0:64 offset1:96
	.loc	1 880 35                        ; attention.py:880:35
	...
	v_add_lshl_u32 v43, v39, s98, 1
	v_add_lshl_u32 v44, v39, s99, 1
	v_add_lshl_u32 v45, v39, s100, 1
	.loc	1 881 25                        ; attention.py:881:25
	s_waitcnt lgkmcnt(0)
