	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v8, s33, v33
	v_or_b32_e32 v9, s33, v32
	v_or_b32_e32 v14, s33, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[22:23], v9, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v8, v[10:13] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(3)
	ds_store_b64 v24, v[6:7] offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v24, v[22:23] offset:18432
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v8, v[14:17] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v8, v[18:21] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	v_dual_mov_b32 v24, 0 :: v_dual_and_b32 v1, 48, v9
	v_dual_mov_b32 v23, 0 :: v_dual_mov_b32 v16, 0
	v_dual_mov_b32 v22, 0 :: v_dual_mov_b32 v21, 0
	v_mov_b32_e32 v14, 0
	v_lshl_or_b32 v28, v26, 6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v17, v17, v49 :: v_dual_add_nc_u32 v146, s6, v39
	v_dual_add_f32 v14, v14, v52 :: v_dual_add_nc_u32 v147, s1, v38
	...
	v_dual_add_f32 v19, v19, v47 :: v_dual_add_f32 v18, v18, v48
	v_dual_add_f32 v16, v16, v50 :: v_dual_add_f32 v15, v15, v51
	v_dual_add_f32 v13, v13, v53 :: v_dual_add_f32 v12, v12, v54
...
; %bb.8:
	...
	v_dual_add_f32 v10, v10, v5 :: v_dual_add_f32 v11, v11, v6
...
.LBB0_11:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v2, v11, v2 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or3_b32 v26, v26, v27, s14
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v24, v4 :: v_dual_add_f32 v7, v21, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_or_b32_e32 v27, 32, v1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v25, v3 :: v_dual_lshlrev_b32 v26, 1, v26
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	...
	v_or_b32_e32 v29, 8, v26
	s_mov_b32 s4, s18
	v_or_b32_e32 v30, 12, v26
	v_or_b32_e32 v31, 16, v26
	v_or_b32_e32 v41, 20, v26
	v_or_b32_e32 v42, 24, v26
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v22, v6 :: v_dual_add_f32 v35, v16, v35
	v_dual_add_f32 v8, v20, v8 :: v_dual_add_f32 v33, v18, v33
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v49, 1, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_add_f32_e32 v40, v10, v40
	v_dual_add_f32 v5, v23, v5 :: v_dual_and_b32 v44, 0x7f, v0
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_bfe_i32 v45, v0, 7, 1
	v_lshrrev_b32_e32 v46, 7, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v38, v13, v38 :: v_dual_and_b32 v47, 14, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v2, v11, v2, s2
	v_cndmask_b32_e64 v4, v24, v4, s2
	v_cndmask_b32_e64 v11, v22, v6, s2
	v_cndmask_b32_e64 v7, v21, v7, s2
	v_cndmask_b32_e64 v6, v18, v33, s2
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshlrev_b32_e32 v21, 6, v49
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v24, v10, v40, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v32, v19, v32 :: v_dual_add_f32 v37, v14, v37
	v_dual_add_f32 v34, v17, v34 :: v_dual_add_f32 v39, v12, v39
	v_dual_add_f32 v36, v15, v36 :: v_dual_and_b32 v9, 0x380, v9
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v22, 0x440, v45
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_add_i32 s1, s1, s14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v19, v19, v32, s2
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v32, v21, s4, 2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v55, v1, v12 :: v_dual_lshlrev_b32 v14, 2, v47
	v_mul_f32_e32 v52, v0, v27
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_or3_b32 v8, v9, v14, v18
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	...
	v_xad_u32 v45, 0x808, v8, 0
	v_xad_u32 v46, 0x1010, v8, 0
	v_xad_u32 v47, 0x1818, v8, 0
	v_xad_u32 v48, 0x2020, v8, 0
	v_xad_u32 v49, 0x2828, v8, 0
	v_xad_u32 v50, 0x3030, v8, 0
	v_xad_u32 v51, 0x3838, v8, 0
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v8, 16, v26
	v_lshlrev_b32_e32 v26, 16, v41
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v30, v0, v9
	v_mul_f32_e32 v31, v0, v10
	v_mul_f32_e32 v41, v0, v12
	v_mul_f32_e32 v29, v0, v8
	v_mul_f32_e32 v42, v0, v14
	v_mul_f32_e32 v43, v0, v26
	v_mul_f32_e32 v53, v0, v28
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v12, v20, v52 :: v_dual_mul_f32 v3, v17, v9
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v8, v1, v8
	v_mul_f32_e32 v27, v1, v27
	v_mul_f32_e32 v54, v1, v10
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v10, v7, v43
	v_mul_f32_e32 v7, v15, v55
	v_mul_f32_e32 v15, v24, v28
	v_dual_mul_f32 v9, v23, v56 :: v_dual_mul_f32 v26, v1, v26
	v_dual_mul_f32 v1, v6, v8 :: v_dual_mul_f32 v6, v5, v41
	v_mul_f32_e32 v8, v11, v42
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v14, v19, v53 :: v_dual_mul_f32 v11, v13, v26
	v_mul_f32_e32 v13, v22, v27
	v_mul_f32_e32 v5, v16, v54
	...
	v_add_lshl_u32 v16, v21, s5, 2
	v_add_lshl_u32 v17, v21, s8, 2
	v_add_lshl_u32 v19, v21, s9, 2
	v_add_lshl_u32 v20, v21, s10, 2
	v_add_lshl_u32 v22, v21, s11, 2
	v_add_lshl_u32 v23, v21, s16, 2
	v_add_lshl_u32 v24, v21, s17, 2
	v_add_lshl_u32 v26, v21, s18, 2
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v0, v18, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v2, v25, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v4, v32, s[12:15], 0 offen
	s_waitcnt lgkmcnt(4)
	...
	buffer_atomic_add_f32 v5, v26, s[12:15], 0 offen
	v_add_lshl_u32 v27, v21, s19, 2
	v_add_lshl_u32 v28, v21, s20, 2
	v_add_lshl_u32 v29, v21, s21, 2
	v_add_lshl_u32 v30, v21, s22, 2
	v_add_lshl_u32 v0, v21, s0, 2
	s_clause 0x4
	buffer_atomic_add_f32 v7, v27, s[12:15], 0 offen
	buffer_atomic_add_f32 v9, v28, s[12:15], 0 offen
	buffer_atomic_add_f32 v11, v29, s[12:15], 0 offen
	buffer_atomic_add_f32 v13, v30, s[12:15], 0 offen
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_vgpr, 148
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.kd
