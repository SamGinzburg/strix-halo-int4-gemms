...
.Ltmp2:
	...
	v_dual_mov_b32 v134, 0 :: v_dual_and_b32 v111, 0xf0, v0
	s_xor_b32 s4, s4, s6
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v127, 0 :: v_dual_and_b32 v12, 24, v7
	v_dual_mov_b32 v132, 0 :: v_dual_and_b32 v11, 24, v8
	v_dual_mov_b32 v130, 0 :: v_dual_and_b32 v7, 0x70, v7
	.loc	1 562 18 is_stmt 0              ; ragged.py:562:18
	v_dual_mov_b32 v135, 0 :: v_dual_lshlrev_b32 v6, 3, v0
	.loc	1 563 18 is_stmt 1              ; ragged.py:563:18
	v_lshl_or_b32 v2, v1, 4, s29
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v143, v1, 5, v11
	v_add3_u32 v144, 0, v1, v7
	.loc	1 558 20                        ; ragged.py:558:20
	s_waitcnt lgkmcnt(0)
	s_add_u32 s0, s6, s30
	s_addc_u32 s1, s7, s31
	v_dual_mov_b32 v128, 0 :: v_dual_lshlrev_b32 v1, 2, v111
	.loc	1 652 25                        ; ragged.py:652:25
	s_load_b32 s7, s[0:1], 0x0
	.loc	1 562 18                        ; ragged.py:562:18
	v_add_co_u32 v3, s0, s24, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_add_co_ci_u32_e64 v4, null, s25, 0, s0
	v_dual_mov_b32 v126, 0 :: v_dual_and_b32 v7, 32, v10
	v_dual_mov_b32 v124, 0 :: v_dual_add_nc_u32 v5, s24, v5
	.loc	1 564 21                        ; ragged.py:564:21
	...
	.loc	1 563 18 is_stmt 1              ; ragged.py:563:18
	v_or_b32_e32 v136, s29, v0
	v_dual_mov_b32 v134, 0 :: v_dual_lshlrev_b32 v9, 4, v0
	v_dual_mov_b32 v129, 0 :: v_dual_and_b32 v142, 24, v6
	v_xor_b32_e32 v4, 8, v143
	v_xor_b32_e32 v6, 16, v143
	v_xor_b32_e32 v11, 24, v143
	.loc	1 628 39                        ; ragged.py:628:39
	s_mul_i32 s25, s9, s33
	v_dual_mov_b32 v125, 0 :: v_dual_and_b32 v8, 28, v8
	v_add3_u32 v1, 0, v1, v7
	v_dual_mov_b32 v122, 0 :: v_dual_lshlrev_b32 v7, 1, v111
	.loc	1 645 25                        ; ragged.py:645:25
	v_mul_lo_u32 v138, v109, s28
	v_mul_lo_u32 v139, v112, s28
	v_mul_lo_u32 v140, v114, s28
	v_mul_lo_u32 v141, v115, s28
	v_mul_lo_u32 v145, v5, s9
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[65:66], null, s25, s7, v[2:3]
	.loc	1 611 28                        ; ragged.py:611:28
	v_lshrrev_b32_e32 v137, 4, v111
	.loc	1 565 20                        ; ragged.py:565:20
	v_cmp_gt_i32_e64 s0, s33, v2
	v_cmp_gt_i32_e64 s1, s33, v136
	v_dual_mov_b32 v123, 0 :: v_dual_add_nc_u32 v146, 0, v3
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v147, 0, v4
	v_dual_mov_b32 v121, 0 :: v_dual_add_nc_u32 v148, 0, v6
	v_dual_mov_b32 v118, 0 :: v_dual_add_nc_u32 v149, 0, v11
	v_dual_mov_b32 v119, 0 :: v_dual_add_nc_u32 v150, 0, v9
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v151, v1, v8
	v_dual_mov_b32 v117, 0 :: v_dual_add_nc_u32 v152, 0, v7
...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_nc_u32_e32 v165, 0, v143
	.loc	1 619 26                        ; ragged.py:619:26
	v_or_b32_e32 v154, s6, v142
	v_or_b32_e32 v153, s6, v137
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 620 31                        ; ragged.py:620:31
	v_cmp_gt_i32_e32 vcc_lo, s9, v154
	.loc	1 629 42                        ; ragged.py:629:42
	v_add_nc_u32_e32 v154, v145, v154
	.loc	1 619 26                        ; ragged.py:619:26
	v_or_b32_e32 v155, 16, v153
	.loc	1 620 31                        ; ragged.py:620:31
	v_cmp_gt_i32_e64 s6, s9, v153
	...
	.loc	1 630 42 is_stmt 1              ; ragged.py:630:42
	v_mad_u64_u32 v[157:158], null, v155, s33, v[65:66]
	.loc	1 620 31                        ; ragged.py:620:31
	v_cmp_gt_i32_e64 s7, s9, v155
	.loc	1 630 66                        ; ragged.py:630:66
	s_and_b32 vcc_lo, s0, s6
	.loc	1 629 34                        ; ragged.py:629:34
	buffer_load_b64 v[161:162], v154, s[24:27], 0 offen
	.loc	1 630 42                        ; ragged.py:630:42
	v_mad_u64_u32 v[153:154], null, v153, s33, v[65:66]
	.loc	1 630 66 is_stmt 0              ; ragged.py:630:66
	s_and_b32 s6, s0, s7
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 630 34                        ; ragged.py:630:34
	v_cndmask_b32_e64 v157, 0x80000000, v157, s6
	s_mov_b32 s6, 32
	v_cndmask_b32_e32 v153, 0x80000000, v153, vcc_lo
	.loc	1 618 23 is_stmt 1              ; ragged.py:618:23
	s_and_b32 vcc_lo, exec_lo, s19
	s_mov_b32 s19, 0
	.loc	1 630 34                        ; ragged.py:630:34
	s_clause 0x1
	buffer_load_b128 v[157:160], v157, s[12:15], 0 offen
	buffer_load_b128 v[153:156], v153, s[12:15], 0 offen
	.loc	1 629 34                        ; ragged.py:629:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v146, v[161:162]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[161:164], v165 offset1:1
	ds_load_2addr_stride64_b64 v[165:168], v165 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[169:172], v147 offset1:1
	ds_load_2addr_stride64_b64 v[173:176], v147 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[177:180], v148 offset1:1
	ds_load_2addr_stride64_b64 v[181:184], v148 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[185:188], v149 offset1:1
	ds_load_2addr_stride64_b64 v[189:192], v149 offset0:2 offset1:3
	.loc	1 630 34                        ; ragged.py:630:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v150, v[153:156]
	ds_store_b128 v150, v[157:160] offset:4096
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 631 31                        ; ragged.py:631:31
	ds_load_u8 v153, v144 offset:1280
	ds_load_u8 v154, v144 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v153, v154, v153, 0xc0c0004
	ds_load_u8 v154, v144 offset:1792
	ds_load_u8 v155, v144 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v154, v155, v154, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v154, v154, 16, v153
	ds_load_u8 v153, v144 offset:256
	ds_load_u8 v155, v144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v153, v155, v153, 0xc0c0004
	ds_load_u8 v155, v144 offset:768
	ds_load_u8 v156, v144 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v155, v156, v155, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v153, v155, 16, v153
	ds_load_u8 v155, v144 offset:3328
	ds_load_u8 v156, v144 offset:3072
	v_wmma_i32_16x16x16_iu4 v[1:8], v[153:154], v[161:162], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[153:154], v[163:164], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[153:154], v[165:166], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[153:154], v[167:168], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v155, v156, v155, 0xc0c0004
	ds_load_u8 v156, v144 offset:3840
	ds_load_u8 v157, v144 offset:3584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v156, v157, v156, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v156, v156, 16, v155
	ds_load_u8 v155, v144 offset:2304
	ds_load_u8 v157, v144 offset:2048
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v155, v157, v155, 0xc0c0004
	ds_load_u8 v157, v144 offset:2816
	ds_load_u8 v158, v144 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v157, v158, v157, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v155, v157, 16, v155
	ds_load_u8 v157, v144 offset:5376
	ds_load_u8 v158, v144 offset:5120
	v_wmma_i32_16x16x16_iu4 v[1:8], v[155:156], v[169:170], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[155:156], v[171:172], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[155:156], v[173:174], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[155:156], v[175:176], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v157, v158, v157, 0xc0c0004
	ds_load_u8 v158, v144 offset:5888
	ds_load_u8 v159, v144 offset:5632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v158, v159, v158, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v158, v158, 16, v157
	ds_load_u8 v157, v144 offset:4352
	ds_load_u8 v159, v144 offset:4096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v157, v159, v157, 0xc0c0004
	ds_load_u8 v159, v144 offset:4864
	ds_load_u8 v160, v144 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v159, v160, v159, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v157, v159, 16, v157
	ds_load_u8 v159, v144 offset:7424
	ds_load_u8 v160, v144 offset:7168
	v_wmma_i32_16x16x16_iu4 v[1:8], v[157:158], v[177:178], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[157:158], v[179:180], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[157:158], v[181:182], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[157:158], v[183:184], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v159, v160, v159, 0xc0c0004
	ds_load_u8 v160, v144 offset:7936
	ds_load_u8 v193, v144 offset:7680
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v160, v193, v160, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v160, v160, 16, v159
	ds_load_u8 v159, v144 offset:6400
	ds_load_u8 v193, v144 offset:6144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v159, v193, v159, 0xc0c0004
	ds_load_u8 v193, v144 offset:6912
	ds_load_u8 v194, v144 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v193, v194, v193, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v159, v193, 16, v159
	ds_load_u8 v193, v144 offset:1408
	ds_load_u8 v194, v144 offset:1152
	v_wmma_i32_16x16x16_iu4 v[1:8], v[159:160], v[185:186], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[159:160], v[187:188], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[159:160], v[189:190], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[159:160], v[191:192], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v193, v194, v193, 0xc0c0004
	ds_load_u8 v194, v144 offset:1920
	ds_load_u8 v195, v144 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v194, v195, v194, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v194, v194, 16, v193
	ds_load_u8 v193, v144 offset:384
	ds_load_u8 v195, v144 offset:128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v193, v195, v193, 0xc0c0004
	ds_load_u8 v195, v144 offset:896
	ds_load_u8 v196, v144 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v195, v196, v195, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v193, v195, 16, v193
	v_wmma_i32_16x16x16_iu4 v[9:16], v[193:194], v[161:162], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v161, v144 offset:3456
	ds_load_u8 v162, v144 offset:3200
	v_wmma_i32_16x16x16_iu4 v[25:32], v[193:194], v[163:164], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[193:194], v[165:166], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[193:194], v[167:168], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v161, v162, v161, 0xc0c0004
	ds_load_u8 v162, v144 offset:3968
	ds_load_u8 v195, v144 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v162, v195, v162, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v162, v162, 16, v161
	ds_load_u8 v161, v144 offset:2432
	ds_load_u8 v195, v144 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v161, v195, v161, 0xc0c0004
	ds_load_u8 v195, v144 offset:2944
	ds_load_u8 v196, v144 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v195, v196, v195, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v161, v195, 16, v161
	v_wmma_i32_16x16x16_iu4 v[9:16], v[161:162], v[169:170], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v169, v144 offset:5504
	ds_load_u8 v170, v144 offset:5248
	v_wmma_i32_16x16x16_iu4 v[25:32], v[161:162], v[171:172], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[161:162], v[173:174], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[161:162], v[175:176], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v169, v170, v169, 0xc0c0004
	ds_load_u8 v170, v144 offset:6016
	ds_load_u8 v195, v144 offset:5760
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v170, v195, v170, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v170, v170, 16, v169
	ds_load_u8 v169, v144 offset:4480
	ds_load_u8 v195, v144 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v169, v195, v169, 0xc0c0004
	ds_load_u8 v195, v144 offset:4992
	ds_load_u8 v196, v144 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v195, v196, v195, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v169, v195, 16, v169
	v_wmma_i32_16x16x16_iu4 v[9:16], v[169:170], v[177:178], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v177, v144 offset:7552
	ds_load_u8 v178, v144 offset:7296
	v_wmma_i32_16x16x16_iu4 v[25:32], v[169:170], v[179:180], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[169:170], v[181:182], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[169:170], v[183:184], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v177, v178, v177, 0xc0c0004
	ds_load_u8 v178, v144 offset:8064
	ds_load_u8 v195, v144 offset:7808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v178, v195, v178, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v178, v178, 16, v177
	ds_load_u8 v177, v144 offset:6528
	ds_load_u8 v195, v144 offset:6272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v177, v195, v177, 0xc0c0004
	ds_load_u8 v195, v144 offset:7040
	ds_load_u8 v196, v144 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v195, v196, v195, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v177, v195, 16, v177
	v_wmma_i32_16x16x16_iu4 v[9:16], v[177:178], v[185:186], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[177:178], v[187:188], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[177:178], v[189:190], v[41:48] neg_lo:[1,1,0]
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_add_lshl_u32 v153, s8, v138, 1
	.loc	1 652 25                        ; ragged.py:652:25
	s_add_i32 s6, s8, s31
	.loc	1 644 40                        ; ragged.py:644:40
	v_add_lshl_u32 v154, s8, v139, 1
	v_add_lshl_u32 v155, s8, v140, 1
	.loc	1 652 25                        ; ragged.py:652:25
	s_mul_i32 s6, s6, s33
	.loc	1 644 40                        ; ragged.py:644:40
	v_add_lshl_u32 v156, s8, v141, 1
	.loc	1 651 40                        ; ragged.py:651:40
	v_add_lshl_u32 v157, v136, s6, 1
	.loc	1 644 40                        ; ragged.py:644:40
	v_cndmask_b32_e64 v153, 0x80000000, v153, s5
	...
	v_dual_mul_f32 v18, v18, v154 :: v_dual_lshlrev_b32 v153, 16, v153
	s_delay_alu instid0(VALU_DEP_1)
	v_mul_f32_e32 v159, v2, v153
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v20, v20, v154 :: v_dual_lshlrev_b32 v157, 16, v157
	v_dual_mul_f32 v158, v1, v153 :: v_dual_lshlrev_b32 v155, 16, v155
	v_dual_mul_f32 v161, v4, v153 :: v_dual_lshlrev_b32 v156, 16, v156
	v_dual_mul_f32 v160, v3, v153 :: v_dual_mul_f32 v17, v17, v154
	v_dual_mul_f32 v162, v5, v153 :: v_dual_mul_f32 v19, v19, v154
	v_dual_mul_f32 v163, v6, v153 :: v_dual_mul_f32 v24, v24, v154
	v_dual_mul_f32 v164, v7, v153 :: v_dual_mul_f32 v21, v21, v154
	v_dual_mul_f32 v165, v8, v153 :: v_dual_mul_f32 v22, v22, v154
	v_dual_mul_f32 v166, v9, v153 :: v_dual_mul_f32 v23, v23, v154
	v_dual_mul_f32 v167, v10, v153 :: v_dual_mul_f32 v28, v28, v154
	v_dual_mul_f32 v168, v11, v153 :: v_dual_mul_f32 v25, v25, v154
	v_dual_mul_f32 v169, v12, v153 :: v_dual_mul_f32 v26, v26, v154
	v_dual_mul_f32 v170, v13, v153 :: v_dual_mul_f32 v27, v27, v154
	v_dual_mul_f32 v171, v14, v153 :: v_dual_mul_f32 v32, v32, v154
	v_dual_mul_f32 v172, v15, v153 :: v_dual_mul_f32 v29, v29, v154
	v_dual_mul_f32 v153, v16, v153 :: v_dual_mul_f32 v30, v30, v154
	.loc	1 656 21                        ; ragged.py:656:21
	...
	.loc	1 649 21                        ; ragged.py:649:21
	v_dual_mul_f32 v31, v31, v154 :: v_dual_mul_f32 v34, v34, v155
	v_dual_mul_f32 v33, v33, v155 :: v_dual_mul_f32 v50, v50, v156
	v_dual_mul_f32 v35, v35, v155 :: v_dual_mul_f32 v52, v52, v156
	v_dual_mul_f32 v36, v36, v155 :: v_dual_mul_f32 v49, v49, v156
	v_dual_mul_f32 v37, v37, v155 :: v_dual_mul_f32 v54, v54, v156
	v_dual_mul_f32 v38, v38, v155 :: v_dual_mul_f32 v51, v51, v156
	v_dual_mul_f32 v39, v39, v155 :: v_dual_mul_f32 v56, v56, v156
	v_dual_mul_f32 v40, v40, v155 :: v_dual_mul_f32 v53, v53, v156
	v_dual_mul_f32 v41, v41, v155 :: v_dual_mul_f32 v58, v58, v156
	v_dual_mul_f32 v42, v42, v155 :: v_dual_mul_f32 v55, v55, v156
	v_dual_mul_f32 v43, v43, v155 :: v_dual_mul_f32 v60, v60, v156
	v_dual_mul_f32 v44, v44, v155 :: v_dual_mul_f32 v57, v57, v156
	v_dual_mul_f32 v45, v45, v155 :: v_dual_mul_f32 v62, v62, v156
	v_dual_mul_f32 v46, v46, v155 :: v_dual_mul_f32 v59, v59, v156
	v_dual_mul_f32 v47, v47, v155 :: v_dual_mul_f32 v64, v64, v156
	v_dual_mul_f32 v48, v48, v155 :: v_dual_mul_f32 v61, v61, v156
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v63, v63, v156 :: v_dual_fmac_f32 v134, v158, v1
	.loc	1 657 17                        ; ragged.py:657:17
	v_dual_fmac_f32 v133, v159, v2 :: v_dual_fmac_f32 v132, v160, v3
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v131, v161, v4 :: v_dual_fmac_f32 v130, v162, v5
	v_dual_fmac_f32 v129, v163, v6 :: v_dual_fmac_f32 v128, v164, v7
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v127, v165, v8 :: v_dual_fmac_f32 v126, v166, v9
	v_dual_fmac_f32 v125, v167, v10 :: v_dual_fmac_f32 v124, v168, v11
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v123, v169, v12 :: v_dual_fmac_f32 v122, v170, v13
	v_dual_fmac_f32 v121, v171, v14 :: v_dual_fmac_f32 v120, v172, v15
	v_dual_fmac_f32 v119, v153, v16 :: v_dual_fmac_f32 v116, v19, v3
	v_dual_fmac_f32 v118, v17, v1 :: v_dual_fmac_f32 v117, v18, v2
	v_dual_fmac_f32 v113, v20, v4 :: v_dual_fmac_f32 v110, v21, v5
	v_dual_fmac_f32 v108, v22, v6 :: v_dual_fmac_f32 v107, v23, v7
	...
	v_dual_fmac_f32 v98, v32, v16 :: v_dual_fmac_f32 v97, v33, v1
	v_dual_fmac_f32 v96, v34, v2 :: v_dual_fmac_f32 v95, v35, v3
	v_dual_fmac_f32 v94, v36, v4 :: v_dual_fmac_f32 v93, v37, v5
	v_dual_fmac_f32 v92, v38, v6 :: v_dual_fmac_f32 v91, v39, v7
	v_dual_fmac_f32 v90, v40, v8 :: v_dual_fmac_f32 v89, v41, v9
	v_dual_fmac_f32 v88, v42, v10 :: v_dual_fmac_f32 v87, v43, v11
	v_dual_fmac_f32 v86, v44, v12 :: v_dual_fmac_f32 v85, v45, v13
	v_dual_fmac_f32 v84, v46, v14 :: v_dual_fmac_f32 v83, v47, v15
	v_dual_fmac_f32 v82, v48, v16 :: v_dual_fmac_f32 v81, v49, v1
	v_dual_fmac_f32 v80, v50, v2 :: v_dual_fmac_f32 v79, v51, v3
	v_dual_fmac_f32 v78, v52, v4 :: v_dual_fmac_f32 v77, v53, v5
	v_dual_fmac_f32 v76, v54, v6 :: v_dual_fmac_f32 v75, v55, v7
	v_dual_fmac_f32 v74, v56, v8 :: v_dual_fmac_f32 v73, v57, v9
	v_dual_fmac_f32 v72, v58, v10 :: v_dual_fmac_f32 v71, v59, v11
	v_dual_fmac_f32 v70, v60, v12 :: v_dual_fmac_f32 v69, v61, v13
	v_dual_fmac_f32 v68, v62, v14 :: v_dual_fmac_f32 v67, v63, v15
	v_fmac_f32_e32 v66, v64, v16
	.loc	1 614 19                        ; ragged.py:614:19
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add3_u32 v18, v113, v18, 0x7fff
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 197
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 34
