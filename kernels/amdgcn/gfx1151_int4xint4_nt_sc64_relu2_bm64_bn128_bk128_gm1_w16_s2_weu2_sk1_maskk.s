	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v15, 0 :: v_dual_and_b32 v2, 24, v9
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v1, s16 :: v_dual_add_nc_u32 v46, 0, v13
	v_dual_mov_b32 v3, s18 :: v_dual_add_nc_u32 v48, 0, v14
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b64 v[81:82], v51, s[24:27], 0 offen
	...
	s_clause 0x1
	buffer_load_u16 v67, v42, s[28:31], 0 offen
	buffer_load_u16 v68, v41, s[28:31], 0 offen
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	s_waitcnt lgkmcnt(2)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v60, v60, v68 :: v_dual_lshlrev_b32 v67, 16, v67
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v11, v51, v70 :: v_dual_lshlrev_b32 v76, 16, v76
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v69, 16, v69
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v59, v59, v68 :: v_dual_fmac_f32 v26, v52, v71
	v_dual_mul_f32 v61, v61, v68 :: v_dual_fmac_f32 v24, v54, v73
	v_dual_mul_f32 v63, v63, v68 :: v_dual_fmac_f32 v22, v56, v75
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v65, v65, v68 :: v_dual_fmac_f32 v20, v58, v69
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v25, v53, v72 :: v_dual_fmac_f32 v18, v60, v71
	v_dual_fmac_f32 v23, v55, v74 :: v_dual_fmac_f32 v16, v62, v73
	v_dual_fmac_f32 v21, v57, v76 :: v_dual_fmac_f32 v14, v64, v75
	v_dual_fmac_f32 v19, v59, v70 :: v_dual_fmac_f32 v12, v66, v69
	v_fmac_f32_e32 v17, v61, v72
	v_fmac_f32_e32 v15, v63, v74
	v_fmac_f32_e32 v13, v65, v76
...
; %bb.4:
	...
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v47, s23 :: v_dual_mov_b32 v40, s16
	v_mov_b32_e32 v46, s22
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	v_or3_b32 v33, v34, v1, v33
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v44, s20 :: v_dual_add_nc_u32 v1, 0, v32
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_xad_u32 v8, v32, 8, 0
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v42, s18 :: v_dual_add_nc_u32 v7, 0, v33
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
...
.LBB0_5:
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v8, v8, v32 :: v_dual_lshlrev_b32 v33, 16, v33
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v10, v10, v32 :: v_dual_lshlrev_b32 v41, 16, v42
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v7, v7, v32 :: v_dual_lshlrev_b32 v42, 16, v43
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v2, v2, v33, v26
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v32 :: v_dual_lshlrev_b32 v34, 16, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v9, v9, v42, v23
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v38, v38, v32 :: v_dual_max_f32 v3, v3, v3
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	...
	v_dual_mul_f32 v32, v40, v32 :: v_dual_max_f32 v5, v5, v5
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v13, v13, v34, s2
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_max_f32_e32 v6, v6, v6
	v_dual_max_f32 v16, v20, v20 :: v_dual_max_f32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v11, v11, v11 :: v_dual_mul_f32 v4, v4, v4
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v17, 1, v49
	v_dual_mul_f32 v13, v13, v13 :: v_dual_and_b32 v18, 1, v46
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v8, v8, v8 :: v_dual_and_b32 v19, 1, v50
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v12, v12, v12 :: v_dual_and_b32 v23, 1, v54
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v29, s[4:7], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 92
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
