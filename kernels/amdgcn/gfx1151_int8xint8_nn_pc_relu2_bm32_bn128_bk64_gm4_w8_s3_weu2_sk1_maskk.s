...
.Ltmp13:
	...
	s_waitcnt vmcnt(4)
	v_perm_b32 v8, v10, v4, 0x5010400
	v_perm_b32 v10, v10, v4, 0x7030602
	v_perm_b32 v23, v12, v6, 0x5010400
	v_perm_b32 v12, v12, v6, 0x7030602
	v_perm_b32 v24, v13, v7, 0x5010400
	v_perm_b32 v13, v13, v7, 0x7030602
	v_lshrrev_b32_e32 v25, 8, v8
	v_lshrrev_b32_e32 v30, 24, v8
	v_perm_b32 v22, v11, v5, 0x5010400
	v_perm_b32 v11, v11, v5, 0x7030602
	...
	ds_store_b16 v49, v10 offset:640
	ds_store_b16_d16_hi v49, v10 offset:704
	...
	v_lshlrev_b16 v20.h, 8, v58.l
	v_or_b16 v4.l, v4.l, v13.l
	v_or_b16 v4.h, v4.h, v13.h
	v_or_b16 v5.l, v5.l, v14.l
	v_or_b16 v5.h, v5.h, v14.h
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v6.l, v6.l, v15.l
	v_or_b16 v6.h, v6.h, v15.h
	...
	ds_store_b16 v49, v10 offset:8832
	ds_store_b16_d16_hi v49, v10 offset:8896
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v17, v17, v60 :: v_dual_add_nc_u32 v122, s31, v38
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v16, v16, v61 :: v_dual_add_nc_u32 v123, s31, v39
	v_dual_add_f32 v15, v15, v62 :: v_dual_add_f32 v14, v14, v63
	v_dual_add_f32 v13, v13, v64 :: v_dual_add_nc_u32 v126, s31, v42
	v_dual_add_f32 v11, v11, v66 :: v_dual_add_nc_u32 v124, s31, v40
	v_dual_add_f32 v12, v12, v65 :: v_dual_add_nc_u32 v127, s31, v43
...
; %bb.8:
	...
	v_add_nc_u32_e32 v34, s4, v4
	v_add_nc_u32_e32 v35, s4, v3
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v39, s13 :: v_dual_add_nc_u32 v42, s1, v32
	v_dual_mov_b32 v38, s12 :: v_dual_mov_b32 v37, s11
	...
	v_dual_add_f32 v20, v20, v27 :: v_dual_add_f32 v17, v17, v5
	v_dual_add_f32 v18, v18, v29 :: v_dual_add_f32 v15, v15, v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v19, v19, v28 :: v_dual_add_f32 v14, v14, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_f32 v12, v12, v7 :: v_dual_add_f32 v13, v13, v6
	v_dual_add_f32 v11, v11, v8 :: v_dual_add_f32 v10, v10, v26
.LBB0_9:
...
; %bb.10:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v41, s11 :: v_dual_add_nc_u32 v4, s31, v4
	v_dual_mov_b32 v39, s9 :: v_dual_mov_b32 v38, s8
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[42:45], v26
	ds_load_b128 v[46:49], v27
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v36, s6 :: v_dual_add_nc_u32 v27, s3, v31
	v_mov_b32_e32 v37, s7
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[50:53], v28 offset:1024
	ds_load_b128 v[54:57], v28
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v35, s5 :: v_dual_add_nc_u32 v26, s3, v33
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[62:65], v27 offset:1024
	ds_load_b128 v[66:69], v27
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v40, s10 :: v_dual_add_nc_u32 v5, s31, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[1:4], v4
	ds_load_b128 v[5:8], v5
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v28, s3, v32
	ds_load_b128 v[58:61], v26
	ds_load_b128 v[70:73], v26 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_mov_b32_e32 v34, s4
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[74:77], v28
	ds_load_b128 v[78:81], v28 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
...
.LBB0_11:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_add_f32 v5, v10, v5 :: v_dual_lshlrev_b32 v2, 1, v2
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v28, v20, v28 :: v_dual_add_f32 v35, v17, v35
	...
	s_mov_b32 s4, s26
	v_or_b32_e32 v30, 4, v3
	v_or_b32_e32 v31, 8, v3
	v_or_b32_e32 v32, 12, v3
	v_or_b32_e32 v33, 16, v3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v34, v18, v34 :: v_dual_add_f32 v37, v15, v37
	v_dual_add_f32 v36, v16, v36 :: v_dual_add_f32 v39, v13, v39
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_add_f32 v38, v14, v38 :: v_dual_add_f32 v41, v11, v41
	v_dual_add_f32 v40, v12, v40 :: v_dual_mov_b32 v47, 0x7632
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v12, v12, v40, s2
	v_cndmask_b32_e64 v11, v11, v41, s2
	...
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v39, v2, v31 :: v_dual_lshlrev_b32 v36, 16, v44
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	v_lshlrev_b32_e32 v33, 16, v33
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v31, v4, v31 :: v_dual_lshlrev_b32 v30, 16, v30
	v_dual_mul_f32 v34, v4, v34 :: v_dual_mul_f32 v3, v18, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v41, v2, v33
	v_dual_mul_f32 v38, v2, v30 :: v_dual_and_b32 v1, 0x78, v1
	v_dual_mul_f32 v30, v4, v30 :: v_dual_mul_f32 v43, v2, v35
	v_mul_f32_e32 v40, v2, v32
	v_mul_f32_e32 v2, v2, v36
	v_dual_mul_f32 v32, v4, v32 :: v_dual_mul_f32 v5, v5, v37
	...
	v_dual_mul_f32 v8, v8, v40 :: v_dual_mul_f32 v17, v17, v30
	v_dual_mul_f32 v18, v21, v42 :: v_dual_max_f32 v5, 0, v5
	v_dual_mul_f32 v20, v20, v43 :: v_dual_mul_f32 v13, v13, v34
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v14, v14, v33 :: v_dual_max_f32 v7, 0, v7
	v_dual_mul_f32 v10, v10, v41 :: v_dual_mul_f32 v15, v15, v32
	...
	v_dual_max_f32 v11, 0, v18 :: v_dual_max_f32 v18, 0, v20
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v7, v7, v7
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v12, v12, v35 :: v_dual_max_f32 v17, 0, v17
	...
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v2, v19, v2 :: v_dual_max_f32 v3, 0, v3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v16, 0, v16 :: v_dual_mul_f32 v17, v17, v17
	v_dual_max_f32 v15, 0, v15 :: v_dual_max_f32 v14, 0, v14
	v_dual_max_f32 v4, 0, v4 :: v_dual_and_b32 v19, 1, v45
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v23, 1, v25
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v19, 1, v45
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_add3_u32 v2, v15, v3, 0x7fff
	v_dual_mov_b32 v46, 0x5410 :: v_dual_and_b32 v3, 1, v45
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v4, v4, v4 :: v_dual_lshlrev_b32 v29, 1, v9
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v12, v12, v12 :: v_dual_cndmask_b32 v5, v7, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_lshl_or_b32 v8, v10, 8, v10
	v_dual_cndmask_b32 v6, v6, v7 :: v_dual_cndmask_b32 v7, 0x1054, v46
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_perm_b32 v0, v6, v5, v12
	v_perm_b32 v2, v10, v11, v12
	v_perm_b32 v4, v14, v8, v12
	v_permlanex16_b32 v15, v3, s1, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v3, v10, v11, v7
	v_perm_b32 v5, v14, v8, v7
	v_add_lshl_u32 v8, v9, s0, 1
	s_delay_alu instid0(VALU_DEP_4)
	v_perm_b32 v6, v15, v13, v12
	v_perm_b32 v7, v15, v13, v7
	s_clause 0x1
	buffer_store_b128 v[0:3], v29, s[16:19], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 129
