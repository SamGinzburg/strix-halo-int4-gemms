...
.Ltmp29:
	...
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v68, v68, v2 :: v_dual_mul_f32 v191, v73, v83
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_mul_f32 v170, v67, v82 :: v_dual_mul_f32 v183, v65, v83
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v135, v66, v85 :: v_dual_mul_f32 v190, v72, v83
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v169, v66, v82
	v_mul_f32_e32 v171, v68, v82
	v_mul_f32_e32 v172, v69, v82
	v_mul_f32_e32 v173, v70, v82
	v_mul_f32_e32 v174, v71, v82
	v_mul_f32_e32 v175, v72, v82
	v_mul_f32_e32 v176, v73, v82
	v_mul_f32_e32 v178, v75, v82
	...
	v_fma_f32 v85, v177, v33, v149
	v_fma_f32 v107, v180, v36, v152
	...
	v_fma_f32 v135, v182, v38, v154
	v_fma_f32 v39, v82, v39, v155
	v_fma_f32 v40, v183, v40, v121
	v_fma_f32 v82, v184, v41, v117
	v_fma_f32 v139, v185, v42, v116
	v_fma_f32 v163, v193, v50, v108
	v_fma_f32 v164, v194, v51, v106
	v_fma_f32 v166, v196, v53, v104
	v_fma_f32 v168, v65, v56, v101
	v_fma_f32 v57, v66, v57, v100
	v_fma_f32 v169, v67, v58, v99
	v_fma_f32 v170, v68, v59, v98
	v_fma_f32 v173, v71, v62, v95
...
.Ltmp31:
	...
	v_fma_f32 v126, v181, v37, v153
	v_fma_f32 v156, v186, v43, v115
	v_fma_f32 v157, v187, v44, v114
	v_fma_f32 v158, v188, v45, v113
	v_fma_f32 v160, v190, v47, v111
	v_fma_f32 v161, v191, v48, v110
	v_fma_f32 v162, v192, v49, v109
	v_fma_f32 v165, v195, v52, v105
	v_fma_f32 v167, v197, v54, v103
	v_fma_f32 v174, v72, v63, v94
	v_fma_f32 v75, v80, v8, v86
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v37, v120, v10, s2
	v_cndmask_b32_e64 v63, v81, v23, s2
	v_cndmask_b32_e64 v47, v121, v40, s2
...
.Ltmp33:
	...
	v_fma_f32 v159, v189, v46, v112
	v_fma_f32 v83, v83, v55, v102
	v_fma_f32 v171, v69, v60, v97
	v_fma_f32 v172, v70, v61, v96
	...
	v_cndmask_b32_e64 v52, v154, v135, s2
	v_cndmask_b32_e64 v49, v155, v39, s2
	v_cndmask_b32_e64 v44, v115, v156, s2
	v_cndmask_b32_e64 v39, v114, v157, s2
	v_cndmask_b32_e64 v40, v113, v158, s2
	v_cndmask_b32_e64 v30, v109, v162, s2
	v_cndmask_b32_e64 v28, v108, v163, s2
	v_cndmask_b32_e64 v29, v106, v164, s2
	v_cndmask_b32_e64 v27, v105, v165, s2
	v_cndmask_b32_e64 v26, v104, v166, s2
	v_cndmask_b32_e64 v24, v103, v167, s2
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp35:
	...
	v_cndmask_b32_e64 v43, v116, v139, s2
	v_cndmask_b32_e64 v34, v112, v159, s2
	v_cndmask_b32_e64 v35, v111, v160, s2
	v_cndmask_b32_e64 v32, v110, v161, s2
...
.Ltmp37:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v101, v168, s2
...
.Ltmp39:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v20, v98, v170, s2
	v_cndmask_b32_e64 v19, v97, v171, s2
	v_cndmask_b32_e64 v18, v96, v172, s2
.Ltmp40:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp41:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v22, v99, v169, s2
...
.Ltmp44:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v14, v95, v173, s2
	v_cndmask_b32_e64 v15, v94, v174, s2
.Ltmp45:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp48:
	...
	v_and_or_b32 v78, 0x680, v246, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp49:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp54:
	...
	v_dual_mov_b32 v1, v74 :: v_dual_mov_b32 v78, v76
.Ltmp55:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp57:
	...
	v_dual_max_f32 v75, v78, v78 :: v_dual_max_f32 v74, v76, v76
...
.Ltmp60:
	...
	v_dual_mov_b32 v77, v1 :: v_dual_max_f32 v78, v78, v78
...
.Ltmp65:
	...
	v_dual_max_f32 v74, v78, v78 :: v_dual_mov_b32 v79, v75
.Ltmp66:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp79:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v85, v76, v80 :: v_dual_mul_f32 v76, v86, v78
	...
	v_dual_fmac_f32 v93, v74, v86 :: v_dual_fmac_f32 v92, v87, v81
	.loc	1 77 9                          ; generate_amdgcn.py:77:9 @[ generate_amdgcn.py:446:9 ]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 53
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 56
