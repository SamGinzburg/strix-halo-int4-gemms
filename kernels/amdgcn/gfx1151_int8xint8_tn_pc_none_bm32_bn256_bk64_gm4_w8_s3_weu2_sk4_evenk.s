	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	.loc	1 327 14 is_stmt 1              ; generate_amdgcn.py:327:14
	v_lshrrev_b32_e32 v2, 4, v219
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_and_b32_e32 v221, 15, v219
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_mad_u64_u32 v[6:7], null, s29, 48, v[0:1]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_add3_u32 v4, v1, v3, s33
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v24, s6, v46
	v_add_nc_u32_e32 v25, s6, v6
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v13, 0x80000000, v5, s3
	v_dual_mov_b32 v44, v7 :: v_dual_mov_b32 v11, v6
	...
	v_cndmask_b32_e64 v26, 0x80000000, v3, s2
	v_cndmask_b32_e64 v28, 0x80000000, v12, s2
	s_clause 0x3
	buffer_load_b128 v[2:5], v2, s[24:27], 0 offen
	buffer_load_b128 v[12:15], v13, s[24:27], 0 offen
	buffer_load_b128 v[16:19], v8, s[24:27], 0 offen
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[32:33], v1, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	...
	buffer_load_b128 v[40:43], v34, s[24:27], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	s_waitcnt vmcnt(7)
	ds_store_b128 v34, v[12:15] offset:4096
	s_waitcnt vmcnt(6)
	ds_store_b128 v34, v[16:19] offset:8192
	s_waitcnt vmcnt(5)
	ds_store_b128 v34, v[20:23] offset:12288
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b64 v8, v[32:33] offset:34816
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v34, v[24:27] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v34, v[28:31] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v34, v[36:39] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v34, v[40:43] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	s_mov_b32 s9, s4
	s_mov_b32 s10, s4
	v_dual_mov_b32 v235, v11 :: v_dual_mov_b32 v8, v44
	v_dual_mov_b32 v18, s11 :: v_dual_mov_b32 v15, s8
	v_dual_mov_b32 v17, s10 :: v_dual_lshlrev_b32 v2, 4, v219
	v_dual_mov_b32 v16, s9 :: v_dual_mov_b32 v13, s6
	v_dual_mov_b32 v14, s7 :: v_dual_mov_b32 v11, s4
	v_dual_mov_b32 v12, s5 :: v_dual_mov_b32 v45, 0
	s_clause 0x1                            ; 32-byte Folded Spill
	scratch_store_b128 off, v[11:14], off offset:20
	scratch_store_b128 off, v[15:18], off offset:36
...
.Ltmp15:
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	scratch_store_b64 off, v[35:36], off offset:8 ; 8-byte Folded Spill
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 334 14                        ; generate_amdgcn.py:334:14
	s_lshl_b32 s6, s5, 8
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v58, s4, v5, v221
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s6, s15, s6
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v59, s36, v221
	.loc	1 372 30 is_stmt 0              ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[12:13], null, s6, s28, v[35:36]
	.loc	1 378 30 is_stmt 1              ; generate_amdgcn.py:378:30
	s_mul_i32 s4, s6, s29
	v_dual_mov_b32 v4, v46 :: v_dual_add_nc_u32 v61, s36, v47
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v60, s36, v9
	s_mov_b32 s36, s0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s0, s34, 1
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v56, s4, v8
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_lshl_b32 s0, s34, 11
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v55, s4, v46
	...
	v_dual_mov_b32 v26, v25 :: v_dual_mov_b32 v13, v235
	...
	v_dual_mov_b32 v6, v47 :: v_dual_mov_b32 v19, v18
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s6, s5, 1
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	v_perm_b32 v10, v106, v98, 0xc0c0004
	...
	ds_load_u8 v49, v59 offset:1040
	...
	v_dual_mov_b32 v16, v15 :: v_dual_mov_b32 v15, v220
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_perm_b32 v11, v100, v99, 0xc0c0004
	...
	scratch_load_b128 v[162:165], off, off offset:20
	scratch_load_b128 v[166:169], off, off offset:36
	...
	v_lshl_or_b32 v102, v35, 16, v254
	...
	v_dual_mov_b32 v16, v17 :: v_dual_add_nc_u32 v159, s7, v3
	...
	v_dual_mov_b32 v221, v37 :: v_dual_mov_b32 v36, v38
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt vmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[78:81], v[70:73], v[162:169] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[62:69], v[126:129], v[70:73], v[162:169] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[70:77], v[78:81], v[142:145], v[162:169] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[78:85], v[126:129], v[142:145], v[162:169] neg_lo:[1,1,0]
	...
	v_dual_mov_b32 v46, v4 :: v_dual_mov_b32 v47, v6
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v2, v2, v9 :: v_dual_add_f32 v39, v39, v48
	v_mov_b32_e32 v9, v7
	v_dual_add_f32 v45, v45, v10 :: v_dual_mov_b32 v10, v12
	v_dual_add_f32 v31, v31, v55 :: v_dual_add_f32 v38, v38, v49
	v_add_f32_e32 v27, v27, v59
	v_dual_add_f32 v36, v36, v51 :: v_dual_add_f32 v25, v25, v61
	v_dual_add_f32 v34, v34, v52 :: v_dual_add_f32 v23, v23, v63
	v_dual_add_f32 v32, v32, v54 :: v_dual_add_f32 v21, v21, v65
	v_dual_add_f32 v30, v30, v56 :: v_dual_add_f32 v19, v19, v67
	v_dual_add_f32 v29, v29, v57 :: v_dual_add_f32 v28, v28, v58
	v_dual_add_f32 v17, v17, v69 :: v_dual_add_f32 v26, v26, v60
	v_dual_add_f32 v15, v15, v71 :: v_dual_add_f32 v24, v24, v62
	v_add_f32_e32 v22, v22, v64
	v_add_f32_e32 v20, v20, v66
	v_add_f32_e32 v18, v18, v68
	v_add_f32_e32 v16, v16, v70
	v_dual_add_f32 v220, v220, v72 :: v_dual_add_f32 v33, v33, v53
	s_waitcnt vmcnt(0)
	v_mov_b32_e32 v35, v0
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	scratch_load_b64 v[0:1], off, off       ; 8-byte Folded Reload
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v44, v44, v11 :: v_dual_add_nc_u32 v161, s1, v13
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_waitcnt vmcnt(0)
...
; %bb.8:
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v7, v47, v35, 0xc0c0004
	ds_load_u8 v14, v5 offset:80
	ds_load_u8 v35, v5 offset:48
	...
	v_perm_b32 v35, v118, v35, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	v_perm_b32 v35, v155, v154, 0xc0c0004
	...
	v_perm_b32 v35, v192, v191, 0xc0c0004
	...
	v_dual_add_f32 v17, v17, v0 :: v_dual_add_f32 v20, v20, v6
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
; %bb.10:
	...
	v_perm_b32 v35, v110, v35, 0xc0c0004
	...
	v_perm_b32 v35, v153, v152, 0xc0c0004
	...
	v_perm_b32 v35, v189, v179, 0xc0c0004
...
.LBB0_11:
	...
	.loc	1 326 14 is_stmt 1              ; generate_amdgcn.py:326:14
	v_or_b32_e32 v2, s14, v219
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_add_f32_e32 v14, v34, v49
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_bfe_i32 v71, v219, 0, 1
	v_lshl_add_u32 v72, v1, 1, 0
	...
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	buffer_load_u16 v35, v0, s[4:7], 0 offen
	buffer_load_u16 v70, v3, s[4:7], 0 offen
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_and_b32 s5, s19, 0xffff
	s_mov_b32 s4, s18
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_add_f32_e32 v3, v40, v5
	v_add_f32_e32 v5, v45, v7
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v0, v4, s[4:7], 0 offen
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v46, v6 :: v_dual_add_f32 v7, v43, v9
	v_dual_add_f32 v6, v44, v8 :: v_dual_add_f32 v9, v41, v11
	v_add_f32_e32 v8, v42, v10
	v_dual_add_f32 v10, v39, v12 :: v_dual_add_f32 v11, v38, v13
	v_dual_add_f32 v12, v37, v47 :: v_dual_add_f32 v49, v31, v52
	v_add_f32_e32 v13, v36, v48
	v_dual_add_f32 v47, v33, v50 :: v_dual_add_f32 v48, v32, v51
	v_dual_add_f32 v51, v29, v54 :: v_dual_add_f32 v50, v30, v53
	v_dual_add_f32 v53, v27, v56 :: v_dual_add_f32 v54, v26, v57
	v_dual_add_f32 v57, v23, v60 :: v_dual_add_f32 v56, v24, v59
	v_dual_add_f32 v59, v21, v62 :: v_dual_add_f32 v60, v20, v63
	v_dual_add_f32 v63, v17, v66 :: v_dual_add_f32 v62, v18, v65
	v_dual_add_f32 v65, v15, v68 :: v_dual_add_f32 v66, v220, v69
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_and_b32_e32 v69, 1, v219
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v52, v28, v55 :: v_dual_add_f32 v55, v25, v58
	v_dual_add_f32 v58, v22, v61 :: v_dual_add_f32 v61, v19, v64
	v_dual_add_f32 v64, v16, v67 :: v_dual_lshlrev_b32 v67, 2, v1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v40, v40, v3, s2
	v_cndmask_b32_e64 v32, v32, v48, s2
	v_cndmask_b32_e64 v48, v27, v53, s2
	...
	v_cndmask_b32_e64 v49, v25, v55, s2
	...
	v_cndmask_b32_e64 v52, v19, v61, s2
	v_cndmask_b32_e64 v33, v33, v47, s2
	v_cndmask_b32_e64 v47, v29, v51, s2
	v_cndmask_b32_e64 v51, v21, v59, s2
	v_cndmask_b32_e64 v20, v20, v60, s2
	v_cndmask_b32_e64 v30, v30, v50, s2
	v_cndmask_b32_e64 v50, v23, v57, s2
	v_cndmask_b32_e64 v22, v22, v58, s2
	v_cndmask_b32_e64 v57, v220, v66, s2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s4, s29, 6
	s_mul_i32 s5, s29, 7
	s_mul_i32 s8, s29, 9
	...
	v_and_b32_e32 v4, 0x840, v71
	v_lshlrev_b32_e32 v5, 2, v68
	v_lshlrev_b32_e32 v6, 6, v69
	.loc	1 418 23 is_stmt 0              ; generate_amdgcn.py:418:23
	v_mad_u64_u32 v[16:17], null, s33, s29, v[2:3]
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v2, 0x3f8, v73
	.loc	1 406 16 is_stmt 1              ; generate_amdgcn.py:406:16
	v_add3_u32 v3, 0, v67, v3
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_or3_b32 v8, v1, v6, v5
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(0)
	...
	v_xad_u32 v97, 0x5028, v8, 0
	v_xad_u32 v98, 0x5868, v8, 0
	v_xad_u32 v99, 0x6030, v8, 0
	v_xad_u32 v100, 0x6870, v8, 0
	v_xad_u32 v101, 0x7038, v8, 0
	v_xad_u32 v102, 0x7878, v8, 0
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	ds_load_b128 v[8:11], v72 offset:512
	ds_load_b128 v[12:15], v72 offset:528
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	...
	v_dual_mul_f32 v21, v1, v18 :: v_dual_lshlrev_b32 v58, 2, v16
	v_mul_f32_e32 v27, v4, v18
	v_mul_f32_e32 v112, v10, v18
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v0, v40, v19 :: v_dual_mul_f32 v111, v9, v18
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v120, v3, v17
	v_dual_mul_f32 v126, v9, v17 :: v_dual_mul_f32 v23, v2, v18
	v_mul_f32_e32 v25, v3, v18
	v_mul_f32_e32 v29, v5, v18
	v_mul_f32_e32 v70, v6, v18
	...
	v_dual_mul_f32 v18, v15, v18 :: v_dual_mul_f32 v119, v2, v17
	v_mul_f32_e32 v125, v8, v17
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v2, v46, v21 :: v_dual_mul_f32 v21, v36, v112
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v127, v10, v17 :: v_dual_mul_f32 v20, v20, v126
	v_mul_f32_e32 v122, v5, v17
	v_dual_mul_f32 v128, v11, v17 :: v_dual_mul_f32 v19, v37, v111
	v_dual_mul_f32 v121, v4, v17 :: v_dual_mul_f32 v4, v45, v23
	v_dual_mul_f32 v123, v6, v17 :: v_dual_mul_f32 v8, v43, v27
	v_mul_f32_e32 v129, v12, v17
	v_dual_mul_f32 v130, v13, v17 :: v_dual_mul_f32 v27, v32, v115
	v_mul_f32_e32 v131, v14, v17
	v_mul_f32_e32 v132, v15, v17
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v6, v44, v25
	v_dual_mul_f32 v10, v42, v29 :: v_dual_mul_f32 v3, v28, v118
	v_mul_f32_e32 v12, v41, v70
	v_mul_f32_e32 v17, v38, v110
	v_mul_f32_e32 v29, v31, v116
	v_mul_f32_e32 v31, v30, v18
	v_dual_mul_f32 v7, v26, v120 :: v_dual_mul_f32 v18, v51, v125
	v_dual_mul_f32 v15, v22, v124 :: v_dual_mul_f32 v22, v52, v127
	v_dual_mul_f32 v1, v47, v117 :: v_dual_mul_f32 v30, v56, v131
	v_dual_mul_f32 v14, v39, v109 :: v_dual_mul_f32 v5, v48, v119
	v_dual_mul_f32 v23, v34, v113 :: v_dual_mul_f32 v28, v55, v130
	v_dual_mul_f32 v11, v24, v122 :: v_dual_mul_f32 v24, v53, v128
	v_mul_f32_e32 v25, v33, v114
	v_dual_mul_f32 v9, v49, v121 :: v_dual_add_nc_u32 v34, s30, v58
	v_dual_mul_f32 v13, v50, v123 :: v_dual_mul_f32 v32, v57, v132
	...
	ds_load_b64 v[21:22], v97
	ds_load_b64 v[23:24], v98
	ds_load_b64 v[25:26], v99
	ds_load_b64 v[27:28], v100
	ds_load_b64 v[29:30], v101
	ds_load_b64 v[31:32], v102
	...
	s_waitcnt lgkmcnt(0)
	s_clause 0xb
	buffer_atomic_add_f32 v31, v73, s[12:15], 0 offen
	buffer_atomic_add_f32 v1, v36, s[12:15], 0 offen
	buffer_atomic_add_f32 v3, v74, s[12:15], 0 offen
	...
	buffer_atomic_add_f32 v11, v78, s[12:15], 0 offen
	buffer_atomic_add_f32 v13, v79, s[12:15], 0 offen
	buffer_atomic_add_f32 v15, v80, s[12:15], 0 offen
	buffer_atomic_add_f32 v18, v81, s[12:15], 0 offen
	buffer_atomic_add_f32 v20, v82, s[12:15], 0 offen
	buffer_atomic_add_f32 v22, v83, s[12:15], 0 offen
	v_add_lshl_u32 v84, v16, s34, 2
	v_add_lshl_u32 v85, v16, s35, 2
	v_add_lshl_u32 v86, v16, s36, 2
	v_add_lshl_u32 v87, v16, s37, 2
	v_add_lshl_u32 v0, v16, s0, 2
	s_clause 0x4
	buffer_atomic_add_f32 v24, v84, s[12:15], 0 offen
	buffer_atomic_add_f32 v26, v85, s[12:15], 0 offen
	buffer_atomic_add_f32 v28, v86, s[12:15], 0 offen
	buffer_atomic_add_f32 v30, v87, s[12:15], 0 offen
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 38
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 60
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 60
    .sgpr_count:     40
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
