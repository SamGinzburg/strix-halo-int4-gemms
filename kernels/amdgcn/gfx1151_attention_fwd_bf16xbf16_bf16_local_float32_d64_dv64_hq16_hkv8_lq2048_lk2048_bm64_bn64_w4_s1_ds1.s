...
; %bb.4:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v198, s13, v4
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v4, 7, v67
	v_dual_mov_b32 v31, v25 :: v_dual_lshlrev_b32 v6, 4, v33
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, 48, v34
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v195, s12, v1
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v199, s13, v1
	...
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v200, s13, v2
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v201, s13, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v1, v6, v169
	...
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v217, v2, v169
	...
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v178, v2, v68
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 104
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 52
