	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_or_b32_e32 v3, s26, v69
	.loc	1 93 28                         ; generate_amdgcn.py:93:28
	s_sub_i32 s2, s2, s3
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	v_or_b32_e32 v4, s26, v67
	...
	s_cmp_gt_i32 s22, 1
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	s_mul_i32 s13, s15, s26
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_gt_i32_e64 s2, s25, v4
	.loc	1 125 30                        ; generate_amdgcn.py:125:30
	v_add3_u32 v1, s12, s21, v1
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cselect_b32 s3, -1, 0
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_add3_u32 v2, s13, s20, v2
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	v_dual_mov_b32 v3, v8 :: v_dual_and_b32 v42, 0x88, v42
	v_mov_b32_e32 v4, v8
	v_mov_b32_e32 v2, v8
	v_dual_mov_b32 v1, v8 :: v_dual_add_nc_u32 v76, 0, v68
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
...
.Ltmp15:
	...
	v_sub_nc_u32_e32 v77, s25, v69
	v_sub_nc_u32_e32 v78, s25, v67
	v_add3_u32 v79, v3, s21, v65
	v_subrev_nc_u32_e32 v80, s19, v1
	v_dual_mov_b32 v46, v41 :: v_dual_add_nc_u32 v81, 0, v2
	v_dual_mov_b32 v43, v41 :: v_dual_add_nc_u32 v82, 0, v4
	v_dual_mov_b32 v48, v41 :: v_dual_add_nc_u32 v83, 0, v73
	v_dual_mov_b32 v45, v41 :: v_dual_add_nc_u32 v84, 0, v74
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e32 vcc_lo, s1, v77
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e64 s0, s1, v78
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s22, s22, -1
	s_add_i32 s1, s1, 16
	s_cmp_lg_u32 s22, 0
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_cndmask_b32_e32 v65, 0x80000000, v79, vcc_lo
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v85, v65, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	ds_load_b64 v[67:68], v81 offset:2048
	ds_load_b64 v[65:66], v82 offset:2048
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	buffer_load_b32 v86, v86, s[16:19], 0 offen
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:896
	ds_load_u8 v89, v70 offset:768
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:128
	ds_load_u8 v89, v70
	ds_load_u8 v90, v70 offset:16
	ds_load_u8 v91, v70 offset:32
	ds_load_u8 v92, v70 offset:48
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:384
	ds_load_u8 v93, v70 offset:256
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v87, v70 offset:1664
	ds_load_u8 v88, v70 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:1920
	ds_load_u8 v89, v70 offset:1792
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1152
	ds_load_u8 v89, v70 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1408
	ds_load_u8 v93, v70 offset:1280
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v93, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[41:48], v[87:88], v[65:66], v[41:48] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:656
	ds_load_u8 v88, v70 offset:528
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:912
	ds_load_u8 v89, v70 offset:784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v90, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:400
	ds_load_u8 v90, v70 offset:272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[57:64], v[87:88], v[67:68], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:1680
	ds_load_u8 v88, v70 offset:1552
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:1936
	ds_load_u8 v89, v70 offset:1808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1168
	ds_load_u8 v89, v70 offset:1040
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1424
	ds_load_u8 v90, v70 offset:1296
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[57:64], v[87:88], v[65:66], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:672
	ds_load_u8 v88, v70 offset:544
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:928
	ds_load_u8 v89, v70 offset:800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	ds_load_u8 v89, v70 offset:416
	ds_load_u8 v90, v70 offset:288
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:160
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v87, v70 offset:1696
	ds_load_u8 v88, v70 offset:1568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:1952
	ds_load_u8 v89, v70 offset:1824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1184
	ds_load_u8 v89, v70 offset:1056
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1440
	ds_load_u8 v90, v70 offset:1312
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[49:56], v[87:88], v[65:66], v[49:56] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:688
	ds_load_u8 v88, v70 offset:560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:944
	ds_load_u8 v89, v70 offset:816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	ds_load_u8 v89, v70 offset:432
	ds_load_u8 v90, v70 offset:304
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:176
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v87, v70 offset:1712
	ds_load_u8 v88, v70 offset:1584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:1968
	ds_load_u8 v89, v70 offset:1840
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1200
	ds_load_u8 v89, v70 offset:1072
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1456
	ds_load_u8 v90, v70 offset:1328
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[33:40], v[87:88], v[65:66], v[33:40] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:704
	ds_load_u8 v88, v70 offset:576
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:960
	ds_load_u8 v89, v70 offset:832
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:192
	ds_load_u8 v89, v70 offset:64
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:448
	ds_load_u8 v90, v70 offset:320
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[25:32], v[87:88], v[67:68], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:1728
	ds_load_u8 v88, v70 offset:1600
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:1984
	ds_load_u8 v89, v70 offset:1856
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1216
	ds_load_u8 v89, v70 offset:1088
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1472
	ds_load_u8 v90, v70 offset:1344
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[25:32], v[87:88], v[65:66], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:720
	ds_load_u8 v88, v70 offset:592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:976
	ds_load_u8 v89, v70 offset:848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:208
	ds_load_u8 v89, v70 offset:80
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:464
	ds_load_u8 v90, v70 offset:336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[17:24], v[87:88], v[67:68], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:1744
	ds_load_u8 v88, v70 offset:1616
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:2000
	ds_load_u8 v89, v70 offset:1872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1232
	ds_load_u8 v89, v70 offset:1104
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1488
	ds_load_u8 v90, v70 offset:1360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[17:24], v[87:88], v[65:66], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:736
	ds_load_u8 v88, v70 offset:608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:992
	ds_load_u8 v89, v70 offset:864
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:224
	ds_load_u8 v89, v70 offset:96
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:480
	ds_load_u8 v90, v70 offset:352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[9:16], v[87:88], v[67:68], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:1760
	ds_load_u8 v88, v70 offset:1632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:2016
	ds_load_u8 v89, v70 offset:1888
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v87, v70 offset:1248
	ds_load_u8 v89, v70 offset:1120
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v89, v87, 0xc0c0004
	ds_load_u8 v89, v70 offset:1504
	ds_load_u8 v90, v70 offset:1376
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v87, v89, 16, v87
	v_wmma_i32_16x16x16_iu4 v[9:16], v[87:88], v[65:66], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v87, v70 offset:240
	ds_load_u8 v88, v70 offset:112
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v70 offset:496
	ds_load_u8 v89, v70 offset:368
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v87, v88, 16, v87
	ds_load_u8 v88, v70 offset:752
	ds_load_u8 v89, v70 offset:624
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	ds_load_u8 v89, v83
	ds_load_u8 v90, v70 offset:880
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v87, v70 offset:1392
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v87, v68, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v67, v68, 16, v67
	ds_load_u8 v68, v70 offset:1776
	ds_load_u8 v87, v70 offset:1648
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v87, v68, 0xc0c0004
	ds_load_u8 v87, v84
	ds_load_u8 v88, v70 offset:1904
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b8 v75, v85 offset:2048
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(0)
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	buffer_load_u16 v100, v65, s[0:3], 0 offen
	s_waitcnt vmcnt(7)
	...
	s_waitcnt vmcnt(1)
	v_dual_max_f32 v44, 0, v44 :: v_dual_lshlrev_b32 v73, 16, v99
	s_delay_alu instid0(VALU_DEP_1)
	...
	s_waitcnt vmcnt(54)
	v_dual_max_f32 v48, 0, v48 :: v_dual_lshlrev_b32 v99, 16, v101
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_waitcnt vmcnt(52)
	...
	v_dual_max_f32 v68, 0, v25 :: v_dual_mul_f32 v95, v1, v95
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	s_waitcnt vmcnt(32)
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(22)
	v_dual_mul_f32 v60, v77, v60 :: v_dual_lshlrev_b32 v107, 16, v109
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	v_dual_mul_f32 v87, v1, v87 :: v_dual_lshlrev_b32 v84, 16, v84
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	v_dual_mul_f32 v81, v1, v81 :: v_dual_lshlrev_b32 v78, 16, v78
	...
	.loc	1 151 19 is_stmt 1              ; generate_amdgcn.py:151:19
	v_dual_max_f32 v41, 0, v41 :: v_dual_mul_f32 v72, v1, v72
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v43, v67, v43
	v_dual_mul_f32 v45, v70, v45 :: v_dual_mul_f32 v46, v71, v46
	v_mul_f32_e32 v57, v74, v57
	v_dual_mul_f32 v61, v78, v61 :: v_dual_mul_f32 v64, v81, v64
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v65, v65, v8 :: v_dual_max_f32 v46, 0, v46
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	...
	v_dual_max_f32 v14, 0, v2 :: v_dual_mul_f32 v11, v41, v41
	v_max_f32_e32 v12, 0, v4
	v_dual_max_f32 v8, 0, v5 :: v_dual_mul_f32 v5, v42, v42
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v4.h, 0
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v47, v72, v47 :: v_dual_mul_f32 v58, v75, v58
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v45, 0, v45 :: v_dual_max_f32 v58, 0, v58
	v_dual_max_f32 v71, 0, v17 :: v_dual_max_f32 v72, 0, v18
	v_dual_max_f32 v75, 0, v21 :: v_dual_max_f32 v76, 0, v22
	...
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_mul_lo_u32 v13, s15, v69
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v47, 0, v47 :: v_dual_max_f32 v60, 0, v60
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v61, 0, v61 :: v_dual_max_f32 v50, 0, v50
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v59, 0, v59 :: v_dual_max_f32 v64, 0, v64
	v_dual_max_f32 v63, 0, v63 :: v_dual_max_f32 v52, 0, v52
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v57, 0, v57 :: v_dual_max_f32 v62, 0, v62
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v53, 0, v53 :: v_dual_max_f32 v34, 0, v34
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_and_b32_e32 v22, 1, v4
	v_add3_u32 v42, v42, v44, 0x7fff
	v_mov_b16_e32 v4.l, v45.h
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_mul_f32_e32 v44, v63, v63
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v47, v49, v49 :: v_dual_and_b32 v42, 1, v4
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v33, v33, v33 :: v_dual_and_b32 v46, 1, v4
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v55, 0, v55 :: v_dual_max_f32 v36, 0, v36
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v4.l, v41.h
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v37, 0, v37 :: v_dual_max_f32 v70, 0, v26
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v39, 0, v39 :: v_dual_and_b32 v50, 1, v50
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v27, 0, v27 :: v_dual_and_b32 v48, 1, v48
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v36, v36, v36 :: v_dual_mul_f32 v29, v102, v29
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v29, v29, v29 :: v_dual_and_b32 v48, 1, v4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v37, v68, v68 :: v_dual_mul_f32 v30, v30, v30
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v26, v26, v26 :: v_dual_and_b32 v39, 1, v39
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v47.h, v4.h
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v24, v24, v24 :: v_dual_and_b32 v37, 1, v47
	v_dual_mul_f32 v18, v18, v18 :: v_dual_and_b32 v39, 1, v4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v14, v14, v14 :: v_dual_and_b32 v29, 1, v32
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v40.l, v39.h
	v_mov_b16_e32 v40.h, v4.h
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v47, v74, v74 :: v_dual_and_b32 v32, 1, v4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v66, v122, v131 :: v_dual_mul_f32 v67, v124, v132
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v15, 0, v66 :: v_dual_max_f32 v10, 0, v67
	v_max_f32_e32 v9, 0, v6
	v_dual_max_f32 v7, 0, v7 :: v_dual_max_f32 v6, 0, v65
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v37, 1, v48
	v_dual_mul_f32 v39, v76, v76 :: v_dual_mul_f32 v40, v75, v75
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_and_b32_e32 v49, 1, v4
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v20, v20, v20 :: v_dual_and_b32 v37, 1, v37
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v12, v12, v12 :: v_dual_and_b32 v39, 1, v50
	v_dual_mul_f32 v23, v23, v23 :: v_dual_and_b32 v40, 1, v4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_cndmask_b32_e32 v31, v30, v35, vcc_lo
	v_add3_u32 v15, v15, v20, 0x7fff
	v_and_b32_e32 v26, 1, v26
	v_mov_b16_e32 v20.l, v8.h
	v_mov_b16_e32 v20.h, v4.h
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v9, v9, v9 :: v_dual_cndmask_b32 v30, v35, v30
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_dual_cndmask_b32 v9, v42, v21 :: v_dual_cndmask_b32 v10, v21, v42
	s_delay_alu instid0(VALU_DEP_3)
	v_add3_u32 v7, v7, v23, 0x7fff
	v_cndmask_b32_e32 v13, v22, v43, vcc_lo
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 133
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 27
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     29
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.kd
