	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[10:13], v4, s[28:31], 0 offen
	buffer_load_b128 v[14:17], v5, s[28:31], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[30:33], v1, s[28:31], 0 offen
	buffer_load_b128 v[34:37], v3, s[28:31], 0 offen
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v1, s40, v102
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_lshl_b32 s7, s35, 6
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v3, s40, v103
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s7, s4, s7
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v4, s40, v105
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	s_waitcnt vmcnt(8)
	v_perm_b32 v66, v14, v10, 0x4000501
	...
	v_perm_b32 v33, v66, v17, 0x7060302
	v_perm_b32 v17, v66, v17, 0x5040100
	...
	ds_store_2addr_b32 v58, v31, v13 offset1:16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	...
	v_perm_b32 v26, v57, v53, 0x6020703
	...
	v_perm_b32 v23, v26, v24, 0x7060302
	v_perm_b32 v24, v26, v24, 0x5040100
	ds_store_2addr_b32 v59, v27, v2 offset1:16
	ds_store_2addr_b32 v60, v3, v10 offset1:16
	ds_store_2addr_b32 v61, v11, v12 offset1:16
	ds_store_2addr_b32 v62, v13, v14 offset1:16
	ds_store_2addr_b32 v63, v15, v16 offset1:16
	ds_store_2addr_b32 v59, v17, v18 offset0:160 offset1:176
	ds_store_2addr_b32 v64, v19, v20 offset1:16
	ds_store_2addr_b32 v65, v23, v24 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
.LBB0_3:                                ; %Flow94
	...
	v_mul_lo_u32 v48, v11, s41
	v_mul_lo_u32 v41, v8, s41
	v_mul_lo_u32 v43, v9, s41
	v_lshlrev_b32_e32 v98, 1, v1
	v_lshlrev_b32_e32 v99, 1, v25
	s_and_not1_b32 vcc_lo, exec_lo, s4
	s_waitcnt vmcnt(0)
	v_and_b32_e32 v10, 1, v0
	v_or_b32_e32 v45, s33, v0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s26, s40
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s40, s14, s19
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v130, s18, v116
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v9, s40, v102
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v10, s40, v105
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v24, s45, v95
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v131, s18, v117
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v175, s45, v96
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[139:142], v175
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[179:182], v131
	v_add_nc_u32_e32 v130, s18, v118
	...
	ds_load_b128 v[155:158], v175 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	ds_load_b128 v[171:174], v175 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	ds_load_b128 v[195:198], v175 offset:3072
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v13, s40, v103
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v124, v14
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v14, s35, v21
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_cndmask_b32_e32 v13, 0x80000000, v13, vcc_lo
	s_clause 0x3
	buffer_load_u16 v209, v13, s[4:7], 0 offen
	buffer_load_u16 v210, v14, s[4:7], 0 offen
	buffer_load_u16 v211, v15, s[4:7], 0 offen
	buffer_load_u16 v212, v16, s[4:7], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v213, s18, v108
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s43, s19, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s19, s17, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s42, s18, 0x8000
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_mul_f32 v213, v13, v10 :: v_dual_lshlrev_b32 v12, 16, v212
	v_mul_f32_e32 v214, v14, v10
	v_mul_f32_e32 v215, v15, v10
	v_mul_f32_e32 v216, v16, v10
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v226, v18, v10 :: v_dual_mul_f32 v209, v13, v9
	v_mul_f32_e32 v210, v14, v9
	v_mul_f32_e32 v211, v15, v9
	v_mul_f32_e32 v212, v16, v9
	v_mul_f32_e32 v221, v17, v9
	v_mul_f32_e32 v222, v18, v9
	v_mul_f32_e32 v223, v19, v9
	v_mul_f32_e32 v224, v20, v9
	v_dual_mul_f32 v228, v20, v10 :: v_dual_mul_f32 v217, v13, v11
	v_mul_f32_e32 v218, v14, v11
	v_mul_f32_e32 v219, v15, v11
	v_dual_mul_f32 v220, v16, v11 :: v_dual_mul_f32 v13, v13, v12
	v_mul_f32_e32 v14, v14, v12
	v_mul_f32_e32 v15, v15, v12
	v_dual_mul_f32 v16, v16, v12 :: v_dual_mul_f32 v225, v17, v10
	v_dual_mul_f32 v230, v18, v11 :: v_dual_mul_f32 v227, v19, v10
	v_mul_f32_e32 v232, v20, v11
	...
	v_dual_fmac_f32 v26, v210, v124 :: v_dual_add_nc_u32 v201, s43, v109
	v_fmac_f32_e32 v23, v209, v123
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v28, v212, v126 :: v_dual_fmac_f32 v31, v223, v129
	v_dual_fmac_f32 v30, v222, v128 :: v_dual_fmac_f32 v33, v233, v131
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v32, v224, v130 :: v_dual_fmac_f32 v35, v235, v133
	v_dual_fmac_f32 v34, v234, v132 :: v_dual_fmac_f32 v37, v245, v135
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v194, v24, v193 offset1:16
	v_perm_b32 v24, v204, v196, 0x7060302
	v_perm_b32 v193, v204, v196, 0x5040100
	v_add_nc_u32_e32 v194, s43, v112
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v36, v236, v134 :: v_dual_fmac_f32 v39, v247, v137
	v_dual_fmac_f32 v38, v246, v136 :: v_dual_fmac_f32 v47, v215, v141
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v194, v24, v193 offset1:16
	v_perm_b32 v24, v205, v197, 0x7060302
	v_perm_b32 v193, v205, v197, 0x5040100
	v_add_nc_u32_e32 v194, s43, v113
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v40, v9, v138 :: v_dual_fmac_f32 v51, v226, v144
	v_dual_fmac_f32 v44, v213, v139 :: v_dual_fmac_f32 v49, v216, v142
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v194, v24, v193 offset1:16
	v_perm_b32 v24, v206, v198, 0x7060302
	v_perm_b32 v193, v206, v198, 0x5040100
	v_add_nc_u32_e32 v194, s43, v114
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v46, v214, v140 :: v_dual_fmac_f32 v53, v228, v146
	v_dual_fmac_f32 v50, v225, v143 :: v_dual_fmac_f32 v55, v238, v148
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v201, v24, v193 offset0:160 offset1:176
	v_perm_b32 v24, v207, v199, 0x7060302
	v_perm_b32 v193, v207, v199, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v52, v227, v145 :: v_dual_fmac_f32 v57, v240, v150
	v_dual_fmac_f32 v54, v237, v147 :: v_dual_fmac_f32 v61, v10, v154
	v_dual_fmac_f32 v56, v239, v149 :: v_dual_fmac_f32 v59, v249, v152
	v_dual_fmac_f32 v58, v248, v151 :: v_dual_fmac_f32 v63, v218, v156
	v_dual_fmac_f32 v60, v250, v153 :: v_dual_fmac_f32 v65, v220, v158
	v_dual_fmac_f32 v62, v217, v155 :: v_dual_fmac_f32 v67, v230, v160
	v_dual_fmac_f32 v64, v219, v157 :: v_dual_fmac_f32 v69, v232, v162
	v_dual_fmac_f32 v66, v229, v159 :: v_dual_fmac_f32 v71, v242, v164
	v_dual_fmac_f32 v68, v231, v161 :: v_dual_fmac_f32 v73, v244, v166
	v_dual_fmac_f32 v70, v241, v163 :: v_dual_fmac_f32 v75, v252, v168
	v_dual_fmac_f32 v72, v243, v165 :: v_dual_fmac_f32 v79, v14, v172
	v_dual_fmac_f32 v74, v251, v167 :: v_dual_fmac_f32 v81, v16, v174
	v_dual_fmac_f32 v76, v253, v169 :: v_dual_fmac_f32 v77, v11, v170
	v_dual_fmac_f32 v78, v13, v171 :: v_dual_fmac_f32 v83, v18, v176
	v_dual_fmac_f32 v80, v15, v173 :: v_dual_fmac_f32 v85, v20, v178
	v_dual_fmac_f32 v82, v17, v175 :: v_dual_fmac_f32 v89, v188, v181
	v_dual_fmac_f32 v84, v19, v177 :: v_dual_fmac_f32 v87, v186, v179
	v_dual_fmac_f32 v88, v187, v180 :: v_dual_fmac_f32 v91, v190, v183
	v_dual_fmac_f32 v90, v189, v182 :: v_dual_fmac_f32 v93, v192, v185
	v_dual_fmac_f32 v92, v191, v184 :: v_dual_add_nc_u32 v11, s43, v115
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.9:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v4, s16, v20
	v_add_nc_u32_e32 v1, s16, v103
	v_add_nc_u32_e32 v3, s16, v229
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v8, s11 :: v_dual_add_nc_u32 v19, s45, v94
...
.LBB0_10:
	...
	v_cndmask_b32_e32 v3, 0x80000000, v3, vcc_lo
	s_clause 0x3
	buffer_load_u16 v168, v1, s[12:15], 0 offen
	buffer_load_u16 v135, v3, s[12:15], 0 offen
	buffer_load_u16 v152, v4, s[12:15], 0 offen
	buffer_load_u16 v102, v5, s[12:15], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
...
; %bb.11:
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v17, s43, v42
	v_add_nc_u32_e32 v18, s43, v20
	v_dual_mov_b32 v130, v245 :: v_dual_add_nc_u32 v95, s42, v95
	...
	v_dual_mov_b32 v135, v244 :: v_dual_mov_b32 v150, v123
	v_dual_mov_b32 v129, v0 :: v_dual_mov_b32 v138, v247
	v_dual_mov_b32 v147, v246 :: v_dual_add_nc_u32 v96, s42, v96
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v217, v236 :: v_dual_mov_b32 v226, s11
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[235:238], v95 offset:2048
	ds_load_b128 v[108:111], v96
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v219, s4 :: v_dual_mov_b32 v160, v112
	v_dual_mov_b32 v161, v113 :: v_dual_mov_b32 v188, v114
	v_dual_mov_b32 v0, v98 :: v_dual_mov_b32 v123, v48
	v_dual_mov_b32 v98, v115 :: v_dual_mov_b32 v121, v45
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[112:115], v96 offset:2048
	v_dual_mov_b32 v122, v43 :: v_dual_mov_b32 v45, v117
	v_dual_mov_b32 v120, v41 :: v_dual_mov_b32 v43, v24
	v_dual_mov_b32 v48, v116 :: v_dual_mov_b32 v41, v118
	v_dual_mov_b32 v24, v119 :: v_dual_mov_b32 v149, v134
	ds_load_b128 v[116:119], v96 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v225, s10 :: v_dual_mov_b32 v224, s9
	v_dual_mov_b32 v223, s8 :: v_dual_mov_b32 v222, s7
	v_dual_mov_b32 v221, s6 :: v_dual_mov_b32 v220, s5
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[164:167], v185 offset:8192
	ds_load_b128 v[213:216], v186
	v_dual_mov_b32 v218, v230 :: v_dual_mov_b32 v25, v231
	v_dual_mov_b32 v134, v22 :: v_dual_mov_b32 v255, v233
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	...
	v_dual_mov_b32 v22, v232 :: v_dual_mov_b32 v141, v125
	v_dual_mov_b32 v151, v136 :: v_dual_mov_b32 v136, v162
	v_dual_mov_b32 v162, v227 :: v_dual_mov_b32 v125, v240
	v_dual_mov_b32 v42, v234 :: v_dual_mov_b32 v143, v127
	v_wmma_i32_16x16x16_iu8 v[227:234], v[251:254], v[235:238], v[219:226] neg_lo:[1,1,0]
	v_dual_mov_b32 v140, v124 :: v_dual_mov_b32 v127, v242
	...
	v_dual_mov_b32 v98, v0 :: v_dual_mov_b32 v245, v130
	v_dual_mov_b32 v114, v188 :: v_dual_mov_b32 v113, v161
	...
	v_dual_mov_b32 v24, v43 :: v_dual_mov_b32 v43, v122
	...
	v_dual_mov_b32 v134, v149 :: v_dual_mov_b32 v227, v162
	v_cvt_f32_i32_e32 v209, v233
	v_dual_mov_b32 v233, v255 :: v_dual_mov_b32 v162, v136
	...
	v_dual_mov_b32 v112, v160 :: v_dual_mov_b32 v243, v137
	v_dual_mov_b32 v244, v135 :: v_dual_mov_b32 v117, v45
	...
	v_dual_mov_b32 v246, v147 :: v_dual_mov_b32 v129, v145
	v_mov_b32_e32 v145, v168
	v_mov_b16_e64 v135.l, v139.l
	v_mov_b16_e64 v168.l, v153.l
	v_dual_mov_b32 v118, v41 :: v_dual_mov_b32 v41, v120
	v_dual_mov_b32 v116, v48 :: v_dual_mov_b32 v247, v138
	v_dual_mov_b32 v48, v123 :: v_dual_mov_b32 v123, v150
...
.LBB0_12:
	...
	s_mul_i32 s5, s4, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v18, v48, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v19, v45, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	buffer_load_u16 v43, v20, s[12:15], 0 offen
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v45, v45, v148, v86
	v_fma_f32 v48, v48, v0, v93
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v97, v97, v217, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v45, v86, v45, s3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cndmask_b32_e64 v48, v93, v48, s3
	...
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v153, v1, v20 :: v_dual_lshlrev_b32 v42, 16, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v14, v14, v20 :: v_dual_lshlrev_b32 v1, 16, v19
	...
	v_fma_f32 v93, v113, v128, v60
	v_fma_f32 v94, v114, v127, v59
	v_fma_f32 v24, v132, v227, v51
	v_fma_f32 v22, v134, v22, v49
	v_fma_f32 v21, v135, v21, v47
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_cndmask_b32_e64 v60, v60, v93, s3
	v_cndmask_b32_e64 v59, v59, v94, s3
	v_cndmask_b32_e64 v24, v51, v24, s3
	v_cndmask_b32_e64 v22, v49, v22, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v134, v15, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v95, v115, v126, v58
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v21, v47, v21, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v47, v8, v236, v32
	v_fma_f32 v49, v7, v235, v31
	...
	v_mul_f32_e32 v123, v4, v41
	v_mul_f32_e32 v125, v6, v41
	v_mul_f32_e32 v128, v9, v41
	v_mul_f32_e32 v4, v4, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v105, v131, v162, v52
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v6, v6, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v106, v133, v247, v50
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v9, v9, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v136, v246, v46
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v71, v71, v102, s3
	v_cndmask_b32_e64 v70, v70, v103, s3
	v_cndmask_b32_e64 v69, v69, v104, s3
	v_cndmask_b32_e64 v52, v52, v105, s3
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v43, v1, v18
	v_mul_f32_e32 v47, v2, v18
	v_mul_f32_e32 v49, v3, v18
	v_mul_f32_e32 v105, v1, v40
	v_mul_f32_e32 v106, v2, v40
	v_dual_mul_f32 v107, v3, v40 :: v_dual_mul_f32 v120, v1, v41
	v_mul_f32_e32 v121, v2, v41
	v_dual_mul_f32 v122, v3, v41 :: v_dual_mul_f32 v1, v1, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v102, v118, v188, v55
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v2, v2, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v103, v119, v161, v54
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v3, v3, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v130, v160, v53
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v55, v55, v102, s3
	v_cndmask_b32_e64 v29, v29, v92, s3
	v_cndmask_b32_e64 v54, v54, v103, s3
	v_cndmask_b32_e64 v27, v27, v94, s3
	v_cndmask_b32_e64 v53, v53, v104, s3
	...
	v_dual_mul_f32 v119, v15, v40 :: v_dual_mul_f32 v124, v5, v41
	v_mul_f32_e32 v126, v7, v41
	v_mul_f32_e32 v131, v12, v41
	v_mul_f32_e32 v133, v14, v41
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v17, v43, v17, v23
	v_fma_f32 v43, v49, v101, v27
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v42, v47, v100, v26
	v_fma_f32 v47, v51, v164, v28
	v_fma_f32 v49, v92, v165, v29
	v_fma_f32 v51, v93, v166, v30
	v_fma_f32 v92, v94, v167, v31
	v_fma_f32 v93, v95, v169, v32
	v_fma_f32 v15, v15, v225, v48
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v17, v23, v17, s2
	v_cndmask_b32_e64 v23, v26, v42, s2
	v_cndmask_b32_e64 v26, v27, v43, s2
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v49, v56, v111, s2
	v_cndmask_b32_e64 v56, v64, v118, s2
	v_cndmask_b32_e64 v64, v72, v126, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v72, 0, v23
	v_max_f32_e32 v23, v31, v31
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v100, v104, v176, v39
	v_fma_f32 v104, v108, v181, v22
	v_fma_f32 v115, v119, v193, v60
	...
	v_cndmask_b32_e64 v43, v52, v107, s2
	v_cndmask_b32_e64 v47, v55, v110, s2
	v_cndmask_b32_e64 v52, v59, v114, s2
	v_cndmask_b32_e64 v55, v63, v117, s2
	v_cndmask_b32_e64 v59, v67, v121, s2
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v108, v112, v185, v53
	v_fma_f32 v112, v116, v190, v57
	v_fma_f32 v41, v41, v210, v77
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v42, v50, v105, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v12, v12, v222, v90
	v_fma_f32 v16, v16, v226, v45
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v50, v57, v112, s2
	v_cndmask_b32_e64 v57, v65, v119, s2
	...
	v_cndmask_b32_e64 v45, v45, v16, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_cndmask_b32_e64 v19, v44, v101, s2
	v_cndmask_b32_e64 v39, v46, v102, s2
	v_cndmask_b32_e64 v21, v21, v103, s2
	v_cndmask_b32_e64 v46, v54, v109, s2
	v_cndmask_b32_e64 v51, v58, v113, s2
	v_cndmask_b32_e64 v54, v62, v116, s2
	v_cndmask_b32_e64 v58, v66, v120, s2
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v44, v53, v108, s2
	v_cndmask_b32_e64 v1, v78, v1, s2
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v17, v26, v26 :: v_dual_max_f32 v78, 0, v16
	v_max_f32_e32 v16, v19, v19
	v_dual_max_f32 v18, v39, v39 :: v_dual_max_f32 v19, v21, v21
	v_dual_max_f32 v26, v32, v32 :: v_dual_max_f32 v39, 0, v15
	v_dual_max_f32 v32, 0, v12 :: v_dual_max_f32 v15, v42, v42
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v53, v60, v115, s2
	...
	v_dual_max_f32 v18, v43, v43 :: v_dual_max_f32 v81, 0, v16
	v_max_f32_e32 v43, 0, v15
	v_dual_max_f32 v15, v47, v47 :: v_dual_max_f32 v16, v24, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v7, v139, v84
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v8, v85, v8, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v42, 0, v12
	v_dual_max_f32 v12, v46, v46 :: v_dual_max_f32 v85, 0, v19
	v_max_f32_e32 v19, v51, v51
	v_dual_max_f32 v47, 0, v15 :: v_dual_max_f32 v44, 0, v16
	v_max_f32_e32 v15, v53, v53
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v60, v68, v122, s2
	v_cndmask_b32_e64 v7, v84, v7, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v84, 0, v18
	v_dual_max_f32 v16, v49, v49 :: v_dual_max_f32 v51, 0, v19
	v_dual_max_f32 v19, v55, v55 :: v_dual_max_f32 v18, v50, v50
	v_max_f32_e32 v46, 0, v12
	v_max_f32_e32 v12, v52, v52
	v_dual_max_f32 v52, 0, v15 :: v_dual_max_f32 v15, v57, v57
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v2, v2, v212, v79
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v49, 0, v16
	v_dual_max_f32 v16, v40, v40 :: v_dual_max_f32 v55, 0, v19
	v_max_f32_e32 v19, v60, v60
	v_dual_max_f32 v57, 0, v15 :: v_dual_max_f32 v50, 0, v18
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v53, 0, v16 :: v_dual_max_f32 v18, v54, v54
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	scratch_load_b32 v0, off, off offset:4  ; 4-byte Folded Reload
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v60, 0, v19 :: v_dual_max_f32 v1, v1, v1
	v_dual_max_f32 v54, 0, v18 :: v_dual_max_f32 v19, v65, v65
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v40, 0, v12 :: v_dual_max_f32 v59, 0, v18
	v_max_f32_e32 v18, v64, v64
	v_dual_max_f32 v28, 0, v1 :: v_dual_max_f32 v1, v2, v2
	...
	v_dual_max_f32 v26, v37, v37 :: v_dual_max_f32 v15, v62, v62
	v_dual_max_f32 v37, 0, v18 :: v_dual_max_f32 v56, 0, v12
	v_dual_max_f32 v35, 0, v19 :: v_dual_max_f32 v12, v61, v61
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v62, 0, v15 :: v_dual_max_f32 v61, 0, v12
	v_dual_max_f32 v58, 0, v16 :: v_dual_max_f32 v15, v67, v67
	v_dual_max_f32 v12, v66, v66 :: v_dual_max_f32 v29, 0, v1
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v80, 0, v26 :: v_dual_max_f32 v33, 0, v12
	v_max_f32_e32 v63, 0, v16
	v_max_f32_e32 v16, v68, v68
	v_dual_max_f32 v26, 0, v3 :: v_dual_max_f32 v3, v9, v9
	v_dual_max_f32 v18, v41, v41 :: v_dual_max_f32 v27, 0, v2
	...
	v_dual_max_f32 v34, 0, v15 :: v_dual_max_f32 v23, 0, v5
	v_dual_max_f32 v30, 0, v18 :: v_dual_max_f32 v1, v7, v7
	v_max_f32_e32 v5, v11, v11
	v_max_f32_e32 v7, 0, v6
	v_dual_max_f32 v19, 0, v2 :: v_dual_max_f32 v22, 0, v4
	v_dual_max_f32 v15, 0, v3 :: v_dual_max_f32 v4, v10, v10
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v14, v86, v14, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v17, 0, v17
	v_dual_max_f32 v31, 0, v16 :: v_dual_max_f32 v12, 0, v5
	v_dual_max_f32 v2, v13, v13 :: v_dual_max_f32 v5, v48, v48
	v_dual_max_f32 v16, 0, v4 :: v_dual_mul_f32 v9, v71, v71
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v13, v70, v70
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v4, v14, v14 :: v_dual_mul_f32 v17, v17, v17
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_dual_mul_f32 v39, v39, v39 :: v_dual_and_b32 v24, 1, v24
	v_dual_mul_f32 v25, v72, v72 :: v_dual_max_f32 v10, 0, v2
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v41.l, v17.h
	v_mov_b16_e32 v41.h, v20.l
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v24, v75, v75 :: v_dual_and_b32 v21, 1, v21
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_add3_u32 v17, v41, v21, 0x7fff
	v_mov_b16_e32 v21.l, v24.h
	v_mov_b16_e32 v21.h, v20.l
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v8, 0, v5
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v36, v36, v36 :: v_dual_and_b32 v41, 1, v45
	v_mul_f32_e32 v45, v76, v76
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_and_b32_e32 v21, 1, v21
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v32, v78, v78
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v41.l, v48.h
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v43, v43, v43
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v45, v45, v24, 0x7fff
	v_add3_u32 v24, v36, v25, 0x7fff
	v_mov_b16_e32 v25.l, v32.h
	v_mov_b16_e32 v25.h, v20.l
	v_and_b32_e32 v36, 1, v41
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v41, v80, v80 :: v_dual_mul_f32 v64, v79, v79
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v47, v47, v47 :: v_dual_and_b32 v36, 1, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v48, v64, v32, 0x7fff
	s_delay_alu instid0(VALU_DEP_4)
	v_add3_u32 v32, v41, v36, 0x7fff
	v_mov_b16_e32 v36.l, v39.h
	v_mov_b16_e32 v36.h, v20.l
	v_and_b32_e32 v41, 1, v45
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v45, v82, v82 :: v_dual_mul_f32 v64, v81, v81
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v32.l, v48.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v26, v26, v26 :: v_dual_and_b32 v39, 1, v44
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v12, v12, v12 :: v_dual_mul_f32 v27, v27, v27
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v49.l, v48.h
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v42, v84, v84
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v44, v47, v44, 0x7fff
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v23, v23, v23 :: v_dual_mul_f32 v14, v14, v14
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v45, 1, v64
	...
	v_mov_b16_e32 v49.h, v20.l
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v50, v55, v55 :: v_dual_mul_f32 v55, v62, v62
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v52, v59, v59 :: v_dual_mul_f32 v49, v60, v60
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v51, v61, v61
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v50, v52, v50, 0x7fff
	v_mov_b16_e32 v52.h, v20.l
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add3_u32 v48, v53, v48, 0x7fff
	...
	v_cndmask_b32_e32 v37, v34, v51, vcc_lo
	...
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_dual_cndmask_b32 v33, v48, v45 :: v_dual_and_b32 v22, 1, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_cndmask_b32_e32 v18, v43, v41, vcc_lo
	v_mov_b16_e32 v12.l, v11.h
	v_cndmask_b32_e32 v27, v46, v42, vcc_lo
	v_mov_b16_e32 v16.l, v15.h
	v_mov_b16_e32 v15.h, v20.l
	v_cndmask_b32_e32 v20, v41, v43, vcc_lo
	v_and_b32_e32 v12, 1, v12
	v_cndmask_b32_e32 v28, v42, v46, vcc_lo
	v_dual_cndmask_b32 v31, v50, v47 :: v_dual_cndmask_b32 v34, v51, v34
	...
	v_dual_mov_b32 v26, 0x7632 :: v_dual_cndmask_b32 v41, v0, v14
	...
	v_cndmask_b32_e32 v36, v45, v48, vcc_lo
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 72
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 72
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
