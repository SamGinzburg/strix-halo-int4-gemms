...
.Ltmp0:
	...
	.loc	1 773 26                        ; attention.py:773:26
	v_mad_u64_u32 v[3:4], null, s50, s8, v[41:42]
	.loc	1 774 26                        ; attention.py:774:26
	...
	ds_bpermute_b32 v8, v55, v17
	ds_bpermute_b32 v10, v55, v18
	ds_bpermute_b32 v9, v57, v15
	ds_bpermute_b32 v11, v57, v16
	ds_bpermute_b32 v12, v57, v17
	ds_bpermute_b32 v13, v57, v18
	.loc	1 818 13                        ; attention.py:818:13
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b32_e64 v15, 0x1054, v15, s25
	v_cndmask_b32_e64 v16, 0x3276, v16, s25
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v52, 0x5040504, v15
	v_and_b32_e32 v53, 0x7060706, v16
	s_branch .LBB0_3
.LBB0_2:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v44, v6, v9, s25
	v_cndmask_b32_e64 v48, v9, v6, s25
	s_clause 0x1
	s_load_b64 s[56:57], s[0:1], 0x30
	s_load_b128 s[16:19], s[0:1], 0x68
	v_cndmask_b32_e64 v45, v7, v11, s25
	v_cndmask_b32_e64 v49, v11, v7, s25
	...
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v43, v10, v13, s25
	...
	v_cndmask_b32_e64 v47, v13, v10, s25
	v_dual_mov_b32 v106, 0xff800000 :: v_dual_lshlrev_b32 v37, 2, v32
	v_mov_b32_e32 v10, 0x7632
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_cmp_eq_u32_e32 vcc_lo, 0, v14
	.loc	1 759 31                        ; attention.py:759:31
	v_and_b32_e32 v6, 56, v0
	v_dual_mov_b32 v108, 0xff800000 :: v_dual_lshlrev_b32 v11, 3, v0
	v_dual_mov_b32 v26, v24 :: v_dual_lshlrev_b32 v33, 3, v35
	v_cndmask_b32_e32 v39, 0x7531, v3, vcc_lo
	v_lshrrev_b32_e32 v38, 1, v6
	v_dual_mov_b32 v17, v24 :: v_dual_lshlrev_b32 v50, 6, v14
	v_cndmask_b32_e64 v52, 0x1054, v9, s25
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s0, s0, 29
	v_mov_b32_e32 v29, v24
	v_xor_b32_e32 v72, v2, v6
	s_add_i32 s0, s3, s0
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v42, v8, v12, s25
	v_cndmask_b32_e64 v46, v12, v8, s25
	v_dual_mov_b32 v25, v24 :: v_dual_and_b32 v8, 24, v0
	v_bfe_i32 v0, v0, 3, 1
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v59, s6, v5
	v_cndmask_b32_e64 v53, 0x3276, v10, s25
	v_dual_mov_b32 v28, v24 :: v_dual_and_b32 v73, 48, v11
	v_dual_mov_b32 v21, v24 :: v_dual_cndmask_b32 v36, 0x6420, v36
	...
	v_and_or_b32 v71, v37, 60, v50
	v_lshl_or_b32 v72, v35, 9, v72
	v_dual_mov_b32 v27, v24 :: v_dual_and_b32 v4, 24, v4
	v_dual_mov_b32 v19, v24 :: v_dual_and_b32 v74, 0x210, v0
	v_lshl_or_b32 v39, v39, 8, v39
	v_lshl_or_b32 v37, v53, 8, v53
	v_lshl_or_b32 v35, v35, 6, v73
	v_lshl_or_b32 v36, v36, 8, v36
	v_xor_b32_e32 v61, v7, v8
	v_lshl_or_b32 v62, v1, 5, v4
	v_dual_mov_b32 v16, v24 :: v_dual_and_b32 v37, 0x760076, v37
	v_mov_b32_e32 v23, v24
	v_dual_mov_b32 v13, v24 :: v_dual_and_b32 v36, 0x750031, v36
	v_xor_b32_e32 v73, v35, v74
	v_xor_b32_e32 v75, 8, v61
	v_xor_b32_e32 v76, 8, v62
	v_xor_b32_e32 v77, 16, v62
	v_xor_b32_e32 v78, 24, v62
	v_lshl_or_b32 v37, v37, 4, v37
	v_xor_b32_e32 v84, 32, v73
	v_xor_b32_e32 v85, 48, v73
	v_xor_b32_e32 v86, 0x420, v73
	v_xor_b32_e32 v87, 0x430, v73
	v_xor_b32_e32 v88, 0x410, v73
	.loc	1 756 22                        ; attention.py:756:22
	s_sub_i32 s1, s3, s1
	...
	s_mul_i32 s6, s17, s6
	v_dual_mov_b32 v31, v24 :: v_dual_add_nc_u32 v60, s7, v5
	v_mov_b32_e32 v18, v24
	v_mov_b32_e32 v20, v24
	v_dual_mov_b32 v9, v24 :: v_dual_add_nc_u32 v74, 0, v75
	v_dual_mov_b32 v10, v24 :: v_dual_and_b32 v53, 0x7060706, v37
	v_mov_b32_e32 v11, v24
	v_dual_mov_b32 v14, v24 :: v_dual_add_nc_u32 v85, 0, v85
	v_dual_mov_b32 v0, v24 :: v_dual_add_nc_u32 v87, 0, v87
	v_dual_mov_b32 v5, v24 :: v_dual_add_nc_u32 v84, 0, v84
	v_dual_mov_b32 v7, v24 :: v_dual_add_nc_u32 v86, 0, v86
	v_or_b32_e32 v63, 16, v58
	v_or_b32_e32 v64, 18, v58
	v_or_b32_e32 v65, 20, v58
	v_or_b32_e32 v66, 22, v58
	v_or_b32_e32 v67, 24, v58
	v_or_b32_e32 v68, 26, v58
	v_or_b32_e32 v69, 28, v58
	v_or_b32_e32 v70, 30, v58
	v_dual_mov_b32 v109, v24 :: v_dual_add_nc_u32 v88, 0, v88
	v_add_nc_u32_e32 v75, 0, v76
	v_add_nc_u32_e32 v76, 0, v77
	v_add_nc_u32_e32 v77, 0, v78
	v_xor_b32_e32 v78, 64, v71
	s_mov_b32 s40, 0
	...
	.loc	1 818 13                        ; attention.py:818:13
	s_waitcnt vmcnt(0)
	v_mad_u64_u32 v[50:51], null, s39, v38, v[33:34]
	v_lshl_or_b32 v33, v52, 8, v52
	v_mov_b32_e32 v30, v24
	v_xor_b32_e32 v51, 0x120, v72
	v_xor_b32_e32 v52, 0x1b0, v72
	v_and_b32_e32 v38, 0x750031, v39
	v_dual_mov_b32 v8, v24 :: v_dual_and_b32 v33, 0x540054, v33
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v15, v24 :: v_dual_add_nc_u32 v80, 0, v51
	v_add_nc_u32_e32 v81, 0, v52
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v33, v33, 4, v33
	v_mad_u64_u32 v[51:52], null, s19, v32, v[40:41]
	v_mov_b32_e32 v3, v24
	v_xor_b32_e32 v39, 0x90, v72
	v_lshl_or_b32 v35, v38, 4, v38
	v_xor_b32_e32 v38, 16, v73
	v_lshl_or_b32 v32, v36, 4, v36
	v_and_b32_e32 v52, 0x5040504, v33
	v_dual_mov_b32 v22, v24 :: v_dual_lshlrev_b32 v33, 16, v34
	v_dual_mov_b32 v12, v24 :: v_dual_add_nc_u32 v79, 0, v39
	v_add_nc_u32_e32 v83, 0, v38
	v_dual_mov_b32 v1, v24 :: v_dual_and_b32 v82, 0x7050301, v35
	v_dual_mov_b32 v2, v24 :: v_dual_add_nc_u32 v89, 1, v51
	v_dual_mov_b32 v4, v24 :: v_dual_add_nc_u32 v91, 3, v51
	v_dual_mov_b32 v6, v24 :: v_dual_add_nc_u32 v93, 5, v51
	.loc	1 843 41                        ; attention.py:843:41
	v_dual_mul_f32 v105, s3, v33 :: v_dual_add_nc_u32 v90, 2, v51
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v92, 4, v51
	v_add_nc_u32_e32 v94, 6, v51
	v_add_nc_u32_e32 v95, 7, v51
	v_add_nc_u32_e32 v96, 8, v51
	v_add_nc_u32_e32 v97, 9, v51
	v_add_nc_u32_e32 v98, 10, v51
	v_add_nc_u32_e32 v99, 11, v51
	v_add_nc_u32_e32 v100, 12, v51
	v_add_nc_u32_e32 v101, 13, v51
	v_add_nc_u32_e32 v102, 14, v51
	v_add_nc_u32_e32 v103, 15, v51
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v112, s68, v112
	v_or_b32_e32 v113, s68, v40
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v115, 3, v40
	v_or_b32_e32 v116, 4, v40
	v_or_b32_e32 v117, 5, v40
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s6, v112, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s7, v112, v60
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v112, s68, v114
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s8, s73, s68
	v_mad_u64_u32 v[129:130], null, s1, s39, v[50:51]
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v130, s8, v51, 2
	v_add_lshl_u32 v138, s8, v89, 2
	v_add_lshl_u32 v139, s8, v90, 2
	v_add_lshl_u32 v140, s8, v91, 2
	v_add_lshl_u32 v141, s8, v92, 2
	v_add_lshl_u32 v151, s8, v93, 2
	v_add_lshl_u32 v152, s8, v94, 2
	v_add_lshl_u32 v153, s8, v95, 2
	v_add_lshl_u32 v154, s8, v96, 2
	v_add_lshl_u32 v155, s8, v97, 2
	v_add_lshl_u32 v156, s8, v98, 2
	v_add_lshl_u32 v157, s8, v99, 2
	v_add_lshl_u32 v158, s8, v100, 2
	v_add_lshl_u32 v159, s8, v101, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s1, v113, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s3, v113, v60
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v160, s8, v102, 2
	v_add_lshl_u32 v161, s8, v103, 2
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v113, s68, v115
	v_or_b32_e32 v114, s68, v116
	v_or_b32_e32 v115, s68, v117
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s8, v112, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s9, v112, v60
	.loc	1 823 32                        ; attention.py:823:32
	v_cndmask_b32_e64 v112, 0x80000000, v128, s5
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s10, v113, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s11, v113, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s12, v114, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s13, v114, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v115, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s15, v115, v60
	.loc	1 823 32                        ; attention.py:823:32
	...
	.loc	1 823 32                        ; attention.py:823:32
	v_add_nc_u32_e32 v110, 0, v61
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v32, s40 :: v_dual_add_nc_u32 v111, 0, v62
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v116, s68, v118
	v_or_b32_e32 v117, s68, v119
	.loc	1 828 33                        ; attention.py:828:33
	...
	s_barrier
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v116, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s17, v116, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s18, v117, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s19, v117, v60
	...
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v170, 0x80000000, v116, s0
	v_cndmask_b32_e64 v171, 0x80000000, v117, s0
	.loc	1 828 33                        ; attention.py:828:33
	...
	v_or_b32_e32 v131, 2, v58
	v_or_b32_e32 v132, 4, v58
	v_or_b32_e32 v133, 6, v58
	v_or_b32_e32 v134, 8, v58
	v_or_b32_e32 v135, 10, v58
	v_or_b32_e32 v136, 12, v58
	v_or_b32_e32 v137, 14, v58
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v118, s68, v120
	v_or_b32_e32 v119, s68, v121
	...
	s_and_b32 s6, s4, s8
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v120, s68, v122
	v_or_b32_e32 v121, s68, v123
	v_or_b32_e32 v122, s68, v124
	v_or_b32_e32 v123, s68, v125
	v_or_b32_e32 v124, s68, v126
	v_or_b32_e32 v125, s68, v127
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v162, v131, s68, 1
	v_add_lshl_u32 v163, v132, s68, 1
	v_add_lshl_u32 v164, v133, s68, 1
	v_add_lshl_u32 v165, v134, s68, 1
	v_add_lshl_u32 v166, v135, s68, 1
	v_add_lshl_u32 v167, v136, s68, 1
	v_add_lshl_u32 v168, v137, s68, 1
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s20, v118, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s21, v118, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s22, v119, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s23, v119, v60
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v118, v129, s70, 1
	v_add_lshl_u32 v119, v129, s71, 1
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v169, 0x80000000, v130, s1
	v_cndmask_b32_e64 v174, 0x80000000, v138, s14
	v_cndmask_b32_e64 v175, 0x80000000, v139, s15
	v_cndmask_b32_e64 v176, 0x80000000, v140, s17
	v_cndmask_b32_e64 v177, 0x80000000, v141, s6
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s24, v120, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s26, v120, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s27, v121, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s28, v121, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s31, v123, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s33, v123, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s34, v124, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s35, v124, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s36, v125, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s37, v125, v60
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s29, v122, v59
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v122, v60
	.loc	1 867 21 is_stmt 0              ; attention.py:867:21
	s_and_b32 s13, s20, s21
	s_and_b32 s12, s18, s19
	s_and_b32 s18, s22, s23
	.loc	1 838 37 is_stmt 1              ; attention.py:838:37
	v_add_lshl_u32 v142, s68, v58, 1
	.loc	1 867 21                        ; attention.py:867:21
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v154, 0x80000000, v154, s16
	.loc	1 867 21                        ; attention.py:867:21
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v155, 0x80000000, v155, s18
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s7, s4, s21
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v143, v63, s68, 1
	v_add_lshl_u32 v144, v64, s68, 1
	v_add_lshl_u32 v145, v65, s68, 1
	v_add_lshl_u32 v146, v66, s68, 1
	v_add_lshl_u32 v147, v67, s68, 1
	v_add_lshl_u32 v148, v68, s68, 1
	v_add_lshl_u32 v149, v69, s68, 1
	v_add_lshl_u32 v150, v70, s68, 1
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v151, 0x80000000, v151, s9
	v_cndmask_b32_e64 v152, 0x80000000, v152, s11
	v_cndmask_b32_e64 v153, 0x80000000, v153, s12
	...
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v172, 0x80000000, v118, s0
	v_cndmask_b32_e64 v173, 0x80000000, v119, s0
	.loc	1 879 36                        ; attention.py:879:36
	...
	ds_store_b64 v74, v[114:115]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[110:113], v111 offset1:1
	ds_load_2addr_stride64_b64 v[114:117], v75 offset1:1
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 823 32                        ; attention.py:823:32
	ds_load_2addr_stride64_b64 v[32:35], v76 offset1:1
	ds_load_2addr_stride64_b64 v[36:39], v77 offset1:1
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(2)
	...
	buffer_load_u16 v111, v162, s[60:63], 0 offen
	buffer_load_u16 v112, v163, s[60:63], 0 offen
	buffer_load_u16 v113, v164, s[60:63], 0 offen
	buffer_load_u16 v114, v165, s[60:63], 0 offen
	buffer_load_u16 v115, v166, s[60:63], 0 offen
	buffer_load_u16 v116, v167, s[60:63], 0 offen
	buffer_load_u16 v117, v168, s[60:63], 0 offen
	buffer_load_u16 v118, v143, s[60:63], 0 offen
	buffer_load_u16 v119, v144, s[60:63], 0 offen
	buffer_load_u16 v120, v145, s[60:63], 0 offen
	buffer_load_u16 v121, v146, s[60:63], 0 offen
	buffer_load_u16 v122, v147, s[60:63], 0 offen
	buffer_load_u16 v123, v148, s[60:63], 0 offen
	buffer_load_u16 v124, v149, s[60:63], 0 offen
	buffer_load_u16 v125, v150, s[60:63], 0 offen
	.loc	1 879 36                        ; attention.py:879:36
	s_clause 0x7
	buffer_load_b32 v144, v169, s[56:59], 0 offen
	buffer_load_b32 v146, v174, s[56:59], 0 offen
	buffer_load_b32 v148, v175, s[56:59], 0 offen
	buffer_load_b32 v149, v176, s[56:59], 0 offen
	buffer_load_b32 v142, v177, s[56:59], 0 offen
	buffer_load_b32 v143, v151, s[56:59], 0 offen
	buffer_load_b32 v145, v152, s[56:59], 0 offen
	buffer_load_b32 v147, v153, s[56:59], 0 offen
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 890 30                        ; attention.py:890:30
	s_clause 0x1
	buffer_load_b128 v[36:39], v170, s[64:67], 0 offen
	buffer_load_b128 v[32:35], v171, s[64:67], 0 offen
	.loc	1 879 36                        ; attention.py:879:36
	s_clause 0x7
	buffer_load_b32 v152, v154, s[56:59], 0 offen
	buffer_load_b32 v154, v155, s[56:59], 0 offen
	buffer_load_b32 v156, v156, s[56:59], 0 offen
	buffer_load_b32 v157, v157, s[56:59], 0 offen
	...
	.loc	1 890 30                        ; attention.py:890:30
	s_clause 0x1
	buffer_load_b128 v[163:166], v172, s[64:67], 0 offen
	buffer_load_b128 v[159:162], v173, s[64:67], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt vmcnt(35)
	v_dual_mul_f32 v139, v105, v139 :: v_dual_lshlrev_b32 v110, 16, v110
	.loc	1 838 37                        ; attention.py:838:37
	s_waitcnt vmcnt(34)
	...
	ds_store_2addr_b64 v79, v[167:168], v[159:160] offset1:8
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v80, v[32:33], v[160:161] offset1:8
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v81, v[32:33], v[35:36] offset1:8
	.loc	1 879 36                        ; attention.py:879:36
	...
	v_dual_cndmask_b32 v119, v145, v147 :: v_dual_lshlrev_b32 v166, 16, v121
	...
	.loc	1 880 35                        ; attention.py:880:35
	v_cndmask_b32_e32 v118, v147, v145, vcc_lo
	v_cndmask_b32_e32 v120, v148, v149, vcc_lo
	.loc	1 881 25                        ; attention.py:881:25
	v_lshlrev_b16 v32.l, 8, v32.l
	.loc	1 880 35                        ; attention.py:880:35
	v_cndmask_b32_e32 v123, v146, v144, vcc_lo
	.loc	1 838 37                        ; attention.py:838:37
	v_lshlrev_b32_e32 v167, 16, v122
	.loc	1 880 35                        ; attention.py:880:35
	v_cndmask_b32_e32 v122, v144, v146, vcc_lo
	...
	.loc	1 880 35                        ; attention.py:880:35
	v_cndmask_b32_e32 v115, v142, v143, vcc_lo
	.loc	1 881 25                        ; attention.py:881:25
	v_lshlrev_b16 v32.l, 8, v32.l
	.loc	1 880 35                        ; attention.py:880:35
	...
	.loc	1 881 25 is_stmt 1              ; attention.py:881:25
	v_perm_b32 v150, v156, v154, v82
	.loc	1 880 35                        ; attention.py:880:35
	v_dual_mul_f32 v153, 0x3fb8aa3b, v118 :: v_dual_mul_f32 v146, 0x3fb8aa3b, v108
	.loc	1 881 25                        ; attention.py:881:25
	...
	.loc	1 880 25 is_stmt 0              ; attention.py:880:25
	v_fmac_f32_e32 v153, v130, v161
	.loc	1 880 35                        ; attention.py:880:35
	v_mul_f32_e32 v130, 0x3fb8aa3b, v145
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v146, v127, v111
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v128, v138, v167 :: v_dual_mul_f32 v157, 0x3fb8aa3b, v121
	.loc	1 880 35                        ; attention.py:880:35
	...
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v130, v134, v163 :: v_dual_fmac_f32 v157, v133, v117
	.loc	1 881 25                        ; attention.py:881:25
	...
	v_mul_f32_e32 v154, 0x3fb8aa3b, v119
	v_mul_f32_e32 v156, 0x3fb8aa3b, v120
	v_cndmask_b32_e64 v149, v124, v125, s25
	v_mul_f32_e32 v129, 0x3fb8aa3b, v129
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v154, v131, v162 :: v_dual_and_b32 v145, 0x1000000, v33
	.loc	1 880 35                        ; attention.py:880:35
	v_dual_mul_f32 v131, 0x3fb8aa3b, v126 :: v_dual_fmac_f32 v156, v132, v116
	v_cndmask_b32_e64 v132, v142, v143, s25
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v129, v139, v168 :: v_dual_and_b32 v142, 1, v33
	v_fmac_f32_e32 v131, v137, v166
	.loc	1 881 25 is_stmt 1              ; attention.py:881:25
	...
	.loc	1 880 25 is_stmt 0              ; attention.py:880:25
	v_dual_fmac_f32 v132, v141, v170 :: v_dual_and_b32 v33, 0x10000, v33
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 881 25 is_stmt 1              ; attention.py:881:25
	v_and_b32_e32 v142, 0x100, v133
	v_and_b32_e32 v141, 1, v133
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v36, v136, v165 :: v_dual_and_b32 v139, 1, v138
	.loc	1 881 25                        ; attention.py:881:25
...
.Ltmp6:
	...
	ds_load_b128 v[120:123], v87
	ds_load_b128 v[116:119], v86
...
.Ltmp8:
	...
	v_permlanex16_b32 v129, v128, s72, 0xfedcba98 op_sel:[1,0]
.Ltmp9:
	.loc	1 884 24                        ; attention.py:884:24
	v_max3_f32 v162, v106, v128, v129
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_sub_f32_e32 v136, v106, v162
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v134, v134
	v_exp_f32_e32 v135, v135
	.loc	1 886 33 is_stmt 0              ; attention.py:886:33
	v_cndmask_b32_e64 v106, v128, 0, s30
	...
	v_cndmask_b16 v106.l, 0x7fff, v128.h, s30
	...
	v_cndmask_b16 v106.h, 0x7fff, v106.h, s29
	...
	v_permlanex16_b32 v130, v106, s72, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v133, v32, s72, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b16 v135.h, 0x7fff, v131.h, s36
	v_cndmask_b16 v136.h, 0x7fff, v132.h, s37
	s_delay_alu instid0(VALU_DEP_4)
	v_perm_b32 v128, v130, v106, v52
	v_perm_b32 v129, v130, v106, v53
	v_perm_b32 v130, v133, v32, v52
	v_permlanex16_b32 v106, v135, s72, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v131, v133, v32, v53
	v_permlanex16_b32 v32, v136, s72, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_perm_b32 v132, v106, v135, v52
	v_perm_b32 v133, v106, v135, v53
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[108:111], v86 offset:2048
	ds_load_b128 v[112:115], v87 offset:2048
	.loc	1 895 23                        ; attention.py:895:23
	...
	.loc	1 896 23                        ; attention.py:896:23
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[0:7], v[108:115], v[128:135], v[0:7]
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v113, v151, v140, s25
	v_cndmask_b32_e64 v114, v140, v151, s25
	v_cndmask_b32_e64 v115, v33, v148, s25
	v_cndmask_b32_e64 v108, v144, v141, s25
	v_cndmask_b32_e64 v109, v35, v145, s25
	ds_bpermute_b32 v113, v71, v113
	ds_bpermute_b32 v114, v78, v114
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v16, v16, v32
	.loc	1 882 26                        ; attention.py:882:26
	ds_bpermute_b32 v115, v71, v115
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v20, v20, v32
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v32, v141, v144, s25
	v_cndmask_b32_e64 v110, v145, v35, s25
	v_cndmask_b32_e64 v111, v150, v146, s25
	v_cndmask_b32_e64 v112, v146, v150, s25
	.loc	1 896 23                        ; attention.py:896:23
	v_wmma_f32_16x16x16_bf16 v[16:23], v[116:123], v[128:135], v[16:23]
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[120:123], v158 offset:2048
	ds_load_b128 v[116:119], v158 offset:3072
	.loc	1 882 26                        ; attention.py:882:26
	ds_bpermute_b32 v109, v71, v109
	ds_bpermute_b32 v110, v78, v110
	ds_bpermute_b32 v111, v71, v111
	ds_bpermute_b32 v112, v78, v112
	ds_bpermute_b32 v108, v78, v108
	ds_bpermute_b32 v32, v71, v32
	.loc	1 886 62                        ; attention.py:886:62
	...
	v_cndmask_b32_e64 v123, v148, v33, s25
	ds_bpermute_b32 v128, v71, v128
	ds_bpermute_b32 v129, v78, v129
	ds_bpermute_b32 v130, v71, v130
	ds_bpermute_b32 v131, v78, v131
	v_cndmask_b32_e64 v132, v149, v142, s25
	v_cndmask_b32_e64 v133, v142, v149, s25
	ds_bpermute_b32 v123, v78, v123
	.loc	1 886 62                        ; attention.py:886:62
	s_waitcnt lgkmcnt(9)
	v_dual_sub_f32 v134, v141, v162 :: v_dual_cndmask_b32 v135, v110, v109
	.loc	1 882 26                        ; attention.py:882:26
	ds_bpermute_b32 v132, v71, v132
	ds_bpermute_b32 v133, v78, v133
	s_waitcnt lgkmcnt(9)
	v_dual_cndmask_b32 v109, v109, v110 :: v_dual_cndmask_b32 v110, v112, v111
	v_dual_cndmask_b32 v111, v111, v112 :: v_dual_sub_f32 v36, v36, v162
	v_dual_cndmask_b32 v112, v114, v113 :: v_dual_cndmask_b32 v113, v113, v114
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v134, v134
	...
	.loc	1 882 26                        ; attention.py:882:26
	s_waitcnt lgkmcnt(5)
	v_cndmask_b32_e32 v114, v129, v128, vcc_lo
	s_waitcnt lgkmcnt(3)
	v_dual_cndmask_b32 v146, v128, v129 :: v_dual_cndmask_b32 v147, v131, v130
	v_cndmask_b32_e32 v148, v130, v131, vcc_lo
.Ltmp10:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max_f32_e32 v128, v108, v108
	s_waitcnt lgkmcnt(2)
	v_dual_max_f32 v129, v32, v32 :: v_dual_cndmask_b32 v160, v123, v115
.Ltmp11:
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e32 v130, v108, v32, vcc_lo
	v_dual_cndmask_b32 v32, v32, v108 :: v_dual_cndmask_b32 v163, v115, v123
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v108, v150, v162
	v_sub_f32_e32 v131, v149, v162
.Ltmp12:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max3_f32 v115, v115, v123, v114
	v_max3_f32 v123, v111, v112, v113
	v_max_f32_e32 v128, v129, v128
	v_max3_f32 v129, v109, v147, v148
.Ltmp13:
	.loc	1 882 26                        ; attention.py:882:26
	s_waitcnt lgkmcnt(0)
...
.Ltmp14:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max3_f32 v132, v132, v133, v110
.Ltmp15:
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp16:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max3_f32 v115, v123, v115, v146
	v_max3_f32 v123, v128, v135, v129
.Ltmp17:
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v128, 0, v134, s28
...
.Ltmp18:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max3_f32 v115, v123, v132, v115
.Ltmp19:
	.loc	1 896 30                        ; attention.py:896:30
	v_mov_b16_e64 v106.l, v128.h
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v108, 0, v108, s13
	v_cndmask_b32_e64 v123, v131, 0, s26
	.loc	1 896 30                        ; attention.py:896:30
	v_mov_b16_e32 v120.l, v36.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
.Ltmp20:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:883:29 ]
	v_dual_mov_b32 v131, v115 :: v_dual_and_b32 v106, 1, v106
.Ltmp21:
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp23:
	.loc	1 896 30                        ; attention.py:896:30
	v_add3_u32 v106, v128, v106, 0x7fff
...
.Ltmp25:
	...
	v_cndmask_b16 v36.l, 0x7fff, v106.h, s13
.Ltmp26:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max_f32_e32 v106, v115, v128
.Ltmp27:
	.loc	1 896 30                        ; attention.py:896:30
	v_mov_b16_e32 v34.l, v35.h
	.loc	1 885 25                        ; attention.py:885:25
	v_cmp_neq_f32_e64 s13, 0xff800000, v107
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v132.l, 0x7fff, v108.h, s20
	v_cmp_o_f32_e64 s27, v123, v123
	.loc	1 884 24                        ; attention.py:884:24
	v_max_f32_e32 v108, v38, v106
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v140, v151, v162
	.loc	1 884 24                        ; attention.py:884:24
	v_max_f32_e32 v39, v39, v106
	.loc	1 896 30                        ; attention.py:896:30
	v_and_b32_e32 v38, 1, v34
	v_mov_b16_e32 v34.l, v123.h
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v109, v109, v108
	.loc	1 886 49 is_stmt 0              ; attention.py:886:49
	v_exp_f32_e32 v133, v140
	.loc	1 885 74 is_stmt 1              ; attention.py:885:74
	v_dual_sub_f32 v106, v107, v39 :: v_dual_sub_f32 v113, v113, v108
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v120, v130, v108
	v_sub_f32_e32 v32, v32, v108
	v_sub_f32_e32 v121, v135, v108
	.loc	1 886 49 is_stmt 0              ; attention.py:886:49
	v_exp_f32_e32 v109, v109
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v111, v111, v108
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_cndmask_b16 v115.l, 0x7fff, v36.h, s19
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v32, v32
	s_delay_alu instid0(TRANS32_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 886 33 is_stmt 0              ; attention.py:886:33
	v_cndmask_b32_e64 v129, v133, 0, s18
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_cmp_o_f32_e64 s18, v35, v35
	v_add3_u32 v35, v35, v38, 0x7fff
	.loc	1 886 62                        ; attention.py:886:62
	v_dual_sub_f32 v135, v160, v108 :: v_dual_and_b32 v38, 1, v34
	.loc	1 896 30                        ; attention.py:896:30
	v_mov_b16_e64 v34.l, v129.h
	.loc	1 885 61                        ; attention.py:885:61
	v_exp_f32_e32 v133, v106
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v106, v120
	v_exp_f32_e32 v107, v121
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v36.h, 0x7fff, v35.h, s18
	v_and_b32_e32 v35, 1, v34
	v_add3_u32 v38, v123, v38, 0x7fff
	v_mov_b16_e32 v122.h, v34.h
	v_mov_b16_e32 v122.l, v33.h
	v_cmp_o_f32_e64 s28, v129, v129
	v_add3_u32 v35, v129, v35, 0x7fff
	v_cndmask_b16 v115.h, 0x7fff, v38.h, s27
	.loc	1 886 33                        ; attention.py:886:33
	...
	v_cndmask_b16 v132.h, 0x7fff, v35.h, s28
.Ltmp28:
...
.Ltmp29:
	.loc	1 886 62                        ; attention.py:886:62
	v_dual_sub_f32 v38, v147, v108 :: v_dual_add_f32 v35, v106, v107
	v_sub_f32_e32 v107, v148, v108
	v_sub_f32_e32 v109, v164, v108
	v_sub_f32_e32 v134, v165, v108
	...
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_permlanex16_b32 v120, v36, s72, 0xfedcba98 op_sel:[1,0]
	v_dual_mov_b32 v107, v39 :: v_dual_sub_f32 v112, v112, v108
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v147, v163, v108
	.loc	1 886 33 is_stmt 0              ; attention.py:886:33
	v_cndmask_b32_e64 v38, 0, v38, s17
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_perm_b32 v144, v120, v36, v52
	v_perm_b32 v145, v120, v36, v53
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v36, v161, v162
	.loc	1 886 33 is_stmt 0              ; attention.py:886:33
	v_cndmask_b32_e64 v39, 0, v148, s9
	v_cndmask_b32_e64 v109, 0, v109, s11
	v_cndmask_b32_e64 v134, 0, v134, s12
	v_cndmask_b32_e64 v110, 0, v110, s16
	v_cndmask_b32_e64 v111, 0, v111, s15
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v36, v36
	.loc	1 886 62                        ; attention.py:886:62
	v_sub_f32_e32 v146, v146, v108
.Ltmp30:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_dual_add_f32 v38, v38, v39 :: v_dual_add_f32 v39, v109, v134
	s_delay_alu instid0(VALU_DEP_3)
...
.Ltmp33:
	...
	v_cndmask_b32_e64 v146, 0, v146, s6
	.loc	1 896 30                        ; attention.py:896:30
	v_and_b32_e32 v34, 1, v34
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp34:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_dual_add_f32 v110, v112, v113 :: v_dual_add_f32 v111, v135, v147
.Ltmp35:
	.loc	1 896 30                        ; attention.py:896:30
	v_cmp_o_f32_e64 s3, v36, v36
.Ltmp36:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_add_f32_e32 v112, v114, v146
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
.Ltmp37:
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp41:
	...
	ds_load_b128 v[156:159], v85 offset:2048
	ds_load_b128 v[140:143], v88
	ds_load_b128 v[120:123], v88 offset:2048
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v39, v115, s72, 0xfedcba98 op_sel:[1,0]
	.loc	1 885 25                        ; attention.py:885:25
...
.Ltmp43:
	...
	v_permlanex16_b32 v34, v132, s72, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v146, v39, v115, v52
.Ltmp44:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_add_f32_e32 v32, v32, v35
.Ltmp45:
	.loc	1 896 30                        ; attention.py:896:30
	v_perm_b32 v147, v39, v115, v53
	v_permlanex16_b32 v36, v33, s72, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v148, v34, v132, v52
	v_perm_b32 v149, v34, v132, v53
.Ltmp46:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_dual_mov_b32 v35, v32 :: v_dual_mov_b32 v106, v162
...
.Ltmp49:
	...
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2)
	v_wmma_f32_16x16x16_bf16 v[24:31], v[124:131], v[144:151], v[24:31]
	s_waitcnt lgkmcnt(1)
...
.Ltmp51:
	...
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[0:7], v[116:123], v[144:151], v[0:7]
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 897 23                        ; attention.py:897:23
	v_fmac_f32_e32 v109, v37, v133
	.loc	1 818 13                        ; attention.py:818:13
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_fp32_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.num_vgpr, 178
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_fp32_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.numbered_sgpr, 74
