	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v9, 0x100, v0
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v31, 15, v0
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	v_lshlrev_b32_e32 v7, 1, v0
	v_mov_b32_e32 v29, 0
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v11, 0xe0, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v32, 0, v7
...
.Ltmp11:
	...
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v33, v32, v7
	v_mov_b32_e32 v15, 0
...
; %bb.1:                                ; %.lr.ph
	...
	v_add3_u32 v4, s42, v4, v31
	s_lshl_b32 s0, s13, 8
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v5, 0, v31
	v_mul_lo_u32 v8, s35, v6
	v_subrev_nc_u32_e32 v36, s0, v3
	s_lshl_b32 s0, s14, 7
	s_mov_b32 s14, s12
	...
	v_add3_u32 v40, v3, s42, v1
	v_add_nc_u32_e32 v41, v5, v18
	v_mul_lo_u32 v7, s22, v7
	v_dual_mov_b32 v28, 0 :: v_dual_lshlrev_b32 v35, 1, v17
	v_mov_b32_e32 v26, 0
	v_dual_mov_b32 v25, 0 :: v_dual_lshlrev_b32 v38, 1, v4
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_cmp_lg_u32 s10, 0
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	v_cndmask_b32_e64 v42, 0x80000000, v40, s0
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v40, s34, v40
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	buffer_load_u16 v64, v42, s[4:7], 0 offen
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	v_cndmask_b32_e64 v42, 0x80000000, v39, s0
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v39, s23, v39
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	buffer_load_b32 v65, v42, s[24:27], 0 offen
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	ds_load_u8 v42, v30 offset:2368
	ds_load_u8 v43, v30 offset:2304
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v30 offset:2496
	ds_load_u8 v44, v30 offset:2432
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v43, 16, v42
	ds_load_u8 v42, v30 offset:2112
	ds_load_u8 v43, v30 offset:2048
	ds_load_u8 v52, v30 offset:2080
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v30 offset:2240
	ds_load_u8 v44, v30 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	ds_load_u8 v50, v30 offset:2880
	ds_load_u8 v51, v30 offset:2816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v30 offset:3008
	ds_load_u8 v53, v30 offset:2944
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v53, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v30 offset:2624
	ds_load_u8 v53, v30 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v53, v50, 0xc0c0004
	ds_load_u8 v53, v30 offset:2752
	ds_load_u8 v54, v30 offset:2688
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v50, v30 offset:2400
	ds_load_u8 v51, v30 offset:2336
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v30 offset:2528
	ds_load_u8 v53, v30 offset:2464
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v53, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v63, v51, 16, v50
	ds_load_u8 v50, v30 offset:2144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v51, v30 offset:2272
	ds_load_u8 v52, v30 offset:2208
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v58, v30 offset:2912
	ds_load_u8 v59, v30 offset:2848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	ds_load_u8 v59, v30 offset:3040
	ds_load_u8 v62, v30 offset:2976
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v59, v62, v59, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v59, v59, 16, v58
	ds_load_u8 v58, v30 offset:2656
	ds_load_u8 v62, v30 offset:2592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v62, v58, 0xc0c0004
	ds_load_u8 v62, v30 offset:2784
	ds_load_u8 v63, v30 offset:2720
	s_waitcnt lgkmcnt(0)
	...
	s_clause 0x1
	buffer_load_u16 v58, v38, s[28:31], 0 offen
	buffer_load_u16 v59, v37, s[28:31], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v51, v51, v59 :: v_dual_lshlrev_b32 v58, 16, v58
	v_dual_mul_f32 v45, v45, v58 :: v_dual_add_nc_u32 v60, v35, v36
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v61, v60, s[36:39], 0 offen
	buffer_load_u16 v62, v60, s[36:39], 0 offen offset:4
	buffer_load_u16 v63, v60, s[36:39], 0 offen offset:8
	buffer_load_u16 v66, v60, s[36:39], 0 offen offset:12
	buffer_load_u16 v67, v60, s[36:39], 0 offen offset:16
	buffer_load_u16 v68, v60, s[36:39], 0 offen offset:20
	buffer_load_u16 v69, v60, s[36:39], 0 offen offset:24
	buffer_load_u16 v60, v60, s[36:39], 0 offen offset:28
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	...
	v_dual_mul_f32 v49, v49, v58 :: v_dual_mul_f32 v52, v52, v59
	v_mul_f32_e32 v50, v50, v59
	v_mul_f32_e32 v53, v53, v59
	v_dual_mul_f32 v55, v55, v59 :: v_dual_add_nc_u32 v36, s11, v36
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b16 v32, v64 offset:2048
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v54, v54, v59 :: v_dual_fmac_f32 v29, v43, v62
	v_dual_mul_f32 v56, v56, v59 :: v_dual_fmac_f32 v27, v45, v66
	v_dual_mul_f32 v57, v57, v59 :: v_dual_fmac_f32 v10, v42, v61
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v28, v44, v63 :: v_dual_fmac_f32 v25, v47, v68
	v_dual_fmac_f32 v26, v46, v67 :: v_dual_fmac_f32 v23, v49, v60
	v_dual_fmac_f32 v24, v48, v69 :: v_dual_fmac_f32 v21, v51, v62
	v_dual_fmac_f32 v22, v50, v61 :: v_dual_fmac_f32 v19, v53, v66
	v_fmac_f32_e32 v20, v52, v63
	v_dual_fmac_f32 v15, v54, v67 :: v_dual_fmac_f32 v14, v55, v68
	v_dual_fmac_f32 v13, v56, v69 :: v_dual_fmac_f32 v12, v57, v60
...
; %bb.4:
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	v_add3_u32 v1, 0, v31, v18
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	ds_load_u8 v2, v30 offset:2368
	ds_load_u8 v3, v30 offset:2304
	ds_load_u8 v4, v30 offset:2496
	ds_load_u8 v5, v30 offset:2432
	ds_load_u8 v6, v30 offset:2112
	ds_load_u8 v7, v30 offset:2048
	ds_load_u8 v8, v30 offset:2240
	ds_load_u8 v31, v30 offset:2176
	ds_load_u8 v32, v1 offset:640
	ds_load_u8 v33, v1 offset:768
	ds_load_u8 v34, v1 offset:512
	ds_load_u8 v35, v1 offset:896
	ds_load_u8 v36, v1 offset:128
	ds_load_u8 v37, v1 offset:384
	ds_load_u8 v38, v1 offset:256
	ds_load_u8 v39, v1
	ds_load_u8 v44, v30 offset:2528
	ds_load_u8 v45, v30 offset:2464
	ds_load_u8 v46, v30 offset:2400
	ds_load_u8 v47, v30 offset:2336
	ds_load_u8 v48, v30 offset:2272
	ds_load_u8 v49, v30 offset:2208
	ds_load_u8 v50, v30 offset:2144
	ds_load_u8 v51, v30 offset:2080
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v2, v3, v2, 0xc0c0004
	ds_load_u8 v66, v30 offset:2784
	ds_load_u8 v67, v30 offset:2720
	ds_load_u8 v68, v30 offset:2656
	ds_load_u8 v69, v30 offset:2592
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v3, v5, v4, 0xc0c0004
	ds_load_u8 v61, v1 offset:1152
	ds_load_u8 v62, v1 offset:1408
	ds_load_u8 v63, v1 offset:1280
	ds_load_u8 v64, v1 offset:1024
	...
	v_perm_b32 v6, v34, v32, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v7, v33, v35, 0xc0c0004
	v_lshl_or_b32 v40, v5, 16, v4
	ds_load_u8 v4, v30 offset:2880
	ds_load_u8 v5, v30 offset:2816
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v3, v38, v37, 0xc0c0004
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v2, v39, v36, 0xc0c0004
	v_lshl_or_b32 v43, v7, 16, v6
	ds_load_u8 v6, v30 offset:3008
	ds_load_u8 v7, v30 offset:2944
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	v_lshl_or_b32 v42, v3, 16, v2
	ds_load_u8 v2, v30 offset:2624
	ds_load_u8 v3, v30 offset:2560
	ds_load_u8 v8, v30 offset:2752
	ds_load_u8 v31, v30 offset:2688
	ds_load_u8 v52, v1 offset:1664
	ds_load_u8 v53, v1 offset:1920
	ds_load_u8 v54, v1 offset:1792
	ds_load_u8 v55, v1 offset:1536
	ds_load_u8 v56, v30 offset:3040
	ds_load_u8 v57, v30 offset:2976
	ds_load_u8 v58, v30 offset:2912
	ds_load_u8 v59, v30 offset:2848
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	...
	v_perm_b32 v60, v5, v4, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v30, v3, v2, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v70, v31, v8, 0xc0c0004
	v_perm_b32 v65, v7, v6, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[42:43], v[40:41], v[32:39] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	...
	v_lshl_or_b32 v31, v65, 16, v60
	v_lshl_or_b32 v30, v70, 16, v30
	v_lshl_or_b32 v40, v49, 16, v40
	v_wmma_i32_16x16x16_iu4 v[32:39], v[42:43], v[44:45], v[32:39] neg_lo:[1,1,0]
	v_lshl_or_b32 v43, v47, 16, v46
	v_lshl_or_b32 v42, v50, 16, v48
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[40:41], v[30:31], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[40:41], v[42:43], v[32:39] neg_lo:[1,1,0]
...
.LBB0_5:
	...
	v_add_nc_u32_e32 v31, 8, v17
	v_add_nc_u32_e32 v42, 16, v17
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v6, v6, v40 :: v_dual_add_nc_u32 v43, 20, v17
	v_mul_f32_e32 v1, v1, v40
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v18, 0x80000000, v30, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v2, v2, v40
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v30, 0x80000000, v31, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v4, v4, v40 :: v_dual_add_nc_u32 v31, 12, v17
	v_dual_mul_f32 v5, v5, v40 :: v_dual_add_nc_u32 v44, 24, v17
	v_dual_mul_f32 v8, v8, v40 :: v_dual_add_nc_u32 v17, 28, v17
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v46, v30, s[20:23], 0 offen
	...
	buffer_load_u16 v48, v17, s[20:23], 0 offen
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v49, v16, s[8:11], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_and_b32_e32 v51, 0x78, v16
	v_and_b32_e32 v18, 0x840, v18
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_mul_lo_u32 v31, s35, v30
	v_add3_u32 v16, s42, s33, v17
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	s_waitcnt lgkmcnt(0)
	v_lshl_or_b32 v11, v11, 3, v51
	v_lshrrev_b32_e32 v51, 1, v9
	s_barrier
	...
	v_xad_u32 v52, v11, 8, 0
	v_xad_u32 v53, v11, 16, 0
	v_xad_u32 v54, v11, 24, 0
	v_xad_u32 v55, v11, 32, 0
	v_xad_u32 v56, v11, 40, 0
	v_xad_u32 v57, v11, 48, 0
	v_xad_u32 v58, v11, 56, 0
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(8)
	...
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_add_nc_u32_e32 v17, v16, v31
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v42, 16, v42
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v40, v3, v45, v28
	v_fma_f32 v6, v6, v43, v25
	...
	v_fma_f32 v2, v2, v41, v29
	v_fma_f32 v11, v32, v11, v22
	v_fma_f32 v4, v4, v46, v27
	v_fma_f32 v32, v33, v41, v21
	v_fma_f32 v33, v34, v45, v20
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
	v_add_co_u32 v17, vcc_lo, s40, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v47, v23
	v_fma_f32 v34, v35, v46, v19
	v_fma_f32 v48, v5, v42, v26
	v_fma_f32 v35, v36, v42, v15
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_ci_u32_e64 v18, null, s41, v18, vcc_lo
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v49, v7, v44, v24
	v_fma_f32 v36, v37, v43, v14
	v_fma_f32 v37, v38, v44, v13
	v_fma_f32 v38, v39, v47, v12
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v1, v10, v1, s2
	v_cndmask_b32_e64 v3, v29, v2, s2
	v_cndmask_b32_e64 v2, v22, v11, s2
	v_cndmask_b32_e64 v7, v27, v4, s2
	v_cndmask_b32_e64 v4, v21, v32, s2
	v_cndmask_b32_e64 v5, v28, v40, s2
	v_cndmask_b32_e64 v25, v25, v6, s2
	v_cndmask_b32_e64 v6, v20, v33, s2
	v_cndmask_b32_e64 v23, v23, v8, s2
	v_cndmask_b32_e64 v8, v19, v34, s2
	v_cndmask_b32_e64 v10, v26, v48, s2
	v_cndmask_b32_e64 v11, v15, v35, s2
	v_cndmask_b32_e64 v27, v24, v49, s2
	v_cndmask_b32_e64 v26, v14, v36, s2
	v_cndmask_b32_e64 v28, v13, v37, s2
	v_cndmask_b32_e64 v24, v12, v38, s2
	ds_store_b64 v51, v[1:2]
	ds_store_b64 v52, v[3:4]
	ds_store_b64 v53, v[5:6]
	ds_store_b64 v54, v[7:8]
	ds_store_b64 v55, v[10:11]
	ds_store_b64 v56, v[25:26]
	ds_store_b64 v57, v[27:28]
	ds_store_b64 v58, v[23:24]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.num_vgpr, 71
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_maskk.kd
