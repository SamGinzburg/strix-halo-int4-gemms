...
.LBB0_3:                                ; %Flow610
	...
	v_or_b32_e32 v38, s33, v119
	s_ashr_i32 s1, s5, 6
	scratch_store_b32 off, v119, off offset:76 ; 4-byte Folded Spill
	v_or_b32_e32 v156, s26, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[157:160], v69 offset:4096
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[179:186], v[157:160], v[81:84], v[125:132] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[198:205], v[157:160], v[133:136], v[125:132] neg_lo:[1,1,0]
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[157:160], v66 offset:2048
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[222:229], v[133:136], v[157:160], v[222:229] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_wmma_i32_16x16x16_iu8 v[230:237], v[187:190], v[157:160], v[230:237] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[179:186], v[133:136], v[81:84], v[179:186] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[198:205], v[133:136], v[157:160], v[198:205] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	v_wmma_i32_16x16x16_iu8 v[214:221], v[133:136], v[157:160], v[214:221] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[81:84], v66
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[133:136], v69
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v128, v156, s49, 1
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	v_fmac_f32_e32 v173, v11, v155
	s_waitcnt vmcnt(30)
	v_dual_fmac_f32 v194, v10, v116 :: v_dual_lshlrev_b32 v11, 16, v129
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v155, v9, v154
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	s_waitcnt vmcnt(21)
	v_dual_fmac_f32 v58, v155, v180 :: v_dual_lshlrev_b32 v155, 16, v229
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v10, v127, v11
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v157, v9, v155
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(20)
	v_lshlrev_b32_e32 v157, 16, v230
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v169, v10, v134
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v10, v127, v126
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v158, v9, v157
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v170, v10, v133
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	s_waitcnt vmcnt(19)
	v_dual_fmac_f32 v89, v10, v136 :: v_dual_lshlrev_b32 v158, 16, v231
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v10, v127, v129 :: v_dual_mul_f32 v159, v9, v158
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v91, v10, v135 :: v_dual_mul_f32 v10, v127, v130
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(17)
	v_lshlrev_b32_e32 v160, 16, v233
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v10, v127, v132
	v_dual_mul_f32 v174, v9, v160 :: v_dual_fmac_f32 v59, v10, v198
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v10, v127, v154 :: v_dual_fmac_f32 v33, v174, v185
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v60, v10, v199
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v10, v127, v155
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	s_waitcnt vmcnt(16)
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v34, v176, v186 :: v_dual_fmac_f32 v35, v10, v204
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v193, 0 :: v_dual_mov_b32 v138, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_mov_b32 v231, 0 :: v_dual_mov_b32 v102, 0
	...
	v_dual_mov_b32 v255, 0 :: v_dual_mov_b32 v88, 0
...
; %bb.9:
	...
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[179:186], v[157:160], v[29:32], v[125:132] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[206:213], v[157:160], v[13:16], v[125:132] neg_lo:[1,1,0]
...
; %bb.13:
	...
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[215:222], v[157:160], v[25:28], v[215:222] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu8 v[199:206], v[157:160], v[5:8], v[199:206] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	...
	v_cvt_f32_i32_e32 v154, v216
	v_cvt_f32_i32_e32 v174, v217
	v_cvt_f32_i32_e32 v210, v218
	v_cvt_f32_i32_e32 v157, v221
	...
	v_cvt_f32_i32_e32 v160, v205
	v_cvt_f32_i32_e32 v159, v206
.LBB0_14:
	.loc	1 0 19 is_stmt 0                ; generate_amdgcn.py:0:19
...
; %bb.15:
	...
	v_dual_mov_b32 v225, v231 :: v_dual_add_nc_u32 v90, s44, v90
	v_dual_mov_b32 v126, v100 :: v_dual_add_nc_u32 v83, s44, v83
	...
	v_dual_mov_b32 v248, v180 :: v_dual_mov_b32 v231, v182
	ds_load_b128 v[179:182], v90 offset:4096
	v_dual_mov_b32 v100, v0 :: v_dual_mov_b32 v1, v162
	...
	v_dual_mov_b32 v162, v161 :: v_dual_mov_b32 v161, v156
	v_dual_mov_b32 v156, v153 :: v_dual_mov_b32 v153, v152
	v_dual_mov_b32 v152, v151 :: v_dual_mov_b32 v151, v150
	ds_load_b128 v[244:247], v84 offset:4096
	ds_load_b128 v[157:160], v84
	v_mov_b32_e32 v84, v187
	v_dual_mov_b32 v150, v149 :: v_dual_mov_b32 v149, v148
	...
	v_dual_mov_b32 v232, v155 :: v_dual_mov_b32 v155, v176
	v_mov_b32_e32 v176, v212
	v_wmma_i32_16x16x16_iu8 v[207:214], v[227:230], v[17:20], v[217:224] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[199:206], v[157:160], v[21:24], v[199:206] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_wmma_i32_16x16x16_iu8 v[17:24], v[157:160], v[9:12], v[17:24] neg_lo:[1,1,0]
	...
	v_dual_mov_b32 v153, v156 :: v_dual_mov_b32 v156, v161
	...
	v_dual_mov_b32 v236, v249 :: v_dual_mov_b32 v249, v250
	...
	v_dual_mov_b32 v100, v126 :: v_dual_mov_b32 v179, v241
	v_dual_mov_b32 v182, v231 :: v_dual_mov_b32 v231, v225
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 256
