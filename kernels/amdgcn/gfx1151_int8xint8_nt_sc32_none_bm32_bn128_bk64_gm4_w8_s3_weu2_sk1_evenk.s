	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp22:
	...
	v_dual_mov_b32 v23, 0 :: v_dual_lshlrev_b32 v4, 4, v4
	v_or_b32_e32 v13, s22, v15
	v_mov_b32_e32 v25, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v29, v3, v8, s2
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_or_b32 v8, s15, 7, v16
	s_mov_b32 s15, s12
	...
	v_dual_mov_b32 v24, 0 :: v_dual_lshlrev_b32 v5, 4, v0
	v_and_b32_e32 v10, 0x160, v10
	v_and_b32_e32 v2, 28, v6
	v_dual_mov_b32 v27, 0 :: v_dual_and_b32 v6, 0x37c, v6
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v7, s22, v7
	...
	v_mul_lo_u32 v31, v9, s28
	v_dual_mov_b32 v21, 0 :: v_dual_and_b32 v12, 0x90, v12
	...
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v39, 0, v6
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v43, 0, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v5, v12, v5
	v_xor_b32_e32 v12, 16, v14
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v44, 0, v3
	v_or_b32_e32 v32, 2, v29
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v40, 0, v5
	...
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v41, 0, v14
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v42, 0, v12
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v64, v64, v79 :: v_dual_lshlrev_b32 v77, 16, v109
	...
	v_mul_f32_e32 v62, v62, v79
	v_dual_mul_f32 v76, v80, v76 :: v_dual_fmac_f32 v19, v53, v82
	v_dual_mul_f32 v75, v80, v75 :: v_dual_fmac_f32 v24, v45, v82
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v28, v46, v81 :: v_dual_fmac_f32 v27, v47, v86
	v_dual_fmac_f32 v20, v54, v81 :: v_dual_fmac_f32 v17, v55, v86
	v_dual_fmac_f32 v26, v48, v85 :: v_dual_fmac_f32 v25, v49, v90
	v_dual_fmac_f32 v18, v56, v85 :: v_dual_fmac_f32 v13, v57, v90
	v_dual_fmac_f32 v23, v50, v89 :: v_dual_fmac_f32 v22, v51, v94
	v_dual_fmac_f32 v14, v58, v89 :: v_dual_fmac_f32 v27, v63, v88
	v_dual_fmac_f32 v21, v52, v93 :: v_dual_fmac_f32 v12, v59, v94
	v_dual_fmac_f32 v11, v60, v93 :: v_dual_fmac_f32 v24, v61, v84
	v_dual_fmac_f32 v28, v62, v83 :: v_dual_fmac_f32 v25, v65, v92
	v_dual_fmac_f32 v26, v64, v87 :: v_dual_fmac_f32 v19, v69, v84
	v_dual_fmac_f32 v23, v66, v91 :: v_dual_fmac_f32 v22, v67, v96
	v_dual_fmac_f32 v21, v68, v95 :: v_dual_fmac_f32 v12, v75, v96
	v_dual_fmac_f32 v20, v70, v83 :: v_dual_fmac_f32 v17, v71, v88
	v_dual_fmac_f32 v18, v72, v87 :: v_dual_fmac_f32 v13, v73, v92
	v_fmac_f32_e32 v14, v74, v91
	v_fmac_f32_e32 v11, v76, v95
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 129
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
