	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
.Lfunc_begin0:
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v94, 0 :: v_dual_mov_b32 v53, 0
	...
	v_dual_mov_b32 v40, 0 :: v_dual_mov_b32 v7, 0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_fmac_f32 v97, v155, v154 :: v_dual_fmac_f32 v90, v153, v152
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v84, v160, v149
	v_dual_fmac_f32 v92, v157, v146 :: v_dual_lshlrev_b32 v145, 16, v145
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v158, v179, v143 :: v_dual_fmac_f32 v95, v156, v145
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x1
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v161, v186, v143 :: v_dual_lshlrev_b32 v150, 16, v150
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	...
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v82, v161, v150 :: v_dual_fmac_f32 v89, v158, v147
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_clause 0x3
	...
	v_dual_mul_f32 v105, v105, v143 :: v_dual_add_nc_u32 v100, s44, v100
	v_dual_mul_f32 v107, v107, v143 :: v_dual_add_nc_u32 v102, 2, v102
	...
	s_waitcnt vmcnt(12)
	v_dual_fmac_f32 v54, v169, v156 :: v_dual_lshlrev_b32 v157, 16, v157
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(8)
	v_lshlrev_b32_e32 v158, 16, v158
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v58, v167, v155 :: v_dual_lshlrev_b32 v149, 16, v149
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v98, v171, v157 :: v_dual_lshlrev_b32 v147, 16, v147
	s_waitcnt vmcnt(13)
	v_dual_fmac_f32 v94, v173, v158 :: v_dual_lshlrev_b32 v159, 16, v159
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v148, 16, v148
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v174, v198, v143 :: v_dual_fmac_f32 v85, v176, v149
	v_mul_f32_e32 v172, v196, v143
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v160, 16, v160
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v78, v179, v161
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v91, v174, v148 :: v_dual_fmac_f32 v96, v172, v147
	v_fmac_f32_e32 v83, v177, v160
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x3
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v88, v175, v159 :: v_dual_fmac_f32 v81, v178, v150
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	...
	v_mul_f32_e32 v122, v122, v143
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(32)
	v_lshlrev_b32_e32 v151, 16, v151
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(31)
	v_dual_fmac_f32 v55, v107, v153 :: v_dual_lshlrev_b32 v162, 16, v162
	v_fmac_f32_e32 v53, v108, v164
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v64, v144, v151
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x3
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v120, v120, v143 :: v_dual_fmac_f32 v51, v109, v165
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v146, 16, v146
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v124, v124, v143 :: v_dual_fmac_f32 v93, v110, v154
	v_dual_mul_f32 v126, v126, v143 :: v_dual_fmac_f32 v87, v111, v166
	v_dual_mul_f32 v128, v128, v143 :: v_dual_fmac_f32 v73, v114, v145
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(25)
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v132, v132, v143 :: v_dual_fmac_f32 v67, v117, v169
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v147, 16, v147
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v134, v134, v143 :: v_dual_fmac_f32 v69, v116, v156
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v159, 16, v159
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v136, v136, v143 :: v_dual_fmac_f32 v49, v119, v170
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v179, 16, v179
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v138, v138, v143 :: v_dual_fmac_f32 v47, v120, v157
	v_dual_mul_f32 v140, v140, v143 :: v_dual_fmac_f32 v41, v123, v172
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v50, v118, v146 :: v_dual_add_nc_u32 v99, s44, v99
	v_dual_fmac_f32 v38, v125, v173 :: v_dual_fmac_f32 v57, v106, v163
	v_fmac_f32_e32 v76, v126, v148
	v_dual_fmac_f32 v80, v112, v155 :: v_dual_fmac_f32 v75, v127, v174
	v_dual_fmac_f32 v70, v130, v149 :: v_dual_fmac_f32 v77, v113, v167
	v_dual_fmac_f32 v68, v131, v176 :: v_dual_fmac_f32 v45, v121, v171
	v_dual_fmac_f32 v66, v132, v160 :: v_dual_fmac_f32 v43, v122, v147
	v_dual_fmac_f32 v63, v133, v177 :: v_dual_fmac_f32 v48, v134, v150
	v_fmac_f32_e32 v74, v128, v159
	v_fmac_f32_e32 v46, v135, v178
	v_dual_fmac_f32 v39, v124, v158 :: v_dual_fmac_f32 v72, v129, v175
	v_fmac_f32_e32 v44, v136, v161
	v_fmac_f32_e32 v42, v137, v179
	v_fmac_f32_e32 v59, v105, v152
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(3)
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v40, v138, v144 :: v_dual_lshlrev_b32 v103, 16, v103
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v3, v93, v76 offset0:64 offset1:96
	ds_store_2addr_b32 v20, v97, v96 offset1:32
	ds_store_2addr_b32 v20, v87, v75 offset0:64 offset1:96
	ds_store_2addr_b32 v21, v95, v94 offset1:32
	ds_store_2addr_b32 v21, v80, v74 offset0:64 offset1:96
	ds_store_2addr_b32 v22, v92, v91 offset1:32
	ds_store_2addr_b32 v22, v77, v72 offset0:64 offset1:96
	ds_store_2addr_b32 v23, v89, v88 offset1:32
	ds_store_2addr_b32 v23, v73, v70 offset0:64 offset1:96
	ds_store_2addr_b32 v24, v86, v85 offset1:32
	ds_store_2addr_b32 v24, v71, v68 offset0:64 offset1:96
	ds_store_2addr_b32 v25, v84, v83 offset1:32
	ds_store_2addr_b32 v25, v69, v66 offset0:64 offset1:96
	ds_store_2addr_b32 v26, v82, v81 offset1:32
	ds_store_2addr_b32 v26, v67, v63 offset0:64 offset1:96
	ds_store_2addr_b32 v27, v79, v78 offset1:32
	...
	ds_store_2addr_b32 v29, v62, v61 offset1:32
	ds_store_2addr_b32 v29, v47, v44 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v31, v43, v40 offset0:64 offset1:96
	ds_store_2addr_b32 v32, v56, v55 offset1:32
	ds_store_2addr_b32 v32, v41, v7 offset0:64 offset1:96
	ds_store_2addr_b32 v33, v54, v53 offset1:32
	ds_store_2addr_b32 v33, v39, v5 offset0:64 offset1:96
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_vgpr, 204
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.kd
