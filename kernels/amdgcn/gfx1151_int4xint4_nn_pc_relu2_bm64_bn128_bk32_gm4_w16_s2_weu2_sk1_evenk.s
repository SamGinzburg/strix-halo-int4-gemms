	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_cmp_lt_i32 s13, 34
	.loc	1 101 14                        ; generate_amdgcn.py:101:14
	v_and_b32_e32 v18, 14, v9
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_mad_u64_u32 v[1:2], null, s29, v28, v[18:19]
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
	v_lshrrev_b32_e32 v19, 1, v0
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add3_u32 v25, s2, s15, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 127 22 is_stmt 0              ; generate_amdgcn.py:127:22
	v_dual_cndmask_b32 v1, 0x80000000, v25 :: v_dual_lshlrev_b32 v20, 2, v0
	...
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_mad_u64_u32 v[2:3], null, s25, v29, v[17:18]
	v_add3_u32 v26, s12, s3, v2
	s_mov_b32 s12, 0
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_mov_b32_e32 v1, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_and_b32_e32 v13, 0x37e, v9
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_and_b32_e32 v21, 15, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v22, 0x108, v0
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	v_dual_mov_b32 v8, v1 :: v_dual_add_nc_u32 v23, 0, v23
	v_mov_b32_e32 v9, v1
	...
	s_waitcnt vmcnt(1)
	ds_store_b16 v23, v27 offset:2048
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(0)
...
; %bb.1:                                ; %.lr.ph
	...
	s_mov_b32 s19, s12
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_add_nc_u32_e32 v1, s26, v26
	.loc	1 131 22 is_stmt 0              ; generate_amdgcn.py:131:22
	s_mov_b32 s22, s6
	s_mov_b32 s23, s7
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	buffer_load_u16 v40, v25, s[4:7], 0 offen offset:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	buffer_load_b32 v41, v1, s[20:23], 0 offen
	v_add_nc_u32_e32 v1, 0, v21
	v_lshl_or_b32 v4, v21, 4, v22
	s_delay_alu instid0(VALU_DEP_2)
	v_add_nc_u32_e32 v25, v1, v20
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	ds_load_u8 v3, v25 offset:1664
	ds_load_u8 v4, v25 offset:1920
	ds_load_u8 v6, v25 offset:1792
	ds_load_u8 v42, v25 offset:1536
	ds_load_u8 v43, v25 offset:1152
	ds_load_u8 v44, v25 offset:1408
	ds_load_u8 v45, v25 offset:1280
	ds_load_u8 v46, v25 offset:1024
	v_mov_b32_e32 v16, s19
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[30:33], v26 offset0:4 offset1:5
	ds_load_2addr_stride64_b64 v[34:37], v27 offset0:4 offset1:5
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
...
.Ltmp15:
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_perm_b32 v42, v42, v3, 0xc0c0004
	v_perm_b32 v47, v6, v4, 0xc0c0004
	v_perm_b32 v43, v46, v43, 0xc0c0004
	v_perm_b32 v44, v45, v44, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[38:39], v[30:31], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v31, v47, 16, v42
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[1:8], v[30:31], v[34:35], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[30:31], v[36:37], v[9:16] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cbranch_scc1 .LBB0_4
; %bb.2:                                ; %.peel.next
	v_add3_u32 v29, s2, v29, 32
	v_add_nc_u32_e32 v28, s24, v28
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_lo_u32 v30, s25, v29
	v_mad_u64_u32 v[28:29], null, s29, v28, s[2:3]
	s_lshl_b32 s2, s28, 7
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_add3_u32 v29, v30, s2, v17
	s_lshl_b32 s2, s27, 7
	v_add3_u32 v17, v28, v18, 32
	v_subrev_nc_u32_e32 v18, s2, v29
	s_add_i32 s2, s12, -2
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	buffer_load_b32 v41, v18, s[20:23], 0 offen
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v36, v25 offset:640
	ds_load_u8 v37, v25 offset:896
	ds_load_u8 v38, v25 offset:768
	ds_load_u8 v39, v25 offset:512
	ds_load_u8 v42, v25 offset:128
	ds_load_u8 v43, v25 offset:384
	ds_load_u8 v44, v25 offset:256
	ds_load_u8 v45, v25
	ds_load_u8 v46, v25 offset:1664
	ds_load_u8 v47, v25 offset:1920
	ds_load_u8 v48, v25 offset:1792
	ds_load_u8 v49, v25 offset:1536
	ds_load_u8 v50, v25 offset:1152
	ds_load_u8 v51, v25 offset:1280
	ds_load_u8 v52, v25 offset:1024
	ds_load_u8 v53, v25 offset:1408
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[28:31], v26 offset0:4 offset1:5
	ds_load_2addr_stride64_b64 v[32:35], v27 offset0:4 offset1:5
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	v_perm_b32 v38, v45, v42, 0xc0c0004
	...
	v_perm_b32 v44, v52, v50, 0xc0c0004
	v_perm_b32 v45, v51, v53, 0xc0c0004
	v_lshl_or_b32 v36, v39, 16, v38
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v39, v43, 16, v42
	v_lshl_or_b32 v38, v45, 16, v44
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[36:37], v[28:29], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[36:37], v[30:31], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[38:39], v[32:33], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2)
...
; %bb.5:
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[17:18], v[24:25], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[30:31], v[26:27], v[1:8] neg_lo:[1,1,0]
...
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	v_dual_mul_f32 v1, v41, v1 :: v_dual_lshlrev_b32 v24, 16, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_dual_mul_f32 v22, v22, v29 :: v_dual_mul_f32 v3, v43, v3
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v2, v42, v2
	v_dual_mul_f32 v4, v44, v4 :: v_dual_max_f32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v16, v22, v16 :: v_dual_max_f32 v3, 0, v3
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v6, v46, v6 :: v_dual_mul_f32 v21, v21, v29
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v8, v21, v8 :: v_dual_mul_f32 v9, v18, v9
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v21, 1, v33
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v10, v23, v10 :: v_dual_mul_f32 v11, v24, v11
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v12, v25, v12 :: v_dual_and_b32 v21, 1, v30
	v_dual_mul_f32 v13, v26, v13 :: v_dual_max_f32 v10, 0, v10
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v14, v27, v14 :: v_dual_and_b32 v23, 1, v35
	v_dual_mul_f32 v15, v28, v15 :: v_dual_max_f32 v12, 0, v12
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	v_dual_max_f32 v13, 0, v13 :: v_dual_mul_f32 v10, v10, v10
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	...
	v_dual_cndmask_b32 v6, 0x3276, v32 :: v_dual_and_b32 v27, 1, v39
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 54
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_bm64_bn128_bk32_gm4_w16_s2_weu2_sk1_evenk.kd
