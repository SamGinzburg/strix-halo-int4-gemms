	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_rcp_iflag_f32_e32 v18, s6
	v_lshlrev_b32_e32 v3, 6, v3
	v_and_b32_e32 v5, 0x440, v7
.Ltmp14:
	.loc	1 213 14                        ; generate_amdgcn.py:213:14
	v_lshlrev_b32_e32 v16, 1, v2
	v_lshlrev_b32_e32 v2, 4, v2
	v_lshl_or_b32 v40, v6, 10, v4
	...
	v_and_or_b32 v2, 0x88, v12, v2
	v_or3_b32 v41, v0, v4, v3
	v_xor_b32_e32 v5, 8, v40
	s_mul_f32 s6, s6, 0x4f7ffffe
	v_xor_b32_e32 v9, v10, v11
	v_xor_b32_e32 v10, 8, v2
	v_xor_b32_e32 v6, 16, v40
	v_xor_b32_e32 v7, 24, v40
	v_xor_b32_e32 v0, 32, v40
	v_xor_b32_e32 v3, 40, v40
	v_xor_b32_e32 v4, 48, v40
	v_xor_b32_e32 v11, 56, v40
	v_xor_b32_e32 v12, 0x808, v41
	v_xor_b32_e32 v13, 0x1010, v41
	v_xor_b32_e32 v14, 0x1818, v41
	v_xor_b32_e32 v15, 0x2020, v41
	v_xor_b32_e32 v20, 0x2828, v41
	v_xor_b32_e32 v21, 0x3030, v41
	v_xor_b32_e32 v22, 0x3838, v41
	s_cvt_u32_f32 s6, s6
	s_and_b32 s13, s5, 0xffff
	s_and_b32 s5, s7, 0xffff
	s_sub_i32 s7, 0, s28
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mad_u64_u32 v[18:19], null, s21, v8, v[1:2]
	s_mul_i32 s7, s7, s6
	.loc	1 221 36                        ; generate_amdgcn.py:221:36
	...
	s_mul_i32 s35, s21, 12
	s_mul_i32 s36, s21, 14
	s_lshl_b32 s37, s21, 4
	s_mul_i32 s38, s21, 18
	s_mul_i32 s39, s21, 20
	s_mul_i32 s40, s21, 22
	s_mul_i32 s41, s21, 24
	s_mul_i32 s42, s21, 26
	s_mul_i32 s43, s21, 28
	s_mul_i32 s44, s21, 30
	s_bfe_i32 s46, s16, 0x1001d
	s_add_i32 s47, s6, s1
	s_mov_b32 s16, s8
	s_mov_b32 s17, s9
	s_mov_b32 s18, s14
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s7, s7, s46
	s_mul_i32 s48, s6, s28
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, 0
	s_sub_i32 s1, s1, s48
	s_add_i32 s48, s6, 1
	s_sub_i32 s49, s1, s28
	s_cmp_ge_u32 s1, s28
	...
	s_mul_hi_u32 s1, s49, s50
	s_abs_i32 s50, s51
	s_add_i32 s49, s49, s1
	s_xor_b32 s1, s51, s48
	s_mul_hi_u32 s49, s50, s49
	s_ashr_i32 s1, s1, 31
	s_mul_i32 s52, s49, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s50, s50, s52
	s_add_i32 s52, s49, 1
	s_sub_i32 s53, s50, s6
	s_cmp_ge_u32 s50, s6
	s_cselect_b32 s49, s52, s49
	s_cselect_b32 s50, s53, s50
	s_add_i32 s52, s49, 1
	s_cmp_ge_u32 s50, s6
	s_cselect_b32 s6, s52, s49
...
; %bb.3:                                ; %.lr.ph
	...
	v_lshl_or_b32 v1, s6, 7, v27
	s_lshl_b32 s1, s1, 7
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s48, v25
	s_mov_b32 s50, s3
	v_subrev_nc_u32_e32 v3, s1, v1
	s_mov_b32 s51, s45
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[19:20], null, s26, v2, v[16:17]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[20:21], null, s26, v3, v[17:18]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_nc_u32_e32 v21, s50, v17
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	v_add_nc_u32_e32 v23, s50, v20
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	v_add_nc_u32_e32 v22, s50, v19
	.loc	1 229 27                        ; generate_amdgcn.py:229:27
	v_cmp_lt_i32_e32 vcc_lo, s50, v37
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	s_mov_b32 s6, s14
	...
	s_cmp_lg_u32 s51, 0
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	v_cndmask_b32_e64 v21, 0x80000000, v23, s1
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	v_cndmask_b32_e32 v23, 0x80000000, v22, vcc_lo
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	...
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v65, v38, v21
	ds_bpermute_b32 v66, v38, v22
	ds_bpermute_b32 v67, v39, v21
	ds_bpermute_b32 v68, v39, v22
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	s_waitcnt vmcnt(0)
	ds_store_b16 v42, v23
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[21:24], v43 offset1:32
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[63:64], v[21:22], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[63:64], v[23:24], v[8:15] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v15, s1, v35
	v_or_b32_e32 v1, s1, v34
	v_or_b32_e32 v21, s1, v36
	...
	buffer_load_u16 v68, v21, s[8:11], 0 offen
	v_add3_u32 v0, s48, s1, v18
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add_co_u32 v21, vcc_lo, s22, v9
	...
	v_mul_f32_e32 v67, v1, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v79, v9, v65
	v_mul_f32_e32 v72, v1, v64
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v2, v79, v2
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mul_f32 v64, v72, v24 :: v_dual_mul_f32 v75, v9, v11
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v66, v1, v10
	v_mul_f32_e32 v10, v9, v10
	v_dual_mul_f32 v68, v1, v11 :: v_dual_mul_f32 v11, v67, v62
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v62, v71, v59 :: v_dual_add_nc_u32 v69, 0, v40
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v74, v9, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v10, v10, v19 :: v_dual_mul_f32 v1, v1, v65
	v_mul_f32_e32 v9, v66, v63
	v_dual_mul_f32 v13, v68, v61 :: v_dual_mul_f32 v14, v75, v7
	v_dual_mul_f32 v12, v74, v8 :: v_dual_mul_f32 v61, v76, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v1, v1, v20 :: v_dual_mul_f32 v24, v15, v3
...
.LBB0_7:                                ; %atomicrmw.start86
	...
	global_atomic_cmpswap_b32 v15, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
	v_cmp_eq_u32_e32 vcc_lo, v15, v24
...
.LBB0_11:                               ; %atomicrmw.start74
	...
	global_atomic_cmpswap_b32 v13, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
	v_cmp_eq_u32_e32 vcc_lo, v13, v24
...
.LBB0_13:                               ; %atomicrmw.start68
	...
	global_atomic_cmpswap_b32 v11, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_15:                               ; %atomicrmw.start62
	...
	global_atomic_cmpswap_b32 v9, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_17:                               ; %atomicrmw.start56
	...
	global_atomic_cmpswap_b32 v7, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
	v_cmp_eq_u32_e32 vcc_lo, v7, v24
...
.LBB0_19:                               ; %atomicrmw.start50
	...
	v_add_f32_e32 v23, v24, v3
	global_atomic_cmpswap_b32 v5, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_21:                               ; %atomicrmw.start44
	...
	global_atomic_cmpswap_b32 v3, v[21:22], v[23:24], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_27:                               ; %atomicrmw.start26
	...
	global_atomic_cmpswap_b32 v1, v[13:14], v[19:20], off glc
	s_waitcnt vmcnt(0)
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 80
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 54
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     56
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
