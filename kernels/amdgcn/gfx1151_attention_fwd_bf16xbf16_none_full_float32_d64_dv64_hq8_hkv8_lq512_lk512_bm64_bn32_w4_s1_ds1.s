...
.Ltmp0:
	...
	s_mov_b32 s36, s4
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v1, s3, v89
	.loc	1 787 26                        ; attention.py:787:26
	...
	v_cndmask_b32_e64 v9, 0x80000000, v4, s0
	v_cndmask_b32_e64 v10, 0x80000000, v1, s0
	s_clause 0x3
	buffer_load_b128 v[1:4], v2, s[36:39], 0 offen
	buffer_load_b128 v[5:8], v5, s[36:39], 0 offen
	buffer_load_b128 v[13:16], v9, s[36:39], 0 offen
	buffer_load_b128 v[33:36], v10, s[36:39], 0 offen
	...
	v_dual_mov_b32 v10, v25 :: v_dual_and_b32 v47, 48, v47
	...
	v_dual_mov_b32 v12, v25 :: v_dual_add_nc_u32 v95, 0, v42
	...
	v_dual_mov_b32 v23, v25 :: v_dual_and_b32 v38, 0x760076, v40
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v11, v25 :: v_dual_add_nc_u32 v98, 0, v43
	...
	s_waitcnt vmcnt(2)
	ds_store_b128 v95, v[5:8] offset:2048
	s_waitcnt vmcnt(1)
	...
	v_dual_mov_b32 v6, v25 :: v_dual_and_b32 v105, 0x5040504, v37
	v_lshl_or_b32 v37, v38, 4, v38
	v_dual_mov_b32 v3, v25 :: v_dual_add_nc_u32 v106, 0, v39
	v_mov_b32_e32 v15, v25
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v16, v25 :: v_dual_and_b32 v115, 0x7060706, v37
...
.Ltmp19:
	...
	.loc	1 895 23                        ; attention.py:895:23
	v_dual_mul_f32 v9, v9, v127 :: v_dual_add_f32 v122, v78, v80
...
.Ltmp21:
	...
	.loc	1 896 23                        ; attention.py:896:23
	s_waitcnt lgkmcnt(2)
	v_wmma_f32_16x16x16_bf16 v[1:8], v[128:135], v[73:80], v[1:8]
	.loc	1 890 30                        ; attention.py:890:30
...
.Ltmp23:
	.loc	1 818 13                        ; attention.py:818:13
	s_cmpk_lt_u32 s35, 0x1e0
	s_mov_b32 s35, s2
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp24:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_permlanex16_b32 v118, v117, s33, 0xfedcba98 op_sel:[1,0]
.Ltmp25:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp26:
	...
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[1:8], v[128:135], v[65:72], v[1:8]
	.loc	1 818 13                        ; attention.py:818:13
...
; %bb.2:
	...
	v_div_scale_f32 v50, null, v91, v91, v10
	...
	v_div_scale_f32 v43, null, v91, v91, v9
	...
	v_div_scale_f32 v52, null, v91, v91, v12
	s_mov_b32 vcc_lo, s2
	...
	v_div_scale_f32 v37, s4, v9, v91, v9
	v_fma_f32 v38, -v46, v40, v38
	v_div_scale_f32 v46, null, v91, v91, v11
	...
	v_div_scale_f32 v44, s2, v10, v91, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v49, s5, v11, v91, v11
	v_fmac_f32_e32 v54, v40, v54
	v_div_scale_f32 v40, s3, v12, v91, v12
	...
	v_div_scale_f32 v41, null, v91, v91, v13
	...
	s_mov_b32 vcc_lo, s2
	v_div_scale_f32 v44, null, v91, v91, v14
	...
	v_div_scale_f32 v45, s2, v13, v91, v13
	v_div_fmas_f32 v42, v42, v47, v48
	v_fma_f32 v47, -v52, v43, v40
	v_div_fixup_f32 v9, v37, v91, v9
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v37, v45, v38
	v_div_fixup_f32 v10, v39, v91, v10
	v_div_fixup_f32 v11, v42, v91, v11
	...
	v_div_scale_f32 v39, s4, v14, v91, v14
	v_rcp_f32_e32 v48, v42
	v_div_fmas_f32 v40, v40, v54, v43
	v_fmac_f32_e32 v37, v47, v38
	v_div_scale_f32 v47, null, v91, v91, v16
	v_mul_f32_e32 v43, v39, v46
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fixup_f32 v12, v40, v91, v12
	...
	v_div_scale_f32 v38, null, v91, v91, v1
	v_div_scale_f32 v40, s2, v15, v91, v15
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_div_scale_f32 v37, s3, v16, v91, v16
	...
	v_div_fixup_f32 v2, v41, v91, v2
	v_div_scale_f32 v41, null, v91, v91, v7
	.loc	1 1044 19                       ; attention.py:1044:19
	...
	.loc	1 1044 48                       ; attention.py:1044:48
	v_div_fixup_f32 v7, v38, v91, v7
	.loc	1 1046 24                       ; attention.py:1046:24
	v_add_lshl_u32 v38, v37, v35, 2
	.loc	1 1044 19                       ; attention.py:1044:19
	v_cndmask_b32_e64 v6, 0, v6, s1
	.loc	1 1044 48 is_stmt 0             ; attention.py:1044:48
	v_div_fixup_f32 v8, v40, v91, v8
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 144
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 44
