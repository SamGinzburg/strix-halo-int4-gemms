	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v1, s41, v165
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v2, s14, v87
	v_add_nc_u32_e32 v3, s14, v164
	v_add_nc_u32_e32 v4, s14, v166
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	s_add_i32 s15, s14, s35
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v5, s14, v88
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v6, s15, v164
	v_add_nc_u32_e32 v7, s15, v166
	v_add_nc_u32_e32 v8, s15, v88
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x7
	buffer_load_b128 v[4:7], v9, s[20:23], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v168, 0, v3
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v3, 16, v95
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v167, 0, v1
	s_waitcnt vmcnt(8)
	ds_store_b64 v167, v[36:37] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	ds_store_b128 v168, v[4:7]
	s_waitcnt vmcnt(6)
	ds_store_b128 v168, v[8:11] offset:4096
	s_waitcnt vmcnt(5)
	ds_store_b128 v168, v[12:15] offset:8192
	s_waitcnt vmcnt(4)
	ds_store_b128 v168, v[16:19] offset:12288
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(3)
	ds_store_b128 v168, v[20:23] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v168, v[24:27] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v168, v[28:31] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v168, v[32:35] offset:28672
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v1, 6, v95
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_3:                                ; %Flow654
	...
	v_or_b32_e32 v4, s34, v95
	v_or_b32_e32 v3, s34, v3
	s_ashr_i32 s1, s13, 8
	v_dual_mov_b32 v97, 0 :: v_dual_and_b32 v92, 0xf0, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_lo_u32 v161, v4, s1
	v_mul_lo_u32 v162, v3, s1
	v_or_b32_e32 v86, s42, v0
...
.Ltmp22:
	...
	s_lshr_b32 s0, s12, 6
	s_mov_b32 s12, 0
	v_and_or_b32 v2, v2, 48, v163
	v_dual_mov_b32 v105, 0 :: v_dual_and_b32 v6, 32, v93
	v_and_or_b32 v1, 0x70, v1, v95
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	...
	v_dual_mov_b32 v160, 0 :: v_dual_add_nc_u32 v171, 0, v2
	v_add_nc_u32_e32 v172, 0, v3
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v173, 0, v4
	v_add_nc_u32_e32 v174, 0, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	ds_store_b128 v168, v[13:16] offset:4096
	ds_store_b128 v168, v[17:20] offset:8192
	ds_store_b128 v168, v[21:24] offset:12288
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b64 v167, v[89:90] offset:32768
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b128 v168, v[25:28] offset:16384
	ds_store_b128 v168, v[29:32] offset:20480
	ds_store_b128 v168, v[33:36] offset:24576
	ds_store_b128 v168, v[37:40] offset:28672
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
...
.LBB0_6:
	...
	v_dual_mov_b32 v160, 0 :: v_dual_mov_b32 v163, v1
.LBB0_7:                                ; %._crit_edge
...
; %bb.8:
	...
	ds_load_u8 v82, v174 offset:640
	ds_load_u8 v83, v174 offset:384
	ds_load_u8 v84, v174 offset:128
	ds_load_u8 v163, v174 offset:7040
	ds_load_u8 v164, v174 offset:6784
	ds_load_u8 v165, v174 offset:6528
	ds_load_u8 v166, v174 offset:6272
	ds_load_u8 v167, v174 offset:6016
	ds_load_u8 v168, v174 offset:5760
	ds_load_u8 v169, v174 offset:5504
	ds_load_u8 v170, v174 offset:5248
	s_waitcnt lgkmcnt(38)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	ds_load_u8 v171, v174 offset:4992
	ds_load_u8 v172, v174 offset:4736
	ds_load_u8 v173, v174 offset:4480
	ds_load_u8 v175, v174 offset:4224
	...
	ds_load_u8 v204, v174 offset:15232
	ds_load_u8 v205, v174 offset:14976
	ds_load_u8 v206, v174 offset:14720
	ds_load_u8 v207, v174 offset:14464
	...
	ds_load_u8 v74, v174 offset:4352
	ds_load_u8 v75, v174 offset:4096
	ds_load_u8 v76, v174 offset:4864
	ds_load_u8 v77, v174 offset:4608
	ds_load_u8 v87, v174 offset:8064
	ds_load_u8 v88, v174 offset:7808
	ds_load_u8 v89, v174 offset:7552
	ds_load_u8 v90, v174 offset:7296
	...
	v_perm_b32 v60, v82, v65, 0xc0c0004
	...
	ds_load_u8 v176, v174 offset:11776
	v_perm_b32 v48, v75, v74, 0xc0c0004
	...
	ds_load_u8 v177, v174 offset:9216
	ds_load_u8 v178, v174 offset:9984
	ds_load_u8 v179, v174 offset:9728
	...
	v_perm_b32 v55, v176, v56, 0xc0c0004
	ds_load_u8 v56, v174 offset:8448
	ds_load_u8 v176, v174 offset:8192
	...
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v52, v177, v52, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v177, v179, v178, 0xc0c0004
	ds_load_u8 v178, v174 offset:15616
	ds_load_u8 v179, v174 offset:15360
	...
	v_lshl_or_b32 v46, v177, 16, v52
	s_delay_alu instid0(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[74:81], v[36:39], v[29:32], v[66:73] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v56, v176, v56, 0xc0c0004
	ds_load_u8 v176, v174 offset:16128
	ds_load_u8 v198, v174 offset:15872
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v184, v185, v184, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[74:81], v[41:44], v[25:28], v[74:81] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v52, v179, v178, 0xc0c0004
	ds_load_u8 v178, v174 offset:13568
	ds_load_u8 v179, v174 offset:13312
	...
	ds_load_u8 v177, v174 offset:14848
	...
	v_wmma_i32_16x16x16_iu8 v[74:81], v[45:48], v[21:24], v[74:81] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v176, v198, v176, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v208, v55, v54, 0xc0c0004
	ds_load_u8 v54, v174 offset:13056
	ds_load_u8 v55, v174 offset:12800
	ds_load_u8 v210, v174 offset:14208
	ds_load_u8 v211, v174 offset:13952
	ds_load_u8 v212, v174 offset:13696
	ds_load_u8 v213, v174 offset:13440
	ds_load_u8 v198, v174 offset:12544
	ds_load_u8 v203, v174 offset:12288
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v209, v177, v56, 0xc0c0004
	v_perm_b32 v201, v202, v201, 0xc0c0004
	ds_load_u8 v202, v174 offset:13184
	ds_load_u8 v214, v174 offset:12928
	ds_load_u8 v215, v174 offset:12672
	ds_load_u8 v216, v174 offset:12416
	v_lshl_or_b32 v56, v49, 16, v51
	v_perm_b32 v51, v166, v165, 0xc0c0004
	v_perm_b32 v49, v90, v89, 0xc0c0004
	v_lshl_or_b32 v52, v176, 16, v52
	v_perm_b32 v179, v179, v178, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v89, v82, 16, v51
	...
	v_perm_b32 v50, v88, v87, 0xc0c0004
	v_perm_b32 v87, v175, v173, 0xc0c0004
	v_lshl_or_b32 v54, v58, 16, v57
	v_lshl_or_b32 v53, v60, 16, v59
	v_lshl_or_b32 v88, v84, 16, v83
	v_perm_b32 v83, v193, v192, 0xc0c0004
	v_lshl_or_b32 v87, v163, 16, v87
	v_perm_b32 v84, v191, v190, 0xc0c0004
	v_perm_b32 v163, v197, v196, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v198, v203, v198, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[57:64], v[53:56], v[29:32], v[66:73] neg_lo:[1,1,0]
	v_lshl_or_b32 v90, v50, 16, v49
	v_perm_b32 v49, v183, v182, 0xc0c0004
	v_perm_b32 v50, v181, v180, 0xc0c0004
	v_lshl_or_b32 v177, v82, 16, v51
	v_lshl_or_b32 v176, v84, 16, v83
	v_lshl_or_b32 v175, v164, 16, v163
	v_perm_b32 v82, v200, v199, 0xc0c0004
	v_perm_b32 v83, v185, v184, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[163:170], v[36:39], v[17:20], v[66:73] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[66:73], v[53:56], v[17:20], v[66:73] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[57:64], v[87:90], v[25:28], v[57:64] neg_lo:[1,1,0]
	v_lshl_or_b32 v178, v50, 16, v49
	v_lshl_or_b32 v49, v65, 16, v198
	v_lshl_or_b32 v182, v83, 16, v82
	v_perm_b32 v65, v207, v206, 0xc0c0004
	v_perm_b32 v82, v205, v204, 0xc0c0004
	v_perm_b32 v83, v213, v212, 0xc0c0004
	v_perm_b32 v36, v211, v210, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v37, v216, v215, 0xc0c0004
	v_perm_b32 v38, v214, v202, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[163:170], v[41:44], v[13:16], v[163:170] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[66:73], v[87:90], v[13:16], v[66:73] neg_lo:[1,1,0]
	v_lshl_or_b32 v51, v209, 16, v208
	v_lshl_or_b32 v50, v201, 16, v179
	v_wmma_i32_16x16x16_iu8 v[57:64], v[175:178], v[21:24], v[57:64] neg_lo:[1,1,0]
	v_lshl_or_b32 v181, v82, 16, v65
	v_lshl_or_b32 v180, v36, 16, v83
	v_lshl_or_b32 v179, v38, 16, v37
	v_wmma_i32_16x16x16_iu8 v[163:170], v[45:48], v[1:4], v[163:170] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[66:73], v[175:178], v[1:4], v[66:73] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[74:81], v[49:52], v[9:12], v[74:81] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[57:64], v[179:182], v[9:12], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[163:170], v[49:52], v[5:8], v[163:170] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[66:73], v[179:182], v[5:8], v[66:73] neg_lo:[1,1,0]
	...
	v_cvt_f32_i32_e32 v60, v163
	v_cvt_f32_i32_e32 v62, v164
	v_cvt_f32_i32_e32 v64, v165
	v_cvt_f32_i32_e32 v65, v166
	v_cvt_f32_i32_e32 v45, v167
	v_cvt_f32_i32_e32 v46, v168
	v_cvt_f32_i32_e32 v48, v169
	v_cvt_f32_i32_e32 v50, v170
	v_cvt_f32_i32_e32 v63, v66
	v_cvt_f32_i32_e32 v36, v67
	v_cvt_f32_i32_e32 v37, v68
...
.LBB0_9:
	...
	v_dual_mov_b32 v89, 0 :: v_dual_mov_b32 v164, 0
...
; %bb.10:
	...
	ds_load_u8 v73, v174 offset:18432
	ds_load_u8 v74, v174 offset:19200
	ds_load_u8 v75, v174 offset:18944
	ds_load_u8 v76, v174 offset:17664
	ds_load_u8 v77, v174 offset:17408
	ds_load_u8 v78, v174 offset:18176
	ds_load_u8 v79, v174 offset:17920
	ds_load_u8 v81, v174 offset:20352
	ds_load_u8 v82, v174 offset:20096
	ds_load_u8 v83, v174 offset:19840
	ds_load_u8 v87, v174 offset:19584
	ds_load_u8 v80, v174 offset:16640
	ds_load_u8 v84, v174 offset:16384
	ds_load_u8 v88, v174 offset:17152
	ds_load_u8 v89, v174 offset:16896
	ds_load_u8 v90, v174 offset:19328
	ds_load_u8 v171, v174 offset:19072
	ds_load_u8 v172, v174 offset:18816
	ds_load_u8 v173, v174 offset:18560
	ds_load_u8 v183, v174 offset:18304
	ds_load_u8 v184, v174 offset:18048
	ds_load_u8 v185, v174 offset:17792
	ds_load_u8 v186, v174 offset:17536
	ds_load_u8 v194, v174 offset:23424
	ds_load_u8 v195, v174 offset:23168
	ds_load_u8 v196, v174 offset:22912
	ds_load_u8 v197, v174 offset:22656
	ds_load_u8 v198, v174 offset:22400
	ds_load_u8 v199, v174 offset:22144
	ds_load_u8 v200, v174 offset:21888
	ds_load_u8 v201, v174 offset:21632
	ds_load_u8 v202, v174 offset:21376
	ds_load_u8 v203, v174 offset:21120
	ds_load_u8 v204, v174 offset:20864
	ds_load_u8 v205, v174 offset:20608
	s_waitcnt lgkmcnt(38)
	...
	s_mov_b32 s19, s12
	s_waitcnt lgkmcnt(38)
	v_perm_b32 v42, v73, v44, 0xc0c0004
	s_mov_b32 s13, s12
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v44, v75, v74, 0xc0c0004
	v_lshl_or_b32 v43, v41, 16, v40
	s_waitcnt lgkmcnt(34)
	v_perm_b32 v73, v77, v76, 0xc0c0004
	s_waitcnt lgkmcnt(26)
	v_perm_b32 v40, v84, v80, 0xc0c0004
	v_perm_b32 v74, v79, v78, 0xc0c0004
	v_lshl_or_b32 v42, v44, 16, v42
	ds_load_u8 v44, v174 offset:17280
	ds_load_u8 v187, v174 offset:17024
	ds_load_u8 v188, v174 offset:16768
	ds_load_u8 v189, v174 offset:16512
	v_perm_b32 v81, v82, v81, 0xc0c0004
	v_perm_b32 v83, v87, v83, 0xc0c0004
	v_lshl_or_b32 v41, v74, 16, v73
	ds_load_u8 v74, v174 offset:23808
	ds_load_u8 v75, v174 offset:23552
	ds_load_u8 v76, v174 offset:24320
	ds_load_u8 v77, v174 offset:24064
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v73, v89, v88, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v82, v173, v172, 0xc0c0004
	v_perm_b32 v87, v171, v90, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v171, v186, v185, 0xc0c0004
	v_perm_b32 v172, v184, v183, 0xc0c0004
	v_lshl_or_b32 v40, v73, 16, v40
	ds_load_u8 v73, v174 offset:22784
	ds_load_u8 v78, v174 offset:22528
	ds_load_u8 v79, v174 offset:23296
	ds_load_u8 v80, v174 offset:23040
	ds_load_u8 v84, v174 offset:21760
	ds_load_u8 v88, v174 offset:21504
	ds_load_u8 v89, v174 offset:22272
	ds_load_u8 v163, v174 offset:22016
	ds_load_u8 v164, v174 offset:20736
	ds_load_u8 v165, v174 offset:20480
	ds_load_u8 v166, v174 offset:21248
	ds_load_u8 v167, v174 offset:20992
	ds_load_u8 v190, v174 offset:24448
	ds_load_u8 v191, v174 offset:24192
	ds_load_u8 v192, v174 offset:23936
	ds_load_u8 v193, v174 offset:23680
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
	...
	v_dual_mov_b32 v182, s19 :: v_dual_mov_b32 v181, s18
	s_waitcnt lgkmcnt(10)
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v79, v163, v89, 0xc0c0004
	ds_load_u8 v88, v174 offset:27904
	ds_load_u8 v89, v174 offset:27648
	ds_load_u8 v206, v174 offset:28416
	ds_load_u8 v207, v174 offset:28160
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v80, v165, v164, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v84, v167, v166, 0xc0c0004
	v_lshl_or_b32 v76, v75, 16, v74
	v_lshl_or_b32 v75, v77, 16, v73
	v_lshl_or_b32 v74, v79, 16, v78
	v_dual_mov_b32 v180, s17 :: v_dual_mov_b32 v179, s16
	v_lshl_or_b32 v73, v84, 16, v80
	ds_load_u8 v77, v174 offset:26880
	ds_load_u8 v78, v174 offset:26624
	ds_load_u8 v79, v174 offset:27392
	ds_load_u8 v80, v174 offset:27136
	ds_load_u8 v84, v174 offset:25856
	...
	v_dual_mov_b32 v178, s15 :: v_dual_mov_b32 v177, s14
	v_dual_mov_b32 v176, s13 :: v_dual_mov_b32 v175, s12
	v_lshl_or_b32 v90, v81, 16, v83
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v81, v191, v190, 0xc0c0004
	v_perm_b32 v83, v195, v194, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v88, v89, v88, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v77, v78, v77, 0xc0c0004
	v_perm_b32 v89, v207, v206, 0xc0c0004
	ds_load_u8 v206, v174 offset:24832
	...
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v84, v208, v84, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[163:170], v[40:43], v[29:32], v[175:182] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(12)
	...
	v_wmma_i32_16x16x16_iu8 v[163:170], v[73:76], v[25:28], v[163:170] neg_lo:[1,1,0]
	v_lshl_or_b32 v78, v208, 16, v84
	s_waitcnt lgkmcnt(12)
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v77, v215, 16, v206
	ds_load_u8 v88, v174 offset:30976
	ds_load_u8 v89, v174 offset:30720
	ds_load_u8 v206, v174 offset:31488
	...
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v84, v210, v209, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[163:170], v[77:80], v[21:24], v[163:170] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v207, v229, v207, 0xc0c0004
	ds_load_u8 v229, v174 offset:28928
	ds_load_u8 v234, v174 offset:28672
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v238, v89, v88, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v206, v208, v206, 0xc0c0004
	ds_load_u8 v88, v174 offset:29440
	ds_load_u8 v89, v174 offset:29184
	ds_load_u8 v208, v174 offset:30592
	ds_load_u8 v239, v174 offset:30336
	ds_load_u8 v240, v174 offset:30080
	ds_load_u8 v241, v174 offset:29824
	v_lshl_or_b32 v84, v207, 16, v84
	...
	ds_load_u8 v242, v174 offset:29056
	ds_load_u8 v243, v174 offset:28800
	v_perm_b32 v174, v203, v202, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v229, v234, v229, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v234, v89, v88, 0xc0c0004
	v_lshl_or_b32 v89, v87, 16, v82
	v_lshl_or_b32 v88, v172, 16, v171
	v_lshl_or_b32 v87, v44, 16, v173
	v_perm_b32 v44, v193, v192, 0xc0c0004
	v_perm_b32 v82, v197, v196, 0xc0c0004
	v_perm_b32 v171, v201, v200, 0xc0c0004
	v_perm_b32 v172, v199, v198, 0xc0c0004
	v_perm_b32 v173, v205, v204, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[183:190], v[87:90], v[29:32], v[175:182] neg_lo:[1,1,0]
	v_lshl_or_b32 v32, v81, 16, v44
	v_lshl_or_b32 v31, v83, 16, v82
	v_lshl_or_b32 v30, v172, 16, v171
	v_lshl_or_b32 v29, v174, 16, v173
	v_perm_b32 v44, v214, v213, 0xc0c0004
	v_perm_b32 v81, v212, v211, 0xc0c0004
	v_perm_b32 v82, v220, v219, 0xc0c0004
	v_perm_b32 v83, v218, v217, 0xc0c0004
	v_perm_b32 v171, v224, v223, 0xc0c0004
	v_perm_b32 v172, v222, v221, 0xc0c0004
	v_perm_b32 v192, v226, v225, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[183:190], v[29:32], v[25:28], v[183:190] neg_lo:[1,1,0]
	v_lshl_or_b32 v174, v81, 16, v44
	v_lshl_or_b32 v173, v83, 16, v82
	v_lshl_or_b32 v172, v172, 16, v171
	v_lshl_or_b32 v171, v192, 16, v191
	v_perm_b32 v25, v231, v230, 0xc0c0004
	v_perm_b32 v26, v216, v215, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v191, v237, v236, 0xc0c0004
	v_perm_b32 v192, v235, v207, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[183:190], v[171:174], v[21:24], v[183:190] neg_lo:[1,1,0]
	v_perm_b32 v193, v241, v240, 0xc0c0004
	v_lshl_or_b32 v44, v26, 16, v25
	v_wmma_i32_16x16x16_iu8 v[21:28], v[40:43], v[17:20], v[175:182] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[175:182], v[87:90], v[17:20], v[175:182] neg_lo:[1,1,0]
	v_perm_b32 v17, v239, v208, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v243, v242, 0xc0c0004
	v_perm_b32 v19, v233, v232, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[21:28], v[73:76], v[13:16], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[175:182], v[29:32], v[13:16], v[175:182] neg_lo:[1,1,0]
	v_lshl_or_b32 v83, v206, 16, v238
	v_lshl_or_b32 v82, v210, 16, v209
	v_lshl_or_b32 v81, v234, 16, v229
	v_lshl_or_b32 v43, v192, 16, v191
	v_lshl_or_b32 v42, v17, 16, v193
	v_lshl_or_b32 v41, v19, 16, v18
	v_wmma_i32_16x16x16_iu8 v[21:28], v[77:80], v[1:4], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[175:182], v[171:174], v[1:4], v[175:182] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[163:170], v[81:84], v[9:12], v[163:170] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[183:190], v[41:44], v[9:12], v[183:190] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[21:28], v[81:84], v[5:8], v[21:28] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_cvt_f32_i32_e32 v88, v166
	v_cvt_f32_i32_e32 v74, v167
	v_cvt_f32_i32_e32 v76, v168
	v_cvt_f32_i32_e32 v79, v169
	v_cvt_f32_i32_e32 v82, v170
	v_cvt_f32_i32_e32 v40, v183
	v_cvt_f32_i32_e32 v83, v184
	v_cvt_f32_i32_e32 v89, v185
	v_cvt_f32_i32_e32 v164, v186
	v_cvt_f32_i32_e32 v166, v187
	v_cvt_f32_i32_e32 v87, v188
	v_cvt_f32_i32_e32 v90, v189
	v_cvt_f32_i32_e32 v163, v190
...
.Ltmp25:
	...
	v_dual_mul_f32 v161, v6, v18 :: v_dual_mul_f32 v12, v12, v17
	...
	v_fma_f32 v57, v86, v53, v145
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v53, v155, v2, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_fma_f32 v26, v26, v69, v152
	v_fma_f32 v32, v32, v51, v146
	v_fma_f32 v58, v161, v54, v144
	v_fma_f32 v67, v12, v50, v133
	v_fma_f32 v68, v11, v48, v134
	v_fma_f32 v69, v10, v46, v135
	v_fma_f32 v70, v9, v45, v136
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v54, v156, v5, s2
	v_cndmask_b32_e64 v52, v154, v3, s2
	v_cndmask_b32_e64 v51, v153, v4, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v29, v29, v71, v149
	v_fma_f32 v28, v28, v72, v150
	v_fma_f32 v31, v31, v49, v147
	v_fma_f32 v30, v30, v47, v148
	v_fma_f32 v61, v175, v61, v141
	v_fma_f32 v63, v174, v59, v142
	v_fma_f32 v66, v14, v62, v139
	v_fma_f32 v13, v13, v60, v140
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v49, v151, v27, s2
	v_cndmask_b32_e64 v48, v150, v28, s2
	v_cndmask_b32_e64 v46, v149, v29, s2
	v_cndmask_b32_e64 v47, v148, v30, s2
	v_cndmask_b32_e64 v45, v147, v31, s2
	v_cndmask_b32_e64 v31, v145, v57, s2
	v_cndmask_b32_e64 v30, v144, v58, s2
	v_cndmask_b32_e64 v28, v142, v63, s2
	v_cndmask_b32_e64 v27, v141, v61, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v64, v15, v64, v137
	v_fma_f32 v65, v16, v65, v138
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v16, v157, v25, s2
	v_cndmask_b32_e64 v14, v140, v13, s2
	v_cndmask_b32_e64 v13, v136, v70, s2
	v_cndmask_b32_e64 v25, v137, v64, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v23, v23, v55, v159
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v55, v160, v22, s2
	v_cndmask_b32_e64 v50, v152, v26, s2
	v_cndmask_b32_e64 v26, v139, v66, s2
	v_cndmask_b32_e64 v15, v158, v24, s2
	v_cndmask_b32_e64 v22, v159, v23, s2
	v_cndmask_b32_e64 v23, v134, v68, s2
	v_cndmask_b32_e64 v24, v133, v67, s2
	v_cndmask_b32_e64 v32, v146, v32, s2
	.loc	1 426 31                        ; generate_amdgcn.py:426:31
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v2, 16, v21
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v21, v135, v69, s2
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	ds_store_b32 v20, v2 offset:34816
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v162, v7, v18
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	ds_load_b128 v[60:63], v19 offset:34832
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v20, v138, v65, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v56, v162, v56, v143
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v29, v143, v56, s2
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	...
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v3, v3, v17 :: v_dual_mul_f32 v72, v61, v18
	v_mul_f32_e32 v61, v61, v17
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v19, v19, v40, v105
	v_fma_f32 v40, v64, v87, v131
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v3, v3, v171, v123
	v_fma_f32 v76, v72, v76, v122
	v_fma_f32 v75, v61, v75, v108
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v87, v105, v19, s2
	v_cndmask_b32_e64 v40, v131, v40, s2
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v58, v58, v169, v110
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v19, v110, v58, s2
	v_cndmask_b32_e64 v58, v108, v75, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v75, 0xbfb8aa3b, v87 :: v_dual_mul_f32 v66, v5, v18
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_mul_f32_e32 v5, v5, v17
	v_mul_f32_e32 v68, v57, v18
	v_mul_f32_e32 v86, v62, v18
	v_mul_f32_e32 v69, v59, v18
	v_mul_f32_e32 v71, v60, v18
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v5, v5, v173, v119
	v_fma_f32 v68, v68, v80, v130
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_mul_f32_e32 v134, v10, v18
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v79, v86, v79, v120
	v_fma_f32 v69, v69, v88, v128
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v3, v119, v5, s2
	v_cndmask_b32_e64 v5, v130, v68, s2
	v_cndmask_b32_e64 v68, v122, v76, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v76, 0xbfb8aa3b, v40 :: v_dual_mul_f32 v65, v4, v18
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_mul_f32_e32 v62, v62, v17
	v_mul_f32_e32 v9, v9, v17
	v_mul_f32_e32 v4, v4, v17
	v_dual_mul_f32 v67, v56, v18 :: v_dual_mul_f32 v10, v10, v17
	v_dual_mul_f32 v135, v11, v18 :: v_dual_mul_f32 v60, v60, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v9, v9, v168, v125
	v_fma_f32 v4, v4, v172, v121
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v67, v67, v77, v132
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_dual_mul_f32 v133, v63, v18 :: v_dual_mul_f32 v56, v56, v17
	v_mul_f32_e32 v57, v57, v17
	v_mul_f32_e32 v59, v59, v17
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v64, v65, v90, v129
	v_fma_f32 v65, v66, v163, v127
	v_fma_f32 v80, v71, v74, v124
	v_fma_f32 v86, v60, v73, v109
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v73, v125, v9, s2
	v_cndmask_b32_e64 v9, v121, v4, s2
	v_cndmask_b32_e64 v4, v132, v67, s2
	v_cndmask_b32_e64 v67, v120, v79, s2
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_dual_mul_f32 v136, v12, v18 :: v_dual_mul_f32 v63, v63, v17
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v77, v133, v82, v118
	v_fma_f32 v57, v57, v167, v112
	v_fma_f32 v78, v62, v78, v107
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v74, v127, v65, s2
	v_cndmask_b32_e64 v71, v128, v69, s2
	v_cndmask_b32_e64 v69, v124, v80, s2
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_dual_mul_f32 v18, v2, v18 :: v_dual_mul_f32 v105, 0xbfb8aa3b, v67
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v82, v136, v164, v115
	v_fma_f32 v59, v59, v170, v111
	v_fma_f32 v81, v63, v81, v106
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v60, v112, v57, s2
	v_cndmask_b32_e64 v57, v107, v78, s2
	v_cndmask_b32_e64 v63, v115, v82, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v78, 0xbfb8aa3b, v74 :: v_dual_mul_f32 v107, 0xbfb8aa3b, v69
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v18, v18, v166, v114
	v_fma_f32 v66, v70, v84, v126
	v_fma_f32 v84, v135, v89, v116
	v_fma_f32 v56, v56, v165, v113
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_mul_f32_e32 v89, 0xbfb8aa3b, v4
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v83, v134, v83, v117
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v88, v129, v64, s2
	v_cndmask_b32_e64 v62, v114, v18, s2
	v_cndmask_b32_e64 v18, v111, v59, s2
	v_cndmask_b32_e64 v59, v109, v86, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_mul_f32_e32 v109, 0xbfb8aa3b, v63
	v_cmp_gt_f32_e64 s3, 0xc2fc0000, v78
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v70, v126, v66, s2
	v_cndmask_b32_e64 v66, v118, v77, s2
	v_cndmask_b32_e64 v65, v117, v83, s2
	v_cndmask_b32_e64 v61, v113, v56, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v82, 0xbfb8aa3b, v3 :: v_dual_mul_f32 v77, 0xbfb8aa3b, v88
	v_cmp_gt_f32_e64 s0, 0xc2fc0000, v76
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v56, v106, v81, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_mul_f32_e32 v79, 0xbfb8aa3b, v73
	...
	v_mul_f32_e32 v80, 0xbfb8aa3b, v72
	v_dual_mul_f32 v106, 0xbfb8aa3b, v68 :: v_dual_mul_f32 v117, 0xbfb8aa3b, v57
	v_dual_mul_f32 v90, 0xbfb8aa3b, v66 :: v_dual_mul_f32 v115, 0xbfb8aa3b, v61
	v_mul_f32_e32 v111, 0xbfb8aa3b, v65
	v_cmp_gt_f32_e64 s7, 0xc2fc0000, v82
	v_cndmask_b32_e64 v76, 0, 0x42800000, s0
	v_cmp_gt_f32_e64 s1, 0xc2fc0000, v77
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v64, v116, v84, s2
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	v_dual_mul_f32 v83, 0xbfb8aa3b, v70 :: v_dual_mul_f32 v86, 0xbfb8aa3b, v5
	v_mul_f32_e32 v119, 0xbfb8aa3b, v59
	...
	v_dual_fmac_f32 v76, 0xbfb8aa3b, v40 :: v_dual_fmac_f32 v107, 0xbfb8aa3b, v69
	v_dual_mul_f32 v108, 0xbfb8aa3b, v62 :: v_dual_fmac_f32 v75, 0xbfb8aa3b, v87
	v_cndmask_b32_e64 v79, 0, 0x42800000, s4
	v_mul_f32_e32 v110, 0xbfb8aa3b, v64
	v_cndmask_b32_e64 v81, 0, 0x42800000, s6
	v_fmac_f32_e32 v105, 0xbfb8aa3b, v67
	v_exp_f32_e32 v78, v78
	v_cmp_gt_f32_e64 s11, 0xc2fc0000, v83
	v_cmp_gt_f32_e64 s15, 0xc2fc0000, v90
	v_dual_mul_f32 v84, 0xbfb8aa3b, v71 :: v_dual_mul_f32 v113, 0xbfb8aa3b, v18
	v_cndmask_b32_e64 v80, 0, 0x42800000, s5
	v_cmp_gt_f32_e64 s9, 0xc2fc0000, v86
	...
	v_dual_mul_f32 v112, 0xbfb8aa3b, v19 :: v_dual_fmac_f32 v77, 0xbfb8aa3b, v88
	v_exp_f32_e32 v76, v76
	v_dual_mul_f32 v114, 0xbfb8aa3b, v60 :: v_dual_fmac_f32 v81, 0xbfb8aa3b, v9
	v_cndmask_b32_e64 v123, 0, 0xffffffc0, s3
	v_fmac_f32_e32 v79, 0xbfb8aa3b, v73
	...
	v_cndmask_b32_e64 v86, 0, 0x42800000, s9
	v_cmp_gt_f32_e64 s10, 0xc2fc0000, v84
	v_cndmask_b32_e64 v109, 0, 0x42800000, s18
	v_cndmask_b32_e64 v119, 0, 0x42800000, s24
	v_dual_fmac_f32 v80, 0xbfb8aa3b, v72 :: v_dual_fmac_f32 v111, 0xbfb8aa3b, v65
	v_fmac_f32_e32 v106, 0xbfb8aa3b, v68
	v_cmp_gt_f32_e64 s8, 0xc2fc0000, v89
	v_fmac_f32_e32 v115, 0xbfb8aa3b, v61
	...
	v_dual_mul_f32 v116, 0xbfb8aa3b, v56 :: v_dual_fmac_f32 v83, 0xbfb8aa3b, v70
	v_cmp_gt_f32_e64 s22, 0xc2fc0000, v113
	v_cndmask_b32_e64 v117, 0, 0x42800000, s26
	v_fmac_f32_e32 v90, 0xbfb8aa3b, v66
	v_cndmask_b32_e64 v84, 0, 0x42800000, s10
	v_dual_fmac_f32 v86, 0xbfb8aa3b, v5 :: v_dual_fmac_f32 v109, 0xbfb8aa3b, v63
	...
	v_ldexp_f32 v82, v82, v127
	v_ldexp_f32 v77, v77, v122
	v_fmac_f32_e32 v108, 0xbfb8aa3b, v62
	...
	v_div_scale_f32 v126, null, v78, v78, v74
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	.loc	1 441 34                        ; generate_amdgcn.py:441:34
	v_dual_add_f32 v82, 1.0, v82 :: v_dual_add_f32 v77, 1.0, v77
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_exp_f32_e32 v108, v108
	.loc	1 441 34                        ; generate_amdgcn.py:441:34
	v_add_f32_e32 v105, 1.0, v105
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v122, null, v76, v76, v40
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	v_ldexp_f32 v83, v83, v131
	v_ldexp_f32 v90, v90, v135
	v_cndmask_b32_e64 v130, 0, 0xffffffc0, s10
	v_dual_fmac_f32 v112, 0xbfb8aa3b, v19 :: v_dual_add_f32 v81, 1.0, v81
	...
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v120, null, v75, v75, v87
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v134, null, v82, v82, v3
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v130, null, v80, v80, v72
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_fmac_f32 v116, 0xbfb8aa3b, v56 :: v_dual_add_f32 v89, 1.0, v89
	.loc	1 441 34                        ; generate_amdgcn.py:441:34
	v_dual_add_f32 v86, 1.0, v86 :: v_dual_add_f32 v115, 1.0, v115
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v128, null, v79, v79, v73
	...
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v142, null, v83, v83, v70
	...
	v_div_scale_f32 v132, null, v81, v81, v9
	...
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_scale_f32 v138, null, v86, v86, v5
	...
	.loc	1 441 34                        ; generate_amdgcn.py:441:34
	v_dual_add_f32 v84, 1.0, v84 :: v_dual_add_f32 v113, 1.0, v113
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	...
	v_div_scale_f32 v121, vcc_lo, v87, v75, v87
	v_div_scale_f32 v140, null, v84, v84, v71
	...
	v_div_scale_f32 v123, s26, v40, v76, v40
	v_div_scale_f32 v172, null, v117, v117, v57
	...
	v_div_scale_f32 v125, s27, v88, v77, v88
	...
	v_div_scale_f32 v127, s25, v74, v78, v74
	v_rcp_f32_e32 v197, v162
	v_fma_f32 v222, -v156, v194, 1.0
	v_rcp_f32_e32 v202, v172
	v_fma_f32 v210, -v132, v182, 1.0
	v_dual_fmac_f32 v192, v220, v192 :: v_dual_mul_f32 v205, v123, v177
	v_div_scale_f32 v129, s24, v73, v79, v73
	...
	v_div_scale_f32 v131, s23, v72, v80, v72
	...
	v_div_scale_f32 v143, s17, v70, v83, v70
	v_div_scale_f32 v159, s9, v62, v108, v62
	v_fma_f32 v230, -v172, v202, 1.0
	v_dual_fmac_f32 v195, v223, v195 :: v_dual_mul_f32 v210, v133, v182
	v_rcp_f32_e32 v203, v174
	v_dual_fmac_f32 v200, v228, v200 :: v_dual_mul_f32 v213, v139, v185
	v_mul_f32_e32 v221, v155, v193
	v_fma_f32 v236, -v128, v208, v129
	v_fma_f32 v216, -v144, v188, 1.0
	v_dual_fmac_f32 v198, v226, v198 :: v_dual_mul_f32 v211, v135, v183
	v_fma_f32 v237, -v130, v209, v131
	v_fmac_f32_e32 v206, v234, v178
	v_div_scale_f32 v141, s18, v71, v84, v71
	...
	v_dual_mul_f32 v220, v153, v192 :: v_dual_fmac_f32 v207, v235, v179
	v_dual_fmac_f32 v202, v230, v202 :: v_dual_mul_f32 v215, v143, v187
	v_mul_f32_e32 v223, v159, v195
	...
	v_div_scale_f32 v167, s5, v19, v112, v19
	v_dual_fmac_f32 v199, v227, v199 :: v_dual_mul_f32 v214, v141, v186
	v_div_fmas_f32 v120, v120, v176, v204
	s_mov_b32 vcc_lo, s26
	v_mul_f32_e32 v225, v163, v197
	...
	v_dual_fmac_f32 v190, v218, v190 :: v_dual_fmac_f32 v213, v241, v185
	...
	v_dual_mul_f32 v222, v157, v194 :: v_dual_fmac_f32 v211, v239, v183
	v_div_fmas_f32 v122, v122, v178, v206
	s_mov_b32 vcc_lo, s25
	v_div_scale_f32 v165, s6, v18, v113, v18
	v_mul_f32_e32 v227, v167, v199
	v_fma_f32 v232, -v140, v214, v141
	v_fma_f32 v125, -v130, v209, v131
	v_fma_f32 v237, -v150, v219, v151
	v_fmac_f32_e32 v212, v240, v184
	v_div_fixup_f32 v75, v120, v75, v87
	v_div_fmas_f32 v87, v123, v179, v207
	s_mov_b32 vcc_lo, s24
	v_fmac_f32_e32 v215, v233, v187
	v_fma_f32 v126, -v132, v210, v133
	v_div_scale_f32 v175, s0, v56, v116, v56
	v_dual_fmac_f32 v203, v231, v203 :: v_dual_mul_f32 v218, v149, v190
	...
	v_div_fixup_f32 v77, v122, v77, v88
	v_div_fmas_f32 v88, v125, v181, v209
	...
	v_div_fixup_f32 v76, v121, v76, v40
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v40, v55, v75
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fixup_f32 v55, v87, v78, v74
	v_div_fmas_f32 v74, v126, v182, v210
	...
	v_div_fixup_f32 v73, v120, v79, v73
	v_fma_f32 v233, -v162, v225, v163
	v_fmac_f32_e32 v216, v234, v188
	v_div_fmas_f32 v75, v127, v183, v211
	...
	v_div_fixup_f32 v72, v88, v80, v72
	v_dual_mul_f32 v224, v161, v196 :: v_dual_fmac_f32 v217, v235, v189
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	v_div_fixup_f32 v74, v74, v81, v9
	v_fma_f32 v237, -v170, v229, v171
	v_fmac_f32_e32 v218, v236, v190
	v_dual_fmac_f32 v222, v240, v194 :: v_dual_mul_f32 v9, v54, v73
	v_div_fmas_f32 v54, v129, v185, v213
	s_mov_b32 vcc_lo, s18
	v_fmac_f32_e32 v225, v233, v197
	v_fma_f32 v132, -v144, v216, v145
	v_fmac_f32_e32 v226, v234, v198
	v_div_fixup_f32 v73, v75, v82, v3
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	v_div_fixup_f32 v55, v55, v89, v4
	v_fmac_f32_e32 v220, v238, v192
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v4, v52, v74
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	...
	v_div_fixup_f32 v54, v54, v86, v5
	v_div_fmas_f32 v72, v132, v188, v216
	s_mov_b32 vcc_lo, s15
	v_div_scale_f32 v173, s1, v57, v117, v57
	v_fma_f32 v135, -v150, v219, v151
	v_div_fixup_f32 v53, v53, v84, v71
	v_fma_f32 v235, -v166, v227, v167
	v_mul_f32_e32 v228, v169, v200
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_dual_mul_f32 v50, v50, v55 :: v_dual_mul_f32 v11, v11, v17
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fmas_f32 v55, v133, v189, v217
	s_mov_b32 vcc_lo, s14
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v5, v51, v73
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_fma_f32 v136, -v152, v220, v153
	v_div_fixup_f32 v52, v52, v83, v70
	v_dual_fmac_f32 v224, v232, v196 :: v_dual_mul_f32 v51, v49, v54
	v_div_fmas_f32 v54, v134, v190, v218
	s_mov_b32 vcc_lo, s13
	v_fma_f32 v137, -v154, v221, v155
	v_div_fixup_f32 v69, v72, v107, v69
	v_dual_mul_f32 v230, v173, v202 :: v_dual_mul_f32 v15, v15, v77
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v48, v48, v53
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fmas_f32 v53, v135, v191, v219
	s_mov_b32 vcc_lo, s12
	v_fmac_f32_e32 v227, v235, v199
	v_fma_f32 v236, -v168, v228, v169
	v_fma_f32 v138, -v156, v222, v157
	v_div_fixup_f32 v55, v55, v106, v68
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	v_div_fixup_f32 v54, v54, v105, v67
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	v_div_fixup_f32 v53, v53, v90, v66
	v_dual_fmac_f32 v228, v236, v200 :: v_dual_mul_f32 v45, v45, v55
	v_div_fmas_f32 v55, v138, v194, v222
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v141, -v162, v225, v163
	v_div_fixup_f32 v52, v52, v111, v65
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v32, v32, v54
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fmas_f32 v54, v139, v195, v223
	s_mov_b32 vcc_lo, s8
	v_dual_fmac_f32 v230, v238, v202 :: v_dual_mul_f32 v31, v31, v53
	v_div_fmas_f32 v53, v140, v196, v224
	s_mov_b32 vcc_lo, s7
	v_fma_f32 v142, -v164, v226, v165
	v_div_fixup_f32 v47, v47, v110, v64
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_dual_mul_f32 v22, v22, v76 :: v_dual_mul_f32 v29, v29, v47
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fmas_f32 v47, v142, v198, v226
	v_div_fixup_f32 v52, v52, v114, v60
	v_fma_f32 v143, -v166, v227, v167
	v_div_fixup_f32 v55, v55, v109, v63
	.loc	1 431 17 is_stmt 1              ; generate_amdgcn.py:431:17
	v_fma_f32 v11, v11, v43, v103
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fixup_f32 v47, v47, v113, v18
	.loc	1 441 15 is_stmt 0              ; generate_amdgcn.py:441:15
	v_dual_mul_f32 v18, v26, v52 :: v_dual_mul_f32 v7, v7, v17
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_fma_f32 v52, -v174, v231, v175
	s_mov_b32 vcc_lo, s5
	v_div_fixup_f32 v53, v53, v115, v61
	v_fma_f32 v144, -v168, v228, v169
	v_div_fixup_f32 v54, v54, v108, v62
	v_fmac_f32_e32 v231, v52, v203
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v52, v103, v11, s2
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	s_mov_b32 vcc_lo, s4
	.loc	1 431 17 is_stmt 1              ; generate_amdgcn.py:431:17
	v_fma_f32 v10, v10, v44, v104
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	v_mul_f32_e32 v27, v27, v54
	.loc	1 441 22 is_stmt 0              ; generate_amdgcn.py:441:22
	v_div_fixup_f32 v55, v55, v112, v19
	.loc	1 441 15                        ; generate_amdgcn.py:441:15
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v47, v104, v10, s2
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	...
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fma_f32 v11, v12, v42, v102
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_mul_f32_e32 v43, 0xbfb8aa3b, v47
	.loc	1 441 22 is_stmt 0              ; generate_amdgcn.py:441:22
	v_div_fmas_f32 v10, v10, v203, v231
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_dual_mul_f32 v42, 0xbfb8aa3b, v52 :: v_dual_mul_f32 v1, v1, v17
	.loc	1 431 17 is_stmt 1              ; generate_amdgcn.py:431:17
	v_fma_f32 v2, v2, v41, v101
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	v_cmp_gt_f32_e32 vcc_lo, 0xc2fc0000, v43
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v43, v102, v11, s2
	.loc	1 441 22                        ; generate_amdgcn.py:441:22
	v_div_fixup_f32 v10, v10, v116, v56
	...
	.loc	1 441 22 is_stmt 0              ; generate_amdgcn.py:441:22
	v_div_fixup_f32 v44, v44, v117, v57
	.loc	1 441 40                        ; generate_amdgcn.py:441:40
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v63, v60, v58 :: v_dual_add_f32 v24, 1.0, v24
...
.Ltmp50:
	...
	v_dual_fmac_f32 v39, v53, v39 :: v_dual_fmac_f32 v42, v54, v42
	v_div_scale_f32 v54, s1, v49, v38, v49
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fma_f32 v50, -v55, v36, 1.0
	v_mul_f32_e32 v26, v54, v42
	...
	v_dual_mul_f32 v42, v49, v46 :: v_dual_fmac_f32 v43, v52, v43
...
.Ltmp52:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.num_vgpr, 246
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Ldebug_info_start0:
	...
	.long	.Ltmp50-.Ltmp26                 ; DW_AT_high_pc
	.byte	1                               ; DW_AT_call_file
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_swiglu_outint4sc256_bm32_bn256_bk64_gm4_w8_s2_weu2_sk1_evenk.kd
