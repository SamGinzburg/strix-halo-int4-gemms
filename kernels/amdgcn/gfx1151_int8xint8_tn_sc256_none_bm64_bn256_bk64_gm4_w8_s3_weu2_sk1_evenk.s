	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_add3_u32 v89, v2, v1, s34
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmp_gt_i32 s13, 63
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	s_mul_i32 s15, s22, s26
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_mul_i32 s2, s23, s26
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s3, -1, 0
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_lshl_b32 s45, s23, 4
	s_lshl_b32 s44, s23, 5
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	...
	buffer_load_b128 v[37:40], v2, s[28:31], 0 offen
	buffer_load_b128 v[41:44], v3, s[28:31], 0 offen
...
.LBB0_3:                                ; %Flow94
	...
	v_or_b32_e32 v5, s34, v117
	v_or_b32_e32 v2, s34, v2
	v_or_b32_e32 v3, s34, v3
	v_or_b32_e32 v4, s34, v4
	v_and_b32_e32 v255, 0xf0, v0
	s_ashr_i32 s0, s14, 8
	v_or_b32_e32 v154, s35, v0
	v_mul_lo_u32 v155, v5, s0
	v_mul_lo_u32 v241, v2, s0
	v_mul_lo_u32 v242, v3, s0
	v_mul_lo_u32 v153, v4, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 372 30 is_stmt 0              ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[9:10], null, s1, s22, v[89:90]
	...
	v_cndmask_b32_e32 v77, 0x80000000, v77, vcc_lo
	s_clause 0x3
	buffer_load_u16 v102, v77, s[36:39], 0 offen
	buffer_load_u16 v115, v78, s[36:39], 0 offen
	buffer_load_u16 v116, v79, s[36:39], 0 offen
	buffer_load_u16 v140, v80, s[36:39], 0 offen
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
...
.LBB0_12:
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v82, v241, s1, 1
	v_add_lshl_u32 v83, v242, s1, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s2, s0
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v84, v153, s1, 1
	...
	v_mul_f32_e32 v151, v67, v64
	v_mul_f32_e32 v152, v66, v64
	v_mul_f32_e32 v153, v65, v64
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_mov_b16_e64 v64.h, v249.l
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v154, v80, v64 :: v_dual_lshlrev_b32 v83, 16, v83
	v_mul_f32_e32 v172, v78, v64
	...
	v_fma_f32 v72, v72, v193, v125
	v_fma_f32 v158, v64, v202, v118
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_waitcnt vmcnt(0)
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	ds_store_b32 v248, v64 offset:40960
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_cndmask_b32_e64 v125, v125, v72, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	ds_load_b128 v[72:75], v252 offset:41472
	ds_load_b128 v[76:79], v252 offset:41488
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_fma_f32 v65, v80, v201, v133
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v150, v150, v154, s3
	v_cndmask_b32_e64 v149, v149, v155, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v80, v71, v192, v124
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v148, v148, v156, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v140, v70, v140, v123
	v_fma_f32 v154, v69, v191, v122
	v_fma_f32 v155, v68, v190, v121
	v_fma_f32 v156, v67, v254, v120
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v81, v133, v65, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	ds_load_b128 v[68:71], v252 offset:40976
	s_waitcnt lgkmcnt(2)
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v157, v66, v188, v119
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	ds_load_b128 v[64:67], v252 offset:40960
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_cndmask_b32_e64 v80, v124, v80, s3
	v_cndmask_b32_e64 v123, v123, v140, s3
	v_cndmask_b32_e64 v113, v162, v113, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v162, v178, v210, v142
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v122, v122, v154, s3
	v_cndmask_b32_e64 v121, v121, v155, s3
	v_cndmask_b32_e64 v120, v120, v156, s3
	v_cndmask_b32_e64 v119, v119, v157, s3
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v118, v118, v158, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v124, v64, v85
	v_mul_f32_e32 v133, v65, v85
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v193, v76, v83 :: v_dual_lshlrev_b32 v84, 16, v84
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_dual_mul_f32 v82, v79, v82 :: v_dual_mul_f32 v181, v64, v83
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v84, v124, v107, v118
	v_fma_f32 v9, v133, v9, v119
	v_fma_f32 v10, v140, v10, v120
	v_fma_f32 v57, v65, v57, v101
	v_fma_f32 v11, v154, v11, v121
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v65, v118, v84, s2
	v_cndmask_b32_e64 v9, v119, v9, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v12, v155, v12, v122
	v_fma_f32 v13, v156, v13, v123
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v16, v159, v16, v126
	v_fma_f32 v17, v160, v17, v127
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v18, v161, v18, v128
	v_fma_f32 v19, v162, v19, v129
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v20, v163, v20, v130
	v_fma_f32 v21, v164, v21, v131
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v24, v166, v24, v134
	v_fma_f32 v25, v167, v25, v135
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v26, v168, v26, v136
	v_fma_f32 v27, v169, v27, v137
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v28, v170, v28, v138
	v_fma_f32 v29, v171, v29, v139
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v34, v176, v34, v145
	v_fma_f32 v35, v177, v35, v146
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v36, v178, v36, v147
	v_fma_f32 v37, v179, v37, v148
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v38, v180, v38, v149
	v_fma_f32 v39, v82, v39, v150
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_fma_f32 v64, v77, v6, v89
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v68, v92, v3, s2
	v_cndmask_b32_e64 v69, v91, v4, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v70, v90, v5, s2
	v_cndmask_b32_e64 v64, v89, v64, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_cndmask_b32 v13, v15, v12 :: v_dual_cndmask_b32 v40, v0, v38
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 44
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 44
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
