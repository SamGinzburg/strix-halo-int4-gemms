...
.Ltmp0:
	...
	s_abs_i32 s6, s2
	v_dual_mov_b32 v49, 0 :: v_dual_and_b32 v2, 7, v0
	.loc	1 98 32                         ; generate_amdgcn.py:98:32
	v_lshrrev_b32_e32 v3, 3, v0
	s_load_b64 s[40:41], s[0:1], 0x20
	v_dual_mov_b32 v58, 0 :: v_dual_and_b32 v45, 0x100, v0
	v_dual_mov_b32 v60, 0 :: v_dual_and_b32 v47, 0xe0, v0
...
.Ltmp11:
	...
	s_abs_i32 s4, s13
	v_dual_mov_b32 v62, 0 :: v_dual_add_nc_u32 v69, v68, v12
	s_cvt_f32_u32 s5, s4
	s_sub_i32 s8, 0, s4
	v_mov_b32_e32 v48, 0
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
...
.LBB0_5:
	...
	s_mov_b32 s23, s11
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v21, v16, s[8:11], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v16, 0x80000000, v18, s2
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	buffer_load_u16 v23, v16, s[20:23], 0 offen
	s_mov_b32 s0, 0
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v12, v12, v21 :: v_dual_add_nc_u32 v25, 20, v18
	v_mul_f32_e32 v9, v9, v21
	v_mul_f32_e32 v10, v10, v21
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v16, 0x80000000, v19, s2
	v_cndmask_b32_e64 v19, 0x80000000, v22, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v11, v11, v21 :: v_dual_add_nc_u32 v22, 12, v18
	v_dual_mul_f32 v15, v15, v21 :: v_dual_add_nc_u32 v26, 24, v18
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v28, v19, s[20:23], 0 offen
	buffer_load_u16 v29, v22, s[20:23], 0 offen
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v31, v17, s[8:11], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_and_b32_e32 v33, 0x840, v18
	v_and_b32_e32 v32, 14, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v8, v8, v31 :: v_dual_lshlrev_b32 v29, 16, v29
	v_dual_mul_f32 v6, v6, v31 :: v_dual_and_b32 v17, 0x7f, v0
	v_dual_mul_f32 v14, v14, v21 :: v_dual_mul_f32 v3, v3, v31
	v_dual_mul_f32 v20, v20, v21 :: v_dual_and_b32 v19, 0x78, v16
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	...
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_lshl_or_b32 v19, v47, 3, v19
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v4, v4, v31 :: v_dual_lshlrev_b32 v35, 11, v32
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_mad_u64_u32 v[17:18], null, s35, v22, v[16:17]
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v10, v10, v27, v62
	v_fma_f32 v11, v11, v28, v61
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	v_or3_b32 v33, v35, v34, v19
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_ashrrev_i32_e32 v18, 31, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v21, v1, v23, v55
	v_fma_f32 v23, v2, v27, v54
	v_fma_f32 v27, v3, v28, v53
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v34, 0, v33
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_lshlrev_b64 v[18:19], 2, v[17:18]
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v12, v12, v29, v60
	v_fma_f32 v28, v4, v29, v52
	v_fma_f32 v13, v13, v24, v59
	v_fma_f32 v24, v5, v24, v51
	v_fma_f32 v29, v8, v30, v46
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	...
	v_cndmask_b32_e64 v6, v53, v27, s2
	v_xad_u32 v37, v33, 24, 0
	v_cndmask_b32_e64 v7, v60, v12, s2
	v_cndmask_b32_e64 v8, v52, v28, s2
	v_xad_u32 v38, v33, 32, 0
	v_cndmask_b32_e64 v9, v59, v13, s2
	v_cndmask_b32_e64 v10, v51, v24, s2
	v_cndmask_b32_e64 v21, v46, v29, s2
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_vgpr, 81
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.numbered_sgpr, 43
