	...
	.text
	.globl	amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8                          ; -- Begin function amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.p2align	8
	.type	amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8,@function
amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8:                                 ; @amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	2 293 12 prologue_end           ; standard.py:293:12 @[ kda_backward.py:594:25 ]
	v_lshrrev_b32_e32 v9, 3, v0
.Ltmp1:
	.loc	1 573 17                        ; kda_backward.py:573:17
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[1:2], null, s3, s2, v[0:1]
	.loc	1 541 18                        ; kda_backward.py:541:18
	v_cmp_gt_i32_e32 vcc_lo, s3, v0
	.loc	1 572 25                        ; kda_backward.py:572:25
	s_and_b32 s9, s5, 0xffff
	s_mov_b32 s8, s4
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b32_e32 v2, 1, v1
	v_dual_cndmask_b32 v2, 0x80000000, v2 :: v_dual_lshlrev_b32 v1, 2, v1
	buffer_load_u16 v3, v2, s[8:11], 0 offen
	.loc	1 577 23                        ; kda_backward.py:577:23
	...
	s_mov_b32 s8, s2
	.loc	1 594 32                        ; kda_backward.py:594:32
	v_dual_mul_f32 v6, v3, v3 :: v_dual_mul_f32 v7, v2, v2
	.loc	1 587 25                        ; kda_backward.py:587:25
...
.Ltmp4:
	...
	v_dual_fmac_f32 v6, v3, v3 :: v_dual_fmac_f32 v7, v2, v2
	v_add_f32_dpp v6, v6, v6 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp5:
	.loc	2 263 12 is_stmt 0              ; standard.py:263:12 @[ standard.py:293:12 @[ kda_backward.py:598:25 ] ]
...
.Ltmp10:
	.loc	2 293 12 is_stmt 1              ; standard.py:293:12 @[ kda_backward.py:594:25 ]
	v_permlanex16_b32 v8, v6, -1, -1 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp11:
	.loc	2 293 12 is_stmt 0              ; standard.py:293:12 @[ kda_backward.py:598:25 ]
	v_permlanex16_b32 v10, v7, -1, -1 op_sel:[1,0]
.Ltmp12:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ kda_backward.py:594:25 ] ]
	v_dual_add_f32 v6, v6, v8 :: v_dual_add_f32 v7, v7, v10
.Ltmp13:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_backward.py:594:25 ]
	v_and_b32_e32 v8, 12, v9
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_readlane_b32 s0, v6, 31
	v_lshlrev_b32_e32 v0, 2, v0
.Ltmp14:
	.loc	2 293 12 is_stmt 0              ; standard.py:293:12 @[ kda_backward.py:598:25 ]
	v_readlane_b32 s1, v7, 31
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp15:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_backward.py:594:25 ]
	v_dual_mov_b32 v7, s0 :: v_dual_add_nc_u32 v6, 0, v8
...
.Ltmp22:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_backward.py:598:25 ]
	v_dual_mov_b32 v8, s1 :: v_dual_max_f32 v7, 0x2b8cbccc, v7
	ds_store_b32 v6, v8
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v8, v0
...
.Ltmp28:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_backward.py:598:25 ]
	v_dual_mov_b32 v10, v8 :: v_dual_fmac_f32 v11, v13, v11
...
.Ltmp34:
	...
	v_dual_fmac_f32 v9, v4, v3 :: v_dual_mul_f32 v16, v13, v12
...
.Ltmp45:
	...
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v10, v5, v2 :: v_dual_mov_b32 v9, s0
.Ltmp46:
...
.Ltmp59:
	...
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mov_b32 v9, v6 :: v_dual_mov_b32 v10, v0
	v_mov_b32_dpp v9, v9 row_xmask:1 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp60:
	.loc	2 293 12 is_stmt 0              ; standard.py:293:12 @[ kda_backward.py:609:30 ]
...
.Ltmp61:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp62:
	.loc	2 263 12 is_stmt 0              ; standard.py:263:12 @[ standard.py:293:12 @[ kda_backward.py:609:30 ] ]
...
.Ltmp68:
	...
	.loc	1 603 32                        ; kda_backward.py:603:32
	v_div_scale_f32 v2, null, v7, v7, v3
	.loc	1 607 30                        ; kda_backward.py:607:30
	v_div_scale_f32 v4, null, v8, v8, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 603 32                        ; kda_backward.py:603:32
	v_rcp_f32_e32 v5, v2
	.loc	1 607 30                        ; kda_backward.py:607:30
	...
	.loc	1 607 30                        ; kda_backward.py:607:30
	v_div_scale_f32 v9, s0, v0, v8, v0
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 603 32                        ; kda_backward.py:603:32
	v_div_fixup_f32 v2, v2, v7, v3
	.loc	1 607 30                        ; kda_backward.py:607:30
	v_div_fixup_f32 v0, v4, v8, v0
	.loc	1 614 9                         ; kda_backward.py:614:9
...
.Ltmp69:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8, .Lfunc_end0-amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_vgpr, 19
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_agpr, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.numbered_sgpr, 12
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.private_seg_size, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_recursion, 0
	.set amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8"                        ; string offset=91 ; amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8
    .private_segment_fixed_size: 0
    .sgpr_count:     14
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_kda_bwd_norm_bf16_b7_t2048_h48_d128_dv128_vb64_ci8.kd
