...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_or_b32_e32 v169, s41, v136
	v_or_b32_e32 v170, s41, v138
	.loc	1 1131 28                       ; ragged.py:1131:28
	v_or_b32_e32 v167, 2, v136
	.loc	1 1141 26                       ; ragged.py:1141:26
	v_or_b32_e32 v168, s41, v137
	v_or_b32_e32 v171, s41, v139
	v_or_b32_e32 v172, s41, v140
	v_or_b32_e32 v173, s41, v141
	v_or_b32_e32 v180, s41, v142
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v166, s7, v143, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_add_i32 s39, s7, s6
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v167, s7, v144, 1
	v_add_lshl_u32 v168, s7, v145, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_mul_i32 s39, s39, s33
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v169, s7, v146, 1
	.loc	1 1213 40                       ; ragged.py:1213:40
	v_add_lshl_u32 v170, v150, s39, 1
	.loc	1 1204 40                       ; ragged.py:1204:40
	...
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v59, v169, v59 :: v_dual_fmac_f32 v132, v172, v2
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v133, v171, v1 :: v_dual_fmac_f32 v130, v174, v4
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v131, v173, v3 :: v_dual_fmac_f32 v128, v176, v6
	v_dual_fmac_f32 v129, v175, v5 :: v_dual_fmac_f32 v126, v178, v8
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v127, v177, v7 :: v_dual_fmac_f32 v124, v166, v10
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v125, v170, v9 :: v_dual_fmac_f32 v120, v179, v14
	v_dual_fmac_f32 v123, v181, v11 :: v_dual_fmac_f32 v122, v182, v12
	v_dual_fmac_f32 v121, v183, v13 :: v_dual_fmac_f32 v118, v185, v16
	v_dual_fmac_f32 v119, v184, v15 :: v_dual_fmac_f32 v116, v18, v2
	...
	v_dual_fmac_f32 v75, v59, v11 :: v_dual_fmac_f32 v68, v61, v13
	v_dual_fmac_f32 v73, v62, v14 :: v_dual_fmac_f32 v72, v63, v15
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 214
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 42
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
