...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s29, v3, v[1:2]
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp19:
	...
	buffer_load_b128 v[15:18], v4, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v28, v1, s[4:7], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[19:22], v5, s[16:19], 0 offen
	buffer_load_b128 v[23:26], v6, s[16:19], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v10, v55, v38
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v16, v60, v43 :: v_dual_fmac_f32 v17, v61, v44
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v56, v54, v56 :: v_dual_lshlrev_b32 v57, 16, v90
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v12, v56, v39 :: v_dual_mul_f32 v57, v54, v57
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v54, v54, v62
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v57, v40 :: v_dual_add_nc_u32 v136, s39, v37
...
.LBB0_9:
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v37, v22, s4, 1
	v_add_lshl_u32 v38, v20, s4, 1
	v_add_lshl_u32 v39, v23, s4, 1
...
; %bb.10:
	...
	v_mov_b32_e32 v42, 0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v50, s33, v30
	v_add_nc_u32_e32 v54, s33, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v44, v49, v46, 0xc0c0004
	v_perm_b32 v46, v48, v47, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v58, s33, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 138
