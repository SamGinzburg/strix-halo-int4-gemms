...
.Ltmp0:
	...
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v8, 2, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v11, 0 :: v_dual_lshlrev_b32 v2, 3, v32
	v_mov_b32_e32 v24, 0
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_lshrrev_b32_e32 v28, 1, v0
	v_dual_mov_b32 v16, 0 :: v_dual_add_nc_u32 v33, 0, v8
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v38, 1, v8
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v53, v61, v53 :: v_dual_lshlrev_b32 v60, 16, v60
	...
	v_dual_mul_f32 v50, v50, v60 :: v_dual_mul_f32 v55, v61, v55
	v_dual_mul_f32 v51, v51, v60 :: v_dual_mul_f32 v54, v61, v54
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v56, v61, v56 :: v_dual_fmac_f32 v11, v44, v63
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v62, 16, v62
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v23, v48, v67 :: v_dual_lshlrev_b32 v68, 16, v69
	.loc	1 180 20 is_stmt 0              ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v58, v61, v58 :: v_dual_fmac_f32 v25, v46, v65
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v26, v45, v60 :: v_dual_fmac_f32 v17, v54, v65
	v_dual_fmac_f32 v24, v47, v64 :: v_dual_fmac_f32 v15, v56, v67
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v22, v49, v66 :: v_dual_fmac_f32 v21, v50, v68
	v_dual_fmac_f32 v20, v51, v62 :: v_dual_fmac_f32 v19, v53, v60
	v_dual_fmac_f32 v18, v52, v63 :: v_dual_fmac_f32 v13, v58, v68
	v_fmac_f32_e32 v16, v55, v64
	v_fmac_f32_e32 v14, v57, v66
	v_fmac_f32_e32 v12, v59, v62
...
.LBB0_5:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v7, v7, v32 :: v_dual_lshlrev_b32 v30, 16, v30
	v_dual_mul_f32 v1, v1, v30 :: v_dual_add_nc_u32 v42, 12, v29
	v_dual_mul_f32 v4, v4, v30 :: v_dual_add_nc_u32 v43, 16, v29
	v_dual_mul_f32 v3, v3, v30 :: v_dual_add_nc_u32 v44, 20, v29
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v45, 24, v29
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v33, v33, v30
	v_dual_mul_f32 v6, v6, v32 :: v_dual_add_nc_u32 v29, 28, v29
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v30 :: v_dual_and_b32 v28, 0x78, v28
	v_dual_mul_f32 v9, v9, v30 :: v_dual_and_b32 v0, 16, v0
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v36, v36, v32 :: v_dual_lshlrev_b32 v37, 16, v39
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(6)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v5, v5, v41, v24
	v_fma_f32 v30, v30, v29, v20
	v_fma_f32 v33, v33, v42, v22
	v_fma_f32 v8, v8, v42, v14
	v_fma_f32 v2, v2, v39, v18
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_cndmask_b16 v5.h, 0x7fff, v15.h, s6
	v_cmp_o_f32_e64 s8, v2, v2
	v_mov_b16_e32 v52.l, v13.h
	v_cndmask_b16 v5.l, 0x7fff, v14.h, s5
	...
	v_dual_cndmask_b32 v5, 0x1054, v47 :: v_dual_and_b32 v6, 1, v46
	...
	v_add3_u32 v0, v16, v6, 0x7fff
	v_dual_cndmask_b32 v13, 0x3276, v48 :: v_dual_and_b32 v20, 1, v51
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 90
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 43
