...
.Ltmp0:
	...
	s_waitcnt lgkmcnt(6)
	v_cndmask_b32_e64 v98, v32, v48, s1
	.loc	1 779 31                        ; attention.py:779:31
	s_waitcnt vmcnt(0)
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v57, s33, v128
	v_or_b32_e32 v50, s33, v132
	v_or_b32_e32 v51, s33, v131
	v_or_b32_e32 v52, s33, v130
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v53, s39, v144, 1
	v_add_lshl_u32 v54, s39, v145, 1
	v_add_lshl_u32 v55, s39, v146, 1
	v_add_lshl_u32 v56, s39, v147, 1
...
.Ltmp12:
	...
	v_permlanex16_b32 v40, v56, s38, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v199, v78, v39, v170
	v_perm_b32 v200, v78, v39, v171
	v_permlanex16_b32 v39, v55, s38, 0xfedcba98 op_sel:[1,0]
	.loc	1 886 62                        ; attention.py:886:62
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 48
