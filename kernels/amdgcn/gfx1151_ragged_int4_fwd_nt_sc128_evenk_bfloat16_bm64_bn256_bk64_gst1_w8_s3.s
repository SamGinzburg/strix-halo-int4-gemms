...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 414 18 is_stmt 0              ; ragged.py:414:18
	...
	s_mul_i32 s23, s34, s33
	v_dual_mov_b32 v125, 0 :: v_dual_add_nc_u32 v4, s22, v4
	.loc	1 415 21                        ; ragged.py:415:21
	v_cmp_le_i64_e32 vcc_lo, s[24:25], v[2:3]
	...
	.loc	1 494 25                        ; ragged.py:494:25
	v_mul_lo_u32 v138, v93, s10
	v_mul_lo_u32 v139, v98, s10
	v_mul_lo_u32 v140, v99, s10
	v_mul_lo_u32 v141, v100, s10
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	.loc	1 478 34                        ; ragged.py:478:34
	buffer_load_b64 v[162:163], v162, s[24:27], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 479 34                        ; ragged.py:479:34
	s_waitcnt vmcnt(2)
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v154, s23, v138, 1
	.loc	1 501 25                        ; ragged.py:501:25
	s_add_i32 s22, s23, s11
	.loc	1 493 40                        ; ragged.py:493:40
	v_add_lshl_u32 v155, s23, v139, 1
	v_add_lshl_u32 v156, s23, v140, 1
	.loc	1 501 25                        ; ragged.py:501:25
	s_mul_i32 s22, s22, s33
	.loc	1 493 40                        ; ragged.py:493:40
	v_add_lshl_u32 v157, s23, v141, 1
	.loc	1 500 40                        ; ragged.py:500:40
	v_add_lshl_u32 v158, v137, s22, 1
	.loc	1 493 40                        ; ragged.py:493:40
	...
	v_dual_fmac_f32 v126, v168, v9 :: v_dual_fmac_f32 v125, v169, v10
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v124, v170, v11 :: v_dual_fmac_f32 v123, v171, v12
	v_dual_fmac_f32 v122, v172, v13 :: v_dual_fmac_f32 v121, v173, v14
	v_dual_fmac_f32 v120, v154, v15 :: v_dual_fmac_f32 v119, v16, v0
	v_dual_fmac_f32 v118, v17, v1 :: v_dual_fmac_f32 v117, v18, v2
	v_dual_fmac_f32 v116, v19, v3 :: v_dual_fmac_f32 v115, v20, v4
	v_dual_fmac_f32 v114, v21, v5 :: v_dual_fmac_f32 v113, v22, v6
	v_dual_fmac_f32 v112, v23, v7 :: v_dual_fmac_f32 v111, v24, v8
	...
	v_dual_fmac_f32 v103, v31, v15 :: v_dual_fmac_f32 v96, v34, v2
	v_dual_fmac_f32 v101, v32, v0 :: v_dual_fmac_f32 v92, v37, v5
	v_dual_fmac_f32 v97, v33, v1 :: v_dual_fmac_f32 v94, v36, v4
	v_dual_fmac_f32 v95, v35, v3 :: v_dual_fmac_f32 v88, v41, v9
	v_dual_fmac_f32 v91, v38, v6 :: v_dual_fmac_f32 v90, v39, v7
	v_dual_fmac_f32 v89, v40, v8 :: v_dual_fmac_f32 v86, v43, v11
	v_dual_fmac_f32 v87, v42, v10 :: v_dual_fmac_f32 v84, v45, v13
	v_dual_fmac_f32 v85, v44, v12 :: v_dual_fmac_f32 v82, v47, v15
	v_dual_fmac_f32 v83, v46, v14 :: v_dual_fmac_f32 v80, v49, v1
	v_dual_fmac_f32 v81, v48, v0 :: v_dual_fmac_f32 v78, v51, v3
	v_dual_fmac_f32 v79, v50, v2 :: v_dual_fmac_f32 v76, v53, v5
	v_dual_fmac_f32 v77, v52, v4 :: v_dual_fmac_f32 v74, v55, v7
	v_dual_fmac_f32 v75, v54, v6 :: v_dual_fmac_f32 v72, v57, v9
	v_dual_fmac_f32 v73, v56, v8 :: v_dual_fmac_f32 v70, v59, v11
	v_dual_fmac_f32 v71, v58, v10 :: v_dual_fmac_f32 v68, v61, v13
	v_dual_fmac_f32 v69, v60, v12 :: v_dual_fmac_f32 v66, v63, v15
	v_fmac_f32_e32 v67, v62, v14
	.loc	1 464 19                        ; ragged.py:464:19
