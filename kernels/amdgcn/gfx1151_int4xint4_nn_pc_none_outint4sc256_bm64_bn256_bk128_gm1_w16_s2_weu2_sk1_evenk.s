...
.Ltmp0:
	...
	.loc	1 127 32                        ; generate_amdgcn.py:127:32
	v_and_b32_e32 v88, 0xe0, v0
	v_lshlrev_b32_e32 v86, 2, v0
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_and_b32_e32 v14, 56, v90
...
.Ltmp11:
	...
	v_mad_u64_u32 v[3:4], null, s17, v84, v[65:66]
	...
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[4:5], null, s24, v2, v[1:2]
	v_add3_u32 v4, s16, s2, v4
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[11:12], v4, s[4:7], 0 offen
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v47, v[11:12] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v48, v[3:6]
	s_waitcnt vmcnt(0)
	ds_store_b128 v48, v[7:10] offset:8192
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cbranch_scc1 .LBB0_3
; %bb.1:                                ; %.lr.ph
	.loc	1 0 9 is_stmt 0                 ; generate_amdgcn.py:0:9
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v4, s16, v84
...
.Ltmp13:
	...
	v_dual_mov_b32 v18, v13 :: v_dual_add_nc_u32 v5, 0x60, v4
	v_dual_mov_b32 v15, v13 :: v_dual_add_nc_u32 v4, 64, v4
	v_dual_mov_b32 v14, v13 :: v_dual_and_b32 v3, 0x438, v3
...
.Ltmp15:
	...
	v_lshl_or_b32 v6, v85, 6, v3
	v_sub_nc_u32_e64 v3, s14, 2 clamp
	v_mov_b32_e32 v17, v13
	s_lshl_b32 s15, s23, 8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v19, v13 :: v_dual_add_nc_u32 v52, 0, v6
	...
	v_xor_b32_e32 v11, 40, v6
	v_xor_b32_e32 v12, 48, v6
	v_add3_u32 v3, v5, s15, v65
	v_add3_u32 v4, v4, s15, v65
	v_xor_b32_e32 v5, 56, v6
	s_lshl_b32 s15, s22, 8
	v_add3_u32 v51, v2, v1, 64
	v_subrev_nc_u32_e32 v49, s15, v3
	v_subrev_nc_u32_e32 v50, s15, v4
	v_dual_mov_b32 v20, v13 :: v_dual_add_nc_u32 v53, 0, v7
	v_dual_mov_b32 v21, v13 :: v_dual_add_nc_u32 v54, 0, v8
	v_dual_mov_b32 v22, v13 :: v_dual_add_nc_u32 v55, 0, v9
	v_dual_mov_b32 v23, v13 :: v_dual_add_nc_u32 v56, 0, v10
	v_dual_mov_b32 v24, v13 :: v_dual_add_nc_u32 v57, 0, v11
	v_dual_mov_b32 v25, v13 :: v_dual_add_nc_u32 v58, 0, v12
	v_dual_mov_b32 v26, v13 :: v_dual_add_nc_u32 v59, 0, v5
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[45:46], v51, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	buffer_load_b128 v[9:12], v50, s[12:15], 0 offen
	buffer_load_b128 v[37:40], v49, s[12:15], 0 offen
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v67, v92 offset:1280
	ds_load_u8 v68, v92 offset:1024
	ds_load_u8 v63, v92 offset:1792
	ds_load_u8 v66, v92 offset:1536
	ds_load_u8 v61, v92 offset:256
	ds_load_u8 v64, v92
	ds_load_u8 v60, v92 offset:768
	ds_load_u8 v62, v92 offset:512
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[41:44], v52 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[69:72], v53 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v73, v92 offset:3328
	ds_load_u8 v74, v92 offset:1920
	ds_load_u8 v75, v92 offset:1408
	ds_load_u8 v76, v92 offset:1152
	ds_load_u8 v77, v92 offset:1664
	ds_load_u8 v78, v92 offset:896
	ds_load_u8 v79, v92 offset:384
	ds_load_u8 v80, v92 offset:128
	ds_load_u8 v81, v92 offset:640
	ds_load_u8 v82, v92 offset:3584
	ds_load_u8 v83, v92 offset:2304
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	...
	s_add_i32 s16, s16, -1
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v95, v92 offset:14976
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cmp_lg_u32 s16, 0
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v67, v68, v67, 0xc0c0004
	ds_load_u8 v68, v92 offset:3072
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v63, v66, v63, 0xc0c0004
	ds_load_u8 v66, v92 offset:3840
	...
	v_lshl_or_b32 v60, v60, 16, v64
	ds_load_u8 v64, v92 offset:2048
	ds_load_u8 v67, v92 offset:2816
	ds_load_u8 v74, v92 offset:3968
	ds_load_u8 v77, v92 offset:3712
	ds_load_u8 v79, v92 offset:3456
	ds_load_u8 v75, v92 offset:2560
	v_lshl_or_b32 v63, v63, 16, v62
	v_lshl_or_b32 v62, v78, 16, v76
	ds_load_u8 v76, v92 offset:3200
	ds_load_u8 v78, v92 offset:2944
	ds_load_u8 v80, v92 offset:2432
	ds_load_u8 v81, v92 offset:2176
	v_wmma_i32_16x16x16_iu4 v[13:20], v[60:61], v[41:42], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[60:61], v[43:44], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[62:63], v[41:42], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[62:63], v[43:44], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v87, v92 offset:2688
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[41:44], v54 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v68, v68, v73, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v66, v82, v66, 0xc0c0004
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[60:63], v55 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v64, v64, v83, 0xc0c0004
	ds_load_u8 v82, v92 offset:6016
	ds_load_u8 v83, v92 offset:5504
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v74, v77, v74, 0xc0c0004
	ds_load_u8 v77, v92 offset:4352
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v73, v75, v67, 0xc0c0004
	v_lshl_or_b32 v67, v66, 16, v68
	ds_load_u8 v75, v92 offset:5376
	v_lshl_or_b32 v66, v73, 16, v64
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v73, v76, v79, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v79, v81, v80, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v78, v87, v78, 0xc0c0004
	ds_load_u8 v64, v92 offset:5120
	ds_load_u8 v68, v92 offset:5888
	v_wmma_i32_16x16x16_iu4 v[13:20], v[66:67], v[69:70], v[13:20] neg_lo:[1,1,0]
	v_lshl_or_b32 v74, v74, 16, v73
	v_wmma_i32_16x16x16_iu4 v[29:36], v[66:67], v[71:72], v[29:36] neg_lo:[1,1,0]
	v_lshl_or_b32 v73, v78, 16, v79
	ds_load_u8 v76, v92 offset:5632
	ds_load_u8 v78, v92 offset:4608
	ds_load_u8 v79, v92 offset:7424
	v_wmma_i32_16x16x16_iu4 v[21:28], v[73:74], v[69:70], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[73:74], v[71:72], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v69, v92 offset:5248
	ds_load_u8 v70, v92 offset:5760
	ds_load_u8 v71, v92 offset:4992
	ds_load_u8 v72, v92 offset:4480
	ds_load_u8 v73, v92 offset:4224
	ds_load_u8 v74, v92 offset:4736
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v72, v73, v72, 0xc0c0004
	ds_load_u8 v73, v92 offset:9216
	ds_load_u8 v81, v92 offset:4864
	ds_load_u8 v80, v92 offset:4096
	v_perm_b32 v64, v64, v75, 0xc0c0004
	v_perm_b32 v66, v76, v68, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v74, v71, 0xc0c0004
	ds_load_u8 v75, v92 offset:7168
	ds_load_u8 v76, v92 offset:7936
	ds_load_u8 v74, v92 offset:9984
	v_lshl_or_b32 v67, v66, 16, v64
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v78, v78, v81, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v68, v80, v77, 0xc0c0004
	ds_load_u8 v80, v92 offset:6400
	v_lshl_or_b32 v66, v78, 16, v68
	v_perm_b32 v68, v69, v83, 0xc0c0004
	v_perm_b32 v69, v70, v82, 0xc0c0004
	ds_load_u8 v64, v92 offset:6144
	ds_load_u8 v78, v92 offset:6912
	ds_load_u8 v70, v92 offset:9472
	v_wmma_i32_16x16x16_iu4 v[13:20], v[66:67], v[41:42], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[66:67], v[43:44], v[29:36] neg_lo:[1,1,0]
	v_lshl_or_b32 v69, v69, 16, v68
	v_lshl_or_b32 v68, v71, 16, v72
	ds_load_u8 v66, v92 offset:8064
	ds_load_u8 v67, v92 offset:7552
	ds_load_u8 v71, v92 offset:9728
	ds_load_u8 v72, v92 offset:8448
	v_wmma_i32_16x16x16_iu4 v[21:28], v[68:69], v[41:42], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[68:69], v[43:44], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v43, v92 offset:7296
	ds_load_u8 v44, v92 offset:7808
	ds_load_u8 v68, v92 offset:7040
	ds_load_u8 v69, v92 offset:6528
	ds_load_u8 v82, v92 offset:6272
	ds_load_u8 v83, v92 offset:6784
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v43, v43, v67, 0xc0c0004
	ds_load_u8 v67, v92 offset:11776
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v44, v44, v66, 0xc0c0004
	ds_load_u8 v66, v92 offset:10496
	ds_load_u8 v77, v92 offset:7680
	ds_load_u8 v81, v92 offset:6656
	v_perm_b32 v41, v75, v79, 0xc0c0004
	v_perm_b32 v64, v64, v80, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v69, v82, v69, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v68, v83, v68, 0xc0c0004
	v_lshl_or_b32 v44, v44, 16, v43
	ds_load_u8 v75, v92 offset:8192
	ds_load_u8 v80, v92 offset:10240
	ds_load_u8 v82, v92 offset:9600
	ds_load_u8 v83, v92 offset:9344
	v_lshl_or_b32 v43, v68, 16, v69
	ds_load_u8 v68, v92 offset:10112
	ds_load_u8 v69, v92 offset:9856
	ds_load_u8 v79, v92 offset:11520
	v_wmma_i32_16x16x16_iu4 v[1:8], v[43:44], v[62:63], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[43:44], v[60:61], v[21:28] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v42, v77, v76, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v78, v81, v78, 0xc0c0004
	ds_load_u8 v77, v92 offset:8704
	ds_load_u8 v81, v92 offset:11008
	v_lshl_or_b32 v42, v42, 16, v41
	v_lshl_or_b32 v41, v78, 16, v64
	ds_load_u8 v64, v92 offset:11264
	ds_load_u8 v78, v92 offset:12032
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v68, v69, v68, 0xc0c0004
	ds_load_u8 v69, v92 offset:12544
	v_wmma_i32_16x16x16_iu4 v[29:36], v[41:42], v[62:63], v[29:36] neg_lo:[1,1,0]
	ds_load_u8 v62, v92 offset:8576
	ds_load_u8 v63, v92 offset:8320
	ds_load_u8 v87, v92 offset:9088
	ds_load_u8 v93, v92 offset:8832
	ds_load_u8 v94, v92 offset:10752
	v_wmma_i32_16x16x16_iu4 v[13:20], v[41:42], v[60:61], v[13:20] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[41:44], v56 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_perm_b32 v60, v73, v70, 0xc0c0004
	v_perm_b32 v70, v75, v72, 0xc0c0004
	v_perm_b32 v73, v83, v82, 0xc0c0004
	ds_load_u8 v72, v92 offset:13568
	ds_load_u8 v75, v92 offset:12288
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v67, v67, v78, 0xc0c0004
	ds_load_u8 v78, v92 offset:14336
	ds_load_u8 v76, v92 offset:8960
	v_perm_b32 v61, v71, v74, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	v_lshl_or_b32 v63, v68, 16, v73
	ds_load_u8 v74, v92 offset:13824
	ds_load_u8 v68, v92 offset:12800
	ds_load_u8 v73, v92 offset:15616
	v_lshl_or_b32 v61, v61, 16, v60
	v_perm_b32 v66, v80, v66, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v80, v94, v81, 0xc0c0004
	ds_load_u8 v81, v92 offset:14848
	v_lshl_or_b32 v66, v80, 16, v66
	ds_load_u8 v80, v92 offset:15232
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v71, v77, v76, 0xc0c0004
	v_perm_b32 v76, v93, v87, 0xc0c0004
	ds_load_u8 v77, v92 offset:13056
	v_lshl_or_b32 v60, v71, 16, v70
	v_lshl_or_b32 v62, v76, 16, v62
	ds_load_u8 v70, v92 offset:13312
	ds_load_u8 v71, v92 offset:14080
	ds_load_u8 v76, v92 offset:14592
	v_wmma_i32_16x16x16_iu4 v[13:20], v[60:61], v[41:42], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[60:61], v[43:44], v[29:36] neg_lo:[1,1,0]
	ds_load_u8 v60, v92 offset:15360
	ds_load_u8 v61, v92 offset:12160
	v_wmma_i32_16x16x16_iu4 v[21:28], v[62:63], v[41:42], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[62:63], v[43:44], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v41, v92 offset:11904
	ds_load_u8 v42, v92 offset:11648
	ds_load_u8 v43, v92 offset:11392
	ds_load_u8 v44, v92 offset:11136
	ds_load_u8 v62, v92 offset:16128
	ds_load_u8 v63, v92 offset:15872
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v60, v60, v73, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v82, v43, v42, 0xc0c0004
	ds_load_u8 v42, v92 offset:12928
	ds_load_u8 v43, v92 offset:12416
	v_perm_b32 v69, v75, v69, 0xc0c0004
	ds_load_u8 v75, v92 offset:10368
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	ds_load_u8 v63, v92 offset:14208
	ds_load_u8 v73, v92 offset:13440
	v_perm_b32 v70, v70, v72, 0xc0c0004
	ds_load_u8 v72, v92 offset:10880
	v_perm_b32 v64, v64, v79, 0xc0c0004
	ds_load_u8 v79, v92 offset:15104
	v_perm_b32 v71, v74, v71, 0xc0c0004
	ds_load_u8 v74, v92 offset:10624
	v_perm_b32 v61, v41, v61, 0xc0c0004
	ds_load_u8 v41, v92 offset:12672
	v_perm_b32 v76, v78, v76, 0xc0c0004
	ds_load_u8 v78, v92 offset:13952
	v_lshl_or_b32 v67, v67, 16, v64
	v_lshl_or_b32 v71, v71, 16, v70
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v83, v72, v44, 0xc0c0004
	ds_load_u8 v44, v92 offset:15744
	ds_load_u8 v72, v92 offset:15488
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v92 offset:14720
	v_perm_b32 v79, v81, v79, 0xc0c0004
	ds_load_u8 v81, v92 offset:13184
	v_perm_b32 v68, v68, v77, 0xc0c0004
	ds_load_u8 v77, v92 offset:13696
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v87, v43, v41, 0xc0c0004
	v_lshl_or_b32 v74, v83, 16, v74
	v_lshl_or_b32 v70, v68, 16, v69
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v93, v72, v44, 0xc0c0004
	ds_load_u8 v72, v92 offset:14464
	v_perm_b32 v78, v78, v63, 0xc0c0004
	ds_load_u8 v63, v92 offset:16256
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v81, v42, v81, 0xc0c0004
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[41:44], v57 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v77, v73, v77, 0xc0c0004
	ds_load_u8 v73, v92 offset:16000
	v_lshl_or_b32 v77, v78, 16, v77
	v_perm_b32 v78, v95, v80, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v94, v72, v75, 0xc0c0004
	v_lshl_or_b32 v75, v61, 16, v82
	v_lshl_or_b32 v72, v79, 16, v76
	v_lshl_or_b32 v76, v81, 16, v87
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[66:67], v[41:42], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[66:67], v[43:44], v[29:36] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v73, v63, 0xc0c0004
	v_lshl_or_b32 v73, v62, 16, v60
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[60:63], v58 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[66:69], v59 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_wmma_i32_16x16x16_iu4 v[21:28], v[74:75], v[41:42], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[74:75], v[43:44], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v79, v64, 16, v93
	v_lshl_or_b32 v78, v78, 16, v94
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v47, v[45:46] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v48, v[9:12]
	s_waitcnt vmcnt(0)
	ds_store_b128 v48, v[37:40] offset:8192
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_wmma_i32_16x16x16_iu4 v[13:20], v[70:71], v[60:61], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[76:77], v[60:61], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[70:71], v[62:63], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[76:77], v[62:63], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[72:73], v[66:67], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[78:79], v[66:67], v[21:28] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[29:36], v[72:73], v[68:69], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[78:79], v[68:69], v[1:8] neg_lo:[1,1,0]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
.LBB0_9:
	...
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
	buffer_load_u16 v6, v5, s[4:7], 0 offen
...
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max_f32_e32 v6, v6, v6
	v_dual_max_f32 v3, v3, v6 :: v_dual_lshlrev_b32 v6, 4, v89
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp30:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
...
.Ltmp47:
	...
	.loc	1 86 5                          ; generate_amdgcn.py:86:5 @[ generate_amdgcn.py:243:9 ]
	buffer_store_b64 v[4:5], v21, s[4:7], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 96
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 26
