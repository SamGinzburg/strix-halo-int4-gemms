...
.Ltmp11:
	...
	v_mad_u64_u32 v[57:58], null, s21, v36, v[105:106]
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
...
.Ltmp13:
	...
	s_lshl_b32 s34, s2, 5
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v59, s31, 2, v57
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	s_mul_i32 s2, s34, s9
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s6, s21, s4
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v60, v1, v2, s2
	...
	v_add_nc_u32_e32 v1, s4, v57
	.loc	1 414 39 is_stmt 1              ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v10, s6, v59
	v_add_nc_u32_e32 v11, s6, v58
	s_mov_b32 s4, 0
	...
	v_cndmask_b32_e64 v14, 0x80000000, v11, s2
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v22, 0x80000000, v18, s2
	...
	v_add_nc_u32_e32 v26, s21, v1
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[18:21], v19, s[16:19], 0 offen
	...
	v_add_nc_u32_e32 v73, 0, v36
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v36, 0x4000, v67
	v_add_nc_u32_e32 v37, 0x4000, v68
	v_add_nc_u32_e32 v38, 0x4000, v69
	v_add_nc_u32_e32 v39, 0x4000, v70
	v_add_nc_u32_e32 v40, 0x4000, v71
	v_add_nc_u32_e32 v41, 0x4000, v72
	v_add_nc_u32_e32 v42, 0x4000, v73
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(8)
	ds_store_b64 v66, v[34:35] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(6)
	v_perm_b32 v34, v6, v2, 0x4000501
	...
	v_perm_b32 v25, v34, v17, 0x7060302
	v_perm_b32 v17, v34, v17, 0x5040100
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v67, v25, v17 offset1:16
	ds_store_2addr_b32 v68, v34, v2 offset1:16
	ds_store_2addr_b32 v69, v18, v6 offset1:16
	ds_store_2addr_b32 v70, v22, v3 offset1:16
	ds_store_2addr_b32 v71, v19, v7 offset1:16
	ds_store_2addr_b32 v67, v23, v4 offset0:160 offset1:176
	ds_store_2addr_b32 v72, v20, v8 offset1:16
	ds_store_2addr_b32 v73, v24, v5 offset1:16
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
...
.Ltmp14:
	...
	v_and_b32_e32 v3, 0x1800, v61
	v_and_b32_e32 v2, 0x210, v2
	v_bfe_i32 v4, v0, 5, 1
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v74, s21, v57
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v65, v108, 6, v3
	v_xor_b32_e32 v2, v2, v1
	v_or_b32_e32 v1, v64, v1
	v_and_b32_e32 v3, 0x420, v4
	v_dual_mov_b32 v112, 0 :: v_dual_add_nc_u32 v83, 0x4000, v67
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_or_b32_e32 v2, v2, v65
	v_xor_b32_e32 v4, 16, v1
	v_xor_b32_e32 v5, 32, v1
	v_add_nc_u32_e32 v75, 0, v1
	v_dual_mov_b32 v115, 0 :: v_dual_add_nc_u32 v84, 0x4000, v68
	v_xor_b32_e32 v2, v2, v3
	v_xor_b32_e32 v3, 48, v1
	v_add_nc_u32_e32 v76, 0, v4
	v_dual_mov_b32 v118, 0 :: v_dual_add_nc_u32 v77, 0, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v1, 16, v2
	v_xor_b32_e32 v4, 32, v2
	v_add_nc_u32_e32 v78, 0, v3
	v_xor_b32_e32 v3, 48, v2
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v79, 0, v2
	v_add_nc_u32_e32 v80, 0, v1
	v_dual_mov_b32 v114, 0 :: v_dual_add_nc_u32 v81, 0, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v117, 0 :: v_dual_add_nc_u32 v82, 0, v3
	v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v2, s5
	v_dual_mov_b32 v3, s6 :: v_dual_mov_b32 v4, s7
	v_dual_mov_b32 v5, s8 :: v_dual_mov_b32 v6, s9
	v_dual_mov_b32 v7, s10 :: v_dual_mov_b32 v8, s11
	v_dual_mov_b32 v122, 0 :: v_dual_add_nc_u32 v85, 0x4000, v69
	v_dual_mov_b32 v113, 0 :: v_dual_add_nc_u32 v86, 0x4000, v70
	v_dual_mov_b32 v124, 0 :: v_dual_add_nc_u32 v87, 0x4000, v71
	v_dual_mov_b32 v121, 0 :: v_dual_add_nc_u32 v88, 0x4000, v72
	v_dual_mov_b32 v126, 0 :: v_dual_add_nc_u32 v89, 0x4000, v73
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v90, s5, v60
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s5, s5, s21
	s_add_i32 s5, s5, s20
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b64 v[102:103], v90, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[185:188], v75 offset:33792
	ds_load_b128 v[189:192], v76 offset:33792
	ds_load_b128 v[98:101], v75 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[137:140], v79
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[169:172], v76 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[141:144], v80
	ds_load_b128 v[153:156], v79 offset:8192
	ds_load_b128 v[157:160], v80 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[177:180], v79 offset:16384
	ds_load_b128 v[181:184], v80 offset:16384
	ds_load_b128 v[193:196], v79 offset:24576
	ds_load_b128 v[197:200], v80 offset:24576
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[90:97], v[137:140], v[98:101], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[90:97], v[141:144], v[169:172], v[90:97] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[129:136], v[141:144], v[189:192], v[129:136] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[137:144], v[153:156], v[98:101], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[145:152], v[157:160], v[189:192], v[145:152] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[161:168], v[193:196], v[98:101], v[1:8] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[137:144], v[157:160], v[169:172], v[137:144] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[153:160], v[177:180], v[98:101], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[98:101], v77 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[185:188], v81
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[193:196], v81 offset:24576
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[177:184], v[197:200], v[189:192], v[177:184] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[189:192], v77 offset:33792
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[90:97], v[185:188], v[98:101], v[90:97] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[161:168], v[193:196], v[98:101], v[161:168] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[129:136], v[185:188], v[189:192], v[129:136] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[185:188], v81 offset:8192
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[177:184], v[193:196], v[189:192], v[177:184] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[193:196], v82 offset:24576
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[137:144], v[185:188], v[98:101], v[137:144] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[145:152], v[185:188], v[189:192], v[145:152] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[185:188], v81 offset:16384
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[153:160], v[185:188], v[98:101], v[153:160] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[169:176], v[185:188], v[189:192], v[169:176] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[98:101], v78 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[185:188], v82
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_wmma_i32_16x16x16_iu8 v[129:136], v[185:188], v[189:192], v[129:136] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[185:188], v82 offset:8192
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[177:184], v[193:196], v[189:192], v[177:184] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v161, v161
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v104, v94
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v94, s5, v74
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v109, v95
	v_cvt_f32_i32_e32 v110, v96
	...
	v_wmma_i32_16x16x16_iu8 v[145:152], v[185:188], v[189:192], v[145:152] neg_lo:[1,1,0]
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[185:188], v82 offset:16384
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[90:93], v90, s[16:19], 0 offen
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v44, v44, v101 :: v_dual_add_f32 v35, v35, v135
	v_dual_add_f32 v42, v42, v99 :: v_dual_add_f32 v49, v49, v129
	v_dual_add_f32 v41, v41, v98 :: v_dual_add_f32 v40, v40, v119
	v_add_f32_e32 v33, v33, v133
	v_dual_add_f32 v38, v38, v109 :: v_dual_add_f32 v55, v55, v148
	v_dual_add_f32 v48, v48, v141 :: v_dual_add_f32 v53, v53, v146
	v_dual_add_f32 v46, v46, v139 :: v_dual_add_f32 v125, v125, v145
	v_dual_add_f32 v122, v122, v142 :: v_dual_add_f32 v127, v127, v151
	v_dual_add_f32 v124, v124, v144 :: v_dual_add_f32 v19, v19, v155
	v_dual_add_f32 v52, v52, v132 :: v_dual_add_f32 v17, v17, v153
	v_dual_add_f32 v50, v50, v130 :: v_dual_add_f32 v15, v15, v159
	v_dual_add_f32 v36, v36, v136 :: v_dual_add_f32 v13, v13, v157
	v_dual_add_f32 v34, v34, v134 :: v_dual_add_f32 v111, v111, v161
	v_dual_add_f32 v56, v56, v149 :: v_dual_add_f32 v23, v23, v164
	v_dual_add_f32 v54, v54, v147 :: v_dual_add_f32 v21, v21, v162
	v_dual_add_f32 v126, v126, v150 :: v_dual_add_f32 v117, v117, v167
	v_dual_add_f32 v128, v128, v152 :: v_dual_add_f32 v27, v27, v171
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v20, v20, v156 :: v_dual_add_f32 v25, v25, v169
	v_dual_add_f32 v18, v18, v154 :: v_dual_add_f32 v11, v11, v175
	v_dual_add_f32 v16, v16, v160 :: v_dual_add_f32 v9, v9, v173
	v_dual_add_f32 v14, v14, v158 :: v_dual_add_f32 v115, v115, v177
	v_dual_add_f32 v24, v24, v165 :: v_dual_add_f32 v31, v31, v180
	v_dual_add_f32 v22, v22, v163 :: v_dual_add_f32 v29, v29, v178
	...
	v_dual_add_f32 v112, v112, v184 :: v_dual_add_f32 v39, v39, v110
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v185, v94, v90, 0x4000501
	v_perm_b32 v186, v94, v90, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v90, s5, v59
	v_add_nc_u32_e32 v94, s5, v58
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v187, v95, v91, 0x4000501
	v_perm_b32 v188, v95, v91, 0x6020703
	v_perm_b32 v189, v96, v92, 0x4000501
	v_perm_b32 v190, v96, v92, 0x6020703
	v_perm_b32 v191, v97, v93, 0x4000501
	v_perm_b32 v192, v97, v93, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[90:93], v90, s[16:19], 0 offen
	buffer_load_b128 v[94:97], v94, s[16:19], 0 offen
	.loc	1 414 39 is_stmt 1              ; generate_amdgcn.py:414:39
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v193, v94, v90, 0x4000501
	v_perm_b32 v194, v94, v90, 0x6020703
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v90, s5, v57
	v_add_nc_u32_e32 v94, s5, v74
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v195, v95, v91, 0x4000501
	v_perm_b32 v196, v95, v91, 0x6020703
	v_perm_b32 v197, v96, v92, 0x4000501
	v_perm_b32 v198, v96, v92, 0x6020703
	v_perm_b32 v199, v97, v93, 0x4000501
	v_perm_b32 v200, v97, v93, 0x6020703
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_clause 0x1
	buffer_load_b128 v[90:93], v90, s[16:19], 0 offen
	buffer_load_b128 v[94:97], v94, s[16:19], 0 offen
	s_waitcnt vmcnt(0)
	v_perm_b32 v201, v94, v90, 0x4000501
	v_perm_b32 v202, v94, v90, 0x6020703
	.loc	1 414 39 is_stmt 0              ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v90, s5, v59
	v_add_nc_u32_e32 v94, s5, v58
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v203, v95, v91, 0x4000501
	v_perm_b32 v204, v95, v91, 0x6020703
	v_perm_b32 v205, v96, v92, 0x4000501
	v_perm_b32 v206, v96, v92, 0x6020703
	v_perm_b32 v207, v97, v93, 0x4000501
	v_perm_b32 v208, v97, v93, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[90:93], v90, s[16:19], 0 offen
	buffer_load_b128 v[94:97], v94, s[16:19], 0 offen
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b64 v66, v[102:103] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v102, v193, v185, 0x5040100
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v209, v94, v90, 0x4000501
	v_perm_b32 v90, v94, v90, 0x6020703
	v_perm_b32 v94, v95, v91, 0x4000501
	v_perm_b32 v91, v95, v91, 0x6020703
	v_perm_b32 v95, v96, v92, 0x4000501
	v_perm_b32 v92, v96, v92, 0x6020703
	v_perm_b32 v96, v97, v93, 0x4000501
	v_perm_b32 v93, v97, v93, 0x6020703
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v97, v193, v185, 0x7060302
	ds_store_2addr_b32 v67, v97, v102 offset1:16
	v_perm_b32 v97, v194, v186, 0x7060302
	v_perm_b32 v102, v194, v186, 0x5040100
	ds_store_2addr_b32 v68, v97, v102 offset1:16
	v_perm_b32 v97, v195, v187, 0x7060302
	v_perm_b32 v102, v195, v187, 0x5040100
	ds_store_2addr_b32 v69, v97, v102 offset1:16
	v_perm_b32 v97, v196, v188, 0x7060302
	v_perm_b32 v102, v196, v188, 0x5040100
	ds_store_2addr_b32 v70, v97, v102 offset1:16
	v_perm_b32 v97, v197, v189, 0x7060302
	v_perm_b32 v102, v197, v189, 0x5040100
	ds_store_2addr_b32 v71, v97, v102 offset1:16
	v_perm_b32 v97, v198, v190, 0x7060302
	v_perm_b32 v102, v198, v190, 0x5040100
	ds_store_2addr_b32 v67, v97, v102 offset0:160 offset1:176
	v_perm_b32 v97, v199, v191, 0x7060302
	v_perm_b32 v102, v199, v191, 0x5040100
	ds_store_2addr_b32 v72, v97, v102 offset1:16
	v_perm_b32 v97, v200, v192, 0x7060302
	v_perm_b32 v102, v200, v192, 0x5040100
	ds_store_2addr_b32 v73, v97, v102 offset1:16
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v97, v209, v201, 0x7060302
	v_perm_b32 v102, v209, v201, 0x5040100
	ds_store_2addr_b32 v83, v97, v102 offset1:16
	v_perm_b32 v97, v90, v202, 0x7060302
	v_perm_b32 v90, v90, v202, 0x5040100
	ds_store_2addr_b32 v84, v97, v90 offset1:16
	v_perm_b32 v90, v94, v203, 0x7060302
	v_perm_b32 v94, v94, v203, 0x5040100
	ds_store_2addr_b32 v85, v90, v94 offset1:16
	v_perm_b32 v90, v91, v204, 0x7060302
	v_perm_b32 v91, v91, v204, 0x5040100
	v_perm_b32 v94, v96, v207, 0x5040100
	ds_store_2addr_b32 v86, v90, v91 offset1:16
	v_perm_b32 v90, v95, v205, 0x7060302
	v_perm_b32 v91, v95, v205, 0x5040100
	v_perm_b32 v95, v93, v208, 0x7060302
	v_perm_b32 v93, v93, v208, 0x5040100
	ds_store_2addr_b32 v87, v90, v91 offset1:16
	v_perm_b32 v90, v92, v206, 0x7060302
	v_perm_b32 v91, v92, v206, 0x5040100
	v_perm_b32 v92, v96, v207, 0x7060302
	ds_store_2addr_b32 v83, v90, v91 offset0:160 offset1:176
	ds_store_2addr_b32 v88, v92, v94 offset1:16
	ds_store_2addr_b32 v89, v95, v93 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v2, v64 :: v_dual_mov_b32 v109, v61
