	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v15, v16 :: v_dual_lshlrev_b32 v18, 3, v20
...
.Ltmp11:
	...
	v_mad_u64_u32 v[1:2], null, s16, v26, v[17:18]
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	v_mad_u64_u32 v[2:3], null, s17, v26, v[18:19]
	.loc	1 121 13                        ; generate_amdgcn.py:121:13
	...
	v_dual_mov_b32 v13, v16 :: v_dual_lshlrev_b32 v22, 1, v0
	v_mov_b32_e32 v14, v16
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	s_mul_i32 s7, s7, s6
	v_dual_mov_b32 v12, v16 :: v_dual_add_nc_u32 v23, 0, v22
	s_mul_hi_u32 s7, s6, s7
	v_dual_mov_b32 v11, v16 :: v_dual_add_nc_u32 v24, 0, v19
	s_add_i32 s6, s6, s7
	...
	v_dual_mov_b32 v9, v16 :: v_dual_add_nc_u32 v22, 0, v20
	...
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cmpk_lt_i32 s23, 0x82
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	s_waitcnt vmcnt(1)
	ds_store_b16 v23, v25 offset:2048
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v24, v[27:28]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cbranch_scc1 .LBB0_3
; %bb.1:                                ; %.lr.ph
	s_add_i32 s19, s19, 64
	v_sub_nc_u32_e32 v25, s22, v26
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v2, s19, v26
.Ltmp12:
...
.Ltmp15:
	...
	v_dual_mov_b32 v2, v1 :: v_dual_add_nc_u32 v3, 0, v21
	s_lshl_b32 s15, s20, 7
	v_mov_b32_e32 v7, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_readfirstlane_b32 s21, v5
	v_add3_u32 v4, v4, s14, v18
	v_add_nc_u32_e32 v26, v3, v20
	v_mov_b32_e32 v3, v1
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 136 23                        ; generate_amdgcn.py:136:23
	v_cmp_lt_i32_e32 vcc_lo, s19, v25
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_add_i32 s21, s21, -1
	s_add_i32 s19, s19, 64
	s_cmp_lg_u32 s21, 0
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	v_dual_cndmask_b32 v27, 0x80000000, v17 :: v_dual_cndmask_b32 v28, 0x80000000, v18
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v17, s16, v17
	v_add_nc_u32_e32 v18, s20, v18
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	buffer_load_u16 v41, v27, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	buffer_load_b64 v[27:28], v28, s[12:15], 0 offen
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v29, v22 offset:2208
	ds_load_u8 v30, v22 offset:2176
	ds_load_u8 v31, v22 offset:2272
	ds_load_u8 v32, v22 offset:2240
	ds_load_u8 v33, v22 offset:2144
	ds_load_u8 v34, v22 offset:2112
	ds_load_u8 v35, v22 offset:2048
	ds_load_u8 v36, v22 offset:2064
	ds_load_u8 v37, v22 offset:2080
	ds_load_u8 v38, v22 offset:2160
	ds_load_u8 v39, v22 offset:2128
	ds_load_u8 v40, v22 offset:2096
	ds_load_u8 v42, v26 offset:640
	ds_load_u8 v43, v26 offset:896
	ds_load_u8 v44, v26 offset:768
	ds_load_u8 v45, v26 offset:512
	ds_load_u8 v46, v26 offset:128
	ds_load_u8 v47, v26 offset:384
	ds_load_u8 v48, v26 offset:256
	ds_load_u8 v49, v26
	ds_load_u8 v50, v22 offset:2464
	ds_load_u8 v51, v22 offset:2432
	ds_load_u8 v52, v22 offset:2528
	ds_load_u8 v53, v22 offset:2496
	ds_load_u8 v54, v22 offset:2336
	ds_load_u8 v55, v22 offset:2304
	ds_load_u8 v56, v22 offset:2400
	ds_load_u8 v57, v22 offset:2368
	ds_load_u8 v58, v26 offset:1664
	ds_load_u8 v59, v26 offset:1920
	ds_load_u8 v60, v26 offset:1792
	ds_load_u8 v61, v26 offset:1536
	ds_load_u8 v62, v26 offset:1152
	ds_load_u8 v63, v26 offset:1408
	ds_load_u8 v64, v26 offset:1280
	ds_load_u8 v65, v26 offset:1024
	ds_load_u8 v66, v22 offset:2288
	ds_load_u8 v67, v22 offset:2256
	ds_load_u8 v68, v22 offset:2224
	ds_load_u8 v69, v22 offset:2192
	ds_load_u8 v70, v22 offset:2544
	ds_load_u8 v71, v22 offset:2512
	ds_load_u8 v72, v22 offset:2480
	ds_load_u8 v73, v22 offset:2448
	ds_load_u8 v74, v22 offset:2416
	ds_load_u8 v75, v22 offset:2384
	ds_load_u8 v76, v22 offset:2352
	ds_load_u8 v77, v22 offset:2320
	...
	v_perm_b32 v35, v49, v46, 0xc0c0004
	...
	v_perm_b32 v40, v36, v40, 0xc0c0004
	...
	v_perm_b32 v53, v71, v70, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	v_lshl_or_b32 v34, v43, 16, v42
	v_lshl_or_b32 v33, v45, 16, v44
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v23, v41 offset:2048
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v24, v[27:28]
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_wmma_i32_16x16x16_iu4 v[1:8], v[35:36], v[33:34], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[35:36], v[39:40], v[9:16] neg_lo:[1,1,0]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	s_mov_b32 s4, s10
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_and_b32_e32 v12, 0x380, v19
	v_xor_b32_e32 v0, v0, v8
	v_lshlrev_b32_e32 v10, 6, v10
	v_and_b32_e32 v19, 0x440, v29
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v14, s17, v30
	.loc	1 168 15                        ; generate_amdgcn.py:168:15
	v_cvt_f32_i32_e32 v13, v13
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_lshl_or_b32 v0, v6, 10, v0
	.loc	1 168 15                        ; generate_amdgcn.py:168:15
	...
	v_xad_u32 v37, v0, 8, 0
	v_xad_u32 v38, v0, 16, 0
	v_xad_u32 v39, v0, 24, 0
	v_xad_u32 v40, v0, 32, 0
	v_xad_u32 v41, v0, 40, 0
	v_xad_u32 v42, v0, 48, 0
	v_xad_u32 v43, v0, 56, 0
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	s_add_i32 s3, s3, s2
	.loc	1 168 15                        ; generate_amdgcn.py:168:15
	...
	s_lshl_b32 s13, s17, 4
	s_mul_i32 s14, s17, 18
	s_mul_i32 s15, s17, 20
	.loc	1 247 9 is_stmt 0               ; generate_amdgcn.py:247:9
	s_and_b32 s1, s1, 0xffff
	s_mov_b32 s2, s6
	s_mov_b32 s3, s7
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	s_mul_i32 s16, s17, 22
	s_mul_i32 s18, s17, 24
	s_mul_i32 s19, s17, 26
	s_mul_i32 s20, s17, 28
	s_mul_i32 s21, s17, 30
	...
	v_xad_u32 v45, 0x808, v6, 0
	v_xad_u32 v46, 0x1010, v6, 0
	v_xad_u32 v47, 0x1818, v6, 0
	v_xad_u32 v48, 0x2020, v6, 0
	v_xad_u32 v49, 0x2828, v6, 0
	v_xad_u32 v50, 0x3030, v6, 0
	v_xad_u32 v51, 0x3838, v6, 0
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
	s_waitcnt vmcnt(8)
	...
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v54, v6, v10 :: v_dual_lshlrev_b32 v21, 16, v27
	v_mul_f32_e32 v26, v0, v17
	v_dual_mul_f32 v52, v0, v20 :: v_dual_mul_f32 v17, v6, v17
	v_dual_mul_f32 v20, v6, v20 :: v_dual_mul_f32 v23, v0, v10
	v_dual_mul_f32 v25, v0, v14 :: v_dual_lshlrev_b32 v28, 2, v19
	v_mul_f32_e32 v27, v0, v18
	v_mul_f32_e32 v53, v0, v21
	.loc	1 171 9 is_stmt 0               ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v0, v22, v1 :: v_dual_mul_f32 v1, v8, v4
	v_dual_mul_f32 v4, v24, v3 :: v_dual_mul_f32 v3, v54, v9
	...
	v_dual_mul_f32 v21, v6, v21 :: v_dual_mul_f32 v2, v23, v2
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v8, v26, v5 :: v_dual_mul_f32 v5, v55, v11
	v_mul_f32_e32 v6, v25, v31
	v_mul_f32_e32 v12, v52, v7
	v_dual_mul_f32 v7, v56, v34 :: v_dual_mul_f32 v10, v27, v32
	v_dual_mul_f32 v14, v53, v33 :: v_dual_mul_f32 v11, v18, v35
	v_mul_f32_e32 v15, v21, v16
	ds_store_b64 v36, v[0:1]
	ds_store_b64 v37, v[2:3]
	ds_store_b64 v38, v[4:5]
	ds_store_b64 v39, v[6:7]
	ds_store_b64 v40, v[8:9]
	...
	v_add_lshl_u32 v26, v19, s18, 2
	v_add_lshl_u32 v27, v19, s19, 2
	v_add_lshl_u32 v31, v19, s20, 2
	v_add_lshl_u32 v0, v19, s21, 2
	s_clause 0x4
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_vgpr, 78
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.numbered_sgpr, 26
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     28
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.kd
