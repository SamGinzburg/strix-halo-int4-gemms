...
; %bb.5:                                ; %.lr.ph
	...
	v_cndmask_b32_e64 v45, 0x1054, v3, s6
	v_cndmask_b32_e64 v46, 0x3276, v4, s6
	...
	v_and_b32_e32 v44, 24, v1
	v_dual_mov_b32 v26, v25 :: v_dual_lshlrev_b32 v43, 4, v35
	...
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v47, 1, v51
	...
	v_dual_mov_b32 v35, v33 :: v_dual_add_nc_u32 v46, 0, v43
	...
	s_sub_i32 s13, s9, s7
	s_cmp_ge_u32 s9, s7
	v_dual_mov_b32 v39, v33 :: v_dual_and_b32 v44, 0x540054, v44
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v45, 0x760076, v45
	.loc	1 742 27                        ; attention.py:742:27
	s_waitcnt lgkmcnt(0)
	s_mul_f32 s28, s8, 0x3fb8aa3b
	.loc	1 569 19                        ; attention.py:569:19
	...
	s_sub_i32 s3, s7, s3
	.loc	1 771 51                        ; attention.py:771:51
	v_or_b32_e32 v79, 4, v0
	v_or_b32_e32 v80, 6, v0
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s0, s34, v51
	.loc	1 571 21                        ; attention.py:571:21
	v_or_b32_e32 v81, 2, v74
	v_or_b32_e32 v82, 4, v74
	v_or_b32_e32 v83, 6, v74
	v_or_b32_e32 v84, 8, v74
	v_or_b32_e32 v85, 10, v74
	v_or_b32_e32 v86, 12, v74
	v_or_b32_e32 v87, 14, v74
	v_mov_b32_e32 v40, v33
	v_subrev_nc_u32_e32 v88, s45, v75
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v89, s46, v75
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v94, 0, v94
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v96, 0, v96
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v98, 0x7060706, v43
	v_mov_b32_e32 v19, v25
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v95, 0, v95
	v_mov_b32_e32 v21, v25
	v_dual_mov_b32 v22, v25 :: v_dual_and_b32 v97, 0x5040504, v42
	...
	.loc	1 707 13                        ; attention.py:707:13
	v_lshl_add_u32 v91, s34, 1, v52
	v_lshl_add_u32 v92, s34, 2, v52
	v_mov_b32_e32 v102, v25
	.loc	1 772 39                        ; attention.py:772:39
	s_lshl_b32 s49, s1, 3
	s_and_b32 s27, s27, 0xffff
	.loc	1 710 33                        ; attention.py:710:33
	s_add_i32 s52, s3, s10
	s_mov_b32 s36, s22
	s_mov_b32 s22, s38
	s_mov_b32 s44, s26
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v10, v25 :: v_dual_mov_b32 v101, v76
...
.LBB0_6:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cmp_gt_i32_e32 vcc_lo, s49, v105
	.loc	1 797 41                        ; attention.py:797:41
	v_add_lshl_u32 v109, s7, v51, 1
	.loc	1 732 30                        ; attention.py:732:30
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v41, v76, v41 :: v_dual_mul_f32 v42, v99, v42
	...
	.loc	1 775 32                        ; attention.py:775:32
	s_clause 0x3
	buffer_load_u8 v109, v106, s[36:39], 0 offen
	buffer_load_u8 v106, v107, s[36:39], 0 offen
	buffer_load_u8 v107, v108, s[36:39], 0 offen
	buffer_load_u8 v108, v111, s[36:39], 0 offen
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v44, v101, v44 :: v_dual_mul_f32 v45, v76, v45
	.loc	1 727 37                        ; attention.py:727:37
	...
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v47, s30, v47 :: v_dual_mul_f32 v44, s48, v44
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v41, 0xff800000, v41, s57
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v48, s48, v48 :: v_dual_mul_f32 v45, s28, v45
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v47, 0xff800000, v47, s61
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v44, 0xff800000, v44, s54
	v_cndmask_b32_e64 v43, 0xff800000, v43, s59
	v_cndmask_b32_e64 v48, 0xff800000, v48, s60
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v46, s29, v46
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v104, 0xff800000, v42, s55
	v_cndmask_b32_e64 v45, 0xff800000, v45, s58
...
.Ltmp9:
	...
	v_permlanex16_b32 v124, v42, s53, 0xfedcba98 op_sel:[1,0]
.Ltmp10:
	.loc	1 816 30                        ; attention.py:816:30
	...
	v_cmp_gt_i32_e64 s12, s31, v105
	.loc	1 771 36 is_stmt 1              ; attention.py:771:36
	v_or_b32_e32 v120, s1, v80
	.loc	1 782 31                        ; attention.py:782:31
	...
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v103, 0, v104, s55
	v_cndmask_b32_e64 v104, 0, v127, s59
	.loc	1 815 23                        ; attention.py:815:23
	v_mul_f32_e32 v9, v9, v43
	s_delay_alu instid0(TRANS32_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v44, 0, v44, s54
	v_cndmask_b32_e64 v45, 0, v45, s58
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v117.l, v103.h
	s_delay_alu instid0(TRANS32_DEP_1)
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v46, 0, v46, s56
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp12:
	...
	v_cndmask_b32_e64 v48, 0, v48, s60
	.loc	1 815 23                        ; attention.py:815:23
...
.Ltmp14:
	...
	v_cndmask_b32_e64 v105, 0, v111, s12
	.loc	1 782 30                        ; attention.py:782:30
	v_cmp_gt_i32_e64 s12, s31, v118
	.loc	1 783 76                        ; attention.py:783:76
	...
	.loc	1 783 32                        ; attention.py:783:32
	v_cndmask_b32_e64 v107, 0, v112, s12
	.loc	1 782 30                        ; attention.py:782:30
	...
	.loc	1 783 32                        ; attention.py:783:32
	v_cndmask_b32_e64 v108, 0, v115, s12
	.loc	1 782 30                        ; attention.py:782:30
	...
	v_cndmask_b32_e64 v46, v46, v106, s12
	.loc	1 786 38                        ; attention.py:786:38
	...
	v_cvt_f32_i32_e32 v46, v46
	.loc	1 786 29                        ; attention.py:786:29
	v_cndmask_b32_e64 v41, v109, v112, s12
	...
	.loc	1 786 29                        ; attention.py:786:29
	v_cndmask_b32_e64 v109, v110, v115, s12
	.loc	1 786 38 is_stmt 0              ; attention.py:786:38
	...
	v_cndmask_b32_e64 v105, v105, v106, s12
	...
	v_cndmask_b32_e64 v106, v107, v110, s12
	.loc	1 787 39 is_stmt 0              ; attention.py:787:39
	...
	.loc	1 787 30 is_stmt 1              ; attention.py:787:30
	v_cndmask_b32_e64 v107, v108, v112, s12
	.loc	1 787 39 is_stmt 0              ; attention.py:787:39
	...
	.loc	1 787 30 is_stmt 1              ; attention.py:787:30
	v_cndmask_b32_e64 v108, v111, v115, s12
	.loc	1 814 30                        ; attention.py:814:30
...
.Ltmp16:
	...
	v_cndmask_b16 v45.h, 0x7fff, v105.h, s17
	v_cndmask_b16 v44.l, 0x7fff, v109.h, s14
	v_cndmask_b16 v44.h, 0x7fff, v44.h, s15
	v_cndmask_b16 v46.l, 0x7fff, v106.h, s18
	v_cndmask_b16 v46.h, 0x7fff, v107.h, s19
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u16_d16 v105, v77 offset:512
	ds_load_u16_d16 v112, v77 offset:288
	ds_load_u16_d16 v121, v77 offset:608
	ds_load_u16_d16 v120, v77 offset:352
.Ltmp17:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_add_f32_e32 v127, v128, v129
.Ltmp18:
	.loc	1 814 30                        ; attention.py:814:30
	ds_load_u16_d16 v129, v77 offset:576
	ds_load_u16_d16 v130, v77 offset:832
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp20:
	...
	v_cndmask_b16 v47.l, 0x7fff, v104.h, s7
.Ltmp21:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
	v_permlanex16_b32 v103, v41, s53, 0xfedcba98 op_sel:[1,0]
.Ltmp22:
	.loc	1 816 30                        ; attention.py:816:30
	v_cndmask_b16 v48.l, 0x7fff, v114.h, s8
	v_cndmask_b16 v48.h, 0x7fff, v117.h, s11
...
.Ltmp24:
	.loc	1 814 30                        ; attention.py:814:30
	ds_load_u16_d16 v131, v77 offset:1088
	ds_load_u16_d16 v132, v77 offset:1344
	ds_load_u16_d16 v133, v77 offset:1600
	ds_load_u16_d16 v134, v77 offset:1856
	s_waitcnt lgkmcnt(6)
	ds_load_u16_d16_hi v120, v77 offset:480
	ds_load_u16_d16 v106, v77 offset:768
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v129, v77 offset:704
	ds_load_u16_d16 v113, v77 offset:544
	ds_load_u16_d16 v104, v77 offset:256
	ds_load_u16_d16 v128, v77 offset:320
	ds_load_u16_d16 v103, v77
	ds_load_u16_d16 v111, v77 offset:32
	ds_load_u16_d16 v127, v77 offset:64
	ds_load_u16_d16 v119, v77 offset:96
	ds_load_u16_d16 v107, v77 offset:1024
	ds_load_u16_d16 v114, v77 offset:800
	s_waitcnt lgkmcnt(16)
	ds_load_u16_d16_hi v130, v77 offset:960
	ds_load_u16_d16 v122, v77 offset:864
	ds_load_u16_d16 v108, v77 offset:1280
	ds_load_u16_d16 v115, v77 offset:1056
	s_waitcnt lgkmcnt(19)
	ds_load_u16_d16_hi v131, v77 offset:1216
	ds_load_u16_d16 v123, v77 offset:1120
	ds_load_u16_d16 v109, v77 offset:1536
	ds_load_u16_d16 v116, v77 offset:1312
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v132, v77 offset:1472
	ds_load_u16_d16 v124, v77 offset:1376
	ds_load_u16_d16 v110, v77 offset:1792
	ds_load_u16_d16 v117, v77 offset:1568
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v133, v77 offset:1728
	ds_load_u16_d16 v125, v77 offset:1632
	ds_load_u16_d16 v118, v77 offset:1824
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v134, v77 offset:1984
	ds_load_u16_d16 v126, v77 offset:1888
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v103, v77 offset:128
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v111, v77 offset:160
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v127, v77 offset:192
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v119, v77 offset:224
	ds_load_u16_d16_hi v105, v77 offset:640
	ds_load_u16_d16_hi v104, v77 offset:384
	ds_load_u16_d16_hi v112, v77 offset:416
	ds_load_u16_d16_hi v128, v77 offset:448
	ds_load_u16_d16_hi v106, v77 offset:896
	ds_load_u16_d16_hi v113, v77 offset:672
	ds_load_u16_d16_hi v121, v77 offset:736
	s_waitcnt lgkmcnt(29)
	ds_load_u16_d16_hi v107, v77 offset:1152
	s_waitcnt lgkmcnt(29)
	ds_load_u16_d16_hi v114, v77 offset:928
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v122, v77 offset:992
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v108, v77 offset:1408
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v115, v77 offset:1184
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v123, v77 offset:1248
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v109, v77 offset:1664
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v116, v77 offset:1440
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v124, v77 offset:1504
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v110, v77 offset:1920
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v117, v77 offset:1696
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v125, v77 offset:1760
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v118, v77 offset:1952
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v44, v46, s53, 0xfedcba98 op_sel:[1,0]
	.loc	1 814 30                        ; attention.py:814:30
	s_waitcnt lgkmcnt(24)
	ds_load_u16_d16_hi v126, v77 offset:2016
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v138, v47, s53, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v140, v48, s53, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v142, v45, s53, 0xfedcba98 op_sel:[1,0]
...
.LBB0_7:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v110, s42, v85
	v_or_b32_e32 v111, s42, v86
	v_or_b32_e32 v119, s42, v87
	.loc	1 714 73                        ; attention.py:714:73
	v_cmp_gt_i32_e64 s1, s31, v108
	v_cmp_gt_i32_e64 s3, s31, v107
	v_cmp_gt_i32_e64 s7, s31, v106
	v_cmp_gt_i32_e64 s11, s31, v105
	v_cmp_gt_i32_e64 s8, s31, v119
	v_cmp_gt_i32_e64 s9, s31, v111
	v_cmp_gt_i32_e64 s10, s31, v110
	v_cmp_gt_i32_e64 s12, s31, v109
	.loc	1 743 25                        ; attention.py:743:25
	s_and_b32 s57, s2, s11
	s_and_b32 s55, s2, s7
	s_and_b32 s59, s2, s3
	s_and_b32 s54, s2, s1
	s_and_b32 s58, s2, s12
	s_and_b32 s56, s2, s10
	s_and_b32 s61, s2, s9
...
; %bb.8:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cmp_le_i32_e32 vcc_lo, v105, v75
	v_cmp_le_i32_e64 s13, v106, v75
	v_cmp_le_i32_e64 s14, v107, v75
	v_cmp_le_i32_e64 s15, v108, v75
	v_cmp_le_i32_e64 s16, v109, v75
	v_cmp_le_i32_e64 s17, v110, v75
	.loc	1 746 21 is_stmt 0              ; attention.py:746:21
	s_and_b32 s27, vcc_lo, s57
	s_and_b32 s13, s13, s55
	.loc	1 746 30                        ; attention.py:746:30
	v_cmp_le_i32_e64 s18, v111, v75
	...
	s_and_b32 s17, s17, s56
	s_or_b32 s57, s57, s27
	s_or_b32 s55, s55, s13
	s_and_not1_b32 s13, s59, exec_lo
	s_and_b32 s14, s14, exec_lo
	s_and_not1_b32 s27, s54, exec_lo
	s_and_b32 s15, s15, exec_lo
	s_and_b32 s18, s18, s61
	s_and_b32 s19, s19, s60
	s_or_b32 s59, s13, s14
	s_or_b32 s54, s27, s15
	...
	s_or_b32 s61, s13, s14
	s_or_b32 s60, s15, s16
.LBB0_9:                                ;   in Loop: Header=BB0_7 Depth=1
	.loc	1 0 0                           ; attention.py:0
	v_add_lshl_u32 v104, s26, v74, 1
	...
	v_cndmask_b32_e64 v120, 0x80000000, v115, s12
	v_cndmask_b32_e64 v121, 0x80000000, v116, s10
	v_cndmask_b32_e64 v122, 0x80000000, v117, s9
	v_cndmask_b32_e64 v123, 0x80000000, v118, s8
	s_clause 0x7
...
; %bb.10:                               ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cmp_le_i32_e64 s12, v105, v89
	v_cmp_le_i32_e64 s13, v106, v89
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v107, v88
	v_cmp_ge_i32_e64 s7, v108, v88
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s14, v107, v89
	v_cmp_le_i32_e64 s15, v108, v89
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s8, v109, v88
	v_cmp_ge_i32_e64 s9, v110, v88
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s16, v109, v89
	v_cmp_le_i32_e64 s17, v110, v89
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s12, vcc_lo, s12
	s_and_b32 s1, s1, s13
	.loc	1 748 30 is_stmt 1              ; attention.py:748:30
	v_cmp_ge_i32_e64 s10, v111, v88
	v_cmp_ge_i32_e64 s11, v119, v88
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s18, v111, v89
	v_cmp_le_i32_e64 s19, v119, v89
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s7, s7, s15
	s_and_b32 s3, s3, s14
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_runtime_bfloat16_d64_dv64_shaperuntime_bm64_bn16_w4_s1_ds1.numbered_sgpr, 62
