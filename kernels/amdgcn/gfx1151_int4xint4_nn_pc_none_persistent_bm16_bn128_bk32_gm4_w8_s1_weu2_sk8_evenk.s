...
.Ltmp16:
	...
	s_sub_i32 s7, 0, s25
	v_mad_u64_u32 v[8:9], null, s21, v5, v[1:2]
	s_mul_i32 s7, s7, s6
	.loc	1 222 36                        ; generate_amdgcn.py:222:36
	...
	v_lshl_add_u32 v22, v13, 3, v22
	v_or_b32_e32 v9, s17, v13
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_mul_hi_u32 s6, s39, s41
	s_abs_i32 s41, s42
	s_add_i32 s39, s39, s6
	s_xor_b32 s6, s42, s40
	s_mul_hi_u32 s39, s41, s39
	s_ashr_i32 s6, s6, 31
	s_mul_i32 s43, s39, s7
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s41, s41, s43
	s_add_i32 s43, s39, 1
	s_sub_i32 s44, s41, s7
	s_cmp_ge_u32 s41, s7
	s_cselect_b32 s39, s43, s39
	s_cselect_b32 s41, s44, s41
	s_add_i32 s43, s39, 1
	s_cmp_ge_u32 s41, s7
	s_cselect_b32 s7, s43, s39
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
...
; %bb.3:                                ; %.lr.ph
	...
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s38, v12
	s_lshl_b32 s6, s6, 7
	s_mov_b32 s40, s34
	v_subrev_nc_u32_e32 v44, s6, v1
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[10:11], null, s1, v2, v[9:10]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v7, s6, v17
	v_or_b32_e32 v47, s6, v18
	v_or_b32_e32 v48, s6, v19
	.loc	1 242 18                        ; generate_amdgcn.py:242:18
	buffer_load_u16 v50, v0, s[16:19], 0 offen
	.loc	1 243 26                        ; generate_amdgcn.py:243:26
	v_or_b32_e32 v49, s6, v20
	v_or_b32_e32 v0, s6, v21
	...
	buffer_load_u16 v53, v0, s[8:11], 0 offen
	v_add3_u32 v0, s38, s6, v8
	...
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v48, v50, v48 :: v_dual_lshlrev_b32 v51, 16, v51
	v_dual_mul_f32 v49, v50, v49 :: v_dual_lshlrev_b32 v52, 16, v52
	...
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v5, v48, v5 :: v_dual_mul_f32 v52, v50, v52
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v6, v50, v6
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v4, v49, v4 :: v_dual_mul_f32 v47, v50, v47
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v50, v50, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v46, v51, v46 :: v_dual_mul_f32 v45, v52, v45
	v_mul_f32_e32 v6, v6, v44
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v10, v47, v10 :: v_dual_mul_f32 v3, v50, v3
	ds_store_b32 v28, v46
	ds_store_b32 v29, v45
	ds_store_b32 v30, v6
	ds_store_b32 v31, v7
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.numbered_sgpr, 45
