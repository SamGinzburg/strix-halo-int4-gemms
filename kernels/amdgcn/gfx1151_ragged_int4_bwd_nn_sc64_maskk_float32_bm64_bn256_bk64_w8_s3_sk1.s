...
; %bb.4:                                ; %.preheader.lr.ph
	...
	v_dual_mov_b32 v134, 0 :: v_dual_add_nc_u32 v7, s33, v89
	...
	v_dual_mov_b32 v126, 0 :: v_dual_add_nc_u32 v7, 16, v11
	s_sub_i32 s10, s10, s36
	v_mul_lo_u32 v11, s35, v11
	s_mul_i32 s7, s7, s10
	s_lshl_b32 s10, s36, 6
	v_mul_lo_u32 v7, s35, v7
	v_add3_u32 v2, s11, s10, v2
	...
	v_dual_mov_b32 v125, 0 :: v_dual_lshlrev_b32 v4, 1, v4
	...
	v_dual_mov_b32 v123, 0 :: v_dual_add_nc_u32 v152, 0, v1
	v_dual_mov_b32 v124, 0 :: v_dual_add_nc_u32 v153, 0, v5
	v_dual_mov_b32 v121, 0 :: v_dual_add_nc_u32 v154, 0, v8
	v_dual_mov_b32 v122, 0 :: v_dual_add_nc_u32 v155, 0, v9
	v_dual_mov_b32 v119, 0 :: v_dual_add_nc_u32 v156, 0, v10
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v157, v0, v6
	v_dual_mov_b32 v117, 0 :: v_dual_add_nc_u32 v158, 0, v4
...
.LBB0_5:                                ; %._crit_edge
	...
	v_dual_mul_f32 v53, v167, v33 :: v_dual_add_nc_u32 v148, s23, v148
	v_dual_mul_f32 v38, v183, v32 :: v_dual_add_nc_u32 v149, s23, v149
	v_dual_mul_f32 v40, v181, v32 :: v_dual_add_nc_u32 v73, 32, v73
	v_dual_mul_f32 v37, v184, v32 :: v_dual_add_nc_u32 v150, 32, v150
	v_dual_mul_f32 v55, v165, v33 :: v_dual_add_nc_u32 v160, 32, v160
	v_dual_mul_f32 v42, v179, v32 :: v_dual_add_nc_u32 v151, 32, v151
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 240
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 51
