...
.Ltmp0:
	...
	.loc	1 584 26                        ; attention.py:584:26
	v_or_b32_e32 v2, s11, v33
	.loc	1 570 21 is_stmt 1              ; attention.py:570:21
	v_or_b32_e32 v15, s5, v33
	...
	s_add_i32 s2, s5, s7
	.loc	1 585 26                        ; attention.py:585:26
	buffer_load_b128 v[17:20], v2, s[12:15], 0 offen
	v_and_or_b32 v8, v6, 30, v4
	.loc	1 570 31                        ; attention.py:570:31
	...
	s_min_i32 s12, s9, 0x200
	.loc	1 613 39                        ; attention.py:613:39
	s_add_i32 s13, s13, s10
	.loc	1 619 35                        ; attention.py:619:35
	s_add_i32 s12, s12, 15
	.loc	1 585 26                        ; attention.py:585:26
	...
	s_and_b32 s35, s13, 0x7ffffff0
	.loc	1 619 33                        ; attention.py:619:33
	s_and_b32 s48, s12, -16
	s_mov_b32 s12, 0
	...
	ds_bpermute_b32 v9, v60, v19
	ds_bpermute_b32 v11, v60, v20
	ds_bpermute_b32 v10, v62, v17
	ds_bpermute_b32 v12, v62, v18
	ds_bpermute_b32 v13, v62, v19
	ds_bpermute_b32 v14, v62, v20
	.loc	1 707 13                        ; attention.py:707:13
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_cndmask_b32_e64 v17, 0x1054, v17, s9
	v_cndmask_b32_e64 v18, 0x3276, v18, s9
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v57, 0x5040504, v17
	v_and_b32_e32 v58, 0x7060706, v18
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_3:                                ; %Flow
	...
	v_or_b32_e32 v61, s11, v16
	s_and_not1_b32 vcc_lo, exec_lo, s12
	s_cbranch_vccnz .LBB0_22
; %bb.4:                                ; %.lr.ph
	s_load_b256 s[12:19], s[0:1], 0x8
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v17, 0x6420 :: v_dual_lshlrev_b32 v16, 1, v61
	...
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v46, v9, v13, s9
	v_cndmask_b32_e64 v48, v7, v10, s9
	v_cndmask_b32_e64 v50, v13, v9, s9
	v_cndmask_b32_e64 v52, v10, v7, s9
	v_dual_mov_b32 v9, 0x5410 :: v_dual_and_b32 v6, 24, v6
	v_or_b32_e32 v64, s8, v4
	v_mov_b32_e32 v4, 0x7531
	v_dual_mov_b32 v10, 0x7632 :: v_dual_add_nc_u32 v15, s10, v15
	v_mov_b32_e32 v32, 0
	...
	.loc	1 585 26                        ; attention.py:585:26
	v_cndmask_b32_e64 v49, v8, v12, s9
	v_cndmask_b32_e64 v53, v12, v8, s9
	v_lshrrev_b32_e32 v5, 2, v5
	v_dual_mov_b32 v105, 0xff800000 :: v_dual_lshlrev_b32 v12, 5, v0
	v_dual_mov_b32 v78, 0 :: v_dual_cndmask_b32 v39, 0x6420, v4
	v_dual_cndmask_b32 v38, 0x7531, v17 :: v_dual_mov_b32 v29, v32
	v_cndmask_b32_e64 v40, 0x1054, v9, s9
	v_cndmask_b32_e64 v41, 0x3276, v10, s9
	v_dual_mov_b32 v25, v32 :: v_dual_and_b32 v18, 0x70, v0
	v_cndmask_b32_e64 v47, v11, v14, s9
	v_cndmask_b32_e64 v51, v14, v11, s9
	v_dual_mov_b32 v16, 0 :: v_dual_lshlrev_b32 v11, 7, v0
	v_bfe_i32 v35, v0, 2, 1
	v_xor_b32_e32 v36, v3, v5
	v_lshl_or_b32 v37, v2, 5, v6
	v_dual_mov_b32 v26, v32 :: v_dual_and_b32 v55, 0x160, v12
	...
	v_dual_mov_b32 v17, v32 :: v_dual_and_b32 v42, 0x700, v11
	v_lshrrev_b32_e32 v43, 2, v18
	v_cndmask_b32_e64 v44, 0x90, 0, vcc_lo
	v_dual_mov_b32 v28, v32 :: v_dual_add_nc_u32 v87, 0, v37
	v_mov_b32_e32 v30, v32
	v_mov_b32_e32 v18, v32
	v_dual_mov_b32 v21, v32 :: v_dual_add_nc_u32 v86, 0, v36
	v_dual_mov_b32 v23, v32 :: v_dual_and_b32 v36, 0x750031, v39
	v_mov_b32_e32 v9, v32
	v_xor_b32_e32 v56, 8, v37
	v_xor_b32_e32 v57, 16, v37
	v_xor_b32_e32 v58, 24, v37
	v_and_or_b32 v85, 0x90, v35, v55
	v_and_b32_e32 v35, 0x750031, v38
	...
	v_or_b32_e32 v65, 1, v63
	v_or_b32_e32 v66, 2, v63
	v_or_b32_e32 v67, 3, v63
	v_or_b32_e32 v68, 4, v63
	v_or_b32_e32 v69, 5, v63
	v_or_b32_e32 v70, 6, v63
	v_or_b32_e32 v71, 7, v63
	v_dual_mov_b32 v27, v32 :: v_dual_and_b32 v54, 28, v3
	.loc	1 748 47                        ; attention.py:748:47
	v_subrev_nc_u32_e32 v72, s6, v15
	v_dual_mov_b32 v31, v32 :: v_dual_lshlrev_b32 v76, 2, v1
	v_lshl_or_b32 v77, s3, 8, v19
	v_dual_mov_b32 v19, v32 :: v_dual_add_nc_u32 v42, 0, v42
	.loc	1 567 22                        ; attention.py:567:22
	s_and_b32 s6, s1, -8
	v_xor_b32_e32 v43, v44, v43
	v_xor_b32_e32 v39, 16, v85
	...
	s_lshl_b32 s49, s3, 5
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v73, s7, v15
	.loc	1 566 23                        ; attention.py:566:23
	s_ashr_i32 s7, s1, 3
	.loc	1 567 22                        ; attention.py:567:22
	s_sub_i32 s3, s3, s6
	...
	s_mul_i32 s3, s22, s3
	v_dual_mov_b32 v107, 0xff800000 :: v_dual_mov_b32 v8, 0
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s0, s33, v45
	v_or_b32_e32 v74, s8, v7
	v_or_b32_e32 v75, 2, v64
	v_dual_mov_b32 v20, v32 :: v_dual_add_nc_u32 v89, 0, v56
	v_dual_mov_b32 v22, v32 :: v_dual_add_nc_u32 v91, 0, v58
	v_dual_mov_b32 v10, v32 :: v_dual_add_nc_u32 v93, 0, v39
	v_dual_mov_b32 v11, v32 :: v_dual_add_nc_u32 v90, 0, v57
	v_dual_mov_b32 v12, v32 :: v_dual_and_b32 v95, 0x7050301, v36
	v_dual_mov_b32 v13, v32 :: v_dual_add_nc_u32 v92, v42, v43
	v_dual_mov_b32 v14, v32 :: v_dual_and_b32 v57, 0x5040504, v37
	v_dual_mov_b32 v15, v32 :: v_dual_and_b32 v94, 0x7050301, v35
	v_dual_mov_b32 v1, v32 :: v_dual_and_b32 v58, 0x7060706, v38
	v_dual_mov_b32 v2, v32 :: v_dual_add_nc_u32 v97, v33, v66
	v_dual_mov_b32 v3, v32 :: v_dual_add_nc_u32 v96, v33, v65
	v_dual_mov_b32 v4, v32 :: v_dual_add_nc_u32 v99, v33, v68
	v_dual_mov_b32 v5, v32 :: v_dual_add_nc_u32 v98, v33, v67
	v_dual_mov_b32 v6, v32 :: v_dual_add_nc_u32 v101, v33, v70
	v_dual_mov_b32 v7, v32 :: v_dual_add_nc_u32 v100, v33, v69
	v_or_b32_e32 v79, 4, v64
	v_or_b32_e32 v80, 6, v64
	v_or_b32_e32 v81, 8, v64
	v_or_b32_e32 v82, 10, v64
	v_or_b32_e32 v83, 12, v64
	v_or_b32_e32 v84, 14, v64
	.loc	1 714 31                        ; attention.py:714:31
	v_cmp_gt_i32_e64 s1, s34, v54
	v_xor_b32_e32 v88, 64, v76
	.loc	1 707 13                        ; attention.py:707:13
	v_add_nc_u32_e32 v102, v33, v71
	v_dual_mov_b32 v106, 0xff800000 :: v_dual_add_nc_u32 v103, v33, v63
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v39, v39, v42 :: v_dual_mul_f32 v40, s51, v40
	v_dual_mul_f32 v117, v104, v117 :: v_dual_mul_f32 v42, v113, v44
	v_mul_f32_e32 v114, v104, v115
	.loc	1 759 25                        ; attention.py:759:25
	v_perm_b32 v115, v38, v107, v94
	v_perm_b32 v38, v38, v107, v95
	.loc	1 727 37                        ; attention.py:727:37
	v_mov_b16_e32 v112.l, v41.l
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v37, v104, v37 :: v_dual_mul_f32 v42, s51, v42
	.loc	1 759 25                        ; attention.py:759:25
	...
	s_waitcnt lgkmcnt(0)
	.loc	1 759 25                        ; attention.py:759:25
	v_cndmask_b32_e64 v109, v38, v107, s9
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v35, v35, v111
	.loc	1 759 25                        ; attention.py:759:25
	v_cndmask_b32_e64 v38, v107, v38, s9
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v39, s51, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v43, s51, v43 :: v_dual_and_b32 v110, 0x100, v109
	v_dual_mul_f32 v35, s51, v35 :: v_dual_and_b32 v114, 0x1000000, v109
	...
	v_cndmask_b32_e64 v122, v36, v42, s9
	.loc	1 759 25                        ; attention.py:759:25
	v_cmp_eq_u32_e64 s8, 1, v111
	v_cmp_eq_u32_e64 s20, 0, v38
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v38, 0xff800000, v44, s17
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v37, s51, v37
	.loc	1 764 26                        ; attention.py:764:26
	ds_bpermute_b32 v122, v76, v122
	...
	v_cndmask_b32_e64 v123, v42, v36, s9
	v_cndmask_b32_e64 v35, v43, v38, s9
.Ltmp1:
...
.Ltmp2:
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v109, v37, v39, s9
	v_cndmask_b32_e64 v110, v39, v37, s9
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v113, v42, v43, v37
.Ltmp4:
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v114, v44, v40, s9
	v_cndmask_b32_e64 v117, v40, v44, s9
	v_cndmask_b32_e64 v107, v38, v43, s9
	ds_bpermute_b32 v109, v76, v109
	ds_bpermute_b32 v110, v88, v110
	ds_bpermute_b32 v124, v76, v35
	.loc	1 814 30                        ; attention.py:814:30
	s_barrier
	.loc	1 764 26                        ; attention.py:764:26
	ds_bpermute_b32 v107, v88, v107
.Ltmp5:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	s_waitcnt lgkmcnt(4)
...
.Ltmp6:
	.loc	1 764 26                        ; attention.py:764:26
	ds_bpermute_b32 v112, v76, v114
	ds_bpermute_b32 v113, v88, v117
	ds_bpermute_b32 v114, v88, v123
	.loc	1 814 30                        ; attention.py:814:30
	v_mov_b16_e32 v123.h, v41.l
.Ltmp7:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
	v_permlanex16_b32 v117, v111, s50, 0xfedcba98 op_sel:[1,0]
.Ltmp8:
	.loc	1 707 13                        ; attention.py:707:13
...
.Ltmp20:
	...
	v_cndmask_b32_e64 v134, 0, v38, s17
.Ltmp21:
	.loc	2 170 12 is_stmt 1              ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
...
.Ltmp36:
	...
	v_dual_fmac_f32 v33, v78, v106 :: v_dual_and_b32 v110, 1, v117
	.loc	1 814 30                        ; attention.py:814:30
	...
	v_dual_mov_b32 v78, v33 :: v_dual_and_b32 v109, 1, v121
	...
	v_cndmask_b16 v40.h, 0x7fff, v34.h, s10
	v_cndmask_b16 v40.l, 0x7fff, v37.h, s11
	v_cndmask_b16 v34.h, 0x7fff, v38.h, s12
	...
	.loc	1 814 30                        ; attention.py:814:30
	ds_store_2addr_b32 v92, v42, v40 offset1:8
	ds_store_2addr_b32 v92, v34, v37 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[36:39], v120
	ds_load_b128 v[108:111], v120 offset:512
	ds_load_b128 v[40:43], v93
	ds_load_b128 v[112:115], v93 offset:512
	ds_load_b128 v[116:119], v120 offset:1024
	ds_load_b128 v[124:127], v120 offset:1536
	ds_load_b128 v[120:123], v93 offset:1024
	ds_load_b128 v[128:131], v93 offset:1536
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v133, v55, s50, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v34, v135, s50, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v137, v44, s50, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v139, v56, s50, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4)
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[41:42], v87
	ds_load_b64 v[43:44], v89
	ds_load_b64 v[55:56], v90
	ds_load_b64 v[108:109], v91
	.loc	1 717 33                        ; attention.py:717:33
...
.LBB0_8:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_or_b32_e32 v42, s35, v65
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v42, v72
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v42, v73
...
.LBB0_10:                               ;   in Loop: Header=BB0_6 Depth=1
	...
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v43, v72
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v43, v73
...
.LBB0_14:                               ;   in Loop: Header=BB0_6 Depth=1
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v44, v72
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v44, v73
...
.LBB0_18:                               ;   in Loop: Header=BB0_6 Depth=1
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v55, v72
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v55, v73
...
.LBB0_23:                               ; %._crit_edge
	...
	v_cndmask_b32_e64 v4, v16, v25, s9
	v_cndmask_b32_e64 v5, v25, v16, s9
	v_cndmask_b32_e64 v16, v0, v9, s9
	v_cndmask_b32_e64 v0, v9, v0, s9
	v_cndmask_b32_e64 v3, v24, v26, s9
	v_cndmask_b32_e64 v6, v19, v17, s9
	v_cndmask_b32_e64 v7, v17, v19, s9
	v_cndmask_b32_e64 v10, v8, v18, s9
	v_cndmask_b32_e64 v8, v18, v8, s9
	v_cndmask_b32_e64 v15, v14, v11, s9
	v_cndmask_b32_e64 v11, v11, v14, s9
	v_cndmask_b32_e64 v14, v12, v22, s9
	v_cndmask_b32_e64 v12, v22, v12, s9
	v_cndmask_b32_e64 v17, v2, v13, s9
	v_cndmask_b32_e64 v2, v13, v2, s9
	s_mov_b32 s3, 0x76543210
	v_cndmask_b32_e64 v1, v26, v24, s9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 141
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 52
