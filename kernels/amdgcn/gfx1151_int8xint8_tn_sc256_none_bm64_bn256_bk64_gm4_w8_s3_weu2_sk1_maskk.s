...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v79, v239, s16, 1
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cvt_f32_i32_e32 v73, v80
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v80, v240, s16, 1
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v238, 0 :: v_dual_mov_b32 v151, 0
	v_dual_mov_b32 v152, 0 :: v_dual_mov_b32 v241, 0
...
.LBB0_10:
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v3, v239, s0, 1
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v2, 0x80000000, v2
	v_add_lshl_u32 v4, v240, s0, 1
...
; %bb.11:
	...
	scratch_store_b32 off, v152, off offset:8
	...
	scratch_store_b32 off, v151, off offset:16
	...
	v_dual_mov_b32 v210, v206 :: v_dual_mov_b32 v225, v221
	v_dual_mov_b32 v206, v202 :: v_dual_mov_b32 v221, v217
	v_dual_mov_b32 v202, v198 :: v_dual_mov_b32 v217, v213
	v_dual_mov_b32 v198, v194 :: v_dual_mov_b32 v213, v209
	v_dual_mov_b32 v209, v205 :: v_dual_mov_b32 v64, v192
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mov_b32 v215, v219 :: v_dual_mov_b32 v192, v64
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	ds_load_u8 v57, v57
...
.LBB0_12:
	...
	s_mul_i32 s1, s0, s27
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v64, v155, s0, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v81, v154, s1, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 s1, -1, 0
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v82, v239, s0, 1
	v_add_lshl_u32 v83, v240, s0, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_fma_f32 v93, v93, v152, v182
	v_fma_f32 v94, v94, v151, v181
	...
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v105, v78, v64 :: v_dual_lshlrev_b32 v82, 16, v82
	...
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v172, v78, v64 :: v_dual_lshlrev_b32 v83, 16, v83
	...
	v_dual_mul_f32 v162, v75, v85 :: v_dual_mul_f32 v193, v76, v83
	...
	v_dual_mul_f32 v180, v78, v82 :: v_dual_mul_f32 v181, v64, v83
	...
	v_mul_lo_u32 v6, s27, v117
	v_add3_u32 v2, s35, s34, v86
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add_nc_u32_e32 v5, s49, v6
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_permlanex16_b32 v0, v0, s0, 0xfedcba98 op_sel:[1,0]
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add_nc_u32_e32 v4, s48, v6
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	buffer_store_b128 v[11:14], v6, s[24:27], 0 offen offset:256
	...
	buffer_store_b128 v[27:30], v4, s[24:27], 0 offen
	buffer_store_b128 v[31:34], v2, s[24:27], 0 offen
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 44
