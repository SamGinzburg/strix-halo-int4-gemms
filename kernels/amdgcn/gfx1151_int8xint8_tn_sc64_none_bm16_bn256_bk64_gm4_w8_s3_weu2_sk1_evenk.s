	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v6, 0x80000000, v20, s2
	s_clause 0x3
	buffer_load_b128 v[2:5], v2, s[4:7], 0 offen
	buffer_load_b128 v[12:15], v7, s[4:7], 0 offen
	buffer_load_b128 v[22:25], v8, s[4:7], 0 offen
	buffer_load_b128 v[26:29], v19, s[4:7], 0 offen
	v_cndmask_b32_e64 v7, 0x80000000, v30, s2
	v_cndmask_b32_e64 v8, 0x80000000, v31, s2
	v_cndmask_b32_e64 v19, 0x80000000, v32, s2
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v39, v1, s[8:11], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[30:33], v6, s[4:7], 0 offen
	buffer_load_b128 v[34:37], v7, s[4:7], 0 offen
	buffer_load_b128 v[42:45], v8, s[4:7], 0 offen
	buffer_load_b128 v[46:49], v19, s[4:7], 0 offen
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_waitcnt vmcnt(9)
	ds_store_b32 v6, v38 offset:32768
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(8)
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v6, v39 offset:33792
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(3)
	...
	s_waitcnt vmcnt(1)
	ds_store_b128 v7, v[42:45] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v7, v[46:49] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_3:                                ; %Flow46
	...
	v_mul_lo_u32 v40, v2, s0
	v_lshlrev_b32_e32 v13, 2, v38
	v_lshlrev_b32_e32 v15, 5, v0
	v_lshlrev_b32_e32 v136, 1, v38
	s_and_not1_b32 vcc_lo, exec_lo, s6
	s_add_i32 s1, s30, 64
	s_cbranch_vccnz .LBB0_7
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v22, 0 :: v_dual_and_b32 v19, 0x70, v1
	s_mov_b32 s17, s16
	s_mov_b32 s18, s16
	s_mov_b32 s19, s16
	s_mov_b32 s20, s16
	...
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v43, 0, v136
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v30, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_add3_u32 v24, 0, v13, v1
	v_dual_mov_b32 v1, s16 :: v_dual_mov_b32 v6, s21
	v_dual_mov_b32 v2, s17 :: v_dual_mov_b32 v3, s18
	v_mov_b32_e32 v8, s23
	v_dual_mov_b32 v4, s19 :: v_dual_mov_b32 v5, s20
	v_dual_mov_b32 v7, s22 :: v_dual_add_nc_u32 v42, v24, v23
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s18, s30
	.loc	1 372 22 is_stmt 1              ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v45, s19, v21
	v_add_nc_u32_e32 v48, s19, v20
	...
	v_add_lshl_u32 v52, v40, s18, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s18, s18, s27
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[46:47], null, s1, s26, v[11:12]
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v60, v39, s18, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v47, s20, v9
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v52, 0x80000000, v52, vcc_lo
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v49, s20, v17
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_cndmask_b32_e32 v60, 0x80000000, v60, vcc_lo
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v120, v46, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	buffer_load_u16 v189, v60, s[40:43], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v190, v52, s[36:39], 0 offen
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v50, s20, v18
	v_add_nc_u32_e32 v51, s20, v10
	.loc	1 378 22 is_stmt 0              ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[60:63], v47, s[4:7], 0 offen
	buffer_load_b128 v[64:67], v49, s[4:7], 0 offen
	buffer_load_b128 v[68:71], v50, s[4:7], 0 offen
	buffer_load_b128 v[72:75], v51, s[4:7], 0 offen
	.loc	1 379 19 is_stmt 1              ; generate_amdgcn.py:379:19
	ds_load_u8 v46, v45 offset:208
	ds_load_u8 v53, v45 offset:240
	ds_load_u8 v54, v45 offset:224
	ds_load_u8 v55, v45 offset:192
	ds_load_u8 v56, v45 offset:144
	ds_load_u8 v57, v45 offset:176
	ds_load_u8 v58, v45 offset:160
	ds_load_u8 v59, v45 offset:128
	ds_load_u8 v76, v45 offset:80
	ds_load_u8 v77, v45 offset:112
	ds_load_u8 v78, v45 offset:96
	ds_load_u8 v79, v45 offset:64
	ds_load_u8 v80, v45
	ds_load_u8 v81, v45 offset:16
	ds_load_u8 v82, v45 offset:32
	ds_load_u8 v83, v45 offset:48
	ds_load_u8 v84, v45 offset:464
	ds_load_u8 v85, v45 offset:496
	ds_load_u8 v86, v45 offset:480
	ds_load_u8 v87, v45 offset:448
	ds_load_u8 v88, v45 offset:400
	ds_load_u8 v89, v45 offset:432
	ds_load_u8 v90, v45 offset:416
	ds_load_u8 v91, v45 offset:384
	ds_load_u8 v92, v45 offset:336
	ds_load_u8 v93, v45 offset:368
	ds_load_u8 v94, v45 offset:352
	ds_load_u8 v95, v45 offset:320
	ds_load_u8 v96, v45 offset:272
	ds_load_u8 v97, v45 offset:304
	ds_load_u8 v98, v45 offset:288
	ds_load_u8 v99, v45 offset:256
	ds_load_u8 v100, v45 offset:720
	ds_load_u8 v101, v45 offset:752
	ds_load_u8 v102, v45 offset:736
	ds_load_u8 v103, v45 offset:704
	ds_load_u8 v104, v45 offset:656
	ds_load_u8 v105, v45 offset:688
	ds_load_u8 v106, v45 offset:672
	ds_load_u8 v107, v45 offset:640
	ds_load_u8 v108, v45 offset:592
	ds_load_u8 v109, v45 offset:624
	ds_load_u8 v110, v45 offset:608
	ds_load_u8 v111, v45 offset:576
	ds_load_u8 v112, v45 offset:528
	ds_load_u8 v113, v45 offset:560
	ds_load_u8 v114, v45 offset:544
	ds_load_u8 v115, v45 offset:512
	ds_load_u8 v116, v44 offset:11520
	ds_load_u8 v117, v44 offset:11264
	ds_load_u8 v118, v44 offset:12032
	ds_load_u8 v119, v44 offset:11776
	ds_load_u8 v121, v45 offset:976
	ds_load_u8 v48, v48
	ds_load_u8 v122, v45 offset:992
	ds_load_u8 v123, v45 offset:960
	ds_load_u8 v124, v45 offset:912
	ds_load_u8 v125, v45 offset:944
	ds_load_u8 v126, v45 offset:928
	ds_load_u8 v127, v45 offset:896
	ds_load_u8 v128, v45 offset:848
	ds_load_u8 v129, v45 offset:880
	ds_load_u8 v130, v45 offset:864
	ds_load_u8 v131, v45 offset:832
	ds_load_u8 v132, v45 offset:784
	ds_load_u8 v133, v45 offset:816
	ds_load_u8 v134, v45 offset:800
	ds_load_u8 v45, v45 offset:768
	ds_load_u8 v135, v44 offset:3328
	ds_load_u8 v136, v44 offset:3072
	ds_load_u8 v137, v44 offset:3840
	ds_load_u8 v138, v44 offset:3584
	ds_load_u8 v139, v44 offset:3968
	ds_load_u8 v140, v44 offset:3712
	ds_load_u8 v141, v44 offset:3456
	ds_load_u8 v142, v44 offset:3200
	ds_load_u8 v143, v44 offset:2304
	ds_load_u8 v144, v44 offset:2048
	ds_load_u8 v145, v44 offset:2816
	ds_load_u8 v146, v44 offset:2560
	ds_load_u8 v147, v44 offset:2944
	ds_load_u8 v148, v44 offset:2688
	ds_load_u8 v149, v44 offset:2432
	ds_load_u8 v150, v44 offset:2176
	ds_load_u8 v151, v44 offset:1280
	ds_load_u8 v152, v44 offset:1024
	ds_load_u8 v153, v44 offset:1792
	ds_load_u8 v154, v44 offset:1536
	ds_load_u8 v155, v44 offset:1920
	ds_load_u8 v156, v44 offset:1664
	ds_load_u8 v157, v44 offset:1408
	ds_load_u8 v158, v44 offset:1152
	ds_load_u8 v159, v44 offset:256
	ds_load_u8 v160, v44
	ds_load_u8 v161, v44 offset:768
	ds_load_u8 v162, v44 offset:512
	ds_load_u8 v163, v44 offset:896
	ds_load_u8 v164, v44 offset:640
	ds_load_u8 v165, v44 offset:384
	ds_load_u8 v166, v44 offset:128
	ds_load_u8 v167, v44 offset:7424
	ds_load_u8 v168, v44 offset:7168
	ds_load_u8 v169, v44 offset:7936
	ds_load_u8 v170, v44 offset:7680
	ds_load_u8 v171, v44 offset:8064
	ds_load_u8 v172, v44 offset:7808
	ds_load_u8 v173, v44 offset:7552
	ds_load_u8 v174, v44 offset:7296
	ds_load_u8 v175, v44 offset:6400
	ds_load_u8 v176, v44 offset:6144
	ds_load_u8 v177, v44 offset:6912
	ds_load_u8 v178, v44 offset:6656
	ds_load_u8 v179, v44 offset:7040
	ds_load_u8 v180, v44 offset:6784
	ds_load_u8 v181, v44 offset:6528
	ds_load_u8 v182, v44 offset:6272
	ds_load_u8 v183, v44 offset:5376
	ds_load_u8 v184, v44 offset:5120
	ds_load_u8 v185, v44 offset:5888
	ds_load_u8 v186, v44 offset:5632
	ds_load_u8 v187, v44 offset:6016
	ds_load_u8 v188, v44 offset:5760
	ds_load_u8 v52, v44 offset:5504
	ds_load_u8 v191, v44 offset:5248
	ds_load_u8 v192, v44 offset:4352
	ds_load_u8 v193, v44 offset:4096
	ds_load_u8 v194, v44 offset:4864
	ds_load_u8 v195, v44 offset:4608
	ds_load_u8 v196, v44 offset:4992
	ds_load_u8 v197, v44 offset:4736
	ds_load_u8 v198, v44 offset:4480
	ds_load_u8 v199, v44 offset:4224
	ds_load_u8 v47, v44 offset:12160
	ds_load_u8 v49, v44 offset:11904
	ds_load_u8 v50, v44 offset:11648
	ds_load_u8 v51, v44 offset:11392
	ds_load_u8 v200, v44 offset:10496
	ds_load_u8 v201, v44 offset:10240
	ds_load_u8 v202, v44 offset:11008
	ds_load_u8 v203, v44 offset:10752
	ds_load_u8 v204, v44 offset:11136
	ds_load_u8 v205, v44 offset:10880
	ds_load_u8 v206, v44 offset:10624
	ds_load_u8 v207, v44 offset:10368
	ds_load_u8 v208, v44 offset:9472
	ds_load_u8 v209, v44 offset:9216
	ds_load_u8 v210, v44 offset:9984
	ds_load_u8 v211, v44 offset:9728
	ds_load_u8 v212, v44 offset:10112
	ds_load_u8 v213, v44 offset:9856
	ds_load_u8 v214, v44 offset:9600
	ds_load_u8 v215, v44 offset:9344
	ds_load_u8 v216, v44 offset:8448
	ds_load_u8 v217, v44 offset:8192
	ds_load_u8 v218, v44 offset:8960
	ds_load_u8 v219, v44 offset:8704
	ds_load_u8 v220, v44 offset:9088
	ds_load_u8 v221, v44 offset:8832
	ds_load_u8 v222, v44 offset:8576
	ds_load_u8 v223, v44 offset:8320
	ds_load_u8 v224, v44 offset:15616
	ds_load_u8 v225, v44 offset:15360
	ds_load_u8 v226, v44 offset:16128
	ds_load_u8 v227, v44 offset:15872
	ds_load_u8 v228, v44 offset:16256
	ds_load_u8 v229, v44 offset:16000
	ds_load_u8 v230, v44 offset:15744
	ds_load_u8 v231, v44 offset:15488
	ds_load_u8 v232, v44 offset:14592
	ds_load_u8 v233, v44 offset:14336
	ds_load_u8 v234, v44 offset:15104
	ds_load_u8 v235, v44 offset:14848
	ds_load_u8 v236, v44 offset:15232
	ds_load_u8 v237, v44 offset:14976
	ds_load_u8 v238, v44 offset:14720
	ds_load_u8 v239, v44 offset:14464
	ds_load_u8 v240, v44 offset:13568
	ds_load_u8 v241, v44 offset:13312
	ds_load_u8 v242, v44 offset:14080
	ds_load_u8 v243, v44 offset:13824
	ds_load_u8 v244, v44 offset:14208
	ds_load_u8 v245, v44 offset:13952
	ds_load_u8 v246, v44 offset:13696
	ds_load_u8 v247, v44 offset:13440
	ds_load_u8 v248, v44 offset:12544
	ds_load_u8 v249, v44 offset:12288
	ds_load_u8 v250, v44 offset:13056
	ds_load_u8 v251, v44 offset:12800
	ds_load_u8 v252, v44 offset:13184
	ds_load_u8 v253, v44 offset:12928
	ds_load_u8 v254, v44 offset:12672
	ds_load_u8 v44, v44 offset:12416
	s_waitcnt lgkmcnt(62)
	v_perm_b32 v46, v55, v46, 0xc0c0004
	v_perm_b32 v53, v54, v53, 0xc0c0004
	v_perm_b32 v54, v59, v56, 0xc0c0004
	v_perm_b32 v55, v58, v57, 0xc0c0004
	v_perm_b32 v56, v79, v76, 0xc0c0004
	v_perm_b32 v57, v78, v77, 0xc0c0004
	v_perm_b32 v58, v80, v81, 0xc0c0004
	v_perm_b32 v59, v82, v83, 0xc0c0004
	v_perm_b32 v80, v136, v135, 0xc0c0004
	v_perm_b32 v81, v138, v137, 0xc0c0004
	...
	v_perm_b32 v93, v170, v169, 0xc0c0004
	v_perm_b32 v94, v176, v175, 0xc0c0004
	v_perm_b32 v95, v178, v177, 0xc0c0004
	v_perm_b32 v96, v184, v183, 0xc0c0004
	v_perm_b32 v97, v186, v185, 0xc0c0004
	v_perm_b32 v98, v193, v192, 0xc0c0004
	v_perm_b32 v99, v195, v194, 0xc0c0004
	...
	v_perm_b32 v115, v219, v218, 0xc0c0004
	v_perm_b32 v116, v123, v121, 0xc0c0004
	v_perm_b32 v48, v122, v48, 0xc0c0004
	v_perm_b32 v119, v131, v128, 0xc0c0004
	v_perm_b32 v45, v45, v132, 0xc0c0004
	...
	v_perm_b32 v147, v191, v52, 0xc0c0004
	v_perm_b32 v50, v51, v50, 0xc0c0004
	v_perm_b32 v47, v49, v47, 0xc0c0004
	v_perm_b32 v49, v207, v206, 0xc0c0004
	v_perm_b32 v51, v205, v204, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v44, v254, 0xc0c0004
	v_perm_b32 v161, v253, v252, 0xc0c0004
	v_lshl_or_b32 v79, v53, 16, v46
	v_lshl_or_b32 v78, v55, 16, v54
	v_lshl_or_b32 v77, v57, 16, v56
	v_lshl_or_b32 v76, v59, 16, v58
	v_lshl_or_b32 v55, v81, 16, v80
	v_lshl_or_b32 v54, v83, 16, v82
	v_lshl_or_b32 v53, v136, 16, v135
	v_lshl_or_b32 v52, v138, 16, v137
	v_perm_b32 v110, v201, v200, 0xc0c0004
	v_perm_b32 v111, v203, v202, 0xc0c0004
	v_perm_b32 v112, v209, v208, 0xc0c0004
	v_perm_b32 v113, v211, v210, 0xc0c0004
	v_perm_b32 v143, v174, v173, 0xc0c0004
	v_perm_b32 v144, v172, v171, 0xc0c0004
	v_perm_b32 v145, v182, v181, 0xc0c0004
	v_perm_b32 v146, v180, v179, 0xc0c0004
	v_perm_b32 v148, v188, v187, 0xc0c0004
	...
	v_lshl_or_b32 v89, v105, 16, v104
	v_lshl_or_b32 v88, v107, 16, v106
	v_lshl_or_b32 v92, v115, 16, v114
	v_lshl_or_b32 v99, v48, 16, v116
	v_lshl_or_b32 v96, v122, 16, v45
	v_lshl_or_b32 v107, v132, 16, v131
	v_lshl_or_b32 v106, v134, 16, v133
	v_lshl_or_b32 v105, v140, 16, v139
	v_lshl_or_b32 v104, v142, 16, v141
	v_lshl_or_b32 v115, v47, 16, v50
	v_lshl_or_b32 v114, v51, 16, v49
	v_lshl_or_b32 v116, v161, 16, v44
	...
	v_perm_b32 v123, v225, v224, 0xc0c0004
	v_perm_b32 v124, v227, v226, 0xc0c0004
	v_perm_b32 v125, v233, v232, 0xc0c0004
	v_perm_b32 v126, v235, v234, 0xc0c0004
	v_perm_b32 v127, v241, v240, 0xc0c0004
	v_perm_b32 v128, v243, v242, 0xc0c0004
	v_perm_b32 v129, v249, v248, 0xc0c0004
	v_perm_b32 v130, v251, v250, 0xc0c0004
	v_perm_b32 v151, v215, v214, 0xc0c0004
	...
	v_lshl_or_b32 v95, v109, 16, v108
	...
	v_wmma_i32_16x16x16_iu8 v[52:59], v[104:107], v[76:79], v[1:8] neg_lo:[1,1,0]
	...
	v_perm_b32 v157, v239, v238, 0xc0c0004
	v_perm_b32 v158, v237, v236, 0xc0c0004
	v_perm_b32 v159, v247, v246, 0xc0c0004
	v_perm_b32 v160, v245, v244, 0xc0c0004
	v_lshl_or_b32 v98, v118, 16, v117
	v_lshl_or_b32 v97, v121, 16, v119
	v_lshl_or_b32 v103, v124, 16, v123
	v_lshl_or_b32 v102, v126, 16, v125
	v_lshl_or_b32 v101, v128, 16, v127
	v_lshl_or_b32 v100, v130, 16, v129
	v_lshl_or_b32 v113, v152, 16, v151
	v_lshl_or_b32 v112, v154, 16, v153
	v_wmma_i32_16x16x16_iu8 v[52:59], v[108:111], v[80:83], v[52:59] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[44:51], v[92:95], v[88:91], v[44:51] neg_lo:[1,1,0]
	v_lshl_or_b32 v119, v156, 16, v155
	v_lshl_or_b32 v118, v158, 16, v157
	v_lshl_or_b32 v117, v160, 16, v159
	v_wmma_i32_16x16x16_iu8 v[52:59], v[112:115], v[88:91], v[52:59] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[44:51], v[100:103], v[96:99], v[44:51] neg_lo:[1,1,0]
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s18, s31, 1
	s_mov_b32 s16, s35
	s_cmp_lt_i32 s18, 2
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[52:59], v[116:119], v[96:99], v[52:59] neg_lo:[1,1,0]
	...
	s_add_i32 s18, s17, 1
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_lshl_b32 s20, s31, 14
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_lshl_b32 s19, s31, 10
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_add_i32 s35, s20, 0
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_add_i32 s19, s19, 0
	s_mov_b32 s14, s44
	s_add_i32 s44, s19, 0x8000
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmp_lg_u32 s17, s45
	s_mov_b32 s17, s18
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v92, 16, v190
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v44, 16, v189
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	ds_store_b32 v42, v44 offset:34816
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[44:47], v43 offset:34816
	ds_load_b128 v[48:51], v43 offset:34832
	ds_load_b128 v[52:55], v43 offset:35328
	ds_load_b128 v[56:59], v43 offset:35344
	s_waitcnt lgkmcnt(2)
	v_mul_f32_e32 v51, v51, v92
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v29, v51, v83
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v55, v55, v92
	v_mul_f32_e32 v54, v54, v92
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v59, v59, v92 :: v_dual_add_nc_u32 v12, s35, v41
	v_mul_f32_e32 v47, v47, v92
	v_mul_f32_e32 v44, v44, v92
	v_mul_f32_e32 v45, v45, v92
	v_mul_f32_e32 v46, v46, v92
	v_mul_f32_e32 v48, v48, v92
	v_mul_f32_e32 v49, v49, v92
	v_mul_f32_e32 v50, v50, v92
	v_dual_mul_f32 v57, v57, v92 :: v_dual_fmac_f32 v36, v59, v91
	v_mul_f32_e32 v56, v56, v92
	v_dual_mul_f32 v58, v58, v92 :: v_dual_fmac_f32 v33, v55, v87
	v_dual_mul_f32 v53, v53, v92 :: v_dual_fmac_f32 v32, v54, v86
	v_mul_f32_e32 v52, v52, v92
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v24, v46, v78 :: v_dual_add_nc_u32 v255, s19, v16
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v22, v44, v76 :: v_dual_fmac_f32 v37, v58, v90
	v_fmac_f32_e32 v23, v45, v77
	v_dual_fmac_f32 v25, v47, v79 :: v_dual_fmac_f32 v26, v48, v80
	v_dual_fmac_f32 v27, v49, v81 :: v_dual_fmac_f32 v28, v50, v82
	v_dual_fmac_f32 v31, v53, v85 :: v_dual_fmac_f32 v30, v52, v84
	v_dual_fmac_f32 v35, v57, v89 :: v_dual_fmac_f32 v34, v56, v88
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	ds_store_b32 v255, v120 offset:32768
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v12, v[60:63]
	s_waitcnt vmcnt(2)
	ds_store_b128 v12, v[64:67] offset:4096
	s_waitcnt vmcnt(1)
	ds_store_b128 v12, v[68:71] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v12, v[72:75] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v59, v20 :: v_dual_lshlrev_b32 v136, 1, v38
	s_branch .LBB0_8
.LBB0_7:
...
; %bb.9:
	...
	ds_load_u8 v19, v6 offset:64
	ds_load_u8 v20, v6 offset:16
	...
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v1, v19, v12, 0xc0c0004
	v_lshl_or_b32 v3, v7, 16, v3
	ds_load_u8 v11, v44
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v7, v42, v20, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v12, v41, v43, 0xc0c0004
	ds_load_u8 v16, v5 offset:2304
	ds_load_u8 v19, v5 offset:2048
	ds_load_u8 v20, v5 offset:2816
	...
	v_perm_b32 v19, v41, v20, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v41, v43, v42, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v42, v48, v44, 0xc0c0004
	v_lshl_or_b32 v10, v9, 16, v8
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	v_lshl_or_b32 v9, v19, 16, v16
	s_waitcnt lgkmcnt(8)
	...
	ds_load_u8 v20, v5 offset:1920
	ds_load_u8 v77, v5 offset:1664
	ds_load_u8 v78, v5 offset:1408
	ds_load_u8 v79, v5 offset:1152
	ds_load_u8 v12, v5 offset:896
	ds_load_u8 v16, v5 offset:640
	ds_load_u8 v19, v5 offset:384
	ds_load_u8 v80, v5 offset:128
	...
	v_perm_b32 v20, v77, v20, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v19, v80, v19, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	...
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v70, v81, v71, 0xc0c0004
	v_lshl_or_b32 v43, v48, 16, v47
	v_lshl_or_b32 v42, v45, 16, v104
	ds_load_u8 v45, v6 offset:624
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v47, v99, v82, 0xc0c0004
	v_lshl_or_b32 v41, v70, 16, v69
	v_perm_b32 v48, v98, v105, 0xc0c0004
	...
	v_perm_b32 v19, v97, v96, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[60:67], v[41:44], v[7:10], v[60:67] neg_lo:[1,1,0]
	v_lshl_or_b32 v44, v48, 16, v47
	v_perm_b32 v20, v95, v94, 0xc0c0004
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v42, v107, v106, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v41, v108, v46, 0xc0c0004
	ds_load_u8 v46, v5 offset:11520
	ds_load_u8 v47, v5 offset:11264
	ds_load_u8 v48, v5 offset:12032
	...
	v_lshl_or_b32 v4, v16, 16, v12
	v_lshl_or_b32 v3, v20, 16, v19
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v45, v87, v45, 0xc0c0004
	...
	v_lshl_or_b32 v42, v45, 16, v86
	v_lshl_or_b32 v41, v88, 16, v87
	...
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v47, v104, v48, 0xc0c0004
	ds_load_u8 v48, v5 offset:9984
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v45, v86, v45, 0xc0c0004
	...
	v_perm_b32 v12, v106, v105, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v104, v104, v48, 0xc0c0004
	v_lshl_or_b32 v48, v47, 16, v46
	v_lshl_or_b32 v47, v45, 16, v89
	v_perm_b32 v16, v92, v91, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v19, v114, v113, 0xc0c0004
	v_lshl_or_b32 v46, v104, 16, v87
	v_perm_b32 v20, v108, v107, 0xc0c0004
	v_lshl_or_b32 v4, v16, 16, v12
	v_perm_b32 v12, v135, v134, 0xc0c0004
	...
	v_lshl_or_b32 v45, v115, 16, v90
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v2, v58, 16, v57
	v_wmma_i32_16x16x16_iu8 v[60:67], v[45:48], v[41:44], v[60:67] neg_lo:[1,1,0]
	v_perm_b32 v45, v122, v88, 0xc0c0004
	v_perm_b32 v46, v126, v123, 0xc0c0004
	v_perm_b32 v47, v125, v124, 0xc0c0004
	...
	v_perm_b32 v45, v70, v71, 0xc0c0004
...
.LBB0_10:
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_and_b32_e32 v1, 32, v15
	v_dual_mov_b32 v66, 0 :: v_dual_add_nc_u32 v57, 0, v136
...
; %bb.11:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v61, s35, v18
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v18, s44, v59
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
.LBB0_12:
	...
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v74, 0x7632 :: v_dual_mul_f32 v15, v15, v40
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v21, v30, v21, s3
	...
	v_cndmask_b32_e64 v29, v29, v40, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	v_cndmask_b32_e32 v7, 0x1054, v60, vcc_lo
	v_cndmask_b32_e32 v8, 0x3276, v74, vcc_lo
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
