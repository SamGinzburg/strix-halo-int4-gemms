...
.Ltmp19:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s2, s36, s18
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v2, s18, v38
	...
	buffer_load_b128 v[27:30], v7, s[20:23], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
...
.LBB0_3:                                ; %Flow19
	...
	v_or_b32_e32 v15, s14, v1
	s_ashr_i32 s0, s24, 8
	v_or_b32_e32 v27, s33, v4
	v_or_b32_e32 v26, s33, v8
	v_or_b32_e32 v25, s33, v12
	v_mul_lo_u32 v28, v15, s0
	v_or_b32_e32 v23, s33, v13
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s18, s15
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s15, s11, s41
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_ashr_i32 s41, s40, 31
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v41, s15, v38
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_lshr_b32 s41, s41, 24
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s42, s15, s36
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	...
	v_dual_fmac_f32 v15, v60, v43 :: v_dual_add_nc_u32 v100, s34, v40
...
; %bb.8:
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v2, s19, v36
	v_add_nc_u32_e32 v6, s19, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v38, s10, v32
	v_add_nc_u32_e32 v39, s10, v29
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	v_add_nc_u32_e32 v39, s19, v33
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s10, v31
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v45, v38 :: v_dual_add_nc_u32 v42, s10, v30
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[6:9], v[50:53], v[38:45] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[38:45], v[54:57], v[62:65], v[38:45] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	v_dual_cndmask_b32 v20, 0x80000000, v20 :: v_dual_lshlrev_b32 v37, 1, v37
	s_clause 0x7
	...
	v_and_or_b32 v10, 0x1c0, v10, v11
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v7, v31, v7, v18
	v_fma_f32 v9, v11, v9, v13
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v35, v29, v36
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xor_b32_e32 v36, v37, v50
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v5, v33, v5, v16
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v7, v18, v7, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v6, v32, v6, v17
	v_fma_f32 v8, v30, v8, v19
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v11, v49, 9, v36
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_xad_u32 v16, v11, 20, 0
	v_xad_u32 v17, v11, 24, 0
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v27, v28, v27 :: v_dual_lshlrev_b32 v20, 16, v20
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v25, v25, v39, v3
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_or_b32 v0, v0, 32, v10
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v29, v29, v45 :: v_dual_add_nc_u32 v10, 0, v11
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v2, v35, v2, v14
	v_fma_f32 v23, v23, v40, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_nc_u32_e32 v18, 0, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v4, v29, v4, v12
	v_fma_f32 v21, v21, v41, v6
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v2, v14, v2, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v24, v24, v42, v7
	v_fma_f32 v22, v22, v43, v8
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v4, v12, v4, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v20, v20, v44, v9
	v_fma_f32 v26, v26, v38, v2
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xad_u32 v12, v11, 4, 0
