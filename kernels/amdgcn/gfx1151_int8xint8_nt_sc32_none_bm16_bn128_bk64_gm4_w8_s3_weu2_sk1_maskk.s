	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow58
	...
	v_dual_mov_b32 v16, 0 :: v_dual_and_b32 v15, 0xf0, v0
...
.Ltmp16:
	...
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v6, 1, v0
.Ltmp17:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_lshr_b32 s0, s0, 26
.Ltmp18:
...
.Ltmp19:
	...
	v_dual_mov_b32 v28, 0 :: v_dual_and_b32 v11, 0x160, v11
	v_and_b32_e32 v12, 0x90, v12
	v_dual_mov_b32 v18, 0 :: v_dual_lshlrev_b32 v3, 4, v3
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp24:
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_bfe_u32 v2, v0, 4, 1
	v_and_b32_e32 v6, 0x17e, v6
	v_and_b32_e32 v8, 0x90, v8
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v1, 0xf70, v1
	v_and_b32_e32 v13, 0x90, v13
	v_or_b32_e32 v16, v12, v11
...
.Ltmp27:
	...
	v_or3_b32 v22, v2, v7, s14
	v_xor_b32_e32 v2, 16, v16
	v_xor_b32_e32 v7, 16, v3
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v34, 0, v16
	v_mov_b32_e32 v16, 0
	v_xor_b32_e32 v1, v13, v1
	v_mul_lo_u32 v23, v14, s2
	v_mad_u64_u32 v[12:13], null, s24, v4, v[10:11]
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v32, 0, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v33, 0, v1
	v_add_nc_u32_e32 v35, 0, v2
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v36, 0, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v38, s3, v9
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	v_add_nc_u32_e32 v39, s3, v11
	.loc	1 339 27                        ; generate_amdgcn.py:339:27
	v_add_nc_u32_e32 v40, s3, v10
	...
	buffer_load_b128 v[38:41], v43, s[4:7], 0 offen
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v47, v42, s[16:19], 0 offen
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	buffer_load_b128 v[42:45], v44, s[4:7], 0 offen
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 356 29                        ; generate_amdgcn.py:356:29
	s_ashr_i32 s25, s25, 5
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_dual_cndmask_b32 v48, 0x80000000, v48 :: v_dual_cndmask_b32 v53, 0x80000000, v53
	v_add_lshl_u32 v57, v23, s25, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cmp_lt_i32 s25, s2
	.loc	1 360 40                        ; generate_amdgcn.py:360:40
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v59, v24, s25, 1
	v_add_lshl_u32 v58, v22, s25, 1
	v_add_lshl_u32 v60, v25, s25, 1
	v_add_lshl_u32 v61, v26, s25, 1
	v_add_lshl_u32 v62, v27, s25, 1
	v_add_lshl_u32 v63, v29, s25, 1
	v_add_lshl_u32 v64, v30, s25, 1
	v_add_lshl_u32 v65, v31, s25, 1
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(3)
	ds_store_b16 v32, v46 offset:8192
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(2)
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v32, v47 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v33, v[42:45] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	s_clause 0x1
	buffer_load_u16 v78, v48, s[20:23], 0 offen
	buffer_load_u16 v79, v57, s[20:23], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0xf
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[50:53], v34 offset:8192
	ds_load_b128 v[54:57], v34 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[58:61], v36 offset:4096
	ds_load_b128 v[62:65], v37
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[66:69], v35 offset:8192
	ds_load_b128 v[70:73], v35 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[74:77], v37 offset:4096
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[46:49], v[50:53], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[58:61], v[54:57], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[62:65], v[66:69], v[38:45] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[74:77], v[70:73], v[46:53] neg_lo:[1,1,0]
	...
	s_waitcnt vmcnt(11)
	v_dual_mul_f32 v51, v55, v51 :: v_dual_lshlrev_b32 v60, 16, v84
	v_dual_mul_f32 v49, v55, v49 :: v_dual_lshlrev_b32 v56, 16, v80
	v_dual_mul_f32 v41, v54, v41 :: v_dual_lshlrev_b32 v58, 16, v82
	v_mul_f32_e32 v43, v54, v43
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v40, v54, v40 :: v_dual_lshlrev_b32 v61, 16, v85
	s_waitcnt vmcnt(9)
	v_dual_mul_f32 v45, v54, v45 :: v_dual_lshlrev_b32 v62, 16, v86
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v53, v55, v53 :: v_dual_lshlrev_b32 v64, 16, v88
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v42, v54, v42 :: v_dual_lshlrev_b32 v65, 16, v89
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v21, v41, v61 :: v_dual_lshlrev_b32 v68, 16, v92
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v44, v54, v44 :: v_dual_lshlrev_b32 v69, 16, v93
	v_mul_f32_e32 v38, v54, v38
	v_mul_f32_e32 v39, v54, v39
	v_dual_mul_f32 v48, v55, v48 :: v_dual_lshlrev_b32 v63, 16, v87
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v17, v38, v56 :: v_dual_lshlrev_b32 v66, 16, v90
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v50, v55, v50 :: v_dual_lshlrev_b32 v67, 16, v91
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v19, v43, v65 :: v_dual_lshlrev_b32 v70, 16, v94
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v52, v55, v52 :: v_dual_lshlrev_b32 v71, 16, v95
	v_mul_f32_e32 v47, v55, v47
	v_mul_f32_e32 v46, v55, v46
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v28, v39, v57
	v_dual_fmac_f32 v20, v40, v60 :: v_dual_fmac_f32 v13, v45, v69
	v_dual_fmac_f32 v18, v42, v64 :: v_dual_fmac_f32 v21, v49, v62
	v_dual_fmac_f32 v16, v44, v68 :: v_dual_fmac_f32 v19, v51, v66
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v17, v46, v59 :: v_dual_fmac_f32 v28, v47, v58
	v_dual_fmac_f32 v20, v48, v63 :: v_dual_fmac_f32 v13, v53, v70
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v18, v50, v67
	v_fmac_f32_e32 v16, v52, v71
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
...
.Ltmp28:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 96
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
