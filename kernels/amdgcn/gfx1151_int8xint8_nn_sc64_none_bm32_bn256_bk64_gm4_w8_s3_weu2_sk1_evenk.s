...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v77, s38, v16
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s15, s15, 26
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s16, s38, s35
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	buffer_load_u16 v185, v79, s[40:43], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v81, s1, v71
	v_add_nc_u32_e32 v82, s1, v72
	v_add_nc_u32_e32 v83, s1, v73
	v_add_nc_u32_e32 v84, s1, v74
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v189, s39, v65
	v_add_nc_u32_e32 v193, s39, v69
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v144, v86, v141
	v_mul_f32_e32 v86, v86, v142
	v_dual_mul_f32 v145, v87, v141 :: v_dual_add_nc_u32 v186, s16, v62
	v_dual_mul_f32 v146, v88, v141 :: v_dual_add_nc_u32 v187, s39, v63
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v147, v89, v141 :: v_dual_add_nc_u32 v188, s39, v64
	v_dual_mul_f32 v149, v91, v141 :: v_dual_add_nc_u32 v190, s39, v66
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_mul_f32 v80, v80, v142 :: v_dual_add_nc_u32 v191, s39, v67
	v_mul_f32_e32 v148, v90, v141
	v_dual_mul_f32 v109, v77, v141 :: v_dual_add_nc_u32 v192, s39, v68
...
.LBB0_10:
	...
	s_clause 0x1
	buffer_load_u16 v118, v1, s[8:11], 0 offen
...
; %bb.11:
	...
	s_mov_b32 s19, s12
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v58, s39, v129
	v_add_nc_u32_e32 v95, s39, v126
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v54, s1, v54
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v93, s39, v127
	v_add_nc_u32_e32 v94, s39, v128
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v128, s14 :: v_dual_add_nc_u32 v93, s1, v55
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v127, s13 :: v_dual_add_nc_u32 v58, s1, v57
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[162:165], v93 offset:1024
	ds_load_b128 v[166:169], v93
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v126, s12 :: v_dual_add_nc_u32 v95, s1, v56
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 194
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 45
