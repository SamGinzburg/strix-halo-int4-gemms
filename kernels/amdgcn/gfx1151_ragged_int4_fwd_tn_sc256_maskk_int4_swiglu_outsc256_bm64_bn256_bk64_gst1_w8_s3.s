...
.LBB0_3:                                ; %Flow761
	...
	v_dual_mov_b32 v185, 0 :: v_dual_mov_b32 v238, 0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v93, 0 :: v_dual_and_b32 v0, 24, v0
	...
	v_dual_mov_b32 v91, 0 :: v_dual_add_nc_u32 v0, 0, v20
	...
	v_dual_mov_b32 v193, 0 :: v_dual_add_nc_u32 v232, 0, v14
	v_dual_mov_b32 v191, 0 :: v_dual_add_nc_u32 v230, 0, v16
	v_dual_mov_b32 v190, 0 :: v_dual_add_nc_u32 v231, 0, v6
	v_dual_mov_b32 v188, 0 :: v_dual_add_nc_u32 v239, 0, v17
	v_dual_mov_b32 v92, 0 :: v_dual_add_nc_u32 v233, 0, v1
	v_dual_mov_b32 v90, 0 :: v_dual_add_nc_u32 v253, 0, v9
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v254, 0, v15
	v_dual_mov_b32 v108, 0 :: v_dual_add_nc_u32 v175, 0, v19
	v_dual_mov_b32 v109, 0 :: v_dual_add_nc_u32 v234, 0, v21
	v_dual_mov_b32 v110, 0 :: v_dual_add_nc_u32 v235, v3, v22
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v146, 0, v24
	v_dual_mov_b32 v129, 0 :: v_dual_add_nc_u32 v236, 0, v25
	...
	v_dual_mov_b32 v238, 0 :: v_dual_mov_b32 v171, 0
...
.LBB0_5:                                ; =>This Loop Header: Depth=1
	...
	scratch_store_b32 off, v212, off offset:572
	...
	scratch_store_b32 off, v238, off offset:416
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_mad_u64_u32 v[137:138], null, v129, s40, v[237:238]
	.loc	1 1142 32                       ; ragged.py:1142:32
	v_cmp_gt_i32_e64 s3, s7, v129
	.loc	1 1141 26                       ; ragged.py:1141:26
	v_or_b32_e32 v129, 1, v129
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_mad_u64_u32 v[138:139], null, v129, s40, v[237:238]
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_clause 0x2
	buffer_load_u8 v172, v136, s[20:23], 0 offen
	...
	buffer_load_u8 v174, v148, s[20:23], 0 offen
	buffer_load_u8 v173, v147, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	...
	ds_load_b64 v[165:166], v225
	ds_load_b64 v[155:156], v229
	ds_load_b64 v[149:150], v226
	ds_load_b64 v[167:168], v228
	ds_load_b64 v[161:162], v232
	ds_load_b64 v[151:152], v230
	ds_load_b64 v[169:170], v231
	ds_load_b64 v[163:164], v239
	...
	v_cndmask_b32_e64 v137, 0x80000000, v252, s3
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v235, v172
	ds_store_b8 v235, v246 offset:64
	ds_store_b8 v235, v251 offset:128
	...
	ds_load_u8 v157, v236
	ds_load_u8 v155, v219 offset:1968
	...
	.loc	1 1190 36                       ; ragged.py:1190:36
	ds_load_u8 v236, v219 offset:1696
	v_mov_b32_e32 v160, v237
	.loc	1 1185 39                       ; ragged.py:1185:39
	...
	v_dual_mov_b32 v159, v227 :: v_dual_mov_b32 v158, v145
	v_mov_b32_e32 v229, v220
	s_delay_alu instid0(VALU_DEP_4)
	v_lshlrev_b16 v130.l, 8, v130.l
	.loc	1 1190 36                       ; ragged.py:1190:36
	ds_load_u8 v220, v219 offset:1952
	ds_load_u8 v148, v219 offset:1600
	ds_load_u8 v232, v219 offset:1616
	ds_load_u8 v151, v219 offset:1632
	ds_load_u8 v152, v219 offset:1648
	ds_load_u8 v145, v219 offset:1664
	ds_load_u8 v248, v219 offset:1584
	ds_load_u8 v227, v219 offset:1552
	v_mov_b32_e32 v149, v239
	ds_load_u8 v150, v219 offset:1568
	ds_load_u8 v239, v219 offset:1792
	...
	ds_load_u8 v161, v219 offset:768
	...
	ds_load_u8 v0, v219 offset:1360
	s_waitcnt lgkmcnt(0)
	...
	v_perm_b32 v129, v161, v167, 0xc0c0004
	...
	scratch_load_b32 v131, off, off offset:28
	...
	s_waitcnt vmcnt(0)
	v_perm_b32 v132, v132, v0, 0xc0c0004
	...
	.loc	1 1190 36                       ; ragged.py:1190:36
	v_perm_b32 v0, v239, v215, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[129:130], v[133:134], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[131:132], v[133:134], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[129:130], v[135:136], v[17:24] neg_lo:[1,1,0]
	...
	v_perm_b32 v130, v199, v148, 0xc0c0004
	v_perm_b32 v131, v145, v241, 0xc0c0004
	...
	v_perm_b32 v130, v227, v232, 0xc0c0004
	v_perm_b32 v131, v213, v242, 0xc0c0004
	v_mov_b32_e32 v232, v153
	v_mov_b32_e32 v239, v149
	v_lshl_or_b32 v136, v129, 16, v0
	v_perm_b32 v0, v211, v205, 0xc0c0004
	v_lshl_or_b32 v135, v131, 16, v130
	v_perm_b32 v129, v220, v154, 0xc0c0004
	v_perm_b32 v130, v150, v151, 0xc0c0004
	v_perm_b32 v131, v236, v249, 0xc0c0004
	v_mov_b32_e32 v220, v229
	v_mov_b32_e32 v236, v147
	v_lshl_or_b32 v138, v129, 16, v0
	v_perm_b32 v0, v248, v152, 0xc0c0004
	v_lshl_or_b32 v137, v131, 16, v130
	v_perm_b32 v129, v250, v240, 0xc0c0004
	v_perm_b32 v130, v162, v237, 0xc0c0004
	v_perm_b32 v131, v155, v157, 0xc0c0004
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	scratch_load_b32 v212, off, off offset:572
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 46
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 652
