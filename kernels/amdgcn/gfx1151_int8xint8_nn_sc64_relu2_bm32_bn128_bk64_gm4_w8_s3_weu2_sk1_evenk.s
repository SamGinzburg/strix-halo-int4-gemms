...
.Ltmp19:
	...
	buffer_load_b64 v[23:24], v1, s[4:7], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v7, s18 :: v_dual_mov_b32 v12, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v12, v84, v50 :: v_dual_mul_f32 v85, v71, v77
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v71, v71, v80
	v_mul_f32_e32 v73, v72, v73
	v_mul_f32_e32 v74, v72, v74
	v_mul_f32_e32 v75, v72, v75
	v_dual_mul_f32 v76, v72, v76 :: v_dual_add_nc_u32 v163, s16, v46
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 165
