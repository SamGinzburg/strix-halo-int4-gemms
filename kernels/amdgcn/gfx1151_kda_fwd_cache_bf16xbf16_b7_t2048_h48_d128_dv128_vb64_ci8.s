	...
	.text
	.globl	amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8                          ; -- Begin function amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.p2align	8
	.type	amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8,@function
amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8:                                 ; @amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 182 17                        ; kda_gluon.py:182:17
	v_add_lshl_u32 v2, s18, v212, 2
	.loc	1 143 13                        ; kda_gluon.py:143:13
	v_add_nc_u32_e32 v169, v4, v30
	v_add_nc_u32_e32 v170, v4, v31
	.loc	1 182 17                        ; kda_gluon.py:182:17
	...
	.loc	1 143 13                        ; kda_gluon.py:143:13
	v_add_nc_u32_e32 v234, v7, v30
	v_add_nc_u32_e32 v226, v7, v31
	.loc	1 182 17                        ; kda_gluon.py:182:17
	...
	v_add_lshl_u32 v6, s18, v226, 2
	v_cndmask_b32_e64 v5, 0x80000000, v5, s6
	.loc	1 143 13                        ; kda_gluon.py:143:13
	v_add_nc_u32_e32 v208, v9, v30
	.loc	1 182 17                        ; kda_gluon.py:182:17
	...
	v_add_nc_u32_e32 v230, v15, v30
	.loc	1 182 17                        ; kda_gluon.py:182:17
	s_clause 0x2
	buffer_store_b64 v[2:3], v5, s[28:31], 0 offen
	buffer_store_b64 v[2:3], v6, s[28:31], 0 offen
	buffer_store_b64 v[2:3], v7, s[28:31], 0 offen
	v_add_lshl_u32 v5, s18, v190, 2
	buffer_store_b64 v[2:3], v4, s[28:31], 0 offen
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v48, 0 :: v_dual_add_nc_u32 v7, 0, v7
	v_xor_b32_e32 v3, v10, v9
	v_dual_mov_b32 v41, v159 :: v_dual_add_nc_u32 v4, 0, v4
	...
	v_dual_mov_b32 v50, 0 :: v_dual_add_nc_u32 v3, 0, v3
	s_cselect_b32 s22, s37, s22
	s_cselect_b32 s30, s45, s30
	s_add_i32 s37, s22, 1
	s_cmp_ge_u32 s30, s31
	...
	s_xor_b32 s22, s22, s49
	s_and_b32 s21, s23, 0xffff
	s_sub_i32 s22, s22, s49
	v_dual_mov_b32 v43, v159 :: v_dual_add_nc_u32 v4, 0, v5
	.loc	1 119 22                        ; kda_gluon.py:119:22
	s_mul_i32 s23, s22, s51
	.loc	1 189 21                        ; kda_gluon.py:189:21
	...
	v_dual_mov_b32 v49, v159 :: v_dual_add_nc_u32 v2, v2, v11
	.loc	1 190 9                         ; kda_gluon.py:190:9
	s_mul_i32 s2, s46, s48
	scratch_store_b32 off, v4, off offset:40 ; 4-byte Folded Spill
	s_add_i32 s2, s2, s47
	v_dual_mov_b32 v47, v159 :: v_dual_add_nc_u32 v4, 0, v6
	v_add_lshl_u32 v211, s2, v0, 1
	v_dual_mov_b32 v51, v159 :: v_dual_add_nc_u32 v0, 0, v1
	scratch_store_b32 off, v4, off offset:44 ; 4-byte Folded Spill
	s_mul_i32 s56, s43, s51
	...
	v_dual_mov_b32 v45, v159 :: v_dual_add_nc_u32 v228, 0, v12
	v_lshl_add_u32 v232, s43, 1, v8
	v_dual_mov_b32 v52, 0 :: v_dual_mov_b32 v53, v159
	v_dual_mov_b32 v54, 0 :: v_dual_mov_b32 v55, v159
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v57, v159
	v_dual_mov_b32 v58, 0 :: v_dual_mov_b32 v59, v159
	v_dual_mov_b32 v60, 0 :: v_dual_mov_b32 v61, v159
	v_dual_mov_b32 v62, 0 :: v_dual_mov_b32 v63, v159
	v_dual_mov_b32 v64, 0 :: v_dual_mov_b32 v65, v159
	v_dual_mov_b32 v66, 0 :: v_dual_mov_b32 v67, v159
	v_dual_mov_b32 v68, 0 :: v_dual_mov_b32 v69, v159
	v_dual_mov_b32 v70, 0 :: v_dual_mov_b32 v71, v159
	v_dual_mov_b32 v72, 0 :: v_dual_mov_b32 v73, v159
	v_dual_mov_b32 v74, 0 :: v_dual_mov_b32 v75, v159
	v_dual_mov_b32 v76, 0 :: v_dual_mov_b32 v77, v159
	v_dual_mov_b32 v78, 0 :: v_dual_mov_b32 v79, v159
	v_dual_mov_b32 v80, 0 :: v_dual_mov_b32 v81, v159
	v_dual_mov_b32 v82, 0 :: v_dual_mov_b32 v83, v159
	v_dual_mov_b32 v84, 0 :: v_dual_mov_b32 v85, v159
	v_dual_mov_b32 v86, 0 :: v_dual_mov_b32 v87, v159
	v_dual_mov_b32 v88, 0 :: v_dual_mov_b32 v89, v159
	v_dual_mov_b32 v90, 0 :: v_dual_mov_b32 v91, v159
	v_dual_mov_b32 v92, 0 :: v_dual_mov_b32 v93, v159
	v_dual_mov_b32 v94, 0 :: v_dual_mov_b32 v95, v159
	v_dual_mov_b32 v96, 0 :: v_dual_mov_b32 v97, v159
	v_dual_mov_b32 v98, 0 :: v_dual_mov_b32 v99, v159
	v_dual_mov_b32 v100, 0 :: v_dual_mov_b32 v101, v159
	v_dual_mov_b32 v102, 0 :: v_dual_mov_b32 v103, v159
	v_dual_mov_b32 v104, 0 :: v_dual_mov_b32 v105, v159
	v_dual_mov_b32 v106, 0 :: v_dual_mov_b32 v107, v159
	v_dual_mov_b32 v108, 0 :: v_dual_mov_b32 v109, v159
	v_dual_mov_b32 v110, 0 :: v_dual_mov_b32 v111, v159
	v_dual_mov_b32 v112, 0 :: v_dual_mov_b32 v113, v159
	v_dual_mov_b32 v114, 0 :: v_dual_mov_b32 v115, v159
	v_dual_mov_b32 v116, 0 :: v_dual_mov_b32 v117, v159
	v_dual_mov_b32 v118, 0 :: v_dual_mov_b32 v119, v159
	v_dual_mov_b32 v120, 0 :: v_dual_mov_b32 v121, v159
	v_dual_mov_b32 v122, 0 :: v_dual_mov_b32 v123, v159
	v_dual_mov_b32 v124, 0 :: v_dual_mov_b32 v125, v159
	v_dual_mov_b32 v126, 0 :: v_dual_mov_b32 v127, v159
	v_dual_mov_b32 v128, 0 :: v_dual_mov_b32 v129, v159
	v_dual_mov_b32 v130, 0 :: v_dual_mov_b32 v131, v159
	v_dual_mov_b32 v132, 0 :: v_dual_mov_b32 v133, v159
	v_dual_mov_b32 v134, 0 :: v_dual_mov_b32 v135, v159
	v_dual_mov_b32 v136, 0 :: v_dual_mov_b32 v137, v159
	v_dual_mov_b32 v138, 0 :: v_dual_mov_b32 v139, v159
	v_dual_mov_b32 v140, 0 :: v_dual_mov_b32 v141, v159
	v_dual_mov_b32 v142, 0 :: v_dual_mov_b32 v143, v159
	v_dual_mov_b32 v144, 0 :: v_dual_mov_b32 v145, v159
	v_dual_mov_b32 v146, 0 :: v_dual_mov_b32 v147, v159
	v_dual_mov_b32 v148, 0 :: v_dual_mov_b32 v149, v159
	v_dual_mov_b32 v150, 0 :: v_dual_mov_b32 v151, v159
	v_dual_mov_b32 v152, 0 :: v_dual_mov_b32 v153, v159
	v_dual_mov_b32 v154, 0 :: v_dual_mov_b32 v155, v159
	v_dual_mov_b32 v156, 0 :: v_dual_mov_b32 v157, v159
	v_mov_b32_e32 v158, 0
	v_lshl_add_u32 v235, s43, 2, v31
	s_mov_b32 s44, s26
	s_mul_i32 s26, s46, s51
	s_mov_b32 s53, 8
	s_and_b32 s25, s25, 0xffff
	s_and_b32 s45, s27, 0xffff
	s_and_b32 s41, s41, 0xffff
	s_lshl_b32 s54, s26, 1
	s_lshl_b32 s55, s56, 1
...
.Ltmp2:
	...
	s_mov_b32 s30, s38
	s_mov_b32 s31, s39
	v_dual_mov_b32 v195, v226 :: v_dual_add_nc_u32 v232, s55, v232
	v_dual_mov_b32 v193, v164 :: v_dual_mov_b32 v194, v234
	v_mov_b32_e32 v197, v180
	v_dual_mov_b32 v198, v208 :: v_dual_mov_b32 v199, v182
	v_mov_b32_e32 v201, v184
	v_mov_b32_e32 v203, v186
	v_mov_b32_e32 v205, v188
	s_waitcnt vmcnt(3)
	v_dual_mov_b32 v191, v174 :: v_dual_lshlrev_b32 v2, 16, v2
	.loc	1 235 21                        ; kda_gluon.py:235:21
	s_waitcnt vmcnt(1)
...
.Ltmp25:
	...
	.loc	1 267 21                        ; kda_gluon.py:267:21
	v_cndmask_b32_e64 v2, 0x80000000, v211, s18
	.loc	1 311 21                        ; kda_gluon.py:311:21
	v_add_nc_u32_e32 v211, s54, v211
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 274 28                        ; kda_gluon.py:274:28
...
.Ltmp27:
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	scratch_load_b32 v206, off, off offset:60 ; 4-byte Folded Reload
	.loc	1 310 32                        ; kda_gluon.py:310:32
	s_add_i32 s22, s57, s53
	s_and_b32 s2, s2, 7
	...
	.loc	1 313 30                        ; kda_gluon.py:313:30
	s_lshr_b32 s26, s23, 29
	.loc	1 310 31                        ; kda_gluon.py:310:31
	s_or_b32 s23, s22, s2
	.loc	1 313 30                        ; kda_gluon.py:313:30
	s_add_i32 s2, s53, s26
	.loc	1 311 21                        ; kda_gluon.py:311:21
	s_add_i32 s53, s53, 1
	.loc	1 313 30                        ; kda_gluon.py:313:30
	s_ashr_i32 s2, s2, 3
	...
	ds_load_b128 v[4:7], v228 offset:16
	...
	.loc	1 282 27                        ; kda_gluon.py:282:27
	ds_load_b128 v[0:3], v228 offset:128
	ds_load_b128 v[4:7], v228 offset:144
	.loc	1 284 21                        ; kda_gluon.py:284:21
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 282 27                        ; kda_gluon.py:282:27
	ds_load_b128 v[0:3], v228 offset:256
	ds_load_b128 v[4:7], v228 offset:272
	.loc	1 284 21                        ; kda_gluon.py:284:21
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 282 27                        ; kda_gluon.py:282:27
	ds_load_b128 v[0:3], v228 offset:384
	ds_load_b128 v[4:7], v228 offset:400
...
.Ltmp32:
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[12:15], v228
	ds_load_b128 v[24:27], v228 offset:16
	ds_load_b128 v[28:31], v228 offset:128
	ds_load_b128 v[20:23], v228 offset:144
	.loc	1 284 21                        ; kda_gluon.py:284:21
	v_mul_f32_e32 v158, v158, v7
	.loc	1 283 23                        ; kda_gluon.py:283:23
	ds_load_b128 v[16:19], v228 offset:256
	ds_load_b128 v[8:11], v228 offset:272
	...
	s_waitcnt lgkmcnt(2)
	v_mul_f32_e32 v250, v124, v23
	v_mul_f32_e32 v161, v109, v27
	v_mul_f32_e32 v253, v45, v26
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v251, v140, v11 :: v_dual_mul_f32 v254, v61, v22
.Ltmp33:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
	v_fmac_f32_e32 v1, v40, v24
	v_fmac_f32_e32 v250, v120, v21
	v_fmac_f32_e32 v0, v32, v12
	v_fmac_f32_e32 v253, v41, v24
	v_dual_fmac_f32 v251, v136, v9 :: v_dual_fmac_f32 v254, v57, v20
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
.Ltmp34:
	.loc	1 285 33                        ; kda_gluon.py:285:33
	v_dual_mul_f32 v255, v77, v10 :: v_dual_add_f32 v244, v0, v1
	v_mul_f32_e32 v0, v52, v30
	v_mul_f32_e32 v1, v60, v22
	v_mul_f32_e32 v249, v108, v27
.Ltmp35:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
	v_fmac_f32_e32 v255, v73, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v161, v105, v25 :: v_dual_fmac_f32 v0, v48, v28
...
.Ltmp36:
	...
	v_dual_mul_f32 v162, v125, v23 :: v_dual_add_f32 v245, v0, v1
...
.Ltmp38:
	.loc	1 283 23                        ; kda_gluon.py:283:23
	ds_load_b128 v[4:7], v228 offset:384
	ds_load_b128 v[0:3], v228 offset:400
.Ltmp39:
...
.Ltmp41:
	...
	v_dual_fmac_f32 v162, v121, v21 :: v_dual_add_f32 v245, v246, v247
...
.Ltmp45:
	...
	v_dual_fmac_f32 v250, v128, v17 :: v_dual_mul_f32 v249, v158, v3
...
.Ltmp47:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v164, v153, v1 :: v_dual_add_f32 v247, v250, v251
...
.Ltmp49:
	...
	v_dual_fmac_f32 v250, v155, v1 :: v_dual_fmac_f32 v253, v49, v28
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
...
.Ltmp53:
	...
	v_dual_fmac_f32 v255, v129, v17 :: v_dual_add_f32 v160, v254, v160
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
...
.Ltmp55:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
	v_dual_add_f32 v161, v161, v162 :: v_dual_add_f32 v160, v248, v160
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp56:
	.loc	1 285 33                        ; kda_gluon.py:285:33
	v_dual_mul_f32 v248, v142, v11 :: v_dual_fmac_f32 v255, v145, v5
.Ltmp57:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
	...
	v_add_f32_e32 v164, v246, v247
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
.Ltmp58:
	.loc	1 285 33                        ; kda_gluon.py:285:33
	v_dual_mul_f32 v246, v110, v27 :: v_dual_add_f32 v161, v161, v162
.Ltmp59:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
...
.Ltmp61:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	v_permlanex16_b32 v163, v160, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp62:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
...
.Ltmp64:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	v_permlanex16_b32 v161, v162, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp65:
	.loc	1 285 33                        ; kda_gluon.py:285:33
...
.Ltmp71:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v247, v126, v23 :: v_dual_add_f32 v160, v160, v161
.Ltmp72:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
...
.Ltmp80:
	...
	v_dual_add_f32 v161, v162, v163 :: v_dual_mul_f32 v162, v63, v22
.Ltmp81:
	.loc	1 285 33                        ; kda_gluon.py:285:33
...
.Ltmp82:
	...
	v_dual_add_f32 v160, v160, v161 :: v_dual_fmac_f32 v163, v75, v8
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp83:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	v_permlanex16_b32 v161, v160, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp84:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
...
.Ltmp90:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
	v_dual_add_f32 v161, v162, v163 :: v_dual_fmac_f32 v164, v99, v13
	v_add_f32_e32 v160, v160, v161
...
.Ltmp97:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	ds_store_b128 v176, v[244:247]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[244:247], v177
.Ltmp98:
...
.Ltmp99:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	v_permlanex16_b32 v160, v244, s58, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v161, v245, s58, 0xfedcba98 op_sel:[1,0]
...
.Ltmp101:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:285:26 ]
	v_permlanex16_b32 v160, v246, s58, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v161, v247, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp102:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:285:26 ] ]
...
.Ltmp103:
	...
	.loc	1 286 26                        ; kda_gluon.py:286:26
	ds_store_2addr_b64 v178, v[244:245], v[246:247] offset1:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[243:246], v178 offset1:16
	.loc	1 294 27                        ; kda_gluon.py:294:27
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 292 13                        ; kda_gluon.py:292:13
	v_fmac_f32_e32 v99, v13, v246
	v_dual_fmac_f32 v106, v25, v245 :: v_dual_fmac_f32 v127, v23, v246
	v_fmac_f32_e32 v109, v27, v244
	v_dual_fmac_f32 v110, v27, v245 :: v_dual_fmac_f32 v65, v16, v244
	v_dual_fmac_f32 v134, v19, v245 :: v_dual_fmac_f32 v89, v0, v244
	v_dual_fmac_f32 v76, v10, v243 :: v_dual_fmac_f32 v91, v0, v246
	v_dual_fmac_f32 v78, v10, v245 :: v_dual_fmac_f32 v153, v1, v244
	v_dual_fmac_f32 v140, v11, v243 :: v_dual_fmac_f32 v155, v1, v246
	v_fmac_f32_e32 v88, v0, v243
	...
	.loc	1 292 13                        ; kda_gluon.py:292:13
	v_fmac_f32_e32 v107, v25, v246
	v_dual_fmac_f32 v96, v13, v243 :: v_dual_fmac_f32 v117, v31, v244
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 295 21                        ; kda_gluon.py:295:21
	v_dual_mul_f32 v0, s52, v0 :: v_dual_mul_f32 v1, s52, v1
	.loc	1 292 13                        ; kda_gluon.py:292:13
	v_fmac_f32_e32 v97, v13, v244
	v_dual_fmac_f32 v98, v13, v245 :: v_dual_fmac_f32 v119, v31, v246
	v_fmac_f32_e32 v101, v15, v244
	v_dual_fmac_f32 v102, v15, v245 :: v_dual_fmac_f32 v57, v20, v244
	v_dual_fmac_f32 v103, v15, v246 :: v_dual_fmac_f32 v104, v25, v243
	v_fmac_f32_e32 v125, v23, v244
	v_dual_fmac_f32 v105, v25, v244 :: v_dual_fmac_f32 v108, v27, v243
	v_fmac_f32_e32 v123, v21, v246
	v_dual_fmac_f32 v111, v27, v246 :: v_dual_fmac_f32 v112, v29, v243
	v_fmac_f32_e32 v133, v19, v244
	v_dual_fmac_f32 v116, v31, v243 :: v_dual_fmac_f32 v131, v17, v246
	v_dual_fmac_f32 v126, v23, v245 :: v_dual_fmac_f32 v81, v4, v244
	v_dual_fmac_f32 v64, v16, v243 :: v_dual_fmac_f32 v85, v6, v244
	v_dual_fmac_f32 v66, v16, v245 :: v_dual_fmac_f32 v87, v6, v246
	v_dual_fmac_f32 v68, v18, v243 :: v_dual_fmac_f32 v83, v4, v246
	v_dual_fmac_f32 v70, v18, v245 :: v_dual_fmac_f32 v145, v5, v244
	v_dual_fmac_f32 v128, v17, v243 :: v_dual_fmac_f32 v149, v7, v244
	v_dual_fmac_f32 v130, v17, v245 :: v_dual_fmac_f32 v151, v7, v246
	v_dual_fmac_f32 v132, v19, v243 :: v_dual_fmac_f32 v147, v5, v246
	v_dual_fmac_f32 v72, v8, v243 :: v_dual_fmac_f32 v93, v2, v244
	v_dual_fmac_f32 v74, v8, v245 :: v_dual_fmac_f32 v95, v2, v246
	v_dual_fmac_f32 v136, v9, v243 :: v_dual_fmac_f32 v157, v3, v244
	v_dual_fmac_f32 v138, v9, v245 :: v_dual_fmac_f32 v159, v3, v246
	v_fmac_f32_e32 v80, v4, v243
	v_fmac_f32_e32 v82, v4, v245
	...
	v_dual_fmac_f32 v47, v26, v246 :: v_dual_fmac_f32 v32, v12, v243
	v_fmac_f32_e32 v53, v30, v244
	v_fmac_f32_e32 v33, v12, v244
	v_dual_fmac_f32 v34, v12, v245 :: v_dual_fmac_f32 v55, v30, v246
	v_fmac_f32_e32 v35, v12, v246
	v_dual_fmac_f32 v40, v24, v243 :: v_dual_fmac_f32 v61, v22, v244
	v_fmac_f32_e32 v41, v24, v244
	v_dual_fmac_f32 v42, v24, v245 :: v_dual_fmac_f32 v63, v22, v246
	v_fmac_f32_e32 v43, v24, v246
	v_dual_fmac_f32 v48, v28, v243 :: v_dual_fmac_f32 v69, v18, v244
	v_dual_fmac_f32 v50, v28, v245 :: v_dual_fmac_f32 v71, v18, v246
	v_dual_fmac_f32 v52, v30, v243 :: v_dual_fmac_f32 v67, v16, v246
	v_dual_fmac_f32 v54, v30, v245 :: v_dual_fmac_f32 v129, v17, v244
	v_dual_fmac_f32 v114, v29, v245 :: v_dual_fmac_f32 v135, v19, v246
	v_dual_fmac_f32 v118, v31, v245 :: v_dual_fmac_f32 v73, v8, v244
	v_dual_fmac_f32 v56, v20, v243 :: v_dual_fmac_f32 v77, v10, v244
	v_dual_fmac_f32 v58, v20, v245 :: v_dual_fmac_f32 v79, v10, v246
	v_dual_fmac_f32 v60, v22, v243 :: v_dual_fmac_f32 v75, v8, v246
	v_dual_fmac_f32 v62, v22, v245 :: v_dual_fmac_f32 v137, v9, v244
	v_dual_fmac_f32 v120, v21, v243 :: v_dual_fmac_f32 v141, v11, v244
	v_dual_fmac_f32 v122, v21, v245 :: v_dual_fmac_f32 v143, v11, v246
	...
	v_dual_mul_f32 v23, v111, v7 :: v_dual_fmac_f32 v8, v32, v0
.Ltmp104:
...
.Ltmp105:
	...
	v_dual_mov_b32 v204, v187 :: v_dual_add_f32 v9, v9, v17
	v_dual_mov_b32 v187, v170 :: v_dual_mov_b32 v206, v189
.Ltmp106:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
...
.Ltmp107:
	...
	v_mul_f32_e32 v240, v127, v7
.Ltmp108:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_fmac_f32_e32 v24, v48, v0
	v_dual_fmac_f32 v25, v112, v1 :: v_dual_fmac_f32 v26, v49, v0
...
.Ltmp110:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_add_f32_e32 v19, v27, v163
	v_dual_mov_b32 v163, v180 :: v_dual_add_f32 v10, v10, v18
	scratch_load_b32 v27, off, off offset:28 ; 4-byte Folded Reload
.Ltmp111:
	.loc	1 298 33                        ; kda_gluon.py:298:33
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v241, v68, v2
	v_dual_mul_f32 v242, v132, v3 :: v_dual_mul_f32 v243, v69, v2
...
.Ltmp113:
	...
	v_dual_mov_b32 v188, v171 :: v_dual_mov_b32 v185, v168
	.loc	1 298 33                        ; kda_gluon.py:298:33
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v167, v148, v3
	v_mul_f32_e32 v171, v150, v3
	v_mul_f32_e32 v170, v86, v2
	v_mul_f32_e32 v172, v87, v2
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v174, v94, v6 :: v_dual_fmac_f32 v167, v144, v1
...
.Ltmp117:
	.loc	1 298 33                        ; kda_gluon.py:298:33
	v_dual_mul_f32 v1, v156, v7 :: v_dual_mov_b32 v208, v190
	v_mov_b32_e32 v190, v173
	v_dual_mul_f32 v173, v157, v7 :: v_dual_mov_b32 v226, v200
	v_dual_mov_b32 v200, v183 :: v_dual_mov_b32 v183, v166
	v_mul_f32_e32 v166, v84, v2
	v_dual_mul_f32 v168, v85, v2 :: v_dual_fmac_f32 v1, v152, v5
.Ltmp118:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_fmac_f32_e32 v172, v83, v0
.Ltmp119:
	.loc	1 298 33                        ; kda_gluon.py:298:33
...
.Ltmp120:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_dual_fmac_f32 v166, v80, v0 :: v_dual_fmac_f32 v175, v154, v5
	v_dual_fmac_f32 v168, v81, v0 :: v_dual_add_f32 v17, v242, v250
	v_fmac_f32_e32 v173, v153, v5
	v_dual_add_f32 v1, v167, v1 :: v_dual_mul_f32 v0, v92, v6
.Ltmp121:
	.loc	1 298 33                        ; kda_gluon.py:298:33
...
.Ltmp122:
	...
	v_dual_fmac_f32 v174, v90, v4 :: v_dual_add_f32 v1, v17, v1
	v_add_f32_e32 v18, v26, v162
	v_fmac_f32_e32 v6, v91, v4
	v_dual_add_f32 v26, v169, v173 :: v_dual_mov_b32 v169, v186
...
.Ltmp124:
	...
	v_dual_mov_b32 v162, v179 :: v_dual_add_f32 v5, v5, v7
	v_add_f32_e32 v0, v166, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_add_f32_e32 v7, v9, v16
	v_dual_add_f32 v9, v11, v19 :: v_dual_add_f32 v2, v168, v2
	v_dual_add_f32 v11, v246, v254 :: v_dual_add_f32 v0, v8, v0
	v_add_f32_e32 v8, v10, v18
	v_add_f32_e32 v10, v25, v26
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_add_f32 v2, v24, v2 :: v_dual_add_f32 v1, v7, v1
	v_dual_add_f32 v0, v5, v0 :: v_dual_mov_b32 v179, v196
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_f32_e32 v5, v9, v10
	v_dual_add_f32 v2, v8, v2 :: v_dual_add_f32 v7, v245, v253
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_add_f32_e32 v0, v0, v1
	v_dual_add_f32 v8, v170, v174 :: v_dual_add_f32 v9, v13, v21
	v_dual_add_f32 v1, v2, v5 :: v_dual_add_f32 v10, v29, v238
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
.Ltmp125:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:298:26 ]
	v_permlanex16_b32 v2, v0, s58, 0xfedcba98 op_sel:[1,0]
	v_dual_mov_b32 v170, v187 :: v_dual_mov_b32 v187, v204
	v_permlanex16_b32 v5, v1, s58, 0xfedcba98 op_sel:[1,0]
	v_dual_mov_b32 v168, v185 :: v_dual_add_f32 v3, v3, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp126:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_add_f32_e32 v0, v0, v2
	v_dual_add_f32 v2, v12, v20 :: v_dual_add_f32 v1, v1, v5
	v_dual_add_f32 v5, v28, v164 :: v_dual_add_f32 v12, v171, v175
	v_dual_mov_b32 v185, v202 :: v_dual_mov_b32 v166, v183
	v_mov_b32_e32 v171, v188
	v_dual_mov_b32 v183, v200 :: v_dual_mov_b32 v200, v226
	v_mov_b32_e32 v226, v195
	...
	v_dual_add_f32 v6, v172, v6 :: v_dual_add_f32 v9, v15, v23
	s_delay_alu instid0(VALU_DEP_4)
	v_add_f32_e32 v2, v2, v5
	v_dual_add_f32 v10, v31, v240 :: v_dual_add_f32 v11, v248, v165
...
.Ltmp127:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:298:26 ]
	v_permlanex16_b32 v5, v2, s58, 0xfedcba98 op_sel:[1,0]
	s_clause 0x2                            ; 12-byte Folded Reload
...
.Ltmp128:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_dual_add_f32 v3, v11, v3 :: v_dual_add_f32 v2, v2, v5
...
.Ltmp130:
	...
	v_dual_mov_b32 v164, v193 :: v_dual_mov_b32 v165, v182
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_add_f32 v4, v4, v5 :: v_dual_add_f32 v3, v6, v3
	v_mov_b32_e32 v186, v203
	v_mov_b32_e32 v172, v189
	v_dual_mov_b32 v174, v191 :: v_dual_mov_b32 v175, v192
	v_dual_add_f32 v3, v4, v3 :: v_dual_mov_b32 v208, v198
	v_mov_b32_e32 v182, v199
	v_dual_mov_b32 v188, v205 :: v_dual_mov_b32 v189, v206
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp131:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:298:26 ]
	v_permlanex16_b32 v4, v3, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp132:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
...
.Ltmp135:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:298:26 ]
	v_permlanex16_b32 v4, v0, s58, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v5, v1, s58, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
.Ltmp136:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
...
.Ltmp137:
	.loc	2 293 12                        ; standard.py:293:12 @[ kda_gluon.py:298:26 ]
	v_permlanex16_b32 v4, v2, s58, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v5, v3, s58, 0xfedcba98 op_sel:[1,0]
.Ltmp138:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ kda_gluon.py:298:26 ] ]
	v_dual_add_f32 v2, v2, v4 :: v_dual_add_f32 v3, v3, v5
.Ltmp139:
	.loc	1 299 26                        ; kda_gluon.py:299:26
	ds_store_2addr_b64 v178, v[0:1], v[2:3] offset1:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v0, v237
	...
	v_add_lshl_u32 v0, s22, v207, 2
	v_cndmask_b32_e64 v0, 0x80000000, v0, s2
	.loc	1 311 21                        ; kda_gluon.py:311:21
	s_add_i32 s2, s57, s53
	s_delay_alu instid0(SALU_CYCLE_1)
	s_cmp_lg_u32 s2, 8
	.loc	1 327 21                        ; kda_gluon.py:327:21
...
.Ltmp140:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8, .Lfunc_end0-amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_vgpr, 256
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_agpr, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.numbered_sgpr, 59
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.private_seg_size, 76
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_recursion, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8"                        ; string offset=88 ; amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
    .private_segment_fixed_size: 76
    .sgpr_count:     61
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_kda_fwd_cache_bf16xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.kd
