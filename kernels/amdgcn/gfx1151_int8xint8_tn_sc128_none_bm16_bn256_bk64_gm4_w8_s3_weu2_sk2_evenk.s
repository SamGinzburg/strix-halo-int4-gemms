...
.Ltmp19:
	...
	buffer_load_b32 v12, v2, s[4:7], 0 offen
	...
	.loc	1 402 30 is_stmt 1              ; generate_amdgcn.py:402:30
	v_add3_u32 v10, s15, s16, v9
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v28, s12, v36
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_cndmask_b32_e64 v2, 0x80000000, v10, s3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v10, 0x80000000, v28, s3
	s_clause 0x1
	...
	buffer_load_b128 v[55:58], v10, s[20:23], 0 offen
	.loc	1 402 22 is_stmt 1              ; generate_amdgcn.py:402:22
	buffer_load_b32 v10, v2, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v2, v0, 0, 1
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	v_add_nc_u32_e32 v63, 0x4000, v32
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(9)
	ds_store_b32 v11, v12 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	v_perm_b32 v12, v16, v5, 0x4000501
	...
	v_perm_b32 v50, v12, v19, 0x7060302
	v_perm_b32 v12, v12, v19, 0x5040100
	v_perm_b32 v19, v5, v20, 0x7060302
	...
	ds_store_2addr_b32 v32, v50, v12 offset1:16
	ds_store_2addr_b32 v33, v19, v5 offset1:16
	...
	ds_store_2addr_b32 v32, v25, v7 offset0:160 offset1:176
	...
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b32 v11, v10 offset:33792
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 179
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 47
