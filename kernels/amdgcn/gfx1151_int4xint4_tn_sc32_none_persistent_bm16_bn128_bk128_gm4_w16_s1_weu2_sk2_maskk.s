	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
.Lfunc_begin0:
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	v_dual_mov_b32 v48, 0 :: v_dual_mov_b32 v3, 0
	s_xor_b32 s0, s0, s1
	...
	s_add_i32 s13, s0, 1
	s_cmp_ge_u32 s10, s7
	v_dual_mov_b32 v97, 0 :: v_dual_mov_b32 v56, 0
	s_cselect_b32 s0, s13, s0
...
; %bb.3:                                ; %.lr.ph
	...
	v_mov_b32_e32 v98, 0
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v96, 0 :: v_dual_add_nc_u32 v3, s48, v0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_mul_f32_e32 v168, v26, v229
	v_mul_f32_e32 v173, v39, v229
	v_mul_f32_e32 v174, v40, v229
	v_mul_f32_e32 v175, v175, v229
	v_mul_f32_e32 v177, v177, v229
	v_dual_mul_f32 v158, v2, v229 :: v_dual_lshlrev_b32 v39, 16, v123
	v_mul_f32_e32 v159, v8, v229
	s_waitcnt vmcnt(37)
	v_dual_mul_f32 v160, v10, v229 :: v_dual_lshlrev_b32 v1, 16, v107
	s_waitcnt vmcnt(36)
	v_dual_mul_f32 v161, v11, v229 :: v_dual_lshlrev_b32 v2, 16, v108
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(30)
	v_lshlrev_b32_e32 v40, 16, v124
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v162, v12, v229 :: v_dual_lshlrev_b32 v11, 16, v111
	v_dual_mul_f32 v163, v14, v229 :: v_dual_lshlrev_b32 v10, 16, v110
	v_mul_f32_e32 v164, v16, v229
	v_dual_mul_f32 v165, v23, v229 :: v_dual_lshlrev_b32 v12, 16, v112
	v_mul_f32_e32 v166, v24, v229
	v_dual_mul_f32 v167, v25, v229 :: v_dual_lshlrev_b32 v16, 16, v114
	v_dual_mul_f32 v169, v27, v229 :: v_dual_lshlrev_b32 v24, 16, v116
	s_waitcnt vmcnt(27)
	v_dual_mul_f32 v170, v28, v229 :: v_dual_lshlrev_b32 v107, 16, v126
	v_dual_mul_f32 v171, v29, v229 :: v_dual_lshlrev_b32 v26, 16, v118
	v_mul_f32_e32 v172, v38, v229
	v_mul_f32_e32 v176, v176, v229
	v_mul_f32_e32 v178, v178, v229
	v_dual_mul_f32 v179, v179, v229 :: v_dual_lshlrev_b32 v108, 16, v127
	v_mul_f32_e32 v180, v180, v229
	v_mul_f32_e32 v181, v181, v229
	v_mul_f32_e32 v182, v182, v229
	v_mul_f32_e32 v183, v183, v229
	v_dual_mul_f32 v184, v184, v229 :: v_dual_lshlrev_b32 v123, 16, v142
	v_mul_f32_e32 v185, v185, v229
	v_mul_f32_e32 v186, v186, v229
	v_mul_f32_e32 v187, v187, v229
	v_mul_f32_e32 v188, v188, v229
	v_dual_mul_f32 v189, v189, v229 :: v_dual_lshlrev_b32 v124, 16, v143
	...
	v_dual_mul_f32 v208, v208, v229 :: v_dual_fmac_f32 v83, v163, v12
	v_dual_mul_f32 v209, v209, v229 :: v_dual_fmac_f32 v94, v159, v2
	v_dual_mul_f32 v211, v211, v229 :: v_dual_fmac_f32 v88, v161, v10
	v_dual_mul_f32 v212, v212, v229 :: v_dual_fmac_f32 v61, v167, v24
	v_dual_mul_f32 v213, v213, v229 :: v_dual_fmac_f32 v86, v162, v11
	v_dual_mul_f32 v214, v214, v229 :: v_dual_fmac_f32 v57, v169, v26
	v_dual_mul_f32 v215, v215, v229 :: v_dual_fmac_f32 v66, v165, v16
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v23, 16, v115
	v_lshlrev_b32_e32 v27, 16, v119
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v217, v217, v229
	v_dual_mul_f32 v219, v219, v229 :: v_dual_lshlrev_b32 v28, 16, v120
	v_mul_f32_e32 v216, v216, v229
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v38, 16, v122
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v218, v218, v229
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v93, v175, v40 :: v_dual_lshlrev_b32 v14, 16, v113
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(26)
	v_dual_mul_f32 v210, v210, v229 :: v_dual_lshlrev_b32 v111, 16, v130
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v95, v174, v39 :: v_dual_lshlrev_b32 v8, 16, v109
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v87, v177, v107 :: v_dual_lshlrev_b32 v106, 16, v125
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v109, 16, v128
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v85, v178, v108 :: v_dual_lshlrev_b32 v110, 16, v129
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(27)
	v_lshlrev_b32_e32 v116, 16, v135
	v_lshlrev_b32_e32 v119, 16, v138
	v_lshlrev_b32_e32 v120, 16, v139
	v_lshlrev_b32_e32 v125, 16, v144
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v54, v186, v116 :: v_dual_lshlrev_b32 v29, 16, v121
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v121, 16, v140
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v80, v180, v110 :: v_dual_add_nc_u32 v105, s28, v105
	v_fmac_f32_e32 v91, v160, v8
	v_dual_fmac_f32 v81, v164, v14 :: v_dual_fmac_f32 v64, v166, v23
	v_dual_fmac_f32 v56, v170, v27 :: v_dual_fmac_f32 v53, v171, v28
	v_fmac_f32_e32 v97, v173, v38
	v_fmac_f32_e32 v84, v189, v119
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(26)
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v65, v181, v111 :: v_dual_lshlrev_b32 v114, 16, v133
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	v_lshlrev_b32_e32 v25, 16, v117
	s_waitcnt vmcnt(24)
	v_lshlrev_b32_e32 v118, 16, v136
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v63, v182, v112 :: v_dual_lshlrev_b32 v122, 16, v141
	v_dual_fmac_f32 v55, v185, v115 :: v_dual_lshlrev_b32 v126, 16, v145
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(22)
	v_lshlrev_b32_e32 v127, 16, v146
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v92, v188, v118 :: v_dual_lshlrev_b32 v117, 16, v137
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(21)
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(19)
	v_dual_fmac_f32 v79, v190, v120 :: v_dual_lshlrev_b32 v130, 16, v149
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(18)
	...
	s_waitcnt vmcnt(10)
	v_lshlrev_b32_e32 v139, 16, v221
	s_waitcnt vmcnt(9)
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v90, v176, v106 :: v_dual_add_nc_u32 v101, s45, v101
	v_dual_fmac_f32 v96, v158, v1 :: v_dual_fmac_f32 v77, v205, v135
	v_dual_fmac_f32 v99, v172, v29 :: v_dual_fmac_f32 v70, v194, v124
	v_dual_fmac_f32 v82, v179, v109 :: v_dual_fmac_f32 v49, v198, v128
	v_dual_fmac_f32 v60, v183, v113 :: v_dual_fmac_f32 v43, v202, v132
	v_fmac_f32_e32 v58, v184, v114
	v_fmac_f32_e32 v59, v168, v25
	v_dual_fmac_f32 v52, v187, v117 :: v_dual_fmac_f32 v75, v206, v136
	v_dual_fmac_f32 v76, v191, v121 :: v_dual_fmac_f32 v71, v208, v138
	v_dual_fmac_f32 v68, v195, v125 :: v_dual_fmac_f32 v69, v209, v139
	v_dual_fmac_f32 v50, v197, v127 :: v_dual_fmac_f32 v47, v199, v129
	v_dual_fmac_f32 v46, v200, v130 :: v_dual_fmac_f32 v41, v203, v133
	v_dual_fmac_f32 v62, v211, v141 :: v_dual_fmac_f32 v3, v212, v142
	v_dual_fmac_f32 v48, v213, v143 :: v_dual_fmac_f32 v45, v215, v145
	v_dual_fmac_f32 v72, v193, v123 :: v_dual_fmac_f32 v67, v210, v140
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(2)
	...
	v_fmac_f32_e32 v78, v204, v134
	v_dual_fmac_f32 v4, v214, v144 :: v_dual_fmac_f32 v7, v217, v147
	v_dual_fmac_f32 v42, v216, v146 :: v_dual_fmac_f32 v5, v218, v148
...
.LBB0_6:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v0, v92, v78 offset0:64 offset1:96
	s_waitcnt vmcnt(9)
	ds_store_2addr_b32 v1, v98, v97 offset1:32
	ds_store_2addr_b32 v1, v84, v77 offset0:64 offset1:96
	s_waitcnt vmcnt(8)
	ds_store_2addr_b32 v2, v96, v95 offset1:32
	ds_store_2addr_b32 v2, v79, v75 offset0:64 offset1:96
	s_waitcnt vmcnt(7)
	ds_store_2addr_b32 v8, v94, v93 offset1:32
	ds_store_2addr_b32 v8, v76, v73 offset0:64 offset1:96
	s_waitcnt vmcnt(6)
	ds_store_2addr_b32 v14, v91, v90 offset1:32
	ds_store_2addr_b32 v14, v74, v71 offset0:64 offset1:96
	s_waitcnt vmcnt(5)
	ds_store_2addr_b32 v16, v88, v87 offset1:32
	ds_store_2addr_b32 v16, v72, v69 offset0:64 offset1:96
	s_waitcnt vmcnt(4)
	ds_store_2addr_b32 v23, v86, v85 offset1:32
	ds_store_2addr_b32 v23, v70, v67 offset0:64 offset1:96
	s_waitcnt vmcnt(3)
	ds_store_2addr_b32 v24, v83, v82 offset1:32
	ds_store_2addr_b32 v24, v68, v62 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v35, v57, v55 offset1:32
	ds_store_2addr_b32 v35, v44, v7 offset0:64 offset1:96
	ds_store_2addr_b32 v36, v56, v54 offset1:32
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.private_seg_size, 92
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk
    .private_segment_fixed_size: 92
    .sgpr_count:     55
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk2_maskk.kd
