	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	v_cndmask_b32_e64 v10, 0x80000000, v8, s3
	.loc	1 406 30 is_stmt 0              ; generate_amdgcn.py:406:30
	v_add_nc_u32_e32 v8, 0x80, v8
	v_add_nc_u32_e32 v12, 0x80, v5
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	s_mov_b32 s12, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v44, v9, v8
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v10, 16, v6
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v8, v7, 1, v12
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_xor_b32_e32 v45, v11, v13
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(5)
	ds_store_b64 v38, v[34:35] offset:16384
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	s_waitcnt vmcnt(4)
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v38, v[36:37] offset:18432
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	...
	v_lshl_or_b32 v36, v6, 6, v7
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v3, s22, v3
...
.Ltmp23:
	...
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	v_add3_u32 v47, v4, v1, 0x100
	v_add3_u32 v48, v3, v2, 0x100
	v_xor_b32_e32 v37, 16, v36
	v_xor_b32_e32 v39, 32, v36
	v_add3_u32 v46, v5, v1, 0x100
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v80, v74, v80 :: v_dual_mul_f32 v89, v73, v81
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v79, 16, v125
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	s_waitcnt vmcnt(2)
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v15, v88, v54 :: v_dual_lshlrev_b32 v82, 16, v128
	v_fmac_f32_e32 v24, v80, v62
	...
	v_dual_mul_f32 v84, v73, v76 :: v_dual_lshlrev_b32 v75, 16, v121
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v12, v85, v51
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v83, v73, v75
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v129, s15, v44
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v11, v84, v50 :: v_dual_lshlrev_b32 v78, 16, v124
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v79, v74, v79
	v_mul_f32_e32 v77, v74, v77
	v_mul_f32_e32 v76, v74, v76
	v_dual_mul_f32 v75, v74, v75 :: v_dual_add_nc_u32 v130, s34, v45
	v_mul_f32_e32 v86, v73, v78
	v_mul_f32_e32 v73, v73, v82
	v_mul_f32_e32 v78, v74, v78
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v20, v76, v58 :: v_dual_mul_f32 v81, v74, v81
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v74, v74, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v10, v83, v49 :: v_dual_fmac_f32 v13, v86, v52
	v_fmac_f32_e32 v17, v73, v56
	v_dual_fmac_f32 v19, v75, v57 :: v_dual_fmac_f32 v22, v78, v60
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v21, v77, v59 :: v_dual_fmac_f32 v18, v74, v64
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.kd
