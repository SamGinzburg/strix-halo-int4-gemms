...
.LBB0_3:                                ; %Flow525
	...
	v_dual_mov_b32 v80, 0 :: v_dual_mov_b32 v123, 0
	...
	v_dual_mov_b32 v134, 0 :: v_dual_mov_b32 v71, 0
	v_dual_mov_b32 v128, 0 :: v_dual_mov_b32 v73, 0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v129, 0 :: v_dual_mov_b32 v80, 0
	v_dual_mov_b32 v127, 0 :: v_dual_mov_b32 v66, 0
	v_dual_mov_b32 v133, 0 :: v_dual_mov_b32 v68, 0
	v_dual_mov_b32 v131, 0 :: v_dual_mov_b32 v78, 0
	v_dual_mov_b32 v125, 0 :: v_dual_mov_b32 v76, 0
...
.LBB0_5:                                ; =>This Loop Header: Depth=1
	...
	scratch_store_b32 off, v112, off offset:176
	scratch_store_b32 off, v111, off offset:172
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	s_cmp_lt_i32 s48, s7
	.loc	1 1156 34                       ; ragged.py:1156:34
	v_cndmask_b32_e32 v136, 0x80000000, v71, vcc_lo
	.loc	1 1157 25                       ; ragged.py:1157:25
	...
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_mad_u64_u32 v[80:81], null, s4, s74, v[67:68]
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_mad_u64_u32 v[81:82], null, v83, s25, v[65:66]
	.loc	1 1156 34                       ; ragged.py:1156:34
	...
	v_cndmask_b32_e32 v84, 0x80000000, v81, vcc_lo
	.loc	1 1141 26                       ; ragged.py:1141:26
	v_or_b32_e32 v81, 4, v83
	s_mov_b32 s4, 32
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 1142 32                       ; ragged.py:1142:32
	v_cmp_gt_i32_e32 vcc_lo, s7, v81
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_mad_u64_u32 v[81:82], null, v81, s25, v[65:66]
	.loc	1 1155 66 is_stmt 0             ; ragged.py:1155:66
	s_and_b32 vcc_lo, s76, vcc_lo
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e32 v85, 0x80000000, v81, vcc_lo
	...
	s_and_b32 vcc_lo, s76, vcc_lo
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e32 v137, 0x80000000, v81, vcc_lo
	.loc	1 1141 26 is_stmt 1             ; ragged.py:1141:26
	...
	s_and_b32 vcc_lo, s76, vcc_lo
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e32 v138, 0x80000000, v81, vcc_lo
	.loc	1 1141 26 is_stmt 1             ; ragged.py:1141:26
	v_or_b32_e32 v81, 20, v83
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 1142 32                       ; ragged.py:1142:32
	v_cmp_gt_i32_e32 vcc_lo, s7, v81
	.loc	1 1155 42                       ; ragged.py:1155:42
	...
	s_and_b32 vcc_lo, s76, vcc_lo
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e32 v139, 0x80000000, v81, vcc_lo
	.loc	1 1141 26 is_stmt 1             ; ragged.py:1141:26
	v_or_b32_e32 v81, 24, v83
	.loc	1 1142 32                       ; ragged.py:1142:32
	v_cmp_gt_i32_e32 vcc_lo, s7, v81
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_mad_u64_u32 v[81:82], null, v81, s25, v[65:66]
	...
	s_and_b32 vcc_lo, s76, vcc_lo
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e32 v153, 0x80000000, v81, vcc_lo
	.loc	1 1141 26 is_stmt 1             ; ragged.py:1141:26
	v_or_b32_e32 v81, 28, v83
	...
	buffer_load_u8 v87, v69, s[8:11], 0 offen
	buffer_load_u8 v88, v155, s[8:11], 0 offen
	buffer_load_u8 v89, v156, s[8:11], 0 offen
	buffer_load_u8 v90, v157, s[8:11], 0 offen
	buffer_load_u8 v91, v158, s[8:11], 0 offen
	buffer_load_u8 v92, v159, s[8:11], 0 offen
	buffer_load_u8 v93, v160, s[8:11], 0 offen
	buffer_load_u8 v94, v161, s[8:11], 0 offen
	buffer_load_u8 v95, v162, s[8:11], 0 offen
	buffer_load_u8 v96, v163, s[8:11], 0 offen
	buffer_load_u8 v97, v164, s[8:11], 0 offen
	buffer_load_u8 v98, v165, s[8:11], 0 offen
	buffer_load_u8 v154, v166, s[8:11], 0 offen
	...
	buffer_load_u8 v104, v70, s[8:11], 0 offen
	buffer_load_u8 v105, v136, s[8:11], 0 offen
	buffer_load_u8 v106, v66, s[8:11], 0 offen
	buffer_load_u8 v107, v71, s[8:11], 0 offen
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_clause 0x7
	buffer_load_u8 v66, v84, s[20:23], 0 offen
	buffer_load_u8 v68, v85, s[20:23], 0 offen
	buffer_load_u8 v69, v86, s[20:23], 0 offen
	buffer_load_u8 v70, v138, s[20:23], 0 offen
	buffer_load_u8 v71, v139, s[20:23], 0 offen
	buffer_load_u8 v72, v153, s[20:23], 0 offen
	buffer_load_u8 v73, v81, s[20:23], 0 offen
	buffer_load_u8 v74, v137, s[20:23], 0 offen
	.loc	1 1156 34                       ; ragged.py:1156:34
	buffer_load_u8 v84, v80, s[8:11], 0 offen
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_waitcnt vmcnt(8)
	ds_store_b8 v142, v66
	s_waitcnt vmcnt(7)
	ds_store_b8 v142, v68 offset:256
	s_waitcnt vmcnt(6)
	ds_store_b8 v142, v69 offset:512
	s_waitcnt vmcnt(5)
	ds_store_b8 v142, v70 offset:1024
	s_waitcnt vmcnt(4)
	ds_store_b8 v142, v71 offset:1280
	s_waitcnt vmcnt(1)
	ds_store_b8 v143, v74
	ds_store_b8 v142, v72 offset:1536
	ds_store_b8 v144, v73
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	ds_load_u8 v66, v140 offset:320
	ds_load_u8 v68, v140 offset:256
	ds_load_u8 v138, v140 offset:336
	ds_load_u8 v139, v140 offset:272
	ds_load_u8 v249, v140 offset:352
	ds_load_u8 v250, v140 offset:288
	ds_load_u8 v243, v140 offset:368
	ds_load_u8 v244, v140 offset:304
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v68, v68, v66, 0xc0c0004
	ds_load_u8 v66, v140 offset:448
	ds_load_u8 v69, v140 offset:384
	ds_load_u8 v73, v140 offset:464
	ds_load_u8 v76, v140 offset:400
	ds_load_u8 v255, v140 offset:480
	ds_load_u8 v136, v140 offset:416
	ds_load_u8 v247, v140 offset:496
	ds_load_u8 v248, v140 offset:432
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v69, v69, v66, 0xc0c0004
	ds_load_u8 v70, v140 offset:64
	ds_load_u8 v71, v140
	ds_load_u8 v79, v140 offset:80
	ds_load_u8 v66, v140 offset:96
	ds_load_u8 v252, v140 offset:112
	ds_load_u8 v80, v140 offset:16
	ds_load_u8 v74, v140 offset:32
	ds_load_u8 v254, v140 offset:48
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v73, v76, v73, 0xc0c0004
	v_lshl_or_b32 v69, v69, 16, v68
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	ds_load_u8 v72, v140 offset:192
	ds_load_u8 v75, v140 offset:128
	ds_load_u8 v81, v140 offset:208
	ds_load_u8 v82, v140 offset:144
	ds_load_u8 v77, v140 offset:224
	ds_load_u8 v78, v140 offset:160
	ds_load_u8 v153, v140 offset:240
	ds_load_u8 v71, v140 offset:176
	...
	ds_load_u8 v245, v140 offset:960
	ds_load_u8 v246, v140 offset:896
	ds_load_u8 v211, v140 offset:1024
	ds_load_u8 v219, v140 offset:976
	...
	ds_load_u8 v251, v140 offset:832
	ds_load_u8 v253, v140 offset:768
	...
	ds_load_u8 v203, v140 offset:1392
	ds_load_u8 v205, v140 offset:1328
	ds_load_u8 v184, v140 offset:1984
	...
	ds_load_u8 v190, v140 offset:1920
	...
	ds_load_u8 v197, v140 offset:1728
	ds_load_u8 v200, v140 offset:1792
	...
	ds_load_u8 v204, v140 offset:1664
	...
	ds_store_b8 v142, v87 offset:256
	ds_store_b8 v142, v88 offset:512
	ds_store_b8 v142, v90 offset:1024
	ds_store_b8 v142, v91 offset:1280
	ds_store_b8 v142, v92 offset:1536
	ds_store_b8 v142, v94 offset:2048
	ds_store_b8 v142, v95 offset:2304
	ds_store_b8 v142, v96 offset:2560
	ds_store_b8 v142, v98 offset:3072
	ds_store_b8 v142, v154 offset:3328
	ds_store_b8 v142, v99 offset:3584
	ds_store_b8 v142, v101 offset:4096
	ds_store_b8 v142, v102 offset:4352
	ds_store_b8 v142, v103 offset:4608
	ds_store_b8 v142, v105 offset:5120
	ds_store_b8 v142, v106 offset:5376
	ds_store_b8 v142, v107 offset:5632
	ds_store_b8 v142, v109 offset:6144
	ds_store_b8 v142, v110 offset:6400
	ds_store_b8 v142, v111 offset:6656
	ds_store_b8 v142, v113 offset:7168
	ds_store_b8 v142, v114 offset:7424
	ds_store_b8 v142, v115 offset:7680
	ds_store_b8 v143, v89
	ds_store_b8 v144, v93
	ds_store_b8 v147, v97
	ds_store_b8 v148, v100
	ds_store_b8 v149, v104
	ds_store_b8 v150, v108
	ds_store_b8 v151, v112
	s_waitcnt vmcnt(0)
	ds_store_b8 v152, v84
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	...
	v_perm_b32 v76, v136, v255, 0xc0c0004
	v_perm_b32 v78, v254, v252, 0xc0c0004
	v_perm_b32 v71, v71, v153, 0xc0c0004
	v_perm_b32 v70, v137, v70, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	...
	v_lshl_or_b32 v80, v73, 16, v87
	v_perm_b32 v73, v250, v249, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	v_lshl_or_b32 v74, v76, 16, v73
	v_lshl_or_b32 v73, v77, 16, v66
	v_perm_b32 v66, v244, v243, 0xc0c0004
	v_lshl_or_b32 v84, v84, 16, v83
	v_perm_b32 v76, v248, v247, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v77, v76, 16, v66
	v_lshl_or_b32 v76, v71, 16, v78
	...
	v_wmma_i32_16x16x16_iu4 v[33:40], v[83:84], v[73:74], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[83:84], v[79:80], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[83:84], v[76:77], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[85:86], v[68:69], v[9:16] neg_lo:[1,1,0]
	v_perm_b32 v68, v246, v245, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[41:48], v[85:86], v[73:74], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[85:86], v[79:80], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[85:86], v[76:77], v[57:64] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4)
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	scratch_load_b32 v112, off, off offset:176
	...
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v134, v72, v1 :: v_dual_fmac_f32 v129, v77, v6
	v_dual_fmac_f32 v133, v73, v2 :: v_dual_fmac_f32 v132, v74, v3
	s_waitcnt lgkmcnt(1)
	v_fmac_f32_e32 v123, v83, v12
	v_dual_fmac_f32 v131, v75, v4 :: v_dual_fmac_f32 v130, v76, v5
	v_fmac_f32_e32 v125, v66, v10
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v128, v78, v7 :: v_dual_fmac_f32 v121, v80, v14
	v_fmac_f32_e32 v127, v79, v8
	v_dual_fmac_f32 v126, v71, v9 :: v_dual_fmac_f32 v119, v86, v16
	s_waitcnt vmcnt(27)
	v_dual_fmac_f32 v124, v82, v11 :: v_dual_fmac_f32 v111, v21, v5
	v_dual_fmac_f32 v122, v84, v13 :: v_dual_fmac_f32 v117, v18, v2
	s_waitcnt vmcnt(26)
	v_dual_fmac_f32 v120, v85, v15 :: v_dual_fmac_f32 v109, v22, v6
	s_clause 0xf                            ; 64-byte Folded Reload
	...
	s_waitcnt vmcnt(40)
	v_dual_fmac_f32 v118, v17, v1 :: v_dual_fmac_f32 v107, v24, v8
	v_fmac_f32_e32 v116, v19, v3
	v_fmac_f32_e32 v112, v20, v4
...
.Ltmp75:
	...
	v_div_scale_f32 v43, null, v47, v47, v112
	v_div_scale_f32 v46, null, v47, v47, v111
	...
	v_div_scale_f32 v49, s62, v112, v47, v112
	v_fmac_f32_e32 v45, v41, v45
	v_div_scale_f32 v41, s59, v111, v47, v111
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_div_fixup_f32 v36, v36, v47, v112
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_div_fixup_f32 v37, v37, v47, v111
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_maskk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 77
