...
.Ltmp2:
	...
	v_cmp_gt_i64_e64 s8, s[44:45], v[7:8]
	v_cmp_gt_i64_e64 s9, s[44:45], v[9:10]
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v9, s46, v25
	v_add_co_u32 v3, vcc_lo, v1, 16
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_add_co_ci_u32_e64 v4, null, 0, v2, vcc_lo
	...
	.loc	1 1205 25                       ; ragged.py:1205:25
	v_mul_lo_u32 v36, v1, s48
	v_mul_lo_u32 v37, v2, s48
	v_bfe_i32 v1, v0, 7, 1
	...
	v_mul_lo_u32 v68, v33, s50
	v_mul_lo_u32 v70, v26, s50
	v_mul_lo_u32 v72, v27, s50
	v_mul_lo_u32 v74, v28, s50
	...
	v_dual_mov_b32 v1, s12 :: v_dual_add_nc_u32 v76, s33, v10
	v_mov_b32_e32 v97, 0
	.loc	1 1135 19                       ; ragged.py:1135:19
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v119, s12, v35, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v162, v120
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v120, s12, v36, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v169, v121
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v121, s12, v37, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v170, v122
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v122, s12, v38, 1
	...
	buffer_load_u16 v178, v122, s[40:43], 0 offen
	.loc	1 1201 27                       ; ragged.py:1201:27
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 194
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 57
