...
.Ltmp11:
	...
	v_mad_u64_u32 v[1:2], null, s21, v34, v[65:66]
	.loc	1 121 13                        ; generate_amdgcn.py:121:13
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v6, 0x80000000, v2
	s_clause 0x1
	buffer_load_b128 v[2:5], v1, s[16:19], 0 offen
	buffer_load_b128 v[6:9], v6, s[16:19], 0 offen
	.loc	1 135 18                        ; generate_amdgcn.py:135:18
	v_or_b32_e32 v1, s26, v35
	...
	.loc	1 152 30                        ; generate_amdgcn.py:152:30
	v_mad_u64_u32 v[10:11], null, s20, v35, v[33:34]
	v_add3_u32 v1, s6, s23, v10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 152 22 is_stmt 0              ; generate_amdgcn.py:152:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_lshlrev_b32 v10, 3, v0
	v_add_nc_u32_e32 v43, 0, v10
	buffer_load_b64 v[18:19], v1, s[12:15], 0 offen
...
.Ltmp15:
	...
	v_xor_b32_e32 v11, 40, v1
	v_xor_b32_e32 v6, 8, v1
	v_xor_b32_e32 v7, 16, v1
	v_xor_b32_e32 v8, 24, v1
	v_xor_b32_e32 v10, 32, v1
	v_dual_mov_b32 v29, v9 :: v_dual_add_nc_u32 v66, 0, v11
	v_mov_b32_e32 v11, v9
	v_mul_lo_u32 v2, s21, v2
	v_xor_b32_e32 v12, 48, v1
	v_add3_u32 v3, v3, s0, v65
	v_xor_b32_e32 v5, 56, v1
	v_add3_u32 v59, v4, s23, v33
	v_add_nc_u32_e32 v60, 0, v1
	v_dual_mov_b32 v16, v9 :: v_dual_add_nc_u32 v61, 0, v6
	v_add3_u32 v2, v2, s0, v65
	s_lshl_b32 s0, s25, 8
	v_dual_mov_b32 v25, v9 :: v_dual_add_nc_u32 v62, 0, v7
	v_subrev_nc_u32_e32 v57, s0, v3
	s_delay_alu instid0(VALU_DEP_3)
	v_subrev_nc_u32_e32 v58, s0, v2
	v_dual_mov_b32 v26, v9 :: v_dual_add_nc_u32 v63, 0, v8
	v_dual_mov_b32 v27, v9 :: v_dual_add_nc_u32 v64, 0, v10
	v_dual_mov_b32 v28, v9 :: v_dual_add_nc_u32 v67, 0, v12
	v_dual_mov_b32 v31, v9 :: v_dual_add_nc_u32 v76, 0, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 136 23                        ; generate_amdgcn.py:136:23
	v_cmp_lt_i32_e64 s0, s1, v55
	.loc	1 137 23                        ; generate_amdgcn.py:137:23
	v_cmp_lt_i32_e32 vcc_lo, s1, v56
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_add_i32 s3, s3, -1
	s_add_i32 s1, s1, 64
	s_cmp_lg_u32 s3, 0
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	v_cndmask_b32_e64 v33, 0x80000000, v59, s0
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_dual_cndmask_b32 v34, 0x80000000, v58 :: v_dual_cndmask_b32 v37, 0x80000000, v57
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v58, s25, v58
	v_add_nc_u32_e32 v59, s20, v59
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	buffer_load_b64 v[41:42], v33, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	...
	ds_load_u8 v81, v75 offset:16704
	ds_load_u8 v82, v75 offset:16640
	ds_load_u8 v83, v75 offset:16832
	ds_load_u8 v84, v75 offset:16768
	ds_load_u8 v85, v75 offset:16448
	ds_load_u8 v86, v75 offset:16384
	ds_load_u8 v87, v75 offset:16576
	ds_load_u8 v88, v75 offset:16512
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[77:80], v60 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v89, v75 offset:16864
	ds_load_u8 v90, v75 offset:16736
	ds_load_u8 v91, v75 offset:16672
	ds_load_u8 v92, v75 offset:16800
	ds_load_u8 v93, v75 offset:16608
	ds_load_u8 v94, v75 offset:16480
	ds_load_u8 v95, v75 offset:16416
	ds_load_u8 v96, v75 offset:16544
	ds_load_u8 v97, v75 offset:17216
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v57, s25, v57
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v99, v75 offset:17536
	...
	ds_load_u8 v85, v75 offset:17344
	ds_load_u8 v86, v75 offset:17280
	v_lshl_or_b32 v81, v84, 16, v83
	v_perm_b32 v83, v91, v90, 0xc0c0004
	v_perm_b32 v84, v92, v89, 0xc0c0004
	v_perm_b32 v91, v95, v94, 0xc0c0004
	ds_load_u8 v87, v75 offset:16960
	ds_load_u8 v88, v75 offset:16896
	ds_load_u8 v90, v75 offset:17088
	ds_load_u8 v89, v75 offset:17024
	ds_load_u8 v92, v75 offset:17376
	ds_load_u8 v94, v75 offset:17312
	ds_load_u8 v98, v75 offset:17152
	v_lshl_or_b32 v84, v84, 16, v83
	v_lshl_or_b32 v83, v93, 16, v91
	ds_load_u8 v91, v75 offset:17248
	ds_load_u8 v93, v75 offset:17184
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[81:82], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v81, v75 offset:16992
	ds_load_u8 v82, v75 offset:16928
	v_wmma_i32_16x16x16_iu4 v[17:24], v[77:78], v[83:84], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[83:84], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v83, v75 offset:17120
	ds_load_u8 v84, v75 offset:17056
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[77:80], v61 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v85, v86, v85, 0xc0c0004
	ds_load_u8 v96, v75 offset:17728
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v88, v89, v90, 0xc0c0004
	ds_load_u8 v89, v75 offset:17792
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v92, v94, v92, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v95, v98, v97, 0xc0c0004
	ds_load_u8 v97, v75 offset:17664
	ds_load_u8 v98, v75 offset:17856
	ds_load_u8 v94, v75 offset:17600
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v90, v93, v91, 0xc0c0004
	v_lshl_or_b32 v86, v85, 16, v95
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	v_lshl_or_b32 v85, v88, 16, v87
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v82, v84, v83, 0xc0c0004
	v_lshl_or_b32 v88, v92, 16, v90
	ds_load_u8 v91, v75 offset:17472
	ds_load_u8 v93, v75 offset:17408
	s_waitcnt lgkmcnt(7)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[85:86], v[9:16] neg_lo:[1,1,0]
	v_lshl_or_b32 v87, v82, 16, v81
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[85:86], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v85, v75 offset:17888
	ds_load_u8 v86, v75 offset:17760
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[81:84], v62 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v95, v75 offset:18240
	v_wmma_i32_16x16x16_iu4 v[17:24], v[77:78], v[87:88], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[87:88], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v79, v75 offset:17696
	ds_load_u8 v80, v75 offset:17824
	ds_load_u8 v87, v75 offset:17632
	ds_load_u8 v88, v75 offset:17504
	ds_load_u8 v90, v75 offset:17440
	ds_load_u8 v92, v75 offset:17568
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v77, v97, v96, 0xc0c0004
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v78, v89, v98, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v94, v99, v94, 0xc0c0004
	ds_load_u8 v96, v75 offset:18304
	ds_load_u8 v97, v75 offset:18016
	ds_load_u8 v98, v75 offset:17952
	v_lshl_or_b32 v78, v78, 16, v77
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v91, v93, v91, 0xc0c0004
	ds_load_u8 v93, v75 offset:18368
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v79, v86, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v80, v80, v85, 0xc0c0004
	v_lshl_or_b32 v77, v94, 16, v91
	ds_load_u8 v91, v75 offset:17984
	...
	ds_load_u8 v86, v75 offset:18112
	ds_load_u8 v85, v75 offset:18048
	ds_load_u8 v90, v75 offset:18400
	ds_load_u8 v92, v75 offset:18336
	ds_load_u8 v89, v75 offset:18176
	v_lshl_or_b32 v79, v87, 16, v88
	ds_load_u8 v87, v75 offset:18272
	ds_load_u8 v88, v75 offset:18208
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[83:84], v[79:80], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v81, v75 offset:18144
	ds_load_u8 v82, v75 offset:18080
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[77:80], v63 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v84, v96, v93, 0xc0c0004
	ds_load_u8 v96, v75 offset:18496
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v91, v94, v91, 0xc0c0004
	ds_load_u8 v94, v75 offset:18880
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v85, v85, v86, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v83, v89, v95, 0xc0c0004
	ds_load_u8 v89, v75 offset:18752
	ds_load_u8 v95, v75 offset:18816
	ds_load_u8 v93, v75 offset:18688
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	...
	v_lshl_or_b32 v85, v85, 16, v91
	v_lshl_or_b32 v88, v88, 16, v87
	ds_load_u8 v97, v75 offset:18624
	ds_load_u8 v98, v75 offset:18560
	ds_load_u8 v90, v75 offset:18432
	v_lshl_or_b32 v87, v81, 16, v92
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[85:86], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[85:86], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v85, v75 offset:18912
	ds_load_u8 v86, v75 offset:18784
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[81:84], v64 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_wmma_i32_16x16x16_iu4 v[17:24], v[77:78], v[87:88], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[87:88], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v79, v75 offset:18720
	ds_load_u8 v80, v75 offset:18848
	ds_load_u8 v87, v75 offset:18656
	ds_load_u8 v88, v75 offset:18528
	ds_load_u8 v91, v75 offset:18464
	ds_load_u8 v92, v75 offset:18592
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v78, v95, v94, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v77, v93, v89, 0xc0c0004
	ds_load_u8 v89, v75 offset:19264
	ds_load_u8 v94, v75 offset:19392
	v_lshl_or_b32 v78, v78, 16, v77
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v95, v98, v97, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v90, v90, v96, 0xc0c0004
	ds_load_u8 v97, v75 offset:19296
	ds_load_u8 v98, v75 offset:19232
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v79, v86, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v80, v80, v85, 0xc0c0004
	ds_load_u8 v85, v75 offset:19776
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v88, v91, v88, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v87, v92, v87, 0xc0c0004
	ds_load_u8 v91, v75 offset:19712
	v_lshl_or_b32 v80, v80, 16, v79
	ds_load_u8 v86, v75 offset:19136
	ds_load_u8 v92, v75 offset:19072
	v_lshl_or_b32 v79, v87, 16, v88
	ds_load_u8 v87, v75 offset:19424
	ds_load_u8 v88, v75 offset:19360
	v_lshl_or_b32 v77, v95, 16, v90
	ds_load_u8 v90, v75 offset:19008
	ds_load_u8 v95, v75 offset:18944
	v_wmma_i32_16x16x16_iu4 v[1:8], v[83:84], v[79:80], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[81:82], v[79:80], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[83:84], v[77:78], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v83, v75 offset:19040
	ds_load_u8 v84, v75 offset:18976
	ds_load_u8 v99, v75 offset:19168
	ds_load_u8 v100, v75 offset:19104
	ds_load_u8 v101, v75 offset:19904
	v_wmma_i32_16x16x16_iu4 v[9:16], v[81:82], v[77:78], v[9:16] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[77:80], v66 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v85, v91, v85, 0xc0c0004
	ds_load_u8 v91, v75 offset:19680
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v86, v92, v86, 0xc0c0004
	v_perm_b32 v92, v98, v97, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v75 offset:19584
	ds_load_u8 v96, v75 offset:19328
	ds_load_u8 v93, v75 offset:19200
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v83, v84, v83, 0xc0c0004
	v_lshl_or_b32 v84, v87, 16, v92
	ds_load_u8 v87, v75 offset:20416
	ds_load_u8 v92, v75 offset:20352
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v82, v96, v94, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v81, v93, v89, 0xc0c0004
	v_perm_b32 v89, v95, v90, 0xc0c0004
	v_perm_b32 v95, v100, v99, 0xc0c0004
	ds_load_u8 v94, v75 offset:20288
	ds_load_u8 v93, v75 offset:19648
	v_lshl_or_b32 v82, v82, 16, v81
	v_lshl_or_b32 v81, v86, 16, v89
	v_lshl_or_b32 v83, v95, 16, v83
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v87, v92, v87, 0xc0c0004
	ds_load_u8 v92, v75 offset:20384
	ds_load_u8 v96, v75 offset:20224
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[81:82], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v81, v75 offset:20032
	ds_load_u8 v82, v75 offset:19968
	v_wmma_i32_16x16x16_iu4 v[17:24], v[77:78], v[83:84], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[83:84], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v77, v75 offset:19936
	ds_load_u8 v78, v75 offset:19872
	ds_load_u8 v79, v75 offset:19808
	ds_load_u8 v80, v75 offset:19744
	ds_load_u8 v83, v75 offset:20160
	ds_load_u8 v84, v75 offset:20096
	ds_load_u8 v86, v75 offset:19520
	ds_load_u8 v89, v75 offset:19456
	ds_load_u8 v90, v75 offset:19840
	ds_load_u8 v95, v75 offset:19552
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v98, v78, v77, 0xc0c0004
	v_perm_b32 v81, v82, v81, 0xc0c0004
	ds_load_u8 v82, v75 offset:20320
	ds_load_u8 v77, v75 offset:20064
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v83, v84, v83, 0xc0c0004
	ds_load_u8 v84, v75 offset:20256
	v_perm_b32 v97, v80, v79, 0xc0c0004
	ds_load_u8 v79, v75 offset:20192
	ds_load_u8 v78, v75 offset:20000
	ds_load_u8 v80, v75 offset:20128
	v_perm_b32 v94, v96, v94, 0xc0c0004
	ds_load_u8 v96, v75 offset:20448
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v89, v89, v86, 0xc0c0004
	v_perm_b32 v88, v88, v93, 0xc0c0004
	ds_load_u8 v93, v75 offset:19616
	ds_load_u8 v86, v75 offset:19488
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v90, v90, v101, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v99, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v92, v92, v96, 0xc0c0004
	v_perm_b32 v96, v78, v77, 0xc0c0004
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[77:80], v67 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v91, v93, v91, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v95, v86, v95, 0xc0c0004
	v_perm_b32 v93, v84, v82, 0xc0c0004
	v_lshl_or_b32 v86, v90, 16, v85
	v_lshl_or_b32 v85, v88, 16, v89
	v_lshl_or_b32 v88, v87, 16, v94
	v_lshl_or_b32 v87, v83, 16, v81
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[81:84], v76 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v90, v98, 16, v97
	v_lshl_or_b32 v89, v91, 16, v95
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v92, v92, 16, v93
	v_lshl_or_b32 v91, v99, 16, v96
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[85:86], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[77:78], v[89:90], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[85:86], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[89:90], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[81:82], v[87:88], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[81:82], v[91:92], v[17:24] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[25:32], v[83:84], v[87:88], v[25:32] neg_lo:[1,1,0]
	...
	v_or_b16 v34.l, v34.l, v41.l
	v_or_b16 v34.h, v34.h, v41.h
	v_or_b16 v35.l, v35.l, v42.l
	v_or_b16 v35.h, v35.h, v42.h
	v_or_b16 v36.l, v36.l, v77.l
	v_or_b16 v36.h, v36.h, v77.h
	v_or_b16 v37.l, v37.l, v78.l
	v_or_b16 v37.h, v37.h, v78.h
	v_or_b16 v38.l, v38.l, v79.l
	v_or_b16 v38.h, v38.h, v79.h
	v_or_b16 v39.l, v39.l, v80.l
	v_or_b16 v39.h, v39.h, v80.h
	v_or_b16 v40.l, v40.l, v81.l
	v_or_b16 v40.h, v40.h, v81.h
...
.Ltmp24:
	...
	v_dual_mul_f32 v9, v22, v9 :: v_dual_mul_f32 v2, v47, v2
.Ltmp25:
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 102
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 28
