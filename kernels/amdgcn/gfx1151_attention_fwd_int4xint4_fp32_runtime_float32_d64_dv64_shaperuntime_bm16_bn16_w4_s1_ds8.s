	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8,@function
amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8:                                 ; @amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
.Lfunc_begin0:
...
; %bb.8:                                ; %.lr.ph
	...
	v_mov_b16_e32 v60.l, 0
	.loc	1 573 27                        ; attention.py:573:27
	v_add_nc_u32_e32 v59, s11, v5
	...
	.loc	1 569 19                        ; attention.py:569:19
	s_xor_b32 s6, s6, s28
	v_dual_mov_b32 v6, 0x7632 :: v_dual_and_b32 v5, 1, v0
	s_waitcnt lgkmcnt(0)
	v_mul_lo_u32 v1, s39, v3
	v_and_b32_e32 v3, 60, v41
	s_sub_i32 s6, s6, s28
	v_dual_cndmask_b32 v6, 0x3276, v6 :: v_dual_lshlrev_b32 v7, 6, v5
	...
	v_or3_b32 v69, v1, v5, v8
	v_lshl_or_b32 v1, v9, 8, v9
	v_mov_b32_e32 v9, 0
	v_xor_b32_e32 v5, 28, v66
	v_lshl_add_u32 v8, v42, 2, 0
	v_dual_mov_b32 v72, v60 :: v_dual_add_nc_u32 v63, s10, v58
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v12, v9 :: v_dual_and_b32 v1, 0x540054, v1
	...
	v_dual_mov_b32 v73, v60 :: v_dual_mov_b32 v2, v1
	v_lshl_or_b32 v3, v3, 4, v3
	v_mov_b32_e32 v10, v9
	v_mov_b32_e32 v11, v9
	v_dual_mov_b32 v13, v9 :: v_dual_add_nc_u32 v76, 0, v18
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v70, 0x7060706, v3
	v_dual_mov_b32 v88, 0xff800000 :: v_dual_lshlrev_b32 v3, 1, v26
	v_mov_b32_e32 v14, v9
	v_dual_mov_b32 v15, v9 :: v_dual_add_nc_u32 v78, 0, v20
	v_dual_mov_b32 v16, v9 :: v_dual_add_nc_u32 v75, 0, v17
	v_dual_mov_b32 v86, v1 :: v_dual_add_nc_u32 v77, 0, v19
	v_add_nc_u32_e32 v79, 0, v21
	v_add_nc_u32_e32 v80, 0, v22
	v_add_nc_u32_e32 v81, 0, v5
	v_dual_mov_b32 v5, v1 :: v_dual_add_nc_u32 v82, 0, v6
	v_add_nc_u32_e32 v83, 0, v7
	v_dual_mov_b32 v7, v1 :: v_dual_add_nc_u32 v84, v8, v3
	v_mov_b32_e32 v3, v1
	v_dual_mov_b32 v6, v1 :: v_dual_add_nc_u32 v85, v4, v23
	v_mov_b32_e32 v4, v1
	v_dual_mov_b32 v8, v1 :: v_dual_mov_b32 v87, 0xff800000
...
.LBB0_9:                                ;   in Loop: Header=BB0_10 Depth=1
	...
	v_add_lshl_u32 v90, s5, v37, 2
	v_add_lshl_u32 v99, s5, v67, 2
	...
	s_add_i32 s5, s19, s5
	.loc	1 761 36                        ; attention.py:761:36
	v_cndmask_b32_e64 v90, 0x80000000, v90, s63
	v_cndmask_b32_e64 v99, 0x80000000, v99, s62
	.loc	1 732 30                        ; attention.py:732:30
	...
	.loc	1 761 36                        ; attention.py:761:36
	s_clause 0x1
	buffer_load_b32 v100, v90, s[24:27], 0 offen
	...
	s_waitcnt vmcnt(4)
	v_mov_b16_e32 v92.h, v96.l
	s_waitcnt vmcnt(3)
	v_mov_b16_e32 v93.h, v97.l
	s_waitcnt vmcnt(2)
	v_mov_b16_e32 v94.h, v98.l
	v_mov_b16_e32 v96.h, v93.l
	v_mov_b16_e32 v97.h, v94.l
	.loc	1 732 30                        ; attention.py:732:30
	v_cvt_f32_i32_e32 v24, v24
	v_cvt_f32_i32_e32 v22, v22
	v_cvt_f32_i32_e32 v21, v21
	v_dual_mul_f32 v19, v72, v19 :: v_dual_add_nc_u32 v102, 0, v68
	v_dual_mul_f32 v20, v73, v20 :: v_dual_add_nc_u32 v103, 0, v69
	.loc	1 798 53                        ; attention.py:798:53
	s_lshr_b32 s6, s6, 28
	.loc	1 727 37                        ; attention.py:727:37
	v_mov_b16_e32 v93.l, v90.l
	v_mov_b16_e32 v94.l, v90.l
	v_mov_b16_e32 v96.l, v90.l
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v23, v72, v23 :: v_dual_mul_f32 v24, v73, v24
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v93, v19, v93 :: v_dual_add_nc_u32 v106, s5, v56
	.loc	1 774 30                        ; attention.py:774:30
	s_add_i32 s5, s5, s51
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v105, v71, v18 :: v_dual_add_nc_u32 v98, 0, v65
	v_dual_mul_f32 v104, v60, v17 :: v_dual_add_nc_u32 v101, 0, v66
	.loc	1 798 53                        ; attention.py:798:53
	s_add_i32 s6, s19, s6
	v_mad_u64_u32 v[17:18], null, s5, s18, v[38:39]
	s_ashr_i32 s6, s6, 4
	.loc	1 727 37                        ; attention.py:727:37
	v_mov_b16_e32 v90.h, v95.l
	v_mov_b16_e32 v95.h, v92.l
	v_mov_b16_e32 v92.l, v90.l
	v_mov_b16_e32 v95.l, v90.l
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v21, v60, v21 :: v_dual_mul_f32 v22, v71, v22
	v_dual_mul_f32 v94, v20, v94 :: v_dual_mul_f32 v23, v23, v96
	.loc	1 777 27                        ; attention.py:777:27
	v_cmp_gt_i32_e32 vcc_lo, s50, v106
	.loc	1 798 25                        ; attention.py:798:25
	s_add_i32 s5, s6, s52
	.loc	1 727 37                        ; attention.py:727:37
	v_mov_b16_e32 v97.l, v90.l
	.loc	1 798 25                        ; attention.py:798:25
	s_mul_i32 s5, s5, s18
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v92, v105, v92 :: v_dual_add_nc_u32 v19, s56, v17
	v_mul_f32_e32 v104, v104, v90
	.loc	1 727 37                        ; attention.py:727:37
	v_mov_b16_e32 v90.h, v91.l
	.loc	1 797 41                        ; attention.py:797:41
	v_add_lshl_u32 v91, s5, v26, 1
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v22, v22, v95 :: v_dual_add_nc_u32 v95, s57, v17
	v_dual_mul_f32 v24, v24, v97 :: v_dual_mul_f32 v21, v21, v90
	.loc	1 775 32                        ; attention.py:775:32
	v_cndmask_b32_e32 v97, 0x80000000, v17, vcc_lo
	.loc	1 797 41                        ; attention.py:797:41
	...
	v_or_b32_e32 v113, 1, v106
	v_add_nc_u32_e32 v116, 9, v106
	.loc	1 761 36                        ; attention.py:761:36
	s_waitcnt vmcnt(1)
	v_cndmask_b32_e64 v20, 0xff800000, v100, s63
	s_waitcnt vmcnt(0)
	v_cndmask_b32_e64 v96, 0xff800000, v99, s62
	.loc	1 762 35                        ; attention.py:762:35
	ds_store_b32 v98, v20
	ds_store_b32 v74, v96
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s5, 0xff800000, v20
	v_cmp_neq_f32_e64 s6, 0xff800000, v96
	.loc	1 762 35                        ; attention.py:762:35
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v96, v101
	ds_load_b32 v105, v75
	ds_load_b32 v107, v76
	ds_load_b32 v108, v77
	ds_load_b32 v109, v78
	ds_load_b32 v110, v79
	ds_load_b32 v111, v80
	ds_load_b32 v112, v81
	v_add_nc_u32_e32 v18, s55, v17
	.loc	1 775 32                        ; attention.py:775:32
	v_cndmask_b32_e32 v100, 0x80000000, v19, vcc_lo
	.loc	1 763 25                        ; attention.py:763:25
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 775 32                        ; attention.py:775:32
	v_cndmask_b32_e32 v99, 0x80000000, v18, vcc_lo
	.loc	1 763 25                        ; attention.py:763:25
	s_and_b32 vcc_lo, s63, s5
	s_and_b32 s5, s62, s6
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u8_d16 v17, v103
	s_waitcnt lgkmcnt(0)
	ds_load_u8_d16_hi v17, v103 offset:8
	ds_load_u8_d16 v18, v103 offset:16
	s_waitcnt lgkmcnt(0)
	ds_load_u8_d16_hi v18, v103 offset:24
	ds_load_u8_d16 v19, v83
	s_waitcnt lgkmcnt(0)
	ds_load_u8_d16_hi v19, v83 offset:8
	ds_load_u8_d16 v20, v83 offset:16
	s_waitcnt lgkmcnt(0)
	ds_load_u8_d16_hi v20, v83 offset:24
	.loc	1 762 35                        ; attention.py:762:35
	v_dual_mul_f32 v96, 0x3fb8aa3b, v96 :: v_dual_mul_f32 v109, 0x3fb8aa3b, v109
	v_dual_mul_f32 v102, 0x3fb8aa3b, v108 :: v_dual_mul_f32 v105, 0x3fb8aa3b, v105
	v_mul_f32_e32 v103, 0x3fb8aa3b, v107
	v_dual_mul_f32 v107, 0x3fb8aa3b, v112 :: v_dual_mul_f32 v108, 0x3fb8aa3b, v111
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v110, 0x3fb8aa3b, v110 :: v_dual_fmac_f32 v105, s58, v92
	.loc	1 762 25 is_stmt 0              ; attention.py:762:25
	v_dual_fmac_f32 v96, s22, v104 :: v_dual_fmac_f32 v103, s59, v93
	v_dual_fmac_f32 v102, s60, v94 :: v_dual_fmac_f32 v109, s22, v21
	...
	v_cmp_eq_u16_e64 s5, 1, v17.h
	v_cmp_eq_u16_e64 s6, 1, v19.h
	v_cmp_eq_u16_e64 s12, 1, v18.l
	.loc	1 762 25                        ; attention.py:762:25
	v_dual_fmac_f32 v110, s58, v22 :: v_dual_fmac_f32 v107, s60, v24
	v_fmac_f32_e32 v108, s59, v23
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v17, 0xff800000, v96, s10
	.loc	1 763 25                        ; attention.py:763:25
	v_cmp_eq_u16_e64 s8, 1, v20.h
	v_cmp_eq_u16_e64 s7, 1, v18.h
	v_cmp_eq_u16_e64 s11, 1, v20.l
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v19, 0xff800000, v105, s9
	v_cndmask_b32_e64 v22, 0xff800000, v103, s5
	v_cndmask_b32_e64 v21, 0xff800000, v102, s6
	v_cndmask_b32_e64 v18, 0xff800000, v109, s12
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_cndmask_b32_e64 v23, 0xff800000, v107, s8
	v_cndmask_b32_e64 v24, 0xff800000, v108, s7
	v_cndmask_b32_e64 v20, 0xff800000, v110, s11
	ds_store_b32 v101, v17
	ds_store_b32 v75, v19
	ds_store_b32 v76, v22
	ds_store_b32 v77, v21
	ds_store_b32 v78, v18
	ds_store_b32 v79, v20
	ds_store_b32 v80, v24
	ds_store_b32 v81, v23
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v96, v98
	.loc	1 797 41                        ; attention.py:797:41
...
.Ltmp3:
	...
	v_max3_f32 v107, v17, v19, v22
	v_max3_f32 v108, v21, v18, v20
.Ltmp4:
	.loc	1 782 31                        ; attention.py:782:31
	v_add_nc_u32_e32 v115, 5, v106
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v103.h, v90.l
	v_mov_b16_e32 v104.h, v90.l
	v_mov_b16_e32 v111.h, v90.l
	v_mov_b16_e32 v105.h, v90.l
	.loc	1 785 30                        ; attention.py:785:30
	...
	s_cmp_lt_i32 s19, s49
	.loc	1 782 31                        ; attention.py:782:31
	v_add_nc_u32_e32 v106, 13, v106
.Ltmp5:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	s_waitcnt lgkmcnt(0)
	v_max_f32_e32 v98, v96, v96
.Ltmp6:
	.loc	1 775 32                        ; attention.py:775:32
	s_clause 0x3
	buffer_load_u8 v92, v97, s[40:43], 0 offen
	buffer_load_u8 v93, v99, s[40:43], 0 offen
	buffer_load_u8 v94, v100, s[40:43], 0 offen
...
.Ltmp9:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
	v_mov_b32_dpp v97, v97 row_xmask:8 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp10:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max_f32_e32 v97, v97, v97
	v_dual_max_f32 v97, v98, v97 :: v_dual_max_f32 v98, v87, v87
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp11:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
...
.Ltmp15:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v107, v107, v108, v109
.Ltmp16:
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp17:
	...
	v_permlanex16_b32 v109, v107, s61, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp18:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
...
.Ltmp19:
	.loc	1 766 24                        ; attention.py:766:24
	v_max3_f32 v107, v89, v107, v109
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
.Ltmp20:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_dual_max_f32 v97, v97, v114 :: v_dual_sub_f32 v18, v18, v107
.Ltmp21:
	.loc	1 767 74                        ; attention.py:767:74
	v_sub_f32_e32 v109, v89, v107
...
.Ltmp25:
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v17, v17, v107 :: v_dual_max_f32 v114, v114, v114
	v_sub_f32_e32 v20, v20, v107
	.loc	1 767 25                        ; attention.py:767:25
	v_cndmask_b32_e64 v89, 0, v109, s13
	.loc	1 768 62                        ; attention.py:768:62
...
.Ltmp27:
	...
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e32 v89, 0, v96, vcc_lo
	v_cndmask_b32_e64 v21, 0, v21, s6
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v101.l, v23.h
	v_and_b32_e32 v97, 1, v103
	.loc	1 768 33                        ; attention.py:768:33
...
.Ltmp29:
	...
	v_add3_u32 v19, v19, v97, 0x7fff
.Ltmp30:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
	v_mov_b32_dpp v96, v96 row_xmask:8 row_mask:0xf bank_mask:0xf
.Ltmp31:
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v108.l, v24.h
...
.Ltmp32:
	...
	v_dual_add_f32 v89, v89, v96 :: v_dual_and_b32 v104, 1, v105
.Ltmp33:
	.loc	1 768 33                        ; attention.py:768:33
...
.Ltmp35:
	.loc	1 816 30                        ; attention.py:816:30
	v_add3_u32 v17, v17, v103, 0x7fff
	v_mov_b16_e32 v110.l, v22.h
...
.Ltmp39:
	...
	v_add3_u32 v24, v24, v108, 0x7fff
	...
	v_cndmask_b16 v101.h, 0x7fff, v19.h, s5
	.loc	1 782 30                        ; attention.py:782:30
	v_cmp_gt_i32_e64 s5, s23, v113
	.loc	1 816 30                        ; attention.py:816:30
	v_cndmask_b16 v101.l, 0x7fff, v17.h, s6
	.loc	1 785 32                        ; attention.py:785:32
	s_waitcnt vmcnt(3)
	v_lshrrev_b16 v90.l, 4, v92.l
	s_waitcnt vmcnt(2)
	v_lshrrev_b16 v99.l, 4, v93.l
	.loc	1 783 76                        ; attention.py:783:76
	v_and_b16 v17.l, v92.l, 15
	.loc	1 784 29                        ; attention.py:784:29
	v_and_b32_e32 v19, 15, v92
	.loc	1 785 32                        ; attention.py:785:32
	s_waitcnt vmcnt(1)
	v_lshrrev_b16 v100.l, 4, v94.l
	.loc	1 783 32                        ; attention.py:783:32
	v_cndmask_b32_e64 v90, 0, v90, s5
	.loc	1 782 30                        ; attention.py:782:30
	v_cmp_gt_i32_e64 s5, s23, v115
	.loc	1 783 76                        ; attention.py:783:76
	v_and_b16 v17.h, v93.l, 15
	.loc	1 784 29                        ; attention.py:784:29
	v_and_b32_e32 v20, 15, v93
	.loc	1 816 30                        ; attention.py:816:30
	v_and_b32_e32 v105, 1, v110
	v_and_b32_e32 v110, 1, v112
	.loc	1 783 32                        ; attention.py:783:32
	v_cndmask_b32_e64 v92, 0, v99, s5
	.loc	1 782 30                        ; attention.py:782:30
	v_cmp_gt_i32_e64 s5, s23, v116
	.loc	1 785 32                        ; attention.py:785:32
	s_waitcnt vmcnt(0)
	v_lshrrev_b16 v102.l, 4, v95.l
	.loc	1 784 29                        ; attention.py:784:29
	v_and_b32_e32 v103, 15, v94
	.loc	1 816 30                        ; attention.py:816:30
	v_add3_u32 v97, v18, v110, 0x7fff
	.loc	1 783 76                        ; attention.py:783:76
	v_and_b16 v18.l, v94.l, 15
	.loc	1 783 32 is_stmt 0              ; attention.py:783:32
	v_cndmask_b32_e64 v93, 0, v100, s5
	.loc	1 782 30 is_stmt 1              ; attention.py:782:30
	v_cmp_gt_i32_e64 s5, s23, v106
	.loc	1 783 76                        ; attention.py:783:76
	v_and_b16 v18.h, v95.l, 15
	.loc	1 784 29                        ; attention.py:784:29
	v_and_b32_e32 v104, 15, v95
	.loc	1 786 54                        ; attention.py:786:54
	v_or_b32_e32 v95, -16, v19
	v_or_b32_e32 v99, -16, v20
	.loc	1 783 32                        ; attention.py:783:32
	v_cndmask_b32_e64 v94, 0, v102, s5
...
.Ltmp41:
	...
	v_cvt_f32_i32_e32 v19, v19
	.loc	1 786 29                        ; attention.py:786:29
	v_cndmask_b32_e64 v17, v20, v99, s5
	.loc	1 786 38 is_stmt 0              ; attention.py:786:38
	v_cmp_lt_u16_e64 s5, 7, v18.l
	.loc	1 787 56 is_stmt 1              ; attention.py:787:56
	v_or_b32_e32 v99, -16, v92
.Ltmp42:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
...
.Ltmp43:
	...
	v_cvt_f32_i32_e32 v17, v17
	.loc	1 786 29                        ; attention.py:786:29
	v_cndmask_b32_e64 v20, v103, v100, s5
	.loc	1 786 38 is_stmt 0              ; attention.py:786:38
...
.Ltmp45:
	...
	v_cvt_f32_i32_e32 v20, v20
	.loc	1 786 29                        ; attention.py:786:29
	v_cndmask_b32_e64 v18, v104, v102, s5
...
.Ltmp46:
	...
	v_dual_mov_b32 v89, v22 :: v_dual_mul_f32 v20, v20, v91
.Ltmp47:
	.loc	1 814 31                        ; attention.py:814:31
	v_cvt_f32_i32_e32 v18, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 787 30                        ; attention.py:787:30
	v_cndmask_b32_e64 v90, v90, v95, s5
...
.Ltmp49:
	.loc	1 814 31                        ; attention.py:814:31
	v_dual_mul_f32 v17, v17, v91 :: v_dual_mul_f32 v18, v91, v18
	v_cvt_f32_i32_e32 v90, v90
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 787 30                        ; attention.py:787:30
	v_cndmask_b32_e64 v92, v92, v99, s5
	.loc	1 787 39 is_stmt 0              ; attention.py:787:39
	v_cmp_lt_u32_e64 s5, 7, v93
	.loc	1 814 30 is_stmt 1              ; attention.py:814:30
	v_bfe_u32 v95, v17, 16, 1
	v_bfe_u32 v99, v20, 16, 1
	...
	.loc	1 787 30 is_stmt 1              ; attention.py:787:30
	v_cndmask_b32_e64 v94, v94, v102, s5
	.loc	1 814 30                        ; attention.py:814:30
	v_cmp_o_f32_e64 s5, v19, v19
	...
	v_mul_f32_e32 v92, v92, v91
	.loc	1 814 30                        ; attention.py:814:30
	v_add3_u32 v20, v20, v99, 0x7fff
	...
	v_add3_u32 v19, v90, v94, 0x7fff
	v_add3_u32 v90, v92, v95, 0x7fff
	v_add3_u32 v20, v93, v99, 0x7fff
	v_add3_u32 v91, v91, v100, 0x7fff
	v_cndmask_b16 v17.h, 0x7fff, v17.h, s6
	v_cndmask_b16 v19.l, 0x7fff, v19.h, s12
	v_cndmask_b16 v19.h, 0x7fff, v90.h, s13
	v_cndmask_b16 v18.h, 0x7fff, v18.h, s8
	v_cndmask_b16 v20.l, 0x7fff, v20.h, s14
	v_cndmask_b16 v20.h, 0x7fff, v91.h, s15
	ds_store_b16 v84, v17
	ds_store_b16 v84, v19 offset:128
	ds_store_b16_d16_hi v84, v17 offset:512
	ds_store_b16_d16_hi v84, v19 offset:640
	ds_store_b16 v84, v18 offset:1024
	ds_store_b16 v84, v20 offset:1152
	ds_store_b16_d16_hi v84, v18 offset:1536
	ds_store_b16_d16_hi v84, v20 offset:1664
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u16_d16 v90, v85
	ds_load_u16_d16 v91, v85 offset:256
	ds_load_u16_d16 v92, v85 offset:512
	ds_load_u16_d16 v93, v85 offset:768
	ds_load_u16_d16 v94, v85 offset:1024
	ds_load_u16_d16 v95, v85 offset:1280
	ds_load_u16_d16 v96, v85 offset:1536
	ds_load_u16_d16 v97, v85 offset:1792
	.loc	1 766 24 is_stmt 1              ; attention.py:766:24
	v_max_f32_e32 v17, v98, v109
	.loc	1 816 30                        ; attention.py:816:30
	s_waitcnt lgkmcnt(1)
	v_cndmask_b16 v19.h, 0x7fff, v96.h, vcc_lo
	s_waitcnt lgkmcnt(0)
	v_cndmask_b16 v19.l, 0x7fff, v97.h, s9
	.loc	1 814 30                        ; attention.py:814:30
	ds_load_u16_d16_hi v90, v85 offset:128
	ds_load_u16_d16_hi v91, v85 offset:384
	ds_load_u16_d16_hi v92, v85 offset:640
	ds_load_u16_d16_hi v93, v85 offset:896
	ds_load_u16_d16_hi v94, v85 offset:1152
	ds_load_u16_d16_hi v95, v85 offset:1408
	ds_load_u16_d16_hi v96, v85 offset:1664
	ds_load_u16_d16_hi v97, v85 offset:1920
	.loc	1 767 74                        ; attention.py:767:74
	v_sub_f32_e32 v18, v87, v17
	.loc	1 816 30                        ; attention.py:816:30
	v_cndmask_b16 v20.h, 0x7fff, v23.h, s10
	v_cndmask_b16 v20.l, 0x7fff, v24.h, s11
	v_permlanex16_b32 v23, v101, s61, 0xfedcba98 op_sel:[1,0]
	.loc	1 767 25                        ; attention.py:767:25
	v_cmp_neq_f32_e32 vcc_lo, 0xff800000, v87
	.loc	1 767 61 is_stmt 0              ; attention.py:767:61
	v_exp_f32_e32 v18, v18
	.loc	1 816 30 is_stmt 1              ; attention.py:816:30
	v_permlanex16_b32 v24, v21, s61, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v103, v19, s61, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v105, v20, s61, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v98, v23, v101, v39
	v_perm_b32 v99, v23, v101, v70
	v_perm_b32 v100, v24, v21, v39
	v_perm_b32 v101, v24, v21, v70
	v_perm_b32 v102, v103, v19, v39
	v_perm_b32 v103, v103, v19, v70
	.loc	1 767 25                        ; attention.py:767:25
	v_dual_cndmask_b32 v23, 0, v18 :: v_dual_add_f32 v18, v22, v89
	.loc	1 816 30                        ; attention.py:816:30
	v_perm_b32 v104, v105, v20, v39
	v_perm_b32 v105, v105, v20, v70
	v_mov_b32_e32 v89, v107
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v87, v17 :: v_dual_fmac_f32 v18, v86, v23
	.loc	1 816 23 is_stmt 0              ; attention.py:816:23
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[1:8], v[90:97], v[98:105], v[1:8]
	s_delay_alu instid0(VALU_DEP_2)
...
.LBB0_10:                               ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 727 37                        ; attention.py:727:37
	v_cndmask_b32_e32 v90, 0x80000000, v97, vcc_lo
	.loc	1 729 30                        ; attention.py:729:30
	...
	buffer_load_u16 v98, v90, s[36:39], 0 offen
	...
	.loc	1 708 31                        ; attention.py:708:31
	v_add_nc_u32_e32 v90, s19, v44
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 745 17                        ; attention.py:745:17
	v_cmp_le_i32_e32 vcc_lo, v90, v58
	v_cmp_le_i32_e64 s5, v90, v59
	.loc	1 714 73                        ; attention.py:714:73
	v_cmp_gt_i32_e64 s6, s23, v90
	.loc	1 745 17                        ; attention.py:745:17
...
; %bb.11:                               ;   in Loop: Header=BB0_10 Depth=1
	...
	v_cmp_ge_i32_e32 vcc_lo, v90, v61
	v_cmp_ge_i32_e64 s5, v90, v62
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s6, v90, v63
	v_cmp_le_i32_e64 s7, v90, v64
...
.Ltmp141:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_vgpr, 117
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.numbered_sgpr, 64
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
    .private_segment_fixed_size: 0
    .sgpr_count:     66
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.kd
