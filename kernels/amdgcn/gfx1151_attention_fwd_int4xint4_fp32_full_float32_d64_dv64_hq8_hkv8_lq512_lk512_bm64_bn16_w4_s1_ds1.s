...
.Ltmp0:
	...
	v_dual_mov_b32 v1, v24 :: v_dual_lshlrev_b32 v76, 1, v53
	.loc	1 566 23                        ; attention.py:566:23
	s_ashr_i32 s8, s0, 3
	.loc	1 567 22                        ; attention.py:567:22
	s_sub_i32 s1, s3, s1
	...
	v_dual_mov_b32 v2, v24 :: v_dual_add_nc_u32 v67, 0, v72
	...
	v_dual_mov_b32 v6, v24 :: v_dual_add_nc_u32 v61, 0, v42
	v_lshl_or_b32 v59, s3, 10, v76
	v_xor_b32_e32 v70, 8, v42
	v_xor_b32_e32 v76, 16, v42
	v_xor_b32_e32 v80, 24, v42
	v_xor_b32_e32 v71, v60, v71
	v_add_nc_u32_e32 v60, 0, v43
	v_mad_u64_u32 v[42:43], null, s37, v75, v[37:38]
	v_dual_mov_b32 v15, v24 :: v_dual_and_b32 v62, 0x160, v62
	v_mov_b32_e32 v4, v24
	v_dual_mov_b32 v7, v24 :: v_dual_add_nc_u32 v64, v67, v44
	...
	v_mad_u64_u32 v[38:39], null, s5, v77, s[4:5]
	s_mul_i32 s3, s3, s37
	...
	v_add_nc_u32_e32 v78, 0, v48
	.loc	1 707 13                        ; attention.py:707:13
	v_add_lshl_u32 v82, v38, v82, 2
	.loc	1 587 23                        ; attention.py:587:23
	v_cmp_gt_i32_e32 vcc_lo, 0x200, v77
	...
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v48, v35, v39, s3
	v_cndmask_b32_e64 v50, v39, v35, s3
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v51, v38, v36, s3
	...
	v_cndmask_b32_e64 v49, v36, v38, s3
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v114, v59, s[44:47], 0 offen offset:8
	buffer_load_u16 v115, v59, s[44:47], 0 offen offset:12
	buffer_load_u16 v116, v59, s[44:47], 0 offen offset:16
	.loc	1 717 33                        ; attention.py:717:33
	...
	.loc	1 727 37                        ; attention.py:727:37
	buffer_load_u16 v86, v59, s[44:47], 0 offen offset:4
	.loc	1 717 33                        ; attention.py:717:33
	s_waitcnt lgkmcnt(2)
	...
	.loc	1 761 36                        ; attention.py:761:36
	s_waitcnt vmcnt(6)
	v_dual_cndmask_b32 v33, 0xff800000, v98 :: v_dual_cndmask_b32 v36, 0xff800000, v99
	v_cndmask_b32_e32 v35, 0xff800000, v97, vcc_lo
	.loc	1 727 37                        ; attention.py:727:37
	s_clause 0x2
	buffer_load_u16 v97, v59, s[44:47], 0 offen offset:20
	buffer_load_u16 v98, v59, s[44:47], 0 offen offset:24
	buffer_load_u16 v99, v59, s[44:47], 0 offen offset:28
	.loc	1 761 36                        ; attention.py:761:36
	s_waitcnt vmcnt(8)
	v_cndmask_b32_e32 v40, 0xff800000, v103, vcc_lo
	v_cndmask_b32_e32 v34, 0xff800000, v100, vcc_lo
	v_dual_cndmask_b32 v38, 0xff800000, v104 :: v_dual_cndmask_b32 v39, 0xff800000, v101
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s6, 0xff800000, v36
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_neq_f32_e64 s3, 0xff800000, v40
	.loc	1 761 36                        ; attention.py:761:36
	v_cndmask_b32_e32 v37, 0xff800000, v102, vcc_lo
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s5, 0xff800000, v35
	v_cmp_neq_f32_e64 s9, 0xff800000, v34
	v_cmp_neq_f32_e64 s11, 0xff800000, v38
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v102, v83, v107
	.loc	1 763 34                        ; attention.py:763:34
	...
	.loc	1 732 30                        ; attention.py:732:30
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v100, v83, v105 :: v_dual_lshlrev_b32 v91, 16, v91
	v_mul_f32_e32 v103, v83, v108
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v104, v83, v113 :: v_dual_lshlrev_b32 v105, 16, v114
	.loc	1 727 37                        ; attention.py:727:37
	s_waitcnt vmcnt(3)
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v101, v83, v106 :: v_dual_lshlrev_b32 v106, 16, v115
	.loc	1 727 37                        ; attention.py:727:37
	s_waitcnt vmcnt(1)
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v108, v89, v86 :: v_dual_lshlrev_b32 v107, 16, v116
	v_dual_mul_f32 v105, v90, v105 :: v_dual_mul_f32 v106, v100, v106
	v_dual_mul_f32 v102, v102, v97 :: v_dual_mul_f32 v103, v103, v98
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v104, v104, v99
	.loc	1 762 35                        ; attention.py:762:35
	ds_load_b64 v[86:87], v72
	ds_load_b64 v[89:90], v77
	ds_load_b64 v[97:98], v78
	ds_load_b64 v[99:100], v79
	.loc	1 763 25                        ; attention.py:763:25
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b32 v64, v36
	...
	s_barrier
	.loc	1 762 35                        ; attention.py:762:35
	v_dual_mul_f32 v37, 0x3fb8aa3b, v86 :: v_dual_mul_f32 v38, 0x3fb8aa3b, v87
	v_mul_f32_e32 v40, 0x3fb8aa3b, v90
	v_dual_mul_f32 v90, 0x3fb8aa3b, v99 :: v_dual_mul_f32 v87, 0x3fb8aa3b, v97
	...
	v_fmac_f32_e32 v90, s38, v103
	.loc	1 763 25                        ; attention.py:763:25
	v_lshrrev_b16 v36.h, 8, v34.h
	v_and_b16 v34.h, 1, v34.h
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v98, s38, v104
	.loc	1 763 25                        ; attention.py:763:25
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v101, v101, v107 :: v_dual_fmac_f32 v38, s38, v108
	.loc	1 762 35                        ; attention.py:762:35
	v_dual_mul_f32 v39, 0x3fb8aa3b, v89 :: v_dual_fmac_f32 v40, s38, v106
	.loc	1 763 25                        ; attention.py:763:25
	...
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v103, 0xff800000, v90, s14
	v_cndmask_b32_e64 v104, 0xff800000, v98, s18
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v37, s38, v91
	v_fmac_f32_e32 v87, s38, v101
	v_fmac_f32_e32 v97, s38, v102
	.loc	1 763 25                        ; attention.py:763:25
...
.Ltmp2:
	...
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v39, s38, v105
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v101, 0xff800000, v87, s13
	v_cndmask_b32_e64 v87, 0xff800000, v38, s15
	v_cndmask_b32_e64 v90, 0xff800000, v40, s16
	v_cndmask_b32_e64 v102, 0xff800000, v97, s17
...
.Ltmp6:
	...
	v_permlanex16_b32 v97, v91, s35, 0xfedcba98 op_sel:[1,0]
.Ltmp7:
	.loc	1 766 24                        ; attention.py:766:24
	v_max3_f32 v91, v57, v91, v97
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v86, v86, v91 :: v_dual_add_nc_u32 v81, 64, v81
.Ltmp8:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	s_waitcnt lgkmcnt(0)
	v_dual_max_f32 v99, v35, v35 :: v_dual_max_f32 v98, v37, v37
	v_max_f32_e32 v100, v39, v39
.Ltmp9:
...
.Ltmp12:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_dual_max_f32 v97, v98, v97 :: v_dual_max_f32 v98, v100, v99
.Ltmp13:
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp14:
	...
	v_max3_f32 v98, v98, v40, v36
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp15:
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v87, v87, v91 :: v_dual_mov_b32 v100, v98
...
.Ltmp25:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
	v_dual_mov_b32 v100, v98 :: v_dual_and_b32 v105, 1, v111
.Ltmp26:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
...
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max_f32_e32 v97, v97, v99
.Ltmp30:
	.loc	1 816 30                        ; attention.py:816:30
	v_cndmask_b16 v105.l, 0x7fff, v86.h, s15
	v_cndmask_b16 v105.h, 0x7fff, v87.h, s11
.Ltmp31:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max_f32_e32 v87, v100, v100
...
.Ltmp33:
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v106, v105, s35, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
...
.Ltmp36:
	.loc	1 816 30                        ; attention.py:816:30
	v_perm_b32 v98, v106, v105, v85
	.loc	1 766 24                        ; attention.py:766:24
	v_dual_max_f32 v87, v110, v108 :: v_dual_max_f32 v86, v99, v99
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v40, v40, v87 :: v_dual_max_f32 v107, v97, v86
	v_sub_f32_e32 v110, v35, v87
	...
	.loc	1 766 24                        ; attention.py:766:24
	v_max_f32_e32 v86, v109, v107
	.loc	1 816 30                        ; attention.py:816:30
	v_perm_b32 v97, v106, v105, v84
	.loc	1 768 49                        ; attention.py:768:49
	...
	v_sub_f32_e32 v109, v34, v86
	v_dual_sub_f32 v34, v90, v91 :: v_dual_sub_f32 v37, v37, v86
	v_sub_f32_e32 v90, v101, v91
	v_dual_sub_f32 v33, v33, v86 :: v_dual_sub_f32 v36, v36, v87
	...
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v38, v38, v86 :: v_dual_max_f32 v105, v88, v88
	.loc	1 766 24                        ; attention.py:766:24
	v_max_f32_e32 v41, v41, v107
	.loc	1 768 33                        ; attention.py:768:33
...
.Ltmp37:
	...
	v_dual_add_f32 v33, v37, v33 :: v_dual_add_f32 v36, v40, v36
...
.Ltmp38:
	...
	.loc	1 816 30 is_stmt 1              ; attention.py:816:30
	v_mov_b16_e32 v106.l, v34.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cmp_o_f32_e64 s11, v34, v34
	v_and_b32_e32 v35, 1, v106
	.loc	1 767 74                        ; attention.py:767:74
	v_sub_f32_e32 v106, v57, v91
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 816 30                        ; attention.py:816:30
	...
	v_cndmask_b32_e64 v57, 0, v106, s11
	.loc	1 768 62                        ; attention.py:768:62
...
.Ltmp44:
	...
	v_dual_mul_f32 v37, v89, v37 :: v_dual_mul_f32 v36, v38, v36
	v_mul_f32_e32 v38, v38, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_bfe_i32 v91, v33, 0, 16
	...
	v_mov_b16_e32 v106.l, v40.h
	v_mov_b16_e32 v33.l, v68.h
	v_and_b32_e32 v89, 1, v90
	.loc	1 814 31                        ; attention.py:814:31
	v_dual_mul_f32 v39, v39, v92 :: v_dual_and_b32 v90, 1, v111
	.loc	1 814 30                        ; attention.py:814:30
...
.Ltmp46:
	...
	.loc	1 767 25                        ; attention.py:767:25
	v_cndmask_b32_e64 v35, 0, v122, s11
	v_cndmask_b32_e64 v36, 0, v123, s12
.Ltmp47:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 125
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 53
