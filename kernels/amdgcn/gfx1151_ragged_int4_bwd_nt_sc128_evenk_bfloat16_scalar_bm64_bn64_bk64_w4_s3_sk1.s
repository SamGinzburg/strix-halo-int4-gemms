	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_addc_u32 s7, s7, s9
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v3, s39, v41
	.loc	1 1313 19                       ; ragged.py:1313:19
	s_load_b32 s41, s[6:7], 0x0
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v4, s39, v40
	s_mov_b32 s5, 0
...
; %bb.4:                                ; %.preheader.lr.ph
	...
	v_dual_mov_b32 v64, 0 :: v_dual_and_b32 v7, 24, v0
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or3_b32 v70, v3, v4, s33
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v3, s39, v56
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v4, s33, v56
	s_cmp_lt_i32 s3, 64
	v_mov_b32_e32 v68, 0
	...
	s_add_i32 s38, s39, s40
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v67, 0 :: v_dual_add_nc_u32 v8, s38, v41
	v_mov_b32_e32 v63, 0
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[3:4], null, s34, v56, v[3:4]
	v_dual_mov_b32 v65, 0 :: v_dual_lshlrev_b32 v4, 1, v0
	.loc	1 1520 37                       ; ragged.py:1520:37
	s_mul_i32 s22, s20, s35
	.loc	1 1433 43                       ; ragged.py:1433:43
	s_mul_i32 s20, s20, s23
	v_dual_mov_b32 v62, 0 :: v_dual_add_nc_u32 v9, s38, v40
	s_delay_alu instid0(VALU_DEP_2)
	...
	v_mad_u64_u32 v[33:34], null, s38, s34, v[3:4]
	...
	v_mad_u64_u32 v[34:35], null, s20, s34, v[3:4]
	...
	v_mul_lo_u32 v86, v8, s35
	v_cndmask_b32_e64 v8, 0, 1, s45
	v_mul_lo_u32 v87, v9, s35
	.loc	1 1312 20                       ; ragged.py:1312:20
	...
	v_cmp_ne_u32_e64 s20, 1, v8
	v_dual_mov_b32 v61, 0 :: v_dual_add_nc_u32 v88, 0, v4
	v_dual_mov_b32 v60, 0 :: v_dual_add_nc_u32 v89, 0, v3
	v_dual_mov_b32 v59, 0 :: v_dual_add_nc_u32 v90, 0, v1
	v_dual_mov_b32 v58, 0 :: v_dual_add_nc_u32 v91, 0, v6
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v92, 0, v5
	v_dual_mov_b32 v54, 0 :: v_dual_add_nc_u32 v93, 0, v7
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v94, 0, v2
	v_dual_mov_b32 v52, 0 :: v_dual_add_nc_u32 v95, 0, v10
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v96, 0, v11
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add_lshl_u32 v17, v86, s35, 1
	v_add_lshl_u32 v18, v87, s35, 1
	.loc	1 1520 25                       ; ragged.py:1520:25
	s_add_i32 s26, s35, s22
	...
	v_add_lshl_u32 v114, v84, s26, 1
	v_add_lshl_u32 v115, v85, s26, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	s_clause 0x1
	...
	v_cndmask_b32_e64 v114, 0x80000000, v114, s18
	v_cndmask_b32_e64 v115, 0x80000000, v115, s19
	s_clause 0xf
	...
	s_waitcnt vmcnt(15)
	v_dual_mul_f32 v110, v110, v17 :: v_dual_lshlrev_b32 v19, 16, v19
	.loc	1 1519 40                       ; ragged.py:1519:40
	s_waitcnt vmcnt(14)
	...
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v108, v108, v17 :: v_dual_lshlrev_b32 v27, 16, v27
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v101, v101, v17 :: v_dual_lshlrev_b32 v30, 16, v30
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v10, v10, v18 :: v_dual_lshlrev_b32 v29, 16, v29
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v99, v99, v17 :: v_dual_lshlrev_b32 v32, 16, v32
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v106, v106, v17 :: v_dual_lshlrev_b32 v31, 16, v31
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v104, v104, v17 :: v_dual_lshlrev_b32 v115, 16, v115
	.loc	1 1519 40                       ; ragged.py:1519:40
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v114, 16, v114
	.loc	1 1517 21                       ; ragged.py:1517:21
	v_dual_mul_f32 v102, v102, v17 :: v_dual_mul_f32 v15, v15, v18
	v_dual_mul_f32 v100, v100, v17 :: v_dual_mul_f32 v11, v11, v18
	v_mul_f32_e32 v17, v98, v17
	v_dual_mul_f32 v13, v13, v18 :: v_dual_fmac_f32 v68, v111, v21
	v_dual_mul_f32 v9, v9, v18 :: v_dual_fmac_f32 v64, v108, v24
	v_dual_mul_f32 v8, v8, v18 :: v_dual_fmac_f32 v65, v109, v23
	v_dual_mul_f32 v7, v7, v18 :: v_dual_fmac_f32 v66, v113, v19
	v_dual_mul_f32 v4, v4, v18 :: v_dual_fmac_f32 v63, v107, v25
	v_dual_mul_f32 v3, v3, v18 :: v_dual_fmac_f32 v60, v104, v28
	v_dual_mul_f32 v6, v6, v18 :: v_dual_fmac_f32 v69, v112, v20
	v_dual_mul_f32 v5, v5, v18 :: v_dual_fmac_f32 v52, v16, v20
	v_dual_mul_f32 v2, v2, v18 :: v_dual_fmac_f32 v61, v105, v27
	v_dual_mul_f32 v1, v1, v18 :: v_dual_fmac_f32 v48, v14, v24
	.loc	1 1525 17                       ; ragged.py:1525:17
	v_dual_fmac_f32 v67, v110, v22 :: v_dual_fmac_f32 v44, v8, v28
	v_dual_fmac_f32 v62, v106, v26 :: v_dual_fmac_f32 v59, v103, v29
	v_dual_fmac_f32 v58, v102, v30 :: v_dual_fmac_f32 v57, v101, v31
	v_dual_fmac_f32 v55, v100, v32 :: v_dual_fmac_f32 v54, v99, v114
	v_dual_fmac_f32 v53, v17, v115 :: v_dual_fmac_f32 v50, v12, v22
	v_dual_fmac_f32 v51, v15, v19 :: v_dual_fmac_f32 v46, v10, v26
	v_dual_fmac_f32 v49, v11, v21 :: v_dual_fmac_f32 v42, v4, v30
	v_dual_fmac_f32 v47, v13, v23 :: v_dual_fmac_f32 v38, v6, v32
	v_fmac_f32_e32 v45, v9, v25
	v_dual_fmac_f32 v43, v7, v27 :: v_dual_fmac_f32 v36, v1, v114
	v_fmac_f32_e32 v39, v3, v29
	v_fmac_f32_e32 v37, v5, v31
	v_fmac_f32_e32 v35, v2, v115
	.loc	1 1421 19                       ; ragged.py:1421:19
...
.LBB0_8:                                ; %.lr.ph
	...
	s_mov_b32 s26, s42
	v_add_nc_u32_e32 v98, s49, v33
	v_add_nc_u32_e32 v99, s49, v34
	s_mov_b32 s27, s43
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1436 38                       ; ragged.py:1436:38
	v_cndmask_b32_e64 v98, 0x80000000, v98, s0
	.loc	1 1437 38                       ; ragged.py:1437:38
	v_cndmask_b32_e64 v102, 0x80000000, v99, s1
	.loc	1 1436 38                       ; ragged.py:1436:38
	...
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt vmcnt(1)
	ds_store_b64 v88, v[98:99]
	ds_store_b64 v89, v[100:101]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[98:101], v90 offset1:2
	ds_load_2addr_stride64_b64 v[106:109], v91 offset1:2
	ds_load_2addr_stride64_b64 v[110:113], v92 offset1:2
	ds_load_2addr_stride64_b64 v[114:117], v93 offset1:2
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v88, v[102:103]
	ds_store_b64 v89, v[104:105]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[102:105], v94 offset1:2
	ds_load_2addr_stride64_b64 v[118:121], v95 offset1:2
	ds_load_2addr_stride64_b64 v[122:125], v96 offset1:2
	ds_load_2addr_stride64_b64 v[126:129], v97 offset1:2
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[102:103], v[100:101], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[104:105], v[100:101], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[118:119], v[106:107], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[120:121], v[106:107], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[118:119], v[108:109], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[120:121], v[108:109], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[122:123], v[110:111], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[124:125], v[110:111], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[122:123], v[112:113], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[124:125], v[112:113], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
...
.LBB0_10:                               ; %._crit_edge34
	...
	v_add3_u32 v28, v54, v29, 0x7fff
	v_mov_b16_e32 v29.l, v51.h
	...
	v_cndmask_b16 v40.l, 0x7fff, v34.h, s3
	...
	v_add3_u32 v37, v35, v41, 0x7fff
	v_cmp_o_f32_e64 s18, v35, v35
	v_cndmask_b16 v35.h, 0x7fff, v39.h, s3
	v_cmp_eq_u32_e64 s3, 0, v0
	v_cndmask_b16 v0.l, 0x7fff, v34.h, s19
	v_mov_b32_e32 v34, 0x5410
	v_cndmask_b16 v35.l, 0x7fff, v27.h, s17
	...
	v_cndmask_b32_e64 v34, 0x3276, v36, s3
	s_mov_b32 s17, 0x76543210
	v_cndmask_b16 v0.h, 0x7fff, v37.h, s18
	v_cndmask_b32_e64 v36, v33, v30, s3
	...
	v_cndmask_b32_e64 v35, v0, v40, s3
	...
	v_perm_b32 v29, v30, v36, v32
	v_perm_b32 v30, v30, v36, v34
	v_perm_b32 v36, v31, v33, v32
	...
	.loc	1 1545 17                       ; ragged.py:1545:17
	buffer_store_b16 v37, v50, s[36:39], 0 offen
	v_cndmask_b32_e64 v50, 0x80000000, v52, s3
	v_add_lshl_u32 v37, v3, v18, 1
	...
	buffer_store_b16 v21, v37, s[36:39], 0 offen
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 130
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.kd
