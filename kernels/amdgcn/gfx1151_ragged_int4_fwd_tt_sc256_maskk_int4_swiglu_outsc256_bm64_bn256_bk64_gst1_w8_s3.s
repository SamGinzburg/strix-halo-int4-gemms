...
; %bb.4:                                ; %.lr.ph
	...
	scratch_store_b64 off, v[14:15], off offset:312 ; 8-byte Folded Spill
	v_add_nc_u32_e32 v63, s33, v58
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_cndmask_b32_e64 v1, 0x80000000, v129, s3
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_mad_u64_u32 v[129:130], null, v2, s36, v[213:214]
	.loc	1 1142 32 is_stmt 1             ; ragged.py:1142:32
	v_cmp_gt_i32_e64 s3, s35, v2
	.loc	1 1155 66                       ; ragged.py:1155:66
	s_and_b32 s3, s34, s3
	.loc	1 1155 34 is_stmt 0             ; ragged.py:1155:34
	v_cndmask_b32_e64 v2, 0x80000000, v129, s3
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_mad_u64_u32 v[129:130], null, v3, s36, v[213:214]
	.loc	1 1142 32 is_stmt 1             ; ragged.py:1142:32
	v_cmp_gt_i32_e64 s3, s35, v3
	.loc	1 1155 66                       ; ragged.py:1155:66
	s_and_b32 s3, s34, s3
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
	.loc	1 1155 34 is_stmt 0             ; ragged.py:1155:34
	v_cndmask_b32_e64 v3, 0x80000000, v129, s3
	.loc	1 1155 42                       ; ragged.py:1155:42
	...
	v_add_nc_u32_e32 v7, v224, v222
	.loc	1 1155 66                       ; ragged.py:1155:66
	s_and_b32 s3, s34, s3
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_add_nc_u32_e32 v8, v225, v222
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_cndmask_b32_e64 v0, 0x80000000, v129, s3
	.loc	1 1142 32                       ; ragged.py:1142:32
	v_cmp_gt_i32_e64 s3, s35, v222
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_add_nc_u32_e32 v129, v226, v222
	v_add_nc_u32_e32 v130, v227, v222
	v_add_nc_u32_e32 v135, v221, v222
	v_add_nc_u32_e32 v136, v228, v222
	.loc	1 1156 34                       ; ragged.py:1156:34
	v_cndmask_b32_e64 v4, 0x80000000, v4, s3
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_add_nc_u32_e32 v137, v229, v222
	v_add_nc_u32_e32 v138, v230, v222
	v_add_nc_u32_e32 v139, v231, v222
	v_add_nc_u32_e32 v140, v232, v222
	v_add_nc_u32_e32 v141, v233, v222
	v_add_nc_u32_e32 v142, v234, v222
	v_add_nc_u32_e32 v143, v235, v222
	v_add_nc_u32_e32 v144, v236, v222
	...
	.loc	1 1185 39                       ; ragged.py:1185:39
	v_cndmask_b32_e64 v237, 0x80000000, v237, s3
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	...
	.loc	1 1185 39                       ; ragged.py:1185:39
	v_cndmask_b32_e64 v240, 0x80000000, v240, s3
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	...
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v242, v129, v222
	...
	v_cndmask_b32_e64 v254, 0x80000000, v254, s3
	.loc	1 1186 29                       ; ragged.py:1186:29
	...
	v_cndmask_b32_e64 v253, 0x80000000, v253, s3
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	...
	.loc	1 1185 39                       ; ragged.py:1185:39
	v_cndmask_b32_e64 v255, 0x80000000, v255, s3
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	...
	.loc	1 1186 29                       ; ragged.py:1186:29
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v216, v162, v222
	...
	v_dual_mov_b32 v253, v129 :: v_dual_mov_b32 v218, v163
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc256_maskk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 1184
