...
.Ltmp11:
	...
	v_mad_u64_u32 v[7:8], null, s11, v4, v[1:2]
...
.Ltmp13:
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_clause 0x1
	buffer_load_b32 v44, v8, s[12:15], 0 offen
...
.Ltmp15:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_subrev_nc_u32_e32 v33, s10, v6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b32 v86, v32, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[46:49], v34, s[16:19], 0 offen
	...
	v_add_nc_u32_e32 v41, s1, v35
	v_add_nc_u32_e32 v42, s1, v36
	...
	v_dual_add_f32 v15, v15, v40 :: v_dual_add_nc_u32 v34, s22, v34
	v_dual_add_f32 v16, v16, v41 :: v_dual_add_nc_u32 v127, s27, v18
	v_add_f32_e32 v12, v12, v43
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v38, v38
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v11, v11, v42 :: v_dual_add_f32 v14, v14, v45
	v_add_f32_e32 v13, v13, v44
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v9, v9, v38 :: v_dual_add_nc_u32 v32, s23, v32
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v128, s10, v23
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_add_i32 s1, s27, 0x4000
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v129, s10, v24
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s25, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v130, s10, v25
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v131, s10, v26
	v_add_nc_u32_e32 v132, s10, v27
	v_add_nc_u32_e32 v133, s10, v28
	v_add_nc_u32_e32 v134, s10, v29
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(2)
...
; %bb.9:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v22, v18 :: v_dual_add_nc_u32 v21, s0, v5
...
; %bb.11:
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v38, s1, v17
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v4, s10, v4
	v_add_nc_u32_e32 v18, s10, v3
	v_add_nc_u32_e32 v19, s10, v2
	v_add_nc_u32_e32 v20, s10, v1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v5, s1, v5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 135
