	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 569 19                        ; attention.py:569:19
	s_add_i32 s0, s1, s0
	v_dual_mov_b32 v29, v65 :: v_dual_add_nc_u32 v2, 0, v2
	.loc	1 599 26                        ; attention.py:599:26
	...
	s_lshl3_add_u32 s15, s3, s0
	.loc	1 753 27                        ; attention.py:753:27
	s_mul_i32 s3, s9, s3
	v_dual_mov_b32 v31, v65 :: v_dual_add_nc_u32 v88, v7, v80
	.loc	1 752 25                        ; attention.py:752:25
	s_add_i32 s48, s1, s3
	v_cmp_eq_u32_e64 s1, 0, v3
	v_dual_mov_b32 v18, 0x7531 :: v_dual_add_nc_u32 v89, v7, v84
	.loc	1 707 13                        ; attention.py:707:13
	v_add_nc_u32_e32 v90, v7, v83
	v_dual_mov_b32 v28, v65 :: v_dual_add_nc_u32 v91, v7, v82
	...
	v_dual_mov_b32 v21, v65 :: v_dual_and_b32 v16, 0x760032, v16
	v_lshl_or_b32 v18, v18, 8, v18
	v_dual_mov_b32 v20, v65 :: v_dual_lshlrev_b32 v95, 2, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v32, v65 :: v_dual_and_b32 v7, 0x750031, v7
	v_cmp_eq_u32_e64 s3, 0, v78
	v_dual_mov_b32 v27, v65 :: v_dual_add_nc_u32 v86, s13, v6
	v_lshl_or_b32 v1, v7, 4, v7
	.loc	1 748 47                        ; attention.py:748:47
	v_subrev_nc_u32_e32 v87, s12, v6
	.loc	1 771 51                        ; attention.py:771:51
	v_lshrrev_b32_e32 v6, 4, v0
	v_lshl_or_b32 v16, v16, 4, v16
	v_dual_mov_b32 v23, v65 :: v_dual_and_b32 v18, 0x750031, v18
	v_cndmask_b32_e64 v14, 0x1054, v14, s3
	v_and_b32_e32 v96, 0x7050301, v1
	v_cndmask_b32_e64 v1, 0x3276, v15, s3
	v_xor_b32_e32 v11, 0x50, v85
	v_cndmask_b32_e64 v17, 0x5410, v15, s1
	v_and_b32_e32 v93, 0x7060302, v16
	...
	v_lshl_or_b32 v99, s15, 10, v6
	v_lshl_or_b32 v1, v1, 8, v1
	v_dual_mov_b32 v15, v65 :: v_dual_lshlrev_b32 v6, 5, v0
	.loc	1 571 21                        ; attention.py:571:21
	v_bfe_i32 v4, v0, 0, 1
	.loc	1 601 23                        ; attention.py:601:23
	v_cmp_gt_i32_e64 s0, 0x800, v5
	v_dual_mov_b32 v26, v65 :: v_dual_and_b32 v5, 0x70, v0
	v_xor_b32_e32 v10, 64, v85
	v_xor_b32_e32 v12, 0x60, v85
	v_lshl_or_b32 v17, v17, 8, v17
	v_dual_mov_b32 v24, v65 :: v_dual_and_b32 v97, 0x7050301, v7
	v_and_b32_e32 v1, 0x760076, v1
	v_lshlrev_b32_e32 v7, 7, v0
	v_and_b32_e32 v6, 0x160, v6
	.loc	1 748 30                        ; attention.py:748:30
	v_dual_mov_b32 v120, v87 :: v_dual_add_nc_u32 v107, 0, v11
	v_mov_b32_e32 v11, v65
	v_and_or_b32 v98, v16, 60, v3
	v_and_b32_e32 v3, 0x540054, v14
	v_bfe_i32 v14, v0, 2, 1
	v_dual_mov_b32 v30, v65 :: v_dual_and_b32 v17, 0x760032, v17
	v_lshrrev_b32_e32 v5, 2, v5
	v_and_b32_e32 v4, 0x90, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_and_or_b32 v100, 0x90, v14, v6
	v_dual_mov_b32 v121, v87 :: v_dual_add_nc_u32 v106, 0, v10
	.loc	1 749 30                        ; attention.py:749:30
	v_dual_mov_b32 v123, v86 :: v_dual_add_nc_u32 v108, 0, v12
	v_mov_b32_e32 v10, v65
	v_lshl_or_b32 v3, v3, 4, v3
	v_mov_b32_e32 v12, v65
	v_lshl_or_b32 v1, v1, 4, v1
	v_dual_mov_b32 v14, v65 :: v_dual_and_b32 v7, 0x700, v7
	v_mov_b32_e32 v16, v65
	v_xor_b32_e32 v2, 16, v85
	v_xor_b32_e32 v8, 32, v85
	v_xor_b32_e32 v9, 48, v85
	v_xor_b32_e32 v13, 0x70, v85
	...
	v_and_b32_e32 v94, 0x7060302, v17
	v_dual_mov_b32 v6, v65 :: v_dual_add_nc_u32 v103, 0, v2
	v_dual_mov_b32 v7, v65 :: v_dual_add_nc_u32 v104, 0, v8
	v_dual_mov_b32 v8, v65 :: v_dual_add_nc_u32 v105, 0, v9
	.loc	1 748 30                        ; attention.py:748:30
	v_dual_mov_b32 v122, v87 :: v_dual_add_nc_u32 v109, 0, v13
	.loc	1 749 30                        ; attention.py:749:30
	v_dual_mov_b32 v124, v86 :: v_dual_add_nc_u32 v111, 0, v4
	...
	v_dual_mov_b32 v125, v86 :: v_dual_add_nc_u32 v110, v3, v1
	v_mov_b32_e32 v1, 0
	...
	s_lshl_b32 s45, s15, 11
	.loc	1 794 21                        ; attention.py:794:21
	s_lshl_b32 s47, s15, 7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 741 30                        ; attention.py:741:30
	v_dual_mov_b32 v71, v65 :: v_dual_add_nc_u32 v158, s6, v99
	...
	v_or_b32_e32 v134, s35, v112
	v_or_b32_e32 v135, s35, v113
	...
	v_add_lshl_u32 v150, s5, v115, 1
	v_add_lshl_u32 v151, s5, v88, 1
	v_add_lshl_u32 v152, s5, v117, 1
	v_add_lshl_u32 v153, s5, v116, 1
...
.Ltmp43:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 168
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.kd
