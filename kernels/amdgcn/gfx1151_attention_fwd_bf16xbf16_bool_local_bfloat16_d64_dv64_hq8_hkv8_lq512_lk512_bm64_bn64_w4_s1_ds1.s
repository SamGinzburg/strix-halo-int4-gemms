...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v2, s12, v2
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v166, s6, v4
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v170, s7, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v167, s6, v1
	v_subrev_nc_u32_e32 v168, s6, v2
	v_dual_mov_b32 v44, v41 :: v_dual_add_nc_u32 v171, s7, v1
	v_dual_mov_b32 v45, v41 :: v_dual_add_nc_u32 v172, s7, v2
	v_dual_mov_b32 v47, v41 :: v_dual_lshlrev_b32 v2, 7, v28
	v_dual_mov_b32 v48, v41 :: v_dual_lshlrev_b32 v1, 6, v72
	...
	v_dual_mov_b32 v46, v41 :: v_dual_add_nc_u32 v173, s7, v3
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v23, v41 :: v_dual_lshlrev_b32 v12, 2, v72
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 112
