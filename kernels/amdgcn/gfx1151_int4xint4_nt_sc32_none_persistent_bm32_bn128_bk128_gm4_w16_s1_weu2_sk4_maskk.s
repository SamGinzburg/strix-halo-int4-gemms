	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	v_or3_b32 v11, v11, v18, v19
	v_xor_b32_e32 v19, v8, v9
	v_and_b32_e32 v8, 0x60, v21
	v_and_b32_e32 v20, 0x77c, v5
.Ltmp11:
...
.Ltmp18:
	...
	v_and_b32_e32 v13, 0x108, v0
	v_lshlrev_b32_e32 v0, 5, v0
	v_lshlrev_b32_e32 v9, 2, v4
	s_sub_i32 s4, 0, s5
	v_xor_b32_e32 v24, 8, v11
	v_lshl_or_b32 v13, v2, 4, v13
	...
	v_xor_b32_e32 v34, 0x1010, v0
	v_xor_b32_e32 v35, 0x2040, v0
	v_xor_b32_e32 v36, 0x3050, v0
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
	v_or_b32_e32 v18, v10, v2
	v_or_b32_e32 v9, s0, v2
	v_and_or_b32 v10, v5, 12, s0
	s_mul_i32 s4, s4, s1
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
...
.LBB0_2:                                ; %._crit_edge
	...
	ds_load_2addr_b32 v[11:12], v36 offset1:32
	...
	v_add_lshl_u32 v37, v7, s6, 2
	v_add_lshl_u32 v38, v7, s7, 2
	s_waitcnt lgkmcnt(3)
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v4, s45, v14
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_dual_mov_b32 v6, v0 :: v_dual_add_nc_u32 v3, v17, v44
	.loc	1 323 30                        ; generate_amdgcn.py:323:30
	...
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	v_mov_b32_e32 v4, v0
	v_dual_mov_b32 v5, v0 :: v_dual_add_nc_u32 v44, s42, v44
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
	s_add_i32 s47, s47, -1
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[54:55], v20
	ds_load_b64 v[56:57], v21
	.loc	1 323 30                        ; generate_amdgcn.py:323:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	s_barrier
	.loc	1 327 22                        ; generate_amdgcn.py:327:22
	buffer_load_u16 v58, v45, s[8:11], 0 offen
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x7
	buffer_load_u16 v59, v3, s[24:27], 0 offen
	buffer_load_u16 v60, v3, s[24:27], 0 offen offset:4
	buffer_load_u16 v61, v3, s[24:27], 0 offen offset:8
	buffer_load_u16 v62, v3, s[24:27], 0 offen offset:12
	buffer_load_u16 v63, v3, s[24:27], 0 offen offset:16
	buffer_load_u16 v64, v3, s[24:27], 0 offen offset:20
	buffer_load_u16 v65, v3, s[24:27], 0 offen offset:24
	buffer_load_u16 v66, v3, s[24:27], 0 offen offset:28
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	v_mov_b32_e32 v7, v0
	v_mov_b32_e32 v1, v0
	v_mov_b32_e32 v2, v0
	...
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[46:53], v[1:2], v[54:55], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[46:53], v[3:4], v[56:57], v[46:53] neg_lo:[1,1,0]
	...
	s_waitcnt vmcnt(5)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v1, v1, v47 :: v_dual_lshlrev_b32 v50, 16, v61
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v40, v1, v48 :: v_dual_add_nc_u32 v45, 2, v45
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_dual_mul_f32 v2, v2, v47 :: v_dual_lshlrev_b32 v49, 16, v60
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v4, v4, v47 :: v_dual_lshlrev_b32 v51, 16, v62
	v_mul_f32_e32 v6, v6, v47
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v43, v2, v49 :: v_dual_lshlrev_b32 v52, 16, v63
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v46, v46, v47 :: v_dual_lshlrev_b32 v53, 16, v64
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v3, v3, v47 :: v_dual_lshlrev_b32 v54, 16, v65
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v38, v6, v53 :: v_dual_lshlrev_b32 v55, 16, v66
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_mul_f32_e32 v5, v5, v47
	v_mul_f32_e32 v7, v7, v47
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v42, v3, v50 :: v_dual_fmac_f32 v41, v4, v51
	v_fmac_f32_e32 v13, v46, v55
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v39, v5, v52
	v_fmac_f32_e32 v37, v7, v54
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.num_vgpr, 67
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_maskk.kd
