	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v31, v65 :: v_dual_add_nc_u32 v92, s13, v5
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v28, v65 :: v_dual_add_nc_u32 v3, 0, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v30, v65 :: v_dual_and_b32 v1, 12, v0
	...
	v_dual_mov_b32 v77, 0 :: v_dual_add_nc_u32 v98, v9, v88
	v_dual_mov_b32 v32, v65 :: v_dual_lshlrev_b32 v9, 5, v0
	...
	v_xor_b32_e32 v5, 32, v93
	v_cndmask_b32_e64 v1, 0x1054, v2, s1
	v_dual_mov_b32 v2, 0x7632 :: v_dual_and_b32 v15, 64, v0
	v_dual_mov_b32 v135, 0xff800000 :: v_dual_add_nc_u32 v106, 0, v3
	v_mov_b32_e32 v3, v65
	s_delay_alu instid0(VALU_DEP_3)
	v_cndmask_b32_e64 v2, 0x3276, v2, s1
	v_and_b32_e32 v20, 0x700, v20
	...
	v_dual_mov_b32 v13, v65 :: v_dual_and_b32 v4, 0x70, v0
	...
	v_dual_mov_b32 v129, 0xff800000 :: v_dual_add_nc_u32 v2, 0, v20
	v_dual_mov_b32 v20, v65 :: v_dual_lshlrev_b32 v19, 1, v15
	v_lshrrev_b32_e32 v15, 5, v15
	v_and_b32_e32 v21, 0x90, v21
	v_xor_b32_e32 v6, 48, v93
	v_xor_b32_e32 v7, 64, v93
	v_or_b32_e32 v18, v101, v19
	v_or3_b32 v102, v16, v17, v15
	v_add_nc_u32_e32 v100, 0, v19
	v_xor_b32_e32 v8, 0x50, v93
	v_xor_b32_e32 v11, 0x70, v93
	...
	v_dual_mov_b32 v127, 0xff800000 :: v_dual_add_nc_u32 v108, 0, v6
	...
	v_dual_mov_b32 v128, 0xff800000 :: v_dual_add_nc_u32 v109, 0, v7
	v_add_nc_u32_e32 v110, 0, v8
	s_delay_alu instid0(VALU_DEP_4)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s1, s1, s23
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v67, v65 :: v_dual_add_nc_u32 v138, 0, v93
	...
	v_or_b32_e32 v142, s34, v85
	v_or_b32_e32 v140, s34, v87
	v_or_b32_e32 v139, s34, v88
	...
	s_barrier
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v141, s34, v86
	v_dual_mov_b32 v130, v77 :: v_dual_add_nc_u32 v167, s4, v126
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s1, v142, v89
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s4, v142, v90
	.loc	1 955 25                        ; attention.py:955:25
	s_add_i32 s3, s46, s34
	.loc	1 1001 53                       ; attention.py:1001:53
	s_lshr_b32 s5, s34, 4
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s10, v140, v89
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s12, v140, v90
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s14, v139, v89
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s16, v139, v90
	...
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s5, v142, v92
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s6, v141, v89
	v_cmp_ge_i32_e64 s7, v141, v91
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s8, v141, v90
	v_cmp_le_i32_e64 s9, v141, v92
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s11, v140, v91
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s13, v140, v92
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s15, v139, v91
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s17, v139, v92
...
.Ltmp56:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 172
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
