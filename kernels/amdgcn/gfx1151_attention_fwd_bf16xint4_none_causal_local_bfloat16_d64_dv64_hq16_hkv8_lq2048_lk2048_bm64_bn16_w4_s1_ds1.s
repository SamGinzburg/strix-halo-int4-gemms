	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v15, v8 :: v_dual_lshlrev_b32 v26, 1, v0
	.loc	1 598 26                        ; attention.py:598:26
	s_waitcnt lgkmcnt(0)
	...
	s_mul_i32 s5, s18, 48
	v_dual_mov_b32 v13, v8 :: v_dual_and_b32 v52, 0x70, v26
	s_delay_alu instid0(VALU_DEP_2)
...
; %bb.1:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v3, s12, v35
	.loc	1 566 23                        ; attention.py:566:23
	s_ashr_i32 s8, s3, 31
	s_load_b32 s13, s[0:1], 0x64
	s_lshr_b32 s14, s8, 28
	...
	.loc	1 707 13                        ; attention.py:707:13
	s_lshl_b32 s6, s3, 10
	v_cndmask_b32_e64 v8, 0x3276, v8, s5
	v_cndmask_b32_e64 v7, 0x1054, v7, s5
	...
	v_and_b32_e32 v81, 0x7060706, v8
	v_and_b32_e32 v8, 0x160, v18
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v4, 0, v4
	ds_load_b128 v[61:64], v10
	ds_load_b128 v[57:60], v4
	v_and_or_b32 v82, 0x90, v0, v8
	.loc	1 707 13                        ; attention.py:707:13
	v_add3_u32 v0, s7, s33, v65
	v_mov_b32_e32 v65, 0
	...
	v_dual_mov_b32 v29, v65 :: v_dual_and_b32 v16, 0x90, v16
	s_add_i32 s3, s3, s1
	v_mov_b32_e32 v32, v65
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v80, 0x5040504, v7
	v_dual_mov_b32 v20, v65 :: v_dual_and_b32 v7, 0x700, v17
	s_lshl3_add_u32 s1, s4, s3
	v_dual_mov_b32 v26, v65 :: v_dual_lshlrev_b32 v1, 2, v66
	v_xor_b32_e32 v6, v16, v6
	v_mul_lo_u32 v16, s18, v0
	v_or_b32_e32 v0, s1, v9
	v_xor_b32_e32 v4, 16, v78
	v_xor_b32_e32 v10, 32, v78
	v_xor_b32_e32 v11, 48, v78
	v_xor_b32_e32 v12, 64, v78
	v_xor_b32_e32 v13, 0x50, v78
	v_xor_b32_e32 v14, 0x60, v78
	v_xor_b32_e32 v15, 0x70, v78
	v_dual_mov_b32 v22, v65 :: v_dual_add_nc_u32 v7, 0, v7
	v_dual_mov_b32 v21, v65 :: v_dual_lshlrev_b32 v8, 3, v66
	v_xor_b32_e32 v9, 16, v82
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s0, s19, v1
	.loc	1 707 13                        ; attention.py:707:13
	v_mad_u64_u32 v[0:1], null, s19, v0, v[1:2]
	s_mul_i32 s6, s19, s6
	v_lshl_add_u32 v84, v16, 1, v2
	v_lshl_add_u32 v83, s6, 1, v8
	v_dual_mov_b32 v24, v65 :: v_dual_add_nc_u32 v85, 0, v4
	v_dual_mov_b32 v23, v65 :: v_dual_add_nc_u32 v86, 0, v10
	v_dual_mov_b32 v10, v65 :: v_dual_add_nc_u32 v87, 0, v11
	v_add_nc_u32_e32 v88, 0, v12
	v_dual_mov_b32 v12, v65 :: v_dual_add_nc_u32 v89, 0, v13
	v_dual_mov_b32 v11, v65 :: v_dual_add_nc_u32 v90, 0, v14
	v_dual_mov_b32 v14, v65 :: v_dual_add_nc_u32 v91, 0, v15
	v_dual_mov_b32 v16, v65 :: v_dual_add_nc_u32 v93, v7, v6
	v_dual_mov_b32 v13, v65 :: v_dual_add_nc_u32 v94, 0, v9
	v_mov_b32_e32 v27, v65
	v_mov_b32_e32 v28, v65
	v_min_i32_e32 v92, v3, v5
	...
	v_dual_mov_b32 v4, v65 :: v_dual_mov_b32 v75, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v73, 0x80000000, v84 :: v_dual_mov_b32 v66, v65
...
.Ltmp7:
	...
	v_perm_b32 v66, v67, v100, v80
	v_perm_b32 v67, v67, v100, v81
	.loc	1 768 33                        ; attention.py:768:33
	...
	v_perm_b32 v68, v69, v102, v80
	v_perm_b32 v69, v69, v102, v81
	.loc	1 768 33                        ; attention.py:768:33
	...
	v_perm_b32 v70, v71, v104, v80
	v_perm_b32 v71, v71, v104, v81
	.loc	1 768 33                        ; attention.py:768:33
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_perm_b32 v72, v73, v107, v80
	v_perm_b32 v73, v73, v107, v81
	.loc	1 775 32                        ; attention.py:775:32
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 115
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.kd
