	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_sub_i32 s9, 0, s5
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[11:12], null, s31, v5, v[9:10]
	.loc	1 319 16                        ; generate_amdgcn.py:319:16
	v_rcp_iflag_f32_e32 v1, s6
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_lshl_add_u32 v16, s31, 6, v10
	v_lshl_add_u32 v45, s31, 7, v10
...
.Ltmp19:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s6, s35, s30
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v46, v1, v15, s4
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v1, s6, v10
	v_add_nc_u32_e32 v2, s6, v16
	v_add_nc_u32_e32 v4, s6, v45
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e64 v7, 0x80000000, v1, s3
	...
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v6, s30, v46
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v22, s34, v15
	v_or_b32_e32 v23, s34, v9
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v30, s34, v46
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s6, s6, 64
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_cndmask_b32_e32 v14, 0x80000000, v6, vcc_lo
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_cmp_gt_i32_e32 vcc_lo, s31, v22
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s4, s31, v23
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v1, 64, v1
	v_add_nc_u32_e32 v31, s6, v16
	...
	buffer_load_b128 v[26:29], v12, s[36:39], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v12, v14, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v4, 0x80000000, v31
	v_dual_cndmask_b32 v14, 0x80000000, v32 :: v_dual_cndmask_b32 v13, 0x80000000, v13
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v42, v2, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[30:33], v1, s[36:39], 0 offen
	buffer_load_b128 v[34:37], v4, s[36:39], 0 offen
	buffer_load_b128 v[38:41], v14, s[36:39], 0 offen
	buffer_load_b128 v[50:53], v13, s[36:39], 0 offen
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v48, v3, v4
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v49, v13, v1
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v13, v12 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v13, v42 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	...
	s_waitcnt vmcnt(1)
	ds_store_b128 v1, v[38:41] offset:24576
	s_waitcnt vmcnt(0)
...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s22, s16
	s_mov_b32 s23, s16
	v_and_b32_e32 v2, 0x1c00, v47
	v_or_b32_e32 v37, v3, v1
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v51, 0, v12
	v_dual_mov_b32 v21, 0 :: v_dual_mov_b32 v22, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v41, v1, v2, v3
	v_and_b32_e32 v1, 32, v47
	v_xor_b32_e32 v40, 16, v37
	v_xor_b32_e32 v39, 32, v37
	v_xor_b32_e32 v38, 48, v37
	v_xor_b32_e32 v42, 16, v41
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_waitcnt lgkmcnt(0)
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_cndmask_b32_e32 v54, 0x80000000, v58, vcc_lo
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e32 vcc_lo, s31, v53
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_barrier
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v56, s20, v16
	s_mov_b32 s18, s14
	s_mov_b32 s14, s1
	.loc	1 376 22 is_stmt 0              ; generate_amdgcn.py:376:22
	...
	buffer_load_u16 v129, v54, s[40:43], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v130, v52, s[4:7], 0 offen
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v52, s20, v11
	.loc	1 376 22 is_stmt 0              ; generate_amdgcn.py:376:22
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v60, v60, v100 :: v_dual_add_nc_u32 v131, s20, v49
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v25, v59, v91 :: v_dual_add_nc_u32 v132, s44, v48
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v18, v52, v84 :: v_dual_fmac_f32 v33, v66, v98
	...
	v_dual_fmac_f32 v26, v60, v92 :: v_dual_fmac_f32 v29, v63, v95
	v_dual_fmac_f32 v28, v62, v94 :: v_dual_fmac_f32 v31, v65, v97
	v_fmac_f32_e32 v30, v64, v96
...
.LBB0_10:
	...
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v62, 0, v12
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v72, 0 :: v_dual_add_nc_u32 v63, v1, v14
...
.LBB0_12:
	...
	v_dual_cndmask_b32 v8, 0x3276, v40 :: v_dual_cndmask_b32 v1, v1, v3
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 133
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
