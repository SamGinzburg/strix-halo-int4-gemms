	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	s_clause 0x1
	buffer_load_b64 v[7:8], v4, s[20:23], 0 offen
...
.LBB0_3:                                ; %Flow66
	...
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v26, 0xe0, v0
	v_dual_mov_b32 v11, 0 :: v_dual_and_b32 v32, 16, v4
	v_bfe_u32 v27, v0, 4, 1
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v15, 0 :: v_dual_lshlrev_b32 v28, 6, v31
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v30, 2, v0
	v_dual_mov_b32 v12, 0 :: v_dual_lshlrev_b32 v29, 5, v26
...
; %bb.4:                                ; %.lr.ph
	...
	v_add3_u32 v4, s34, v32, v31
	v_or_b32_e32 v3, s15, v3
	s_lshl_b32 s13, s13, 7
	v_add_nc_u32_e32 v35, s34, v2
	...
	v_mul_lo_u32 v24, s40, v5
	v_subrev_nc_u32_e32 v5, s13, v23
	v_mul_lo_u32 v23, s40, v4
	...
	v_subrev_nc_u32_e32 v35, s17, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 168 18                        ; generate_amdgcn.py:168:18
	s_clause 0x1
	buffer_load_u16 v97, v37, s[36:39], 0 offen
	buffer_load_u16 v98, v36, s[36:39], 0 offen
	.loc	1 191 34                        ; generate_amdgcn.py:191:34
	...
	s_clause 0x1
	buffer_load_u16 v89, v99, s[28:31], 0 offen
	buffer_load_u16 v90, v99, s[28:31], 0 offen offset:4
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(4)
	...
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x5
	buffer_load_u16 v91, v99, s[28:31], 0 offen offset:8
	buffer_load_u16 v92, v99, s[28:31], 0 offen offset:12
	buffer_load_u16 v93, v99, s[28:31], 0 offen offset:16
	buffer_load_u16 v94, v99, s[28:31], 0 offen offset:20
	buffer_load_u16 v102, v99, s[28:31], 0 offen offset:24
	buffer_load_u16 v99, v99, s[28:31], 0 offen offset:28
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(2)
	...
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	buffer_load_b64 v[85:86], v100, s[20:23], 0 offen
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(3)
	...
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	buffer_load_b64 v[77:78], v101, s[20:23], 0 offen
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	v_dual_mul_f32 v66, v74, v66 :: v_dual_add_nc_u32 v37, 2, v37
	v_dual_mul_f32 v62, v73, v62 :: v_dual_add_nc_u32 v35, s42, v35
	...
	v_dual_mul_f32 v72, v74, v72 :: v_dual_lshlrev_b32 v73, 16, v89
	v_mul_f32_e32 v67, v74, v67
	v_mul_f32_e32 v69, v74, v69
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v81, 16, v102
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v71, v74, v71 :: v_dual_lshlrev_b32 v74, 16, v90
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v24, v65, v73 :: v_dual_lshlrev_b32 v75, 16, v91
	.loc	1 205 18 is_stmt 1              ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v79, 16, v93
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v9, v57, v73 :: v_dual_lshlrev_b32 v82, 16, v99
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v23, v58, v74 :: v_dual_fmac_f32 v14, v68, v76
	v_dual_fmac_f32 v22, v59, v75 :: v_dual_fmac_f32 v21, v60, v76
	v_fmac_f32_e32 v16, v66, v74
	v_dual_fmac_f32 v20, v61, v79 :: v_dual_fmac_f32 v19, v62, v80
	v_fmac_f32_e32 v10, v72, v82
	v_dual_fmac_f32 v18, v63, v81 :: v_dual_fmac_f32 v17, v64, v82
	v_dual_fmac_f32 v12, v70, v80 :: v_dual_fmac_f32 v15, v67, v75
	v_fmac_f32_e32 v13, v69, v79
	v_fmac_f32_e32 v11, v71, v81
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
...
.LBB0_6:                                ; %._crit_edge
	...
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_or_b32_e32 v32, 32, v31
	.loc	1 168 26                        ; generate_amdgcn.py:168:26
	v_mul_lo_u32 v1, s40, v31
	s_add_i32 s4, s4, s3
	v_dual_mov_b32 v5, 0 :: v_dual_mov_b32 v6, 0
	v_mul_lo_u32 v2, s40, v32
...
; %bb.7:
	...
	v_dual_mov_b32 v40, s19 :: v_dual_and_b32 v1, 56, v30
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_and_or_b32 v30, 0x438, v30, v28
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v39, s18 :: v_dual_mov_b32 v38, s17
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	v_or3_b32 v63, v29, v1, v28
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v37, s16 :: v_dual_mov_b32 v36, s15
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_add_nc_u32_e32 v1, 0, v30
	v_xad_u32 v3, v30, 8, 0
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	v_add_nc_u32_e32 v2, 0, v63
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[43:46], v1 offset0:16 offset1:20
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v5, v30, 16, 0
	ds_load_2addr_stride64_b64 v[47:50], v3 offset0:16 offset1:20
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[67:68], v1
	ds_load_b64 v[69:70], v2
	ds_load_b64 v[71:72], v4
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v1, v30, 24, 0
	v_xad_u32 v2, v30, 32, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v35, s14 :: v_dual_mov_b32 v34, s13
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	v_xad_u32 v64, v30, 40, 0
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[73:74], v65
	ds_load_b64 v[75:76], v66
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v77, v30, 56, 0
	v_xad_u32 v30, v30, 48, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(9)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[28:29], v[43:44], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[28:29], v[45:46], v[33:40] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[43:46], v64 offset0:16 offset1:20
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	v_xad_u32 v78, v63, 48, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[67:68], v[47:48], v[1:8] neg_lo:[1,1,0]
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	v_xad_u32 v47, v63, 56, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_wmma_i32_16x16x16_iu4 v[33:40], v[67:68], v[49:50], v[33:40] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[63:66], v30 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(6)
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[47:50], v77 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	...
	v_wmma_i32_16x16x16_iu4 v[33:40], v[69:70], v[57:58], v[33:40] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[75:76], v[59:60], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[75:76], v[61:62], v[33:40] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[73:74], v[43:44], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[73:74], v[45:46], v[33:40] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[28:29], v[63:64], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[28:29], v[65:66], v[33:40] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[51:52], v[47:48], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[51:52], v[49:50], v[33:40] neg_lo:[1,1,0]
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
...
.LBB0_8:
	...
	v_dual_mul_f32 v34, v34, v46 :: v_dual_and_b32 v25, 0x78, v25
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_dual_mul_f32 v33, v33, v46 :: v_dual_and_b32 v0, 16, v0
	v_mul_f32_e32 v39, v39, v46
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_mul_lo_u32 v31, s35, v31
	v_mul_lo_u32 v32, s35, v32
	s_mul_i32 s34, s34, s35
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v35, v35, v46 :: v_dual_mul_f32 v6, v6, v41
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_add3_u32 v25, s34, s33, v25
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v36, v36, v46 :: v_dual_mul_f32 v7, v7, v41
	v_dual_mul_f32 v37, v37, v46 :: v_dual_mul_f32 v8, v8, v41
	v_mul_f32_e32 v40, v40, v46
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add_lshl_u32 v31, v25, v31, 1
	v_add_lshl_u32 v25, v25, v32, 1
	...
	v_fma_f32 v27, v33, v27, v24
	v_fma_f32 v2, v2, v28, v23
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v3, v3, v29, v22
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v33, v38, v41, v12
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_max_f32_e32 v9, v9, v9
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v5, v5, v32, v20
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_max_f32_e32 v4, v4, v4
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v34, v39, v43, v11
	v_fma_f32 v32, v37, v32, v13
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_max_f32_e32 v1, 0, v1
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v8, v8, v26, v17
	v_fma_f32 v26, v40, v26, v10
	...
	.loc	1 214 19                        ; generate_amdgcn.py:214:19
	v_dual_mul_f32 v7, v7, v7 :: v_dual_and_b32 v30, 1, v61
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_dual_max_f32 v3, 0, v3 :: v_dual_and_b32 v24, 1, v54
	v_dual_max_f32 v4, 0, v4 :: v_dual_and_b32 v23, 1, v53
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_dual_cndmask_b32 v4, v4, v8 :: v_dual_and_b32 v5, 0x760076, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v8, v16, v12 :: v_dual_and_b32 v3, 0x540054, v3
	...
	v_permlanex16_b32 v3, v4, s3, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v5, v8, s3, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v8, v0, s3, 0xfedcba98 op_sel:[1,0]
	s_mov_b32 s2, s6
	...
	buffer_store_b128 v[4:7], v25, s[0:3], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 103
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
