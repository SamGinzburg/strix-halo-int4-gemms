...
.Ltmp0:
	...
	.loc	1 774 26                        ; attention.py:774:26
	v_and_or_b32 v61, v50, 30, v48
	v_xor_b32_e32 v58, v38, v52
	v_and_b32_e32 v52, 24, v50
	v_or_b32_e32 v59, s72, v48
	.loc	1 779 31                        ; attention.py:779:31
	v_cndmask_b32_e64 v1, 0x80000000, v2, s2
	v_cndmask_b32_e64 v48, 0x7632, v46, s1
	...
	v_dual_mov_b32 v16, v24 :: v_dual_and_b32 v65, 0x210, v60
	v_dual_mov_b32 v17, v24 :: v_dual_and_b32 v38, 48, v38
	v_dual_mov_b32 v19, v24 :: v_dual_lshlrev_b32 v60, 2, v61
	v_lshl_or_b32 v61, v41, 5, v52
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v21, v24 :: v_dual_and_b32 v48, 0x760032, v48
	.loc	1 759 31                        ; attention.py:759:31
	v_lshrrev_b32_e32 v69, 1, v44
	v_xor_b32_e32 v38, v38, v44
	v_lshl_or_b32 v44, v51, 6, v53
	v_lshl_or_b32 v53, v41, 8, v41
	v_lshl_or_b32 v70, v42, 8, v42
	v_lshl_or_b32 v71, v43, 8, v43
	v_mad_u64_u32 v[41:42], null, s5, v39, v[36:37]
	v_mov_b32_e32 v18, v24
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v20, v24 :: v_dual_and_b32 v39, 0x750031, v71
	...
	v_mad_u64_u32 v[42:43], null, s57, v69, v[37:38]
	v_lshl_or_b32 v36, v48, 4, v48
	v_and_b32_e32 v37, 0x760032, v53
	v_and_b32_e32 v38, 0x750031, v70
	v_dual_mov_b32 v28, v24 :: v_dual_lshlrev_b32 v49, 6, v49
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v13, v24 :: v_dual_and_b32 v72, 0x7060302, v36
	v_xor_b32_e32 v48, 0x1b0, v64
	v_lshl_or_b32 v36, v37, 4, v37
	v_lshl_or_b32 v37, v38, 4, v38
	v_lshl_or_b32 v38, v39, 4, v39
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s0, s0, 3
	v_dual_mov_b32 v12, v24 :: v_dual_add_nc_u32 v75, 0, v48
	.loc	1 871 27                        ; attention.py:871:27
	s_mul_i32 s0, s59, s0
	v_and_or_b32 v62, v50, 60, v49
	v_xor_b32_e32 v49, 8, v61
	s_mov_b32 s68, s52
	...
	v_dual_mov_b32 v22, v24 :: v_dual_add_nc_u32 v69, 0, v49
	v_dual_mov_b32 v7, v24 :: v_dual_and_b32 v82, 0x7060302, v36
	...
	v_dual_mov_b32 v4, v24 :: v_dual_and_b32 v83, 0x7050301, v37
	v_mov_b32_e32 v6, v24
	v_and_b32_e32 v84, 0x7050301, v38
	v_lshl_or_b32 v38, v46, 8, v46
	.loc	1 844 25                        ; attention.py:844:25
	s_mul_f32 s7, s58, 0x3fb8aa3b
	v_dual_mov_b32 v10, v24 :: v_dual_add_nc_u32 v73, 0, v43
	v_dual_mov_b32 v15, v24 :: v_dual_add_nc_u32 v74, 0, v44
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[43:44], null, s57, 3, v[42:43]
	v_xor_b32_e32 v66, 8, v58
	v_xor_b32_e32 v50, 16, v61
	v_xor_b32_e32 v52, 24, v61
	v_xor_b32_e32 v51, 16, v65
	v_xor_b32_e32 v53, 32, v65
	v_xor_b32_e32 v78, 48, v65
	v_xor_b32_e32 v79, 0x420, v65
	v_xor_b32_e32 v80, 0x430, v65
	v_xor_b32_e32 v81, 0x410, v65
	v_dual_mov_b32 v23, v24 :: v_dual_add_nc_u32 v66, 0, v66
	v_dual_mov_b32 v8, v24 :: v_dual_add_nc_u32 v71, 0, v52
	v_dual_mov_b32 v11, v24 :: v_dual_add_nc_u32 v70, 0, v50
	v_dual_mov_b32 v14, v24 :: v_dual_add_nc_u32 v77, 0, v53
	v_dual_mov_b32 v0, v24 :: v_dual_add_nc_u32 v79, 0, v79
	v_dual_mov_b32 v1, v24 :: v_dual_add_nc_u32 v76, 0, v51
	v_dual_mov_b32 v2, v24 :: v_dual_add_nc_u32 v81, 0, v81
	v_dual_mov_b32 v3, v24 :: v_dual_add_nc_u32 v78, 0, v78
	v_dual_mov_b32 v5, v24 :: v_dual_add_nc_u32 v80, 0, v80
	v_xor_b32_e32 v67, 64, v62
	s_mov_b32 s44, 0
	.loc	1 870 25                        ; attention.py:870:25
	s_mul_i32 s6, s5, s6
	...
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v39, v60, v32
	ds_bpermute_b32 v32, v63, v32
	ds_bpermute_b32 v48, v60, v33
	ds_bpermute_b32 v33, v63, v33
	ds_bpermute_b32 v49, v60, v34
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_or_b32 s3, s74, s72
	v_or_b32_e32 v90, 2, v59
	v_mad_u64_u32 v[105:106], null, s3, s56, v[40:41]
	v_or_b32_e32 v91, 4, v59
	v_or_b32_e32 v92, 6, v59
	v_or_b32_e32 v93, 8, v59
	v_add_nc_u32_e32 v107, 8, v41
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v108, s57, v42
	v_lshl_add_u32 v109, s57, 1, v42
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s5, s52, s74
	.loc	1 889 30                        ; attention.py:889:30
	s_mul_i32 s3, s3, s57
	v_or_b32_e32 v94, 10, v59
	v_or_b32_e32 v95, 12, v59
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v126, s74, v90, 1
	v_add_lshl_u32 v127, s74, v91, 1
	v_add_lshl_u32 v128, s74, v92, 1
	v_add_lshl_u32 v129, s74, v93, 1
	...
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v130, s74, v94, 1
	v_add_lshl_u32 v131, s74, v95, 1
	.loc	1 879 36                        ; attention.py:879:36
	...
	v_dual_mov_b32 v32, s44 :: v_dual_add_nc_u32 v87, 0, v61
	.loc	1 890 30                        ; attention.py:890:30
	...
	v_or_b32_e32 v96, 14, v59
	v_or_b32_e32 v97, 16, v59
	v_or_b32_e32 v98, 18, v59
	v_or_b32_e32 v99, 20, v59
	v_or_b32_e32 v100, 22, v59
	v_or_b32_e32 v101, 24, v59
	v_or_b32_e32 v102, 26, v59
	v_or_b32_e32 v103, 28, v59
	v_or_b32_e32 v104, 30, v59
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v106, s5, v41, 1
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v132, s74, v96, 1
	v_add_lshl_u32 v133, s74, v97, 1
	v_add_lshl_u32 v134, s74, v98, 1
	v_add_lshl_u32 v135, s74, v99, 1
	v_add_lshl_u32 v136, s74, v100, 1
	v_add_lshl_u32 v137, s74, v101, 1
	v_add_lshl_u32 v138, s74, v102, 1
	v_add_lshl_u32 v139, s74, v103, 1
	v_add_lshl_u32 v140, s74, v104, 1
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e32 v141, 0x80000000, v106, vcc_lo
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v89, s74, v59, 1
	...
	.loc	1 823 32                        ; attention.py:823:32
	ds_load_2addr_stride64_b64 v[122:125], v70 offset1:1
	...
	.loc	1 823 32                        ; attention.py:823:32
	ds_load_2addr_stride64_b64 v[114:117], v71 offset1:1
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v73, v[37:38], v[33:34] offset1:8
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v74, v[32:33], v[34:35] offset1:8
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v75, v[34:35], v[109:110] offset1:8
	.loc	1 879 36                        ; attention.py:879:36
	v_and_b32_e32 v34, 0xffff0000, v93
	.loc	1 880 35                        ; attention.py:880:35
	v_perm_b32 v109, v91, v90, v72
	...
	ds_bpermute_b32 v136, v60, v136
	ds_bpermute_b32 v137, v63, v137
	.loc	1 881 25                        ; attention.py:881:25
	...
	ds_bpermute_b32 v110, v60, v110
	ds_bpermute_b32 v135, v63, v135
	.loc	1 881 25                        ; attention.py:881:25
	...
	.loc	1 880 35                        ; attention.py:880:35
	ds_bpermute_b32 v133, v60, v133
	ds_bpermute_b32 v134, v63, v134
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[107:110], v76 offset:2048
	.loc	1 880 25                        ; attention.py:880:25
	...
	ds_bpermute_b32 v35, v60, v102
	ds_bpermute_b32 v101, v63, v101
	v_perm_b32 v102, v34, v139, v83
	v_perm_b32 v34, v34, v139, v84
	ds_bpermute_b32 v102, v60, v102
	ds_bpermute_b32 v34, v63, v34
	s_waitcnt lgkmcnt(2)
...
.Ltmp6:
	...
	v_permlanex16_b32 v99, v34, s73, 0xfedcba98 op_sel:[1,0]
.Ltmp7:
	.loc	1 884 24                        ; attention.py:884:24
	...
	v_permlanex16_b32 v86, v36, s73, 0xfedcba98 op_sel:[1,0]
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v100, v37, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v25, v25, v36
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v101, v38, s73, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v102, v99, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	...
	ds_bpermute_b32 v86, v62, v86
	ds_bpermute_b32 v99, v67, v99
	ds_bpermute_b32 v100, v67, v100
	...
	ds_bpermute_b32 v103, v62, v103
	ds_bpermute_b32 v104, v67, v104
	ds_bpermute_b32 v107, v62, v107
	ds_bpermute_b32 v108, v67, v108
	ds_bpermute_b32 v105, v62, v105
...
.Ltmp19:
	...
	.loc	1 886 62 is_stmt 0              ; attention.py:886:62
	v_dual_sub_f32 v129, v134, v34 :: v_dual_mov_b32 v136, v68
	.loc	1 886 49                        ; attention.py:886:49
	v_exp_f32_e32 v123, v123
	.loc	1 882 26 is_stmt 1              ; attention.py:882:26
	ds_bpermute_b32 v104, v62, v104
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp27:
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v68.h, 0x7fff, v105.h, s24
	v_and_b32_e32 v106, 1, v106
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_add3_u32 v35, v35, v106, 0x7fff
	v_mov_b16_e32 v106.h, v32.l
	v_mov_b16_e32 v106.l, v125.h
	v_cndmask_b16 v68.l, 0x7fff, v35.h, s22
...
.Ltmp43:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v37, v68, s73, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v94, v39, s73, 0xfedcba98 op_sel:[1,0]
.Ltmp44:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp45:
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[127:130], v77 offset:2048
	ds_load_b128 v[107:110], v78
	ds_load_b128 v[131:134], v78 offset:2048
	ds_load_b128 v[123:126], v81
	ds_load_b128 v[99:102], v81 offset:2048
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v35, v36, s73, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v89, v37, v68, v52
.Ltmp46:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp47:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v137, v38, s73, 0xfedcba98 op_sel:[1,0]
...
.Ltmp55:
	...
	.loc	1 818 13                        ; attention.py:818:13
	s_add_i32 s3, s74, 32
	s_cmpk_lt_u32 s74, 0x1e0
	s_mov_b32 s74, s3
	.loc	1 897 23                        ; attention.py:897:23
	v_fmac_f32_e32 v68, v136, v34
	.loc	1 818 13                        ; attention.py:818:13
	s_cbranch_scc1 .LBB0_1
; %bb.2:
	ds_bpermute_b32 v38, v60, v68
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.num_vgpr, 145
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.numbered_sgpr, 75
