...
; %bb.1:                                ; %.lr.ph
	...
	v_mad_u64_u32 v[4:5], null, s15, v37, s[14:15]
	...
	v_dual_mov_b32 v7, s18 :: v_dual_lshlrev_b32 v38, 1, v31
	v_dual_mov_b32 v4, s15 :: v_dual_lshlrev_b32 v39, 1, v30
	v_mov_b32_e32 v12, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v78, v78, v87 :: v_dual_add_nc_u32 v95, s12, v40
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x1
	buffer_load_u16 v83, v97, s[36:39], 0 offen offset:24
	buffer_load_u16 v84, v97, s[36:39], 0 offen offset:28
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v75, v75, v87 :: v_dual_add_nc_u32 v96, s12, v41
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
...
.LBB0_8:
	...
	s_mov_b32 s23, s11
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v45, v18, s[8:11], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v18, 0x80000000, v32, s2
	v_add_nc_u32_e32 v32, 12, v16
	buffer_load_u16 v46, v19, s[20:23], 0 offen
	v_cndmask_b32_e64 v19, 0x80000000, v33, s2
	v_add_nc_u32_e32 v33, 16, v16
	v_add_nc_u32_e32 v47, 20, v16
	...
	buffer_load_u16 v50, v19, s[20:23], 0 offen
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v53, v17, s[8:11], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v6, v6, v11 :: v_dual_lshlrev_b32 v45, 16, v49
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v35, v36, v51 :: v_dual_lshlrev_b32 v46, 16, v50
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_add3_u32 v16, s34, s33, v18
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v36, v37, v51 :: v_dual_lshlrev_b32 v33, 16, v33
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v39, v40, v51 :: v_dual_lshlrev_b32 v48, 16, v48
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v50, 16, v52
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v40, v41, v51
	v_mul_f32_e32 v41, v42, v51
	v_mul_f32_e32 v42, v43, v51
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_ashrrev_i32_e32 v18, 31, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v3, v3, v2, v12
	v_fma_f32 v35, v35, v2, v24
	v_fma_f32 v4, v4, v45, v31
	v_fma_f32 v5, v5, v46, v30
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_lshlrev_b64 v[18:19], 2, v[17:18]
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v36, v36, v45, v23
	v_fma_f32 v7, v7, v33, v28
	...
	v_cndmask_b32_e64 v33, v25, v51, s2
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk4_evenk.numbered_sgpr, 42
