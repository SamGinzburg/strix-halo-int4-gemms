...
.Ltmp19:
	...
	v_lshl_add_u32 v12, s7, 6, v10
	v_lshl_add_u32 v14, s7, 7, v10
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_add_nc_u32_e32 v35, s5, v12
	v_add_nc_u32_e32 v36, s5, v14
...
; %bb.4:                                ; %.lr.ph
	v_lshl_or_b32 v53, v3, 6, v4
	v_dual_mov_b32 v20, 0 :: v_dual_lshlrev_b32 v3, 2, v19
	s_mov_b32 s17, s16
	s_mov_b32 s18, s16
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v64, s34, v13
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_lshr_b32 s19, s19, 25
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v66, s34, v15
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_add_i32 s18, s18, s19
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	s_add_i32 s20, s34, s43
	.loc	1 343 23                        ; generate_amdgcn.py:343:23
	...
	buffer_load_u16 v170, v64, s[28:31], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	buffer_load_u16 v171, v70, s[36:39], 0 offen
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v172, v66, s[28:31], 0 offen
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v69, s19, v58
	v_add_nc_u32_e32 v70, s19, v60
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	v_dual_mul_f32 v142, v76, v128 :: v_dual_add_nc_u32 v173, s19, v61
	...
	v_dual_mul_f32 v66, v66, v129 :: v_dual_fmac_f32 v27, v137, v119
	v_dual_mul_f32 v68, v68, v129 :: v_dual_fmac_f32 v31, v141, v123
	v_mul_f32_e32 v69, v69, v129
	v_dual_mul_f32 v70, v70, v129 :: v_dual_fmac_f32 v37, v128, v127
	v_dual_mul_f32 v72, v72, v129 :: v_dual_fmac_f32 v39, v67, v83
	v_mul_f32_e32 v73, v73, v129
	v_dual_mul_f32 v74, v74, v129 :: v_dual_fmac_f32 v43, v71, v87
	...
	v_dual_fmac_f32 v21, v131, v113 :: v_dual_fmac_f32 v22, v132, v114
	v_dual_fmac_f32 v25, v135, v117 :: v_dual_fmac_f32 v24, v134, v116
	v_dual_fmac_f32 v29, v139, v121 :: v_dual_fmac_f32 v26, v136, v118
	v_dual_fmac_f32 v33, v143, v125 :: v_dual_fmac_f32 v28, v138, v120
	v_dual_fmac_f32 v35, v65, v81 :: v_dual_fmac_f32 v30, v140, v122
	v_dual_fmac_f32 v41, v69, v85 :: v_dual_fmac_f32 v32, v142, v124
	v_fmac_f32_e32 v36, v144, v126
	v_dual_fmac_f32 v34, v64, v80 :: v_dual_fmac_f32 v51, v78, v94
	v_fmac_f32_e32 v40, v68, v84
	v_fmac_f32_e32 v42, v70, v86
	v_dual_fmac_f32 v46, v73, v89 :: v_dual_fmac_f32 v47, v74, v90
...
; %bb.10:
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v59, s22 :: v_dual_mov_b32 v58, s21
	v_dual_mov_b32 v57, s20 :: v_dual_mov_b32 v56, s19
	v_dual_mov_b32 v55, s18 :: v_dual_mov_b32 v54, s17
