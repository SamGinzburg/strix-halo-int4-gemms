	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	v_dual_mul_f32 v132, v23, v65 :: v_dual_mul_f32 v51, v92, v51
	v_mul_f32_e32 v65, v24, v65
	v_mul_f32_e32 v133, v21, v69
	v_dual_mul_f32 v134, v22, v69 :: v_dual_mul_f32 v55, v96, v55
	v_dual_mul_f32 v135, v23, v69 :: v_dual_mul_f32 v50, v72, v50
	v_dual_mul_f32 v69, v24, v69 :: v_dual_mul_f32 v52, v93, v52
	v_mul_f32_e32 v23, v23, v70
	v_dual_mul_f32 v24, v24, v70 :: v_dual_mul_f32 v49, v71, v49
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v56, v97, v56 :: v_dual_mul_f32 v37, v130, v37
	...
	v_dual_mul_f32 v18, v18, v70 :: v_dual_mul_f32 v47, v104, v47
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v48, v105, v48 :: v_dual_mul_f32 v35, v120, v35
	v_mul_f32_e32 v36, v121, v36
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_bfe_u32 v105, v27, 16, 1
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v12, v12, v70
	v_dual_mul_f32 v20, v20, v70 :: v_dual_mul_f32 v41, v98, v41
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v42, v99, v42 :: v_dual_mul_f32 v45, v102, v45
	v_dual_mul_f32 v46, v103, v46 :: v_dual_mul_f32 v29, v110, v29
	...
	v_cndmask_b16 v24.l, 0x7fff, v49.h, s1
	...
	v_dual_mul_f32 v43, v100, v43 :: v_dual_add_nc_u32 v6, 0x100, v2
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v53, v94, v53 :: v_dual_mul_f32 v54, v95, v54
	...
	v_bfe_u32 v89, v43, 16, 1
	v_bfe_u32 v90, v44, 16, 1
	...
	v_add3_u32 v50, v52, v67, 0x7fff
	v_add3_u32 v52, v54, v76, 0x7fff
	v_add3_u32 v53, v55, v77, 0x7fff
	v_add3_u32 v54, v56, v78, 0x7fff
	v_add3_u32 v55, v57, v79, 0x7fff
	v_add3_u32 v56, v58, v80, 0x7fff
	...
	v_add3_u32 v41, v41, v87, 0x7fff
	v_add3_u32 v42, v42, v88, 0x7fff
	v_add3_u32 v43, v43, v89, 0x7fff
	v_add3_u32 v44, v44, v90, 0x7fff
	v_add3_u32 v45, v45, v91, 0x7fff
	v_add3_u32 v46, v46, v92, 0x7fff
	v_add3_u32 v47, v47, v93, 0x7fff
	v_add3_u32 v48, v48, v94, 0x7fff
	...
	v_cndmask_b16 v24.h, 0x7fff, v50.h, s2
	v_cndmask_b16 v49.h, 0x7fff, v52.h, s4
	v_cndmask_b16 v50.l, 0x7fff, v53.h, s5
	v_cndmask_b16 v50.h, 0x7fff, v54.h, s6
	v_cndmask_b16 v51.l, 0x7fff, v55.h, s7
	v_cndmask_b16 v51.h, 0x7fff, v56.h, s8
	v_cndmask_b16 v52.l, 0x7fff, v57.h, s9
	v_cndmask_b16 v52.h, 0x7fff, v58.h, s10
	v_cndmask_b16 v53.l, 0x7fff, v59.h, s11
	v_cndmask_b16 v53.h, 0x7fff, v60.h, s12
	v_cndmask_b16 v54.l, 0x7fff, v61.h, s13
	v_cndmask_b16 v54.h, 0x7fff, v62.h, s14
	v_cndmask_b16 v41.l, 0x7fff, v41.h, s15
	v_cndmask_b16 v41.h, 0x7fff, v42.h, s16
	v_cndmask_b16 v42.l, 0x7fff, v43.h, s17
	v_cndmask_b16 v42.h, 0x7fff, v44.h, s18
	v_cndmask_b16 v43.l, 0x7fff, v45.h, s19
	v_cndmask_b16 v43.h, 0x7fff, v46.h, s20
	v_cndmask_b16 v44.l, 0x7fff, v47.h, s21
	v_cndmask_b16 v44.h, 0x7fff, v48.h, s22
	...
	v_cndmask_b32_e64 v8, v49, v23, s3
	v_cndmask_b32_e64 v15, v23, v49, s3
	v_cndmask_b32_e64 v17, v24, v50, s3
	v_cndmask_b32_e64 v19, v51, v53, s3
	v_cndmask_b32_e64 v21, v52, v54, s3
	v_cndmask_b32_e64 v23, v41, v43, s3
	v_cndmask_b32_e64 v37, v42, v44, s3
	v_cndmask_b32_e64 v40, v0, v13, s3
	v_cndmask_b32_e64 v0, v13, v0, s3
	v_lshl_or_b32 v11, v11, 4, v11
	v_lshl_or_b32 v12, v12, 4, v12
	s_mov_b32 s0, 0x76543210
	v_cndmask_b32_e64 v16, v50, v24, s3
	v_cndmask_b32_e64 v18, v53, v51, s3
	v_cndmask_b32_e64 v20, v54, v52, s3
	v_cndmask_b32_e64 v22, v43, v41, s3
	v_cndmask_b32_e64 v24, v44, v42, s3
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 136
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.kd
