...
.Ltmp25:
	...
	v_mul_lo_u32 v4, s14, v207
	v_dual_mov_b32 v161, 0 :: v_dual_lshlrev_b32 v2, 1, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v166, 0 :: v_dual_lshlrev_b32 v5, 4, v1
	v_or_b32_e32 v12, s25, v1
	v_lshl_or_b32 v7, v1, 9, v208
	v_add_nc_u32_e32 v215, 0, v2
	v_mov_b32_e32 v197, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_add3_u32 v201, v6, v5, s2
	s_mov_b32 s2, s0
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_lshlrev_b32_e32 v3, 3, v203
	v_and_b32_e32 v9, 0x60, v206
	v_and_b32_e32 v10, 0xe00, v204
	v_mov_b32_e32 v178, 0
	v_or_b32_e32 v14, 32, v12
	v_add3_u32 v209, v4, v3, s25
	v_bfe_i32 v3, v0, 2, 1
	v_bfe_i32 v4, v0, 3, 1
	v_mul_lo_u32 v211, v12, s28
	v_mul_lo_u32 v213, v14, s28
	v_and_b32_e32 v14, 2, v15
	v_and_b32_e32 v3, 0x90, v3
	v_and_b32_e32 v4, 0x110, v4
	v_lshlrev_b32_e32 v8, 3, v0
	v_add_nc_u32_e32 v210, 0, v1
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v14, 0, v14
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v3, v3, v4
	v_mov_b32_e32 v165, 0
	v_xor_b32_e32 v4, 0x90, v7
	v_or_b32_e32 v1, 0x3f0, v0
	v_xor_b32_e32 v11, 0x110, v7
	v_or3_b32 v3, v9, v10, v3
	v_or_b32_e32 v10, 16, v12
	v_or_b32_e32 v9, 0x7f0, v0
	v_dual_mov_b32 v198, 0 :: v_dual_and_b32 v15, 28, v205
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v13, 16, v3
	v_mul_lo_u32 v212, v10, s28
	v_or_b32_e32 v10, 48, v12
	v_dual_mov_b32 v193, 0 :: v_dual_lshlrev_b32 v12, 2, v0
	v_mov_b32_e32 v157, 0
	v_dual_mov_b32 v162, 0 :: v_dual_add_nc_u32 v217, 0, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_lo_u32 v214, v10, s28
	v_and_b32_e32 v10, 0x1c0, v12
	v_and_b32_e32 v12, 32, v206
	v_dual_mov_b32 v153, 0 :: v_dual_add_nc_u32 v218, 0, v7
	v_dual_mov_b32 v194, 0 :: v_dual_add_nc_u32 v219, 0, v4
	s_delay_alu instid0(VALU_DEP_3)
	v_add3_u32 v10, v14, v10, v12
	v_add3_u32 v12, v215, v2, v12
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v221, 0, v1
	v_dual_mov_b32 v190, 0 :: v_dual_add_nc_u32 v223, 0, v3
	v_mov_b32_e32 v8, s7
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_lshl_add_u32 v216, s14, 5, v209
	v_dual_mov_b32 v185, 0 :: v_dual_add_nc_u32 v220, 0, v11
	v_dual_mov_b32 v149, 0 :: v_dual_add_nc_u32 v222, 0, v9
	v_dual_mov_b32 v181, 0 :: v_dual_add_nc_u32 v224, 0, v13
	...
	v_mov_b32_e32 v1, s0
	v_dual_mov_b32 v154, 0 :: v_dual_add_nc_u32 v225, v10, v15
	v_dual_mov_b32 v145, 0 :: v_dual_add_nc_u32 v226, v12, v15
	...
	v_dual_mov_b32 v142, 0 :: v_dual_mov_b32 v167, 0
	v_dual_mov_b32 v170, 0 :: v_dual_mov_b32 v199, 0
	v_dual_mov_b32 v138, 0 :: v_dual_mov_b32 v163, 0
	v_dual_mov_b32 v195, 0 :: v_dual_mov_b32 v180, 0
	...
	v_dual_mov_b32 v187, 0 :: v_dual_mov_b32 v196, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s2, s2, s26
	v_mad_u64_u32 v[17:18], null, s2, s15, v[201:202]
	v_or_b32_e32 v9, s2, v208
	s_or_b32 s1, s2, 32
	...
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt vmcnt(0)
	ds_store_b64 v217, v[9:10] offset:16384
	.loc	1 368 21                        ; generate_amdgcn.py:368:21
	v_or_b32_e32 v9, s1, v207
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	...
	ds_store_b16_d16_hi v218, v9 offset:32
	ds_store_b16 v218, v10 offset:64
	ds_store_b16_d16_hi v218, v10 offset:96
	ds_store_b16 v219, v11
	ds_store_b16_d16_hi v219, v11 offset:32
	ds_store_b16 v219, v12 offset:64
	ds_store_b16_d16_hi v219, v12 offset:96
	ds_store_b16 v220, v13
	ds_store_b16_d16_hi v220, v13 offset:32
	ds_store_b16 v220, v14 offset:64
	v_add_nc_u32_e32 v9, s3, v216
	...
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_store_b16_d16_hi v220, v14 offset:96
	v_lshlrev_b16 v15.l, 8, v15.l
	...
	ds_store_b16 v218, v15 offset:384
	v_lshlrev_b16 v16.l, 8, v16.l
	s_delay_alu instid0(VALU_DEP_1)
	v_or_b16 v16.l, v16.h, v16.l
	v_and_b16 v16.h, 0xff, v25.h
	ds_store_b16_d16_hi v218, v15 offset:416
	v_lshrrev_b32_e32 v15, 24, v27
	v_or_b16 v16.h, v16.h, v17.l
	ds_store_b16 v218, v16 offset:448
	v_lshrrev_b32_e32 v17, 24, v33
	ds_store_b16_d16_hi v218, v16 offset:480
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	...
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt vmcnt(0)
	ds_store_b64 v217, v[11:12] offset:18432
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_or_b16 v16.h, v16.h, v17.l
	ds_store_b16 v218, v9 offset:8192
	ds_store_b16_d16_hi v218, v9 offset:8224
	ds_store_b16 v218, v10 offset:8256
	ds_store_b16_d16_hi v218, v10 offset:8288
	ds_store_b16 v219, v11 offset:8192
	ds_store_b16_d16_hi v219, v11 offset:8224
	ds_store_b16 v219, v12 offset:8256
	ds_store_b16_d16_hi v219, v12 offset:8288
	ds_store_b16 v220, v13 offset:8192
	ds_store_b16_d16_hi v220, v13 offset:8224
	ds_store_b16 v220, v14 offset:8256
	ds_store_b16_d16_hi v220, v14 offset:8288
	ds_store_b16 v218, v15 offset:8576
	ds_store_b16_d16_hi v218, v15 offset:8608
	ds_store_b16 v218, v16 offset:8640
	ds_store_b16_d16_hi v218, v16 offset:8672
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[41:44], v223
	ds_load_b128 v[45:48], v224
	ds_load_b128 v[49:52], v223 offset:4096
	ds_load_b128 v[53:56], v224 offset:4096
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	ds_load_u8 v14, v210 offset:18368
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v13, v16, v15, 0xc0c0004
	v_lshl_or_b32 v12, v10, 16, v9
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v10, v18, v17, 0xc0c0004
	ds_load_u8 v16, v210 offset:18304
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v15, v20, v19, 0xc0c0004
	v_lshl_or_b32 v11, v13, 16, v11
	ds_load_u8 v9, v210 offset:18240
	ds_load_u8 v13, v210 offset:18176
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v18, v22, v21, 0xc0c0004
	ds_load_u8 v19, v210 offset:18112
	ds_load_u8 v21, v210 offset:18048
	v_lshl_or_b32 v10, v15, 16, v10
	ds_load_u8 v15, v210 offset:17984
	ds_load_u8 v17, v210 offset:17920
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v13, v13, v9, 0xc0c0004
	ds_load_u8 v9, v210 offset:17728
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v15, v17, v15, 0xc0c0004
	ds_load_u8 v17, v210 offset:17856
	v_perm_b32 v19, v21, v19, 0xc0c0004
	ds_load_u8 v21, v210 offset:17792
	v_perm_b32 v14, v16, v14, 0xc0c0004
	ds_load_u8 v16, v210 offset:17664
	v_lshl_or_b32 v15, v19, 16, v15
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v22, v16, v9, 0xc0c0004
	ds_load_u8 v9, v210 offset:17472
	ds_load_u8 v16, v210 offset:17408
	ds_load_u8 v24, v210 offset:16512
	v_perm_b32 v17, v21, v17, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v21, v16, v9, 0xc0c0004
	ds_load_u8 v9, v210 offset:17600
	ds_load_u8 v16, v210 offset:17536
	s_waitcnt lgkmcnt(2)
	...
	v_cvt_f32_i32_e32 v237, v121
	v_cvt_f32_i32_e32 v235, v122
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(0)
	ds_store_b16 v225, v41 offset:20480
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	...
	s_clause 0x3
	buffer_load_u16 v241, v41, s[4:7], 0 offen
	buffer_load_u16 v240, v42, s[4:7], 0 offen
	buffer_load_u16 v239, v43, s[4:7], 0 offen
	buffer_load_u16 v238, v44, s[4:7], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[97:100], v223 offset:8192
	ds_load_b128 v[101:104], v224 offset:8192
	ds_load_b128 v[227:230], v223 offset:12288
	ds_load_b128 v[231:234], v224 offset:12288
	.loc	1 387 34                        ; generate_amdgcn.py:387:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s0, s0, 1
	...
	v_wmma_i32_16x16x16_iu8 v[49:56], v[227:230], v[57:60], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[49:56], v[231:234], v[61:64], v[49:56] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[65:72], v[227:230], v[73:76], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[65:72], v[231:234], v[77:80], v[65:72] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[81:88], v[227:230], v[89:92], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[81:88], v[231:234], v[93:96], v[81:88] neg_lo:[1,1,0]
	...
	v_perm_b32 v90, v91, v90, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v249, v90, 16, v89
	v_wmma_i32_16x16x16_iu8 v[89:96], v[97:100], v[242:245], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[89:96], v[101:104], v[246:249], v[89:96] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[97:104], v[227:230], v[242:245], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v230, v107
	v_cvt_f32_i32_e32 v229, v116
	v_cvt_f32_i32_e32 v116, v117
	s_delay_alu instid0(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[97:104], v[231:234], v[246:249], v[97:104] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v234, v105
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	ds_load_b128 v[41:44], v215 offset:20480
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v227, v109
	...
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v102, 16, v241
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v228, v108
	...
	v_cvt_f32_i32_e32 v244, v12
	v_cvt_f32_i32_e32 v10, v16
	v_cvt_f32_i32_e32 v245, v9
	...
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v45, v132, v102 :: v_dual_lshlrev_b32 v104, 16, v239
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_lshlrev_b32_e32 v103, 16, v240
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt lgkmcnt(0)
	v_lshlrev_b32_e32 v46, 16, v41
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v132, 16, v238
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v232, v106
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v180, v45, v46 :: v_dual_mul_f32 v45, v102, v128
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v168, v39, v46 :: v_dual_mul_f32 v39, v102, v127
	v_dual_fmac_f32 v199, v38, v45 :: v_dual_mul_f32 v38, v132, v243
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v46, v202, s2, 1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v20, v104, v20 :: v_dual_fmac_f32 v197, v39, v45
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v200, v38, v45 :: v_dual_lshlrev_b32 v39, 16, v44
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v38, v102, v126
	.loc	1 388 22 is_stmt 1              ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v45, v214, s1, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	v_dual_cndmask_b32 v45, 0x80000000, v45 :: v_dual_mul_f32 v10, v132, v10
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v163, v33, v39
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v33, v132, v244 :: v_dual_cndmask_b32 v38, 0x80000000, v38
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	ds_load_b128 v[45:48], v215 offset:20496
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_store_b32 v226, v57 offset:20480
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[57:60], v215 offset:20480
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(1)
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v163, v73, v60
	.loc	1 388 22 is_stmt 1              ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v73, 16, v126
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v74, v89, v73 :: v_dual_fmac_f32 v161, v82, v60
	v_mul_f32_e32 v82, v101, v38
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v180, v74, v57
	v_dual_fmac_f32 v178, v82, v57 :: v_dual_mul_f32 v57, v73, v90
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v57, v73, v91 :: v_dual_fmac_f32 v166, v82, v58
	v_mul_f32_e32 v82, v38, v99
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v200, v57, v59
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v57, v73, v92 :: v_dual_fmac_f32 v198, v82, v59
	...
	v_dual_mul_f32 v13, v33, v13 :: v_dual_fmac_f32 v162, v82, v60
	...
	v_mul_f32_e32 v28, v102, v234
	v_dual_mul_f32 v35, v39, v54 :: v_dual_fmac_f32 v158, v21, v29
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	v_lshlrev_b32_e32 v21, 16, v47
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v29, v38, v40 :: v_dual_fmac_f32 v192, v11, v21
	...
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v10, v33, v85 :: v_dual_mul_f32 v11, v102, v34
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	v_mul_f32_e32 v28, v103, v236
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v186, v28, v10
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v28, v104, v237
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v10, v102, v232
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v149, v10, v11 :: v_dual_mul_f32 v10, v103, v233
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v150, v10, v11 :: v_dual_and_b32 v19, 0xffff0000, v44
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v10, v104, v235
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v151, v10, v11 :: v_dual_mul_f32 v10, v132, v124
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v152, v10, v11 :: v_dual_and_b32 v27, 0xffff0000, v48
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v10, v102, v230 :: v_dual_mul_f32 v11, v103, v107
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v181, v10, v18 :: v_dual_mul_f32 v10, v103, v231
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v10, v102, v228
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v18, v104, v110 :: v_dual_fmac_f32 v145, v10, v19
	v_dual_mul_f32 v10, v103, v229 :: v_dual_fmac_f32 v139, v18, v27
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v10, v102, v227 :: v_dual_mul_f32 v19, v132, v113
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v141, v10, v21 :: v_dual_mul_f32 v10, v103, v112
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v137, v10, v27
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_load_b128 v[9:12], v215 offset:20992
	v_dual_mul_f32 v27, v38, v31 :: v_dual_mul_f32 v14, v33, v14
	v_dual_mul_f32 v20, v33, v15 :: v_dual_mul_f32 v31, v39, v50
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v40, v73, v67 :: v_dual_fmac_f32 v187, v31, v9
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v185, v18, v9 :: v_dual_mul_f32 v22, v33, v22
	v_fmac_f32_e32 v145, v14, v12
	v_fmac_f32_e32 v181, v13, v11
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_load_b128 v[13:16], v215 offset:21008
	v_mul_f32_e32 v33, v39, v52
	v_mul_f32_e32 v34, v39, v53
	v_mul_f32_e32 v26, v38, v30
	v_mul_f32_e32 v28, v38, v32
	v_mul_f32_e32 v32, v39, v51
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v183, v33, v11
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v36, v39, v55 :: v_dual_fmac_f32 v147, v34, v12
	v_dual_mul_f32 v44, v73, v71 :: v_dual_fmac_f32 v149, v19, v10
	...
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v184, v41, v11 :: v_dual_fmac_f32 v137, v22, v16
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v30, v38, v49 :: v_dual_fmac_f32 v151, v32, v10
	v_dual_mul_f32 v38, v39, v65 :: v_dual_fmac_f32 v143, v36, v14
	v_mul_f32_e32 v39, v73, v66
	v_mul_f32_e32 v42, v73, v69
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v173, v20, v13
	v_fmac_f32_e32 v141, v21, v14
	v_dual_fmac_f32 v169, v17, v15 :: v_dual_fmac_f32 v150, v24, v10
	v_fmac_f32_e32 v146, v26, v12
	v_fmac_f32_e32 v174, v27, v13
	v_fmac_f32_e32 v142, v28, v14
	v_fmac_f32_e32 v170, v29, v15
	v_dual_fmac_f32 v138, v30, v16 :: v_dual_fmac_f32 v175, v35, v13
	v_fmac_f32_e32 v171, v37, v15
	v_dual_fmac_f32 v139, v38, v16 :: v_dual_fmac_f32 v188, v39, v9
	v_fmac_f32_e32 v148, v42, v12
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.num_vgpr, 250
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 95
