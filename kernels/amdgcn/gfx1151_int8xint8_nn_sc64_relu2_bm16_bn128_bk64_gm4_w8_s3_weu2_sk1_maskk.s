	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v6, s18, v16
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v21, v5, v16, s3
	...
	buffer_load_b128 v[30:33], v6, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(4)
	v_perm_b32 v34, v22, v17, 0x5010400
	v_perm_b32 v22, v22, v17, 0x7030602
	v_perm_b32 v47, v24, v19, 0x5010400
	v_perm_b32 v24, v24, v19, 0x7030602
	v_perm_b32 v48, v25, v20, 0x5010400
	v_perm_b32 v25, v25, v20, 0x7030602
	v_lshrrev_b32_e32 v49, 8, v34
	v_lshrrev_b32_e32 v50, 24, v34
	v_perm_b32 v46, v23, v18, 0x5010400
	v_perm_b32 v23, v23, v18, 0x7030602
	...
	v_or_b16 v18.l, v18.l, v46.l
	v_or_b16 v18.h, v18.h, v46.h
	v_lshrrev_b32_e32 v46, 8, v26
	v_or_b16 v19.l, v19.l, v47.l
	v_or_b16 v19.h, v19.h, v47.h
...
.LBB0_3:                                ; %Flow15
	...
	v_or_b32_e32 v12, s25, v2
	s_ashr_i32 s1, s24, 6
	v_or_b32_e32 v29, s6, v5
	v_or_b32_e32 v28, s6, v11
	v_or_b32_e32 v27, s6, v13
	v_mul_lo_u32 v30, v12, s1
	v_or_b32_e32 v25, s6, v14
	v_or_b32_e32 v23, s6, v15
	v_or_b32_e32 v26, s6, v6
	v_or_b32_e32 v24, s6, v7
	v_or_b32_e32 v22, s6, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s0, s0, s40
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v54, s33, v21
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s41, s33, s7
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s40, s0, 6
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	v_mul_f32_e32 v94, v61, v62
	v_mul_f32_e32 v95, v61, v63
	v_mul_f32_e32 v96, v61, v64
	v_mul_f32_e32 v97, v61, v65
	v_mul_f32_e32 v98, v61, v66
	v_mul_f32_e32 v99, v61, v67
	...
	v_dual_fmac_f32 v17, v97, v71 :: v_dual_add_nc_u32 v110, s40, v38
	v_dual_fmac_f32 v18, v98, v72 :: v_dual_add_nc_u32 v111, s36, v39
	v_dual_fmac_f32 v19, v99, v73 :: v_dual_add_nc_u32 v112, s36, v40
	v_dual_fmac_f32 v20, v76, v74 :: v_dual_add_nc_u32 v113, s36, v41
	v_dual_fmac_f32 v13, v77, v75 :: v_dual_add_nc_u32 v114, s36, v42
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v11, v94, v68 :: v_dual_fmac_f32 v14, v95, v69
	v_fmac_f32_e32 v15, v96, v70
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_8:                                ; %Flow16
	...
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v6, v2, v46
	v_mov_b32_e32 v2, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b32_e32 v51, v6, v47
	v_mov_b32_e32 v6, 0
...
; %bb.9:
	...
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v2, s34, v52
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v6, s34, v51
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v16, s14, v34
	v_add_nc_u32_e32 v21, s14, v31
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v41, v35 :: v_dual_add_nc_u32 v36, s34, v50
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v16, s34, v49
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v38, v35 :: v_dual_add_nc_u32 v21, s14, v33
	v_dual_mov_b32 v40, v35 :: v_dual_add_nc_u32 v37, s14, v32
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[57:60], v36
	ds_load_b128 v[61:64], v16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[65:68], v21
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[35:42], v[6:9], v[53:56], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[35:42], v[2:5], v[43:46], v[35:42] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[35:42], v[61:64], v[69:72], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[35:42], v[57:60], v[65:68], v[35:42] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	v_add_lshl_u32 v41, v22, s0, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v40, v16, s[12:15], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_dual_cndmask_b32 v16, 0x80000000, v21 :: v_dual_cndmask_b32 v21, 0x80000000, v35
	...
	s_clause 0x7
	buffer_load_u16 v41, v16, s[16:19], 0 offen
	buffer_load_u16 v42, v21, s[16:19], 0 offen
...
; %bb.11:
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s36, v52
	v_add_nc_u32_e32 v16, s36, v51
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v21, s35, v34
	v_add_nc_u32_e32 v31, s35, v31
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v34, s36, v50
	ds_load_b128 v[50:53], v1
	ds_load_b128 v[54:57], v16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[58:61], v21
	ds_load_b128 v[62:65], v31
	v_add_nc_u32_e32 v21, s35, v32
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v1, s36, v49
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v37, v32 :: v_dual_add_nc_u32 v16, s35, v33
...
.LBB0_12:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v9, v32, v9, v13
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v15, v11, v15 :: v_dual_lshlrev_b32 v22, 16, v22
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v14, v11, v14 :: v_dual_max_f32 v1, v1, v1
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v13, v14, v16, v2
	v_fma_f32 v14, v15, v21, v3
	v_fma_f32 v16, v18, v36, v6
	v_fma_f32 v18, v20, v38, v8
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v7, v7, v7 :: v_dual_and_b32 v0, 1, v49
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 118
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
