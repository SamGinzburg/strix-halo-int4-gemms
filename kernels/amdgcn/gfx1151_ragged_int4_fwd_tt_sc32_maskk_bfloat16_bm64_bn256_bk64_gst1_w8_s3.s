...
.Ltmp0:
	...
	v_dual_mov_b32 v90, 0 :: v_dual_and_b32 v95, 15, v0
...
.Ltmp2:
	...
	v_dual_mov_b32 v92, 0 :: v_dual_and_b32 v83, 0xf0, v0
	s_xor_b32 s4, s4, s6
	s_mov_b32 s36, 0
	s_sub_i32 s4, s4, s6
	...
	v_dual_mov_b32 v66, 0 :: v_dual_add_nc_u32 v69, 16, v67
	.loc	1 932 25 is_stmt 1              ; ragged.py:932:25
	v_add_nc_u32_e32 v72, 32, v67
	v_add_nc_u32_e32 v73, 48, v67
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 913 39                        ; ragged.py:913:39
	s_mul_i32 s22, s56, s33
	...
	v_mad_u64_u32 v[10:11], null, v4, s56, s[22:23]
	v_or_b32_e32 v17, 0x60, v4
	v_xor_b32_e32 v30, v12, v13
	v_mad_u64_u32 v[11:12], null, s56, v5, s[22:23]
	v_or_b32_e32 v18, 0x70, v4
	v_mad_u64_u32 v[12:13], null, s56, v6, s[22:23]
	v_or_b32_e32 v19, 0x80, v4
	v_mad_u64_u32 v[13:14], null, s56, v7, s[22:23]
	v_or_b32_e32 v20, 0x90, v4
	v_mad_u64_u32 v[14:15], null, s56, v8, s[22:23]
	v_or_b32_e32 v21, 0xa0, v4
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s8, s33, v16
	v_mad_u64_u32 v[15:16], null, s56, v16, s[22:23]
	.loc	1 850 18                        ; ragged.py:850:18
	v_or_b32_e32 v22, 0xb0, v4
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s9, s33, v17
	v_mad_u64_u32 v[16:17], null, s56, v17, s[22:23]
	.loc	1 851 21                        ; ragged.py:851:21
	...
	v_mad_u64_u32 v[17:18], null, s56, v18, s[22:23]
	.loc	1 850 18                        ; ragged.py:850:18
	v_or_b32_e32 v2, 0xd0, v4
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s11, s33, v19
	v_mad_u64_u32 v[18:19], null, s56, v19, s[22:23]
	.loc	1 850 18                        ; ragged.py:850:18
	v_or_b32_e32 v25, 0xe0, v4
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s12, s33, v20
	v_mad_u64_u32 v[19:20], null, s56, v20, s[22:23]
	.loc	1 850 18                        ; ragged.py:850:18
	v_or_b32_e32 v26, 0xf0, v4
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s13, s33, v21
	v_mad_u64_u32 v[20:21], null, s56, v21, s[22:23]
	v_cmp_gt_i32_e64 s14, s33, v22
	v_mad_u64_u32 v[21:22], null, s56, v22, s[22:23]
	v_or_b32_e32 v28, 0x300, v0
	v_mad_u64_u32 v[22:23], null, s56, v1, s[22:23]
	.loc	1 850 18                        ; ragged.py:850:18
	v_or_b32_e32 v96, s35, v0
	v_or_b32_e32 v29, 0x3f0, v0
	v_xor_b32_e32 v31, 8, v27
	v_dual_mov_b32 v81, 0 :: v_dual_lshlrev_b32 v34, 1, v83
	v_mad_u64_u32 v[23:24], null, s56, v2, s[22:23]
	.loc	1 852 20                        ; ragged.py:852:20
	v_cmp_gt_i32_e64 s17, s33, v25
	v_mad_u64_u32 v[24:25], null, s56, v25, s[22:23]
	v_cmp_gt_i32_e64 s18, s33, v26
	v_mad_u64_u32 v[25:26], null, s56, v26, s[22:23]
	...
	v_dual_mov_b32 v80, 0 :: v_dual_add_nc_u32 v9, s20, v3
	v_dual_mov_b32 v78, 0 :: v_dual_add_nc_u32 v99, 0, v28
	v_dual_mov_b32 v28, 0 :: v_dual_mov_b32 v1, s36
	...
	v_dual_mov_b32 v71, 0 :: v_dual_add_nc_u32 v104, 0, v31
	v_dual_mov_b32 v70, 0 :: v_dual_add_nc_u32 v105, v33, v32
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v106, 0, v34
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s20, s60, 4
	.loc	1 901 19                        ; ragged.py:901:19
	v_or_b32_e32 v107, 12, v97
	v_or_b32_e32 v110, s20, v95
	v_or_b32_e32 v109, s20, v97
	.loc	1 917 34                        ; ragged.py:917:34
	s_mov_b32 s50, s30
	s_mov_b32 s51, s31
	v_or_b32_e32 v111, s20, v107
	v_cmp_gt_i32_e64 s21, s56, v110
	v_mad_u64_u32 v[107:108], null, v109, s57, v[9:10]
	v_or_b32_e32 v108, 4, v109
	v_add_nc_u32_e32 v112, v10, v110
	v_cmp_gt_i32_e64 s20, s56, v109
	v_or_b32_e32 v109, 8, v109
	v_add_nc_u32_e32 v113, v11, v110
	s_and_b32 s25, s0, s21
	v_add_nc_u32_e32 v114, v12, v110
	v_mad_u64_u32 v[123:124], null, v111, s57, v[9:10]
	v_cmp_gt_i32_e64 s23, s56, v108
	v_mad_u64_u32 v[124:125], null, v108, s57, v[9:10]
	v_cndmask_b32_e64 v108, 0x80000000, v112, s25
	s_and_b32 s25, s1, s21
	v_add_nc_u32_e32 v115, v13, v110
	v_cmp_gt_i32_e64 s24, s56, v109
	v_mad_u64_u32 v[125:126], null, v109, s57, v[9:10]
	v_cndmask_b32_e64 v109, 0x80000000, v113, s25
	s_and_b32 s25, s5, s21
	v_add_nc_u32_e32 v116, v14, v110
	v_cmp_gt_i32_e64 s22, s56, v111
	v_cndmask_b32_e64 v111, 0x80000000, v114, s25
	s_and_b32 s25, s6, s21
	v_add_nc_u32_e32 v117, v15, v110
	v_cndmask_b32_e64 v112, 0x80000000, v115, s25
	s_and_b32 s25, s7, s21
	v_add_nc_u32_e32 v118, v16, v110
	v_cndmask_b32_e64 v113, 0x80000000, v116, s25
	s_and_b32 s25, s8, s21
	v_add_nc_u32_e32 v119, v17, v110
	v_cndmask_b32_e64 v114, 0x80000000, v117, s25
	s_and_b32 s25, s9, s21
	v_add_nc_u32_e32 v120, v18, v110
	v_cndmask_b32_e64 v115, 0x80000000, v118, s25
	s_and_b32 s25, s10, s21
	v_add_nc_u32_e32 v121, v19, v110
	v_cndmask_b32_e64 v116, 0x80000000, v119, s25
	s_and_b32 s25, s11, s21
	v_add_nc_u32_e32 v122, v20, v110
	v_cndmask_b32_e64 v117, 0x80000000, v120, s25
	s_and_b32 s25, s12, s21
	v_add_nc_u32_e32 v127, v21, v110
	v_cndmask_b32_e64 v118, 0x80000000, v121, s25
	s_and_b32 s25, s13, s21
	v_add_nc_u32_e32 v128, v22, v110
	v_cndmask_b32_e64 v119, 0x80000000, v122, s25
	s_and_b32 s25, s14, s21
	v_add_nc_u32_e32 v129, v23, v110
	v_cndmask_b32_e64 v120, 0x80000000, v127, s25
	s_and_b32 s25, s15, s21
	v_add_nc_u32_e32 v130, v24, v110
	v_add_nc_u32_e32 v110, v25, v110
	v_cndmask_b32_e64 v121, 0x80000000, v128, s25
	s_and_b32 s25, s16, s21
	s_and_b32 s20, s58, s20
	v_cndmask_b32_e64 v122, 0x80000000, v129, s25
	s_and_b32 s25, s17, s21
	s_and_b32 s21, s18, s21
	v_cndmask_b32_e64 v126, 0x80000000, v130, s25
	v_cndmask_b32_e64 v127, 0x80000000, v110, s21
	s_and_b32 s21, s58, s22
	v_cndmask_b32_e64 v128, 0x80000000, v107, s20
	s_and_b32 s22, s58, s23
	s_and_b32 s20, s58, s24
	s_clause 0xf
	buffer_load_u8 v107, v108, s[48:51], 0 offen
	buffer_load_u8 v108, v109, s[48:51], 0 offen
	buffer_load_u8 v109, v111, s[48:51], 0 offen
	...
	v_cndmask_b32_e64 v126, 0x80000000, v123, s21
	v_cndmask_b32_e64 v124, 0x80000000, v124, s22
	v_cndmask_b32_e64 v125, 0x80000000, v125, s20
	.loc	1 916 34                        ; ragged.py:916:34
	s_clause 0x3
	buffer_load_u8 v123, v128, s[28:31], 0 offen
	...
	.loc	1 916 34                        ; ragged.py:916:34
	s_waitcnt vmcnt(3)
	ds_store_b8 v98, v123
	s_waitcnt vmcnt(1)
	ds_store_b8 v98, v124 offset:256
	ds_store_b8 v99, v126
	s_waitcnt vmcnt(0)
	ds_store_b8 v98, v125 offset:512
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 932 25                        ; ragged.py:932:25
	v_mul_lo_u32 v116, v69, s34
	.loc	1 929 27                        ; ragged.py:929:27
	v_cvt_f32_i32_e32 v109, v117
	.loc	1 932 25                        ; ragged.py:932:25
	v_mul_lo_u32 v117, v72, s34
	.loc	1 929 27                        ; ragged.py:929:27
	v_cvt_f32_i32_e32 v110, v118
	.loc	1 932 25                        ; ragged.py:932:25
	v_mul_lo_u32 v118, v73, s34
	.loc	1 929 27                        ; ragged.py:929:27
	v_cvt_f32_i32_e32 v111, v119
	.loc	1 938 40                        ; ragged.py:938:40
	v_add_lshl_u32 v119, v96, s20, 1
	.loc	1 931 40                        ; ragged.py:931:40
	v_add_lshl_u32 v115, s60, v115, 1
	v_add_lshl_u32 v116, s60, v116, 1
	.loc	1 929 27                        ; ragged.py:929:27
	v_cvt_f32_i32_e32 v112, v120
	.loc	1 931 40                        ; ragged.py:931:40
	v_add_lshl_u32 v117, s60, v117, 1
	.loc	1 938 40                        ; ragged.py:938:40
	v_cndmask_b32_e64 v119, 0x80000000, v119, s19
	.loc	1 931 40                        ; ragged.py:931:40
	v_add_lshl_u32 v118, s60, v118, 1
	...
	v_dual_mul_f32 v143, v144, v115 :: v_dual_mul_f32 v180, v114, v117
	...
	v_dual_mul_f32 v146, v146, v117 :: v_dual_mul_f32 v173, v175, v115
	v_mul_f32_e32 v174, v176, v115
	.loc	1 944 17                        ; ragged.py:944:17
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v94, v120, v108 :: v_dual_mul_f32 v175, v183, v115
	s_waitcnt lgkmcnt(0)
	v_fmac_f32_e32 v68, v153, v114
	v_dual_fmac_f32 v93, v121, v109 :: v_dual_fmac_f32 v92, v122, v110
	v_dual_fmac_f32 v78, v116, v107 :: v_dual_fmac_f32 v77, v135, v108
	v_fmac_f32_e32 v89, v129, v113
	v_fmac_f32_e32 v71, v147, v112
	v_dual_fmac_f32 v57, v118, v107 :: v_dual_fmac_f32 v52, v148, v112
	v_dual_fmac_f32 v35, v145, v113 :: v_dual_mul_f32 v176, v184, v115
	.loc	1 943 21                        ; ragged.py:943:21
	...
	.loc	1 944 17                        ; ragged.py:944:17
	v_dual_fmac_f32 v76, v136, v109 :: v_dual_fmac_f32 v75, v141, v110
	v_dual_fmac_f32 v55, v138, v109 :: v_dual_fmac_f32 v54, v143, v110
	v_dual_fmac_f32 v41, v123, v107 :: v_dual_fmac_f32 v36, v140, v112
	v_fmac_f32_e32 v40, v124, v108
	v_dual_fmac_f32 v56, v137, v108 :: v_dual_fmac_f32 v39, v127, v109
	v_fmac_f32_e32 v38, v128, v110
	v_dual_fmac_f32 v90, v126, v112 :: v_dual_fmac_f32 v91, v125, v111
	v_fmac_f32_e32 v50, v155, v114
	v_fmac_f32_e32 v88, v130, v114
	v_fmac_f32_e32 v74, v142, v111
	v_dual_fmac_f32 v70, v150, v113 :: v_dual_fmac_f32 v53, v144, v111
	v_dual_fmac_f32 v34, v146, v114 :: v_dual_fmac_f32 v51, v151, v113
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v37, v139, v111 :: v_dual_fmac_f32 v86, v132, v116
	v_dual_fmac_f32 v87, v131, v115 :: v_dual_fmac_f32 v84, v134, v118
	v_fmac_f32_e32 v85, v133, v117
	v_dual_fmac_f32 v65, v154, v115 :: v_dual_fmac_f32 v64, v159, v116
	v_dual_fmac_f32 v63, v160, v117 :: v_dual_fmac_f32 v62, v163, v118
	v_dual_fmac_f32 v49, v156, v115 :: v_dual_fmac_f32 v48, v161, v116
	v_fmac_f32_e32 v33, v168, v115
	v_dual_fmac_f32 v47, v162, v117 :: v_dual_fmac_f32 v46, v167, v118
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v61, v164, v119 :: v_dual_fmac_f32 v32, v170, v116
	v_fmac_f32_e32 v45, v173, v119
	v_dual_fmac_f32 v31, v171, v117 :: v_dual_fmac_f32 v30, v172, v118
	v_dual_fmac_f32 v59, v166, v121 :: v_dual_fmac_f32 v82, v149, v119
	v_fmac_f32_e32 v79, v158, v122
	v_dual_fmac_f32 v81, v152, v120 :: v_dual_fmac_f32 v80, v157, v121
	v_dual_fmac_f32 v60, v165, v120 :: v_dual_fmac_f32 v43, v175, v121
	v_dual_fmac_f32 v58, v169, v122 :: v_dual_fmac_f32 v27, v179, v121
	v_dual_fmac_f32 v44, v174, v120 :: v_dual_fmac_f32 v29, v177, v119
	v_fmac_f32_e32 v42, v176, v122
	v_fmac_f32_e32 v28, v178, v120
	v_fmac_f32_e32 v26, v180, v122
	.loc	1 901 19                        ; ragged.py:901:19
...
.LBB0_3:                                ; %._crit_edge
	...
	v_bfe_u32 v72, v84, 16, 1
	v_add3_u32 v69, v86, v69, 0x7fff
	...
	v_add3_u32 v72, v80, v72, 0x7fff
	v_cmp_o_f32_e64 s21, v80, v80
	v_cndmask_b16 v69.l, 0x7fff, v69.h, s19
	v_bfe_u32 v80, v79, 16, 1
	v_cndmask_b16 v69.h, 0x7fff, v73.h, s20
	...
	v_cndmask_b16 v72.h, 0x7fff, v80.h, s19
	v_cndmask_b16 v73.l, 0x7fff, v73.h, s20
	v_cndmask_b16 v73.h, 0x7fff, v78.h, s21
	...
	v_cndmask_b16 v64.h, 0x7fff, v68.h, s19
	...
	v_cndmask_b32_e64 v28, v66, v69, s19
	v_cndmask_b32_e64 v30, v67, v72, s19
	v_cndmask_b32_e64 v35, v73, v75, s19
	v_cndmask_b32_e64 v38, v74, v70, s19
	...
	v_cndmask_b32_e64 v24, v69, v66, s19
	v_cndmask_b32_e64 v29, v72, v67, s19
	v_cndmask_b32_e64 v32, v75, v73, s19
	v_cndmask_b32_e64 v36, v70, v74, s19
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc32_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 199
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc32_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc32_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 61
