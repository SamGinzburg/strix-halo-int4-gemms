...
.Ltmp2:
	...
	s_waitcnt lgkmcnt(0)
	s_mul_i32 s29, s10, s20
	.loc	1 573 19                        ; ragged.py:573:19
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 0 19 is_stmt 0                ; ragged.py:0:19
	v_dual_mov_b32 v3, s29 :: v_dual_lshlrev_b32 v4, 1, v0
	v_dual_mov_b32 v2, s22 :: v_dual_and_b32 v1, 16, v0
	s_branch .LBB0_3
.LBB0_2:
	s_mov_b32 s7, -1
                                        ; implicit-def: $vgpr4
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v7, 0 :: v_dual_and_b32 v72, 15, v0
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 573 19                        ; ragged.py:573:19
	v_add3_u32 v4, s29, s1, v4
	s_lshl_b32 s1, s12, 8
	v_lshl_or_b32 v2, v72, 5, v2
	v_and_or_b32 v3, v74, 30, v3
	.loc	1 568 18                        ; ragged.py:568:18
	v_and_b32_e32 v66, 24, v7
	.loc	1 573 19                        ; ragged.py:573:19
	...
	v_dual_mov_b32 v10, v1 :: v_dual_add_nc_u32 v9, 0x80, v4
	...
	v_mov_b32_e32 v8, v1
	.loc	1 573 19                        ; ragged.py:573:19
	v_mad_u64_u32 v[67:68], null, v5, s21, v[66:67]
	v_mov_b32_e32 v5, v1
	v_xor_b32_e32 v6, v7, v6
	v_xor_b32_e32 v7, 8, v2
	v_dual_mov_b32 v11, v1 :: v_dual_add_nc_u32 v80, 0, v2
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[68:69], null, s21, v9, v[65:66]
	v_mad_u64_u32 v[69:70], null, s21, v4, v[65:66]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v81, s31, v65
	.loc	1 575 26                        ; ragged.py:575:26
	v_add_nc_u32_e32 v82, s31, v66
	.loc	1 585 38                        ; ragged.py:585:38
	v_add_nc_u32_e32 v84, s31, v69
	.loc	1 585 30 is_stmt 0              ; ragged.py:585:30
	v_add_nc_u32_e32 v85, s31, v68
	.loc	1 584 30 is_stmt 1              ; ragged.py:584:30
	v_add_nc_u32_e32 v83, s31, v67
	.loc	1 575 26                        ; ragged.py:575:26
	v_cmp_gt_i32_e64 s2, s21, v81
	v_cmp_gt_i32_e64 s3, s21, v82
	...
	s_and_b32 s2, s0, s2
	.loc	1 585 30 is_stmt 0              ; ragged.py:585:30
	v_cndmask_b32_e64 v81, 0x80000000, v84, s4
	.loc	1 584 62 is_stmt 1              ; ragged.py:584:62
	s_and_b32 s3, s30, s3
	.loc	1 585 30                        ; ragged.py:585:30
	v_cndmask_b32_e64 v85, 0x80000000, v85, s2
	.loc	1 584 30                        ; ragged.py:584:30
	v_cndmask_b32_e64 v89, 0x80000000, v83, s3
	.loc	1 573 19                        ; ragged.py:573:19
	s_cmp_lt_i32 s31, s21
	.loc	1 585 30                        ; ragged.py:585:30
	s_clause 0x1
	buffer_load_b128 v[81:84], v81, s[16:19], 0 offen
	buffer_load_b128 v[85:88], v85, s[16:19], 0 offen
	.loc	1 584 30                        ; ragged.py:584:30
	buffer_load_b64 v[89:90], v89, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 585 30                        ; ragged.py:585:30
	s_waitcnt vmcnt(2)
	ds_bpermute_b32 v101, v75, v81
	ds_bpermute_b32 v102, v75, v82
	ds_bpermute_b32 v103, v76, v81
	ds_bpermute_b32 v104, v76, v82
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v105, v75, v85
	ds_bpermute_b32 v106, v75, v86
	ds_bpermute_b32 v107, v76, v85
	ds_bpermute_b32 v108, v76, v86
	.loc	1 584 30                        ; ragged.py:584:30
	s_waitcnt vmcnt(0)
	ds_store_b64 v70, v[89:90]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[89:92], v80 offset1:1
	ds_load_2addr_stride64_b64 v[93:96], v80 offset0:2 offset1:3
	.loc	1 585 30                        ; ragged.py:585:30
	ds_bpermute_b32 v109, v75, v83
	ds_bpermute_b32 v110, v75, v84
	ds_bpermute_b32 v111, v76, v83
	ds_bpermute_b32 v112, v76, v84
	ds_bpermute_b32 v113, v75, v87
	ds_bpermute_b32 v114, v75, v88
	ds_bpermute_b32 v115, v76, v87
	ds_bpermute_b32 v116, v76, v88
	.loc	1 584 30                        ; ragged.py:584:30
	ds_load_2addr_stride64_b64 v[81:84], v77 offset1:1
	ds_load_2addr_stride64_b64 v[85:88], v77 offset0:2 offset1:3
	.loc	1 585 30                        ; ragged.py:585:30
	v_cndmask_b32_e64 v97, v103, v101, s1
	v_cndmask_b32_e64 v98, v104, v102, s1
	v_cndmask_b32_e64 v101, v101, v103, s1
	v_cndmask_b32_e64 v102, v102, v104, s1
	v_cndmask_b32_e64 v99, v107, v105, s1
	v_cndmask_b32_e64 v100, v108, v106, s1
	v_cndmask_b32_e64 v103, v105, v107, s1
	v_cndmask_b32_e64 v104, v106, v108, s1
	.loc	1 586 27                        ; ragged.py:586:27
	s_waitcnt lgkmcnt(11)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[97:98], v[89:90], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[97:98], v[91:92], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[99:100], v[89:90], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[99:100], v[91:92], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[97:98], v[93:94], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[97:98], v[95:96], v[49:56] neg_lo:[1,1,0]
	.loc	1 584 30                        ; ragged.py:584:30
	ds_load_2addr_stride64_b64 v[89:92], v78 offset1:1
	.loc	1 586 27                        ; ragged.py:586:27
	v_wmma_i32_16x16x16_iu4 v[41:48], v[99:100], v[93:94], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[99:100], v[95:96], v[57:64] neg_lo:[1,1,0]
	.loc	1 584 30                        ; ragged.py:584:30
	ds_load_2addr_stride64_b64 v[93:96], v78 offset0:2 offset1:3
	.loc	1 585 30                        ; ragged.py:585:30
	s_waitcnt lgkmcnt(9)
	v_cndmask_b32_e64 v105, v111, v109, s1
	s_waitcnt lgkmcnt(8)
	v_cndmask_b32_e64 v106, v112, v110, s1
	v_cndmask_b32_e64 v107, v109, v111, s1
	v_cndmask_b32_e64 v108, v110, v112, s1
	s_waitcnt lgkmcnt(5)
	v_cndmask_b32_e64 v109, v115, v113, s1
	s_waitcnt lgkmcnt(4)
	v_cndmask_b32_e64 v110, v116, v114, s1
	.loc	1 584 30                        ; ragged.py:584:30
	ds_load_2addr_stride64_b64 v[97:100], v79 offset1:1
	.loc	1 586 27                        ; ragged.py:586:27
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[105:106], v[81:82], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[105:106], v[83:84], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[105:106], v[85:86], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[109:110], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[109:110], v[83:84], v[25:32] neg_lo:[1,1,0]
	.loc	1 584 30                        ; ragged.py:584:30
	ds_load_2addr_stride64_b64 v[81:84], v79 offset0:2 offset1:3
	.loc	1 586 27                        ; ragged.py:586:27
	v_wmma_i32_16x16x16_iu4 v[49:56], v[105:106], v[87:88], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[109:110], v[85:86], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[109:110], v[87:88], v[57:64] neg_lo:[1,1,0]
	.loc	1 585 30                        ; ragged.py:585:30
	v_cndmask_b32_e64 v111, v113, v115, s1
	v_cndmask_b32_e64 v112, v114, v116, s1
	.loc	1 586 27                        ; ragged.py:586:27
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[101:102], v[89:90], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[103:104], v[89:90], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[101:102], v[91:92], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[103:104], v[91:92], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[101:102], v[93:94], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[101:102], v[95:96], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[103:104], v[93:94], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[103:104], v[95:96], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[107:108], v[97:98], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[111:112], v[97:98], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[107:108], v[99:100], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[111:112], v[99:100], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[107:108], v[81:82], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[107:108], v[83:84], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[111:112], v[81:82], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[111:112], v[83:84], v[57:64] neg_lo:[1,1,0]
	.loc	1 573 19                        ; ragged.py:573:19
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_mov_b32 v3, s29 :: v_dual_mov_b32 v2, s22
	v_dual_mov_b32 v4, v74 :: v_dual_mov_b32 v1, v73
.LBB0_7:                                ; %._crit_edge
	.loc	1 562 32                        ; ragged.py:562:32
	v_or_b32_e32 v5, 48, v72
	v_or_b32_e32 v36, 32, v72
	v_or_b32_e32 v38, 16, v72
	...
	v_add_co_ci_u32_e64 v37, null, s23, 0, s0
	v_add_co_u32 v38, s0, s22, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_add_co_ci_u32_e64 v39, null, s23, 0, s0
	v_add_co_u32 v40, s0, s22, v72
	v_add_co_ci_u32_e64 v41, null, s23, 0, s0
	.loc	1 564 21                        ; ragged.py:564:21
	v_cmp_le_i64_e32 vcc_lo, s[24:25], v[5:6]
	.loc	1 564 48 is_stmt 0              ; ragged.py:564:48
	v_cmp_gt_i64_e64 s3, s[26:27], v[5:6]
	.loc	1 564 21                        ; ragged.py:564:21
	v_cmp_le_i64_e64 s1, s[24:25], v[38:39]
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_le_i64_e64 s2, s[24:25], v[40:41]
	.loc	1 564 48                        ; ragged.py:564:48
	v_cmp_gt_i64_e64 s6, s[26:27], v[40:41]
	v_cmp_gt_i64_e64 s5, s[26:27], v[38:39]
	.loc	1 564 21                        ; ragged.py:564:21
	v_cmp_le_i64_e64 s0, s[24:25], v[36:37]
	.loc	1 564 48                        ; ragged.py:564:48
	v_cmp_gt_i64_e64 s4, s[26:27], v[36:37]
	...
	buffer_load_u16 v40, v3, s[52:55], 0 offen
	...
	v_dual_mul_f32 v71, v80, v37 :: v_dual_and_b32 v0, 0xf0, v0
	v_mul_f32_e32 v45, v101, v38
	v_dual_mul_f32 v46, v100, v38 :: v_dual_and_b32 v3, 28, v4
	v_mul_f32_e32 v50, v96, v38
	v_dual_mul_f32 v59, v86, v37 :: v_dual_add_nc_u32 v2, v72, v2
	.loc	1 563 36                        ; ragged.py:563:36
	v_lshrrev_b32_e32 v4, 1, v0
	.loc	1 607 17                        ; ragged.py:607:17
	v_lshl_add_u32 v41, v0, 2, 0
	v_lshl_add_u32 v42, v0, 1, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 600 17                        ; ragged.py:600:17
	v_dual_mul_f32 v58, v87, v37 :: v_dual_add_nc_u32 v43, 32, v2
	.loc	1 563 18                        ; ragged.py:563:18
	v_or_b32_e32 v0, s28, v4
	.loc	1 600 17                        ; ragged.py:600:17
	v_dual_mul_f32 v61, v84, v37 :: v_dual_add_nc_u32 v4, 16, v2
	v_dual_mul_f32 v63, v82, v37 :: v_dual_add_nc_u32 v44, 48, v2
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v47, v99, v38 :: v_dual_lshlrev_b32 v36, 16, v36
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v52, v94, v38 :: v_dual_lshlrev_b32 v39, 16, v39
	v_mul_f32_e32 v48, v98, v38
	.loc	1 607 17                        ; ragged.py:607:17
	v_add3_u32 v41, v41, v5, v3
	.loc	1 600 17                        ; ragged.py:600:17
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v49, v97, v38 :: v_dual_lshlrev_b32 v40, 16, v40
	.loc	1 661 13                        ; ragged.py:661:13
	v_mul_lo_u32 v5, v4, s20
	v_mul_lo_u32 v4, v43, s20
	v_mul_lo_u32 v3, v44, s20
	.loc	1 600 17                        ; ragged.py:600:17
	v_mul_f32_e32 v43, v103, v38
	v_mul_f32_e32 v44, v102, v38
	v_dual_mul_f32 v51, v95, v38 :: v_dual_mul_f32 v60, v85, v37
	v_dual_mul_f32 v53, v93, v38 :: v_dual_mul_f32 v62, v83, v37
	v_dual_mul_f32 v54, v92, v38 :: v_dual_mul_f32 v73, v78, v37
	v_dual_mul_f32 v55, v91, v38 :: v_dual_mul_f32 v64, v81, v37
	v_dual_mul_f32 v56, v90, v38 :: v_dual_mul_f32 v75, v75, v37
	v_dual_mul_f32 v57, v89, v38 :: v_dual_mul_f32 v72, v79, v37
	v_dual_mul_f32 v38, v88, v38 :: v_dual_mul_f32 v69, v69, v37
	v_dual_mul_f32 v74, v77, v37 :: v_dual_mul_f32 v67, v67, v36
	v_dual_mul_f32 v76, v76, v37 :: v_dual_mul_f32 v65, v65, v36
	v_dual_mul_f32 v70, v70, v37 :: v_dual_mul_f32 v35, v35, v36
	v_dual_mul_f32 v37, v68, v37 :: v_dual_mul_f32 v68, v34, v36
	v_mul_f32_e32 v66, v66, v36
	v_dual_mul_f32 v77, v33, v36 :: v_dual_mul_f32 v22, v22, v39
	v_dual_mul_f32 v78, v32, v36 :: v_dual_mul_f32 v21, v21, v39
	v_mul_f32_e32 v79, v31, v36
	v_mul_f32_e32 v80, v30, v36
	v_dual_mul_f32 v81, v29, v36 :: v_dual_mul_f32 v16, v16, v39
	v_dual_mul_f32 v82, v28, v36 :: v_dual_mul_f32 v87, v18, v39
	v_dual_mul_f32 v83, v27, v36 :: v_dual_mul_f32 v88, v17, v39
	v_dual_mul_f32 v84, v26, v36 :: v_dual_mul_f32 v15, v15, v39
	v_dual_mul_f32 v85, v25, v36 :: v_dual_mul_f32 v14, v14, v39
	v_dual_mul_f32 v86, v24, v36 :: v_dual_mul_f32 v13, v13, v39
	v_dual_mul_f32 v36, v23, v36 :: v_dual_mul_f32 v9, v9, v39
	.loc	1 607 17                        ; ragged.py:607:17
	...
	v_dual_mul_f32 v60, v62, v27 :: v_dual_mul_f32 v47, v49, v29
	v_mul_f32_e32 v49, v51, v17
	v_mul_f32_e32 v51, v53, v19
	...
	v_dual_mul_f32 v63, v71, v30 :: v_dual_mul_f32 v64, v72, v17
	v_mul_f32_e32 v37, v37, v34
	v_dual_mul_f32 v71, v73, v18 :: v_dual_mul_f32 v72, v74, v19
	v_dual_mul_f32 v73, v76, v20 :: v_dual_mul_f32 v74, v75, v31
	v_dual_mul_f32 v69, v69, v33 :: v_dual_mul_f32 v66, v66, v24
	v_mul_f32_e32 v65, v65, v25
	v_dual_mul_f32 v35, v35, v26 :: v_dual_mul_f32 v68, v68, v27
	v_dual_mul_f32 v75, v77, v28 :: v_dual_mul_f32 v76, v78, v29
	v_dual_mul_f32 v77, v79, v30 :: v_dual_mul_f32 v78, v80, v17
	v_dual_mul_f32 v79, v81, v18 :: v_dual_mul_f32 v80, v82, v19
	v_dual_mul_f32 v36, v36, v34 :: v_dual_mul_f32 v21, v21, v24
	...
	.loc	1 607 17                        ; ragged.py:607:17
	v_dual_mul_f32 v16, v16, v29 :: v_dual_mul_f32 v13, v13, v18
	v_dual_mul_f32 v12, v12, v19 :: v_dual_mul_f32 v9, v9, v32
	v_dual_mul_f32 v10, v10, v31 :: v_dual_mul_f32 v7, v7, v34
	.loc	1 660 9                         ; ragged.py:660:9
	...
	v_add3_u32 v66, v80, v113, 0x7fff
	...
	v_add3_u32 v44, v81, v114, 0x7fff
	.loc	1 607 17                        ; ragged.py:607:17
	...
	v_cndmask_b16 v44.l, 0x7fff, v66.h, s5
	...
	v_add3_u32 v49, v36, v49, 0x7fff
	v_cmp_o_f32_e64 s8, v36, v36
	v_cndmask_b16 v36.l, 0x7fff, v46.h, s5
	v_bfe_u32 v46, v22, 16, 1
	.loc	1 607 17                        ; ragged.py:607:17
	v_mul_f32_e32 v25, v87, v27
	.loc	1 660 9                         ; ragged.py:660:9
	v_cndmask_b16 v36.h, 0x7fff, v47.h, s6
	v_cndmask_b16 v47.l, 0x7fff, v48.h, s7
	v_cndmask_b16 v47.h, 0x7fff, v49.h, s8
	v_bfe_u32 v48, v21, 16, 1
	v_add3_u32 v46, v22, v46, 0x7fff
	...
	v_cndmask_b16 v23.l, 0x7fff, v46.h, s5
	...
	v_cmp_o_f32_e64 s31, v72, v72
	v_cmp_o_f32_e64 s33, v73, v73
	v_cmp_o_f32_e64 s34, v74, v74
	...
	v_add3_u32 v38, v38, v86, 0x7fff
	v_add3_u32 v42, v56, v87, 0x7fff
	v_add3_u32 v50, v64, v95, 0x7fff
	v_add3_u32 v51, v71, v96, 0x7fff
	v_add3_u32 v52, v72, v97, 0x7fff
	v_add3_u32 v53, v73, v98, 0x7fff
	v_add3_u32 v54, v74, v99, 0x7fff
	...
	v_cndmask_b16 v30.h, 0x7fff, v38.h, s20
	v_cndmask_b16 v38.l, 0x7fff, v50.h, s29
	v_cndmask_b16 v38.h, 0x7fff, v51.h, s30
	...
	v_cndmask_b32_e64 v26, v40, v38, s5
	v_cndmask_b32_e64 v27, v38, v40, s5
	...
	v_cndmask_b16 v45.l, 0x7fff, v64.h, s46
	v_cndmask_b16 v45.h, 0x7fff, v65.h, s47
	...
	v_cndmask_b32_e64 v35, v45, v36, s5
	v_cndmask_b32_e64 v37, v44, v47, s5
	...
	v_cndmask_b32_e64 v34, v36, v45, s5
	...
	v_cndmask_b32_e64 v36, v47, v44, s5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 117
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 56
