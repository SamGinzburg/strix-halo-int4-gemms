...
.LBB0_2:                                ;   in Loop: Header=BB0_3 Depth=1
	...
	v_dual_mul_f32 v38, v111, v38 :: v_dual_mul_f32 v119, s52, v36
	...
	v_dual_mul_f32 v117, s52, v34 :: v_dual_mul_f32 v118, s52, v35
	v_dual_mul_f32 v35, s52, v37 :: v_dual_mul_f32 v36, s52, v38
	.loc	1 759 25                        ; attention.py:759:25
	...
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v39, s52, v39 :: v_dual_mul_f32 v40, s52, v40
...
.Ltmp23:
	...
	v_dual_mul_f32 v30, v30, v125 :: v_dual_add_f32 v117, v120, v122
	v_dual_mul_f32 v24, v24, v125 :: v_dual_add_f32 v37, v37, v115
...
.Ltmp31:
	...
	v_dual_mul_f32 v8, v8, v125 :: v_dual_fmac_f32 v37, v90, v40
	.loc	1 816 30                        ; attention.py:816:30
	...
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v7, v7, v125 :: v_dual_and_b32 v114, 1, v114
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 816 30                        ; attention.py:816:30
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 53
