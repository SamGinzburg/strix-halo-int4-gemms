	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_abs_i32 s6, s5
	v_dual_mov_b32 v23, 0 :: v_dual_and_b32 v16, 56, v4
	s_cvt_f32_u32 s7, s6
	s_sub_i32 s10, 0, s6
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v72, 0 :: v_dual_add_nc_u32 v3, s34, v3
	...
	s_mov_b32 s22, s16
	s_mov_b32 s23, s16
	v_dual_mov_b32 v70, 0 :: v_dual_add_nc_u32 v91, 0, v6
	v_dual_mov_b32 v73, 0 :: v_dual_add_nc_u32 v92, 0, v7
	v_dual_mov_b32 v68, 0 :: v_dual_add_nc_u32 v93, 0, v8
	v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v1, s16
	v_dual_mov_b32 v71, 0 :: v_dual_add_nc_u32 v94, 0, v16
	v_dual_mov_b32 v66, 0 :: v_dual_add_nc_u32 v95, 0, v17
	v_dual_mov_b32 v69, 0 :: v_dual_add_nc_u32 v96, 0, v18
	v_dual_mov_b32 v64, 0 :: v_dual_add_nc_u32 v97, 0, v19
	v_dual_mov_b32 v67, 0 :: v_dual_add_nc_u32 v98, 0, v20
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v25, v111, v114 :: v_dual_add_nc_u32 v112, s42, v9
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x1
...
.LBB0_5:
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v137, 4, v81
	v_add_nc_u32_e32 v138, 8, v81
	v_add_nc_u32_e32 v140, 12, v81
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v98, v98, v82 :: v_dual_add_nc_u32 v161, 0x60, v81
	...
	v_dual_mul_f32 v90, v90, v82 :: v_dual_add_nc_u32 v153, 64, v81
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	v_dual_mul_f32 v10, v10, v82 :: v_dual_add_nc_u32 v145, 32, v81
	...
	v_fma_f32 v2, v2, v137, v78
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(56)
	v_lshlrev_b32_e32 v144, 16, v144
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v3, v3, v138, v77
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	v_fma_f32 v104, v105, v168, v47
	v_fma_f32 v105, v106, v169, v46
	v_fma_f32 v106, v107, v170, v45
	v_fma_f32 v107, v108, v171, v44
	v_fma_f32 v108, v109, v172, v43
	v_fma_f32 v109, v110, v173, v42
	v_fma_f32 v110, v111, v174, v41
	v_fma_f32 v111, v112, v175, v40
	...
	v_fma_f32 v123, v124, v187, v27
	v_fma_f32 v124, v125, v188, v26
	v_fma_f32 v125, v126, v189, v25
	v_fma_f32 v126, v127, v190, v24
	v_fma_f32 v127, v128, v191, v23
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v128, v129, v192, v22
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v197, 16, v197
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v129, v130, v193, v21
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v81, 16, v81
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v130, v131, v194, v20
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v79, 16, v79
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v131, v132, v195, v19
	v_fma_f32 v132, v133, v196, v18
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v22, v22, v128, s2
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v133, v134, v197, v17
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_vgpr, 241
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.kd
