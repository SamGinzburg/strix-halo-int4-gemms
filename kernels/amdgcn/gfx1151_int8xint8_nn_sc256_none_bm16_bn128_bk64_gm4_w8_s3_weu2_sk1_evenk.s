...
.Ltmp11:
	...
	v_mad_u64_u32 v[7:8], null, s15, v5, v[1:2]
...
.Ltmp21:
	...
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v9, v3, 1, v12
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v12, v14, v5
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	s_waitcnt vmcnt(2)
	v_perm_b32 v62, v42, v25, 0x5010400
	...
	v_perm_b32 v42, v42, v25, 0x7030602
...
.LBB0_3:                                ; %Flow79
	...
	v_or_b32_e32 v17, s34, v4
	s_ashr_i32 s0, s26, 8
	v_or_b32_e32 v25, s14, v9
	v_or_b32_e32 v24, s14, v13
	v_or_b32_e32 v23, s14, v14
	v_mul_lo_u32 v26, v17, s0
	v_or_b32_e32 v21, s14, v15
	v_or_b32_e32 v19, s14, v16
	v_or_b32_e32 v22, s14, v10
	v_or_b32_e32 v20, s14, v11
	v_or_b32_e32 v18, s14, v12
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s11, s30, 7
	v_xor_b32_e32 v29, 16, v27
	v_xor_b32_e32 v28, 32, v27
	v_and_or_b32 v4, 0x210, v9, v6
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v6, 0x81, v5
...
.Ltmp23:
	...
	s_add_i32 s10, s1, -2
	v_subrev_nc_u32_e32 v47, s11, v4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[58:61], v48, s[20:23], 0 offen
	buffer_load_b128 v[62:65], v47, s[20:23], 0 offen
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v50, v26, s18, 1
	...
	s_mov_b32 s1, s34
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v50, s18, v27
	v_add_nc_u32_e32 v51, s18, v29
	s_mov_b32 s34, s19
	v_add_nc_u32_e32 v52, s18, v28
	v_add_nc_u32_e32 v53, s18, v30
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s35, v40
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s34, s37, 0x4000
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v115, s35, v41
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s10, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_barrier
	...
	v_mul_f32_e32 v58, v74, v76
	v_mul_f32_e32 v59, v74, v75
	v_mul_f32_e32 v60, v74, v78
	v_mul_f32_e32 v61, v74, v77
	v_mul_f32_e32 v62, v74, v80
	v_mul_f32_e32 v63, v74, v79
	v_mul_f32_e32 v64, v74, v82
	v_dual_mul_f32 v65, v74, v81 :: v_dual_add_nc_u32 v48, s33, v48
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v15, v61, v69 :: v_dual_add_nc_u32 v108, s37, v34
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v13, v63, v71
	v_dual_fmac_f32 v16, v58, v66 :: v_dual_add_nc_u32 v109, s35, v35
	v_dual_fmac_f32 v11, v65, v73 :: v_dual_add_nc_u32 v110, s35, v36
	v_dual_fmac_f32 v12, v62, v70 :: v_dual_add_nc_u32 v111, s35, v37
	v_dual_fmac_f32 v10, v64, v72 :: v_dual_add_nc_u32 v113, s35, v39
	v_dual_fmac_f32 v9, v59, v67 :: v_dual_fmac_f32 v14, v60, v68
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v43, v33 :: v_dual_mov_b32 v6, v31
...
; %bb.9:
	...
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v2, s19, v50
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v36, v33 :: v_dual_add_nc_u32 v31, s19, v48
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v39, v33 :: v_dual_add_nc_u32 v6, s19, v46
...
; %bb.11:
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v38, s35, v48
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s35, v50
	v_add_nc_u32_e32 v37, s35, v49
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v29, s34, v29
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v60, v53 :: v_dual_add_nc_u32 v27, s34, v27
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v37, s34, v30
	v_add_nc_u32_e32 v39, s34, v28
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 116
