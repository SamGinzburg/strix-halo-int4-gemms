...
.Ltmp0:
	...
	v_dual_mov_b32 v22, 0 :: v_dual_lshlrev_b32 v9, 1, v12
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_lshrrev_b32_e32 v38, 2, v0
	v_dual_mov_b32 v23, 0 :: v_dual_and_b32 v10, 24, v5
...
.Ltmp11:
	...
	v_or_b32_e32 v20, 6, v28
	v_or_b32_e32 v19, 8, v28
	v_or_b32_e32 v18, 10, v28
	.loc	1 89 16                         ; generate_amdgcn.py:89:16
	s_mul_f32 s9, s9, 0x4f7ffffe
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_or_b32_e32 v17, 12, v28
	v_or_b32_e32 v16, 14, v28
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_add_nc_u32_e32 v36, 0, v7
	.loc	1 89 16                         ; generate_amdgcn.py:89:16
	s_cvt_u32_f32 s9, s9
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v37, 0, v5
...
.Ltmp21:
	...
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	buffer_load_b64 v[3:4], v4, s[16:19], 0 offen
...
; %bb.1:                                ; %.lr.ph
	...
	v_or_b32_e32 v21, s6, v19
	v_or_b32_e32 v22, s6, v18
	v_or_b32_e32 v6, s6, v17
	buffer_load_u16 v70, v2, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v27, v3, s[20:23], 0 offen
	v_or_b32_e32 v23, s6, v16
	...
	s_clause 0x7
	buffer_load_u16 v30, v2, s[24:27], 0 offen
	...
	buffer_load_u16 v77, v21, s[24:27], 0 offen
	.loc	1 155 22                        ; generate_amdgcn.py:155:22
	...
	ds_load_b64 v[21:22], v39 offset:4096
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	ds_load_b64 v[25:26], v41 offset:4096
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	ds_load_b64 v[62:63], v43 offset:4096
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	v_mov_b32_e32 v8, v1
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[66:67], v45 offset:4096
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_wmma_i32_16x16x16_iu4 v[50:57], v[23:24], v[21:22], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[50:57], v[60:61], v[25:26], v[50:57] neg_lo:[1,1,0]
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	v_fma_f32 v22, v22, v52, 0
	v_fma_f32 v23, v23, v53, 0
	v_fma_f32 v24, v24, v54, 0
	v_fma_f32 v25, v25, v55, 0
	v_fma_f32 v26, v26, v56, 0
	v_fma_f32 v27, v50, v57, 0
	v_fma_f32 v30, v51, v60, 0
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v77, v48, s[20:23], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	...
	buffer_load_b64 v[59:60], v12, s[16:19], 0 offen
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v27, v56, v67
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v54, v54, v58 :: v_dual_add_nc_u32 v47, s35, v47
	v_dual_mul_f32 v51, v51, v58 :: v_dual_add_nc_u32 v48, 2, v48
	v_dual_mul_f32 v53, v53, v58 :: v_dual_lshlrev_b32 v62, 16, v79
	v_dual_mul_f32 v55, v55, v58 :: v_dual_lshlrev_b32 v64, 16, v81
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v22, v51, v62
	v_fmac_f32_e32 v24, v53, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v26, v55, v66 :: v_dual_fmac_f32 v21, v12, v61
	v_dual_fmac_f32 v23, v52, v63 :: v_dual_fmac_f32 v30, v57, v68
	v_fmac_f32_e32 v25, v54, v65
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
...
; %bb.5:
	...
	ds_load_b64 v[33:34], v6
	v_xad_u32 v4, v1, 24, 0
	v_xad_u32 v5, v1, 16, 0
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[35:36], v2 offset:4096
	ds_load_b64 v[37:38], v3 offset:4096
	ds_load_b64 v[39:40], v7 offset:4096
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[41:42], v[37:38], v[1:8] neg_lo:[1,1,0]
...
.LBB0_6:
	...
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v2, v2, v8 :: v_dual_lshlrev_b32 v19, 16, v19
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v3, v3, v8 :: v_dual_lshlrev_b32 v18, 16, v18
	v_mul_f32_e32 v7, v7, v8
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v4, v4, v8 :: v_dual_lshlrev_b32 v17, 16, v17
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v2, v2, v11, v23
	v_fma_f32 v3, v3, v12, v24
	.loc	1 187 19 is_stmt 1              ; generate_amdgcn.py:187:19
	v_max_f32_e32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v4, v4, v19, v25
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	s_waitcnt vmcnt(0)
	v_dual_max_f32 v3, 0, v3 :: v_dual_lshlrev_b32 v16, 16, v16
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v14, v9, v21
	.loc	1 188 19 is_stmt 1              ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v2, v2, v2 :: v_dual_and_b32 v9, 1, v20
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_max_f32_e32 v7, v7, v7
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v6, v6, v17, v27
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v8, v8, v8 :: v_dual_mul_f32 v5, v5, v5
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v7, v7, v7 :: v_dual_max_f32 v6, 0, v6
	...
	v_cndmask_b32_e32 v9, 0x1054, v28, vcc_lo
	...
	v_cndmask_b32_e32 v10, 0x3276, v29, vcc_lo
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 36
