...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v21, v33 :: v_dual_add_nc_u32 v66, 0, v54
	v_mov_b32_e32 v22, v33
	v_xor_b32_e32 v69, 8, v61
	v_xor_b32_e32 v70, 16, v61
	v_xor_b32_e32 v71, 24, v61
	v_lshl_or_b32 v51, v51, 4, v51
	v_lshl_or_b32 v54, v67, 4, v67
	v_dual_mov_b32 v0, 0xff800000 :: v_dual_add_nc_u32 v67, 0, v68
	...
	v_dual_mov_b32 v24, v33 :: v_dual_and_b32 v51, 0x5040504, v51
	...
	v_dual_mov_b32 v23, v33 :: v_dual_mul_f32 v68, s1, v53
	v_mov_b32_e32 v9, v33
	v_mov_b32_e32 v12, v33
	v_dual_mov_b32 v14, v33 :: v_dual_and_b32 v53, 0x7060706, v54
	.loc	1 932 25                        ; attention.py:932:25
	v_mov_b32_e32 v69, v68
	v_mov_b32_e32 v70, v68
	v_dual_mov_b32 v71, v68 :: v_dual_mov_b32 v54, v33
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 908 32                        ; attention.py:908:32
	v_cndmask_b32_e64 v72, 0x80000000, v50, s0
	.loc	1 978 32                        ; attention.py:978:32
	v_dual_cndmask_b32 v73, 0x80000000, v49 :: v_dual_cndmask_b32 v76, 0x80000000, v58
	.loc	1 904 31                        ; attention.py:904:31
	v_add_nc_u32_e32 v74, s23, v56
	.loc	1 978 32                        ; attention.py:978:32
	v_mov_b16_e32 v75.l, 0
	.loc	1 908 32                        ; attention.py:908:32
	buffer_load_b32 v72, v72, s[24:27], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 904 31                        ; attention.py:904:31
	v_add_nc_u32_e32 v77, 12, v74
	v_add_nc_u32_e32 v78, 10, v74
	v_add_nc_u32_e32 v79, 4, v74
	v_add_nc_u32_e32 v80, 8, v74
	v_add_nc_u32_e32 v81, 6, v74
	.loc	1 949 30                        ; attention.py:949:30
	v_cmp_le_i32_e64 s5, v77, v57
	v_cmp_le_i32_e64 s6, v78, v57
	v_cmp_le_i32_e64 s9, v79, v57
	v_cmp_le_i32_e64 s7, v80, v57
	v_cmp_le_i32_e64 s8, v81, v57
	v_dual_mov_b32 v112, v54 :: v_dual_add_nc_u32 v49, s34, v49
	v_cmp_le_i32_e64 s1, v74, v57
	.loc	1 1000 41                       ; attention.py:1000:41
	v_mov_b16_e32 v96.l, v75.l
	.loc	1 949 21                        ; attention.py:949:21
	s_and_b32 s8, s2, s8
	.loc	1 1017 30                       ; attention.py:1017:30
	v_mov_b16_e32 v92.h, v75.l
	.loc	1 949 21                        ; attention.py:949:21
	s_and_b32 s5, s2, s5
	s_and_b32 s1, s2, s1
	s_and_b32 s7, s2, s7
	...
	v_mov_b16_e32 v95.h, v75.l
	v_mov_b16_e32 v97.h, v75.l
	v_mov_b16_e32 v98.h, v75.l
	v_mov_b16_e32 v99.h, v75.l
	v_mov_b16_e32 v100.h, v75.l
	.loc	1 1019 30                       ; attention.py:1019:30
	v_mov_b16_e32 v101.h, v75.l
	v_mov_b16_e32 v102.h, v75.l
	v_mov_b16_e32 v103.h, v75.l
	v_mov_b16_e32 v104.h, v75.l
	v_mov_b16_e32 v105.h, v75.l
	v_mov_b16_e32 v116.h, v75.l
	v_mov_b16_e32 v117.h, v75.l
	v_mov_b16_e32 v118.h, v75.l
	...
	.loc	1 908 32                        ; attention.py:908:32
	s_waitcnt vmcnt(0)
	ds_store_b32 v60, v72
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 923 37                        ; attention.py:923:37
	s_clause 0x7
	buffer_load_u16 v106, v59, s[36:39], 0 offen
	buffer_load_u16 v107, v59, s[36:39], 0 offen offset:4
	buffer_load_u16 v108, v59, s[36:39], 0 offen offset:8
	buffer_load_u16 v109, v59, s[36:39], 0 offen offset:16
	buffer_load_u16 v110, v59, s[36:39], 0 offen offset:20
	buffer_load_u16 v111, v59, s[36:39], 0 offen offset:28
	buffer_load_u16 v113, v59, s[36:39], 0 offen offset:24
	buffer_load_u16 v114, v59, s[36:39], 0 offen offset:12
	.loc	1 978 32                        ; attention.py:978:32
	buffer_load_b32 v115, v73, s[40:43], 0 offen
	.loc	1 1000 41                       ; attention.py:1000:41
	buffer_load_b64 v[72:73], v76, s[28:31], 0 offen
	.loc	1 908 32                        ; attention.py:908:32
	ds_load_b64 v[84:85], v61
	ds_load_b64 v[86:87], v62
	ds_load_b64 v[88:89], v63
	ds_load_b64 v[90:91], v64
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 913 33                        ; attention.py:913:33
	v_wmma_i32_16x16x16_iu4 v[76:83], v[84:85], v[47:48], v[33:40] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[76:83], v[86:87], v[45:46], v[76:83] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[76:83], v[88:89], v[43:44], v[76:83] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[76:83], v[90:91], v[41:42], v[76:83] neg_lo:[1,1,0]
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v80, v68, v80 :: v_dual_mul_f32 v81, v69, v81
	.loc	1 923 37                        ; attention.py:923:37
	s_waitcnt vmcnt(7)
	v_lshlrev_b32_e32 v85, 16, v108
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v89, 16, v113
	.loc	1 978 32                        ; attention.py:978:32
	s_waitcnt vmcnt(1)
	v_bfe_i32 v91, v115, 0, 8
	.loc	1 1000 41                       ; attention.py:1000:41
	s_waitcnt vmcnt(0)
	...
	v_add_nc_u32_e32 v54, 14, v74
	.loc	1 904 31                        ; attention.py:904:31
	v_add_nc_u32_e32 v74, 2, v74
	.loc	1 1000 41                       ; attention.py:1000:41
	v_mov_b16_e32 v96.h, v73.l
	.loc	1 923 37                        ; attention.py:923:37
	v_lshlrev_b32_e32 v90, 16, v114
	v_lshlrev_b32_e32 v86, 16, v109
	.loc	1 978 32                        ; attention.py:978:32
	v_mov_b16_e32 v92.l, v115.h
	.loc	1 949 30                        ; attention.py:949:30
	v_cmp_le_i32_e64 s10, v74, v57
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 978 32                        ; attention.py:978:32
	v_lshrrev_b32_e32 v109, 24, v115
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v74, v69, v74 :: v_dual_mul_f32 v77, v71, v77
	v_mul_f32_e32 v79, v71, v79
	.loc	1 923 37                        ; attention.py:923:37
	v_lshlrev_b32_e32 v84, 16, v107
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v80, v80, v86 :: v_dual_and_b32 v107, 0xffff0000, v72
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v77, v77, v90
	v_mul_f32_e32 v79, v79, v88
	.loc	1 949 30                        ; attention.py:949:30
	v_cmp_le_i32_e64 s3, v54, v57
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v84, v74, v84 :: v_dual_lshlrev_b32 v87, 16, v110
	v_mul_f32_e32 v82, v68, v54
	v_mul_f32_e32 v76, v70, v76
	v_mul_f32_e32 v78, v70, v78
	.loc	1 923 37                        ; attention.py:923:37
	v_lshlrev_b32_e32 v83, 16, v106
	.loc	1 986 76                        ; attention.py:986:76
	v_and_b16 v54.l, v115.l, 15
	.loc	1 988 32                        ; attention.py:988:32
	v_lshrrev_b16 v54.h, 4, v115.l
	.loc	1 978 32                        ; attention.py:978:32
	v_lshrrev_b32_e32 v106, 8, v115
	.loc	1 932 25                        ; attention.py:932:25
	v_mul_f32_e32 v78, v78, v89
	v_dual_mul_f32 v82, v82, v83 :: v_dual_mul_f32 v83, v76, v85
	...
	v_cndmask_b32_e64 v90, 0xff800000, v77, s8
	.loc	1 1000 41                       ; attention.py:1000:41
	v_and_b32_e32 v108, 0xffff0000, v73
	.loc	1 990 39                        ; attention.py:990:39
	v_mov_b16_e32 v73.l, v91.l
	.loc	1 986 76                        ; attention.py:986:76
	...
	.loc	1 978 32                        ; attention.py:978:32
	v_bfe_i32 v85, v106, 0, 8
	v_bfe_i32 v86, v92, 0, 8
	v_bfe_i32 v87, v109, 0, 8
	.loc	1 967 26                        ; attention.py:967:26
	v_cndmask_b32_e64 v81, 0xff800000, v81, s6
	v_cndmask_b32_e64 v80, 0xff800000, v80, s7
	v_cndmask_b32_e64 v88, 0xff800000, v79, s3
	v_cndmask_b32_e64 v89, 0xff800000, v78, s5
	v_cndmask_b32_e64 v83, 0xff800000, v83, s9
	...
	v_or_b16 v76.h, v54.h, -16
	.loc	1 989 38                        ; attention.py:989:38
	v_cmp_lt_u16_e64 s11, 7, v73.h
	.loc	1 986 76                        ; attention.py:986:76
	v_and_b16 v72.l, v115.h, 15
	.loc	1 988 32                        ; attention.py:988:32
	v_lshrrev_b32_e32 v110, 20, v115
	v_lshrrev_b16 v72.h, 4, v106.l
	v_lshrrev_b16 v76.l, 4, v109.l
	.loc	1 990 39                        ; attention.py:990:39
	v_mov_b16_e32 v77.l, v85.l
	v_mov_b16_e32 v78.l, v86.l
	v_mov_b16_e32 v79.l, v87.l
	.loc	1 989 29                        ; attention.py:989:29
	v_or_b16 v73.l, v54.l, v73.l
.Ltmp1:
	.file	2 "<triton>/python/triton/language" "standard.py"
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max_f32_e32 v85, v89, v88
.Ltmp2:
	.loc	1 990 30                        ; attention.py:990:30
	v_cndmask_b16 v86.l, v54.h, v76.h, s13
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max3_f32 v87, v82, v84, v83
	v_max3_f32 v91, v90, v80, v81
.Ltmp4:
	.loc	1 989 29                        ; attention.py:989:29
	v_cndmask_b16 v54.h, 0, -16, s11
	...
	.loc	1 986 76                        ; attention.py:986:76
	v_and_b16 v74.h, v109.l, 15
	.loc	1 988 32                        ; attention.py:988:32
	v_and_b16 v72.h, v72.h, 15
	.loc	1 990 56                        ; attention.py:990:56
	v_or_b16 v79.h, v76.l, -16
	.loc	1 990 39 is_stmt 0              ; attention.py:990:39
	v_cmp_gt_i16_e64 s14, 0, v78.l
	v_cmp_gt_i16_e64 s11, 0, v79.l
.Ltmp5:
	.loc	2 170 12 is_stmt 1              ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max3_f32 v85, v87, v91, v85
.Ltmp6:
	.loc	1 989 29                        ; attention.py:989:29
	v_or_b16 v78.l, v73.h, v54.h
	...
	v_or_b16 v54.l, v72.h, -16
	.loc	1 990 30                        ; attention.py:990:30
	v_cndmask_b16 v76.l, v76.l, v79.h, s11
	.loc	1 1017 31 is_stmt 1             ; attention.py:1017:31
	v_cvt_f32_i32_e32 v73, v73
	v_cvt_f32_i32_e32 v79, v86
.Ltmp7:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:968:29 ]
	v_permlanex16_b32 v86, v85, s45, 0xfedcba98 op_sel:[1,0]
.Ltmp8:
	.loc	1 989 29                        ; attention.py:989:29
	...
	v_cndmask_b16 v54.l, v72.h, v54.l, s13
	.loc	1 1017 31                       ; attention.py:1017:31
	v_mul_f32_e32 v73, v75, v73
	v_mul_f32_e32 v75, v75, v79
	.loc	1 969 24                        ; attention.py:969:24
	v_max3_f32 v79, v0, v85, v86
	.loc	1 989 29                        ; attention.py:989:29
	...
	v_sub_f32_e32 v86, v88, v79
	.loc	1 970 74                        ; attention.py:970:74
	v_sub_f32_e32 v88, v0, v79
	.loc	1 1017 31                       ; attention.py:1017:31
	...
	v_dual_mul_f32 v74, v96, v74 :: v_dual_sub_f32 v83, v83, v79
	.loc	1 971 62                        ; attention.py:971:62
	v_sub_f32_e32 v85, v90, v79
	.loc	1 1017 31                       ; attention.py:1017:31
	v_cvt_f32_i32_e32 v72, v72
	v_dual_mul_f32 v54, v107, v54 :: v_dual_sub_f32 v81, v81, v79
	v_mul_f32_e32 v77, v96, v77
	v_cvt_f32_i32_e32 v76, v76
	v_dual_mul_f32 v78, v107, v78 :: v_dual_sub_f32 v87, v89, v79
	.loc	1 1017 30 is_stmt 0             ; attention.py:1017:30
	v_mov_b16_e32 v92.l, v73.h
	...
	v_mov_b16_e32 v98.l, v74.h
	v_mov_b16_e32 v99.l, v76.h
	v_add3_u32 v73, v73, v89, 0x7fff
	v_and_b32_e32 v89, 1, v95
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v94, 0, v85, s8
	v_cndmask_b32_e64 v95, 0, v83, s9
	.loc	1 1017 30                       ; attention.py:1017:30
	v_and_b32_e32 v90, 1, v93
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v19, v19, v113 :: v_dual_and_b32 v92, 1, v100
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v26, v26, v113 :: v_dual_and_b32 v91, 1, v99
	.loc	1 1017 30                       ; attention.py:1017:30
...
.Ltmp10:
	.loc	1 1017 30                       ; attention.py:1017:30
	v_add3_u32 v75, v75, v90, 0x7fff
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v17, v17, v113 :: v_dual_and_b32 v90, 1, v98
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_cndmask_b32_e64 v93, 0, v82, s1
	v_cndmask_b32_e64 v96, 0, v81, s6
	v_cndmask_b32_e64 v97, 0, v80, s7
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cmp_o_f32_e64 s16, v74, v74
	v_cmp_o_f32_e64 s17, v76, v76
	v_cndmask_b16 v75.l, 0x7fff, v73.h, s11
	v_add3_u32 v73, v74, v90, 0x7fff
	v_add3_u32 v74, v76, v91, 0x7fff
	.loc	1 971 49                        ; attention.py:971:49
	v_exp_f32_e32 v87, v87
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cndmask_b16 v75.h, 0x7fff, v75.h, s12
	v_cndmask_b16 v76.h, 0x7fff, v54.h, s14
	v_cndmask_b16 v76.l, 0x7fff, v78.h, s15
	.loc	1 1019 30                       ; attention.py:1019:30
	v_mov_b16_e32 v101.l, v92.h
	v_mov_b16_e32 v102.l, v93.h
	v_mov_b16_e32 v103.l, v94.h
	v_mov_b16_e32 v104.l, v95.h
	v_mov_b16_e32 v105.l, v96.h
	v_mov_b16_e32 v116.l, v97.h
	.loc	1 1018 23                       ; attention.py:1018:23
	v_mul_f32_e32 v29, v29, v113
	.loc	1 971 49                        ; attention.py:971:49
	v_exp_f32_e32 v86, v86
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cndmask_b16 v54.l, 0x7fff, v77.h, s13
	v_cndmask_b16 v54.h, 0x7fff, v73.h, s16
	v_cndmask_b16 v73.h, 0x7fff, v74.h, s17
	...
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v65, v75, v76 offset1:8
	ds_store_2addr_b32 v65, v54, v73 offset0:16 offset1:24
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v98, 0, v86, s3
	v_cndmask_b32_e64 v99, 0, v87, s5
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v23, v23, v113 :: v_dual_add_f32 v88, v93, v92
	v_dual_mul_f32 v11, v11, v113 :: v_dual_add_f32 v100, v97, v96
	.loc	1 1019 30                       ; attention.py:1019:30
	v_add3_u32 v54, v92, v54, 0x7fff
	v_add3_u32 v92, v93, v101, 0x7fff
	v_add3_u32 v93, v94, v102, 0x7fff
	v_add3_u32 v94, v95, v103, 0x7fff
	v_add3_u32 v95, v96, v104, 0x7fff
	v_add3_u32 v96, v97, v105, 0x7fff
	v_mov_b16_e32 v117.l, v98.h
	v_mov_b16_e32 v118.l, v99.h
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v21, v21, v113 :: v_dual_add_f32 v106, v99, v98
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v54.h, 0x7fff, v54.h, s1
	v_cndmask_b16 v54.l, 0x7fff, v92.h, s3
	v_cndmask_b16 v92.h, 0x7fff, v93.h, s5
	v_cndmask_b16 v92.l, 0x7fff, v94.h, s6
	v_cndmask_b16 v93.h, 0x7fff, v95.h, s7
	v_cndmask_b16 v93.l, 0x7fff, v96.h, s8
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v13, v13, v113 :: v_dual_and_b32 v108, 1, v118
	v_dual_mul_f32 v15, v15, v113 :: v_dual_add_f32 v100, v100, v106
	.loc	1 1019 30                       ; attention.py:1019:30
	v_and_b32_e32 v107, 1, v117
.Ltmp11:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_add_f32_e32 v109, v88, v89
.Ltmp12:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v94, v54, s45, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v95, v92, s45, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v101, v93, s45, 0xfedcba98 op_sel:[1,0]
	v_cmp_o_f32_e64 s9, v98, v98
	v_cmp_o_f32_e64 s10, v99, v99
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v3, v3, v113 :: v_dual_add_f32 v114, v109, v100
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_add3_u32 v102, v98, v107, 0x7fff
	v_add3_u32 v103, v99, v108, 0x7fff
	v_perm_b32 v96, v94, v54, v51
	v_perm_b32 v97, v94, v54, v53
	v_perm_b32 v98, v95, v92, v51
	v_perm_b32 v99, v95, v92, v53
	v_perm_b32 v100, v101, v93, v51
	v_perm_b32 v101, v101, v93, v53
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_load_b128 v[104:107], v66 offset:1536
	ds_load_b128 v[92:95], v67 offset:1024
	ds_load_b128 v[108:111], v67 offset:1536
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v115.h, 0x7fff, v102.h, s9
	v_cndmask_b16 v115.l, 0x7fff, v103.h, s10
.Ltmp13:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_permlanex16_b32 v54, v114, s45, 0xfedcba98 op_sel:[1,0]
.Ltmp14:
	.loc	1 1018 23                       ; attention.py:1018:23
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v103, v115, s45, 0xfedcba98 op_sel:[1,0]
	.loc	1 1018 23                       ; attention.py:1018:23
	...
	v_dual_mul_f32 v1, v1, v113 :: v_dual_add_f32 v54, v114, v54
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_perm_b32 v102, v103, v115, v51
	v_perm_b32 v103, v103, v115, v53
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 119
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 46
