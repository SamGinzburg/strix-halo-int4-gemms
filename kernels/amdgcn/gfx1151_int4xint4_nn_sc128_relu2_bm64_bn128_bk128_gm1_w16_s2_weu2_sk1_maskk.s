...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x5
	buffer_load_u16 v81, v51, s[36:39], 0 offen
	buffer_load_u16 v82, v51, s[36:39], 0 offen offset:4
	buffer_load_u16 v83, v51, s[36:39], 0 offen offset:8
	buffer_load_u16 v84, v51, s[36:39], 0 offen offset:12
	buffer_load_u16 v85, v51, s[36:39], 0 offen offset:16
	buffer_load_u16 v86, v51, s[36:39], 0 offen offset:20
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x1
	buffer_load_u16 v87, v51, s[36:39], 0 offen offset:24
	buffer_load_u16 v88, v51, s[36:39], 0 offen offset:28
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	...
	v_fmac_f32_e32 v25, v51, v73
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v54, v54, v70 :: v_dual_lshlrev_b32 v71, 16, v80
	...
	v_dual_mul_f32 v61, v61, v71 :: v_dual_lshlrev_b32 v78, 16, v85
	v_dual_mul_f32 v62, v62, v71 :: v_dual_lshlrev_b32 v79, 16, v86
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v23, v53, v77 :: v_dual_lshlrev_b32 v80, 16, v87
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v64, v64, v71 :: v_dual_lshlrev_b32 v81, 16, v88
	v_mul_f32_e32 v58, v58, v71
	v_mul_f32_e32 v59, v59, v71
	v_mul_f32_e32 v60, v60, v71
	v_dual_mul_f32 v63, v63, v71 :: v_dual_fmac_f32 v10, v50, v72
	v_dual_mul_f32 v65, v65, v71 :: v_dual_fmac_f32 v24, v52, v76
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v22, v54, v78 :: v_dual_fmac_f32 v21, v55, v79
	v_dual_fmac_f32 v20, v56, v80 :: v_dual_fmac_f32 v19, v57, v81
	v_dual_fmac_f32 v18, v58, v72 :: v_dual_fmac_f32 v17, v59, v73
	v_dual_fmac_f32 v16, v60, v76 :: v_dual_fmac_f32 v15, v61, v77
	v_dual_fmac_f32 v14, v62, v78 :: v_dual_fmac_f32 v13, v63, v79
	v_dual_fmac_f32 v12, v64, v80 :: v_dual_fmac_f32 v11, v65, v81
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
...
.LBB0_5:
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v33, v33, v31 :: v_dual_lshlrev_b32 v30, 16, v30
	...
	v_dual_mul_f32 v36, v36, v30 :: v_dual_mul_f32 v35, v35, v31
	v_dual_mul_f32 v30, v38, v30 :: v_dual_mul_f32 v37, v37, v31
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v32, v33, v42, v14
	v_fma_f32 v33, v35, v43, v13
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	s_waitcnt vmcnt(0)
	v_dual_max_f32 v5, v5, v5 :: v_dual_lshlrev_b32 v28, 16, v28
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v10, v21, v34, s2
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v35, v37, v44, v12
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_dual_max_f32 v16, v19, v19 :: v_dual_max_f32 v9, 0, v9
	...
	v_dual_max_f32 v6, v6, v6 :: v_dual_mul_f32 v7, v7, v7
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v17, 1, v49
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v14, v14, v14 :: v_dual_max_f32 v3, 0, v3
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 44
