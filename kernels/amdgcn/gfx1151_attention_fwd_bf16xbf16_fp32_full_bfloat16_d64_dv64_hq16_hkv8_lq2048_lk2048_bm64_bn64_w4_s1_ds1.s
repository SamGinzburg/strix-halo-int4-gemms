...
.Ltmp8:
	...
	v_permlanex16_b32 v98, v97, s98, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp9:
...
.Ltmp57:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v68, v100, s98, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp61:
	...
	v_add_lshl_u32 v131, s83, v135, 1
...
.Ltmp72:
	...
	v_add_lshl_u32 v127, s83, v136, 1
	.loc	1 886 33                        ; attention.py:886:33
...
.Ltmp86:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v99, v68, s98, 0xfedcba98 op_sel:[1,0]
	...
	.loc	1 890 30 is_stmt 1              ; attention.py:890:30
	v_add_lshl_u32 v134, s83, v191, 1
	s_delay_alu instid0(VALU_DEP_3)
...
.Ltmp90:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v107, 1, v107
	v_permlanex16_b32 v124, v119, s98, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 886 33                        ; attention.py:886:33
...
.Ltmp98:
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v132, s83, v189, 1
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp102:
	...
	v_exp_f32_e32 v71, v71
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v91, v117, s98, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_2)
...
.Ltmp115:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v72, v110, s98, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v94, v98, s98, 0xfedcba98 op_sel:[1,0]
...
.Ltmp119:
	...
	v_permlanex16_b32 v94, v106, s98, 0xfedcba98 op_sel:[1,0]
...
.Ltmp121:
	...
	v_permlanex16_b32 v98, v107, s98, 0xfedcba98 op_sel:[1,0]
.Ltmp122:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 252
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 0
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 0
