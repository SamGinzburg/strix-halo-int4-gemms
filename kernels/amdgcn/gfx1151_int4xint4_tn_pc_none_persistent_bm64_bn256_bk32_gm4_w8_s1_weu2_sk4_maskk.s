...
.Ltmp13:
	...
	s_cvt_f32_u32 s7, s68
	v_and_or_b32 v75, 0xe000, v14, v10
	v_or3_b32 v76, v12, v11, v9
	...
	v_xor_b32_e32 v10, 0x2010, v76
	v_xor_b32_e32 v11, 0x4020, v76
	v_readfirstlane_b32 s7, v17
.Ltmp14:
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mul_lo_u32 v17, s21, v2
	v_mul_lo_u32 v2, s20, v2
	v_xor_b32_e32 v12, 0x6030, v76
	v_xor_b32_e32 v13, 0x8040, v76
	s_mul_f32 s7, s7, 0x4f7ffffe
	v_xor_b32_e32 v14, 0xa050, v76
	v_xor_b32_e32 v15, 0xc060, v76
	v_xor_b32_e32 v16, 0xe070, v76
	s_cvt_u32_f32 s7, s7
	s_mov_b32 s16, s10
	s_sub_i32 s10, 0, s68
	.loc	1 221 36                        ; generate_amdgcn.py:221:36
	...
	v_lshl_add_u32 v77, v69, 4, v17
	v_lshl_add_u32 v78, v69, 2, v2
	v_add_nc_u32_e32 v79, 0, v3
	v_add_nc_u32_e32 v80, 0, v4
	v_add_nc_u32_e32 v81, 0, v5
	v_add_nc_u32_e32 v82, v73, v6
	v_add_nc_u32_e32 v83, v8, v7
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s6, s94, s18
	s_mul_hi_u32 s10, s19, s10
	s_ashr_i32 s6, s6, 31
	s_mul_i32 s95, s10, s7
	v_dual_mov_b32 v102, 0 :: v_dual_mov_b32 v103, 0
	s_sub_i32 s19, s19, s95
	s_add_i32 s95, s10, 1
	s_sub_i32 s96, s19, s7
	s_cmp_ge_u32 s19, s7
	v_dual_mov_b32 v104, 0 :: v_dual_mov_b32 v105, 0
	s_cselect_b32 s10, s95, s10
	s_cselect_b32 s19, s96, s19
	s_add_i32 s95, s10, 1
	s_cmp_ge_u32 s19, s7
	v_dual_mov_b32 v106, 0 :: v_dual_mov_b32 v107, 0
	s_cselect_b32 s7, s95, s10
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_cndmask_b32 v67, 0x80000000, v65 :: v_dual_cndmask_b32 v68, 0x80000000, v66
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	v_add_nc_u32_e32 v65, s20, v65
	v_add_nc_u32_e32 v66, s93, v66
	s_cmp_lg_u32 s18, 0
	.loc	1 232 26                        ; generate_amdgcn.py:232:26
	buffer_load_b32 v67, v67, s[12:15], 0 offen
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v79, v67
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 240 27                        ; generate_amdgcn.py:240:27
	ds_load_u8 v67, v73 offset:192
	ds_load_u8 v68, v73 offset:128
	ds_load_u8 v97, v73 offset:208
	ds_load_u8 v98, v73 offset:144
	ds_load_u8 v99, v73 offset:224
	ds_load_u8 v100, v73 offset:160
	ds_load_u8 v101, v73 offset:240
	ds_load_u8 v102, v73 offset:176
	ds_load_u8 v103, v73 offset:448
	ds_load_u8 v104, v73 offset:384
	ds_load_u8 v105, v73 offset:464
	ds_load_u8 v106, v73 offset:400
	ds_load_u8 v107, v73 offset:480
	ds_load_u8 v108, v73 offset:416
	ds_load_u8 v109, v73 offset:496
	ds_load_u8 v110, v73 offset:432
	ds_load_u8 v111, v73 offset:320
	ds_load_u8 v112, v73 offset:256
	ds_load_u8 v113, v73 offset:336
	ds_load_u8 v114, v73 offset:272
	ds_load_u8 v115, v73 offset:352
	ds_load_u8 v116, v73 offset:288
	ds_load_u8 v117, v73 offset:368
	ds_load_u8 v118, v73 offset:304
	ds_load_u8 v119, v73 offset:64
	ds_load_u8 v120, v73 offset:80
	ds_load_u8 v121, v73 offset:96
	ds_load_u8 v122, v73 offset:112
	ds_load_u8 v123, v73
	ds_load_u8 v124, v73 offset:16
	ds_load_u8 v125, v73 offset:32
	ds_load_u8 v126, v73 offset:48
	ds_load_u8 v127, v73 offset:960
	ds_load_u8 v128, v73 offset:896
	ds_load_u8 v129, v73 offset:976
	ds_load_u8 v130, v73 offset:912
	ds_load_u8 v131, v73 offset:992
	ds_load_u8 v132, v73 offset:928
	ds_load_u8 v133, v80
	ds_load_u8 v134, v73 offset:944
	ds_load_u8 v135, v73 offset:832
	ds_load_u8 v136, v73 offset:768
	ds_load_u8 v137, v73 offset:848
	ds_load_u8 v138, v73 offset:784
	ds_load_u8 v139, v73 offset:864
	ds_load_u8 v140, v73 offset:800
	ds_load_u8 v141, v73 offset:880
	ds_load_u8 v142, v73 offset:816
	ds_load_u8 v143, v73 offset:704
	ds_load_u8 v144, v73 offset:640
	ds_load_u8 v145, v73 offset:720
	ds_load_u8 v146, v73 offset:656
	ds_load_u8 v147, v73 offset:736
	ds_load_u8 v148, v73 offset:672
	ds_load_u8 v149, v73 offset:752
	ds_load_u8 v150, v73 offset:688
	ds_load_u8 v151, v73 offset:576
	ds_load_u8 v152, v73 offset:512
	ds_load_u8 v153, v73 offset:592
	ds_load_u8 v154, v73 offset:528
	ds_load_u8 v155, v73 offset:608
	ds_load_u8 v156, v73 offset:544
	ds_load_u8 v157, v73 offset:624
	ds_load_u8 v158, v73 offset:560
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	s_barrier
	.loc	1 240 27                        ; generate_amdgcn.py:240:27
	ds_load_u8 v93, v82 offset:1280
	ds_load_u8 v94, v82 offset:1024
	ds_load_u8 v95, v82 offset:1792
	ds_load_u8 v96, v82 offset:1536
	ds_load_u8 v159, v82 offset:1920
	ds_load_u8 v160, v82 offset:1664
	ds_load_u8 v161, v82 offset:1408
	ds_load_u8 v162, v82 offset:1152
	ds_load_u8 v163, v82 offset:256
	ds_load_u8 v164, v82
	ds_load_u8 v165, v82 offset:768
	ds_load_u8 v166, v82 offset:512
	ds_load_u8 v167, v82 offset:896
	ds_load_u8 v168, v82 offset:640
	ds_load_u8 v169, v82 offset:384
	ds_load_u8 v170, v82 offset:128
	ds_load_u8 v171, v82 offset:3328
	ds_load_u8 v172, v82 offset:3072
	ds_load_u8 v173, v82 offset:3840
	ds_load_u8 v174, v82 offset:3584
	ds_load_u8 v175, v82 offset:3968
	ds_load_u8 v176, v82 offset:3712
	ds_load_u8 v177, v82 offset:3456
	ds_load_u8 v178, v82 offset:3200
	ds_load_u8 v179, v82 offset:2304
	ds_load_u8 v180, v82 offset:2048
	ds_load_u8 v181, v82 offset:2816
	ds_load_u8 v182, v82 offset:2560
	ds_load_u8 v183, v82 offset:2944
	ds_load_u8 v184, v82 offset:2688
	ds_load_u8 v185, v82 offset:2432
	ds_load_u8 v186, v82 offset:2176
	...
	v_perm_b32 v127, v144, v143, 0xc0c0004
	...
	v_lshl_or_b32 v68, v103, 16, v111
	s_waitcnt lgkmcnt(30)
	v_perm_b32 v111, v94, v93, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v131, v96, v95, 0xc0c0004
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v132, v164, v163, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v133, v166, v165, 0xc0c0004
	v_lshl_or_b32 v94, v119, 16, v112
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v112, v172, v171, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v119, v174, v173, 0xc0c0004
	...
	v_perm_b32 v125, v156, v155, 0xc0c0004
	...
	v_lshl_or_b32 v67, v67, 16, v104
	v_lshl_or_b32 v93, v127, 16, v123
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v123, v180, v179, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	...
	v_lshl_or_b32 v108, v131, 16, v111
	v_lshl_or_b32 v107, v133, 16, v132
	v_lshl_or_b32 v110, v119, 16, v112
	v_lshl_or_b32 v112, v135, 16, v134
	v_lshl_or_b32 v111, v137, 16, v136
	v_lshl_or_b32 v98, v114, 16, v98
	v_lshl_or_b32 v97, v124, 16, v120
	v_lshl_or_b32 v102, v121, 16, v116
	v_lshl_or_b32 v101, v128, 16, v125
	v_lshl_or_b32 v105, v126, 16, v122
	v_lshl_or_b32 v106, v130, 16, v129
	v_lshl_or_b32 v109, v127, 16, v123
	v_lshl_or_b32 v114, v139, 16, v138
	v_lshl_or_b32 v113, v141, 16, v140
	v_wmma_i32_16x16x16_iu4 v[1:8], v[107:108], v[67:68], v[1:8] neg_lo:[1,1,0]
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v34, s94, v69
	v_or_b32_e32 v35, s94, v70
	v_or_b32_e32 v36, s94, v71
	v_or_b32_e32 v37, s94, v72
	...
	v_dual_mul_f32 v140, v149, v67 :: v_dual_mul_f32 v35, v150, v32
	...
	v_dual_mul_f32 v136, v148, v68 :: v_dual_mul_f32 v39, v151, v31
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn256_bk32_gm4_w8_s1_weu2_sk4_maskk.num_vgpr, 187
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn256_bk32_gm4_w8_s1_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn256_bk32_gm4_w8_s1_weu2_sk4_maskk.numbered_sgpr, 97
