...
.LBB0_3:                                ; %Flow169
	...
	v_dual_mov_b32 v35, 0 :: v_dual_and_b32 v36, 24, v3
...
; %bb.4:                                ; %.preheader.lr.ph
	v_dual_mov_b32 v66, 0 :: v_dual_and_b32 v5, 32, v0
	...
	v_or3_b32 v70, v4, v6, s33
	v_or_b32_e32 v6, s33, v7
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v4, s35, v3
	s_cmpk_lt_i32 s3, 0x80
	v_dual_mov_b32 v62, 0 :: v_dual_and_b32 v9, 24, v9
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v65, 0 :: v_dual_and_b32 v4, 16, v6
	v_dual_mov_b32 v63, 0 :: v_dual_add_nc_u32 v10, s34, v3
	v_dual_mov_b32 v67, 0 :: v_dual_lshlrev_b32 v8, 3, v0
	v_lshl_or_b32 v2, v2, 5, v9
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[33:34], null, v10, s44, v[4:5]
	v_dual_mov_b32 v61, 0 :: v_dual_and_b32 v4, 24, v0
	.loc	1 1520 37                       ; ragged.py:1520:37
	s_mul_i32 s22, s20, s45
	.loc	1 1433 43                       ; ragged.py:1433:43
	s_mul_i32 s20, s20, s23
	v_dual_mov_b32 v64, 0 :: v_dual_and_b32 v3, 24, v8
	v_add3_u32 v7, s33, s20, v7
	v_xor_b32_e32 v4, v6, v4
	v_lshl_or_b32 v1, v1, 3, v2
	v_lshl_or_b32 v2, v5, 4, v2
	v_dual_mov_b32 v60, 0 :: v_dual_add_nc_u32 v9, s34, v42
	v_dual_mov_b32 v59, 0 :: v_dual_add_nc_u32 v10, s34, v41
	.loc	1 1310 18                       ; ragged.py:1310:18
	...
	v_or_b32_e32 v79, 34, v70
	v_or_b32_e32 v80, 36, v70
	v_or_b32_e32 v81, 38, v70
	v_or_b32_e32 v82, 40, v70
	v_or_b32_e32 v83, 42, v70
	v_or_b32_e32 v84, 44, v70
	v_or_b32_e32 v85, 46, v70
	v_mad_u64_u32 v[34:35], null, v7, s44, v[3:4]
	v_xor_b32_e32 v3, 8, v4
	v_xor_b32_e32 v6, 8, v1
	v_xor_b32_e32 v7, 16, v1
	v_xor_b32_e32 v5, 24, v1
	v_xor_b32_e32 v8, v8, v36
	v_xor_b32_e32 v11, 8, v2
	v_xor_b32_e32 v12, 16, v2
	v_xor_b32_e32 v13, 24, v2
	v_mul_lo_u32 v86, v9, s45
	v_cndmask_b32_e64 v9, 0, 1, s46
	v_mul_lo_u32 v87, v10, s45
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s4, s23, v70
	v_cmp_gt_i32_e64 s5, s23, v71
	v_cmp_gt_i32_e64 s6, s23, v72
	v_cmp_gt_i32_e64 s7, s23, v73
	v_cmp_gt_i32_e64 s8, s23, v74
	v_cmp_gt_i32_e64 s9, s23, v75
	v_cmp_gt_i32_e64 s10, s23, v76
	v_cmp_gt_i32_e64 s11, s23, v77
	v_cmp_gt_i32_e64 s12, s23, v78
	v_cmp_gt_i32_e64 s13, s23, v79
	v_cmp_gt_i32_e64 s14, s23, v80
	v_cmp_gt_i32_e64 s15, s23, v81
	v_cmp_gt_i32_e64 s16, s23, v82
	v_cmp_gt_i32_e64 s17, s23, v83
	v_cmp_gt_i32_e64 s18, s23, v84
	v_cmp_gt_i32_e64 s19, s23, v85
	v_cmp_ne_u32_e64 s20, 1, v9
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v88, 0, v4
	v_dual_mov_b32 v58, 0 :: v_dual_add_nc_u32 v89, 0, v3
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v90, 0, v1
	v_dual_mov_b32 v56, 0 :: v_dual_add_nc_u32 v91, 0, v6
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v92, 0, v7
	v_dual_mov_b32 v54, 0 :: v_dual_add_nc_u32 v93, 0, v5
	v_dual_mov_b32 v49, 0 :: v_dual_add_nc_u32 v94, 0, v8
	v_dual_mov_b32 v52, 0 :: v_dual_add_nc_u32 v95, 0, v2
	v_dual_mov_b32 v51, 0 :: v_dual_add_nc_u32 v96, 0, v11
	v_dual_mov_b32 v48, 0 :: v_dual_add_nc_u32 v97, 0, v12
	v_dual_mov_b32 v47, 0 :: v_dual_add_nc_u32 v98, 0, v13
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add_lshl_u32 v18, v87, s38, 1
	.loc	1 1520 25                       ; ragged.py:1520:25
	s_add_i32 s26, s38, s22
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	v_add_lshl_u32 v115, v84, s26, 1
	v_add_lshl_u32 v116, v85, s26, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	s_clause 0x1
	...
	v_cndmask_b32_e64 v115, 0x80000000, v115, s18
	v_cndmask_b32_e64 v116, 0x80000000, v116, s19
	s_clause 0xf
	...
	v_fmac_f32_e32 v69, v113, v20
	.loc	1 1517 21                       ; ragged.py:1517:21
	v_dual_mul_f32 v7, v7, v18 :: v_dual_fmac_f32 v66, v114, v19
	v_dual_mul_f32 v4, v4, v18 :: v_dual_fmac_f32 v65, v110, v23
	v_dual_mul_f32 v3, v3, v18 :: v_dual_fmac_f32 v68, v112, v21
	v_dual_mul_f32 v6, v6, v18 :: v_dual_fmac_f32 v63, v108, v25
	v_dual_mul_f32 v5, v5, v18 :: v_dual_fmac_f32 v52, v15, v19
	v_dual_mul_f32 v2, v2, v18 :: v_dual_fmac_f32 v59, v104, v29
	v_dual_mul_f32 v1, v1, v18 :: v_dual_fmac_f32 v50, v11, v21
	.loc	1 1525 17                       ; ragged.py:1525:17
	v_dual_fmac_f32 v67, v111, v22 :: v_dual_fmac_f32 v64, v109, v24
	v_dual_fmac_f32 v62, v107, v26 :: v_dual_fmac_f32 v61, v106, v27
	v_dual_fmac_f32 v60, v105, v28 :: v_dual_fmac_f32 v57, v102, v31
	v_dual_fmac_f32 v58, v103, v30 :: v_dual_fmac_f32 v55, v100, v115
	v_dual_fmac_f32 v56, v101, v32 :: v_dual_fmac_f32 v51, v12, v22
	v_dual_fmac_f32 v54, v17, v116 :: v_dual_fmac_f32 v47, v10, v26
	v_dual_fmac_f32 v53, v16, v20 :: v_dual_fmac_f32 v48, v13, v23
	v_dual_fmac_f32 v49, v14, v24 :: v_dual_fmac_f32 v46, v9, v25
	v_dual_fmac_f32 v44, v7, v27 :: v_dual_fmac_f32 v45, v8, v28
	v_dual_fmac_f32 v40, v3, v29 :: v_dual_fmac_f32 v43, v4, v30
	v_dual_fmac_f32 v38, v5, v31 :: v_dual_fmac_f32 v39, v6, v32
	v_fmac_f32_e32 v37, v1, v115
	v_fmac_f32_e32 v35, v2, v116
	.loc	1 1421 19                       ; ragged.py:1421:19
...
.LBB0_8:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v99, s49, v33
	.loc	1 1437 46                       ; ragged.py:1437:46
	v_add_nc_u32_e32 v100, s49, v34
	...
	.loc	1 1437 38                       ; ragged.py:1437:38
	v_cndmask_b32_e64 v103, 0x80000000, v100, s1
	.loc	1 1436 38                       ; ragged.py:1436:38
	buffer_load_b128 v[99:102], v99, s[40:43], 0 offen
	.loc	1 1437 38                       ; ragged.py:1437:38
	buffer_load_b64 v[115:116], v103, s[24:27], 0 offen
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1448 25                       ; ragged.py:1448:25
	s_add_i32 s26, s48, 32
	.loc	1 1426 27                       ; ragged.py:1426:27
	s_cmpk_lt_i32 s48, 0x60
	s_mov_b32 s48, s26
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt vmcnt(1)
	ds_store_b64 v88, v[99:100]
	ds_store_b64 v89, v[101:102]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[99:102], v90 offset1:4
	ds_load_2addr_stride64_b64 v[103:106], v91 offset1:4
	ds_load_2addr_stride64_b64 v[107:110], v92 offset1:4
	ds_load_2addr_stride64_b64 v[111:114], v93 offset1:4
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v94, v[115:116]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[115:118], v95 offset1:2
	ds_load_2addr_stride64_b64 v[119:122], v96 offset1:2
	ds_load_2addr_stride64_b64 v[123:126], v97 offset1:2
	ds_load_2addr_stride64_b64 v[127:130], v98 offset1:2
	.loc	1 1438 35                       ; ragged.py:1438:35
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[115:116], v[99:100], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[117:118], v[99:100], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[115:116], v[101:102], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[117:118], v[101:102], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[119:120], v[103:104], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[121:122], v[103:104], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[119:120], v[105:106], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[121:122], v[105:106], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[123:124], v[107:108], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[125:126], v[107:108], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[123:124], v[109:110], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[125:126], v[109:110], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
...
.LBB0_10:                               ; %._crit_edge34
	...
	v_or_b32_e32 v5, 39, v36
	v_or_b32_e32 v9, 35, v36
	v_or_b32_e32 v10, 34, v36
	v_or_b32_e32 v6, 38, v36
	v_or_b32_e32 v13, 7, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v1, s33, v5
	v_or_b32_e32 v11, s33, v9
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v7, 37, v36
	v_or_b32_e32 v8, 36, v36
	.loc	1 1310 18                       ; ragged.py:1310:18
	...
	v_or_b32_e32 v12, 32, v36
	v_or_b32_e32 v14, 6, v36
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	...
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v16, 4, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v1, s33, v15
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v18, 2, v36
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	...
	.loc	1 1545 26                       ; ragged.py:1545:26
	v_mad_u64_u32 v[3:4], null, s23, v42, s[18:19]
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s16, s23, v2
	.loc	1 1545 17                       ; ragged.py:1545:17
	v_add3_u32 v4, v66, v1, 0x7fff
	.loc	1 1545 26 is_stmt 0             ; ragged.py:1545:26
	v_mad_u64_u32 v[1:2], null, s23, v41, s[18:19]
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	v_add3_u32 v26, v56, v27, 0x7fff
	v_cmp_o_f32_e64 s3, v56, v56
	v_add3_u32 v27, v55, v28, 0x7fff
	...
	v_add3_u32 v38, v35, v41, 0x7fff
	v_cmp_o_f32_e64 s18, v35, v35
	v_cndmask_b16 v35.h, 0x7fff, v40.h, s3
	...
	v_cndmask_b32_e64 v33, 0x3276, v37, s3
	...
	v_perm_b32 v28, v29, v37, v31
	v_perm_b32 v29, v29, v37, v33
	v_perm_b32 v37, v30, v32, v31
	...
	.loc	1 1545 17                       ; ragged.py:1545:17
	buffer_store_b16 v34, v50, s[36:39], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_evenk_bfloat16_scalar_bm128_bn64_bk64_w8_s3_sk1.num_vgpr, 131
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_evenk_bfloat16_scalar_bm128_bn64_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_evenk_bfloat16_scalar_bm128_bn64_bk64_w8_s3_sk1.numbered_sgpr, 50
