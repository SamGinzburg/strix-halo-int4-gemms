...
; %bb.4:                                ; %.lr.ph
	...
	v_bfe_i32 v2, v0, 5, 1
	v_bfe_i32 v5, v0, 3, 1
	v_add3_u32 v42, s8, v4, 0x200
	v_and_or_b32 v40, 0x1800, v8, v11
	v_add_nc_u32_e32 v6, 0x201, v3
	v_add_nc_u32_e32 v41, 0x200, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v21, v21, v56 :: v_dual_add_nc_u32 v42, 0x100, v42
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 212
