...
.Ltmp11:
	...
	s_mul_i32 s5, s2, s8
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v5, s11, v32
	.loc	1 322 28                        ; generate_amdgcn.py:322:28
	s_sub_i32 s5, s4, s5
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v6, s11, v33
	v_or_b32_e32 v7, s11, v34
...
.Ltmp13:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v26, s10, v31
	v_or_b32_e32 v27, s10, v30
	v_or_b32_e32 v28, s10, v32
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v37, s10, v33
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s6, s6, s4
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_add3_u32 v39, s12, s3, v11
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s3, s7, v27
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v38, s10, v34
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v40, s6, v9
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s4, s7, v28
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s5, s7, v37
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[2:5], v1, s[28:31], 0 offen
	buffer_load_b128 v[13:16], v6, s[28:31], 0 offen
	buffer_load_b128 v[17:20], v7, s[28:31], 0 offen
	buffer_load_b128 v[21:24], v8, s[28:31], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v6, v25, s[24:27], 0 offen
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v52, v1, s[24:27], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[25:28], v7, s[28:31], 0 offen
	buffer_load_b128 v[40:43], v8, s[28:31], 0 offen
	buffer_load_b128 v[44:47], v37, s[28:31], 0 offen
	buffer_load_b128 v[48:51], v38, s[28:31], 0 offen
...
.Ltmp14:
	...
	s_mov_b32 s14, s8
	s_mov_b32 s15, s8
	v_dual_mov_b32 v24, 0 :: v_dual_and_b32 v37, 0x70, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[40:41], null, s0, s18, v[11:12]
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	...
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s3, s7, v48
	v_cmp_gt_i32_e64 s4, s7, v49
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v118, v40, s[24:27], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[56:59], v41, s[28:31], 0 offen
	buffer_load_b128 v[60:63], v45, s[28:31], 0 offen
	buffer_load_b128 v[64:67], v46, s[28:31], 0 offen
	buffer_load_b128 v[68:71], v47, s[28:31], 0 offen
	...
	v_dual_add_f32 v22, v22, v46 :: v_dual_add_nc_u32 v117, s0, v39
...
.LBB0_11:
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v38, s[16:19], 0 offen
	buffer_store_b128 v[4:7], v38, s[16:19], 0 offen offset:256
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 250
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 38
