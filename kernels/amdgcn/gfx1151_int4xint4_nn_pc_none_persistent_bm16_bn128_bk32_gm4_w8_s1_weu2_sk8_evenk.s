	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph5
	...
	v_and_or_b32 v5, 0x88, v7, v5
	v_and_b32_e32 v7, 0x1040, v7
	v_and_b32_e32 v1, 0x7f, v0
	v_and_b32_e32 v9, 0x88, v4
...
.Ltmp12:
	...
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_or_b32_e32 v22, s0, v12
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_and_or_b32 v14, v12, 1, v3
	...
	v_mul_lo_u32 v1, s25, v22
	v_xor_b32_e32 v30, 8, v2
	s_delay_alu instid0(VALU_DEP_4)
	s_mul_f32 s6, s6, 0x4f7ffffe
	v_xor_b32_e32 v31, 12, v2
	v_xor_b32_e32 v32, 16, v2
	v_xor_b32_e32 v4, 20, v2
	v_xor_b32_e32 v34, 24, v2
	v_xor_b32_e32 v35, 28, v2
	v_xor_b32_e32 v37, 0x408, v0
	v_xor_b32_e32 v38, 0x810, v0
	v_xor_b32_e32 v39, 0xc18, v0
	v_xor_b32_e32 v40, 0x1040, v0
	v_xor_b32_e32 v41, 0x1448, v0
	v_xor_b32_e32 v42, 0x1850, v0
	v_xor_b32_e32 v43, 0x1c58, v0
	s_cvt_u32_f32 s6, s6
	...
	v_or_b32_e32 v19, 10, v14
	v_or_b32_e32 v20, 12, v14
	v_or_b32_e32 v21, 14, v14
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_lshl_add_u32 v22, v13, 3, v1
	v_or_b32_e32 v9, s0, v13
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v49, s6, v20
	v_or_b32_e32 v50, s6, v21
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	...
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v7, v4, v7 :: v_dual_lshlrev_b32 v50, 16, v50
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v7, v7, v11 :: v_dual_mul_f32 v48, v4, v48
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v47, 16, v47
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v49, v4, v49 :: v_dual_lshlrev_b32 v46, 16, v46
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_mul_f32_e32 v2, v48, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v47, v4, v47 :: v_dual_lshlrev_b32 v6, 16, v6
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v1, v49, v1 :: v_dual_mul_f32 v46, v4, v46
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v3, v47, v3 :: v_dual_mul_f32 v6, v4, v6
	v_dual_mul_f32 v10, v46, v10 :: v_dual_lshlrev_b32 v5, 16, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v6, v6, v44 :: v_dual_mul_f32 v5, v4, v5
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v4, v4, v50 :: v_dual_mul_f32 v5, v5, v45
	...
	ds_load_b32 v6, v42
	ds_load_b32 v7, v43
	v_add3_u32 v10, s40, s6, v8
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 305 13 is_stmt 1              ; generate_amdgcn.py:305:13
	v_lshlrev_b32_e32 v11, 2, v10
	v_add_lshl_u32 v44, v10, s28, 2
	v_add_lshl_u32 v46, v10, s30, 2
	v_add_lshl_u32 v45, v10, s29, 2
	v_add_lshl_u32 v47, v10, s31, 2
	v_add_lshl_u32 v48, v10, s33, 2
	v_add_lshl_u32 v49, v10, s34, 2
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v0, v11, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v1, v44, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v2, v45, s[12:15], 0 offen
	v_add_lshl_u32 v0, v10, s35, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v3, v46, s[12:15], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v4, v47, s[12:15], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v5, v48, s[12:15], 0 offen
	s_waitcnt lgkmcnt(1)
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v1, s7, 7, v22
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s40, v12
	s_lshl_b32 s6, s6, 7
	s_mov_b32 s42, s36
	v_subrev_nc_u32_e32 v44, s6, v1
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[10:11], null, s3, v2, v[9:10]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	buffer_load_u8 v11, v10, s[16:19], 0 offen
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b64 v[45:46], v44, s[4:7], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[47:48], v24
	ds_load_b64 v[49:50], v25
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v26, v[45:46]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 266 27                        ; generate_amdgcn.py:266:27
	ds_load_u8 v11, v27 offset:640
	ds_load_u8 v45, v27 offset:896
	ds_load_u8 v46, v27 offset:768
	ds_load_u8 v51, v27 offset:512
	ds_load_u8 v52, v27 offset:128
	ds_load_u8 v53, v27 offset:384
	ds_load_u8 v54, v27 offset:256
	ds_load_u8 v55, v27
	ds_load_u8 v56, v27 offset:1664
	ds_load_u8 v57, v27 offset:1920
	ds_load_u8 v58, v27 offset:1792
	ds_load_u8 v59, v27 offset:1536
	ds_load_u8 v60, v27 offset:1152
	ds_load_u8 v61, v27 offset:1280
	ds_load_u8 v62, v27 offset:1024
	ds_load_u8 v63, v27 offset:1408
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v45, v46, v45, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v11, v51, v11, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v51, v55, v52, 0xc0c0004
	v_perm_b32 v52, v54, v53, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v46, v45, 16, v11
	s_waitcnt lgkmcnt(5)
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[45:46], v[47:48], v[0:7] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v51, v56, 16, v55
	v_wmma_i32_16x16x16_iu4 v[0:7], v[51:52], v[49:50], v[0:7] neg_lo:[1,1,0]
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.Ltmp13:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.num_vgpr, 64
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_evenk.kd
