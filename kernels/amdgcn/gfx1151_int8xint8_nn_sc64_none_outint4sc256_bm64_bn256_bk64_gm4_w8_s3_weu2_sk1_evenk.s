...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_and_b32_e32 v0, 32, v214
	s_mov_b32 s10, 0
	v_and_or_b32 v104, 0x1c0, v8, v7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v33, v216, v127 :: v_dual_fmac_f32 v52, v211, v142
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_fmac_f32 v49, v209, v140 :: v_dual_fmac_f32 v62, v243, v151
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v25, v21, v24 offset1:16
	v_perm_b32 v21, v201, v28, 0x7060302
	v_perm_b32 v24, v201, v28, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v51, v210, v141 :: v_dual_fmac_f32 v66, v212, v155
	v_dual_fmac_f32 v55, v221, v144 :: v_dual_fmac_f32 v68, v214, v157
	v_dual_fmac_f32 v57, v223, v146 :: v_dual_fmac_f32 v64, v245, v153
...
; %bb.6:                                ; %Flow
	...
	v_and_b32_e32 v241, 8, v214
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v105, off offset:48
...
.LBB0_8:                                ; %Flow95
	...
	v_dual_mov_b32 v17, 0 :: v_dual_and_b32 v240, 6, v214
	v_cmp_eq_u32_e32 vcc_lo, 0, v241
	v_dual_mov_b32 v159, 0 :: v_dual_mov_b32 v242, 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v162, 0 :: v_dual_lshlrev_b32 v3, 3, v240
	...
	v_dual_mov_b32 v164, 0 :: v_dual_mov_b32 v11, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_mov_b32 v248, 0 :: v_dual_mov_b32 v13, 0
	v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v15, 0
	v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v251, 0
	v_dual_mov_b32 v14, 0 :: v_dual_mov_b32 v161, 0
	...
	v_dual_mov_b32 v142, 0 :: v_dual_mov_b32 v235, 0
	...
	v_dual_mov_b32 v118, 0 :: v_dual_mov_b32 v239, 0
	v_dual_mov_b32 v158, 0 :: v_dual_mov_b32 v151, 0
	v_dual_mov_b32 v152, 0 :: v_dual_mov_b32 v243, 0
...
; %bb.9:
	...
	v_cvt_f32_i32_e32 v238, v117
	v_cvt_f32_i32_e32 v15, v118
	v_cvt_f32_i32_e32 v251, v119
	v_cvt_f32_i32_e32 v16, v120
	v_cvt_f32_i32_e32 v161, v121
	v_cvt_f32_i32_e32 v157, v122
...
.LBB0_10:
	...
	buffer_load_u16 v138, v3, s[8:11], 0 offen
	buffer_load_u16 v120, v4, s[8:11], 0 offen
	buffer_load_u16 v122, v5, s[8:11], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
...
; %bb.11:
	...
	v_dual_mov_b32 v156, v248 :: v_dual_add_nc_u32 v17, s45, v25
	v_dual_mov_b32 v137, v123 :: v_dual_add_nc_u32 v18, s45, v234
	v_dual_mov_b32 v129, v21 :: v_dual_add_nc_u32 v104, s1, v233
	v_dual_mov_b32 v133, v164 :: v_dual_add_nc_u32 v188, s45, v237
	v_mov_b32_e32 v155, v247
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	ds_load_b128 v[247:250], v17 offset:8192
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v252, off offset:52
	scratch_store_b32 off, v235, off offset:68
	v_dual_mov_b32 v123, v214 :: v_dual_mov_b32 v212, v251
	v_dual_mov_b32 v214, v253 :: v_dual_mov_b32 v213, v254
	...
	v_dual_mov_b32 v164, v116 :: v_dual_add_nc_u32 v211, s1, v232
	v_dual_mov_b32 v149, v159 :: v_dual_add_nc_u32 v116, s1, v231
	s_mov_b32 s12, 0
	...
	scratch_store_b32 off, v166, off offset:60
	scratch_store_b32 off, v242, off offset:76
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v230, s19 :: v_dual_mov_b32 v223, s12
	v_dual_mov_b32 v124, v162 :: v_dual_add_nc_u32 v189, s45, v236
	v_dual_mov_b32 v150, v190 :: v_dual_mov_b32 v229, s18
	v_dual_mov_b32 v154, v161 :: v_dual_mov_b32 v227, s16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[104:107], v116 offset:3072
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v228, s17 :: v_dual_mov_b32 v161, v112
	v_dual_mov_b32 v226, s15 :: v_dual_mov_b32 v171, v114
	v_mov_b32_e32 v162, v113
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[112:115], v116 offset:2048
	v_dual_mov_b32 v190, v117 :: v_dual_mov_b32 v45, v151
	s_waitcnt vmcnt(3)
	v_mov_b16_e32 v21.l, v0.l
	v_dual_mov_b32 v0, v98 :: v_dual_mov_b32 v151, v139
	v_mov_b32_e32 v98, v118
	v_dual_mov_b32 v166, v119 :: v_dual_mov_b32 v139, v126
	...
	s_waitcnt vmcnt(1)
	v_mov_b16_e32 v22.l, v120.l
	v_mov_b32_e32 v120, v23
	v_dual_mov_b32 v28, v125 :: v_dual_mov_b32 v23, v243
	v_mov_b32_e32 v125, v53
	v_dual_mov_b32 v53, v50 :: v_dual_mov_b32 v50, v47
	v_mov_b32_e32 v153, v141
	v_dual_mov_b32 v47, v46 :: v_dual_mov_b32 v46, v152
	v_mov_b32_e32 v152, v140
	v_dual_mov_b32 v140, v245 :: v_dual_mov_b32 v141, v246
	...
	v_dual_mov_b32 v254, v213 :: v_dual_mov_b32 v251, v212
	v_mov_b32_e32 v253, v214
	v_wmma_i32_16x16x16_iu8 v[223:230], v[247:250], v[104:107], v[223:230] neg_lo:[1,1,0]
	scratch_load_b32 v252, off, off offset:52 ; 4-byte Folded Reload
	s_waitcnt lgkmcnt(5)
	...
	v_dual_mov_b32 v112, v161 :: v_dual_mov_b32 v117, v190
	...
	v_dual_mov_b32 v214, v123 :: v_dual_mov_b32 v123, v137
	s_waitcnt lgkmcnt(0)
	...
	scratch_load_b32 v242, off, off offset:76
	scratch_load_b32 v166, off, off offset:60
	...
	scratch_load_b32 v235, off, off offset:68 ; 4-byte Folded Reload
	v_cvt_f32_i32_e32 v217, v241
	v_mov_b32_e32 v241, v158
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v171, off, off offset:72
	scratch_load_b32 v158, off, off offset:64
	v_dual_mov_b32 v118, v98 :: v_dual_and_b32 v249, 15, v214
	v_mov_b32_e32 v98, v0
	v_mov_b16_e32 v0.l, v21.l
	v_dual_mov_b32 v248, v156 :: v_dual_mov_b32 v247, v155
...
.Ltmp21:
	...
	s_mul_i32 s0, s1, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v18, v53, s1, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v19, v50, s0, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s0, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v24, v46, s1, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v25, v47, s1, 1
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v53, v53, v151, v93
	v_fma_f32 v103, v103, v158, v91
	...
	v_cndmask_b32_e64 v90, v96, v46, s3
	v_cndmask_b32_e64 v89, v89, v104, s3
	v_cndmask_b32_e64 v96, v85, v108, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v27, v27, v23, v97
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v94, v94, v50, s3
...
.Ltmp23:
	...
	v_fma_f32 v74, v134, v21, v56
	v_fma_f32 v21, v140, v238, v48
	v_fma_f32 v50, v114, v235, v79
	...
	v_cndmask_b32_e64 v50, v68, v109, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v53, v112, v132, v65
	v_fma_f32 v71, v118, v126, v59
	v_fma_f32 v72, v119, v165, v58
	v_fma_f32 v77, v137, v77, v52
	v_fma_f32 v78, v139, v78, v49
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v109, v65, v53, s3
	v_cndmask_b32_e64 v59, v59, v71, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v28, v8, v164, v36
	v_fma_f32 v111, v156, v190, v66
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v81, v81, v46, s3
	v_cndmask_b32_e64 v106, v69, v108, s3
	v_cndmask_b32_e64 v23, v29, v23, s3
	v_cndmask_b32_e64 v28, v36, v28, s3
	v_cndmask_b32_e64 v108, v66, v111, s3
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v25, 16, v25
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v56, v56, v74, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v5, v5, v45 :: v_dual_mul_f32 v126, v15, v24
	v_mul_f32_e32 v98, v13, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v73, v133, v160, v57
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v125, v14, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v22, v138, v251, v51
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v111, v15, v20
	v_mul_f32_e32 v124, v13, v24
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v71, v57, v73, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v57, v3, v242, v31
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v22, v51, v22, s3
	v_cndmask_b32_e64 v51, v49, v78, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v49, v6, v245, v34
	v_fma_f32 v124, v124, v210, v143
	v_fma_f32 v125, v125, v211, v142
	v_fma_f32 v126, v126, v212, v141
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v31, v31, v57, s3
	v_cndmask_b32_e64 v34, v34, v49, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	s_waitcnt vmcnt(0)
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v84, v11, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v68, v115, v123, v62
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v85, v12, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v152, v171, v70
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v82, v9, v20
	v_mul_f32_e32 v123, v12, v24
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v62, v62, v68, s3
	v_cndmask_b32_e64 v68, v58, v72, s3
	v_cndmask_b32_e64 v72, v52, v77, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v5, v244, v33
	v_fma_f32 v58, v2, v162, v30
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v99 offset:40960
	ds_load_b128 v[5:8], v99 offset:40976
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v70, v117, v127, v60
	v_fma_f32 v76, v136, v161, v54
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v30, v30, v58, s3
	v_cndmask_b32_e64 v33, v33, v52, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v58, v9, v18
	v_mul_f32_e32 v65, v12, v18
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v54, v54, v76, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v83, v10, v20
	v_mul_f32_e32 v99, v14, v20
	v_mul_f32_e32 v120, v9, v24
	v_mul_f32_e32 v121, v10, v24
	v_dual_mul_f32 v122, v11, v24 :: v_dual_mul_f32 v9, v9, v25
	v_mul_f32_e32 v12, v12, v25
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v129, v83, v191, v59
	v_fma_f32 v98, v98, v194, v62
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v29, v1, v18
	v_mul_f32_e32 v36, v2, v18
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v80, v8, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v66, v113, v131, v64
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v112, v1, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v75, v135, v157, v55
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v115, v4, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v67, v114, v130, v63
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v117, v6, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v69, v116, v128, v61
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v64, v64, v66, s3
	v_cndmask_b32_e64 v55, v55, v75, s3
	v_cndmask_b32_e64 v110, v63, v67, s3
	v_cndmask_b32_e64 v67, v60, v70, s3
	v_cndmask_b32_e64 v61, v61, v69, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v44, v3, v18
	v_mul_f32_e32 v48, v4, v18
	v_mul_f32_e32 v49, v5, v18
	v_mul_f32_e32 v52, v6, v18
	v_mul_f32_e32 v53, v7, v18
	v_mul_f32_e32 v57, v8, v18
	v_mul_f32_e32 v60, v10, v18
	v_mul_f32_e32 v63, v11, v18
	v_mul_f32_e32 v66, v13, v18
	v_mul_f32_e32 v69, v14, v18
	v_mul_f32_e32 v70, v15, v18
	v_dual_mul_f32 v18, v16, v18 :: v_dual_mul_f32 v73, v1, v20
	v_mul_f32_e32 v74, v2, v20
	v_mul_f32_e32 v75, v3, v20
	v_mul_f32_e32 v76, v4, v20
	v_mul_f32_e32 v77, v5, v20
	v_mul_f32_e32 v78, v6, v20
	v_mul_f32_e32 v79, v7, v20
	v_mul_f32_e32 v20, v16, v20
	v_mul_f32_e32 v113, v2, v24
	v_mul_f32_e32 v114, v3, v24
	v_mul_f32_e32 v116, v5, v24
	v_mul_f32_e32 v118, v7, v24
	v_mul_f32_e32 v119, v8, v24
	...
	v_fma_f32 v44, v49, v168, v33
	v_fma_f32 v49, v52, v169, v34
	v_fma_f32 v52, v53, v170, v35
	v_fma_f32 v53, v57, v172, v28
	v_fma_f32 v57, v58, v173, v37
	v_fma_f32 v58, v60, v174, v38
	v_fma_f32 v60, v63, v175, v39
	v_fma_f32 v63, v65, v176, v40
	v_fma_f32 v65, v66, v177, v41
	v_fma_f32 v66, v69, v178, v42
	v_fma_f32 v69, v70, v179, v43
	v_fma_f32 v73, v73, v181, v21
	v_fma_f32 v74, v74, v182, v51
	v_fma_f32 v130, v84, v192, v67
	v_fma_f32 v131, v85, v193, v61
	v_fma_f32 v1, v1, v215, v103
	v_fma_f32 v2, v2, v216, v102
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v85, v23, v17, s2
	v_cndmask_b32_e64 v84, v30, v25, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v18, v18, v180, v19
	v_fma_f32 v76, v76, v184, v72
	v_fma_f32 v77, v77, v185, v54
	v_fma_f32 v100, v78, v186, v55
	v_fma_f32 v127, v80, v188, v71
	v_fma_f32 v128, v82, v189, v68
	v_fma_f32 v99, v99, v195, v110
	v_fma_f32 v111, v111, v196, v64
	v_fma_f32 v112, v112, v198, v108
	v_fma_f32 v113, v113, v199, v107
	v_fma_f32 v3, v3, v217, v97
	v_fma_f32 v4, v4, v218, v96
	v_fma_f32 v5, v5, v219, v86
	v_fma_f32 v6, v6, v220, v87
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v83, v32, v36, s2
	v_cndmask_b32_e64 v48, v33, v44, s2
	...
	v_cndmask_b32_e64 v73, v21, v73, s2
	v_cndmask_b32_e64 v74, v51, v74, s2
...
.Ltmp25:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v75, v75, v183, v22
	v_fma_f32 v101, v79, v187, v56
	v_fma_f32 v20, v20, v197, v109
	v_fma_f32 v115, v115, v201, v106
	v_fma_f32 v116, v116, v202, v46
	v_fma_f32 v117, v117, v203, v47
	v_fma_f32 v121, v121, v207, v146
	v_fma_f32 v122, v122, v208, v145
	v_fma_f32 v123, v123, v209, v144
	v_fma_f32 v10, v10, v224, v92
	v_fma_f32 v13, v13, v227, v95
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v82, v31, v29, s2
	v_cndmask_b32_e64 v70, v19, v18, s2
	v_cndmask_b32_e64 v79, v72, v76, s2
	v_cndmask_b32_e64 v80, v54, v77, s2
	v_cndmask_b32_e64 v77, v55, v100, s2
	v_cndmask_b32_e64 v76, v71, v127, s2
	v_cndmask_b32_e64 v71, v68, v128, s2
	v_cndmask_b32_e64 v72, v59, v129, s2
	v_cndmask_b32_e64 v67, v67, v130, s2
	v_cndmask_b32_e64 v68, v61, v131, s2
	v_cndmask_b32_e64 v61, v62, v98, s2
	v_cndmask_b32_e64 v62, v110, v99, s2
	v_cndmask_b32_e64 v59, v64, v111, s2
	v_cndmask_b32_e64 v54, v108, v112, s2
	v_cndmask_b32_e64 v55, v107, v113, s2
	v_cndmask_b32_e64 v33, v97, v3, s2
	v_cndmask_b32_e64 v31, v96, v4, s2
...
.Ltmp27:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v114, v114, v200, v50
	v_fma_f32 v118, v118, v204, v105
	v_fma_f32 v119, v119, v205, v104
	v_fma_f32 v120, v120, v206, v147
	v_fma_f32 v24, v24, v213, v81
	v_fma_f32 v7, v7, v221, v88
	v_fma_f32 v8, v8, v222, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v52, v35, v52, s2
	v_cndmask_b32_e64 v53, v28, v53, s2
	v_cndmask_b32_e64 v57, v37, v57, s2
	v_cndmask_b32_e64 v78, v22, v75, s2
	v_cndmask_b32_e64 v75, v56, v101, s2
	v_cndmask_b32_e64 v56, v109, v20, s2
	v_cndmask_b32_e64 v51, v106, v115, s2
	v_cndmask_b32_e64 v46, v46, v116, s2
	v_cndmask_b32_e64 v47, v47, v117, s2
	v_cndmask_b32_e64 v41, v146, v121, s2
	v_cndmask_b32_e64 v39, v145, v122, s2
	v_cndmask_b32_e64 v40, v144, v123, s2
	v_cndmask_b32_e64 v38, v143, v124, s2
	v_cndmask_b32_e64 v37, v142, v125, s2
	v_cndmask_b32_e64 v35, v141, v126, s2
	v_cndmask_b32_e64 v23, v92, v10, s2
...
.Ltmp29:
	...
	v_fma_f32 v132, v14, v228, v90
	v_fma_f32 v133, v15, v229, v27
	v_fma_f32 v134, v16, v230, v26
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v50, v50, v114, s2
	v_cndmask_b32_e64 v43, v105, v118, s2
	v_cndmask_b32_e64 v44, v104, v119, s2
	v_cndmask_b32_e64 v42, v147, v120, s2
	v_cndmask_b32_e64 v36, v81, v24, s2
...
.Ltmp31:
	...
	v_cndmask_b32_e64 v11, v90, v132, s2
	v_cndmask_b32_e64 v12, v27, v133, s2
.Ltmp32:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp33:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v13, v26, v134, s2
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp49:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v2, v17 :: v_dual_max_f32 v21, v20, v20
...
.Ltmp56:
	...
	v_max_f32_e32 v19, v19, v19
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_max_f32 v5, v5, v5 :: v_dual_max_f32 v2, v2, v19
	v_max_f32_e32 v5, v17, v5
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_max_f32 v17, v21, v18 :: v_dual_mov_b32 v20, v2
.Ltmp57:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp58:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v18, v18, v18 :: v_dual_max_f32 v19, v21, v21
.Ltmp59:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp60:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v24, v17, v19 :: v_dual_max_f32 v17, v20, v20
.Ltmp61:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp66:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v3, v25, v25 :: v_dual_max_f32 v2, v19, v19
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_max_f32 v19, v5, v2 :: v_dual_add_nc_u32 v2, 0, v252
	v_dual_max_f32 v20, v24, v3 :: v_dual_lshlrev_b32 v25, 3, v241
...
.Ltmp68:
	...
	s_waitcnt lgkmcnt(0)
	v_dual_max_f32 v1, v17, v17 :: v_dual_max_f32 v18, v18, v18
	...
	v_dual_max_f32 v20, 0x2b8cbccc, v20 :: v_dual_fmac_f32 v5, v8, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	v_dual_mul_f32 v19, v81, v26 :: v_dual_and_b32 v86, 0xffff0000, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.Ltmp70:
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_dual_fmac_f32 v26, v27, v26 :: v_dual_and_b32 v81, 0xffff0000, v5
	...
	v_dual_mul_f32 v25, v18, v87 :: v_dual_fmac_f32 v26, v91, v26
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_dual_fmac_f32 v84, v82, v92 :: v_dual_mul_f32 v19, v88, v85
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 84
