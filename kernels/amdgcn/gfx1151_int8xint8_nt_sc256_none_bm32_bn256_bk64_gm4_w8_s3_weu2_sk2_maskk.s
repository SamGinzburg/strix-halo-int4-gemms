...
.Ltmp11:
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_mad_u64_u32 v[6:7], null, s6, v4, v[1:2]
	s_waitcnt lgkmcnt(0)
...
.Ltmp21:
	...
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	s_add_i32 s17, s7, 0x80
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v15, s7, v8
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	...
	buffer_load_b128 v[41:44], v10, s[24:27], 0 offen
...
.LBB0_3:                                ; %Flow246
	...
	s_ashr_i32 s34, s22, 8
	v_or_b32_e32 v17, s21, v0
...
.Ltmp22:
	...
	s_lshr_b32 s14, s20, 7
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v21, 28, v6
.Ltmp23:
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	...
	v_add_nc_u32_e32 v62, v22, v21
	v_mov_b32_e32 v21, 0
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v63, 0, v23
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v70, v18, s7, 1
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_cndmask_b32_e32 v64, 0x80000000, v66, vcc_lo
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v66, v52, s7, 1
	...
	.loc	1 344 23                        ; generate_amdgcn.py:344:23
	v_cmp_gt_i32_e32 vcc_lo, s6, v65
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	...
	buffer_load_u16 v170, v66, s[28:31], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	buffer_load_u16 v171, v64, s[36:39], 0 offen
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v172, v70, s[28:31], 0 offen
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v64, s17, v11
	v_cndmask_b32_e32 v66, 0x80000000, v68, vcc_lo
	v_add_nc_u32_e32 v68, s18, v57
	v_add_nc_u32_e32 v69, s18, v58
	v_add_nc_u32_e32 v70, s18, v60
	v_cndmask_b32_e32 v64, 0x80000000, v64, vcc_lo
	s_clause 0x3
	buffer_load_b128 v[96:99], v65, s[24:27], 0 offen
	buffer_load_b128 v[100:103], v66, s[24:27], 0 offen
	buffer_load_b128 v[104:107], v67, s[24:27], 0 offen
	buffer_load_b128 v[108:111], v64, s[24:27], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v64, s7, v53
	v_add_nc_u32_e32 v65, s7, v54
	v_add_nc_u32_e32 v66, s7, v56
	v_add_nc_u32_e32 v67, s7, v55
	...
	s_mov_b32 s14, s40
	s_cmp_lt_i32 s7, 2
	s_cselect_b32 s42, s7, 0
	s_add_i32 s15, s15, -1
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_lshl_b32 s18, s42, 11
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_lshl_b32 s19, s42, 14
	...
	v_dual_mul_f32 v140, v74, v128 :: v_dual_add_nc_u32 v173, s18, v10
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v143, v77, v128 :: v_dual_add_nc_u32 v174, s41, v9
	...
	v_dual_mul_f32 v144, v78, v128 :: v_dual_fmac_f32 v21, v131, v113
	v_dual_mul_f32 v128, v79, v128 :: v_dual_fmac_f32 v23, v133, v115
	v_mul_f32_e32 v64, v64, v129
	v_mul_f32_e32 v65, v65, v129
	v_mul_f32_e32 v66, v66, v129
	v_dual_mul_f32 v68, v68, v129 :: v_dual_fmac_f32 v27, v137, v119
	v_mul_f32_e32 v69, v69, v129
	v_dual_mul_f32 v70, v70, v129 :: v_dual_fmac_f32 v31, v141, v123
	v_mul_f32_e32 v71, v71, v129
	v_dual_mul_f32 v72, v72, v129 :: v_dual_fmac_f32 v39, v67, v83
	v_mul_f32_e32 v73, v73, v129
	v_dual_mul_f32 v74, v74, v129 :: v_dual_fmac_f32 v37, v128, v127
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v76, v76, v129 :: v_dual_fmac_f32 v43, v71, v87
	v_mul_f32_e32 v77, v77, v129
	v_dual_mul_f32 v78, v78, v129 :: v_dual_fmac_f32 v45, v72, v88
	v_dual_mul_f32 v79, v79, v129 :: v_dual_fmac_f32 v20, v130, v112
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v25, v135, v117 :: v_dual_fmac_f32 v22, v132, v114
	v_dual_fmac_f32 v29, v139, v121 :: v_dual_fmac_f32 v24, v134, v116
	v_dual_fmac_f32 v33, v143, v125 :: v_dual_fmac_f32 v26, v136, v118
	v_dual_fmac_f32 v35, v65, v81 :: v_dual_fmac_f32 v28, v138, v120
	v_dual_fmac_f32 v41, v69, v85 :: v_dual_fmac_f32 v30, v140, v122
	v_fmac_f32_e32 v32, v142, v124
	v_fmac_f32_e32 v36, v144, v126
	v_dual_fmac_f32 v34, v64, v80 :: v_dual_fmac_f32 v47, v74, v90
	v_dual_fmac_f32 v38, v66, v82 :: v_dual_fmac_f32 v49, v76, v92
	v_dual_fmac_f32 v40, v68, v84 :: v_dual_fmac_f32 v51, v78, v94
	v_fmac_f32_e32 v42, v70, v86
	v_fmac_f32_e32 v46, v73, v89
	v_fmac_f32_e32 v48, v75, v91
	v_fmac_f32_e32 v50, v77, v93
	v_fmac_f32_e32 v44, v79, v95
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
.LBB0_10:
	...
	s_cmp_lt_i32 s8, s34
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v1, v52, s8, 1
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v2, v17, s6, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	...
	v_add_lshl_u32 v3, v18, s8, 1
	s_and_b32 s13, s13, 0xffff
	v_dual_mov_b32 v99, 0 :: v_dual_and_b32 v74, 14, v0
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	...
	s_clause 0x1
	buffer_load_u16 v129, v1, s[12:15], 0 offen
...
; %bb.11:
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v59, s26 :: v_dual_mov_b32 v58, s25
	v_dual_mov_b32 v57, s24 :: v_dual_mov_b32 v56, s23
	v_dual_mov_b32 v55, s22 :: v_dual_mov_b32 v54, s21
...
.LBB0_12:
	...
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_dual_mul_f32 v131, v11, v55 :: v_dual_and_b32 v0, 0x3f8, v0
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 43
