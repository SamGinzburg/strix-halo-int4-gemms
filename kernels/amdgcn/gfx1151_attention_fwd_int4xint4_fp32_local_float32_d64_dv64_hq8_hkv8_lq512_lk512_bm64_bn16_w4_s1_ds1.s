...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v18, v33 :: v_dual_lshlrev_b32 v37, 1, v7
	...
	v_dual_mov_b32 v29, v33 :: v_dual_and_b32 v90, 0x700, v16
	v_mov_b32_e32 v26, v33
	v_lshrrev_b32_e32 v91, 2, v3
	...
	v_dual_mov_b32 v115, 0xff800000 :: v_dual_lshlrev_b32 v88, 8, v7
	v_cndmask_b32_e64 v44, v39, v48, s1
	v_cndmask_b32_e64 v47, v47, v46, s1
	v_cndmask_b32_e64 v46, v48, v39, s1
	v_cndmask_b32_e64 v48, v36, v38, s1
	v_cndmask_b32_e64 v50, v38, v36, s1
	v_xor_b32_e32 v36, v5, v6
	v_lshrrev_b32_e32 v38, 1, v8
	v_dual_mov_b32 v20, v33 :: v_dual_lshlrev_b32 v39, 1, v10
	v_lshl_or_b32 v40, v8, 6, v66
	v_lshl_or_b32 v79, v2, 5, v12
	v_dual_mov_b32 v22, v33 :: v_dual_and_b32 v89, 0x260, v11
	v_dual_mov_b32 v24, v33 :: v_dual_and_b32 v83, 0x120, v13
	v_dual_mov_b32 v27, v33 :: v_dual_and_b32 v84, 0x300, v11
	v_lshrrev_b32_e32 v85, 5, v10
	v_cndmask_b32_e64 v86, 0x1054, v14, s1
	v_cndmask_b32_e64 v87, 0x3276, v15, s1
	v_dual_mov_b32 v31, v33 :: v_dual_and_b32 v92, 0x160, v11
	v_lshl_or_b32 v34, v34, 2, v37
	.loc	1 566 23                        ; attention.py:566:23
	s_add_i32 s8, s3, s0
	v_dual_mov_b32 v19, v33 :: v_dual_add_nc_u32 v90, 0, v90
	v_dual_mov_b32 v14, v33 :: v_dual_add_nc_u32 v35, s36, v35
	v_xor_b32_e32 v91, v81, v91
	...
	v_dual_mov_b32 v10, v33 :: v_dual_add_nc_u32 v37, s36, v78
	...
	v_add_nc_u32_e32 v79, 0, v39
	v_or3_b32 v80, v84, v80, v85
	v_lshl_or_b32 v40, v86, 8, v86
	v_lshl_or_b32 v94, v87, 8, v87
	v_and_or_b32 v81, 0x90, v82, v92
	v_add_nc_u32_e32 v82, 0, v36
	v_xor_b32_e32 v36, 8, v77
	v_or3_b32 v88, v88, v89, v34
	v_dual_mov_b32 v13, v33 :: v_dual_add_nc_u32 v90, v90, v91
	v_dual_mov_b32 v15, v33 :: v_dual_add_nc_u32 v92, s17, v35
	.loc	1 748 47                        ; attention.py:748:47
	v_subrev_nc_u32_e32 v91, s16, v35
	v_mul_lo_u32 v35, s15, v93
	v_dual_mov_b32 v32, v33 :: v_dual_lshlrev_b32 v75, 2, v2
	v_or_b32_e32 v76, s37, v4
	v_dual_mov_b32 v23, v33 :: v_dual_and_b32 v40, 0x540054, v40
	v_dual_mov_b32 v11, v33 :: v_dual_and_b32 v94, 0x760076, v94
	v_dual_mov_b32 v16, v33 :: v_dual_add_nc_u32 v87, s17, v37
	v_dual_mov_b32 v2, v33 :: v_dual_add_nc_u32 v89, v79, v38
	v_dual_mov_b32 v4, v33 :: v_dual_add_nc_u32 v93, 0, v36
	...
	v_dual_mov_b32 v119, 0xff800000 :: v_dual_mov_b32 v30, v33
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s0, s33, v42
	v_dual_mov_b32 v5, v33 :: v_dual_add_nc_u32 v96, 0, v39
	v_dual_mov_b32 v6, v33 :: v_dual_add_nc_u32 v95, 0, v95
	v_dual_mov_b32 v8, v33 :: v_dual_add_nc_u32 v97, 0, v97
	v_add_nc_u32_e32 v99, 0, v99
	v_and_b32_e32 v100, 0x5040504, v40
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mov_b32 v40, v33 :: v_dual_max_f32 v119, v119, v119
	v_dual_mov_b32 v36, v33 :: v_dual_add_nc_u32 v131, 0, v77
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_dual_mov_b32 v126, v38 :: v_dual_mov_b32 v125, v37
	...
	v_or_b32_e32 v132, s23, v75
	v_or_b32_e32 v134, s23, v84
	.loc	1 752 25                        ; attention.py:752:25
	s_add_i32 s51, s50, s23
	.loc	1 708 31                        ; attention.py:708:31
	v_or_b32_e32 v133, s23, v83
	.loc	1 712 32                        ; attention.py:712:32
	buffer_load_b32 v34, v34, s[24:27], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v132, v86
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v132, v87
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s11, v134, v86
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s13, v134, v87
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s4, v132, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s6, v132, v92
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s12, v134, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s14, v134, v92
	...
	v_or_b32_e32 v135, s23, v85
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s7, v133, v86
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s9, v133, v87
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s8, v133, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s10, v133, v92
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s15, v135, v86
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s17, v135, v87
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s16, v135, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s18, v135, v92
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s7, s7, s9
	...
	v_add_lshl_u32 v138, v0, s23, 1
	v_add_lshl_u32 v139, v67, s23, 1
	v_add_lshl_u32 v140, v68, s23, 1
	v_add_lshl_u32 v141, v69, s23, 1
	v_add_lshl_u32 v142, v70, s23, 1
	v_add_lshl_u32 v120, v71, s23, 1
	v_add_lshl_u32 v143, v72, s23, 1
	v_add_lshl_u32 v144, v73, s23, 1
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b64 v89, v[122:123], v[136:137] offset1:32
	...
	v_dual_mul_f32 v138, v114, v40 :: v_dual_add_nc_u32 v123, v79, v78
	.loc	1 763 25                        ; attention.py:763:25
	...
	.loc	1 762 35                        ; attention.py:762:35
	ds_store_2addr_b64 v89, v[124:125], v[126:127] offset0:64 offset1:96
	.loc	1 732 30                        ; attention.py:732:30
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v127, v36, v125 :: v_dual_mul_f32 v130, v137, v130
	v_dual_mul_f32 v128, v124, v128 :: v_dual_mul_f32 v131, v138, v131
	.loc	1 762 35                        ; attention.py:762:35
	...
	v_fmac_f32_e32 v132, s49, v126
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v136, s49, v127 :: v_dual_fmac_f32 v39, s49, v128
	.loc	1 762 35                        ; attention.py:762:35
	...
	v_dual_fmac_f32 v40, s49, v129 :: v_dual_fmac_f32 v125, s49, v131
	v_dual_fmac_f32 v124, s49, v130 :: v_dual_fmac_f32 v137, s49, v41
	v_fmac_f32_e32 v138, s49, v121
	...
	ds_load_2addr_b64 v[38:41], v89 offset1:32
.Ltmp1:
...
.Ltmp2:
	...
	v_permlanex16_b32 v124, v121, s48, 0xfedcba98 op_sel:[1,0]
...
.Ltmp24:
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v122, v139, s48, 0xfedcba98 op_sel:[1,0]
.Ltmp25:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
...
.Ltmp28:
	...
	v_permlanex16_b32 v39, v40, s48, 0xfedcba98 op_sel:[1,0]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v41, v52, s48, 0xfedcba98 op_sel:[1,0]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 145
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 52
