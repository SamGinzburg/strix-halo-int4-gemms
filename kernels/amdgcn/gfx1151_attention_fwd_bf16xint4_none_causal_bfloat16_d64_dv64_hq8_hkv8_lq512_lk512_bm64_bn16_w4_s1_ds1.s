	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 787 26                        ; attention.py:787:26
	v_add3_u32 v2, v4, v5, s7
	s_mul_i32 s7, s14, 48
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v4, 1, v2
	v_add_lshl_u32 v5, v2, s8, 1
...
; %bb.1:                                ; %.lr.ph
	...
	v_lshl_or_b32 v78, v2, 7, v6
	.loc	1 810 25                        ; attention.py:810:25
	s_min_i32 s0, s7, 0x200
	.loc	1 903 13                        ; attention.py:903:13
	...
	v_dual_mov_b32 v28, v64 :: v_dual_lshlrev_b32 v17, 7, v0
	v_mov_b32_e32 v27, v64
	ds_load_b128 v[60:63], v10
	ds_load_b128 v[56:59], v4
	v_mov_b32_e32 v4, 0x7632
	v_lshl_or_b32 v7, v7, 4, v7
	v_dual_mov_b32 v25, v64 :: v_dual_add_nc_u32 v80, s6, v5
	...
	v_dual_mov_b32 v31, v64 :: v_dual_and_b32 v16, 0x160, v16
	...
	v_and_b32_e32 v4, 0x700, v17
	v_mov_b32_e32 v17, v64
	v_and_or_b32 v83, 0x90, v0, v16
	v_mov_b32_e32 v16, 0
	.loc	1 903 13                        ; attention.py:903:13
	v_mul_lo_u32 v1, s14, v1
	v_dual_mov_b32 v23, v64 :: v_dual_add_nc_u32 v0, 0, v4
	v_lshl_or_b32 v4, s3, 8, v11
	v_xor_b32_e32 v7, 16, v83
	v_lshl_add_u32 v84, v2, 3, s1
	v_add_nc_u32_e32 v86, 0, v8
	v_dual_mov_b32 v18, v64 :: v_dual_add_nc_u32 v87, 0, v9
	v_mad_u64_u32 v[73:74], null, s15, v4, v[3:4]
	v_lshl_add_u32 v85, v1, 1, v6
	v_dual_mov_b32 v11, v64 :: v_dual_add_nc_u32 v88, 0, v10
	v_dual_mov_b32 v20, v64 :: v_dual_add_nc_u32 v89, 0, v12
	v_add_nc_u32_e32 v90, 0, v13
	v_mov_b32_e32 v13, v64
	v_dual_mov_b32 v22, v64 :: v_dual_add_nc_u32 v91, 0, v14
	v_add_nc_u32_e32 v92, 0, v15
	v_mov_b32_e32 v15, v64
	v_dual_mov_b32 v8, 0 :: v_dual_add_nc_u32 v93, v0, v5
	v_dual_mov_b32 v1, v64 :: v_dual_add_nc_u32 v94, 0, v7
	v_mov_b32_e32 v9, v64
	v_dual_mov_b32 v10, v64 :: v_dual_mov_b32 v95, 0xff800000
	v_mov_b32_e32 v12, v64
	v_mov_b32_e32 v14, v64
	v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v3, v64
	v_mov_b32_e32 v2, v64
	v_mov_b32_e32 v4, v64
	v_dual_mov_b32 v5, v64 :: v_dual_mov_b32 v74, 0
...
.Ltmp10:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 114
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 35
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     37
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
