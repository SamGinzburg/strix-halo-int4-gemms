	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_dual_mov_b32 v5, v1 :: v_dual_lshlrev_b32 v18, 3, v0
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v6, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v7, v1 :: v_dual_and_b32 v14, 0x17e, v10
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v9, v1
	v_mov_b32_e32 v10, v1
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_xor_b32_e32 v23, v15, v14
	v_mov_b32_e32 v8, v1
	v_dual_mov_b32 v11, v1 :: v_dual_add_nc_u32 v24, 0, v18
	v_mov_b32_e32 v12, v1
	v_mov_b32_e32 v13, v1
	v_mov_b32_e32 v14, v1
	v_mov_b32_e32 v15, v1
	v_dual_mov_b32 v16, v1 :: v_dual_add_nc_u32 v23, 0, v23
	s_waitcnt vmcnt(1)
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v16, s19 :: v_dual_add_nc_u32 v27, 0x800, v4
	v_mov_b32_e32 v12, s15
	v_mov_b32_e32 v14, s17
	v_dual_mov_b32 v13, s16 :: v_dual_add_nc_u32 v28, 0x800, v5
	ds_load_u8 v3, v25 offset:1664
	ds_load_u8 v4, v25 offset:1920
	ds_load_u8 v5, v25 offset:1792
	ds_load_u8 v44, v25 offset:1536
	ds_load_u8 v45, v25 offset:1152
	ds_load_u8 v46, v25 offset:1408
	ds_load_u8 v47, v25 offset:1280
...
.Ltmp15:
	...
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_perm_b32 v44, v44, v3, 0xc0c0004
	v_perm_b32 v49, v5, v4, 0xc0c0004
	v_perm_b32 v45, v48, v45, 0xc0c0004
	v_perm_b32 v46, v47, v46, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[41:42], v[31:32], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v32, v49, 16, v44
	v_wmma_i32_16x16x16_iu4 v[9:16], v[41:42], v[33:34], v[9:16] neg_lo:[1,1,0]
	v_lshl_or_b32 v31, v46, 16, v45
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cmp_eq_u32 s12, 2
	...
	s_cbranch_scc1 .LBB0_4
; %bb.2:                                ; %.peel.next
	v_add3_u32 v30, s2, v30, 0x80
	v_add_nc_u32_e32 v26, s24, v26
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_lo_u32 v32, s25, v30
	v_mad_u64_u32 v[30:31], null, s29, v26, s[2:3]
	s_lshl_b32 s2, s28, 7
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_add3_u32 v17, v32, s2, v17
	s_lshl_b32 s2, s27, 7
	v_add3_u32 v26, v30, v29, 0x80
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[39:40], v[29:30], v[1:8] neg_lo:[1,1,0]
...
; %bb.5:
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[29:30], v[21:22], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v31, v34, 16, v31
	v_wmma_i32_16x16x16_iu4 v[9:16], v[29:30], v[23:24], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[31:32], v[25:26], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[31:32], v[27:28], v[9:16] neg_lo:[1,1,0]
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	v_or_b32_e32 v23, 12, v19
	v_or_b32_e32 v24, 16, v19
	v_or_b32_e32 v25, 20, v19
	v_or_b32_e32 v26, 24, v19
	v_or_b32_e32 v27, 28, v19
	s_clause 0x7
	...
	s_lshl_b32 s5, s25, 2
	.loc	1 247 9 is_stmt 0               ; generate_amdgcn.py:247:9
	v_add_lshl_u32 v29, v18, s4, 2
	v_add_lshl_u32 v30, v18, s5, 2
	...
	v_dual_mul_f32 v56, v6, v14 :: v_dual_lshlrev_b32 v19, 16, v25
	...
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v26, v0, v17 :: v_dual_lshlrev_b32 v21, 16, v27
	v_mul_f32_e32 v22, v0, v8
	v_dual_mul_f32 v8, v6, v8 :: v_dual_mul_f32 v27, v0, v19
	v_mul_f32_e32 v19, v6, v19
	v_mul_f32_e32 v23, v0, v10
	v_mul_f32_e32 v25, v0, v14
	...
	v_dual_mul_f32 v11, v19, v35 :: v_dual_mul_f32 v54, v6, v10
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v17, v6, v17
	v_mul_f32_e32 v20, v6, v20
	v_dual_mul_f32 v21, v6, v21 :: v_dual_lshlrev_b32 v28, 2, v18
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	...
	v_add_lshl_u32 v16, v18, s8, 2
	v_add_lshl_u32 v17, v18, s9, 2
	v_add_lshl_u32 v19, v18, s10, 2
	v_add_lshl_u32 v20, v18, s11, 2
	v_add_lshl_u32 v21, v18, s12, 2
	v_add_lshl_u32 v22, v18, s13, 2
	v_add_lshl_u32 v23, v18, s14, 2
	v_add_lshl_u32 v24, v18, s15, 2
	s_waitcnt lgkmcnt(7)
	...
	v_add_lshl_u32 v25, v18, s16, 2
	v_add_lshl_u32 v26, v18, s17, 2
	v_add_lshl_u32 v27, v18, s18, 2
	v_add_lshl_u32 v31, v18, s19, 2
	v_add_lshl_u32 v0, v18, s20, 2
	s_clause 0x4
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.num_vgpr, 57
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm32_bn128_bk32_gm4_w8_s2_weu2_sk4_evenk.kd
