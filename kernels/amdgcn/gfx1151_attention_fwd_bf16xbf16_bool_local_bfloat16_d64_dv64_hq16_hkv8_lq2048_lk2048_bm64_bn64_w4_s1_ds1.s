	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 853 49                        ; attention.py:853:49
	v_lshlrev_b32_e32 v1, 3, v2
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v5, 7, v71
	v_lshlrev_b32_e32 v6, 6, v72
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v2, 4, v2
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v3, s12, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v169, s6, v4
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v171, s7, v4
	v_mov_b32_e32 v27, v25
	v_mov_b32_e32 v28, v25
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v4, v5, v6, v2
	.loc	1 866 47                        ; attention.py:866:47
	...
	v_mad_u64_u32 v[145:146], null, s90, v4, v[1:2]
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v4, v8, v10
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v253, 5, v151
	v_or_b32_e32 v146, v2, v5
	v_lshl_add_u32 v2, s11, 5, v8
	.loc	1 818 13                        ; attention.py:818:13
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v4, off
	scratch_store_b32 off, v73, off offset:40
	v_add_nc_u32_e32 v4, v8, v11
	v_dual_mov_b32 v32, v25 :: v_dual_lshlrev_b32 v3, 1, v0
	v_dual_mov_b32 v19, v25 :: v_dual_lshlrev_b32 v6, 4, v0
	scratch_store_b32 off, v4, off offset:4 ; 4-byte Folded Spill
	v_dual_mov_b32 v15, v25 :: v_dual_add_nc_u32 v4, v8, v12
	v_dual_mov_b32 v18, v25 :: v_dual_and_b32 v7, 0x70, v3
	...
	v_dual_mov_b32 v24, v25 :: v_dual_lshlrev_b32 v5, 2, v72
	v_dual_mov_b32 v231, v25 :: v_dual_and_b32 v6, 0x80, v6
	scratch_store_b32 off, v4, off offset:12 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v4, v8, v253
	v_dual_mov_b32 v14, v25 :: v_dual_and_b32 v9, 0x260, v154
	v_and_or_b32 v6, v70, 16, v6
	v_mov_b32_e32 v16, v25
	scratch_store_b32 off, v4, off offset:16 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v4, v2, v151
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_dual_mov_b32 v229, 0xff800000 :: v_dual_add_nc_u32 v4, v2, v10
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_dual_mov_b32 v12, v25 :: v_dual_lshlrev_b32 v11, 3, v72
	v_mov_b32_e32 v230, 0xff800000
	scratch_store_b32 off, v4, off offset:36 ; 4-byte Folded Spill
	v_and_b32_e32 v4, 12, v0
	v_add_nc_u32_e32 v252, v8, v153
	v_add_nc_u32_e32 v181, v8, v163
	v_add_nc_u32_e32 v182, v8, v164
	...
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v183, v2, v253
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v3, 0x1054, v5, s4
	v_cndmask_b32_e64 v5, 0x3276, v6, s4
	v_dual_mov_b32 v235, 0xff800000 :: v_dual_add_nc_u32 v184, v2, v254
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v185, v2, v255
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v3, v3, 8, v3
	v_dual_mov_b32 v233, v25 :: v_dual_add_nc_u32 v186, v2, v152
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v187, v2, v153
	v_add_nc_u32_e32 v189, v2, v163
...
; %bb.47:                               ;   in Loop: Header=BB0_6 Depth=1
	.loc	1 0 34 is_stmt 0                ; attention.py:0:34
	scratch_load_b32 v108, off, off offset:36 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v108, s4, v108
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 877 34                        ; attention.py:877:34
...
.Ltmp95:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 101
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 48
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1
    .private_segment_fixed_size: 48
    .sgpr_count:     103
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.kd
