...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v101, s48, v119
	.loc	1 402 30 is_stmt 0              ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[9:10], null, s1, s34, v[91:92]
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add3_u32 v102, s14, v92, v119
...
; %bb.9:
	...
	s_mov_b32 s19, s12
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v113, s48, v119
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
; %bb.11:
	...
	v_add_nc_u32_e32 v122, s46, v119
	...
	scratch_store_b32 off, v245, off offset:24
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v1, s46, v109
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v25, s45, v112
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v57, s46, v108
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	v_mov_b32_e32 v245, v113
	v_mov_b32_e32 v63, v196
	v_mov_b32_e32 v117, v119
	v_mov_b32_e32 v119, v232
	v_dual_mov_b32 v235, v230 :: v_dual_mov_b32 v230, v225
	v_dual_mov_b32 v225, v220 :: v_dual_mov_b32 v238, v233
	v_dual_mov_b32 v220, v215 :: v_dual_mov_b32 v215, v210
	...
	v_dual_mov_b32 v221, v216 :: v_dual_mov_b32 v216, v211
	v_dual_mov_b32 v211, v206 :: v_dual_mov_b32 v206, v201
	v_mov_b32_e32 v201, v194
	v_dual_mov_b32 v227, v222 :: v_dual_mov_b32 v210, v205
	...
	v_dual_mov_b32 v219, v214 :: v_dual_mov_b32 v64, v197
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v2, v3, v2, 0xc0c0004
	v_dual_mov_b32 v214, v209 :: v_dual_mov_b32 v209, v204
	...
	v_dual_mov_b32 v113, v245 :: v_dual_mov_b32 v114, v246
	s_clause 0x2                            ; 12-byte Folded Reload
	scratch_load_b32 v116, off, off offset:12
	scratch_load_b32 v246, off, off offset:20
	scratch_load_b32 v245, off, off offset:24
	s_waitcnt lgkmcnt(0)
	...
	scratch_load_b32 v117, off, off offset:28
...
.Ltmp29:
	...
	v_dual_max_f32 v11, v11, v11 :: v_dual_lshlrev_b32 v82, 16, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v11, 0, v11 :: v_dual_mul_f32 v176, v74, v82
	v_dual_max_f32 v17, v17, v17 :: v_dual_mul_f32 v74, v74, v84
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v19, v120, v19, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v171, v69, v82 :: v_dual_max_f32 v32, v32, v32
	v_mul_f32_e32 v179, v77, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v21, v165, v21, v137
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v13, v121, v13, s2
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v33, v176, v33, v149
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v21, v137, v21, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v180, v78, v82 :: v_dual_max_f32 v15, v15, v15
	v_dual_mul_f32 v174, v72, v82 :: v_dual_max_f32 v19, v19, v19
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v35, v178, v35, v151
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v28, v28, v28 :: v_dual_mul_f32 v173, v71, v82
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v37, v180, v37, v153
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v36, 0, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v38, v181, v38, v154
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_cndmask_b32_e64 v40, v122, v40, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v33, 0, v33 :: v_dual_max_f32 v74, 0, v34
	v_dual_max_f32 v35, 0, v35 :: v_dual_max_f32 v34, v37, v37
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v40, v41, v41 :: v_dual_max_f32 v75, 0, v34
	v_dual_max_f32 v76, 0, v37 :: v_dual_max_f32 v77, 0, v38
	v_dual_max_f32 v38, v44, v44 :: v_dual_max_f32 v39, 0, v39
	v_dual_max_f32 v34, v42, v42 :: v_dual_max_f32 v37, v43, v43
	v_dual_max_f32 v42, v46, v46 :: v_dual_max_f32 v41, v45, v45
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v43, 0, v34 :: v_dual_max_f32 v44, 0, v37
	v_dual_max_f32 v78, 0, v38 :: v_dual_max_f32 v79, 0, v41
	v_max_f32_e32 v80, 0, v42
	v_dual_max_f32 v34, v47, v47 :: v_dual_max_f32 v37, v48, v48
	v_dual_max_f32 v38, v49, v49 :: v_dual_max_f32 v41, v50, v50
	v_max_f32_e32 v42, v51, v51
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v24, v24, v24 :: v_dual_max_f32 v81, 0, v34
	v_dual_max_f32 v82, 0, v37 :: v_dual_max_f32 v83, 0, v38
	v_dual_max_f32 v84, 0, v41 :: v_dual_max_f32 v85, 0, v42
	v_dual_max_f32 v34, v52, v52 :: v_dual_max_f32 v37, v53, v53
	...
	v_cndmask_b32_e64 v10, v118, v10, s2
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v38, v54, v54 :: v_dual_max_f32 v41, v55, v55
	...
	v_dual_max_f32 v19, 0, v19 :: v_dual_max_f32 v12, v12, v12
	v_dual_max_f32 v14, v14, v14 :: v_dual_max_f32 v23, v23, v23
	v_dual_max_f32 v16, v16, v16 :: v_dual_max_f32 v15, 0, v15
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v31, v174, v31, v147
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v18, v18, v18 :: v_dual_max_f32 v23, 0, v23
	...
	v_dual_max_f32 v38, v59, v59 :: v_dual_max_f32 v57, 0, v34
	v_max_f32_e32 v91, 0, v37
	v_dual_max_f32 v37, v63, v63 :: v_dual_max_f32 v94, 0, v42
	...
	v_dual_max_f32 v41, v60, v60 :: v_dual_max_f32 v92, 0, v38
	v_dual_max_f32 v34, v62, v62 :: v_dual_max_f32 v3, v3, v3
	v_dual_max_f32 v38, v64, v64 :: v_dual_max_f32 v1, 0, v1
	v_dual_max_f32 v4, v4, v4 :: v_dual_max_f32 v25, 0, v25
	...
	v_dual_max_f32 v95, 0, v34 :: v_dual_max_f32 v96, 0, v37
	v_max_f32_e32 v97, 0, v38
	v_dual_max_f32 v3, 0, v3 :: v_dual_max_f32 v6, v6, v6
	...
	v_dual_mul_f32 v99, v65, v65 :: v_dual_mul_f32 v38, v11, v11
	v_dual_mul_f32 v34, v9, v9 :: v_dual_mul_f32 v37, v10, v10
	v_dual_mul_f32 v41, v12, v12 :: v_dual_mul_f32 v42, v13, v13
	v_dual_mul_f32 v49, v16, v16 :: v_dual_mul_f32 v50, v17, v17
	v_dual_mul_f32 v53, v18, v18 :: v_dual_mul_f32 v54, v19, v19
	v_dual_mul_f32 v58, v20, v20 :: v_dual_mul_f32 v59, v21, v21
	v_dual_mul_f32 v62, v22, v22 :: v_dual_mul_f32 v63, v23, v23
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v30, 0, v30 :: v_dual_max_f32 v31, 0, v31
	v_dual_max_f32 v40, 0, v40 :: v_dual_max_f32 v5, 0, v5
	v_dual_max_f32 v6, 0, v6 :: v_dual_max_f32 v7, 0, v7
	v_max_f32_e32 v98, 0, v8
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v66, v24, v24 :: v_dual_mul_f32 v67, v25, v25
	v_dual_mul_f32 v70, v26, v26 :: v_dual_mul_f32 v71, v27, v27
	v_dual_mul_f32 v73, v28, v28 :: v_dual_mul_f32 v72, v29, v29
	v_dual_mul_f32 v64, v32, v32 :: v_dual_mul_f32 v65, v33, v33
	v_dual_mul_f32 v60, v74, v74 :: v_dual_mul_f32 v61, v35, v35
	v_dual_mul_f32 v55, v36, v36 :: v_dual_mul_f32 v56, v75, v75
	v_dual_mul_f32 v52, v76, v76 :: v_dual_mul_f32 v51, v77, v77
	v_dual_mul_f32 v16, v1, v1 :: v_dual_mul_f32 v13, v3, v3
	v_dual_mul_f32 v17, v97, v97 :: v_dual_mul_f32 v8, v4, v4
.Ltmp30:
...
.Ltmp31:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v45, v14, v14 :: v_dual_mul_f32 v46, v15, v15
	v_dual_mul_f32 v68, v30, v30 :: v_dual_mul_f32 v69, v31, v31
	v_dual_mul_f32 v47, v39, v39 :: v_dual_mul_f32 v48, v40, v40
	v_dual_mul_f32 v43, v43, v43 :: v_dual_mul_f32 v44, v44, v44
	v_dual_mul_f32 v39, v78, v78 :: v_dual_mul_f32 v40, v79, v79
	v_dual_mul_f32 v32, v82, v82 :: v_dual_mul_f32 v31, v83, v83
	v_dual_mul_f32 v28, v84, v84 :: v_dual_mul_f32 v29, v85, v85
	v_dual_mul_f32 v27, v86, v86 :: v_dual_mul_f32 v26, v87, v87
	v_dual_mul_f32 v24, v88, v88 :: v_dual_mul_f32 v25, v89, v89
	v_dual_mul_f32 v9, v5, v5 :: v_dual_mul_f32 v10, v6, v6
.Ltmp32:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp38:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v14, v95, v95 :: v_dual_mul_f32 v15, v96, v96
.Ltmp39:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp45:
	...
	v_dual_max_f32 v76, v4, v57 :: v_dual_and_b32 v7, 0x60, v0
	v_dual_max_f32 v75, v3, v33 :: v_dual_and_b32 v4, 3, v0
.Ltmp46:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp48:
	...
	v_and_or_b32 v77, 0x680, v123, v4
...
.Ltmp49:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v77, v5, v1 :: v_dual_add_nc_u32 v30, 0, v30
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp50:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp51:
	...
	v_dual_max_f32 v78, v77, v77 :: v_dual_mov_b32 v57, v76
.Ltmp52:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp54:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v5, v75 :: v_dual_max_f32 v74, v76, v76
.Ltmp55:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v75, v75, v75 :: v_dual_mov_b32 v76, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp56:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp57:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v5, v5, v5 :: v_dual_max_f32 v76, v76, v76
	v_max_f32_e32 v5, v75, v5
	v_max_f32_e32 v75, v77, v77
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_max_f32_e32 v1, v1, v76
	v_max_f32_e32 v57, v74, v57
	v_dual_max_f32 v74, v78, v75 :: v_dual_mov_b32 v75, v57
...
.Ltmp59:
	...
	v_dual_max_f32 v79, v74, v76 :: v_dual_mov_b32 v76, v57
.Ltmp60:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp63:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v74, v77, v77 :: v_dual_max_f32 v75, v78, v78
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 52
