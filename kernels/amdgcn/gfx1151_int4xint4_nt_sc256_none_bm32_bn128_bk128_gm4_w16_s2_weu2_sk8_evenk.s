	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
; %bb.5:                                ; %.peel.next
	...
	s_lshl_b32 s5, s33, 7
	v_add3_u32 v13, s28, v42, v13
	v_or_b32_e32 v61, s5, v39
	v_or_b32_e32 v11, s5, v11
	s_lshl_b32 s5, s29, 7
	v_subrev_nc_u32_e32 v39, s24, v40
	v_mul_lo_u32 v42, s19, v13
	v_subrev_nc_u32_e32 v40, s5, v61
	v_subrev_nc_u32_e32 v13, s5, v11
	v_add_nc_u32_e32 v61, s28, v12
	v_sub_nc_u32_e32 v59, s31, v9
	v_sub_nc_u32_e32 v60, s31, v10
	v_mad_u64_u32 v[11:12], null, s31, v40, v[10:11]
	...
	v_mad_u64_u32 v[9:10], null, s31, v61, v[9:10]
	v_lshl_add_u32 v10, v42, 1, 2
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	buffer_load_u16 v13, v10, s[12:15], 0 offen
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e32 vcc_lo, s30, v59
	v_cmp_lt_i32_e64 s5, s30, v60
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_add_i32 s29, s29, -1
	.loc	1 198 26                        ; generate_amdgcn.py:198:26
	s_and_b32 vcc_lo, vcc_lo, s3
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_add_nc_u32_e32 v40, s30, v9
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	v_add_nc_u32_e32 v61, s30, v11
	.loc	1 218 34 is_stmt 0              ; generate_amdgcn.py:218:34
	v_add_nc_u32_e32 v42, s30, v12
	.loc	1 188 9 is_stmt 1               ; generate_amdgcn.py:188:9
	s_addk_i32 s30, 0x80
	...
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	v_dual_cndmask_b32 v61, 0x80000000, v61 :: v_dual_add_nc_u32 v62, v45, v39
	...
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	s_clause 0x1
	buffer_load_b64 v[69:70], v42, s[20:23], 0 offen
	...
	v_dual_mul_f32 v62, v13, v62 :: v_dual_add_nc_u32 v39, s34, v39
	...
	v_dual_fmac_f32 v31, v64, v75 :: v_dual_lshlrev_b32 v68, 16, v106
	v_dual_fmac_f32 v28, v62, v73 :: v_dual_lshlrev_b32 v77, 16, v111
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v78, 16, v112
	v_lshlrev_b32_e32 v74, 16, v108
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v27, v61, v68 :: v_dual_add_nc_u32 v10, 2, v10
	v_dual_fmac_f32 v26, v42, v67 :: v_dual_fmac_f32 v33, v65, v76
	v_dual_fmac_f32 v34, v66, v77 :: v_dual_fmac_f32 v35, v13, v78
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v29, v63, v74
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_vgpr, 113
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.numbered_sgpr, 35
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     37
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.kd
