...
.LBB0_3:                                ; %Flow78
	...
	v_dual_mov_b32 v11, 0 :: v_dual_and_b32 v34, 16, v6
	v_dual_mov_b32 v16, 0 :: v_dual_and_b32 v27, 0xe0, v0
	v_bfe_i32 v6, v0, 3, 1
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v29, 15, v0
	v_bfe_u32 v28, v0, 4, 1
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v30, 0x108, v0
	v_dual_mov_b32 v24, 0 :: v_dual_lshlrev_b32 v31, 4, v5
	v_dual_mov_b32 v21, 0 :: v_dual_lshlrev_b32 v32, 3, v27
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v33, 0x88, v6
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v9, 32, v8
	...
	v_dual_mov_b32 v2, s41 :: v_dual_lshlrev_b32 v39, 1, v28
	v_dual_mov_b32 v5, s44 :: v_dual_add_nc_u32 v46, 0, v13
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_clause 0x7
	buffer_load_u16 v76, v49, s[28:31], 0 offen offset:4
	buffer_load_u16 v77, v49, s[28:31], 0 offen
	buffer_load_u16 v78, v49, s[28:31], 0 offen offset:12
	buffer_load_u16 v79, v49, s[28:31], 0 offen offset:8
	buffer_load_u16 v80, v49, s[28:31], 0 offen offset:20
	buffer_load_u16 v81, v49, s[28:31], 0 offen offset:16
	buffer_load_u16 v82, v49, s[28:31], 0 offen offset:28
	buffer_load_u16 v83, v49, s[28:31], 0 offen offset:24
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	...
	v_dual_mul_f32 v56, v64, v56 :: v_dual_lshlrev_b32 v63, 16, v73
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_dual_mul_f32 v52, v63, v52 :: v_dual_mul_f32 v55, v64, v55
	...
	v_dual_mul_f32 v48, v63, v48 :: v_dual_lshlrev_b32 v69, 16, v82
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v67, 16, v80
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v23, v49, v66 :: v_dual_lshlrev_b32 v70, 16, v83
	v_fmac_f32_e32 v12, v47, v64
	v_dual_fmac_f32 v22, v50, v65 :: v_dual_lshlrev_b32 v63, 16, v76
	v_dual_fmac_f32 v15, v53, v70 :: v_dual_lshlrev_b32 v68, 16, v81
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v26, v55, v64 :: v_dual_fmac_f32 v25, v48, v63
	v_dual_fmac_f32 v14, v54, v69 :: v_dual_fmac_f32 v19, v51, v68
	v_fmac_f32_e32 v24, v56, v63
	v_dual_fmac_f32 v18, v52, v67 :: v_dual_fmac_f32 v21, v57, v66
	v_dual_fmac_f32 v20, v58, v65 :: v_dual_fmac_f32 v17, v59, v68
	v_dual_fmac_f32 v16, v60, v67 :: v_dual_fmac_f32 v13, v61, v70
	v_fmac_f32_e32 v11, v62, v69
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
...
; %bb.7:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v36, s11 :: v_dual_add_nc_u32 v3, 0, v1
	v_dual_mov_b32 v35, s10 :: v_dual_add_nc_u32 v4, 0, v2
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	v_xad_u32 v2, v2, 8, 0
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_xad_u32 v1, v1, 8, 0
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[9:10], v[44:45], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[9:10], v[46:47], v[29:36] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[37:38], v[48:49], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[29:36], v[37:38], v[50:51], v[29:36] neg_lo:[1,1,0]
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
...
.LBB0_8:
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v38, v38, v45 :: v_dual_add_nc_u32 v33, 20, v27
	v_dual_mul_f32 v37, v37, v45 :: v_dual_add_nc_u32 v32, 16, v27
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	buffer_load_u16 v28, v28, s[20:23], 0 offen
	v_cndmask_b32_e64 v29, 0x80000000, v29, s2
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v39, v39, v45 :: v_dual_add_nc_u32 v44, 24, v27
	v_dual_mul_f32 v34, v34, v45 :: v_dual_add_nc_u32 v27, 28, v27
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	v_dual_mul_f32 v9, v9, v45 :: v_dual_and_b32 v0, 16, v0
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v36, v36, v45 :: v_dual_and_b32 v43, 0x78, v43
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v1, v1, v28, v12
	v_fma_f32 v10, v10, v28, v26
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_waitcnt vmcnt(5)
	...
	v_fma_f32 v6, v6, v31, v18
	v_fma_f32 v5, v5, v32, v19
	v_fma_f32 v12, v39, v28, v20
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v4, v4, v28, v22
	v_fma_f32 v28, v34, v31, v16
	v_fma_f32 v9, v9, v32, v17
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_and_b32_e32 v19, 1, v53
	v_add3_u32 v3, v3, v17, 0x7fff
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v29, v37, v29, v24
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_cndmask_b16 v9.l, 0x7fff, v6.h, s10
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v7, v7, v33, v15
	v_fma_f32 v30, v35, v33, v13
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_add3_u32 v8, v8, v23, 0x7fff
	v_add3_u32 v2, v24, v14, 0x7fff
	...
	v_cndmask_b32_e32 v10, 0x1054, v46, vcc_lo
	...
	v_dual_cndmask_b32 v7, v9, v2 :: v_dual_cndmask_b32 v2, v2, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 48
