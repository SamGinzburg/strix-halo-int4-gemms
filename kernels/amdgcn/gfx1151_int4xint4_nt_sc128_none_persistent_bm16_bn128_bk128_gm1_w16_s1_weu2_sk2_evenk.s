	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
.Lfunc_begin0:
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_add_i32 s6, s3, 1
	s_cmp_ge_u32 s0, s38
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v91, 0
	...
	s_add_i32 s13, s7, 1
	s_cmp_ge_u32 s11, s0
	v_dual_mov_b32 v97, 0 :: v_dual_mov_b32 v68, 0
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v87, 0 :: v_dual_mov_b32 v54, 0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v121, v121, v160 :: v_dual_add_nc_u32 v118, 2, v118
	...
	v_dual_fmac_f32 v108, v194, v182 :: v_dual_mul_f32 v199, v216, v160
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(18)
	v_dual_mul_f32 v202, v219, v160 :: v_dual_lshlrev_b32 v171, 16, v171
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v102, v196, v180
	s_waitcnt vmcnt(17)
	v_dual_fmac_f32 v98, v198, v179 :: v_dual_lshlrev_b32 v173, 16, v173
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(16)
	v_lshlrev_b32_e32 v170, 16, v170
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v200, v217, v160
	v_mul_f32_e32 v201, v218, v160
	v_mul_f32_e32 v203, v220, v160
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v113, v192, v173
	v_fmac_f32_e32 v111, v193, v170
	v_fmac_f32_e32 v81, v200, v171
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v176, v176, v160
	v_mul_f32_e32 v166, v166, v160
	v_mul_f32_e32 v122, v122, v160
	v_dual_mul_f32 v124, v124, v160 :: v_dual_add_nc_u32 v159, s48, v117
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v106, v191, v183
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_clause 0x1
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(30)
	v_dual_mul_f32 v123, v123, v160 :: v_dual_lshlrev_b32 v174, 16, v174
	v_dual_mul_f32 v195, v212, v160 :: v_dual_fmac_f32 v100, v197, v181
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x1
	...
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v95, v199, v174
	s_waitcnt vmcnt(30)
	v_dual_fmac_f32 v105, v195, v178 :: v_dual_lshlrev_b32 v172, 16, v172
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(32)
	v_dual_fmac_f32 v78, v201, v175 :: v_dual_lshlrev_b32 v161, 16, v161
	.loc	1 274 24 is_stmt 0              ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v177, v177, v160
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(31)
	v_dual_fmac_f32 v70, v176, v162 :: v_dual_lshlrev_b32 v165, 16, v165
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(30)
	v_lshlrev_b32_e32 v163, 16, v163
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v167, v167, v160 :: v_dual_fmac_f32 v112, v166, v161
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v107, v122, v185 :: v_dual_lshlrev_b32 v186, 16, v186
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v101, v124, v187 :: v_dual_fmac_f32 v72, v177, v164
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x5
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(39)
	v_dual_mul_f32 v145, v145, v160 :: v_dual_lshlrev_b32 v190, 16, v190
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v104, v123, v186 :: v_dual_mul_f32 v149, v149, v160
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v97, v126, v189 :: v_dual_add_nc_u32 v116, s44, v116
	s_waitcnt vmcnt(38)
	v_dual_fmac_f32 v94, v127, v190 :: v_dual_lshlrev_b32 v183, 16, v183
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(37)
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v109, v135, v182 :: v_dual_lshlrev_b32 v200, 16, v200
	s_waitcnt vmcnt(17)
	v_dual_fmac_f32 v103, v136, v194 :: v_dual_lshlrev_b32 v172, 16, v172
	.loc	1 274 24 is_stmt 0              ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(16)
	v_dual_mul_f32 v147, v147, v160 :: v_dual_lshlrev_b32 v202, 16, v202
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v80, v128, v183 :: v_dual_mul_f32 v151, v151, v160
	v_fmac_f32_e32 v96, v137, v178
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v153, v153, v160 :: v_dual_fmac_f32 v66, v143, v179
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v77, v129, v191
	v_dual_fmac_f32 v110, v121, v184 :: v_dual_fmac_f32 v75, v130, v173
	v_fmac_f32_e32 v71, v132, v170
	v_fmac_f32_e32 v69, v133, v193
	v_fmac_f32_e32 v67, v134, v159
	v_fmac_f32_e32 v93, v138, v195
	v_fmac_f32_e32 v85, v141, v181
	v_fmac_f32_e32 v83, v142, v197
	v_fmac_f32_e32 v65, v144, v198
	v_dual_fmac_f32 v63, v145, v174 :: v_dual_fmac_f32 v92, v151, v172
	v_fmac_f32_e32 v59, v147, v171
	...
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v99, v125, v188 :: v_dual_fmac_f32 v60, v2, v163
	v_fmac_f32_e32 v79, v158, v176
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(7)
	v_lshlrev_b32_e32 v168, 16, v168
	s_waitcnt vmcnt(6)
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v157, v157, v160 :: v_dual_fmac_f32 v88, v154, v203
	v_dual_mul_f32 v1, v1, v160 :: v_dual_fmac_f32 v84, v156, v177
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v3, v3, v160 :: v_dual_fmac_f32 v82, v157, v162
	v_dual_mul_f32 v7, v7, v160 :: v_dual_fmac_f32 v62, v1, v169
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v73, v131, v192 :: v_dual_fmac_f32 v56, v4, v161
	...
	v_dual_fmac_f32 v55, v149, v175 :: v_dual_fmac_f32 v86, v155, v164
	v_dual_fmac_f32 v91, v152, v202 :: v_dual_fmac_f32 v14, v7, v120
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v34, v103, v91 offset0:64 offset1:96
	ds_store_2addr_b32 v35, v111, v110 offset1:32
	ds_store_2addr_b32 v35, v96, v90 offset0:64 offset1:96
	ds_store_2addr_b32 v36, v108, v107 offset1:32
	ds_store_2addr_b32 v36, v93, v88 offset0:64 offset1:96
	ds_store_2addr_b32 v37, v105, v104 offset1:32
	ds_store_2addr_b32 v37, v89, v86 offset0:64 offset1:96
	ds_store_2addr_b32 v38, v102, v101 offset1:32
	ds_store_2addr_b32 v38, v87, v84 offset0:64 offset1:96
	ds_store_2addr_b32 v39, v100, v99 offset1:32
	ds_store_2addr_b32 v39, v85, v82 offset0:64 offset1:96
	ds_store_2addr_b32 v40, v98, v97 offset1:32
	ds_store_2addr_b32 v40, v83, v79 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v43, v78, v77 offset1:32
	ds_store_2addr_b32 v43, v63, v60 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v45, v59, v56 offset0:64 offset1:96
	ds_store_2addr_b32 v46, v72, v71 offset1:32
	ds_store_2addr_b32 v46, v57, v53 offset0:64 offset1:96
	ds_store_2addr_b32 v47, v70, v69 offset1:32
	ds_store_2addr_b32 v47, v55, v52 offset0:64 offset1:96
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.num_vgpr, 221
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_evenk.kd
