...
.Ltmp14:
	...
	s_mov_b32 s10, s4
	s_mov_b32 s11, s4
	v_dual_mov_b32 v161, 0 :: v_dual_and_b32 v98, 0x70, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v162, v162, v23 :: v_dual_add_f32 v155, v155, v13
	v_dual_add_f32 v160, v160, v24 :: v_dual_add_f32 v157, v157, v11
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_f32 v158, v158, v10 :: v_dual_add_f32 v153, v153, v15
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	v_add_nc_u32_e32 v13, s4, v96
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_add_f32_e32 v154, v154, v14
	v_add_f32_e32 v152, v152, v16
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_cvt_f32_i32_e32 v31, v31
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v151, v151, v25 :: v_dual_add_f32 v150, v150, v26
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v149, v149, v27 :: v_dual_add_f32 v148, v148, v28
	v_add_f32_e32 v143, v143, v33
	v_dual_add_f32 v147, v147, v29 :: v_dual_add_f32 v146, v146, v30
	v_add_f32_e32 v141, v141, v35
	v_dual_add_f32 v145, v145, v31 :: v_dual_add_f32 v144, v144, v32
	v_dual_add_f32 v139, v139, v37 :: v_dual_add_f32 v142, v142, v34
	v_add_f32_e32 v137, v137, v39
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v140, v140, v36 :: v_dual_add_f32 v135, v135, v41
	v_dual_add_f32 v138, v138, v38 :: v_dual_add_f32 v133, v133, v43
	v_dual_add_f32 v136, v136, v40 :: v_dual_add_f32 v131, v131, v45
	v_dual_add_f32 v134, v134, v42 :: v_dual_add_f32 v129, v129, v47
	v_dual_add_f32 v132, v132, v44 :: v_dual_add_f32 v127, v127, v49
	v_dual_add_f32 v130, v130, v46 :: v_dual_add_f32 v125, v125, v51
	v_dual_add_f32 v128, v128, v48 :: v_dual_add_f32 v123, v123, v53
	v_dual_add_f32 v122, v122, v54 :: v_dual_add_f32 v121, v121, v55
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	...
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	v_add_nc_u32_e32 v23, s4, v91
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_cvt_f32_i32_e32 v69, v21
	v_cvt_f32_i32_e32 v57, v57
	v_cvt_f32_i32_e32 v59, v59
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_add_f32_e32 v118, v118, v58
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	...
	s_add_i32 s31, s8, 0
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v164, v164, v69 :: v_dual_add_f32 v163, v163, v70
	v_dual_add_f32 v119, v119, v57 :: v_dual_add_f32 v116, v116, v60
	v_dual_add_f32 v117, v117, v59 :: v_dual_add_f32 v114, v114, v62
	v_dual_add_f32 v115, v115, v61 :: v_dual_add_f32 v112, v112, v64
	v_dual_add_f32 v113, v113, v63 :: v_dual_add_f32 v110, v110, v72
	v_dual_add_f32 v111, v111, v71 :: v_dual_add_f32 v108, v108, v74
	v_dual_add_f32 v109, v109, v73 :: v_dual_add_f32 v106, v106, v75
...
; %bb.8:
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v104, v104, v4 :: v_dual_add_f32 v105, v105, v3
.LBB0_9:
...
; %bb.10:
	...
	v_add_nc_u32_e32 v170, s33, v107
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
...
.LBB0_11:
	...
	v_or_b32_e32 v65, s29, v107
	.loc	1 300 14                        ; generate_amdgcn.py:300:14
	v_or_b32_e32 v68, s30, v0
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v5, v106, v5 :: v_dual_add_f32 v6, v105, v6
	.loc	1 380 16                        ; generate_amdgcn.py:380:16
	...
	v_cndmask_b32_e64 v105, v105, v6, s2
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	...
	v_cndmask_b32_e64 v107, v122, v54, s2
	...
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v72, v106, v5, s2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 380 16                        ; generate_amdgcn.py:380:16
	...
	v_dual_mul_f32 v114, v10, v18 :: v_dual_mul_f32 v125, v1, v21
	v_dual_mul_f32 v116, v12, v18 :: v_dual_mul_f32 v127, v3, v21
	v_dual_mul_f32 v123, v15, v18 :: v_dual_mul_f32 v130, v6, v21
	...
	v_dual_mul_f32 v57, v15, v17 :: v_dual_mul_f32 v106, v8, v18
	v_dual_mul_f32 v122, v14, v18 :: v_dual_mul_f32 v129, v5, v21
	v_mul_f32_e32 v135, v11, v21
	v_mul_f32_e32 v145, v5, v25
	v_dual_mul_f32 v120, v13, v18 :: v_dual_mul_f32 v131, v7, v21
	v_mul_f32_e32 v147, v7, v25
	v_dual_mul_f32 v113, v9, v18 :: v_dual_mul_f32 v126, v2, v21
	v_dual_mul_f32 v115, v11, v18 :: v_dual_mul_f32 v128, v4, v21
	v_dual_mul_f32 v124, v16, v18 :: v_dual_mul_f32 v133, v9, v21
	v_mul_f32_e32 v136, v12, v21
	v_mul_f32_e32 v149, v9, v25
	v_dual_mul_f32 v132, v8, v21 :: v_dual_mul_f32 v17, v82, v38
	...
	v_dual_mul_f32 v146, v6, v25 :: v_dual_mul_f32 v69, v24, v58
	v_mul_f32_e32 v148, v8, v25
	v_dual_mul_f32 v150, v10, v25 :: v_dual_mul_f32 v7, v96, v126
	v_dual_mul_f32 v151, v11, v25 :: v_dual_mul_f32 v38, v92, v114
	v_mul_f32_e32 v152, v12, v25
	v_mul_f32_e32 v153, v13, v25
	v_mul_f32_e32 v154, v14, v25
	v_mul_f32_e32 v155, v15, v25
	v_mul_f32_e32 v156, v16, v25
	.loc	1 380 9 is_stmt 0               ; generate_amdgcn.py:380:9
	v_mul_f32_e32 v1, v78, v29
	v_mul_f32_e32 v9, v80, v34
	v_dual_mul_f32 v13, v81, v37 :: v_dual_mul_f32 v58, v39, v123
	v_mul_f32_e32 v2, v89, v59
	v_mul_f32_e32 v10, v27, v67
	v_mul_f32_e32 v11, v43, v127
	v_mul_f32_e32 v3, v95, v125
	v_dual_mul_f32 v39, v100, v134 :: v_dual_mul_f32 v4, v119, v141
	v_dual_mul_f32 v18, v90, v71 :: v_dual_mul_f32 v37, v87, v49
	v_dual_mul_f32 v12, v117, v143 :: v_dual_mul_f32 v21, v83, v41
	v_mul_f32_e32 v41, v19, v50
	v_mul_f32_e32 v49, v88, v54
	v_dual_mul_f32 v29, v85, v45 :: v_dual_mul_f32 v8, v118, v142
	v_dual_mul_f32 v45, v20, v53 :: v_dual_mul_f32 v24, v62, v146
	v_mul_f32_e32 v53, v22, v55
	v_mul_f32_e32 v22, v30, v74
	v_dual_mul_f32 v30, v32, v106 :: v_dual_mul_f32 v19, v97, v129
	v_dual_mul_f32 v43, v51, v135 :: v_dual_mul_f32 v20, v61, v145
	v_mul_f32_e32 v25, v84, v42
	v_mul_f32_e32 v6, v26, v66
	v_mul_f32_e32 v14, v28, v70
	v_mul_f32_e32 v26, v31, v104
	v_mul_f32_e32 v27, v47, v131
	v_mul_f32_e32 v28, v63, v147
	v_dual_mul_f32 v5, v79, v33 :: v_dual_mul_f32 v54, v94, v122
	v_dual_mul_f32 v33, v86, v46 :: v_dual_mul_f32 v34, v91, v113
	v_dual_mul_f32 v31, v48, v132 :: v_dual_mul_f32 v42, v35, v115
	v_dual_mul_f32 v46, v36, v116 :: v_dual_mul_f32 v35, v99, v133
	v_dual_mul_f32 v47, v52, v136 :: v_dual_mul_f32 v36, v111, v149
	v_dual_mul_f32 v57, v23, v57 :: v_dual_mul_f32 v16, v60, v144
	v_mul_f32_e32 v50, v93, v120
	v_mul_f32_e32 v70, v40, v124
	v_mul_f32_e32 v15, v44, v128
	v_mul_f32_e32 v23, v98, v130
	v_dual_mul_f32 v51, v102, v137 :: v_dual_mul_f32 v44, v109, v151
	v_dual_mul_f32 v55, v107, v138 :: v_dual_mul_f32 v48, v108, v152
	v_dual_mul_f32 v59, v121, v139 :: v_dual_mul_f32 v52, v72, v153
	v_dual_mul_f32 v71, v56, v140 :: v_dual_mul_f32 v56, v105, v154
	v_mul_f32_e32 v32, v112, v148
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 38
