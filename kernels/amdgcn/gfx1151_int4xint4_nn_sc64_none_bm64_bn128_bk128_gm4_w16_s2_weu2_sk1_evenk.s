...
.Ltmp0:
	...
	v_dual_mov_b32 v13, 0 :: v_dual_lshlrev_b32 v2, 3, v26
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v55, v63, v55 :: v_dual_lshlrev_b32 v62, 16, v62
	...
	v_dual_mul_f32 v52, v52, v62 :: v_dual_mul_f32 v57, v63, v57
	v_dual_mul_f32 v53, v53, v62 :: v_dual_mul_f32 v56, v63, v56
	...
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v25, v47, v62 :: v_dual_lshlrev_b32 v64, 16, v64
	.loc	1 180 20 is_stmt 0              ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v58, v63, v58
	v_dual_mul_f32 v60, v63, v60 :: v_dual_fmac_f32 v15, v57, v66
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v10, v46, v65 :: v_dual_fmac_f32 v21, v51, v68
	v_dual_fmac_f32 v24, v48, v67 :: v_dual_fmac_f32 v17, v55, v62
	v_dual_fmac_f32 v23, v49, v66 :: v_dual_fmac_f32 v22, v50, v69
	v_dual_fmac_f32 v13, v59, v68 :: v_dual_fmac_f32 v20, v52, v70
	v_fmac_f32_e32 v11, v61, v64
	v_dual_fmac_f32 v19, v53, v64 :: v_dual_fmac_f32 v18, v54, v65
	v_fmac_f32_e32 v16, v56, v67
	v_fmac_f32_e32 v14, v58, v69
	v_fmac_f32_e32 v12, v60, v70
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 83
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 44
