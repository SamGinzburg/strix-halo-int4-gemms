...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v119, 0x80, v0
	v_dual_mov_b32 v11, 0 :: v_dual_and_b32 v118, 15, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v121, 0 :: v_dual_and_b32 v26, 0xe0, v0
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mov_b32 v204, 0 :: v_dual_add_nc_u32 v1, s72, v118
	.loc	1 1046 21                       ; ragged.py:1046:21
	...
	v_mul_lo_u32 v122, v1, s34
	v_dual_mov_b32 v200, 0 :: v_dual_lshlrev_b32 v1, 1, v0
	...
	v_dual_mov_b32 v196, 0 :: v_dual_and_b32 v13, 0xf0, v0
	v_dual_mov_b32 v211, 0 :: v_dual_lshlrev_b32 v14, 5, v0
	v_dual_mov_b32 v190, 0 :: v_dual_add_nc_u32 v17, s72, v25
	...
	.loc	1 1205 25 is_stmt 1             ; ragged.py:1205:25
	v_mul_lo_u32 v123, v2, s34
	v_mul_lo_u32 v124, v3, s34
	v_cndmask_b32_e64 v2, 0x88, 0, s2
	v_dual_mov_b32 v198, 0 :: v_dual_and_b32 v3, 24, v1
	...
	v_dual_mov_b32 v209, 0 :: v_dual_lshlrev_b32 v18, 2, v13
	v_dual_mov_b32 v191, 0 :: v_dual_and_b32 v14, 32, v14
	v_add3_u32 v147, 0, v118, v10
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v10, 8, v17
	v_dual_mov_b32 v186, 0 :: v_dual_add_nc_u32 v19, 16, v17
	...
	v_xor_b32_e32 v126, v2, v120
	v_lshl_or_b32 v127, v118, 5, v3
	v_mad_u64_u32 v[109:110], null, s78, 24, v[90:91]
	v_mad_u64_u32 v[110:111], null, s78, 25, v[90:91]
	v_add3_u32 v14, 0, v18, v14
	v_mul_lo_u32 v153, v17, s36
	v_mul_lo_u32 v154, v10, s36
	v_mul_lo_u32 v155, v19, s36
	v_dual_mov_b32 v187, 0 :: v_dual_add_nc_u32 v10, 24, v17
	v_dual_mov_b32 v185, 0 :: v_dual_add_nc_u32 v18, 32, v17
	v_dual_mov_b32 v182, 0 :: v_dual_add_nc_u32 v19, 40, v17
	v_dual_mov_b32 v183, 0 :: v_dual_add_nc_u32 v20, 48, v17
	v_dual_mov_b32 v180, 0 :: v_dual_add_nc_u32 v17, 56, v17
	...
	.loc	1 1205 25 is_stmt 1             ; ragged.py:1205:25
	v_mul_lo_u32 v125, v4, s34
	v_xor_b32_e32 v2, 0x110, v126
	v_xor_b32_e32 v3, 8, v127
	v_xor_b32_e32 v4, 16, v127
	v_xor_b32_e32 v5, 24, v127
	...
	v_dual_mov_b32 v188, 0 :: v_dual_and_b32 v1, 28, v1
	v_dual_mov_b32 v184, 0 :: v_dual_lshlrev_b32 v13, 1, v13
	...
	v_mul_lo_u32 v166, v10, s36
	v_mul_lo_u32 v167, v18, s36
	v_mul_lo_u32 v168, v19, s36
	v_mul_lo_u32 v169, v20, s36
	v_mul_lo_u32 v170, v17, s36
	v_mad_u64_u32 v[116:117], null, s78, 31, v[90:91]
	v_lshl_add_u32 v181, s78, 4, v90
	v_dual_mov_b32 v179, 0 :: v_dual_add_nc_u32 v192, 0, v2
	v_dual_mov_b32 v178, 0 :: v_dual_add_nc_u32 v193, 0, v3
	v_dual_mov_b32 v177, 0 :: v_dual_add_nc_u32 v194, 0, v4
	v_dual_mov_b32 v176, 0 :: v_dual_add_nc_u32 v195, 0, v5
	v_dual_mov_b32 v174, 0 :: v_dual_add_nc_u32 v197, 0, v0
	v_dual_mov_b32 v172, 0 :: v_dual_add_nc_u32 v199, 0, v6
	v_dual_mov_b32 v164, 0 :: v_dual_add_nc_u32 v201, 0, v7
	v_dual_mov_b32 v162, 0 :: v_dual_add_nc_u32 v203, 0, v8
	v_dual_mov_b32 v160, 0 :: v_dual_add_nc_u32 v205, 0, v9
	v_dual_mov_b32 v175, 0 :: v_dual_add_nc_u32 v206, 0, v11
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v207, 0, v12
	v_dual_mov_b32 v173, 0 :: v_dual_add_nc_u32 v208, 0, v15
	v_dual_mov_b32 v171, 0 :: v_dual_add_nc_u32 v210, 0, v16
	v_dual_mov_b32 v165, 0 :: v_dual_add_nc_u32 v212, v14, v1
	v_dual_mov_b32 v163, 0 :: v_dual_add_nc_u32 v214, 0, v13
...
.LBB0_5:                                ; =>This Loop Header: Depth=1
	...
	v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, v121
	v_mov_b32_e32 v3, v121
	v_dual_mov_b32 v4, v121 :: v_dual_mov_b32 v9, 0
	v_mov_b32_e32 v5, v121
	v_dual_mov_b32 v6, v121 :: v_dual_mov_b32 v17, 0
	v_mov_b32_e32 v7, v121
	v_dual_mov_b32 v8, v121 :: v_dual_mov_b32 v25, 0
	v_dual_mov_b32 v10, v121 :: v_dual_mov_b32 v33, 0
	v_mov_b32_e32 v11, v121
	v_dual_mov_b32 v12, v121 :: v_dual_mov_b32 v41, 0
	v_mov_b32_e32 v13, v121
	v_dual_mov_b32 v14, v121 :: v_dual_mov_b32 v49, 0
	v_mov_b32_e32 v15, v121
	v_dual_mov_b32 v16, v121 :: v_dual_mov_b32 v57, 0
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_add_nc_u32_e32 v66, v153, v65
	v_add_nc_u32_e32 v68, v155, v65
	v_add_nc_u32_e32 v70, v167, v65
	v_add_nc_u32_e32 v72, v169, v65
	.loc	1 1156 34                       ; ragged.py:1156:34
	buffer_load_u8 v225, v73, s[16:19], 0 offen
	v_lshl_add_u32 v73, s78, 1, v90
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_add_nc_u32_e32 v67, v154, v65
	v_add_nc_u32_e32 v69, v166, v65
	v_add_nc_u32_e32 v71, v168, v65
	v_add_nc_u32_e32 v65, v170, v65
	v_add_nc_u32_e32 v73, s25, v73
	...
	ds_load_u8 v224, v147 offset:1280
	ds_load_u8 v225, v147 offset:1024
	ds_load_u8 v226, v147 offset:1920
	ds_load_u8 v227, v147 offset:1664
	ds_load_u8 v228, v147 offset:1408
	ds_load_u8 v229, v147 offset:1152
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v224, v225, v224, 0xc0c0004
	ds_load_u8 v225, v147 offset:1792
	ds_load_u8 v230, v147 offset:1536
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v230, v147 offset:256
	ds_load_u8 v231, v147
	ds_load_u8 v232, v147 offset:896
	ds_load_u8 v233, v147 offset:640
	ds_load_u8 v234, v147 offset:384
	ds_load_u8 v235, v147 offset:128
	v_lshl_or_b32 v225, v225, 16, v224
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v230, v231, v230, 0xc0c0004
	ds_load_u8 v231, v147 offset:768
	ds_load_u8 v236, v147 offset:512
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v216, v147 offset:3328
	ds_load_u8 v217, v147 offset:3072
	ds_load_u8 v218, v147 offset:3968
	ds_load_u8 v219, v147 offset:3712
	ds_load_u8 v220, v147 offset:3456
	ds_load_u8 v221, v147 offset:3200
	v_wmma_i32_16x16x16_iu4 v[57:64], v[226:227], v[222:223], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v216, v217, v216, 0xc0c0004
	ds_load_u8 v217, v147 offset:3840
	ds_load_u8 v222, v147 offset:3584
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v222, v147 offset:2304
	ds_load_u8 v223, v147 offset:2048
	ds_load_u8 v224, v147 offset:2944
	ds_load_u8 v225, v147 offset:2688
	ds_load_u8 v226, v147 offset:2432
	ds_load_u8 v227, v147 offset:2176
	v_lshl_or_b32 v217, v217, 16, v216
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v222, v223, v222, 0xc0c0004
	ds_load_u8 v223, v147 offset:2816
	ds_load_u8 v228, v147 offset:2560
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v81, v147 offset:5376
	ds_load_u8 v82, v147 offset:5120
	ds_load_u8 v83, v147 offset:6016
	ds_load_u8 v84, v147 offset:5760
	ds_load_u8 v85, v147 offset:5504
	ds_load_u8 v86, v147 offset:5248
	v_wmma_i32_16x16x16_iu4 v[25:32], v[218:219], v[87:88], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	ds_load_u8 v82, v147 offset:5888
	ds_load_u8 v87, v147 offset:5632
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v87, v147 offset:4352
	ds_load_u8 v88, v147 offset:4096
	ds_load_u8 v216, v147 offset:4992
	ds_load_u8 v217, v147 offset:4736
	ds_load_u8 v218, v147 offset:4480
	ds_load_u8 v219, v147 offset:4224
	v_lshl_or_b32 v82, v82, 16, v81
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v147 offset:4864
	ds_load_u8 v220, v147 offset:4608
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v73, v147 offset:7424
	ds_load_u8 v74, v147 offset:7168
	ds_load_u8 v75, v147 offset:8064
	ds_load_u8 v76, v147 offset:7808
	ds_load_u8 v77, v147 offset:7552
	ds_load_u8 v78, v147 offset:7296
	v_wmma_i32_16x16x16_iu4 v[25:32], v[83:84], v[79:80], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v147 offset:7936
	ds_load_u8 v79, v147 offset:7680
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v79, v147 offset:6400
	ds_load_u8 v80, v147 offset:6144
	ds_load_u8 v81, v147 offset:7040
	ds_load_u8 v82, v147 offset:6784
	ds_load_u8 v83, v147 offset:6528
	ds_load_u8 v84, v147 offset:6272
	v_lshl_or_b32 v74, v74, 16, v73
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v79, v80, v79, 0xc0c0004
	ds_load_u8 v80, v147 offset:6912
	ds_load_u8 v85, v147 offset:6656
	s_waitcnt lgkmcnt(2)
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v65, s35, v122, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_add_i32 s18, s35, s33
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v66, s35, v123, 1
	v_add_lshl_u32 v67, s35, v124, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_mul_i32 s18, s18, s78
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v68, s35, v125, 1
	...
	v_dual_fmac_f32 v177, v23, v7 :: v_dual_fmac_f32 v174, v26, v10
	v_dual_fmac_f32 v175, v25, v9 :: v_dual_fmac_f32 v172, v28, v12
	v_dual_fmac_f32 v173, v27, v11 :: v_dual_fmac_f32 v162, v33, v1
	v_dual_fmac_f32 v171, v29, v13 :: v_dual_fmac_f32 v164, v31, v15
	v_dual_fmac_f32 v165, v30, v14 :: v_dual_fmac_f32 v160, v35, v3
	v_dual_fmac_f32 v163, v32, v16 :: v_dual_fmac_f32 v158, v37, v5
	v_dual_fmac_f32 v161, v34, v2 :: v_dual_fmac_f32 v156, v39, v7
	v_dual_fmac_f32 v159, v36, v4 :: v_dual_fmac_f32 v150, v42, v10
	v_dual_fmac_f32 v157, v38, v6 :: v_dual_fmac_f32 v152, v40, v8
	v_dual_fmac_f32 v151, v41, v9 :: v_dual_fmac_f32 v148, v44, v12
	v_dual_fmac_f32 v149, v43, v11 :: v_dual_fmac_f32 v140, v49, v1
	v_dual_fmac_f32 v145, v45, v13 :: v_dual_fmac_f32 v142, v47, v15
	v_dual_fmac_f32 v143, v46, v14 :: v_dual_fmac_f32 v138, v51, v3
	v_dual_fmac_f32 v141, v48, v16 :: v_dual_fmac_f32 v136, v53, v5
	v_dual_fmac_f32 v139, v50, v2 :: v_dual_fmac_f32 v134, v55, v7
	v_dual_fmac_f32 v137, v52, v4 :: v_dual_fmac_f32 v132, v57, v9
	v_dual_fmac_f32 v135, v54, v6 :: v_dual_fmac_f32 v130, v59, v11
	v_dual_fmac_f32 v133, v56, v8 :: v_dual_fmac_f32 v128, v61, v13
	v_dual_fmac_f32 v131, v58, v10 :: v_dual_fmac_f32 v144, v63, v15
	v_dual_fmac_f32 v129, v60, v12 :: v_dual_fmac_f32 v146, v62, v14
	v_fmac_f32_e32 v117, v64, v16
	.loc	1 1135 19                       ; ragged.py:1135:19
	s_cbranch_scc1 .LBB0_5
; %bb.8:                                ; %._crit_edge.loopexit
	.loc	1 1234 19                       ; ragged.py:1234:19
	v_dual_max_f32 v37, v158, v158 :: v_dual_max_f32 v38, v157, v157
	v_max_f32_e32 v39, v156, v156
	v_dual_max_f32 v41, v151, v151 :: v_dual_max_f32 v44, v148, v148
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v37, 0, v37 :: v_dual_max_f32 v40, v152, v152
	v_dual_max_f32 v38, 0, v38 :: v_dual_max_f32 v39, 0, v39
	v_dual_max_f32 v42, v150, v150 :: v_dual_max_f32 v43, v149, v149
	...
	v_dual_max_f32 v43, 0, v43 :: v_dual_max_f32 v40, v145, v145
	v_dual_max_f32 v41, v143, v143 :: v_dual_max_f32 v44, v141, v141
	v_dual_max_f32 v42, v142, v142 :: v_dual_max_f32 v45, v140, v140
	v_dual_max_f32 v84, 0, v40 :: v_dual_max_f32 v85, 0, v41
	v_dual_max_f32 v40, v139, v139 :: v_dual_max_f32 v41, v138, v138
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_max_f32 v86, 0, v42 :: v_dual_max_f32 v87, 0, v44
	v_max_f32_e32 v88, 0, v45
	v_dual_max_f32 v42, v137, v137 :: v_dual_max_f32 v45, v135, v135
	v_max_f32_e32 v44, v136, v136
	v_dual_max_f32 v5, v204, v204 :: v_dual_max_f32 v6, v202, v202
	v_dual_max_f32 v7, v200, v200 :: v_dual_max_f32 v8, v198, v198
	...
	v_dual_max_f32 v25, v175, v175 :: v_dual_max_f32 v26, v174, v174
	v_dual_max_f32 v27, v173, v173 :: v_dual_max_f32 v28, v172, v172
	v_max_f32_e32 v29, v171, v171
	v_dual_max_f32 v89, 0, v40 :: v_dual_max_f32 v90, 0, v41
	v_dual_max_f32 v91, 0, v42 :: v_dual_max_f32 v92, 0, v44
	v_dual_max_f32 v93, 0, v45 :: v_dual_max_f32 v40, v134, v134
	v_dual_max_f32 v41, v133, v133 :: v_dual_max_f32 v42, v132, v132
	v_dual_max_f32 v45, v130, v130 :: v_dual_max_f32 v44, v131, v131
	v_dual_max_f32 v1, v215, v215 :: v_dual_max_f32 v2, v213, v213
	...
	v_max_f32_e32 v30, v165, v165
	v_dual_max_f32 v29, 0, v29 :: v_dual_max_f32 v32, v163, v163
	v_dual_max_f32 v31, v164, v164 :: v_dual_max_f32 v34, v161, v161
	v_max_f32_e32 v33, v162, v162
	v_dual_max_f32 v35, v160, v160 :: v_dual_max_f32 v36, v159, v159
	v_dual_max_f32 v94, 0, v40 :: v_dual_max_f32 v95, 0, v41
	v_dual_max_f32 v96, 0, v42 :: v_dual_max_f32 v97, 0, v44
	v_dual_max_f32 v98, 0, v45 :: v_dual_max_f32 v41, v128, v128
	v_max_f32_e32 v42, v146, v146
	v_max_f32_e32 v40, v129, v129
	v_dual_max_f32 v45, v117, v117 :: v_dual_max_f32 v44, v144, v144
	...
	v_dual_max_f32 v100, 0, v41 :: v_dual_mul_f32 v71, v3, v3
	v_max_f32_e32 v101, 0, v42
	v_max_f32_e32 v99, 0, v40
	v_dual_max_f32 v103, 0, v45 :: v_dual_max_f32 v102, 0, v44
	...
	v_dual_mul_f32 v13, v100, v100 :: v_dual_mul_f32 v12, v101, v101
	v_dual_mul_f32 v11, v102, v102 :: v_dual_mul_f32 v10, v103, v103
...
.Ltmp28:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_lshlrev_b32_e32 v86, 1, v119
	v_xor_b32_e32 v64, v64, v24
	v_lshl_add_u32 v34, v87, 4, v34
	v_lshrrev_b32_e32 v88, 3, v119
...
.Ltmp83:
	...
	v_dual_fmac_f32 v101, v82, v94 :: v_dual_fmac_f32 v100, v95, v89
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_and_b32_e32 v83, 15, v106
	v_and_b32_e32 v87, 15, v107
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 80
