	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	s_add_i32 s2, s2, s16
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s16, s35, s15
.Ltmp14:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_ashr_i32 s3, s12, 31
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add3_u32 v5, s33, s16, v5
...
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s24, s12, s2
.Ltmp19:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s12, 0xff
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v6, v7, v2, s14
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v5, s19, v5
	.loc	1 408 22 is_stmt 0              ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[19:22], v9, s[20:23], 0 offen
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_clause 0x1
	buffer_load_b32 v53, v7, s[4:7], 0 offen
	buffer_load_b32 v54, v6, s[4:7], 0 offen
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s12, 0x2ff
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_b32_e32 v9, 0x70, v5
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b32_e32 v10, 0x420, v7
	v_lshlrev_b32_e32 v5, 5, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v7, v6, 1, v9
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v9, v10, v4
	v_lshlrev_b32_e32 v6, 3, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_or_b32_e32 v12, 2, v7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v41, v8, 10, v9
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	...
	s_waitcnt vmcnt(2)
	v_perm_b32 v63, v33, v27, 0x5010400
	v_and_b16 v21.h, 0xff, v31.h
	...
	v_perm_b32 v27, v33, v27, 0x7030602
	...
	v_perm_b32 v33, v34, v28, 0x5010400
	v_perm_b32 v34, v34, v28, 0x7030602
	v_perm_b32 v64, v35, v29, 0x5010400
	v_perm_b32 v35, v35, v29, 0x7030602
	v_perm_b32 v65, v36, v30, 0x5010400
	v_perm_b32 v36, v36, v30, 0x7030602
	...
	v_or_b16 v16.l, v16.l, v26.l
	v_or_b16 v23.l, v23.l, v51.l
	v_or_b16 v23.h, v23.h, v51.h
	v_lshrrev_b32_e32 v51, 24, v27
	v_or_b16 v16.h, v16.h, v26.h
	v_or_b16 v19.l, v19.l, v31.l
	v_or_b16 v19.h, v19.h, v31.h
	v_or_b16 v24.l, v24.l, v52.l
	v_or_b16 v24.h, v24.h, v52.h
	v_and_b16 v25.l, 0xff, v63.l
	v_and_b16 v25.h, 0xff, v63.h
	v_lshrrev_b32_e32 v52, 8, v33
	v_lshrrev_b32_e32 v63, 24, v33
	v_and_b16 v28.l, 0xff, v34.l
	v_lshrrev_b32_e32 v66, 8, v34
	v_lshrrev_b32_e32 v67, 24, v34
	v_and_b16 v28.h, 0xff, v34.h
	v_and_b16 v29.l, 0xff, v64.l
	v_lshrrev_b32_e32 v34, 8, v64
	v_lshrrev_b32_e32 v68, 24, v64
	v_and_b16 v29.h, 0xff, v64.h
	v_and_b16 v30.l, 0xff, v35.l
	v_lshrrev_b32_e32 v64, 8, v35
	v_lshrrev_b32_e32 v69, 24, v35
	v_and_b16 v30.h, 0xff, v35.h
	v_and_b16 v31.l, 0xff, v65.l
	v_lshrrev_b32_e32 v35, 8, v65
	v_lshrrev_b32_e32 v70, 24, v65
	v_and_b16 v31.h, 0xff, v65.h
	v_lshrrev_b32_e32 v65, 8, v36
	v_lshrrev_b32_e32 v71, 24, v36
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v55, v53 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v56, v11
	ds_store_b16_d16_hi v56, v11 offset:64
	ds_store_b16 v57, v16
	ds_store_b16_d16_hi v57, v16 offset:64
	...
	ds_store_b16 v62, v24
	ds_store_b16_d16_hi v62, v24 offset:64
	v_lshlrev_b16 v11.l, 8, v48.l
	v_lshlrev_b16 v11.h, 8, v49.l
	...
	v_lshlrev_b16 v19.l, 8, v52.l
	v_lshlrev_b16 v19.h, 8, v63.l
	...
	v_lshlrev_b16 v23.l, 8, v35.l
	v_lshlrev_b16 v23.h, 8, v70.l
	v_lshlrev_b16 v24.l, 8, v65.l
	v_lshlrev_b16 v24.h, 8, v71.l
	v_or_b16 v11.l, v25.l, v11.l
	v_or_b16 v11.h, v25.h, v11.h
	v_or_b16 v16.l, v26.l, v16.l
	v_or_b16 v16.h, v26.h, v16.h
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v56, v11 offset:8192
	ds_store_b16_d16_hi v56, v11 offset:8256
	ds_store_b16 v57, v16 offset:8192
	ds_store_b16_d16_hi v57, v16 offset:8256
	...
	ds_store_b16 v62, v24 offset:8192
	ds_store_b16_d16_hi v62, v24 offset:8256
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_and_or_b32 v48, 0x1800, v5, v6
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s22, s15, 0x100
	s_mov_b32 s10, 0
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_3:                                ; %Flow23
	...
	v_or_b32_e32 v19, s14, v32
	s_ashr_i32 s1, s24, 8
	v_or_b32_e32 v35, s33, v7
	v_or_b32_e32 v34, s33, v12
	v_or_b32_e32 v33, s33, v13
	v_mul_lo_u32 v36, v19, s1
	v_or_b32_e32 v30, s33, v14
	v_or_b32_e32 v28, s33, v15
	v_or_b32_e32 v31, s33, v8
	v_or_b32_e32 v29, s33, v9
	v_or_b32_e32 v27, s33, v10
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_or_b32 v48, 0x1800, v5, v6
	v_add3_u32 v3, s15, v3, 0x200
	s_lshl_b32 s0, s31, 7
	v_bfe_i32 v7, v0, 5, 1
	v_add_nc_u32_e32 v5, 0x201, v4
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v4, 0x200, v4
	...
	v_add3_u32 v55, v3, s14, v2
	s_mov_b32 s26, 0x7ffffffe
	v_add3_u32 v5, v5, s0, v1
	v_add3_u32 v1, v4, s0, v1
	s_max_i32 s0, s1, 3
	s_and_b32 s25, s9, 0xffff
	s_mov_b32 s24, s8
	v_subrev_nc_u32_e32 v53, s10, v5
	v_subrev_nc_u32_e32 v54, s10, v1
	v_mov_b32_e32 v1, 0
	...
	v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v26, 0
	v_dual_mov_b32 v8, v1 :: v_dual_mov_b32 v21, 0
	v_or_b32_e32 v49, v6, v40
	v_mov_b32_e32 v6, v1
	s_mov_b32 s28, s16
	s_add_i32 s0, s0, -2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b32 v56, v55, s[4:7], 0 offen
	...
	buffer_load_b128 v[13:16], v53, s[20:23], 0 offen
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s15, s38, s15
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_ashr_i32 s15, s15, 8
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s39, s15, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v57, v36, s15, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cmp_lt_i32 s15, s1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v58, v35, s39, 1
	v_add_lshl_u32 v59, v34, s39, 1
	v_add_lshl_u32 v60, v33, s39, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v61, v30, s39, 1
	v_add_lshl_u32 v62, v28, s39, 1
	v_add_lshl_u32 v63, v31, s39, 1
	v_add_lshl_u32 v64, v29, s39, 1
	v_add_lshl_u32 v65, v27, s39, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v97, v57, s[24:27], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v98, v58, s[28:31], 0 offen
	buffer_load_u16 v99, v59, s[28:31], 0 offen
	buffer_load_u16 v100, v60, s[28:31], 0 offen
	buffer_load_u16 v101, v61, s[28:31], 0 offen
	buffer_load_u16 v102, v62, s[28:31], 0 offen
	buffer_load_u16 v103, v63, s[28:31], 0 offen
	buffer_load_u16 v104, v64, s[28:31], 0 offen
	buffer_load_u16 v105, v65, s[28:31], 0 offen
	s_mov_b32 s15, s10
	s_mov_b32 s10, s34
	s_mov_b32 s34, s18
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v57, s15, v32
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v58, s34, v49
	v_add_nc_u32_e32 v59, s34, v50
	v_add_nc_u32_e32 v60, s34, v51
	v_add_nc_u32_e32 v61, s34, v52
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v62, s15, v37
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[65:68], v58
	ds_load_b128 v[69:72], v59
	ds_load_b128 v[73:76], v60
	ds_load_b128 v[77:80], v61
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v58, v57 offset:208
	ds_load_u8 v59, v57 offset:240
	ds_load_u8 v60, v57 offset:224
	ds_load_u8 v61, v57 offset:192
	ds_load_u8 v63, v57 offset:144
	ds_load_u8 v64, v57 offset:176
	ds_load_u8 v81, v57 offset:160
	ds_load_u8 v82, v57 offset:128
	ds_load_u8 v83, v57 offset:80
	ds_load_u8 v84, v57 offset:112
	ds_load_u8 v85, v57 offset:96
	ds_load_u8 v86, v57 offset:64
	ds_load_u8 v87, v57
	ds_load_u8 v88, v57 offset:16
	ds_load_u8 v89, v57 offset:32
	ds_load_u8 v90, v57 offset:48
	ds_load_u8 v91, v57 offset:464
	ds_load_u8 v92, v57 offset:496
	ds_load_u8 v93, v57 offset:480
	ds_load_u8 v94, v57 offset:448
	ds_load_u8 v95, v57 offset:400
	ds_load_u8 v96, v57 offset:432
	ds_load_u8 v106, v57 offset:416
	ds_load_u8 v107, v57 offset:384
	ds_load_u8 v108, v57 offset:336
	ds_load_u8 v109, v57 offset:368
	ds_load_u8 v110, v57 offset:352
	ds_load_u8 v111, v57 offset:320
	ds_load_u8 v112, v57 offset:272
	ds_load_u8 v113, v57 offset:304
	ds_load_u8 v114, v57 offset:288
	ds_load_u8 v115, v57 offset:256
	ds_load_u8 v116, v57 offset:720
	ds_load_u8 v117, v57 offset:752
	ds_load_u8 v118, v57 offset:736
	ds_load_u8 v119, v57 offset:704
	ds_load_u8 v120, v57 offset:656
	ds_load_u8 v121, v57 offset:688
	ds_load_u8 v122, v57 offset:672
	ds_load_u8 v123, v57 offset:640
	ds_load_u8 v124, v57 offset:592
	ds_load_u8 v125, v57 offset:624
	ds_load_u8 v126, v57 offset:608
	ds_load_u8 v127, v57 offset:576
	ds_load_u8 v128, v57 offset:528
	ds_load_u8 v129, v57 offset:560
	ds_load_u8 v130, v57 offset:544
	ds_load_u8 v131, v57 offset:512
	ds_load_u8 v132, v57 offset:976
	ds_load_u8 v62, v62
	ds_load_u8 v133, v57 offset:992
	ds_load_u8 v134, v57 offset:960
	ds_load_u8 v135, v57 offset:912
	ds_load_u8 v136, v57 offset:944
	ds_load_u8 v137, v57 offset:928
	ds_load_u8 v138, v57 offset:896
	ds_load_u8 v139, v57 offset:848
	ds_load_u8 v140, v57 offset:880
	ds_load_u8 v141, v57 offset:864
	ds_load_u8 v142, v57 offset:832
	ds_load_u8 v143, v57 offset:784
	ds_load_u8 v144, v57 offset:816
	ds_load_u8 v145, v57 offset:800
	ds_load_u8 v57, v57 offset:768
	s_waitcnt lgkmcnt(60)
	v_perm_b32 v58, v61, v58, 0xc0c0004
	v_perm_b32 v59, v60, v59, 0xc0c0004
	s_waitcnt lgkmcnt(56)
	v_perm_b32 v60, v82, v63, 0xc0c0004
	v_perm_b32 v61, v81, v64, 0xc0c0004
	s_waitcnt lgkmcnt(52)
	v_perm_b32 v63, v86, v83, 0xc0c0004
	v_perm_b32 v64, v85, v84, 0xc0c0004
	s_waitcnt lgkmcnt(50)
	v_perm_b32 v81, v87, v88, 0xc0c0004
	s_waitcnt lgkmcnt(48)
	v_perm_b32 v85, v89, v90, 0xc0c0004
	s_waitcnt lgkmcnt(44)
	v_perm_b32 v86, v94, v91, 0xc0c0004
	v_perm_b32 v87, v93, v92, 0xc0c0004
	s_waitcnt lgkmcnt(40)
	v_perm_b32 v89, v107, v95, 0xc0c0004
	v_perm_b32 v90, v106, v96, 0xc0c0004
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v91, v111, v108, 0xc0c0004
	v_perm_b32 v92, v110, v109, 0xc0c0004
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v93, v115, v112, 0xc0c0004
	v_perm_b32 v94, v114, v113, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v95, v119, v116, 0xc0c0004
	v_perm_b32 v96, v118, v117, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v112, v134, v132, 0xc0c0004
	v_perm_b32 v62, v133, v62, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v57, v143, 0xc0c0004
	...
	v_lshl_or_b32 v96, v62, 16, v112
	v_lshl_or_b32 v93, v117, 16, v57
	v_wmma_i32_16x16x16_iu8 v[57:64], v[65:68], v[81:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lt_i32 s11, 2
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_lshl_or_b32 v90, v109, 16, v108
	v_lshl_or_b32 v89, v111, 16, v110
	v_wmma_i32_16x16x16_iu8 v[57:64], v[69:72], v[85:88], v[57:64] neg_lo:[1,1,0]
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_lshl_b32 s34, s11, 10
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_mov_b32 s18, s37
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_lshl_b32 s37, s11, 13
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[57:64], v[77:80], v[93:96], v[57:64] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s37, s37, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s0, s0, -1
	s_add_i32 s15, s38, 0x100
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_add_i32 s34, s39, 0x4000
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v148, s37, v42
	v_add_nc_u32_e32 v149, s37, v43
	v_add_nc_u32_e32 v150, s37, v44
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v64, v64
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v151, s37, v45
	v_add_nc_u32_e32 v153, s37, v47
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s0, 0
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(11)
	ds_store_b32 v146, v56 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(9)
	v_perm_b32 v56, v13, v9, 0x5010400
	v_perm_b32 v13, v13, v9, 0x7030602
	v_perm_b32 v57, v14, v10, 0x5010400
	...
	v_fmac_f32_e32 v26, v57, v71
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v147, v9
	ds_store_b16_d16_hi v147, v9 offset:64
	ds_store_b16 v148, v10
	ds_store_b16_d16_hi v148, v10 offset:64
	ds_store_b16 v149, v11
	ds_store_b16_d16_hi v149, v11 offset:64
	ds_store_b16 v150, v12
	ds_store_b16_d16_hi v150, v12 offset:64
	ds_store_b16 v151, v13
	ds_store_b16_d16_hi v151, v13 offset:64
	ds_store_b16 v147, v14 offset:640
	ds_store_b16_d16_hi v147, v14 offset:704
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v10, v56, v10 :: v_dual_add_nc_u32 v53, s19, v53
	v_dual_mul_f32 v9, v56, v9 :: v_dual_add_nc_u32 v54, s19, v54
	v_dual_mul_f32 v12, v56, v12 :: v_dual_add_nc_u32 v55, s36, v55
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v23, v12, v68 :: v_dual_add_nc_u32 v152, s37, v46
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v15.l, v15.l, v62.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v19, v9, v65
	v_dual_fmac_f32 v21, v10, v66 :: v_dual_fmac_f32 v22, v11, v67
	v_dual_fmac_f32 v24, v13, v69 :: v_dual_fmac_f32 v25, v14, v70
	v_fmac_f32_e32 v20, v56, v64
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v15.h, v15.h, v62.h
	v_or_b16 v16.l, v16.l, v63.l
	v_or_b16 v16.h, v16.h, v63.h
	ds_store_b16 v152, v15
	ds_store_b16_d16_hi v152, v15 offset:64
	ds_store_b16 v153, v16
	ds_store_b16_d16_hi v153, v16 offset:64
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v11, v37 :: v_dual_mov_b32 v16, v40
	v_dual_mov_b32 v49, v38 :: v_dual_mov_b32 v50, v39
	s_add_i32 s22, s38, 0x200
	s_branch .LBB0_8
.LBB0_7:
...
.LBB0_8:                                ; %Flow24
	...
	v_mov_b32_e32 v8, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v7, v3, v48
	v_mov_b32_e32 v3, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b32_e32 v39, v7, v16
	v_mov_b32_e32 v7, 0
	v_xor_b32_e32 v42, 16, v39
	v_xor_b32_e32 v43, 32, v39
	v_xor_b32_e32 v44, 48, v39
	s_cbranch_vccnz .LBB0_10
; %bb.9:
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v16, s10, v32
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v3, s18, v44
	v_add_nc_u32_e32 v7, s18, v43
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v38, v16 offset:240
	ds_load_u8 v40, v16 offset:144
	ds_load_u8 v41, v16 offset:176
	ds_load_u8 v45, v16 offset:160
	ds_load_u8 v46, v16 offset:128
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[3:6], v3
	ds_load_b128 v[7:10], v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v47, v16 offset:112
	ds_load_u8 v48, v16 offset:80
	ds_load_u8 v49, v16 offset:96
	ds_load_u8 v50, v16 offset:64
	ds_load_u8 v51, v16
	ds_load_u8 v52, v16 offset:16
	ds_load_u8 v57, v16 offset:32
	ds_load_u8 v58, v16 offset:48
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v41, v45, v41, 0xc0c0004
	v_mov_b32_e32 v45, 0
	ds_load_u8 v12, v16 offset:208
	ds_load_u8 v13, v16 offset:224
	ds_load_u8 v14, v16 offset:192
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v40, v46, v40, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v15, s18, v42
	v_add_nc_u32_e32 v37, s18, v39
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v61, v16 offset:336
	ds_load_u8 v62, v16 offset:352
	ds_load_u8 v63, v16 offset:320
	ds_load_u8 v64, v16 offset:272
	ds_load_u8 v65, v16 offset:304
	ds_load_u8 v66, v16 offset:288
	ds_load_u8 v67, v16 offset:256
	ds_load_u8 v70, v16 offset:496
	ds_load_u8 v71, v16 offset:400
	ds_load_u8 v72, v16 offset:432
	ds_load_u8 v73, v16 offset:416
	ds_load_u8 v74, v16 offset:384
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v46, v51, v52, 0xc0c0004
	v_mov_b32_e32 v52, v45
	v_mov_b32_e32 v51, v45
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v38, v13, v38, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v59, v14, v12, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v61, v63, v61, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v63, v66, v65, 0xc0c0004
	v_lshl_or_b32 v60, v38, 16, v59
	v_lshl_or_b32 v59, v41, 16, v40
	v_perm_b32 v38, v50, v48, 0xc0c0004
	v_perm_b32 v40, v49, v47, 0xc0c0004
	v_mov_b32_e32 v50, v45
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[12:15], v15
	ds_load_b128 v[53:56], v37
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v37, s10, v11
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_perm_b32 v47, v57, v58, 0xc0c0004
	v_lshl_or_b32 v58, v40, 16, v38
	ds_load_u8 v38, v16 offset:368
	ds_load_u8 v41, v16 offset:464
	ds_load_u8 v68, v16 offset:480
	ds_load_u8 v69, v16 offset:448
	ds_load_u8 v37, v37
	...
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v40, v69, v41, 0xc0c0004
	ds_load_u8 v41, v16 offset:592
	ds_load_u8 v69, v16 offset:608
	ds_load_u8 v75, v16 offset:576
	ds_load_u8 v76, v16 offset:528
	ds_load_u8 v77, v16 offset:560
	ds_load_u8 v78, v16 offset:544
	ds_load_u8 v79, v16 offset:512
	v_perm_b32 v70, v74, v71, 0xc0c0004
	v_perm_b32 v71, v73, v72, 0xc0c0004
	v_perm_b32 v38, v62, v38, 0xc0c0004
	v_perm_b32 v62, v67, v64, 0xc0c0004
	v_lshl_or_b32 v56, v68, 16, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v55, v71, 16, v70
	v_lshl_or_b32 v54, v38, 16, v61
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v53, v63, 16, v62
	ds_load_u8 v38, v16 offset:752
	ds_load_u8 v40, v16 offset:720
	ds_load_u8 v57, v16 offset:736
	ds_load_u8 v58, v16 offset:704
	ds_load_u8 v59, v16 offset:656
	ds_load_u8 v60, v16 offset:672
	ds_load_u8 v61, v16 offset:640
	ds_load_u8 v62, v16 offset:688
	ds_load_u8 v63, v16 offset:624
	ds_load_u8 v64, v16 offset:976
	ds_load_u8 v65, v16 offset:992
	ds_load_u8 v66, v16 offset:960
	ds_load_u8 v67, v16 offset:912
	ds_load_u8 v68, v16 offset:944
	ds_load_u8 v70, v16 offset:928
	ds_load_u8 v71, v16 offset:896
	ds_load_u8 v72, v16 offset:880
	ds_load_u8 v73, v16 offset:848
	ds_load_u8 v74, v16 offset:864
	ds_load_u8 v80, v16 offset:832
	ds_load_u8 v81, v16 offset:784
	ds_load_u8 v82, v16 offset:816
	ds_load_u8 v83, v16 offset:800
	ds_load_u8 v16, v16 offset:768
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v40, v58, v40, 0xc0c0004
	v_perm_b32 v38, v57, v38, 0xc0c0004
	s_waitcnt lgkmcnt(17)
	...
	v_wmma_i32_16x16x16_iu8 v[45:52], v[12:15], v[53:56], v[45:52] neg_lo:[1,1,0]
	v_lshl_or_b32 v15, v38, 16, v40
	v_perm_b32 v61, v78, v77, 0xc0c0004
	v_perm_b32 v60, v79, v76, 0xc0c0004
	v_lshl_or_b32 v14, v58, 16, v57
	v_lshl_or_b32 v13, v59, 16, v41
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v38, v66, v64, 0xc0c0004
	v_perm_b32 v37, v65, v37, 0xc0c0004
	v_lshl_or_b32 v12, v61, 16, v60
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v40, v71, v67, 0xc0c0004
	v_perm_b32 v41, v70, v68, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v53, v80, v73, 0xc0c0004
	v_perm_b32 v54, v74, v72, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v16, v16, v81, 0xc0c0004
	v_perm_b32 v55, v83, v82, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[45:52], v[7:10], v[12:15], v[45:52] neg_lo:[1,1,0]
	v_lshl_or_b32 v10, v37, 16, v38
	v_lshl_or_b32 v9, v41, 16, v40
	v_lshl_or_b32 v8, v54, 16, v53
	v_lshl_or_b32 v7, v55, 16, v16
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[45:52], v[3:6], v[7:10], v[45:52] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	s_cmp_lt_i32 s4, s1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v12, v36, s4, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s4, s4, s35
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v13, v35, s4, 1
	v_add_lshl_u32 v14, v34, s4, 1
	v_add_lshl_u32 v15, v33, s4, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s5
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v16, v30, s4, 1
	v_add_lshl_u32 v37, v28, s4, 1
	v_add_lshl_u32 v38, v31, s4, 1
	v_add_lshl_u32 v40, v29, s4, 1
	v_add_lshl_u32 v41, v27, s4, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_dual_cndmask_b32 v16, 0x80000000, v16 :: v_dual_cndmask_b32 v37, 0x80000000, v37
	v_dual_cndmask_b32 v38, 0x80000000, v38 :: v_dual_cndmask_b32 v41, 0x80000000, v41
...
; %bb.11:
	...
	v_lshl_or_b32 v71, v45, 16, v32
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v32, v69, v44, 0xc0c0004
	v_mov_b32_e32 v44, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_perm_b32 v39, v68, v43, 0xc0c0004
	v_dual_mov_b32 v48, v44 :: v_dual_add_nc_u32 v11, s34, v11
	...
	v_lshl_or_b32 v69, v39, 16, v32
	ds_load_u8 v32, v2 offset:368
	...
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v39, v83, v42, 0xc0c0004
	...
	v_perm_b32 v32, v77, v32, 0xc0c0004
	v_perm_b32 v75, v82, v79, 0xc0c0004
	v_perm_b32 v76, v81, v80, 0xc0c0004
	v_lshl_or_b32 v67, v43, 16, v39
	v_lshl_or_b32 v66, v73, 16, v72
	v_lshl_or_b32 v65, v32, 16, v74
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v64, v76, 16, v75
	ds_load_u8 v32, v2 offset:752
	ds_load_u8 v39, v2 offset:720
	...
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v39, v68, v39, 0xc0c0004
	v_perm_b32 v32, v43, v32, 0xc0c0004
	s_waitcnt lgkmcnt(17)
	...
	v_lshl_or_b32 v59, v11, 16, v32
	v_lshl_or_b32 v58, v42, 16, v39
...
.LBB0_12:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v15, v7, v24
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s1, s14, s35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v14, v8, v25
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_add_i32 s1, s1, s33
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v32, v11, v32 :: v_dual_lshlrev_b32 v29, 16, v29
	v_mul_f32_e32 v33, v11, v33
	v_dual_mul_f32 v34, v11, v34 :: v_dual_and_b32 v43, 0x1e0, v0
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_and_b32_e32 v0, 28, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v36, v4, v22
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v31, v11, v31 :: v_dual_lshlrev_b32 v30, 16, v30
	v_dual_mul_f32 v29, v11, v29 :: v_dual_lshlrev_b32 v28, 16, v28
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_and_or_b32 v0, 0x1c0, v18, v0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(0)
	...
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	v_add3_u32 v18, s1, v39, v41
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v11, v11, v27
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v30, v30, v47, v6
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshl_or_b32 v38, v17, 2, v43
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v28, v28, v48, v7
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v20, 0, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v3, v37, v3, v21
	v_fma_f32 v5, v35, v5, v19
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xor_b32_e32 v12, v38, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v31, v31, v49, v8
	v_fma_f32 v29, v29, v50, v9
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v3, v21, v3, s2
	v_cndmask_b32_e64 v5, v19, v5, s2
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshl_or_b32 v12, v17, 9, v12
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v11, v11, v51, v10
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v21, 0x408, v0, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v27, v34, v45, v3
	v_fma_f32 v2, v32, v2, v5
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v1, 0, v12
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v32, v33, v46, v4
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v13, v12, 4, 0
	v_xad_u32 v23, 0xc18, v0, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v2, v5, v2, s3
	v_cndmask_b32_e64 v3, v3, v27, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v14, v12, 8, 0
	v_xad_u32 v22, 0x810, v0, 0
	v_xad_u32 v24, 0x1040, v0, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v4, v4, v32, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v15, v12, 12, 0
	v_xad_u32 v25, 0x1448, v0, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v5, v6, v30, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v16, v12, 16, 0
	v_xad_u32 v26, 0x1850, v0, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v6, v7, v28, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v17, v12, 20, 0
	v_xad_u32 v19, v12, 24, 0
	v_xad_u32 v12, v12, 28, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v8, v31, s3
	v_cndmask_b32_e64 v8, v9, v29, s3
	v_cndmask_b32_e64 v9, v10, v11, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	ds_store_b32 v1, v2
	ds_store_b32 v13, v3
	ds_store_b32 v14, v4
	...
	v_add_lshl_u32 v9, v18, s0, 2
	v_add_lshl_u32 v11, v18, s4, 2
	v_add_lshl_u32 v10, v18, s1, 2
	v_add_lshl_u32 v12, v18, s2, 2
	v_add_lshl_u32 v13, v18, s5, 2
	v_add_lshl_u32 v14, v18, s6, 2
	s_waitcnt lgkmcnt(7)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 154
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 40
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     42
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
