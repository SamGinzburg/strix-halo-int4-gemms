...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v15, 0x5410 :: v_dual_lshlrev_b32 v2, 4, v2
	...
	v_subrev_nc_u32_e32 v96, s12, v7
	.loc	1 952 47                        ; attention.py:952:47
	v_add_nc_u32_e32 v97, s13, v7
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v14, 0x7531 :: v_dual_lshlrev_b32 v79, 2, v82
	v_mul_lo_u32 v3, s11, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v9, 0x7531, v9, s1
	v_add_nc_u32_e32 v114, 0, v7
	v_dual_mov_b32 v26, v65 :: v_dual_lshlrev_b32 v87, 3, v4
	...
	v_dual_mov_b32 v27, v65 :: v_dual_add_nc_u32 v98, v3, v88
	v_dual_mov_b32 v32, v65 :: v_dual_add_nc_u32 v99, v3, v89
	v_dual_mov_b32 v29, v65 :: v_dual_add_nc_u32 v100, v3, v90
	v_dual_mov_b32 v18, v65 :: v_dual_add_nc_u32 v101, v3, v91
	v_dual_mov_b32 v31, v65 :: v_dual_add_nc_u32 v102, v3, v92
	v_dual_mov_b32 v22, v65 :: v_dual_add_nc_u32 v103, v3, v93
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v104, v3, v94
	v_lshl_or_b32 v14, v14, 8, v14
	v_lshl_or_b32 v9, v9, 4, v9
	v_dual_mov_b32 v24, v65 :: v_dual_add_nc_u32 v105, v3, v87
	...
	v_dual_mov_b32 v9, 0x7632 :: v_dual_lshlrev_b32 v4, 6, v4
	v_dual_mov_b32 v23, v65 :: v_dual_add_nc_u32 v116, 0, v10
	v_mov_b32_e32 v10, v65
	v_cmp_eq_u32_e64 s3, 0, v3
	v_xor_b32_e32 v11, 0x50, v95
	v_lshl_or_b32 v14, v14, 4, v14
	v_and_or_b32 v109, v1, 60, v4
	v_lshlrev_b32_e32 v4, 5, v0
	v_cndmask_b32_e64 v3, 0x1054, v15, s3
	v_cndmask_b32_e64 v9, 0x3276, v9, s3
	v_xor_b32_e32 v13, 0x70, v95
	...
	v_dual_mov_b32 v11, v65 :: v_dual_and_b32 v4, 0x160, v4
	v_bfe_i32 v5, v0, 0, 1
	.loc	1 790 23                        ; attention.py:790:23
	...
	v_xor_b32_e32 v12, 0x60, v95
	v_lshlrev_b32_e32 v108, 2, v15
	v_and_b32_e32 v111, 0x5040504, v3
	v_dual_mov_b32 v15, v65 :: v_dual_and_b32 v112, 0x7060706, v1
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v67, s45, v67 :: v_dual_add_nc_u32 v80, s5, v124
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 163
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 49
