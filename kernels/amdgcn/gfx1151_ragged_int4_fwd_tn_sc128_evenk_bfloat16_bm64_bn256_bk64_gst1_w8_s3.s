...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_mad_u64_u32 v[67:68], null, v67, s8, v[65:66]
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v70, 0x80000000, v67, s6
	.loc	1 461 28 is_stmt 1              ; ragged.py:461:28
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v71, 0x80000000, v67, s6
	.loc	1 461 28 is_stmt 1              ; ragged.py:461:28
	...
	v_mad_u64_u32 v[67:68], null, v67, s8, v[65:66]
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v72, 0x80000000, v67, s6
	.loc	1 461 28 is_stmt 1              ; ragged.py:461:28
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v73, 0x80000000, v67, s6
	.loc	1 461 28 is_stmt 1              ; ragged.py:461:28
	...
	v_mad_u64_u32 v[67:68], null, v67, s8, v[65:66]
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v74, 0x80000000, v67, s6
	.loc	1 461 28 is_stmt 1              ; ragged.py:461:28
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 478 34 is_stmt 0              ; ragged.py:478:34
	v_cndmask_b32_e64 v75, 0x80000000, v67, s6
	.loc	1 469 26 is_stmt 1              ; ragged.py:469:26
	v_or_b32_e32 v67, s30, v140
	...
	ds_load_u8 v239, v142 offset:224
	ds_load_u8 v240, v142 offset:160
	ds_load_u8 v242, v142 offset:240
	ds_load_u8 v243, v142 offset:176
	ds_load_u8 v78, v142 offset:448
	ds_load_u8 v79, v142 offset:384
	ds_load_u8 v80, v142 offset:464
	ds_load_u8 v81, v142 offset:400
	ds_load_u8 v252, v142 offset:480
	ds_load_u8 v254, v142 offset:416
	ds_load_u8 v246, v142 offset:496
	ds_load_u8 v247, v142 offset:432
	...
	ds_load_u8 v253, v142 offset:368
	ds_load_u8 v255, v142 offset:304
	ds_load_u8 v86, v142 offset:64
	ds_load_u8 v87, v142 offset:80
	ds_load_u8 v150, v142 offset:96
	ds_load_u8 v116, v142 offset:112
	ds_load_u8 v88, v142
	ds_load_u8 v89, v142 offset:16
	ds_load_u8 v115, v142 offset:32
	ds_load_u8 v0, v142 offset:48
	ds_load_u8 v244, v142 offset:960
	ds_load_u8 v245, v142 offset:896
	ds_load_u8 v208, v142 offset:1024
	ds_load_u8 v215, v142 offset:976
	ds_load_u8 v217, v142 offset:912
	ds_load_u8 v211, v142 offset:992
	ds_load_u8 v212, v142 offset:928
	ds_load_u8 v209, v142 offset:944
	ds_load_u8 v248, v142 offset:832
	ds_load_u8 v249, v142 offset:768
	...
	ds_load_u8 v200, v142 offset:1392
	ds_load_u8 v202, v142 offset:1328
	ds_load_u8 v181, v142 offset:1984
	...
	ds_load_u8 v241, v147
	ds_load_u8 v152, v148
	ds_load_u8 v153, v142 offset:1968
	ds_load_u8 v187, v142 offset:1920
	...
	ds_load_u8 v194, v142 offset:1728
	ds_load_u8 v197, v142 offset:1792
	...
	v_perm_b32 v0, v0, v116, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	...
	v_perm_b32 v79, v240, v239, 0xc0c0004
	...
	v_perm_b32 v76, v254, v252, 0xc0c0004
	...
	v_perm_b32 v69, v255, v253, 0xc0c0004
	v_perm_b32 v78, v247, v246, 0xc0c0004
	v_perm_b32 v79, v243, v242, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_perm_b32 v70, v251, v250, 0xc0c0004
	...
	v_perm_b32 v73, v217, v215, 0xc0c0004
	v_perm_b32 v76, v230, v229, 0xc0c0004
	v_perm_b32 v77, v235, v233, 0xc0c0004
	v_perm_b32 v78, v227, v226, 0xc0c0004
	v_perm_b32 v79, v209, v241, 0xc0c0004
	v_lshl_or_b32 v74, v73, 16, v0
	v_lshl_or_b32 v73, v76, 16, v75
	v_perm_b32 v0, v221, v220, 0xc0c0004
	v_perm_b32 v75, v212, v211, 0xc0c0004
	...
	v_perm_b32 v67, v234, v228, 0xc0c0004
	...
	v_lshl_or_b32 v71, v74, 16, v73
	v_perm_b32 v73, v199, v198, 0xc0c0004
	v_perm_b32 v76, v183, v182, 0xc0c0004
	v_perm_b32 v77, v188, v186, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[71:72], v[67:68], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[69:70], v[73:74], v[17:24] neg_lo:[1,1,0]
	v_perm_b32 v67, v187, v181, 0xc0c0004
	v_lshl_or_b32 v76, v75, 16, v0
	v_lshl_or_b32 v75, v78, 16, v77
	v_perm_b32 v0, v202, v200, 0xc0c0004
	...
	v_perm_b32 v0, v197, v189, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu4 v[49:56], v[69:70], v[115:116], v[49:56] neg_lo:[1,1,0]
	v_perm_b32 v69, v176, v203, 0xc0c0004
	v_perm_b32 v70, v201, v194, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[57:64], v[71:72], v[115:116], v[57:64] neg_lo:[1,1,0]
	v_lshl_or_b32 v68, v67, 16, v0
	v_lshl_or_b32 v67, v70, 16, v69
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_dual_fmac_f32 v128, v80, v9 :: v_dual_fmac_f32 v129, v79, v8
	v_dual_fmac_f32 v126, v82, v11 :: v_dual_fmac_f32 v127, v81, v10
	v_dual_fmac_f32 v124, v84, v13 :: v_dual_fmac_f32 v125, v83, v12
	v_dual_fmac_f32 v122, v16, v15 :: v_dual_fmac_f32 v123, v85, v14
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 124
