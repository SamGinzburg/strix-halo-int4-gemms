...
.Ltmp0:
	...
	v_dual_mov_b32 v23, v33 :: v_dual_and_b32 v88, 0x7050301, v40
	v_dual_mov_b32 v11, v33 :: v_dual_add_nc_u32 v68, 0, v44
	...
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v48, v62, v35
	ds_bpermute_b32 v35, v64, v35
	ds_bpermute_b32 v49, v62, v36
	...
	v_mul_f32_e32 v90, s8, v40
	v_lshl_or_b32 v39, v41, 4, v41
	v_lshl_or_b32 v41, v44, 4, v44
	v_cndmask_b32_e64 v44, 0x1054, v46, s4
	v_cndmask_b32_e64 v46, 0x3276, v47, s4
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v47, v36, v49, s4
	v_and_b32_e32 v87, 0x7060302, v39
	ds_bpermute_b32 v39, v62, v37
	ds_bpermute_b32 v37, v64, v37
	v_and_b32_e32 v89, 0x7050301, v41
	v_lshl_or_b32 v41, v44, 8, v44
	v_lshl_or_b32 v44, v46, 8, v46
	v_cndmask_b32_e64 v46, v48, v35, s4
	v_cndmask_b32_e64 v49, v49, v36, s4
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v43, v34, v38, s4
	v_cndmask_b32_e64 v45, v38, v34, s4
	v_and_b32_e32 v34, 0x540054, v41
	v_and_b32_e32 v38, 0x760076, v44
	v_cndmask_b32_e64 v44, v35, v48, s4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v34, v34, 4, v34
	v_lshl_or_b32 v35, v38, 4, v38
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v48, v37, v39, s4
	v_cndmask_b32_e64 v50, v39, v37, s4
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v106, s24, v77, 1
	.loc	1 978 32                        ; attention.py:978:32
	v_mov_b16_e32 v41.l, 0
	.loc	1 923 37                        ; attention.py:923:37
	v_add_lshl_u32 v107, s24, v78, 1
	.loc	1 908 32                        ; attention.py:908:32
	buffer_load_b32 v34, v34, s[40:43], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 923 37                        ; attention.py:923:37
	v_add_lshl_u32 v108, s24, v79, 1
	.loc	1 974 36                        ; attention.py:974:36
	s_lshr_b32 s14, s24, 1
	.loc	1 923 37                        ; attention.py:923:37
	v_add_lshl_u32 v109, s24, v80, 1
	v_add_lshl_u32 v110, s24, v81, 1
	v_add_lshl_u32 v111, s24, v82, 1
	...
	.loc	1 923 37                        ; attention.py:923:37
	v_add_lshl_u32 v97, s24, v84, 1
	.loc	1 965 35                        ; attention.py:965:35
	ds_bpermute_b32 v107, v62, v38
	ds_bpermute_b32 v108, v64, v37
	.loc	1 964 36                        ; attention.py:964:36
	...
	v_dual_fmac_f32 v38, v39, v40 :: v_dual_add_nc_u32 v39, s14, v70
	...
	ds_store_2addr_b32 v67, v99, v104 offset1:8
	ds_store_2addr_b32 v67, v36, v102 offset0:16 offset1:24
	.loc	1 966 25                        ; attention.py:966:25
	s_waitcnt lgkmcnt(2)
...
.Ltmp5:
	...
	ds_load_b128 v[103:106], v75 offset:512
	.loc	1 1018 23                       ; attention.py:1018:23
	...
	ds_bpermute_b32 v97, v71, v97
	ds_bpermute_b32 v105, v65, v105
...
.Ltmp13:
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_load_b128 v[103:106], v75 offset:1024
...
.Ltmp18:
	.loc	1 970 25                        ; attention.py:970:25
	v_cndmask_b32_e64 v104, 0, v69, s5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bf16_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 115
