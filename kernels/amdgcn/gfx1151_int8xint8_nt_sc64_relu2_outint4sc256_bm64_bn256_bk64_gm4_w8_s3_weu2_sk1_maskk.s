	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_8:                                ; %Flow95
	...
	v_dual_mov_b32 v173, 0 :: v_dual_mov_b32 v246, 0
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	v_dual_mov_b32 v247, 0 :: v_dual_mov_b32 v158, 0
	v_dual_mov_b32 v249, 0 :: v_dual_mov_b32 v234, 0
	v_dual_mov_b32 v251, 0 :: v_dual_mov_b32 v232, 0
	...
	v_dual_mov_b32 v171, 0 :: v_dual_mov_b32 v254, 0
	v_dual_mov_b32 v253, 0 :: v_dual_mov_b32 v120, 0
	...
	v_dual_mov_b32 v207, 0 :: v_dual_mov_b32 v114, 0
	v_dual_mov_b32 v113, 0 :: v_dual_mov_b32 v112, 0
	v_dual_mov_b32 v17, 0 :: v_dual_mov_b32 v146, 0
...
; %bb.9:
	...
	v_cvt_f32_i32_e32 v216, v112
	v_cvt_f32_i32_e32 v237, v113
	v_cvt_f32_i32_e32 v238, v114
	v_cvt_f32_i32_e32 v231, v115
	v_cvt_f32_i32_e32 v173, v116
...
.LBB0_10:
	...
	v_dual_mov_b32 v218, 0 :: v_dual_mov_b32 v139, 0
...
; %bb.11:
	...
	v_dual_mov_b32 v149, v133 :: v_dual_add_nc_u32 v20, s46, v230
	v_dual_mov_b32 v152, v124 :: v_dual_add_nc_u32 v99, s45, v229
	v_dual_mov_b32 v150, v134 :: v_dual_add_nc_u32 v165, s46, v54
	v_dual_mov_b32 v185, v243 :: v_dual_add_nc_u32 v166, s46, v22
	v_dual_mov_b32 v133, v121 :: v_dual_mov_b32 v124, v247
	v_dual_mov_b32 v121, v244 :: v_dual_mov_b32 v154, v126
	v_dual_mov_b32 v134, v245 :: v_dual_mov_b32 v151, v246
	v_mov_b32_e32 v126, v249
	ds_load_b128 v[243:246], v19 offset:8192
	v_mov_b32_e32 v153, v125
	v_dual_mov_b32 v125, v248 :: v_dual_mov_b32 v156, v253
	v_dual_mov_b32 v127, v250 :: v_dual_add_nc_u32 v184, s45, v101
	ds_load_b128 v[247:250], v19
	v_dual_mov_b32 v145, v129 :: v_dual_mov_b32 v186, v111
	v_mov_b32_e32 v129, v251
	v_dual_mov_b32 v167, v140 :: v_dual_mov_b32 v148, v235
	v_dual_mov_b32 v140, v252 :: v_dual_mov_b32 v157, v254
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v226, s19 :: v_dual_add_nc_u32 v111, s45, v100
	s_clause 0x5                            ; 24-byte Folded Spill
	scratch_store_b32 off, v171, off offset:36
	scratch_store_b32 off, v234, off offset:64
	scratch_store_b32 off, v237, off offset:68
	scratch_store_b32 off, v92, off offset:56
	scratch_store_b32 off, v232, off offset:60
	scratch_store_b32 off, v238, off offset:40
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[235:238], v99 offset:2048
	v_dual_mov_b32 v155, v158 :: v_dual_mov_b32 v224, s17
	ds_load_b128 v[103:106], v111
	v_dual_mov_b32 v139, v169 :: v_dual_mov_b32 v222, s15
	v_dual_mov_b32 v217, v231 :: v_dual_mov_b32 v220, s13
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v225, s18 :: v_dual_mov_b32 v158, v109
	v_dual_mov_b32 v223, s16 :: v_dual_mov_b32 v0, v59
	v_mov_b32_e32 v221, s14
	v_mov_b32_e32 v219, s12
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v132, off offset:48
	scratch_store_b32 off, v173, off offset:72
	...
	v_dual_mov_b32 v114, v17 :: v_dual_mov_b32 v113, v92
	...
	scratch_load_b32 v173, off, off offset:72
	v_dual_mov_b32 v231, v217 :: v_dual_mov_b32 v172, v218
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v227, off, off offset:44
	...
	v_dual_mov_b32 v246, v151 :: v_dual_mov_b32 v245, v134
	v_mov_b32_e32 v244, v121
	v_dual_mov_b32 v134, v150 :: v_dual_mov_b32 v121, v133
	v_mov_b32_e32 v133, v149
	v_dual_mov_b32 v243, v185 :: v_dual_mov_b32 v250, v127
	v_dual_mov_b32 v247, v124 :: v_dual_mov_b32 v254, v157
	v_dual_mov_b32 v124, v152 :: v_dual_mov_b32 v251, v129
	v_dual_mov_b32 v252, v140 :: v_dual_mov_b32 v129, v145
	...
	v_dual_mov_b32 v235, v148 :: v_dual_mov_b32 v158, v155
	v_mov_b32_e32 v169, v139
	v_cvt_f32_i32_e32 v212, v236
	v_cvt_f32_i32_e32 v139, v240
...
.Ltmp23:
	...
	v_fma_f32 v96, v96, v147, v89
	v_fma_f32 v97, v97, v131, v88
	v_fma_f32 v98, v98, v144, v87
	v_fma_f32 v99, v99, v170, v86
	v_fma_f32 v100, v100, v169, v85
	v_fma_f32 v101, v101, v146, v83
	...
	v_fma_f32 v91, v111, v140, v73
	v_fma_f32 v96, v112, v172, v72
	...
	v_fma_f32 v96, v112, v252, v51
	v_fma_f32 v97, v113, v171, v50
	v_fma_f32 v94, v134, v158, v41
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v90, v6, v231, v28
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v57, v57, v89, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v89, v7, v173, v29
	v_fma_f32 v91, v5, v238, v27
	v_fma_f32 v94, v4, v237, v26
	v_fma_f32 v96, v3, v216, v25
	v_fma_f32 v97, v2, v235, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v93 offset:40960
	ds_load_b128 v[5:8], v93 offset:40976
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v132, v232, v43
	v_fma_f32 v105, v133, v234, v42
	v_fma_f32 v106, v136, v251, v39
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v114, v12, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v151, v168, v61
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_cndmask_b32_e64 v24, v24, v97, s3
	v_cndmask_b32_e64 v23, v23, v98, s3
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(2)
	...
	v_mul_f32_e32 v55, v2, v19
	v_mul_f32_e32 v89, v3, v19
	v_mul_f32_e32 v90, v4, v19
	v_mul_f32_e32 v91, v5, v19
	v_mul_f32_e32 v92, v6, v19
	v_mul_f32_e32 v93, v7, v19
	v_mul_f32_e32 v94, v8, v19
	v_mul_f32_e32 v96, v9, v19
	v_mul_f32_e32 v97, v10, v19
	v_mul_f32_e32 v98, v11, v19
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v118, v1, v22
	v_mul_f32_e32 v124, v7, v22
	v_mul_f32_e32 v126, v9, v22
	v_mul_f32_e32 v127, v10, v22
	v_mul_f32_e32 v128, v11, v22
	v_mul_f32_e32 v129, v12, v22
	...
	v_dual_mul_f32 v14, v14, v38 :: v_dual_max_f32 v21, 0, v21
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v8, v83, v8, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v15, v15, v38
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v19, v19, v19 :: v_dual_mul_f32 v122, v5, v22
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_fma_f32 v40, v55, v161, v24
	v_fma_f32 v55, v89, v162, v25
	v_fma_f32 v89, v90, v163, v26
	v_fma_f32 v90, v91, v164, v27
	v_fma_f32 v91, v92, v165, v28
	v_fma_f32 v92, v93, v166, v29
	v_fma_f32 v93, v94, v153, v30
	v_fma_f32 v94, v96, v154, v31
	v_fma_f32 v95, v97, v156, v32
	v_fma_f32 v96, v98, v157, v33
	v_fma_f32 v97, v99, v167, v34
	v_fma_f32 v98, v100, v186, v35
	v_fma_f32 v99, v101, v174, v36
	v_fma_f32 v100, v102, v175, v37
	v_fma_f32 v101, v103, v177, v39
	v_fma_f32 v102, v104, v178, v18
	v_fma_f32 v103, v105, v179, v41
	v_fma_f32 v104, v106, v180, v42
	v_fma_f32 v106, v108, v182, v44
	v_fma_f32 v105, v107, v181, v43
	v_fma_f32 v107, v109, v183, v45
	v_fma_f32 v108, v110, v184, v46
	v_fma_f32 v109, v111, v185, v47
	v_fma_f32 v111, v113, v188, v49
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v23, v38, s2
	v_cndmask_b32_e64 v38, v41, v103, s2
	v_cndmask_b32_e64 v41, v44, v106, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v110, v112, v187, v48
	v_fma_f32 v112, v114, v189, v50
	v_fma_f32 v114, v116, v191, v52
	v_fma_f32 v16, v16, v226, v56
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v24, v24, v40, s2
	v_cndmask_b32_e64 v20, v39, v101, s2
	v_cndmask_b32_e64 v39, v42, v104, s2
	v_cndmask_b32_e64 v40, v43, v105, s2
	v_cndmask_b32_e64 v42, v45, v107, s2
	v_cndmask_b32_e64 v43, v46, v108, s2
	v_cndmask_b32_e64 v44, v47, v109, s2
	v_cndmask_b32_e64 v46, v49, v111, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v41, v41, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v113, v115, v190, v51
	v_fma_f32 v116, v118, v194, v60
	v_fma_f32 v14, v14, v224, v59
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v45, v48, v110, s2
	v_cndmask_b32_e64 v47, v50, v112, s2
	v_cndmask_b32_e64 v49, v52, v114, s2
	v_cndmask_b32_e64 v16, v56, v16, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v42, v42, v42
	v_dual_max_f32 v56, 0, v41 :: v_dual_max_f32 v41, v44, v44
	v_max_f32_e32 v44, v46, v46
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v115, v117, v192, v53
	v_fma_f32 v3, v3, v213, v78
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v37, v37, v100, s2
	v_cndmask_b32_e64 v48, v51, v113, s2
	v_cndmask_b32_e64 v51, v60, v116, s2
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v8, v8, v8 :: v_dual_max_f32 v59, 0, v42
	v_dual_max_f32 v42, v45, v45 :: v_dual_max_f32 v45, v47, v47
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v6, v6, v139, v81
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v50, v53, v115, s2
	v_cndmask_b32_e64 v52, v61, v117, s2
	v_cndmask_b32_e64 v3, v78, v3, s2
	v_cndmask_b32_e64 v4, v79, v4, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v37, v37, v37 :: v_dual_max_f32 v46, v48, v48
	v_max_f32_e32 v78, 0, v45
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v119, v121, v197, v63
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v45, v51, v51
	v_max_f32_e32 v51, 0, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v12, v12, v222, v88
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v25, v25, v55, s2
	v_cndmask_b32_e64 v55, v63, v119, s2
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v48, 0, v42 :: v_dual_max_f32 v3, v3, v3
	v_dual_max_f32 v81, 0, v46 :: v_dual_max_f32 v12, v12, v12
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v52, 0, v42 :: v_dual_max_f32 v3, 0, v3
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v53, v62, v118, s2
	v_cndmask_b32_e64 v7, v82, v7, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v82, 0, v45
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v83, 0, v46 :: v_dual_max_f32 v16, v16, v16
	v_max_f32_e32 v46, v60, v60
	v_max_f32_e32 v84, 0, v42
	v_max_f32_e32 v42, v63, v63
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_max_f32 v26, 0, v26 :: v_dual_max_f32 v49, v61, v61
	v_dual_max_f32 v30, v30, v30 :: v_dual_max_f32 v61, 0, v41
	v_dual_max_f32 v34, v34, v34 :: v_dual_max_f32 v43, v43, v43
	v_dual_max_f32 v41, v62, v62 :: v_dual_max_f32 v12, 0, v12
	v_dual_max_f32 v89, 0, v42 :: v_dual_max_f32 v42, v68, v68
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v35, v35, v98, s2
	v_cndmask_b32_e64 v36, v36, v99, s2
	v_cndmask_b32_e64 v18, v18, v102, s2
	v_cndmask_b32_e64 v9, v85, v9, s2
	v_cndmask_b32_e64 v11, v87, v11, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v30, 0, v30 :: v_dual_max_f32 v85, 0, v45
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v87, 0, v49 :: v_dual_max_f32 v34, 0, v34
	v_dual_max_f32 v45, v64, v64 :: v_dual_max_f32 v88, 0, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_max_f32 v18, v18, v18 :: v_dual_max_f32 v41, v67, v67
	...
	v_dual_max_f32 v38, v38, v38 :: v_dual_max_f32 v45, v69, v69
	v_dual_max_f32 v18, 0, v18 :: v_dual_max_f32 v1, v1, v1
	v_max_f32_e32 v40, v40, v40
	v_dual_max_f32 v86, 0, v46 :: v_dual_max_f32 v7, v7, v7
	v_dual_max_f32 v46, v65, v65 :: v_dual_max_f32 v49, v66, v66
	v_max_f32_e32 v98, 0, v16
	v_dual_max_f32 v22, v22, v22 :: v_dual_max_f32 v9, v9, v9
	v_dual_max_f32 v94, 0, v42 :: v_dual_max_f32 v11, v11, v11
	v_max_f32_e32 v2, v2, v2
	v_dual_max_f32 v6, v6, v6 :: v_dual_max_f32 v25, 0, v25
	v_dual_max_f32 v29, 0, v29 :: v_dual_max_f32 v20, 0, v20
	v_dual_max_f32 v38, 0, v38 :: v_dual_max_f32 v93, 0, v41
	v_dual_max_f32 v40, 0, v40 :: v_dual_max_f32 v91, 0, v46
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v46, v28, v28
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v92, 0, v49
	v_max_f32_e32 v95, 0, v45
	...
	v_dual_max_f32 v11, 0, v11 :: v_dual_max_f32 v6, 0, v6
	v_dual_max_f32 v15, v15, v15 :: v_dual_max_f32 v14, v14, v14
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v99, v23, v23 :: v_dual_mul_f32 v80, v24, v24
	v_dual_mul_f32 v42, v26, v26 :: v_dual_mul_f32 v45, v27, v27
	v_dual_mul_f32 v53, v31, v31 :: v_dual_mul_f32 v58, v34, v34
	v_dual_mul_f32 v79, v32, v32 :: v_dual_mul_f32 v62, v35, v35
	v_dual_mul_f32 v57, v33, v33 :: v_dual_mul_f32 v70, v20, v20
	v_dual_mul_f32 v63, v36, v36 :: v_dual_mul_f32 v66, v37, v37
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v22, 0, v22 :: v_dual_max_f32 v7, 0, v7
	v_dual_max_f32 v5, 0, v5 :: v_dual_max_f32 v8, 0, v8
	v_dual_max_f32 v13, 0, v13 :: v_dual_max_f32 v10, 0, v10
	v_dual_max_f32 v97, 0, v15 :: v_dual_max_f32 v96, 0, v14
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v41, v25, v25
	v_dual_mul_f32 v49, v29, v29 :: v_dual_mul_f32 v50, v30, v30
	v_dual_mul_f32 v67, v19, v19 :: v_dual_mul_f32 v74, v38, v38
	v_dual_mul_f32 v71, v18, v18 :: v_dual_mul_f32 v76, v56, v56
	v_dual_mul_f32 v75, v39, v39 :: v_dual_mul_f32 v64, v44, v44
	v_dual_mul_f32 v77, v40, v40 :: v_dual_mul_f32 v72, v59, v59
	v_dual_mul_f32 v73, v43, v43 :: v_dual_mul_f32 v56, v52, v52
	v_dual_mul_f32 v68, v47, v47 :: v_dual_mul_f32 v69, v48, v48
	v_dual_mul_f32 v65, v78, v78 :: v_dual_mul_f32 v60, v51, v51
	v_dual_mul_f32 v59, v81, v81 :: v_dual_mul_f32 v52, v83, v83
	v_dual_mul_f32 v55, v21, v21 :: v_dual_mul_f32 v48, v84, v84
	v_dual_mul_f32 v51, v82, v82 :: v_dual_mul_f32 v40, v88, v88
	v_dual_mul_f32 v47, v61, v61 :: v_dual_mul_f32 v44, v86, v86
	v_dual_mul_f32 v43, v85, v85 :: v_dual_mul_f32 v36, v92, v92
	v_dual_mul_f32 v37, v90, v90 :: v_dual_mul_f32 v34, v93, v93
	v_dual_mul_f32 v35, v91, v91 :: v_dual_mul_f32 v32, v22, v22
	v_dual_mul_f32 v33, v94, v94 :: v_dual_mul_f32 v30, v1, v1
	v_dual_mul_f32 v31, v95, v95 :: v_dual_mul_f32 v28, v2, v2
	v_dual_mul_f32 v29, v3, v3 :: v_dual_mul_f32 v26, v5, v5
	v_dual_mul_f32 v27, v4, v4 :: v_dual_mul_f32 v24, v10, v10
.Ltmp24:
...
.Ltmp25:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v39, v87, v87 :: v_dual_mul_f32 v38, v89, v89
	v_dual_mul_f32 v25, v6, v6 :: v_dual_mul_f32 v16, v8, v8
	v_dual_mul_f32 v15, v7, v7 :: v_dual_mul_f32 v10, v13, v13
	v_dual_mul_f32 v23, v9, v9 :: v_dual_mul_f32 v14, v11, v11
	v_mul_f32_e32 v9, v12, v12
.Ltmp26:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max3_f32 v1, v1, v41, v2
	v_max3_f32 v2, v3, v4, v67
	v_dual_max_f32 v3, v70, v71 :: v_dual_max_f32 v12, v51, v52
...
.Ltmp33:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v13, v98, v98 :: v_dual_max_f32 v20, v19, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	...
	s_waitcnt vmcnt(0)
	v_dual_max_f32 v18, v1, v5 :: v_dual_and_b32 v5, 0x80, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_max3_f32 v21, v4, v6, v7
	v_dual_max_f32 v19, v2, v8 :: v_dual_lshlrev_b32 v4, 5, v241
.Ltmp35:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp44:
	...
	v_dual_max_f32 v3, v3, v3 :: v_dual_lshlrev_b32 v8, 3, v8
.Ltmp45:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp46:
	...
	v_dual_max_f32 v20, v21, v21 :: v_dual_max_f32 v3, v19, v3
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.Ltmp56:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v18, v22, v22 :: v_dual_max_f32 v21, v19, v21
.Ltmp57:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp59:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v81, v21 :: v_dual_max_f32 v20, v20, v1
...
.Ltmp61:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	scratch_load_b64 v[81:82], off, off offset:4 ; 8-byte Folded Reload
	s_waitcnt lgkmcnt(0)
	s_barrier
.Ltmp62:
	.loc	1 76 13                         ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
...
.Ltmp65:
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_dual_fmac_f32 v22, v17, v22 :: v_dual_and_b32 v5, 1, v5
	...
	v_div_scale_f32 v91, s2, v42, v81, v42
	...
	v_fma_f32 v21, -v84, v54, v89
	v_div_scale_f32 v92, null, v81, v81, v46
	v_fmac_f32_e32 v83, v22, v83
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v87, v91, v18 :: v_dual_fmac_f32 v54, v21, v85
	...
	v_dual_mul_f32 v88, v80, v93 :: v_dual_mul_f32 v21, v82, v83
...
.Ltmp69:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 80
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 80
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
