...
.Ltmp0:
	...
	s_abs_i32 s10, s2
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v16, 15, v0
	...
	v_dual_mov_b32 v19, 0 :: v_dual_lshlrev_b32 v2, 3, v16
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v64, v30, s[20:23], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v65, v38, s[24:27], 0 offen
	buffer_load_u16 v66, v38, s[24:27], 0 offen offset:4
	buffer_load_u16 v67, v38, s[24:27], 0 offen offset:8
	buffer_load_u16 v68, v38, s[24:27], 0 offen offset:12
	buffer_load_u16 v69, v38, s[24:27], 0 offen offset:16
	buffer_load_u16 v70, v38, s[24:27], 0 offen offset:20
	buffer_load_u16 v71, v38, s[24:27], 0 offen offset:24
	buffer_load_u16 v72, v38, s[24:27], 0 offen offset:28
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	v_cndmask_b32_e64 v37, 0x80000000, v31, s0
	buffer_load_b64 v[45:46], v37, s[16:19], 0 offen
	...
	v_dual_fmac_f32 v18, v39, v50 :: v_dual_add_nc_u32 v29, s34, v29
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v40, v40, v47
	v_dual_mul_f32 v41, v41, v47 :: v_dual_lshlrev_b32 v48, 16, v65
	v_dual_mul_f32 v42, v42, v47 :: v_dual_lshlrev_b32 v49, 16, v66
	v_dual_mul_f32 v44, v44, v47 :: v_dual_lshlrev_b32 v51, 16, v68
	v_dual_mul_f32 v43, v43, v47 :: v_dual_lshlrev_b32 v52, 16, v69
	...
	v_fmac_f32_e32 v15, v41, v52
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v10, v37, v48 :: v_dual_fmac_f32 v19, v38, v49
	v_dual_fmac_f32 v13, v43, v54 :: v_dual_fmac_f32 v12, v44, v55
...
; %bb.4:
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	v_add3_u32 v9, 0, v16, v22
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v2, 0x218, v23
	ds_load_u8 v6, v9 offset:640
	ds_load_u8 v7, v9 offset:896
	ds_load_u8 v8, v9 offset:768
	ds_load_u8 v24, v9 offset:512
	ds_load_u8 v25, v9 offset:128
	ds_load_u8 v26, v9 offset:256
	ds_load_u8 v27, v9
	...
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_mov_b32_e32 v3, v1
	ds_load_u8 v29, v9 offset:1664
	ds_load_u8 v30, v9 offset:1792
	ds_load_u8 v31, v9 offset:1536
	...
	v_mov_b32_e32 v2, v1
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_xad_u32 v33, v23, 8, 0
	v_add_nc_u32_e32 v34, 0, v23
	v_xad_u32 v32, v23, 24, 0
	v_xad_u32 v35, v23, 16, 0
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	s_waitcnt lgkmcnt(16)
	...
	v_perm_b32 v27, v26, v28, 0xc0c0004
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[23:24], v33 offset:4096
	ds_load_b64 v[25:26], v34 offset:4096
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	ds_load_u8 v33, v9 offset:1920
	ds_load_u8 v34, v9 offset:1152
	...
	v_perm_b32 v47, v31, v29, 0xc0c0004
	v_lshl_or_b32 v28, v7, 16, v6
	v_lshl_or_b32 v27, v27, 16, v8
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v8, v1
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v33, v30, v33, 0xc0c0004
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[29:30], v35 offset:4096
	ds_load_b64 v[31:32], v32 offset:4096
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	s_waitcnt lgkmcnt(11)
	...
	v_lshl_or_b32 v23, v27, 16, v9
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[23:24], v[31:32], v[1:8] neg_lo:[1,1,0]
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
...
.LBB0_5:
	...
	v_dual_mov_b32 v30, 0x7632 :: v_dual_add_nc_u32 v21, 4, v16
	v_dual_mov_b32 v29, 0x5410 :: v_dual_add_nc_u32 v22, 8, v16
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	v_cndmask_b32_e64 v20, 0x80000000, v20, s2
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v24, 12, v16
	v_cndmask_b32_e64 v23, 0x80000000, v16, s2
	v_add_nc_u32_e32 v25, 16, v16
	v_add_nc_u32_e32 v26, 20, v16
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v4, v4, v20 :: v_dual_lshlrev_b32 v21, 16, v21
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v2, v2, v20 :: v_dual_lshlrev_b32 v25, 16, v25
	v_mul_f32_e32 v6, v6, v20
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v3, v3, v20 :: v_dual_lshlrev_b32 v26, 16, v26
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	s_waitcnt vmcnt(0)
	v_dual_max_f32 v5, v5, v5 :: v_dual_lshlrev_b32 v16, 16, v16
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v3, v3, v3 :: v_dual_max_f32 v4, v4, v4
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v5, v5, v5 :: v_dual_and_b32 v10, 1, v28
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v8, v8, v8 :: v_dual_mul_f32 v7, v7, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v8, v8, v8 :: v_dual_and_b32 v13, 1, v33
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 36
