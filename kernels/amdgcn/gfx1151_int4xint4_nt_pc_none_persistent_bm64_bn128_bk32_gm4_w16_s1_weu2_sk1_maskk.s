	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph3
	...
	v_dual_mov_b32 v9, 0x5410 :: v_dual_and_b32 v2, 7, v0
	.loc	1 247 36                        ; generate_amdgcn.py:247:36
	v_and_or_b32 v25, v1, 16, v5
	.loc	1 234 24                        ; generate_amdgcn.py:234:24
	s_lshl_b32 s34, s12, 2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_and_or_b32 v26, v1, 1, v6
	v_bfe_i32 v6, v0, 6, 1
	v_and_b32_e32 v1, 0x78, v7
	v_and_b32_e32 v7, 0x37e, v8
...
.Ltmp12:
	...
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_mad_u64_u32 v[18:19], null, s19, v25, v[1:2]
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v37, 0x7060706, v0
	v_cndmask_b32_e64 v0, 0, 1, s13
	s_mul_i32 s5, s5, s4
	v_mad_u64_u32 v[19:20], null, s19, v27, v[1:2]
	s_max_i32 s45, s1, 1
	...
	v_sub_nc_u32_e32 v35, s35, v16
	v_and_b32_e32 v36, 0x5040504, v4
	s_add_i32 s47, s4, s1
	v_cmp_ne_u32_e64 s1, 1, v0
	v_add_nc_u32_e32 v38, 0, v6
	v_add_nc_u32_e32 v39, 0, v5
...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v9, s3, v25
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v12, s4, v28
	v_or_b32_e32 v11, s4, v26
	v_or_b32_e32 v14, s4, v30
	v_or_b32_e32 v13, s4, v29
	v_or_b32_e32 v15, s4, v31
	v_or_b32_e32 v48, s4, v32
	v_or_b32_e32 v49, s4, v33
	v_or_b32_e32 v50, s4, v34
	...
	s_cmp_lt_i32 s2, s33
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_mov_b16_e32 v55.h, v51.h
	v_mov_b16_e32 v54.h, v51.h
	v_mov_b16_e32 v53.h, v51.h
	v_mov_b16_e32 v56.h, v51.h
	v_add_lshl_u32 v52, s30, v18, 1
	...
	v_mul_f32_e32 v61, v15, v9
	v_mul_f32_e32 v63, v49, v9
	v_dual_mul_f32 v15, v10, v15 :: v_dual_mul_f32 v58, v12, v9
	.loc	1 269 18                        ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v13, 16, v13
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v62, v48, v9
	v_mul_f32_e32 v57, v11, v9
	v_mul_f32_e32 v11, v10, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v46, v58, v46 :: v_dual_mul_f32 v59, v13, v9
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	...
	v_dual_mul_f32 v11, v59, v45 :: v_dual_lshlrev_b32 v14, 16, v14
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v48, v10, v48
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v6, v12, v6 :: v_dual_mul_f32 v5, v15, v5
	v_mul_f32_e32 v4, v13, v4
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v60, v14, v9
	v_mul_f32_e32 v9, v50, v9
	v_mul_f32_e32 v14, v10, v14
	v_mul_f32_e32 v50, v10, v50
	v_mul_f32_e32 v10, v10, v49
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v12, v60, v44 :: v_dual_mul_f32 v13, v61, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v2, v14, v2 :: v_dual_mul_f32 v15, v63, v20
	...
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v14, v62, v21 :: v_dual_mul_f32 v7, v9, v7
	...
	v_perm_b32 v0, v3, v1, v36
	v_perm_b32 v1, v3, v1, v37
	v_perm_b32 v2, v5, v7, v36
	v_perm_b32 v3, v5, v7, v37
	v_perm_b32 v4, v9, v6, v36
	v_perm_b32 v5, v9, v6, v37
	v_perm_b32 v6, v10, v8, v36
	v_perm_b32 v7, v10, v8, v37
	v_add_lshl_u32 v8, s30, v19, 1
	s_clause 0x1
	buffer_store_b128 v[0:3], v52, s[20:23], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[21:22], null, s35, v3, v[17:18]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_add_nc_u32_e32 v44, s5, v20
	.loc	1 255 27                        ; generate_amdgcn.py:255:27
	v_cmp_lt_i32_e32 vcc_lo, s5, v35
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	v_add_nc_u32_e32 v45, s5, v21
	s_mov_b32 s30, s26
	s_mov_b32 s31, s27
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	s_add_i32 s6, s6, -1
	...
	s_cmp_lg_u32 s6, 0
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	v_cndmask_b32_e32 v22, 0x80000000, v45, vcc_lo
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	buffer_load_u16 v44, v44, s[24:27], 0 offen
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	buffer_load_b32 v22, v22, s[28:31], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[44:47], v39 offset1:1
	ds_load_2addr_stride64_b64 v[48:51], v40 offset1:1
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b32 v41, v22
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[52:53], v[44:45], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[52:53], v[46:47], v[8:15] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[54:55], v[48:49], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[54:55], v[50:51], v[8:15] neg_lo:[1,1,0]
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.num_vgpr, 64
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_maskk.kd
