...
.Ltmp2:
	...
	s_waitcnt lgkmcnt(0)
	s_mul_i32 s25, s20, s16
	.loc	1 424 19                        ; ragged.py:424:19
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 0 19 is_stmt 0                ; ragged.py:0:19
	v_dual_mov_b32 v3, s25 :: v_dual_lshlrev_b32 v4, 1, v0
	v_dual_mov_b32 v2, s18 :: v_dual_and_b32 v1, 16, v0
	s_branch .LBB0_3
.LBB0_2:
	s_mov_b32 s7, -1
                                        ; implicit-def: $vgpr4
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v7, 0 :: v_dual_and_b32 v70, 15, v0
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v69, 1, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v1, 0 :: v_dual_lshlrev_b32 v4, 4, v69
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add_co_u32 v2, s0, s18, v6
	...
	v_mov_b32_e32 v7, v1
	v_mad_u64_u32 v[65:66], null, v6, s17, v[2:3]
	v_mad_u64_u32 v[66:67], null, s17, v11, v[4:5]
	v_mad_u64_u32 v[67:68], null, s17, v5, v[4:5]
	v_mov_b32_e32 v4, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 435 30 is_stmt 0              ; ragged.py:435:30
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_mov_b32 v3, s25 :: v_dual_mov_b32 v2, s18
	v_dual_mov_b32 v4, v72 :: v_dual_mov_b32 v1, v71
.LBB0_7:                                ; %._crit_edge
	.loc	1 413 32                        ; ragged.py:413:32
	v_or_b32_e32 v5, 48, v70
	v_or_b32_e32 v36, 32, v70
	v_or_b32_e32 v38, 16, v70
	...
	v_add_co_u32 v38, s0, s18, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_add_co_ci_u32_e64 v39, null, s19, 0, s0
	v_add_co_u32 v40, s0, s18, v70
	...
	.loc	1 415 21                        ; ragged.py:415:21
	v_cmp_le_i64_e64 s1, s[20:21], v[38:39]
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_le_i64_e64 s2, s[20:21], v[40:41]
	.loc	1 415 48                        ; ragged.py:415:48
	v_cmp_gt_i64_e64 s6, s[22:23], v[40:41]
	v_cmp_gt_i64_e64 s5, s[22:23], v[38:39]
	.loc	1 415 21                        ; ragged.py:415:21
	v_cmp_le_i64_e64 s0, s[20:21], v[36:37]
	.loc	1 415 48                        ; ragged.py:415:48
	v_cmp_gt_i64_e64 s4, s[22:23], v[36:37]
	...
	v_dual_mul_f32 v69, v80, v37 :: v_dual_and_b32 v0, 0xf0, v0
	v_mul_f32_e32 v45, v101, v38
	v_dual_mul_f32 v46, v100, v38 :: v_dual_and_b32 v3, 28, v4
	v_mul_f32_e32 v50, v96, v38
	v_dual_mul_f32 v61, v84, v37 :: v_dual_add_nc_u32 v2, v70, v2
	.loc	1 414 36                        ; ragged.py:414:36
	...
	.loc	1 450 17                        ; ragged.py:450:17
	v_dual_mul_f32 v59, v86, v37 :: v_dual_add_nc_u32 v4, 16, v2
	...
	v_dual_mul_f32 v54, v92, v38 :: v_dual_mul_f32 v71, v78, v37
	v_dual_mul_f32 v55, v91, v38 :: v_dual_mul_f32 v64, v81, v37
	v_dual_mul_f32 v56, v90, v38 :: v_dual_mul_f32 v75, v75, v37
	v_dual_mul_f32 v57, v89, v38 :: v_dual_mul_f32 v70, v79, v37
	v_dual_mul_f32 v38, v88, v38 :: v_dual_mul_f32 v73, v73, v37
	v_dual_mul_f32 v72, v77, v37 :: v_dual_mul_f32 v67, v67, v36
	v_dual_mul_f32 v76, v76, v37 :: v_dual_mul_f32 v65, v65, v36
	v_dual_mul_f32 v74, v74, v37 :: v_dual_mul_f32 v35, v35, v36
	...
	v_dual_mul_f32 v63, v69, v30 :: v_dual_mul_f32 v64, v70, v17
	v_dual_mul_f32 v69, v71, v18 :: v_dual_mul_f32 v70, v72, v19
	v_mul_f32_e32 v73, v73, v33
	v_dual_mul_f32 v71, v76, v20 :: v_dual_mul_f32 v72, v75, v31
	...
	.loc	1 457 17                        ; ragged.py:457:17
	v_dual_mul_f32 v74, v74, v32 :: v_dual_mul_f32 v67, v67, v23
	.loc	1 509 9                         ; ragged.py:509:9
	...
	v_cmp_o_f32_e64 s31, v70, v70
	v_cmp_o_f32_e64 s33, v71, v71
	v_cmp_o_f32_e64 s34, v72, v72
	v_cmp_o_f32_e64 s35, v74, v74
	v_cmp_o_f32_e64 s36, v73, v73
	...
	v_add3_u32 v51, v69, v96, 0x7fff
	v_add3_u32 v52, v70, v97, 0x7fff
	v_add3_u32 v53, v71, v98, 0x7fff
	v_add3_u32 v54, v72, v99, 0x7fff
	v_add3_u32 v55, v74, v100, 0x7fff
	v_add3_u32 v56, v73, v101, 0x7fff
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_pc_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 56
