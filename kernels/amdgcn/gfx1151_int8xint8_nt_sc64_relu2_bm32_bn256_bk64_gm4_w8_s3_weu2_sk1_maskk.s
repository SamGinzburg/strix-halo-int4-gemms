	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	s_cmp_gt_i32 s18, 63
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v63, v1, v15, s4
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s3, -1, 0
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s6, s44, s26
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_and_b32 s9, s9, 0xffff
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_and_b32 s29, s29, 0xffff
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v7, s26, v63
	.loc	1 327 14                        ; generate_amdgcn.py:327:14
	...
	v_or_b32_e32 v5, s26, v9
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_cmp_gt_i32_e32 vcc_lo, s27, v2
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[11:12], null, s27, v6, v[9:10]
	v_lshl_add_u32 v16, s27, 6, v10
	v_lshl_add_u32 v62, s27, 7, v10
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_cndmask_b32_e32 v29, 0x80000000, v7, vcc_lo
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v21, s40, v15
	v_or_b32_e32 v22, s40, v9
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v30, s40, v63
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s6, s6, 64
	...
	v_add_nc_u32_e32 v32, s6, v62
	v_add_nc_u32_e32 v14, 64, v6
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[5:8], v8, s[28:31], 0 offen
	...
	buffer_load_b128 v[25:28], v13, s[28:31], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[12:13], v29, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e32 v1, 0x80000000, v1, vcc_lo
	v_cndmask_b32_e32 v33, 0x80000000, v31, vcc_lo
	v_dual_cndmask_b32 v39, 0x80000000, v32 :: v_dual_cndmask_b32 v14, 0x80000000, v14
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[37:38], v2, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[29:32], v1, s[28:31], 0 offen
	buffer_load_b128 v[33:36], v33, s[28:31], 0 offen
	buffer_load_b128 v[40:43], v39, s[28:31], 0 offen
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v66, v3, v14
	v_and_b32_e32 v3, 48, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v65, v4, v1
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_or_b32_e32 v4, 16, v39
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v14, 0, v66
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b64 v14, v[12:13] offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b64 v14, v[37:38] offset:34816
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v1, v[29:32] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v1, v[33:36] offset:20480
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s22, s16
	s_mov_b32 s23, s16
	v_and_b32_e32 v1, 32, v64
	v_and_or_b32 v58, 0x1c00, v64, v54
	v_xor_b32_e32 v55, 16, v54
	v_xor_b32_e32 v57, 32, v54
	v_xor_b32_e32 v56, 48, v54
	v_add3_u32 v18, 0, v13, v1
	v_dual_mov_b32 v1, s16 :: v_dual_mov_b32 v6, s21
	v_xor_b32_e32 v59, 16, v58
	v_xor_b32_e32 v60, 32, v58
	v_xor_b32_e32 v61, 48, v58
	v_dual_mov_b32 v17, 0 :: v_dual_mov_b32 v4, s19
	v_dual_mov_b32 v2, s17 :: v_dual_mov_b32 v3, s18
	v_dual_mov_b32 v8, s23 :: v_dual_mov_b32 v5, s20
	v_dual_mov_b32 v7, s22 :: v_dual_add_nc_u32 v68, 0, v14
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v67, v18, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v69, s40, v15
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_lshr_b32 s19, s19, 26
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v71, s40, v63
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v70, s40, v9
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v76, v52, s18, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v74, s20, v62
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[173:174], v69, s[8:11], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v69, 0x80000000, v71, vcc_lo
	v_cndmask_b32_e32 v71, 0x80000000, v75, vcc_lo
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	buffer_load_u16 v175, v69, s[4:7], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	buffer_load_u16 v176, v75, s[36:39], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v177, v71, s[4:7], 0 offen
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v69, s20, v11
	.loc	1 376 22 is_stmt 0              ; generate_amdgcn.py:376:22
	v_cndmask_b32_e32 v71, 0x80000000, v73, vcc_lo
	s_mov_b32 s19, s16
	s_mov_b32 s16, s43
	v_add_nc_u32_e32 v73, s19, v58
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v74, s19, v59
	v_add_nc_u32_e32 v75, s19, v60
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v179, s43, v65
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2)
	v_mul_f32_e32 v144, v78, v133
	v_mul_f32_e32 v78, v78, v134
	v_dual_mul_f32 v145, v79, v133 :: v_dual_add_nc_u32 v178, s19, v66
	...
	v_mul_f32_e32 v149, v83, v133
	v_dual_mul_f32 v133, v84, v133 :: v_dual_fmac_f32 v20, v138, v120
	v_mul_f32_e32 v69, v69, v134
	v_mul_f32_e32 v70, v70, v134
	v_dual_mul_f32 v71, v71, v134 :: v_dual_fmac_f32 v24, v142, v124
	v_mul_f32_e32 v72, v72, v134
	v_dual_mul_f32 v73, v73, v134 :: v_dual_fmac_f32 v28, v146, v128
	v_mul_f32_e32 v74, v74, v134
	v_dual_mul_f32 v75, v75, v134 :: v_dual_fmac_f32 v32, v133, v132
	v_mul_f32_e32 v76, v76, v134
	v_dual_mul_f32 v77, v77, v134 :: v_dual_fmac_f32 v36, v72, v88
	v_mul_f32_e32 v80, v80, v134
	v_mul_f32_e32 v79, v79, v134
	v_dual_mul_f32 v81, v81, v134 :: v_dual_fmac_f32 v40, v75, v91
	v_mul_f32_e32 v82, v82, v134
	v_mul_f32_e32 v84, v84, v134
	v_mul_f32_e32 v83, v83, v134
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v17, v135, v117 :: v_dual_fmac_f32 v18, v136, v118
	v_dual_fmac_f32 v19, v137, v119 :: v_dual_fmac_f32 v22, v140, v122
	v_dual_fmac_f32 v21, v139, v121 :: v_dual_fmac_f32 v26, v144, v126
	v_dual_fmac_f32 v23, v141, v123 :: v_dual_fmac_f32 v30, v148, v130
	v_dual_fmac_f32 v25, v143, v125 :: v_dual_fmac_f32 v34, v70, v86
	v_dual_fmac_f32 v27, v145, v127 :: v_dual_fmac_f32 v38, v74, v90
	v_dual_fmac_f32 v29, v147, v129 :: v_dual_fmac_f32 v44, v78, v94
	v_dual_fmac_f32 v31, v149, v131 :: v_dual_fmac_f32 v48, v82, v98
	v_fmac_f32_e32 v33, v69, v85
	v_fmac_f32_e32 v35, v71, v87
	v_fmac_f32_e32 v37, v73, v89
	v_fmac_f32_e32 v41, v76, v92
	v_dual_fmac_f32 v43, v77, v93 :: v_dual_fmac_f32 v46, v80, v96
	v_fmac_f32_e32 v45, v79, v95
	v_dual_fmac_f32 v47, v81, v97 :: v_dual_fmac_f32 v42, v84, v100
...
; %bb.9:
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v10, s16, v61
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v11, s14, v56
	ds_load_b128 v[117:120], v3 offset:1024
	ds_load_b128 v[121:124], v3
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[133:136], v11
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[145:148], v11 offset:1024
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(8)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 186
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
