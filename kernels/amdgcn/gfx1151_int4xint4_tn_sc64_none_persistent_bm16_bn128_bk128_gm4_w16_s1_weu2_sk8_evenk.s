...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v113, 0 :: v_dual_add_nc_u32 v0, s46, v8
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v120, s46, v10
	...
	v_dual_mov_b32 v112, 0 :: v_dual_mov_b32 v75, 0
	v_dual_mov_b32 v110, 0 :: v_dual_mov_b32 v73, 0
	v_dual_mov_b32 v108, 0 :: v_dual_mov_b32 v69, 0
	...
	v_dual_mov_b32 v70, 0 :: v_dual_mov_b32 v89, 0
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v33, v99, v92 offset0:64 offset1:96
	ds_store_2addr_b32 v34, v111, v110 offset1:32
	ds_store_2addr_b32 v34, v94, v90 offset0:64 offset1:96
	ds_store_2addr_b32 v35, v109, v108 offset1:32
	ds_store_2addr_b32 v35, v91, v88 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v39, v83, v77 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v42, v79, v78 offset1:32
	ds_store_2addr_b32 v42, v63, v59 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v45, v72, v70 offset1:32
	ds_store_2addr_b32 v45, v57, v53 offset0:64 offset1:96
	ds_store_2addr_b32 v46, v71, v69 offset1:32
	ds_store_2addr_b32 v46, v56, v52 offset0:64 offset1:96
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk8_evenk.numbered_sgpr, 51
