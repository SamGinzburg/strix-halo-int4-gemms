	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v16, s35, 4, v9
	v_lshl_add_u32 v18, s35, 5, v9
	.loc	1 293 16                        ; generate_amdgcn.py:293:16
...
.Ltmp21:
	...
	v_cndmask_b32_e64 v8, 0x80000000, v19, s2
	v_cndmask_b32_e64 v12, 0x80000000, v20, s2
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	buffer_load_b32 v13, v1, s[4:7], 0 offen
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x3
	buffer_load_b128 v[33:36], v6, s[24:27], 0 offen
	buffer_load_b128 v[41:44], v7, s[24:27], 0 offen
	buffer_load_b128 v[45:48], v8, s[24:27], 0 offen
	buffer_load_b128 v[49:52], v12, s[24:27], 0 offen
...
.LBB0_3:                                ; %Flow133
	...
	v_or_b32_e32 v21, s23, v0
	v_lshlrev_b32_e32 v13, 1, v0
	v_mul_lo_u32 v39, v2, s40
	v_lshlrev_b32_e32 v12, 2, v3
	v_lshlrev_b32_e32 v14, 5, v0
	v_lshlrev_b32_e32 v23, 1, v3
	s_and_not1_b32 vcc_lo, exec_lo, s10
	s_add_i32 s41, s22, 0x200
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 346 30                        ; generate_amdgcn.py:346:30
	v_mad_u64_u32 v[45:46], null, s41, s34, v[11:12]
	...
	s_barrier
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	buffer_load_u16 v188, v59, s[36:39], 0 offen
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v189, v51, s[28:31], 0 offen
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	v_add_nc_u32_e32 v49, s16, v18
	v_add_nc_u32_e32 v50, s16, v10
	.loc	1 352 22 is_stmt 0              ; generate_amdgcn.py:352:22
	s_clause 0x3
	buffer_load_b128 v[59:62], v46, s[24:27], 0 offen
	buffer_load_b128 v[63:66], v48, s[24:27], 0 offen
	buffer_load_b128 v[67:70], v49, s[24:27], 0 offen
	buffer_load_b128 v[71:74], v50, s[24:27], 0 offen
	...
	v_dual_mul_f32 v51, v51, v91 :: v_dual_add_nc_u32 v254, s42, v40
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v29, v49, v81 :: v_dual_mul_f32 v54, v54, v91
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v33, v52, v84
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v56, v56, v91 :: v_dual_fmac_f32 v35, v54, v86
	v_mul_f32_e32 v57, v57, v91
	v_dual_mul_f32 v58, v58, v91 :: v_dual_fmac_f32 v25, v45, v77
	v_dual_mul_f32 v53, v53, v91 :: v_dual_fmac_f32 v30, v50, v82
	v_mul_f32_e32 v55, v55, v91
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v28, v48, v80 :: v_dual_add_nc_u32 v253, s15, v15
	v_fmac_f32_e32 v24, v44, v76
	v_dual_fmac_f32 v26, v46, v78 :: v_dual_fmac_f32 v27, v47, v79
	v_fmac_f32_e32 v38, v57, v89
	v_fmac_f32_e32 v34, v53, v85
	v_dual_fmac_f32 v36, v55, v87 :: v_dual_fmac_f32 v37, v56, v88
	v_dual_fmac_f32 v32, v51, v83 :: v_dual_fmac_f32 v31, v58, v90
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
...
; %bb.9:
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v57, s19 :: v_dual_add_nc_u32 v6, s10, v17
	...
	v_dual_mov_b32 v55, s17 :: v_dual_add_nc_u32 v44, s10, v59
...
; %bb.11:
	...
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	v_add_nc_u32_e32 v61, s42, v18
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	v_add_nc_u32_e32 v18, s43, v59
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
...
.LBB0_12:
	...
	s_cmp_lt_i32 s5, s40
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v17, v39, s5, 1
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v18, v21, s6, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	...
	buffer_load_u16 v39, v18, s[20:23], 0 offen
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v59, v17, s[8:11], 0 offen
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 255
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
