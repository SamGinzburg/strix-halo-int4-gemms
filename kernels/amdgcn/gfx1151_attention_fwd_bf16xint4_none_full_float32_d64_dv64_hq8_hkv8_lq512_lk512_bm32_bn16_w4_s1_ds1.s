	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v73, v[9:12] offset:2048
	v_mov_b32_e32 v10, v16
	v_lshl_or_b32 v70, v65, 7, v5
	v_mov_b32_e32 v11, v16
	v_dual_mov_b32 v12, v16 :: v_dual_lshlrev_b32 v19, 2, v66
	...
	v_dual_mov_b32 v3, v16 :: v_dual_lshlrev_b32 v64, 1, v65
	v_add3_u32 v5, 0, v19, v63
	v_or3_b32 v72, v0, v21, v18
	v_lshl_or_b32 v0, v63, 6, v70
	v_add_nc_u32_e32 v7, 0, v20
	v_add_nc_u32_e32 v15, 0, v15
	v_dual_mov_b32 v1, v16 :: v_dual_lshlrev_b32 v14, 1, v63
	v_add_nc_u32_e32 v71, 0, v61
	v_add_nc_u32_e32 v75, v5, v64
	v_add_nc_u32_e32 v5, 0, v0
	v_dual_mov_b32 v69, 0 :: v_dual_add_nc_u32 v76, v7, v64
	v_xad_u32 v7, v0, 16, 0
	v_add_nc_u32_e32 v77, v15, v13
	v_xad_u32 v13, v0, 32, 0
	v_add_nc_u32_e32 v74, v71, v14
	v_xad_u32 v14, v0, 48, 0
	v_xad_u32 v15, v0, 64, 0
	v_xad_u32 v44, 0x50, v0, 0
	...
	v_xor_b32_e32 v17, 32, v70
	v_xor_b32_e32 v18, 48, v70
	v_xor_b32_e32 v19, 64, v70
	.loc	1 759 21 is_stmt 0              ; attention.py:759:21
	v_or3_b32 v22, s15, v65, v67
	v_xor_b32_e32 v20, 0x50, v70
	v_xor_b32_e32 v21, 0x60, v70
	v_xor_b32_e32 v23, 16, v72
	.loc	1 981 24 is_stmt 1              ; attention.py:981:24
	v_cmp_gt_i32_e64 s1, s11, v61
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s0, 0x200, v22
	v_xor_b32_e32 v22, 0x70, v70
	v_add_nc_u32_e32 v78, 0, v6
	v_add_nc_u32_e32 v79, 0, v17
	v_add_nc_u32_e32 v80, 0, v18
	v_add_nc_u32_e32 v81, 0, v19
	v_add_nc_u32_e32 v82, 0, v20
	v_add_nc_u32_e32 v83, 0, v21
	v_add_nc_u32_e32 v84, 0, v22
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s2, s2, s10
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v20, v16 :: v_dual_add_nc_u32 v87, 0, v70
	.loc	1 939 32                        ; attention.py:939:32
	v_add_lshl_u32 v17, s2, v60, 1
	.loc	1 974 36                        ; attention.py:974:36
	s_lshr_b32 s2, s29, 1
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v19, v16 :: v_dual_add_nc_u32 v106, 0, v72
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v18, v16 :: v_dual_cndmask_b32 v17, 0x80000000, v17
	v_mov_b32_e32 v21, v16
	v_dual_mov_b32 v22, v16 :: v_dual_mov_b32 v113, v69
	.loc	1 1018 23                       ; attention.py:1018:23
	v_add_nc_u32_e32 v88, v71, v62
	.loc	1 939 32                        ; attention.py:939:32
	buffer_load_b128 v[56:59], v17, s[16:19], 0 offen
	.loc	1 944 30                        ; attention.py:944:30
	v_mov_b32_e32 v17, v16
	v_dual_mov_b32 v96, v23 :: v_dual_add_nc_u32 v69, s2, v68
	...
	v_mad_u64_u32 v[17:18], null, v69, s11, v[61:62]
	.loc	1 1001 25                       ; attention.py:1001:25
	s_mul_i32 s3, s3, s11
	.loc	1 939 32                        ; attention.py:939:32
	s_waitcnt lgkmcnt(0)
...
.Ltmp4:
	...
	v_permlanex16_b32 v89, v87, s30, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp5:
...
.Ltmp8:
	...
	v_dual_add_f32 v98, v19, v20 :: v_dual_sub_f32 v89, v86, v87
...
.Ltmp15:
	...
	v_cndmask_b16 v20.h, 0x7fff, v69.h, s9
	ds_store_b16 v75, v17
	ds_store_b16_d16_hi v75, v17 offset:128
	ds_store_b16 v75, v18 offset:256
	ds_store_b16_d16_hi v75, v18 offset:384
	ds_store_b16 v75, v19 offset:512
	ds_store_b16_d16_hi v75, v19 offset:640
	ds_store_b16 v75, v20 offset:768
	ds_store_b16_d16_hi v75, v20 offset:896
	...
	.loc	1 978 32                        ; attention.py:978:32
	v_bfe_i32 v21, v69, 0, 8
	.loc	1 989 29                        ; attention.py:989:29
	v_or_b16 v56.l, v18.l, v20.l
	.loc	1 990 56                        ; attention.py:990:56
	v_or_b16 v20.l, v18.h, -16
	.loc	1 988 32                        ; attention.py:988:32
	v_lshrrev_b16 v19.l, 4, v69.l
	.loc	1 986 76                        ; attention.py:986:76
	v_and_b16 v17.h, v69.l, 15
	.loc	1 990 39                        ; attention.py:990:39
	...
	v_dual_mul_f32 v69, v105, v69 :: v_dual_mul_f32 v12, v12, v86
	v_dual_mul_f32 v97, v105, v97 :: v_dual_mul_f32 v14, v14, v86
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_dual_mul_f32 v19, v22, v19 :: v_dual_mul_f32 v4, v4, v86
	v_cvt_f32_i32_e32 v17, v17
	.loc	1 1017 30 is_stmt 0             ; attention.py:1017:30
	v_mov_b16_e32 v23.l, v69.h
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v2, v2, v86 :: v_dual_and_b32 v23, 1, v107
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_dual_mul_f32 v21, v59, v21 :: v_dual_mul_f32 v0, v0, v86
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v6, v6, v86 :: v_dual_and_b32 v59, 1, v111
...
.Ltmp16:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v89, v99, v89 :: v_dual_mul_f32 v18, v110, v18
.Ltmp17:
	.loc	1 1019 30                       ; attention.py:1019:30
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp19:
	.loc	1 1019 30                       ; attention.py:1019:30
	ds_load_u16_d16 v89, v76
	ds_load_u16_d16 v90, v76 offset:128
	ds_load_u16_d16 v91, v76 offset:256
	ds_load_u16_d16 v92, v76 offset:384
	ds_load_u16_d16 v93, v76 offset:512
	ds_load_u16_d16 v94, v76 offset:640
	ds_load_u16_d16 v95, v76 offset:768
	ds_load_u16_d16 v96, v76 offset:896
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v89, v76 offset:64
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v90, v76 offset:192
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v91, v76 offset:320
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v92, v76 offset:448
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v93, v76 offset:576
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v94, v76 offset:704
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v95, v76 offset:832
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v96, v76 offset:960
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b32 v77, v23, v20 offset1:8
	ds_store_2addr_b32 v77, v18, v19 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp20:
	...
	v_permlanex16_b32 v58, v57, s30, 0xfedcba98 op_sel:[1,0]
.Ltmp21:
	.loc	1 903 13                        ; attention.py:903:13
	s_add_i32 s2, s29, 16
	s_cmpk_lt_u32 s29, 0x1f0
	s_mov_b32 s29, s2
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp22:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_vgpr, 117
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.kd
