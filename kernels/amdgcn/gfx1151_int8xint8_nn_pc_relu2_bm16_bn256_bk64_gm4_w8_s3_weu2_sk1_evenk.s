...
.Ltmp13:
	...
	buffer_load_b128 v[14:17], v8, s[20:23], 0 offen
	...
	buffer_load_b128 v[32:35], v8, s[20:23], 0 offen
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v2, s4, v9
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	buffer_load_b128 v[50:53], v8, s[20:23], 0 offen
...
.Ltmp14:
	...
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v3, 0x210, v4
	v_bfe_i32 v4, v0, 5, 1
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v48, s25, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_dual_mov_b32 v8, s11 :: v_dual_mov_b32 v23, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[77:80], v56, s[20:23], 0 offen
	buffer_load_b128 v[81:84], v57, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	s_add_i32 s28, s8, 0
	s_mov_b32 s29, s27
	v_add_nc_u32_e32 v131, s28, v39
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s27, s7, 0x8000
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v134, s28, v42
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v136, s28, v44
	v_add_nc_u32_e32 v137, s28, v45
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v14, v14, v53 :: v_dual_add_f32 v29, v29, v54
	v_dual_add_f32 v28, v28, v55 :: v_dual_add_f32 v27, v27, v56
	...
	v_dual_add_f32 v15, v15, v68 :: v_dual_add_nc_u32 v130, s7, v38
	v_dual_add_f32 v17, v17, v66 :: v_dual_add_nc_u32 v132, s28, v40
	v_dual_add_f32 v16, v16, v67 :: v_dual_add_nc_u32 v133, s28, v41
...
; %bb.8:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_f32 v16, v16, v8 :: v_dual_add_f32 v17, v17, v7
	v_dual_add_f32 v15, v15, v9 :: v_dual_add_f32 v14, v14, v10
.LBB0_9:
...
; %bb.10:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v44, s11 :: v_dual_add_nc_u32 v31, s28, v2
	v_dual_mov_b32 v42, s9 :: v_dual_add_nc_u32 v35, s27, v35
	v_dual_mov_b32 v37, s4 :: v_dual_add_nc_u32 v32, s27, v32
	v_dual_mov_b32 v39, s6 :: v_dual_add_nc_u32 v30, s28, v3
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v43, s10 :: v_dual_add_nc_u32 v6, s28, v4
	v_dual_mov_b32 v40, s7 :: v_dual_add_nc_u32 v31, s27, v34
	v_dual_mov_b32 v41, s8 :: v_dual_add_nc_u32 v10, s28, v5
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_11:
	...
	v_dual_mov_b32 v45, 0x7632 :: v_dual_lshlrev_b32 v40, 2, v13
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	buffer_load_u16 v2, v3, s[4:7], 0 offen
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_lshlrev_b32_e32 v1, 5, v1
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v3, v14, v6 :: v_dual_add_f32 v4, v29, v7
	...
	v_dual_add_f32 v38, v16, v43 :: v_dual_add_f32 v39, v15, v44
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v46, v14, v3, s2
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v14, v14, v32 :: v_dual_max_f32 v1, 0, v1
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v11, v19, v11
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v3, v3, v32 :: v_dual_mul_f32 v10, v20, v10
	v_mul_f32_e32 v2, v2, v32
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v5, v5, v32 :: v_dual_mul_f32 v14, v16, v14
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v3, v27, v3 :: v_dual_mul_f32 v0, v46, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v2, v28, v2 :: v_dual_mul_f32 v7, v7, v32
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v4, v4, v32 :: v_dual_mul_f32 v5, v25, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v13, v13, v32 :: v_dual_max_f32 v14, 0, v14
	.loc	1 443 15 is_stmt 1              ; generate_amdgcn.py:443:15
	v_max_f32_e32 v2, 0, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v6, v6, v32 :: v_dual_mul_f32 v7, v23, v7
	v_mul_f32_e32 v15, v15, v32
	v_dual_mul_f32 v12, v12, v32 :: v_dual_mul_f32 v13, v17, v13
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 436 9 is_stmt 0               ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v6, v24, v6 :: v_dual_mul_f32 v9, v9, v32
	.loc	1 443 15 is_stmt 1              ; generate_amdgcn.py:443:15
	v_dual_max_f32 v3, 0, v3 :: v_dual_max_f32 v0, 0, v0
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v2, v2, v2
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v15, v30, v15
	v_dual_mul_f32 v4, v26, v4 :: v_dual_max_f32 v5, 0, v5
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v6, 0, v6
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v8, v8, v32 :: v_dual_mul_f32 v9, v21, v9
	.loc	1 436 9 is_stmt 0               ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v12, v18, v12
	.loc	1 444 15 is_stmt 1              ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v0, v0, v0 :: v_dual_mul_f32 v1, v1, v1
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v8, v22, v8 :: v_dual_max_f32 v7, 0, v7
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v12, v12, v12 :: v_dual_cndmask_b32 v5, v3, v1
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_mov_b16_e32 v42.l, v11.h
	v_mov_b16_e32 v2.l, v6.h
	v_and_b32_e32 v21, 1, v37
	v_and_b32_e32 v22, 1, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_cndmask_b32 v6, 0x3276, v45 :: v_dual_and_b32 v7, 1, v42
	...
	buffer_store_b128 v[4:7], v33, s[0:3], 0 offen offset:256
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 138
