...
.Ltmp13:
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v20, s37, v47
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_and_b32 s21, s21, 0xffff
	s_mov_b32 s6, 0
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v46, v43, 4, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_add3_u32 v1, s28, s4, v46
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	s_mul_i32 s4, s18, s37
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	v_add_nc_u32_e32 v27, s19, v1
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v52, 0x90, v51
	v_add_nc_u32_e32 v62, 0, v51
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v53, 0x110, v51
	v_add_nc_u32_e32 v63, 0, v52
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v41, v2, v19, s29
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v19, s37, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v64, 0, v53
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	...
	v_cndmask_b32_e64 v23, 0x80000000, v19, s3
	s_clause 0x1
	buffer_load_b128 v[19:22], v1, s[24:27], 0 offen
	buffer_load_b128 v[23:26], v23, s[24:27], 0 offen
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e64 v1, 0x80000000, v27, s3
	v_cndmask_b32_e64 v31, 0x80000000, v28, s3
	s_clause 0x1
	...
	s_lshl_b32 s3, s18, 5
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_u16 v60, v1, s[20:23], 0 offen
	.loc	1 398 17 is_stmt 1              ; generate_amdgcn.py:398:17
	v_or_b32_e32 v1, s37, v47
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s31, v1
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v1, s4, s3, v41
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_lshlrev_b32 v2, 4, v0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s5, 0x5f
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_u16 v65, v1, s[20:23], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(8)
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(6)
	v_perm_b32 v70, v15, v11, 0x5010400
	v_perm_b32 v71, v15, v11, 0x7030602
	v_perm_b32 v72, v16, v12, 0x5010400
	v_perm_b32 v73, v16, v12, 0x7030602
	v_perm_b32 v74, v17, v13, 0x5010400
	v_perm_b32 v75, v17, v13, 0x7030602
	v_perm_b32 v76, v18, v14, 0x5010400
	v_perm_b32 v77, v18, v14, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_lshlrev_b16 v17.h, 8, v69.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v18.l, 0xff, v70.l
	v_lshrrev_b32_e32 v55, 8, v70
	v_lshrrev_b32_e32 v56, 24, v70
	v_and_b16 v18.h, 0xff, v70.h
	v_and_b16 v35.l, 0xff, v71.l
	v_lshrrev_b32_e32 v57, 8, v71
	v_lshrrev_b32_e32 v58, 24, v71
	v_and_b16 v35.h, 0xff, v71.h
	v_and_b16 v36.l, 0xff, v72.l
	v_lshrrev_b32_e32 v59, 8, v72
	...
	v_and_b16 v54.l, 0xff, v77.l
	v_lshrrev_b32_e32 v75, 8, v77
	v_lshrrev_b32_e32 v76, 24, v77
	v_and_b16 v54.h, 0xff, v77.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(4)
	v_perm_b32 v77, v23, v19, 0x5010400
	v_perm_b32 v23, v23, v19, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(2)
	v_perm_b32 v82, v31, v27, 0x5010400
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_perm_b32 v80, v26, v22, 0x5010400
	v_perm_b32 v81, v26, v22, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v31, v31, v27, 0x7030602
	v_perm_b32 v83, v32, v28, 0x5010400
	v_perm_b32 v32, v32, v28, 0x7030602
	v_perm_b32 v84, v33, v29, 0x5010400
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v10.l, 8, v55.l
	v_lshlrev_b16 v11.l, 8, v57.l
	v_lshlrev_b16 v14.h, 8, v70.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v10.h, 8, v56.l
	v_lshlrev_b16 v11.h, 8, v58.l
	v_lshlrev_b16 v15.l, 8, v71.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v58, 24, v23
	v_and_b16 v19.l, 0xff, v77.l
	v_and_b16 v19.h, 0xff, v77.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v13.l, 8, v67.l
	v_lshlrev_b16 v13.h, 8, v68.l
	v_lshlrev_b16 v14.l, 8, v69.l
	v_lshlrev_b16 v16.h, 8, v74.l
	v_lshlrev_b16 v17.l, 8, v75.l
	v_lshlrev_b16 v17.h, 8, v76.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b16 v20.l, 0xff, v23.l
	v_and_b16 v20.h, 0xff, v23.h
	v_and_b16 v21.l, 0xff, v78.l
	v_lshrrev_b32_e32 v59, 8, v78
	v_lshrrev_b32_e32 v66, 24, v78
	v_and_b16 v21.h, 0xff, v78.h
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v1.h, v35.l, v11.l
	v_or_b16 v11.l, v38.h, v14.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v14.h, 8, v55.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v3.l, v35.h, v11.h
	v_or_b16 v11.h, v39.l, v15.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v15.l, 8, v56.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v3.h, v36.l, v12.l
	v_or_b16 v12.l, v39.h, v15.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v15.h, 8, v57.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v4.h, v36.h, v12.h
	v_or_b16 v12.h, v40.l, v16.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v16.l, 8, v58.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v1.l, v18.h, v10.h
	v_lshlrev_b16 v38.h, 8, v77.l
	v_and_b16 v34.l, 0xff, v86.l
	v_and_b16 v34.h, 0xff, v86.h
	v_or_b16 v5.l, v37.l, v13.l
	v_or_b16 v5.h, v37.h, v13.h
	v_or_b16 v10.h, v38.l, v14.l
	v_or_b16 v13.l, v40.h, v16.h
	v_or_b16 v13.h, v54.l, v17.l
	v_or_b16 v14.l, v54.h, v17.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v16.h, 8, v59.l
	v_lshlrev_b16 v17.l, 8, v66.l
	...
	v_lshlrev_b16 v54.l, 8, v82.l
	v_lshlrev_b16 v54.h, 8, v83.l
	...
	ds_store_b16 v62, v10 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v63, v4
	ds_store_b16 v64, v6
	...
	ds_store_b16 v62, v9 offset:448
	ds_store_b16_d16_hi v62, v9 offset:480
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	ds_store_b16_d16_hi v64, v10 offset:16384
	ds_store_b16 v64, v11 offset:16416
	ds_store_b16_d16_hi v64, v11 offset:16448
	ds_store_b16 v64, v12 offset:16480
	ds_store_b16_d16_hi v62, v12 offset:16768
	ds_store_b16 v62, v13 offset:16800
	ds_store_b16_d16_hi v62, v13 offset:16832
	ds_store_b16 v62, v14 offset:16864
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v1.l, v19.l, v14.h
	v_or_b16 v1.h, v19.h, v15.l
	v_or_b16 v3.l, v20.l, v15.h
	v_or_b16 v3.h, v20.h, v16.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v10.l, v27.l, v38.h
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v4.l, v21.l, v16.h
	v_or_b16 v4.h, v21.h, v17.l
	v_or_b16 v5.l, v22.l, v17.h
	v_or_b16 v5.h, v22.h, v18.l
	v_or_b16 v6.l, v23.l, v18.h
	v_or_b16 v6.h, v23.h, v35.l
	v_or_b16 v7.l, v24.l, v35.h
	v_or_b16 v7.h, v24.h, v36.l
	v_or_b16 v8.l, v25.l, v36.h
	v_or_b16 v8.h, v25.h, v37.l
	v_or_b16 v9.l, v26.l, v37.h
	v_or_b16 v9.h, v26.h, v38.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v10.h, v27.h, v39.l
	v_or_b16 v11.l, v28.l, v39.h
	v_or_b16 v11.h, v28.h, v40.l
	v_or_b16 v12.l, v29.l, v40.h
	v_or_b16 v12.h, v29.h, v54.l
	v_or_b16 v13.l, v30.l, v54.h
	v_or_b16 v13.h, v30.h, v55.l
	v_or_b16 v14.l, v31.l, v55.h
	v_or_b16 v14.h, v31.h, v56.l
	v_or_b16 v15.l, v32.l, v56.h
	v_or_b16 v15.h, v32.h, v57.l
	v_or_b16 v16.l, v33.l, v57.h
	v_or_b16 v16.h, v33.h, v58.l
	v_or_b16 v17.l, v34.l, v58.h
	v_or_b16 v17.h, v34.h, v59.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v62, v10 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v62, v11 offset:24640
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v62, v8 offset:8576
	ds_store_b16_d16_hi v62, v8 offset:8608
	ds_store_b16 v62, v9 offset:8640
	ds_store_b16_d16_hi v62, v9 offset:8672
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v62, v10 offset:24608
	ds_store_b16_d16_hi v62, v11 offset:24672
	ds_store_b16 v63, v12 offset:24576
	ds_store_b16_d16_hi v63, v12 offset:24608
	ds_store_b16 v63, v13 offset:24640
	ds_store_b16_d16_hi v63, v13 offset:24672
	ds_store_b16 v64, v14 offset:24576
	ds_store_b16_d16_hi v64, v14 offset:24608
	ds_store_b16 v64, v15 offset:24640
	ds_store_b16_d16_hi v64, v15 offset:24672
	ds_store_b16 v62, v16 offset:24960
	ds_store_b16_d16_hi v62, v16 offset:24992
	ds_store_b16 v62, v17 offset:25024
	ds_store_b16_d16_hi v62, v17 offset:25056
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
.Ltmp14:
	...
	v_and_or_b32 v54, 0x60, v48, v2
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v55, s33, v46
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s0, s37, s3
	s_mov_b32 s7, s4
	v_or_b32_e32 v61, s0, v47
	v_or_b32_e32 v62, s0, v45
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s3, s0, s33
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[58:59], null, s0, s18, v[41:42]
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s0, s3, s28
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s31, v61
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v59, s0, v46
	v_add_nc_u32_e32 v63, s0, v55
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	s_add_i32 s3, s0, s19
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	...
	buffer_load_b128 v[94:97], v63, s[24:27], 0 offen
	buffer_load_b128 v[98:101], v61, s[24:27], 0 offen
	buffer_load_b128 v[102:105], v62, s[24:27], 0 offen
	v_add_nc_u32_e32 v58, s7, v56
	v_add_nc_u32_e32 v59, s7, v57
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v60, s6, v43
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v61, s8, v56
	v_add_nc_u32_e32 v62, s8, v57
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[66:69], v58
	ds_load_b128 v[74:77], v58 offset:4096
	ds_load_b128 v[106:109], v59
	ds_load_b128 v[110:113], v59 offset:4096
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v58, v60 offset:208
	ds_load_u8 v59, v60 offset:240
	ds_load_u8 v63, v60 offset:224
	ds_load_u8 v64, v60 offset:192
	ds_load_u8 v65, v60 offset:144
	ds_load_u8 v70, v60 offset:176
	ds_load_u8 v71, v60 offset:160
	ds_load_u8 v72, v60 offset:128
	ds_load_u8 v73, v60 offset:80
	ds_load_u8 v78, v60 offset:112
	ds_load_u8 v79, v60 offset:96
	ds_load_u8 v80, v60 offset:64
	ds_load_u8 v81, v60
	ds_load_u8 v86, v60 offset:16
	ds_load_u8 v87, v60 offset:32
	ds_load_u8 v88, v60 offset:48
	ds_load_u8 v89, v60 offset:464
	ds_load_u8 v126, v60 offset:496
	ds_load_u8 v127, v60 offset:480
	ds_load_u8 v128, v60 offset:448
	ds_load_u8 v129, v60 offset:400
	ds_load_u8 v130, v60 offset:432
	ds_load_u8 v131, v60 offset:416
	ds_load_u8 v132, v60 offset:384
	ds_load_u8 v133, v60 offset:336
	ds_load_u8 v135, v60 offset:368
	ds_load_u8 v136, v60 offset:352
	ds_load_u8 v137, v60 offset:320
	ds_load_u8 v138, v60 offset:272
	ds_load_u8 v139, v60 offset:304
	ds_load_u8 v140, v60 offset:288
	ds_load_u8 v60, v60 offset:256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[82:85], v61
	ds_load_b128 v[114:117], v61 offset:4096
	ds_load_b128 v[118:121], v62
	ds_load_b128 v[122:125], v62 offset:4096
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v58, v64, v58, 0xc0c0004
	v_perm_b32 v59, v63, v59, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v61, v72, v65, 0xc0c0004
	v_perm_b32 v62, v71, v70, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v63, v80, v73, 0xc0c0004
	v_perm_b32 v64, v79, v78, 0xc0c0004
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v65, v81, v86, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v70, v87, v88, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v71, v128, v89, 0xc0c0004
	v_perm_b32 v72, v127, v126, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v73, v132, v129, 0xc0c0004
	v_perm_b32 v78, v131, v130, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v79, v137, v133, 0xc0c0004
	v_perm_b32 v80, v136, v135, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v81, v140, v139, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v60, v60, v138, 0xc0c0004
	v_lshl_or_b32 v129, v59, 16, v58
	v_lshl_or_b32 v128, v62, 16, v61
	v_lshl_or_b32 v127, v64, 16, v63
	v_lshl_or_b32 v126, v70, 16, v65
	v_lshl_or_b32 v133, v72, 16, v71
	v_lshl_or_b32 v132, v78, 16, v73
	v_lshl_or_b32 v131, v80, 16, v79
	v_lshl_or_b32 v130, v81, 16, v60
	v_wmma_i32_16x16x16_iu8 v[58:65], v[66:69], v[126:129], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[66:73], v[74:77], v[126:129], v[1:8] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[74:81], v[82:85], v[126:129], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[58:65], v[106:109], v[130:133], v[58:65] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[82:89], v[114:117], v[126:129], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[74:81], v[118:121], v[130:133], v[74:81] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[66:73], v[110:113], v[130:133], v[66:73] neg_lo:[1,1,0]
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[82:89], v[122:125], v[130:133], v[82:89] neg_lo:[1,1,0]
	...
	v_dual_add_f32 v40, v40, v69 :: v_dual_add_nc_u32 v141, s3, v44
	v_dual_add_f32 v39, v39, v68 :: v_dual_add_nc_u32 v142, s34, v51
	v_dual_add_f32 v24, v24, v71 :: v_dual_add_nc_u32 v143, s34, v52
	v_dual_add_f32 v23, v23, v70 :: v_dual_add_nc_u32 v144, s34, v53
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v30, v30, v65 :: v_dual_add_f32 v29, v29, v64
	v_dual_add_f32 v32, v32, v67 :: v_dual_add_f32 v31, v31, v66
	v_dual_add_f32 v34, v34, v73 :: v_dual_add_f32 v33, v33, v72
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v10, v10, v75 :: v_dual_add_f32 v9, v9, v74
	v_dual_add_f32 v28, v28, v77 :: v_dual_add_f32 v27, v27, v76
	v_dual_add_f32 v12, v12, v79 :: v_dual_add_f32 v11, v11, v78
	v_dual_add_f32 v20, v20, v81 :: v_dual_add_f32 v19, v19, v80
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v25, v25, v58 :: v_dual_add_f32 v22, v22, v83
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v21, v21, v82 :: v_dual_add_f32 v36, v36, v85
	v_dual_add_f32 v35, v35, v84 :: v_dual_add_f32 v14, v14, v87
	v_dual_add_f32 v13, v13, v86 :: v_dual_add_f32 v18, v18, v89
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b16 v141, v134 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v59, v94, v90, 0x5010400
	v_perm_b32 v60, v94, v90, 0x7030602
	v_perm_b32 v62, v95, v91, 0x7030602
	v_perm_b32 v61, v95, v91, 0x5010400
	v_perm_b32 v63, v96, v92, 0x5010400
	v_perm_b32 v64, v96, v92, 0x7030602
	v_perm_b32 v65, v97, v93, 0x5010400
	v_perm_b32 v66, v97, v93, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v67, v102, v98, 0x5010400
	v_perm_b32 v68, v102, v98, 0x7030602
	v_perm_b32 v69, v103, v99, 0x5010400
	v_perm_b32 v70, v103, v99, 0x7030602
	v_perm_b32 v71, v104, v100, 0x5010400
	v_perm_b32 v72, v104, v100, 0x7030602
	v_perm_b32 v73, v105, v101, 0x5010400
	v_perm_b32 v74, v105, v101, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v75, 8, v59
	v_lshrrev_b32_e32 v76, 24, v59
	v_lshrrev_b32_e32 v77, 8, v60
	v_lshrrev_b32_e32 v78, 24, v60
	...
	v_lshrrev_b32_e32 v80, 24, v61
	v_and_b16 v61.l, 0xff, v62.l
	v_lshrrev_b32_e32 v82, 24, v62
	v_and_b16 v62.l, 0xff, v63.l
	v_lshrrev_b32_e32 v83, 8, v63
	v_lshrrev_b32_e32 v84, 24, v63
	v_and_b16 v63.l, 0xff, v64.l
	v_lshrrev_b32_e32 v85, 8, v64
	v_lshrrev_b32_e32 v86, 24, v64
	v_and_b16 v64.l, 0xff, v65.l
	v_lshrrev_b32_e32 v87, 8, v65
	v_lshrrev_b32_e32 v88, 24, v65
	v_and_b16 v65.l, 0xff, v66.l
	v_lshrrev_b32_e32 v89, 8, v66
	v_lshrrev_b32_e32 v90, 24, v66
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v66.l, 0xff, v67.l
	v_lshrrev_b32_e32 v91, 8, v67
	v_lshrrev_b32_e32 v92, 24, v67
	v_and_b16 v67.l, 0xff, v68.l
	v_lshrrev_b32_e32 v93, 8, v68
	v_lshrrev_b32_e32 v94, 24, v68
	v_and_b16 v68.l, 0xff, v69.l
	v_lshrrev_b32_e32 v95, 8, v69
	v_lshrrev_b32_e32 v96, 24, v69
	v_and_b16 v69.l, 0xff, v70.l
	v_lshrrev_b32_e32 v97, 8, v70
	v_lshrrev_b32_e32 v98, 24, v70
	v_and_b16 v70.l, 0xff, v71.l
	v_lshrrev_b32_e32 v99, 8, v71
	v_lshrrev_b32_e32 v100, 24, v71
	v_and_b16 v71.l, 0xff, v72.l
	v_lshrrev_b32_e32 v101, 8, v72
	v_lshrrev_b32_e32 v102, 24, v72
	v_and_b16 v72.l, 0xff, v73.l
	v_lshrrev_b32_e32 v103, 8, v73
	v_lshrrev_b32_e32 v104, 24, v73
	v_and_b16 v73.l, 0xff, v74.l
	v_lshrrev_b32_e32 v105, 8, v74
	v_lshrrev_b32_e32 v106, 24, v74
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v74.l, 8, v75.l
	...
	v_lshlrev_b16 v75.l, 8, v77.l
	v_lshlrev_b16 v75.h, 8, v78.l
	v_lshlrev_b16 v77.l, 8, v81.l
	v_lshlrev_b16 v76.l, 8, v79.l
	v_lshlrev_b16 v76.h, 8, v80.l
	v_lshlrev_b16 v77.h, 8, v82.l
	v_lshlrev_b16 v78.l, 8, v83.l
	v_lshlrev_b16 v78.h, 8, v84.l
	v_lshlrev_b16 v79.l, 8, v85.l
	v_lshlrev_b16 v79.h, 8, v86.l
	v_lshlrev_b16 v80.l, 8, v87.l
	v_lshlrev_b16 v80.h, 8, v88.l
	v_lshlrev_b16 v81.l, 8, v89.l
	v_lshlrev_b16 v81.h, 8, v90.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v82.l, 8, v91.l
	v_lshlrev_b16 v82.h, 8, v92.l
	v_lshlrev_b16 v83.l, 8, v93.l
	v_lshlrev_b16 v83.h, 8, v94.l
	v_lshlrev_b16 v84.l, 8, v95.l
	v_lshlrev_b16 v84.h, 8, v96.l
	v_lshlrev_b16 v85.l, 8, v97.l
	v_lshlrev_b16 v85.h, 8, v98.l
	v_lshlrev_b16 v86.l, 8, v99.l
	v_lshlrev_b16 v86.h, 8, v100.l
	v_lshlrev_b16 v87.l, 8, v101.l
	v_lshlrev_b16 v87.h, 8, v102.l
	v_lshlrev_b16 v88.l, 8, v103.l
	v_lshlrev_b16 v88.h, 8, v104.l
	v_lshlrev_b16 v89.l, 8, v105.l
	v_lshlrev_b16 v89.h, 8, v106.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v142, v58
	ds_store_b16_d16_hi v142, v58 offset:32
	ds_store_b16 v142, v59 offset:64
	ds_store_b16_d16_hi v142, v59 offset:96
	ds_store_b16 v143, v61 offset:64
	ds_store_b16_d16_hi v143, v61 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v142, v66 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v143, v60
	ds_store_b16_d16_hi v143, v60 offset:32
	ds_store_b16 v144, v62
	ds_store_b16_d16_hi v144, v62 offset:32
	ds_store_b16 v144, v63 offset:64
	ds_store_b16_d16_hi v144, v63 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v142, v67 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v142, v64 offset:384
	ds_store_b16_d16_hi v142, v64 offset:416
	ds_store_b16 v142, v65 offset:448
	ds_store_b16_d16_hi v142, v65 offset:480
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v142, v66 offset:16416
	ds_store_b16_d16_hi v142, v67 offset:16480
	ds_store_b16 v143, v68 offset:16384
	ds_store_b16_d16_hi v143, v68 offset:16416
	ds_store_b16 v143, v69 offset:16448
	ds_store_b16_d16_hi v143, v69 offset:16480
	ds_store_b16 v144, v70 offset:16384
	ds_store_b16_d16_hi v144, v70 offset:16416
	ds_store_b16 v144, v71 offset:16448
	ds_store_b16_d16_hi v144, v71 offset:16480
	ds_store_b16 v142, v72 offset:16768
	ds_store_b16_d16_hi v142, v72 offset:16800
	ds_store_b16 v142, v73 offset:16832
	ds_store_b16_d16_hi v142, v73 offset:16864
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v1, v48 :: v_dual_mov_b32 v72, v50
...
.LBB0_8:                                ; %._crit_edge
	...
	ds_load_u8_d16 v52, v2 offset:400
...
; %bb.9:
	...
	v_add_nc_u32_e32 v54, s6, v3
	ds_load_b128 v[96:99], v72 offset:4096
	ds_load_b128 v[100:103], v72
	ds_load_b128 v[88:91], v54 offset:4096
	ds_load_b128 v[92:95], v54
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(26)
	v_perm_b32 v54, v65, v67, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	...
	v_lshl_or_b32 v106, v75, 16, v54
	v_perm_b32 v54, v53, v55, 0xc0c0004
	...
	v_perm_b32 v109, v50, v52, 0xc0c0004
	...
	v_lshl_or_b32 v103, v108, 16, v54
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v23, v23, v72 :: v_dual_add_f32 v40, v40, v73
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v33, v33, v73 :: v_dual_add_f32 v24, v24, v54
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
; %bb.11:
	...
	v_lshl_or_b32 v86, v64, 16, v54
	v_perm_b32 v53, v53, v55, 0xc0c0004
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v84, v47, 16, v53
	v_mov_b32_e32 v62, s6
	v_mov_b32_e32 v60, s4
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v53, v57, v59, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v54, v56, v58, 0xc0c0004
	v_perm_b32 v55, v50, v52, 0xc0c0004
	...
	v_lshl_or_b32 v7, v54, 16, v53
	v_lshl_or_b32 v6, v56, 16, v55
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v95, s11 :: v_dual_add_nc_u32 v8, s34, v2
	v_dual_mov_b32 v94, s10 :: v_dual_add_nc_u32 v7, s34, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 145
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 39
