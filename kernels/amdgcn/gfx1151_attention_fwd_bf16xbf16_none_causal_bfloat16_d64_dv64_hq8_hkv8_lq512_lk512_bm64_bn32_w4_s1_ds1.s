...
.Ltmp0:
	...
	.loc	1 598 26                        ; attention.py:598:26
	v_add3_u32 v2, v5, v3, s3
	s_lshl_b32 s3, s20, 5
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 599 26                        ; attention.py:599:26
	v_add_nc_u32_e32 v88, 0, v22
	v_lshlrev_b32_e32 v5, 1, v2
	v_add_lshl_u32 v6, v2, s5, 1
	v_add_lshl_u32 v7, v2, s3, 1
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v1, s8, v1
	v_lshlrev_b32_e32 v4, 4, v4
	.loc	1 621 25                        ; attention.py:621:25
	s_min_i32 s11, s4, 0x200
	s_clause 0x1
	...
	s_ashr_i32 s1, s0, 31
	v_dual_mov_b32 v27, v24 :: v_dual_add_nc_u32 v90, s9, v0
	s_lshr_b32 s1, s1, 27
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 599 26                        ; attention.py:599:26
	v_xad_u32 v0, 0x70, v5, 0
	.loc	1 622 34                        ; attention.py:622:34
	s_add_i32 s23, s0, s1
	...
	v_dual_mov_b32 v31, v24 :: v_dual_and_b32 v92, 0x5040504, v0
	...
	v_dual_mov_b32 v30, v24 :: v_dual_and_b32 v93, 0x7060706, v3
	v_lshl_add_u32 v97, v11, 1, v4
	v_lshl_add_u32 v98, v0, 1, v4
	v_dual_mov_b32 v16, v24 :: v_dual_add_nc_u32 v99, 0, v5
	v_dual_mov_b32 v17, v24 :: v_dual_add_nc_u32 v100, 0, v6
	v_dual_mov_b32 v18, v24 :: v_dual_add_nc_u32 v101, 0, v7
	v_dual_mov_b32 v19, v24 :: v_dual_add_nc_u32 v102, 0, v8
	v_dual_mov_b32 v20, v24 :: v_dual_add_nc_u32 v103, 0, v9
	v_dual_mov_b32 v21, v24 :: v_dual_add_nc_u32 v104, 0, v10
	v_dual_mov_b32 v22, v24 :: v_dual_add_nc_u32 v105, 0, v12
...
.Ltmp10:
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v73.l, 0x7fff, v72.h, s18
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b16 v75.h, 0x7fff, v75.h, s15
...
.Ltmp12:
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v75.l, 0x7fff, v74.h, s16
.Ltmp13:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
...
.Ltmp16:
	...
	v_cndmask_b16 v77.l, 0x7fff, v76.h, s14
	v_and_b32_e32 v76, 1, v68
	v_add3_u32 v76, v115, v76, 0x7fff
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v77.h, 0x7fff, v76.h, s13
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v79.l, 0x7fff, v78.h, s12
...
.Ltmp20:
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v79.h, 0x7fff, v78.h, s11
	.loc	1 699 23                        ; attention.py:699:23
...
.Ltmp22:
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v65.l, 0x7fff, v64.h, s10
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_cndmask_b16 v65.h, 0x7fff, v64.h, s9
	.loc	1 699 23                        ; attention.py:699:23
...
.Ltmp36:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cndmask_b16 v71.l, 0x7fff, v71.h, s4
	...
	v_cndmask_b16 v69.h, 0x7fff, v70.h, s5
	v_cndmask_b16 v71.h, 0x7fff, v68.h, s6
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_4:                                ; %._crit_edge
	...
	v_div_scale_f32 v48, s4, v27, v85, v27
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v39, s5, v28, v85, v28
	...
	v_div_scale_f32 v43, s4, v30, v85, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v49, s6, v31, v85, v31
	...
	v_div_scale_f32 v44, s4, v17, v85, v17
	v_fma_f32 v36, -v46, v38, v47
	v_div_scale_f32 v46, s5, v18, v85, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v44, s4, v20, v85, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fma_f32 v36, -v43, v37, v46
	v_div_scale_f32 v43, s6, v21, v85, v21
	...
	s_mov_b32 vcc_lo, s6
	v_div_scale_f32 v43, s4, v23, v85, v23
	v_rcp_f32_e32 v44, v41
	...
	v_div_scale_f32 v36, s5, v8, v85, v8
	...
	v_div_scale_f32 v48, s6, v10, v85, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	v_div_scale_f32 v39, s4, v11, v85, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v38, s5, v13, v85, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v36, s4, v15, v85, v15
	v_mul_f32_e32 v42, v38, v45
	v_div_scale_f32 v51, s5, v0, v85, v0
	...
	v_div_scale_f32 v52, s6, v1, v85, v1
	...
	v_div_scale_f32 v51, s5, v6, v85, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v53, s6, v7, v85, v7
	...
	v_div_scale_f32 v48, s4, v5, v85, v5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 123
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 48
