	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8                          ; -- Begin function amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8,@function
amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8:                                 ; @amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 878 25                        ; attention.py:878:25
...
.Ltmp13:
	...
	.loc	1 913 13                        ; attention.py:913:13
...
.Ltmp32:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 899 30                        ; attention.py:899:30
	v_mul_f32_e32 v3, v4, v2
.Ltmp33:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:899:23 ]
	v_mov_b32_dpp v3, v3 row_xmask:4 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp34:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:899:23 ] ]
...
.Ltmp42:
	...
	.loc	1 910 27 is_stmt 0              ; attention.py:910:27
	...
	.loc	1 913 32 is_stmt 1              ; attention.py:913:32
	v_bfe_u32 v1, v0, 16, 1
	v_cmp_o_f32_e32 vcc_lo, v0, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_add3_u32 v0, v0, v1, 0x7fff
	.loc	1 913 13 is_stmt 0              ; attention.py:913:13
	v_add_lshl_u32 v1, s1, v11, 1
	.loc	1 913 32                        ; attention.py:913:32
	...
	.loc	1 868 5 is_stmt 1               ; attention.py:868:5
	s_endpgm
.Ltmp43:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8, .Lfunc_end0-amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.num_vgpr, 20
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.numbered_sgpr, 18
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8
    .private_segment_fixed_size: 0
    .sgpr_count:     20
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_reduce_bfloat16_dv64_ds8.kd
