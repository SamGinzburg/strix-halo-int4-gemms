	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_and_b32_e32 v245, 3, v207
	v_lshlrev_b32_e32 v244, 4, v245
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v246, 4, v207
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_and_b32_e32 v242, 15, v207
	v_lshlrev_b32_e32 v96, 5, v207
...
.LBB0_3:                                ; %Flow94
	...
	v_and_b32_e32 v0, 0xf0, v207
	s_ashr_i32 s0, s14, 6
	v_or_b32_e32 v58, s13, v207
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v92, v19 :: v_dual_lshlrev_b32 v1, 3, v207
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v234, 0 :: v_dual_and_b32 v3, 6, v207
	v_dual_mov_b32 v243, 0 :: v_dual_mov_b32 v160, 0
	v_dual_mov_b32 v218, 0 :: v_dual_mov_b32 v237, 0
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	...
	v_dual_mov_b32 v92, 0 :: v_dual_mov_b32 v241, 0
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	v_dual_mov_b32 v217, 0 :: v_dual_mov_b32 v124, 0
	v_dual_mov_b32 v233, 0 :: v_dual_mov_b32 v126, 0
	...
	v_dual_mov_b32 v253, 0 :: v_dual_mov_b32 v232, 0
	v_dual_mov_b32 v255, 0 :: v_dual_mov_b32 v130, 0
	v_dual_mov_b32 v127, 0 :: v_dual_mov_b32 v228, 0
	v_dual_mov_b32 v227, 0 :: v_dual_mov_b32 v132, 0
	...
	v_dual_mov_b32 v17, 0 :: v_dual_mov_b32 v116, 0
...
; %bb.9:
	...
	v_cvt_f32_i32_e32 v250, v108
	v_cvt_f32_i32_e32 v251, v109
	v_cvt_f32_i32_e32 v185, v118
	...
	v_cvt_f32_i32_e32 v227, v136
	v_cvt_f32_i32_e32 v130, v137
	v_cvt_f32_i32_e32 v228, v138
...
.LBB0_10:
	...
	buffer_load_u16 v18, v6, s[8:11], 0 offen
	...
	v_dual_mov_b32 v153, 0 :: v_dual_mov_b32 v188, 0
	...
	v_dual_mov_b32 v213, 0 :: v_dual_mov_b32 v156, 0
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_store_b32 v155, v1 offset:40960
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.11:
	...
	v_dual_mov_b32 v152, v124 :: v_dual_add_nc_u32 v19, s45, v20
	.loc	1 406 22 is_stmt 1              ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v20, s45, v230
	v_dual_mov_b32 v124, v248 :: v_dual_add_nc_u32 v99, s1, v229
	v_dual_mov_b32 v216, v244 :: v_dual_add_nc_u32 v165, s45, v22
	v_dual_mov_b32 v151, v135 :: v_dual_add_nc_u32 v166, s45, v21
	...
	v_dual_mov_b32 v123, v247 :: v_dual_mov_b32 v154, v250
	v_dual_mov_b32 v153, v125 :: v_dual_mov_b32 v128, v167
	v_mov_b32_e32 v125, v249
	ds_load_b128 v[247:250], v19
	v_mov_b32_e32 v131, v117
	v_dual_mov_b32 v129, v116 :: v_dual_mov_b32 v156, v141
	v_mov_b32_e32 v119, v95
	v_dual_mov_b32 v117, v143 :: v_dual_add_nc_u32 v184, s1, v101
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v143, v127 :: v_dual_mov_b32 v226, s19
	v_dual_mov_b32 v127, v251 :: v_dual_mov_b32 v224, s17
	v_dual_mov_b32 v141, v253 :: v_dual_mov_b32 v222, s15
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v220, s13 :: v_dual_add_nc_u32 v111, s1, v100
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[208:211], v99 offset:1024
	ds_load_b128 v[95:98], v99 offset:3072
	s_clause 0xc                            ; 52-byte Folded Spill
	scratch_store_b32 off, v228, off offset:68
	scratch_store_b32 off, v227, off offset:48
	scratch_store_b32 off, v185, off offset:64
	scratch_store_b32 off, v233, off offset:44
	scratch_store_b32 off, v168, off offset:52
	scratch_store_b32 off, v169, off offset:60
	scratch_store_b32 off, v231, off offset:28
	scratch_store_b32 off, v0, off offset:40
	scratch_store_b32 off, v237, off offset:56
	scratch_store_b32 off, v232, off offset:20
	scratch_store_b32 off, v234, off offset:24
	...
	v_dual_mov_b32 v59, v58 :: v_dual_mov_b32 v148, v132
	v_mov_b32_e32 v58, v56
	v_dual_mov_b32 v56, v55 :: v_dual_mov_b32 v55, v54
	v_mov_b32_e32 v132, v120
	s_waitcnt vmcnt(1)
	v_mov_b16_e32 v54.l, v110.l
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_mov_b16_e64 v159.l, v139.l
	v_dual_mov_b32 v139, v118 :: v_dual_mov_b32 v118, v17
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(9)
	...
	v_dual_mov_b32 v17, v207 :: v_dual_mov_b32 v150, v134
	v_dual_mov_b32 v207, v112 :: v_dual_mov_b32 v120, v239
	...
	scratch_store_b32 off, v242, off offset:16 ; 4-byte Folded Spill
	v_dual_mov_b32 v149, v133 :: v_dual_mov_b32 v134, v122
	v_mov_b32_e32 v133, v121
	v_dual_mov_b32 v121, v240 :: v_dual_mov_b32 v122, v241
	...
	v_dual_mov_b32 v113, v92 :: v_dual_mov_b32 v114, v185
	...
	v_dual_mov_b32 v125, v153 :: v_dual_mov_b32 v254, v142
	...
	scratch_load_b32 v231, off, off offset:28
	scratch_load_b32 v169, off, off offset:60
	scratch_load_b32 v168, off, off offset:52
	...
	scratch_load_b32 v234, off, off offset:24
	scratch_load_b32 v232, off, off offset:20
	scratch_load_b32 v246, off, off offset:12
	scratch_load_b32 v245, off, off offset:8
	v_mov_b32_e32 v250, v154
	v_cvt_f32_i32_e32 v186, v176
	...
	scratch_load_b32 v228, off, off offset:68
	scratch_load_b32 v185, off, off offset:64
	...
	v_dual_mov_b32 v112, v207 :: v_dual_mov_b32 v207, v17
	v_mov_b32_e32 v244, v216
	v_mov_b32_e32 v248, v124
	v_dual_mov_b32 v124, v152 :: v_dual_mov_b32 v247, v123
	v_dual_mov_b32 v142, v116 :: v_dual_mov_b32 v123, v135
	v_dual_mov_b32 v252, v140 :: v_dual_mov_b32 v135, v151
	v_mov_b32_e32 v116, v129
	v_dual_mov_b32 v253, v141 :: v_dual_mov_b32 v140, v167
...
.Ltmp23:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v56, v56, v147, v84
	v_fma_f32 v96, v96, v144, v89
	v_fma_f32 v97, v97, v118, v88
	v_fma_f32 v98, v98, v117, v87
	v_fma_f32 v99, v99, v116, v86
	v_fma_f32 v100, v100, v167, v85
	v_fma_f32 v101, v101, v95, v83
	...
	v_fma_f32 v76, v112, v169, v72
	v_fma_f32 v77, v113, v138, v71
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v77, v9, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v106, v150, v227, v62
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v79, v10, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v148, v228, v64
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v62, v113, v168, v50
	v_fma_f32 v63, v114, v126, v49
	v_fma_f32 v64, v127, v125, v48
	v_fma_f32 v65, v128, v124, v47
	v_fma_f32 v66, v129, v123, v46
	v_fma_f32 v67, v130, v122, v45
	v_fma_f32 v70, v133, v233, v42
	v_fma_f32 v17, v134, v217, v41
	...
	v_fma_f32 v42, v6, v0, v28
	v_fma_f32 v45, v5, v238, v27
	v_fma_f32 v46, v4, v237, v26
	v_fma_f32 v49, v3, v218, v25
	v_fma_f32 v50, v2, v160, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v93 offset:40960
	ds_load_b128 v[5:8], v93 offset:40976
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v69, v132, v120, v43
	v_fma_f32 v71, v136, v185, v39
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(1)
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v68, v131, v121, v44
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v43, v43, v69, s3
	v_cndmask_b32_e64 v61, v61, v107, s3
	v_cndmask_b32_e64 v107, v60, v108, s3
	v_cndmask_b32_e64 v39, v39, v71, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v80, v11, v21
	v_mul_f32_e32 v81, v12, v21
	v_mul_f32_e32 v93, v14, v21
	v_mul_f32_e32 v108, v15, v21
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v69, v1, v21
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v55, v8, v19 :: v_dual_mul_f32 v70, v2, v21
	v_mul_f32_e32 v71, v3, v21
	v_mul_f32_e32 v72, v4, v21
	v_mul_f32_e32 v73, v5, v21
	v_mul_f32_e32 v74, v6, v21
	v_mul_f32_e32 v75, v7, v21
	v_mul_f32_e32 v76, v8, v21
	v_mul_f32_e32 v21, v16, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v60, v112, v252, v51
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v116, v8, v22
	...
	v_mul_f32_e32 v109, v1, v22
	v_mul_f32_e32 v110, v2, v22
	v_mul_f32_e32 v111, v3, v22
	v_mul_f32_e32 v112, v4, v22
	v_mul_f32_e32 v113, v5, v22
	v_mul_f32_e32 v114, v6, v22
	v_mul_f32_e32 v115, v7, v22
	v_mul_f32_e32 v117, v9, v22
	v_mul_f32_e32 v118, v10, v22
	v_mul_f32_e32 v119, v11, v22
	v_mul_f32_e32 v120, v12, v22
	v_mul_f32_e32 v121, v13, v22
	v_mul_f32_e32 v122, v14, v22
	v_mul_f32_e32 v123, v15, v22
...
.Ltmp25:
	...
	v_fma_f32 v50, v55, v159, v30
	v_fma_f32 v55, v57, v186, v31
	...
	v_fma_f32 v67, v68, v175, v37
	v_fma_f32 v68, v69, v177, v39
	v_fma_f32 v69, v70, v178, v18
	v_fma_f32 v128, v80, v188, v58
	v_fma_f32 v129, v81, v189, v56
	...
	v_fma_f32 v95, v71, v179, v17
	v_fma_f32 v72, v72, v180, v65
	v_fma_f32 v73, v73, v181, v43
	v_fma_f32 v124, v75, v183, v64
	v_fma_f32 v125, v76, v184, v59
	v_fma_f32 v127, v79, v187, v48
	v_fma_f32 v92, v92, v190, v51
	v_fma_f32 v93, v93, v191, v52
	v_fma_f32 v109, v109, v194, v107
	v_fma_f32 v110, v110, v195, v61
	v_fma_f32 v3, v3, v213, v78
	v_fma_f32 v4, v4, v214, v98
	v_fma_f32 v5, v5, v215, v97
	v_fma_f32 v6, v6, v216, v96
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v70, v39, v68, s2
	v_cndmask_b32_e64 v71, v18, v69, s2
...
.Ltmp27:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v74, v74, v182, v44
	v_fma_f32 v126, v77, v153, v47
	v_fma_f32 v108, v108, v192, v53
	v_fma_f32 v112, v112, v197, v105
	v_fma_f32 v113, v113, v198, v104
	v_fma_f32 v114, v114, v199, v103
	v_fma_f32 v118, v118, v203, v143
	v_fma_f32 v119, v119, v204, v142
	v_fma_f32 v120, v120, v205, v141
	v_fma_f32 v121, v121, v206, v140
	v_fma_f32 v122, v122, v208, v139
	v_fma_f32 v123, v123, v209, v138
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v41, v25, v41, s2
	v_cndmask_b32_e64 v49, v29, v49, s2
	v_cndmask_b32_e64 v67, v20, v19, s2
	v_cndmask_b32_e64 v76, v65, v72, s2
	v_cndmask_b32_e64 v77, v43, v73, s2
	v_cndmask_b32_e64 v72, v64, v124, s2
	v_cndmask_b32_e64 v73, v59, v125, s2
	v_cndmask_b32_e64 v64, v58, v128, s2
	v_cndmask_b32_e64 v58, v51, v92, s2
	v_cndmask_b32_e64 v59, v52, v93, s2
	v_cndmask_b32_e64 v51, v107, v109, s2
	v_cndmask_b32_e64 v52, v61, v110, s2
...
.Ltmp29:
	...
	v_fma_f32 v111, v111, v196, v106
	v_fma_f32 v115, v115, v200, v102
	v_fma_f32 v116, v116, v201, v101
	v_fma_f32 v117, v117, v202, v144
	v_fma_f32 v22, v22, v210, v137
	v_fma_f32 v10, v10, v220, v86
	v_fma_f32 v13, v13, v223, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v55, v31, v55, s2
	v_cndmask_b32_e64 v74, v44, v74, s2
	v_cndmask_b32_e64 v69, v48, v127, s2
	v_cndmask_b32_e64 v65, v56, v129, s2
	v_cndmask_b32_e64 v56, v53, v108, s2
	v_cndmask_b32_e64 v48, v105, v112, s2
	v_cndmask_b32_e64 v43, v104, v113, s2
	v_cndmask_b32_e64 v44, v103, v114, s2
	v_cndmask_b32_e64 v37, v143, v118, s2
	v_cndmask_b32_e64 v35, v142, v119, s2
	v_cndmask_b32_e64 v36, v141, v120, s2
	v_cndmask_b32_e64 v34, v140, v121, s2
	v_cndmask_b32_e64 v33, v139, v122, s2
	v_cndmask_b32_e64 v31, v138, v123, s2
.Ltmp30:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp31:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v7, v156, v82
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v75, v17, v95, s2
	v_cndmask_b32_e64 v68, v47, v126, s2
	v_cndmask_b32_e64 v53, v94, v21, s2
	v_cndmask_b32_e64 v47, v106, v111, s2
	v_cndmask_b32_e64 v39, v102, v115, s2
	v_cndmask_b32_e64 v40, v101, v116, s2
	v_cndmask_b32_e64 v38, v144, v117, s2
...
.Ltmp45:
	...
	v_and_b32_e32 v7, 0x60, v207
	v_and_b32_e32 v5, 0x80, v207
	v_and_b32_e32 v8, 8, v207
	v_lshl_add_u32 v3, v2, 2, v3
	v_and_or_b32 v21, 0x680, v246, v4
.Ltmp46:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp54:
	...
	v_dual_max_f32 v17, v19, v19 :: v_dual_max_f32 v18, v21, v21
...
.Ltmp64:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v17, v21, v21 :: v_dual_max_f32 v18, v22, v22
.Ltmp65:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp66:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v17, v1, v17 :: v_dual_max_f32 v18, v3, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp70:
	...
	v_dual_fmac_f32 v5, v8, v5 :: v_dual_mul_f32 v2, v3, v22
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v83, v1, v5 :: v_dual_and_b32 v82, 0xffff0000, v3
	...
	v_dual_mul_f32 v54, v84, v22 :: v_dual_and_b32 v61, 0xffff0000, v1
	.loc	1 76 13                         ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
	...
	v_div_scale_f32 v20, s2, v55, v82, v55
	...
	v_fmac_f32_e32 v89, v18, v54
	v_fma_f32 v91, -v86, v92, 1.0
	v_dual_mul_f32 v18, v20, v81 :: v_dual_and_b32 v17, 0xffff0000, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_dual_mul_f32 v87, v91, v92 :: v_dual_fmac_f32 v18, v84, v81
	...
	v_fma_f32 v18, -v90, v89, v84
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v89, v18, v81 :: v_dual_mul_f32 v18, v20, v80
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_dual_fmac_f32 v85, v84, v92 :: v_dual_mul_f32 v20, v89, v83
	...
	s_mov_b32 vcc_lo, s1
	v_dual_mul_f32 v90, v83, v80 :: v_dual_mul_f32 v85, v86, v81
	...
	v_dual_fmac_f32 v84, v19, v79 :: v_dual_mul_f32 v89, v82, v80
	v_mul_f32_e32 v19, v85, v78
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	v_dual_mul_f32 v92, v89, v78 :: v_dual_fmac_f32 v85, v82, v85
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v81, v61, v85 :: v_dual_fmac_f32 v88, v90, v88
...
.Ltmp74:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 76
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 76
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
