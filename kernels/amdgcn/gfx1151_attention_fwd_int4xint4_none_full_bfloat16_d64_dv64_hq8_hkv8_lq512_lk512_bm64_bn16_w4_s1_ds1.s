...
.Ltmp0:
	...
	ds_bpermute_b32 v51, v66, v44
	ds_bpermute_b32 v67, v53, v44
	ds_bpermute_b32 v70, v66, v45
	...
	v_dual_mov_b32 v22, v24 :: v_dual_and_b32 v49, 0x540054, v43
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt lgkmcnt(6)
	v_cndmask_b32_e64 v42, v69, v55, s0
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v50, v49, 4, v49
	v_mov_b32_e32 v15, v24
	s_waitcnt lgkmcnt(4)
	v_cndmask_b32_e64 v43, v47, v46, s0
	.loc	1 779 31                        ; attention.py:779:31
	s_waitcnt vmcnt(0)
	...
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v44, v55, v69, s0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v11, v24 :: v_dual_mul_f32 v66, s8, v45
	v_and_b32_e32 v48, 0x760076, v48
	v_cndmask_b32_e64 v45, v46, v47, s0
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v46, v67, v51, s0
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v47, v53, v70, s0
	v_cndmask_b32_e64 v49, v70, v53, s0
	v_lshl_or_b32 v55, v48, 4, v48
	v_mov_b32_e32 v8, v24
	v_cndmask_b32_e64 v48, v51, v67, s0
	v_and_b32_e32 v50, 0x5040504, v50
	v_mov_b16_e32 v53.l, 0
	v_and_b32_e32 v51, 0x7060706, v55
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x2
	buffer_load_u16 v90, v56, s[24:27], 0 offen
	buffer_load_u16 v91, v56, s[24:27], 0 offen offset:4
	buffer_load_u16 v92, v56, s[24:27], 0 offen offset:8
	...
	v_cndmask_b32_e64 v55, 0x80000000, v40, s1
	.loc	1 923 37                        ; attention.py:923:37
	s_clause 0x4
	buffer_load_u16 v79, v56, s[24:27], 0 offen offset:12
	buffer_load_u16 v80, v56, s[24:27], 0 offen offset:16
	buffer_load_u16 v81, v56, s[24:27], 0 offen offset:20
	buffer_load_u16 v82, v56, s[24:27], 0 offen offset:24
	buffer_load_u16 v83, v56, s[24:27], 0 offen offset:28
	.loc	1 1000 41                       ; attention.py:1000:41
	buffer_load_b64 v[69:70], v85, s[28:31], 0 offen
	.loc	1 978 32                        ; attention.py:978:32
	buffer_load_b32 v84, v55, s[12:15], 0 offen
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 932 25                        ; attention.py:932:25
	v_mul_f32_e32 v69, v55, v78
	v_mul_f32_e32 v77, v77, v85
	v_mul_f32_e32 v71, v71, v90
	v_dual_mul_f32 v73, v73, v80 :: v_dual_mul_f32 v74, v74, v81
	v_dual_mul_f32 v72, v72, v79 :: v_dual_mul_f32 v75, v75, v82
	v_mul_f32_e32 v76, v76, v83
	.loc	1 986 76                        ; attention.py:986:76
	s_waitcnt vmcnt(0)
	v_and_b16 v55.h, v84.l, 15
...
.Ltmp6:
	...
	.loc	1 989 29                        ; attention.py:989:29
	v_or_b16 v84.l, v55.h, v69.h
	.loc	1 990 56                        ; attention.py:990:56
	v_or_b16 v55.h, v55.l, -16
	.loc	1 978 32                        ; attention.py:978:32
	...
	v_cndmask_b16 v82.l, v55.l, v55.h, s3
	.loc	1 990 56 is_stmt 0              ; attention.py:990:56
	v_or_b16 v55.l, v69.h, -16
	...
	.loc	1 990 30 is_stmt 1              ; attention.py:990:30
	v_cndmask_b16 v83.l, v69.h, v55.l, s5
	.loc	1 989 29                        ; attention.py:989:29
	v_cndmask_b16 v55.l, 0, -16, s3
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_cvt_f32_i32_e32 v71, v71
	.loc	1 989 29 is_stmt 1              ; attention.py:989:29
	v_or_b16 v70.l, v70.l, v55.l
	.loc	1 990 56                        ; attention.py:990:56
	v_or_b16 v55.l, v69.l, -16
	.loc	1 1017 31                       ; attention.py:1017:31
	...
	.loc	1 990 30                        ; attention.py:990:30
	v_cndmask_b16 v55.l, v69.l, v55.l, s6
.Ltmp7:
...
.Ltmp8:
	...
	v_dual_mul_f32 v86, v92, v86 :: v_dual_sub_f32 v79, v79, v69
	...
	v_cndmask_b16 v55.l, 0x7fff, v78.h, s6
	.loc	1 971 33 is_stmt 1              ; attention.py:971:33
	...
	v_cndmask_b32_e64 v92, 0, v73, s2
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cndmask_b16 v73.l, 0x7fff, v55.h, s4
	v_cndmask_b16 v55.h, 0x7fff, v70.h, s7
.Ltmp9:
...
.Ltmp12:
	...
	v_mov_b16_e32 v83.h, v53.l
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cndmask_b16 v73.h, 0x7fff, v81.h, s5
	.loc	1 1019 30                       ; attention.py:1019:30
	v_mov_b16_e32 v83.l, v78.h
	v_and_b32_e32 v71, 1, v71
.Ltmp13:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v81, v70, v74 :: v_dual_and_b32 v74, 1, v88
.Ltmp14:
	...
	.loc	1 971 62                        ; attention.py:971:62
	v_sub_f32_e32 v75, v75, v69
	v_sub_f32_e32 v76, v76, v69
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v93, 0, v76, s2
	v_cndmask_b32_e64 v94, 0, v75, s2
	.loc	1 1018 23                       ; attention.py:1018:23
	v_mul_f32_e32 v27, v27, v91
.Ltmp15:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v75, v92, v80 :: v_dual_and_b32 v76, 1, v83
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
.Ltmp16:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_mov_b16_e32 v90.l, v93.h
.Ltmp17:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_add_f32_e32 v70, v94, v93
.Ltmp18:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_mov_b16_e32 v86.l, v94.h
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v31, v31, v91 :: v_dual_and_b32 v82, 1, v82
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v17, v17, v91 :: v_dual_and_b32 v88, 1, v90
	v_dual_mul_f32 v19, v19, v91 :: v_dual_and_b32 v86, 1, v86
	v_dual_mul_f32 v20, v20, v91 :: v_dual_and_b32 v83, 1, v84
	v_dual_mul_f32 v8, v8, v91 :: v_dual_add_f32 v85, v75, v70
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cmp_o_f32_e64 s3, v77, v77
	v_cmp_o_f32_e64 s4, v78, v78
	v_and_b32_e32 v84, 1, v89
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v59, v87, v73 offset1:8
	ds_store_2addr_b32 v59, v55, v68 offset0:16 offset1:24
	.loc	1 1019 30                       ; attention.py:1019:30
	v_add3_u32 v55, v78, v76, 0x7fff
	v_add3_u32 v68, v77, v74, 0x7fff
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v10, v10, v91 :: v_dual_add_f32 v81, v81, v85
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	v_add3_u32 v78, v72, v71, 0x7fff
	v_add3_u32 v79, v79, v83, 0x7fff
	v_add3_u32 v82, v92, v82, 0x7fff
	v_add3_u32 v80, v80, v84, 0x7fff
	v_add3_u32 v83, v94, v86, 0x7fff
	v_add3_u32 v84, v93, v88, 0x7fff
	v_cndmask_b16 v68.h, 0x7fff, v68.h, s3
	v_cndmask_b16 v68.l, 0x7fff, v55.h, s4
	v_cndmask_b16 v85.h, 0x7fff, v79.h, s5
	v_cndmask_b16 v85.l, 0x7fff, v78.h, s6
	v_cndmask_b16 v86.h, 0x7fff, v80.h, s7
	v_cndmask_b16 v86.l, 0x7fff, v82.h, s8
.Ltmp19:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_permlanex16_b32 v55, v81, s34, 0xfedcba98 op_sel:[1,0]
.Ltmp20:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v87.h, 0x7fff, v84.h, s9
	v_cndmask_b16 v87.l, 0x7fff, v83.h, s10
	v_permlanex16_b32 v79, v68, s34, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v83, v86, s34, 0xfedcba98 op_sel:[1,0]
.Ltmp21:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
...
.Ltmp22:
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v88, v87, s34, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v78, v79, v68, v50
	v_perm_b32 v79, v79, v68, v51
	v_permlanex16_b32 v68, v85, s34, 0xfedcba98 op_sel:[1,0]
	.loc	1 1018 23                       ; attention.py:1018:23
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_perm_b32 v80, v68, v85, v50
	v_perm_b32 v81, v68, v85, v51
	v_perm_b32 v82, v83, v86, v50
	v_perm_b32 v83, v83, v86, v51
	v_perm_b32 v84, v88, v87, v50
	v_perm_b32 v85, v88, v87, v51
	.loc	1 1020 23                       ; attention.py:1020:23
	v_fmac_f32_e32 v55, v67, v91
	.loc	1 1017 30                       ; attention.py:1017:30
...
; %bb.2:
	...
	v_div_scale_f32 v41, null, v55, v55, v27
	v_div_scale_f32 v42, s1, v25, v55, v25
	v_div_scale_f32 v45, s3, v26, v55, v26
	...
	s_mov_b32 vcc_lo, s4
	v_div_scale_f32 v38, s3, v29, v55, v29
	...
	v_div_scale_f32 v35, s5, v31, v55, v31
	v_mul_f32_e32 v41, v38, v48
	v_div_scale_f32 v37, s4, v30, v55, v30
	v_div_fmas_f32 v32, v32, v42, v33
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v42, v35, v45
	v_fma_f32 v34, -v40, v41, v38
	v_div_scale_f32 v39, null, v55, v55, v16
	v_div_scale_f32 v46, null, v55, v55, v17
	...
	v_div_scale_f32 v31, s4, v18, v55, v18
	v_fma_f32 v33, -v39, v35, v33
	v_div_scale_f32 v39, null, v55, v55, v20
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v38, null, v55, v55, v22
	...
	v_div_scale_f32 v48, s5, v21, v55, v21
	v_fma_f32 v37, -v44, v43, v40
	s_mov_b32 vcc_lo, s1
	v_div_scale_f32 v41, s1, v22, v55, v22
	...
	v_div_scale_f32 v40, null, v55, v55, v23
	...
	v_div_fixup_f32 v18, v35, v55, v20
	v_fma_f32 v20, -v46, v33, v48
	v_div_scale_f32 v35, null, v55, v55, v8
	s_mov_b32 vcc_lo, s5
	v_div_fixup_f32 v19, v34, v55, v19
	...
	v_div_scale_f32 v34, s3, v23, v55, v23
	v_fmac_f32_e32 v37, v42, v37
	v_div_scale_f32 v42, null, v55, v55, v9
	v_div_fixup_f32 v21, v20, v55, v21
	...
	v_div_scale_f32 v42, s4, v13, v55, v13
	...
	v_div_scale_f32 v41, s3, v12, v55, v12
	...
	v_div_scale_f32 v39, null, v55, v55, v0
	v_fmac_f32_e32 v44, v38, v44
	v_rcp_f32_e32 v37, v45
	v_div_scale_f32 v38, s1, v14, v55, v14
	...
	v_div_scale_f32 v41, s3, v15, v55, v15
	...
	v_div_scale_f32 v34, s4, v0, v55, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v40, v33, v40
	v_div_scale_f32 v33, s5, v1, v55, v1
	...
	v_div_scale_f32 v36, s1, v2, v55, v2
	s_mov_b32 vcc_lo, s3
	...
	v_div_scale_f32 v45, s4, v5, v55, v5
	...
	v_div_scale_f32 v22, s3, v3, v55, v3
	...
	v_div_scale_f32 v34, s1, v4, v55, v4
	...
	.loc	1 1044 48 is_stmt 0             ; attention.py:1044:48
	v_div_fmas_f32 v33, v33, v42, v56
	s_mov_b32 vcc_lo, s6
	.loc	1 1049 36 is_stmt 1             ; attention.py:1049:36
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 95
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 37
