...
.Ltmp13:
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v49, v2, s[16:19], 0 offen
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x3
	...
	buffer_load_b128 v[45:48], v42, s[20:23], 0 offen
...
.LBB0_11:
	...
	v_cndmask_b32_e64 v32, v18, v35, s2
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b32_e64 v25, v25, v8, s2
	v_cndmask_b32_e64 v20, v20, v33, s2
	v_cndmask_b32_e64 v19, v19, v34, s2
	v_cndmask_b32_e64 v33, v17, v36, s2
	v_cndmask_b32_e64 v34, v16, v37, s2
	v_cndmask_b32_e64 v36, v15, v38, s2
	.loc	1 380 16                        ; generate_amdgcn.py:380:16
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v4, v29, v4 :: v_dual_mul_f32 v9, v24, v9
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 380 16                        ; generate_amdgcn.py:380:16
	...
	.loc	1 380 16                        ; generate_amdgcn.py:380:16
	v_dual_mul_f32 v16, v16, v30 :: v_dual_mul_f32 v7, v26, v7
	v_mul_f32_e32 v11, v11, v30
	v_mul_f32_e32 v15, v15, v30
	v_mul_f32_e32 v17, v17, v30
	v_dual_mul_f32 v18, v18, v30 :: v_dual_mul_f32 v13, v20, v13
	.loc	1 380 9                         ; generate_amdgcn.py:380:9
	v_mul_f32_e32 v16, v33, v16
	v_dual_mul_f32 v6, v27, v6 :: v_dual_mul_f32 v11, v22, v11
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v14, v19, v14 :: v_dual_mul_f32 v17, v34, v17
	v_dual_mul_f32 v10, v23, v10 :: v_dual_mul_f32 v15, v32, v15
	v_mul_f32_e32 v18, v36, v18
	.loc	1 392 9 is_stmt 1               ; generate_amdgcn.py:392:9
	ds_store_2addr_stride64_b32 v31, v3, v11 offset1:2
