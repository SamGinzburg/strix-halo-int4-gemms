...
.Ltmp0:
	...
	v_mov_b32_e32 v7, v8
	v_dual_mov_b32 v6, v8 :: v_dual_and_b32 v1, 16, v34
	...
	v_dual_mov_b32 v5, v8 :: v_dual_lshlrev_b32 v42, 1, v0
	.loc	1 805 17                        ; attention.py:805:17
	s_add_i32 s4, s4, 32
	.loc	1 802 39                        ; attention.py:802:39
	s_add_i32 s5, s5, s14
	...
	v_or_b32_e32 v54, 26, v61
	v_or_b32_e32 v53, 28, v61
	v_or_b32_e32 v52, 30, v61
	.loc	1 776 23                        ; attention.py:776:23
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v25, 0 :: v_dual_and_b32 v2, 56, v0
	v_and_b32_e32 v3, 0x3f0, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v72, 0x5410 :: v_dual_lshlrev_b32 v1, 1, v1
	v_dual_mov_b32 v27, v25 :: v_dual_and_b32 v4, 24, v0
	v_dual_mov_b32 v75, 0x7632 :: v_dual_and_b32 v74, 7, v0
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 779 31                        ; attention.py:779:31
	v_cndmask_b32_e64 v1, 0x80000000, v1, s2
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v5, 24, v42
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v6, 48, v34
	v_mov_b32_e32 v28, v25
	v_xor_b32_e32 v70, v3, v4
	v_dual_mov_b32 v32, v25 :: v_dual_lshlrev_b32 v7, 3, v0
	s_waitcnt lgkmcnt(0)
	s_and_b32 s49, s9, 0xffff
	s_mov_b32 s48, s8
	s_load_b32 s8, s[0:1], 0x68
	buffer_load_u16 v82, v1, s[48:51], 0 offen
	v_dual_mov_b32 v94, 0xff800000 :: v_dual_and_b32 v1, 16, v0
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s0, s3, 31
	v_dual_mov_b32 v17, v25 :: v_dual_lshlrev_b32 v34, 3, v74
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s0, s3, s0
	v_lshl_or_b32 v71, v33, 5, v5
	v_xor_b32_e32 v33, v6, v2
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v44, v35, v38, s1
	v_cndmask_b32_e64 v48, v38, v35, s1
	v_xor_b32_e32 v35, 8, v70
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v73, s14, v43
	...
	v_dual_mov_b32 v18, v25 :: v_dual_and_b32 v77, 48, v7
	.loc	1 821 32                        ; attention.py:821:32
	s_and_b32 s9, s0, 0xffffc000
	.loc	1 892 65                        ; attention.py:892:65
	v_cmp_gt_i32_e64 s0, s61, v34
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v47, v47, v39, s1
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[50:51], null, s61, v50, v[34:35]
	v_cndmask_b32_e64 v34, 0x1054, v72, s1
	v_cndmask_b32_e64 v39, 0x3276, v75, s1
	v_lshl_or_b32 v72, v74, 9, v33
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v69, s12, v73
	.loc	1 758 19                        ; attention.py:758:19
	s_bfe_u32 s12, s3, 0x10007
	v_dual_mov_b32 v19, v25 :: v_dual_and_b32 v78, 0x210, v8
	s_add_i32 s3, s3, s12
	.loc	1 774 26                        ; attention.py:774:26
	...
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v76, s13, v73
	.loc	1 821 32                        ; attention.py:821:32
	s_lshl_b32 s1, s1, 10
	...
	v_xor_b32_e32 v37, 16, v71
	v_xor_b32_e32 v38, 24, v71
	v_xor_b32_e32 v74, v33, v78
	...
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v75, 0, v35
	v_mov_b32_e32 v21, v25
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v77, 0, v37
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v78, 0, v38
	v_min_i32_e32 v73, v73, v76
	v_xor_b32_e32 v51, 0x120, v72
	v_xor_b32_e32 v81, 0x1b0, v72
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s46, s65
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v33, s36 :: v_dual_add_nc_u32 v96, 0, v70
	.loc	1 822 32                        ; attention.py:822:32
	v_mad_u64_u32 v[112:113], null, s1, s60, v[41:42]
	v_mad_u64_u32 v[113:114], null, s1, s61, v[50:51]
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v34, s37 :: v_dual_add_nc_u32 v97, 0, v71
	...
	v_or_b32_e32 v95, s65, v61
	v_or_b32_e32 v98, s65, v67
	v_or_b32_e32 v100, s65, v65
	v_or_b32_e32 v99, s65, v66
	v_or_b32_e32 v101, s65, v64
	v_or_b32_e32 v102, s65, v63
	v_or_b32_e32 v103, s65, v62
	v_or_b32_e32 v104, s65, v60
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v95, v95, s46, 1
	v_add_lshl_u32 v98, v98, s46, 1
	v_add_lshl_u32 v100, v100, s46, 1
	v_add_lshl_u32 v99, v99, s46, 1
	v_add_lshl_u32 v101, v101, s46, 1
	v_add_lshl_u32 v102, v102, s46, 1
	v_add_lshl_u32 v103, v103, s46, 1
	v_add_lshl_u32 v104, v104, s46, 1
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s46, v52
	v_or_b32_e32 v105, s65, v59
	v_or_b32_e32 v106, s65, v58
	v_or_b32_e32 v107, s65, v57
	v_or_b32_e32 v108, s65, v56
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s1, v111, v69
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s3, v73, v111
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v111, s46, v55
	v_or_b32_e32 v109, s65, v55
	v_or_b32_e32 v110, s65, v54
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v105, v105, s46, 1
	v_add_lshl_u32 v106, v106, s46, 1
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s8, v111, v69
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s9, v73, v111
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v111, s46, v58
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v107, v107, s46, 1
	v_add_lshl_u32 v108, v108, s46, 1
	v_add_lshl_u32 v109, v109, s46, 1
	v_add_lshl_u32 v110, v110, s46, 1
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v111, v69
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s15, v73, v111
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v111, s46, v62
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s21, v73, v111
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v111, s46, v65
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s1, s2, s1
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s27, v73, v111
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v111, s46, v61
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s33, v111, v69
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s34, v73, v111
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s5, v73, v33
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v33, s46, v56
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s11, v73, v33
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v33, s46, v59
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s17, v73, v33
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v33, s46, v63
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s23, v73, v33
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v33, s46, v66
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s4, s2, s4
	s_and_b32 s14, s34, s33
	s_and_b32 s8, s2, s8
	s_and_b32 s9, s23, s22
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v33, v69
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s29, v73, v33
	...
	v_dual_mul_f32 v38, v86, v38 :: v_dual_mul_f32 v123, v92, v123
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s7, v73, v114
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v114, s46, v57
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s13, v73, v114
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v114, s46, v60
	.loc	1 838 37                        ; attention.py:838:37
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s19, v73, v114
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v114, s46, v64
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s12, s29, s28
	.loc	1 890 30                        ; attention.py:890:30
	s_barrier
	.loc	1 867 21                        ; attention.py:867:21
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s25, v73, v114
	.loc	1 819 31 is_stmt 1              ; attention.py:819:31
	v_or_b32_e32 v114, s46, v67
	.loc	1 890 30                        ; attention.py:890:30
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s31, v73, v114
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_mov_b16_e32 v114.h, v33.h
	.loc	1 890 30                        ; attention.py:890:30
	ds_store_2addr_b64 v79, v[96:97], v[128:129] offset1:8
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s10, s25, s24
	s_and_b32 s11, s27, s26
	s_and_b32 s13, s31, s30
	s_and_b32 s6, s2, s6
	s_and_b32 s13, s2, s13
	s_and_b32 s7, s2, s7
	s_and_b32 s10, s2, s10
	s_and_b32 s11, s2, s11
	s_and_b32 s16, s19, s18
	.loc	1 896 30                        ; attention.py:896:30
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.num_vgpr, 146
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.numbered_sgpr, 66
