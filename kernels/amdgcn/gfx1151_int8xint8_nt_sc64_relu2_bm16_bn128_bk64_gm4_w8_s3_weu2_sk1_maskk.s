	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v11, s30, v37
	v_or_b32_e32 v12, s30, v9
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v21, s30, v39
	...
	buffer_load_b128 v[17:20], v8, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v46, s33, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v44, s40, v30
	v_add_nc_u32_e32 v45, s40, v31
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v47, s33, v36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_add_nc_u32_e32 v48, s33, v33
	v_add_nc_u32_e32 v49, s33, v35
	...
	s_waitcnt vmcnt(2)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v65, v58, v65 :: v_dual_lshlrev_b32 v66, 16, v99
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v19, v65, v48
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v64, v58, v64 :: v_dual_lshlrev_b32 v61, 16, v94
	v_mul_f32_e32 v59, v58, v59
	v_mul_f32_e32 v60, v58, v60
	v_mul_f32_e32 v62, v58, v62
	v_mul_f32_e32 v63, v58, v63
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v18, v64, v47 :: v_dual_mul_f32 v61, v58, v61
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v58, v58, v66
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v17, v63, v46 :: v_dual_add_nc_u32 v100, s41, v40
	v_dual_fmac_f32 v14, v61, v44 :: v_dual_add_nc_u32 v101, s34, v41
	v_fmac_f32_e32 v11, v59, v42
	v_fmac_f32_e32 v13, v60, v43
...
; %bb.10:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v33, v29 :: v_dual_add_nc_u32 v30, s33, v30
...
.LBB0_11:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v17, v18, v41, v7
	v_fma_f32 v18, v19, v42, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	...
	v_dual_max_f32 v7, 0, v7 :: v_dual_and_b32 v0, 1, v49
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v3, v3, v3 :: v_dual_max_f32 v8, 0, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 102
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
