	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s12, v5, v[1:2]
...
.Ltmp19:
	...
	buffer_load_b64 v[49:50], v1, s[4:7], 0 offen
	v_cndmask_b32_e64 v1, 0x80000000, v8, s3
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	buffer_load_b128 v[21:24], v13, s[28:31], 0 offen
	buffer_load_b128 v[25:28], v14, s[28:31], 0 offen
	buffer_load_b128 v[29:32], v15, s[28:31], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[51:52], v1, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[33:36], v3, s[28:31], 0 offen
	buffer_load_b128 v[37:40], v5, s[28:31], 0 offen
	buffer_load_b128 v[41:44], v6, s[28:31], 0 offen
	buffer_load_b128 v[45:48], v7, s[28:31], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	s_waitcnt vmcnt(7)
	ds_store_b128 v54, v[21:24] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(6)
	ds_store_b128 v54, v[25:28] offset:16384
	s_waitcnt vmcnt(5)
	ds_store_b128 v54, v[29:32] offset:20480
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v54, v[33:36] offset:8192
	s_waitcnt vmcnt(2)
	ds_store_b128 v54, v[37:40] offset:12288
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v54, v[41:44] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v54, v[45:48] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_lshl_or_b32 v91, v75, 6, v2
	s_mov_b32 s10, 0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshl_or_b32 v100, v1, 5, v91
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v99, 16, v91
	v_xor_b32_e32 v92, 32, v91
...
.LBB0_3:                                ; %Flow322
	...
	v_or_b32_e32 v17, s33, v75
	v_or_b32_e32 v7, s33, v7
	s_ashr_i32 s1, s13, 6
	v_or_b32_e32 v90, s22, v3
	v_or_b32_e32 v89, s22, v8
	v_mul_lo_u32 v95, v17, s1
	v_mul_lo_u32 v96, v7, s1
	v_or_b32_e32 v88, s22, v14
	v_or_b32_e32 v87, s22, v15
	v_or_b32_e32 v63, s22, v16
	v_or_b32_e32 v64, s22, v4
	v_or_b32_e32 v65, s22, v5
	v_or_b32_e32 v66, s22, v6
	v_add_nc_u32_e32 v86, s23, v3
	v_add_nc_u32_e32 v84, s23, v8
	v_add_nc_u32_e32 v82, s23, v14
	v_add_nc_u32_e32 v80, s23, v15
	v_add_nc_u32_e32 v79, s23, v16
	v_add_nc_u32_e32 v81, s23, v4
	v_add_nc_u32_e32 v45, s23, v5
	v_add_nc_u32_e32 v46, s23, v6
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v7, s18 :: v_dual_mov_b32 v62, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s16, s34, s27
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_add_i32 s14, s14, s15
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	s_add_i32 s17, s34, s47
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_ashr_i32 s14, s14, 6
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[30:31], v14, s[4:7], 0 offen
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cmp_lt_i32 s14, s1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v14, v95, s14, 1
	v_add_lshl_u32 v15, v96, s14, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s14, s14, s35
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v16, v90, s14, 1
	.loc	1 396 39                        ; generate_amdgcn.py:396:39
	s_add_i32 s15, s14, s22
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v17, v89, s14, 1
	v_add_lshl_u32 v18, v88, s14, 1
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v32, v45, s15, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v19, v87, s14, 1
	v_add_lshl_u32 v20, v63, s14, 1
	v_add_lshl_u32 v21, v64, s14, 1
	v_add_lshl_u32 v22, v65, s14, 1
	v_add_lshl_u32 v23, v66, s14, 1
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v24, v86, s15, 1
	v_add_lshl_u32 v25, v84, s15, 1
	v_add_lshl_u32 v26, v82, s15, 1
	v_add_lshl_u32 v27, v80, s15, 1
	v_add_lshl_u32 v28, v79, s15, 1
	v_add_lshl_u32 v29, v81, s15, 1
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_clause 0x1
	buffer_load_u16 v76, v14, s[36:39], 0 offen
	buffer_load_u16 v77, v15, s[36:39], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0xf
	buffer_load_u16 v78, v16, s[40:43], 0 offen
	buffer_load_u16 v83, v17, s[40:43], 0 offen
	buffer_load_u16 v85, v18, s[40:43], 0 offen
	...
	buffer_load_u16 v196, v71, s[40:43], 0 offen
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v14, s16, v9
	v_add_nc_u32_e32 v15, s16, v10
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v16, s17, v9
	v_add_nc_u32_e32 v17, s17, v10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[71:74], v14, s[28:31], 0 offen
	buffer_load_b128 v[120:123], v15, s[28:31], 0 offen
	buffer_load_b128 v[124:127], v16, s[28:31], 0 offen
	buffer_load_b128 v[128:131], v17, s[28:31], 0 offen
	s_mov_b32 s14, s0
	s_mov_b32 s15, s12
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v14, s14, v91
	v_add_nc_u32_e32 v15, s14, v99
	s_mov_b32 s16, s10
	v_add_nc_u32_e32 v16, s14, v92
	v_add_nc_u32_e32 v17, s14, v94
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v18, s15, v100
	v_add_nc_u32_e32 v19, s15, v102
	v_add_nc_u32_e32 v20, s15, v101
	v_add_nc_u32_e32 v21, s15, v103
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v22, s16, v100
	v_add_nc_u32_e32 v23, s16, v102
	v_add_nc_u32_e32 v24, s16, v101
	v_add_nc_u32_e32 v25, s16, v103
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[132:135], v14
	ds_load_b128 v[112:115], v14 offset:1024
	ds_load_b128 v[136:139], v15
	ds_load_b128 v[140:143], v15 offset:1024
	ds_load_b128 v[144:147], v16
	ds_load_b128 v[148:151], v16 offset:1024
	ds_load_b128 v[152:155], v17
	ds_load_b128 v[156:159], v17 offset:1024
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[104:107], v18
	ds_load_b128 v[160:163], v19
	ds_load_b128 v[164:167], v20
	ds_load_b128 v[168:171], v21
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[172:175], v22
	ds_load_b128 v[176:179], v23
	ds_load_b128 v[180:183], v24
	ds_load_b128 v[184:187], v25
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s14, s49, 1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	...
	v_wmma_i32_16x16x16_iu8 v[14:21], v[104:107], v[132:135], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[22:29], v[104:107], v[112:115], v[1:8] neg_lo:[1,1,0]
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[14:21], v[160:163], v[136:139], v[14:21] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[112:119], v[172:175], v[132:135], v[1:8] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[22:29], v[160:163], v[140:143], v[22:29] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[104:111], v[176:179], v[140:143], v[104:111] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[14:21], v[164:167], v[144:147], v[14:21] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[112:119], v[176:179], v[136:139], v[112:119] neg_lo:[1,1,0]
	s_mov_b32 s10, s44
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[22:29], v[164:167], v[148:151], v[22:29] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[104:111], v[180:183], v[148:151], v[104:111] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[14:21], v[168:171], v[152:155], v[14:21] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[112:119], v[180:183], v[144:147], v[112:119] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_add_i32 s46, s15, 0x8000
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[22:29], v[168:171], v[156:159], v[22:29] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v197, s15, v12
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_lshlrev_b32_e32 v136, 16, v194
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_store_b64 v197, v[30:31] offset:32768
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_lshlrev_b32_e32 v31, 16, v77
	v_lshlrev_b32_e32 v30, 16, v76
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v147, v30, v133 :: v_dual_lshlrev_b32 v132, 16, v190
	v_mul_f32_e32 v133, v31, v133
	v_mul_f32_e32 v151, v30, v137
	v_dual_mul_f32 v152, v30, v136 :: v_dual_lshlrev_b32 v77, 16, v83
	v_dual_mul_f32 v150, v30, v134 :: v_dual_lshlrev_b32 v83, 16, v93
	v_mul_f32_e32 v134, v31, v134
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v76, 16, v78
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v148, v30, v132 :: v_dual_mul_f32 v141, v31, v83
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v83, v30, v83 :: v_dual_lshlrev_b32 v138, 16, v196
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v132, v31, v132
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v139, v31, v77
	v_mul_f32_e32 v77, v30, v77
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v53, v83, v17
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v153, v30, v138 :: v_dual_lshlrev_b32 v78, 16, v85
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v61, v77, v15 :: v_dual_lshlrev_b32 v32, 16, v32
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v93, 16, v98
	v_lshlrev_b32_e32 v98, 16, v189
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v142, v31, v78
	v_dual_mul_f32 v78, v30, v78 :: v_dual_lshlrev_b32 v135, 16, v193
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v137, v31, v137
	v_dual_mul_f32 v136, v31, v136 :: v_dual_lshlrev_b32 v85, 16, v97
	v_dual_mul_f32 v138, v31, v138 :: v_dual_lshlrev_b32 v97, 16, v188
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v143, v31, v93
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v144, v31, v85
	v_mul_f32_e32 v93, v30, v93
	v_mul_f32_e32 v85, v30, v85
	v_mul_f32_e32 v145, v31, v98
	v_mul_f32_e32 v146, v31, v97
	v_dual_mul_f32 v97, v30, v97 :: v_dual_mul_f32 v140, v31, v76
	v_mul_f32_e32 v76, v30, v76
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v52, v78, v16
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v149, v30, v135 :: v_dual_add_nc_u32 v198, s45, v13
	v_mul_f32_e32 v135, v31, v135
	v_dual_mul_f32 v31, v31, v32 :: v_dual_mul_f32 v98, v30, v98
	v_mul_f32_e32 v30, v30, v32
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v60, v76, v14
	v_dual_fmac_f32 v41, v85, v18 :: v_dual_fmac_f32 v68, v139, v23
	v_dual_fmac_f32 v42, v93, v19 :: v_dual_fmac_f32 v67, v140, v22
	v_dual_fmac_f32 v33, v97, v20 :: v_dual_fmac_f32 v44, v143, v27
	v_fmac_f32_e32 v34, v98, v21
	v_dual_fmac_f32 v56, v142, v24 :: v_dual_fmac_f32 v57, v141, v25
	v_dual_fmac_f32 v43, v144, v26 :: v_dual_fmac_f32 v36, v145, v29
	v_dual_fmac_f32 v35, v146, v28 :: v_dual_fmac_f32 v62, v147, v113
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_fmac_f32 v47, v148, v112 :: v_dual_fmac_f32 v54, v150, v114
	v_dual_fmac_f32 v55, v149, v115 :: v_dual_fmac_f32 v48, v152, v116
	v_dual_fmac_f32 v49, v151, v117 :: v_dual_fmac_f32 v38, v153, v119
	v_dual_fmac_f32 v37, v30, v118 :: v_dual_fmac_f32 v70, v133, v105
	v_dual_fmac_f32 v69, v132, v104 :: v_dual_fmac_f32 v58, v134, v106
	v_dual_fmac_f32 v59, v135, v107 :: v_dual_fmac_f32 v50, v136, v108
	v_dual_fmac_f32 v51, v137, v109 :: v_dual_fmac_f32 v40, v138, v111
	v_fmac_f32_e32 v39, v31, v110
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v198, v[71:74]
	s_waitcnt vmcnt(2)
	ds_store_b128 v198, v[120:123] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v198, v[124:127] offset:16384
	s_waitcnt vmcnt(0)
	ds_store_b128 v198, v[128:131] offset:20480
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_6:
	...
	s_add_i32 s44, 0, 0x6000
.LBB0_7:                                ; %._crit_edge
	v_dual_mov_b32 v78, 0 :: v_dual_add_nc_u32 v17, s0, v92
	v_dual_mov_b32 v118, 0 :: v_dual_add_nc_u32 v1, s0, v91
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v5, s0, v99
	v_dual_mov_b32 v119, 0 :: v_dual_add_nc_u32 v18, s0, v94
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.8:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v111, s43 :: v_dual_add_nc_u32 v76, s12, v102
	v_mov_b32_e32 v110, s42
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[71:74], v71
	ds_load_b128 v[112:115], v76
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v108, s40 :: v_dual_add_nc_u32 v77, s12, v101
	v_dual_mov_b32 v109, s41 :: v_dual_add_nc_u32 v76, s12, v103
	v_dual_mov_b32 v107, s39 :: v_dual_mov_b32 v106, s38
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[127:130], v77
	ds_load_b128 v[131:134], v76
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v105, s37 :: v_dual_mov_b32 v104, s36
	s_waitcnt lgkmcnt(3)
...
.LBB0_11:
	...
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v9, s0, v86, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_and_b32 s25, s25, 0xffff
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v10, s0, v84, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v5, 0x80000000, v5 :: v_dual_cndmask_b32 v6, 0x80000000, v6
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v11, s0, v82, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	v_dual_mov_b32 v108, 0 :: v_dual_add_nc_u32 v17, s46, v92
	v_dual_mov_b32 v136, 0 :: v_dual_add_nc_u32 v1, s46, v91
	v_dual_mov_b32 v140, 0 :: v_dual_add_nc_u32 v5, s46, v99
	v_dual_mov_b32 v139, 0 :: v_dual_add_nc_u32 v18, s46, v94
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[29:32], v17
	ds_load_b128 v[21:24], v17 offset:1024
	ds_load_b128 v[25:28], v18
...
; %bb.12:
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v154, s19 :: v_dual_add_nc_u32 v91, s45, v100
	v_dual_mov_b32 v153, s18 :: v_dual_add_nc_u32 v92, s45, v102
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[137:140], v91
	ds_load_b128 v[141:144], v92
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v151, s16 :: v_dual_add_nc_u32 v92, s45, v101
	v_dual_mov_b32 v152, s17 :: v_dual_add_nc_u32 v91, s45, v103
	v_dual_mov_b32 v150, s15 :: v_dual_mov_b32 v149, s14
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[170:173], v92
	ds_load_b128 v[174:177], v91
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
; %bb.14:
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v177, s19 :: v_dual_add_nc_u32 v100, s44, v100
	v_dual_mov_b32 v175, s17 :: v_dual_add_nc_u32 v102, s44, v102
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[178:181], v100
	ds_load_b128 v[182:185], v102
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_dual_mov_b32 v171, s13 :: v_dual_add_nc_u32 v100, s44, v101
	v_dual_mov_b32 v173, s15 :: v_dual_add_nc_u32 v106, s44, v103
...
.LBB0_15:
	...
	s_add_i32 s4, s4, s22
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v84, v1, v7
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v86, v1, v22 :: v_dual_mul_f32 v7, v2, v7
	v_mul_f32_e32 v87, v1, v21
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v3, s4, v6, v3
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_cndmask_b32_e32 v6, 0x80000000, v63, vcc_lo
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_mov_b16_e64 v23.h, v163.l
	v_mov_b16_e32 v23.l, v1.l
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v90, v1, v26
	v_dual_mul_f32 v26, v2, v26 :: v_dual_cndmask_b32 v63, 0x80000000, v64
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_cndmask_b32_e32 v64, 0x80000000, v65, vcc_lo
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v100, v1, v27 :: v_dual_cndmask_b32 v65, 0x80000000, v66
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_fma_f32 v66, v84, v134, v69
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v84, v87, v123, v67
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v22, v2, v22 :: v_dual_mul_f32 v95, v1, v25
	v_dual_mul_f32 v25, v2, v25 :: v_dual_mul_f32 v96, v1, v28
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	...
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v82, v1, v20
	v_dual_mul_f32 v20, v2, v20 :: v_dual_mul_f32 v89, v1, v23
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v21, v2, v21 :: v_dual_mul_f32 v88, v1, v24
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v24, v2, v24 :: v_dual_mul_f32 v101, v1, v19
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v95, v95, v121, v56
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v51, v51, v96, s2
	...
	buffer_load_u16 v7, v64, s[24:27], 0 offen
	buffer_load_u16 v6, v65, s[24:27], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	v_dual_mul_f32 v49, v5, v11 :: v_dual_lshlrev_b32 v8, 16, v8
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v9, v4, v9
	v_mul_f32_e32 v11, v4, v11
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v65, v69, v66, s2
	v_cndmask_b32_e64 v66, v68, v86, s2
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v48, v5, v8 :: v_dual_lshlrev_b32 v13, 16, v13
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v52, v5, v10 :: v_dual_lshlrev_b32 v17, 16, v17
	v_dual_mul_f32 v8, v4, v8 :: v_dual_mul_f32 v55, v5, v15
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v15, v4, v15
	v_mul_f32_e32 v53, v5, v13
	v_mul_f32_e32 v54, v5, v12
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v10, v4, v10 :: v_dual_mul_f32 v61, v5, v17
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v13, v4, v13 :: v_dual_lshlrev_b32 v14, 16, v14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v15, v24, v15, s3
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_mul_f32_e32 v68, v5, v16
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v64, v70, v82, s2
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_mul_f32_e32 v51, 0xbfb8aa3b, v13
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_fma_f32 v60, v60, v156, v58
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_mul_f32 v28, 0xbfb8aa3b, v25 :: v_dual_fmac_f32 v27, 0xbfb8aa3b, v26
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_mul_f32 v52, 0xbfb8aa3b, v49 :: v_dual_fmac_f32 v53, 0xbfb8aa3b, v47
	v_dual_mul_f32 v54, 0xbfb8aa3b, v14 :: v_dual_fmac_f32 v51, 0xbfb8aa3b, v13
	v_mul_f32_e32 v55, 0xbfb8aa3b, v15
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_mul_f32 v50, 0xbfb8aa3b, v12 :: v_dual_mul_f32 v59, 0xbfb8aa3b, v17
	...
	v_dual_fmac_f32 v28, 0xbfb8aa3b, v25 :: v_dual_add_f32 v27, 1.0, v27
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_fmac_f32 v50, 0xbfb8aa3b, v12 :: v_dual_add_f32 v51, 1.0, v51
	v_fmac_f32_e32 v55, 0xbfb8aa3b, v15
	...
	v_dual_add_f32 v28, 1.0, v28 :: v_dual_fmac_f32 v95, v121, v95
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_div_scale_f32 v64, s0, v26, v27, v26
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 411 34                        ; generate_amdgcn.py:411:34
	v_dual_add_f32 v54, 1.0, v54 :: v_dual_add_f32 v55, 1.0, v55
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_exp_f32_e32 v52, v52
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_mul_f32_e32 v121, v64, v95
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	...
	v_mul_f32_e32 v57, 0xbfb8aa3b, v23
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_mul_f32 v58, 0xbfb8aa3b, v16 :: v_dual_fmac_f32 v57, 0xbfb8aa3b, v23
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_div_scale_f32 v61, vcc_lo, v25, v28, v25
	v_fmac_f32_e32 v117, v127, v117
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(TRANS32_DEP_2)
	v_div_scale_f32 v82, null, v52, v52, v49
	v_fma_f32 v120, -v60, v90, 1.0
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_exp_f32_e32 v57, v57
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_fma_f32 v122, -v65, v96, 1.0
	s_delay_alu instid0(VALU_DEP_3)
	v_rcp_f32_e32 v115, v82
	v_fma_f32 v129, -v62, v121, v64
	v_dual_fmac_f32 v90, v120, v90 :: v_dual_mul_f32 v127, v118, v117
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_cndmask_b32_e64 v69, 0, 0xffffffc0, s9
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_div_scale_f32 v66, s1, v13, v51, v13
	v_div_scale_f32 v84, s6, v49, v52, v49
	v_fmac_f32_e32 v121, v129, v95
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_fma_f32 v125, -v82, v115, 1.0
	.loc	1 411 34                        ; generate_amdgcn.py:411:34
	...
	.loc	1 411 22                        ; generate_amdgcn.py:411:22
	v_div_fmas_f32 v61, v61, v95, v121
	s_mov_b32 vcc_lo, s1
	v_div_fixup_f32 v25, v60, v28, v25
	v_div_fmas_f32 v62, v62, v96, v122
	v_mul_f32_e32 v126, v87, v116
	s_mov_b32 vcc_lo, s4
	...
	v_fma_f32 v67, -v86, v126, v87
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_fmac_f32 v56, 0xbfb8aa3b, v24 :: v_dual_add_f32 v57, 1.0, v57
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v47, v5, v31 :: v_dual_lshlrev_b32 v6, 16, v6
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 411 15                        ; generate_amdgcn.py:411:15
	v_dual_mul_f32 v14, v18, v14 :: v_dual_and_b32 v17, 1, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 411 40                        ; generate_amdgcn.py:411:40
	v_dual_fmac_f32 v26, 0xbfb8aa3b, v13 :: v_dual_mul_f32 v27, v1, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	.loc	1 411 34                        ; generate_amdgcn.py:411:34
	v_dual_add_f32 v28, 1.0, v28 :: v_dual_mul_f32 v31, v32, v26
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 199
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
