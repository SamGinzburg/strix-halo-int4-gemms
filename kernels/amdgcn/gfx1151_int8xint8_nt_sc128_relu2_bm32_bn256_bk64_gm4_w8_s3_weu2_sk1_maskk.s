	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v34, s4, v11
	.loc	1 376 22 is_stmt 0              ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[26:29], v13, s[28:31], 0 offen
	buffer_load_b128 v[30:33], v23, s[28:31], 0 offen
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v12, 0x80000000, v34 :: v_dual_cndmask_b32 v7, 0x80000000, v7
	v_cndmask_b32_e32 v8, 0x80000000, v8, vcc_lo
	v_cndmask_b32_e32 v13, 0x80000000, v24, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[23:24], v2, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	...
	buffer_load_b128 v[46:49], v13, s[28:31], 0 offen
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b64 v50, v[23:24] offset:34816
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s14, s41
	s_cmp_lt_i32 s18, 2
	s_cselect_b32 s43, s18, 0
	s_add_i32 s15, s15, -1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_lshl_b32 s18, s43, 11
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_lshl_b32 s19, s43, 14
	...
	v_dual_mul_f32 v145, v79, v133 :: v_dual_add_nc_u32 v178, s18, v14
	...
	v_dual_mul_f32 v75, v75, v134 :: v_dual_fmac_f32 v28, v145, v127
	v_mul_f32_e32 v76, v76, v134
	v_dual_mul_f32 v77, v77, v134 :: v_dual_fmac_f32 v26, v143, v125
	v_mul_f32_e32 v78, v78, v134
	v_dual_mul_f32 v79, v79, v134 :: v_dual_fmac_f32 v32, v149, v131
	v_mul_f32_e32 v82, v82, v134
	v_dual_mul_f32 v83, v83, v134 :: v_dual_fmac_f32 v34, v69, v85
	v_mul_f32_e32 v84, v84, v134
	v_dual_mul_f32 v81, v81, v134 :: v_dual_fmac_f32 v30, v147, v129
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v17, v135, v117 :: v_dual_fmac_f32 v22, v140, v122
	v_dual_fmac_f32 v19, v137, v119 :: v_dual_fmac_f32 v44, v78, v94
	v_dual_fmac_f32 v21, v139, v121 :: v_dual_fmac_f32 v46, v80, v96
	v_dual_fmac_f32 v23, v141, v123 :: v_dual_fmac_f32 v48, v82, v98
	v_dual_fmac_f32 v27, v144, v126 :: v_dual_fmac_f32 v36, v71, v87
	v_dual_fmac_f32 v29, v146, v128 :: v_dual_fmac_f32 v38, v73, v89
	v_dual_fmac_f32 v31, v148, v130 :: v_dual_fmac_f32 v40, v75, v91
	v_fmac_f32_e32 v33, v133, v132
	v_dual_fmac_f32 v35, v70, v86 :: v_dual_fmac_f32 v42, v84, v100
	v_fmac_f32_e32 v37, v72, v88
	v_fmac_f32_e32 v39, v74, v90
	v_fmac_f32_e32 v41, v76, v92
	v_fmac_f32_e32 v43, v77, v93
...
.LBB0_12:
	...
	v_fma_f32 v10, v10, v71, v27
	v_fma_f32 v9, v9, v70, v26
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v20, v20, v20 :: v_dual_max_f32 v27, 0, v27
	...
	v_dual_mov_b32 v16, 0x7632 :: v_dual_and_b32 v45, 1, v149
	s_delay_alu instid0(VALU_DEP_4)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 186
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
