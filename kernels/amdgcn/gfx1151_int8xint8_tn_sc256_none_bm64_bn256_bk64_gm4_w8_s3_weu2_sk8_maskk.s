	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_or_b32_e32 v93, 0xbf0, v0
	v_or_b32_e32 v94, 0xff0, v0
...
.Ltmp11:
	...
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_lshrrev_b32_e32 v87, 2, v1
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 349 16                        ; generate_amdgcn.py:349:16
	s_cvt_u32_f32 s5, s5
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_mul_lo_u32 v3, s35, v87
...
.Ltmp20:
	...
	s_add_i32 s13, s27, 0x1ff
.Ltmp21:
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v4, s26, v87
	.loc	1 356 14                        ; generate_amdgcn.py:356:14
	s_lshl_b32 s46, s12, 8
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s12, s46, s19
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v3, s26, v86
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v90, s40, v88
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v85, v2, v5, s41
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v2, s12, v88
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_and_b32 s5, s5, 0xffff
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, vcc_lo, s3
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v6, s12, v90
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add_nc_u32_e32 v3, s18, v85
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v2, s42, v87
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s12, s12, s15
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v6, 32, v113
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v3, s12, v88
	v_add_nc_u32_e32 v4, s12, v90
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	v_cmp_gt_i32_e32 vcc_lo, s27, v2
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v5, s12, v89
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	s_lshl_b32 s12, s34, 9
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_cndmask_b32_e32 v2, 0x80000000, v2, vcc_lo
	buffer_load_b128 v[44:47], v2, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v2, v0, 0, 1
	...
	v_perm_b32 v23, v9, v8, 0x7060302
	...
	s_waitcnt vmcnt(3)
	v_perm_b32 v19, v32, v28, 0x4000501
	s_waitcnt vmcnt(1)
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v2, v25, v19, 0x7060302
	v_perm_b32 v8, v25, v19, 0x5040100
	v_perm_b32 v9, v27, v26, 0x7060302
	v_perm_b32 v10, v27, v26, 0x5040100
	v_perm_b32 v11, v32, v28, 0x7060302
	v_perm_b32 v12, v32, v28, 0x5040100
	v_perm_b32 v13, v33, v29, 0x7060302
	v_perm_b32 v14, v33, v29, 0x5040100
	v_perm_b32 v15, v37, v36, 0x7060302
	v_perm_b32 v16, v37, v36, 0x5040100
	v_perm_b32 v17, v34, v30, 0x7060302
	v_perm_b32 v18, v34, v30, 0x5040100
	v_perm_b32 v19, v40, v38, 0x7060302
	v_perm_b32 v20, v40, v38, 0x5040100
	v_perm_b32 v21, v35, v31, 0x7060302
	v_perm_b32 v22, v35, v31, 0x5040100
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b32_e32 v91, 0x1800, v196
	v_and_b32_e32 v92, 48, v3
...
.LBB0_3:                                ; %Flow90
	...
	v_mul_lo_u32 v153, v9, s43
	v_mul_lo_u32 v140, v5, s43
	v_mul_lo_u32 v141, v6, s43
	v_mul_lo_u32 v142, v7, s43
	v_or_b32_e32 v119, s46, v0
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v1, v0, 3, 1
	v_dual_mov_b32 v121, 0 :: v_dual_and_b32 v92, 48, v3
.Ltmp22:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v114, s48, v113
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v11, s42, v86
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[9:10], null, s42, s34, v[85:86]
	...
	v_xor_b32_e32 v81, 32, v109
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v115, s12, v81
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v9, s42, v87
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v79, v10
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v10, s35, v88
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(3)
	v_mul_f32_e32 v226, v15, v74
	v_dual_mul_f32 v222, v15, v73 :: v_dual_lshlrev_b32 v75, 16, v210
	v_mul_f32_e32 v208, v9, v73
	v_mul_f32_e32 v209, v10, v73
	v_mul_f32_e32 v210, v11, v73
	v_dual_mul_f32 v211, v12, v73 :: v_dual_mul_f32 v212, v9, v74
	v_mul_f32_e32 v213, v10, v74
	v_mul_f32_e32 v214, v11, v74
	v_dual_mul_f32 v215, v12, v74 :: v_dual_mul_f32 v216, v9, v75
	v_mul_f32_e32 v217, v10, v75
	v_mul_f32_e32 v218, v11, v75
	v_mul_f32_e32 v219, v12, v75
	v_mul_f32_e32 v9, v9, v76
	v_mul_f32_e32 v10, v10, v76
	v_mul_f32_e32 v11, v11, v76
	v_mul_f32_e32 v12, v12, v76
	v_mul_f32_e32 v220, v13, v73
	v_mul_f32_e32 v221, v14, v73
	v_dual_mul_f32 v223, v16, v73 :: v_dual_mul_f32 v224, v13, v74
	v_dual_mul_f32 v225, v14, v74 :: v_dual_mul_f32 v228, v13, v75
	v_dual_mul_f32 v227, v16, v74 :: v_dual_mul_f32 v230, v15, v75
	v_mul_f32_e32 v229, v14, v75
	v_dual_mul_f32 v231, v16, v75 :: v_dual_mul_f32 v14, v14, v76
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v13, v13, v76 :: v_dual_mul_f32 v234, v191, v73
	v_dual_mul_f32 v15, v15, v76 :: v_dual_mul_f32 v232, v189, v73
	v_dual_mul_f32 v16, v16, v76 :: v_dual_mul_f32 v233, v190, v73
	v_dual_mul_f32 v236, v189, v74 :: v_dual_mul_f32 v235, v192, v73
	v_mul_f32_e32 v238, v191, v74
	v_dual_mul_f32 v237, v190, v74 :: v_dual_mul_f32 v240, v189, v75
	v_dual_mul_f32 v239, v192, v74 :: v_dual_mul_f32 v242, v191, v75
	v_mul_f32_e32 v241, v190, v75
	v_dual_mul_f32 v243, v192, v75 :: v_dual_mul_f32 v190, v190, v76
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v189, v189, v76 :: v_dual_mul_f32 v246, v195, v73
	...
	v_dual_mul_f32 v247, v193, v74 :: v_dual_mul_f32 v252, v195, v75
	...
	v_dual_fmac_f32 v121, v208, v77 :: v_dual_add_nc_u32 v200, s44, v98
	v_fmac_f32_e32 v123, v210, v19
	v_dual_fmac_f32 v125, v220, v21 :: v_dual_fmac_f32 v122, v209, v18
	v_fmac_f32_e32 v127, v222, v23
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v200, v196, v64 offset1:16
	v_perm_b32 v64, v201, v115, 0x7060302
	v_perm_b32 v115, v201, v115, 0x5040100
	v_add_nc_u32_e32 v196, s44, v99
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v124, v211, v20 :: v_dual_fmac_f32 v133, v244, v82
	v_dual_fmac_f32 v126, v221, v22 :: v_dual_fmac_f32 v131, v234, v80
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v128, v223, v24 :: v_dual_fmac_f32 v137, v212, v33
	v_dual_fmac_f32 v129, v232, v78 :: v_dual_fmac_f32 v130, v233, v79
	v_fmac_f32_e32 v135, v246, v84
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v116, v64, v115 offset1:16
	v_perm_b32 v64, v203, v117, 0x7060302
	v_perm_b32 v115, v203, v117, 0x5040100
	v_add_nc_u32_e32 v116, s44, v105
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v132, v235, v81 :: v_dual_fmac_f32 v139, v214, v35
	v_dual_fmac_f32 v134, v245, v83 :: v_dual_fmac_f32 v143, v215, v36
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v116, v64, v115 offset1:16
	v_perm_b32 v64, v204, v120, 0x7060302
	v_perm_b32 v115, v204, v120, 0x5040100
	v_add_nc_u32_e32 v116, s44, v106
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v136, v73, v114 :: v_dual_fmac_f32 v147, v227, v40
	v_dual_fmac_f32 v138, v213, v34 :: v_dual_fmac_f32 v151, v239, v28
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v116, v64, v115 offset1:16
	v_perm_b32 v64, v205, v197, 0x7060302
	v_perm_b32 v115, v205, v197, 0x5040100
	v_add_nc_u32_e32 v116, s44, v107
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v144, v224, v37 :: v_dual_fmac_f32 v145, v225, v38
	v_dual_fmac_f32 v146, v226, v39 :: v_dual_fmac_f32 v149, v237, v26
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v200, v64, v115 offset0:160 offset1:176
	v_perm_b32 v64, v206, v198, 0x7060302
	v_perm_b32 v115, v206, v198, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v148, v236, v25 :: v_dual_fmac_f32 v155, v249, v31
	v_dual_fmac_f32 v150, v238, v27 :: v_dual_fmac_f32 v157, v216, v49
	v_dual_fmac_f32 v152, v247, v29 :: v_dual_fmac_f32 v159, v218, v51
	...
	v_fmac_f32_e32 v180, v16, v72
	v_dual_fmac_f32 v182, v189, v57 :: v_dual_add_nc_u32 v11, s44, v108
...
; %bb.9:
	...
	s_mov_b32 s23, s16
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v110, s48, v113
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v117, s48, v114
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v111, s48, v190
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
.LBB0_12:
	...
	s_mul_i32 s5, s4, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v64, v153, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v81, v119, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v82, v140, s4, 1
	v_add_lshl_u32 v83, v141, s4, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s5
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v84, v142, s4, 1
	...
	v_mul_f32_e32 v140, v66, v64
	v_mul_f32_e32 v141, v65, v64
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v160, v176, v219, v150
	v_fma_f32 v88, v88, v117, v187
	v_fma_f32 v140, v140, v226, v158
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v153, v155, v153, s3
	...
	v_cndmask_b32_e64 v139, v139, v168, s3
	v_cndmask_b32_e64 v138, v138, v169, s3
	...
	v_cndmask_b32_e64 v137, v137, v170, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_fma_f32 v35, v177, v35, v151
	v_fma_f32 v36, v178, v36, v152
	v_fma_f32 v48, v189, v48, v110
	v_fma_f32 v70, v72, v1, v93
	v_fma_f32 v155, v176, v34, v150
	...
	v_cndmask_b32_e64 v3, v141, v40, s2
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v39, v82, v39, v142
	v_fma_f32 v82, v182, v41, v140
	...
	v_cndmask_b32_e64 v46, v151, v35, s2
	v_cndmask_b32_e64 v50, v152, v36, s2
	...
	v_cndmask_b32_e64 v42, v150, v155, s2
	...
	v_cndmask_b32_e64 v62, v142, v39, s2
	v_cndmask_b32_e64 v7, v140, v82, s2
	...
	v_cndmask_b32_e64 v58, v153, v157, s2
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 98
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 92
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 92
    .sgpr_count:     100
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
