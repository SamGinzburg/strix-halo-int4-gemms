...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s24, s8
	v_dual_mov_b32 v28, v33 :: v_dual_lshlrev_b32 v15, 7, v0
	buffer_load_u16 v39, v1, s[24:27], 0 offen
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v68, s18, v83
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v49, v37, v41, s1
	v_cndmask_b32_e64 v51, v41, v37, s1
	v_dual_mov_b32 v30, v33 :: v_dual_lshlrev_b32 v37, 1, v6
	...
	v_dual_mov_b32 v18, v33 :: v_dual_and_b32 v73, 0x120, v12
	s_add_i32 s8, s3, s0
	v_cndmask_b32_e64 v71, 0x90, 0, vcc_lo
	v_dual_mov_b32 v31, v33 :: v_dual_and_b32 v80, 0x700, v15
	v_mov_b32_e32 v26, v33
	v_lshrrev_b32_e32 v81, 2, v3
	v_lshl_or_b32 v67, v35, 5, v37
	.loc	1 759 21                        ; attention.py:759:21
	...
	v_dual_mov_b32 v119, 0xff800000 :: v_dual_lshlrev_b32 v40, 1, v8
	v_xor_b32_e32 v36, v4, v5
	v_lshrrev_b32_e32 v38, 1, v7
	v_lshl_or_b32 v41, v7, 6, v66
	v_dual_mov_b32 v27, v33 :: v_dual_lshlrev_b32 v78, 8, v6
	v_dual_mov_b32 v32, v33 :: v_dual_and_b32 v79, 0x260, v10
	v_dual_mov_b32 v29, v33 :: v_dual_and_b32 v74, 0x300, v10
	v_lshrrev_b32_e32 v75, 5, v8
	v_dual_mov_b32 v19, v33 :: v_dual_and_b32 v82, 0x160, v10
	...
	v_add_nc_u32_e32 v37, s36, v68
	v_xor_b32_e32 v68, v69, v73
	v_dual_mov_b32 v21, v33 :: v_dual_add_nc_u32 v80, 0, v80
	v_dual_mov_b32 v24, v33 :: v_dual_add_nc_u32 v35, s36, v35
	v_xor_b32_e32 v81, v71, v81
	v_dual_mov_b32 v22, v33 :: v_dual_add_nc_u32 v69, 0, v40
	...
	v_dual_mov_b32 v13, v33 :: v_dual_add_nc_u32 v80, v80, v81
	v_dual_mov_b32 v15, v33 :: v_dual_add_nc_u32 v82, s17, v35
	...
	v_dual_mov_b32 v10, v33 :: v_dual_add_nc_u32 v77, s17, v37
	v_dual_mov_b32 v11, v33 :: v_dual_and_b32 v84, 0x760076, v84
	v_dual_mov_b32 v12, v33 :: v_dual_and_b32 v41, 0x540054, v41
	v_dual_mov_b32 v14, v33 :: v_dual_add_nc_u32 v83, 0, v36
	.loc	1 758 19                        ; attention.py:758:19
	s_bfe_i32 s9, s9, 0x80000
	.loc	1 951 47                        ; attention.py:951:47
	v_subrev_nc_u32_e32 v76, s16, v37
	v_xor_b32_e32 v37, 16, v67
	v_add_nc_u32_e32 v79, v69, v38
	v_xor_b32_e32 v38, 0x60, v70
	...
	v_dual_mov_b32 v7, v33 :: v_dual_add_nc_u32 v88, 0, v38
	.loc	1 760 21                        ; attention.py:760:21
	...
	v_dual_mov_b32 v16, v33 :: v_dual_add_nc_u32 v85, 0, v85
	v_dual_mov_b32 v2, v33 :: v_dual_add_nc_u32 v87, 0, v87
	v_dual_mov_b32 v4, v33 :: v_dual_add_nc_u32 v89, 0, v89
	v_dual_mov_b32 v5, v33 :: v_dual_add_nc_u32 v86, 0, v40
	v_dual_mov_b32 v6, v33 :: v_dual_and_b32 v101, 0x7060706, v101
	v_dual_mov_b32 v8, v33 :: v_dual_add_nc_u32 v103, 0, v37
	...
	v_dual_mul_f32 v114, s12, v34 :: v_dual_add_nc_u32 v107, v36, v0
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 913 33                        ; attention.py:913:33
	v_dual_mov_b32 v34, v33 :: v_dual_add_nc_u32 v41, s23, v91
	v_dual_mov_b32 v35, v33 :: v_dual_add_nc_u32 v122, 0, v67
	...
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v128, s23, v74
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s3, v126, v76
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s5, v126, v77
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v127, s23, v73
	.loc	1 955 25                        ; attention.py:955:25
	s_add_i32 s50, s49, s23
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s7, v128, v76
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s13, v128, v77
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s4, v126, v81
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s6, v126, v82
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s12, v128, v81
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s14, v128, v82
	.loc	1 952 21 is_stmt 0              ; attention.py:952:21
	s_and_b32 s3, s3, s5
	s_and_b32 s5, s7, s13
	.loc	1 951 30 is_stmt 1              ; attention.py:951:30
	v_cmp_ge_i32_e64 s8, v127, v76
	v_cmp_ge_i32_e64 s9, v127, v81
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s10, v127, v77
	v_cmp_le_i32_e64 s11, v127, v82
	...
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s15, v129, v76
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s17, v129, v77
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s16, v129, v81
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s18, v129, v82
	.loc	1 952 21 is_stmt 0              ; attention.py:952:21
	s_and_b32 s9, s1, s5
	...
	v_add_lshl_u32 v134, v92, s23, 1
	v_add_lshl_u32 v137, v93, s23, 1
	v_add_lshl_u32 v138, v94, s23, 1
	v_add_lshl_u32 v139, v95, s23, 1
	v_add_lshl_u32 v140, v96, s23, 1
	v_add_lshl_u32 v141, v97, s23, 1
	v_add_lshl_u32 v143, v99, s23, 1
	.loc	1 966 25                        ; attention.py:966:25
	.loc	1 990 39                        ; attention.py:990:39
	.loc	1 908 32                        ; attention.py:908:32
	s_waitcnt vmcnt(0)
	ds_store_b32 v72, v120
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[120:121], v122
	ds_load_b64 v[122:123], v83
	ds_load_b64 v[124:125], v84
	.loc	1 913 33                        ; attention.py:913:33
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[34:41], v[120:121], v[50:51], v[34:41] neg_lo:[1,1,0]
	.loc	1 908 32                        ; attention.py:908:32
	ds_load_b64 v[120:121], v85
	.loc	1 913 33                        ; attention.py:913:33
	s_waitcnt lgkmcnt(2)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b64 v79, v[120:121], v[135:136] offset1:32
	.loc	1 966 25                        ; attention.py:966:25
	s_and_b32 s4, s7, s10
	s_and_b32 s10, s3, s8
	s_and_b32 s8, s6, s14
	...
	.loc	1 966 25                        ; attention.py:966:25
	v_add_nc_u32_e32 v122, v69, v68
	v_add_nc_u32_e32 v121, 0, v70
	...
	.loc	1 965 35                        ; attention.py:965:35
	ds_store_2addr_b64 v79, v[130:131], v[132:133] offset0:64 offset1:96
	.loc	1 966 25                        ; attention.py:966:25
...
.Ltmp2:
	...
	v_permlanex16_b32 v122, v121, s35, 0xfedcba98 op_sel:[1,0]
...
.Ltmp5:
	...
	v_dual_sub_f32 v41, v41, v121 :: v_dual_max_f32 v122, v123, v122
.Ltmp6:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max_f32_e32 v123, v125, v124
...
.Ltmp14:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:968:29 ]
	v_dual_mov_b32 v124, v122 :: v_dual_and_b32 v131, 1, v139
.Ltmp15:
	.loc	1 1019 30                       ; attention.py:1019:30
...
.Ltmp26:
	...
	v_dual_add_f32 v125, v125, v128 :: v_dual_and_b32 v38, 1, v38
.Ltmp27:
	.loc	1 971 49                        ; attention.py:971:49
	...
	v_permlanex16_b32 v39, v133, s35, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_perm_b32 v38, v39, v133, v100
	v_perm_b32 v39, v39, v133, v101
	.loc	1 969 24                        ; attention.py:969:24
	v_max_f32_e32 v133, v116, v116
	v_dual_max_f32 v123, v133, v123 :: v_dual_and_b32 v52, 1, v52
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_permlanex16_b32 v52, v41, s35, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
...
.Ltmp33:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_mov_b32_e32 v125, v53
	v_dual_mov_b32 v117, v52 :: v_dual_mul_f32 v18, v18, v115
	v_mov_b32_dpp v125, v125 row_xmask:1 row_mask:0xf bank_mask:0xf
...
.Ltmp43:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 1018 23 is_stmt 1             ; attention.py:1018:23
	v_dual_mul_f32 v25, v25, v115 :: v_dual_and_b32 v130, 1, v130
	.loc	1 1017 30                       ; attention.py:1017:30
	v_mov_b16_e64 v132.l, v126.h
	v_mov_b16_e64 v135.l, v131.h
	v_mov_b16_e64 v120.l, v128.h
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v27, v27, v115 :: v_dual_and_b32 v116, 1, v116
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 144
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 51
