	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_dual_mov_b32 v117, 0 :: v_dual_and_b32 v76, 15, v0
	s_mul_f32 s10, s10, 0x4f7ffffe
	scratch_store_b32 off, v1, off offset:168 ; 4-byte Folded Spill
	v_mov_b32_e32 v1, 0
	v_dual_mov_b32 v116, 0 :: v_dual_and_b32 v81, 16, v0
	...
	v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v210, 0
...
.Ltmp16:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:154:22 ]
	s_lshr_b32 s0, s1, 24
	v_dual_mov_b32 v224, 0 :: v_dual_add_nc_u32 v17, 64, v13
	s_add_i32 s2, s2, s0
	v_cmp_gt_i32_e64 s0, 0x80, v13
.Ltmp17:
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_lshrrev_b32_e32 v13, 3, v81
	v_dual_mov_b32 v213, 0 :: v_dual_add_nc_u32 v18, 64, v14
	v_cmp_gt_i32_e32 vcc_lo, 0x80, v14
	v_dual_mov_b32 v197, 0 :: v_dual_add_nc_u32 v14, s22, v76
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_ashr_i32 s5, s5, 1
...
.Ltmp19:
	...
	v_dual_mov_b32 v158, 0 :: v_dual_and_b32 v13, 2, v13
	s_lshl_b32 s8, s7, 8
	s_lshl_b32 s7, s7, 7
	...
	v_dual_mov_b32 v204, 0 :: v_dual_lshlrev_b32 v17, 1, v14
	v_dual_mov_b32 v253, 0 :: v_dual_add_nc_u32 v14, s3, v4
	...
	v_dual_mov_b32 v191, 0 :: v_dual_add_nc_u32 v0, 0, v2
	...
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v0, 0, v6
	s_mov_b32 s8, s4
	s_mov_b32 s9, s4
	...
	v_dual_mov_b32 v173, 0 :: v_dual_add_nc_u32 v0, 0, v10
	...
	v_dual_mov_b32 v90, 0 :: v_dual_mov_b32 v1, s5
	v_dual_mov_b32 v146, 0 :: v_dual_mov_b32 v3, s7
	v_dual_mov_b32 v88, 0 :: v_dual_mov_b32 v5, s9
	v_dual_mov_b32 v144, 0 :: v_dual_mov_b32 v7, s11
	v_mov_b32_e32 v84, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	scratch_store_b32 off, v210, off offset:624
	...
	v_dual_mov_b32 v99, v51 :: v_dual_mov_b32 v100, v52
	...
	buffer_load_u16 v210, v1, s[16:19], 0 offen offset:12
	...
	buffer_load_u16 v211, v6, s[16:19], 0 offen offset:60
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v129, v194, v4 :: v_dual_lshlrev_b32 v4, 16, v210
	scratch_load_b32 v210, off, off offset:624 ; 4-byte Folded Reload
	...
	scratch_load_b32 v165, off, off offset:364
	scratch_load_b32 v167, off, off offset:380
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v204, v7, v4
	.loc	1 209 29 is_stmt 1              ; generate_amdgcn.py:209:29
	v_cvt_f32_i32_e32 v4, v135
	.loc	1 208 27                        ; generate_amdgcn.py:208:27
	v_lshlrev_b32_e32 v120, 16, v141
	scratch_load_b32 v141, off, off offset:220 ; 4-byte Folded Reload
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_mul_f32_e32 v135, v194, v4
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(7)
	v_fmac_f32_e32 v210, v6, v5
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v118, v194, v5 :: v_dual_lshlrev_b32 v119, 16, v163
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v6, v194, v6 :: v_dual_lshlrev_b32 v5, 16, v179
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	v_dual_mul_f32 v7, v194, v7 :: v_dual_lshlrev_b32 v4, 16, v138
	v_mov_b32_e32 v11, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v10, v9 :: v_dual_fmac_f32 v33, v6, v5
	v_dual_mov_b32 v9, v8 :: v_dual_fmac_f32 v34, v7, v4
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_mul_f32_e32 v8, v194, v5
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_cvt_f32_i32_e32 v5, v9
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v121, v194, v4 :: v_dual_lshlrev_b32 v136, 16, v171
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v4, 16, v164
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v6, v194, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v5, v194, v5
	.loc	1 208 27                        ; generate_amdgcn.py:208:27
	v_lshlrev_b32_e32 v7, 16, v172
	s_clause 0x3                            ; 16-byte Folded Reload
	...
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v125, v194, v0 :: v_dual_lshlrev_b32 v0, 16, v246
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v4, v194, v4
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	v_dual_mul_f32 v127, v194, v0 :: v_dual_lshlrev_b32 v124, 16, v249
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v184, v194, v2 :: v_dual_fmac_f32 v189, v4, v0
	v_cvt_f32_i32_e32 v0, v105
	v_dual_mul_f32 v105, v194, v0 :: v_dual_lshlrev_b32 v2, 16, v209
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v3, v194, v3 :: v_dual_lshlrev_b32 v2, 16, v245
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v2, v194, v2 :: v_dual_fmac_f32 v187, v3, v0
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	v_lshlrev_b32_e32 v39, 16, v158
	scratch_store_b32 off, v17, off offset:172 ; 4-byte Folded Spill
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v86, v194, v1 :: v_dual_lshlrev_b32 v1, 16, v234
	scratch_store_b32 off, v18, off offset:176 ; 4-byte Folded Spill
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v2, v194, v2
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v154, off, off offset:316
	scratch_load_b32 v158, off, off offset:616
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v91, v194, v0 :: v_dual_lshlrev_b32 v0, 16, v197
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v3, v194, v3
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v3, v194, v3 :: v_dual_lshlrev_b32 v90, 16, v202
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	v_cvt_f32_i32_e32 v3, v10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v3, v194, v3 :: v_dual_lshlrev_b32 v92, 16, v240
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v73, v194, v0 :: v_dual_lshlrev_b32 v0, 16, v231
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v3, v194, v3
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v75, v194, v0 :: v_dual_lshlrev_b32 v96, 16, v222
	v_dual_mul_f32 v94, v194, v1 :: v_dual_lshlrev_b32 v1, 16, v236
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v0, 16, v227
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v3, v194, v3
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v2, v194, v2 :: v_dual_fmac_f32 v169, v3, v0
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v3, v194, v3 :: v_dual_lshlrev_b32 v76, 16, v228
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	v_cvt_f32_i32_e32 v3, v12
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v57, v194, v0 :: v_dual_lshlrev_b32 v80, 16, v149
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v2, v194, v2
	s_delay_alu instid0(VALU_DEP_3)
	...
	scratch_load_b32 v151, off, off offset:296
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v3, v194, v3
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_mul_f32_e32 v38, v194, v1
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v2, v194, v2 :: v_dual_lshlrev_b32 v1, 16, v161
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v2, v194, v2 :: v_dual_lshlrev_b32 v1, 16, v21
	.loc	1 208 27                        ; generate_amdgcn.py:208:27
	v_lshlrev_b32_e32 v21, 16, v45
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_mul_f32_e32 v45, v194, v0
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v3, v194, v3 :: v_dual_lshlrev_b32 v0, 16, v24
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v2, v194, v2 :: v_dual_lshlrev_b32 v23, 16, v47
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	.loc	1 209 17                        ; generate_amdgcn.py:209:17
	s_waitcnt vmcnt(10)
	v_dual_fmac_f32 v98, v63, v40 :: v_dual_fmac_f32 v97, v18, v17
	scratch_load_b32 v17, off, off offset:672 ; 4-byte Folded Reload
	s_waitcnt vmcnt(9)
	v_dual_fmac_f32 v100, v61, v60 :: v_dual_fmac_f32 v99, v62, v39
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	s_waitcnt vmcnt(8)
	v_cvt_f32_i32_e32 v3, v10
	v_cvt_f32_i32_e32 v2, v9
	...
	.loc	1 209 17                        ; generate_amdgcn.py:209:17
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v101, v38, v37 :: v_dual_lshlrev_b32 v0, 16, v0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v144, v3, v0
	.loc	1 208 27                        ; generate_amdgcn.py:208:27
	...
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v133, v184, v183 :: v_dual_fmac_f32 v132, v125, v124
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v125, off, off offset:516
	scratch_load_b32 v124, off, off offset:512
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v125, v86, v85 :: v_dual_lshlrev_b32 v0, 16, v0
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	...
	v_dual_fmac_f32 v119, v91, v90 :: v_dual_lshlrev_b32 v16, 16, v200
	...
	v_dual_fmac_f32 v102, v36, v35 :: v_dual_fmac_f32 v85, v14, v13
	s_waitcnt vmcnt(8)
	...
	s_waitcnt vmcnt(6)
	v_dual_fmac_f32 v135, v6, v5 :: v_dual_fmac_f32 v120, v89, v112
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v112, off, off offset:424
	scratch_load_b32 v89, off, off offset:248
	s_waitcnt vmcnt(6)
	v_dual_fmac_f32 v90, v46, v23 :: v_dual_fmac_f32 v91, v47, v24
	s_waitcnt vmcnt(4)
	...
	.loc	1 209 17 is_stmt 0              ; generate_amdgcn.py:209:17
	v_dual_fmac_f32 v155, v8, v7 :: v_dual_fmac_f32 v94, v43, v42
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	s_waitcnt vmcnt(5)
	v_dual_fmac_f32 v0, v105, v128 :: v_dual_fmac_f32 v109, v54, v53
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v108, v77, v76 :: v_dual_fmac_f32 v127, v84, v83
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	s_waitcnt vmcnt(5)
	v_dual_fmac_f32 v92, v22, v21 :: v_dual_fmac_f32 v107, v79, v56
	s_waitcnt vmcnt(4)
	v_fmac_f32_e32 v106, v78, v55
	s_waitcnt vmcnt(3)
...
.LBB0_4:                                ; %._crit_edge
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 211 26                        ; generate_amdgcn.py:211:26
	v_dual_mul_f32 v72, v63, v68 :: v_dual_fmac_f32 v67, v70, v67
	.loc	1 211 19                        ; generate_amdgcn.py:211:19
	v_mul_f32_e32 v61, v210, v64
	.loc	1 211 44                        ; generate_amdgcn.py:211:44
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 211 19                        ; generate_amdgcn.py:211:19
	v_dual_mul_f32 v12, v213, v12 :: v_dual_and_b32 v71, 1, v71
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v3.l, v12.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 944
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 944
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.kd
