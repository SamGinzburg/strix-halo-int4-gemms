...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_clause 0x1
	buffer_load_b64 v[63:64], v40, s[20:23], 0 offen offset:128
	buffer_load_b64 v[65:66], v41, s[20:23], 0 offen offset:128
...
; %bb.2:                                ; %.peel.next
	...
	v_add3_u32 v44, v44, v33, 0x100
	s_add_i32 s2, s3, -2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v33, v47, v33, 0x100
	v_add3_u32 v45, v48, v46, 0x100
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm32_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 95
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm32_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm32_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 32
