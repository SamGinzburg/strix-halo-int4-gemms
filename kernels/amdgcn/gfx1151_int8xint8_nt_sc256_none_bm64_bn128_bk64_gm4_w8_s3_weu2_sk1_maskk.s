	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	s_mul_i32 s3, s30, s14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s2, -1, 0
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_mad_u64_u32 v[4:5], null, s33, s14, v[3:4]
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v8, 0x80000000, v10 :: v_dual_cndmask_b32 v7, 0x80000000, v9
	s_clause 0x1
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[38:41], v7, s[16:19], 0 offen
	buffer_load_b128 v[45:48], v8, s[16:19], 0 offen
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_add_nc_u32_e32 v74, s5, v73
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v75, s5, v72
	...
	v_add_lshl_u32 v79, v55, s0, 1
	v_add_lshl_u32 v80, v54, s0, 1
	v_add_lshl_u32 v81, v53, s0, 1
	v_add_lshl_u32 v82, v52, s0, 1
	v_add_lshl_u32 v83, v51, s0, 1
	v_add_lshl_u32 v84, v50, s0, 1
	v_add_lshl_u32 v85, v49, s0, 1
	v_add_lshl_u32 v86, v48, s0, 1
	v_add_lshl_u32 v87, v47, s0, 1
	v_add_lshl_u32 v88, v45, s0, 1
	v_add_lshl_u32 v89, v46, s0, 1
	v_add_lshl_u32 v90, v17, s0, 1
	v_add_lshl_u32 v91, v18, s0, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_clause 0x1
	buffer_load_u16 v174, v75, s[36:39], 0 offen
	buffer_load_u16 v175, v76, s[36:39], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0xf
	buffer_load_u16 v176, v77, s[40:43], 0 offen
	buffer_load_u16 v177, v74, s[40:43], 0 offen
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v143, v126, v118 :: v_dual_add_nc_u32 v192, s6, v69
	v_dual_mul_f32 v145, v128, v118 :: v_dual_lshlrev_b32 v120, 16, v176
	v_mul_f32_e32 v126, v119, v126
	v_mul_f32_e32 v138, v123, v118
	v_dual_mul_f32 v133, v119, v133 :: v_dual_lshlrev_b32 v134, 16, v190
	v_dual_mul_f32 v147, v130, v118 :: v_dual_lshlrev_b32 v124, 16, v180
	v_dual_mul_f32 v130, v119, v130 :: v_dual_lshlrev_b32 v129, 16, v185
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v122, 16, v178
	v_lshlrev_b32_e32 v125, 16, v181
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v137, v120, v118 :: v_dual_mul_f32 v120, v119, v120
	v_mul_f32_e32 v123, v119, v123
	v_dual_mul_f32 v141, v124, v118 :: v_dual_mul_f32 v124, v119, v124
	v_dual_mul_f32 v144, v129, v118 :: v_dual_add_nc_u32 v193, s35, v69
	...
	v_dual_mul_f32 v150, v135, v118 :: v_dual_fmac_f32 v37, v141, v79
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v39, v138, v76
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v118, v134, v118
	v_mul_f32_e32 v134, v119, v134
	v_mul_f32_e32 v119, v119, v135
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v19, v136, v74 :: v_dual_fmac_f32 v42, v137, v75
	v_dual_fmac_f32 v41, v139, v77 :: v_dual_fmac_f32 v16, v148, v86
	v_dual_fmac_f32 v35, v140, v78 :: v_dual_fmac_f32 v10, v118, v89
	v_dual_fmac_f32 v33, v143, v81 :: v_dual_fmac_f32 v40, v121, v90
	v_dual_fmac_f32 v27, v144, v82 :: v_dual_fmac_f32 v36, v123, v92
	v_dual_fmac_f32 v29, v145, v83 :: v_dual_fmac_f32 v34, v122, v93
	v_dual_fmac_f32 v23, v146, v84 :: v_dual_fmac_f32 v38, v120, v91
	v_dual_fmac_f32 v25, v147, v85 :: v_dual_fmac_f32 v32, v125, v94
	v_dual_fmac_f32 v15, v149, v87 :: v_dual_fmac_f32 v28, v127, v96
	v_dual_fmac_f32 v11, v150, v88 :: v_dual_fmac_f32 v30, v124, v95
	v_dual_fmac_f32 v26, v126, v97 :: v_dual_fmac_f32 v21, v131, v100
	v_dual_fmac_f32 v24, v129, v98 :: v_dual_fmac_f32 v13, v132, v103
	v_dual_fmac_f32 v22, v128, v99 :: v_dual_fmac_f32 v9, v134, v105
	v_fmac_f32_e32 v20, v130, v101
	v_fmac_f32_e32 v14, v133, v102
	v_fmac_f32_e32 v12, v119, v104
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.9:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v103, s11 :: v_dual_add_nc_u32 v84, s26, v61
	v_dual_mov_b32 v96, s4 :: v_dual_add_nc_u32 v85, s26, v62
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v98, s6 :: v_dual_add_nc_u32 v83, s26, v64
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v97, s5 :: v_dual_add_nc_u32 v84, s26, v63
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_10:
	...
	s_cmp_lt_i32 s0, s1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v70, v59, s0, 1
	v_add_lshl_u32 v71, v60, s0, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	...
	v_add_lshl_u32 v99, v53, s0, 1
	v_add_lshl_u32 v100, v52, s0, 1
	v_add_lshl_u32 v101, v51, s0, 1
	v_dual_cndmask_b32 v70, 0x80000000, v70 :: v_dual_cndmask_b32 v97, 0x80000000, v97
	v_add_lshl_u32 v102, v50, s0, 1
	s_and_b32 s13, s13, 0xffff
	v_add_lshl_u32 v103, v49, s0, 1
	...
	v_add_lshl_u32 v97, v47, s0, 1
	v_add_lshl_u32 v98, v45, s0, 1
	v_dual_cndmask_b32 v70, 0x80000000, v102 :: v_dual_cndmask_b32 v71, 0x80000000, v103
	v_add_lshl_u32 v99, v46, s0, 1
	v_add_lshl_u32 v100, v17, s0, 1
	v_add_lshl_u32 v101, v18, s0, 1
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 203
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
