...
.Ltmp2:
	...
	v_add_nc_u32_e32 v155, 32, v151
	v_add_nc_u32_e32 v156, 48, v151
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v172, 0 :: v_dual_and_b32 v11, 24, v7
	v_dual_mov_b32 v173, 0 :: v_dual_and_b32 v10, 24, v8
	v_dual_mov_b32 v170, 0 :: v_dual_and_b32 v7, 0x70, v7
	...
	v_lshl_or_b32 v186, v1, 5, v10
	v_add3_u32 v187, 0, v1, v7
	.loc	1 409 20                        ; ragged.py:409:20
	s_waitcnt lgkmcnt(0)
	s_add_u32 s0, s8, s30
	s_addc_u32 s1, s9, s31
	v_dual_mov_b32 v166, 0 :: v_dual_lshlrev_b32 v1, 2, v152
	...
	v_dual_mov_b32 v164, 0 :: v_dual_and_b32 v7, 32, v9
	v_dual_mov_b32 v162, 0 :: v_dual_add_nc_u32 v5, s20, v5
	.loc	1 415 21                        ; ragged.py:415:21
	...
	v_lshrrev_b32_e32 v179, 4, v152
	v_dual_mov_b32 v174, 0 :: v_dual_and_b32 v185, 24, v6
	v_xor_b32_e32 v4, 8, v186
	v_xor_b32_e32 v6, 16, v186
	v_xor_b32_e32 v10, 24, v186
	.loc	1 477 39                        ; ragged.py:477:39
	s_mul_i32 s9, s34, s33
	v_dual_mov_b32 v168, 0 :: v_dual_lshlrev_b32 v11, 4, v0
	v_dual_mov_b32 v171, 0 :: v_dual_and_b32 v8, 28, v8
	v_add3_u32 v1, 0, v1, v7
	v_dual_mov_b32 v160, 0 :: v_dual_lshlrev_b32 v7, 1, v152
	.loc	1 494 25                        ; ragged.py:494:25
	v_mul_lo_u32 v180, v151, s28
	v_mul_lo_u32 v181, v154, s28
	v_mul_lo_u32 v182, v155, s28
	v_mul_lo_u32 v183, v156, s28
	v_mul_lo_u32 v188, v5, s34
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[97:98], null, s9, s8, v[2:3]
	.loc	1 416 20                        ; ragged.py:416:20
	v_cmp_gt_i32_e64 s0, s33, v2
	v_cmp_gt_i32_e64 s1, s33, v178
	.loc	1 461 28                        ; ragged.py:461:28
	v_or_b32_e32 v184, 16, v179
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v189, 0, v3
	v_dual_mov_b32 v169, 0 :: v_dual_add_nc_u32 v190, 0, v4
	v_dual_mov_b32 v150, 0 :: v_dual_add_nc_u32 v191, 0, v6
	v_dual_mov_b32 v167, 0 :: v_dual_add_nc_u32 v192, 0, v10
	v_dual_mov_b32 v148, 0 :: v_dual_add_nc_u32 v193, 0, v11
	v_dual_mov_b32 v165, 0 :: v_dual_add_nc_u32 v194, v1, v8
	v_dual_mov_b32 v146, 0 :: v_dual_add_nc_u32 v195, 0, v7
	v_dual_mov_b32 v163, 0 :: v_dual_mov_b32 v144, 0
	v_dual_mov_b32 v161, 0 :: v_dual_mov_b32 v142, 0
	v_dual_mov_b32 v159, 0 :: v_dual_mov_b32 v140, 0
...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v189, v[65:66]
	v_add_nc_u32_e32 v65, 0, v186
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[81:84], v65 offset1:1
	ds_load_2addr_stride64_b64 v[77:80], v65 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[85:88], v190 offset1:1
	ds_load_2addr_stride64_b64 v[73:76], v190 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[89:92], v191 offset1:1
	ds_load_2addr_stride64_b64 v[69:72], v191 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[93:96], v192 offset1:1
	ds_load_2addr_stride64_b64 v[65:68], v192 offset0:2 offset1:3
	.loc	1 479 34                        ; ragged.py:479:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b128 v193, v[98:101]
	s_waitcnt vmcnt(0)
	ds_store_b128 v193, v[102:105] offset:4096
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 480 31                        ; ragged.py:480:31
	ds_load_u8 v98, v187 offset:1280
	ds_load_u8 v99, v187 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v98, v99, v98, 0xc0c0004
	ds_load_u8 v99, v187 offset:1792
	ds_load_u8 v100, v187 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v99, v100, v99, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v99, v99, 16, v98
	ds_load_u8 v98, v187 offset:256
	ds_load_u8 v100, v187
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v98, v100, v98, 0xc0c0004
	ds_load_u8 v100, v187 offset:768
	ds_load_u8 v101, v187 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v100, v101, v100, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v98, v100, 16, v98
	ds_load_u8 v100, v187 offset:3328
	ds_load_u8 v101, v187 offset:3072
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v100, v101, v100, 0xc0c0004
	ds_load_u8 v101, v187 offset:3840
	ds_load_u8 v102, v187 offset:3584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v101, v101, 16, v100
	ds_load_u8 v100, v187 offset:2304
	...
	ds_load_u8 v102, v187 offset:5376
	ds_load_u8 v103, v187 offset:5120
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v103, v102, 0xc0c0004
	ds_load_u8 v103, v187 offset:5888
	ds_load_u8 v104, v187 offset:5632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v103, v104, v103, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v103, v103, 16, v102
	ds_load_u8 v102, v187 offset:4352
	ds_load_u8 v104, v187 offset:4096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v104, v102, 0xc0c0004
	ds_load_u8 v104, v187 offset:4864
	ds_load_u8 v105, v187 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v104, v105, v104, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v102, v104, 16, v102
	ds_load_u8 v104, v187 offset:7424
	ds_load_u8 v105, v187 offset:7168
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v104, v105, v104, 0xc0c0004
	ds_load_u8 v105, v187 offset:7936
	ds_load_u8 v106, v187 offset:7680
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v105, v105, 16, v104
	ds_load_u8 v104, v187 offset:6400
	ds_load_u8 v106, v187 offset:6144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v104, v106, v104, 0xc0c0004
	ds_load_u8 v106, v187 offset:6912
	ds_load_u8 v107, v187 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v104, v106, 16, v104
	ds_load_u8 v106, v187 offset:1408
	ds_load_u8 v107, v187 offset:1152
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	ds_load_u8 v107, v187 offset:1920
	ds_load_u8 v196, v187 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v196, v107, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v107, v107, 16, v106
	ds_load_u8 v106, v187 offset:384
	ds_load_u8 v196, v187 offset:128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v196, v106, 0xc0c0004
	ds_load_u8 v196, v187 offset:896
	ds_load_u8 v197, v187 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v196, v197, v196, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v106, v196, 16, v106
	v_wmma_i32_16x16x16_iu4 v[9:16], v[106:107], v[81:82], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v81, v187 offset:3456
	ds_load_u8 v82, v187 offset:3200
	...
	ds_load_u8 v82, v187 offset:3968
	ds_load_u8 v196, v187 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v82, v196, v82, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v82, v82, 16, v81
	ds_load_u8 v81, v187 offset:2432
	ds_load_u8 v196, v187 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v81, v196, v81, 0xc0c0004
	ds_load_u8 v196, v187 offset:2944
	ds_load_u8 v197, v187 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v196, v197, v196, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v81, v196, 16, v81
	v_wmma_i32_16x16x16_iu4 v[9:16], v[81:82], v[85:86], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v85, v187 offset:5504
	ds_load_u8 v86, v187 offset:5248
	...
	ds_load_u8 v86, v187 offset:6016
	ds_load_u8 v196, v187 offset:5760
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v86, v196, v86, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v86, v86, 16, v85
	ds_load_u8 v85, v187 offset:4480
	ds_load_u8 v196, v187 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v85, v196, v85, 0xc0c0004
	ds_load_u8 v196, v187 offset:4992
	ds_load_u8 v197, v187 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v196, v197, v196, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v85, v196, 16, v85
	v_wmma_i32_16x16x16_iu4 v[9:16], v[85:86], v[89:90], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v89, v187 offset:7552
	ds_load_u8 v90, v187 offset:7296
	...
	ds_load_u8 v90, v187 offset:8064
	ds_load_u8 v196, v187 offset:7808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v196, v90, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v90, v90, 16, v89
	ds_load_u8 v89, v187 offset:6528
	ds_load_u8 v196, v187 offset:6272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v196, v89, 0xc0c0004
	ds_load_u8 v196, v187 offset:7040
	ds_load_u8 v197, v187 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v196, v197, v196, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v89, v196, 16, v89
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_add_lshl_u32 v65, s7, v180, 1
	.loc	1 501 25                        ; ragged.py:501:25
	s_add_i32 s8, s7, s6
	.loc	1 493 40                        ; ragged.py:493:40
	v_add_lshl_u32 v66, s7, v181, 1
	v_add_lshl_u32 v67, s7, v182, 1
	.loc	1 501 25                        ; ragged.py:501:25
	s_mul_i32 s8, s8, s33
	.loc	1 493 40                        ; ragged.py:493:40
	v_add_lshl_u32 v68, s7, v183, 1
	.loc	1 500 40                        ; ragged.py:500:40
	v_add_lshl_u32 v69, v178, s8, 1
	.loc	1 493 40                        ; ragged.py:493:40
	...
	v_dual_fmac_f32 v158, v19, v3 :: v_dual_fmac_f32 v157, v20, v4
	v_dual_fmac_f32 v153, v21, v5 :: v_dual_fmac_f32 v150, v22, v6
	v_dual_fmac_f32 v149, v23, v7 :: v_dual_fmac_f32 v148, v24, v8
	v_dual_fmac_f32 v147, v25, v9 :: v_dual_fmac_f32 v146, v26, v10
	v_dual_fmac_f32 v145, v27, v11 :: v_dual_fmac_f32 v144, v28, v12
	v_dual_fmac_f32 v143, v29, v13 :: v_dual_fmac_f32 v142, v30, v14
	v_dual_fmac_f32 v141, v31, v15 :: v_dual_fmac_f32 v140, v32, v16
	v_dual_fmac_f32 v139, v33, v1 :: v_dual_fmac_f32 v138, v34, v2
	v_dual_fmac_f32 v137, v35, v3 :: v_dual_fmac_f32 v136, v36, v4
	v_dual_fmac_f32 v135, v37, v5 :: v_dual_fmac_f32 v134, v38, v6
	v_dual_fmac_f32 v133, v39, v7 :: v_dual_fmac_f32 v132, v40, v8
	v_dual_fmac_f32 v131, v41, v9 :: v_dual_fmac_f32 v130, v42, v10
	v_dual_fmac_f32 v129, v43, v11 :: v_dual_fmac_f32 v128, v44, v12
	v_dual_fmac_f32 v127, v45, v13 :: v_dual_fmac_f32 v126, v46, v14
	v_dual_fmac_f32 v125, v47, v15 :: v_dual_fmac_f32 v124, v48, v16
	v_dual_fmac_f32 v123, v49, v1 :: v_dual_fmac_f32 v122, v50, v2
	v_dual_fmac_f32 v121, v51, v3 :: v_dual_fmac_f32 v120, v52, v4
	v_dual_fmac_f32 v119, v53, v5 :: v_dual_fmac_f32 v118, v54, v6
	v_dual_fmac_f32 v117, v55, v7 :: v_dual_fmac_f32 v116, v56, v8
	v_dual_fmac_f32 v115, v57, v9 :: v_dual_fmac_f32 v114, v58, v10
	v_dual_fmac_f32 v113, v59, v11 :: v_dual_fmac_f32 v112, v60, v12
	v_dual_fmac_f32 v111, v61, v13 :: v_dual_fmac_f32 v110, v62, v14
	v_dual_fmac_f32 v109, v63, v15 :: v_dual_fmac_f32 v108, v64, v16
	.loc	1 464 19                        ; ragged.py:464:19
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add3_u32 v18, v157, v18, 0x7fff
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 198
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 35
