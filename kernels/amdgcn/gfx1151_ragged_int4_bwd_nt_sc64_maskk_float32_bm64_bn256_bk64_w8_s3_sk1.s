...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v58, v58, v0 :: v_dual_add_nc_u32 v67, 32, v67
	v_dual_mul_f32 v41, v41, v1 :: v_dual_add_nc_u32 v68, 32, v68
	v_dual_mul_f32 v60, v60, v0 :: v_dual_add_nc_u32 v69, 32, v69
	v_dual_mul_f32 v57, v57, v0 :: v_dual_add_nc_u32 v70, 32, v70
	v_dual_mul_f32 v62, v62, v0 :: v_dual_add_nc_u32 v71, 32, v71
	v_dual_mul_f32 v43, v43, v1 :: v_dual_add_nc_u32 v72, 32, v72
	v_dual_mul_f32 v64, v64, v0 :: v_dual_add_nc_u32 v73, 32, v73
	v_dual_mul_f32 v59, v59, v0 :: v_dual_add_nc_u32 v74, 32, v74
	v_dual_mul_f32 v50, v50, v0 :: v_dual_add_nc_u32 v75, 32, v75
	v_dual_mul_f32 v45, v45, v1 :: v_dual_add_nc_u32 v76, 32, v76
	v_dual_mul_f32 v52, v52, v0 :: v_dual_add_nc_u32 v77, 32, v77
	v_dual_mul_f32 v61, v61, v0 :: v_dual_add_nc_u32 v78, 32, v78
	v_dual_mul_f32 v54, v54, v0 :: v_dual_add_nc_u32 v79, 32, v79
	v_dual_mul_f32 v47, v47, v1 :: v_dual_add_nc_u32 v80, 32, v80
	.loc	1 1115 19                       ; ragged.py:1115:19
	v_add_nc_u32_e32 v81, 32, v81
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v63, v63, v0 :: v_dual_add_nc_u32 v82, 32, v82
	v_dual_mul_f32 v42, v42, v1 :: v_dual_add_nc_u32 v83, 32, v83
	v_dual_mul_f32 v33, v33, v1 :: v_dual_add_nc_u32 v84, 32, v84
	v_dual_mul_f32 v26, v26, v2 :: v_dual_add_nc_u32 v85, 32, v85
	v_dual_mul_f32 v49, v49, v0 :: v_dual_add_nc_u32 v86, 32, v86
	v_dual_mul_f32 v44, v44, v1 :: v_dual_add_nc_u32 v87, 32, v87
	v_dual_mul_f32 v35, v35, v1 :: v_dual_add_nc_u32 v88, 32, v88
	v_dual_mul_f32 v28, v28, v2 :: v_dual_add_nc_u32 v89, 32, v89
	v_dual_mul_f32 v51, v51, v0 :: v_dual_add_nc_u32 v90, 32, v90
	v_dual_mul_f32 v46, v46, v1 :: v_dual_add_nc_u32 v91, 32, v91
	v_dual_mul_f32 v37, v37, v1 :: v_dual_add_nc_u32 v92, 32, v92
	v_dual_mul_f32 v30, v30, v2 :: v_dual_add_nc_u32 v93, 32, v93
	v_dual_mul_f32 v53, v53, v0 :: v_dual_add_nc_u32 v94, 32, v94
	v_dual_mul_f32 v48, v48, v1 :: v_dual_add_nc_u32 v95, 32, v95
	v_dual_mul_f32 v39, v39, v1 :: v_dual_add_nc_u32 v96, 32, v96
	v_dual_mul_f32 v32, v32, v2 :: v_dual_add_nc_u32 v97, 32, v97
	v_dual_mul_f32 v55, v55, v0 :: v_dual_add_nc_u32 v98, 32, v98
	v_dual_mul_f32 v34, v34, v1 :: v_dual_add_nc_u32 v99, 32, v99
	v_dual_mul_f32 v25, v25, v2 :: v_dual_add_nc_u32 v100, 32, v100
	v_dual_mul_f32 v18, v18, v2 :: v_dual_add_nc_u32 v101, 32, v101
	v_dual_mul_f32 v36, v36, v1 :: v_dual_add_nc_u32 v103, 32, v103
	v_dual_mul_f32 v27, v27, v2 :: v_dual_add_nc_u32 v104, 32, v104
	v_dual_mul_f32 v20, v20, v2 :: v_dual_add_nc_u32 v105, 32, v105
	v_mul_f32_e32 v0, v56, v0
	v_dual_mul_f32 v40, v40, v1 :: v_dual_mul_f32 v31, v31, v2
	v_mul_f32_e32 v24, v24, v2
	v_dual_mul_f32 v109, v11, v107 :: v_dual_add_nc_u32 v102, 32, v102
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 81
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.private_seg_size, 256
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.uses_flat_scratch, 1
