...
.Ltmp21:
	...
	v_dual_mov_b32 v175, 0 :: v_dual_add_nc_u32 v144, 0, v3
	v_dual_mov_b32 v173, 0 :: v_dual_add_nc_u32 v146, 0, v4
	v_dual_mov_b32 v171, 0 :: v_dual_add_nc_u32 v148, 0, v5
	v_dual_mov_b32 v169, 0 :: v_dual_add_nc_u32 v150, 0, v6
	v_dual_mov_b32 v167, 0 :: v_dual_add_nc_u32 v152, 0, v7
	v_mov_b32_e32 v1, s12
	v_dual_mov_b32 v4, s15 :: v_dual_add_nc_u32 v95, 0, v94
	v_dual_mov_b32 v165, 0 :: v_dual_add_nc_u32 v154, 0, v9
	v_dual_mov_b32 v174, 0 :: v_dual_add_nc_u32 v155, 0, v10
	v_dual_mov_b32 v161, 0 :: v_dual_add_nc_u32 v156, 0, v11
	v_dual_mov_b32 v172, 0 :: v_dual_add_nc_u32 v157, 0, v13
	v_dual_mov_b32 v170, 0 :: v_dual_add_nc_u32 v163, 0, v14
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v144, v177 offset:8192
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	s_waitcnt vmcnt(0)
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v164, v240, v207 :: v_dual_lshlrev_b32 v213, 16, v81
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	...
	v_dual_mul_f32 v30, v43, v221 :: v_dual_fmac_f32 v167, v237, v210
	...
	v_dual_mul_f32 v26, v47, v221 :: v_dual_fmac_f32 v159, v244, v203
	v_mul_f32_e32 v25, v48, v221
	v_dual_mul_f32 v24, v222, v221 :: v_dual_fmac_f32 v165, v239, v208
	v_mul_f32_e32 v23, v223, v221
	v_dual_mul_f32 v22, v224, v221 :: v_dual_fmac_f32 v151, v247, v200
	v_mul_f32_e32 v21, v225, v221
	v_dual_mul_f32 v20, v226, v221 :: v_dual_fmac_f32 v149, v248, v199
	v_dual_mul_f32 v18, v63, v221 :: v_dual_fmac_f32 v147, v249, v198
	...
	v_fmac_f32_e32 v162, v241, v206
	v_dual_fmac_f32 v166, v238, v209 :: v_dual_fmac_f32 v115, v27, v91
	v_dual_fmac_f32 v160, v243, v204 :: v_dual_fmac_f32 v161, v242, v205
	v_dual_fmac_f32 v158, v245, v202 :: v_dual_fmac_f32 v153, v246, v201
	v_dual_fmac_f32 v142, v252, v195 :: v_dual_fmac_f32 v145, v250, v197
