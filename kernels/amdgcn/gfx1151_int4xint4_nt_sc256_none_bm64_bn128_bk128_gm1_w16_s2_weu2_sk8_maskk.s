	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	v_dual_mov_b32 v11, 0 :: v_dual_add_nc_u32 v34, 0, v8
	s_waitcnt vmcnt(2)
...
; %bb.1:                                ; %.lr.ph
	...
	v_xor_b32_e32 v24, 24, v14
	v_xor_b32_e32 v25, 32, v14
	v_xor_b32_e32 v26, 40, v14
	v_xor_b32_e32 v27, 48, v14
	v_xor_b32_e32 v28, 56, v14
	...
	v_dual_mov_b32 v1, s12 :: v_dual_lshlrev_b32 v38, 1, v30
	v_mov_b32_e32 v5, s16
	v_dual_mov_b32 v6, s17 :: v_dual_lshlrev_b32 v39, 1, v39
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v46, 0, v13
	...
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v53, 0, v23
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v54, 0, v24
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v55, 0, v25
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v56, 0, v26
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v57, 0, v27
	v_dual_mov_b32 v15, 0 :: v_dual_add_nc_u32 v58, 0, v28
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v30, v76, v79 :: v_dual_lshlrev_b32 v89, 16, v89
	v_dual_fmac_f32 v28, v78, v81 :: v_dual_lshlrev_b32 v83, 16, v83
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v84, 16, v84
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v71, v71, v88 :: v_dual_fmac_f32 v26, v64, v89
	v_dual_mul_f32 v73, v73, v88 :: v_dual_fmac_f32 v22, v68, v79
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v29, v77, v80 :: v_dual_fmac_f32 v20, v70, v81
	v_dual_fmac_f32 v27, v63, v82 :: v_dual_fmac_f32 v24, v66, v84
	v_fmac_f32_e32 v25, v65, v83
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v23, v67, v90 :: v_dual_fmac_f32 v14, v73, v83
	v_fmac_f32_e32 v21, v69, v80
	v_fmac_f32_e32 v19, v71, v82
...
; %bb.7:
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_and_or_b32 v67, 0x438, v31, v32
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	s_mov_b32 s12, 0
...
.LBB0_8:
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	v_add_lshl_u32 v18, s0, v31, 1
	s_mov_b32 s10, 0x7ffffffe
	v_cndmask_b32_e64 v17, 0x80000000, v17, s2
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v32, 4, v16
	v_cndmask_b32_e64 v31, 0x80000000, v16, s2
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	buffer_load_u16 v51, v31, s[20:23], 0 offen
	...
	v_lshrrev_b32_e32 v54, 1, v10
	.loc	1 98 32                         ; generate_amdgcn.py:98:32
	v_lshrrev_b32_e32 v31, 7, v0
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_and_b32_e32 v44, 0x840, v16
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v3, v3, v2 :: v_dual_lshlrev_b32 v12, 16, v47
	...
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v39, v40, v45 :: v_dual_lshlrev_b32 v50, 16, v52
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(2)
	...
	v_fma_f32 v12, v35, v12, v23
	v_fma_f32 v4, v4, v46, v30
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
	v_lshlrev_b64 v[17:18], 2, v[17:18]
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v5, v5, v47, v29
	v_fma_f32 v35, v36, v46, v22
	v_fma_f32 v7, v7, v50, v27
	v_fma_f32 v36, v37, v47, v21
	v_fma_f32 v43, v6, v49, v28
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_u32 v17, vcc_lo, s40, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v37, v38, v49, v20
	v_fma_f32 v38, v39, v50, v19
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_ci_u32_e64 v18, null, s41, v18, vcc_lo
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v33, v26
	v_fma_f32 v34, v34, v48, v25
	v_fma_f32 v45, v2, v51, v24
	v_fma_f32 v39, v40, v33, v15
	v_fma_f32 v40, v41, v48, v14
	v_fma_f32 v41, v42, v51, v13
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v2, v11, v3, s2
	v_cndmask_b32_e64 v3, v23, v12, s2
	v_cndmask_b32_e64 v4, v30, v4, s2
	v_cndmask_b32_e64 v6, v29, v5, s2
	v_cndmask_b32_e64 v5, v22, v35, s2
	v_cndmask_b32_e64 v27, v27, v7, s2
	v_cndmask_b32_e64 v7, v21, v36, s2
	v_cndmask_b32_e64 v11, v28, v43, s2
	v_cndmask_b32_e64 v12, v20, v37, s2
	v_cndmask_b32_e64 v28, v19, v38, s2
	v_cndmask_b32_e64 v29, v26, v8, s2
	v_cndmask_b32_e64 v25, v25, v34, s2
	v_cndmask_b32_e64 v33, v24, v45, s2
	v_cndmask_b32_e64 v30, v15, v39, s2
	v_cndmask_b32_e64 v26, v14, v40, s2
	v_cndmask_b32_e64 v34, v13, v41, s2
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_vgpr, 98
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.kd
