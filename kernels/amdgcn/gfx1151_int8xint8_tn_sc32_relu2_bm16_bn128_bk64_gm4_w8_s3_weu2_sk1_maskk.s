	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp26:
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	v_or_b32_e32 v23, s28, v11
	s_lshl_b32 s1, s17, 7
	s_mov_b32 s3, s0
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v3, 7, v0
	...
	v_or3_b32 v13, v1, v2, s24
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_or_b32_e32 v1, 32, v23
	v_or_b32_e32 v8, v2, v5
	v_mul_lo_u32 v5, s15, v23
	v_mov_b32_e32 v34, 0
	...
	v_add3_u32 v5, v5, s1, v6
	v_or_b32_e32 v19, 8, v13
	v_or_b32_e32 v20, 10, v13
	v_add3_u32 v2, v2, s1, v6
	v_mul_lo_u32 v6, s14, v23
	s_lshl_b32 s1, s2, 7
	s_mov_b32 s2, s0
	v_subrev_nc_u32_e32 v24, s1, v5
	v_subrev_nc_u32_e32 v23, s1, v2
	s_mov_b32 s1, s0
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_add3_u32 v25, v1, s16, v3
	v_add3_u32 v27, v6, s16, v3
	s_mov_b32 s16, s4
	s_mov_b32 s4, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v55, v22, s0, 1
	v_add_lshl_u32 v57, v13, s1, 1
	...
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	s_waitcnt vmcnt(3)
	ds_store_b16 v28, v45 offset:8192
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(2)
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v28, v46 offset:8704
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v29, v[41:44] offset:4096
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	buffer_load_u16 v86, v56, s[4:7], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0x7
	...
	ds_load_u8 v37, v12 offset:8400
	ds_load_u8 v38, v12 offset:8432
	ds_load_u8 v39, v12 offset:8416
	ds_load_u8 v40, v12 offset:8384
	ds_load_u8 v41, v12 offset:8336
	ds_load_u8 v42, v12 offset:8368
	ds_load_u8 v43, v12 offset:8352
	ds_load_u8 v44, v12 offset:8320
	ds_load_u8 v45, v12 offset:8272
	ds_load_u8 v46, v12 offset:8304
	ds_load_u8 v47, v12 offset:8288
	ds_load_u8 v48, v12 offset:8256
	ds_load_u8 v49, v12 offset:8192
	ds_load_u8 v50, v12 offset:8208
	ds_load_u8 v51, v12 offset:8224
	ds_load_u8 v52, v12 offset:8240
	ds_load_u8 v53, v14 offset:1664
	ds_load_u8 v54, v14 offset:1920
	ds_load_u8 v55, v14 offset:1792
	ds_load_u8 v56, v14 offset:1536
	ds_load_u8 v57, v14 offset:1152
	ds_load_u8 v58, v14 offset:1408
	ds_load_u8 v59, v14 offset:1280
	ds_load_u8 v60, v14 offset:1024
	ds_load_u8 v61, v14 offset:640
	ds_load_u8 v62, v14 offset:896
	ds_load_u8 v63, v14 offset:768
	ds_load_u8 v64, v14 offset:512
	ds_load_u8 v65, v14 offset:128
	ds_load_u8 v66, v14 offset:384
	ds_load_u8 v67, v14 offset:256
	ds_load_u8 v68, v14
	ds_load_u8 v69, v12 offset:8656
	ds_load_u8 v70, v12 offset:8688
	ds_load_u8 v71, v12 offset:8672
	ds_load_u8 v72, v12 offset:8640
	ds_load_u8 v73, v12 offset:8592
	ds_load_u8 v74, v12 offset:8624
	ds_load_u8 v75, v12 offset:8608
	ds_load_u8 v76, v12 offset:8576
	ds_load_u8 v95, v12 offset:8528
	ds_load_u8 v96, v12 offset:8560
	ds_load_u8 v97, v12 offset:8544
	ds_load_u8 v98, v12 offset:8512
	ds_load_u8 v99, v12 offset:8464
	ds_load_u8 v100, v12 offset:8496
	ds_load_u8 v101, v12 offset:8480
	ds_load_u8 v102, v12 offset:8448
	ds_load_u8 v103, v14 offset:3712
	ds_load_u8 v104, v14 offset:3968
	ds_load_u8 v105, v14 offset:3840
	ds_load_u8 v106, v14 offset:3584
	ds_load_u8 v107, v14 offset:3200
	ds_load_u8 v108, v14 offset:3456
	ds_load_u8 v109, v14 offset:3328
	ds_load_u8 v110, v14 offset:3072
	ds_load_u8 v111, v14 offset:2688
	ds_load_u8 v112, v14 offset:2944
	ds_load_u8 v113, v14 offset:2816
	ds_load_u8 v114, v14 offset:2560
	ds_load_u8 v115, v14 offset:2176
	ds_load_u8 v116, v14 offset:2432
	ds_load_u8 v117, v14 offset:2304
	ds_load_u8 v118, v14 offset:2048
	ds_load_u8 v119, v12 offset:8912
	ds_load_u8 v120, v12 offset:8944
	ds_load_u8 v121, v12 offset:8928
	ds_load_u8 v122, v12 offset:8896
	ds_load_u8 v123, v12 offset:8848
	ds_load_u8 v124, v12 offset:8880
	ds_load_u8 v125, v12 offset:8864
	ds_load_u8 v126, v12 offset:8832
	ds_load_u8 v127, v12 offset:8784
	ds_load_u8 v128, v12 offset:8816
	ds_load_u8 v129, v12 offset:8800
	ds_load_u8 v130, v12 offset:8768
	ds_load_u8 v131, v12 offset:8720
	ds_load_u8 v132, v12 offset:8752
	ds_load_u8 v133, v12 offset:8736
	ds_load_u8 v134, v12 offset:8704
	ds_load_u8 v135, v14 offset:5760
	ds_load_u8 v136, v14 offset:6016
	ds_load_u8 v137, v14 offset:5888
	ds_load_u8 v138, v14 offset:5632
	ds_load_u8 v139, v14 offset:5248
	ds_load_u8 v140, v14 offset:5504
	ds_load_u8 v141, v14 offset:5376
	ds_load_u8 v142, v14 offset:5120
	ds_load_u8 v143, v14 offset:4736
	ds_load_u8 v144, v14 offset:4992
	ds_load_u8 v145, v14 offset:4864
	ds_load_u8 v146, v14 offset:4608
	ds_load_u8 v147, v14 offset:4224
	ds_load_u8 v148, v14 offset:4480
	ds_load_u8 v149, v14 offset:4352
	ds_load_u8 v150, v14 offset:4096
	ds_load_u8 v151, v12 offset:9168
	ds_load_u8 v152, v12 offset:9200
	ds_load_u8 v153, v12 offset:9184
	ds_load_u8 v154, v12 offset:9152
	ds_load_u8 v155, v12 offset:9104
	ds_load_u8 v156, v12 offset:9136
	ds_load_u8 v157, v12 offset:9120
	ds_load_u8 v158, v12 offset:9088
	ds_load_u8 v159, v12 offset:9040
	ds_load_u8 v160, v12 offset:9072
	ds_load_u8 v161, v12 offset:9056
	ds_load_u8 v162, v12 offset:9024
	ds_load_u8 v163, v12 offset:8976
	ds_load_u8 v164, v12 offset:9008
	ds_load_u8 v165, v12 offset:8992
	ds_load_u8 v166, v12 offset:8960
	ds_load_u8 v167, v14 offset:7808
	ds_load_u8 v168, v14 offset:8064
	ds_load_u8 v169, v14 offset:7936
	ds_load_u8 v170, v14 offset:7680
	ds_load_u8 v171, v14 offset:7296
	ds_load_u8 v172, v14 offset:7552
	ds_load_u8 v173, v14 offset:7424
	ds_load_u8 v174, v14 offset:7168
	ds_load_u8 v175, v14 offset:6784
	ds_load_u8 v176, v14 offset:7040
	ds_load_u8 v177, v14 offset:6912
	ds_load_u8 v178, v14 offset:6656
	ds_load_u8 v179, v14 offset:6272
	ds_load_u8 v180, v14 offset:6528
	ds_load_u8 v181, v14 offset:6400
	ds_load_u8 v182, v14 offset:6144
	...
	v_dual_mul_f32 v48, v48, v62 :: v_dual_lshlrev_b32 v53, 16, v77
	v_dual_mul_f32 v39, v39, v53 :: v_dual_lshlrev_b32 v54, 16, v78
	v_dual_mul_f32 v41, v41, v53 :: v_dual_lshlrev_b32 v56, 16, v80
	v_dual_mul_f32 v40, v40, v53 :: v_dual_add_nc_u32 v27, s14, v27
	v_dual_mul_f32 v37, v37, v53 :: v_dual_add_nc_u32 v24, s29, v24
	v_dual_mul_f32 v42, v42, v53 :: v_dual_add_nc_u32 v23, s29, v23
	v_dual_mul_f32 v44, v44, v53 :: v_dual_lshlrev_b32 v55, 16, v79
	v_dual_mul_f32 v43, v43, v53 :: v_dual_lshlrev_b32 v58, 16, v82
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v26, v37, v54 :: v_dual_lshlrev_b32 v61, 16, v85
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v38, v38, v53 :: v_dual_fmac_f32 v35, v39, v56
	v_dual_mul_f32 v50, v50, v62 :: v_dual_lshlrev_b32 v57, 16, v81
	v_dual_mul_f32 v52, v52, v62 :: v_dual_lshlrev_b32 v59, 16, v83
	v_dual_mul_f32 v45, v45, v62 :: v_dual_lshlrev_b32 v60, 16, v84
	v_dual_mul_f32 v46, v46, v62 :: v_dual_add_nc_u32 v25, s14, v25
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(7)
	v_dual_fmac_f32 v34, v40, v57 :: v_dual_lshlrev_b32 v63, 16, v87
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v47, v47, v62 :: v_dual_lshlrev_b32 v64, 16, v88
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(5)
	v_dual_fmac_f32 v36, v38, v55 :: v_dual_lshlrev_b32 v65, 16, v89
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v31, v43, v60 :: v_dual_lshlrev_b32 v66, 16, v90
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v30, v44, v61 :: v_dual_lshlrev_b32 v67, 16, v91
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v49, v49, v62 :: v_dual_lshlrev_b32 v68, 16, v92
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v32, v42, v59 :: v_dual_lshlrev_b32 v69, 16, v93
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v35, v47, v65 :: v_dual_lshlrev_b32 v70, 16, v94
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v51, v51, v62 :: v_dual_fmac_f32 v26, v45, v63
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v33, v41, v58 :: v_dual_fmac_f32 v36, v46, v64
	v_fmac_f32_e32 v34, v48, v66
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v32, v50, v68 :: v_dual_fmac_f32 v31, v51, v69
	v_dual_fmac_f32 v33, v49, v67 :: v_dual_fmac_f32 v30, v52, v70
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %._crit_edge.loopexit
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v1, v26, v26 :: v_dual_max_f32 v2, v36, v36
	v_max_f32_e32 v3, v35, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v5, v33, v33 :: v_dual_max_f32 v8, v30, v30
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v4, v34, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_max_f32 v2, 0, v2 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v6, v32, v32 :: v_dual_max_f32 v7, v31, v31
	v_dual_max_f32 v4, 0, v4 :: v_dual_max_f32 v5, 0, v5
	v_max_f32_e32 v14, 0, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_max_f32 v6, 0, v6 :: v_dual_max_f32 v13, 0, v7
...
.Ltmp27:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 183
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
