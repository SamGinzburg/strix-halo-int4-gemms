...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v51, v29, s[4:7], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v52, v36, s[24:27], 0 offen offset:4
	buffer_load_u16 v53, v36, s[24:27], 0 offen
	buffer_load_u16 v54, v36, s[24:27], 0 offen offset:12
	buffer_load_u16 v55, v36, s[24:27], 0 offen offset:8
	buffer_load_u16 v56, v36, s[24:27], 0 offen offset:20
	buffer_load_u16 v57, v36, s[24:27], 0 offen offset:16
	buffer_load_u16 v58, v36, s[24:27], 0 offen offset:28
	buffer_load_u16 v59, v36, s[24:27], 0 offen offset:24
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v40, v42, v40 :: v_dual_lshlrev_b32 v45, 16, v54
	v_dual_mul_f32 v37, v42, v37 :: v_dual_lshlrev_b32 v46, 16, v55
	v_mul_f32_e32 v36, v42, v36
	v_dual_mul_f32 v39, v42, v39 :: v_dual_add_nc_u32 v28, s35, v28
	v_dual_mul_f32 v41, v42, v41 :: v_dual_add_nc_u32 v30, s36, v30
	v_dual_mul_f32 v38, v42, v38 :: v_dual_lshlrev_b32 v43, 16, v52
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v14, v40, v51 :: v_dual_lshlrev_b32 v47, 16, v56
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v35, v42, v35
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v15, v37, v45
	v_dual_fmac_f32 v17, v36, v46 :: v_dual_lshlrev_b32 v48, 16, v57
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v49, 16, v58
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v19, v35, v43 :: v_dual_fmac_f32 v18, v38, v48
	v_dual_fmac_f32 v16, v39, v47 :: v_dual_fmac_f32 v13, v41, v49
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
; %bb.4:
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[3:4], v26 offset:2048
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[1:2], v25 offset:2048
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v10, v38, v35, 0xc0c0004
	v_perm_b32 v31, v37, v36, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[23:30], v[5:6], v[1:2], v[23:30] neg_lo:[1,1,0]
	v_lshl_or_b32 v2, v8, 16, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v1, v31, 16, v10
...
.LBB0_5:
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v6, v6, v20 :: v_dual_add_nc_u32 v27, 24, v10
	v_dual_mul_f32 v3, v3, v20 :: v_dual_add_nc_u32 v10, 28, v10
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 37
