...
.Ltmp0:
	...
	v_mad_u64_u32 v[39:40], null, s5, v77, s[0:1]
	.loc	1 774 26                        ; attention.py:774:26
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 923 37                        ; attention.py:923:37
	s_clause 0x5
	buffer_load_u16 v111, v61, s[44:47], 0 offen offset:4
	buffer_load_u16 v112, v61, s[44:47], 0 offen offset:8
	buffer_load_u16 v113, v61, s[44:47], 0 offen offset:12
	buffer_load_u16 v115, v61, s[44:47], 0 offen offset:16
	buffer_load_u16 v116, v61, s[44:47], 0 offen offset:20
	buffer_load_u16 v117, v61, s[44:47], 0 offen offset:24
	.loc	1 913 33                        ; attention.py:913:33
	...
	s_waitcnt vmcnt(6)
	v_dual_mov_b32 v36, v35 :: v_dual_lshlrev_b32 v91, 16, v91
	...
	.loc	1 923 37                        ; attention.py:923:37
	buffer_load_u16 v97, v61, s[44:47], 0 offen offset:28
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 964 36                        ; attention.py:964:36
	v_dual_cndmask_b32 v37, 0xff800000, v99 :: v_dual_cndmask_b32 v40, 0xff800000, v101
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 964 36                        ; attention.py:964:36
	v_dual_cndmask_b32 v35, 0xff800000, v100 :: v_dual_cndmask_b32 v34, 0xff800000, v98
	v_dual_cndmask_b32 v39, 0xff800000, v104 :: v_dual_cndmask_b32 v38, 0xff800000, v102
	.loc	1 966 34                        ; attention.py:966:34
	...
	v_mul_f32_e32 v98, v85, v86
	.loc	1 966 25                        ; attention.py:966:25
	v_cndmask_b32_e64 v37, 0, 1, s11
	v_or_b16 v100.l, v35.l, v34.l
	v_mov_b16_e32 v34.l, v99.l
	v_mov_b16_e32 v35.l, v101.l
	...
	.loc	1 932 25                        ; attention.py:932:25
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v99, v85, v106 :: v_dual_lshlrev_b32 v104, 16, v111
	.loc	1 966 25                        ; attention.py:966:25
	v_or_b16 v36.h, v36.l, v34.l
	v_or_b16 v36.l, v37.l, v34.h
	.loc	1 965 35                        ; attention.py:965:35
	ds_load_b64 v[34:35], v81
	.loc	1 932 25                        ; attention.py:932:25
	v_mul_f32_e32 v37, v85, v89
	v_mul_f32_e32 v89, v85, v90
	v_mul_f32_e32 v90, v85, v105
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v101, v85, v107 :: v_dual_lshlrev_b32 v106, 16, v113
	v_mul_f32_e32 v103, v85, v114
	.loc	1 923 37                        ; attention.py:923:37
	...
	ds_store_b32 v82, v36
	s_waitcnt lgkmcnt(0)
	.loc	1 965 35                        ; attention.py:965:35
	v_mul_f32_e32 v38, 0x3fb8aa3b, v38
	v_dual_mul_f32 v40, 0x3fb8aa3b, v40 :: v_dual_mul_f32 v113, 0x3fb8aa3b, v87
	.loc	1 966 25                        ; attention.py:966:25
	s_barrier
	.loc	1 965 35                        ; attention.py:965:35
	...
	v_dual_fmac_f32 v38, v98, v91 :: v_dual_mul_f32 v41, 0x3fb8aa3b, v41
	.loc	1 965 35                        ; attention.py:965:35
	v_mul_f32_e32 v112, 0x3fb8aa3b, v86
	v_dual_mul_f32 v87, 0x3fb8aa3b, v34 :: v_dual_mul_f32 v114, 0x3fb8aa3b, v35
	...
	v_dual_fmac_f32 v39, v37, v104 :: v_dual_fmac_f32 v112, v99, v107
	.loc	1 932 25                        ; attention.py:932:25
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v102, v85, v108 :: v_dual_lshlrev_b32 v111, 16, v117
	.loc	1 923 37                        ; attention.py:923:37
	v_lshlrev_b32_e32 v108, 16, v116
	.loc	1 965 25                        ; attention.py:965:25
	v_fmac_f32_e32 v40, v89, v105
	...
	v_cndmask_b32_e64 v101, 0xff800000, v112, s14
	...
	.loc	1 965 25                        ; attention.py:965:25
	v_dual_fmac_f32 v41, v90, v106 :: v_dual_fmac_f32 v114, v103, v97
	.loc	1 967 26                        ; attention.py:967:26
	v_cndmask_b32_e64 v90, 0xff800000, v41, s17
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v104, 0xff800000, v114, s19
	.loc	1 965 25                        ; attention.py:965:25
	v_fmac_f32_e32 v87, v102, v111
	.loc	1 967 26                        ; attention.py:967:26
	v_cndmask_b32_e64 v102, 0xff800000, v113, s18
	.loc	1 1017 30                       ; attention.py:1017:30
	v_mov_b16_e32 v113.h, v92.l
	v_mov_b16_e32 v111.h, v92.l
	.loc	1 967 26                        ; attention.py:967:26
	v_cndmask_b32_e64 v103, 0xff800000, v87, s15
...
.Ltmp6:
	...
	v_permlanex16_b32 v99, v97, s34, 0xfedcba98 op_sel:[1,0]
.Ltmp7:
	.loc	1 969 24                        ; attention.py:969:24
	v_max3_f32 v105, v59, v97, v99
	.loc	1 903 13                        ; attention.py:903:13
	v_add_nc_u32_e32 v44, s36, v44
	v_add_nc_u32_e32 v43, s38, v43
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 971 62                        ; attention.py:971:62
	v_dual_sub_f32 v86, v86, v105 :: v_dual_add_nc_u32 v83, 64, v83
	s_waitcnt lgkmcnt(1)
	v_dual_sub_f32 v87, v87, v105 :: v_dual_max_f32 v100, v36, v36
.Ltmp8:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	s_waitcnt lgkmcnt(0)
	v_dual_max_f32 v97, v34, v34 :: v_dual_max_f32 v106, v40, v40
.Ltmp9:
	.loc	1 971 49                        ; attention.py:971:49
	v_exp_f32_e32 v86, v86
.Ltmp10:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max_f32_e32 v99, v38, v38
.Ltmp11:
	.loc	1 971 49                        ; attention.py:971:49
...
.Ltmp16:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_dual_max_f32 v99, v106, v100 :: v_dual_mov_b32 v100, v97
...
.Ltmp26:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v100.l, 0x7fff, v86.h, s16
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cndmask_b16 v100.h, 0x7fff, v87.h, s12
.Ltmp27:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_dual_max_f32 v106, v106, v106 :: v_dual_mov_b32 v91, v97
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp28:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:968:29 ]
...
.Ltmp29:
	...
	v_max_f32_e32 v91, v97, v86
	v_max_f32_e32 v99, v99, v106
.Ltmp30:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v106, v100, s34, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 969 24                        ; attention.py:969:24
	v_max_f32_e32 v86, v109, v91
.Ltmp31:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:968:29 ]
...
.Ltmp34:
	.loc	1 971 62                        ; attention.py:971:62
	v_dual_sub_f32 v108, v35, v86 :: v_dual_sub_f32 v35, v90, v105
...
.Ltmp36:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_perm_b32 v98, v106, v100, v54
	.loc	1 971 49                        ; attention.py:971:49
	v_exp_f32_e32 v35, v35
	v_exp_f32_e32 v34, v34
	.loc	1 971 62 is_stmt 0              ; attention.py:971:62
	v_dual_sub_f32 v39, v39, v86 :: v_dual_max_f32 v106, v88, v88
.Ltmp37:
	.loc	2 170 12 is_stmt 1              ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_max_f32_e32 v107, v99, v87
...
.Ltmp38:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 971 62 is_stmt 0              ; attention.py:971:62
	v_dual_sub_f32 v109, v36, v87 :: v_dual_sub_f32 v36, v89, v105
	...
	v_dual_sub_f32 v40, v40, v87 :: v_dual_and_b32 v89, 1, v89
...
.Ltmp42:
	...
	v_cmp_o_f32_e64 s12, v35, v35
	v_and_b32_e32 v36, 1, v110
	.loc	1 970 74                        ; attention.py:970:74
	v_sub_f32_e32 v110, v59, v105
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	v_cndmask_b32_e64 v59, 0, v110, s12
	.loc	1 971 62                        ; attention.py:971:62
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v18, v18, v59 :: v_dual_and_b32 v89, 1, v89
	.loc	1 1019 30                       ; attention.py:1019:30
	v_add3_u32 v89, v94, v89, 0x7fff
	.loc	1 1017 30                       ; attention.py:1017:30
	v_mov_b16_e32 v94.h, v92.l
	.loc	1 969 24                        ; attention.py:969:24
	v_max_f32_e32 v42, v42, v91
	...
	v_dual_mul_f32 v6, v6, v59 :: v_dual_sub_f32 v59, v76, v42
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v76, 0, v108, s8
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 970 61                        ; attention.py:970:61
	v_exp_f32_e32 v121, v59
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v59, 0, v107, s10
.Ltmp43:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v38, v39, v59 :: v_dual_add_f32 v39, v40, v76
.Ltmp44:
	.loc	1 1000 41                       ; attention.py:1000:41
...
.Ltmp45:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v34, v34, v38 :: v_dual_add_f32 v37, v39, v37
.Ltmp46:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_dual_mov_b32 v38, v34 :: v_dual_mov_b32 v39, v37
...
.Ltmp47:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_add_f32_e32 v123, v37, v39
.Ltmp48:
	.loc	1 970 74                        ; attention.py:970:74
	v_sub_f32_e32 v106, v88, v91
.Ltmp49:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
...
.Ltmp50:
	...
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v76, v40, v92 :: v_dual_and_b32 v89, 1, v90
...
.Ltmp54:
	.loc	1 970 25                        ; attention.py:970:25
	v_cndmask_b32_e64 v36, 0, v121, s12
.Ltmp55:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_mov_b32_dpp v34, v34 row_xmask:1 row_mask:0xf bank_mask:0xf
.Ltmp56:
	.loc	1 970 25                        ; attention.py:970:25
	v_cndmask_b32_e64 v37, 0, v122, s13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp57:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
...
.Ltmp58:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v41, v88, v34 :: v_dual_add_f32 v42, v123, v35
	s_delay_alu instid0(VALU_DEP_1)
.Ltmp59:
	.loc	1 1020 23                       ; attention.py:1020:23
	v_dual_fmac_f32 v41, v95, v36 :: v_dual_fmac_f32 v42, v96, v37
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 124
