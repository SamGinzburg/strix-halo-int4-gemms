...
.Ltmp11:
	...
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	v_mad_u64_u32 v[1:2], null, s17, v55, v[33:34]
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[2:3], null, s24, v54, v[34:35]
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	v_add3_u32 v1, s20, s5, v1
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v39, v[17:18] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_store_b16 v44, v1
	ds_store_b16_d16_hi v44, v1 offset:64
	ds_store_b16 v45, v2
...
.LBB0_3:                                ; %Flow121
	...
	v_dual_mov_b32 v8, 0 :: v_dual_lshlrev_b32 v51, 6, v35
	v_lshlrev_b32_e32 v37, 2, v0
	v_lshlrev_b32_e32 v53, 5, v41
...
.Ltmp14:
	...
	v_and_or_b32 v4, 0x438, v1, v51
.Ltmp15:
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v1, 0x41, v2
	...
	v_add_nc_u32_e32 v1, s19, v54
	v_readfirstlane_b32 s14, v9
	v_xor_b32_e32 v5, 8, v4
	v_xor_b32_e32 v6, 16, v4
	v_xor_b32_e32 v7, 24, v4
	v_mad_u64_u32 v[1:2], null, s24, v1, s[16:17]
	v_add3_u32 v9, v19, s15, v33
	v_add3_u32 v2, v18, s15, v33
	s_lshl_b32 s15, s22, 8
	v_xor_b32_e32 v8, 32, v4
	v_xor_b32_e32 v10, 40, v4
	v_subrev_nc_u32_e32 v54, s15, v9
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v62, 0, v12
	v_xor_b32_e32 v11, 48, v4
	v_subrev_nc_u32_e32 v43, s15, v2
	v_add3_u32 v34, v1, v34, 64
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_mov_b32_e32 v12, v9
	v_xor_b32_e32 v3, v3, v38
	v_dual_mov_b32 v26, v9 :: v_dual_add_nc_u32 v55, 0, v4
	v_add_nc_u32_e32 v56, 0, v5
	v_dual_mov_b32 v28, v9 :: v_dual_add_nc_u32 v57, 0, v6
	v_or3_b32 v3, v3, v53, v51
	v_add_nc_u32_e32 v58, 0, v7
	v_dual_mov_b32 v30, v9 :: v_dual_add_nc_u32 v59, 0, v8
	v_dual_mov_b32 v25, v9 :: v_dual_add_nc_u32 v60, 0, v10
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_xor_b32_e32 v20, 48, v3
	v_xor_b32_e32 v18, 56, v3
	v_dual_mov_b32 v32, v9 :: v_dual_add_nc_u32 v61, 0, v11
	v_add_nc_u32_e32 v63, 0, v3
	v_dual_mov_b32 v29, v9 :: v_dual_add_nc_u32 v64, 0, v13
	v_add_nc_u32_e32 v65, 0, v14
	v_dual_mov_b32 v31, v9 :: v_dual_add_nc_u32 v66, 0, v15
	v_dual_mov_b32 v22, v9 :: v_dual_add_nc_u32 v67, 0, v16
	v_add_nc_u32_e32 v68, 0, v17
	v_mov_b32_e32 v17, v9
	v_dual_mov_b32 v24, v9 :: v_dual_add_nc_u32 v69, 0, v20
	v_dual_mov_b32 v19, v9 :: v_dual_add_nc_u32 v70, 0, v18
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[91:92], v34, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	buffer_load_b128 v[71:74], v54, s[12:15], 0 offen
	buffer_load_b128 v[75:78], v43, s[12:15], 0 offen
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[79:82], v55 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[83:86], v63 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[87:90], v56 offset0:32 offset1:36
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v43, s22, v43
	v_add_nc_u32_e32 v54, s22, v54
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v64 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[83:86], v57 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[87:88], v[9:16] neg_lo:[1,1,0]
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v65 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[87:90], v58 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[79:80], v[85:86], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[85:86], v[1:8] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v66 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[83:86], v59 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[87:88], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[81:82], v[87:88], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[89:90], v[1:8] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v67 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[87:90], v60 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[83:84], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[81:82], v[83:84], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[85:86], v[1:8] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v68 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[83:86], v61 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[87:88], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[81:82], v[87:88], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[89:90], v[1:8] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v69 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[87:90], v62 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[83:84], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[81:82], v[83:84], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[85:86], v[1:8] neg_lo:[1,1,0]
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[79:82], v70 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v39, v[91:92] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(0)
	...
	v_lshlrev_b16 v82.h, 8, v86.l
	v_lshlrev_b16 v83.l, 8, v87.l
	v_or_b16 v74.h, v74.h, v79.l
	v_or_b16 v75.l, v75.l, v79.h
	v_or_b16 v75.h, v75.h, v80.l
	v_or_b16 v76.l, v76.l, v80.h
	v_or_b16 v76.h, v76.h, v81.l
	v_or_b16 v77.l, v77.l, v81.h
	v_or_b16 v77.h, v77.h, v82.l
	v_or_b16 v78.l, v78.l, v82.h
	v_or_b16 v78.h, v78.h, v83.l
	ds_store_b16 v44, v71
	ds_store_b16_d16_hi v44, v71 offset:64
	ds_store_b16 v45, v72
	ds_store_b16_d16_hi v45, v72 offset:64
	ds_store_b16 v46, v73
	ds_store_b16_d16_hi v46, v73 offset:64
	ds_store_b16 v47, v74
	ds_store_b16_d16_hi v47, v74 offset:64
	ds_store_b16 v48, v75
	ds_store_b16_d16_hi v48, v75 offset:64
	ds_store_b16 v49, v76
	ds_store_b16_d16_hi v49, v76 offset:64
	ds_store_b16 v50, v77
	ds_store_b16_d16_hi v50, v77 offset:64
...
.LBB0_11:
	...
	v_and_b32_e32 v34, 56, v37
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_and_or_b32 v38, 0x438, v37, v51
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_xor_b32_e32 v34, v34, v43
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_add_nc_u32_e32 v44, 0, v38
	v_xad_u32 v52, v38, 8, 0
	v_xad_u32 v39, v38, 56, 0
	v_xad_u32 v64, v38, 48, 0
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_or3_b32 v34, v34, v53, v51
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[44:47], v44 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[52:55], v52 offset0:32 offset1:36
	v_xad_u32 v76, v38, 40, 0
	v_xad_u32 v80, v38, 32, 0
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_add_nc_u32_e32 v48, 0, v34
	v_xad_u32 v56, v34, 8, 0
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_xad_u32 v84, v38, 24, 0
	v_xad_u32 v38, v38, 16, 0
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_xad_u32 v72, v34, 16, 0
	ds_load_2addr_stride64_b64 v[48:51], v48 offset1:16
	ds_load_2addr_stride64_b64 v[56:59], v56 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[60:63], v39 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[64:67], v64 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[68:71], v38 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_xad_u32 v38, v34, 24, 0
	ds_load_2addr_stride64_b64 v[72:75], v72 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[76:79], v76 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[80:83], v80 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[84:87], v84 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_xad_u32 v39, v34, 32, 0
	v_xad_u32 v96, v34, 48, 0
	ds_load_2addr_stride64_b64 v[88:91], v38 offset1:16
	v_xad_u32 v38, v34, 56, 0
	v_xad_u32 v34, v34, 40, 0
	ds_load_2addr_stride64_b64 v[92:95], v39 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[44:47], v34 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(10)
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[48:51], v96 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(7)
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[52:55], v38 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[88:89], v[84:85], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[90:91], v[84:85], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[88:89], v[86:87], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[90:91], v[86:87], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[92:93], v[80:81], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[94:95], v[80:81], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[92:93], v[82:83], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[94:95], v[82:83], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[44:45], v[76:77], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[46:47], v[76:77], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[44:45], v[78:79], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[46:47], v[78:79], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[48:49], v[64:65], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[50:51], v[64:65], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[48:49], v[66:67], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[54:55], v[60:61], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[52:53], v[62:63], v[17:24] neg_lo:[1,1,0]
...
.LBB0_12:
	...
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_clause 0x7
	buffer_load_u16 v45, v44, s[8:11], 0 offen
...
.Ltmp24:
	...
	s_waitcnt vmcnt(2)
	v_dual_max_f32 v14, 0, v14 :: v_dual_lshlrev_b32 v59, 16, v59
	...
	v_dual_mul_f32 v5, v59, v5 :: v_dual_mul_f32 v4, v58, v4
	v_dual_mul_f32 v7, v61, v7 :: v_dual_mul_f32 v6, v60, v6
	...
	v_dual_max_f32 v45, 0, v16 :: v_dual_max_f32 v26, 0, v26
	...
	v_dual_max_f32 v48, 0, v19 :: v_dual_max_f32 v1, 0, v1
	v_dual_max_f32 v50, 0, v21 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v22, 0, v22 :: v_dual_max_f32 v5, 0, v5
	v_dual_max_f32 v52, 0, v24 :: v_dual_max_f32 v53, 0, v6
	v_dual_max_f32 v2, 0, v2 :: v_dual_max_f32 v55, 0, v8
	v_dual_max_f32 v4, 0, v4 :: v_dual_mul_f32 v57, v10, v10
	v_dual_max_f32 v54, 0, v7 :: v_dual_mul_f32 v59, v12, v12
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v56, v9, v9 :: v_dual_mul_f32 v17, v44, v44
	v_dual_mul_f32 v58, v11, v11 :: v_dual_mul_f32 v15, v13, v13
	v_dual_mul_f32 v16, v14, v14 :: v_dual_mul_f32 v19, v25, v25
	v_dual_mul_f32 v18, v45, v45 :: v_dual_mul_f32 v21, v27, v27
	v_dual_mul_f32 v20, v26, v26 :: v_dual_mul_f32 v23, v28, v28
	v_dual_mul_f32 v24, v29, v29 :: v_dual_mul_f32 v25, v30, v30
	v_dual_mul_f32 v26, v31, v31 :: v_dual_mul_f32 v27, v32, v32
	v_dual_mul_f32 v45, v49, v49 :: v_dual_mul_f32 v32, v22, v22
	v_mul_f32_e32 v22, v1, v1
	v_dual_mul_f32 v14, v2, v2 :: v_dual_max_f32 v1, v56, v57
.Ltmp25:
...
.Ltmp28:
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v31, v47, v47 :: v_dual_mul_f32 v44, v50, v50
	v_dual_mul_f32 v30, v51, v51 :: v_dual_mul_f32 v7, v4, v4
...
.Ltmp30:
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v4, v54, v54 :: v_dual_mul_f32 v3, v55, v55
.Ltmp31:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	...
	v_max3_f32 v10, v30, v28, v22
.Ltmp32:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
	v_lshl_add_u32 v13, v40, 8, 0
.Ltmp33:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
...
.Ltmp59:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v40, -v10, v13, v12
	v_fmac_f32_e32 v13, v40, v11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v13, v12, v11
	v_fma_f32 v41, -v10, v13, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v13, v41, v11
	v_fma_f32 v10, -v10, v13, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v10, v10, v11, v13
	...
	v_div_scale_f32 v13, vcc_lo, v57, v40, v57
	v_mul_f32_e32 v41, v13, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v42, -v11, v41, v13
	v_fmac_f32_e32 v41, v42, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v11, -v11, v41, v13
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v12, v12, v13, v42
	v_div_scale_f32 v13, null, v40, v40, v59
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v13, v13, v40, v59
	...
	v_fma_f32 v43, -v41, v42, 1.0
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v21, v40, v21
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v47, v43, v42
	v_fma_f32 v48, -v41, v47, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v43, null, v9, v9, v22
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v44, v45, v44
	v_div_scale_f32 v45, vcc_lo, v22, v9, v22
	v_mul_f32_e32 v46, v45, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v47, -v43, v46, v45
	v_fmac_f32_e32 v46, v47, v44
	...
	v_div_fmas_f32 v43, v43, v44, v46
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v22, v43, v9, v22
	v_div_scale_f32 v43, null, v9, v9, v14
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_fma_f32 v45, -v43, v44, 1.0
	v_fmac_f32_e32 v44, v45, v44
	v_div_scale_f32 v45, vcc_lo, v14, v9, v14
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v46, v45, v44
	v_fma_f32 v47, -v43, v46, v45
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v43, v43, v44, v46
	v_div_fixup_f32 v14, v43, v9, v14
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 97
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 25
