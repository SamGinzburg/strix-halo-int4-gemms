	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_or_b32_e32 v136, 0x3f0, v0
	v_or_b32_e32 v135, 0x7f0, v0
.Ltmp1:
...
.Ltmp11:
	...
	s_lshl_b32 s29, s3, 4
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_xor_b32 s26, s5, s23
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_add_i32 s5, s4, s6
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	s_mul_i32 s6, s9, s29
	v_mad_u64_u32 v[4:5], null, s9, v3, v[1:2]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_sub_i32 s9, s26, s23
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_ashr_i32 s27, s5, 1
	...
	.loc	1 139 39                        ; generate_amdgcn.py:139:39
	...
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	v_or_b32_e32 v9, s5, v194
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_gt_i32_e32 vcc_lo, s27, v8
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_cndmask_b32_e64 v4, 0x80000000, v4, s2
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_cndmask_b32_e64 v6, 0x80000000, v6, s2
	.loc	1 139 39 is_stmt 0              ; generate_amdgcn.py:139:39
	v_add_nc_u32_e32 v10, s11, v7
	.loc	1 109 23 is_stmt 1              ; generate_amdgcn.py:109:23
	v_cmp_gt_i32_e64 s2, s27, v9
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v8, v4, s[16:19], 0 offen
	buffer_load_b32 v6, v6, s[16:19], 0 offen
	v_dual_cndmask_b32 v4, 0x80000000, v7 :: v_dual_cndmask_b32 v7, 0x80000000, v10
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	v_xor_b32_e32 v138, v4, v11
	v_lshlrev_b32_e32 v4, 4, v0
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v11, 0, v137
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v12, 0, v138
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(4)
	ds_store_2addr_stride64_b32 v11, v8, v6 offset1:16
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(3)
	...
	s_waitcnt vmcnt(1)
	ds_store_2addr_stride64_b32 v11, v10, v7 offset0:8 offset1:24
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(0)
	ds_store_b8 v12, v5 offset:8448
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v18, 0 :: v_dual_lshlrev_b32 v5, 1, v3
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
	v_sub_nc_u32_e32 v140, s27, v3
.Ltmp12:
...
.Ltmp14:
	...
	s_lshr_b32 s0, s0, 4
	v_dual_mov_b32 v21, v18 :: v_dual_add_nc_u32 v2, s20, v2
	v_dual_mov_b32 v20, v18 :: v_dual_add_nc_u32 v5, 0x41, v3
	v_dual_mov_b32 v22, v18 :: v_dual_add_nc_u32 v3, 64, v3
.Ltmp15:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_lshl_b32 s1, s26, 7
	...
	v_and_or_b32 v141, 0x88, v4, v134
	v_mad_u64_u32 v[9:10], null, s27, v2, v[194:195]
	s_lshl_b32 s2, s23, 7
	v_add3_u32 v4, v5, s1, v1
	v_readfirstlane_b32 s0, v6
	v_add3_u32 v1, v3, s1, v1
	v_sub_nc_u32_e32 v139, s27, v194
	v_xor_b32_e32 v142, 8, v141
	v_subrev_nc_u32_e32 v143, s2, v4
	v_mov_b32_e32 v23, v18
	v_subrev_nc_u32_e32 v144, s2, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s0, s29, v139
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v130, s29, v9
	s_mov_b32 s30, s23
	s_mov_b32 s23, s28
	s_mov_b32 s28, s24
	s_mov_b32 s24, s3
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v147, s28, v194
	v_add_nc_u32_e32 v149, s28, v136
	v_add_nc_u32_e32 v148, s28, v135
	s_mov_b32 s3, s1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v130, s30, v141
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e32 vcc_lo, s29, v140
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s0, s25, 1
	s_mov_b32 s1, s2
	s_cmp_lt_i32 s0, 2
	...
	v_add_nc_u32_e32 v130, s30, v142
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_cndmask_b32_e32 v145, 0x80000000, v144, vcc_lo
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cselect_b32 s25, s0, 0
	v_add_nc_u32_e32 v144, s26, v144
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_lshl_b32 s0, s25, 8
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v130, s0, v138
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_lshl_b32 s0, s25, 11
	s_delay_alu instid0(SALU_CYCLE_1)
	s_add_i32 s3, s0, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(2)
...
.LBB0_7:
	...
	v_dual_mov_b32 v117, v9 :: v_dual_mov_b32 v24, v8
	v_dual_mov_b32 v121, v9 :: v_dual_mov_b32 v20, v8
	v_dual_mov_b32 v123, v9 :: v_dual_mov_b32 v22, v8
	v_dual_mov_b32 v127, v9 :: v_dual_mov_b32 v18, v8
...
.LBB0_8:                                ; %._crit_edge
	...
	s_barrier
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_cndmask_b32_e64 v130, 0, 1, s22
	...
	v_add_nc_u32_e32 v131, s23, v9
	v_dual_mov_b32 v181, v117 :: v_dual_mov_b32 v180, v116
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v179, v115 :: v_dual_add_nc_u32 v132, s23, v201
...
; %bb.9:
	...
	v_add_nc_u32_e32 v133, s18, v194
	v_add_nc_u32_e32 v150, s18, v221
	v_add_nc_u32_e32 v148, s18, v226
	v_add_nc_u32_e32 v182, s18, v250
	v_add_nc_u32_e32 v149, s18, v220
	...
	ds_load_u8 v149, v149
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v160, s18, v238
	v_add_nc_u32_e32 v162, s18, v229
	v_add_nc_u32_e32 v172, s18, v254
	v_add_nc_u32_e32 v161, s18, v228
	v_add_nc_u32_e32 v164, s18, v242
	v_add_nc_u32_e32 v165, s18, v233
	v_add_nc_u32_e32 v173, s18, v244
	v_add_nc_u32_e32 v166, s18, v234
	v_add_nc_u32_e32 v174, s18, v245
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v138, s18, v219
	v_add_nc_u32_e32 v139, s18, v217
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v138, v138
	ds_load_u8 v139, v139
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v142, s18, v214
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v146, v141, 16, v140
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v140, s18, v218
	v_add_nc_u32_e32 v141, s18, v213
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v142, v142
	ds_load_u8 v140, v140
	ds_load_u8 v141, v141
	...
	v_perm_b32 v139, v140, v139, 0xc0c0004
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v140, s18, v216
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	v_perm_b32 v140, v141, v140, 0xc0c0004
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v141, s18, v215
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v141, v141
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v141, v142, v141, 0xc0c0004
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v146, s18, v227
	v_add_nc_u32_e32 v147, s18, v225
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v147, s18, v230
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v147, v147
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v147, v148, v147, 0xc0c0004
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v148, s18, v224
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(3)
	v_add_nc_u32_e32 v154, s18, v154
	s_waitcnt vmcnt(2)
	v_add_nc_u32_e32 v155, s18, v155
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v149, s18, v223
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v149, v149
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v146, v147, v146, 0xc0c0004
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v158, s18, v239
	v_add_nc_u32_e32 v159, s18, v237
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v159, s18, v240
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v159, v159
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v159, v160, v159, 0xc0c0004
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v160, s18, v232
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v161, s18, v231
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v161, v161
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v162, s18, v243
	v_add_nc_u32_e32 v163, s18, v241
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v162, v162
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v163, s18, v248
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v163, v163
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v163, v164, v163, 0xc0c0004
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v164, s18, v236
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v165, s18, v235
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v165, v165
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v162, v163, v162, 0xc0c0004
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v172, s18, v247
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v173, s18, v246
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v173, v173
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v170, v171, v170, 0xc0c0004
	...
	s_waitcnt vmcnt(1)
	v_add_nc_u32_e32 v208, s18, v208
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v209, s18, v209
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
...
; %bb.11:
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[18:25], v[66:67], v[197:198], v[18:25] neg_lo:[1,1,0]
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v71, v71
	v_wmma_i32_16x16x16_iu4 v[18:25], v[66:67], v[195:196], v[18:25] neg_lo:[1,1,0]
	ds_load_u8 v68, v68
	ds_load_u8 v70, v70
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[72:73], v[197:198], v[10:17] neg_lo:[1,1,0]
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[72:73], v[195:196], v[10:17] neg_lo:[1,1,0]
...
.LBB0_12:                               ; %._crit_edge279
	...
	s_waitcnt lgkmcnt(1)
	v_dual_mov_b32 v198, v129 :: v_dual_add_nc_u32 v9, s28, v9
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v255, v219 :: v_dual_add_nc_u32 v196, s28, v201
...
; %bb.15:
	...
	scratch_load_b64 v[132:133], off, off offset:520
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[18:25], v[66:67], v[229:230], v[18:25] neg_lo:[1,1,0]
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[72:73], v[229:230], v[10:17] neg_lo:[1,1,0]
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	s_clause 0x3                            ; 16-byte Folded Reload
...
.LBB0_17:
	.loc	1 142 22 is_stmt 1              ; generate_amdgcn.py:142:22
	v_or_b32_e32 v9, s20, v194
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
	...
	.loc	1 147 31                        ; generate_amdgcn.py:147:31
	v_add_lshl_u32 v255, s0, v74, 1
	.loc	1 142 14                        ; generate_amdgcn.py:142:14
	buffer_load_u16 v94, v9, s[12:15], 0 offen
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_and_b32 s13, s7, 0xffff
	s_mov_b32 s12, s6
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	s_clause 0x7
	buffer_load_u16 v99, v255, s[12:15], 0 offen offset:4
	buffer_load_u16 v90, v255, s[12:15], 0 offen offset:16
	buffer_load_u16 v92, v255, s[12:15], 0 offen offset:20
	buffer_load_u16 v71, v255, s[12:15], 0 offen offset:24
	buffer_load_u16 v72, v255, s[12:15], 0 offen offset:28
	buffer_load_u16 v141, v255, s[12:15], 0 offen offset:8
	buffer_load_u16 v150, v255, s[12:15], 0 offen
	buffer_load_u16 v149, v255, s[12:15], 0 offen offset:12
	...
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	s_clause 0x2
	buffer_load_u16 v244, v78, s[12:15], 0 offen
	buffer_load_u16 v245, v79, s[12:15], 0 offen
	buffer_load_u16 v243, v74, s[12:15], 0 offen
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	...
	buffer_load_u16 v248, v3, s[12:15], 0 offen
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	buffer_load_u16 v249, v7, s[12:15], 0 offen
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	v_cvt_f32_i32_e32 v128, v228
	v_cvt_f32_i32_e32 v66, v132
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v228, v16
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v16, 32, v106
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v68, v25
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v25, 36, v106
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v108, v27
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v27, 40, v106
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v95, v28
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v28, 44, v106
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	v_cvt_f32_i32_e32 v79, v208
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v208, v64
	v_cvt_f32_i32_e32 v64, v31
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v31, 48, v106
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	...
	v_cvt_f32_i32_e32 v240, v209
	v_cvt_f32_i32_e32 v241, v210
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v32, 52, v106
	v_or_b32_e32 v33, 56, v106
	v_or_b32_e32 v34, 60, v106
	s_clause 0x7
	buffer_load_u16 v232, v16, s[12:15], 0 offen
	buffer_load_u16 v234, v25, s[12:15], 0 offen
	buffer_load_u16 v223, v27, s[12:15], 0 offen
	buffer_load_u16 v224, v28, s[12:15], 0 offen
	buffer_load_u16 v216, v31, s[12:15], 0 offen
	buffer_load_u16 v217, v32, s[12:15], 0 offen
	buffer_load_u16 v210, v33, s[12:15], 0 offen
	buffer_load_u16 v212, v34, s[12:15], 0 offen
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	...
	v_cvt_f32_i32_e32 v222, v211
	v_cvt_f32_i32_e32 v78, v207
	...
	v_mul_lo_u32 v24, s11, v194
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v134, v36
	v_cvt_f32_i32_e32 v36, v12
	v_cvt_f32_i32_e32 v96, v29
	v_cvt_f32_i32_e32 v29, v14
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	v_cvt_f32_i32_e32 v83, v253
	...
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	s_clause 0x1f
	buffer_load_u16 v26, v255, s[12:15], 0 offen offset:32
	buffer_load_u16 v236, v255, s[12:15], 0 offen offset:36
	buffer_load_u16 v35, v255, s[12:15], 0 offen offset:40
	buffer_load_u16 v225, v255, s[12:15], 0 offen offset:44
	buffer_load_u16 v39, v255, s[12:15], 0 offen offset:48
	buffer_load_u16 v218, v255, s[12:15], 0 offen offset:52
	buffer_load_u16 v211, v255, s[12:15], 0 offen offset:56
	buffer_load_u16 v43, v255, s[12:15], 0 offen offset:60
	buffer_load_u16 v205, v255, s[12:15], 0 offen offset:64
	buffer_load_u16 v207, v255, s[12:15], 0 offen offset:68
	buffer_load_u16 v198, v255, s[12:15], 0 offen offset:72
	buffer_load_u16 v200, v255, s[12:15], 0 offen offset:76
	buffer_load_u16 v192, v255, s[12:15], 0 offen offset:80
	buffer_load_u16 v193, v255, s[12:15], 0 offen offset:84
	buffer_load_u16 v184, v255, s[12:15], 0 offen offset:88
	buffer_load_u16 v185, v255, s[12:15], 0 offen offset:92
	buffer_load_u16 v175, v255, s[12:15], 0 offen offset:96
	buffer_load_u16 v176, v255, s[12:15], 0 offen offset:100
	buffer_load_u16 v168, v255, s[12:15], 0 offen offset:104
	buffer_load_u16 v170, v255, s[12:15], 0 offen offset:108
	buffer_load_u16 v161, v255, s[12:15], 0 offen offset:112
	buffer_load_u16 v162, v255, s[12:15], 0 offen offset:116
	buffer_load_u16 v155, v255, s[12:15], 0 offen offset:120
	buffer_load_u16 v157, v255, s[12:15], 0 offen offset:124
	buffer_load_u16 v147, v255, s[12:15], 0 offen offset:128
	buffer_load_u16 v148, v255, s[12:15], 0 offen offset:132
	buffer_load_u16 v139, v255, s[12:15], 0 offen offset:136
	buffer_load_u16 v140, v255, s[12:15], 0 offen offset:140
	buffer_load_u16 v130, v255, s[12:15], 0 offen offset:144
	buffer_load_u16 v131, v255, s[12:15], 0 offen offset:148
	buffer_load_u16 v120, v255, s[12:15], 0 offen offset:152
	buffer_load_u16 v122, v255, s[12:15], 0 offen offset:156
	s_clause 0x7
	buffer_load_u16 v111, v255, s[12:15], 0 offen offset:160
	buffer_load_u16 v113, v255, s[12:15], 0 offen offset:164
	buffer_load_u16 v103, v255, s[12:15], 0 offen offset:168
	buffer_load_u16 v104, v255, s[12:15], 0 offen offset:172
	buffer_load_u16 v91, v255, s[12:15], 0 offen offset:176
	buffer_load_u16 v93, v255, s[12:15], 0 offen offset:180
	buffer_load_u16 v57, v255, s[12:15], 0 offen offset:184
	buffer_load_u16 v60, v255, s[12:15], 0 offen offset:188
	scratch_store_b32 off, v0, off offset:16 ; 4-byte Folded Spill
	s_waitcnt vmcnt(61)
	v_lshlrev_b32_e32 v62, 16, v99
	.loc	1 142 14                        ; generate_amdgcn.py:142:14
	v_lshlrev_b32_e32 v3, 16, v94
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	s_waitcnt vmcnt(54)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v62, v3, v62 :: v_dual_lshlrev_b32 v27, 16, v149
	.loc	1 148 13 is_stmt 0              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v252, v62, v115 :: v_dual_and_b32 v9, 16, v0
	.loc	1 141 15 is_stmt 1              ; generate_amdgcn.py:141:15
	scratch_store_b32 off, v9, off offset:20 ; 4-byte Folded Spill
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
	...
	v_cvt_f32_i32_e32 v66, v21
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v142, 0xbfb8aa3b, v252 :: v_dual_mul_f32 v27, v3, v27
	...
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v55, 0x70, v106
	v_or_b32_e32 v56, 0x74, v106
	v_or_b32_e32 v58, 0x78, v106
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v142, 0xbfb8aa3b, v252
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v61, 0x7c, v106
	v_or_b32_e32 v38, 64, v106
	v_or_b32_e32 v40, 0x44, v106
	...
	s_clause 0x1
	buffer_load_u16 v239, v158, s[12:15], 0 offen
	buffer_load_u16 v23, v15, s[12:15], 0 offen
	v_or_b32_e32 v49, 0x5c, v106
	s_clause 0x7
	buffer_load_u16 v204, v38, s[12:15], 0 offen
	buffer_load_u16 v206, v40, s[12:15], 0 offen
	buffer_load_u16 v194, v41, s[12:15], 0 offen
	buffer_load_u16 v199, v42, s[12:15], 0 offen
	buffer_load_u16 v190, v46, s[12:15], 0 offen
	buffer_load_u16 v191, v47, s[12:15], 0 offen
	buffer_load_u16 v182, v48, s[12:15], 0 offen
	buffer_load_u16 v183, v49, s[12:15], 0 offen
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v32, v27, v66
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v94, 0x80, v106
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v142, v142, v163
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v62, 0xa0, v106
	v_or_b32_e32 v12, 0xc0, v106
	v_or_b32_e32 v99, 0x84, v106
	v_or_b32_e32 v115, 0xa4, v106
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v1, 1.0, v142
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v14, 0xc4, v106
	v_or_b32_e32 v123, 0x88, v106
	v_or_b32_e32 v254, 0xa8, v106
	v_or_b32_e32 v10, 0xc8, v106
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v25, null, v1, v1, v252
	v_div_scale_f32 v31, s0, v252, v1, v252
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v124, 0x8c, v106
	v_or_b32_e32 v100, 0xac, v106
	v_or_b32_e32 v11, 0xcc, v106
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v150, v3, v150
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v132, 0x90, v106
	v_or_b32_e32 v133, 0x94, v106
	v_or_b32_e32 v250, 0x98, v106
	v_or_b32_e32 v251, 0x9c, v106
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v0, v150, v156
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_clause 0x7
	buffer_load_u16 v177, v50, s[12:15], 0 offen
	buffer_load_u16 v178, v51, s[12:15], 0 offen
	buffer_load_u16 v169, v54, s[12:15], 0 offen
	buffer_load_u16 v171, v7, s[12:15], 0 offen
	buffer_load_u16 v163, v55, s[12:15], 0 offen
	buffer_load_u16 v164, v56, s[12:15], 0 offen
	buffer_load_u16 v156, v58, s[12:15], 0 offen
	buffer_load_u16 v158, v61, s[12:15], 0 offen
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v7, -v25, v28, 1.0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v105, 0xb0, v106
	v_or_b32_e32 v8, 0xbc, v106
	v_or_b32_e32 v6, 0xd0, v106
	v_or_b32_e32 v4, 0xd8, v106
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v28, v7, v28 :: v_dual_lshlrev_b32 v7, 16, v141
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v102, 0xb4, v106
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v7, v3, v7 :: v_dual_mul_f32 v16, 0xbfb8aa3b, v0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v5, 0xdc, v106
	s_clause 0xf
	buffer_load_u16 v149, v94, s[12:15], 0 offen
	buffer_load_u16 v150, v99, s[12:15], 0 offen
	buffer_load_u16 v141, v123, s[12:15], 0 offen
	buffer_load_u16 v142, v124, s[12:15], 0 offen
	buffer_load_u16 v132, v132, s[12:15], 0 offen
	buffer_load_u16 v133, v133, s[12:15], 0 offen
	buffer_load_u16 v123, v250, s[12:15], 0 offen
	buffer_load_u16 v124, v251, s[12:15], 0 offen
	buffer_load_u16 v251, v62, s[12:15], 0 offen
	buffer_load_u16 v115, v115, s[12:15], 0 offen
	buffer_load_u16 v250, v254, s[12:15], 0 offen
	buffer_load_u16 v66, v100, s[12:15], 0 offen
	buffer_load_u16 v99, v105, s[12:15], 0 offen
	buffer_load_u16 v94, v102, s[12:15], 0 offen
	buffer_load_u16 v61, v114, s[12:15], 0 offen
	buffer_load_u16 v62, v8, s[12:15], 0 offen
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v38, v7, v67 :: v_dual_lshlrev_b32 v7, 16, v90
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e32 vcc_lo, 0xc2fc0000, v16
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v21, 0xe0, v106
	v_or_b32_e32 v22, 0xe4, v106
	v_or_b32_e32 v20, 0xe8, v106
	v_or_b32_e32 v18, 0xec, v106
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v16, 0, 0x42800000, vcc_lo
	v_cndmask_b32_e64 v27, 0, 0xffffffc0, vcc_lo
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_or_b32_e32 v19, 0xf0, v106
	v_or_b32_e32 v15, 0xf8, v106
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v16, 0xbfb8aa3b, v0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_or_b32_e32 v17, 0xf4, v106
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v33, v27, v28
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v27, 0xbfb8aa3b, v38
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cmp_gt_f32_e64 s1, 0xc2fc0000, v16
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v25, -v25, v33, v31
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v16, 0, 0x42800000, s1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v25, v25, v28, v33
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	s_clause 0x7
	buffer_load_u16 v54, v12, s[12:15], 0 offen
	buffer_load_u16 v56, v14, s[12:15], 0 offen
	buffer_load_u16 v49, v10, s[12:15], 0 offen
	buffer_load_u16 v51, v11, s[12:15], 0 offen
	buffer_load_u16 v41, v6, s[12:15], 0 offen
	buffer_load_u16 v42, v9, s[12:15], 0 offen
	buffer_load_u16 v33, v4, s[12:15], 0 offen
	buffer_load_u16 v34, v5, s[12:15], 0 offen
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v4, v3, v7
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v8, 16, v92
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v16, 0xbfb8aa3b, v32
	v_cndmask_b32_e64 v9, 0, 0xffffffc0, s1
	v_cmp_gt_f32_e32 vcc_lo, 0xc2fc0000, v27
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v11, v4, v246
	.loc	1 148 25 is_stmt 0              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v5, v3, v8
	.loc	1 149 44 is_stmt 1              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v8, v16
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v25, v1, v252
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v6, 0, 0x42800000, vcc_lo
	v_cndmask_b32_e64 v12, 0, 0xffffffc0, vcc_lo
	s_waitcnt vmcnt(62)
	v_dual_mul_f32 v47, 0xbfb8aa3b, v11 :: v_dual_lshlrev_b32 v26, 16, v26
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v26, v3, v26 :: v_dual_add_f32 v9, 1.0, v9
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v31, null, v40, v40, v0
	v_div_scale_f32 v10, s0, v0, v40, v0
	s_mov_b32 vcc_lo, s0
	v_rcp_f32_e32 v46, v31
	v_fma_f32 v7, -v31, v46, 1.0
	s_waitcnt vmcnt(43)
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_fmac_f32 v46, v7, v46 :: v_dual_lshlrev_b32 v57, 16, v57
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_clause 0x7
	buffer_load_u16 v27, v21, s[12:15], 0 offen
	buffer_load_u16 v28, v22, s[12:15], 0 offen
	buffer_load_u16 v21, v20, s[12:15], 0 offen
	buffer_load_u16 v20, v18, s[12:15], 0 offen
	buffer_load_u16 v4, v19, s[12:15], 0 offen
	buffer_load_u16 v16, v17, s[12:15], 0 offen
	buffer_load_u16 v8, v15, s[12:15], 0 offen
	buffer_load_u16 v7, v106, s[12:15], 0 offen
	v_lshlrev_b32_e32 v15, 16, v242
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v6, 0xbfb8aa3b, v38 :: v_dual_lshlrev_b32 v17, 16, v243
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v14, v10, v46 :: v_dual_mul_f32 v5, v5, v247
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	...
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v18, 16, v245
	v_lshlrev_b32_e32 v19, 16, v244
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v31, v14, v10
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v1, v17, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v57, v57, v52 :: v_dual_add_f32 v6, 1.0, v6
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v14, v12, v46
	v_div_scale_f32 v12, null, v9, v9, v32
	...
	v_fma_f32 v10, -v31, v14, v10
	v_div_scale_f32 v31, null, v6, v6, v38
	v_rcp_f32_e32 v22, v12
	v_div_fmas_f32 v10, v10, v46, v14
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v46, v31
	v_div_fixup_f32 v0, v10, v40, v0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	v_div_scale_f32 v25, s0, v32, v9, v32
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v67, v17, v46 :: v_dual_fmac_f32 v40, 0xbfb8aa3b, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v0, v40, v15
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 38 is_stmt 0              ; generate_amdgcn.py:149:38
	v_dual_add_f32 v15, 1.0, v0 :: v_dual_mul_f32 v10, v25, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v48, -v12, v10, v25
	s_delay_alu instid0(VALU_DEP_1)
	v_fmac_f32_e32 v10, v48, v22
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	s_clause 0x7
	buffer_load_u16 v100, v255, s[12:15], 0 offen offset:192
	buffer_load_u16 v102, v255, s[12:15], 0 offen offset:196
	buffer_load_u16 v90, v255, s[12:15], 0 offen offset:200
	buffer_load_u16 v92, v255, s[12:15], 0 offen offset:204
	buffer_load_u16 v55, v255, s[12:15], 0 offen offset:208
	buffer_load_u16 v58, v255, s[12:15], 0 offen offset:212
	buffer_load_u16 v48, v255, s[12:15], 0 offen offset:216
	buffer_load_u16 v50, v255, s[12:15], 0 offen offset:220
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v10, v25
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v10, v9, v32
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v10, v18, v75
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v14, v14, v47
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v15, v15, v11
	v_fma_f32 v47, -v31, v67, v17
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v13.h, 0x7fff, v1.h, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v12, 1.0, v14 :: v_dual_mul_f32 v9, v10, v9
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v10, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v67, v47, v46
	s_mov_b32 vcc_lo, s2
	v_div_scale_f32 v1, null, v12, v12, v5
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v14, v3, v19
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v17, -v31, v67, v17
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v22, -v18, v10, 1.0
	v_div_fmas_f32 v17, v17, v46, v67
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	v_div_scale_f32 v22, s0, v11, v15, v11
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fma_f32 v19, -v1, v0, 1.0
	v_div_fixup_f32 v6, v17, v6, v38
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v17, 16, v72
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v31, v22, v10
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v17, v3, v17 :: v_dual_mul_f32 v6, v14, v6
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v25, v19, v0 :: v_dual_and_b32 v14, 1, v2
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v73, v26, v226
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v17, v17, v68
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v68.h, v2.h
	v_add3_u32 v67, v9, v14, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v9, -v1, v25, v19
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v14, 0xbfb8aa3b, v17 :: v_dual_fmac_f32 v25, v9, v0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v9, -v18, v31, v22
	v_fma_f32 v1, -v1, v25, v19
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v31, v9, v10
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v9, v32, v69
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v1, v0, v25
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v0, -v18, v31, v22
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v19, 0xbfb8aa3b, v9
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v68.l, v6.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v1, v12, v5
	v_div_fmas_f32 v10, v0, v10, v31
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e32 vcc_lo, 0xc2fc0000, v19
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	s_clause 0x7
	buffer_load_u16 v46, v255, s[12:15], 0 offen offset:224
	buffer_load_u16 v47, v255, s[12:15], 0 offen offset:228
	buffer_load_u16 v38, v255, s[12:15], 0 offen offset:232
	buffer_load_u16 v40, v255, s[12:15], 0 offen offset:236
	buffer_load_u16 v31, v255, s[12:15], 0 offen offset:240
	buffer_load_u16 v32, v255, s[12:15], 0 offen offset:244
	buffer_load_u16 v0, v255, s[12:15], 0 offen offset:248
	buffer_load_u16 v25, v255, s[12:15], 0 offen offset:252
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v5, v19, v11
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v19.h, 0x7fff, v67.h, s1
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v67, v67, v231 :: v_dual_fmac_f32 v14, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v72, 0xbfb8aa3b, v67
	v_exp_f32_e32 v14, v14
	s_delay_alu instid0(TRANS32_DEP_1)
	v_ldexp_f32 v18, v14, v18
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_add3_u32 v14, s20, s10, v24
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v24, 16, v249
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	s_mov_b32 s10, s14
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_waitcnt vmcnt(36)
	...
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v1, v24, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v24, -v15, v11, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v11, v24, v11
	v_div_scale_f32 v24, s0, v17, v18, v17
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_and_b32_e32 v22, 1, v68
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v69, v24, v11 :: v_dual_lshlrev_b32 v68, 16, v248
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v71, -v15, v69, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v19.l, 0x7fff, v22.h, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v68, v68, v80
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v69, v71, v11 :: v_dual_and_b32 v22, 1, v2
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e32 vcc_lo, 0xc2fc0000, v72
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v71, 0xbfb8aa3b, v73 :: v_dual_mul_f32 v10, v68, v10
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v68, v12
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v70, -v12, v68, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v33, v3, v33 :: v_dual_and_b32 v6, 1, v6
	v_dual_mul_f32 v42, v3, v42 :: v_dual_fmac_f32 v71, 0xbfb8aa3b, v73
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v68, v70, v68
	v_div_scale_f32 v70, s1, v9, v5, v9
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v6, v10, v6, 0x7fff
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v26, v70, v68
	v_fma_f32 v24, -v12, v26, v70
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v26, v24, v68
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, vcc_lo
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	v_div_fmas_f32 v11, v15, v11, v69
	v_fma_f32 v12, -v12, v26, v70
	s_mov_b32 vcc_lo, s1
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v69, 16, v234
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v68, v26
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v1, v1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_div_fixup_f32 v9, v11, v18, v17
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_waitcnt vmcnt(18)
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v1, v23, v9 :: v_dual_lshlrev_b32 v16, 16, v16
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v23, 16, v225
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	v_mul_f32_e32 v23, v3, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v72, 0xbfb8aa3b, v67
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v23, v23, v220
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v72, v72
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_ldexp_f32 v15, v72, v24
	v_exp_f32_e32 v24, v71
	.loc	1 149 38 is_stmt 0              ; generate_amdgcn.py:149:38
	v_dual_add_f32 v15, 1.0, v15 :: v_dual_lshlrev_b32 v72, 16, v232
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v15, v15, v67
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v24, v26
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v26.h, 0x7fff, v22.h, vcc_lo
	...
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v26.l, 0x7fff, v6.h, vcc_lo
	v_and_b32_e32 v6, 1, v2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v9, v9, v73
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v6, v1, v6, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v22, -v12, v11, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v11, v22, v11
	v_div_scale_f32 v22, vcc_lo, v67, v15, v67
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v68, v75, v82 :: v_dual_mul_f32 v1, v22, v11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v5, v68, v5 :: v_dual_mul_f32 v68, 0xbfb8aa3b, v23
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v70, -v12, v1, v22
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v1, v70, v11 :: v_dual_and_b32 v10, 1, v17
	v_rcp_f32_e32 v17, v18
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v68, 0, 0x42800000, s2
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v1, v22
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_add3_u32 v10, v5, v10, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v68, 0xbfb8aa3b, v23
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v24, -v18, v17, 1.0
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v22, v68
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v1, v15, v67
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v67, 16, v218
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v17, v24, v17 :: v_dual_lshlrev_b32 v24, 16, v35
	v_div_scale_f32 v35, s1, v73, v9, v73
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v12, v22, v12
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v71, v35, v17 :: v_dual_add_f32 v12, 1.0, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v70, -v18, v71, v35
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v24, v3, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v15, null, v12, v12, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v71, v70, v17
	v_fma_f32 v11, -v18, v71, v35
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v18, v3, v69 :: v_dual_lshlrev_b32 v69, 16, v223
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v35.h, 0x7fff, v6.h, s0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v11, v11, v17, v71
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v11, v9, v73
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v1, v18, v1 :: v_dual_mul_f32 v22, v72, v83
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v24, v24, v219
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v35.l, 0x7fff, v10.h, vcc_lo
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	s_waitcnt vmcnt(1)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_add_f32 v11, 1.0, v11 :: v_dual_lshlrev_b32 v0, 16, v0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v11, v11, v24
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v22, v3, v67
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v70, v1, v17
	v_fma_f32 v67, -v18, v10, 1.0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v72, -v15, v70, v1
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v39, v3, v39
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v10, v67, v10
	v_div_scale_f32 v67, s1, v24, v11, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v70, v72, v17
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v75, v39, v213
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v39, v3, v68
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v73, v67, v10
	v_fma_f32 v1, -v15, v70, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v72, 0xbfb8aa3b, v75
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v76, v39, v230
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v68, -v18, v73, v67
	v_div_fmas_f32 v1, v1, v17, v70
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s3, 0xc2fc0000, v72
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s1
	v_dual_fmac_f32 v73, v68, v10 :: v_dual_lshlrev_b32 v70, 16, v216
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v17, -v18, v73, v67
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v67, v69, v229 :: v_dual_mul_f32 v70, v3, v70
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v39, 0xbfb8aa3b, v75
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v71, 0xbfb8aa3b, v22
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v10, v17, v10, v73
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v10, v10, v11, v24
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v11, 0, 0xffffffc0, s3
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v39.h, 0x7fff, v6.h, s0
	v_cndmask_b16 v39.l, 0x7fff, v5.h, vcc_lo
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v71, 0, 0x42800000, s2
	v_cndmask_b32_e64 v18, 0, 0xffffffc0, s2
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v10, v67, v10 :: v_dual_lshlrev_b32 v67, 16, v217
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v17, v11
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v9, null, v11, v11, v75
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v15.l, v10.h
	v_mov_b16_e32 v15.h, v2.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v6, v6, v22
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v43.h, 0x7fff, v18.h, s0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v18, -v9, v23, 1.0
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v23, v18, v23 :: v_dual_mul_f32 v18, v3, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v10, v15, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v15, vcc_lo, v22, v6, v22
	v_div_scale_f32 v24, s0, v75, v11, v75
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v18, v18, v208
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v68, v15, v17
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v71, -v12, v68, v15
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v73
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v68, v71, v17
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v1, v1, v209 :: v_dual_mul_f32 v72, v24, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v73, 0, 0x42800000, s2
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v68, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v71, -v9, v72, v24
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v69, 0xbfb8aa3b, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v73, 0xbfb8aa3b, v18
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v17, v68
	s_mov_b32 vcc_lo, s0
	v_fmac_f32_e32 v72, v71, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s1, 0xc2fc0000, v69
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v68, 16, v212
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v12, v6, v22
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v71, 16, v210
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v9, -v9, v72, v24
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v69, 0, 0x42800000, s1
	v_cndmask_b32_e64 v15, 0, 0xffffffc0, s1
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, s2
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v68, v3, v68
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v9, v9, v23, v72
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v23, v67, v203
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v69, 0xbfb8aa3b, v1
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v67, v70, v202 :: v_dual_lshlrev_b32 v70, 16, v205
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v17, v73
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v9, v11, v75
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v10, v10
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v68, v68, v197
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v6.h
	v_cndmask_b16 v43.l, 0x7fff, v5.h, vcc_lo
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v17, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v17.h, v2.h
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v15, v69, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 38 is_stmt 0              ; generate_amdgcn.py:149:38
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v22, null, v10, v10, v18
	v_div_scale_f32 v12, null, v15, v15, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v23, v22
	v_rcp_f32_e32 v11, v12
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_fma_f32 v69, -v22, v23, 1.0
	v_fma_f32 v24, -v12, v11, 1.0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v23, v69, v23
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v69, v3, v70
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v11, v24, v11
	v_div_scale_f32 v24, vcc_lo, v1, v15, v1
	v_div_scale_f32 v70, s0, v18, v10, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v69, v69, v59
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v72, v24, v11 :: v_dual_mul_f32 v9, v67, v9
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v59, v3, v71
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v75, v70, v23 :: v_dual_mul_f32 v76, 0xbfb8aa3b, v69
	v_fma_f32 v71, -v12, v72, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v72, v71, v11 :: v_dual_and_b32 v5, 1, v17
	v_fma_f32 v71, -v22, v75, v70
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v17, 16, v207
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v76, 0, 0x42800000, s2
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v72, v24
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_and_b32_e32 v67, 1, v2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v75, v71, v23 :: v_dual_fmac_f32 v76, 0xbfb8aa3b, v69
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v11, v12, v11, v72
	s_mov_b32 vcc_lo, s0
	v_fma_f32 v12, -v22, v75, v70
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v1, v11, v15, v1
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v15, v59, v196
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v23, v75
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v15, v6, v67, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v17, v17, v201 :: v_dual_and_b32 v6, 1, v2
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v73, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v15, v3, v15
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v73, 0, 0x42800000, s1
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, s1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v75, 0xbfb8aa3b, v15
	v_fmac_f32_e32 v73, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v75
	v_exp_f32_e32 v73, v73
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_ldexp_f32 v22, v73, v24
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v22, v22, v17
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v24, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v59.l, 0x7fff, v5.h, s0
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v24, null, v11, v11, v69
	v_div_scale_f32 v70, s1, v69, v11, v69
	v_fma_f32 v67, -v12, v18, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v23, v24
	v_fmac_f32_e32 v18, v67, v18
	v_div_scale_f32 v9, vcc_lo, v17, v22, v17
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v67, -v24, v23, 1.0
	v_dual_mul_f32 v68, v9, v18 :: v_dual_fmac_f32 v23, v67, v23
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v67, 16, v198
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v12, v68, v9
	v_mul_f32_e32 v73, v70, v23
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v67, v3, v67 :: v_dual_fmac_f32 v68, v72, v18
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v65, -v24, v73, v70
	v_fma_f32 v9, -v12, v68, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v72, 0xbfb8aa3b, v15
	v_mul_f32_e32 v75, 0xbfb8aa3b, v67
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v73, v65, v23
	v_div_fmas_f32 v9, v9, v18, v68
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_cmp_gt_f32_e64 s3, 0xc2fc0000, v75
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v24, -v24, v73, v70
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v70, 16, v194
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v9, v22, v17
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v65, 0, 0xffffffc0, s2
	v_cndmask_b32_e64 v12, 0, 0x42800000, s3
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v23, v24, v23, v73
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	...
	v_cmp_o_f32_e64 s0, v1, v1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v12, 0xbfb8aa3b, v67 :: v_dual_lshlrev_b32 v1, 16, v206
	...
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v22, 16, v193
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v65.l, 0x7fff, v5.h, vcc_lo
	v_cndmask_b16 v65.h, 0x7fff, v6.h, s0
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v1, v1, v189 :: v_dual_add_f32 v6, 1.0, v18
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v1, v1, v9
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v9, v12, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v6, v6, v15
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v17.h, v2.h
	v_mov_b16_e32 v2.l, v1.h
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v9, v9, v67
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v1, v5, 0x7fff
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v1, v3, v22 :: v_dual_lshlrev_b32 v22, 16, v199
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v71, 16, v204
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v1, v1, v187 :: v_dual_mul_f32 v22, v3, v22
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v71, v3, v71 :: v_dual_mul_f32 v72, 0xbfb8aa3b, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v22, v22, v181
	v_mul_f32_e32 v24, v71, v188
	.loc	1 149 26 is_stmt 1              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v11, v23, v11, v69
	v_rcp_f32_e32 v23, v18
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v69, 16, v192
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v68, -v18, v23, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v10, v24, v10
	v_div_scale_f32 v24, vcc_lo, v15, v6, v15
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v72, 0xbfb8aa3b, v1 :: v_dual_fmac_f32 v23, v68, v23
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v68, v3, v69 :: v_dual_mul_f32 v71, v24, v10
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v69, s1, v67, v9, v67
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v72, v72
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v68, v68, v186
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v73, -v12, v71, v24
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v75, v69, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v76, 0xbfb8aa3b, v68 :: v_dual_and_b32 v17, 1, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v71, v73, v10
	v_fma_f32 v73, -v18, v75, v69
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v71, v24
	v_fmac_f32_e32 v75, v73, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, s2
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v73, 16, v190
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v76, 0, 0x42800000, s3
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v10, v12, v10, v71
	v_fma_f32 v12, -v18, v75, v69
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v18, v72, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v76, 0xbfb8aa3b, v68
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v69, 16, v184
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v23, v75
	.loc	1 149 38 is_stmt 0              ; generate_amdgcn.py:149:38
	v_add_f32_e32 v18, 1.0, v18
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v10, v6, v15
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v24, v76
	v_cndmask_b32_e64 v10, 0, 0xffffffc0, s3
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v15, v70, v101
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v101.h, 0x7fff, v5.h, s0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v70, 16, v191
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v12, v9, v67
	v_div_scale_f32 v12, null, v18, v18, v1
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	...
	v_rcp_f32_e32 v10, v12
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v17, v3, v23
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v23, vcc_lo, v1, v18, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_scale_f32 v22, null, v5, v5, v68
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v67, -v22, v24, 1.0
	v_mul_f32_e32 v71, v23, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v72, 0, 0x42800000, s1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v24, v67, v24
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v67, v3, v69
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v69, s0, v68, v5, v68
	v_fma_f32 v75, -v12, v71, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v72, 0xbfb8aa3b, v17 :: v_dual_mul_f32 v67, v67, v179
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v76, v69, v24 :: v_dual_fmac_f32 v71, v75, v10
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v72, v72
	v_mul_f32_e32 v77, 0xbfb8aa3b, v67
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v75, -v22, v76, v69
	v_fma_f32 v12, -v12, v71, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v23, 0, 0xffffffc0, s1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v77
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v76, v75, v24 :: v_dual_lshlrev_b32 v75, 16, v182
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v10, v12, v10, v71
	s_mov_b32 vcc_lo, s0
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v22, v76, v69
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v22, v72, v23
	v_cndmask_b32_e64 v69, 0, 0xffffffc0, s2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v10, v18, v1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v77, 0xbfb8aa3b, v67
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v24, v76
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v24, v70, v174
	v_mul_f32_e32 v70, v73, v112
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v23, v77
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v5, v12, v5, v68
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v112.h, 0x7fff, v11.h, vcc_lo
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v22, 1.0, v22 :: v_dual_mul_f32 v1, v24, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v5, v70, v5 :: v_dual_lshlrev_b32 v24, 16, v176
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v18.h, v2.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v22, v22, v17
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v10, v23, v69
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	v_rcp_f32_e32 v10, v12
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v24, v24, v173 :: v_dual_mul_f32 v75, v3, v75
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v71, 16, v183
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v23, null, v6, v6, v67
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v70, 0xbfb8aa3b, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v69, s1, v67, v6, v67
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v68, -v23, v11, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v70, 0xbfb8aa3b, v24 :: v_dual_fmac_f32 v11, v68, v11
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v68, 16, v175
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v73, v69, v11 :: v_dual_mul_f32 v68, v3, v68
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v68, v68, v172
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v76, 0xbfb8aa3b, v68 :: v_dual_mul_f32 v9, v15, v9
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v15.h, v2.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_div_scale_f32 v18, vcc_lo, v17, v22, v17
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v9, v5, v9, 0x7fff
	v_add3_u32 v15, v1, v15, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v1, v18, v10
	v_fma_f32 v72, -v12, v1, v18
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v1, v72, v10
	v_fma_f32 v72, -v23, v73, v69
	v_fma_f32 v12, -v12, v1, v18
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v73, v72, v11
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v18, v70
	v_cndmask_b32_e64 v70, 0, 0x42800000, s3
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v12, v10, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v10, -v23, v73, v69
	s_mov_b32 vcc_lo, s1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v70, 0xbfb8aa3b, v68
	v_cndmask_b32_e64 v12, 0, 0xffffffc0, s2
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v23, v3, v71
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v10, v10, v11, v73
	v_div_fixup_f32 v1, v1, v22, v17
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v11, v70
	v_ldexp_f32 v12, v18, v12
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v18, v75, v167
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v10, v6, v67
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v10, 0, 0xffffffc0, s3
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v5, v5
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v12, 1.0, v12 :: v_dual_mul_f32 v23, v23, v121
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v11, null, v12, v12, v24
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v121.l, 0x7fff, v9.h, vcc_lo
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v1, v23, v1 :: v_dual_add_f32 v10, 1.0, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v17, v11
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v23, 16, v170
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v67, 16, v178
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v10, v10, v68
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e64 s0, v1, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v71, s1, v68, v10, v68
	...
	v_mov_b16_e32 v5.h, v2.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v17, v22, v17 :: v_dual_mul_f32 v22, v3, v23
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v15, v1, v15, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v1, vcc_lo, v24, v12, v24
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v23, -v18, v9, 1.0
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v22, v22, v166 :: v_dual_mul_f32 v67, v67, v135
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v70, v1, v17
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v72, 0xbfb8aa3b, v22 :: v_dual_lshlrev_b32 v23, 16, v168
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v73, -v11, v70, v1
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v69, 16, v177
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v75, v71, v9
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v23, v3, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v72
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v70, v73, v17
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v6, v5, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v73, -v18, v75, v71
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v75, v73, v9 :: v_dual_mul_f32 v76, 0xbfb8aa3b, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v72, 0xbfb8aa3b, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v1, v17, v70
	s_mov_b32 vcc_lo, s1
	v_fma_f32 v17, -v18, v75, v71
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s3, 0xc2fc0000, v76
	v_exp_f32_e32 v11, v72
	v_cndmask_b32_e64 v18, 0, 0xffffffc0, s2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v1, v12, v24
	v_div_fmas_f32 v9, v17, v9, v75
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v72, 0, 0x42800000, s3
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v69, v69, v129
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v1, v67, v1
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v9, v10, v68
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v72, 0xbfb8aa3b, v23
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v9, v69, v9 :: v_dual_and_b32 v18, 1, v2
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e64 s0, v1, v1
	v_mov_b16_e32 v15.h, v2.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v11, v11, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v18, v1, v18, 0x7fff
	v_mov_b16_e32 v15.l, v9.h
	...
	v_rcp_f32_e32 v17, v12
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v1, 16, v162
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v135.h, 0x7fff, v18.h, s0
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v10, 1.0, v10 :: v_dual_and_b32 v15, 1, v15
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v129.l, 0x7fff, v5.h, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v1, v3, v1 :: v_dual_lshlrev_b32 v68, 16, v171
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v9, v15, 0x7fff
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v6, null, v10, v10, v23
	v_fma_f32 v67, -v12, v17, 1.0
	v_div_scale_f32 v15, vcc_lo, v22, v11, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v24, v6
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v1, v1, v160
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v17, v67, v17
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v67, 16, v161
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v68, v3, v68 :: v_dual_lshlrev_b32 v71, 16, v169
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v70, 0xbfb8aa3b, v1
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v69, v15, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v71, v3, v71
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v18, -v6, v24, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s1, 0xc2fc0000, v70
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v12, v69, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v24, v18, v24
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v18, v3, v67
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v67, s0, v23, v10, v23
	v_fmac_f32_e32 v69, v72, v17
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v70, 0, 0x42800000, s1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v18, v18, v159 :: v_dual_mul_f32 v73, v67, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v69, v15
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v70, 0xbfb8aa3b, v1 :: v_dual_mul_f32 v75, 0xbfb8aa3b, v18
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v6, v73, v67
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v15, 0, 0xffffffc0, s1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v17, v69
	s_mov_b32 vcc_lo, s0
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v75
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v6, -v6, v73, v67
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v67, 0, 0xffffffc0, s2
	v_fmac_f32_e32 v75, 0xbfb8aa3b, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v6, v6, v24, v73
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v24, v68, v154
	v_mul_f32_e32 v68, v71, v153
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v15, v70, v15
	v_exp_f32_e32 v17, v75
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v6, v10, v23
	v_div_fixup_f32 v10, v12, v11, v22
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v9, v9
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v15, 1.0, v15
	...
	v_div_scale_f32 v12, null, v15, v15, v1
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v17, v67
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v17.l, v6.h
	v_mov_b16_e32 v17.h, v2.h
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v71, 16, v163
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v9.h
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v10, 1.0, v11
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v17, v3, v17 :: v_dual_lshlrev_b32 v68, 16, v164
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v23, v22
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v68, v3, v68 :: v_dual_fmac_f32 v11, v24, v11
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v24, vcc_lo, v1, v15, v1
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v73, 0xbfb8aa3b, v17
	...
	v_fma_f32 v69, -v22, v23, 1.0
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v68, v68, v146
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v72, v24, v11
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s1, 0xc2fc0000, v73
	...
	v_cndmask_b32_e64 v73, 0, 0x42800000, s1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v75, -v12, v72, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v69, v69, v151
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v76, v70, v23 :: v_dual_fmac_f32 v73, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v72, v75, v11 :: v_dual_mul_f32 v77, 0xbfb8aa3b, v69
	v_fma_f32 v75, -v22, v76, v70
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v73, v73
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v23, v76
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v11, 0, 0xffffffc0, s2
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v15, v71, v145 :: v_dual_add_f32 v22, 1.0, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v24, v77
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v10, v12, v10, v18
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v23.h, v2.h
	...
	v_cndmask_b16 v145.l, 0x7fff, v5.h, s0
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	v_div_scale_f32 v70, s1, v69, v11, v69
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v68, v9, v18 :: v_dual_mul_f32 v15, v15, v144
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_and_b32_e32 v6, 1, v2
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	v_add3_u32 v6, v1, v6, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v23, v67, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v68, v72, v18 :: v_dual_lshlrev_b32 v67, 16, v147
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v75
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	...
	v_mul_f32_e32 v1, v3, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v24, v73, v70
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v67, v67, v143
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v9, v9, v18, v68
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v75, 0xbfb8aa3b, v15
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v1, v1, v138
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v73, v72, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v76, 0xbfb8aa3b, v67
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v9, v22, v17
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v18, v75
	...
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v24, v71, v137
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v137.h, 0x7fff, v6.h, s0
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v12, 0xbfb8aa3b, v67
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v10, v10
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	...
	v_exp_f32_e32 v12, v12
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v137.l, 0x7fff, v5.h, vcc_lo
	v_cmp_o_f32_e64 s0, v1, v1
	v_and_b32_e32 v5, 1, v2
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v69, 16, v139
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v11, v24, v11 :: v_dual_lshlrev_b32 v70, 16, v149
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v1, v5, 0x7fff
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v1, v1, v136 :: v_dual_lshlrev_b32 v22, 16, v150
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v9, 1.0, v9
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v72, 0xbfb8aa3b, v1
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v9, v9, v67
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v17.l, v11.h
	...
	v_fma_f32 v24, -v12, v10, 1.0
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v22, v22, v128 :: v_dual_and_b32 v17, 1, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v72, 0, 0x42800000, s2
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v72, 0xbfb8aa3b, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v68, -v18, v23, 1.0
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_add3_u32 v17, v11, v17, 0x7fff
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v71, v24, v10
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v72, v72
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v23, v68, v23 :: v_dual_mul_f32 v68, v3, v69
	v_div_scale_f32 v69, s1, v67, v9, v67
	v_fma_f32 v73, -v12, v71, v24
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v68, v68, v134 :: v_dual_mul_f32 v75, v69, v23
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v71, v73, v10 :: v_dual_mul_f32 v76, 0xbfb8aa3b, v68
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v73, -v18, v75, v69
	v_fma_f32 v12, -v12, v71, v24
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	v_div_fmas_f32 v12, v12, v23, v75
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v18, 1.0, v18 :: v_dual_mul_f32 v15, v70, v127
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v127.h, 0x7fff, v5.h, s0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v24, v76
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	...
	v_cmp_o_f32_e32 vcc_lo, v11, v11
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v23, 16, v131
	v_lshlrev_b32_e32 v69, 16, v130
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v67, -v22, v24, 1.0
	v_dual_mul_f32 v71, v23, v10 :: v_dual_fmac_f32 v72, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v24, v67, v24 :: v_dual_and_b32 v15, 1, v15
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v67, v3, v69
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v69, s0, v68, v5, v68
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v67, v67, v125 :: v_dual_mul_f32 v76, v69, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v15, v9, v15, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v71, v75, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v77, 0xbfb8aa3b, v67
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v76, v75, v24
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v75, 16, v132
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v10, v12, v10, v71
	s_mov_b32 vcc_lo, s0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	v_mul_f32_e32 v1, v24, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_dual_mul_f32 v5, v70, v5 :: v_dual_lshlrev_b32 v24, 16, v122
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v18.h, v2.h
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v10, v23, v69
	...
	v_rcp_f32_e32 v10, v12
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v24, v24, v117 :: v_dual_and_b32 v9, 1, v18
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_div_scale_f32 v23, null, v6, v6, v67
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v70, 0xbfb8aa3b, v24 :: v_dual_and_b32 v15, 1, v2
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e64 s0, v1, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	v_add3_u32 v9, v5, v9, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v11, v68, v11 :: v_dual_lshlrev_b32 v68, 16, v120
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v72, -v12, v1, v18
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v70, 0xbfb8aa3b, v24 :: v_dual_mul_f32 v73, v69, v11
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v68, v3, v68 :: v_dual_fmac_f32 v1, v72, v10
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v23, v73, v69
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v73, v72, v11 :: v_dual_mul_f32 v76, 0xbfb8aa3b, v68
	v_div_fmas_f32 v1, v12, v10, v1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v12, 0, 0xffffffc0, s2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v23, v23, v109 :: v_dual_add_f32 v12, 1.0, v12
	v_mul_f32_e32 v18, v75, v110
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v10, v6, v67
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v10, 1.0, v10 :: v_dual_and_b32 v5, 1, v5
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v17, v11
	v_div_scale_f32 v1, s0, v24, v12, v24
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	s_mov_b32 vcc_lo, s0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v69, 16, v124
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v9, v18
	v_fma_f32 v22, -v11, v17, 1.0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v72, 16, v123
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v110.l, 0x7fff, v5.h, s1
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	v_fma_f32 v23, -v18, v9, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v6, v1, v17 :: v_dual_mul_f32 v15, v22, v108
	v_dual_fmac_f32 v9, v23, v9 :: v_dual_lshlrev_b32 v22, 16, v111
	v_div_scale_f32 v23, s2, v68, v10, v68
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v67, 0xbfb8aa3b, v15 :: v_dual_mul_f32 v22, v3, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v70, -v11, v6, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v71, v23, v9
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v6, v70, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v70, -v18, v71, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v67, 0, 0x42800000, s3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v73, 0xbfb8aa3b, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v1, -v11, v6, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v71, v70, v9 :: v_dual_lshlrev_b32 v70, 16, v115
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v67, 0xbfb8aa3b, v15
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cmp_gt_f32_e64 s4, 0xc2fc0000, v73
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v1, v17, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v6, -v18, v71, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v17, 0, 0xffffffc0, s3
	...
	s_mov_b32 vcc_lo, s2
	v_div_fixup_f32 v1, v1, v12, v24
	v_div_fmas_f32 v6, v6, v9, v71
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v9, v3, v69
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v9, v18, v11
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v68, vcc_lo, v15, v10, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v17, v12
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v5, v5, v22
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v17, v24, v17 :: v_dual_lshlrev_b32 v24, 16, v103
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v11, v6, v11, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v69, 0xbfb8aa3b, v9
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v72, v68, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v24, v3, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v71, -v18, v67, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s0, 0xc2fc0000, v69
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v76, -v12, v72, v68
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v24, v24, v95
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v67, v71, v67
	v_div_scale_f32 v71, s1, v22, v5, v22
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v69, 0, 0x42800000, s0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v73, 0xbfb8aa3b, v24 :: v_dual_fmac_f32 v72, v76, v17
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v77, v71, v67
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v80, 0, 0xffffffc0, s0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v69, 0xbfb8aa3b, v9
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v73
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v72, v68
	v_fma_f32 v76, -v18, v77, v71
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v69, v69
	v_cndmask_b32_e64 v73, 0, 0x42800000, s2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v17, v72
	v_fmac_f32_e32 v77, v76, v67
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v73, 0xbfb8aa3b, v24 :: v_dual_lshlrev_b32 v72, 16, v91
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v10, v12, v10, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_fma_f32 v17, -v18, v77, v71
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v18, 0, 0xffffffc0, s2
	v_ldexp_f32 v68, v69, v80
	v_exp_f32_e32 v69, v73
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v72, v3, v72
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v17, v17, v67, v77
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v1, v1
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v5, v17, v5, v22
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v17, v70, v88
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v67, null, v68, v68, v9
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v18, v69, v18
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v69, v75, v89
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	...
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v18, 1.0, v18 :: v_dual_mul_f32 v5, v69, v5
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v88.h, 0x7fff, v23.h, vcc_lo
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v69, 16, v93
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v18, v18, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v10.l, v5.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v17, -v67, v22, 1.0
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v69, v3, v69 :: v_dual_and_b32 v6, 1, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v22, v17, v22
	v_div_scale_f32 v10, s0, v9, v68, v9
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v64, v69, v64
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v69, 16, v250
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v23, v10, v22
	v_fma_f32 v11, -v12, v15, 1.0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v73, 0xbfb8aa3b, v64
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v69, v3, v69
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v70, -v67, v23, v10
	v_fmac_f32_e32 v15, v11, v15
	v_div_scale_f32 v11, s1, v24, v18, v24
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v73
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v23, v70, v22
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_and_b32_e32 v17, 1, v2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v71, v11, v15
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v6, v5, v6, 0x7fff
	v_cmp_o_f32_e64 s0, v1, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v10, -v67, v23, v10
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v67, v72, v63
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v70, -v12, v71, v11
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	s_mov_b32 vcc_lo, s1
	v_fmac_f32_e32 v71, v70, v15
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v63, 0xbfb8aa3b, v64 :: v_dual_mul_f32 v22, v3, v66
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v23, v69, v87
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v10, v68, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fma_f32 v11, -v12, v71, v11
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v12, 0xbfb8aa3b, v67 :: v_dual_mul_f32 v69, 0xbfb8aa3b, v57
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v11, v11, v15, v71
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v11, v11, v18, v24
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_mov_b16_e32 v10.h, v2.h
	v_cndmask_b16 v63.l, 0x7fff, v6.h, vcc_lo
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v23, 16, v60
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v9, v9, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_mul_f32_e32 v23, v3, v23
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v6, v11, v10, 0x7fff
	v_and_b32_e32 v15, 1, v2
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v5, 1.0, v5
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v69, 0xbfb8aa3b, v57
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v23, v23, v53
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v63.h, 0x7fff, v17.h, s0
	v_add3_u32 v15, v1, v15, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v10, null, v5, v5, v67
	v_fma_f32 v22, -v18, v12, 1.0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	v_dual_fmac_f32 v12, v22, v12 :: v_dual_lshlrev_b32 v1, 16, v94
	v_div_scale_f32 v22, vcc_lo, v64, v9, v64
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	v_mul_f32_e32 v1, v3, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v60, v22, v12 :: v_dual_lshlrev_b32 v17, 16, v99
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v53, -v10, v24, 1.0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v17, v3, v17 :: v_dual_fmac_f32 v24, v53, v24
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v53, s1, v67, v5, v67
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v52, 0xbfb8aa3b, v23
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v60, v66, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v18, -v18, v60, v22
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v22, 0, 0xffffffc0, s2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v66, -v10, v68, v53
	v_div_fmas_f32 v12, v18, v12, v60
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	s_mov_b32 vcc_lo, s1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v22, v52, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v12, v9, v64
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v52.h, 0x7fff, v15.h, s0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v10, -v10, v68, v53
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v15.h, v2.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v22, 1.0, v22 :: v_dual_mul_f32 v1, v1, v9
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v10, v10, v24, v68
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, s3
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v22, v22, v23
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v11, v11
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v5, v10, v5, v67
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v10, v18, v24
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v11, null, v9, v9, v57
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v17, v1, v17, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v1, s0, v23, v22, v23
	v_rcp_f32_e32 v6, v11
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v18, -v12, v10, 1.0
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v53.h, 0x7fff, v17.h, vcc_lo
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v10, v18, v10 :: v_dual_and_b32 v15, 1, v15
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v24, -v11, v6, 1.0
	v_dual_mul_f32 v17, v1, v10 :: v_dual_mul_f32 v18, v18, v45
	v_div_scale_f32 v45, s1, v57, v9, v57
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v6, v24, v6
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v24, 16, v100
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v60, 0xbfb8aa3b, v18
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v64, -v12, v17, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v66, v45, v6
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v24, v3, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v12, v44, v221
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v6, v9, v57
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v9, 0, 0xffffffc0, s3
	v_exp_f32_e32 v10, v60
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v11, 1.0, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v17, v17, v215 :: v_dual_mul_f32 v6, v12, v6
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v22, v3, v22
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v5, v5
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v10, null, v11, v11, v18
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v2.l, v1.h
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v17, null, v9, v9, v24
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v5.h, v2.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add3_u32 v15, v1, v15, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v1, vcc_lo, v18, v11, v18
	v_rcp_f32_e32 v23, v17
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fma_f32 v44, -v10, v12, 1.0
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v57
	.loc	1 144 16 is_stmt 1              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v45, v3, v45
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v12, v44, v12 :: v_dual_and_b32 v5, 1, v5
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v37, -v17, v23, 1.0
	v_dual_mul_f32 v56, v1, v12 :: v_dual_fmac_f32 v57, 0xbfb8aa3b, v22
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v23, v37, v23
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v37, v3, v44
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v44, s1, v24, v9, v24
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v57, v57
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v37, v37, v36 :: v_dual_lshlrev_b32 v36, 16, v54
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v54, -v10, v56, v1
	v_dual_mul_f32 v60, v44, v23 :: v_dual_mul_f32 v61, 0xbfb8aa3b, v37
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v1, -v10, v56, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v60, v54, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v10, 0, 0xffffffc0, s2
	v_cndmask_b32_e64 v61, 0, 0x42800000, s3
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v1, v12, v56
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v12, -v17, v60, v44
	s_mov_b32 vcc_lo, s1
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v61, 0xbfb8aa3b, v37
	v_cndmask_b32_e64 v44, 0, 0xffffffc0, s3
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v1, v1, v11, v18
	v_div_fmas_f32 v12, v12, v23, v60
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v10, v57, v10
	v_exp_f32_e32 v17, v61
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v23, v45, v74
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v9, v12, v9, v24
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 38 is_stmt 0              ; generate_amdgcn.py:149:38
	v_dual_add_f32 v10, 1.0, v10 :: v_dual_mul_f32 v1, v23, v1
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v9, v36, v9
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v12, null, v10, v10, v22
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v11, v17, v44
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v17.h, v2.h
	s_delay_alu instid0(VALU_DEP_4)
	v_mov_b16_e32 v17.l, v9.h
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v18, null, v11, v11, v37
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v54, 0xbfb8aa3b, v17 :: v_dual_and_b32 v5, 1, v2
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v23, v30, v23 :: v_dual_mul_f32 v30, v3, v44
	v_div_scale_f32 v44, s0, v37, v11, v37
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v49, -v12, v51, v24
	v_dual_mul_f32 v55, v44, v23 :: v_dual_fmac_f32 v54, 0xbfb8aa3b, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v56, 0xbfb8aa3b, v30 :: v_dual_mul_f32 v29, v3, v29
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v51, v49, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v49, -v18, v55, v44
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v51, v24
	v_fmac_f32_e32 v55, v49, v23
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v24, 0, 0xffffffc0, s1
	v_cndmask_b32_e64 v56, 0, 0x42800000, s2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v12, v12, v15, v51
	v_fma_f32 v15, -v18, v55, v44
	s_delay_alu instid0(TRANS32_DEP_1) | instid1(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v18, v54, v24
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v56, 0xbfb8aa3b, v30
	v_cndmask_b32_e64 v44, 0, 0xffffffc0, s2
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	v_div_fixup_f32 v10, v12, v10, v22
	v_div_fmas_f32 v15, v15, v23, v55
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v24, v56
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v18, 1.0, v18 :: v_dual_mul_f32 v23, v45, v79
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e64 s0, v9, v9
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v11, v15, v11, v37
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v1, v1
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v15, null, v18, v18, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v10, v23, v10 :: v_dual_mul_f32 v11, v29, v11
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v12, v24, v44
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v6, vcc_lo, v17, v18, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_and_b32_e32 v1, 1, v23
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v24, null, v12, v12, v30
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v44, v6, v22 :: v_dual_mul_f32 v23, v3, v23
	v_fma_f32 v37, -v24, v9, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v48, v23, v227 :: v_dual_lshlrev_b32 v23, 16, v41
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v23, v3, v23 :: v_dual_fmac_f32 v44, v41, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v41, -v24, v49, v45
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v9, v23, v9 :: v_dual_lshlrev_b32 v30, 16, v47
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_rcp_f32_e32 v17, v15
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v22.l, 0x7fff, v1.h, vcc_lo
	v_cndmask_b16 v23.h, 0x7fff, v11.h, s0
	v_and_b32_e32 v5, 1, v5
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v24, null, v12, v12, v37
	v_div_scale_f32 v11, vcc_lo, v48, v10, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v1, v9, v5, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v6, v24
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_fma_f32 v18, -v15, v17, 1.0
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v5, v3, v30
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v5, v5, v233 :: v_dual_mul_f32 v30, v3, v30
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v18, -v24, v6, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v34, v11, v17
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v41, 0xbfb8aa3b, v5 :: v_dual_fmac_f32 v6, v18, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_dual_mul_f32 v45, v42, v6 :: v_dual_fmac_f32 v34, v44, v17
	.loc	1 148 25 is_stmt 1              ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v18, v3, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_fma_f32 v44, -v24, v45, v42
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v11, -v15, v34, v11
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v18, v18, v235 :: v_dual_fmac_f32 v41, 0xbfb8aa3b, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v45, v44, v6
	v_div_fmas_f32 v11, v11, v17, v34
	s_mov_b32 vcc_lo, s0
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v24, v30, v238
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v6, v17, v6, v45
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_fmac_f32_e32 v44, 0xbfb8aa3b, v18
	...
	v_mul_f32_e32 v9, v24, v10
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_cndmask_b16 v23.l, 0x7fff, v1.h, vcc_lo
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v17, v44
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v30, v33, v237
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v11, null, v15, v15, v5
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_lshlrev_b32_e32 v33, 16, v40
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v37, v3, v37 :: v_dual_mul_f32 v6, v30, v6
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v1, null, v12, v12, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v10, v30, v10
	v_div_scale_f32 v30, vcc_lo, v5, v15, v5
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v38, s0, v18, v12, v18
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	s_mov_b32 vcc_lo, s0
	v_dual_mul_f32 v44, v38, v34 :: v_dual_fmac_f32 v45, 0xbfb8aa3b, v37
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v42, -v1, v44, v38
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v11, v45
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_add3_u32 v10, v9, v24, 0x7fff
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v10.l, 0x7fff, v17.h, s0
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v1, -v1, v44, v38
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	scratch_load_b32 v38, off, off offset:56 ; 4-byte Folded Reload
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v1, v1, v34, v44
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_fmac_f32_e32 v15, v24, v15
	v_div_scale_f32 v24, vcc_lo, v33, v30, v33
	.loc	1 144 9 is_stmt 1               ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(1)
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_mul_f32_e32 v5, v24, v15
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v17.h, 0x7fff, v17.h, s0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v28, -v12, v5, v24
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v5, v28, v15
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	scratch_load_b32 v28, off, off offset:48 ; 4-byte Folded Reload
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v12, -v12, v5, v24
	v_div_fmas_f32 v5, v12, v15, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_div_fixup_f32 v5, v5, v30, v33
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(1)
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v17.l, 0x7fff, v6.h, s2
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v6, 16, v21
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v21, -v18, v32, v27
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v1, v3, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_dual_fmac_f32 v32, v21, v9 :: v_dual_lshlrev_b32 v21, 16, v31
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v12, -v18, v32, v27
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v1, v1, v28 :: v_dual_mul_f32 v6, v6, v9
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v9, 0, 0x42800000, vcc_lo
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v24, 0xbfb8aa3b, v1 :: v_dual_fmac_f32 v9, 0xbfb8aa3b, v12
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v15, v15, v20 :: v_dual_lshlrev_b32 v20, 16, v25
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_scale_f32 v32, null, v21, v21, v15
	v_rcp_f32_e32 v38, v32
	.loc	1 148 13 is_stmt 1              ; generate_amdgcn.py:148:13
	s_waitcnt vmcnt(0)
	v_mul_f32_e32 v0, v0, v20
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v20, null, v11, v11, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v25, 0xbfb8aa3b, v0 :: v_dual_fmac_f32 v18, v30, v18
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v30, vcc_lo, v1, v11, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v16, s2, v15, v21, v15
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v25, 1.0, v25
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v40, -v20, v33, v30
	v_div_scale_f32 v34, null, v25, v25, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v30, s3, v0, v25, v0
	v_div_fmas_f32 v20, v20, v31, v42
	v_fma_f32 v31, -v32, v28, v16
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v7, -v32, v28, v16
	v_div_fmas_f32 v7, v7, v38, v28
	s_mov_b32 vcc_lo, s3
	s_delay_alu instid0(VALU_DEP_1)
	v_div_fixup_f32 v7, v7, v21, v15
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(0)
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v11, -v34, v33, v30
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v11, v11, v41, v33
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v6, v6
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v0, v11, v25, v0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 19 is_stmt 0              ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v0, v5, v0 :: v_dual_and_b32 v5, 1, v2
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	v_cmp_o_f32_e32 vcc_lo, v1, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v1, v0, v7, 0x7fff
	v_add3_u32 v2, v3, v2, 0x7fff
	scratch_load_b32 v3, off, off offset:20 ; 4-byte Folded Reload
	v_cndmask_b16 v0.h, 0x7fff, v5.h, vcc_lo
	...
	v_dual_cndmask_b32 v10, v22, v10 :: v_dual_cndmask_b32 v35, v0, v17
	v_dual_cndmask_b32 v0, v17, v0 :: v_dual_mov_b32 v17, 0x5410
	...
	v_cndmask_b32_e32 v3, v13, v26, vcc_lo
	v_cndmask_b32_e32 v1, v26, v13, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_cndmask_b32_e32 v16, v112, v129, vcc_lo
	...
	v_perm_b32 v2, v3, v1, v37
	v_perm_b32 v3, v3, v1, v38
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.private_seg_size, 540
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 540
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.kd
