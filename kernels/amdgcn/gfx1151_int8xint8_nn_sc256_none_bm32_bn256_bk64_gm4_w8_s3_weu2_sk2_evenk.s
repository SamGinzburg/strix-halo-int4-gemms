	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v17, 0x80000000, v6, s3
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v21, 0x80000000, v7, s3
	v_cndmask_b32_e64 v31, 0x80000000, v4, s2
	...
	v_cndmask_b32_e64 v3, 0x80000000, v29, s2
	v_cndmask_b32_e64 v8, 0x80000000, v30, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[45:46], v1, s[4:7], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[29:32], v31, s[28:31], 0 offen
	buffer_load_b128 v[33:36], v14, s[28:31], 0 offen
	buffer_load_b128 v[37:40], v3, s[28:31], 0 offen
	...
	s_waitcnt vmcnt(7)
	ds_store_b128 v14, v[17:20] offset:4096
	s_waitcnt vmcnt(6)
	ds_store_b128 v14, v[21:24] offset:8192
	s_waitcnt vmcnt(5)
	ds_store_b128 v14, v[25:28] offset:12288
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
...
.LBB0_3:                                ; %Flow62
	...
	v_mul_lo_u32 v52, v4, s0
	v_mul_lo_u32 v51, v3, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v122, v52, s1, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cmp_lt_i32 s1, s0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v124, v17, s14, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v123, v51, s1, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v67, s23, v15
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v68, s15, v9
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[166:167], v67, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v179, v122, s[36:39], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	buffer_load_u16 v180, v124, s[40:43], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v181, v123, s[36:39], 0 offen
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v69, s15, v16
	v_add_nc_u32_e32 v70, s15, v57
	v_add_nc_u32_e32 v71, s15, v10
	.loc	1 378 22 is_stmt 0              ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[122:125], v68, s[28:31], 0 offen
	buffer_load_b128 v[126:129], v69, s[28:31], 0 offen
	buffer_load_b128 v[130:133], v70, s[28:31], 0 offen
	buffer_load_b128 v[134:137], v71, s[28:31], 0 offen
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	...
	v_dual_fmac_f32 v21, v115, v97 :: v_dual_add_nc_u32 v244, s44, v59
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	...
	v_dual_mul_f32 v70, v70, v111 :: v_dual_fmac_f32 v25, v119, v101
	v_dual_mul_f32 v72, v72, v111 :: v_dual_fmac_f32 v29, v139, v105
	v_dual_mul_f32 v73, v73, v111 :: v_dual_fmac_f32 v18, v112, v94
	v_dual_mul_f32 v74, v74, v111 :: v_dual_fmac_f32 v37, v65, v81
	v_dual_mul_f32 v76, v76, v111 :: v_dual_fmac_f32 v33, v110, v109
	v_dual_mul_f32 v77, v77, v111 :: v_dual_fmac_f32 v20, v114, v96
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v19, v113, v95 :: v_dual_fmac_f32 v22, v116, v98
	v_dual_fmac_f32 v23, v117, v99 :: v_dual_fmac_f32 v24, v118, v100
	v_dual_fmac_f32 v26, v120, v102 :: v_dual_fmac_f32 v27, v121, v103
	v_dual_fmac_f32 v28, v138, v104 :: v_dual_fmac_f32 v31, v141, v107
	v_dual_fmac_f32 v30, v140, v106 :: v_dual_fmac_f32 v35, v63, v79
	v_dual_fmac_f32 v32, v142, v108 :: v_dual_fmac_f32 v39, v67, v83
	v_dual_fmac_f32 v34, v62, v78 :: v_dual_fmac_f32 v41, v69, v85
	v_dual_fmac_f32 v36, v64, v80 :: v_dual_fmac_f32 v43, v70, v86
	v_dual_fmac_f32 v38, v66, v82 :: v_dual_fmac_f32 v45, v72, v88
	v_dual_fmac_f32 v40, v68, v84 :: v_dual_fmac_f32 v47, v74, v90
	v_dual_fmac_f32 v44, v71, v87 :: v_dual_fmac_f32 v49, v76, v92
...
; %bb.10:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v96, s1, v56
	v_add_nc_u32_e32 v97, s1, v55
	v_add_nc_u32_e32 v104, s1, v54
	v_add_nc_u32_e32 v102, s1, v53
...
.LBB0_11:
	...
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v2, v93, s[20:23], 0 offen
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v4, v32, s[20:23], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v6, v94, s[20:23], 0 offen
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 245
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.kd
