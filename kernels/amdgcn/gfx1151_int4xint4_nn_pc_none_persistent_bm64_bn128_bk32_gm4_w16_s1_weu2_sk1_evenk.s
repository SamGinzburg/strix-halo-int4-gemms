	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph5
	...
	v_dual_mov_b32 v11, 0x5410 :: v_dual_and_b32 v8, 16, v0
	...
	v_lshl_or_b32 v0, v5, 4, v0
	s_add_i32 s0, s13, s0
	s_mov_b32 s24, s4
	s_ashr_i32 s35, s0, 1
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_and_or_b32 v24, v1, 1, v6
.Ltmp11:
...
.Ltmp16:
	...
	v_mad_u64_u32 v[18:19], null, s19, v2, v[1:2]
	...
	v_and_b32_e32 v33, 0x5040504, v11
	v_and_b32_e32 v34, 0x7060706, v8
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_and_or_b32 v19, v3, 14, s1
...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v45, s4, v30
	v_or_b32_e32 v46, s4, v31
	v_or_b32_e32 v47, s4, v32
	...
	v_mov_b16_e32 v51.h, v48.h
	v_mov_b16_e32 v52.h, v48.h
	v_mov_b16_e32 v53.h, v48.h
	v_add_lshl_u32 v49, s30, v16, 1
	...
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v59, v45, v9 :: v_dual_lshlrev_b32 v10, 16, v10
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v14, 16, v14
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v60, v46, v9
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v58, v15, v9 :: v_dual_mul_f32 v11, v10, v11
	.loc	1 269 18                        ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v13, 16, v13
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v45, v10, v45
	v_dual_mul_f32 v55, v12, v9 :: v_dual_mul_f32 v12, v10, v12
	v_mul_f32_e32 v15, v10, v15
	v_mul_f32_e32 v57, v14, v9
	v_mul_f32_e32 v14, v10, v14
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_mul_f32_e32 v8, v11, v8
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_mul_f32_e32 v56, v13, v9
	v_mul_f32_e32 v13, v10, v13
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v47, 16, v47
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v43, v55, v43 :: v_dual_mul_f32 v2, v14, v2
	v_mul_f32_e32 v6, v12, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v4, v13, v4 :: v_dual_mul_f32 v9, v47, v9
	.loc	1 270 20 is_stmt 0              ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v47, v10, v47 :: v_dual_mul_f32 v14, v59, v21
	v_mul_f32_e32 v10, v10, v46
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v11, v56, v42 :: v_dual_mul_f32 v12, v57, v41
	v_dual_mul_f32 v7, v9, v7 :: v_dual_mul_f32 v0, v47, v0
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_mov_b16_e32 v50.l, v8.h
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_mul_f32_e32 v13, v58, v40
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	...
	v_perm_b32 v0, v3, v1, v33
	v_perm_b32 v1, v3, v1, v34
	v_perm_b32 v2, v5, v7, v33
	v_perm_b32 v3, v5, v7, v34
	v_perm_b32 v4, v9, v6, v33
	v_perm_b32 v5, v9, v6, v34
	v_perm_b32 v6, v10, v8, v33
	v_perm_b32 v7, v10, v8, v34
	v_add_lshl_u32 v8, s30, v17, 1
	s_clause 0x1
	buffer_store_b128 v[0:3], v49, s[20:23], 0 offen
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v1, s6, 7, v18
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s3, v22
	s_lshl_b32 s5, s5, 7
	s_delay_alu instid0(VALU_DEP_3) | instid1(SALU_CYCLE_1)
	v_subrev_nc_u32_e32 v40, s5, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[20:21], null, s35, v2, v[19:20]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	buffer_load_u16 v21, v20, s[24:27], 0 offen
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b32 v49, v40, s[28:31], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[41:44], v36 offset1:1
	ds_load_2addr_stride64_b64 v[45:48], v37 offset1:1
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	ds_load_u8 v21, v39 offset:640
	ds_load_u8 v49, v39 offset:896
	ds_load_u8 v50, v39 offset:768
	ds_load_u8 v51, v39 offset:512
	ds_load_u8 v52, v39 offset:128
	ds_load_u8 v53, v39 offset:384
	ds_load_u8 v54, v39 offset:256
	ds_load_u8 v55, v39
	ds_load_u8 v56, v39 offset:1664
	ds_load_u8 v57, v39 offset:1920
	ds_load_u8 v58, v39 offset:1792
	ds_load_u8 v59, v39 offset:1536
	ds_load_u8 v60, v39 offset:1152
	ds_load_u8 v61, v39 offset:1280
	ds_load_u8 v62, v39 offset:1024
	ds_load_u8 v63, v39 offset:1408
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v49, v50, v49, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v21, v51, v21, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v51, v55, v52, 0xc0c0004
	v_perm_b32 v52, v54, v53, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v50, v49, 16, v21
	s_waitcnt lgkmcnt(5)
	...
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v55, v62, v60, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v61, v63, 0xc0c0004
	v_lshl_or_b32 v52, v54, 16, v53
	v_wmma_i32_16x16x16_iu4 v[0:7], v[49:50], v[41:42], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[49:50], v[43:44], v[8:15] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v51, v56, 16, v55
	v_wmma_i32_16x16x16_iu4 v[0:7], v[51:52], v[45:46], v[0:7] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu4 v[8:15], v[51:52], v[47:48], v[8:15] neg_lo:[1,1,0]
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 64
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn128_bk32_gm4_w16_s1_weu2_sk1_evenk.kd
