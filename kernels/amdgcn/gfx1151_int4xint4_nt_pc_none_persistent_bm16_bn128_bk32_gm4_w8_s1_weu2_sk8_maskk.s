	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp16:
	...
	s_cvt_u32_f32 s6, s6
	v_xor_b32_e32 v5, 12, v2
	v_xor_b32_e32 v34, 16, v2
	v_xor_b32_e32 v3, 20, v2
	v_xor_b32_e32 v36, 24, v2
	v_xor_b32_e32 v37, 28, v2
	v_xor_b32_e32 v39, 0x408, v0
	v_xor_b32_e32 v40, 0x810, v0
	v_xor_b32_e32 v41, 0xc18, v0
	v_xor_b32_e32 v42, 0x1040, v0
	v_xor_b32_e32 v43, 0x1448, v0
	v_xor_b32_e32 v44, 0x1850, v0
	v_xor_b32_e32 v45, 0x1c58, v0
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_mad_u64_u32 v[10:11], null, s25, v4, v[1:2]
	...
	v_or_b32_e32 v22, 12, v16
	v_or_b32_e32 v23, 14, v16
	v_sub_nc_u32_e32 v24, s29, v8
...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v5, s3, v16
	v_or_b32_e32 v6, s3, v17
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	v_lshlrev_b32_e32 v4, 1, v4
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v7, s3, v18
	v_or_b32_e32 v47, s3, v19
	v_or_b32_e32 v48, s3, v20
	v_or_b32_e32 v49, s3, v21
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	buffer_load_u16 v4, v4, s[20:23], 0 offen
	.loc	1 269 26                        ; generate_amdgcn.py:269:26
	v_or_b32_e32 v50, s3, v22
	v_or_b32_e32 v51, s3, v23
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	...
	v_dual_mul_f32 v49, v4, v49 :: v_dual_lshlrev_b32 v6, 16, v6
	.loc	1 269 18 is_stmt 1              ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v5, 16, v5
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v7, v7, v12 :: v_dual_mul_f32 v50, v4, v50
	.loc	1 269 18                        ; generate_amdgcn.py:269:18
	v_lshlrev_b32_e32 v48, 16, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v2, v49, v2 :: v_dual_mul_f32 v5, v4, v5
	.loc	1 270 20 is_stmt 0              ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v6, v4, v6 :: v_dual_mul_f32 v1, v50, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v48, v4, v48
	v_dual_mul_f32 v4, v4, v51 :: v_dual_mul_f32 v5, v5, v46
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v6, v6, v13 :: v_dual_mul_f32 v3, v48, v3
	...
	ds_load_b32 v6, v44
	ds_load_b32 v7, v45
	v_add3_u32 v11, s42, s3, v10
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 305 13 is_stmt 1              ; generate_amdgcn.py:305:13
	v_lshlrev_b32_e32 v12, 2, v11
	v_add_lshl_u32 v13, v11, s31, 2
	v_add_lshl_u32 v47, v11, s34, 2
	v_add_lshl_u32 v46, v11, s33, 2
	v_add_lshl_u32 v48, v11, s35, 2
	v_add_lshl_u32 v49, v11, s36, 2
	v_add_lshl_u32 v50, v11, s37, 2
	s_waitcnt lgkmcnt(7)
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s7, s7, s40
	s_mul_i32 s42, s6, s30
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, 0
	s_sub_i32 s3, s3, s42
	s_add_i32 s42, s6, 1
	s_sub_i32 s43, s3, s30
	s_cmp_ge_u32 s3, s30
	...
	s_abs_i32 s6, s42
	s_cvt_f32_u32 s43, s6
	s_sub_i32 s44, 0, s6
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_iflag_f32_e32 v0, s43
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s3, s3, 7
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s42, v15
	s_mov_b32 s44, s28
	v_subrev_nc_u32_e32 v3, s3, v1
	s_mov_b32 s45, s39
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[11:12], null, s29, v2, v[8:9]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[12:13], null, s29, v3, v[9:10]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_add_nc_u32_e32 v13, s44, v9
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	v_add_nc_u32_e32 v47, s44, v12
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	v_add_nc_u32_e32 v46, s44, v11
	.loc	1 255 27                        ; generate_amdgcn.py:255:27
	v_cmp_lt_i32_e32 vcc_lo, s44, v24
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	s_mov_b32 s6, s18
	...
	s_addk_i32 s44, 0x80
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	v_cndmask_b32_e64 v13, 0x80000000, v47, s3
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	s_cmp_lg_u32 s45, 0
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	buffer_load_b64 v[46:47], v13, s[4:7], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	buffer_load_u8 v13, v48, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	s_waitcnt vmcnt(1)
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 56
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
