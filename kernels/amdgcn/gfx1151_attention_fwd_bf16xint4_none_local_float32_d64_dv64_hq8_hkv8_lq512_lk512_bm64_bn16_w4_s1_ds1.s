	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	s_max_i32 s11, s4, 0
	v_dual_mov_b32 v1, v8 :: v_dual_add_nc_u32 v78, 0, v52
...
; %bb.1:                                ; %.lr.ph
	...
	v_xor_b32_e32 v9, 64, v79
	v_xor_b32_e32 v5, v13, v5
	.loc	1 707 13                        ; attention.py:707:13
	v_add3_u32 v13, s10, s22, v65
	v_mov_b32_e32 v65, 0
	...
	v_dual_mov_b32 v30, v65 :: v_dual_add_nc_u32 v81, s9, v3
	.loc	1 599 26                        ; attention.py:599:26
	v_xad_u32 v3, 0x70, v4, 0
	ds_load_b128 v[37:40], v3
	ds_load_b128 v[33:36], v6
	v_xad_u32 v3, v4, 48, 0
	ds_load_b128 v[45:48], v7
	ds_load_b128 v[41:44], v8
	v_dual_mov_b32 v32, v65 :: v_dual_and_b32 v7, 16, v0
	...
	v_dual_mov_b32 v7, 0x7632 :: v_dual_add_nc_u32 v4, 0, v4
	v_mov_b32_e32 v25, 0
	ds_load_b128 v[61:64], v3
	ds_load_b128 v[57:60], v4
	v_cndmask_b32_e64 v4, 0x1054, v6, s1
	v_cndmask_b32_e64 v6, 0x3276, v7, s1
	v_dual_mov_b32 v20, v65 :: v_dual_lshlrev_b32 v15, 5, v0
	...
	v_dual_mov_b32 v31, v65 :: v_dual_and_b32 v82, 0x5040504, v4
	v_dual_mov_b32 v22, v65 :: v_dual_and_b32 v83, 0x7060706, v6
	v_and_b32_e32 v6, 0x160, v15
	v_dual_mov_b32 v17, 0 :: v_dual_and_b32 v4, 0x700, v14
	v_xor_b32_e32 v7, 32, v79
	v_xor_b32_e32 v8, 48, v79
	s_delay_alu instid0(VALU_DEP_4)
	v_and_or_b32 v84, 0x90, v0, v6
	v_dual_mov_b32 v23, v65 :: v_dual_lshlrev_b32 v0, 3, v66
	v_mul_lo_u32 v6, s16, v13
	v_or_b32_e32 v13, s1, v77
	v_xor_b32_e32 v10, 0x50, v79
	v_xor_b32_e32 v11, 0x60, v79
	v_xor_b32_e32 v12, 0x70, v79
	v_dual_mov_b32 v21, v65 :: v_dual_add_nc_u32 v4, 0, v4
	s_mul_i32 s8, s17, s8
	v_xor_b32_e32 v14, 16, v84
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s0, s17, v1
	.loc	1 707 13                        ; attention.py:707:13
	v_lshl_add_u32 v85, s8, 1, v0
	v_mad_u64_u32 v[0:1], null, s17, v13, v[1:2]
	v_lshl_add_u32 v86, v6, 1, v2
	v_dual_mov_b32 v24, v65 :: v_dual_add_nc_u32 v87, 0, v3
	v_add_nc_u32_e32 v88, 0, v7
	v_add_nc_u32_e32 v89, 0, v8
	v_add_nc_u32_e32 v90, 0, v9
	v_add_nc_u32_e32 v91, 0, v10
	v_dual_mov_b32 v13, v65 :: v_dual_add_nc_u32 v92, 0, v11
	v_add_nc_u32_e32 v93, 0, v12
	v_dual_mov_b32 v15, v65 :: v_dual_add_nc_u32 v94, v4, v5
	v_dual_mov_b32 v16, v65 :: v_dual_add_nc_u32 v95, 0, v14
	v_mov_b32_e32 v28, v65
	v_dual_mov_b32 v18, v65 :: v_dual_mov_b32 v9, 0
	v_mov_b32_e32 v10, v65
	v_mov_b32_e32 v11, v65
	v_mov_b32_e32 v12, v65
	v_dual_mov_b32 v14, v65 :: v_dual_mov_b32 v1, 0
	v_mov_b32_e32 v2, v65
	v_dual_mov_b32 v3, v65 :: v_dual_mov_b32 v96, 0xff800000
	v_mov_b32_e32 v4, v65
	v_dual_mov_b32 v5, v65 :: v_dual_mov_b32 v76, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v73, 0x80000000, v86 :: v_dual_mov_b32 v66, v65
...
.Ltmp7:
	...
	v_perm_b32 v66, v67, v100, v82
	v_perm_b32 v67, v67, v100, v83
	.loc	1 768 33                        ; attention.py:768:33
	...
	v_perm_b32 v68, v69, v102, v82
	v_perm_b32 v69, v69, v102, v83
	.loc	1 768 33                        ; attention.py:768:33
	...
	v_perm_b32 v70, v71, v104, v82
	v_perm_b32 v71, v71, v104, v83
	.loc	1 768 33                        ; attention.py:768:33
	...
	v_perm_b32 v72, v73, v107, v82
	v_perm_b32 v73, v73, v107, v83
	.loc	1 775 32                        ; attention.py:775:32
	...
	v_cndmask_b32_e64 v107, 0x80000000, v85, s0
	.loc	1 707 13                        ; attention.py:707:13
	v_add_nc_u32_e32 v85, s34, v85
	.loc	1 797 41                        ; attention.py:797:41
	...
	v_dual_mul_f32 v27, v27, v114 :: v_dual_add_nc_u32 v96, 0, v84
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 115
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
