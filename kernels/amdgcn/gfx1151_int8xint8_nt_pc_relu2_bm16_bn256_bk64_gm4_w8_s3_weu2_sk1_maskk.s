	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[10:11], null, s27, v2, v[9:10]
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[11:12], null, s27, v5, v[9:10]
	v_lshl_add_u32 v39, s27, 6, v10
	v_lshl_add_u32 v40, s27, 7, v10
...
.Ltmp13:
	...
	buffer_load_b128 v[14:17], v2, s[20:23], 0 offen
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[18:21], v8, s[20:23], 0 offen
	buffer_load_b128 v[22:25], v12, s[20:23], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v8, v27, s[16:19], 0 offen
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v28, v2, s[16:19], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[30:33], v1, s[20:23], 0 offen
	buffer_load_b128 v[34:37], v12, s[20:23], 0 offen
	buffer_load_b128 v[45:48], v27, s[20:23], 0 offen
	buffer_load_b128 v[49:52], v26, s[20:23], 0 offen
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v12, v28 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v1, v[30:33] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v1, v[34:37] offset:20480
	s_waitcnt vmcnt(1)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s7, s35, 1
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v52, s3, v37
	v_cndmask_b32_e32 v46, 0x80000000, v48, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v121, v45, s[16:19], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[61:64], v46, s[20:23], 0 offen
	buffer_load_b128 v[65:68], v45, s[20:23], 0 offen
	buffer_load_b128 v[69:72], v47, s[20:23], 0 offen
	buffer_load_b128 v[73:76], v48, s[20:23], 0 offen
	v_add_nc_u32_e32 v49, s3, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v45, s6, v30
	v_add_nc_u32_e32 v46, s6, v33
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v50, s3, v35
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v47, s6, v32
	v_add_nc_u32_e32 v48, s6, v31
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v51, s3, v36
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v122, s8, v44
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v16, v16, v58 :: v_dual_add_nc_u32 v123, s30, v43
	v_add_f32_e32 v14, v14, v45
	v_dual_add_f32 v28, v28, v46 :: v_dual_add_f32 v27, v27, v47
	...
	v_dual_add_f32 v15, v15, v59 :: v_dual_add_f32 v12, v12, v60
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(4)
...
; %bb.8:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v5, s31, v32
	v_add_nc_u32_e32 v3, s31, v31
	...
	v_dual_add_f32 v17, v17, v3 :: v_dual_add_f32 v12, v12, v6
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v15, v15, v5 :: v_dual_add_f32 v14, v14, v7
.LBB0_9:
...
; %bb.10:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v6, s3, v32
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v4, s30, v37
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_11:
	...
	s_mov_b32 s4, s12
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v28, v4 :: v_dual_lshlrev_b32 v31, 1, v31
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	v_dual_add_f32 v39, v12, v44 :: v_dual_mov_b32 v46, 0x7632
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v47, v14, v3, s2
	...
	s_barrier
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v16, v42 :: v_dual_add_f32 v38, v15, v43
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_add3_u32 v0, v40, v1, v29
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v1, 16, v31
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v29, v15, v38, s2
	v_cndmask_b32_e64 v31, v12, v39, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v39.h, v43.h
	...
	.loc	1 416 18 is_stmt 0              ; generate_amdgcn.py:416:18
	v_add3_u32 v38, s26, s24, v42
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	s_mov_b32 s2, s6
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add_lshl_u32 v32, v38, v32, 1
	...
	v_dual_mul_f32 v5, v5, v30 :: v_dual_max_f32 v0, 0, v0
	v_dual_mul_f32 v6, v6, v30 :: v_dual_mul_f32 v1, v28, v1
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v12, v12, v30 :: v_dual_mul_f32 v7, v22, v7
	v_mul_f32_e32 v11, v11, v30
	v_dual_mul_f32 v13, v13, v30 :: v_dual_max_f32 v8, 0, v8
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v6, v23, v6
	v_dual_mul_f32 v10, v19, v10 :: v_dual_max_f32 v1, 0, v1
	v_mul_f32_e32 v12, v17, v12
	v_dual_mul_f32 v2, v27, v2 :: v_dual_mul_f32 v11, v18, v11
	...
	v_dual_max_f32 v2, 0, v2 :: v_dual_mul_f32 v1, v1, v1
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v9, v9, v30 :: v_dual_max_f32 v4, 0, v4
	v_mul_f32_e32 v14, v14, v30
	v_dual_mul_f32 v15, v15, v30 :: v_dual_max_f32 v12, 0, v12
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v13, v13, v13 :: v_dual_and_b32 v16, 1, v43
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v34.l, v2.h
	v_mov_b16_e32 v43.l, v3.h
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v9, v20, v9 :: v_dual_mul_f32 v14, v29, v14
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v15, v15, v15 :: v_dual_and_b32 v20, 1, v36
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_mov_b16_e32 v41.l, v14.h
	v_add3_u32 v4, v4, v19, 0x7fff
	v_dual_cndmask_b32 v6, 0x3276, v46 :: v_dual_and_b32 v21, 1, v37
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v32, s[0:3], 0 offen
	buffer_store_b128 v[4:7], v32, s[0:3], 0 offen offset:256
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 124
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
