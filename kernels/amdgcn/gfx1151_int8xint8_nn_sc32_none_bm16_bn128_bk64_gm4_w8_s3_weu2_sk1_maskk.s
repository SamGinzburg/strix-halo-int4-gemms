	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow119
	...
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v13, 0xf0, v0
...
.Ltmp23:
	...
	v_dual_mov_b32 v16, 0 :: v_dual_lshlrev_b32 v9, 1, v2
	s_waitcnt lgkmcnt(0)
	...
	v_or3_b32 v21, v4, v1, s14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_add_nc_u32_e32 v4, s17, v11
	s_mov_b32 s17, s5
	s_mov_b32 s5, s0
	v_dual_mov_b32 v20, 0 :: v_dual_lshlrev_b32 v5, 5, v0
	...
	s_lshl_b32 s2, s2, 7
	s_delay_alu instid0(VALU_DEP_3)
	v_and_b32_e32 v5, 0x160, v5
	v_and_b32_e32 v7, 0x17e, v7
	v_add_nc_u32_e32 v22, 0, v2
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_and_b32_e32 v6, 0x70, v3
	v_mul_lo_u32 v23, v12, s26
	v_and_or_b32 v5, 0x90, v10, v5
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_or_b32_e32 v10, s27, v14
	v_or_b32_e32 v24, 2, v21
	v_or_b32_e32 v25, 4, v21
	v_or_b32_e32 v26, 6, v21
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v36, 0, v5
	v_or_b32_e32 v1, 32, v10
	v_mul_lo_u32 v2, s15, v10
	v_mad_u64_u32 v[10:11], null, s24, v4, v[9:10]
	v_or_b32_e32 v28, 8, v21
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_lo_u32 v1, s15, v1
	v_or_b32_e32 v29, 10, v21
	v_or_b32_e32 v30, 12, v21
	v_or_b32_e32 v31, 14, v21
	v_add3_u32 v2, v2, s1, v6
	v_mov_b32_e32 v19, 0
	v_mov_b32_e32 v15, 0
	v_mov_b32_e32 v11, 0
	v_add3_u32 v1, v1, s1, v6
	v_subrev_nc_u32_e32 v33, s2, v2
	s_mov_b32 s1, s0
.Ltmp24:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	v_cndmask_b32_e32 v42, 0x80000000, v32, vcc_lo
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(3)
	ds_store_b16 v34, v46 offset:8192
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(2)
	ds_store_b128 v35, v[38:41]
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v34, v47 offset:8704
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v35, v[42:45] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	buffer_load_u16 v79, v57, s[4:7], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0xf
	buffer_load_u16 v80, v49, s[8:11], 0 offen
	buffer_load_u16 v81, v50, s[8:11], 0 offen
	buffer_load_u16 v82, v59, s[8:11], 0 offen
	buffer_load_u16 v83, v58, s[8:11], 0 offen
	buffer_load_u16 v84, v51, s[8:11], 0 offen
	buffer_load_u16 v85, v52, s[8:11], 0 offen
	buffer_load_u16 v86, v61, s[8:11], 0 offen
	buffer_load_u16 v87, v60, s[8:11], 0 offen
	buffer_load_u16 v88, v53, s[8:11], 0 offen
	buffer_load_u16 v89, v54, s[8:11], 0 offen
	buffer_load_u16 v90, v63, s[8:11], 0 offen
	buffer_load_u16 v91, v62, s[8:11], 0 offen
	buffer_load_u16 v92, v55, s[8:11], 0 offen
	buffer_load_u16 v93, v56, s[8:11], 0 offen
	buffer_load_u16 v94, v65, s[8:11], 0 offen
	buffer_load_u16 v95, v64, s[8:11], 0 offen
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v38, v22 offset:1664
	ds_load_u8 v39, v22 offset:1920
	ds_load_u8 v40, v22 offset:1792
	ds_load_u8 v41, v22 offset:1536
	ds_load_u8 v42, v22 offset:1152
	ds_load_u8 v43, v22 offset:1408
	ds_load_u8 v44, v22 offset:1280
	ds_load_u8 v45, v22 offset:1024
	ds_load_u8 v50, v22 offset:640
	ds_load_u8 v51, v22 offset:896
	ds_load_u8 v52, v22 offset:768
	ds_load_u8 v53, v22 offset:512
	ds_load_u8 v66, v22 offset:128
	ds_load_u8 v67, v22 offset:384
	ds_load_u8 v68, v22 offset:256
	ds_load_u8 v69, v22
	ds_load_u8 v70, v22 offset:3712
	ds_load_u8 v71, v22 offset:3968
	ds_load_u8 v72, v22 offset:3840
	ds_load_u8 v73, v22 offset:3584
	ds_load_u8 v74, v22 offset:3200
	ds_load_u8 v75, v22 offset:3456
	ds_load_u8 v76, v22 offset:3328
	ds_load_u8 v77, v22 offset:3072
	ds_load_u8 v96, v22 offset:2688
	ds_load_u8 v97, v22 offset:2944
	ds_load_u8 v98, v22 offset:2816
	ds_load_u8 v99, v22 offset:2560
	ds_load_u8 v100, v22 offset:2176
	ds_load_u8 v101, v22 offset:2432
	ds_load_u8 v102, v22 offset:2304
	ds_load_u8 v103, v22 offset:2048
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[46:49], v36 offset:8192
	ds_load_b128 v[54:57], v36 offset:8704
	ds_load_b128 v[58:61], v37 offset:8192
	ds_load_b128 v[62:65], v37 offset:8704
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v104, v22 offset:5760
	ds_load_u8 v105, v22 offset:6016
	ds_load_u8 v106, v22 offset:5888
	ds_load_u8 v107, v22 offset:5632
	ds_load_u8 v108, v22 offset:5248
	ds_load_u8 v109, v22 offset:5504
	ds_load_u8 v110, v22 offset:5376
	ds_load_u8 v111, v22 offset:5120
	ds_load_u8 v112, v22 offset:4736
	ds_load_u8 v113, v22 offset:4992
	ds_load_u8 v114, v22 offset:4864
	ds_load_u8 v115, v22 offset:4608
	ds_load_u8 v116, v22 offset:4224
	ds_load_u8 v117, v22 offset:4480
	ds_load_u8 v118, v22 offset:4352
	ds_load_u8 v119, v22 offset:4096
	ds_load_u8 v120, v22 offset:7808
	ds_load_u8 v121, v22 offset:8064
	ds_load_u8 v122, v22 offset:7936
	ds_load_u8 v123, v22 offset:7680
	ds_load_u8 v124, v22 offset:7296
	ds_load_u8 v125, v22 offset:7552
	ds_load_u8 v126, v22 offset:7424
	ds_load_u8 v127, v22 offset:7168
	ds_load_u8 v128, v22 offset:6784
	ds_load_u8 v129, v22 offset:7040
	ds_load_u8 v130, v22 offset:6912
	ds_load_u8 v131, v22 offset:6656
	ds_load_u8 v132, v22 offset:6272
	ds_load_u8 v133, v22 offset:6528
	ds_load_u8 v134, v22 offset:6400
	ds_load_u8 v135, v22 offset:6144
	...
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v46, v55, v46 :: v_dual_lshlrev_b32 v59, 16, v83
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v48, v55, v48 :: v_dual_lshlrev_b32 v61, 16, v85
	v_mul_f32_e32 v49, v55, v49
	v_dual_mul_f32 v38, v54, v38 :: v_dual_add_nc_u32 v33, s28, v33
	v_dual_mul_f32 v41, v54, v41 :: v_dual_add_nc_u32 v32, s28, v32
	v_dual_mul_f32 v43, v54, v43 :: v_dual_lshlrev_b32 v56, 16, v80
	v_dual_mul_f32 v45, v54, v45 :: v_dual_lshlrev_b32 v60, 16, v84
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v42, v54, v42 :: v_dual_lshlrev_b32 v63, 16, v87
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v50, v55, v50 :: v_dual_lshlrev_b32 v65, 16, v89
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v44, v54, v44 :: v_dual_lshlrev_b32 v67, 16, v91
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v52, v55, v52 :: v_dual_lshlrev_b32 v69, 16, v93
	v_dual_mul_f32 v39, v54, v39 :: v_dual_lshlrev_b32 v68, 16, v92
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_lshlrev_b32_e32 v64, 16, v88
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v40, v54, v40
	v_dual_mul_f32 v53, v55, v53 :: v_dual_lshlrev_b32 v62, 16, v86
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_lshlrev_b32_e32 v66, 16, v90
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v16, v38, v56 :: v_dual_lshlrev_b32 v71, 16, v95
	.loc	1 362 24 is_stmt 0              ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v47, v55, v47
	v_mul_f32_e32 v51, v55, v51
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v27, v39, v57 :: v_dual_lshlrev_b32 v70, 16, v94
	v_fmac_f32_e32 v17, v42, v64
	v_dual_fmac_f32 v19, v40, v60 :: v_dual_fmac_f32 v18, v43, v65
	v_fmac_f32_e32 v11, v45, v69
	v_dual_fmac_f32 v20, v41, v61 :: v_dual_fmac_f32 v15, v44, v68
	v_dual_fmac_f32 v16, v46, v59 :: v_dual_fmac_f32 v27, v47, v58
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v19, v48, v63 :: v_dual_fmac_f32 v20, v49, v62
	v_dual_fmac_f32 v17, v50, v67 :: v_dual_fmac_f32 v18, v51, v66
	v_fmac_f32_e32 v15, v52, v71
	v_fmac_f32_e32 v11, v53, v70
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 136
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
