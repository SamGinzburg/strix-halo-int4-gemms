	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v49, v12, 4, v4
	v_lshl_add_u32 v50, s29, 1, v49
	v_add_nc_u32_e32 v51, s28, v49
...
.Ltmp13:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v3, 0x80000000, v11, s2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_cndmask_b32_e64 v2, 0x80000000, v10, s2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v10, 0x80000000, v25, s2
	s_clause 0x1
	buffer_load_b128 v[25:28], v3, s[24:27], 0 offen
	buffer_load_b128 v[29:32], v10, s[24:27], 0 offen
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v3, s4, v49
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v10, s29, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v3, 0x80000000, v3, s2
	v_cndmask_b32_e64 v10, 0x80000000, v10, s2
	s_clause 0x1
	buffer_load_b128 v[33:36], v3, s[24:27], 0 offen
	buffer_load_b128 v[37:40], v10, s[24:27], 0 offen
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	buffer_load_b64 v[43:44], v2, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v2, v0, 0, 1
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v53, v2, v45
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v54, v10, 10, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v8, 0, v53
	v_lshlrev_b32_e32 v3, 5, v0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v59, 0x90, v54
	v_xor_b32_e32 v60, 0x120, v54
	v_xor_b32_e32 v61, 0x1b0, v54
	v_xor_b32_e32 v62, 0x210, v54
	v_add_nc_u32_e32 v45, 0, v54
	v_xor_b32_e32 v63, 0x330, v54
	v_xor_b32_e32 v64, 0x3a0, v54
	v_add_nc_u32_e32 v46, 0, v59
	...
	v_add_nc_u32_e32 v66, 0x4000, v45
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	v_perm_b32 v41, v13, v4, 0x4000501
	...
	v_perm_b32 v32, v41, v16, 0x7060302
	...
	v_perm_b32 v37, v38, v34, 0x4000501
	...
	ds_store_2addr_b32 v45, v32, v16 offset1:16
	...
	ds_store_2addr_b32 v57, v18, v14 offset1:16
	ds_store_2addr_b32 v45, v22, v6 offset0:160 offset1:176
	ds_store_2addr_b32 v58, v19, v15 offset1:16
	ds_store_2addr_b32 v65, v23, v7 offset1:16
	v_perm_b32 v4, v24, v20, 0x7060302
	v_perm_b32 v5, v24, v20, 0x5040100
	v_perm_b32 v6, v25, v33, 0x7060302
	v_perm_b32 v7, v25, v33, 0x5040100
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v8, v29, v37, 0x7060302
	...
	v_perm_b32 v18, v27, v35, 0x7060302
	v_perm_b32 v19, v27, v35, 0x5040100
	v_perm_b32 v20, v31, v39, 0x7060302
	v_perm_b32 v21, v31, v39, 0x5040100
	v_perm_b32 v22, v28, v36, 0x7060302
	v_perm_b32 v23, v28, v36, 0x5040100
	ds_store_2addr_b32 v66, v4, v5 offset1:16
	ds_store_2addr_b32 v67, v6, v7 offset1:16
	ds_store_2addr_b32 v68, v8, v13 offset1:16
	ds_store_2addr_b32 v69, v14, v15 offset1:16
	ds_store_2addr_b32 v70, v16, v17 offset1:16
	ds_store_2addr_b32 v66, v18, v19 offset0:160 offset1:176
	ds_store_2addr_b32 v71, v20, v21 offset1:16
	ds_store_2addr_b32 v72, v22, v23 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v57, 48, v2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_mov_b32 s6, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v45, v12, 6, v57
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v58, v1, 6, v6
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v4, v0, 3, 1
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v57, 48, v2
.Ltmp14:
...
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v65, s29, v49
	v_lshl_or_b32 v58, v1, 6, v2
	v_xor_b32_e32 v1, v3, v57
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s7, s6, s29
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v70, s6, v52
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s7, s7, s18
	s_mov_b32 s6, s31
	v_add_nc_u32_e32 v71, s7, v49
	v_add_nc_u32_e32 v72, s7, v65
	v_add_nc_u32_e32 v73, s7, v50
	v_add_nc_u32_e32 v74, s7, v51
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b64 v[174:175], v70, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[102:105], v71, s[24:27], 0 offen
	buffer_load_b128 v[106:109], v72, s[24:27], 0 offen
	buffer_load_b128 v[110:113], v73, s[24:27], 0 offen
	buffer_load_b128 v[114:117], v74, s[24:27], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v70, s6, v45
	v_add_nc_u32_e32 v71, s6, v46
	s_mov_b32 s31, s1
	s_mov_b32 s1, s4
	v_add_nc_u32_e32 v72, s6, v48
	v_add_nc_u32_e32 v73, s6, v47
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v74, s1, v66
	v_add_nc_u32_e32 v75, s1, v67
	v_add_nc_u32_e32 v76, s1, v68
	v_add_nc_u32_e32 v77, s1, v69
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[86:89], v70
	ds_load_b128 v[118:121], v70 offset:1024
	ds_load_b128 v[122:125], v71
	ds_load_b128 v[126:129], v71 offset:1024
	ds_load_b128 v[130:133], v72
	ds_load_b128 v[134:137], v72 offset:1024
	ds_load_b128 v[138:141], v73
	ds_load_b128 v[142:145], v73 offset:1024
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[94:97], v74
	ds_load_b128 v[146:149], v74 offset:8192
	ds_load_b128 v[150:153], v75
	ds_load_b128 v[154:157], v75 offset:8192
	ds_load_b128 v[158:161], v76
	ds_load_b128 v[162:165], v76 offset:8192
	ds_load_b128 v[166:169], v77
	ds_load_b128 v[170:173], v77 offset:8192
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s7, s35, 1
	s_mov_b32 s4, s19
	s_cmp_lt_i32 s7, 2
	...
	v_wmma_i32_16x16x16_iu8 v[78:85], v[146:149], v[86:89], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[86:93], v[94:97], v[118:121], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[94:101], v[146:149], v[118:121], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[70:77], v[150:153], v[122:125], v[70:77] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[78:85], v[154:157], v[122:125], v[78:85] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[86:93], v[150:153], v[126:129], v[86:93] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[94:101], v[154:157], v[126:129], v[94:101] neg_lo:[1,1,0]
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s5, s34
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[70:77], v[158:161], v[130:133], v[70:77] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[78:85], v[162:165], v[130:133], v[78:85] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[86:93], v[158:161], v[134:137], v[86:93] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[94:101], v[162:165], v[134:137], v[94:101] neg_lo:[1,1,0]
	s_mov_b32 s5, s6
	v_wmma_i32_16x16x16_iu8 v[70:77], v[166:169], v[138:141], v[70:77] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[78:85], v[170:173], v[138:141], v[78:85] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[86:93], v[166:169], v[142:145], v[86:93] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[94:101], v[170:173], v[142:145], v[94:101] neg_lo:[1,1,0]
	...
	v_dual_add_f32 v38, v38, v77 :: v_dual_add_nc_u32 v177, s19, v54
	v_dual_add_f32 v36, v36, v79 :: v_dual_add_f32 v37, v37, v78
	v_dual_add_f32 v31, v31, v84 :: v_dual_add_nc_u32 v176, s8, v53
	v_dual_add_f32 v27, v27, v88 :: v_dual_add_nc_u32 v178, s19, v59
	v_dual_add_f32 v32, v32, v83 :: v_dual_add_nc_u32 v179, s19, v60
	v_dual_add_f32 v25, v25, v90 :: v_dual_add_nc_u32 v180, s19, v61
	v_dual_add_f32 v30, v30, v85 :: v_dual_add_nc_u32 v181, s19, v62
	v_dual_add_f32 v23, v23, v92 :: v_dual_add_nc_u32 v182, s19, v63
	v_dual_add_f32 v28, v28, v87 :: v_dual_add_nc_u32 v183, s19, v64
	v_dual_add_f32 v35, v35, v80 :: v_dual_add_f32 v34, v34, v81
	v_add_f32_e32 v33, v33, v82
	v_dual_add_f32 v29, v29, v86 :: v_dual_add_f32 v26, v26, v89
	v_dual_add_f32 v21, v21, v94 :: v_dual_add_f32 v24, v24, v91
	v_dual_add_f32 v19, v19, v96 :: v_dual_add_f32 v22, v22, v93
	v_dual_add_f32 v17, v17, v98 :: v_dual_add_f32 v20, v20, v95
	v_dual_add_f32 v15, v15, v100 :: v_dual_add_f32 v18, v18, v97
	v_dual_add_f32 v16, v16, v99 :: v_dual_add_f32 v13, v13, v101
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(4)
	ds_store_b64 v176, v[174:175] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v70, v106, v102, 0x4000501
	v_perm_b32 v72, v106, v102, 0x6020703
	s_waitcnt vmcnt(0)
	v_perm_b32 v71, v114, v110, 0x4000501
	v_perm_b32 v73, v114, v110, 0x6020703
	v_perm_b32 v74, v107, v103, 0x4000501
	v_perm_b32 v75, v115, v111, 0x4000501
	v_perm_b32 v76, v107, v103, 0x6020703
	v_perm_b32 v77, v115, v111, 0x6020703
	v_perm_b32 v78, v108, v104, 0x4000501
	v_perm_b32 v79, v116, v112, 0x4000501
	v_perm_b32 v80, v108, v104, 0x6020703
	v_perm_b32 v81, v116, v112, 0x6020703
	v_perm_b32 v82, v109, v105, 0x4000501
	v_perm_b32 v83, v117, v113, 0x4000501
	v_perm_b32 v84, v109, v105, 0x6020703
	v_perm_b32 v85, v117, v113, 0x6020703
	...
	ds_store_2addr_b32 v177, v86, v70 offset1:16
	ds_store_2addr_b32 v178, v71, v72 offset1:16
	ds_store_2addr_b32 v179, v73, v74 offset1:16
	ds_store_2addr_b32 v180, v75, v76 offset1:16
	ds_store_2addr_b32 v181, v77, v78 offset1:16
	ds_store_2addr_b32 v177, v79, v80 offset0:160 offset1:176
	ds_store_2addr_b32 v182, v81, v82 offset1:16
	ds_store_2addr_b32 v183, v83, v84 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v5, v55 :: v_dual_mov_b32 v4, v56
	s_branch .LBB0_8
.LBB0_7:
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v51, s19, v1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v45, s1, v45
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v76, s11 :: v_dual_add_nc_u32 v5, s19, v4
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v74, s9 :: v_dual_add_nc_u32 v49, s19, v2
	v_dual_mov_b32 v75, s10 :: v_dual_add_nc_u32 v50, s19, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 184
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
