	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp12:
	...
	v_and_b32_e32 v49, 0x5040504, v6
	s_cvt_u32_f32 s5, s5
	...
	s_mul_i32 s6, s6, s5
	v_or_b32_e32 v41, 16, v33
	s_mul_hi_u32 s1, s5, s6
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_or_b32_e32 v42, 0x100, v40
	v_sub_nc_u32_e32 v43, s59, v33
	v_xor_b32_e32 v45, 4, v44
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_add_nc_u32_e32 v47, v9, v12
	v_add_nc_u32_e32 v48, 0x100, v46
	v_and_b32_e32 v50, 0x7060706, v7
	s_add_i32 s63, s5, s1
...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v18, s4, v33
	v_or_b32_e32 v19, s4, v41
	...
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	v_add_lshl_u32 v70, s4, v47, 1
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	s_clause 0x1
	buffer_load_u16 v68, v18, s[48:51], 0 offen
	buffer_load_u16 v69, v19, s[48:51], 0 offen
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_add_lshl_u32 v71, s4, v46, 1
	v_add_lshl_u32 v72, s4, v48, 1
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_cmp_lt_i32 s2, s57
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	s_waitcnt vmcnt(0)
	...
	ds_load_b128 v[25:28], v55 offset:1024
	ds_load_b128 v[29:32], v55 offset:1040
	s_waitcnt lgkmcnt(3)
	v_mul_f32_e32 v73, v17, v68
	v_dual_mul_f32 v17, v17, v69 :: v_dual_mul_f32 v74, v18, v68
	v_mul_f32_e32 v76, v20, v68
	s_waitcnt lgkmcnt(2)
	v_mul_f32_e32 v78, v22, v68
	v_mul_f32_e32 v80, v24, v68
	v_dual_mul_f32 v75, v19, v68 :: v_dual_mul_f32 v18, v18, v69
	v_dual_mul_f32 v77, v21, v68 :: v_dual_mul_f32 v20, v20, v69
	v_dual_mul_f32 v79, v23, v68 :: v_dual_mul_f32 v22, v22, v69
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v81, v25, v68 :: v_dual_mul_f32 v24, v24, v69
	v_dual_mul_f32 v82, v26, v68 :: v_dual_mul_f32 v19, v19, v69
	v_dual_mul_f32 v83, v27, v68 :: v_dual_mul_f32 v26, v26, v69
	v_dual_mul_f32 v84, v28, v68 :: v_dual_mul_f32 v21, v21, v69
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v85, v29, v68 :: v_dual_mul_f32 v28, v28, v69
	v_dual_mul_f32 v86, v30, v68 :: v_dual_mul_f32 v23, v23, v69
	v_dual_mul_f32 v87, v31, v68 :: v_dual_mul_f32 v30, v30, v69
	v_dual_mul_f32 v68, v32, v68 :: v_dual_mul_f32 v25, v25, v69
	v_dual_mul_f32 v27, v27, v69 :: v_dual_mul_f32 v66, v74, v66
	v_dual_mul_f32 v29, v29, v69 :: v_dual_mul_f32 v64, v76, v64
	v_dual_mul_f32 v31, v31, v69 :: v_dual_mul_f32 v62, v78, v62
	v_dual_mul_f32 v32, v32, v69 :: v_dual_mul_f32 v67, v73, v67
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v65, v75, v65 :: v_dual_mul_f32 v60, v80, v60
	v_dual_mul_f32 v63, v77, v63 :: v_dual_mul_f32 v58, v82, v58
	v_dual_mul_f32 v61, v79, v61 :: v_dual_mul_f32 v56, v84, v56
	v_dual_mul_f32 v59, v81, v59 :: v_dual_mul_f32 v36, v87, v36
	v_dual_mul_f32 v57, v83, v57 :: v_dual_mul_f32 v38, v85, v38
	v_dual_mul_f32 v37, v86, v37 :: v_dual_mul_f32 v16, v17, v16
	v_dual_mul_f32 v35, v68, v35 :: v_dual_mul_f32 v14, v19, v14
	...
	v_add3_u32 v14, v14, v73, 0x7fff
	v_add3_u32 v13, v13, v74, 0x7fff
	v_add3_u32 v12, v12, v75, 0x7fff
	v_add3_u32 v11, v11, v76, 0x7fff
	v_add3_u32 v10, v10, v77, 0x7fff
	v_add3_u32 v9, v9, v78, 0x7fff
	...
	v_perm_b32 v1, v4, v2, v49
	v_perm_b32 v2, v4, v2, v50
	v_perm_b32 v3, v5, v6, v49
	v_perm_b32 v4, v5, v6, v50
	v_perm_b32 v5, v7, v10, v49
	v_perm_b32 v6, v7, v10, v50
	v_perm_b32 v7, v8, v14, v49
	v_perm_b32 v8, v8, v14, v50
	v_perm_b32 v9, v11, v17, v49
	v_perm_b32 v10, v11, v17, v50
	v_perm_b32 v11, v12, v15, v49
	v_perm_b32 v12, v12, v15, v50
	v_perm_b32 v13, v16, v18, v49
	v_perm_b32 v14, v16, v18, v50
	v_perm_b32 v15, v20, v19, v49
	v_perm_b32 v16, v20, v19, v50
	s_clause 0x3
	buffer_store_b128 v[1:4], v70, s[36:39], 0 offen
	buffer_store_b128 v[5:8], v70, s[36:39], 0 offen offset:512
	buffer_store_b128 v[9:12], v71, s[36:39], 0 offen
	buffer_store_b128 v[13:16], v72, s[36:39], 0 offen
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v4, s4, v39
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	s_lshl_b32 s6, s6, 9
	s_lshl_b32 s3, s3, 9
	v_or_b32_e32 v2, s6, v42
	v_or_b32_e32 v3, s6, v40
	v_mad_u64_u32 v[35:36], null, s59, v4, v[33:34]
	v_mov_b32_e32 v4, v1
	...
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
	v_mad_u64_u32 v[36:37], null, s59, v2, v[34:35]
	v_mad_u64_u32 v[37:38], null, s59, v3, v[34:35]
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v8, v1
	v_mov_b32_e32 v9, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	s_clause 0x1
	buffer_load_b64 v[56:57], v56, s[44:47], 0 offen
	buffer_load_b64 v[58:59], v58, s[44:47], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	...
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	s_waitcnt vmcnt(2)
	ds_bpermute_b32 v67, v44, v57
	ds_bpermute_b32 v65, v45, v56
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt vmcnt(0)
	ds_store_b8 v51, v38
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	ds_bpermute_b32 v38, v44, v56
	ds_bpermute_b32 v68, v45, v57
	ds_bpermute_b32 v70, v44, v58
	ds_bpermute_b32 v71, v44, v59
	ds_bpermute_b32 v72, v45, v58
	ds_bpermute_b32 v73, v45, v59
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[56:59], v52 offset1:32
	ds_load_2addr_b64 v[60:63], v53 offset1:32
	.loc	1 263 26                        ; generate_amdgcn.py:263:26
	v_cndmask_b32_e64 v64, v65, v38, s0
	v_cndmask_b32_e64 v66, v38, v65, s0
	v_cndmask_b32_e64 v65, v68, v67, s0
	v_cndmask_b32_e64 v67, v67, v68, s0
	v_cndmask_b32_e64 v68, v72, v70, s0
	v_cndmask_b32_e64 v69, v73, v71, s0
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[68:69], v[56:57], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[68:69], v[58:59], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[66:67], v[60:61], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[66:67], v[62:63], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[70:71], v[60:61], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[70:71], v[62:63], v[25:32] neg_lo:[1,1,0]
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.Ltmp13:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_vgpr, 88
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.numbered_sgpr, 66
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     68
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.kd
