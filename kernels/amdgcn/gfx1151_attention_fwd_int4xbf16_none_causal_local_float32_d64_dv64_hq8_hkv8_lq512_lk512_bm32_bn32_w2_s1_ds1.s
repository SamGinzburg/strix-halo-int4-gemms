...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v72, 0x5410 :: v_dual_and_b32 v5, 24, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 779 31                        ; attention.py:779:31
	v_lshlrev_b32_e32 v1, 1, v1
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v6, 48, v43
	s_load_b32 s3, s[0:1], 0x68
	v_dual_mov_b32 v75, 0x7632 :: v_dual_and_b32 v74, 7, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_cndmask_b32_e64 v1, 0x80000000, v1, s2
	v_dual_mov_b32 v28, v25 :: v_dual_and_b32 v3, 0x3f0, v43
	...
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v73, s14, v44
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_cndmask_b32_e64 v38, 0x1054, v72, s1
	...
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[50:51], null, s61, v51, v[50:51]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.num_vgpr, 146
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.numbered_sgpr, 66
