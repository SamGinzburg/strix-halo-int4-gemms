	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 787 26                        ; attention.py:787:26
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[102:103], null, s61, v66, v[65:66]
	s_mul_i32 s8, s61, s46
	.loc	1 790 61                        ; attention.py:790:61
	v_cmp_gt_i32_e64 s31, s61, v65
	.loc	1 787 26                        ; attention.py:787:26
	s_lshl_b32 s9, s61, 5
	...
	.loc	1 787 26                        ; attention.py:787:26
	v_add_nc_u32_e32 v1, s8, v102
	v_lshl_add_u32 v116, s61, 4, v102
...
.LBB0_3:                                ; %Flow229
	...
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v117, 0x78, v0
	v_and_b32_e32 v115, 0x60, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v1, s14, v1
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v5, 7, v113
	v_dual_mov_b32 v27, v25 :: v_dual_lshlrev_b32 v6, 6, v115
	v_dual_mov_b32 v32, v25 :: v_dual_lshlrev_b32 v7, 4, v33
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v128, s12, v1
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v132, s13, v1
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v5, v6, v7
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v3, s14, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v129, s12, v2
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v133, s13, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v2, 0x70, v1, 0
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v130, s12, v3
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v134, s13, v3
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v3, 0x60, v1, 0
	v_dual_mov_b32 v19, 0x7632 :: v_dual_add_nc_u32 v4, s14, v34
	...
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v131, s13, v4
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v4, v1, 48, 0
	v_xad_u32 v6, v1, 32, 0
	v_xad_u32 v8, v1, 16, 0
	...
	v_lshl_add_u32 v13, s11, 5, v1
	v_mad_u64_u32 v[2:3], null, s11, 48, v[1:2]
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v136, v123, v1
	v_lshlrev_b32_e32 v1, 6, v0
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v137, v123, v12
	...
	v_dual_mov_b32 v184, 0xff800000 :: v_dual_add_nc_u32 v159, 0, v10
	...
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v142, v124, v13
	...
	v_dual_mov_b32 v181, 0xff800000 :: v_dual_add_nc_u32 v158, 0, v9
	...
	v_lshl_or_b32 v7, v115, 3, v7
	v_cndmask_b32_e64 v18, 0x1054, v18, s0
	v_xor_b32_e32 v5, 32, v135
	v_xor_b32_e32 v6, 48, v135
	v_and_b32_e32 v17, 2, v119
	v_and_b32_e32 v20, 0x80, v67
	v_and_or_b32 v1, 0x700, v1, v16
	v_cndmask_b32_e64 v19, 0x3276, v19, s0
	v_xor_b32_e32 v150, v7, v0
	v_lshl_or_b32 v0, v18, 8, v18
	v_dual_mov_b32 v106, v25 :: v_dual_add_nc_u32 v155, 0, v5
	v_dual_mov_b32 v179, 0xff800000 :: v_dual_add_nc_u32 v156, 0, v6
	v_mov_b32_e32 v5, v25
	v_mov_b32_e32 v6, v25
	v_or3_b32 v151, v1, v20, v17
	v_lshl_or_b32 v1, v19, 8, v19
	v_xor_b32_e32 v7, 56, v147
	v_and_b32_e32 v20, 0x540054, v0
	v_xor_b32_e32 v8, 64, v135
	v_xor_b32_e32 v3, 8, v147
	v_and_b32_e32 v21, 0x760076, v1
	v_mad_u64_u32 v[0:1], null, s60, v66, v[65:66]
	v_add_nc_u32_e32 v168, 0, v7
	v_mov_b32_e32 v7, v25
	v_lshl_or_b32 v1, v20, 4, v20
	v_xor_b32_e32 v4, 16, v135
	...
	v_dual_mov_b32 v103, v25 :: v_dual_and_b32 v152, 0x5040504, v1
	v_dual_mov_b32 v186, 0xff800000 :: v_dual_add_nc_u32 v157, 0, v8
	v_add_nc_u32_e32 v161, 0, v2
	v_dual_mov_b32 v183, 0xff800000 :: v_dual_add_nc_u32 v162, 0, v3
	...
	v_dual_mov_b32 v105, v25 :: v_dual_add_nc_u32 v154, 0, v4
	v_dual_mov_b32 v185, 0xff800000 :: v_dual_add_nc_u32 v160, 0, v11
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v104, v25 :: v_dual_and_b32 v153, 0x7060706, v20
	v_add_nc_u32_e32 v163, 0, v12
	v_add_nc_u32_e32 v165, 0, v14
	...
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v176, 0, v3
	...
	v_dual_mov_b32 v4, v25 :: v_dual_add_nc_u32 v177, 3, v136
	...
	v_cmp_gt_i32_e32 vcc_lo, s60, v65
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 853 32                        ; attention.py:853:32
	s_add_i32 s25, s64, s62
	.loc	1 859 30                        ; attention.py:859:30
	v_dual_mov_b32 v72, s43 :: v_dual_add_nc_u32 v73, 0, v135
	.loc	1 853 32                        ; attention.py:853:32
	s_mul_i32 s0, s25, s61
	.loc	1 859 30                        ; attention.py:859:30
	...
	v_cndmask_b32_e64 v90, 0x80000000, v84, s31
	s_clause 0x1
	buffer_load_b128 v[83:86], v83, s[52:55], 0 offen
	buffer_load_b128 v[90:93], v90, s[52:55], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 859 30                        ; attention.py:859:30
	v_dual_mov_b32 v65, s36 :: v_dual_add_nc_u32 v74, 0, v147
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v76, s62, v124
	v_or_b32_e32 v75, s62, v125
	v_or_b32_e32 v77, s62, v123
	v_or_b32_e32 v78, s62, v126
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v80, 1, v136
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v76, v127
	v_cmp_ge_i32_e64 s10, v76, v128
	v_cmp_ge_i32_e64 s11, v76, v129
	v_cmp_ge_i32_e64 s12, v76, v130
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s13, v76, v131
	v_cmp_le_i32_e64 s14, v76, v132
	v_cmp_le_i32_e64 s15, v76, v133
	v_cmp_le_i32_e64 s16, v76, v134
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v75, v127
	v_cmp_ge_i32_e64 s18, v75, v128
	v_cmp_ge_i32_e64 s19, v75, v129
	v_cmp_ge_i32_e64 s20, v75, v130
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s21, v75, v131
	v_cmp_le_i32_e64 s22, v75, v132
	v_cmp_le_i32_e64 s23, v75, v133
	v_cmp_le_i32_e64 s24, v75, v134
	v_mad_u64_u32 v[75:76], null, s25, s60, v[0:1]
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s0, v77, v127
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s5, v77, v131
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s26, s66, s62
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s3, v77, v129
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s7, v77, v133
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s25, v78, v127
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s29, v78, v131
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s1, v77, v128
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s6, v77, v132
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v87, s26, v136, 2
	v_add_lshl_u32 v88, s26, v177, 2
	v_add_lshl_u32 v94, s26, v137, 2
	v_add_lshl_u32 v95, s26, v138, 2
	v_add_lshl_u32 v96, s26, v139, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s4, v77, v130
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s8, v77, v134
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v77, s26, v149, 2
	v_add_lshl_u32 v76, s26, v80, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s27, v78, v129
	v_cmp_ge_i32_e64 s28, v78, v130
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v78, v132
	v_cmp_le_i32_e64 s33, v78, v133
	v_cmp_le_i32_e64 s34, v78, v134
	.loc	1 867 21 is_stmt 0              ; attention.py:867:21
	s_and_b32 s0, s0, s5
	s_and_b32 s5, s9, s13
	s_and_b32 s9, s17, s21
	s_and_b32 s13, s25, s29
	s_and_b32 s10, s10, s14
	s_and_b32 s14, s18, s22
	s_and_b32 s18, s3, s7
	s_and_b32 s3, s2, s0
	s_and_b32 s1, s1, s6
	s_and_b32 s6, s2, s9
	...
	s_and_b32 s9, s2, s14
	s_and_b32 s4, s2, s18
	s_and_b32 s16, s2, s19
	s_and_b32 s5, s2, s21
	s_and_b32 s8, s2, s8
	s_and_b32 s12, s2, s12
	s_and_b32 s19, s2, s22
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v73, s26, v140, 2
	v_add_lshl_u32 v83, s26, v141, 2
	v_add_lshl_u32 v84, s26, v142, 2
	v_add_lshl_u32 v85, s26, v143, 2
	v_add_lshl_u32 v86, s26, v144, 2
	v_add_lshl_u32 v90, s26, v145, 2
	v_add_lshl_u32 v91, s26, v146, 2
	v_add_lshl_u32 v92, s26, v148, 2
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(4)
	...
	v_cndmask_b32_e64 v70, 0x80000000, v88, s15
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e32 v98, 0x80000000, v66, vcc_lo
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v80, s26, v81, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s26, v78, v128
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v71, 0x80000000, v94, s7
	v_cndmask_b32_e64 v68, 0x80000000, v76, s0
	v_cndmask_b32_e64 v72, 0x80000000, v95, s1
	v_cndmask_b32_e64 v69, 0x80000000, v80, s6
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s17, s26, s30
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v75, 0x80000000, v96, s9
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s10, s2, s17
	s_and_b32 s17, s2, s11
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v73, 0x80000000, v73, s10
	v_cndmask_b32_e64 v76, 0x80000000, v83, s4
	v_cndmask_b32_e64 v78, 0x80000000, v84, s17
	v_cndmask_b32_e64 v80, 0x80000000, v85, s16
	v_cndmask_b32_e64 v81, 0x80000000, v86, s5
	v_cndmask_b32_e64 v83, 0x80000000, v90, s8
	v_cndmask_b32_e64 v84, 0x80000000, v91, s12
	.loc	1 890 30                        ; attention.py:890:30
	v_dual_cndmask_b32 v96, 0x80000000, v65 :: v_dual_add_nc_u32 v79, 0, v150
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v85, 0x80000000, v92, s18
	s_clause 0xf
	buffer_load_b32 v65, v67, s[48:51], 0 offen
	buffer_load_b32 v66, v69, s[48:51], 0 offen
	buffer_load_b32 v69, v70, s[48:51], 0 offen
	buffer_load_b32 v70, v71, s[48:51], 0 offen
	buffer_load_b32 v73, v73, s[48:51], 0 offen
	buffer_load_b32 v71, v72, s[48:51], 0 offen
	buffer_load_b32 v67, v68, s[48:51], 0 offen
	buffer_load_b32 v72, v75, s[48:51], 0 offen
	buffer_load_b32 v75, v76, s[48:51], 0 offen
	buffer_load_b32 v76, v80, s[48:51], 0 offen
	buffer_load_b32 v80, v81, s[48:51], 0 offen
	buffer_load_b32 v81, v83, s[48:51], 0 offen
	buffer_load_b32 v86, v77, s[48:51], 0 offen
	buffer_load_b32 v83, v84, s[48:51], 0 offen
	buffer_load_b32 v77, v78, s[48:51], 0 offen
	buffer_load_b32 v84, v85, s[48:51], 0 offen
	...
	s_waitcnt vmcnt(14)
	v_cndmask_b32_e64 v66, 0xff800000, v66, s6
	s_waitcnt vmcnt(13)
	v_cndmask_b32_e64 v68, 0xff800000, v69, s15
	s_waitcnt vmcnt(12)
	v_cndmask_b32_e64 v69, 0xff800000, v70, s7
	s_waitcnt vmcnt(10)
	v_cndmask_b32_e64 v71, 0xff800000, v71, s1
	s_waitcnt vmcnt(9)
	v_cndmask_b32_e64 v67, 0xff800000, v67, s0
	s_waitcnt vmcnt(8)
	v_cndmask_b32_e64 v70, 0xff800000, v72, s9
	v_cndmask_b32_e64 v72, 0xff800000, v73, s10
	s_waitcnt vmcnt(7)
	v_cndmask_b32_e64 v75, 0xff800000, v75, s4
	s_waitcnt vmcnt(5)
	v_cndmask_b32_e64 v78, 0xff800000, v80, s5
	s_waitcnt vmcnt(4)
	v_cndmask_b32_e64 v80, 0xff800000, v81, s8
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s23, 0xff800000, v70
	.loc	1 879 36                        ; attention.py:879:36
	s_waitcnt vmcnt(2)
	v_cndmask_b32_e64 v83, 0xff800000, v83, s12
	v_cndmask_b32_e64 v76, 0xff800000, v76, s16
	s_waitcnt vmcnt(0)
	v_cndmask_b32_e64 v81, 0xff800000, v84, s18
	v_cndmask_b32_e64 v77, 0xff800000, v77, s17
	v_cndmask_b32_e64 v84, 0xff800000, v86, s19
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s13, 0xff800000, v65
	v_cmp_neq_f32_e64 s20, 0xff800000, v66
	v_cmp_neq_f32_e64 s11, 0xff800000, v67
	v_cmp_neq_f32_e64 s22, 0xff800000, v69
	v_cmp_neq_f32_e64 s14, 0xff800000, v71
	v_cmp_neq_f32_e64 s29, 0xff800000, v80
	v_cmp_neq_f32_e64 s30, 0xff800000, v83
	...
	s_and_b32 s13, s6, s20
	s_and_b32 s12, s7, s22
	.loc	1 881 34 is_stmt 0              ; attention.py:881:34
	v_cmp_neq_f32_e64 s21, 0xff800000, v68
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v68, 0, 1, s13
	v_cndmask_b32_e64 v66, 0, 1, s12
	v_lshlrev_b16 v65.l, 8, v65.l
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s33, 0xff800000, v81
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v67, 0, 1, s14
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s27, 0xff800000, v77
	v_cmp_neq_f32_e64 s26, 0xff800000, v76
	.loc	1 881 25                        ; attention.py:881:25
	v_or_b16 v80.h, v66.l, v65.l
	v_mov_b16_e32 v65.l, v68.l
	s_and_b32 s6, s18, s33
	v_mov_b16_e32 v66.l, v67.l
	v_cndmask_b32_e64 v77, 0, 1, s6
	v_cndmask_b32_e64 v81, 0, 1, s0
	v_lshlrev_b16 v65.l, 8, v65.l
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s25, 0xff800000, v75
	.loc	1 881 25                        ; attention.py:881:25
	s_and_b32 s7, s16, s26
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s28, 0xff800000, v78
	.loc	1 881 25                        ; attention.py:881:25
	...
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s34, 0xff800000, v84
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v67, 0, 1, s11
	v_lshlrev_b16 v65.l, 8, v65.l
	s_and_b32 s5, s5, s28
	s_and_b32 s17, s17, s27
	s_and_b32 s15, s19, s34
	.loc	1 880 35 is_stmt 1              ; attention.py:880:35
	s_waitcnt lgkmcnt(0)
	.loc	1 881 25                        ; attention.py:881:25
	...
	v_dual_mul_f32 v93, 0x3fb8aa3b, v72 :: v_dual_fmac_f32 v84, s65, v215
	.loc	1 880 25 is_stmt 0              ; attention.py:880:25
	v_dual_fmac_f32 v78, s65, v212 :: v_dual_mul_f32 v75, 0x3fb8aa3b, v75
	.loc	1 880 35                        ; attention.py:880:35
	v_dual_mul_f32 v76, 0x3fb8aa3b, v76 :: v_dual_fmac_f32 v81, s65, v213
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v88, s65, v219 :: v_dual_fmac_f32 v83, s65, v214
	v_fmac_f32_e32 v86, s65, v217
	.loc	1 880 35                        ; attention.py:880:35
	...
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v87, s65, v218 :: v_dual_fmac_f32 v90, s65, v188
	v_dual_fmac_f32 v85, s65, v216 :: v_dual_fmac_f32 v92, s65, v190
	v_dual_fmac_f32 v93, s65, v191 :: v_dual_fmac_f32 v76, s65, v193
	v_fmac_f32_e32 v75, s65, v192
	...
	v_cmp_eq_u16_e64 s28, 1, v70.l
	v_cmp_eq_u16_e64 s29, 1, v70.h
	v_cmp_eq_u16_e64 s18, 1, v72.h
	v_cmp_eq_u16_e64 s30, 1, v65.l
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v70, 0xff800000, v84, s33
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v95, s65, v194
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s34, 1, v66.l
	v_cmp_eq_u16_e64 s27, 1, v69.h
	v_cmp_eq_u16_e64 s35, 1, v66.h
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v94, 0xff800000, v78, s3
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v91, s65, v189
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s24, 1, v71.l
	v_cmp_eq_u16_e64 s25, 1, v67.l
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v191, 0xff800000, v87, s29
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s22, 1, v71.h
	v_cmp_eq_u16_e64 s20, 1, v72.l
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v87, 0xff800000, v95, s18
	v_cndmask_b32_e64 v95, 0xff800000, v81, s30
	v_cndmask_b32_e64 v190, 0xff800000, v86, s34
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v99, s65, v195
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s23, 1, v67.h
	v_cmp_eq_u16_e64 s21, 1, v68.l
	v_cmp_eq_u16_e64 s19, 1, v68.h
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v69, 0xff800000, v83, s27
	v_cndmask_b32_e64 v189, 0xff800000, v85, s28
	v_cndmask_b32_e64 v192, 0xff800000, v88, s35
	v_cndmask_b32_e64 v111, 0xff800000, v90, s24
	v_cndmask_b32_e64 v112, 0xff800000, v91, s25
	v_cndmask_b32_e64 v109, 0xff800000, v92, s22
	v_cndmask_b32_e64 v107, 0xff800000, v75, s20
	v_cndmask_b32_e64 v110, 0xff800000, v93, s23
	v_cndmask_b32_e64 v108, 0xff800000, v76, s21
	v_cndmask_b32_e64 v88, 0xff800000, v99, s19
	...
	.loc	1 890 30                        ; attention.py:890:30
	s_clause 0x1
	buffer_load_b128 v[78:81], v96, s[56:59], 0 offen
	buffer_load_b128 v[98:101], v98, s[56:59], 0 offen
.Ltmp1:
...
.Ltmp6:
	...
	v_permlanex16_b32 v66, v65, s68, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp7:
	...
	v_cndmask_b32_e64 v68, 0, v68, s33
	v_cndmask_b32_e64 v66, 0, v66, s3
	.loc	1 885 25 is_stmt 1              ; attention.py:885:25
	v_cndmask_b32_e64 v189, 0, v73, s26
	.loc	1 886 62                        ; attention.py:886:62
	...
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v71, 0, v71, s29
	.loc	1 896 30                        ; attention.py:896:30
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v94.l, 0x7fff, v66.h, s33
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v68.h, 0x7fff, v66.h, s35
	.loc	1 886 33                        ; attention.py:886:33
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v68.l, 0x7fff, v67.h, s34
	v_permlanex16_b32 v67, v94, s68, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v11, v11, v189
	v_mul_f32_e32 v12, v12, v189
	v_mul_f32_e32 v13, v13, v189
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v69, v68, s68, 0xfedcba98 op_sel:[1,0]
	...
	v_cndmask_b16 v72.l, 0x7fff, v71.h, s30
	v_permlanex16_b32 v71, v70, s68, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v14, v14, v189
	v_mul_f32_e32 v15, v15, v189
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v72.h, 0x7fff, v67.h, s29
...
.Ltmp51:
	...
	v_cndmask_b16 v70.h, 0x7fff, v70.h, s20
	.loc	1 885 25                        ; attention.py:885:25
	v_cmp_neq_f32_e64 s20, 0xff800000, v183
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v71, v70, s68, 0xfedcba98 op_sel:[1,0]
	...
	v_cndmask_b16 v72.h, 0x7fff, v72.h, s18
	.loc	1 885 25                        ; attention.py:885:25
	v_cmp_neq_f32_e64 s18, 0xff800000, v186
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v87, v72, s68, 0xfedcba98 op_sel:[1,0]
...
.Ltmp53:
	...
	.loc	1 885 25                        ; attention.py:885:25
	v_cndmask_b32_e64 v107, 0, v110, s18
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(TRANS32_DEP_2)
	.loc	1 885 61                        ; attention.py:885:61
	...
	.loc	1 885 25                        ; attention.py:885:25
	v_cndmask_b32_e64 v108, 0, v112, s19
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 885 61                        ; attention.py:885:61
	...
	.loc	1 885 25                        ; attention.py:885:25
	v_cndmask_b32_e64 v109, 0, v187, s20
	v_cndmask_b32_e64 v110, 0, v197, s21
	.loc	1 886 33                        ; attention.py:886:33
...
.LBB0_7:                                ; %._crit_edge
	...
	v_div_scale_f32 v49, s4, v29, v37, v29
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	s_mov_b32 vcc_lo, s2
	v_div_scale_f32 v42, s2, v30, v37, v30
	...
	v_div_scale_f32 v51, s2, v17, v37, v17
	...
	v_div_scale_f32 v41, s3, v12, v37, v12
	...
	v_div_scale_f32 v40, s4, v14, v37, v14
	...
	v_div_scale_f32 v41, s2, v15, v37, v15
...
.Ltmp87:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 222
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 69
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     71
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.kd
