...
; %bb.4:                                ; %.lr.ph
	...
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v14, v33 :: v_dual_lshlrev_b32 v51, 16, v51
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 928 41                        ; attention.py:928:41
	v_mul_f32_e32 v83, s1, v51
	v_mov_b32_e32 v17, v33
	v_mov_b32_e32 v19, v33
	v_dual_mov_b32 v2, v33 :: v_dual_and_b32 v51, 0x5040504, v52
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s11, v93, v64
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s12, v93, v65
	.loc	1 951 30                        ; attention.py:951:30
	...
	v_add_lshl_u32 v94, v63, s33, 1
	v_add_lshl_u32 v95, v67, s33, 1
	v_add_lshl_u32 v96, v68, s33, 1
	v_add_lshl_u32 v97, v69, s33, 1
	v_add_lshl_u32 v98, v72, s33, 1
	v_add_lshl_u32 v99, v73, s33, 1
	v_add_lshl_u32 v101, v70, s33, 1
	v_add_lshl_u32 v104, v71, s33, 1
	.loc	1 904 31                        ; attention.py:904:31
	...
	s_and_b32 s5, s9, s10
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s13, v100, v64
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s14, v100, v65
	...
	.loc	1 1000 41                       ; attention.py:1000:41
	v_dual_cndmask_b32 v53, 0x80000000, v112 :: v_dual_mul_f32 v90, v83, v90
	.loc	1 932 25                        ; attention.py:932:25
	...
	v_dual_mul_f32 v93, v86, v93 :: v_dual_mul_f32 v102, v85, v102
	v_dual_mul_f32 v103, v86, v103 :: v_dual_mul_f32 v106, v83, v106
...
.Ltmp8:
	...
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v80, v112, v91 offset1:8
	ds_store_2addr_b32 v80, v89, v53 offset0:16 offset1:24
	.loc	1 1019 30                       ; attention.py:1019:30
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 123
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 45
