...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v18, s3, v39
	v_or_b32_e32 v19, s3, v42
	...
	v_permlanex16_b32 v4, v4, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v5, v8, s64, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b32_e64 v10, v23, v21, s0
	v_cndmask_b32_e64 v14, v24, v22, s0
	v_permlanex16_b32 v7, v12, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v8, v16, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v11, v11, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v12, v9, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v16, v3, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v20, v1, s64, 0xfedcba98 op_sel:[1,0]
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v4, s3, v40
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	s_lshl_b32 s6, s6, 9
	s_lshl_b32 s5, s5, 9
	v_or_b32_e32 v2, s6, v43
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	s_mov_b32 s47, s43
	s_clause 0x1
	buffer_load_b64 v[56:57], v37, s[44:47], 0 offen
	buffer_load_b64 v[58:59], v36, s[44:47], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	buffer_load_u8 v38, v35, s[40:43], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	ds_bpermute_b32 v70, v45, v57
	ds_bpermute_b32 v71, v44, v58
	ds_bpermute_b32 v72, v44, v59
	ds_bpermute_b32 v73, v45, v58
	ds_bpermute_b32 v74, v45, v59
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_cndmask_b32_e64 v65, v70, v67, s0
	v_cndmask_b32_e64 v67, v67, v70, s0
	v_cndmask_b32_e64 v68, v73, v71, s0
	v_cndmask_b32_e64 v69, v74, v72, s0
	v_cndmask_b32_e64 v70, v71, v73, s0
	v_cndmask_b32_e64 v71, v72, v74, s0
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 88
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 65
