...
; %bb.3:                                ; %.lr.ph117
	...
	scratch_store_b32 off, v32, off offset:772
	scratch_store_b32 off, v30, off offset:780
	s_waitcnt lgkmcnt(0)
	s_clause 0x1                            ; 32-byte Folded Spill
	scratch_store_b128 off, v[14:17], off offset:224
	scratch_store_b128 off, v[18:21], off offset:240
	v_or3_b32 v21, v3, v2, v10
	v_dual_mov_b32 v65, 0 :: v_dual_lshlrev_b32 v2, 1, v32
	v_dual_mov_b32 v66, v243 :: v_dual_lshlrev_b32 v3, 2, v29
	...
	v_dual_mov_b32 v70, v243 :: v_dual_add_nc_u32 v1, 0, v1
	scratch_store_b32 off, v29, off offset:776 ; 4-byte Folded Spill
	...
	v_dual_mov_b32 v96, v243 :: v_dual_add_nc_u32 v1, 0, v1
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v82, v243 :: v_dual_add_nc_u32 v1, 0, v1
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	v_add_nc_u32_e32 v7, s35, v7
	v_add_nc_u32_e32 v1, 0, v1
	scratch_store_b32 off, v8, off offset:640 ; 4-byte Folded Spill
	.loc	1 579 17                        ; attention_backward.py:579:17
	v_add_nc_u32_e32 v8, s33, v8
	scratch_store_b32 off, v1, off offset:468 ; 4-byte Folded Spill
	v_xor_b32_e32 v1, 32, v25
	scratch_store_b32 off, v8, off offset:648 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v8, s33, v8
	scratch_store_b32 off, v7, off offset:644 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v1, 0, v1
	.loc	1 535 17                        ; attention_backward.py:535:17
	v_add_nc_u32_e32 v7, s35, v7
	scratch_store_b32 off, v8, off offset:656 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v8, s33, v8
	...
	v_add_nc_u32_e32 v7, s35, v7
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v8, off offset:672
	...
	v_add_nc_u32_e32 v7, s35, v7
	v_add_nc_u32_e32 v1, 0, v1
	scratch_store_b32 off, v8, off offset:696 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v8, s33, v8
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	v_add_nc_u32_e32 v7, s35, v7
	scratch_store_b32 off, v8, off offset:712 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v8, s33, v8
	...
	v_add_nc_u32_e32 v7, s35, v7
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v8, off offset:728
...
.LBB0_7:                                ;   in Loop: Header=BB0_8 Depth=2
	...
	v_dual_mov_b32 v249, v243 :: v_dual_add_nc_u32 v100, s33, v23
	...
	.loc	1 701 33                        ; attention_backward.py:701:33
	v_cndmask_b32_e64 v33, 0, v11, s3
	.loc	1 721 37                        ; attention_backward.py:721:37
	...
	.loc	1 701 33                        ; attention_backward.py:701:33
	v_cndmask_b32_e64 v34, 0, v12, s6
	.loc	1 721 37                        ; attention_backward.py:721:37
	...
	v_cndmask_b16 v239.h, 0x7fff, v11.h, s6
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b16 v27.h, 0x7fff, v12.h, s7
	.loc	1 722 33                        ; attention_backward.py:722:33
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v7, 0, v7
	.loc	1 727 34                        ; attention_backward.py:727:34
	...
	ds_store_b16 v238, v7
	v_cndmask_b16 v7.l, 0x7fff, v9.h, s3
	.loc	1 716 21                        ; attention_backward.py:716:21
	...
	ds_store_b16 v2, v7
	v_cndmask_b16 v7.l, 0x7fff, v11.h, s7
	.loc	1 716 21                        ; attention_backward.py:716:21
	...
	.loc	1 728 34                        ; attention_backward.py:728:34
	ds_store_b16 v3, v7
	v_cndmask_b16 v7.l, 0x7fff, v12.h, s8
	.loc	1 716 21                        ; attention_backward.py:716:21
	v_add3_u32 v11, v169, v11, 0x7fff
	v_cndmask_b16 v224.h, 0x7fff, v10.h, s3
	...
	v_cndmask_b16 v42.h, 0x7fff, v11.h, s6
	...
	v_cndmask_b16 v31.h, 0x7fff, v10.h, s3
	...
	v_cndmask_b16 v29.h, 0x7fff, v11.h, s6
	...
	v_cndmask_b16 v32.h, 0x7fff, v10.h, s3
	.loc	1 735 35                        ; attention_backward.py:735:35
	...
	v_cndmask_b16 v30.h, 0x7fff, v11.h, s6
	.loc	1 735 35                        ; attention_backward.py:735:35
	...
	v_cndmask_b16 v15.h, 0x7fff, v231.h, s6
	...
	v_cndmask_b16 v9.h, 0x7fff, v13.h, s7
	v_bfe_u32 v13, v12, 16, 1
	...
	v_cndmask_b16 v9.l, 0x7fff, v42.h, s6
	...
	v_cndmask_b16 v14.l, 0x7fff, v42.h, s3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_dual_sub_f32 v7, v160, v206 :: v_dual_sub_f32 v12, v154, v15
	...
	v_add3_u32 v11, v10, v11, 0x7fff
	v_bfe_u32 v10, v186, 16, 1
	v_cndmask_b16 v9.l, 0x7fff, v11.h, s0
	.loc	1 732 35                        ; attention_backward.py:732:35
	v_sub_f32_e32 v11, v152, v20
	.loc	1 732 34                        ; attention_backward.py:732:34
	v_bfe_u32 v13, v12, 16, 1
	v_cmp_o_f32_e64 s3, v12, v12
	v_add3_u32 v10, v186, v10, 0x7fff
	...
	.loc	1 732 35                        ; attention_backward.py:732:35
	v_sub_f32_e32 v15, v146, v17
	.loc	1 732 34                        ; attention_backward.py:732:34
	v_cmp_o_f32_e64 s1, v13, v13
	v_add3_u32 v12, v11, v12, 0x7fff
	v_bfe_u32 v11, v184, 16, 1
	v_add3_u32 v14, v13, v14, 0x7fff
	v_bfe_u32 v17, v15, 16, 1
	v_bfe_u32 v13, v182, 16, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add3_u32 v11, v184, v11, 0x7fff
	v_cndmask_b16 v12.l, 0x7fff, v14.h, s1
	v_bfe_u32 v14, v180, 16, 1
	...
	v_cmp_o_f32_e32 vcc_lo, v180, v180
	v_cndmask_b16 v13.l, 0x7fff, v16.h, s6
	v_cndmask_b16 v11.h, 0x7fff, v11.h, s0
	v_cmp_o_f32_e64 s0, v15, v15
	v_bfe_u32 v15, v40, 16, 1
	v_add3_u32 v14, v180, v14, 0x7fff
	v_cndmask_b16 v12.h, 0x7fff, v13.h, s3
	v_cmp_o_f32_e64 s3, v181, v181
	v_cndmask_b16 v14.l, 0x7fff, v17.h, s0
	v_add3_u32 v15, v40, v15, 0x7fff
	v_cndmask_b16 v13.h, 0x7fff, v14.h, vcc_lo
	v_cmp_o_f32_e64 s0, v183, v183
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v14.h, 0x7fff, v15.h, s1
	.loc	1 745 35 is_stmt 1              ; attention_backward.py:745:35
	v_wmma_f32_16x16x16_bf16 v[73:80], v[7:14], v[106:113], v[73:80]
	.loc	1 732 35                        ; attention_backward.py:732:35
	v_dual_sub_f32 v7, v161, v34 :: v_dual_sub_f32 v10, v155, v239
	v_dual_sub_f32 v8, v159, v31 :: v_dual_sub_f32 v9, v157, v29
	v_dual_sub_f32 v12, v151, v35 :: v_dual_sub_f32 v11, v153, v36
	v_dual_sub_f32 v14, v147, v30 :: v_dual_sub_f32 v13, v149, v32
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 732 34 is_stmt 0              ; attention_backward.py:732:34
	...
	v_cndmask_b16 v9.l, 0x7fff, v17.h, s6
	...
	v_cndmask_b16 v12.l, 0x7fff, v17.h, s6
	...
	v_cndmask_b16 v14.l, 0x7fff, v17.h, s3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v14.h, 0x7fff, v14.h, s6
	.loc	1 745 35 is_stmt 1              ; attention_backward.py:745:35
...
; %bb.9:                                ;   in Loop: Header=BB0_8 Depth=2
	...
	v_cmp_le_i32_e64 s6, v222, v33
	v_cmp_le_i32_e64 s7, v222, v34
	.loc	1 676 21 is_stmt 0              ; attention_backward.py:676:21
	s_and_b32 s22, s93, vcc_lo
	s_and_b32 s0, s91, s0
	.loc	1 676 30                        ; attention_backward.py:676:30
	v_cmp_le_i32_e64 s8, v222, v28
	v_cmp_le_i32_e64 s9, v222, v29
...
.LBB0_12:                               ; %Flow527
	...
	scratch_load_b32 v32, off, off offset:772
	scratch_load_b32 v29, off, off offset:776
	scratch_load_b32 v30, off, off offset:780
	s_branch .LBB0_14
.LBB0_13:
	v_mov_b32_e32 v72, 0
	s_delay_alu instid0(VALU_DEP_1)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_bwd_dkv_bf16xbf16_bf16_runtime_outbfloat16_doutfloat32_float32_d64_dv64_shaperuntime_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 97
	...
	.set amd_strix_halo_gfx1151_attention_bwd_dkv_bf16xbf16_bf16_runtime_outbfloat16_doutfloat32_float32_d64_dv64_shaperuntime_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 788
