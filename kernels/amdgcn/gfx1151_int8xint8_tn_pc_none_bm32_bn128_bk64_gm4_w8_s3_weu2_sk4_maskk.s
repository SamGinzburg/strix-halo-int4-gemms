	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s29, v31, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s9, s9
	s_mul_i32 s10, s10, s9
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_lshl_add_u32 v34, s29, 5, v9
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp13:
	...
	buffer_load_b64 v[1:2], v3, s[20:23], 0 offen
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[24:25], v3, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s0, s1, s29
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[37:38], null, s1, s28, v[10:11]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s0, s0, s14
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[105:106], v37, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[53:56], v38, s[24:27], 0 offen
	buffer_load_b128 v[57:60], v43, s[24:27], 0 offen
...
.LBB0_12:
	...
	v_or3_b32 v2, v2, v28, s14
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v13, v4 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v25, v7 :: v_dual_and_b32 v44, 0x7f, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_f32 v5, v27, v5 :: v_dual_lshlrev_b32 v2, 1, v2
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v10, v22, v10 :: v_dual_add_f32 v31, v20, v31
	v_dual_add_f32 v34, v17, v34 :: v_dual_and_b32 v47, 14, v0
	v_dual_add_f32 v38, v12, v38 :: v_dual_and_b32 v49, 1, v0
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshlrev_b32_e32 v48, 2, v0
	v_bfe_i32 v0, v0, 0, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v4, v13, v4, s2
	v_cndmask_b32_e64 v13, v22, v10, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v26, v6 :: v_dual_add_f32 v9, v23, v9
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v22, 0x3f8, v48
	v_and_b32_e32 v0, 0x440, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v8, v24, v8 :: v_dual_add_f32 v33, v18, v33
	v_dual_add_f32 v30, v21, v30 :: v_dual_add_f32 v35, v16, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xor_b32_e32 v0, v0, v22
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v32, v19, v32 :: v_dual_add_f32 v37, v14, v37
	v_dual_add_f32 v36, v15, v36 :: v_dual_and_b32 v11, 0x380, v11
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	...
	v_cndmask_b32_e64 v10, v20, v31, s2
	v_cndmask_b32_e64 v19, v19, v32, s2
	v_cndmask_b32_e64 v18, v18, v33, s2
	...
	v_xad_u32 v32, v0, 24, 0
	v_xad_u32 v33, v0, 32, 0
	v_xad_u32 v34, v0, 40, 0
	v_xad_u32 v35, v0, 48, 0
	v_xad_u32 v36, v0, 56, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v7, v25, v7, s2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	v_mul_lo_u32 v20, s29, v46
	...
	s_lshl_b32 s3, s29, 1
	s_lshl_b32 s4, s29, 2
	v_add3_u32 v20, s1, v44, v20
	s_mul_i32 s5, s29, 6
	s_lshl_b32 s8, s29, 3
	s_mul_i32 s9, s29, 10
	s_mul_i32 s10, s29, 12
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v26, v20, s4, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshlrev_b32_e32 v23, 6, v49
	s_delay_alu instid0(VALU_DEP_1)
	v_xor_b32_e32 v22, v24, v23
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_dual_mul_f32 v40, v0, v2 :: v_dual_lshlrev_b32 v25, 2, v47
	v_dual_mul_f32 v2, v1, v2 :: v_dual_mul_f32 v41, v0, v3
	v_mul_f32_e32 v53, v0, v39
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_or3_b32 v11, v11, v25, v22
	v_add_lshl_u32 v25, v20, s3, 2
	s_delay_alu instid0(VALU_DEP_2)
	v_add_nc_u32_e32 v37, 0, v11
	v_xad_u32 v38, 0x808, v11, 0
	v_xad_u32 v44, 0x1010, v11, 0
	v_xad_u32 v45, 0x1818, v11, 0
	v_xad_u32 v46, 0x2020, v11, 0
	v_xad_u32 v47, 0x2828, v11, 0
	v_xad_u32 v48, 0x3030, v11, 0
	v_xad_u32 v49, 0x3838, v11, 0
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v11, 16, v29
	v_lshlrev_b32_e32 v29, 16, v42
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v52, v0, v29 :: v_dual_mul_f32 v3, v1, v3
	v_mul_f32_e32 v28, v1, v28
	v_mul_f32_e32 v29, v1, v29
	v_mul_f32_e32 v54, v1, v12
	v_mul_f32_e32 v42, v0, v11
	v_dual_mul_f32 v11, v1, v11 :: v_dual_lshlrev_b32 v22, 2, v20
	v_dual_mul_f32 v39, v1, v39 :: v_dual_mul_f32 v50, v0, v14
	v_mul_f32_e32 v43, v0, v12
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v0, v4, v40 :: v_dual_mul_f32 v1, v10, v2
	v_mul_f32_e32 v2, v5, v41
	v_dual_mul_f32 v4, v6, v42 :: v_dual_mul_f32 v3, v19, v3
	v_dual_mul_f32 v8, v8, v50 :: v_dual_mul_f32 v5, v18, v11
	v_dual_mul_f32 v6, v7, v43 :: v_dual_mul_f32 v7, v17, v54
	v_dual_mul_f32 v10, v9, v51 :: v_dual_mul_f32 v11, v15, v28
	v_dual_mul_f32 v12, v13, v52 :: v_dual_mul_f32 v9, v16, v55
	v_dual_mul_f32 v14, v21, v53 :: v_dual_mul_f32 v15, v24, v39
	v_mul_f32_e32 v13, v23, v29
	...
	v_add_lshl_u32 v23, v20, s16, 2
	v_add_lshl_u32 v24, v20, s17, 2
	v_add_lshl_u32 v27, v20, s18, 2
	s_waitcnt lgkmcnt(7)
	...
	v_add_lshl_u32 v28, v20, s19, 2
	v_add_lshl_u32 v29, v20, s20, 2
	v_add_lshl_u32 v30, v20, s21, 2
	v_add_lshl_u32 v31, v20, s22, 2
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 241
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
