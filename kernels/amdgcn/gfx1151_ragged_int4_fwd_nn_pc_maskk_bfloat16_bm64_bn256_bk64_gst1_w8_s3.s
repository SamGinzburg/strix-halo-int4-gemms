...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v2, s24 :: v_dual_lshlrev_b32 v3, 1, v0
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v7, 0 :: v_dual_and_b32 v90, 15, v0
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v89, 0xf0, v0
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 568 18                        ; ragged.py:568:18
	v_and_b32_e32 v86, 24, v6
	v_add_nc_u32_e32 v4, s18, v4
	v_and_b32_e32 v8, 24, v91
	...
	.loc	1 573 19                        ; ragged.py:573:19
	v_mad_u64_u32 v[2:3], null, s17, s24, v[85:86]
	v_and_b32_e32 v3, 24, v7
	v_dual_mov_b32 v16, v1 :: v_dual_and_b32 v7, 0x70, v7
	...
	v_add3_u32 v92, 0, v90, v7
	v_dual_mov_b32 v7, v1 :: v_dual_add_nc_u32 v94, 0, v3
	v_mov_b32_e32 v13, v1
	v_mul_lo_u32 v6, s16, v6
	v_mov_b32_e32 v3, v1
	v_mad_u64_u32 v[87:88], null, v4, s17, v[86:87]
	v_add3_u32 v2, v2, s0, v5
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v20, v1
	v_mov_b32_e32 v21, v1
	v_mov_b32_e32 v22, v1
	v_subrev_nc_u32_e32 v88, s1, v2
	v_mov_b32_e32 v2, v1
	...
	v_subrev_nc_u32_e32 v93, s1, v5
	v_mov_b32_e32 v5, v1
	v_lshl_or_b32 v8, v90, 5, v8
	...
	v_dual_mov_b32 v8, v1 :: v_dual_add_nc_u32 v95, 0, v9
	v_add_nc_u32_e32 v96, 0, v10
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v10, v1 :: v_dual_add_nc_u32 v97, 0, v11
	v_dual_mov_b32 v9, v1 :: v_dual_add_nc_u32 v98, 0, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v65, s3, v86
	.loc	1 574 22                        ; ragged.py:574:22
	v_add_nc_u32_e32 v66, s3, v85
	.loc	1 584 30                        ; ragged.py:584:30
	v_add_nc_u32_e32 v67, s3, v87
	...
	.loc	1 584 30                        ; ragged.py:584:30
	v_cndmask_b32_e64 v65, 0x80000000, v67, s0
	.loc	1 585 30                        ; ragged.py:585:30
	v_cndmask_b32_e64 v67, 0x80000000, v88, s1
	.loc	1 573 19                        ; ragged.py:573:19
	...
	s_cmp_lt_i32 s3, s17
	.loc	1 585 30                        ; ragged.py:585:30
	v_cndmask_b32_e64 v68, 0x80000000, v93, s0
	.loc	1 584 30                        ; ragged.py:584:30
	buffer_load_b64 v[65:66], v65, s[4:7], 0 offen
	.loc	1 573 19                        ; ragged.py:573:19
	v_add_nc_u32_e32 v93, s27, v93
	.loc	1 585 30                        ; ragged.py:585:30
	s_clause 0x1
	buffer_load_b128 v[100:103], v67, s[12:15], 0 offen
	buffer_load_b128 v[104:107], v68, s[12:15], 0 offen
	.loc	1 584 30                        ; ragged.py:584:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v94, v[65:66]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[108:111], v99 offset1:1
	ds_load_2addr_stride64_b64 v[112:115], v99 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[116:119], v95 offset1:1
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b128 v98, v[100:103]
	s_waitcnt vmcnt(0)
	ds_store_b128 v98, v[104:107] offset:4096
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 586 27                        ; ragged.py:586:27
	ds_load_u8 v100, v92 offset:1280
	ds_load_u8 v101, v92 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v100, v101, v100, 0xc0c0004
	ds_load_u8 v101, v92 offset:1792
	ds_load_u8 v102, v92 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	ds_load_u8 v102, v92 offset:256
	ds_load_u8 v103, v92
	v_lshl_or_b32 v101, v101, 16, v100
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v103, v102, 0xc0c0004
	ds_load_u8 v103, v92 offset:768
	ds_load_u8 v104, v92 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v103, v104, v103, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v100, v103, 16, v102
	ds_load_u8 v102, v92 offset:1408
	ds_load_u8 v103, v92 offset:1152
	v_wmma_i32_16x16x16_iu4 v[1:8], v[100:101], v[108:109], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[100:101], v[110:111], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[100:101], v[112:113], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[100:101], v[114:115], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v102, v103, v102, 0xc0c0004
	ds_load_u8 v103, v92 offset:1920
	ds_load_u8 v104, v92 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v103, v104, v103, 0xc0c0004
	ds_load_u8 v104, v92 offset:384
	ds_load_u8 v105, v92 offset:128
	v_lshl_or_b32 v103, v103, 16, v102
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v104, v105, v104, 0xc0c0004
	ds_load_u8 v105, v92 offset:896
	ds_load_u8 v106, v92 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	ds_load_u8 v106, v92 offset:3200
	v_lshl_or_b32 v102, v105, 16, v104
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[102:103], v[108:109], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[102:103], v[110:111], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[102:103], v[112:113], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[102:103], v[114:115], v[57:64] neg_lo:[1,1,0]
	ds_load_u8 v100, v92 offset:3328
	ds_load_u8 v101, v92 offset:3072
	ds_load_u8 v102, v92 offset:3840
	ds_load_u8 v103, v92 offset:3584
	ds_load_u8 v104, v92 offset:2304
	ds_load_u8 v105, v92 offset:2048
	ds_load_u8 v110, v92 offset:5248
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v100, v101, v100, 0xc0c0004
	ds_load_u8 v101, v92 offset:2816
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v102, v103, v102, 0xc0c0004
	ds_load_u8 v103, v92 offset:2560
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v104, v105, v104, 0xc0c0004
	ds_load_u8 v105, v92 offset:3456
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v103, v103, v101, 0xc0c0004
	v_lshl_or_b32 v101, v102, 16, v100
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v100, v103, 16, v104
	ds_load_u8 v102, v92 offset:3968
	ds_load_u8 v103, v92 offset:3712
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v104, v106, v105, 0xc0c0004
	ds_load_u8 v105, v92 offset:2432
	v_wmma_i32_16x16x16_iu4 v[1:8], v[100:101], v[116:117], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[100:101], v[118:119], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[100:101], v[81:82], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[100:101], v[83:84], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v102, v103, v102, 0xc0c0004
	ds_load_u8 v103, v92 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v103, v105, 0xc0c0004
	ds_load_u8 v103, v92 offset:2944
	ds_load_u8 v106, v92 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v106, v103, 0xc0c0004
	v_lshl_or_b32 v103, v102, 16, v104
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v102, v106, 16, v105
	ds_load_u8 v104, v92 offset:5376
	ds_load_u8 v105, v92 offset:5120
	ds_load_u8 v106, v92 offset:5888
	ds_load_u8 v107, v92 offset:5632
	ds_load_u8 v108, v92 offset:4352
	ds_load_u8 v109, v92 offset:4096
	v_wmma_i32_16x16x16_iu4 v[9:16], v[102:103], v[116:117], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[102:103], v[118:119], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[102:103], v[81:82], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[102:103], v[83:84], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	v_perm_b32 v104, v105, v104, 0xc0c0004
	ds_load_u8 v105, v92 offset:4864
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v108, v109, v108, 0xc0c0004
	ds_load_u8 v109, v92 offset:5504
	ds_load_u8 v107, v92 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v107, v107, v105, 0xc0c0004
	v_lshl_or_b32 v105, v106, 16, v104
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v104, v107, 16, v108
	ds_load_u8 v106, v92 offset:6016
	ds_load_u8 v107, v92 offset:5760
	v_perm_b32 v108, v110, v109, 0xc0c0004
	ds_load_u8 v109, v92 offset:4480
	v_wmma_i32_16x16x16_iu4 v[1:8], v[104:105], v[77:78], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[104:105], v[79:80], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[104:105], v[73:74], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[104:105], v[75:76], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	ds_load_u8 v107, v92 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v109, v107, v109, 0xc0c0004
	ds_load_u8 v107, v92 offset:4992
	ds_load_u8 v110, v92 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v110, v110, v107, 0xc0c0004
	v_lshl_or_b32 v107, v106, 16, v108
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v106, v110, 16, v109
	ds_load_u8 v108, v92 offset:7424
	ds_load_u8 v109, v92 offset:7168
	v_wmma_i32_16x16x16_iu4 v[9:16], v[106:107], v[77:78], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[106:107], v[79:80], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[106:107], v[73:74], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[106:107], v[75:76], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v108, v109, v108, 0xc0c0004
	ds_load_u8 v109, v92 offset:7936
	ds_load_u8 v110, v92 offset:7680
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v109, v110, v109, 0xc0c0004
	ds_load_u8 v110, v92 offset:6400
	ds_load_u8 v111, v92 offset:6144
	v_lshl_or_b32 v109, v109, 16, v108
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v110, v111, v110, 0xc0c0004
	ds_load_u8 v111, v92 offset:6912
	ds_load_u8 v112, v92 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v108, v111, 16, v110
	ds_load_u8 v110, v92 offset:7552
	ds_load_u8 v111, v92 offset:7296
	v_wmma_i32_16x16x16_iu4 v[1:8], v[108:109], v[69:70], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[108:109], v[71:72], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[108:109], v[65:66], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[108:109], v[67:68], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v110, v111, v110, 0xc0c0004
	ds_load_u8 v111, v92 offset:8064
	ds_load_u8 v112, v92 offset:7808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v111, v112, v111, 0xc0c0004
	ds_load_u8 v112, v92 offset:6528
	ds_load_u8 v113, v92 offset:6272
	v_lshl_or_b32 v111, v111, 16, v110
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v112, v113, v112, 0xc0c0004
	ds_load_u8 v113, v92 offset:7040
	ds_load_u8 v114, v92 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v113, v114, v113, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v110, v113, 16, v112
	v_wmma_i32_16x16x16_iu4 v[9:16], v[110:111], v[69:70], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[110:111], v[71:72], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[110:111], v[65:66], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[110:111], v[67:68], v[57:64] neg_lo:[1,1,0]
	.loc	1 573 19                        ; ragged.py:573:19
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_mov_b32 v2, s24 :: v_dual_mov_b32 v1, s18
	v_mov_b32_e32 v3, v91
.LBB0_7:                                ; %._crit_edge
	.loc	1 562 32                        ; ragged.py:562:32
	v_or_b32_e32 v4, 48, v90
	v_or_b32_e32 v6, 32, v90
	v_or_b32_e32 v36, 16, v90
	...
	s_and_b32 s0, s0, s4
	.loc	1 607 17 is_stmt 1              ; ragged.py:607:17
	v_lshl_add_u32 v41, v89, 2, 0
	.loc	1 564 20                        ; ragged.py:564:20
	s_and_b32 s2, s2, s6
	.loc	1 607 17                        ; ragged.py:607:17
	v_lshl_add_u32 v42, v89, 1, 0
	.loc	1 599 36                        ; ragged.py:599:36
	...
	v_dual_mul_f32 v58, v83, v36 :: v_dual_add_nc_u32 v5, v90, v1
	v_dual_mul_f32 v51, v94, v37 :: v_dual_and_b32 v4, 32, v4
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v55, v87, v37 :: v_dual_lshlrev_b32 v38, 16, v38
	...
	v_dual_mul_f32 v54, v88, v37 :: v_dual_mul_f32 v73, v73, v36
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 120
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_pc_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 56
