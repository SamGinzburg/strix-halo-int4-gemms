	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	s_add_i32 s2, s2, s6
	.loc	1 368 22 is_stmt 1              ; generate_amdgcn.py:368:22
	s_lshl_b32 s6, s3, 6
	...
	s_mul_i32 s2, s24, s5
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_mad_u64_u32 v[4:5], null, s26, s5, v[3:4]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b128 v[87:90], v54, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[91:94], v52, s[20:23], 0 offen
	buffer_load_b128 v[95:98], v53, s[20:23], 0 offen
	s_mov_b32 s6, s27
	s_mov_b32 s27, s0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v21, v21, v73 :: v_dual_add_f32 v22, v22, v74
	v_dual_add_f32 v13, v13, v75 :: v_dual_add_f32 v14, v14, v76
	v_dual_add_f32 v17, v17, v77 :: v_dual_add_f32 v18, v18, v78
	v_dual_add_f32 v19, v19, v79 :: v_dual_add_f32 v20, v20, v80
	v_dual_add_f32 v23, v23, v81 :: v_dual_add_f32 v24, v24, v82
	v_dual_add_f32 v15, v15, v83 :: v_dual_add_f32 v16, v16, v84
	v_dual_add_f32 v11, v11, v85 :: v_dual_add_f32 v12, v12, v86
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(2)
...
; %bb.9:
	...
	v_add_nc_u32_e32 v51, s7, v50
	v_add_nc_u32_e32 v1, s7, v48
	v_add_nc_u32_e32 v59, s7, v49
	v_add_nc_u32_e32 v2, s7, v47
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_mov_b32 s7, s4
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v3, s27, v43
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v1, s4 :: v_dual_add_nc_u32 v60, s27, v45
	v_mov_b32_e32 v5, s8
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v37, v53 :: v_dual_add_f32 v34, v34, v52
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v32, v32, v52 :: v_dual_add_f32 v29, v29, v55
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
; %bb.11:
	...
	ds_load_b128 v[95:98], v46 offset:2048
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v86, v30, v1 :: v_dual_lshlrev_b32 v43, 1, v43
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v53, v32, v53 :: v_dual_add_f32 v54, v31, v54
	...
	v_dual_mul_f32 v19, v19, v59 :: v_dual_mul_f32 v20, v20, v58
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v17, v17, v50 :: v_dual_and_b32 v36, 1, v36
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v33, v33, v73 :: v_dual_mul_f32 v32, v32, v74
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b16 v17.h, 0x7fff, v32.h, s16
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 157
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 40
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     42
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
