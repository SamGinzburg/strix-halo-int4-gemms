	...
	.text
	.globl	amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8                          ; -- Begin function amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.p2align	8
	.type	amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8,@function
amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8:                                 ; @amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph
	...
	s_clause 0x6
	s_load_b32 s56, s[0:1], 0x6c
	s_load_b32 s57, s[0:1], 0x84
	...
	v_dual_mov_b32 v49, v0 :: v_dual_add_nc_u32 v2, v2, v9
	...
	v_dual_mov_b32 v50, 0 :: v_dual_add_nc_u32 v3, 0, v6
	v_dual_mov_b32 v53, v0 :: v_dual_add_nc_u32 v2, 0, v8
	v_mov_b32_e32 v55, v0
	scratch_store_b32 off, v3, off offset:44 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v227, s38, v5
	scratch_store_b32 off, v2, off offset:52 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v2, 0, v11
	v_dual_mov_b32 v51, v0 :: v_dual_add_nc_u32 v232, 0, v10
	v_dual_mov_b32 v54, 0 :: v_dual_mov_b32 v57, v0
	...
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v59, v0
	v_dual_mov_b32 v58, 0 :: v_dual_mov_b32 v61, v0
	v_dual_mov_b32 v60, 0 :: v_dual_mov_b32 v63, v0
	v_dual_mov_b32 v62, 0 :: v_dual_mov_b32 v65, v0
	v_dual_mov_b32 v64, 0 :: v_dual_mov_b32 v67, v0
	v_dual_mov_b32 v66, 0 :: v_dual_mov_b32 v69, v0
	v_dual_mov_b32 v68, 0 :: v_dual_mov_b32 v71, v0
	v_dual_mov_b32 v70, 0 :: v_dual_mov_b32 v73, v0
	v_dual_mov_b32 v72, 0 :: v_dual_mov_b32 v75, v0
	v_dual_mov_b32 v74, 0 :: v_dual_mov_b32 v77, v0
	v_dual_mov_b32 v76, 0 :: v_dual_mov_b32 v79, v0
	v_dual_mov_b32 v78, 0 :: v_dual_mov_b32 v81, v0
	v_dual_mov_b32 v80, 0 :: v_dual_mov_b32 v83, v0
	v_dual_mov_b32 v82, 0 :: v_dual_mov_b32 v85, v0
	v_dual_mov_b32 v84, 0 :: v_dual_mov_b32 v87, v0
	v_dual_mov_b32 v86, 0 :: v_dual_mov_b32 v89, v0
	v_dual_mov_b32 v88, 0 :: v_dual_mov_b32 v91, v0
	v_dual_mov_b32 v90, 0 :: v_dual_mov_b32 v93, v0
	v_dual_mov_b32 v92, 0 :: v_dual_mov_b32 v95, v0
	v_dual_mov_b32 v94, 0 :: v_dual_mov_b32 v97, v0
	v_dual_mov_b32 v96, 0 :: v_dual_mov_b32 v99, v0
	v_dual_mov_b32 v98, 0 :: v_dual_mov_b32 v101, v0
	v_dual_mov_b32 v100, 0 :: v_dual_mov_b32 v103, v0
	v_dual_mov_b32 v102, 0 :: v_dual_mov_b32 v105, v0
	v_dual_mov_b32 v104, 0 :: v_dual_mov_b32 v107, v0
	v_dual_mov_b32 v106, 0 :: v_dual_mov_b32 v109, v0
	v_dual_mov_b32 v108, 0 :: v_dual_mov_b32 v111, v0
	v_dual_mov_b32 v110, 0 :: v_dual_mov_b32 v113, v0
	v_dual_mov_b32 v112, 0 :: v_dual_mov_b32 v115, v0
	v_dual_mov_b32 v114, 0 :: v_dual_mov_b32 v117, v0
	v_dual_mov_b32 v116, 0 :: v_dual_mov_b32 v119, v0
	v_dual_mov_b32 v118, 0 :: v_dual_mov_b32 v121, v0
	v_dual_mov_b32 v120, 0 :: v_dual_mov_b32 v123, v0
	v_dual_mov_b32 v122, 0 :: v_dual_mov_b32 v125, v0
	v_dual_mov_b32 v124, 0 :: v_dual_mov_b32 v127, v0
	v_dual_mov_b32 v126, 0 :: v_dual_mov_b32 v129, v0
	v_dual_mov_b32 v128, 0 :: v_dual_mov_b32 v131, v0
	v_dual_mov_b32 v130, 0 :: v_dual_mov_b32 v133, v0
	v_dual_mov_b32 v132, 0 :: v_dual_mov_b32 v135, v0
	v_dual_mov_b32 v134, 0 :: v_dual_mov_b32 v137, v0
	v_dual_mov_b32 v136, 0 :: v_dual_mov_b32 v139, v0
	v_dual_mov_b32 v138, 0 :: v_dual_mov_b32 v141, v0
	v_dual_mov_b32 v140, 0 :: v_dual_mov_b32 v143, v0
	v_dual_mov_b32 v142, 0 :: v_dual_mov_b32 v145, v0
	v_dual_mov_b32 v144, 0 :: v_dual_mov_b32 v147, v0
	v_dual_mov_b32 v146, 0 :: v_dual_mov_b32 v149, v0
	v_dual_mov_b32 v148, 0 :: v_dual_mov_b32 v151, v0
	v_dual_mov_b32 v150, 0 :: v_dual_mov_b32 v153, v0
	v_dual_mov_b32 v152, 0 :: v_dual_mov_b32 v155, v0
	v_dual_mov_b32 v154, 0 :: v_dual_mov_b32 v157, v0
	v_dual_mov_b32 v156, 0 :: v_dual_mov_b32 v159, v0
	v_lshl_add_u32 v236, s46, 2, v31
	s_lshl_b32 s59, s30, 2
	s_lshl_b32 s60, s60, 1
	s_sub_i32 s61, 0, s35
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 193 31                        ; kda_gluon.py:193:31
	v_cndmask_b32_e64 v1, 0x80000000, v212, s1
	v_cndmask_b32_e64 v2, 0x80000000, v227, s0
	...
	s_mov_b32 s38, s42
	s_mov_b32 s39, s43
	v_dual_mov_b32 v197, v235 :: v_dual_add_nc_u32 v212, s58, v212
	...
	v_dual_mov_b32 v192, v174 :: v_dual_add_nc_u32 v227, s58, v227
	.loc	1 193 31                        ; kda_gluon.py:193:31
...
.Ltmp16:
	...
	.loc	1 267 21                        ; kda_gluon.py:267:21
	v_cndmask_b32_e64 v2, 0x80000000, v226, s18
	.loc	1 311 21                        ; kda_gluon.py:311:21
	v_add_nc_u32_e32 v226, s60, v226
	.loc	1 274 28                        ; kda_gluon.py:274:28
...
.Ltmp93:
	...
	v_mul_f32_e32 v0, s57, v0
	.loc	1 292 13                        ; kda_gluon.py:292:13
	v_dual_fmac_f32 v32, v12, v244 :: v_dual_mul_f32 v1, s57, v1
...
.Ltmp130:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8, .Lfunc_end0-amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_vgpr, 256
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_agpr, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.numbered_sgpr, 64
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.private_seg_size, 80
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_recursion, 0
	.set amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8"                        ; string offset=88 ; amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8
    .private_segment_fixed_size: 80
    .sgpr_count:     66
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_kda_fwd_cache_int4xbf16_b7_t2048_h48_d128_dv128_vb64_ci8.kd
