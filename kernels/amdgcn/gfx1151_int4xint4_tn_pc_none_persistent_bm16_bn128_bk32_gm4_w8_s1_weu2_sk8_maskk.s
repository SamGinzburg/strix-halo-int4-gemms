	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp12:
	...
	v_xor_b32_e32 v7, 12, v2
	v_xor_b32_e32 v29, 16, v2
	v_xor_b32_e32 v30, 20, v2
	v_readfirstlane_b32 s6, v9
	v_mad_u64_u32 v[9:10], null, s21, v6, v[1:2]
	...
	v_lshl_add_u32 v21, v8, 3, v11
	v_mad_u64_u32 v[10:11], null, s20, v3, v[8:9]
	s_mul_i32 s7, s7, s6
	.loc	1 222 36                        ; generate_amdgcn.py:222:36
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v41, s39, v10
	s_lshl_b32 s6, s6, 7
	s_mov_b32 s41, s1
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s41, v20
	...
	s_cmp_lg_u32 s42, 0
	.loc	1 232 26                        ; generate_amdgcn.py:232:26
	buffer_load_u8 v45, v43, s[12:15], 0 offen
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
...
.LBB0_6:                                ; %._crit_edge
	...
	.loc	1 242 18                        ; generate_amdgcn.py:242:18
	buffer_load_u16 v49, v0, s[16:19], 0 offen
	.loc	1 243 26                        ; generate_amdgcn.py:243:26
	...
	buffer_load_u16 v51, v2, s[8:11], 0 offen
	...
	buffer_load_u16 v52, v0, s[8:11], 0 offen
	...
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v51, v49, v51 :: v_dual_lshlrev_b32 v52, 16, v52
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v44, v51, v44
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v46, v49, v46
	v_dual_mul_f32 v47, v49, v47 :: v_dual_lshlrev_b32 v50, 16, v50
	.loc	1 243 18 is_stmt 1              ; generate_amdgcn.py:243:18
	v_lshlrev_b32_e32 v6, 16, v6
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v48, v49, v48 :: v_dual_lshlrev_b32 v7, 16, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v41, v46, v41 :: v_dual_mul_f32 v50, v49, v50
	v_dual_mul_f32 v5, v47, v5 :: v_dual_mul_f32 v6, v49, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v4, v48, v4 :: v_dual_mul_f32 v7, v49, v7
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v49, v49, v52
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v45, v50, v45
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v6, v6, v43 :: v_dual_mul_f32 v7, v7, v42
...
.Ltmp13:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 77
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm16_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
