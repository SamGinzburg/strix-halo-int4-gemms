...
.Ltmp11:
	...
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	v_lshl_add_u32 v53, s25, 4, v25
	.loc	1 297 13                        ; generate_amdgcn.py:297:13
	s_mul_hi_u32 s2, s9, s10
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	v_lshl_add_u32 v54, s25, 5, v25
	.loc	1 297 13                        ; generate_amdgcn.py:297:13
	s_add_i32 s9, s9, s2
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
...
.Ltmp13:
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v41, v19, s[16:19], 0 offen
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v27, v19, s[16:19], 0 offen
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x3
	...
	buffer_load_b128 v[37:40], v24, s[20:23], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v59, v9, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_add_i32 s30, s3, 0
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v35, v35, v69 :: v_dual_add_nc_u32 v204, s1, v58
	v_dual_add_f32 v32, v32, v72 :: v_dual_add_nc_u32 v205, s30, v57
	...
	v_dual_add_f32 v34, v34, v70 :: v_dual_add_f32 v33, v33, v71
	v_dual_add_f32 v30, v30, v74 :: v_dual_add_f32 v31, v31, v73
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 38
