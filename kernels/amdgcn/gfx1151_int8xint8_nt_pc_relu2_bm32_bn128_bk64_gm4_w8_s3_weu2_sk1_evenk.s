	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_xor_b32_e32 v36, v18, v5
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_and_b32_e32 v18, 15, v0
	v_and_b32_e32 v5, 48, v25
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v30, 0, v36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b64 v29, v[23:24] offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v30, v[6:9]
	s_waitcnt vmcnt(3)
	ds_store_b128 v30, v[10:13] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v29, v[27:28] offset:18432
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v30, v[14:17] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v30, v[19:22] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_3
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_lshl_or_b32 v27, v18, 6, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshl_or_b32 v31, v26, 5, v27
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v28, 16, v27
	v_xor_b32_e32 v30, 32, v27
	v_xor_b32_e32 v29, 48, v27
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v32, 16, v31
	v_xor_b32_e32 v33, 32, v31
	v_xor_b32_e32 v34, 48, v31
	s_clause 0x1
...
.Ltmp15:
	...
	s_mov_b32 s6, s4
	s_mov_b32 s7, s4
	v_add3_u32 v37, v4, v3, 0x80
	v_add3_u32 v38, v5, v1, 0x80
	v_mov_b32_e32 v14, 0
	v_add3_u32 v39, v6, v1, 0x80
	v_mov_b32_e32 v1, s4
	v_xor_b32_e32 v29, 48, v27
	v_xor_b32_e32 v32, 16, v31
	v_xor_b32_e32 v33, 32, v31
	...
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v8, s11
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[108:109], v37, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[56:59], v38, s[20:23], 0 offen
	buffer_load_b128 v[60:63], v39, s[20:23], 0 offen
	s_mov_b32 s7, s4
	s_mov_b32 s6, s29
	...
	ds_load_b128 v[68:71], v40 offset:1024
	ds_load_b128 v[72:75], v41
	ds_load_b128 v[76:79], v41 offset:1024
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[80:83], v45
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[84:87], v42
	ds_load_b128 v[88:91], v42 offset:1024
	ds_load_b128 v[92:95], v43
	ds_load_b128 v[96:99], v43 offset:1024
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[100:103], v46
	ds_load_b128 v[104:107], v47
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s5, s5, 1
	s_mov_b32 s4, s28
	s_cmp_lt_i32 s5, 2
	...
	v_wmma_i32_16x16x16_iu8 v[40:47], v[64:67], v[48:51], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(9)
	v_wmma_i32_16x16x16_iu8 v[48:55], v[64:67], v[68:71], v[1:8] neg_lo:[1,1,0]
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_add_i32 s28, s7, 0
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[40:47], v[80:83], v[72:75], v[40:47] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_waitcnt lgkmcnt(0)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[40:47], v[100:103], v[84:87], v[40:47] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_barrier
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[48:55], v[100:103], v[88:91], v[48:55] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[40:47], v[104:107], v[92:95], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[48:55], v[104:107], v[96:99], v[48:55] neg_lo:[1,1,0]
	...
	v_dual_add_f32 v14, v14, v40 :: v_dual_add_nc_u32 v39, 64, v39
	v_dual_add_f32 v25, v25, v41 :: v_dual_add_nc_u32 v38, 64, v38
	v_dual_add_f32 v24, v24, v42 :: v_dual_add_nc_u32 v37, 64, v37
	v_dual_add_f32 v15, v15, v50 :: v_dual_add_nc_u32 v110, s6, v35
	v_dual_add_f32 v10, v10, v54 :: v_dual_add_nc_u32 v111, s28, v36
	v_dual_add_f32 v23, v23, v43 :: v_dual_add_f32 v22, v22, v44
	v_dual_add_f32 v21, v21, v45 :: v_dual_add_f32 v20, v20, v46
	v_add_f32_e32 v19, v19, v47
	v_dual_add_f32 v17, v17, v48 :: v_dual_add_f32 v16, v16, v49
	v_dual_add_f32 v13, v13, v51 :: v_dual_add_f32 v12, v12, v52
	v_add_f32_e32 v11, v11, v53
	v_add_f32_e32 v9, v9, v55
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v110, v[108:109] offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v111, v[56:59]
	s_waitcnt vmcnt(0)
	ds_store_b128 v111, v[60:63] offset:4096
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.7:
	...
	v_add_nc_u32_e32 v2, s29, v30
	ds_load_b128 v[71:74], v3 offset:1024
	ds_load_b128 v[75:78], v3
	v_add_nc_u32_e32 v35, s29, v29
	ds_load_b128 v[83:86], v35
	ds_load_b128 v[87:90], v35 offset:1024
	ds_load_b128 v[67:70], v2
	ds_load_b128 v[79:82], v2 offset:1024
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_wmma_i32_16x16x16_iu8 v[35:42], v[55:58], v[63:66], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[35:42], v[51:54], v[75:78], v[35:42] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[35:42], v[47:50], v[67:70], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[35:42], v[43:46], v[83:86], v[35:42] neg_lo:[1,1,0]
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[1:8], v[55:58], v[59:62], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v41, v41
	v_cvt_f32_i32_e32 v42, v42
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v25, v25, v36 :: v_dual_add_f32 v22, v22, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[1:8], v[51:54], v[71:74], v[1:8] neg_lo:[1,1,0]
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_add_f32_e32 v20, v20, v41
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[47:50], v[79:82], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[1:8], v[43:46], v[87:90], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v23, v23, v38 :: v_dual_add_f32 v12, v12, v1
	v_add_f32_e32 v19, v19, v42
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v11, v11, v2 :: v_dual_add_f32 v10, v10, v3
	v_dual_add_f32 v9, v9, v4 :: v_dual_add_f32 v14, v14, v5
.LBB0_8:
...
; %bb.9:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[47:50], v[55:58], v[27:34] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[27:34], v[47:50], v[51:54], v[27:34] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[43:46], v[67:70], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[27:34], v[43:46], v[63:66], v[27:34] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[39:42], v[59:62], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[27:34], v[39:42], v[71:74], v[27:34] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[35:38], v[75:78], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[27:34], v[35:38], v[79:82], v[27:34] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cvt_f32_i32_e32 v1, v1
	v_cvt_f32_i32_e32 v2, v2
	v_cvt_f32_i32_e32 v3, v3
...
.LBB0_10:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 399 13 is_stmt 1              ; generate_amdgcn.py:399:13
	v_dual_add_f32 v1, v14, v1 :: v_dual_lshlrev_b32 v26, 1, v26
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_or_b32_e32 v28, 32, v27
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v35, v17, v35 :: v_dual_add_f32 v36, v16, v36
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	...
	v_or_b32_e32 v30, 8, v26
	s_and_b32 s5, s15, 0xffff
	s_mov_b32 s4, s14
	v_or_b32_e32 v31, 12, v26
	v_or_b32_e32 v32, 16, v26
	v_or_b32_e32 v33, 20, v26
	v_or_b32_e32 v34, 24, v26
	v_or_b32_e32 v43, 28, v26
	s_clause 0x7
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v15, v37 :: v_dual_add_f32 v38, v13, v38
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v16, v16, v36, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v39, v12, v39 :: v_dual_add_f32 v40, v11, v40
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v15, v15, v37, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v24, v3 :: v_dual_add_f32 v4, v23, v4
	v_dual_add_f32 v41, v10, v41 :: v_dual_add_f32 v42, v9, v42
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_cndmask_b32_e64 v9, v9, v42, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_cndmask_b32_e64 v14, v17, v35, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_mul_f32_e32 v37, v27, v26
	v_dual_mul_f32 v26, v28, v26 :: v_dual_lshlrev_b32 v31, 16, v31
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	...
	v_add3_u32 v18, s5, v44, v18
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v40, v27, v31
	v_mul_f32_e32 v38, v27, v29
	v_dual_mul_f32 v42, v27, v33 :: v_dual_mul_f32 v31, v28, v31
	v_mul_f32_e32 v29, v28, v29
	v_mul_f32_e32 v43, v27, v34
	v_mul_f32_e32 v41, v27, v32
	v_dual_mul_f32 v27, v27, v36 :: v_dual_mul_f32 v30, v28, v30
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v2, v2, v38 :: v_dual_mul_f32 v13, v13, v31
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v32, v28, v32
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v4, v4, v40 :: v_dual_mul_f32 v15, v15, v30
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_max_f32_e32 v2, 0, v2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v34, v28, v34 :: v_dual_mul_f32 v3, v3, v39
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v16, v16, v29
	v_dual_mul_f32 v12, v12, v32 :: v_dual_max_f32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v15, 0, v15 :: v_dual_mul_f32 v2, v2, v2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v33, v28, v33
	v_dual_mul_f32 v28, v28, v36 :: v_dual_mul_f32 v5, v5, v41
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v6, v6, v42 :: v_dual_max_f32 v3, 0, v3
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v4, 0, v4 :: v_dual_max_f32 v13, 0, v13
	v_dual_max_f32 v16, 0, v16 :: v_dual_mul_f32 v1, v1, v1
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_mul_f32_e32 v15, v15, v15
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v17.l, v2.h
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v14, v14, v26 :: v_dual_mul_f32 v7, v7, v43
	v_dual_mul_f32 v8, v8, v27 :: v_dual_mul_f32 v9, v9, v28
	v_dual_mul_f32 v11, v11, v33 :: v_dual_mul_f32 v10, v10, v34
	...
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v17, 1, v17
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v45.l, v1.h
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v14, 0, v14 :: v_dual_max_f32 v7, 0, v7
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v14, v14, v14 :: v_dual_mul_f32 v7, v7, v7
	v_dual_mul_f32 v8, v8, v8 :: v_dual_mul_f32 v9, v9, v9
	v_dual_mul_f32 v12, v12, v12 :: v_dual_and_b32 v19, 1, v19
	...
	v_add3_u32 v1, v4, v26, 0x7fff
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v21, 1, v21
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add3_u32 v5, v5, v20, 0x7fff
	v_mov_b16_e32 v1.l, v3.h
	v_and_b32_e32 v3, 1, v45
	v_mov_b16_e32 v45.l, v14.h
	v_add3_u32 v4, v6, v17, 0x7fff
	v_dual_mov_b32 v46, 0x5410 :: v_dual_lshlrev_b32 v35, 1, v18
	...
	v_cndmask_b32_e32 v4, 0x1054, v46, vcc_lo
	v_dual_cndmask_b32 v6, 0x3276, v47 :: v_dual_and_b32 v7, 1, v45
	...
	v_mov_b16_e32 v16.l, v3.h
	v_add3_u32 v3, v13, v7, 0x7fff
	...
	v_dual_cndmask_b32 v9, v6, v16 :: v_dual_cndmask_b32 v6, v16, v6
	...
	v_add_lshl_u32 v8, v18, s3, 1
	s_mov_b32 s3, s7
	s_clause 0x1
	buffer_store_b128 v[0:3], v35, s[0:3], 0 offen
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 112
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
