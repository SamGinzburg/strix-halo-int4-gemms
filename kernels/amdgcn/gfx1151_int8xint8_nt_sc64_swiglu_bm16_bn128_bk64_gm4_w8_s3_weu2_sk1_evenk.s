	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s12, v3, v[2:3]
...
.Ltmp19:
	...
	buffer_load_b32 v49, v2, s[4:7], 0 offen
	...
	buffer_load_b128 v[25:28], v15, s[28:31], 0 offen
	buffer_load_b128 v[29:32], v16, s[28:31], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v50, v2, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[33:36], v3, s[28:31], 0 offen
	buffer_load_b128 v[37:40], v6, s[28:31], 0 offen
	buffer_load_b128 v[41:44], v7, s[28:31], 0 offen
	buffer_load_b128 v[45:48], v8, s[28:31], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(9)
	ds_store_b32 v51, v49 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(8)
	ds_store_b128 v52, v[17:20]
	s_waitcnt vmcnt(7)
	ds_store_b128 v52, v[21:24] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(6)
	ds_store_b128 v52, v[25:28] offset:16384
	s_waitcnt vmcnt(5)
	ds_store_b128 v52, v[29:32] offset:20480
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v51, v50 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v52, v[33:36] offset:8192
	s_waitcnt vmcnt(2)
	ds_store_b128 v52, v[37:40] offset:12288
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v52, v[41:44] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v52, v[45:48] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_and_b32_e32 v17, 48, v3
	s_mov_b32 s10, 0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v55, v1, 6, v17
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshl_or_b32 v51, v2, 5, v55
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v58, 16, v55
	v_xor_b32_e32 v60, 32, v55
	v_xor_b32_e32 v62, 48, v55
...
.LBB0_3:                                ; %Flow162
	...
	s_ashr_i32 s1, s14, 6
	v_or_b32_e32 v48, s22, v4
	v_or_b32_e32 v49, s22, v8
	v_or_b32_e32 v47, s22, v14
	v_mul_lo_u32 v50, v33, s1
	v_or_b32_e32 v46, s22, v15
	v_or_b32_e32 v45, s22, v16
	v_or_b32_e32 v44, s22, v5
	v_or_b32_e32 v43, s22, v6
	v_or_b32_e32 v42, s22, v7
	v_add_nc_u32_e32 v41, s23, v4
	v_add_nc_u32_e32 v40, s23, v8
	v_add_nc_u32_e32 v39, s23, v14
	v_add_nc_u32_e32 v37, s23, v15
	v_add_nc_u32_e32 v35, s23, v16
	v_add_nc_u32_e32 v38, s23, v5
	v_add_nc_u32_e32 v36, s23, v6
	v_add_nc_u32_e32 v34, s23, v7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v15, v50, s14, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s14, s14, s34
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v16, v48, s14, 1
	v_add_lshl_u32 v56, v49, s14, 1
	v_add_lshl_u32 v57, v47, s14, 1
	.loc	1 396 39                        ; generate_amdgcn.py:396:39
	s_add_i32 s15, s14, s22
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v59, v46, s14, 1
	v_add_lshl_u32 v61, v45, s14, 1
	v_add_lshl_u32 v63, v44, s14, 1
	v_add_lshl_u32 v64, v43, s14, 1
	v_add_lshl_u32 v65, v42, s14, 1
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_add_lshl_u32 v66, v41, s15, 1
	v_add_lshl_u32 v67, v40, s15, 1
	v_add_lshl_u32 v68, v39, s15, 1
	v_add_lshl_u32 v69, v37, s15, 1
	v_add_lshl_u32 v70, v35, s15, 1
	v_add_lshl_u32 v71, v38, s15, 1
	v_add_lshl_u32 v72, v36, s15, 1
	v_add_lshl_u32 v73, v34, s15, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_dual_cndmask_b32 v15, 0x80000000, v15 :: v_dual_cndmask_b32 v16, 0x80000000, v16
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v14, v14, s[4:7], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v56, 0x80000000, v56 :: v_dual_cndmask_b32 v57, 0x80000000, v57
	v_dual_cndmask_b32 v59, 0x80000000, v59 :: v_dual_cndmask_b32 v64, 0x80000000, v64
	v_dual_cndmask_b32 v61, 0x80000000, v61 :: v_dual_cndmask_b32 v66, 0x80000000, v66
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v63, 0x80000000, v63 :: v_dual_cndmask_b32 v68, 0x80000000, v68
	v_dual_cndmask_b32 v65, 0x80000000, v65 :: v_dual_cndmask_b32 v70, 0x80000000, v70
	.loc	1 396 31                        ; generate_amdgcn.py:396:31
	v_dual_cndmask_b32 v67, 0x80000000, v67 :: v_dual_cndmask_b32 v72, 0x80000000, v72
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v63, s16, v9
	v_add_nc_u32_e32 v64, s16, v10
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v65, s17, v9
	v_add_nc_u32_e32 v66, s17, v10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[79:82], v63, s[28:31], 0 offen
	buffer_load_b128 v[83:86], v64, s[28:31], 0 offen
	buffer_load_b128 v[87:90], v65, s[28:31], 0 offen
	buffer_load_b128 v[91:94], v66, s[28:31], 0 offen
	s_mov_b32 s14, s0
	s_mov_b32 s15, s12
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v63, s14, v55
	v_add_nc_u32_e32 v64, s14, v58
	v_add_nc_u32_e32 v65, s14, v60
	s_mov_b32 s16, s10
	v_add_nc_u32_e32 v66, s14, v62
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v67, s15, v51
	v_add_nc_u32_e32 v68, s15, v52
	v_add_nc_u32_e32 v69, s15, v53
	v_add_nc_u32_e32 v70, s15, v54
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v75, s16, v51
	v_add_nc_u32_e32 v76, s16, v52
	v_add_nc_u32_e32 v77, s16, v53
	v_add_nc_u32_e32 v78, s16, v54
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[95:98], v63
	ds_load_b128 v[99:102], v64
	ds_load_b128 v[103:106], v65
	ds_load_b128 v[107:110], v66
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[71:74], v67
	ds_load_b128 v[111:114], v68
	ds_load_b128 v[115:118], v69
	ds_load_b128 v[119:122], v70
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[123:126], v75
	ds_load_b128 v[127:130], v76
	...
	s_barrier
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s48, s14, 0
	s_mov_b32 s12, s44
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_lshl_b32 s15, s48, 10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_lshl_b32 s16, s48, 13
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_add_i32 s15, s15, 0
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_add_i32 s44, s16, 0
	...
	v_wmma_i32_16x16x16_iu8 v[63:70], v[71:74], v[95:98], v[1:8] neg_lo:[1,1,0]
	s_mov_b32 s10, s35
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_add_i32 s45, s15, 0x8000
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[71:78], v[123:126], v[95:98], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[63:70], v[111:114], v[99:102], v[63:70] neg_lo:[1,1,0]
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_add_i32 s35, s44, 0x4000
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmp_lg_u32 s13, s47
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[71:78], v[127:130], v[99:102], v[71:78] neg_lo:[1,1,0]
	s_mov_b32 s13, s14
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[63:70], v[115:118], v[103:106], v[63:70] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[71:78], v[131:134], v[103:106], v[71:78] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[63:70], v[119:122], v[107:110], v[63:70] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[71:78], v[135:138], v[107:110], v[71:78] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cvt_f32_i32_e32 v66, v66
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v150, s15, v12
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(21)
	ds_store_b32 v150, v14 offset:32768
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(20)
	...
	v_dual_fmac_f32 v32, v98, v72 :: v_dual_lshlrev_b32 v97, 16, v142
	v_fmac_f32_e32 v28, v99, v73
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v24, v101, v75 :: v_dual_mul_f32 v97, v14, v97
	v_dual_fmac_f32 v17, v97, v71 :: v_dual_lshlrev_b32 v96, 16, v141
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v96, v14, v96 :: v_dual_lshlrev_b32 v57, 16, v59
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v59, 16, v61
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v18, v96, v70 :: v_dual_lshlrev_b32 v61, 16, v139
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v57, v14, v57
	v_mul_f32_e32 v59, v14, v59
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v95, 16, v140
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v61, v14, v61
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v27, v57, v66 :: v_dual_fmac_f32 v22, v59, v67
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v95, v14, v95
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v23, v61, v68 :: v_dual_lshlrev_b32 v102, 16, v147
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v56, v14, v56 :: v_dual_fmac_f32 v19, v95, v69
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v26, v56, v65 :: v_dual_mul_f32 v15, v14, v15
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v151, s44, v13
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_fmac_f32_e32 v25, v102, v76
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v30, v15, v63
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v151, v[79:82]
	s_waitcnt vmcnt(2)
	ds_store_b128 v151, v[83:86] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v151, v[87:90] offset:16384
	s_waitcnt vmcnt(0)
	ds_store_b128 v151, v[91:94] offset:20480
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_fmac_f32 v29, v100, v74 :: v_dual_mul_f32 v104, v14, v104
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 398 33                        ; generate_amdgcn.py:398:33
	v_dual_mul_f32 v14, v14, v103 :: v_dual_fmac_f32 v21, v104, v78
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_fmac_f32_e32 v20, v14, v77
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_7:                                ; %Flow163
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v1, s0, v55
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cndmask_b32_e64 v56, 0, 1, s3
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v2, s0, v58
	v_dual_mov_b32 v64, 0 :: v_dual_add_nc_u32 v3, s0, v60
	v_dual_mov_b32 v67, 0 :: v_dual_add_nc_u32 v4, s0, v62
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
; %bb.8:
	v_dual_mov_b32 v66, 0 :: v_dual_add_nc_u32 v57, s12, v52
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v56, s12, v51
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v68, v66 :: v_dual_add_nc_u32 v59, s12, v53
	v_mov_b32_e32 v67, v66
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[74:77], v56
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v69, v66 :: v_dual_add_nc_u32 v56, s12, v54
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	v_wmma_i32_16x16x16_iu8 v[66:73], v[74:77], v[13:16], v[66:73] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[66:73], v[78:81], v[9:12], v[66:73] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[66:73], v[86:89], v[5:8], v[66:73] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[66:73], v[82:85], v[1:4], v[66:73] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v2, s45, v58
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cndmask_b32_e64 v58, 0, 1, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v3, s45, v60
	v_mov_b32_e32 v60, 0
	v_dual_mov_b32 v79, 0 :: v_dual_add_nc_u32 v4, s45, v62
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
; %bb.12:
	v_mov_b32_e32 v78, 0
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v58, s44, v51
	v_add_nc_u32_e32 v60, s44, v52
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v85, v78 :: v_dual_add_nc_u32 v62, s44, v53
	v_mov_b32_e32 v79, v78
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[105:108], v58
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v83, v78 :: v_dual_add_nc_u32 v58, s44, v54
	v_mov_b32_e32 v81, v78
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[109:112], v60
	ds_load_b128 v[113:116], v58
...
; %bb.14:
	v_dual_mov_b32 v105, 0 :: v_dual_add_nc_u32 v52, s35, v52
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v51, s35, v51
	v_add_nc_u32_e32 v55, s35, v54
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_dual_mov_b32 v107, v105 :: v_dual_add_nc_u32 v84, s35, v53
...
.LBB0_15:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v37, v37, v59, v19
	v_fma_f32 v51, v52, v61, v18
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 152
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
