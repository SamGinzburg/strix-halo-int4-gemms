...
.Ltmp13:
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b64 v[23:24], v9, s[16:19], 0 offen
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[14:17], v1, s[20:23], 0 offen
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v25, 0, v39
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v8, v[10:13] offset:4096
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_waitcnt vmcnt(3)
	ds_store_b64 v25, v[6:7] offset:16384
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
...
.Ltmp14:
	...
	s_mov_b32 s10, s4
	s_mov_b32 s11, s4
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v1, 48, v9
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v24, 0
	v_dual_mov_b32 v23, 0 :: v_dual_mov_b32 v20, 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v28, v22, 6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s0, s31
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b64 v[108:109], v40, s[16:19], 0 offen
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	...
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[56:59], v41, s[20:23], 0 offen
	buffer_load_b128 v[60:63], v42, s[20:23], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	v_dual_add_f32 v13, v13, v53 :: v_dual_add_nc_u32 v146, s6, v39
	v_dual_add_f32 v18, v18, v48 :: v_dual_add_nc_u32 v147, s1, v38
	...
	v_dual_add_f32 v17, v17, v49 :: v_dual_add_f32 v16, v16, v50
	v_dual_add_f32 v15, v15, v51 :: v_dual_add_f32 v14, v14, v52
	v_dual_add_f32 v11, v11, v55 :: v_dual_add_f32 v12, v12, v54
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_add_i32 s0, s5, 1
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.8:
	...
	v_dual_add_f32 v23, v23, v4 :: v_dual_add_f32 v18, v18, v3
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v13, v13, v3 :: v_dual_add_f32 v14, v14, v2
...
.LBB0_11:
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v2, v10, v2 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 379 22                        ; generate_amdgcn.py:379:22
	v_or3_b32 v22, v22, v27, s24
	.loc	1 378 14                        ; generate_amdgcn.py:378:14
	s_mov_b32 s4, s12
	.loc	1 299 32                        ; generate_amdgcn.py:299:32
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_add_f32 v3, v26, v3 :: v_dual_lshlrev_b32 v22, 1, v22
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	...
	v_or_b32_e32 v29, 8, v22
	v_or_b32_e32 v30, 12, v22
	v_or_b32_e32 v31, 16, v22
	v_or_b32_e32 v41, 20, v22
	v_or_b32_e32 v42, 24, v22
	v_or_b32_e32 v43, 28, v22
	s_clause 0x7
	...
	v_dual_add_f32 v32, v19, v32 :: v_dual_add_f32 v33, v18, v33
	...
	v_cndmask_b32_e64 v20, v19, v32, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_and_b32_e32 v3, 0x3f8, v47
	.loc	1 392 23 is_stmt 0              ; generate_amdgcn.py:392:23
	v_add3_u32 v1, s0, v1, v2
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v32, v13, v38, s2
	v_cndmask_b32_e64 v17, v17, v34, s2
	v_cndmask_b32_e64 v34, v11, v40, s2
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	...
	v_cndmask_b32_e64 v24, v14, v37, s2
	v_cndmask_b32_e64 v33, v12, v39, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_mov_b32 s0, 0
	...
	v_xad_u32 v36, v4, 8, 0
	v_xad_u32 v37, v4, 16, 0
	v_add_co_u32 v18, vcc_lo, s26, v2
	v_xad_u32 v38, v4, 24, 0
	v_xad_u32 v39, v4, 32, 0
	v_xad_u32 v40, v4, 40, 0
	...
	v_dual_mul_f32 v11, v3, v11 :: v_dual_mul_f32 v28, v2, v4
	v_mul_f32_e32 v44, v2, v27
	v_mul_f32_e32 v27, v3, v27
	v_dual_mul_f32 v43, v2, v22 :: v_dual_lshlrev_b32 v16, 16, v41
	v_mul_f32_e32 v49, v3, v14
	v_mul_f32_e32 v31, v2, v13
	v_mul_f32_e32 v13, v3, v13
	v_dual_mul_f32 v4, v3, v4 :: v_dual_mul_f32 v41, v2, v14
	...
	v_mul_f32_e32 v2, v10, v28
	v_dual_mul_f32 v3, v6, v4 :: v_dual_mul_f32 v6, v25, v30
	v_mul_f32_e32 v4, v26, v29
	v_mul_f32_e32 v10, v5, v31
	v_dual_mul_f32 v5, v17, v11 :: v_dual_mul_f32 v14, v7, v42
	v_mul_f32_e32 v11, v15, v13
	v_mul_f32_e32 v13, v24, v49
	v_dual_mul_f32 v12, v23, v41 :: v_dual_mul_f32 v7, v21, v48
	v_mul_f32_e32 v21, v34, v27
	v_mul_f32_e32 v16, v8, v43
	v_dual_mul_f32 v20, v20, v44 :: v_dual_mul_f32 v17, v33, v22
