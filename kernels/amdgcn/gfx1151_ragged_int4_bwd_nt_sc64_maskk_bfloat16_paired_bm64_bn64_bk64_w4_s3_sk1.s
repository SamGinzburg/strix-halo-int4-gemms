	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
.Lfunc_begin0:
...
.LBB0_2:                                ;   in Loop: Header=BB0_3 Depth=1
	...
	v_dual_mul_f32 v27, v179, v27 :: v_dual_add_nc_u32 v34, 32, v34
	.loc	1 1213 40                       ; ragged.py:1213:40
	s_waitcnt vmcnt(3)
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v1, v1, v180 :: v_dual_add_nc_u32 v50, 32, v50
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v16, v180, v16 :: v_dual_lshlrev_b32 v195, 16, v195
	v_dual_mul_f32 v23, v179, v23 :: v_dual_add_nc_u32 v46, 32, v46
	v_dual_mul_f32 v30, v179, v30 :: v_dual_add_nc_u32 v39, 32, v39
	v_dual_mul_f32 v17, v179, v17 :: v_dual_add_nc_u32 v40, 32, v40
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v26, v179, v26 :: v_dual_add_nc_u32 v35, 32, v35
	v_dual_mul_f32 v29, v179, v29 :: v_dual_add_nc_u32 v36, 32, v36
	.loc	1 1219 17                       ; ragged.py:1219:17
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v28, v179, v28 :: v_dual_add_nc_u32 v37, 32, v37
	v_dual_mul_f32 v31, v179, v31 :: v_dual_add_nc_u32 v38, 32, v38
	v_dual_mul_f32 v32, v179, v32 :: v_dual_add_nc_u32 v41, 32, v41
	v_dual_mul_f32 v19, v179, v19 :: v_dual_add_nc_u32 v42, 32, v42
	v_dual_mul_f32 v18, v179, v18 :: v_dual_add_nc_u32 v43, 32, v43
	v_dual_mul_f32 v21, v179, v21 :: v_dual_add_nc_u32 v44, 32, v44
	v_dual_mul_f32 v20, v179, v20 :: v_dual_add_nc_u32 v45, 32, v45
	v_dual_mul_f32 v22, v179, v22 :: v_dual_add_nc_u32 v47, 32, v47
	v_dual_mul_f32 v25, v25, v179 :: v_dual_add_nc_u32 v48, 32, v48
	v_dual_mul_f32 v24, v179, v24 :: v_dual_add_nc_u32 v49, 32, v49
	v_dual_mul_f32 v2, v180, v2 :: v_dual_add_nc_u32 v51, 32, v51
	v_dual_mul_f32 v3, v180, v3 :: v_dual_add_nc_u32 v52, 32, v52
	v_dual_mul_f32 v4, v180, v4 :: v_dual_add_nc_u32 v53, 32, v53
	v_dual_mul_f32 v5, v180, v5 :: v_dual_add_nc_u32 v54, 32, v54
	v_dual_mul_f32 v6, v180, v6 :: v_dual_add_nc_u32 v55, 32, v55
	v_dual_mul_f32 v7, v180, v7 :: v_dual_add_nc_u32 v56, 32, v56
	v_dual_mul_f32 v8, v180, v8 :: v_dual_add_nc_u32 v57, 32, v57
	v_dual_mul_f32 v9, v180, v9 :: v_dual_add_nc_u32 v58, 32, v58
	v_dual_mul_f32 v10, v180, v10 :: v_dual_add_nc_u32 v59, 32, v59
	v_dual_mul_f32 v11, v180, v11 :: v_dual_add_nc_u32 v60, 32, v60
	v_dual_mul_f32 v12, v180, v12 :: v_dual_add_nc_u32 v61, 32, v61
	v_dual_mul_f32 v13, v180, v13 :: v_dual_add_nc_u32 v62, 32, v62
	v_dual_mul_f32 v14, v180, v14 :: v_dual_add_nc_u32 v63, 32, v63
	v_dual_mul_f32 v15, v180, v15 :: v_dual_add_nc_u32 v64, 32, v64
	.loc	1 1213 40                       ; ragged.py:1213:40
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 219
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 97
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1
    .private_segment_fixed_size: 0
    .sgpr_count:     99
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc64_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.kd
