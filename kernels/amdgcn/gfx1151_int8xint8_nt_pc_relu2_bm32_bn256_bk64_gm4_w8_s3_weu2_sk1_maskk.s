	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v55, s30, 6, v10
	v_lshl_add_u32 v56, s30, 7, v10
...
.Ltmp13:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v16, s33, v54
	v_or_b32_e32 v17, s33, v9
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s4, s4, 64
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v26, s33, v57
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[165:166], v61, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[93:96], v62, s[24:27], 0 offen
	buffer_load_b128 v[97:100], v61, s[24:27], 0 offen
	buffer_load_b128 v[101:104], v63, s[24:27], 0 offen
	buffer_load_b128 v[105:108], v64, s[24:27], 0 offen
	...
	v_dual_add_f32 v43, v43, v62 :: v_dual_add_f32 v42, v42, v63
	v_dual_add_f32 v41, v41, v64 :: v_dual_add_f32 v40, v40, v65
	v_dual_add_f32 v39, v39, v66 :: v_dual_add_f32 v38, v38, v67
	v_dual_add_f32 v37, v37, v68 :: v_dual_add_f32 v36, v36, v69
	v_dual_add_f32 v35, v35, v70 :: v_dual_add_f32 v34, v34, v71
	...
	v_dual_add_f32 v22, v22, v83 :: v_dual_add_f32 v27, v27, v78
	v_add_f32_e32 v20, v20, v85
	v_dual_add_f32 v26, v26, v79 :: v_dual_add_f32 v25, v25, v80
	v_add_f32_e32 v18, v18, v86
	v_dual_add_f32 v23, v23, v82 :: v_dual_add_f32 v16, v16, v88
	v_dual_add_f32 v21, v21, v84 :: v_dual_add_f32 v14, v14, v90
...
; %bb.8:
	...
	v_dual_add_f32 v24, v24, v55 :: v_dual_add_f32 v15, v15, v2
	v_dual_add_f32 v23, v23, v56 :: v_dual_add_f32 v22, v22, v57
	v_add_f32_e32 v13, v13, v4
	v_dual_add_f32 v21, v21, v10 :: v_dual_add_f32 v14, v14, v3
	v_dual_add_f32 v12, v12, v5 :: v_dual_add_f32 v19, v19, v6
.LBB0_9:
...
; %bb.10:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[90:93], v[62:65], v[46:53] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[82:85], v[110:113], v[4:11] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[54:61], v[78:81], v[110:113], v[54:61] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[62:69], v[82:85], v[106:109], v[62:69] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[46:53], v[78:81], v[106:109], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[74:77], v[102:105], v[4:11] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[118:121], v[114:117], v[4:11] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
...
.LBB0_11:
	...
	v_dual_add_f32 v4, v19, v4 :: v_dual_lshlrev_b32 v47, 1, v3
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	s_delay_alu instid0(VALU_DEP_2)
	v_or_b32_e32 v46, 32, v2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v11, v37, v11 :: v_dual_add_f32 v48, v36, v54
	v_dual_add_f32 v49, v35, v55 :: v_dual_add_f32 v50, v34, v56
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	buffer_load_u16 v3, v2, s[4:7], 0 offen
	buffer_load_u16 v2, v46, s[4:7], 0 offen
	...
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_and_b32_e32 v47, 0xf0, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v51, v33, v57 :: v_dual_add_f32 v52, v32, v58
	v_dual_add_f32 v53, v31, v59 :: v_dual_add_f32 v54, v30, v60
	v_dual_add_f32 v55, v29, v61 :: v_dual_add_f32 v56, v28, v62
	v_dual_add_f32 v57, v27, v63 :: v_dual_add_f32 v58, v26, v64
	v_dual_add_f32 v59, v25, v65 :: v_dual_add_f32 v60, v24, v66
	v_dual_add_f32 v61, v23, v67 :: v_dual_add_f32 v62, v22, v68
	v_dual_add_f32 v63, v21, v69 :: v_dual_add_f32 v64, v20, v70
	v_dual_add_f32 v65, v18, v71 :: v_dual_add_f32 v66, v17, v72
	v_dual_add_f32 v67, v16, v73 :: v_dual_add_f32 v68, v15, v74
	v_dual_add_f32 v69, v14, v75 :: v_dual_add_f32 v70, v13, v76
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_mov_b32 v74, 0x7632 :: v_dual_and_b32 v45, 28, v45
	v_dual_mov_b32 v73, 0x5410 :: v_dual_and_b32 v72, 32, v1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v76, v19, v4, s2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_lshl_add_u32 v4, v47, 2, 0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v41, v7 :: v_dual_add_f32 v8, v40, v8
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v43, v43, v5, s2
	v_cndmask_b32_e64 v34, v34, v50, s2
	v_cndmask_b32_e64 v50, v16, v67, s2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_lshl_add_u32 v16, v47, 1, 0
	v_add3_u32 v4, v4, v72, v45
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v9, v39, v9 :: v_dual_add_f32 v10, v38, v10
	v_dual_add_f32 v71, v12, v77 :: v_dual_and_b32 v0, 16, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_cndmask_b32_e64 v48, v18, v65, s2
	v_cndmask_b32_e64 v49, v17, v66, s2
	v_cndmask_b32_e64 v51, v15, v68, s2
	v_cndmask_b32_e64 v52, v14, v69, s2
	v_cndmask_b32_e64 v53, v13, v70, s2
	v_cndmask_b32_e64 v54, v12, v71, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_mul_lo_u32 v44, s15, v44
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	v_cndmask_b32_e64 v20, v20, v64, s2
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_lshl_add_u32 v67, s15, 4, v44
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v22, v22, v62, s2
	v_cndmask_b32_e64 v26, v26, v58, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add_lshl_u32 v44, v66, v44, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v75, v8, v3 :: v_dual_mul_f32 v6, v6, v2
	...
	v_dual_mul_f32 v17, v17, v2 :: v_dual_mul_f32 v42, v42, v71
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v43, v43, v70 :: v_dual_mul_f32 v40, v40, v75
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v77, v9, v3
	v_dual_mul_f32 v78, v10, v3 :: v_dual_mul_f32 v5, v5, v2
	v_mul_f32_e32 v81, v13, v3
	v_dual_mul_f32 v82, v14, v3 :: v_dual_mul_f32 v11, v11, v2
	v_mul_f32_e32 v83, v15, v3
	v_dual_mul_f32 v84, v16, v3 :: v_dual_mul_f32 v13, v13, v2
	v_dual_mul_f32 v86, v18, v3 :: v_dual_mul_f32 v15, v15, v2
	v_dual_mul_f32 v3, v19, v3 :: v_dual_mul_f32 v38, v38, v78
	v_mul_f32_e32 v9, v9, v2
	v_mul_f32_e32 v10, v10, v2
	v_mul_f32_e32 v14, v14, v2
	v_mul_f32_e32 v16, v16, v2
	v_mul_f32_e32 v18, v18, v2
	v_dual_mul_f32 v2, v19, v2 :: v_dual_mul_f32 v19, v76, v67
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v7, v25, v7 :: v_dual_mul_f32 v12, v20, v12
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mul_f32 v17, v52, v17 :: v_dual_mul_f32 v2, v54, v2
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v20, 0, v43 :: v_dual_mul_f32 v41, v41, v72
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v34, v34, v82 :: v_dual_mul_f32 v37, v37, v79
	v_dual_mul_f32 v32, v32, v84 :: v_dual_mul_f32 v11, v21, v11
	v_dual_mul_f32 v16, v51, v16 :: v_dual_mul_f32 v15, v50, v15
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_max_f32_e32 v19, 0, v19
	v_max_f32_e32 v21, 0, v42
	v_dual_max_f32 v17, 0, v17 :: v_dual_mul_f32 v20, v20, v20
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v39, v39, v77 :: v_dual_mul_f32 v36, v36, v80
	v_dual_mul_f32 v5, v27, v5 :: v_dual_mul_f32 v10, v22, v10
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_max_f32_e32 v22, 0, v41
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v31, v31, v85 :: v_dual_mul_f32 v6, v26, v6
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v26, 0, v37 :: v_dual_max_f32 v15, 0, v15
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v3, v29, v3 :: v_dual_mul_f32 v8, v24, v8
	v_dual_mul_f32 v9, v23, v9 :: v_dual_mul_f32 v14, v49, v14
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v23, 0, v40 :: v_dual_max_f32 v24, 0, v39
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_mul_f32_e32 v21, v21, v21
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v35, v35, v81 :: v_dual_mul_f32 v30, v30, v86
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v29, 0, v34 :: v_dual_max_f32 v32, 0, v32
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v15, v15, v15 :: v_dual_mul_f32 v34, v2, v2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v33, v33, v83 :: v_dual_mul_f32 v4, v28, v4
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v25, 0, v38 :: v_dual_max_f32 v28, 0, v35
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add3_u32 v2, v20, v2, 0x7fff
	v_and_b32_e32 v35, 1, v47
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v27, 0, v36 :: v_dual_max_f32 v30, 0, v30
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v23, v23, v23 :: v_dual_mul_f32 v26, v26, v26
	v_dual_mul_f32 v17, v17, v17 :: v_dual_and_b32 v36, 1, v55
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_and_b32_e32 v20, 1, v1
	v_mov_b16_e32 v1.l, v24.h
	v_add3_u32 v19, v19, v35, 0x7fff
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v25, v25, v25 :: v_dual_mul_f32 v28, v28, v28
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v33, 0, v33 :: v_dual_max_f32 v4, 0, v4
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v33, v33, v33 :: v_dual_mul_f32 v4, v4, v4
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add3_u32 v23, v23, v37, 0x7fff
	v_mov_b16_e32 v1.l, v28.h
	v_add3_u32 v0, v26, v20, 0x7fff
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v31, v31, v31 :: v_dual_and_b32 v38, 1, v57
	...
	v_dual_cndmask_b32 v22, v21, v2 :: v_dual_and_b32 v39, 1, v45
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v9, v9, v9 :: v_dual_and_b32 v42, 1, v59
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_cndmask_b32 v29, v3, v23 :: v_dual_and_b32 v46, 1, v62
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v13, v48, v13 :: v_dual_mul_f32 v18, v53, v18
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_cndmask_b32 v23, v23, v3 :: v_dual_and_b32 v48, 1, v64
	v_cndmask_b32_e32 v20, v20, v24, vcc_lo
	v_and_b32_e32 v24, 0x5040504, v2
	v_and_b32_e32 v21, 0x7060706, v21
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v11, v11, v11 :: v_dual_and_b32 v30, 1, v1
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v13, v13, v13 :: v_dual_mul_f32 v18, v18, v18
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_cndmask_b32 v19, v23, v26 :: v_dual_and_b32 v50, 1, v68
	...
	v_dual_cndmask_b32 v12, v0, v11 :: v_dual_and_b32 v49, 1, v65
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_dual_cndmask_b32 v0, v11, v0 :: v_dual_and_b32 v1, 1, v1
	s_delay_alu instid0(VALU_DEP_3)
	...
	s_clause 0x3
	buffer_store_b128 v[2:5], v44, s[12:15], 0 offen
	buffer_store_b128 v[6:9], v44, s[12:15], 0 offen offset:256
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 169
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
