...
.Ltmp23:
	...
	v_cndmask_b32_e64 v49, v49, v109, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_fma_f32 v101, v105, v182, v49
	v_fma_f32 v102, v106, v183, v28
	v_fma_f32 v103, v107, v184, v52
	...
	v_cndmask_b32_e64 v21, v49, v101, s2
	v_cndmask_b32_e64 v28, v28, v102, s2
	v_cndmask_b32_e64 v40, v52, v103, s2
	...
	v_cndmask_b32_e64 v49, v59, v109, s2
	...
	v_dual_max_f32 v37, v39, v39 :: v_dual_max_f32 v40, v42, v42
	v_dual_max_f32 v42, v44, v44 :: v_dual_max_f32 v21, v21, v21
	v_dual_max_f32 v44, v49, v49 :: v_dual_max_f32 v49, v56, v56
	...
	v_dual_max_f32 v48, v55, v55 :: v_dual_max_f32 v55, 0, v49
	v_dual_max_f32 v52, v58, v58 :: v_dual_max_f32 v49, v60, v60
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_max_f32 v81, 0, v52 :: v_dual_max_f32 v48, v59, v59
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v37, 0, v37 :: v_dual_max_f32 v46, v51, v51
	v_dual_max_f32 v44, 0, v44 :: v_dual_max_f32 v39, 0, v39
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v8, v222, v89
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v51, v57, v57 :: v_dual_max_f32 v20, v20, v20
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v51, 0, v51 :: v_dual_max_f32 v20, 0, v20
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, v23, v23 :: v_dual_max_f32 v88, 0, v53
	v_dual_max_f32 v53, v67, v67 :: v_dual_max_f32 v48, v64, v64
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 84
