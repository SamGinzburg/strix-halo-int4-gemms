	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v147, 0xff800000 :: v_dual_lshlrev_b32 v48, 9, v0
	v_dual_mov_b32 v151, 0xff800000 :: v_dual_lshlrev_b32 v52, 5, v0
	...
	v_dual_mov_b32 v228, 0xff800000 :: v_dual_add_nc_u32 v155, 0, v45
	...
	v_xor_b32_e32 v107, 0x120, v160
	v_xor_b32_e32 v108, 0x1b0, v160
	v_xor_b32_e32 v109, 0x240, v160
	v_xor_b32_e32 v110, 0x2d0, v160
	v_xor_b32_e32 v111, 0x360, v160
	v_xor_b32_e32 v112, 0x3f0, v160
	v_mad_u64_u32 v[134:135], null, s81, 3, v[132:133]
	.loc	1 871 27                        ; attention.py:871:27
	s_mul_i32 s3, s83, s8
	v_add_nc_u32_e32 v162, 0, v72
	v_add_nc_u32_e32 v166, 0, v76
	...
	v_add_nc_u32_e32 v219, 0, v107
	v_add_nc_u32_e32 v220, 0, v108
	v_add_nc_u32_e32 v221, 0, v109
	v_add_nc_u32_e32 v222, 0, v110
	v_add_nc_u32_e32 v223, 0, v111
	v_dual_mov_b32 v135, v17 :: v_dual_add_nc_u32 v224, 0, v112
	...
	scratch_store_b32 off, v73, off offset:88 ; 4-byte Folded Spill
	...
	v_add_nc_u32_e32 v161, 0, v60
	v_and_b32_e32 v139, 0x5040504, v48
	...
	v_add_nc_u32_e32 v217, v46, v113
	scratch_store_b32 off, v0, off offset:52 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v0, 0, v57
	v_add_nc_u32_e32 v218, 0, v54
	v_and_b32_e32 v140, 0x7060706, v42
	...
	v_add_nc_u32_e32 v163, 0, v73
	v_dual_mov_b32 v13, v17 :: v_dual_add_nc_u32 v164, 0, v74
	...
	v_dual_mov_b32 v11, v17 :: v_dual_add_nc_u32 v216, 0, v106
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v100, s83, v134, 1
	.loc	1 881 25                        ; attention.py:881:25
...
.Ltmp4:
	...
	v_permlanex16_b32 v170, v169, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
.Ltmp5:
	...
	v_permlanex16_b32 v169, v66, s99, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v169, v68, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v169, v70, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v169, v72, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	...
	v_permlanex16_b32 v89, v66, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v89, v68, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v89, v70, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v89, v72, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_permlanex16_b32 v81, v66, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v81, v68, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v81, v70, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v81, v72, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1)
...
.Ltmp15:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v73, v66, s99, 0xfedcba98 op_sel:[1,0]
.Ltmp16:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:883:29 ]
...
.Ltmp28:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v73, v68, s99, 0xfedcba98 op_sel:[1,0]
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max_f32_e32 v83, v83, v84
...
.Ltmp36:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v73, v70, s99, 0xfedcba98 op_sel:[1,0]
	.loc	1 886 62                        ; attention.py:886:62
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v73, v72, s99, 0xfedcba98 op_sel:[1,0]
...
.Ltmp140:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 100
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 112
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
    .private_segment_fixed_size: 112
    .sgpr_count:     102
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.kd
