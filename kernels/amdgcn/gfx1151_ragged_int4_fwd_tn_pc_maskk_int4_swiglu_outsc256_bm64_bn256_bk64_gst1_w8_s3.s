...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v3, v1 :: v_dual_lshlrev_b32 v8, 3, v167
	...
	v_dual_mov_b32 v23, v1 :: v_dual_add_nc_u32 v150, 0, v17
	...
	v_dual_mov_b32 v25, v1 :: v_dual_add_nc_u32 v0, 0, v15
	...
	v_dual_mov_b32 v41, v1 :: v_dual_add_nc_u32 v158, 0, v28
	v_dual_mov_b32 v18, v1 :: v_dual_add_nc_u32 v159, 0, v6
	scratch_store_b32 off, v0, off offset:48 ; 4-byte Folded Spill
	v_dual_mov_b32 v31, v1 :: v_dual_add_nc_u32 v0, 0, v20
	v_dual_mov_b32 v43, v1 :: v_dual_add_nc_u32 v160, 0, v8
	v_mov_b32_e32 v6, v1
	...
	v_dual_mov_b32 v45, v1 :: v_dual_add_nc_u32 v162, 0, v177
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_waitcnt vmcnt(0)
	v_or_b32_e32 v163, s3, v0
	scratch_load_b32 v0, off, off offset:4  ; 4-byte Folded Reload
	.loc	1 1070 38                       ; ragged.py:1070:38
	v_mad_u64_u32 v[173:174], null, v163, s33, v[130:131]
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e32 vcc_lo, s21, v163
	.loc	1 1059 22                       ; ragged.py:1059:22
	v_or_b32_e32 v163, 1, v163
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1070 38                       ; ragged.py:1070:38
	v_mad_u64_u32 v[174:175], null, v163, s33, v[130:131]
	v_add_nc_u32_e32 v164, s34, v173
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s0, s21, v163
	...
	v_add_nc_u32_e32 v165, s34, v174
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 1070 30                       ; ragged.py:1070:30
	v_cndmask_b32_e64 v169, 0x80000000, v165, s0
	s_clause 0x1
	...
	v_mad_u64_u32 v[163:164], null, v165, s2, v[129:130]
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v165
	.loc	1 1070 30                       ; ragged.py:1070:30
	...
	v_cndmask_b32_e64 v166, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 1, v165
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v163
	.loc	1 1069 38                       ; ragged.py:1069:38
	v_mad_u64_u32 v[163:164], null, v163, s2, v[129:130]
	.loc	1 1069 62 is_stmt 0             ; ragged.py:1069:62
	s_and_b32 s1, s29, s1
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 1069 30                       ; ragged.py:1069:30
	v_cndmask_b32_e64 v172, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 2, v165
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v163
	.loc	1 1069 38                       ; ragged.py:1069:38
	v_mad_u64_u32 v[163:164], null, v163, s2, v[129:130]
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 1069 30                       ; ragged.py:1069:30
	v_cndmask_b32_e64 v180, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 3, v165
	.loc	1 1069 30                       ; ragged.py:1069:30
	s_clause 0x2
	buffer_load_u8 v218, v166, s[4:7], 0 offen
	buffer_load_u8 v219, v172, s[4:7], 0 offen
	buffer_load_u8 v220, v180, s[4:7], 0 offen
	.loc	1 1070 30                       ; ragged.py:1070:30
	...
	.loc	1 1069 30 is_stmt 0             ; ragged.py:1069:30
	v_cndmask_b32_e64 v181, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 4, v165
	...
	s_and_b32 s1, s29, s1
	.loc	1 1069 30                       ; ragged.py:1069:30
	v_cndmask_b32_e64 v182, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 5, v165
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v163
	.loc	1 1069 38                       ; ragged.py:1069:38
	...
	s_and_b32 s1, s29, s1
	.loc	1 1069 30                       ; ragged.py:1069:30
	v_cndmask_b32_e64 v183, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 7, v165
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v163
	.loc	1 1069 38                       ; ragged.py:1069:38
	...
	s_and_b32 s1, s29, s1
	.loc	1 1069 30                       ; ragged.py:1069:30
	v_cndmask_b32_e64 v184, 0x80000000, v163, s1
	.loc	1 1059 22 is_stmt 1             ; ragged.py:1059:22
	v_or_b32_e32 v163, 6, v165
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 1060 27                       ; ragged.py:1060:27
	v_cmp_gt_i32_e64 s1, s21, v163
	.loc	1 1069 38                       ; ragged.py:1069:38
	...
	s_clause 0x4
	buffer_load_u8 v213, v183, s[4:7], 0 offen
	buffer_load_u8 v214, v184, s[4:7], 0 offen
	buffer_load_u8 v215, v163, s[4:7], 0 offen
	buffer_load_u8 v216, v182, s[4:7], 0 offen
	buffer_load_u8 v217, v181, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	scratch_load_b32 v0, off, off offset:8  ; 4-byte Folded Reload
	.loc	1 1096 25                       ; ragged.py:1096:25
	v_add_nc_u32_e32 v181, s35, v173
	.loc	1 1070 30                       ; ragged.py:1070:30
	v_lshrrev_b32_e32 v173, 24, v179
	.loc	1 1096 25                       ; ragged.py:1096:25
	v_add_nc_u32_e32 v182, s35, v174
	...
	v_lshlrev_b16 v163.l, 8, v219.l
	v_or_b16 v165.h, v215.l, v163.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_or_b16 v164.l, v218.l, v163.l
	s_waitcnt vmcnt(1)
	v_lshlrev_b16 v163.l, 8, v217.l
	v_or_b16 v164.h, v220.l, v163.l
	.loc	1 1070 30                       ; ragged.py:1070:30
	...
	v_cndmask_b32_e32 v163, 0x80000000, v181, vcc_lo
	v_cndmask_b32_e64 v164, 0x80000000, v182, s0
	.loc	1 1070 30                       ; ragged.py:1070:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1095 35                       ; ragged.py:1095:35
	s_clause 0x1
	buffer_load_b128 v[181:184], v163, s[12:15], 0 offen
	buffer_load_b128 v[185:188], v164, s[12:15], 0 offen
	s_waitcnt vmcnt(0)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v156, v218
	ds_store_b8 v156, v219 offset:64
	ds_store_b8 v156, v220 offset:128
	...
	ds_load_u8 v136, v162 offset:1744
	ds_load_u8 v137, v162 offset:1680
	ds_load_u8 v138, v162 offset:1760
	ds_load_u8 v139, v162 offset:1696
	ds_load_u8 v140, v162 offset:1776
	ds_load_u8 v141, v162 offset:1712
	ds_load_u8 v142, v162 offset:1664
	ds_load_u8 v143, v162 offset:1600
	ds_load_u8 v144, v162 offset:1616
	ds_load_u8 v145, v162 offset:1552
	ds_load_u8 v146, v162 offset:1632
	ds_load_u8 v147, v162 offset:1568
	ds_load_u8 v148, v162 offset:1648
	ds_load_u8 v149, v162 offset:1584
	.loc	1 1095 35                       ; ragged.py:1095:35
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_perm_b32 v143, v231, v143, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 1100 32                       ; ragged.py:1100:32
	v_lshl_or_b32 v169, v135, 16, v143
...
.LBB0_7:                                ; %._crit_edge
	...
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s3, s[24:25], v[1:2]
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s4, s[26:27], v[1:2]
	.loc	1 1044 32 is_stmt 1             ; ragged.py:1044:32
	...
	v_or_b32_e32 v1, s31, v167
	s_delay_alu instid0(VALU_DEP_1)
	v_mad_u64_u32 v[1:2], null, s33, s28, v[1:2]
	.loc	1 1114 36                       ; ragged.py:1114:36
...
.Ltmp63:
	...
	.loc	1 1249 13                       ; ragged.py:1249:13
	v_mad_u64_u32 v[10:11], null, v36, s5, v[6:7]
	.loc	1 1248 9                        ; ragged.py:1248:9
	...
	.loc	1 1249 13 is_stmt 1             ; ragged.py:1249:13
	v_mad_u64_u32 v[10:11], null, v7, s5, v[6:7]
	.loc	1 1248 9                        ; ragged.py:1248:9
	v_or_b16 v8.h, v2.l, v1.l
	...
	.loc	1 1249 13                       ; ragged.py:1249:13
	v_mad_u64_u32 v[11:12], null, v9, s5, v[6:7]
	.loc	1 1046 20                       ; ragged.py:1046:20
	s_and_b32 s3, s3, s4
	.loc	1 1249 13                       ; ragged.py:1249:13
	v_mad_u64_u32 v[12:13], null, v13, s5, v[6:7]
	.loc	1 1248 9                        ; ragged.py:1248:9
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_pc_maskk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 36
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_pc_maskk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 92
