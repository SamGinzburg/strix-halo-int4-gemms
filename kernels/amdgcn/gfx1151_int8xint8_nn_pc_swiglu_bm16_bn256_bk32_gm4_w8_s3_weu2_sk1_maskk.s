...
.Ltmp13:
	...
	s_mov_b32 s6, 0
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v45, v42, 4, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add3_u32 v1, s18, s4, v45
	...
	.loc	1 408 22 is_stmt 0              ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v52, v42, 9, v44
	.loc	1 414 39 is_stmt 1              ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v11, s31, v10
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v19, s35, v46
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v47, v18, v46, s2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v53, 0x90, v52
	v_add_nc_u32_e32 v63, 0, v52
	v_xor_b32_e32 v54, 0x110, v52
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, vcc_lo, s29
	s_cmp_gt_i32 s5, 63
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v65, 0, v54
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v18, s35, v44
	v_or_b32_e32 v36, s35, v46
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	v_cmp_gt_i32_e64 s3, s30, v18
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v18, s31, v1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 s3, s3, s2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v1, 0x80000000, v1, s3
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v22, 0x80000000, v18, s3
	s_clause 0x1
	buffer_load_b128 v[18:21], v1, s[20:23], 0 offen
	buffer_load_b128 v[22:25], v22, s[20:23], 0 offen
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e64 v1, 0x80000000, v26, s3
	v_cndmask_b32_e64 v30, 0x80000000, v27, s3
	s_clause 0x1
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v34, 0x17e, v43
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s30, v36
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_u16 v61, v1, s[12:15], 0 offen
	v_bfe_i32 v1, v0, 6, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v35, 0x90, v1
	v_xor_b32_e32 v51, v35, v34
	...
	buffer_load_u16 v66, v34, s[12:15], 0 offen
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(8)
	...
	v_lshrrev_b32_e32 v70, 24, v38
	v_and_b16 v9.h, 0xff, v38.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(2)
	v_perm_b32 v38, v14, v10, 0x5010400
	v_perm_b32 v71, v14, v10, 0x7030602
	v_perm_b32 v72, v15, v11, 0x5010400
	v_perm_b32 v73, v15, v11, 0x7030602
	v_perm_b32 v74, v16, v12, 0x5010400
	v_perm_b32 v75, v16, v12, 0x7030602
	v_perm_b32 v76, v17, v13, 0x5010400
	v_perm_b32 v77, v17, v13, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v10.l, 8, v39.l
	v_lshlrev_b16 v10.h, 8, v40.l
	v_lshlrev_b16 v11.l, 8, v34.l
	v_lshlrev_b16 v11.h, 8, v55.l
	v_lshlrev_b16 v12.l, 8, v56.l
	v_lshlrev_b16 v12.h, 8, v57.l
	v_lshlrev_b16 v13.l, 8, v35.l
	v_lshlrev_b16 v13.h, 8, v58.l
	v_lshlrev_b16 v14.l, 8, v59.l
	v_lshlrev_b16 v14.h, 8, v60.l
	v_lshlrev_b16 v15.l, 8, v36.l
	...
	v_and_b16 v55.l, 0xff, v77.l
	v_lshrrev_b32_e32 v76, 8, v77
	v_lshrrev_b32_e32 v78, 24, v77
	v_and_b16 v55.h, 0xff, v77.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v77, v22, v18, 0x5010400
	v_perm_b32 v22, v22, v18, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v83, v30, v26, 0x5010400
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v79, v23, v19, 0x5010400
	v_perm_b32 v23, v23, v19, 0x7030602
	v_perm_b32 v80, v24, v20, 0x5010400
	v_perm_b32 v24, v24, v20, 0x7030602
	v_perm_b32 v81, v25, v21, 0x5010400
	v_perm_b32 v82, v25, v21, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v10.l, 8, v56.l
	v_lshlrev_b16 v11.l, 8, v58.l
	v_lshlrev_b16 v14.h, 8, v71.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v56, 8, v77
	v_or_b16 v2.h, v2.h, v10.h
	v_or_b16 v3.h, v3.h, v11.h
	v_or_b16 v7.l, v7.l, v15.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v10.h, 8, v57.l
	v_lshlrev_b16 v11.h, 8, v59.l
	v_lshlrev_b16 v15.l, 8, v72.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v57, 24, v77
	v_or_b16 v4.l, v4.l, v12.l
	v_or_b16 v7.h, v7.h, v15.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v12.l, 8, v60.l
	v_lshlrev_b16 v15.h, 8, v73.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v58, 8, v22
	v_or_b16 v4.h, v4.h, v12.h
	v_or_b16 v8.l, v8.l, v16.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v12.h, 8, v67.l
	v_lshlrev_b16 v16.l, 8, v74.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v59, 24, v22
	v_or_b16 v9.h, v9.h, v17.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v17.h, 8, v78.l
	...
	v_or_b16 v10.l, v34.l, v10.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v63, v2
	ds_store_b16_d16_hi v63, v2 offset:32
	...
	v_lshlrev_b16 v38.h, 8, v78.l
	v_and_b16 v33.l, 0xff, v87.l
	v_and_b16 v33.h, 0xff, v87.h
	v_or_b16 v5.l, v37.l, v13.l
	v_or_b16 v5.h, v37.h, v13.h
	v_or_b16 v10.h, v38.l, v14.l
	v_or_b16 v13.l, v40.h, v16.h
	v_or_b16 v13.h, v55.l, v17.l
	v_or_b16 v14.l, v55.h, v17.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v16.h, 8, v60.l
	v_lshlrev_b16 v17.l, 8, v67.l
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v63, v2 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v63, v2 offset:16416
	...
	v_or_b16 v12.h, v28.h, v55.l
	v_or_b16 v13.l, v29.l, v55.h
	v_or_b16 v13.h, v29.h, v56.l
	v_or_b16 v14.l, v30.l, v56.h
	v_or_b16 v14.h, v30.h, v57.l
	v_or_b16 v15.l, v31.l, v57.h
	v_or_b16 v15.h, v31.h, v58.l
	v_or_b16 v16.l, v32.l, v58.h
	v_or_b16 v16.h, v32.h, v59.l
	v_or_b16 v17.l, v33.l, v59.h
	v_or_b16 v17.h, v33.h, v60.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v63, v2 offset:8192
	ds_store_b16_d16_hi v63, v2 offset:8224
	ds_store_b16 v63, v3 offset:8256
	ds_store_b16_d16_hi v63, v3 offset:8288
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v63, v10 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v64, v4 offset:8192
	ds_store_b16_d16_hi v64, v4 offset:8224
	ds_store_b16 v64, v5 offset:8256
	ds_store_b16_d16_hi v64, v5 offset:8288
	ds_store_b16 v65, v6 offset:8192
	ds_store_b16_d16_hi v65, v6 offset:8224
	ds_store_b16 v65, v7 offset:8256
	ds_store_b16_d16_hi v65, v7 offset:8288
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b16 v62, v66 offset:33280
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v63, v11 offset:24640
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v63, v8 offset:8576
	ds_store_b16_d16_hi v63, v8 offset:8608
	ds_store_b16 v63, v9 offset:8640
	ds_store_b16_d16_hi v63, v9 offset:8672
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v63, v10 offset:24608
	ds_store_b16_d16_hi v63, v11 offset:24672
	ds_store_b16 v64, v12 offset:24576
	ds_store_b16_d16_hi v64, v12 offset:24608
	ds_store_b16 v64, v13 offset:24640
	ds_store_b16_d16_hi v64, v13 offset:24672
	ds_store_b16 v65, v14 offset:24576
	ds_store_b16_d16_hi v65, v14 offset:24608
	ds_store_b16 v65, v15 offset:24640
	ds_store_b16_d16_hi v65, v15 offset:24672
	ds_store_b16 v63, v16 offset:24960
	ds_store_b16_d16_hi v63, v16 offset:24992
	ds_store_b16 v63, v17 offset:25024
	ds_store_b16_d16_hi v63, v17 offset:25056
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_mov_b32 s3, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v56, 0x160, v57
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_or_b32 v55, 0x60, v57, v3
	s_branch .LBB0_3
.LBB0_2:
...
.Ltmp14:
	...
	v_and_b32_e32 v56, 0x160, v49
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v57, s31, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_or_b32 v55, 0x60, v49, v1
	v_xor_b32_e32 v1, v2, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_or_b32_e32 v58, v2, v56
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v12, 0
	v_mov_b32_e32 v26, 0
	v_or_b32_e32 v59, v55, v1
	v_mov_b32_e32 v1, s4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_u16 v138, v62, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_dual_cndmask_b32 v62, 0x80000000, v66 :: v_dual_cndmask_b32 v63, 0x80000000, v63
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[94:97], v65, s[20:23], 0 offen
	buffer_load_b128 v[98:101], v62, s[20:23], 0 offen
	buffer_load_b128 v[102:105], v63, s[20:23], 0 offen
	buffer_load_b128 v[106:109], v64, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v62, s6, v58
	v_add_nc_u32_e32 v63, s6, v60
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v64, s7, v59
	v_add_nc_u32_e32 v65, s7, v61
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v66, s8, v59
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[110:113], v62
	ds_load_b128 v[114:117], v63
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[70:73], v64
	ds_load_b128 v[78:81], v64 offset:4096
	ds_load_b128 v[118:121], v65
	ds_load_b128 v[122:125], v65 offset:4096
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[86:89], v66
	ds_load_b128 v[126:129], v66 offset:4096
	ds_load_b128 v[130:133], v67
	ds_load_b128 v[134:137], v67 offset:4096
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lt_i32 s3, 2
	s_mov_b32 s4, s33
	...
	v_wmma_i32_16x16x16_iu8 v[62:69], v[70:73], v[110:113], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[70:77], v[78:81], v[110:113], v[1:8] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[78:85], v[86:89], v[110:113], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[62:69], v[118:121], v[114:117], v[62:69] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[86:93], v[126:129], v[110:113], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[78:85], v[130:133], v[114:117], v[78:85] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[70:77], v[122:125], v[114:117], v[70:77] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4)
	v_cvt_f32_i32_e32 v63, v63
	v_cvt_f32_i32_e32 v64, v64
	v_cvt_f32_i32_e32 v66, v66
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[86:93], v[134:137], v[114:117], v[86:93] neg_lo:[1,1,0]
	...
	v_dual_add_f32 v30, v30, v69 :: v_dual_add_nc_u32 v139, s3, v51
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v9, v9, v78 :: v_dual_add_nc_u32 v140, s33, v52
	v_dual_add_f32 v10, v10, v79 :: v_dual_add_nc_u32 v141, s33, v53
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v33, v33, v76 :: v_dual_add_nc_u32 v142, s33, v54
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v16, v16, v67 :: v_dual_add_f32 v29, v29, v68
	v_dual_add_f32 v32, v32, v71 :: v_dual_add_f32 v31, v31, v70
	v_dual_add_f32 v40, v40, v73 :: v_dual_add_f32 v27, v27, v80
	v_dual_add_f32 v39, v39, v72 :: v_dual_add_f32 v24, v24, v75
	v_dual_add_f32 v23, v23, v74 :: v_dual_add_f32 v34, v34, v77
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v11, v11, v82 :: v_dual_add_f32 v28, v28, v81
	v_dual_add_f32 v19, v19, v84 :: v_dual_add_f32 v20, v20, v85
	v_add_f32_e32 v35, v35, v88
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v25, v25, v62 :: v_dual_add_f32 v12, v12, v83
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v21, v21, v86 :: v_dual_add_f32 v22, v22, v87
	v_dual_add_f32 v13, v13, v90 :: v_dual_add_f32 v36, v36, v89
	v_dual_add_f32 v17, v17, v92 :: v_dual_add_f32 v14, v14, v91
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(4)
	ds_store_b16 v139, v138 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v63, v98, v94, 0x5010400
	v_perm_b32 v64, v98, v94, 0x7030602
	v_perm_b32 v66, v99, v95, 0x7030602
	v_perm_b32 v65, v99, v95, 0x5010400
	v_perm_b32 v67, v100, v96, 0x5010400
	v_perm_b32 v68, v100, v96, 0x7030602
	v_perm_b32 v69, v101, v97, 0x5010400
	v_perm_b32 v70, v101, v97, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v71, v106, v102, 0x5010400
	v_perm_b32 v72, v106, v102, 0x7030602
	v_perm_b32 v73, v107, v103, 0x5010400
	v_perm_b32 v74, v107, v103, 0x7030602
	v_perm_b32 v75, v108, v104, 0x5010400
	v_perm_b32 v76, v108, v104, 0x7030602
	v_perm_b32 v77, v109, v105, 0x5010400
	v_perm_b32 v78, v109, v105, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v79, 8, v63
	v_lshrrev_b32_e32 v80, 24, v63
	v_lshrrev_b32_e32 v81, 8, v64
	v_lshrrev_b32_e32 v82, 24, v64
	v_lshrrev_b32_e32 v85, 8, v66
	...
	v_lshrrev_b32_e32 v90, 24, v68
	v_and_b16 v68.l, 0xff, v69.l
	v_lshrrev_b32_e32 v91, 8, v69
	v_lshrrev_b32_e32 v92, 24, v69
	v_and_b16 v69.l, 0xff, v70.l
	v_lshrrev_b32_e32 v93, 8, v70
	v_lshrrev_b32_e32 v94, 24, v70
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v70.l, 0xff, v71.l
	v_lshrrev_b32_e32 v95, 8, v71
	v_lshrrev_b32_e32 v96, 24, v71
	v_and_b16 v71.l, 0xff, v72.l
	v_lshrrev_b32_e32 v97, 8, v72
	v_lshrrev_b32_e32 v98, 24, v72
	v_and_b16 v72.l, 0xff, v73.l
	v_lshrrev_b32_e32 v99, 8, v73
	v_lshrrev_b32_e32 v100, 24, v73
	v_and_b16 v73.l, 0xff, v74.l
	v_lshrrev_b32_e32 v101, 8, v74
	v_lshrrev_b32_e32 v102, 24, v74
	v_and_b16 v74.l, 0xff, v75.l
	v_lshrrev_b32_e32 v103, 8, v75
	v_lshrrev_b32_e32 v104, 24, v75
	v_and_b16 v75.l, 0xff, v76.l
	v_lshrrev_b32_e32 v105, 8, v76
	v_lshrrev_b32_e32 v106, 24, v76
	v_and_b16 v76.l, 0xff, v77.l
	v_lshrrev_b32_e32 v107, 8, v77
	v_lshrrev_b32_e32 v108, 24, v77
	v_and_b16 v77.l, 0xff, v78.l
	v_lshrrev_b32_e32 v109, 8, v78
	...
	v_lshlrev_b16 v80.l, 8, v83.l
	v_lshlrev_b16 v80.h, 8, v84.l
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v140, v62
	ds_store_b16_d16_hi v140, v62 offset:32
	ds_store_b16 v140, v63 offset:64
	ds_store_b16_d16_hi v140, v63 offset:96
	ds_store_b16 v141, v65 offset:64
	ds_store_b16_d16_hi v141, v65 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v140, v70 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v141, v64
	ds_store_b16_d16_hi v141, v64 offset:32
	ds_store_b16 v142, v66
	ds_store_b16_d16_hi v142, v66 offset:32
	ds_store_b16 v142, v67 offset:64
	ds_store_b16_d16_hi v142, v67 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v140, v71 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v140, v68 offset:384
	ds_store_b16_d16_hi v140, v68 offset:416
	ds_store_b16 v140, v69 offset:448
	ds_store_b16_d16_hi v140, v69 offset:480
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v140, v70 offset:16416
	ds_store_b16_d16_hi v140, v71 offset:16480
	ds_store_b16 v141, v72 offset:16384
	ds_store_b16_d16_hi v141, v72 offset:16416
	ds_store_b16 v141, v73 offset:16448
	ds_store_b16_d16_hi v141, v73 offset:16480
	ds_store_b16 v142, v74 offset:16384
	ds_store_b16_d16_hi v142, v74 offset:16416
	ds_store_b16 v142, v75 offset:16448
	ds_store_b16_d16_hi v142, v75 offset:16480
	ds_store_b16 v140, v76 offset:16768
	ds_store_b16_d16_hi v140, v76 offset:16800
	ds_store_b16 v140, v77 offset:16832
	ds_store_b16_d16_hi v140, v77 offset:16864
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v57, v49 :: v_dual_mov_b32 v2, v48
...
; %bb.9:
	...
	ds_load_b128 v[70:73], v48 offset:4096
	ds_load_b128 v[74:77], v49
	ds_load_b128 v[78:81], v49 offset:4096
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s6, s4
	...
	v_wmma_i32_16x16x16_iu8 v[58:65], v[66:69], v[5:8], v[48:55] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[48:55], v[70:73], v[5:8], v[48:55] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[58:65], v[74:77], v[1:4], v[58:65] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[48:55], v[78:81], v[1:4], v[48:55] neg_lo:[1,1,0]
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v38, v38, v60 :: v_dual_add_f32 v15, v15, v61
	v_dual_add_f32 v37, v37, v56 :: v_dual_add_f32 v16, v16, v62
	v_dual_add_f32 v30, v30, v64 :: v_dual_add_f32 v29, v29, v63
...
.LBB0_12:
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v48, 0 :: v_dual_add_nc_u32 v1, s34, v46
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v2, s34, v47
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v69, s11 :: v_dual_add_nc_u32 v46, s33, v44
	v_dual_mov_b32 v68, s10 :: v_dual_add_nc_u32 v47, s33, v45
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[49:52], v46
	ds_load_b128 v[53:56], v46 offset:4096
	ds_load_b128 v[58:61], v47
	ds_load_b128 v[78:81], v47 offset:4096
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[62:69], v[53:56], v[5:8], v[62:69] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[70:77], v[58:61], v[1:4], v[70:77] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[62:69], v[78:81], v[1:4], v[62:69] neg_lo:[1,1,0]
...
; %bb.15:
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_dual_mov_b32 v86, s11 :: v_dual_add_nc_u32 v45, s3, v45
...
.LBB0_16:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v60, v26, v55 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	v_lshlrev_b32_e32 v2, 1, v2
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	s_mov_b32 s20, s24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v62, v25, v53 :: v_dual_add_f32 v55, v15, v46
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v58, v37, v47 :: v_dual_and_b32 v3, 32, v57
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 143
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm16_bn256_bk32_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 38
