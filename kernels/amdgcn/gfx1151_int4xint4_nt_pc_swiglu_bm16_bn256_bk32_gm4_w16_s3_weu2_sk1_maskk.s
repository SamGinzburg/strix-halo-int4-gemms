	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_or_b32_e32 v7, s24, v25
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_ashr_i32 s25, s2, 1
	.loc	1 93 28                         ; generate_amdgcn.py:93:28
	s_sub_i32 s4, s4, s5
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_mad_u64_u32 v[3:4], null, s25, v2, v[25:26]
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_and_b32_e32 v11, 0xf78, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	v_or_b32_e32 v6, s24, v1
	.loc	1 129 30                        ; generate_amdgcn.py:129:30
	v_mad_u64_u32 v[4:5], null, s25, v38, v[1:2]
	...
	.loc	1 136 25 is_stmt 1              ; generate_amdgcn.py:136:25
	...
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_gt_i32_e64 s2, s25, v9
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[3:4], v6, s[16:19], 0 offen
	buffer_load_b64 v[5:6], v7, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v12, v12, s[12:15], 0 offen
	s_waitcnt vmcnt(0)
	ds_store_b8 v11, v12 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	ds_store_2addr_stride64_b64 v14, v[3:4], v[5:6] offset1:16
	...
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_dual_cndmask_b32 v9, 0x80000000, v10 :: v_dual_cndmask_b32 v8, 0x80000000, v8
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v13, v7, s[12:15], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[7:8], v8, s[16:19], 0 offen
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v11, v13 offset:16640
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v14, v[7:8], v[9:10] offset0:8 offset1:24
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
.Ltmp15:
	...
	s_lshl_b32 s1, s23, 8
	v_sub_nc_u32_e32 v26, s25, v25
	v_or_b32_e32 v28, v0, v20
	v_or_b32_e32 v29, v21, v0
	v_add3_u32 v0, s11, s2, v38
	...
	s_mov_b32 s29, 1
	s_add_i32 s28, s18, 1
	v_mad_u64_u32 v[8:9], null, s25, v0, v[1:2]
	v_add_nc_u32_e32 v0, s20, v2
	v_mad_u64_u32 v[17:18], null, s25, v3, v[1:2]
	s_add_i32 s30, s24, 32
	s_add_i32 s26, 0, 0x4000
	v_mad_u64_u32 v[18:19], null, s25, v0, v[25:26]
	v_mov_b32_e32 v0, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v32, s30, v17
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e32 vcc_lo, s30, v27
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s1, s30, v26
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v33, s30, v8
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v36, s26, v28
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v41, s27, v29
	...
	v_add_nc_u32_e32 v43, s25, v29
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v45, s26, v30
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	...
	buffer_load_b64 v[34:35], v34, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_add_i32 s24, s1, 0x4000
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	s_add_i32 s2, s23, 0x2000
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[41:42], v[36:37], v[9:16] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[43:44], v[36:37], v[0:7] neg_lo:[1,1,0]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v36, s1, v23
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v37, s23, v24
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lg_u32 s28, 0
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[49:50], v[45:46], v[0:7] neg_lo:[1,1,0]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v36, v19 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v37, v[32:33], v[34:35] offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
.LBB0_8:                                ; %._crit_edge
	...
	v_add_nc_u32_e32 v17, s26, v30
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_xor_b32_e32 v41, 8, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v18, s26, v31
...
.LBB0_17:
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v23, s10, v12
	v_or_b32_e32 v24, s10, v11
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v12, s3, v12, 1
	v_add_lshl_u32 v11, s3, v11, 1
	v_add_lshl_u32 v25, s3, v10, 1
	s_clause 0x6
	...
	s_mov_b32 s11, s15
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_permlanex16_b32 v6, v6, s12, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b32_e64 v8, v3, v1, s0
	v_cndmask_b32_e64 v3, v1, v3, s0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_perm_b32 v0, v6, v2, v7
	v_permlanex16_b32 v8, v8, s12, 0xfedcba98 op_sel:[1,0]
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_vgpr, 72
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.kd
