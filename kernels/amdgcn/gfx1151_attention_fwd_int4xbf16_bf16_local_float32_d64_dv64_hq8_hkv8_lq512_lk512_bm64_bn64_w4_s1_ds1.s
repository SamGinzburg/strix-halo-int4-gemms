...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v193, 0xff800000 :: v_dual_lshlrev_b32 v8, 5, v0
	v_dual_mov_b32 v222, 0xff800000 :: v_dual_and_b32 v51, 28, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v20, v17 :: v_dual_lshlrev_b32 v9, 2, v41
	.loc	1 585 26                        ; attention.py:585:26
	v_cmp_eq_u32_e64 s1, 0, v44
	v_dual_mov_b32 v49, 0xff800000 :: v_dual_and_b32 v2, 24, v0
	...
	v_dual_mov_b32 v23, v17 :: v_dual_and_b32 v142, 56, v1
	v_dual_mov_b32 v28, v17 :: v_dual_and_b32 v59, 0x60, v8
	v_lshl_or_b32 v60, v51, 7, v9
	v_mov_b32_e32 v18, v17
	v_lshl_or_b32 v41, v41, 4, v7
	.loc	1 585 26                        ; attention.py:585:26
	v_cndmask_b32_e64 v143, v35, v39, s1
	v_cndmask_b32_e64 v11, 0x1020, 0, vcc_lo
	v_bfe_i32 v12, v0, 2, 1
	v_dual_mov_b32 v237, 0xff800000 :: v_dual_and_b32 v52, 8, v0
	v_xor_b32_e32 v195, v14, v2
	v_dual_mov_b32 v25, v17 :: v_dual_lshlrev_b32 v62, 6, v44
	v_xor_b32_e32 v205, v41, v50
	v_or3_b32 v206, v60, v59, v51
	.loc	1 629 13                        ; attention.py:629:13
	v_mad_u64_u32 v[50:51], null, s96, v45, v[142:143]
	v_dual_mov_b32 v234, 0xff800000 :: v_dual_lshlrev_b32 v5, 9, v0
	v_dual_mov_b32 v191, 0xff800000 :: v_dual_lshlrev_b32 v6, 6, v46
	.loc	1 585 26                        ; attention.py:585:26
	v_cndmask_b32_e64 v144, v37, v40, s1
	v_dual_mov_b32 v32, v17 :: v_dual_and_b32 v63, 0x310, v1
	v_and_or_b32 v64, 0x2040, v12, v11
	...
	v_dual_mov_b32 v26, v17 :: v_dual_lshlrev_b32 v57, 5, v44
	v_and_or_b32 v58, 0x1c00, v5, v6
	v_mov_b32_e32 v14, v17
	v_or3_b32 v208, v64, v35, v63
	v_lshl_or_b32 v35, v36, 8, v36
	v_lshl_or_b32 v36, v37, 8, v37
	...
	v_dual_mov_b32 v21, v17 :: v_dual_and_b32 v48, 0x1b8, v48
	...
	v_dual_mov_b32 v30, v17 :: v_dual_and_b32 v61, 0x2040, v10
	v_lshl_add_u32 v190, v42, 1, 0
	...
	v_dual_mov_b32 v10, v17 :: v_dual_add_nc_u32 v69, s19, v55
	...
	v_dual_mov_b32 v22, v17 :: v_dual_and_b32 v13, 4, v0
	v_and_or_b32 v34, 0x1020, v46, v61
	v_xor_b32_e32 v33, v56, v42
	scratch_store_b32 off, v37, off offset:44 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v37, 0, v54
	v_xor_b32_e32 v56, 16, v206
	v_dual_mov_b32 v24, v17 :: v_dual_and_b32 v47, 0x80, v47
	...
	v_dual_mov_b32 v2, v17 :: v_dual_add_nc_u32 v213, 0, v33
	v_mul_lo_u32 v33, s15, v45
	scratch_store_b32 off, v37, off offset:52 ; 4-byte Folded Spill
	v_dual_mov_b32 v138, v17 :: v_dual_add_nc_u32 v37, 0, v56
	v_and_b32_e32 v35, 0x540054, v35
	v_add3_u32 v34, v65, v47, v34
	.loc	1 566 23                        ; attention.py:566:23
	s_ashr_i32 s0, s3, 31
	v_dual_mov_b32 v13, v17 :: v_dual_and_b32 v36, 0x760076, v36
	scratch_store_b32 off, v37, off offset:56 ; 4-byte Folded Spill
	v_xor_b32_e32 v37, 32, v208
	s_lshr_b32 s0, s0, 29
	v_dual_mov_b32 v3, v17 :: v_dual_add_nc_u32 v238, v34, v44
	v_lshl_or_b32 v40, v35, 4, v35
	v_mad_u64_u32 v[34:35], null, s15, 48, v[33:34]
	s_add_i32 s0, s3, s0
	v_dual_mov_b32 v27, v17 :: v_dual_add_nc_u32 v42, s19, v66
	v_dual_mov_b32 v29, v17 :: v_dual_add_nc_u32 v46, s19, v67
	v_dual_mov_b32 v31, v17 :: v_dual_add_nc_u32 v48, s19, v68
	...
	s_mul_i32 s3, s14, s3
	v_dual_mov_b32 v12, v17 :: v_dual_add_nc_u32 v207, s17, v69
	v_dual_mov_b32 v15, v17 :: v_dual_add_nc_u32 v228, 0, v52
	v_dual_mov_b32 v1, v17 :: v_dual_add_nc_u32 v236, 0, v59
	v_dual_mov_b32 v4, v17 :: v_dual_add_nc_u32 v215, s17, v42
	v_dual_mov_b32 v5, v17 :: v_dual_add_nc_u32 v240, 0, v38
	v_dual_mov_b32 v6, v17 :: v_dual_add_nc_u32 v217, s17, v46
	v_dual_mov_b32 v7, v17 :: v_dual_and_b32 v244, 0x7060706, v36
	v_dual_mov_b32 v8, v17 :: v_dual_add_nc_u32 v219, s17, v48
	v_dual_mov_b32 v139, v17 :: v_dual_add_nc_u32 v246, v35, v0
	v_dual_mov_b32 v141, v17 :: v_dual_add_nc_u32 v248, v35, v71
	.loc	1 696 65                        ; attention.py:696:65
	v_cmp_gt_i32_e64 s0, s96, v142
	.loc	1 670 47                        ; attention.py:670:47
	v_subrev_nc_u32_e32 v152, s16, v69
	v_subrev_nc_u32_e32 v214, s16, v42
	...
	.loc	1 590 31                        ; attention.py:590:31
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v154, 16, v43
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 633 32                        ; attention.py:633:32
	s_add_i32 s67, s97, s79
	.loc	1 634 32                        ; attention.py:634:32
	v_add_nc_u32_e32 v37, 0, v195
	.loc	1 633 32                        ; attention.py:633:32
	v_mad_u64_u32 v[33:34], null, s67, s78, v[231:232]
	.loc	1 674 25                        ; attention.py:674:25
	s_add_i32 vcc_hi, s104, s97
	v_or_b32_e32 v106, s79, v169
	v_or_b32_e32 v95, s79, v137
	v_or_b32_e32 v96, s79, v166
	v_or_b32_e32 v97, s79, v184
	v_or_b32_e32 v98, s79, v177
	.loc	1 634 32                        ; attention.py:634:32
	v_cndmask_b32_e64 v33, 0x80000000, v33, s66
	...
	v_or_b32_e32 v99, s79, v183
	v_or_b32_e32 v100, s79, v182
	v_or_b32_e32 v101, s79, v181
	v_or_b32_e32 v102, s79, v180
	v_or_b32_e32 v103, s79, v179
	...
	v_or_b32_e32 v104, s79, v178
	v_or_b32_e32 v105, s79, v176
	...
	v_or_b32_e32 v108, s79, v174
	v_or_b32_e32 v109, s79, v172
	v_or_b32_e32 v110, s79, v170
	v_or_b32_e32 v111, s79, v168
	v_or_b32_e32 v112, s79, v173
	.loc	1 649 37                        ; attention.py:649:37
	...
	v_or_b32_e32 v113, s79, v171
	v_or_b32_e32 v107, s79, v175
	.loc	1 654 30                        ; attention.py:654:30
	...
	v_dual_fmac_f32 v82, s103, v81 :: v_dual_lshlrev_b32 v83, 16, v94
	.loc	1 654 30                        ; attention.py:654:30
	...
	v_fmac_f32_e32 v46, s103, v72
	.loc	1 684 35                        ; attention.py:684:35
	v_mul_f32_e32 v72, 0x3fb8aa3b, v96
	.loc	1 684 25                        ; attention.py:684:25
	v_fmac_f32_e32 v72, s103, v75
	.loc	1 683 36 is_stmt 1              ; attention.py:683:36
	s_waitcnt vmcnt(0)
	...
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v42, s103, v63 :: v_dual_and_b32 v45, 0xffff0000, v45
	.loc	1 683 36                        ; attention.py:683:36
	...
	.loc	1 684 25 is_stmt 0              ; attention.py:684:25
	v_dual_fmac_f32 v45, s103, v76 :: v_dual_mul_f32 v76, 0x3fb8aa3b, v85
	.loc	1 654 30 is_stmt 1              ; attention.py:654:30
	v_mul_f32_e32 v62, v62, v83
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v34, s103, v50 :: v_dual_lshlrev_b32 v83, 16, v103
	v_fmac_f32_e32 v76, s103, v74
	.loc	1 683 36                        ; attention.py:683:36
	s_waitcnt vmcnt(0)
	...
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v47, s103, v80 :: v_dual_mul_f32 v50, 0x3fb8aa3b, v86
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 684 35 is_stmt 0              ; attention.py:684:35
	v_dual_mul_f32 v74, 0x3fb8aa3b, v33 :: v_dual_add_nc_u32 v33, 0, v206
	.loc	1 684 25                        ; attention.py:684:25
	v_fmac_f32_e32 v50, s103, v70
	.loc	1 684 35                        ; attention.py:684:35
	v_mul_f32_e32 v70, 0x3fb8aa3b, v87
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 684 25                        ; attention.py:684:25
	v_fmac_f32_e32 v74, s103, v73
	v_fmac_f32_e32 v70, s103, v68
	.loc	1 683 36 is_stmt 1              ; attention.py:683:36
	s_waitcnt vmcnt(0)
	...
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v63, s103, v62 :: v_dual_fmac_f32 v54, s103, v53
	.loc	1 684 35 is_stmt 0              ; attention.py:684:35
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v62, s103, v61 :: v_dual_and_b32 v43, 0xffff0000, v43
	.loc	1 685 25                        ; attention.py:685:25
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 684 35                        ; attention.py:684:35
	v_dual_mul_f32 v80, 0x3fb8aa3b, v83 :: v_dual_fmac_f32 v61, s103, v60
	...
	.loc	1 684 25 is_stmt 0              ; attention.py:684:25
	v_fmac_f32_e32 v80, s103, v79
	v_fmac_f32_e32 v60, s103, v58
	.loc	1 685 25 is_stmt 1              ; attention.py:685:25
	v_lshlrev_b16 v114.l, 8, v114.l
	.loc	1 684 35                        ; attention.py:684:35
	v_dual_mul_f32 v79, 0x3fb8aa3b, v41 :: v_dual_fmac_f32 v52, s103, v51
	...
	ds_store_2addr_b32 v228, v118, v119 offset1:32
	ds_store_2addr_b32 v228, v116, v114 offset0:64 offset1:96
	...
	.loc	1 684 35                        ; attention.py:684:35
	v_dual_mul_f32 v41, 0x3fb8aa3b, v89 :: v_dual_fmac_f32 v48, s103, v78
	v_mul_f32_e32 v78, 0x3fb8aa3b, v84
	.loc	1 684 25 is_stmt 0              ; attention.py:684:25
	v_dual_fmac_f32 v58, s103, v59 :: v_dual_mul_f32 v59, 0x3fb8aa3b, v37
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v41, s103, v64 :: v_dual_fmac_f32 v78, s103, v77
	v_fmac_f32_e32 v59, s103, v57
	.loc	1 684 35                        ; attention.py:684:35
	v_mul_f32_e32 v57, 0x3fb8aa3b, v93
	.loc	1 684 25                        ; attention.py:684:25
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v57, s103, v56 :: v_dual_and_b32 v36, 0x1000000, v51
	.loc	1 685 25 is_stmt 1              ; attention.py:685:25
	...
	s_waitcnt vmcnt(1)
	v_mad_u64_u32 v[117:118], null, s67, s96, v[114:115]
	.loc	1 685 25                        ; attention.py:685:25
	s_waitcnt vmcnt(0)
	ds_load_b32 v56, v33
	scratch_load_b32 v33, off, off offset:48 ; 4-byte Folded Reload
	.loc	1 684 25                        ; attention.py:684:25
	v_dual_fmac_f32 v73, s103, v71 :: v_dual_lshlrev_b32 v114, 1, v117
	.loc	1 694 30                        ; attention.py:694:30
	v_add_lshl_u32 v115, v117, s99, 1
	v_add_lshl_u32 v116, v117, s100, 1
	v_add_lshl_u32 v117, v117, s101, 1
	.loc	1 685 25                        ; attention.py:685:25
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 684 25                        ; attention.py:684:25
	v_fmac_f32_e32 v79, s103, v65
	.loc	1 684 35 is_stmt 0              ; attention.py:684:35
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v43, 0x3fb8aa3b, v43 :: v_dual_and_b32 v46, 1, v64
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 684 25                        ; attention.py:684:25
	v_fmac_f32_e32 v43, s103, v69
	.loc	1 685 25 is_stmt 1              ; attention.py:685:25
	...
	s_waitcnt vmcnt(0)
	ds_load_b32 v81, v33
	ds_load_b32 v83, v233
	ds_load_b32 v84, v235
	ds_load_b32 v85, v236
	v_and_b32_e32 v33, 0x10000, v51
	.loc	1 684 25                        ; attention.py:684:25
	s_waitcnt lgkmcnt(4)
	v_dual_fmac_f32 v71, s103, v67 :: v_dual_and_b32 v34, 1, v65
	.loc	1 686 26                        ; attention.py:686:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 685 25                        ; attention.py:685:25
	...
	.loc	1 686 26                        ; attention.py:686:26
	v_cndmask_b32_e64 v38, 0xff800000, v45, s3
	.loc	1 694 30                        ; attention.py:694:30
	...
	.loc	1 686 26                        ; attention.py:686:26
	v_cndmask_b32_e64 v34, 0xff800000, v47, s67
...
; %bb.6:                                ; %Flow
	...
	scratch_load_b32 v43, off, off offset:72
