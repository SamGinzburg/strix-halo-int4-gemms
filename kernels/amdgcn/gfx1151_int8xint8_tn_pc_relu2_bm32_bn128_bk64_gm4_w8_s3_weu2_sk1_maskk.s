...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s15, v32, v[1:2]
...
.Ltmp13:
	...
	s_add_i32 s6, s6, s7
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_add3_u32 v14, s4, s3, v10
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s3, s30, v12
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v15, s6, v9
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s4, s30, v13
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v16, s6, v35
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s0, s1, s15
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[38:39], null, s1, s14, v[10:11]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s0, s0, s28
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_cmp_gt_i32_e32 vcc_lo, s30, v44
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v39, s0, v9
	...
	v_dual_add_f32 v17, v17, v48 :: v_dual_add_nc_u32 v108, s7, v30
	v_dual_add_f32 v20, v20, v45 :: v_dual_add_nc_u32 v109, s1, v31
	v_dual_add_f32 v11, v11, v38 :: v_dual_add_f32 v26, v26, v39
	v_dual_add_f32 v25, v25, v40 :: v_dual_add_f32 v24, v24, v41
	v_dual_add_f32 v23, v23, v42 :: v_dual_add_f32 v18, v18, v47
	v_dual_add_f32 v22, v22, v43 :: v_dual_add_f32 v21, v21, v44
	v_dual_add_f32 v19, v19, v46 :: v_dual_add_f32 v16, v16, v49
	v_dual_add_f32 v15, v15, v50 :: v_dual_add_f32 v14, v14, v51
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v11, v4 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or3_b32 v2, v2, v29, s28
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v30, v20, v30 :: v_dual_add_f32 v35, v15, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v24, v7 :: v_dual_and_b32 v28, 0x78, v28
	v_dual_add_f32 v10, v21, v10 :: v_dual_add_f32 v31, v19, v31
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v17, v17, v33, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_mul_i32 s3, s29, s15
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v25, v6 :: v_dual_add_f32 v9, v22, v9
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_add_i32 s3, s3, s28
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v24, s3, v28, v27
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v34, v16, v34 :: v_dual_mov_b32 v47, 0x7632
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v5, v26, v5, s2
	v_cndmask_b32_e64 v6, v25, v6, s2
	v_cndmask_b32_e64 v11, v20, v30, s2
	...
	v_dual_mul_f32 v38, v1, v29 :: v_dual_lshlrev_b32 v35, 16, v43
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v32, 16, v40
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v29, v3, v29 :: v_dual_lshlrev_b32 v36, 16, v44
	v_mul_f32_e32 v43, v1, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v40, v1, v32 :: v_dual_lshlrev_b32 v33, 16, v41
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v2, 16, v2
	v_lshlrev_b32_e32 v34, 16, v42
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v32, v3, v32 :: v_dual_mul_f32 v5, v5, v38
	v_dual_mul_f32 v41, v1, v33 :: v_dual_and_b32 v0, 16, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v37, v1, v2
	v_dual_mul_f32 v2, v3, v2 :: v_dual_lshlrev_b32 v31, 16, v39
	v_dual_mul_f32 v35, v3, v35 :: v_dual_lshlrev_b32 v30, 1, v24
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v4, v4, v37 :: v_dual_mul_f32 v39, v1, v31
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v33, v3, v33
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v7, v7, v40 :: v_dual_mul_f32 v10, v10, v43
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_max_f32_e32 v4, 0, v4
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v6, v6, v39 :: v_dual_mul_f32 v15, v15, v33
	.loc	1 406 16 is_stmt 0              ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v42, v1, v34 :: v_dual_mul_f32 v31, v3, v31
	v_dual_mul_f32 v1, v1, v36 :: v_dual_mul_f32 v34, v3, v34
	v_dual_mul_f32 v3, v3, v36 :: v_dual_mul_f32 v8, v8, v41
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_max_f32_e32 v5, 0, v5
	v_dual_max_f32 v7, 0, v7 :: v_dual_max_f32 v10, 0, v10
	v_dual_max_f32 v15, 0, v15 :: v_dual_mul_f32 v4, v4, v4
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v9, v9, v42 :: v_dual_mul_f32 v16, v16, v32
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v8, 0, v8 :: v_dual_mul_f32 v5, v5, v5
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v2, v19, v2 :: v_dual_mul_f32 v17, v17, v31
	v_mul_f32_e32 v1, v11, v1
	v_mul_f32_e32 v11, v18, v29
	v_dual_mul_f32 v3, v12, v3 :: v_dual_max_f32 v6, 0, v6
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v7, v7, v7 :: v_dual_mul_f32 v10, v10, v10
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v13, v13, v35 :: v_dual_max_f32 v2, 0, v2
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v11, 0, v11 :: v_dual_max_f32 v12, 0, v17
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v6, v6, v6
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v15, v15, v15 :: v_dual_and_b32 v18, 1, v20
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v16, v16, v16 :: v_dual_mul_f32 v13, v13, v13
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_cndmask_b32 v8, 0x3276, v47 :: v_dual_cndmask_b32 v9, v0, v4
	v_mov_b16_e32 v11.l, v1.h
	v_add3_u32 v1, v16, v2, 0x7fff
	v_and_b32_e32 v2, 1, v45
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_cndmask_b32 v7, v2, v11 :: v_dual_and_b32 v26, 1, v28
	v_dual_cndmask_b32 v2, v11, v2 :: v_dual_and_b32 v11, 0x7060706, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_dual_cndmask_b32 v5, v1, v3 :: v_dual_cndmask_b32 v12, v3, v1
	...
	v_add_lshl_u32 v8, v24, s0, 1
	s_delay_alu instid0(VALU_DEP_3)
	v_perm_b32 v6, v14, v12, v10
	v_perm_b32 v7, v14, v12, v11
	s_clause 0x1
	buffer_store_b128 v[0:3], v30, s[12:15], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 242
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 36
