...
.Ltmp11:
	...
	s_mov_b32 s15, s7
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[1:2], null, s20, v32, v[17:18]
	.loc	1 127 14                        ; generate_amdgcn.py:127:14
	v_or_b32_e32 v18, s16, v0
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	...
	v_mad_u64_u32 v[2:3], null, v18, s20, s[2:3]
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	v_dual_mov_b32 v38, 0x7632 :: v_dual_lshlrev_b32 v19, 1, v19
	...
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v9, v9, v19 :: v_dual_and_b32 v0, 16, v0
	v_mul_f32_e32 v1, v1, v19
	v_mul_f32_e32 v3, v3, v19
	v_mul_f32_e32 v5, v5, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v10, v10, v19 :: v_dual_mul_f32 v9, v9, v29
	v_mul_f32_e32 v4, v4, v19
	v_dual_mul_f32 v6, v6, v19 :: v_dual_mul_f32 v1, v1, v21
	v_dual_mul_f32 v8, v8, v19 :: v_dual_mul_f32 v5, v5, v25
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v11, v11, v19 :: v_dual_mul_f32 v4, v4, v24
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v14, v14, v19 :: v_dual_max_f32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v15, v15, v19 :: v_dual_mul_f32 v8, v8, v28
	v_dual_mul_f32 v16, v16, v19 :: v_dual_max_f32 v5, 0, v5
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v3, v3, v23 :: v_dual_mul_f32 v10, v10, v30
	.loc	1 178 19 is_stmt 1              ; generate_amdgcn.py:178:19
	v_dual_max_f32 v2, 0, v2 :: v_dual_mul_f32 v7, v7, v19
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_dual_mul_f32 v13, v13, v19 :: v_dual_mul_f32 v6, v6, v26
	v_mul_f32_e32 v12, v12, v19
	.loc	1 171 9 is_stmt 0               ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v11, v11, v31 :: v_dual_mul_f32 v14, v14, v34
	v_dual_mul_f32 v15, v15, v35 :: v_dual_mul_f32 v16, v16, v36
	.loc	1 178 19 is_stmt 1              ; generate_amdgcn.py:178:19
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v2, v2, v2
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_mul_f32_e32 v5, v5, v5
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_mul_f32_e32 v13, v13, v33
	v_dual_mul_f32 v7, v7, v27 :: v_dual_mul_f32 v12, v12, v32
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v19, 1, v18
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_dual_mul_f32 v14, v14, v14 :: v_dual_and_b32 v21, 1, v40
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 78
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 22
