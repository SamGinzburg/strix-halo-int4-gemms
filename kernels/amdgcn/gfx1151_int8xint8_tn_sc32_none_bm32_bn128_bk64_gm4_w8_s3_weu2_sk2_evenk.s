	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp26:
	...
	v_dual_mov_b32 v29, 0 :: v_dual_and_b32 v4, 7, v0
	...
	v_add3_u32 v48, v2, s22, v4
	v_add3_u32 v49, v5, s22, v4
	v_dual_mov_b32 v30, 0 :: v_dual_add_nc_u32 v51, 0, v7
	...
	v_dual_mov_b32 v6, s17 :: v_dual_mov_b32 v25, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_b32 v54, v48, s[24:27], 0 offen
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	...
	v_dual_mul_f32 v11, v11, v77 :: v_dual_add_nc_u32 v48, s28, v48
	s_waitcnt vmcnt(17)
	...
	v_dual_mul_f32 v54, v54, v78 :: v_dual_add_nc_u32 v49, s28, v49
	...
	v_dual_mul_f32 v73, v73, v88 :: v_dual_fmac_f32 v28, v55, v81
	v_dual_mul_f32 v74, v74, v88 :: v_dual_fmac_f32 v29, v9, v79
	v_dual_mul_f32 v75, v75, v88 :: v_dual_fmac_f32 v30, v53, v79
	v_dual_mul_f32 v76, v76, v88 :: v_dual_fmac_f32 v27, v11, v81
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v31, v10, v80 :: v_dual_fmac_f32 v26, v56, v82
	v_dual_fmac_f32 v25, v12, v82 :: v_dual_fmac_f32 v32, v54, v80
	v_dual_fmac_f32 v23, v13, v83 :: v_dual_fmac_f32 v22, v58, v84
	v_dual_fmac_f32 v21, v14, v84 :: v_dual_fmac_f32 v24, v57, v83
	v_dual_fmac_f32 v19, v15, v85 :: v_dual_fmac_f32 v18, v60, v86
	v_dual_fmac_f32 v17, v16, v86 :: v_dual_fmac_f32 v20, v59, v85
	v_dual_fmac_f32 v29, v61, v89 :: v_dual_fmac_f32 v32, v70, v90
	v_dual_fmac_f32 v31, v62, v90 :: v_dual_fmac_f32 v30, v69, v89
	v_dual_fmac_f32 v27, v63, v91 :: v_dual_fmac_f32 v26, v72, v92
	v_dual_fmac_f32 v25, v64, v92 :: v_dual_fmac_f32 v28, v71, v91
	v_dual_fmac_f32 v23, v65, v93 :: v_dual_fmac_f32 v22, v74, v94
	v_dual_fmac_f32 v21, v66, v94 :: v_dual_fmac_f32 v24, v73, v93
	v_dual_fmac_f32 v19, v67, v95 :: v_dual_fmac_f32 v18, v76, v96
	v_dual_fmac_f32 v17, v68, v96 :: v_dual_fmac_f32 v20, v75, v95
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
.LBB0_3:                                ; %._crit_edge
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_bfe_i32 v4, v0, 0, 1
	v_and_b32_e32 v5, 0x3f8, v33
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	v_add_lshl_u32 v17, v16, s3, 2
	v_add_lshl_u32 v19, v16, s5, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s8, s29, 14
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v20, v16, s6, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_lshl_b32 s9, s29, 4
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	s_waitcnt lgkmcnt(6)
	...
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v6, v18, s[20:23], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v8, v19, s[20:23], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v10, v20, s[20:23], 0 offen
	v_add_lshl_u32 v0, v16, s7, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s10, s29, 18
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v2, v16, s8, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s11, s29, 20
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v4, v16, s9, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s12, s29, 22
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v6, v16, s10, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s2, s29, 24
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v8, v16, s11, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s0, s29, 26
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	s_waitcnt lgkmcnt(1)
	...
	v_add_lshl_u32 v0, v16, s12, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s13, s29, 28
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v1, v16, s2, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s14, s29, 30
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v2, v16, s0, 2
	v_add_lshl_u32 v3, v16, s13, 2
	v_add_lshl_u32 v4, v16, s14, 2
	s_clause 0x4
...
.Ltmp27:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 254
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.kd
