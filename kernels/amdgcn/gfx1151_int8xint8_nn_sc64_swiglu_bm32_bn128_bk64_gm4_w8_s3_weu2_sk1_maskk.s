...
.Ltmp19:
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v1, s17, v157
	v_add_nc_u32_e32 v2, s17, v158
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.15:
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v94, v97, v99, 0xc0c0004
	.loc	1 384 31                        ; generate_amdgcn.py:384:31
	...
	ds_load_u8 v107, v197
	ds_load_u8 v109, v198
	...
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v131, v99, v97, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v111, v111, v101, 0xc0c0004
	v_perm_b32 v107, v109, v107, 0xc0c0004
	v_perm_b32 v108, v108, v110, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v109, v96, v98, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v110, v100, v102, 0xc0c0004
	v_perm_b32 v112, v113, v112, 0xc0c0004
	v_perm_b32 v113, v114, v95, 0xc0c0004
	.loc	1 384 31                        ; generate_amdgcn.py:384:31
	...
	v_lshl_or_b32 v32, v111, 16, v131
	v_lshl_or_b32 v31, v108, 16, v107
	v_lshl_or_b32 v30, v110, 16, v109
	v_lshl_or_b32 v29, v113, 16, v112
	s_waitcnt lgkmcnt(6)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 248
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 53
