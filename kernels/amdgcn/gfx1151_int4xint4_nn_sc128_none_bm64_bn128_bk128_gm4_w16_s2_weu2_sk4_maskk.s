...
.LBB0_8:
	...
	buffer_load_u16 v47, v19, s[24:27], 0 offen
	buffer_load_u16 v48, v35, s[24:27], 0 offen
	buffer_load_u16 v43, v43, s[24:27], 0 offen
	buffer_load_u16 v44, v44, s[24:27], 0 offen
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v49, v16, s[12:15], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x2
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v51, v18, s[12:15], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v37, v37, v50 :: v_dual_lshlrev_b32 v44, 16, v44
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v10, v10, v50 :: v_dual_mul_f32 v3, v3, v48
	v_dual_mul_f32 v6, v6, v48 :: v_dual_mul_f32 v11, v11, v50
	v_mul_f32_e32 v5, v5, v48
	v_mul_f32_e32 v8, v8, v48
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_ashrrev_i32_e32 v18, 31, v17
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v38, v38, v50 :: v_dual_mul_f32 v7, v7, v48
	...
	v_fma_f32 v2, v2, v36, v34
	v_fma_f32 v15, v9, v15, v27
	v_fma_f32 v4, v4, v43, v32
	v_fma_f32 v10, v10, v36, v26
	v_fma_f32 v48, v3, v47, v33
	...
	v_fma_f32 v36, v37, v43, v24
	v_fma_f32 v37, v38, v44, v23
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_ci_u32_e64 v19, null, s41, v19, vcc_lo
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v51, v7, v46, v29
	v_fma_f32 v38, v39, v45, v22
	v_fma_f32 v39, v40, v46, v21
	v_fma_f32 v40, v41, v49, v20
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_cndmask_b32_e64 v5, v33, v48, s2
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.numbered_sgpr, 45
