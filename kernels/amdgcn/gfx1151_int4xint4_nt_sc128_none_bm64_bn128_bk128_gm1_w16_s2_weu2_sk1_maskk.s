...
.Ltmp0:
	...
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v28, 0xe0, v0
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v53, 0, v19
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v54, 0, v20
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v55, 0, v21
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v56, 0, v22
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v70, v74, v70 :: v_dual_lshlrev_b32 v73, 16, v96
	v_mul_f32_e32 v62, v62, v73
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x1
	buffer_load_u16 v104, v93, s[36:39], 0 offen offset:28
	buffer_load_u16 v93, v93, s[36:39], 0 offen offset:24
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v57, v57, v73
	v_mul_f32_e32 v58, v58, v73
	v_mul_f32_e32 v63, v63, v73
	v_dual_mul_f32 v64, v64, v73 :: v_dual_add_nc_u32 v35, s3, v35
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v9, v57, v76
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v68, v74, v68 :: v_dual_lshlrev_b32 v75, 16, v99
	v_dual_mul_f32 v61, v61, v73 :: v_dual_add_nc_u32 v36, 2, v36
	v_dual_mul_f32 v66, v74, v66 :: v_dual_add_nc_u32 v37, 2, v37
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v72, v74, v72 :: v_dual_lshlrev_b32 v79, 16, v101
	v_dual_mul_f32 v65, v74, v65 :: v_dual_lshlrev_b32 v80, 16, v100
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v67, v74, v67 :: v_dual_lshlrev_b32 v82, 16, v102
	v_mul_f32_e32 v59, v59, v73
	v_mul_f32_e32 v60, v60, v73
	v_mul_f32_e32 v69, v74, v69
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v21, v61, v82 :: v_dual_fmac_f32 v16, v66, v75
	.loc	1 162 26 is_stmt 1              ; generate_amdgcn.py:162:26
	s_waitcnt lgkmcnt(0)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v22, v60, v79 :: v_dual_fmac_f32 v13, v69, v82
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	s_barrier
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v24, v58, v75
	.loc	1 180 20 is_stmt 0              ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v71, v74, v71
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v14, v68, v79 :: v_dual_lshlrev_b32 v85, 16, v104
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v81, 16, v103
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v15, v67, v80 :: v_dual_lshlrev_b32 v86, 16, v93
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v10, v72, v85
	v_dual_fmac_f32 v18, v64, v85 :: v_dual_fmac_f32 v23, v59, v80
	v_dual_fmac_f32 v20, v62, v81 :: v_dual_fmac_f32 v19, v63, v86
	v_dual_fmac_f32 v17, v65, v76 :: v_dual_fmac_f32 v12, v70, v81
	v_fmac_f32_e32 v11, v71, v86
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
.LBB0_5:
	...
	v_cndmask_b16 v6.h, 0x7fff, v16.h, s6
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 41
