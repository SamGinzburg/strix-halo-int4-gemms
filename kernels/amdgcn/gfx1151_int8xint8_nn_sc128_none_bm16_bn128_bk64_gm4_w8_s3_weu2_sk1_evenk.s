	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp12:
	...
	s_add_i32 s27, s28, 0x7f
.Ltmp13:
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_xor_b32 s31, s12, s30
.Ltmp14:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:333:28 ]
	s_add_i32 s25, s28, 63
.Ltmp15:
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp21:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v30, v8, s[4:7], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v37, v30 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v36, v[14:17]
	s_waitcnt vmcnt(3)
	ds_store_b128 v36, v[18:21] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v37, v35 offset:17408
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v36, v[22:25] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v36, v[26:29] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_3:                                ; %Flow79
	...
	v_or_b32_e32 v23, s14, v11
	v_mul_lo_u32 v26, v17, s0
	v_or_b32_e32 v21, s14, v12
	v_or_b32_e32 v19, s14, v13
	v_or_b32_e32 v22, s14, v7
	v_or_b32_e32 v20, s14, v8
	v_or_b32_e32 v18, s14, v9
...
.Ltmp23:
	...
	s_add_i32 s11, s1, -2
	v_subrev_nc_u32_e32 v35, s10, v5
	v_subrev_nc_u32_e32 v36, s10, v1
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v2, s26, v2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s37, s18, s15
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v38, v26, s18, 1
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[46:49], v36, s[20:23], 0 offen
	buffer_load_b128 v[50:53], v35, s[20:23], 0 offen
	s_mov_b32 s18, s10
	s_mov_b32 s10, s1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v38, s18, v27
	v_add_nc_u32_e32 v39, s18, v28
	s_mov_b32 s1, s19
	v_add_nc_u32_e32 v40, s18, v29
	v_add_nc_u32_e32 v41, s18, v30
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v42, s1, v33, v31
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_mul_f32 v62, v54, v62 :: v_dual_add_nc_u32 v137, s33, v32
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v14, v58, v41 :: v_dual_lshlrev_b32 v57, 16, v90
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v56, v54, v56
	v_dual_mul_f32 v55, v54, v55 :: v_dual_add_nc_u32 v36, s34, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v12, v60, v43 :: v_dual_mul_f32 v57, v54, v57
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v54, v54, v61
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v136, s37, v34
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v9, v55, v38 :: v_dual_fmac_f32 v16, v56, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v15, v57, v40
	v_fmac_f32_e32 v11, v54, v44
	v_fmac_f32_e32 v10, v62, v45
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.9:
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s10, v30
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s10, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v33, v37, v34, 0xc0c0004
	v_perm_b32 v34, v36, v35, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v45, s10, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 138
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 38
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     40
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
