...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v27, 0 :: v_dual_lshlrev_b32 v40, 1, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v3, v1
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v14, v44, v14 :: v_dual_lshlrev_b32 v49, 16, v49
	v_dual_mul_f32 v11, v44, v11 :: v_dual_lshlrev_b32 v48, 16, v48
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v12, v44, v12 :: v_dual_lshlrev_b32 v51, 16, v51
	v_mul_f32_e32 v16, v44, v16
	v_dual_mul_f32 v13, v44, v13 :: v_dual_lshlrev_b32 v50, 16, v50
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v22, v9, v46 :: v_dual_lshlrev_b32 v45, 16, v45
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v15, v44, v15 :: v_dual_lshlrev_b32 v52, 16, v52
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v28, v11, v48 :: v_dual_fmac_f32 v27, v13, v50
	v_dual_fmac_f32 v26, v12, v49 :: v_dual_fmac_f32 v25, v14, v51
	v_dual_fmac_f32 v24, v15, v52 :: v_dual_fmac_f32 v23, v16, v45
...
; %bb.4:
	...
	v_perm_b32 v9, v14, v16, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[3:10], v[11:12], v[1:2], v[3:10] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v18, v39, v38, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v17, v40, v37, 0xc0c0004
	v_lshl_or_b32 v2, v14, 16, v13
...
.LBB0_5:
	...
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v4, v4, v9 :: v_dual_lshlrev_b32 v11, 16, v11
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(3)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v3, v3, v15, v27
	v_fma_f32 v4, v4, v16, v25
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_add3_u32 v3, v7, v9, 0x7fff
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v7, 0x3276, v30 :: v_dual_and_b32 v14, 1, v32
	v_dual_cndmask_b32 v4, v1, v2 :: v_dual_and_b32 v9, 1, v19
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cndmask_b16 v3.l, 0x7fff, v3.h, s6
	v_lshl_or_b32 v7, v7, 8, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_add3_u32 v0, v5, v14, 0x7fff
	v_cndmask_b32_e32 v5, 0x1054, v20, vcc_lo
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 59
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 35
