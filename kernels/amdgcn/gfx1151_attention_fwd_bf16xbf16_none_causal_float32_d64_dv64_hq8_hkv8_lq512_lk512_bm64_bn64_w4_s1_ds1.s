...
.Ltmp0:
	...
	.loc	1 599 26                        ; attention.py:599:26
	v_add_lshl_u32 v3, v88, s3, 1
	.loc	1 601 22                        ; attention.py:601:22
	s_and_b32 s2, s2, vcc_lo
	.loc	1 570 31                        ; attention.py:570:31
	v_or_b32_e32 v118, 10, v121
	.loc	1 599 26                        ; attention.py:599:26
	v_add_lshl_u32 v5, v125, s3, 1
	v_add_lshl_u32 v6, v126, s3, 1
	v_add_lshl_u32 v7, v89, s3, 1
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v80, 0xff800000 :: v_dual_add_nc_u32 v129, s8, v6
	v_or_b32_e32 v130, v4, v7
	...
	v_dual_mov_b32 v26, v24 :: v_dual_add_nc_u32 v5, 0, v5
	...
	v_dual_mov_b32 v31, v24 :: v_dual_and_b32 v0, 0x760076, v0
	...
	s_lshr_b32 s0, s0, 26
	v_dual_mov_b32 v28, v24 :: v_dual_and_b32 v131, 0x5040504, v4
	s_add_i32 s62, s3, s0
	.loc	1 696 65                        ; attention.py:696:65
	v_cmp_gt_i32_e64 s0, s61, v1
	v_dual_mov_b32 v17, v24 :: v_dual_and_b32 v132, 0x7060706, v0
	v_lshl_add_u32 v133, v3, 1, 0
	v_dual_mov_b32 v19, v24 :: v_dual_add_nc_u32 v134, 0, v5
	v_dual_mov_b32 v21, v24 :: v_dual_add_nc_u32 v136, 0, v7
	v_dual_mov_b32 v30, v24 :: v_dual_add_nc_u32 v137, 0, v8
	v_dual_mov_b32 v23, v24 :: v_dual_add_nc_u32 v138, 0, v9
	v_dual_mov_b32 v16, v24 :: v_dual_add_nc_u32 v139, 0, v10
	v_dual_mov_b32 v9, v24 :: v_dual_add_nc_u32 v140, 0, v11
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 181
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 69
