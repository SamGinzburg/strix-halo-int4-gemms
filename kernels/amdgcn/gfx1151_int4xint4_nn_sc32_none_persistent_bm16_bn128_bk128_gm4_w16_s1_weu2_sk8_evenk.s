...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
	ds_store_2addr_b32 v0, v91, v100 offset1:32
	ds_store_2addr_b32 v0, v88, v70 offset0:64 offset1:96
	s_waitcnt vmcnt(4)
	ds_store_2addr_b32 v11, v99, v98 offset1:32
	ds_store_2addr_b32 v11, v77, v67 offset0:64 offset1:96
	s_waitcnt vmcnt(3)
	ds_store_2addr_b32 v20, v97, v96 offset1:32
	ds_store_2addr_b32 v20, v68, v64 offset0:64 offset1:96
	ds_store_2addr_b32 v22, v95, v94 offset1:32
	ds_store_2addr_b32 v22, v65, v61 offset0:64 offset1:96
	ds_store_2addr_b32 v23, v93, v92 offset1:32
	ds_store_2addr_b32 v23, v63, v59 offset0:64 offset1:96
	ds_store_2addr_b32 v24, v90, v89 offset1:32
	ds_store_2addr_b32 v24, v60, v57 offset0:64 offset1:96
	ds_store_2addr_b32 v25, v87, v86 offset1:32
	ds_store_2addr_b32 v25, v58, v54 offset0:64 offset1:96
	ds_store_2addr_b32 v26, v85, v84 offset1:32
	ds_store_2addr_b32 v26, v55, v51 offset0:64 offset1:96
	ds_store_2addr_b32 v27, v83, v82 offset1:32
	ds_store_2addr_b32 v27, v53, v49 offset0:64 offset1:96
	ds_store_2addr_b32 v28, v81, v80 offset1:32
	ds_store_2addr_b32 v28, v52, v47 offset0:64 offset1:96
	ds_store_2addr_b32 v29, v79, v78 offset1:32
	ds_store_2addr_b32 v29, v50, v44 offset0:64 offset1:96
	ds_store_2addr_b32 v30, v76, v75 offset1:32
	ds_store_2addr_b32 v30, v48, v42 offset0:64 offset1:96
	ds_store_2addr_b32 v31, v74, v72 offset1:32
	ds_store_2addr_b32 v31, v46, v41 offset0:64 offset1:96
	ds_store_2addr_b32 v32, v73, v69 offset1:32
	ds_store_2addr_b32 v32, v45, v39 offset0:64 offset1:96
	ds_store_2addr_b32 v33, v71, v66 offset1:32
	ds_store_2addr_b32 v33, v43, v38 offset0:64 offset1:96
	v_add_nc_u32_e32 v0, 0, v101
	ds_store_2addr_b32 v34, v62, v56 offset1:32
	ds_store_2addr_b32 v34, v40, v4 offset0:64 offset1:96
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v0, v0
	s_waitcnt vmcnt(2)
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	s_abs_i32 s14, s13
	v_dual_mov_b32 v61, 0 :: v_dual_mov_b32 v40, 0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_dual_fmac_f32 v91, v0, v154 :: v_dual_lshlrev_b32 v0, 16, v237
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	...
	s_waitcnt vmcnt(60)
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_fmac_f32 v97, v154, v0 :: v_dual_lshlrev_b32 v2, 16, v107
	.loc	1 329 24 is_stmt 0              ; generate_amdgcn.py:329:24
	v_mul_f32_e32 v159, v11, v230
	s_waitcnt vmcnt(58)
	v_dual_mul_f32 v160, v12, v230 :: v_dual_lshlrev_b32 v11, 16, v113
	...
	v_dual_mul_f32 v167, v167, v230 :: v_dual_lshlrev_b32 v10, 16, v112
	s_waitcnt vmcnt(52)
	v_dual_mul_f32 v169, v169, v230 :: v_dual_lshlrev_b32 v20, 16, v115
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v81, v161, v11 :: v_dual_lshlrev_b32 v12, 16, v114
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(50)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v79, v162, v12 :: v_dual_lshlrev_b32 v36, 16, v118
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(42)
	v_lshlrev_b32_e32 v115, 16, v129
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_mul_f32_e32 v155, v6, v230
	v_dual_mul_f32 v156, v8, v230 :: v_dual_lshlrev_b32 v5, 16, v108
	v_dual_mul_f32 v168, v168, v230 :: v_dual_lshlrev_b32 v107, 16, v121
	v_mul_f32_e32 v170, v170, v230
	v_dual_mul_f32 v171, v171, v230 :: v_dual_lshlrev_b32 v106, 16, v120
	v_mul_f32_e32 v174, v174, v230
	v_dual_mul_f32 v175, v175, v230 :: v_dual_lshlrev_b32 v114, 16, v128
	...
	s_waitcnt vmcnt(41)
	v_dual_mul_f32 v184, v184, v230 :: v_dual_lshlrev_b32 v129, 16, v143
	...
	v_dual_mul_f32 v197, v197, v230 :: v_dual_fmac_f32 v76, v163, v20
	v_mul_f32_e32 v198, v198, v230
	v_dual_mul_f32 v199, v199, v230 :: v_dual_fmac_f32 v74, v164, v21
	v_mul_f32_e32 v200, v200, v230
	v_dual_mul_f32 v201, v201, v230 :: v_dual_fmac_f32 v62, v167, v37
	v_mul_f32_e32 v202, v202, v230
	v_dual_mul_f32 v203, v203, v230 :: v_dual_fmac_f32 v98, v169, v107
	...
	v_mul_f32_e32 v214, v214, v230
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	v_lshlrev_b32_e32 v6, 16, v109
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v85, v159, v9 :: v_dual_lshlrev_b32 v8, 16, v110
	s_waitcnt vmcnt(39)
	v_dual_fmac_f32 v73, v165, v35 :: v_dual_lshlrev_b32 v108, 16, v122
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(38)
	v_lshlrev_b32_e32 v109, 16, v123
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_mul_f32_e32 v205, v205, v230
	v_dual_mul_f32 v209, v209, v230 :: v_dual_lshlrev_b32 v110, 16, v124
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(37)
	v_dual_fmac_f32 v71, v166, v36 :: v_dual_lshlrev_b32 v112, 16, v126
	.loc	1 328 22 is_stmt 1              ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(36)
	v_lshlrev_b32_e32 v113, 16, v127
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	v_mul_f32_e32 v207, v207, v230
	v_mul_f32_e32 v213, v213, v230
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(35)
	v_dual_fmac_f32 v89, v173, v111 :: v_dual_lshlrev_b32 v116, 16, v130
	.loc	1 328 22 is_stmt 1              ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(34)
	v_lshlrev_b32_e32 v117, 16, v131
	.loc	1 329 24                        ; generate_amdgcn.py:329:24
	s_waitcnt vmcnt(33)
	v_dual_mul_f32 v215, v215, v230 :: v_dual_lshlrev_b32 v118, 16, v132
	v_dual_mul_f32 v211, v211, v230 :: v_dual_fmac_f32 v80, v177, v115
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(32)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v75, v179, v117 :: v_dual_lshlrev_b32 v122, 16, v134
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v69, v181, v119 :: v_dual_lshlrev_b32 v124, 16, v138
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(23)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v77, v185, v123 :: v_dual_lshlrev_b32 v128, 16, v142
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(17)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v65, v187, v125 :: v_dual_lshlrev_b32 v132, 16, v146
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(11)
	v_dual_fmac_f32 v45, v197, v135 :: v_dual_lshlrev_b32 v142, 16, v218
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(10)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v55, v191, v129 :: v_dual_lshlrev_b32 v136, 16, v150
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(8)
	v_lshlrev_b32_e32 v145, 16, v221
	s_waitcnt vmcnt(7)
	v_lshlrev_b32_e32 v146, 16, v222
	s_waitcnt vmcnt(6)
	v_lshlrev_b32_e32 v147, 16, v223
	s_waitcnt vmcnt(5)
	v_lshlrev_b32_e32 v148, 16, v224
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v93, v156, v5 :: v_dual_add_nc_u32 v102, s46, v102
	v_dual_fmac_f32 v95, v155, v2 :: v_dual_fmac_f32 v66, v182, v120
	v_dual_fmac_f32 v90, v157, v6 :: v_dual_fmac_f32 v61, v203, v141
	v_fmac_f32_e32 v87, v158, v8
	v_dual_fmac_f32 v83, v160, v10 :: v_dual_fmac_f32 v56, v183, v121
	v_fmac_f32_e32 v96, v170, v108
	v_dual_fmac_f32 v100, v168, v106 :: v_dual_fmac_f32 v57, v205, v143
	v_fmac_f32_e32 v94, v171, v109
	v_fmac_f32_e32 v86, v174, v112
	v_dual_fmac_f32 v92, v172, v110 :: v_dual_fmac_f32 v51, v207, v145
	v_fmac_f32_e32 v84, v175, v113
	v_dual_fmac_f32 v82, v176, v114 :: v_dual_fmac_f32 v47, v209, v147
	v_fmac_f32_e32 v78, v178, v116
	v_fmac_f32_e32 v88, v184, v122
	v_dual_fmac_f32 v68, v186, v124 :: v_dual_fmac_f32 v63, v188, v126
	v_dual_fmac_f32 v60, v189, v127 :: v_dual_fmac_f32 v53, v192, v130
	v_dual_fmac_f32 v58, v190, v128 :: v_dual_fmac_f32 v59, v204, v142
	v_dual_fmac_f32 v46, v196, v134 :: v_dual_fmac_f32 v43, v198, v136
	v_dual_fmac_f32 v52, v193, v131 :: v_dual_fmac_f32 v49, v208, v146
	v_fmac_f32_e32 v40, v199, v137
	v_fmac_f32_e32 v70, v200, v138
	v_fmac_f32_e32 v64, v202, v140
	v_dual_fmac_f32 v54, v206, v144 :: v_dual_fmac_f32 v67, v201, v139
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_waitcnt vmcnt(4)
	...
	.loc	1 329 17                        ; generate_amdgcn.py:329:17
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v72, v180, v118 :: v_dual_lshlrev_b32 v153, 16, v229
	v_dual_fmac_f32 v50, v194, v132 :: v_dual_fmac_f32 v41, v212, v150
	v_fmac_f32_e32 v48, v195, v133
	v_fmac_f32_e32 v44, v210, v148
	v_dual_fmac_f32 v42, v211, v149 :: v_dual_fmac_f32 v39, v213, v151
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk8_evenk.numbered_sgpr, 54
