	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph10
	...
	v_dual_mov_b32 v9, 0x7632 :: v_dual_and_b32 v2, 15, v0
	.loc	1 247 36                        ; generate_amdgcn.py:247:36
	v_lshrrev_b32_e32 v3, 4, v0
	v_cmp_eq_u32_e64 s0, 0, v7
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_lshl_or_b32 v13, s3, 4, v5
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_lshrrev_b32_e32 v4, 1, v0
	v_lshlrev_b32_e32 v6, 2, v0
	.loc	1 247 36                        ; generate_amdgcn.py:247:36
	v_and_or_b32 v11, v3, 16, v2
	v_cndmask_b32_e64 v3, 0x1054, v8, s0
	v_cndmask_b32_e64 v7, 0x3276, v9, s0
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_mul_lo_u32 v8, s29, v13
...
.Ltmp18:
	...
	v_lshl_add_u32 v17, v1, 2, v8
	v_and_b32_e32 v15, 0x5040504, v3
	v_cndmask_b32_e64 v3, 0, 1, s1
	v_mad_u64_u32 v[8:9], null, s28, v13, v[1:2]
...
; %bb.6:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v2, s5, v11
	.loc	1 278 13 is_stmt 1              ; generate_amdgcn.py:278:13
	v_lshl_or_b32 v1, s6, 8, v10
	v_lshl_add_u32 v3, s6, 7, v17
	s_lshl_b32 s6, s4, 8
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_lo_u32 v31, s39, v2
	s_lshl_b32 s4, s4, 7
	v_subrev_nc_u32_e32 v30, s6, v1
	v_subrev_nc_u32_e32 v32, s4, v3
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v33, s5, v8
...
.LBB0_7:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_dual_mov_b32 v4, v0 :: v_dual_add_nc_u32 v3, v14, v30
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 285 31                        ; generate_amdgcn.py:285:31
	...
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	v_dual_mov_b32 v6, v0 :: v_dual_cndmask_b32 v1, 0x80000000, v33
	.loc	1 296 30                        ; generate_amdgcn.py:296:30
	...
	s_barrier
	.loc	1 298 22                        ; generate_amdgcn.py:298:22
	buffer_load_u16 v58, v31, s[8:11], 0 offen
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x7
	buffer_load_u16 v59, v3, s[24:27], 0 offen offset:4
	buffer_load_u16 v60, v3, s[24:27], 0 offen
	buffer_load_u16 v61, v3, s[24:27], 0 offen offset:12
	buffer_load_u16 v62, v3, s[24:27], 0 offen offset:8
	buffer_load_u16 v63, v3, s[24:27], 0 offen offset:20
	buffer_load_u16 v64, v3, s[24:27], 0 offen offset:16
	buffer_load_u16 v65, v3, s[24:27], 0 offen offset:28
	buffer_load_u16 v66, v3, s[24:27], 0 offen offset:24
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	v_mov_b32_e32 v7, v0
	v_mov_b32_e32 v1, v0
	v_mov_b32_e32 v2, v0
	...
	v_dual_mov_b32 v36, v2 :: v_dual_mov_b32 v39, v5
	...
	ds_load_u8 v67, v20
	ds_load_u8 v68, v20 offset:1664
	ds_load_u8 v69, v20 offset:1920
	ds_load_u8 v70, v20 offset:1792
	ds_load_u8 v71, v20 offset:1536
	ds_load_u8 v72, v20 offset:1152
	ds_load_u8 v73, v20 offset:1280
	ds_load_u8 v74, v20 offset:1024
	ds_load_u8 v75, v20 offset:1408
	v_perm_b32 v47, v48, v47, 0xc0c0004
	v_perm_b32 v45, v46, v45, 0xc0c0004
	v_perm_b32 v44, v49, v44, 0xc0c0004
	v_perm_b32 v42, v42, v43, 0xc0c0004
	v_perm_b32 v46, v52, v51, 0xc0c0004
	v_perm_b32 v49, v55, v50, 0xc0c0004
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v51, v3, v2, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v50, v4, v1, 0xc0c0004
	...
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v53, v70, v69, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v52, v71, v68, 0xc0c0004
	v_lshl_or_b32 v6, v51, 16, v50
	v_lshl_or_b32 v5, v7, 16, v5
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v54, v74, v72, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v55, v73, v75, 0xc0c0004
	v_lshl_or_b32 v4, v46, 16, v43
	v_lshl_or_b32 v3, v49, 16, v48
	v_lshl_or_b32 v43, v53, 16, v52
	v_wmma_i32_16x16x16_iu4 v[34:41], v[5:6], v[1:2], v[34:41] neg_lo:[1,1,0]
	v_lshl_or_b32 v42, v55, 16, v54
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[34:41], v[42:43], v[3:4], v[34:41] neg_lo:[1,1,0]
	...
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v6, v35, v6 :: v_dual_lshlrev_b32 v37, 16, v60
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v4, v35, v4 :: v_dual_lshlrev_b32 v39, 16, v62
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v1, v35, v1 :: v_dual_lshlrev_b32 v40, 16, v63
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v34, v35, v34 :: v_dual_lshlrev_b32 v41, 16, v64
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v3, v35, v3 :: v_dual_lshlrev_b32 v42, 16, v65
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v24, v6, v40 :: v_dual_lshlrev_b32 v43, 16, v66
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v5, v35, v5 :: v_dual_fmac_f32 v26, v4, v38
	v_mul_f32_e32 v7, v35, v7
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_fmac_f32_e32 v27, v1, v37
	v_fmac_f32_e32 v25, v3, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v23, v5, v41
	v_dual_fmac_f32 v21, v34, v42 :: v_dual_fmac_f32 v22, v7, v43
	.loc	1 278 13 is_stmt 1              ; generate_amdgcn.py:278:13
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.num_vgpr, 76
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm32_bn128_bk128_gm1_w16_s1_weu2_sk1_maskk.kd
