...
.Ltmp18:
	...
	v_xor_b32_e32 v7, 24, v37
	v_xor_b32_e32 v0, 32, v37
	v_xor_b32_e32 v3, 40, v37
	v_xor_b32_e32 v4, 48, v37
	v_xor_b32_e32 v11, 56, v37
	v_xor_b32_e32 v12, 0x808, v38
	v_xor_b32_e32 v13, 0x1010, v38
	v_xor_b32_e32 v14, 0x1818, v38
	v_xor_b32_e32 v15, 0x2020, v38
	v_xor_b32_e32 v20, 0x2828, v38
	v_xor_b32_e32 v21, 0x3030, v38
	v_xor_b32_e32 v55, 0x3838, v38
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	v_mad_u64_u32 v[18:19], null, s25, v8, v[1:2]
	...
	v_sub_nc_u32_e32 v34, s29, v16
	v_xor_b32_e32 v36, 4, v35
	s_add_i32 s49, s6, s1
	...
	s_mul_i32 s37, s25, 12
	s_mul_i32 s38, s25, 14
	s_lshl_b32 s39, s25, 4
	s_mul_i32 s40, s25, 18
	s_mul_i32 s41, s25, 20
	s_mul_i32 s42, s25, 22
	s_mul_i32 s43, s25, 24
	s_mul_i32 s44, s25, 26
	s_mul_i32 s45, s25, 28
	s_mul_i32 s46, s25, 30
	s_and_b32 s13, s13, 0xffff
	s_bfe_i32 s48, s14, 0x1001d
	s_mov_b32 s20, s8
	s_mov_b32 s21, s9
	s_mov_b32 s22, s18
	s_mov_b32 s23, s19
...
.LBB0_2:                                ; %._crit_edge
	...
	v_or_b32_e32 v8, s50, v23
	.loc	1 298 26                        ; generate_amdgcn.py:298:26
	v_or_b32_e32 v10, s3, v25
	v_or_b32_e32 v11, s3, v27
	v_or_b32_e32 v12, s3, v28
	v_or_b32_e32 v13, s3, v29
	v_or_b32_e32 v14, s3, v30
	v_or_b32_e32 v15, s3, v31
	v_or_b32_e32 v61, s3, v32
	v_or_b32_e32 v62, s3, v33
	...
	v_or_b32_e32 v9, s50, v26
	.loc	1 334 27                        ; generate_amdgcn.py:334:27
	s_mul_i32 s50, s50, s25
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	s_add_i32 s2, s2, 20
	v_add3_u32 v63, s50, s3, v18
	s_cmp_lt_i32 s2, s26
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 334 13                        ; generate_amdgcn.py:334:13
	v_add_lshl_u32 v67, v63, s31, 2
	v_add_lshl_u32 v68, v63, s33, 2
	...
	.loc	1 299 20                        ; generate_amdgcn.py:299:20
	v_dual_mul_f32 v72, v8, v13 :: v_dual_add_nc_u32 v65, 0, v38
	v_mul_f32_e32 v79, v9, v13
	.loc	1 299 13 is_stmt 0              ; generate_amdgcn.py:299:13
	v_mul_f32_e32 v13, v78, v5
	.loc	1 299 20                        ; generate_amdgcn.py:299:20
	v_dual_mul_f32 v73, v8, v14 :: v_dual_add_nc_u32 v64, 0, v37
	...
	v_dual_mul_f32 v57, v80, v3 :: v_dual_mul_f32 v20, v75, v20
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v12, v71, v58
	.loc	1 299 20                        ; generate_amdgcn.py:299:20
	v_mul_f32_e32 v74, v8, v15
	.loc	1 299 13                        ; generate_amdgcn.py:299:13
	v_mul_f32_e32 v8, v69, v60
	v_dual_mul_f32 v15, v79, v4 :: v_dual_mul_f32 v60, v76, v19
	.loc	1 334 13 is_stmt 1              ; generate_amdgcn.py:334:13
	v_add_lshl_u32 v19, v63, s34, 2
	.loc	1 299 13                        ; generate_amdgcn.py:299:13
	v_mul_f32_e32 v58, v74, v21
	v_mul_f32_e32 v21, v61, v1
	v_mul_f32_e32 v61, v62, v0
	ds_store_b64 v64, v[8:9]
	ds_store_b64 v42, v[10:11]
	ds_store_b64 v43, v[12:13]
	ds_store_b64 v44, v[14:15]
	ds_store_b64 v45, v[56:57]
	ds_store_b64 v46, v[58:59]
	...
	ds_load_b64 v[14:15], v55
	.loc	1 334 13                        ; generate_amdgcn.py:334:13
	v_add_lshl_u32 v20, v63, s35, 2
	v_add_lshl_u32 v21, v63, s36, 2
	v_add_lshl_u32 v56, v63, s37, 2
	v_add_lshl_u32 v57, v63, s38, 2
	v_add_lshl_u32 v58, v63, s39, 2
	v_add_lshl_u32 v59, v63, s40, 2
	v_add_lshl_u32 v60, v63, s41, 2
	s_waitcnt lgkmcnt(7)
	...
	v_add_lshl_u32 v61, v63, s42, 2
	v_add_lshl_u32 v62, v63, s43, 2
	v_add_lshl_u32 v64, v63, s44, 2
	v_add_lshl_u32 v65, v63, s45, 2
	v_add_lshl_u32 v0, v63, s46, 2
	s_clause 0x4
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	s_abs_i32 s3, s2
	s_ashr_i32 s7, s2, 31
	s_mul_hi_u32 s6, s3, s49
	s_xor_b32 s7, s7, s48
	s_mul_i32 s50, s6, s30
	v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, 0
	s_sub_i32 s3, s3, s50
	s_add_i32 s50, s6, 1
	s_sub_i32 s51, s3, s30
	s_cmp_ge_u32 s3, s30
	...
	s_abs_i32 s6, s50
	v_mov_b32_e32 v1, 0
	s_cvt_f32_u32 s51, s6
	s_sub_i32 s52, 0, s6
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_iflag_f32_e32 v0, s51
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_sub_i32 s50, s53, s50
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	s_add_i32 s50, s50, s7
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 276 18 is_stmt 1              ; generate_amdgcn.py:276:18
	s_lshl_b32 s50, s50, 5
	.loc	1 281 13                        ; generate_amdgcn.py:281:13
	s_cbranch_vccnz .LBB0_2
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_or_b32 v1, s6, 7, v24
	s_lshl_b32 s3, s3, 7
	v_mov_b32_e32 v0, 0
	v_add_nc_u32_e32 v2, s50, v22
	s_mov_b32 s52, s28
	v_subrev_nc_u32_e32 v3, s3, v1
	s_mov_b32 s53, s47
	v_mov_b32_e32 v1, v0
	v_mad_u64_u32 v[19:20], null, s29, v2, v[16:17]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[20:21], null, s29, v3, v[17:18]
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_mov_b32_e32 v5, v0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_add_nc_u32_e32 v21, s52, v17
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	v_add_nc_u32_e32 v57, s52, v20
	.loc	1 289 26                        ; generate_amdgcn.py:289:26
	v_add_nc_u32_e32 v56, s52, v19
	.loc	1 284 27                        ; generate_amdgcn.py:284:27
	v_cmp_lt_i32_e32 vcc_lo, s52, v34
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	s_mov_b32 s6, s18
	...
	s_add_i32 s53, s53, -1
	.loc	1 289 26                        ; generate_amdgcn.py:289:26
	v_cndmask_b32_e32 v58, 0x80000000, v56, vcc_lo
	.loc	1 281 13                        ; generate_amdgcn.py:281:13
	s_addk_i32 s52, 0x80
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	v_cndmask_b32_e64 v21, 0x80000000, v57, s3
	.loc	1 281 13                        ; generate_amdgcn.py:281:13
	s_cmp_lg_u32 s53, 0
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	buffer_load_b64 v[56:57], v21, s[4:7], 0 offen
	.loc	1 289 26                        ; generate_amdgcn.py:289:26
	buffer_load_u16 v21, v58, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v66, v35, v56
	ds_bpermute_b32 v67, v35, v57
	ds_bpermute_b32 v68, v36, v56
	ds_bpermute_b32 v69, v36, v57
	.loc	1 289 26                        ; generate_amdgcn.py:289:26
	s_waitcnt vmcnt(0)
	ds_store_b16 v39, v21
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[56:59], v40 offset1:32
	ds_load_2addr_b64 v[60:63], v41 offset1:32
	.loc	1 292 26                        ; generate_amdgcn.py:292:26
	v_cndmask_b32_e64 v64, v68, v66, s0
	v_cndmask_b32_e64 v65, v69, v67, s0
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 82
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm32_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 56
