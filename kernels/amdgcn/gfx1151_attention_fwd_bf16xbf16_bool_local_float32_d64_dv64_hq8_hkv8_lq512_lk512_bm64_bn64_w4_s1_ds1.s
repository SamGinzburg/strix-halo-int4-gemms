	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v44, v41 :: v_dual_add_nc_u32 v171, s9, v1
	v_dual_mov_b32 v45, v41 :: v_dual_add_nc_u32 v172, s9, v2
	v_dual_mov_b32 v47, v41 :: v_dual_lshlrev_b32 v2, 7, v28
	v_dual_mov_b32 v48, v41 :: v_dual_lshlrev_b32 v1, 6, v73
	v_dual_mov_b32 v17, v41 :: v_dual_lshlrev_b32 v4, 4, v69
	...
	v_or_b32_e32 v174, v4, v2
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v169, s8, v3
	v_dual_mov_b32 v46, v41 :: v_dual_add_nc_u32 v173, s9, v3
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v190, 0xff800000 :: v_dual_add_nc_u32 v3, v1, v162
	...
	v_dual_mov_b32 v21, v41 :: v_dual_and_b32 v10, 8, v0
	...
	v_add_nc_u32_e32 v207, v6, v161
	v_add_nc_u32_e32 v208, v6, v162
	...
	v_add_nc_u32_e32 v209, v6, v163
	v_add_nc_u32_e32 v210, v6, v164
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v3, off offset:24
	scratch_store_b32 off, v1, off offset:92
	v_add_nc_u32_e32 v3, v5, v146
	v_add_nc_u32_e32 v1, v6, v146
	v_add_nc_u32_e32 v211, v6, v165
	v_xor_b32_e32 v6, 0x70, v174
	v_dual_mov_b32 v19, v41 :: v_dual_lshlrev_b32 v8, 5, v0
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v3, off offset:28
	scratch_store_b32 off, v1, off offset:96
	v_add_nc_u32_e32 v3, v5, v159
	v_bfe_i32 v11, v0, 3, 1
	v_dual_mov_b32 v187, v41 :: v_dual_add_nc_u32 v220, 0, v6
	v_mov_b32_e32 v6, v41
	scratch_store_b32 off, v3, off offset:32 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v3, v5, v160
	v_mov_b32_e32 v20, v41
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s0, s3, 31
	v_and_b32_e32 v8, 0x60, v8
	v_mov_b32_e32 v22, v41
	.loc	1 818 13                        ; attention.py:818:13
	scratch_store_b32 off, v3, off offset:36 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v3, v5, v161
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s0, s0, 29
	v_dual_mov_b32 v23, v41 :: v_dual_lshlrev_b32 v12, 2, v73
	v_mov_b32_e32 v24, v41
	.loc	1 818 13                        ; attention.py:818:13
	scratch_store_b32 off, v3, off offset:40 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v3, v5, v162
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s0, s3, s0
	...
	v_add_nc_u32_e32 v3, v5, v165
	v_dual_mov_b32 v14, v41 :: v_dual_add_nc_u32 v5, v2, v161
	.loc	1 788 26                        ; attention.py:788:26
	s_mov_b32 s68, 0
	...
	v_dual_mov_b32 v12, v41 :: v_dual_add_nc_u32 v221, 0, v1
	...
	v_dual_mov_b32 v7, v41 :: v_dual_add_nc_u32 v204, 0, v1
	...
	v_dual_mov_b32 v2, v41 :: v_dual_add_nc_u32 v247, 0, v4
...
.Ltmp131:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 101
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 112
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1
    .private_segment_fixed_size: 112
    .sgpr_count:     103
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.kd
