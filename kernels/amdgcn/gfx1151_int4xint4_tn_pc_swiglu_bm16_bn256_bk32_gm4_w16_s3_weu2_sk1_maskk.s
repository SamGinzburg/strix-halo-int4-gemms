	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s10, v38, v[1:2]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	...
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	v_or_b32_e32 v10, s4, v38
	v_or_b32_e32 v11, s4, v3
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_lshl_add_u32 v8, s11, 5, v5
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_dual_cndmask_b32 v8, 0x80000000, v8 :: v_dual_add_nc_u32 v17, 0, v9
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_cndmask_b32_e32 v12, 0x80000000, v12, vcc_lo
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v15, v10, s[12:15], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_b32_e32 v18, 0x70, v4
	v_add_nc_u32_e32 v6, s27, v38
	v_sub_nc_u32_e32 v23, s28, v3
.Ltmp12:
...
.Ltmp13:
	...
	s_lshl_b32 s0, s29, 8
	s_lshl_b32 s1, s25, 8
	v_sub_nc_u32_e32 v22, s28, v38
	s_mov_b32 s28, 1
	v_readfirstlane_b32 s2, v7
	s_lshl_b32 s29, s11, 5
	v_add3_u32 v26, v6, s21, v1
	v_mov_b32_e32 v1, 0
	v_lshlrev_b32_e32 v5, 1, v3
	v_and_or_b32 v24, 0x88, v4, v18
	s_add_i32 s30, s2, 1
	...
	v_dual_mov_b32 v10, v1 :: v_dual_add_nc_u32 v5, 0x41, v3
	...
	v_subrev_nc_u32_e32 v27, s1, v4
	v_subrev_nc_u32_e32 v28, s1, v2
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v4, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e32 vcc_lo, s27, v23
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s0, s27, v22
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_dual_cndmask_b32 v30, 0x80000000, v28 :: v_dual_cndmask_b32 v31, 0x80000000, v27
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_cndmask_b32_e64 v29, 0x80000000, v26, s0
	s_mov_b32 s0, s25
	s_mov_b32 s25, s10
	s_mov_b32 s10, s26
	s_mov_b32 s26, s2
	buffer_load_u8 v37, v29, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[29:30], v30, s[16:19], 0 offen
	buffer_load_b64 v[31:32], v31, s[16:19], 0 offen
	v_add_nc_u32_e32 v34, s10, v20
	s_mov_b32 s2, s3
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v33, s0, v24
	v_add_nc_u32_e32 v35, s0, v25
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v36, s2, v20
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v40, v34 offset:1280
	ds_load_u8 v41, v34 offset:1792
	ds_load_u8 v42, v34 offset:1536
	ds_load_u8 v43, v34 offset:1024
	ds_load_u8 v44, v34 offset:256
	ds_load_u8 v45, v34 offset:768
	ds_load_u8 v46, v34 offset:512
	ds_load_u8 v47, v34
	ds_load_u8 v48, v34 offset:3328
	ds_load_u8 v49, v34 offset:3840
	ds_load_u8 v50, v34 offset:3584
	ds_load_u8 v51, v34 offset:3072
	ds_load_u8 v52, v34 offset:2304
	ds_load_u8 v53, v34 offset:2816
	ds_load_u8 v54, v34 offset:2560
	ds_load_u8 v55, v34 offset:2048
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v56, v36 offset:1280
	ds_load_u8 v57, v36 offset:1792
	ds_load_u8 v58, v36 offset:1536
	ds_load_u8 v59, v36 offset:1024
	ds_load_u8 v60, v36 offset:256
	ds_load_u8 v61, v36 offset:768
	ds_load_u8 v62, v36 offset:512
	ds_load_u8 v63, v36
	ds_load_u8 v64, v36 offset:3328
	ds_load_u8 v65, v36 offset:3840
	ds_load_u8 v66, v36 offset:3584
	ds_load_u8 v67, v36 offset:3072
	ds_load_u8 v68, v36 offset:2304
	ds_load_u8 v69, v36 offset:2816
	ds_load_u8 v70, v36 offset:2560
	ds_load_u8 v71, v36 offset:2048
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v54, v71, v68, 0xc0c0004
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	v_add_nc_u32_e32 v27, s29, v27
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v33, s0, v21
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[42:43], v[35:36], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[46:47], v[35:36], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s30, s30, -1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
...
; %bb.9:
	...
	v_add_nc_u32_e32 v31, s18, v45
	v_add_nc_u32_e32 v23, s18, v48
	v_add_nc_u32_e32 v34, s18, v41
	v_add_nc_u32_e32 v24, s18, v47
	v_add_nc_u32_e32 v32, s18, v44
	v_add_nc_u32_e32 v33, s18, v43
	v_add_nc_u32_e32 v35, s18, v53
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v25, v25
	ds_load_u8 v31, v31
	ds_load_u8 v23, v23
	...
	v_add_nc_u32_e32 v37, s18, v40
	v_add_nc_u32_e32 v22, s18, v50
	v_add_nc_u32_e32 v36, s18, v49
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v31, s3, v46
	v_add_nc_u32_e32 v32, s3, v45
	v_add_nc_u32_e32 v16, s3, v48
	v_add_nc_u32_e32 v35, s3, v41
	v_add_nc_u32_e32 v17, s3, v47
	v_add_nc_u32_e32 v33, s3, v44
	v_add_nc_u32_e32 v34, s3, v43
	v_add_nc_u32_e32 v36, s3, v53
...
.LBB0_12:                               ; %._crit_edge55
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v29, v13 :: v_dual_add_nc_u32 v26, s10, v30
...
.LBB0_17:
	...
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	s_waitcnt lgkmcnt(0)
	buffer_load_u16 v34, v10, s[12:15], 0 offen
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_vgpr, 73
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_maskk.kd
