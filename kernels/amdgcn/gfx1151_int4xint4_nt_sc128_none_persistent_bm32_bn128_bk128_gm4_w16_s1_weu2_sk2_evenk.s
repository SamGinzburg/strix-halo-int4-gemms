	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	v_and_or_b32 v12, 0x438, v8, v11
	v_or3_b32 v11, v21, v22, v11
...
.Ltmp11:
	...
	v_xor_b32_e32 v32, v23, v9
	v_lshlrev_b32_e32 v9, 1, v0
	.loc	2 43 12 is_stmt 0               ; standard.py:43:12 @[ generate_amdgcn.py:246:26 ]
	s_ashr_i32 s1, s0, 31
	v_and_b32_e32 v21, 0x2040, v21
.Ltmp12:
	.loc	1 210 22 is_stmt 1              ; generate_amdgcn.py:210:22
	s_lshr_b32 s13, s12, 31
.Ltmp13:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:246:26 ]
	s_lshr_b32 s1, s1, 25
	v_and_b32_e32 v22, 0x60, v9
.Ltmp14:
...
.Ltmp18:
	...
	v_xor_b32_e32 v16, 24, v12
	v_and_b32_e32 v0, 32, v0
	v_xor_b32_e32 v28, 32, v12
	v_xor_b32_e32 v29, 40, v12
	v_readfirstlane_b32 s0, v8
	v_xor_b32_e32 v30, 48, v12
	v_or3_b32 v0, v0, v9, v6
	v_xor_b32_e32 v31, 56, v12
	v_xor_b32_e32 v34, 8, v11
	s_mul_f32 s0, s0, 0x4f7ffffe
	v_xor_b32_e32 v35, 16, v11
	v_xor_b32_e32 v36, 24, v11
	v_xor_b32_e32 v37, 32, v11
	v_xor_b32_e32 v38, 40, v11
	v_xor_b32_e32 v39, 48, v11
	v_xor_b32_e32 v40, 56, v11
	v_xor_b32_e32 v42, 4, v3
	v_xor_b32_e32 v43, 8, v3
	v_xor_b32_e32 v44, 12, v3
	v_xor_b32_e32 v6, 16, v3
	v_xor_b32_e32 v46, 20, v3
	v_xor_b32_e32 v47, 24, v3
	v_xor_b32_e32 v48, 28, v3
	v_xor_b32_e32 v50, 0x1010, v0
	v_xor_b32_e32 v51, 0x2040, v0
	v_xor_b32_e32 v52, 0x3050, v0
	s_cvt_u32_f32 s0, s0
	s_sub_i32 s1, 0, s29
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	...
	v_or_b32_e32 v22, v10, v2
	v_lshl_or_b32 v9, v2, 2, s3
	v_lshl_or_b32 v10, v5, 3, s3
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v4, s42, v17
	s_lshl_b32 s1, s1, 7
	s_lshl_b32 s3, s0, 8
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v2, s42, v22
	v_or_b32_e32 v3, s1, v20
	v_subrev_nc_u32_e32 v58, s3, v1
	v_or_b32_e32 v1, s1, v18
	v_mad_u64_u32 v[11:12], null, s26, v4, v[9:10]
	s_lshl_b32 s0, s0, 7
	v_mul_lo_u32 v59, s41, v2
	v_subrev_nc_u32_e32 v2, s0, v3
	v_subrev_nc_u32_e32 v1, s0, v1
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v53, 0
	v_dual_mov_b32 v54, 0 :: v_dual_mov_b32 v15, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[12:13], null, s26, v2, v[10:11]
	v_mad_u64_u32 v[13:14], null, s26, v1, v[10:11]
	v_mov_b32_e32 v14, 0
	v_mov_b32_e32 v16, 0
	s_mov_b32 s44, 0
	s_mov_b32 s45, s27
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_cndmask_b32 v1, 0x80000000, v3 :: v_dual_add_nc_u32 v6, v21, v58
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	v_cndmask_b32_e64 v2, 0x80000000, v4, s0
	v_cndmask_b32_e64 v3, 0x80000000, v5, s0
	s_mov_b32 s7, s15
	.loc	1 265 30                        ; generate_amdgcn.py:265:30
	...
	ds_load_b64 v[72:73], v26
	ds_load_b64 v[74:75], v27
	ds_load_b64 v[76:77], v28
	ds_load_b64 v[78:79], v29
	ds_load_b64 v[80:81], v30
	ds_load_b64 v[82:83], v31
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v32, v[1:2], v[3:4] offset1:8
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 272 22                        ; generate_amdgcn.py:272:22
	...
	buffer_load_u16 v86, v6, s[16:19], 0 offen offset:4
	buffer_load_u16 v87, v6, s[16:19], 0 offen offset:8
	buffer_load_u16 v88, v6, s[16:19], 0 offen offset:12
	buffer_load_u16 v89, v6, s[16:19], 0 offen offset:16
	buffer_load_u16 v90, v6, s[16:19], 0 offen offset:20
	buffer_load_u16 v91, v6, s[16:19], 0 offen offset:24
	buffer_load_u16 v92, v6, s[16:19], 0 offen offset:28
	...
	v_dual_mov_b32 v66, v6 :: v_dual_mov_b32 v61, v1
	v_mov_b32_e32 v60, v0
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	ds_load_b64 v[1:2], v33
	ds_load_b64 v[3:4], v34
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[1:2], v[68:69], v[60:67] neg_lo:[1,1,0]
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	ds_load_b64 v[1:2], v35
	ds_load_b64 v[5:6], v36
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[3:4], v[70:71], v[60:67] neg_lo:[1,1,0]
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	ds_load_b64 v[3:4], v37
	ds_load_b64 v[68:69], v38
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[1:2], v[72:73], v[60:67] neg_lo:[1,1,0]
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	ds_load_b64 v[1:2], v39
	ds_load_b64 v[70:71], v40
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[5:6], v[74:75], v[60:67] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[3:4], v[76:77], v[60:67] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[68:69], v[78:79], v[60:67] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[1:2], v[80:81], v[60:67] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[60:67], v[70:71], v[82:83], v[60:67] neg_lo:[1,1,0]
	...
	v_dual_mul_f32 v1, v1, v61 :: v_dual_lshlrev_b32 v64, 16, v87
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v56, v1, v62 :: v_dual_add_nc_u32 v59, 2, v59
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v2, v2, v61 :: v_dual_lshlrev_b32 v63, 16, v86
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v4, v4, v61 :: v_dual_lshlrev_b32 v65, 16, v88
	v_mul_f32_e32 v6, v6, v61
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v57, v2, v63 :: v_dual_lshlrev_b32 v66, 16, v89
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v60, v60, v61 :: v_dual_lshlrev_b32 v67, 16, v90
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v3, v3, v61 :: v_dual_lshlrev_b32 v68, 16, v91
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v54, v4, v65 :: v_dual_lshlrev_b32 v69, 16, v92
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v5, v5, v61 :: v_dual_fmac_f32 v14, v6, v67
	v_mul_f32_e32 v7, v7, v61
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v55, v3, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v15, v60, v69
	v_dual_fmac_f32 v53, v5, v66 :: v_dual_fmac_f32 v16, v7, v68
...
.LBB0_5:                                ; %._crit_edge
	...
	s_barrier
	ds_store_b32 v41, v56
	ds_store_b32 v42, v57
	ds_store_b32 v43, v55
	ds_store_b32 v44, v54
	ds_store_b32 v45, v53
	ds_store_b32 v46, v14
	ds_store_b32 v47, v16
	ds_store_b32 v48, v15
	...
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	ds_load_2addr_b32 v[11:12], v49 offset1:32
	ds_load_2addr_b32 v[6:7], v50 offset1:32
	ds_load_2addr_b32 v[4:5], v51 offset1:32
	ds_load_2addr_b32 v[1:2], v52 offset1:32
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_vgpr, 93
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.kd
