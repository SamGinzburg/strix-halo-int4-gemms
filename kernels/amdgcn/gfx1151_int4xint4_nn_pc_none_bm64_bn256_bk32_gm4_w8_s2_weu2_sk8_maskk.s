	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_dual_mov_b32 v5, v8 :: v_dual_lshlrev_b32 v66, 4, v69
	v_dual_mov_b32 v4, v8 :: v_dual_and_b32 v41, 0x37c, v41
	...
	v_mad_u64_u32 v[2:3], null, s21, v75, v[65:66]
	...
	s_mov_b32 s15, s7
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v70, 0, v41
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v41, v8 :: v_dual_cndmask_b32 v2, 0x80000000, v2
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v70, v73 offset:4096
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(0)
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v2, 0, v69
	v_add_nc_u32_e32 v1, s2, v74
	v_and_b32_e32 v3, 0x70, v68
.Ltmp12:
...
.Ltmp15:
	...
	v_dual_mov_b32 v43, v41 :: v_dual_add_nc_u32 v4, s3, v75
	s_delay_alu instid0(VALU_DEP_4)
	v_subrev_nc_u32_e32 v75, s15, v1
	v_dual_mov_b32 v48, v41 :: v_dual_add_nc_u32 v1, 0, v3
	v_dual_mov_b32 v58, v41 :: v_dual_add_nc_u32 v3, 0, v6
	v_sub_nc_u32_e32 v73, s21, v65
	v_mad_u64_u32 v[65:66], null, s21, v4, v[65:66]
	v_sub_nc_u32_e32 v74, s21, v74
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	v_dual_mul_f32 v155, v74, v85 :: v_dual_mul_f32 v70, v88, v43
	...
	v_dual_mul_f32 v150, v68, v85 :: v_dual_mul_f32 v65, v87, v42
	v_mul_f32_e32 v152, v71, v85
	v_dual_mul_f32 v154, v73, v85 :: v_dual_mul_f32 v71, v107, v51
	v_dual_mul_f32 v156, v75, v85 :: v_dual_mul_f32 v83, v112, v55
	v_dual_mul_f32 v157, v76, v85 :: v_dual_mul_f32 v74, v89, v44
	v_mul_f32_e32 v158, v77, v85
	v_dual_mul_f32 v159, v78, v85 :: v_dual_mul_f32 v78, v91, v46
	v_dual_mul_f32 v160, v79, v85 :: v_dual_mul_f32 v87, v113, v56
	v_mul_f32_e32 v161, v80, v85
	v_dual_mul_f32 v162, v81, v85 :: v_dual_mul_f32 v91, v124, v34
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v41, v86, v41 :: v_dual_mul_f32 v82, v92, v47
	v_mul_f32_e32 v86, v93, v48
	v_dual_mul_f32 v42, v104, v49 :: v_dual_mul_f32 v107, v129, v39
	v_dual_mul_f32 v43, v131, v25 :: v_dual_mul_f32 v72, v133, v27
	v_mul_f32_e32 v44, v147, v9
	v_dual_mul_f32 v45, v90, v45 :: v_dual_mul_f32 v90, v95, v58
	v_dual_mul_f32 v58, v123, v33 :: v_dual_mul_f32 v73, v149, v11
	v_dual_mul_f32 v46, v109, v53 :: v_dual_mul_f32 v67, v132, v26
	v_dual_mul_f32 v76, v134, v28 :: v_dual_mul_f32 v47, v135, v29
	v_mul_f32_e32 v48, v151, v13
	...
	v_dual_mul_f32 v66, v105, v50 :: v_dual_mul_f32 v75, v108, v52
	v_mul_f32_e32 v79, v111, v54
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_vgpr, 163
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.numbered_sgpr, 79
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     81
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.kd
