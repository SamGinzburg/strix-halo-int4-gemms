	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v23, v14, s[12:15], 0 offen
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v24, v14, s[12:15], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[14:17], v11, s[16:19], 0 offen
	buffer_load_b128 v[18:21], v13, s[16:19], 0 offen
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_and_b32_e32 v26, 48, v13
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v34, v11, v25
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v35, v22, v26
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v26, v[14:17] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v26, v[18:21] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_lshl_or_b32 v23, v12, 6, v2
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshl_or_b32 v25, v22, 5, v23
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_3:
	...
	s_load_b64 s[4:5], s[0:1], 0x20
.LBB0_4:                                ; %.lr.ph
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v1, 48, v1
.Ltmp14:
	.loc	2 43 12 is_stmt 1               ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_lshr_b32 s27, s24, 8
	s_addk_i32 s26, 0x100
	s_add_i32 s25, 0, 0x4000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v23, v12, 6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s25, s1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v84, v36, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[44:47], v37, s[16:19], 0 offen
	...
	v_dual_add_f32 v21, v21, v37 :: v_dual_add_f32 v20, v20, v38
	v_dual_add_f32 v19, v19, v39 :: v_dual_add_f32 v18, v18, v40
	v_dual_add_f32 v17, v17, v41 :: v_dual_add_f32 v16, v16, v42
...
; %bb.7:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_f32 v14, v14, v9 :: v_dual_add_f32 v15, v15, v2
.LBB0_8:
...
; %bb.9:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v2, 0 :: v_dual_add_nc_u32 v3, s24, v29
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v4, s1, v26
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v8, v2 :: v_dual_add_nc_u32 v5, s1, v24
	v_mov_b32_e32 v7, v2
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	v_wmma_i32_16x16x16_iu8 v[2:9], v[23:26], v[50:53], v[2:9] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cvt_f32_i32_e32 v2, v2
	v_cvt_f32_i32_e32 v3, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.LBB0_10:
	...
	v_or3_b32 v10, v10, v22, s6
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v21, v3 :: v_dual_lshlrev_b32 v12, 1, v12
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s12, s8
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v5, v19, v5 :: v_dual_lshlrev_b32 v10, 1, v10
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	s_mov_b32 s12, s10
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v8, v16, v8 :: v_dual_add_f32 v9, v14, v9
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v2, v15, v2 :: v_dual_and_b32 v29, 0x7f, v0
	v_dual_add_f32 v4, v20, v4 :: v_dual_add_f32 v7, v17, v7
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_bfe_i32 v33, v0, 3, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v18, v6 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	v_dual_mul_f32 v3, v3, v22 :: v_dual_lshlrev_b32 v28, 16, v28
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v24, v12, v24 :: v_dual_and_b32 v19, 0x204, v30
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v26, v12, v26 :: v_dual_mul_f32 v5, v5, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v10, v12, v10 :: v_dual_and_b32 v13, 28, v13
	v_mul_f32_e32 v23, v12, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v1, v32, 2, v1
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v25, 16, v25
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_or_b32 v11, 0x1c0, v11, v13
	...
	v_add_lshl_u32 v9, v13, s1, 2
	v_add_lshl_u32 v11, v13, s8, 2
	v_add_lshl_u32 v10, v13, s3, 2
	v_add_lshl_u32 v12, v13, s9, 2
	.loc	1 418 23 is_stmt 0              ; generate_amdgcn.py:418:23
	s_mul_i32 s0, s7, 14
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	s_mov_b32 s7, s15
	v_add_lshl_u32 v14, v13, s10, 2
	v_add_lshl_u32 v15, v13, s11, 2
	s_waitcnt lgkmcnt(7)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 87
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
