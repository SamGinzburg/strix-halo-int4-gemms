...
.Ltmp0:
	...
	v_dual_mov_b32 v31, 0 :: v_dual_and_b32 v12, 0x70, v0
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_lshlrev_b32_e32 v10, 3, v0
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_and_b32_e32 v16, 0xe0, v0
	v_dual_mov_b32 v32, 0 :: v_dual_and_b32 v17, 15, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_lshrrev_b32_e32 v11, 1, v12
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v13, 0x100, v0
...
; %bb.1:                                ; %.lr.ph
	v_lshl_or_b32 v14, s17, 8, v16
	s_add_i32 s15, s18, 0x80
	s_lshl_b32 s0, s6, 8
	v_add3_u32 v5, s34, v34, v17
	...
	v_xor_b32_e32 v19, 48, v4
	v_xor_b32_e32 v20, 56, v4
	v_mad_u64_u32 v[9:10], null, s7, v3, v[1:2]
	v_subrev_nc_u32_e32 v44, s0, v2
	v_add_nc_u32_e32 v45, 0, v4
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v46, 0, v6
	v_add_nc_u32_e32 v47, 0, v7
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v48, 0, v8
	v_mov_b32_e32 v1, s16
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v49, 0, v11
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v50, 0, v15
	v_dual_mov_b32 v30, 0 :: v_dual_add_nc_u32 v51, 0, v19
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v52, 0, v20
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v66, v66, v74 :: v_dual_lshlrev_b32 v73, 16, v85
	v_dual_mul_f32 v53, v53, v73 :: v_dual_add_nc_u32 v44, s44, v44
	v_dual_mul_f32 v55, v55, v73 :: v_dual_add_nc_u32 v42, 2, v42
	v_dual_mul_f32 v56, v56, v73 :: v_dual_add_nc_u32 v43, 2, v43
	v_dual_mul_f32 v58, v58, v73 :: v_dual_lshlrev_b32 v75, 16, v87
	v_dual_mul_f32 v59, v59, v73 :: v_dual_lshlrev_b32 v76, 16, v88
	v_dual_mul_f32 v60, v60, v73 :: v_dual_lshlrev_b32 v79, 16, v91
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v14, v53, v75 :: v_dual_lshlrev_b32 v81, 16, v93
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v54, v54, v73
	v_mul_f32_e32 v57, v57, v73
	v_dual_mul_f32 v64, v64, v74 :: v_dual_add_nc_u32 v41, s43, v41
	v_dual_mul_f32 v68, v68, v74 :: v_dual_lshlrev_b32 v77, 16, v89
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v78, 16, v90
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v63, v63, v74 :: v_dual_lshlrev_b32 v80, 16, v92
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v29, v57, v79 :: v_dual_lshlrev_b32 v82, 16, v94
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v61, v61, v74
	v_mul_f32_e32 v62, v62, v74
	v_dual_mul_f32 v65, v65, v74 :: v_dual_fmac_f32 v32, v54, v76
	v_dual_mul_f32 v67, v67, v74 :: v_dual_fmac_f32 v28, v58, v80
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v31, v55, v77 :: v_dual_fmac_f32 v30, v56, v78
	v_dual_fmac_f32 v27, v59, v81 :: v_dual_fmac_f32 v26, v60, v82
	v_dual_fmac_f32 v25, v61, v75 :: v_dual_fmac_f32 v24, v62, v76
	v_dual_fmac_f32 v23, v63, v77 :: v_dual_fmac_f32 v22, v64, v78
	v_dual_fmac_f32 v21, v65, v79 :: v_dual_fmac_f32 v20, v66, v80
	v_fmac_f32_e32 v19, v67, v81
	v_fmac_f32_e32 v15, v68, v82
...
.LBB0_8:
	...
	s_mov_b32 s27, s15
	.loc	1 178 26                        ; generate_amdgcn.py:178:26
	v_mul_i32_i24_e32 v17, s26, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v34, 0x80000000, v18, s2
	s_mov_b32 s26, s14
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	buffer_load_u16 v43, v34, s[24:27], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v36, 8, v18
	v_add_nc_u32_e32 v33, 4, v18
	v_add_nc_u32_e32 v44, 16, v18
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v4, v4, v35 :: v_dual_add_nc_u32 v45, 20, v18
	v_mul_f32_e32 v1, v1, v35
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v34, 0x80000000, v36, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v3, v3, v35 :: v_dual_add_nc_u32 v36, 12, v18
	v_dual_mul_f32 v7, v7, v35 :: v_dual_add_nc_u32 v46, 24, v18
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v48, v34, s[24:27], 0 offen
	...
	buffer_load_u16 v49, v18, s[24:27], 0 offen
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v50, v17, s[12:15], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_and_b32_e32 v34, 0x78, v42
	.loc	1 98 32                         ; generate_amdgcn.py:98:32
	v_lshrrev_b32_e32 v33, 7, v0
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v6, v6, v35 :: v_dual_and_b32 v17, 0x7f, v0
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_bfe_i32 v18, v0, 0, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v52, v16, 3, v34
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_mul_lo_u32 v34, s35, v33
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v9, v9, v50 :: v_dual_lshlrev_b32 v36, 16, v36
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_lshlrev_b32_e32 v53, 11, v42
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v10, v10, v50
	v_dual_mul_f32 v35, v37, v50 :: v_dual_lshlrev_b32 v48, 16, v48
	v_mul_f32_e32 v11, v11, v50
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_or3_b32 v51, v53, v51, v18
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_ashrrev_i32_e32 v18, 31, v17
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v37, v38, v50 :: v_dual_lshlrev_b32 v44, 16, v44
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v1, v1, v43, v14
	v_fma_f32 v2, v2, v47, v32
	v_fma_f32 v43, v9, v43, v25
	v_fma_f32 v4, v4, v36, v30
	v_fma_f32 v10, v10, v47, v24
	v_fma_f32 v41, v3, v48, v31
	v_fma_f32 v6, v6, v45, v28
	v_fma_f32 v11, v11, v48, v23
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
	v_add_co_u32 v17, vcc_lo, s40, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v49, v26
	v_fma_f32 v35, v35, v36, v22
	v_fma_f32 v50, v5, v44, v29
	v_fma_f32 v36, v37, v44, v21
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_ci_u32_e64 v18, null, s41, v18, vcc_lo
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v59, v7, v46, v27
	v_fma_f32 v37, v38, v45, v20
	v_fma_f32 v38, v39, v46, v19
	v_fma_f32 v39, v40, v49, v15
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v1, v14, v1, s2
	v_cndmask_b32_e64 v3, v32, v2, s2
	v_cndmask_b32_e64 v2, v25, v43, s2
	v_xad_u32 v53, v51, 8, 0
	v_cndmask_b32_e64 v7, v30, v4, s2
	v_cndmask_b32_e64 v4, v24, v10, s2
	v_xad_u32 v54, v51, 16, 0
	v_cndmask_b32_e64 v5, v31, v41, s2
	v_cndmask_b32_e64 v28, v28, v6, s2
	v_cndmask_b32_e64 v6, v23, v11, s2
	v_xad_u32 v55, v51, 24, 0
	v_cndmask_b32_e64 v14, v26, v8, s2
	v_cndmask_b32_e64 v8, v22, v35, s2
	v_xad_u32 v56, v51, 32, 0
	v_cndmask_b32_e64 v9, v29, v50, s2
	v_cndmask_b32_e64 v10, v21, v36, s2
	v_xad_u32 v57, v51, 40, 0
	v_xad_u32 v58, v51, 48, 0
	v_xad_u32 v51, v51, 56, 0
	v_cndmask_b32_e64 v30, v27, v59, s2
	v_cndmask_b32_e64 v29, v20, v37, s2
	v_cndmask_b32_e64 v31, v19, v38, s2
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk2_maskk.numbered_sgpr, 45
