...
.Ltmp0:
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_add_lshl_u32 v1, v89, s4, 1
	.loc	1 790 22                        ; attention.py:790:22
	s_and_b32 s2, s2, vcc_lo
	.loc	1 759 31                        ; attention.py:759:31
	v_bfe_u32 v112, v0, 4, 1
	.loc	1 788 26                        ; attention.py:788:26
	v_add_lshl_u32 v2, v125, s4, 1
	v_add_lshl_u32 v3, v126, s4, 1
	v_add_lshl_u32 v4, v90, s4, 1
...
; %bb.1:                                ; %.lr.ph
	...
	s_add_i32 s11, s3, s5
	v_dual_mov_b32 v81, 0xff800000 :: v_dual_lshlrev_b32 v2, 7, v67
	.loc	1 756 22                        ; attention.py:756:22
	s_and_b32 s4, s11, 0xfff0
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v25, 0 :: v_dual_lshlrev_b32 v4, 4, v33
	s_add_i32 s3, s3, s12
	...
	s_and_b32 s91, s0, 0xfffff800
	v_or_b32_e32 v131, v4, v2
	...
	v_subrev_nc_u32_e32 v129, s8, v1
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v130, s9, v1
	...
	v_xad_u32 v1, v3, 16, 0
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v3, 0, v3
	ds_load_b128 v[61:64], v1
	ds_load_b128 v[57:60], v3
	v_cndmask_b32_e64 v1, 0x1054, v2, s1
	v_cndmask_b32_e64 v0, 0x3276, v0, s1
	v_xor_b32_e32 v3, 16, v131
	v_xor_b32_e32 v2, 32, v131
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v135, 0, v3
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v136, 0, v2
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v157, s90, v170 :: v_dual_mul_f32 v150, s90, v173
	v_mul_f32_e32 v153, s90, v169
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v161, s90, v171 :: v_dual_mul_f32 v156, s90, v65
	v_mul_f32_e32 v160, s90, v66
	v_mad_u64_u32 v[65:66], null, s1, s89, v[0:1]
	v_dual_mul_f32 v158, s90, v67 :: v_dual_mul_f32 v159, s90, v68
	v_dual_mul_f32 v154, s90, v69 :: v_dual_mul_f32 v155, s90, v70
	v_dual_mul_f32 v151, s90, v71 :: v_dual_mul_f32 v152, s90, v72
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v87, s90, v77 :: v_dual_mul_f32 v88, s90, v78
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v77, 0x80000000, v65, s0
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v85, s90, v79 :: v_dual_mul_f32 v86, s90, v80
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[174:181], v[142:149], v[33:40], v[174:181]
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v149, s90, v172
	v_dual_mul_f32 v147, s90, v73 :: v_dual_mul_f32 v148, s90, v74
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v73, 0x80000000, v68, s0
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v145, s90, v75 :: v_dual_mul_f32 v146, s90, v76
	.loc	1 890 30                        ; attention.py:890:30
	s_clause 0x3
	...
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v142, s90, v166 :: v_dual_mul_f32 v143, s90, v167
	v_dual_mul_f32 v164, s90, v178 :: v_dual_add_nc_u32 v167, 0, v127
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 860 21                        ; attention.py:860:21
	v_dual_mul_f32 v83, s90, v174 :: v_dual_mul_f32 v84, s90, v175
	v_dual_mul_f32 v82, s90, v176 :: v_dual_mul_f32 v163, s90, v179
	v_mul_f32_e32 v144, s90, v168
	v_dual_mul_f32 v162, s90, v177 :: v_dual_mul_f32 v165, s90, v180
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt vmcnt(3)
	...
	v_or_b32_e32 v66, s78, v91
	v_or_b32_e32 v67, s78, v92
	.loc	1 882 26                        ; attention.py:882:26
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 182
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 97
