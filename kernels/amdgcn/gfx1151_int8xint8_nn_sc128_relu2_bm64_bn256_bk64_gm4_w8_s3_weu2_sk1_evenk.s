...
.Ltmp0:
	...
	v_lshlrev_b32_e32 v14, 4, v242
	v_and_b32_e32 v3, 48, v14
	v_lshrrev_b32_e32 v2, 4, v242
...
.Ltmp21:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[41:44], v6, s[24:27], 0 offen
	buffer_load_b128 v[45:48], v11, s[24:27], 0 offen
	buffer_load_b128 v[49:52], v2, s[24:27], 0 offen
	buffer_load_b128 v[53:56], v3, s[24:27], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_3:                                ; %Flow94
	...
	v_or_b32_e32 v102, s34, v242
	v_mul_lo_u32 v101, v4, s44
	v_mul_lo_u32 v99, v5, s44
	v_mul_lo_u32 v103, v7, s44
	v_mul_lo_u32 v254, v6, s44
...
.Ltmp22:
	...
	v_dual_mov_b32 v8, s19 :: v_dual_add_nc_u32 v25, v9, v21
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v198, v166, s[28:31], 0 offen
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[166:169], v166, s[24:27], 0 offen
	buffer_load_b128 v[170:173], v170, s[24:27], 0 offen
	buffer_load_b128 v[174:177], v174, s[24:27], 0 offen
	buffer_load_b128 v[178:181], v178, s[24:27], 0 offen
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v215, v188, v10 :: v_dual_lshlrev_b32 v12, 16, v200
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v210, v187, v9 :: v_dual_mul_f32 v227, v192, v10
	v_mul_f32_e32 v199, v184, v9
	v_dual_mul_f32 v200, v185, v9 :: v_dual_mul_f32 v219, v188, v11
	v_mul_f32_e32 v201, v182, v10
	v_mul_f32_e32 v202, v183, v10
	v_mul_f32_e32 v203, v184, v10
	v_dual_mul_f32 v204, v185, v10 :: v_dual_mul_f32 v205, v182, v11
	v_mul_f32_e32 v206, v183, v11
	v_mul_f32_e32 v207, v184, v11
	v_dual_mul_f32 v208, v185, v11 :: v_dual_mul_f32 v221, v190, v9
	v_dual_mul_f32 v182, v182, v12 :: v_dual_mul_f32 v223, v192, v9
	v_mul_f32_e32 v183, v183, v12
	v_dual_mul_f32 v184, v184, v12 :: v_dual_mul_f32 v225, v190, v10
	v_mul_f32_e32 v185, v185, v12
	v_mul_f32_e32 v209, v186, v9
	v_mul_f32_e32 v211, v188, v9
	v_dual_mul_f32 v212, v189, v9 :: v_dual_mul_f32 v229, v190, v11
	v_mul_f32_e32 v213, v186, v10
	v_dual_mul_f32 v214, v187, v10 :: v_dual_mul_f32 v231, v192, v11
	v_mul_f32_e32 v216, v189, v10
	v_mul_f32_e32 v218, v187, v11
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v220, v189, v11 :: v_dual_mul_f32 v233, v194, v9
	...
	v_dual_mul_f32 v226, v191, v10 :: v_dual_mul_f32 v241, v196, v11
	v_mul_f32_e32 v228, v193, v10
	v_dual_mul_f32 v230, v191, v11 :: v_dual_fmac_f32 v67, v198, v28
	v_dual_mul_f32 v232, v193, v11 :: v_dual_fmac_f32 v69, v200, v30
	...
	v_fmac_f32_e32 v71, v210, v32
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v9, v197, v9 :: v_dual_mul_f32 v192, v192, v12
	v_dual_mul_f32 v236, v194, v10 :: v_dual_fmac_f32 v83, v201, v47
	v_dual_mul_f32 v238, v196, v10 :: v_dual_fmac_f32 v75, v222, v40
	v_dual_mul_f32 v10, v197, v10 :: v_dual_fmac_f32 v79, v234, v44
	...
	v_dual_fmac_f32 v68, v199, v29 :: v_dual_fmac_f32 v87, v213, v51
	v_dual_fmac_f32 v70, v209, v31 :: v_dual_fmac_f32 v97, v238, v61
	v_dual_fmac_f32 v72, v211, v37 :: v_dual_fmac_f32 v91, v225, v55
	v_dual_fmac_f32 v74, v221, v39 :: v_dual_fmac_f32 v105, v206, v64
	v_dual_fmac_f32 v76, v223, v41 :: v_dual_fmac_f32 v95, v236, v59
	v_dual_fmac_f32 v78, v233, v43 :: v_dual_fmac_f32 v107, v208, v137
	v_dual_fmac_f32 v80, v235, v45 :: v_dual_fmac_f32 v109, v218, v139
	v_dual_fmac_f32 v81, v9, v46 :: v_dual_fmac_f32 v84, v202, v48
	v_fmac_f32_e32 v111, v220, v141
	v_dual_fmac_f32 v86, v204, v50 :: v_dual_fmac_f32 v113, v230, v143
	v_dual_fmac_f32 v88, v214, v52 :: v_dual_fmac_f32 v115, v232, v145
	v_dual_fmac_f32 v90, v216, v54 :: v_dual_fmac_f32 v119, v11, v149
	v_dual_fmac_f32 v92, v226, v56 :: v_dual_fmac_f32 v117, v240, v147
	v_dual_fmac_f32 v94, v228, v58 :: v_dual_fmac_f32 v121, v183, v151
	v_dual_fmac_f32 v96, v237, v60 :: v_dual_fmac_f32 v125, v187, v155
	...
	v_dual_fmac_f32 v108, v217, v138 :: v_dual_fmac_f32 v131, v192, v160
	v_dual_fmac_f32 v110, v219, v140 :: v_dual_fmac_f32 v133, v194, v162
	v_dual_fmac_f32 v112, v229, v142 :: v_dual_fmac_f32 v135, v196, v164
	v_dual_fmac_f32 v114, v231, v144 :: v_dual_add_nc_u32 v9, s46, v14
	v_fmac_f32_e32 v116, v239, v146
...
.LBB0_9:
	...
	buffer_load_u16 v165, v3, s[8:11], 0 offen
	buffer_load_u16 v185, v4, s[8:11], 0 offen
	buffer_load_u16 v65, v5, s[8:11], 0 offen
...
; %bb.10:
	...
	v_dual_mov_b32 v3, s14 :: v_dual_add_nc_u32 v208, s45, v34
	v_dual_mov_b32 v6, s17 :: v_dual_add_nc_u32 v13, s45, v33
	...
	v_dual_mov_b32 v7, s18 :: v_dual_mov_b32 v178, v228
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.LBB0_11:
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v35, v99, s4, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_cndmask_b32_e32 v33, 0x80000000, v33, vcc_lo
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v36, v254, s4, 1
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v9, 0, v4 :: v_dual_add_nc_u32 v4, s42, v7
	...
	v_permlanex16_b32 v34, v35, s2, 0xfedcba98 op_sel:[1,0]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 120
