...
.Ltmp0:
	...
	v_dual_mov_b32 v145, 0xff800000 :: v_dual_lshlrev_b32 v46, 1, v0
	...
	v_dual_mov_b32 v149, 0xff800000 :: v_dual_lshlrev_b32 v48, 9, v0
	...
	v_dual_mov_b32 v138, v17 :: v_dual_add_nc_u32 v153, 0, v0
	v_xor_b32_e32 v0, 16, v151
	...
	v_dual_mov_b32 v228, 0xff800000 :: v_dual_add_nc_u32 v159, 0, v0
	...
	v_dual_mov_b32 v31, v17 :: v_dual_lshlrev_b32 v76, 3, v64
	...
	v_dual_mov_b32 v227, 0xff800000 :: v_dual_add_nc_u32 v166, 0, v47
	v_xor_b32_e32 v73, 48, v151
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v197, 0x5040504, v45
	...
	v_xor_b32_e32 v107, 0x1b0, v158
	v_xor_b32_e32 v108, 0x240, v158
	v_xor_b32_e32 v109, 0x2d0, v158
	v_xor_b32_e32 v110, 0x360, v158
	v_xor_b32_e32 v111, 0x3f0, v158
	...
	s_mul_i32 s1, s4, s1
	v_dual_mov_b32 v226, 0xff800000 :: v_dual_add_nc_u32 v161, 0, v73
	v_dual_mov_b32 v135, v17 :: v_dual_add_nc_u32 v162, 0, v74
	...
	v_xor_b32_e32 v48, 0x90, v158
	v_xor_b32_e32 v54, 0x120, v158
	...
	v_add_nc_u32_e32 v216, v46, v112
	scratch_store_b32 off, v0, off offset:48 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v0, 0, v56
	v_add_nc_u32_e32 v217, 0, v48
	v_add_nc_u32_e32 v218, 0, v54
	v_dual_mov_b32 v11, v17 :: v_dual_and_b32 v224, 0x7060706, v42
	...
	v_dual_mov_b32 v137, v17 :: v_dual_add_nc_u32 v164, 0, v76
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v100, s98, v134, 1
	.loc	1 881 25                        ; attention.py:881:25
...
.Ltmp4:
	...
	v_permlanex16_b32 v168, v167, s97, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
.Ltmp5:
	...
	v_permlanex16_b32 v167, v66, s97, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v167, v68, s97, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	v_permlanex16_b32 v167, v70, s97, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v167, v72, s97, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 256
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 112
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 1
