...
.Ltmp12:
	...
	s_add_i32 s27, s7, 0x7f
.Ltmp13:
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
	s_xor_b32 s25, s4, s19
...
.Ltmp21:
	...
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	v_cmp_gt_i32_e64 s4, s7, v14
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	s_clause 0x1
	buffer_load_b128 v[17:20], v10, s[20:23], 0 offen
	...
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_dual_cndmask_b32 v8, 0x80000000, v8 :: v_dual_and_b32 v13, 48, v10
...
.LBB0_3:                                ; %Flow21
	...
	v_or_b32_e32 v18, s6, v3
	s_ashr_i32 s0, s27, 7
	v_or_b32_e32 v26, s33, v7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v45, v27, s18, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s18, s18, s35
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v46, v25, s18, 1
	v_add_lshl_u32 v47, v24, s18, 1
	v_add_lshl_u32 v48, v22, s18, 1
	v_add_lshl_u32 v49, v20, s18, 1
	v_add_lshl_u32 v50, v23, s18, 1
	v_cndmask_b32_e32 v46, 0x80000000, v46, vcc_lo
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v91, v43, s[8:11], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v43, v26, s18, 1
	v_add_lshl_u32 v51, v21, s18, 1
	v_add_lshl_u32 v52, v19, s18, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v92, v45, s[24:27], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v93, v43, s[28:31], 0 offen
	...
	buffer_load_u16 v100, v52, s[28:31], 0 offen
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	...
	s_clause 0x1
	buffer_load_b128 v[51:54], v43, s[20:23], 0 offen
	buffer_load_b128 v[55:58], v44, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v43, s18, v28
	v_add_nc_u32_e32 v44, s18, v31
	v_add_nc_u32_e32 v45, s18, v29
	v_add_nc_u32_e32 v46, s18, v30
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	v_add_nc_u32_e32 v49, s1, v32
	v_add_nc_u32_e32 v50, s1, v34
...
; %bb.9:
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v38, 0 :: v_dual_add_nc_u32 v7, s15, v31
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v2, s14, v35
	v_add_nc_u32_e32 v6, s14, v33
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v8, s15, v28
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v45, v38 :: v_dual_add_nc_u32 v36, s14, v34
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v40, v38 :: v_dual_add_nc_u32 v7, s15, v30
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_10:
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v43, v23, s7, 1
	v_add_lshl_u32 v42, v20, s7, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_add_lshl_u32 v41, v22, s7, 1
	v_add_lshl_u32 v44, v21, s7, 1
...
.LBB0_12:
	...
	v_add_lshl_u32 v13, v37, s8, 2
	v_add_lshl_u32 v14, v37, s9, 2
	s_waitcnt lgkmcnt(7)
