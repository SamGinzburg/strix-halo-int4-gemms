...
.Ltmp19:
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v1, s13, v73
	v_add_nc_u32_e32 v3, s13, v175
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_or_b32_e32 v245, 0x1b00, v49
	scratch_store_b32 off, v0, off offset:24 ; 4-byte Folded Spill
	v_or_b32_e32 v0, 0x380, v49
	v_or_b32_e32 v243, 0x1b80, v49
...
; %bb.4:                                ; %.lr.ph
	...
	v_or_b32_e32 v245, 0x1b00, v176
	scratch_store_b32 off, v0, off offset:12 ; 4-byte Folded Spill
	v_or_b32_e32 v0, 0x300, v176
	v_or_b32_e32 v243, 0x1b80, v176
	...
	v_or_b32_e32 v215, 0x1f80, v176
	v_or_b32_e32 v216, 0xc0, v176
	v_or_b32_e32 v217, 0x140, v176
	scratch_store_b32 off, v0, off          ; 4-byte Folded Spill
	v_or_b32_e32 v0, 0x400, v176
	v_or_b32_e32 v233, 0x1c0, v176
	v_or_b32_e32 v214, 0x240, v176
	v_or_b32_e32 v235, 0x2c0, v176
	v_or_b32_e32 v255, 0x5c0, v176
	scratch_store_b32 off, v0, off offset:28 ; 4-byte Folded Spill
	v_or_b32_e32 v0, 0x480, v176
	v_or_b32_e32 v239, 0x8c0, v176
	v_or_b32_e32 v247, 0x9c0, v176
	v_or_b32_e32 v251, 0xa40, v176
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v120, v214 :: v_dual_add_nc_u32 v1, s49, v220
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_mov_b32_e32 v44, 0
	v_dual_mov_b32 v122, v255 :: v_dual_mov_b32 v43, 0
	...
	v_dual_mov_b32 v227, v244 :: v_dual_mov_b32 v206, v249
	scratch_store_b32 off, v0, off offset:312 ; 4-byte Folded Spill
	v_mov_b32_e32 v0, 0
	v_mov_b32_e32 v226, v253
	v_mov_b32_e32 v200, v248
	v_dual_mov_b32 v202, v254 :: v_dual_mov_b32 v199, v232
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	scratch_load_b32 v214, off, off offset:404
	...
	scratch_load_b32 v255, off, off offset:384
	scratch_load_b32 v248, off, off offset:388
	scratch_load_b32 v254, off, off offset:392
	scratch_load_b32 v232, off, off offset:396
	v_dual_mov_b32 v196, 0 :: v_dual_mov_b32 v191, v245
	scratch_store_b32 off, v0, off offset:308 ; 4-byte Folded Spill
	v_mov_b32_e32 v0, 0
	v_mov_b32_e32 v204, v243
	v_dual_mov_b32 v231, v239 :: v_dual_mov_b32 v228, v234
	...
	v_dual_mov_b32 v34, 0 :: v_dual_mov_b32 v205, v250
	scratch_store_b32 off, v0, off offset:336 ; 4-byte Folded Spill
	v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v229, v247
	scratch_load_b32 v250, off, off offset:400 ; 4-byte Folded Reload
...
; %bb.9:
	...
	s_mov_b32 s19, s12
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v33, s27, v255
	v_add_nc_u32_e32 v34, s27, v248
	v_add_nc_u32_e32 v36, s27, v253
	v_add_nc_u32_e32 v35, s27, v249
...
; %bb.11:
	...
	scratch_load_b32 v36, off, off offset:20
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	...
	scratch_load_b32 v29, off, off offset:140
...
; %bb.13:
	...
	s_mov_b32 s19, s12
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v1, s45, v255
	v_add_nc_u32_e32 v2, s45, v248
	v_add_nc_u32_e32 v4, s45, v253
	v_add_nc_u32_e32 v3, s45, v249
...
; %bb.15:
	...
	v_dual_mov_b32 v210, v182 :: v_dual_add_nc_u32 v193, s44, v215
	v_add_nc_u32_e32 v182, s44, v205
	v_dual_mov_b32 v24, v176 :: v_dual_add_nc_u32 v181, s44, v214
	v_add_nc_u32_e32 v5, s44, v203
	...
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v205, off, off offset:128
	...
	v_add_nc_u32_e32 v180, s44, v249
	v_add_nc_u32_e32 v249, s44, v246
	v_add_nc_u32_e32 v246, s44, v236
	v_dual_mov_b32 v236, v196 :: v_dual_add_nc_u32 v179, s44, v252
	...
	scratch_store_b32 off, v178, off offset:176 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v178, s44, v255
	v_add_nc_u32_e32 v255, s44, v235
	v_dual_mov_b32 v235, v194 :: v_dual_add_nc_u32 v194, s44, v204
	scratch_load_b32 v204, off, off offset:136 ; 4-byte Folded Reload
	v_add_nc_u32_e32 v59, s44, v1
	scratch_load_b32 v1, off, off offset:48 ; 4-byte Folded Reload
	v_add_nc_u32_e32 v175, s44, v253
	v_add_nc_u32_e32 v253, s44, v217
	v_add_nc_u32_e32 v217, s44, v205
	s_waitcnt vmcnt(2)
	v_dual_mov_b32 v205, v218 :: v_dual_add_nc_u32 v68, s44, v0
	scratch_load_b32 v0, off, off offset:172 ; 4-byte Folded Reload
	s_waitcnt vmcnt(2)
	v_add_nc_u32_e32 v218, s44, v204
	s_waitcnt vmcnt(1)
	...
	v_dual_mov_b32 v218, v205 :: v_dual_mov_b32 v219, v206
	...
	v_perm_b32 v183, v72, v183, 0xc0c0004
	s_waitcnt lgkmcnt(14)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 872
