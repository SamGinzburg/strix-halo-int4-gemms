	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v68, s27, 5, v53
	v_mad_u64_u32 v[54:55], null, s27, 48, v[53:54]
...
.Ltmp21:
	...
	s_cmp_gt_i32 s17, 63
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v4, s30, v63
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s3, -1, 0
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v6, s30, v66
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v21, s48, v64
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v5, s7, v70
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v22, s48, v63
	v_or_b32_e32 v23, s48, v65
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	buffer_load_b128 v[29:32], v30, s[36:39], 0 offen
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s30, s48
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s48, s14, s5
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v76, s1, v85
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v11, s48, v64
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[9:10], null, s48, s26, v[55:56]
	s_mov_b32 s4, s16
	...
	v_wmma_i32_16x16x16_iu8 v[25:32], v[37:40], v[33:36], v[25:32] neg_lo:[1,1,0]
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v38, s48, v65
	v_or_b32_e32 v37, s48, v63
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[122:129], v[41:44], v[33:36], v[122:129] neg_lo:[1,1,0]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v35, s4, v70
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v39, s48, v66
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e64 s0, s31, v38
	v_cmp_gt_i32_e32 vcc_lo, s31, v37
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v33, s48, v67
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
.LBB0_12:
	...
	s_mov_b32 s26, s14
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	buffer_load_u16 v53, v2, s[28:31], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v2, v119, s0, 1
	s_mov_b32 s0, 0x76543210
	s_delay_alu instid0(VALU_DEP_1)
	v_cndmask_b32_e32 v2, 0x80000000, v2, vcc_lo
	s_clause 0x1
	buffer_load_u16 v54, v1, s[12:15], 0 offen
	buffer_load_u16 v55, v2, s[12:15], 0 offen
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v1.l, 0
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_mov_b16_e64 v1.h, v157.l
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_mul_lo_u32 v2, s27, v85
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_permlanex16_b32 v16, v11, s0, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v15, v18, s0, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_b32_e32 v18, 0x5040504, v4
	v_permlanex16_b32 v17, v9, s0, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v24, v6, s0, 0xfedcba98 op_sel:[1,0]
	...
	buffer_store_b128 v[8:11], v0, s[24:27], 0 offen offset:256
	buffer_store_b128 v[12:15], v1, s[24:27], 0 offen
	buffer_store_b128 v[16:19], v1, s[24:27], 0 offen offset:256
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 230
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
