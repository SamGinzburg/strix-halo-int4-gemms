	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s19, v33, v[1:2]
...
.Ltmp21:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v11, s24, v2
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v9, s5, v5
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v12, s24, v33
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[13:16], v8, s[20:23], 0 offen
	buffer_load_b128 v[17:20], v9, s[20:23], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_cndmask_b32_e32 v6, 0x80000000, v7, vcc_lo
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s4, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v29, v10, s[8:11], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(3)
	ds_store_b32 v37, v29 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v37, v30 offset:17408
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v36, v[21:24] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v36, v[25:28] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_3:                                ; %Flow79
	...
	v_or_b32_e32 v17, s26, v31
	s_ashr_i32 s0, s27, 7
	v_or_b32_e32 v25, s18, v5
	v_or_b32_e32 v24, s18, v9
	v_or_b32_e32 v23, s18, v10
	v_mul_lo_u32 v26, v17, s0
	v_or_b32_e32 v21, s18, v11
	v_or_b32_e32 v19, s18, v12
	v_or_b32_e32 v22, s18, v6
	v_or_b32_e32 v20, s18, v7
	v_or_b32_e32 v18, s18, v8
...
; %bb.4:                                ; %.lr.ph
	...
	v_or_b32_e32 v39, 0x80, v2
	v_dual_mov_b32 v15, 0 :: v_dual_mov_b32 v10, 0
	v_lshl_or_b32 v27, v31, 6, v4
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v4, 0xa0, v5
...
.Ltmp23:
	...
	s_add_i32 s15, s1, -2
	v_subrev_nc_u32_e32 v37, s14, v1
	v_mov_b32_e32 v1, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_ashr_i32 s7, s7, 31
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_add_nc_u32_e32 v40, s37, v39
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_lshr_b32 s7, s7, 25
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v42, s37, v38
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_add_i32 s7, s37, s7
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_add_nc_u32_e32 v41, s37, v33
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	...
	v_add_lshl_u32 v42, v26, s7, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s7, s7, s19
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v43, v24, s7, 1
	v_add_lshl_u32 v44, v23, s7, 1
	v_add_lshl_u32 v45, v21, s7, 1
	v_add_lshl_u32 v46, v19, s7, 1
	v_add_lshl_u32 v47, v22, s7, 1
	v_cndmask_b32_e32 v43, 0x80000000, v43, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v88, v40, s[8:11], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v40, v25, s7, 1
	v_add_lshl_u32 v48, v20, s7, 1
	v_add_lshl_u32 v49, v18, s7, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_dual_cndmask_b32 v42, 0x80000000, v42 :: v_dual_cndmask_b32 v45, 0x80000000, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v40, 0x80000000, v40 :: v_dual_cndmask_b32 v47, 0x80000000, v47
	v_dual_cndmask_b32 v44, 0x80000000, v44 :: v_dual_cndmask_b32 v49, 0x80000000, v49
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v89, v42, s[24:27], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	buffer_load_u16 v90, v40, s[28:31], 0 offen
	buffer_load_u16 v91, v43, s[28:31], 0 offen
	...
	ds_load_u8 v72, v44 offset:1024
	ds_load_u8 v73, v44 offset:640
	ds_load_u8 v74, v44 offset:896
	ds_load_u8 v75, v44 offset:768
	ds_load_u8 v76, v44 offset:512
	ds_load_u8 v77, v44 offset:128
	ds_load_u8 v78, v44 offset:384
	ds_load_u8 v79, v44 offset:256
	ds_load_u8 v80, v44
	ds_load_u8 v81, v44 offset:3712
	ds_load_u8 v82, v44 offset:3968
	ds_load_u8 v83, v44 offset:3840
	ds_load_u8 v84, v44 offset:3584
	ds_load_u8 v85, v44 offset:3200
	ds_load_u8 v86, v44 offset:3456
	ds_load_u8 v87, v44 offset:3328
	ds_load_u8 v98, v44 offset:3072
	ds_load_u8 v99, v44 offset:2688
	ds_load_u8 v100, v44 offset:2944
	ds_load_u8 v101, v44 offset:2816
	ds_load_u8 v102, v44 offset:2560
	ds_load_u8 v103, v44 offset:2176
	ds_load_u8 v104, v44 offset:2432
	ds_load_u8 v105, v44 offset:2304
	ds_load_u8 v106, v44 offset:2048
	ds_load_u8 v107, v44 offset:5760
	ds_load_u8 v108, v44 offset:6016
	ds_load_u8 v109, v44 offset:5888
	ds_load_u8 v110, v44 offset:5632
	ds_load_u8 v111, v44 offset:5248
	ds_load_u8 v112, v44 offset:5504
	ds_load_u8 v113, v44 offset:5376
	ds_load_u8 v114, v44 offset:5120
	ds_load_u8 v115, v44 offset:4736
	ds_load_u8 v116, v44 offset:4992
	ds_load_u8 v117, v44 offset:4864
	ds_load_u8 v118, v44 offset:4608
	ds_load_u8 v119, v44 offset:4224
	ds_load_u8 v120, v44 offset:4480
	ds_load_u8 v121, v44 offset:4352
	ds_load_u8 v122, v44 offset:4096
	ds_load_u8 v123, v44 offset:7808
	ds_load_u8 v124, v44 offset:8064
	ds_load_u8 v125, v44 offset:7936
	ds_load_u8 v126, v44 offset:7680
	ds_load_u8 v127, v44 offset:7296
	ds_load_u8 v128, v44 offset:7552
	ds_load_u8 v129, v44 offset:7424
	ds_load_u8 v130, v44 offset:7168
	ds_load_u8 v131, v44 offset:6784
	ds_load_u8 v132, v44 offset:7040
	ds_load_u8 v133, v44 offset:6912
	ds_load_u8 v134, v44 offset:6656
	ds_load_u8 v135, v44 offset:6272
	ds_load_u8 v136, v44 offset:6528
	ds_load_u8 v137, v44 offset:6400
	ds_load_u8 v44, v44 offset:6144
	s_waitcnt lgkmcnt(60)
	v_perm_b32 v40, v43, v40, 0xc0c0004
	v_perm_b32 v41, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(56)
	v_perm_b32 v42, v72, v45, 0xc0c0004
	v_perm_b32 v43, v47, v46, 0xc0c0004
	s_waitcnt lgkmcnt(52)
	v_perm_b32 v45, v76, v73, 0xc0c0004
	v_perm_b32 v46, v75, v74, 0xc0c0004
	s_waitcnt lgkmcnt(48)
	v_perm_b32 v47, v80, v77, 0xc0c0004
	v_perm_b32 v72, v79, v78, 0xc0c0004
	s_waitcnt lgkmcnt(44)
	v_perm_b32 v76, v84, v81, 0xc0c0004
	v_perm_b32 v77, v83, v82, 0xc0c0004
	s_waitcnt lgkmcnt(40)
	v_perm_b32 v78, v98, v85, 0xc0c0004
	v_perm_b32 v80, v87, v86, 0xc0c0004
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v81, v102, v99, 0xc0c0004
	v_perm_b32 v82, v101, v100, 0xc0c0004
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v83, v106, v103, 0xc0c0004
	v_perm_b32 v84, v105, v104, 0xc0c0004
	s_waitcnt lgkmcnt(29)
	v_perm_b32 v86, v109, v108, 0xc0c0004
	v_lshl_or_b32 v75, v41, 16, v40
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v109, v137, v136, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v44, v135, 0xc0c0004
	v_lshl_or_b32 v74, v43, 16, v42
	v_lshl_or_b32 v73, v46, 16, v45
	v_lshl_or_b32 v72, v72, 16, v47
	v_perm_b32 v85, v110, v107, 0xc0c0004
	v_perm_b32 v87, v114, v111, 0xc0c0004
	v_perm_b32 v98, v113, v112, 0xc0c0004
	v_perm_b32 v99, v118, v115, 0xc0c0004
	v_perm_b32 v100, v117, v116, 0xc0c0004
	v_perm_b32 v101, v122, v119, 0xc0c0004
	v_perm_b32 v102, v121, v120, 0xc0c0004
	v_lshl_or_b32 v79, v77, 16, v76
	v_lshl_or_b32 v78, v80, 16, v78
	v_lshl_or_b32 v77, v82, 16, v81
	v_lshl_or_b32 v76, v84, 16, v83
	v_lshl_or_b32 v84, v109, 16, v44
	v_wmma_i32_16x16x16_iu8 v[40:47], v[72:75], v[56:59], v[1:8] neg_lo:[1,1,0]
	v_perm_b32 v103, v126, v123, 0xc0c0004
	v_perm_b32 v104, v125, v124, 0xc0c0004
	v_perm_b32 v105, v130, v127, 0xc0c0004
	v_perm_b32 v106, v129, v128, 0xc0c0004
	v_perm_b32 v107, v134, v131, 0xc0c0004
	v_perm_b32 v108, v133, v132, 0xc0c0004
	v_lshl_or_b32 v83, v86, 16, v85
	v_lshl_or_b32 v82, v98, 16, v87
	v_lshl_or_b32 v81, v100, 16, v99
	v_lshl_or_b32 v80, v102, 16, v101
	...
	v_lshl_or_b32 v85, v108, 16, v107
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v60, v56, v60 :: v_dual_lshlrev_b32 v61, 16, v94
	v_dual_mul_f32 v62, v56, v62 :: v_dual_lshlrev_b32 v63, 16, v96
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v12, v62, v45
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v56, v56, v63 :: v_dual_add_nc_u32 v37, s35, v37
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_add_nc_u32_e32 v36, s35, v36
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v61, v44 :: v_dual_add_nc_u32 v138, s38, v35
	v_dual_fmac_f32 v16, v58, v41 :: v_dual_add_nc_u32 v139, s33, v32
	v_fmac_f32_e32 v9, v57, v40
	v_fmac_f32_e32 v15, v59, v42
	v_fmac_f32_e32 v11, v56, v46
	v_fmac_f32_e32 v10, v64, v47
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_store_b32 v138, v88 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v139, v[48:51]
	s_waitcnt vmcnt(0)
	ds_store_b128 v139, v[52:55] offset:4096
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.9:
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s14, v30
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s14, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v33, v37, v34, 0xc0c0004
	v_perm_b32 v34, v36, v35, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v45, s14, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v36, v53, v39, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v35, v54, v38, 0xc0c0004
	...
	v_lshl_or_b32 v56, v31, 16, v8
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v8, v61, v57, 0xc0c0004
	v_perm_b32 v31, v60, v59, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v57, v65, v62, 0xc0c0004
	v_lshl_or_b32 v53, v38, 16, v37
	...
	v_wmma_i32_16x16x16_iu8 v[32:39], v[53:56], v[49:52], v[32:39] neg_lo:[1,1,0]
	v_lshl_or_b32 v52, v31, 16, v8
	v_lshl_or_b32 v51, v58, 16, v57
	v_lshl_or_b32 v50, v60, 16, v59
	v_lshl_or_b32 v49, v62, 16, v61
	ds_load_u8 v8, v7 offset:5760
	ds_load_u8 v31, v7 offset:6016
	ds_load_u8 v53, v7 offset:5888
	ds_load_u8 v54, v7 offset:5632
	...
	v_perm_b32 v31, v53, v31, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[32:39], v[49:52], v[45:48], v[32:39] neg_lo:[1,1,0]
	v_lshl_or_b32 v48, v31, 16, v8
	v_lshl_or_b32 v47, v54, 16, v53
	v_lshl_or_b32 v46, v56, 16, v55
	v_lshl_or_b32 v45, v58, 16, v57
	s_waitcnt lgkmcnt(12)
	...
	v_wmma_i32_16x16x16_iu8 v[32:39], v[45:48], v[41:44], v[32:39] neg_lo:[1,1,0]
	v_lshl_or_b32 v44, v31, 16, v8
	v_lshl_or_b32 v43, v50, 16, v49
	v_lshl_or_b32 v42, v52, 16, v51
	v_lshl_or_b32 v41, v53, 16, v7
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[32:39], v[41:44], v[3:6], v[32:39] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v34, v25, s8, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s3, s7
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v35, v24, s8, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v33, 0x80000000, v33, vcc_lo
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v36, v23, s8, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_and_b32 s13, s13, 0xffff
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v38, v22, s8, 1
	v_add_lshl_u32 v37, v19, s8, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v39, v33, s[12:15], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v33, 0x80000000, v34 :: v_dual_cndmask_b32 v34, 0x80000000, v35
	v_dual_cndmask_b32 v35, 0x80000000, v36 :: v_dual_cndmask_b32 v44, 0x80000000, v38
	v_add_lshl_u32 v36, v21, s8, 1
	v_add_lshl_u32 v41, v20, s8, 1
	v_add_lshl_u32 v42, v18, s8, 1
	s_and_b32 s5, s5, 0xffff
	s_mov_b32 s7, s15
	v_dual_cndmask_b32 v36, 0x80000000, v36 :: v_dual_cndmask_b32 v43, 0x80000000, v37
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_cndmask_b32 v46, 0x80000000, v42 :: v_dual_cndmask_b32 v45, 0x80000000, v41
	s_clause 0x7
	buffer_load_u16 v41, v33, s[4:7], 0 offen
	buffer_load_u16 v42, v34, s[4:7], 0 offen
	buffer_load_u16 v37, v35, s[4:7], 0 offen
	buffer_load_u16 v38, v36, s[4:7], 0 offen
	buffer_load_u16 v35, v43, s[4:7], 0 offen
	buffer_load_u16 v36, v44, s[4:7], 0 offen
	buffer_load_u16 v33, v45, s[4:7], 0 offen
	buffer_load_u16 v34, v46, s[4:7], 0 offen
...
; %bb.11:
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v2, s33, v40
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v40, v2 offset:1664
	...
	ds_load_u8 v50, v2 offset:640
	ds_load_u8 v51, v2 offset:896
	ds_load_u8 v52, v2 offset:768
	...
	v_dual_mov_b32 v45, 0 :: v_dual_add_nc_u32 v30, s1, v30
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v53, s1, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v44, v49, v46, 0xc0c0004
	v_perm_b32 v46, v48, v47, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v57, s1, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v48, v52, v51, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v47, v65, v50, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v61, s1, v27
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v70, v2 offset:3712
	ds_load_u8 v71, v2 offset:3968
	ds_load_u8 v72, v2 offset:3840
	ds_load_u8 v73, v2 offset:3584
	ds_load_u8 v74, v2 offset:3200
	ds_load_u8 v75, v2 offset:3456
	ds_load_u8 v76, v2 offset:3328
	ds_load_u8 v77, v2 offset:3072
	ds_load_u8 v78, v2 offset:2688
	ds_load_u8 v79, v2 offset:2944
	ds_load_u8 v80, v2 offset:2816
	ds_load_u8 v81, v2 offset:2560
	ds_load_u8 v82, v2 offset:2176
	ds_load_u8 v83, v2 offset:2432
	ds_load_u8 v84, v2 offset:2304
	ds_load_u8 v85, v2 offset:2048
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v49, v68, v66, 0xc0c0004
	v_lshl_or_b32 v68, v43, 16, v40
	...
	v_perm_b32 v43, v72, v71, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v71, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v70, v81, v78, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v73, v84, v83, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v72, v85, v82, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v50, v67, v69, 0xc0c0004
	v_lshl_or_b32 v67, v46, 16, v44
	v_mov_b32_e32 v46, v45
	v_perm_b32 v44, v77, v74, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[45:52], v[65:68], v[61:64], v[45:52] neg_lo:[1,1,0]
	v_lshl_or_b32 v64, v43, 16, v40
	v_lshl_or_b32 v63, v69, 16, v44
	v_lshl_or_b32 v62, v71, 16, v70
	v_lshl_or_b32 v61, v73, 16, v72
	ds_load_u8 v40, v2 offset:5760
	ds_load_u8 v43, v2 offset:6016
	ds_load_u8 v44, v2 offset:5888
	...
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v40, v65, v40, 0xc0c0004
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	...
	v_perm_b32 v69, v76, v75, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[45:52], v[61:64], v[57:60], v[45:52] neg_lo:[1,1,0]
	v_lshl_or_b32 v60, v43, 16, v40
	v_lshl_or_b32 v59, v65, 16, v44
	v_lshl_or_b32 v58, v67, 16, v66
	v_lshl_or_b32 v57, v69, 16, v68
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v40, v81, v78, 0xc0c0004
	v_perm_b32 v43, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v44, v85, v82, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[45:52], v[57:60], v[53:56], v[45:52] neg_lo:[1,1,0]
	v_lshl_or_b32 v56, v43, 16, v40
	v_lshl_or_b32 v55, v61, 16, v44
	v_lshl_or_b32 v54, v63, 16, v62
	v_lshl_or_b32 v53, v64, 16, v2
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[45:52], v[53:56], v[27:30], v[45:52] neg_lo:[1,1,0]
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v4, v33, v4, v15
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v34, v27, v34
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_mov_b16_e32 v28.h, v42.l
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v3, v35, v3, v13
	v_fma_f32 v28, v28, v32, v16
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v19, 16, v19
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v15, v11, v15 :: v_dual_lshlrev_b32 v20, 16, v20
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_cndmask_b32_e64 v7, v9, v12, s2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v13, v14, v48, v8
	v_fma_f32 v14, v15, v45, v4
	v_fma_f32 v15, v16, v46, v5
	v_fma_f32 v16, v19, v43, v3
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_cndmask_b32 v11, 0x3276, v39 :: v_dual_and_b32 v14, 1, v42
	...
	v_cndmask_b32_e32 v10, 0x1054, v38, vcc_lo
	v_cndmask_b16 v8.l, 0x7fff, v4.h, s2
	...
	v_perm_b32 v1, v2, v5, v4
	v_perm_b32 v2, v6, v7, v3
	v_perm_b32 v3, v6, v7, v4
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 140
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
