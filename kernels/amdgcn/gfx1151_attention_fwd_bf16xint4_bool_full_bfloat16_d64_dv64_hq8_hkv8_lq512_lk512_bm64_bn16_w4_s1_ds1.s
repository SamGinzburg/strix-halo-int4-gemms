	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v23, v33 :: v_dual_add_nc_u32 v94, 0, v47
	v_dual_mov_b32 v10, v33 :: v_dual_lshlrev_b32 v45, 6, v45
	v_dual_mov_b32 v11, v33 :: v_dual_and_b32 v16, 0x750031, v16
	v_lshl_or_b32 v89, s3, 8, v50
	v_and_b32_e32 v50, 0x700, v52
	v_lshrrev_b32_e32 v49, 2, v49
	v_and_b32_e32 v52, 0x160, v53
	...
	v_and_or_b32 v92, v48, 60, v45
	v_xor_b32_e32 v44, v46, v49
	v_add_nc_u32_e32 v45, 0, v50
	v_and_or_b32 v93, 0x90, v54, v52
	.loc	1 599 26 is_stmt 1              ; attention.py:599:26
	v_lshl_or_b32 v46, v86, 6, v90
	v_and_b32_e32 v43, 0x540054, v43
	v_lshl_or_b32 v16, v16, 4, v16
	v_and_b32_e32 v42, 0x760076, v42
	v_mul_lo_u32 v53, s9, v55
	v_dual_mov_b32 v12, v33 :: v_dual_lshlrev_b32 v91, 2, v51
	v_dual_mov_b32 v13, v33 :: v_dual_add_nc_u32 v54, 0, v46
	v_xor_b32_e32 v47, 16, v90
	v_xor_b32_e32 v48, 32, v90
	v_xor_b32_e32 v49, 48, v90
	v_xor_b32_e32 v50, 64, v90
	v_xor_b32_e32 v51, 0x50, v90
	v_xor_b32_e32 v52, 0x60, v90
	v_dual_mov_b32 v112, 0xff800000 :: v_dual_add_nc_u32 v95, v45, v44
	v_xor_b32_e32 v44, 0x70, v90
	v_xor_b32_e32 v45, 16, v93
	...
	s_waitcnt vmcnt(2)
	ds_store_b128 v94, v[5:8] offset:2048
	s_waitcnt vmcnt(1)
	ds_store_b128 v94, v[34:37] offset:4096
	s_waitcnt vmcnt(0)
	ds_store_b128 v94, v[38:41] offset:6144
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v7, v33 :: v_dual_and_b32 v84, 0x7060706, v42
...
.Ltmp8:
	.loc	1 764 26                        ; attention.py:764:26
	ds_bpermute_b32 v126, v92, v126
	ds_bpermute_b32 v127, v108, v127
	ds_bpermute_b32 v130, v92, v131
...
.Ltmp36:
	...
	.loc	1 814 30                        ; attention.py:814:30
	ds_store_2addr_b32 v95, v74, v73 offset1:8
	ds_store_2addr_b32 v95, v34, v38 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_add_i32 s4, s33, 16
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v142, v39, s34, 0xfedcba98 op_sel:[1,0]
...
.Ltmp37:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 147
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
