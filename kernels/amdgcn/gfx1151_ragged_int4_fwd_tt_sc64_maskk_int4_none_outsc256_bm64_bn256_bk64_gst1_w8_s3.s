...
.Ltmp0:
	...
	v_dual_mov_b32 v38, 0 :: v_dual_and_b32 v3, 63, v0
.Ltmp1:
...
.LBB0_3:                                ; %Flow469
	...
	v_dual_mov_b32 v42, 0 :: v_dual_and_b32 v103, 15, v0
	v_dual_mov_b32 v43, 0 :: v_dual_and_b32 v104, 0xf0, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v89, 0 :: v_dual_add_nc_u32 v2, s34, v103
	...
	s_lshl_b32 s3, s41, 8
	.loc	1 1044 18                       ; ragged.py:1044:18
	v_dual_mov_b32 v86, 0 :: v_dual_add_nc_u32 v5, 32, v2
	v_mov_b32_e32 v88, 0
	...
	v_dual_mov_b32 v71, 0 :: v_dual_lshlrev_b32 v38, 1, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_lo_u32 v3, v3, s40
	v_mul_lo_u32 v2, v2, s40
	v_dual_mov_b32 v72, 0 :: v_dual_and_b32 v39, 0x7f, v0
	v_dual_mov_b32 v70, 0 :: v_dual_and_b32 v35, 0x88, v35
	v_dual_mov_b32 v61, 0 :: v_dual_lshlrev_b32 v40, 5, v103
	.loc	1 1045 18                       ; ragged.py:1045:18
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v3, off offset:4
	scratch_store_b32 off, v2, off offset:12
	v_dual_mov_b32 v77, 0 :: v_dual_and_b32 v2, 0xe0, v0
	...
	v_lshlrev_b32_e32 v48, 2, v104
	v_dual_mov_b32 v54, 0 :: v_dual_lshlrev_b32 v49, 1, v104
	v_dual_mov_b32 v81, 0 :: v_dual_add_nc_u32 v112, 0, v41
	v_dual_mov_b32 v41, 0 :: v_dual_and_b32 v2, 32, v2
	.loc	1 1046 20                       ; ragged.py:1046:20
	s_and_b32 s0, s0, s4
	...
	v_dual_mov_b32 v64, 0 :: v_dual_add_nc_u32 v115, 0, v39
	v_dual_mov_b32 v101, 0 :: v_dual_add_nc_u32 v120, 0, v49
	v_mov_b32_e32 v39, 0
	v_mov_b32_e32 v49, 0
	...
	v_add_nc_u32_e32 v106, 0, v103
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v108, 0, v0
	v_add_nc_u32_e32 v109, 0, v42
	v_dual_mov_b32 v63, 0 :: v_dual_add_nc_u32 v110, 0, v43
	scratch_store_b64 off, v[2:3], off offset:28 ; 8-byte Folded Spill
	v_mad_u64_u32 v[2:3], null, v5, s43, s[6:7]
	v_add_nc_u32_e32 v111, 0, v40
	v_add_nc_u32_e32 v113, 0, v35
	v_dual_mov_b32 v79, 0 :: v_dual_add_nc_u32 v114, 0, v44
	v_dual_mov_b32 v97, 0 :: v_dual_add_nc_u32 v116, 0, v45
	scratch_store_b64 off, v[2:3], off offset:36 ; 8-byte Folded Spill
	v_mad_u64_u32 v[2:3], null, v6, s43, s[6:7]
	v_dual_mov_b32 v62, 0 :: v_dual_add_nc_u32 v117, 0, v46
	v_dual_mov_b32 v95, 0 :: v_dual_add_nc_u32 v118, 0, v47
	...
	v_mov_b32_e32 v47, 0
	v_dual_mov_b32 v80, 0 :: v_dual_add_nc_u32 v119, v48, v38
	v_mov_b32_e32 v48, 0
	v_mov_b32_e32 v46, 0
	...
	v_mad_u64_u32 v[8:9], null, v9, s43, s[6:7]
	v_mad_u64_u32 v[9:10], null, v10, s43, s[6:7]
	v_mad_u64_u32 v[10:11], null, v11, s43, s[6:7]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s30, s22
	v_or_b32_e32 v121, s14, v34
	s_mov_b32 s31, s23
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_mov_b32 s15, s23
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_mad_u64_u32 v[34:35], null, v121, s44, v[1:2]
	v_cmp_gt_i32_e64 s3, s43, v121
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v122, 0x80000000, v34, s3
	v_or_b32_e32 v34, 4, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v123, 0x80000000, v34, s3
	v_or_b32_e32 v34, 8, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v124, 0x80000000, v34, s3
	v_or_b32_e32 v34, 12, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v125, 0x80000000, v34, s3
	v_or_b32_e32 v34, 16, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v126, 0x80000000, v34, s3
	v_or_b32_e32 v34, 20, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v128, 0x80000000, v34, s3
	v_or_b32_e32 v34, 24, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	s_and_b32 s3, s42, s3
	v_cndmask_b32_e64 v130, 0x80000000, v34, s3
	v_or_b32_e32 v34, 28, v121
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_cmp_gt_i32_e64 s3, s43, v34
	v_mad_u64_u32 v[34:35], null, v34, s44, v[1:2]
	...
	v_add_nc_u32_e32 v134, v8, v35
	v_add_nc_u32_e32 v135, v9, v35
	v_add_nc_u32_e32 v136, v10, v35
	v_add_nc_u32_e32 v137, v11, v35
	v_add_nc_u32_e32 v138, v12, v35
	v_add_nc_u32_e32 v139, v13, v35
	v_add_nc_u32_e32 v140, v14, v35
	v_add_nc_u32_e32 v141, v15, v35
	v_add_nc_u32_e32 v142, v16, v35
	v_add_nc_u32_e32 v143, v17, v35
	v_add_nc_u32_e32 v144, v18, v35
	v_add_nc_u32_e32 v145, v19, v35
	v_add_nc_u32_e32 v146, v20, v35
	v_add_nc_u32_e32 v147, v21, v35
	v_add_nc_u32_e32 v148, v22, v35
	v_add_nc_u32_e32 v149, v23, v35
	v_add_nc_u32_e32 v150, v24, v35
	v_add_nc_u32_e32 v151, v25, v35
	v_add_nc_u32_e32 v152, v26, v35
	v_add_nc_u32_e32 v153, v27, v35
	v_add_nc_u32_e32 v154, v28, v35
	v_add_nc_u32_e32 v155, v29, v35
	v_add_nc_u32_e32 v156, v30, v35
	v_add_nc_u32_e32 v157, v31, v35
	v_add_nc_u32_e32 v158, v32, v35
	...
	v_cndmask_b32_e64 v160, 0x80000000, v149, s3
	v_cndmask_b32_e64 v162, 0x80000000, v151, s3
	v_cndmask_b32_e64 v163, 0x80000000, v152, s3
	v_cndmask_b32_e64 v164, 0x80000000, v153, s3
	v_cndmask_b32_e64 v165, 0x80000000, v154, s3
	...
	v_cndmask_b32_e64 v159, 0x80000000, v147, s3
	v_cndmask_b32_e64 v161, 0x80000000, v150, s3
	v_cndmask_b32_e64 v166, 0x80000000, v155, s3
	v_cndmask_b32_e64 v167, 0x80000000, v156, s3
	v_cndmask_b32_e64 v168, 0x80000000, v157, s3
	v_cndmask_b32_e64 v169, 0x80000000, v158, s3
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v121, v2, v35
	scratch_load_b64 v[2:3], off, off offset:28 ; 8-byte Folded Reload
	v_cndmask_b32_e64 v121, 0x80000000, v121, s3
	s_waitcnt vmcnt(0)
	v_add_nc_u32_e32 v127, v2, v35
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_clause 0x1f
	buffer_load_u8 v147, v121, s[24:27], 0 offen
	buffer_load_u8 v127, v127, s[24:27], 0 offen
	buffer_load_u8 v149, v129, s[24:27], 0 offen
	buffer_load_u8 v129, v131, s[24:27], 0 offen
	buffer_load_u8 v150, v132, s[24:27], 0 offen
	buffer_load_u8 v131, v133, s[24:27], 0 offen
	buffer_load_u8 v151, v134, s[24:27], 0 offen
	buffer_load_u8 v132, v135, s[24:27], 0 offen
	buffer_load_u8 v152, v136, s[24:27], 0 offen
	buffer_load_u8 v133, v137, s[24:27], 0 offen
	buffer_load_u8 v153, v138, s[24:27], 0 offen
	buffer_load_u8 v134, v139, s[24:27], 0 offen
	buffer_load_u8 v154, v140, s[24:27], 0 offen
	buffer_load_u8 v135, v141, s[24:27], 0 offen
	buffer_load_u8 v155, v142, s[24:27], 0 offen
	buffer_load_u8 v137, v143, s[24:27], 0 offen
	buffer_load_u8 v156, v144, s[24:27], 0 offen
	buffer_load_u8 v139, v145, s[24:27], 0 offen
	buffer_load_u8 v157, v146, s[24:27], 0 offen
	buffer_load_u8 v140, v159, s[24:27], 0 offen
	buffer_load_u8 v158, v148, s[24:27], 0 offen
	buffer_load_u8 v141, v160, s[24:27], 0 offen
	buffer_load_u8 v160, v161, s[24:27], 0 offen
	buffer_load_u8 v142, v162, s[24:27], 0 offen
	buffer_load_u8 v162, v163, s[24:27], 0 offen
	buffer_load_u8 v143, v164, s[24:27], 0 offen
	buffer_load_u8 v163, v165, s[24:27], 0 offen
	buffer_load_u8 v144, v166, s[24:27], 0 offen
	buffer_load_u8 v164, v167, s[24:27], 0 offen
	buffer_load_u8 v145, v168, s[24:27], 0 offen
	buffer_load_u8 v165, v169, s[24:27], 0 offen
	buffer_load_u8 v148, v35, s[24:27], 0 offen
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_clause 0x7
	buffer_load_u8 v35, v122, s[20:23], 0 offen
	buffer_load_u8 v121, v123, s[20:23], 0 offen
	buffer_load_u8 v122, v124, s[20:23], 0 offen
	buffer_load_u8 v123, v126, s[20:23], 0 offen
	buffer_load_u8 v124, v128, s[20:23], 0 offen
	buffer_load_u8 v126, v130, s[20:23], 0 offen
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_waitcnt vmcnt(7)
	ds_store_b8 v108, v35
	s_waitcnt vmcnt(6)
	ds_store_b8 v108, v121 offset:256
	s_waitcnt vmcnt(5)
	ds_store_b8 v108, v122 offset:512
	s_waitcnt vmcnt(4)
	ds_store_b8 v108, v123 offset:1024
	s_waitcnt vmcnt(3)
	ds_store_b8 v108, v124 offset:1280
	s_waitcnt vmcnt(0)
	ds_store_b8 v109, v125
	ds_store_b8 v108, v126 offset:1536
	ds_store_b8 v110, v34
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	ds_load_u8 v34, v106 offset:320
	ds_load_u8 v35, v106 offset:256
	ds_load_u8 v191, v106 offset:336
	ds_load_u8 v192, v106 offset:272
	ds_load_u8 v168, v106 offset:352
	ds_load_u8 v170, v106 offset:288
	ds_load_u8 v121, v106 offset:368
	ds_load_u8 v122, v106 offset:304
	ds_load_u8 v247, v106 offset:1168
	ds_load_u8 v248, v106 offset:1184
	ds_load_u8 v249, v106 offset:1040
	ds_load_u8 v250, v106 offset:1056
	ds_load_u8 v251, v106 offset:1424
	ds_load_u8 v252, v106 offset:1440
	ds_load_u8 v253, v106 offset:1296
	ds_load_u8 v254, v106 offset:1312
	ds_load_u8 v255, v106 offset:1680
	ds_load_u8 v37, v106 offset:1696
	ds_load_u8 v36, v106 offset:1552
	ds_load_u8 v102, v106 offset:1568
	ds_load_u8 v103, v106 offset:1936
	ds_load_u8 v104, v106 offset:1952
	ds_load_u8 v105, v106 offset:1808
	ds_load_u8 v107, v106 offset:1824
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_mul_i32 s3, s3, s33
	.loc	1 1161 31                       ; ragged.py:1161:31
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	ds_load_u8 v35, v106 offset:448
	ds_load_u8 v125, v106 offset:384
	ds_load_u8 v198, v106 offset:464
	ds_load_u8 v199, v106 offset:400
	ds_load_u8 v173, v106 offset:480
	ds_load_u8 v174, v106 offset:416
	ds_load_u8 v123, v106 offset:496
	ds_load_u8 v124, v106 offset:432
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v35, v125, v35, 0xc0c0004
	ds_load_u8 v128, v106 offset:64
	ds_load_u8 v130, v106
	ds_load_u8 v203, v106 offset:80
	ds_load_u8 v177, v106 offset:96
	ds_load_u8 v125, v106 offset:112
	ds_load_u8 v204, v106 offset:16
	ds_load_u8 v178, v106 offset:32
	ds_load_u8 v126, v106 offset:48
	v_lshl_or_b32 v35, v35, 16, v34
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v136, v130, v128, 0xc0c0004
	ds_load_u8 v138, v106 offset:192
	ds_load_u8 v146, v106 offset:128
	ds_load_u8 v206, v106 offset:208
	ds_load_u8 v207, v106 offset:144
	ds_load_u8 v179, v106 offset:224
	ds_load_u8 v180, v106 offset:160
	ds_load_u8 v128, v106 offset:240
	ds_load_u8 v130, v106 offset:176
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v138, v146, v138, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v34, v138, 16, v136
	ds_load_u8 v146, v106 offset:832
	ds_load_u8 v159, v106 offset:768
	ds_load_u8 v208, v106 offset:848
	ds_load_u8 v209, v106 offset:784
	ds_load_u8 v181, v106 offset:864
	ds_load_u8 v182, v106 offset:800
	ds_load_u8 v136, v106 offset:880
	ds_load_u8 v138, v106 offset:816
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v166, v159, v146, 0xc0c0004
	ds_load_u8 v159, v106 offset:960
	ds_load_u8 v161, v106 offset:896
	ds_load_u8 v210, v106 offset:976
	ds_load_u8 v211, v106 offset:912
	ds_load_u8 v183, v106 offset:992
	ds_load_u8 v184, v106 offset:928
	ds_load_u8 v146, v106 offset:944
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v171, v161, v159, 0xc0c0004
	ds_load_u8 v167, v106 offset:576
	ds_load_u8 v169, v106 offset:512
	ds_load_u8 v212, v106 offset:592
	ds_load_u8 v213, v106 offset:528
	ds_load_u8 v185, v106 offset:608
	ds_load_u8 v186, v106 offset:544
	ds_load_u8 v159, v106 offset:624
	ds_load_u8 v161, v106 offset:560
	v_lshl_or_b32 v229, v171, 16, v166
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v172, v169, v167, 0xc0c0004
	ds_load_u8 v175, v106 offset:704
	ds_load_u8 v176, v106 offset:640
	ds_load_u8 v215, v106 offset:720
	ds_load_u8 v216, v106 offset:656
	ds_load_u8 v189, v106 offset:736
	ds_load_u8 v190, v106 offset:672
	ds_load_u8 v167, v106 offset:752
	ds_load_u8 v169, v106 offset:688
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v175, v176, v175, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v228, v175, 16, v172
	ds_load_u8 v175, v106 offset:1344
	ds_load_u8 v176, v106 offset:1280
	ds_load_u8 v166, v106 offset:1264
	ds_load_u8 v218, v106 offset:1360
	ds_load_u8 v195, v106 offset:1376
	ds_load_u8 v171, v106 offset:1392
	ds_load_u8 v172, v106 offset:1328
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v194, v176, v175, 0xc0c0004
	ds_load_u8 v187, v106 offset:1408
	ds_load_u8 v188, v106 offset:1472
	ds_load_u8 v234, v106 offset:1488
	ds_load_u8 v200, v106 offset:1504
	ds_load_u8 v175, v106 offset:1520
	ds_load_u8 v176, v106 offset:1456
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v196, v187, v188, 0xc0c0004
	ds_load_u8 v193, v106 offset:1024
	ds_load_u8 v197, v106 offset:1088
	ds_load_u8 v235, v106 offset:1104
	ds_load_u8 v214, v106 offset:1120
	ds_load_u8 v187, v106 offset:1136
	ds_load_u8 v188, v106 offset:1072
	v_lshl_or_b32 v231, v196, 16, v194
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v197, v193, v197, 0xc0c0004
	ds_load_u8 v201, v106 offset:1152
	ds_load_u8 v202, v106 offset:1216
	ds_load_u8 v236, v106 offset:1232
	ds_load_u8 v217, v106 offset:1248
	ds_load_u8 v193, v106 offset:1200
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v201, v201, v202, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v230, v201, 16, v197
	ds_load_u8 v201, v106 offset:1792
	ds_load_u8 v202, v106 offset:1856
	ds_load_u8 v237, v106 offset:1872
	ds_load_u8 v219, v106 offset:1888
	ds_load_u8 v194, v106 offset:1904
	ds_load_u8 v196, v106 offset:1840
	ds_load_u8 v197, v106 offset:1776
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v220, v201, v202, 0xc0c0004
	ds_load_u8 v221, v106 offset:1920
	ds_load_u8 v222, v106 offset:1984
	ds_load_u8 v238, v106 offset:2000
	ds_load_u8 v239, v106 offset:2016
	ds_load_u8 v205, v111
	ds_load_u8 v201, v112
	ds_load_u8 v202, v106 offset:1968
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v105, v105, v237, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v107, v107, v219, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v221, v221, v222, 0xc0c0004
	ds_load_u8 v222, v106 offset:1536
	ds_load_u8 v223, v106 offset:1600
	ds_load_u8 v240, v106 offset:1616
	ds_load_u8 v241, v106 offset:1632
	ds_load_u8 v242, v106 offset:1648
	ds_load_u8 v243, v106 offset:1584
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v103, v103, v238, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v104, v104, v239, 0xc0c0004
	v_lshl_or_b32 v233, v221, 16, v220
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v222, v222, v223, 0xc0c0004
	ds_load_u8 v223, v106 offset:1664
	ds_load_u8 v224, v106 offset:1728
	ds_load_u8 v244, v106 offset:1744
	ds_load_u8 v245, v106 offset:1760
	ds_load_u8 v246, v106 offset:1712
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v113, v147
	ds_store_b8 v113, v149 offset:512
	ds_store_b8 v113, v150 offset:1024
	ds_store_b8 v113, v151 offset:1536
	ds_store_b8 v113, v152 offset:2048
	ds_store_b8 v113, v153 offset:2560
	ds_store_b8 v113, v154 offset:3072
	ds_store_b8 v113, v155 offset:3584
	ds_store_b8 v113, v156 offset:4096
	ds_store_b8 v113, v157 offset:4608
	ds_store_b8 v113, v158 offset:5120
	ds_store_b8 v113, v160 offset:5632
	ds_store_b8 v113, v162 offset:6144
	ds_store_b8 v113, v163 offset:6656
	ds_store_b8 v113, v164 offset:7168
	ds_store_b8 v113, v165 offset:7680
	ds_store_b8 v114, v127
	ds_store_b8 v114, v129 offset:512
	ds_store_b8 v114, v131 offset:1024
	ds_store_b8 v114, v132 offset:1536
	ds_store_b8 v114, v133 offset:2048
	ds_store_b8 v114, v134 offset:2560
	ds_store_b8 v114, v135 offset:3072
	ds_store_b8 v114, v137 offset:3584
	ds_store_b8 v114, v139 offset:4096
	ds_store_b8 v114, v140 offset:4608
	ds_store_b8 v114, v141 offset:5120
	ds_store_b8 v114, v142 offset:5632
	ds_store_b8 v114, v143 offset:6144
	ds_store_b8 v114, v144 offset:6656
	ds_store_b8 v114, v145 offset:7168
	ds_store_b8 v114, v148 offset:7680
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[131:134], v115 offset1:8
	ds_load_2addr_stride64_b64 v[139:142], v116 offset1:8
	ds_load_2addr_stride64_b64 v[155:158], v117 offset1:8
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_dual_mov_b32 v154, s11 :: v_dual_mov_b32 v153, s10
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	ds_load_2addr_stride64_b64 v[162:165], v118 offset1:8
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_perm_b32 v223, v223, v224, 0xc0c0004
	v_perm_b32 v127, v204, v203, 0xc0c0004
	v_perm_b32 v129, v207, v206, 0xc0c0004
	v_perm_b32 v135, v213, v212, 0xc0c0004
	v_perm_b32 v137, v216, v215, 0xc0c0004
	v_lshl_or_b32 v232, v223, 16, v222
	v_perm_b32 v36, v36, v240, 0xc0c0004
	v_perm_b32 v102, v102, v241, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[220:227], v[131:132], v[34:35], v[147:154] neg_lo:[1,1,0]
	v_lshl_or_b32 v143, v137, 16, v135
	v_perm_b32 v135, v249, v235, 0xc0c0004
	v_perm_b32 v137, v247, v236, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[220:227], v[139:140], v[228:229], v[220:227] neg_lo:[1,1,0]
	v_perm_b32 v37, v37, v245, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[220:227], v[155:156], v[230:231], v[220:227] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[220:227], v[162:163], v[232:233], v[220:227] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v145, v220
	v_cvt_f32_i32_e32 v160, v221
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cvt_f32_i32_e32 v2, v222
	v_cvt_f32_i32_e32 v3, v223
	v_cvt_f32_i32_e32 v4, v224
	v_cvt_f32_i32_e32 v5, v225
	v_cvt_f32_i32_e32 v6, v226
	v_cvt_f32_i32_e32 v7, v227
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[220:227], v[133:134], v[34:35], v[147:154] neg_lo:[1,1,0]
	v_perm_b32 v34, v192, v191, 0xc0c0004
	v_perm_b32 v35, v199, v198, 0xc0c0004
	v_lshl_or_b32 v191, v137, 16, v135
	v_lshl_or_b32 v199, v103, 16, v105
	v_perm_b32 v135, v186, v185, 0xc0c0004
	v_perm_b32 v137, v190, v189, 0xc0c0004
	v_lshl_or_b32 v35, v35, 16, v34
	v_lshl_or_b32 v34, v129, 16, v127
	v_perm_b32 v127, v209, v208, 0xc0c0004
	v_perm_b32 v129, v211, v210, 0xc0c0004
	v_lshl_or_b32 v186, v104, 16, v107
	v_lshl_or_b32 v185, v37, 16, v102
	v_wmma_i32_16x16x16_iu4 v[206:213], v[131:132], v[34:35], v[147:154] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v144, v129, 16, v127
	v_perm_b32 v127, v253, v218, 0xc0c0004
	v_perm_b32 v129, v251, v234, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[220:227], v[141:142], v[228:229], v[220:227] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[206:213], v[139:140], v[143:144], v[206:213] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v192, v129, 16, v127
	v_perm_b32 v127, v255, v244, 0xc0c0004
	v_perm_b32 v129, v180, v179, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[220:227], v[157:158], v[230:231], v[220:227] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[206:213], v[155:156], v[191:192], v[206:213] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v198, v127, 16, v36
	v_perm_b32 v127, v178, v177, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[220:227], v[164:165], v[232:233], v[220:227] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[206:213], v[162:163], v[198:199], v[206:213] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	v_cvt_f32_i32_e32 v103, v207
	v_cvt_f32_i32_e32 v105, v208
	v_cvt_f32_i32_e32 v203, v209
	v_cvt_f32_i32_e32 v204, v210
	v_cvt_f32_i32_e32 v215, v211
	v_cvt_f32_i32_e32 v216, v212
	v_cvt_f32_i32_e32 v218, v213
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[206:213], v[133:134], v[34:35], v[147:154] neg_lo:[1,1,0]
	v_perm_b32 v34, v170, v168, 0xc0c0004
	v_perm_b32 v35, v174, v173, 0xc0c0004
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v222, v222
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[206:213], v[141:142], v[143:144], v[206:213] neg_lo:[1,1,0]
	v_lshl_or_b32 v143, v137, 16, v135
	v_perm_b32 v135, v250, v214, 0xc0c0004
	v_lshl_or_b32 v35, v35, 16, v34
	v_lshl_or_b32 v34, v129, 16, v127
	v_perm_b32 v127, v182, v181, 0xc0c0004
	v_perm_b32 v129, v184, v183, 0xc0c0004
	v_perm_b32 v137, v248, v217, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[206:213], v[157:158], v[191:192], v[206:213] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[177:184], v[131:132], v[34:35], v[147:154] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v144, v129, 16, v127
	v_perm_b32 v127, v254, v195, 0xc0c0004
	v_perm_b32 v129, v252, v200, 0xc0c0004
	v_lshl_or_b32 v173, v137, 16, v135
	v_wmma_i32_16x16x16_iu4 v[206:213], v[164:165], v[198:199], v[206:213] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[177:184], v[139:140], v[143:144], v[177:184] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v227, v227
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_lshl_or_b32 v174, v129, 16, v127
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[177:184], v[155:156], v[173:174], v[177:184] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[177:184], v[162:163], v[185:186], v[177:184] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v192, v211
	v_cvt_f32_i32_e32 v199, v213
	v_cvt_f32_i32_e32 v209, v210
	s_delay_alu instid0(VALU_DEP_4)
	v_cvt_f32_i32_e32 v37, v177
	v_cvt_f32_i32_e32 v102, v178
	v_cvt_f32_i32_e32 v104, v179
	v_cvt_f32_i32_e32 v107, v180
	v_cvt_f32_i32_e32 v168, v181
	v_cvt_f32_i32_e32 v170, v182
	v_cvt_f32_i32_e32 v189, v183
	v_cvt_f32_i32_e32 v190, v184
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[177:184], v[133:134], v[34:35], v[147:154] neg_lo:[1,1,0]
	v_perm_b32 v34, v122, v121, 0xc0c0004
	v_perm_b32 v35, v124, v123, 0xc0c0004
	v_perm_b32 v121, v126, v125, 0xc0c0004
	v_perm_b32 v122, v130, v128, 0xc0c0004
	v_perm_b32 v123, v138, v136, 0xc0c0004
	v_perm_b32 v124, v146, v205, 0xc0c0004
	v_lshl_or_b32 v35, v35, 16, v34
	v_wmma_i32_16x16x16_iu4 v[177:184], v[141:142], v[143:144], v[177:184] neg_lo:[1,1,0]
	v_lshl_or_b32 v34, v122, 16, v121
	v_perm_b32 v121, v161, v159, 0xc0c0004
	v_perm_b32 v122, v169, v167, 0xc0c0004
	v_lshl_or_b32 v130, v124, 16, v123
	v_perm_b32 v123, v188, v187, 0xc0c0004
	v_perm_b32 v124, v193, v166, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[177:184], v[157:158], v[173:174], v[177:184] neg_lo:[1,1,0]
	v_lshl_or_b32 v129, v122, 16, v121
	v_perm_b32 v121, v172, v171, 0xc0c0004
	v_perm_b32 v122, v176, v175, 0xc0c0004
	v_lshl_or_b32 v135, v124, 16, v123
	v_perm_b32 v123, v196, v194, 0xc0c0004
	v_perm_b32 v124, v202, v201, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[177:184], v[164:165], v[185:186], v[177:184] neg_lo:[1,1,0]
	v_lshl_or_b32 v136, v122, 16, v121
	v_perm_b32 v121, v243, v242, 0xc0c0004
	v_perm_b32 v122, v246, v197, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[121:128], v[131:132], v[34:35], v[147:154] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[121:128], v[139:140], v[129:130], v[121:128] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v173, v183
	v_cvt_f32_i32_e32 v144, v182
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[121:128], v[155:156], v[135:136], v[121:128] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[121:128], v[162:163], v[137:138], v[121:128] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	v_cvt_f32_i32_e32 v146, v125
	v_cvt_f32_i32_e32 v155, v126
	v_cvt_f32_i32_e32 v156, v127
	v_cvt_f32_i32_e32 v159, v128
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[121:128], v[133:134], v[34:35], v[147:154] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[121:128], v[141:142], v[129:130], v[121:128] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[121:128], v[157:158], v[135:136], v[121:128] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[121:128], v[164:165], v[137:138], v[121:128] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	.loc	1 1204 40                       ; ragged.py:1204:40
	scratch_load_b32 v123, off, off offset:8 ; 4-byte Folded Reload
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v135, v124
	.loc	1 1204 40                       ; ragged.py:1204:40
	scratch_load_b32 v124, off, off offset:12 ; 4-byte Folded Reload
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	v_cvt_f32_i32_e32 v129, v127
	v_cvt_f32_i32_e32 v130, v128
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(4)
	v_add_lshl_u32 v121, s46, v121, 1
	s_waitcnt vmcnt(3)
	v_add_lshl_u32 v122, s46, v122, 1
	s_waitcnt vmcnt(2)
	v_add_lshl_u32 v123, s46, v123, 1
	v_cndmask_b32_e32 v121, 0x80000000, v121, vcc_lo
	s_waitcnt vmcnt(1)
	v_add_lshl_u32 v124, s46, v124, 1
	v_cndmask_b32_e64 v122, 0x80000000, v122, s0
	.loc	1 1213 40                       ; ragged.py:1213:40
	s_waitcnt vmcnt(0)
	v_add_lshl_u32 v125, v125, s3, 1
	.loc	1 1204 40                       ; ragged.py:1204:40
	...
	.loc	1 1213 40                       ; ragged.py:1213:40
	buffer_load_u16 v125, v125, s[28:31], 0 offen
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_clause 0x3
	buffer_load_u16 v121, v121, s[12:15], 0 offen
	buffer_load_u16 v137, v122, s[12:15], 0 offen
	buffer_load_u16 v138, v123, s[12:15], 0 offen
	buffer_load_u16 v141, v124, s[12:15], 0 offen
	...
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_store_b32 v119, v122
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[121:124], v120
	ds_load_b128 v[125:128], v120 offset:16
	.loc	1 1226 17                       ; ragged.py:1226:17
	s_waitcnt lgkmcnt(1)
	v_fmac_f32_e32 v99, v2, v123
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v2, v142, v3
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v98, v2, v124
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(2)
	...
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v85, v3, v121
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v3, v2, v103
	v_mul_f32_e32 v4, v142, v4
	v_dual_mul_f32 v145, v142, v145 :: v_dual_fmac_f32 v84, v3, v122
	v_mul_f32_e32 v3, v2, v105
	.loc	1 1226 17                       ; ragged.py:1226:17
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v97, v4, v125
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v142, v5
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v101, v145, v121
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v145, v142, v160
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v83, v3, v123
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v3, v2, v203 :: v_dual_fmac_f32 v96, v4, v126
	v_mul_f32_e32 v4, v142, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v100, v145, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v5, v226, v142 :: v_dual_fmac_f32 v82, v3, v124
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v3, 16, v138
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v95, v4, v127
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v142, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v7, v142, v224 :: v_dual_mul_f32 v36, v3, v37
	v_dual_mul_f32 v105, v174, v3 :: v_dual_fmac_f32 v94, v4, v128
	v_dual_mul_f32 v4, v2, v204 :: v_dual_mul_f32 v103, v144, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v69, v36, v121 :: v_dual_mul_f32 v36, v3, v102
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v102, v199, v2 :: v_dual_fmac_f32 v81, v4, v125
	v_mul_f32_e32 v4, v2, v215
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v68, v36, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v36, v3, v104
	v_mul_f32_e32 v104, v173, v3
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v80, v4, v126
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v2, v216
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v6, v227, v142 :: v_dual_fmac_f32 v67, v36, v123
	v_mul_f32_e32 v36, v3, v107
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v79, v4, v127 :: v_dual_mul_f32 v4, v2, v218
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v66, v36, v124
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(0)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v4, v3, v168 :: v_dual_mul_f32 v37, v36, v131
	v_mul_f32_e32 v35, v35, v36
	v_mul_f32_e32 v107, v129, v36
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v65, v4, v125 :: v_dual_mul_f32 v4, v3, v170
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v53, v37, v121
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v37, v36, v132
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v64, v4, v126
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v3, v189
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v52, v37, v122 :: v_dual_mul_f32 v37, v36, v139
	v_dual_fmac_f32 v63, v4, v127 :: v_dual_mul_f32 v4, v3, v190
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v51, v37, v123
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v37, v36, v140
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v62, v4, v128
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v36, v146
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v50, v37, v124 :: v_dual_mul_f32 v37, v198, v2
	v_fmac_f32_e32 v49, v4, v125
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v36, v155
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v48, v4, v126
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v36, v156
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v47, v4, v127
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v36, v159
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v46, v4, v128
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_load_b128 v[121:124], v120 offset:512
	ds_load_b128 v[125:128], v120 offset:528
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v220, v142
	.loc	1 1226 17                       ; ragged.py:1226:17
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v86, v4, v121 :: v_dual_fmac_f32 v41, v35, v126
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v142, v221
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v90, v7, v125
	v_fmac_f32_e32 v88, v5, v127
	v_dual_fmac_f32 v71, v37, v127 :: v_dual_fmac_f32 v70, v102, v128
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v93, v4, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v142, v222
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v56, v103, v126 :: v_dual_fmac_f32 v55, v104, v127
	v_fmac_f32_e32 v87, v6, v128
	v_fmac_f32_e32 v54, v105, v128
	v_fmac_f32_e32 v92, v4, v123
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v142, v223
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v40, v107, v127 :: v_dual_fmac_f32 v91, v4, v124
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v191, v2
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v77, v4, v121 :: v_dual_mul_f32 v4, v2, v206
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v76, v4, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v2, v207
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v75, v4, v123 :: v_dual_mul_f32 v4, v2, v208
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v74, v4, v124
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v143, v3
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v61, v4, v121
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v3, v177
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v60, v4, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v3, v178
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v59, v4, v123
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v3, v179
	v_mul_f32_e32 v3, v3, v180
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v58, v4, v124
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v34, v36
	v_dual_mul_f32 v34, v192, v2 :: v_dual_fmac_f32 v57, v3, v125
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v45, v4, v121
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v4, v36, v133 :: v_dual_mul_f32 v121, v130, v36
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v72, v34, v126
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v44, v4, v122
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v4, v36, v134 :: v_dual_fmac_f32 v39, v121, v128
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 1226 17                       ; ragged.py:1226:17
	...
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v4, v225, v142
	v_mul_f32_e32 v2, v2, v209
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v38, v36, v125
	v_fmac_f32_e32 v89, v4, v126
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v73, v2, v125
	.loc	1 1135 19                       ; ragged.py:1135:19
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 19 is_stmt 0                ; ragged.py:0:19
	v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v2, 0x80, v0
	v_and_b32_e32 v103, 15, v0
	v_and_b32_e32 v104, 0xf0, v0
.LBB0_7:                                ; %._crit_edge
.Ltmp5:
	.loc	2 170 12 is_stmt 1              ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max_f32_e64 v1, |v100|, |v100|
	v_max_f32_e64 v4, |v101|, |v101|
	v_max3_f32 v5, |v98|, |v97|, |v96|
	v_max3_f32 v6, |v93|, |v92|, |v91|
	v_max3_f32 v7, |v90|, |v89|, |v88|
	v_max_f32_e64 v8, |v85|, |v85|
	v_max_f32_e32 v1, v4, v1
	v_max_f32_e64 v4, |v84|, |v84|
	v_max3_f32 v11, |v76|, |v75|, |v74|
	v_max3_f32 v6, v6, v7, |v87|
	v_max_f32_e64 v7, |v69|, |v69|
	v_max3_f32 v1, v1, |v99|, v5
	v_max_f32_e64 v5, |v68|, |v68|
	v_max_f32_e32 v4, v8, v4
	v_max3_f32 v8, |v82|, |v81|, |v80|
	v_max3_f32 v12, |v73|, |v72|, |v71|
	v_max3_f32 v13, |v60|, |v59|, |v58|
	v_max_f32_e32 v5, v7, v5
	v_max3_f32 v7, |v66|, |v65|, |v64|
	v_max3_f32 v14, |v57|, |v56|, |v55|
	v_max3_f32 v9, |v95|, |v94|, |v86|
	v_max3_f32 v10, |v79|, |v78|, |v77|
	v_max3_f32 v4, v4, |v83|, v8
	v_max3_f32 v8, v11, v12, |v70|
	v_max3_f32 v11, |v63|, |v62|, |v61|
	v_max3_f32 v5, v5, |v67|, v7
	v_max3_f32 v7, v13, v14, |v54|
	v_max_f32_e64 v12, |v52|, |v52|
	v_max_f32_e64 v13, |v53|, |v53|
	v_max3_f32 v1, v1, v9, v6
	v_max3_f32 v4, v4, v10, v8
	v_max3_f32 v5, v5, v11, v7
	v_max3_f32 v7, |v50|, |v49|, |v48|
	v_max_f32_e32 v6, v13, v12
	v_max3_f32 v9, |v44|, |v43|, |v42|
	v_max3_f32 v10, |v38|, |v41|, |v40|
	s_mov_b32 s0, 0x76543210
	v_max3_f32 v8, |v47|, |v46|, |v45|
.Ltmp6:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_permlanex16_b32 v11, v1, s0, 0xfedcba98 op_sel:[1,0]
.Ltmp7:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max3_f32 v6, v6, |v51|, v7
.Ltmp8:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_permlanex16_b32 v7, v4, s0, 0xfedcba98 op_sel:[1,0]
.Ltmp9:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max3_f32 v9, v9, v10, |v39|
.Ltmp10:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_permlanex16_b32 v12, v5, s0, 0xfedcba98 op_sel:[1,0]
.Ltmp11:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v10, v11, v11 :: v_dual_lshlrev_b32 v13, 4, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_max_f32_e32 v7, v7, v7
	v_max3_f32 v8, v6, v8, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_max_f32_e32 v12, v12, v12
	v_dual_max_f32 v10, v1, v10 :: v_dual_and_b32 v1, 3, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_max_f32_e32 v11, v4, v7
.Ltmp12:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp18:
	...
	v_dual_mov_b32 v4, v10 :: v_dual_mov_b32 v15, v12
.Ltmp19:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
...
.Ltmp21:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_max_f32 v11, v15, v15 :: v_dual_max_f32 v4, v10, v4
.Ltmp22:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_dual_mov_b32 v15, v8 :: v_dual_max_f32 v16, v13, v13
...
.Ltmp23:
	...
	v_dual_max_f32 v12, v13, v13 :: v_dual_mov_b32 v13, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_max_f32_e32 v15, v15, v15
	v_dual_max_f32 v10, v10, v11 :: v_dual_max_f32 v11, v16, v12
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp24:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp26:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_dual_mov_b32 v16, v11 :: v_dual_max_f32 v13, v13, v13
	v_mov_b32_dpp v16, v16 row_xmask:2 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp27:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max_f32_e32 v4, v4, v13
	v_dual_max_f32 v13, v16, v16 :: v_dual_mov_b32 v12, v10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp28:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp31:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v12, v10, v12 :: v_dual_max_f32 v11, v8, v11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_max_f32 v8, v18, v18 :: v_dual_mov_b32 v17, v12
...
.Ltmp43:
	...
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s2, s[38:39], v[14:15]
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_div_scale_f32 v13, null, 0x40e00000, 0x40e00000, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v22, v1, v16 :: v_dual_max_f32 v23, 0x2b8cbccc, v2
	...
	.loc	1 1046 48                       ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s3, s[36:37], v[14:15]
	...
	.loc	1 1046 21 is_stmt 1             ; ragged.py:1046:21
	v_cmp_le_i64_e64 s4, s[38:39], v[10:11]
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_div_fixup_f32 v1, v1, 0x40e00000, v4
	.loc	1 1046 48                       ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s5, s[36:37], v[10:11]
	.loc	1 1238 24                       ; ragged.py:1238:24
	...
	v_div_scale_f32 v14, null, v27, v27, v101
	.loc	1 1238 24                       ; ragged.py:1238:24
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v20, null, v27, v27, v99
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v22, null, v27, v27, v98
	.loc	1 1238 24                       ; ragged.py:1238:24
	...
	v_div_scale_f32 v17, vcc_lo, v101, v27, v101
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v21, v24, v21
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_div_fixup_f32 v12, v16, 0x40e00000, v12
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v16, null, v27, v27, v100
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_and_b32_e32 v2, 1, v8
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v24, s9, v99, v27, v99
	.loc	1 1238 23                       ; ragged.py:1238:23
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v26, null, v27, v27, v97
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_and_b32_e32 v11, 1, v15
	v_mov_b16_e32 v15.l, v18.h
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v31, null, v27, v27, v93
	v_div_scale_f32 v36, null, v27, v27, v89
	.loc	1 1238 23                       ; ragged.py:1238:23
	...
	v_div_scale_f32 v37, null, v27, v27, v88
	v_fma_f32 v10, -v14, v11, v17
	v_fmac_f32_e32 v19, v12, v19
	v_div_scale_f32 v12, s8, v100, v27, v100
	.loc	1 1238 23                       ; ragged.py:1238:23
	...
	v_div_scale_f32 v14, s10, v98, v27, v98
	...
	v_div_scale_f32 v30, null, v27, v27, v94
	...
	s_mov_b32 vcc_lo, s8
	v_div_scale_f32 v26, s9, v95, v27, v95
	v_fmac_f32_e32 v22, v15, v29
	v_fmac_f32_e32 v21, v28, v21
	v_div_scale_f32 v28, null, v27, v27, v86
	...
	v_div_scale_f32 v25, s8, v94, v27, v94
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v15, v16, v27, v97
	...
	v_div_scale_f32 v21, s8, v92, v27, v92
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v34, s9, v91, v27, v91
	s_mov_b32 vcc_lo, s11
	v_dual_fmac_f32 v25, v26, v35 :: v_dual_and_b32 v10, 0xffff0000, v2
	...
	v_div_fixup_f32 v19, v19, v27, v86
	v_fmac_f32_e32 v31, v26, v31
	v_div_scale_f32 v26, s10, v90, v27, v90
	...
	v_div_scale_f32 v33, s8, v89, v27, v89
	v_div_fixup_f32 v21, v21, v27, v92
	v_fma_f32 v30, -v30, v22, v34
	v_fma_f32 v34, -v28, v25, v26
	v_rcp_f32_e32 v92, v35
	v_fma_f32 v93, -v37, v32, 1.0
	s_mov_b32 vcc_lo, s9
	v_mul_f32_e32 v86, v33, v24
	v_div_fmas_f32 v22, v30, v29, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v25, v34, v31 :: v_dual_fmac_f32 v32, v93, v32
	v_div_scale_f32 v30, s9, v88, v27, v88
	v_fma_f32 v29, -v36, v86, v33
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v34, -v35, v92, 1.0
	v_fma_f32 v26, -v28, v25, v26
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v28, v30, v32
	s_mov_b32 vcc_lo, s10
	v_div_fixup_f32 v22, v22, v27, v91
	v_fmac_f32_e32 v86, v29, v24
	v_fmac_f32_e32 v92, v34, v92
	v_div_scale_f32 v29, s11, v87, v27, v87
	v_div_scale_f32 v34, null, v102, v102, v85
	v_div_fmas_f32 v25, v26, v31, v25
	v_fma_f32 v31, -v37, v28, v30
	v_div_scale_f32 v91, null, v102, v102, v84
	v_fma_f32 v26, -v36, v86, v33
	v_rcp_f32_e32 v33, v34
	v_mul_f32_e32 v36, v29, v92
	v_fmac_f32_e32 v28, v31, v32
	v_rcp_f32_e32 v31, v91
	s_mov_b32 vcc_lo, s8
	v_div_fixup_f32 v11, v11, v27, v101
	v_div_fmas_f32 v26, v26, v24, v86
	v_fma_f32 v86, -v35, v36, v29
	v_div_fixup_f32 v24, v25, v27, v90
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v93, -v34, v33, 1.0
	v_div_fixup_f32 v25, v26, v27, v89
	v_fma_f32 v26, -v37, v28, v30
	v_fmac_f32_e32 v36, v86, v92
	v_fma_f32 v37, -v91, v31, 1.0
	v_div_scale_f32 v86, null, v102, v102, v83
	v_fmac_f32_e32 v33, v93, v33
	v_div_scale_f32 v30, s8, v85, v102, v85
	v_div_fmas_f32 v26, v26, v32, v28
	v_fma_f32 v28, -v35, v36, v29
	v_fmac_f32_e32 v31, v37, v31
	v_rcp_f32_e32 v32, v86
	v_div_scale_f32 v37, null, v102, v102, v82
	s_mov_b32 vcc_lo, s11
	v_mul_f32_e32 v29, v30, v33
	v_div_scale_f32 v35, s9, v84, v102, v84
	v_div_fmas_f32 v28, v28, v92, v36
	v_rcp_f32_e32 v92, v37
	v_div_fixup_f32 v12, v12, v27, v100
	v_div_fixup_f32 v13, v13, v27, v99
	v_div_fixup_f32 v14, v14, v27, v98
	v_div_fixup_f32 v17, v17, v27, v95
	v_div_fixup_f32 v18, v18, v27, v94
	v_fma_f32 v36, -v34, v29, v30
	v_mul_f32_e32 v89, v35, v31
	v_fma_f32 v90, -v86, v32, 1.0
	v_div_fixup_f32 v26, v26, v27, v88
	v_div_fixup_f32 v27, v28, v27, v87
	v_div_scale_f32 v87, null, v102, v102, v81
	v_fmac_f32_e32 v29, v36, v33
	v_fma_f32 v28, -v91, v89, v35
	v_fmac_f32_e32 v32, v90, v32
	v_div_scale_f32 v36, s10, v83, v102, v83
	v_fma_f32 v88, -v37, v92, 1.0
	v_rcp_f32_e32 v90, v87
	v_fma_f32 v30, -v34, v29, v30
	v_fmac_f32_e32 v89, v28, v31
	v_mul_f32_e32 v34, v36, v32
	v_fmac_f32_e32 v92, v88, v92
	v_div_scale_f32 v88, s11, v82, v102, v82
	s_mov_b32 vcc_lo, s8
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v11, v11
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v28, v30, v33, v29
	v_fma_f32 v29, -v91, v89, v35
	v_fma_f32 v30, -v86, v34, v36
	v_mul_f32_e32 v33, v88, v92
	v_fma_f32 v35, -v87, v90, 1.0
	v_div_scale_f32 v91, null, v102, v102, v80
	s_mov_b32 vcc_lo, s9
	v_fmac_f32_e32 v34, v30, v32
	v_div_fmas_f32 v29, v29, v31, v89
	v_rcp_f32_e32 v89, v91
	v_fma_f32 v30, -v37, v33, v88
	v_fmac_f32_e32 v90, v35, v90
	v_div_scale_f32 v35, s8, v81, v102, v81
	v_div_fixup_f32 v29, v29, v102, v84
	v_fma_f32 v31, -v86, v34, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(TRANS32_DEP_1)
	v_dual_fmac_f32 v33, v30, v92 :: v_dual_mul_f32 v36, v35, v90
	v_div_scale_f32 v84, null, v102, v102, v79
	s_mov_b32 vcc_lo, s10
	v_fma_f32 v30, -v91, v89, 1.0
	v_div_fmas_f32 v31, v31, v32, v34
	v_fma_f32 v32, -v37, v33, v88
	v_fma_f32 v34, -v87, v36, v35
	v_rcp_f32_e32 v37, v84
	v_div_scale_f32 v86, null, v102, v102, v78
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v28, v28, v102, v85
	v_fmac_f32_e32 v89, v30, v89
	v_div_scale_f32 v85, s9, v80, v102, v80
	v_div_fmas_f32 v32, v32, v92, v33
	v_fmac_f32_e32 v36, v34, v90
	v_rcp_f32_e32 v34, v86
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v33, v85, v89
	v_fma_f32 v88, -v84, v37, 1.0
	v_div_fixup_f32 v30, v31, v102, v83
	v_div_fixup_f32 v31, v32, v102, v82
	v_fma_f32 v32, -v87, v36, v35
	v_div_scale_f32 v87, null, v102, v102, v77
	s_mov_b32 vcc_lo, s8
	v_fma_f32 v35, -v91, v33, v85
	v_fmac_f32_e32 v37, v88, v37
	v_div_scale_f32 v82, s10, v79, v102, v79
	v_fma_f32 v83, -v86, v34, 1.0
	v_div_fmas_f32 v32, v32, v90, v36
	v_rcp_f32_e32 v36, v87
	v_fmac_f32_e32 v33, v35, v89
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v35, v82, v37 :: v_dual_fmac_f32 v34, v83, v34
	v_div_scale_f32 v83, s8, v78, v102, v78
	v_div_scale_f32 v88, null, v102, v102, v76
	v_div_fixup_f32 v32, v32, v102, v81
	v_fma_f32 v81, -v91, v33, v85
	v_fma_f32 v85, -v84, v35, v82
	v_mul_f32_e32 v90, v83, v34
	v_rcp_f32_e32 v91, v88
	v_fma_f32 v92, -v87, v36, 1.0
	s_mov_b32 vcc_lo, s9
	v_fmac_f32_e32 v35, v85, v37
	v_div_fmas_f32 v33, v81, v89, v33
	v_fma_f32 v81, -v86, v90, v83
	v_fmac_f32_e32 v36, v92, v36
	v_div_scale_f32 v85, s9, v77, v102, v77
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_div_fixup_f32 v33, v33, v102, v80
	v_fma_f32 v89, -v88, v91, 1.0
	v_fma_f32 v80, -v84, v35, v82
	v_fmac_f32_e32 v90, v81, v34
	v_mul_f32_e32 v81, v85, v36
	v_div_scale_f32 v84, null, v102, v102, v75
	s_mov_b32 vcc_lo, s10
	v_fmac_f32_e32 v91, v89, v91
	v_div_scale_f32 v82, s11, v76, v102, v76
	v_div_fmas_f32 v35, v80, v37, v35
	v_fma_f32 v37, -v86, v90, v83
	v_fma_f32 v80, -v87, v81, v85
	v_rcp_f32_e32 v83, v84
	v_div_scale_f32 v89, null, v102, v102, v74
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v86, v82, v91 :: v_dual_fmac_f32 v81, v80, v36
	s_mov_b32 vcc_lo, s8
	v_rcp_f32_e32 v80, v89
	v_div_fmas_f32 v37, v37, v34, v90
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
	v_fma_f32 v90, -v88, v86, v82
	v_div_fixup_f32 v34, v35, v102, v79
	v_fma_f32 v92, -v84, v83, 1.0
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v35, v37, v102, v78
	v_fma_f32 v37, -v87, v81, v85
	v_fmac_f32_e32 v86, v90, v91
	v_fmac_f32_e32 v83, v92, v83
	v_div_scale_f32 v78, s8, v75, v102, v75
	v_fma_f32 v79, -v89, v80, 1.0
	v_div_scale_f32 v85, null, v102, v102, v73
	v_div_fmas_f32 v36, v37, v36, v81
	v_fma_f32 v37, -v88, v86, v82
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v81, v78, v83 :: v_dual_fmac_f32 v80, v79, v80
	v_rcp_f32_e32 v79, v85
	v_div_scale_f32 v87, null, v102, v102, v72
	s_mov_b32 vcc_lo, s11
	v_div_scale_f32 v82, s9, v74, v102, v74
	v_div_fmas_f32 v37, v37, v91, v86
	v_fma_f32 v86, -v84, v81, v78
	v_rcp_f32_e32 v91, v87
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	v_mul_f32_e32 v88, v82, v80
	v_fma_f32 v90, -v85, v79, 1.0
	...
	v_fma_f32 v36, -v89, v88, v82
	v_fmac_f32_e32 v79, v90, v79
	v_div_scale_f32 v37, s10, v73, v102, v73
	v_fma_f32 v90, -v87, v91, 1.0
	v_fma_f32 v78, -v84, v81, v78
	v_rcp_f32_e32 v84, v86
	v_fmac_f32_e32 v88, v36, v80
	v_mul_f32_e32 v36, v37, v79
	v_fmac_f32_e32 v91, v90, v91
	v_div_scale_f32 v90, s11, v72, v102, v72
	s_mov_b32 vcc_lo, s8
	v_div_scale_f32 v92, null, v102, v102, v70
	v_div_fmas_f32 v78, v78, v83, v81
	v_fma_f32 v81, -v89, v88, v82
	v_fma_f32 v82, -v85, v36, v37
	v_mul_f32_e32 v83, v90, v91
	v_fma_f32 v89, -v86, v84, 1.0
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v75, v78, v102, v75
	v_div_fmas_f32 v80, v81, v80, v88
	v_fmac_f32_e32 v36, v82, v79
	v_rcp_f32_e32 v81, v92
	v_fma_f32 v82, -v87, v83, v90
	v_fmac_f32_e32 v84, v89, v84
	v_div_scale_f32 v88, s8, v71, v102, v71
	v_fma_f32 v37, -v85, v36, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v83, v82, v91
	s_mov_b32 vcc_lo, s10
	v_mul_f32_e32 v78, v88, v84
	v_div_fixup_f32 v74, v80, v102, v74
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v80, -v92, v81, 1.0
	v_div_scale_f32 v82, null, v23, v23, v69
	v_div_fmas_f32 v36, v37, v79, v36
	v_fma_f32 v37, -v87, v83, v90
	v_fma_f32 v79, -v86, v78, v88
	...
	v_fmac_f32_e32 v37, v85, v80
	v_fma_f32 v81, -v87, v90, v84
	v_fma_f32 v85, -v88, v91, 1.0
	v_fmac_f32_e32 v78, v92, v78
	v_div_scale_f32 v83, s9, v67, v23, v67
	v_div_fixup_f32 v70, v36, v102, v70
	v_fma_f32 v36, -v82, v37, v86
	v_fmac_f32_e32 v90, v81, v79
	v_fmac_f32_e32 v91, v85, v91
	v_div_scale_f32 v85, null, v23, v23, v65
	s_mov_b32 vcc_lo, s10
	v_mul_f32_e32 v81, v83, v78
	v_div_scale_f32 v82, s11, v66, v23, v66
	v_div_fmas_f32 v36, v36, v80, v37
	v_fma_f32 v37, -v87, v90, v84
	v_rcp_f32_e32 v84, v85
	v_div_scale_f32 v87, null, v23, v23, v64
	s_mov_b32 vcc_lo, s8
	v_fma_f32 v80, -v89, v81, v83
	v_mul_f32_e32 v86, v82, v91
	v_div_fmas_f32 v37, v37, v79, v90
	v_rcp_f32_e32 v79, v87
	v_div_fixup_f32 v69, v36, v23, v69
	v_fmac_f32_e32 v81, v80, v78
	v_fma_f32 v80, -v88, v86, v82
	v_fma_f32 v90, -v85, v84, 1.0
	v_div_fixup_f32 v68, v37, v23, v68
	v_div_scale_f32 v37, s8, v65, v23, v65
	v_fma_f32 v36, -v89, v81, v83
	v_fmac_f32_e32 v86, v80, v91
	v_fmac_f32_e32 v84, v90, v84
	v_fma_f32 v80, -v87, v79, 1.0
	v_div_scale_f32 v83, null, v23, v23, v63
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v92, null, v23, v23, v60
	v_div_fmas_f32 v36, v36, v78, v81
	v_fma_f32 v78, -v88, v86, v82
	v_mul_f32_e32 v81, v37, v84
	v_fmac_f32_e32 v79, v80, v79
	v_rcp_f32_e32 v80, v83
	v_div_scale_f32 v82, s9, v64, v23, v64
	v_div_scale_f32 v88, null, v23, v23, v62
	s_mov_b32 vcc_lo, s11
	v_mul_f32_e32 v89, v82, v79
	v_div_fmas_f32 v78, v78, v91, v86
	v_fma_f32 v86, -v85, v81, v37
	v_rcp_f32_e32 v91, v88
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v90, -v83, v80, 1.0
	v_div_fixup_f32 v67, v36, v23, v67
	v_fma_f32 v36, -v87, v89, v82
	v_fmac_f32_e32 v81, v86, v84
	v_div_scale_f32 v86, null, v23, v23, v61
	v_div_fixup_f32 v66, v78, v23, v66
	v_fmac_f32_e32 v80, v90, v80
	v_div_scale_f32 v78, s10, v63, v23, v63
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v90, -v88, v91, 1.0
	v_fma_f32 v37, -v85, v81, v37
	v_fmac_f32_e32 v89, v36, v79
	v_rcp_f32_e32 v85, v86
	s_mov_b32 vcc_lo, s8
	v_mul_f32_e32 v36, v78, v80
	v_fmac_f32_e32 v91, v90, v91
	v_div_scale_f32 v90, s11, v62, v23, v62
	v_div_fmas_f32 v37, v37, v84, v81
	v_fma_f32 v81, -v87, v89, v82
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v82, -v83, v36, v78
	v_mul_f32_e32 v84, v90, v91
	v_fma_f32 v87, -v86, v85, 1.0
	v_div_fmas_f32 v79, v81, v79, v89
	v_rcp_f32_e32 v81, v92
	v_fmac_f32_e32 v36, v82, v80
	v_fma_f32 v82, -v88, v84, v90
	v_fmac_f32_e32 v85, v87, v85
	v_div_scale_f32 v87, s8, v61, v23, v61
	v_div_fixup_f32 v65, v37, v23, v65
	v_div_fixup_f32 v64, v79, v23, v64
	v_fma_f32 v37, -v83, v36, v78
	v_fmac_f32_e32 v84, v82, v91
	v_mul_f32_e32 v78, v87, v85
	v_fma_f32 v79, -v92, v81, 1.0
	v_div_scale_f32 v82, null, v23, v23, v59
	s_mov_b32 vcc_lo, s10
	v_div_scale_f32 v83, s9, v60, v23, v60
	v_div_fmas_f32 v36, v37, v80, v36
	v_fma_f32 v37, -v88, v84, v90
	...
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v63, v36, v23, v63
	v_rcp_f32_e32 v80, v88
	v_div_fmas_f32 v37, v37, v91, v84
	v_mul_f32_e32 v84, v83, v81
	v_fma_f32 v36, -v86, v78, v87
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v89, -v82, v79, 1.0
	s_mov_b32 vcc_lo, s8
	v_div_fixup_f32 v62, v37, v23, v62
	v_fma_f32 v37, -v92, v84, v83
	v_div_scale_f32 v86, s10, v59, v23, v59
	v_fmac_f32_e32 v79, v89, v79
	v_fma_f32 v87, -v88, v80, 1.0
	v_div_scale_f32 v89, null, v23, v23, v57
	v_div_fmas_f32 v36, v36, v85, v78
	v_fmac_f32_e32 v84, v37, v81
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v80, v87, v80
	v_rcp_f32_e32 v78, v89
	v_div_scale_f32 v87, null, v23, v23, v56
	v_mul_f32_e32 v37, v86, v79
	v_div_scale_f32 v85, s8, v58, v23, v58
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(TRANS32_DEP_2)
	v_rcp_f32_e32 v91, v87
	v_div_fixup_f32 v36, v36, v23, v61
	v_fma_f32 v61, -v92, v84, v83
	v_fma_f32 v83, -v82, v37, v86
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v61, v61, v81, v84
	v_fmac_f32_e32 v37, v83, v79
	v_fma_f32 v81, -v88, v90, v85
	v_fmac_f32_e32 v78, v92, v78
	v_div_scale_f32 v83, s9, v57, v23, v57
	v_fma_f32 v84, -v87, v91, 1.0
	v_div_fixup_f32 v60, v61, v23, v60
	v_fma_f32 v61, -v82, v37, v86
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v90, v81, v80 :: v_dual_mul_f32 v81, v83, v78
	v_fmac_f32_e32 v91, v84, v91
	v_div_scale_f32 v84, null, v23, v23, v55
	s_mov_b32 vcc_lo, s10
	v_div_scale_f32 v82, s11, v56, v23, v56
	v_div_fmas_f32 v37, v61, v79, v37
	v_fma_f32 v61, -v88, v90, v85
	v_fma_f32 v79, -v89, v81, v83
	v_rcp_f32_e32 v85, v84
	v_div_scale_f32 v88, null, v23, v23, v54
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v86, v82, v91 :: v_dual_fmac_f32 v81, v79, v78
	s_mov_b32 vcc_lo, s8
	v_rcp_f32_e32 v79, v88
	v_div_fmas_f32 v61, v61, v80, v90
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
	v_fma_f32 v80, -v87, v86, v82
	v_div_fixup_f32 v37, v37, v23, v59
	v_fma_f32 v90, -v84, v85, 1.0
	v_fma_f32 v59, -v89, v81, v83
	v_div_fixup_f32 v58, v61, v23, v58
	v_fmac_f32_e32 v86, v80, v91
	v_div_scale_f32 v61, s8, v55, v23, v55
	v_fmac_f32_e32 v85, v90, v85
	v_fma_f32 v80, -v88, v79, 1.0
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v89, null, v10, v10, v52
	v_div_fmas_f32 v59, v59, v78, v81
	v_fma_f32 v78, -v87, v86, v82
	v_mul_f32_e32 v81, v61, v85
	v_fmac_f32_e32 v79, v80, v79
	v_div_scale_f32 v80, null, v10, v10, v53
	s_mov_b32 vcc_lo, s11
	v_div_scale_f32 v82, s9, v54, v23, v54
	v_div_fmas_f32 v78, v78, v91, v86
	v_rcp_f32_e32 v83, v80
	v_fma_f32 v86, -v84, v81, v61
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v87, v82, v79
	v_div_fixup_f32 v57, v59, v23, v57
	v_div_fixup_f32 v56, v78, v23, v56
	v_rcp_f32_e32 v78, v89
	v_fmac_f32_e32 v81, v86, v85
	v_fma_f32 v59, -v88, v87, v82
	s_mov_b32 vcc_lo, s8
	v_div_scale_f32 v91, null, v10, v10, v50
	v_fma_f32 v86, -v80, v83, 1.0
	v_fma_f32 v61, -v84, v81, v61
	v_div_scale_f32 v84, null, v10, v10, v51
	v_fmac_f32_e32 v87, v59, v79
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v83, v86, v83
	v_div_scale_f32 v59, s10, v53, v10, v53
	v_rcp_f32_e32 v86, v84
	v_fma_f32 v90, -v89, v78, 1.0
	v_div_fmas_f32 v61, v61, v85, v81
	v_fma_f32 v81, -v88, v87, v82
	v_mul_f32_e32 v82, v59, v83
	s_mov_b32 vcc_lo, s9
	v_fmac_f32_e32 v78, v90, v78
	v_div_scale_f32 v85, s8, v52, v10, v52
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_fma_f32 v90, -v80, v82, v59
	v_fma_f32 v88, -v84, v86, 1.0
	v_rcp_f32_e32 v93, v91
	v_div_fmas_f32 v79, v81, v79, v87
	v_mul_f32_e32 v92, v85, v78
	v_fmac_f32_e32 v82, v90, v83
	v_fmac_f32_e32 v86, v88, v86
	v_div_scale_f32 v88, s11, v51, v10, v51
	v_div_fixup_f32 v55, v61, v23, v55
	v_div_fixup_f32 v23, v79, v23, v54
	v_fma_f32 v54, -v80, v82, v59
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v87, v88, v86
	v_div_scale_f32 v79, null, v10, v10, v49
	v_fma_f32 v81, -v89, v92, v85
	v_fma_f32 v61, -v91, v93, 1.0
	v_fma_f32 v59, -v84, v87, v88
	s_mov_b32 vcc_lo, s10
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v12, v12
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v92, v81, v78
	v_fmac_f32_e32 v93, v61, v93
	v_fmac_f32_e32 v87, v59, v86
	v_rcp_f32_e32 v59, v79
	v_div_scale_f32 v61, s9, v50, v10, v50
	v_div_fmas_f32 v54, v54, v83, v82
	v_fma_f32 v80, -v89, v92, v85
	v_div_scale_f32 v82, null, v10, v10, v48
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(TRANS32_DEP_1)
	v_mul_f32_e32 v81, v61, v93
	s_mov_b32 vcc_lo, s8
	v_div_fixup_f32 v53, v54, v10, v53
	v_fma_f32 v83, -v79, v59, 1.0
	v_div_fmas_f32 v78, v80, v78, v92
	v_fma_f32 v80, -v84, v87, v88
	v_rcp_f32_e32 v84, v82
	v_fma_f32 v85, -v91, v81, v61
	v_fmac_f32_e32 v59, v83, v59
	v_div_scale_f32 v83, s8, v49, v10, v49
	s_mov_b32 vcc_lo, s11
	...
	v_fma_f32 v61, -v91, v81, v61
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v85, -v79, v54, v83
	v_div_fixup_f32 v51, v80, v10, v51
	v_div_scale_f32 v80, null, v10, v10, v47
	v_fmac_f32_e32 v84, v78, v84
	v_div_scale_f32 v78, s10, v48, v10, v48
	v_div_fmas_f32 v61, v61, v93, v81
	v_fmac_f32_e32 v54, v85, v59
	v_rcp_f32_e32 v86, v80
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v81, v78, v84
	s_mov_b32 vcc_lo, s8
	v_div_fixup_f32 v50, v61, v10, v50
	v_fma_f32 v61, -v79, v54, v83
	v_div_scale_f32 v85, null, v10, v10, v46
	...
	v_div_scale_f32 v59, null, v10, v10, v45
	v_fma_f32 v83, -v80, v86, 1.0
	v_rcp_f32_e32 v87, v85
	v_fmac_f32_e32 v81, v79, v84
	v_rcp_f32_e32 v79, v59
	v_div_scale_f32 v61, s8, v47, v10, v47
	...
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v88, -v59, v79, 1.0
	v_mul_f32_e32 v82, v61, v86
	s_mov_b32 vcc_lo, s10
	v_fmac_f32_e32 v87, v54, v87
	v_div_scale_f32 v54, s9, v46, v10, v46
	v_fmac_f32_e32 v79, v88, v79
	v_div_scale_f32 v88, null, v10, v10, v43
	v_div_fmas_f32 v78, v78, v84, v81
	v_fma_f32 v81, -v80, v82, v61
	v_mul_f32_e32 v84, v54, v87
	v_div_scale_f32 v90, s10, v45, v10, v45
	...
	v_div_scale_f32 v91, s11, v44, v10, v44
	v_div_fixup_f32 v48, v78, v10, v48
	v_fma_f32 v61, -v80, v82, v61
	v_fmac_f32_e32 v84, v81, v87
	v_fma_f32 v78, -v59, v93, v90
	...
	v_div_scale_f32 v81, s8, v43, v10, v43
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v59, -v59, v93, v90
	v_fmac_f32_e32 v80, v78, v89
	v_div_fmas_f32 v61, v61, v86, v82
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v78, v81, v92
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v82, null, v10, v10, v42
	v_div_fmas_f32 v54, v54, v87, v84
	s_mov_b32 vcc_lo, s10
	v_div_fixup_f32 v47, v61, v10, v47
	v_div_fmas_f32 v59, v59, v79, v93
	v_fma_f32 v79, -v83, v80, v91
	v_fma_f32 v83, -v88, v78, v81
	v_rcp_f32_e32 v84, v82
	v_div_fixup_f32 v46, v54, v10, v46
	v_div_fixup_f32 v45, v59, v10, v45
	v_div_scale_f32 v59, null, v10, v10, v38
	v_fmac_f32_e32 v78, v83, v92
	s_mov_b32 vcc_lo, s11
	v_div_scale_f32 v86, null, v10, v10, v39
	v_div_fmas_f32 v79, v79, v89, v80
	s_delay_alu instid0(VALU_DEP_3)
	v_fma_f32 v54, -v88, v78, v81
	s_mov_b32 vcc_lo, s8
	v_fma_f32 v61, -v82, v84, 1.0
	v_rcp_f32_e32 v88, v86
	v_div_fixup_f32 v44, v79, v10, v44
	v_div_fmas_f32 v54, v54, v92, v78
	v_rcp_f32_e32 v78, v59
	v_fmac_f32_e32 v84, v61, v84
	v_div_scale_f32 v80, vcc_lo, v42, v10, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v43, v54, v10, v43
	v_div_scale_f32 v61, null, v10, v10, v41
	v_mul_f32_e32 v85, v80, v84
	v_div_scale_f32 v79, null, v10, v10, v40
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v54, -v59, v78, 1.0
	v_rcp_f32_e32 v81, v61
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v89, -v82, v85, v80
	v_rcp_f32_e32 v83, v79
	v_fma_f32 v92, -v86, v88, 1.0
	v_fmac_f32_e32 v78, v54, v78
	v_div_scale_f32 v54, s8, v38, v10, v38
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v87, s9, v41, v10, v41
	v_fmac_f32_e32 v83, v90, v83
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_fma_f32 v54, -v59, v91, v54
	v_div_scale_f32 v90, s10, v40, v10, v40
	.loc	1 1239 13                       ; ragged.py:1239:13
	v_med3_f32 v33, v33, s8, 0x40e00000
	v_cvt_i32_f32_e32 v35, v35
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v54, v54, v78, v91
	v_fmac_f32_e32 v88, v92, v88
	v_div_scale_f32 v92, s11, v39, v10, v39
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_dual_mul_f32 v94, v90, v83 :: v_dual_mul_f32 v95, v92, v88
	v_fma_f32 v82, -v61, v93, v87
	.loc	1 1239 13                       ; ragged.py:1239:13
	...
	v_fma_f32 v59, -v86, v95, v92
	v_fmac_f32_e32 v93, v82, v81
	.loc	1 1239 13                       ; ragged.py:1239:13
	v_cvt_i32_f32_e32 v54, v54
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fixup_f32 v42, v80, v10, v42
	v_dual_fmac_f32 v94, v89, v83 :: v_dual_fmac_f32 v95, v59, v88
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fma_f32 v61, -v61, v93, v87
	.loc	1 1240 13 is_stmt 0             ; ragged.py:1240:13
	v_rndne_f32_e32 v17, v17
	v_rndne_f32_e32 v18, v18
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v59, -v79, v94, v90
	v_fma_f32 v78, -v86, v95, v92
	v_div_fmas_f32 v61, v61, v81, v93
	s_mov_b32 vcc_lo, s10
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v19, v19
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v59, v59, v83, v94
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v41, v61, v10, v41
	v_div_fmas_f32 v78, v78, v88, v95
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v20, v20
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fixup_f32 v40, v59, v10, v40
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v21, v21
	v_rndne_f32_e32 v22, v22
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fixup_f32 v10, v78, v10, v39
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_cvt_i32_f32_e32 v77, v23
	v_cvt_i32_f32_e32 v90, v38
	v_cvt_i32_f32_e32 v93, v10
	...
	.loc	1 1245 22                       ; ragged.py:1245:22
	v_lshlrev_b32_e32 v34, 10, v0
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v59, v75
	v_rndne_f32_e32 v61, v74
	...
	v_cvt_i32_f32_e32 v78, v53
	v_cvt_i32_f32_e32 v79, v52
	v_cvt_i32_f32_e32 v80, v51
	v_cvt_i32_f32_e32 v81, v50
	.loc	1 1245 22                       ; ragged.py:1245:22
	v_add3_u32 v34, 0, v34, v37
	v_and_or_b32 v6, 0x1b00, v36, v6
	.loc	1 1239 13                       ; ragged.py:1239:13
	...
	.loc	1 1245 22                       ; ragged.py:1245:22
	v_add3_u32 v7, v34, v9, v7
	v_xad_u32 v6, v6, v104, 0
	.loc	1 1239 13                       ; ragged.py:1239:13
	v_cvt_i32_f32_e32 v74, v57
	v_cvt_i32_f32_e32 v76, v55
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc64_maskk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 47
