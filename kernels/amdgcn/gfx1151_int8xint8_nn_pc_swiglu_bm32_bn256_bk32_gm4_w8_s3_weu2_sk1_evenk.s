...
.Ltmp13:
	...
	s_mov_b32 s6, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_cndmask_b32_e64 v11, 0x80000000, v2, s3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	buffer_load_b128 v[20:23], v12, s[20:23], 0 offen
	...
	buffer_load_b128 v[28:31], v12, s[20:23], 0 offen
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	s_clause 0x1
	buffer_load_b128 v[32:35], v13, s[20:23], 0 offen
	buffer_load_b128 v[36:39], v12, s[20:23], 0 offen
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	v_add_nc_u32_e32 v12, s29, v1
	...
	buffer_load_b128 v[44:47], v12, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v59, v11, s[16:19], 0 offen
	v_cndmask_b32_e64 v8, 0x80000000, v8, s2
	v_bfe_i32 v1, v0, 5, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v11, v19, 9, v7
	v_and_b32_e32 v12, 4, v0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v64, v8, s[16:19], 0 offen
	v_and_b32_e32 v1, 0x90, v1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v16, 0x90, v11
	v_add_nc_u32_e32 v61, 0, v11
	v_xor_b32_e32 v83, 0x110, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v15, v1, v6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v62, 0, v16
	v_lshlrev_b32_e32 v1, 4, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v63, 0, v83
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(6)
	v_perm_b32 v23, v28, v24, 0x5010400
	...
	v_perm_b32 v72, v37, v33, 0x7030602
	v_perm_b32 v73, v38, v34, 0x5010400
	v_perm_b32 v74, v38, v34, 0x7030602
	v_perm_b32 v75, v39, v35, 0x5010400
	v_perm_b32 v76, v39, v35, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshrrev_b32_e32 v77, 8, v23
	v_lshrrev_b32_e32 v78, 24, v23
	v_and_b16 v20.l, 0xff, v24.l
	v_lshrrev_b32_e32 v79, 8, v24
	v_lshrrev_b32_e32 v80, 24, v24
	v_lshrrev_b32_e32 v81, 8, v28
	v_lshrrev_b32_e32 v84, 24, v28
	v_lshrrev_b32_e32 v85, 8, v25
	v_lshrrev_b32_e32 v86, 24, v25
	v_lshrrev_b32_e32 v87, 8, v29
	v_lshrrev_b32_e32 v88, 24, v29
	v_and_b16 v24.l, 0xff, v26.l
	v_lshrrev_b32_e32 v89, 8, v26
	v_lshrrev_b32_e32 v90, 24, v26
	v_lshrrev_b32_e32 v91, 8, v30
	v_lshrrev_b32_e32 v92, 24, v30
	v_and_b16 v26.l, 0xff, v27.l
	v_lshrrev_b32_e32 v93, 8, v27
	v_lshrrev_b32_e32 v94, 24, v27
	s_waitcnt vmcnt(2)
	v_perm_b32 v95, v44, v40, 0x5010400
	v_perm_b32 v96, v44, v40, 0x7030602
	v_perm_b32 v97, v45, v41, 0x5010400
	v_perm_b32 v98, v45, v41, 0x7030602
	v_perm_b32 v99, v46, v42, 0x5010400
	v_perm_b32 v100, v46, v42, 0x7030602
	v_perm_b32 v101, v47, v43, 0x5010400
	v_perm_b32 v102, v47, v43, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_lshrrev_b32_e32 v68, 24, v70
	v_and_b16 v6.h, 0xff, v18.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v18.h, 0xff, v23.h
	v_and_b16 v23.h, 0xff, v29.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v29.h, 8, v52.l
	v_and_b16 v36.l, 0xff, v70.l
	v_and_b16 v36.h, 0xff, v70.h
	...
	v_lshrrev_b32_e32 v107, 24, v76
	v_and_b16 v42.h, 0xff, v76.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v43.l, 8, v77.l
	v_lshlrev_b16 v43.h, 8, v78.l
	v_lshlrev_b16 v44.l, 8, v79.l
	v_lshlrev_b16 v44.h, 8, v80.l
	v_lshlrev_b16 v45.l, 8, v81.l
	v_lshlrev_b16 v45.h, 8, v84.l
	v_lshlrev_b16 v46.l, 8, v85.l
	v_lshlrev_b16 v46.h, 8, v86.l
	v_lshlrev_b16 v47.l, 8, v87.l
	v_lshlrev_b16 v47.h, 8, v88.l
	v_lshlrev_b16 v48.l, 8, v89.l
	v_lshlrev_b16 v48.h, 8, v90.l
	v_lshlrev_b16 v49.l, 8, v91.l
	v_lshlrev_b16 v49.h, 8, v92.l
	v_lshlrev_b16 v50.l, 8, v93.l
	v_lshlrev_b16 v50.h, 8, v94.l
	v_lshrrev_b32_e32 v76, 8, v95
	v_lshrrev_b32_e32 v77, 24, v95
	v_lshrrev_b32_e32 v78, 8, v96
	v_lshrrev_b32_e32 v79, 24, v96
	v_lshrrev_b32_e32 v80, 8, v97
	v_lshrrev_b32_e32 v81, 24, v97
	v_lshrrev_b32_e32 v84, 8, v98
	v_lshrrev_b32_e32 v85, 24, v98
	v_lshrrev_b32_e32 v86, 8, v99
	v_lshrrev_b32_e32 v87, 24, v99
	v_lshrrev_b32_e32 v88, 8, v100
	v_lshrrev_b32_e32 v89, 24, v100
	v_lshrrev_b32_e32 v90, 8, v101
	v_lshrrev_b32_e32 v91, 24, v101
	v_lshrrev_b32_e32 v92, 8, v102
	...
	v_and_b16 v56.l, 0xff, v100.l
	v_and_b16 v56.h, 0xff, v100.h
	v_and_b16 v57.l, 0xff, v101.l
	v_and_b16 v57.h, 0xff, v101.h
	v_and_b16 v58.l, 0xff, v102.l
	v_and_b16 v58.h, 0xff, v102.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_lshlrev_b16 v34.l, 8, v75.l
	v_lshlrev_b16 v34.h, 8, v107.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v18.l, v18.l, v43.l
	v_or_b16 v18.h, v18.h, v43.h
	...
	v_lshlrev_b16 v43.l, 8, v76.l
	v_lshlrev_b16 v43.h, 8, v77.l
	v_lshlrev_b16 v44.l, 8, v78.l
	v_lshlrev_b16 v44.h, 8, v79.l
	v_lshlrev_b16 v45.l, 8, v80.l
	v_lshlrev_b16 v45.h, 8, v81.l
	v_lshlrev_b16 v46.l, 8, v84.l
	v_lshlrev_b16 v46.h, 8, v85.l
	v_lshlrev_b16 v47.l, 8, v86.l
	v_lshlrev_b16 v47.h, 8, v87.l
	v_lshlrev_b16 v48.l, 8, v88.l
	v_lshlrev_b16 v48.h, 8, v89.l
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v61, v2
	ds_store_b16_d16_hi v61, v2 offset:32
	ds_store_b16 v61, v3 offset:64
	ds_store_b16_d16_hi v61, v3 offset:96
	ds_store_b16_d16_hi v62, v4 offset:32
	ds_store_b16 v62, v5 offset:64
	ds_store_b16_d16_hi v62, v5 offset:96
	v_or_b16 v2.l, v35.l, v27.l
	v_or_b16 v2.h, v35.h, v27.h
	v_or_b16 v3.l, v36.l, v28.l
	v_or_b16 v3.h, v36.h, v28.h
	v_or_b16 v5.l, v37.h, v29.h
	v_or_b16 v4.h, v37.l, v29.l
	v_or_b16 v5.h, v38.l, v30.l
	v_or_b16 v27.l, v38.h, v30.h
	v_or_b16 v27.h, v39.l, v31.l
	v_or_b16 v28.l, v39.h, v31.h
	v_or_b16 v28.h, v40.l, v32.l
	v_or_b16 v29.l, v40.h, v32.h
	v_or_b16 v29.h, v41.l, v33.l
	v_or_b16 v30.l, v41.h, v33.h
	v_or_b16 v30.h, v42.l, v34.l
	v_or_b16 v31.l, v42.h, v34.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v61, v18 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v62, v4
	ds_store_b16 v63, v6
	ds_store_b16_d16_hi v63, v6 offset:32
	ds_store_b16 v63, v7 offset:64
	ds_store_b16_d16_hi v63, v7 offset:96
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v60, v59 offset:32768
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v61, v20 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v61, v8 offset:384
	ds_store_b16_d16_hi v61, v8 offset:416
	ds_store_b16 v61, v17 offset:448
	ds_store_b16_d16_hi v61, v17 offset:480
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v61, v18 offset:16416
	ds_store_b16_d16_hi v61, v20 offset:16480
	ds_store_b16 v62, v21 offset:16384
	ds_store_b16_d16_hi v62, v21 offset:16416
	ds_store_b16 v62, v22 offset:16448
	ds_store_b16_d16_hi v62, v22 offset:16480
	ds_store_b16 v63, v23 offset:16384
	ds_store_b16_d16_hi v63, v23 offset:16416
	ds_store_b16 v63, v24 offset:16448
	ds_store_b16_d16_hi v63, v24 offset:16480
	ds_store_b16 v61, v25 offset:16768
	ds_store_b16_d16_hi v61, v25 offset:16800
	ds_store_b16 v61, v26 offset:16832
	ds_store_b16_d16_hi v61, v26 offset:16864
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v4.l, v51.l, v43.l
	v_or_b16 v6.l, v51.h, v43.h
	v_or_b16 v6.h, v52.l, v44.l
	v_or_b16 v7.l, v52.h, v44.h
	v_or_b16 v7.h, v53.l, v45.l
	v_or_b16 v8.l, v53.h, v45.h
	v_or_b16 v8.h, v54.l, v46.l
	v_or_b16 v17.l, v54.h, v46.h
	v_or_b16 v17.h, v55.l, v47.l
	v_or_b16 v18.l, v55.h, v47.h
	v_or_b16 v18.h, v56.l, v48.l
	v_or_b16 v20.l, v56.h, v48.h
	v_or_b16 v20.h, v57.l, v49.l
	v_or_b16 v21.l, v57.h, v49.h
	v_or_b16 v21.h, v58.l, v50.l
	v_or_b16 v22.l, v58.h, v50.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v61, v2 offset:8192
	ds_store_b16_d16_hi v61, v2 offset:8224
	ds_store_b16 v61, v3 offset:8256
	ds_store_b16_d16_hi v61, v3 offset:8288
	ds_store_b16 v62, v5 offset:8224
	ds_store_b16_d16_hi v62, v5 offset:8256
	ds_store_b16 v62, v27 offset:8288
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v61, v4 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v62, v4 offset:8192
	ds_store_b16_d16_hi v63, v27 offset:8192
	ds_store_b16 v63, v28 offset:8224
	ds_store_b16_d16_hi v63, v28 offset:8256
	ds_store_b16 v63, v29 offset:8288
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b32 v60, v64 offset:33792
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v61, v6 offset:24640
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v61, v29 offset:8576
	ds_store_b16 v61, v30 offset:8608
	ds_store_b16_d16_hi v61, v30 offset:8640
	ds_store_b16 v61, v31 offset:8672
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v61, v6 offset:24608
	ds_store_b16 v61, v7 offset:24672
	ds_store_b16_d16_hi v62, v7 offset:24576
	ds_store_b16 v62, v8 offset:24608
	ds_store_b16_d16_hi v62, v8 offset:24640
	ds_store_b16 v62, v17 offset:24672
	ds_store_b16_d16_hi v63, v17 offset:24576
	ds_store_b16 v63, v18 offset:24608
	ds_store_b16_d16_hi v63, v18 offset:24640
	ds_store_b16 v63, v20 offset:24672
	ds_store_b16_d16_hi v61, v20 offset:24960
	ds_store_b16 v61, v21 offset:24992
	ds_store_b16_d16_hi v61, v21 offset:25024
	ds_store_b16 v61, v22 offset:25056
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v86, 5, v0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_mov_b32 s4, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v85, 0x160, v86
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_or_b32 v84, 0x60, v86, v3
	s_branch .LBB0_3
.LBB0_2:
...
.Ltmp14:
	...
	v_and_b32_e32 v85, 0x160, v13
	v_and_or_b32 v84, 0x60, v13, v1
	v_dual_mov_b32 v75, 0 :: v_dual_add_nc_u32 v86, s29, v9
	v_mov_b32_e32 v80, 0
	v_xor_b32_e32 v1, v2, v3
	v_or_b32_e32 v87, v2, v85
	v_dual_mov_b32 v81, 0 :: v_dual_mov_b32 v70, 0
	v_dual_mov_b32 v71, 0 :: v_dual_mov_b32 v72, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_or_b32_e32 v88, v84, v1
	v_mov_b32_e32 v1, s4
	v_xor_b32_e32 v89, 16, v87
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_xor_b32_e32 v90, 16, v88
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s34, s1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v91, s6, v87
	.loc	1 404 30 is_stmt 0              ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v97, s1, v10
	s_mov_b32 s7, s4
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v92, s6, v89
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v93, s7, v88
	v_add_nc_u32_e32 v94, s7, v90
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v95, s8, v88
	v_add_nc_u32_e32 v96, s8, v90
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v203, v97, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[139:142], v91
	ds_load_b128 v[155:158], v91 offset:512
	ds_load_b128 v[159:162], v92
	ds_load_b128 v[163:166], v92 offset:512
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[115:118], v93
	ds_load_b128 v[123:126], v93 offset:4096
	ds_load_b128 v[167:170], v94
	ds_load_b128 v[171:174], v94 offset:4096
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[147:150], v95
	ds_load_b128 v[175:178], v95 offset:4096
	ds_load_b128 v[179:182], v96
	...
	s_add_i32 s1, s6, s26
	s_mov_b32 s4, s31
	v_add_nc_u32_e32 v98, s1, v9
	v_add_nc_u32_e32 v99, s1, v86
	.loc	1 408 22 is_stmt 0              ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[187:190], v98, s[20:23], 0 offen
	buffer_load_b128 v[191:194], v99, s[20:23], 0 offen
	.loc	1 414 39 is_stmt 1              ; generate_amdgcn.py:414:39
	s_add_i32 s1, s1, s27
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lt_i32 s9, 2
	...
	s_waitcnt lgkmcnt(7)
	v_wmma_i32_16x16x16_iu8 v[107:114], v[115:118], v[155:158], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[99:106], v[171:174], v[159:162], v[99:106] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[107:114], v[167:170], v[163:166], v[107:114] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_lshl_b32 s7, s36, 13
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[131:138], v[183:186], v[159:162], v[131:138] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s31, s7, 0
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_clause 0x1
	buffer_load_b128 v[195:198], v91, s[20:23], 0 offen
	buffer_load_b128 v[199:202], v92, s[20:23], 0 offen
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[91:98], v[115:118], v[139:142], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[115:122], v[123:126], v[155:158], v[1:8] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[123:130], v[147:150], v[139:142], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[91:98], v[167:170], v[159:162], v[91:98] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[139:146], v[147:150], v[155:158], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[115:122], v[171:174], v[163:166], v[115:122] neg_lo:[1,1,0]
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[123:130], v[179:182], v[159:162], v[123:130] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[139:146], v[179:182], v[163:166], v[139:146] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v69, v69, v98 :: v_dual_add_nc_u32 v204, s1, v15
	v_dual_add_f32 v52, v52, v105 :: v_dual_add_nc_u32 v205, s31, v11
	v_dual_add_f32 v61, v61, v102 :: v_dual_add_nc_u32 v206, s31, v16
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_wmma_i32_16x16x16_iu8 v[147:154], v[183:186], v[163:166], v[147:154] neg_lo:[1,1,0]
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v73, v73, v96 :: v_dual_add_f32 v68, v68, v97
	v_dual_add_f32 v65, v65, v100 :: v_dual_add_f32 v60, v60, v101
	v_dual_add_f32 v56, v56, v103 :: v_dual_add_f32 v53, v53, v106
	v_dual_add_f32 v49, v49, v108 :: v_dual_add_f32 v48, v48, v107
	v_dual_add_f32 v44, v44, v109 :: v_dual_add_nc_u32 v207, s31, v83
	v_dual_add_f32 v45, v45, v110 :: v_dual_add_f32 v40, v40, v111
	v_dual_add_f32 v37, v37, v114 :: v_dual_add_f32 v32, v32, v115
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v80, v80, v91 :: v_dual_add_f32 v41, v41, v112
	...
	v_dual_add_f32 v74, v74, v123 :: v_dual_add_f32 v75, v75, v124
	v_dual_add_f32 v76, v76, v125 :: v_dual_add_f32 v77, v77, v126
	v_dual_add_f32 v70, v70, v127 :: v_dual_add_f32 v71, v71, v128
	v_dual_add_f32 v66, v66, v129 :: v_dual_add_f32 v67, v67, v130
	v_dual_add_f32 v62, v62, v131 :: v_dual_add_f32 v63, v63, v132
	v_dual_add_f32 v58, v58, v133 :: v_dual_add_f32 v59, v59, v134
	v_dual_add_f32 v54, v54, v135 :: v_dual_add_f32 v55, v55, v136
	v_dual_add_f32 v50, v50, v137 :: v_dual_add_f32 v51, v51, v138
	v_dual_add_f32 v46, v46, v139 :: v_dual_add_f32 v47, v47, v140
	v_dual_add_f32 v42, v42, v141 :: v_dual_add_f32 v43, v43, v142
	v_dual_add_f32 v38, v38, v143 :: v_dual_add_f32 v39, v39, v144
	v_dual_add_f32 v18, v18, v146 :: v_dual_add_f32 v17, v17, v145
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v204, v203 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v92, v191, v187, 0x5010400
	v_perm_b32 v93, v191, v187, 0x7030602
	v_perm_b32 v95, v192, v188, 0x7030602
	v_perm_b32 v94, v192, v188, 0x5010400
	v_perm_b32 v96, v193, v189, 0x5010400
	v_perm_b32 v97, v193, v189, 0x7030602
	v_perm_b32 v98, v194, v190, 0x5010400
	v_perm_b32 v99, v194, v190, 0x7030602
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v100, v199, v195, 0x5010400
	v_perm_b32 v101, v199, v195, 0x7030602
	v_perm_b32 v102, v200, v196, 0x5010400
	v_perm_b32 v103, v200, v196, 0x7030602
	v_perm_b32 v104, v201, v197, 0x5010400
	v_perm_b32 v105, v201, v197, 0x7030602
	v_perm_b32 v106, v202, v198, 0x5010400
	v_perm_b32 v107, v202, v198, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v205, v91
	ds_store_b16_d16_hi v205, v91 offset:32
	ds_store_b16 v205, v92 offset:64
	ds_store_b16_d16_hi v205, v92 offset:96
	ds_store_b16 v206, v94 offset:64
	ds_store_b16_d16_hi v206, v94 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v205, v99 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v206, v93
	ds_store_b16_d16_hi v206, v93 offset:32
	ds_store_b16 v207, v95
	ds_store_b16_d16_hi v207, v95 offset:32
	ds_store_b16 v207, v96 offset:64
	ds_store_b16_d16_hi v207, v96 offset:96
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v205, v100 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v205, v97 offset:384
	ds_store_b16_d16_hi v205, v97 offset:416
	ds_store_b16 v205, v98 offset:448
	ds_store_b16_d16_hi v205, v98 offset:480
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v205, v99 offset:16416
	ds_store_b16_d16_hi v205, v100 offset:16480
	ds_store_b16 v206, v101 offset:16384
	ds_store_b16_d16_hi v206, v101 offset:16416
	ds_store_b16 v206, v102 offset:16448
	ds_store_b16_d16_hi v206, v102 offset:16480
	ds_store_b16 v207, v103 offset:16384
	ds_store_b16_d16_hi v207, v103 offset:16416
	ds_store_b16 v207, v104 offset:16448
	ds_store_b16_d16_hi v207, v104 offset:16480
	ds_store_b16 v205, v105 offset:16768
	ds_store_b16_d16_hi v205, v105 offset:16800
	ds_store_b16 v205, v106 offset:16832
	ds_store_b16_d16_hi v205, v106 offset:16864
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
.LBB0_8:                                ; %._crit_edge
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_or_b32_e32 v85, v83, v85
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v88, 0x110, 0, vcc_lo
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_and_not1_b32 vcc_lo, exec_lo, s3
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v87, 16, v85
	v_add_nc_u32_e32 v1, s0, v85
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v83, v83, v88
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cndmask_b32_e64 v88, 0, 1, s3
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v2, s0, v87
...
; %bb.9:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v88, s6, v83
	v_add_nc_u32_e32 v89, s6, v84
	ds_load_b128 v[120:123], v88
	ds_load_b128 v[124:127], v88 offset:4096
	ds_load_b128 v[128:131], v89 offset:4096
	ds_load_b128 v[132:135], v89
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s6, s4
	v_dual_mov_b32 v95, s11 :: v_dual_mov_b32 v92, s8
	v_dual_mov_b32 v94, s10 :: v_dual_mov_b32 v93, s9
	v_dual_mov_b32 v91, s7 :: v_dual_mov_b32 v90, s6
	v_dual_mov_b32 v89, s5 :: v_dual_mov_b32 v88, s4
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[96:103], v[120:123], v[13:16], v[88:95] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[104:111], v[124:127], v[13:16], v[88:95] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[112:119], v[120:123], v[9:12], v[88:95] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[96:103], v[132:135], v[5:8], v[96:103] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[88:95], v[124:127], v[9:12], v[88:95] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[104:111], v[128:131], v[5:8], v[104:111] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[112:119], v[132:135], v[1:4], v[112:119] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4)
	v_cvt_f32_i32_e32 v98, v98
	v_cvt_f32_i32_e32 v99, v99
	v_wmma_i32_16x16x16_iu8 v[88:95], v[128:131], v[1:4], v[88:95] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v100, v100
	v_cvt_f32_i32_e32 v101, v101
	v_cvt_f32_i32_e32 v107, v107
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v79, v79, v99 :: v_dual_add_f32 v78, v78, v98
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v61, v61, v107 :: v_dual_add_f32 v60, v60, v98
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v53, v53, v98 :: v_dual_add_f32 v52, v52, v99
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_cvt_f32_i32_e32 v105, v105
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v49, v49, v100 :: v_dual_add_f32 v48, v48, v101
	v_dual_add_f32 v45, v45, v98 :: v_dual_add_f32 v44, v44, v99
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v98, v117
	v_cvt_f32_i32_e32 v100, v116
	v_cvt_f32_i32_e32 v101, v119
	v_cvt_f32_i32_e32 v99, v118
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v32, v32, v88 :: v_dual_add_f32 v29, v29, v91
	...
	v_dual_add_f32 v41, v41, v98 :: v_dual_add_f32 v40, v40, v100
	v_dual_add_f32 v37, v37, v101 :: v_dual_add_f32 v36, v36, v99
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v88, s30, v83
	v_add_nc_u32_e32 v89, s30, v84
	ds_load_b128 v[120:123], v88
	ds_load_b128 v[124:127], v88 offset:4096
	ds_load_b128 v[128:131], v89 offset:4096
	ds_load_b128 v[132:135], v89
	...
	v_cvt_f32_i32_e32 v2, v99
	v_cvt_f32_i32_e32 v3, v100
	v_cvt_f32_i32_e32 v4, v101
...
.LBB0_12:
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v88, 0 :: v_dual_add_nc_u32 v1, s33, v85
	v_dual_mov_b32 v109, 0 :: v_dual_add_nc_u32 v2, s33, v87
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v85, s31, v83
	v_add_nc_u32_e32 v87, s31, v84
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v123, s11 :: v_dual_mov_b32 v118, s6
	v_mov_b32_e32 v122, s10
	v_mov_b32_e32 v120, s8
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[89:92], v85
	ds_load_b128 v[112:115], v85 offset:4096
	ds_load_b128 v[132:135], v87 offset:4096
	ds_load_b128 v[136:139], v87
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v121, s9 :: v_dual_mov_b32 v116, s4
	v_mov_b32_e32 v119, s7
	v_mov_b32_e32 v117, s5
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[124:131], v[89:92], v[13:16], v[116:123] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[96:103], v[112:115], v[13:16], v[116:123] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[104:111], v[89:92], v[9:12], v[116:123] neg_lo:[1,1,0]
...
.LBB0_16:
	...
	v_lshl_add_u32 v4, v82, 2, 0
	.loc	1 414 39                        ; generate_amdgcn.py:414:39
	s_add_i32 s0, s26, s27
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v158, v69, v93 :: v_dual_add_f32 v161, v64, v92
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	s_clause 0x1
	...
	s_mov_b32 s20, s14
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v154, v79, v91 :: v_dual_and_b32 v3, 32, v86
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	buffer_load_u16 v1, v2, s[20:23], 0 offen
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v155, v78, v87 :: v_dual_lshlrev_b32 v2, 1, v0
	...
	v_dual_add_f32 v109, v53, v101 :: v_dual_add_f32 v110, v52, v98
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	...
	v_add_f32_e32 v93, v28, v116
	v_dual_add_f32 v87, v22, v112 :: v_dual_add_f32 v116, v76, v123
	v_dual_add_f32 v84, v21, v120 :: v_dual_add_f32 v85, v20, v118
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_add_f32 v107, v75, v122 :: v_dual_add_f32 v108, v74, v88
	v_add_f32_e32 v118, v70, v121
	v_dual_add_f32 v112, v51, v136 :: v_dual_add_f32 v113, v50, v133
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_lshl_add_u32 v103, v82, 1, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v156, v73, v89 :: v_dual_add_f32 v159, v68, v90
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm32_bn256_bk32_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 37
