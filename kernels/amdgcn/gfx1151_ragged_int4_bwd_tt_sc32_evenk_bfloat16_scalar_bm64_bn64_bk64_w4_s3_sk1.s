...
.Ltmp11:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_2)
	.loc	1 1309 36                       ; ragged.py:1309:36
	v_and_or_b32 v44, v0, 15, v2
	.loc	1 1306 17                       ; ragged.py:1306:17
	s_mul_i32 s6, s6, s7
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	s_mul_hi_u32 s4, s7, s6
	.loc	1 1309 36                       ; ragged.py:1309:36
	v_or_b32_e32 v43, 32, v44
	.loc	1 1306 17                       ; ragged.py:1306:17
	s_add_i32 s4, s7, s4
...
.LBB0_3:                                ; %Flow156
	...
	v_dual_mov_b32 v33, 0 :: v_dual_and_b32 v2, 16, v0
...
; %bb.4:                                ; %.preheader.lr.ph
	v_dual_mov_b32 v72, 0 :: v_dual_and_b32 v3, 32, v0
	.loc	1 1309 36 is_stmt 1             ; ragged.py:1309:36
	v_lshrrev_b32_e32 v4, 4, v2
	v_dual_mov_b32 v71, 0 :: v_dual_and_b32 v2, 63, v0
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_bfe_i32 v7, v0, 3, 1
	v_add3_u32 v6, s23, s33, v58
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or3_b32 v73, v4, v5, s23
	v_or_b32_e32 v4, s23, v58
	.loc	1 1309 18                       ; ragged.py:1309:18
	v_or_b32_e32 v5, s39, v2
	...
	v_dual_mov_b32 v67, 0 :: v_dual_lshlrev_b32 v0, 4, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mad_u64_u32 v[32:33], null, s34, v4, v[2:3]
	v_dual_mov_b32 v69, 0 :: v_dual_and_b32 v2, 8, v5
	.loc	1 1314 26                       ; ragged.py:1314:26
	s_lshr_b32 s46, s40, 1
	v_cndmask_b32_e64 v1, 0x108, 0, vcc_lo
	s_cmp_lt_i32 s3, 16
	v_dual_mov_b32 v66, 0 :: v_dual_and_b32 v5, 0x378, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[34:35], null, s34, 3, v[32:33]
	v_mad_u64_u32 v[35:36], null, s34, 5, v[32:33]
	v_mad_u64_u32 v[36:37], null, s34, 6, v[32:33]
	v_mad_u64_u32 v[37:38], null, s34, 7, v[32:33]
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[38:39], null, v6, s44, v[2:3]
	v_dual_mov_b32 v65, 0 :: v_dual_and_b32 v2, 0x88, v7
	v_dual_mov_b32 v63, 0 :: v_dual_and_b32 v6, 0x270, v0
	v_cndmask_b32_e64 v7, 0x108, 0, s4
	s_delay_alu instid0(VALU_DEP_3)
	v_and_or_b32 v0, 0x70, v0, v2
	s_cselect_b32 s47, -1, 0
	s_add_i32 s33, s39, s21
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v74, 2, v73
	v_xor3_b32 v2, v7, v4, v2
	v_dual_mov_b32 v61, 0 :: v_dual_add_nc_u32 v4, 0, v6
	v_xor_b32_e32 v1, v0, v1
	v_cndmask_b32_e64 v6, 0x88, 0, s4
	v_lshl_or_b32 v0, v3, 3, v0
	v_dual_mov_b32 v64, 0 :: v_dual_add_nc_u32 v3, s33, v44
	v_dual_mov_b32 v62, 0 :: v_dual_add_nc_u32 v7, s33, v43
	...
	v_or_b32_e32 v81, 32, v73
	v_or_b32_e32 v82, 34, v73
	v_or_b32_e32 v83, 36, v73
	v_or_b32_e32 v84, 38, v73
	v_or_b32_e32 v85, 40, v73
	v_or_b32_e32 v86, 42, v73
	v_or_b32_e32 v87, 44, v73
	v_or_b32_e32 v88, 46, v73
	v_xor_b32_e32 v8, 8, v1
	v_xor_b32_e32 v5, v6, v5
	v_xor_b32_e32 v6, 8, v0
	v_mul_lo_u32 v92, v3, s45
	v_cndmask_b32_e64 v3, 0, 1, s47
	v_mul_lo_u32 v93, v7, s45
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s5, s35, v73
	v_cmp_gt_i32_e64 s6, s35, v74
	v_cmp_gt_i32_e64 s7, s35, v75
	...
	v_cmp_gt_i32_e64 s15, s35, v83
	v_cmp_gt_i32_e64 s16, s35, v84
	v_cmp_gt_i32_e64 s17, s35, v85
	v_cmp_gt_i32_e64 s18, s35, v86
	v_cmp_gt_i32_e64 s19, s35, v87
	v_cmp_gt_i32_e64 s20, s35, v88
	v_dual_mov_b32 v68, 0 :: v_dual_add_nc_u32 v89, s34, v32
	v_lshl_add_u32 v90, s34, 1, v32
	v_lshl_add_u32 v91, s34, 2, v32
	v_cmp_ne_u32_e64 s21, 1, v3
	v_dual_mov_b32 v59, 0 :: v_dual_add_nc_u32 v94, v4, v2
	v_dual_mov_b32 v60, 0 :: v_dual_add_nc_u32 v95, 0, v1
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v96, 0, v8
	v_dual_mov_b32 v56, 0 :: v_dual_add_nc_u32 v97, 0, v5
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v98, 0, v0
	v_dual_mov_b32 v54, 0 :: v_dual_add_nc_u32 v99, 0, v6
	...
	s_mul_i32 s48, s38, s44
	.loc	1 1520 37                       ; ragged.py:1520:37
	s_mul_i32 s49, s38, s45
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add_lshl_u32 v16, v92, s38, 1
	v_add_lshl_u32 v17, v93, s38, 1
	.loc	1 1520 25                       ; ragged.py:1520:25
	s_add_i32 s26, s38, s49
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	s_mul_i32 s26, s26, s35
	.loc	1 1512 40                       ; ragged.py:1512:40
	v_cndmask_b32_e64 v16, 0x80000000, v16, s22
	.loc	1 1519 40                       ; ragged.py:1519:40
	v_add_lshl_u32 v18, v73, s26, 1
	v_add_lshl_u32 v27, v82, s26, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	v_cndmask_b32_e64 v17, 0x80000000, v17, s2
	.loc	1 1519 40                       ; ragged.py:1519:40
	v_add_lshl_u32 v19, v74, s26, 1
	v_add_lshl_u32 v26, v81, s26, 1
	v_add_lshl_u32 v20, v75, s26, 1
	v_add_lshl_u32 v29, v84, s26, 1
	v_add_lshl_u32 v21, v76, s26, 1
	v_add_lshl_u32 v28, v83, s26, 1
	v_add_lshl_u32 v22, v77, s26, 1
	v_add_lshl_u32 v23, v78, s26, 1
	v_add_lshl_u32 v24, v79, s26, 1
	v_add_lshl_u32 v25, v80, s26, 1
	v_add_lshl_u32 v30, v85, s26, 1
	v_add_lshl_u32 v31, v86, s26, 1
	v_add_lshl_u32 v116, v87, s26, 1
	v_add_lshl_u32 v117, v88, s26, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	s_clause 0x1
	...
	v_cndmask_b32_e64 v117, 0x80000000, v117, s20
	s_clause 0xf
	...
	.loc	1 1421 19                       ; ragged.py:1421:19
	s_lshl_b32 s51, s26, 4
	s_cmp_lg_u32 s38, s50
	s_mov_b32 s38, s26
	.loc	1 1512 40                       ; ragged.py:1512:40
	s_waitcnt vmcnt(16)
	...
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v110, v110, v16 :: v_dual_lshlrev_b32 v21, 16, v21
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v108, v108, v16 :: v_dual_lshlrev_b32 v23, 16, v23
	.loc	1 1519 40                       ; ragged.py:1519:40
	v_lshlrev_b32_e32 v22, 16, v22
	.loc	1 1517 21                       ; ragged.py:1517:21
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v106, v106, v16 :: v_dual_lshlrev_b32 v25, 16, v25
	v_dual_mul_f32 v13, v13, v17 :: v_dual_lshlrev_b32 v24, 16, v24
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v104, v104, v16 :: v_dual_lshlrev_b32 v27, 16, v27
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v111, v111, v16 :: v_dual_lshlrev_b32 v26, 16, v26
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v102, v102, v16 :: v_dual_lshlrev_b32 v29, 16, v29
	s_waitcnt vmcnt(4)
	...
	.loc	1 1517 21                       ; ragged.py:1517:21
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v109, v109, v16 :: v_dual_lshlrev_b32 v30, 16, v30
	.loc	1 1525 17                       ; ragged.py:1525:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v72, v114, v19 :: v_dual_lshlrev_b32 v117, 16, v117
	.loc	1 1517 21                       ; ragged.py:1517:21
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v7, v7, v17 :: v_dual_lshlrev_b32 v116, 16, v116
	v_dual_mul_f32 v107, v107, v16 :: v_dual_mul_f32 v14, v14, v17
	v_dual_mul_f32 v105, v105, v16 :: v_dual_mul_f32 v10, v10, v17
	v_dual_mul_f32 v103, v103, v16 :: v_dual_mul_f32 v12, v12, v17
	v_dual_mul_f32 v101, v101, v16 :: v_dual_mul_f32 v8, v8, v17
	v_mul_f32_e32 v16, v100, v16
	v_dual_mul_f32 v6, v6, v17 :: v_dual_fmac_f32 v71, v115, v18
	v_dual_mul_f32 v3, v3, v17 :: v_dual_fmac_f32 v70, v113, v20
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v2, v2, v17 :: v_dual_fmac_f32 v57, v101, v116
	v_dual_mul_f32 v5, v5, v17 :: v_dual_fmac_f32 v68, v111, v22
	v_dual_mul_f32 v4, v4, v17 :: v_dual_fmac_f32 v67, v110, v23
	v_dual_mul_f32 v1, v1, v17 :: v_dual_fmac_f32 v64, v107, v26
	v_dual_mul_f32 v0, v0, v17 :: v_dual_fmac_f32 v63, v106, v27
	.loc	1 1525 17                       ; ragged.py:1525:17
	v_dual_fmac_f32 v69, v112, v21 :: v_dual_fmac_f32 v66, v109, v24
	v_dual_fmac_f32 v65, v108, v25 :: v_dual_fmac_f32 v62, v105, v28
	v_dual_fmac_f32 v61, v104, v29 :: v_dual_fmac_f32 v60, v103, v30
	v_dual_fmac_f32 v59, v102, v31 :: v_dual_fmac_f32 v56, v16, v117
	v_dual_fmac_f32 v54, v14, v18 :: v_dual_fmac_f32 v55, v15, v19
	v_dual_fmac_f32 v52, v10, v20 :: v_dual_fmac_f32 v53, v11, v21
	v_dual_fmac_f32 v50, v12, v22 :: v_dual_fmac_f32 v51, v13, v23
	v_dual_fmac_f32 v48, v8, v24 :: v_dual_fmac_f32 v49, v9, v25
	v_dual_fmac_f32 v46, v6, v26 :: v_dual_fmac_f32 v47, v7, v27
	v_dual_fmac_f32 v42, v2, v28 :: v_dual_fmac_f32 v45, v3, v29
	v_dual_fmac_f32 v40, v4, v30 :: v_dual_fmac_f32 v41, v5, v31
	v_fmac_f32_e32 v39, v0, v116
	v_fmac_f32_e32 v33, v1, v117
	.loc	1 1421 19                       ; ragged.py:1421:19
...
.LBB0_8:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v100, s53, v38
	.loc	1 1436 46                       ; ragged.py:1436:46
	s_mul_i32 s53, s54, s34
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_mov_b32 s27, s43
	.loc	1 1436 46                       ; ragged.py:1436:46
	s_add_i32 s53, s53, s39
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 1437 38                       ; ragged.py:1437:38
	v_cndmask_b32_e64 v100, 0x80000000, v100, s1
	v_add_nc_u32_e32 v107, s53, v37
	v_add_nc_u32_e32 v106, s53, v35
	v_add_nc_u32_e32 v104, s53, v34
	v_add_nc_u32_e32 v102, s53, v89
	v_add_nc_u32_e32 v105, s53, v91
	v_add_nc_u32_e32 v108, s53, v36
	v_add_nc_u32_e32 v101, s53, v32
	v_add_nc_u32_e32 v103, s53, v90
	...
	buffer_load_u8 v102, v102, s[40:43], 0 offen
	buffer_load_u8 v110, v108, s[40:43], 0 offen
	buffer_load_u8 v105, v105, s[40:43], 0 offen
	buffer_load_u8 v111, v103, s[40:43], 0 offen
	buffer_load_u8 v112, v101, s[40:43], 0 offen
	.loc	1 1437 38                       ; ragged.py:1437:38
	buffer_load_b64 v[108:109], v100, s[24:27], 0 offen
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1448 25                       ; ragged.py:1448:25
	s_add_i32 s26, s52, 16
	...
	s_waitcnt vmcnt(4)
	v_or_b16 v103.h, v110.l, v100.l
	s_waitcnt vmcnt(3)
	v_or_b16 v103.l, v105.l, v100.h
	s_waitcnt vmcnt(2)
	v_or_b16 v102.h, v111.l, v101.l
	s_waitcnt vmcnt(1)
	v_or_b16 v102.l, v112.l, v101.h
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[108:109], v[100:101], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[110:111], v[100:101], v[8:15] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[108:109], v[102:103], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[24:31], v[110:111], v[102:103], v[24:31] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[0:7], v[112:113], v[104:105], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[114:115], v[104:105], v[8:15] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[112:113], v[106:107], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[24:31], v[114:115], v[106:107], v[24:31] neg_lo:[1,1,0]
	.loc	1 1426 27                       ; ragged.py:1426:27
...
.LBB0_10:                               ; %._crit_edge46
	...
	.loc	1 1545 26                       ; ragged.py:1545:26
	v_mad_u64_u32 v[18:19], null, s35, v44, s[20:21]
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s17, s35, v20
	.loc	1 1545 17                       ; ragged.py:1545:17
	v_add3_u32 v19, v71, v0, 0x7fff
	v_add3_u32 v20, v72, v1, 0x7fff
	.loc	1 1545 26 is_stmt 0             ; ragged.py:1545:26
	v_mad_u64_u32 v[0:1], null, s35, v43, s[20:21]
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	v_cndmask_b16 v31.h, 0x7fff, v34.h, s18
	v_and_b32_e32 v34, 1, v21
	...
	v_cndmask_b16 v33.h, 0x7fff, v38.h, s20
	...
	v_cndmask_b32_e64 v31, v33, v34, s4
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 118
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 55
