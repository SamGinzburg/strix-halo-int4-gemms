	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp15:
	...
	v_mul_lo_u32 v52, s30, v3
	v_mul_lo_u32 v54, s30, v6
	v_xor_b32_e32 v44, 16, v43
	v_xor_b32_e32 v45, 32, v43
	v_mul_lo_u32 v55, s30, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[88:91], v56, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[92:95], v57, s[24:27], 0 offen
	buffer_load_b128 v[96:99], v58, s[24:27], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v23, v23, v73 :: v_dual_add_f32 v24, v24, v72
	v_dual_add_f32 v21, v21, v75 :: v_dual_add_f32 v22, v22, v74
	v_dual_add_f32 v19, v19, v77 :: v_dual_add_f32 v20, v20, v76
	v_dual_add_f32 v17, v17, v79 :: v_dual_add_f32 v18, v18, v78
	v_dual_add_f32 v15, v15, v81 :: v_dual_add_f32 v16, v16, v80
	v_dual_add_f32 v13, v13, v83 :: v_dual_add_f32 v14, v14, v82
	v_dual_add_f32 v11, v11, v85 :: v_dual_add_f32 v12, v12, v84
	v_dual_add_f32 v9, v9, v87 :: v_dual_add_f32 v10, v10, v86
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.7:
	...
	v_dual_add_f32 v9, v9, v4 :: v_dual_add_f32 v32, v32, v5
.LBB0_8:
...
.LBB0_10:
	...
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v62, v31, v62 :: v_dual_add_f32 v67, v26, v67
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	v_dual_mul_f32 v45, v3, v45 :: v_dual_mul_f32 v32, v32, v52
	...
	v_dual_mul_f32 v31, v31, v82 :: v_dual_mul_f32 v30, v30, v83
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v3, v9, v3
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_max_f32_e32 v9, 0, v32
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v35, v35, v79 :: v_dual_mul_f32 v28, v28, v85
	v_dual_mul_f32 v6, v22, v6 :: v_dual_mul_f32 v15, v15, v45
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v21, 0, v39 :: v_dual_max_f32 v22, 0, v38
	...
	v_dual_mul_f32 v29, v29, v29 :: v_dual_mul_f32 v16, v16, v16
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_and_b32_e32 v35, 1, v54
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v14, 0, v14 :: v_dual_mul_f32 v23, v23, v23
	v_dual_max_f32 v32, 0, v34 :: v_dual_max_f32 v5, 0, v5
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 158
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 32
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     34
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
