...
.Ltmp19:
	...
	buffer_load_b128 v[15:18], v3, s[24:27], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b64 v[29:30], v1, s[4:7], 0 offen
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[19:22], v4, s[24:27], 0 offen
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 352 22 is_stmt 0              ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[63:66], v47, s[24:27], 0 offen
	buffer_load_b128 v[67:70], v48, s[24:27], 0 offen
	s_mov_b32 s14, s10
	s_mov_b32 s15, s12
	.loc	1 348 22 is_stmt 1              ; generate_amdgcn.py:348:22
	...
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_dual_mul_f32 v87, v71, v79 :: v_dual_add_nc_u32 v164, s43, v45
	...
	v_dual_mul_f32 v72, v72, v80 :: v_dual_add_nc_u32 v163, s15, v46
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
...
; %bb.8:
	...
	v_dual_mov_b32 v47, s16 :: v_dual_add_nc_u32 v72, s10, v39
...
; %bb.10:
	...
	ds_load_u8 v78, v3
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v98, s42, v38
	v_add_nc_u32_e32 v80, s42, v36
	v_add_nc_u32_e32 v79, s42, v37
	v_add_nc_u32_e32 v106, s42, v39
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	s_waitcnt lgkmcnt(13)
