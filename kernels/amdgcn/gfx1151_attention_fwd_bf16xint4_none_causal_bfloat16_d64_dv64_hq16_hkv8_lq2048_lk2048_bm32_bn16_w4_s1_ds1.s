	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_b32_e32 v14, 0x700, v14
	v_dual_mov_b32 v90, 0xff800000 :: v_dual_add_nc_u32 v73, s9, v1
	s_add_i32 s3, s3, s18
	.loc	1 903 13                        ; attention.py:903:13
	s_lshl_b32 s9, s10, 14
	s_lshl_b32 s18, s1, 11
	.loc	1 974 51                        ; attention.py:974:51
	...
	s_waitcnt lgkmcnt(0)
	s_mul_f32 s29, s0, 0x3fb8aa3b
	.loc	1 903 13                        ; attention.py:903:13
	v_or_b32_e32 v7, s9, v7
	.loc	1 981 24                        ; attention.py:981:24
	v_cmp_gt_i32_e64 s0, s14, v49
	.loc	1 790 23                        ; attention.py:790:23
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v1, v64, 6, v72
	v_xor_b32_e32 v12, 0x70, v72
	...
	v_dual_mov_b32 v7, v49 :: v_dual_add_nc_u32 v82, 0, v12
	...
	v_dual_mov_b32 v4, v49 :: v_dual_add_nc_u32 v79, 0, v8
	v_mov_b32_e32 v8, v49
	v_add_nc_u32_e32 v85, v13, v6
	v_mov_b32_e32 v6, v49
	v_or3_b32 v74, v16, v51, v15
	...
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v86, 0, v16
	v_mov_b32_e32 v13, v49
	v_mov_b32_e32 v14, v49
	v_dual_mov_b32 v97, 0 :: v_dual_add_nc_u32 v84, v11, v69
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_cndmask_b32_e64 v94, 0x80000000, v61, s0
	.loc	1 1000 41                       ; attention.py:1000:41
	v_cndmask_b32_e64 v95, 0x80000000, v75, s0
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v51, v49 :: v_dual_add_nc_u32 v96, s30, v71
	.loc	1 939 32                        ; attention.py:939:32
	...
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v56, v49 :: v_dual_add_nc_u32 v61, s33, v61
	...
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v52, v49 :: v_dual_add_nc_u32 v91, v67, v65
	v_dual_mov_b32 v53, v49 :: v_dual_add_nc_u32 v92, v67, v68
	v_dual_mov_b32 v54, v49 :: v_dual_add_nc_u32 v75, s31, v75
	v_dual_mov_b32 v55, v49 :: v_dual_add_nc_u32 v88, 0, v74
	v_dual_mov_b32 v87, v97 :: v_dual_mov_b32 v104, v56
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v102, v54 :: v_dual_mov_b32 v103, v55
	...
	v_dual_mul_f32 v93, s29, v101 :: v_dual_add_nc_u32 v96, 14, v96
	v_mul_f32_e32 v50, s29, v97
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 949 30                        ; attention.py:949:30
	v_cmp_le_i32_e64 s4, v53, v73
	v_cmp_le_i32_e64 s9, v96, v73
	.loc	1 945 21                        ; attention.py:945:21
	v_mul_f32_e32 v53, s29, v98
	v_dual_mul_f32 v57, s29, v99 :: v_dual_mul_f32 v58, s29, v100
	v_dual_mul_f32 v95, s29, v102 :: v_dual_mul_f32 v96, s29, v103
	.loc	1 967 26                        ; attention.py:967:26
	v_cndmask_b32_e64 v98, 0xff800000, v50, s1
	.loc	1 945 21                        ; attention.py:945:21
	v_mul_f32_e32 v97, s29, v104
	.loc	1 949 21                        ; attention.py:949:21
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_vgpr, 122
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.kd
