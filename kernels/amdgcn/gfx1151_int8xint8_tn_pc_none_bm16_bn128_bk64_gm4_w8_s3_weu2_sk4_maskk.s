	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_sub_i32 s2, s2, s5
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add3_u32 v4, s20, s4, v4
	.loc	1 352 13                        ; generate_amdgcn.py:352:13
	s_add_i32 s2, s2, s8
.Ltmp12:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s28, s23, 0xff
.Ltmp13:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_dual_cndmask_b32 v6, 0x80000000, v4 :: v_dual_cndmask_b32 v5, 0x80000000, v5
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s23, v7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[11:14], v6, s[16:19], 0 offen
	buffer_load_b128 v[15:18], v5, s[16:19], 0 offen
	...
	s_clause 0x1
	buffer_load_b128 v[31:34], v4, s[16:19], 0 offen
	buffer_load_b128 v[35:38], v8, s[16:19], 0 offen
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_dual_cndmask_b32 v4, 0x80000000, v7 :: v_dual_and_b32 v7, 6, v0
	v_lshlrev_b32_e32 v23, 6, v9
	s_mov_b32 s3, 0
	buffer_load_b32 v44, v4, s[12:15], 0 offen
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	...
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v4, s4, s25, v6
	v_lshlrev_b32_e32 v6, 5, v0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, vcc_lo, s2
	s_cmpk_gt_i32 s28, 0x2ff
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_cndmask_b32_e32 v4, 0x80000000, v4, vcc_lo
	buffer_load_b32 v45, v4, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v4, v0, 0, 1
	...
	v_or_b16 v4.l, v4.l, v17.l
	v_or_b16 v4.h, v4.h, v17.h
	s_waitcnt vmcnt(2)
	v_perm_b32 v17, v35, v31, 0x5010400
	v_or_b16 v8.l, v8.l, v18.l
	v_or_b16 v8.h, v8.h, v18.h
	v_perm_b32 v18, v35, v31, 0x7030602
	...
	v_perm_b32 v19, v36, v32, 0x5010400
	v_perm_b32 v31, v36, v32, 0x7030602
	v_perm_b32 v32, v37, v33, 0x5010400
	v_perm_b32 v33, v37, v33, 0x7030602
	v_perm_b32 v35, v38, v34, 0x5010400
	...
	v_and_b16 v12.l, 0xff, v31.l
	v_and_b16 v12.h, 0xff, v31.h
	v_and_b16 v13.l, 0xff, v32.l
	v_and_b16 v13.h, 0xff, v32.h
	v_and_b16 v14.l, 0xff, v33.l
	v_and_b16 v14.h, 0xff, v33.h
	...
	v_or_b16 v11.l, v11.l, v19.l
	v_or_b16 v11.h, v11.h, v19.h
	v_or_b16 v12.l, v12.l, v31.l
	v_or_b16 v12.h, v12.h, v31.h
	v_or_b16 v13.l, v13.l, v32.l
	v_or_b16 v13.h, v13.h, v32.h
	v_or_b16 v14.l, v14.l, v33.l
	v_or_b16 v14.h, v14.h, v33.h
	v_or_b16 v15.l, v15.l, v34.l
	v_or_b16 v15.h, v15.h, v34.h
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v47, v4 offset:8192
	ds_store_b16_d16_hi v47, v4 offset:8256
...
; %bb.4:                                ; %.lr.ph
	...
	v_bfe_i32 v8, v0, 3, 1
	v_add3_u32 v33, s29, v2, 0x200
	v_and_or_b32 v31, 0x1800, v6, v7
	v_and_b32_e32 v4, 0x420, v4
	v_add_nc_u32_e32 v11, 0x201, v3
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v32, 0x200, v3
	s_lshl_b32 s1, s27, 7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_or_b32 v2, 0x210, v8, v4
	v_mul_lo_u32 v3, s7, v11
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_lo_u32 v4, s7, v32
	v_mul_lo_u32 v6, s6, v33
	s_lshl_b32 s3, s26, 7
...
.Ltmp15:
	...
	v_or_b32_e32 v34, v2, v23
	v_add3_u32 v35, v6, s21, v5
	s_add_i32 s27, s0, -2
	v_subrev_nc_u32_e32 v36, s3, v3
	v_subrev_nc_u32_e32 v37, s3, v1
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v38, 16, v34
	v_xor_b32_e32 v39, 32, v34
	v_xor_b32_e32 v40, 48, v34
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s6, s28, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_dual_cndmask_b32 v42, 0x80000000, v37 :: v_dual_cndmask_b32 v43, 0x80000000, v36
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_cndmask_b32_e64 v41, 0x80000000, v35, s0
	s_mov_b32 s0, s3
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lt_i32 s6, 2
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b32 v89, v41, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[49:52], v42, s[16:19], 0 offen
	buffer_load_b128 v[53:56], v43, s[16:19], 0 offen
	v_add_nc_u32_e32 v43, s0, v34
	v_add_nc_u32_e32 v46, s0, v40
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v41, s29, v18
	v_add_nc_u32_e32 v42, s29, v20
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[57:60], v43
	ds_load_b128 v[61:64], v44
	ds_load_b128 v[65:68], v45
	ds_load_b128 v[69:72], v46
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v43, v41 offset:208
	ds_load_u8 v44, v41 offset:240
	ds_load_u8 v45, v41 offset:224
	ds_load_u8 v46, v41 offset:192
	ds_load_u8 v47, v41 offset:144
	ds_load_u8 v48, v41 offset:176
	ds_load_u8 v73, v41 offset:160
	ds_load_u8 v74, v41 offset:128
	ds_load_u8 v75, v41 offset:80
	ds_load_u8 v76, v41 offset:112
	ds_load_u8 v77, v41 offset:96
	ds_load_u8 v78, v41 offset:64
	ds_load_u8 v79, v41
	ds_load_u8 v80, v41 offset:16
	ds_load_u8 v81, v41 offset:32
	ds_load_u8 v82, v41 offset:48
	ds_load_u8 v83, v41 offset:464
	ds_load_u8 v84, v41 offset:496
	ds_load_u8 v85, v41 offset:480
	ds_load_u8 v86, v41 offset:448
	ds_load_u8 v87, v41 offset:400
	ds_load_u8 v88, v41 offset:432
	ds_load_u8 v90, v41 offset:416
	ds_load_u8 v91, v41 offset:384
	ds_load_u8 v92, v41 offset:336
	ds_load_u8 v93, v41 offset:368
	ds_load_u8 v94, v41 offset:352
	ds_load_u8 v95, v41 offset:320
	ds_load_u8 v96, v41 offset:272
	ds_load_u8 v97, v41 offset:304
	ds_load_u8 v98, v41 offset:288
	ds_load_u8 v99, v41 offset:256
	ds_load_u8 v100, v41 offset:720
	ds_load_u8 v101, v41 offset:752
	ds_load_u8 v102, v41 offset:736
	ds_load_u8 v103, v41 offset:704
	ds_load_u8 v104, v41 offset:656
	ds_load_u8 v105, v41 offset:688
	ds_load_u8 v106, v41 offset:672
	ds_load_u8 v107, v41 offset:640
	ds_load_u8 v108, v41 offset:592
	ds_load_u8 v109, v41 offset:624
	ds_load_u8 v110, v41 offset:608
	ds_load_u8 v111, v41 offset:576
	ds_load_u8 v112, v41 offset:528
	ds_load_u8 v113, v41 offset:560
	ds_load_u8 v114, v41 offset:544
	ds_load_u8 v115, v41 offset:512
	ds_load_u8 v116, v41 offset:976
	ds_load_u8 v42, v42
	ds_load_u8 v117, v41 offset:992
	ds_load_u8 v118, v41 offset:960
	ds_load_u8 v119, v41 offset:912
	ds_load_u8 v120, v41 offset:944
	ds_load_u8 v121, v41 offset:928
	ds_load_u8 v122, v41 offset:896
	ds_load_u8 v123, v41 offset:848
	ds_load_u8 v124, v41 offset:880
	ds_load_u8 v125, v41 offset:864
	ds_load_u8 v126, v41 offset:832
	ds_load_u8 v127, v41 offset:784
	ds_load_u8 v128, v41 offset:816
	ds_load_u8 v129, v41 offset:800
	ds_load_u8 v41, v41 offset:768
	s_waitcnt lgkmcnt(60)
	v_perm_b32 v43, v46, v43, 0xc0c0004
	v_perm_b32 v44, v45, v44, 0xc0c0004
	s_waitcnt lgkmcnt(56)
	v_perm_b32 v45, v74, v47, 0xc0c0004
	v_perm_b32 v46, v73, v48, 0xc0c0004
	s_waitcnt lgkmcnt(52)
	v_perm_b32 v47, v78, v75, 0xc0c0004
	v_perm_b32 v48, v77, v76, 0xc0c0004
	s_waitcnt lgkmcnt(50)
	v_perm_b32 v73, v79, v80, 0xc0c0004
	s_waitcnt lgkmcnt(48)
	v_perm_b32 v77, v81, v82, 0xc0c0004
	s_waitcnt lgkmcnt(44)
	v_perm_b32 v78, v86, v83, 0xc0c0004
	v_perm_b32 v79, v85, v84, 0xc0c0004
	s_waitcnt lgkmcnt(40)
	v_perm_b32 v81, v91, v87, 0xc0c0004
	v_perm_b32 v82, v90, v88, 0xc0c0004
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v83, v95, v92, 0xc0c0004
	v_perm_b32 v84, v94, v93, 0xc0c0004
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v85, v99, v96, 0xc0c0004
	v_perm_b32 v86, v98, v97, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v87, v103, v100, 0xc0c0004
	v_perm_b32 v88, v102, v101, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v96, v118, v116, 0xc0c0004
	v_perm_b32 v42, v117, v42, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v41, v127, 0xc0c0004
	v_perm_b32 v101, v129, v128, 0xc0c0004
	v_lshl_or_b32 v76, v44, 16, v43
	v_lshl_or_b32 v75, v46, 16, v45
	v_lshl_or_b32 v74, v48, 16, v47
	v_lshl_or_b32 v73, v77, 16, v73
	v_perm_b32 v90, v107, v104, 0xc0c0004
	v_perm_b32 v91, v106, v105, 0xc0c0004
	v_perm_b32 v92, v111, v108, 0xc0c0004
	v_perm_b32 v93, v110, v109, 0xc0c0004
	v_perm_b32 v94, v115, v112, 0xc0c0004
	v_perm_b32 v95, v114, v113, 0xc0c0004
	v_lshl_or_b32 v80, v79, 16, v78
	v_lshl_or_b32 v79, v82, 16, v81
	v_lshl_or_b32 v78, v84, 16, v83
	v_lshl_or_b32 v77, v86, 16, v85
	v_lshl_or_b32 v84, v88, 16, v87
	v_lshl_or_b32 v88, v42, 16, v96
	v_lshl_or_b32 v85, v101, 16, v41
	v_wmma_i32_16x16x16_iu8 v[41:48], v[57:60], v[73:76], v[1:8] neg_lo:[1,1,0]
	v_perm_b32 v97, v122, v119, 0xc0c0004
	v_perm_b32 v98, v121, v120, 0xc0c0004
	v_perm_b32 v99, v126, v123, 0xc0c0004
	v_perm_b32 v100, v125, v124, 0xc0c0004
	v_lshl_or_b32 v83, v91, 16, v90
	v_lshl_or_b32 v82, v93, 16, v92
	v_lshl_or_b32 v81, v95, 16, v94
	v_wmma_i32_16x16x16_iu8 v[41:48], v[61:64], v[77:80], v[41:48] neg_lo:[1,1,0]
	...
	s_mov_b32 s3, s26
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[41:48], v[65:68], v[81:84], v[41:48] neg_lo:[1,1,0]
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_lshl_b32 s0, s28, 10
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_lshl_b32 s6, s28, 13
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_add_i32 s0, s0, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s26, s6, 0
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[41:48], v[69:72], v[85:88], v[41:48] neg_lo:[1,1,0]
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_add_f32 v16, v16, v43 :: v_dual_add_nc_u32 v37, s24, v37
	v_dual_add_f32 v15, v15, v44 :: v_dual_add_nc_u32 v130, s0, v10
	v_dual_add_f32 v14, v14, v45 :: v_dual_add_nc_u32 v35, s25, v35
	v_dual_add_f32 v12, v12, v47 :: v_dual_add_nc_u32 v33, 0x100, v33
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_add_nc_u32_e32 v137, s26, v30
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(2)
	ds_store_b32 v130, v89 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v42, v53, v49, 0x5010400
	v_perm_b32 v43, v53, v49, 0x7030602
	v_perm_b32 v44, v54, v50, 0x5010400
	v_perm_b32 v45, v54, v50, 0x7030602
	v_perm_b32 v46, v55, v51, 0x5010400
	v_perm_b32 v47, v55, v51, 0x7030602
	v_perm_b32 v48, v56, v52, 0x5010400
	v_perm_b32 v49, v56, v52, 0x7030602
	v_lshrrev_b32_e32 v50, 8, v42
	v_lshrrev_b32_e32 v51, 24, v42
	v_lshrrev_b32_e32 v52, 8, v43
	...
	v_lshlrev_b16 v50.l, 8, v52.l
	v_lshlrev_b16 v50.h, 8, v53.l
	v_lshlrev_b16 v51.l, 8, v54.l
	v_lshlrev_b16 v51.h, 8, v55.l
	v_lshlrev_b16 v52.l, 8, v56.l
	v_lshlrev_b16 v52.h, 8, v57.l
	v_lshlrev_b16 v53.l, 8, v58.l
	v_lshlrev_b16 v53.h, 8, v59.l
	v_lshlrev_b16 v54.l, 8, v60.l
	v_lshlrev_b16 v54.h, 8, v61.l
	v_lshlrev_b16 v55.l, 8, v62.l
	v_lshlrev_b16 v55.h, 8, v63.l
	v_lshlrev_b16 v56.l, 8, v64.l
	v_lshlrev_b16 v56.h, 8, v65.l
	...
	ds_store_b16 v135, v45
	ds_store_b16_d16_hi v135, v45 offset:64
	ds_store_b16 v131, v46 offset:640
	ds_store_b16_d16_hi v131, v46 offset:704
	ds_store_b16 v136, v47
	ds_store_b16_d16_hi v136, v47 offset:64
	ds_store_b16 v137, v48
	ds_store_b16_d16_hi v137, v48 offset:64
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v4, v20 :: v_dual_mov_b32 v33, v22
...
; %bb.9:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v22, s3, v6
	v_add_nc_u32_e32 v23, s3, v5
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v25, v20 :: v_dual_add_nc_u32 v24, s1, v4
...
; %bb.11:
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v44, s6, v18
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v6, s26, v6
	v_add_nc_u32_e32 v23, s26, v5
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v20, v44 offset:208
	ds_load_u8 v21, v44 offset:224
	ds_load_u8 v22, v44 offset:192
	ds_load_u8 v24, v44 offset:240
	ds_load_u8 v25, v44 offset:144
	ds_load_u8 v26, v44 offset:176
	ds_load_u8 v27, v44 offset:160
	ds_load_u8 v32, v44 offset:128
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[5:8], v6
	ds_load_b128 v[28:31], v23
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v23, v44 offset:112
	ds_load_u8 v40, v44 offset:80
	ds_load_u8 v41, v44 offset:96
	ds_load_u8 v45, v44 offset:64
	ds_load_u8 v46, v44
	ds_load_u8 v47, v44 offset:16
	ds_load_u8 v48, v44 offset:32
	ds_load_u8 v49, v44 offset:48
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v21, v21, v24, 0xc0c0004
	v_perm_b32 v20, v22, v20, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v22, v32, v25, 0xc0c0004
	v_perm_b32 v24, v27, v26, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v43, v21, 16, v20
	v_dual_mov_b32 v20, 0 :: v_dual_add_nc_u32 v3, s26, v3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s26, v2
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_lshl_or_b32 v42, v24, 16, v22
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v21, v46, v47, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v22, v48, v49, 0xc0c0004
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v27, v20 :: v_dual_add_nc_u32 v2, s6, v4
	v_perm_b32 v3, v45, v40, 0xc0c0004
	v_perm_b32 v4, v41, v23, 0xc0c0004
	v_lshl_or_b32 v40, v22, 16, v21
	v_mov_b32_e32 v21, v20
	ds_load_u8 v50, v44 offset:336
	ds_load_u8 v51, v44 offset:352
	ds_load_u8 v52, v44 offset:320
	ds_load_u8 v53, v44 offset:272
	ds_load_u8 v54, v44 offset:304
	ds_load_u8 v55, v44 offset:288
	ds_load_u8 v56, v44 offset:256
	ds_load_u8 v46, v44 offset:496
	ds_load_u8 v47, v44 offset:400
	ds_load_u8 v48, v44 offset:432
	ds_load_u8 v49, v44 offset:416
	ds_load_u8 v59, v44 offset:384
	v_lshl_or_b32 v41, v4, 16, v3
	ds_load_u8 v3, v44 offset:368
	ds_load_u8 v45, v44 offset:464
	ds_load_u8 v57, v44 offset:480
	ds_load_u8 v58, v44 offset:448
	ds_load_u8 v2, v2
	v_mov_b32_e32 v22, v20
	v_mov_b32_e32 v23, v20
	v_mov_b32_e32 v24, v20
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v46, v57, v46, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v4, v58, v45, 0xc0c0004
	ds_load_u8 v45, v44 offset:592
	ds_load_u8 v58, v44 offset:608
	ds_load_u8 v60, v44 offset:576
	ds_load_u8 v61, v44 offset:528
	ds_load_u8 v62, v44 offset:560
	ds_load_u8 v63, v44 offset:544
	ds_load_u8 v64, v44 offset:512
	v_perm_b32 v49, v52, v50, 0xc0c0004
	v_perm_b32 v3, v51, v3, 0xc0c0004
	v_perm_b32 v50, v56, v53, 0xc0c0004
	v_perm_b32 v51, v55, v54, 0xc0c0004
	v_lshl_or_b32 v39, v46, 16, v4
	v_lshl_or_b32 v38, v48, 16, v47
	v_lshl_or_b32 v37, v3, 16, v49
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v36, v51, 16, v50
	ds_load_u8 v3, v44 offset:752
	ds_load_u8 v4, v44 offset:720
	ds_load_u8 v40, v44 offset:736
	ds_load_u8 v41, v44 offset:704
	ds_load_u8 v42, v44 offset:656
	ds_load_u8 v43, v44 offset:672
	ds_load_u8 v46, v44 offset:640
	ds_load_u8 v47, v44 offset:688
	ds_load_u8 v48, v44 offset:624
	ds_load_u8 v49, v44 offset:976
	ds_load_u8 v50, v44 offset:992
	ds_load_u8 v51, v44 offset:960
	ds_load_u8 v52, v44 offset:912
	ds_load_u8 v53, v44 offset:944
	ds_load_u8 v54, v44 offset:928
	ds_load_u8 v55, v44 offset:896
	ds_load_u8 v56, v44 offset:880
	ds_load_u8 v57, v44 offset:848
	ds_load_u8 v59, v44 offset:864
	ds_load_u8 v65, v44 offset:832
	ds_load_u8 v66, v44 offset:784
	ds_load_u8 v67, v44 offset:816
	ds_load_u8 v68, v44 offset:800
	ds_load_u8 v44, v44 offset:768
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v4, v41, v4, 0xc0c0004
	v_perm_b32 v3, v40, v3, 0xc0c0004
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v40, v46, v42, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v41, v43, v47, 0xc0c0004
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v43, v58, v48, 0xc0c0004
	v_perm_b32 v42, v60, v45, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[20:27], v[32:35], v[36:39], v[20:27] neg_lo:[1,1,0]
	v_lshl_or_b32 v35, v3, 16, v4
	v_perm_b32 v46, v63, v62, 0xc0c0004
	v_perm_b32 v45, v64, v61, 0xc0c0004
	v_lshl_or_b32 v34, v41, 16, v40
	v_lshl_or_b32 v33, v43, 16, v42
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v3, v51, v49, 0xc0c0004
	v_perm_b32 v2, v50, v2, 0xc0c0004
	v_lshl_or_b32 v32, v46, 16, v45
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v4, v55, v52, 0xc0c0004
	v_perm_b32 v36, v54, v53, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v37, v65, v57, 0xc0c0004
	v_perm_b32 v38, v59, v56, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v39, v44, v66, 0xc0c0004
	v_perm_b32 v40, v68, v67, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[20:27], v[28:31], v[32:35], v[20:27] neg_lo:[1,1,0]
	v_lshl_or_b32 v31, v2, 16, v3
	v_lshl_or_b32 v30, v36, 16, v4
	v_lshl_or_b32 v29, v38, 16, v37
	v_lshl_or_b32 v28, v40, 16, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[20:27], v[5:8], v[28:31], v[20:27] neg_lo:[1,1,0]
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 138
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
