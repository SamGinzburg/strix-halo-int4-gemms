	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp18:
	...
	v_xor_b32_e32 v16, v5, v1
	v_and_or_b32 v14, 0x88, v12, v6
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 278 13                        ; generate_amdgcn.py:278:13
	ds_store_2addr_b32 v0, v89, v99 offset1:32
	ds_store_2addr_b32 v0, v92, v67 offset0:64 offset1:96
	s_waitcnt vmcnt(9)
	ds_store_2addr_b32 v10, v98, v97 offset1:32
	ds_store_2addr_b32 v10, v84, v66 offset0:64 offset1:96
	s_waitcnt vmcnt(8)
	ds_store_2addr_b32 v18, v96, v95 offset1:32
	ds_store_2addr_b32 v18, v73, v63 offset0:64 offset1:96
	s_waitcnt vmcnt(7)
	ds_store_2addr_b32 v19, v94, v93 offset1:32
	ds_store_2addr_b32 v19, v64, v61 offset0:64 offset1:96
	s_waitcnt vmcnt(6)
	ds_store_2addr_b32 v20, v91, v90 offset1:32
	ds_store_2addr_b32 v20, v62, v58 offset0:64 offset1:96
	s_waitcnt vmcnt(5)
	ds_store_2addr_b32 v21, v88, v87 offset1:32
	ds_store_2addr_b32 v21, v59, v55 offset0:64 offset1:96
	s_waitcnt vmcnt(4)
	ds_store_2addr_b32 v22, v86, v85 offset1:32
	ds_store_2addr_b32 v22, v57, v53 offset0:64 offset1:96
	s_waitcnt vmcnt(3)
	ds_store_2addr_b32 v23, v83, v82 offset1:32
	ds_store_2addr_b32 v23, v54, v51 offset0:64 offset1:96
	ds_store_2addr_b32 v25, v81, v80 offset1:32
	ds_store_2addr_b32 v25, v52, v48 offset0:64 offset1:96
	ds_store_2addr_b32 v26, v79, v78 offset1:32
	ds_store_2addr_b32 v26, v50, v46 offset0:64 offset1:96
	ds_store_2addr_b32 v27, v77, v76 offset1:32
	ds_store_2addr_b32 v27, v49, v44 offset0:64 offset1:96
	ds_store_2addr_b32 v28, v75, v74 offset1:32
	ds_store_2addr_b32 v28, v47, v41 offset0:64 offset1:96
	ds_store_2addr_b32 v29, v72, v71 offset1:32
	ds_store_2addr_b32 v29, v45, v40 offset0:64 offset1:96
	ds_store_2addr_b32 v30, v70, v68 offset1:32
	ds_store_2addr_b32 v30, v43, v39 offset0:64 offset1:96
	ds_store_2addr_b32 v31, v69, v65 offset1:32
	ds_store_2addr_b32 v31, v42, v37 offset0:64 offset1:96
	v_add_nc_u32_e32 v0, 0, v101
	ds_store_2addr_b32 v32, v60, v56 offset1:32
	ds_store_2addr_b32 v32, v38, v36 offset0:64 offset1:96
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v0, v0
	s_waitcnt vmcnt(2)
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	s_waitcnt vmcnt(40)
	v_dual_mul_f32 v0, v0, v229 :: v_dual_lshlrev_b32 v157, 16, v232
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	...
	s_waitcnt vmcnt(37)
	v_dual_mul_f32 v160, v6, v229 :: v_dual_lshlrev_b32 v1, 16, v107
	v_mul_f32_e32 v169, v22, v229
	v_mul_f32_e32 v170, v23, v229
	s_waitcnt vmcnt(35)
	v_dual_mul_f32 v171, v24, v229 :: v_dual_lshlrev_b32 v22, 16, v119
	v_mul_f32_e32 v172, v33, v229
	v_dual_mul_f32 v173, v34, v229 :: v_dual_lshlrev_b32 v34, 16, v123
	v_mul_f32_e32 v174, v35, v229
	v_mul_f32_e32 v175, v175, v229
	v_mul_f32_e32 v177, v177, v229
	v_mul_f32_e32 v158, v2, v229
	v_mul_f32_e32 v159, v4, v229
	v_dual_mul_f32 v161, v7, v229 :: v_dual_lshlrev_b32 v2, 16, v108
	s_waitcnt vmcnt(30)
	v_dual_mul_f32 v162, v8, v229 :: v_dual_lshlrev_b32 v35, 16, v124
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v7, 16, v111
	s_waitcnt vmcnt(27)
	v_lshlrev_b32_e32 v107, 16, v126
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v95, v174, v34 :: v_dual_lshlrev_b32 v24, 16, v121
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v163, v9, v229 :: v_dual_lshlrev_b32 v6, 16, v110
	v_mul_f32_e32 v164, v10, v229
	v_dual_mul_f32 v165, v18, v229 :: v_dual_lshlrev_b32 v8, 16, v112
	v_mul_f32_e32 v166, v19, v229
	v_dual_mul_f32 v167, v20, v229 :: v_dual_lshlrev_b32 v10, 16, v114
	v_dual_mul_f32 v168, v21, v229 :: v_dual_lshlrev_b32 v23, 16, v120
	v_mul_f32_e32 v176, v176, v229
	s_waitcnt vmcnt(26)
	v_dual_mul_f32 v178, v178, v229 :: v_dual_lshlrev_b32 v111, 16, v130
	v_mul_f32_e32 v179, v179, v229
	v_mul_f32_e32 v180, v180, v229
	v_mul_f32_e32 v181, v181, v229
	v_mul_f32_e32 v182, v182, v229
	v_dual_mul_f32 v183, v183, v229 :: v_dual_lshlrev_b32 v120, 16, v139
	v_dual_mul_f32 v184, v184, v229 :: v_dual_lshlrev_b32 v119, 16, v138
	v_dual_mul_f32 v185, v185, v229 :: v_dual_lshlrev_b32 v124, 16, v143
	v_dual_mul_f32 v186, v186, v229 :: v_dual_lshlrev_b32 v121, 16, v140
	v_mul_f32_e32 v187, v187, v229
	v_dual_mul_f32 v188, v188, v229 :: v_dual_lshlrev_b32 v123, 16, v142
	...
	v_dual_mul_f32 v205, v205, v229 :: v_dual_fmac_f32 v94, v159, v2
	v_mul_f32_e32 v206, v206, v229
	v_dual_mul_f32 v207, v207, v229 :: v_dual_fmac_f32 v88, v161, v6
	v_mul_f32_e32 v208, v208, v229
	v_dual_mul_f32 v209, v209, v229 :: v_dual_fmac_f32 v86, v162, v7
	v_dual_mul_f32 v212, v212, v229 :: v_dual_fmac_f32 v83, v163, v8
	v_dual_mul_f32 v213, v213, v229 :: v_dual_fmac_f32 v60, v171, v23
	v_dual_mul_f32 v214, v214, v229 :: v_dual_fmac_f32 v79, v165, v10
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v18, 16, v115
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v218, v218, v229 :: v_dual_lshlrev_b32 v19, 16, v116
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v99, v172, v24 :: v_dual_lshlrev_b32 v20, 16, v117
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_mul_f32_e32 v211, v211, v229
	v_dual_mul_f32 v216, v216, v229 :: v_dual_lshlrev_b32 v21, 16, v118
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_fmac_f32_e32 v77, v166, v18
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v33, 16, v122
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v69, v170, v22 :: v_dual_lshlrev_b32 v4, 16, v109
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	v_mul_f32_e32 v210, v210, v229
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v108, 16, v127
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v93, v175, v35 :: v_dual_lshlrev_b32 v106, 16, v125
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v109, 16, v128
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(24)
	v_dual_mul_f32 v215, v215, v229 :: v_dual_lshlrev_b32 v112, 16, v131
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v87, v177, v107 :: v_dual_lshlrev_b32 v110, 16, v129
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(21)
	v_dual_mul_f32 v219, v219, v229 :: v_dual_lshlrev_b32 v118, 16, v136
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v78, v181, v111 :: v_dual_lshlrev_b32 v9, 16, v113
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v113, 16, v132
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v217, v217, v229 :: v_dual_fmac_f32 v80, v180, v110
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x2
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v85, v178, v108 :: v_dual_lshlrev_b32 v114, 16, v133
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	s_waitcnt vmcnt(19)
	v_dual_fmac_f32 v73, v190, v120 :: v_dual_lshlrev_b32 v130, 16, v149
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(18)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v84, v189, v119 :: v_dual_lshlrev_b32 v117, 16, v137
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(16)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v59, v193, v123 :: v_dual_lshlrev_b32 v134, 16, v153
	s_waitcnt vmcnt(10)
	v_dual_fmac_f32 v62, v192, v122 :: v_dual_lshlrev_b32 v139, 16, v221
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(9)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	s_waitcnt vmcnt(6)
	v_dual_fmac_f32 v52, v196, v126 :: v_dual_lshlrev_b32 v143, 16, v225
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(5)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v76, v182, v112 :: v_dual_add_nc_u32 v101, s47, v101
	v_dual_fmac_f32 v68, v185, v115 :: v_dual_add_nc_u32 v105, s34, v105
	v_dual_fmac_f32 v96, v158, v1 :: v_dual_fmac_f32 v45, v200, v130
	v_fmac_f32_e32 v91, v160, v4
	v_dual_fmac_f32 v75, v167, v19 :: v_dual_fmac_f32 v72, v168, v20
	v_dual_fmac_f32 v70, v169, v21 :: v_dual_fmac_f32 v57, v194, v124
	v_dual_fmac_f32 v97, v173, v33 :: v_dual_fmac_f32 v42, v202, v132
	v_fmac_f32_e32 v90, v176, v106
	v_dual_fmac_f32 v82, v179, v109 :: v_dual_fmac_f32 v49, v198, v128
	v_dual_fmac_f32 v74, v183, v113 :: v_dual_fmac_f32 v43, v201, v131
	v_dual_fmac_f32 v56, v187, v117 :: v_dual_fmac_f32 v67, v204, v134
	v_fmac_f32_e32 v92, v188, v118
	v_fmac_f32_e32 v81, v164, v9
	v_dual_fmac_f32 v64, v191, v121 :: v_dual_fmac_f32 v63, v206, v136
	v_dual_fmac_f32 v54, v195, v125 :: v_dual_fmac_f32 v55, v209, v139
	v_dual_fmac_f32 v47, v199, v129 :: v_dual_fmac_f32 v66, v205, v135
	v_dual_fmac_f32 v51, v211, v141 :: v_dual_fmac_f32 v48, v212, v142
	v_dual_fmac_f32 v46, v213, v143 :: v_dual_fmac_f32 v41, v215, v145
	v_dual_fmac_f32 v50, v197, v127 :: v_dual_fmac_f32 v53, v210, v140
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(2)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v38, v203, v133 :: v_dual_lshlrev_b32 v149, 16, v231
	v_dual_fmac_f32 v61, v207, v137 :: v_dual_fmac_f32 v58, v208, v138
	v_dual_fmac_f32 v44, v214, v144 :: v_dual_fmac_f32 v39, v217, v147
	v_dual_fmac_f32 v40, v216, v146 :: v_dual_fmac_f32 v37, v218, v148
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v36, v219, v149
	.loc	1 278 13                        ; generate_amdgcn.py:278:13
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.numbered_sgpr, 55
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.private_seg_size, 92
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
    .private_segment_fixed_size: 92
    .sgpr_count:     57
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.kd
