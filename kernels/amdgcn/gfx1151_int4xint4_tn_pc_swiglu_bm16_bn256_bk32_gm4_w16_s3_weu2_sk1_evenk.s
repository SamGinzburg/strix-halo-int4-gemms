	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s6, v38, v[2:3]
	...
	s_lshl_b32 s5, s7, 1
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_xor_b32 s29, s4, s26
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_mad_u64_u32 v[5:6], null, s5, v1, v[3:4]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_sub_i32 s4, s29, s26
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v14, v8, s[16:19], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[5:6], v5, s[20:23], 0 offen
	buffer_load_b64 v[7:8], v11, s[20:23], 0 offen
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v15, v4, s[16:19], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[10:11], v12, s[20:23], 0 offen
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v16, v15 offset:16640
...
.Ltmp15:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add3_u32 v24, v6, s5, v2
	s_lshl_b32 s26, s7, 5
	v_mul_lo_u32 v7, s7, v1
	v_mov_b32_e32 v1, 0
	v_and_or_b32 v22, 0x88, v4, v18
	s_add_i32 s0, 0, 0x4000
	s_add_i32 s11, 0, 0x4100
	...
	v_add3_u32 v4, v5, s22, v3
	v_add3_u32 v3, v7, s22, v3
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v14, v1
	v_subrev_nc_u32_e32 v25, s23, v4
	v_subrev_nc_u32_e32 v26, s23, v3
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v37, v24, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[27:28], v26, s[20:23], 0 offen
	buffer_load_b64 v[29:30], v25, s[20:23], 0 offen
	s_mov_b32 s29, s0
	s_mov_b32 s0, s11
	s_mov_b32 s11, s25
	s_mov_b32 s25, s3
	v_add_nc_u32_e32 v32, s11, v20
	s_mov_b32 s3, s6
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v31, s29, v22
	v_add_nc_u32_e32 v33, s29, v23
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v34, s3, v20
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v35, v32 offset:1280
	ds_load_u8 v36, v32 offset:1792
	ds_load_u8 v40, v32 offset:1536
	ds_load_u8 v41, v32 offset:1024
	ds_load_u8 v42, v32 offset:256
	ds_load_u8 v43, v32 offset:768
	ds_load_u8 v44, v32 offset:512
	ds_load_u8 v45, v32
	ds_load_u8 v46, v32 offset:3328
	ds_load_u8 v47, v32 offset:3840
	ds_load_u8 v48, v32 offset:3584
	ds_load_u8 v49, v32 offset:3072
	ds_load_u8 v50, v32 offset:2304
	ds_load_u8 v51, v32 offset:2816
	ds_load_u8 v52, v32 offset:2560
	ds_load_u8 v53, v32 offset:2048
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v54, v34 offset:1280
	ds_load_u8 v55, v34 offset:1792
	ds_load_u8 v56, v34 offset:1536
	ds_load_u8 v57, v34 offset:1024
	ds_load_u8 v58, v34 offset:256
	ds_load_u8 v59, v34 offset:768
	ds_load_u8 v60, v34 offset:512
	ds_load_u8 v61, v34
	ds_load_u8 v62, v34 offset:3328
	ds_load_u8 v63, v34 offset:3840
	ds_load_u8 v64, v34 offset:3584
	ds_load_u8 v65, v34 offset:3072
	ds_load_u8 v66, v34 offset:2304
	ds_load_u8 v67, v34 offset:2816
	ds_load_u8 v68, v34 offset:2560
	...
	v_perm_b32 v35, v41, v35, 0xc0c0004
	v_perm_b32 v36, v40, v36, 0xc0c0004
	...
	v_perm_b32 v46, v57, v54, 0xc0c0004
	v_perm_b32 v47, v56, v55, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v49, v60, v59, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v48, v61, v58, 0xc0c0004
	s_mov_b32 s6, s1
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s1, s27, 1
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_perm_b32 v44, v53, v50, 0xc0c0004
	...
	s_cmp_lt_i32 s1, 2
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v40, v45, 16, v44
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cselect_b32 s27, s1, 0
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_lshl_or_b32 v45, v51, 16, v50
	v_lshl_or_b32 v44, v53, 16, v52
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[35:36], v[31:32], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[42:43], v[31:32], v[1:8] neg_lo:[1,1,0]
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_lshl_b32 s1, s27, 8
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_lshl_b32 s3, s27, 12
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	s_add_i32 s1, s1, 0
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_add_i32 s3, s3, 0
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v31, s1, v21
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[40:41], v[33:34], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[44:45], v[33:34], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s28, s28, -1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v31, v37 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v32, v[27:28], v[29:30] offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %._crit_edge.loopexit
	.loc	1 0 9 is_stmt 0                 ; generate_amdgcn.py:0:9
	v_or_b32_e32 v41, 0x100, v20
	v_or_b32_e32 v43, 0x200, v20
	v_or_b32_e32 v44, 0x300, v20
	v_or_b32_e32 v45, 0x400, v20
	v_or_b32_e32 v46, 0x500, v20
	v_or_b32_e32 v47, 0x600, v20
	v_or_b32_e32 v48, 0x700, v20
	v_or_b32_e32 v40, 0x800, v20
	v_or_b32_e32 v42, 0x900, v20
	v_or_b32_e32 v49, 0xa00, v20
	v_or_b32_e32 v50, 0xb00, v20
	v_or_b32_e32 v51, 0xc00, v20
	v_or_b32_e32 v52, 0xd00, v20
	v_or_b32_e32 v54, 0xe00, v20
	v_or_b32_e32 v55, 0xf00, v20
	v_dual_mov_b32 v22, v19 :: v_dual_mov_b32 v53, v20
	s_mov_b32 s22, s25
	s_branch .LBB0_8
.LBB0_7:
	v_mov_b32_e32 v8, 0
...
.LBB0_8:                                ; %._crit_edge
	...
	v_xor_b32_e32 v30, 8, v9
	v_add_nc_u32_e32 v18, s0, v9
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_add_nc_u32_e32 v19, s0, v30
...
; %bb.9:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v25, s22, v46
	v_add_nc_u32_e32 v31, s22, v45
	v_add_nc_u32_e32 v23, s22, v48
	v_add_nc_u32_e32 v34, s22, v41
	v_add_nc_u32_e32 v24, s22, v47
	v_add_nc_u32_e32 v32, s22, v44
	v_add_nc_u32_e32 v33, s22, v43
	v_add_nc_u32_e32 v35, s22, v53
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v25, v25
	ds_load_u8 v31, v31
	ds_load_u8 v23, v23
	...
	ds_load_u8 v24, v24
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v20, s22, v52
	v_add_nc_u32_e32 v21, s22, v51
	v_add_nc_u32_e32 v18, s22, v55
	v_add_nc_u32_e32 v37, s22, v40
	v_add_nc_u32_e32 v22, s22, v50
	v_add_nc_u32_e32 v36, s22, v49
	v_add_nc_u32_e32 v56, s22, v42
	...
	ds_load_u8 v56, v56
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v18, v31, v25, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	...
	v_dual_mov_b32 v19, v11 :: v_dual_mov_b32 v18, v10
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v34, v61, v59, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v37, v56, 0xc0c0004
	v_perm_b32 v36, v36, v60, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[18:25], v[31:32], v[28:29], v[18:25] neg_lo:[1,1,0]
	v_lshl_or_b32 v32, v34, 16, v33
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v31, v36, 16, v35
	v_wmma_i32_16x16x16_iu4 v[18:25], v[31:32], v[26:27], v[18:25] neg_lo:[1,1,0]
.LBB0_10:
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
...
; %bb.11:
	...
	v_add_nc_u32_e32 v32, s6, v45
	v_add_nc_u32_e32 v16, s6, v48
	v_add_nc_u32_e32 v35, s6, v41
	v_add_nc_u32_e32 v17, s6, v47
	v_add_nc_u32_e32 v33, s6, v44
	v_add_nc_u32_e32 v34, s6, v43
	v_add_nc_u32_e32 v36, s6, v53
	v_add_nc_u32_e32 v12, s6, v52
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v31, v31
	ds_load_u8 v32, v32
	ds_load_u8 v16, v16
	...
	ds_load_u8 v17, v17
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v13, s6, v51
	v_add_nc_u32_e32 v10, s6, v55
	v_add_nc_u32_e32 v37, s6, v40
	v_add_nc_u32_e32 v14, s6, v50
	v_add_nc_u32_e32 v15, s6, v49
	v_add_nc_u32_e32 v56, s6, v42
	...
	v_perm_b32 v16, v36, v35, 0xc0c0004
	v_perm_b32 v17, v34, v33, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v16, v37, v56, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[10:11], v[28:29], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[10:11], v[26:27], v[1:8] neg_lo:[1,1,0]
...
.LBB0_12:                               ; %._crit_edge54
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v29, v13 :: v_dual_add_nc_u32 v26, s11, v30
	v_dual_mov_b32 v31, v15 :: v_dual_mov_b32 v30, v14
	ds_load_b64 v[36:37], v9
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_b64 v[34:35], v26
	v_cndmask_b32_e64 v9, 0, 1, s2
	v_dual_mov_b32 v27, v17 :: v_dual_mov_b32 v28, v12
	v_dual_mov_b32 v26, v16 :: v_dual_mov_b32 v33, v11
...
; %bb.13:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v33, s3, v46
	v_add_nc_u32_e32 v56, s3, v45
	v_add_nc_u32_e32 v31, s3, v48
	v_add_nc_u32_e32 v59, s3, v41
	v_add_nc_u32_e32 v32, s3, v47
	v_add_nc_u32_e32 v57, s3, v44
	v_add_nc_u32_e32 v58, s3, v43
	...
	ds_load_u8 v32, v32
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v28, s3, v51
	v_add_nc_u32_e32 v9, s3, v55
	v_add_nc_u32_e32 v61, s3, v40
	v_add_nc_u32_e32 v29, s3, v50
	v_add_nc_u32_e32 v30, s3, v49
	v_add_nc_u32_e32 v62, s3, v42
	v_add_nc_u32_e32 v26, s3, v54
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v63, v27
	ds_load_u8 v28, v28
	ds_load_u8 v9, v9
	...
	ds_load_u8 v62, v62
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v26, v56, v33, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v27, v32, v31, 0xc0c0004
	v_perm_b32 v31, v60, v59, 0xc0c0004
	v_perm_b32 v32, v58, v57, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v28, v28, v63, 0xc0c0004
	v_lshl_or_b32 v27, v27, 16, v26
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v29, v30, v29, 0xc0c0004
	v_lshl_or_b32 v26, v32, 16, v31
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v9, v64, v9, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v31, v61, v62, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[18:25], v[26:27], v[36:37], v[18:25] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v27, v9, 16, v28
	v_lshl_or_b32 v26, v29, 16, v31
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[18:25], v[26:27], v[34:35], v[18:25] neg_lo:[1,1,0]
...
; %bb.15:
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[9:10], v[36:37], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v10, v12, 16, v11
	v_lshl_or_b32 v9, v13, 16, v15
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[9:10], v[34:35], v[1:8] neg_lo:[1,1,0]
	s_branch .LBB0_17
.LBB0_16:
...
.LBB0_17:
	...
	s_mov_b32 s16, s14
	.loc	1 143 22 is_stmt 0              ; generate_amdgcn.py:143:22
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v14, v17, v14 :: v_dual_lshlrev_b32 v11, 1, v11
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v32, 0xbfb8aa3b, v1 :: v_dual_mul_f32 v15, v17, v15
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v3, v15, v3 :: v_dual_and_b32 v0, 16, v0
	...
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v5, v14, v5 :: v_dual_mul_f32 v20, v17, v20
	v_dual_mul_f32 v7, v12, v7 :: v_dual_mul_f32 v14, 0xbfb8aa3b, v2
	v_mul_f32_e32 v4, v16, v4
	v_mul_f32_e32 v8, v18, v8
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v12, v20, v33
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_waitcnt vmcnt(4)
	...
	.loc	1 149 44 is_stmt 1              ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v21, 0xbfb8aa3b, v3 :: v_dual_mul_f32 v24, v17, v24
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	v_dual_mul_f32 v11, v11, v27 :: v_dual_mul_f32 v6, v13, v6
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v16, v16, v31 :: v_dual_mul_f32 v13, v13, v26
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v26, 0xbfb8aa3b, v8 :: v_dual_fmac_f32 v17, 0xbfb8aa3b, v1
	v_mul_f32_e32 v23, 0xbfb8aa3b, v5
	v_cmp_gt_f32_e64 s0, 0xc2fc0000, v22
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v18, v24, v29 :: v_dual_mul_f32 v15, v15, v30
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 73
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
