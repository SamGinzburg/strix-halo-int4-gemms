...
.Ltmp11:
	...
	v_mad_u64_u32 v[5:6], null, s11, v4, v[2:3]
...
.Ltmp13:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[7:10], v7, s[16:19], 0 offen
	buffer_load_b128 v[11:14], v11, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v15, v15, s[12:15], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[18:21], v5, s[16:19], 0 offen
	buffer_load_b128 v[25:28], v6, s[16:19], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	s_waitcnt vmcnt(5)
	ds_store_b32 v22, v16 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v29, v[7:10]
	s_waitcnt vmcnt(3)
	ds_store_b128 v29, v[11:14] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v22, v15 offset:17408
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v1, s21, v1
	s_lshl_b32 s18, s26, 7
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v6, 0xa0, v4
	v_add_nc_u32_e32 v4, 0x80, v4
	v_lshl_or_b32 v19, v17, 6, v5
	s_lshl_b32 s19, s25, 7
	v_mul_lo_u32 v6, s11, v6
	v_mov_b32_e32 v14, 0
	v_mul_lo_u32 v7, s11, v4
	v_mad_u64_u32 v[4:5], null, s24, v1, s[10:11]
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v20, 16, v19
	v_xor_b32_e32 v21, 32, v19
	v_add3_u32 v5, v6, s18, v2
	v_xor_b32_e32 v22, 48, v19
	v_add3_u32 v2, v7, s18, v2
	v_add3_u32 v25, v4, v3, 0x80
	v_mov_b32_e32 v3, v1
	v_subrev_nc_u32_e32 v26, s19, v5
	v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v11, 0
	v_subrev_nc_u32_e32 v27, s19, v2
	v_mov_b32_e32 v2, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v76, v25, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[36:39], v27, s[16:19], 0 offen
	buffer_load_b128 v[40:43], v26, s[16:19], 0 offen
	s_mov_b32 s26, s1
	s_mov_b32 s1, s0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_add_i32 s24, s24, -1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_lshl_b32 s0, s25, 10
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_lshl_b32 s10, s25, 13
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_dual_add_f32 v9, v9, v28 :: v_dual_add_nc_u32 v26, s22, v26
	v_dual_add_f32 v10, v10, v29 :: v_dual_add_nc_u32 v27, s22, v27
	v_dual_add_f32 v16, v16, v31 :: v_dual_add_nc_u32 v25, 64, v25
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v117, s26, v24
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v13, v13, v34 :: v_dual_add_nc_u32 v118, s10, v23
	v_dual_add_f32 v15, v15, v30 :: v_dual_add_f32 v12, v12, v33
	v_dual_add_f32 v11, v11, v32 :: v_dual_add_f32 v14, v14, v35
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_add_i32 s0, s26, 0x4000
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmp_lg_u32 s24, 0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(2)
...
; %bb.9:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v10, v10, v6 :: v_dual_add_f32 v11, v11, v3
	v_dual_add_f32 v9, v9, v7 :: v_dual_add_f32 v14, v14, v4
	s_delay_alu instid0(VALU_DEP_3)
...
.LBB0_12:
	...
	v_or3_b32 v2, v2, v18, s20
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v9, v3 :: v_dual_lshlrev_b32 v18, 1, v17
	...
	buffer_load_u16 v19, v2, s[12:15], 0 offen
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v8, v16, v8 :: v_dual_add_f32 v23, v13, v23
	v_dual_add_f32 v4, v10, v4 :: v_dual_add_f32 v5, v11, v5
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v3, v3, v15 :: v_dual_lshlrev_b32 v18, 16, v20
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	v_dual_mul_f32 v21, v12, v21 :: v_dual_lshlrev_b32 v20, 16, v22
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	...
	v_dual_mul_f32 v2, v12, v2 :: v_dual_mul_f32 v5, v5, v21
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 119
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 28
