	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_mul_hi_u32 s13, s20, s21
	s_add_i32 s13, s20, s13
	s_waitcnt lgkmcnt(0)
	s_mov_b64 s[20:21], s[6:7]
	s_mul_hi_u32 s6, s16, s13
	s_xor_b32 s7, s2, s18
	s_mul_i32 s13, s6, s19
	s_ashr_i32 s30, s7, 31
	s_sub_i32 s7, s16, s13
	s_add_i32 s13, s6, 1
	s_sub_i32 s16, s7, s19
	s_cmp_ge_u32 s7, s19
...
.Ltmp19:
	...
	v_or_b16 v18.h, v27.h, v18.h
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v19.l, v28.l, v19.l
	v_or_b16 v19.h, v28.h, v19.h
	v_or_b16 v20.l, v29.l, v20.l
	v_or_b16 v20.h, v29.h, v20.h
	v_or_b16 v21.l, v30.l, v21.l
	v_or_b16 v21.h, v30.h, v21.h
...
; %bb.4:                                ; %.lr.ph
	...
	v_subrev_nc_u32_e32 v55, s10, v1
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v53, 48, v50
	v_subrev_nc_u32_e32 v54, s10, v5
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v22, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v21, 0
	v_mov_b32_e32 v5, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[9:12], v55, s[20:23], 0 offen
	buffer_load_b128 v[13:16], v54, s[20:23], 0 offen
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s18, s37, s18
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_ashr_i32 s18, s18, 6
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s38, s18, s15
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v58, v36, s18, 1
	...
	v_add_lshl_u32 v63, v29, s38, 1
	v_add_lshl_u32 v64, v32, s38, 1
	v_add_lshl_u32 v65, v30, s38, 1
	v_add_lshl_u32 v66, v28, s38, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v98, v58, s[24:27], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	...
	buffer_load_u16 v106, v66, s[28:31], 0 offen
	s_mov_b32 s18, s10
	s_mov_b32 s10, s1
	s_mov_b32 s1, s19
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v58, s18, v26
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v59, s1, v50
	v_add_nc_u32_e32 v60, s1, v51
	v_add_nc_u32_e32 v61, s1, v52
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v148, s14, v42
	v_add_nc_u32_e32 v149, s14, v43
	v_add_nc_u32_e32 v150, s14, v44
	v_add_nc_u32_e32 v151, s14, v45
	v_add_nc_u32_e32 v153, s14, v47
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s18, s37, 64
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_add_i32 s1, s38, 0x4000
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s11, 0
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(11)
	...
	v_dual_fmac_f32 v19, v59, v65 :: v_dual_add_nc_u32 v152, s14, v46
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v9, v57, v9 :: v_dual_add_nc_u32 v54, s34, v54
	v_dual_mul_f32 v10, v57, v10 :: v_dual_add_nc_u32 v55, s34, v55
	v_dual_mul_f32 v11, v57, v11 :: v_dual_add_nc_u32 v56, s35, v56
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v21, v14, v70 :: v_dual_add_nc_u32 v154, s14, v48
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b16 v15.l, v15.l, v63.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v18, v9, v67 :: v_dual_fmac_f32 v25, v10, v66
	v_dual_fmac_f32 v24, v11, v69 :: v_dual_fmac_f32 v23, v12, v68
	v_fmac_f32_e32 v22, v13, v71
	v_fmac_f32_e32 v20, v57, v72
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v10, v38 :: v_dual_mov_b32 v5, v41
	v_dual_mov_b32 v50, v39 :: v_dual_mov_b32 v51, v40
...
.LBB0_8:                                ; %._crit_edge
	...
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v4, v2, v49
	v_mov_b32_e32 v2, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b32_e32 v15, v4, v5
	v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v5, 0
	v_xor_b32_e32 v38, 16, v15
	v_xor_b32_e32 v39, 32, v15
	v_xor_b32_e32 v40, 48, v15
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
; %bb.9:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s19, v40
	v_add_nc_u32_e32 v6, s19, v39
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v11, v16 offset:208
	ds_load_u8 v12, v16 offset:224
	ds_load_u8 v13, v16 offset:192
	ds_load_u8 v41, v16 offset:240
	ds_load_u8 v42, v16 offset:144
	ds_load_u8 v43, v16 offset:176
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v46, v16 offset:112
	ds_load_u8 v47, v16 offset:80
	ds_load_u8 v48, v16 offset:96
	ds_load_u8 v53, v16 offset:64
	ds_load_u8 v54, v16
	ds_load_u8 v57, v16 offset:16
	ds_load_u8 v58, v16 offset:32
	ds_load_u8 v59, v16 offset:48
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v42, v45, v42, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v44, v54, v57, 0xc0c0004
	v_perm_b32 v55, v13, v11, 0xc0c0004
	v_perm_b32 v41, v12, v41, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v45, v58, v59, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v56, v41, 16, v55
	v_lshl_or_b32 v55, v43, 16, v42
	v_perm_b32 v42, v53, v47, 0xc0c0004
	v_perm_b32 v43, v48, v46, 0xc0c0004
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v14, s19, v38
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v37, s19, v15
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v60, v16 offset:336
	ds_load_u8 v61, v16 offset:352
	ds_load_u8 v62, v16 offset:320
	ds_load_u8 v63, v16 offset:272
	ds_load_u8 v64, v16 offset:304
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v37, s10, v10
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v57, v16 offset:496
	ds_load_u8 v58, v16 offset:400
	ds_load_u8 v59, v16 offset:432
	ds_load_u8 v70, v16 offset:416
	ds_load_u8 v71, v16 offset:384
	ds_load_u8 v72, v16 offset:368
	v_lshl_or_b32 v53, v45, 16, v44
	v_mov_b32_e32 v44, v41
	ds_load_u8 v67, v16 offset:464
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v62, v66, v63, 0xc0c0004
	v_perm_b32 v63, v65, v64, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_wmma_i32_16x16x16_iu8 v[41:48], v[49:52], v[53:56], v[41:48] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v59, v70, v59, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v58, v71, v58, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v61, v61, v72, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v57, v68, v57, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v67, v69, v67, 0xc0c0004
	ds_load_u8 v69, v16 offset:592
	ds_load_u8 v73, v16 offset:608
	ds_load_u8 v74, v16 offset:576
	ds_load_u8 v75, v16 offset:528
	ds_load_u8 v76, v16 offset:560
	ds_load_u8 v77, v16 offset:544
	ds_load_u8 v78, v16 offset:512
	v_lshl_or_b32 v51, v59, 16, v58
	v_lshl_or_b32 v50, v61, 16, v60
	v_lshl_or_b32 v49, v63, 16, v62
	v_lshl_or_b32 v52, v57, 16, v67
	ds_load_u8 v53, v16 offset:752
	ds_load_u8 v54, v16 offset:720
	ds_load_u8 v55, v16 offset:736
	ds_load_u8 v56, v16 offset:704
	ds_load_u8 v57, v16 offset:656
	ds_load_u8 v58, v16 offset:672
	ds_load_u8 v59, v16 offset:640
	ds_load_u8 v60, v16 offset:688
	ds_load_u8 v61, v16 offset:624
	ds_load_u8 v62, v16 offset:976
	ds_load_u8 v63, v16 offset:992
	ds_load_u8 v64, v16 offset:960
	ds_load_u8 v65, v16 offset:912
	ds_load_u8 v66, v16 offset:944
	ds_load_u8 v67, v16 offset:928
	ds_load_u8 v68, v16 offset:896
	ds_load_u8 v70, v16 offset:880
	ds_load_u8 v71, v16 offset:848
	ds_load_u8 v72, v16 offset:864
	ds_load_u8 v79, v16 offset:832
	ds_load_u8 v80, v16 offset:784
	ds_load_u8 v81, v16 offset:816
	ds_load_u8 v82, v16 offset:800
	ds_load_u8 v16, v16 offset:768
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v54, v56, v54, 0xc0c0004
	v_perm_b32 v53, v55, v53, 0xc0c0004
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v55, v59, v57, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v56, v58, v60, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[41:48], v[11:14], v[49:52], v[41:48] neg_lo:[1,1,0]
	v_lshl_or_b32 v14, v53, 16, v54
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v49, v64, v62, 0xc0c0004
	v_lshl_or_b32 v13, v56, 16, v55
	v_perm_b32 v58, v73, v61, 0xc0c0004
	v_perm_b32 v57, v74, v69, 0xc0c0004
	v_perm_b32 v37, v63, v37, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v50, v68, v65, 0xc0c0004
	v_perm_b32 v60, v77, v76, 0xc0c0004
	v_perm_b32 v59, v78, v75, 0xc0c0004
	v_lshl_or_b32 v12, v58, 16, v57
	v_perm_b32 v51, v67, v66, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v52, v79, v71, 0xc0c0004
	v_perm_b32 v53, v72, v70, 0xc0c0004
	v_lshl_or_b32 v11, v60, 16, v59
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v16, v16, v80, 0xc0c0004
	v_perm_b32 v54, v82, v81, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[41:48], v[6:9], v[11:14], v[41:48] neg_lo:[1,1,0]
	v_lshl_or_b32 v9, v37, 16, v49
	v_lshl_or_b32 v8, v51, 16, v50
	v_lshl_or_b32 v7, v53, 16, v52
	v_lshl_or_b32 v6, v54, 16, v16
	v_wmma_i32_16x16x16_iu8 v[41:48], v[2:5], v[6:9], v[41:48] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v16, v29, s4, 1
	v_add_lshl_u32 v37, v32, s4, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v41, v11, s[8:11], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_dual_cndmask_b32 v11, 0x80000000, v12 :: v_dual_cndmask_b32 v12, 0x80000000, v13
	v_dual_cndmask_b32 v13, 0x80000000, v14 :: v_dual_cndmask_b32 v44, 0x80000000, v16
	v_add_lshl_u32 v14, v31, s4, 1
	v_add_lshl_u32 v42, v30, s4, 1
	v_add_lshl_u32 v43, v28, s4, 1
	s_and_b32 s17, s17, 0xffff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v45, 0x80000000, v37 :: v_dual_cndmask_b32 v14, 0x80000000, v14
	v_dual_cndmask_b32 v46, 0x80000000, v42 :: v_dual_cndmask_b32 v47, 0x80000000, v43
	s_clause 0x7
	buffer_load_u16 v42, v11, s[16:19], 0 offen
	buffer_load_u16 v43, v12, s[16:19], 0 offen
	buffer_load_u16 v16, v13, s[16:19], 0 offen
	buffer_load_u16 v37, v14, s[16:19], 0 offen
	buffer_load_u16 v13, v44, s[16:19], 0 offen
	buffer_load_u16 v14, v45, s[16:19], 0 offen
	buffer_load_u16 v11, v46, s[16:19], 0 offen
	buffer_load_u16 v12, v47, s[16:19], 0 offen
...
; %bb.11:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v39, v1 offset:112
	ds_load_u8 v40, v1 offset:80
	ds_load_u8 v51, v1 offset:96
	ds_load_u8 v52, v1 offset:64
	ds_load_u8 v53, v1
	ds_load_u8 v70, v1 offset:16
	ds_load_u8 v71, v1 offset:32
	...
	v_mov_b32_e32 v46, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v38, s14, v38
	v_add_nc_u32_e32 v15, s14, v15
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_lshl_or_b32 v73, v44, 16, v26
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v26, v51, v39, 0xc0c0004
	v_mov_b32_e32 v49, v46
	v_mov_b32_e32 v50, v46
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[62:65], v38
	ds_load_b128 v[66:69], v15
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v15, v52, v40, 0xc0c0004
	v_dual_mov_b32 v51, v46 :: v_dual_add_nc_u32 v10, s1, v10
	ds_load_u8 v45, v1 offset:336
	ds_load_u8 v75, v1 offset:352
	ds_load_u8 v76, v1 offset:320
	ds_load_u8 v77, v1 offset:272
	ds_load_u8 v78, v1 offset:304
	ds_load_u8 v79, v1 offset:288
	ds_load_u8 v80, v1 offset:256
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v47, v71, v74, 0xc0c0004
	ds_load_u8 v74, v1 offset:496
	ds_load_u8 v81, v1 offset:400
	ds_load_u8 v82, v1 offset:432
	ds_load_u8 v83, v1 offset:416
	ds_load_u8 v84, v1 offset:384
	v_lshl_or_b32 v71, v26, 16, v15
	ds_load_u8 v15, v1 offset:368
	ds_load_u8 v38, v1 offset:464
	ds_load_u8 v39, v1 offset:480
	ds_load_u8 v40, v1 offset:448
	ds_load_u8 v10, v10
	v_perm_b32 v44, v53, v70, 0xc0c0004
	v_mov_b32_e32 v48, v46
	v_mov_b32_e32 v52, v46
	v_mov_b32_e32 v53, v46
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v70, v47, 16, v44
	v_mov_b32_e32 v47, v46
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v45, v76, v45, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[46:53], v[66:69], v[70:73], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v76, v79, v78, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v39, v39, v74, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v26, v40, v38, 0xc0c0004
	ds_load_u8 v38, v1 offset:592
	ds_load_u8 v40, v1 offset:608
	ds_load_u8 v44, v1 offset:576
	ds_load_u8 v85, v1 offset:528
	ds_load_u8 v86, v1 offset:560
	ds_load_u8 v87, v1 offset:544
	ds_load_u8 v88, v1 offset:512
	v_perm_b32 v74, v84, v81, 0xc0c0004
	v_perm_b32 v81, v83, v82, 0xc0c0004
	v_perm_b32 v15, v75, v15, 0xc0c0004
	v_perm_b32 v75, v80, v77, 0xc0c0004
	v_lshl_or_b32 v69, v39, 16, v26
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v68, v81, 16, v74
	v_lshl_or_b32 v67, v15, 16, v45
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v66, v76, 16, v75
	ds_load_u8 v15, v1 offset:752
	ds_load_u8 v26, v1 offset:720
	ds_load_u8 v39, v1 offset:736
	ds_load_u8 v45, v1 offset:704
	ds_load_u8 v70, v1 offset:656
	ds_load_u8 v71, v1 offset:672
	ds_load_u8 v72, v1 offset:640
	ds_load_u8 v73, v1 offset:688
	ds_load_u8 v74, v1 offset:624
	ds_load_u8 v75, v1 offset:976
	ds_load_u8 v76, v1 offset:992
	ds_load_u8 v77, v1 offset:960
	ds_load_u8 v78, v1 offset:912
	ds_load_u8 v79, v1 offset:944
	ds_load_u8 v80, v1 offset:928
	ds_load_u8 v81, v1 offset:896
	ds_load_u8 v82, v1 offset:880
	ds_load_u8 v83, v1 offset:848
	...
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v26, v45, v26, 0xc0c0004
	v_perm_b32 v15, v39, v15, 0xc0c0004
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v39, v72, v70, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v45, v71, v73, 0xc0c0004
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v40, v40, v74, 0xc0c0004
	v_perm_b32 v38, v44, v38, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[46:53], v[62:65], v[66:69], v[46:53] neg_lo:[1,1,0]
	v_lshl_or_b32 v65, v15, 16, v26
	v_perm_b32 v70, v87, v86, 0xc0c0004
	v_perm_b32 v44, v88, v85, 0xc0c0004
	v_lshl_or_b32 v64, v45, 16, v39
	v_lshl_or_b32 v63, v40, 16, v38
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v15, v77, v75, 0xc0c0004
	v_perm_b32 v10, v76, v10, 0xc0c0004
	v_lshl_or_b32 v62, v70, 16, v44
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v26, v81, v78, 0xc0c0004
	v_perm_b32 v38, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v39, v89, v83, 0xc0c0004
	v_perm_b32 v40, v84, v82, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v1, v1, v90, 0xc0c0004
	v_perm_b32 v44, v92, v91, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[46:53], v[58:61], v[62:65], v[46:53] neg_lo:[1,1,0]
	v_lshl_or_b32 v61, v10, 16, v15
	v_lshl_or_b32 v60, v38, 16, v26
	v_lshl_or_b32 v59, v40, 16, v39
	v_lshl_or_b32 v58, v44, 16, v1
...
.LBB0_12:
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(1)
	v_mov_b16_e32 v11.h, v43.l
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s1, s1, 26
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v37.h, v11.l
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s1, s22, s1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_mov_b32 s18, s10
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v26, v34, s1, 1
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v34.l, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v15, v35, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_dual_cndmask_b32 v29, 0x80000000, v29 :: v_dual_cndmask_b32 v30, 0x80000000, v30
	v_dual_cndmask_b32 v28, 0x80000000, v28 :: v_dual_mul_f32 v11, v34, v11
	s_clause 0x7
	...
	s_waitcnt vmcnt(9)
	v_mov_b16_e32 v12.h, v42.l
	v_mov_b16_e32 v13.h, v37.l
	v_mov_b16_e32 v14.h, v16.l
	v_mov_b16_e32 v16.h, v14.l
	v_mov_b16_e32 v35.h, v13.l
	v_mov_b16_e32 v36.h, v12.l
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v11, v8, v25
	v_fma_f32 v7, v13, v7, v23
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v14, v4, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v11, v10, v11 :: v_dual_lshlrev_b32 v14, 16, v33
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v13, v10, v13 :: v_dual_lshlrev_b32 v18, 16, v28
	v_mul_f32_e32 v12, v10, v12
	v_mul_f32_e32 v14, v10, v14
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v11, v11, v45, v8
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v19, 16, v30
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v3, v16, v3, v21
	v_fma_f32 v1, v12, v1, v6
	v_fma_f32 v12, v13, v49, v7
	v_fma_f32 v13, v14, v46, v4
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v15, v10, v15 :: v_dual_lshlrev_b32 v16, 16, v29
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v15, v16, v44, v2
	v_fma_f32 v16, v19, v48, v5
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 155
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
