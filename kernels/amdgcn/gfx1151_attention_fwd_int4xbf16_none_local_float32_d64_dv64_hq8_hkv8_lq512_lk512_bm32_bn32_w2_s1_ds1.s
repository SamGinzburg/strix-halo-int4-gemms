...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v2, s3, v44
	v_dual_mov_b32 v46, 0x7632 :: v_dual_and_b32 v5, 24, v43
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 779 31                        ; attention.py:779:31
	v_lshlrev_b32_e32 v1, 1, v1
	v_dual_mov_b32 v43, 0x5410 :: v_dual_add_nc_u32 v112, s13, v2
	...
	v_lshl_or_b32 v114, v33, 5, v5
	v_lshl_add_u32 v110, v33, 1, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v113, v93, v4
	...
	v_cndmask_b32_e64 v36, 0x1054, v43, s1
	v_cndmask_b32_e64 v37, 0x3276, v46, s1
	v_cndmask_b32_e64 v69, v35, v39, s1
	v_cndmask_b32_e64 v73, v39, v35, s1
	v_xor_b32_e32 v34, 8, v114
	v_xor_b32_e32 v35, 16, v114
	v_lshl_or_b32 v36, v36, 8, v36
	v_lshl_or_b32 v37, v37, 8, v37
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v116, 0, v34
	v_mov_b32_e32 v17, v25
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v117, 0, v35
	v_dual_mov_b32 v22, v25 :: v_dual_and_b32 v33, 0x540054, v36
	v_and_b32_e32 v34, 0x760076, v37
	v_cndmask_b32_e64 v67, v38, v41, s1
	v_cndmask_b32_e64 v71, v41, v38, s1
	.loc	1 844 25                        ; attention.py:844:25
	s_waitcnt lgkmcnt(0)
	s_mul_f32 s1, s8, 0x3fb8aa3b
	v_xor_b32_e32 v38, 24, v114
	...
	v_or_b32_e32 v107, s47, v77
	v_or_b32_e32 v108, s47, v76
	v_or_b32_e32 v109, s47, v78
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v111, s12, v2
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v118, 0, v38
	...
	v_dual_mov_b32 v14, v25 :: v_dual_mov_b32 v123, v119
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v45, 0, v113
	.loc	1 822 32                        ; attention.py:822:32
	v_mad_u64_u32 v[41:42], null, s1, s60, v[65:66]
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v33, s36 :: v_dual_add_nc_u32 v46, 0, v114
	...
	v_or_b32_e32 v51, s62, v76
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s3, v49, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s4, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s62, v77
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s5, v51, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s6, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s8, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s62, v80
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v51, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s10, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s12, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s62, v82
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s13, v51, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s14, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s16, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s62, v84
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v51, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s18, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s20, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s62, v87
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s21, v51, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v51, v112
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s26, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v51, s62, v90
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s27, v49, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s28, v49, v112
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v51, v112
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v51, s62, v85
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s31, v49, v111
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s33, v49, v112
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.num_vgpr, 145
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.numbered_sgpr, 68
