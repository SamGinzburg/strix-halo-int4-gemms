	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 96 22 is_stmt 1               ; generate_amdgcn.py:96:22
	s_lshr_b32 s1, s13, 1
	s_mov_b32 s13, s12
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
...
.Ltmp21:
	...
	v_or_b32_e32 v8, s29, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_subrev_nc_u32_e32 v115, s1, v9
	s_lshl_b32 s1, s14, 7
	s_mov_b32 s14, s12
	v_add_nc_u32_e32 v112, 0, v6
	v_dual_mov_b32 v105, 0 :: v_dual_add_nc_u32 v6, 32, v1
	...
	v_dual_mov_b32 v107, 0 :: v_dual_add_nc_u32 v2, 64, v8
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x1
	buffer_load_u16 v9, v118, s[24:27], 0 offen
	buffer_load_u16 v10, v117, s[24:27], 0 offen
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[128:129], v[33:34], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_wmma_i32_16x16x16_iu4 v[17:24], v[128:129], v[73:74], v[17:24] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 201 35                        ; generate_amdgcn.py:201:35
	...
	v_perm_b32 v26, v27, v26, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v128, v26, 16, v25
	v_wmma_i32_16x16x16_iu4 v[25:32], v[128:129], v[71:72], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v71, v112 offset:9856
	ds_load_u8 v72, v112 offset:9728
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v71, v72, v71, 0xc0c0004
	ds_load_u8 v72, v112 offset:10112
	ds_load_u8 v130, v112 offset:9984
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v72, v130, v72, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v72, v72, 16, v71
	ds_load_u8 v71, v112 offset:9344
	ds_load_u8 v130, v112 offset:9216
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v71, v130, v71, 0xc0c0004
	ds_load_u8 v130, v112 offset:9600
	ds_load_u8 v131, v112 offset:9472
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v130, v131, v130, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v71, v130, 16, v71
	...
	ds_load_u8 v130, v112 offset:11008
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v130, v68, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v68, v68, 16, v67
	ds_load_u8 v67, v112 offset:10368
	ds_load_u8 v130, v112 offset:10240
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v67, v130, v67, 0xc0c0004
	ds_load_u8 v130, v112 offset:10624
	ds_load_u8 v131, v112 offset:10496
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v130, v131, v130, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v130, v112 offset:12032
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v130, v64, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v64, v64, 16, v63
	ds_load_u8 v63, v112 offset:11392
	ds_load_u8 v130, v112 offset:11264
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v63, v130, v63, 0xc0c0004
	ds_load_u8 v130, v112 offset:11648
	ds_load_u8 v131, v112 offset:11520
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v130, v131, v130, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v63, v130, 16, v63
	...
	ds_load_u8 v130, v112 offset:13056
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v60, v130, v60, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v60, v60, 16, v59
	ds_load_u8 v59, v112 offset:12416
	ds_load_u8 v130, v112 offset:12288
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v59, v130, v59, 0xc0c0004
	ds_load_u8 v130, v112 offset:12672
	ds_load_u8 v131, v112 offset:12544
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v130, v131, v130, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v59, v130, 16, v59
	...
	ds_load_u8 v130, v112 offset:14080
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v40, v130, v40, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v131, v40, 16, v39
	ds_load_u8 v39, v112 offset:13440
	ds_load_u8 v40, v112 offset:13312
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v39, v40, v39, 0xc0c0004
	ds_load_u8 v40, v112 offset:13696
	ds_load_u8 v130, v112 offset:13568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v40, v130, v40, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v130, v40, 16, v39
	v_wmma_i32_16x16x16_iu4 v[25:32], v[130:131], v[37:38], v[25:32] neg_lo:[1,1,0]
	...
	v_perm_b32 v38, v39, v38, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v132, v38, 16, v37
	v_wmma_i32_16x16x16_iu4 v[25:32], v[132:133], v[35:36], v[25:32] neg_lo:[1,1,0]
	...
	.loc	1 202 36                        ; generate_amdgcn.py:202:36
	v_wmma_i32_16x16x16_iu4 v[25:32], v[134:135], v[33:34], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[128:129], v[51:52], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	.loc	1 202 36                        ; generate_amdgcn.py:202:36
	v_wmma_i32_16x16x16_iu4 v[33:40], v[130:131], v[65:66], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[132:133], v[69:70], v[33:40] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[33:40], v[134:135], v[73:74], v[33:40] neg_lo:[1,1,0]
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v128, v109 offset:16800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v128, v70, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v70, v70, 16, v69
	ds_load_u8 v69, v109 offset:16480
	ds_load_u8 v128, v109 offset:16416
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v69, v128, v69, 0xc0c0004
	ds_load_u8 v128, v109 offset:16608
	ds_load_u8 v129, v109 offset:16544
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v69, v128, 16, v69
	...
	ds_load_u8 v128, v109 offset:17312
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v128, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v52, v52, 16, v51
	ds_load_u8 v51, v109 offset:16992
	ds_load_u8 v128, v109 offset:16928
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v128, v51, 0xc0c0004
	ds_load_u8 v128, v109 offset:17120
	ds_load_u8 v129, v109 offset:17056
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v51, v128, 16, v51
	...
	ds_load_u8 v128, v109 offset:17824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v128, v56, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v56, v56, 16, v55
	ds_load_u8 v55, v109 offset:17504
	ds_load_u8 v128, v109 offset:17440
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v55, v128, v55, 0xc0c0004
	ds_load_u8 v128, v109 offset:17632
	ds_load_u8 v129, v109 offset:17568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v55, v128, 16, v55
	...
	ds_load_u8 v128, v109 offset:18336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v60, v128, v60, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v60, v60, 16, v59
	ds_load_u8 v59, v109 offset:18016
	ds_load_u8 v128, v109 offset:17952
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v59, v128, v59, 0xc0c0004
	ds_load_u8 v128, v109 offset:18144
	ds_load_u8 v129, v109 offset:18080
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v128, v109 offset:18848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v128, v62, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v62, v62, 16, v61
	ds_load_u8 v61, v109 offset:18528
	ds_load_u8 v128, v109 offset:18464
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v61, v128, v61, 0xc0c0004
	ds_load_u8 v128, v109 offset:18656
	ds_load_u8 v129, v109 offset:18592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v61, v128, 16, v61
	...
	ds_load_u8 v128, v109 offset:19360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v66, v128, v66, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v66, v66, 16, v65
	ds_load_u8 v65, v109 offset:19040
	ds_load_u8 v128, v109 offset:18976
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v65, v128, v65, 0xc0c0004
	ds_load_u8 v128, v109 offset:19168
	ds_load_u8 v129, v109 offset:19104
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v128, v109 offset:19872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v128, v68, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v68, v68, 16, v67
	ds_load_u8 v67, v109 offset:19552
	ds_load_u8 v128, v109 offset:19488
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v67, v128, v67, 0xc0c0004
	ds_load_u8 v128, v109 offset:19680
	ds_load_u8 v129, v109 offset:19616
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v128, v109 offset:20384
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v72, v128, v72, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v72, v72, 16, v71
	ds_load_u8 v71, v109 offset:20064
	ds_load_u8 v128, v109 offset:20000
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v71, v128, v71, 0xc0c0004
	ds_load_u8 v128, v109 offset:20192
	ds_load_u8 v129, v109 offset:20128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	ds_load_u8 v128, v112 offset:8960
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v128, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v74, v74, 16, v73
	ds_load_u8 v73, v112 offset:8320
	ds_load_u8 v128, v112 offset:8192
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v128, v73, 0xc0c0004
	ds_load_u8 v128, v112 offset:8576
	ds_load_u8 v129, v112 offset:8448
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v73, v128, 16, v73
	...
	v_add_nc_u32_e32 v41, v114, v116
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v48, v128, v48, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v48, v48, 16, v47
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v128, v50, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v50, v50, 16, v49
	ds_load_u8 v49, v112 offset:13440
	ds_load_u8 v128, v112 offset:13312
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v49, v128, v49, 0xc0c0004
	ds_load_u8 v128, v112 offset:13696
	ds_load_u8 v129, v112 offset:13568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v49, v128, 16, v49
	...
	ds_load_u8 v128, v112 offset:15104
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v128, v54, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v54, v54, 16, v53
	ds_load_u8 v53, v112 offset:14464
	ds_load_u8 v128, v112 offset:14336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v53, v128, v53, 0xc0c0004
	ds_load_u8 v128, v112 offset:14720
	ds_load_u8 v129, v112 offset:14592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v53, v128, 16, v53
	...
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v54, v41, s[8:11], 0 offen
	buffer_load_u16 v55, v41, s[8:11], 0 offen offset:4
	buffer_load_u16 v52, v41, s[8:11], 0 offen offset:8
	buffer_load_u16 v53, v41, s[8:11], 0 offen offset:12
	buffer_load_u16 v48, v41, s[8:11], 0 offen offset:16
	buffer_load_u16 v49, v41, s[8:11], 0 offen offset:20
	buffer_load_u16 v44, v41, s[8:11], 0 offen offset:24
	buffer_load_u16 v45, v41, s[8:11], 0 offen offset:28
	.loc	1 202 36                        ; generate_amdgcn.py:202:36
	...
	ds_load_u8 v128, v112 offset:16128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v128, v58, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v58, v58, 16, v57
	ds_load_u8 v57, v112 offset:15488
	ds_load_u8 v128, v112 offset:15360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v128, v57, 0xc0c0004
	ds_load_u8 v128, v112 offset:15744
	ds_load_u8 v129, v112 offset:15616
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v128, v129, v128, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v57, v128, 16, v57
	...
	v_add_nc_u32_e32 v41, v114, v115
	s_clause 0x7
	buffer_load_u16 v56, v41, s[8:11], 0 offen
	buffer_load_u16 v57, v41, s[8:11], 0 offen offset:4
	buffer_load_u16 v50, v41, s[8:11], 0 offen offset:8
	buffer_load_u16 v51, v41, s[8:11], 0 offen offset:12
	...
	buffer_load_u16 v43, v41, s[8:11], 0 offen offset:28
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v87, v18, v55
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_cvt_f32_i32_e32 v18, v34
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v34, v126, v10
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(12)
	v_dual_fmac_f32 v105, v34, v55 :: v_dual_lshlrev_b32 v34, 16, v53
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v36, v126, v11
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_cvt_f32_i32_e32 v11, v28
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v84, v19, v52 :: v_dual_lshlrev_b32 v19, 16, v51
	v_fmac_f32_e32 v100, v35, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v11, v126, v11 :: v_dual_lshlrev_b32 v34, 16, v49
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v22, v127, v22 :: v_dual_fmac_f32 v99, v36, v52
	v_dual_mul_f32 v21, v127, v21 :: v_dual_mul_f32 v36, v126, v14
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_cvt_f32_i32_e32 v14, v30
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v80, v22, v34
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_cvt_f32_i32_e32 v22, v38
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v96, v36, v34 :: v_dual_lshlrev_b32 v35, 16, v48
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v34, 16, v44
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v17, v127, v17 :: v_dual_lshlrev_b32 v54, 16, v54
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v22, v127, v22 :: v_dual_fmac_f32 v79, v21, v35
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v14, v126, v14 :: v_dual_lshlrev_b32 v21, 16, v47
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v95, v13, v35 :: v_dual_lshlrev_b32 v30, 16, v45
	...
	v_dual_mul_f32 v23, v127, v23 :: v_dual_fmac_f32 v88, v17, v54
	.loc	1 209 29                        ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v18, v127, v18 :: v_dual_lshlrev_b32 v17, 16, v57
	v_dual_mul_f32 v9, v126, v9 :: v_dual_mul_f32 v20, v127, v20
	v_dual_mul_f32 v28, v127, v28 :: v_dual_lshlrev_b32 v25, 16, v50
	v_mul_f32_e32 v26, v127, v26
	v_dual_mul_f32 v12, v126, v12 :: v_dual_lshlrev_b32 v27, 16, v46
	v_dual_mul_f32 v24, v127, v24 :: v_dual_mul_f32 v29, v126, v29
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v76, v13, v34
	v_dual_fmac_f32 v75, v23, v30 :: v_dual_fmac_f32 v104, v10, v41
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v92, v15, v34 :: v_dual_lshlrev_b32 v13, 16, v43
	.loc	1 209 17                        ; generate_amdgcn.py:209:17
	v_dual_fmac_f32 v102, v11, v19 :: v_dual_lshlrev_b32 v23, 16, v42
	.loc	1 209 29 is_stmt 0              ; generate_amdgcn.py:209:29
	v_dual_mul_f32 v35, v127, v35 :: v_dual_fmac_f32 v98, v14, v21
	v_dual_mul_f32 v31, v126, v31 :: v_dual_fmac_f32 v90, v33, v41
	.loc	1 206 13 is_stmt 1              ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v106, v56, v54
	v_dual_fmac_f32 v91, v16, v30 :: v_dual_fmac_f32 v86, v26, v25
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 209 17                        ; generate_amdgcn.py:209:17
	v_dual_fmac_f32 v107, v9, v17 :: v_dual_fmac_f32 v78, v35, v23
	v_fmac_f32_e32 v101, v12, v25
	v_dual_fmac_f32 v97, v29, v27 :: v_dual_fmac_f32 v82, v22, v21
	v_dual_fmac_f32 v93, v31, v23 :: v_dual_fmac_f32 v94, v32, v13
	v_fmac_f32_e32 v89, v18, v17
	v_fmac_f32_e32 v85, v20, v19
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 136
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 32
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     34
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.kd
