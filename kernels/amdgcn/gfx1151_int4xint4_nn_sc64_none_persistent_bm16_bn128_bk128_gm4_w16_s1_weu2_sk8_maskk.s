...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v119, 0 :: v_dual_add_nc_u32 v0, s47, v20
	v_dual_mov_b32 v110, 0 :: v_dual_add_nc_u32 v1, s47, v19
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v0, v113, v99 offset0:64 offset1:96
	ds_store_2addr_b32 v39, v119, v118 offset1:32
	ds_store_2addr_b32 v39, v105, v98 offset0:64 offset1:96
	ds_store_2addr_b32 v40, v117, v116 offset1:32
	ds_store_2addr_b32 v40, v100, v96 offset0:64 offset1:96
	ds_store_2addr_b32 v41, v115, v114 offset1:32
	ds_store_2addr_b32 v41, v97, v94 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v45, v89, v83 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v48, v85, v84 offset1:32
	ds_store_2addr_b32 v48, v69, v65 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v51, v78, v76 offset1:32
	ds_store_2addr_b32 v51, v63, v59 offset0:64 offset1:96
	ds_store_2addr_b32 v52, v77, v75 offset1:32
	ds_store_2addr_b32 v52, v62, v58 offset0:64 offset1:96
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm16_bn128_bk128_gm4_w16_s1_weu2_sk8_maskk.numbered_sgpr, 52
