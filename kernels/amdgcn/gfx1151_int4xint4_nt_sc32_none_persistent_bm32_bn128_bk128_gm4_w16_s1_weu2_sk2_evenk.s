...
.Ltmp18:
	...
	v_xor_b32_e32 v27, 8, v11
	v_xor_b32_e32 v12, 4, v3
	v_lshl_or_b32 v13, v2, 4, v13
	v_and_b32_e32 v0, 32, v0
	v_readfirstlane_b32 s0, v8
	v_xor_b32_e32 v30, 8, v3
	v_xor_b32_e32 v31, 12, v3
	v_xor_b32_e32 v16, 8, v13
	v_or3_b32 v0, v0, v9, v6
	s_mul_f32 s0, s0, 0x4f7ffffe
	v_xor_b32_e32 v6, 16, v3
	v_xor_b32_e32 v33, 20, v3
	v_xor_b32_e32 v34, 24, v3
	v_xor_b32_e32 v35, 28, v3
	v_xor_b32_e32 v37, 0x1010, v0
	v_xor_b32_e32 v38, 0x2040, v0
	v_xor_b32_e32 v39, 0x3050, v0
	s_cvt_u32_f32 s0, s0
	s_sub_i32 s1, 0, s29
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	...
	v_or_b32_e32 v9, s3, v2
	v_and_or_b32 v10, v5, 12, s3
	...
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v39, 0, v39
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v4, s42, v17
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	s_and_b32 s0, s1, s0
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	v_dual_cndmask_b32 v2, 0x80000000, v4 :: v_dual_mov_b32 v5, v0
	...
	s_barrier
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	v_dual_mov_b32 v7, v0 :: v_dual_add_nc_u32 v44, s40, v44
	v_mov_b32_e32 v6, v0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	s_add_i32 s45, s45, -1
	...
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	buffer_load_u16 v59, v3, s[16:19], 0 offen
	buffer_load_u16 v60, v3, s[16:19], 0 offen offset:4
	buffer_load_u16 v61, v3, s[16:19], 0 offen offset:8
	buffer_load_u16 v62, v3, s[16:19], 0 offen offset:12
	buffer_load_u16 v63, v3, s[16:19], 0 offen offset:16
	buffer_load_u16 v64, v3, s[16:19], 0 offen offset:20
	buffer_load_u16 v65, v3, s[16:19], 0 offen offset:24
	buffer_load_u16 v66, v3, s[16:19], 0 offen offset:28
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	v_mov_b32_e32 v1, v0
	v_mov_b32_e32 v2, v0
	v_mov_b32_e32 v3, v0
	...
	v_dual_mul_f32 v6, v6, v47 :: v_dual_lshlrev_b32 v51, 16, v62
	...
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v4, v4, v47 :: v_dual_lshlrev_b32 v55, 16, v66
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v41, v3, v50
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v7, v7, v47
	v_mul_f32_e32 v5, v5, v47
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v43, v2, v49 :: v_dual_fmac_f32 v40, v4, v51
	v_dual_fmac_f32 v13, v6, v53 :: v_dual_fmac_f32 v16, v7, v54
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v14, v5, v52 :: v_dual_fmac_f32 v15, v46, v55
...
.LBB0_5:                                ; %._crit_edge
	...
	s_barrier
	ds_store_b32 v28, v42
	ds_store_b32 v29, v43
	...
	ds_load_2addr_b32 v[6:7], v37 offset1:32
	ds_load_2addr_b32 v[4:5], v38 offset1:32
	ds_load_2addr_b32 v[1:2], v39 offset1:32
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.numbered_sgpr, 46
