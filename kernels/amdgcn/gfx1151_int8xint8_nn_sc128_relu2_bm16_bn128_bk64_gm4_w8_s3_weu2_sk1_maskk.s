	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v11, s20, v2
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v9, s5, v5
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v12, s20, v33
	...
	buffer_load_b128 v[18:21], v9, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	buffer_load_b128 v[26:29], v5, s[16:19], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(3)
	ds_store_b32 v37, v10 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
...
.LBB0_3:                                ; %Flow25
	...
	s_ashr_i32 s30, s23, 7
	v_or_b32_e32 v25, s28, v5
	v_or_b32_e32 v24, s28, v9
	v_or_b32_e32 v23, s28, v11
	v_mul_lo_u32 v26, v10, s30
	v_or_b32_e32 v21, s28, v12
	v_or_b32_e32 v19, s28, v13
	v_or_b32_e32 v22, s28, v6
	v_or_b32_e32 v20, s28, v7
	v_or_b32_e32 v18, s28, v8
...
.Ltmp23:
	...
	v_subrev_nc_u32_e32 v36, s18, v4
	s_mov_b32 s24, s4
	v_subrev_nc_u32_e32 v37, s18, v1
	v_mov_b32_e32 v1, 0
	v_add_nc_u32_e32 v3, s22, v3
	v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v14, 0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v7, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v89, v42, s[20:23], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	buffer_load_u16 v90, v40, s[24:27], 0 offen
	...
	buffer_load_b128 v[52:55], v41, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_waitcnt vmcnt(2)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v63, v56, v63 :: v_dual_lshlrev_b32 v64, 16, v97
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v59, v42 :: v_dual_add_nc_u32 v36, s35, v36
	v_dual_fmac_f32 v14, v60, v43 :: v_dual_add_nc_u32 v37, s35, v37
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v15, v61, v44 :: v_dual_add_nc_u32 v138, s38, v35
	v_dual_fmac_f32 v12, v58, v41 :: v_dual_add_nc_u32 v139, s33, v32
	v_fmac_f32_e32 v9, v57, v40
	v_fmac_f32_e32 v11, v56, v47
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.9:
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v7, s34, v42
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v51, s14, v27
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
...
.LBB0_10:
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v37, v21, s8, 1
	v_add_lshl_u32 v38, v19, s8, 1
	v_add_lshl_u32 v39, v22, s8, 1
	v_add_lshl_u32 v40, v20, s8, 1
	v_add_lshl_u32 v41, v18, s8, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 140
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
