...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v117, s13, v4
	v_subrev_nc_u32_e32 v118, s12, v1
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v121, s13, v1
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v122, s13, v2
	...
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v120, s12, v3
	...
	v_dual_mov_b32 v16, 0x7632 :: v_dual_add_nc_u32 v157, 0, v17
	...
	v_cndmask_b32_e64 v4, 0x3276, v16, s0
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[90:91], null, s60, v5, v[65:66]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v188, s62, v112
	v_or_b32_e32 v189, s62, v113
	v_or_b32_e32 v190, s62, v114
	v_or_b32_e32 v191, s62, v115
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s68, s65, s62
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s0, v188, v116
	v_cmp_ge_i32_e64 s1, v188, v118
	v_cmp_ge_i32_e64 s3, v188, v119
	v_cmp_ge_i32_e64 s8, v188, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s4, v188, v117
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s11, v189, v117
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v190, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s21, v190, v117
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s25, v191, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s29, v191, v117
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v192, s68, v125, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v189, v118
	v_cmp_ge_i32_e64 s10, v189, v119
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s12, v189, v121
	v_cmp_le_i32_e64 s15, v189, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v190, v118
	v_cmp_ge_i32_e64 s18, v190, v119
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v190, v121
	v_cmp_le_i32_e64 s23, v190, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s26, v191, v118
	v_cmp_ge_i32_e64 s27, v191, v119
	.loc	1 867 30                        ; attention.py:867:30
	...
	.loc	1 866 30 is_stmt 1              ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v191, v120
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s18, s2, s8
	.loc	1 867 30 is_stmt 0              ; attention.py:867:30
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 199
