	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	buffer_load_b64 v[34:35], v7, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e64 v7, 0x80000000, v8, s2
	v_cndmask_b32_e64 v8, 0x80000000, v12, s2
	s_clause 0x1
	buffer_load_b128 v[16:19], v11, s[28:31], 0 offen
	buffer_load_b128 v[20:23], v5, s[28:31], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[36:37], v6, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[26:29], v7, s[28:31], 0 offen
...
.Ltmp23:
	...
	v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v4, s15
	v_dual_mov_b32 v2, s13 :: v_dual_mov_b32 v3, s14
	v_dual_mov_b32 v8, s19 :: v_dual_mov_b32 v5, s16
	v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v7, s18
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v49, v34, s14, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s15, s14, s23
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cmp_lt_i32 s14, s0
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v50, v35, s14, 1
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v51, v33, s15, 1
	v_add_lshl_u32 v52, v32, s15, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v53, v31, s15, 1
	v_add_lshl_u32 v54, v29, s15, 1
	v_add_lshl_u32 v55, v27, s15, 1
	v_add_lshl_u32 v56, v30, s15, 1
	v_add_lshl_u32 v57, v28, s15, 1
	v_add_lshl_u32 v58, v26, s15, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	s_clause 0x1
	buffer_load_b128 v[65:68], v49, s[28:31], 0 offen
	buffer_load_b128 v[69:72], v50, s[28:31], 0 offen
	s_mov_b32 s14, s10
	s_mov_b32 s10, s1
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	...
	v_mul_f32_e32 v88, v73, v80
	v_mul_f32_e32 v80, v74, v80
	v_dual_mul_f32 v86, v73, v78 :: v_dual_lshlrev_b32 v75, 16, v121
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v14, v88, v54 :: v_dual_lshlrev_b32 v77, 16, v123
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v87, v73, v79 :: v_dual_fmac_f32 v12, v86, v52
	v_mul_f32_e32 v83, v73, v75
	s_waitcnt vmcnt(2)
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v85, v73, v77 :: v_dual_lshlrev_b32 v82, 16, v128
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v23, v80, v62
	v_fmac_f32_e32 v9, v83, v49
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v75, v74, v75 :: v_dual_add_nc_u32 v130, s35, v45
	v_dual_mul_f32 v77, v74, v77 :: v_dual_lshlrev_b32 v76, 16, v122
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v11, v85, v51
	v_fmac_f32_e32 v13, v87, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v18, v75, v57
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v10, v84, v50 :: v_dual_add_nc_u32 v129, s15, v44
	v_dual_fmac_f32 v16, v73, v56 :: v_dual_mul_f32 v79, v74, v79
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v78, v74, v78
	v_dual_mul_f32 v74, v74, v82 :: v_dual_fmac_f32 v15, v89, v55
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v19, v76, v58 :: v_dual_fmac_f32 v24, v81, v63
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v20, v77, v59 :: v_dual_fmac_f32 v21, v78, v60
	v_dual_fmac_f32 v22, v79, v61 :: v_dual_fmac_f32 v17, v74, v64
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.9:
	...
	v_add_nc_u32_e32 v6, s12, v41
	v_add_nc_u32_e32 v7, s12, v42
	v_add_nc_u32_e32 v8, s12, v40
	s_mov_b32 s12, 0
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_mov_b32 s19, s12
	...
	s_mov_b32 s15, s12
	s_mov_b32 s17, s12
	v_dual_mov_b32 v52, s19 :: v_dual_mov_b32 v51, s18
	v_mov_b32_e32 v49, s16
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[2:5], v2
	ds_load_b128 v[61:64], v6
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v45, s12 :: v_dual_add_nc_u32 v6, s10, v36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v8, s10, v37
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v50, s17 :: v_dual_add_nc_u32 v7, s10, v39
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[85:88], v8 offset:1024
	ds_load_b128 v[89:92], v8
	v_add_nc_u32_e32 v6, s10, v38
...
.LBB0_10:
	...
	buffer_load_u16 v72, v54, s[24:27], 0 offen
	buffer_load_u16 v73, v57, s[24:27], 0 offen
	buffer_load_u16 v74, v58, s[24:27], 0 offen
	buffer_load_u16 v75, v59, s[24:27], 0 offen
	buffer_load_u16 v76, v60, s[24:27], 0 offen
	buffer_load_u16 v77, v61, s[24:27], 0 offen
...
.LBB0_12:
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v91, v36, v40 :: v_dual_and_b32 v70, 0x78, v70
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_mul_i32 s1, s22, s23
	.loc	1 416 9 is_stmt 0               ; generate_amdgcn.py:416:9
	v_dual_mov_b32 v72, 0x7632 :: v_dual_mul_f32 v89, v36, v38
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_add_i32 s1, s1, s33
	.loc	1 394 24 is_stmt 1              ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v88, v36, v37
	v_mul_f32_e32 v92, v36, v41
	v_mul_f32_e32 v93, v36, v42
	v_mul_f32_e32 v94, v36, v43
	v_mul_f32_e32 v95, v36, v69
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v25, s1, v70, v25
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v90, v36, v39
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_mov_b16_e32 v36.h, v53.l
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v53.h, v36.l
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v51, v89, v51, v24
	v_fma_f32 v7, v39, v7, v14
	v_fma_f32 v49, v91, v49, v22
	v_fma_f32 v3, v42, v3, v11
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v5, v40, v5, v13
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v26, 16, v26
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v4, v41, v4, v12
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v28, 16, v28
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v37, v37, v44, v16
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v43, v36, v43 :: v_dual_lshlrev_b32 v12, 16, v32
	v_mul_f32_e32 v36, v36, v69
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v45, v95, v45, v18
	v_fma_f32 v48, v92, v48, v21
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v19, v19, v46, s3
	v_cndmask_b32_e64 v16, v16, v37, s3
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v6, v36, v6, v9
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v18, v18, v45, s3
	v_cndmask_b32_e64 v21, v21, v48, s3
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_lshlrev_b32_e32 v69, 1, v25
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v50, v90, v50, v23
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v47, v93, v47, v20
	v_fma_f32 v1, v29, v1, v6
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v31, v9, v13
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v32, v9, v14 :: v_dual_mul_f32 v11, v10, v11
	v_dual_mul_f32 v34, v9, v27 :: v_dual_mul_f32 v13, v10, v13
	v_dual_mul_f32 v35, v9, v28 :: v_dual_mul_f32 v14, v10, v14
	v_dual_mul_f32 v9, v9, v26 :: v_dual_mul_f32 v28, v10, v28
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v26, v30, v54, v2
	v_fma_f32 v29, v31, v55, v3
	v_fma_f32 v30, v32, v56, v4
	v_fma_f32 v31, v33, v57, v5
	v_fma_f32 v32, v34, v58, v7
	v_fma_f32 v33, v35, v59, v8
	v_fma_f32 v9, v9, v60, v16
	v_fma_f32 v11, v11, v61, v18
	v_fma_f32 v12, v12, v62, v19
	v_fma_f32 v28, v28, v67, v24
	v_fma_f32 v13, v13, v63, v20
	v_fma_f32 v14, v14, v64, v21
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_max_f32_e32 v1, v1, v1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v10, v10, v68, v17
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_dual_max_f32 v7, v7, v7 :: v_dual_max_f32 v12, v12, v12
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v2, v2, v26, s2
	v_cndmask_b32_e64 v3, v3, v29, s2
	v_cndmask_b32_e64 v15, v23, v27, s2
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v15, v15, v15 :: v_dual_and_b32 v32, 1, v86
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v3, 0, v3 :: v_dual_and_b32 v28, 1, v82
	...
	v_dual_cndmask_b32 v0, v13, v0 :: v_dual_cndmask_b32 v7, v15, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
