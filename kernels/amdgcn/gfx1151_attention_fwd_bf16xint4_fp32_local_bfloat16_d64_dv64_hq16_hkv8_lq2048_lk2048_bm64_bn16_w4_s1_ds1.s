	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshr_b32 s8, s4, 28
	v_dual_mov_b32 v25, 0 :: v_dual_lshlrev_b32 v6, 4, v34
	s_add_i32 s15, s3, s8
	s_load_b128 s[8:11], s[0:1], 0x64
	.loc	1 570 31                        ; attention.py:570:31
	v_or_b32_e32 v3, s22, v1
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v90, v78, 7, v6
	...
	v_dual_mov_b32 v32, v65 :: v_dual_add_nc_u32 v3, 0, v3
	.loc	1 599 26                        ; attention.py:599:26
	...
	v_dual_mov_b32 v31, v65 :: v_dual_and_b32 v12, 48, v0
	...
	v_dual_mov_b32 v77, 0 :: v_dual_add_nc_u32 v112, 0, v10
	...
	s_mul_i32 s8, s9, s15
	v_dual_mov_b32 v129, 0xff800000 :: v_dual_add_nc_u32 v116, 0, v14
	...
	.loc	1 748 47                        ; attention.py:748:47
	v_subrev_nc_u32_e32 v92, s12, v4
	v_dual_mov_b32 v27, v65 :: v_dual_add_nc_u32 v94, s13, v4
	v_dual_mov_b32 v29, v65 :: v_dual_and_b32 v4, 0x70, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b32_e64 v1, 0x1054, v1, s1
	v_xor_b32_e32 v13, 8, v100
	v_lshlrev_b32_e32 v20, 7, v0
	v_bfe_i32 v21, v0, 0, 1
	v_xor_b32_e32 v8, 0x50, v90
	v_lshl_or_b32 v1, v1, 8, v1
	v_dual_mov_b32 v24, v65 :: v_dual_and_b32 v15, 64, v0
	v_lshrrev_b32_e32 v4, 2, v4
	v_and_b32_e32 v21, 0x90, v21
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_b32_e32 v1, 0x540054, v1
	v_add_nc_u32_e32 v115, 0, v13
	v_dual_mov_b32 v13, v65 :: v_dual_and_b32 v20, 0x700, v20
	v_xor_b32_e32 v11, 0x70, v90
	v_lshl_or_b32 v1, v1, 4, v1
	v_lshlrev_b32_e32 v19, 1, v15
	v_and_b32_e32 v16, 0xfc, v82
	...
	v_dual_mov_b32 v23, v65 :: v_dual_and_b32 v2, 0x300, v9
	v_add_nc_u32_e32 v113, 0, v11
	v_mov_b32_e32 v11, v65
	v_xor_b32_e32 v6, 48, v90
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_xor_b32_e32 v3, 16, v90
	v_lshl_or_b32 v15, v15, 8, v15
	v_add_nc_u32_e32 v109, 0, v6
	v_dual_mov_b32 v135, 0xff800000 :: v_dual_add_nc_u32 v114, v101, v12
	v_mov_b32_e32 v12, v65
	v_or_b32_e32 v18, v102, v19
	v_dual_mov_b32 v6, v65 :: v_dual_and_b32 v15, 0x760076, v15
	...
	v_xor_b32_e32 v5, 32, v90
	v_xor_b32_e32 v7, 64, v90
	...
	v_dual_mov_b32 v3, v65 :: v_dual_add_nc_u32 v122, v4, v1
	...
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v106, 0x7060706, v15
	...
	.loc	1 707 13                        ; attention.py:707:13
	v_add_nc_u32_e32 v124, 1, v95
	v_add_nc_u32_e32 v125, 2, v95
	v_add_nc_u32_e32 v126, 3, v95
	v_lshl_or_b32 v127, s3, 10, v81
	.loc	1 752 25                        ; attention.py:752:25
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s1, s1, s23
	.loc	1 741 30                        ; attention.py:741:30
	v_dual_mov_b32 v66, v65 :: v_dual_add_nc_u32 v139, 0, v90
	...
	v_or_b32_e32 v143, s33, v86
	v_or_b32_e32 v141, s33, v88
	v_or_b32_e32 v140, s33, v89
	v_or_b32_e32 v142, s33, v87
	.loc	1 736 32                        ; attention.py:736:32
	buffer_load_b128 v[66:69], v66, s[28:31], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s1, v143, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s4, v143, v93
	.loc	1 752 25                        ; attention.py:752:25
	s_add_i32 s3, s46, s33
	.loc	1 798 53                        ; attention.py:798:53
	s_lshr_b32 s5, s33, 4
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s10, v141, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s12, v141, v93
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s14, v140, v91
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s16, v140, v93
	...
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v143, v94
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s6, v142, v91
	v_cmp_ge_i32_e64 s7, v142, v92
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s8, v142, v93
	v_cmp_le_i32_e64 s9, v142, v94
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s11, v141, v92
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s13, v141, v94
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s15, v140, v92
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s17, v140, v94
...
.Ltmp62:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 173
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.kd
