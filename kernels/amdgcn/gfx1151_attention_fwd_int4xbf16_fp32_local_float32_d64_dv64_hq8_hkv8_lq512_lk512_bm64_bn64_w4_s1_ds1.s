...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v17, 0 :: v_dual_and_b32 v44, 16, v0
	v_dual_mov_b32 v55, 0x7632 :: v_dual_and_b32 v2, 12, v0
	v_bfe_i32 v4, v0, 5, 1
	...
	s_mov_b32 s80, s8
	v_dual_mov_b32 v18, v17 :: v_dual_and_b32 v49, 3, v0
	buffer_load_u16 v43, v1, s[80:83], 0 offen
	v_dual_mov_b32 v192, 0xff800000 :: v_dual_and_b32 v1, 7, v0
	v_dual_mov_b32 v20, v17 :: v_dual_and_b32 v3, 0x7c, v50
	v_dual_mov_b32 v22, v17 :: v_dual_lshlrev_b32 v5, 3, v0
	v_cndmask_b32_e64 v6, 0x1020, 0, vcc_lo
	v_bfe_i32 v52, v0, 3, 1
	v_bfe_i32 v7, v0, 2, 1
	v_dual_mov_b32 v24, v17 :: v_dual_and_b32 v53, 8, v0
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v56, s19, v45
	.loc	1 774 26                        ; attention.py:774:26
	v_cmp_eq_u32_e64 s1, 0, v44
	v_dual_mov_b32 v28, v17 :: v_dual_lshlrev_b32 v59, 5, v2
	v_dual_mov_b32 v32, v17 :: v_dual_and_b32 v63, 0x2040, v4
	v_dual_mov_b32 v23, v17 :: v_dual_lshlrev_b32 v64, 6, v44
	v_dual_mov_b32 v41, 0xff800000 :: v_dual_lshlrev_b32 v48, 2, v42
	v_lshrrev_b32_e32 v51, 3, v42
	v_dual_mov_b32 v193, 0xff800000 :: v_dual_and_b32 v8, 4, v0
	v_dual_mov_b32 v221, 0xff800000 :: v_dual_lshlrev_b32 v58, 4, v1
	v_cndmask_b32_e64 v144, v37, v40, s1
	v_xor_b32_e32 v195, v9, v47
	v_dual_mov_b32 v30, v17 :: v_dual_and_b32 v61, 0x630, v9
	v_dual_mov_b32 v21, v17 :: v_dual_lshlrev_b32 v62, 5, v49
	v_lshl_or_b32 v42, v42, 4, v3
	v_dual_mov_b32 v10, v17 :: v_dual_and_b32 v65, 0x310, v5
	...
	v_and_or_b32 v37, 0x1020, v52, v63
	v_lshl_or_b32 v38, v53, 4, v64
	v_cndmask_b32_e64 v39, 0x1054, v54, s1
	v_dual_mov_b32 v227, 0xff800000 :: v_dual_lshlrev_b32 v142, 3, v1
	v_dual_mov_b32 v19, v17 :: v_dual_and_b32 v46, 0x80, v46
	v_lshl_or_b32 v60, v47, 1, v48
	v_lshl_add_u32 v67, v8, 9, 0
	v_mov_b32_e32 v14, v17
	v_cndmask_b32_e64 v145, v33, v36, s1
	v_cndmask_b32_e64 v149, v36, v33, s1
	v_lshl_or_b32 v33, v47, 8, v58
	v_xor_b32_e32 v204, v42, v51
	v_xor_b32_e32 v42, 8, v195
	v_or3_b32 v205, v61, v34, v35
	v_xor_b32_e32 v34, v37, v62
	v_or3_b32 v207, v66, v38, v65
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v35, s18, v68
	v_lshl_or_b32 v38, v39, 8, v39
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[51:52], null, s96, v45, v[142:143]
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v27, v17 :: v_dual_add_nc_u32 v212, s17, v35
	v_mov_b32_e32 v4, v17
	v_mov_b32_e32 v6, v17
	v_xor_b32_e32 v152, v33, v60
	v_add_nc_u32_e32 v33, 0, v42
	v_add3_u32 v34, v67, v46, v34
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v211, s16, v35
	v_and_b32_e32 v35, 0x540054, v38
	v_xor_b32_e32 v38, 16, v205
	s_clause 0x1                            ; 12-byte Folded Spill
	scratch_store_b32 off, v9, off
	scratch_store_b64 off, v[51:52], off offset:4
	v_mov_b32_e32 v1, v17
	v_dual_mov_b32 v140, v17 :: v_dual_add_nc_u32 v223, v34, v44
	...
	v_dual_mov_b32 v26, v17 :: v_dual_lshlrev_b32 v57, 1, v2
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v69, 32, v56
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v36, v50, 7, v62
	v_cndmask_b32_e64 v40, 0x3276, v55, s1
	v_mov_b32_e32 v25, v17
	v_lshl_or_b32 v203, v72, 5, v57
	scratch_store_b32 off, v34, off offset:16 ; 4-byte Folded Spill
	v_or3_b32 v206, v36, v48, v50
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v36, s18, v69
	v_lshl_or_b32 v39, v40, 8, v40
	v_mov_b32_e32 v29, v17
	v_mov_b32_e32 v9, v17
	v_xor_b32_e32 v40, 8, v203
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v213, s16, v36
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v214, s17, v36
	v_and_b32_e32 v36, 0x760076, v39
	v_xor_b32_e32 v39, 32, v205
	v_mov_b32_e32 v3, v17
	v_dual_mov_b32 v8, v17 :: v_dual_add_nc_u32 v217, 0, v40
	v_xor_b32_e32 v42, 16, v203
	v_xor_b32_e32 v40, 48, v205
	v_dual_mov_b32 v11, v17 :: v_dual_add_nc_u32 v34, 0, v39
	v_mov_b32_e32 v5, v17
	scratch_store_b32 off, v72, off offset:72 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v218, 0, v42
	v_xor_b32_e32 v42, 64, v205
	scratch_store_b32 off, v34, off offset:20 ; 4-byte Folded Spill
	v_dual_mov_b32 v7, v17 :: v_dual_add_nc_u32 v34, 0, v40
	v_mul_lo_u32 v33, s15, v45
	v_xor_b32_e32 v45, 0x50, v205
	v_mov_b32_e32 v139, v17
	scratch_store_b32 off, v34, off offset:24 ; 4-byte Folded Spill
	v_add_nc_u32_e32 v34, 0, v42
	v_xor_b32_e32 v47, 24, v203
	v_xor_b32_e32 v46, 0x60, v205
	...
	v_xor_b32_e32 v48, 0x810, v204
	v_add_nc_u32_e32 v219, 0, v47
	v_xor_b32_e32 v47, 0x70, v205
	...
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v215, s16, v37
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v216, s17, v37
	v_xor_b32_e32 v37, 0x2040, v152
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s0, s0, 29
	...
	s_add_i32 s0, s3, s0
	v_dual_mov_b32 v12, v17 :: v_dual_add_nc_u32 v71, s18, v56
	scratch_store_b32 off, v34, off offset:52 ; 4-byte Folded Spill
	v_dual_mov_b32 v15, v17 :: v_dual_add_nc_u32 v34, 0, v51
	...
	v_xor_b32_e32 v53, 24, v206
	v_xor_b32_e32 v54, 28, v206
	v_xor_b32_e32 v55, 32, v207
	v_xor_b32_e32 v56, 64, v207
	v_xor_b32_e32 v57, 0x60, v207
	...
	v_dual_mov_b32 v2, v17 :: v_dual_add_nc_u32 v209, s17, v71
	.loc	1 892 65                        ; attention.py:892:65
	v_cmp_gt_i32_e64 s0, s96, v142
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v208, s16, v71
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v102, s79, v232
	v_or_b32_e32 v103, s79, v231
	v_or_b32_e32 v104, s79, v230
	v_or_b32_e32 v105, s79, v229
	v_or_b32_e32 v106, s79, v228
	.loc	1 823 32                        ; attention.py:823:32
	v_cndmask_b32_e64 v33, 0x80000000, v33, s67
	v_or_b32_e32 v107, s79, v226
	v_or_b32_e32 v108, s79, v225
	v_or_b32_e32 v110, s79, v210
	v_or_b32_e32 v111, s79, v151
	buffer_load_b128 v[33:36], v33, s[80:83], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	scratch_load_b32 v0, off, off offset:12 ; 4-byte Folded Reload
	v_or_b32_e32 v112, s79, v137
	v_or_b32_e32 v113, s79, v167
	v_or_b32_e32 v114, s79, v177
	v_or_b32_e32 v115, s79, v184
	v_or_b32_e32 v116, s79, v183
	v_or_b32_e32 v117, s79, v182
	v_or_b32_e32 v118, s79, v181
	v_or_b32_e32 v119, s79, v180
	v_or_b32_e32 v120, s79, v179
	v_or_b32_e32 v121, s79, v178
	v_or_b32_e32 v122, s79, v169
	v_or_b32_e32 v123, s79, v176
	v_or_b32_e32 v124, s79, v175
	v_or_b32_e32 v125, s79, v173
	v_or_b32_e32 v126, s79, v171
	v_or_b32_e32 v127, s79, v170
	v_or_b32_e32 v128, s79, v174
	v_or_b32_e32 v129, s79, v172
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v102, v102, s97, 1
	v_add_lshl_u32 v103, v103, s97, 1
	v_add_lshl_u32 v104, v104, s97, 1
	v_add_lshl_u32 v105, v105, s97, 1
	v_add_lshl_u32 v106, v106, s97, 1
	v_add_lshl_u32 v107, v107, s97, 1
	v_add_lshl_u32 v108, v108, s97, 1
	v_add_lshl_u32 v110, v110, s97, 1
	v_add_lshl_u32 v111, v111, s97, 1
	v_add_lshl_u32 v112, v112, s97, 1
	v_add_lshl_u32 v113, v113, s97, 1
	v_add_lshl_u32 v114, v114, s97, 1
	v_add_lshl_u32 v115, v115, s97, 1
	v_add_lshl_u32 v116, v116, s97, 1
	v_add_lshl_u32 v117, v117, s97, 1
	v_add_lshl_u32 v118, v118, s97, 1
	v_add_lshl_u32 v119, v119, s97, 1
	v_add_lshl_u32 v120, v120, s97, 1
	v_add_lshl_u32 v121, v121, s97, 1
	v_add_lshl_u32 v122, v122, s97, 1
	v_add_lshl_u32 v123, v123, s97, 1
	v_add_lshl_u32 v124, v124, s97, 1
	v_add_lshl_u32 v125, v125, s97, 1
	v_add_lshl_u32 v126, v126, s97, 1
	v_add_lshl_u32 v127, v127, s97, 1
	v_add_lshl_u32 v128, v128, s97, 1
	v_add_lshl_u32 v129, v129, s97, 1
	.loc	1 880 35                        ; attention.py:880:35
	v_add_nc_u32_e32 v130, 0, v152
	...
	v_cmp_ge_i32_e64 s5, v33, v208
	v_cmp_ge_i32_e64 s7, v33, v211
	v_cmp_ge_i32_e64 s11, v33, v213
	v_cmp_ge_i32_e64 s3, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s6, v33, v209
	v_cmp_le_i32_e64 s8, v33, v212
	v_cmp_le_i32_e64 s12, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s19, v33, v208
	v_cmp_ge_i32_e64 s9, v33, v211
	v_cmp_ge_i32_e64 s16, v33, v213
	v_cmp_ge_i32_e64 s13, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s20, v33, v209
	v_cmp_le_i32_e64 s14, v33, v212
	v_cmp_le_i32_e64 s17, v33, v214
	...
	s_and_b32 s5, s5, s6
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s21, v33, v208
	v_cmp_ge_i32_e64 s23, v33, v211
	v_cmp_ge_i32_e64 s27, v33, v213
	v_cmp_ge_i32_e64 s18, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v33, v209
	v_cmp_le_i32_e64 s25, v33, v212
	v_cmp_le_i32_e64 s28, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s61, v33, v208
	v_cmp_ge_i32_e64 s26, v33, v211
	v_cmp_ge_i32_e64 s33, v33, v213
	v_cmp_ge_i32_e64 s30, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s62, v33, v209
	v_cmp_le_i32_e64 s29, v33, v212
	v_cmp_le_i32_e64 s34, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s1, v33, v208
	v_cmp_ge_i32_e64 s40, v33, v211
	v_cmp_ge_i32_e64 s37, v33, v213
	v_cmp_ge_i32_e64 s35, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s58, v33, v209
	v_cmp_le_i32_e64 s42, v33, v212
	v_cmp_le_i32_e64 s38, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s63, v33, v208
	v_cmp_ge_i32_e64 s51, v33, v211
	v_cmp_ge_i32_e64 s43, v33, v213
	v_cmp_ge_i32_e64 s39, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s64, v33, v209
	v_cmp_le_i32_e64 s52, v33, v212
	v_cmp_le_i32_e64 s44, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s10, v33, v208
	v_cmp_ge_i32_e64 s49, v33, v211
	v_cmp_ge_i32_e64 s47, v33, v213
	v_cmp_ge_i32_e64 s45, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s53, v33, v209
	v_cmp_le_i32_e64 s50, v33, v212
	v_cmp_le_i32_e64 s48, v33, v214
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s65, v33, v208
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s66, v33, v209
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s59, v33, v211
	v_cmp_ge_i32_e64 s56, v33, v213
	v_cmp_ge_i32_e64 s54, v33, v215
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s60, v33, v212
	v_cmp_le_i32_e64 s57, v33, v214
	...
	v_or_b32_e32 v98, s79, v168
	v_or_b32_e32 v99, s79, v235
	v_or_b32_e32 v100, s79, v234
	v_or_b32_e32 v101, s79, v233
	v_or_b32_e32 v109, s79, v0
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v98, v98, s97, 1
	v_add_lshl_u32 v99, v99, s97, 1
	v_add_lshl_u32 v100, v100, s97, 1
	v_add_lshl_u32 v101, v101, s97, 1
	v_add_lshl_u32 v109, v109, s97, 1
	s_clause 0x4
	...
	v_add_lshl_u32 v43, v45, s99, 1
	v_add_lshl_u32 v44, v45, s100, 1
	v_add_lshl_u32 v45, v45, s101, 1
	...
	ds_load_b128 v[101:104], v223 offset:768
	ds_load_b128 v[105:108], v223 offset:1536
	ds_load_b128 v[97:100], v223 offset:1792
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.LBB0_7:                                ; %._crit_edge
	...
	v_add_lshl_u32 v17, v32, v232, 2
	v_add_lshl_u32 v18, v32, v231, 2
