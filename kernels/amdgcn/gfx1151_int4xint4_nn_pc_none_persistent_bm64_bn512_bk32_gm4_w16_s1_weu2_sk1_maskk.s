	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	v_and_b32_e32 v15, 32, v2
	s_add_i32 s0, s13, s0
	s_mov_b32 s64, s4
	s_ashr_i32 s81, s0, 1
	v_mul_lo_u32 v2, s57, v70
.Ltmp11:
	...
	v_cndmask_b32_e64 v19, 0x1054, v3, s0
	v_cndmask_b32_e64 v20, 0x3276, v4, s0
	v_mad_u64_u32 v[3:4], null, s57, 48, v[2:3]
	v_rcp_iflag_f32_e32 v21, s5
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v4, v19, 8, v19
	s_lshl_b32 s82, s57, 4
.Ltmp12:
	.loc	1 241 5 is_stmt 1               ; generate_amdgcn.py:241:5
	v_add_nc_u32_e32 v76, v10, v2
	v_add_nc_u32_e32 v16, s82, v2
	...
	v_and_b32_e32 v13, 0x37e, v7
	v_and_b32_e32 v8, 0x88, v8
	v_and_b32_e32 v4, 0x760076, v19
	s_mul_f32 s5, s5, 0x4f7ffffe
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_lshl_b32 s85, s3, 4
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_and_b32_e32 v1, 0x1f0, v6
	v_and_b32_e32 v83, 0x5040504, v2
	s_cvt_u32_f32 s5, s5
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_or_b32_e32 v2, s85, v5
	s_mov_b32 s68, s6
	s_sub_i32 s6, 0, s83
	...
	v_add_nc_u32_e32 v81, v10, v3
	v_add_nc_u32_e32 v82, v12, v3
	v_cndmask_b32_e64 v3, 0, 1, s4
	s_mul_i32 s6, s6, s5
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_mad_u64_u32 v[66:67], null, s57, v2, v[1:2]
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_max_i32 s84, s1, 1
	...
	v_sub_nc_u32_e32 v74, s81, v65
	v_sub_nc_u32_e32 v75, s81, v5
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_add_nc_u32_e32 v77, v10, v16
	v_add_nc_u32_e32 v78, v12, v16
	v_add_nc_u32_e32 v79, v10, v18
	v_add_nc_u32_e32 v80, v12, v18
	v_and_b32_e32 v84, 0x7060706, v4
	s_add_i32 s87, s5, s1
	v_cmp_ne_u32_e64 s1, 1, v3
	v_add_nc_u32_e32 v85, 0, v8
	v_add_nc_u32_e32 v86, 0, v9
	v_add_nc_u32_e32 v87, 0, v13
	v_add_nc_u32_e32 v88, 0, v6
	v_add_nc_u32_e32 v89, v11, v14
	v_add_nc_u32_e32 v90, v15, v7
...
.LBB0_2:                                ; %._crit_edge
	...
	ds_load_b128 v[37:40], v91 offset:16
	s_waitcnt lgkmcnt(0)
	...
	ds_load_b128 v[41:44], v91 offset:1024
	ds_load_b128 v[45:48], v91 offset:1040
	...
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v95, v140, v95 :: v_dual_mul_f32 v92, v150, v92
	v_dual_mul_f32 v93, v149, v93 :: v_dual_mul_f32 v50, v50, v67
	...
	v_dual_mul_f32 v30, v128, v30 :: v_dual_mul_f32 v29, v129, v29
	v_dual_mul_f32 v26, v132, v26 :: v_dual_mul_f32 v25, v133, v25
	v_dual_mul_f32 v20, v152, v20 :: v_dual_mul_f32 v19, v153, v19
	v_dual_mul_f32 v97, v138, v97 :: v_dual_mul_f32 v68, v151, v68
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	...
	v_bfe_u32 v118, v93, 16, 1
	v_bfe_u32 v119, v92, 16, 1
	...
	v_cmp_o_f32_e64 s30, v93, v93
	v_cmp_o_f32_e64 s31, v92, v92
	...
	v_add3_u32 v62, v93, v118, 0x7fff
	v_add3_u32 v63, v92, v119, 0x7fff
	...
	v_perm_b32 v1, v4, v3, v83
	v_perm_b32 v2, v4, v3, v84
	v_perm_b32 v3, v6, v5, v83
	v_perm_b32 v4, v6, v5, v84
	v_perm_b32 v5, v7, v9, v83
	v_perm_b32 v6, v7, v9, v84
	v_perm_b32 v9, v12, v18, v83
	v_perm_b32 v10, v12, v18, v84
	v_perm_b32 v17, v20, v33, v83
	v_perm_b32 v18, v20, v33, v84
	v_add_lshl_u32 v33, s70, v76, 1
	v_perm_b32 v7, v8, v14, v83
	v_perm_b32 v8, v8, v14, v84
	v_perm_b32 v11, v13, v22, v83
	v_perm_b32 v12, v13, v22, v84
	v_perm_b32 v19, v21, v31, v83
	v_perm_b32 v20, v21, v31, v84
	v_perm_b32 v21, v23, v29, v83
	v_perm_b32 v22, v23, v29, v84
	v_perm_b32 v23, v24, v34, v83
	v_perm_b32 v24, v24, v34, v84
	v_add_lshl_u32 v34, s70, v77, 1
	v_perm_b32 v13, v15, v26, v83
	v_perm_b32 v14, v15, v26, v84
	v_perm_b32 v15, v16, v30, v83
	v_perm_b32 v16, v16, v30, v84
	v_perm_b32 v25, v27, v35, v83
	v_perm_b32 v26, v27, v35, v84
	v_add_lshl_u32 v35, s70, v78, 1
	v_perm_b32 v27, v28, v36, v83
	v_perm_b32 v28, v28, v36, v84
	v_add_lshl_u32 v36, s70, v79, 1
	s_clause 0x3
	...
	v_add_lshl_u32 v1, s70, v80, 1
	v_add_lshl_u32 v2, s70, v81, 1
	v_perm_b32 v29, v32, v37, v83
	v_perm_b32 v30, v32, v37, v84
	v_perm_b32 v31, v39, v38, v83
	v_perm_b32 v32, v39, v38, v84
	v_add_lshl_u32 v3, s70, v82, 1
	s_clause 0x3
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v2, s6, 9, v66
	v_mov_b32_e32 v1, 0
	v_add_nc_u32_e32 v3, s3, v69
	s_lshl_b32 s5, s5, 9
	s_mov_b32 s6, s84
	v_subrev_nc_u32_e32 v92, s5, v2
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[67:68], null, s81, v3, v[65:66]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s5, v75
	...
	s_add_i32 s6, s6, -1
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	v_cndmask_b32_e32 v93, 0x80000000, v92, vcc_lo
	.loc	1 255 27                        ; generate_amdgcn.py:255:27
	v_cmp_lt_i32_e32 vcc_lo, s5, v74
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_add_nc_u32_e32 v92, s82, v92
	s_add_i32 s5, s5, 16
	s_cmp_lg_u32 s6, 0
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	v_cndmask_b32_e32 v68, 0x80000000, v68, vcc_lo
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b128 v[93:96], v93, s[68:71], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	buffer_load_u16 v68, v68, s[64:67], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b16 v85, v68
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[97:100], v86 offset1:32
	ds_load_2addr_b64 v[101:104], v86 offset0:64 offset1:96
	ds_load_2addr_b64 v[105:108], v87 offset1:32
	ds_load_2addr_b64 v[109:112], v87 offset0:64 offset1:96
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_load_u8 v68, v89 offset:6656
	ds_load_u8 v93, v89 offset:6144
	ds_load_u8 v94, v89 offset:7680
	ds_load_u8 v95, v89 offset:7168
	ds_load_u8 v96, v89 offset:4608
	ds_load_u8 v113, v89 offset:4096
	ds_load_u8 v114, v89 offset:5632
	ds_load_u8 v115, v89 offset:5120
	ds_load_u8 v116, v89 offset:2560
	ds_load_u8 v117, v89 offset:2048
	ds_load_u8 v118, v89 offset:3584
	ds_load_u8 v119, v89 offset:3072
	ds_load_u8 v120, v89 offset:3840
	ds_load_u8 v121, v89 offset:3328
	ds_load_u8 v122, v89 offset:2816
	ds_load_u8 v123, v89 offset:2304
	ds_load_u8 v124, v89 offset:512
	ds_load_u8 v125, v89
	ds_load_u8 v126, v89 offset:1536
	ds_load_u8 v127, v89 offset:1024
	ds_load_u8 v128, v89 offset:1792
	ds_load_u8 v129, v89 offset:1280
	ds_load_u8 v130, v89 offset:768
	ds_load_u8 v131, v89 offset:256
	ds_load_u8 v132, v89 offset:7936
	ds_load_u8 v133, v89 offset:7424
	ds_load_u8 v134, v89 offset:6912
	ds_load_u8 v135, v89 offset:6400
	ds_load_u8 v136, v89 offset:5888
	ds_load_u8 v137, v89 offset:5376
	ds_load_u8 v138, v89 offset:4864
	ds_load_u8 v139, v89 offset:4352
...
.Ltmp13:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_vgpr, 155
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.numbered_sgpr, 89
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     91
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm64_bn512_bk32_gm4_w16_s1_weu2_sk1_maskk.kd
