	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 108 18 is_stmt 1              ; generate_amdgcn.py:108:18
	...
	v_dual_mov_b32 v10, v1 :: v_dual_lshlrev_b32 v25, 4, v0
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v10, s13 :: v_dual_add_nc_u32 v3, 16, v31
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
...
.Ltmp15:
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[1:8], v[35:36], v[47:48], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[37:38], v[47:48], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[39:40], v[49:50], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[41:42], v[49:50], v[9:16] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cbranch_scc1 .LBB0_4
; %bb.2:                                ; %.peel.next
	s_lshl_b32 s2, s33, 9
...
; %bb.5:
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[18:19], v[28:29], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[20:21], v[28:29], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[24:25], v[30:31], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[26:27], v[30:31], v[9:16] neg_lo:[1,1,0]
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_dual_mov_b32 v2, 0x5410 :: v_dual_lshlrev_b32 v19, 1, v19
	...
	v_dual_mul_f32 v2, v2, v18 :: v_dual_and_b32 v41, 0x5040504, v41
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v6, v6, v28 :: v_dual_mul_f32 v7, v7, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v0, v0, v21 :: v_dual_mul_f32 v1, v1, v22
	v_dual_mul_f32 v2, v2, v24 :: v_dual_mul_f32 v3, v3, v25
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	v_dual_mul_f32 v4, v4, v26 :: v_dual_max_f32 v1, 0, v1
	...
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v13, v13, v18 :: v_dual_mul_f32 v10, v10, v32
	v_mul_f32_e32 v12, v12, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v14, v14, v18 :: v_dual_mul_f32 v15, v15, v16
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	...
	v_dual_max_f32 v5, 0, v5 :: v_dual_mul_f32 v8, v8, v30
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v14, v14, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_max_f32 v12, 0, v12 :: v_dual_mul_f32 v1, v1, v1
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v7, v7, v29 :: v_dual_and_b32 v42, 0x7060706, v42
	.loc	1 151 19                        ; generate_amdgcn.py:151:19
	...
	v_dual_mul_f32 v0, v0, v0 :: v_dual_mul_f32 v5, v5, v5
	...
	v_dual_mul_f32 v12, v12, v12 :: v_dual_and_b32 v21, 1, v38
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 152 19                        ; generate_amdgcn.py:152:19
	v_dual_mul_f32 v14, v14, v14 :: v_dual_and_b32 v19, 1, v19
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v23, s[20:23], 0 offen
	buffer_store_b128 v[4:7], v23, s[20:23], 0 offen offset:512
	.loc	1 80 1 is_stmt 1                ; generate_amdgcn.py:80:1
	s_endpgm
.Ltmp17:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 51
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_bm16_bn512_bk32_gm4_w16_s2_weu2_sk1_maskk.kd
