...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s1, s3, s0
	v_dual_mov_b32 v27, v25 :: v_dual_and_b32 v12, 1, v0
	...
	v_dual_mov_b32 v13, 0x6420 :: v_dual_add_nc_u32 v116, s13, v7
	...
	s_mul_i32 s3, s10, s3
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v6, 7, v92
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s66, s3, s1
	v_cmp_eq_u32_e64 s1, 0, v12
	v_dual_mov_b32 v26, v25 :: v_dual_lshlrev_b32 v7, 6, v94
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v15, 16, v0
	...
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v13, 0x750031, v13
	...
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v14, 0x750031, v14
	v_cndmask_b32_e64 v16, 0x1054, v16, s3
	v_cndmask_b32_e64 v15, 0x3276, v15, s3
	v_xad_u32 v9, v7, 32, 0
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v7, 0, v7
	...
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v134, 0x7050301, v13
	...
	v_dual_mov_b32 v19, v25 :: v_dual_lshlrev_b32 v136, 2, v15
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 215
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 69
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.private_seg_size, 0
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.uses_flat_scratch, 0
