	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp19:
	...
	v_add_nc_u32_e32 v12, s12, v14
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_cndmask_b32_e64 v5, 0x80000000, v5, s3
	v_cndmask_b32_e64 v6, 0x80000000, v6, s3
	v_cndmask_b32_e64 v29, 0x80000000, v7, s3
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	...
	s_clause 0x1
	buffer_load_b128 v[17:20], v16, s[24:27], 0 offen
	buffer_load_b128 v[21:24], v5, s[24:27], 0 offen
	...
	buffer_load_b32 v7, v8, s[4:7], 0 offen
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x3
	...
	buffer_load_b128 v[50:53], v6, s[24:27], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_xor_b32_e32 v44, v6, v5
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_xor_b32_e32 v45, v4, v8
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v8, 0, v45
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v6, v1 offset:32768
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v6, v7 offset:33792
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_waitcnt vmcnt(3)
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v19, 0 :: v_dual_and_b32 v2, 0x1c00, v16
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	...
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v47, 0, v20
	v_dual_mov_b32 v22, 0 :: v_dual_mov_b32 v23, 0
	v_mov_b32_e32 v30, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_or_b32_e32 v36, v4, v1
	v_or3_b32 v40, v1, v2, v4
	v_and_b32_e32 v1, 32, v16
	...
	v_dual_mov_b32 v7, s18 :: v_dual_add_nc_u32 v46, v21, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v48, s34, v15
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_lshr_b32 s15, s15, 25
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	s_add_i32 s16, s34, s23
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_add_i32 s14, s14, s15
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_add_nc_u32_e32 v50, s16, v14
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_add_nc_u32_e32 v48, s16, v9
	v_add_nc_u32_e32 v49, s16, v13
	...
	v_dual_fmac_f32 v19, v48, v80 :: v_dual_add_nc_u32 v128, s42, v45
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	s_waitcnt lgkmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v60, v60, v96 :: v_dual_fmac_f32 v25, v53, v85
	v_mul_f32_e32 v61, v61, v96
	v_dual_mul_f32 v62, v62, v96 :: v_dual_fmac_f32 v27, v55, v87
	v_dual_mul_f32 v63, v63, v96 :: v_dual_fmac_f32 v26, v54, v86
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v22, v50, v82 :: v_dual_add_nc_u32 v127, s15, v44
	v_fmac_f32_e32 v21, v49, v81
	v_dual_fmac_f32 v23, v51, v83 :: v_dual_fmac_f32 v24, v52, v84
	v_fmac_f32_e32 v31, v58, v90
	v_dual_fmac_f32 v29, v56, v88 :: v_dual_fmac_f32 v30, v57, v89
	v_dual_fmac_f32 v32, v59, v91 :: v_dual_fmac_f32 v33, v60, v92
	v_dual_fmac_f32 v34, v61, v93 :: v_dual_fmac_f32 v35, v62, v94
	v_fmac_f32_e32 v28, v63, v95
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.9:
	...
	v_add_nc_u32_e32 v10, s12, v43
	v_add_nc_u32_e32 v3, s12, v41
	v_add_nc_u32_e32 v4, s12, v40
	s_mov_b32 s12, 0
	ds_load_b128 v[13:16], v2 offset:8192
	...
	s_mov_b32 s19, s12
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v2, s10, v39
	v_add_nc_u32_e32 v5, s10, v36
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[59:62], v4 offset:8192
	ds_load_b128 v[63:66], v4
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	ds_load_b128 v[67:70], v2
	ds_load_b128 v[71:74], v5
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[75:78], v3 offset:8192
	ds_load_b128 v[79:82], v3
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v4, s10, v38
	v_add_nc_u32_e32 v2, s10, v37
	ds_load_b128 v[83:86], v4
	ds_load_b128 v[87:90], v2
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[91:94], v10
	ds_load_b128 v[95:98], v10 offset:8192
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[47:54], v[63:66], v[71:74], v[2:9] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[59:62], v[71:74], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[47:54], v[79:82], v[67:70], v[47:54] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[75:78], v[67:70], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[47:54], v[55:58], v[83:86], v[47:54] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[13:16], v[83:86], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[47:54], v[91:94], v[87:90], v[47:54] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[2:9], v[95:98], v[87:90], v[2:9] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_or3_b32 v45, v11, v1, v12
	v_dual_mov_b32 v66, 0 :: v_dual_mov_b32 v65, 0
	v_dual_mov_b32 v72, 0 :: v_dual_mov_b32 v67, 0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v74, 0 :: v_dual_add_nc_u32 v47, 0, v45
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 129
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.kd
