	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp22:
	...
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_and_b32_e32 v3, 0x70, v13
	v_and_b32_e32 v5, 0x90, v5
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_lshrrev_b32_e32 v14, 3, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v45, 0 :: v_dual_and_b32 v4, 0x37c, v4
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_lshl_b32 s3, s3, 6
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_bfe_u32 v2, v0, 4, 1
	...
	v_or_b32_e32 v5, v3, v12
	v_or3_b32 v16, v2, v3, s2
	v_and_b32_e32 v6, 0x160, v6
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v1, 7, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v46, 0 :: v_dual_add_nc_u32 v15, 0, v5
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_or_b32_e32 v5, s3, v14
	v_and_or_b32 v6, 0x90, v7, v6
	v_or_b32_e32 v7, s22, v12
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	v_dual_mov_b32 v44, 0 :: v_dual_add_nc_u32 v5, s22, v14
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_lo_u32 v2, s23, v2
	v_dual_mov_b32 v43, 0 :: v_dual_lshlrev_b32 v8, 4, v0
	...
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v30, 0, v8
	v_dual_mov_b32 v37, 0 :: v_dual_add_nc_u32 v32, 0, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v11, s13, v2
	v_subrev_nc_u32_e32 v27, s13, v1
	s_mov_b32 s13, s12
	...
	v_dual_mov_b32 v42, 0 :: v_dual_add_nc_u32 v39, 0, v29
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v58, v18, s0, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cmp_lt_i32 s0, s29
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v57, v17, s0, 1
	...
	v_cndmask_b32_e32 v49, 0x80000000, v27, vcc_lo
	.loc	1 339 27                        ; generate_amdgcn.py:339:27
	v_cmp_gt_i32_e32 vcc_lo, s28, v47
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	...
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	v_cndmask_b32_e32 v51, 0x80000000, v11, vcc_lo
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	...
	v_add_lshl_u32 v75, v24, s16, 1
	v_add_lshl_u32 v76, v25, s16, 1
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(3)
	ds_store_b32 v28, v55 offset:8192
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(2)
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v28, v56 offset:9216
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v30, v[51:54] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	s_clause 0x1
	buffer_load_u16 v121, v67, s[12:15], 0 offen
	buffer_load_u16 v122, v68, s[12:15], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0x7
	...
	buffer_load_u16 v130, v76, s[8:11], 0 offen
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[55:58], v32 offset:8192
	ds_load_b128 v[63:66], v32 offset:8704
	ds_load_b128 v[79:82], v39 offset:8192
	ds_load_b128 v[83:86], v39 offset:8704
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v47, v15 offset:1664
	ds_load_u8 v48, v15 offset:1920
	ds_load_u8 v49, v15 offset:1792
	ds_load_u8 v50, v15 offset:1536
	ds_load_u8 v51, v15 offset:1152
	ds_load_u8 v52, v15 offset:1408
	ds_load_u8 v53, v15 offset:1280
	ds_load_u8 v54, v15 offset:1024
	ds_load_u8 v59, v15 offset:640
	ds_load_u8 v60, v15 offset:896
	ds_load_u8 v61, v15 offset:768
	ds_load_u8 v62, v15 offset:512
	ds_load_u8 v67, v15 offset:128
	ds_load_u8 v68, v15 offset:384
	ds_load_u8 v69, v15 offset:256
	ds_load_u8 v70, v15
	ds_load_u8 v75, v15 offset:3712
	ds_load_u8 v76, v15 offset:3968
	ds_load_u8 v77, v15 offset:3840
	ds_load_u8 v78, v15 offset:3584
	ds_load_u8 v99, v15 offset:3200
	ds_load_u8 v100, v15 offset:3456
	ds_load_u8 v101, v15 offset:3328
	ds_load_u8 v102, v15 offset:3072
	ds_load_u8 v103, v15 offset:2688
	ds_load_u8 v104, v15 offset:2944
	ds_load_u8 v105, v15 offset:2816
	ds_load_u8 v106, v15 offset:2560
	ds_load_u8 v107, v15 offset:2176
	ds_load_u8 v108, v15 offset:2432
	ds_load_u8 v109, v15 offset:2304
	ds_load_u8 v110, v15 offset:2048
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[71:74], v32 offset:9216
	ds_load_b128 v[87:90], v32 offset:9728
	ds_load_b128 v[91:94], v39 offset:9216
	ds_load_b128 v[95:98], v39 offset:9728
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v131, v15 offset:5760
	ds_load_u8 v132, v15 offset:6016
	ds_load_u8 v133, v15 offset:5888
	ds_load_u8 v134, v15 offset:5632
	ds_load_u8 v135, v15 offset:5248
	ds_load_u8 v136, v15 offset:5504
	ds_load_u8 v137, v15 offset:5376
	ds_load_u8 v138, v15 offset:5120
	ds_load_u8 v139, v15 offset:4736
	ds_load_u8 v140, v15 offset:4992
	ds_load_u8 v141, v15 offset:4864
	ds_load_u8 v142, v15 offset:4608
	ds_load_u8 v143, v15 offset:4224
	ds_load_u8 v144, v15 offset:4480
	ds_load_u8 v145, v15 offset:4352
	ds_load_u8 v146, v15 offset:4096
	ds_load_u8 v147, v15 offset:7808
	ds_load_u8 v148, v15 offset:8064
	ds_load_u8 v149, v15 offset:7936
	ds_load_u8 v150, v15 offset:7680
	ds_load_u8 v151, v15 offset:7296
	ds_load_u8 v152, v15 offset:7552
	ds_load_u8 v153, v15 offset:7424
	ds_load_u8 v154, v15 offset:7168
	ds_load_u8 v155, v15 offset:6784
	ds_load_u8 v156, v15 offset:7040
	ds_load_u8 v157, v15 offset:6912
	ds_load_u8 v158, v15 offset:6656
	ds_load_u8 v159, v15 offset:6272
	ds_load_u8 v160, v15 offset:6528
	ds_load_u8 v161, v15 offset:6400
	ds_load_u8 v162, v15 offset:6144
	...
	s_waitcnt vmcnt(15)
	v_dual_mul_f32 v62, v62, v80 :: v_dual_lshlrev_b32 v83, 16, v115
	v_mul_f32_e32 v55, v55, v80
	v_mul_f32_e32 v56, v56, v80
	v_mul_f32_e32 v57, v57, v80
	...
	v_dual_mul_f32 v60, v60, v80 :: v_dual_lshlrev_b32 v81, 16, v113
	v_mul_f32_e32 v52, v52, v79
	v_dual_mul_f32 v49, v49, v79 :: v_dual_lshlrev_b32 v82, 16, v114
	v_dual_mul_f32 v51, v51, v79 :: v_dual_lshlrev_b32 v84, 16, v116
	v_dual_mul_f32 v54, v54, v79 :: v_dual_lshlrev_b32 v85, 16, v117
	v_dual_mul_f32 v53, v53, v79 :: v_dual_lshlrev_b32 v86, 16, v118
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v94, 16, v126
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v47, v47, v79 :: v_dual_lshlrev_b32 v98, 16, v130
	v_mul_f32_e32 v48, v48, v79
	v_mul_f32_e32 v50, v50, v79
	v_dual_mul_f32 v72, v72, v90 :: v_dual_lshlrev_b32 v87, 16, v119
	v_mul_f32_e32 v64, v64, v89
	v_dual_mul_f32 v63, v63, v89 :: v_dual_lshlrev_b32 v88, 16, v120
	v_dual_mul_f32 v61, v61, v80 :: v_dual_mul_f32 v70, v70, v89
	v_dual_mul_f32 v66, v66, v89 :: v_dual_lshlrev_b32 v91, 16, v123
	v_dual_mul_f32 v65, v65, v89 :: v_dual_lshlrev_b32 v92, 16, v124
	v_dual_mul_f32 v74, v74, v90 :: v_dual_lshlrev_b32 v93, 16, v125
	v_dual_mul_f32 v68, v68, v89 :: v_dual_lshlrev_b32 v95, 16, v127
	v_dual_mul_f32 v67, v67, v89 :: v_dual_lshlrev_b32 v96, 16, v128
	v_dual_mul_f32 v76, v76, v90 :: v_dual_lshlrev_b32 v97, 16, v129
	v_dual_mul_f32 v69, v69, v89 :: v_dual_mul_f32 v78, v78, v90
	v_dual_mul_f32 v71, v71, v90 :: v_dual_fmac_f32 v44, v50, v84
	v_dual_mul_f32 v73, v73, v90 :: v_dual_fmac_f32 v26, v47, v81
	v_dual_mul_f32 v75, v75, v90 :: v_dual_fmac_f32 v40, v54, v88
	v_dual_mul_f32 v77, v77, v90 :: v_dual_fmac_f32 v38, v55, v81
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v46, v48, v82 :: v_dual_fmac_f32 v45, v49, v83
	v_dual_fmac_f32 v43, v51, v85 :: v_dual_fmac_f32 v42, v52, v86
	v_dual_fmac_f32 v41, v53, v87 :: v_dual_fmac_f32 v34, v59, v85
	v_dual_fmac_f32 v37, v56, v82 :: v_dual_fmac_f32 v36, v57, v83
	v_dual_fmac_f32 v35, v58, v84 :: v_dual_fmac_f32 v26, v63, v91
	v_dual_fmac_f32 v33, v60, v86 :: v_dual_fmac_f32 v38, v71, v91
	v_dual_fmac_f32 v31, v61, v87 :: v_dual_fmac_f32 v46, v64, v92
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v29, v62, v88 :: v_dual_fmac_f32 v36, v73, v93
	v_dual_fmac_f32 v45, v65, v93 :: v_dual_fmac_f32 v44, v66, v94
	v_dual_fmac_f32 v43, v67, v95 :: v_dual_fmac_f32 v42, v68, v96
	v_dual_fmac_f32 v41, v69, v97 :: v_dual_fmac_f32 v40, v70, v98
	v_dual_fmac_f32 v37, v72, v92 :: v_dual_fmac_f32 v34, v75, v95
	v_fmac_f32_e32 v35, v74, v94
	v_fmac_f32_e32 v33, v76, v96
	v_fmac_f32_e32 v31, v77, v97
	v_fmac_f32_e32 v29, v78, v98
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.3:                                ; %._crit_edge.loopexit
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v1, v26, v26 :: v_dual_max_f32 v4, v44, v44
	v_dual_max_f32 v2, v46, v46 :: v_dual_max_f32 v3, v45, v45
	v_dual_max_f32 v9, v38, v38 :: v_dual_max_f32 v10, v37, v37
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v2, 0, v2
	v_max_f32_e32 v11, v36, v36
	v_dual_max_f32 v5, v43, v43 :: v_dual_max_f32 v6, v42, v42
	v_dual_max_f32 v7, v41, v41 :: v_dual_max_f32 v8, v40, v40
	v_dual_max_f32 v19, 0, v9 :: v_dual_max_f32 v20, 0, v10
	v_dual_max_f32 v9, v35, v35 :: v_dual_mul_f32 v18, v1, v1
	v_dual_max_f32 v21, 0, v11 :: v_dual_max_f32 v10, v34, v34
	v_dual_max_f32 v11, v33, v33 :: v_dual_max_f32 v14, v31, v31
	...
	v_max_f32_e32 v22, 0, v9
	v_dual_max_f32 v24, 0, v11 :: v_dual_max_f32 v23, 0, v10
	v_dual_max_f32 v26, 0, v15 :: v_dual_max_f32 v25, 0, v14
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 163
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
