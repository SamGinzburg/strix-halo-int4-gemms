	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 352 28                        ; generate_amdgcn.py:352:28
	s_sub_i32 s4, s2, s5
	v_or_b32_e32 v43, s28, v0
.Ltmp12:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s2, s18, 0x1ff
.Ltmp13:
...
.Ltmp15:
	...
	s_add_i32 s1, s18, 31
	v_dual_mov_b32 v25, 0 :: v_dual_and_b32 v44, 28, v42
...
.Ltmp22:
	...
	v_dual_mov_b32 v26, 0 :: v_dual_lshlrev_b32 v9, 1, v0
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v2, 0, v2
	...
	v_add3_u32 v10, v2, v8, v1
	v_add3_u32 v11, v53, v5, v1
	s_lshl_b32 s34, s29, 4
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v54, 0, v3
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v55, 0, v6
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v56, 0, v4
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v57, 0, v7
	v_mov_b32_e32 v1, s4
.Ltmp23:
	...
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v59, v11, v9
	v_mov_b32_e32 v11, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_cmp_lt_i32 s0, s33
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	buffer_load_b32 v76, v60, s[20:23], 0 offen
	.loc	1 387 34                        ; generate_amdgcn.py:387:34
	...
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	buffer_load_b32 v77, v63, s[20:23], 0 offen
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	s_clause 0x3
	buffer_load_b128 v[60:63], v64, s[24:27], 0 offen
	buffer_load_b128 v[64:67], v65, s[24:27], 0 offen
	buffer_load_b128 v[68:71], v68, s[24:27], 0 offen
	buffer_load_b128 v[72:75], v72, s[24:27], 0 offen
	...
	v_dual_fmac_f32 v26, v121, v199 :: v_dual_lshlrev_b32 v203, 16, v64
	...
	v_dual_fmac_f32 v25, v120, v199 :: v_dual_and_b32 v62, 0xffff0000, v62
	...
	v_dual_fmac_f32 v22, v81, v203 :: v_dual_and_b32 v65, 0xffff0000, v65
	v_dual_fmac_f32 v35, v185, v200 :: v_dual_and_b32 v66, 0xffff0000, v66
	v_dual_fmac_f32 v18, v82, v204 :: v_dual_and_b32 v67, 0xffff0000, v67
	...
	v_dual_fmac_f32 v13, v190, v205 :: v_dual_fmac_f32 v40, v195, v60
	v_dual_fmac_f32 v11, v68, v206 :: v_dual_fmac_f32 v24, v89, v64
	v_dual_fmac_f32 v39, v69, v60 :: v_dual_fmac_f32 v30, v88, v63
	v_dual_fmac_f32 v37, v70, v61 :: v_dual_fmac_f32 v34, v197, v62
	v_dual_fmac_f32 v33, v71, v62 :: v_dual_fmac_f32 v20, v90, v65
	v_dual_fmac_f32 v29, v72, v63 :: v_dual_fmac_f32 v16, v91, v66
	v_dual_fmac_f32 v23, v73, v64 :: v_dual_fmac_f32 v10, v198, v67
	v_fmac_f32_e32 v19, v74, v65
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v21, v188, v203 :: v_dual_fmac_f32 v14, v83, v205
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v31, v93, v62 :: v_dual_fmac_f32 v22, v80, v64
	v_dual_fmac_f32 v27, v94, v63 :: v_dual_fmac_f32 v18, v81, v65
	v_dual_fmac_f32 v21, v95, v64 :: v_dual_fmac_f32 v14, v82, v66
	v_dual_fmac_f32 v17, v96, v65 :: v_dual_fmac_f32 v12, v83, v67
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v13, v97, v66 :: v_dual_fmac_f32 v40, v84, v68
	v_dual_fmac_f32 v11, v98, v67 :: v_dual_fmac_f32 v38, v85, v69
	v_dual_fmac_f32 v39, v99, v68 :: v_dual_fmac_f32 v34, v86, v70
	v_dual_fmac_f32 v37, v100, v69 :: v_dual_fmac_f32 v30, v87, v71
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v33, v101, v70 :: v_dual_fmac_f32 v24, v88, v72
	v_dual_fmac_f32 v23, v103, v72 :: v_dual_fmac_f32 v16, v90, v74
	v_dual_fmac_f32 v19, v104, v73 :: v_dual_fmac_f32 v10, v91, v75
	v_fmac_f32_e32 v15, v105, v74
	v_dual_fmac_f32 v9, v106, v75 :: v_dual_fmac_f32 v26, v76, v60
	v_dual_fmac_f32 v29, v102, v71 :: v_dual_fmac_f32 v20, v89, v73
...
.LBB0_7:                                ; %._crit_edge
	...
	v_mad_u64_u32 v[4:5], null, s19, s29, v[1:2]
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	v_add_lshl_u32 v36, v4, s29, 2
	s_waitcnt lgkmcnt(15)
	buffer_atomic_add_f32 v0, v35, s[16:19], 0 offen
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v5, v36, s[16:19], 0 offen
	v_lshl_add_u32 v0, s29, 3, v35
	v_add_lshl_u32 v5, v4, s0, 2
	v_add_nc_u32_e32 v3, v3, v35
	v_add_lshl_u32 v36, v4, s1, 2
	v_add_lshl_u32 v37, v4, s2, 2
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v7, v0, s[16:19], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v9, v5, s[16:19], 0 offen
	s_waitcnt lgkmcnt(11)
	buffer_atomic_add_f32 v11, v3, s[16:19], 0 offen
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v13, v36, s[16:19], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v15, v37, s[16:19], 0 offen
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v17, v0, s[16:19], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v19, v2, s[16:19], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v21, v3, s[16:19], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v23, v5, s[16:19], 0 offen
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v25, v7, s[16:19], 0 offen
	...
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s11, s29, 17
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v5, v4, s10, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s12, s29, 18
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshl_add_u32 v7, s29, 6, v35
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s13, s29, 19
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v27, v0, s[16:19], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v29, v2, s[16:19], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v31, v3, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_clause 0x1
	buffer_atomic_add_f32 v33, v5, s[16:19], 0 offen
	buffer_atomic_add_f32 v1, v7, s[16:19], 0 offen
	v_add_lshl_u32 v0, v4, s11, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s14, s29, 20
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v1, v4, s12, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s15, s29, 21
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v2, v4, s13, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s20, s29, 22
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v3, v4, s14, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s21, s29, 23
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v5, v4, s15, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s22, s29, 24
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	s_clause 0x4
	buffer_atomic_add_f32 v6, v0, s[16:19], 0 offen
	buffer_atomic_add_f32 v8, v1, s[16:19], 0 offen
	buffer_atomic_add_f32 v10, v2, s[16:19], 0 offen
	buffer_atomic_add_f32 v12, v3, s[16:19], 0 offen
	buffer_atomic_add_f32 v14, v5, s[16:19], 0 offen
	v_add_lshl_u32 v0, v4, s20, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s23, s29, 25
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v1, v4, s21, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s24, s29, 26
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v2, v4, s22, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s25, s29, 27
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v3, v4, s23, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s26, s29, 28
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v5, v4, s24, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s27, s29, 29
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	s_clause 0x4
	buffer_atomic_add_f32 v16, v0, s[16:19], 0 offen
	buffer_atomic_add_f32 v18, v1, s[16:19], 0 offen
	buffer_atomic_add_f32 v20, v2, s[16:19], 0 offen
	buffer_atomic_add_f32 v22, v3, s[16:19], 0 offen
	buffer_atomic_add_f32 v24, v5, s[16:19], 0 offen
	v_add_lshl_u32 v0, v4, s25, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s28, s29, 30
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v1, v4, s26, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s30, s29, 31
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v2, v4, s27, 2
	v_add_lshl_u32 v3, v4, s28, 2
	v_add_lshl_u32 v4, v4, s30, 2
	s_clause 0x4
	buffer_atomic_add_f32 v26, v0, s[16:19], 0 offen
	buffer_atomic_add_f32 v28, v1, s[16:19], 0 offen
	buffer_atomic_add_f32 v30, v2, s[16:19], 0 offen
	buffer_atomic_add_f32 v32, v3, s[16:19], 0 offen
	buffer_atomic_add_f32 v34, v4, s[16:19], 0 offen
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 207
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
