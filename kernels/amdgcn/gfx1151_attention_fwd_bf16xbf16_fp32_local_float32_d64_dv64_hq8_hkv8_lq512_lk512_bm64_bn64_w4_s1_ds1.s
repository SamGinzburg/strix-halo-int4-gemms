...
; %bb.4:                                ; %.lr.ph
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v197, s13, v4
	v_subrev_nc_u32_e32 v194, s12, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_subrev_nc_u32_e32 v195, s12, v2
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v198, s13, v1
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v199, s13, v2
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v200, s13, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	s_add_i32 s0, s3, s0
	v_dual_mov_b32 v174, v25 :: v_dual_add_nc_u32 v215, v8, v12
	.loc	1 818 13                        ; attention.py:818:13
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	v_dual_mov_b32 v188, 0xff800000 :: v_dual_and_b32 v3, 3, v0
	v_cmp_eq_u32_e64 s0, 0, v68
	.loc	1 818 13                        ; attention.py:818:13
	scratch_store_b32 off, v1, off offset:28 ; 4-byte Folded Spill
	v_dual_mov_b32 v172, v25 :: v_dual_add_nc_u32 v1, v8, v169
	v_dual_mov_b32 v204, 0xff800000 :: v_dual_add_nc_u32 v217, v2, v9
	...
	v_dual_mov_b32 v190, 0xff800000 :: v_dual_add_nc_u32 v219, v2, v11
	...
	v_dual_mov_b32 v8, v25 :: v_dual_and_b32 v11, 8, v0
	...
	v_dual_mov_b32 v12, v25 :: v_dual_and_b32 v9, 0x310, v9
	...
	v_dual_mov_b32 v203, 0xff800000 :: v_dual_add_nc_u32 v238, 0, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_dual_mov_b32 v11, v25 :: v_dual_add_nc_u32 v180, 0, v1
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 105
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 72
