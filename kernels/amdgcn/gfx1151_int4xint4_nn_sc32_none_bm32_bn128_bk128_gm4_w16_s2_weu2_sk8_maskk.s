	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v20, v36, v44 :: v_dual_add_nc_u32 v29, s35, v29
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
...
.LBB0_6:                                ; %Flow54
	...
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v1, 0x1e0, v0
	v_dual_mov_b32 v7, 0 :: v_dual_mov_b32 v24, 0
	...
	buffer_load_u16 v5, v3, s[24:27], 0 offen
	v_mov_b32_e32 v3, 0
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.7:
	...
	ds_load_u8 v7, v3 offset:896
	ds_load_u8 v8, v3 offset:768
	ds_load_u8 v10, v3 offset:512
	ds_load_u8 v24, v3 offset:128
	ds_load_u8 v25, v3 offset:384
	ds_load_u8 v26, v3 offset:256
	ds_load_u8 v27, v3
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_add_nc_u32_e32 v9, 0, v4
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	ds_load_u8 v31, v3 offset:1664
	ds_load_u8 v32, v3 offset:1920
	ds_load_u8 v33, v3 offset:1792
	ds_load_u8 v34, v3 offset:1536
	ds_load_u8 v35, v3 offset:1152
	ds_load_u8 v36, v3 offset:1408
	ds_load_u8 v37, v3 offset:1280
	ds_load_u8 v38, v3 offset:1024
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	...
	v_perm_b32 v9, v10, v6, 0xc0c0004
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[6:7], v28 offset:2048
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	...
	v_lshl_or_b32 v8, v26, 16, v10
	v_mov_b32_e32 v26, v23
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v10, v34, v31, 0xc0c0004
	v_perm_b32 v31, v33, v32, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v32, v38, v35, 0xc0c0004
	v_perm_b32 v33, v37, v36, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[23:30], v[8:9], v[3:4], v[23:30] neg_lo:[1,1,0]
	v_lshl_or_b32 v4, v31, 16, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v3, v33, 16, v32
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[23:30], v[3:4], v[6:7], v[23:30] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	v_dual_mul_f32 v10, v10, v30 :: v_dual_add_nc_u32 v23, 8, v9
	v_dual_mul_f32 v7, v7, v30 :: v_dual_add_nc_u32 v26, 12, v9
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_cndmask_b32_e64 v21, 0x80000000, v9, s2
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v24, v24, v30 :: v_dual_add_nc_u32 v27, 16, v9
	v_dual_mul_f32 v25, v25, v30 :: v_dual_add_nc_u32 v28, 20, v9
	v_dual_mul_f32 v8, v8, v30 :: v_dual_add_nc_u32 v29, 24, v9
	v_dual_mul_f32 v4, v4, v30 :: v_dual_add_nc_u32 v9, 28, v9
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v6, v6, v30 :: v_dual_and_b32 v31, 0x7f, v0
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	...
	v_and_or_b32 v12, 0x31c, v12, v36
	...
	v_xad_u32 v2, v5, 4, 0
	v_xad_u32 v13, v5, 8, 0
	v_xad_u32 v30, v5, 12, 0
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v12, s19, v32
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_xad_u32 v32, v5, 16, 0
	v_xad_u32 v33, v5, 20, 0
	v_xad_u32 v34, v5, 24, 0
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v0, v3, v0, v11
	v_fma_f32 v3, v7, v21, v20
	v_fma_f32 v7, v10, v22, v19
	v_fma_f32 v10, v24, v23, v18
	v_fma_f32 v21, v25, v26, v17
	v_fma_f32 v4, v4, v28, v15
	v_fma_f32 v8, v8, v27, v16
	...
	v_cndmask_b32_e64 v10, v17, v21, s2
	...
	v_add_lshl_u32 v15, v8, s8, 2
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v0, v9, s[16:19], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v2, v10, s[16:19], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v4, v11, s[16:19], 0 offen
	v_add_lshl_u32 v0, v8, s0, 2
	s_waitcnt lgkmcnt(0)
	s_clause 0x4
	buffer_atomic_add_f32 v6, v12, s[16:19], 0 offen
	buffer_atomic_add_f32 v1, v13, s[16:19], 0 offen
	buffer_atomic_add_f32 v3, v14, s[16:19], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.num_vgpr, 66
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.kd
