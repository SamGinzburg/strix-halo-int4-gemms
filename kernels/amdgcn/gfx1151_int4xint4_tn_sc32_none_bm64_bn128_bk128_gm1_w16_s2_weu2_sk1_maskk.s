...
.Ltmp0:
	...
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v31, 0, v7
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v15, 0 :: v_dual_lshlrev_b32 v36, 1, v8
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v50, v58, v50 :: v_dual_lshlrev_b32 v57, 16, v57
	...
	v_dual_mul_f32 v47, v47, v57 :: v_dual_mul_f32 v52, v58, v52
	v_dual_mul_f32 v48, v48, v57 :: v_dual_mul_f32 v51, v58, v51
	v_mul_f32_e32 v49, v58, v49
	v_mul_f32_e32 v54, v58, v54
	v_dual_mul_f32 v56, v58, v56 :: v_dual_add_nc_u32 v35, s41, v35
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v24, v42, v57 :: v_dual_lshlrev_b32 v67, 16, v68
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v59, 16, v59
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v53, v58, v53
	v_dual_mul_f32 v55, v58, v55 :: v_dual_fmac_f32 v22, v44, v61
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v9, v41, v60 :: v_dual_fmac_f32 v20, v46, v65
	v_dual_fmac_f32 v23, v43, v62 :: v_dual_fmac_f32 v16, v49, v60
	v_dual_fmac_f32 v21, v45, v66 :: v_dual_fmac_f32 v14, v52, v61
	v_dual_fmac_f32 v19, v47, v67 :: v_dual_fmac_f32 v12, v54, v65
	v_dual_fmac_f32 v18, v48, v59 :: v_dual_fmac_f32 v17, v50, v57
	v_dual_fmac_f32 v10, v56, v59 :: v_dual_fmac_f32 v15, v51, v62
	v_fmac_f32_e32 v13, v53, v66
...
.LBB0_5:
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v42, 12, v27
	v_add_nc_u32_e32 v43, 16, v27
	v_add_nc_u32_e32 v44, 20, v27
	v_add_nc_u32_e32 v45, 24, v27
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v31, v31, v28 :: v_dual_lshlrev_b32 v30, 16, v30
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v28 :: v_dual_and_b32 v26, 0x78, v26
	...
	v_dual_mul_f32 v35, v35, v28 :: v_dual_mul_f32 v2, v2, v30
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v7, v7, v30 :: v_dual_and_b32 v0, 16, v0
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v5, v5, v41, v22
	v_fma_f32 v33, v33, v42, v20
	v_fma_f32 v8, v8, v42, v12
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	v_fma_f32 v32, v32, v40, v15
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_add3_u32 v12, v20, v22, 0x7fff
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	...
	v_cndmask_b16 v4.h, 0x7fff, v12.h, s4
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v30, v36, v44, v11
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	v_add3_u32 v9, v15, v19, 0x7fff
	v_cndmask_b32_e32 v3, v3, v5, vcc_lo
	v_cndmask_b32_e32 v5, 0x1054, v47, vcc_lo
	...
	v_cndmask_b32_e32 v8, v7, v2, vcc_lo
	...
	v_and_b32_e32 v7, 0x5040504, v5
	v_and_b32_e32 v10, 0x7060706, v6
	v_permlanex16_b32 v6, v2, s15, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_permlanex16_b32 v11, v5, s15, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v3, v3, v4, v10
	v_perm_b32 v4, v6, v8, v7
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 69
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 43
