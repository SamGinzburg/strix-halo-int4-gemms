	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v4, v83, 6, v97
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s1, s3, s1
	v_bfe_u32 v16, v0, 4, 1
	v_xor_b32_e32 v13, 0x60, v97
	...
	v_xad_u32 v7, 0x50, v4, 0
	.loc	1 756 22                        ; attention.py:756:22
	s_sub_i32 s8, s3, s8
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s1, s1, 3
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v8, v4, 64, 0
	...
	v_dual_mov_b32 v25, 0 :: v_dual_and_b32 v2, 0x70, v0
	v_cndmask_b32_e64 v9, 0x7531, v9, s1
	v_cndmask_b32_e64 v14, 0x6420, v14, s1
	v_xor_b32_e32 v10, 64, v97
	v_xor_b32_e32 v15, 0x70, v97
	v_dual_mov_b32 v128, 0xff800000 :: v_dual_add_nc_u32 v119, 0, v13
	v_lshl_or_b32 v9, v9, 8, v9
	v_lshl_or_b32 v14, v14, 8, v14
	v_lshrrev_b32_e32 v2, 2, v2
	v_dual_mov_b32 v127, 0xff800000 :: v_dual_add_nc_u32 v120, 0, v15
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v9, 0x750031, v9
	v_mov_b32_e32 v65, 0
	.loc	1 760 21                        ; attention.py:760:21
	...
	v_dual_mov_b32 v23, v65 :: v_dual_and_b32 v106, 0x7050301, v9
	v_dual_mov_b32 v9, 0x5410 :: v_dual_add_nc_u32 v96, s13, v6
	v_or_b32_e32 v91, 4, v87
	v_or_b32_e32 v92, 5, v87
	v_or_b32_e32 v93, 6, v87
	v_or_b32_e32 v94, 7, v87
	.loc	1 951 47                        ; attention.py:951:47
	v_subrev_nc_u32_e32 v95, s12, v6
	v_dual_mov_b32 v29, v65 :: v_dual_add_nc_u32 v98, v12, v88
	v_dual_mov_b32 v28, v65 :: v_dual_add_nc_u32 v99, v12, v89
	v_dual_mov_b32 v31, v65 :: v_dual_add_nc_u32 v100, v12, v90
	v_dual_mov_b32 v32, v65 :: v_dual_add_nc_u32 v101, v12, v91
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v102, v12, v92
	v_dual_mov_b32 v18, v65 :: v_dual_add_nc_u32 v103, v12, v93
	v_dual_mov_b32 v19, v65 :: v_dual_add_nc_u32 v104, v12, v94
	v_dual_mov_b32 v20, v65 :: v_dual_add_nc_u32 v105, v12, v87
	...
	v_cndmask_b32_e64 v9, 0x1054, v9, s12
	v_lshlrev_b32_e32 v108, 2, v1
	v_dual_mov_b32 v24, v65 :: v_dual_and_b32 v107, 0x7050301, v12
	v_cndmask_b32_e64 v12, 0x3276, v14, s12
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v9, v9, 8, v9
	v_lshl_or_b32 v110, s3, 8, v6
	v_dual_mov_b32 v13, v65 :: v_dual_lshlrev_b32 v6, 5, v0
	...
	v_dual_mov_b32 v14, v65 :: v_dual_lshlrev_b32 v9, 7, v0
	v_dual_mov_b32 v15, v65 :: v_dual_and_b32 v6, 0x160, v6
	v_dual_mov_b32 v16, v65 :: v_dual_and_b32 v5, 0x90, v5
	...
	v_xor_b32_e32 v4, 16, v97
	v_xor_b32_e32 v7, 32, v97
	v_xor_b32_e32 v8, 48, v97
	v_xor_b32_e32 v11, 0x50, v97
	v_and_b32_e32 v112, 0x5040504, v3
	v_and_b32_e32 v113, 0x7060706, v1
	v_xor_b32_e32 v1, v5, v2
	v_add_nc_u32_e32 v2, 0, v9
	v_xor_b32_e32 v3, 16, v111
	.loc	1 981 24                        ; attention.py:981:24
	v_cmp_gt_i32_e64 s0, s27, v79
	v_dual_mov_b32 v5, v65 :: v_dual_add_nc_u32 v114, 0, v4
	v_dual_mov_b32 v6, v65 :: v_dual_add_nc_u32 v115, 0, v7
	v_dual_mov_b32 v7, v65 :: v_dual_add_nc_u32 v116, 0, v8
	v_dual_mov_b32 v125, 0 :: v_dual_add_nc_u32 v118, 0, v11
	v_dual_mov_b32 v27, v65 :: v_dual_add_nc_u32 v122, 0, v3
	v_dual_mov_b32 v30, v65 :: v_dual_mov_b32 v9, 0
	v_mov_b32_e32 v11, v65
	v_mov_b32_e32 v3, v65
	v_dual_mov_b32 v126, 0xff800000 :: v_dual_add_nc_u32 v121, v2, v1
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v67, s45, v67 :: v_dual_add_nc_u32 v80, s4, v110
...
.Ltmp37:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 163
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
