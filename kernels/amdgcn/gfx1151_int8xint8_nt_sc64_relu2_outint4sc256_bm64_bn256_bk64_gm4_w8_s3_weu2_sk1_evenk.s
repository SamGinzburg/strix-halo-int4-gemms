	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_and_b32_e32 v245, 3, v0
	v_and_b32_e32 v242, 15, v0
	v_lshlrev_b32_e32 v96, 5, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshlrev_b32_e32 v244, 4, v245
	v_lshlrev_b32_e32 v97, 6, v242
.Ltmp1:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[13:14], null, s12, v1, v[244:245]
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
	s_cvt_u32_f32 s18, s18
	s_mov_b64 s[24:25], s[10:11]
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_mad_u64_u32 v[14:15], null, s12, v2, v[244:245]
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
	s_mul_i32 s6, s6, s18
	s_mul_hi_u32 s6, s18, s6
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_lshl_add_u32 v20, s12, 6, v13
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
	s_add_i32 s18, s18, s6
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_lshl_add_u32 v95, s12, 7, v13
	.loc	1 353 13                        ; generate_amdgcn.py:353:13
...
.Ltmp15:
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_mad_u64_u32 v[15:16], null, s34, s12, v[13:14]
.Ltmp16:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_lshr_b32 s2, s2, 26
.Ltmp17:
...
.Ltmp19:
	...
	s_clause 0x1
	buffer_load_b128 v[23:26], v16, s[28:31], 0 offen
	buffer_load_b128 v[27:30], v3, s[28:31], 0 offen
	v_cndmask_b32_e64 v3, 0x80000000, v12, s2
	s_clause 0x1
	buffer_load_b128 v[31:34], v4, s[28:31], 0 offen
	buffer_load_b128 v[35:38], v17, s[28:31], 0 offen
	...
	buffer_load_b128 v[51:54], v3, s[28:31], 0 offen
	buffer_load_b128 v[55:58], v4, s[28:31], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v3, 1, v0
	v_lshlrev_b32_e32 v2, 4, v0
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v4, 16, v242
	v_or_b32_e32 v5, 32, v242
	v_or_b32_e32 v6, 48, v242
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v2, 6, v242
	s_mov_b32 s10, 0
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_and_b32_e32 v17, 0x1c00, v1
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_3:                                ; %Flow94
	...
	v_mul_lo_u32 v59, v7, s0
	v_mul_lo_u32 v54, v4, s0
	v_mul_lo_u32 v55, v5, s0
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_b32_e32 v17, 0x1c00, v96
	v_dual_mov_b32 v247, v0 :: v_dual_mov_b32 v92, v19
	v_mov_b32_e32 v23, 0
	...
	v_mov_b32_e32 v32, 0
	v_add3_u32 v9, 0, v19, v1
	v_dual_mov_b32 v1, s12 :: v_dual_mov_b32 v4, s15
	v_or_b32_e32 v100, v99, v17
	...
	v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v26, 0
	v_dual_mov_b32 v6, s17 :: v_dual_mov_b32 v7, s18
	v_mov_b32_e32 v28, 0
	v_dual_mov_b32 v8, s19 :: v_dual_add_nc_u32 v107, v9, v16
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v21, s12, v100
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v9, s44, v15
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v18, s47, v99
	.loc	1 406 22 is_stmt 1              ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v22, s12, v104
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v19, s47, v101
	buffer_load_b128 v[9:12], v9, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[173:176], v21 offset:8192
	ds_load_b128 v[177:180], v22 offset:8192
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[169:172], v22
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[141:144], v18 offset:1024
	ds_load_b128 v[145:148], v19 offset:1024
	ds_load_b128 v[157:160], v18 offset:2048
	ds_load_b128 v[161:164], v19 offset:2048
	ds_load_b128 v[181:184], v18 offset:3072
	ds_load_b128 v[185:188], v19 offset:3072
	v_add_nc_u32_e32 v18, s47, v102
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v19, s12, v105
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[109:116], v[165:168], v[125:128], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[117:124], v[173:176], v[125:128], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_wmma_i32_16x16x16_iu8 v[133:140], v[173:176], v[141:144], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu8 v[109:116], v[169:172], v[129:132], v[109:116] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[117:124], v[177:180], v[129:132], v[117:124] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[125:132], v[165:168], v[141:144], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[133:140], v[177:180], v[145:148], v[133:140] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[149:156], v[173:176], v[157:160], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[125:132], v[169:172], v[145:148], v[125:132] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[141:148], v[165:168], v[157:160], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[149:156], v[177:180], v[161:164], v[149:156] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[141:148], v[169:172], v[161:164], v[141:148] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[157:164], v[165:168], v[181:184], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[157:164], v[169:172], v[185:188], v[157:164] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[165:172], v[173:176], v[181:184], v[1:8] neg_lo:[1,1,0]
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[181:184], v19 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[165:172], v[177:180], v[185:188], v[165:172] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v18
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[177:180], v19
	...
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_add_nc_u32_e32 v94, s12, v13
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s14, s14, 6
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_add_nc_u32_e32 v185, s12, v14
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s15, s14, s35
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cmp_lt_i32 s14, s0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v21, v55, s14, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v22, v56, s14, 1
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e32 v21, 0x80000000, v21, vcc_lo
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[117:124], v[181:184], v[173:176], v[117:124] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[109:116], v[177:180], v[173:176], v[109:116] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v18 offset:1024
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_cndmask_b32_e32 v22, 0x80000000, v22, vcc_lo
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[125:132], v[177:180], v[173:176], v[125:132] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[133:140], v[181:184], v[173:176], v[133:140] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v18 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[141:148], v[177:180], v[173:176], v[141:148] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[149:156], v[181:184], v[173:176], v[149:156] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v18 offset:3072
	v_add_nc_u32_e32 v18, s47, v103
	s_mov_b32 s47, s1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[157:164], v[177:180], v[173:176], v[157:164] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[165:172], v[181:184], v[173:176], v[165:172] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v18
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[177:180], v19
	...
	v_wmma_i32_16x16x16_iu8 v[157:164], v[177:180], v[173:176], v[157:164] neg_lo:[1,1,0]
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_add_nc_u32_e32 v177, s12, v20
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[165:172], v[181:184], v[173:176], v[165:172] neg_lo:[1,1,0]
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	v_add_nc_u32_e32 v181, s12, v95
	.loc	1 406 22 is_stmt 0              ; generate_amdgcn.py:406:22
	s_clause 0x3
	buffer_load_b128 v[173:176], v94, s[28:31], 0 offen
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v94, s14, v98
	s_add_i32 s1, s14, 0x8000
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s13, s11
	s_mov_b32 s13, s15
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b128 v94, v[9:12] offset:32768
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v11, 16, v19
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v9, s45, v98
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v213, v193, v11 :: v_dual_lshlrev_b32 v12, 16, v21
	v_mul_f32_e32 v214, v194, v11
	v_mul_f32_e32 v215, v195, v11
	v_mul_f32_e32 v19, v189, v10
	v_mul_f32_e32 v21, v190, v10
	v_mul_f32_e32 v22, v191, v10
	v_dual_mul_f32 v94, v192, v10 :: v_dual_mul_f32 v205, v189, v12
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v210, v194, v10 :: v_dual_mul_f32 v225, v197, v11
	v_dual_mul_f32 v211, v195, v10 :: v_dual_mul_f32 v226, v198, v11
	v_dual_mul_f32 v212, v196, v10 :: v_dual_mul_f32 v227, v199, v11
	v_mul_f32_e32 v216, v196, v11
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	v_dual_mul_f32 v176, v192, v11 :: v_dual_mul_f32 v189, v189, v18
	v_mul_f32_e32 v206, v190, v12
	v_mul_f32_e32 v207, v191, v12
	v_dual_mul_f32 v208, v192, v12 :: v_dual_mul_f32 v209, v193, v10
	v_mul_f32_e32 v220, v196, v12
	v_dual_mul_f32 v217, v193, v12 :: v_dual_mul_f32 v190, v190, v18
	v_dual_mul_f32 v191, v191, v18 :: v_dual_mul_f32 v218, v194, v12
	v_dual_mul_f32 v192, v192, v18 :: v_dual_mul_f32 v219, v195, v12
	v_dual_mul_f32 v193, v193, v18 :: v_dual_mul_f32 v228, v200, v11
	v_dual_mul_f32 v194, v194, v18 :: v_dual_mul_f32 v229, v197, v12
	v_dual_mul_f32 v195, v195, v18 :: v_dual_mul_f32 v230, v198, v12
	v_dual_mul_f32 v196, v196, v18 :: v_dual_mul_f32 v231, v199, v12
	v_dual_mul_f32 v221, v197, v10 :: v_dual_mul_f32 v232, v200, v12
	v_mul_f32_e32 v222, v198, v10
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v223, v199, v10 :: v_dual_mul_f32 v236, v201, v11
	v_dual_mul_f32 v224, v200, v10 :: v_dual_mul_f32 v237, v202, v11
	v_dual_mul_f32 v197, v197, v18 :: v_dual_mul_f32 v238, v203, v11
	v_dual_mul_f32 v198, v198, v18 :: v_dual_mul_f32 v239, v201, v12
	v_dual_mul_f32 v199, v199, v18 :: v_dual_mul_f32 v240, v202, v12
	v_dual_mul_f32 v200, v200, v18 :: v_dual_mul_f32 v241, v203, v12
	v_dual_mul_f32 v233, v201, v10 :: v_dual_mul_f32 v12, v204, v12
	v_dual_mul_f32 v234, v202, v10 :: v_dual_fmac_f32 v23, v19, v109
	v_dual_mul_f32 v235, v203, v10 :: v_dual_fmac_f32 v26, v94, v112
	v_dual_mul_f32 v10, v204, v10 :: v_dual_fmac_f32 v25, v22, v111
	v_mul_f32_e32 v11, v204, v11
	v_dual_mul_f32 v201, v201, v18 :: v_dual_fmac_f32 v30, v212, v116
	v_dual_mul_f32 v202, v202, v18 :: v_dual_fmac_f32 v27, v209, v113
	v_dual_mul_f32 v203, v203, v18 :: v_dual_fmac_f32 v34, v224, v120
	v_dual_mul_f32 v18, v204, v18 :: v_dual_fmac_f32 v29, v211, v115
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v24, v21, v110 :: v_dual_fmac_f32 v33, v223, v119
	v_dual_fmac_f32 v28, v210, v114 :: v_dual_fmac_f32 v31, v221, v117
	v_dual_fmac_f32 v32, v222, v118 :: v_dual_fmac_f32 v35, v233, v121
	v_dual_fmac_f32 v36, v234, v122 :: v_dual_fmac_f32 v37, v235, v123
	v_dual_fmac_f32 v38, v10, v124 :: v_dual_fmac_f32 v39, v173, v125
	v_dual_fmac_f32 v40, v174, v126 :: v_dual_fmac_f32 v41, v175, v127
	v_dual_fmac_f32 v42, v176, v128 :: v_dual_fmac_f32 v43, v213, v129
	v_dual_fmac_f32 v44, v214, v130 :: v_dual_fmac_f32 v45, v215, v131
	v_dual_fmac_f32 v46, v216, v132 :: v_dual_fmac_f32 v47, v225, v133
	v_dual_fmac_f32 v48, v226, v134 :: v_dual_fmac_f32 v49, v227, v135
	v_dual_fmac_f32 v50, v228, v136 :: v_dual_fmac_f32 v53, v238, v139
	v_dual_fmac_f32 v51, v236, v137 :: v_dual_fmac_f32 v52, v237, v138
	v_dual_fmac_f32 v57, v11, v140 :: v_dual_fmac_f32 v60, v205, v141
	v_dual_fmac_f32 v61, v206, v142 :: v_dual_fmac_f32 v62, v207, v143
	v_dual_fmac_f32 v63, v208, v144 :: v_dual_fmac_f32 v64, v217, v145
	v_dual_fmac_f32 v65, v218, v146 :: v_dual_fmac_f32 v66, v219, v147
	v_dual_fmac_f32 v67, v220, v148 :: v_dual_fmac_f32 v68, v229, v149
	v_dual_fmac_f32 v69, v230, v150 :: v_dual_fmac_f32 v70, v231, v151
	v_dual_fmac_f32 v71, v232, v152 :: v_dual_fmac_f32 v72, v239, v153
	v_dual_fmac_f32 v73, v240, v154 :: v_dual_fmac_f32 v74, v241, v155
	v_dual_fmac_f32 v75, v12, v156 :: v_dual_fmac_f32 v76, v189, v157
	v_dual_fmac_f32 v77, v190, v158 :: v_dual_fmac_f32 v78, v191, v159
	v_dual_fmac_f32 v79, v192, v160 :: v_dual_fmac_f32 v80, v193, v161
	v_dual_fmac_f32 v81, v194, v162 :: v_dual_fmac_f32 v82, v195, v163
	v_dual_fmac_f32 v83, v196, v164 :: v_dual_fmac_f32 v86, v198, v166
	v_dual_fmac_f32 v85, v197, v165 :: v_dual_fmac_f32 v88, v200, v168
	v_dual_fmac_f32 v87, v199, v167 :: v_dual_fmac_f32 v90, v202, v170
	v_dual_fmac_f32 v89, v201, v169 :: v_dual_fmac_f32 v84, v18, v172
	v_fmac_f32_e32 v91, v203, v171
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
...
; %bb.6:                                ; %Flow
	...
	v_dual_mov_b32 v0, v247 :: v_dual_mov_b32 v19, v92
	s_branch .LBB0_8
.LBB0_7:
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v113, 0 :: v_dual_mov_b32 v144, 0
...
; %bb.9:
	...
	s_mov_b32 s19, s12
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v14, s47, v229
	v_add_nc_u32_e32 v15, s47, v101
	v_add_nc_u32_e32 v18, s47, v100
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v8, s18 :: v_dual_add_nc_u32 v17, s47, v94
	v_dual_mov_b32 v3, s13 :: v_dual_mov_b32 v4, s14
	v_dual_mov_b32 v5, s15 :: v_dual_mov_b32 v6, s16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[190:193], v17 offset:1024
	ds_load_b128 v[138:141], v17
	ds_load_b128 v[194:197], v14 offset:3072
	ds_load_b128 v[150:153], v14 offset:2048
	ds_load_b128 v[198:201], v18 offset:3072
	ds_load_b128 v[202:205], v18 offset:2048
	ds_load_b128 v[208:211], v15 offset:3072
	ds_load_b128 v[212:215], v15 offset:2048
	ds_load_b128 v[216:219], v17 offset:3072
	ds_load_b128 v[220:223], v17 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_cvt_f32_i32_e32 v160, v111
	v_cvt_f32_i32_e32 v236, v112
	v_cvt_f32_i32_e32 v237, v113
	v_cvt_f32_i32_e32 v238, v114
	v_cvt_f32_i32_e32 v207, v115
	v_cvt_f32_i32_e32 v92, v116
	v_cvt_f32_i32_e32 v231, v117
	v_cvt_f32_i32_e32 v239, v102
	v_cvt_f32_i32_e32 v240, v103
	v_cvt_f32_i32_e32 v241, v104
	v_cvt_f32_i32_e32 v247, v105
	v_cvt_f32_i32_e32 v248, v106
	v_cvt_f32_i32_e32 v249, v107
	v_cvt_f32_i32_e32 v116, v108
	v_cvt_f32_i32_e32 v251, v109
...
.LBB0_10:
	...
	s_cmp_lt_i32 s4, s0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v2, v59, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v3, v58, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v4, v54, s4, 1
	v_dual_cndmask_b32 v2, 0x80000000, v2 :: v_dual_cndmask_b32 v3, 0x80000000, v3
	v_add_lshl_u32 v5, v55, s4, 1
	v_add_lshl_u32 v6, v56, s4, 1
	...
	scratch_store_b32 off, v94, off offset:12 ; 4-byte Folded Spill
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_clause 0x3
	buffer_load_u16 v155, v2, s[8:11], 0 offen
	buffer_load_u16 v18, v4, s[8:11], 0 offen
	buffer_load_u16 v94, v5, s[8:11], 0 offen
	buffer_load_u16 v96, v6, s[8:11], 0 offen
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v165, 0 :: v_dual_add_nc_u32 v140, v1, v16
	...
	v_dual_mov_b32 v184, 0 :: v_dual_mov_b32 v153, 0
	...
	v_dual_mov_b32 v154, 0 :: v_dual_mov_b32 v219, 0
	...
	s_mov_b32 s12, 0
	s_waitcnt vmcnt(4)
	v_dual_mov_b32 v208, 0 :: v_dual_lshlrev_b32 v1, 16, v3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_store_b32 v140, v1 offset:40960
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.11:
	...
	v_dual_mov_b32 v152, v136 :: v_dual_add_nc_u32 v19, s45, v20
	v_dual_mov_b32 v153, v124 :: v_dual_add_nc_u32 v20, s45, v230
	v_dual_mov_b32 v136, v123 :: v_dual_add_nc_u32 v99, s1, v229
	v_dual_mov_b32 v216, v244 :: v_dual_add_nc_u32 v165, s45, v22
	v_dual_mov_b32 v123, v247 :: v_dual_add_nc_u32 v166, s45, v21
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v245, off offset:16
	scratch_store_b32 off, v242, off offset:20
	.loc	1 406 22 is_stmt 1              ; generate_amdgcn.py:406:22
	ds_load_b128 v[243:246], v19 offset:8192
	v_mov_b32_e32 v124, v248
	v_dual_mov_b32 v154, v125 :: v_dual_mov_b32 v159, v140
	v_mov_b32_e32 v125, v249
	ds_load_b128 v[247:250], v19
	v_dual_mov_b32 v140, v118 :: v_dual_mov_b32 v131, v95
	v_dual_mov_b32 v132, v117 :: v_dual_mov_b32 v117, v143
	v_dual_mov_b32 v128, v186 :: v_dual_mov_b32 v119, v157
	v_dual_mov_b32 v118, v145 :: v_dual_mov_b32 v143, v127
	v_dual_mov_b32 v127, v251 :: v_dual_mov_b32 v156, v141
	v_mov_b32_e32 v145, v129
	v_dual_mov_b32 v129, v252 :: v_dual_add_nc_u32 v184, s1, v101
	v_dual_mov_b32 v141, v253 :: v_dual_mov_b32 v186, v111
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	...
	s_mov_b32 s19, s12
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v157, v142 :: v_dual_mov_b32 v226, s19
	v_mov_b32_e32 v142, v254
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v224, s17 :: v_dual_add_nc_u32 v111, s1, v100
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[103:106], v111
	ds_load_b128 v[107:110], v111 offset:2048
	v_dual_mov_b32 v17, v55 :: v_dual_mov_b32 v222, s15
	v_dual_mov_b32 v55, v54 :: v_dual_mov_b32 v220, s13
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_mov_b32_e32 v225, s18
	v_dual_mov_b32 v223, s16 :: v_dual_mov_b32 v150, v134
	v_dual_mov_b32 v221, s14 :: v_dual_mov_b32 v134, v121
	...
	scratch_store_b32 off, v236, off offset:68
	scratch_store_b32 off, v233, off offset:44
	scratch_store_b32 off, v168, off offset:56
	scratch_store_b32 off, v231, off offset:40
	scratch_store_b32 off, v207, off offset:52
	scratch_store_b32 off, v237, off offset:60
	scratch_store_b32 off, v232, off offset:24
	scratch_store_b32 off, v234, off offset:28
	scratch_store_b32 off, v92, off offset:36
	scratch_store_b32 off, v238, off offset:32
	v_dual_mov_b32 v92, v113 :: v_dual_mov_b32 v151, v135
	v_dual_mov_b32 v135, v122 :: v_dual_mov_b32 v122, v241
	s_waitcnt lgkmcnt(3)
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	scratch_load_b32 v165, off, off offset:12 ; 4-byte Folded Reload
	s_waitcnt vmcnt(1)
	v_mov_b16_e32 v54.l, v96.l
	...
	v_dual_mov_b32 v133, v120 :: v_dual_mov_b32 v120, v239
	...
	v_mov_b32_e32 v114, v185
	v_dual_mov_b32 v112, v207 :: v_dual_mov_b32 v113, v92
	v_dual_mov_b32 v111, v186 :: v_dual_mov_b32 v186, v128
	...
	v_dual_mov_b32 v124, v153 :: v_dual_mov_b32 v247, v123
	...
	scratch_load_b32 v231, off, off offset:40
	scratch_load_b32 v168, off, off offset:56
	...
	scratch_load_b32 v232, off, off offset:24
	scratch_load_b32 v245, off, off offset:16
	...
	scratch_load_b32 v236, off, off offset:68
	scratch_load_b32 v169, off, off offset:64
	scratch_load_b32 v228, off, off offset:48
	v_cvt_f32_i32_e32 v154, v242
	scratch_load_b32 v242, off, off offset:20 ; 4-byte Folded Reload
	v_mov_b16_e32 v96.l, v54.l
	v_dual_mov_b32 v54, v55 :: v_dual_mov_b32 v55, v17
	v_mov_b32_e32 v244, v216
	v_mov_b32_e32 v254, v142
	v_mov_b32_e32 v142, v157
	v_mov_b32_e32 v253, v141
	v_dual_mov_b32 v141, v156 :: v_dual_mov_b32 v252, v129
	...
	v_cvt_f32_i32_e32 v156, v175
	v_cvt_f32_i32_e32 v159, v176
	...
	v_dual_mov_b32 v239, v120 :: v_dual_mov_b32 v120, v133
	v_mov_b32_e32 v133, v149
	v_cvt_f32_i32_e32 v216, v240
	v_dual_mov_b32 v240, v121 :: v_dual_mov_b32 v121, v134
	v_mov_b32_e32 v134, v150
	v_cvt_f32_i32_e32 v217, v241
	v_dual_mov_b32 v241, v122 :: v_dual_mov_b32 v122, v135
...
.Ltmp23:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v59, v59, v146, v90
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v59, v90, v59, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(3)
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v56, v56, v148, v84
	v_fma_f32 v96, v96, v144, v89
	v_fma_f32 v97, v97, v118, v88
	v_fma_f32 v98, v98, v117, v87
	v_fma_f32 v99, v99, v95, v86
	v_fma_f32 v100, v100, v186, v85
	v_fma_f32 v101, v101, v157, v83
	v_fma_f32 v102, v102, v145, v82
	v_fma_f32 v103, v103, v143, v81
	v_fma_f32 v104, v104, v114, v80
	v_fma_f32 v105, v105, v113, v79
	v_fma_f32 v106, v106, v112, v78
	...
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v112, v13, v54 :: v_dual_lshlrev_b32 v21, 16, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v58, v58, v147, v91
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e32 v54.h, v18.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v56, v84, v56, s3
	v_cndmask_b32_e64 v58, v91, v58, s3
	v_cndmask_b32_e64 v84, v89, v96, s3
	...
	v_cndmask_b32_e64 v79, v79, v105, s3
	v_cndmask_b32_e64 v78, v78, v106, s3
	v_cndmask_b32_e64 v76, v76, v108, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v89, v109, v142, v75
	v_fma_f32 v90, v110, v141, v74
	v_fma_f32 v91, v111, v228, v73
	v_fma_f32 v96, v112, v139, v72
	v_fma_f32 v97, v113, v138, v71
	v_fma_f32 v98, v114, v137, v70
	v_fma_f32 v99, v143, v136, v69
	v_fma_f32 v100, v144, v135, v68
	v_fma_f32 v101, v145, v134, v67
	v_fma_f32 v102, v146, v133, v66
	v_fma_f32 v105, v149, v130, v63
	v_fma_f32 v106, v150, v129, v62
	v_fma_f32 v108, v152, v127, v60
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v109, v16, v54
	v_mul_f32_e32 v110, v15, v54
	v_mul_f32_e32 v111, v14, v54
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v71, v71, v97, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v97, v113, v126, v50
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v69, v69, v99, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v99, v127, v124, v48
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v50, v50, v97, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v16, v16, v251, v38
	v_fma_f32 v15, v15, v116, v37
	v_fma_f32 v14, v14, v249, v36
	v_fma_f32 v13, v13, v248, v35
	v_fma_f32 v12, v12, v247, v34
	v_fma_f32 v11, v11, v241, v33
	v_fma_f32 v10, v10, v240, v32
	v_fma_f32 v9, v9, v239, v31
	v_fma_f32 v97, v1, v234, v23
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	ds_load_b128 v[13:16], v93 offset:41488
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v48, v48, v99, s3
	v_cndmask_b32_e64 v23, v23, v97, s3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v91, v111, v253, v52
	v_fma_f32 v96, v112, v169, v51
	v_fma_f32 v94, v133, v185, v42
	v_fma_f32 v17, v134, v167, v41
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v52, v52, v91, s3
	v_cndmask_b32_e64 v51, v51, v96, s3
	v_cndmask_b32_e64 v42, v42, v94, s3
	v_cndmask_b32_e64 v17, v41, v17, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v97, v11, v19
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v99, v13, v19
	v_mul_f32_e32 v115, v14, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v90, v110, v254, v53
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v116, v15, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v95, v97, v171, v33
	v_fma_f32 v97, v99, v173, v35
	v_fma_f32 v89, v109, v255, v57
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v53, v53, v90, s3
	v_cndmask_b32_e64 v18, v40, v18, s3
	v_cndmask_b32_e64 v33, v33, v95, s2
	v_cndmask_b32_e64 v35, v35, v97, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_dual_max_f32 v33, v33, v33 :: v_dual_mul_f32 v4, v4, v54
	v_dual_max_f32 v35, v35, v35 :: v_dual_mul_f32 v2, v2, v54
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v40, v8, v231, v30
	v_fma_f32 v41, v7, v92, v29
	v_fma_f32 v89, v6, v207, v28
	v_fma_f32 v90, v5, v238, v27
	v_fma_f32 v94, v3, v236, v25
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[5:8], v93 offset:40976
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v33, 0, v33
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v91, v4, v237, v26
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v35, 0, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v96, v2, v160, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v93 offset:40960
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v81, v81, v103, s3
	v_cndmask_b32_e64 v80, v80, v104, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v110, v9, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v103, v147, v168, v65
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v77, v77, v107, s3
	v_cndmask_b32_e64 v70, v70, v98, s3
	v_cndmask_b32_e64 v68, v68, v100, s3
	v_cndmask_b32_e64 v67, v67, v101, s3
	v_cndmask_b32_e64 v66, v66, v102, s3
	v_cndmask_b32_e64 v65, v65, v103, s3
	v_cndmask_b32_e64 v63, v63, v105, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v98, v114, v125, v49
	v_fma_f32 v100, v128, v123, v47
	v_fma_f32 v101, v129, v122, v46
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v109, v8, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v148, v218, v64
	v_fma_f32 v102, v130, v121, v45
	v_fma_f32 v103, v131, v120, v44
	v_fma_f32 v105, v136, v252, v39
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v114, v13, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v151, v232, v61
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v64, v64, v104, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v132, v233, v43
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v62, v62, v106, s3
	v_cndmask_b32_e64 v60, v60, v108, s3
	v_cndmask_b32_e64 v61, v61, v107, s3
	v_cndmask_b32_e64 v49, v49, v98, s3
	v_cndmask_b32_e64 v47, v47, v100, s3
	v_cndmask_b32_e64 v46, v46, v101, s3
	v_cndmask_b32_e64 v45, v45, v102, s3
	v_cndmask_b32_e64 v44, v44, v103, s3
	v_cndmask_b32_e64 v43, v43, v104, s3
	v_cndmask_b32_e64 v39, v39, v105, s3
	v_cndmask_b32_e64 v30, v30, v40, s3
	v_cndmask_b32_e64 v29, v29, v41, s3
	v_cndmask_b32_e64 v28, v28, v89, s3
	v_cndmask_b32_e64 v27, v27, v90, s3
	v_cndmask_b32_e64 v26, v26, v91, s3
	v_cndmask_b32_e64 v25, v25, v94, s3
	v_cndmask_b32_e64 v24, v24, v96, s3
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(0)
	...
	v_mul_f32_e32 v55, v3, v19
	v_mul_f32_e32 v89, v4, v19
	v_mul_f32_e32 v90, v5, v19
	v_mul_f32_e32 v91, v6, v19
	v_mul_f32_e32 v92, v7, v19
	v_mul_f32_e32 v93, v8, v19
	v_mul_f32_e32 v94, v9, v19
	v_mul_f32_e32 v96, v10, v19
	v_mul_f32_e32 v98, v12, v19
	v_mul_f32_e32 v100, v14, v19
	v_mul_f32_e32 v101, v15, v19
	v_dual_mul_f32 v19, v16, v19 :: v_dual_mul_f32 v102, v1, v21
	v_mul_f32_e32 v103, v2, v21
	v_mul_f32_e32 v104, v3, v21
	v_mul_f32_e32 v105, v4, v21
	v_mul_f32_e32 v106, v5, v21
	v_mul_f32_e32 v107, v6, v21
	v_mul_f32_e32 v108, v7, v21
	v_mul_f32_e32 v111, v10, v21
	v_mul_f32_e32 v112, v11, v21
	v_mul_f32_e32 v113, v12, v21
	v_mul_f32_e32 v21, v16, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v99, v101, v175, v37
	v_fma_f32 v19, v19, v176, v20
	v_fma_f32 v101, v103, v178, v18
	v_fma_f32 v103, v105, v180, v42
	v_fma_f32 v21, v21, v193, v57
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v37, v37, v99, s2
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_lshlrev_b32_e32 v22, 16, v22
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v19, v20, v19, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v105, v107, v182, v44
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v21, v57, v21, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v37, v37, v37
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v117, v1, v22
	v_dual_mul_f32 v118, v2, v22 :: v_dual_max_f32 v19, v19, v19
	v_mul_f32_e32 v119, v3, v22
	v_mul_f32_e32 v120, v4, v22
	v_mul_f32_e32 v121, v5, v22
	v_dual_mul_f32 v122, v6, v22 :: v_dual_max_f32 v37, 0, v37
	v_mul_f32_e32 v123, v7, v22
	v_dual_mul_f32 v124, v8, v22 :: v_dual_max_f32 v19, 0, v19
	v_mul_f32_e32 v125, v9, v22
	v_mul_f32_e32 v126, v10, v22
	v_mul_f32_e32 v127, v11, v22
	v_mul_f32_e32 v128, v12, v22
	v_mul_f32_e32 v129, v13, v22
	v_mul_f32_e32 v130, v14, v22
	v_mul_f32_e32 v131, v15, v22
	v_mul_f32_e32 v22, v16, v22
	v_dual_mul_f32 v12, v12, v38 :: v_dual_max_f32 v21, v21, v21
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v12, v88, v12, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v38, v40, v243, v23
	v_fma_f32 v40, v41, v161, v24
	v_fma_f32 v41, v55, v162, v25
	v_fma_f32 v55, v89, v163, v26
	v_fma_f32 v89, v90, v164, v27
	v_fma_f32 v90, v91, v165, v28
	v_fma_f32 v91, v92, v166, v29
	v_fma_f32 v92, v93, v156, v30
	v_fma_f32 v93, v94, v159, v31
	v_fma_f32 v94, v96, v170, v32
	v_fma_f32 v96, v98, v172, v34
	v_fma_f32 v98, v100, v174, v36
	v_fma_f32 v100, v102, v177, v39
	v_fma_f32 v102, v104, v179, v17
	v_fma_f32 v104, v106, v181, v43
	v_fma_f32 v106, v108, v183, v45
	v_fma_f32 v108, v110, v153, v47
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v25, v25, v41, s2
	v_cndmask_b32_e64 v17, v17, v102, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v109, v184, v46
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v41, v45, v106, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v109, v111, v187, v48
	v_fma_f32 v110, v112, v188, v49
	v_fma_f32 v111, v113, v189, v50
	v_fma_f32 v112, v114, v190, v51
	v_fma_f32 v113, v115, v191, v52
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v20, v39, v100, s2
	v_cndmask_b32_e64 v39, v43, v104, s2
	v_cndmask_b32_e64 v43, v47, v108, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v17, v17, v17
	v_max_f32_e32 v41, v41, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v114, v116, v192, v53
	v_fma_f32 v116, v118, v195, v61
	v_fma_f32 v118, v120, v197, v63
	v_fma_f32 v120, v122, v199, v65
	v_fma_f32 v122, v124, v201, v67
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v23, v38, s2
	v_cndmask_b32_e64 v24, v24, v40, s2
	v_cndmask_b32_e64 v38, v42, v103, s2
	v_cndmask_b32_e64 v40, v44, v105, s2
	v_cndmask_b32_e64 v42, v46, v107, s2
	v_cndmask_b32_e64 v44, v48, v109, s2
	v_cndmask_b32_e64 v45, v49, v110, s2
	v_cndmask_b32_e64 v47, v51, v112, s2
	v_cndmask_b32_e64 v48, v52, v113, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v17, 0, v17
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v124, v126, v203, v69
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v39, v39, v39
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v126, v128, v205, v71
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v56, 0, v41 :: v_dual_max_f32 v41, v43, v43
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v57, v65, v120, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v43, v45, v45
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v65, v71, v126, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v42, v42, v42 :: v_dual_max_f32 v45, v47, v47
	v_max_f32_e32 v47, 0, v41
	v_max_f32_e32 v41, v48, v48
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v14, v14, v224, v59
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v16, v16, v16
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v15, v15, v225, v58
	v_fma_f32 v3, v3, v213, v78
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v46, v50, v111, s2
	v_cndmask_b32_e64 v49, v53, v114, s2
	v_cndmask_b32_e64 v51, v61, v116, s2
	v_cndmask_b32_e64 v14, v59, v14, s2
	v_cndmask_b32_e64 v15, v58, v15, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v12, v12, v12 :: v_dual_max_f32 v59, 0, v42
	v_max_f32_e32 v42, v44, v44
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v8, v154, v83
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v53, v63, v118, s2
	v_cndmask_b32_e64 v63, v69, v124, s2
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v115, v117, v194, v60
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v46, v51, v51
	v_dual_max_f32 v48, 0, v41 :: v_dual_max_f32 v15, v15, v15
	v_dual_max_f32 v69, 0, v42 :: v_dual_max_f32 v42, v49, v49
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v117, v119, v196, v62
	v_fma_f32 v119, v121, v198, v64
	v_fma_f32 v121, v123, v200, v66
	v_fma_f32 v123, v125, v202, v68
	v_fma_f32 v128, v130, v208, v73
	v_fma_f32 v13, v13, v223, v84
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v26, v26, v55, s2
	v_cndmask_b32_e64 v30, v30, v92, s2
	v_cndmask_b32_e64 v50, v60, v115, s2
	v_cndmask_b32_e64 v52, v62, v117, s2
	v_cndmask_b32_e64 v62, v68, v123, s2
	v_cndmask_b32_e64 v8, v83, v8, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, 0, v23 :: v_dual_max_f32 v24, 0, v24
	v_dual_max_f32 v51, 0, v42 :: v_dual_max_f32 v42, v53, v53
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v4, v214, v79
	v_fma_f32 v6, v6, v216, v81
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v36, v36, v98, s2
	v_cndmask_b32_e64 v18, v18, v101, s2
	v_cndmask_b32_e64 v55, v64, v119, s2
	v_cndmask_b32_e64 v60, v66, v121, s2
	v_cndmask_b32_e64 v61, v67, v122, s2
	v_cndmask_b32_e64 v67, v73, v128, s2
	v_cndmask_b32_e64 v13, v84, v13, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v30, v30, v30
	v_dual_max_f32 v45, v50, v50 :: v_dual_mul_f32 v98, v23, v23
	v_max_f32_e32 v26, v26, v26
	v_max_f32_e32 v84, 0, v42
	v_max_f32_e32 v42, v62, v62
	v_max_f32_e32 v8, v8, v8
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v125, v127, v204, v70
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v28, v28, v90, s2
	v_cndmask_b32_e64 v34, v34, v96, s2
	v_cndmask_b32_e64 v4, v79, v4, s2
	v_cndmask_b32_e64 v6, v81, v6, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v81, 0, v45 :: v_dual_max_f32 v26, 0, v26
	v_max_f32_e32 v41, v52, v52
	v_dual_max_f32 v45, v55, v55 :: v_dual_max_f32 v30, 0, v30
	v_dual_max_f32 v49, v60, v60 :: v_dual_max_f32 v18, v18, v18
	v_dual_max_f32 v88, 0, v42 :: v_dual_max_f32 v3, v3, v3
	v_max_f32_e32 v42, v67, v67
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v127, v129, v206, v72
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v66, v72, v127, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v34, v34, v34 :: v_dual_max_f32 v83, 0, v41
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v11, v87, v11, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v38, v38, v38 :: v_dual_max_f32 v87, 0, v49
	v_dual_max_f32 v18, 0, v18 :: v_dual_max_f32 v41, v61, v61
	v_max_f32_e32 v4, v4, v4
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v9, v85, v9, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v28, 0, v28
	v_dual_max_f32 v34, 0, v34 :: v_dual_max_f32 v85, 0, v45
	v_dual_max_f32 v45, v63, v63 :: v_dual_max_f32 v38, 0, v38
	v_max_f32_e32 v61, 0, v41
	v_dual_max_f32 v41, v66, v66 :: v_dual_max_f32 v4, 0, v4
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v7, v217, v82
	v_fma_f32 v2, v2, v212, v77
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v27, v27, v89, s2
	v_cndmask_b32_e64 v32, v32, v94, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v49, v65, v65
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v82, v7, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v82, 0, v46
	v_max_f32_e32 v46, v57, v57
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v129, v131, v209, v74
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v92, 0, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v1, v1, v211, v76
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v29, v29, v91, s2
	v_cndmask_b32_e64 v31, v31, v93, s2
	v_cndmask_b32_e64 v64, v70, v125, s2
	v_cndmask_b32_e64 v68, v74, v129, s2
	v_cndmask_b32_e64 v1, v76, v1, s2
	v_cndmask_b32_e64 v2, v77, v2, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v27, v27, v27 :: v_dual_max_f32 v32, v32, v32
	v_dual_max_f32 v36, v36, v36 :: v_dual_max_f32 v39, 0, v39
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v22, v22, v210, v75
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v43, 0, v43
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v10, v10, v220, v86
	v_fma_f32 v5, v5, v215, v80
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_max_f32 v86, 0, v46 :: v_dual_max_f32 v1, v1, v1
	v_dual_max_f32 v46, v64, v64 :: v_dual_max_f32 v89, 0, v45
	v_dual_max_f32 v45, v68, v68 :: v_dual_max_f32 v2, v2, v2
	v_max_f32_e32 v7, v7, v7
	v_dual_max_f32 v13, v13, v13 :: v_dual_max_f32 v14, v14, v14
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v5, v80, v5, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_max_f32 v90, 0, v46 :: v_dual_max_f32 v5, v5, v5
	v_dual_max_f32 v22, v22, v22 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v93, 0, v42 :: v_dual_mul_f32 v62, v35, v35
	v_max_f32_e32 v94, 0, v45
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v6, v6, v6
	v_dual_max_f32 v9, v9, v9 :: v_dual_max_f32 v2, 0, v2
	v_max_f32_e32 v11, v11, v11
	v_dual_max_f32 v95, 0, v14 :: v_dual_mul_f32 v66, v37, v37
	v_dual_max_f32 v97, 0, v16 :: v_dual_mul_f32 v58, v34, v34
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v80, v24, v24
	v_dual_mul_f32 v42, v26, v26 :: v_dual_mul_f32 v45, v27, v27
	v_mul_f32_e32 v74, v17, v17
	v_mul_f32_e32 v46, v28, v28
	v_dual_mul_f32 v79, v32, v32 :: v_dual_mul_f32 v68, v47, v47
	v_dual_mul_f32 v57, v33, v33 :: v_dual_mul_f32 v64, v43, v43
	v_mul_f32_e32 v63, v36, v36
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v91, 0, v49 :: v_dual_max_f32 v6, 0, v6
	v_dual_max_f32 v7, 0, v7 :: v_dual_max_f32 v12, 0, v12
	v_dual_max_f32 v13, 0, v13 :: v_dual_mul_f32 v50, v30, v30
	v_dual_max_f32 v96, 0, v15 :: v_dual_mul_f32 v41, v25, v25
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v70, v20, v20 :: v_dual_mul_f32 v49, v29, v29
	v_dual_mul_f32 v76, v40, v40 :: v_dual_mul_f32 v53, v31, v31
	v_dual_mul_f32 v72, v56, v56 :: v_dual_mul_f32 v67, v19, v19
	v_dual_mul_f32 v60, v48, v48 :: v_dual_mul_f32 v71, v18, v18
	v_dual_mul_f32 v48, v84, v84 :: v_dual_mul_f32 v75, v38, v38
	v_dual_mul_f32 v40, v61, v61 :: v_dual_mul_f32 v77, v39, v39
	v_dual_mul_f32 v52, v82, v82 :: v_dual_mul_f32 v73, v59, v59
	v_dual_mul_f32 v69, v69, v69 :: v_dual_mul_f32 v38, v88, v88
	v_dual_mul_f32 v65, v44, v44 :: v_dual_mul_f32 v36, v91, v91
	v_dual_mul_f32 v59, v78, v78 :: v_dual_mul_f32 v34, v92, v92
	v_dual_mul_f32 v56, v51, v51 :: v_dual_mul_f32 v51, v81, v81
	v_dual_mul_f32 v28, v2, v2 :: v_dual_mul_f32 v47, v83, v83
	v_dual_mul_f32 v30, v1, v1 :: v_dual_mul_f32 v29, v3, v3
...
.Ltmp24:
	...
	v_max_f32_e32 v1, v98, v80
	v_max3_f32 v2, v42, v45, v46
	v_max3_f32 v3, v79, v57, v58
	v_max3_f32 v4, v62, v63, v66
.Ltmp25:
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v22, 0, v22 :: v_dual_max_f32 v5, 0, v5
	v_dual_max_f32 v10, v10, v10 :: v_dual_max_f32 v9, 0, v9
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v55, v21, v21 :: v_dual_mul_f32 v32, v22, v22
	v_dual_mul_f32 v43, v85, v85 :: v_dual_mul_f32 v16, v8, v8
	v_mul_f32_e32 v15, v7, v7
.Ltmp26:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max3_f32 v1, v1, v41, v2
	v_max3_f32 v2, v3, v4, v67
	v_max_f32_e32 v3, v70, v71
	v_max3_f32 v4, v75, v77, v76
	v_max3_f32 v7, v69, v64, v65
	v_max3_f32 v8, v59, v60, v56
.Ltmp27:
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v10, 0, v10 :: v_dual_max_f32 v11, 0, v11
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v44, v86, v86 :: v_dual_mul_f32 v39, v87, v87
	v_mul_f32_e32 v26, v5, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v37, v89, v89 :: v_dual_mul_f32 v24, v10, v10
	v_dual_mul_f32 v35, v90, v90 :: v_dual_mul_f32 v14, v11, v11
	v_mul_f32_e32 v33, v93, v93
	v_dual_mul_f32 v31, v94, v94 :: v_dual_mul_f32 v10, v13, v13
	v_mul_f32_e32 v25, v6, v6
.Ltmp28:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max3_f32 v5, v49, v50, v53
	v_max3_f32 v6, v72, v73, v68
	v_max3_f32 v3, v3, v74, v4
	v_max3_f32 v4, v7, v8, v55
	v_max3_f32 v13, v48, v43, v44
	v_max3_f32 v17, v37, v35, v36
	v_max3_f32 v1, v1, v5, v2
.Ltmp29:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v11, v95, v95
.Ltmp30:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp32:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max_f32_e32 v12, v51, v52
	v_max3_f32 v18, v34, v33, v31
	v_max3_f32 v7, v39, v40, v38
	v_max_f32_e32 v4, v30, v28
.Ltmp33:
	.loc	1 76 13                         ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
	v_mov_b16_e32 v82.h, v54.l
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max3_f32 v8, v12, v47, v13
	v_max3_f32 v17, v17, v18, v32
.Ltmp35:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v12, v96, v96 :: v_dual_mul_f32 v13, v97, v97
...
.Ltmp48:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v17, v1, v5 :: v_dual_lshlrev_b32 v8, 3, v8
.Ltmp49:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp53:
	...
	v_dual_mov_b32 v21, v19 :: v_dual_max_f32 v18, v18, v18
.Ltmp54:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp62:
	...
	v_dual_max_f32 v19, v20, v20 :: v_dual_mov_b32 v20, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_max_f32 v17, v17, v18 :: v_dual_max_f32 v18, v22, v19
.Ltmp63:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_mov_b32_dpp v20, v20 row_xmask:2 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v19, v17 :: v_dual_mov_b32 v22, v18
.Ltmp64:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_max_f32_e32 v20, v20, v20
...
.Ltmp66:
	...
	v_dual_max_f32 v19, v19, v19 :: v_dual_max_f32 v20, v22, v22
.Ltmp67:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v22, v3 :: v_dual_add_nc_u32 v5, 0, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mov_b32_e32 v21, v1
.Ltmp68:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v19, v17, v19 :: v_dual_max_f32 v20, v18, v20
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp69:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v61, v19 :: v_dual_mov_b32 v78, v20
.Ltmp70:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v18, v22, v22 :: v_dual_max_f32 v17, v21, v21
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp71:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp78:
	...
	v_div_scale_f32 v83, s0, v18, 0x40e00000, v18
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_3)
	v_rcp_f32_e32 v78, v61
	v_div_scale_f32 v84, s1, v20, 0x40e00000, v20
	...
	v_fma_f32 v81, -v19, v2, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v5, v8, v5
	v_fma_f32 v8, -v61, v78, 1.0
	v_fmac_f32_e32 v2, v81, v22
	.loc	1 76 13                         ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
	...
	v_div_scale_f32 v91, null, v81, v81, v46
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 76 14                         ; generate_amdgcn.py:76:14 @[ generate_amdgcn.py:446:9 ]
	v_fma_f32 v17, -v21, v82, v83
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_div_scale_f32 v21, null, v81, v81, v98
	v_rcp_f32_e32 v92, v91
	.loc	1 76 14                         ; generate_amdgcn.py:76:14 @[ generate_amdgcn.py:446:9 ]
	v_mul_f32_e32 v19, v84, v78
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_div_scale_f32 v87, s0, v80, v81, v80
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v22, v21
	v_div_scale_f32 v90, null, v81, v81, v45
	.loc	1 76 14                         ; generate_amdgcn.py:76:14 @[ generate_amdgcn.py:446:9 ]
	v_fma_f32 v1, -v61, v19, v84
	s_delay_alu instid0(VALU_DEP_1)
	v_fmac_f32_e32 v19, v1, v78
	v_div_fmas_f32 v1, v17, v5, v82
	s_mov_b32 vcc_lo, s1
	.loc	1 76 13 is_stmt 0               ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
	v_mov_b16_e32 v5.l, v2.h
	v_mov_b16_e32 v5.h, v54.l
	.loc	1 76 14                         ; generate_amdgcn.py:76:14 @[ generate_amdgcn.py:446:9 ]
	v_fma_f32 v17, -v61, v19, v84
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_div_scale_f32 v19, null, v81, v81, v80
	...
	v_div_scale_f32 v83, vcc_lo, v98, v81, v98
	.loc	1 76 13                         ; generate_amdgcn.py:76:13 @[ generate_amdgcn.py:446:9 ]
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_dual_mul_f32 v54, v83, v22 :: v_dual_and_b32 v5, 1, v61
	v_fma_f32 v17, -v19, v82, 1.0
	...
	v_mul_f32_e32 v20, v87, v82
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v88, -v84, v85, 1.0
	v_fma_f32 v21, -v21, v54, v83
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v83, -v19, v20, v87
	v_fmac_f32_e32 v85, v88, v85
	v_div_scale_f32 v88, s1, v41, v81, v41
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v21, v21, v22, v54
	v_fmac_f32_e32 v20, v83, v82
	v_rcp_f32_e32 v83, v90
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v54, v88, v85
	s_mov_b32 vcc_lo, s0
	v_fma_f32 v19, -v19, v20, v87
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v22, -v84, v54, v88
	v_div_fmas_f32 v19, v19, v82, v20
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v93, -v90, v83, 1.0
	v_fmac_f32_e32 v54, v22, v85
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v22, v19, v81, v80
	v_fmac_f32_e32 v83, v93, v83
	v_fma_f32 v93, -v91, v92, 1.0
	v_div_scale_f32 v80, s3, v46, v81, v46
	v_fma_f32 v19, -v84, v54, v88
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v92, v93, v92
	v_div_fmas_f32 v19, v19, v85, v54
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v88, v80, v92
	v_div_scale_f32 v86, null, v81, v81, v42
	v_div_scale_f32 v82, s0, v45, v81, v45
	v_div_scale_f32 v84, null, v81, v81, v49
	v_rcp_f32_e32 v18, v86
	v_div_fixup_f32 v41, v19, v81, v41
	v_div_scale_f32 v19, s1, v49, v81, v49
	v_div_scale_f32 v93, null, v81, v81, v58
	v_div_fixup_f32 v21, v21, v81, v98
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v89, -v86, v18, 1.0
	v_fmac_f32_e32 v18, v89, v18
	v_div_scale_f32 v89, s2, v42, v81, v42
	s_mov_b32 vcc_lo, s2
	v_mul_f32_e32 v87, v89, v18
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v20, -v86, v87, v89
	v_dual_fmac_f32 v87, v20, v18 :: v_dual_mul_f32 v20, v82, v83
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v54, -v86, v87, v89
	v_div_scale_f32 v89, null, v81, v81, v50
	v_fma_f32 v85, -v90, v20, v82
	v_rcp_f32_e32 v86, v84
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v18, v54, v18, v87
	v_rcp_f32_e32 v54, v89
	s_mov_b32 vcc_lo, s0
	v_fmac_f32_e32 v20, v85, v83
	v_fma_f32 v85, -v91, v88, v80
	v_div_fixup_f32 v42, v18, v81, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	v_fma_f32 v18, -v90, v20, v82
	v_fma_f32 v87, -v84, v86, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_fmac_f32_e32 v88, v85, v92
	v_fma_f32 v82, -v89, v54, 1.0
	v_div_scale_f32 v85, null, v81, v81, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v86, v87, v86 :: v_dual_and_b32 v61, 0xffff0000, v1
	v_fmac_f32_e32 v54, v82, v54
	v_div_fmas_f32 v18, v18, v83, v20
	v_fma_f32 v20, -v91, v88, v80
	v_rcp_f32_e32 v82, v85
	v_div_scale_f32 v87, null, v81, v81, v79
	s_mov_b32 vcc_lo, s3
	v_mul_f32_e32 v80, v19, v86
	v_div_scale_f32 v83, s0, v50, v81, v50
	v_div_fmas_f32 v20, v20, v92, v88
	v_rcp_f32_e32 v92, v87
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v88, -v84, v80, v19
	v_mul_f32_e32 v90, v83, v54
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v91, -v85, v82, 1.0
	v_div_fixup_f32 v45, v18, v81, v45
	v_div_fixup_f32 v46, v20, v81, v46
	v_fmac_f32_e32 v80, v88, v86
	v_fma_f32 v18, -v89, v90, v83
	v_fmac_f32_e32 v82, v91, v82
	v_div_scale_f32 v20, s2, v53, v81, v53
	v_div_scale_f32 v88, null, v81, v81, v57
	v_fma_f32 v91, -v87, v92, 1.0
	v_fma_f32 v19, -v84, v80, v19
	v_fmac_f32_e32 v90, v18, v54
	v_mul_f32_e32 v18, v20, v82
	v_rcp_f32_e32 v84, v88
	v_fmac_f32_e32 v92, v91, v92
	v_div_scale_f32 v91, s3, v79, v81, v79
	s_mov_b32 vcc_lo, s1
	.loc	1 78 35                         ; generate_amdgcn.py:78:35 @[ generate_amdgcn.py:446:9 ]
	v_and_b32_e32 v17, 0xffff0000, v2
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_div_fmas_f32 v19, v19, v86, v80
	v_fma_f32 v80, -v89, v90, v83
	v_fma_f32 v83, -v85, v18, v20
	v_mul_f32_e32 v86, v91, v92
	s_mov_b32 vcc_lo, s0
	v_fma_f32 v89, -v88, v84, 1.0
	v_div_fmas_f32 v54, v80, v54, v90
	v_fmac_f32_e32 v18, v83, v82
	v_rcp_f32_e32 v80, v93
	v_fma_f32 v83, -v87, v86, v91
	v_fmac_f32_e32 v84, v89, v84
	v_div_scale_f32 v89, s0, v57, v81, v57
	v_div_fixup_f32 v49, v19, v81, v49
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v86, v83, v92
	v_div_scale_f32 v83, null, v81, v81, v62
	v_div_fixup_f32 v50, v54, v81, v50
	v_fma_f32 v19, -v85, v18, v20
	v_mul_f32_e32 v20, v89, v84
	v_fma_f32 v54, -v93, v80, 1.0
	v_rcp_f32_e32 v85, v83
	s_mov_b32 vcc_lo, s2
	v_div_scale_f32 v90, null, v81, v81, v63
	v_div_fmas_f32 v18, v19, v82, v18
	v_fma_f32 v19, -v87, v86, v91
	v_fma_f32 v82, -v88, v20, v89
	v_fmac_f32_e32 v80, v54, v80
	v_div_scale_f32 v87, s1, v58, v81, v58
	s_mov_b32 vcc_lo, s3
	v_fmac_f32_e32 v20, v82, v84
	v_div_fmas_f32 v19, v19, v92, v86
	v_rcp_f32_e32 v82, v90
	v_mul_f32_e32 v86, v87, v80
	v_fma_f32 v91, -v83, v85, 1.0
	v_div_fixup_f32 v53, v18, v81, v53
	v_div_fixup_f32 v54, v19, v81, v79
	v_fma_f32 v18, -v88, v20, v89
	v_fma_f32 v19, -v93, v86, v87
	v_fmac_f32_e32 v85, v91, v85
	v_div_scale_f32 v79, s2, v62, v81, v62
	s_mov_b32 vcc_lo, s0
	v_fma_f32 v88, -v90, v82, 1.0
	v_div_fmas_f32 v18, v18, v84, v20
	v_fmac_f32_e32 v86, v19, v80
	v_mul_f32_e32 v19, v79, v85
	v_div_scale_f32 v84, s0, v63, v81, v63
	v_fmac_f32_e32 v82, v88, v82
	v_div_fixup_f32 v57, v18, v81, v57
	v_fma_f32 v18, -v93, v86, v87
	v_fma_f32 v87, -v83, v19, v79
	s_mov_b32 vcc_lo, s1
	v_mul_f32_e32 v91, v84, v82
	v_div_scale_f32 v89, null, v81, v81, v66
	v_div_fmas_f32 v18, v18, v80, v86
	v_fmac_f32_e32 v19, v87, v85
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v80, -v90, v91, v84
	s_mov_b32 vcc_lo, s2
	v_rcp_f32_e32 v20, v89
	v_div_fixup_f32 v58, v18, v81, v58
	v_fma_f32 v18, -v83, v19, v79
	v_div_scale_f32 v83, null, v78, v78, v70
	v_div_scale_f32 v88, null, v81, v81, v67
	v_fmac_f32_e32 v91, v80, v82
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v18, v18, v85, v19
	v_rcp_f32_e32 v85, v83
	s_delay_alu instid0(VALU_DEP_3)
	v_rcp_f32_e32 v92, v88
	s_mov_b32 vcc_lo, s0
	v_fma_f32 v19, -v90, v91, v84
	v_fma_f32 v93, -v89, v20, 1.0
	v_div_scale_f32 v86, s1, v66, v81, v66
	v_div_scale_f32 v80, s3, v67, v81, v67
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	v_div_fmas_f32 v19, v19, v82, v91
	v_fma_f32 v91, -v83, v85, 1.0
	...
	v_dual_fmac_f32 v85, v91, v85 :: v_dual_fmac_f32 v20, v93, v20
	v_fmac_f32_e32 v92, v87, v92
	v_div_fixup_f32 v63, v19, v81, v63
	v_div_scale_f32 v19, s0, v70, v78, v70
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v79, v86, v20
	v_mul_f32_e32 v87, v80, v92
	v_rcp_f32_e32 v82, v90
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v84, -v89, v79, v86
	v_fmac_f32_e32 v79, v84, v20
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v18, v18, v20, v79
	v_fma_f32 v20, -v88, v87, v80
	v_div_scale_f32 v88, null, v78, v78, v75
	s_mov_b32 vcc_lo, s3
	v_mul_f32_e32 v79, v19, v85
	v_div_fmas_f32 v20, v20, v92, v87
	v_rcp_f32_e32 v92, v88
	s_mov_b32 vcc_lo, s0
	v_rcp_f32_e32 v80, v86
	v_fma_f32 v87, -v83, v79, v19
	v_div_fixup_f32 v66, v18, v81, v66
	v_div_fixup_f32 v67, v20, v81, v67
	v_div_scale_f32 v20, s2, v74, v78, v74
	...
	v_fmac_f32_e32 v92, v87, v92
	v_div_scale_f32 v87, s3, v75, v78, v75
	v_fmac_f32_e32 v82, v84, v82
	v_div_scale_f32 v84, s1, v71, v78, v71
	v_div_fmas_f32 v19, v19, v85, v79
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v85, v87, v92
	v_dual_fmac_f32 v80, v91, v80 :: v_dual_mul_f32 v89, v84, v82
	v_div_scale_f32 v91, null, v78, v78, v76
	s_mov_b32 vcc_lo, s1
	v_div_fixup_f32 v70, v19, v78, v70
	v_fma_f32 v18, -v90, v89, v84
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v89, v18, v82
	v_fma_f32 v79, -v90, v89, v84
	v_fma_f32 v90, -v81, v83, 1.0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v79, v79, v82, v89
	...
	v_fma_f32 v18, -v81, v20, v89
	v_div_scale_f32 v81, s2, v72, v78, v72
	...
	v_mul_f32_e32 v81, v85, v20
	v_div_scale_f32 v92, null, v78, v78, v55
	v_fma_f32 v79, -v89, v81, v85
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v81, v79, v20
	v_rcp_f32_e32 v79, v87
	v_fma_f32 v18, -v89, v81, v85
	v_div_scale_f32 v85, null, v78, v78, v59
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	...
	v_div_scale_f32 v88, null, v78, v78, v60
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fixup_f32 v69, v20, v78, v69
	v_fmac_f32_e32 v81, v86, v83
	v_div_scale_f32 v20, s2, v59, v78, v59
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_dual_fmac_f32 v89, v18, v79 :: v_dual_mul_f32 v18, v20, v80
	...
	v_div_scale_f32 v90, s3, v60, v78, v60
	v_div_fixup_f32 v65, v79, v78, v65
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v20, v80, v84
	s_mov_b32 vcc_lo, s3
	v_mul_f32_e32 v83, v90, v91
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v79, -v92, v81, 1.0
	v_div_fixup_f32 v59, v18, v78, v59
	...
	s_mov_b32 vcc_lo, s0
	v_div_fixup_f32 v60, v19, v78, v60
	...
	v_dual_fmac_f32 v85, v80, v91 :: v_dual_mul_f32 v78, v19, v84
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_dual_fmac_f32 v79, v78, v79 :: v_dual_mul_f32 v18, v20, v80
	v_fmac_f32_e32 v90, v89, v90
	v_div_scale_f32 v89, s3, v40, v61, v40
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v81, -v83, v18, v20
	...
	v_dual_fmac_f32 v84, v19, v79 :: v_dual_mul_f32 v19, v85, v78
	...
	v_dual_fmac_f32 v90, v88, v61 :: v_dual_fmac_f32 v87, v91, v87
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_dual_mul_f32 v94, v91, v87 :: v_dual_fmac_f32 v93, v88, v82
	.loc	1 77 9 is_stmt 1                ; generate_amdgcn.py:77:9 @[ generate_amdgcn.py:446:9 ]
	...
	v_rndne_f32_e32 v45, v53
	v_rndne_f32_e32 v53, v62
	...
	v_rndne_f32_e32 v54, v63
	v_rndne_f32_e32 v57, v66
	v_rndne_f32_e32 v63, v74
...
.Ltmp82:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 76
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 76
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
