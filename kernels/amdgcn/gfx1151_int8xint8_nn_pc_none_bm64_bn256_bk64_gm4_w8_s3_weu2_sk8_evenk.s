	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v83, v14, 4, v3
	v_add_nc_u32_e32 v84, s24, v83
...
.Ltmp13:
	...
	buffer_load_b128 v[4:7], v1, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[15:18], v3, s[20:23], 0 offen
	buffer_load_b128 v[19:22], v8, s[20:23], 0 offen
	buffer_load_b128 v[23:26], v11, s[20:23], 0 offen
	buffer_load_b128 v[27:30], v12, s[20:23], 0 offen
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	...
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	buffer_load_b128 v[47:50], v1, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v1, v0, 0, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v92, v10, v8
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v93, v12, 10, v1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_perm_b32 v35, v5, v4, 0x7060302
	...
	s_waitcnt vmcnt(1)
	v_perm_b32 v22, v43, v39, 0x4000501
	...
	ds_store_2addr_b32 v2, v35, v4 offset1:16
	...
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v1, v[47:50] offset:36864
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v1, v26, v22, 0x7060302
	v_perm_b32 v2, v26, v22, 0x5040100
	v_perm_b32 v4, v28, v36, 0x7060302
	v_perm_b32 v5, v28, v36, 0x5040100
	v_perm_b32 v6, v29, v37, 0x7060302
	v_perm_b32 v7, v29, v37, 0x5040100
	v_perm_b32 v8, v30, v38, 0x7060302
	v_perm_b32 v11, v30, v38, 0x5040100
	v_perm_b32 v15, v31, v39, 0x7060302
	v_perm_b32 v16, v31, v39, 0x5040100
	v_perm_b32 v17, v32, v40, 0x7060302
	v_perm_b32 v18, v32, v40, 0x5040100
	v_perm_b32 v19, v33, v41, 0x7060302
	v_perm_b32 v20, v33, v41, 0x5040100
	v_perm_b32 v21, v34, v42, 0x7060302
	v_perm_b32 v22, v34, v42, 0x5040100
	ds_store_2addr_b32 v55, v1, v2 offset1:16
	ds_store_2addr_b32 v56, v4, v5 offset1:16
	ds_store_2addr_b32 v57, v6, v7 offset1:16
	ds_store_2addr_b32 v58, v8, v11 offset1:16
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_mov_b32 s6, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v79, v14, 6, v87
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b32_e32 v88, 0x1800, v1
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v1, v0, 3, 1
	v_dual_mov_b32 v46, 0 :: v_dual_and_b32 v87, 48, v3
.Ltmp14:
	...
	v_and_b32_e32 v88, 0x1800, v91
	v_bfe_i32 v3, v0, 5, 1
	v_lshl_or_b32 v79, v14, 6, v87
	v_xor_b32_e32 v1, v1, v87
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v100, s25, v83
	v_dual_mov_b32 v78, 0 :: v_dual_mov_b32 v75, 0
	v_and_b32_e32 v3, 0x420, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v1, v2, v1, v88
	v_xor_b32_e32 v80, 16, v79
	v_xor_b32_e32 v81, 32, v79
	v_xor_b32_e32 v82, 48, v79
	v_mov_b32_e32 v77, 0
	v_xor_b32_e32 v101, v1, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s4, s31, s6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v113, s7, v101
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v105, s4, v85
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v181, s35, v79
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	...
	s_mul_i32 s4, s4, s25
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b128 v[169:172], v105, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[173:176], v113 offset:8192
	ds_load_b128 v[177:180], v114 offset:8192
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[121:124], v181
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[161:164], v113
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[125:128], v185
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[165:168], v114
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[137:140], v181 offset:1024
	ds_load_b128 v[141:144], v185 offset:1024
	ds_load_b128 v[153:156], v181 offset:2048
	ds_load_b128 v[157:160], v185 offset:2048
	ds_load_b128 v[181:184], v181 offset:3072
	ds_load_b128 v[185:188], v185 offset:3072
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s4, s4, s28
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[105:112], v[161:164], v[121:124], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[113:120], v[173:176], v[121:124], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_wmma_i32_16x16x16_iu8 v[129:136], v[173:176], v[137:140], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu8 v[105:112], v[165:168], v[125:128], v[105:112] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[113:120], v[177:180], v[125:128], v[113:120] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[121:128], v[161:164], v[137:140], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[129:136], v[177:180], v[141:144], v[129:136] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[145:152], v[173:176], v[153:156], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[145:152], v[177:180], v[157:160], v[145:152] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[153:160], v[165:168], v[185:188], v[153:160] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[161:168], v[173:176], v[181:184], v[1:8] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v181, s7, v103
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[161:168], v[177:180], v[185:188], v[161:168] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v185, s35, v81
	ds_load_b128 v[173:176], v185
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[177:180], v181
	ds_load_b128 v[181:184], v181 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[105:112], v[177:180], v[173:176], v[105:112] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[113:120], v[181:184], v[173:176], v[113:120] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v185 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[121:128], v[177:180], v[173:176], v[121:128] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[129:136], v[181:184], v[173:176], v[129:136] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v185 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[137:144], v[177:180], v[173:176], v[137:144] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[145:152], v[181:184], v[173:176], v[145:152] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v185 offset:3072
	v_add_nc_u32_e32 v185, s35, v82
	s_mov_b32 s35, s30
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[161:168], v[181:184], v[173:176], v[161:168] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v181, s7, v104
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[153:160], v[177:180], v[173:176], v[153:160] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[173:176], v185
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[177:180], v181
	...
	v_dual_add_f32 v66, v66, v118 :: v_dual_add_f32 v67, v67, v117
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[121:128], v[177:180], v[173:176], v[121:128] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[129:136], v[181:184], v[173:176], v[129:136] neg_lo:[1,1,0]
	...
	ds_load_b128 v[173:176], v185 offset:3072
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v65, v65, v119 :: v_dual_add_f32 v58, v58, v126
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v63, v63, v121 :: v_dual_add_f32 v56, v56, v128
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[153:160], v[177:180], v[173:176], v[153:160] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[161:168], v[181:184], v[173:176], v[161:168] neg_lo:[1,1,0]
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v108, s4, v83
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v180, v112
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v112, s4, v100
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_add_f32_e32 v75, v75, v177
	v_add_f32_e32 v73, v73, v179
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	...
	v_cvt_f32_i32_e32 v105, v168
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_add_f32_e32 v71, v71, v181
	v_add_f32_e32 v69, v69, v183
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v78, v78, v174 :: v_dual_add_f32 v77, v77, v175
	v_add_f32_e32 v76, v76, v176
	v_add_f32_e32 v74, v74, v178
	v_add_f32_e32 v72, v72, v180
	v_dual_add_f32 v70, v70, v182 :: v_dual_add_f32 v61, v61, v123
	v_dual_add_f32 v54, v54, v130 :: v_dual_add_f32 v59, v59, v125
	v_dual_add_f32 v52, v52, v132 :: v_dual_add_f32 v57, v57, v127
	v_dual_add_f32 v50, v50, v134 :: v_dual_add_f32 v55, v55, v129
	v_dual_add_f32 v48, v48, v136 :: v_dual_add_f32 v53, v53, v131
	v_add_f32_e32 v42, v42, v141
	v_dual_add_f32 v51, v51, v133 :: v_dual_add_f32 v44, v44, v139
	v_dual_add_f32 v49, v49, v135 :: v_dual_add_f32 v38, v38, v145
	v_dual_add_f32 v47, v47, v137 :: v_dual_add_f32 v40, v40, v143
	v_dual_add_f32 v45, v45, v138 :: v_dual_add_f32 v36, v36, v147
	v_dual_add_f32 v43, v43, v140 :: v_dual_add_f32 v34, v34, v149
	v_dual_add_f32 v41, v41, v142 :: v_dual_add_f32 v32, v32, v151
	v_dual_add_f32 v39, v39, v144 :: v_dual_add_f32 v30, v30, v153
	v_dual_add_f32 v37, v37, v146 :: v_dual_add_f32 v28, v28, v155
	v_dual_add_f32 v35, v35, v148 :: v_dual_add_f32 v26, v26, v157
	v_dual_add_f32 v33, v33, v150 :: v_dual_add_f32 v24, v24, v159
	v_dual_add_f32 v31, v31, v152 :: v_dual_add_f32 v22, v22, v161
	v_dual_add_f32 v29, v29, v154 :: v_dual_add_f32 v20, v20, v163
	v_dual_add_f32 v27, v27, v156 :: v_dual_add_f32 v18, v18, v165
	v_dual_add_f32 v19, v19, v164 :: v_dual_add_f32 v16, v16, v106
	v_add_f32_e32 v17, v17, v107
	v_dual_add_f32 v15, v15, v105 :: v_dual_add_f32 v60, v60, v124
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v166, v112, v108, 0x4000501
	v_perm_b32 v167, v112, v108, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v108, s4, v86
	v_add_nc_u32_e32 v112, s4, v84
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v168, v113, v109, 0x4000501
	v_perm_b32 v184, v113, v109, 0x6020703
	v_perm_b32 v185, v114, v110, 0x4000501
	v_perm_b32 v186, v114, v110, 0x6020703
	v_perm_b32 v187, v115, v111, 0x4000501
	v_perm_b32 v188, v115, v111, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[108:111], v108, s[20:23], 0 offen
	buffer_load_b128 v[112:115], v112, s[20:23], 0 offen
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	...
	v_dual_add_f32 v21, v21, v162 :: v_dual_add_nc_u32 v106, s29, v99
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s7, s5, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s30, s6, 0x8000
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v107, s29, v98
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s5, s33
	s_mov_b32 s5, s7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v189, v112, v108, 0x4000501
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v115, s6, v92
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v105, v109, v184, 0x7060302
	v_perm_b32 v109, v109, v184, 0x5040100
	v_perm_b32 v116, v110, v186, 0x7060302
	v_perm_b32 v110, v110, v186, 0x5040100
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b128 v115, v[169:172] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v115, v189, v166, 0x7060302
	v_perm_b32 v166, v189, v166, 0x5040100
	v_add_nc_u32_e32 v169, s29, v93
	v_perm_b32 v117, v114, v187, 0x7060302
	v_perm_b32 v114, v114, v187, 0x5040100
	v_perm_b32 v118, v111, v188, 0x7060302
	v_perm_b32 v111, v111, v188, 0x5040100
	ds_store_2addr_b32 v169, v115, v166 offset1:16
	v_perm_b32 v115, v108, v167, 0x7060302
	v_perm_b32 v108, v108, v167, 0x5040100
	v_add_nc_u32_e32 v166, s29, v94
	ds_store_2addr_b32 v166, v115, v108 offset1:16
	v_perm_b32 v108, v112, v168, 0x7060302
	v_perm_b32 v112, v112, v168, 0x5040100
	v_add_nc_u32_e32 v115, s29, v95
	ds_store_2addr_b32 v115, v108, v112 offset1:16
	v_add_nc_u32_e32 v108, s29, v96
	v_add_nc_u32_e32 v112, s29, v97
	v_perm_b32 v115, v113, v185, 0x7060302
	v_perm_b32 v113, v113, v185, 0x5040100
	ds_store_2addr_b32 v108, v105, v109 offset1:16
	ds_store_2addr_b32 v112, v115, v113 offset1:16
	ds_store_2addr_b32 v169, v116, v110 offset0:160 offset1:176
	ds_store_2addr_b32 v107, v117, v114 offset1:16
	ds_store_2addr_b32 v106, v118, v111 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v1, v91 :: v_dual_mov_b32 v2, v90
...
; %bb.9:
	...
	v_dual_mov_b32 v87, s12 :: v_dual_add_nc_u32 v128, s35, v80
	v_mov_b32_e32 v84, s9
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[123:126], v127 offset:1024
	ds_load_b128 v[107:110], v127
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v85, s10 :: v_dual_add_nc_u32 v130, s35, v81
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v146, s11 :: v_dual_add_nc_u32 v83, s29, v8
	v_dual_mov_b32 v145, s10 :: v_dual_add_nc_u32 v84, s29, v6
	v_dual_mov_b32 v143, s8 :: v_dual_add_nc_u32 v86, s29, v5
	v_dual_mov_b32 v144, s9 :: v_dual_add_nc_u32 v85, s29, v7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v142, s7 :: v_dual_add_nc_u32 v83, s30, v79
	v_dual_mov_b32 v140, s5 :: v_dual_add_nc_u32 v119, s30, v81
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[159:162], v86 offset:8192
	ds_load_b128 v[163:166], v86
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v141, s6 :: v_dual_add_nc_u32 v120, s30, v82
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 219
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 89
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     91
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
