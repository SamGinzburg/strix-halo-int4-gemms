	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s18, s14
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add_nc_u32_e32 v1, s1, v22
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_sub_nc_u32_e32 v22, s23, v10
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e32 vcc_lo, s1, v21
	.loc	1 129 30                        ; generate_amdgcn.py:129:30
	v_add_nc_u32_e32 v2, 64, v23
...
.Ltmp13:
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	buffer_load_u8 v37, v1, s[12:15], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_dual_cndmask_b32 v2, 0x80000000, v2 :: v_dual_lshlrev_b32 v1, 4, v0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_max_u32 s1, s1, 2
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[27:28], v2, s[16:19], 0 offen
	v_bfe_i32 v2, v0, 3, 1
...
; %bb.5:                                ; %.peel.next
	...
	s_lshl_b32 s2, s21, 7
	v_add_nc_u32_e32 v27, s6, v11
	s_add_i32 s21, s22, 0x80
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[27:28], v27, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[29:30], v23 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_b64 v[31:32], v24
...
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v19, v9, v19 :: v_dual_lshlrev_b32 v24, 2, v0
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v16, 16, v16
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v20, v9, v20 :: v_dual_lshlrev_b32 v21, 16, v21
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v5, v19, v5 :: v_dual_lshlrev_b32 v0, 1, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v16, v9, v16 :: v_dual_lshlrev_b32 v17, 16, v17
	v_dual_mul_f32 v21, v9, v21 :: v_dual_and_b32 v0, 28, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v6, v20, v6 :: v_dual_mul_f32 v17, v9, v17
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v12, 16, v12
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v2, v16, v2 :: v_dual_mul_f32 v7, v21, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v3, v17, v3
	.loc	1 144 16 is_stmt 0              ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v12, v9, v12 :: v_dual_lshlrev_b32 v11, 1, v11
	v_mul_f32_e32 v9, v9, v22
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_and_or_b32 v0, 0x1c0, v24, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v11, v10, 2, v11
	v_dual_mul_f32 v1, v12, v1 :: v_dual_mul_f32 v8, v9, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_vgpr, 38
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.numbered_sgpr, 25
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     27
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk4_maskk.kd
