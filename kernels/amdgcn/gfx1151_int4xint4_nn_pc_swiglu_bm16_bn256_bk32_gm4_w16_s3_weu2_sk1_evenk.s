	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[5:6], null, s27, v1, v[26:27]
	.loc	1 93 28                         ; generate_amdgcn.py:93:28
	s_sub_i32 s2, s2, s4
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v16, v12, s[16:19], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[10:11], v13, s[20:23], 0 offen
	buffer_load_b64 v[12:13], v15, s[20:23], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_bfe_i32 v4, v0, 7, 1
	...
	v_xor_b32_e32 v21, v4, v15
	v_lshlrev_b32_e32 v4, 4, v0
	s_delay_alu instid0(VALU_DEP_2)
	v_add_nc_u32_e32 v15, 0, v21
	s_waitcnt vmcnt(5)
	ds_store_b8 v15, v14 offset:16384
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v15, v16 offset:16640
...
.Ltmp15:
	...
	v_mad_u64_u32 v[3:4], null, s27, v1, s[6:7]
	v_mov_b32_e32 v1, 0
	v_and_or_b32 v22, 0x88, v5, v18
	v_readfirstlane_b32 s6, v6
	s_add_i32 s11, 0, 0x4100
	v_add3_u32 v4, v7, s1, v2
	v_add3_u32 v2, v8, s1, v2
	v_xor_b32_e32 v23, 8, v22
	v_add3_u32 v24, v3, v26, 32
	v_mov_b32_e32 v3, v1
	v_subrev_nc_u32_e32 v25, s3, v4
	v_subrev_nc_u32_e32 v27, s3, v2
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v38, v24, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[28:29], v27, s[20:23], 0 offen
	buffer_load_b64 v[30:31], v25, s[20:23], 0 offen
	s_mov_b32 s28, s0
	s_mov_b32 s0, s11
	s_mov_b32 s11, s24
	s_mov_b32 s24, s3
	v_add_nc_u32_e32 v33, s11, v20
	s_mov_b32 s3, s6
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v32, s28, v22
	v_add_nc_u32_e32 v34, s28, v23
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v35, s3, v20
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v36, v33 offset:1280
	ds_load_u8 v37, v33 offset:1792
	ds_load_u8 v40, v33 offset:1536
	ds_load_u8 v41, v33 offset:1024
	ds_load_u8 v42, v33 offset:256
	ds_load_u8 v43, v33 offset:768
	ds_load_u8 v44, v33 offset:512
	ds_load_u8 v45, v33
	...
	ds_load_u8 v52, v33 offset:2560
	ds_load_u8 v53, v33 offset:2048
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v54, v35 offset:1280
	ds_load_u8 v55, v35 offset:1792
	ds_load_u8 v56, v35 offset:1536
	ds_load_u8 v57, v35 offset:1024
	ds_load_u8 v58, v35 offset:256
	ds_load_u8 v59, v35 offset:768
	ds_load_u8 v60, v35 offset:512
	ds_load_u8 v61, v35
	ds_load_u8 v62, v35 offset:3328
	ds_load_u8 v63, v35 offset:3840
	ds_load_u8 v64, v35 offset:3584
	ds_load_u8 v65, v35 offset:3072
	ds_load_u8 v66, v35 offset:2304
	ds_load_u8 v67, v35 offset:2816
	ds_load_u8 v68, v35 offset:2560
	ds_load_u8 v69, v35 offset:2048
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[36:37], v[32:33], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[42:43], v[32:33], v[1:8] neg_lo:[1,1,0]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_lshl_b32 s1, s26, 8
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v32, v38 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v33, v[28:29], v[30:31] offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
; %bb.9:
	...
	v_add_nc_u32_e32 v32, s22, v45
	v_add_nc_u32_e32 v23, s22, v48
	v_add_nc_u32_e32 v35, s22, v41
	v_add_nc_u32_e32 v24, s22, v47
	v_add_nc_u32_e32 v33, s22, v44
	v_add_nc_u32_e32 v34, s22, v43
	v_add_nc_u32_e32 v36, s22, v53
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v25, v25
	ds_load_u8 v32, v32
	ds_load_u8 v23, v23
	...
	v_add_nc_u32_e32 v38, s22, v40
	v_add_nc_u32_e32 v22, s22, v50
	v_add_nc_u32_e32 v37, s22, v49
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v32, s6, v46
	v_add_nc_u32_e32 v33, s6, v45
	v_add_nc_u32_e32 v16, s6, v48
	v_add_nc_u32_e32 v36, s6, v41
	v_add_nc_u32_e32 v17, s6, v47
	v_add_nc_u32_e32 v34, s6, v44
	v_add_nc_u32_e32 v35, s6, v43
	v_add_nc_u32_e32 v37, s6, v53
...
.LBB0_12:                               ; %._crit_edge54
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v30, v13 :: v_dual_add_nc_u32 v27, s11, v31
	s_delay_alu instid0(VALU_DEP_3)
...
; %bb.13:
	...
	ds_load_u8 v33, v33
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v29, s3, v51
	v_add_nc_u32_e32 v9, s3, v55
	v_add_nc_u32_e32 v61, s3, v40
	v_add_nc_u32_e32 v30, s3, v50
	v_add_nc_u32_e32 v31, s3, v49
	v_add_nc_u32_e32 v62, s3, v42
	v_add_nc_u32_e32 v27, s3, v54
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v63, v28
	ds_load_u8 v29, v29
	ds_load_u8 v9, v9
...
.LBB0_17:
	...
	buffer_load_u16 v26, v10, s[16:19], 0 offen
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 73
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm16_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
