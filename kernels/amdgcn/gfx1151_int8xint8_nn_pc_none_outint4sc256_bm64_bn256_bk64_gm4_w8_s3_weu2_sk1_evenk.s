...
.Ltmp0:
	...
	v_lshlrev_b32_e32 v84, 6, v0
	v_and_b32_e32 v85, 8, v0
	v_and_b32_e32 v86, 32, v0
	v_lshlrev_b32_e32 v87, 6, v61
	s_mov_b32 s18, 0
.Ltmp1:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[58:59], null, s29, v2, v[57:58]
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v82, s29, 1, v58
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshlrev_b32_e32 v60, 4, v0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_xor_b32_e32 v89, v60, v43
	.loc	1 349 16                        ; generate_amdgcn.py:349:16
...
.Ltmp13:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v15, s8, v58
	v_add_nc_u32_e32 v3, s8, v82
	v_add_nc_u32_e32 v4, s8, v59
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v1, 0x80000000, v15, s3
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v23, s33, v83
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v24, s8, v82
	.loc	1 408 22 is_stmt 0              ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v19, 0x80000000, v16, s3
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v25, s8, v59
	...
	v_cndmask_b32_e64 v27, 0x80000000, v25, s2
	...
	v_add_nc_u32_e32 v44, 0, v91
	v_add_nc_u32_e32 v45, 0, v92
	v_add_nc_u32_e32 v46, 0, v93
	v_add_nc_u32_e32 v47, 0, v94
	v_add_nc_u32_e32 v48, 0, v95
	v_add_nc_u32_e32 v49, 0, v96
	...
	v_perm_b32 v4, v11, v7, 0x6020703
	v_perm_b32 v5, v12, v8, 0x4000501
	v_perm_b32 v6, v12, v8, 0x6020703
	v_perm_b32 v7, v13, v9, 0x4000501
	v_perm_b32 v8, v13, v9, 0x6020703
	...
	v_perm_b32 v27, v3, v11, 0x7060302
	...
	ds_store_2addr_b32 v44, v11, v4 offset1:16
	ds_store_2addr_b32 v45, v12, v5 offset1:16
	ds_store_2addr_b32 v46, v13, v6 offset1:16
	ds_store_2addr_b32 v47, v14, v7 offset1:16
	ds_store_2addr_b32 v43, v15, v8 offset0:160 offset1:176
	...
	v_perm_b32 v3, v19, v18, 0x5040100
...
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v97, s29, v58
	v_and_or_b32 v88, 0x1c0, v84, v2
	...
	v_dual_mov_b32 v5, s20 :: v_dual_mov_b32 v78, 0
	...
	v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v69, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s19, v99
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v106, s16, v83
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v182, s36, v98
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v115, s19, v103
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v186, s36, v100
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s16, s16, s29
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b128 v[170:173], v106, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v182, s19, v104
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v182, s19, v105
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v80, v80, v120 :: v_dual_add_f32 v39, v39, v133
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v111, s16, v58
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v183, v115
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v115, s16, v97
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v56, v56, v177 :: v_dual_add_f32 v55, v55, v176
	v_add_f32_e32 v53, v53, v174
	v_add_f32_e32 v27, v27, v180
	v_add_f32_e32 v25, v25, v178
	v_add_f32_e32 v47, v47, v185
	v_dual_add_f32 v45, v45, v183 :: v_dual_add_f32 v52, v52, v125
	v_add_f32_e32 v19, v19, v128
	v_dual_add_f32 v51, v51, v124 :: v_dual_add_f32 v50, v50, v123
	v_add_f32_e32 v75, v75, v137
	v_dual_add_f32 v20, v20, v129 :: v_dual_add_f32 v37, v37, v131
	v_dual_add_f32 v18, v18, v127 :: v_dual_add_f32 v43, v43, v140
	v_dual_add_f32 v78, v78, v130 :: v_dual_add_f32 v77, v77, v135
	v_dual_add_f32 v40, v40, v134 :: v_dual_add_f32 v15, v15, v144
	v_dual_add_f32 v38, v38, v132 :: v_dual_add_f32 v41, v41, v138
	v_dual_add_f32 v76, v76, v136 :: v_dual_add_f32 v13, v13, v142
	v_dual_add_f32 v44, v44, v141 :: v_dual_add_f32 v33, v33, v147
	v_dual_add_f32 v42, v42, v139 :: v_dual_add_f32 v35, v35, v149
	v_dual_add_f32 v16, v16, v145 :: v_dual_add_f32 v73, v73, v151
	v_dual_add_f32 v14, v14, v143 :: v_dual_add_f32 v71, v71, v153
	v_dual_add_f32 v74, v74, v146 :: v_dual_add_f32 v31, v31, v156
	v_dual_add_f32 v36, v36, v150 :: v_dual_add_f32 v11, v11, v160
	v_dual_add_f32 v34, v34, v148 :: v_dual_add_f32 v29, v29, v154
	v_dual_add_f32 v72, v72, v152 :: v_dual_add_f32 v9, v9, v158
	v_dual_add_f32 v32, v32, v157 :: v_dual_add_f32 v23, v23, v163
	v_dual_add_f32 v30, v30, v155 :: v_dual_add_f32 v21, v21, v108
	v_dual_add_f32 v10, v10, v159 :: v_dual_add_f32 v69, v69, v109
	v_add_f32_e32 v70, v70, v162
	v_dual_add_f32 v24, v24, v164 :: v_dual_add_f32 v67, v67, v106
	v_add_f32_e32 v22, v22, v110
	v_add_f32_e32 v68, v68, v107
	v_add_f32_e32 v48, v48, v186
	v_dual_add_f32 v17, v17, v126 :: v_dual_add_f32 v46, v46, v184
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v165, v115, v111, 0x4000501
	v_perm_b32 v166, v115, v111, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v111, s16, v82
	v_add_nc_u32_e32 v115, s16, v59
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_add_i32 s0, s0, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v12, v12, v161 :: v_dual_add_nc_u32 v109, s0, v96
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v110, s0, v94
	v_add_nc_u32_e32 v108, s0, v95
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	ds_store_2addr_b32 v108, v115, v116 offset1:16
	ds_store_2addr_b32 v109, v117, v114 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v6, v87 :: v_dual_mov_b32 v1, v85
	v_dual_mov_b32 v4, v84 :: v_dual_mov_b32 v3, v86
	s_mov_b32 s18, s16
.LBB0_7:                                ; %Flow214
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
...
; %bb.8:
	...
	s_mov_b32 s23, s16
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v88, s18, v59
	v_add_nc_u32_e32 v85, s18, v84
	v_add_nc_u32_e32 v87, s18, v83
	v_add_nc_u32_e32 v86, s18, v82
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s18, s16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v93, s36, v7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[165:168], v88 offset:8192
	ds_load_b128 v[169:172], v88
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v133, s36, v8
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v87, s18 :: v_dual_add_nc_u32 v134, s36, v58
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 221
