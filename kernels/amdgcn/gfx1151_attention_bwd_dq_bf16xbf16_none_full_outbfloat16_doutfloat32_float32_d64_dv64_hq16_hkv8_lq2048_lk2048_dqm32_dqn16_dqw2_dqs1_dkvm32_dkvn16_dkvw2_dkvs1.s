	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1                          ; -- Begin function amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1,@function
amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1:                                 ; @amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v102, 0 :: v_dual_lshlrev_b32 v17, 3, v89
	...
	.loc	1 166 23                        ; attention_backward.py:166:23
	s_clause 0x3
	buffer_load_b128 v[85:88], v25, s[24:27], 0 offen
	buffer_load_b128 v[81:84], v28, s[24:27], 0 offen
	buffer_load_b128 v[77:80], v26, s[24:27], 0 offen
	buffer_load_b128 v[73:76], v27, s[24:27], 0 offen
	.loc	1 171 28                        ; attention_backward.py:171:28
	s_and_b32 s25, s7, 0xffff
	s_mov_b32 s24, s6
	v_cndmask_b32_e64 v1, 0x80000000, v21, s0
	s_clause 0x7
	...
	buffer_load_b128 v[53:56], v20, s[24:27], 0 offen
	buffer_load_b128 v[49:52], v24, s[24:27], 0 offen
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v137, 0, v103
	.loc	1 230 21                        ; attention_backward.py:230:21
	s_mul_i32 s2, s2, s34
	v_dual_mov_b32 v127, v34 :: v_dual_add_nc_u32 v138, 0, v104
	.loc	1 229 28                        ; attention_backward.py:229:28
	v_add_lshl_u32 v35, s2, v129, 1
	v_add_lshl_u32 v36, s2, v132, 1
	v_add_nc_u32_e32 v139, 0, v105
	v_add_nc_u32_e32 v140, 0, v106
	.loc	1 234 26                        ; attention_backward.py:234:26
	v_dual_mov_b32 v38, v33 :: v_dual_add_nc_u32 v141, 0, v107
	...
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_clause 0x1
	buffer_load_b128 v[119:122], v35, s[24:27], 0 offen
	buffer_load_b128 v[123:126], v36, s[24:27], 0 offen
	.loc	1 234 26                        ; attention_backward.py:234:26
	v_mov_b32_e32 v35, v33
	v_mov_b32_e32 v36, v33
	v_dual_mov_b32 v37, v33 :: v_dual_add_nc_u32 v142, 0, v108
	v_dual_mov_b32 v39, v33 :: v_dual_add_nc_u32 v144, 0, v110
	v_dual_mov_b32 v40, v33 :: v_dual_add_nc_u32 v143, 0, v109
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_waitcnt vmcnt(1)
	ds_store_b128 v133, v[119:122]
	s_waitcnt vmcnt(0)
	ds_store_b128 v133, v[123:126] offset:1024
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[119:122], v137
	ds_load_b128 v[123:126], v138
	ds_load_b128 v[145:148], v139
	ds_load_b128 v[149:152], v140
	ds_load_b128 v[153:156], v141
	ds_load_b128 v[157:160], v142
	ds_load_b128 v[161:164], v143
	ds_load_b128 v[165:168], v144
	.loc	1 234 26                        ; attention_backward.py:234:26
	s_waitcnt lgkmcnt(6)
	v_wmma_f32_16x16x16_bf16 v[111:118], v[119:126], v[1:8], v[111:118]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_f32_16x16x16_bf16 v[111:118], v[145:152], v[9:16], v[111:118]
	s_waitcnt lgkmcnt(2)
	v_wmma_f32_16x16x16_bf16 v[111:118], v[153:160], v[17:24], v[111:118]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_f32_16x16x16_bf16 v[111:118], v[161:168], v[25:32], v[111:118]
	.loc	1 235 17                        ; attention_backward.py:235:17
	v_dual_mul_f32 v34, s23, v111 :: v_dual_mul_f32 v35, s23, v112
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v36, s23, v113 :: v_dual_mul_f32 v37, s23, v114
	v_dual_mul_f32 v38, s23, v115 :: v_dual_mul_f32 v39, s23, v116
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v40, s23, v117 :: v_dual_mul_f32 v111, s23, v118
...
.Ltmp6:
	...
	v_dual_mov_b32 v38, v102 :: v_dual_sub_f32 v37, v127, v34
...
.Ltmp18:
	...
	v_dual_mul_f32 v77, v52, v80 :: v_dual_mul_f32 v80, v54, v110
	.loc	1 166 23                        ; attention_backward.py:166:23
	v_mov_b16_e32 v103.l, v35.l
	v_mov_b16_e32 v104.l, v35.l
	v_mov_b16_e32 v105.l, v35.l
	v_mov_b16_e32 v106.l, v35.l
	v_mov_b16_e32 v107.l, v35.l
	v_mov_b16_e32 v108.l, v35.l
	v_mov_b16_e32 v109.l, v35.l
	v_mov_b16_e32 v110.l, v35.l
	v_mov_b16_e32 v111.l, v35.l
	v_mov_b16_e32 v112.l, v35.l
	v_mov_b16_e32 v113.l, v35.l
.Ltmp19:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_fmac_f32 v86, v71, v38 :: v_dual_mul_f32 v73, v46, v73
	v_dual_fmac_f32 v40, v67, v35 :: v_dual_mul_f32 v35, v48, v74
	v_fmac_f32_e32 v80, v53, v109
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_add_f32 v36, v87, v86 :: v_dual_fmac_f32 v73, v45, v113
.Ltmp20:
	.loc	1 166 23                        ; attention_backward.py:166:23
...
.Ltmp21:
	...
	v_dual_fmac_f32 v83, v57, v103 :: v_dual_and_b32 v76, 0xffff0000, v76
	v_dual_fmac_f32 v84, v61, v105 :: v_dual_fmac_f32 v77, v51, v106
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v78, v55, v108 :: v_dual_add_f32 v35, v73, v35
	v_fmac_f32_e32 v82, v63, v104
.Ltmp22:
	.loc	1 176 24                        ; attention_backward.py:176:24
	v_dual_mul_f32 v76, v44, v76 :: v_dual_fmac_f32 v79, v49, v107
.Ltmp23:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_add_f32_e32 v38, v85, v40
	v_dual_add_f32 v40, v83, v81 :: v_dual_fmac_f32 v75, v41, v111
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_f32_e32 v39, v84, v82
	v_fmac_f32_e32 v76, v43, v110
	s_delay_alu instid0(VALU_DEP_4)
	v_add_f32_e32 v36, v36, v38
.Ltmp24:
	.loc	1 264 43                        ; attention_backward.py:264:43
	v_cmp_gt_f32_e64 s2, 0x800000, v102
...
.Ltmp25:
	...
	v_dual_add_f32 v38, v39, v40 :: v_dual_add_f32 v39, v80, v78
	v_add_f32_e32 v40, v79, v77
...
.Ltmp26:
	...
	.loc	1 124 21                        ; attention_backward.py:124:21
	v_or_b32_e32 v37, s16, v33
.Ltmp27:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_add_f32 v39, v39, v40 :: v_dual_mov_b32 v74, v36
...
.Ltmp34:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
	v_dual_mov_b32 v77, v36 :: v_dual_mov_b32 v40, v38
	s_mov_b32 s12, 0
...
.Ltmp37:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_add_f32_e32 v35, v35, v73
	v_dual_add_f32 v36, v36, v77 :: v_dual_lshlrev_b32 v77, 2, v91
	s_mov_b32 s30, s10
...
.Ltmp39:
	...
	s_mov_b32 s31, s11
	v_dual_mov_b32 v82, 0x5410 :: v_dual_lshlrev_b32 v85, 5, v0
...
.Ltmp46:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_add_f32 v39, v39, v74 :: v_dual_add_f32 v34, v36, v37
	s_mov_b32 s16, s12
.Ltmp47:
	.loc	1 266 9                         ; attention_backward.py:266:9
	s_and_b32 s2, s3, s2
...
.Ltmp48:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mov_b32 v74, v38 :: v_dual_add_f32 v39, v39, v76
...
.Ltmp50:
	...
	v_dual_mov_b32 v74, v38 :: v_dual_add_f32 v37, v40, v76
.Ltmp51:
	.loc	1 392 17                        ; attention_backward.py:392:17
	v_bfe_u32 v40, v69, 16, 1
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_lshrrev_b32_e32 v76, 2, v91
.Ltmp52:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_add_f32_e32 v36, v39, v75
...
.Ltmp54:
	.loc	1 267 9                         ; attention_backward.py:267:9
	v_add_nc_u32_e32 v75, 0, v100
.Ltmp55:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_add_f32 v35, v38, v74 :: v_dual_and_b32 v74, 24, v0
.Ltmp56:
	.loc	1 266 9                         ; attention_backward.py:266:9
	...
	.loc	1 266 9                         ; attention_backward.py:266:9
	s_waitcnt lgkmcnt(0)
	buffer_store_b32 v73, v38, s[8:11], 0 offen
	.loc	1 267 9                         ; attention_backward.py:267:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_dual_mov_b32 v94, v33 :: v_dual_add_nc_u32 v157, 0, v37
	...
	v_add3_u32 v34, v39, v76, v90
	v_add_nc_u32_e32 v156, 0, v36
	v_dual_mov_b32 v36, v33 :: v_dual_add_nc_u32 v165, 0, v83
	...
	v_dual_mov_b32 v92, v33 :: v_dual_add_nc_u32 v155, 0, v35
	v_add_nc_u32_e32 v152, 0, v34
	v_mov_b32_e32 v34, v33
	v_or3_b32 v149, v85, v84, v87
	v_dual_mov_b32 v35, v33 :: v_dual_lshlrev_b32 v86, 1, v74
	...
	v_dual_mov_b32 v81, v33 :: v_dual_add_nc_u32 v168, 0, v85
	...
	v_dual_mov_b32 v90, v33 :: v_dual_add_nc_u32 v153, 0, v38
	...
	v_dual_mov_b32 v96, v33 :: v_dual_add_nc_u32 v159, 0, v73
	v_add_nc_u32_e32 v160, 0, v75
	v_dual_mov_b32 v82, v33 :: v_dual_add_nc_u32 v161, 0, v76
	v_add_nc_u32_e32 v162, 0, v79
	v_add_nc_u32_e32 v163, 0, v80
	v_add_nc_u32_e32 v167, 0, v84
	v_dual_mov_b32 v38, v33 :: v_dual_add_nc_u32 v169, 0, v86
	v_add_nc_u32_e32 v166, v77, v74
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	v_fma_f32 v188, s23, v198, -v145
	v_fma_f32 v189, s23, v199, -v145
	v_fma_f32 v186, s23, v196, -v145
	v_fma_f32 v187, s23, v197, -v145
	v_fma_f32 v190, s23, v200, -v145
	v_fma_f32 v191, s23, v201, -v145
	.loc	1 398 31                        ; attention_backward.py:398:31
	...
	.loc	1 345 58                        ; attention_backward.py:345:58
	v_fma_f32 v176, s23, v194, -v145
	v_fma_f32 v177, s23, v195, -v145
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_sub_f32_e32 v178, v178, v147
	.loc	1 345 45                        ; attention_backward.py:345:45
	v_exp_f32_e32 v130, v176
	s_delay_alu instid0(VALU_DEP_2)
	v_exp_f32_e32 v131, v177
	v_exp_f32_e32 v176, v186
	v_exp_f32_e32 v177, v187
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_sub_f32_e32 v174, v184, v147
	...
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_sub_f32_e32 v173, v183, v147
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 345 29                        ; attention_backward.py:345:29
	v_cndmask_b32_e64 v179, 0, v179, s0
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_sub_f32_e32 v170, v180, v147
	.loc	1 345 45                        ; attention_backward.py:345:45
	v_exp_f32_e32 v180, v190
	.loc	1 396 26                        ; attention_backward.py:396:26
	v_mul_f32_e32 v173, v179, v173
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 396 43 is_stmt 0              ; attention_backward.py:396:43
	v_dual_sub_f32 v171, v181, v147 :: v_dual_mul_f32 v170, v176, v170
	.loc	1 345 45 is_stmt 1              ; attention_backward.py:345:45
	v_exp_f32_e32 v181, v191
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_dual_sub_f32 v172, v182, v147 :: v_dual_mul_f32 v173, s22, v173
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	.loc	1 396 26 is_stmt 0              ; attention_backward.py:396:26
	v_dual_mul_f32 v171, v177, v171 :: v_dual_mul_f32 v170, s22, v170
	.loc	1 345 29 is_stmt 1              ; attention_backward.py:345:29
	v_cndmask_b32_e64 v180, 0, v180, s0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 396 43                        ; attention_backward.py:396:43
	v_dual_sub_f32 v175, v185, v147 :: v_dual_mul_f32 v172, v178, v172
	.loc	1 397 34                        ; attention_backward.py:397:34
	v_mul_f32_e32 v171, s22, v171
	.loc	1 397 33 is_stmt 0              ; attention_backward.py:397:33
	...
	.loc	1 396 26                        ; attention_backward.py:396:26
	v_dual_mul_f32 v174, v180, v174 :: v_dual_mul_f32 v131, s22, v131
	.loc	1 397 34                        ; attention_backward.py:397:34
	v_mul_f32_e32 v172, s22, v172
	.loc	1 397 33 is_stmt 0              ; attention_backward.py:397:33
	v_bfe_u32 v178, v170, 16, 1
	.loc	1 396 26 is_stmt 1              ; attention_backward.py:396:26
	v_dual_mul_f32 v175, v181, v175 :: v_dual_mul_f32 v174, s22, v174
...
.Ltmp57:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_vgpr, 204
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1"                        ; string offset=97 ; amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
    .private_segment_fixed_size: 0
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_full_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.kd
