	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_lshl_b32 s36, s3, 4
	.loc	1 93 13                         ; generate_amdgcn.py:93:13
	s_xor_b32 s37, s5, s19
	.loc	1 95 22                         ; generate_amdgcn.py:95:22
	s_lshr_b32 s17, s4, 31
	.loc	1 93 13                         ; generate_amdgcn.py:93:13
	s_sub_i32 s3, s37, s19
.Ltmp12:
...
.Ltmp13:
	...
	v_or_b32_e32 v5, s6, v11
	.loc	1 155 22                        ; generate_amdgcn.py:155:22
	v_or_b32_e32 v3, s36, v10
.Ltmp14:
...
.LBB0_3:                                ; %Flow68
	...
	v_dual_mov_b32 v15, 0 :: v_dual_lshlrev_b32 v34, 3, v40
	v_dual_mov_b32 v26, 0 :: v_dual_and_b32 v33, 0x108, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_or_b32_e32 v5, s0, v9
	v_or_b32_e32 v4, s33, v16
	v_or_b32_e32 v8, s33, v19
	v_or_b32_e32 v6, s33, v23
	v_mul_lo_u32 v3, v3, s1
	.loc	1 156 27                        ; generate_amdgcn.py:156:27
	v_cmp_gt_i32_e32 vcc_lo, s18, v5
	.loc	1 162 34                        ; generate_amdgcn.py:162:34
	v_add_nc_u32_e32 v2, v2, v5
	v_or_b32_e32 v7, s33, v22
	v_or_b32_e32 v25, s33, v17
	.loc	1 164 34                        ; generate_amdgcn.py:164:34
	...
	v_or_b32_e32 v5, s33, v21
	v_or_b32_e32 v26, s33, v20
	v_or_b32_e32 v27, s33, v18
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x3
	buffer_load_u16 v54, v2, s[28:31], 0 offen
	buffer_load_u16 v55, v4, s[28:31], 0 offen
	buffer_load_u16 v56, v6, s[28:31], 0 offen
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x3
	buffer_load_u16 v59, v2, s[28:31], 0 offen
	buffer_load_u16 v60, v4, s[28:31], 0 offen
	buffer_load_u16 v61, v5, s[28:31], 0 offen
	buffer_load_u16 v62, v6, s[28:31], 0 offen
	.loc	1 155 22                        ; generate_amdgcn.py:155:22
	v_or_b32_e32 v2, s0, v10
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	s_mov_b32 s22, s10
	s_mov_b32 s23, s11
	v_lshl_or_b32 v3, v9, 4, v33
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 156 27                        ; generate_amdgcn.py:156:27
	...
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	buffer_load_b32 v63, v1, s[20:23], 0 offen
	v_lshlrev_b32_e32 v1, 4, v0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v1, 0x70, v1
	v_or3_b32 v1, v1, v34, v2
	...
	v_mov_b32_e32 v8, v1
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[49:50], v41 offset:2048
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_wmma_i32_16x16x16_iu4 v[25:32], v[47:48], v[45:46], v[1:8] neg_lo:[1,1,0]
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v46, 16, v55
	v_lshlrev_b32_e32 v48, 16, v57
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_wmma_i32_16x16x16_iu4 v[25:32], v[51:52], v[49:50], v[25:32] neg_lo:[1,1,0]
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	v_dual_mul_f32 v28, v28, v49 :: v_dual_lshlrev_b32 v45, 16, v54
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v30, v30, v49 :: v_dual_lshlrev_b32 v47, 16, v56
	v_dual_mul_f32 v32, v32, v49 :: v_dual_lshlrev_b32 v51, 16, v60
	v_dual_mul_f32 v25, v25, v49 :: v_dual_lshlrev_b32 v54, 16, v62
	v_mul_f32_e32 v26, v26, v49
	v_mul_f32_e32 v27, v27, v49
	v_mul_f32_e32 v29, v29, v49
	v_mul_f32_e32 v31, v31, v49
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v25, v25, v45, 0
	v_fma_f32 v26, v26, v46, 0
	v_fma_f32 v27, v27, v47, 0
	v_fma_f32 v28, v28, v48, 0
	v_fma_f32 v29, v29, v50, 0
	v_fma_f32 v30, v30, v51, 0
	v_fma_f32 v31, v31, v52, 0
	v_fma_f32 v32, v32, v54, 0
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	s_cbranch_scc1 .LBB0_7
; %bb.5:                                ; %.peel.next
	v_lshl_or_b32 v12, s37, 7, v12
	s_lshl_b32 s0, s37, 8
	s_lshl_b32 s5, s7, 1
	v_add3_u32 v45, s6, v44, v9
	v_add3_u32 v40, s5, s0, v40
	s_lshl_b32 s0, s19, 7
	v_sub_nc_u32_e32 v44, s18, v10
	v_subrev_nc_u32_e32 v12, s0, v12
	v_add_nc_u32_e32 v46, s6, v11
	v_mul_lo_u32 v45, s1, v45
	s_lshl_b32 s14, s19, 8
	v_lshlrev_b32_e32 v43, 1, v43
	v_mad_u64_u32 v[10:11], null, s18, v12, v[10:11]
	v_subrev_nc_u32_e32 v40, s14, v40
	s_add_i32 s14, s36, 32
	s_add_i32 s15, s1, -2
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_add_nc_u32_e32 v46, s14, v11
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v48, v43, v40
	.loc	1 156 27                        ; generate_amdgcn.py:156:27
	v_cmp_lt_i32_e32 vcc_lo, s14, v44
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	s_cmp_lg_u32 s15, 0
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_cndmask_b32_e64 v12, 0x80000000, v46, s0
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	s_barrier
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v62, v45, s[24:27], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v63, v48, s[28:31], 0 offen
	buffer_load_u16 v64, v48, s[28:31], 0 offen offset:4
	buffer_load_u16 v65, v48, s[28:31], 0 offen offset:8
	buffer_load_u16 v66, v48, s[28:31], 0 offen offset:12
	buffer_load_u16 v67, v48, s[28:31], 0 offen offset:16
	buffer_load_u16 v68, v48, s[28:31], 0 offen offset:20
	buffer_load_u16 v69, v48, s[28:31], 0 offen offset:24
	buffer_load_u16 v70, v48, s[28:31], 0 offen offset:28
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v45, 2, v45
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	buffer_load_b32 v71, v46, s[20:23], 0 offen
	ds_load_b64 v[54:55], v39
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[56:57], v38 offset:2048
	ds_load_b64 v[58:59], v41 offset:2048
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	ds_load_b64 v[60:61], v42
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(10)
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v25, v46, v55 :: v_dual_lshlrev_b32 v62, 16, v70
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v51, v51, v54 :: v_dual_add_nc_u32 v40, s5, v40
	v_dual_mul_f32 v48, v48, v54 :: v_dual_lshlrev_b32 v57, 16, v65
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v56, 16, v64
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v50, v50, v54 :: v_dual_lshlrev_b32 v59, 16, v67
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v58, 16, v66
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v52, v52, v54 :: v_dual_lshlrev_b32 v61, 16, v69
	v_dual_mul_f32 v47, v47, v54 :: v_dual_lshlrev_b32 v60, 16, v68
	v_mul_f32_e32 v49, v49, v54
	v_mul_f32_e32 v53, v53, v54
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v27, v48, v57
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v29, v50, v59 :: v_dual_fmac_f32 v26, v47, v56
	v_dual_fmac_f32 v28, v49, v58 :: v_dual_fmac_f32 v31, v52, v61
	v_fmac_f32_e32 v30, v51, v60
	v_fmac_f32_e32 v32, v53, v62
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
...
; %bb.9:
	...
	v_cndmask_b32_e64 v4, 0x88, 0, s0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or3_b32 v2, v2, v34, v4
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_lshl_or_b32 v4, v9, 4, v33
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[39:40], v7 offset:2048
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_mov_b32_e32 v7, v4
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	ds_load_b64 v[33:34], v5
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_b64 v[35:36], v6 offset:2048
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_mov_b32_e32 v5, v4
	v_mov_b32_e32 v6, v4
	v_mov_b32_e32 v8, v4
	...
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[4:11], v[33:34], v[35:36], v[4:11] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[4:11], v[37:38], v[39:40], v[4:11] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_lshl_u32 v10, s1, v23, 1
	v_add_lshl_u32 v11, s1, v22, 1
	v_add_lshl_u32 v17, s1, v17, 1
	v_add_lshl_u32 v20, s1, v20, 1
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v16, v2, s[12:15], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v2, 0x80000000, v9, s2
	v_cndmask_b32_e64 v9, 0x80000000, v10, s2
	v_cndmask_b32_e64 v10, 0x80000000, v11, s2
	v_add_lshl_u32 v11, s1, v19, 1
	v_add_lshl_u32 v19, s1, v21, 1
	...
	buffer_load_u16 v22, v10, s[16:19], 0 offen
	buffer_load_u16 v23, v11, s[16:19], 0 offen
	...
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v33, 0x2040, 0, s0
	...
	s_waitcnt lgkmcnt(0)
	v_and_or_b32 v10, 0x31c, v13, v10
	s_barrier
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v6, v6, v16 :: v_dual_lshlrev_b32 v21, 16, v21
	v_mul_f32_e32 v15, v15, v16
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v8, v8, v16 :: v_dual_lshlrev_b32 v9, 16, v9
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v5, v5, v16 :: v_dual_lshlrev_b32 v22, 16, v22
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v12, v12, v16 :: v_dual_lshlrev_b32 v23, 16, v23
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v17, 16, v17
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v7, v7, v16 :: v_dual_lshlrev_b32 v18, 16, v18
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v15, v15, v21, v25
	v_fma_f32 v4, v4, v9, v26
	v_fma_f32 v5, v5, v22, v27
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
	v_add_co_u32 v10, vcc_lo, s34, v10
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v6, v6, v23, v28
	v_fma_f32 v7, v7, v17, v29
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_add_co_ci_u32_e64 v11, null, s35, v11, vcc_lo
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v19, v30
	v_fma_f32 v9, v12, v20, v31
	v_fma_f32 v12, v16, v18, v32
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v15, v25, v15, s2
	v_xad_u32 v14, v13, 4, 0
	v_cndmask_b32_e64 v4, v26, v4, s2
	v_xad_u32 v33, v13, 8, 0
	v_cndmask_b32_e64 v5, v27, v5, s2
	v_xad_u32 v34, v13, 12, 0
	v_cndmask_b32_e64 v6, v28, v6, s2
	v_xad_u32 v36, v13, 16, 0
	v_xad_u32 v37, v13, 20, 0
	v_xad_u32 v38, v13, 24, 0
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.num_vgpr, 72
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk2_evenk.kd
