...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v33, v33, v42 :: v_dual_lshlrev_b32 v44, 16, v44
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v17, v33, v45 :: v_dual_mul_f32 v32, v32, v42
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v36, v36, v42 :: v_dual_lshlrev_b32 v47, 16, v47
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v35, v35, v42 :: v_dual_lshlrev_b32 v48, 16, v48
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v38, v38, v42 :: v_dual_lshlrev_b32 v49, 16, v49
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v50, 16, v50
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v10, v32, v44 :: v_dual_lshlrev_b32 v51, 16, v51
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v14, v36, v49 :: v_dual_lshlrev_b32 v43, 16, v43
	.loc	1 180 20 is_stmt 0              ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v34, v34, v42
	v_mul_f32_e32 v37, v37, v42
	v_dual_mul_f32 v39, v39, v42 :: v_dual_fmac_f32 v12, v38, v51
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v15, v35, v48 :: v_dual_fmac_f32 v16, v34, v47
	v_fmac_f32_e32 v13, v37, v50
	s_delay_alu instid0(VALU_DEP_3)
...
; %bb.4:
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	v_add3_u32 v26, 0, v22, v20
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	ds_load_u8 v1, v21 offset:4256
	ds_load_u8 v2, v21 offset:4320
	ds_load_u8 v3, v21 offset:4288
	ds_load_u8 v4, v21 offset:4224
	ds_load_u8 v5, v21 offset:4192
	ds_load_u8 v6, v21 offset:4160
	ds_load_u8 v7, v21 offset:4096
	ds_load_u8 v8, v21 offset:4128
	ds_load_u8 v22, v26 offset:640
	ds_load_u8 v23, v26 offset:896
	ds_load_u8 v24, v26 offset:768
	ds_load_u8 v25, v26 offset:512
	ds_load_u8 v27, v26 offset:128
	ds_load_u8 v28, v26 offset:256
	ds_load_u8 v29, v26
	ds_load_u8 v30, v26 offset:384
	...
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v7, v24, v23, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v27, v21 offset:4512
	ds_load_u8 v29, v21 offset:4576
	ds_load_u8 v31, v21 offset:4544
	ds_load_u8 v32, v21 offset:4480
	ds_load_u8 v33, v21 offset:4384
	ds_load_u8 v34, v21 offset:4448
	ds_load_u8 v35, v21 offset:4416
	ds_load_u8 v36, v21 offset:4352
	ds_load_u8 v37, v26 offset:1664
	ds_load_u8 v38, v26 offset:1920
	ds_load_u8 v39, v26 offset:1792
	ds_load_u8 v40, v26 offset:1536
	ds_load_u8 v41, v26 offset:1152
	ds_load_u8 v42, v26 offset:1408
	ds_load_u8 v43, v26 offset:1280
	ds_load_u8 v44, v26 offset:1024
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v24, v28, v30, 0xc0c0004
	v_lshl_or_b32 v25, v7, 16, v6
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_lshl_or_b32 v24, v24, 16, v8
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v8, v1
	...
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v31, v40, v37, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[24:25], v[22:23], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v23, v28, 16, v27
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v34, v43, v42, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v44, v41, 0xc0c0004
	v_lshl_or_b32 v22, v30, 16, v29
	v_lshl_or_b32 v25, v32, 16, v31
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v24, v34, 16, v33
	ds_load_u8 v27, v21 offset:4768
	ds_load_u8 v28, v21 offset:4832
	ds_load_u8 v29, v21 offset:4800
	...
	ds_load_u8 v35, v26 offset:2688
	ds_load_u8 v36, v26 offset:2944
	ds_load_u8 v37, v26 offset:2816
	ds_load_u8 v38, v26 offset:2560
	ds_load_u8 v39, v26 offset:2176
	ds_load_u8 v40, v26 offset:2432
	...
	ds_load_u8 v50, v21 offset:4864
	ds_load_u8 v51, v26 offset:3712
	ds_load_u8 v52, v26 offset:3968
	ds_load_u8 v53, v26 offset:3840
	ds_load_u8 v54, v26 offset:3584
	ds_load_u8 v55, v26 offset:3200
	ds_load_u8 v56, v26 offset:3456
	ds_load_u8 v57, v26 offset:3328
	ds_load_u8 v26, v26 offset:3072
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v21, v30, v27, 0xc0c0004
	v_perm_b32 v27, v29, v28, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v28, v34, v31, 0xc0c0004
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 35
