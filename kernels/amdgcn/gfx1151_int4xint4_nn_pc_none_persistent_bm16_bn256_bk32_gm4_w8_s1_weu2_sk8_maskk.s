	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_lshl_or_b32 v24, v6, 10, v8
	v_or3_b32 v25, v1, v11, v10
	s_sub_i32 s15, 0, s28
	v_rcp_iflag_f32_e32 v26, s7
	v_add_nc_u32_e32 v7, 0, v17
	v_xor_b32_e32 v2, v3, v2
	v_xor_b32_e32 v3, 8, v5
	v_and_b32_e32 v6, 0x70, v9
	v_xor_b32_e32 v1, 4, v24
	v_xor_b32_e32 v8, 8, v24
	v_xor_b32_e32 v9, 12, v24
	v_xor_b32_e32 v10, 16, v24
	v_xor_b32_e32 v11, 20, v24
	v_readfirstlane_b32 s7, v26
.Ltmp14:
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_or_b32_e32 v26, s3, v20
	v_xor_b32_e32 v12, 24, v24
	v_xor_b32_e32 v13, 28, v24
	v_xor_b32_e32 v14, 0x404, v25
	s_mul_f32 s7, s7, 0x4f7ffffe
	v_mul_lo_u32 v26, s25, v26
	v_xor_b32_e32 v15, 0x808, v25
	v_xor_b32_e32 v16, 0xc0c, v25
	s_cvt_u32_f32 s7, s7
	v_xor_b32_e32 v18, 0x1010, v25
	v_xor_b32_e32 v19, 0x1414, v25
	v_xor_b32_e32 v44, 0x1818, v25
	v_xor_b32_e32 v45, 0x1c1c, v25
	v_xor_b32_e32 v46, 0x2040, v25
	v_xor_b32_e32 v47, 0x2444, v25
	v_xor_b32_e32 v48, 0x2848, v25
	v_xor_b32_e32 v49, 0x2c4c, v25
	v_xor_b32_e32 v50, 0x3050, v25
	v_xor_b32_e32 v51, 0x3454, v25
	v_xor_b32_e32 v52, 0x3858, v25
	v_xor_b32_e32 v53, 0x3c5c, v25
	v_cndmask_b32_e64 v27, 0, 1, s6
	s_mul_i32 s15, s15, s7
	s_max_i32 s44, s0, 1
	s_mul_hi_u32 s0, s7, s15
	v_sub_nc_u32_e32 v22, s27, v17
	v_sub_nc_u32_e32 v23, s27, v20
	s_add_i32 s46, s7, s0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_lshl_add_u32 v26, v17, 4, v26
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 305 13                        ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v75, s49, v68, 2
	.loc	1 305 27                        ; generate_amdgcn.py:305:27
	s_add_i32 s57, s6, s39
	.loc	1 305 13                        ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v76, s50, v68, 2
	.loc	1 305 27                        ; generate_amdgcn.py:305:27
	s_add_i32 s58, s6, s40
	.loc	1 305 13                        ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v77, s51, v68, 2
	v_add_lshl_u32 v78, s52, v68, 2
	v_add_lshl_u32 v79, s53, v68, 2
	v_add_lshl_u32 v80, s54, v68, 2
	v_add_lshl_u32 v81, s55, v68, 2
	v_add_lshl_u32 v82, s56, v68, 2
	.loc	1 305 27                        ; generate_amdgcn.py:305:27
	...
	ds_load_b128 v[13:16], v64 offset:16
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v12, v12, v69 :: v_dual_add_nc_u32 v71, 0, v24
	...
	v_dual_mul_f32 v16, v16, v18 :: v_dual_mul_f32 v13, v13, v55
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	ds_load_b128 v[60:63], v64 offset:512
	ds_load_b128 v[64:67], v64 offset:528
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v9, v9, v59 :: v_dual_mul_f32 v10, v10, v58
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 305 13 is_stmt 1              ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v55, s60, v68, 2
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	...
	v_dual_mul_f32 v63, v63, v69 :: v_dual_mul_f32 v2, v66, v2
	v_dual_mul_f32 v60, v60, v69 :: v_dual_mul_f32 v3, v65, v3
	v_mul_f32_e32 v15, v15, v69
	v_dual_mul_f32 v67, v67, v69 :: v_dual_mul_f32 v6, v62, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_mul_f32_e32 v8, v60, v8
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v14, v14, v69 :: v_dual_mul_f32 v15, v15, v19
	v_mul_f32_e32 v11, v11, v69
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v7, v61, v7 :: v_dual_mul_f32 v4, v64, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v14, v14, v54 :: v_dual_mul_f32 v5, v63, v5
	v_mul_f32_e32 v11, v11, v57
	v_mul_f32_e32 v1, v67, v1
	ds_store_2addr_stride64_b32 v71, v9, v8 offset1:2
	ds_store_2addr_stride64_b32 v32, v10, v7 offset1:2
	ds_store_2addr_stride64_b32 v33, v11, v6 offset1:2
	ds_store_2addr_stride64_b32 v34, v12, v5 offset1:2
	ds_store_2addr_stride64_b32 v35, v13, v4 offset1:2
	ds_store_2addr_stride64_b32 v36, v14, v3 offset1:2
	ds_store_2addr_stride64_b32 v37, v15, v2 offset1:2
	ds_store_2addr_stride64_b32 v38, v16, v1 offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v1, v70
	ds_load_b32 v2, v39
	...
	ds_load_b32 v18, v53
	.loc	1 305 13 is_stmt 1              ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v12, s57, v68, 2
	v_add_lshl_u32 v19, s58, v68, 2
	v_add_lshl_u32 v54, s59, v68, 2
	s_waitcnt lgkmcnt(15)
	buffer_atomic_add_f32 v1, v72, s[12:15], 0 offen
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v2, v73, s[12:15], 0 offen
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v3, v74, s[12:15], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v4, v75, s[12:15], 0 offen
	s_waitcnt lgkmcnt(11)
	buffer_atomic_add_f32 v5, v76, s[12:15], 0 offen
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v6, v77, s[12:15], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v7, v78, s[12:15], 0 offen
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v8, v79, s[12:15], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v9, v80, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v10, v81, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v11, v82, s[12:15], 0 offen
	v_add_lshl_u32 v1, s61, v68, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v13, v12, s[12:15], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v14, v19, s[12:15], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v15, v54, s[12:15], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v16, v55, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v2, s7, 8, v26
	v_mov_b32_e32 v1, 0
	v_add_nc_u32_e32 v3, s48, v20
	s_lshl_b32 s6, s6, 8
	s_mov_b32 s50, s3
	v_subrev_nc_u32_e32 v54, s6, v2
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[18:19], null, s27, v3, v[17:18]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s50, v23
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	v_add_nc_u32_e32 v19, s50, v18
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b128 v30, v[55:58]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 266 27                        ; generate_amdgcn.py:266:27
	ds_load_u8 v19, v31 offset:3328
	ds_load_u8 v55, v31 offset:3072
	ds_load_u8 v56, v31 offset:3840
	ds_load_u8 v57, v31 offset:3584
	ds_load_u8 v58, v31 offset:2304
	ds_load_u8 v63, v31 offset:2048
	ds_load_u8 v64, v31 offset:2816
	ds_load_u8 v65, v31 offset:2560
	ds_load_u8 v66, v31 offset:1280
	ds_load_u8 v67, v31 offset:1024
	ds_load_u8 v68, v31 offset:1792
	ds_load_u8 v69, v31 offset:1536
	ds_load_u8 v70, v31 offset:1920
	ds_load_u8 v71, v31 offset:1664
	ds_load_u8 v72, v31 offset:1408
	ds_load_u8 v73, v31 offset:1152
	ds_load_u8 v74, v31 offset:256
	ds_load_u8 v75, v31
	ds_load_u8 v76, v31 offset:768
	ds_load_u8 v77, v31 offset:512
	ds_load_u8 v78, v31 offset:896
	ds_load_u8 v79, v31 offset:640
	ds_load_u8 v80, v31 offset:384
	ds_load_u8 v81, v31 offset:128
	ds_load_u8 v82, v31 offset:3968
	ds_load_u8 v83, v31 offset:3712
	ds_load_u8 v84, v31 offset:3456
	ds_load_u8 v85, v31 offset:3200
	ds_load_u8 v86, v31 offset:2944
	ds_load_u8 v87, v31 offset:2688
	ds_load_u8 v88, v31 offset:2432
	ds_load_u8 v89, v31 offset:2176
	...
	v_perm_b32 v19, v55, v19, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v68, v75, v74, 0xc0c0004
	v_perm_b32 v74, v63, v58, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	...
	v_lshl_or_b32 v58, v57, 16, v19
	v_lshl_or_b32 v57, v65, 16, v74
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 90
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 62
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     64
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
