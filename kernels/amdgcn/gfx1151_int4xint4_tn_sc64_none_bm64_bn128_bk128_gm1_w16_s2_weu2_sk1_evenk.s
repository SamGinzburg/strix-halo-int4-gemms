	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow200
	...
	v_or_b32_e32 v28, v4, v32
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v29, 0x70, v27
	v_bfe_u32 v30, v0, 4, 1
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v16, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v31, 0, v28
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v5, 0, v32
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_subrev_nc_u32_e32 v37, s15, v3
	s_mov_b32 s15, s12
	v_mul_lo_u32 v3, s22, v7
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v42, v5, v29
	...
	v_mov_b32_e32 v21, 0
	v_dual_mov_b32 v26, 0 :: v_dual_lshlrev_b32 v39, 1, v4
	v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v24, 0
	v_dual_mov_b32 v11, 0 :: v_dual_lshlrev_b32 v38, 1, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	s_clause 0x1
	buffer_load_u16 v9, v39, s[40:43], 0 offen
	buffer_load_u16 v10, v38, s[40:43], 0 offen
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e32 vcc_lo, s1, v35
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_dual_mul_f32 v49, v45, v49 :: v_dual_mul_f32 v56, v43, v56
	v_mul_f32_e32 v50, v45, v50
	v_mul_f32_e32 v51, v45, v51
	v_mul_f32_e32 v52, v45, v52
	v_dual_mul_f32 v45, v45, v53 :: v_dual_mul_f32 v58, v43, v58
	...
	s_barrier
	s_waitcnt vmcnt(9)
	ds_store_b32 v33, v44 offset:4096
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	s_waitcnt vmcnt(0)
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v57, v43, v57 :: v_dual_lshlrev_b32 v66, 16, v68
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	v_dual_mul_f32 v43, v43, v60 :: v_dual_fmac_f32 v26, v54, v63
	.loc	1 233 13 is_stmt 0              ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v12, v46, v63 :: v_dual_fmac_f32 v23, v48, v65
	v_fmac_f32_e32 v16, v59, v66
	v_dual_fmac_f32 v22, v49, v64 :: v_dual_fmac_f32 v25, v47, v53
	v_fmac_f32_e32 v20, v57, v64
	v_dual_fmac_f32 v18, v51, v66 :: v_dual_fmac_f32 v19, v50, v67
	v_dual_fmac_f32 v24, v55, v53 :: v_dual_fmac_f32 v15, v52, v68
	v_dual_fmac_f32 v14, v45, v62 :: v_dual_fmac_f32 v21, v56, v65
	v_fmac_f32_e32 v17, v58, v67
	v_fmac_f32_e32 v13, v43, v68
	v_fmac_f32_e32 v11, v61, v62
	.loc	1 188 9 is_stmt 1               ; generate_amdgcn.py:188:9
	s_cbranch_scc1 .LBB0_5
.LBB0_6:                                ; %._crit_edge
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v1, 32, v28
	.loc	1 195 26                        ; generate_amdgcn.py:195:26
	v_mul_lo_u32 v2, s35, v28
...
; %bb.7:
	...
	ds_load_u8 v34, v31 offset:4992
	ds_load_u8 v35, v31 offset:4672
	ds_load_u8 v36, v31 offset:4608
	ds_load_u8 v37, v31 offset:4800
	ds_load_u8 v46, v31 offset:4736
	ds_load_u8 v47, v10 offset:1664
	ds_load_u8 v48, v10 offset:1920
	ds_load_u8 v49, v10 offset:1792
	ds_load_u8 v50, v10 offset:1536
	...
	ds_load_u8 v62, v10 offset:1408
	ds_load_u8 v63, v10 offset:1280
	ds_load_u8 v64, v10 offset:1024
	...
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v34, v46, v37, 0xc0c0004
	...
	v_perm_b32 v36, v49, v48, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v35, v50, v47, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[46:53], v[6:7], v[4:5], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v5, v32, 16, v9
	v_lshl_or_b32 v4, v34, 16, v33
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v9, v36, 16, v35
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v8, v64, v8, 0xc0c0004
	ds_load_u8 v32, v31 offset:5440
	ds_load_u8 v33, v31 offset:5376
	ds_load_u8 v34, v31 offset:5568
	ds_load_u8 v35, v31 offset:5504
	v_perm_b32 v36, v63, v62, 0xc0c0004
	ds_load_u8 v37, v31 offset:5184
	ds_load_u8 v62, v31 offset:5120
	ds_load_u8 v63, v31 offset:5312
	ds_load_u8 v64, v31 offset:5248
	...
	v_lshl_or_b32 v8, v36, 16, v8
	ds_load_u8 v36, v31 offset:5600
	ds_load_u8 v81, v31 offset:5536
	ds_load_u8 v82, v31 offset:5472
	ds_load_u8 v83, v31 offset:5408
	v_wmma_i32_16x16x16_iu4 v[46:53], v[8:9], v[4:5], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v37, v62, v37, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v62, v64, v63, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v64, v75, v74, 0xc0c0004
	v_perm_b32 v32, v33, v32, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v63, v76, v73, 0xc0c0004
	v_perm_b32 v33, v35, v34, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v74, v79, v78, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v73, v80, v77, 0xc0c0004
	ds_load_u8 v34, v31 offset:5952
	ds_load_u8 v35, v31 offset:5888
	...
	v_lshl_or_b32 v4, v62, 16, v37
	v_lshl_or_b32 v5, v33, 16, v32
	v_lshl_or_b32 v33, v64, 16, v63
	v_lshl_or_b32 v32, v74, 16, v73
	ds_load_u8 v37, v31 offset:5696
	ds_load_u8 v62, v31 offset:5632
	ds_load_u8 v63, v31 offset:6112
	ds_load_u8 v64, v31 offset:6048
	...
	v_wmma_i32_16x16x16_iu4 v[46:53], v[32:33], v[4:5], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v35, v85, v84, 0xc0c0004
	ds_load_u8 v84, v31 offset:5856
	ds_load_u8 v85, v31 offset:5792
	ds_load_u8 v90, v31 offset:5728
	ds_load_u8 v31, v31 offset:5664
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v4, v62, v37, 0xc0c0004
	ds_load_u8 v37, v10 offset:3200
	ds_load_u8 v62, v10 offset:3456
	ds_load_u8 v91, v10 offset:3328
	ds_load_u8 v92, v10 offset:3072
	v_lshl_or_b32 v5, v35, 16, v34
	v_perm_b32 v10, v57, v56, 0xc0c0004
	...
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v57, v79, v77, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v58, v78, v80, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[38:45], v[6:7], v[34:35], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v6, v60, 16, v59
	v_lshl_or_b32 v7, v55, 16, v54
	v_perm_b32 v34, v83, v82, 0xc0c0004
	v_perm_b32 v35, v81, v36, 0xc0c0004
	v_perm_b32 v36, v89, v88, 0xc0c0004
	v_perm_b32 v54, v87, v86, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v37, v92, v37, 0xc0c0004
	v_perm_b32 v55, v91, v62, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[38:45], v[8:9], v[6:7], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v7, v35, 16, v34
	v_lshl_or_b32 v6, v54, 16, v36
	v_perm_b32 v8, v74, v73, 0xc0c0004
	v_perm_b32 v34, v64, v63, 0xc0c0004
	v_perm_b32 v31, v31, v90, 0xc0c0004
	v_perm_b32 v35, v85, v84, 0xc0c0004
	v_lshl_or_b32 v4, v56, 16, v4
	v_lshl_or_b32 v10, v58, 16, v57
	v_lshl_or_b32 v9, v55, 16, v37
	v_wmma_i32_16x16x16_iu4 v[38:45], v[32:33], v[6:7], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v7, v34, 16, v8
	v_lshl_or_b32 v6, v35, 16, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[46:53], v[9:10], v[4:5], v[46:53] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[38:45], v[9:10], v[6:7], v[38:45] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v38, v38, v46 :: v_dual_and_b32 v3, 0x78, v27
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	buffer_load_u16 v30, v30, s[16:19], 0 offen
	.loc	1 245 18                        ; generate_amdgcn.py:245:18
	v_mul_lo_u32 v27, s23, v28
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v35, v35, v46 :: v_dual_add_nc_u32 v44, 20, v29
	v_dual_mul_f32 v40, v40, v46 :: v_dual_add_nc_u32 v43, 16, v29
	v_dual_mul_f32 v34, v34, v46 :: v_dual_add_nc_u32 v45, 24, v29
	v_dual_mul_f32 v36, v36, v46 :: v_dual_add_nc_u32 v29, 28, v29
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	v_fma_f32 v3, v4, v30, v12
	v_fma_f32 v4, v35, v30, v26
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_waitcnt vmcnt(5)
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v5, v5, v1, v25
	v_fma_f32 v1, v39, v1, v24
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v2, v2, v29, v14
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_mov_b16_e32 v49.l, v1.h
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v26, v40, v31, v21
	v_fma_f32 v8, v8, v35, v19
	v_fma_f32 v9, v9, v32, v18
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v12, v41, v30, v20
	v_fma_f32 v31, v34, v35, v17
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_cndmask_b32_e32 v6, 0x1054, v28, vcc_lo
	...
	v_permlanex16_b32 v4, v2, s15, 0xfedcba98 op_sel:[1,0]
	...
	v_perm_b32 v0, v3, v5, v8
	v_perm_b32 v2, v4, v7, v8
	v_perm_b32 v1, v3, v5, v10
	v_perm_b32 v3, v4, v7, v10
	...
	buffer_store_b128 v[4:7], v33, s[20:23], 0 offen
	.loc	1 106 1                         ; generate_amdgcn.py:106:1
	s_endpgm
.Ltmp22:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 93
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
