...
; %bb.1:                                ; %.lr.ph
	...
	v_xor_b32_e32 v3, 32, v113
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v148, 0xff800000 :: v_dual_add_nc_u32 v131, 0, v13
	...
	v_dual_mov_b32 v160, 0 :: v_dual_add_nc_u32 v143, 0, v3
	...
	v_dual_mov_b32 v22, v65 :: v_dual_add_nc_u32 v111, s13, v7
	v_xor_b32_e32 v7, 48, v113
	v_xor_b32_e32 v5, 0x70, v113
	...
	v_dual_mov_b32 v157, 0 :: v_dual_add_nc_u32 v132, 0, v14
	v_xor_b32_e32 v2, 16, v116
	v_dual_mov_b32 v156, 0 :: v_dual_add_nc_u32 v139, 0, v1
	...
	v_dual_mov_b32 v169, 0xff800000 :: v_dual_add_nc_u32 v138, 0, v4
	v_dual_mov_b32 v171, 0xff800000 :: v_dual_add_nc_u32 v140, 0, v2
	v_xor_b32_e32 v2, 24, v116
	v_xor_b32_e32 v4, 0x810, v117
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v141, 0, v1
	...
	v_dual_mov_b32 v155, 0 :: v_dual_and_b32 v120, 0x5040504, v6
	v_and_b32_e32 v121, 0x7060706, v18
	v_dual_mov_b32 v168, 0xff800000 :: v_dual_add_nc_u32 v129, 0, v8
	v_dual_mov_b32 v150, 0xff800000 :: v_dual_add_nc_u32 v133, 0, v15
	v_dual_mov_b32 v159, 0 :: v_dual_add_nc_u32 v134, 0, v17
	v_dual_mov_b32 v152, 0xff800000 :: v_dual_add_nc_u32 v135, 0, v16
	v_dual_mov_b32 v161, 0 :: v_dual_add_nc_u32 v136, 0, v21
	v_dual_mov_b32 v154, 0 :: v_dual_add_nc_u32 v137, 0, v19
	v_dual_mov_b32 v173, 0xff800000 :: v_dual_add_nc_u32 v142, 0, v2
	v_dual_mov_b32 v175, 0xff800000 :: v_dual_add_nc_u32 v144, 0, v4
	v_dual_mov_b32 v170, 0xff800000 :: v_dual_add_nc_u32 v145, 0, v1
	...
	v_lshl_or_b32 v146, s3, 8, v66
	v_dual_mov_b32 v89, 0xff800000 :: v_dual_mov_b32 v172, 0xff800000
	v_mov_b32_e32 v174, 0xff800000
	v_mov_b32_e32 v176, 0xff800000
	.loc	1 955 25                        ; attention.py:955:25
	s_mul_i32 s12, s7, s33
	s_add_i32 s45, s6, s4
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 216
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 47
