	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v30, 0 :: v_dual_and_b32 v11, 0x100, v0
	v_dual_mov_b32 v29, 0 :: v_dual_lshlrev_b32 v16, 2, v0
	v_dual_mov_b32 v21, 0 :: v_dual_and_b32 v14, 0xe0, v0
	v_dual_mov_b32 v22, 0 :: v_dual_mov_b32 v23, 0
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v35, 0, v16
	v_mov_b32_e32 v12, 0
.Ltmp1:
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v44, v5, v19
	v_mov_b32_e32 v29, 0
	v_dual_mov_b32 v28, 0 :: v_dual_lshlrev_b32 v41, 1, v4
	v_dual_mov_b32 v23, 0 :: v_dual_mov_b32 v26, 0
	v_dual_mov_b32 v21, 0 :: v_dual_lshlrev_b32 v40, 1, v7
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v56, v56, v63 :: v_dual_fmac_f32 v29, v50, v69
	v_dual_mul_f32 v60, v60, v63 :: v_dual_fmac_f32 v25, v54, v65
	v_dual_mul_f32 v61, v61, v63 :: v_dual_fmac_f32 v32, v47, v66
	v_mul_f32_e32 v58, v58, v63
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v31, v48, v67 :: v_dual_fmac_f32 v30, v49, v68
	v_dual_fmac_f32 v28, v51, v70 :: v_dual_fmac_f32 v27, v52, v71
	v_dual_fmac_f32 v26, v53, v64 :: v_dual_fmac_f32 v23, v56, v67
	v_dual_fmac_f32 v22, v57, v68 :: v_dual_fmac_f32 v15, v60, v71
	v_dual_fmac_f32 v20, v59, v70 :: v_dual_fmac_f32 v13, v61, v64
	v_dual_fmac_f32 v24, v55, v66 :: v_dual_fmac_f32 v21, v58, v69
...
.LBB0_5:
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v34, v19, s[8:11], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v19, 0x80000000, v18, s2
	v_add_nc_u32_e32 v41, 8, v18
	s_mov_b32 s22, s10
	v_add_nc_u32_e32 v43, 16, v18
	v_add_nc_u32_e32 v44, 20, v18
	buffer_load_u16 v42, v19, s[20:23], 0 offen
	v_cndmask_b32_e64 v19, 0x80000000, v33, s2
	v_cndmask_b32_e64 v33, 0x80000000, v41, s2
	v_add_nc_u32_e32 v41, 12, v18
	v_add_nc_u32_e32 v45, 24, v18
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	buffer_load_u16 v47, v33, s[20:23], 0 offen
	...
	buffer_load_u16 v48, v18, s[20:23], 0 offen
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v49, v17, s[8:11], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v2, v2, v34 :: v_dual_and_b32 v17, 0x840, v17
	v_mul_f32_e32 v1, v1, v34
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_lshl_or_b32 v14, v14, 3, v16
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	...
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_lshlrev_b32_e32 v51, 11, v50
	v_xor_b32_e32 v14, v14, v17
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v4, v4, v34 :: v_dual_lshlrev_b32 v41, 16, v41
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_mad_u64_u32 v[17:18], null, s35, v33, v[16:17]
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_or3_b32 v14, v51, v19, v14
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v6, v6, v34 :: v_dual_lshlrev_b32 v43, 16, v43
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v44, 16, v44
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v8, v8, v34 :: v_dual_lshlrev_b32 v45, 16, v45
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_add_nc_u32_e32 v51, 0, v14
	v_xad_u32 v52, v14, 8, 0
	v_xad_u32 v53, v14, 16, 0
	v_xad_u32 v54, v14, 24, 0
	v_xad_u32 v55, v14, 32, 0
	v_xad_u32 v56, v14, 40, 0
	v_xad_u32 v57, v14, 48, 0
	v_xad_u32 v58, v14, 56, 0
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v14, 16, v42
	v_lshlrev_b32_e32 v42, 16, v46
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v7, v7, v34 :: v_dual_lshlrev_b32 v46, 16, v47
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(1)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v2, v2, v42, v32
	v_fma_f32 v4, v4, v41, v30
	...
	v_fma_f32 v59, v9, v14, v25
	v_fma_f32 v10, v10, v42, v24
	v_fma_f32 v40, v3, v46, v31
	v_fma_f32 v34, v34, v46, v23
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.num_vgpr, 90
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk2_maskk.kd
