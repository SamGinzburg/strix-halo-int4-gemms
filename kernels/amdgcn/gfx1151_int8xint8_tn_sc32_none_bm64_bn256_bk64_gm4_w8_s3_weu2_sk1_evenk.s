...
.Ltmp0:
	...
	.loc	2 43 13 prologue_end            ; standard.py:43:13 @[ generate_amdgcn.py:317:17 ]
	s_waitcnt lgkmcnt(0)
...
.Ltmp24:
	...
	v_and_or_b32 v1, 0x70, v1, v171
	v_dual_mov_b32 v197, 0 :: v_dual_lshlrev_b32 v8, 1, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v201, 0 :: v_dual_and_b32 v4, 56, v3
	v_add_nc_u32_e32 v208, 0, v1
	v_add_nc_u32_e32 v206, 0, v3
	v_or_b32_e32 v5, 0x7f0, v0
	v_dual_mov_b32 v196, 0 :: v_dual_and_b32 v9, 28, v8
	v_add3_u32 v204, v2, v4, s29
	v_or_b32_e32 v2, s29, v171
	v_mov_b32_e32 v202, 0
	v_or_b32_e32 v4, 0x3f0, v0
	s_lshl_b32 s2, s19, 4
	v_dual_mov_b32 v193, 0 :: v_dual_add_nc_u32 v216, v206, v3
	v_or_b32_e32 v6, 16, v2
	v_or_b32_e32 v7, 32, v2
	v_or_b32_e32 v1, 48, v2
	v_mul_lo_u32 v209, v2, s1
	v_lshrrev_b32_e32 v2, 6, v0
	v_mul_lo_u32 v210, v6, s1
	v_mul_lo_u32 v211, v7, s1
	v_mul_lo_u32 v212, v1, s1
	v_lshlrev_b32_e32 v1, 2, v0
	v_lshlrev_b32_e32 v6, 5, v0
	v_and_b32_e32 v2, 2, v2
	v_dual_mov_b32 v200, 0 :: v_dual_lshlrev_b32 v7, 1, v172
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v1, 0x1c0, v1
	v_dual_mov_b32 v199, 0 :: v_dual_and_b32 v6, 32, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v195, 0 :: v_dual_add_nc_u32 v2, 0, v2
	v_dual_mov_b32 v198, 0 :: v_dual_add_nc_u32 v213, 0, v7
	v_dual_mov_b32 v194, 0 :: v_dual_add_nc_u32 v217, 0, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v10, v2, v1, v6
	v_add3_u32 v11, v213, v7, v6
	v_dual_mov_b32 v191, 0 :: v_dual_add_nc_u32 v218, 0, v5
	v_mov_b32_e32 v1, s4
	v_dual_mov_b32 v4, s7 :: v_dual_add_nc_u32 v205, s2, v203
	v_dual_mov_b32 v6, s9 :: v_dual_add_nc_u32 v207, 0, v171
	v_or_b32_e32 v214, s28, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_add_u32 v215, s18, 5, v204
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_mov_b32_e32 v5, s8
	v_dual_mov_b32 v7, s10 :: v_dual_mov_b32 v8, s11
	v_dual_mov_b32 v192, 0 :: v_dual_add_nc_u32 v219, v10, v9
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v220, v11, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	s_add_i32 s7, s7, s28
	v_add_nc_u32_e32 v10, s6, v215
	v_add_nc_u32_e32 v11, s7, v203
	s_add_i32 s6, s7, s30
	v_add_nc_u32_e32 v13, s7, v205
	v_add_nc_u32_e32 v17, s6, v203
	...
	v_add_nc_u32_e32 v23, s6, v205
	.loc	1 356 29 is_stmt 1              ; generate_amdgcn.py:356:29
	s_ashr_i32 s5, s5, 5
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(2)
	ds_store_b128 v216, v[9:12]
	s_waitcnt vmcnt(1)
	ds_store_b128 v216, v[13:16] offset:4096
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	ds_store_b64 v206, v[21:22] offset:16384
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	...
	s_cmp_lt_i32 s5, s1
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	ds_store_b64 v206, v[25:26] offset:18432
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(1)
	ds_store_b128 v216, v[17:20] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v216, v[21:24] offset:12288
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_load_u8 v25, v208 offset:3328
	ds_load_u8 v26, v208 offset:3072
	ds_load_u8 v27, v208 offset:3840
	ds_load_u8 v28, v208 offset:3584
	ds_load_u8 v29, v208 offset:2304
	...
	ds_load_u8 v14, v207 offset:18240
	...
	ds_load_u8 v18, v207 offset:18368
	ds_load_u8 v16, v207 offset:18304
	ds_load_u8 v19, v207 offset:17984
	v_lshl_or_b32 v42, v17, 16, v15
	ds_load_u8 v15, v207 offset:17920
	ds_load_u8 v17, v207 offset:18112
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v20, v23, v21, 0xc0c0004
	ds_load_u8 v21, v207 offset:18048
	ds_load_u8 v23, v207 offset:17728
	v_perm_b32 v22, v27, v25, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v41, v22, 16, v20
	ds_load_u8 v20, v207 offset:17536
	...
	ds_load_u8 v18, v207 offset:17856
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v15, v15, v19, 0xc0c0004
	ds_load_u8 v19, v207 offset:17792
	ds_load_u8 v14, v207 offset:17664
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v17, v21, v17, 0xc0c0004
	ds_load_u8 v21, v207 offset:17472
	v_lshl_or_b32 v16, v16, 16, v13
	v_lshl_or_b32 v15, v17, 16, v15
	ds_load_u8 v13, v207 offset:17408
	ds_load_u8 v17, v207 offset:17600
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v14, v14, v23, 0xc0c0004
	ds_load_u8 v19, v208 offset:7424
	v_lshl_or_b32 v14, v18, 16, v14
	ds_load_u8 v18, v208 offset:7168
	ds_load_u8 v22, v208 offset:7936
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v13, v13, v21, 0xc0c0004
	ds_load_u8 v21, v208 offset:7680
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v17, v20, v17, 0xc0c0004
	ds_load_u8 v20, v208 offset:6400
	...
	ds_load_u8 v19, v208 offset:6144
	v_lshl_or_b32 v48, v21, 16, v18
	ds_load_u8 v17, v208 offset:5120
	ds_load_u8 v18, v208 offset:5888
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v19, v19, v20, 0xc0c0004
	ds_load_u8 v20, v208 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v20, v20, v22, 0xc0c0004
	ds_load_u8 v22, v208 offset:5376
	v_lshl_or_b32 v47, v20, 16, v19
	ds_load_u8 v19, v208 offset:5632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	ds_load_u8 v19, v208 offset:4352
	v_perm_b32 v17, v17, v22, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v46, v18, 16, v17
	ds_load_u8 v17, v208 offset:4096
	ds_load_u8 v18, v208 offset:4864
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v17, v17, v19, 0xc0c0004
	ds_load_u8 v19, v208 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	ds_load_u8 v19, v208 offset:3456
	v_lshl_or_b32 v45, v18, 16, v17
	ds_load_u8 v17, v208 offset:3200
	ds_load_u8 v18, v208 offset:3968
	v_wmma_i32_16x16x16_iu8 v[33:40], v[45:48], v[13:16], v[33:40] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1)
	v_cvt_f32_i32_e32 v37, v37
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v17, v17, v19, 0xc0c0004
	ds_load_u8 v19, v208 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	ds_load_u8 v19, v208 offset:2432
	ds_load_u8 v20, v208 offset:2176
	v_lshl_or_b32 v52, v18, 16, v17
	ds_load_u8 v17, v208 offset:1408
	ds_load_u8 v18, v208 offset:1152
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v19, v20, v19, 0xc0c0004
	ds_load_u8 v20, v208 offset:2944
	ds_load_u8 v21, v208 offset:2688
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v18, v208 offset:1920
	ds_load_u8 v19, v208 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	v_lshl_or_b32 v50, v18, 16, v17
	ds_load_u8 v17, v208 offset:384
	ds_load_u8 v18, v208 offset:128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v17, v18, v17, 0xc0c0004
	ds_load_u8 v18, v208 offset:896
	ds_load_u8 v19, v208 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v49, v18, 16, v17
	ds_load_u8 v17, v208 offset:7552
	ds_load_u8 v18, v208 offset:7296
	...
	ds_load_u8 v19, v208 offset:7808
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	ds_load_u8 v19, v208 offset:6528
	ds_load_u8 v20, v208 offset:6272
	v_lshl_or_b32 v56, v18, 16, v17
	ds_load_u8 v17, v208 offset:5504
	ds_load_u8 v18, v208 offset:5248
	s_waitcnt lgkmcnt(4)
	...
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v19, v20, v19, 0xc0c0004
	ds_load_u8 v20, v208 offset:7040
	ds_load_u8 v21, v208 offset:6784
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v17, v18, v17, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v19, v208 offset:5760
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	v_lshl_or_b32 v54, v18, 16, v17
	ds_load_u8 v17, v208 offset:4480
	ds_load_u8 v18, v208 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v17, v18, v17, 0xc0c0004
	ds_load_u8 v18, v208 offset:4992
	ds_load_u8 v19, v208 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v19, v18, 0xc0c0004
	...
	v_add_lshl_u32 v41, v214, s6, 1
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v42, v210, s5, 1
	v_add_lshl_u32 v43, v211, s5, 1
	v_add_lshl_u32 v44, v212, s5, 1
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	s_waitcnt vmcnt(0)
	ds_store_b16 v219, v41 offset:20480
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v41, v209, s5, 1
	...
	s_clause 0x3
	buffer_load_u16 v235, v41, s[8:11], 0 offen
	buffer_load_u16 v234, v42, s[8:11], 0 offen
	buffer_load_u16 v233, v43, s[8:11], 0 offen
	buffer_load_u16 v232, v44, s[8:11], 0 offen
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	ds_load_u8 v41, v208 offset:11520
	ds_load_u8 v42, v208 offset:11264
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:12032
	ds_load_u8 v43, v208 offset:11776
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v208 offset:10496
	ds_load_u8 v44, v208 offset:10240
	v_lshl_or_b32 v100, v42, 16, v41
	ds_load_u8 v41, v208 offset:9472
	ds_load_u8 v42, v208 offset:9216
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	ds_load_u8 v44, v208 offset:11008
	ds_load_u8 v45, v208 offset:10752
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	...
	ds_load_u8 v42, v208 offset:9984
	ds_load_u8 v43, v208 offset:9728
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	v_lshl_or_b32 v98, v42, 16, v41
	ds_load_u8 v41, v208 offset:8448
	ds_load_u8 v42, v208 offset:8192
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:8960
	ds_load_u8 v43, v208 offset:8704
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	ds_load_u8 v41, v208 offset:15616
	ds_load_u8 v42, v208 offset:15360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:16128
	ds_load_u8 v43, v208 offset:15872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v208 offset:14592
	ds_load_u8 v44, v208 offset:14336
	v_lshl_or_b32 v104, v42, 16, v41
	ds_load_u8 v41, v208 offset:13568
	ds_load_u8 v42, v208 offset:13312
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	ds_load_u8 v44, v208 offset:15104
	ds_load_u8 v45, v208 offset:14848
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	...
	ds_load_u8 v42, v208 offset:14080
	ds_load_u8 v43, v208 offset:13824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	v_lshl_or_b32 v102, v42, 16, v41
	ds_load_u8 v41, v208 offset:12544
	ds_load_u8 v42, v208 offset:12288
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:13056
	ds_load_u8 v43, v208 offset:12800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v101, v42, 16, v41
	ds_load_u8 v41, v208 offset:11648
	ds_load_u8 v42, v208 offset:11392
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:12160
	ds_load_u8 v43, v208 offset:11904
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v208 offset:10624
	ds_load_u8 v44, v208 offset:10368
	v_lshl_or_b32 v224, v42, 16, v41
	ds_load_u8 v41, v208 offset:9600
	ds_load_u8 v42, v208 offset:9344
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	ds_load_u8 v44, v208 offset:11136
	ds_load_u8 v45, v208 offset:10880
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v223, v44, 16, v43
	ds_load_u8 v42, v208 offset:10112
	ds_load_u8 v43, v208 offset:9856
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	v_lshl_or_b32 v222, v42, 16, v41
	ds_load_u8 v41, v208 offset:8576
	ds_load_u8 v42, v208 offset:8320
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:9088
	ds_load_u8 v43, v208 offset:8832
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v221, v42, 16, v41
	ds_load_u8 v41, v208 offset:15744
	ds_load_u8 v42, v208 offset:15488
	v_wmma_i32_16x16x16_iu8 v[49:56], v[221:224], v[57:60], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:16256
	ds_load_u8 v43, v208 offset:16000
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	ds_load_u8 v43, v208 offset:14720
	ds_load_u8 v44, v208 offset:14464
	v_lshl_or_b32 v228, v42, 16, v41
	ds_load_u8 v41, v208 offset:13696
	ds_load_u8 v42, v208 offset:13440
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	ds_load_u8 v44, v208 offset:15232
	ds_load_u8 v45, v208 offset:14976
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	...
	ds_load_u8 v42, v208 offset:14208
	ds_load_u8 v43, v208 offset:13952
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	v_lshl_or_b32 v226, v42, 16, v41
	ds_load_u8 v41, v208 offset:12672
	ds_load_u8 v42, v208 offset:12416
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v41, v42, v41, 0xc0c0004
	ds_load_u8 v42, v208 offset:13184
	ds_load_u8 v43, v208 offset:12928
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v42, v43, v42, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_wmma_i32_16x16x16_iu8 v[49:56], v[225:228], v[61:64], v[49:56] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[65:72], v[221:224], v[73:76], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[65:72], v[225:228], v[77:80], v[65:72] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[81:88], v[221:224], v[89:92], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[81:88], v[225:228], v[93:96], v[81:88] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[89:96], v[97:100], v[236:239], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[89:96], v[101:104], v[240:243], v[89:96] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[97:104], v[221:224], v[236:239], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v223, v116
	v_cvt_f32_i32_e32 v116, v117
	v_cvt_f32_i32_e32 v117, v134
	s_delay_alu instid0(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[97:104], v[225:228], v[240:243], v[97:104] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v227, v114
	v_cvt_f32_i32_e32 v114, v135
	v_cvt_f32_i32_e32 v135, v11
	v_cvt_f32_i32_e32 v134, v12
	v_cvt_f32_i32_e32 v239, v9
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	ds_load_b128 v[9:12], v213 offset:20480
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_cvt_f32_i32_e32 v225, v115
	v_cvt_f32_i32_e32 v115, v126
	v_cvt_f32_i32_e32 v126, v36
	v_cvt_f32_i32_e32 v36, v38
	v_cvt_f32_i32_e32 v236, v33
	...
	v_cvt_f32_i32_e32 v238, v17
	v_cvt_f32_i32_e32 v222, v108
	...
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v42, v236, v41
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_cvt_f32_i32_e32 v81, v100
	v_cvt_f32_i32_e32 v100, v44
	v_cvt_f32_i32_e32 v221, v109
	v_cvt_f32_i32_e32 v109, v110
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(2)
	v_dual_fmac_f32 v197, v42, v73 :: v_dual_lshlrev_b32 v42, 16, v234
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_cvt_f32_i32_e32 v110, v128
	v_cvt_f32_i32_e32 v128, v34
	v_cvt_f32_i32_e32 v241, v74
	v_cvt_f32_i32_e32 v226, v106
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v43, v237, v42
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v186, v43, v73
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v43, 16, v233
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v202, v73, v74 :: v_dual_mul_f32 v39, v42, v39
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	...
	.loc	1 362 24 is_stmt 0              ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v38, v44, v135 :: v_dual_fmac_f32 v167, v39, v74
	...
	v_add_lshl_u32 v74, v214, s6, 1
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	v_cvt_f32_i32_e32 v63, v77
	v_cvt_f32_i32_e32 v64, v93
	v_cvt_f32_i32_e32 v224, v107
	v_cvt_f32_i32_e32 v107, v120
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_dual_cndmask_b32 v74, 0x80000000, v74 :: v_dual_fmac_f32 v201, v39, v73
	v_lshlrev_b32_e32 v39, 16, v12
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v73, v212, s5, 1
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v33, v209, s5, 1
	v_add_lshl_u32 v39, v211, s5, 1
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	ds_load_b128 v[73:76], v213 offset:20496
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	v_dual_mul_f32 v13, v44, v13 :: v_dual_and_b32 v12, 0xffff0000, v12
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	ds_store_b32 v220, v77 offset:20480
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[77:80], v213 offset:20480
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v183, v94, v80 :: v_dual_mul_f32 v94, v244, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v168, v94, v77
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v94, v39, v241 :: v_dual_mul_f32 v77, v93, v90
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v167, v94, v78
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v94, v39, v242
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v166, v94, v79
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v94, v39, v243
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v165, v94, v80
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v149, v77, v80
	.loc	1 360 22 is_stmt 1              ; generate_amdgcn.py:360:22
	v_lshlrev_b32_e32 v77, 16, v73
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v182, v29, v77 :: v_dual_lshlrev_b32 v29, 16, v74
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	...
	v_fmac_f32_e32 v162, v19, v21
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v14, v41, v34 :: v_dual_lshlrev_b32 v19, 16, v76
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v144, v20, v9 :: v_dual_mul_f32 v9, v41, v226
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	...
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v9, v41, v224 :: v_dual_mul_f32 v10, v42, v107
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v192, v9, v11 :: v_dual_mul_f32 v9, v42, v225
	v_dual_fmac_f32 v176, v9, v11 :: v_dual_mul_f32 v9, v43, v122
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v158, v9, v11
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v9, v44, v123
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v142, v9, v11 :: v_dual_and_b32 v19, 0xffff0000, v76
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v9, v41, v222
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v169, v10, v19
	v_fmac_f32_e32 v191, v9, v12
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v9, v42, v223
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v175, v24, v12 :: v_dual_fmac_f32 v160, v29, v9
	v_fmac_f32_e32 v178, v21, v9
	v_dual_fmac_f32 v158, v31, v11 :: v_dual_fmac_f32 v157, v32, v12
	v_fmac_f32_e32 v144, v37, v9
	v_dual_fmac_f32 v176, v23, v11 :: v_dual_fmac_f32 v177, v22, v10
	v_dual_fmac_f32 v143, v38, v10 :: v_dual_fmac_f32 v142, v39, v11
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v141, v40, v12 :: v_dual_fmac_f32 v190, v17, v13
	v_dual_fmac_f32 v189, v18, v14 :: v_dual_fmac_f32 v188, v19, v15
	v_dual_fmac_f32 v187, v20, v16 :: v_dual_fmac_f32 v174, v25, v13
	v_dual_fmac_f32 v173, v26, v14 :: v_dual_fmac_f32 v170, v27, v15
	v_fmac_f32_e32 v169, v28, v16
	v_dual_fmac_f32 v159, v30, v10 :: v_dual_fmac_f32 v156, v33, v13
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 245
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 31
