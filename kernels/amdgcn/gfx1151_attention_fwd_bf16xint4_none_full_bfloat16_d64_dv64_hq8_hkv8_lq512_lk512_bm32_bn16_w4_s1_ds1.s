	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	s_mov_b32 s16, s4
	v_dual_mov_b32 v68, 0 :: v_dual_and_b32 v15, 64, v15
	v_and_b32_e32 v16, 0x700, v16
	v_lshl_or_b32 v69, v66, 7, v10
	...
	v_lshl_or_b32 v11, v64, 6, v69
	v_add_nc_u32_e32 v12, 0, v22
	v_lshl_or_b32 v67, s3, 8, v14
	v_lshlrev_b32_e32 v14, 1, v64
	v_add_nc_u32_e32 v70, 0, v62
	v_xad_u32 v45, 0x50, v11, 0
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v72, v[5:8] offset:2048
	v_mov_b32_e32 v2, v17
	v_lshrrev_b32_e32 v13, 2, v13
	v_mov_b32_e32 v8, v17
	v_add_nc_u32_e32 v74, v10, v65
	v_add_nc_u32_e32 v10, 0, v11
	v_add_nc_u32_e32 v75, v12, v65
	v_xor_b32_e32 v13, v18, v13
	v_xad_u32 v12, v11, 16, 0
	v_mov_b32_e32 v5, v17
	v_add_nc_u32_e32 v73, v70, v14
	...
	v_xor_b32_e32 v18, 32, v69
	v_mov_b32_e32 v10, v17
	v_mov_b32_e32 v11, v17
	v_mov_b32_e32 v12, v17
	v_or3_b32 v71, v20, v23, v19
	v_xor_b32_e32 v19, 48, v69
	...
	v_add_nc_u32_e32 v83, 0, v23
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v13, v17 :: v_dual_add_nc_u32 v84, 0, v24
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s2, s2, s10
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v21, v17 :: v_dual_add_nc_u32 v86, 0, v69
	.loc	1 939 32                        ; attention.py:939:32
	v_add_lshl_u32 v18, s2, v61, 1
	.loc	1 974 36                        ; attention.py:974:36
	s_lshr_b32 s2, s29, 1
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v20, v17 :: v_dual_add_nc_u32 v105, 0, v71
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v19, v17 :: v_dual_cndmask_b32 v18, 0x80000000, v18
	v_mov_b32_e32 v22, v17
	v_dual_mov_b32 v23, v17 :: v_dual_mov_b32 v112, v68
	.loc	1 1018 23                       ; attention.py:1018:23
	v_add_nc_u32_e32 v87, v70, v63
	.loc	1 939 32                        ; attention.py:939:32
	buffer_load_b128 v[57:60], v18, s[16:19], 0 offen
	.loc	1 944 30                        ; attention.py:944:30
	v_mov_b32_e32 v18, v17
	v_dual_mov_b32 v95, v24 :: v_dual_add_nc_u32 v68, s2, v67
	...
	v_mad_u64_u32 v[18:19], null, v68, s11, v[62:63]
	.loc	1 1001 25                       ; attention.py:1001:25
	s_mul_i32 s3, s3, s11
	.loc	1 939 32                        ; attention.py:939:32
	s_waitcnt lgkmcnt(0)
...
.Ltmp4:
	...
	v_permlanex16_b32 v88, v86, s30, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp5:
...
.Ltmp8:
	...
	v_dual_add_f32 v97, v20, v21 :: v_dual_sub_f32 v88, v85, v86
...
.Ltmp14:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_add_f32_e32 v88, v60, v68
.Ltmp15:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_add3_u32 v60, v60, v94, 0x7fff
	v_add3_u32 v68, v68, v95, 0x7fff
	...
	v_cndmask_b16 v21.h, 0x7fff, v68.h, s9
	ds_store_b16 v74, v18
	ds_store_b16_d16_hi v74, v18 offset:128
	ds_store_b16 v74, v19 offset:256
	ds_store_b16_d16_hi v74, v19 offset:384
	ds_store_b16 v74, v20 offset:512
	ds_store_b16_d16_hi v74, v20 offset:640
	ds_store_b16 v74, v21 offset:768
	ds_store_b16_d16_hi v74, v21 offset:896
	...
	.loc	1 978 32                        ; attention.py:978:32
	v_bfe_i32 v22, v68, 0, 8
	.loc	1 989 29                        ; attention.py:989:29
	v_or_b16 v57.l, v19.l, v21.l
	.loc	1 990 56                        ; attention.py:990:56
	v_or_b16 v21.l, v19.h, -16
	.loc	1 988 32                        ; attention.py:988:32
	v_lshrrev_b16 v20.l, 4, v68.l
	.loc	1 986 76                        ; attention.py:986:76
	v_and_b16 v18.h, v68.l, 15
	.loc	1 990 39                        ; attention.py:990:39
	...
	v_dual_mul_f32 v68, v104, v68 :: v_dual_mul_f32 v3, v3, v85
	v_dual_mul_f32 v96, v104, v96 :: v_dual_mul_f32 v5, v5, v85
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_dual_mul_f32 v22, v60, v22 :: v_dual_mul_f32 v7, v7, v85
.Ltmp16:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v88, v98, v88 :: v_dual_and_b32 v97, 1, v113
.Ltmp17:
	.loc	1 1018 23                       ; attention.py:1018:23
	v_mul_f32_e32 v13, v13, v85
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v19, v109, v19 :: v_dual_mul_f32 v18, v23, v18
	.loc	1 1017 30 is_stmt 0             ; attention.py:1017:30
	v_mov_b16_e32 v110.l, v57.h
	s_delay_alu instid0(VALU_DEP_4)
.Ltmp18:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_dual_add_f32 v58, v89, v88 :: v_dual_mul_f32 v15, v15, v85
.Ltmp19:
	.loc	1 1019 30                       ; attention.py:1019:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u16_d16 v88, v75
	ds_load_u16_d16 v89, v75 offset:128
	ds_load_u16_d16 v90, v75 offset:256
	ds_load_u16_d16 v91, v75 offset:384
	ds_load_u16_d16 v92, v75 offset:512
	ds_load_u16_d16 v93, v75 offset:640
	ds_load_u16_d16 v94, v75 offset:768
	ds_load_u16_d16 v95, v75 offset:896
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_dual_mul_f32 v8, v8, v85 :: v_dual_mov_b32 v85, v86
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v88, v75 offset:64
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v89, v75 offset:192
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v90, v75 offset:320
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v91, v75 offset:448
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v92, v75 offset:576
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v93, v75 offset:704
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v94, v75 offset:832
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v95, v75 offset:960
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b32 v76, v24, v21 offset1:8
	ds_store_2addr_b32 v76, v19, v20 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp20:
	...
	v_permlanex16_b32 v59, v58, s30, 0xfedcba98 op_sel:[1,0]
.Ltmp21:
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_vgpr, 116
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.kd
