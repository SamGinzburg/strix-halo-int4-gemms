...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_mad_u64_u32 v[167:168], null, s1, s33, v[67:68]
	.loc	1 934 31                        ; ragged.py:934:31
	s_cselect_b32 s66, -1, 0
	s_cmp_lt_i32 s9, s35
	.loc	1 944 42                        ; ragged.py:944:42
	v_mad_u64_u32 v[168:169], null, s9, s33, v[67:68]
	.loc	1 934 31                        ; ragged.py:934:31
	s_cselect_b32 s67, -1, 0
	s_cmp_lt_i32 s8, s35
	.loc	1 944 42                        ; ragged.py:944:42
	v_mad_u64_u32 v[169:170], null, s8, s33, v[67:68]
	.loc	1 934 31                        ; ragged.py:934:31
	s_cselect_b32 s68, -1, 0
	s_cmp_lt_i32 s7, s35
	.loc	1 944 42                        ; ragged.py:944:42
	v_mad_u64_u32 v[170:171], null, s7, s33, v[67:68]
	.loc	1 934 31                        ; ragged.py:934:31
	s_cselect_b32 s69, -1, 0
	s_cmp_lt_i32 s6, s35
	.loc	1 944 42                        ; ragged.py:944:42
	v_mad_u64_u32 v[171:172], null, s6, s33, v[67:68]
	.loc	1 934 31                        ; ragged.py:934:31
	...
	.loc	1 943 34                        ; ragged.py:943:34
	v_dual_cndmask_b32 v206, 0x80000000, v206 :: v_dual_add_nc_u32 v217, 0, v145
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_dual_mul_f32 v18, v18, v168 :: v_dual_lshlrev_b32 v167, 16, v167
	s_delay_alu instid0(VALU_DEP_1)
	v_mul_f32_e32 v173, v2, v167
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v20, v20, v168 :: v_dual_lshlrev_b32 v171, 16, v171
	v_dual_mul_f32 v172, v1, v167 :: v_dual_lshlrev_b32 v169, 16, v169
	...
	v_dual_mul_f32 v177, v6, v167 :: v_dual_mul_f32 v24, v24, v168
	...
	v_dual_mul_f32 v181, v10, v167 :: v_dual_mul_f32 v28, v28, v168
	...
	v_dual_mul_f32 v185, v14, v167 :: v_dual_mul_f32 v32, v32, v168
	...
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v133, v175, v4 :: v_dual_fmac_f32 v132, v176, v5
	v_dual_fmac_f32 v131, v177, v6 :: v_dual_fmac_f32 v130, v178, v7
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v129, v179, v8 :: v_dual_fmac_f32 v128, v180, v9
	v_dual_fmac_f32 v127, v181, v10 :: v_dual_fmac_f32 v126, v182, v11
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v125, v183, v12 :: v_dual_fmac_f32 v124, v184, v13
	v_dual_fmac_f32 v123, v185, v14 :: v_dual_fmac_f32 v122, v186, v15
	v_dual_fmac_f32 v120, v167, v16 :: v_dual_fmac_f32 v119, v17, v1
	v_dual_fmac_f32 v118, v18, v2 :: v_dual_fmac_f32 v117, v19, v3
	v_dual_fmac_f32 v116, v20, v4 :: v_dual_fmac_f32 v115, v21, v5
	v_dual_fmac_f32 v114, v22, v6 :: v_dual_fmac_f32 v113, v23, v7
	v_dual_fmac_f32 v112, v24, v8 :: v_dual_fmac_f32 v107, v26, v10
	v_dual_fmac_f32 v108, v25, v9 :: v_dual_fmac_f32 v105, v27, v11
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 218
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
