	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	s_abs_i32 s10, s2
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v8, 7, v0
	...
	v_dual_mov_b32 v15, 0 :: v_dual_and_b32 v2, 12, v9
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	v_bfe_i32 v27, v0, 5, 1
...
.Ltmp21:
	...
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	buffer_load_b32 v6, v6, s[24:27], 0 offen
	...
	s_waitcnt vmcnt(1)
	ds_store_b16 v35, v5 offset:2048
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	s_waitcnt vmcnt(0)
	ds_store_b32 v36, v6
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
; %bb.1:                                ; %.lr.ph
	v_add3_u32 v7, s33, v30, v28
	v_lshl_or_b32 v10, s20, 8, v29
	s_lshl_b32 s0, s17, 8
	v_lshl_or_b32 v4, s20, 7, v4
	s_add_i32 s42, s18, 16
	s_mov_b32 s18, s16
	...
	v_lshl_or_b32 v5, v28, 4, v31
	v_or3_b32 v6, v32, v33, v34
	...
	v_sub_nc_u32_e32 v37, s19, v1
	v_sub_nc_u32_e32 v38, s19, v2
	v_lshlrev_b32_e32 v42, 1, v7
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v43, 0, v5
	...
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v45, 0, v6
	v_mov_b32_e32 v1, s16
	v_dual_mov_b32 v4, s19 :: v_dual_lshlrev_b32 v39, 1, v27
	v_dual_mov_b32 v11, 0 :: v_dual_add_nc_u32 v46, 0, v12
	v_dual_mov_b32 v3, s18 :: v_dual_mov_b32 v2, s17
	v_dual_mov_b32 v5, s20 :: v_dual_mov_b32 v22, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_cmp_lg_u32 s40, 0
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	buffer_load_u16 v73, v47, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	s_clause 0x1
	buffer_load_u16 v74, v42, s[28:31], 0 offen
	buffer_load_u16 v75, v41, s[28:31], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v76, v49, s[36:39], 0 offen
	buffer_load_u16 v77, v49, s[36:39], 0 offen offset:4
	buffer_load_u16 v78, v49, s[36:39], 0 offen offset:8
	buffer_load_u16 v79, v49, s[36:39], 0 offen offset:12
	buffer_load_u16 v80, v49, s[36:39], 0 offen offset:16
	buffer_load_u16 v81, v49, s[36:39], 0 offen offset:20
	buffer_load_u16 v82, v49, s[36:39], 0 offen offset:24
	buffer_load_u16 v83, v49, s[36:39], 0 offen offset:28
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	v_cndmask_b32_e64 v47, 0x80000000, v48, s0
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	...
	buffer_load_b32 v84, v47, s[24:27], 0 offen
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(11)
	ds_store_b16 v35, v73 offset:2048
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v56, v56, v64 :: v_dual_mul_f32 v47, v47, v63
	v_dual_mul_f32 v49, v49, v63 :: v_dual_add_nc_u32 v40, s41, v40
	v_dual_mul_f32 v52, v52, v63 :: v_dual_add_nc_u32 v41, 2, v41
	v_dual_mul_f32 v51, v51, v63 :: v_dual_add_nc_u32 v42, 2, v42
	v_dual_mul_f32 v53, v53, v63 :: v_dual_lshlrev_b32 v66, 16, v77
	v_dual_mul_f32 v48, v48, v63 :: v_dual_lshlrev_b32 v69, 16, v80
	v_mul_f32_e32 v50, v50, v63
	v_dual_mul_f32 v54, v54, v63 :: v_dual_fmac_f32 v11, v47, v65
	v_dual_mul_f32 v58, v58, v64 :: v_dual_lshlrev_b32 v67, 16, v78
	v_dual_mul_f32 v55, v55, v64 :: v_dual_lshlrev_b32 v68, 16, v79
	v_dual_mul_f32 v57, v57, v64 :: v_dual_lshlrev_b32 v70, 16, v81
	v_dual_mul_f32 v60, v60, v64 :: v_dual_lshlrev_b32 v71, 16, v82
	v_dual_mul_f32 v59, v59, v64 :: v_dual_lshlrev_b32 v72, 16, v83
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v61, v61, v64 :: v_dual_fmac_f32 v22, v52, v70
	v_dual_mul_f32 v62, v62, v64 :: v_dual_fmac_f32 v25, v49, v67
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v26, v48, v66
	v_dual_fmac_f32 v24, v50, v68 :: v_dual_fmac_f32 v23, v51, v69
	v_dual_fmac_f32 v21, v53, v71 :: v_dual_fmac_f32 v20, v54, v72
	v_dual_fmac_f32 v19, v55, v65 :: v_dual_fmac_f32 v18, v56, v66
	v_dual_fmac_f32 v17, v57, v67 :: v_dual_fmac_f32 v16, v58, v68
	v_dual_fmac_f32 v15, v59, v69 :: v_dual_fmac_f32 v14, v60, v70
	v_dual_fmac_f32 v13, v61, v71 :: v_dual_fmac_f32 v12, v62, v72
...
; %bb.4:
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	v_lshl_or_b32 v1, v28, 4, v31
	.loc	1 164 26                        ; generate_amdgcn.py:164:26
	v_or3_b32 v2, v32, v33, v34
	s_mov_b32 s16, 0
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	s_mov_b32 s17, s16
	...
	v_xad_u32 v7, v1, 8, 0
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v47, s23 :: v_dual_mov_b32 v42, s18
	...
	.loc	1 162 26                        ; generate_amdgcn.py:162:26
	ds_load_2addr_stride64_b64 v[5:8], v7 offset0:4 offset1:5
	.loc	1 167 27                        ; generate_amdgcn.py:167:27
	v_dual_mov_b32 v45, s21 :: v_dual_mov_b32 v40, s16
	v_mov_b32_e32 v43, s19
	v_mov_b32_e32 v41, s17
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[31:38], v[9:10], v[1:2], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[40:47], v[9:10], v[3:4], v[40:47] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[31:38], v[48:49], v[5:6], v[31:38] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[40:47], v[48:49], v[7:8], v[40:47] neg_lo:[1,1,0]
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
...
.LBB0_5:
	...
	v_add_nc_u32_e32 v33, 8, v27
	v_cndmask_b32_e64 v34, 0x80000000, v27, s2
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	s_clause 0x1
	...
	v_mul_lo_u32 v28, s7, v28
	s_mul_i32 s33, s33, s7
	v_mul_lo_u32 v30, s7, v30
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v10, v10, v31 :: v_dual_lshlrev_b32 v29, 16, v29
	v_dual_mul_f32 v2, v2, v29 :: v_dual_add_nc_u32 v41, 12, v27
	v_dual_mul_f32 v1, v1, v29 :: v_dual_add_nc_u32 v42, 16, v27
	v_dual_mul_f32 v4, v4, v29 :: v_dual_add_nc_u32 v43, 20, v27
	v_dual_mul_f32 v9, v9, v29 :: v_dual_add_nc_u32 v44, 24, v27
	v_dual_mul_f32 v6, v6, v29 :: v_dual_add_nc_u32 v27, 28, v27
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v35, v35, v29 :: v_dual_and_b32 v0, 16, v0
	...
	v_fma_f32 v1, v1, v34, v11
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fma_f32 v2, v2, v32, v26
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(0)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v29, v29, v27, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v2, v2, v2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v36, v36, v31 :: v_dual_lshlrev_b32 v33, 16, v33
	v_dual_mul_f32 v38, v38, v31 :: v_dual_lshlrev_b32 v39, 16, v41
	v_dual_mul_f32 v8, v8, v31 :: v_dual_and_b32 v45, 0x78, v45
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v4, v4, v33, v25
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fma_f32 v6, v6, v39, v24
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v20, v20, v29, s2
	.loc	1 190 18                        ; generate_amdgcn.py:190:18
	v_add3_u32 v45, s33, s6, v45
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v39, v16
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v10, v10, v41, v15
	.loc	1 180 20 is_stmt 0              ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v3, v3, v31
	.loc	1 187 19 is_stmt 1              ; generate_amdgcn.py:187:19
	v_dual_max_f32 v6, v6, v6 :: v_dual_lshlrev_b32 v43, 16, v44
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v9, v9, v41, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v10, v15, v10, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v31 :: v_dual_max_f32 v16, v20, v20
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_max_f32_e32 v8, v8, v8
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v3, v3, v34, v19
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_max_f32_e32 v10, v10, v10
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v5, v5, v32, v18
	v_fma_f32 v32, v36, v42, v14
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v27, v31, v27, v12
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v3, v3, v3 :: v_dual_max_f32 v16, 0, v16
	...
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v16, v16, v16
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v5, v5, v5 :: v_dual_max_f32 v8, 0, v8
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v9, v9, v9 :: v_dual_and_b32 v18, 1, v46
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v5, 0, v5 :: v_dual_mul_f32 v8, v8, v8
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v5, v5, v5 :: v_dual_and_b32 v20, 1, v51
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v7, v7, v7 :: v_dual_max_f32 v10, 0, v10
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v7, 0, v7 :: v_dual_mul_f32 v10, v10, v10
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_mov_b16_e32 v46.l, v16.h
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v33, v38, v43, v13
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v13, v13, v13 :: v_dual_mul_f32 v14, v14, v14
	...
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v13, v13, v13 :: v_dual_and_b32 v24, 1, v55
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	v_add_lshl_u32 v8, v45, v30, 1
	s_clause 0x1
	buffer_store_b128 v[0:3], v28, s[4:7], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 85
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
