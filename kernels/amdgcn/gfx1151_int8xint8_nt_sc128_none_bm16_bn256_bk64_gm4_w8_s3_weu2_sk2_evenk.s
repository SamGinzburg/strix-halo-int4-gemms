...
.Ltmp19:
	...
	s_clause 0x1
	buffer_load_b128 v[17:20], v16, s[28:31], 0 offen
	buffer_load_b128 v[21:24], v5, s[28:31], 0 offen
	...
	buffer_load_b128 v[37:40], v11, s[28:31], 0 offen
...
.LBB0_3:                                ; %Flow47
	...
	v_mul_lo_u32 v35, v2, s0
	v_lshlrev_b32_e32 v11, 2, v6
	v_lshlrev_b32_e32 v19, 1, v6
	s_and_not1_b32 vcc_lo, exec_lo, s10
	s_cbranch_vccnz .LBB0_7
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v1, 48, v5
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	...
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	v_and_b32_e32 v2, 0x1c00, v16
	v_or_b32_e32 v36, v4, v1
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v47, 0, v19
	v_mov_b32_e32 v23, 0
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v46, v20, v12
	v_mov_b32_e32 v20, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v23, v52, v84 :: v_dual_add_nc_u32 v128, s33, v45
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	...
	v_dual_mul_f32 v62, v62, v96 :: v_dual_fmac_f32 v31, v59, v91
	v_dual_mul_f32 v63, v63, v96 :: v_dual_fmac_f32 v24, v53, v85
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v20, v49, v81 :: v_dual_add_nc_u32 v127, s16, v44
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v18, v48, v80 :: v_dual_fmac_f32 v33, v61, v93
	v_dual_fmac_f32 v21, v50, v82 :: v_dual_fmac_f32 v22, v51, v83
	v_dual_fmac_f32 v25, v54, v86 :: v_dual_fmac_f32 v26, v55, v87
	v_dual_fmac_f32 v28, v56, v88 :: v_dual_fmac_f32 v27, v63, v95
	v_dual_fmac_f32 v29, v57, v89 :: v_dual_fmac_f32 v30, v58, v90
	v_fmac_f32_e32 v32, v60, v92
	v_fmac_f32_e32 v34, v62, v94
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.9:
	...
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[57:60], v4 offset:8192
	ds_load_b128 v[61:64], v4
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[65:68], v2
	ds_load_b128 v[69:72], v5
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	ds_load_b128 v[73:76], v3 offset:8192
	...
	ds_load_b128 v[93:96], v10 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[61:64], v[69:72], v[2:9] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[57:60], v[69:72], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[77:80], v[65:68], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[73:76], v[65:68], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[45:48], v[81:84], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[13:16], v[81:84], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[89:92], v[85:88], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[2:9], v[93:96], v[85:88], v[2:9] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	v_dual_mov_b32 v65, 0 :: v_dual_add_nc_u32 v62, 0, v19
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	buffer_load_u16 v3, v3, s[24:27], 0 offen
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v79, v2, s[8:11], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_or3_b32 v78, v11, v1, v12
	v_mov_b32_e32 v63, 0
	v_dual_mov_b32 v67, 0 :: v_dual_mov_b32 v68, 0
	v_dual_mov_b32 v69, 0 :: v_dual_mov_b32 v70, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v71, 0 :: v_dual_add_nc_u32 v52, 0, v78
	...
	s_mov_b32 s12, 0
	s_waitcnt vmcnt(1)
	v_dual_mov_b32 v66, 0 :: v_dual_lshlrev_b32 v1, 16, v3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
...
.LBB0_12:
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v19, v21, v46, s3
