...
; %bb.4:                                ; %.lr.ph
	...
	v_mul_lo_u32 v80, v1, s44
	v_mul_lo_u32 v81, v2, s44
	v_bfe_i32 v1, v0, 7, 1
	...
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[42:43], null, s3, s11, v[41:42]
	.loc	1 1205 25 is_stmt 1             ; ragged.py:1205:25
	v_mul_lo_u32 v82, v3, s44
	v_mul_lo_u32 v83, v4, s44
	...
	v_mul_lo_u32 v107, v15, s46
	v_mul_lo_u32 v108, v17, s46
	v_mul_lo_u32 v109, v18, s46
	...
	v_mul_lo_u32 v122, v19, s46
	v_mul_lo_u32 v123, v20, s46
	v_mul_lo_u32 v125, v15, s46
	.loc	1 1135 19 is_stmt 1             ; ragged.py:1135:19
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v9, s80, v42
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s5, s46
	v_add_nc_u32_e32 v10, s80, v43
	...
	v_cndmask_b32_e64 v10, 0x80000000, v12, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s56, s46
	v_add_nc_u32_e32 v14, s80, v47
	v_cndmask_b32_e64 v11, 0x80000000, v13, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s57, s46
	v_add_nc_u32_e32 v15, s80, v48
	v_cndmask_b32_e64 v7, 0x80000000, v7, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s58, s46
	v_add_nc_u32_e32 v16, s80, v49
	s_clause 0x2
	...
	v_cndmask_b32_e64 v10, 0x80000000, v15, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v17, s80, v50
	v_cndmask_b32_e64 v11, 0x80000000, v16, s4
	s_cmp_lt_i32 s60, s46
	v_add_nc_u32_e32 v18, s80, v51
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s61, s46
	v_add_nc_u32_e32 v19, s80, v52
	s_clause 0x2
	buffer_load_u8 v76, v9, s[20:23], 0 offen
	buffer_load_u8 v173, v10, s[20:23], 0 offen
	buffer_load_u8 v174, v11, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v17, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s62, s46
	.loc	1 1135 19                       ; ragged.py:1135:19
	v_lshl_add_u32 v8, s33, 4, v42
	v_cndmask_b32_e64 v10, 0x80000000, v18, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v20, s80, v53
	v_cndmask_b32_e64 v11, 0x80000000, v19, s4
	s_cmp_lt_i32 s63, s46
	v_add_nc_u32_e32 v8, s80, v8
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s64, s46
	v_add_nc_u32_e32 v21, s80, v54
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_clause 0x2
	buffer_load_u8 v175, v9, s[20:23], 0 offen
	buffer_load_u8 v176, v10, s[20:23], 0 offen
	buffer_load_u8 v177, v11, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v20, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s65, s46
	v_cndmask_b32_e64 v8, 0x80000000, v8, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v22, s80, v55
	v_cndmask_b32_e64 v10, 0x80000000, v21, s4
	s_cmp_lt_i32 s66, s46
	v_add_nc_u32_e32 v23, s80, v56
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s67, s46
	v_add_nc_u32_e32 v24, s80, v57
	s_clause 0x4
	buffer_load_u8 v6, v6, s[20:23], 0 offen
	buffer_load_u8 v7, v7, s[20:23], 0 offen
	buffer_load_u8 v178, v9, s[20:23], 0 offen
	buffer_load_u8 v179, v10, s[20:23], 0 offen
	buffer_load_u8 v8, v8, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v22, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s68, s46
	v_cndmask_b32_e64 v11, 0x80000000, v23, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v25, s80, v58
	v_cndmask_b32_e64 v10, 0x80000000, v24, s4
	s_cmp_lt_i32 s69, s46
	v_add_nc_u32_e32 v26, s80, v59
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s70, s46
	v_add_nc_u32_e32 v27, s80, v60
	s_clause 0x2
	buffer_load_u8 v180, v9, s[20:23], 0 offen
	buffer_load_u8 v181, v11, s[20:23], 0 offen
	buffer_load_u8 v182, v10, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v25, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s71, s46
	v_cndmask_b32_e64 v11, 0x80000000, v26, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v28, s80, v61
	v_cndmask_b32_e64 v10, 0x80000000, v27, s4
	s_cmp_lt_i32 s72, s46
	v_add_nc_u32_e32 v29, s80, v62
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s73, s46
	v_add_nc_u32_e32 v30, s80, v63
	s_clause 0x2
	buffer_load_u8 v183, v9, s[20:23], 0 offen
	buffer_load_u8 v184, v11, s[20:23], 0 offen
	buffer_load_u8 v185, v10, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v28, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s74, s46
	v_cndmask_b32_e64 v11, 0x80000000, v29, s4
	s_cselect_b32 s4, -1, 0
	v_add_nc_u32_e32 v31, s80, v64
	v_cndmask_b32_e64 v10, 0x80000000, v30, s4
	s_cmp_lt_i32 s75, s46
	v_add_nc_u32_e32 v32, s80, v65
	s_cselect_b32 s4, -1, 0
	s_clause 0x1
	buffer_load_u8 v186, v9, s[20:23], 0 offen
	buffer_load_u8 v188, v10, s[20:23], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v31, s4
	s_cmp_lt_i32 s76, s46
	v_add_nc_u32_e32 v33, s80, v66
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s77, s46
	v_add_nc_u32_e32 v34, s80, v67
	v_cmp_gt_i32_e64 s3, s46, v3
	s_clause 0x1
	buffer_load_u8 v187, v11, s[20:23], 0 offen
	buffer_load_u8 v189, v9, s[20:23], 0 offen
	v_cndmask_b32_e64 v11, 0x80000000, v32, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s78, s46
	v_add_nc_u32_e32 v36, v107, v3
	v_cndmask_b32_e64 v10, 0x80000000, v33, s4
	s_cselect_b32 s4, -1, 0
	s_cmp_lt_i32 s79, s46
	v_add_nc_u32_e32 v37, v108, v3
	v_cndmask_b32_e64 v9, 0x80000000, v34, s4
	s_cselect_b32 s4, -1, 0
	s_and_b32 s5, s47, s3
	v_add_nc_u32_e32 v38, v109, v3
	buffer_load_u8 v190, v11, s[20:23], 0 offen
	v_cndmask_b32_e64 v11, 0x80000000, v36, s5
	s_and_b32 s5, s48, s3
	v_add_nc_u32_e32 v39, v120, v3
	v_cndmask_b32_e64 v12, 0x80000000, v37, s5
	s_and_b32 s5, s49, s3
	v_add_nc_u32_e32 v40, v121, v3
	v_cndmask_b32_e64 v13, 0x80000000, v38, s5
	s_and_b32 s5, s50, s3
	v_add_nc_u32_e32 v69, v122, v3
	v_cndmask_b32_e64 v14, 0x80000000, v39, s5
	s_and_b32 s5, s51, s3
	v_add_nc_u32_e32 v70, v123, v3
	v_add_nc_u32_e32 v3, v125, v3
	v_add_nc_u32_e32 v35, s80, v68
	v_cndmask_b32_e64 v15, 0x80000000, v40, s5
	s_and_b32 s5, s52, s3
	.loc	1 1155 34                       ; ragged.py:1155:34
	v_add_nc_u32_e32 v1, 0, v84
	v_cndmask_b32_e64 v16, 0x80000000, v69, s5
	s_and_b32 s5, s53, s3
	s_and_b32 s3, s6, s3
	v_cndmask_b32_e64 v17, 0x80000000, v70, s5
	v_cndmask_b32_e64 v3, 0x80000000, v3, s3
	v_cndmask_b32_e64 v18, 0x80000000, v35, s4
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_clause 0x1
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	buffer_load_u8 v191, v18, s[20:23], 0 offen
	.loc	1 1155 34                       ; ragged.py:1155:34
	...
	s_waitcnt vmcnt(1)
	ds_store_b8 v145, v12
	ds_store_b8 v145, v14 offset:512
	ds_store_b8 v145, v15 offset:1024
	...
	ds_store_b8 v151, v73 offset:1280
	ds_store_b8 v151, v74 offset:1536
	ds_store_b8 v151, v7 offset:2048
	ds_store_b8 v151, v76 offset:2304
	ds_store_b8 v151, v173 offset:2560
	ds_store_b8 v151, v175 offset:3072
	ds_store_b8 v151, v176 offset:3328
	ds_store_b8 v151, v177 offset:3584
	ds_store_b8 v151, v8 offset:4096
	ds_store_b8 v151, v179 offset:4352
	ds_store_b8 v151, v180 offset:4608
	ds_store_b8 v151, v182 offset:5120
	ds_store_b8 v151, v183 offset:5376
	ds_store_b8 v151, v184 offset:5632
	ds_store_b8 v151, v186 offset:6144
	ds_store_b8 v151, v187 offset:6400
	ds_store_b8 v151, v188 offset:6656
	ds_store_b8 v151, v190 offset:7168
	ds_store_b8 v151, v69 offset:7424
	ds_store_b8 v151, v70 offset:7680
	ds_store_b8 v153, v72
	ds_store_b8 v155, v75
	ds_store_b8 v157, v174
	ds_store_b8 v158, v178
	ds_store_b8 v159, v181
	ds_store_b8 v160, v185
	ds_store_b8 v161, v189
	s_waitcnt vmcnt(0)
	ds_store_b8 v163, v191
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v11, s54, v80, 1
	v_add_lshl_u32 v12, s54, v81, 1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[25:32], v[181:182], v[15:16], v[25:32] neg_lo:[1,1,0]
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v15, s54, v82, 1
	v_add_lshl_u32 v16, s54, v83, 1
	...
	v_dual_mul_f32 v180, v209, v11 :: v_dual_mul_f32 v11, v70, v9
	...
	v_fmac_f32_e32 v119, v178, v3
	v_dual_fmac_f32 v97, v16, v3 :: v_dual_fmac_f32 v96, v69, v4
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v167, v25, v5 :: v_dual_fmac_f32 v116, v188, v6
	v_dual_fmac_f32 v126, v15, v1 :: v_dual_fmac_f32 v141, v181, v2
	v_fmac_f32_e32 v94, v71, v6
	v_fmac_f32_e32 v124, v177, v2
	v_dual_fmac_f32 v137, v185, v6 :: v_dual_fmac_f32 v114, v190, v8
	...
	v_fmac_f32_e32 v138, v184, v5
	v_dual_fmac_f32 v136, v186, v7 :: v_dual_fmac_f32 v135, v187, v8
	...
	v_dual_fmac_f32 v113, v191, v9 :: v_dual_fmac_f32 v112, v192, v10
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v111, v13, v11 :: v_dual_fmac_f32 v100, v22, v4
	...
	v_dual_fmac_f32 v128, v175, v3 :: v_dual_fmac_f32 v127, v176, v4
	v_dual_fmac_f32 v105, v17, v1 :: v_dual_fmac_f32 v106, v195, v2
	v_dual_fmac_f32 v103, v18, v2 :: v_dual_fmac_f32 v104, v196, v3
	v_fmac_f32_e32 v101, v21, v3
	v_fmac_f32_e32 v102, v197, v4
	.loc	1 1135 19                       ; ragged.py:1135:19
...
.Ltmp39:
	...
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s2, s[40:41], v[84:85]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1238 24                       ; ragged.py:1238:24
	...
	.loc	1 1046 48                       ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s3, s[42:43], v[84:85]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 81
