...
.Ltmp14:
	...
	s_cvt_u32_f32 s7, s7
	v_xor_b32_e32 v14, 8, v41
	v_xor_b32_e32 v15, 16, v41
	v_xor_b32_e32 v16, 24, v41
	v_xor_b32_e32 v8, 32, v41
	v_xor_b32_e32 v11, 40, v41
	v_xor_b32_e32 v13, 48, v41
	v_xor_b32_e32 v17, 56, v41
	v_xor_b32_e32 v18, 0x840, v42
	v_xor_b32_e32 v19, 0x1008, v42
	v_xor_b32_e32 v20, 0x1848, v42
	v_xor_b32_e32 v21, 0x2010, v42
	v_xor_b32_e32 v22, 0x2850, v42
	v_xor_b32_e32 v23, 0x3018, v42
	v_xor_b32_e32 v24, 0x3858, v42
	v_xor_b32_e32 v25, 0x4020, v42
	v_xor_b32_e32 v26, 0x4860, v42
	v_xor_b32_e32 v27, 0x5028, v42
	v_xor_b32_e32 v28, 0x5868, v42
	v_xor_b32_e32 v29, 0x6030, v42
	v_xor_b32_e32 v30, 0x6870, v42
	v_xor_b32_e32 v31, 0x7038, v42
	v_xor_b32_e32 v32, 0x7878, v42
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_lshl_add_u32 v43, v37, 4, v3
	...
	v_add_nc_u32_e32 v56, 0, v13
	v_add_nc_u32_e32 v57, 0, v17
	v_add_nc_u32_e32 v58, 0, v18
	v_add_nc_u32_e32 v59, 0, v19
	v_add_nc_u32_e32 v60, 0, v20
	v_add_nc_u32_e32 v61, 0, v21
	v_add_nc_u32_e32 v62, 0, v22
	v_add_nc_u32_e32 v63, 0, v23
	v_add_nc_u32_e32 v64, 0, v24
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 305 27 is_stmt 0              ; generate_amdgcn.py:305:27
	...
	.loc	1 305 13                        ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v96, s64, v88, 2
	v_add_lshl_u32 v97, s65, v88, 2
	v_add_lshl_u32 v98, s66, v88, 2
	v_add_lshl_u32 v99, s67, v88, 2
	v_add_lshl_u32 v100, s68, v88, 2
	v_add_lshl_u32 v101, s69, v88, 2
	v_add_lshl_u32 v102, s70, v88, 2
	v_add_lshl_u32 v103, s71, v88, 2
	v_add_lshl_u32 v104, s72, v88, 2
	v_add_lshl_u32 v105, s73, v88, 2
	v_add_lshl_u32 v106, s74, v88, 2
	v_add_lshl_u32 v107, s75, v88, 2
	v_add_lshl_u32 v108, s76, v88, 2
	v_add_lshl_u32 v109, s77, v88, 2
	v_add_lshl_u32 v110, s78, v88, 2
	v_add_lshl_u32 v111, s79, v88, 2
	v_add_lshl_u32 v112, s80, v88, 2
	v_add_lshl_u32 v113, s81, v88, 2
	v_add_lshl_u32 v114, s82, v88, 2
	v_add_lshl_u32 v115, s83, v88, 2
	v_add_lshl_u32 v116, s84, v88, 2
	v_add_lshl_u32 v117, s85, v88, 2
	v_add_lshl_u32 v118, s86, v88, 2
	.loc	1 305 27                        ; generate_amdgcn.py:305:27
	s_add_i32 s87, s6, s55
	s_add_i32 s88, s6, s56
	s_add_i32 s89, s6, s57
	s_add_i32 s90, s6, s58
	s_add_i32 s91, s6, s59
	.loc	1 241 5 is_stmt 1               ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	s_waitcnt vmcnt(0)
	...
	.loc	1 305 13 is_stmt 0              ; generate_amdgcn.py:305:13
	v_add_lshl_u32 v94, s22, v88, 2
	v_add_lshl_u32 v95, s23, v88, 2
	.loc	1 241 5 is_stmt 1               ; generate_amdgcn.py:241:5
	s_cmp_lt_i32 s2, s26
	.loc	1 269 18                        ; generate_amdgcn.py:269:18
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v132, v30, v87 :: v_dual_mul_f32 v141, v24, v89
	...
	v_dual_mul_f32 v121, v19, v87 :: v_dual_add_nc_u32 v90, 0, v41
	v_dual_mul_f32 v122, v20, v87 :: v_dual_add_nc_u32 v91, 0, v42
	v_dual_mul_f32 v123, v21, v87 :: v_dual_mul_f32 v140, v23, v89
	v_mul_f32_e32 v145, v28, v89
	...
	v_dual_mul_f32 v19, v120, v85 :: v_dual_mul_f32 v18, v134, v16
	v_dual_mul_f32 v31, v126, v79 :: v_dual_mul_f32 v30, v140, v10
	v_dual_mul_f32 v32, v141, v9 :: v_dual_mul_f32 v79, v142, v8
	v_dual_mul_f32 v27, v124, v81 :: v_dual_mul_f32 v20, v135, v15
	v_dual_mul_f32 v29, v125, v80 :: v_dual_mul_f32 v28, v139, v11
	v_mul_f32_e32 v80, v128, v77
	v_mul_f32_e32 v74, v131, v74
	v_dual_mul_f32 v26, v138, v12 :: v_dual_mul_f32 v81, v143, v7
	v_dual_mul_f32 v21, v121, v84 :: v_dual_mul_f32 v84, v132, v73
	v_dual_mul_f32 v23, v122, v83 :: v_dual_mul_f32 v22, v136, v14
	v_mul_f32_e32 v77, v144, v6
	v_dual_mul_f32 v25, v123, v82 :: v_dual_mul_f32 v24, v137, v13
	v_dual_mul_f32 v82, v130, v75 :: v_dual_mul_f32 v83, v145, v5
	v_dual_mul_f32 v75, v146, v4 :: v_dual_mul_f32 v86, v133, v35
	v_mul_f32_e32 v34, v87, v34
	v_mul_f32_e32 v85, v147, v3
	v_mul_f32_e32 v87, v148, v2
	v_mul_f32_e32 v35, v89, v1
	ds_store_2addr_stride64_b64 v90, v[17:18], v[78:79] offset1:2
	ds_store_2addr_stride64_b64 v51, v[19:20], v[80:81] offset1:2
	ds_store_2addr_stride64_b64 v52, v[21:22], v[76:77] offset1:2
	ds_store_2addr_stride64_b64 v53, v[23:24], v[82:83] offset1:2
	ds_store_2addr_stride64_b64 v54, v[25:26], v[74:75] offset1:2
	ds_store_2addr_stride64_b64 v55, v[27:28], v[84:85] offset1:2
	ds_store_2addr_stride64_b64 v56, v[29:30], v[86:87] offset1:2
	ds_store_2addr_stride64_b64 v57, v[31:32], v[34:35] offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[1:2], v91
	ds_load_b64 v[3:4], v58
	ds_load_b64 v[5:6], v59
	ds_load_b64 v[7:8], v60
	ds_load_b64 v[9:10], v61
	ds_load_b64 v[11:12], v62
	ds_load_b64 v[13:14], v63
	ds_load_b64 v[15:16], v64
	ds_load_b64 v[17:18], v65
	ds_load_b64 v[19:20], v66
	ds_load_b64 v[21:22], v67
	ds_load_b64 v[23:24], v68
	ds_load_b64 v[25:26], v69
	ds_load_b64 v[27:28], v70
	ds_load_b64 v[29:30], v71
	...
	v_add_lshl_u32 v34, s87, v88, 2
	v_add_lshl_u32 v35, s88, v88, 2
	v_add_lshl_u32 v73, s89, v88, 2
	v_add_lshl_u32 v74, s90, v88, 2
	v_add_lshl_u32 v1, s91, v88, 2
	s_clause 0x4
	buffer_atomic_add_f32 v24, v34, s[12:15], 0 offen
	buffer_atomic_add_f32 v26, v35, s[12:15], 0 offen
	buffer_atomic_add_f32 v28, v73, s[12:15], 0 offen
	buffer_atomic_add_f32 v30, v74, s[12:15], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s6, s6, 8
	s_mov_b32 s22, s3
	v_subrev_nc_u32_e32 v73, s6, v2
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[34:35], null, s27, v3, v[33:34]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s22, v40
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	v_add_nc_u32_e32 v35, s22, v34
	...
	s_add_i32 s23, s23, -1
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	v_cndmask_b32_e32 v74, 0x80000000, v73, vcc_lo
	.loc	1 255 27                        ; generate_amdgcn.py:255:27
	v_cmp_lt_i32_e32 vcc_lo, s22, v39
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_add_nc_u32_e32 v73, s63, v73
	s_add_i32 s22, s22, 32
	s_cmp_lg_u32 s23, 0
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	v_cndmask_b32_e32 v35, 0x80000000, v35, vcc_lo
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b128 v[74:77], v74, s[4:7], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[78:81], v45 offset1:32
	...
	ds_load_u8 v74, v48 offset:3072
	ds_load_u8 v75, v48 offset:3840
	ds_load_u8 v76, v48 offset:3584
	ds_load_u8 v77, v48 offset:2304
	ds_load_u8 v86, v48 offset:2048
	ds_load_u8 v87, v48 offset:2816
	ds_load_u8 v88, v48 offset:2560
	ds_load_u8 v89, v48 offset:1280
	ds_load_u8 v90, v48 offset:1024
	ds_load_u8 v91, v48 offset:1792
	ds_load_u8 v92, v48 offset:1536
	ds_load_u8 v93, v48 offset:1920
	ds_load_u8 v94, v48 offset:1664
	ds_load_u8 v95, v48 offset:1408
	ds_load_u8 v96, v48 offset:1152
	ds_load_u8 v97, v48 offset:256
	ds_load_u8 v98, v48
	ds_load_u8 v99, v48 offset:768
	ds_load_u8 v100, v48 offset:512
	ds_load_u8 v101, v48 offset:896
	ds_load_u8 v102, v48 offset:640
	ds_load_u8 v103, v48 offset:384
	ds_load_u8 v104, v48 offset:128
	ds_load_u8 v105, v48 offset:3968
	ds_load_u8 v106, v48 offset:3712
	ds_load_u8 v107, v48 offset:3456
	ds_load_u8 v108, v48 offset:3200
	ds_load_u8 v109, v48 offset:2944
	ds_load_u8 v110, v48 offset:2688
	ds_load_u8 v111, v48 offset:2432
	ds_load_u8 v112, v48 offset:2176
	...
	v_perm_b32 v35, v74, v35, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v91, v98, v97, 0xc0c0004
	v_perm_b32 v97, v86, v77, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	...
	v_lshl_or_b32 v77, v76, 16, v35
	v_lshl_or_b32 v76, v88, 16, v97
	v_lshl_or_b32 v89, v96, 16, v95
	v_wmma_i32_16x16x16_iu4 v[1:8], v[74:75], v[78:79], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v88, v99, 16, v98
	v_wmma_i32_16x16x16_iu4 v[9:16], v[86:87], v[78:79], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[74:75], v[80:81], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[86:87], v[80:81], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[76:77], v[82:83], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[88:89], v[82:83], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[76:77], v[84:85], v[17:24] neg_lo:[1,1,0]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn256_bk32_gm4_w8_s1_weu2_sk2_maskk.num_vgpr, 149
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn256_bk32_gm4_w8_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn256_bk32_gm4_w8_s1_weu2_sk2_maskk.numbered_sgpr, 92
