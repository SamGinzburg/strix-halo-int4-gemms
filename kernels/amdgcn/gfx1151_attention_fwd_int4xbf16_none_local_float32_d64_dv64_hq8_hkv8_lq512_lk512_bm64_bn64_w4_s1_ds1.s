...
; %bb.4:                                ; %.lr.ph
	...
	v_xor_b32_e32 v122, v112, v4
	.loc	1 759 31                        ; attention.py:759:31
	v_lshrrev_b32_e32 v45, 3, v0
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v33, 56, v3
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v124, 0, v34
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[77:78], null, s67, v45, v[33:34]
	v_xor_b32_e32 v33, 24, v123
	v_lshl_or_b32 v37, v37, 8, v37
	v_lshl_or_b32 v38, v38, 8, v38
	v_mov_b32_e32 v31, v25
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v125, 0, v35
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v127, 0, v33
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v121, s13, v2
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v126, 0, v36
	v_dual_mov_b32 v19, v25 :: v_dual_and_b32 v130, 0x7060706, v34
	v_mov_b32_e32 v23, v25
	v_mov_b32_e32 v9, v25
	v_mov_b32_e32 v11, v25
	v_dual_mov_b32 v12, v25 :: v_dual_and_b32 v129, 0x5040504, v33
	...
	v_dual_mov_b32 v17, v25 :: v_dual_mul_f32 v128, s0, v35
	v_mov_b32_e32 v21, v25
	v_mov_b32_e32 v14, v25
	v_dual_mov_b32 v16, v25 :: v_dual_mov_b32 v133, v128
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v143, s79, v93
	v_or_b32_e32 v144, s79, v92
	...
	v_cmp_le_i32_e64 s1, v154, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s4, v155, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s6, v155, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s5, v156, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s7, v156, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s8, v157, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s10, v157, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s65, v181, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s66, v181, v121
	.loc	1 823 32                        ; attention.py:823:32
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 819 31                        ; attention.py:819:31
	...
	v_or_b32_e32 v158, s92, v92
	v_or_b32_e32 v159, s92, v93
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s39, v150, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s40, v151, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s44, v151, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s43, v152, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s48, v152, v121
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s54, v153, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v158, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s11, v158, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s12, v159, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s14, v159, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s29, v165, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s33, v165, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s31, v166, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s34, v166, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s35, v167, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s36, v167, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s19, v168, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v168, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s23, v169, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s27, v169, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s26, v170, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v170, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s38, v171, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s42, v171, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s41, v172, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s45, v172, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s46, v173, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s51, v173, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s50, v174, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s55, v174, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s56, v175, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s60, v175, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s59, v176, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s63, v176, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s47, v177, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s53, v177, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s52, v178, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s57, v178, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s58, v179, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s62, v179, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s61, v180, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s64, v180, v121
	.loc	1 890 30                        ; attention.py:890:30
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s15, v160, v121
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s20, v162, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s21, v163, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s25, v163, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s24, v164, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s28, v164, v121
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v161, v120
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s18, v161, v121
	.loc	1 867 21 is_stmt 0              ; attention.py:867:21
	s_and_b32 s37, s40, s44
	s_and_b32 s40, s43, s48
	s_and_b32 s43, s49, s54
	s_and_b32 s44, s17, s20
	s_and_b32 s20, s21, s25
	s_and_b32 s21, s24, s28
	s_and_b32 s24, s29, s33
	s_and_b32 s49, s31, s34
	s_and_b32 s34, s46, s51
	s_and_b32 s31, s56, s60
	s_and_b32 s33, s59, s63
	s_and_b32 s48, s0, s1
...
.LBB0_7:                                ; %._crit_edge
	...
	v_cmp_gt_i32_e32 vcc_lo, s67, v94
	.loc	1 1051 17                       ; attention.py:1051:17
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 197
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 98
