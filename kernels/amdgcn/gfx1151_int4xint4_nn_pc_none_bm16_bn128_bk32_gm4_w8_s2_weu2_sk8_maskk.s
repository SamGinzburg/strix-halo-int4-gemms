...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u8 v33, v23, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	buffer_load_b64 v[23:24], v24, s[12:15], 0 offen
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	ds_load_u8 v29, v20 offset:640
	ds_load_u8 v30, v20 offset:896
	ds_load_u8 v31, v20 offset:768
...
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	v_dual_mul_f32 v19, v9, v19 :: v_dual_lshlrev_b32 v16, 16, v16
	...
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_add3_u32 v1, s0, v12, v2
	.loc	1 129 14                        ; generate_amdgcn.py:129:14
	v_lshlrev_b32_e32 v15, 16, v15
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v13, v16, v13 :: v_dual_mul_f32 v18, v9, v18
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v15, v15, v23 :: v_dual_mul_f32 v20, v9, v20
	.loc	1 130 16 is_stmt 0              ; generate_amdgcn.py:130:16
	...
	v_dual_mul_f32 v7, v20, v7 :: v_dual_mul_f32 v8, v9, v8
