...
.Ltmp11:
	...
	v_mul_lo_u32 v2, s27, v76
	.loc	1 92 28                         ; generate_amdgcn.py:92:28
	s_sub_i32 s2, s2, s12
	.loc	1 115 30                        ; generate_amdgcn.py:115:30
	v_mul_lo_u32 v3, s27, v79
	...
	buffer_load_b64 v[83:84], v4, s[20:23], 0 offen
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_bfe_i32 v2, v0, 6, 1
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_clause 0x1
	buffer_load_b64 v[101:102], v72, s[20:23], 0 offen offset:16
	buffer_load_b64 v[103:104], v73, s[20:23], 0 offen offset:16
...
; %bb.2:                                ; %.peel.next
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mad_u64_u32 v[81:82], null, s27, v79, s[2:3]
	v_mad_u64_u32 v[76:77], null, s27, v77, s[2:3]
	v_mad_u64_u32 v[82:83], null, s27, v83, s[2:3]
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_clause 0x1
	buffer_load_b64 v[103:104], v76, s[20:23], 0 offen
	buffer_load_b64 v[105:106], v77, s[20:23], 0 offen
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
...
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v108, v11, v70 :: v_dual_mul_f32 v93, v12, v67
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_lshrrev_b32_e32 v0, 1, v0
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v94, v13, v67 :: v_dual_lshlrev_b32 v71, 16, v72
	v_mul_f32_e32 v72, v9, v67
	v_mul_f32_e32 v98, v9, v68
	.loc	1 190 18                        ; generate_amdgcn.py:190:18
	v_add3_u32 v3, s24, s3, v0
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_mul_f32_e32 v106, v9, v70
	v_mul_f32_e32 v9, v9, v71
	v_mul_f32_e32 v99, v10, v68
	v_dual_mul_f32 v103, v14, v68 :: v_dual_mul_f32 v110, v13, v70
	.loc	1 190 18                        ; generate_amdgcn.py:190:18
	v_mad_u64_u32 v[0:1], null, s25, 48, v[2:3]
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_dual_mul_f32 v104, v15, v68 :: v_dual_add_nc_u32 v1, 0x100, v3
	v_mul_f32_e32 v111, v14, v70
	v_mul_f32_e32 v91, v10, v67
	v_mul_f32_e32 v92, v11, v67
	v_mul_f32_e32 v95, v14, v67
	v_dual_mul_f32 v96, v15, v67 :: v_dual_mul_f32 v101, v12, v68
	v_mul_f32_e32 v97, v16, v67
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v114, v17, v67 :: v_dual_mul_f32 v125, v20, v70
	v_dual_mul_f32 v115, v18, v67 :: v_dual_mul_f32 v124, v19, v70
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v116, v19, v67 :: v_dual_mul_f32 v129, v21, v68
	v_dual_mul_f32 v117, v20, v67 :: v_dual_mul_f32 v130, v22, v68
	v_mul_f32_e32 v126, v21, v67
	v_dual_mul_f32 v127, v22, v67 :: v_dual_mul_f32 v134, v23, v70
	v_mul_f32_e32 v128, v23, v67
	v_dual_mul_f32 v67, v24, v67 :: v_dual_mul_f32 v100, v11, v68
	v_dual_mul_f32 v107, v10, v70 :: v_dual_mul_f32 v102, v13, v68
	v_mul_f32_e32 v109, v12, v70
	v_dual_mul_f32 v105, v16, v68 :: v_dual_mul_f32 v112, v15, v70
	v_dual_mul_f32 v113, v16, v70 :: v_dual_mul_f32 v10, v10, v71
	v_dual_mul_f32 v11, v11, v71 :: v_dual_mul_f32 v118, v17, v68
	v_dual_mul_f32 v12, v12, v71 :: v_dual_mul_f32 v119, v18, v68
	v_dual_mul_f32 v13, v13, v71 :: v_dual_mul_f32 v120, v19, v68
	v_dual_mul_f32 v14, v14, v71 :: v_dual_mul_f32 v121, v20, v68
	v_dual_mul_f32 v15, v15, v71 :: v_dual_mul_f32 v122, v17, v70
	v_dual_mul_f32 v16, v16, v71 :: v_dual_mul_f32 v123, v18, v70
	v_mul_f32_e32 v17, v17, v71
	v_dual_mul_f32 v18, v18, v71 :: v_dual_mul_f32 v131, v23, v68
	v_dual_mul_f32 v19, v19, v71 :: v_dual_mul_f32 v132, v21, v70
	v_dual_mul_f32 v20, v20, v71 :: v_dual_mul_f32 v133, v22, v70
	v_mul_f32_e32 v68, v24, v68
	v_dual_mul_f32 v70, v24, v70 :: v_dual_mul_f32 v21, v21, v71
	v_dual_mul_f32 v22, v22, v71 :: v_dual_mul_f32 v53, v129, v53
	v_mul_f32_e32 v23, v23, v71
	v_dual_mul_f32 v24, v24, v71 :: v_dual_mul_f32 v33, v114, v33
	.loc	1 130 9 is_stmt 0               ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v71, v72, v73 :: v_dual_mul_f32 v46, v103, v46
	v_dual_mul_f32 v47, v104, v47 :: v_dual_mul_f32 v72, v91, v74
	v_dual_mul_f32 v40, v67, v40 :: v_dual_mul_f32 v41, v98, v41
	v_dual_mul_f32 v73, v92, v75 :: v_dual_mul_f32 v34, v115, v34
	v_dual_mul_f32 v35, v116, v35 :: v_dual_mul_f32 v36, v117, v36
	v_dual_mul_f32 v37, v126, v37 :: v_dual_mul_f32 v48, v105, v48
	v_dual_mul_f32 v49, v118, v49 :: v_dual_mul_f32 v50, v119, v50
	v_dual_mul_f32 v51, v120, v51 :: v_dual_mul_f32 v62, v111, v62
	...
	v_dual_mul_f32 v12, v12, v82 :: v_dual_mul_f32 v15, v15, v85
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_bfe_u32 v85, v40, 16, 1
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v74, v93, v76 :: v_dual_mul_f32 v75, v94, v77
	v_dual_mul_f32 v76, v95, v78 :: v_dual_mul_f32 v77, v96, v79
	v_mul_f32_e32 v78, v97, v80
	v_dual_mul_f32 v58, v107, v58 :: v_dual_mul_f32 v61, v110, v61
	v_dual_mul_f32 v60, v109, v60 :: v_dual_mul_f32 v63, v112, v63
	v_dual_mul_f32 v30, v133, v30 :: v_dual_mul_f32 v11, v11, v81
	v_dual_mul_f32 v32, v70, v32 :: v_dual_mul_f32 v9, v9, v65
	v_dual_mul_f32 v16, v16, v86 :: v_dual_mul_f32 v19, v19, v89
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v64, v113, v64 :: v_dual_mul_f32 v27, v124, v27
	v_dual_mul_f32 v20, v20, v90 :: v_dual_mul_f32 v7, v23, v7
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v42, v99, v42 :: v_dual_mul_f32 v43, v100, v43
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_cmp_o_f32_e64 s12, v37, v37
	v_add3_u32 v37, v37, v82, 0x7fff
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v26, v123, v26 :: v_dual_mul_f32 v29, v132, v29
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v14, v14, v84 :: v_dual_mul_f32 v17, v17, v87
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_bfe_u32 v87, v42, 16, 1
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v28, v125, v28 :: v_dual_mul_f32 v31, v134, v31
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v10, v10, v66 :: v_dual_mul_f32 v13, v13, v83
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v18, v18, v88 :: v_dual_mul_f32 v21, v21, v69
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v38, v127, v38 :: v_dual_mul_f32 v39, v128, v39
	v_dual_mul_f32 v44, v101, v44 :: v_dual_mul_f32 v45, v102, v45
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v56, v68, v56 :: v_dual_mul_f32 v57, v106, v57
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v52, v121, v52 :: v_dual_mul_f32 v55, v131, v55
	v_dual_mul_f32 v54, v130, v54 :: v_dual_mul_f32 v59, v108, v59
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn512_bk32_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 135
