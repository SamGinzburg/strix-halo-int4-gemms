	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp27:
	...
	v_dual_max_f32 v16, v16, v16 :: v_dual_mul_f32 v69, v69, v2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v187, v70, v83 :: v_dual_lshlrev_b32 v82, 16, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v159, v72, v85 :: v_dual_mul_f32 v182, v65, v83
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v176, v74, v82 :: v_dual_max_f32 v17, v17, v17
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v168, v66, v82 :: v_dual_max_f32 v13, v13, v13
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v167, v65, v82 :: v_dual_max_f32 v32, v32, v32
	v_mul_f32_e32 v179, v77, v82
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v108, v170, v108, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v170, v68, v82 :: v_dual_max_f32 v15, v15, v15
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v36, v142, v36, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v177, v75, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v40, v182, v40, v119
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v24, v24, v24 :: v_dual_mul_f32 v169, v67, v82
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v36, v36, v36 :: v_dual_mul_f32 v181, v79, v82
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v172, v70, v82 :: v_dual_max_f32 v13, 0, v13
	v_dual_mul_f32 v82, v80, v82 :: v_dual_max_f32 v17, 0, v17
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v37, v180, v37, v141
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v35, v151, v35, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v36, 0, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v38, v181, v38, v140
	...
	v_cndmask_b32_e64 v38, v140, v38, s2
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v40, v41, v41 :: v_dual_max_f32 v41, 0, v35
	v_dual_max_f32 v80, 0, v43 :: v_dual_max_f32 v35, v42, v42
	v_max_f32_e32 v78, 0, v39
	v_dual_max_f32 v42, v45, v45 :: v_dual_max_f32 v45, 0, v38
	v_dual_max_f32 v38, v48, v48 :: v_dual_max_f32 v39, v49, v49
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_dual_max_f32 v40, 0, v40 :: v_dual_max_f32 v37, 0, v37
	v_max_f32_e32 v44, 0, v35
	v_dual_max_f32 v35, v47, v47 :: v_dual_max_f32 v82, 0, v38
	v_dual_max_f32 v83, 0, v39 :: v_dual_max_f32 v38, v53, v53
	...
	v_dual_max_f32 v42, v50, v50 :: v_dual_max_f32 v43, v51, v51
	v_dual_max_f32 v39, v59, v59 :: v_dual_max_f32 v4, v4, v4
	v_max_f32_e32 v87, 0, v38
	v_max_f32_e32 v38, v58, v58
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v25, v143, v25, s2
	...
	v_dual_max_f32 v14, v14, v14 :: v_dual_max_f32 v23, v23, v23
	...
	v_dual_max_f32 v91, 0, v38 :: v_dual_max_f32 v8, v8, v8
	v_max_f32_e32 v38, v63, v63
	v_max_f32_e32 v85, 0, v43
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_max_f32 v43, v56, v56 :: v_dual_max_f32 v58, 0, v35
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_max_f32 v22, 0, v22 :: v_dual_max_f32 v31, v31, v31
	v_dual_max_f32 v23, 0, v23 :: v_dual_max_f32 v18, 0, v18
	v_dual_max_f32 v25, 0, v25 :: v_dual_max_f32 v30, v30, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_dual_max_f32 v29, 0, v29 :: v_dual_max_f32 v90, 0, v43
	v_dual_max_f32 v43, v61, v61 :: v_dual_max_f32 v6, v6, v6
	v_dual_max_f32 v89, 0, v42 :: v_dual_max_f32 v42, v60, v60
	v_dual_max_f32 v92, 0, v39 :: v_dual_max_f32 v35, v62, v62
	v_dual_max_f32 v8, 0, v8 :: v_dual_max_f32 v1, v1, v1
	v_dual_max_f32 v6, 0, v6 :: v_dual_max_f32 v39, v64, v64
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v98, v65, v65 :: v_dual_max_f32 v3, v3, v3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v26, 0, v26 :: v_dual_max_f32 v27, 0, v27
	v_dual_max_f32 v30, 0, v30 :: v_dual_max_f32 v31, 0, v31
	v_dual_max_f32 v93, 0, v42 :: v_dual_max_f32 v4, 0, v4
	v_max_f32_e32 v94, 0, v43
	v_dual_max_f32 v95, 0, v35 :: v_dual_mul_f32 v42, v12, v12
	v_dual_max_f32 v96, 0, v38 :: v_dual_max_f32 v1, 0, v1
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v46, v14, v14 :: v_dual_max_f32 v97, 0, v39
	v_dual_mul_f32 v50, v16, v16 :: v_dual_max_f32 v5, v5, v5
	v_mul_f32_e32 v64, v23, v23
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v7, v7, v7 :: v_dual_mul_f32 v60, v21, v21
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v35, v9, v9 :: v_dual_mul_f32 v74, v28, v28
	v_dual_mul_f32 v38, v10, v10 :: v_dual_max_f32 v3, 0, v3
	v_dual_mul_f32 v54, v18, v18 :: v_dual_mul_f32 v39, v11, v11
	v_mul_f32_e32 v66, v33, v33
	v_dual_mul_f32 v43, v13, v13 :: v_dual_mul_f32 v70, v31, v31
	v_dual_mul_f32 v51, v17, v17 :: v_dual_mul_f32 v62, v75, v75
	v_dual_mul_f32 v55, v19, v19 :: v_dual_mul_f32 v52, v76, v76
	v_dual_mul_f32 v59, v20, v20 :: v_dual_mul_f32 v48, v77, v77
	v_dual_mul_f32 v63, v22, v22 :: v_dual_mul_f32 v44, v44, v44
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v5, 0, v5 :: v_dual_mul_f32 v72, v27, v27
	v_dual_max_f32 v7, 0, v7 :: v_dual_mul_f32 v68, v25, v25
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v47, v15, v15 :: v_dual_mul_f32 v56, v36, v36
	v_mul_f32_e32 v67, v24, v24
	v_mul_f32_e32 v73, v29, v29
	v_mul_f32_e32 v61, v34, v34
	v_dual_mul_f32 v57, v41, v41 :: v_dual_mul_f32 v24, v90, v90
	v_dual_mul_f32 v53, v37, v37 :: v_dual_mul_f32 v22, v58, v58
	v_dual_mul_f32 v37, v81, v81 :: v_dual_mul_f32 v14, v3, v3
...
.Ltmp29:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v71, v26, v26 :: v_dual_mul_f32 v36, v80, v80
	v_dual_mul_f32 v69, v30, v30 :: v_dual_mul_f32 v30, v85, v85
	v_dual_mul_f32 v65, v32, v32 :: v_dual_mul_f32 v28, v86, v86
	v_dual_mul_f32 v49, v40, v40 :: v_dual_mul_f32 v20, v93, v93
	v_dual_mul_f32 v45, v45, v45 :: v_dual_mul_f32 v16, v96, v96
	v_dual_mul_f32 v40, v78, v78 :: v_dual_mul_f32 v41, v79, v79
	v_mul_f32_e32 v18, v97, v97
	v_dual_mul_f32 v32, v83, v83 :: v_dual_mul_f32 v29, v84, v84
	v_dual_mul_f32 v27, v87, v87 :: v_dual_max_f32 v34, v48, v49
	v_dual_mul_f32 v25, v88, v88 :: v_dual_mul_f32 v26, v89, v89
...
.Ltmp31:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v33, v82, v82 :: v_dual_mul_f32 v10, v5, v5
.Ltmp32:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp54:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v34, v75, v75 :: v_dual_mov_b32 v5, v76
	v_dual_max_f32 v58, v76, v76 :: v_dual_mov_b32 v31, v77
...
.Ltmp57:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v76, v3 :: v_dual_max_f32 v31, v34, v31
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.Ltmp67:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
	v_dual_mov_b32 v58, v31 :: v_dual_lshlrev_b32 v1, 5, v1
...
.Ltmp84:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 72
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 72
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
