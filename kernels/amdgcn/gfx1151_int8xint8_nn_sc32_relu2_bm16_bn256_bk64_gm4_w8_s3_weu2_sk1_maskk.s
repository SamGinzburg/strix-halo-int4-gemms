...
.Ltmp21:
	...
	v_dual_mov_b32 v43, 0 :: v_dual_and_b32 v6, 0x110, v6
	v_lshrrev_b32_e32 v16, 6, v0
	v_dual_mov_b32 v41, 0 :: v_dual_lshlrev_b32 v18, 1, v10
	s_waitcnt lgkmcnt(0)
...
.Ltmp23:
	...
	v_add3_u32 v31, v16, v18, v8
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v5, 0x17e, v3
	v_xor_b32_e32 v24, 16, v4
	v_xor_b32_e32 v26, 16, v6
	v_dual_mov_b32 v33, 0 :: v_dual_and_b32 v28, 28, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v5, v7, v5
	v_xor_b32_e32 v7, 0x90, v20
	v_add3_u32 v30, v9, v19, v8
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_add_nc_u32_e32 v23, 0, v22
	v_add_nc_u32_e32 v27, 0, v24
	v_add_nc_u32_e32 v36, 0, v26
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_dual_mov_b32 v4, s7 :: v_dual_mov_b32 v5, s8
	v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v7, s10
	v_dual_mov_b32 v8, s11 :: v_dual_add_nc_u32 v37, v30, v28
	v_add_nc_u32_e32 v38, v31, v28
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v48, s6, v14
	.loc	1 368 21                        ; generate_amdgcn.py:368:21
	v_or_b32_e32 v45, s5, v12
	...
	v_add_lshl_u32 v60, v15, s0, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v61, v17, s6, 1
	...
	ds_store_b16 v19, v68 offset:16384
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_store_b16 v20, v44
	ds_store_b16_d16_hi v20, v44 offset:32
	ds_store_b16 v20, v45 offset:64
	ds_store_b16_d16_hi v20, v45 offset:96
	...
	ds_store_b16 v23, v48
	ds_store_b16_d16_hi v23, v48 offset:32
	ds_store_b16 v23, v49 offset:64
	ds_store_b16_d16_hi v23, v49 offset:96
	ds_store_b16 v20, v50 offset:384
	ds_store_b16_d16_hi v20, v50 offset:416
	ds_store_b16 v20, v51 offset:448
	ds_store_b16_d16_hi v20, v51 offset:480
	...
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	s_waitcnt vmcnt(0)
	ds_store_b16 v19, v69 offset:16896
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_store_b16 v20, v44 offset:8192
	ds_store_b16_d16_hi v20, v44 offset:8224
	ds_store_b16 v20, v45 offset:8256
	ds_store_b16_d16_hi v20, v45 offset:8288
	...
	ds_store_b16 v23, v48 offset:8192
	ds_store_b16_d16_hi v23, v48 offset:8224
	ds_store_b16 v23, v49 offset:8256
	ds_store_b16_d16_hi v23, v49 offset:8288
	ds_store_b16 v20, v50 offset:8576
	ds_store_b16_d16_hi v20, v50 offset:8608
	ds_store_b16 v20, v51 offset:8640
	ds_store_b16_d16_hi v20, v51 offset:8672
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	v_add_lshl_u32 v45, v15, s0, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v46, v17, s5, 1
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	ds_load_b128 v[60:63], v25 offset:16384
	ds_load_b128 v[64:67], v27 offset:16384
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[52:55], v29
	ds_load_b128 v[68:71], v29 offset:4096
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(1)
	ds_store_b16 v37, v44 offset:17408
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v81, v46, s[12:15], 0 offen
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	...
	v_cvt_f32_i32_e32 v94, v55
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	ds_load_b128 v[44:47], v16 offset:17408
	ds_load_b128 v[48:51], v16 offset:17424
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	ds_load_b128 v[60:63], v25 offset:16896
	ds_load_b128 v[64:67], v27 offset:16896
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[52:55], v29 offset:8192
	ds_load_b128 v[68:71], v29 offset:12288
	ds_load_b128 v[72:75], v36 offset:8192
	ds_load_b128 v[76:79], v36 offset:12288
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v88, v88, v80 :: v_dual_and_b32 v107, 0xffff0000, v45
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	v_dual_fmac_f32 v39, v88, v103 :: v_dual_mul_f32 v86, v86, v80
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v89, v89, v80
	v_mul_f32_e32 v90, v90, v80
	v_mul_f32_e32 v84, v84, v80
	v_mul_f32_e32 v87, v87, v80
	v_mul_f32_e32 v91, v91, v80
	v_mul_f32_e32 v92, v92, v80
	v_dual_mul_f32 v93, v93, v80 :: v_dual_and_b32 v112, 0xffff0000, v50
	v_mul_f32_e32 v94, v94, v80
	v_dual_mul_f32 v96, v57, v80 :: v_dual_and_b32 v113, 0xffff0000, v51
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	v_and_b32_e32 v106, 0xffff0000, v44
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v41, v86, v101 :: v_dual_lshlrev_b32 v98, 16, v44
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_lshlrev_b32_e32 v102, 16, v48
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v35, v89, v104 :: v_dual_fmac_f32 v34, v90, v105
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_and_b32_e32 v110, 0xffff0000, v48
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_wmma_i32_16x16x16_iu8 v[44:51], v[52:55], v[60:63], v[1:8] neg_lo:[1,1,0]
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v83, v83, v80
	v_mul_f32_e32 v85, v85, v80
	v_mul_f32_e32 v95, v56, v80
	v_dual_mul_f32 v97, v58, v80 :: v_dual_fmac_f32 v32, v92, v107
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v43, v84, v99 :: v_dual_mul_f32 v80, v59, v80
	.loc	1 379 23 is_stmt 1              ; generate_amdgcn.py:379:23
	v_wmma_i32_16x16x16_iu8 v[52:59], v[68:71], v[60:63], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[44:51], v[72:75], v[64:67], v[44:51] neg_lo:[1,1,0]
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v42, v85, v100
	v_dual_fmac_f32 v31, v93, v108 :: v_dual_fmac_f32 v30, v94, v109
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_lshlrev_b32_e32 v44, 16, v81
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v26, v96, v111 :: v_dual_mul_f32 v63, v63, v76
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v67, v67, v76
	ds_store_b32 v38, v44 offset:17408
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[44:47], v16 offset:17408
	ds_load_b128 v[48:51], v16 offset:17424
	ds_load_b128 v[52:55], v16 offset:17920
	ds_load_b128 v[56:59], v16 offset:17936
	v_mul_f32_e32 v66, v66, v76
	v_mul_f32_e32 v61, v61, v76
	v_mul_f32_e32 v65, v65, v76
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v68, v68, v76 :: v_dual_fmac_f32 v41, v63, v47
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v40, v87, v102
	s_waitcnt lgkmcnt(2)
	v_fmac_f32_e32 v35, v66, v50
	v_dual_fmac_f32 v28, v95, v110 :: v_dual_fmac_f32 v43, v61, v45
	v_fmac_f32_e32 v22, v80, v113
	v_fmac_f32_e32 v39, v65, v49
	v_fmac_f32_e32 v33, v91, v106
	v_fmac_f32_e32 v18, v83, v98
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_fmac_f32 v34, v67, v51 :: v_dual_fmac_f32 v33, v68, v52
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v24, v97, v112
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v72, v72, v76
	v_mul_f32_e32 v73, v73, v76
	v_mul_f32_e32 v74, v74, v76
	v_dual_mul_f32 v75, v75, v76 :: v_dual_fmac_f32 v42, v62, v46
	v_dual_mul_f32 v71, v71, v76 :: v_dual_fmac_f32 v32, v69, v53
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v18, v60, v44
	v_dual_fmac_f32 v40, v64, v48 :: v_dual_fmac_f32 v31, v70, v54
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v30, v71, v55
	s_waitcnt lgkmcnt(0)
	v_fmac_f32_e32 v28, v72, v56
	v_fmac_f32_e32 v26, v73, v57
	v_fmac_f32_e32 v24, v74, v58
	v_fmac_f32_e32 v22, v75, v59
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_2
; %bb.3:                                ; %._crit_edge.loopexit
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v1, v18, v18 :: v_dual_max_f32 v2, v43, v43
	v_dual_max_f32 v7, v35, v35 :: v_dual_max_f32 v8, v34, v34
	v_dual_max_f32 v9, v33, v33 :: v_dual_max_f32 v12, v32, v32
	...
	v_dual_max_f32 v12, v28, v28 :: v_dual_max_f32 v21, 0, v13
	v_dual_max_f32 v14, v24, v24 :: v_dual_max_f32 v13, v26, v26
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v23, 0, v12 :: v_dual_max_f32 v26, 0, v15
	v_max_f32_e32 v24, 0, v13
	v_dual_max_f32 v22, 0, v9 :: v_dual_max_f32 v25, 0, v14
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 114
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 31
