	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8,@function
amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8:                                 ; @amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
.Lfunc_begin0:
...
; %bb.8:                                ; %.lr.ph
	...
	v_dual_mov_b32 v86, 0xff800000 :: v_dual_and_b32 v7, 16, v0
	s_add_i32 s51, s6, s20
	s_load_b32 s20, s[0:1], 0x7c
	.loc	1 573 27                        ; attention.py:573:27
	v_add_nc_u32_e32 v60, s11, v5
	s_delay_alu instid0(VALU_DEP_2)
	v_cmp_eq_u32_e32 vcc_lo, 0, v7
	.loc	1 771 51                        ; attention.py:771:51
	v_lshrrev_b32_e32 v58, 6, v44
	s_clause 0x1
	...
	s_mul_i32 s21, s51, s23
	.loc	1 773 30                        ; attention.py:773:30
	s_mul_i32 s50, s51, s49
	...
	s_mul_i32 s5, s8, s29
	.loc	1 570 31                        ; attention.py:570:31
	v_bfe_u32 v59, v0, 4, 1
	v_mov_b16_e32 v62.l, 0
	v_mul_lo_u32 v1, s20, v46
	.loc	1 742 27                        ; attention.py:742:27
	s_mul_f32 s48, s28, 0x3fb8aa3b
	...
	s_and_b32 s13, s13, 0xffff
	s_add_i32 s52, s5, s24
	.loc	1 707 13                        ; attention.py:707:13
	v_mad_u64_u32 v[38:39], null, s31, v4, v[1:2]
	v_mad_u64_u32 v[39:40], null, s31, v3, v[1:2]
	v_dual_mov_b32 v1, 0x5410 :: v_dual_and_b32 v8, 1, v0
	v_mad_u64_u32 v[40:41], null, s45, v58, v[27:28]
	v_subrev_nc_u32_e32 v63, s9, v60
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v1, 0x1054, v1 :: v_dual_lshlrev_b32 v12, 6, v8
	v_lshlrev_b32_e32 v8, 5, v8
	s_and_b32 s39, s39, 0xffff
	s_xor_b32 s22, s7, -1
	v_lshl_or_b32 v1, v1, 8, v1
	s_add_i32 s52, s52, s25
	s_lshl_b32 s53, s45, 1
	...
	s_mov_b32 s42, s26
	s_mov_b32 s43, s27
	v_xor_b32_e32 v2, v2, v57
	v_mov_b32_e32 v7, 0x7632
	v_dual_mov_b32 v85, 0xff800000 :: v_dual_mov_b32 v84, 0xff800000
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_or_b32_e32 v2, v2, v12
	v_dual_cndmask_b32 v7, 0x3276, v7 :: v_dual_add_nc_u32 v80, 0, v2
	v_mov_b32_e32 v2, v1
	v_or3_b32 v67, v42, v12, v9
	v_mov_b32_e32 v9, 0
	.loc	1 573 27                        ; attention.py:573:27
	v_add_nc_u32_e32 v61, s11, v6
	v_bfe_i32 v6, v0, 3, 1
	v_and_b32_e32 v11, 14, v0
	v_lshl_or_b32 v7, v7, 8, v7
	v_mov_b32_e32 v16, v9
	v_xor_b32_e32 v3, 0x84, v67
	v_and_b32_e32 v6, 0x84, v6
	v_dual_mov_b32 v14, v9 :: v_dual_add_nc_u32 v65, s10, v60
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v12, v9 :: v_dual_add_nc_u32 v71, 0, v3
	v_and_or_b32 v6, v10, 3, v6
	v_mul_u32_u24_e32 v10, 0x42, v11
	v_mov_b32_e32 v11, v9
	v_add_nc_u32_e32 v82, v5, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_or3_b32 v68, v6, v8, v13
	v_xor_b32_e32 v4, 4, v68
	s_delay_alu instid0(VALU_DEP_1)
	v_add_nc_u32_e32 v72, 0, v4
	v_mov_b32_e32 v4, v1
	v_add3_u32 v69, v10, v8, v13
	v_mov_b32_e32 v10, v9
	v_add_nc_u32_e32 v66, s10, v61
	v_and_b32_e32 v7, 0x760076, v7
	v_subrev_nc_u32_e32 v64, s9, v61
	...
	v_dual_mov_b32 v15, v9 :: v_dual_add_nc_u32 v74, 0, v8
	v_and_b32_e32 v70, 0x7060706, v7
	v_lshlrev_b32_e32 v7, 1, v27
	v_add_nc_u32_e32 v75, 0, v17
	v_add_nc_u32_e32 v76, 0, v18
	v_add_nc_u32_e32 v77, 0, v19
	v_dual_mov_b32 v3, v1 :: v_dual_add_nc_u32 v78, 0, v20
	v_add_nc_u32_e32 v79, 0, v21
	v_add_nc_u32_e32 v81, v22, v7
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v8, v1
...
.LBB0_9:                                ;   in Loop: Header=BB0_10 Depth=1
	...
	v_dual_mul_f32 v18, v62, v18 :: v_dual_mul_f32 v25, v87, v95
	...
	s_delay_alu instid0(VALU_DEP_2)
	v_mul_f32_e32 v87, v18, v93
	.loc	1 759 25                        ; attention.py:759:25
	v_cndmask_b32_e64 v17, 0, 1, vcc_lo
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v93, v19, v94 :: v_dual_add_nc_u32 v20, 0, v68
	.loc	1 759 25                        ; attention.py:759:25
	v_add_nc_u32_e32 v19, 0, v67
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v21, v62, v21 :: v_dual_mul_f32 v24, v24, v88
	.loc	1 759 25                        ; attention.py:759:25
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v23, v62, v23 :: v_dual_mul_f32 v88, s48, v93
	.loc	1 771 36                        ; attention.py:771:36
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v22, v22, v90 :: v_dual_add_nc_u32 v17, 0, v69
	...
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v22, s48, v22 :: v_dual_mul_f32 v87, s48, v87
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v21, v21, v91 :: v_dual_add_nc_u32 v18, s13, v58
	.loc	1 759 25                        ; attention.py:759:25
	v_and_b16 v19.l, 1, v19.l
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v23, s48, v23 :: v_dual_add_nc_u32 v90, s55, v17
	.loc	1 759 25                        ; attention.py:759:25
	...
	v_cmp_gt_i32_e64 s13, s49, v18
	.loc	1 798 53                        ; attention.py:798:53
	s_lshr_b32 s14, s14, 28
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v89, s48, v92
	v_dual_mul_f32 v21, s48, v21 :: v_dual_max_f32 v96, v84, v84
	.loc	1 759 25                        ; attention.py:759:25
	...
	v_add_nc_u32_e32 v23, s53, v17
	v_cndmask_b32_e64 v20, 0xff800000, v24, s12
	v_add_nc_u32_e32 v24, s54, v17
	.loc	1 798 53                        ; attention.py:798:53
...
.Ltmp7:
	...
	v_permlanex16_b32 v105, v103, s56, 0xfedcba98 op_sel:[1,0]
.Ltmp8:
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp53:
	...
	v_permlanex16_b32 v22, v86, s56, 0xfedcba98 op_sel:[1,0]
	.loc	1 767 74                        ; attention.py:767:74
...
.Ltmp55:
	...
	v_permlanex16_b32 v23, v25, s56, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v100, v19, s56, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v102, v20, s56, 0xfedcba98 op_sel:[1,0]
...
.LBB0_10:                               ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_le_i32_e32 vcc_lo, v25, v60
	v_cmp_le_i32_e64 s6, v25, v61
	.loc	1 714 73                        ; attention.py:714:73
...
.Ltmp153:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_vgpr, 113
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.numbered_sgpr, 57
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8
    .private_segment_fixed_size: 0
    .sgpr_count:     59
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_runtime_float32_d64_dv64_shaperuntime_bm16_bn16_w4_s1_ds8.kd
