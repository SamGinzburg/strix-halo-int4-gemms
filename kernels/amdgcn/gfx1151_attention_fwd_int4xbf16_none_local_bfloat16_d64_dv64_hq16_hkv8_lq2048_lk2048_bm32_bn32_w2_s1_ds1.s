...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v6, 0x5410 :: v_dual_lshlrev_b32 v1, 1, v56
	s_mov_b32 s51, 0x31027000
	s_mov_b32 s50, 0x7ffffffe
	v_dual_mov_b32 v7, 0x7632 :: v_dual_and_b32 v2, 56, v0
	s_delay_alu instid0(VALU_DEP_2)
	...
	.loc	1 774 26                        ; attention.py:774:26
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v44, v38, v48, s5
	v_cndmask_b32_e64 v48, v48, v38, s5
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v5, 24, v36
	v_dual_mov_b32 v32, v25 :: v_dual_lshlrev_b32 v9, 3, v0
	v_mov_b32_e32 v27, v25
	v_xor_b32_e32 v38, v8, v2
	.loc	1 779 31                        ; attention.py:779:31
	s_and_b32 s49, s13, 0xffff
	s_mov_b32 s48, s12
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v45, v39, v49, s5
	.loc	1 779 31                        ; attention.py:779:31
	buffer_load_u16 v53, v1, s[48:51], 0 offen
	v_dual_mov_b32 v94, 0xff800000 :: v_dual_add_nc_u32 v1, s16, v37
	v_dual_mov_b32 v26, v25 :: v_dual_and_b32 v37, 7, v0
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v49, v49, v39, s5
	v_dual_mov_b32 v28, v25 :: v_dual_and_b32 v3, 0x3f0, v35
	v_bfe_i32 v10, v0, 3, 1
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v18, v25 :: v_dual_lshlrev_b32 v33, 3, v37
	.loc	1 759 31                        ; attention.py:759:31
	v_lshrrev_b32_e32 v35, 1, v2
	v_lshl_or_b32 v74, v34, 5, v5
	v_cndmask_b32_e64 v34, 0x1054, v6, s5
	v_cndmask_b32_e64 v36, 0x3276, v7, s5
	v_dual_mov_b32 v20, v25 :: v_dual_and_b32 v39, 48, v9
	v_lshl_or_b32 v75, v37, 9, v38
	...
	s_lshr_b32 s1, s1, 28
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v42, v40, v50, s5
	v_cndmask_b32_e64 v47, v47, v46, s5
	v_cndmask_b32_e64 v46, v50, v40, s5
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s1, s3, s1
	v_xor_b32_e32 v73, v3, v4
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v40, 0x210, v10
	.loc	1 892 65                        ; attention.py:892:65
	v_cmp_gt_i32_e32 vcc_lo, s46, v33
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[50:51], null, s46, v35, v[33:34]
	v_lshl_or_b32 v33, v34, 8, v34
	v_lshl_or_b32 v34, v36, 8, v36
	v_lshl_or_b32 v35, v37, 6, v39
	v_xor_b32_e32 v36, 0x90, v75
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v0, s6, v1
	.loc	1 756 22                        ; attention.py:756:22
	s_and_b32 s6, s1, 0xfff0
	v_dual_mov_b32 v17, v25 :: v_dual_and_b32 v34, 0x760076, v34
	s_sub_i32 s3, s3, s6
	v_dual_mov_b32 v22, v25 :: v_dual_and_b32 v33, 0x540054, v33
	v_mov_b32_e32 v9, v25
	v_dual_mov_b32 v12, v25 :: v_dual_add_nc_u32 v81, 0, v36
	v_xor_b32_e32 v54, 8, v73
	v_xor_b32_e32 v76, v35, v40
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v72, s7, v1
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v78, 0, v78
	v_dual_mov_b32 v21, v25 :: v_dual_add_nc_u32 v80, 0, v80
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v82, 0, v37
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v79, 0, v79
	v_dual_mov_b32 v11, v25 :: v_dual_add_nc_u32 v84, 0, v35
	v_dual_mov_b32 v14, v25 :: v_dual_add_nc_u32 v83, 0, v38
	v_dual_mov_b32 v15, v25 :: v_dual_add_nc_u32 v88, 0, v54
	v_dual_mov_b32 v16, v25 :: v_dual_and_b32 v51, 0x5040504, v33
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v90, 0, v90
	...
	s_mov_b32 s52, s14
	s_mov_b32 s56, s10
	s_add_i32 s65, s65, s1
	s_mov_b32 s48, s8
	s_mov_b32 s49, s9
	s_mov_b32 s53, s15
	v_mov_b32_e32 v54, v25
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v13, v25 :: v_dual_lshlrev_b32 v36, 16, v53
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 843 41                        ; attention.py:843:41
	v_dual_mul_f32 v86, s0, v36 :: v_dual_and_b32 v53, 0x7060706, v34
	v_dual_mov_b32 v3, v25 :: v_dual_mov_b32 v92, v86
	.loc	1 847 25                        ; attention.py:847:25
	v_mov_b32_e32 v91, v86
	v_mov_b32_e32 v93, v86
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 822 32                        ; attention.py:822:32
	s_add_i32 s0, s60, s65
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v33, s36 :: v_dual_add_nc_u32 v96, 0, v73
	.loc	1 822 32                        ; attention.py:822:32
	v_mad_u64_u32 v[112:113], null, s0, s47, v[41:42]
	v_mad_u64_u32 v[113:114], null, s0, s46, v[50:51]
	.loc	1 828 33                        ; attention.py:828:33
	v_dual_mov_b32 v34, s37 :: v_dual_add_nc_u32 v97, 0, v74
	...
	v_add_lshl_u32 v118, v113, s62, 1
	v_add_lshl_u32 v119, v113, s63, 1
	...
	v_or_b32_e32 v95, s65, v55
	v_or_b32_e32 v98, s65, v57
	v_or_b32_e32 v100, s65, v59
	v_or_b32_e32 v99, s65, v58
	v_or_b32_e32 v101, s65, v60
	v_or_b32_e32 v102, s65, v61
	v_or_b32_e32 v103, s65, v62
	v_or_b32_e32 v104, s65, v63
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v95, v95, s60, 1
	v_add_lshl_u32 v98, v98, s60, 1
	v_add_lshl_u32 v100, v100, s60, 1
	v_add_lshl_u32 v99, v99, s60, 1
	v_add_lshl_u32 v101, v101, s60, 1
	v_add_lshl_u32 v102, v102, s60, 1
	v_add_lshl_u32 v103, v103, s60, 1
	v_add_lshl_u32 v104, v104, s60, 1
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v71
	v_or_b32_e32 v105, s65, v64
	v_or_b32_e32 v106, s65, v65
	v_or_b32_e32 v107, s65, v66
	v_or_b32_e32 v108, s65, v67
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s0, v111, v0
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s1, v111, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v68
	v_or_b32_e32 v109, s65, v68
	v_or_b32_e32 v110, s65, v69
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v105, v105, s60, 1
	v_add_lshl_u32 v106, v106, s60, 1
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v111, v0
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s10, v111, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v65
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v107, v107, s60, 1
	v_add_lshl_u32 v108, v108, s60, 1
	v_add_lshl_u32 v109, v109, s60, 1
	v_add_lshl_u32 v110, v110, s60, 1
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s15, v111, v0
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s16, v111, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v62
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v111, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v59
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s0, s2, s0
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s28, v111, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v111, s60, v55
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s34, v111, v0
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s35, v111, v72
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s3, v33, v0
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s6, v33, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v33, s60, v67
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s12, v33, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v33, s60, v64
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s18, v33, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v33, s60, v61
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s24, v33, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v33, s60, v58
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s3, s2, s3
	...
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v114, s60, v69
	.loc	1 847 25                        ; attention.py:847:25
	v_mul_f32_e32 v124, v93, v124
	v_mul_f32_e32 v112, v92, v139
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s20, v114, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v114, s60, v60
	.loc	1 847 25                        ; attention.py:847:25
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s26, v114, v72
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v114, s60, v57
	.loc	1 867 21                        ; attention.py:867:21
	...
	s_barrier
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v136, 0xff800000, v109, s3
...
.Ltmp4:
	...
	v_permlanex16_b32 v37, v36, s64, 0xfedcba98 op_sel:[1,0]
.Ltmp5:
	...
	v_cmp_neq_f32_e64 s11, 0xff800000, v94
	.loc	1 896 30                        ; attention.py:896:30
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v109, v112, s64, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v111, v110, s64, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v108, v109, v112, v53
	v_permlanex16_b32 v112, v113, s64, 0xfedcba98 op_sel:[1,0]
	...
	.loc	1 886 62                        ; attention.py:886:62
	v_dual_sub_f32 v113, v120, v36 :: v_dual_and_b32 v94, 1, v134
	.loc	1 895 23                        ; attention.py:895:23
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v94.l, 0x7fff, v94.h, s12
	.loc	1 886 33                        ; attention.py:886:33
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v94.h, 0x7fff, v113.h, s11
	.loc	1 895 23                        ; attention.py:895:23
	...
	v_permlanex16_b32 v114, v94, s64, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_perm_b32 v113, v114, v94, v51
	v_perm_b32 v114, v114, v94, v53
	.loc	1 886 33                        ; attention.py:886:33
	...
	.loc	1 890 30                        ; attention.py:890:30
	ds_load_b128 v[98:101], v89
	ds_load_b128 v[94:97], v88
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 895 23                        ; attention.py:895:23
	v_dual_mul_f32 v5, v5, v143 :: v_dual_add_f32 v34, v135, v34
	.loc	1 896 23                        ; attention.py:896:23
	s_waitcnt lgkmcnt(1)
	...
	ds_load_b128 v[99:102], v90 offset:2048
	.loc	1 886 33                        ; attention.py:886:33
...
.Ltmp21:
	...
	v_permlanex16_b32 v37, v34, s64, 0xfedcba98 op_sel:[1,0]
.Ltmp22:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp23:
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_permlanex16_b32 v37, v35, s64, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v39, v36, s64, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_permlanex16_b32 v38, v111, s64, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_permlanex16_b32 v40, v112, s64, 0xfedcba98 op_sel:[1,0]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.num_vgpr, 146
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.numbered_sgpr, 66
