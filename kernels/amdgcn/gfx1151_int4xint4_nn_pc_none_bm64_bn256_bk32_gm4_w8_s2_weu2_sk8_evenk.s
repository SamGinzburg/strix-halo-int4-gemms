	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v5, v8 :: v_dual_and_b32 v50, 0x88, v50
	v_mov_b32_e32 v7, v8
	v_mov_b32_e32 v6, v8
...
.Ltmp11:
	...
	v_dual_mov_b32 v4, v8 :: v_dual_and_b32 v49, 0x37c, v49
	...
	.loc	1 93 13                         ; generate_amdgcn.py:93:13
	s_xor_b32 s23, s16, s21
	.loc	1 95 22                         ; generate_amdgcn.py:95:22
	s_add_i32 s16, s20, s18
	.loc	1 93 13                         ; generate_amdgcn.py:93:13
	s_sub_i32 s18, s23, s21
	.loc	1 95 22                         ; generate_amdgcn.py:95:22
	s_ashr_i32 s22, s16, 1
	.loc	1 92 28                         ; generate_amdgcn.py:92:28
	s_mul_i32 s15, s18, s15
	v_dual_mov_b32 v16, v8 :: v_dual_add_nc_u32 v71, 0, v49
	s_sub_i32 s2, s2, s15
	...
	.loc	1 105 9                         ; generate_amdgcn.py:105:9
	s_cmpk_lt_i32 s20, 0x102
	.loc	1 113 30                        ; generate_amdgcn.py:113:30
	v_mad_u64_u32 v[1:2], null, s22, v73, v[65:66]
	.loc	1 117 30                        ; generate_amdgcn.py:117:30
	...
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_add_nc_u32 v72, 0, v67
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	...
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v71, v79 offset:4096
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	s_waitcnt vmcnt(0)
...
; %bb.1:                                ; %.lr.ph
	v_add3_u32 v1, s2, v74, 0x80
	v_dual_mov_b32 v49, 0 :: v_dual_and_b32 v2, 0x70, v67
.Ltmp12:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:105:32 ]
	s_add_i32 s10, s22, 0x7f
...
.Ltmp13:
	...
	v_and_or_b32 v5, 0x88, v68, v2
	v_dual_mov_b32 v51, v49 :: v_dual_add_nc_u32 v2, s16, v73
	s_lshl_b32 s10, s23, 8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_readfirstlane_b32 s11, v4
	v_xor_b32_e32 v4, 8, v5
	v_add3_u32 v7, v1, s10, v66
	v_mad_u64_u32 v[1:2], null, s22, v2, s[2:3]
	v_dual_mov_b32 v50, v49 :: v_dual_add_nc_u32 v3, 0, v70
	...
	v_subrev_nc_u32_e32 v66, s10, v7
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v71, v104 offset:4096
	.loc	1 117 22                        ; generate_amdgcn.py:117:22
	s_waitcnt vmcnt(0)
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	v_dual_mul_f32 v45, v12, v17 :: v_dual_mul_f32 v114, v6, v18
	...
	v_dual_mul_f32 v148, v8, v21 :: v_dual_mul_f32 v5, v23, v50
	v_dual_mul_f32 v150, v10, v21 :: v_dual_mul_f32 v9, v25, v51
	v_mul_f32_e32 v151, v11, v21
	v_mul_f32_e32 v152, v12, v21
	v_mul_f32_e32 v153, v13, v21
	v_dual_mul_f32 v154, v14, v21 :: v_dual_mul_f32 v25, v33, v55
	v_dual_mul_f32 v155, v15, v21 :: v_dual_mul_f32 v18, v113, v79
	v_dual_mul_f32 v156, v16, v21 :: v_dual_mul_f32 v21, v30, v54
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_mul_f32_e32 v1, v22, v49
	...
	v_mul_f32_e32 v10, v111, v43
	v_dual_mul_f32 v11, v127, v27 :: v_dual_mul_f32 v16, v144, v97
	v_dual_mul_f32 v19, v129, v86 :: v_dual_mul_f32 v12, v143, v96
	v_mul_f32_e32 v13, v26, v52
	v_dual_mul_f32 v17, v29, v53 :: v_dual_mul_f32 v30, v116, v48
	v_mul_f32_e32 v22, v114, v46
	v_dual_mul_f32 v26, v115, v47 :: v_dual_mul_f32 v15, v128, v28
	v_dual_mul_f32 v47, v136, v20 :: v_dual_mul_f32 v52, v153, v106
	v_mul_f32_e32 v20, v145, v98
	v_dual_mul_f32 v6, v76, v42 :: v_dual_mul_f32 v23, v130, v87
	v_mul_f32_e32 v28, v147, v100
	v_mul_f32_e32 v27, v131, v31
	v_dual_mul_f32 v29, v34, v56 :: v_dual_mul_f32 v42, v119, v35
	v_dual_mul_f32 v37, v38, v58 :: v_dual_mul_f32 v34, v117, v80
	v_mul_f32_e32 v46, v120, v36
	...
	v_dual_mul_f32 v45, v45, v60 :: v_dual_mul_f32 v38, v118, v81
	...
	v_dual_mul_f32 v40, v150, v103 :: v_dual_mul_f32 v73, v156, v73
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 157
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 24
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     26
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.kd
