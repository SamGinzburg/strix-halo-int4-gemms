...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 717 33                        ; attention.py:717:33
	v_dual_mov_b32 v34, v32 :: v_dual_add_nc_u32 v125, 0, v69
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 711 32                        ; attention.py:711:32
	v_mad_u64_u32 v[134:135], null, v110, s27, v[50:51]
	.loc	1 717 33                        ; attention.py:717:33
	v_dual_mov_b32 v35, v32 :: v_dual_add_nc_u32 v110, 0, v79
	...
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s3, v117, v84
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s5, v117, v87
	...
	.loc	1 708 31                        ; attention.py:708:31
	v_or_b32_e32 v118, s33, v67
	v_or_b32_e32 v120, s33, v57
	v_or_b32_e32 v119, s33, v66
	...
	s_barrier
	.loc	1 708 31                        ; attention.py:708:31
	v_or_b32_e32 v122, s33, v62
	.loc	1 752 25                        ; attention.py:752:25
	s_add_i32 s10, s22, s33
	.loc	1 798 53                        ; attention.py:798:53
	s_lshr_b32 s11, s33, 4
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s6, v118, v82
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s7, v118, v85
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s8, v120, v64
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s9, v120, v63
	.loc	1 761 36                        ; attention.py:761:36
	v_add_lshl_u32 v120, s10, v100, 1
	.loc	1 798 25                        ; attention.py:798:25
	s_add_i32 s14, s11, s35
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s11, v119, v86
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s19, v121, v83
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s20, v121, v86
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s17, v122, v64
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s18, v122, v63
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s6, s6, s7
	s_and_b32 s9, s8, s9
	s_and_b32 s8, s4, s6
	.loc	1 708 31 is_stmt 1              ; attention.py:708:31
	v_or_b32_e32 v123, s33, v61
	.loc	1 774 30                        ; attention.py:774:30
	v_mad_u64_u32 v[117:118], null, v117, s26, v[41:42]
	.loc	1 708 31                        ; attention.py:708:31
	v_or_b32_e32 v124, s33, v59
	.loc	1 798 25                        ; attention.py:798:25
	s_mul_i32 s21, s14, s26
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 748 30                        ; attention.py:748:30
	v_cmp_ge_i32_e64 s15, v123, v82
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s16, v123, v85
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s3, s3, s5
	.loc	1 748 30 is_stmt 1              ; attention.py:748:30
	v_cmp_ge_i32_e64 s12, v124, v84
	.loc	1 749 30                        ; attention.py:749:30
	v_cmp_le_i32_e64 s14, v124, v87
	.loc	1 749 21 is_stmt 0              ; attention.py:749:21
	s_and_b32 s3, s4, s3
	s_and_b32 s5, s15, s16
	.loc	1 727 37 is_stmt 1              ; attention.py:727:37
	v_add_lshl_u32 v111, s33, v58, 1
	v_add_lshl_u32 v112, v70, s33, 1
	v_add_lshl_u32 v114, v71, s33, 1
	.loc	1 775 32                        ; attention.py:775:32
	v_cndmask_b32_e64 v123, 0x80000000, v117, s0
	.loc	1 727 37                        ; attention.py:727:37
	v_add_lshl_u32 v113, v74, s33, 1
	v_add_lshl_u32 v115, v75, s33, 1
	v_add_lshl_u32 v116, v76, s33, 1
	.loc	1 775 32                        ; attention.py:775:32
	...
	v_perm_b32 v131, v129, v118, v93
	v_perm_b32 v132, v129, v118, v94
	.loc	1 761 36                        ; attention.py:761:36
	...
	.loc	1 762 35                        ; attention.py:762:35
	v_perm_b32 v129, v130, v128, v93
	v_perm_b32 v124, v130, v128, v94
	.loc	1 763 25                        ; attention.py:763:25
	s_and_b32 s6, s6, s14
	s_and_b32 s5, s3, s5
	.loc	1 761 36                        ; attention.py:761:36
	...
	.loc	1 763 25                        ; attention.py:763:25
	v_perm_b32 v129, v118, v121, v95
	.loc	1 814 30                        ; attention.py:814:30
	v_mov_b16_e64 v131.l, v120.h
	.loc	1 763 25                        ; attention.py:763:25
	v_perm_b32 v118, v118, v121, v96
	.loc	1 814 30                        ; attention.py:814:30
	...
	v_dual_fmac_f32 v35, s53, v112 :: v_dual_and_b32 v112, 0xffff0000, v123
	.loc	1 814 30                        ; attention.py:814:30
	...
	.loc	1 762 25                        ; attention.py:762:25
	v_dual_fmac_f32 v136, s53, v115 :: v_dual_mul_f32 v137, 0x3fb8aa3b, v112
	.loc	1 761 36                        ; attention.py:761:36
	v_and_b32_e32 v112, 0xffff0000, v124
	.loc	1 814 30                        ; attention.py:814:30
	v_and_b32_e32 v115, 1, v131
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v137, s53, v39
	v_dual_fmac_f32 v134, s53, v38 :: v_dual_lshlrev_b32 v111, 16, v123
	...
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v111, s53, v37
	v_dual_fmac_f32 v38, s53, v113 :: v_dual_and_b32 v113, 1, v126
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 814 30                        ; attention.py:814:30
	...
	ds_store_2addr_b32 v91, v36, v34 offset1:8
	ds_store_2addr_b32 v91, v33, v112 offset0:16 offset1:24
	.loc	1 763 25                        ; attention.py:763:25
	s_waitcnt lgkmcnt(2)
...
.Ltmp3:
	...
	v_permlanex16_b32 v109, v40, s52, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bf16_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 54
