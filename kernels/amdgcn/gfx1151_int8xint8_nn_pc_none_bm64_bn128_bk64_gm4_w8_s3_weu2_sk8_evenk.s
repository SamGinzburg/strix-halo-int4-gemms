	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp15:
	...
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v2, s15, v2
	...
	v_xor_b32_e32 v59, 16, v57
	v_xor_b32_e32 v60, 32, v57
	v_add3_u32 v2, v6, s1, v1
	v_add3_u32 v1, v7, s1, v1
	v_add3_u32 v62, v4, v3, 0x400
	v_xor_b32_e32 v58, 48, v57
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b128 v[9:12], v62, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[13:16], v64, s[24:27], 0 offen
	buffer_load_b128 v[17:20], v63, s[24:27], 0 offen
	s_mov_b32 s6, s30
	s_mov_b32 s30, s0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v65, s6, v57
	s_mov_b32 s0, s4
	v_add_nc_u32_e32 v66, s6, v59
	v_add_nc_u32_e32 v67, s6, v60
	v_add_nc_u32_e32 v68, s6, v58
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add3_u32 v69, s0, v55, v56
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_add_f32 v51, v51, v69 :: v_dual_add_nc_u32 v62, 0x200, v62
	v_dual_add_f32 v52, v52, v68 :: v_dual_add_nc_u32 v225, s6, v61
	v_dual_add_f32 v45, v45, v75 :: v_dual_add_nc_u32 v226, s1, v21
...
; %bb.10:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v73, s11 :: v_dual_add_nc_u32 v2, s0, v60
	...
	v_dual_mov_b32 v70, s8 :: v_dual_add_nc_u32 v3, s0, v59
	v_dual_mov_b32 v71, s9 :: v_dual_add_nc_u32 v10, s0, v58
	v_dual_mov_b32 v69, s7 :: v_dual_add_nc_u32 v8, s0, v57
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_11:
	...
	v_cndmask_b32_e64 v36, v36, v20, s2
	v_cndmask_b32_e64 v39, v28, v68, s2
	v_cndmask_b32_e64 v2, v44, v2, s2
	v_cndmask_b32_e64 v44, v51, v6, s2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	v_mul_lo_u32 v6, s29, v88
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v46, v24, v72, s2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	v_add3_u32 v48, s40, v86, v6
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v37, v30, v66, s2
	v_cndmask_b32_e64 v43, v25, v71, s2
	...
	v_cndmask_b32_e64 v41, v26, v70, s2
	v_cndmask_b32_e64 v7, v50, v7, s2
	v_cndmask_b32_e64 v50, v23, v73, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	s_mul_i32 s22, s29, 6
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v52, v48, s20, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_lshl_b32 s23, s29, 3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v53, v48, s21, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	...
	s_mov_b32 s14, s6
	s_mov_b32 s15, s7
	v_add_lshl_u32 v54, v48, s22, 2
	v_add_lshl_u32 v61, v48, s23, 2
	v_add_lshl_u32 v62, v48, s24, 2
	v_add_lshl_u32 v63, v48, s25, 2
	v_add_lshl_u32 v64, v48, s26, 2
	v_add_lshl_u32 v65, v48, s27, 2
	v_add_lshl_u32 v66, v48, s30, 2
	v_add_lshl_u32 v67, v48, s31, 2
	v_add_lshl_u32 v68, v48, s33, 2
	v_add_lshl_u32 v69, v48, s34, 2
	v_add_lshl_u32 v70, v48, s35, 2
	v_add_lshl_u32 v71, v48, s36, 2
	v_add_lshl_u32 v72, v48, s37, 2
	v_add_lshl_u32 v73, v48, s28, 2
	v_add_lshl_u32 v86, v48, s38, 2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s5, s29, 54
	s_mul_i32 s4, s29, 56
	s_mul_i32 s3, s29, 58
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshlrev_b32_e32 v10, 6, v91
	v_and_b32_e32 v12, 0x840, v87
	v_and_b32_e32 v21, 0x700, v21
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v77, v0, v22 :: v_dual_lshlrev_b32 v14, 2, v89
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_lshl_u32 v87, v48, s39, 2
	v_xor_b32_e32 v10, v12, v10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_or3_b32 v8, v21, v14, v10
	v_add_nc_u32_e32 v88, 0, v8
	v_xad_u32 v89, 0x1008, v8, 0
	v_xad_u32 v90, 0x2010, v8, 0
	v_xad_u32 v91, 0x3018, v8, 0
	v_xad_u32 v92, 0x4020, v8, 0
	v_xad_u32 v93, 0x5028, v8, 0
	v_xad_u32 v94, 0x6030, v8, 0
	v_xad_u32 v95, 0x7038, v8, 0
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	v_lshlrev_b32_e32 v8, 16, v57
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_mul_f32_e32 v85, v1, v8
	v_mul_f32_e32 v82, v0, v28
	v_mul_f32_e32 v80, v0, v25
	v_dual_mul_f32 v111, v1, v24 :: v_dual_lshlrev_b32 v12, 16, v59
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	v_lshlrev_b32_e32 v6, 16, v78
	v_lshlrev_b32_e32 v21, 16, v79
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_mul_f32_e32 v25, v1, v25
	v_dual_mul_f32 v60, v0, v16 :: v_dual_lshlrev_b32 v23, 16, v81
	.loc	1 435 14                        ; generate_amdgcn.py:435:14
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v78, v0, v23 :: v_dual_mul_f32 v105, v1, v12
	v_mul_f32_e32 v55, v0, v6
	v_mul_f32_e32 v107, v1, v16
	v_dual_mul_f32 v56, v0, v8 :: v_dual_mul_f32 v23, v1, v23
	v_mul_f32_e32 v106, v1, v14
	v_dual_mul_f32 v113, v1, v28 :: v_dual_lshlrev_b32 v10, 16, v58
	...
	v_mul_f32_e32 v59, v0, v14
	v_mul_f32_e32 v74, v0, v18
	v_dual_mul_f32 v79, v0, v24 :: v_dual_mul_f32 v104, v1, v10
	.loc	1 436 9 is_stmt 0               ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v10, v7, v60
	v_dual_mul_f32 v14, v9, v75 :: v_dual_mul_f32 v7, v35, v105
	v_mul_f32_e32 v9, v34, v106
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_mul_f32_e32 v81, v0, v26
	v_mul_f32_e32 v112, v1, v26
	v_mul_f32_e32 v110, v1, v22
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v0, v2, v55
	v_mul_f32_e32 v2, v3, v56
	v_dual_mul_f32 v3, v19, v85 :: v_dual_mul_f32 v108, v1, v18
	v_dual_mul_f32 v18, v11, v77 :: v_dual_mul_f32 v11, v33, v107
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_mul_f32_e32 v114, v1, v30
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v30, v17, v83
	v_mul_f32_e32 v17, v37, v21
	v_mul_f32_e32 v21, v39, v23
	v_dual_mul_f32 v23, v27, v111 :: v_dual_mul_f32 v84, v1, v6
	v_mul_f32_e32 v16, v47, v76
	v_dual_mul_f32 v22, v13, v79 :: v_dual_mul_f32 v13, v32, v108
	v_mul_f32_e32 v27, v43, v112
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v1, v38, v84
	v_dual_mul_f32 v19, v29, v110 :: v_dual_mul_f32 v4, v4, v57
	v_mul_f32_e32 v6, v5, v58
	v_mul_f32_e32 v20, v45, v78
	v_mul_f32_e32 v26, v15, v81
	v_mul_f32_e32 v15, v31, v109
	v_mul_f32_e32 v5, v36, v104
	v_dual_mul_f32 v8, v44, v59 :: v_dual_mul_f32 v25, v41, v25
	v_mul_f32_e32 v12, v49, v74
	v_mul_f32_e32 v24, v42, v80
	v_dual_mul_f32 v28, v40, v82 :: v_dual_mul_f32 v29, v46, v113
	v_mul_f32_e32 v31, v50, v114
	...
	v_add_lshl_u32 v32, v48, s19, 2
	v_add_lshl_u32 v33, v48, s18, 2
	v_add_lshl_u32 v34, v48, s17, 2
	v_add_lshl_u32 v35, v48, s16, 2
	v_add_lshl_u32 v36, v48, s11, 2
	v_add_lshl_u32 v37, v48, s10, 2
	v_add_lshl_u32 v38, v48, s9, 2
	v_add_lshl_u32 v39, v48, s8, 2
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v0, v51, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v4, v52, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v8, v53, s[12:15], 0 offen
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v12, v54, s[12:15], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v16, v61, s[12:15], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v20, v62, s[12:15], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v24, v63, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_clause 0x13
	buffer_atomic_add_f32 v28, v64, s[12:15], 0 offen
	buffer_atomic_add_f32 v2, v65, s[12:15], 0 offen
	buffer_atomic_add_f32 v6, v66, s[12:15], 0 offen
	buffer_atomic_add_f32 v10, v67, s[12:15], 0 offen
	buffer_atomic_add_f32 v14, v68, s[12:15], 0 offen
	buffer_atomic_add_f32 v18, v69, s[12:15], 0 offen
	buffer_atomic_add_f32 v22, v70, s[12:15], 0 offen
	buffer_atomic_add_f32 v26, v71, s[12:15], 0 offen
	buffer_atomic_add_f32 v30, v72, s[12:15], 0 offen
	buffer_atomic_add_f32 v1, v73, s[12:15], 0 offen
	buffer_atomic_add_f32 v5, v86, s[12:15], 0 offen
	buffer_atomic_add_f32 v9, v87, s[12:15], 0 offen
	...
	v_add_lshl_u32 v40, v48, s5, 2
	v_add_lshl_u32 v41, v48, s4, 2
	v_add_lshl_u32 v42, v48, s3, 2
	v_add_lshl_u32 v43, v48, s1, 2
	v_add_lshl_u32 v0, v48, s0, 2
	s_clause 0x4
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 227
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
