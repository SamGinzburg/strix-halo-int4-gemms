	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b32 v10, v5, s[16:19], 0 offen
	buffer_load_b32 v11, v4, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v12, v3, s[12:15], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_xor_b32_e32 v19, v3, v5
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_xor_b32_e32 v20, v4, v6
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v14, 0, v20
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(5)
	ds_store_b8 v6, v8 offset:8192
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(3)
	ds_store_2addr_stride64_b32 v14, v10, v11 offset1:16
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v6, v12 offset:8704
	.loc	1 0 0                           ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v14, v7, v13 offset0:8 offset1:24
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
.Ltmp15:
	...
	v_bfe_i32 v5, v0, 3, 1
	v_xor_b32_e32 v32, 8, v31
	v_mad_u64_u32 v[2:3], null, s24, v3, s[10:11]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[3:4], null, s24, v4, s[10:11]
	v_and_or_b32 v21, 0x88, v5, v18
	s_mov_b32 s27, 1
	s_add_i32 s26, s1, 1
	s_add_i32 s0, 0, 0x2000
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_add3_u32 v23, v2, v1, 32
	v_xor_b32_e32 v22, 8, v21
	v_add3_u32 v24, v3, v1, 32
	v_mov_b32_e32 v1, 0
	v_add_nc_u32_e32 v5, s22, v39
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v43, v25, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b32 v44, v24, s[16:19], 0 offen
	buffer_load_b32 v45, v23, s[16:19], 0 offen
	s_mov_b32 s28, s0
	s_mov_b32 s0, s23
	s_mov_b32 s23, s25
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v27, s28, v31
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v29, s23, v21
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v33, s24, v21
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v35, s28, v32
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v28, s10, v20
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_add_i32 s23, s1, 0x2000
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[37:38], v[35:36], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(0)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 74
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
