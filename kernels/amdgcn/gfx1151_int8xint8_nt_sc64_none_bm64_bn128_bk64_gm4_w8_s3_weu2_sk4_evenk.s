	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow45
	...
	v_or_b32_e32 v45, s33, v25
	v_or_b32_e32 v48, s33, v6
	v_or_b32_e32 v46, s33, v8
	v_or_b32_e32 v44, s33, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v88, v45, s15, 1
	v_add_lshl_u32 v89, v48, s15, 1
	v_add_lshl_u32 v90, v46, s15, 1
	v_add_lshl_u32 v91, v44, s15, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_dual_fmac_f32 v26, v150, v88 :: v_dual_fmac_f32 v33, v125, v95
	v_dual_fmac_f32 v28, v120, v90 :: v_dual_fmac_f32 v35, v127, v97
	v_dual_fmac_f32 v30, v122, v92 :: v_dual_fmac_f32 v37, v128, v98
	v_dual_fmac_f32 v32, v124, v94 :: v_dual_fmac_f32 v39, v130, v100
	v_dual_fmac_f32 v34, v126, v96 :: v_dual_fmac_f32 v41, v132, v102
	v_dual_fmac_f32 v38, v129, v99 :: v_dual_fmac_f32 v43, v134, v104
	v_fmac_f32_e32 v40, v131, v101
	v_fmac_f32_e32 v42, v133, v103
	v_fmac_f32_e32 v36, v119, v105
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.9:
	...
	v_add_nc_u32_e32 v7, s12, v67
	v_add_nc_u32_e32 v8, s12, v69
	v_add_nc_u32_e32 v70, s12, v66
	s_mov_b32 s12, 0
	s_delay_alu instid0(SALU_CYCLE_1)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s19, s12
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v87, s12 :: v_dual_add_nc_u32 v6, s10, v62
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v92, s17 :: v_dual_add_nc_u32 v7, s10, v65
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v91, s16 :: v_dual_mov_b32 v90, s15
...
.LBB0_10:
	...
	v_add_lshl_u32 v102, v53, s4, 1
	v_add_lshl_u32 v103, v52, s4, 1
	v_dual_cndmask_b32 v96, 0x80000000, v96 :: v_dual_cndmask_b32 v99, 0x80000000, v99
	v_add_lshl_u32 v104, v51, s4, 1
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 200
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc64_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
