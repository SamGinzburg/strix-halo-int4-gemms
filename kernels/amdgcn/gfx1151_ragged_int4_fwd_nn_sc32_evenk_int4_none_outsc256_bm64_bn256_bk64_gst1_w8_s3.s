...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v74, 0 :: v_dual_add_nc_u32 v9, s42, v25
	v_add_co_u32 v3, vcc_lo, v1, 16
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_add_co_ci_u32_e64 v4, null, 0, v2, vcc_lo
	v_add_co_u32 v5, vcc_lo, v1, 32
	...
	v_mul_lo_u32 v100, v95, s12
	v_mul_lo_u32 v101, v26, s12
	v_mul_lo_u32 v102, v27, s12
	v_mul_lo_u32 v103, v28, s12
	...
	v_dual_mov_b32 v23, 0 :: v_dual_mov_b32 v2, s9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v119, s8, v96, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v162, v120
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v120, s8, v97, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v169, v121
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v121, s8, v98, 1
	...
	buffer_load_u16 v170, v170, s[36:39], 0 offen
	.loc	1 1201 27                       ; ragged.py:1201:27
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 194
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 46
