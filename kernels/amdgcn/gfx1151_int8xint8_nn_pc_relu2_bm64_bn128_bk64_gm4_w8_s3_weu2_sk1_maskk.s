...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s29, v42, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s9, s9
	s_mul_i32 s10, s10, s9
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_lshl_add_u32 v53, s29, 5, v9
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp13:
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v8, s31, v51
	v_or_b32_e32 v14, s31, v42
	v_or_b32_e32 v18, s31, v52
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	buffer_load_b128 v[26:29], v6, s[24:27], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_lshlrev_b32_e32 v1, 1, v0
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v6, 0, v50
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_add_nc_u32_e32 v7, 0, v55
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v6, v[10:13] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v7, v[14:17] offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b128 v7, v[18:21] offset:20480
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v6, v[22:25] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v6, v[26:29] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	v_dual_mov_b32 v7, s10 :: v_dual_mov_b32 v38, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s7, s34, 1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b128 v[88:91], v61, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[120:123], v62, s[24:27], 0 offen
	buffer_load_b128 v[124:127], v63, s[24:27], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_add_i32 s1, s7, s1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v37, v61 :: v_dual_add_nc_u32 v228, s7, v55
	...
	v_dual_add_f32 v36, v36, v62 :: v_dual_add_f32 v35, v35, v63
	v_dual_add_f32 v33, v33, v65 :: v_dual_add_f32 v32, v32, v66
	v_dual_add_f32 v31, v31, v67 :: v_dual_add_f32 v30, v30, v68
	v_dual_add_f32 v29, v29, v69 :: v_dual_add_f32 v28, v28, v70
	...
	v_dual_add_f32 v15, v15, v82 :: v_dual_add_f32 v16, v16, v81
	v_dual_add_f32 v13, v13, v84 :: v_dual_add_f32 v14, v14, v83
	v_dual_add_f32 v11, v11, v86 :: v_dual_add_f32 v12, v12, v85
...
; %bb.8:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v27, v27, v53 :: v_dual_add_f32 v26, v26, v54
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v23, v23, v52 :: v_dual_add_f32 v22, v22, v53
...
; %bb.10:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v3, v9 offset:1664
	ds_load_u8 v4, v9 offset:1536
	ds_load_u8 v5, v9 offset:1920
	ds_load_u8 v6, v9 offset:1792
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v1, s0, v49
	v_add_nc_u32_e32 v2, s0, v48
	v_add_nc_u32_e32 v62, s0, v47
	v_add_nc_u32_e32 v7, s0, v46
	ds_load_b128 v[54:57], v1 offset:2048
	ds_load_b128 v[58:61], v1
	ds_load_b128 v[79:82], v2 offset:2048
	ds_load_b128 v[71:74], v2
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v1, v9 offset:1152
	ds_load_u8 v2, v9 offset:1024
	ds_load_u8 v8, v9 offset:1408
	ds_load_u8 v46, v9 offset:1280
	ds_load_u8 v47, v9 offset:640
	ds_load_u8 v48, v9 offset:512
	ds_load_u8 v49, v9 offset:896
	ds_load_u8 v50, v9 offset:768
	ds_load_u8 v63, v9 offset:1984
	ds_load_u8 v64, v9 offset:1856
	ds_load_u8 v65, v9 offset:1728
	ds_load_u8 v66, v9 offset:1600
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[83:86], v7 offset:2048
	ds_load_b128 v[75:78], v7
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v1, v2, v1, 0xc0c0004
	v_perm_b32 v3, v4, v3, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v2, v46, v8, 0xc0c0004
	v_perm_b32 v4, v6, v5, 0xc0c0004
	ds_load_u8 v5, v9 offset:128
	ds_load_u8 v6, v9
	ds_load_u8 v51, v9 offset:384
	ds_load_u8 v52, v9 offset:256
	ds_load_u8 v67, v9 offset:1472
	ds_load_u8 v68, v9 offset:1344
	ds_load_u8 v69, v9 offset:1216
	ds_load_u8 v70, v9 offset:1088
	s_waitcnt lgkmcnt(16)
	...
	ds_load_u8 v46, v9 offset:3712
	ds_load_u8 v47, v9 offset:3584
	ds_load_u8 v48, v9 offset:3968
	ds_load_u8 v49, v9 offset:3840
	ds_load_u8 v50, v9 offset:3200
	ds_load_u8 v51, v9 offset:3072
	ds_load_u8 v52, v9 offset:3456
	ds_load_u8 v53, v9 offset:3328
	ds_load_u8 v91, v9 offset:2688
	ds_load_u8 v92, v9 offset:2560
	ds_load_u8 v93, v9 offset:2944
	ds_load_u8 v94, v9 offset:2816
	ds_load_u8 v95, v9 offset:2176
	ds_load_u8 v96, v9 offset:2048
	ds_load_u8 v97, v9 offset:2432
	ds_load_u8 v98, v9 offset:2304
	ds_load_u8 v116, v9 offset:4032
	ds_load_u8 v117, v9 offset:3904
	ds_load_u8 v118, v9 offset:3776
	ds_load_u8 v119, v9 offset:3648
	ds_load_u8 v107, v9 offset:960
	ds_load_u8 v108, v9 offset:832
	ds_load_u8 v109, v9 offset:704
	ds_load_u8 v111, v9 offset:576
	ds_load_u8 v112, v9 offset:448
	ds_load_u8 v113, v9 offset:320
	ds_load_u8 v114, v9 offset:192
	ds_load_u8 v115, v9 offset:64
	ds_load_u8 v120, v9 offset:3520
	ds_load_u8 v121, v9 offset:3392
	ds_load_u8 v122, v9 offset:3264
	ds_load_u8 v123, v9 offset:3136
	ds_load_u8 v124, v9 offset:3008
	ds_load_u8 v125, v9 offset:2880
	ds_load_u8 v126, v9 offset:2752
	ds_load_u8 v127, v9 offset:2624
	ds_load_u8 v128, v9 offset:2496
	ds_load_u8 v129, v9 offset:2368
	ds_load_u8 v130, v9 offset:2240
	ds_load_u8 v131, v9 offset:2112
	s_waitcnt lgkmcnt(34)
	v_perm_b32 v101, v51, v50, 0xc0c0004
	ds_load_u8 v141, v9 offset:5056
	ds_load_u8 v142, v9 offset:4928
	ds_load_u8 v143, v9 offset:4800
	ds_load_u8 v144, v9 offset:4672
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v102, v53, v52, 0xc0c0004
	v_mov_b32_e32 v3, s6
	s_waitcnt lgkmcnt(34)
	...
	ds_load_u8 v97, v9 offset:5760
	ds_load_u8 v98, v9 offset:5632
	ds_load_u8 v103, v9 offset:6016
	ds_load_u8 v104, v9 offset:5888
	v_perm_b32 v99, v47, v46, 0xc0c0004
	v_perm_b32 v100, v49, v48, 0xc0c0004
	v_lshl_or_b32 v92, v92, 16, v91
	v_lshl_or_b32 v91, v96, 16, v95
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v67, v111, v109, 0xc0c0004
	v_perm_b32 v68, v108, v107, 0xc0c0004
	v_lshl_or_b32 v94, v100, 16, v99
	ds_load_u8 v95, v9 offset:5248
	ds_load_u8 v96, v9 offset:5120
	ds_load_u8 v99, v9 offset:5504
	ds_load_u8 v100, v9 offset:5376
	ds_load_u8 v101, v9 offset:4736
	ds_load_u8 v102, v9 offset:4608
	ds_load_u8 v105, v9 offset:4992
	ds_load_u8 v106, v9 offset:4864
	ds_load_u8 v132, v9 offset:6080
	ds_load_u8 v133, v9 offset:5952
	ds_load_u8 v134, v9 offset:5824
	ds_load_u8 v135, v9 offset:5696
	s_waitcnt lgkmcnt(32)
	v_perm_b32 v69, v115, v114, 0xc0c0004
	v_perm_b32 v70, v113, v112, 0xc0c0004
	v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v7, s10
	v_lshl_or_b32 v114, v63, 16, v65
	v_lshl_or_b32 v113, v66, 16, v64
	v_lshl_or_b32 v112, v68, 16, v67
	v_lshl_or_b32 v111, v70, 16, v69
	...
	ds_load_u8 v103, v9 offset:4224
	ds_load_u8 v104, v9 offset:4096
	ds_load_u8 v110, v9 offset:4480
	ds_load_u8 v136, v9 offset:4352
	ds_load_u8 v137, v9 offset:5568
	ds_load_u8 v138, v9 offset:5440
	ds_load_u8 v139, v9 offset:5312
	ds_load_u8 v140, v9 offset:5184
	s_waitcnt lgkmcnt(16)
	...
	ds_load_u8 v101, v9 offset:7808
	ds_load_u8 v102, v9 offset:7680
	ds_load_u8 v105, v9 offset:8064
	ds_load_u8 v106, v9 offset:7936
	ds_load_u8 v145, v9 offset:4544
	ds_load_u8 v146, v9 offset:4416
	ds_load_u8 v147, v9 offset:4288
	ds_load_u8 v148, v9 offset:4160
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v104, v136, v110, 0xc0c0004
	ds_load_u8 v136, v9 offset:7296
	ds_load_u8 v149, v9 offset:7168
	ds_load_u8 v150, v9 offset:7552
	ds_load_u8 v151, v9 offset:7424
	ds_load_u8 v152, v9 offset:8128
	ds_load_u8 v153, v9 offset:8000
	ds_load_u8 v154, v9 offset:7872
	ds_load_u8 v155, v9 offset:7744
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v110, v102, v101, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[46:53], v[87:90], v[75:78], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v95, v104, 16, v103
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v156, v106, v105, 0xc0c0004
	ds_load_u8 v157, v9 offset:6784
	ds_load_u8 v158, v9 offset:6656
	ds_load_u8 v159, v9 offset:7040
	ds_load_u8 v160, v9 offset:6912
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[99:102], v62 offset:2048
	ds_load_b128 v[103:106], v62
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v62, v9 offset:6272
	ds_load_u8 v161, v9 offset:6144
	v_wmma_i32_16x16x16_iu8 v[63:70], v[111:114], v[75:78], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v110, v156, 16, v110
	ds_load_u8 v156, v9 offset:7616
	ds_load_u8 v162, v9 offset:7488
	ds_load_u8 v163, v9 offset:7360
	ds_load_u8 v164, v9 offset:7232
	v_lshl_or_b32 v118, v109, 16, v108
	...
	ds_load_u8 v150, v9 offset:6528
	ds_load_u8 v151, v9 offset:6400
	ds_load_u8 v165, v9 offset:7104
	ds_load_u8 v166, v9 offset:6976
	ds_load_u8 v167, v9 offset:6848
	ds_load_u8 v168, v9 offset:6720
	v_lshl_or_b32 v115, v122, 16, v121
	v_perm_b32 v75, v135, v134, 0xc0c0004
	...
	ds_load_u8 v159, v9 offset:6592
	ds_load_u8 v160, v9 offset:6464
	ds_load_u8 v169, v9 offset:6336
	...
	v_wmma_i32_16x16x16_iu8 v[46:53], v[91:94], v[71:74], v[46:53] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[63:70], v[115:118], v[71:74], v[63:70] neg_lo:[1,1,0]
	v_lshl_or_b32 v122, v76, 16, v75
	v_lshl_or_b32 v121, v78, 16, v77
	v_lshl_or_b32 v120, v109, 16, v108
	v_lshl_or_b32 v119, v123, 16, v119
	v_perm_b32 v71, v155, v154, 0xc0c0004
	v_perm_b32 v72, v153, v152, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[46:53], v[95:98], v[58:61], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v62, v161, v62, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v107, v151, v150, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[63:70], v[119:122], v[58:61], v[63:70] neg_lo:[1,1,0]
	v_lshl_or_b32 v61, v72, 16, v71
	v_wmma_i32_16x16x16_iu8 v[71:78], v[87:90], v[83:86], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[1:8], v[111:114], v[83:86], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v107, v107, 16, v62
	v_perm_b32 v58, v164, v163, 0xc0c0004
	v_perm_b32 v59, v162, v156, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v62, v168, v167, 0xc0c0004
	v_perm_b32 v83, v166, v165, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v9, v169, 0xc0c0004
	v_perm_b32 v84, v160, v159, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[71:78], v[91:94], v[79:82], v[71:78] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[1:8], v[115:118], v[79:82], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v109, v149, 16, v136
	v_lshl_or_b32 v108, v158, 16, v157
	v_lshl_or_b32 v60, v59, 16, v58
	v_lshl_or_b32 v59, v83, 16, v62
	v_lshl_or_b32 v58, v84, 16, v9
	v_wmma_i32_16x16x16_iu8 v[71:78], v[95:98], v[54:57], v[71:78] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[1:8], v[119:122], v[54:57], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[46:53], v[107:110], v[103:106], v[46:53] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[63:70], v[58:61], v[103:106], v[63:70] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[71:78], v[107:110], v[99:102], v[71:78] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[1:8], v[58:61], v[99:102], v[1:8] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	v_or3_b32 v1, v1, v44, s14
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v60, v37, v60 :: v_dual_and_b32 v43, 56, v43
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_or_b32_e32 v5, s15, v2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v55, v17, v55 :: v_dual_lshlrev_b32 v4, 1, v4
	v_dual_add_f32 v56, v41, v56 :: v_dual_lshlrev_b32 v1, 1, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v58, v39, v58 :: v_dual_lshlrev_b32 v5, 1, v5
	...
	s_add_i32 s1, s1, s14
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v67, v30, v67 :: v_dual_add_f32 v72, v25, v72
	v_dual_add_f32 v73, v24, v73 :: v_dual_add_f32 v78, v19, v78
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v17, v17, v55, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_or_b32_e32 v55, s1, v43
	v_add3_u32 v43, s1, v43, 64
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v69, v28, v69 :: v_dual_add_f32 v74, v23, v74
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b32_e32 v87, 0x5410
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v25, v25, v72, s2
	v_cndmask_b32_e64 v24, v24, v73, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add_lshl_u32 v72, v55, v3, 1
	v_add_lshl_u32 v73, v43, v3, 1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v71, v26, v71 :: v_dual_add_f32 v76, v21, v76
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v23, v23, v74, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v57, v40, v57 :: v_dual_add_f32 v62, v35, v62
	v_dual_add_f32 v59, v38, v59 :: v_dual_add_f32 v64, v33, v64
	v_dual_add_f32 v61, v36, v61 :: v_dual_add_f32 v66, v31, v66
	v_dual_add_f32 v63, v34, v63 :: v_dual_add_f32 v68, v29, v68
	v_dual_add_f32 v75, v22, v75 :: v_dual_add_f32 v80, v16, v80
	v_dual_add_f32 v77, v20, v77 :: v_dual_add_f32 v82, v14, v82
	v_dual_add_f32 v79, v18, v79 :: v_dual_add_f32 v84, v12, v84
	v_dual_add_f32 v81, v15, v81 :: v_dual_add_f32 v86, v10, v86
	v_dual_add_f32 v83, v13, v83 :: v_dual_and_b32 v0, 16, v0
	v_dual_add_f32 v85, v11, v85 :: v_dual_mov_b32 v88, 0x7632
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v41, v41, v56, s2
	v_cndmask_b32_e64 v39, v39, v58, s2
	v_cndmask_b32_e64 v21, v21, v76, s2
	v_cndmask_b32_e64 v40, v40, v57, s2
	v_cndmask_b32_e64 v38, v38, v59, s2
	v_cndmask_b32_e64 v37, v37, v60, s2
	v_cndmask_b32_e64 v35, v35, v62, s2
	v_cndmask_b32_e64 v34, v34, v63, s2
	v_cndmask_b32_e64 v33, v33, v64, s2
	v_cndmask_b32_e64 v31, v31, v66, s2
	v_cndmask_b32_e64 v22, v22, v75, s2
	v_cndmask_b32_e64 v20, v20, v77, s2
	v_cndmask_b32_e64 v19, v19, v78, s2
	v_cndmask_b32_e64 v18, v18, v79, s2
	...
	v_cndmask_b32_e64 v10, v10, v86, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v65, v32, v65 :: v_dual_add_f32 v70, v27, v70
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v1.h, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v36, v36, v61, s2
	v_cndmask_b32_e64 v29, v29, v68, s2
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b32_e64 v32, v32, v65, s2
	v_cndmask_b32_e64 v30, v30, v67, s2
	v_cndmask_b32_e64 v27, v27, v70, s2
	v_cndmask_b32_e64 v26, v26, v71, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v76, v3, v8 :: v_dual_lshlrev_b32 v53, 16, v54
	v_mul_f32_e32 v54, v3, v5
	v_mul_f32_e32 v75, v3, v7
	v_mul_f32_e32 v86, v3, v51
	v_mul_f32_e32 v84, v3, v49
	v_mul_f32_e32 v5, v4, v5
	v_mul_f32_e32 v7, v4, v7
	v_mul_f32_e32 v89, v3, v52
	v_mul_f32_e32 v85, v3, v50
	v_mul_f32_e32 v83, v3, v48
	v_mul_f32_e32 v79, v3, v44
	v_mul_f32_e32 v81, v3, v46
	v_mul_f32_e32 v78, v3, v42
	v_mul_f32_e32 v82, v3, v47
	v_mul_f32_e32 v80, v3, v45
	v_dual_mul_f32 v77, v3, v9 :: v_dual_mul_f32 v8, v4, v8
	v_dual_mul_f32 v3, v3, v53 :: v_dual_mul_f32 v42, v4, v42
	v_dual_mul_f32 v9, v4, v9 :: v_dual_mul_f32 v6, v25, v6
	v_dual_mul_f32 v44, v4, v44 :: v_dual_mul_f32 v17, v17, v54
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v45, v4, v45 :: v_dual_mul_f32 v8, v23, v8
	v_dual_mul_f32 v46, v4, v46 :: v_dual_mul_f32 v39, v39, v76
	v_dual_mul_f32 v47, v4, v47 :: v_dual_mul_f32 v38, v38, v77
	v_dual_mul_f32 v48, v4, v48 :: v_dual_mul_f32 v41, v41, v74
	v_dual_mul_f32 v49, v4, v49 :: v_dual_mul_f32 v18, v18, v46
	v_dual_mul_f32 v50, v4, v50 :: v_dual_mul_f32 v35, v35, v80
	v_dual_mul_f32 v51, v4, v51 :: v_dual_mul_f32 v34, v34, v81
	v_dual_mul_f32 v52, v4, v52 :: v_dual_mul_f32 v37, v37, v78
	v_dual_mul_f32 v4, v4, v53 :: v_dual_mul_f32 v33, v33, v82
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v40, v40, v75 :: v_dual_mul_f32 v31, v31, v84
	v_dual_mul_f32 v7, v24, v7 :: v_dual_mul_f32 v14, v14, v49
	v_dual_mul_f32 v9, v22, v9 :: v_dual_mul_f32 v20, v20, v44
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v13, v13, v50 :: v_dual_mul_f32 v4, v10, v4
	v_dual_mul_f32 v11, v11, v52 :: v_dual_max_f32 v10, 0, v17
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v17, 0, v41 :: v_dual_max_f32 v22, 0, v40
	v_dual_max_f32 v23, 0, v39 :: v_dual_max_f32 v24, 0, v38
	...
	v_dual_mul_f32 v30, v30, v85 :: v_dual_mul_f32 v3, v27, v3
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v26, 0, v36 :: v_dual_max_f32 v27, 0, v35
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v27, v27, v27 :: v_dual_mul_f32 v34, v34, v34
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v28, v28, v89 :: v_dual_mul_f32 v21, v21, v42
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v28, 0, v28 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v6, 0, v6 :: v_dual_mul_f32 v29, v29, v29
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v9, v9, v9 :: v_dual_mul_f32 v18, v18, v18
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v61.l, v32.h
	v_mov_b16_e32 v62.l, v30.h
	v_mov_b16_e32 v10.l, v22.h
	v_add3_u32 v0, v27, v17, 0x7fff
	v_and_b32_e32 v17, 1, v1
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v28, v28, v28 :: v_dual_mul_f32 v3, v3, v3
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v19, v19, v45 :: v_dual_mul_f32 v16, v16, v47
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v5, 0, v5 :: v_dual_max_f32 v8, 0, v8
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_cndmask_b32 v25, v0, v10 :: v_dual_and_b32 v40, 1, v60
	v_dual_cndmask_b32 v0, v10, v0 :: v_dual_and_b32 v47, 1, v66
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v21, v21, v21 :: v_dual_mul_f32 v16, v16, v16
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v15, v15, v48 :: v_dual_mul_f32 v12, v12, v51
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b16_e32 v68.l, v18.h
	v_dual_cndmask_b32 v17, v17, v24 :: v_dual_and_b32 v46, 1, v65
	...
	v_perm_b32 v2, v10, v22, v24
	v_perm_b32 v3, v10, v22, v28
	...
	v_perm_b32 v6, v17, v27, v24
	v_perm_b32 v7, v17, v27, v28
	v_and_b32_e32 v17, 1, v1
	...
	v_dual_cndmask_b32 v19, v21, v26 :: v_dual_cndmask_b32 v20, v26, v21
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_dual_cndmask_b32 v17, v0, v10 :: v_dual_cndmask_b32 v0, v10, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add3_u32 v13, v13, v50, 0x7fff
	...
	v_add3_u32 v11, v11, v51, 0x7fff
	v_perm_b32 v10, v18, v19, v24
	...
	v_perm_b32 v11, v18, v19, v28
	v_add_lshl_u32 v0, v43, v67, 1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_cndmask_b32_e32 v17, v14, v1, vcc_lo
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 230
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 35
