...
.Ltmp11:
	...
	v_dual_mov_b32 v44, 0 :: v_dual_and_b32 v23, 0xf0, v0
...
.Ltmp24:
	...
	v_mul_lo_u32 v45, v8, s1
	v_dual_mov_b32 v39, 0 :: v_dual_and_b32 v8, 2, v14
	v_dual_mov_b32 v35, 0 :: v_dual_lshlrev_b32 v14, 1, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_mul_lo_u32 v46, v11, s1
	v_dual_mov_b32 v42, 0 :: v_dual_lshlrev_b32 v11, 1, v23
	v_dual_mov_b32 v38, 0 :: v_dual_and_b32 v9, 32, v9
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v8, 0, v8
	v_dual_mov_b32 v36, 0 :: v_dual_add_nc_u32 v47, 0, v11
	v_xor_b32_e32 v12, 0x90, v2
	v_xor_b32_e32 v10, 0x110, v2
	v_xor_b32_e32 v13, 16, v5
	v_xor_b32_e32 v15, 16, v7
	v_dual_mov_b32 v31, 0 :: v_dual_and_b32 v14, 28, v14
	v_add3_u32 v16, v8, v4, v9
	v_add3_u32 v11, v47, v11, v9
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_add3_u32 v9, v3, v1, s2
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v49, 0, v6
	v_add_nc_u32_e32 v50, 0, v2
	v_dual_mov_b32 v30, 0 :: v_dual_add_nc_u32 v53, 0, v5
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v55, 0, v7
	v_mov_b32_e32 v1, s4
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v51, 0, v12
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v52, 0, v10
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v54, 0, v13
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v56, 0, v15
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_dual_mov_b32 v4, s7 :: v_dual_mov_b32 v5, s8
	v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v7, s10
	v_dual_mov_b32 v8, s11 :: v_dual_add_nc_u32 v57, v16, v14
	v_mov_b32_e32 v26, 0
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v58, v11, v14
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v60, s6, v41
	.loc	1 368 21                        ; generate_amdgcn.py:368:21
	s_or_b32 s5, s6, 32
	.loc	1 386 29                        ; generate_amdgcn.py:386:29
	s_ashr_i32 s6, s6, 5
	.loc	1 374 34                        ; generate_amdgcn.py:374:34
	v_add_nc_u32_e32 v75, s5, v41
	...
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v60, v46, s6, 1
	v_add_lshl_u32 v61, v45, s5, 1
	v_add_lshl_u32 v62, v46, s5, 1
	.loc	1 390 40                        ; generate_amdgcn.py:390:40
	s_mul_i32 s5, s5, s19
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v117, v63, s[12:15], 0 offen
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_clause 0x1
	buffer_load_u16 v118, v61, s[8:11], 0 offen
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	ds_load_b128 v[59:62], v47 offset:18432
	ds_load_b128 v[88:91], v47 offset:18448
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	...
	v_dual_fmac_f32 v43, v121, v153 :: v_dual_lshlrev_b32 v134, 16, v59
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	v_lshlrev_b32_e32 v155, 16, v88
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v42, v122, v154 :: v_dual_and_b32 v159, 0xffff0000, v59
	v_dual_fmac_f32 v38, v137, v156 :: v_dual_and_b32 v161, 0xffff0000, v61
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[67:74], v[104:107], v[75:78], v[1:8] neg_lo:[1,1,0]
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v40, v133, v134
	v_dual_fmac_f32 v39, v136, v155 :: v_dual_and_b32 v162, 0xffff0000, v62
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_wmma_i32_16x16x16_iu8 v[59:66], v[83:86], v[75:78], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[75:82], v[83:86], v[92:95], v[1:8] neg_lo:[1,1,0]
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v44, v120, v152 :: v_dual_lshlrev_b32 v157, 16, v90
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v29, v146, v165 :: v_dual_fmac_f32 v28, v147, v91
	v_dual_fmac_f32 v11, v131, v165 :: v_dual_fmac_f32 v10, v132, v91
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v36, v139, v158 :: v_dual_fmac_f32 v33, v142, v161
	v_dual_fmac_f32 v30, v145, v164 :: v_dual_fmac_f32 v31, v144, v163
	v_dual_fmac_f32 v26, v123, v152 :: v_dual_fmac_f32 v27, v116, v134
	v_dual_fmac_f32 v16, v127, v160 :: v_dual_fmac_f32 v25, v124, v153
	v_dual_fmac_f32 v22, v125, v154 :: v_dual_fmac_f32 v21, v135, v155
	v_dual_fmac_f32 v20, v148, v156 :: v_dual_fmac_f32 v19, v149, v157
	v_fmac_f32_e32 v18, v150, v158
	v_dual_fmac_f32 v17, v126, v159 :: v_dual_fmac_f32 v14, v129, v162
	v_dual_fmac_f32 v15, v128, v161 :: v_dual_fmac_f32 v12, v130, v164
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v108, 16, v119
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v80, v108, v80 :: v_dual_lshlrev_b32 v107, 16, v118
	v_dual_mul_f32 v106, v106, v107 :: v_dual_lshlrev_b32 v59, 16, v117
	v_mul_f32_e32 v93, v107, v93
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v13, v151, v163 :: v_dual_mul_f32 v76, v108, v76
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_store_b32 v58, v59 offset:18432
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[59:62], v47 offset:18432
	ds_load_b128 v[63:66], v47 offset:18448
	ds_load_b128 v[67:70], v47 offset:18944
	ds_load_b128 v[71:74], v47 offset:18960
	v_dual_mul_f32 v91, v107, v91 :: v_dual_mul_f32 v78, v108, v78
	v_dual_mul_f32 v92, v107, v92 :: v_dual_mul_f32 v77, v108, v77
	v_dual_mul_f32 v94, v107, v94 :: v_dual_mul_f32 v79, v108, v79
	v_dual_mul_f32 v95, v107, v95 :: v_dual_mul_f32 v82, v108, v82
	v_dual_mul_f32 v96, v107, v96 :: v_dual_mul_f32 v81, v108, v81
	v_dual_mul_f32 v97, v107, v97 :: v_dual_mul_f32 v84, v108, v84
	v_dual_mul_f32 v98, v107, v98 :: v_dual_mul_f32 v83, v108, v83
	v_dual_mul_f32 v99, v107, v99 :: v_dual_mul_f32 v86, v108, v86
	v_dual_mul_f32 v100, v107, v100 :: v_dual_mul_f32 v85, v108, v85
	v_dual_mul_f32 v101, v107, v101 :: v_dual_mul_f32 v88, v108, v88
	v_dual_mul_f32 v102, v107, v102 :: v_dual_mul_f32 v87, v108, v87
	v_dual_mul_f32 v103, v107, v103 :: v_dual_mul_f32 v90, v108, v90
	v_dual_mul_f32 v104, v107, v104 :: v_dual_mul_f32 v89, v108, v89
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v105, v107, v105 :: v_dual_fmac_f32 v40, v106, v59
	v_dual_mul_f32 v75, v75, v108 :: v_dual_fmac_f32 v42, v93, v62
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v44, v91, v60 :: v_dual_fmac_f32 v43, v92, v61
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v39, v94, v63 :: v_dual_fmac_f32 v38, v95, v64
	v_dual_fmac_f32 v37, v96, v65 :: v_dual_fmac_f32 v36, v97, v66
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v35, v98, v67 :: v_dual_fmac_f32 v34, v99, v68
	v_dual_fmac_f32 v33, v100, v69 :: v_dual_fmac_f32 v32, v101, v70
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v31, v102, v71 :: v_dual_fmac_f32 v30, v103, v72
	v_dual_fmac_f32 v29, v104, v73 :: v_dual_fmac_f32 v28, v105, v74
	v_dual_fmac_f32 v27, v75, v59 :: v_dual_fmac_f32 v26, v76, v60
	v_dual_fmac_f32 v25, v77, v61 :: v_dual_fmac_f32 v22, v78, v62
	v_dual_fmac_f32 v21, v79, v63 :: v_dual_fmac_f32 v20, v80, v64
	v_dual_fmac_f32 v19, v81, v65 :: v_dual_fmac_f32 v18, v82, v66
	v_dual_fmac_f32 v17, v83, v67 :: v_dual_fmac_f32 v16, v84, v68
	v_dual_fmac_f32 v15, v85, v69 :: v_dual_fmac_f32 v14, v86, v70
	v_dual_fmac_f32 v13, v87, v71 :: v_dual_fmac_f32 v12, v88, v72
	v_dual_fmac_f32 v11, v89, v73 :: v_dual_fmac_f32 v10, v90, v74
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 166
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 29
