	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[17:18], null, s7, v32, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s11, s11
	s_mul_i32 s18, s18, s11
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_lshl_add_u32 v35, s7, 5, v17
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp13:
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v20, v9, s[12:15], 0 offen
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_dual_cndmask_b32 v13, 0x80000000, v14 :: v_dual_add_nc_u32 v22, 0, v31
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v21, v9, s[12:15], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	ds_store_b32 v23, v20 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v23, v21 offset:17408
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v22, v[9:12] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v22, v[13:16] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	v_dual_mov_b32 v2, v1 :: v_dual_mov_b32 v27, 0
	v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v26, 0
	v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v25, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s1, s20
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[9:10], null, s0, s6, v[18:19]
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	...
	v_dual_add_f32 v27, v27, v39 :: v_dual_cndmask_b32 v10, 0x80000000, v10
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v26, v26, v40 :: v_dual_add_nc_u32 v79, s22, v31
	v_dual_add_f32 v20, v20, v38 :: v_dual_add_f32 v25, v25, v41
	v_add_f32_e32 v24, v24, v42
	v_dual_add_f32 v22, v22, v44 :: v_dual_add_f32 v21, v21, v45
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
...
; %bb.9:
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v30, s26, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v3, v30 offset:208
	ds_load_u8 v4, v30 offset:224
	ds_load_u8 v5, v30 offset:192
	ds_load_u8 v7, v30 offset:240
	ds_load_u8 v8, v30 offset:144
	ds_load_u8 v9, v30 offset:176
	ds_load_u8 v10, v30 offset:160
	ds_load_u8 v11, v30 offset:128
	ds_load_u8 v12, v30 offset:112
	ds_load_u8 v13, v30 offset:80
	ds_load_u8 v14, v30 offset:96
	ds_load_u8 v15, v30 offset:64
	ds_load_u8 v16, v30
	ds_load_u8 v17, v30 offset:16
	ds_load_u8 v18, v30 offset:32
	ds_load_u8 v32, v30 offset:48
	...
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v9, v15, v13, 0xc0c0004
	v_lshl_or_b32 v14, v4, 16, v3
	v_mov_b32_e32 v3, 0
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v31, s25, v2
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v6, s26, v1
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v11, v18, v32, 0xc0c0004
	ds_load_u8 v5, v31 offset:1664
	ds_load_u8 v33, v31 offset:1920
	ds_load_u8 v34, v31 offset:1792
	ds_load_u8 v35, v31 offset:1536
	ds_load_u8 v36, v31 offset:1152
	ds_load_u8 v37, v31 offset:1408
	ds_load_u8 v38, v31 offset:1280
	ds_load_u8 v39, v31 offset:1024
	...
	ds_load_u8 v47, v31
	ds_load_u8 v48, v30 offset:288
	ds_load_u8 v49, v30 offset:256
	v_lshl_or_b32 v13, v8, 16, v7
	v_lshl_or_b32 v12, v10, 16, v9
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v4, v35, v5, 0xc0c0004
	v_perm_b32 v5, v34, v33, 0xc0c0004
	ds_load_u8 v32, v30 offset:464
	ds_load_u8 v33, v30 offset:480
	ds_load_u8 v34, v30 offset:448
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v7, v38, v37, 0xc0c0004
	v_lshl_or_b32 v18, v5, 16, v4
	v_mov_b32_e32 v5, v3
	ds_load_u8 v50, v6
	v_perm_b32 v6, v16, v17, 0xc0c0004
	...
	ds_load_u8 v35, v30 offset:496
	ds_load_u8 v36, v30 offset:400
	ds_load_u8 v37, v30 offset:432
	ds_load_u8 v38, v30 offset:416
	ds_load_u8 v39, v30 offset:384
	ds_load_u8 v40, v30 offset:336
	ds_load_u8 v41, v30 offset:352
	ds_load_u8 v42, v30 offset:320
	ds_load_u8 v43, v30 offset:368
	ds_load_u8 v44, v30 offset:272
	ds_load_u8 v45, v30 offset:304
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[3:10], v[15:18], v[11:14], v[3:10] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v12, v33, v35, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v13, v39, v36, 0xc0c0004
	v_perm_b32 v15, v38, v37, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v16, v42, v40, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v17, v41, v43, 0xc0c0004
	ds_load_u8 v18, v31 offset:3712
	ds_load_u8 v33, v31 offset:3968
	ds_load_u8 v35, v31 offset:3840
	ds_load_u8 v36, v31 offset:3584
	ds_load_u8 v37, v31 offset:3200
	ds_load_u8 v38, v31 offset:3456
	ds_load_u8 v39, v31 offset:3328
	ds_load_u8 v40, v31 offset:3072
	ds_load_u8 v41, v31 offset:2688
	ds_load_u8 v42, v31 offset:2944
	ds_load_u8 v43, v31 offset:2816
	ds_load_u8 v54, v31 offset:2560
	ds_load_u8 v55, v31 offset:2176
	ds_load_u8 v56, v31 offset:2432
	ds_load_u8 v57, v31 offset:2304
	ds_load_u8 v58, v31 offset:2048
	v_perm_b32 v11, v34, v32, 0xc0c0004
	v_lshl_or_b32 v13, v15, 16, v13
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v15, v48, v45, 0xc0c0004
	ds_load_u8 v32, v30 offset:592
	ds_load_u8 v34, v30 offset:608
	ds_load_u8 v46, v30 offset:576
	ds_load_u8 v47, v30 offset:528
	ds_load_u8 v51, v30 offset:560
	ds_load_u8 v52, v30 offset:544
	ds_load_u8 v53, v30 offset:512
	v_lshl_or_b32 v14, v12, 16, v11
	v_perm_b32 v11, v49, v44, 0xc0c0004
	ds_load_u8 v44, v30 offset:720
	ds_load_u8 v49, v30 offset:736
	ds_load_u8 v59, v30 offset:704
	ds_load_u8 v60, v30 offset:752
	ds_load_u8 v61, v30 offset:656
	ds_load_u8 v62, v30 offset:688
	ds_load_u8 v63, v30 offset:672
	ds_load_u8 v64, v30 offset:640
	v_lshl_or_b32 v12, v17, 16, v16
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v17, v35, v33, 0xc0c0004
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v35, v39, v38, 0xc0c0004
	v_perm_b32 v16, v36, v18, 0xc0c0004
	...
	v_lshl_or_b32 v15, v39, 16, v38
	ds_load_u8 v38, v30 offset:624
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v40, v63, v62, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v39, v64, v61, 0xc0c0004
	ds_load_u8 v41, v31 offset:5760
	ds_load_u8 v42, v31 offset:6016
	ds_load_u8 v43, v31 offset:5888
	ds_load_u8 v44, v31 offset:5632
	ds_load_u8 v45, v31 offset:5248
	ds_load_u8 v48, v31 offset:5504
	ds_load_u8 v49, v31 offset:5376
	ds_load_u8 v54, v31 offset:5120
	ds_load_u8 v55, v31 offset:4736
	ds_load_u8 v56, v31 offset:4992
	ds_load_u8 v57, v31 offset:4864
	ds_load_u8 v58, v31 offset:4608
	ds_load_u8 v59, v31 offset:4224
	ds_load_u8 v60, v31 offset:4480
	ds_load_u8 v61, v31 offset:4352
	ds_load_u8 v62, v31 offset:4096
	v_wmma_i32_16x16x16_iu8 v[3:10], v[15:18], v[11:14], v[3:10] neg_lo:[1,1,0]
	v_lshl_or_b32 v14, v37, 16, v33
	v_perm_b32 v11, v53, v47, 0xc0c0004
	v_lshl_or_b32 v13, v40, 16, v39
	v_perm_b32 v15, v52, v51, 0xc0c0004
	ds_load_u8 v35, v30 offset:800
	ds_load_u8 v36, v30 offset:768
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v17, v43, v42, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v16, v44, v41, 0xc0c0004
	v_lshl_or_b32 v11, v15, 16, v11
	...
	ds_load_u8 v38, v30 offset:784
	ds_load_u8 v46, v30 offset:848
	ds_load_u8 v63, v30 offset:864
	ds_load_u8 v64, v30 offset:832
	ds_load_u8 v65, v30 offset:816
	s_waitcnt lgkmcnt(8)
	...
	v_lshl_or_b32 v15, v40, 16, v39
	v_lshl_or_b32 v17, v33, 16, v32
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v16, v37, 16, v34
	ds_load_u8 v32, v30 offset:976
	ds_load_u8 v33, v30 offset:992
	ds_load_u8 v34, v30 offset:960
	ds_load_u8 v37, v30 offset:912
	ds_load_u8 v39, v30 offset:944
	ds_load_u8 v40, v30 offset:928
	ds_load_u8 v41, v30 offset:896
	ds_load_u8 v30, v30 offset:880
	ds_load_u8 v42, v31 offset:7808
	ds_load_u8 v43, v31 offset:8064
	ds_load_u8 v44, v31 offset:7936
	ds_load_u8 v45, v31 offset:7680
	ds_load_u8 v47, v31 offset:7296
	ds_load_u8 v48, v31 offset:7552
	ds_load_u8 v49, v31 offset:7424
	ds_load_u8 v51, v31 offset:7168
	ds_load_u8 v52, v31 offset:6784
	ds_load_u8 v53, v31 offset:7040
	ds_load_u8 v54, v31 offset:6912
	ds_load_u8 v55, v31 offset:6656
	ds_load_u8 v56, v31 offset:6272
	ds_load_u8 v57, v31 offset:6528
	ds_load_u8 v58, v31 offset:6400
	...
	v_wmma_i32_16x16x16_iu8 v[3:10], v[15:18], v[11:14], v[3:10] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v30, v63, v30, 0xc0c0004
	...
	v_lshl_or_b32 v12, v30, 16, v39
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v16, v45, v42, 0xc0c0004
	v_perm_b32 v17, v44, v43, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v31, v31, v56, 0xc0c0004
	v_lshl_or_b32 v11, v15, 16, v11
	v_lshl_or_b32 v18, v17, 16, v16
	v_lshl_or_b32 v17, v32, 16, v30
	v_lshl_or_b32 v16, v34, 16, v33
	v_lshl_or_b32 v15, v35, 16, v31
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v23, v23, v5 :: v_dual_add_f32 v20, v20, v3
	v_add_f32_e32 v22, v22, v6
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v24, v24, v4 :: v_dual_add_f32 v21, v21, v7
.LBB0_10:
...
; %bb.11:
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v30, s3, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v3, v30 offset:208
	ds_load_u8 v4, v30 offset:224
	ds_load_u8 v5, v30 offset:192
	ds_load_u8 v6, v30 offset:240
	ds_load_u8 v7, v30 offset:144
	ds_load_u8 v8, v30 offset:176
	ds_load_u8 v9, v30 offset:160
	ds_load_u8 v10, v30 offset:128
	ds_load_u8 v11, v30 offset:112
	ds_load_u8 v12, v30 offset:80
	ds_load_u8 v13, v30 offset:96
	ds_load_u8 v14, v30 offset:64
	ds_load_u8 v15, v30
	ds_load_u8 v16, v30 offset:16
	ds_load_u8 v17, v30 offset:32
	ds_load_u8 v18, v30 offset:48
	s_waitcnt lgkmcnt(12)
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v10, v15, v16, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v11, v17, v18, 0xc0c0004
	...
	ds_load_u8 v45, v2
	ds_load_u8 v46, v30 offset:288
	ds_load_u8 v47, v30 offset:256
	...
	ds_load_u8 v31, v30 offset:464
	ds_load_u8 v32, v30 offset:480
	ds_load_u8 v33, v30 offset:448
	s_waitcnt lgkmcnt(14)
	...
	ds_load_u8 v34, v30 offset:496
	ds_load_u8 v35, v30 offset:400
	ds_load_u8 v36, v30 offset:432
	ds_load_u8 v37, v30 offset:416
	ds_load_u8 v38, v30 offset:384
	ds_load_u8 v39, v30 offset:336
	ds_load_u8 v40, v30 offset:352
	ds_load_u8 v41, v30 offset:320
	ds_load_u8 v42, v30 offset:368
	ds_load_u8 v43, v30 offset:272
	ds_load_u8 v44, v30 offset:304
	v_lshl_or_b32 v16, v9, 16, v8
	v_mov_b32_e32 v5, v3
	v_lshl_or_b32 v15, v15, 16, v10
	v_mov_b32_e32 v6, v3
	...
	v_perm_b32 v11, v33, v31, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v16, v41, v39, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v17, v40, v42, 0xc0c0004
	ds_load_u8 v18, v2 offset:3712
	...
	ds_load_u8 v43, v30 offset:720
	ds_load_u8 v47, v30 offset:736
	ds_load_u8 v57, v30 offset:704
	ds_load_u8 v58, v30 offset:752
	ds_load_u8 v59, v30 offset:656
	ds_load_u8 v60, v30 offset:688
	ds_load_u8 v61, v30 offset:672
	ds_load_u8 v62, v30 offset:640
	v_lshl_or_b32 v12, v17, 16, v16
	s_waitcnt lgkmcnt(25)
	v_perm_b32 v15, v46, v44, 0xc0c0004
	s_waitcnt lgkmcnt(21)
	v_perm_b32 v17, v34, v32, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v16, v35, v18, 0xc0c0004
	ds_load_u8 v31, v30 offset:592
	ds_load_u8 v33, v30 offset:608
	ds_load_u8 v45, v30 offset:576
	ds_load_u8 v48, v30 offset:528
	ds_load_u8 v49, v30 offset:560
	ds_load_u8 v50, v30 offset:544
	...
	v_lshl_or_b32 v15, v38, 16, v37
	ds_load_u8 v37, v30 offset:624
	s_waitcnt lgkmcnt(8)
	...
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v17, v42, v41, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v16, v43, v40, 0xc0c0004
	ds_load_u8 v34, v30 offset:800
	ds_load_u8 v35, v30 offset:768
	s_waitcnt lgkmcnt(11)
	...
	ds_load_u8 v37, v30 offset:784
	ds_load_u8 v45, v30 offset:848
	ds_load_u8 v61, v30 offset:864
	ds_load_u8 v62, v30 offset:832
	ds_load_u8 v63, v30 offset:816
	v_lshl_or_b32 v12, v33, 16, v31
	v_perm_b32 v31, v52, v44, 0xc0c0004
	v_perm_b32 v33, v56, v53, 0xc0c0004
	v_lshl_or_b32 v15, v39, 16, v38
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v17, v32, 16, v31
	v_lshl_or_b32 v16, v36, 16, v33
	ds_load_u8 v31, v30 offset:976
	ds_load_u8 v32, v30 offset:992
	ds_load_u8 v33, v30 offset:960
	ds_load_u8 v36, v30 offset:912
	ds_load_u8 v38, v30 offset:944
	ds_load_u8 v39, v30 offset:928
	...
	v_wmma_i32_16x16x16_iu8 v[3:10], v[15:18], v[11:14], v[3:10] neg_lo:[1,1,0]
	v_lshl_or_b32 v14, v1, 16, v31
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v30, v61, v30, 0xc0c0004
	...
	v_lshl_or_b32 v12, v30, 16, v36
	v_perm_b32 v16, v43, v42, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v17, v49, v46, 0xc0c0004
	...
	v_lshl_or_b32 v16, v32, 16, v31
	v_lshl_or_b32 v15, v33, 16, v2
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[3:10], v[15:18], v[11:14], v[3:10] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v3, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v27, v4 :: v_dual_lshlrev_b32 v11, 1, v2
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s12, s8
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v5, v26, v5 :: v_dual_add_f32 v10, v21, v10
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v6, v25, v6 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v20, v3 :: v_dual_add_f32 v8, v23, v8
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v4, v27, v4, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v24, v7 :: v_dual_and_b32 v0, 16, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v3, v20, v3, s2
	v_cndmask_b32_e64 v6, v25, v6, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v9, v22, v9 :: v_dual_mov_b32 v30, 0x7632
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_mov_b16_e32 v22.h, v28.h
	v_mov_b16_e32 v23.h, v28.h
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v7, v8, v16 :: v_dual_mul_f32 v8, v9, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v9, v10, v11 :: v_dual_and_b32 v12, 1, v22
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v8, v8, v8 :: v_dual_mul_f32 v3, v3, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v5, v5, v5 :: v_dual_cndmask_b32 v12, 0x3276, v30
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v10, 0x1054, v29 :: v_dual_and_b32 v5, 1, v28
	...
	v_dual_cndmask_b32 v1, v3, v1 :: v_dual_and_b32 v8, 0x760076, v11
	...
	v_and_or_b32 v8, 0x78, v19, s20
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_lshl_or_b32 v2, v5, 4, v5
	v_cndmask_b32_e32 v5, v4, v0, vcc_lo
	v_dual_cndmask_b32 v4, v0, v4 :: v_dual_and_b32 v3, 0x7060706, v3
	s_mov_b32 s7, s15
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 168
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
