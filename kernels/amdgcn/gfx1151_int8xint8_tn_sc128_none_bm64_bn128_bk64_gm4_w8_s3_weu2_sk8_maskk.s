...
.Ltmp23:
	...
	.loc	1 346 30                        ; generate_amdgcn.py:346:30
	v_add3_u32 v9, s5, s43, v4
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cselect_b32 s3, -1, 0
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	s_add_i32 s5, s42, s17
	...
	v_or_b32_e32 v28, s43, v49
	v_or_b32_e32 v30, s43, v30
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	v_add_nc_u32_e32 v29, 0, v69
	v_or_b32_e32 v118, s42, v31
	v_or_b32_e32 v117, s42, v32
	v_mul_lo_u32 v120, v28, s44
	v_mul_lo_u32 v121, v30, s44
	v_or_b32_e32 v116, s42, v33
	v_or_b32_e32 v115, s42, v34
	v_or_b32_e32 v114, s42, v35
	v_or_b32_e32 v113, s42, v36
	v_or_b32_e32 v112, s42, v37
	v_or_b32_e32 v111, s42, v38
	v_or_b32_e32 v110, s42, v39
	v_or_b32_e32 v109, s42, v40
	v_or_b32_e32 v108, s42, v41
	v_or_b32_e32 v106, s42, v42
	v_or_b32_e32 v107, s42, v43
	v_or_b32_e32 v105, s42, v44
	v_or_b32_e32 v104, s42, v45
	s_mov_b32 s16, 0
	s_mov_b64 s[4:5], s[14:15]
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cmpk_lt_i32 s20, 0x600
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	s_waitcnt vmcnt(3)
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v71, 0 :: v_dual_add_nc_u32 v4, s48, v50
.Ltmp24:
...
.Ltmp25:
	...
	v_add3_u32 v5, v5, s14, v2
	v_add3_u32 v2, v4, s14, v2
	v_add3_u32 v53, v6, s43, v1
	v_dual_mov_b32 v81, 0 :: v_dual_mov_b32 v82, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v54, s15, v5
	v_subrev_nc_u32_e32 v55, s15, v2
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 344 23                        ; generate_amdgcn.py:344:23
	v_cmp_gt_i32_e64 s0, s6, v46
	v_cmp_gt_i32_e32 vcc_lo, s6, v45
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	...
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v71, v58, v29 :: v_dual_lshlrev_b32 v46, 16, v46
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v77, v31, v34 :: v_dual_lshlrev_b32 v62, 16, v29
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	...
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v34, v32, s[28:31], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	buffer_load_u16 v29, v30, s[36:39], 0 offen
	s_waitcnt vmcnt(0)
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v98, v23, v16 :: v_dual_add_nc_u32 v53, s7, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v102, v39, v20 :: v_dual_add_nc_u32 v55, s46, v55
	v_dual_fmac_f32 v96, v41, v22 :: v_dual_add_nc_u32 v43, s17, v69
	v_dual_fmac_f32 v90, v44, v9 :: v_dual_fmac_f32 v91, v45, v10
	v_fmac_f32_e32 v93, v47, v12
	v_fmac_f32_e32 v95, v57, v14
	v_fmac_f32_e32 v97, v58, v15
	v_dual_fmac_f32 v99, v24, v17 :: v_dual_fmac_f32 v100, v37, v18
	v_fmac_f32_e32 v101, v38, v19
	v_fmac_f32_e32 v103, v40, v21
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	v_add_nc_u32_e32 v42, s45, v69
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.6:
	...
	v_dual_mov_b32 v10, s20 :: v_dual_mov_b32 v15, s25
	...
	v_dual_mov_b32 v12, s22 :: v_dual_mov_b32 v17, s27
...
.LBB0_7:
	...
	buffer_load_u16 v157, v4, s[4:7], 0 offen
	buffer_load_u16 v158, v2, s[4:7], 0 offen
	buffer_load_u16 v159, v5, s[4:7], 0 offen
	buffer_load_u16 v160, v6, s[4:7], 0 offen
	buffer_load_u16 v161, v7, s[4:7], 0 offen
	buffer_load_u16 v162, v8, s[4:7], 0 offen
	buffer_load_u16 v163, v10, s[4:7], 0 offen
	...
	v_mov_b32_e32 v17, 0
	s_clause 0x7
	buffer_load_u16 v164, v2, s[4:7], 0 offen
	buffer_load_u16 v165, v3, s[4:7], 0 offen
	buffer_load_u16 v166, v4, s[4:7], 0 offen
	buffer_load_u16 v167, v5, s[4:7], 0 offen
	buffer_load_u16 v168, v6, s[4:7], 0 offen
	buffer_load_u16 v169, v7, s[4:7], 0 offen
	buffer_load_u16 v170, v8, s[4:7], 0 offen
	buffer_load_u16 v171, v10, s[4:7], 0 offen
...
; %bb.8:
	...
	v_dual_mov_b32 v2, s21 :: v_dual_mov_b32 v5, s24
	v_dual_mov_b32 v4, s23 :: v_dual_mov_b32 v7, s26
...
.LBB0_9:
	...
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v33, v119, s1, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v32, 0x80000000, v32
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v34, v118, s1, 1
	v_add_lshl_u32 v37, v117, s1, 1
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b32_e32 v33, 0x80000000, v33, vcc_lo
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	s_clause 0x1
	buffer_load_u16 v1, v1, s[12:15], 0 offen
	buffer_load_u16 v38, v32, s[12:15], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v39, v115, s1, 1
	v_cndmask_b32_e32 v32, 0x80000000, v34, vcc_lo
	v_cndmask_b32_e32 v34, 0x80000000, v37, vcc_lo
	v_add_lshl_u32 v37, v116, s1, 1
	v_add_lshl_u32 v40, v114, s1, 1
	v_add_lshl_u32 v41, v113, s1, 1
	v_add_lshl_u32 v42, v112, s1, 1
	v_add_lshl_u32 v43, v111, s1, 1
	v_add_lshl_u32 v44, v110, s1, 1
	v_add_lshl_u32 v45, v109, s1, 1
	...
	s_clause 0x7
	buffer_load_u16 v46, v33, s[4:7], 0 offen
	...
	v_add_lshl_u32 v43, v108, s1, 1
	v_cndmask_b32_e32 v34, 0x80000000, v45, vcc_lo
	v_add_lshl_u32 v44, v106, s1, 1
	v_add_lshl_u32 v45, v107, s1, 1
	v_add_lshl_u32 v49, v105, s1, 1
	v_add_lshl_u32 v50, v104, s1, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	s_clause 0x7
	buffer_load_u16 v51, v32, s[4:7], 0 offen
	buffer_load_u16 v52, v33, s[4:7], 0 offen
	buffer_load_u16 v53, v34, s[4:7], 0 offen
