...
; %bb.1:                                ; %.lr.ph
	...
	s_add_i32 s0, s0, 15
	v_dual_mov_b32 v24, v32 :: v_dual_add_nc_u32 v59, 0, v67
	...
	v_dual_mov_b32 v1, v32 :: v_dual_and_b32 v68, 0x7060706, v68
	...
	s_mov_b32 s31, s27
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v15, v32 :: v_dual_lshlrev_b32 v66, 16, v66
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 928 41                        ; attention.py:928:41
	v_mul_f32_e32 v66, s1, v66
	v_mov_b32_e32 v16, v32
	v_mov_b32_e32 v18, v32
	v_dual_mov_b32 v3, v32 :: v_dual_mov_b32 v70, v66
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v73, 0x80000000, v42 :: v_dual_cndmask_b32 v76, 0x80000000, v56
	.loc	1 904 31                        ; attention.py:904:31
	v_add_nc_u32_e32 v74, s23, v51
	.loc	1 978 32                        ; attention.py:978:32
	...
	v_cmp_le_i32_e64 s4, v77, v54
	v_cmp_le_i32_e64 s5, v78, v54
	v_cmp_le_i32_e64 s8, v79, v54
	v_cmp_le_i32_e64 s6, v80, v54
	v_cmp_le_i32_e64 s7, v81, v54
	v_dual_mov_b32 v112, v50 :: v_dual_add_nc_u32 v49, s35, v49
	v_cmp_le_i32_e64 s1, v74, v54
	...
	.loc	1 908 32                        ; attention.py:908:32
	s_waitcnt vmcnt(0)
	ds_store_b32 v58, v72
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 923 37                        ; attention.py:923:37
	s_clause 0x7
	buffer_load_u16 v106, v57, s[36:39], 0 offen
	buffer_load_u16 v107, v57, s[36:39], 0 offen offset:4
	buffer_load_u16 v108, v57, s[36:39], 0 offen offset:8
	buffer_load_u16 v109, v57, s[36:39], 0 offen offset:16
	buffer_load_u16 v110, v57, s[36:39], 0 offen offset:20
	buffer_load_u16 v111, v57, s[36:39], 0 offen offset:28
	buffer_load_u16 v113, v57, s[36:39], 0 offen offset:24
	buffer_load_u16 v114, v57, s[36:39], 0 offen offset:12
	.loc	1 978 32                        ; attention.py:978:32
	buffer_load_b32 v115, v73, s[40:43], 0 offen
	.loc	1 1000 41                       ; attention.py:1000:41
	buffer_load_b64 v[72:73], v76, s[28:31], 0 offen
	.loc	1 908 32                        ; attention.py:908:32
	ds_load_b64 v[84:85], v59
	ds_load_b64 v[86:87], v60
	ds_load_b64 v[88:89], v61
	ds_load_b64 v[90:91], v62
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 913 33                        ; attention.py:913:33
	v_wmma_i32_16x16x16_iu4 v[76:83], v[84:85], v[47:48], v[32:39] neg_lo:[1,1,0]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[76:83], v[90:91], v[40:41], v[76:83] neg_lo:[1,1,0]
	.loc	1 932 25                        ; attention.py:932:25
	...
	.loc	1 932 25                        ; attention.py:932:25
	v_dual_mul_f32 v80, v66, v80 :: v_dual_mul_f32 v81, v69, v81
	.loc	1 923 37                        ; attention.py:923:37
	s_waitcnt vmcnt(7)
	...
	v_cndmask_b32_e64 v90, 0xff800000, v77, s7
	.loc	1 1000 41                       ; attention.py:1000:41
	...
	v_cndmask_b32_e64 v80, 0xff800000, v80, s6
	v_cndmask_b32_e64 v88, 0xff800000, v79, s3
	v_cndmask_b32_e64 v89, 0xff800000, v78, s4
	...
	v_or_b16 v76.h, v50.h, -16
	.loc	1 989 38                        ; attention.py:989:38
	v_cmp_lt_u16_e64 s10, 7, v73.h
	.loc	1 986 76                        ; attention.py:986:76
...
.Ltmp2:
	...
	v_cndmask_b16 v86.l, v50.h, v76.h, s12
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
...
.Ltmp6:
	...
	v_or_b16 v50.l, v72.h, -16
	.loc	1 990 30                        ; attention.py:990:30
	v_cndmask_b16 v76.l, v76.l, v79.h, s10
...
.Ltmp8:
	...
	v_cndmask_b16 v50.l, v72.h, v50.l, s12
	.loc	1 1017 31                       ; attention.py:1017:31
	v_mul_f32_e32 v73, v75, v73
	v_mul_f32_e32 v75, v75, v79
	.loc	1 969 24                        ; attention.py:969:24
	v_max3_f32 v79, v55, v85, v86
	.loc	1 989 29                        ; attention.py:989:29
	...
	v_dual_mul_f32 v50, v107, v50 :: v_dual_sub_f32 v81, v81, v79
	...
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v72, v108, v72 :: v_dual_mov_b32 v55, v79
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 971 62                        ; attention.py:971:62
	v_dual_sub_f32 v84, v84, v79 :: v_dual_and_b32 v89, 1, v92
	.loc	1 1017 30                       ; attention.py:1017:30
	v_mov_b16_e32 v94.l, v50.h
	.loc	1 971 62                        ; attention.py:971:62
	v_sub_f32_e32 v82, v82, v79
	.loc	1 970 25                        ; attention.py:970:25
	v_cndmask_b32_e64 v113, 0, v88, s18
	.loc	1 971 62                        ; attention.py:971:62
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v24, v24, v113 :: v_dual_and_b32 v89, 1, v95
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v94, 0, v85, s7
	v_cndmask_b32_e64 v95, 0, v83, s8
	.loc	1 1017 30                       ; attention.py:1017:30
	v_and_b32_e32 v90, 1, v93
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v17, v17, v113 :: v_dual_and_b32 v92, 1, v100
	.loc	1 1017 30                       ; attention.py:1017:30
...
.Ltmp10:
	...
	v_cndmask_b16 v50.h, 0x7fff, v73.h, s15
	v_cndmask_b16 v73.h, 0x7fff, v74.h, s16
	...
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v63, v75, v76 offset1:8
	ds_store_2addr_b32 v63, v50, v73 offset0:16 offset1:24
	.loc	1 1019 30                       ; attention.py:1019:30
	v_and_b32_e32 v50, 1, v101
	...
	v_cndmask_b32_e64 v99, 0, v87, s4
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v19, v19, v113 :: v_dual_add_f32 v88, v93, v92
	v_dual_mul_f32 v23, v23, v113 :: v_dual_add_f32 v100, v97, v96
	.loc	1 1019 30                       ; attention.py:1019:30
	...
	v_cndmask_b16 v50.l, 0x7fff, v92.h, s3
	v_cndmask_b16 v92.h, 0x7fff, v93.h, s4
	v_cndmask_b16 v92.l, 0x7fff, v94.h, s5
	v_cndmask_b16 v93.h, 0x7fff, v95.h, s6
	v_cndmask_b16 v93.l, 0x7fff, v96.h, s7
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v11, v11, v113 :: v_dual_and_b32 v108, 1, v118
	v_dual_mul_f32 v13, v13, v113 :: v_dual_add_f32 v100, v100, v106
	.loc	1 1019 30                       ; attention.py:1019:30
...
.Ltmp12:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v94, v50, s45, 0xfedcba98 op_sel:[1,0]
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v15, v15, v113 :: v_dual_add_f32 v114, v109, v100
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_perm_b32 v96, v94, v50, v67
	v_perm_b32 v97, v94, v50, v68
	v_perm_b32 v98, v95, v92, v67
	v_perm_b32 v99, v95, v92, v68
	v_perm_b32 v100, v101, v93, v67
	v_perm_b32 v101, v101, v93, v68
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_load_b128 v[104:107], v64 offset:1536
	ds_load_b128 v[92:95], v65 offset:1024
	ds_load_b128 v[108:111], v65 offset:1536
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v115.h, 0x7fff, v102.h, s8
	v_cndmask_b16 v115.l, 0x7fff, v103.h, s9
.Ltmp13:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:972:24 ]
	v_permlanex16_b32 v50, v114, s45, 0xfedcba98 op_sel:[1,0]
.Ltmp14:
	.loc	1 1018 23                       ; attention.py:1018:23
	...
	v_dual_mul_f32 v1, v1, v113 :: v_dual_add_f32 v50, v114, v50
	...
	.loc	1 1019 30                       ; attention.py:1019:30
	v_perm_b32 v102, v103, v115, v67
	v_perm_b32 v103, v103, v115, v68
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 119
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 46
