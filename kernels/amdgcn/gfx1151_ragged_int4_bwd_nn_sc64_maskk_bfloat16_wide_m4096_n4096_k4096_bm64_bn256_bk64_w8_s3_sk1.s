...
; %bb.4:                                ; %.lr.ph12
	...
	v_dual_mov_b32 v143, 0 :: v_dual_lshlrev_b32 v6, 2, v126
	v_dual_mov_b32 v141, 0 :: v_dual_and_b32 v2, 32, v2
	v_dual_mov_b32 v136, 0 :: v_dual_add_nc_u32 v7, 16, v5
	s_bitcmp1_b32 s9, 0
	.loc	1 1115 19                       ; ragged.py:1115:19
	...
	v_dual_mov_b32 v139, 0 :: v_dual_and_b32 v4, 28, v4
	v_dual_mov_b32 v134, 0 :: v_dual_lshlrev_b32 v7, 1, v126
	.loc	1 1115 19                       ; ragged.py:1115:19
	s_lshl_b32 s3, s7, 8
	s_lshl_b32 s2, s2, 8
	...
	.loc	1 1115 19                       ; ragged.py:1115:19
	v_add3_u32 v192, s2, v6, v1
	v_add3_u32 v193, s2, v5, v1
	v_dual_mov_b32 v137, 0 :: v_dual_add_nc_u32 v194, v2, v4
	v_dual_mov_b32 v132, 0 :: v_dual_add_nc_u32 v195, 0, v7
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v57, v57, v1 :: v_dual_add_nc_u32 v192, s35, v192
	v_dual_mul_f32 v42, v42, v2 :: v_dual_add_nc_u32 v193, s35, v193
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 215
