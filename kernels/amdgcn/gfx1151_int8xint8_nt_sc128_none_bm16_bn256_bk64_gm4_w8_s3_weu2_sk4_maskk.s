	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_mad_u64_u32 v[8:9], null, s6, v4, v[1:2]
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_lshl_add_u32 v9, s6, 6, v8
	v_lshl_add_u32 v12, s6, 7, v8
	...
	buffer_load_b128 v[20:23], v13, s[24:27], 0 offen
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	buffer_load_b128 v[24:27], v14, s[24:27], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v7, 0x1c00, v11
.Ltmp22:
...
.Ltmp23:
	...
	v_add3_u32 v14, v5, v1, 0x200
	v_xor_b32_e32 v39, 16, v36
	v_xor_b32_e32 v38, 32, v36
	v_add3_u32 v16, v8, v1, 0x200
	v_add3_u32 v44, v4, v1, 0x200
	v_add3_u32 v15, v7, v1, 0x200
	v_add3_u32 v45, v3, v2, 0x200
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v52, s7, v38
	v_add_nc_u32_e32 v53, s7, v37
	...
	v_fmac_f32_e32 v29, v58, v90
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v62, v62, v98 :: v_dual_add_nc_u32 v129, s18, v13
	v_dual_mul_f32 v61, v61, v98 :: v_dual_add_nc_u32 v130, s41, v12
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v20, v50, v82 :: v_dual_fmac_f32 v21, v51, v83
	v_dual_fmac_f32 v22, v52, v84 :: v_dual_fmac_f32 v23, v53, v85
	v_dual_fmac_f32 v24, v54, v86 :: v_dual_fmac_f32 v25, v55, v87
	v_dual_fmac_f32 v27, v57, v89 :: v_dual_fmac_f32 v30, v59, v91
	v_fmac_f32_e32 v33, v62, v94
	v_dual_fmac_f32 v31, v60, v92 :: v_dual_fmac_f32 v32, v61, v93
...
; %bb.9:
	...
	s_mov_b32 s27, s20
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v62, s27 :: v_dual_add_nc_u32 v5, s16, v42
	v_dual_mov_b32 v58, s23 :: v_dual_add_nc_u32 v15, s16, v40
	.loc	1 350 22 is_stmt 1              ; generate_amdgcn.py:350:22
	ds_load_b128 v[1:4], v5 offset:8192
	ds_load_b128 v[11:14], v5
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v56, s21 :: v_dual_add_nc_u32 v5, s14, v39
	v_dual_mov_b32 v59, s24 :: v_dual_add_nc_u32 v16, s14, v36
	v_dual_mov_b32 v61, s26 :: v_dual_add_nc_u32 v8, s16, v41
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v60, s25 :: v_dual_add_nc_u32 v7, s16, v43
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[95:98], v7
	ds_load_b128 v[99:102], v7 offset:8192
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	v_wmma_i32_16x16x16_iu8 v[55:62], v[1:4], v[87:90], v[55:62] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_10:
	...
	s_cmp_lt_i32 s6, s34
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v1, v18, s6, 1
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v2, v17, s7, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
