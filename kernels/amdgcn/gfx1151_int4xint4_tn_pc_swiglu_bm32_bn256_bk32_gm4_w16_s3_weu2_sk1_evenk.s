	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[5:6], null, s5, v3, v[2:3]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	...
	buffer_load_b64 v[12:13], v9, s[20:23], 0 offen
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
...
; %bb.4:                                ; %.lr.ph
	...
	v_add3_u32 v3, s29, v3, 32
	s_lshl_b32 s22, s27, 8
...
.Ltmp12:
	...
	v_dual_mov_b32 v12, v10 :: v_dual_add_nc_u32 v5, 0x41, v4
	v_dual_mov_b32 v13, v10 :: v_dual_add_nc_u32 v4, 64, v4
	v_mov_b32_e32 v14, v10
.Ltmp13:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add3_u32 v35, v3, s14, v1
	...
	v_add3_u32 v5, v5, s22, v2
	v_add3_u32 v2, v4, s22, v2
	v_mov_b32_e32 v4, v10
	v_mov_b32_e32 v7, v10
	v_mov_b32_e32 v8, v10
	v_subrev_nc_u32_e32 v36, s23, v5
	v_subrev_nc_u32_e32 v37, s23, v2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	buffer_load_u8 v58, v35, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b64 v[38:39], v37, s[20:23], 0 offen
	buffer_load_b64 v[40:41], v36, s[20:23], 0 offen
	s_mov_b32 s29, s0
	s_mov_b32 s0, s15
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v42, s29, v66
	s_mov_b32 s15, s26
	s_mov_b32 s26, s3
	s_mov_b32 s3, s24
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v43, s15, v9
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v44, s3, v9
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v45, v42 offset:96
	ds_load_u8 v46, v42 offset:64
	ds_load_u8 v47, v42
	ds_load_u8 v48, v42 offset:16
	ds_load_u8 v49, v42 offset:32
	ds_load_u8 v50, v42 offset:112
	ds_load_u8 v51, v42 offset:80
	ds_load_u8 v52, v42 offset:48
	ds_load_u8 v53, v43 offset:1280
	ds_load_u8 v54, v43 offset:1792
	ds_load_u8 v55, v43 offset:1536
	ds_load_u8 v56, v43 offset:1024
	ds_load_u8 v57, v43 offset:256
	ds_load_u8 v59, v43 offset:768
	ds_load_u8 v60, v43 offset:512
	ds_load_u8 v61, v43
	ds_load_u8 v62, v43 offset:3328
	ds_load_u8 v63, v43 offset:3840
	ds_load_u8 v64, v43 offset:3584
	ds_load_u8 v65, v43 offset:3072
	ds_load_u8 v68, v43 offset:2304
	ds_load_u8 v69, v43 offset:2816
	ds_load_u8 v70, v43 offset:2560
	ds_load_u8 v43, v43 offset:2048
	ds_load_u8 v71, v42 offset:160
	ds_load_u8 v72, v42 offset:128
	ds_load_u8 v73, v42 offset:224
	ds_load_u8 v74, v42 offset:192
	ds_load_u8 v75, v42 offset:240
	ds_load_u8 v76, v42 offset:208
	ds_load_u8 v77, v42 offset:176
	ds_load_u8 v78, v42 offset:144
	ds_load_u8 v79, v42 offset:416
	ds_load_u8 v80, v42 offset:384
	ds_load_u8 v81, v42 offset:480
	ds_load_u8 v82, v42 offset:448
	ds_load_u8 v83, v42 offset:496
	ds_load_u8 v84, v42 offset:464
	ds_load_u8 v85, v42 offset:432
	ds_load_u8 v86, v42 offset:400
	ds_load_u8 v87, v42 offset:288
	ds_load_u8 v88, v42 offset:256
	ds_load_u8 v89, v42 offset:352
	ds_load_u8 v90, v42 offset:320
	ds_load_u8 v91, v42 offset:368
	ds_load_u8 v92, v42 offset:336
	ds_load_u8 v93, v42 offset:304
	ds_load_u8 v42, v42 offset:272
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v94, v44 offset:1280
	ds_load_u8 v95, v44 offset:1792
	ds_load_u8 v96, v44 offset:1536
	ds_load_u8 v97, v44 offset:1024
	ds_load_u8 v98, v44 offset:256
	ds_load_u8 v99, v44 offset:768
	ds_load_u8 v100, v44 offset:512
	ds_load_u8 v101, v44
	ds_load_u8 v102, v44 offset:3328
	ds_load_u8 v103, v44 offset:3840
	ds_load_u8 v104, v44 offset:3584
	ds_load_u8 v105, v44 offset:3072
	ds_load_u8 v106, v44 offset:2304
	ds_load_u8 v107, v44 offset:2816
	ds_load_u8 v108, v44 offset:2560
	...
	v_perm_b32 v46, v47, v49, 0xc0c0004
	v_perm_b32 v47, v56, v53, 0xc0c0004
	v_perm_b32 v49, v55, v54, 0xc0c0004
	v_perm_b32 v53, v61, v57, 0xc0c0004
	v_perm_b32 v54, v60, v59, 0xc0c0004
	s_waitcnt lgkmcnt(30)
	v_perm_b32 v55, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v56, v82, v81, 0xc0c0004
	...
	v_perm_b32 v52, v48, v52, 0xc0c0004
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v74, v97, v94, 0xc0c0004
	v_perm_b32 v75, v96, v95, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v76, v101, v98, 0xc0c0004
	...
	v_lshl_or_b32 v56, v81, 16, v80
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[18:25], v[44:45], v[42:43], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[44:45], v[50:51], v[26:33] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[54:55], v[42:43], v[10:17] neg_lo:[1,1,0]
	...
	.loc	1 125 22                        ; generate_amdgcn.py:125:22
	v_add_nc_u32_e32 v109, s1, v0
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[18:25], v[48:49], v[46:47], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[48:49], v[52:53], v[26:33] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[56:57], v[46:47], v[10:17] neg_lo:[1,1,0]
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v109, v58 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v42, v[38:39], v[40:41] offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
; %bb.9:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v36, s22, v80
	v_add_nc_u32_e32 v37, s22, v79
	v_add_nc_u32_e32 v34, s22, v82
	v_add_nc_u32_e32 v40, s22, v83
	v_add_nc_u32_e32 v35, s22, v81
	v_add_nc_u32_e32 v38, s22, v78
	v_add_nc_u32_e32 v39, s22, v77
	v_add_nc_u32_e32 v41, s22, v75
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v36, v36
	ds_load_u8 v37, v37
	ds_load_u8 v34, v34
	...
	ds_load_u8 v41, v41
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v44, s22, v73
	v_add_nc_u32_e32 v45, s22, v72
	v_add_nc_u32_e32 v42, s22, v76
	v_add_nc_u32_e32 v48, s22, v69
	v_add_nc_u32_e32 v46, s22, v71
	v_add_nc_u32_e32 v47, s22, v70
	v_add_nc_u32_e32 v49, s22, v68
	v_add_nc_u32_e32 v43, s22, v74
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v44, v44
	ds_load_u8 v45, v45
	ds_load_u8 v103, v42
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v20, s24, v80
	v_add_nc_u32_e32 v21, s24, v79
	v_add_nc_u32_e32 v18, s24, v82
	v_add_nc_u32_e32 v24, s24, v83
	v_add_nc_u32_e32 v19, s24, v81
	v_add_nc_u32_e32 v22, s24, v78
	v_add_nc_u32_e32 v23, s24, v77
	v_add_nc_u32_e32 v25, s24, v75
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v20, v20
	ds_load_u8 v21, v21
	ds_load_u8 v18, v18
	...
	ds_load_u8 v25, v25
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v28, s24, v73
	v_add_nc_u32_e32 v29, s24, v72
	v_add_nc_u32_e32 v26, s24, v76
	v_add_nc_u32_e32 v33, s24, v68
	v_add_nc_u32_e32 v27, s24, v74
	v_add_nc_u32_e32 v30, s24, v71
	v_add_nc_u32_e32 v31, s24, v70
	v_add_nc_u32_e32 v32, s24, v69
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(30)
...
.LBB0_12:                               ; %._crit_edge86
	...
	s_waitcnt lgkmcnt(10)
	v_dual_mov_b32 v53, v29 :: v_dual_add_nc_u32 v50, s15, v66
	s_waitcnt lgkmcnt(9)
...
.LBB0_17:
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v29, s5, v23
	v_or_b32_e32 v30, s5, v22
	.loc	1 143 14 is_stmt 0              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v18, 1, v18
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v23, s0, v23, 1
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v19, s5, v19
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 120
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
