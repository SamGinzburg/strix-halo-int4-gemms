	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp18:
	...
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v4, 0x70, v9
.Ltmp19:
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
...
.Ltmp26:
	...
	s_lshl_b32 s1, s2, 7
	s_mov_b32 s2, s0
	v_subrev_nc_u32_e32 v31, s1, v4
	v_or_b32_e32 v26, 8, v19
	v_subrev_nc_u32_e32 v30, s1, v3
	s_mov_b32 s1, s0
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	v_mov_b32_e32 v25, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_add3_u32 v32, v2, s16, v5
	v_add3_u32 v33, v1, s16, v5
	s_mov_b32 s16, s4
	s_mov_b32 s4, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v44, v33, s[16:19], 0 offen
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	buffer_load_b128 v[36:39], v31, s[20:23], 0 offen
	.loc	1 342 26                        ; generate_amdgcn.py:342:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v45, v32, s[16:19], 0 offen
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	buffer_load_b128 v[40:43], v30, s[20:23], 0 offen
	...
	buffer_load_u16 v77, v55, s[4:7], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0xf
	...
	ds_load_u8 v36, v18 offset:8400
	ds_load_u8 v37, v18 offset:8432
	ds_load_u8 v38, v18 offset:8416
	ds_load_u8 v39, v18 offset:8384
	ds_load_u8 v40, v18 offset:8336
	ds_load_u8 v41, v18 offset:8368
	ds_load_u8 v42, v18 offset:8352
	ds_load_u8 v43, v18 offset:8320
	ds_load_u8 v44, v18 offset:8272
	ds_load_u8 v45, v18 offset:8304
	ds_load_u8 v46, v18 offset:8288
	ds_load_u8 v47, v18 offset:8256
	ds_load_u8 v48, v18 offset:8192
	ds_load_u8 v49, v18 offset:8208
	ds_load_u8 v50, v18 offset:8224
	ds_load_u8 v51, v18 offset:8240
	ds_load_u8 v52, v20 offset:1664
	ds_load_u8 v53, v20 offset:1920
	ds_load_u8 v54, v20 offset:1792
	ds_load_u8 v55, v20 offset:1536
	ds_load_u8 v56, v20 offset:1152
	ds_load_u8 v57, v20 offset:1408
	ds_load_u8 v58, v20 offset:1280
	ds_load_u8 v59, v20 offset:1024
	ds_load_u8 v60, v20 offset:640
	ds_load_u8 v61, v20 offset:896
	ds_load_u8 v62, v20 offset:768
	ds_load_u8 v63, v20 offset:512
	ds_load_u8 v64, v20 offset:128
	ds_load_u8 v65, v20 offset:384
	ds_load_u8 v66, v20 offset:256
	ds_load_u8 v67, v20
	ds_load_u8 v68, v18 offset:8656
	ds_load_u8 v69, v18 offset:8688
	ds_load_u8 v70, v18 offset:8672
	ds_load_u8 v71, v18 offset:8640
	ds_load_u8 v72, v18 offset:8592
	ds_load_u8 v73, v18 offset:8624
	ds_load_u8 v74, v18 offset:8608
	ds_load_u8 v75, v18 offset:8576
	ds_load_u8 v94, v18 offset:8528
	ds_load_u8 v95, v18 offset:8560
	ds_load_u8 v96, v18 offset:8544
	ds_load_u8 v97, v18 offset:8512
	ds_load_u8 v98, v18 offset:8464
	ds_load_u8 v99, v18 offset:8496
	ds_load_u8 v100, v18 offset:8480
	ds_load_u8 v101, v18 offset:8448
	ds_load_u8 v102, v20 offset:3712
	ds_load_u8 v103, v20 offset:3968
	ds_load_u8 v104, v20 offset:3840
	ds_load_u8 v105, v20 offset:3584
	ds_load_u8 v106, v20 offset:3200
	ds_load_u8 v107, v20 offset:3456
	ds_load_u8 v108, v20 offset:3328
	ds_load_u8 v109, v20 offset:3072
	ds_load_u8 v110, v20 offset:2688
	ds_load_u8 v111, v20 offset:2944
	ds_load_u8 v112, v20 offset:2816
	ds_load_u8 v113, v20 offset:2560
	ds_load_u8 v114, v20 offset:2176
	ds_load_u8 v115, v20 offset:2432
	ds_load_u8 v116, v20 offset:2304
	ds_load_u8 v117, v20 offset:2048
	ds_load_u8 v118, v18 offset:8912
	ds_load_u8 v119, v18 offset:8944
	ds_load_u8 v120, v18 offset:8928
	ds_load_u8 v121, v18 offset:8896
	ds_load_u8 v122, v18 offset:8848
	ds_load_u8 v123, v18 offset:8880
	ds_load_u8 v124, v18 offset:8864
	ds_load_u8 v125, v18 offset:8832
	ds_load_u8 v126, v18 offset:8784
	ds_load_u8 v127, v18 offset:8816
	ds_load_u8 v128, v18 offset:8800
	ds_load_u8 v129, v18 offset:8768
	ds_load_u8 v130, v18 offset:8720
	ds_load_u8 v131, v18 offset:8752
	ds_load_u8 v132, v18 offset:8736
	ds_load_u8 v133, v18 offset:8704
	ds_load_u8 v134, v20 offset:5760
	ds_load_u8 v135, v20 offset:6016
	ds_load_u8 v136, v20 offset:5888
	ds_load_u8 v137, v20 offset:5632
	ds_load_u8 v138, v20 offset:5248
	ds_load_u8 v139, v20 offset:5504
	ds_load_u8 v140, v20 offset:5376
	ds_load_u8 v141, v20 offset:5120
	ds_load_u8 v142, v20 offset:4736
	ds_load_u8 v143, v20 offset:4992
	ds_load_u8 v144, v20 offset:4864
	ds_load_u8 v145, v20 offset:4608
	ds_load_u8 v146, v20 offset:4224
	ds_load_u8 v147, v20 offset:4480
	ds_load_u8 v148, v20 offset:4352
	ds_load_u8 v149, v20 offset:4096
	ds_load_u8 v150, v18 offset:9168
	ds_load_u8 v151, v18 offset:9200
	ds_load_u8 v152, v18 offset:9184
	ds_load_u8 v153, v18 offset:9152
	ds_load_u8 v154, v18 offset:9104
	ds_load_u8 v155, v18 offset:9136
	ds_load_u8 v156, v18 offset:9120
	ds_load_u8 v157, v18 offset:9088
	ds_load_u8 v158, v18 offset:9040
	ds_load_u8 v159, v18 offset:9072
	ds_load_u8 v160, v18 offset:9056
	ds_load_u8 v161, v18 offset:9024
	ds_load_u8 v162, v18 offset:8976
	ds_load_u8 v163, v18 offset:9008
	ds_load_u8 v164, v18 offset:8992
	ds_load_u8 v165, v18 offset:8960
	ds_load_u8 v166, v20 offset:7808
	ds_load_u8 v167, v20 offset:8064
	ds_load_u8 v168, v20 offset:7936
	ds_load_u8 v169, v20 offset:7680
	ds_load_u8 v170, v20 offset:7296
	ds_load_u8 v171, v20 offset:7552
	ds_load_u8 v172, v20 offset:7424
	ds_load_u8 v173, v20 offset:7168
	ds_load_u8 v174, v20 offset:6784
	ds_load_u8 v175, v20 offset:7040
	ds_load_u8 v176, v20 offset:6912
	ds_load_u8 v177, v20 offset:6656
	ds_load_u8 v178, v20 offset:6272
	ds_load_u8 v179, v20 offset:6528
	ds_load_u8 v180, v20 offset:6400
	ds_load_u8 v181, v20 offset:6144
	...
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v46, v53, v46 :: v_dual_lshlrev_b32 v57, 16, v81
	s_waitcnt vmcnt(11)
	v_dual_mul_f32 v49, v53, v49 :: v_dual_lshlrev_b32 v58, 16, v82
	v_dual_mul_f32 v47, v53, v47 :: v_dual_add_nc_u32 v30, s28, v30
	v_mul_f32_e32 v37, v52, v37
	v_dual_mul_f32 v36, v52, v36 :: v_dual_add_nc_u32 v31, s28, v31
	v_dual_mul_f32 v39, v52, v39 :: v_dual_lshlrev_b32 v54, 16, v78
	v_dual_mul_f32 v38, v52, v38 :: v_dual_lshlrev_b32 v55, 16, v79
	v_dual_mul_f32 v41, v52, v41 :: v_dual_lshlrev_b32 v56, 16, v80
	s_waitcnt vmcnt(10)
	v_dual_mul_f32 v40, v52, v40 :: v_dual_lshlrev_b32 v59, 16, v83
	s_waitcnt vmcnt(9)
	v_dual_mul_f32 v43, v52, v43 :: v_dual_lshlrev_b32 v60, 16, v84
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v51, v53, v51 :: v_dual_lshlrev_b32 v62, 16, v86
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v42, v52, v42 :: v_dual_lshlrev_b32 v63, 16, v87
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v17, v39, v59 :: v_dual_lshlrev_b32 v66, 16, v90
	s_waitcnt vmcnt(2)
	v_dual_fmac_f32 v16, v38, v58 :: v_dual_lshlrev_b32 v67, 16, v91
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v48, v53, v48 :: v_dual_lshlrev_b32 v61, 16, v85
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v25, v37, v55 :: v_dual_lshlrev_b32 v64, 16, v88
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v50, v53, v50 :: v_dual_lshlrev_b32 v65, 16, v89
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v13, v36, v54 :: v_dual_lshlrev_b32 v68, 16, v92
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v14, v40, v62 :: v_dual_lshlrev_b32 v69, 16, v93
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v45, v53, v45
	v_mul_f32_e32 v44, v53, v44
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v15, v41, v63 :: v_dual_fmac_f32 v12, v42, v66
	v_dual_fmac_f32 v11, v43, v67 :: v_dual_fmac_f32 v16, v46, v61
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v13, v44, v57
	v_dual_fmac_f32 v25, v45, v56 :: v_dual_fmac_f32 v14, v48, v65
	v_dual_fmac_f32 v17, v47, v60 :: v_dual_fmac_f32 v12, v50, v69
	v_fmac_f32_e32 v15, v49, v64
	v_fmac_f32_e32 v11, v51, v68
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
...
.Ltmp27:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 182
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
