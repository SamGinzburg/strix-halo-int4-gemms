...
.Ltmp0:
	...
	.loc	1 587 61 is_stmt 1              ; attention.py:587:61
	...
	v_lshl_or_b32 v64, s3, 8, v52
	v_xor_b32_e32 v41, v56, v41
	v_dual_mov_b32 v49, 0x5410 :: v_dual_and_b32 v62, 16, v0
	...
	.loc	1 707 13                        ; attention.py:707:13
	v_mad_u64_u32 v[40:41], null, s35, v64, v[40:41]
	...
	v_add_nc_u32_e32 v61, 0, v69
	.loc	1 707 13                        ; attention.py:707:13
	s_mul_i32 s3, s3, s35
	v_mov_b32_e32 v0, v24
	s_lshl_b32 s3, s3, 6
	v_dual_mov_b32 v8, v24 :: v_dual_add_nc_u32 v55, 0, v55
	v_lshl_add_u32 v62, v47, 3, s3
	...
	.loc	1 585 26                        ; attention.py:585:26
	s_waitcnt vmcnt(1)
	ds_bpermute_b32 v64, v68, v42
	ds_bpermute_b32 v70, v65, v42
	.loc	1 707 13                        ; attention.py:707:13
	v_mad_u64_u32 v[41:42], null, s34, v67, v[46:47]
	.loc	1 585 26                        ; attention.py:585:26
	ds_bpermute_b32 v46, v68, v43
	ds_bpermute_b32 v67, v65, v43
	ds_bpermute_b32 v69, v68, v44
	ds_bpermute_b32 v71, v65, v44
	ds_bpermute_b32 v68, v68, v45
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v2, v24 :: v_dual_and_b32 v47, 0x540054, v43
	.loc	1 585 26                        ; attention.py:585:26
	s_waitcnt lgkmcnt(6)
	v_cndmask_b32_e64 v42, v70, v64, s1
	v_cndmask_b32_e64 v44, v64, v70, s1
	s_waitcnt lgkmcnt(4)
	v_cndmask_b32_e64 v43, v67, v46, s1
	v_lshl_or_b32 v64, v47, 4, v47
	...
	.loc	1 585 26                        ; attention.py:585:26
	v_cndmask_b32_e64 v45, v46, v67, s1
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v46, v71, v69, s1
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v47, v65, v68, s1
	v_cndmask_b32_e64 v49, v68, v65, s1
	v_lshl_or_b32 v67, v48, 4, v48
	v_mov_b32_e32 v4, v24
	v_cndmask_b32_e64 v48, v69, v71, s1
	v_and_b32_e32 v64, 0x5040504, v64
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v68, v24 :: v_dual_and_b32 v65, 0x7060706, v67
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v67, v68 :: v_dual_add_nc_u32 v62, s37, v62
	.loc	1 712 32                        ; attention.py:712:32
	...
	v_dual_mul_f32 v77, v63, v77 :: v_dual_add_nc_u32 v40, s38, v40
	...
	v_dual_mul_f32 v78, s36, v78 :: v_dual_mul_f32 v73, s36, v73
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v72, s36, v72 :: v_dual_mul_f32 v75, s36, v75
	v_mul_f32_e32 v74, s36, v74
...
.Ltmp6:
	...
	v_dual_mul_f32 v82, v87, v82 :: v_dual_and_b32 v83, 1, v83
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 768 62 is_stmt 1              ; attention.py:768:62
	v_dual_sub_f32 v81, v81, v94 :: v_dual_and_b32 v72, 1, v89
	.loc	1 767 74                        ; attention.py:767:74
	v_sub_f32_e32 v87, v66, v94
	.loc	1 814 30                        ; attention.py:814:30
	...
	v_cndmask_b16 v66.l, 0x7fff, v72.h, s7
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v72, 0, v79, s2
	.loc	1 768 62 is_stmt 0              ; attention.py:768:62
	v_sub_f32_e32 v78, v78, v94
	v_dual_sub_f32 v74, v74, v94 :: v_dual_and_b32 v85, 1, v85
	...
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v84, 0, v75, s2
	...
	v_cndmask_b32_e64 v71, 0, v78, s2
	...
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v81, 0, v76, s2
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v90.l, v79.h
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v27, v27, v93 :: v_dual_and_b32 v66, 1, v83
	v_dual_mul_f32 v29, v29, v93 :: v_dual_and_b32 v68, 1, v68
	s_delay_alu instid0(VALU_DEP_4)
.Ltmp7:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_add_f32_e32 v76, v84, v81
.Ltmp8:
	.loc	1 768 62                        ; attention.py:768:62
	...
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v17, v17, v93 :: v_dual_and_b32 v90, 1, v90
	v_dual_mul_f32 v21, v21, v93 :: v_dual_and_b32 v86, 1, v86
	.loc	1 816 30                        ; attention.py:816:30
	...
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v78, 0, v80, s2
	v_cndmask_b32_e64 v80, 0, v73, s2
.Ltmp9:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_add_f32_e32 v73, v72, v71
.Ltmp10:
	.loc	1 815 23                        ; attention.py:815:23
...
.Ltmp12:
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v91.l, v78.h
.Ltmp13:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_add_f32_e32 v75, v80, v79
.Ltmp14:
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp15:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_dual_add_f32 v83, v73, v74 :: v_dual_and_b32 v88, 1, v91
	v_dual_add_f32 v87, v75, v76 :: v_dual_and_b32 v82, 1, v82
.Ltmp16:
	.loc	1 816 30                        ; attention.py:816:30
...
.Ltmp17:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_dual_add_f32 v82, v83, v87 :: v_dual_mul_f32 v9, v9, v93
.Ltmp18:
	.loc	1 816 30                        ; attention.py:816:30
	v_add3_u32 v83, v84, v89, 0x7fff
	v_cndmask_b16 v84.h, 0x7fff, v68.h, s1
	v_cndmask_b16 v84.l, 0x7fff, v66.h, s3
	v_add3_u32 v77, v77, v85, 0x7fff
	v_cndmask_b16 v66.l, 0x7fff, v78.h, s5
	v_cndmask_b16 v85.h, 0x7fff, v79.h, s6
	v_cndmask_b16 v85.l, 0x7fff, v80.h, s7
.Ltmp19:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
	v_permlanex16_b32 v68, v82, s33, 0xfedcba98 op_sel:[1,0]
.Ltmp20:
	.loc	1 816 30                        ; attention.py:816:30
	v_cndmask_b16 v86.h, 0x7fff, v81.h, s8
	v_cndmask_b16 v86.l, 0x7fff, v83.h, s9
	v_permlanex16_b32 v78, v84, s33, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b16 v66.h, 0x7fff, v77.h, s4
.Ltmp21:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_dual_add_f32 v68, v82, v68 :: v_dual_mul_f32 v23, v23, v93
.Ltmp22:
	.loc	1 816 30                        ; attention.py:816:30
	...
	v_dual_mul_f32 v11, v11, v93 :: v_dual_mov_b32 v66, v94
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 95
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 39
