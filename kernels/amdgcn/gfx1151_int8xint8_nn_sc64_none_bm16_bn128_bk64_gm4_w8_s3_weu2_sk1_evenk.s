	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s15, v3, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s19, s19
	s_mul_i32 s6, s6, s19
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_lshl_add_u32 v35, s15, 5, v9
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp17:
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v36, v5, v4, s3
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_add_i32 s25, s26, s2
.Ltmp19:
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	...
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_and_or_b32 v2, v2, 1, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v37, v3, v4
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v30, v27 offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v29, v[11:14]
	s_waitcnt vmcnt(3)
	ds_store_b128 v29, v[15:18] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v30, v28 offset:17408
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
...
.LBB0_3:                                ; %Flow73
	...
	v_or_b32_e32 v18, s24, v32
	s_ashr_i32 s0, s25, 6
	v_or_b32_e32 v26, s14, v2
	v_or_b32_e32 v25, s14, v6
	v_or_b32_e32 v24, s14, v7
	v_mul_lo_u32 v27, v18, s0
	v_or_b32_e32 v22, s14, v8
	v_or_b32_e32 v20, s14, v10
	v_or_b32_e32 v23, s14, v3
	v_or_b32_e32 v21, s14, v4
	v_or_b32_e32 v19, s14, v5
	s_and_not1_b32 vcc_lo, exec_lo, s10
	s_cbranch_vccnz .LBB0_6
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v1, 48, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v38, v27, s38, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cmp_lt_i32 s38, s0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v39, v26, s39, 1
	v_add_lshl_u32 v40, v25, s39, 1
	v_add_lshl_u32 v41, v24, s39, 1
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v42, v22, s39, 1
	v_add_lshl_u32 v43, v20, s39, 1
	v_add_lshl_u32 v44, v23, s39, 1
	v_add_lshl_u32 v45, v21, s39, 1
	v_add_lshl_u32 v46, v19, s39, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v87, v38, s[24:27], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	buffer_load_u16 v88, v39, s[28:31], 0 offen
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v38, s40, v9
	v_add_nc_u32_e32 v39, s40, v35
	.loc	1 378 22 is_stmt 0              ; generate_amdgcn.py:378:22
	s_clause 0x1
	...
	s_mov_b32 s10, s1
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v38, s38, v28
	v_add_nc_u32_e32 v39, s38, v29
	s_mov_b32 s1, s19
	v_add_nc_u32_e32 v40, s38, v30
	v_add_nc_u32_e32 v41, s38, v31
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v42, s1, v34, v32
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v62, v54, v62 :: v_dual_add_nc_u32 v137, s34, v33
	...
	v_fmac_f32_e32 v16, v57, v40
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v54, v54, v61
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v60, v43 :: v_dual_add_nc_u32 v136, s39, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v17, v56, v39 :: v_dual_fmac_f32 v14, v59, v42
...
; %bb.8:
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v7, s19, v40
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v49, s10, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v8, v7 offset:1664
	ds_load_u8 v9, v7 offset:1920
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s10, v31
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s10, v30
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v33, v37, v34, 0xc0c0004
	v_perm_b32 v34, v36, v35, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v45, s10, v29
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(4)
	...
	v_lshl_or_b32 v56, v9, 16, v8
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v8, v61, v57, 0xc0c0004
	v_perm_b32 v9, v60, v59, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	v_perm_b32 v9, v53, v9, 0xc0c0004
...
.LBB0_9:
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v34, v26, s4, 1
	v_add_lshl_u32 v35, v25, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v33, 0x80000000, v33, vcc_lo
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v36, v24, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_and_b32 s9, s9, 0xffff
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v38, v23, s4, 1
	v_add_lshl_u32 v37, v20, s4, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	v_add_lshl_u32 v36, v22, s4, 1
	v_add_lshl_u32 v41, v21, s4, 1
	v_add_lshl_u32 v42, v19, s4, 1
	s_and_b32 s17, s17, 0xffff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v43, 0x80000000, v37 :: v_dual_cndmask_b32 v36, 0x80000000, v36
	v_dual_cndmask_b32 v45, 0x80000000, v41 :: v_dual_cndmask_b32 v46, 0x80000000, v42
	s_clause 0x7
	buffer_load_u16 v41, v33, s[16:19], 0 offen
	buffer_load_u16 v42, v34, s[16:19], 0 offen
	buffer_load_u16 v37, v35, s[16:19], 0 offen
	buffer_load_u16 v38, v36, s[16:19], 0 offen
	buffer_load_u16 v35, v43, s[16:19], 0 offen
	buffer_load_u16 v36, v44, s[16:19], 0 offen
	buffer_load_u16 v33, v45, s[16:19], 0 offen
	buffer_load_u16 v34, v46, s[16:19], 0 offen
...
; %bb.10:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[45:52], v[53:56], v[28:31], v[45:52] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_mov_b32 v38, 0x5410 :: v_dual_mul_f32 v29, v28, v29
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v29, v29, v32, v17
	v_fma_f32 v7, v30, v7, v10
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v20, v11, v20 :: v_dual_lshlrev_b32 v13, 16, v26
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v16, v17, v43, v3
	v_fma_f32 v11, v11, v49, v9
	v_fma_f32 v17, v20, v47, v6
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 138
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
