	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_mov_b32_e32 v55, 0
	v_dual_mov_b32 v50, 0 :: v_dual_lshlrev_b32 v73, 1, v4
	v_dual_mov_b32 v47, 0 :: v_dual_mov_b32 v54, 0
	v_dual_mov_b32 v45, 0 :: v_dual_lshlrev_b32 v72, 1, v7
	...
	s_mov_b32 s36, s10
	s_max_i32 s44, s0, 1
	s_lshl_b32 s45, s23, 1
	s_lshl_b32 s46, s23, 6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	s_clause 0x1
	buffer_load_u16 v9, v73, s[40:43], 0 offen
	buffer_load_u16 v10, v72, s[40:43], 0 offen
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e32 vcc_lo, s1, v69
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_dual_mul_f32 v13, v77, v13 :: v_dual_mul_f32 v20, v76, v20
	...
	v_dual_mul_f32 v24, v76, v24 :: v_dual_add_nc_u32 v71, s45, v71
	.loc	1 214 26                        ; generate_amdgcn.py:214:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(9)
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v21, v76, v21 :: v_dual_fmac_f32 v46, v9, v32
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v31, 16, v31
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v23, v76, v23 :: v_dual_lshlrev_b32 v38, 16, v38
	.loc	1 233 13 is_stmt 0              ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v60, v17, v32 :: v_dual_fmac_f32 v59, v10, v33
	v_dual_fmac_f32 v56, v12, v35 :: v_dual_fmac_f32 v53, v13, v36
	v_fmac_f32_e32 v58, v18, v33
	v_dual_fmac_f32 v52, v14, v37 :: v_dual_fmac_f32 v57, v11, v34
	v_dual_fmac_f32 v48, v16, v31 :: v_dual_fmac_f32 v49, v15, v38
	v_dual_fmac_f32 v54, v20, v35 :: v_dual_fmac_f32 v55, v19, v34
	v_dual_fmac_f32 v50, v22, v37 :: v_dual_fmac_f32 v51, v21, v36
	v_fmac_f32_e32 v47, v23, v38
	v_fmac_f32_e32 v45, v24, v31
	.loc	1 188 9 is_stmt 1               ; generate_amdgcn.py:188:9
	s_cbranch_scc1 .LBB0_5
.LBB0_6:                                ; %._crit_edge
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v31, 32, v62
	.loc	1 195 26                        ; generate_amdgcn.py:195:26
	v_mul_lo_u32 v1, s35, v62
	s_mul_i32 s1, s34, s35
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_max_i32 s0, s0, 0
	v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v10, 0
	.loc	1 195 26                        ; generate_amdgcn.py:195:26
	v_mul_lo_u32 v2, s35, v31
	s_add_i32 s1, s1, s0
	...
	buffer_load_u16 v33, v2, s[28:31], 0 offen
...
.LBB0_8:
	...
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_dual_mov_b32 v30, 0x5410 :: v_dual_add_nc_u32 v7, 4, v5
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v10, v10, v26 :: v_dual_add_nc_u32 v21, 12, v5
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_mov_b32 s16, s10
	v_add_nc_u32_e32 v8, 8, v5
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v12, v12, v26 :: v_dual_add_nc_u32 v23, 20, v5
	v_dual_mul_f32 v9, v9, v26 :: v_dual_add_nc_u32 v22, 16, v5
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_cndmask_b32_e64 v7, 0x80000000, v7, s2
	buffer_load_u16 v6, v6, s[16:19], 0 offen
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v11, v11, v26 :: v_dual_add_nc_u32 v24, 24, v5
	v_dual_mul_f32 v14, v14, v26 :: v_dual_add_nc_u32 v5, 28, v5
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_cndmask_b32_e64 v21, 0x80000000, v21, s2
	.loc	1 245 18                        ; generate_amdgcn.py:245:18
	v_mul_lo_u32 v29, s23, v31
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v13, v13, v26 :: v_dual_and_b32 v0, 16, v0
	v_dual_mul_f32 v16, v16, v26 :: v_dual_and_b32 v27, 0x78, v61
	s_delay_alu instid0(VALU_DEP_3)
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v20, v20, v25 :: v_dual_mul_f32 v15, v15, v26
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_mul_lo_u32 v28, s23, v62
	s_mul_i32 s34, s34, s23
	s_mov_b32 s15, 0x76543210
	v_add3_u32 v27, s34, s33, v27
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_fma_f32 v9, v9, v6, v46
	v_fma_f32 v6, v17, v6, v60
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_waitcnt vmcnt(5)
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v10, v10, v7, v59
	v_fma_f32 v7, v18, v7, v58
	v_fma_f32 v13, v13, v22, v53
	v_fma_f32 v14, v14, v21, v52
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v8, 16, v8
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v16, v16, v5, v48
	v_fma_f32 v4, v4, v5, v45
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v5, v59, v10, s2
	v_cndmask_b32_e64 v7, v58, v7, s2
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_bfe_u32 v10, v9, 16, 1
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v13, v53, v13, s2
	v_cndmask_b32_e64 v14, v52, v14, s2
	v_cndmask_b32_e64 v6, v60, v6, s2
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v11, v11, v8, v57
	v_fma_f32 v12, v12, v17, v56
	v_fma_f32 v2, v2, v21, v50
	v_fma_f32 v1, v1, v22, v51
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v11, v57, v11, s2
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v17, v20, v17, v54
	v_fma_f32 v8, v19, v8, v55
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_bfe_u32 v19, v11, 16, 1
	v_bfe_u32 v20, v12, 16, 1
	v_cndmask_b16 v9.h, 0x7fff, v5.h, s1
	v_add3_u32 v5, v7, v10, 0x7fff
	v_cndmask_b16 v10.l, 0x7fff, v13.h, s7
	v_cndmask_b16 v10.h, 0x7fff, v14.h, s8
	...
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_cndmask_b16 v6.l, 0x7fff, v11.h, s3
	v_cndmask_b16 v5.l, 0x7fff, v6.h, s0
	v_cndmask_b16 v6.h, 0x7fff, v12.h, s4
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v23, 16, v24
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v8, v55, v8, s2
	v_cndmask_b32_e64 v17, v54, v17, s2
	v_cndmask_b32_e64 v16, v48, v16, s2
	v_cndmask_b32_e64 v4, v45, v4, s2
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v15, v15, v23, v49
	v_fma_f32 v3, v3, v23, v47
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_cndmask_b32_e64 v3, v47, v3, s2
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_cndmask_b16 v1.l, 0x7fff, v3.h, s14
	v_cndmask_b32_e32 v3, v9, v10, vcc_lo
	v_add3_u32 v2, v2, v20, 0x7fff
	v_cndmask_b16 v2.l, 0x7fff, v1.h, s10
	...
	v_cndmask_b32_e32 v12, 0x3276, v31, vcc_lo
	v_cmp_o_f32_e64 s12, v16, v16
	v_add3_u32 v16, v16, v24, 0x7fff
	v_add3_u32 v7, v8, v19, 0x7fff
	v_add3_u32 v8, v17, v18, 0x7fff
	v_cndmask_b16 v1.h, 0x7fff, v4.h, s13
	v_cndmask_b16 v11.l, 0x7fff, v15.h, s11
	v_cndmask_b16 v11.h, 0x7fff, v16.h, s12
	v_cndmask_b16 v0.l, 0x7fff, v7.h, s6
	v_cndmask_b16 v0.h, 0x7fff, v8.h, s5
	v_dual_cndmask_b32 v8, 0x1054, v30 :: v_dual_cndmask_b32 v7, v10, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v9, v11, v6 :: v_dual_cndmask_b32 v6, v6, v11
	v_cndmask_b32_e32 v10, v2, v5, vcc_lo
	v_lshl_or_b32 v4, v8, 8, v8
	v_lshl_or_b32 v8, v12, 8, v12
	...
	v_permlanex16_b32 v1, v3, s15, 0xfedcba98 op_sel:[1,0]
	v_and_b32_e32 v11, 0x5040504, v4
	v_and_b32_e32 v12, 0x7060706, v5
	v_permlanex16_b32 v3, v6, s15, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v5, v2, s15, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v13, v0, s15, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v0, v1, v7, v11
	v_perm_b32 v1, v1, v7, v12
	v_perm_b32 v2, v3, v9, v11
	v_perm_b32 v3, v3, v9, v12
	v_perm_b32 v4, v5, v10, v11
	v_perm_b32 v5, v5, v10, v12
	v_perm_b32 v6, v13, v8, v11
	v_perm_b32 v7, v13, v8, v12
	s_clause 0x1
	buffer_store_b128 v[0:3], v26, s[20:23], 0 offen
	buffer_store_b128 v[4:7], v27, s[20:23], 0 offen
	.loc	1 106 1                         ; generate_amdgcn.py:106:1
	s_endpgm
.Ltmp22:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 82
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.kd
