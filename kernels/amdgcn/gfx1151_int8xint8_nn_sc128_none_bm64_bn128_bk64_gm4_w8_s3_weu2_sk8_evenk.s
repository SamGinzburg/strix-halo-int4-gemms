	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp20:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[32:35], v11, s[20:23], 0 offen
	buffer_load_b128 v[36:39], v10, s[20:23], 0 offen
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s13, s30, 0x200
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	...
	buffer_load_b128 v[44:47], v10, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_clause 0x1
	buffer_load_b128 v[48:51], v8, s[4:7], 0 offen
	buffer_load_b128 v[52:55], v7, s[4:7], 0 offen
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	...
	v_perm_b32 v83, v45, v41, 0x5010400
	v_perm_b32 v45, v45, v41, 0x7030602
	v_perm_b32 v84, v46, v42, 0x5010400
	...
	v_lshlrev_b16 v32.l, 8, v56.l
	v_lshlrev_b16 v32.h, 8, v57.l
	v_lshlrev_b16 v33.l, 8, v58.l
	v_lshlrev_b16 v33.h, 8, v59.l
	v_and_b16 v47.l, 0xff, v86.l
	v_and_b16 v47.h, 0xff, v86.h
	v_lshlrev_b16 v34.l, 8, v60.l
	v_lshlrev_b16 v34.h, 8, v61.l
	...
	v_or_b16 v37.l, v45.l, v37.l
	v_or_b16 v37.h, v45.h, v37.h
	v_or_b16 v38.l, v46.l, v38.l
	v_or_b16 v38.h, v46.h, v38.h
	v_or_b16 v39.l, v47.l, v39.l
	v_or_b16 v39.h, v47.h, v39.h
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
...
; %bb.4:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v6, 0x401, v4
	v_and_or_b32 v5, 0x210, v15, v14
...
.Ltmp22:
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v83, s12, v5
	v_subrev_nc_u32_e32 v84, s12, v1
	s_mov_b32 s12, 0
	...
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v3, s27, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[122:125], v84, s[20:23], 0 offen
	buffer_load_b128 v[126:129], v83, s[20:23], 0 offen
	...
	s_cmp_lt_i32 s14, s1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v87, v62, s14, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v88, v60, s15, 1
	v_add_lshl_u32 v89, v59, s15, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v90, v58, s15, 1
	v_add_lshl_u32 v91, v57, s15, 1
	v_add_lshl_u32 v92, v56, s15, 1
	v_add_lshl_u32 v93, v55, s15, 1
	v_add_lshl_u32 v94, v54, s15, 1
	v_add_lshl_u32 v95, v53, s15, 1
	v_add_lshl_u32 v96, v52, s15, 1
	v_add_lshl_u32 v97, v51, s15, 1
	v_add_lshl_u32 v98, v50, s15, 1
	v_add_lshl_u32 v99, v48, s15, 1
	v_add_lshl_u32 v100, v46, s15, 1
	v_add_lshl_u32 v101, v49, s15, 1
	v_add_lshl_u32 v102, v47, s15, 1
	v_add_lshl_u32 v103, v45, s15, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_mul_f32_e32 v99, v118, v125
	v_mul_f32_e32 v125, v119, v125
	v_mul_f32_e32 v97, v118, v123
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_fmac_f32_e32 v16, v97, v133
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(6)
	v_lshlrev_b32_e32 v129, 16, v197
	v_lshlrev_b32_e32 v120, 16, v188
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v147, 16, v199
	v_lshlrev_b32_e32 v122, 16, v190
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v149, 16, v201
	v_lshlrev_b32_e32 v124, 16, v192
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v151, 16, v203
	v_lshlrev_b32_e32 v126, 16, v194
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v155, v118, v147 :: v_dual_add_nc_u32 v84, s31, v84
	v_dual_mul_f32 v157, v118, v149 :: v_dual_add_nc_u32 v206, s34, v71
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v127, 16, v195
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v100, v118, v126
	v_dual_mul_f32 v153, v118, v129 :: v_dual_lshlrev_b32 v150, 16, v202
	v_mul_f32_e32 v129, v119, v129
	v_dual_mul_f32 v94, v118, v120 :: v_dual_lshlrev_b32 v121, 16, v189
	v_dual_mul_f32 v147, v119, v147 :: v_dual_lshlrev_b32 v128, 16, v196
	v_mul_f32_e32 v96, v118, v122
	v_dual_mul_f32 v149, v119, v149 :: v_dual_lshlrev_b32 v146, 16, v198
	v_mul_f32_e32 v98, v118, v124
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_dual_mul_f32 v95, v118, v121 :: v_dual_add_nc_u32 v210, s34, v75
	...
	v_dual_mul_f32 v101, v118, v127 :: v_dual_add_nc_u32 v208, s34, v73
	v_mul_f32_e32 v127, v119, v127
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v13, v94, v130
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v152, v118, v128 :: v_dual_add_nc_u32 v83, s31, v83
	v_mul_f32_e32 v128, v119, v128
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v15, v96, v132
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v154, v118, v146 :: v_dual_add_nc_u32 v207, s34, v72
	v_mul_f32_e32 v146, v119, v146
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v17, v98, v134
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v156, v118, v148 :: v_dual_add_nc_u32 v205, s34, v70
	v_mul_f32_e32 v148, v119, v148
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v19, v100, v136
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v158, v118, v150 :: v_dual_add_nc_u32 v211, s34, v76
	v_mul_f32_e32 v150, v119, v150
	v_dual_mul_f32 v118, v118, v151 :: v_dual_add_nc_u32 v209, s34, v74
	v_mul_f32_e32 v119, v119, v151
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v14, v95, v131 :: v_dual_fmac_f32 v21, v152, v138
	v_dual_fmac_f32 v18, v99, v135 :: v_dual_fmac_f32 v23, v154, v140
	v_dual_fmac_f32 v20, v101, v137 :: v_dual_fmac_f32 v25, v156, v142
	v_dual_fmac_f32 v22, v153, v139 :: v_dual_fmac_f32 v27, v158, v144
	v_dual_fmac_f32 v24, v155, v141 :: v_dual_fmac_f32 v29, v120, v102
	v_dual_fmac_f32 v26, v157, v143 :: v_dual_fmac_f32 v31, v122, v104
	v_dual_fmac_f32 v28, v118, v145 :: v_dual_fmac_f32 v33, v124, v106
	v_dual_fmac_f32 v30, v121, v103 :: v_dual_fmac_f32 v35, v126, v108
	v_dual_fmac_f32 v32, v123, v105 :: v_dual_fmac_f32 v39, v129, v111
	v_dual_fmac_f32 v34, v125, v107 :: v_dual_fmac_f32 v41, v147, v113
	v_dual_fmac_f32 v36, v127, v109 :: v_dual_fmac_f32 v43, v149, v115
	v_dual_fmac_f32 v38, v128, v110 :: v_dual_fmac_f32 v37, v119, v117
	v_fmac_f32_e32 v40, v146, v112
	v_fmac_f32_e32 v42, v148, v114
	v_fmac_f32_e32 v44, v150, v116
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.11:
	...
	s_mov_b32 s23, s16
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s34, v144
	v_add_nc_u32_e32 v93, s34, v142
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v123, s23 :: v_dual_add_nc_u32 v94, s34, v143
	v_dual_mov_b32 v118, s18 :: v_dual_add_nc_u32 v95, s34, v141
	v_mov_b32_e32 v122, s22
	v_mov_b32_e32 v120, s20
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 212
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
