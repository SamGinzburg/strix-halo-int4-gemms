	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_or_b32_e32 v88, 0x7f0, v0
	v_or_b32_e32 v89, 0xbf0, v0
	v_or_b32_e32 v90, 0xff0, v0
...
.Ltmp11:
	...
	v_lshl_add_u32 v82, v106, 4, v3
	v_add_nc_u32_e32 v83, s26, v82
...
.Ltmp13:
	...
	v_add_nc_u32_e32 v84, s27, v82
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s5, 0x1ff
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add_nc_u32_e32 v1, s6, v81
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_add_nc_u32_e32 v43, 0, v94
	v_xor_b32_e32 v99, 0x330, v94
	v_xor_b32_e32 v100, 0x3a0, v94
	v_add_nc_u32_e32 v44, 0, v95
	v_add_nc_u32_e32 v45, 0, v96
	...
	s_waitcnt vmcnt(3)
	v_perm_b32 v18, v27, v23, 0x4000501
	v_perm_b32 v20, v27, v23, 0x6020703
	v_perm_b32 v27, v4, v3, 0x7060302
	...
	s_waitcnt vmcnt(1)
	v_perm_b32 v14, v35, v31, 0x4000501
	...
	ds_store_2addr_b32 v43, v27, v3 offset1:16
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v1, v18, v14, 0x7060302
	v_perm_b32 v3, v18, v14, 0x5040100
	v_perm_b32 v4, v20, v28, 0x7060302
	v_perm_b32 v5, v20, v28, 0x5040100
	v_perm_b32 v6, v21, v29, 0x7060302
	v_perm_b32 v7, v21, v29, 0x5040100
	v_perm_b32 v8, v22, v30, 0x7060302
	v_perm_b32 v9, v22, v30, 0x5040100
	v_perm_b32 v10, v23, v31, 0x7060302
	v_perm_b32 v11, v23, v31, 0x5040100
	v_perm_b32 v12, v24, v32, 0x7060302
	v_perm_b32 v13, v24, v32, 0x5040100
	v_perm_b32 v14, v25, v33, 0x7060302
	v_perm_b32 v15, v25, v33, 0x5040100
	v_perm_b32 v16, v26, v34, 0x7060302
	v_perm_b32 v17, v26, v34, 0x5040100
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b32_e32 v85, 0x1800, v171
	v_and_b32_e32 v86, 48, v2
...
.Ltmp14:
	...
	v_and_b32_e32 v85, 0x1800, v91
	v_bfe_i32 v3, v0, 5, 1
	v_dual_mov_b32 v140, 0 :: v_dual_add_nc_u32 v171, s25, v82
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s6, s5, 8
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v176, s33, v106
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s6, s34, s6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v18, s4, v173
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	...
	ds_load_u8 v16, v176 offset:640
	ds_load_u8 v17, v176 offset:320
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	ds_load_u8 v10, v176 offset:256
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v11, v12, v11, 0xc0c0004
	ds_load_u8 v12, v176 offset:448
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v13, v14, v13, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v14, v16, v15, 0xc0c0004
	v_lshl_or_b32 v28, v11, 16, v9
	ds_load_u8 v9, v176 offset:384
	ds_load_u8 v11, v176 offset:64
	v_lshl_or_b32 v27, v14, 16, v13
	ds_load_u8 v13, v176
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v9, v9, v12, 0xc0c0004
	ds_load_u8 v12, v176 offset:192
	...
	ds_load_u8 v9, v176 offset:128
	ds_load_u8 v10, v176 offset:1856
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v11, v13, v11, 0xc0c0004
	ds_load_u8 v13, v176 offset:1792
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v9, v9, v12, 0xc0c0004
	ds_load_u8 v12, v176 offset:1984
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v10, v13, v10, 0xc0c0004
	ds_load_u8 v13, v176 offset:1536
	v_lshl_or_b32 v25, v9, 16, v11
	ds_load_u8 v9, v176 offset:1920
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v158, v158, v22 :: v_dual_add_f32 v143, v143, v37
	v_dual_add_f32 v156, v156, v24 :: v_dual_add_f32 v141, v141, v39
	v_dual_add_f32 v154, v154, v26 :: v_dual_add_f32 v139, v139, v40
	...
	v_perm_b32 v61, v62, v61, 0xc0c0004
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v62, s33, v90
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v62, v62
	ds_load_u8 v63, v176 offset:4016
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v150, v150, v30 :: v_dual_add_f32 v135, v135, v44
	v_dual_add_f32 v148, v148, v32 :: v_dual_add_f32 v133, v133, v46
	v_dual_add_f32 v146, v146, v34 :: v_dual_add_f32 v131, v131, v48
	v_dual_add_f32 v144, v144, v36 :: v_dual_add_f32 v129, v129, v50
	v_dual_add_f32 v142, v142, v38 :: v_dual_add_f32 v127, v127, v52
	v_dual_add_f32 v138, v138, v41 :: v_dual_add_f32 v125, v125, v54
	v_dual_add_f32 v136, v136, v43 :: v_dual_add_f32 v123, v123, v56
	s_mov_b32 s33, s31
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v14, s4, v82
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[69:76], v[77:80], v[61:64], v[69:76] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v78, v18
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v18, s4, v171
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v161, v161, v79 :: v_dual_add_f32 v160, v160, v80
	v_dual_add_f32 v159, v159, v176 :: v_dual_add_f32 v134, v134, v45
	v_dual_add_f32 v121, v121, v178 :: v_dual_add_f32 v132, v132, v47
	v_dual_add_f32 v119, v119, v180 :: v_dual_add_f32 v130, v130, v49
	v_dual_add_f32 v117, v117, v182 :: v_dual_add_f32 v128, v128, v51
	v_dual_add_f32 v115, v115, v184 :: v_dual_add_f32 v126, v126, v53
	v_dual_add_f32 v113, v113, v70 :: v_dual_add_f32 v124, v124, v55
	v_add_f32_e32 v111, v111, v13
	v_dual_add_f32 v118, v118, v181 :: v_dual_add_f32 v109, v109, v11
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v72, v18, v14, 0x4000501
	v_perm_b32 v73, v18, v14, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v14, s4, v84
	v_add_nc_u32_e32 v18, s4, v83
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v74, v19, v15, 0x4000501
	v_perm_b32 v75, v19, v15, 0x6020703
	v_perm_b32 v76, v20, v16, 0x4000501
	v_perm_b32 v185, v20, v16, 0x6020703
	v_perm_b32 v186, v21, v17, 0x4000501
	v_perm_b32 v187, v21, v17, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[14:17], v14, s[20:23], 0 offen
	buffer_load_b128 v[18:21], v18, s[20:23], 0 offen
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	...
	s_add_i32 s30, s7, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v122, v122, v177 :: v_dual_add_nc_u32 v13, s30, v98
	v_dual_add_f32 v120, v120, v179 :: v_dual_add_nc_u32 v11, s30, v100
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s7, s5, 1
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_add_i32 s31, s6, 0x8000
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v12, s30, v99
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s5, s35
	s_mov_b32 s5, s7
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v188, v18, v14, 0x4000501
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v10, v19, v76, 0x7060302
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	ds_store_b128 v21, v[57:60] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v21, v188, v72, 0x7060302
	v_perm_b32 v57, v188, v72, 0x5040100
	v_add_nc_u32_e32 v58, s30, v94
	ds_store_2addr_b32 v58, v21, v57 offset1:16
	v_perm_b32 v21, v14, v73, 0x7060302
	v_perm_b32 v14, v14, v73, 0x5040100
	v_add_nc_u32_e32 v57, s30, v95
	ds_store_2addr_b32 v57, v21, v14 offset1:16
	v_perm_b32 v14, v18, v74, 0x7060302
	v_perm_b32 v18, v18, v74, 0x5040100
	v_add_nc_u32_e32 v21, s30, v96
	ds_store_2addr_b32 v21, v14, v18 offset1:16
	v_perm_b32 v14, v15, v75, 0x7060302
	v_perm_b32 v15, v15, v75, 0x5040100
	v_add_nc_u32_e32 v18, s30, v97
	ds_store_2addr_b32 v18, v14, v15 offset1:16
	v_perm_b32 v14, v19, v76, 0x5040100
	v_perm_b32 v15, v16, v185, 0x7060302
	v_perm_b32 v16, v16, v185, 0x5040100
	v_perm_b32 v18, v20, v186, 0x7060302
	v_perm_b32 v19, v20, v186, 0x5040100
	v_perm_b32 v20, v17, v187, 0x7060302
	v_perm_b32 v17, v17, v187, 0x5040100
	ds_store_2addr_b32 v13, v10, v14 offset1:16
	ds_store_2addr_b32 v58, v15, v16 offset0:160 offset1:176
	ds_store_2addr_b32 v12, v18, v19 offset1:16
	ds_store_2addr_b32 v11, v20, v17 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v175, v87 :: v_dual_mov_b32 v176, v88
	v_dual_mov_b32 v177, v89 :: v_dual_mov_b32 v178, v90
	v_dual_mov_b32 v171, v91 :: v_dual_mov_b32 v172, v93
...
; %bb.11:
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v179, s31, v106
	s_mov_b32 s4, 0
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s30, v75
	ds_load_b128 v[65:68], v1 offset:8192
	ds_load_b128 v[81:84], v1
	v_add_nc_u32_e32 v1, s30, v74
	ds_load_b128 v[69:72], v1 offset:8192
	ds_load_b128 v[85:88], v1
	v_add_nc_u32_e32 v1, s30, v73
...
.LBB0_12:
	...
	s_mul_i32 s54, s25, 33
	s_add_i32 s62, s4, s52
	s_mul_i32 s73, s25, 34
	s_add_i32 s61, s4, s53
	s_mul_i32 s74, s25, 35
	s_add_i32 s60, s4, s54
	s_mul_i32 s75, s25, 36
	s_add_i32 s53, s4, s73
	...
	s_mul_i32 s55, s25, 59
	s_add_i32 s33, s4, s58
	s_mul_i32 s56, s25, 60
	s_add_i32 s34, s4, s29
	s_mul_i32 s57, s25, 61
	s_add_i32 s29, s4, s55
	s_add_i32 s27, s4, s56
	s_mul_i32 s24, s25, 63
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 189
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 89
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     91
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
