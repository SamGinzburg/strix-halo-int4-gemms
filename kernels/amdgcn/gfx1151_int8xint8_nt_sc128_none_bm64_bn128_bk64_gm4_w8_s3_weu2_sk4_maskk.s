	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_mad_u64_u32 v[4:5], null, s34, s6, v[3:4]
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	buffer_load_b128 v[43:46], v6, s[24:27], 0 offen
	buffer_load_b128 v[47:50], v7, s[24:27], 0 offen
	.loc	1 299 32                        ; generate_amdgcn.py:299:32
...
.Ltmp23:
	...
	v_lshl_or_b32 v5, s20, 7, v2
	s_mov_b32 s20, s16
	v_add_nc_u32_e32 v2, s34, v2
	v_or_b32_e32 v74, 0x200, v1
	...
	v_add3_u32 v73, v2, v1, 0x200
	v_xor_b32_e32 v69, 48, v66
	v_mov_b32_e32 v13, 0
	v_add3_u32 v72, v3, v1, 0x200
	v_dual_mov_b32 v14, 0 :: v_dual_mov_b32 v19, 0
	v_mov_b32_e32 v15, 0
	v_add3_u32 v71, v4, v1, 0x200
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v89, v33, s0, 1
	v_add_lshl_u32 v90, v48, s0, 1
	v_add_lshl_u32 v91, v46, s0, 1
	v_add_lshl_u32 v92, v32, s0, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	...
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	s_clause 0x1
	buffer_load_u16 v175, v76, s[28:31], 0 offen
	buffer_load_u16 v176, v77, s[28:31], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_clause 0xf
	buffer_load_u16 v177, v75, s[36:39], 0 offen
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v80, s7, v67
	v_add_nc_u32_e32 v81, s7, v68
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_dual_mul_f32 v137, v119, v121 :: v_dual_add_nc_u32 v194, s43, v70
	...
	v_dual_fmac_f32 v27, v119, v90 :: v_dual_fmac_f32 v34, v125, v95
	v_dual_fmac_f32 v29, v122, v92 :: v_dual_fmac_f32 v36, v127, v97
	v_dual_fmac_f32 v31, v124, v94 :: v_dual_fmac_f32 v40, v130, v100
	v_dual_fmac_f32 v35, v126, v96 :: v_dual_fmac_f32 v42, v132, v102
	v_dual_fmac_f32 v37, v128, v98 :: v_dual_fmac_f32 v44, v134, v104
	v_dual_fmac_f32 v39, v129, v99 :: v_dual_fmac_f32 v38, v120, v106
	v_fmac_f32_e32 v41, v131, v101
	v_fmac_f32_e32 v43, v133, v103
	v_fmac_f32_e32 v45, v135, v105
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.9:
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v94, s27 :: v_dual_add_nc_u32 v7, s16, v67
	v_dual_mov_b32 v89, s22 :: v_dual_add_nc_u32 v70, s16, v66
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v87, s20 :: v_dual_add_nc_u32 v6, s14, v62
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v92, s25 :: v_dual_add_nc_u32 v7, s14, v65
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	ds_load_b128 v[139:142], v70 offset:2048
	ds_load_b128 v[143:146], v70
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v91, s24 :: v_dual_add_nc_u32 v8, s16, v69
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
.LBB0_10:
	...
	v_add_lshl_u32 v99, v55, s0, 1
	v_add_lshl_u32 v100, v54, s0, 1
	v_add_lshl_u32 v101, v53, s0, 1
	v_add_lshl_u32 v102, v52, s0, 1
	v_dual_cndmask_b32 v95, 0x80000000, v95 :: v_dual_cndmask_b32 v98, 0x80000000, v98
	v_add_lshl_u32 v103, v51, s0, 1
	s_and_b32 s5, s5, 0xffff
	s_mov_b32 s6, s14
	v_add_lshl_u32 v104, v50, s0, 1
...
.LBB0_12:
	...
	buffer_load_u16 v62, v33, s[4:7], 0 offen
	buffer_load_u16 v48, v48, s[4:7], 0 offen
	buffer_load_u16 v46, v46, s[4:7], 0 offen
	buffer_load_u16 v63, v32, s[4:7], 0 offen
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 200
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
