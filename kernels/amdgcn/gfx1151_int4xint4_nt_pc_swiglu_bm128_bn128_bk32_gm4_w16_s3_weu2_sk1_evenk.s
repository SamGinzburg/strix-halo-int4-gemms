	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_cmp_gt_i32 s26, 33
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_mad_u64_u32 v[4:5], null, s22, s24, v[3:4]
	...
	v_mad_u64_u32 v[5:6], null, s21, s24, v[3:4]
	.loc	1 136 25                        ; generate_amdgcn.py:136:25
	v_mad_u64_u32 v[6:7], null, s20, s24, v[3:4]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 129 30 is_stmt 0              ; generate_amdgcn.py:129:30
	v_add_nc_u32_e32 v5, 16, v5
	.loc	1 135 31 is_stmt 1              ; generate_amdgcn.py:135:31
	v_cndmask_b32_e64 v9, 0x80000000, v6, s3
	.loc	1 136 25                        ; generate_amdgcn.py:136:25
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b32 v6, v7, s[16:19], 0 offen
	...
	v_xor_b32_e32 v68, v3, v8
	v_lshlrev_b32_e32 v3, 4, v0
	s_delay_alu instid0(VALU_DEP_2)
	v_add_nc_u32_e32 v8, 0, v68
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(4)
	ds_store_2addr_stride64_b32 v8, v10, v6 offset1:16
	.loc	1 135 31 is_stmt 1              ; generate_amdgcn.py:135:31
	s_waitcnt vmcnt(3)
	ds_store_b32 v8, v7 offset:8192
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(1)
	ds_store_2addr_stride64_b32 v8, v11, v4 offset0:8 offset1:24
	.loc	1 135 31 is_stmt 1              ; generate_amdgcn.py:135:31
	s_waitcnt vmcnt(0)
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_mov_b32 s19, 0
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v67, v138, 1, v4
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_lshl_or_b32 v66, v139, 3, v4
	s_branch .LBB0_3
.LBB0_2:
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v4, v0, 3, 1
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v3, 0x70, v3
...
.Ltmp12:
	...
	v_lshl_or_b32 v67, v138, 1, v3
.Ltmp13:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add3_u32 v5, s15, s18, v1
	v_lshl_or_b32 v66, v139, 3, v3
.Ltmp14:
...
.Ltmp15:
	...
	v_or_b32_e32 v69, v4, v67
	v_or_b32_e32 v70, v4, v66
	v_subrev_nc_u32_e32 v4, s1, v5
	v_subrev_nc_u32_e32 v5, s1, v6
	v_dual_mov_b32 v12, v10 :: v_dual_add_nc_u32 v1, s22, v1
	v_readfirstlane_b32 s18, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[3:4], null, s24, v4, s[14:15]
	v_mad_u64_u32 v[4:5], null, s24, v5, s[14:15]
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[5:6], null, s24, v1, s[14:15]
	v_xor_b32_e32 v71, 8, v69
	v_xor_b32_e32 v72, 8, v70
	v_add3_u32 v73, v3, v2, 32
	v_mov_b32_e32 v13, v10
	v_add3_u32 v74, v4, v2, 32
	v_mov_b32_e32 v14, v10
	v_add3_u32 v75, v5, v2, 32
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_b32 v100, v75, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b32 v101, v74, s[16:19], 0 offen
	buffer_load_b32 v102, v73, s[16:19], 0 offen
	s_mov_b32 s28, s0
	s_mov_b32 s0, s14
	s_mov_b32 s14, s25
	s_mov_b32 s25, s23
	s_mov_b32 s23, s24
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v76, s28, v69
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v80, s14, v70
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v84, s23, v70
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v88, s28, v71
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v92, s14, v72
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v96, s23, v72
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[76:79], v76 offset1:2
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[80:83], v80 offset1:2
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	ds_load_2addr_stride64_b64 v[84:87], v84 offset1:2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[88:91], v88 offset1:2
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[92:95], v92 offset1:2
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	ds_load_2addr_stride64_b64 v[96:99], v96 offset1:2
	s_mov_b32 s24, s1
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s1, s27, 1
	...
	s_add_i32 s14, s1, 0
	s_waitcnt lgkmcnt(0)
	v_add_nc_u32_e32 v103, s14, v68
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_add_i32 s23, s14, 0x1000
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	s_add_i32 s1, s14, 0x2000
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lg_u32 s26, 0
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[34:41], v[80:81], v[76:77], v[34:41] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[42:49], v[82:83], v[76:77], v[42:49] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[50:57], v[80:81], v[78:79], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[58:65], v[82:83], v[78:79], v[58:65] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[84:85], v[76:77], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[86:87], v[76:77], v[26:33] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[18:25], v[84:85], v[78:79], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[86:87], v[78:79], v[1:8] neg_lo:[1,1,0]
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[34:41], v[92:93], v[88:89], v[34:41] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[42:49], v[94:95], v[88:89], v[42:49] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[50:57], v[92:93], v[90:91], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[58:65], v[94:95], v[90:91], v[58:65] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[96:97], v[88:89], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[98:99], v[88:89], v[26:33] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[18:25], v[96:97], v[90:91], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[98:99], v[90:91], v[1:8] neg_lo:[1,1,0]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_barrier
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(1)
	ds_store_2addr_stride64_b32 v103, v100, v101 offset1:16
	.loc	1 135 31 is_stmt 1              ; generate_amdgcn.py:135:31
	s_waitcnt vmcnt(0)
	ds_store_b32 v103, v102 offset:8192
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v94, v62 :: v_dual_mov_b32 v89, v57
	v_dual_mov_b32 v88, v56 :: v_dual_mov_b32 v87, v55
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_or_b32_e32 v106, v9, v67
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_or_b32_e32 v9, v9, v66
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_cndmask_b32_e64 v67, 0, 1, s3
	v_dual_mov_b32 v86, v54 :: v_dual_mov_b32 v81, v49
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_xor_b32_e32 v107, 8, v106
	v_add_nc_u32_e32 v66, s18, v106
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_cmp_ne_u32_e64 s0, 1, v67
	v_dual_mov_b32 v93, v61 :: v_dual_mov_b32 v92, v60
	v_dual_mov_b32 v91, v59 :: v_dual_add_nc_u32 v68, s18, v107
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[102:105], v66 offset1:2
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	ds_load_2addr_stride64_b64 v[98:101], v68 offset1:2
	v_dual_mov_b32 v90, v58 :: v_dual_mov_b32 v85, v53
	v_dual_mov_b32 v84, v52 :: v_dual_mov_b32 v83, v51
	v_dual_mov_b32 v82, v50 :: v_dual_mov_b32 v77, v45
	v_dual_mov_b32 v80, v48 :: v_dual_mov_b32 v79, v47
	v_dual_mov_b32 v76, v44 :: v_dual_mov_b32 v75, v43
	v_dual_mov_b32 v78, v46 :: v_dual_mov_b32 v73, v41
	v_dual_mov_b32 v74, v42 :: v_dual_mov_b32 v69, v37
...
.LBB0_12:                               ; %._crit_edge150
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	v_add_nc_u32_e32 v98, s14, v106
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_cndmask_b32_e64 v106, 0, 1, s2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v99, s14, v107
...
; %bb.13:
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v106, s23, v9
	v_add_nc_u32_e32 v110, s23, v140
...
.LBB0_17:
	...
	v_add_lshl_u32 v45, s20, v34, 1
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v34, s21, v34
	v_or_b32_e32 v46, s21, v9
	v_or_b32_e32 v48, s21, v44
	.loc	1 143 14 is_stmt 0              ; generate_amdgcn.py:143:14
	s_and_b32 s17, s7, 0xffff
	s_mov_b32 s16, s6
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v38, s20, v38, 1
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v35, s20, v35, 1
	v_add_lshl_u32 v39, s20, v39, 1
	v_add_lshl_u32 v9, s20, v9, 1
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v103, s21, v102
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v64, v16
	v_cvt_f32_i32_e32 v52, v27
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v143, s20, v7, 1
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v105, s21, v100
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v100, s20, v100, 1
	v_add_lshl_u32 v101, s20, v101, 1
	v_add_lshl_u32 v142, s20, v29, 1
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v34, s20, v43, 1
	v_add_lshl_u32 v36, s20, v44, 1
	s_clause 0x7
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v104, s21, v53
	v_or_b32_e32 v106, s21, v99
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v99, s20, v99, 1
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_waitcnt vmcnt(15)
	...
	.loc	1 147 23 is_stmt 1              ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v67, s20, v102, 1
	v_add_lshl_u32 v102, s20, v53, 1
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v54, s21, v24
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v24, s20, v24, 1
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 147
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
