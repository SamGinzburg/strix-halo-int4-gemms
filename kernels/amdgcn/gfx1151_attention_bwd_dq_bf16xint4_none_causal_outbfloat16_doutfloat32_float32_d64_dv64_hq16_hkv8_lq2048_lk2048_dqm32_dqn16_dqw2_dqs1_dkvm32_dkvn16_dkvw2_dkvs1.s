	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1                          ; -- Begin function amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1,@function
amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1:                                 ; @amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
.Lfunc_begin0:
...
.Ltmp0:
	...
	s_barrier
	.loc	1 166 23                        ; attention_backward.py:166:23
	buffer_load_b128 v[1:4], v19, s[12:15], 0 offen
	.loc	1 167 13                        ; attention_backward.py:167:13
	...
	s_add_i32 s1, s0, 32
	.loc	1 166 23                        ; attention_backward.py:166:23
	buffer_load_b128 v[13:16], v14, s[12:15], 0 offen
	.loc	1 171 28                        ; attention_backward.py:171:28
	s_and_b32 s13, s19, 0xffff
	s_mov_b32 s12, s18
	s_clause 0x3
	buffer_load_b128 v[69:72], v22, s[12:15], 0 offen
	buffer_load_b128 v[65:68], v17, s[12:15], 0 offen
	buffer_load_b128 v[57:60], v20, s[12:15], 0 offen
	buffer_load_b128 v[49:52], v21, s[12:15], 0 offen
	...
	.loc	1 171 28                        ; attention_backward.py:171:28
	buffer_load_b128 v[61:64], v17, s[12:15], 0 offen
	v_cndmask_b32_e32 v17, 0x80000000, v18, vcc_lo
	v_cndmask_b32_e32 v18, 0x80000000, v22, vcc_lo
	s_clause 0x2
	buffer_load_b128 v[53:56], v19, s[12:15], 0 offen
	buffer_load_b128 v[41:44], v17, s[12:15], 0 offen
	buffer_load_b128 v[45:48], v18, s[12:15], 0 offen
	.loc	1 159 29                        ; attention_backward.py:159:29
...
.Ltmp9:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_fmac_f32 v5, v61, v24 :: v_dual_mul_f32 v2, v72, v2
...
.Ltmp13:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_fmac_f32 v1, v69, v20 :: v_dual_add_nc_u32 v210, s5, v33
...
.Ltmp14:
	...
	.loc	1 176 24                        ; attention_backward.py:176:24
	v_dual_mul_f32 v9, v54, v9 :: v_dual_add_nc_u32 v74, 0, v34
	.loc	1 159 29                        ; attention_backward.py:159:29
...
.Ltmp15:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_fmac_f32 v2, v71, v19 :: v_dual_fmac_f32 v9, v53, v28
.Ltmp16:
	.loc	1 159 29                        ; attention_backward.py:159:29
...
.Ltmp29:
	...
	v_dual_fmac_f32 v8, v59, v21 :: v_dual_add_nc_u32 v75, 0, v39
.Ltmp30:
	.loc	1 166 23                        ; attention_backward.py:166:23
	v_and_b32_e32 v13, 0xffff0000, v13
	.loc	1 159 29                        ; attention_backward.py:159:29
	ds_load_b128 v[222:225], v75
	ds_load_b128 v[226:229], v76
.Ltmp31:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
...
.Ltmp42:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mov_b32 v37, v33 :: v_dual_add_f32 v84, v35, v39
	v_mov_b32_dpp v37, v37 row_xmask:2 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp43:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_add_f32 v83, v34, v38 :: v_dual_mov_b32 v88, v84
	v_dual_add_f32 v86, v33, v37 :: v_dual_add_f32 v85, v36, v40
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp44:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
...
; %bb.1:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v93, 0, v107
	v_add_nc_u32_e32 v94, 0, v108
...
.Ltmp65:
	...
	.loc	1 267 9                         ; attention_backward.py:267:9
	s_waitcnt lgkmcnt(0)
	buffer_store_b32 v73, v36, s[16:19], 0 offen
	.loc	1 392 17                        ; attention_backward.py:392:17
...
; %bb.5:                                ; %.lr.ph102
	...
	v_dual_mov_b32 v79, 0x7632 :: v_dual_lshlrev_b32 v36, 2, v105
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_dual_mov_b32 v34, v81 :: v_dual_add_nc_u32 v237, 0, v107
	v_add_nc_u32_e32 v238, 0, v108
	v_add_nc_u32_e32 v239, 0, v109
	v_add_nc_u32_e32 v240, 0, v110
	v_dual_mov_b32 v38, v81 :: v_dual_add_nc_u32 v241, 0, v111
...
.Ltmp66:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 40
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1"                        ; string offset=97 ; amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
    .private_segment_fixed_size: 40
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_causal_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.kd
