	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp17:
	...
	s_cvt_f32_u32 s1, s7
	v_bfe_i32 v0, v0, 7, 1
	v_and_b32_e32 v6, 0x840, v6
	v_lshl_or_b32 v16, v61, 3, v16
	v_rcp_iflag_f32_e32 v37, s1
...
.Ltmp18:
	...
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	v_mad_u64_u32 v[32:33], null, s35, v3, v[1:2]
	.loc	1 276 36                        ; generate_amdgcn.py:276:36
	v_or_b32_e32 v9, 44, v3
	v_or3_b32 v63, v30, v4, v6
	v_and_b32_e32 v4, 0x1008, v5
	v_or3_b32 v0, v16, v28, v0
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	v_mad_u64_u32 v[33:34], null, s35, v14, v[1:2]
	s_lshl_b32 s3, s3, 6
	.loc	1 276 36                        ; generate_amdgcn.py:276:36
	v_or_b32_e32 v8, 52, v3
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	v_mad_u64_u32 v[34:35], null, s35, v13, v[1:2]
	.loc	1 276 36                        ; generate_amdgcn.py:276:36
	v_or_b32_e32 v7, 60, v3
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	v_mad_u64_u32 v[35:36], null, s35, v12, v[1:2]
	v_or_b32_e32 v65, s3, v60
	v_mad_u64_u32 v[36:37], null, s35, v11, v[1:2]
	s_mul_f32 s1, s1, 0x4f7ffffe
	v_mad_u64_u32 v[37:38], null, s35, v10, v[1:2]
	v_and_b32_e32 v18, 56, v18
	v_lshl_or_b32 v19, v17, 6, v19
	v_xor_b32_e32 v64, v0, v4
	v_mad_u64_u32 v[38:39], null, s35, v9, v[1:2]
	v_mad_u64_u32 v[39:40], null, s35, v8, v[1:2]
	s_cvt_u32_f32 s1, s1
	v_mad_u64_u32 v[40:41], null, s35, v7, v[1:2]
	v_mul_lo_u32 v1, s35, v65
	s_mov_b32 s24, s4
	s_sub_i32 s4, 0, s7
	...
	v_xor_b32_e32 v6, 16, v63
	v_xor_b32_e32 v16, 24, v63
	...
	v_or_b32_e32 v66, v15, v17
	v_cndmask_b32_e64 v3, 0, 1, s0
	v_lshl_or_b32 v41, v2, 3, s3
	s_mul_i32 s4, s4, s1
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	...
	v_cmp_gt_i32_e64 s1, 64, v41
	v_cmp_gt_i32_e64 s3, 64, v65
...
.LBB0_2:                                ; %._crit_edge
	...
	v_add_lshl_u32 v18, s10, v33, 2
	v_add_lshl_u32 v20, s10, v35, 2
	.loc	1 270 5                         ; generate_amdgcn.py:270:5
	s_cmp_lt_i32 s2, s34
	...
	v_add_lshl_u32 v0, v16, s43, 2
	v_add_lshl_u32 v2, s10, v36, 2
	v_add_lshl_u32 v4, v16, s44, 2
	v_add_lshl_u32 v6, s10, v37, 2
	...
	v_add_lshl_u32 v0, s10, v38, 2
	v_add_lshl_u32 v1, v16, s46, 2
	v_add_lshl_u32 v2, s10, v39, 2
	v_add_lshl_u32 v4, v16, s47, 2
	v_add_lshl_u32 v5, s10, v40, 2
	s_clause 0x4
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_sub_i32 s54, s10, s4
	.loc	1 274 32                        ; generate_amdgcn.py:274:32
	s_mul_i32 s13, s54, s13
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	...
	s_lshl_b32 s53, s13, 6
	.loc	1 307 13                        ; generate_amdgcn.py:307:13
	s_cbranch_vccnz .LBB0_2
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_or_b32 v0, s10, 8, v61
	v_dual_mov_b32 v56, 0 :: v_dual_add_nc_u32 v1, s53, v68
	s_lshl_b32 s11, s4, 8
	v_add_nc_u32_e32 v2, s53, v66
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_subrev_nc_u32_e32 v90, s11, v0
	v_dual_mov_b32 v55, v56 :: v_dual_add_nc_u32 v0, s53, v60
	v_mul_lo_u32 v91, s51, v1
	v_lshl_add_u32 v1, s10, 7, v69
	v_mov_b32_e32 v57, v56
	v_mul_lo_u32 v92, s51, v2
	v_mad_u64_u32 v[58:59], null, s41, v0, v[41:42]
	s_lshl_b32 s4, s4, 7
	v_dual_mov_b32 v54, 0 :: v_dual_mov_b32 v53, v56
	v_subrev_nc_u32_e32 v59, s4, v1
	v_dual_mov_b32 v52, 0 :: v_dual_mov_b32 v51, v56
	v_dual_mov_b32 v50, 0 :: v_dual_mov_b32 v49, v56
	v_dual_mov_b32 v48, 0 :: v_dual_mov_b32 v47, v56
	v_dual_mov_b32 v46, 0 :: v_dual_mov_b32 v45, v56
	v_dual_mov_b32 v44, 0 :: v_dual_mov_b32 v43, v56
	v_mov_b32_e32 v42, 0
	s_mov_b32 s55, 0
	s_mov_b32 s56, s42
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	.loc	1 325 30                        ; generate_amdgcn.py:325:30
	v_cndmask_b32_e64 v1, 0x80000000, v59, s4
	.loc	1 320 30                        ; generate_amdgcn.py:320:30
	...
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x1
	buffer_load_u16 v103, v95, s[36:39], 0 offen
	buffer_load_u16 v108, v95, s[36:39], 0 offen offset:8
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	...
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	buffer_load_u16 v100, v95, s[36:39], 0 offen offset:4
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	s_waitcnt lgkmcnt(5)
	...
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	buffer_load_u16 v109, v95, s[36:39], 0 offen offset:16
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	...
	.loc	1 328 22                        ; generate_amdgcn.py:328:22
	s_clause 0x2
	buffer_load_u16 v107, v95, s[36:39], 0 offen offset:20
	buffer_load_u16 v105, v95, s[36:39], 0 offen offset:24
	buffer_load_u16 v95, v95, s[36:39], 0 offen offset:28
	.loc	1 326 31                        ; generate_amdgcn.py:326:31
	...
	v_dual_mul_f32 v9, v9, v16 :: v_dual_add_nc_u32 v90, s50, v90
	v_dual_mul_f32 v8, v8, v16 :: v_dual_add_nc_u32 v59, s52, v59
	s_waitcnt vmcnt(7)
	...
	v_dual_mul_f32 v4, v4, v17 :: v_dual_fmac_f32 v55, v1, v19
	v_dual_mul_f32 v6, v6, v17 :: v_dual_fmac_f32 v57, v0, v18
	v_dual_mul_f32 v7, v7, v17 :: v_dual_fmac_f32 v56, v8, v18
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 329 17 is_stmt 0              ; generate_amdgcn.py:329:17
	v_dual_fmac_f32 v54, v9, v19 :: v_dual_fmac_f32 v53, v2, v20
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_vgpr, 111
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.numbered_sgpr, 57
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     59
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.kd
