	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_lshl_b32 s17, s30, 6
	s_add_i32 s4, s4, s31
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add3_u32 v6, v8, v2, s16
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	...
	v_dual_cndmask_b32 v9, 0x80000000, v9 :: v_dual_add_nc_u32 v8, 64, v8
	...
	s_clause 0x1
	buffer_load_b128 v[15:18], v10, s[36:39], 0 offen
	buffer_load_b128 v[19:22], v11, s[36:39], 0 offen
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	buffer_load_b64 v[23:24], v9, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_lshlrev_b32_e32 v9, 1, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_or_b32_e32 v11, 16, v25
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_cndmask_b32_e32 v6, 0x80000000, v6, vcc_lo
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s4, s2
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v8, 0x80000000, v8 :: v_dual_and_b32 v9, 48, v9
	v_cndmask_b32_e32 v5, 0x80000000, v5, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[34:35], v6, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[26:29], v8, s[36:39], 0 offen
	buffer_load_b128 v[30:33], v5, s[36:39], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_and_b32_e32 v5, 0xe0, v0
	v_lshrrev_b32_e32 v8, 4, v0
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_xor_b32_e32 v45, v7, v9
	s_mov_b32 s16, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(3)
	ds_store_b64 v37, v[23:24] offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_store_b128 v38, v[15:18]
	ds_store_b128 v38, v[19:22] offset:4096
	v_and_b32_e32 v15, 48, v36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v37, v[34:35] offset:18432
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v7, s22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_fmac_f32_e32 v10, v86, v52
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v90, v75, v82 :: v_dual_lshlrev_b32 v77, 16, v123
	v_mul_f32_e32 v88, v75, v80
	v_mul_f32_e32 v80, v76, v80
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v19, v78, v60
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v14, v90, v56 :: v_dual_mul_f32 v85, v75, v77
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v77, v76, v77
	v_dual_mul_f32 v82, v76, v82 :: v_dual_lshlrev_b32 v79, 16, v125
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v12, v88, v54
	v_dual_fmac_f32 v21, v80, v62 :: v_dual_fmac_f32 v18, v77, v59
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v23, v82, v64
	v_fmac_f32_e32 v11, v87, v53
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v20, v79, v61
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v89, v75, v81 :: v_dual_lshlrev_b32 v84, 16, v130
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v131, s19, v44
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v9, v85, v51
	v_fmac_f32_e32 v15, v91, v57
	v_fmac_f32_e32 v16, v75, v58
	v_dual_fmac_f32 v24, v83, v65 :: v_dual_fmac_f32 v17, v76, v66
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 133
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
