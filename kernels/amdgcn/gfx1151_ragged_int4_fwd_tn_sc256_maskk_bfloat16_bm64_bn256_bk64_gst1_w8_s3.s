...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_mad_u64_u32 v[67:68], null, v67, s9, v[65:66]
	.loc	1 629 34 is_stmt 0              ; ragged.py:629:34
	v_cndmask_b32_e64 v76, 0x80000000, v67, s5
	.loc	1 611 28 is_stmt 1              ; ragged.py:611:28
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 629 34 is_stmt 0              ; ragged.py:629:34
	v_cndmask_b32_e64 v77, 0x80000000, v67, s5
	.loc	1 629 42                        ; ragged.py:629:42
	v_mad_u64_u32 v[67:68], null, v0, s9, v[65:66]
	.loc	1 629 34                        ; ragged.py:629:34
	...
	ds_load_u8 v247, v145 offset:208
	ds_load_u8 v248, v145 offset:144
	ds_load_u8 v253, v145 offset:224
	ds_load_u8 v254, v145 offset:160
	...
	ds_load_u8 v243, v145 offset:960
	ds_load_u8 v244, v145 offset:896
	ds_load_u8 v211, v145 offset:1024
	ds_load_u8 v218, v145 offset:976
	ds_load_u8 v221, v145 offset:912
	ds_load_u8 v214, v145 offset:992
	ds_load_u8 v216, v145 offset:928
	ds_load_u8 v212, v145 offset:944
	ds_load_u8 v245, v145 offset:832
	ds_load_u8 v246, v145 offset:768
	...
	ds_load_u8 v204, v145 offset:1392
	ds_load_u8 v205, v145 offset:1328
	ds_load_u8 v183, v145 offset:1984
	...
	ds_load_u8 v189, v145 offset:1920
	...
	ds_load_u8 v196, v145 offset:1728
	ds_load_u8 v199, v145 offset:1792
	...
	ds_load_u8 v202, v145 offset:1664
	...
	ds_load_u8 v84, v146 offset:1920
	ds_load_u8 v85, v146 offset:1664
	ds_load_u8 v86, v146 offset:1408
	ds_load_u8 v87, v146 offset:1152
	v_perm_b32 v74, v76, v74, 0xc0c0004
	v_perm_b32 v76, v83, v82, 0xc0c0004
	v_perm_b32 v82, v248, v247, 0xc0c0004
	...
	v_perm_b32 v77, v254, v253, 0xc0c0004
	...
	ds_load_u8 v71, v146 offset:1536
	...
	ds_load_u8 v71, v146 offset:256
	ds_load_u8 v72, v146
	...
	ds_load_u8 v72, v146 offset:768
	ds_load_u8 v92, v146 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v92, v92, v72, 0xc0c0004
	...
	v_lshl_or_b32 v71, v92, 16, v71
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v70, v70, 16, v69
	v_lshl_or_b32 v69, v85, 16, v84
	s_delay_alu instid0(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[71:72], v[67:68], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[71:72], v[80:81], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[71:72], v[74:75], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[71:72], v[76:77], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[69:70], v[67:68], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[69:70], v[80:81], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[69:70], v[74:75], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[69:70], v[76:77], v[57:64] neg_lo:[1,1,0]
	v_perm_b32 v67, v244, v243, 0xc0c0004
	v_perm_b32 v69, v252, v251, 0xc0c0004
	...
	v_perm_b32 v73, v221, v218, 0xc0c0004
	v_perm_b32 v76, v233, v232, 0xc0c0004
	v_perm_b32 v77, v238, v237, 0xc0c0004
	v_perm_b32 v78, v231, v229, 0xc0c0004
	...
	v_perm_b32 v75, v216, v214, 0xc0c0004
	...
	v_perm_b32 v67, v236, v230, 0xc0c0004
	...
	v_lshl_or_b32 v71, v74, 16, v73
	v_perm_b32 v73, v203, v201, 0xc0c0004
	v_perm_b32 v76, v186, v185, 0xc0c0004
	v_perm_b32 v77, v191, v190, 0xc0c0004
	v_perm_b32 v78, v184, v182, 0xc0c0004
	v_perm_b32 v79, v188, v187, 0xc0c0004
	v_lshl_or_b32 v74, v73, 16, v0
	v_lshl_or_b32 v73, v76, 16, v75
	v_perm_b32 v0, v208, v207, 0xc0c0004
	v_perm_b32 v75, v200, v198, 0xc0c0004
	...
	v_perm_b32 v77, v197, v195, 0xc0c0004
	v_perm_b32 v67, v189, v183, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[25:32], v[71:72], v[73:74], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[69:70], v[75:76], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[71:72], v[75:76], v[41:48] neg_lo:[1,1,0]
	...
	v_perm_b32 v70, v202, v196, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[57:64], v[71:72], v[77:78], v[57:64] neg_lo:[1,1,0]
	v_lshl_or_b32 v68, v67, 16, v0
	v_lshl_or_b32 v67, v70, 16, v69
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_dual_fmac_f32 v132, v80, v9 :: v_dual_fmac_f32 v135, v77, v6
	v_fmac_f32_e32 v130, v82, v11
	v_dual_fmac_f32 v134, v78, v7 :: v_dual_fmac_f32 v133, v79, v8
	v_dual_fmac_f32 v128, v84, v13 :: v_dual_fmac_f32 v131, v81, v10
	v_dual_fmac_f32 v126, v16, v15 :: v_dual_fmac_f32 v129, v83, v12
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 120
