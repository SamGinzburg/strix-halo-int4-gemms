	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp22:
	...
	v_bfe_i32 v7, v0, 5, 1
	v_dual_mov_b32 v43, 0 :: v_dual_lshlrev_b32 v4, 4, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v16, v3, v6, s2
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_or_b32 v6, s14, 7, v15
	s_mov_b32 s14, s12
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_lshlrev_b32_e32 v1, 2, v0
	v_lshlrev_b32_e32 v8, 5, v0
	v_and_b32_e32 v10, 16, v2
	v_dual_mov_b32 v46, 0 :: v_dual_and_b32 v11, 0x90, v11
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v9, 28, v1
	v_and_b32_e32 v8, 0x160, v8
	v_dual_mov_b32 v45, 0 :: v_dual_and_b32 v2, 0xf70, v2
	v_dual_mov_b32 v39, 0 :: v_dual_and_b32 v12, 0x90, v12
	v_dual_mov_b32 v44, 0 :: v_dual_add_nc_u32 v5, s22, v5
	...
	v_xor_b32_e32 v8, 16, v27
	v_xor_b32_e32 v3, 16, v4
	v_mul_lo_u32 v17, v13, s29
	v_mul_lo_u32 v18, v7, s29
	v_mad_u64_u32 v[12:13], null, s28, v6, v[10:11]
	v_dual_mov_b32 v37, 0 :: v_dual_add_nc_u32 v26, 0, v1
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v28, 0, v2
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v32, 0, v8
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v34, 0, v4
	v_dual_mov_b32 v42, 0 :: v_dual_add_nc_u32 v41, 0, v3
	...
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v30, 0, v27
	v_dual_mov_b32 v33, 0 :: v_dual_mov_b32 v2, s13
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(3)
	ds_store_b32 v26, v55 offset:8192
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(2)
	ds_store_b128 v28, v[47:50]
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	...
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v28, v[51:54] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[63:66], v34
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[55:58], v30 offset:8192
	ds_load_b128 v[67:70], v30 offset:8704
	ds_load_b128 v[71:74], v30 offset:9216
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[79:82], v34 offset:4096
	ds_load_b128 v[83:86], v41
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[87:90], v30 offset:9728
	ds_load_b128 v[91:94], v32 offset:8192
	ds_load_b128 v[95:98], v32 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[99:102], v41 offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[103:106], v32 offset:9216
	ds_load_b128 v[107:110], v32 offset:9728
	...
	s_waitcnt vmcnt(15)
	v_dual_mul_f32 v58, v58, v80 :: v_dual_lshlrev_b32 v83, 16, v115
	v_mul_f32_e32 v55, v55, v80
	s_waitcnt vmcnt(11)
	v_dual_mul_f32 v60, v60, v80 :: v_dual_lshlrev_b32 v87, 16, v119
	s_waitcnt vmcnt(9)
	v_dual_mul_f32 v62, v62, v80 :: v_dual_lshlrev_b32 v89, 16, v121
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v57, v57, v80 :: v_dual_lshlrev_b32 v90, 16, v122
	v_dual_mul_f32 v56, v56, v80 :: v_dual_lshlrev_b32 v81, 16, v113
	...
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v59, v59, v80 :: v_dual_lshlrev_b32 v94, 16, v126
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v61, v61, v80 :: v_dual_lshlrev_b32 v98, 16, v130
	v_mul_f32_e32 v47, v47, v79
	v_mul_f32_e32 v48, v48, v79
	v_mul_f32_e32 v50, v50, v79
	v_dual_mul_f32 v64, v64, v89 :: v_dual_lshlrev_b32 v91, 16, v123
	v_dual_mul_f32 v63, v63, v89 :: v_dual_lshlrev_b32 v92, 16, v124
	v_dual_mul_f32 v72, v72, v90 :: v_dual_lshlrev_b32 v93, 16, v125
	v_dual_mul_f32 v66, v66, v89 :: v_dual_lshlrev_b32 v95, 16, v127
	v_dual_mul_f32 v65, v65, v89 :: v_dual_lshlrev_b32 v96, 16, v128
	v_dual_mul_f32 v74, v74, v90 :: v_dual_lshlrev_b32 v97, 16, v129
	v_dual_mul_f32 v67, v67, v89 :: v_dual_mul_f32 v76, v76, v90
	v_dual_mul_f32 v68, v68, v89 :: v_dual_mul_f32 v71, v71, v90
	v_dual_mul_f32 v69, v69, v89 :: v_dual_mul_f32 v78, v78, v90
	v_dual_mul_f32 v70, v70, v89 :: v_dual_mul_f32 v73, v73, v90
	v_dual_mul_f32 v75, v75, v90 :: v_dual_fmac_f32 v44, v50, v84
	v_dual_mul_f32 v77, v77, v90 :: v_dual_fmac_f32 v38, v55, v81
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v13, v47, v81 :: v_dual_fmac_f32 v46, v48, v82
	v_dual_fmac_f32 v45, v49, v83 :: v_dual_fmac_f32 v42, v52, v86
	v_dual_fmac_f32 v43, v51, v85 :: v_dual_fmac_f32 v40, v53, v87
	v_dual_fmac_f32 v39, v54, v88 :: v_dual_fmac_f32 v36, v57, v83
	v_fmac_f32_e32 v37, v56, v82
	v_dual_fmac_f32 v35, v58, v84 :: v_dual_fmac_f32 v38, v71, v91
	v_dual_fmac_f32 v33, v59, v85 :: v_dual_fmac_f32 v46, v64, v92
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v31, v60, v86 :: v_dual_fmac_f32 v36, v73, v93
	v_dual_fmac_f32 v29, v61, v87 :: v_dual_fmac_f32 v44, v66, v94
	v_fmac_f32_e32 v27, v62, v88
	v_dual_fmac_f32 v13, v63, v91 :: v_dual_fmac_f32 v42, v68, v96
	v_fmac_f32_e32 v45, v65, v93
	v_dual_fmac_f32 v43, v67, v95 :: v_dual_fmac_f32 v40, v69, v97
	v_fmac_f32_e32 v39, v70, v98
	v_fmac_f32_e32 v37, v72, v92
	v_fmac_f32_e32 v35, v74, v94
	v_fmac_f32_e32 v33, v75, v95
	v_fmac_f32_e32 v31, v76, v96
	v_fmac_f32_e32 v29, v77, v97
	v_fmac_f32_e32 v27, v78, v98
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.3:                                ; %._crit_edge.loopexit
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v1, v13, v13 :: v_dual_max_f32 v2, v46, v46
	v_dual_max_f32 v9, v38, v38 :: v_dual_max_f32 v10, v37, v37
	v_max_f32_e32 v11, v36, v36
	v_dual_max_f32 v3, v45, v45 :: v_dual_max_f32 v4, v44, v44
	v_dual_max_f32 v5, v43, v43 :: v_dual_max_f32 v6, v42, v42
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v2, 0, v2
	v_dual_max_f32 v7, v40, v40 :: v_dual_max_f32 v8, v39, v39
	v_dual_max_f32 v20, 0, v10 :: v_dual_max_f32 v21, 0, v11
	v_dual_max_f32 v10, v33, v33 :: v_dual_max_f32 v11, v31, v31
	v_max_f32_e32 v19, 0, v9
	v_dual_max_f32 v9, v35, v35 :: v_dual_max_f32 v12, v29, v29
	v_dual_max_f32 v13, v27, v27 :: v_dual_mul_f32 v18, v1, v1
	...
	v_dual_max_f32 v24, 0, v11 :: v_dual_max_f32 v25, 0, v12
...
.LBB0_4:                                ; %._crit_edge
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v14, s1, v15, v14
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_cmp_eq_u32_e32 vcc_lo, 0, v0
	v_mov_b32_e32 v0, 0x5410
	v_add3_u32 v15, v17, v23, 0x7fff
	...
	v_dual_cndmask_b32 v1, v5, v1 :: v_dual_cndmask_b32 v6, v12, v15
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
