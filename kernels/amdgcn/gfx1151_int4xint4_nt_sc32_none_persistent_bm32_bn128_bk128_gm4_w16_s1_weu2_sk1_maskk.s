	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp20:
	...
	v_lshl_or_b32 v5, v1, 4, v6
	v_and_b32_e32 v6, 0x77c, v3
	...
	v_dual_mov_b32 v0, 0 :: v_dual_lshlrev_b32 v11, 3, v15
	v_readfirstlane_b32 s5, v12
	v_xor_b32_e32 v6, v7, v6
	v_and_b32_e32 v7, 0x540054, v10
	v_lshl_or_b32 v8, v8, 4, v8
	v_or3_b32 v4, v4, v11, v9
	...
	s_cvt_u32_f32 s5, s5
	v_and_b32_e32 v19, 0x7060706, v8
	.loc	1 278 13                        ; generate_amdgcn.py:278:13
	v_and_or_b32 v8, v3, 12, s3
	v_or_b32_e32 v9, s3, v1
	s_sub_i32 s6, 0, s9
	.loc	1 247 36                        ; generate_amdgcn.py:247:36
	v_and_or_b32 v16, v13, 16, v1
	s_mul_i32 s6, s6, s5
	s_mov_b32 s24, s10
	v_and_b32_e32 v18, 0x5040504, v7
...
; %bb.6:                                ; %.lr.ph
	...
	s_lshl_b32 s8, s5, 8
	s_lshl_b32 s5, s5, 7
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v4, s7, v13
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s7, v16
	v_subrev_nc_u32_e32 v35, s8, v1
	v_subrev_nc_u32_e32 v1, s5, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[10:11], null, s37, v4, v[9:10]
	v_mul_lo_u32 v36, s40, v3
	v_dual_mov_b32 v28, 0 :: v_dual_mov_b32 v29, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[11:12], null, s37, v1, v[8:9]
...
.LBB0_7:                                ;   Parent Loop BB0_3 Depth=1
	...
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	v_dual_cndmask_b32 v2, 0x80000000, v4 :: v_dual_add_nc_u32 v3, v20, v35
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_mov_b32 s31, s23
	...
	s_barrier
	.loc	1 298 22                        ; generate_amdgcn.py:298:22
	buffer_load_u16 v49, v36, s[12:15], 0 offen
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x7
	buffer_load_u16 v50, v3, s[28:31], 0 offen offset:4
	buffer_load_u16 v51, v3, s[28:31], 0 offen
	buffer_load_u16 v52, v3, s[28:31], 0 offen offset:12
	buffer_load_u16 v53, v3, s[28:31], 0 offen offset:8
	buffer_load_u16 v54, v3, s[28:31], 0 offen offset:20
	buffer_load_u16 v55, v3, s[28:31], 0 offen offset:16
	buffer_load_u16 v56, v3, s[28:31], 0 offen offset:28
	buffer_load_u16 v57, v3, s[28:31], 0 offen offset:24
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	v_mov_b32_e32 v7, v0
	v_mov_b32_e32 v1, v0
	v_mov_b32_e32 v2, v0
	v_dual_mov_b32 v3, v0 :: v_dual_add_nc_u32 v36, 2, v36
	...
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[37:44], v[1:2], v[45:46], v[37:44] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[37:44], v[3:4], v[47:48], v[37:44] neg_lo:[1,1,0]
	...
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v3, v38, v3 :: v_dual_lshlrev_b32 v42, 16, v53
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v5, v38, v5 :: v_dual_lshlrev_b32 v44, 16, v55
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v45, 16, v56
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v7, v38, v7 :: v_dual_lshlrev_b32 v46, 16, v57
	v_mul_f32_e32 v2, v38, v2
	v_mul_f32_e32 v1, v38, v1
	v_dual_mul_f32 v4, v38, v4 :: v_dual_lshlrev_b32 v43, 16, v54
	v_mul_f32_e32 v6, v38, v6
	v_dual_mul_f32 v37, v38, v37 :: v_dual_fmac_f32 v28, v5, v44
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_fmac_f32_e32 v32, v1, v40
	v_dual_fmac_f32 v30, v3, v42 :: v_dual_fmac_f32 v33, v2, v39
	v_fmac_f32_e32 v12, v37, v45
...
.Ltmp21:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.num_vgpr, 58
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc32_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk1_maskk.kd
