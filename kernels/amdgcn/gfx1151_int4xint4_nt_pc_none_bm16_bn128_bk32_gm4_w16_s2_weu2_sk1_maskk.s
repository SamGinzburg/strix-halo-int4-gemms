	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v70, 4, v0
...
.Ltmp11:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v1, v9 :: v_dual_and_b32 v6, 0x88, v2
	v_mov_b32_e32 v2, v9
	v_mov_b32_e32 v3, v9
	v_mov_b32_e32 v4, v9
	v_mov_b32_e32 v7, v9
	...
	v_dual_mov_b32 v8, v9 :: v_dual_add_nc_u32 v71, 0, v71
	s_mov_b32 s12, 0
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lt_i32 s13, 34
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
...
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(23)
	v_dual_mul_f32 v15, v72, v15 :: v_dual_lshlrev_b32 v106, 16, v108
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v61, v118, v61
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v93, v1, v93
	v_dual_mul_f32 v94, v1, v94 :: v_dual_lshlrev_b32 v89, 16, v89
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v13, v70, v13 :: v_dual_lshlrev_b32 v90, 16, v90
	v_mul_f32_e32 v16, v73, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v18, v75, v18 :: v_dual_mul_f32 v77, v1, v77
	v_dual_mul_f32 v17, v74, v17 :: v_dual_mul_f32 v78, v1, v78
	.loc	1 144 16 is_stmt 0              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v71, v1, v71
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v11, v68, v11 :: v_dual_mul_f32 v68, v123, v2
	...
	v_add3_u32 v10, v11, v70, 0x7fff
	v_cndmask_b16 v11.h, 0x7fff, v66.h, s0
	v_cmp_o_f32_e64 s0, v14, v14
	v_cndmask_b16 v11.l, 0x7fff, v65.h, vcc_lo
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v21, v78, v21 :: v_dual_mul_f32 v24, v81, v24
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v29, v86, v29 :: v_dual_mul_f32 v32, v89, v32
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_cndmask_b16 v17.h, 0x7fff, v18.h, s2
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v47, v104, v47 :: v_dual_mul_f32 v52, v109, v52
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_dual_mul_f32 v49, v106, v49 :: v_dual_mul_f32 v54, v111, v54
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v55, v112, v55 :: v_dual_mul_f32 v60, v117, v60
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v63, v120, v63 :: v_dual_mul_f32 v4, v125, v4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 216 9 is_stmt 0               ; generate_amdgcn.py:216:9
	v_add3_u32 v6, v7, v40, 0x7fff
	v_cmp_o_f32_e64 s1, v7, v7
	v_cmp_eq_u32_e64 s3, 0, v3
	v_cndmask_b16 v3.l, 0x7fff, v36.h, vcc_lo
	v_cndmask_b16 v3.h, 0x7fff, v39.h, s0
	v_add3_u32 v5, v8, v5, 0x7fff
	v_cmp_o_f32_e64 s2, v8, v8
	v_cndmask_b16 v5.l, 0x7fff, v6.h, s1
	v_cndmask_b32_e64 v6, v10, v11, s3
	v_cndmask_b32_e64 v7, v11, v10, s3
	v_cndmask_b32_e64 v8, v13, v9, s3
	v_cndmask_b32_e64 v9, v9, v13, s3
	v_cndmask_b32_e64 v10, v15, v12, s3
	v_cndmask_b32_e64 v11, v12, v15, s3
	v_cndmask_b32_e64 v12, v17, v14, s3
	v_cndmask_b32_e64 v13, v14, v17, s3
	v_cndmask_b32_e64 v14, v19, v16, s3
	v_cndmask_b32_e64 v15, v16, v19, s3
	v_cndmask_b32_e64 v16, v21, v18, s3
	v_cndmask_b32_e64 v17, v18, v21, s3
	v_cndmask_b32_e64 v18, v23, v20, s3
	v_cndmask_b32_e64 v19, v20, v23, s3
	v_cndmask_b32_e64 v20, v25, v22, s3
	v_cndmask_b32_e64 v21, v22, v25, s3
	v_cndmask_b32_e64 v22, v27, v24, s3
	v_cndmask_b32_e64 v23, v24, v27, s3
	v_cndmask_b32_e64 v24, v29, v26, s3
	v_cndmask_b32_e64 v25, v26, v29, s3
	v_cndmask_b32_e64 v26, v31, v28, s3
	v_cndmask_b32_e64 v27, v28, v31, s3
	v_cndmask_b32_e64 v28, v33, v30, s3
	v_cndmask_b32_e64 v29, v30, v33, s3
	v_cndmask_b32_e64 v30, v35, v32, s3
	v_cndmask_b32_e64 v31, v32, v35, s3
	v_cndmask_b32_e64 v32, v37, v34, s3
	v_cndmask_b32_e64 v33, v34, v37, s3
	v_cndmask_b32_e64 v34, v3, v4, s3
	...
	v_cndmask_b32_e64 v35, v5, v38, s3
	v_cndmask_b32_e64 v5, v38, v5, s3
	...
	v_and_b32_e32 v36, 0x7060706, v36
	...
	v_perm_b32 v5, v9, v8, v37
	v_perm_b32 v6, v9, v8, v36
	v_perm_b32 v7, v11, v10, v37
	v_perm_b32 v8, v11, v10, v36
	v_perm_b32 v9, v13, v12, v37
	v_perm_b32 v10, v13, v12, v36
	v_perm_b32 v11, v15, v14, v37
	v_perm_b32 v12, v15, v14, v36
	v_perm_b32 v13, v17, v16, v37
	v_perm_b32 v14, v17, v16, v36
	v_perm_b32 v15, v19, v18, v37
	v_perm_b32 v16, v19, v18, v36
	v_perm_b32 v17, v21, v20, v37
	v_perm_b32 v18, v21, v20, v36
	v_perm_b32 v19, v23, v22, v37
	v_perm_b32 v20, v23, v22, v36
	v_perm_b32 v21, v25, v24, v37
	v_perm_b32 v22, v25, v24, v36
	v_perm_b32 v23, v27, v26, v37
	v_perm_b32 v24, v27, v26, v36
	v_perm_b32 v25, v29, v28, v37
	v_perm_b32 v26, v29, v28, v36
	v_perm_b32 v27, v31, v30, v37
	v_perm_b32 v28, v31, v30, v36
	v_perm_b32 v29, v33, v32, v37
	v_perm_b32 v30, v33, v32, v36
	v_perm_b32 v31, v38, v34, v37
	v_perm_b32 v33, v39, v35, v37
	v_dual_cndmask_b32 v37, 0x80000000, v1 :: v_dual_cndmask_b32 v0, 0x80000000, v0
	v_cndmask_b32_e32 v2, 0x80000000, v2, vcc_lo
	s_mov_b32 s22, s6
	s_mov_b32 s23, s7
	s_clause 0x2
	buffer_store_b128 v[3:6], v37, s[20:23], 0 offen
	...
	v_perm_b32 v32, v38, v34, v36
	v_perm_b32 v34, v39, v35, v36
	v_cndmask_b32_e32 v1, 0x80000000, v1, vcc_lo
	s_clause 0x4
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 133
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w16_s2_weu2_sk1_maskk.kd
