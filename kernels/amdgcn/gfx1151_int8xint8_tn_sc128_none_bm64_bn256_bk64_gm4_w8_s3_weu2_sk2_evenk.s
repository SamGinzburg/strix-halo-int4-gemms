...
.LBB0_3:                                ; %Flow90
	...
	v_mul_lo_u32 v151, v9, s42
	v_mul_lo_u32 v138, v5, s42
	v_mul_lo_u32 v139, v6, s42
	v_mul_lo_u32 v140, v7, s42
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v130, v233, v79 :: v_dual_fmac_f32 v137, v212, v33
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_fmac_f32 v142, v214, v35 :: v_dual_fmac_f32 v145, v225, v38
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v116, v64, v115 offset1:16
	...
	v_dual_fmac_f32 v152, v239, v28 :: v_dual_fmac_f32 v159, v218, v51
...
.LBB0_12:
	...
	s_mul_i32 s5, s4, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v64, v151, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v81, v119, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v82, v138, s4, 1
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v138, v158, v138, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v158, v174, v221, v153
	v_fma_f32 v140, v140, v224, v156
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v3, v139, v40, s2
	...
	v_cndmask_b32_e64 v62, v140, v39, s2
	v_cndmask_b32_e64 v7, v138, v82, s2
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 98
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 92
