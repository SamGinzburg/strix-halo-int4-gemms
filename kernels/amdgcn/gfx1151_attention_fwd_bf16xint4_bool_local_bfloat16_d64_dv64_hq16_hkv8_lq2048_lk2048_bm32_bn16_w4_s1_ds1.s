...
; %bb.4:                                ; %.lr.ph
	...
	v_and_b32_e32 v15, 0x180, v11
	v_and_b32_e32 v12, 52, v12
	v_dual_mov_b32 v125, 0xff800000 :: v_dual_and_b32 v16, 2, v0
	...
	v_dual_mov_b32 v115, 0 :: v_dual_lshlrev_b32 v62, 2, v61
	...
	v_xor_b32_e32 v9, 0x70, v78
	v_xor_b32_e32 v49, 0x120, v83
	v_dual_mov_b32 v119, 0xff800000 :: v_dual_and_b32 v16, 14, v0
	v_lshrrev_b32_e32 v54, 3, v13
	v_lshl_or_b32 v13, v13, 3, v14
	v_dual_mov_b32 v123, 0xff800000 :: v_dual_lshlrev_b32 v10, 5, v15
	...
	v_dual_mov_b32 v121, 0xff800000 :: v_dual_lshlrev_b32 v16, 1, v16
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v2, v1, 6, v78
	.loc	1 903 13                        ; attention.py:903:13
	v_add_nc_u32_e32 v3, 0, v1
	v_dual_mov_b32 v122, 0xff800000 :: v_dual_lshlrev_b32 v65, 1, v1
	v_dual_mov_b32 v124, 0xff800000 :: v_dual_lshlrev_b32 v1, 4, v1
	.loc	1 762 27                        ; attention.py:762:27
	...
	v_xor_b32_e32 v5, 48, v78
	v_add_nc_u32_e32 v107, 0, v63
	.loc	1 903 13                        ; attention.py:903:13
	v_mad_u64_u32 v[63:64], null, s7, v51, v[61:62]
	v_xor_b32_e32 v6, 64, v78
	v_xor_b32_e32 v7, 0x50, v78
	v_xor_b32_e32 v8, 0x60, v78
	...
	v_dual_mov_b32 v117, 0xff800000 :: v_dual_lshlrev_b32 v110, 1, v61
	v_xor_b32_e32 v54, 16, v88
	v_add_nc_u32_e32 v90, 0, v4
	v_add_nc_u32_e32 v108, v87, v65
	v_mov_b32_e32 v4, v49
	v_lshl_add_u32 v1, v72, 2, v3
	v_dual_mov_b32 v118, 0xff800000 :: v_dual_add_nc_u32 v3, 0, v66
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_vgpr, 164
