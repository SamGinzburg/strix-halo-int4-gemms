	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[10:11], null, s19, v3, v[9:10]
...
.Ltmp15:
	...
	v_or_b32_e32 v3, s18, v38
	v_or_b32_e32 v6, s18, v9
...
.Ltmp19:
	...
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v6, s18, v40
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v11, s7, v38
	v_or_b32_e32 v12, s7, v9
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v13, s7, v40
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_dual_cndmask_b32 v6, 0x80000000, v13 :: v_dual_lshlrev_b32 v11, 2, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s4, s2
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v2, 0x80000000, v2 :: v_dual_and_b32 v7, 48, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s18, s7
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	s_add_i32 s7, s37, s42
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_ashr_i32 s42, s41, 31
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v43, s7, v38
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_lshr_b32 s42, s42, 24
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v45, s7, v40
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_add_i32 s41, s41, s42
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s43, s7, s36
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_cmp_gt_i32_e32 vcc_lo, s19, v43
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_ashr_i32 s41, s41, 8
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v44, s7, v9
	...
	v_add_nc_u32_e32 v49, s1, v34
	v_add_nc_u32_e32 v50, s1, v36
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v60, v43 :: v_dual_add_nc_u32 v102, s34, v42
...
; %bb.8:
	...
	v_add_nc_u32_e32 v6, s14, v35
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v38, s15, v33
	v_add_nc_u32_e32 v39, s15, v30
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	v_mov_b32_e32 v38, 0
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v40, s14, v36
	v_add_nc_u32_e32 v39, s14, v34
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s15, v32
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v45, v38 :: v_dual_add_nc_u32 v42, s15, v31
...
; %bb.10:
	...
	v_add_nc_u32_e32 v1, s34, v34
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v33, v30 :: v_dual_add_nc_u32 v32, s1, v32
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
...
.LBB0_11:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_cndmask_b32 v21, 0x80000000, v21 :: v_dual_lshlrev_b32 v10, 1, v10
	s_clause 0x7
	...
	v_dual_mul_f32 v27, v29, v27 :: v_dual_and_b32 v12, 28, v12
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v23, 16, v23
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v26, v29, v26 :: v_dual_lshlrev_b32 v25, 16, v25
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_or_b32 v11, 0x1c0, v11, v12
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v12, v30, v31
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v10, v49, 2, v10
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v31, v30, v32
	v_mul_f32_e32 v32, v30, v33
	v_dual_mul_f32 v33, v30, v34 :: v_dual_lshlrev_b32 v0, 5, v0
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v10, v49, 9, v10
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v34, v30, v35
	v_mul_f32_e32 v35, v30, v36
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v3, v35, v3, v16
	v_fma_f32 v2, v36, v2, v15
	v_fma_f32 v4, v30, v4, v13
	v_fma_f32 v5, v34, v5, v17
	v_fma_f32 v8, v31, v8, v20
	v_fma_f32 v7, v32, v7, v19
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(0)
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v21, v29, v21 :: v_dual_add_nc_u32 v18, 0, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v1, v28, v1, v4
	v_fma_f32 v27, v27, v38, v2
	v_fma_f32 v26, v26, v39, v3
	v_fma_f32 v24, v24, v40, v5
	v_fma_f32 v22, v22, v41, v6
	v_fma_f32 v25, v25, v42, v7
	v_fma_f32 v23, v23, v43, v8
	v_fma_f32 v21, v21, v44, v9
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v4, v5, v24, s2
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v6, v7, v25, s2
	v_cndmask_b32_e64 v7, v8, v23, s2
	v_cndmask_b32_e64 v8, v9, v21, s2
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	ds_store_b32 v11, v1
	ds_store_b32 v12, v2
	ds_store_b32 v13, v3
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 103
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
