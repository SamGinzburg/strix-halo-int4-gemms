	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_and_b32_e32 v45, 0x700, v46
	v_lshrrev_b32_e32 v43, 2, v43
	v_and_b32_e32 v46, 0x90, v47
	v_and_b32_e32 v47, 0x160, v48
	v_lshl_or_b32 v87, v39, 7, v15
	...
	v_xor_b32_e32 v38, v46, v43
	v_add_nc_u32_e32 v39, 0, v45
	v_and_or_b32 v88, 0x90, v49, v47
	v_lshl_or_b32 v40, v40, 6, v87
	.loc	1 758 19                        ; attention.py:758:19
	...
	v_dual_mov_b32 v21, v33 :: v_dual_add_nc_u32 v90, v39, v38
	v_dual_mov_b32 v23, v33 :: v_dual_add_nc_u32 v38, 0, v40
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v42, s28, v85
	.loc	1 788 26                        ; attention.py:788:26
	v_add_nc_u32_e32 v89, 0, v41
	v_xor_b32_e32 v41, 16, v87
	v_xor_b32_e32 v43, 32, v87
	v_xor_b32_e32 v45, 48, v87
	v_xor_b32_e32 v46, 64, v87
	v_xor_b32_e32 v47, 0x50, v87
	v_xor_b32_e32 v48, 0x60, v87
	v_xor_b32_e32 v49, 0x70, v87
	v_xor_b32_e32 v50, 16, v88
	.loc	1 755 23                        ; attention.py:755:23
	s_ashr_i32 s0, s0, 4
	.loc	1 758 19                        ; attention.py:758:19
	s_ashr_i32 s2, s2, 1
	...
	.loc	1 788 26                        ; attention.py:788:26
	s_waitcnt vmcnt(3)
	ds_store_b128 v89, v[1:4]
	s_waitcnt vmcnt(2)
	ds_store_b128 v89, v[5:8] offset:2048
	s_waitcnt vmcnt(1)
	ds_store_b128 v89, v[11:14] offset:4096
	s_waitcnt vmcnt(0)
	ds_store_b128 v89, v[34:37] offset:6144
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v84, 0x7060706, v15
	v_mov_b32_e32 v3, v33
	v_mov_b32_e32 v15, v33
	v_mov_b32_e32 v2, v33
	v_mov_b32_e32 v4, v33
	v_dual_mov_b32 v5, v33 :: v_dual_mov_b32 v100, 0xff800000
	v_mov_b32_e32 v6, v33
	v_dual_mov_b32 v7, v33 :: v_dual_mov_b32 v86, 0
	v_mov_b32_e32 v8, v33
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 938 32                        ; attention.py:938:32
	s_add_i32 s3, s25, s28
	.loc	1 944 30                        ; attention.py:944:30
	v_mov_b32_e32 v40, v33
	.loc	1 938 32                        ; attention.py:938:32
	s_mul_i32 s3, s3, s14
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v34, v33 :: v_dual_add_nc_u32 v101, 0, v87
	...
	v_dual_mul_f32 v35, s27, v73 :: v_dual_mul_f32 v36, s27, v74
	v_dual_mul_f32 v37, s27, v75 :: v_dual_mul_f32 v38, s27, v76
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v39, s27, v77 :: v_dual_mul_f32 v40, s27, v78
	v_dual_mul_f32 v73, s27, v79 :: v_dual_mul_f32 v74, s27, v80
	s_delay_alu instid0(VALU_DEP_4)
...
.Ltmp6:
	...
	v_permlanex16_b32 v37, v35, s26, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp7:
...
.Ltmp9:
	...
	v_permlanex16_b32 v74, v39, s26, 0xfedcba98 op_sel:[1,0]
...
.Ltmp11:
	...
	v_permlanex16_b32 v76, v77, s26, 0xfedcba98 op_sel:[1,0]
...
.Ltmp13:
	...
	v_permlanex16_b32 v78, v79, s26, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.Ltmp20:
	...
	v_permlanex16_b32 v37, v36, s26, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp21:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v80, v104, s26, 0xfedcba98 op_sel:[1,0]
.Ltmp22:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
...
.Ltmp23:
	...
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v90, v107, v104 offset1:8
	.loc	1 1000 41                       ; attention.py:1000:41
	...
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_store_2addr_b32 v90, v104, v106 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 113
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_full_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.kd
