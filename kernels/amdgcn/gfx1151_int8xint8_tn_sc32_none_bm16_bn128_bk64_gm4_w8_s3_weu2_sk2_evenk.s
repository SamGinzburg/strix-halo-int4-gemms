...
.Ltmp24:
	...
	v_add3_u32 v32, v1, s28, v6
	v_add3_u32 v33, v2, s28, v6
	v_add_nc_u32_e32 v34, 0, v9
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v35, 0, v7
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v44, v33, s[20:23], 0 offen
	.loc	1 322 26                        ; generate_amdgcn.py:322:26
	buffer_load_b128 v[36:39], v31, s[4:7], 0 offen
	.loc	1 316 26                        ; generate_amdgcn.py:316:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v45, v32, s[20:23], 0 offen
	.loc	1 322 26                        ; generate_amdgcn.py:322:26
	...
	v_dual_mul_f32 v38, v38, v52 :: v_dual_add_nc_u32 v33, s24, v33
	...
	v_dual_mul_f32 v45, v45, v61 :: v_dual_add_nc_u32 v32, s24, v32
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v46, v46, v61 :: v_dual_lshlrev_b32 v63, 16, v87
	.loc	1 336 17                        ; generate_amdgcn.py:336:17
	s_waitcnt vmcnt(5)
	v_dual_fmac_f32 v17, v38, v55 :: v_dual_lshlrev_b32 v64, 16, v88
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v16, v39, v56 :: v_dual_lshlrev_b32 v65, 16, v89
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v15, v40, v57 :: v_dual_lshlrev_b32 v66, 16, v90
	.loc	1 336 24                        ; generate_amdgcn.py:336:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v48, v48, v61 :: v_dual_lshlrev_b32 v67, 16, v91
	.loc	1 336 17                        ; generate_amdgcn.py:336:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v13, v42, v59 :: v_dual_lshlrev_b32 v68, 16, v92
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v14, v41, v58 :: v_dual_lshlrev_b32 v69, 16, v93
	.loc	1 336 24                        ; generate_amdgcn.py:336:24
	v_dual_mul_f32 v50, v50, v61 :: v_dual_fmac_f32 v11, v43, v60
	.loc	1 336 17                        ; generate_amdgcn.py:336:17
	v_dual_fmac_f32 v12, v36, v53 :: v_dual_fmac_f32 v17, v46, v64
	v_dual_fmac_f32 v18, v45, v63 :: v_dual_fmac_f32 v15, v48, v66
	v_fmac_f32_e32 v16, v47, v65
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v12, v44, v62 :: v_dual_fmac_f32 v13, v50, v68
