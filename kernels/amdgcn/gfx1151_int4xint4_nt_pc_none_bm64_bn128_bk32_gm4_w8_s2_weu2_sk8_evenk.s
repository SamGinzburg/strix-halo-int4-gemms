	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_mad_u64_u32 v[1:2], null, s16, v49, v[33:34]
	.loc	1 129 30                        ; generate_amdgcn.py:129:30
	v_mad_u64_u32 v[2:3], null, s16, v50, v[34:35]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add3_u32 v47, s2, s11, v1
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_mov_b32 s11, s7
	.loc	1 129 30 is_stmt 0              ; generate_amdgcn.py:129:30
	v_add3_u32 v46, s2, s10, v2
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_mov_b32 s10, s6
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_cndmask_b32_e32 v2, 0x80000000, v46, vcc_lo
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	v_and_b32_e32 v7, 0x37c, v37
	v_xor_b32_e32 v4, v4, v7
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_cndmask_b32 v1, 0x80000000, v47 :: v_dual_add_nc_u32 v44, 0, v4
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v44, v3 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
...
.LBB0_3:                                ; %Flow58
	v_bfe_i32 v2, v0, 3, 1
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v36, 0x80, v0
	v_dual_mov_b32 v3, 0 :: v_dual_lshlrev_b32 v38, 4, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v41, 0x88, v2
	v_mov_b32_e32 v2, 0
	v_dual_mov_b32 v5, 0 :: v_dual_lshlrev_b32 v42, 1, v36
	...
	v_dual_mov_b32 v30, 0 :: v_dual_mov_b32 v9, 0
...
; %bb.4:                                ; %.lr.ph
	...
	s_mov_b32 s11, s7
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_b32 v69, v47, s[4:7], 0 offen offset:128
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[67:68], v46, s[8:11], 0 offen offset:128
	s_mov_b32 s20, 0
.Ltmp12:
...
.Ltmp15:
	...
	s_cmp_eq_u32 s18, 2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[51:54], v40 offset0:4 offset1:5
	v_add_nc_u32_e32 v47, 0, v2
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[55:58], v46 offset1:2
	v_add_nc_u32_e32 v48, 0, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[59:62], v47 offset0:4 offset1:5
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[63:66], v48 offset1:2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v44, v69 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v45, v[67:68]
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
...
; %bb.5:                                ; %.peel.next
	v_lshl_or_b32 v50, s17, 7, v50
	s_lshl_b32 s15, s15, 7
	v_add_nc_u32_e32 v51, s12, v49
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_subrev_nc_u32_e32 v50, s15, v50
	v_mad_u64_u32 v[49:50], null, s16, v50, s[2:3]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[50:51], null, s16, v51, s[2:3]
	s_add_i32 s2, s18, -2
	v_add3_u32 v34, v49, v34, 0x100
	v_add3_u32 v33, v50, v33, 0x100
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	buffer_load_b32 v67, v33, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[65:66], v34, s[8:11], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[49:52], v40 offset0:4 offset1:5
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[53:56], v46 offset1:2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[57:60], v47 offset0:4 offset1:5
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[61:64], v48 offset1:2
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v44, v67 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v45, v[65:66]
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
...
.LBB0_12:
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_or3_b32 v43, v40, v34, v41
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_or3_b32 v34, v41, v42, v34
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v41, 0, v43
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v45, 0, v34
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_xad_u32 v49, v43, 8, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_xad_u32 v34, v34, 8, 0
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[41:44], v41 offset1:2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[45:48], v45 offset0:4 offset1:5
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_2addr_stride64_b64 v[49:52], v49 offset1:2
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_2addr_stride64_b64 v[53:56], v34 offset0:4 offset1:5
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[51:52], v[53:54], v[17:24] neg_lo:[1,1,0]
...
.LBB0_13:
	...
	v_or3_b32 v34, v34, v41, s12
	s_mov_b32 s6, 0x7ffffffe
	.loc	1 143 22 is_stmt 1              ; generate_amdgcn.py:143:22
	v_or3_b32 v33, v33, v39, s3
	.loc	1 142 14                        ; generate_amdgcn.py:142:14
	s_mov_b32 s4, s8
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_and_or_b32 v6, 0x78, v37, v40
	v_or3_b32 v0, v8, v0, v9
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_lshrrev_b32_e32 v57, 7, v36
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	...
	v_xad_u32 v37, v4, 8, 0
	v_xad_u32 v38, v4, 16, 0
	...
	v_dual_mul_f32 v55, v4, v8 :: v_dual_lshlrev_b32 v30, 16, v33
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v12, 16, v45
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v45, v0, v14 :: v_dual_lshlrev_b32 v24, 16, v53
	v_dual_mul_f32 v53, v0, v30 :: v_dual_lshlrev_b32 v20, 16, v51
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v105, v4, v12
	v_mul_f32_e32 v106, v4, v14
	v_dual_mul_f32 v107, v4, v15 :: v_dual_lshlrev_b32 v22, 16, v52
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v6, 16, v48
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v52, v0, v28
	v_dual_mul_f32 v111, v4, v24 :: v_dual_lshlrev_b32 v16, 16, v50
	v_mul_f32_e32 v109, v4, v20
	v_dual_mul_f32 v50, v0, v24 :: v_dual_lshlrev_b32 v9, 16, v42
	v_mul_f32_e32 v113, v4, v28
	v_mul_f32_e32 v51, v0, v26
	v_dual_mul_f32 v104, v4, v10 :: v_dual_lshlrev_b32 v11, 16, v44
	v_mul_f32_e32 v44, v0, v13
	v_mul_f32_e32 v49, v0, v22
	v_mul_f32_e32 v33, v0, v6
	v_mul_f32_e32 v54, v4, v6
	...
	v_dual_mul_f32 v112, v4, v26 :: v_dual_mul_f32 v13, v13, v31
	v_dual_mul_f32 v114, v4, v30 :: v_dual_mul_f32 v15, v106, v32
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v0, v33, v1
	v_mul_f32_e32 v16, v46, v17
	v_mul_f32_e32 v1, v54, v25
	v_dual_mul_f32 v17, v107, v67 :: v_dual_mul_f32 v2, v34, v2
	v_mul_f32_e32 v4, v39, v3
	v_dual_mul_f32 v8, v42, v5 :: v_dual_mul_f32 v25, v111, v71
	v_mul_f32_e32 v18, v47, v18
	v_dual_mul_f32 v20, v48, v19 :: v_dual_mul_f32 v3, v55, v64
	v_mul_f32_e32 v5, v9, v27
	v_dual_mul_f32 v6, v41, v58 :: v_dual_mul_f32 v19, v108, v68
	v_mul_f32_e32 v10, v43, v59
	v_mul_f32_e32 v24, v50, v21
	v_mul_f32_e32 v21, v109, v69
	v_mul_f32_e32 v22, v49, v61
	v_dual_mul_f32 v28, v52, v23 :: v_dual_mul_f32 v9, v11, v29
	v_dual_mul_f32 v12, v44, v7 :: v_dual_mul_f32 v23, v110, v70
	v_dual_mul_f32 v7, v104, v65 :: v_dual_mul_f32 v14, v45, v60
	v_mul_f32_e32 v31, v114, v74
	v_mul_f32_e32 v26, v51, v62
	v_mul_f32_e32 v30, v53, v63
	v_mul_f32_e32 v11, v105, v66
	v_mul_f32_e32 v27, v112, v72
	v_mul_f32_e32 v29, v113, v73
	ds_store_2addr_stride64_b64 v36, v[0:1], v[16:17] offset1:2
	ds_store_2addr_stride64_b64 v37, v[2:3], v[18:19] offset1:2
	ds_store_2addr_stride64_b64 v38, v[4:5], v[20:21] offset1:2
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 115
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.kd
