...
.Ltmp13:
	...
	v_dual_cndmask_b32 v2, 0x80000000, v13 :: v_dual_lshlrev_b32 v11, 3, v24
	s_clause 0x1
	...
	s_clause 0x1
	buffer_load_b128 v[35:38], v13, s[20:23], 0 offen
	buffer_load_b128 v[39:42], v15, s[20:23], 0 offen
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_cndmask_b32_e64 v13, 0x80000000, v16, s3
	v_cndmask_b32_e64 v15, 0x80000000, v17, s3
	s_clause 0x1
	buffer_load_b128 v[43:46], v13, s[20:23], 0 offen
	buffer_load_b128 v[47:50], v15, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_dual_cndmask_b32 v13, 0x80000000, v14 :: v_dual_lshlrev_b32 v14, 3, v0
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_clause 0x1
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v51, s35, v12
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v16, v14, v15
	v_and_b32_e32 v14, 32, v0
	buffer_load_b64 v[62:63], v13, s[16:19], 0 offen
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, vcc_lo, s2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_dual_cndmask_b32 v51, 0x80000000, v51 :: v_dual_lshlrev_b32 v26, 3, v18
	v_add_nc_u32_e32 v64, 0, v16
	v_lshlrev_b32_e32 v15, 6, v24
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s5, 0xbf
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b64 v[66:67], v51, s[16:19], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v13, v0, 0, 1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v13, 0x420, v13
	v_xor_b32_e32 v17, v13, v9
	v_and_b32_e32 v13, 8, v0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v17, v18, 10, v17
	v_xor_b32_e32 v18, 0x90, v17
	v_xor_b32_e32 v19, 0x120, v17
	v_add_nc_u32_e32 v68, 0, v17
	v_xor_b32_e32 v20, 0x1b0, v17
	v_xor_b32_e32 v21, 0x210, v17
	v_add_nc_u32_e32 v69, 0, v18
	v_xor_b32_e32 v22, 0x330, v17
	v_add_nc_u32_e32 v70, 0, v19
	v_xor_b32_e32 v23, 0x3a0, v17
	...
	v_lshrrev_b32_e32 v78, 8, v54
	v_lshrrev_b32_e32 v79, 24, v54
	...
	s_waitcnt vmcnt(6)
	v_perm_b32 v89, v40, v36, 0x5010400
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(4)
	v_perm_b32 v93, v47, v43, 0x5010400
	v_perm_b32 v47, v47, v43, 0x7030602
	v_perm_b32 v94, v48, v44, 0x5010400
	s_waitcnt vmcnt(2)
	v_perm_b32 v55, v5, v1, 0x5010400
	v_perm_b32 v81, v5, v1, 0x7030602
	v_perm_b32 v82, v6, v2, 0x5010400
	v_perm_b32 v83, v6, v2, 0x7030602
	v_perm_b32 v84, v7, v3, 0x5010400
	v_perm_b32 v85, v7, v3, 0x7030602
	v_perm_b32 v86, v8, v4, 0x5010400
	v_perm_b32 v87, v8, v4, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v1.l, 8, v56.l
	v_lshlrev_b16 v1.h, 8, v57.l
	v_lshlrev_b16 v2.l, 8, v51.l
	v_lshlrev_b16 v2.h, 8, v58.l
	v_lshlrev_b16 v3.l, 8, v59.l
	v_lshlrev_b16 v3.h, 8, v60.l
	v_lshlrev_b16 v4.l, 8, v52.l
	v_lshlrev_b16 v4.h, 8, v61.l
	v_lshlrev_b16 v5.l, 8, v75.l
	v_lshlrev_b16 v5.h, 8, v76.l
	v_lshlrev_b16 v6.l, 8, v53.l
	v_lshlrev_b16 v6.h, 8, v77.l
	v_lshlrev_b16 v7.l, 8, v78.l
	v_lshlrev_b16 v7.h, 8, v79.l
	v_lshlrev_b16 v8.l, 8, v54.l
	v_lshlrev_b16 v8.h, 8, v80.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v51.l, 0xff, v55.l
	v_lshrrev_b32_e32 v59, 8, v55
	v_lshrrev_b32_e32 v60, 24, v55
	v_and_b16 v51.h, 0xff, v55.h
	v_and_b16 v52.l, 0xff, v81.l
	v_lshrrev_b32_e32 v61, 8, v81
	v_lshrrev_b32_e32 v75, 24, v81
	v_and_b16 v52.h, 0xff, v81.h
	v_and_b16 v53.l, 0xff, v82.l
	v_lshrrev_b32_e32 v76, 8, v82
	v_lshrrev_b32_e32 v77, 24, v82
	v_and_b16 v53.h, 0xff, v82.h
	v_and_b16 v54.l, 0xff, v83.l
	v_lshrrev_b32_e32 v78, 8, v83
	v_lshrrev_b32_e32 v79, 24, v83
	v_and_b16 v54.h, 0xff, v83.h
	v_and_b16 v55.l, 0xff, v84.l
	v_lshrrev_b32_e32 v80, 8, v84
	v_lshrrev_b32_e32 v81, 24, v84
	v_and_b16 v55.h, 0xff, v84.h
	v_and_b16 v56.l, 0xff, v85.l
	v_lshrrev_b32_e32 v82, 8, v85
	v_lshrrev_b32_e32 v83, 24, v85
	v_and_b16 v56.h, 0xff, v85.h
	v_and_b16 v57.l, 0xff, v86.l
	v_lshrrev_b32_e32 v84, 8, v86
	v_lshrrev_b32_e32 v85, 24, v86
	v_and_b16 v57.h, 0xff, v86.h
	v_and_b16 v58.l, 0xff, v87.l
	v_lshrrev_b32_e32 v86, 8, v87
	v_lshrrev_b32_e32 v88, 24, v87
	v_and_b16 v58.h, 0xff, v87.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v87, v39, v35, 0x5010400
	...
	v_perm_b32 v96, v50, v46, 0x5010400
	v_perm_b32 v97, v50, v46, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_and_b16 v37.l, 0xff, v89.l
	v_lshrrev_b32_e32 v77, 24, v89
	v_and_b16 v37.h, 0xff, v89.h
	...
	v_lshrrev_b32_e32 v98, 24, v48
	v_and_b16 v46.h, 0xff, v48.h
	v_and_b16 v47.l, 0xff, v95.l
	v_lshrrev_b32_e32 v99, 8, v95
	v_lshrrev_b32_e32 v100, 24, v95
	v_and_b16 v47.h, 0xff, v95.h
	v_and_b16 v48.l, 0xff, v49.l
	v_lshrrev_b32_e32 v95, 8, v49
	v_lshrrev_b32_e32 v101, 24, v49
	v_and_b16 v48.h, 0xff, v49.h
	v_and_b16 v49.l, 0xff, v96.l
	v_lshrrev_b32_e32 v102, 8, v96
	v_lshrrev_b32_e32 v103, 24, v96
	v_and_b16 v49.h, 0xff, v96.h
	v_lshrrev_b32_e32 v96, 8, v97
	v_lshrrev_b32_e32 v104, 24, v97
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v68, v1
	ds_store_b16_d16_hi v68, v1 offset:64
	ds_store_b16 v69, v2
	ds_store_b16_d16_hi v69, v2 offset:64
	ds_store_b16 v70, v3
	ds_store_b16_d16_hi v70, v3 offset:64
	ds_store_b16 v71, v4
	ds_store_b16_d16_hi v71, v4 offset:64
	ds_store_b16 v72, v5
	ds_store_b16_d16_hi v72, v5 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v3.h, v54.l, v30.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v30.l, 8, v59.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v27.l, v51.l, v27.l
	v_or_b16 v4.l, v54.h, v30.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v30.h, 8, v60.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v4.h, v55.l, v31.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v31.l, 8, v61.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v5.l, v55.h, v31.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v31.h, 8, v75.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v1.l, v51.h, v27.h
	v_or_b16 v5.h, v56.l, v32.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v32.l, 8, v76.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v50.l, 0xff, v97.l
	v_and_b16 v50.h, 0xff, v97.h
	v_or_b16 v1.h, v52.l, v28.l
	v_or_b16 v2.l, v52.h, v28.h
	v_or_b16 v2.h, v53.l, v29.l
	v_or_b16 v3.l, v53.h, v29.h
	v_or_b16 v27.h, v56.h, v32.h
	v_or_b16 v28.l, v57.l, v33.l
	v_or_b16 v28.h, v57.h, v33.h
	v_or_b16 v29.l, v58.l, v34.l
	v_or_b16 v29.h, v58.h, v34.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v32.h, 8, v77.l
	v_lshlrev_b16 v33.l, 8, v78.l
	v_lshlrev_b16 v33.h, 8, v79.l
	v_lshlrev_b16 v34.l, 8, v80.l
	v_lshlrev_b16 v34.h, 8, v81.l
	v_lshlrev_b16 v51.l, 8, v82.l
	v_lshlrev_b16 v51.h, 8, v83.l
	v_lshlrev_b16 v52.l, 8, v84.l
	v_lshlrev_b16 v52.h, 8, v85.l
	v_lshlrev_b16 v53.l, 8, v86.l
	v_lshlrev_b16 v53.h, 8, v87.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v54.l, 8, v88.l
	v_lshlrev_b16 v54.h, 8, v89.l
	v_lshlrev_b16 v55.l, 8, v90.l
	v_lshlrev_b16 v55.h, 8, v91.l
	v_lshlrev_b16 v56.l, 8, v92.l
	v_lshlrev_b16 v56.h, 8, v93.l
	v_lshlrev_b16 v57.l, 8, v94.l
	v_lshlrev_b16 v57.h, 8, v98.l
	v_lshlrev_b16 v58.l, 8, v99.l
	v_lshlrev_b16 v58.h, 8, v100.l
	v_lshlrev_b16 v59.l, 8, v95.l
	v_lshlrev_b16 v59.h, 8, v101.l
	v_lshlrev_b16 v60.l, 8, v102.l
	v_lshlrev_b16 v60.h, 8, v103.l
	v_lshlrev_b16 v61.l, 8, v96.l
	v_lshlrev_b16 v61.h, 8, v104.l
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(1)
	ds_store_b64 v64, v[62:63] offset:32768
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v68, v27 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v68, v6 offset:640
	ds_store_b16_d16_hi v68, v6 offset:704
	ds_store_b16 v73, v7
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v68, v1 offset:16448
	ds_store_b16_d16_hi v69, v1 offset:16384
	ds_store_b16 v69, v2 offset:16448
	ds_store_b16_d16_hi v70, v2 offset:16384
	ds_store_b16 v70, v3 offset:16448
	ds_store_b16_d16_hi v71, v3 offset:16384
	ds_store_b16 v71, v4 offset:16448
	ds_store_b16_d16_hi v72, v4 offset:16384
	ds_store_b16 v72, v5 offset:16448
	ds_store_b16_d16_hi v68, v5 offset:17024
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_or_b16 v6.l, v40.l, v51.l
	v_or_b16 v6.h, v40.h, v51.h
	v_or_b16 v7.l, v41.l, v52.l
	v_or_b16 v7.h, v41.h, v52.h
	v_or_b16 v8.l, v42.l, v53.l
	v_or_b16 v8.h, v42.h, v53.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v27.l, v43.l, v54.l
	v_or_b16 v27.h, v43.h, v54.h
	v_or_b16 v28.l, v44.l, v55.l
	v_or_b16 v28.h, v44.h, v55.h
	v_or_b16 v29.l, v45.l, v56.l
	v_or_b16 v29.h, v45.h, v56.h
	v_or_b16 v30.l, v46.l, v57.l
	v_or_b16 v30.h, v46.h, v57.h
	v_or_b16 v31.l, v47.l, v58.l
	v_or_b16 v31.h, v47.h, v58.h
	v_or_b16 v32.l, v48.l, v59.l
	v_or_b16 v32.h, v48.h, v59.h
	v_or_b16 v33.l, v49.l, v60.l
	v_or_b16 v33.h, v49.h, v60.h
	v_or_b16 v34.l, v50.l, v61.l
	v_or_b16 v34.h, v50.h, v61.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v68, v1 offset:8192
	ds_store_b16_d16_hi v68, v1 offset:8256
	ds_store_b16 v69, v2 offset:8192
	ds_store_b16_d16_hi v69, v2 offset:8256
	ds_store_b16 v70, v3 offset:8192
	ds_store_b16_d16_hi v70, v3 offset:8256
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v64, v[66:67] offset:34816
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v68, v27 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v68, v6 offset:8832
	ds_store_b16_d16_hi v68, v6 offset:8896
...
.Ltmp14:
	...
	v_and_or_b32 v70, 0x1800, v25, v26
	v_lshl_or_b32 v66, v65, 6, v26
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v24, s31, v10
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s6, s35, s6
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v79, s8, v25
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v29, s6, v11
	v_or_b32_e32 v30, s6, v9
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v31, s6, v12
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s7, s6, s31
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v80, s8, v26
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	v_add_nc_u32_e32 v31, s6, v24
	s_mov_b32 s6, s0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v75, s7, v25
	v_dual_cndmask_b32 v32, 0x80000000, v32 :: v_dual_cndmask_b32 v71, 0x80000000, v71
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_dual_cndmask_b32 v72, 0x80000000, v30 :: v_dual_cndmask_b32 v73, 0x80000000, v31
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b64 v[171:172], v29, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[29:32], v32, s[20:23], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v76, s7, v26
	v_add_nc_u32_e32 v77, s7, v27
	v_add_nc_u32_e32 v78, s7, v28
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_add_nc_u32_e32 v81, s8, v27
	v_add_nc_u32_e32 v82, s8, v28
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_add_f32 v53, v53, v87 :: v_dual_add_nc_u32 v174, s33, v17
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	...
	v_dual_add_f32 v36, v36, v86 :: v_dual_add_f32 v35, v35, v85
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_add_f32_e32 v54, v54, v88
	v_dual_add_f32 v49, v49, v89 :: v_dual_add_nc_u32 v176, s33, v19
	v_add_f32_e32 v50, v50, v90
	v_dual_add_f32 v43, v43, v91 :: v_dual_add_nc_u32 v178, s33, v21
	v_dual_add_f32 v38, v38, v94 :: v_dual_add_nc_u32 v173, s3, v16
	v_dual_add_f32 v44, v44, v92 :: v_dual_add_nc_u32 v175, s33, v18
	v_dual_add_f32 v56, v56, v98 :: v_dual_add_nc_u32 v177, s33, v20
	v_dual_add_f32 v62, v62, v96 :: v_dual_add_nc_u32 v179, s33, v22
	v_dual_add_f32 v37, v37, v93 :: v_dual_add_nc_u32 v180, s33, v23
	v_dual_add_f32 v61, v61, v95 :: v_dual_add_f32 v46, v46, v100
	v_dual_add_f32 v55, v55, v97 :: v_dual_add_f32 v40, v40, v102
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(4)
	ds_store_b64 v173, v[171:172] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(2)
	v_perm_b32 v71, v103, v29, 0x5010400
	v_perm_b32 v72, v103, v29, 0x7030602
	v_perm_b32 v73, v104, v30, 0x5010400
	v_perm_b32 v74, v104, v30, 0x7030602
	v_perm_b32 v75, v105, v31, 0x5010400
	v_perm_b32 v76, v105, v31, 0x7030602
	v_perm_b32 v77, v106, v32, 0x5010400
	v_perm_b32 v78, v106, v32, 0x7030602
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(0)
	v_perm_b32 v79, v111, v107, 0x5010400
	v_perm_b32 v80, v111, v107, 0x7030602
	v_perm_b32 v81, v112, v108, 0x5010400
	v_perm_b32 v82, v112, v108, 0x7030602
	v_perm_b32 v83, v113, v109, 0x5010400
	v_perm_b32 v84, v113, v109, 0x7030602
	v_perm_b32 v85, v114, v110, 0x5010400
	v_perm_b32 v86, v114, v110, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshrrev_b32_e32 v87, 8, v71
	...
	v_lshrrev_b32_e32 v93, 8, v74
	v_lshrrev_b32_e32 v94, 24, v74
	v_and_b16 v71.l, 0xff, v75.l
	v_lshrrev_b32_e32 v95, 8, v75
	v_lshrrev_b32_e32 v96, 24, v75
	v_lshrrev_b32_e32 v97, 8, v76
	v_lshrrev_b32_e32 v98, 24, v76
	v_lshrrev_b32_e32 v99, 8, v77
	v_lshrrev_b32_e32 v100, 24, v77
	v_lshrrev_b32_e32 v101, 8, v78
	v_lshrrev_b32_e32 v102, 24, v78
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v75.l, 0xff, v79.l
	v_lshrrev_b32_e32 v103, 8, v79
	v_lshrrev_b32_e32 v104, 24, v79
	v_lshrrev_b32_e32 v105, 8, v80
	v_lshrrev_b32_e32 v106, 24, v80
	v_lshrrev_b32_e32 v107, 8, v81
	v_lshrrev_b32_e32 v108, 24, v81
	v_lshrrev_b32_e32 v109, 8, v82
	v_lshrrev_b32_e32 v110, 24, v82
	v_and_b16 v79.l, 0xff, v83.l
	v_lshrrev_b32_e32 v111, 8, v83
	v_lshrrev_b32_e32 v112, 24, v83
	v_lshrrev_b32_e32 v113, 8, v84
	v_lshrrev_b32_e32 v114, 24, v84
	v_lshrrev_b32_e32 v115, 8, v85
	v_lshrrev_b32_e32 v116, 24, v85
	v_lshrrev_b32_e32 v117, 8, v86
	v_lshrrev_b32_e32 v118, 24, v86
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v83.l, 8, v87.l
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v84.h, 8, v90.l
	v_and_b16 v31.l, 0xff, v73.l
	v_and_b16 v73.l, 0xff, v77.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v77.l, 0xff, v81.l
	v_and_b16 v81.l, 0xff, v85.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v85.l, 8, v91.l
	...
	v_and_b16 v81.h, 0xff, v85.h
	v_and_b16 v82.l, 0xff, v86.l
	v_and_b16 v82.h, 0xff, v86.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v85.h, 8, v92.l
	v_lshlrev_b16 v86.l, 8, v93.l
	v_lshlrev_b16 v86.h, 8, v94.l
	v_lshlrev_b16 v87.l, 8, v95.l
	v_lshlrev_b16 v87.h, 8, v96.l
	v_lshlrev_b16 v88.l, 8, v97.l
	v_lshlrev_b16 v88.h, 8, v98.l
	v_lshlrev_b16 v89.l, 8, v99.l
	...
	v_lshlrev_b16 v92.h, 8, v106.l
	v_lshlrev_b16 v93.l, 8, v107.l
	v_lshlrev_b16 v93.h, 8, v108.l
	v_lshlrev_b16 v94.l, 8, v109.l
	v_lshlrev_b16 v94.h, 8, v110.l
	v_lshlrev_b16 v95.l, 8, v111.l
	v_lshlrev_b16 v95.h, 8, v112.l
	v_lshlrev_b16 v96.l, 8, v113.l
	v_lshlrev_b16 v96.h, 8, v114.l
	v_lshlrev_b16 v97.l, 8, v115.l
	v_lshlrev_b16 v97.h, 8, v116.l
	v_lshlrev_b16 v98.l, 8, v117.l
	v_lshlrev_b16 v98.h, 8, v118.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v177, v32
	ds_store_b16_d16_hi v177, v32 offset:64
	ds_store_b16 v178, v71
	ds_store_b16_d16_hi v178, v71 offset:64
	ds_store_b16 v174, v72 offset:640
	ds_store_b16_d16_hi v174, v72 offset:704
	...
	ds_store_b16 v177, v78 offset:16384
	ds_store_b16_d16_hi v177, v78 offset:16448
	ds_store_b16 v178, v79 offset:16384
	ds_store_b16_d16_hi v178, v79 offset:16448
	ds_store_b16 v174, v80 offset:17024
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v179, v73 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v174, v80 offset:17088
	ds_store_b16 v179, v81 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v180, v74
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v179, v81 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v180, v74 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v180, v82 offset:16384
	ds_store_b16_d16_hi v180, v82 offset:16448
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v71, v15 :: v_dual_mov_b32 v24, v13
...
.LBB0_12:
	...
	v_mov_b32_e32 v66, 0
	v_add_nc_u32_e32 v2, s34, v67
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v84, 0 :: v_dual_add_nc_u32 v13, s34, v68
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cndmask_b32_e64 v67, 0, 1, s2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v14, s34, v69
	v_mov_b32_e32 v69, 0
	ds_load_b128 v[25:28], v13
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v67, s33, v71
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v87, s11 :: v_dual_add_nc_u32 v68, s33, v73
	v_mov_b32_e32 v86, s10
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[74:77], v67
	ds_load_b128 v[96:99], v68
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v85, s9 :: v_dual_add_nc_u32 v68, s33, v70
	v_dual_mov_b32 v84, s8 :: v_dual_add_nc_u32 v67, s33, v72
...
; %bb.15:
	...
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_dual_mov_b32 v104, s11 :: v_dual_add_nc_u32 v71, s3, v73
	v_mov_b32_e32 v103, s10
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_load_b128 v[105:108], v66
	ds_load_b128 v[109:112], v71
	.loc	1 415 28                        ; generate_amdgcn.py:415:28
	v_dual_mov_b32 v99, s6 :: v_dual_add_nc_u32 v70, s3, v70
	v_dual_mov_b32 v101, s8 :: v_dual_add_nc_u32 v66, s3, v72
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 181
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_swiglu_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 38
