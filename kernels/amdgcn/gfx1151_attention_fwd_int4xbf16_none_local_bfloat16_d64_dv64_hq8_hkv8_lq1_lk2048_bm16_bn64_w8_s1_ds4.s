...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v10, 56, v12
	...
	v_dual_mov_b32 v6, v1 :: v_dual_and_b32 v17, 24, v5
	...
	v_dual_mov_b32 v4, v1 :: v_dual_and_b32 v41, 24, v12
	...
	v_dual_mov_b32 v123, v119 :: v_dual_add_nc_u32 v118, 0, v12
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v33, s96, v53
	v_or_b32_e32 v38, s96, v55
	v_or_b32_e32 v39, s96, v56
	v_or_b32_e32 v40, s96, v57
	v_or_b32_e32 v126, s96, v58
	v_or_b32_e32 v136, s96, v59
	.loc	1 634 32                        ; attention.py:634:32
	v_cndmask_b32_e64 v17, 0x80000000, v17, s0
	.loc	1 649 37                        ; attention.py:649:37
	v_add_lshl_u32 v137, v90, s94, 1
	v_add_lshl_u32 v138, v91, s94, 1
	v_add_lshl_u32 v139, v92, s94, 1
	v_add_lshl_u32 v142, v93, s94, 1
	.loc	1 634 32                        ; attention.py:634:32
	buffer_load_b64 v[17:18], v17, s[80:83], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 649 37                        ; attention.py:649:37
	v_add_lshl_u32 v144, v94, s94, 1
	v_add_lshl_u32 v157, v95, s94, 1
	v_add_lshl_u32 v170, v96, s94, 1
	v_add_lshl_u32 v171, v97, s94, 1
	v_add_lshl_u32 v172, v98, s94, 1
	v_add_lshl_u32 v173, v99, s94, 1
	v_add_lshl_u32 v174, v100, s94, 1
	v_add_lshl_u32 v175, v101, s94, 1
	v_add_lshl_u32 v176, v102, s94, 1
	v_add_lshl_u32 v177, v103, s94, 1
	v_add_lshl_u32 v178, v104, s94, 1
	v_add_lshl_u32 v179, v105, s94, 1
	v_add_lshl_u32 v180, v106, s94, 1
	v_add_lshl_u32 v181, v107, s94, 1
	v_add_lshl_u32 v182, v108, s94, 1
	v_add_lshl_u32 v183, v109, s94, 1
	v_add_lshl_u32 v184, v110, s94, 1
	v_add_lshl_u32 v185, v111, s94, 1
	v_add_lshl_u32 v186, v112, s94, 1
	v_add_lshl_u32 v187, v113, s94, 1
	.loc	1 634 32                        ; attention.py:634:32
	s_waitcnt vmcnt(0)
	...
	ds_load_2addr_stride64_b64 v[29:32], v87 offset0:2 offset1:3
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[146:153], v[29:30], v[43:44], v[9:16] neg_lo:[1,1,0]
	...
	.loc	1 639 33                        ; attention.py:639:33
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[146:153], v[9:10], v[45:46], v[146:153] neg_lo:[1,1,0]
	...
	.loc	1 639 33                        ; attention.py:639:33
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[146:153], v[9:10], v[47:48], v[146:153] neg_lo:[1,1,0]
	...
	.loc	1 639 33                        ; attention.py:639:33
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[146:153], v[9:10], v[49:50], v[146:153] neg_lo:[1,1,0]
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_cvt_f32_i32_e32 v158, v151
	v_cvt_f32_i32_e32 v155, v149
	v_cvt_f32_i32_e32 v154, v148
	...
	buffer_load_u16 v36, v137, s[84:87], 0 offen
	buffer_load_u16 v39, v138, s[84:87], 0 offen
	buffer_load_u16 v37, v139, s[84:87], 0 offen
	buffer_load_u16 v129, v142, s[84:87], 0 offen
	buffer_load_u16 v142, v144, s[84:87], 0 offen
	buffer_load_u16 v144, v157, s[84:87], 0 offen
	buffer_load_u16 v146, v170, s[84:87], 0 offen
	buffer_load_u16 v131, v171, s[84:87], 0 offen
	buffer_load_u16 v136, v172, s[84:87], 0 offen
	buffer_load_u16 v132, v173, s[84:87], 0 offen
	buffer_load_u16 v137, v174, s[84:87], 0 offen
	buffer_load_u16 v134, v175, s[84:87], 0 offen
	buffer_load_u16 v161, v176, s[84:87], 0 offen
	buffer_load_u16 v162, v177, s[84:87], 0 offen
	buffer_load_u16 v164, v178, s[84:87], 0 offen
	buffer_load_u16 v165, v179, s[84:87], 0 offen
	buffer_load_u16 v148, v180, s[84:87], 0 offen
	buffer_load_u16 v157, v181, s[84:87], 0 offen
	buffer_load_u16 v159, v182, s[84:87], 0 offen
	buffer_load_u16 v160, v183, s[84:87], 0 offen
	buffer_load_u16 v149, v184, s[84:87], 0 offen
	buffer_load_u16 v130, v185, s[84:87], 0 offen
	buffer_load_u16 v133, v186, s[84:87], 0 offen
	buffer_load_u16 v138, v187, s[84:87], 0 offen
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v19, v124, v19 :: v_dual_mul_f32 v20, v123, v20
	v_dual_mul_f32 v21, v119, v21 :: v_dual_mul_f32 v28, v122, v28
	.loc	1 670 30                        ; attention.py:670:30
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v26, v123, v26 :: v_dual_mul_f32 v27, v124, v27
	.loc	1 671 21                        ; attention.py:671:21
	s_and_b32 s103, s5, s6
	s_and_b32 s5, s7, s8
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 670 30                        ; attention.py:670:30
	...
	.loc	1 671 21                        ; attention.py:671:21
	s_and_b32 s28, vcc_lo, s26
	s_and_b32 s29, s54, s55
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 670 30                        ; attention.py:670:30
	...
	v_dual_mul_f32 v19, v19, v39 :: v_dual_lshlrev_b32 v38, 16, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v17, v17, v38
	.loc	1 664 17                        ; attention.py:664:17
	v_mul_f32_e32 v19, s102, v19
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_f32_e32 v17, s100, v17
	...
	v_mul_f32_e32 v9, v123, v156
	.loc	1 649 37                        ; attention.py:649:37
	v_lshlrev_b32_e32 v10, 16, v164
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v158.h, v126.h
	.loc	1 689 25                        ; attention.py:689:25
	v_cmp_neq_f32_e64 s2, 0xff800000, v163
	.loc	1 694 30                        ; attention.py:694:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v156, v9, v10 :: v_dual_mul_f32 v9, v122, v155
	.loc	1 649 37                        ; attention.py:649:37
	...
	v_dual_mul_f32 v9, v119, v154 :: v_dual_lshlrev_b32 v10, 16, v161
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v154.h, v126.h
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v161, v9, v10
	v_dual_mul_f32 v9, v124, v153 :: v_dual_lshlrev_b32 v10, 16, v160
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v38, s101, v156 :: v_dual_mul_f32 v39, s100, v162
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v153.h, v126.h
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v125, v9, v10
	v_dual_mul_f32 v9, v123, v152 :: v_dual_lshlrev_b32 v10, 16, v159
	.loc	1 686 26                        ; attention.py:686:26
	...
	v_dual_mul_f32 v9, v122, v151 :: v_dual_lshlrev_b32 v10, 16, v157
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v20, s101, v20 :: v_dual_mul_f32 v125, s102, v125
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v151.h, v126.h
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v157, v9, v10
	v_dual_mul_f32 v9, v119, v145 :: v_dual_lshlrev_b32 v10, 16, v148
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v148, v9, v10 :: v_dual_mul_f32 v9, v123, v147
	.loc	1 649 37                        ; attention.py:649:37
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v36, s99, v148 :: v_dual_mul_f32 v149, v9, v10
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v9, v124, v143 :: v_dual_lshlrev_b32 v10, 16, v146
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v143.h, v126.h
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v146, v9, v10 :: v_dual_mul_f32 v9, v123, v141
	.loc	1 649 37                        ; attention.py:649:37
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v142, v9, v10 :: v_dual_mul_f32 v9, v119, v23
	v_mul_f32_e32 v10, v122, v24
	v_mul_f32_e32 v23, v122, v32
	v_mul_f32_e32 v24, v122, v15
	.loc	1 649 37                        ; attention.py:649:37
	v_lshlrev_b32_e32 v32, 16, v137
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v137, v10, v16 :: v_dual_lshlrev_b32 v130, 16, v130
	v_dual_mul_f32 v32, v12, v32 :: v_dual_lshlrev_b32 v15, 16, v129
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mul_f32 v136, v9, v15 :: v_dual_lshlrev_b32 v129, 16, v132
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v32, s102, v32 :: v_dual_lshlrev_b32 v31, 16, v131
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v22, v22, v129
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v129, s99, v161 :: v_dual_lshlrev_b32 v40, 16, v40
	.loc	1 654 30                        ; attention.py:654:30
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 664 17                        ; attention.py:664:17
	v_mul_f32_e32 v22, s101, v22
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v40, v13, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v31, s99, v31 :: v_dual_lshlrev_b32 v128, 16, v128
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v23, v23, v131
	.loc	1 649 37                        ; attention.py:649:37
	v_lshlrev_b32_e32 v33, 16, v33
	.loc	1 664 17                        ; attention.py:664:17
	v_mul_f32_e32 v131, s101, v144
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v128, v14, v128
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v23, s100, v23 :: v_dual_lshlrev_b32 v34, 16, v34
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 654 30                        ; attention.py:654:30
	...
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v33, s101, v149 :: v_dual_mul_f32 v24, v24, v34
	.loc	1 649 37                        ; attention.py:649:37
	v_lshlrev_b32_e32 v37, 16, v37
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v29, v29, v130 :: v_dual_lshlrev_b32 v134, 16, v139
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v18, v18, v35
	v_dual_mul_f32 v21, v21, v37 :: v_dual_lshlrev_b32 v132, 16, v138
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v130, s102, v146 :: v_dual_lshlrev_b32 v133, 16, v133
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v18, s99, v18 :: v_dual_mul_f32 v25, s99, v25
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v26, v26, v132 :: v_dual_lshlrev_b32 v135, 16, v135
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v28, v28, v133 :: v_dual_mul_f32 v27, v27, v134
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v132, s100, v142 :: v_dual_mul_f32 v133, s99, v136
	v_mul_f32_e32 v134, s100, v137
	.loc	1 654 30                        ; attention.py:654:30
	v_mul_f32_e32 v30, v30, v135
	.loc	1 664 17                        ; attention.py:664:17
	v_mul_f32_e32 v128, s102, v128
	v_dual_mul_f32 v24, s100, v24 :: v_dual_mul_f32 v21, s99, v21
	v_dual_mul_f32 v34, s101, v159 :: v_dual_mul_f32 v35, s100, v157
	v_dual_mul_f32 v37, s102, v165 :: v_dual_mul_f32 v40, s101, v40
	v_dual_mul_f32 v30, s102, v30 :: v_dual_mul_f32 v29, s99, v29
	v_dual_mul_f32 v26, s101, v26 :: v_dual_mul_f32 v27, s102, v27
	.loc	1 686 26                        ; attention.py:686:26
...
.Ltmp1:
	...
	v_max3_f32 v142, v130, v31, v134
	v_max_f32_e32 v144, v25, v24
	v_max3_f32 v146, v128, v18, v17
.Ltmp2:
	.loc	1 686 26                        ; attention.py:686:26
...
.Ltmp3:
	...
	v_max3_f32 v148, v20, v19, v21
	v_dual_max_f32 v149, v29, v28 :: v_dual_max_f32 v156, v27, v30
	v_max3_f32 v138, v139, v142, v138
	v_max3_f32 v139, v144, v40, v146
...
.Ltmp7:
	...
	v_max3_f32 v125, v163, v125, v136
	...
	v_cndmask_b32_e64 v131, 0, v142, s29
	...
	v_mov_b16_e64 v145.l, v36.h
	.loc	1 699 23                        ; attention.py:699:23
	v_mul_f32_e32 v5, v5, v138
	v_mul_f32_e32 v2, v2, v138
	.loc	1 690 33                        ; attention.py:690:33
	v_cndmask_b32_e64 v146, 0, v132, s19
	.loc	1 690 62 is_stmt 0              ; attention.py:690:62
	...
	v_cndmask_b32_e64 v148, 0, v130, s16
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp17:
	...
	.loc	1 690 62                        ; attention.py:690:62
	v_dual_sub_f32 v17, v17, v125 :: v_dual_add_f32 v164, v30, v139
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 690 33                        ; attention.py:690:33
	v_cndmask_b32_e64 v156, 0, v128, s27
...
.Ltmp19:
	...
	.loc	1 690 62 is_stmt 0              ; attention.py:690:62
	v_dual_sub_f32 v18, v18, v125 :: v_dual_add_f32 v21, v144, v156
	.loc	1 700 30 is_stmt 1              ; attention.py:700:30
	v_mov_b16_e64 v158.l, v19.h
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp20:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_add_f32_e32 v162, v26, v27
	v_add_f32_e32 v28, v148, v137
.Ltmp21:
	.loc	1 690 49                        ; attention.py:690:49
	v_exp_f32_e32 v18, v18
.Ltmp22:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v26, v37, v129 :: v_dual_and_b32 v27, 1, v166
.Ltmp23:
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp24:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v163, v28, v29 :: v_dual_and_b32 v28, 1, v167
.Ltmp25:
	.loc	1 700 30                        ; attention.py:700:30
	v_mov_b16_e64 v154.l, v31.h
.Ltmp26:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
...
.Ltmp30:
	...
	v_dual_add_f32 v23, v35, v128 :: v_dual_add_f32 v22, v33, v130
.Ltmp31:
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp36:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_add_f32_e32 v160, v20, v21
	v_dual_add_f32 v20, v36, v132 :: v_dual_add_f32 v21, v34, v131
.Ltmp37:
	.loc	1 700 30                        ; attention.py:700:30
	v_and_b32_e32 v29, 1, v152
	v_and_b32_e32 v26, 1, v155
	s_delay_alu instid0(VALU_DEP_3)
.Ltmp38:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v165, v142, v20 :: v_dual_and_b32 v30, 1, v151
.Ltmp39:
	.loc	1 700 30                        ; attention.py:700:30
	v_and_b32_e32 v142, 1, v158
.Ltmp40:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_add_f32_e32 v158, v21, v22
.Ltmp41:
	.loc	1 700 30                        ; attention.py:700:30
	v_add3_u32 v21, v25, v27, 0x7fff
	v_add3_u32 v22, v144, v28, 0x7fff
	v_and_b32_e32 v25, 1, v127
	v_and_b32_e32 v28, 1, v153
	v_and_b32_e32 v153, 1, v147
	v_and_b32_e32 v20, 1, v126
	v_and_b32_e32 v151, 1, v145
	v_add3_u32 v152, v146, v25, 0x7fff
	v_add3_u32 v146, v149, v29, 0x7fff
	v_add3_u32 v149, v34, v153, 0x7fff
	v_and_b32_e32 v34, 1, v143
	v_mov_b16_e64 v126.l, v156.h
	v_add3_u32 v127, v148, v26, 0x7fff
	v_add3_u32 v147, v38, v30, 0x7fff
	v_add3_u32 v148, v36, v151, 0x7fff
	v_and_b32_e32 v36, 1, v141
	v_and_b32_e32 v38, 1, v140
...
.Ltmp42:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v35, v162, v163 :: v_dual_add_f32 v36, v164, v165
	v_dual_add_f32 v151, v158, v166 :: v_dual_add_f32 v34, v160, v161
.Ltmp43:
	.loc	1 700 30                        ; attention.py:700:30
	v_add3_u32 v143, v37, v38, 0x7fff
	v_and_b32_e32 v38, 1, v126
	v_mov_b16_e64 v126.l, v159.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp44:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v34, v34, v35 :: v_dual_and_b32 v27, 1, v154
	v_add_f32_e32 v35, v36, v151
.Ltmp45:
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp48:
	...
	v_permlanex16_b32 v127, v151, s98, 0xfedcba98 op_sel:[1,0]
.Ltmp49:
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp51:
	...
	v_permlanex16_b32 v156, v37, s98, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v36, v154, s98, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v38, v155, s98, 0xfedcba98 op_sel:[1,0]
	...
	v_add3_u32 v151, v39, v151, 0x7fff
	...
	v_cndmask_b16 v152.l, 0x7fff, v141.h, s16
	v_perm_b32 v39, v40, v139, v120
	v_perm_b32 v40, v40, v139, v121
	v_cndmask_b16 v141.h, 0x7fff, v151.h, s18
	v_and_b32_e32 v151, 1, v126
	v_mov_b16_e64 v126.l, v135.h
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v154, v85 offset:6144
	ds_load_u16_d16 v155, v85 offset:6400
	ds_load_u16_d16 v156, v85 offset:6656
	ds_load_u16_d16 v157, v85 offset:6912
	ds_load_u16_d16 v158, v85 offset:7168
	ds_load_u16_d16 v159, v85 offset:7424
	ds_load_u16_d16 v160, v85 offset:7680
	ds_load_u16_d16 v161, v85 offset:7936
	...
	ds_load_u16_d16_hi v154, v85 offset:6272
	ds_load_u16_d16_hi v155, v85 offset:6528
	ds_load_u16_d16_hi v156, v85 offset:6784
	ds_load_u16_d16_hi v157, v85 offset:7040
	ds_load_u16_d16_hi v158, v85 offset:7296
	ds_load_u16_d16_hi v159, v85 offset:7552
	ds_load_u16_d16_hi v160, v85 offset:7808
	ds_load_u16_d16_hi v161, v85 offset:8064
	.loc	1 700 30                        ; attention.py:700:30
	...
	v_cndmask_b16 v152.h, 0x7fff, v19.h, s27
	...
	v_permlanex16_b32 v14, v152, s98, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v16, v153, s98, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v9, v18, v148, v120
	v_perm_b32 v10, v18, v148, v121
	v_perm_b32 v11, v12, v149, v120
	v_perm_b32 v12, v12, v149, v121
	v_perm_b32 v13, v14, v152, v120
	v_perm_b32 v14, v14, v152, v121
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn64_w8_s1_ds4.num_vgpr, 188
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq1_lk2048_bm16_bn64_w8_s1_ds4.numbered_sgpr, 104
