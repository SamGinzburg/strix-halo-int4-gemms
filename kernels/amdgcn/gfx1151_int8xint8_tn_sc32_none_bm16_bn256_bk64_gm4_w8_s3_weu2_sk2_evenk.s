	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
.Lfunc_begin0:
...
.Ltmp25:
	...
	v_add3_u32 v32, v3, v6, s14
	v_lshrrev_b32_e32 v6, 6, v0
	v_lshlrev_b32_e32 v8, 2, v0
	v_dual_mov_b32 v30, 0 :: v_dual_and_b32 v13, 32, v5
	v_lshl_add_u32 v31, v1, 4, v2
	v_lshrrev_b32_e32 v2, 1, v0
	v_or_b32_e32 v7, s14, v1
	v_add_nc_u32_e32 v34, 0, v1
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v37, 0, v10
	s_delay_alu instid0(VALU_DEP_4)
	v_and_or_b32 v2, 0x70, v2, v1
	v_and_b32_e32 v1, 2, v6
	v_lshlrev_b32_e32 v3, 4, v0
	v_and_b32_e32 v14, 28, v4
	v_add3_u32 v17, v37, v10, v13
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v35, 0, v2
	v_and_b32_e32 v2, 0x1c0, v8
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v1, 0, v1
	s_lshl_b32 s29, s25, 4
	v_mul_lo_u32 v36, v7, s28
	v_add_nc_u32_e32 v33, s29, v31
	s_delay_alu instid0(VALU_DEP_3)
	v_add3_u32 v16, v1, v2, v13
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v39, 0, v4
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v40, 0, v3
	v_mov_b32_e32 v8, s7
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_add_u32 v38, s24, 5, v32
	...
	v_mov_b32_e32 v1, s0
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v41, v16, v14
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v42, v17, v14
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v60, v44, s[16:19], 0 offen
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_clause 0x3
	buffer_load_b128 v[43:46], v45, s[20:23], 0 offen
	buffer_load_b128 v[47:50], v47, s[20:23], 0 offen
	buffer_load_b128 v[51:54], v51, s[20:23], 0 offen
...
.LBB0_7:                                ; %._crit_edge
	...
	ds_store_2addr_stride64_b32 v1, v15, v30 offset1:2
	ds_store_2addr_stride64_b32 v5, v29, v28 offset1:2
	...
	v_add_lshl_u32 v4, v0, s25, 2
	v_lshl_add_u32 v20, s25, 3, v19
	v_add_nc_u32_e32 v3, v3, v19
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v5, v4, s[12:15], 0 offen
	...
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v13, v5, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	...
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v18, v5, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_vgpr, 185
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_evenk.kd
