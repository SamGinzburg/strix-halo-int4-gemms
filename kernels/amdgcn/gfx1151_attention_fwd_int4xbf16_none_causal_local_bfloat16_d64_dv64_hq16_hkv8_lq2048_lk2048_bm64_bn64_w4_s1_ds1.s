...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 629 13                        ; attention.py:629:13
	v_mad_u64_u32 v[109:110], null, s69, v38, v[33:34]
	...
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v35, s7, v37
	v_mov_b32_e32 v24, v25
	v_xor_b32_e32 v39, 8, v148
	v_xor_b32_e32 v40, 8, v149
	v_xor_b32_e32 v41, 16, v149
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v152, 0, v40
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v154, 0, v42
	v_dual_mov_b32 v17, v25 :: v_dual_and_b32 v110, 0x5040504, v33
	v_dual_mov_b32 v19, v25 :: v_dual_and_b32 v112, 0x7060706, v34
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v151, 0, v39
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v153, 0, v41
	...
	v_dual_mov_b32 v10, v25 :: v_dual_mov_b32 v175, v171
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mov_b32 v33, s72 :: v_dual_add_nc_u32 v42, 0, v149
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s30, v150, v43
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v43, s71, v130
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s31, v44, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s33, v150, v44
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s20, v150, v43
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v43, s71, v126
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s21, v44, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s22, v150, v44
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s28, v150, v43
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v43, s71, v122
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s34, v44, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s35, v150, v44
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s41, v150, v43
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v43, s71, v118
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s42, v44, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s43, v150, v44
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s49, v150, v43
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v43, s71, v113
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s50, v44, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s51, v150, v44
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s12, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v132
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s13, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s14, v150, v42
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s16, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v128
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s17, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s18, v150, v42
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s24, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v124
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s25, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s26, v150, v42
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s37, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v120
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s38, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s40, v150, v42
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s45, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v116
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s46, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s47, v150, v42
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s53, v150, v41
	.loc	1 630 31 is_stmt 1              ; attention.py:630:31
	v_or_b32_e32 v41, s71, v144
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s54, v42, v147
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s55, v150, v42
	...
	.loc	1 670 21 is_stmt 0              ; attention.py:670:21
	v_cmp_ge_i32_e64 s61, v150, v41
	.loc	1 671 21 is_stmt 1              ; attention.py:671:21
	s_and_b32 s7, s14, s13
	s_and_b32 s3, s33, s31
	...
	s_and_b32 s33, s51, s50
	s_and_b32 s30, s55, s54
	...
	s_and_b32 s31, s53, s52
	s_and_b32 s28, s43, s42
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 223
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 105
