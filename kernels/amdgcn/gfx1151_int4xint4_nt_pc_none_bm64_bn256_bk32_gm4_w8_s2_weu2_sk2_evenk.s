...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_clause 0x1
	buffer_load_b64 v[99:100], v72, s[20:23], 0 offen offset:32
	buffer_load_b64 v[101:102], v73, s[20:23], 0 offen offset:32
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
...
; %bb.2:                                ; %.peel.next
	...
	v_add3_u32 v76, v76, v65, 64
	s_add_i32 s2, s3, -2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v65, v79, v65, 64
	v_add3_u32 v77, v80, v78, 64
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk2_evenk.num_vgpr, 158
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk2_evenk.numbered_sgpr, 32
