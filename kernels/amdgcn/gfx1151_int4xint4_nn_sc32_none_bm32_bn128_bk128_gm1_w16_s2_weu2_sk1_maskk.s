	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	v_mad_u64_u32 v[5:6], null, v8, s33, v[5:6]
.Ltmp20:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:181:22 ]
...
.LBB0_3:                                ; %Flow95
	...
	v_dual_mov_b32 v17, 0 :: v_dual_and_b32 v22, 0x108, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_sub_nc_u32_e32 v26, s33, v3
	s_lshl_b32 s22, s31, 7
	v_add3_u32 v10, s6, v25, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_clause 0x7
	buffer_load_u16 v52, v36, s[28:31], 0 offen offset:4
	buffer_load_u16 v53, v36, s[28:31], 0 offen
	buffer_load_u16 v54, v36, s[28:31], 0 offen offset:12
	buffer_load_u16 v55, v36, s[28:31], 0 offen offset:8
	buffer_load_u16 v56, v36, s[28:31], 0 offen offset:20
	buffer_load_u16 v57, v36, s[28:31], 0 offen offset:16
	buffer_load_u16 v58, v36, s[28:31], 0 offen offset:28
	buffer_load_u16 v59, v36, s[28:31], 0 offen offset:24
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	...
	v_dual_fmac_f32 v11, v34, v43 :: v_dual_add_nc_u32 v28, s35, v28
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	...
	v_fmac_f32_e32 v18, v36, v45
	v_dual_fmac_f32 v16, v38, v47 :: v_dual_fmac_f32 v15, v39, v46
	v_dual_fmac_f32 v19, v35, v42 :: v_dual_fmac_f32 v14, v40, v49
...
.LBB0_6:                                ; %._crit_edge
	...
	buffer_load_u16 v23, v1, s[24:27], 0 offen
	v_mov_b32_e32 v1, 0
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.7:
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	v_add3_u32 v1, 0, v9, v20
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_lshl_or_b32 v2, v9, 4, v22
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	ds_load_u8 v3, v1 offset:640
	ds_load_u8 v4, v1 offset:896
	ds_load_u8 v5, v1 offset:768
	ds_load_u8 v6, v1 offset:512
	ds_load_u8 v7, v1 offset:128
	ds_load_u8 v8, v1 offset:384
	ds_load_u8 v25, v1 offset:256
	ds_load_u8 v26, v1
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v9, 0, v2
	ds_load_u8 v22, v1 offset:1664
	ds_load_u8 v32, v1 offset:1920
	ds_load_u8 v33, v1 offset:1792
	ds_load_u8 v34, v1 offset:1536
	ds_load_u8 v35, v1 offset:1152
	ds_load_u8 v36, v1 offset:1408
	ds_load_u8 v37, v1 offset:1280
	ds_load_u8 v38, v1 offset:1024
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_xad_u32 v27, v2, 8, 0
	ds_load_b64 v[1:2], v9 offset:2048
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[3:4], v27 offset:2048
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v9, v38, v35, 0xc0c0004
	v_lshl_or_b32 v5, v8, 16, v7
	v_perm_b32 v7, v34, v22, 0xc0c0004
	v_perm_b32 v8, v33, v32, 0xc0c0004
	v_perm_b32 v22, v37, v36, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[24:31], v[5:6], v[1:2], v[24:31] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v2, v8, 16, v7
	v_lshl_or_b32 v1, v22, 16, v9
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[24:31], v[1:2], v[3:4], v[24:31] neg_lo:[1,1,0]
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
...
.LBB0_8:
	...
	v_dual_mul_f32 v6, v6, v28 :: v_dual_add_nc_u32 v21, 4, v9
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v8, v8, v28 :: v_dual_add_nc_u32 v25, 16, v9
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_clause 0x1
	buffer_load_u16 v20, v20, s[8:11], 0 offen
	buffer_load_u16 v21, v21, s[8:11], 0 offen
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v1, v1, v28 :: v_dual_add_nc_u32 v26, 20, v9
	v_dual_mul_f32 v2, v2, v28 :: v_dual_add_nc_u32 v27, 24, v9
	v_dual_mul_f32 v4, v4, v28 :: v_dual_add_nc_u32 v9, 28, v9
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	v_fma_f32 v3, v3, v25, v15
	v_fma_f32 v2, v2, v24, v16
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 65
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
