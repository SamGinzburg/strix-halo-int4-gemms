	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3,@function
amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3:                                 ; @amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v7, 0 :: v_dual_and_b32 v118, 15, v0
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v119, 0xf0, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v215, 0 :: v_dual_and_b32 v26, 0xe0, v0
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mov_b32 v204, 0 :: v_dual_add_nc_u32 v3, 32, v1
	v_dual_mov_b32 v211, 0 :: v_dual_add_nc_u32 v4, 48, v1
	...
	.loc	1 1205 25 is_stmt 1             ; ragged.py:1205:25
	v_mul_lo_u32 v121, v1, s44
	v_mul_lo_u32 v122, v2, s44
	v_bfe_i32 v1, v0, 7, 1
	...
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v16, s34, v25
	...
	.loc	1 1205 25 is_stmt 1             ; ragged.py:1205:25
	v_mul_lo_u32 v123, v3, s44
	v_mul_lo_u32 v124, v4, s44
	v_dual_mov_b32 v202, 0 :: v_dual_and_b32 v3, 0x7f, v0
	v_dual_mov_b32 v200, 0 :: v_dual_and_b32 v1, 0x88, v1
	v_dual_mov_b32 v191, 0 :: v_dual_and_b32 v4, 24, v2
	v_dual_mov_b32 v198, 0 :: v_dual_lshlrev_b32 v13, 5, v0
	v_mad_u64_u32 v[104:105], null, s33, 19, v[90:91]
	v_mad_u64_u32 v[105:106], null, s33, 20, v[90:91]
	v_add3_u32 v146, 0, v118, v10
	v_dual_mov_b32 v185, 0 :: v_dual_add_nc_u32 v10, 8, v16
	v_dual_mov_b32 v183, 0 :: v_dual_add_nc_u32 v18, 16, v16
	...
	v_xor_b32_e32 v125, v1, v3
	v_lshl_or_b32 v126, v118, 5, v4
	v_dual_mov_b32 v196, 0 :: v_dual_lshlrev_b32 v17, 2, v119
	...
	v_mul_lo_u32 v152, v16, s23
	v_mul_lo_u32 v153, v10, s23
	v_mul_lo_u32 v154, v18, s23
	v_dual_mov_b32 v179, 0 :: v_dual_add_nc_u32 v10, 24, v16
	v_dual_mov_b32 v177, 0 :: v_dual_add_nc_u32 v18, 32, v16
	v_dual_mov_b32 v186, 0 :: v_dual_add_nc_u32 v19, 40, v16
	v_dual_mov_b32 v173, 0 :: v_dual_add_nc_u32 v20, 48, v16
	v_dual_mov_b32 v171, 0 :: v_dual_add_nc_u32 v16, 56, v16
	...
	v_xor_b32_e32 v1, 0x110, v125
	v_xor_b32_e32 v3, 8, v126
	v_xor_b32_e32 v4, 16, v126
	v_xor_b32_e32 v5, 24, v126
	...
	v_dual_mov_b32 v187, 0 :: v_dual_and_b32 v2, 28, v2
	v_add3_u32 v13, 0, v17, v13
	v_dual_mov_b32 v188, 0 :: v_dual_lshlrev_b32 v17, 1, v119
	...
	v_mul_lo_u32 v165, v10, s23
	v_mul_lo_u32 v166, v18, s23
	v_mul_lo_u32 v167, v19, s23
	v_mul_lo_u32 v168, v20, s23
	v_mul_lo_u32 v169, v16, s23
	v_mad_u64_u32 v[116:117], null, s33, 31, v[90:91]
	v_lshl_add_u32 v175, s33, 3, v90
	v_lshl_add_u32 v181, s33, 4, v90
	v_dual_mov_b32 v163, 0 :: v_dual_add_nc_u32 v192, 0, v1
	v_dual_mov_b32 v184, 0 :: v_dual_add_nc_u32 v193, 0, v3
	v_dual_mov_b32 v161, 0 :: v_dual_add_nc_u32 v194, 0, v4
	v_dual_mov_b32 v182, 0 :: v_dual_add_nc_u32 v195, 0, v5
	v_dual_mov_b32 v180, 0 :: v_dual_add_nc_u32 v197, 0, v0
	v_dual_mov_b32 v178, 0 :: v_dual_add_nc_u32 v199, 0, v6
	v_dual_mov_b32 v176, 0 :: v_dual_add_nc_u32 v201, 0, v7
	v_dual_mov_b32 v174, 0 :: v_dual_add_nc_u32 v203, 0, v8
	v_dual_mov_b32 v172, 0 :: v_dual_add_nc_u32 v205, 0, v9
	v_dual_mov_b32 v159, 0 :: v_dual_add_nc_u32 v206, 0, v11
	v_dual_mov_b32 v170, 0 :: v_dual_add_nc_u32 v207, 0, v12
	v_dual_mov_b32 v157, 0 :: v_dual_add_nc_u32 v208, 0, v14
	v_dual_mov_b32 v155, 0 :: v_dual_add_nc_u32 v210, 0, v15
	v_dual_mov_b32 v151, 0 :: v_dual_add_nc_u32 v212, v13, v2
	v_dual_mov_b32 v149, 0 :: v_dual_add_nc_u32 v214, 0, v17
...
.LBB0_5:                                ; =>This Loop Header: Depth=1
	...
	v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, v120
	v_mov_b32_e32 v3, v120
	v_dual_mov_b32 v4, v120 :: v_dual_mov_b32 v9, 0
	v_mov_b32_e32 v5, v120
	v_dual_mov_b32 v6, v120 :: v_dual_mov_b32 v17, 0
	v_mov_b32_e32 v7, v120
	v_dual_mov_b32 v8, v120 :: v_dual_mov_b32 v25, 0
	v_dual_mov_b32 v10, v120 :: v_dual_mov_b32 v33, 0
	v_mov_b32_e32 v11, v120
	v_dual_mov_b32 v12, v120 :: v_dual_mov_b32 v41, 0
	v_mov_b32_e32 v13, v120
	v_dual_mov_b32 v14, v120 :: v_dual_mov_b32 v49, 0
	v_mov_b32_e32 v15, v120
	v_dual_mov_b32 v16, v120 :: v_dual_mov_b32 v57, 0
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_add_nc_u32_e32 v66, v152, v65
	v_add_nc_u32_e32 v68, v154, v65
	v_add_nc_u32_e32 v70, v166, v65
	v_add_nc_u32_e32 v72, v168, v65
	.loc	1 1156 34                       ; ragged.py:1156:34
	buffer_load_u8 v225, v73, s[16:19], 0 offen
	v_lshl_add_u32 v73, s33, 1, v90
	.loc	1 1155 42                       ; ragged.py:1155:42
	v_add_nc_u32_e32 v67, v153, v65
	v_add_nc_u32_e32 v69, v165, v65
	v_add_nc_u32_e32 v71, v167, v65
	v_add_nc_u32_e32 v65, v169, v65
	v_add_nc_u32_e32 v73, s25, v73
	...
	s_waitcnt vmcnt(28)
	ds_store_b8 v192, v67
	ds_store_b8 v192, v69 offset:512
	ds_store_b8 v192, v71 offset:1024
	ds_store_b8 v192, v65 offset:1536
	v_add_nc_u32_e32 v65, 0, v126
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[216:219], v65 offset1:1
	ds_load_2addr_stride64_b64 v[220:223], v65 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[85:88], v193 offset1:1
	ds_load_2addr_stride64_b64 v[81:84], v193 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[77:80], v194 offset1:1
	ds_load_2addr_stride64_b64 v[73:76], v194 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[69:72], v195 offset1:1
	ds_load_2addr_stride64_b64 v[65:68], v195 offset0:2 offset1:3
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v197, v224
	ds_store_b8 v197, v225 offset:256
	ds_store_b8 v197, v226 offset:512
	s_waitcnt vmcnt(27)
	ds_store_b8 v197, v228 offset:1024
	s_waitcnt vmcnt(26)
	ds_store_b8 v197, v229 offset:1280
	s_waitcnt vmcnt(25)
	ds_store_b8 v197, v230 offset:1536
	s_waitcnt vmcnt(23)
	ds_store_b8 v197, v232 offset:2048
	s_waitcnt vmcnt(22)
	ds_store_b8 v197, v233 offset:2304
	s_waitcnt vmcnt(21)
	ds_store_b8 v197, v234 offset:2560
	s_waitcnt vmcnt(19)
	ds_store_b8 v197, v236 offset:3072
	s_waitcnt vmcnt(18)
	ds_store_b8 v197, v237 offset:3328
	s_waitcnt vmcnt(17)
	ds_store_b8 v197, v238 offset:3584
	s_waitcnt vmcnt(15)
	ds_store_b8 v197, v240 offset:4096
	s_waitcnt vmcnt(14)
	ds_store_b8 v197, v241 offset:4352
	s_waitcnt vmcnt(13)
	ds_store_b8 v197, v242 offset:4608
	s_waitcnt vmcnt(11)
	ds_store_b8 v197, v244 offset:5120
	s_waitcnt vmcnt(10)
	ds_store_b8 v197, v245 offset:5376
	s_waitcnt vmcnt(9)
	ds_store_b8 v197, v246 offset:5632
	s_waitcnt vmcnt(7)
	ds_store_b8 v197, v248 offset:6144
	s_waitcnt vmcnt(6)
	ds_store_b8 v197, v249 offset:6400
	s_waitcnt vmcnt(5)
	ds_store_b8 v197, v250 offset:6656
	s_waitcnt vmcnt(3)
	ds_store_b8 v197, v252 offset:7168
	s_waitcnt vmcnt(2)
	ds_store_b8 v197, v253 offset:7424
	s_waitcnt vmcnt(1)
	ds_store_b8 v197, v254 offset:7680
	ds_store_b8 v199, v227
	ds_store_b8 v201, v231
	ds_store_b8 v203, v235
	ds_store_b8 v205, v239
	ds_store_b8 v206, v243
	ds_store_b8 v207, v247
	ds_store_b8 v208, v251
	s_waitcnt vmcnt(0)
	ds_store_b8 v210, v255
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	ds_load_u8 v224, v146 offset:1280
	ds_load_u8 v225, v146 offset:1024
	ds_load_u8 v226, v146 offset:1920
	ds_load_u8 v227, v146 offset:1664
	ds_load_u8 v228, v146 offset:1408
	ds_load_u8 v229, v146 offset:1152
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v224, v225, v224, 0xc0c0004
	ds_load_u8 v225, v146 offset:1792
	ds_load_u8 v230, v146 offset:1536
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v230, v146 offset:256
	ds_load_u8 v231, v146
	ds_load_u8 v232, v146 offset:896
	ds_load_u8 v233, v146 offset:640
	ds_load_u8 v234, v146 offset:384
	ds_load_u8 v235, v146 offset:128
	v_lshl_or_b32 v225, v225, 16, v224
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v230, v231, v230, 0xc0c0004
	ds_load_u8 v231, v146 offset:768
	ds_load_u8 v236, v146 offset:512
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v216, v146 offset:3328
	ds_load_u8 v217, v146 offset:3072
	ds_load_u8 v218, v146 offset:3968
	ds_load_u8 v219, v146 offset:3712
	ds_load_u8 v220, v146 offset:3456
	ds_load_u8 v221, v146 offset:3200
	v_wmma_i32_16x16x16_iu4 v[57:64], v[226:227], v[222:223], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v216, v217, v216, 0xc0c0004
	ds_load_u8 v217, v146 offset:3840
	ds_load_u8 v222, v146 offset:3584
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v222, v146 offset:2304
	ds_load_u8 v223, v146 offset:2048
	ds_load_u8 v224, v146 offset:2944
	ds_load_u8 v225, v146 offset:2688
	ds_load_u8 v226, v146 offset:2432
	ds_load_u8 v227, v146 offset:2176
	v_lshl_or_b32 v217, v217, 16, v216
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v222, v223, v222, 0xc0c0004
	ds_load_u8 v223, v146 offset:2816
	ds_load_u8 v228, v146 offset:2560
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v81, v146 offset:5376
	ds_load_u8 v82, v146 offset:5120
	ds_load_u8 v83, v146 offset:6016
	ds_load_u8 v84, v146 offset:5760
	ds_load_u8 v85, v146 offset:5504
	ds_load_u8 v86, v146 offset:5248
	v_wmma_i32_16x16x16_iu4 v[25:32], v[218:219], v[87:88], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	ds_load_u8 v82, v146 offset:5888
	ds_load_u8 v87, v146 offset:5632
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v87, v146 offset:4352
	ds_load_u8 v88, v146 offset:4096
	ds_load_u8 v216, v146 offset:4992
	ds_load_u8 v217, v146 offset:4736
	ds_load_u8 v218, v146 offset:4480
	ds_load_u8 v219, v146 offset:4224
	v_lshl_or_b32 v82, v82, 16, v81
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v87, v88, v87, 0xc0c0004
	ds_load_u8 v88, v146 offset:4864
	ds_load_u8 v220, v146 offset:4608
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v73, v146 offset:7424
	ds_load_u8 v74, v146 offset:7168
	ds_load_u8 v75, v146 offset:8064
	ds_load_u8 v76, v146 offset:7808
	ds_load_u8 v77, v146 offset:7552
	ds_load_u8 v78, v146 offset:7296
	v_wmma_i32_16x16x16_iu4 v[25:32], v[83:84], v[79:80], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v146 offset:7936
	ds_load_u8 v79, v146 offset:7680
	s_waitcnt lgkmcnt(4)
	...
	ds_load_u8 v79, v146 offset:6400
	ds_load_u8 v80, v146 offset:6144
	ds_load_u8 v81, v146 offset:7040
	ds_load_u8 v82, v146 offset:6784
	ds_load_u8 v83, v146 offset:6528
	ds_load_u8 v84, v146 offset:6272
	v_lshl_or_b32 v74, v74, 16, v73
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v79, v80, v79, 0xc0c0004
	ds_load_u8 v80, v146 offset:6912
	ds_load_u8 v85, v146 offset:6656
	s_waitcnt lgkmcnt(2)
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v65, s46, v121, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_add_i32 s18, s46, s11
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v66, s46, v122, 1
	v_add_lshl_u32 v67, s46, v123, 1
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_mul_i32 s18, s18, s33
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v68, s46, v124, 1
	...
	v_dual_mul_f32 v65, v85, v65 :: v_dual_mul_f32 v34, v34, v67
	v_dual_mul_f32 v29, v29, v66 :: v_dual_mul_f32 v36, v36, v67
	v_dual_mul_f32 v31, v31, v66 :: v_dual_mul_f32 v38, v38, v67
	...
	v_dual_mul_f32 v40, v40, v67 :: v_dual_mul_f32 v49, v49, v68
	v_dual_mul_f32 v41, v41, v67 :: v_dual_mul_f32 v58, v58, v68
	v_dual_mul_f32 v42, v42, v67 :: v_dual_mul_f32 v51, v51, v68
	v_dual_mul_f32 v43, v43, v67 :: v_dual_mul_f32 v60, v60, v68
	v_dual_mul_f32 v44, v44, v67 :: v_dual_mul_f32 v53, v53, v68
	v_dual_mul_f32 v45, v45, v67 :: v_dual_mul_f32 v62, v62, v68
	v_dual_mul_f32 v46, v46, v67 :: v_dual_mul_f32 v55, v55, v68
	v_dual_mul_f32 v47, v47, v67 :: v_dual_mul_f32 v64, v64, v68
	v_dual_mul_f32 v48, v48, v67 :: v_dual_mul_f32 v57, v57, v68
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v59, v59, v68 :: v_dual_fmac_f32 v204, v73, v5
	v_dual_mul_f32 v61, v61, v68 :: v_dual_fmac_f32 v202, v74, v6
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v63, v63, v68 :: v_dual_fmac_f32 v196, v77, v9
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v215, v69, v1 :: v_dual_fmac_f32 v200, v75, v7
	v_dual_fmac_f32 v213, v70, v2 :: v_dual_fmac_f32 v198, v76, v8
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v211, v71, v3 :: v_dual_fmac_f32 v188, v81, v13
	v_dual_fmac_f32 v209, v72, v4 :: v_dual_fmac_f32 v190, v79, v11
	v_dual_fmac_f32 v191, v78, v10 :: v_dual_fmac_f32 v186, v83, v15
	v_dual_fmac_f32 v189, v80, v12 :: v_dual_fmac_f32 v184, v17, v1
	v_dual_fmac_f32 v187, v82, v14 :: v_dual_fmac_f32 v182, v19, v3
	v_dual_fmac_f32 v185, v65, v16 :: v_dual_fmac_f32 v178, v22, v6
	v_dual_fmac_f32 v183, v18, v2 :: v_dual_fmac_f32 v180, v20, v4
	v_dual_fmac_f32 v179, v21, v5 :: v_dual_fmac_f32 v176, v24, v8
	v_dual_fmac_f32 v177, v23, v7 :: v_dual_fmac_f32 v174, v25, v9
	v_dual_fmac_f32 v173, v26, v10 :: v_dual_fmac_f32 v172, v27, v11
	v_dual_fmac_f32 v171, v28, v12 :: v_dual_fmac_f32 v170, v29, v13
	v_dual_fmac_f32 v164, v30, v14 :: v_dual_fmac_f32 v163, v31, v15
	v_dual_fmac_f32 v162, v32, v16 :: v_dual_fmac_f32 v161, v33, v1
	v_dual_fmac_f32 v160, v34, v2 :: v_dual_fmac_f32 v159, v35, v3
	v_dual_fmac_f32 v158, v36, v4 :: v_dual_fmac_f32 v157, v37, v5
	v_dual_fmac_f32 v156, v38, v6 :: v_dual_fmac_f32 v155, v39, v7
	v_dual_fmac_f32 v151, v40, v8 :: v_dual_fmac_f32 v150, v41, v9
	v_dual_fmac_f32 v149, v42, v10 :: v_dual_fmac_f32 v148, v43, v11
	v_dual_fmac_f32 v147, v44, v12 :: v_dual_fmac_f32 v144, v45, v13
	v_dual_fmac_f32 v142, v46, v14 :: v_dual_fmac_f32 v141, v47, v15
	v_dual_fmac_f32 v140, v48, v16 :: v_dual_fmac_f32 v139, v49, v1
	v_dual_fmac_f32 v138, v50, v2 :: v_dual_fmac_f32 v137, v51, v3
	v_dual_fmac_f32 v136, v52, v4 :: v_dual_fmac_f32 v135, v53, v5
	v_dual_fmac_f32 v134, v54, v6 :: v_dual_fmac_f32 v133, v55, v7
	v_dual_fmac_f32 v132, v56, v8 :: v_dual_fmac_f32 v131, v57, v9
	v_dual_fmac_f32 v130, v58, v10 :: v_dual_fmac_f32 v129, v59, v11
	v_dual_fmac_f32 v128, v60, v12 :: v_dual_fmac_f32 v127, v61, v13
	v_fmac_f32_e32 v145, v62, v14
	v_fmac_f32_e32 v143, v63, v15
	v_fmac_f32_e32 v117, v64, v16
	.loc	1 1135 19                       ; ragged.py:1135:19
	s_cbranch_scc1 .LBB0_5
; %bb.8:                                ; %._crit_edge.loopexit
	.loc	1 1234 19                       ; ragged.py:1234:19
	v_dual_max_f32 v35, v159, v159 :: v_dual_max_f32 v36, v158, v158
	v_dual_max_f32 v37, v157, v157 :: v_dual_max_f32 v38, v156, v156
	v_dual_max_f32 v39, v155, v155 :: v_dual_max_f32 v40, v150, v150
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_max_f32 v36, 0, v36 :: v_dual_max_f32 v37, 0, v37
	v_dual_max_f32 v41, v149, v149 :: v_dual_max_f32 v42, v148, v148
	v_max_f32_e32 v46, 0, v39
	v_max_f32_e32 v39, v151, v151
	v_dual_max_f32 v43, v147, v147 :: v_dual_max_f32 v78, 0, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v79, 0, v41 :: v_dual_max_f32 v80, 0, v42
	v_max_f32_e32 v72, 0, v39
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_max_f32_e32 v81, 0, v43
	v_dual_max_f32 v39, v144, v144 :: v_dual_max_f32 v40, v142, v142
	v_dual_max_f32 v41, v141, v141 :: v_dual_max_f32 v42, v140, v140
	...
	v_dual_max_f32 v86, 0, v43 :: v_dual_max_f32 v39, v138, v138
	v_dual_max_f32 v40, v137, v137 :: v_dual_max_f32 v41, v136, v136
	v_dual_max_f32 v42, v135, v135 :: v_dual_max_f32 v43, v134, v134
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v87, 0, v39 :: v_dual_max_f32 v88, 0, v40
	v_dual_max_f32 v89, 0, v41 :: v_dual_max_f32 v40, v132, v132
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v90, 0, v42 :: v_dual_max_f32 v91, 0, v43
	v_dual_max_f32 v42, v130, v130 :: v_dual_max_f32 v1, v215, v215
	v_dual_max_f32 v2, v213, v213 :: v_dual_max_f32 v5, v204, v204
	v_dual_max_f32 v6, v202, v202 :: v_dual_max_f32 v7, v200, v200
	v_dual_max_f32 v8, v198, v198 :: v_dual_max_f32 v9, v196, v196
	v_dual_max_f32 v15, v186, v186 :: v_dual_max_f32 v16, v185, v185
	v_dual_max_f32 v17, v184, v184 :: v_dual_max_f32 v18, v183, v183
	v_max_f32_e32 v19, v182, v182
	v_dual_max_f32 v27, v172, v172 :: v_dual_max_f32 v28, v171, v171
	v_max_f32_e32 v29, v170, v170
	v_max_f32_e32 v43, v129, v129
	v_max_f32_e32 v39, v133, v133
	v_max_f32_e32 v93, 0, v40
	v_dual_max_f32 v95, 0, v42 :: v_dual_max_f32 v40, v127, v127
	v_max_f32_e32 v41, v131, v131
	v_dual_max_f32 v3, v211, v211 :: v_dual_max_f32 v4, v209, v209
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v2, 0, v2
	v_dual_max_f32 v6, 0, v6 :: v_dual_max_f32 v7, 0, v7
	v_max_f32_e32 v12, v189, v189
	v_dual_max_f32 v9, 0, v9 :: v_dual_max_f32 v10, v191, v191
	v_dual_max_f32 v11, v190, v190 :: v_dual_max_f32 v14, v187, v187
	v_max_f32_e32 v13, v188, v188
	v_dual_max_f32 v16, 0, v16 :: v_dual_max_f32 v17, 0, v17
	v_dual_max_f32 v20, v180, v180 :: v_dual_max_f32 v19, 0, v19
	v_dual_max_f32 v22, v178, v178 :: v_dual_max_f32 v21, v179, v179
	v_dual_max_f32 v24, v176, v176 :: v_dual_max_f32 v23, v177, v177
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v20, 0, v20 :: v_dual_max_f32 v25, v174, v174
	v_dual_max_f32 v26, v173, v173 :: v_dual_max_f32 v27, 0, v27
	v_max_f32_e32 v30, v164, v164
	v_dual_max_f32 v28, 0, v28 :: v_dual_max_f32 v29, 0, v29
	v_dual_max_f32 v32, v162, v162 :: v_dual_max_f32 v31, v163, v163
	v_dual_max_f32 v34, v160, v160 :: v_dual_max_f32 v33, v161, v161
	s_delay_alu instid0(VALU_DEP_4)
	v_max_f32_e32 v30, 0, v30
	v_max_f32_e32 v96, 0, v43
	v_dual_max_f32 v92, 0, v39 :: v_dual_max_f32 v39, v128, v128
	v_dual_max_f32 v42, v143, v143 :: v_dual_max_f32 v43, v117, v117
	.loc	1 1235 13                       ; ragged.py:1235:13
	v_mul_f32_e32 v50, v2, v2
	.loc	1 1234 19                       ; ragged.py:1234:19
	v_max_f32_e32 v98, 0, v40
	v_max_f32_e32 v94, 0, v41
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_max_f32 v41, v145, v145 :: v_dual_max_f32 v100, 0, v42
	...
	v_dual_max_f32 v38, 0, v38 :: v_dual_max_f32 v97, 0, v39
	.loc	1 1235 13                       ; ragged.py:1235:13
	v_dual_mul_f32 v54, v4, v4 :: v_dual_max_f32 v99, 0, v41
	v_dual_mul_f32 v58, v6, v6 :: v_dual_max_f32 v101, 0, v43
	...
	v_dual_mul_f32 v27, v86, v86 :: v_dual_mul_f32 v10, v99, v99
...
.Ltmp40:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 256
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc256_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.kd
