	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow91
	...
	v_dual_mov_b32 v15, 0 :: v_dual_and_b32 v10, 0xf0, v0
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v9, 7, v0
...
.Ltmp23:
	...
	v_and_or_b32 v8, 0x90, v13, v8
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v7, 0x90, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_or3_b32 v21, v4, v1, s14
	v_add_nc_u32_e32 v4, s15, v6
	v_xor_b32_e32 v15, 16, v8
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v36, 0, v8
	...
	v_or_b32_e32 v16, s15, v3
	v_lshl_add_u32 v31, v3, 1, v4
	v_or_b32_e32 v28, 10, v21
	v_mul_lo_u32 v1, s25, v1
	v_or_b32_e32 v29, 12, v21
	v_mul_lo_u32 v23, v16, s26
	v_or_b32_e32 v30, 14, v21
	v_add3_u32 v2, v2, s1, v5
	v_mov_b32_e32 v16, 0
.Ltmp24:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_ashr_i32 s24, s18, 9
...
.Ltmp25:
	...
	s_lshl_b32 s1, s2, 7
	s_mov_b32 s2, s0
	v_subrev_nc_u32_e32 v33, s1, v2
	v_mov_b32_e32 v19, 0
	v_subrev_nc_u32_e32 v32, s1, v1
	s_mov_b32 s1, s0
	v_and_b32_e32 v14, 0x17e, v11
	...
	v_dual_mov_b32 v4, s3 :: v_dual_add_nc_u32 v35, 0, v14
	v_dual_mov_b32 v3, s2 :: v_dual_mov_b32 v2, s1
	v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v14, 0
	s_and_b32 s11, s11, 0xffff
	s_lshl_b32 s28, s25, 9
	s_mov_b32 s22, s18
	s_mov_b32 s23, s19
	s_mov_b32 s4, s8
	s_mov_b32 s5, s9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[38:41], v33, s[20:23], 0 offen
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	buffer_load_u16 v46, v42, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_u16 v47, v42, s[16:19], 0 offen offset:32
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	buffer_load_b128 v[42:45], v32, s[20:23], 0 offen
	...
	v_add_lshl_u32 v64, v29, s1, 1
	v_add_lshl_u32 v65, v30, s1, 1
	...
	v_dual_mul_f32 v47, v47, v63 :: v_dual_lshlrev_b32 v54, 16, v78
	v_dual_mul_f32 v43, v43, v54 :: v_dual_lshlrev_b32 v56, 16, v80
	v_mul_f32_e32 v39, v39, v54
	v_dual_mul_f32 v38, v38, v54 :: v_dual_add_nc_u32 v33, s28, v33
	v_dual_mul_f32 v41, v41, v54 :: v_dual_add_nc_u32 v32, s28, v32
	v_dual_mul_f32 v40, v40, v54 :: v_dual_lshlrev_b32 v57, 16, v81
	v_dual_mul_f32 v42, v42, v54 :: v_dual_lshlrev_b32 v59, 16, v83
	v_dual_mul_f32 v45, v45, v54 :: v_dual_lshlrev_b32 v60, 16, v84
	v_dual_mul_f32 v44, v44, v54 :: v_dual_lshlrev_b32 v61, 16, v85
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v20, v39, v56
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v49, v49, v63 :: v_dual_lshlrev_b32 v58, 16, v82
	v_dual_mul_f32 v51, v51, v63 :: v_dual_lshlrev_b32 v62, 16, v86
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v53, v53, v63 :: v_dual_lshlrev_b32 v64, 16, v88
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v46, v46, v63 :: v_dual_lshlrev_b32 v65, 16, v89
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(5)
	v_dual_fmac_f32 v13, v38, v55 :: v_dual_lshlrev_b32 v66, 16, v90
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v18, v41, v58 :: v_dual_lshlrev_b32 v67, 16, v91
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v19, v40, v57 :: v_dual_lshlrev_b32 v68, 16, v92
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v48, v48, v63 :: v_dual_lshlrev_b32 v69, 16, v93
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v17, v42, v59 :: v_dual_lshlrev_b32 v70, 16, v94
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v16, v43, v60 :: v_dual_lshlrev_b32 v71, 16, v95
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v50, v50, v63 :: v_dual_fmac_f32 v15, v44, v61
	v_dual_mul_f32 v52, v52, v63 :: v_dual_fmac_f32 v13, v46, v64
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v14, v45, v62 :: v_dual_fmac_f32 v17, v50, v68
	v_dual_fmac_f32 v20, v47, v65 :: v_dual_fmac_f32 v19, v48, v66
	v_dual_fmac_f32 v18, v49, v67 :: v_dual_fmac_f32 v15, v52, v70
	v_fmac_f32_e32 v16, v51, v69
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v14, v53, v71
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v2, v11 :: v_dual_mov_b32 v1, v12
.LBB0_7:                                ; %._crit_edge
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 136
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
