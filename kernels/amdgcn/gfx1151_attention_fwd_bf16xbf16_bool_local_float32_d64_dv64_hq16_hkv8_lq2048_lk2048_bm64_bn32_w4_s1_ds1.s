...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v26, 0x70, v23, 0
	v_xad_u32 v27, 0x60, v23, 0
	v_xad_u32 v28, 0x50, v23, 0
	.loc	1 756 22                        ; attention.py:756:22
	s_sub_i32 s3, s3, s11
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v29, v23, 64, 0
	v_xad_u32 v30, v23, 48, 0
	.loc	1 758 19                        ; attention.py:758:19
	s_bfe_u32 s0, s3, 0x10007
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v31, v23, 32, 0
	ds_load_b128 v[37:40], v26
	ds_load_b128 v[33:36], v27
	ds_load_b128 v[45:48], v28
	ds_load_b128 v[41:44], v29
	ds_load_b128 v[53:56], v30
	ds_load_b128 v[49:52], v31
	v_xad_u32 v26, v23, 16, 0
	...
	v_mad_u64_u32 v[106:107], null, s57, v4, v[1:2]
	...
	v_dual_mov_b32 v226, 0xff800000 :: v_dual_add_nc_u32 v175, 0, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v124, 0xff800000 :: v_dual_add_nc_u32 v171, 0, v1
	...
	v_dual_mov_b32 v224, 0xff800000 :: v_dual_add_nc_u32 v173, 0, v1
	...
	v_dual_mov_b32 v228, 0xff800000 :: v_dual_add_nc_u32 v179, 0, v2
	...
	v_dual_mov_b32 v121, v97 :: v_dual_add_nc_u32 v182, 0, v2
	...
	v_dual_mov_b32 v232, 0xff800000 :: v_dual_add_nc_u32 v181, 0, v3
	v_dual_mov_b32 v234, 0xff800000 :: v_dual_add_nc_u32 v183, 0, v4
	v_xor_b32_e32 v3, 48, v143
	v_dual_mov_b32 v255, 0xff800000 :: v_dual_add_nc_u32 v184, 0, v1
	v_xor_b32_e32 v1, 56, v143
	v_xor_b32_e32 v4, 64, v143
	v_dual_mov_b32 v236, 0xff800000 :: v_dual_add_nc_u32 v185, 0, v2
	v_xor_b32_e32 v2, 0x48, v143
	v_dual_mov_b32 v225, 0xff800000 :: v_dual_add_nc_u32 v186, 0, v3
	v_dual_mov_b32 v238, 0xff800000 :: v_dual_add_nc_u32 v187, 0, v1
	v_dual_mov_b32 v227, 0xff800000 :: v_dual_add_nc_u32 v188, 0, v4
	v_xor_b32_e32 v1, 0x50, v143
	v_xor_b32_e32 v3, 0x58, v143
	v_dual_mov_b32 v254, 0xff800000 :: v_dual_add_nc_u32 v189, 0, v2
	...
	v_dual_mov_b32 v229, 0xff800000 :: v_dual_add_nc_u32 v190, 0, v1
	v_dual_mov_b32 v252, 0xff800000 :: v_dual_add_nc_u32 v191, 0, v3
	v_dual_mov_b32 v250, 0xff800000 :: v_dual_add_nc_u32 v193, 0, v2
	v_dual_mov_b32 v231, 0xff800000 :: v_dual_add_nc_u32 v194, 0, v4
	...
	v_dual_mov_b32 v230, 0xff800000 :: v_dual_add_nc_u32 v177, 0, v5
	v_xor_b32_e32 v5, 12, v6
	v_dual_mov_b32 v248, 0xff800000 :: v_dual_add_nc_u32 v195, 0, v1
	v_dual_mov_b32 v235, 0xff800000 :: v_dual_add_nc_u32 v196, 0, v2
	v_dual_mov_b32 v246, 0xff800000 :: v_dual_add_nc_u32 v197, 0, v3
	v_dual_mov_b32 v233, 0xff800000 :: v_dual_add_nc_u32 v198, 0, v4
	v_xor_b32_e32 v1, 16, v6
	v_xor_b32_e32 v2, 20, v6
	v_xor_b32_e32 v3, 24, v6
	v_xor_b32_e32 v4, 28, v6
	v_dual_mov_b32 v244, 0xff800000 :: v_dual_add_nc_u32 v199, 0, v5
	v_xor_b32_e32 v5, 32, v6
	v_dual_mov_b32 v237, 0xff800000 :: v_dual_add_nc_u32 v200, 0, v1
	v_dual_mov_b32 v242, 0xff800000 :: v_dual_add_nc_u32 v201, 0, v2
	v_dual_mov_b32 v253, 0xff800000 :: v_dual_add_nc_u32 v202, 0, v3
	v_dual_mov_b32 v240, 0xff800000 :: v_dual_add_nc_u32 v203, 0, v4
	...
	v_dual_mov_b32 v251, 0xff800000 :: v_dual_add_nc_u32 v204, 0, v5
	v_xor_b32_e32 v5, 52, v6
	v_add_nc_u32_e32 v205, 0, v1
	v_dual_mov_b32 v249, 0xff800000 :: v_dual_add_nc_u32 v206, 0, v2
	v_add_nc_u32_e32 v207, 0, v3
	v_dual_mov_b32 v247, 0xff800000 :: v_dual_add_nc_u32 v208, 0, v4
	v_xor_b32_e32 v1, 56, v6
	v_xor_b32_e32 v2, 60, v6
	v_xor_b32_e32 v3, 0x810, v152
	v_xor_b32_e32 v4, 0x1020, v152
	...
	v_xor_b32_e32 v5, 0x1830, v152
	v_dual_mov_b32 v245, 0xff800000 :: v_dual_add_nc_u32 v210, 0, v1
	v_add_nc_u32_e32 v211, 0, v2
	v_dual_mov_b32 v243, 0xff800000 :: v_dual_add_nc_u32 v212, 0, v3
	...
	v_dual_mov_b32 v241, 0xff800000 :: v_dual_add_nc_u32 v214, 0, v5
	v_xor_b32_e32 v5, 32, v160
	v_add_nc_u32_e32 v215, 0, v1
	v_dual_mov_b32 v239, 0xff800000 :: v_dual_add_nc_u32 v216, 0, v2
	...
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v149, s9, v7
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v150, s9, v8
	v_add_nc_u32_e32 v151, s9, v9
	v_add_nc_u32_e32 v153, s9, v10
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v155, s9, v12
	v_add_nc_u32_e32 v156, s9, v13
	v_add_nc_u32_e32 v157, s9, v14
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v158, s9, v15
	v_add_nc_u32_e32 v161, s9, v16
	v_dual_mov_b32 v9, v25 :: v_dual_add_nc_u32 v162, s9, v17
	v_add_nc_u32_e32 v163, s9, v18
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v164, s8, v19
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v165, s9, v19
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v166, s8, v20
	v_dual_mov_b32 v8, v25 :: v_dual_add_nc_u32 v167, s9, v20
	v_dual_mov_b32 v120, v6 :: v_dual_add_nc_u32 v219, 0, v5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 256
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 66
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.private_seg_size, 168
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.uses_flat_scratch, 1
