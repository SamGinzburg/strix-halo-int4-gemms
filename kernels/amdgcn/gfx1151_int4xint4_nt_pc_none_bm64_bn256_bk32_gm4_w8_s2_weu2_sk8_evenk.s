...
.Ltmp0:
	...
	v_dual_mov_b32 v9, 0 :: v_dual_and_b32 v66, 3, v0
...
.Ltmp11:
	...
	v_mad_u64_u32 v[1:2], null, s30, v77, v[65:66]
	...
	v_dual_mov_b32 v14, v9 :: v_dual_lshlrev_b32 v75, 3, v0
	v_dual_mov_b32 v18, v9 :: v_dual_and_b32 v3, 0x88, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v17, v9 :: v_dual_and_b32 v4, 0x778, v75
	...
	v_dual_mov_b32 v26, v9 :: v_dual_add_nc_u32 v71, 0, v2
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_clause 0x1
	buffer_load_b64 v[99:100], v72, s[20:23], 0 offen offset:128
	buffer_load_b64 v[101:102], v73, s[20:23], 0 offen offset:128
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
...
.Ltmp13:
	...
	s_cbranch_scc1 .LBB0_4
; %bb.2:                                ; %.peel.next
	v_lshl_or_b32 v77, s31, 8, v77
	s_lshl_b32 s10, s29, 8
	v_add_nc_u32_e32 v81, s24, v76
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_subrev_nc_u32_e32 v77, s10, v77
	v_or_b32_e32 v79, 0x80, v77
	v_mad_u64_u32 v[76:77], null, s30, v77, s[2:3]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_mad_u64_u32 v[79:80], null, s30, v79, s[2:3]
	v_mad_u64_u32 v[80:81], null, s30, v81, s[2:3]
	v_add3_u32 v76, v76, v65, 0x100
	s_add_i32 s2, s3, -2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v65, v79, v65, 0x100
	v_add3_u32 v77, v80, v78, 0x100
...
; %bb.5:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_or_b32 v68, 0x88, v68, v73
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	v_lshl_or_b32 v81, v71, 3, v68
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_add_nc_u32_e32 v73, 0, v68
	...
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	ds_load_2addr_b64 v[89:92], v68 offset1:32
	ds_load_2addr_b64 v[93:96], v68 offset0:64 offset1:96
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	s_waitcnt lgkmcnt(3)
...
.LBB0_6:                                ; %._crit_edge._crit_edge
	...
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v126, v1, v21
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v41, v6, v17 :: v_dual_add_nc_u32 v114, 0, v11
	ds_load_b128 v[9:12], v13 offset:512
	ds_load_b128 v[13:16], v13 offset:528
	v_mul_f32_e32 v45, v8, v17
	v_dual_mul_f32 v116, v7, v18 :: v_dual_lshlrev_b32 v25, 16, v77
	...
	v_dual_mul_f32 v77, v6, v18 :: v_dual_mul_f32 v142, v1, v25
	v_mul_f32_e32 v74, v3, v18
	v_mul_f32_e32 v144, v3, v25
	v_dual_mul_f32 v42, v7, v17 :: v_dual_mul_f32 v73, v2, v18
	v_mul_f32_e32 v76, v5, v18
	v_dual_mul_f32 v146, v5, v25 :: v_dual_mul_f32 v75, v4, v18
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v46, v9, v17
	v_dual_mul_f32 v49, v10, v17 :: v_dual_mul_f32 v118, v9, v18
	v_dual_mul_f32 v53, v12, v17 :: v_dual_mul_f32 v120, v11, v18
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v54, v13, v17
	v_dual_mul_f32 v55, v14, v17 :: v_dual_mul_f32 v122, v13, v18
	v_mul_f32_e32 v58, v16, v17
	v_dual_mul_f32 v117, v8, v18 :: v_dual_mul_f32 v128, v3, v21
	v_dual_mul_f32 v50, v11, v17 :: v_dual_mul_f32 v119, v10, v18
	v_dual_mul_f32 v130, v5, v21 :: v_dual_mul_f32 v121, v12, v18
	v_dual_mul_f32 v132, v7, v21 :: v_dual_mul_f32 v125, v16, v18
	v_mul_f32_e32 v136, v11, v21
	v_dual_mul_f32 v124, v15, v18 :: v_dual_mul_f32 v127, v2, v21
	v_dual_mul_f32 v148, v7, v25 :: v_dual_mul_f32 v123, v14, v18
	v_mul_f32_e32 v134, v9, v21
	v_mul_f32_e32 v150, v9, v25
	v_dual_mul_f32 v57, v15, v17 :: v_dual_mul_f32 v72, v58, v24
	v_mul_f32_e32 v129, v4, v21
	v_mul_f32_e32 v131, v6, v21
	v_mul_f32_e32 v133, v8, v21
	v_dual_mul_f32 v135, v10, v21 :: v_dual_mul_f32 v18, v76, v90
	v_mul_f32_e32 v137, v12, v21
	v_dual_mul_f32 v138, v13, v21 :: v_dual_mul_f32 v9, v34, v80
	v_mul_f32_e32 v139, v14, v21
	v_dual_mul_f32 v140, v15, v21 :: v_dual_mul_f32 v1, v29, v78
	v_mul_f32_e32 v141, v16, v21
	v_mul_f32_e32 v143, v2, v25
	v_dual_mul_f32 v145, v4, v25 :: v_dual_mul_f32 v34, v118, v91
	v_mul_f32_e32 v147, v6, v25
	v_mul_f32_e32 v149, v8, v25
	v_mul_f32_e32 v151, v10, v25
	v_mul_f32_e32 v152, v11, v25
	v_mul_f32_e32 v154, v13, v25
	v_dual_mul_f32 v155, v14, v25 :: v_dual_mul_f32 v58, v124, v39
	v_dual_mul_f32 v156, v15, v25 :: v_dual_mul_f32 v5, v33, v79
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_mul_f32_e32 v13, v37, v81
	v_mul_f32_e32 v17, v38, v82
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_dual_mul_f32 v157, v16, v25 :: v_dual_mul_f32 v4, v142, v104
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_mul_f32_e32 v29, v45, v85
	v_mul_f32_e32 v37, v49, v87
	v_mul_f32_e32 v45, v53, v20
	v_dual_mul_f32 v49, v54, v88 :: v_dual_mul_f32 v2, v59, v89
	v_mul_f32_e32 v53, v55, v22
	v_mul_f32_e32 v22, v77, v30
	v_dual_mul_f32 v30, v117, v32 :: v_dual_mul_f32 v153, v12, v25
	v_dual_mul_f32 v3, v126, v95 :: v_dual_mul_f32 v16, v145, v60
	v_mul_f32_e32 v33, v46, v86
	v_mul_f32_e32 v10, v74, v27
	v_mul_f32_e32 v11, v128, v43
	v_dual_mul_f32 v12, v144, v106 :: v_dual_mul_f32 v21, v41, v83
	v_mul_f32_e32 v25, v42, v84
	v_dual_mul_f32 v41, v50, v19 :: v_dual_mul_f32 v6, v73, v26
	v_mul_f32_e32 v46, v121, v36
	v_dual_mul_f32 v73, v125, v40 :: v_dual_mul_f32 v20, v146, v61
	v_dual_mul_f32 v19, v130, v97 :: v_dual_mul_f32 v32, v149, v107
	v_mul_f32_e32 v14, v75, v28
	...
	v_mul_f32_e32 v35, v134, v99
	v_mul_f32_e32 v36, v150, v108
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_dual_mul_f32 v38, v119, v92 :: v_dual_mul_f32 v57, v57, v23
	v_mul_f32_e32 v8, v143, v105
	v_mul_f32_e32 v50, v122, v93
	v_dual_mul_f32 v54, v123, v94 :: v_dual_mul_f32 v15, v129, v44
	v_dual_mul_f32 v40, v151, v109 :: v_dual_mul_f32 v31, v133, v48
	v_dual_mul_f32 v44, v152, v110 :: v_dual_mul_f32 v39, v135, v100
	v_mul_f32_e32 v60, v156, v67
	v_mul_f32_e32 v43, v136, v51
	v_mul_f32_e32 v47, v137, v52
	v_mul_f32_e32 v51, v138, v101
	v_mul_f32_e32 v55, v139, v102
	v_dual_mul_f32 v59, v140, v103 :: v_dual_mul_f32 v74, v141, v56
	v_dual_mul_f32 v23, v131, v98 :: v_dual_mul_f32 v48, v153, v111
	v_mul_f32_e32 v24, v147, v62
	v_mul_f32_e32 v52, v154, v112
	v_mul_f32_e32 v56, v155, v113
	v_mul_f32_e32 v75, v157, v69
	ds_store_b128 v114, v[1:4]
	ds_store_b128 v114, v[9:12] offset:256
	ds_store_b128 v114, v[17:20] offset:512
	ds_store_b128 v114, v[25:28] offset:768
	ds_store_b128 v114, v[33:36] offset:4096
	ds_store_b128 v114, v[41:44] offset:4352
	ds_store_b128 v114, v[49:52] offset:4608
	ds_store_b128 v114, v[57:60] offset:4864
	ds_store_b128 v115, v[5:8]
	ds_store_b128 v115, v[13:16] offset:256
	ds_store_b128 v115, v[21:24] offset:512
	ds_store_b128 v115, v[29:32] offset:768
	ds_store_b128 v115, v[37:40] offset:4096
	ds_store_b128 v115, v[45:48] offset:4352
	ds_store_b128 v115, v[53:56] offset:4608
	ds_store_b128 v115, v[72:75] offset:4864
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 158
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn256_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 32
