...
.Ltmp13:
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v1, v11, s[12:15], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v16, v2, s[12:15], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[11:14], v11, s[16:19], 0 offen
	buffer_load_b128 v[20:23], v15, s[16:19], 0 offen
	v_add_nc_u32_e32 v15, 0, v36
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_lshrrev_b32_e32 v2, 1, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmpk_gt_i32 s22, 0x5ff
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(4)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s1, s20
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[9:10], null, s0, s6, v[17:18]
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
...
; %bb.11:
	...
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v10, v16, v17, 0xc0c0004
	s_waitcnt lgkmcnt(18)
	...
	v_lshl_or_b32 v31, v9, 16, v8
	v_mov_b32_e32 v5, v3
	v_lshl_or_b32 v30, v16, 16, v10
	ds_load_u8 v16, v15 offset:464
	ds_load_u8 v17, v15 offset:480
	...
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v12, v17, v35, 0xc0c0004
	...
	ds_load_u8 v17, v15 offset:720
	ds_load_u8 v44, v15 offset:736
	ds_load_u8 v48, v15 offset:704
	...
	v_perm_b32 v31, v36, v32, 0xc0c0004
	v_perm_b32 v32, v35, v33, 0xc0c0004
	s_waitcnt lgkmcnt(23)
	...
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v37, v53, v41, 0xc0c0004
	v_lshl_or_b32 v33, v32, 16, v31
	v_lshl_or_b32 v32, v36, 16, v35
	s_waitcnt lgkmcnt(16)
	...
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v37, v44, v58, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	...
	v_lshl_or_b32 v31, v37, 16, v34
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v30, v40, 16, v39
	ds_load_u8 v16, v15 offset:976
	ds_load_u8 v17, v15 offset:992
	...
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v17, v41, v37, 0xc0c0004
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v17, v50, v47, 0xc0c0004
	...
	v_lshl_or_b32 v33, v16, 16, v15
	v_lshl_or_b32 v32, v30, 16, v17
	v_lshl_or_b32 v31, v34, 16, v31
	v_lshl_or_b32 v30, v35, 16, v2
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[3:10], v[30:33], v[11:14], v[3:10] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v3, v3
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v21, v3 :: v_dual_lshlrev_b32 v2, 1, v2
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s12, s8
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v10, v20, v10 :: v_dual_lshlrev_b32 v31, 1, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v4, v27, v4 :: v_dual_lshlrev_b32 v1, 1, v1
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v5, v26, v5 :: v_dual_and_b32 v28, 0x7f, v0
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v25, 0x1040, v32
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v16, 16, v16
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v27, 0x204, v29
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v14, v2, v14 :: v_dual_lshlrev_b32 v17, 16, v17
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v11, 16, v11
	v_lshlrev_b32_e32 v12, 16, v12
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v16, v2, v16 :: v_dual_lshlrev_b32 v13, 16, v13
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_b32_e32 v26, 28, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v11, v2, v11
	v_dual_mul_f32 v12, v2, v12 :: v_dual_and_b32 v21, 0x1e0, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v13, v2, v13
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_and_or_b32 v18, 0x1c0, v18, v26
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v1, 16, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v21, v19, 2, v21
	...
	v_dual_mul_f32 v2, v2, v17 :: v_dual_add_nc_u32 v27, 0, v0
	...
	v_add_lshl_u32 v9, v20, s1, 2
	v_add_lshl_u32 v11, v20, s8, 2
	v_add_lshl_u32 v10, v20, s3, 2
	v_add_lshl_u32 v12, v20, s9, 2
	v_add_lshl_u32 v13, v20, s10, 2
	v_add_lshl_u32 v14, v20, s11, 2
	s_waitcnt lgkmcnt(7)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 168
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 31
