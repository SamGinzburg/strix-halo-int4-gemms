...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_add_i32 s6, s6, s11
	v_dual_mov_b32 v87, 0 :: v_dual_mov_b32 v126, 0
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v115, 0 :: v_dual_add_nc_u32 v0, s46, v25
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_lshl_add_u32 v1, s0, 7, v33
	s_lshl_b32 s7, s6, 8
	s_lshl_b32 s6, s6, 7
	s_delay_alu instid0(VALU_DEP_2)
	v_mul_lo_u32 v130, s44, v0
	v_subrev_nc_u32_e32 v127, s7, v30
	v_subrev_nc_u32_e32 v128, s7, v31
	v_subrev_nc_u32_e32 v129, s7, v32
	v_subrev_nc_u32_e32 v131, s6, v1
	...
	v_dual_mov_b32 v90, 0 :: v_dual_mov_b32 v113, 0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_mul_f32 v4, v4, v3 :: v_dual_fmac_f32 v115, v7, v6
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v120, v7, v6 :: v_dual_mul_f32 v7, v136, v3
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
...
.LBB0_5:                                ; %._crit_edge
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b32 v0, v115, v126 offset1:32
	ds_store_2addr_b32 v0, v121, v104 offset0:64 offset1:96
	ds_store_2addr_b32 v45, v125, v124 offset1:32
	ds_store_2addr_b32 v45, v116, v103 offset0:64 offset1:96
	ds_store_2addr_b32 v46, v123, v122 offset1:32
	ds_store_2addr_b32 v46, v108, v102 offset0:64 offset1:96
	ds_store_2addr_b32 v47, v120, v119 offset1:32
	ds_store_2addr_b32 v47, v105, v100 offset0:64 offset1:96
	ds_store_2addr_b32 v48, v118, v117 offset1:32
	ds_store_2addr_b32 v48, v101, v98 offset0:64 offset1:96
	ds_store_2addr_b32 v49, v114, v113 offset1:32
	ds_store_2addr_b32 v49, v99, v96 offset0:64 offset1:96
	ds_store_2addr_b32 v50, v112, v111 offset1:32
	ds_store_2addr_b32 v50, v97, v94 offset0:64 offset1:96
	ds_store_2addr_b32 v51, v110, v109 offset1:32
	ds_store_2addr_b32 v51, v95, v91 offset0:64 offset1:96
	ds_store_2addr_b32 v52, v107, v106 offset1:32
	...
	ds_store_2addr_b32 v54, v90, v89 offset1:32
	ds_store_2addr_b32 v54, v75, v72 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v56, v71, v68 offset0:64 offset1:96
	ds_store_2addr_b32 v57, v84, v83 offset1:32
	ds_store_2addr_b32 v57, v69, v65 offset0:64 offset1:96
	ds_store_2addr_b32 v58, v82, v81 offset1:32
	ds_store_2addr_b32 v58, v67, v64 offset0:64 offset1:96
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk4_evenk.numbered_sgpr, 51
