...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v43, v6, v30
	v_dual_mov_b32 v1, s16 :: v_dual_lshlrev_b32 v36, 1, v28
	v_dual_mov_b32 v5, s20 :: v_dual_mov_b32 v10, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x1
	buffer_load_u16 v71, v39, s[4:7], 0 offen
	buffer_load_u16 v72, v38, s[4:7], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	buffer_load_u16 v73, v45, s[36:39], 0 offen offset:4
	buffer_load_u16 v74, v45, s[36:39], 0 offen
	buffer_load_u16 v75, v45, s[36:39], 0 offen offset:12
	buffer_load_u16 v76, v45, s[36:39], 0 offen offset:8
	buffer_load_u16 v77, v45, s[36:39], 0 offen offset:20
	buffer_load_u16 v78, v45, s[36:39], 0 offen offset:16
	buffer_load_u16 v79, v45, s[36:39], 0 offen offset:28
	buffer_load_u16 v80, v45, s[36:39], 0 offen offset:24
	.loc	1 166 26                        ; generate_amdgcn.py:166:26
	...
	v_dual_mul_f32 v49, v49, v60 :: v_dual_lshlrev_b32 v62, 16, v73
	v_dual_mul_f32 v51, v51, v60 :: v_dual_lshlrev_b32 v64, 16, v75
	v_dual_mul_f32 v45, v45, v60 :: v_dual_lshlrev_b32 v68, 16, v79
	v_mul_f32_e32 v46, v46, v60
	v_mul_f32_e32 v50, v50, v60
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v10, v44, v63
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v53, v61, v53 :: v_dual_add_nc_u32 v40, s43, v40
	v_dual_mul_f32 v54, v61, v54 :: v_dual_lshlrev_b32 v65, 16, v76
	v_dual_mul_f32 v55, v61, v55 :: v_dual_lshlrev_b32 v66, 16, v77
	v_dual_mul_f32 v52, v61, v52 :: v_dual_lshlrev_b32 v67, 16, v78
	v_dual_mul_f32 v58, v61, v58 :: v_dual_lshlrev_b32 v69, 16, v80
	v_mul_f32_e32 v56, v61, v56
	v_dual_mul_f32 v59, v61, v59 :: v_dual_fmac_f32 v24, v46, v65
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v25, v45, v62
	v_dual_fmac_f32 v23, v47, v64 :: v_dual_fmac_f32 v22, v48, v67
	v_dual_fmac_f32 v21, v49, v66 :: v_dual_fmac_f32 v20, v50, v69
	v_dual_fmac_f32 v19, v51, v68 :: v_dual_fmac_f32 v18, v52, v63
	v_dual_fmac_f32 v17, v53, v62 :: v_dual_fmac_f32 v16, v54, v65
	v_dual_fmac_f32 v15, v55, v64 :: v_dual_fmac_f32 v14, v56, v67
	v_dual_fmac_f32 v13, v57, v66 :: v_dual_fmac_f32 v12, v58, v69
	v_fmac_f32_e32 v11, v59, v68
...
.LBB0_5:
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v5, v5, v37, v17
	v_fma_f32 v1, v1, v39, v10
	v_fma_f32 v2, v2, v37, v25
	...
	v_dual_cndmask_b32 v13, 0x3276, v48 :: v_dual_and_b32 v18, 1, v49
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 44
