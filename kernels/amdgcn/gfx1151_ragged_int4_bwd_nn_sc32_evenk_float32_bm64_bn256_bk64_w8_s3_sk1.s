...
; %bb.4:                                ; %.preheader.lr.ph
	...
	v_dual_mov_b32 v131, 0 :: v_dual_add_nc_u32 v2, s9, v2
	.loc	1 708 20                        ; ragged.py:708:20
	v_cmp_gt_i32_e64 s6, s10, v5
	v_bfe_i32 v6, v0, 3, 1
	v_dual_mov_b32 v133, 0 :: v_dual_and_b32 v4, 0xf0, v0
	.loc	1 707 18                        ; ragged.py:707:18
	v_or_b32_e32 v134, s23, v0
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[66:67], null, v2, s28, v[1:2]
	v_dual_mov_b32 v128, 0 :: v_dual_lshlrev_b32 v1, 4, v0
	v_bfe_i32 v2, v0, 5, 1
	v_dual_mov_b32 v126, 0 :: v_dual_and_b32 v3, 0x37c, v3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v124, 0 :: v_dual_and_b32 v5, 0x70, v1
	v_dual_mov_b32 v129, 0 :: v_dual_and_b32 v2, 0x88, v2
	v_mov_b32_e32 v127, 0
	v_lshl_or_b32 v65, v92, 4, s23
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_and_or_b32 v5, 0x88, v6, v5
	v_add_nc_u32_e32 v6, s9, v92
	v_dual_mov_b32 v122, 0 :: v_dual_mov_b32 v121, 0
	v_xor_b32_e32 v2, v2, v3
	v_xor_b32_e32 v3, 8, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v7, 16, v6
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v9, 32, v6
	v_dual_mov_b32 v123, 0 :: v_dual_add_nc_u32 v10, 48, v6
	v_mul_lo_u32 v135, v6, s29
	v_lshlrev_b32_e32 v6, 5, v0
	v_mul_lo_u32 v136, v7, s29
	v_dual_mov_b32 v119, 0 :: v_dual_lshlrev_b32 v0, 1, v0
	v_dual_mov_b32 v118, 0 :: v_dual_lshlrev_b32 v7, 2, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v117, 0 :: v_dual_and_b32 v6, 32, v6
	v_dual_mov_b32 v125, 0 :: v_dual_add_nc_u32 v8, 0, v108
	...
	v_mad_u64_u32 v[67:68], null, s22, s28, v[64:65]
	...
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v139, 0, v2
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v140, 0, v5
	v_dual_mov_b32 v114, 0 :: v_dual_add_nc_u32 v141, 0, v3
	v_dual_mov_b32 v109, 0 :: v_dual_add_nc_u32 v142, 0, v1
	v_dual_mov_b32 v112, 0 :: v_dual_add_nc_u32 v143, v8, v92
	v_dual_mov_b32 v107, 0 :: v_dual_add_nc_u32 v144, v6, v0
	v_dual_mov_b32 v110, 0 :: v_dual_add_nc_u32 v145, 0, v4
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add_lshl_u32 v32, v135, s22, 1
	.loc	1 816 25                        ; ragged.py:816:25
	s_add_i32 s14, s22, s10
	.loc	1 808 40                        ; ragged.py:808:40
	v_add_lshl_u32 v33, v136, s22, 1
	v_add_lshl_u32 v34, v137, s22, 1
	.loc	1 816 25                        ; ragged.py:816:25
	s_mul_i32 s14, s14, s11
	.loc	1 808 40                        ; ragged.py:808:40
	v_add_lshl_u32 v35, v138, s22, 1
	.loc	1 815 40                        ; ragged.py:815:40
	v_add_lshl_u32 v36, v134, s14, 1
	.loc	1 808 40                        ; ragged.py:808:40
	...
	v_dual_fmac_f32 v112, v57, v21 :: v_dual_fmac_f32 v97, v28, v19
	v_dual_fmac_f32 v110, v59, v23 :: v_dual_fmac_f32 v103, v148, v25
	v_dual_fmac_f32 v107, v61, v11 :: v_dual_fmac_f32 v106, v62, v12
	v_dual_fmac_f32 v105, v63, v13 :: v_dual_fmac_f32 v104, v149, v24
	v_dual_fmac_f32 v102, v147, v26 :: v_dual_fmac_f32 v101, v33, v27
	v_dual_fmac_f32 v100, v31, v16 :: v_dual_fmac_f32 v99, v30, v17
	v_dual_fmac_f32 v98, v29, v18 :: v_dual_fmac_f32 v95, v150, v21
	v_dual_fmac_f32 v96, v146, v20 :: v_dual_fmac_f32 v93, v152, v23
	v_dual_fmac_f32 v94, v151, v22 :: v_dual_fmac_f32 v87, v157, v24
	v_dual_fmac_f32 v91, v153, v10 :: v_dual_fmac_f32 v90, v154, v11
	v_dual_fmac_f32 v89, v155, v12 :: v_dual_fmac_f32 v88, v156, v13
	v_dual_fmac_f32 v86, v158, v25 :: v_dual_fmac_f32 v85, v159, v26
	v_dual_fmac_f32 v84, v34, v27 :: v_dual_fmac_f32 v83, v15, v16
	v_dual_fmac_f32 v82, v14, v17 :: v_dual_fmac_f32 v81, v36, v18
	v_dual_fmac_f32 v80, v160, v19 :: v_dual_fmac_f32 v79, v161, v20
	v_dual_fmac_f32 v78, v162, v21 :: v_dual_fmac_f32 v77, v9, v22
	v_dual_fmac_f32 v76, v8, v23 :: v_dual_fmac_f32 v75, v7, v10
	v_dual_fmac_f32 v74, v6, v11 :: v_dual_fmac_f32 v73, v5, v12
	v_dual_fmac_f32 v72, v4, v13 :: v_dual_fmac_f32 v71, v3, v24
	v_dual_fmac_f32 v70, v2, v25 :: v_dual_fmac_f32 v69, v1, v26
...
.LBB0_8:                                ; %.lr.ph
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[146:147], v[150:151], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[146:147], v[152:153], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[146:147], v[154:155], v[32:39] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[48:55], v[146:147], v[156:157], v[48:55] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v148, v149, v148, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[148:149], v[158:159], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[148:149], v[160:161], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[148:149], v[162:163], v[32:39] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[48:55], v[148:149], v[164:165], v[48:55] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v166, v167, v166, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[8:15], v[166:167], v[150:151], v[8:15] neg_lo:[1,1,0]
	ds_load_u8 v150, v143 offset:3456
	ds_load_u8 v151, v143 offset:3200
	v_wmma_i32_16x16x16_iu4 v[24:31], v[166:167], v[152:153], v[24:31] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[40:47], v[166:167], v[154:155], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[56:63], v[166:167], v[156:157], v[56:63] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	...
	v_wmma_i32_16x16x16_iu4 v[8:15], v[150:151], v[158:159], v[8:15] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[24:31], v[150:151], v[160:161], v[24:31] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[40:47], v[150:151], v[162:163], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[56:63], v[150:151], v[164:165], v[56:63] neg_lo:[1,1,0]
	.loc	1 775 23                        ; ragged.py:775:23
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 178
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nn_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 36
