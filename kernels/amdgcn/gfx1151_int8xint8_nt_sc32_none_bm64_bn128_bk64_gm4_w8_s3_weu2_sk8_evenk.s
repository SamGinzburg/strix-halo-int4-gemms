	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp13:
	.loc	1 297 13                        ; generate_amdgcn.py:297:13
	s_xor_b32 s16, s2, s13
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_sub_i32 s2, s16, s13
...
.LBB0_3:                                ; %Flow256
	...
	v_dual_mov_b32 v12, 0 :: v_dual_and_b32 v43, 0x80, v0
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v45, 0x60, v0
...
.Ltmp22:
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
	s_lshl_b32 s0, s13, 7
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v6, s20, v9
	v_mov_b32_e32 v9, 0
	...
	v_and_b32_e32 v11, 0x90, v12
	v_or3_b32 v7, v7, v8, s20
...
.Ltmp23:
	...
	s_ashr_i32 s24, s15, 5
	v_xor_b32_e32 v12, 16, v8
	v_mul_lo_u32 v49, v7, s24
	v_mul_lo_u32 v50, v11, s24
.Ltmp24:
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_mad_u64_u32 v[41:42], null, s12, v6, v[1:2]
	v_lshl_add_u32 v42, v44, 4, v5
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v66, 0, v2
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v68, 0, v8
	v_dual_mov_b32 v23, 0 :: v_dual_add_nc_u32 v70, 0, v3
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v71, 0, v4
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v69, 0, v12
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 318 26                        ; generate_amdgcn.py:318:26
	buffer_load_b64 v[80:81], v76, s[12:15], 0 offen
	.loc	1 320 26                        ; generate_amdgcn.py:320:26
	buffer_load_b128 v[72:75], v77, s[4:7], 0 offen
	.loc	1 318 26                        ; generate_amdgcn.py:318:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_b64 v[82:83], v76, s[12:15], 0 offen offset:32
	.loc	1 320 26                        ; generate_amdgcn.py:320:26
	buffer_load_b128 v[76:79], v77, s[4:7], 0 offen offset:32
	.loc	1 332 22                        ; generate_amdgcn.py:332:22
	v_add_lshl_u32 v84, v49, s25, 1
	v_add_lshl_u32 v85, v50, s25, 1
	...
	v_add_lshl_u32 v86, v48, s25, 1
	v_add_lshl_u32 v87, v51, s25, 1
	v_add_lshl_u32 v88, v52, s25, 1
	v_add_lshl_u32 v89, v53, s25, 1
	v_add_lshl_u32 v90, v54, s25, 1
	v_add_lshl_u32 v91, v55, s25, 1
	v_add_lshl_u32 v92, v56, s25, 1
	v_add_lshl_u32 v93, v57, s25, 1
	v_add_lshl_u32 v94, v58, s25, 1
	v_add_lshl_u32 v95, v59, s25, 1
	v_add_lshl_u32 v96, v60, s25, 1
	v_add_lshl_u32 v97, v61, s25, 1
	v_add_lshl_u32 v98, v62, s25, 1
	v_add_lshl_u32 v99, v63, s25, 1
	v_add_lshl_u32 v100, v64, s25, 1
	v_add_lshl_u32 v101, v65, s25, 1
	...
	.loc	1 334 22                        ; generate_amdgcn.py:334:22
	v_add_lshl_u32 v104, v48, s25, 1
	v_add_lshl_u32 v105, v51, s25, 1
	v_add_lshl_u32 v106, v52, s25, 1
	v_add_lshl_u32 v107, v53, s25, 1
	v_add_lshl_u32 v108, v54, s25, 1
	v_add_lshl_u32 v109, v55, s25, 1
	v_add_lshl_u32 v110, v56, s25, 1
	v_add_lshl_u32 v111, v57, s25, 1
	v_add_lshl_u32 v112, v58, s25, 1
	v_add_lshl_u32 v113, v59, s25, 1
	v_add_lshl_u32 v114, v60, s25, 1
	v_add_lshl_u32 v115, v61, s25, 1
	v_add_lshl_u32 v116, v62, s25, 1
	v_add_lshl_u32 v117, v63, s25, 1
	v_add_lshl_u32 v118, v64, s25, 1
	v_add_lshl_u32 v119, v65, s25, 1
	.loc	1 331 34                        ; generate_amdgcn.py:331:34
	s_cmp_lt_i32 s0, s24
	.loc	1 334 22                        ; generate_amdgcn.py:334:22
	...
	.loc	1 332 22                        ; generate_amdgcn.py:332:22
	s_clause 0x1
	buffer_load_u16 v176, v84, s[16:19], 0 offen
	buffer_load_u16 v177, v85, s[16:19], 0 offen
	.loc	1 334 22                        ; generate_amdgcn.py:334:22
	s_clause 0xf
	...
	.loc	1 332 22                        ; generate_amdgcn.py:332:22
	s_clause 0x1
	buffer_load_u16 v194, v102, s[16:19], 0 offen
	buffer_load_u16 v195, v103, s[16:19], 0 offen
	.loc	1 334 22                        ; generate_amdgcn.py:334:22
	s_clause 0xf
	...
	v_dual_mul_f32 v130, v130, v155 :: v_dual_fmac_f32 v9, v72, v138
	v_dual_mul_f32 v131, v131, v155 :: v_dual_fmac_f32 v10, v88, v138
	v_dual_mul_f32 v132, v132, v155 :: v_dual_fmac_f32 v31, v74, v140
	v_dual_mul_f32 v133, v133, v155 :: v_dual_fmac_f32 v32, v90, v140
	v_dual_mul_f32 v134, v134, v155 :: v_dual_fmac_f32 v27, v75, v141
	v_dual_mul_f32 v135, v135, v155 :: v_dual_fmac_f32 v24, v92, v142
	.loc	1 336 17 is_stmt 0              ; generate_amdgcn.py:336:17
	v_dual_fmac_f32 v35, v73, v139 :: v_dual_fmac_f32 v28, v91, v141
	v_dual_fmac_f32 v23, v76, v142 :: v_dual_fmac_f32 v36, v89, v139
	v_dual_fmac_f32 v19, v77, v143 :: v_dual_fmac_f32 v16, v94, v144
	v_dual_fmac_f32 v15, v78, v144 :: v_dual_fmac_f32 v20, v93, v143
	v_dual_fmac_f32 v13, v79, v145 :: v_dual_fmac_f32 v40, v96, v146
	v_dual_fmac_f32 v39, v80, v146 :: v_dual_fmac_f32 v14, v95, v145
	v_dual_fmac_f32 v37, v81, v147 :: v_dual_fmac_f32 v34, v98, v148
	v_dual_fmac_f32 v33, v82, v148 :: v_dual_fmac_f32 v38, v97, v147
	v_dual_fmac_f32 v29, v83, v149 :: v_dual_fmac_f32 v26, v100, v150
	v_dual_fmac_f32 v25, v84, v150 :: v_dual_fmac_f32 v30, v99, v149
	v_dual_fmac_f32 v21, v85, v151 :: v_dual_fmac_f32 v18, v102, v152
	v_dual_fmac_f32 v17, v86, v152 :: v_dual_fmac_f32 v22, v101, v151
	v_dual_fmac_f32 v11, v87, v153 :: v_dual_fmac_f32 v10, v120, v156
	v_dual_fmac_f32 v12, v103, v153 :: v_dual_fmac_f32 v9, v104, v156
	v_dual_fmac_f32 v35, v105, v157 :: v_dual_fmac_f32 v32, v122, v158
	v_dual_fmac_f32 v31, v106, v158 :: v_dual_fmac_f32 v36, v121, v157
	v_dual_fmac_f32 v27, v107, v159 :: v_dual_fmac_f32 v24, v124, v160
	v_dual_fmac_f32 v23, v108, v160 :: v_dual_fmac_f32 v28, v123, v159
	v_dual_fmac_f32 v19, v109, v161 :: v_dual_fmac_f32 v16, v126, v162
	v_dual_fmac_f32 v15, v110, v162 :: v_dual_fmac_f32 v20, v125, v161
	v_dual_fmac_f32 v13, v111, v163 :: v_dual_fmac_f32 v40, v128, v164
	v_dual_fmac_f32 v39, v112, v164 :: v_dual_fmac_f32 v14, v127, v163
	v_dual_fmac_f32 v37, v113, v165 :: v_dual_fmac_f32 v34, v130, v166
	v_dual_fmac_f32 v33, v114, v166 :: v_dual_fmac_f32 v38, v129, v165
	v_dual_fmac_f32 v29, v115, v167 :: v_dual_fmac_f32 v26, v132, v168
	v_dual_fmac_f32 v25, v116, v168 :: v_dual_fmac_f32 v30, v131, v167
	v_dual_fmac_f32 v21, v117, v169 :: v_dual_fmac_f32 v18, v134, v170
	v_dual_fmac_f32 v17, v118, v170 :: v_dual_fmac_f32 v22, v133, v169
	v_fmac_f32_e32 v11, v119, v171
	v_fmac_f32_e32 v12, v135, v171
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
...
.Ltmp27:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 212
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
