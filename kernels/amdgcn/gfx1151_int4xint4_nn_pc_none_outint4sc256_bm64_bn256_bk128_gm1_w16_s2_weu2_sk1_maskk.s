...
.Ltmp11:
	...
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	v_mad_u64_u32 v[3:4], null, s21, v2, v[37:38]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add3_u32 v3, s23, s8, v3
	...
	s_clause 0x1
	buffer_load_b128 v[4:7], v3, s[16:19], 0 offen
	...
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[8:9], null, s26, v3, v[1:2]
	.loc	1 135 18                        ; generate_amdgcn.py:135:18
	...
	v_xor_b32_e32 v10, 0x110, v9
	v_xor_b32_e32 v17, 0x198, v9
	v_xor_b32_e32 v18, 0x220, v9
	v_xor_b32_e32 v19, 0x2a8, v9
	v_xor_b32_e32 v20, 0x330, v9
	v_xor_b32_e32 v9, 0x3b8, v9
	...
	v_perm_b32 v9, v13, v4, 0x7030602
	v_perm_b32 v10, v14, v5, 0x5010400
	v_perm_b32 v13, v14, v5, 0x7030602
	v_perm_b32 v14, v15, v6, 0x5010400
	v_perm_b32 v15, v15, v6, 0x7030602
	v_perm_b32 v17, v16, v7, 0x5010400
	...
	v_lshlrev_b16 v15.l, 8, v20.l
	v_and_b16 v5.h, 0xff, v9.h
	v_and_b16 v9.h, 0xff, v15.h
	v_lshlrev_b16 v15.h, 8, v21.l
	...
	v_or_b16 v4.l, v4.l, v14.l
	v_or_b16 v4.h, v4.h, v14.h
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v12, v[22:23] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_store_b16 v47, v4
...
.Ltmp13:
	...
	v_add_nc_u32_e32 v60, 0, v14
	v_mov_b32_e32 v14, v13
	v_xor_b32_e32 v5, v5, v11
	v_add_nc_u32_e32 v61, 0, v15
	v_dual_mov_b32 v15, v13 :: v_dual_add_nc_u32 v6, 0x41, v2
	...
	v_dual_mov_b32 v31, v13 :: v_dual_add_nc_u32 v66, 0, v19
	v_mov_b32_e32 v19, v13
	v_mul_lo_u32 v2, s21, v2
	v_xor_b32_e32 v22, 32, v5
	v_xor_b32_e32 v23, 40, v5
	v_xor_b32_e32 v24, 48, v5
	v_xor_b32_e32 v25, 56, v5
	v_add3_u32 v6, v6, s3, v37
	v_dual_mov_b32 v27, v13 :: v_dual_add_nc_u32 v62, 0, v16
	v_add3_u32 v2, v2, s3, v37
	v_mov_b32_e32 v16, v13
	s_add_i32 s1, s0, 1
	s_lshl_b32 s0, s25, 8
	v_sub_nc_u32_e32 v44, s26, v1
	v_mad_u64_u32 v[9:10], null, s26, v3, v[1:2]
	v_subrev_nc_u32_e32 v56, s0, v6
	v_subrev_nc_u32_e32 v57, s0, v2
	v_add_nc_u32_e32 v10, 0, v4
	v_add_nc_u32_e32 v58, 0, v7
	v_add_nc_u32_e32 v59, 0, v8
	v_dual_mov_b32 v29, v13 :: v_dual_add_nc_u32 v64, 0, v18
	v_add_nc_u32_e32 v65, 0, v5
	v_dual_mov_b32 v26, v13 :: v_dual_add_nc_u32 v67, 0, v20
	v_dual_mov_b32 v33, v13 :: v_dual_add_nc_u32 v68, 0, v21
	v_dual_mov_b32 v28, v13 :: v_dual_add_nc_u32 v69, 0, v22
	v_dual_mov_b32 v35, v13 :: v_dual_add_nc_u32 v70, 0, v23
	v_dual_mov_b32 v30, v13 :: v_dual_add_nc_u32 v71, 0, v24
	v_dual_mov_b32 v1, v13 :: v_dual_add_nc_u32 v72, 0, v25
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_add_nc_u32_e32 v73, s24, v9
	.loc	1 136 23                        ; generate_amdgcn.py:136:23
	v_cmp_lt_i32_e64 s0, s24, v44
	.loc	1 137 23                        ; generate_amdgcn.py:137:23
	v_cmp_lt_i32_e32 vcc_lo, s24, v55
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_add_i32 s1, s1, -1
	s_add_i32 s24, s24, 64
	s_cmp_lg_u32 s1, 0
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	v_dual_cndmask_b32 v74, 0x80000000, v57 :: v_dual_cndmask_b32 v77, 0x80000000, v56
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v57, s3, v57
	v_add_nc_u32_e32 v56, s3, v56
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[89:90], v73, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v10 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v65 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[29:36], v[85:86], v[83:84], v[29:36] neg_lo:[1,1,0]
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v66 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[87:88], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v59 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v67 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[87:88], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v60 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v68 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v69 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[87:88], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v62 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v70 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[87:88], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v63 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v71 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[13:20], v[85:86], v[81:82], v[13:20] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[21:28], v[87:88], v[81:82], v[21:28] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[87:88], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v64 offset0:32 offset1:36
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	ds_load_2addr_stride64_b64 v[85:88], v72 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v12, v[89:90] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(0)
	...
	ds_store_b16 v53, v79
	ds_store_b16_d16_hi v53, v79 offset:64
	ds_store_b16 v54, v80
	ds_store_b16_d16_hi v54, v80 offset:64
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 94
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 27
