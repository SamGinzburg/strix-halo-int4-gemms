...
.Ltmp0:
	...
	.loc	1 805 17                        ; attention.py:805:17
	s_add_i32 s4, s4, 64
	v_dual_mov_b32 v14, v8 :: v_dual_add_nc_u32 v75, 0, v53
	s_add_i32 s5, s4, s9
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s0, s3, s12
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v5, s10, v36
	...
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v7, 16, v0
	...
	.loc	1 852 32                        ; attention.py:852:32
	s_and_b32 s10, s1, 0xfffff800
	.loc	1 760 21                        ; attention.py:760:21
	v_lshrrev_b32_e32 v2, 2, v4
	v_or_b32_e32 v77, v3, v1
	v_mov_b32_e32 v1, 0x5410
	v_cmp_eq_u32_e64 s1, 0, v7
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v16, 48, v67
	v_lshrrev_b32_e32 v4, 1, v4
	v_bfe_i32 v17, v0, 3, 1
	v_dual_mov_b32 v24, v25 :: v_dual_and_b32 v15, 48, v15
	v_cndmask_b32_e64 v1, 0x1054, v1, s1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v4, v16, v4
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v16, 0x210, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v15, v66, 6, v15
	v_lshl_or_b32 v1, v1, 8, v1
	v_dual_mov_b32 v7, 0x7632 :: v_dual_add_nc_u32 v6, s9, v5
	v_xor_b32_e32 v10, 48, v77
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v81, v15, v16
	v_and_b32_e32 v1, 0x540054, v1
	v_xor_b32_e32 v9, 32, v77
	v_cndmask_b32_e64 v7, 0x3276, v7, s1
	.loc	1 818 13                        ; attention.py:818:13
	s_add_i32 s1, s3, s10
	v_xor_b32_e32 v18, 32, v81
	s_add_i32 s1, s1, s47
	...
	v_xor_b32_e32 v21, 0x420, v81
	v_and_b32_e32 v7, 0x760076, v7
	v_xor_b32_e32 v23, 0x410, v81
	v_lshl_or_b32 v79, v66, 9, v4
	v_and_b32_e32 v78, 0x5040504, v1
	v_add_nc_u32_e32 v1, s1, v2
	v_add_nc_u32_e32 v2, s1, v65
	v_dual_mov_b32 v103, v25 :: v_dual_add_nc_u32 v100, 0, v21
	...
	v_xor_b32_e32 v8, 16, v77
	v_xor_b32_e32 v11, 64, v77
	v_xor_b32_e32 v12, 0x50, v77
	v_xor_b32_e32 v13, 0x60, v77
	v_lshl_add_u32 v82, v20, 1, v3
	v_mov_b32_e32 v20, v25
	v_lshl_or_b32 v7, v7, 4, v7
	v_xor_b32_e32 v14, 0x70, v77
	v_xor_b32_e32 v4, 0x90, v79
	v_xor_b32_e32 v15, 0x1b0, v79
	v_xor_b32_e32 v17, 16, v81
	v_and_b32_e32 v80, 0x7060706, v7
	v_xor_b32_e32 v7, 0x120, v79
	v_xor_b32_e32 v19, 48, v81
	v_xor_b32_e32 v22, 0x430, v81
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v76, s8, v5
	.loc	1 818 13                        ; attention.py:818:13
	v_lshl_add_u32 v83, v1, 1, v3
	v_lshl_add_u32 v84, v16, 1, v3
	v_lshl_add_u32 v85, v2, 1, v3
	v_add_nc_u32_e32 v86, 0, v8
	v_add_nc_u32_e32 v89, 0, v11
	v_add_nc_u32_e32 v90, 0, v12
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v91, 0, v13
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v92, 0, v14
	v_min_i32_e32 v93, v5, v6
	v_dual_mov_b32 v3, v25 :: v_dual_add_nc_u32 v94, 0, v4
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v95, 0, v7
	v_dual_mov_b32 v5, v25 :: v_dual_add_nc_u32 v96, 0, v15
	v_dual_mov_b32 v4, v25 :: v_dual_add_nc_u32 v97, 0, v17
	v_dual_mov_b32 v6, v25 :: v_dual_add_nc_u32 v99, 0, v19
	v_dual_mov_b32 v8, v25 :: v_dual_add_nc_u32 v101, 0, v22
	...
	v_dual_mov_b32 v7, v25 :: v_dual_mov_b32 v104, 0xff800000
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v112, 0x80000000, v85 :: v_dual_cndmask_b32 v113, 0x80000000, v84
	.loc	1 819 31                        ; attention.py:819:31
	v_add_nc_u32_e32 v114, s47, v73
	v_dual_mov_b32 v105, v103 :: v_dual_add_nc_u32 v106, 0, v79
	.loc	1 854 32                        ; attention.py:854:32
	s_clause 0x1
	buffer_load_b128 v[115:118], v112, s[48:51], 0 offen
	buffer_load_b128 v[119:122], v113, s[48:51], 0 offen
	v_add_nc_u32_e32 v108, 0, v77
	...
	v_dual_mov_b32 v66, s37 :: v_dual_add_nc_u32 v109, 0, v81
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s25, v130, v76
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s26, v93, v130
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s27, v132, v76
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s28, v93, v132
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s29, v133, v76
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s31, v93, v133
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s34, v131, v76
	.loc	1 867 21 is_stmt 1              ; attention.py:867:21
	s_and_b32 s4, s4, s3
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s3, v93, v131
	.loc	1 890 30                        ; attention.py:890:30
	v_cndmask_b32_e64 v111, 0x80000000, v83, s0
	v_cndmask_b32_e64 v110, 0x80000000, v82, s0
	...
	.loc	1 854 32                        ; attention.py:854:32
	ds_load_b128 v[69:72], v88
	ds_load_b128 v[65:68], v87
	ds_load_b128 v[122:125], v91 offset:2048
	ds_load_b128 v[126:129], v92 offset:2048
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(2)
	v_wmma_f32_16x16x16_bf16 v[130:137], v[65:72], v[49:56], v[130:137]
	.loc	1 854 32                        ; attention.py:854:32
	ds_load_b128 v[65:68], v87 offset:2048
	ds_load_b128 v[69:72], v88 offset:2048
	.loc	1 859 30                        ; attention.py:859:30
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s6, v93, v103
	.loc	1 860 21 is_stmt 1              ; attention.py:860:21
	v_mul_f32_e32 v125, s57, v135
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s7, v112, v76
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s8, v93, v112
	.loc	1 860 21 is_stmt 1              ; attention.py:860:21
	v_mul_f32_e32 v126, s57, v136
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v113, v76
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s10, v93, v113
	.loc	1 860 21 is_stmt 1              ; attention.py:860:21
	v_dual_mul_f32 v108, s57, v130 :: v_dual_mul_f32 v127, s57, v137
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s5, s6, s5
	s_and_b32 s61, s8, s7
	s_and_b32 s6, s10, s9
	...
	s_and_b32 s16, s31, s29
	s_and_b32 s17, s33, s30
	s_and_b32 s18, s3, s34
	s_and_b32 s3, s2, s5
	s_and_b32 s5, s2, s6
	s_and_b32 s6, s2, s7
	s_and_b32 s7, s2, s8
...
.Ltmp15:
	...
	.loc	1 886 62 is_stmt 0              ; attention.py:886:62
	v_dual_sub_f32 v114, v114, v108 :: v_dual_and_b32 v133, 1, v138
	.loc	1 886 33                        ; attention.py:886:33
...
.Ltmp21:
	...
	.loc	1 886 62 is_stmt 0              ; attention.py:886:62
	v_dual_sub_f32 v117, v117, v108 :: v_dual_add_f32 v128, v128, v129
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp23:
	...
	.loc	1 895 23                        ; attention.py:895:23
	v_dual_mul_f32 v29, v29, v135 :: v_dual_and_b32 v104, 1, v112
	v_dual_mul_f32 v31, v31, v135 :: v_dual_and_b32 v112, 1, v113
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp26:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_dual_add_f32 v129, v116, v117 :: v_dual_sub_f32 v110, v110, v108
.Ltmp27:
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp29:
	...
	v_dual_mul_f32 v1, v1, v135 :: v_dual_add_f32 v132, v110, v120
	.loc	1 896 30                        ; attention.py:896:30
	...
	.loc	1 895 23                        ; attention.py:895:23
	v_dual_mul_f32 v2, v2, v135 :: v_dual_add_f32 v131, v131, v132
...
.Ltmp33:
	...
	v_perm_b32 v110, v112, v111, v78
	v_perm_b32 v111, v112, v111, v80
	v_perm_b32 v112, v113, v103, v78
	v_and_b32_e32 v125, 1, v107
	v_mov_b16_e32 v107.l, v119.h
	v_perm_b32 v113, v113, v103, v80
	...
	v_perm_b32 v114, v118, v104, v78
	v_perm_b32 v115, v118, v104, v80
	...
	v_perm_b32 v116, v126, v121, v78
	v_perm_b32 v117, v126, v121, v80
	...
	v_perm_b32 v118, v107, v122, v78
	v_perm_b32 v119, v107, v122, v80
	v_perm_b32 v120, v121, v123, v78
	v_perm_b32 v121, v121, v123, v80
	v_permlanex16_b32 v104, v127, s60, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v122, v103, v124, v78
	v_perm_b32 v123, v103, v124, v80
	s_delay_alu instid0(VALU_DEP_3)
	v_perm_b32 v124, v104, v127, v78
	v_perm_b32 v125, v104, v127, v80
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt vmcnt(1)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 140
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 62
