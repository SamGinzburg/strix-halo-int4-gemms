...
.Ltmp11:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v9, v12, 4, v5
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_mad_u64_u32 v[10:11], null, s23, 3, v[9:10]
	v_lshl_add_u32 v82, s23, 1, v9
	.loc	1 349 16                        ; generate_amdgcn.py:349:16
...
.Ltmp13:
	...
	buffer_load_b128 v[22:25], v6, s[24:27], 0 offen
	v_cndmask_b32_e64 v1, 0x80000000, v3, s3
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v6, s4, v82
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v3, 0x80000000, v7, s3
	.loc	1 404 30 is_stmt 1              ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v5, s29, v83
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	...
	s_clause 0x1
	buffer_load_b128 v[42:45], v3, s[24:27], 0 offen
	buffer_load_b128 v[46:49], v5, s[24:27], 0 offen
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	buffer_load_b128 v[50:53], v1, s[12:15], 0 offen
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(9)
	ds_store_b128 v2, v[14:17] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	...
	s_waitcnt vmcnt(3)
	v_perm_b32 v30, v38, v34, 0x4000501
	v_perm_b32 v31, v38, v34, 0x6020703
	v_perm_b32 v38, v14, v22, 0x7060302
	...
	v_perm_b32 v25, v18, v26, 0x7060302
	v_perm_b32 v18, v18, v26, 0x5040100
	v_perm_b32 v26, v19, v27, 0x7060302
	v_perm_b32 v19, v19, v27, 0x5040100
	v_perm_b32 v27, v20, v28, 0x7060302
	v_perm_b32 v20, v20, v28, 0x5040100
	v_perm_b32 v28, v21, v29, 0x7060302
	v_perm_b32 v21, v21, v29, 0x5040100
	s_waitcnt vmcnt(1)
	v_perm_b32 v29, v46, v42, 0x4000501
	v_perm_b32 v32, v39, v35, 0x4000501
	v_perm_b32 v33, v39, v35, 0x6020703
	v_perm_b32 v39, v46, v42, 0x6020703
	v_perm_b32 v34, v40, v36, 0x4000501
	v_perm_b32 v35, v40, v36, 0x6020703
	v_perm_b32 v40, v47, v43, 0x4000501
	v_perm_b32 v36, v41, v37, 0x4000501
	v_perm_b32 v37, v41, v37, 0x6020703
	v_perm_b32 v41, v47, v43, 0x6020703
	v_perm_b32 v42, v48, v44, 0x4000501
	v_perm_b32 v43, v48, v44, 0x6020703
	v_perm_b32 v44, v49, v45, 0x4000501
	v_perm_b32 v45, v49, v45, 0x6020703
	ds_store_2addr_b32 v3, v38, v14 offset1:16
	ds_store_2addr_b32 v6, v22, v15 offset1:16
	ds_store_2addr_b32 v7, v23, v16 offset1:16
	ds_store_2addr_b32 v8, v24, v17 offset1:16
	ds_store_2addr_b32 v54, v25, v18 offset1:16
	ds_store_2addr_b32 v3, v26, v19 offset0:160 offset1:176
	ds_store_2addr_b32 v55, v27, v20 offset1:16
	ds_store_2addr_b32 v56, v28, v21 offset1:16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v2, v[50:53] offset:36864
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v2, v30, v29, 0x7060302
	v_perm_b32 v3, v30, v29, 0x5040100
	v_perm_b32 v6, v31, v39, 0x7060302
	v_perm_b32 v7, v31, v39, 0x5040100
	v_perm_b32 v8, v32, v40, 0x7060302
	v_perm_b32 v14, v32, v40, 0x5040100
	v_perm_b32 v15, v33, v41, 0x7060302
	v_perm_b32 v16, v33, v41, 0x5040100
	v_perm_b32 v17, v34, v42, 0x7060302
	v_perm_b32 v18, v34, v42, 0x5040100
	v_perm_b32 v19, v35, v43, 0x7060302
	v_perm_b32 v20, v35, v43, 0x5040100
	v_perm_b32 v21, v36, v44, 0x7060302
	v_perm_b32 v22, v36, v44, 0x5040100
	v_perm_b32 v23, v37, v45, 0x7060302
	v_perm_b32 v24, v37, v45, 0x5040100
	ds_store_2addr_b32 v57, v2, v3 offset1:16
	ds_store_2addr_b32 v58, v6, v7 offset1:16
	ds_store_2addr_b32 v59, v8, v14 offset1:16
	ds_store_2addr_b32 v60, v15, v16 offset1:16
	ds_store_2addr_b32 v61, v17, v18 offset1:16
	ds_store_2addr_b32 v57, v19, v20 offset0:160 offset1:176
	ds_store_2addr_b32 v62, v21, v22 offset1:16
	ds_store_2addr_b32 v63, v23, v24 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_3
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v84, 48, v4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v78, v12, 6, v84
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_or_b32 v85, 0x1c0, v1, v6
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_4:                                ; %.lr.ph
	v_bfe_i32 v2, v0, 3, 1
	v_dual_mov_b32 v45, 0 :: v_dual_and_b32 v84, 48, v4
.Ltmp14:
...
.Ltmp15:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v96, s23, v9
	v_and_or_b32 v85, 0x1c0, v1, v3
	v_xor_b32_e32 v1, v2, v84
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s4, s29, s6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v109, s7, v97
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v101, s4, v83
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v177, s33, v78
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v110, s7, v98
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v181, s33, v79
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s4, s4, s23
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b128 v[165:168], v101, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[169:172], v109 offset:8192
	ds_load_b128 v[173:176], v110 offset:8192
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[117:120], v177
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[133:136], v177 offset:1024
	ds_load_b128 v[137:140], v181 offset:1024
	ds_load_b128 v[149:152], v177 offset:2048
	ds_load_b128 v[153:156], v181 offset:2048
	ds_load_b128 v[177:180], v177 offset:3072
	ds_load_b128 v[181:184], v181 offset:3072
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s4, s4, s22
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[101:108], v[157:160], v[117:120], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[109:116], v[169:172], v[117:120], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_wmma_i32_16x16x16_iu8 v[125:132], v[169:172], v[133:136], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu8 v[101:108], v[161:164], v[121:124], v[101:108] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[109:116], v[173:176], v[121:124], v[109:116] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[117:124], v[157:160], v[133:136], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[125:132], v[173:176], v[137:140], v[125:132] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[141:148], v[169:172], v[149:152], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[117:124], v[161:164], v[137:140], v[117:124] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[133:140], v[157:160], v[149:152], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[141:148], v[173:176], v[153:156], v[141:148] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[133:140], v[161:164], v[153:156], v[133:140] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[149:156], v[157:160], v[177:180], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[149:156], v[161:164], v[181:184], v[149:156] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[157:164], v[169:172], v[177:180], v[1:8] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v177, s7, v99
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[157:164], v[173:176], v[181:184], v[157:164] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v181, s33, v80
	ds_load_b128 v[169:172], v181
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[173:176], v177
	ds_load_b128 v[177:180], v177 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[101:108], v[173:176], v[169:172], v[101:108] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[109:116], v[177:180], v[169:172], v[109:116] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[169:172], v181 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[117:124], v[173:176], v[169:172], v[117:124] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[125:132], v[177:180], v[169:172], v[125:132] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[169:172], v181 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[133:140], v[173:176], v[169:172], v[133:140] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[141:148], v[177:180], v[169:172], v[141:148] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[169:172], v181 offset:3072
	v_add_nc_u32_e32 v181, s33, v81
	s_mov_b32 s33, s1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[157:164], v[177:180], v[169:172], v[157:164] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v177, s7, v100
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[149:156], v[173:176], v[169:172], v[149:156] neg_lo:[1,1,0]
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[169:172], v181
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[173:176], v177
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v65, v65, v114 :: v_dual_add_f32 v54, v54, v125
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[133:140], v[173:176], v[169:172], v[133:140] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[141:148], v[177:180], v[169:172], v[141:148] neg_lo:[1,1,0]
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v63, v63, v116 :: v_dual_add_f32 v52, v52, v127
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v106, s4, v9
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v178, v110
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v110, s4, v96
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v45, v45, v169 :: v_dual_add_f32 v76, v76, v171
	...
	v_dual_add_f32 v62, v62, v117 :: v_dual_add_f32 v61, v61, v118
	v_dual_add_f32 v50, v50, v129 :: v_dual_add_f32 v59, v59, v120
	v_dual_add_f32 v48, v48, v131 :: v_dual_add_f32 v57, v57, v122
	v_dual_add_f32 v46, v46, v133 :: v_dual_add_f32 v55, v55, v124
	v_add_f32_e32 v44, v44, v134
	v_dual_add_f32 v53, v53, v126 :: v_dual_add_f32 v42, v42, v136
	v_dual_add_f32 v51, v51, v128 :: v_dual_add_f32 v40, v40, v138
	v_dual_add_f32 v49, v49, v130 :: v_dual_add_f32 v38, v38, v140
	v_dual_add_f32 v47, v47, v132 :: v_dual_add_f32 v36, v36, v142
	v_dual_add_f32 v43, v43, v135 :: v_dual_add_f32 v34, v34, v144
	v_dual_add_f32 v41, v41, v137 :: v_dual_add_f32 v32, v32, v146
	v_dual_add_f32 v39, v39, v139 :: v_dual_add_f32 v30, v30, v148
	v_dual_add_f32 v37, v37, v141 :: v_dual_add_f32 v28, v28, v150
	v_dual_add_f32 v35, v35, v143 :: v_dual_add_f32 v26, v26, v152
	v_dual_add_f32 v33, v33, v145 :: v_dual_add_f32 v24, v24, v154
	v_dual_add_f32 v31, v31, v147 :: v_dual_add_f32 v22, v22, v156
	v_dual_add_f32 v29, v29, v149 :: v_dual_add_f32 v20, v20, v158
	v_dual_add_f32 v27, v27, v151 :: v_dual_add_f32 v18, v18, v105
	v_dual_add_f32 v23, v23, v155 :: v_dual_add_f32 v14, v14, v101
	v_dual_add_f32 v21, v21, v157 :: v_dual_add_f32 v16, v16, v103
	v_add_f32_e32 v19, v19, v159
	v_add_f32_e32 v17, v17, v104
	v_add_f32_e32 v15, v15, v102
	v_add_f32_e32 v75, v75, v172
	v_dual_add_f32 v71, v71, v176 :: v_dual_add_f32 v60, v60, v119
	v_dual_add_f32 v56, v56, v123 :: v_dual_add_f32 v67, v67, v180
	v_dual_add_f32 v58, v58, v121 :: v_dual_add_f32 v69, v69, v178
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v160, v110, v106, 0x4000501
	v_perm_b32 v161, v110, v106, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v106, s4, v82
	v_add_nc_u32_e32 v110, s4, v10
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v162, v111, v107, 0x4000501
	v_perm_b32 v163, v111, v107, 0x6020703
	v_perm_b32 v164, v112, v108, 0x4000501
	v_perm_b32 v182, v112, v108, 0x6020703
	v_perm_b32 v183, v113, v109, 0x4000501
	v_perm_b32 v184, v113, v109, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[106:109], v106, s[24:27], 0 offen
	buffer_load_b128 v[110:113], v110, s[24:27], 0 offen
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	...
	s_add_i32 s0, s0, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v25, v25, v153 :: v_dual_add_nc_u32 v104, s0, v94
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v105, s0, v93
	...
	v_perm_b32 v110, v111, v107, 0x4000501
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v113, s6, v88
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v102, v111, v164, 0x7060302
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b128 v113, v[165:168] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v113, v185, v160, 0x7060302
	v_perm_b32 v160, v185, v160, 0x5040100
	v_add_nc_u32_e32 v165, s0, v89
	ds_store_2addr_b32 v165, v113, v160 offset1:16
	v_perm_b32 v113, v106, v161, 0x7060302
	v_perm_b32 v106, v106, v161, 0x5040100
	v_add_nc_u32_e32 v160, s0, v90
	ds_store_2addr_b32 v160, v113, v106 offset1:16
	v_perm_b32 v106, v110, v162, 0x7060302
	v_perm_b32 v110, v110, v162, 0x5040100
	v_add_nc_u32_e32 v113, s0, v91
	ds_store_2addr_b32 v113, v106, v110 offset1:16
	v_perm_b32 v106, v107, v163, 0x7060302
	v_perm_b32 v107, v107, v163, 0x5040100
	v_add_nc_u32_e32 v110, s0, v92
	ds_store_2addr_b32 v110, v106, v107 offset1:16
	v_perm_b32 v106, v111, v164, 0x5040100
	v_perm_b32 v107, v108, v182, 0x7060302
	v_perm_b32 v108, v108, v182, 0x5040100
	v_perm_b32 v110, v112, v183, 0x7060302
	v_perm_b32 v111, v112, v183, 0x5040100
	v_perm_b32 v112, v109, v184, 0x7060302
	v_perm_b32 v109, v109, v184, 0x5040100
	ds_store_2addr_b32 v105, v102, v106 offset1:16
	ds_store_2addr_b32 v165, v107, v108 offset0:160 offset1:176
	ds_store_2addr_b32 v104, v110, v111 offset1:16
	ds_store_2addr_b32 v103, v112, v109 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v3, v86 :: v_dual_mov_b32 v2, v87
.LBB0_7:                                ; %Flow72
	...
	v_xor_b32_e32 v3, v3, v84
	v_cndmask_b32_e64 v2, 0x420, 0, vcc_lo
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_and_not1_b32 vcc_lo, exec_lo, s3
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b32_e32 v3, v85, v3
...
; %bb.8:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v83, s9 :: v_dual_add_nc_u32 v10, s33, v78
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v126, s33, v79
	ds_load_b128 v[122:125], v10 offset:1024
	ds_load_b128 v[106:109], v10
	v_add_nc_u32_e32 v128, s33, v80
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v86, s12 :: v_dual_add_nc_u32 v127, s33, v81
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 214
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
