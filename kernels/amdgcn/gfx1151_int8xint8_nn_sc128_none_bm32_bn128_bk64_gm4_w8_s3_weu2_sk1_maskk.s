	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[3:4], null, s27, v2, v[1:2]
...
.Ltmp20:
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b64 v[54:55], v6, s[8:11], 0 offen
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	...
	v_lshrrev_b32_e32 v66, 24, v33
	v_lshrrev_b32_e32 v67, 8, v30
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_or_b32 v52, 0x1800, v6, v7
	v_dual_mov_b32 v11, 0 :: v_dual_add_nc_u32 v6, s31, v2
	v_lshl_or_b32 v37, v9, 6, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_or_b32 v5, 0x210, v8, v5
	v_or_b32_e32 v60, 0x80, v2
	v_add_nc_u32_e32 v7, 0x81, v6
	v_add_nc_u32_e32 v6, 0x80, v6
	v_or_b32_e32 v61, 0x80, v3
	...
	v_subrev_nc_u32_e32 v57, s14, v5
	v_subrev_nc_u32_e32 v58, s14, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v134, v63, s[40:43], 0 offen
	buffer_load_u16 v135, v62, s[40:43], 0 offen
	...
	buffer_load_u16 v140, v71, s[40:43], 0 offen
	buffer_load_u16 v141, v70, s[40:43], 0 offen
	s_mov_b32 s18, s14
	s_mov_b32 s14, s1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v66, s1, v53
	v_add_nc_u32_e32 v67, s1, v54
	v_add_nc_u32_e32 v68, s1, v55
	v_add_nc_u32_e32 v69, s1, v56
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v142, s19, v44
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v80, 16, v141
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v122, v77, v71
	v_dual_mul_f32 v125, v79, v71 :: v_dual_lshlrev_b32 v76, 16, v137
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v78, 16, v139
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v124, v80, v71 :: v_dual_add_nc_u32 v143, s35, v45
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v17, v125, v93 :: v_dual_lshlrev_b32 v74, 16, v135
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v121, v78, v71 :: v_dual_add_nc_u32 v58, s34, v58
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v21, v122, v91 :: v_dual_lshlrev_b32 v72, 16, v133
	v_fmac_f32_e32 v15, v124, v92
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b16 v64.l, 0xff, v65.l
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v19, v121, v90 :: v_dual_mul_f32 v120, v72, v76
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v75, 16, v136
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v78, v72, v78 :: v_dual_add_nc_u32 v57, s34, v57
	v_mul_f32_e32 v116, v72, v74
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v20, v120, v97 :: v_dual_lshlrev_b32 v73, 16, v134
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v119, v72, v75
	v_dual_mul_f32 v80, v72, v80 :: v_dual_add_nc_u32 v145, s35, v47
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v113, v74, v71
	v_mul_f32_e32 v117, v76, v71
	v_mul_f32_e32 v118, v75, v71
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v70.l, 8, v81.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v24, v116, v95
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v114, v73, v71 :: v_dual_mul_f32 v115, v72, v73
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v18, v119, v96 :: v_dual_mul_f32 v123, v72, v77
	v_fmac_f32_e32 v16, v78, v99
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v79, v72, v79 :: v_dual_add_nc_u32 v144, s35, v46
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v25, v118, v89 :: v_dual_add_nc_u32 v146, s35, v48
	v_dual_fmac_f32 v26, v114, v87 :: v_dual_add_nc_u32 v147, s35, v49
	v_dual_fmac_f32 v23, v117, v88 :: v_dual_add_nc_u32 v148, s35, v50
	v_dual_fmac_f32 v22, v115, v94 :: v_dual_add_nc_u32 v149, s35, v51
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v11, v113, v86
	v_dual_fmac_f32 v14, v123, v98 :: v_dual_fmac_f32 v13, v80, v101
	v_fmac_f32_e32 v12, v79, v100
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v86, s11 :: v_dual_add_nc_u32 v1, s35, v76
	v_dual_mov_b32 v85, s10 :: v_dual_add_nc_u32 v50, s35, v75
	v_dual_mov_b32 v84, s9 :: v_dual_add_nc_u32 v51, s35, v74
	v_dual_mov_b32 v83, s8 :: v_dual_add_nc_u32 v52, s35, v73
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 150
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
