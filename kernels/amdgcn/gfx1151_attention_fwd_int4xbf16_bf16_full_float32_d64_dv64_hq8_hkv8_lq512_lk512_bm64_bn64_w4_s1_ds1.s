...
.Ltmp0:
	...
	v_dual_mov_b32 v8, v17 :: v_dual_and_b32 v43, 56, v45
	v_add_nc_u32_e32 v185, v38, v46
	...
	v_dual_mov_b32 v99, v17 :: v_dual_add_nc_u32 v184, 0, v39
	...
	v_dual_mov_b32 v4, v17 :: v_dual_add_nc_u32 v181, 0, v56
	v_dual_mov_b32 v6, v17 :: v_dual_add_nc_u32 v183, 0, v58
	v_dual_mov_b32 v98, v17 :: v_dual_add_nc_u32 v189, 0, v45
	v_dual_mov_b32 v97, v17 :: v_dual_add_nc_u32 v182, 0, v57
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_or_b32 s83, s102, s100
	.loc	1 823 32                        ; attention.py:823:32
	v_add_nc_u32_e32 v37, 0, v153
	.loc	1 822 32                        ; attention.py:822:32
	v_mad_u64_u32 v[33:34], null, s83, s80, v[95:96]
	...
	ds_load_2addr_stride64_b64 v[83:86], v181 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[49:52], v182 offset1:1
	ds_load_2addr_stride64_b64 v[87:90], v182 offset0:2 offset1:3
	ds_load_2addr_stride64_b64 v[73:76], v183 offset1:1
	ds_load_2addr_stride64_b64 v[91:94], v183 offset0:2 offset1:3
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(7)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_2addr_b64 v184, v[125:126], v[127:128] offset1:16
	...
	.loc	1 880 35                        ; attention.py:880:35
	ds_store_2addr_b64 v184, v[125:126], v[127:128] offset0:64 offset1:80
	.loc	1 838 37                        ; attention.py:838:37
	s_waitcnt vmcnt(32)
	...
	ds_store_2addr_b64 v184, v[112:113], v[114:115] offset0:32 offset1:48
	...
	ds_store_2addr_b64 v184, v[112:113], v[114:115] offset0:96 offset1:112
	.loc	1 879 36                        ; attention.py:879:36
...
.Ltmp24:
	...
	v_permlanex16_b32 v58, v57, s101, 0xfedcba98 op_sel:[1,0]
.Ltmp25:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v112, v218, s101, 0xfedcba98 op_sel:[1,0]
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 886 62                        ; attention.py:886:62
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_bf16_full_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 80
