	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
.Lfunc_begin0:
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v58, v58, v0 :: v_dual_add_nc_u32 v67, 0x80, v67
	v_dual_mul_f32 v41, v41, v1 :: v_dual_add_nc_u32 v68, 0x80, v68
	v_dual_mul_f32 v60, v60, v0 :: v_dual_add_nc_u32 v69, 0x80, v69
	v_dual_mul_f32 v57, v57, v0 :: v_dual_add_nc_u32 v70, 0x80, v70
	v_dual_mul_f32 v62, v62, v0 :: v_dual_add_nc_u32 v71, 0x80, v71
	v_dual_mul_f32 v43, v43, v1 :: v_dual_add_nc_u32 v72, 0x80, v72
	v_dual_mul_f32 v64, v64, v0 :: v_dual_add_nc_u32 v73, 0x80, v73
	v_dual_mul_f32 v59, v59, v0 :: v_dual_add_nc_u32 v74, 0x80, v74
	v_dual_mul_f32 v50, v50, v0 :: v_dual_add_nc_u32 v75, 0x80, v75
	v_dual_mul_f32 v45, v45, v1 :: v_dual_add_nc_u32 v76, 0x80, v76
	v_dual_mul_f32 v52, v52, v0 :: v_dual_add_nc_u32 v77, 0x80, v77
	v_dual_mul_f32 v61, v61, v0 :: v_dual_add_nc_u32 v78, 0x80, v78
	v_dual_mul_f32 v54, v54, v0 :: v_dual_add_nc_u32 v79, 0x80, v79
	v_dual_mul_f32 v47, v47, v1 :: v_dual_add_nc_u32 v80, 0x80, v80
	.loc	1 1115 19                       ; ragged.py:1115:19
	v_add_nc_u32_e32 v81, 0x80, v81
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v63, v63, v0 :: v_dual_add_nc_u32 v82, 0x80, v82
	v_dual_mul_f32 v42, v42, v1 :: v_dual_add_nc_u32 v83, 0x80, v83
	v_dual_mul_f32 v33, v33, v1 :: v_dual_add_nc_u32 v84, 0x80, v84
	v_dual_mul_f32 v26, v26, v2 :: v_dual_add_nc_u32 v85, 0x80, v85
	v_dual_mul_f32 v49, v49, v0 :: v_dual_add_nc_u32 v86, 0x80, v86
	v_dual_mul_f32 v44, v44, v1 :: v_dual_add_nc_u32 v87, 0x80, v87
	v_dual_mul_f32 v35, v35, v1 :: v_dual_add_nc_u32 v88, 0x80, v88
	v_dual_mul_f32 v28, v28, v2 :: v_dual_add_nc_u32 v89, 0x80, v89
	v_dual_mul_f32 v51, v51, v0 :: v_dual_add_nc_u32 v90, 0x80, v90
	v_dual_mul_f32 v46, v46, v1 :: v_dual_add_nc_u32 v91, 0x80, v91
	v_dual_mul_f32 v37, v37, v1 :: v_dual_add_nc_u32 v92, 0x80, v92
	v_dual_mul_f32 v30, v30, v2 :: v_dual_add_nc_u32 v93, 0x80, v93
	v_dual_mul_f32 v53, v53, v0 :: v_dual_add_nc_u32 v94, 0x80, v94
	v_dual_mul_f32 v48, v48, v1 :: v_dual_add_nc_u32 v95, 0x80, v95
	v_dual_mul_f32 v39, v39, v1 :: v_dual_add_nc_u32 v96, 0x80, v96
	v_dual_mul_f32 v32, v32, v2 :: v_dual_add_nc_u32 v97, 0x80, v97
	v_dual_mul_f32 v55, v55, v0 :: v_dual_add_nc_u32 v98, 0x80, v98
	v_dual_mul_f32 v34, v34, v1 :: v_dual_add_nc_u32 v99, 0x80, v99
	v_dual_mul_f32 v25, v25, v2 :: v_dual_add_nc_u32 v100, 0x80, v100
	v_dual_mul_f32 v18, v18, v2 :: v_dual_add_nc_u32 v101, 0x80, v101
	v_dual_mul_f32 v36, v36, v1 :: v_dual_add_nc_u32 v103, 0x80, v103
	v_dual_mul_f32 v27, v27, v2 :: v_dual_add_nc_u32 v104, 0x80, v104
	v_dual_mul_f32 v20, v20, v2 :: v_dual_add_nc_u32 v105, 0x80, v105
	v_mul_f32_e32 v0, v56, v0
	v_dual_mul_f32 v40, v40, v1 :: v_dual_mul_f32 v31, v31, v2
	v_mul_f32_e32 v24, v24, v2
	v_dual_mul_f32 v109, v11, v107 :: v_dual_add_nc_u32 v102, 0x80, v102
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 81
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.private_seg_size, 256
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1
    .private_segment_fixed_size: 256
    .sgpr_count:     83
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.kd
