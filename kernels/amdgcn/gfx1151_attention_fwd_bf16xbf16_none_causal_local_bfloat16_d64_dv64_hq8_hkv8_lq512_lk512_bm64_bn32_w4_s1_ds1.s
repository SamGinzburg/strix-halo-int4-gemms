...
.Ltmp0:
	...
	v_mov_b32_e32 v3, v8
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v89, v36, v34
	.loc	1 802 39                        ; attention.py:802:39
	s_sub_i32 s2, s5, s8
	v_mov_b32_e32 v2, v8
	v_dual_mov_b32 v16, v8 :: v_dual_and_b32 v25, 0x70, v25
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v36, s5, v89
	v_mov_b32_e32 v4, v8
	v_mov_b32_e32 v1, v8
	v_mov_b32_e32 v12, v8
	.loc	1 788 26                        ; attention.py:788:26
	v_xor_b32_e32 v53, v67, v25
...
; %bb.1:                                ; %.lr.ph
	...
	v_and_b32_e32 v16, 0x210, v0
	v_lshl_or_b32 v15, v66, 6, v15
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v2, 0x540054, v2
	v_cndmask_b32_e64 v7, 0x3276, v7, s3
	.loc	1 818 13                        ; attention.py:818:13
	s_add_i32 s10, s10, s57
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_xor_b32_e32 v96, v15, v16
	v_lshl_or_b32 v2, v2, 4, v2
	v_add_nc_u32_e32 v1, s10, v1
	v_lshl_or_b32 v7, v7, 8, v7
	v_xor_b32_e32 v9, 32, v93
	v_xor_b32_e32 v23, 0x410, v96
	v_and_b32_e32 v0, 0x5040504, v2
	v_add_nc_u32_e32 v2, s10, v65
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v7, 0x760076, v7
	v_mul_lo_u32 v1, s47, v1
	v_add_nc_u32_e32 v117, 0, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v16, 16, v2
	v_lshl_or_b32 v7, v7, 4, v7
	v_lshl_or_b32 v94, v66, 9, v5
	...
	v_xor_b32_e32 v10, 48, v93
	v_xor_b32_e32 v11, 64, v93
	v_xor_b32_e32 v12, 0x50, v93
	v_xor_b32_e32 v13, 0x60, v93
	v_xor_b32_e32 v14, 0x70, v93
	v_and_b32_e32 v95, 0x7060706, v7
	v_xor_b32_e32 v5, 0x90, v94
	v_xor_b32_e32 v7, 0x120, v94
	v_xor_b32_e32 v15, 0x1b0, v94
	v_xor_b32_e32 v17, 16, v96
	v_xor_b32_e32 v18, 32, v96
	v_xor_b32_e32 v19, 48, v96
	v_add_nc_u32_e32 v20, s47, v1
	v_xor_b32_e32 v21, 0x420, v96
	v_xor_b32_e32 v22, 0x430, v96
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v92, s8, v4
	.loc	1 818 13                        ; attention.py:818:13
	v_lshl_add_u32 v98, v1, 1, v3
	v_lshl_add_u32 v99, v16, 1, v3
	v_lshl_add_u32 v100, v2, 1, v3
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v101, 0, v8
	v_add_nc_u32_e32 v103, 0, v10
	v_mov_b32_e32 v10, v25
	v_add_nc_u32_e32 v104, 0, v11
	v_add_nc_u32_e32 v105, 0, v12
	v_mov_b32_e32 v12, v25
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v106, 0, v13
	v_add_nc_u32_e32 v107, 0, v14
	v_mov_b32_e32 v14, v25
	v_min_i32_e32 v108, v4, v6
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v109, 0, v5
	v_add_nc_u32_e32 v110, 0, v7
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v111, 0, v15
	v_dual_mov_b32 v5, v25 :: v_dual_add_nc_u32 v112, 0, v17
	v_dual_mov_b32 v4, v25 :: v_dual_add_nc_u32 v113, 0, v18
	v_dual_mov_b32 v7, v25 :: v_dual_add_nc_u32 v114, 0, v19
	v_dual_mov_b32 v6, v25 :: v_dual_add_nc_u32 v115, 0, v21
	v_dual_mov_b32 v73, 0xff800000 :: v_dual_add_nc_u32 v116, 0, v22
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v79, 0x80000000, v100 :: v_dual_add_nc_u32 v76, 0, v93
	v_dual_cndmask_b32 v81, 0x80000000, v99 :: v_dual_add_nc_u32 v120, 0, v96
	...
	v_cmp_ge_i32_e64 s10, v81, v92
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s11, v108, v81
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s12, v86, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s13, v108, v86
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v87, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s15, v108, v87
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v88, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s17, v108, v88
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s18, v126, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s19, v108, v126
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s20, v127, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s21, v108, v127
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s22, v128, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s23, v108, v128
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s24, v129, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s25, v108, v129
	...
	v_cndmask_b32_e64 v75, 0x80000000, v98, s0
	v_cndmask_b32_e64 v74, 0x80000000, v97, s0
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s4, v78, v92
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s5, v108, v78
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s27, v108, v130
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v131, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s29, v108, v131
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s5, v132, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s30, v108, v132
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s31, v133, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s34, v108, v133
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[85:88], v101
	ds_load_b128 v[81:84], v76
	ds_load_b128 v[122:125], v76 offset:2048
	ds_load_b128 v[126:129], v101 offset:2048
	.loc	1 818 13                        ; attention.py:818:13
	...
	.loc	1 890 30                        ; attention.py:890:30
	v_add_nc_u32_e32 v121, 0, v94
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v97, s60, v97
	.loc	1 890 30                        ; attention.py:890:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 866 30                        ; attention.py:866:30
	...
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s35, v108, v78
	.loc	1 859 30 is_stmt 1              ; attention.py:859:30
	v_wmma_f32_16x16x16_bf16 v[138:145], v[65:72], v[33:40], v[138:145]
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v68, s59, v133
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s6, v77, v92
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s7, v108, v77
	.loc	1 860 21 is_stmt 1              ; attention.py:860:21
	v_mul_f32_e32 v72, s59, v137
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s8, v79, v92
	.loc	1 866 21 is_stmt 0              ; attention.py:866:21
	v_cmp_ge_i32_e64 s9, v108, v79
	.loc	1 860 21 is_stmt 1              ; attention.py:860:21
	v_dual_mul_f32 v65, s59, v130 :: v_dual_mul_f32 v66, s59, v131
	v_dual_mul_f32 v69, s59, v134 :: v_dual_mul_f32 v70, s59, v135
	v_mul_f32_e32 v76, s59, v139
	...
	s_and_b32 s11, s17, s16
	s_and_b32 s13, s19, s18
	s_and_b32 s14, s21, s20
	s_and_b32 s15, s23, s22
	s_and_b32 s16, s25, s24
	s_and_b32 s17, s27, s26
	s_and_b32 s18, s29, s28
	s_and_b32 s19, s30, s5
	s_and_b32 s20, s34, s31
	s_and_b32 s12, s2, s6
	s_and_b32 s5, s2, s7
	s_and_b32 s6, s2, s8
	s_and_b32 s7, s2, s9
	...
	s_and_b32 s11, s2, s14
	s_and_b32 s13, s2, s15
	s_and_b32 s14, s2, s16
...
.Ltmp13:
	.loc	1 886 62                        ; attention.py:886:62
	v_dual_sub_f32 v75, v75, v122 :: v_dual_add_f32 v130, v126, v128
...
.Ltmp23:
	...
	v_dual_mul_f32 v10, v10, v123 :: v_dual_and_b32 v133, 1, v133
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp25:
	...
	v_cndmask_b16 v131.l, 0x7fff, v74.h, s18
	...
	v_cndmask_b16 v69.h, 0x7fff, v70.h, s9
	v_and_b32_e32 v70, 1, v80
	...
	v_cndmask_b16 v71.l, 0x7fff, v75.h, s12
	v_cndmask_b16 v126.l, 0x7fff, v76.h, s14
	v_perm_b32 v73, v74, v66, v0
	v_perm_b32 v74, v74, v66, v95
	v_perm_b32 v75, v68, v65, v0
	v_permlanex16_b32 v66, v67, s61, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v76, v68, v65, v95
	...
	v_perm_b32 v70, v70, v130, v95
	v_perm_b32 v71, v72, v131, v0
	v_perm_b32 v72, v72, v131, v95
	.loc	1 890 30                        ; attention.py:890:30
...
.LBB0_3:                                ; %._crit_edge
	...
	v_div_scale_f32 v48, s4, v28, v77, v28
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v39, s5, v29, v77, v29
	...
	v_div_scale_f32 v43, s4, v31, v77, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v49, s6, v32, v77, v32
	...
	v_div_scale_f32 v44, s4, v18, v77, v18
	v_fma_f32 v36, -v46, v38, v47
	v_div_scale_f32 v46, s5, v19, v77, v19
	...
	v_div_scale_f32 v44, s4, v21, v77, v21
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fma_f32 v36, -v43, v37, v46
	v_div_scale_f32 v43, s6, v22, v77, v22
	...
	s_mov_b32 vcc_lo, s6
	v_div_scale_f32 v43, s4, v24, v77, v24
	v_rcp_f32_e32 v44, v41
	...
	v_div_scale_f32 v36, s5, v9, v77, v9
	...
	v_div_scale_f32 v48, s6, v11, v77, v11
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	v_div_scale_f32 v39, s4, v12, v77, v12
	...
	v_div_scale_f32 v38, s5, v14, v77, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v36, s4, v16, v77, v16
	v_mul_f32_e32 v42, v38, v45
	v_div_scale_f32 v51, s5, v1, v77, v1
	...
	v_div_scale_f32 v52, s6, v2, v77, v2
	...
	v_div_scale_f32 v51, s5, v7, v77, v7
	...
	v_div_scale_f32 v53, s6, v8, v77, v8
	...
	v_div_scale_f32 v48, s4, v6, v77, v6
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 149
