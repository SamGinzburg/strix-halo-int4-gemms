...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v73, v62, 7, v5
	.loc	1 760 21                        ; attention.py:760:21
	v_lshlrev_b32_e32 v67, 2, v2
	v_bfe_i32 v54, v0, 2, 1
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, s34, v1
	v_lshl_or_b32 v81, s3, 8, v8
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v7, v4, 6, v73
	.loc	1 760 21                        ; attention.py:760:21
	...
	v_dual_mov_b32 v104, 0 :: v_dual_add_nc_u32 v79, v1, v67
	v_lshlrev_b32_e32 v1, 3, v62
	v_xor_b32_e32 v9, 32, v73
	s_load_b128 s[4:7], s[0:1], 0x8
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s0, 0x200, v3
	v_xor_b32_e32 v14, 0x60, v73
	v_lshl_or_b32 v1, v49, 5, v1
	...
	v_dual_mov_b32 v105, 0xff800000 :: v_dual_lshlrev_b32 v2, 5, v2
	...
	v_add_nc_u32_e32 v101, v5, v55
	v_dual_mov_b32 v5, v49 :: v_dual_add_nc_u32 v102, v6, v0
	v_mov_b32_e32 v6, v49
	v_or3_b32 v78, v13, v53, v16
	v_mov_b32_e32 v8, v49
	v_or3_b32 v80, v2, v50, v3
	s_lshr_b32 s1, s1, 29
	.loc	1 945 31                        ; attention.py:945:31
	s_mul_f32 s40, s8, 0x3fb8aa3b
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s1, s3, s1
	v_xor_b32_e32 v10, 48, v73
	.loc	1 756 22                        ; attention.py:756:22
	s_and_b32 s8, s1, -8
	v_xor_b32_e32 v12, 0x50, v73
	v_xor_b32_e32 v13, 0x108, v77
	v_xor_b32_e32 v2, 4, v78
	...
	v_add_nc_u32_e32 v98, v53, v1
	v_dual_mov_b32 v10, v49 :: v_dual_add_nc_u32 v103, 0, v54
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v53, s40, v53 :: v_dual_add_nc_u32 v108, 0, v78
	.loc	1 962 25                        ; attention.py:962:25
...
.Ltmp9:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
	v_dual_max_f32 v0, v52, v52 :: v_dual_sub_f32 v109, v109, v126
...
.Ltmp38:
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v12, v12, v127 :: v_dual_and_b32 v113, 1, v122
	.loc	1 1017 30                       ; attention.py:1017:30
	v_cmp_o_f32_e64 s3, v112, v112
	v_add3_u32 v112, v112, v114, 0x7fff
	v_and_b32_e32 v114, 1, v123
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v14, v14, v127 :: v_dual_and_b32 v119, 1, v124
	.loc	1 1017 30                       ; attention.py:1017:30
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_vgpr, 140
