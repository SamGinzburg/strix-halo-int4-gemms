...
.Ltmp11:
	...
	v_mad_u64_u32 v[9:10], null, s19, v34, v[1:2]
	s_waitcnt lgkmcnt(0)
...
.Ltmp15:
	...
	v_or_b32_e32 v1, s6, v35
	v_or_b32_e32 v4, s6, v34
	v_or_b32_e32 v5, s6, v36
.Ltmp16:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_lshr_b32 s4, s4, 26
.Ltmp17:
...
.Ltmp19:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v27, v4, s[8:11], 0 offen
...
.LBB0_3:                                ; %Flow73
	...
	v_or_b32_e32 v18, s25, v32
	s_ashr_i32 s1, s24, 6
	v_or_b32_e32 v26, s18, v2
	v_or_b32_e32 v25, s18, v6
	v_or_b32_e32 v24, s18, v7
	v_mul_lo_u32 v27, v18, s1
	v_or_b32_e32 v22, s18, v8
	v_or_b32_e32 v20, s18, v10
	v_or_b32_e32 v23, s18, v3
	v_or_b32_e32 v21, s18, v4
	v_or_b32_e32 v19, s18, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v41, s33, v35
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_lshr_b32 s40, s40, 26
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v42, s33, v39
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_add_i32 s0, s0, s40
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_or_b32_e32 v42, s33, v34
	v_or_b32_e32 v41, s33, v36
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v43, s41, v9
	v_add_nc_u32_e32 v44, s41, v37
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v41, 0x80000000, v43, s0
	...
	s_mov_b32 s34, s36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s0, v28
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v45, s34, v38, v32
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v60, v57, v60 :: v_dual_lshlrev_b32 v65, 16, v98
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v16, v60, v43 :: v_dual_mul_f32 v61, v57, v61
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v62, v57, v62 :: v_dual_lshlrev_b32 v59, 16, v92
	v_mul_f32_e32 v65, v57, v65
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v13, v63, v46 :: v_dual_add_nc_u32 v140, s35, v33
	v_dual_fmac_f32 v14, v62, v45 :: v_dual_mul_f32 v59, v57, v59
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v57, v57, v64
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v10, v58, v41 :: v_dual_add_nc_u32 v139, s40, v40
	v_fmac_f32_e32 v11, v65, v48
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v17, v59, v42 :: v_dual_fmac_f32 v12, v57, v47
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.8:
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v7, s36, v40
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v49, s14, v28
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s14, v31
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 141
