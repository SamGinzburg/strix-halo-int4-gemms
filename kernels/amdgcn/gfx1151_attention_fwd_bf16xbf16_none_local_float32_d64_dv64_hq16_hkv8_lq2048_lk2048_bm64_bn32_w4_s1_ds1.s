...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v77, s9, v5
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v24, v25 :: v_dual_lshlrev_b32 v13, 3, v0
	.loc	1 758 19                        ; attention.py:758:19
	...
	v_dual_mov_b32 v27, v25 :: v_dual_and_b32 v14, 48, v67
	...
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v14, 0x210, v15
	...
	v_lshl_or_b32 v80, v66, 9, v4
	v_xor_b32_e32 v20, 0x430, v82
	v_xor_b32_e32 v17, 48, v82
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v22, v25 :: v_dual_and_b32 v5, 0x760076, v5
	...
	v_and_b32_e32 v79, 0x5040504, v1
	...
	v_and_b32_e32 v81, 0x7060706, v5
	...
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v87, 0, v6
	v_lshl_add_u32 v85, v14, 1, v3
	v_mov_b32_e32 v14, v25
	v_mul_lo_u32 v1, s35, v1
	v_add_nc_u32_e32 v88, 0, v7
	v_add_nc_u32_e32 v89, 0, v8
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v90, 0, v9
	v_dual_mov_b32 v9, v25 :: v_dual_add_nc_u32 v92, 0, v11
	v_dual_mov_b32 v8, v25 :: v_dual_add_nc_u32 v93, 0, v12
	v_add_nc_u32_e32 v18, s35, v1
	v_lshl_add_u32 v84, v1, 1, v3
	v_dual_mov_b32 v11, v25 :: v_dual_add_nc_u32 v94, 0, v4
	v_dual_mov_b32 v104, 0xff800000 :: v_dual_add_nc_u32 v95, 0, v5
	v_add_nc_u32_e32 v96, 0, v13
	v_mov_b32_e32 v13, v25
	v_add_nc_u32_e32 v97, 0, v15
	v_dual_mov_b32 v15, v25 :: v_dual_add_nc_u32 v98, 0, v16
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v100, 0, v19
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v102, 0, v21
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 140
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 62
