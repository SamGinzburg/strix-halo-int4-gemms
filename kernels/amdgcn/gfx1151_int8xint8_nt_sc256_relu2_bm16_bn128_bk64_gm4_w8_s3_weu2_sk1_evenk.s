	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	buffer_load_b32 v33, v8, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	buffer_load_b128 v[21:24], v6, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v34, v7, s[4:7], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[25:28], v8, s[16:19], 0 offen
	buffer_load_b128 v[29:32], v10, s[16:19], 0 offen
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v10, v33 offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v37, v[17:20]
	s_waitcnt vmcnt(3)
	ds_store_b128 v37, v[21:24] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v10, v34 offset:17408
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v37, v[25:28] offset:8192
	s_waitcnt vmcnt(0)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s36, s14, s29
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v40, v26, s14, 1
	...
	s_mov_b32 s10, s31
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v40, s14, v27
	v_add_nc_u32_e32 v41, s14, v30
	s_mov_b32 s31, s15
	v_add_nc_u32_e32 v42, s14, v28
	v_add_nc_u32_e32 v43, s14, v29
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v44, s31, v32
	v_add_nc_u32_e32 v45, s31, v34
	v_add_nc_u32_e32 v46, s31, v31
	...
	s_waitcnt lgkmcnt(0)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cselect_b32 s34, s14, 0
	s_add_i32 s11, s11, -1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_lshl_b32 s31, s34, 10
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v16, v62, v45 :: v_dual_mul_f32 v59, v56, v59
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v56, v56, v64
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v15, v61, v44 :: v_dual_add_nc_u32 v98, s36, v35
	v_dual_fmac_f32 v12, v58, v41 :: v_dual_add_nc_u32 v99, s33, v36
	v_fmac_f32_e32 v9, v57, v40
	v_dual_fmac_f32 v13, v59, v42 :: v_dual_fmac_f32 v14, v60, v43
...
; %bb.9:
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v37, 0 :: v_dual_add_nc_u32 v2, s15, v34
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v6, s15, v32
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v7, s10, v30
	v_add_nc_u32_e32 v8, s10, v27
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v40, v37 :: v_dual_add_nc_u32 v35, s15, v33
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v43, v37 :: v_dual_add_nc_u32 v6, s15, v31
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 100
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
