...
; %bb.11:
	...
	v_dual_mov_b32 v125, v52 :: v_dual_mov_b32 v52, v49
	v_mov_b32_e32 v49, v47
	v_dual_mov_b32 v47, v46 :: v_dual_mov_b32 v46, v152
	v_dual_mov_b32 v153, v141 :: v_dual_mov_b32 v152, v140
	...
	v_dual_mov_b32 v46, v47 :: v_dual_mov_b32 v47, v49
	v_dual_mov_b32 v49, v52 :: v_dual_mov_b32 v52, v125
...
.Ltmp25:
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v93, v93, v52, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v115, v145, v78
	...
	v_cndmask_b32_e64 v143, v78, v52, s3
...
.Ltmp27:
	...
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v119, v9, v45 :: v_dual_lshlrev_b32 v20, 16, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v142, v79, v49, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	ds_store_b32 v98, v1 offset:40960
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v49, v112, v132, v65
	v_fma_f32 v72, v133, v160, v57
	v_fma_f32 v76, v137, v76, v53
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_cndmask_b32_e64 v108, v67, v110, s3
	v_cndmask_b32_e64 v110, v65, v49, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v56, v56, v73, s3
	v_cndmask_b32_e64 v55, v55, v74, s3
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v5, v5, v45 :: v_dual_mul_f32 v98, v14, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v71, v119, v165, v58
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v125, v14, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v22, v138, v251, v51
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v65, v13, v18
	v_mul_f32_e32 v85, v13, v20
	v_mul_f32_e32 v124, v13, v24
	v_mul_f32_e32 v13, v13, v25
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v22, v51, v22, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v51, v5, v244, v33
	v_fma_f32 v65, v65, v177, v41
	...
	v_dual_mul_f32 v51, v6, v18 :: v_dual_mul_f32 v78, v7, v20
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v83, v11, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v152, v171, v70
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v80, v9, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v113, v131, v64
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v82, v10, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v67, v115, v123, v62
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v46, v70, v107, s3
	v_cndmask_b32_e64 v107, v68, v109, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v68, v116, v128, v61
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v64, v64, v52, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v4, v0, v32
	v_fma_f32 v70, v118, v126, v59
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v84, v12, v20
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v61, v61, v68, s3
	v_cndmask_b32_e64 v68, v58, v71, s3
	v_cndmask_b32_e64 v71, v57, v72, s3
	v_cndmask_b32_e64 v72, v53, v76, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v53, v3, v242, v31
	v_fma_f32 v57, v2, v162, v30
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v99 offset:40960
	v_mul_f32_e32 v99, v15, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v111, v156, v190, v66
	v_fma_f32 v69, v117, v127, v60
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v30, v30, v57, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v116, v5, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v77, v139, v77, v50
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v109, v66, v111, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v123, v12, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v75, v136, v161, v54
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v62, v62, v67, s3
	v_cndmask_b32_e64 v67, v60, v69, s3
	v_cndmask_b32_e64 v59, v59, v70, s3
	v_cndmask_b32_e64 v50, v50, v77, s3
	v_cndmask_b32_e64 v54, v54, v75, s3
	v_cndmask_b32_e64 v32, v32, v52, s3
	v_cndmask_b32_e64 v31, v31, v53, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v52, v7, v18
	v_mul_f32_e32 v53, v8, v18
	v_mul_f32_e32 v57, v9, v18
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v29, v1, v18
	v_dual_mul_f32 v36, v2, v18 :: v_dual_mul_f32 v115, v4, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v66, v114, v130, v63
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v44, v3, v18
	v_mul_f32_e32 v48, v4, v18
	v_mul_f32_e32 v58, v10, v18
	v_mul_f32_e32 v60, v11, v18
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v111, v63, v66, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v63, v12, v18
	v_mul_f32_e32 v66, v14, v18
	v_mul_f32_e32 v69, v15, v18
	v_mul_f32_e32 v18, v16, v18
	v_mul_f32_e32 v70, v1, v20
	v_mul_f32_e32 v73, v2, v20
	v_mul_f32_e32 v74, v3, v20
	v_mul_f32_e32 v75, v4, v20
	v_mul_f32_e32 v76, v5, v20
	v_mul_f32_e32 v77, v6, v20
	v_mul_f32_e32 v79, v8, v20
	...
	v_mul_f32_e32 v122, v11, v24
	v_mul_f32_e32 v126, v15, v24
	...
	v_fma_f32 v49, v51, v169, v34
	v_fma_f32 v58, v58, v174, v38
	v_fma_f32 v60, v60, v175, v39
	v_fma_f32 v63, v63, v176, v40
	v_fma_f32 v66, v66, v178, v42
	v_fma_f32 v69, v69, v179, v43
	v_fma_f32 v100, v70, v181, v21
	v_fma_f32 v101, v73, v182, v50
	v_fma_f32 v133, v84, v193, v61
	v_fma_f32 v134, v85, v194, v62
	...
	v_fma_f32 v127, v74, v183, v22
	v_fma_f32 v75, v75, v184, v72
	v_fma_f32 v76, v76, v185, v54
	v_fma_f32 v77, v77, v186, v55
	v_fma_f32 v129, v79, v188, v71
	v_fma_f32 v130, v80, v189, v68
	v_fma_f32 v131, v82, v191, v59
	v_fma_f32 v132, v83, v192, v67
	v_fma_f32 v98, v98, v195, v111
	v_fma_f32 v99, v99, v196, v64
	v_fma_f32 v112, v112, v198, v109
	v_fma_f32 v113, v113, v199, v108
	...
	v_cndmask_b32_e64 v73, v21, v100, s2
	v_cndmask_b32_e64 v74, v50, v101, s2
...
.Ltmp29:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v51, v52, v170, v35
	v_fma_f32 v53, v53, v172, v28
	v_fma_f32 v57, v57, v173, v37
	v_fma_f32 v128, v78, v187, v56
	v_fma_f32 v20, v20, v197, v110
	...
	v_cndmask_b32_e64 v79, v72, v75, s2
	v_cndmask_b32_e64 v80, v54, v76, s2
	v_cndmask_b32_e64 v77, v55, v77, s2
	v_cndmask_b32_e64 v76, v71, v129, s2
	v_cndmask_b32_e64 v71, v68, v130, s2
	v_cndmask_b32_e64 v72, v59, v131, s2
	v_cndmask_b32_e64 v67, v67, v132, s2
	v_cndmask_b32_e64 v68, v61, v133, s2
	v_cndmask_b32_e64 v61, v62, v134, s2
	v_cndmask_b32_e64 v62, v111, v98, s2
	v_cndmask_b32_e64 v59, v64, v99, s2
	v_cndmask_b32_e64 v54, v109, v112, s2
	v_cndmask_b32_e64 v55, v108, v113, s2
...
.Ltmp31:
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v52, v35, v51, s2
	v_cndmask_b32_e64 v53, v28, v53, s2
	v_cndmask_b32_e64 v57, v37, v57, s2
	v_cndmask_b32_e64 v78, v22, v127, s2
	v_cndmask_b32_e64 v75, v56, v128, s2
	v_cndmask_b32_e64 v56, v110, v20, s2
...
.Ltmp33:
	...
	v_fma_f32 v135, v14, v228, v90
	v_fma_f32 v136, v15, v229, v27
	v_fma_f32 v137, v16, v230, v26
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v50, v107, v114, s2
...
.Ltmp35:
	...
	v_cndmask_b32_e64 v11, v90, v135, s2
	v_cndmask_b32_e64 v12, v27, v136, s2
.Ltmp36:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp37:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v13, v26, v137, s2
.Ltmp38:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 84
