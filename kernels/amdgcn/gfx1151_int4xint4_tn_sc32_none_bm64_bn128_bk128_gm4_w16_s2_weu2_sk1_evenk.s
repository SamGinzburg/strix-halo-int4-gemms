	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow168
	...
	v_or_b32_e32 v26, v4, v30
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v27, 0x70, v25
	v_bfe_u32 v28, v0, 4, 1
	v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v14, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v29, 0, v26
...
; %bb.4:                                ; %.lr.ph
	...
	v_subrev_nc_u32_e32 v35, s15, v3
	s_mov_b32 s15, s12
	v_mul_lo_u32 v3, s22, v7
	v_dual_mov_b32 v23, 0 :: v_dual_add_nc_u32 v40, v5, v27
	v_add3_u32 v2, v6, s14, v2
	s_mov_b32 s14, s12
	v_dual_mov_b32 v20, 0 :: v_dual_mov_b32 v13, 0
	v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v15, 0
	s_delay_alu instid0(VALU_DEP_3)
	v_subrev_nc_u32_e32 v38, s13, v2
	s_mov_b32 s13, s12
	...
	v_mov_b32_e32 v19, 0
	v_dual_mov_b32 v24, 0 :: v_dual_lshlrev_b32 v37, 1, v4
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v22, 0
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v36, 1, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 168 18                        ; generate_amdgcn.py:168:18
	s_clause 0x1
	buffer_load_u16 v41, v37, s[40:43], 0 offen
	buffer_load_u16 v42, v36, s[40:43], 0 offen
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e32 vcc_lo, s1, v33
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	.loc	1 187 26                        ; generate_amdgcn.py:187:26
	v_cndmask_b32_e32 v41, 0x80000000, v39, vcc_lo
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v39, s22, v39
	.loc	1 187 26                        ; generate_amdgcn.py:187:26
	buffer_load_u16 v65, v41, s[4:7], 0 offen
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	...
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	buffer_load_b32 v66, v41, s[24:27], 0 offen
	...
	v_dual_mul_f32 v50, v64, v50 :: v_dual_add_nc_u32 v57, v34, v35
	v_mul_f32_e32 v42, v63, v42
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v58, v57, s[36:39], 0 offen
	buffer_load_u16 v59, v57, s[36:39], 0 offen offset:4
	buffer_load_u16 v60, v57, s[36:39], 0 offen offset:8
	buffer_load_u16 v61, v57, s[36:39], 0 offen offset:12
	buffer_load_u16 v62, v57, s[36:39], 0 offen offset:16
	buffer_load_u16 v67, v57, s[36:39], 0 offen offset:20
	buffer_load_u16 v68, v57, s[36:39], 0 offen offset:24
	buffer_load_u16 v57, v57, s[36:39], 0 offen offset:28
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	v_dual_mul_f32 v45, v63, v45 :: v_dual_mul_f32 v52, v64, v52
	v_mul_f32_e32 v46, v63, v46
	v_mul_f32_e32 v47, v63, v47
	v_dual_mul_f32 v48, v63, v48 :: v_dual_mul_f32 v49, v64, v49
	...
	s_barrier
	s_waitcnt vmcnt(9)
	ds_store_b16 v31, v65 offset:2048
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(8)
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v51, v64, v51 :: v_dual_fmac_f32 v10, v41, v58
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v63, 16, v67
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v53, v64, v53 :: v_dual_lshlrev_b32 v62, 16, v62
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v24, v49, v58 :: v_dual_lshlrev_b32 v57, 16, v57
	v_dual_fmac_f32 v20, v44, v61 :: v_dual_lshlrev_b32 v67, 16, v68
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_fmac_f32 v23, v42, v59 :: v_dual_fmac_f32 v12, v48, v57
	v_dual_fmac_f32 v21, v43, v60 :: v_dual_fmac_f32 v22, v50, v59
	v_dual_fmac_f32 v17, v45, v62 :: v_dual_fmac_f32 v18, v52, v61
	v_fmac_f32_e32 v16, v46, v63
	v_fmac_f32_e32 v13, v47, v67
	v_dual_fmac_f32 v19, v51, v60 :: v_dual_fmac_f32 v14, v54, v63
	v_fmac_f32_e32 v15, v53, v62
	v_fmac_f32_e32 v11, v55, v67
	v_fmac_f32_e32 v9, v56, v57
	.loc	1 161 9 is_stmt 1               ; generate_amdgcn.py:161:9
	s_cbranch_scc1 .LBB0_5
.LBB0_6:                                ; %._crit_edge
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_or_b32_e32 v1, 32, v26
	...
	s_clause 0x1
	buffer_load_u16 v32, v2, s[28:31], 0 offen
	buffer_load_u16 v33, v3, s[28:31], 0 offen
...
; %bb.7:
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	v_add3_u32 v6, 0, v30, v27
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v2, v29 offset:2368
	ds_load_u8 v3, v29 offset:2304
	ds_load_u8 v4, v29 offset:2496
	ds_load_u8 v5, v29 offset:2432
	ds_load_u8 v7, v29 offset:2112
	ds_load_u8 v8, v29 offset:2048
	ds_load_u8 v30, v29 offset:2240
	ds_load_u8 v31, v29 offset:2176
	ds_load_u8 v34, v6 offset:640
	ds_load_u8 v35, v6 offset:768
	ds_load_u8 v36, v6 offset:512
	ds_load_u8 v37, v6 offset:896
	ds_load_u8 v38, v6 offset:128
	ds_load_u8 v39, v6 offset:384
	ds_load_u8 v40, v6 offset:256
	ds_load_u8 v41, v6
	ds_load_u8 v54, v29 offset:2528
	ds_load_u8 v55, v29 offset:2464
	ds_load_u8 v56, v29 offset:2400
	ds_load_u8 v57, v29 offset:2336
	ds_load_u8 v58, v29 offset:2272
	ds_load_u8 v59, v29 offset:2208
	ds_load_u8 v60, v29 offset:2144
	ds_load_u8 v61, v29 offset:2080
	...
	v_perm_b32 v7, v36, v34, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v8, v35, v37, 0xc0c0004
	v_lshl_or_b32 v2, v5, 16, v4
	ds_load_u8 v31, v29 offset:3008
	ds_load_u8 v34, v29 offset:2944
	s_mov_b32 s16, s12
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v4, v41, v38, 0xc0c0004
	v_lshl_or_b32 v5, v8, 16, v7
	ds_load_u8 v8, v29 offset:2880
	ds_load_u8 v30, v29 offset:2816
	v_perm_b32 v7, v40, v39, 0xc0c0004
	s_mov_b32 s17, s12
	s_mov_b32 s18, s12
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v45, s19 :: v_dual_mov_b32 v44, s18
	v_lshl_or_b32 v4, v7, 16, v4
	ds_load_u8 v7, v29 offset:2624
	ds_load_u8 v35, v29 offset:2560
	ds_load_u8 v36, v29 offset:2752
	ds_load_u8 v37, v29 offset:2688
	ds_load_u8 v62, v6 offset:1664
	ds_load_u8 v63, v6 offset:1920
	ds_load_u8 v64, v6 offset:1792
	ds_load_u8 v65, v6 offset:1536
	ds_load_u8 v66, v29 offset:3040
	ds_load_u8 v67, v29 offset:2976
	ds_load_u8 v68, v29 offset:2912
	ds_load_u8 v69, v29 offset:2848
	...
	ds_load_u8 v34, v29 offset:2784
	ds_load_u8 v72, v29 offset:2720
	ds_load_u8 v73, v29 offset:2656
	ds_load_u8 v74, v29 offset:2592
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v7, v35, v7, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v29, v37, v36, 0xc0c0004
	v_perm_b32 v8, v30, v8, 0xc0c0004
	ds_load_u8 v30, v6 offset:1152
	ds_load_u8 v70, v6 offset:1408
	ds_load_u8 v71, v6 offset:1280
	ds_load_u8 v6, v6 offset:1024
	v_wmma_i32_16x16x16_iu4 v[46:53], v[4:5], v[2:3], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v2, v29, 16, v7
	v_lshl_or_b32 v3, v31, 16, v8
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v7, v65, v62, 0xc0c0004
	v_perm_b32 v8, v64, v63, 0xc0c0004
	v_perm_b32 v29, v57, v56, 0xc0c0004
	v_perm_b32 v31, v55, v54, 0xc0c0004
	v_perm_b32 v35, v61, v60, 0xc0c0004
	v_perm_b32 v36, v59, v58, 0xc0c0004
	v_lshl_or_b32 v7, v8, 16, v7
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v34, v72, v34, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v8, v71, v70, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v6, v6, v30, 0xc0c0004
	v_lshl_or_b32 v30, v31, 16, v29
	v_lshl_or_b32 v29, v36, 16, v35
	v_perm_b32 v31, v69, v68, 0xc0c0004
	v_perm_b32 v35, v67, v66, 0xc0c0004
	v_perm_b32 v36, v74, v73, 0xc0c0004
	v_lshl_or_b32 v6, v8, 16, v6
	v_wmma_i32_16x16x16_iu4 v[38:45], v[4:5], v[29:30], v[38:45] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v5, v35, 16, v31
	v_lshl_or_b32 v4, v34, 16, v36
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[46:53], v[6:7], v[2:3], v[46:53] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[38:45], v[6:7], v[4:5], v[38:45] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	v_dual_mul_f32 v40, v40, v46 :: v_dual_add_nc_u32 v29, 4, v27
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_dual_mov_b32 v33, 0x5410 :: v_dual_add_nc_u32 v30, 8, v27
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v39, v39, v46 :: v_dual_add_nc_u32 v44, 20, v27
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	v_add_lshl_u32 v25, v25, v1, 1
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v5, v5, v32
	v_dual_mul_f32 v41, v41, v46 :: v_dual_mul_f32 v4, v4, v32
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v50.h, v46.l
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v37, v37, v46 :: v_dual_mul_f32 v6, v6, v32
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_fma_f32 v2, v2, v28, v10
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(6)
	v_lshlrev_b32_e32 v1, 16, v29
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v28, v35, v28, v24
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v2, v10, v2, s2
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v10, v24, v28, s2
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v30, 16, v30
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v3, v3, v1, v23
	v_fma_f32 v1, v39, v1, v22
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v7, v7, v32, v16
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v8, v8, v23, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v6, v6, v35, v17
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_cndmask_b16 v3.l, 0x7fff, v4.h, s3
	v_add3_u32 v4, v19, v17, 0x7fff
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v31, v31, v27, v12
	v_fma_f32 v30, v34, v35, v15
	v_fma_f32 v27, v38, v27, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_cndmask_b16 v8.h, 0x7fff, v12.h, s12
	v_cndmask_b32_e32 v12, 0x3276, v47, vcc_lo
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v5, v5, v29, v20
	v_fma_f32 v29, v36, v32, v14
	v_fma_f32 v32, v37, v42, v11
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_cndmask_b16 v3.h, 0x7fff, v5.h, s4
	v_add3_u32 v5, v18, v16, 0x7fff
	v_dual_cndmask_b32 v6, v8, v3 :: v_dual_and_b32 v13, 1, v49
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_cndmask_b32_e32 v5, 0x1054, v33, vcc_lo
	v_add3_u32 v7, v15, v21, 0x7fff
	...
	v_cndmask_b16 v7.h, 0x7fff, v9.h, s13
	...
	v_cndmask_b32_e32 v10, v7, v0, vcc_lo
	v_dual_cndmask_b32 v0, v0, v7 :: v_dual_and_b32 v7, 0x5040504, v5
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_perm_b32 v0, v2, v4, v7
	v_perm_b32 v1, v2, v4, v9
	v_perm_b32 v2, v3, v6, v7
	v_perm_b32 v3, v3, v6, v9
	v_perm_b32 v4, v5, v8, v7
	v_perm_b32 v5, v5, v8, v9
	v_perm_b32 v6, v11, v10, v7
	v_perm_b32 v7, v11, v10, v9
	s_clause 0x1
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 75
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.kd
