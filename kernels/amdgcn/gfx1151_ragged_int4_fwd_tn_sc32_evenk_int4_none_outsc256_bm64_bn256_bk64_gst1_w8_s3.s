...
.LBB0_3:                                ; %Flow436
	...
	v_dual_mov_b32 v31, 0 :: v_dual_and_b32 v26, 0xf0, v0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v58, 0 :: v_dual_lshlrev_b32 v7, 5, v0
	v_dual_mov_b32 v59, 0 :: v_dual_lshlrev_b32 v8, 2, v26
	v_dual_mov_b32 v48, 0 :: v_dual_lshlrev_b32 v13, 1, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v42, 0 :: v_dual_and_b32 v7, 32, v7
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e32 vcc_lo, s[38:39], v[1:2]
	v_dual_mov_b32 v32, 0 :: v_dual_and_b32 v13, 28, v13
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_add3_u32 v7, 0, v8, v7
	.loc	1 1046 48                       ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s3, s[36:37], v[1:2]
	v_dual_mov_b32 v76, 0 :: v_dual_add_nc_u32 v1, s34, v25
	.loc	1 1044 18 is_stmt 1             ; ragged.py:1044:18
	v_mov_b32_e32 v73, 0
	v_dual_mov_b32 v52, 0 :: v_dual_add_nc_u32 v109, v7, v13
	s_waitcnt lgkmcnt(0)
	...
	v_mul_lo_u32 v94, v2, s40
	v_mul_lo_u32 v95, v3, s40
	v_mul_lo_u32 v96, v4, s40
	...
	v_dual_mov_b32 v43, 0 :: v_dual_lshlrev_b32 v8, 1, v26
	.loc	1 1135 19                       ; ragged.py:1135:19
	...
	s_mov_b32 s10, s4
	s_mov_b32 s11, s4
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v103, 0, v1
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v104, 0, v2
	v_dual_mov_b32 v36, 0 :: v_dual_add_nc_u32 v105, 0, v3
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v106, 0, v4
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v107, 0, v5
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v108, v97, v6
	v_dual_mov_b32 v51, 0 :: v_dual_add_nc_u32 v110, 0, v8
	v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s4
	.loc	1 1131 28                       ; ragged.py:1131:28
	v_or_b32_e32 v90, 4, v89
	v_or_b32_e32 v91, 8, v89
	v_or_b32_e32 v92, 12, v89
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v98, s33, v11
	.loc	1 1135 19                       ; ragged.py:1135:19
	v_lshl_add_u32 v99, s33, 1, v11
	v_lshl_add_u32 v100, s33, 2, v11
	v_lshl_add_u32 v101, s33, 3, v11
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v102, 0, v0
	...
	v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v3, s6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s5, s4, 4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_or_b32_e32 v111, s5, v89
	v_or_b32_e32 v113, s5, v90
	v_or_b32_e32 v114, s5, v91
	v_or_b32_e32 v115, s5, v92
	s_mul_i32 s6, s5, s33
	...
	s_clause 0xf
	buffer_load_u8 v159, v116, s[24:27], 0 offen
	buffer_load_u8 v160, v117, s[24:27], 0 offen
	buffer_load_u8 v161, v118, s[24:27], 0 offen
	buffer_load_u8 v162, v119, s[24:27], 0 offen
	buffer_load_u8 v163, v120, s[24:27], 0 offen
	buffer_load_u8 v164, v121, s[24:27], 0 offen
	buffer_load_u8 v165, v122, s[24:27], 0 offen
	buffer_load_u8 v166, v123, s[24:27], 0 offen
	buffer_load_u8 v167, v124, s[24:27], 0 offen
	buffer_load_u8 v168, v125, s[24:27], 0 offen
	buffer_load_u8 v169, v126, s[24:27], 0 offen
	buffer_load_u8 v170, v127, s[24:27], 0 offen
	buffer_load_u8 v171, v128, s[24:27], 0 offen
	buffer_load_u8 v172, v129, s[24:27], 0 offen
	buffer_load_u8 v173, v130, s[24:27], 0 offen
	buffer_load_u8 v174, v131, s[24:27], 0 offen
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_waitcnt vmcnt(3)
	ds_store_b8 v102, v111
	s_waitcnt vmcnt(2)
	ds_store_b8 v102, v112 offset:256
	s_waitcnt vmcnt(1)
	ds_store_b8 v102, v113 offset:512
	s_waitcnt vmcnt(0)
	ds_store_b8 v103, v114
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	ds_load_u8 v175, v97 offset:320
	ds_load_u8 v176, v97 offset:256
	ds_load_u8 v136, v97 offset:336
	ds_load_u8 v138, v97 offset:272
	ds_load_u8 v121, v97 offset:352
	ds_load_u8 v122, v97 offset:288
	ds_load_u8 v111, v97 offset:368
	ds_load_u8 v112, v97 offset:304
	ds_load_u8 v177, v97 offset:448
	ds_load_u8 v178, v97 offset:384
	ds_load_u8 v139, v97 offset:464
	ds_load_u8 v140, v97 offset:400
	ds_load_u8 v124, v97 offset:480
	ds_load_u8 v126, v97 offset:416
	ds_load_u8 v113, v97 offset:496
	ds_load_u8 v114, v97 offset:432
	ds_load_u8 v179, v97 offset:64
	ds_load_u8 v180, v97
	ds_load_u8 v145, v97 offset:80
	ds_load_u8 v127, v97 offset:96
	ds_load_u8 v115, v97 offset:112
	ds_load_u8 v146, v97 offset:16
	ds_load_u8 v130, v97 offset:32
	ds_load_u8 v116, v97 offset:48
	ds_load_u8 v181, v97 offset:192
	ds_load_u8 v182, v97 offset:128
	ds_load_u8 v149, v97 offset:208
	ds_load_u8 v150, v97 offset:144
	ds_load_u8 v133, v97 offset:224
	ds_load_u8 v134, v97 offset:160
	ds_load_u8 v117, v97 offset:240
	ds_load_u8 v118, v97 offset:176
	ds_load_u8 v183, v97 offset:960
	ds_load_u8 v184, v97 offset:896
	ds_load_u8 v151, v97 offset:976
	ds_load_u8 v152, v97 offset:912
	ds_load_u8 v135, v97 offset:992
	ds_load_u8 v137, v97 offset:928
	ds_load_u8 v119, v104
	ds_load_u8 v120, v97 offset:944
	ds_load_u8 v185, v97 offset:832
	ds_load_u8 v186, v97 offset:768
	ds_load_u8 v153, v97 offset:848
	ds_load_u8 v154, v97 offset:784
	ds_load_u8 v141, v97 offset:864
	ds_load_u8 v142, v97 offset:800
	ds_load_u8 v123, v97 offset:880
	ds_load_u8 v125, v97 offset:816
	ds_load_u8 v187, v97 offset:704
	ds_load_u8 v188, v97 offset:640
	ds_load_u8 v155, v97 offset:720
	ds_load_u8 v156, v97 offset:656
	ds_load_u8 v143, v97 offset:736
	ds_load_u8 v144, v97 offset:672
	ds_load_u8 v128, v97 offset:752
	ds_load_u8 v129, v97 offset:688
	ds_load_u8 v189, v97 offset:576
	ds_load_u8 v190, v97 offset:512
	ds_load_u8 v157, v97 offset:592
	ds_load_u8 v158, v97 offset:528
	ds_load_u8 v147, v97 offset:608
	ds_load_u8 v148, v97 offset:544
	ds_load_u8 v131, v97 offset:624
	ds_load_u8 v132, v97 offset:560
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v102, v159
	ds_store_b8 v102, v160 offset:256
	ds_store_b8 v102, v161 offset:512
	ds_store_b8 v102, v163 offset:1024
	ds_store_b8 v102, v164 offset:1280
	ds_store_b8 v102, v165 offset:1536
	ds_store_b8 v102, v167 offset:2048
	ds_store_b8 v102, v168 offset:2304
	ds_store_b8 v102, v169 offset:2560
	ds_store_b8 v102, v171 offset:3072
	ds_store_b8 v102, v172 offset:3328
	ds_store_b8 v103, v162
	ds_store_b8 v105, v166
	ds_store_b8 v106, v170
	ds_store_b8 v102, v173 offset:3584
	ds_store_b8 v107, v174
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 1161 31                       ; ragged.py:1161:31
	ds_load_u8 v159, v108 offset:1280
	ds_load_u8 v160, v108 offset:1024
	ds_load_u8 v162, v108 offset:1792
	ds_load_u8 v164, v108 offset:1536
	v_perm_b32 v161, v176, v175, 0xc0c0004
	v_perm_b32 v163, v178, v177, 0xc0c0004
	ds_load_u8 v175, v108 offset:1920
	ds_load_u8 v176, v108 offset:1664
	v_perm_b32 v165, v180, v179, 0xc0c0004
	v_perm_b32 v166, v182, v181, 0xc0c0004
	v_lshl_or_b32 v168, v163, 16, v161
	ds_load_u8 v177, v108 offset:1408
	ds_load_u8 v178, v108 offset:1152
	...
	v_perm_b32 v145, v150, v149, 0xc0c0004
	...
	ds_load_u8 v160, v108 offset:256
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v161, v164, v162, 0xc0c0004
	ds_load_u8 v162, v108
	ds_load_u8 v179, v108 offset:896
	ds_load_u8 v180, v108 offset:640
	ds_load_u8 v181, v108 offset:384
	ds_load_u8 v182, v108 offset:128
	v_lshl_or_b32 v139, v138, 16, v136
	v_lshl_or_b32 v138, v145, 16, v140
	v_lshl_or_b32 v146, v149, 16, v146
	v_lshl_or_b32 v170, v161, 16, v159
	v_perm_b32 v159, v186, v185, 0xc0c0004
	v_perm_b32 v161, v190, v189, 0xc0c0004
	v_lshl_or_b32 v145, v151, 16, v150
	v_perm_b32 v121, v122, v121, 0xc0c0004
	v_perm_b32 v122, v126, v124, 0xc0c0004
	v_perm_b32 v124, v130, v127, 0xc0c0004
	v_perm_b32 v126, v134, v133, 0xc0c0004
	v_perm_b32 v127, v142, v141, 0xc0c0004
	v_perm_b32 v130, v137, v135, 0xc0c0004
	v_perm_b32 v133, v148, v147, 0xc0c0004
	v_perm_b32 v134, v144, v143, 0xc0c0004
	v_lshl_or_b32 v122, v122, 16, v121
	ds_load_u8 v164, v108 offset:3072
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v160, v162, v160, 0xc0c0004
	ds_load_u8 v162, v108 offset:768
	ds_load_u8 v163, v108 offset:512
	v_lshl_or_b32 v121, v126, 16, v124
	v_lshl_or_b32 v127, v130, 16, v127
	v_lshl_or_b32 v126, v134, 16, v133
	...
	v_perm_b32 v117, v125, v123, 0xc0c0004
	...
	v_lshl_or_b32 v169, v162, 16, v160
	v_perm_b32 v160, v184, v183, 0xc0c0004
	ds_load_u8 v162, v108 offset:3328
	v_lshl_or_b32 v171, v163, 16, v161
	ds_load_u8 v183, v108 offset:3968
	ds_load_u8 v184, v108 offset:3712
	ds_load_u8 v185, v108 offset:3456
	ds_load_u8 v186, v108 offset:3200
	v_wmma_i32_16x16x16_iu4 v[149:156], v[169:170], v[138:139], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v172, v160, 16, v159
	ds_load_u8 v160, v108 offset:3840
	ds_load_u8 v161, v108 offset:3584
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v159, v164, v162, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v160, v161, v160, 0xc0c0004
	ds_load_u8 v161, v108 offset:2304
	ds_load_u8 v162, v108 offset:2048
	ds_load_u8 v187, v108 offset:2944
	ds_load_u8 v188, v108 offset:2688
	ds_load_u8 v189, v108 offset:2432
	ds_load_u8 v190, v108 offset:2176
	v_lshl_or_b32 v174, v160, 16, v159
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v161, v162, v161, 0xc0c0004
	ds_load_u8 v162, v108 offset:2816
	ds_load_u8 v163, v108 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v162, v163, v162, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v173, v162, 16, v161
	v_wmma_i32_16x16x16_iu4 v[159:166], v[169:170], v[167:168], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[149:156], v[173:174], v[145:146], v[149:156] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[159:166], v[173:174], v[171:172], v[159:166] neg_lo:[1,1,0]
	...
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_lshl_or_b32 v176, v160, 16, v159
	v_perm_b32 v159, v186, v185, 0xc0c0004
	v_lshl_or_b32 v175, v162, 16, v161
	v_perm_b32 v160, v184, v183, 0xc0c0004
	v_perm_b32 v161, v190, v189, 0xc0c0004
	v_perm_b32 v162, v188, v187, 0xc0c0004
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v197, v165
	v_cvt_f32_i32_e32 v198, v166
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_lshl_or_b32 v178, v160, 16, v159
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v158, v150
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_lshl_or_b32 v177, v162, 16, v161
	v_wmma_i32_16x16x16_iu4 v[159:166], v[175:176], v[167:168], v[1:8] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[159:166], v[177:178], v[171:172], v[159:166] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v171, v153
	v_cvt_f32_i32_e32 v172, v154
	v_cvt_f32_i32_e32 v180, v156
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[149:156], v[175:176], v[138:139], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[133:140], v[169:170], v[121:122], v[1:8] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v159, v159
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[149:156], v[177:178], v[145:146], v[149:156] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v164, v164
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[133:140], v[173:174], v[126:127], v[133:140] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[133:140], v[175:176], v[121:122], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v121, v116, 16, v115
	v_lshl_or_b32 v122, v118, 16, v117
	v_wmma_i32_16x16x16_iu4 v[111:118], v[169:170], v[119:120], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[133:140], v[177:178], v[126:127], v[133:140] neg_lo:[1,1,0]
	.loc	1 1213 40                       ; ragged.py:1213:40
	v_add_lshl_u32 v155, v10, s5, 1
	.loc	1 1201 27                       ; ragged.py:1201:27
	v_cvt_f32_i32_e32 v160, v160
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[111:118], v[173:174], v[121:122], v[111:118] neg_lo:[1,1,0]
	.loc	1 1201 27                       ; ragged.py:1201:27
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[111:118], v[177:178], v[121:122], v[111:118] neg_lo:[1,1,0]
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v121, s4, v95, 1
	v_add_lshl_u32 v122, s4, v96, 1
	...
	.loc	1 1213 40                       ; ragged.py:1213:40
	buffer_load_u16 v155, v155, s[12:15], 0 offen
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_clause 0x3
	...
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_store_b32 v109, v155
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v155, v119, v191
	v_mul_f32_e32 v156, v119, v192
	v_mul_f32_e32 v169, v119, v193
	v_mul_f32_e32 v170, v119, v194
	v_mul_f32_e32 v173, v119, v195
	v_mul_f32_e32 v174, v119, v196
	v_mul_f32_e32 v175, v119, v197
	v_mul_f32_e32 v176, v119, v198
	v_mul_f32_e32 v159, v159, v119
	v_mul_f32_e32 v160, v119, v160
	v_mul_f32_e32 v161, v119, v161
	v_mul_f32_e32 v162, v119, v162
	v_mul_f32_e32 v164, v164, v119
	v_mul_f32_e32 v165, v165, v119
	v_mul_f32_e32 v166, v166, v119
	v_mul_f32_e32 v163, v119, v163
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(2)
	...
	v_mul_f32_e32 v157, v119, v158
	v_mul_f32_e32 v158, v119, v167
	v_dual_mul_f32 v167, v119, v168 :: v_dual_mul_f32 v146, v146, v119
	v_mul_f32_e32 v168, v119, v171
	v_dual_mul_f32 v171, v119, v172 :: v_dual_mul_f32 v154, v154, v119
	v_mul_f32_e32 v172, v119, v179
	v_mul_f32_e32 v177, v119, v180
	v_dual_mul_f32 v145, v145, v119 :: v_dual_mul_f32 v152, v119, v152
	v_mul_f32_e32 v150, v119, v150
	v_mul_f32_e32 v151, v119, v151
	v_mul_f32_e32 v149, v149, v119
	v_mul_f32_e32 v153, v119, v153
	.loc	1 1204 40                       ; ragged.py:1204:40
	s_waitcnt vmcnt(1)
	...
	v_dual_mul_f32 v124, v119, v130 :: v_dual_mul_f32 v123, v121, v123
	v_dual_mul_f32 v130, v119, v141 :: v_dual_mul_f32 v131, v121, v131
	v_dual_mul_f32 v141, v119, v142 :: v_dual_mul_f32 v182, v116, v121
	v_mul_f32_e32 v128, v121, v128
	v_dual_mul_f32 v129, v121, v129 :: v_dual_mul_f32 v142, v119, v143
	v_dual_mul_f32 v143, v119, v144 :: v_dual_mul_f32 v184, v118, v121
	v_dual_mul_f32 v144, v119, v147 :: v_dual_mul_f32 v179, v121, v112
	v_dual_mul_f32 v136, v119, v136 :: v_dual_mul_f32 v181, v121, v114
	v_dual_mul_f32 v178, v111, v121 :: v_dual_mul_f32 v133, v133, v119
	v_mul_f32_e32 v180, v121, v113
	v_mul_f32_e32 v183, v117, v121
	v_mul_f32_e32 v185, v121, v115
	.loc	1 1216 21                       ; ragged.py:1216:21
	...
	v_mul_f32_e32 v132, v121, v132
	v_dual_mul_f32 v139, v121, v139 :: v_dual_mul_f32 v134, v119, v134
	v_mul_f32_e32 v140, v121, v140
	v_mul_f32_e32 v148, v126, v119
	v_mul_f32_e32 v135, v119, v135
	v_mul_f32_e32 v127, v127, v119
	v_dual_mul_f32 v138, v138, v119 :: v_dual_mul_f32 v137, v119, v137
	.loc	1 1226 17                       ; ragged.py:1226:17
	s_waitcnt lgkmcnt(1)
	v_fmac_f32_e32 v72, v120, v111
	v_dual_fmac_f32 v87, v156, v112 :: v_dual_fmac_f32 v56, v122, v111
	v_dual_fmac_f32 v85, v170, v114 :: v_dual_fmac_f32 v40, v123, v111
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v55, v124, v112 :: v_dual_fmac_f32 v52, v142, v115
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_load_b128 v[119:122], v110 offset:512
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v39, v125, v112 :: v_dual_fmac_f32 v66, v172, v117
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_load_b128 v[123:126], v110 offset:528
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v88, v155, v111
	v_fmac_f32_e32 v86, v169, v113
	v_dual_fmac_f32 v71, v157, v112 :: v_dual_fmac_f32 v82, v175, v117
	v_dual_fmac_f32 v70, v158, v113 :: v_dual_fmac_f32 v69, v167, v114
	v_fmac_f32_e32 v84, v173, v115
	v_dual_fmac_f32 v54, v130, v113 :: v_dual_fmac_f32 v53, v141, v114
	v_fmac_f32_e32 v68, v168, v115
	v_dual_fmac_f32 v38, v128, v113 :: v_dual_fmac_f32 v37, v129, v114
	v_dual_fmac_f32 v50, v144, v117 :: v_dual_fmac_f32 v83, v174, v116
	v_dual_fmac_f32 v36, v131, v115 :: v_dual_fmac_f32 v81, v176, v118
	v_fmac_f32_e32 v34, v139, v117
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v67, v171, v116 :: v_dual_fmac_f32 v78, v162, v122
	v_dual_fmac_f32 v65, v177, v118 :: v_dual_fmac_f32 v80, v160, v120
	v_dual_fmac_f32 v51, v143, v116 :: v_dual_fmac_f32 v64, v145, v119
	v_dual_fmac_f32 v49, v147, v118 :: v_dual_fmac_f32 v48, v148, v119
	v_dual_fmac_f32 v35, v132, v116 :: v_dual_fmac_f32 v62, v151, v121
	v_dual_fmac_f32 v33, v140, v118 :: v_dual_fmac_f32 v46, v135, v121
	v_dual_fmac_f32 v73, v159, v119 :: v_dual_fmac_f32 v30, v180, v121
	v_dual_fmac_f32 v79, v161, v121 :: v_dual_fmac_f32 v32, v178, v119
	v_dual_fmac_f32 v63, v150, v120 :: v_dual_fmac_f32 v24, v181, v122
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v61, v152, v122 :: v_dual_fmac_f32 v60, v153, v123
	v_dual_fmac_f32 v47, v134, v120 :: v_dual_fmac_f32 v58, v149, v125
	v_dual_fmac_f32 v45, v136, v122 :: v_dual_fmac_f32 v44, v137, v123
	v_dual_fmac_f32 v31, v179, v120 :: v_dual_fmac_f32 v74, v166, v126
	v_dual_fmac_f32 v77, v163, v123 :: v_dual_fmac_f32 v76, v164, v124
	v_fmac_f32_e32 v75, v165, v125
	v_dual_fmac_f32 v59, v146, v124 :: v_dual_fmac_f32 v42, v133, v125
	v_dual_fmac_f32 v57, v154, v126 :: v_dual_fmac_f32 v12, v185, v123
	v_fmac_f32_e32 v43, v127, v124
	v_dual_fmac_f32 v41, v138, v126 :: v_dual_fmac_f32 v28, v183, v125
	v_fmac_f32_e32 v29, v182, v124
	v_fmac_f32_e32 v27, v184, v126
	.loc	1 1135 19                       ; ragged.py:1135:19
...
.Ltmp3:
	...
	v_max_f32_e64 v1, |v87|, |v87|
	v_max_f32_e64 v2, |v88|, |v88|
	v_max3_f32 v4, |v85|, |v84|, |v83|
	v_max3_f32 v5, |v80|, |v79|, |v78|
	v_max3_f32 v6, |v77|, |v76|, |v75|
	v_max_f32_e64 v7, |v72|, |v72|
	v_max_f32_e32 v1, v2, v1
	v_max_f32_e64 v2, |v71|, |v71|
	v_max3_f32 v10, |v63|, |v62|, |v61|
	v_max3_f32 v5, v5, v6, |v74|
	v_max_f32_e64 v6, |v56|, |v56|
	v_max3_f32 v11, |v60|, |v59|, |v58|
	v_max_f32_e32 v2, v7, v2
	v_max3_f32 v1, v1, |v86|, v4
	v_max_f32_e64 v4, |v55|, |v55|
	v_max3_f32 v7, |v69|, |v68|, |v67|
	v_max3_f32 v13, |v47|, |v46|, |v45|
	v_max3_f32 v14, |v44|, |v43|, |v42|
	v_max3_f32 v8, |v82|, |v81|, |v73|
	v_max3_f32 v9, |v66|, |v65|, |v64|
	v_max3_f32 v2, v2, |v70|, v7
	v_max3_f32 v7, v10, v11, |v57|
	v_max_f32_e64 v11, |v39|, |v39|
	v_max_f32_e32 v4, v6, v4
	v_max3_f32 v6, |v53|, |v52|, |v51|
	v_max3_f32 v10, |v50|, |v49|, |v48|
	v_max3_f32 v1, v1, v8, v5
	v_max3_f32 v2, v2, v9, v7
	v_max3_f32 v8, |v31|, |v30|, |v24|
	v_max3_f32 v4, v4, |v54|, v6
	v_max3_f32 v6, v13, v14, |v41|
	v_max_f32_e64 v13, |v40|, |v40|
	v_max3_f32 v9, |v12|, |v29|, |v28|
	s_mov_b32 s0, 0x76543210
	v_max3_f32 v7, |v34|, |v33|, |v32|
	v_max3_f32 v4, v4, v10, v6
	v_max_f32_e32 v5, v13, v11
	v_max3_f32 v6, |v37|, |v36|, |v35|
	v_max3_f32 v8, v8, v9, |v27|
.Ltmp4:
...
.Ltmp9:
	...
	v_dual_max_f32 v14, v2, v9 :: v_dual_max_f32 v15, v4, v10
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp10:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_lshl_add_u32 v4, v11, 9, 0
.Ltmp11:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v13, v1, v6 :: v_dual_and_b32 v8, 0x60, v0
.Ltmp12:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp13:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v1, v1, v1 :: v_dual_and_b32 v10, 8, v0
.Ltmp14:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp16:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_xor_b32_e32 v19, v16, v8
.Ltmp17:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max_f32_e32 v16, v5, v1
.Ltmp18:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_add3_u32 v1, v4, v7, v17
	s_mov_b32 s15, 0x31027000
	s_mov_b32 s14, 0x7ffffffe
	v_add3_u32 v4, v20, v18, v19
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_dual_mov_b32 v1, v13 :: v_dual_mov_b32 v4, v14
	v_dual_mov_b32 v5, v15 :: v_dual_max_f32 v14, v14, v14
...
.Ltmp21:
	...
	v_dual_max_f32 v5, v5, v5 :: v_dual_max_f32 v4, v14, v4
...
.Ltmp24:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_dual_mov_b32 v16, v4 :: v_dual_max_f32 v13, v17, v14
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_mov_b32_dpp v16, v16 row_xmask:2 row_mask:0xf bank_mask:0xf
	v_mov_b32_e32 v14, v5
.Ltmp25:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v16, v16, v16 :: v_dual_mov_b32 v15, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp26:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp28:
	...
	v_dual_mov_b32 v17, v13 :: v_dual_max_f32 v14, v14, v14
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
...
.Ltmp32:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_dual_mov_b32 v17, v4 :: v_dual_mov_b32 v16, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
.Ltmp33:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max_f32_e32 v18, v13, v15
.Ltmp34:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp39:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_dual_max_f32 v14, v4, v14 :: v_dual_max_f32 v13, v1, v13
	v_max_f32_e32 v1, v15, v15
	v_dual_max_f32 v4, v19, v19 :: v_dual_max_f32 v15, v5, v1
.Ltmp40:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
...
.Ltmp41:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ ragged.py:1237:20 ] ]
	v_max_f32_e32 v16, v18, v4
.Ltmp42:
	.loc	2 191 16                        ; standard.py:191:16 @[ ragged.py:1237:20 ]
	v_add3_u32 v4, v9, v17, v10
.Ltmp43:
	.loc	1 1044 32                       ; ragged.py:1044:32
...
.Ltmp45:
	...
	v_dual_max_f32 v1, v13, v13 :: v_dual_max_f32 v10, v15, v15
	v_max_f32_e32 v20, v14, v14
	.loc	1 1044 32                       ; ragged.py:1044:32
	v_or_b32_e32 v13, 16, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_dual_max_f32 v4, 0x2b8cbccc, v1 :: v_dual_max_f32 v15, 0x2b8cbccc, v10
	.loc	1 1044 32                       ; ragged.py:1044:32
	v_or_b32_e32 v1, 48, v5
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_max_f32_e32 v20, 0x2b8cbccc, v20
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_div_scale_f32 v11, null, 0x40e00000, 0x40e00000, v4
	...
	v_fma_f32 v23, -v11, v22, v18
	v_div_scale_f32 v16, null, 0x40e00000, 0x40e00000, v20
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s3, s[38:39], v[9:10]
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s4, s[36:37], v[9:10]
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_cmp_le_i64_e64 s5, s[38:39], v[13:14]
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s6, s[36:37], v[13:14]
	.loc	1 1238 24 is_stmt 1             ; ragged.py:1238:24
	v_fma_f32 v1, -v11, v22, v18
	v_rcp_f32_e32 v11, v16
	v_div_scale_f32 v18, null, 0x40e00000, 0x40e00000, v23
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	v_div_scale_f32 v9, s8, v20, 0x40e00000, v20
	v_fma_f32 v89, -v18, v22, 1.0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v90, v9, v11
	v_div_scale_f32 v19, null, 0x40e00000, 0x40e00000, v15
	v_fmac_f32_e32 v22, v89, v22
	v_div_scale_f32 v89, s9, v23, 0x40e00000, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_rcp_f32_e32 v21, v19
	v_fma_f32 v13, -v16, v90, v9
	v_mul_f32_e32 v14, v89, v22
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v90, v13, v11
	v_fma_f32 v13, -v18, v14, v89
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v2, -v19, v21, 1.0
	v_fma_f32 v9, -v16, v90, v9
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v14, v13, v22 :: v_dual_fmac_f32 v21, v2, v21
	v_div_scale_f32 v2, s7, v15, 0x40e00000, v15
	s_mov_b32 vcc_lo, s7
	v_fma_f32 v16, -v18, v14, v89
	v_mul_f32_e32 v17, v2, v21
	v_fma_f32 v4, -v19, v17, v2
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v17, v4, v21
	.loc	1 1238 23 is_stmt 0             ; ragged.py:1238:23
	v_mov_b16_e32 v4.l, v1.h
	v_mov_b16_e32 v4.h, v10.h
	.loc	1 1238 24                       ; ragged.py:1238:24
	...
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_div_fmas_f32 v17, v2, v21, v17
	s_mov_b32 vcc_lo, s8
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_add3_u32 v4, v1, v4, 0x7fff
	.loc	1 1238 24                       ; ragged.py:1238:24
	v_div_fmas_f32 v9, v9, v11, v90
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v15, v17, 0x40e00000, v15
	v_div_fmas_f32 v14, v16, v22, v14
	...
	v_div_scale_f32 v13, null, v91, v91, v88
	v_div_scale_f32 v16, null, v91, v91, v87
	.loc	1 1044 18                       ; ragged.py:1044:18
	...
	.loc	1 1238 24 is_stmt 1             ; ragged.py:1238:24
	v_div_fixup_f32 v14, v14, 0x40e00000, v23
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v23, s9, v87, v91, v87
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_add3_u32 v1, v15, v17, 0x7fff
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_scale_f32 v94, null, v91, v91, v84
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_dual_fmac_f32 v11, v18, v11 :: v_dual_fmac_f32 v20, v17, v20
	v_div_scale_f32 v18, vcc_lo, v88, v91, v88
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_and_b32_e32 v2, 1, v19
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_dual_mul_f32 v15, v18, v11 :: v_dual_and_b32 v10, 1, v10
	.loc	1 1238 23                       ; ragged.py:1238:23
	v_add3_u32 v9, v9, v2, 0x7fff
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add3_u32 v2, v14, v10, 0x7fff
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v21, -v13, v15, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1240 39 is_stmt 0             ; ragged.py:1240:39
	v_and_b32_e32 v90, 0xffff0000, v9
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_dual_fmac_f32 v15, v21, v11 :: v_dual_and_b32 v10, 0xffff0000, v2
	v_mul_f32_e32 v21, v23, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v13, -v13, v15, v18
	v_fma_f32 v18, -v16, v21, v23
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v11, v13, v11, v15
	v_fmac_f32_e32 v21, v18, v20
	v_rcp_f32_e32 v18, v94
	s_mov_b32 vcc_lo, s9
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v13, -v16, v21, v23
	v_div_fmas_f32 v13, v13, v20, v21
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v96, -v94, v18, 1.0
	v_fmac_f32_e32 v18, v96, v18
	v_div_scale_f32 v19, null, v91, v91, v86
	v_div_scale_f32 v95, null, v91, v91, v83
	v_div_scale_f32 v22, null, v91, v91, v85
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v17, v19
	v_div_fixup_f32 v11, v11, v91, v88
	v_rcp_f32_e32 v88, v95
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(TRANS32_DEP_3)
	v_rcp_f32_e32 v14, v22
	v_div_scale_f32 v20, s9, v84, v91, v84
	v_div_fixup_f32 v13, v13, v91, v87
	v_div_scale_f32 v87, null, v91, v91, v82
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v11, v11
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v92, -v19, v17, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v13, v13
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v21, -v95, v88, 1.0
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v93, -v22, v14, 1.0
	v_dual_fmac_f32 v88, v21, v88 :: v_dual_fmac_f32 v17, v92, v17
	v_div_scale_f32 v92, s10, v86, v91, v86
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v14, v93, v14
	v_div_scale_f32 v93, s11, v85, v91, v85
	v_mul_f32_e32 v15, v92, v17
	s_mov_b32 vcc_lo, s10
	v_div_scale_f32 v21, s12, v83, v91, v83
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v23, v93, v14
	v_fma_f32 v16, -v19, v15, v92
	.loc	1 1240 39                       ; ragged.py:1240:39
	v_and_b32_e32 v89, 0xffff0000, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v15, v16, v17
	v_fma_f32 v16, -v22, v23, v93
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v19, -v19, v15, v92
	v_fmac_f32_e32 v23, v16, v14
	v_mul_f32_e32 v16, v20, v18
	v_mul_f32_e32 v92, v21, v88
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v15, v19, v17, v15
	v_fma_f32 v17, -v22, v23, v93
	v_rcp_f32_e32 v22, v87
	v_fma_f32 v19, -v94, v16, v20
	v_div_scale_f32 v93, null, v91, v91, v81
	s_mov_b32 vcc_lo, s11
	v_div_fmas_f32 v17, v17, v14, v23
	v_fmac_f32_e32 v16, v19, v18
	v_rcp_f32_e32 v19, v93
	v_fma_f32 v23, -v95, v92, v21
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v96, -v87, v22, 1.0
	v_div_fixup_f32 v14, v15, v91, v86
	v_div_fixup_f32 v15, v17, v91, v85
	v_fma_f32 v17, -v94, v16, v20
	v_fmac_f32_e32 v92, v23, v88
	v_fmac_f32_e32 v22, v96, v22
	v_div_scale_f32 v20, s10, v82, v91, v82
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v23, -v93, v19, 1.0
	v_div_fmas_f32 v16, v17, v18, v16
	v_fma_f32 v17, -v95, v92, v21
	v_mul_f32_e32 v18, v20, v22
	s_mov_b32 vcc_lo, s12
	v_div_scale_f32 v85, null, v91, v91, v73
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v17, v17, v88, v92
	v_fma_f32 v88, -v87, v18, v20
	v_fmac_f32_e32 v19, v23, v19
	v_div_scale_f32 v23, s9, v81, v91, v81
	v_rcp_f32_e32 v21, v85
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v18, v88, v22
	v_div_scale_f32 v86, null, v91, v91, v80
	v_mul_f32_e32 v92, v23, v19
	v_div_fixup_f32 v17, v17, v91, v83
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v20, -v87, v18, v20
	v_rcp_f32_e32 v95, v86
	s_mov_b32 vcc_lo, s10
	v_fma_f32 v83, -v93, v92, v23
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fma_f32 v94, -v85, v21, 1.0
	v_div_fmas_f32 v18, v20, v22, v18
	v_div_scale_f32 v96, null, v91, v91, v78
	v_fmac_f32_e32 v92, v83, v19
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v16, v16, v91, v84
	v_div_scale_f32 v84, s11, v73, v91, v73
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_fma_f32 v20, -v93, v92, v23
	v_div_scale_f32 v88, null, v91, v91, v79
	v_div_fixup_f32 v18, v18, v91, v82
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v14, v14
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v19, v20, v19, v92
	v_rcp_f32_e32 v92, v96
	v_fmac_f32_e32 v21, v94, v21
	v_fma_f32 v94, -v86, v95, 1.0
	v_rcp_f32_e32 v87, v88
	v_div_fixup_f32 v19, v19, v91, v81
	s_mov_b32 vcc_lo, s11
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v15, v15
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v95, v94, v95
	v_div_scale_f32 v94, s12, v80, v91, v80
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_mul_f32_e32 v23, v94, v95
	v_fma_f32 v93, -v88, v87, 1.0
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v18, v18
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v20, -v86, v23, v94
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v23, v20, v95
	v_fma_f32 v20, -v96, v92, 1.0
	v_fmac_f32_e32 v92, v20, v92
	v_mul_f32_e32 v83, v84, v21
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v22, -v85, v83, v84
	v_fmac_f32_e32 v83, v22, v21
	v_div_scale_f32 v22, s9, v79, v91, v79
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fma_f32 v81, -v85, v83, v84
	v_div_scale_f32 v84, null, v91, v91, v77
	v_div_fmas_f32 v21, v81, v21, v83
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v85, v84
	v_fma_f32 v81, -v86, v23, v94
	s_mov_b32 vcc_lo, s12
	v_div_scale_f32 v86, s10, v78, v91, v78
	v_div_fixup_f32 v20, v21, v91, v73
	v_div_fmas_f32 v23, v81, v95, v23
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v73, s11, v77, v91, v77
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v94, -v84, v85, 1.0
	v_div_fixup_f32 v21, v23, v91, v80
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_div_scale_f32 v94, null, v91, v91, v74
	v_mul_f32_e32 v82, v22, v87
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_fma_f32 v83, -v88, v82, v22
	v_dual_fmac_f32 v82, v83, v87 :: v_dual_mul_f32 v83, v86, v92
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v80, -v93, v81, 1.0
	v_fma_f32 v22, -v88, v82, v22
	v_div_scale_f32 v88, null, v91, v91, v75
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v23, -v96, v83, v86
	v_fmac_f32_e32 v81, v80, v81
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v22, v22, v87, v82
	v_rcp_f32_e32 v80, v88
	s_mov_b32 vcc_lo, s10
	v_fmac_f32_e32 v83, v23, v92
	v_div_scale_f32 v87, s9, v76, v91, v76
	v_div_fixup_f32 v22, v22, v91, v79
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_fma_f32 v23, -v96, v83, v86
	v_fma_f32 v96, -v88, v80, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v22, v22
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v23, v23, v92, v83
	v_div_scale_f32 v83, s10, v75, v91, v75
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v80, v96, v80
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v23, v23, v91, v78
	v_fma_f32 v92, -v94, v95, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v79, -v84, v82, v73
	v_fmac_f32_e32 v82, v79, v85
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fma_f32 v73, -v84, v82, v73
	v_div_scale_f32 v84, null, v90, v90, v72
	v_div_fmas_f32 v73, v73, v85, v82
	v_fma_f32 v85, -v88, v78, v83
	s_mov_b32 vcc_lo, s9
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v73, v73, v91, v77
	v_fmac_f32_e32 v78, v85, v80
	v_mul_f32_e32 v86, v87, v81
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v77, -v88, v78, v83
	v_fma_f32 v79, -v93, v86, v87
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fmac_f32_e32 v86, v79, v81
	v_div_scale_f32 v79, s12, v74, v91, v74
	v_fma_f32 v82, -v93, v86, v87
	v_div_scale_f32 v93, null, v90, v90, v71
	v_rcp_f32_e32 v87, v84
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v81, v82, v81, v86
	v_rcp_f32_e32 v82, v93
	s_mov_b32 vcc_lo, s10
	v_div_fmas_f32 v77, v77, v80, v78
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
	v_div_fixup_f32 v76, v81, v91, v76
	v_div_scale_f32 v81, s9, v72, v90, v72
	v_fma_f32 v86, -v84, v87, 1.0
	s_mov_b32 vcc_lo, s12
	v_div_fixup_f32 v75, v77, v91, v75
	...
	v_div_scale_f32 v83, s10, v71, v90, v71
	v_fmac_f32_e32 v87, v86, v87
	v_div_scale_f32 v86, null, v90, v90, v69
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v85, -v94, v92, v79
	v_fmac_f32_e32 v92, v85, v95
	v_div_scale_f32 v85, null, v90, v90, v70
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v78, -v94, v92, v79
	v_rcp_f32_e32 v80, v85
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v78, v78, v95, v92
	v_mul_f32_e32 v92, v83, v82
	s_mov_b32 vcc_lo, s9
	v_rcp_f32_e32 v95, v86
	v_div_fixup_f32 v74, v78, v91, v74
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_fma_f32 v94, -v85, v80, 1.0
	v_mul_f32_e32 v79, v81, v87
	v_fma_f32 v77, -v93, v92, v83
	v_div_scale_f32 v78, s11, v70, v90, v70
	v_fmac_f32_e32 v80, v94, v80
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v88, -v84, v79, v81
	v_fmac_f32_e32 v92, v77, v82
	v_div_scale_f32 v94, null, v90, v90, v67
	v_fma_f32 v91, -v86, v95, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v79, v88, v87
	v_div_scale_f32 v88, null, v90, v90, v68
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v74, v74
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v81, -v84, v79, v81
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v84, v88
	v_div_fmas_f32 v79, v81, v87, v79
	v_fma_f32 v81, -v93, v92, v83
	s_mov_b32 vcc_lo, s10
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v72, v79, v90, v72
	v_div_fmas_f32 v81, v81, v82, v92
	v_rcp_f32_e32 v82, v94
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v93, -v88, v84, 1.0
	v_div_scale_f32 v92, s9, v68, v90, v68
	v_div_fixup_f32 v71, v81, v90, v71
	s_mov_b32 vcc_lo, s11
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_dual_mul_f32 v79, v92, v84 :: v_dual_fmac_f32 v82, v81, v82
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v83, -v85, v77, v78
	v_fmac_f32_e32 v77, v83, v80
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_fma_f32 v78, -v85, v77, v78
	v_div_scale_f32 v85, s10, v67, v90, v67
	v_div_fmas_f32 v77, v78, v80, v77
	v_fma_f32 v80, -v88, v79, v92
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v70, v77, v90, v70
	v_fmac_f32_e32 v79, v80, v84
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v70, v70
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v77, -v88, v79, v92
	v_div_scale_f32 v88, s11, v66, v90, v66
	v_fmac_f32_e32 v95, v91, v95
	v_div_scale_f32 v91, s12, v69, v90, v69
	v_div_scale_f32 v92, null, v90, v90, v64
	s_mov_b32 vcc_lo, s12
	v_mul_f32_e32 v87, v91, v95
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v83, -v86, v87, v91
	v_fmac_f32_e32 v87, v83, v95
	v_div_scale_f32 v83, null, v90, v90, v66
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v78, -v86, v87, v91
	v_rcp_f32_e32 v81, v83
	v_div_scale_f32 v86, null, v90, v90, v65
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v78, v78, v95, v87
	s_mov_b32 vcc_lo, s9
	v_rcp_f32_e32 v80, v86
	v_div_fmas_f32 v77, v77, v84, v79
	v_rcp_f32_e32 v79, v92
	v_div_fixup_f32 v69, v78, v90, v69
	s_delay_alu instid0(TRANS32_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_fma_f32 v91, -v83, v81, 1.0
	v_div_scale_f32 v84, s9, v65, v90, v65
	v_div_fixup_f32 v68, v77, v90, v68
	s_mov_b32 vcc_lo, s10
	v_fmac_f32_e32 v81, v91, v81
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_fma_f32 v91, -v86, v80, 1.0
	v_mul_f32_e32 v87, v85, v82
	v_fma_f32 v95, -v92, v79, 1.0
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_div_scale_f32 v91, null, v90, v90, v63
	v_fmac_f32_e32 v79, v95, v79
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v93, v84, v80
	v_dual_fmac_f32 v87, v78, v82 :: v_dual_mul_f32 v78, v88, v81
	v_div_scale_f32 v95, null, v90, v90, v57
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v77, -v94, v87, v85
	v_rcp_f32_e32 v94, v91
	v_fma_f32 v85, -v83, v78, v88
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v77, v77, v82, v87
	v_fma_f32 v82, -v86, v93, v84
	v_fmac_f32_e32 v78, v85, v81
	v_div_scale_f32 v85, s10, v64, v90, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_div_fixup_f32 v67, v77, v90, v67
	v_fma_f32 v87, -v91, v94, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v77, -v83, v78, v88
	v_dual_fmac_f32 v93, v82, v80 :: v_dual_mul_f32 v82, v85, v79
	v_div_scale_f32 v83, s12, v63, v90, v63
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v94, v87, v94
	s_mov_b32 vcc_lo, s11
	v_div_scale_f32 v88, null, v90, v90, v61
	v_div_fmas_f32 v77, v77, v81, v78
	v_fma_f32 v78, -v86, v93, v84
	v_fma_f32 v81, -v92, v82, v85
	v_mul_f32_e32 v86, v83, v94
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v87, null, v90, v90, v62
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v82, v81, v79
	v_fma_f32 v81, -v91, v86, v83
	v_div_fmas_f32 v78, v78, v80, v93
	v_rcp_f32_e32 v80, v88
	v_div_fixup_f32 v66, v77, v90, v66
	v_fma_f32 v77, -v92, v82, v85
	v_fmac_f32_e32 v86, v81, v94
	s_mov_b32 vcc_lo, s10
	v_rcp_f32_e32 v84, v87
	v_div_scale_f32 v85, null, v90, v90, v60
	v_div_fmas_f32 v77, v77, v79, v82
	v_fma_f32 v79, -v91, v86, v83
	s_mov_b32 vcc_lo, s12
	v_fma_f32 v81, -v88, v80, 1.0
	v_div_fixup_f32 v65, v78, v90, v65
	v_div_scale_f32 v78, s9, v62, v90, v62
	v_div_fmas_f32 v79, v79, v94, v86
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fma_f32 v93, -v87, v84, 1.0
	v_div_scale_f32 v83, s10, v61, v90, v61
	v_div_fixup_f32 v64, v77, v90, v64
	v_div_fixup_f32 v63, v79, v90, v63
	v_div_scale_f32 v79, s11, v60, v90, v60
	v_fmac_f32_e32 v80, v81, v80
	v_rcp_f32_e32 v81, v85
	v_fmac_f32_e32 v84, v93, v84
	v_div_scale_f32 v91, null, v90, v90, v59
	s_mov_b32 vcc_lo, s9
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v66, v66
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_mul_f32_e32 v82, v78, v84
	v_rcp_f32_e32 v94, v91
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	s_delay_alu instid0(TRANS32_DEP_2)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v93, -v85, v81, 1.0
	v_mul_f32_e32 v92, v83, v80
	v_fma_f32 v86, -v87, v82, v78
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v63, v63
	v_rndne_f32_e32 v67, v67
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v81, v93, v81
	v_fma_f32 v77, -v88, v92, v83
	v_fma_f32 v93, -v91, v94, 1.0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v92, v77, v80 :: v_dual_mul_f32 v77, v79, v81
	v_fmac_f32_e32 v82, v86, v84
	v_div_scale_f32 v86, null, v90, v90, v58
	v_fma_f32 v78, -v87, v82, v78
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v87, v86
	v_div_fmas_f32 v78, v78, v84, v82
	v_fma_f32 v82, -v88, v92, v83
	v_fma_f32 v83, -v85, v77, v79
	s_mov_b32 vcc_lo, s10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_div_fixup_f32 v62, v78, v90, v62
	v_fma_f32 v88, -v86, v87, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v77, v83, v81
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v62, v62
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v87, v88, v87
	v_div_scale_f32 v88, s9, v58, v90, v58
	v_fmac_f32_e32 v94, v93, v94
	v_div_scale_f32 v93, s12, v59, v90, v59
	v_div_fmas_f32 v80, v82, v80, v92
	v_rcp_f32_e32 v82, v95
	v_fma_f32 v78, -v85, v77, v79
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v79, v88, v87 :: v_dual_mul_f32 v84, v93, v94
	v_div_fixup_f32 v61, v80, v90, v61
	s_mov_b32 vcc_lo, s11
	v_div_scale_f32 v85, s10, v57, v90, v57
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_fma_f32 v83, -v91, v84, v93
	v_div_fmas_f32 v77, v78, v81, v77
	v_fma_f32 v80, -v95, v82, 1.0
	v_fma_f32 v81, -v86, v79, v88
	s_mov_b32 vcc_lo, s12
	v_fmac_f32_e32 v84, v83, v94
	v_div_scale_f32 v83, null, v89, v89, v56
	v_fmac_f32_e32 v82, v80, v82
	v_div_fixup_f32 v60, v77, v90, v60
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v78, -v91, v84, v93
	v_rcp_f32_e32 v80, v83
	v_div_scale_f32 v91, null, v89, v89, v55
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v61, v61
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v78, v78, v94, v84
	s_mov_b32 vcc_lo, s9
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v60, v60
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fixup_f32 v59, v78, v90, v59
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fma_f32 v92, -v83, v80, 1.0
	...
	v_fma_f32 v77, -v86, v79, v88
	v_div_scale_f32 v92, null, v89, v89, v54
	v_div_scale_f32 v86, s11, v56, v89, v56
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_div_fmas_f32 v77, v77, v87, v79
	v_fma_f32 v88, -v91, v81, 1.0
	v_div_scale_f32 v87, s9, v55, v89, v55
	v_rcp_f32_e32 v79, v92
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v58, v77, v90, v58
	v_dual_fmac_f32 v81, v88, v81 :: v_dual_mul_f32 v84, v85, v82
	v_div_scale_f32 v88, null, v89, v89, v53
	s_mov_b32 vcc_lo, s10
	v_mul_f32_e32 v93, v87, v81
	v_fma_f32 v78, -v95, v84, v85
	v_rcp_f32_e32 v94, v88
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v58, v58
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v84, v78, v82
	v_mul_f32_e32 v78, v86, v80
	v_fma_f32 v77, -v95, v84, v85
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fma_f32 v85, -v83, v78, v86
	v_fma_f32 v95, -v92, v79, 1.0
	v_fmac_f32_e32 v79, v95, v79
	s_delay_alu instid0(VALU_DEP_4)
	v_div_fmas_f32 v77, v77, v82, v84
	v_fma_f32 v82, -v91, v93, v87
	v_fmac_f32_e32 v78, v85, v80
	v_fma_f32 v85, -v88, v94, 1.0
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v57, v77, v90, v57
	v_fmac_f32_e32 v93, v82, v81
	v_fma_f32 v77, -v83, v78, v86
	v_fmac_f32_e32 v94, v85, v94
	v_div_scale_f32 v83, s12, v53, v89, v53
	v_div_scale_f32 v84, s10, v54, v89, v54
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v77, v77, v80, v78
	v_fma_f32 v78, -v91, v93, v87
	v_mul_f32_e32 v87, v83, v94
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v90, null, v89, v89, v51
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v78, v78, v81, v93
	v_fma_f32 v81, -v88, v87, v83
	v_mul_f32_e32 v82, v84, v79
	v_div_fixup_f32 v56, v77, v89, v56
	s_mov_b32 vcc_lo, s10
	v_div_scale_f32 v85, null, v89, v89, v52
	v_fmac_f32_e32 v87, v81, v94
	v_fma_f32 v80, -v92, v82, v84
	v_div_fixup_f32 v55, v78, v89, v55
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v86, v85
	v_div_scale_f32 v78, s9, v52, v89, v52
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v77, -v92, v82, v84
	v_div_scale_f32 v84, null, v89, v89, v50
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v91, -v85, v86, 1.0
	v_div_fmas_f32 v77, v77, v79, v82
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v81, -v90, v80, 1.0
	v_fma_f32 v79, -v88, v87, v83
	v_div_scale_f32 v88, null, v89, v89, v49
	v_div_scale_f32 v83, s10, v51, v89, v51
	s_mov_b32 vcc_lo, s12
	v_rcp_f32_e32 v93, v88
	v_fmac_f32_e32 v80, v81, v80
	v_rcp_f32_e32 v81, v84
	v_div_fixup_f32 v54, v77, v89, v54
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_2)
	v_dual_fmac_f32 v86, v91, v86 :: v_dual_fmac_f32 v81, v92, v81
	...
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v94, null, v89, v89, v47
	v_fma_f32 v77, -v90, v91, v83
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v53, v79, v89, v53
	v_div_scale_f32 v79, s11, v50, v89, v50
	v_dual_mul_f32 v82, v78, v86 :: v_dual_fmac_f32 v91, v77, v80
	v_div_scale_f32 v92, s12, v49, v89, v49
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v87, null, v89, v89, v48
	v_fma_f32 v78, -v85, v82, v78
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_rcp_f32_e32 v85, v87
	v_div_fmas_f32 v78, v78, v86, v82
	v_fma_f32 v82, -v90, v91, v83
	s_mov_b32 vcc_lo, s10
	v_fma_f32 v83, -v84, v77, v79
	v_mul_f32_e32 v86, v92, v93
	v_div_fixup_f32 v52, v78, v89, v52
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fixup_f32 v51, v80, v89, v51
	v_fmac_f32_e32 v85, v90, v85
	v_div_scale_f32 v90, s9, v48, v89, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v51, v51
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v80, -v94, v82, 1.0
	v_fmac_f32_e32 v77, v83, v81
	v_fma_f32 v83, -v88, v86, v92
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v82, v80, v82
	v_fma_f32 v78, -v84, v77, v79
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v86, v83, v93
	v_div_scale_f32 v83, null, v89, v89, v46
	v_div_scale_f32 v84, s10, v47, v89, v47
	v_mul_f32_e32 v79, v90, v85
	v_div_fmas_f32 v77, v78, v81, v77
	...
	v_fma_f32 v81, -v87, v79, v90
	v_div_fixup_f32 v50, v77, v89, v50
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v49, v78, v89, v49
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v91, -v83, v80, 1.0
	v_fmac_f32_e32 v79, v81, v85
	v_rcp_f32_e32 v81, v88
	v_fma_f32 v78, -v94, v86, v84
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v50, v50
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fmac_f32_e32 v80, v91, v80
	v_fma_f32 v77, -v87, v79, v90
	v_div_scale_f32 v87, s11, v46, v89, v46
	v_fmac_f32_e32 v86, v78, v82
	v_div_scale_f32 v91, null, v89, v89, v44
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v90, -v88, v81, 1.0
	v_mul_f32_e32 v78, v87, v80
	v_div_fmas_f32 v77, v77, v85, v79
	v_div_scale_f32 v85, s9, v45, v89, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v81, v90, v81
	v_div_scale_f32 v90, null, v89, v89, v43
	v_rcp_f32_e32 v79, v91
	v_div_fixup_f32 v48, v77, v89, v48
	v_fma_f32 v77, -v94, v86, v84
	v_rcp_f32_e32 v93, v90
	v_fma_f32 v84, -v83, v78, v87
	v_mul_f32_e32 v92, v85, v81
	s_mov_b32 vcc_lo, s10
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v48, v48
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v77, v77, v82, v86
	s_mov_b32 vcc_lo, s11
	v_fma_f32 v82, -v88, v92, v85
	...
	v_div_fixup_f32 v47, v77, v89, v47
	v_fmac_f32_e32 v92, v82, v81
	v_fmac_f32_e32 v79, v94, v79
	v_fmac_f32_e32 v93, v86, v93
	v_fma_f32 v77, -v83, v78, v87
	v_div_scale_f32 v83, s12, v43, v89, v43
	v_div_scale_f32 v84, s10, v44, v89, v44
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v77, v77, v80, v78
	v_fma_f32 v78, -v88, v92, v85
	v_mul_f32_e32 v87, v83, v93
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v86, null, v89, v89, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v78, v78, v81, v92
	v_fma_f32 v81, -v90, v87, v83
	v_mul_f32_e32 v82, v84, v79
	v_div_fixup_f32 v46, v77, v89, v46
	s_mov_b32 vcc_lo, s10
	v_rcp_f32_e32 v85, v86
	v_fmac_f32_e32 v87, v81, v93
	v_fma_f32 v80, -v91, v82, v84
	v_div_scale_f32 v88, null, v89, v89, v41
	v_div_fixup_f32 v45, v78, v89, v45
	v_div_scale_f32 v78, s9, v42, v89, v42
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v82, v80, v79
	v_rcp_f32_e32 v80, v88
	s_delay_alu instid0(TRANS32_DEP_2)
	v_fma_f32 v92, -v86, v85, 1.0
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v47, v47
	v_rndne_f32_e32 v46, v46
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v77, -v91, v82, v84
	v_div_scale_f32 v91, null, v10, v10, v39
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v45, v45
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v77, v77, v79, v82
	v_fma_f32 v79, -v90, v87, v83
	s_mov_b32 vcc_lo, s12
	v_fma_f32 v81, -v88, v80, 1.0
	v_fmac_f32_e32 v85, v92, v85
	v_div_scale_f32 v83, s10, v41, v89, v41
	v_div_fmas_f32 v79, v79, v93, v87
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v80, v81, v80
	v_div_scale_f32 v81, null, v10, v10, v40
	v_div_fixup_f32 v44, v77, v89, v44
	v_div_fixup_f32 v43, v79, v89, v43
	v_rcp_f32_e32 v79, v91
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v84, v81
	v_mul_f32_e32 v90, v83, v80
	s_mov_b32 vcc_lo, s9
	v_div_scale_f32 v93, null, v10, v10, v37
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_fma_f32 v92, -v91, v79, 1.0
	v_mul_f32_e32 v82, v78, v85
	v_fmac_f32_e32 v90, v77, v80
	v_div_scale_f32 v77, s11, v40, v10, v40
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v86, null, v10, v10, v38
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v85, s9, v39, v10, v39
	s_mov_b32 vcc_lo, s10
	v_div_fixup_f32 v42, v78, v89, v42
	v_fma_f32 v92, -v81, v83, v77
	v_mul_f32_e32 v94, v85, v79
	...
	v_div_fixup_f32 v41, v80, v89, v41
	v_fmac_f32_e32 v87, v88, v87
	v_div_scale_f32 v88, s12, v38, v10, v38
	v_fma_f32 v77, -v81, v83, v77
	v_div_scale_f32 v81, null, v10, v10, v36
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v90, v88, v87
	v_fmac_f32_e32 v94, v82, v79
	v_fma_f32 v80, -v93, v95, 1.0
	v_div_fmas_f32 v77, v77, v84, v83
	s_mov_b32 vcc_lo, s9
	v_fma_f32 v78, -v86, v90, v88
	v_fma_f32 v82, -v91, v94, v85
	v_fmac_f32_e32 v95, v80, v95
	v_div_scale_f32 v80, s10, v37, v10, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v90, v78, v87
	v_rcp_f32_e32 v78, v81
	v_div_fmas_f32 v79, v82, v79, v94
	v_mul_f32_e32 v83, v80, v95
	s_mov_b32 vcc_lo, s12
	v_fma_f32 v82, -v86, v90, v88
	v_div_fixup_f32 v40, v77, v10, v40
	v_div_scale_f32 v84, null, v10, v10, v35
	v_div_fixup_f32 v39, v79, v10, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	...
	v_div_fixup_f32 v38, v82, v10, v38
	v_fmac_f32_e32 v78, v85, v78
	v_div_scale_f32 v85, s9, v36, v10, v36
	v_fmac_f32_e32 v83, v87, v95
	v_div_scale_f32 v82, null, v10, v10, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v87, null, v10, v10, v33
	v_div_fixup_f32 v37, v80, v10, v37
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v42, v42
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_fma_f32 v80, -v81, v77, v85
	...
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_div_fmas_f32 v77, v80, v78, v77
	v_fmac_f32_e32 v88, v85, v88
	v_div_scale_f32 v85, null, v10, v10, v31
	v_div_scale_f32 v78, null, v10, v10, v32
	v_div_scale_f32 v80, s9, v34, v10, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_rcp_f32_e32 v91, v85
	v_div_fixup_f32 v36, v77, v10, v36
	...
	v_div_scale_f32 v77, s10, v33, v10, v33
	v_fma_f32 v93, -v85, v91, 1.0
	v_fmac_f32_e32 v86, v79, v86
	v_div_scale_f32 v79, s11, v35, v10, v35
	s_mov_b32 vcc_lo, s11
	v_fmac_f32_e32 v91, v93, v91
	v_div_scale_f32 v92, s11, v32, v10, v32
	v_mul_f32_e32 v83, v79, v86
	v_div_scale_f32 v93, s12, v31, v10, v31
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v84, null, v10, v10, v24
	s_mov_b32 vcc_lo, s10
	v_fma_f32 v83, -v90, v94, 1.0
	v_div_fmas_f32 v77, v77, v89, v86
	v_rcp_f32_e32 v86, v84
	v_fma_f32 v80, -v85, v82, v93
	v_div_fixup_f32 v34, v79, v10, v34
	v_fmac_f32_e32 v94, v83, v94
	v_div_scale_f32 v83, s9, v30, v10, v30
	v_fma_f32 v78, -v78, v95, v92
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v33, v77, v10, v33
	v_div_scale_f32 v88, null, v10, v10, v27
	s_delay_alu instid0(TRANS32_DEP_1)
	v_fma_f32 v79, -v84, v86, 1.0
	...
	v_div_scale_f32 v79, null, v10, v10, v29
	v_div_fixup_f32 v32, v78, v10, v32
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v81, -v85, v82, v93
	v_fma_f32 v85, -v90, v80, v83
	v_div_scale_f32 v78, null, v10, v10, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v31, v81, v10, v31
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_2)
	v_fma_f32 v77, -v90, v80, v83
	v_rcp_f32_e32 v83, v79
	v_rcp_f32_e32 v90, v88
	v_div_scale_f32 v81, null, v10, v10, v28
	.loc	1 1240 13                       ; ragged.py:1240:13
	...
	v_div_scale_f32 v89, s10, v29, v10, v29
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v92, -v81, v85, 1.0
	v_mul_f32_e32 v95, v89, v83
	v_div_fmas_f32 v77, v77, v94, v80
	v_rcp_f32_e32 v80, v78
	v_div_scale_f32 v82, vcc_lo, v24, v10, v24
	v_fma_f32 v94, -v88, v90, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_div_fixup_f32 v30, v77, v10, v30
	v_fmac_f32_e32 v85, v92, v85
	v_mul_f32_e32 v87, v82, v86
	v_div_scale_f32 v92, s11, v28, v10, v28
	v_fmac_f32_e32 v90, v94, v90
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_fma_f32 v77, -v78, v80, 1.0
	v_div_scale_f32 v94, s12, v27, v10, v27
	v_fma_f32 v91, -v84, v87, v82
	.loc	1 1240 13                       ; ragged.py:1240:13
	v_rndne_f32_e32 v30, v30
	.loc	1 1240 33                       ; ragged.py:1240:33
	v_dual_fmac_f32 v80, v77, v80 :: v_dual_mul_f32 v97, v94, v90
	v_div_scale_f32 v77, s9, v12, v10, v12
	...
	s_mov_b32 vcc_lo, s11
	v_div_fixup_f32 v12, v77, v10, v12
	v_div_fixup_f32 v29, v79, v10, v29
	.loc	1 1239 13 is_stmt 1             ; ragged.py:1239:13
	...
	v_and_b32_e32 v52, 15, v76
	.loc	1 1245 22                       ; ragged.py:1245:22
	v_lshlrev_b32_e32 v75, 4, v25
	v_and_b32_e32 v22, 0x1800, v22
	v_lshlrev_b32_e32 v76, 6, v23
	.loc	1 1239 13                       ; ragged.py:1239:13
	v_and_b32_e32 v74, 15, v24
	.loc	1 1245 22                       ; ragged.py:1245:22
	...
	.loc	1 1245 22                       ; ragged.py:1245:22
	v_add3_u32 v7, v22, v8, v7
	v_xad_u32 v6, v6, v26, 0
	.loc	1 1239 13                       ; ragged.py:1239:13
	...
	v_lshl_or_b32 v19, v26, 4, v14
	v_lshl_or_b32 v15, v27, 4, v15
	v_lshl_or_b32 v16, v28, 4, v16
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 199
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc32_evenk_int4_none_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 44
