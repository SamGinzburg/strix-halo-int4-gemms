	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_lshl_b32 s3, s5, 7
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add3_u32 v18, s6, s4, v1
	.loc	1 131 30                        ; generate_amdgcn.py:131:30
	v_add3_u32 v19, s2, s3, v2
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v4, v1, s[12:15], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	...
	s_waitcnt vmcnt(1)
	ds_store_b8 v15, v4 offset:2048
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(0)
...
.LBB0_3:                                ; %Flow53
	...
	v_dual_mov_b32 v2, 0 :: v_dual_and_b32 v13, 0x70, v1
...
.Ltmp13:
	...
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v18, v2, v9
	...
	v_mov_b32_e32 v3, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[23:24], v19 offset:2048
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v30, v18 offset:1664
	ds_load_u8 v31, v18 offset:1920
	ds_load_u8 v32, v18 offset:1792
	ds_load_u8 v33, v18 offset:1536
	ds_load_u8 v34, v18 offset:1152
	ds_load_u8 v35, v18 offset:1408
	ds_load_u8 v36, v18 offset:1280
	ds_load_u8 v37, v18 offset:1024
	v_lshl_or_b32 v27, v5, 16, v4
	v_mov_b32_e32 v5, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[25:26], v20 offset:2048
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
...
; %bb.5:                                ; %.peel.next
	v_add3_u32 v21, s6, v17, 0x100
	v_add_nc_u32_e32 v17, s20, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mul_lo_u32 v23, s7, v21
	v_mad_u64_u32 v[21:22], null, s23, v17, s[6:7]
	s_lshl_b32 s6, s22, 7
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_add3_u32 v10, v23, s6, v10
	s_lshl_b32 s6, s21, 7
	v_add3_u32 v17, v21, v9, 0x100
	v_subrev_nc_u32_e32 v10, s6, v10
	s_add_i32 s6, s24, -2
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v31, v17, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	buffer_load_b64 v[21:22], v10, s[16:19], 0 offen
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v27, v18 offset:640
	ds_load_u8 v28, v18 offset:896
	ds_load_u8 v29, v18 offset:768
	ds_load_u8 v30, v18 offset:512
	ds_load_u8 v32, v18 offset:128
	ds_load_u8 v33, v18 offset:384
	ds_load_u8 v34, v18 offset:256
	ds_load_u8 v35, v18
	ds_load_u8 v36, v18 offset:1664
	ds_load_u8 v37, v18 offset:1920
	ds_load_u8 v38, v18 offset:1792
	ds_load_u8 v39, v18 offset:1536
	ds_load_u8 v40, v18 offset:1152
	ds_load_u8 v41, v18 offset:1280
	ds_load_u8 v42, v18 offset:1024
	ds_load_u8 v43, v18 offset:1408
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[23:24], v19 offset:2048
	ds_load_b64 v[25:26], v20 offset:2048
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	v_perm_b32 v29, v35, v32, 0xc0c0004
	v_lshl_or_b32 v28, v28, 16, v27
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(1)
	ds_store_b8 v15, v31 offset:2048
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v16, v[21:22]
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	v_perm_b32 v34, v42, v40, 0xc0c0004
	v_perm_b32 v35, v41, v43, 0xc0c0004
	v_lshl_or_b32 v27, v30, 16, v29
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v30, v33, 16, v32
	v_lshl_or_b32 v29, v35, 16, v34
...
; %bb.9:
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_cndmask_b32_e64 v15, 0x88, 0, s1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add3_u32 v16, 0, v13, v9
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v19, v16 offset:640
	ds_load_u8 v20, v16 offset:896
	ds_load_u8 v21, v16 offset:768
	ds_load_u8 v22, v16 offset:512
	ds_load_u8 v23, v16 offset:128
	ds_load_u8 v24, v16 offset:384
	ds_load_u8 v25, v16 offset:256
	ds_load_u8 v26, v16
	ds_load_u8 v27, v16 offset:1664
	ds_load_u8 v28, v16 offset:1792
	ds_load_u8 v29, v16 offset:1536
	ds_load_u8 v30, v16 offset:1920
	ds_load_u8 v31, v16 offset:1152
	ds_load_u8 v32, v16 offset:1280
	ds_load_u8 v33, v16 offset:1024
	ds_load_u8 v34, v16 offset:1408
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_lshl_or_b32 v15, v10, 4, v15
	s_delay_alu instid0(VALU_DEP_1)
	v_add_nc_u32_e32 v17, 0, v15
	v_xad_u32 v18, v15, 8, 0
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v19, v22, v19, 0xc0c0004
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[15:16], v17 offset:2048
	ds_load_b64 v[17:18], v18 offset:2048
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v23, v29, v27, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[19:20], v[15:16], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v20, v25, 16, v22
	s_waitcnt lgkmcnt(0)
...
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	v_cndmask_b32_e64 v22, 0x1040, 0, s1
	v_cndmask_b32_e64 v25, 0x204, 0, s0
	...
	v_or_b32_e32 v19, 20, v13
	v_or_b32_e32 v20, 24, v13
	v_or_b32_e32 v21, 28, v13
	s_clause 0x7
	...
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v17, v9, v17 :: v_dual_lshlrev_b32 v20, 16, v20
	.loc	1 143 14 is_stmt 1              ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v19, 16, v19
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v4, v17, v4 :: v_dual_lshlrev_b32 v21, 16, v21
	.loc	1 144 16 is_stmt 0              ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v20, v9, v20 :: v_dual_lshlrev_b32 v13, 16, v13
	v_dual_mul_f32 v15, v9, v15 :: v_dual_lshlrev_b32 v14, 1, v14
	v_dual_mul_f32 v19, v9, v19 :: v_dual_and_b32 v24, 28, v24
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v13, v9, v13 :: v_dual_lshlrev_b32 v16, 16, v16
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_lshl_or_b32 v14, v10, 2, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v2, v15, v2 :: v_dual_mul_f32 v7, v20, v7
	...
	v_add_lshl_u32 v13, v11, s9, 2
	v_add_lshl_u32 v15, v11, s11, 2
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v6, v19, v6 :: v_dual_mul_f32 v3, v16, v3
	.loc	1 144 16 is_stmt 0              ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v18, v9, v18
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_and_or_b32 v22, 0x1c0, v23, v24
	v_lshl_or_b32 v10, v10, 9, v14
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v9, v9, v21
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v5, v18, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v12, v22, v25
	v_add_nc_u32_e32 v14, 0, v10
	v_xad_u32 v22, v10, 4, 0
	v_xad_u32 v23, v10, 8, 0
	v_xad_u32 v24, v10, 12, 0
	v_and_or_b32 v0, v0, 32, v12
	v_xad_u32 v12, v10, 16, 0
	...
	v_add_lshl_u32 v9, v11, s1, 2
	v_add_lshl_u32 v12, v11, s8, 2
	v_add_lshl_u32 v10, v11, s2, 2
	v_add_lshl_u32 v14, v11, s10, 2
	s_waitcnt lgkmcnt(7)
...
.Ltmp14:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 25
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     27
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.kd
