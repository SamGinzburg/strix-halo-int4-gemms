	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_cndmask_b32_e64 v9, 0x80000000, v6, s4
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v10, v5, s[20:23], 0 offen
	buffer_load_b32 v7, v7, s[20:23], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_b32 v12, v6, s[16:19], 0 offen
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	...
	v_xor_b32_e32 v69, v5, v6
	v_lshlrev_b32_e32 v5, 4, v0
	v_lshlrev_b32_e32 v6, 1, v141
	v_add_nc_u32_e32 v14, 0, v69
	s_waitcnt vmcnt(5)
	ds_store_b32 v14, v11
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(3)
	ds_store_2addr_stride64_b32 v15, v10, v7 offset0:16 offset1:32
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v14, v12 offset:2048
	.loc	1 0 0                           ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v15, v8, v13 offset0:24 offset1:40
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v3, s14, v3
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
.Ltmp15:
	...
	v_and_or_b32 v70, 0x88, v7, v66
	s_lshl_b32 s22, s15, 7
	v_mul_lo_u32 v5, s5, v5
	v_mul_lo_u32 v8, s5, v4
	v_mad_u64_u32 v[3:4], null, s24, v3, s[6:7]
	v_readfirstlane_b32 s1, v6
	v_xor_b32_e32 v71, 8, v70
	v_mov_b32_e32 v14, v10
	v_mov_b32_e32 v15, v10
	v_add3_u32 v4, v5, s3, v2
	v_add3_u32 v2, v8, s3, v2
	v_add3_u32 v72, v3, v1, 32
	v_mov_b32_e32 v16, v10
	v_mov_b32_e32 v17, v10
	v_subrev_nc_u32_e32 v73, s22, v4
	v_subrev_nc_u32_e32 v74, s22, v2
	...
	s_mov_b32 s26, 1
	s_lshl_b32 s25, s5, 5
	s_add_i32 s15, 0, 0x800
	s_add_i32 s27, s1, 1
	s_add_i32 s24, 0, 0x1000
	s_add_i32 s6, 0, 0x1800
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_b32 v75, v72, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v76, v74, s[20:23], 0 offen
	buffer_load_b32 v77, v73, s[20:23], 0 offen
	s_mov_b32 s28, s0
	s_mov_b32 s0, s15
	s_mov_b32 s15, s24
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v78, s28, v70
	v_add_nc_u32_e32 v82, s28, v71
	s_mov_b32 s24, s6
	s_mov_b32 s6, s1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v86, s15, v67
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v87, s6, v67
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	ds_load_u8 v88, v86 offset:640
	ds_load_u8 v89, v86 offset:512
	ds_load_u8 v90, v86 offset:896
	ds_load_u8 v91, v86 offset:768
	ds_load_u8 v92, v86 offset:960
	ds_load_u8 v93, v86 offset:832
	ds_load_u8 v94, v86 offset:704
	ds_load_u8 v95, v86 offset:576
	ds_load_u8 v96, v86 offset:128
	ds_load_u8 v97, v86
	ds_load_u8 v98, v86 offset:384
	ds_load_u8 v99, v86 offset:256
	ds_load_u8 v100, v86 offset:448
	ds_load_u8 v101, v86 offset:320
	ds_load_u8 v102, v86 offset:192
	ds_load_u8 v103, v86 offset:64
	ds_load_u8 v104, v86 offset:1664
	ds_load_u8 v105, v86 offset:1536
	ds_load_u8 v106, v86 offset:1920
	ds_load_u8 v107, v86 offset:1792
	ds_load_u8 v108, v86 offset:1984
	ds_load_u8 v109, v86 offset:1856
	ds_load_u8 v110, v86 offset:1728
	ds_load_u8 v111, v86 offset:1600
	ds_load_u8 v112, v86 offset:1152
	ds_load_u8 v113, v86 offset:1024
	ds_load_u8 v114, v86 offset:1408
	ds_load_u8 v115, v86 offset:1280
	ds_load_u8 v116, v86 offset:1472
	ds_load_u8 v117, v86 offset:1344
	ds_load_u8 v118, v86 offset:1216
	ds_load_u8 v86, v86 offset:1088
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v119, v87 offset:640
	ds_load_u8 v120, v87 offset:512
	ds_load_u8 v121, v87 offset:896
	ds_load_u8 v122, v87 offset:768
	ds_load_u8 v123, v87 offset:960
	ds_load_u8 v124, v87 offset:832
	ds_load_u8 v125, v87 offset:704
	ds_load_u8 v126, v87 offset:576
	ds_load_u8 v127, v87 offset:128
	ds_load_u8 v128, v87
	ds_load_u8 v129, v87 offset:384
	ds_load_u8 v130, v87 offset:256
	ds_load_u8 v131, v87 offset:448
	ds_load_u8 v132, v87 offset:320
	ds_load_u8 v133, v87 offset:192
	ds_load_u8 v134, v87 offset:64
	ds_load_u8 v135, v87 offset:1664
	ds_load_u8 v136, v87 offset:1536
	ds_load_u8 v137, v87 offset:1920
	ds_load_u8 v142, v87 offset:1792
	ds_load_u8 v143, v87 offset:1984
	ds_load_u8 v144, v87 offset:1856
	ds_load_u8 v145, v87 offset:1728
	ds_load_u8 v146, v87 offset:1600
	ds_load_u8 v147, v87 offset:1152
	ds_load_u8 v148, v87 offset:1024
	ds_load_u8 v149, v87 offset:1408
	ds_load_u8 v150, v87 offset:1280
	ds_load_u8 v151, v87 offset:1472
	ds_load_u8 v152, v87 offset:1344
	ds_load_u8 v153, v87 offset:1216
	ds_load_u8 v87, v87 offset:1088
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	v_lshl_or_b32 v100, v119, 16, v118
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[34:41], v[86:87], v[78:79], v[34:41] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[42:49], v[90:91], v[78:79], v[42:49] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[50:57], v[86:87], v[80:81], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[58:65], v[90:91], v[80:81], v[58:65] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[94:95], v[78:79], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[98:99], v[78:79], v[26:33] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[18:25], v[94:95], v[80:81], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[98:99], v[80:81], v[1:8] neg_lo:[1,1,0]
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	s_add_i32 s15, s3, 0
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add_nc_u32_e32 v74, s25, v74
	v_add_nc_u32_e32 v72, 16, v72
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v154, s15, v69
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[34:41], v[88:89], v[82:83], v[34:41] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[42:49], v[92:93], v[82:83], v[42:49] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[50:57], v[88:89], v[84:85], v[50:57] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[58:65], v[92:93], v[84:85], v[58:65] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[10:17], v[96:97], v[82:83], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[100:101], v[82:83], v[26:33] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[18:25], v[96:97], v[84:85], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[100:101], v[84:85], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s27, s27, -1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v155, s15, v68
	s_add_i32 s6, s15, 0x1000
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	s_add_i32 s3, s15, 0x2000
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lg_u32 s27, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v154, v75
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v155, v76, v77 offset0:16 offset1:32
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_mov_b32 v70, v9 :: v_dual_mov_b32 v173, v67
	s_mov_b32 s22, s0
	s_branch .LBB0_8
.LBB0_7:
	v_mov_b32_e32 v8, 0
...
.LBB0_8:                                ; %._crit_edge
	...
	v_add_nc_u32_e32 v67, s22, v9
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_cmp_ne_u32_e64 s0, 1, v66
	v_dual_mov_b32 v87, v55 :: v_dual_mov_b32 v86, v54
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v97, v65 :: v_dual_add_nc_u32 v68, s22, v106
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v42, s1, v155
	v_add_nc_u32_e32 v43, s1, v153
	v_add_nc_u32_e32 v40, s1, v159
	v_add_nc_u32_e32 v46, s1, v147
	v_add_nc_u32_e32 v41, s1, v157
	v_add_nc_u32_e32 v44, s1, v151
	v_add_nc_u32_e32 v45, s1, v149
	v_add_nc_u32_e32 v47, s1, v173
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v42, v42
	ds_load_u8 v43, v43
	ds_load_u8 v40, v40
	...
	ds_load_u8 v41, v41
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v52, s1, v162
	v_add_nc_u32_e32 v53, s1, v161
	v_add_nc_u32_e32 v50, s1, v164
	v_add_nc_u32_e32 v56, s1, v156
	v_add_nc_u32_e32 v38, s1, v168
	v_add_nc_u32_e32 v39, s1, v167
	v_add_nc_u32_e32 v48, s1, v166
	v_add_nc_u32_e32 v49, s1, v165
	v_add_nc_u32_e32 v51, s1, v163
	v_add_nc_u32_e32 v54, s1, v160
	v_add_nc_u32_e32 v55, s1, v158
	v_add_nc_u32_e32 v57, s1, v154
	v_add_nc_u32_e32 v58, s1, v152
	v_add_nc_u32_e32 v59, s1, v150
	v_add_nc_u32_e32 v60, s1, v148
	v_add_nc_u32_e32 v61, s1, v146
	v_add_nc_u32_e32 v62, s1, v145
	v_add_nc_u32_e32 v63, s1, v144
	v_add_nc_u32_e32 v64, s1, v143
	v_add_nc_u32_e32 v65, s1, v142
	v_add_nc_u32_e32 v34, s1, v172
	v_add_nc_u32_e32 v35, s1, v171
	v_add_nc_u32_e32 v36, s1, v170
	v_add_nc_u32_e32 v37, s1, v169
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(6)
...
; %bb.13:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v119, s6, v155
	v_add_nc_u32_e32 v120, s6, v153
	v_add_nc_u32_e32 v131, s6, v159
	v_add_nc_u32_e32 v133, s6, v147
	v_add_nc_u32_e32 v134, s6, v173
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v119, v119
	ds_load_u8 v120, v120
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v135, s6, v151
	v_add_nc_u32_e32 v132, s6, v157
	v_add_nc_u32_e32 v136, s6, v149
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v115, s6, v162
	v_add_nc_u32_e32 v129, s6, v143
	v_add_nc_u32_e32 v116, s6, v161
	v_add_nc_u32_e32 v113, s6, v164
	v_add_nc_u32_e32 v121, s6, v156
	v_add_nc_u32_e32 v9, s6, v172
	v_add_nc_u32_e32 v108, s6, v169
	v_add_nc_u32_e32 v110, s6, v167
	v_add_nc_u32_e32 v111, s6, v166
	v_add_nc_u32_e32 v112, s6, v165
	v_add_nc_u32_e32 v114, s6, v163
	v_add_nc_u32_e32 v117, s6, v160
	v_add_nc_u32_e32 v118, s6, v158
	v_add_nc_u32_e32 v122, s6, v154
	v_add_nc_u32_e32 v123, s6, v152
	v_add_nc_u32_e32 v124, s6, v150
	v_add_nc_u32_e32 v125, s6, v148
	v_add_nc_u32_e32 v126, s6, v146
	v_add_nc_u32_e32 v127, s6, v145
	v_add_nc_u32_e32 v128, s6, v144
	v_add_nc_u32_e32 v130, s6, v142
	v_add_nc_u32_e32 v106, s6, v171
	v_add_nc_u32_e32 v107, s6, v170
	v_add_nc_u32_e32 v109, s6, v168
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(6)
...
; %bb.15:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v41, s3, v155
	v_add_nc_u32_e32 v42, s3, v153
	v_add_nc_u32_e32 v39, s3, v159
	v_add_nc_u32_e32 v45, s3, v147
	v_add_nc_u32_e32 v40, s3, v157
	v_add_nc_u32_e32 v43, s3, v151
	v_add_nc_u32_e32 v44, s3, v149
	v_add_nc_u32_e32 v46, s3, v173
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v41, v41
	ds_load_u8 v42, v42
	ds_load_u8 v39, v39
	...
	ds_load_u8 v40, v40
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v51, s3, v162
	v_add_nc_u32_e32 v52, s3, v161
	v_add_nc_u32_e32 v49, s3, v164
	v_add_nc_u32_e32 v55, s3, v156
	v_add_nc_u32_e32 v9, s3, v172
	v_add_nc_u32_e32 v38, s3, v167
	v_add_nc_u32_e32 v47, s3, v166
	v_add_nc_u32_e32 v48, s3, v165
	v_add_nc_u32_e32 v50, s3, v163
	v_add_nc_u32_e32 v53, s3, v160
	v_add_nc_u32_e32 v54, s3, v158
	v_add_nc_u32_e32 v56, s3, v154
	v_add_nc_u32_e32 v57, s3, v152
	v_add_nc_u32_e32 v58, s3, v150
	v_add_nc_u32_e32 v59, s3, v148
	v_add_nc_u32_e32 v60, s3, v146
	v_add_nc_u32_e32 v61, s3, v145
	v_add_nc_u32_e32 v62, s3, v144
	v_add_nc_u32_e32 v63, s3, v143
	v_add_nc_u32_e32 v64, s3, v142
	v_add_nc_u32_e32 v34, s3, v171
	v_add_nc_u32_e32 v35, s3, v170
	v_add_nc_u32_e32 v36, s3, v169
	v_add_nc_u32_e32 v37, s3, v168
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(6)
...
.LBB0_17:
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v32, s7, v65
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v89, v11
	v_cvt_f32_i32_e32 v11, v33
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v33, s7, v64
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v49, v26
	v_cvt_f32_i32_e32 v26, v28
	v_cvt_f32_i32_e32 v28, v4
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_mul_lo_u32 v4, s5, v59
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v59, s7, v25
	v_or_b32_e32 v62, s7, v31
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
	v_cvt_f32_i32_e32 v35, v106
	v_cvt_f32_i32_e32 v36, v107
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v64, s7, v23
	v_or_b32_e32 v65, s7, v20
	v_or_b32_e32 v70, s7, v19
	v_or_b32_e32 v71, s7, v16
	v_or_b32_e32 v72, s7, v15
	v_or_b32_e32 v73, s7, v14
	v_or_b32_e32 v106, s7, v8
	v_or_b32_e32 v107, s7, v5
	.loc	1 141 15                        ; generate_amdgcn.py:141:15
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 175
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 29
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     31
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm128_bn128_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
