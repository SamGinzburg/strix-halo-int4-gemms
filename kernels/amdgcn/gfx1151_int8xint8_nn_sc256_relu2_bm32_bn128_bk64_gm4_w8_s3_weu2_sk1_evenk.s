	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp20:
	...
	buffer_load_b128 v[23:26], v9, s[20:23], 0 offen
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_clause 0x1
	buffer_load_b64 v[54:55], v8, s[4:7], 0 offen
	buffer_load_b64 v[56:57], v7, s[4:7], 0 offen
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
...
.Ltmp22:
	...
	v_subrev_nc_u32_e32 v57, s10, v5
	v_subrev_nc_u32_e32 v58, s10, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[80:83], v57, s[20:23], 0 offen
	...
	v_add_lshl_u32 v62, v34, s15, 1
	v_add_lshl_u32 v63, v33, s15, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v64, v32, s15, 1
	v_add_lshl_u32 v65, v30, s15, 1
	v_add_lshl_u32 v66, v28, s15, 1
	v_add_lshl_u32 v67, v31, s15, 1
	v_add_lshl_u32 v68, v29, s15, 1
	v_add_lshl_u32 v69, v27, s15, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	v_add_nc_u32_e32 v61, s14, v38
	s_mov_b32 s1, s12
	v_add_nc_u32_e32 v62, s14, v39
	v_add_nc_u32_e32 v63, s14, v40
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_fmac_f32_e32 v15, v72, v88
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v75, v76, v101
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_dual_mul_f32 v74, v76, v100 :: v_dual_lshlrev_b32 v79, 16, v133
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v78, 16, v132
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v18, v75, v91
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v73, v76, v83
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v14, v71, v87
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v69, v76, v79 :: v_dual_fmac_f32 v16, v73, v89
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v141, s34, v45
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v17, v74, v90
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v68, v76, v78 :: v_dual_add_nc_u32 v57, s31, v57
	v_mul_f32_e32 v76, v77, v78
	v_dual_mul_f32 v78, v77, v79 :: v_dual_add_nc_u32 v145, s34, v49
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v13, v70, v86 :: v_dual_add_nc_u32 v144, s34, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v20, v76, v92 :: v_dual_add_nc_u32 v143, s34, v47
	v_fmac_f32_e32 v21, v78, v93
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v79, v77, v80
	v_mul_f32_e32 v80, v77, v81
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v11, v68, v84 :: v_dual_add_nc_u32 v146, s34, v50
	v_dual_fmac_f32 v12, v69, v85 :: v_dual_add_nc_u32 v147, s34, v51
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v23, v80, v95 :: v_dual_add_nc_u32 v140, s15, v44
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v81, v77, v82
	v_mul_f32_e32 v82, v77, v83
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v22, v79, v94
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v142, s34, v46
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b64 v140, v[128:129] offset:16384
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v24, v81, v96 :: v_dual_fmac_f32 v25, v82, v97
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v83, v77, v100 :: v_dual_add_nc_u32 v58, s31, v58
	v_mul_f32_e32 v77, v77, v101
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v26, v83, v98 :: v_dual_fmac_f32 v19, v77, v99
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
; %bb.9:
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v6, s10, v39
	v_add_nc_u32_e32 v41, s10, v37
	v_add_nc_u32_e32 v42, s10, v38
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v7, s12, v78
	v_add_nc_u32_e32 v8, s12, v77
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[83:86], v6
	ds_load_b128 v[87:90], v42 offset:1024
	ds_load_b128 v[91:94], v42
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v49, s23 :: v_dual_mov_b32 v48, s22
	v_dual_mov_b32 v46, s20 :: v_dual_mov_b32 v45, s19
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v44, s18 :: v_dual_add_nc_u32 v7, s10, v40
	v_mov_b32_e32 v43, s17
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[95:98], v6 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v47, s21 :: v_dual_mov_b32 v42, s16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
; %bb.11:
	...
	s_mov_b32 s23, s16
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s34, v78
	v_add_nc_u32_e32 v55, s34, v77
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v65, s23 :: v_dual_add_nc_u32 v56, s34, v76
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v58, s16 :: v_dual_add_nc_u32 v1, s1, v37
	v_dual_mov_b32 v60, s18 :: v_dual_add_nc_u32 v57, s34, v75
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[87:90], v56
	ds_load_b128 v[91:94], v57
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v55, s1, v39
	ds_load_b128 v[95:98], v1 offset:1024
	ds_load_b128 v[99:102], v1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v63, s21 :: v_dual_add_nc_u32 v56, s1, v38
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_12:
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v68, v37, v69 :: v_dual_lshlrev_b32 v15, 16, v32
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v33, v11, v17 :: v_dual_lshlrev_b32 v12, 16, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_fma_f32 v42, v95, v42, v20
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v34, v11, v26 :: v_dual_mul_f32 v15, v12, v15
	v_dual_mul_f32 v35, v11, v28 :: v_dual_mul_f32 v26, v12, v26
	...
	v_dual_cndmask_b32 v7, v16, v12 :: v_dual_and_b32 v18, 1, v50
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 148
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
