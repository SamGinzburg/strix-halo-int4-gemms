	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_or_b32_e32 v37, 0xc0, v36
	v_dual_mov_b32 v14, v9 :: v_dual_lshlrev_b32 v41, 2, v0
	v_mov_b32_e32 v10, v9
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_and_b32_e32 v40, 15, v0
	v_mov_b32_e32 v16, v9
	v_mov_b32_e32 v12, v9
	v_dual_mov_b32 v13, v9 :: v_dual_lshlrev_b32 v46, 5, v43
...
.Ltmp11:
	...
	v_dual_mov_b32 v20, v9 :: v_dual_lshlrev_b32 v45, 6, v40
	...
	v_mad_u64_u32 v[1:2], null, s25, v36, v[33:34]
	...
	s_cmp_lt_i32 s9, 2
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[34:35], null, s22, s25, v[1:2]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cselect_b32 s24, -1, 0
	s_cmp_gt_i32 s9, 1
	.loc	1 156 30                        ; generate_amdgcn.py:156:30
	s_mul_i32 s4, s23, s25
	v_mul_lo_u32 v4, s25, v37
	...
	v_add3_u32 v49, v2, v33, s4
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	v_cndmask_b32_e32 v2, 0x80000000, v50, vcc_lo
	.loc	1 154 22 is_stmt 1              ; generate_amdgcn.py:154:22
	s_and_b32 s13, s13, 0xffff
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_and_b32 s17, s17, 0xffff
	v_cndmask_b32_e32 v5, 0x80000000, v39, vcc_lo
	v_cndmask_b32_e32 v3, 0x80000000, v49, vcc_lo
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[51:52], v1, s[12:15], 0 offen
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_clause 0x3
	buffer_load_b64 v[53:54], v2, s[16:19], 0 offen
	buffer_load_b64 v[55:56], v3, s[16:19], 0 offen
	buffer_load_b64 v[57:58], v4, s[16:19], 0 offen
	buffer_load_b64 v[59:60], v5, s[16:19], 0 offen
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_lshlrev_b32_e32 v4, 3, v0
	v_and_b32_e32 v5, 56, v44
	v_mov_b32_e32 v1, v9
	v_mov_b32_e32 v2, v9
	v_mov_b32_e32 v3, v9
	s_mov_b32 s4, 0
	...
	v_mov_b32_e32 v8, v9
	s_waitcnt vmcnt(4)
	ds_store_b64 v47, v[51:52] offset:16384
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_waitcnt vmcnt(2)
	ds_store_2addr_stride64_b64 v47, v[53:54], v[55:56] offset1:8
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v47, v[57:58], v[59:60] offset0:16 offset1:24
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 156 30                        ; generate_amdgcn.py:156:30
	v_add_nc_u32_e32 v4, 64, v35
	v_add_nc_u32_e32 v1, 64, v50
	v_add_nc_u32_e32 v3, 64, v49
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_mov_b32 s5, s4
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_dual_cndmask_b32 v2, 0x80000000, v2 :: v_dual_add_nc_u32 v5, 64, v39
	...
	s_mov_b32 s19, s15
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[34:35], v2, s[12:15], 0 offen
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	...
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_clause 0x3
	buffer_load_b64 v[85:86], v1, s[16:19], 0 offen
	buffer_load_b64 v[87:88], v3, s[16:19], 0 offen
	buffer_load_b64 v[89:90], v4, s[16:19], 0 offen
	buffer_load_b64 v[91:92], v2, s[16:19], 0 offen
...
.Ltmp13:
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[63:64], v[57:58], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[61:62], v[59:60], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[69:70], v[67:68], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[79:80], v[73:74], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[83:84], v[61:62], v[17:24] neg_lo:[1,1,0]
	v_xor_b32_e32 v61, 48, v39
	v_xor_b32_e32 v39, 56, v39
	v_wmma_i32_16x16x16_iu4 v[25:32], v[81:82], v[63:64], v[25:32] neg_lo:[1,1,0]
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v61 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[69:70], v[65:66], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[71:72], v[65:66], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[71:72], v[67:68], v[1:8] neg_lo:[1,1,0]
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[65:68], v62 offset0:32 offset1:36
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[75:76], v[1:8] neg_lo:[1,1,0]
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[73:76], v64 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b64 v47, v[34:35] offset:16384
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_waitcnt vmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[71:72], v[81:82], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[69:70], v[83:84], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[71:72], v[83:84], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[73:74], v[65:66], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[75:76], v[65:66], v[17:24] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[25:32], v[73:74], v[67:68], v[25:32] neg_lo:[1,1,0]
...
; %bb.2:                                ; %.peel.next
	s_lshl_b32 s5, s26, 8
	s_lshl_b32 s2, s2, 8
	v_or_b32_e32 v34, s5, v36
	v_or_b32_e32 v35, s5, v38
	v_or_b32_e32 v37, s5, v37
	v_add_nc_u32_e32 v39, s22, v36
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v38, s2, v34
	v_subrev_nc_u32_e32 v36, s2, v35
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_2)
	v_subrev_nc_u32_e32 v37, s2, v37
	s_add_i32 s2, s3, 0x80
	s_add_i32 s3, s4, -2
	v_mad_u64_u32 v[34:35], null, s25, v38, v[33:34]
	v_or_b32_e32 v38, 0x80, v38
	v_mad_u64_u32 v[35:36], null, s25, v36, v[33:34]
	v_mad_u64_u32 v[36:37], null, s25, v37, v[33:34]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[37:38], null, s25, v38, v[33:34]
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[85:86], v33, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_clause 0x3
	buffer_load_b64 v[87:88], v39, s[16:19], 0 offen
	buffer_load_b64 v[89:90], v65, s[16:19], 0 offen
	buffer_load_b64 v[91:92], v66, s[16:19], 0 offen
	buffer_load_b64 v[93:94], v67, s[16:19], 0 offen
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	...
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[77:80], v52 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v53 offset0:32 offset1:36
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_add_i32 s3, s3, -1
	s_add_i32 s2, s2, 64
	s_cmp_lg_u32 s3, 0
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[69:72], v55 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[77:78], v[73:74], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[79:80], v[73:74], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[79:80], v[75:76], v[1:8] neg_lo:[1,1,0]
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[73:76], v56 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[77:80], v57 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[65:66], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[67:68], v[81:82], v[17:24] neg_lo:[1,1,0]
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[81:84], v58 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	...
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[69:72], v60 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[73:76], v61 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[65:66], v[79:80], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[67:68], v[79:80], v[1:8] neg_lo:[1,1,0]
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[65:68], v63 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[77:80], v62 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[69:70], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[71:72], v[81:82], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[71:72], v[83:84], v[1:8] neg_lo:[1,1,0]
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[69:72], v64 offset1:16
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b64 v47, v[85:86] offset:16384
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	s_waitcnt vmcnt(2)
	ds_store_2addr_stride64_b64 v47, v[87:88], v[89:90] offset1:8
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v47, v[91:92], v[93:94] offset0:16 offset1:24
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[65:66], v[75:76], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[67:68], v[75:76], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[69:70], v[77:78], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[71:72], v[77:78], v[17:24] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[25:32], v[69:70], v[79:80], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[71:72], v[79:80], v[1:8] neg_lo:[1,1,0]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
.LBB0_8:
	...
	v_and_b32_e32 v33, 56, v41
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_and_or_b32 v37, 0x438, v41, v45
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	v_or3_b32 v38, v46, v33, v45
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_add_nc_u32_e32 v33, 0, v37
	v_xad_u32 v49, v37, 8, 0
	v_xad_u32 v39, v37, 56, 0
	v_xad_u32 v77, v37, 48, 0
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	v_add_nc_u32_e32 v45, 0, v38
	v_xad_u32 v53, v38, 8, 0
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	v_xad_u32 v81, v37, 40, 0
	v_xad_u32 v85, v37, 32, 0
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[57:60], v37 offset0:32 offset1:36
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[61:64], v61 offset1:16
	v_xad_u32 v73, v38, 24, 0
	v_xad_u32 v93, v38, 56, 0
	v_xad_u32 v94, v38, 48, 0
	v_xad_u32 v37, v38, 40, 0
	v_xad_u32 v38, v38, 32, 0
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[65:68], v39 offset0:32 offset1:36
	...
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[89:92], v38 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(11)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[45:46], v[33:34], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[47:48], v[33:34], v[17:24] neg_lo:[1,1,0]
	...
	.loc	1 156 22                        ; generate_amdgcn.py:156:22
	ds_load_2addr_stride64_b64 v[33:36], v37 offset1:16
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	...
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[33:34], v[81:82], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[35:36], v[81:82], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[33:34], v[83:84], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[35:36], v[83:84], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
...
.LBB0_9:
	...
	v_or_b32_e32 v46, 8, v36
	v_or_b32_e32 v47, 12, v36
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
	buffer_load_u16 v39, v38, s[8:11], 0 offen
	v_or_b32_e32 v38, 64, v38
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_or_b32_e32 v48, 16, v36
	v_or_b32_e32 v49, 20, v36
	v_or_b32_e32 v50, 24, v36
	v_or_b32_e32 v51, 28, v36
	v_or_b32_e32 v52, 0x100, v36
	v_or_b32_e32 v53, 0x104, v36
	v_or_b32_e32 v54, 0x108, v36
	v_or_b32_e32 v55, 0x10c, v36
	v_or_b32_e32 v56, 0x110, v36
	v_or_b32_e32 v57, 0x114, v36
	v_or_b32_e32 v58, 0x118, v36
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
...
.Ltmp18:
	...
	v_mul_f32_e32 v61, v39, v46
	v_mul_f32_e32 v46, v38, v46
	v_mul_f32_e32 v69, v39, v54
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_lshlrev_b32_e32 v57, 16, v57
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v67, v39, v52
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_waitcnt vmcnt(0)
	...
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_dual_mul_f32 v52, v38, v52 :: v_dual_lshlrev_b32 v51, 16, v51
	v_dual_mul_f32 v72, v39, v57 :: v_dual_lshlrev_b32 v55, 16, v55
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_lshlrev_b32_e32 v45, 16, v45
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v65, v39, v50
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_lshlrev_b32_e32 v49, 16, v49
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v63, v39, v48
	v_mul_f32_e32 v68, v39, v53
	v_dual_mul_f32 v66, v39, v51 :: v_dual_lshlrev_b32 v37, 16, v37
	v_dual_mul_f32 v48, v38, v48 :: v_dual_lshlrev_b32 v47, 16, v47
	v_mul_f32_e32 v64, v39, v49
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v59, v39, v37 :: v_dual_and_b32 v34, 0x1f0, v0
	v_dual_mul_f32 v70, v39, v55 :: v_dual_and_b32 v35, 16, v0
	v_mul_f32_e32 v60, v39, v45
	v_dual_mul_f32 v62, v39, v47 :: v_dual_mul_f32 v45, v38, v45
	v_mul_f32_e32 v73, v39, v58
	v_mul_f32_e32 v71, v39, v56
	v_mul_f32_e32 v37, v38, v37
	v_mul_f32_e32 v47, v38, v47
	v_mul_f32_e32 v39, v39, v36
	v_dual_mul_f32 v49, v38, v49 :: v_dual_mul_f32 v10, v60, v10
	v_mul_f32_e32 v50, v38, v50
	v_dual_mul_f32 v51, v38, v51 :: v_dual_mul_f32 v14, v64, v14
	v_dual_mul_f32 v53, v38, v53 :: v_dual_mul_f32 v18, v68, v18
	v_dual_mul_f32 v54, v38, v54 :: v_dual_mul_f32 v9, v59, v9
	v_dual_mul_f32 v55, v38, v55 :: v_dual_mul_f32 v22, v72, v22
	v_dual_mul_f32 v56, v38, v56 :: v_dual_mul_f32 v11, v61, v11
	v_dual_mul_f32 v57, v38, v57 :: v_dual_mul_f32 v24, v39, v24
	v_dual_mul_f32 v58, v38, v58 :: v_dual_mul_f32 v13, v63, v13
	v_dual_mul_f32 v36, v38, v36 :: v_dual_mul_f32 v15, v65, v15
	.loc	1 171 9 is_stmt 0               ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v12, v62, v12 :: v_dual_mul_f32 v17, v67, v17
	v_dual_mul_f32 v16, v66, v16 :: v_dual_mul_f32 v19, v69, v19
	v_dual_mul_f32 v20, v70, v20 :: v_dual_mul_f32 v21, v71, v21
	v_dual_mul_f32 v23, v73, v23 :: v_dual_mul_f32 v28, v47, v28
	v_dual_mul_f32 v25, v37, v25 :: v_dual_mul_f32 v32, v51, v32
	v_dual_mul_f32 v26, v45, v26 :: v_dual_mul_f32 v27, v46, v27
	v_dual_mul_f32 v29, v48, v29 :: v_dual_mul_f32 v30, v49, v30
	v_dual_mul_f32 v31, v50, v31 :: v_dual_mul_f32 v2, v53, v2
	v_dual_mul_f32 v1, v52, v1 :: v_dual_mul_f32 v4, v55, v4
	v_dual_mul_f32 v3, v54, v3 :: v_dual_mul_f32 v6, v57, v6
	v_dual_mul_f32 v5, v56, v5 :: v_dual_max_f32 v10, 0, v10
	v_dual_mul_f32 v7, v58, v7 :: v_dual_mul_f32 v8, v36, v8
	...
	v_dual_max_f32 v13, 0, v13 :: v_dual_max_f32 v36, 0, v15
	v_dual_max_f32 v39, 0, v18 :: v_dual_max_f32 v20, 0, v20
	v_dual_max_f32 v45, 0, v19 :: v_dual_max_f32 v46, 0, v21
	v_dual_max_f32 v47, 0, v22 :: v_dual_max_f32 v48, 0, v23
	v_dual_max_f32 v37, 0, v16 :: v_dual_max_f32 v38, 0, v17
	v_dual_max_f32 v49, 0, v24 :: v_dual_max_f32 v50, 0, v25
	v_dual_max_f32 v26, 0, v26 :: v_dual_max_f32 v51, 0, v27
	v_dual_max_f32 v52, 0, v28 :: v_dual_max_f32 v53, 0, v29
	v_dual_max_f32 v30, 0, v30 :: v_dual_max_f32 v55, 0, v32
	v_dual_max_f32 v54, 0, v31 :: v_dual_max_f32 v1, 0, v1
	v_dual_max_f32 v2, 0, v2 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v4, 0, v4 :: v_dual_max_f32 v5, 0, v5
	v_dual_max_f32 v56, 0, v6 :: v_dual_max_f32 v57, 0, v7
	v_dual_max_f32 v58, 0, v8 :: v_dual_mul_f32 v59, v9, v9
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v60, v10, v10 :: v_dual_mul_f32 v61, v11, v11
	v_dual_mul_f32 v62, v12, v12 :: v_dual_mul_f32 v15, v13, v13
	v_dual_mul_f32 v16, v14, v14 :: v_dual_mul_f32 v17, v36, v36
	v_dual_mul_f32 v21, v39, v39 :: v_dual_mul_f32 v22, v45, v45
	v_dual_mul_f32 v23, v20, v20 :: v_dual_mul_f32 v24, v46, v46
	v_dual_mul_f32 v25, v47, v47 :: v_dual_mul_f32 v28, v49, v49
	v_dual_mul_f32 v27, v48, v48 :: v_dual_mul_f32 v36, v51, v51
	v_dual_mul_f32 v18, v37, v37 :: v_dual_mul_f32 v19, v38, v38
	v_dual_mul_f32 v37, v53, v53 :: v_dual_mul_f32 v32, v30, v30
	v_dual_mul_f32 v30, v54, v54 :: v_dual_mul_f32 v7, v4, v4
	v_dual_mul_f32 v20, v1, v1 :: v_dual_mul_f32 v13, v2, v2
	v_dual_mul_f32 v4, v57, v57 :: v_dual_max_f32 v1, v59, v60
.Ltmp19:
...
.Ltmp20:
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v29, v50, v50 :: v_dual_mul_f32 v38, v52, v52
	v_dual_mul_f32 v31, v26, v26 :: v_dual_mul_f32 v26, v55, v55
	v_mul_f32_e32 v8, v3, v3
	v_dual_mul_f32 v6, v5, v5 :: v_dual_mul_f32 v3, v58, v58
...
.Ltmp22:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
	v_lshl_add_u32 v14, v42, 8, 0
.Ltmp23:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max3_f32 v1, v1, v9, v2
	v_max_f32_e32 v2, v29, v31
	v_max3_f32 v9, v38, v37, v32
.Ltmp24:
	.loc	1 83 18                         ; generate_amdgcn.py:83:18 @[ generate_amdgcn.py:243:9 ]
...
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_dual_max_f32 v9, v9, v9 :: v_dual_and_b32 v10, 0xf0, v44
...
.Ltmp31:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_max_f32 v2, v2, v9 :: v_dual_lshlrev_b32 v9, 4, v42
.Ltmp32:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
...
.Ltmp49:
	...
	v_div_scale_f32 v10, null, v39, v39, v59
	v_rcp_f32_e32 v11, v10
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v12, -v10, v11, 1.0
	v_fmac_f32_e32 v11, v12, v11
	v_div_scale_f32 v12, vcc_lo, v59, v39, v59
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v14, v12, v11
	v_fma_f32 v42, -v10, v14, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v14, v42, v11
	v_fma_f32 v10, -v10, v14, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v10, v10, v11, v14
	v_div_scale_f32 v11, null, v39, v39, v60
	v_div_fixup_f32 v10, v10, v39, v59
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v12, v11
	v_fma_f32 v14, -v11, v12, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v12, v14, v12
	v_div_scale_f32 v14, vcc_lo, v60, v39, v60
	v_mul_f32_e32 v42, v14, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v43, -v11, v42, v14
	v_fmac_f32_e32 v42, v43, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v11, -v11, v42, v14
	v_div_fmas_f32 v11, v11, v12, v42
	v_div_scale_f32 v12, null, v39, v39, v61
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v11, v11, v39, v60
	v_rcp_f32_e32 v14, v12
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v42, -v12, v14, 1.0
	v_fmac_f32_e32 v14, v42, v14
	v_div_scale_f32 v42, vcc_lo, v61, v39, v61
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v43, v42, v14
	v_fma_f32 v44, -v12, v43, v42
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v43, v44, v14
	v_fma_f32 v12, -v12, v43, v42
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v12, v12, v14, v43
	v_div_scale_f32 v14, null, v39, v39, v62
	v_div_fixup_f32 v12, v12, v39, v61
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v42, v14
	v_fma_f32 v43, -v14, v42, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v62, v39, v62
	...
	v_div_fmas_f32 v14, v14, v42, v44
	v_div_scale_f32 v42, null, v39, v39, v15
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v14, v14, v39, v62
	v_rcp_f32_e32 v43, v42
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v44, -v42, v43, 1.0
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v15, v39, v15
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_fixup_f32 v15, v42, v39, v15
	...
	v_div_scale_f32 v42, null, v39, v39, v17
	v_rcp_f32_e32 v43, v42
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v44, -v42, v43, 1.0
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v17, v39, v17
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v45, v44, v43
	v_fma_f32 v46, -v42, v45, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v42, v42, v43, v45
	v_div_fixup_f32 v17, v42, v39, v17
	v_div_scale_f32 v42, null, v39, v39, v18
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v43, v42
	v_fma_f32 v44, -v42, v43, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	...
	v_div_fmas_f32 v42, v42, v43, v45
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fixup_f32 v18, v42, v39, v18
	...
	v_div_scale_f32 v42, null, v39, v39, v22
	v_rcp_f32_e32 v43, v42
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v44, -v42, v43, 1.0
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v22, v39, v22
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v45, v44, v43
	v_fma_f32 v46, -v42, v45, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v42, null, v39, v39, v23
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v43, v42
	v_fma_f32 v44, -v42, v43, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v23, v39, v23
	v_mul_f32_e32 v45, v44, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v46, -v42, v45, v44
	v_fmac_f32_e32 v45, v46, v43
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v25, v39, v25
	v_mul_f32_e32 v45, v44, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v46, -v42, v45, v44
	v_fmac_f32_e32 v45, v46, v43
	...
	v_div_scale_f32 v42, null, v39, v39, v28
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v43, v42
	v_fma_f32 v44, -v42, v43, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v43, v44, v43
	v_div_scale_f32 v44, vcc_lo, v28, v39, v28
	v_mul_f32_e32 v45, v44, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v46, -v42, v45, v44
	v_fmac_f32_e32 v45, v46, v43
	...
	v_div_fmas_f32 v42, v42, v43, v45
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fixup_f32 v28, v42, v39, v28
	v_div_scale_f32 v39, null, v9, v9, v29
	v_rcp_f32_e32 v42, v39
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v43, -v39, v42, 1.0
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v29, v9, v29
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v44, v43, v42
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v31, v9, v31
	v_mul_f32_e32 v44, v43, v42
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v45, -v39, v44, v43
	v_fmac_f32_e32 v44, v45, v42
	...
	v_div_scale_f32 v39, null, v9, v9, v36
	v_rcp_f32_e32 v42, v39
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v43, -v39, v42, 1.0
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v36, v9, v36
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v44, v43, v42
	v_fma_f32 v45, -v39, v44, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v39, null, v9, v9, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v42, v39
	v_fma_f32 v43, -v39, v42, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v38, v9, v38
	v_mul_f32_e32 v44, v43, v42
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v45, -v39, v44, v43
	v_fmac_f32_e32 v44, v45, v42
	...
	v_div_fmas_f32 v39, v39, v42, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fixup_f32 v38, v39, v9, v38
	v_div_scale_f32 v39, null, v9, v9, v37
	v_rcp_f32_e32 v42, v39
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v43, -v39, v42, 1.0
	v_fmac_f32_e32 v42, v43, v42
	v_div_scale_f32 v43, vcc_lo, v37, v9, v37
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v44, v43, v42
	v_fma_f32 v45, -v39, v44, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v37, v39, v9, v37
	v_div_scale_f32 v39, null, v9, v9, v32
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v32, v39, v9, v32
	v_div_scale_f32 v39, null, v9, v9, v30
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v30, v39, v9, v30
	v_div_scale_f32 v39, null, v9, v9, v26
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v26, v39, v9, v26
	v_div_scale_f32 v39, null, v9, v9, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_div_fmas_f32 v39, v39, v42, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v20, v39, v9, v20
	v_div_scale_f32 v39, null, v9, v9, v13
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v13, v39, v9, v13
	v_div_scale_f32 v39, null, v9, v9, v8
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_div_fmas_f32 v39, v39, v42, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v8, v39, v9, v8
	v_div_scale_f32 v39, null, v9, v9, v7
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v39, v39, v42, v44
	v_div_fixup_f32 v7, v39, v9, v7
	v_div_scale_f32 v39, null, v9, v9, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_div_scale_f32 v39, null, v9, v9, v4
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_div_fmas_f32 v39, v39, v42, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v4, v39, v9, v4
	v_div_scale_f32 v39, null, v9, v9, v3
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
...
.Ltmp51:
	...
	ds_store_b128 v31, v[36:39] offset:1024
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp53:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 95
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 27
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     29
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
