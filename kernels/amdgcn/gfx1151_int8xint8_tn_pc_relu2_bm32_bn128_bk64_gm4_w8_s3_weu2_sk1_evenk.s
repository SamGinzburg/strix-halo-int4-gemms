...
.Ltmp13:
	...
	s_lshl_b32 s27, s2, 5
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add3_u32 v2, s26, s3, v2
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_gt_i32 s8, 63
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v3, v8, v4, s27
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_clause 0x1
	buffer_load_b64 v[32:33], v8, s[12:15], 0 offen
	buffer_load_b64 v[34:35], v3, s[12:15], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v2, v0, 0, 1
...
; %bb.4:                                ; %.lr.ph
	v_bfe_i32 v2, v0, 5, 1
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v3, s7, v6
.Ltmp14:
...
.Ltmp15:
	...
	v_mov_b32_e32 v34, 0
	v_add3_u32 v51, v5, s27, v4
	v_dual_mov_b32 v33, 0 :: v_dual_mov_b32 v32, 0
	v_add3_u32 v6, v6, s6, v1
	v_add3_u32 v1, v3, s6, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b64 v[17:18], v51, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[9:12], v53, s[20:23], 0 offen
	buffer_load_b128 v[13:16], v52, s[20:23], 0 offen
	s_mov_b32 s6, s4
	s_mov_b32 s7, s24
	v_add_nc_u32_e32 v60, s6, v50
	v_add_nc_u32_e32 v61, s6, v54
	v_add_nc_u32_e32 v62, s6, v55
	v_add_nc_u32_e32 v63, s6, v56
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v57, s7, v35
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v33, v33, v59 :: v_dual_add_nc_u32 v52, s29, v52
	v_dual_add_f32 v34, v34, v58 :: v_dual_add_nc_u32 v53, s29, v53
	v_dual_add_f32 v24, v24, v57 :: v_dual_add_nc_u32 v51, s30, v51
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_add_i32 s31, s7, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v29, v29, v63 :: v_dual_add_f32 v28, v28, v64
	v_dual_add_f32 v25, v25, v67 :: v_dual_add_nc_u32 v202, s31, v42
	v_dual_add_f32 v21, v21, v70 :: v_dual_add_nc_u32 v204, s31, v44
	v_dual_add_f32 v20, v20, v71 :: v_dual_add_nc_u32 v205, s31, v45
	v_dual_add_f32 v23, v23, v68 :: v_dual_add_nc_u32 v206, s31, v46
	v_add_f32_e32 v27, v27, v65
	v_dual_add_f32 v22, v22, v69 :: v_dual_add_f32 v19, v19, v72
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s33, s33, -1
	s_mov_b32 s24, s28
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v203, s31, v43
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s33, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v207, s31, v47
	v_add_nc_u32_e32 v208, s31, v48
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v201, v[17:18] offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
...
; %bb.9:
	...
	s_mov_b32 s15, s8
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v60, s24, v35
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v7, v60 offset:416
	ds_load_u8 v8, v60 offset:384
	ds_load_u8 v9, v60 offset:480
	ds_load_u8 v10, v60 offset:448
	ds_load_u8 v13, v60 offset:288
	ds_load_u8 v14, v60 offset:256
	ds_load_u8 v15, v60 offset:352
	ds_load_u8 v16, v60 offset:320
	ds_load_u8 v17, v60 offset:160
	ds_load_u8 v18, v60 offset:128
	ds_load_u8 v36, v60 offset:224
	ds_load_u8 v37, v60 offset:192
	ds_load_u8 v61, v60 offset:464
	ds_load_u8 v62, v60 offset:432
	ds_load_u8 v63, v60 offset:400
	ds_load_u8 v64, v60 offset:368
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v40, v18, v17, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[15:18], v11
	ds_load_b128 v[44:47], v12
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(6)
	...
	ds_load_u8 v9, v60 offset:96
	ds_load_u8 v10, v60 offset:64
	ds_load_u8 v38, v60
	ds_load_u8 v39, v60 offset:32
	ds_load_u8 v65, v60 offset:336
	ds_load_u8 v66, v60 offset:304
	ds_load_u8 v67, v60 offset:272
	ds_load_u8 v68, v60 offset:240
	v_lshl_or_b32 v50, v14, 16, v13
	v_lshl_or_b32 v49, v36, 16, v40
	ds_load_u8 v75, v60 offset:16
	ds_load_u8 v76, v11
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v8, v38, v39, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v64, v65, v64, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v63, v67, v66, 0xc0c0004
	v_lshl_or_b32 v48, v7, 16, v8
	v_mov_b32_e32 v7, s8
	ds_load_u8 v36, v60 offset:928
	ds_load_u8 v37, v60 offset:896
	ds_load_u8 v38, v60 offset:992
	ds_load_u8 v39, v60 offset:960
	ds_load_u8 v40, v60 offset:800
	ds_load_u8 v41, v60 offset:768
	ds_load_u8 v42, v60 offset:864
	ds_load_u8 v43, v60 offset:832
	ds_load_u8 v53, v60 offset:672
	ds_load_u8 v54, v60 offset:640
	ds_load_u8 v55, v60 offset:736
	ds_load_u8 v57, v60 offset:704
	ds_load_u8 v77, v60 offset:976
	ds_load_u8 v78, v60 offset:944
	ds_load_u8 v79, v60 offset:912
	ds_load_u8 v80, v60 offset:880
	...
	ds_load_u8 v69, v60 offset:208
	ds_load_u8 v70, v60 offset:176
	ds_load_u8 v71, v60 offset:144
	ds_load_u8 v72, v60 offset:112
	ds_load_u8 v73, v60 offset:80
	ds_load_u8 v74, v60 offset:48
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v85, v41, v40, 0xc0c0004
	ds_load_u8 v87, v60 offset:720
	ds_load_u8 v88, v60 offset:688
	ds_load_u8 v89, v60 offset:656
	ds_load_u8 v90, v60 offset:624
	...
	ds_load_u8 v55, v60 offset:1440
	ds_load_u8 v57, v60 offset:1408
	ds_load_u8 v91, v60 offset:1504
	ds_load_u8 v92, v60 offset:1472
	ds_load_u8 v93, v60 offset:592
	ds_load_u8 v94, v60 offset:560
	ds_load_u8 v95, v60 offset:528
	ds_load_u8 v96, v60 offset:496
	v_perm_b32 v58, v37, v36, 0xc0c0004
	v_perm_b32 v59, v39, v38, 0xc0c0004
	ds_load_u8 v36, v60 offset:544
	ds_load_u8 v37, v60 offset:512
	ds_load_u8 v38, v60 offset:608
	ds_load_u8 v39, v60 offset:576
	ds_load_u8 v81, v60 offset:848
	ds_load_u8 v82, v60 offset:816
	ds_load_u8 v83, v60 offset:784
	ds_load_u8 v84, v60 offset:752
	...
	ds_load_u8 v92, v60 offset:1184
	ds_load_u8 v100, v60 offset:1152
	ds_load_u8 v101, v60 offset:1248
	ds_load_u8 v102, v60 offset:1216
	ds_load_u8 v103, v60 offset:1056
	ds_load_u8 v104, v60 offset:1024
	ds_load_u8 v105, v60 offset:1120
	ds_load_u8 v106, v60 offset:1088
	ds_load_u8 v107, v60 offset:1392
	ds_load_u8 v108, v60 offset:1360
	ds_load_u8 v109, v60 offset:1328
	ds_load_u8 v110, v60 offset:1296
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v97, v37, v36, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v98, v39, v38, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[36:43], v[44:47], v[48:51], v[7:14] neg_lo:[1,1,0]
	v_lshl_or_b32 v51, v59, 16, v58
	v_lshl_or_b32 v50, v86, 16, v85
	v_lshl_or_b32 v49, v54, 16, v53
	v_lshl_or_b32 v48, v98, 16, v97
	ds_load_u8 v53, v60 offset:1312
	ds_load_u8 v54, v60 offset:1280
	ds_load_u8 v58, v60 offset:1376
	ds_load_u8 v59, v60 offset:1344
	ds_load_u8 v85, v60 offset:1520
	ds_load_u8 v86, v60 offset:1488
	ds_load_u8 v97, v60 offset:1456
	ds_load_u8 v98, v60 offset:1424
	v_perm_b32 v61, v61, v96, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[36:43], v[15:18], v[48:51], v[36:43] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(18)
	...
	ds_load_u8 v105, v60 offset:1952
	ds_load_u8 v106, v60 offset:1920
	ds_load_u8 v114, v60 offset:2016
	ds_load_u8 v115, v60 offset:1984
	v_lshl_or_b32 v51, v91, 16, v99
	v_lshl_or_b32 v49, v49, 16, v48
	ds_load_u8 v92, v60 offset:1136
	ds_load_u8 v100, v60 offset:1104
	ds_load_u8 v101, v60 offset:1072
	ds_load_u8 v102, v60 offset:1040
	v_lshl_or_b32 v48, v104, 16, v103
	ds_load_u8 v103, v60 offset:1824
	ds_load_u8 v104, v60 offset:1792
	ds_load_u8 v116, v60 offset:1888
	ds_load_u8 v117, v60 offset:1856
	ds_load_u8 v118, v60 offset:1696
	ds_load_u8 v119, v60 offset:1664
	ds_load_u8 v120, v60 offset:1760
	ds_load_u8 v121, v60 offset:1728
	ds_load_u8 v122, v60 offset:1568
	ds_load_u8 v123, v60 offset:1536
	ds_load_u8 v124, v60 offset:1632
	ds_load_u8 v125, v60 offset:1600
	ds_load_u8 v113, v113
	ds_load_u8 v126, v60 offset:2000
	ds_load_u8 v127, v60 offset:1968
	ds_load_u8 v128, v60 offset:1936
	...
	ds_load_u8 v91, v60 offset:1264
	ds_load_u8 v99, v60 offset:1232
	ds_load_u8 v111, v60 offset:1200
	ds_load_u8 v112, v60 offset:1168
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v104, v117, v116, 0xc0c0004
	ds_load_u8 v116, v60 offset:1776
	ds_load_u8 v117, v60 offset:1744
	ds_load_u8 v131, v60 offset:1712
	ds_load_u8 v132, v60 offset:1680
	s_waitcnt lgkmcnt(20)
	...
	ds_load_u8 v114, v60 offset:1904
	ds_load_u8 v115, v60 offset:1872
	ds_load_u8 v129, v60 offset:1840
	ds_load_u8 v130, v60 offset:1808
	ds_load_u8 v120, v60 offset:1648
	ds_load_u8 v121, v60 offset:1616
	ds_load_u8 v133, v60 offset:1584
	ds_load_u8 v60, v60 offset:1552
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v123, v125, v124, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_wmma_i32_16x16x16_iu8 v[36:43], v[56:59], v[48:51], v[36:43] neg_lo:[1,1,0]
	v_lshl_or_b32 v51, v106, 16, v105
	v_lshl_or_b32 v50, v104, 16, v103
	v_lshl_or_b32 v49, v119, 16, v118
	v_lshl_or_b32 v48, v123, 16, v122
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[36:43], v[52:55], v[48:51], v[36:43] neg_lo:[1,1,0]
	v_lshl_or_b32 v51, v61, 16, v62
	v_lshl_or_b32 v50, v64, 16, v63
	v_lshl_or_b32 v49, v66, 16, v65
	v_lshl_or_b32 v48, v67, 16, v68
	v_perm_b32 v61, v79, v78, 0xc0c0004
	...
	v_lshl_or_b32 v47, v62, 16, v61
	v_lshl_or_b32 v46, v64, 16, v63
	v_lshl_or_b32 v45, v66, 16, v65
	v_lshl_or_b32 v44, v68, 16, v67
	...
	v_wmma_i32_16x16x16_iu8 v[7:14], v[15:18], v[44:47], v[7:14] neg_lo:[1,1,0]
	v_lshl_or_b32 v18, v49, 16, v48
	v_lshl_or_b32 v17, v51, 16, v50
	v_lshl_or_b32 v16, v62, 16, v61
	v_lshl_or_b32 v15, v64, 16, v63
	v_perm_b32 v44, v128, v127, 0xc0c0004
	v_perm_b32 v45, v126, v76, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	...
	v_wmma_i32_16x16x16_iu8 v[7:14], v[56:59], v[15:18], v[7:14] neg_lo:[1,1,0]
	v_lshl_or_b32 v18, v45, 16, v44
	v_lshl_or_b32 v17, v47, 16, v46
	v_lshl_or_b32 v16, v49, 16, v48
	v_lshl_or_b32 v15, v51, 16, v50
	v_cvt_f32_i32_e32 v37, v37
	s_delay_alu instid0(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[7:14], v[52:55], v[15:18], v[7:14] neg_lo:[1,1,0]
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v34, v34, v37 :: v_dual_add_f32 v27, v27, v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_cvt_f32_i32_e32 v37, v42
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v28, v28, v15 :: v_dual_add_f32 v25, v25, v9
	v_dual_add_f32 v26, v26, v8 :: v_dual_add_f32 v23, v23, v10
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v32, v32, v16 :: v_dual_add_f32 v31, v31, v17
	v_dual_add_f32 v30, v30, v18 :: v_dual_add_f32 v29, v29, v37
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v56, s28, v35
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v4, s31, v4
	v_add_nc_u32_e32 v52, s31, v6
	v_add_nc_u32_e32 v7, s31, v5
	v_add_nc_u32_e32 v1, s31, v1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v5, v56 offset:416
	ds_load_u8 v6, v56 offset:384
	ds_load_u8 v8, v56 offset:480
	ds_load_u8 v9, v56 offset:448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v3, v56 offset:288
	ds_load_u8 v4, v56 offset:256
	ds_load_u8 v10, v56 offset:352
	ds_load_u8 v11, v56 offset:320
	ds_load_u8 v12, v56 offset:160
	ds_load_u8 v13, v56 offset:128
	ds_load_u8 v14, v56 offset:224
	ds_load_u8 v36, v56 offset:192
	ds_load_u8 v37, v56 offset:96
	ds_load_u8 v38, v56 offset:64
	ds_load_u8 v39, v56
	ds_load_u8 v40, v56 offset:32
	ds_load_u8 v57, v56 offset:464
	ds_load_u8 v58, v56 offset:432
	ds_load_u8 v59, v56 offset:400
	ds_load_u8 v60, v56 offset:368
	ds_load_u8 v71, v56 offset:16
	ds_load_u8 v72, v1
	s_waitcnt lgkmcnt(16)
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v10, v38, v37, 0xc0c0004
	v_perm_b32 v6, v9, v8, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v1, v39, v40, 0xc0c0004
	v_perm_b32 v9, v36, v14, 0xc0c0004
	...
	ds_load_u8 v1, v56 offset:928
	ds_load_u8 v53, v56 offset:896
	ds_load_u8 v54, v56 offset:992
	ds_load_u8 v55, v56 offset:960
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_load_u8 v61, v56 offset:336
	ds_load_u8 v62, v56 offset:304
	ds_load_u8 v63, v56 offset:272
	ds_load_u8 v64, v56 offset:240
	ds_load_u8 v65, v56 offset:208
	ds_load_u8 v66, v56 offset:176
	ds_load_u8 v67, v56 offset:144
	ds_load_u8 v68, v56 offset:112
	ds_load_u8 v69, v56 offset:80
	ds_load_u8 v70, v56 offset:48
	ds_load_u8 v107, v56 offset:1264
	ds_load_u8 v108, v56 offset:1232
	ds_load_u8 v109, v56 offset:1200
	ds_load_u8 v110, v56 offset:1168
	v_wmma_i32_16x16x16_iu8 v[7:14], v[44:47], v[3:6], v[36:43] neg_lo:[1,1,0]
	ds_load_u8 v2, v56 offset:800
	ds_load_u8 v3, v56 offset:768
	ds_load_u8 v4, v56 offset:864
	ds_load_u8 v5, v56 offset:832
	ds_load_u8 v6, v56 offset:672
	ds_load_u8 v74, v56 offset:640
	ds_load_u8 v75, v56 offset:736
	ds_load_u8 v76, v56 offset:704
	ds_load_u8 v77, v56 offset:976
	ds_load_u8 v78, v56 offset:944
	ds_load_u8 v79, v56 offset:912
	ds_load_u8 v80, v56 offset:880
	ds_load_u8 v123, v56 offset:1776
	ds_load_u8 v124, v56 offset:1744
	ds_load_u8 v125, v56 offset:1712
	ds_load_u8 v126, v56 offset:1680
	s_waitcnt lgkmcnt(38)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	s_waitcnt lgkmcnt(33)
	v_perm_b32 v1, v53, v1, 0xc0c0004
	ds_load_u8 v53, v56 offset:544
	ds_load_u8 v81, v56 offset:512
	s_waitcnt lgkmcnt(33)
	v_perm_b32 v54, v55, v54, 0xc0c0004
	ds_load_u8 v55, v56 offset:608
	ds_load_u8 v82, v56 offset:576
	ds_load_u8 v83, v56 offset:848
	ds_load_u8 v84, v56 offset:816
	ds_load_u8 v85, v56 offset:784
	ds_load_u8 v86, v56 offset:752
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v2, v3, v2, 0xc0c0004
	v_perm_b32 v60, v61, v60, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v3, v5, v4, 0xc0c0004
	v_lshl_or_b32 v4, v54, 16, v1
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v6, v74, v6, 0xc0c0004
	ds_load_u8 v5, v56 offset:720
	ds_load_u8 v87, v56 offset:688
	ds_load_u8 v88, v56 offset:656
	ds_load_u8 v89, v56 offset:624
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v74, v76, v75, 0xc0c0004
	v_lshl_or_b32 v3, v3, 16, v2
	ds_load_u8 v75, v56 offset:592
	ds_load_u8 v76, v56 offset:560
	ds_load_u8 v90, v56 offset:528
	ds_load_u8 v91, v56 offset:496
	v_perm_b32 v62, v63, v62, 0xc0c0004
	...
	ds_load_u8 v82, v56 offset:1504
	ds_load_u8 v93, v56 offset:1472
	v_perm_b32 v53, v81, v53, 0xc0c0004
	ds_load_u8 v81, v56 offset:1440
	ds_load_u8 v92, v56 offset:1408
	v_perm_b32 v64, v69, v68, 0xc0c0004
	v_perm_b32 v65, v71, v70, 0xc0c0004
	v_lshl_or_b32 v1, v55, 16, v53
	ds_load_u8 v6, v56 offset:1312
	ds_load_u8 v53, v56 offset:1280
	ds_load_u8 v54, v56 offset:1376
	ds_load_u8 v55, v56 offset:1344
	ds_load_u8 v74, v56 offset:1184
	ds_load_u8 v94, v56 offset:1152
	ds_load_u8 v95, v56 offset:1248
	ds_load_u8 v96, v56 offset:1216
	ds_load_u8 v97, v56 offset:1520
	ds_load_u8 v98, v56 offset:1488
	ds_load_u8 v99, v56 offset:1456
	ds_load_u8 v100, v56 offset:1424
	s_waitcnt lgkmcnt(23)
	v_perm_b32 v5, v5, v86, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[7:14], v[15:18], v[1:4], v[7:14] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v66, v75, v89, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v57, v57, v91, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v6, v53, v6, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v53, v55, v54, 0xc0c0004
	v_perm_b32 v82, v93, v82, 0xc0c0004
	ds_load_u8 v93, v56 offset:1120
	ds_load_u8 v102, v56 offset:1088
	ds_load_u8 v103, v56 offset:1392
	ds_load_u8 v104, v56 offset:1360
	ds_load_u8 v105, v56 offset:1328
	ds_load_u8 v106, v56 offset:1296
	v_perm_b32 v81, v92, v81, 0xc0c0004
	ds_load_u8 v92, v56 offset:1056
	ds_load_u8 v101, v56 offset:1024
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v54, v94, v74, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v55, v96, v95, 0xc0c0004
	v_lshl_or_b32 v3, v53, 16, v6
	v_lshl_or_b32 v4, v82, 16, v81
	ds_load_u8 v74, v56 offset:1136
	ds_load_u8 v94, v56 offset:1104
	ds_load_u8 v95, v56 offset:1072
	ds_load_u8 v96, v56 offset:1040
	v_lshl_or_b32 v59, v57, 16, v58
	v_lshl_or_b32 v2, v55, 16, v54
	v_lshl_or_b32 v58, v60, 16, v62
	v_lshl_or_b32 v57, v63, 16, v61
	...
	ds_load_u8 v101, v56 offset:1952
	ds_load_u8 v111, v56 offset:1920
	ds_load_u8 v112, v56 offset:2016
	ds_load_u8 v113, v56 offset:1984
	v_lshl_or_b32 v1, v93, 16, v92
	ds_load_u8 v6, v56 offset:1824
	ds_load_u8 v53, v56 offset:1792
	ds_load_u8 v54, v56 offset:1888
	ds_load_u8 v55, v56 offset:1856
	ds_load_u8 v81, v56 offset:1696
	ds_load_u8 v82, v56 offset:1664
	ds_load_u8 v92, v56 offset:1760
	ds_load_u8 v93, v56 offset:1728
	ds_load_u8 v73, v73
	ds_load_u8 v102, v56 offset:2000
	ds_load_u8 v114, v56 offset:1968
	ds_load_u8 v115, v56 offset:1936
	v_wmma_i32_16x16x16_iu8 v[7:14], v[48:51], v[1:4], v[7:14] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v6, v53, v6, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v122, v55, v54, 0xc0c0004
	v_perm_b32 v101, v111, v101, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	v_perm_b32 v111, v113, v112, 0xc0c0004
	ds_load_u8 v112, v56 offset:1568
	ds_load_u8 v113, v56 offset:1536
	ds_load_u8 v116, v56 offset:1632
	ds_load_u8 v117, v56 offset:1600
	ds_load_u8 v118, v56 offset:1904
	ds_load_u8 v119, v56 offset:1872
	ds_load_u8 v120, v56 offset:1840
	ds_load_u8 v121, v56 offset:1808
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v82, v93, v92, 0xc0c0004
	v_lshl_or_b32 v3, v122, 16, v6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[52:55], v52
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v61, v77, v73, 0xc0c0004
	v_lshl_or_b32 v4, v111, 16, v101
	v_lshl_or_b32 v2, v82, 16, v81
	ds_load_u8 v6, v56 offset:1648
	ds_load_u8 v81, v56 offset:1616
	ds_load_u8 v82, v56 offset:1584
	ds_load_u8 v92, v56 offset:1552
	...
	v_lshl_or_b32 v56, v64, 16, v65
	v_perm_b32 v64, v88, v87, 0xc0c0004
	v_perm_b32 v65, v90, v76, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v6, v81, v6, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[7:14], v[52:55], v[1:4], v[7:14] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[36:43], v[44:47], v[56:59], v[36:43] neg_lo:[1,1,0]
	v_lshl_or_b32 v47, v61, 16, v60
	v_lshl_or_b32 v46, v63, 16, v62
	v_lshl_or_b32 v45, v5, 16, v64
	...
	v_perm_b32 v62, v94, v74, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[36:43], v[15:18], v[44:47], v[36:43] neg_lo:[1,1,0]
	v_lshl_or_b32 v18, v56, 16, v5
	v_lshl_or_b32 v17, v58, 16, v57
	v_lshl_or_b32 v16, v60, 16, v59
	v_lshl_or_b32 v15, v62, 16, v61
	v_perm_b32 v5, v115, v114, 0xc0c0004
	v_perm_b32 v44, v102, v72, 0xc0c0004
	v_perm_b32 v45, v121, v120, 0xc0c0004
	v_perm_b32 v46, v119, v118, 0xc0c0004
	v_perm_b32 v47, v126, v125, 0xc0c0004
	v_perm_b32 v56, v124, v123, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v92, v82, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[36:43], v[48:51], v[15:18], v[36:43] neg_lo:[1,1,0]
	v_lshl_or_b32 v18, v44, 16, v5
	v_lshl_or_b32 v17, v46, 16, v45
	v_lshl_or_b32 v16, v56, 16, v47
	v_lshl_or_b32 v15, v6, 16, v57
	v_cvt_f32_i32_e32 v7, v7
	v_cvt_f32_i32_e32 v8, v8
	v_cvt_f32_i32_e32 v9, v9
	v_cvt_f32_i32_e32 v10, v10
	v_wmma_i32_16x16x16_iu8 v[36:43], v[52:55], v[15:18], v[36:43] neg_lo:[1,1,0]
...
.LBB0_12:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v36, v22, v36 :: v_dual_add_f32 v39, v19, v39
	...
	v_dual_add_f32 v18, v23, v18 :: v_dual_add_f32 v37, v21, v37
	v_dual_add_f32 v38, v20, v38 :: v_dual_mov_b32 v47, 0x7632
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v14, v28, v14 :: v_dual_add_f32 v15, v27, v15
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v16, v26, v16 :: v_dual_add_f32 v17, v25, v17
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	s_add_i32 s5, s5, s26
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_mul_f32 v3, v4, v3 :: v_dual_lshlrev_b32 v32, 16, v40
	v_dual_mul_f32 v42, v2, v34 :: v_dual_and_b32 v1, 0x78, v1
	v_mul_f32_e32 v38, v2, v5
	v_mul_f32_e32 v41, v2, v33
	v_mul_f32_e32 v39, v2, v6
	v_mul_f32_e32 v40, v2, v32
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	v_add3_u32 v27, s5, v1, v35
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v6, v4, v6 :: v_dual_lshlrev_b32 v35, 16, v43
	.loc	1 436 9 is_stmt 0               ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v8, v8, v38 :: v_dual_mul_f32 v11, v11, v41
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_mul_f32_e32 v5, v4, v5
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v43, v2, v35
	v_mul_f32_e32 v2, v2, v36
	v_dual_mul_f32 v32, v4, v32 :: v_dual_mul_f32 v7, v7, v37
	v_mul_f32_e32 v33, v4, v33
	v_dual_mul_f32 v34, v4, v34 :: v_dual_mul_f32 v3, v15, v3
	v_dual_mul_f32 v35, v4, v35 :: v_dual_mul_f32 v10, v10, v40
	v_dual_mul_f32 v4, v4, v36 :: v_dual_mul_f32 v9, v9, v39
	.loc	1 443 15 is_stmt 1              ; generate_amdgcn.py:443:15
	v_max_f32_e32 v8, 0, v8
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v2, v14, v2 :: v_dual_mul_f32 v5, v16, v5
	v_mul_f32_e32 v14, v18, v32
	v_dual_mul_f32 v16, v21, v34 :: v_dual_max_f32 v7, 0, v7
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v9, 0, v9 :: v_dual_mul_f32 v8, v8, v8
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v12, v12, v42 :: v_dual_mul_f32 v13, v13, v43
	v_dual_mul_f32 v6, v17, v6 :: v_dual_mul_f32 v15, v22, v33
	v_dual_mul_f32 v17, v20, v35 :: v_dual_max_f32 v10, 0, v10
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v4, v19, v4 :: v_dual_max_f32 v3, 0, v3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_mul_f32 v16, v16, v16 :: v_dual_and_b32 v19, 1, v23
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_mov_b32 v46, 0x5410 :: v_dual_lshlrev_b32 v31, 1, v27
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v14, v14, v14 :: v_dual_mul_f32 v17, v17, v17
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_dual_mul_f32 v15, v15, v15 :: v_dual_mul_f32 v4, v4, v4
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_dual_cndmask_b32 v7, v9, v8 :: v_dual_and_b32 v24, 1, v29
	v_cndmask_b32_e32 v8, v8, v9, vcc_lo
	v_add3_u32 v5, v6, v23, 0x7fff
	v_mov_b16_e32 v30.l, v17.h
	v_add3_u32 v6, v15, v24, 0x7fff
	...
	v_perm_b32 v2, v5, v12, v10
	v_perm_b32 v3, v5, v12, v11
	v_perm_b32 v4, v6, v9, v10
	v_perm_b32 v5, v6, v9, v11
	v_perm_b32 v6, v7, v13, v10
	v_perm_b32 v7, v7, v13, v11
	v_add_lshl_u32 v8, v27, s3, 1
	s_mov_b32 s3, s7
	s_clause 0x1
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 209
