	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_xad_u32 v1, 0x50, v5, 0
	v_bfe_i32 v14, v0, 0, 1
	v_lshrrev_b32_e32 v15, 1, v65
	.loc	1 903 13                        ; attention.py:903:13
	...
	v_bfe_i32 v52, v0, 2, 1
	.loc	1 903 13                        ; attention.py:903:13
	v_mad_u64_u32 v[61:62], null, s19, v9, v[49:50]
	v_mov_b32_e32 v49, 0
	...
	v_lshl_add_u32 v75, s1, 1, v14
	v_add_nc_u32_e32 v80, 0, v11
	v_add_nc_u32_e32 v81, 0, v12
	v_add_nc_u32_e32 v87, 0, v51
	v_mov_b32_e32 v11, v49
	v_min_i32_e32 v83, v4, v8
	v_mov_b32_e32 v12, v49
	v_mov_b32_e32 v14, v49
	v_mov_b32_e32 v4, v49
	v_dual_mov_b32 v7, v49 :: v_dual_add_nc_u32 v86, v16, v6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mov_b32 v52, v49 :: v_dual_cndmask_b32 v95, 0x80000000, v61
	v_dual_mov_b32 v53, v49 :: v_dual_cndmask_b32 v96, 0x80000000, v75
	.loc	1 939 32                        ; attention.py:939:32
	buffer_load_b128 v[57:60], v50, s[28:31], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v50, v49 :: v_dual_add_nc_u32 v97, s23, v71
	v_dual_mov_b32 v51, v49 :: v_dual_add_nc_u32 v94, 0, v72
	v_dual_mov_b32 v56, v49 :: v_dual_add_nc_u32 v89, 0, v74
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_cmp_ge_i32_e64 s9, v83, v108
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s10, v109, v73
	.loc	1 951 21                        ; attention.py:951:21
	v_cmp_ge_i32_e64 s11, v83, v109
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s12, v110, v73
	.loc	1 951 21                        ; attention.py:951:21
	v_cmp_ge_i32_e64 s13, v83, v110
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s14, v111, v73
	.loc	1 951 21                        ; attention.py:951:21
	v_cmp_ge_i32_e64 s15, v83, v111
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s16, v112, v73
	.loc	1 951 21                        ; attention.py:951:21
	v_cmp_ge_i32_e64 s17, v83, v112
	.loc	1 944 30 is_stmt 1              ; attention.py:944:30
	v_dual_mov_b32 v54, v49 :: v_dual_add_nc_u32 v93, v68, v67
	v_dual_mov_b32 v55, v49 :: v_dual_add_nc_u32 v92, v68, v65
	v_dual_mov_b32 v107, v56 :: v_dual_mov_b32 v104, v53
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v106, v55 :: v_dual_add_nc_u32 v61, s40, v61
	v_dual_mov_b32 v105, v54 :: v_dual_mov_b32 v102, v51
	v_dual_mov_b32 v103, v52 :: v_dual_mov_b32 v100, v49
	v_dual_mov_b32 v101, v50 :: v_dual_add_nc_u32 v54, 2, v97
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s1, v97, v73
	.loc	1 951 21 is_stmt 0              ; attention.py:951:21
	v_cmp_ge_i32_e64 s3, v83, v97
	.loc	1 978 32 is_stmt 1              ; attention.py:978:32
	v_mov_b16_e32 v90.l, 0
	v_dual_mov_b32 v88, v98 :: v_dual_add_nc_u32 v75, s35, v75
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s4, v54, v73
	.loc	1 951 21 is_stmt 0              ; attention.py:951:21
	v_cmp_ge_i32_e64 s5, v83, v54
	...
	.loc	1 951 21 is_stmt 0              ; attention.py:951:21
	v_cmp_ge_i32_e64 s7, v83, v55
	.loc	1 945 21 is_stmt 1              ; attention.py:945:21
	v_mul_f32_e32 v55, s34, v100
	v_dual_mul_f32 v57, s34, v101 :: v_dual_mul_f32 v102, s34, v107
	v_mul_f32_e32 v94, s34, v103
	v_dual_mul_f32 v96, s34, v104 :: v_dual_mul_f32 v101, s34, v106
...
.Ltmp21:
	...
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v99, v59, v109 :: v_dual_and_b32 v50, 1, v50
...
; %bb.6:                                ; %Flow
	...
	v_dual_mov_b32 v19, v67 :: v_dual_mov_b32 v18, v70
.LBB0_7:                                ; %._crit_edge
	s_delay_alu instid0(VALU_DEP_1)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_vgpr, 124
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_none_causal_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.kd
