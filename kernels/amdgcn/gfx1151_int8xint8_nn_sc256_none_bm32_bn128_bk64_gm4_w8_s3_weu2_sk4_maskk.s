...
.Ltmp19:
	...
	v_perm_b32 v26, v22, v18, 0x5010400
	v_perm_b32 v22, v22, v18, 0x7030602
	v_perm_b32 v37, v23, v19, 0x7030602
	...
	v_lshlrev_b16 v37.l, 8, v72.l
	v_lshlrev_b16 v37.h, 8, v73.l
	v_lshlrev_b16 v41.l, 8, v74.l
	v_lshlrev_b16 v41.h, 8, v75.l
	v_lshlrev_b16 v43.l, 8, v78.l
	v_lshlrev_b16 v43.h, 8, v79.l
	v_or_b16 v18.l, v18.l, v26.l
	v_or_b16 v18.h, v18.h, v26.h
	v_perm_b32 v26, v33, v29, 0x5010400
	v_perm_b32 v28, v33, v29, 0x7030602
	v_perm_b32 v29, v34, v30, 0x5010400
	v_perm_b32 v30, v34, v30, 0x7030602
	v_perm_b32 v32, v35, v31, 0x5010400
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(1)
	ds_store_b64 v44, v[56:57] offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16_d16_hi v64, v20 offset:64
	ds_store_b16 v60, v21 offset:640
	ds_store_b16_d16_hi v60, v21 offset:704
	ds_store_b16 v65, v22
	ds_store_b16_d16_hi v65, v22 offset:64
	ds_store_b16 v66, v23
	ds_store_b16_d16_hi v66, v23 offset:64
	...
	v_lshlrev_b16 v26.l, 8, v37.l
	v_lshlrev_b16 v26.h, 8, v41.l
	v_lshlrev_b16 v28.l, 8, v42.l
	v_lshlrev_b16 v28.h, 8, v43.l
	v_lshlrev_b16 v29.l, 8, v56.l
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v44, v[58:59] offset:18432
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v64, v20 offset:8192
	ds_store_b16_d16_hi v64, v20 offset:8256
	ds_store_b16 v60, v21 offset:8832
	ds_store_b16_d16_hi v60, v21 offset:8896
	ds_store_b16 v65, v22 offset:8192
	ds_store_b16_d16_hi v65, v22 offset:8256
	ds_store_b16 v66, v23 offset:8192
	ds_store_b16_d16_hi v66, v23 offset:8256
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v41, v2, 6, v4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b32_e32 v57, 6, v1
	v_and_b32_e32 v1, 8, v0
	v_and_b32_e32 v58, 32, v0
	v_and_or_b32 v56, 0x1800, v3, v4
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_3:                                ; %Flow23
	...
	v_mul_lo_u32 v36, v16, s34
	v_mul_lo_u32 v37, v5, s34
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v62, s27, v39
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s18, s18, 24
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v63, s27, v27
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s1, s1, s18
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_cndmask_b32_e64 v62, 0x80000000, v64, s1
	...
	v_cndmask_b32_e64 v70, 0x80000000, v71, s1
	v_cndmask_b32_e64 v71, 0x80000000, v72, s1
	v_cndmask_b32_e64 v72, 0x80000000, v73, s1
	v_cndmask_b32_e64 v73, 0x80000000, v74, s1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	...
	v_add_nc_u32_e32 v63, s1, v42
	v_add_nc_u32_e32 v64, s1, v44
	v_add_nc_u32_e32 v65, s1, v43
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_lshl_b32 s18, s47, 11
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s45, s19, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s18, s18, 0
	s_waitcnt lgkmcnt(0)
	s_add_i32 s44, s18, 0x4000
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v124, v72, v76 :: v_dual_add_nc_u32 v143, s45, v49
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v118, v71, v78 :: v_dual_add_nc_u32 v145, s45, v51
	...
	v_dual_mul_f32 v80, v72, v80 :: v_dual_add_nc_u32 v147, s45, v53
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v79, v72, v79 :: v_dual_add_nc_u32 v144, s45, v50
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v11, v113, v86 :: v_dual_add_nc_u32 v146, s45, v52
	v_dual_fmac_f32 v13, v115, v88 :: v_dual_add_nc_u32 v148, s45, v54
	v_dual_fmac_f32 v14, v116, v89 :: v_dual_add_nc_u32 v149, s45, v55
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_10:
	...
	s_cmp_lt_i32 s1, s34
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v50, v36, s1, 1
	v_add_lshl_u32 v51, v37, s1, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v52, v35, s1, 1
	v_add_lshl_u32 v53, v34, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_clause 0x1
	buffer_load_u16 v50, v50, s[12:15], 0 offen
	buffer_load_u16 v66, v51, s[12:15], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v51, v33, s1, 1
	v_add_lshl_u32 v54, v31, s1, 1
	v_add_lshl_u32 v55, v29, s1, 1
	v_dual_cndmask_b32 v52, 0x80000000, v52 :: v_dual_cndmask_b32 v53, 0x80000000, v53
	v_add_lshl_u32 v56, v32, s1, 1
	v_add_lshl_u32 v57, v30, s1, 1
	v_add_lshl_u32 v58, v28, s1, 1
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s45, v78
	v_add_nc_u32_e32 v55, s45, v77
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v65, s11 :: v_dual_add_nc_u32 v56, s45, v76
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v58, s4 :: v_dual_add_nc_u32 v1, s44, v41
	v_dual_mov_b32 v60, s6 :: v_dual_add_nc_u32 v57, s45, v75
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[87:90], v56
	ds_load_b128 v[91:94], v57
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v63, s9 :: v_dual_add_nc_u32 v56, s44, v42
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[95:98], v1 offset:1024
	ds_load_b128 v[99:102], v1
	v_add_nc_u32_e32 v55, s44, v44
	ds_load_b128 v[103:106], v56 offset:1024
	ds_load_b128 v[107:110], v56
	v_add_nc_u32_e32 v1, s44, v43
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
.LBB0_12:
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v81, v41, v67 :: v_dual_and_b32 v0, 0x3f8, v0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v83, v41, v69
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xor_b32_e32 v0, v75, v0
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v80, v41, v66 :: v_dual_and_b32 v9, 0x380, v9
	v_dual_mul_f32 v79, v41, v44 :: v_dual_lshlrev_b32 v10, 6, v10
	v_mul_f32_e32 v77, v41, v42
	v_mul_f32_e32 v78, v41, v43
	v_mul_f32_e32 v82, v41, v68
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshl_or_b32 v0, v74, 10, v0
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v84, v41, v70
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v10, v42, v27, v18
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v27, 0, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v38, v84, v38, v20
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v29, v4, v11 :: v_dual_lshlrev_b32 v16, 16, v30
	v_mul_f32_e32 v11, v6, v11
	v_dual_mul_f32 v31, v4, v13 :: v_dual_lshlrev_b32 v10, 16, v35
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v12, 16, v33
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v33, v4, v15
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v13, v6, v13 :: v_dual_mul_f32 v28, v4, v10
	v_mul_f32_e32 v34, v4, v16
	v_mul_f32_e32 v30, v4, v12
	v_mul_f32_e32 v10, v6, v10
	v_dual_mul_f32 v15, v6, v15 :: v_dual_mul_f32 v32, v4, v14
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v1, v28, v1, v0
	v_fma_f32 v28, v30, v52, v3
	v_fma_f32 v30, v32, v54, v5
	v_fma_f32 v32, v34, v56, v17
	v_fma_f32 v34, v10, v58, v20
	v_fma_f32 v18, v29, v51, v2
	v_fma_f32 v11, v11, v59, v21
	v_fma_f32 v29, v31, v53, v8
	v_fma_f32 v35, v12, v60, v22
	v_fma_f32 v31, v33, v55, v7
	v_fma_f32 v13, v13, v61, v23
	v_fma_f32 v33, v4, v57, v9
	v_fma_f32 v36, v14, v62, v24
	v_fma_f32 v15, v15, v63, v25
	v_fma_f32 v16, v16, v64, v26
	v_fma_f32 v37, v6, v65, v19
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v0, v0, v1, s3
	v_cndmask_b32_e64 v1, v20, v34, s3
	v_cndmask_b32_e64 v2, v2, v18, s3
	v_cndmask_b32_e64 v4, v3, v28, s3
	v_cndmask_b32_e64 v3, v21, v11, s3
	v_cndmask_b32_e64 v6, v8, v29, s3
	v_cndmask_b32_e64 v8, v5, v30, s3
	v_cndmask_b32_e64 v5, v22, v35, s3
	v_cndmask_b32_e64 v10, v7, v31, s3
	v_cndmask_b32_e64 v7, v23, v13, s3
	v_cndmask_b32_e64 v12, v17, v32, s3
	v_cndmask_b32_e64 v14, v9, v33, s3
	v_cndmask_b32_e64 v9, v24, v36, s3
	v_cndmask_b32_e64 v11, v25, v15, s3
	v_cndmask_b32_e64 v13, v26, v16, s3
	v_cndmask_b32_e64 v15, v19, v37, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 150
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 48
