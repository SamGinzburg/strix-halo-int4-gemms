	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp21:
	...
	v_and_or_b32 v22, 0x438, v9, v10
	v_dual_mov_b32 v44, 0 :: v_dual_and_b32 v9, 56, v9
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_subrev_nc_u32_e32 v18, s20, v4
	...
	v_or3_b32 v30, v11, v9, v10
	v_or_b32_e32 v9, s3, v5
	v_or_b32_e32 v10, s3, v3
	v_dual_mov_b32 v38, 0 :: v_dual_lshlrev_b32 v19, 1, v2
	...
	v_dual_mov_b32 v42, 0 :: v_dual_add_nc_u32 v11, 64, v9
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v12, 64, v10
	v_cmp_gt_i32_e32 vcc_lo, 0x80, v10
	v_cmp_gt_i32_e64 s0, 0x80, v9
	v_mad_u64_u32 v[9:10], null, s17, v1, v[3:4]
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v23, 8, v22
	v_xor_b32_e32 v24, 16, v22
	v_xor_b32_e32 v25, 24, v22
	v_xor_b32_e32 v26, 32, v22
	v_xor_b32_e32 v27, 40, v22
	v_xor_b32_e32 v28, 48, v22
	v_xor_b32_e32 v29, 56, v22
	v_xor_b32_e32 v31, 8, v30
	v_xor_b32_e32 v32, 16, v30
	v_xor_b32_e32 v33, 24, v30
	v_xor_b32_e32 v34, 32, v30
	v_xor_b32_e32 v35, 40, v30
	v_xor_b32_e32 v36, 48, v30
	v_xor_b32_e32 v37, 56, v30
	v_cmp_gt_i32_e64 s2, 0x80, v11
	v_mad_u64_u32 v[10:11], null, s17, v2, v[5:6]
	v_mov_b32_e32 v7, v1
	v_cmp_gt_i32_e64 s1, 0x80, v12
	v_mad_u64_u32 v[11:12], null, s17, v4, v[5:6]
	v_dual_mov_b32 v40, 0 :: v_dual_and_b32 v17, 2, v8
	v_mov_b32_e32 v12, 0
	v_sub_nc_u32_e32 v15, s17, v3
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v20, 0, v20
	v_add_nc_u32_e32 v21, 0, v6
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v22, 0, v22
	v_add_nc_u32_e32 v23, 0, v23
	v_dual_mov_b32 v39, 0 :: v_dual_add_nc_u32 v24, 0, v24
	...
	v_dual_mov_b32 v2, v1 :: v_dual_add_nc_u32 v37, 0, v37
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v6, v1
	v_sub_nc_u32_e32 v16, s17, v5
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v8, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v85, v19, s[16:19], 0 offen
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	s_sub_i32 s4, s30, 64
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	s_add_i32 s28, s28, -1
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e64 s3, s4, v16
	...
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e64 s3, s30, v15
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	buffer_load_b32 v52, v45, s[20:23], 0 offen
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	s_clause 0x1
	buffer_load_b64 v[45:46], v46, s[24:27], 0 offen
	buffer_load_b64 v[47:48], v47, s[24:27], 0 offen
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e64 s4, s30, v16
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt vmcnt(3)
	ds_store_b32 v20, v52 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	s_waitcnt vmcnt(1)
	ds_store_2addr_stride64_b64 v21, v[45:46], v[47:48] offset1:8
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	s_clause 0x1
	buffer_load_b64 v[45:46], v50, s[24:27], 0 offen
	buffer_load_b64 v[47:48], v51, s[24:27], 0 offen
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_add_nc_u32_e32 v50, v17, v18
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_b64 v[53:54], v22 offset:8192
	ds_load_b64 v[55:56], v23 offset:8192
	ds_load_b64 v[57:58], v24 offset:8192
	ds_load_b64 v[59:60], v25 offset:8192
	ds_load_b64 v[61:62], v26 offset:8192
	ds_load_b64 v[63:64], v27 offset:8192
	ds_load_b64 v[65:66], v28 offset:8192
	ds_load_b64 v[67:68], v29 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[69:70], v30
	ds_load_b64 v[71:72], v31
	ds_load_b64 v[73:74], v32
	ds_load_b64 v[75:76], v33
	ds_load_b64 v[77:78], v34
	ds_load_b64 v[79:80], v35
	ds_load_b64 v[81:82], v36
	ds_load_b64 v[83:84], v37
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v20, v49 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v21, v[45:46], v[47:48] offset1:8
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v86, v50, s[8:11], 0 offen
	buffer_load_u16 v87, v50, s[8:11], 0 offen offset:4
	buffer_load_u16 v88, v50, s[8:11], 0 offen offset:8
	buffer_load_u16 v89, v50, s[8:11], 0 offen offset:12
	buffer_load_u16 v90, v50, s[8:11], 0 offen offset:16
	buffer_load_u16 v91, v50, s[8:11], 0 offen offset:20
	buffer_load_u16 v92, v50, s[8:11], 0 offen offset:24
	buffer_load_u16 v93, v50, s[8:11], 0 offen offset:28
	...
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[53:54], v30
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_b64 v[55:56], v22 offset:8192
	ds_load_b64 v[57:58], v23 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[59:60], v31
	ds_load_b64 v[61:62], v32
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_b64 v[63:64], v24 offset:8192
	ds_load_b64 v[65:66], v25 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[67:68], v33
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_b64 v[69:70], v26 offset:8192
	ds_load_b64 v[71:72], v27 offset:8192
	ds_load_b64 v[73:74], v28 offset:8192
	ds_load_b64 v[75:76], v29 offset:8192
	.loc	1 191 26                        ; generate_amdgcn.py:191:26
	ds_load_b64 v[77:78], v34
	ds_load_b64 v[79:80], v35
	ds_load_b64 v[81:82], v36
	...
	v_dual_fmac_f32 v44, v46, v54 :: v_dual_add_nc_u32 v19, 2, v19
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v50, v85, v50
	v_dual_mul_f32 v49, v85, v49 :: v_dual_add_nc_u32 v18, s29, v18
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v12, v45, v53 :: v_dual_lshlrev_b32 v55, 16, v88
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v40, v50, v58 :: v_dual_lshlrev_b32 v59, 16, v92
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v43, v47, v55 :: v_dual_lshlrev_b32 v60, 16, v93
	v_dual_fmac_f32 v42, v48, v56 :: v_dual_fmac_f32 v41, v49, v57
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_fmac_f32 v39, v51, v59 :: v_dual_fmac_f32 v38, v52, v60
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_max_f32 v6, v40, v40 :: v_dual_max_f32 v1, 0, v1
	v_dual_max_f32 v4, v42, v42 :: v_dual_max_f32 v7, v39, v39
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_max_f32 v5, 0, v5 :: v_dual_max_f32 v6, 0, v6
	v_max_f32_e32 v16, 0, v8
	v_dual_max_f32 v4, 0, v4 :: v_dual_max_f32 v15, 0, v7
	.loc	1 214 19                        ; generate_amdgcn.py:214:19
	v_dual_mul_f32 v12, v1, v1 :: v_dual_mul_f32 v11, v2, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v9, v3, v3 :: v_dual_mul_f32 v10, v5, v5
	v_dual_mul_f32 v7, v4, v4 :: v_dual_mul_f32 v8, v6, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v6, v15, v15 :: v_dual_mul_f32 v5, v16, v16
...
.LBB0_7:                                ; %._crit_edge
	...
	v_dual_mov_b32 v10, 0x7632 :: v_dual_and_b32 v9, 1, v9
	...
	v_dual_cndmask_b32 v6, v7, v1 :: v_dual_cndmask_b32 v7, v1, v7
	v_permlanex16_b32 v1, v3, s0, 0xfedcba98 op_sel:[1,0]
	v_and_b32_e32 v3, 0x5040504, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v4, v4, 4, v4
	v_permlanex16_b32 v6, v6, s0, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_perm_b32 v0, v1, v12, v3
	v_and_b32_e32 v4, 0x7060706, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_perm_b32 v2, v6, v7, v3
	v_perm_b32 v1, v1, v12, v4
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 94
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.kd
