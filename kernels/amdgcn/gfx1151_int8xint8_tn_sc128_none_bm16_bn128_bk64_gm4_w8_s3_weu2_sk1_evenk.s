...
.Ltmp21:
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v26, v8, s[4:7], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
...
.LBB0_3:                                ; %Flow81
	...
	v_or_b32_e32 v18, s36, v28
	s_ashr_i32 s0, s25, 7
	v_or_b32_e32 v26, s33, v5
	v_or_b32_e32 v25, s33, v10
	v_or_b32_e32 v24, s33, v11
	v_mul_lo_u32 v27, v18, s0
	v_or_b32_e32 v22, s33, v12
	v_or_b32_e32 v20, s33, v13
...
.Ltmp22:
	...
	s_lshr_b32 s1, s24, 6
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v5, 0xa0, v4
.Ltmp23:
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	s_add_i32 s11, s1, -2
	v_subrev_nc_u32_e32 v34, s14, v5
	s_add_i32 s1, 0, 0x4400
	v_subrev_nc_u32_e32 v35, s14, v1
	v_mov_b32_e32 v1, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	buffer_load_u16 v86, v38, s[28:31], 0 offen
	buffer_load_u16 v87, v39, s[28:31], 0 offen
	buffer_load_u16 v88, v40, s[28:31], 0 offen
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[45:48], v35, s[20:23], 0 offen
	buffer_load_b128 v[49:52], v34, s[20:23], 0 offen
	s_mov_b32 s18, s10
	s_mov_b32 s10, s1
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v37, s18, v28
	s_mov_b32 s1, s19
	v_add_nc_u32_e32 v38, s18, v32
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v39, s1, v31, v28
	...
	v_dual_mul_f32 v58, v53, v58 :: v_dual_lshlrev_b32 v55, 16, v87
	v_mul_f32_e32 v57, v53, v57
	v_mul_f32_e32 v61, v53, v61
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v10, v54, v37 :: v_dual_add_nc_u32 v183, s14, v30
...
.LBB0_10:
	...
	v_dual_cndmask_b32 v32, 0x80000000, v34 :: v_dual_cndmask_b32 v41, 0x80000000, v35
	v_add_lshl_u32 v34, v22, s4, 1
	v_add_lshl_u32 v39, v21, s4, 1
	v_add_lshl_u32 v40, v19, s4, 1
	s_and_b32 s17, s17, 0xffff
	v_cndmask_b32_e32 v42, 0x80000000, v36, vcc_lo
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v34, 0x80000000, v34 :: v_dual_cndmask_b32 v43, 0x80000000, v39
	v_dual_cndmask_b32 v44, 0x80000000, v40 :: v_dual_mov_b32 v45, 0
	s_clause 0x7
	buffer_load_u16 v39, v30, s[16:19], 0 offen
	buffer_load_u16 v40, v31, s[16:19], 0 offen
	buffer_load_u16 v35, v32, s[16:19], 0 offen
	buffer_load_u16 v36, v34, s[16:19], 0 offen
	buffer_load_u16 v32, v41, s[16:19], 0 offen
	buffer_load_u16 v34, v42, s[16:19], 0 offen
	buffer_load_u16 v30, v43, s[16:19], 0 offen
	buffer_load_u16 v31, v44, s[16:19], 0 offen
...
; %bb.11:
	...
	v_perm_b32 v33, v42, v33, 0xc0c0004
	s_waitcnt lgkmcnt(17)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 184
