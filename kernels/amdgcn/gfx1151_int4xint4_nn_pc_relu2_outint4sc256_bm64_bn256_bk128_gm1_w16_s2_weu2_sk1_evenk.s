	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v4, v8 :: v_dual_lshlrev_b32 v65, 4, v85
	v_dual_mov_b32 v7, v8 :: v_dual_and_b32 v88, 0xe0, v0
	v_dual_mov_b32 v24, v8 :: v_dual_lshlrev_b32 v9, 3, v0
	v_dual_mov_b32 v5, v8 :: v_dual_and_b32 v10, 56, v90
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 127 32                        ; generate_amdgcn.py:127:32
	v_lshrrev_b32_e32 v91, 1, v88
...
.Ltmp11:
	...
	s_cvt_u32_f32 s5, s5
	v_dual_mov_b32 v10, v8 :: v_dual_add_nc_u32 v43, 0, v9
	v_mov_b32_e32 v9, v8
	...
	v_mad_u64_u32 v[1:2], null, s17, v84, v[65:66]
	...
	.loc	1 154 30                        ; generate_amdgcn.py:154:30
	v_mad_u64_u32 v[2:3], null, s24, v34, v[33:34]
	s_delay_alu instid0(VALU_DEP_1)
	v_add3_u32 v2, s16, s2, v2
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	s_add_i32 s2, s20, s14
	...
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v43, v[45:46] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v44, v[35:38]
	s_waitcnt vmcnt(0)
	ds_store_b128 v44, v[39:42] offset:8192
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cbranch_scc1 .LBB0_3
; %bb.1:                                ; %.lr.ph
	.loc	1 0 9 is_stmt 0                 ; generate_amdgcn.py:0:9
	v_dual_mov_b32 v9, 0 :: v_dual_add_nc_u32 v2, s16, v84
...
.Ltmp13:
	...
	v_dual_mov_b32 v14, v9 :: v_dual_add_nc_u32 v3, 0x60, v2
	v_and_b32_e32 v1, 0x438, v1
...
.Ltmp15:
	...
	v_lshl_or_b32 v4, v85, 6, v1
	v_sub_nc_u32_e64 v1, s14, 2 clamp
	...
	v_dual_mov_b32 v28, v9 :: v_dual_add_nc_u32 v53, 0, v11
	v_mov_b32_e32 v11, v9
	v_mul_lo_u32 v5, s17, v2
	v_add_nc_u32_e32 v2, s19, v34
	v_xor_b32_e32 v8, 24, v4
	v_xor_b32_e32 v10, 32, v4
	v_xor_b32_e32 v12, 48, v4
	v_add_nc_u32_e32 v48, 0, v4
	v_mad_u64_u32 v[1:2], null, s24, v2, s[16:17]
	v_add3_u32 v2, v3, s15, v65
	v_add3_u32 v3, v5, s15, v65
	v_xor_b32_e32 v5, 56, v4
	s_lshl_b32 s15, s22, 8
	v_dual_mov_b32 v16, v9 :: v_dual_add_nc_u32 v49, 0, v6
	v_subrev_nc_u32_e32 v45, s15, v2
	v_subrev_nc_u32_e32 v46, s15, v3
	v_add3_u32 v47, v1, v33, 64
	v_dual_mov_b32 v25, v9 :: v_dual_add_nc_u32 v50, 0, v7
	v_dual_mov_b32 v26, v9 :: v_dual_add_nc_u32 v51, 0, v8
	v_dual_mov_b32 v27, v9 :: v_dual_add_nc_u32 v52, 0, v10
	v_dual_mov_b32 v29, v9 :: v_dual_add_nc_u32 v54, 0, v12
	v_dual_mov_b32 v30, v9 :: v_dual_add_nc_u32 v55, 0, v5
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	buffer_load_b64 v[41:42], v47, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	buffer_load_b128 v[33:36], v46, s[12:15], 0 offen
	buffer_load_b128 v[37:40], v45, s[12:15], 0 offen
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v57, v92 offset:1280
	ds_load_u8 v59, v92 offset:1024
	ds_load_u8 v60, v92 offset:1792
	ds_load_u8 v61, v92 offset:1536
	ds_load_u8 v62, v92 offset:256
	ds_load_u8 v63, v92
	ds_load_u8 v56, v92 offset:768
	ds_load_u8 v58, v92 offset:512
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[66:69], v48 offset0:32 offset1:36
	ds_load_2addr_stride64_b64 v[70:73], v49 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	ds_load_u8 v64, v92 offset:1408
	ds_load_u8 v78, v92 offset:1152
	ds_load_u8 v79, v92 offset:1920
	ds_load_u8 v80, v92 offset:1664
	ds_load_u8 v81, v92 offset:384
	ds_load_u8 v82, v92 offset:128
	ds_load_u8 v83, v92 offset:896
	ds_load_u8 v87, v92 offset:640
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[74:77], v50 offset0:32 offset1:36
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	...
	ds_load_u8 v58, v92 offset:3328
	ds_load_u8 v93, v92 offset:3072
	ds_load_u8 v94, v92 offset:3840
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	s_cmp_lg_u32 s16, 0
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v56, v56, 16, v63
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v63, v78, v64, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v64, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v80, v82, v81, 0xc0c0004
	ds_load_u8 v78, v92 offset:3584
	ds_load_u8 v79, v92 offset:2304
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v82, v87, v83, 0xc0c0004
	v_lshl_or_b32 v64, v64, 16, v63
	v_wmma_i32_16x16x16_iu4 v[9:16], v[56:57], v[66:67], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[56:57], v[68:69], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v87, v92 offset:3968
	ds_load_u8 v95, v92 offset:3456
	v_lshl_or_b32 v63, v82, 16, v80
	ds_load_u8 v80, v92 offset:2560
	ds_load_u8 v82, v92 offset:5376
	v_wmma_i32_16x16x16_iu4 v[25:32], v[63:64], v[66:67], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[63:64], v[68:69], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v63, v92 offset:3200
	ds_load_u8 v64, v92 offset:3712
	ds_load_u8 v66, v92 offset:2944
	ds_load_u8 v67, v92 offset:2432
	ds_load_u8 v68, v92 offset:2176
	ds_load_u8 v69, v92 offset:2688
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v63, v63, v95, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v64, v64, v87, 0xc0c0004
	ds_load_u8 v87, v92 offset:7424
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v67, v68, v67, 0xc0c0004
	ds_load_u8 v68, v92 offset:7168
	ds_load_u8 v83, v92 offset:2816
	ds_load_u8 v81, v92 offset:2048
	v_perm_b32 v56, v93, v58, 0xc0c0004
	v_perm_b32 v57, v78, v94, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v66, v69, v66, 0xc0c0004
	v_lshl_or_b32 v64, v64, 16, v63
	ds_load_u8 v58, v92 offset:5120
	ds_load_u8 v78, v92 offset:5888
	v_lshl_or_b32 v57, v57, 16, v56
	v_lshl_or_b32 v63, v66, 16, v67
	ds_load_u8 v94, v92 offset:6016
	ds_load_u8 v95, v92 offset:5504
	ds_load_u8 v69, v92 offset:7936
	ds_load_u8 v66, v92 offset:7680
	ds_load_u8 v67, v92 offset:6400
	v_wmma_i32_16x16x16_iu4 v[25:32], v[63:64], v[70:71], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[63:64], v[72:73], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v80, v80, v83, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v79, v81, v79, 0xc0c0004
	ds_load_u8 v83, v92 offset:4352
	v_lshl_or_b32 v56, v80, 16, v79
	ds_load_u8 v79, v92 offset:4096
	ds_load_u8 v80, v92 offset:4864
	v_wmma_i32_16x16x16_iu4 v[9:16], v[56:57], v[70:71], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[56:57], v[72:73], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v63, v92 offset:5248
	ds_load_u8 v64, v92 offset:5760
	ds_load_u8 v70, v92 offset:4992
	ds_load_u8 v71, v92 offset:4480
	ds_load_u8 v72, v92 offset:4224
	ds_load_u8 v73, v92 offset:4736
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v63, v63, v95, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v64, v64, v94, 0xc0c0004
	ds_load_u8 v94, v92 offset:8064
	ds_load_u8 v95, v92 offset:7552
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v72, v71, 0xc0c0004
	ds_load_u8 v72, v92 offset:8192
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v70, v73, v70, 0xc0c0004
	ds_load_u8 v73, v92 offset:8960
	ds_load_u8 v81, v92 offset:5632
	ds_load_u8 v93, v92 offset:4608
	v_perm_b32 v56, v58, v82, 0xc0c0004
	v_perm_b32 v79, v79, v83, 0xc0c0004
	ds_load_u8 v58, v92 offset:6144
	ds_load_u8 v82, v92 offset:9472
	ds_load_u8 v83, v92 offset:9728
	v_lshl_or_b32 v64, v64, 16, v63
	v_lshl_or_b32 v63, v70, 16, v71
	ds_load_u8 v70, v92 offset:8704
	ds_load_u8 v71, v92 offset:11520
	v_wmma_i32_16x16x16_iu4 v[25:32], v[63:64], v[74:75], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[63:64], v[76:77], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v57, v81, v78, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v80, v93, v80, 0xc0c0004
	ds_load_u8 v81, v92 offset:6656
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v58, v58, v67, 0xc0c0004
	v_lshl_or_b32 v57, v57, 16, v56
	v_lshl_or_b32 v56, v80, 16, v79
	ds_load_u8 v79, v92 offset:9216
	ds_load_u8 v80, v92 offset:9984
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v70, v70, v73, 0xc0c0004
	ds_load_u8 v73, v92 offset:12544
	v_wmma_i32_16x16x16_iu4 v[9:16], v[56:57], v[74:75], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[56:57], v[76:77], v[17:24] neg_lo:[1,1,0]
	v_perm_b32 v56, v68, v87, 0xc0c0004
	ds_load_u8 v87, v92 offset:10752
	ds_load_u8 v93, v92 offset:8448
	ds_load_u8 v78, v92 offset:6912
	ds_load_u8 v63, v92 offset:7296
	ds_load_u8 v64, v92 offset:7808
	ds_load_u8 v74, v92 offset:7040
	ds_load_u8 v75, v92 offset:6528
	ds_load_u8 v76, v92 offset:6272
	ds_load_u8 v77, v92 offset:6784
	v_perm_b32 v57, v66, v69, 0xc0c0004
	ds_load_u8 v68, v92 offset:11264
	ds_load_u8 v66, v92 offset:12032
	v_lshl_or_b32 v57, v57, 16, v56
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v72, v72, v93, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	ds_load_u8 v76, v92 offset:13312
	ds_load_u8 v77, v92 offset:14080
	v_lshl_or_b32 v56, v69, 16, v58
	v_perm_b32 v58, v63, v95, 0xc0c0004
	v_perm_b32 v63, v64, v94, 0xc0c0004
	ds_load_u8 v95, v92 offset:9600
	ds_load_u8 v96, v92 offset:9344
	ds_load_u8 v69, v92 offset:10240
	ds_load_u8 v81, v92 offset:11008
	v_wmma_i32_16x16x16_iu4 v[17:24], v[56:57], v[61:62], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[56:57], v[59:60], v[9:16] neg_lo:[1,1,0]
	v_lshl_or_b32 v64, v63, 16, v58
	v_lshl_or_b32 v63, v74, 16, v75
	ds_load_u8 v74, v92 offset:10112
	ds_load_u8 v75, v92 offset:9856
	ds_load_u8 v94, v92 offset:13568
	ds_load_u8 v93, v92 offset:13440
	...
	ds_load_u8 v62, v92 offset:8576
	ds_load_u8 v63, v92 offset:8320
	ds_load_u8 v64, v92 offset:9088
	ds_load_u8 v97, v92 offset:8832
	ds_load_u8 v98, v92 offset:13824
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[56:59], v52 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_perm_b32 v60, v79, v82, 0xc0c0004
	v_perm_b32 v61, v83, v80, 0xc0c0004
	ds_load_u8 v80, v92 offset:12800
	ds_load_u8 v67, v92 offset:11776
	ds_load_u8 v78, v92 offset:10496
	ds_load_u8 v82, v92 offset:15360
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v79, v96, v95, 0xc0c0004
	v_lshl_or_b32 v61, v61, 16, v60
	v_lshl_or_b32 v60, v70, 16, v72
	ds_load_u8 v70, v92 offset:12288
	ds_load_u8 v72, v92 offset:13056
	ds_load_u8 v83, v92 offset:16128
	v_perm_b32 v68, v68, v71, 0xc0c0004
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v92 offset:15616
	ds_load_u8 v71, v92 offset:14848
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	v_perm_b32 v76, v76, v94, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v64, v97, v64, 0xc0c0004
	v_lshl_or_b32 v63, v74, 16, v79
	s_waitcnt lgkmcnt(9)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[60:61], v[56:57], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[60:61], v[58:59], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v60, v92 offset:11904
	ds_load_u8 v61, v92 offset:11648
	v_lshl_or_b32 v62, v64, 16, v62
	ds_load_u8 v64, v92 offset:15872
	ds_load_u8 v74, v92 offset:12160
	v_perm_b32 v79, v87, v81, 0xc0c0004
	ds_load_u8 v87, v92 offset:13696
	s_waitcnt lgkmcnt(12)
	...
	ds_load_u8 v56, v92 offset:11392
	ds_load_u8 v57, v92 offset:11136
	ds_load_u8 v58, v92 offset:10880
	ds_load_u8 v59, v92 offset:14592
	ds_load_u8 v62, v92 offset:14336
	ds_load_u8 v63, v92 offset:15104
	ds_load_u8 v67, v92 offset:10624
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v69, v69, v78, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v94, v70, v73, 0xc0c0004
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v72, v80, v72, 0xc0c0004
	ds_load_u8 v73, v92 offset:13184
	ds_load_u8 v80, v92 offset:12928
	ds_load_u8 v81, v92 offset:14208
	v_lshl_or_b32 v72, v72, 16, v94
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v97, v60, v74, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v96, v56, v61, 0xc0c0004
	ds_load_u8 v56, v92 offset:16000
	ds_load_u8 v60, v92 offset:15744
	ds_load_u8 v61, v92 offset:15488
	v_perm_b32 v64, v64, v83, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v83, v62, v59, 0xc0c0004
	ds_load_u8 v59, v92 offset:12416
	...
	ds_load_u8 v82, v92 offset:12672
	ds_load_u8 v62, v92 offset:16256
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v80, v80, v73, 0xc0c0004
	v_lshl_or_b32 v75, v64, 16, v75
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v67, v78, v67, 0xc0c0004
	v_perm_b32 v78, v58, v57, 0xc0c0004
	ds_load_u8 v57, v92 offset:14720
	ds_load_u8 v58, v92 offset:14464
	ds_load_u8 v70, v92 offset:13952
	v_perm_b32 v77, v98, v77, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v82, v59, v82, 0xc0c0004
	ds_load_u8 v98, v92 offset:14976
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v100, v56, v62, 0xc0c0004
	v_perm_b32 v95, v71, v63, 0xc0c0004
	v_perm_b32 v99, v61, v60, 0xc0c0004
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[60:63], v54 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v71, v66, 16, v68
	v_lshl_or_b32 v73, v77, 16, v76
	v_lshl_or_b32 v76, v78, 16, v67
	v_lshl_or_b32 v77, v97, 16, v96
	v_lshl_or_b32 v78, v80, 16, v82
	v_lshl_or_b32 v74, v95, 16, v83
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v101, v58, v57, 0xc0c0004
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[56:59], v53 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v81, v70, v81, 0xc0c0004
	v_lshl_or_b32 v70, v79, 16, v69
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	ds_load_2addr_stride64_b64 v[66:69], v55 offset0:32 offset1:36
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v64, v98, v93, 0xc0c0004
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt lgkmcnt(0)
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v79, v81, 16, v87
	v_lshl_or_b32 v81, v100, 16, v99
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_barrier
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_lshl_or_b32 v80, v64, 16, v101
	.loc	1 154 22                        ; generate_amdgcn.py:154:22
	s_waitcnt vmcnt(2)
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v44, v[37:40] offset:8192
	.loc	1 159 23                        ; generate_amdgcn.py:159:23
	v_wmma_i32_16x16x16_iu4 v[9:16], v[70:71], v[56:57], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[76:77], v[56:57], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[70:71], v[58:59], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[76:77], v[58:59], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[72:73], v[60:61], v[9:16] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[78:79], v[62:63], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.LBB0_8:
	...
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
	buffer_load_u16 v37, v36, s[4:7], 0 offen
	...
	s_clause 0x9
	buffer_load_u16 v38, v35, s[4:7], 0 offen
...
.Ltmp61:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 102
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 26
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     28
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
