	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[3:4], null, s27, v2, v[10:11]
...
.Ltmp19:
	...
	v_mad_u64_u32 v[4:5], null, v7, s7, v[4:5]
.Ltmp20:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:154:22 ]
	s_ashr_i32 s6, s6, 5
.Ltmp21:
	...
	s_cmp_gt_i32 s21, 31
	.loc	1 193 34                        ; generate_amdgcn.py:193:34
	s_mul_i32 s22, s27, s18
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	s_cselect_b32 s2, -1, 0
	.loc	1 171 26                        ; generate_amdgcn.py:171:26
	s_and_b32 s5, s4, s5
	.loc	1 193 34                        ; generate_amdgcn.py:193:34
	v_add3_u32 v3, s22, s26, v3
	.loc	1 171 26                        ; generate_amdgcn.py:171:26
	...
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	buffer_load_b32 v5, v3, s[36:39], 0 offen
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_bfe_i32 v3, v0, 7, 1
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	v_add_nc_u32_e32 v90, 0, v6
	s_mov_b32 s5, -1
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	s_cmp_gt_i32 s21, 63
	...
	v_add_nc_u32_e32 v89, 0, v3
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_lshrrev_b32_e32 v3, 4, v0
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt vmcnt(1)
	ds_store_b8 v89, v4 offset:2048
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(0)
	ds_store_b32 v90, v5
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
...
.LBB0_3:                                ; %Flow335
	...
	v_or_b32_e32 v82, 62, v3
	v_or_b32_e32 v81, 0x7e, v3
	v_dual_mov_b32 v17, 0 :: v_dual_lshlrev_b32 v88, 4, v0
	v_bfe_i32 v86, v0, 3, 1
	v_or_b32_e32 v85, 0x3f0, v0
	v_or_b32_e32 v87, 0x7f0, v0
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v84, 0, v9
...
; %bb.4:                                ; %.lr.ph
	...
	s_add_i32 s34, s18, 16
	v_sub_nc_u32_e32 v91, s7, v2
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v2, s34, v2
	v_dual_mov_b32 v80, 0 :: v_dual_and_b32 v3, 0x70, v88
	v_dual_mov_b32 v78, 0 :: v_dual_lshlrev_b32 v5, 1, v81
	v_dual_mov_b32 v79, 0 :: v_dual_add_nc_u32 v6, s33, v9
	...
	v_dual_mov_b32 v72, 0 :: v_dual_add_nc_u32 v1, s33, v1
	v_xor_b32_e32 v4, 8, v3
	v_add3_u32 v2, v2, s17, v10
	v_subrev_nc_u32_e32 v93, s0, v5
	v_subrev_nc_u32_e32 v94, s0, v7
	s_lshl_b32 s0, s16, 7
	s_mov_b32 s16, 0
	v_mad_u64_u32 v[11:12], null, s7, v1, v[9:10]
	s_mov_b32 s17, s16
	s_mov_b32 s18, s16
	s_mov_b32 s19, s16
	s_mov_b32 s20, s16
	...
	s_lshl_b32 s48, s27, 1
	s_lshl_b32 s49, s27, 4
	s_mov_b32 s44, s12
	s_mov_b32 s45, s13
	s_mov_b32 s46, s30
	s_mov_b32 s47, s31
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v102, s35, v93
	.loc	1 168 18                        ; generate_amdgcn.py:168:18
	buffer_load_u16 v106, v95, s[44:47], 0 offen
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e32 vcc_lo, s34, v91
	...
	s_cmp_lg_u32 s5, 0
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_cndmask_b32_e64 v12, 0x80000000, v13, s0
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v93, s48, v93
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	...
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x6
	buffer_load_u16 v107, v102, s[40:43], 0 offen
	buffer_load_u16 v105, v102, s[40:43], 0 offen offset:4
	buffer_load_u16 v104, v102, s[40:43], 0 offen offset:8
	buffer_load_u16 v103, v102, s[40:43], 0 offen offset:12
	buffer_load_u16 v189, v102, s[40:43], 0 offen offset:16
	buffer_load_u16 v190, v102, s[40:43], 0 offen offset:20
	buffer_load_u16 v191, v102, s[40:43], 0 offen offset:24
	...
	ds_load_u8 v173, v84 offset:640
	ds_load_u8 v174, v84 offset:512
	ds_load_u8 v170, v84 offset:768
	ds_load_u8 v165, v84 offset:784
	ds_load_u8 v172, v84 offset:896
	ds_load_u8 v166, v84 offset:912
	ds_load_u8 v157, v84 offset:928
	...
	ds_load_u8 v158, v84 offset:672
	...
	ds_load_u8 v135, v84 offset:592
	ds_load_u8 v126, v84 offset:608
	ds_load_u8 v111, v84 offset:624
	ds_load_u8 v159, v84 offset:800
	ds_load_u8 v152, v84 offset:816
	ds_load_u8 v143, v84 offset:832
	ds_load_u8 v136, v84 offset:848
	ds_load_u8 v127, v84 offset:864
	ds_load_u8 v112, v84 offset:880
	ds_load_u8 v177, v84
	...
	ds_load_u8 v175, v84 offset:400
	...
	ds_load_u8 v176, v84 offset:272
	...
	ds_load_u8 v181, v84 offset:1024
	ds_load_u8 v183, v84 offset:1152
	ds_load_u8 v119, v84 offset:1136
	ds_load_u8 v182, v84 offset:1408
	ds_load_u8 v184, v84 offset:1280
	v_perm_b32 v173, v174, v173, 0xc0c0004
	ds_load_u8 v174, v84 offset:1968
	s_waitcnt lgkmcnt(50)
	v_perm_b32 v179, v179, v180, 0xc0c0004
	ds_load_u8 v180, v84 offset:1296
	ds_load_u8 v214, v84 offset:1504
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v185, v185, v187, 0xc0c0004
	ds_load_u8 v187, v84 offset:1424
	v_perm_b32 v175, v176, v175, 0xc0c0004
	ds_load_u8 v176, v84 offset:1440
	...
	ds_load_u8 v159, v84 offset:1088
	...
	v_perm_b32 v180, v180, v187, 0xc0c0004
	ds_load_u8 v154, v84 offset:1376
	ds_load_u8 v187, v84 offset:1248
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v176, v194, v176, 0xc0c0004
	...
	v_perm_b32 v174, v208, v174, 0xc0c0004
	...
	v_perm_b32 v159, v159, v206, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v171, v216, v171, 0xc0c0004
	v_perm_b32 v206, v135, v134, 0xc0c0004
	v_perm_b32 v216, v136, v133, 0xc0c0004
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v183, v210, v183, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v210, v161, v178, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v194, v153, v194, 0xc0c0004
	v_perm_b32 v221, v126, v125, 0xc0c0004
	v_perm_b32 v222, v127, v124, 0xc0c0004
	v_perm_b32 v223, v130, v128, 0xc0c0004
	v_perm_b32 v224, v132, v131, 0xc0c0004
	v_perm_b32 v199, v204, v199, 0xc0c0004
	v_perm_b32 v184, v211, v184, 0xc0c0004
	v_perm_b32 v214, v154, v214, 0xc0c0004
	v_perm_b32 v225, v111, v110, 0xc0c0004
	v_perm_b32 v129, v112, v129, 0xc0c0004
	...
	v_lshl_or_b32 v154, v170, 16, v173
	v_lshl_or_b32 v153, v179, 16, v177
	v_lshl_or_b32 v162, v165, 16, v167
	v_lshl_or_b32 v161, v175, 16, v169
	v_lshl_or_b32 v188, v205, 16, v193
	v_lshl_or_b32 v170, v157, 16, v158
	...
	v_perm_b32 v207, v207, v187, 0xc0c0004
	v_lshl_or_b32 v186, v186, 16, v185
	v_lshl_or_b32 v185, v182, 16, v181
	v_lshl_or_b32 v187, v180, 16, v172
	v_lshl_or_b32 v201, v200, 16, v164
	v_lshl_or_b32 v200, v176, 16, v168
	v_lshl_or_b32 v203, v174, 16, v156
	v_lshl_or_b32 v202, v166, 16, v160
	v_lshl_or_b32 v209, v209, 16, v197
	v_lshl_or_b32 v208, v171, 16, v159
	v_lshl_or_b32 v211, v183, 16, v198
	v_lshl_or_b32 v210, v194, 16, v210
	v_lshl_or_b32 v213, v222, 16, v221
	v_lshl_or_b32 v212, v224, 16, v223
	v_lshl_or_b32 v217, v184, 16, v199
	...
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	buffer_load_u16 v149, v102, s[40:43], 0 offen offset:28
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	...
	v_cvt_f32_i32_e32 v194, v195
	v_cvt_f32_i32_e32 v195, v196
	v_cvt_f32_i32_e32 v196, v197
	v_cvt_f32_i32_e32 v197, v198
	v_cvt_f32_i32_e32 v198, v199
	...
	.loc	1 168 18                        ; generate_amdgcn.py:168:18
	v_lshlrev_b32_e32 v215, 16, v106
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_add_nc_u32_e32 v109, s35, v92
	v_lshlrev_b32_e32 v107, 16, v107
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v92, s48, v92
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v106, v215, v123
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v43, v106, v107 :: v_dual_mul_f32 v106, v215, v129
	s_delay_alu instid0(VALU_DEP_1)
	v_fmac_f32_e32 v80, v106, v105
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v105, v215, v185 :: v_dual_add_nc_u32 v108, s35, v94
	.loc	1 205 18 is_stmt 1              ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v104, 16, v104
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v226, v215, v122
	v_mul_f32_e32 v227, v215, v153
	v_mul_f32_e32 v228, v215, v154
	v_mul_f32_e32 v229, v215, v155
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v79, v105, v104 :: v_dual_mul_f32 v104, v215, v118
	.loc	1 205 18 is_stmt 1              ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v150, v102, s[40:43], 0 offen offset:32
	buffer_load_u16 v151, v102, s[40:43], 0 offen offset:36
	buffer_load_u16 v152, v102, s[40:43], 0 offen offset:40
	buffer_load_u16 v142, v102, s[40:43], 0 offen offset:44
	buffer_load_u16 v141, v102, s[40:43], 0 offen offset:48
	buffer_load_u16 v143, v102, s[40:43], 0 offen offset:52
	buffer_load_u16 v144, v102, s[40:43], 0 offen offset:56
	buffer_load_u16 v145, v102, s[40:43], 0 offen offset:60
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v78, v104, v103
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	s_waitcnt vmcnt(11)
	v_dual_mul_f32 v103, v215, v119 :: v_dual_lshlrev_b32 v104, 16, v189
	.loc	1 205 18 is_stmt 1              ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v146, v102, s[40:43], 0 offen offset:64
	buffer_load_u16 v147, v102, s[40:43], 0 offen offset:68
	buffer_load_u16 v148, v102, s[40:43], 0 offen offset:72
	buffer_load_u16 v134, v102, s[40:43], 0 offen offset:76
	buffer_load_u16 v133, v102, s[40:43], 0 offen offset:80
	buffer_load_u16 v135, v102, s[40:43], 0 offen offset:84
	buffer_load_u16 v136, v102, s[40:43], 0 offen offset:88
	buffer_load_u16 v137, v102, s[40:43], 0 offen offset:92
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(18)
	v_dual_fmac_f32 v77, v103, v104 :: v_dual_lshlrev_b32 v104, 16, v190
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v103, v215, v120
	.loc	1 205 18 is_stmt 1              ; generate_amdgcn.py:205:18
	s_clause 0x1f
	buffer_load_u16 v138, v102, s[40:43], 0 offen offset:96
	buffer_load_u16 v139, v102, s[40:43], 0 offen offset:100
	buffer_load_u16 v140, v102, s[40:43], 0 offen offset:104
	buffer_load_u16 v125, v102, s[40:43], 0 offen offset:108
	buffer_load_u16 v124, v102, s[40:43], 0 offen offset:112
	buffer_load_u16 v126, v102, s[40:43], 0 offen offset:116
	buffer_load_u16 v127, v102, s[40:43], 0 offen offset:120
	buffer_load_u16 v131, v102, s[40:43], 0 offen offset:132
	buffer_load_u16 v128, v102, s[40:43], 0 offen offset:128
	buffer_load_u16 v130, v108, s[40:43], 0 offen
	buffer_load_u16 v108, v109, s[40:43], 0 offen
	buffer_load_u16 v109, v102, s[40:43], 0 offen offset:248
	buffer_load_u16 v132, v102, s[40:43], 0 offen offset:136
	buffer_load_u16 v110, v102, s[40:43], 0 offen offset:140
	buffer_load_u16 v111, v102, s[40:43], 0 offen offset:144
	buffer_load_u16 v112, v102, s[40:43], 0 offen offset:148
	buffer_load_u16 v113, v102, s[40:43], 0 offen offset:152
	buffer_load_u16 v114, v102, s[40:43], 0 offen offset:156
	buffer_load_u16 v12, v102, s[40:43], 0 offen offset:160
	buffer_load_u16 v13, v102, s[40:43], 0 offen offset:164
	buffer_load_u16 v14, v102, s[40:43], 0 offen offset:168
	buffer_load_u16 v15, v102, s[40:43], 0 offen offset:172
	buffer_load_u16 v115, v102, s[40:43], 0 offen offset:176
	buffer_load_u16 v116, v102, s[40:43], 0 offen offset:180
	buffer_load_u16 v117, v102, s[40:43], 0 offen offset:184
	buffer_load_u16 v192, v102, s[40:43], 0 offen offset:188
	buffer_load_u16 v193, v102, s[40:43], 0 offen offset:192
	buffer_load_u16 v216, v102, s[40:43], 0 offen offset:196
	buffer_load_u16 v217, v102, s[40:43], 0 offen offset:200
	buffer_load_u16 v218, v102, s[40:43], 0 offen offset:204
	buffer_load_u16 v219, v102, s[40:43], 0 offen offset:208
	buffer_load_u16 v220, v102, s[40:43], 0 offen offset:212
	s_clause 0x2
	buffer_load_u16 v221, v102, s[40:43], 0 offen offset:216
	buffer_load_u16 v189, v102, s[40:43], 0 offen offset:220
	buffer_load_u16 v222, v102, s[40:43], 0 offen offset:224
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fmac_f32_e32 v76, v103, v104
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x1
	buffer_load_u16 v190, v102, s[40:43], 0 offen offset:228
	buffer_load_u16 v223, v102, s[40:43], 0 offen offset:232
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	s_waitcnt vmcnt(54)
	v_dual_mul_f32 v103, v215, v121 :: v_dual_lshlrev_b32 v104, 16, v191
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x2
	buffer_load_u16 v191, v102, s[40:43], 0 offen offset:236
	buffer_load_u16 v224, v102, s[40:43], 0 offen offset:240
	buffer_load_u16 v225, v102, s[40:43], 0 offen offset:244
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	v_cndmask_b32_e32 v102, 0x80000000, v96, vcc_lo
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v230, v215, v156
	v_dual_mul_f32 v231, v215, v157 :: v_dual_add_nc_u32 v96, s49, v96
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v75, v103, v104 :: v_dual_add_nc_u32 v94, s48, v94
	.loc	1 193 26 is_stmt 1              ; generate_amdgcn.py:193:26
	buffer_load_b32 v102, v102, s[36:39], 0 offen
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_mul_f32_e32 v232, v215, v158
	v_mul_f32_e32 v233, v215, v159
	v_mul_f32_e32 v234, v215, v160
	v_mul_f32_e32 v103, v215, v161
	v_mul_f32_e32 v104, v215, v162
	v_mul_f32_e32 v105, v215, v163
	v_mul_f32_e32 v106, v215, v164
	v_mul_f32_e32 v107, v215, v165
	v_mul_f32_e32 v118, v215, v166
	v_mul_f32_e32 v119, v215, v167
	v_mul_f32_e32 v120, v215, v168
	v_mul_f32_e32 v121, v215, v169
	v_mul_f32_e32 v122, v215, v170
	v_mul_f32_e32 v123, v215, v171
	v_mul_f32_e32 v129, v215, v172
	v_mul_f32_e32 v153, v215, v173
	v_mul_f32_e32 v154, v215, v174
	v_mul_f32_e32 v155, v215, v175
	v_mul_f32_e32 v156, v215, v176
	v_mul_f32_e32 v157, v215, v177
	v_mul_f32_e32 v158, v215, v178
	v_mul_f32_e32 v159, v215, v179
	v_mul_f32_e32 v160, v215, v180
	v_mul_f32_e32 v161, v215, v181
	v_mul_f32_e32 v162, v215, v182
	v_mul_f32_e32 v163, v215, v183
	v_mul_f32_e32 v164, v215, v184
	v_mul_f32_e32 v165, v215, v186
	v_mul_f32_e32 v166, v215, v187
	v_mul_f32_e32 v167, v215, v188
	v_mul_f32_e32 v168, v215, v194
	v_mul_f32_e32 v169, v215, v195
	v_mul_f32_e32 v170, v215, v196
	v_mul_f32_e32 v171, v215, v197
	v_mul_f32_e32 v172, v215, v198
	v_mul_f32_e32 v173, v215, v199
	v_mul_f32_e32 v174, v215, v200
	v_mul_f32_e32 v175, v215, v201
	v_mul_f32_e32 v176, v215, v202
	v_mul_f32_e32 v177, v215, v203
	v_mul_f32_e32 v178, v215, v204
	v_mul_f32_e32 v179, v215, v205
	v_mul_f32_e32 v180, v215, v206
	v_mul_f32_e32 v181, v215, v207
	v_mul_f32_e32 v182, v215, v208
	v_mul_f32_e32 v183, v215, v209
	v_mul_f32_e32 v184, v215, v210
	v_mul_f32_e32 v185, v215, v211
	v_mul_f32_e32 v186, v215, v212
	v_mul_f32_e32 v187, v215, v213
	v_mul_f32_e32 v188, v215, v214
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v89, v101 offset:2048
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(0)
	ds_store_b32 v90, v102
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	v_lshlrev_b32_e32 v195, 16, v217
	v_lshlrev_b32_e32 v196, 16, v218
	v_lshlrev_b32_e32 v197, 16, v219
	v_lshlrev_b32_e32 v198, 16, v220
	v_lshlrev_b32_e32 v199, 16, v221
	v_lshlrev_b32_e32 v189, 16, v189
	v_lshlrev_b32_e32 v200, 16, v222
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v71, v229, v152 :: v_dual_lshlrev_b32 v190, 16, v190
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v201, 16, v223
	v_lshlrev_b32_e32 v191, 16, v191
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v73, v227, v150 :: v_dual_lshlrev_b32 v202, 16, v224
	v_dual_fmac_f32 v72, v228, v151 :: v_dual_lshlrev_b32 v203, 16, v225
	v_dual_fmac_f32 v70, v230, v142 :: v_dual_lshlrev_b32 v109, 16, v109
	v_dual_fmac_f32 v69, v231, v141 :: v_dual_lshlrev_b32 v108, 16, v108
	v_dual_fmac_f32 v74, v226, v149 :: v_dual_fmac_f32 v67, v233, v144
	v_dual_fmac_f32 v68, v232, v143 :: v_dual_fmac_f32 v65, v103, v146
	v_dual_fmac_f32 v66, v234, v145 :: v_dual_fmac_f32 v63, v105, v148
	v_dual_fmac_f32 v64, v104, v147 :: v_dual_fmac_f32 v61, v107, v133
	v_dual_fmac_f32 v62, v106, v134 :: v_dual_fmac_f32 v59, v119, v136
	v_dual_fmac_f32 v60, v118, v135 :: v_dual_fmac_f32 v57, v121, v138
	v_dual_fmac_f32 v58, v120, v137 :: v_dual_fmac_f32 v55, v123, v140
	v_dual_fmac_f32 v56, v122, v139 :: v_dual_fmac_f32 v53, v153, v124
	v_dual_fmac_f32 v54, v129, v125 :: v_dual_fmac_f32 v51, v155, v127
	v_dual_fmac_f32 v52, v154, v126 :: v_dual_fmac_f32 v49, v157, v128
	v_dual_fmac_f32 v50, v156, v130 :: v_dual_fmac_f32 v47, v159, v132
	v_dual_fmac_f32 v48, v158, v131 :: v_dual_fmac_f32 v41, v164, v114
	v_dual_fmac_f32 v46, v160, v110 :: v_dual_fmac_f32 v45, v161, v111
	v_dual_fmac_f32 v44, v162, v112 :: v_dual_fmac_f32 v37, v168, v15
	v_dual_fmac_f32 v42, v163, v113 :: v_dual_fmac_f32 v35, v170, v116
	v_dual_fmac_f32 v40, v165, v12 :: v_dual_fmac_f32 v39, v166, v13
	v_dual_fmac_f32 v38, v167, v14 :: v_dual_fmac_f32 v33, v172, v192
	v_dual_fmac_f32 v36, v169, v115 :: v_dual_fmac_f32 v31, v174, v194
	v_dual_fmac_f32 v34, v171, v117 :: v_dual_fmac_f32 v29, v176, v196
	v_dual_fmac_f32 v32, v173, v193 :: v_dual_fmac_f32 v27, v178, v198
	v_dual_fmac_f32 v30, v175, v195 :: v_dual_fmac_f32 v25, v180, v189
	v_dual_fmac_f32 v28, v177, v197 :: v_dual_fmac_f32 v23, v182, v190
	v_dual_fmac_f32 v26, v179, v199 :: v_dual_fmac_f32 v17, v188, v108
...
.LBB0_6:                                ; %Flow336
	...
	v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v90, 0
...
; %bb.7:
	ds_load_u8 v4, v84 offset:640
	ds_load_u8 v5, v84 offset:512
	ds_load_u8 v6, v84 offset:896
	ds_load_u8 v7, v84 offset:768
	s_mov_b32 s5, s4
	s_mov_b32 s6, s4
	s_mov_b32 s7, s4
	s_mov_b32 s8, s4
	...
	s_mov_b32 s11, s4
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_and_b32_e32 v3, 0x70, v88
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v141, s11 :: v_dual_mov_b32 v134, s4
	v_dual_mov_b32 v140, s10 :: v_dual_add_nc_u32 v15, 0, v87
	v_mov_b32_e32 v138, s8
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_and_or_b32 v3, 0x88, v86, v3
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_dual_mov_b32 v136, s6 :: v_dual_mov_b32 v139, s9
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v86, v5, v4, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	...
	v_lshl_or_b32 v8, v7, 16, v86
	ds_load_u8 v7, v84 offset:384
	ds_load_u8 v11, v84 offset:256
	ds_load_u8 v96, v84 offset:144
	ds_load_u8 v104, v84 offset:160
	...
	ds_load_u8 v102, v84 offset:928
	...
	ds_load_u8 v103, v84 offset:800
	...
	ds_load_u8 v106, v84 offset:416
	ds_load_u8 v142, v84 offset:432
	ds_load_u8 v143, v84 offset:448
	ds_load_u8 v144, v84 offset:464
	ds_load_u8 v145, v84 offset:480
	ds_load_u8 v156, v84 offset:496
	ds_load_u8 v99, v84 offset:272
	ds_load_u8 v107, v84 offset:288
	ds_load_u8 v146, v84 offset:304
	ds_load_u8 v147, v84 offset:320
	ds_load_u8 v148, v84 offset:336
	ds_load_u8 v149, v84 offset:352
	ds_load_u8 v157, v84 offset:368
	ds_load_u8 v185, v84 offset:1040
	ds_load_u8 v186, v84 offset:1056
	ds_load_u8 v187, v84 offset:1072
	ds_load_u8 v188, v84 offset:1088
	ds_load_u8 v189, v84 offset:1104
	ds_load_u8 v190, v84 offset:1120
	ds_load_u8 v191, v84 offset:1136
	ds_load_u8 v192, v84 offset:1936
	ds_load_u8 v193, v84 offset:1168
	ds_load_u8 v194, v84 offset:1184
	ds_load_u8 v195, v84 offset:1200
	ds_load_u8 v196, v84 offset:1216
	ds_load_u8 v197, v84 offset:1232
	ds_load_u8 v198, v84 offset:1248
	ds_load_u8 v199, v84 offset:1264
	ds_load_u8 v200, v84 offset:1296
	ds_load_u8 v201, v84 offset:1312
	ds_load_u8 v202, v84 offset:1328
	ds_load_u8 v203, v84 offset:1344
	ds_load_u8 v204, v84 offset:1360
	ds_load_u8 v205, v84 offset:1376
	ds_load_u8 v206, v84 offset:1392
	s_waitcnt lgkmcnt(62)
	v_perm_b32 v7, v11, v7, 0xc0c0004
	ds_load_u8 v11, v84 offset:1664
	ds_load_u8 v100, v84 offset:1536
	v_perm_b32 v12, v14, v12, 0xc0c0004
	v_perm_b32 v86, v88, v87, 0xc0c0004
	v_perm_b32 v13, v101, v13, 0xc0c0004
	s_waitcnt lgkmcnt(44)
	v_perm_b32 v14, v95, v94, 0xc0c0004
	v_perm_b32 v94, v97, v96, 0xc0c0004
	s_waitcnt lgkmcnt(30)
	v_perm_b32 v95, v99, v98, 0xc0c0004
	v_lshl_or_b32 v7, v7, 16, v86
	v_perm_b32 v101, v105, v104, 0xc0c0004
	v_perm_b32 v109, v111, v109, 0xc0c0004
	v_perm_b32 v111, v115, v113, 0xc0c0004
	v_perm_b32 v113, v124, v121, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[85:92], v[7:8], v[5:6], v[134:141] neg_lo:[1,1,0]
	ds_load_u8 v7, v84 offset:1920
	ds_load_u8 v8, v84 offset:1792
	ds_load_u8 v108, v84 offset:1424
	ds_load_u8 v151, v84 offset:1440
	ds_load_u8 v158, v84 offset:1456
	ds_load_u8 v159, v84 offset:1472
	ds_load_u8 v160, v84 offset:1488
	ds_load_u8 v161, v84 offset:1504
	ds_load_u8 v162, v84 offset:1520
	ds_load_u8 v163, v84 offset:1552
	ds_load_u8 v164, v84 offset:1568
	ds_load_u8 v165, v84 offset:1584
	ds_load_u8 v166, v84 offset:1600
	ds_load_u8 v167, v84 offset:1616
	ds_load_u8 v168, v84 offset:1632
	ds_load_u8 v169, v84 offset:1648
	s_waitcnt lgkmcnt(44)
	v_perm_b32 v115, v146, v142, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v11, v100, v11, 0xc0c0004
	ds_load_u8 v100, v84 offset:1152
	ds_load_u8 v170, v84 offset:1680
	ds_load_u8 v171, v84 offset:1696
	ds_load_u8 v172, v84 offset:1712
	ds_load_u8 v173, v84 offset:1728
	ds_load_u8 v174, v84 offset:1744
	ds_load_u8 v175, v84 offset:1760
	ds_load_u8 v176, v84 offset:1776
	ds_load_u8 v177, v84 offset:1808
	ds_load_u8 v178, v84 offset:1824
	ds_load_u8 v179, v84 offset:1840
	ds_load_u8 v180, v84 offset:1856
	ds_load_u8 v181, v84 offset:1872
	ds_load_u8 v182, v84 offset:1888
	ds_load_u8 v183, v84 offset:1904
	v_perm_b32 v121, v112, v110, 0xc0c0004
	v_perm_b32 v124, v116, v114, 0xc0c0004
	s_waitcnt lgkmcnt(29)
	v_perm_b32 v184, v8, v7, 0xc0c0004
	ds_load_u8 v7, v84 offset:1408
	ds_load_u8 v8, v84 offset:1280
	s_waitcnt lgkmcnt(29)
	v_perm_b32 v151, v201, v151, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v93, v93, v100, 0xc0c0004
	v_perm_b32 v122, v130, v122, 0xc0c0004
	v_perm_b32 v130, v147, v143, 0xc0c0004
	v_perm_b32 v142, v203, v159, 0xc0c0004
	v_perm_b32 v143, v118, v117, 0xc0c0004
	v_perm_b32 v146, v120, v119, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	...
	v_perm_b32 v128, v149, v145, 0xc0c0004
	v_perm_b32 v145, v204, v160, 0xc0c0004
	v_perm_b32 v133, v152, v133, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v15, v183, v15, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v96, v8, v7, 0xc0c0004
	v_lshl_or_b32 v8, v14, 16, v12
	v_lshl_or_b32 v12, v184, 16, v11
	ds_load_u8 v184, v84 offset:1952
	v_lshl_or_b32 v7, v95, 16, v94
	v_lshl_or_b32 v11, v96, 16, v93
	v_perm_b32 v14, v103, v102, 0xc0c0004
	v_perm_b32 v102, v107, v106, 0xc0c0004
	v_perm_b32 v103, v200, v108, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[93:100], v[7:8], v[5:6], v[134:141] neg_lo:[1,1,0]
	v_perm_b32 v7, v163, v170, 0xc0c0004
	ds_load_u8 v163, v84 offset:1968
	ds_load_u8 v170, v84 offset:1984
	ds_load_u8 v207, v84 offset:2000
	ds_load_u8 v84, v84 offset:2016
	v_perm_b32 v8, v177, v192, 0xc0c0004
	v_lshl_or_b32 v14, v14, 16, v13
	v_lshl_or_b32 v13, v102, 16, v101
	v_perm_b32 v177, v186, v194, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[85:92], v[11:12], v[3:4], v[85:92] neg_lo:[1,1,0]
	v_lshl_or_b32 v8, v8, 16, v7
	v_perm_b32 v7, v185, v193, 0xc0c0004
	v_perm_b32 v11, v165, v172, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v171, v178, v184, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v7, v103, 16, v7
	v_wmma_i32_16x16x16_iu4 v[101:108], v[13:14], v[5:6], v[134:141] neg_lo:[1,1,0]
	v_lshl_or_b32 v13, v151, 16, v177
	v_lshl_or_b32 v14, v171, 16, v164
	ds_load_u8 v164, v150
	v_wmma_i32_16x16x16_iu4 v[93:100], v[7:8], v[3:4], v[93:100] neg_lo:[1,1,0]
	v_lshl_or_b32 v8, v111, 16, v109
	v_lshl_or_b32 v7, v115, 16, v113
	v_wmma_i32_16x16x16_iu4 v[101:108], v[13:14], v[3:4], v[101:108] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v12, v179, v163, 0xc0c0004
	v_perm_b32 v13, v187, v195, 0xc0c0004
	v_perm_b32 v14, v202, v158, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[109:116], v[7:8], v[5:6], v[134:141] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v8, v12, 16, v11
	v_lshl_or_b32 v12, v124, 16, v121
	v_lshl_or_b32 v7, v14, 16, v13
	v_lshl_or_b32 v11, v130, 16, v122
	v_perm_b32 v13, v166, v173, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v14, v180, v170, 0xc0c0004
	v_perm_b32 v130, v188, v196, 0xc0c0004
	v_lshl_or_b32 v151, v126, 16, v125
	v_wmma_i32_16x16x16_iu4 v[117:124], v[11:12], v[5:6], v[134:141] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v12, v14, 16, v13
	v_lshl_or_b32 v11, v142, 16, v130
	v_lshl_or_b32 v14, v146, 16, v143
	v_lshl_or_b32 v13, v144, 16, v131
	v_perm_b32 v142, v167, v174, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v143, v181, v207, 0xc0c0004
	v_perm_b32 v144, v189, v197, 0xc0c0004
	v_lshl_or_b32 v150, v128, 16, v127
	v_wmma_i32_16x16x16_iu4 v[125:132], v[13:14], v[5:6], v[134:141] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v14, v143, 16, v142
	v_lshl_or_b32 v13, v145, 16, v144
	s_delay_alu instid0(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[142:149], v[150:151], v[5:6], v[134:141] neg_lo:[1,1,0]
	v_perm_b32 v150, v155, v154, 0xc0c0004
	v_perm_b32 v151, v157, v156, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v152, v153, v164, 0xc0c0004
	v_perm_b32 v158, v168, v175, 0xc0c0004
	v_perm_b32 v84, v182, v84, 0xc0c0004
	v_perm_b32 v154, v190, v198, 0xc0c0004
	v_perm_b32 v155, v205, v161, 0xc0c0004
	v_lshl_or_b32 v150, v151, 16, v150
	v_lshl_or_b32 v151, v152, 16, v133
	v_perm_b32 v133, v191, v199, 0xc0c0004
	v_perm_b32 v156, v206, v162, 0xc0c0004
	v_perm_b32 v157, v169, v176, 0xc0c0004
	v_lshl_or_b32 v153, v84, 16, v158
	v_lshl_or_b32 v152, v155, 16, v154
	v_wmma_i32_16x16x16_iu4 v[134:141], v[150:151], v[5:6], v[134:141] neg_lo:[1,1,0]
	v_lshl_or_b32 v5, v156, 16, v133
	v_lshl_or_b32 v6, v15, 16, v157
	v_wmma_i32_16x16x16_iu4 v[109:116], v[7:8], v[3:4], v[109:116] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[117:124], v[11:12], v[3:4], v[117:124] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[125:132], v[13:14], v[3:4], v[125:132] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[142:149], v[152:153], v[3:4], v[142:149] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[134:141], v[5:6], v[3:4], v[134:141] neg_lo:[1,1,0]
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_cvt_f32_i32_e32 v3, v85
	v_cvt_f32_i32_e32 v4, v86
...
.LBB0_8:
	...
	v_dual_mul_f32 v115, v115, v198 :: v_dual_add_nc_u32 v176, 0xa0, v83
	v_dual_mul_f32 v12, v12, v198 :: v_dual_add_nc_u32 v145, 32, v83
	v_dual_mul_f32 v118, v118, v198 :: v_dual_add_nc_u32 v177, 0xa4, v83
	v_dual_mul_f32 v13, v13, v198 :: v_dual_add_nc_u32 v146, 36, v83
	v_dual_mul_f32 v102, v102, v198 :: v_dual_add_nc_u32 v161, 0x60, v83
	v_dual_mul_f32 v117, v117, v198 :: v_dual_add_nc_u32 v178, 0xa8, v83
	v_dual_mul_f32 v123, v123, v198 :: v_dual_add_nc_u32 v184, 0xc0, v83
	v_dual_mul_f32 v14, v14, v198 :: v_dual_add_nc_u32 v147, 40, v83
	v_dual_mul_f32 v101, v101, v198 :: v_dual_add_nc_u32 v162, 0x64, v83
	v_dual_mul_f32 v120, v120, v198 :: v_dual_add_nc_u32 v179, 0xac, v83
	v_dual_mul_f32 v126, v126, v198 :: v_dual_add_nc_u32 v185, 0xc4, v83
	v_dual_mul_f32 v15, v15, v198 :: v_dual_add_nc_u32 v148, 44, v83
	v_dual_mul_f32 v94, v94, v198 :: v_dual_add_nc_u32 v153, 64, v83
	v_dual_mul_f32 v104, v104, v198 :: v_dual_add_nc_u32 v163, 0x68, v83
	v_dual_mul_f32 v107, v107, v198 :: v_dual_add_nc_u32 v168, 0x80, v83
	v_dual_mul_f32 v119, v119, v198 :: v_dual_add_nc_u32 v180, 0xb0, v83
	v_dual_mul_f32 v122, v122, v198 :: v_dual_add_nc_u32 v181, 0xb4, v83
	v_dual_mul_f32 v121, v121, v198 :: v_dual_add_nc_u32 v182, 0xb8, v83
	v_dual_mul_f32 v124, v124, v198 :: v_dual_add_nc_u32 v183, 0xbc, v83
	v_dual_mul_f32 v125, v125, v198 :: v_dual_add_nc_u32 v186, 0xc8, v83
	v_dual_mul_f32 v131, v131, v198 :: v_dual_add_nc_u32 v192, 0xe0, v83
	v_dual_mul_f32 v4, v4, v198 :: v_dual_add_nc_u32 v85, 4, v83
	v_dual_mul_f32 v90, v90, v198 :: v_dual_add_nc_u32 v149, 48, v83
	v_dual_mul_f32 v89, v89, v198 :: v_dual_add_nc_u32 v150, 52, v83
	v_dual_mul_f32 v92, v92, v198 :: v_dual_add_nc_u32 v151, 56, v83
	v_dual_mul_f32 v91, v91, v198 :: v_dual_add_nc_u32 v152, 60, v83
	v_dual_mul_f32 v93, v93, v198 :: v_dual_add_nc_u32 v154, 0x44, v83
	v_dual_mul_f32 v103, v103, v198 :: v_dual_add_nc_u32 v164, 0x6c, v83
	v_dual_mul_f32 v110, v110, v198 :: v_dual_add_nc_u32 v169, 0x84, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v176, 0x80000000, v176, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v128, v128, v198 :: v_dual_add_nc_u32 v187, 0xcc, v83
	v_dual_mul_f32 v134, v134, v198 :: v_dual_add_nc_u32 v193, 0xe4, v83
	v_dual_mul_f32 v3, v3, v198 :: v_dual_add_nc_u32 v86, 8, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v145, 0x80000000, v145, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v96, v96, v198 :: v_dual_add_nc_u32 v155, 0x48, v83
	v_dual_mul_f32 v106, v106, v198 :: v_dual_add_nc_u32 v165, 0x70, v83
	v_dual_mul_f32 v105, v105, v198 :: v_dual_add_nc_u32 v166, 0x74, v83
	v_dual_mul_f32 v108, v108, v198 :: v_dual_add_nc_u32 v167, 0x78, v83
	v_dual_mul_f32 v109, v109, v198 :: v_dual_add_nc_u32 v170, 0x88, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v177, 0x80000000, v177, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v127, v127, v198 :: v_dual_add_nc_u32 v188, 0xd0, v83
	v_dual_mul_f32 v130, v130, v198 :: v_dual_add_nc_u32 v189, 0xd4, v83
	v_dual_mul_f32 v129, v129, v198 :: v_dual_add_nc_u32 v190, 0xd8, v83
	v_dual_mul_f32 v132, v132, v198 :: v_dual_add_nc_u32 v191, 0xdc, v83
	v_dual_mul_f32 v133, v133, v198 :: v_dual_add_nc_u32 v194, 0xe8, v83
	v_dual_mul_f32 v6, v6, v198 :: v_dual_add_nc_u32 v87, 12, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v146, 0x80000000, v146, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v95, v95, v198 :: v_dual_add_nc_u32 v156, 0x4c, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v161, 0x80000000, v161, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v112, v112, v198 :: v_dual_add_nc_u32 v171, 0x8c, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v178, 0x80000000, v178, s2
	v_cndmask_b32_e64 v184, 0x80000000, v184, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v136, v136, v198 :: v_dual_add_nc_u32 v195, 0xec, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_mov_b32 s4, s14
	v_cndmask_b32_e64 v84, 0x80000000, v83, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v5, v5, v198 :: v_dual_add_nc_u32 v88, 16, v83
	v_dual_mul_f32 v7, v7, v198 :: v_dual_add_nc_u32 v142, 20, v83
	v_dual_mul_f32 v8, v8, v198 :: v_dual_add_nc_u32 v143, 24, v83
	v_dual_mul_f32 v11, v11, v198 :: v_dual_add_nc_u32 v144, 28, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v147, 0x80000000, v147, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v98, v98, v198 :: v_dual_add_nc_u32 v157, 0x50, v83
	v_dual_mul_f32 v97, v97, v198 :: v_dual_add_nc_u32 v158, 0x54, v83
	v_dual_mul_f32 v100, v100, v198 :: v_dual_add_nc_u32 v159, 0x58, v83
	v_dual_mul_f32 v99, v99, v198 :: v_dual_add_nc_u32 v160, 0x5c, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v162, 0x80000000, v162, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v111, v111, v198 :: v_dual_add_nc_u32 v172, 0x90, v83
	v_dual_mul_f32 v114, v114, v198 :: v_dual_add_nc_u32 v173, 0x94, v83
	v_dual_mul_f32 v113, v113, v198 :: v_dual_add_nc_u32 v174, 0x98, v83
	v_dual_mul_f32 v116, v116, v198 :: v_dual_add_nc_u32 v175, 0x9c, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v179, 0x80000000, v179, s2
	v_cndmask_b32_e64 v185, 0x80000000, v185, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v135, v135, v198 :: v_dual_add_nc_u32 v196, 0xf0, v83
	v_dual_mul_f32 v138, v138, v198 :: v_dual_add_nc_u32 v197, 0xf4, v83
	v_dual_mul_f32 v140, v140, v198 :: v_dual_add_nc_u32 v83, 0xf8, v83
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v137, v137, v198 :: v_dual_and_b32 v2, 0x180, v0
	...
	v_lshlrev_b32_e32 v191, 16, v191
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v13, v13, v145, v73
	v_fma_f32 v14, v14, v146, v72
	v_fma_f32 v15, v15, v147, v71
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(31)
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v3, v3, v84, v43
	v_fma_f32 v6, v6, v87, v78
	v_fma_f32 v84, v89, v148, v70
	v_fma_f32 v87, v92, v151, v67
	v_fma_f32 v89, v94, v153, v65
	v_fma_f32 v92, v97, v156, v62
	v_fma_f32 v97, v102, v161, v57
	v_fma_f32 v102, v107, v166, v52
	v_fma_f32 v107, v113, v171, v46
	v_fma_f32 v113, v119, v177, v39
	v_fma_f32 v119, v125, v183, v33
	v_fma_f32 v125, v131, v189, v27
	v_fma_f32 v131, v137, v195, v21
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v7, v7, v88, v77
	v_fma_f32 v88, v93, v152, v66
	v_fma_f32 v93, v98, v157, v61
	v_fma_f32 v94, v99, v158, v60
	v_fma_f32 v98, v103, v162, v56
	v_fma_f32 v99, v104, v163, v55
	v_fma_f32 v103, v108, v167, v51
	v_fma_f32 v104, v110, v168, v49
	v_fma_f32 v108, v114, v172, v45
	v_fma_f32 v114, v120, v178, v38
	v_fma_f32 v120, v126, v184, v32
	v_fma_f32 v4, v4, v85, v80
	v_fma_f32 v85, v90, v149, v69
	v_fma_f32 v90, v95, v154, v64
	v_fma_f32 v95, v100, v159, v59
	v_fma_f32 v100, v105, v164, v54
	v_fma_f32 v105, v111, v169, v48
	v_fma_f32 v109, v115, v173, v44
	v_fma_f32 v115, v121, v179, v37
	v_fma_f32 v121, v127, v185, v31
	v_fma_f32 v5, v5, v86, v79
	v_fma_f32 v86, v91, v150, v68
	v_fma_f32 v91, v96, v155, v63
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_lshlrev_b32_e32 v142, 16, v142
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v96, v101, v160, v58
	v_fma_f32 v101, v106, v165, v53
	v_fma_f32 v106, v112, v170, v47
	v_fma_f32 v110, v116, v174, v42
	v_fma_f32 v116, v122, v180, v36
	v_fma_f32 v122, v128, v186, v30
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v143, 16, v143
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v111, v117, v175, v41
	v_fma_f32 v117, v123, v181, v35
	v_fma_f32 v123, v129, v187, v29
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v49, v49, v104, s2
	v_cndmask_b32_e64 v32, v32, v120, s2
	v_cndmask_b32_e64 v4, v80, v4, s2
	v_cndmask_b32_e64 v43, v70, v84, s2
	v_cndmask_b32_e64 v64, v64, v90, s2
	v_cndmask_b32_e64 v48, v48, v105, s2
	v_cndmask_b32_e64 v31, v31, v121, s2
	v_xad_u32 v70, v9, 4, 0
	v_cndmask_b32_e64 v5, v79, v5, s2
	v_cndmask_b32_e64 v63, v63, v91, s2
	ds_store_2addr_b32 v21, v3, v65 offset1:32
	v_xad_u32 v3, v9, 8, 0
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v112, v118, v176, v40
	v_fma_f32 v118, v124, v182, v34
	v_fma_f32 v124, v130, v188, v28
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v144, 16, v144
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v8, v8, v142, v76
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	ds_store_2addr_b32 v70, v4, v64 offset1:32
	v_xad_u32 v4, v9, 12, 0
	v_cndmask_b32_e64 v7, v77, v7, s2
	v_cndmask_b32_e64 v61, v61, v93, s2
	ds_store_2addr_b32 v70, v48, v31 offset0:64 offset1:96
	ds_store_2addr_b32 v3, v5, v63 offset1:32
	v_xad_u32 v5, v9, 16, 0
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v126, v132, v190, v26
	v_fma_f32 v127, v133, v191, v25
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v45, v45, v108, s2
	v_cndmask_b32_e64 v28, v28, v124, s2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v12, v12, v144, v74
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	ds_store_2addr_b32 v3, v47, v30 offset0:64 offset1:96
	ds_store_2addr_b32 v4, v6, v62 offset1:32
	v_xad_u32 v3, v9, 20, 0
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v128, v134, v192, v24
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v11, v75, v11, s2
	v_cndmask_b32_e64 v59, v59, v95, s2
	ds_store_2addr_b32 v4, v46, v29 offset0:64 offset1:96
	ds_store_2addr_b32 v5, v7, v61 offset1:32
	...
	ds_store_2addr_b32 v5, v45, v28 offset0:64 offset1:96
	ds_store_2addr_b32 v3, v8, v60 offset1:32
	v_xad_u32 v5, v9, 28, 0
	v_cndmask_b32_e64 v12, v74, v12, s2
	v_cndmask_b32_e64 v13, v73, v13, s2
	v_cndmask_b32_e64 v58, v58, v96, s2
	v_cndmask_b32_e64 v57, v57, v97, s2
	ds_store_2addr_b32 v3, v44, v27 offset0:64 offset1:96
	ds_store_2addr_b32 v4, v11, v59 offset1:32
	...
	v_lshlrev_b32_e32 v193, 16, v193
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	ds_store_2addr_b32 v4, v42, v26 offset0:64 offset1:96
	ds_store_2addr_b32 v5, v12, v58 offset1:32
	ds_store_2addr_b32 v5, v41, v25 offset0:64 offset1:96
	ds_store_2addr_b32 v3, v13, v57 offset1:32
	ds_store_2addr_b32 v3, v40, v24 offset0:64 offset1:96
	v_lshlrev_b32_e32 v5, 1, v0
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_lshlrev_b32_e32 v194, 16, v194
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v129, v135, v193, v23
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(3)
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v132, v138, v196, v20
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v15, v71, v15, s2
	...
	ds_store_2addr_b32 v4, v14, v56 offset1:32
	ds_store_2addr_b32 v4, v39, v23 offset0:64 offset1:96
	v_xad_u32 v4, v9, 44, 0
	v_lshlrev_b32_e32 v0, 6, v0
	v_xor_b32_e32 v1, v1, v2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v133, v139, v197, v19
	v_fma_f32 v81, v141, v81, v17
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	ds_store_2addr_b32 v3, v15, v55 offset1:32
	ds_store_2addr_b32 v3, v38, v22 offset0:64 offset1:96
	v_xad_u32 v3, v9, 48, 0
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v83, v140, v83, v18
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v68, v68, v86, s2
	v_cndmask_b32_e64 v52, v52, v102, s2
	ds_store_2addr_b32 v4, v43, v54 offset1:32
	ds_store_2addr_b32 v4, v37, v10 offset0:64 offset1:96
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.num_vgpr, 235
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.kd
