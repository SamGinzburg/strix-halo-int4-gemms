...
.LBB0_5:                                ; %._crit_edge
	...
	v_dual_mul_f32 v38, v185, v33 :: v_dual_add_nc_u32 v67, 64, v67
	v_dual_mul_f32 v39, v184, v33 :: v_dual_add_nc_u32 v68, 64, v68
	v_dual_mul_f32 v54, v168, v34 :: v_dual_add_nc_u32 v69, 64, v69
	v_dual_mul_f32 v41, v182, v33 :: v_dual_add_nc_u32 v144, 64, v144
	v_dual_mul_f32 v56, v166, v34 :: v_dual_add_nc_u32 v153, 64, v153
	v_dual_mul_f32 v58, v164, v34 :: v_dual_add_nc_u32 v145, 64, v145
...
.LBB0_8:                                ; %.lr.ph
	...
	v_cmp_gt_i32_e32 vcc_lo, 64, v159
	.loc	1 789 35                        ; ragged.py:789:35
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 220
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 63
