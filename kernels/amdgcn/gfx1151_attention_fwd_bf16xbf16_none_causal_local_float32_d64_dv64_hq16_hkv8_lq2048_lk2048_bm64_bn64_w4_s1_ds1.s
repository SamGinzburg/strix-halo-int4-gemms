...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v81, 0xff800000 :: v_dual_lshlrev_b32 v4, 4, v33
	s_sub_i32 s3, s3, s4
	...
	v_or_b32_e32 v130, v4, v1
	v_mov_b32_e32 v1, 0x5410
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v5, s9, v2
	s_delay_alu instid0(VALU_DEP_4)
	v_xad_u32 v6, 0x70, v3, 0
	v_xad_u32 v7, 0x60, v3, 0
	v_xad_u32 v8, 0x50, v3, 0
	v_xad_u32 v9, v3, 64, 0
	v_xad_u32 v10, v3, 48, 0
	...
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v3, 0, v3
	...
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v1, 0x540054, v1
	v_dual_mov_b32 v27, v25 :: v_dual_and_b32 v0, 0x760076, v0
	...
	v_subrev_nc_u32_e32 v129, s8, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v18, v25 :: v_dual_and_b32 v131, 0x5040504, v11
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v132, 0x7060706, v12
	v_lshl_add_u32 v133, v67, 1, 0
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v134, 0, v3
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v135, 0, v4
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v136, 0, v6
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v137, 0, v7
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v138, 0, v8
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v139, 0, v9
	v_dual_mov_b32 v21, v25 :: v_dual_add_nc_u32 v140, 0, v10
	v_min_i32_e32 v141, v2, v5
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 630 31                        ; attention.py:630:31
	v_or_b32_e32 v66, s78, v94
	v_or_b32_e32 v67, s78, v93
	.loc	1 686 26                        ; attention.py:686:26
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.num_vgpr, 182
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 97
