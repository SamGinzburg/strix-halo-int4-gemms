...
.Ltmp0:
	...
	v_mov_b32_e32 v7, v8
	v_dual_mov_b32 v6, v8 :: v_dual_and_b32 v1, 16, v36
	...
	s_and_b32 s46, s4, 0x7fffffe0
	.loc	1 808 33                        ; attention.py:808:33
	s_and_not1_b32 s47, s47, 31
	s_mov_b32 s36, 0
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v25, 0 :: v_dual_and_b32 v4, 0x3f0, v36
	v_and_b32_e32 v6, 24, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v94, 0xff800000 :: v_dual_lshlrev_b32 v1, 1, v1
	v_dual_mov_b32 v75, 0x7632 :: v_dual_and_b32 v74, 7, v0
	v_dual_mov_b32 v28, v25 :: v_dual_and_b32 v3, 56, v0
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 779 31                        ; attention.py:779:31
	v_cndmask_b32_e64 v1, 0x80000000, v1, s2
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v7, 48, v36
	v_mov_b32_e32 v27, v25
	v_lshl_or_b32 v72, v33, 5, v6
	v_dual_mov_b32 v73, 0x5410 :: v_dual_add_nc_u32 v2, s14, v43
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s0, s0, 28
	v_dual_mov_b32 v17, v25 :: v_dual_lshlrev_b32 v36, 3, v74
	s_add_i32 s0, s3, s0
	.loc	1 759 31                        ; attention.py:759:31
	v_lshrrev_b32_e32 v50, 1, v3
	v_xor_b32_e32 v33, v7, v3
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v42, v37, v46, s1
	v_cndmask_b32_e64 v46, v46, v37, s1
	v_xor_b32_e32 v37, 16, v72
	...
	v_cmp_gt_i32_e64 s0, s61, v36
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v47, v47, v39, s1
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[50:51], null, s61, v50, v[36:37]
	v_cndmask_b32_e64 v36, 0x1054, v73, s1
	...
	s_add_i32 s3, s3, s12
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v45, v35, v40, s1
	v_cndmask_b32_e64 v44, v34, v38, s1
	v_cndmask_b32_e64 v49, v40, v35, s1
	v_cndmask_b32_e64 v48, v38, v34, s1
	...
	v_dual_mov_b32 v9, v25 :: v_dual_and_b32 v34, 0x760076, v39
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v79, 0, v40
	v_mov_b32_e32 v13, v25
	v_xor_b32_e32 v35, 8, v72
	v_xor_b32_e32 v38, 24, v72
	v_xor_b32_e32 v74, v33, v77
	v_and_b32_e32 v33, 0x540054, v36
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.num_vgpr, 146
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.numbered_sgpr, 66
