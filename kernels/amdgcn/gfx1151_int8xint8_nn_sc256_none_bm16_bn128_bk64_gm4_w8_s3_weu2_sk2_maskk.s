	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s35, v33, v[1:2]
...
.Ltmp21:
	...
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[15:18], v8, s[20:23], 0 offen
	buffer_load_b128 v[19:22], v10, s[20:23], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
.Ltmp23:
	...
	v_subrev_nc_u32_e32 v37, s14, v4
	s_mov_b32 s28, s16
	v_subrev_nc_u32_e32 v38, s14, v1
	v_mov_b32_e32 v1, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v43, v27, s18, 1
	.loc	1 392 40                        ; generate_amdgcn.py:392:40
	s_mul_i32 s18, s18, s35
	.loc	1 389 34                        ; generate_amdgcn.py:389:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v44, v25, s18, 1
	v_add_lshl_u32 v45, v24, s18, 1
	v_add_lshl_u32 v46, v22, s18, 1
	v_add_lshl_u32 v47, v20, s18, 1
	v_add_lshl_u32 v48, v23, s18, 1
	v_cndmask_b32_e32 v44, 0x80000000, v44, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v89, v41, s[8:11], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v41, v26, s18, 1
	v_add_lshl_u32 v49, v21, s18, 1
	v_add_lshl_u32 v50, v19, s18, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v90, v43, s[24:27], 0 offen
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	s_clause 0x7
	buffer_load_u16 v91, v41, s[28:31], 0 offen
	...
	.loc	1 368 17                        ; generate_amdgcn.py:368:17
	v_add_nc_u32_e32 v41, 0x100, v42
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_add_nc_u32_e32 v42, 0x120, v42
	s_mov_b32 s18, s14
	s_mov_b32 s14, s1
	s_mov_b32 s1, s19
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	v_cmp_gt_i32_e32 vcc_lo, s7, v41
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v43, s18, v30
	v_add_nc_u32_e32 v44, s18, v31
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add3_u32 v45, s1, v34, v32
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s1, s37, 1
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v41, s18, v28
	v_add_nc_u32_e32 v42, s18, v29
...
.LBB0_10:
	...
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v35, v26, s7, 1
	v_add_lshl_u32 v36, v25, s7, 1
	v_add_lshl_u32 v37, v24, s7, 1
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_and_b32 vcc_lo, s3, s8
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_add_lshl_u32 v38, v22, s7, 1
	v_add_lshl_u32 v39, v20, s7, 1
	v_add_lshl_u32 v40, v23, s7, 1
	v_add_lshl_u32 v41, v21, s7, 1
	v_add_lshl_u32 v42, v19, s7, 1
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_vgpr, 141
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 40
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     42
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.kd
