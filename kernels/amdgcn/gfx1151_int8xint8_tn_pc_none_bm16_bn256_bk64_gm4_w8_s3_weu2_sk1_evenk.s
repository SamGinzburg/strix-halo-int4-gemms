...
.Ltmp11:
	...
	v_lshl_add_u32 v30, s19, 4, v9
	v_lshl_add_u32 v31, s19, 5, v9
...
.Ltmp13:
	...
	buffer_load_b128 v[39:42], v8, s[24:27], 0 offen
	buffer_load_b128 v[43:46], v33, s[24:27], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
...
.Ltmp14:
	...
	s_mov_b32 s11, s4
	v_and_b32_e32 v32, 0x70, v1
	v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v26, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s1, s0, s19
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[35:36], null, s0, s18, v[11:12]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s1, s1, s28
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	v_dual_add_f32 v24, v24, v39 :: v_dual_add_nc_u32 v245, s0, v34
	...
	v_dual_add_f32 v17, v17, v46 :: v_dual_add_f32 v20, v20, v43
...
.LBB0_11:
	...
	s_mov_b32 s22, 0x7ffffffe
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v1, v26, v1 :: v_dual_lshlrev_b32 v6, 1, v6
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s20, s12
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v2, v28, v2 :: v_dual_lshlrev_b32 v7, 1, v7
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	buffer_load_u16 v37, v6, s[20:23], 0 offen
	...
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v6, v7, s[20:23], 0 offen
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v24, v8 :: v_dual_add_f32 v8, v23, v9
	...
	v_cndmask_b32_e64 v29, v19, v29, s2
	v_cndmask_b32_e64 v30, v18, v30, s2
	v_cndmask_b32_e64 v31, v17, v31, s2
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v40, v20, v11, s2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	ds_store_b32 v0, v1
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_load_b128 v[17:20], v41 offset:528
	s_waitcnt lgkmcnt(3)
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v6, v6, v32 :: v_dual_mul_f32 v7, v21, v7
	v_dual_mul_f32 v1, v1, v32 :: v_dual_mul_f32 v16, v16, v17
	v_dual_mul_f32 v4, v4, v32 :: v_dual_mul_f32 v5, v23, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v6, v22, v6 :: v_dual_mul_f32 v13, v13, v20
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v2, v2, v32 :: v_dual_mul_f32 v1, v28, v1
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v10, v10, v32 :: v_dual_mul_f32 v11, v31, v11
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b32_e32 v7, 0x1054, v36, vcc_lo
	v_cmp_o_f32_e64 s12, v15, v15
	v_cndmask_b16 v5.l, 0x7fff, v10.h, s9
	v_cndmask_b16 v10.h, 0x7fff, v13.h, s14
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	...
	v_dual_cndmask_b32 v8, 0x3276, v39 :: v_dual_cndmask_b32 v3, v4, v9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 246
