...
.Ltmp11:
	...
	s_xor_b32 s6, s6, s10
	v_dual_mov_b32 v115, 0 :: v_dual_mov_b32 v180, 0
	s_sub_i32 s6, s6, s10
	...
	s_cselect_b32 s4, s11, s4
	v_dual_mov_b32 v210, 0 :: v_dual_mov_b32 v135, 0
	s_xor_b32 s7, s4, s6
	v_dual_mov_b32 v218, 0 :: v_dual_mov_b32 v211, 0
	s_sub_i32 s33, s7, s6
	...
	v_dual_mov_b32 v197, 0 :: v_dual_mov_b32 v172, 0
	v_dual_mov_b32 v229, 0 :: v_dual_mov_b32 v168, 0
	...
	v_dual_mov_b32 v226, 0 :: v_dual_mov_b32 v241, 0
...
.Ltmp17:
	...
	v_dual_mov_b32 v133, 0 :: v_dual_mov_b32 v188, 0
	...
	v_dual_mov_b32 v185, 0 :: v_dual_mov_b32 v158, 0
	...
	v_dual_mov_b32 v115, 0 :: v_dual_mov_b32 v152, 0
	...
	v_dual_mov_b32 v109, 0 :: v_dual_mov_b32 v150, 0
	v_dual_mov_b32 v171, 0 :: v_dual_mov_b32 v90, 0
	...
	v_dual_mov_b32 v97, 0 :: v_dual_mov_b32 v136, 0
	v_dual_mov_b32 v151, 0 :: v_dual_mov_b32 v2, s5
	v_dual_mov_b32 v93, 0 :: v_dual_mov_b32 v4, s7
	v_dual_mov_b32 v147, 0 :: v_dual_mov_b32 v6, s9
	v_dual_mov_b32 v95, 0 :: v_dual_mov_b32 v8, s11
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v245, v0, s[16:19], 0 offen offset:28
	...
	buffer_load_u16 v227, v0, s[16:19], 0 offen offset:76
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(24)
	v_lshlrev_b32_e32 v126, 16, v245
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	v_dual_mul_f32 v113, v137, v113 :: v_dual_fmac_f32 v198, v72, v126
	...
	v_dual_mul_f32 v30, v137, v30 :: v_dual_mov_b32 v241, v223
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	v_mul_f32_e32 v66, v137, v66
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v174, v62, v132
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	v_cvt_f32_i32_e32 v62, v134
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(17)
	v_lshlrev_b32_e32 v134, 16, v171
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(16)
	v_lshlrev_b32_e32 v136, 16, v209
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	...
	buffer_load_u16 v234, v244, s[16:19], 0 offen offset:32
	buffer_load_u16 v235, v244, s[16:19], 0 offen offset:36
	...
	buffer_load_u16 v254, v244, s[16:19], 0 offen offset:72
	buffer_load_u16 v255, v244, s[16:19], 0 offen offset:76
	...
	s_waitcnt vmcnt(24)
	v_dual_mov_b32 v189, v162 :: v_dual_lshlrev_b32 v128, 16, v234
	s_waitcnt vmcnt(23)
	v_lshlrev_b32_e32 v57, 16, v235
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(21)
	...
	v_lshlrev_b32_e32 v114, 16, v227
	.loc	1 182 27                        ; generate_amdgcn.py:182:27
	...
	s_waitcnt vmcnt(15)
	v_dual_fmac_f32 v161, v51, v136 :: v_dual_lshlrev_b32 v114, 16, v254
	...
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v202, v54, v116 :: v_dual_lshlrev_b32 v51, 16, v255
	.loc	1 183 29 is_stmt 1              ; generate_amdgcn.py:183:29
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v192, v43, v136 :: v_dual_lshlrev_b32 v43, 16, v147
	...
	v_dual_mul_f32 v118, v137, v118 :: v_dual_lshlrev_b32 v41, 16, v144
	v_dual_mul_f32 v54, v137, v54 :: v_dual_lshlrev_b32 v53, 16, v140
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_fmac_f32_e32 v123, v44, v43
	...
	s_waitcnt vmcnt(11)
	v_dual_fmac_f32 v131, v115, v114 :: v_dual_lshlrev_b32 v136, 16, v136
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v115, off, off offset:224
	scratch_load_b32 v114, off, off offset:220
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v181, v33, v136
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x2                            ; 12-byte Folded Reload
	...
	s_waitcnt vmcnt(13)
	v_dual_fmac_f32 v129, v117, v116 :: v_dual_fmac_f32 v128, v118, v55
	scratch_load_b32 v118, off, off offset:236 ; 4-byte Folded Reload
	.loc	1 180 13 is_stmt 1              ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v187, v46, v92
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	...
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v126, v42, v41 :: v_dual_fmac_f32 v121, v93, v92
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	scratch_load_b32 v25, off, off offset:512
	scratch_load_b32 v136, off, off offset:492
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v132, v52, v51 :: v_dual_fmac_f32 v113, v109, v108
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	v_dual_mul_f32 v38, v137, v38 :: v_dual_fmac_f32 v155, v30, v100
	.loc	1 182 27                        ; generate_amdgcn.py:182:27
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v105, v28, v27 :: v_dual_lshlrev_b32 v136, 16, v136
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fmac_f32_e32 v146, v23, v136
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v136, off, off offset:388
	scratch_load_b32 v23, off, off offset:408
	.loc	1 182 27                        ; generate_amdgcn.py:182:27
	...
	.loc	1 183 29 is_stmt 0              ; generate_amdgcn.py:183:29
	v_dual_mul_f32 v30, v137, v30 :: v_dual_fmac_f32 v141, v11, v136
	.loc	1 179 18 is_stmt 1              ; generate_amdgcn.py:179:18
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 183 17 is_stmt 0              ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v98, v103, v32 :: v_dual_fmac_f32 v109, v110, v39
	...
	.loc	1 183 29                        ; generate_amdgcn.py:183:29
	v_dual_mul_f32 v102, v137, v102 :: v_dual_lshlrev_b32 v11, 16, v11
	v_mul_f32_e32 v12, v137, v12
	v_mul_f32_e32 v86, v137, v86
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 183 17 is_stmt 0              ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v96, v81, v104 :: v_dual_fmac_f32 v87, v12, v11
	...
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v92, v22, v21 :: v_dual_lshlrev_b32 v15, 16, v244
	.loc	1 182 27                        ; generate_amdgcn.py:182:27
	s_waitcnt vmcnt(0)
	...
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_dual_fmac_f32 v84, v77, v76 :: v_dual_lshlrev_b32 v9, 16, v9
	.loc	1 183 29 is_stmt 0              ; generate_amdgcn.py:183:29
	v_mul_f32_e32 v14, v137, v14
	...
	v_dual_fmac_f32 v83, v79, v16 :: v_dual_add_nc_u32 v18, s22, v18
	scratch_load_b32 v16, off, off offset:328 ; 4-byte Folded Reload
	.loc	1 182 27                        ; generate_amdgcn.py:182:27
	v_lshlrev_b32_e32 v13, 16, v13
	.loc	1 183 17                        ; generate_amdgcn.py:183:17
	v_fmac_f32_e32 v99, v102, v31
	s_delay_alu instid0(VALU_DEP_2)
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v101, v30, v29 :: v_dual_add_nc_u32 v0, s22, v0
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
.LBB0_4:                                ; %._crit_edge
	...
	v_dual_fmac_f32 v5, 0xbfb8aa3b, v205 :: v_dual_mul_f32 v36, 0xbfb8aa3b, v108
	...
	v_dual_mul_f32 v53, 0xbfb8aa3b, v128 :: v_dual_mul_f32 v50, 0xbfb8aa3b, v122
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	v_fmac_f32_e32 v65, v5, v65
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	v_dual_mul_f32 v35, 0xbfb8aa3b, v125 :: v_dual_mul_f32 v38, 0xbfb8aa3b, v124
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
	v_exp_f32_e32 v71, v4
	v_dual_mul_f32 v51, 0xbfb8aa3b, v123 :: v_dual_mul_f32 v44, 0xbfb8aa3b, v120
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	v_fma_f32 v5, -v66, v67, 1.0
	v_mul_f32_e32 v70, v68, v65
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	v_dual_mul_f32 v41, 0xbfb8aa3b, v121 :: v_dual_mul_f32 v48, 0xbfb8aa3b, v118
	...
	v_dual_mul_f32 v47, 0xbfb8aa3b, v117 :: v_dual_mul_f32 v30, 0xbfb8aa3b, v100
	v_dual_mul_f32 v45, 0xbfb8aa3b, v115 :: v_dual_mul_f32 v42, 0xbfb8aa3b, v113
	...
	v_dual_mul_f32 v39, 0xbfb8aa3b, v111 :: v_dual_mul_f32 v40, 0xbfb8aa3b, v109
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	...
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	v_dual_fmac_f32 v62, 0xbfb8aa3b, v123 :: v_dual_and_b32 v61, 1, v61
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	...
	.loc	1 185 38 is_stmt 0              ; generate_amdgcn.py:185:38
	v_dual_add_f32 v57, 1.0, v58 :: v_dual_mul_f32 v52, v196, v52
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 185 19                        ; generate_amdgcn.py:185:19
	v_mul_f32_e32 v51, v194, v51
	.loc	1 185 26 is_stmt 0              ; generate_amdgcn.py:185:26
	v_div_scale_f32 v53, null, v57, v57, v123
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	...
	.loc	1 185 26 is_stmt 0              ; generate_amdgcn.py:185:26
	v_div_scale_f32 v50, s0, v123, v57, v123
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	...
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
	v_div_fixup_f32 v50, v50, v57, v123
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	...
	.loc	1 185 44                        ; generate_amdgcn.py:185:44
	v_dual_fmac_f32 v59, 0xbfb8aa3b, v119 :: v_dual_mul_f32 v62, v60, v57
	.loc	1 190 9 is_stmt 1               ; generate_amdgcn.py:190:9
	...
	.loc	1 185 19                        ; generate_amdgcn.py:185:19
	v_dual_mul_f32 v43, v177, v43 :: v_dual_fmac_f32 v54, v58, v54
	.loc	1 185 26                        ; generate_amdgcn.py:185:26
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_swiglu_bm16_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 652
