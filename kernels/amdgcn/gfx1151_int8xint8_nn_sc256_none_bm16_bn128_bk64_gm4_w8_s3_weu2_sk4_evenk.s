	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp17:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add3_u32 v2, s33, s2, v11
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s24, s12, s3
.Ltmp19:
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v13, v6, v4, s13
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_clause 0x1
	buffer_load_b32 v51, v4, s[4:7], 0 offen
	buffer_load_b32 v52, v6, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v7, v0, 0, 1
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v37, v10, v12
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v4, v3, 1, v8
	v_lshlrev_b32_e32 v3, 3, v6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v38, v6, 10, v7
	...
	v_perm_b32 v47, v23, v19, 0x7030602
	v_and_b16 v16.l, 0xff, v32.l
	v_lshrrev_b32_e32 v48, 8, v32
	v_lshrrev_b32_e32 v49, 24, v32
	...
	v_lshrrev_b32_e32 v64, 8, v45
	v_lshrrev_b32_e32 v65, 24, v45
	...
	v_lshlrev_b16 v24.l, 8, v61.l
	v_or_b16 v16.h, v16.h, v24.h
	v_lshlrev_b16 v24.h, 8, v62.l
	v_or_b16 v17.l, v17.l, v25.l
	v_lshlrev_b16 v25.l, 8, v63.l
	v_or_b16 v17.h, v17.h, v25.h
	v_lshlrev_b16 v25.h, 8, v64.l
	...
	v_lshlrev_b16 v28.h, 8, v70.l
	v_lshlrev_b16 v29.l, 8, v71.l
	v_lshlrev_b16 v29.h, 8, v72.l
	v_lshlrev_b16 v30.l, 8, v73.l
	v_lshlrev_b16 v30.h, 8, v74.l
	v_lshlrev_b16 v31.l, 8, v75.l
	v_lshlrev_b16 v31.h, 8, v77.l
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(1)
	ds_store_b32 v53, v51 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v54, v21 offset:640
	ds_store_b16_d16_hi v54, v21 offset:704
	...
	v_or_b16 v23.l, v50.l, v31.l
	v_or_b16 v23.h, v50.h, v31.h
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(0)
	ds_store_b32 v53, v52 offset:17408
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v54, v21 offset:8832
	ds_store_b16_d16_hi v54, v21 offset:8896
...
.LBB0_3:                                ; %Flow15
	...
	v_or_b32_e32 v16, s14, v1
	s_ashr_i32 s1, s24, 8
	v_or_b32_e32 v28, s33, v4
	v_or_b32_e32 v27, s33, v8
	v_or_b32_e32 v26, s33, v12
	v_mul_lo_u32 v29, v16, s1
	v_or_b32_e32 v24, s33, v14
	v_or_b32_e32 v22, s33, v15
	v_or_b32_e32 v25, s33, v5
	v_or_b32_e32 v23, s33, v6
	v_or_b32_e32 v21, s33, v7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s40, s38, 8
	s_mov_b32 s18, s15
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s15, s0, s40
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s40, s39, 31
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v51, s15, v13
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s40, s40, 24
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s41, s15, s35
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s39, s39, s40
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s41, s41, s33
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s39, s39, 8
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v99, v51, s[4:7], 0 offen
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cmp_lt_i32 s39, s1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v51, v29, s39, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s39, s39, s35
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v52, s41, v11
	v_add_nc_u32_e32 v53, s41, v46
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v54, v28, s39, 1
	v_add_lshl_u32 v55, v27, s39, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v56, v26, s39, 1
	v_add_lshl_u32 v57, v24, s39, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v58, v22, s39, 1
	v_add_lshl_u32 v67, v25, s39, 1
	v_add_lshl_u32 v68, v23, s39, 1
	v_add_lshl_u32 v69, v21, s39, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[59:62], v52, s[20:23], 0 offen
	buffer_load_b128 v[63:66], v53, s[20:23], 0 offen
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_dual_cndmask_b32 v51, 0x80000000, v51 :: v_dual_cndmask_b32 v52, 0x80000000, v54
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_dual_cndmask_b32 v53, 0x80000000, v55 :: v_dual_cndmask_b32 v54, 0x80000000, v56
	v_dual_cndmask_b32 v55, 0x80000000, v57 :: v_dual_cndmask_b32 v56, 0x80000000, v58
	v_dual_cndmask_b32 v57, 0x80000000, v67 :: v_dual_cndmask_b32 v58, 0x80000000, v68
	v_cndmask_b32_e32 v67, 0x80000000, v69, vcc_lo
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v100, v51, s[24:27], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v101, v52, s[28:31], 0 offen
	...
	s_mov_b32 s10, s34
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v51, s39, v30
	v_add_nc_u32_e32 v52, s39, v33
	s_mov_b32 s34, s19
	v_add_nc_u32_e32 v53, s39, v31
	v_add_nc_u32_e32 v54, s39, v32
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v55, s34, v47
	v_add_nc_u32_e32 v56, s34, v48
	v_add_nc_u32_e32 v57, s34, v49
	v_add_nc_u32_e32 v58, s34, v50
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[67:70], v51
	ds_load_b128 v[71:74], v52
	ds_load_b128 v[75:78], v53
	ds_load_b128 v[79:82], v54
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	s_waitcnt lgkmcnt(0)
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cselect_b32 s37, s34, 0
	s_add_i32 s39, s38, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_lshl_b32 s34, s37, 10
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s38, s11
	s_mov_b32 s38, s39
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s36, v42
	v_add_nc_u32_e32 v115, s36, v43
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[51:58], v[83:86], v[67:70], v[1:8] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v116, s36, v44
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[51:58], v[87:90], v[71:74], v[51:58] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[51:58], v[91:94], v[75:78], v[51:58] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[51:58], v[95:98], v[79:82], v[51:58] neg_lo:[1,1,0]
	...
	v_lshlrev_b16 v63.l, 8, v76.l
	v_lshlrev_b16 v63.h, 8, v77.l
	v_lshlrev_b16 v64.l, 8, v78.l
	v_lshlrev_b16 v64.h, 8, v79.l
	v_lshlrev_b16 v65.l, 8, v80.l
	v_lshlrev_b16 v65.h, 8, v81.l
	v_lshlrev_b16 v66.l, 8, v82.l
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v75, v84, v85
	v_mul_f32_e32 v76, v84, v86
	v_mul_f32_e32 v77, v84, v87
	v_mul_f32_e32 v78, v84, v88
	v_mul_f32_e32 v79, v84, v89
	v_mul_f32_e32 v80, v84, v90
	v_mul_f32_e32 v81, v84, v91
	v_dual_mul_f32 v82, v84, v92 :: v_dual_add_nc_u32 v109, s40, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v18, v79, v71
	v_dual_fmac_f32 v19, v80, v72 :: v_dual_add_nc_u32 v110, s36, v38
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v20, v81, v73 :: v_dual_add_nc_u32 v111, s36, v39
	v_dual_fmac_f32 v17, v78, v70 :: v_dual_add_nc_u32 v112, s36, v40
	v_dual_fmac_f32 v14, v82, v74 :: v_dual_add_nc_u32 v113, s36, v41
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v66.h, 8, v83.l
	v_or_b16 v51.l, v51.l, v59.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v12, v75, v67 :: v_dual_fmac_f32 v15, v76, v68
	v_fmac_f32_e32 v16, v77, v69
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b32 v109, v99 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v110, v56 offset:640
	ds_store_b16_d16_hi v110, v56 offset:704
...
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v46, v36 :: v_dual_mov_b32 v47, v34
...
.LBB0_8:                                ; %Flow16
	...
	v_mov_b32_e32 v4, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v7, v3, v45
	v_mov_b32_e32 v3, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_barrier
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_or_b32_e32 v53, v7, v46
	v_mov_b32_e32 v7, 0
...
; %bb.9:
	...
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v34, s19, v52
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v3, s19, v54
	v_add_nc_u32_e32 v7, s19, v53
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v11, s10, v33
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v42, v35 :: v_dual_add_nc_u32 v13, s10, v30
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v7, s19, v51
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v11, s10, v32
	v_add_nc_u32_e32 v13, s10, v31
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[59:62], v34
	ds_load_b128 v[63:66], v7
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[67:70], v11
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[35:42], v[43:46], v[55:58], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[35:42], v[3:6], v[47:50], v[35:42] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.LBB0_10:
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v36, v28, s4, 1
	v_add_lshl_u32 v37, v27, s4, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_cndmask_b32_e32 v35, 0x80000000, v35, vcc_lo
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v38, v26, s4, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v42, v35, s[8:11], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_dual_cndmask_b32 v35, 0x80000000, v36 :: v_dual_cndmask_b32 v36, 0x80000000, v37
	v_dual_cndmask_b32 v37, 0x80000000, v38 :: v_dual_cndmask_b32 v40, 0x80000000, v40
	v_add_lshl_u32 v38, v24, s4, 1
	v_add_lshl_u32 v41, v23, s4, 1
	v_add_lshl_u32 v43, v21, s4, 1
	...
	s_clause 0x7
	buffer_load_u16 v43, v35, s[16:19], 0 offen
...
; %bb.11:
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s36, v54
	v_add_nc_u32_e32 v39, s36, v53
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v33, s34, v33
	v_add_nc_u32_e32 v30, s34, v30
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[35:38], v2
	ds_load_b128 v[59:62], v39
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[63:66], v33
	ds_load_b128 v[67:70], v30
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s36, v51
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v51, 0 :: v_dual_add_nc_u32 v40, s36, v52
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v39, s34, v32
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v58, v51 :: v_dual_add_nc_u32 v41, s34, v31
	v_mov_b32_e32 v55, v51
	v_mov_b32_e32 v56, v51
	v_mov_b32_e32 v57, v51
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[30:33], v40
	ds_load_b128 v[71:74], v2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[75:78], v39
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[51:58], v[59:62], v[67:70], v[51:58] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[51:58], v[35:38], v[63:66], v[51:58] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[51:58], v[71:74], v[79:82], v[51:58] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[51:58], v[30:33], v[75:78], v[51:58] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_12:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_cndmask_b32 v21, 0x80000000, v21 :: v_dual_lshlrev_b32 v8, 1, v8
	s_clause 0x7
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v33, v30, v33 :: v_dual_and_b32 v0, 28, v0
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_cndmask_b32_e64 v50, 0x1040, 0, s0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v43.l, v30.l
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	v_mov_b16_e32 v44.l, v30.l
	v_mov_b16_e32 v45.l, v30.l
	v_mov_b16_e32 v46.l, v30.l
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v6, v43, v6, v17
	v_fma_f32 v7, v42, v7, v18
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v19, 0, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v5, v30, v5, v12
	v_fma_f32 v31, v31, v34, v14
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v3, v45, v3, v15
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v9, v14, v31, s2
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v15, v8, 8, 0
	v_xad_u32 v1, v8, 16, 0
	v_xad_u32 v34, 0x1850, v0, 0
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_xad_u32 v17, v8, 20, 0
	v_xad_u32 v18, v8, 24, 0
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v44, v4, v16
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v20, 0x408, v0, 0
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v26, v26, v36, v4
	v_fma_f32 v23, v23, v40, v13
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v21, v29, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v24, v24, v37, v6
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v21, v21, v41, v9
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v4, v4, v26, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v22, v22, v38, v7
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v16, v8, 12, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v5, v6, v24, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v8, v8, 28, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v9, v9, v21, s3
	v_cndmask_b32_e64 v6, v7, v22, s3
	v_cndmask_b32_e64 v7, v11, v25, s3
	v_cndmask_b32_e64 v11, v13, v23, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	ds_store_b32 v12, v2
	ds_store_b32 v14, v3
	ds_store_b32 v15, v4
	...
	v_add_lshl_u32 v12, v10, s4, 2
	v_add_lshl_u32 v11, v10, s1, 2
	v_add_lshl_u32 v13, v10, s2, 2
	v_add_lshl_u32 v14, v10, s5, 2
	v_add_lshl_u32 v15, v10, s6, 2
	s_waitcnt lgkmcnt(7)
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 117
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
