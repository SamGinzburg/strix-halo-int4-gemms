...
.Ltmp17:
	...
	v_or3_b32 v3, v20, v3, v8
	v_and_or_b32 v8, 0xf00, v21, v9
	s_cvt_f32_u32 s1, s5
.Ltmp18:
	.loc	1 247 36                        ; generate_amdgcn.py:247:36
	...
	s_lshl_b32 s0, s3, 6
	v_xor_b32_e32 v27, 40, v12
	s_cvt_u32_f32 s1, s1
	v_xor_b32_e32 v28, 48, v12
	v_xor_b32_e32 v29, 56, v12
	v_xor_b32_e32 v32, 8, v11
	v_xor_b32_e32 v33, 16, v11
	v_xor_b32_e32 v34, 24, v11
	v_xor_b32_e32 v35, 32, v11
	v_xor_b32_e32 v36, 40, v11
	v_xor_b32_e32 v37, 48, v11
	v_xor_b32_e32 v38, 56, v11
	v_xor_b32_e32 v40, 4, v3
	v_xor_b32_e32 v41, 8, v3
	v_xor_b32_e32 v42, 12, v3
	v_xor_b32_e32 v6, 16, v3
	v_xor_b32_e32 v44, 20, v3
	v_xor_b32_e32 v45, 24, v3
	v_xor_b32_e32 v46, 28, v3
	v_xor_b32_e32 v48, 0x1010, v0
	v_xor_b32_e32 v49, 0x2040, v0
	v_xor_b32_e32 v50, 0x3050, v0
	.loc	1 278 13                        ; generate_amdgcn.py:278:13
	v_or_b32_e32 v20, v10, v2
	v_lshl_or_b32 v9, v2, 2, s0
	v_lshl_or_b32 v10, v5, 3, s0
	s_mul_i32 s4, s4, s1
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
...
.LBB0_2:                                ; %._crit_edge
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b32 v39, v54
	ds_store_b32 v40, v57
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b32 v[1:2], v47 offset1:32
	ds_load_2addr_b32 v[3:4], v48 offset1:32
	ds_load_2addr_b32 v[5:6], v49 offset1:32
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v4, s45, v15
	s_lshl_b32 s10, s10, 7
	s_lshl_b32 s11, s4, 8
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v2, s45, v20
	v_or_b32_e32 v3, s10, v18
	v_subrev_nc_u32_e32 v58, s11, v1
	v_or_b32_e32 v1, s10, v16
	v_mad_u64_u32 v[11:12], null, s33, v4, v[9:10]
	s_lshl_b32 s4, s4, 7
	v_mul_lo_u32 v59, s43, v2
	v_subrev_nc_u32_e32 v2, s4, v3
	v_subrev_nc_u32_e32 v1, s4, v1
	v_dual_mov_b32 v54, 0 :: v_dual_mov_b32 v53, 0
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v51, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[12:13], null, s33, v2, v[10:11]
	v_mad_u64_u32 v[13:14], null, s33, v1, v[10:11]
	v_mov_b32_e32 v52, 0
	v_mov_b32_e32 v14, 0
	s_mov_b32 s46, 0
	s_mov_b32 s47, s34
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	s_and_b32 s4, s4, s3
	.loc	1 291 30                        ; generate_amdgcn.py:291:30
	v_dual_cndmask_b32 v1, 0x80000000, v3 :: v_dual_add_nc_u32 v6, v19, v58
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[68:69], v22
	ds_load_b64 v[70:71], v23
	ds_load_b64 v[72:73], v24
	ds_load_b64 v[74:75], v25
	ds_load_b64 v[76:77], v26
	ds_load_b64 v[78:79], v27
	ds_load_b64 v[80:81], v28
	ds_load_b64 v[82:83], v29
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v30, v[1:2], v[3:4] offset1:8
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 298 22                        ; generate_amdgcn.py:298:22
	...
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x7
	buffer_load_u16 v85, v6, s[24:27], 0 offen
	buffer_load_u16 v86, v6, s[24:27], 0 offen offset:4
	buffer_load_u16 v87, v6, s[24:27], 0 offen offset:8
	buffer_load_u16 v88, v6, s[24:27], 0 offen offset:12
	buffer_load_u16 v89, v6, s[24:27], 0 offen offset:16
	buffer_load_u16 v90, v6, s[24:27], 0 offen offset:20
	buffer_load_u16 v91, v6, s[24:27], 0 offen offset:24
	buffer_load_u16 v92, v6, s[24:27], 0 offen offset:28
	...
	v_dual_fmac_f32 v54, v1, v62 :: v_dual_add_nc_u32 v59, 2, v59
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	...
	v_dual_fmac_f32 v52, v6, v67 :: v_dual_lshlrev_b32 v69, 16, v92
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_mul_f32_e32 v5, v5, v61
	v_mul_f32_e32 v7, v7, v61
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v56, v3, v64 :: v_dual_fmac_f32 v55, v4, v65
	v_dual_fmac_f32 v14, v60, v69 :: v_dual_fmac_f32 v53, v5, v66
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.numbered_sgpr, 48
