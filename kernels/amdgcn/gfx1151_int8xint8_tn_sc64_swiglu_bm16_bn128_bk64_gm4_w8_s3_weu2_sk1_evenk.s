...
.Ltmp19:
	...
	buffer_load_b32 v73, v3, s[4:7], 0 offen
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_b32_e32 v6, 0x70, v26
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b32 v82, v23, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v5, v0, 0, 1
	...
	v_lshrrev_b32_e32 v83, 24, v50
	v_and_b16 v18.h, 0xff, v50.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(6)
	v_perm_b32 v50, v27, v19, 0x5010400
	v_perm_b32 v84, v27, v19, 0x7030602
	v_perm_b32 v85, v28, v20, 0x5010400
	v_perm_b32 v86, v28, v20, 0x7030602
	v_perm_b32 v87, v29, v21, 0x5010400
	v_perm_b32 v88, v29, v21, 0x7030602
	v_perm_b32 v89, v30, v22, 0x5010400
	v_perm_b32 v90, v30, v22, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(4)
	v_perm_b32 v91, v35, v31, 0x5010400
	v_perm_b32 v92, v35, v31, 0x7030602
	v_perm_b32 v93, v36, v32, 0x5010400
	v_perm_b32 v94, v36, v32, 0x7030602
	v_perm_b32 v95, v37, v33, 0x5010400
	v_perm_b32 v96, v37, v33, 0x7030602
	v_perm_b32 v97, v38, v34, 0x5010400
	v_perm_b32 v98, v38, v34, 0x7030602
	...
	v_and_b16 v30.l, 0xff, v84.l
	v_lshrrev_b32_e32 v56, 8, v84
	v_lshrrev_b32_e32 v57, 24, v84
	v_and_b16 v30.h, 0xff, v84.h
	v_and_b16 v31.l, 0xff, v85.l
	v_lshrrev_b32_e32 v58, 8, v85
	v_lshrrev_b32_e32 v59, 24, v85
	v_and_b16 v31.h, 0xff, v85.h
	v_and_b16 v32.l, 0xff, v86.l
	v_lshrrev_b32_e32 v60, 8, v86
	v_lshrrev_b32_e32 v61, 24, v86
	...
	v_and_b16 v52.l, 0xff, v97.l
	v_lshrrev_b32_e32 v96, 8, v97
	v_lshrrev_b32_e32 v106, 24, v97
	v_and_b16 v52.h, 0xff, v97.h
	v_and_b16 v53.l, 0xff, v98.l
	v_lshrrev_b32_e32 v97, 8, v98
	v_lshrrev_b32_e32 v107, 24, v98
	v_and_b16 v53.h, 0xff, v98.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	s_waitcnt vmcnt(1)
	v_perm_b32 v98, v45, v39, 0x5010400
	v_perm_b32 v108, v45, v39, 0x7030602
	v_perm_b32 v109, v46, v40, 0x5010400
	v_perm_b32 v110, v46, v40, 0x7030602
	v_perm_b32 v111, v47, v41, 0x5010400
	v_perm_b32 v112, v47, v41, 0x7030602
	v_perm_b32 v113, v48, v42, 0x5010400
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_perm_b32 v114, v48, v42, 0x7030602
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_lshlrev_b16 v23.h, 8, v84.l
	v_lshlrev_b16 v24.l, 8, v85.l
	v_lshlrev_b16 v24.h, 8, v86.l
	...
	v_lshlrev_b16 v28.h, 8, v99.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v39.l, 8, v90.l
	v_lshlrev_b16 v39.h, 8, v100.l
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v75, v11
	ds_store_b16_d16_hi v75, v11 offset:64
	ds_store_b16 v76, v12
	ds_store_b16_d16_hi v76, v12 offset:64
	ds_store_b16 v77, v13
	ds_store_b16_d16_hi v77, v13 offset:64
	ds_store_b16 v78, v14
	ds_store_b16_d16_hi v78, v14 offset:64
	ds_store_b16 v79, v15
	ds_store_b16_d16_hi v79, v15 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_or_b16 v13.h, v32.l, v22.l
	v_lshlrev_b16 v32.l, 8, v83.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v40.h, 8, v101.l
	v_lshlrev_b16 v47.l, 8, v96.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshrrev_b32_e32 v96, 24, v113
	v_or_b16 v19.l, v29.l, v19.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v46.h, 8, v105.l
	v_lshlrev_b16 v48.l, 8, v97.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v55.l, 0xff, v108.l
	v_and_b16 v55.h, 0xff, v108.h
	v_and_b16 v56.l, 0xff, v109.l
	v_and_b16 v56.h, 0xff, v109.h
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v41.h, 8, v102.l
	v_lshlrev_b16 v42.h, 8, v103.l
	v_lshlrev_b16 v45.h, 8, v104.l
	v_lshlrev_b16 v47.h, 8, v106.l
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v54.h, 0xff, v98.h
	v_and_b16 v57.l, 0xff, v110.l
	v_and_b16 v57.h, 0xff, v110.h
	v_and_b16 v58.l, 0xff, v111.l
	v_and_b16 v58.h, 0xff, v111.h
	v_and_b16 v59.l, 0xff, v112.l
	v_and_b16 v59.h, 0xff, v112.h
	v_and_b16 v60.l, 0xff, v113.l
	...
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_lshlrev_b16 v32.h, 8, v84.l
	v_lshlrev_b16 v35.l, 8, v89.l
	v_lshlrev_b16 v35.h, 8, v90.l
	v_lshlrev_b16 v36.l, 8, v91.l
	v_lshlrev_b16 v36.h, 8, v92.l
	v_lshlrev_b16 v37.l, 8, v93.l
	v_lshlrev_b16 v37.h, 8, v94.l
	v_lshlrev_b16 v38.l, 8, v95.l
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	ds_store_b32 v74, v73 offset:32768
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v75, v19 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v75, v16 offset:640
	ds_store_b16_d16_hi v75, v16 offset:704
	ds_store_b16 v80, v17
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v75, v11 offset:16448
	ds_store_b16_d16_hi v76, v11 offset:16384
	ds_store_b16 v76, v12 offset:16448
	ds_store_b16_d16_hi v77, v12 offset:16384
	ds_store_b16 v77, v13 offset:16448
	ds_store_b16_d16_hi v78, v13 offset:16384
	ds_store_b16 v78, v14 offset:16448
	ds_store_b16_d16_hi v79, v14 offset:16384
	ds_store_b16 v79, v15 offset:16448
	ds_store_b16_d16_hi v75, v15 offset:17024
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v80, v17 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v75, v19 offset:17088
	ds_store_b16 v80, v20 offset:16384
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v81, v18
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v80, v20 offset:16448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v81, v18 offset:64
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v81, v21 offset:16384
	ds_store_b16_d16_hi v81, v21 offset:16448
	v_or_b16 v11.l, v54.l, v32.l
	v_and_b16 v60.h, 0xff, v113.h
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v48.h, 8, v107.l
	v_or_b16 v29.h, v51.h, v46.h
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	v_and_b16 v61.l, 0xff, v114.l
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_store_b16 v77, v24 offset:8192
	ds_store_b16_d16_hi v77, v24 offset:8256
	ds_store_b16 v78, v27 offset:8192
	ds_store_b16_d16_hi v78, v27 offset:8256
	ds_store_b16 v79, v28 offset:8192
	ds_store_b16_d16_hi v79, v28 offset:8256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	...
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	s_waitcnt vmcnt(0)
	ds_store_b32 v74, v82 offset:33792
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16 v75, v11 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v75, v29 offset:8832
	ds_store_b16_d16_hi v75, v29 offset:8896
	ds_store_b16 v80, v30 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v75, v11 offset:24640
	ds_store_b16 v76, v12 offset:24576
	ds_store_b16_d16_hi v76, v12 offset:24640
	ds_store_b16 v77, v13 offset:24576
	ds_store_b16_d16_hi v77, v13 offset:24640
	ds_store_b16 v78, v14 offset:24576
	ds_store_b16_d16_hi v78, v14 offset:24640
	ds_store_b16 v79, v15 offset:24576
	ds_store_b16_d16_hi v79, v15 offset:24640
	ds_store_b16 v75, v16 offset:25216
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v80, v30 offset:8256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v75, v16 offset:25280
	...
	ds_store_b16 v80, v17 offset:24576
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16 v81, v31 offset:8192
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
	ds_store_b16_d16_hi v80, v17 offset:24640
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_b16_d16_hi v81, v31 offset:8256
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_and_or_b32 v73, 0x1800, v12, v13
	s_mov_b32 s10, 0
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v28, v118, v126 :: v_dual_mul_f32 v83, v111, v141
	.loc	1 426 31                        ; generate_amdgcn.py:426:31
	...
	.loc	1 426 31                        ; generate_amdgcn.py:426:31
	v_lshlrev_b32_e32 v140, 16, v203
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_dual_mul_f32 v86, v111, v142 :: v_dual_lshlrev_b32 v131, 16, v193
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v137, 16, v199
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_fmac_f32 v27, v82, v101 :: v_dual_mul_f32 v84, v111, v140
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v133, 16, v195
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fmac_f32_e32 v35, v85, v108
	.loc	1 428 33                        ; generate_amdgcn.py:428:33
	v_dual_mul_f32 v88, v111, v144 :: v_dual_add_nc_u32 v205, s45, v66
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_dual_fmac_f32 v42, v81, v100 :: v_dual_mul_f32 v113, v111, v131
	v_fmac_f32_e32 v38, v84, v105
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v115, v111, v133
	.loc	1 431 17                        ; generate_amdgcn.py:431:17
	v_fmac_f32_e32 v34, v86, v109
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v119, v111, v137 :: v_dual_fmac_f32 v30, v88, v128
	v_mul_f32_e32 v117, v111, v135
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v41, v112, v98 :: v_dual_add_nc_u32 v206, s45, v67
	v_dual_fmac_f32 v40, v113, v99 :: v_dual_add_nc_u32 v207, s45, v68
	v_dual_fmac_f32 v37, v114, v102 :: v_dual_add_nc_u32 v208, s45, v69
	v_dual_fmac_f32 v36, v115, v103 :: v_dual_add_nc_u32 v209, s45, v70
	v_dual_fmac_f32 v33, v116, v106 :: v_dual_add_nc_u32 v210, s45, v71
	v_dual_fmac_f32 v32, v117, v107 :: v_dual_add_nc_u32 v211, s45, v72
	.loc	1 414 31                        ; generate_amdgcn.py:414:31
...
; %bb.9:
	...
	v_perm_b32 v140, v67, v72, 0xc0c0004
	...
	v_perm_b32 v130, v73, v80, 0xc0c0004
...
; %bb.11:
	...
	v_perm_b32 v72, v23, v25, 0xc0c0004
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 212
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 48
