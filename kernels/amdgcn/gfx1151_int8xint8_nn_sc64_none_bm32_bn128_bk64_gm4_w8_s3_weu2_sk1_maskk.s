...
.Ltmp19:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(4)
	v_perm_b32 v33, v19, v15, 0x5010400
	...
	v_perm_b32 v37, v22, v18, 0x5010400
	v_perm_b32 v39, v22, v18, 0x7030602
	...
	v_lshrrev_b32_e32 v75, 8, v37
	v_lshrrev_b32_e32 v76, 24, v37
	...
	s_waitcnt vmcnt(2)
	v_perm_b32 v33, v29, v23, 0x5010400
	...
	v_lshlrev_b16 v35.l, 8, v67.l
	v_lshlrev_b16 v35.h, 8, v68.l
	...
	v_perm_b32 v23, v29, v23, 0x7030602
	v_perm_b32 v29, v30, v24, 0x5010400
	v_perm_b32 v24, v30, v24, 0x7030602
	v_perm_b32 v30, v31, v25, 0x5010400
	v_perm_b32 v25, v31, v25, 0x7030602
	v_perm_b32 v31, v32, v26, 0x5010400
	v_perm_b32 v26, v32, v26, 0x7030602
	v_or_b16 v16.l, v16.l, v34.l
	v_lshrrev_b32_e32 v32, 8, v33
	v_or_b16 v16.h, v16.h, v34.h
	v_lshrrev_b32_e32 v34, 24, v33
	v_or_b16 v17.l, v17.l, v35.l
	v_or_b16 v17.h, v17.h, v35.h
	v_or_b16 v18.l, v18.l, v37.l
	v_or_b16 v18.h, v18.h, v37.h
	v_or_b16 v19.l, v19.l, v39.l
	v_or_b16 v19.h, v19.h, v39.h
	...
	v_lshlrev_b16 v30.h, 8, v43.l
	v_lshlrev_b16 v31.l, 8, v44.l
	...
	v_or_b16 v19.l, v19.l, v29.l
	v_or_b16 v19.h, v19.h, v29.h
	v_or_b16 v20.l, v20.l, v30.l
	v_or_b16 v20.h, v20.h, v30.h
...
.LBB0_3:                                ; %Flow81
	...
	v_mul_lo_u32 v39, v15, s1
	v_mul_lo_u32 v40, v4, s1
	v_or_b32_e32 v34, s33, v12
	v_or_b32_e32 v32, s33, v13
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v63, v39, s18, 1
	v_add_lshl_u32 v64, v40, s18, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s18, s18, s27
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s0, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v67, v37, s18, 1
	v_add_lshl_u32 v68, v35, s18, 1
	v_add_lshl_u32 v69, v34, s18, 1
	v_add_lshl_u32 v70, v32, s18, 1
	v_add_lshl_u32 v71, v30, s18, 1
	v_add_lshl_u32 v72, v33, s18, 1
	v_add_lshl_u32 v73, v31, s18, 1
	v_add_lshl_u32 v74, v29, s18, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v134, v67, s[40:43], 0 offen
	buffer_load_u16 v135, v66, s[40:43], 0 offen
	buffer_load_u16 v136, v69, s[40:43], 0 offen
	buffer_load_u16 v137, v68, s[40:43], 0 offen
	buffer_load_u16 v138, v71, s[40:43], 0 offen
	buffer_load_u16 v139, v70, s[40:43], 0 offen
	buffer_load_u16 v140, v73, s[40:43], 0 offen
	buffer_load_u16 v141, v72, s[40:43], 0 offen
	s_mov_b32 s0, s14
	s_mov_b32 s18, s16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v114, v73, v71 :: v_dual_lshlrev_b32 v79, 16, v140
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_fmac_f32_e32 v26, v114, v87
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v121, v78, v71
	v_dual_mul_f32 v122, v77, v71 :: v_dual_lshlrev_b32 v75, 16, v136
	v_dual_mul_f32 v125, v79, v71 :: v_dual_add_nc_u32 v142, s18, v48
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v18, v121, v90
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v118, v75, v71
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v20, v122, v91
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v70, v85, v81, 0x7030602
	v_lshrrev_b32_e32 v81, 8, v63
	v_lshrrev_b32_e32 v82, 24, v63
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v24, v118, v89
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v115, v72, v73
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v23, v115, v94
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v119, v72, v75 :: v_dual_lshlrev_b32 v76, 16, v137
	v_mul_f32_e32 v123, v72, v77
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b16 v63.l, 0xff, v64.l
	v_and_b16 v64.l, 0xff, v65.l
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v19, v119, v96
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v120, v72, v76
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v15, v123, v98 :: v_dual_lshlrev_b32 v74, 16, v135
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v78, v72, v78 :: v_dual_add_nc_u32 v143, s44, v49
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(0)
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v16, v125, v93
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v79, v72, v79 :: v_dual_add_nc_u32 v144, s44, v50
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v21, v120, v97
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v113, v74, v71 :: v_dual_mul_f32 v116, v72, v74
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v17, v78, v99
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v145, s44, v51
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v124, v80, v71 :: v_dual_add_nc_u32 v147, s44, v53
	...
	v_dual_fmac_f32 v25, v116, v95 :: v_dual_add_nc_u32 v148, s44, v54
	v_dual_fmac_f32 v22, v117, v88 :: v_dual_add_nc_u32 v149, s44, v55
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v14, v124, v92
	v_dual_fmac_f32 v13, v80, v101 :: v_dual_fmac_f32 v12, v79, v100
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.9:
	...
	v_dual_mov_b32 v50, s8 :: v_dual_add_nc_u32 v27, s14, v41
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v47, s5 :: v_dual_add_nc_u32 v6, s14, v44
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v28, s14, v42
	...
	ds_load_b128 v[93:96], v28 offset:1024
	ds_load_b128 v[97:100], v28
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v48, s6 :: v_dual_add_nc_u32 v7, s14, v43
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_10:
	...
	s_cmp_lt_i32 s0, s1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v50, v39, s0, 1
	v_add_lshl_u32 v51, v40, s0, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
...
; %bb.11:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v86, s11 :: v_dual_add_nc_u32 v1, s44, v76
	v_dual_mov_b32 v85, s10 :: v_dual_add_nc_u32 v50, s44, v75
	v_dual_mov_b32 v84, s9 :: v_dual_add_nc_u32 v51, s44, v74
	v_dual_mov_b32 v83, s8 :: v_dual_add_nc_u32 v52, s44, v73
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	ds_load_b128 v[60:63], v1
	ds_load_b128 v[73:76], v50
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v82, s7 :: v_dual_add_nc_u32 v1, s35, v41
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[87:90], v51
	ds_load_b128 v[91:94], v52
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v80, s5 :: v_dual_add_nc_u32 v51, s35, v42
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[95:98], v1 offset:1024
	ds_load_b128 v[99:102], v1
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v81, s6 :: v_dual_add_nc_u32 v50, s35, v44
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[52:59], v[73:76], v[41:44], v[52:59] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
...
.LBB0_12:
	...
	v_dual_cndmask_b32 v29, 0x80000000, v29 :: v_dual_mul_f32 v82, v41, v43
	s_clause 0x7
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v65.l, v41.l
	v_mov_b16_e32 v67.l, v41.l
	v_mov_b16_e32 v69.l, v41.l
	v_mov_b16_e32 v70.l, v41.l
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v81, v41, v44 :: v_dual_mul_f32 v44, v44, v42
	v_dual_mul_f32 v85, v41, v68 :: v_dual_mul_f32 v68, v68, v42
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	v_add3_u32 v9, s0, v10, v9
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v83, v41, v66
	v_mul_f32_e32 v66, v66, v42
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_dual_mov_b32 v72, 0x7632 :: v_dual_mul_f32 v43, v43, v42
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v84, v41, v65
	v_mul_f32_e32 v65, v65, v42
	v_dual_mul_f32 v86, v41, v67 :: v_dual_mul_f32 v67, v67, v42
	v_mul_f32_e32 v87, v41, v70
	v_mul_f32_e32 v41, v41, v69
	v_mul_f32_e32 v69, v69, v42
	v_mul_f32_e32 v42, v70, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v27, v44, v27, v11
	v_fma_f32 v3, v68, v3, v18
	v_fma_f32 v5, v43, v5, v26
	v_fma_f32 v28, v85, v28, v17
	...
	s_lshl_b32 s1, s27, 4
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v36, v81, v36, v25
	v_fma_f32 v43, v84, v49, v19
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v20, v7, s2
	v_cndmask_b32_e64 v2, v22, v2, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v41, v41, v48, v12
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v12, v12, v41, s2
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	s_mov_b32 s27, s15
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v31, v23, v14 :: v_dual_lshlrev_b32 v20, 16, v37
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v6, v24, v6, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v23, v16, v23 :: v_dual_lshlrev_b32 v24, 16, v33
	v_mul_f32_e32 v33, v26, v14
	v_mul_f32_e32 v35, v28, v14
	v_mul_f32_e32 v28, v16, v28
	v_dual_mul_f32 v29, v20, v14 :: v_dual_lshlrev_b32 v22, 16, v32
	...
	v_dual_cndmask_b32 v11, 0x3276, v72 :: v_dual_and_b32 v22, 1, v77
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v42, s[24:27], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 150
