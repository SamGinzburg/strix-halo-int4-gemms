	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_fmac_f32 v38, v246, v136 :: v_dual_fmac_f32 v45, v213, v139
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v194, v24, v193 offset1:16
	...
	v_dual_fmac_f32 v46, v214, v140 :: v_dual_fmac_f32 v49, v216, v142
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v194, v24, v193 offset1:16
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v48, v215, v141 :: v_dual_fmac_f32 v53, v228, v146
...
; %bb.11:
	...
	v_dual_mov_b32 v0, v98 :: v_dual_mov_b32 v123, v47
	v_dual_mov_b32 v98, v115 :: v_dual_mov_b32 v121, v44
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[112:115], v96 offset:2048
	v_dual_mov_b32 v122, v43 :: v_dual_mov_b32 v47, v116
	v_dual_mov_b32 v120, v41 :: v_dual_mov_b32 v43, v24
	v_dual_mov_b32 v44, v117 :: v_dual_mov_b32 v41, v118
	...
	v_dual_mov_b32 v24, v43 :: v_dual_mov_b32 v247, v138
	...
	v_dual_mov_b32 v244, v135 :: v_dual_mov_b32 v117, v44
...
.LBB0_12:
	...
	s_mul_i32 s5, s4, s35
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v18, v47, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v19, v44, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v44, v44, v148, v86
	v_fma_f32 v47, v47, v0, v93
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v97, v97, v217, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v44, v86, v44, s3
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_cndmask_b32_e64 v47, v93, v47, s3
	...
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v115, v11, v40 :: v_dual_mul_f32 v132, v13, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_mul_f32 v112, v8, v40 :: v_dual_mul_f32 v125, v6, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_mul_f32 v49, v3, v18 :: v_dual_mul_f32 v106, v2, v40
	...
	v_dual_mul_f32 v119, v15, v40 :: v_dual_mul_f32 v120, v1, v41
	...
	v_cndmask_b32_e64 v19, v45, v101, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v117, v13, v40
	v_dual_mul_f32 v40, v16, v40 :: v_dual_mul_f32 v13, v13, v42
	v_mul_f32_e32 v16, v16, v42
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v42, v48, v100, v26
	v_fma_f32 v48, v51, v164, v28
	...
	v_cndmask_b32_e64 v27, v28, v48, s2
	...
	v_dual_max_f32 v23, v31, v31 :: v_dual_max_f32 v80, 0, v26
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v48, v55, v110, s2
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v16, v30, v30 :: v_dual_max_f32 v77, 0, v15
	...
	v_dual_max_f32 v15, v42, v42 :: v_dual_max_f32 v74, 0, v16
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v83, 0, v19 :: v_dual_max_f32 v32, 0, v12
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v85, 0, v19 :: v_dual_max_f32 v36, 0, v12
	v_dual_max_f32 v12, v38, v38 :: v_dual_max_f32 v19, v51, v51
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v4, v81, v4, s2
	v_cndmask_b32_e64 v5, v82, v5, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v81, 0, v16
	v_dual_max_f32 v38, 0, v12 :: v_dual_max_f32 v51, 0, v19
	v_max_f32_e32 v12, v22, v22
	v_max_f32_e32 v82, 0, v18
	v_max_f32_e32 v16, v24, v24
	v_max_f32_e32 v18, v43, v43
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_max_f32 v43, 0, v15 :: v_dual_max_f32 v42, 0, v12
	v_dual_max_f32 v19, v55, v55 :: v_dual_max_f32 v12, v46, v46
	v_max_f32_e32 v15, v48, v48
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v84, v7, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v84, 0, v18 :: v_dual_max_f32 v55, 0, v19
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_max_f32 v19, v60, v60 :: v_dual_max_f32 v48, 0, v15
	v_max_f32_e32 v15, v53, v53
	v_dual_max_f32 v45, 0, v16 :: v_dual_max_f32 v16, v49, v49
	v_max_f32_e32 v18, v50, v50
	v_dual_max_f32 v60, 0, v19 :: v_dual_max_f32 v19, v65, v65
	v_max_f32_e32 v1, v1, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v49, 0, v16 :: v_dual_max_f32 v50, 0, v18
	...
	v_max_f32_e32 v52, 0, v15
	v_max_f32_e32 v54, 0, v18
	v_max_f32_e32 v18, v59, v59
	v_dual_max_f32 v16, v40, v40 :: v_dual_max_f32 v15, v57, v57
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v9, v9, v219, v87
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v35, 0, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_max_f32_e32 v59, 0, v18
	v_dual_max_f32 v53, 0, v16 :: v_dual_max_f32 v16, v58, v58
	v_dual_max_f32 v57, 0, v15 :: v_dual_max_f32 v40, 0, v12
	v_dual_max_f32 v15, v62, v62 :: v_dual_max_f32 v18, v64, v64
	s_delay_alu instid0(VALU_DEP_3)
	v_max_f32_e32 v58, 0, v16
	...
	v_dual_max_f32 v12, v56, v56 :: v_dual_max_f32 v37, 0, v18
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v56, 0, v12
	v_dual_max_f32 v62, 0, v15 :: v_dual_max_f32 v29, 0, v1
	v_dual_max_f32 v15, v67, v67 :: v_dual_max_f32 v18, v41, v41
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v63, 0, v16 :: v_dual_max_f32 v34, 0, v15
	v_max_f32_e32 v30, 0, v18
	v_dual_max_f32 v26, 0, v3 :: v_dual_max_f32 v3, v9, v9
	v_max_f32_e32 v18, 0, v1
	v_dual_max_f32 v1, v69, v69 :: v_dual_max_f32 v16, v68, v68
	v_dual_max_f32 v27, 0, v2 :: v_dual_max_f32 v6, v44, v44
	v_max_f32_e32 v2, v8, v8
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v14, v86, v14, s2
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v12, v61, v61 :: v_dual_max_f32 v31, 0, v16
	v_dual_max_f32 v15, 0, v3 :: v_dual_max_f32 v22, 0, v4
	v_dual_max_f32 v4, v10, v10 :: v_dual_mul_f32 v9, v71, v71
	...
	v_dual_max_f32 v61, 0, v12 :: v_dual_max_f32 v12, v66, v66
	v_max_f32_e32 v23, 0, v5
	v_dual_max_f32 v5, v11, v11 :: v_dual_max_f32 v16, 0, v4
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v41, v73, v73 :: v_dual_mul_f32 v32, v32, v32
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v14, 0, v1 :: v_dual_mul_f32 v25, v74, v74
	v_dual_max_f32 v10, 0, v2 :: v_dual_and_b32 v21, 1, v21
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v8, 0, v5 :: v_dual_and_b32 v41, 1, v44
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v36, v36, v36
	v_mul_f32_e32 v44, v76, v76
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15 is_stmt 1              ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v47, v77, v77 :: v_dual_add_nc_u32 v2, 0x80, v4
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v21, v24, v21, 0x7fff
	v_mov_b16_e32 v21.l, v25.h
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v43, v43, v43 :: v_dual_and_b32 v24, 1, v41
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_and_b32_e32 v25, 1, v32
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v32, v78, v78
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v41.l, v47.h
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v64, v79, v79 :: v_dual_mul_f32 v37, v37, v37
	v_mul_f32_e32 v33, v33, v33
	v_mul_f32_e32 v35, v35, v35
	v_mul_f32_e32 v31, v31, v31
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v47.l, v64.h
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v34, v34, v34 :: v_dual_mul_f32 v29, v29, v29
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v47, v64, v32, 0x7fff
	v_add3_u32 v32, v41, v36, 0x7fff
	v_mov_b16_e32 v36.l, v39.h
	v_mov_b16_e32 v36.h, v20.l
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v64, v81, v81 :: v_dual_and_b32 v41, 1, v44
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v32.l, v47.h
	v_mov_b16_e32 v47.h, v20.l
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v42, v42, v42 :: v_dual_and_b32 v47, 1, v47
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v41.l, v44.h
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v7, v7, v7
	v_dual_mul_f32 v19, v19, v19 :: v_dual_mul_f32 v14, v14, v14
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v47, v85, v85 :: v_dual_and_b32 v44, 1, v44
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_mov_b16_e32 v44.h, v20.l
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v46, v46, v46 :: v_dual_and_b32 v45, 1, v64
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v49, v57, v57 :: v_dual_and_b32 v0, 16, v0
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_dual_cndmask_b32 v31, v50, v47 :: v_dual_and_b32 v22, 1, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	v_dual_cndmask_b32 v33, v48, v45 :: v_dual_and_b32 v12, 1, v12
	v_dual_cndmask_b32 v37, v34, v51 :: v_dual_cndmask_b32 v34, v51, v34
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_and_b32_e32 v15, 1, v15
	v_add3_u32 v11, v11, v12, 0x7fff
	v_dual_cndmask_b32 v12, v32, v24 :: v_dual_cndmask_b32 v27, v46, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	...
	v_dual_cndmask_b32 v19, v26, v19 :: v_dual_cndmask_b32 v40, v11, v16
	v_dual_cndmask_b32 v11, v16, v11 :: v_dual_mov_b32 v26, 0x7632
	v_dual_mov_b32 v16, 0x5410 :: v_dual_cndmask_b32 v41, v0, v14
	v_cndmask_b32_e32 v0, v14, v0, vcc_lo
	v_permlanex16_b32 v14, v7, s2, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_cndmask_b32 v32, v47, v50 :: v_dual_cndmask_b32 v7, 0x1054, v16
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 72
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 72
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc256_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
