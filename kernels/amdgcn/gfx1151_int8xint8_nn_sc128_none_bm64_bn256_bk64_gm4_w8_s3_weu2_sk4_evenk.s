	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_add_nc_u32_e32 v102, s33, v101
...
.Ltmp21:
	...
	v_add_nc_u32_e32 v5, s12, v101
	v_add_nc_u32_e32 v104, s34, v101
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v3, s26, v103
	...
	v_add_nc_u32_e32 v8, s12, v104
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	s_cmpk_gt_i32 s13, 0x1ff
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v6, s12, v102
	...
	buffer_load_b128 v[9:12], v3, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[13:16], v5, s[20:23], 0 offen
	buffer_load_b128 v[17:20], v7, s[20:23], 0 offen
	buffer_load_b128 v[23:26], v8, s[20:23], 0 offen
	buffer_load_b128 v[27:30], v6, s[20:23], 0 offen
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v5, s12, v104
	v_add_nc_u32_e32 v6, s12, v102
	.loc	1 398 17 is_stmt 1              ; generate_amdgcn.py:398:17
	s_add_i32 s41, s26, 0x100
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v7, 32, v1
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v3, s41, v103
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e64 v5, 0x80000000, v5, s2
	v_cndmask_b32_e64 v6, 0x80000000, v6, s2
	s_clause 0x1
	buffer_load_b128 v[31:34], v5, s[20:23], 0 offen
	...
	v_cndmask_b32_e64 v6, 0x80000000, v6, s2
	s_clause 0x1
	buffer_load_b128 v[39:42], v5, s[20:23], 0 offen
	buffer_load_b128 v[43:46], v6, s[20:23], 0 offen
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	buffer_load_b128 v[47:50], v3, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v3, v0, 0, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v108, v21, v6
	v_lshlrev_b32_e32 v4, 3, v0
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_or_b32_e32 v6, 16, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v109, v5, 10, v3
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_add_nc_u32_e32 v56, 0x4000, v21
	...
	v_perm_b32 v35, v10, v9, 0x7060302
	...
	s_waitcnt vmcnt(1)
	v_perm_b32 v20, v43, v39, 0x4000501
	v_perm_b32 v29, v36, v32, 0x4000501
	v_perm_b32 v30, v36, v32, 0x6020703
	v_perm_b32 v36, v43, v39, 0x6020703
	v_perm_b32 v31, v37, v33, 0x4000501
	v_perm_b32 v32, v37, v33, 0x6020703
	v_perm_b32 v37, v44, v40, 0x4000501
	v_perm_b32 v33, v38, v34, 0x4000501
	v_perm_b32 v34, v38, v34, 0x6020703
	v_perm_b32 v38, v44, v40, 0x6020703
	v_perm_b32 v39, v45, v41, 0x4000501
	v_perm_b32 v40, v45, v41, 0x6020703
	v_perm_b32 v41, v46, v42, 0x4000501
	v_perm_b32 v42, v46, v42, 0x6020703
	ds_store_2addr_b32 v21, v35, v9 offset1:16
	ds_store_2addr_b32 v22, v10, v11 offset1:16
	ds_store_2addr_b32 v51, v12, v13 offset1:16
	ds_store_2addr_b32 v52, v17, v14 offset1:16
	ds_store_2addr_b32 v53, v18, v23 offset1:16
	ds_store_2addr_b32 v21, v24, v15 offset0:160 offset1:176
	ds_store_2addr_b32 v54, v19, v25 offset1:16
	ds_store_2addr_b32 v55, v27, v16 offset1:16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v3, v[47:50] offset:36864
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v3, v26, v20, 0x7060302
	v_perm_b32 v9, v26, v20, 0x5040100
	v_perm_b32 v10, v28, v36, 0x7060302
	v_perm_b32 v11, v28, v36, 0x5040100
	v_perm_b32 v12, v29, v37, 0x7060302
	v_perm_b32 v13, v29, v37, 0x5040100
	v_perm_b32 v14, v30, v38, 0x7060302
	v_perm_b32 v15, v30, v38, 0x5040100
	v_perm_b32 v16, v31, v39, 0x7060302
	v_perm_b32 v17, v31, v39, 0x5040100
	v_perm_b32 v18, v32, v40, 0x7060302
	v_perm_b32 v19, v32, v40, 0x5040100
	v_perm_b32 v20, v33, v41, 0x7060302
	v_perm_b32 v21, v33, v41, 0x5040100
	v_perm_b32 v22, v34, v42, 0x7060302
	v_perm_b32 v23, v34, v42, 0x5040100
	ds_store_2addr_b32 v56, v3, v9 offset1:16
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v105, 48, v4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b32_e32 v234, 5, v0
	v_and_b32_e32 v3, 8, v0
	v_and_b32_e32 v235, 32, v0
	s_mov_b32 s10, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v94, v1, 6, v105
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_and_b32_e32 v106, 0x1800, v234
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_3:                                ; %Flow90
	...
	v_mul_lo_u32 v44, v10, s42
	v_mul_lo_u32 v41, v6, s42
	v_mul_lo_u32 v42, v7, s42
	v_mul_lo_u32 v43, v8, s42
	v_or_b32_e32 v23, s27, v0
	v_lshlrev_b32_e32 v11, 6, v0
	v_lshlrev_b32_e32 v99, 2, v2
	v_lshlrev_b32_e32 v107, 1, v5
...
.Ltmp22:
	...
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	v_dual_mov_b32 v25, 0 :: v_dual_and_b32 v2, 0x210, v2
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	...
	v_and_b32_e32 v106, 0x1800, v97
	v_bfe_i32 v4, v0, 5, 1
	v_add3_u32 v9, 0, v99, v100
	v_xor_b32_e32 v2, v2, v105
	v_lshl_or_b32 v94, v1, 6, v105
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v121, 0, v98
	v_and_b32_e32 v4, 0x420, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_or3_b32 v2, v3, v2, v106
	v_xor_b32_e32 v95, 16, v94
	v_xor_b32_e32 v96, 32, v94
	v_xor_b32_e32 v93, 48, v94
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v120, v9, v107
	v_xor_b32_e32 v116, v2, v4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v24, s14, v116
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v9, s41, v103
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v21, s46, v94
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v130, s14, v117
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v22, s46, v95
	buffer_load_b128 v[9:12], v9, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[187:190], v24 offset:8192
	ds_load_b128 v[191:194], v130 offset:8192
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[122:125], v21
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[126:129], v24
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[139:142], v22
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	ds_load_b128 v[155:158], v22 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	ds_load_b128 v[171:174], v22 offset:2048
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	ds_load_b128 v[122:125], v21
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[126:129], v22
	ds_load_b128 v[187:190], v22 offset:8192
	v_add_nc_u32_e32 v22, s14, v119
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_perm_b32 v22, v17, v13, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v13, s14, v104
	v_add_nc_u32_e32 v17, s14, v102
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v24, v18, v14, 0x4000501
	v_perm_b32 v194, v18, v14, 0x6020703
	v_perm_b32 v195, v19, v15, 0x4000501
	v_perm_b32 v196, v19, v15, 0x6020703
	v_perm_b32 v197, v20, v16, 0x4000501
	v_perm_b32 v198, v20, v16, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[13:16], v13, s[20:23], 0 offen
	buffer_load_b128 v[17:20], v17, s[20:23], 0 offen
	...
	s_waitcnt vmcnt(0)
	v_perm_b32 v199, v17, v13, 0x4000501
	v_perm_b32 v200, v17, v13, 0x6020703
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v13, v23, s14, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v201, v18, v14, 0x4000501
	v_perm_b32 v202, v18, v14, 0x6020703
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v14, v41, s12, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v205, v20, v16, 0x4000501
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_cndmask_b32_e32 v13, 0x80000000, v13, vcc_lo
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v206, v20, v16, 0x6020703
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v16, v43, s12, 1
	v_cndmask_b32_e32 v14, 0x80000000, v14, vcc_lo
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v203, v19, v15, 0x4000501
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	buffer_load_u16 v13, v13, s[36:39], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v204, v19, v15, 0x6020703
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v15, v42, s12, 1
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_cndmask_b32_e32 v13, 0x80000000, v13, vcc_lo
	s_clause 0x3
	buffer_load_u16 v207, v13, s[28:31], 0 offen
	buffer_load_u16 v208, v14, s[28:31], 0 offen
	buffer_load_u16 v209, v15, s[28:31], 0 offen
	buffer_load_u16 v210, v16, s[28:31], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v211, s14, v108
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_add_i32 s44, s15, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s15, s13, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_add_i32 s43, s14, 0x8000
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s13, s45
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b128 v211, v[9:12] offset:32768
	s_mov_b32 s13, s15
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v10, 16, v208
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v11, 16, v209
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v12, 16, v210
	v_lshlrev_b32_e32 v9, 16, v207
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(4)
	v_mul_f32_e32 v211, v13, v10
	v_mul_f32_e32 v212, v14, v10
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v213, v15, v10 :: v_dual_mul_f32 v210, v16, v9
	v_mul_f32_e32 v214, v16, v10
	s_waitcnt lgkmcnt(3)
	v_mul_f32_e32 v223, v17, v10
	v_dual_mul_f32 v224, v18, v10 :: v_dual_mul_f32 v215, v13, v11
	v_mul_f32_e32 v216, v14, v11
	v_mul_f32_e32 v217, v15, v11
	v_mul_f32_e32 v218, v16, v11
	v_dual_mul_f32 v16, v16, v12 :: v_dual_mul_f32 v207, v13, v9
	v_mul_f32_e32 v208, v14, v9
	v_mul_f32_e32 v209, v15, v9
	v_dual_mul_f32 v13, v13, v12 :: v_dual_mul_f32 v226, v20, v10
	v_mul_f32_e32 v14, v14, v12
	v_dual_mul_f32 v15, v15, v12 :: v_dual_mul_f32 v228, v18, v11
	v_dual_mul_f32 v219, v17, v9 :: v_dual_mul_f32 v230, v20, v11
	v_mul_f32_e32 v220, v18, v9
	v_dual_mul_f32 v221, v19, v9 :: v_dual_mul_f32 v18, v18, v12
	v_dual_mul_f32 v222, v20, v9 :: v_dual_mul_f32 v225, v19, v10
	s_waitcnt lgkmcnt(2)
	v_mul_f32_e32 v234, v189, v9
	v_dual_mul_f32 v227, v17, v11 :: v_dual_mul_f32 v232, v187, v9
	v_dual_mul_f32 v229, v19, v11 :: v_dual_mul_f32 v238, v189, v10
	v_dual_mul_f32 v17, v17, v12 :: v_dual_mul_f32 v236, v187, v10
	v_dual_mul_f32 v19, v19, v12 :: v_dual_mul_f32 v242, v189, v11
	v_dual_mul_f32 v20, v20, v12 :: v_dual_mul_f32 v231, v186, v9
	v_dual_mul_f32 v240, v187, v11 :: v_dual_mul_f32 v233, v188, v9
	v_mul_f32_e32 v235, v186, v10
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v237, v188, v10 :: v_dual_mul_f32 v244, v191, v9
	v_dual_mul_f32 v239, v186, v11 :: v_dual_mul_f32 v248, v192, v10
	v_dual_mul_f32 v241, v188, v11 :: v_dual_mul_f32 v246, v190, v10
	v_mul_f32_e32 v186, v186, v12
	v_mul_f32_e32 v187, v187, v12
	v_mul_f32_e32 v188, v188, v12
	v_dual_mul_f32 v189, v189, v12 :: v_dual_mul_f32 v250, v191, v11
	v_mul_f32_e32 v243, v190, v9
	v_mul_f32_e32 v245, v192, v9
	v_mul_f32_e32 v9, v193, v9
	v_mul_f32_e32 v247, v191, v10
	v_dual_mul_f32 v10, v193, v10 :: v_dual_mul_f32 v249, v190, v11
	v_mul_f32_e32 v251, v192, v11
	v_dual_mul_f32 v11, v193, v11 :: v_dual_fmac_f32 v26, v208, v124
	v_mul_f32_e32 v190, v190, v12
	v_dual_mul_f32 v191, v191, v12 :: v_dual_fmac_f32 v28, v210, v126
	v_mul_f32_e32 v192, v192, v12
	v_mul_f32_e32 v12, v193, v12
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v193, v199, v21, 0x7060302
	v_perm_b32 v21, v199, v21, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v30, v220, v128 :: v_dual_add_nc_u32 v199, s44, v109
	v_dual_fmac_f32 v34, v232, v132 :: v_dual_fmac_f32 v25, v207, v123
	v_fmac_f32_e32 v32, v222, v130
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v199, v193, v21 offset1:16
	v_perm_b32 v21, v200, v22, 0x7060302
	v_perm_b32 v22, v200, v22, 0x5040100
	v_add_nc_u32_e32 v193, s44, v110
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v27, v209, v125 :: v_dual_fmac_f32 v36, v234, v134
	v_dual_fmac_f32 v29, v219, v127 :: v_dual_fmac_f32 v38, v244, v136
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v193, v21, v22 offset1:16
	v_perm_b32 v21, v201, v24, 0x7060302
	v_perm_b32 v22, v201, v24, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v31, v221, v129 :: v_dual_add_nc_u32 v24, s44, v111
	v_dual_fmac_f32 v46, v212, v140 :: v_dual_fmac_f32 v33, v231, v131
	v_fmac_f32_e32 v40, v9, v138
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v24, v21, v22 offset1:16
	v_perm_b32 v21, v202, v194, 0x7060302
	v_perm_b32 v22, v202, v194, 0x5040100
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v35, v233, v133 :: v_dual_add_nc_u32 v24, s44, v112
	v_dual_fmac_f32 v48, v214, v142 :: v_dual_fmac_f32 v37, v243, v135
	v_fmac_f32_e32 v50, v224, v144
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v24, v21, v22 offset1:16
	v_perm_b32 v21, v203, v195, 0x7060302
	v_perm_b32 v22, v203, v195, 0x5040100
	v_add_nc_u32_e32 v24, s44, v113
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v39, v245, v137 :: v_dual_fmac_f32 v52, v226, v146
	v_dual_fmac_f32 v45, v211, v139 :: v_dual_fmac_f32 v54, v236, v148
	v_dual_fmac_f32 v47, v213, v141 :: v_dual_fmac_f32 v56, v238, v150
	v_dual_fmac_f32 v49, v223, v143 :: v_dual_fmac_f32 v60, v10, v154
	v_dual_fmac_f32 v51, v225, v145 :: v_dual_fmac_f32 v58, v247, v152
	v_dual_fmac_f32 v53, v235, v147 :: v_dual_fmac_f32 v62, v216, v156
	v_dual_fmac_f32 v55, v237, v149 :: v_dual_fmac_f32 v64, v218, v158
	v_dual_fmac_f32 v57, v246, v151 :: v_dual_fmac_f32 v66, v228, v160
	v_dual_fmac_f32 v59, v248, v153 :: v_dual_fmac_f32 v68, v230, v162
	v_dual_fmac_f32 v61, v215, v155 :: v_dual_fmac_f32 v70, v240, v164
	v_dual_fmac_f32 v63, v217, v157 :: v_dual_fmac_f32 v72, v242, v166
	v_dual_fmac_f32 v65, v227, v159 :: v_dual_fmac_f32 v74, v250, v168
	v_dual_fmac_f32 v67, v229, v161 :: v_dual_fmac_f32 v76, v11, v170
	v_dual_fmac_f32 v69, v239, v163 :: v_dual_fmac_f32 v78, v14, v172
	v_dual_fmac_f32 v71, v241, v165 :: v_dual_fmac_f32 v80, v16, v174
	v_dual_fmac_f32 v73, v249, v167 :: v_dual_fmac_f32 v82, v18, v176
	v_dual_fmac_f32 v75, v251, v169 :: v_dual_fmac_f32 v84, v20, v178
	v_dual_fmac_f32 v77, v13, v171 :: v_dual_fmac_f32 v88, v188, v181
	v_dual_fmac_f32 v79, v15, v173 :: v_dual_fmac_f32 v86, v186, v179
	v_dual_fmac_f32 v81, v17, v175 :: v_dual_fmac_f32 v92, v192, v185
	v_dual_fmac_f32 v83, v19, v177 :: v_dual_fmac_f32 v90, v190, v183
	v_dual_fmac_f32 v87, v187, v180 :: v_dual_add_nc_u32 v16, s44, v115
	v_fmac_f32_e32 v89, v189, v182
	v_fmac_f32_e32 v91, v191, v184
	v_fmac_f32_e32 v85, v12, v122
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v10, v204, v196, 0x7060302
	v_perm_b32 v11, v204, v196, 0x5040100
	v_add_nc_u32_e32 v9, s44, v114
	v_perm_b32 v12, v205, v197, 0x7060302
	v_perm_b32 v13, v205, v197, 0x5040100
	v_perm_b32 v14, v206, v198, 0x7060302
	v_perm_b32 v15, v206, v198, 0x5040100
	ds_store_2addr_b32 v24, v21, v22 offset1:16
	ds_store_2addr_b32 v199, v10, v11 offset0:160 offset1:176
	ds_store_2addr_b32 v9, v12, v13 offset1:16
	ds_store_2addr_b32 v16, v14, v15 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v234, v97 :: v_dual_and_b32 v3, 8, v0
	v_and_b32_e32 v235, 32, v0
	s_branch .LBB0_8
.LBB0_7:
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v237, 0 :: v_dual_and_b32 v236, 7, v0
	...
	v_or3_b32 v1, v2, v106, v1
	scratch_store_b32 off, v0, off offset:12 ; 4-byte Folded Spill
	v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v139, 0
	v_dual_mov_b32 v154, 0 :: v_dual_mov_b32 v243, 0
	...
	v_xor_b32_e32 v24, 32, v230
	v_xor_b32_e32 v233, 48, v230
	...
	v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v127, 0
	v_dual_mov_b32 v232, 0 :: v_dual_mov_b32 v129, 0
	v_dual_mov_b32 v22, 0 :: v_dual_mov_b32 v253, 0
	v_dual_mov_b32 v190, 0 :: v_dual_mov_b32 v137, 0
	scratch_store_b32 off, v0, off offset:8 ; 4-byte Folded Spill
	v_dual_mov_b32 v128, 0 :: v_dual_mov_b32 v131, 0
	v_dual_mov_b32 v242, 0 :: v_dual_mov_b32 v141, 0
	...
	v_dual_mov_b32 v250, 0 :: v_dual_mov_b32 v163, 0
...
; %bb.9:
	...
	s_mov_b32 s23, s16
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v4, s12, v230
	v_add_nc_u32_e32 v1, s12, v24
	v_add_nc_u32_e32 v3, s12, v233
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v9, s46, v94
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_cvt_f32_i32_e32 v254, v117
	v_cvt_f32_i32_e32 v255, v118
	v_cvt_f32_i32_e32 v10, v119
	v_cvt_f32_i32_e32 v232, v120
	...
	v_cvt_f32_i32_e32 v242, v129
	v_cvt_f32_i32_e32 v220, v130
	v_cvt_f32_i32_e32 v166, v131
	v_cvt_f32_i32_e32 v129, v132
	v_cvt_f32_i32_e32 v252, v133
	v_cvt_f32_i32_e32 v253, v134
	v_cvt_f32_i32_e32 v250, v135
...
.LBB0_10:
	...
	buffer_load_u16 v140, v4, s[8:11], 0 offen
	buffer_load_u16 v101, v5, s[8:11], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_dual_mov_b32 v157, 0 :: v_dual_add_nc_u32 v158, v1, v107
	...
	v_dual_mov_b32 v144, 0 :: v_dual_mov_b32 v217, 0
	...
	s_waitcnt vmcnt(4)
	v_dual_mov_b32 v214, 0 :: v_dual_lshlrev_b32 v1, 16, v2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_store_b32 v158, v1 offset:40960
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.11:
	...
	s_mov_b32 s12, 0
	v_dual_mov_b32 v152, v251 :: v_dual_add_nc_u32 v17, s44, v21
	v_dual_mov_b32 v153, v129 :: v_dual_add_nc_u32 v94, s43, v94
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	...
	s_mov_b32 s19, s12
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v99, s44, v230
	scratch_load_b32 v18, off, off          ; 4-byte Folded Reload
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v229, s19 :: v_dual_add_nc_u32 v188, s44, v233
	v_mov_b32_e32 v221, v148
	v_dual_mov_b32 v150, v249 :: v_dual_add_nc_u32 v189, s44, v24
	v_dual_mov_b32 v157, v248 :: v_dual_mov_b32 v226, s16
	v_dual_mov_b32 v149, v252 :: v_dual_mov_b32 v224, s14
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[246:249], v17 offset:8192
	v_dual_mov_b32 v143, v253 :: v_dual_mov_b32 v222, s12
	v_mov_b32_e32 v151, v250
	s_waitcnt vmcnt(1)
	v_mov_b16_e64 v148.l, v101.l
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	scratch_store_b32 off, v238, off offset:80
	...
	v_add_nc_u32_e32 v219, s43, v96
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v227, s17 :: v_dual_mov_b32 v126, v117
	v_dual_mov_b32 v225, s15 :: v_dual_mov_b32 v124, v118
	v_dual_mov_b32 v223, s13 :: v_dual_mov_b32 v24, v120
	v_dual_mov_b32 v190, v112 :: v_dual_mov_b32 v97, v113
	v_dual_mov_b32 v22, v122 :: v_dual_mov_b32 v21, v44
	v_mov_b32_e32 v144, v121
	v_dual_mov_b32 v44, v43 :: v_dual_mov_b32 v43, v42
	v_mov_b32_e32 v154, v137
	v_mov_b32_e32 v42, v0
	v_dual_mov_b32 v0, v41 :: v_dual_mov_b32 v41, v114
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_mov_b32 v155, v138 :: v_dual_mov_b32 v156, v237
	v_mov_b32_e32 v138, v255
	v_dual_mov_b32 v255, v235 :: v_dual_mov_b32 v146, v128
	v_dual_mov_b32 v131, v232 :: v_dual_mov_b32 v130, v245
	scratch_store_b32 off, v236, off offset:32 ; 4-byte Folded Spill
	v_mov_b16_e64 v136.l, v135.l
	v_dual_mov_b32 v135, v134 :: v_dual_mov_b32 v128, v244
	v_dual_mov_b32 v134, v133 :: v_dual_mov_b32 v133, v132
	...
	v_dual_mov_b32 v251, v152 :: v_dual_mov_b32 v250, v151
	v_dual_mov_b32 v253, v143 :: v_dual_mov_b32 v252, v149
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	...
	v_dual_mov_b32 v114, v41 :: v_dual_mov_b32 v41, v0
	...
	v_dual_mov_b32 v122, v22 :: v_dual_mov_b32 v113, v97
	v_dual_mov_b32 v120, v24 :: v_dual_mov_b32 v119, v123
	v_dual_mov_b32 v118, v124 :: v_dual_mov_b32 v117, v126
	v_mov_b32_e32 v248, v157
	...
	scratch_load_b32 v123, off, off offset:40
	...
	v_mov_b16_e64 v101.l, v148.l
	v_mov_b32_e32 v121, v144
	v_dual_mov_b32 v249, v150 :: v_dual_mov_b32 v148, v221
	v_dual_mov_b32 v129, v153 :: v_dual_mov_b32 v138, v155
	...
	v_mov_b32_e32 v237, v156
	v_dual_mov_b32 v231, v132 :: v_dual_mov_b32 v132, v133
	v_dual_mov_b32 v133, v134 :: v_dual_mov_b32 v134, v135
	v_mov_b16_e64 v135.l, v136.l
	v_cvt_f32_i32_e32 v218, v242
	v_cvt_f32_i32_e32 v219, v243
	v_mov_b32_e32 v243, v127
	v_dual_mov_b32 v127, v145 :: v_dual_mov_b32 v242, v147
	v_cvt_f32_i32_e32 v144, v244
...
.LBB0_12:
	...
	v_add_lshl_u32 v41, v42, s4, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s5
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v42, v43, s4, 1
	...
	v_dual_cndmask_b32 v19, 0x80000000, v19 :: v_dual_cndmask_b32 v42, 0x80000000, v42
	v_cndmask_b32_e32 v41, 0x80000000, v41, vcc_lo
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	buffer_load_u16 v18, v18, s[24:27], 0 offen
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v44, v16, v43
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_clause 0x3
	...
	v_mul_f32_e32 v94, v14, v43
	v_mul_f32_e32 v95, v13, v43
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v44, v44, v134, v85
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_add_i32 s70, s37, s35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v93, v93, v133, v92
	v_fma_f32 v94, v94, v132, v91
	v_fma_f32 v95, v95, v142, v90
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v85, v85, v44, s3
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	...
	s_add_i32 s14, s37, s92
	s_add_i32 s15, s37, s93
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e64 v43.h, v140.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v96, v96, v122, v89
	v_fma_f32 v101, v101, v121, v88
	v_fma_f32 v102, v102, v120, v87
	v_fma_f32 v103, v103, v119, v86
	v_fma_f32 v104, v104, v118, v84
	v_fma_f32 v105, v105, v117, v83
	v_fma_f32 v106, v106, v125, v82
	v_fma_f32 v107, v107, v115, v81
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e64 v43.h, v135.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v87, v87, v102, s3
	v_cndmask_b32_e64 v82, v82, v106, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v102, v118, v123, v70
	v_fma_f32 v106, v122, v138, v66
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v118, v10, v43
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e64 v43.h, v164.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v77, v77, v111, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v111, v153, v252, v61
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v11, v11, v160, v35
	v_fma_f32 v10, v10, v245, v34
	v_fma_f32 v9, v9, v244, v33
	v_fma_f32 v64, v1, v154, v25
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v21, v133, v231, v49
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_store_b32 v158, v1 offset:40960
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v24, v134, v232, v48
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v76, v76, v44, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v44, v112, v129, v60
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v43, v60, v44, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v60, v2, v237, v26
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v26, v26, v60, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v60, v9, v17
	v_mul_f32_e32 v112, v9, v19
	v_mul_f32_e32 v128, v10, v30
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v65, v115, v242, v57
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v130, v12, v30
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v101, v117, v127, v55
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v127, v9, v30
	v_mul_f32_e32 v9, v9, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v104, v120, v97, v52
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v57, v57, v65, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v97, v11, v17
	v_mul_f32_e32 v114, v11, v19
	v_mul_f32_e32 v129, v11, v30
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v65, v52, v104, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v4, v239, v28
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v98 offset:40960
	v_mul_f32_e32 v11, v11, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v22, v122, v22, v50
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v132, v14, v30
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v103, v119, v190, v53
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v118, v15, v19
	v_mul_f32_e32 v133, v15, v30
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v22, v50, v22, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v50, v5, v240, v29
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v107, v136, v255, v46
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v29, v29, v50, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v110, v152, v253, v62
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v55, v55, v101, s3
	v_cndmask_b32_e64 v28, v28, v52, s3
	v_cndmask_b32_e64 v46, v46, v107, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v64, v10, v17
	v_mul_f32_e32 v101, v13, v17
	v_mul_f32_e32 v102, v14, v17
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v62, v62, v110, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v113, v10, v19
	v_mul_f32_e32 v115, v12, v19
	v_mul_f32_e32 v116, v13, v19
	v_mul_f32_e32 v117, v14, v19
	v_dual_mul_f32 v131, v13, v30 :: v_dual_mul_f32 v10, v10, v36
	v_mul_f32_e32 v13, v13, v36
	v_mul_f32_e32 v14, v14, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v140, v9, v222, v86
	v_fma_f32 v142, v11, v224, v88
	v_fma_f32 v141, v10, v223, v87
	v_fma_f32 v146, v15, v228, v92
	v_fma_f32 v145, v14, v227, v91
	s_waitcnt vmcnt(0)
	v_fma_f32 v44, v7, v0, v31
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[5:8], v98 offset:40976
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v122, v4, v30
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v109, v151, v250, v63
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_dual_mul_f32 v98, v12, v17 :: v_dual_mul_f32 v105, v2, v19
	v_mul_f32_e32 v107, v4, v19
	v_mul_f32_e32 v4, v4, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v106, v135, v106, v47
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v104, v1, v19
	v_mul_f32_e32 v119, v1, v30
	v_mul_f32_e32 v120, v2, v30
	v_mul_f32_e32 v121, v3, v30
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v47, v47, v106, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v106, v3, v19
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v50, v6, v17
	v_mul_f32_e32 v109, v6, v19
	v_mul_f32_e32 v124, v6, v30
	v_mul_f32_e32 v6, v6, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v108, v137, v254, v45
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v48, v5, v17
	v_mul_f32_e32 v52, v7, v17
	v_mul_f32_e32 v56, v8, v17
	v_mul_f32_e32 v17, v16, v17
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v45, v45, v108, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v108, v5, v19
	v_mul_f32_e32 v110, v7, v19
	v_mul_f32_e32 v111, v8, v19
	v_mul_f32_e32 v19, v16, v19
	v_mul_f32_e32 v123, v5, v30
	v_mul_f32_e32 v125, v7, v30
	...
	v_fma_f32 v40, v42, v157, v27
	v_fma_f32 v41, v44, v167, v28
	v_fma_f32 v42, v48, v168, v29
	v_fma_f32 v44, v50, v169, v24
	v_fma_f32 v48, v52, v170, v31
	v_fma_f32 v50, v56, v172, v32
	v_fma_f32 v56, v64, v174, v34
	v_fma_f32 v64, v98, v176, v96
	v_fma_f32 v98, v102, v178, v38
	v_fma_f32 v100, v17, v180, v18
	v_fma_f32 v102, v105, v182, v46
	v_fma_f32 v105, v108, v185, v21
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	scratch_load_b32 v0, off, off offset:24 ; 4-byte Folded Reload
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v138, v7, v144, v83
	v_fma_f32 v144, v13, v226, v90
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v13, v28, v41, s2
	v_cndmask_b32_e64 v28, v31, v48, s2
	v_cndmask_b32_e64 v48, v96, v64, s2
	v_cndmask_b32_e64 v64, v18, v100, s2
	v_cndmask_b32_e64 v18, v21, v105, s2
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	scratch_load_b32 v21, off, off          ; 4-byte Folded Reload
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v99, v103, v179, v39
	v_fma_f32 v103, v106, v183, v47
	v_fma_f32 v106, v109, v186, v22
	v_fma_f32 v108, v111, v188, v65
	v_fma_f32 v111, v114, v192, v55
	v_fma_f32 v114, v117, v195, v58
	v_fma_f32 v117, v120, v199, v62
	v_fma_f32 v120, v123, v202, v93
	v_fma_f32 v123, v126, v205, v68
	v_fma_f32 v126, v129, v208, v71
	v_fma_f32 v129, v132, v211, v74
	v_fma_f32 v132, v1, v214, v77
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v1, v25, v20, s2
	v_cndmask_b32_e64 v25, v22, v106, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v60, v173, v33
	v_fma_f32 v60, v97, v175, v35
	v_fma_f32 v97, v101, v177, v37
	v_fma_f32 v101, v104, v181, v45
	v_fma_f32 v104, v107, v184, v49
	v_fma_f32 v107, v110, v187, v51
	v_fma_f32 v110, v113, v191, v54
	v_fma_f32 v113, v116, v194, v57
	v_fma_f32 v116, v119, v198, v95
	v_fma_f32 v109, v112, v189, v53
	v_fma_f32 v112, v115, v193, v61
	v_fma_f32 v115, v118, v196, v59
	v_fma_f32 v118, v121, v200, v63
	v_fma_f32 v134, v3, v216, v79
	v_fma_f32 v19, v19, v197, v43
	v_fma_f32 v136, v5, v218, v81
	v_fma_f32 v119, v122, v201, v94
	v_fma_f32 v122, v125, v204, v67
	v_fma_f32 v121, v124, v203, v66
	v_fma_f32 v124, v127, v206, v69
	v_fma_f32 v127, v130, v209, v72
	v_fma_f32 v130, v133, v212, v75
	v_fma_f32 v133, v2, v215, v78
	v_fma_f32 v135, v4, v217, v80
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v2, v45, v101, s2
	v_cndmask_b32_e64 v3, v95, v116, s2
	v_cndmask_b32_e64 v4, v77, v132, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v143, v12, v225, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v9, v27, v40, s2
	v_cndmask_b32_e64 v10, v47, v103, s2
	v_cndmask_b32_e64 v11, v63, v118, s2
	v_cndmask_b32_e64 v12, v79, v134, s2
	v_cndmask_b32_e64 v5, v26, v36, s2
	v_cndmask_b32_e64 v17, v29, v42, s2
	v_cndmask_b32_e64 v36, v33, v52, s2
	v_cndmask_b32_e64 v33, v65, v108, s2
	v_cndmask_b32_e64 v65, v43, v19, s2
	v_cndmask_b32_e64 v19, v93, v120, s2
	v_cndmask_b32_e64 v20, v81, v136, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v125, v128, v207, v70
	v_fma_f32 v128, v131, v210, v73
	v_fma_f32 v131, v30, v213, v76
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v29, v51, v107, s2
	v_cndmask_b32_e64 v30, v67, v122, s2
	v_cndmask_b32_e64 v31, v83, v138, s2
	v_cndmask_b32_e64 v24, v24, v44, s2
	v_cndmask_b32_e64 v40, v34, v56, s2
	v_cndmask_b32_e64 v44, v35, v60, s2
	v_cndmask_b32_e64 v52, v37, v97, s2
	v_cndmask_b32_e64 v56, v38, v98, s2
	v_cndmask_b32_e64 v60, v39, v99, s2
	v_cndmask_b32_e64 v37, v53, v109, s2
	v_cndmask_b32_e64 v38, v69, v124, s2
	v_cndmask_b32_e64 v39, v86, v140, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v137, v6, v219, v82
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v6, v46, v102, s2
	v_cndmask_b32_e64 v45, v55, v111, s2
	v_cndmask_b32_e64 v46, v71, v126, s2
	v_cndmask_b32_e64 v47, v88, v142, s2
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v41, v54, v110, s2
	v_cndmask_b32_e64 v53, v57, v113, s2
	v_cndmask_b32_e64 v54, v73, v128, s2
	v_cndmask_b32_e64 v55, v90, v144, s2
	v_cndmask_b32_e64 v14, v49, v104, s2
	v_cndmask_b32_e64 v49, v61, v112, s2
	v_cndmask_b32_e64 v61, v59, v115, s2
	v_cndmask_b32_e64 v7, v62, v117, s2
	v_cndmask_b32_e64 v62, v75, v130, s2
	v_cndmask_b32_e64 v63, v92, v146, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v139, v8, v221, v84
	v_fma_f32 v147, v16, v229, v85
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v42, v70, v125, s2
	v_cndmask_b32_e64 v8, v78, v133, s2
	v_cndmask_b32_e64 v43, v87, v141, s2
	v_cndmask_b32_e64 v32, v32, v50, s2
	v_cndmask_b32_e64 v15, v94, v119, s2
	v_cndmask_b32_e64 v50, v72, v127, s2
	v_cndmask_b32_e64 v16, v80, v135, s2
	v_cndmask_b32_e64 v51, v89, v143, s2
	v_cndmask_b32_e64 v57, v58, v114, s2
	v_cndmask_b32_e64 v26, v66, v121, s2
	v_cndmask_b32_e64 v58, v74, v129, s2
	v_cndmask_b32_e64 v27, v82, v137, s2
	v_cndmask_b32_e64 v59, v91, v145, s2
	v_cndmask_b32_e64 v34, v68, v123, s2
	v_cndmask_b32_e64 v66, v76, v131, s2
	v_cndmask_b32_e64 v35, v84, v139, s2
	v_cndmask_b32_e64 v67, v85, v147, s2
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_mul_i32 s2, s35, 5
	s_mul_i32 s3, s35, 6
	.loc	1 450 9 is_stmt 0               ; generate_amdgcn.py:450:9
	...
	v_lshl_or_b32 v22, v235, 1, v0
	v_lshlrev_b32_e32 v0, 2, v0
	s_waitcnt vmcnt(0)
	v_and_b32_e32 v21, 0xcf0, v21
	v_xor_b32_e32 v21, v22, v21
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v21, v236, 13, v21
	v_add_nc_u32_e32 v22, 0, v21
	ds_store_b128 v22, v[1:4]
	ds_store_b128 v22, v[9:12] offset:256
	ds_store_b128 v22, v[17:20] offset:512
	ds_store_b128 v22, v[28:31] offset:768
	ds_store_b128 v22, v[36:39] offset:4096
	ds_store_b128 v22, v[44:47] offset:4352
	scratch_load_b32 v3, off, off offset:16 ; 4-byte Folded Reload
	v_and_b32_e32 v1, 0x1c00, v234
	v_xad_u32 v2, v21, 32, 0
	ds_store_b128 v22, v[52:55] offset:4608
	ds_store_b128 v22, v[60:63] offset:4864
	...
	v_add_lshl_u32 v0, s13, v23, 2
	v_add_lshl_u32 v1, s12, v23, 2
	...
	v_add_lshl_u32 v3, s14, v23, 2
	v_add_lshl_u32 v4, s15, v23, 2
	s_clause 0x4
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 99
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 88
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 88
    .sgpr_count:     101
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
