...
.Ltmp12:
	...
	v_and_or_b32 v10, 0x31c, v10, v22
...
.Ltmp20:
	...
	v_xor_b32_e32 v28, 24, v14
	v_xor_b32_e32 v29, 32, v14
	v_xor_b32_e32 v30, 40, v14
	v_xor_b32_e32 v31, 48, v14
	v_xor_b32_e32 v32, 56, v14
	...
	v_xor_b32_e32 v39, 40, v34
	v_xor_b32_e32 v40, 48, v34
	v_xor_b32_e32 v41, 56, v34
	v_xor_b32_e32 v43, 4, v3
	s_mul_f32 s0, s0, 0x4f7ffffe
	v_xor_b32_e32 v44, 8, v3
	v_xor_b32_e32 v6, 12, v3
	v_xor_b32_e32 v46, 16, v3
	v_xor_b32_e32 v5, 20, v3
	v_xor_b32_e32 v48, 24, v3
	v_xor_b32_e32 v49, 28, v3
	v_xor_b32_e32 v51, 0x1010, v0
	v_xor_b32_e32 v52, 0x2040, v0
	v_xor_b32_e32 v53, 0x3050, v0
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_or_b32_e32 v22, s26, v8
	v_mad_u64_u32 v[10:11], null, s21, v7, v[1:2]
	v_or_b32_e32 v1, s26, v9
	s_cvt_u32_f32 s3, s0
	s_mov_b32 s12, s4
	s_mov_b32 s4, s6
	s_sub_i32 s6, 0, s30
	...
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v53, 0, v53
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s3, s19, s10
	s_mul_hi_u32 s11, s18, s11
	s_ashr_i32 s3, s3, 31
	s_mul_i32 s43, s11, s6
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s18, s18, s43
	s_add_i32 s43, s11, 1
	s_sub_i32 s44, s18, s6
	s_cmp_ge_u32 s18, s6
...
; %bb.3:                                ; %.lr.ph
	...
	s_lshl_b32 s6, s6, 7
	s_lshl_b32 s7, s3, 8
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v2, s43, v23
	v_or_b32_e32 v3, s6, v20
	v_subrev_nc_u32_e32 v59, s7, v1
	v_or_b32_e32 v1, s6, v18
	s_lshl_b32 s3, s3, 7
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v4, s43, v17
	v_mul_lo_u32 v60, s42, v2
	v_subrev_nc_u32_e32 v2, s3, v3
	v_subrev_nc_u32_e32 v1, s3, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[11:12], null, s27, v4, v[8:9]
	v_dual_mov_b32 v58, 0 :: v_dual_mov_b32 v15, 0
	v_mad_u64_u32 v[12:13], null, s27, v2, v[9:10]
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[13:14], null, s27, v1, v[9:10]
	v_mov_b32_e32 v56, 0
	v_mov_b32_e32 v54, 0
	v_mov_b32_e32 v14, 0
	v_mov_b32_e32 v16, 0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_cndmask_b32 v1, 0x80000000, v2 :: v_dual_add_nc_u32 v6, v22, v59
	...
	buffer_load_b64 v[3:4], v3, s[4:7], 0 offen
	...
	ds_load_b64 v[75:76], v28
	ds_load_b64 v[77:78], v29
	ds_load_b64 v[79:80], v30
	ds_load_b64 v[81:82], v31
	ds_load_b64 v[83:84], v32
	.loc	1 268 30                        ; generate_amdgcn.py:268:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	buffer_load_u16 v86, v6, s[16:19], 0 offen
	buffer_load_u16 v87, v6, s[16:19], 0 offen offset:4
	buffer_load_u16 v88, v6, s[16:19], 0 offen offset:8
	buffer_load_u16 v89, v6, s[16:19], 0 offen offset:12
	buffer_load_u16 v90, v6, s[16:19], 0 offen offset:16
	buffer_load_u16 v91, v6, s[16:19], 0 offen offset:20
	buffer_load_u16 v92, v6, s[16:19], 0 offen offset:24
	buffer_load_u16 v93, v6, s[16:19], 0 offen offset:28
	...
	v_dual_mov_b32 v6, v0 :: v_dual_add_nc_u32 v59, s41, v59
	...
	v_dual_fmac_f32 v58, v2, v64 :: v_dual_lshlrev_b32 v67, 16, v90
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v6, v6, v62 :: v_dual_fmac_f32 v57, v1, v63
	v_mul_f32_e32 v5, v5, v62
	v_dual_mul_f32 v4, v4, v62 :: v_dual_lshlrev_b32 v69, 16, v92
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v56, v3, v65
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v14, v6, v68 :: v_dual_mul_f32 v7, v7, v62
	v_fmac_f32_e32 v54, v5, v67
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_mul_f32_e32 v61, v61, v62
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v55, v4, v66 :: v_dual_fmac_f32 v16, v7, v69
...
.LBB0_5:                                ; %._crit_edge
	...
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	ds_load_2addr_b32 v[11:12], v50 offset1:32
	ds_load_2addr_b32 v[6:7], v51 offset1:32
	ds_load_2addr_b32 v[4:5], v52 offset1:32
	ds_load_2addr_b32 v[1:2], v53 offset1:32
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk4_evenk.numbered_sgpr, 47
