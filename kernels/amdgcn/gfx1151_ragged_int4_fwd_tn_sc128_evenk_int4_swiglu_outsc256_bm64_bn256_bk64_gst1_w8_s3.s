...
.Ltmp2:
	...
	v_cmp_gt_i64_e64 s2, s[30:31], v[0:1]
...
.LBB0_3:                                ; %Flow762
	...
	v_dual_mov_b32 v175, 0 :: v_dual_mov_b32 v200, 0
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s4, s[34:35], v[5:6]
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
	...
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v0, v23, v4
	...
	v_dual_mov_b32 v192, 0 :: v_dual_add_nc_u32 v227, 0, v12
	v_dual_mov_b32 v175, 0 :: v_dual_add_nc_u32 v228, 0, v13
	v_dual_mov_b32 v190, 0 :: v_dual_add_nc_u32 v145, 0, v14
	v_dual_mov_b32 v188, 0 :: v_dual_add_nc_u32 v229, 0, v16
	v_dual_mov_b32 v193, 0 :: v_dual_add_nc_u32 v230, 0, v6
	v_dual_mov_b32 v92, 0 :: v_dual_add_nc_u32 v231, 0, v17
	v_dual_mov_b32 v191, 0 :: v_dual_add_nc_u32 v232, 0, v1
	v_dual_mov_b32 v90, 0 :: v_dual_add_nc_u32 v253, 0, v9
	v_dual_mov_b32 v189, 0 :: v_dual_add_nc_u32 v254, 0, v15
	v_dual_mov_b32 v108, 0 :: v_dual_add_nc_u32 v243, 0, v19
	v_dual_mov_b32 v110, 0 :: v_dual_add_nc_u32 v233, 0, v21
	v_dual_mov_b32 v128, 0 :: v_dual_add_nc_u32 v235, v3, v22
	v_dual_mov_b32 v109, 0 :: v_dual_add_nc_u32 v236, 0, v24
	v_dual_mov_b32 v126, 0 :: v_dual_add_nc_u32 v237, 0, v25
	scratch_store_b32 off, v0, off offset:616 ; 4-byte Folded Spill
	v_dual_mov_b32 v129, 0 :: v_dual_add_nc_u32 v0, 0, v26
	...
	v_dual_mov_b32 v151, 0 :: v_dual_mov_b32 v178, 0
	...
	scratch_store_b32 off, v243, off offset:80
.LBB0_5:                                ; =>This Loop Header: Depth=1
	...
	scratch_store_b32 off, v175, off offset:492
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_add_nc_u32_e32 v8, 0, v212
	.loc	1 1141 26                       ; ragged.py:1141:26
	v_or_b32_e32 v129, s43, v216
	...
	v_mad_u64_u32 v[137:138], null, v129, s39, v[238:239]
	v_mad_u64_u32 v[138:139], null, v130, s39, v[238:239]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_add_nc_u32_e32 v129, s5, v137
	.loc	1 1186 29                       ; ragged.py:1186:29
	v_add_nc_u32_e32 v252, s40, v137
	.loc	1 1157 25                       ; ragged.py:1157:25
	v_add_nc_u32_e32 v133, s5, v138
	.loc	1 1186 29                       ; ragged.py:1186:29
	v_add_nc_u32_e32 v177, s40, v138
	.loc	1 1156 34                       ; ragged.py:1156:34
	s_clause 0x1
	...
	v_mad_u64_u32 v[129:130], null, v129, s38, v[220:221]
	.loc	1 1156 34                       ; ragged.py:1156:34
	...
	.loc	1 1155 34                       ; ragged.py:1155:34
	s_clause 0x2
	buffer_load_u8 v172, v141, s[20:23], 0 offen
	buffer_load_u8 v246, v143, s[20:23], 0 offen
	buffer_load_u8 v251, v136, s[20:23], 0 offen
	.loc	1 1141 26                       ; ragged.py:1141:26
	v_or_b32_e32 v129, s43, v129
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 1155 42                       ; ragged.py:1155:42
	...
	s_clause 0x4
	buffer_load_u8 v245, v148, s[20:23], 0 offen
	buffer_load_u8 v244, v149, s[20:23], 0 offen
	buffer_load_u8 v255, v129, s[20:23], 0 offen
	buffer_load_u8 v174, v147, s[20:23], 0 offen
	buffer_load_u8 v173, v131, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	...
	ds_store_b16 v8, v137
	ds_store_b16_d16_hi v8, v137 offset:32
	ds_store_b16 v8, v138 offset:64
	ds_store_b16_d16_hi v8, v138 offset:96
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	ds_load_2addr_stride64_b64 v[137:140], v8 offset1:8
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	ds_load_2addr_stride64_b64 v[137:140], v243 offset1:8
	.loc	1 1161 31                       ; ragged.py:1161:31
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 1156 34                       ; ragged.py:1156:34
	ds_load_2addr_stride64_b64 v[133:136], v175 offset1:8
	.loc	1 1161 31                       ; ragged.py:1161:31
	...
	ds_load_u8 v185, v219 offset:1088
	...
	ds_load_u8 v151, v219 offset:1920
	.loc	1 1185 39                       ; ragged.py:1185:39
	v_lshlrev_b16 v129.l, 8, v129.l
	v_mov_b32_e32 v158, v225
	...
	.loc	1 1190 36                       ; ragged.py:1190:36
	ds_load_u8 v159, v219 offset:1840
	...
	ds_load_u8 v155, v219 offset:2016
	ds_load_u8 v225, v236
	ds_load_u8 v157, v237
	...
	ds_load_u8 v160, v219 offset:832
	ds_load_u8 v8, v219 offset:768
	ds_load_u8 v175, v219 offset:848
	ds_load_u8 v4, v219 offset:784
	ds_load_u8 v252, v219 offset:864
	ds_load_u8 v243, v219 offset:800
	...
	ds_load_u8 v0, v219 offset:576
	ds_load_u8 v5, v219 offset:512
	ds_load_u8 v6, v219 offset:592
	ds_load_u8 v7, v219 offset:528
	ds_load_u8 v170, v219 offset:608
	ds_load_u8 v169, v219 offset:544
	ds_load_u8 v193, v219 offset:624
	ds_load_u8 v171, v219 offset:560
	...
	ds_load_u8 v1, v219 offset:1360
	s_waitcnt lgkmcnt(0)
	scratch_store_b32 off, v1, off offset:52 ; 4-byte Folded Spill
	ds_load_u8 v1, v219 offset:1376
	s_waitcnt lgkmcnt(0)
	scratch_store_b32 off, v1, off offset:48 ; 4-byte Folded Spill
	ds_load_u8 v1, v219 offset:1392
	s_waitcnt lgkmcnt(0)
	scratch_store_b32 off, v1, off offset:36 ; 4-byte Folded Spill
	ds_load_u8 v194, v219 offset:1408
	ds_load_u8 v1, v219 offset:1328
	s_waitcnt lgkmcnt(0)
	scratch_store_b32 off, v1, off offset:44 ; 4-byte Folded Spill
	ds_load_u8 v220, v219 offset:1936
	ds_load_u8 v153, v219 offset:1952
	ds_load_u8 v147, v219 offset:1600
	ds_load_u8 v148, v219 offset:1616
	ds_load_u8 v234, v219 offset:1632
	ds_load_u8 v154, v219 offset:1648
	ds_load_u8 v248, v219 offset:1664
	ds_load_u8 v152, v219 offset:1584
	ds_load_u8 v146, v219 offset:1552
	...
	ds_load_u8 v1, v219 offset:1680
	ds_load_u8 v2, v219 offset:1696
	.loc	1 1185 39                       ; ragged.py:1185:39
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_perm_b32 v129, v8, v160, 0xc0c0004
	s_clause 0x1                            ; 8-byte Folded Reload
	...
	v_lshl_or_b32 v139, v130, 16, v129
	s_waitcnt vmcnt(0)
	v_perm_b32 v131, v4, v0, 0xc0c0004
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v0, off, off offset:40
	scratch_load_b32 v4, off, off offset:28
	s_waitcnt vmcnt(1)
	v_perm_b32 v132, v0, v225, 0xc0c0004
	v_perm_b32 v0, v194, v181, 0xc0c0004
	v_mov_b32_e32 v225, v158
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v140, v132, 16, v131
	.loc	1 1185 39                       ; ragged.py:1185:39
	ds_load_2addr_stride64_b64 v[129:132], v243 offset1:8
	.loc	1 1190 36                       ; ragged.py:1190:36
	s_waitcnt lgkmcnt(0)
	...
	s_waitcnt vmcnt(0)
	v_perm_b32 v130, v4, v185, 0xc0c0004
	...
	v_perm_b32 v131, v208, v195, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	...
	v_perm_b32 v130, v159, v247, 0xc0c0004
	v_perm_b32 v131, v214, v157, 0xc0c0004
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	s_clause 0x2                            ; 12-byte Folded Reload
	scratch_load_b32 v54, off, off offset:612
	...
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v43, v51, v170
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v122, v43, v47
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v43, v51, v171
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_fmac_f32_e32 v123, v43, v48
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_mul_f32_e32 v43, v51, v175
	scratch_load_b32 v175, off, off offset:492 ; 4-byte Folded Reload
	.loc	1 1226 17                       ; ragged.py:1226:17
	...
	v_dual_fmac_f32 v95, v40, v45 :: v_dual_fmac_f32 v186, v53, v44
	.loc	1 1211 25                       ; ragged.py:1211:25
	s_waitcnt vmcnt(19)
	v_dual_mul_f32 v53, v30, v77 :: v_dual_fmac_f32 v94, v39, v46
	s_waitcnt vmcnt(14)
	...
	.loc	1 1228 21                       ; ragged.py:1228:21
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v185, v53, v46 :: v_dual_fmac_f32 v146, v6, v36
	.loc	1 1211 25                       ; ragged.py:1211:25
	...
	.loc	1 1228 21                       ; ragged.py:1228:21
	v_dual_fmac_f32 v178, v39, v48 :: v_dual_fmac_f32 v159, v53, v43
	.loc	1 1211 25                       ; ragged.py:1211:25
	v_mul_f32_e32 v53, v0, v81
	scratch_load_b32 v81, off, off offset:584 ; 4-byte Folded Reload
	v_dual_mul_f32 v39, v30, v69 :: v_dual_fmac_f32 v164, v1, v35
	.loc	1 1228 21                       ; ragged.py:1228:21
	v_fmac_f32_e32 v214, v2, v36
	v_fmac_f32_e32 v158, v53, v44
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 1211 25                       ; ragged.py:1211:25
	v_dual_mul_f32 v53, v0, v80 :: v_dual_fmac_f32 v176, v39, v49
	...
	.loc	1 1228 21                       ; ragged.py:1228:21
	v_dual_fmac_f32 v210, v8, v38 :: v_dual_fmac_f32 v107, v9, v35
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 1211 25                       ; ragged.py:1211:25
	v_dual_mul_f32 v39, v0, v72 :: v_dual_fmac_f32 v130, v53, v45
	...
	s_waitcnt vmcnt(2)
	v_dual_fmac_f32 v85, v15, v35 :: v_dual_fmac_f32 v120, v10, v33
	.loc	1 1211 25                       ; ragged.py:1211:25
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc128_evenk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 652
