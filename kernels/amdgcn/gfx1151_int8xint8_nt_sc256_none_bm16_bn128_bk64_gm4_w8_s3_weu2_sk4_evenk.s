	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
.Lfunc_begin0:
...
.Ltmp19:
	...
	v_add_nc_u32_e32 v6, s2, v37
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cselect_b32 s2, -1, 0
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	s_add_i32 s31, s14, 0x100
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_cndmask_b32_e64 v2, 0x80000000, v2, s3
	.loc	1 348 30 is_stmt 0              ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v7, s31, v38
	.loc	1 350 22 is_stmt 1              ; generate_amdgcn.py:350:22
	...
	buffer_load_b32 v31, v2, s[4:7], 0 offen
	...
	buffer_load_b128 v[19:22], v6, s[16:19], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v32, v2, s[4:7], 0 offen
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	buffer_load_b128 v[23:26], v3, s[16:19], 0 offen
	buffer_load_b128 v[27:30], v7, s[16:19], 0 offen
	.loc	1 300 32                        ; generate_amdgcn.py:300:32
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_and_b32_e32 v8, 48, v10
	v_lshlrev_b32_e32 v3, 3, v0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cmpk_gt_i32 s21, 0x2ff
	.loc	1 300 32                        ; generate_amdgcn.py:300:32
	v_and_or_b32 v4, v4, 1, v6
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_xor_b32_e32 v39, v11, v7
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_and_b32_e32 v15, 48, v3
	s_mov_b32 s10, 0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v29, v1, 6, v15
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_lshl_b32 s41, s39, 8
	s_mov_b32 s14, s31
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	s_add_i32 s31, s11, s41
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_ashr_i32 s41, s40, 31
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v41, s31, v38
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	s_ashr_i32 s40, s40, 8
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v89, v41, s[4:7], 0 offen
	.loc	1 366 40                        ; generate_amdgcn.py:366:40
	s_mul_i32 s41, s40, s29
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v41, v28, s40, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	s_cmp_lt_i32 s40, s33
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v42, v27, s41, 1
	v_add_lshl_u32 v43, v26, s41, 1
	v_add_lshl_u32 v44, v25, s41, 1
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v45, v23, s41, 1
	v_add_lshl_u32 v46, v21, s41, 1
	v_add_lshl_u32 v47, v24, s41, 1
	v_add_lshl_u32 v48, v22, s41, 1
	v_add_lshl_u32 v49, v20, s41, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	...
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v90, v41, s[20:23], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_clause 0x7
	...
	s_mov_b32 s10, s34
	.loc	1 348 22 is_stmt 1              ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v41, s40, v29
	v_add_nc_u32_e32 v42, s40, v32
	s_mov_b32 s34, s15
	v_add_nc_u32_e32 v43, s40, v30
	v_add_nc_u32_e32 v44, s40, v31
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v45, s34, v34
	v_add_nc_u32_e32 v46, s34, v36
	v_add_nc_u32_e32 v47, s34, v33
	v_add_nc_u32_e32 v48, s34, v35
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	v_dual_fmac_f32 v18, v63, v46 :: v_dual_mul_f32 v59, v57, v59
	v_dual_fmac_f32 v19, v64, v47 :: v_dual_mul_f32 v60, v57, v60
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_mul_f32_e32 v57, v57, v65
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v16, v61, v44 :: v_dual_add_nc_u32 v99, s41, v39
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v15, v60, v43 :: v_dual_add_nc_u32 v100, s35, v40
	v_fmac_f32_e32 v12, v58, v41
	v_dual_fmac_f32 v14, v59, v42 :: v_dual_fmac_f32 v17, v62, v45
	v_fmac_f32_e32 v13, v57, v48
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.8:
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v38, 0 :: v_dual_add_nc_u32 v3, s15, v34
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v2, s15, v36
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v9, s10, v32
	v_add_nc_u32_e32 v37, s10, v29
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v44, v38 :: v_dual_add_nc_u32 v39, s15, v35
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v41, v38 :: v_dual_add_nc_u32 v2, s15, v33
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v3, s10, v31
	v_add_nc_u32_e32 v9, s10, v30
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
...
.LBB0_9:
	...
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v39, v27, s4, 1
	v_add_lshl_u32 v40, v26, s4, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_cndmask_b32_e32 v38, 0x80000000, v38, vcc_lo
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v41, v25, s4, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	s_and_b32 s9, s9, 0xffff
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v43, v24, s4, 1
	v_add_lshl_u32 v42, v21, s4, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	...
	v_add_lshl_u32 v44, v22, s4, 1
	v_add_lshl_u32 v46, v20, s4, 1
...
; %bb.10:
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v32, v29 :: v_dual_add_nc_u32 v31, s34, v31
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[66:69], v35
	ds_load_b128 v[70:73], v4
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	ds_load_b128 v[74:77], v31
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[29:36], v[54:57], v[62:65], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[29:36], v[38:41], v[58:61], v[29:36] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[29:36], v[70:73], v[78:81], v[29:36] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[29:36], v[66:69], v[74:77], v[29:36] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.LBB0_11:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_cndmask_b32 v20, 0x80000000, v20 :: v_dual_lshlrev_b32 v1, 1, v1
	s_clause 0x7
	...
	v_dual_mul_f32 v31, v29, v31 :: v_dual_and_b32 v46, 0x7f, v0
	...
	.loc	1 392 23                        ; generate_amdgcn.py:392:23
	v_add3_u32 v1, s5, v46, v47
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v30, v30, v37, v13
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	...
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v26, v28, v26 :: v_dual_lshlrev_b32 v21, 16, v21
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v8, v32, v8, v18
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v25, v28, v25 :: v_dual_lshlrev_b32 v24, 16, v24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v23, v28, v23 :: v_dual_lshlrev_b32 v22, 16, v22
	s_waitcnt vmcnt(0)
	...
	v_fma_f32 v26, v26, v38, v14
	v_fma_f32 v25, v25, v39, v15
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_co_u32 v2, vcc_lo, s0, v2
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v23, v23, v40, v6
	v_fma_f32 v21, v21, v41, v7
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_co_ci_u32_e64 v3, null, s1, v3, vcc_lo
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v24, v24, v42, v8
	v_fma_f32 v22, v22, v43, v9
	v_fma_f32 v20, v20, v44, v13
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v4, v5, v4, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v16, v29, 4, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v5, v14, v26, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v17, v29, 8, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v14, v15, v25, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v18, v29, 12, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v6, v6, v23, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v19, v29, 16, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v7, v7, v21, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v30, v29, 20, 0
	v_xad_u32 v31, v29, 24, 0
	v_xad_u32 v29, v29, 28, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 101
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.numbered_sgpr, 43
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     45
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.kd
