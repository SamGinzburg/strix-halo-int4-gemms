...
.Ltmp13:
	...
	buffer_load_b128 v[46:49], v8, s[24:27], 0 offen
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	buffer_load_b128 v[50:53], v1, s[20:23], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_bfe_i32 v1, v0, 0, 1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v89, v12, v7
	v_lshlrev_b32_e32 v2, 5, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v90, v17, 10, v1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v1, 0, v89
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v91, 0x90, v90
	v_xor_b32_e32 v92, 0x120, v90
	v_xor_b32_e32 v93, 0x1b0, v90
	v_xor_b32_e32 v94, 0x210, v90
	v_add_nc_u32_e32 v7, 0, v90
	v_xor_b32_e32 v95, 0x330, v90
	v_xor_b32_e32 v96, 0x3a0, v90
	v_add_nc_u32_e32 v8, 0, v91
	v_add_nc_u32_e32 v54, 0, v92
	v_add_nc_u32_e32 v55, 0, v93
	v_add_nc_u32_e32 v56, 0, v94
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(7)
	v_perm_b32 v3, v22, v18, 0x4000501
	v_perm_b32 v4, v22, v18, 0x6020703
	v_perm_b32 v5, v23, v19, 0x4000501
	v_perm_b32 v6, v23, v19, 0x6020703
	...
	v_perm_b32 v38, v3, v22, 0x7060302
	v_perm_b32 v3, v3, v22, 0x5040100
	v_perm_b32 v22, v4, v23, 0x7060302
	v_perm_b32 v4, v4, v23, 0x5040100
	v_perm_b32 v23, v5, v24, 0x7060302
	v_perm_b32 v5, v5, v24, 0x5040100
	v_perm_b32 v24, v6, v25, 0x7060302
	v_perm_b32 v6, v6, v25, 0x5040100
	...
	ds_store_2addr_b32 v7, v38, v3 offset1:16
	ds_store_2addr_b32 v8, v22, v4 offset1:16
	ds_store_2addr_b32 v54, v23, v5 offset1:16
	ds_store_2addr_b32 v55, v24, v6 offset1:16
	ds_store_2addr_b32 v56, v25, v18 offset1:16
	ds_store_2addr_b32 v7, v26, v19 offset0:160 offset1:176
	ds_store_2addr_b32 v57, v27, v20 offset1:16
	ds_store_2addr_b32 v58, v28, v21 offset1:16
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v1, v[50:53] offset:36864
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v1, v30, v29, 0x7060302
	v_perm_b32 v3, v30, v29, 0x5040100
	v_perm_b32 v4, v31, v39, 0x7060302
	v_perm_b32 v5, v31, v39, 0x5040100
	v_perm_b32 v6, v32, v40, 0x7060302
	v_perm_b32 v7, v32, v40, 0x5040100
	v_perm_b32 v8, v33, v41, 0x7060302
	v_perm_b32 v18, v33, v41, 0x5040100
	v_perm_b32 v19, v34, v42, 0x7060302
	v_perm_b32 v20, v34, v42, 0x5040100
	v_perm_b32 v21, v35, v43, 0x7060302
	v_perm_b32 v22, v35, v43, 0x5040100
	v_perm_b32 v23, v36, v44, 0x7060302
	v_perm_b32 v24, v36, v44, 0x5040100
	v_perm_b32 v25, v37, v45, 0x7060302
	v_perm_b32 v26, v37, v45, 0x5040100
	ds_store_2addr_b32 v59, v1, v3 offset1:16
	ds_store_2addr_b32 v60, v4, v5 offset1:16
	ds_store_2addr_b32 v61, v6, v7 offset1:16
	ds_store_2addr_b32 v62, v8, v18 offset1:16
	ds_store_2addr_b32 v63, v19, v20 offset1:16
	ds_store_2addr_b32 v59, v21, v22 offset0:160 offset1:176
	ds_store_2addr_b32 v64, v23, v24 offset1:16
	ds_store_2addr_b32 v65, v25, v26 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
.Ltmp14:
	...
	v_and_or_b32 v84, 0x1c0, v85, v2
	v_dual_mov_b32 v80, 0 :: v_dual_add_nc_u32 v97, s29, v10
	v_dual_mov_b32 v81, 0 :: v_dual_mov_b32 v70, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v2, v3, v1
	v_and_b32_e32 v3, 0x420, v4
	v_or_b32_e32 v98, v88, v1
	v_dual_mov_b32 v79, 0 :: v_dual_mov_b32 v68, 0
	v_or_b32_e32 v2, v84, v2
	v_mov_b32_e32 v78, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v100, 16, v98
	v_xor_b32_e32 v101, 32, v98
	v_xor_b32_e32 v102, 48, v98
	v_xor_b32_e32 v99, v2, v3
	v_dual_mov_b32 v1, s12 :: v_dual_mov_b32 v2, s13
	v_dual_mov_b32 v3, s14 :: v_dual_mov_b32 v76, 0
	s_delay_alu instid0(VALU_DEP_3)
	v_xor_b32_e32 v103, 16, v99
	v_xor_b32_e32 v104, 32, v99
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s15, v99
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v106, s12, v83
	.loc	1 404 22 is_stmt 0              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v182, s36, v98
	.loc	1 408 22 is_stmt 1              ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v115, s15, v103
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v186, s36, v100
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s12, s12, s29
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b128 v[170:173], v106, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_add_f32 v69, v69, v119 :: v_dual_add_f32 v68, v68, v120
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[122:129], v[178:181], v[174:177], v[122:129] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[130:137], v[182:185], v[174:177], v[130:137] neg_lo:[1,1,0]
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v111, s12, v10
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[162:169], v[182:185], v[174:177], v[162:169] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v183, v115
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v78, v78, v178 :: v_dual_add_nc_u32 v115, s12, v97
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	buffer_load_b128 v[115:118], v115, s[24:27], 0 offen
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v81, v81, v175 :: v_dual_add_f32 v80, v80, v176
	v_add_f32_e32 v79, v79, v177
	v_add_f32_e32 v77, v77, v179
	v_add_f32_e32 v75, v75, v181
	v_add_f32_e32 v73, v73, v183
	v_dual_add_f32 v71, v71, v185 :: v_dual_add_f32 v66, v66, v122
	v_dual_add_f32 v61, v61, v127 :: v_dual_add_f32 v64, v64, v124
	v_dual_add_f32 v59, v59, v129 :: v_dual_add_f32 v62, v62, v126
	v_add_f32_e32 v55, v55, v132
	v_dual_add_f32 v60, v60, v128 :: v_dual_add_f32 v53, v53, v134
	v_dual_add_f32 v58, v58, v130 :: v_dual_add_f32 v51, v51, v136
	v_dual_add_f32 v56, v56, v131 :: v_dual_add_f32 v49, v49, v138
	v_dual_add_f32 v54, v54, v133 :: v_dual_add_f32 v47, v47, v140
	v_dual_add_f32 v52, v52, v135 :: v_dual_add_f32 v45, v45, v142
	v_dual_add_f32 v50, v50, v137 :: v_dual_add_f32 v43, v43, v144
	v_dual_add_f32 v48, v48, v139 :: v_dual_add_f32 v41, v41, v146
	v_dual_add_f32 v46, v46, v141 :: v_dual_add_f32 v39, v39, v148
	v_dual_add_f32 v44, v44, v143 :: v_dual_add_f32 v37, v37, v150
	v_dual_add_f32 v42, v42, v145 :: v_dual_add_f32 v35, v35, v152
	v_dual_add_f32 v40, v40, v147 :: v_dual_add_f32 v33, v33, v154
	v_dual_add_f32 v38, v38, v149 :: v_dual_add_f32 v31, v31, v156
	v_dual_add_f32 v36, v36, v151 :: v_dual_add_f32 v29, v29, v158
	v_dual_add_f32 v34, v34, v153 :: v_dual_add_f32 v27, v27, v160
	v_dual_add_f32 v32, v32, v155 :: v_dual_add_f32 v25, v25, v162
	v_dual_add_f32 v30, v30, v157 :: v_dual_add_f32 v23, v23, v164
	v_dual_add_f32 v28, v28, v159 :: v_dual_add_f32 v21, v21, v109
	v_add_f32_e32 v24, v24, v163
	v_dual_add_f32 v22, v22, v110 :: v_dual_add_f32 v19, v19, v107
	v_add_f32_e32 v20, v20, v108
	v_add_f32_e32 v18, v18, v106
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v165, v115, v111, 0x4000501
	v_perm_b32 v166, v115, v111, 0x6020703
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v111, s12, v82
	v_add_nc_u32_e32 v115, s12, v11
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v167, v116, v112, 0x4000501
	v_perm_b32 v168, v116, v112, 0x6020703
	v_perm_b32 v169, v117, v113, 0x4000501
	v_perm_b32 v187, v117, v113, 0x6020703
	v_perm_b32 v188, v118, v114, 0x4000501
	v_perm_b32 v189, v118, v114, 0x6020703
	s_clause 0x1
	buffer_load_b128 v[111:114], v111, s[24:27], 0 offen
	buffer_load_b128 v[115:118], v115, s[24:27], 0 offen
	...
	s_add_i32 s0, s0, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v26, v26, v161 :: v_dual_add_nc_u32 v109, s0, v95
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v110, s0, v94
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_waitcnt vmcnt(0)
	v_perm_b32 v190, v115, v111, 0x4000501
	v_perm_b32 v111, v115, v111, 0x6020703
	v_perm_b32 v115, v116, v112, 0x4000501
	v_perm_b32 v112, v116, v112, 0x6020703
	v_perm_b32 v116, v117, v113, 0x4000501
	v_perm_b32 v113, v117, v113, 0x6020703
	v_perm_b32 v117, v118, v114, 0x4000501
	v_perm_b32 v114, v118, v114, 0x6020703
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v118, s14, v89
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v107, v116, v169, 0x7060302
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_store_b128 v118, v[170:173] offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v118, v190, v165, 0x7060302
	v_perm_b32 v165, v190, v165, 0x5040100
	v_add_nc_u32_e32 v170, s0, v90
	ds_store_2addr_b32 v170, v118, v165 offset1:16
	v_perm_b32 v118, v111, v166, 0x7060302
	v_perm_b32 v111, v111, v166, 0x5040100
	v_add_nc_u32_e32 v165, s0, v91
	ds_store_2addr_b32 v165, v118, v111 offset1:16
	v_perm_b32 v111, v115, v167, 0x7060302
	v_perm_b32 v115, v115, v167, 0x5040100
	v_add_nc_u32_e32 v118, s0, v92
	ds_store_2addr_b32 v118, v111, v115 offset1:16
	v_perm_b32 v111, v112, v168, 0x7060302
	v_perm_b32 v112, v112, v168, 0x5040100
	v_add_nc_u32_e32 v115, s0, v93
	ds_store_2addr_b32 v115, v111, v112 offset1:16
	v_perm_b32 v111, v116, v169, 0x5040100
	v_perm_b32 v112, v113, v187, 0x7060302
	v_perm_b32 v113, v113, v187, 0x5040100
	v_perm_b32 v115, v117, v188, 0x7060302
	v_perm_b32 v116, v117, v188, 0x5040100
	v_perm_b32 v117, v114, v189, 0x7060302
	v_perm_b32 v114, v114, v189, 0x5040100
	ds_store_2addr_b32 v110, v107, v111 offset1:16
	ds_store_2addr_b32 v170, v112, v113 offset0:160 offset1:176
	ds_store_2addr_b32 v109, v115, v116 offset1:16
	ds_store_2addr_b32 v108, v117, v114 offset1:16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
...
; %bb.8:
	...
	v_dual_mov_b32 v89, s20 :: v_dual_add_nc_u32 v130, s36, v6
	v_mov_b32_e32 v86, s17
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[125:128], v129 offset:1024
	ds_load_b128 v[109:112], v129
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v87, s18 :: v_dual_add_nc_u32 v132, s36, v8
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 221
