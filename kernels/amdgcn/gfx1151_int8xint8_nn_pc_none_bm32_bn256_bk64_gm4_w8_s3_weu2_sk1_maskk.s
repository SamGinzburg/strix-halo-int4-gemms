...
.Ltmp13:
	...
	s_lshl_b32 s4, s25, 6
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v3, s29, v51
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s4, s3, s4
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v8, s29, v53
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s6, s3
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s28, v71
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s7, s7, s24
	s_mov_b32 s3, s0
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[103:106], v72, s[20:23], 0 offen
	buffer_load_b128 v[107:110], v71, s[20:23], 0 offen
	buffer_load_b128 v[111:114], v73, s[20:23], 0 offen
	buffer_load_b128 v[115:118], v74, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_add_f32 v22, v22, v71 :: v_dual_add_f32 v45, v45, v72
	...
	v_dual_add_f32 v32, v32, v85 :: v_dual_add_nc_u32 v177, s7, v54
	v_dual_add_f32 v33, v33, v84 :: v_dual_add_nc_u32 v178, s1, v55
	v_dual_add_f32 v28, v28, v89 :: v_dual_add_nc_u32 v179, s1, v60
	v_dual_add_f32 v31, v31, v86 :: v_dual_add_nc_u32 v180, s1, v61
	v_dual_add_f32 v26, v26, v91 :: v_dual_add_nc_u32 v181, s1, v62
	v_dual_add_f32 v29, v29, v88 :: v_dual_add_nc_u32 v182, s1, v63
	v_dual_add_f32 v24, v24, v93 :: v_dual_add_nc_u32 v183, s1, v64
	v_dual_add_f32 v27, v27, v90 :: v_dual_add_nc_u32 v184, s1, v65
	v_dual_add_f32 v36, v36, v81 :: v_dual_add_f32 v35, v35, v82
	v_add_f32_e32 v34, v34, v83
	v_dual_add_f32 v30, v30, v87 :: v_dual_add_f32 v25, v25, v92
	v_add_f32_e32 v18, v18, v98
	v_dual_add_f32 v23, v23, v94 :: v_dual_add_f32 v20, v20, v96
	v_dual_add_f32 v21, v21, v95 :: v_dual_add_f32 v16, v16, v100
	v_dual_add_f32 v19, v19, v97 :: v_dual_add_f32 v14, v14, v102
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 185
