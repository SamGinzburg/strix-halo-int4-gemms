...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v2, 16, v0
	...
	v_lshl_or_b32 v79, v66, 9, v5
	v_lshl_or_b32 v1, v1, 4, v1
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v89, 0, v11
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v97, 0, v17
	...
	v_and_b32_e32 v80, 0x7060706, v2
	v_add_nc_u32_e32 v2, s3, v65
	v_mul_lo_u32 v1, s35, v1
	v_dual_mov_b32 v13, v25 :: v_dual_add_nc_u32 v6, s9, v4
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v16, 16, v2
	...
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v86, 0, v8
	v_add_nc_u32_e32 v87, 0, v9
	v_add_nc_u32_e32 v88, 0, v10
	v_add_nc_u32_e32 v90, 0, v12
	v_add_nc_u32_e32 v92, 0, v14
	v_min_i32_e32 v93, v4, v6
	v_dual_mov_b32 v103, v25 :: v_dual_add_nc_u32 v94, 0, v5
	v_dual_mov_b32 v12, v25 :: v_dual_add_nc_u32 v95, 0, v7
	v_add_nc_u32_e32 v96, 0, v15
	v_add_nc_u32_e32 v98, 0, v18
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v99, 0, v19
	v_add_nc_u32_e32 v100, 0, v21
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v101, 0, v22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 140
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 62
