	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph5
	...
	v_dual_mov_b32 v12, 0x5410 :: v_dual_and_b32 v23, 15, v0
...
.Ltmp12:
	...
	v_and_or_b32 v9, 0x88, v9, v11
	s_lshl_b32 s1, s3, 4
	.loc	1 248 36                        ; generate_amdgcn.py:248:36
	v_and_b32_e32 v1, 0x1f0, v5
	v_and_b32_e32 v2, 0x540054, v12
	...
	v_add_nc_u32_e32 v31, v11, v3
	v_add_nc_u32_e32 v32, v13, v12
...
.LBB0_2:                                ; %._crit_edge
	...
	v_add_lshl_u32 v49, s3, v17, 1
	v_add_lshl_u32 v50, v24, s3, 1
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	s_delay_alu instid0(SALU_CYCLE_1)
	s_cmp_lt_i32 s2, s33
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	buffer_load_u16 v48, v10, s[36:39], 0 offen
	s_waitcnt vmcnt(0)
	...
	ds_load_b128 v[40:43], v33 offset:1024
	ds_load_b128 v[44:47], v33 offset:1040
	s_waitcnt lgkmcnt(3)
	v_mul_f32_e32 v9, v9, v48
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v9, v9, v39 :: v_dual_mul_f32 v10, v10, v48
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 270 20                        ; generate_amdgcn.py:270:20
	v_dual_mul_f32 v14, v14, v48 :: v_dual_mul_f32 v3, v45, v3
	v_dual_mul_f32 v41, v41, v48 :: v_dual_mul_f32 v2, v46, v2
	v_dual_mul_f32 v42, v42, v48 :: v_dual_mul_f32 v11, v11, v37
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v13, v13, v48 :: v_dual_mul_f32 v14, v14, v34
	v_dual_mul_f32 v16, v16, v48 :: v_dual_mul_f32 v7, v41, v7
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v15, v15, v48 :: v_dual_mul_f32 v6, v42, v6
	v_mul_f32_e32 v40, v40, v48
	v_mul_f32_e32 v43, v43, v48
	v_mul_f32_e32 v44, v44, v48
	v_mul_f32_e32 v47, v47, v48
	.loc	1 270 13                        ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v12, v12, v36 :: v_dual_mul_f32 v13, v13, v35
	v_dual_mul_f32 v15, v15, v21 :: v_dual_mul_f32 v16, v16, v20
	v_dual_mul_f32 v8, v40, v8 :: v_dual_mul_f32 v5, v43, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v4, v44, v4 :: v_dual_mul_f32 v1, v47, v1
	...
	v_perm_b32 v1, v4, v2, v25
	v_perm_b32 v2, v4, v2, v26
	v_perm_b32 v3, v5, v6, v25
	v_perm_b32 v4, v5, v6, v26
	v_perm_b32 v5, v8, v9, v25
	v_perm_b32 v6, v8, v9, v26
	v_perm_b32 v7, v11, v10, v25
	v_perm_b32 v8, v11, v10, v26
	s_clause 0x1
	buffer_store_b128 v[1:4], v49, s[20:23], 0 offen
	buffer_store_b128 v[5:8], v50, s[20:23], 0 offen
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
...
; %bb.4:                                ; %.lr.ph
	...
	v_subrev_nc_u32_e32 v34, s5, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[20:21], null, s35, v3, v[19:20]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	buffer_load_u8 v21, v20, s[24:27], 0 offen
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b128 v[35:38], v34, s[28:31], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[39:40], v28
	ds_load_b64 v[41:42], v29
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b128 v30, v[35:38]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 266 27                        ; generate_amdgcn.py:266:27
	ds_load_u8 v21, v31 offset:6656
	ds_load_u8 v35, v31 offset:6144
	ds_load_u8 v36, v31 offset:7680
	ds_load_u8 v37, v31 offset:7168
	ds_load_u8 v38, v31 offset:4608
	ds_load_u8 v43, v31 offset:4096
	ds_load_u8 v44, v31 offset:5632
	ds_load_u8 v45, v31 offset:5120
	ds_load_u8 v46, v31 offset:2560
	ds_load_u8 v47, v31 offset:2048
	ds_load_u8 v48, v31 offset:3584
	ds_load_u8 v49, v31 offset:3072
	ds_load_u8 v50, v31 offset:3840
	ds_load_u8 v51, v31 offset:3328
	ds_load_u8 v52, v31 offset:2816
	ds_load_u8 v53, v31 offset:2304
	ds_load_u8 v54, v31 offset:512
	ds_load_u8 v55, v31
	ds_load_u8 v56, v31 offset:1536
	ds_load_u8 v57, v31 offset:1024
	ds_load_u8 v58, v31 offset:1792
	ds_load_u8 v59, v31 offset:1280
	ds_load_u8 v60, v31 offset:768
	ds_load_u8 v61, v31 offset:256
	ds_load_u8 v62, v31 offset:7936
	ds_load_u8 v63, v31 offset:7424
	ds_load_u8 v64, v31 offset:6912
	ds_load_u8 v65, v31 offset:6400
	ds_load_u8 v66, v31 offset:5888
	ds_load_u8 v67, v31 offset:5376
	ds_load_u8 v68, v31 offset:4864
	ds_load_u8 v69, v31 offset:4352
	...
	v_perm_b32 v54, v43, v38, 0xc0c0004
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v55, v69, v68, 0xc0c0004
	v_lshl_or_b32 v38, v37, 16, v21
	v_lshl_or_b32 v37, v45, 16, v54
	v_lshl_or_b32 v46, v53, 16, v52
	v_wmma_i32_16x16x16_iu4 v[1:8], v[35:36], v[39:40], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v45, v56, 16, v55
	v_wmma_i32_16x16x16_iu4 v[9:16], v[43:44], v[39:40], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[37:38], v[41:42], v[1:8] neg_lo:[1,1,0]
...
.Ltmp13:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 70
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 50
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     52
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.kd
