	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	buffer_load_b128 v[17:20], v10, s[16:19], 0 offen
	buffer_load_b128 v[21:24], v12, s[16:19], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v33, v9, s[8:11], 0 offen
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_dual_cndmask_b32 v8, 0x80000000, v8 :: v_dual_and_b32 v13, 48, v9
	v_cndmask_b32_e32 v6, 0x80000000, v6, vcc_lo
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v34, v7, s[8:11], 0 offen
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	...
	v_or_b32_e32 v11, 10, v7
	v_or_b32_e32 v12, 12, v7
	v_or_b32_e32 v13, 14, v7
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_waitcnt vmcnt(3)
	ds_store_b32 v35, v33 offset:16384
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v35, v34 offset:17408
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_waitcnt vmcnt(1)
...
.LBB0_3:                                ; %Flow59
	...
	s_ashr_i32 s31, s24, 7
	v_or_b32_e32 v26, s28, v7
	v_or_b32_e32 v25, s28, v8
	v_or_b32_e32 v24, s28, v14
	v_mul_lo_u32 v27, v18, s31
	v_or_b32_e32 v22, s28, v15
	v_or_b32_e32 v20, s28, v16
...
; %bb.4:                                ; %.lr.ph
	v_and_b32_e32 v7, 48, v17
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
	v_lshl_or_b32 v5, s21, 7, v5
	s_lshl_b32 s15, s22, 7
	v_or_b32_e32 v41, 0x200, v1
	v_or_b32_e32 v42, 0x200, v2
	v_lshl_or_b32 v28, v3, 6, v7
	v_add_nc_u32_e32 v3, s30, v4
...
.Ltmp22:
	...
	s_lshr_b32 s14, s23, 8
.Ltmp23:
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_add3_u32 v39, v4, v1, 0x200
	s_mov_b32 s23, 0x31027000
	v_mov_b32_e32 v14, 0
	s_mov_b32 s22, 0x7ffffffe
	v_add3_u32 v38, v5, v1, 0x200
	v_mov_b32_e32 v1, 0
	v_mov_b32_e32 v11, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v45, v27, s7, 1
	.loc	1 366 40                        ; generate_amdgcn.py:366:40
	s_mul_i32 s7, s7, s29
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v46, v25, s7, 1
	v_add_lshl_u32 v47, v24, s7, 1
	v_add_lshl_u32 v48, v22, s7, 1
	v_add_lshl_u32 v49, v20, s7, 1
	v_add_lshl_u32 v50, v23, s7, 1
	v_cndmask_b32_e32 v46, 0x80000000, v46, vcc_lo
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	buffer_load_b32 v91, v43, s[8:11], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v43, v26, s7, 1
	v_add_lshl_u32 v51, v21, s7, 1
	v_add_lshl_u32 v52, v19, s7, 1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_dual_cndmask_b32 v45, 0x80000000, v45 :: v_dual_cndmask_b32 v48, 0x80000000, v48
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_dual_cndmask_b32 v43, 0x80000000, v43 :: v_dual_cndmask_b32 v50, 0x80000000, v50
	v_dual_cndmask_b32 v47, 0x80000000, v47 :: v_dual_cndmask_b32 v52, 0x80000000, v52
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	...
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v92, v45, s[20:23], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_clause 0x7
	buffer_load_u16 v93, v43, s[24:27], 0 offen
	...
	.loc	1 350 30                        ; generate_amdgcn.py:350:30
	v_add_nc_u32_e32 v43, s37, v39
	.loc	1 344 23                        ; generate_amdgcn.py:344:23
	v_cmp_gt_i32_e32 vcc_lo, s6, v44
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v45, s37, v38
	s_mov_b32 s7, s15
	s_mov_b32 s15, s33
	s_mov_b32 s33, s14
	s_delay_alu instid0(VALU_DEP_1)
	...
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v43, s7, v28
	v_add_nc_u32_e32 v44, s7, v31
	v_add_nc_u32_e32 v45, s7, v29
	v_add_nc_u32_e32 v46, s7, v30
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v47, s33, v33
	v_add_nc_u32_e32 v48, s33, v35
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	ds_load_b128 v[59:62], v43
	ds_load_b128 v[63:66], v44
	ds_load_b128 v[67:70], v45
	ds_load_b128 v[71:74], v46
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	ds_load_b128 v[75:78], v47
	ds_load_b128 v[79:82], v48
	v_add_nc_u32_e32 v49, s33, v32
	v_add_nc_u32_e32 v50, s33, v34
	...
	s_add_i32 s34, s34, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_add_i32 s7, s37, 0x100
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_add_i32 s33, s38, 0x4000
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_wmma_i32_16x16x16_iu8 v[43:50], v[75:78], v[59:62], v[1:8] neg_lo:[1,1,0]
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cmp_lg_u32 s35, 0
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	s_barrier
	...
	v_wmma_i32_16x16x16_iu8 v[43:50], v[83:86], v[67:70], v[43:50] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[43:50], v[87:90], v[71:74], v[43:50] neg_lo:[1,1,0]
	...
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v60, v59, v60 :: v_dual_lshlrev_b32 v65, 16, v98
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v67, 16, v100
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_dual_mul_f32 v63, v59, v63 :: v_dual_lshlrev_b32 v64, 16, v97
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v65, v59, v65 :: v_dual_lshlrev_b32 v66, 16, v99
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v17, v65, v48 :: v_dual_mul_f32 v66, v59, v66
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_mul_f32_e32 v59, v59, v67
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v101, s38, v36
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v11, v60, v43 :: v_dual_add_nc_u32 v102, s34, v37
	v_dual_fmac_f32 v13, v61, v44 :: v_dual_fmac_f32 v14, v62, v45
	v_fmac_f32_e32 v16, v64, v47
	v_fmac_f32_e32 v18, v66, v49
	v_fmac_f32_e32 v12, v59, v50
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.9:
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v38, 0 :: v_dual_add_nc_u32 v3, s14, v33
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v2, s14, v35
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v36, s15, v31
	v_add_nc_u32_e32 v37, s15, v28
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v42, v38 :: v_dual_add_nc_u32 v39, s14, v34
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v43, v38 :: v_dual_add_nc_u32 v2, s14, v32
	v_dual_mov_b32 v44, v38 :: v_dual_add_nc_u32 v3, s15, v30
	v_dual_mov_b32 v45, v38 :: v_dual_add_nc_u32 v36, s15, v29
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
...
.LBB0_10:
	...
	v_add_lshl_u32 v44, v21, s8, 1
	v_add_lshl_u32 v46, v19, s8, 1
...
; %bb.11:
	...
	v_add_nc_u32_e32 v4, s34, v32
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v30, s33, v30
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v32, v28 :: v_dual_add_nc_u32 v29, s33, v29
...
.LBB0_12:
	...
	v_dual_cndmask_b32 v19, 0x80000000, v19 :: v_dual_and_b32 v48, 7, v0
	s_clause 0x7
	...
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_dual_mul_f32 v32, v28, v32 :: v_dual_and_b32 v49, 0x1040, v49
	...
	v_dual_mul_f32 v29, v28, v29 :: v_dual_and_b32 v46, 0x7f, v0
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v31, v35, v2, v13
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_ashrrev_i32_e32 v2, 31, v1
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v5, v11, v5, s3
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_nc_u32_e32 v11, 0, v28
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v3, v34, v3, v14
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_lshlrev_b32_e32 v24, 16, v24
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v6, v33, v6, v15
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_mul_f32_e32 v26, v27, v26
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v25, v27, v25 :: v_dual_lshlrev_b32 v20, 16, v20
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v24, v27, v24 :: v_dual_lshlrev_b32 v23, 16, v23
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v22, v27, v22 :: v_dual_lshlrev_b32 v21, 16, v21
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v20, v27, v20 :: v_dual_lshlrev_b32 v19, 16, v19
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	...
	v_fma_f32 v25, v25, v38, v13
	v_fma_f32 v24, v24, v39, v14
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_co_u32 v2, vcc_lo, s0, v2
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v22, v22, v40, v6
	v_fma_f32 v20, v20, v41, v7
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_co_ci_u32_e64 v3, null, s1, v3, vcc_lo
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v23, v23, v42, v8
	v_fma_f32 v21, v21, v43, v18
	v_fma_f32 v19, v19, v44, v12
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v4, v5, v4, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v15, v28, 4, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v5, v13, v25, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v16, v28, 8, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v13, v14, v24, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v17, v28, 12, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v6, v6, v22, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v29, v28, 16, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v7, v7, v20, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v30, v28, 20, 0
	v_xad_u32 v31, v28, 24, 0
	v_xad_u32 v28, v28, 28, 0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 103
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
