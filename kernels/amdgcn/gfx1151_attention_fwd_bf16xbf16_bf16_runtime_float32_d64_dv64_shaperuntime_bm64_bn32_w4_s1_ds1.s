...
; %bb.5:                                ; %.lr.ph
	...
	v_dual_mov_b32 v84, 0 :: v_dual_add_nc_u32 v71, s39, v0
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v74, s39, v17
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s15, s82, v2
	v_dual_mov_b32 v19, v57 :: v_dual_add_nc_u32 v100, s39, v2
	v_dual_mov_b32 v23, v57 :: v_dual_and_b32 v2, 31, v65
	.loc	1 762 27                        ; attention.py:762:27
	v_writelane_b32 v255, s1, 7
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s1, s82, v5
	v_dual_mov_b32 v17, v57 :: v_dual_add_nc_u32 v98, s39, v11
	...
	v_dual_mov_b32 v82, 0 :: v_dual_add_nc_u32 v73, s39, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_dual_mov_b32 v92, 0 :: v_dual_add_nc_u32 v79, s39, v3
	.loc	1 762 27                        ; attention.py:762:27
	...
	v_dual_cndmask_b32 v2, 0x3276, v2 :: v_dual_mov_b32 v13, v57
	v_dual_mov_b32 v63, v57 :: v_dual_add_nc_u32 v80, s39, v7
	.loc	1 762 27                        ; attention.py:762:27
	...
	v_dual_mov_b32 v58, v57 :: v_dual_and_b32 v191, 0x5040504, v0
	...
	v_dual_mov_b32 v88, 0 :: v_dual_add_nc_u32 v75, s39, v5
	...
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v72, s39, v9
	v_dual_mov_b32 v59, v57 :: v_dual_add_nc_u32 v76, s39, v8
	...
	v_dual_mov_b32 v86, 0 :: v_dual_add_nc_u32 v77, s39, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v196, 0, v0
	v_xor_b32_e32 v0, 0x50, v169
	v_dual_mov_b32 v139, 0xff800000 :: v_dual_add_nc_u32 v78, s39, v16
	v_mov_b32_e32 v61, v57
	v_dual_mov_b32 v90, 0 :: v_dual_add_nc_u32 v99, s39, v15
	v_dual_mov_b32 v64, v57 :: v_dual_add_nc_u32 v197, 0, v0
	v_xor_b32_e32 v0, 0x60, v169
	v_dual_mov_b32 v96, 0 :: v_dual_add_nc_u32 v101, s39, v6
	v_dual_mov_b32 v159, 0xff800000 :: v_dual_add_nc_u32 v102, s39, v10
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v21, v57 :: v_dual_add_nc_u32 v198, 0, v0
	v_mov_b32_e32 v5, v57
	v_xor_b32_e32 v0, 0x70, v169
	v_dual_mov_b32 v94, 0 :: v_dual_add_nc_u32 v103, s39, v14
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_add_nc_u32_e32 v0, 0, v0
	scratch_store_b32 off, v69, off offset:560 ; 4-byte Folded Spill
	...
	v_dual_mov_b32 v173, 0xff800000 :: v_dual_mov_b32 v160, 0xff800000
	...
	v_dual_mov_b32 v143, 0xff800000 :: v_dual_mov_b32 v180, 0xff800000
	...
	v_subrev_nc_u32_e32 v0, s37, v103
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v0, off offset:476
	scratch_store_b32 off, v71, off offset:352
...
.LBB0_6:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cndmask_b32_e64 v112, 0x80000000, v112, s7
	...
	v_cndmask_b32_e64 v116, 0x80000000, v116, s97
	v_cndmask_b32_e64 v108, 0x80000000, v108, s1
	v_cndmask_b32_e64 v110, 0x80000000, v110, s59
	...
	.loc	1 879 36                        ; attention.py:879:36
	s_waitcnt vmcnt(11)
	v_cndmask_b16 v111.h, 0xff80, v0.l, s14
	v_add_lshl_u32 v0, s3, v146, 1
	s_waitcnt vmcnt(10)
	v_cndmask_b16 v111.l, 0xff80, v98.l, s13
	v_add_lshl_u32 v98, s3, v109, 1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b32_e64 v0, 0x80000000, v0, s12
	v_cndmask_b32_e64 v98, 0x80000000, v98, s9
	s_clause 0x3
	buffer_load_u16 v0, v0, s[84:87], 0 offen
	buffer_load_u16 v98, v98, s[84:87], 0 offen
	...
	.loc	1 879 36                        ; attention.py:879:36
	s_waitcnt vmcnt(13)
	v_cndmask_b16 v132.h, 0xff80, v99.l, s11
	s_waitcnt vmcnt(12)
	v_cndmask_b16 v132.l, 0xff80, v100.l, s10
	s_waitcnt vmcnt(10)
	v_cndmask_b16 v103.h, 0xff80, v101.l, s8
	v_cndmask_b16 v103.l, 0xff80, v103.l, s6
	s_waitcnt vmcnt(0)
	v_cndmask_b16 v113.h, 0xff80, v114.l, s4
	v_cndmask_b16 v108.h, 0xff80, v108.l, s1
	v_cndmask_b16 v108.l, 0xff80, v110.l, s59
	v_cndmask_b16 v110.h, 0xff80, v116.l, s97
	v_cndmask_b16 v110.l, 0xff80, v117.l, s95
	v_cndmask_b16 v131.h, 0xff80, v0.l, s12
	v_cndmask_b16 v131.l, 0xff80, v98.l, s9
	.loc	1 880 35                        ; attention.py:880:35
	v_add_nc_u32_e32 v0, 0, v189
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b16 v112.h, 0xff80, v112.l, s7
	v_cndmask_b16 v112.l, 0xff80, v113.l, s5
	...
	v_dual_fmac_f32 v101, s100, v79 :: v_dual_lshlrev_b32 v122, 16, v100
	...
	v_fmac_f32_e32 v99, s100, v73
	.loc	1 880 35                        ; attention.py:880:35
	v_mul_f32_e32 v123, 0x3fb8aa3b, v122
	.loc	1 879 36 is_stmt 1              ; attention.py:879:36
	v_lshlrev_b32_e32 v114, 16, v114
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v100, s100, v74
	v_fmac_f32_e32 v98, s100, v75
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v124, s100, v77 :: v_dual_fmac_f32 v123, s100, v76
	...
	.loc	1 880 35                        ; attention.py:880:35
	v_dual_mul_f32 v78, 0x3fb8aa3b, v73 :: v_dual_fmac_f32 v129, s100, v71
	v_mul_f32_e32 v79, 0x3fb8aa3b, v74
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 880 25 is_stmt 0              ; attention.py:880:25
	v_dual_fmac_f32 v127, s100, v69 :: v_dual_mul_f32 v80, 0x3fb8aa3b, v0
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_mov_b16_e32 v0.l, 0
	.loc	1 879 36                        ; attention.py:879:36
	v_mov_b16_e64 v0.h, v131.l
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v78, s100, v66 :: v_dual_fmac_f32 v79, s100, v67
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 881 25                        ; attention.py:881:25
	v_lshlrev_b16 v65.l, 8, v65.l
	s_and_b32 s26, s4, s22
	s_and_b32 s31, s81, s3
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	...
	.loc	1 881 34 is_stmt 0              ; attention.py:881:34
	v_cmp_neq_f32_e64 s27, 0xff800000, v110
	.loc	1 881 25                        ; attention.py:881:25
	...
	v_cndmask_b32_e64 v76, 0xff800000, v100, s64
	.loc	1 881 25                        ; attention.py:881:25
	s_waitcnt vmcnt(0)
	...
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v77, 0xff800000, v98, s62
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s63, 1, v0.h
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v73, 0xff800000, v123, s63
	.loc	1 881 25                        ; attention.py:881:25
	s_waitcnt vmcnt(1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_cmp_eq_u16_e64 s60, 1, v0.h
	v_and_b16 v0.h, 1, v66.h
	scratch_load_b32 v66, off, off offset:304 ; 4-byte Folded Reload
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v74, 0xff800000, v124, s60
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s61, 1, v0.h
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v75, 0xff800000, v125, s61
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v128, s100, v70
	.loc	1 896 30                        ; attention.py:896:30
	...
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v156, 0xff800000, v79, s55
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 881 25                        ; attention.py:881:25
	...
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v155, 0xff800000, v127, s53
	.loc	1 881 25                        ; attention.py:881:25
	s_waitcnt vmcnt(0)
	ds_load_u8_d16_hi v67, v68
	...
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v98, 0xff800000, v128, s54
	.loc	1 881 25                        ; attention.py:881:25
	s_waitcnt vmcnt(0)
...
.Ltmp2:
	...
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v138, 0xff800000, v129, s51
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 881 25                        ; attention.py:881:25
	...
	v_cndmask_b32_e64 v154, 0xff800000, v130, s52
	.loc	1 881 25                        ; attention.py:881:25
	v_and_b16 v0.h, 1, v0.h
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	...
	v_and_b16 v0.h, 1, v66.l
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v65, 0xff800000, v99, s66
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 881 25                        ; attention.py:881:25
	v_cmp_eq_u16_e64 s58, 1, v0.h
	v_and_b16 v0.h, 1, v67.l
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v99, 0xff800000, v126, s56
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
...
.Ltmp4:
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v100, 0xff800000, v78, s58
	.loc	1 881 25                        ; attention.py:881:25
...
.Ltmp6:
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v78, 0xff800000, v101, s65
	v_cndmask_b32_e64 v101, 0xff800000, v80, s57
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp12:
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v68, 0, v68, s62
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	...
	v_cndmask_b16 v69.h, 0x7fff, v67.h, s63
	v_cndmask_b16 v69.l, 0x7fff, v68.h, s62
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_cndmask_b16 v71.h, 0x7fff, v69.h, s61
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v71.l, 0x7fff, v70.h, s60
	...
	s_waitcnt vmcnt(1)
	v_mad_u64_u32 v[110:111], null, s94, s96, v[110:111]
	...
	s_mov_b32 s94, s90
	v_add_lshl_u32 v103, v110, s102, 1
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v72, 0, v72, s65
	.loc	1 890 30                        ; attention.py:890:30
	v_add_lshl_u32 v108, v110, s103, 1
	v_add_lshl_u32 v111, v110, s1, 1
	v_add_lshl_u32 v112, v110, s104, 1
	s_mul_i32 s1, s96, 10
	.loc	1 896 30                        ; attention.py:896:30
	...
	s_mul_i32 s1, s96, 12
	v_add_lshl_u32 v116, v110, vcc_hi, 1
	.loc	1 896 30                        ; attention.py:896:30
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v80.l, 0x7fff, v72.h, s60
	.loc	1 890 30                        ; attention.py:890:30
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v72, v80, s67, 0xfedcba98 op_sel:[1,0]
	s_mul_i32 s1, s96, 22
	.loc	1 890 30                        ; attention.py:890:30
...
.Ltmp16:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v67.l, 0x7fff, v66.h, s35
	...
	v_cndmask_b16 v69.l, 0x7fff, v68.h, s35
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v68, v69, s67, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v67, v68, v69, v191
	v_perm_b32 v68, v68, v69, v192
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v71.l, 0x7fff, v70.h, s35
	v_permlanex16_b32 v70, v71, s67, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1)
	v_perm_b32 v69, v70, v71, v191
	v_perm_b32 v70, v70, v71, v192
	...
	v_cndmask_b16 v72.l, 0x7fff, v0.h, s35
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v0, v72, s67, 0xfedcba98 op_sel:[1,0]
...
.Ltmp141:
	.loc	1 884 24                        ; attention.py:884:24
	v_max_f32_e64 v72, s7, s7
	v_max_f32_e64 v74, s11, s11
.Ltmp142:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
...
.Ltmp180:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_readlane_b32 s13, v66, 31
.Ltmp181:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max_f32_e32 v69, v69, v69
.Ltmp182:
	.loc	1 884 24                        ; attention.py:884:24
	v_max_f32_e64 v66, s8, s8
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_max_f32_e64 v76, s13, s13
.Ltmp183:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
	v_max_f32_e32 v67, v67, v69
.Ltmp184:
...
.Ltmp205:
	...
	v_dual_max_f32 v67, v67, v68 :: v_dual_max_f32 v68, v161, v161
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_max_f32 v161, v68, v69 :: v_dual_max_f32 v68, v182, v182
	v_max_f32_e32 v68, v68, v69
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 884 24                        ; attention.py:884:24
	v_dual_max_f32 v71, v71, v72 :: v_dual_max_f32 v72, v162, v162
	.loc	1 886 62                        ; attention.py:886:62
	v_dual_sub_f32 v103, v133, v170 :: v_dual_max_f32 v162, v72, v73
	.loc	1 884 24                        ; attention.py:884:24
	v_max_f32_e32 v72, v178, v178
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.Ltmp223:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_readlane_b32 s6, v99, 31
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp224:
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v101, 0, v101, s34
.Ltmp225:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp236:
	...
	v_cndmask_b32_e64 v98, 0, v98, s27
.Ltmp237:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp238:
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v80, 0, v80, s22
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp239:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp242:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_readlane_b32 s3, v100, 31
	v_readlane_b32 s11, v98, 31
	v_permlanex16_b32 v98, v80, -1, -1 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
.Ltmp243:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp254:
	...
	v_sub_f32_e32 v111, v126, v162
	.loc	1 897 23                        ; attention.py:897:23
	v_fma_f32 v91, v91, v80, s13
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 886 49                        ; attention.py:886:49
...
.Ltmp260:
	...
	.loc	1 886 33                        ; attention.py:886:33
	v_cndmask_b32_e64 v99, 0, v99, s19
.Ltmp261:
...
.Ltmp298:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_readlane_b32 s12, v101, 31
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
.Ltmp299:
	.loc	1 897 23                        ; attention.py:897:23
	v_fma_f32 v88, v88, v80, s14
	.loc	1 885 74                        ; attention.py:885:74
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 897 23 is_stmt 1              ; attention.py:897:23
	v_fma_f32 v84, v84, v80, s12
	.loc	1 818 13                        ; attention.py:818:13
	s_cbranch_scc0 .LBB0_12
.LBB0_7:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v0, s98, v235
...
.LBB0_13:                               ; %._crit_edge
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v69, v56, v69 :: v_dual_fmac_f32 v72, v78, v72
	.loc	1 787 79                        ; attention.py:787:79
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_runtime_float32_d64_dv64_shaperuntime_bm64_bn32_w4_s1_ds1.private_seg_size, 572
