...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 738 35                        ; ragged.py:738:35
	s_mul_i32 s3, s19, s18
	s_clause 0x1
	s_load_b128 s[12:15], s[0:1], 0x0
	s_load_b32 s1, s[0:1], 0x48
	v_mad_u64_u32 v[66:67], null, s3, s16, v[65:66]
	...
	v_dual_mov_b32 v33, v1 :: v_dual_add_nc_u32 v128, s18, v66
	...
	.loc	1 724 18                        ; ragged.py:724:18
	v_or_b32_e32 v121, 1, v98
	v_or_b32_e32 v122, 2, v98
	v_or_b32_e32 v123, 3, v98
	v_or_b32_e32 v124, 4, v98
	v_or_b32_e32 v125, 5, v98
	v_or_b32_e32 v126, 6, v98
	v_or_b32_e32 v127, 7, v98
	.loc	1 729 19                        ; ragged.py:729:19
	v_lshl_add_u32 v129, s18, 1, v66
	v_lshl_add_u32 v67, s18, 2, v66
	v_lshl_add_u32 v95, s18, 3, v66
	v_lshl_add_u32 v130, s18, 4, v66
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v132, s0, v124
	v_add_nc_u32_e32 v140, s3, v72
	v_add_nc_u32_e32 v139, s3, v70
	v_add_nc_u32_e32 v142, s3, v71
	v_add_nc_u32_e32 v131, s3, v67
	v_add_nc_u32_e32 v143, s3, v69
	...
	buffer_load_u8 v164, v131, s[12:15], 0 offen
	buffer_load_u8 v143, v143, s[12:15], 0 offen
	v_add_nc_u32_e32 v144, s3, v129
	v_add_nc_u32_e32 v145, s3, v128
	.loc	1 740 38 is_stmt 0              ; ragged.py:740:38
	v_add_nc_u32_e32 v146, s3, v66
	.loc	1 730 22 is_stmt 1              ; ragged.py:730:22
	v_or_b32_e32 v133, s0, v125
	v_or_b32_e32 v134, s0, v127
	v_or_b32_e32 v135, s0, v126
	v_or_b32_e32 v136, s0, v123
	v_or_b32_e32 v137, s0, v122
	v_or_b32_e32 v138, s0, v121
	v_or_b32_e32 v141, s0, v98
	v_add_nc_u32_e32 v148, s3, v73
	v_add_nc_u32_e32 v151, s3, v76
	v_add_nc_u32_e32 v154, s3, v79
	v_add_nc_u32_e32 v149, s3, v74
	v_add_nc_u32_e32 v152, s3, v77
	v_add_nc_u32_e32 v147, s3, v95
	v_add_nc_u32_e32 v150, s3, v75
	v_add_nc_u32_e32 v153, s3, v78
	v_add_nc_u32_e32 v155, s3, v130
	v_add_nc_u32_e32 v156, s3, v80
	v_add_nc_u32_e32 v157, s3, v81
	v_add_nc_u32_e32 v158, s3, v82
	v_add_nc_u32_e32 v159, s3, v83
	v_add_nc_u32_e32 v160, s3, v84
	v_add_nc_u32_e32 v161, s3, v85
	v_add_nc_u32_e32 v162, s3, v86
	v_add_nc_u32_e32 v163, s3, v87
	...
	.loc	1 740 30                        ; ragged.py:740:30
	s_waitcnt vmcnt(4)
	v_lshlrev_b16 v131.l, 8, v140.l
	s_waitcnt vmcnt(3)
	v_lshlrev_b16 v131.h, 8, v139.l
	v_cndmask_b32_e64 v139, 0x80000000, v145, s2
	s_waitcnt vmcnt(2)
	v_or_b16 v140.h, v142.l, v131.l
	s_waitcnt vmcnt(1)
	v_or_b16 v140.l, v164.l, v131.h
	v_cndmask_b32_e64 v131, 0x80000000, v144, s2
	v_add_nc_u32_e32 v142, s3, v88
	v_add_nc_u32_e32 v164, s3, v89
	s_clause 0x1
	buffer_load_u8 v144, v131, s[12:15], 0 offen
	buffer_load_u8 v139, v139, s[12:15], 0 offen
	s_waitcnt vmcnt(2)
	v_lshlrev_b16 v131.l, 8, v143.l
	v_add_nc_u32_e32 v143, s3, v90
	v_cndmask_b32_e64 v142, 0x80000000, v142, s2
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v143, 0x80000000, v143, s2
	s_waitcnt vmcnt(0)
	v_or_b16 v139.h, v144.l, v131.l
	v_cndmask_b32_e64 v131, 0x80000000, v146, s2
	v_add_nc_u32_e32 v144, s3, v91
	buffer_load_u8 v145, v131, s[12:15], 0 offen
	v_lshlrev_b16 v131.l, 8, v139.l
	v_cndmask_b32_e64 v144, 0x80000000, v144, s2
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_or_b16 v139.l, v145.l, v131.l
	.loc	1 739 38                        ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v132, s1, v[68:69]
	v_add_nc_u32_e32 v145, s3, v92
	.loc	1 740 30                        ; ragged.py:740:30
	v_cndmask_b32_e64 v145, 0x80000000, v145, s2
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 739 30                        ; ragged.py:739:30
	v_cndmask_b32_e32 v146, 0x80000000, v131, vcc_lo
	.loc	1 739 38 is_stmt 0              ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v133, s1, v[68:69]
	.loc	1 739 30                        ; ragged.py:739:30
	v_cndmask_b32_e32 v133, 0x80000000, v131, vcc_lo
	.loc	1 739 38                        ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v134, s1, v[68:69]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	.loc	1 739 30                        ; ragged.py:739:30
	v_cndmask_b32_e32 v134, 0x80000000, v131, vcc_lo
	.loc	1 739 38                        ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v135, s1, v[68:69]
	.loc	1 739 30                        ; ragged.py:739:30
	v_cndmask_b32_e32 v135, 0x80000000, v131, vcc_lo
	.loc	1 739 38                        ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v136, s1, v[68:69]
	v_add_nc_u32_e32 v136, s3, v93
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 740 30 is_stmt 1              ; ragged.py:740:30
	...
	buffer_load_u8 v135, v146, s[4:7], 0 offen
	buffer_load_u8 v146, v131, s[4:7], 0 offen
	s_waitcnt vmcnt(4)
	v_lshlrev_b16 v131.l, 8, v132.l
	s_waitcnt vmcnt(3)
	v_lshlrev_b16 v131.h, 8, v133.l
	s_waitcnt vmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b16 v133.h, v134.l, v131.l
	s_waitcnt vmcnt(1)
	v_or_b16 v133.l, v135.l, v131.h
	.loc	1 739 38 is_stmt 0              ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v137, s1, v[68:69]
	v_add_nc_u32_e32 v134, s3, v94
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 740 30 is_stmt 1              ; ragged.py:740:30
	...
	v_cndmask_b32_e32 v135, 0x80000000, v131, vcc_lo
	.loc	1 739 38 is_stmt 0              ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v138, s1, v[68:69]
	.loc	1 740 30 is_stmt 1              ; ragged.py:740:30
	v_cndmask_b32_e64 v138, 0x80000000, v148, s2
	...
	v_cndmask_b32_e64 v160, 0x80000000, v163, s2
	.loc	1 739 30                        ; ragged.py:739:30
	v_cndmask_b32_e32 v137, 0x80000000, v131, vcc_lo
	.loc	1 739 38 is_stmt 0              ; ragged.py:739:38
	v_mad_u64_u32 v[131:132], null, v141, s1, v[68:69]
	.loc	1 740 30 is_stmt 1              ; ragged.py:740:30
	v_cndmask_b32_e64 v141, 0x80000000, v149, s2
	v_cndmask_b32_e64 v149, 0x80000000, v152, s2
	v_cndmask_b32_e64 v132, 0x80000000, v147, s2
	...
	v_cndmask_b32_e64 v159, 0x80000000, v162, s2
	v_cndmask_b32_e64 v161, 0x80000000, v164, s2
	s_clause 0x17
	buffer_load_u8 v167, v151, s[12:15], 0 offen
	buffer_load_u8 v168, v149, s[12:15], 0 offen
	buffer_load_u8 v169, v150, s[12:15], 0 offen
	buffer_load_u8 v170, v148, s[12:15], 0 offen
	buffer_load_u8 v171, v147, s[12:15], 0 offen
	buffer_load_u8 v172, v141, s[12:15], 0 offen
	buffer_load_u8 v173, v138, s[12:15], 0 offen
	buffer_load_u8 v174, v132, s[12:15], 0 offen
	buffer_load_u8 v175, v159, s[12:15], 0 offen
	buffer_load_u8 v176, v157, s[12:15], 0 offen
	buffer_load_u8 v177, v158, s[12:15], 0 offen
	buffer_load_u8 v178, v156, s[12:15], 0 offen
	buffer_load_u8 v179, v155, s[12:15], 0 offen
	buffer_load_u8 v180, v154, s[12:15], 0 offen
	buffer_load_u8 v181, v153, s[12:15], 0 offen
	buffer_load_u8 v182, v152, s[12:15], 0 offen
	buffer_load_u8 v183, v134, s[12:15], 0 offen
	buffer_load_u8 v184, v145, s[12:15], 0 offen
	buffer_load_u8 v185, v136, s[12:15], 0 offen
	buffer_load_u8 v186, v144, s[12:15], 0 offen
	buffer_load_u8 v187, v143, s[12:15], 0 offen
	buffer_load_u8 v188, v161, s[12:15], 0 offen
	buffer_load_u8 v142, v142, s[12:15], 0 offen
	buffer_load_u8 v189, v160, s[12:15], 0 offen
	.loc	1 739 30                        ; ragged.py:739:30
	s_clause 0x2
	buffer_load_u8 v132, v137, s[4:7], 0 offen
	buffer_load_u8 v134, v135, s[4:7], 0 offen
	buffer_load_u8 v135, v131, s[4:7], 0 offen
	s_waitcnt vmcnt(27)
	v_lshlrev_b16 v131.l, 8, v146.l
	.loc	1 740 30                        ; ragged.py:740:30
	v_add_nc_u32_e32 v141, 0, v100
	.loc	1 739 30                        ; ragged.py:739:30
	v_add_nc_u32_e32 v136, 0, v99
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	v_lshlrev_b16 v131.h, 8, v132.l
	s_waitcnt vmcnt(1)
	v_or_b16 v132.h, v134.l, v131.l
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_2)
	v_or_b16 v132.l, v135.l, v131.h
	ds_store_b64 v102, v[132:133]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[143:144], v103
	ds_load_b64 v[147:148], v104
	ds_load_b64 v[149:150], v105
	ds_load_b64 v[145:146], v106
	ds_load_b64 v[151:152], v107
	ds_load_b64 v[153:154], v108
	ds_load_b64 v[155:156], v109
	ds_load_b64 v[157:158], v110
	ds_load_b64 v[159:160], v111
	ds_load_b64 v[161:162], v112
	ds_load_b64 v[163:164], v113
	ds_load_b64 v[165:166], v114
	ds_load_2addr_stride64_b64 v[131:134], v136 offset1:1
	ds_load_2addr_stride64_b64 v[135:138], v136 offset0:2 offset1:3
	.loc	1 740 30                        ; ragged.py:740:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b64 v141, v[139:140]
	v_lshlrev_b16 v139.l, 8, v167.l
	v_lshlrev_b16 v139.h, 8, v168.l
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_or_b16 v141.h, v169.l, v139.l
	v_lshlrev_b16 v139.l, 8, v171.l
	v_or_b16 v141.l, v170.l, v139.h
	v_lshlrev_b16 v139.h, 8, v176.l
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_or_b16 v140.h, v172.l, v139.l
	v_lshlrev_b16 v139.l, 8, v173.l
	v_or_b16 v168.l, v178.l, v139.h
	v_lshlrev_b16 v139.h, 8, v184.l
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_or_b16 v140.l, v174.l, v139.l
	v_lshlrev_b16 v139.l, 8, v175.l
	v_or_b16 v170.l, v186.l, v139.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_or_b16 v168.h, v177.l, v139.l
	v_lshlrev_b16 v139.l, 8, v179.l
	v_or_b16 v167.h, v180.l, v139.l
	v_lshlrev_b16 v139.l, 8, v181.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_or_b16 v167.l, v182.l, v139.l
	v_lshlrev_b16 v139.l, 8, v183.l
	v_or_b16 v170.h, v185.l, v139.l
	v_lshlrev_b16 v139.l, 8, v187.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_or_b16 v169.h, v188.l, v139.l
	v_lshlrev_b16 v139.l, 8, v142.l
	v_or_b16 v169.l, v189.l, v139.l
	v_add_nc_u32_e32 v139, 0, v101
	ds_store_b64 v115, v[140:141]
	ds_store_b64 v116, v[167:168]
	ds_store_b64 v117, v[169:170]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[139:142], v139 offset1:8
	.loc	1 741 27                        ; ragged.py:741:27
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[17:24], v[139:140], v[145:146], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[141:142], v[145:146], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[139:140], v[155:156], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[141:142], v[155:156], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[139:140], v[161:162], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[141:142], v[161:162], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[139:140], v[131:132], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[141:142], v[131:132], v[9:16] neg_lo:[1,1,0]
	.loc	1 740 30                        ; ragged.py:740:30
	ds_load_2addr_stride64_b64 v[139:142], v118 offset1:8
	.loc	1 741 27                        ; ragged.py:741:27
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[17:24], v[139:140], v[133:134], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[141:142], v[133:134], v[25:32] neg_lo:[1,1,0]
	.loc	1 740 30                        ; ragged.py:740:30
	ds_load_2addr_stride64_b64 v[131:134], v119 offset1:8
	.loc	1 741 27                        ; ragged.py:741:27
	v_wmma_i32_16x16x16_iu4 v[1:8], v[139:140], v[143:144], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[141:142], v[143:144], v[9:16] neg_lo:[1,1,0]
	.loc	1 740 30                        ; ragged.py:740:30
	ds_load_2addr_stride64_b64 v[143:146], v120 offset1:8
	.loc	1 741 27                        ; ragged.py:741:27
	v_wmma_i32_16x16x16_iu4 v[33:40], v[139:140], v[157:158], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[141:142], v[157:158], v[41:48] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[139:140], v[163:164], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[141:142], v[163:164], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[131:132], v[147:148], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[133:134], v[147:148], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[131:132], v[151:152], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[49:56], v[131:132], v[165:166], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[133:134], v[165:166], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[133:134], v[151:152], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[131:132], v[135:136], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[133:134], v[135:136], v[41:48] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[49:56], v[143:144], v[137:138], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[57:64], v[145:146], v[137:138], v[57:64] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[143:144], v[149:150], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[145:146], v[149:150], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[143:144], v[153:154], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[145:146], v[153:154], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[33:40], v[143:144], v[159:160], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[41:48], v[145:146], v[159:160], v[41:48] neg_lo:[1,1,0]
	.loc	1 729 19                        ; ragged.py:729:19
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_pc_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 190
