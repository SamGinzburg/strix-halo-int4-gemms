...
.Ltmp18:
	...
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mad_u64_u32 v[33:34], null, s29, v14, v[1:2]
	s_lshl_b32 s1, s3, 6
	.loc	1 221 36                        ; generate_amdgcn.py:221:36
	v_or_b32_e32 v8, 52, v3
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mad_u64_u32 v[34:35], null, s29, v13, v[1:2]
	v_readfirstlane_b32 s0, v38
	.loc	1 221 36                        ; generate_amdgcn.py:221:36
	v_or_b32_e32 v7, 60, v3
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_mad_u64_u32 v[35:36], null, s29, v12, v[1:2]
	v_or_b32_e32 v65, s1, v60
	v_mad_u64_u32 v[36:37], null, s29, v11, v[1:2]
	v_mad_u64_u32 v[37:38], null, s29, v10, v[1:2]
	v_and_b32_e32 v18, 56, v18
	v_lshl_or_b32 v19, v17, 6, v19
	v_xor_b32_e32 v64, v0, v4
	v_mad_u64_u32 v[38:39], null, s29, v9, v[1:2]
	s_mul_f32 s0, s0, 0x4f7ffffe
	v_mad_u64_u32 v[39:40], null, s29, v8, v[1:2]
	v_mad_u64_u32 v[40:41], null, s29, v7, v[1:2]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_persistent_bm64_bn128_bk128_gm4_w16_s1_weu2_sk8_evenk.numbered_sgpr, 55
