...
.Ltmp0:
	...
	.loc	1 514 23                        ; attention_backward.py:514:23
	v_or_b32_e32 v235, s38, v46
	v_or_b32_e32 v237, s38, v47
	v_or_b32_e32 v246, s38, v48
	v_or_b32_e32 v247, s38, v49
	v_or_b32_e32 v248, s38, v50
	v_or_b32_e32 v249, s38, v51
	v_or_b32_e32 v234, s38, v52
	v_lshlrev_b32_e32 v252, 2, v65
	s_lshl_b32 s63, s3, 12
	v_dual_mov_b32 v27, v41 :: v_dual_and_b32 v64, 0x820, v64
	v_dual_mov_b32 v23, v41 :: v_dual_add_nc_u32 v240, 0, v71
	.loc	1 520 26                        ; attention_backward.py:520:26
	...
	v_xor_b32_e32 v84, 16, v250
	v_xor_b32_e32 v85, 32, v250
	v_xor_b32_e32 v86, 48, v250
	.loc	1 600 19                        ; attention_backward.py:600:19
	v_readfirstlane_b32 s7, v94
	...
	v_add_nc_u32_e32 v244, 0, v75
	v_add_nc_u32_e32 v245, 0, v76
	v_add_nc_u32_e32 v241, 0, v77
	v_add_nc_u32_e32 v251, 0, v78
	v_add_nc_u32_e32 v158, 0, v79
	...
	s_and_b32 s52, s10, 0x7fffffe0
	.loc	1 598 24                        ; attention_backward.py:598:24
	s_min_u32 s75, s7, 0x800
	v_mov_b32_e32 v2, v41
	v_mov_b32_e32 v4, v41
	.loc	1 620 52                        ; attention_backward.py:620:52
	v_cmp_gt_i32_e64 s5, s57, v97
	v_add_nc_u32_e32 v253, 0, v80
	...
	v_add_nc_u32_e32 v236, 0, v91
	v_add_nc_u32_e32 v89, 0, v92
	s_cmp_lt_u32 s52, s75
	s_mov_b32 s8, 0
	s_mov_b32 s64, s50
	...
	scratch_store_b32 off, v157, off offset:328
	scratch_store_b32 off, v244, off offset:332
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	s_add_i32 s6, s78, s77
	s_waitcnt vmcnt(8)
	v_or_b32_e32 v36, s77, v100
	...
	v_dual_mov_b32 v243, v236 :: v_dual_add_nc_u32 v40, 0, v102
	.loc	1 732 34                        ; attention_backward.py:732:34
	s_waitcnt vmcnt(7)
	...
	ds_store_b128 v37, v[33:36]
	ds_store_b128 v37, v[56:59] offset:4096
	ds_store_b128 v236, v[43:46]
	ds_store_b128 v236, v[61:64] offset:4096
	ds_store_b128 v89, v[47:50]
	ds_store_b128 v89, v[65:68] offset:4096
	...
	v_dual_mov_b32 v252, v253 :: v_dual_mov_b32 v253, v158
	v_dual_mov_b32 v158, v251 :: v_dual_mov_b32 v251, v240
	.loc	1 615 36                        ; attention_backward.py:615:36
	s_waitcnt lgkmcnt(5)
	...
	v_cmp_le_i32_e64 s20, v168, v33
	v_cmp_le_i32_e64 s19, v235, v33
	v_cmp_le_i32_e64 s17, v237, v33
	v_cmp_le_i32_e64 s15, v246, v33
	v_cmp_le_i32_e64 s13, v247, v33
	v_cmp_le_i32_e64 s11, v248, v33
	v_cmp_le_i32_e64 s9, v249, v33
	v_cmp_le_i32_e64 s7, v234, v33
	...
	.loc	1 678 30                        ; attention_backward.py:678:30
	v_cmp_ge_i32_e32 vcc_lo, v234, v34
	...
	v_dual_mov_b32 v234, v249 :: v_dual_mov_b32 v249, v247
	v_mov_b32_e32 v247, v237
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 720 30                        ; attention_backward.py:720:30
	v_mul_f32_e32 v33, v159, v83
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b128 v240, v[42:45]
	ds_store_b128 v240, v[46:49] offset:16
	.loc	1 648 33                        ; attention_backward.py:648:33
	...
	.loc	1 658 25                        ; attention_backward.py:658:25
	v_dual_mul_f32 v49, v161, v49 :: v_dual_cndmask_b32 v50, v52, v50
	.loc	1 651 60                        ; attention_backward.py:651:60
	...
	v_cndmask_b16 v49.h, 0x7fff, v33.h, vcc_lo
	ds_store_b128 v240, v[42:45] offset:32
	ds_store_b128 v240, v[46:49] offset:48
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_dual_sub_f32 v44, v151, v70 :: v_dual_sub_f32 v47, v141, v153
	v_sub_f32_e32 v45, v145, v71
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 732 34 is_stmt 0              ; attention_backward.py:732:34
	v_bfe_u32 v50, v42, 16, 1
	v_cmp_o_f32_e64 s7, v42, v42
	v_dual_mov_b32 v71, v190 :: v_dual_sub_f32 v46, v147, v72
	v_mov_b32_e32 v160, v241
	v_add3_u32 v50, v42, v50, 0x7fff
	v_bfe_u32 v42, v140, 16, 1
	v_dual_mov_b32 v241, v244 :: v_dual_sub_f32 v48, v143, v154
	...
	scratch_load_b32 v157, off, off offset:328
	...
	v_cmp_o_f32_e64 s7, v42, v42
	.loc	1 732 35                        ; attention_backward.py:732:35
	v_dual_sub_f32 v46, v111, v172 :: v_dual_sub_f32 v47, v105, v66
	v_sub_f32_e32 v48, v107, v67
	.loc	1 732 34                        ; attention_backward.py:732:34
	v_add3_u32 v50, v42, v50, 0x7fff
	v_bfe_u32 v42, v112, 16, 1
	v_bfe_u32 v49, v33, 16, 1
	v_dual_mov_b32 v235, v246 :: v_dual_mov_b32 v246, v248
	v_mov_b32_e32 v248, v250
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_add3_u32 v51, v112, v42, 0x7fff
	v_bfe_u32 v42, v43, 16, 1
	v_mov_b32_e32 v250, v240
	v_dual_mov_b32 v240, v251 :: v_dual_mov_b32 v251, v158
	...
	v_dual_mov_b32 v168, v237 :: v_dual_mov_b32 v237, v247
	v_mov_b32_e32 v247, v249
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_cndmask_b16 v34.h, 0x7fff, v46.h, s8
	v_mov_b32_e32 v249, v234
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_bwd_dkv_int4xbf16_none_local_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 79
	...
	.set amd_strix_halo_gfx1151_attention_bwd_dkv_int4xbf16_none_local_outbfloat16_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 452
