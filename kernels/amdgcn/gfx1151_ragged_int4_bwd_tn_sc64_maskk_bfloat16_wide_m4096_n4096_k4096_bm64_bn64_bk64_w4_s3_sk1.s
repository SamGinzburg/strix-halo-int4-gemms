	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 1000 17                       ; ragged.py:1000:17
	s_xor_b32 s39, s6, s38
	.loc	1 1007 19                       ; ragged.py:1007:19
	s_lshl_b64 s[8:9], s[24:25], 2
	.loc	1 1000 17                       ; ragged.py:1000:17
	s_sub_i32 s6, s39, s38
...
; %bb.4:                                ; %.lr.ph14
	...
	s_add_i32 s28, s25, s35
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v74, 0 :: v_dual_add_nc_u32 v3, s28, v51
	s_mov_b32 s20, s8
	s_mov_b32 s8, s10
	s_sub_i32 s10, s38, s27
	v_dual_mov_b32 v75, 0 :: v_dual_add_nc_u32 v6, s28, v52
	v_mul_lo_u32 v83, v3, s37
	v_mul_lo_u32 v3, s18, v1
	s_sub_i32 s10, s10, s39
	...
	v_dual_mov_b32 v72, 0 :: v_dual_add_nc_u32 v81, 0, v51
	v_or_b32_e32 v85, 36, v76
	v_or_b32_e32 v86, 38, v76
	v_or_b32_e32 v87, 40, v76
	v_or_b32_e32 v88, 42, v76
	v_or_b32_e32 v89, 44, v76
	v_or_b32_e32 v90, 46, v76
	v_dual_mov_b32 v70, 0 :: v_dual_add_nc_u32 v91, s3, v62
	.loc	1 1115 19                       ; ragged.py:1115:19
	v_subrev_nc_u32_e32 v93, s2, v3
	v_dual_mov_b32 v73, 0 :: v_dual_add_nc_u32 v94, 0, v2
	...
	s_mov_b32 s35, 0
	.loc	1 1115 19                       ; ragged.py:1115:19
	s_lshr_b32 s37, s36, 5
	s_lshl_b32 s38, s19, 5
	s_lshl_b32 s39, s18, 5
	s_mov_b32 s24, s12
	s_mov_b32 s25, s13
	s_mov_b32 s26, s22
	s_mov_b32 s27, s23
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_or_b32_e32 v35, 2, v76
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_add_i32 s2, s35, s33
	.loc	1 1206 40                       ; ragged.py:1206:40
	v_add_lshl_u32 v34, v84, s35, 1
	v_or_b32_e32 v36, 4, v76
	v_or_b32_e32 v38, 6, v76
	.loc	1 1214 25                       ; ragged.py:1214:25
	s_mul_i32 s2, s2, s19
	v_or_b32_e32 v39, 8, v76
	v_or_b32_e32 v40, 10, v76
	v_or_b32_e32 v95, 12, v76
	v_or_b32_e32 v96, 14, v76
	v_or_b32_e32 v97, 34, v76
	.loc	1 1206 40                       ; ragged.py:1206:40
	v_cndmask_b32_e64 v33, 0x80000000, v33, s6
	.loc	1 1213 40                       ; ragged.py:1213:40
	v_add_lshl_u32 v37, v76, s2, 1
	...
	v_dual_mul_f32 v13, v34, v13 :: v_dual_fmac_f32 v74, v29, v39
	v_dual_mul_f32 v2, v34, v2 :: v_dual_fmac_f32 v79, v25, v37
	v_dual_mul_f32 v1, v34, v1 :: v_dual_fmac_f32 v72, v31, v95
	v_dual_mul_f32 v4, v34, v4 :: v_dual_fmac_f32 v75, v28, v38
	v_dual_mul_f32 v6, v34, v6 :: v_dual_fmac_f32 v71, v32, v96
	v_dual_mul_f32 v5, v34, v5 :: v_dual_fmac_f32 v70, v17, v98
	v_dual_mul_f32 v8, v34, v8 :: v_dual_fmac_f32 v63, v24, v102
	v_dual_mul_f32 v7, v34, v7 :: v_dual_fmac_f32 v66, v21, v104
	...
	v_dual_fmac_f32 v69, v18, v97 :: v_dual_fmac_f32 v64, v23, v103
	v_dual_fmac_f32 v65, v22, v101 :: v_dual_fmac_f32 v58, v11, v36
	v_dual_fmac_f32 v60, v9, v37 :: v_dual_fmac_f32 v61, v10, v35
	v_dual_fmac_f32 v59, v12, v38 :: v_dual_fmac_f32 v56, v14, v40
	v_dual_fmac_f32 v55, v13, v39 :: v_dual_fmac_f32 v54, v16, v96
	v_dual_fmac_f32 v53, v15, v95 :: v_dual_fmac_f32 v50, v2, v97
	v_dual_fmac_f32 v49, v1, v98 :: v_dual_fmac_f32 v48, v4, v100
	v_dual_fmac_f32 v47, v3, v99 :: v_dual_fmac_f32 v46, v6, v101
	v_dual_fmac_f32 v45, v5, v104 :: v_dual_fmac_f32 v44, v7, v103
	v_fmac_f32_e32 v43, v8, v102
	.loc	1 1115 19                       ; ragged.py:1115:19
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 216
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_tn_sc64_maskk_bfloat16_wide_m4096_n4096_k4096_bm64_bn64_bk64_w4_s3_sk1.kd
