...
; %bb.1:                                ; %.lr.ph
	...
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[42:43], null, s18, s23, v[41:42]
	...
	v_mul_lo_u32 v150, v17, s22
	v_mul_lo_u32 v151, v18, s22
	...
	v_mul_lo_u32 v153, v18, s22
	v_mul_lo_u32 v154, v19, s22
	v_mul_lo_u32 v155, v20, s22
	v_mul_lo_u32 v156, v11, s22
	v_mad_u64_u32 v[68:69], null, s30, 31, v[42:43]
	.loc	1 720 20                        ; ragged.py:720:20
	s_and_b32 s0, s0, s11
	.loc	1 721 20                        ; ragged.py:721:20
	v_cmp_gt_i32_e64 s11, s30, v41
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v9, s23, v42
	v_or_b32_e32 v3, s22, v3
	v_add_nc_u32_e32 v28, s23, v61
	v_add_nc_u32_e32 v4, s23, v4
	v_add_nc_u32_e32 v29, s23, v62
	v_add_nc_u32_e32 v5, s23, v5
	v_add_nc_u32_e32 v10, s23, v43
	v_add_nc_u32_e32 v30, s23, v63
	v_add_nc_u32_e32 v31, s23, v64
	v_add_nc_u32_e32 v6, s23, v6
	v_add_nc_u32_e32 v11, s23, v44
	v_add_nc_u32_e32 v12, s23, v45
	v_add_nc_u32_e32 v13, s23, v46
	v_add_nc_u32_e32 v14, s23, v47
	v_add_nc_u32_e32 v15, s23, v48
	v_add_nc_u32_e32 v32, s23, v65
	v_add_nc_u32_e32 v33, s23, v66
	v_add_nc_u32_e32 v34, s23, v67
	v_add_nc_u32_e32 v35, s23, v68
	...
	v_add_nc_u32_e32 v16, s23, v49
	v_add_nc_u32_e32 v17, s23, v50
	v_add_nc_u32_e32 v18, s23, v51
	v_add_nc_u32_e32 v19, s23, v52
	v_add_nc_u32_e32 v20, s23, v53
	v_add_nc_u32_e32 v21, s23, v54
	v_add_nc_u32_e32 v22, s23, v55
	v_add_nc_u32_e32 v23, s23, v56
	v_add_nc_u32_e32 v24, s23, v57
	v_add_nc_u32_e32 v25, s23, v58
	v_add_nc_u32_e32 v26, s23, v59
	v_add_nc_u32_e32 v27, s23, v60
	...
	v_cndmask_b32_e64 v30, 0x80000000, v30, s11
	v_cndmask_b32_e64 v31, 0x80000000, v31, s11
	...
	v_cndmask_b32_e64 v32, 0x80000000, v32, s11
	v_cndmask_b32_e64 v33, 0x80000000, v33, s11
	...
	s_clause 0x8
	buffer_load_u8 v71, v9, s[16:19], 0 offen
	buffer_load_u8 v72, v28, s[16:19], 0 offen
	buffer_load_u8 v73, v29, s[16:19], 0 offen
	buffer_load_u8 v74, v30, s[16:19], 0 offen
	buffer_load_u8 v75, v31, s[16:19], 0 offen
	buffer_load_u8 v76, v32, s[16:19], 0 offen
	buffer_load_u8 v172, v33, s[16:19], 0 offen
	buffer_load_u8 v173, v34, s[16:19], 0 offen
	buffer_load_u8 v174, v35, s[16:19], 0 offen
	v_cndmask_b32_e64 v9, 0x80000000, v36, s0
	v_cndmask_b32_e64 v3, 0x80000000, v3, s10
	v_cndmask_b32_e64 v16, 0x80000000, v16, s11
	v_cndmask_b32_e64 v17, 0x80000000, v17, s11
	...
	v_cndmask_b32_e64 v28, 0x80000000, v37, s1
	v_cndmask_b32_e64 v29, 0x80000000, v38, s5
	v_cndmask_b32_e64 v30, 0x80000000, v39, s6
	v_cndmask_b32_e64 v31, 0x80000000, v40, s7
	v_cndmask_b32_e64 v32, 0x80000000, v69, s8
	v_cndmask_b32_e64 v33, 0x80000000, v70, s9
	s_clause 0x16
	buffer_load_u8 v4, v4, s[16:19], 0 offen
	buffer_load_u8 v5, v5, s[16:19], 0 offen
	buffer_load_u8 v69, v10, s[16:19], 0 offen
	buffer_load_u8 v6, v6, s[16:19], 0 offen
	buffer_load_u8 v70, v11, s[16:19], 0 offen
	buffer_load_u8 v175, v12, s[16:19], 0 offen
	buffer_load_u8 v176, v13, s[16:19], 0 offen
	buffer_load_u8 v7, v7, s[16:19], 0 offen
	buffer_load_u8 v177, v14, s[16:19], 0 offen
	buffer_load_u8 v178, v15, s[16:19], 0 offen
	buffer_load_u8 v179, v16, s[16:19], 0 offen
	buffer_load_u8 v180, v17, s[16:19], 0 offen
	buffer_load_u8 v181, v18, s[16:19], 0 offen
	buffer_load_u8 v182, v19, s[16:19], 0 offen
	buffer_load_u8 v183, v20, s[16:19], 0 offen
	buffer_load_u8 v8, v8, s[16:19], 0 offen
	buffer_load_u8 v184, v21, s[16:19], 0 offen
	buffer_load_u8 v185, v22, s[16:19], 0 offen
	buffer_load_u8 v186, v23, s[16:19], 0 offen
	buffer_load_u8 v187, v24, s[16:19], 0 offen
	buffer_load_u8 v188, v25, s[16:19], 0 offen
	buffer_load_u8 v189, v26, s[16:19], 0 offen
	buffer_load_u8 v190, v27, s[16:19], 0 offen
	.loc	1 783 34                        ; ragged.py:783:34
	s_clause 0x7
	buffer_load_u8 v9, v9, s[12:15], 0 offen
	buffer_load_u8 v10, v29, s[12:15], 0 offen
	buffer_load_u8 v11, v31, s[12:15], 0 offen
	buffer_load_u8 v12, v33, s[12:15], 0 offen
	buffer_load_u8 v3, v3, s[12:15], 0 offen
	buffer_load_u8 v13, v32, s[12:15], 0 offen
	buffer_load_u8 v14, v30, s[12:15], 0 offen
	buffer_load_u8 v15, v28, s[12:15], 0 offen
	...
	s_waitcnt vmcnt(4)
	ds_store_b8 v1, v12 offset:1536
	s_waitcnt vmcnt(0)
	ds_store_b8 v157, v15
	ds_store_b8 v157, v14 offset:512
	ds_store_b8 v157, v13 offset:1024
	...
	ds_store_b8 v161, v70 offset:1280
	ds_store_b8 v161, v175 offset:1536
	ds_store_b8 v161, v7 offset:2048
	ds_store_b8 v161, v177 offset:2304
	ds_store_b8 v161, v178 offset:2560
	ds_store_b8 v161, v180 offset:3072
	ds_store_b8 v161, v181 offset:3328
	ds_store_b8 v161, v182 offset:3584
	ds_store_b8 v161, v8 offset:4096
	ds_store_b8 v161, v184 offset:4352
	ds_store_b8 v161, v185 offset:4608
	ds_store_b8 v161, v187 offset:5120
	ds_store_b8 v161, v188 offset:5376
	ds_store_b8 v161, v189 offset:5632
	ds_store_b8 v161, v72 offset:6144
	ds_store_b8 v161, v73 offset:6400
	ds_store_b8 v161, v74 offset:6656
	ds_store_b8 v161, v76 offset:7168
	ds_store_b8 v161, v172 offset:7424
	ds_store_b8 v161, v173 offset:7680
	ds_store_b8 v162, v69
	ds_store_b8 v163, v176
	ds_store_b8 v164, v179
	ds_store_b8 v165, v183
	ds_store_b8 v166, v186
	ds_store_b8 v167, v190
	ds_store_b8 v168, v75
	ds_store_b8 v169, v174
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 805 40                        ; ragged.py:805:40
	v_add_lshl_u32 v19, v41, s18, 1
	.loc	1 798 40                        ; ragged.py:798:40
	v_add_lshl_u32 v11, s29, v11, 1
	v_add_lshl_u32 v12, s29, v12, 1
	v_add_lshl_u32 v15, s29, v15, 1
	v_add_lshl_u32 v16, s29, v16, 1
	.loc	1 805 40                        ; ragged.py:805:40
	v_cndmask_b32_e64 v19, 0x80000000, v19, s11
	.loc	1 798 40                        ; ragged.py:798:40
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 212
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 48
