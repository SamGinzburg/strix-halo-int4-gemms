	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:154:22 ]
	s_add_i32 s2, s2, s0
	v_dual_mov_b32 v50, 0 :: v_dual_add_nc_u32 v17, 64, v15
...
.Ltmp21:
	...
	v_dual_mov_b32 v42, 0 :: v_dual_and_b32 v53, 2, v3
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_lshl_or_b32 v15, s15, 8, v15
	s_mov_b32 s15, s12
	v_mov_b32_e32 v49, 0
	v_sub_nc_u32_e32 v52, s13, v3
	v_dual_mov_b32 v38, 0 :: v_dual_add_nc_u32 v3, s28, v3
	v_subrev_nc_u32_e32 v54, s16, v15
	s_mov_b32 s16, s12
	.loc	1 100 32                        ; generate_amdgcn.py:100:32
	v_and_b32_e32 v4, 0x70, v35
	v_lshlrev_b32_e32 v2, 4, v2
	v_dual_mov_b32 v44, 0 :: v_dual_add_nc_u32 v19, 32, v18
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_add3_u32 v2, v14, s3, v2
	v_xor_b32_e32 v13, 48, v7
	v_xor_b32_e32 v16, 56, v7
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v62, 0, v7
	...
	v_lshlrev_b32_e32 v56, 1, v17
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v63, 0, v8
	v_mov_b32_e32 v55, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v5, v5, v6
	v_lshlrev_b32_e32 v6, 4, v0
	v_dual_mov_b32 v34, 0 :: v_dual_lshlrev_b32 v57, 1, v18
	v_dual_mov_b32 v41, 0 :: v_dual_add_nc_u32 v64, 0, v9
	v_dual_mov_b32 v45, 0 :: v_dual_add_nc_u32 v60, 0, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v40, 0 :: v_dual_add_nc_u32 v61, 0, v6
	v_mov_b32_e32 v1, s12
	v_add_nc_u32_e32 v65, 0, v10
	v_dual_mov_b32 v39, 0 :: v_dual_add_nc_u32 v66, 0, v11
	v_add_nc_u32_e32 v67, 0, v12
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v68, 0, v13
	v_dual_mov_b32 v2, s13 :: v_dual_add_nc_u32 v69, 0, v16
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x1
	buffer_load_u16 v70, v57, s[24:27], 0 offen
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	buffer_load_b64 v[13:14], v13, s[12:15], 0 offen
	.loc	1 171 26                        ; generate_amdgcn.py:171:26
	s_and_b32 s3, s3, s1
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	buffer_load_b64 v[30:31], v15, s[12:15], 0 offen
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(2)
	...
	s_barrier
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	buffer_load_b128 v[25:28], v16, s[16:19], 0 offen
	...
	ds_load_u8 v22, v48 offset:1408
	ds_load_u8 v23, v48 offset:1024
	ds_load_u8 v24, v48 offset:1280
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v62 offset0:16 offset1:20
	ds_load_2addr_stride64_b64 v[76:79], v63 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v84, v48 offset:2688
	ds_load_u8 v85, v48 offset:2944
	ds_load_u8 v86, v48 offset:2816
	ds_load_u8 v87, v48 offset:2560
	ds_load_u8 v88, v48 offset:2176
	ds_load_u8 v89, v48 offset:2432
	ds_load_u8 v90, v48 offset:2304
	ds_load_u8 v91, v48 offset:2048
	...
	v_lshl_or_b32 v82, v16, 16, v15
	s_waitcnt lgkmcnt(9)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[80:81], v[74:75], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[80:81], v[72:73], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(8)
	s_delay_alu instid0(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[82:83], v[78:79], v[9:16] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v64 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v78, v48 offset:3712
	ds_load_u8 v79, v48 offset:3968
	ds_load_u8 v80, v48 offset:3840
	ds_load_u8 v81, v48 offset:3584
	v_wmma_i32_16x16x16_iu4 v[17:24], v[82:83], v[76:77], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v76, v87, v84, 0xc0c0004
	v_perm_b32 v77, v86, v85, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v84, v91, v88, 0xc0c0004
	v_perm_b32 v86, v90, v89, 0xc0c0004
	ds_load_u8 v82, v48 offset:3200
	ds_load_u8 v83, v48 offset:3456
	v_lshl_or_b32 v77, v77, 16, v76
	v_lshl_or_b32 v76, v86, 16, v84
	s_waitcnt lgkmcnt(6)
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v65 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v84, v48 offset:4736
	ds_load_u8 v86, v48 offset:4992
	ds_load_u8 v88, v48 offset:4864
	ds_load_u8 v89, v48 offset:4608
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v77, v80, v79, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v76, v81, v78, 0xc0c0004
	ds_load_u8 v78, v48 offset:4224
	ds_load_u8 v79, v48 offset:4480
	ds_load_u8 v81, v48 offset:4096
	ds_load_u8 v87, v48 offset:3328
	ds_load_u8 v85, v48 offset:3072
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v66 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v80, v48 offset:5760
	ds_load_u8 v82, v48 offset:6016
	ds_load_u8 v85, v48 offset:5888
	ds_load_u8 v87, v48 offset:5632
	v_perm_b32 v76, v89, v84, 0xc0c0004
	ds_load_u8 v84, v48 offset:5248
	v_perm_b32 v77, v88, v86, 0xc0c0004
	ds_load_u8 v86, v48 offset:5504
	ds_load_u8 v88, v48 offset:6784
	ds_load_u8 v81, v48 offset:5120
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v83, v79, 0xc0c0004
	ds_load_u8 v83, v48 offset:5376
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v67 offset0:16 offset1:20
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v89, v48 offset:7040
	ds_load_u8 v90, v48 offset:6912
	ds_load_u8 v91, v48 offset:6656
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v76, v87, v80, 0xc0c0004
	ds_load_u8 v80, v48 offset:6272
	v_perm_b32 v77, v85, v82, 0xc0c0004
	ds_load_u8 v82, v48 offset:6528
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v78, v81, v84, 0xc0c0004
	ds_load_u8 v81, v48 offset:6400
	ds_load_u8 v84, v48 offset:7808
	ds_load_u8 v85, v48 offset:8064
	v_lshl_or_b32 v77, v77, 16, v76
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v79, v83, v86, 0xc0c0004
	ds_load_u8 v83, v48 offset:6144
	v_lshl_or_b32 v76, v79, 16, v78
	s_waitcnt lgkmcnt(9)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[17:24], v[76:77], v[72:73], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[74:75], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v86, v48 offset:7936
	ds_load_u8 v87, v48 offset:7680
	ds_load_u8 v92, v48 offset:7296
	ds_load_u8 v93, v48 offset:7168
	ds_load_u8 v94, v48 offset:7552
	ds_load_u8 v95, v48 offset:7424
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_2addr_stride64_b64 v[72:75], v68 offset0:16 offset1:20
	ds_load_2addr_stride64_b64 v[76:79], v69 offset0:16 offset1:20
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b64 v60, v[30:31] offset:8192
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_perm_b32 v30, v91, v88, 0xc0c0004
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_wmma_i32_16x16x16_iu4 v[17:24], v[30:31], v[72:73], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[30:31], v[74:75], v[9:16] neg_lo:[1,1,0]
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v61, v[25:28]
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_lshl_or_b32 v26, v83, 16, v82
	v_lshl_or_b32 v25, v86, 16, v84
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	v_wmma_i32_16x16x16_iu4 v[17:24], v[25:26], v[76:77], v[17:24] neg_lo:[1,1,0]
	...
	ds_load_u8 v78, v48 offset:1792
	s_waitcnt lgkmcnt(10)
	...
	ds_load_u8 v79, v48 offset:2944
	s_waitcnt lgkmcnt(5)
	...
	v_perm_b32 v31, v78, v77, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	...
	ds_load_u8 v79, v48 offset:4992
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v73, v71, 0xc0c0004
	ds_load_u8 v73, v48 offset:4096
	ds_load_u8 v70, v48 offset:3584
	v_perm_b32 v31, v75, v78, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v73, v73, v74, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v78, v48 offset:6016
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v72, v71, 0xc0c0004
	...
	ds_load_u8 v79, v48 offset:7040
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v71, v73, v71, 0xc0c0004
	...
	v_perm_b32 v72, v72, v74, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v78, v27, v26, 0xc0c0004
	s_waitcnt lgkmcnt(3)
	...
	v_dual_mul_f32 v20, v92, v20 :: v_dual_add_nc_u32 v85, v53, v54
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_clause 0x7
	buffer_load_u16 v80, v85, s[8:11], 0 offen offset:4
	buffer_load_u16 v81, v85, s[8:11], 0 offen
	buffer_load_u16 v87, v85, s[8:11], 0 offen offset:12
	buffer_load_u16 v88, v85, s[8:11], 0 offen offset:8
	buffer_load_u16 v89, v85, s[8:11], 0 offen offset:20
	buffer_load_u16 v90, v85, s[8:11], 0 offen offset:16
	buffer_load_u16 v91, v85, s[8:11], 0 offen offset:28
	buffer_load_u16 v85, v85, s[8:11], 0 offen offset:24
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v17, v92, v17 :: v_dual_add_nc_u32 v54, s30, v54
	v_dual_mul_f32 v19, v92, v19 :: v_dual_add_nc_u32 v56, 2, v56
	...
	v_dual_mul_f32 v22, v92, v22 :: v_dual_add_nc_u32 v57, 2, v57
	v_dual_mul_f32 v21, v92, v21 :: v_dual_add_nc_u32 v58, s33, v58
	v_dual_mul_f32 v24, v92, v24 :: v_dual_add_nc_u32 v59, s33, v59
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v18, v92, v18 :: v_dual_lshlrev_b32 v25, 16, v80
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(6)
	...
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v50, v19, v28 :: v_dual_lshlrev_b32 v71, 16, v85
	.loc	1 206 20 is_stmt 0              ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v23, v92, v23 :: v_dual_mul_f32 v10, v93, v10
	v_mul_f32_e32 v12, v93, v12
	...
	v_dual_fmac_f32 v49, v20, v27 :: v_dual_fmac_f32 v42, v10, v25
	v_dual_fmac_f32 v46, v21, v31 :: v_dual_fmac_f32 v55, v18, v25
	v_dual_fmac_f32 v44, v23, v71 :: v_dual_fmac_f32 v45, v22, v30
	v_fmac_f32_e32 v40, v12, v27
	v_dual_fmac_f32 v43, v24, v70 :: v_dual_fmac_f32 v34, v13, v31
	v_fmac_f32_e32 v41, v9, v26
	v_dual_fmac_f32 v39, v11, v28 :: v_dual_fmac_f32 v38, v14, v30
	v_dual_fmac_f32 v33, v15, v71 :: v_dual_fmac_f32 v32, v16, v70
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 96
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 34
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     36
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
