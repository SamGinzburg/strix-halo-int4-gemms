...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v5, 6, v110
	...
	v_dual_mov_b32 v24, v25 :: v_dual_and_b32 v9, 0x260, v9
	...
	v_dual_mov_b32 v108, v25 :: v_dual_add_nc_u32 v147, 0, v3
	v_and_b32_e32 v145, 0x5040504, v9
	s_delay_alu instid0(VALU_DEP_4)
	v_and_b32_e32 v146, 0x7060706, v15
	v_add_nc_u32_e32 v149, 0, v5
	v_dual_mov_b32 v5, v25 :: v_dual_add_nc_u32 v150, 0, v7
	v_add_nc_u32_e32 v151, 0, v8
	v_add_nc_u32_e32 v155, 0, v16
	v_dual_mov_b32 v107, v25 :: v_dual_add_nc_u32 v156, 0, v14
	...
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v165, v2, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s63, s62
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v74, s63, v124
	.loc	1 853 32                        ; attention.py:853:32
	s_mul_i32 s4, s1, s61
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v78, s63, v120
	.loc	1 854 32                        ; attention.py:854:32
	v_add_lshl_u32 v84, s4, v105, 1
	v_add_lshl_u32 v85, s4, v112, 1
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v77, s63, v122
	v_or_b32_e32 v75, s63, v118
	v_or_b32_e32 v76, s63, v125
	v_or_b32_e32 v79, s63, v123
	v_or_b32_e32 v80, s63, v121
	v_or_b32_e32 v81, s63, v119
	.loc	1 818 13                        ; attention.py:818:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 69
