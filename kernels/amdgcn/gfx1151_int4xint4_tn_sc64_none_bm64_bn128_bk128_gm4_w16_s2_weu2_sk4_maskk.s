...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v15, 0 :: v_dual_lshlrev_b32 v40, 1, v7
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v56, v45, v57 :: v_dual_lshlrev_b32 v71, 16, v71
	v_dual_mul_f32 v57, v45, v58 :: v_dual_lshlrev_b32 v64, 16, v64
	...
	v_dual_fmac_f32 v16, v60, v70 :: v_dual_fmac_f32 v15, v61, v71
	v_dual_fmac_f32 v14, v45, v64 :: v_dual_add_nc_u32 v39, s45, v39
	.loc	1 161 9 is_stmt 1               ; generate_amdgcn.py:161:9
...
.LBB0_8:
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v36, v36, v30 :: v_dual_and_b32 v49, 1, v0
	v_dual_mul_f32 v39, v39, v30 :: v_dual_lshlrev_b32 v52, 4, v0
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_bfe_i32 v0, v0, 7, 1
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v38, v38, v30 :: v_dual_lshlrev_b32 v49, 6, v49
	...
	v_dual_mul_f32 v41, v41, v30 :: v_dual_lshlrev_b32 v30, 11, v48
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_or3_b32 v9, v30, v51, v9
	.loc	1 99 32                         ; generate_amdgcn.py:99:32
	v_or_b32_e32 v56, 36, v31
	v_or_b32_e32 v57, 28, v31
	v_or_b32_e32 v58, 20, v31
	.loc	1 218 23                        ; generate_amdgcn.py:218:23
	v_mad_u64_u32 v[30:31], null, s35, v31, v[29:30]
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v63, 0, v0
	v_xad_u32 v64, 0x2010, v0, 0
	v_xad_u32 v65, 0x4020, v0, 0
	v_xad_u32 v66, 0x6030, v0, 0
	.loc	1 218 23                        ; generate_amdgcn.py:218:23
	v_mul_lo_u32 v49, s35, v60
	v_mul_lo_u32 v50, s35, v59
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_add_nc_u32_e32 v31, 0, v9
	v_xad_u32 v48, v9, 8, 0
	v_xad_u32 v51, v9, 16, 0
	v_xad_u32 v52, v9, 24, 0
	v_xad_u32 v59, v9, 32, 0
	v_xad_u32 v60, v9, 40, 0
	v_xad_u32 v61, v9, 48, 0
	v_xad_u32 v62, v9, 56, 0
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	v_fma_f32 v7, v7, v32, v23
	v_fma_f32 v11, v37, v11, v18
	v_fma_f32 v43, v6, v13, v24
	v_fma_f32 v44, v8, v33, v22
	v_fma_f32 v13, v38, v13, v17
	v_fma_f32 v32, v39, v32, v16
	v_fma_f32 v33, v40, v33, v15
	v_fma_f32 v45, v1, v42, v21
	v_fma_f32 v36, v41, v42, v14
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_cndmask_b32_e64 v8, v24, v43, s2
	v_cndmask_b32_e64 v12, v22, v44, s2
	v_cndmask_b32_e64 v9, v17, v13, s2
	v_cndmask_b32_e64 v11, v16, v32, s2
	v_cndmask_b32_e64 v13, v15, v33, s2
	...
	ds_store_b64 v59, v[8:9]
	ds_store_b64 v60, v[10:11]
	ds_store_b64 v61, v[12:13]
	ds_store_b64 v62, v[21:22]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[0:3], v63 offset1:16
	ds_load_2addr_b64 v[4:7], v64 offset1:16
	ds_load_2addr_b64 v[8:11], v65 offset1:16
	ds_load_2addr_b64 v[12:15], v66 offset1:16
	...
	v_add_lshl_u32 v22, v29, v58, 2
	v_add_lshl_u32 v23, v30, s4, 2
	v_add_lshl_u32 v24, v29, v57, 2
	v_add_lshl_u32 v25, v30, s5, 2
	v_add_lshl_u32 v26, v29, v56, 2
	...
	buffer_atomic_add_f32 v11, v30, s[20:23], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.num_vgpr, 92
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc64_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk4_maskk.numbered_sgpr, 47
