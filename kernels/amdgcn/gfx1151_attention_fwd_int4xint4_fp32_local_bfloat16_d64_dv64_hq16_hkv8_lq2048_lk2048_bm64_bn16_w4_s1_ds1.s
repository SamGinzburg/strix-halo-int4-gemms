...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_add_i32 s1, s3, s0
	v_lshlrev_b32_e32 v65, 1, v6
	v_and_b32_e32 v67, 0x120, v12
	...
	v_dual_mov_b32 v30, v33 :: v_dual_lshlrev_b32 v15, 7, v0
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v57, s13, v56
	...
	v_cndmask_b32_e64 v72, 0x1054, v13, s12
	v_cndmask_b32_e64 v76, 0x3276, v14, s12
	...
	v_dual_mov_b32 v23, v33 :: v_dual_add_nc_u32 v74, v64, v36
	...
	v_subrev_nc_u32_e32 v76, s14, v41
	...
	v_dual_mul_f32 v107, s16, v35 :: v_dual_add_nc_u32 v90, 0, v90
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s8, v128, v76
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s9, v128, v72
	v_cmp_le_i32_e64 s10, v128, v77
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s16, v126, v71
	v_cmp_ge_i32_e64 s17, v126, v76
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s18, v126, v72
	v_cmp_le_i32_e64 s19, v126, v77
	...
	ds_store_2addr_b64 v74, v[52:53], v[112:113] offset0:64 offset1:96
	.loc	1 966 34                        ; attention.py:966:34
	...
	.loc	1 969 24                        ; attention.py:969:24
	v_dual_max_f32 v52, v110, v110 :: v_dual_add_nc_u32 v137, s50, v85
	.loc	1 1001 25                       ; attention.py:1001:25
...
.Ltmp26:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v41, v40, s35, 0xfedcba98 op_sel:[1,0]
.Ltmp27:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:968:29 ] ]
...
.Ltmp34:
	...
	v_permlanex16_b32 v40, v39, s35, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 52
