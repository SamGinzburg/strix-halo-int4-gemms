...
; %bb.0:
	...
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v37, 1, v0
.Ltmp0:
	...
	v_dual_mov_b32 v6, v8 :: v_dual_lshlrev_b32 v1, 4, v37
...
; %bb.1:                                ; %.lr.ph
	...
	s_ashr_i32 s0, s3, 31
	v_dual_mov_b32 v32, v33 :: v_dual_lshlrev_b32 v7, 7, v0
	s_lshr_b32 s0, s0, 28
	.loc	1 585 26                        ; attention.py:585:26
	...
	s_add_i32 s0, s3, s0
	.loc	1 585 26                        ; attention.py:585:26
	v_cndmask_b32_e64 v45, v36, v48, s1
	v_cndmask_b32_e64 v44, v35, v39, s1
	v_cndmask_b32_e64 v47, v47, v40, s1
	v_cndmask_b32_e64 v49, v48, v36, s1
	v_cndmask_b32_e64 v48, v39, v35, s1
	...
	s_sub_i32 s3, s3, s9
	v_dual_mov_b32 v28, v33 :: v_dual_mov_b32 v9, 0
	v_dual_mov_b32 v29, v33 :: v_dual_add_nc_u32 v66, s13, v65
	.loc	1 585 26                        ; attention.py:585:26
	...
	s_add_i32 s3, s3, s12
	v_cndmask_b32_e64 v37, 0x90, 0, vcc_lo
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v68, 0x700, v7
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mov_b32 v34, v33 :: v_dual_add_nc_u32 v93, 0, v62
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.num_vgpr, 121
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_causal_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 49
