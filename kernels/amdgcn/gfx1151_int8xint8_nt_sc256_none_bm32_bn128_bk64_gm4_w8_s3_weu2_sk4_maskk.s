...
.Ltmp19:
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v3, s30, v48
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v7, s27, v46
	v_or_b32_e32 v8, s27, v9
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v11, s27, v48
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
...
.LBB0_3:                                ; %Flow27
	...
	v_mul_lo_u32 v36, v16, s0
	v_mul_lo_u32 v37, v8, s0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v51, s27, v46
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s19, s19, 24
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v53, s27, v48
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s18, s18, s19
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	s_add_i32 s20, s27, s44
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s31, v51
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s18, s18, 8
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v52, s27, v9
...
; %bb.8:
	...
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v46, s16, v42
	ds_load_b128 v[62:65], v10
	ds_load_b128 v[66:69], v46
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v46, s14, v39
	ds_load_b128 v[70:73], v47 offset:1024
	ds_load_b128 v[74:77], v47
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v2, s16, v45
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v10, s14, v41
	ds_load_b128 v[82:85], v46 offset:1024
	ds_load_b128 v[86:89], v46
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v53, s11 :: v_dual_add_nc_u32 v6, s16, v43
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[78:81], v10
	ds_load_b128 v[90:93], v10 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	ds_load_b128 v[98:101], v54 offset:1024
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[66:69], v[74:77], v[46:53] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[46:53], v[66:69], v[70:73], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(6)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[62:65], v[86:89], v[54:61] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[46:53], v[62:65], v[82:85], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[6:9], v[78:81], v[54:61] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[46:53], v[6:9], v[90:93], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[2:5], v[94:97], v[54:61] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[2:5], v[98:101], v[46:53] neg_lo:[1,1,0]
...
; %bb.10:
	...
	s_mov_b32 s11, s4
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v1, s34, v44
	v_add_nc_u32_e32 v42, s34, v42
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v38, s1, v38
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v44, s34, v45
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[54:61], v[78:81], v[86:89], v[38:45] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[38:45], v[62:65], v[102:105], v[38:45] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
.LBB0_11:
	...
	v_bfe_i32 v0, v0, 0, 1
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v81, v38, v43 :: v_dual_and_b32 v12, 0x380, v12
	v_dual_mul_f32 v82, v38, v44 :: v_dual_and_b32 v71, 0x440, v71
	v_mul_f32_e32 v77, v38, v39
	v_mul_f32_e32 v78, v38, v40
	v_dual_mul_f32 v79, v38, v41 :: v_dual_and_b32 v74, 0x3f8, v74
	v_mul_f32_e32 v83, v38, v45
	v_mul_f32_e32 v80, v38, v42
	v_dual_mul_f32 v84, v38, v69 :: v_dual_lshlrev_b32 v75, 6, v75
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_or3_b32 v12, v12, v76, v53
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v45, v38, v45
	v_mul_f32_e32 v38, v38, v69
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v52, v77, v52, v20
	v_fma_f32 v51, v78, v51, v27
	v_fma_f32 v50, v79, v50, v26
	v_fma_f32 v49, v80, v49, v25
	v_fma_f32 v48, v81, v48, v24
	v_fma_f32 v47, v82, v47, v23
	v_fma_f32 v10, v84, v10, v21
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshlrev_b32_e32 v53, 2, v70
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v22, v22, v46, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v40, v8, v18
	v_fma_f32 v4, v43, v4, v15
	v_fma_f32 v6, v38, v6, v11
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v46, 0, v12
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v2, v45, v2, v13
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v38, 0, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v41, v7, v17
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v20, v20, v52, s3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v9, v39, v9, v19
	v_fma_f32 v3, v44, v3, v14
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	v_xad_u32 v47, 0x808, v12, 0
	v_xad_u32 v48, 0x1010, v12, 0
	v_xad_u32 v49, 0x1818, v12, 0
	v_xad_u32 v50, 0x2020, v12, 0
	v_xad_u32 v51, 0x2828, v12, 0
	v_xad_u32 v52, 0x3030, v12, 0
	v_xad_u32 v72, 0x3838, v12, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v12, v18, v8, s3
	v_cndmask_b32_e64 v8, v15, v4, s3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v5, v42, v5, v16
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v42, v0, 32, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v0, v11, v6, s3
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_dual_mul_f32 v33, v4, v17 :: v_dual_lshlrev_b32 v14, 16, v31
	v_dual_mul_f32 v31, v4, v15 :: v_dual_lshlrev_b32 v16, 16, v32
	v_mul_f32_e32 v29, v4, v13
	v_mul_f32_e32 v19, v4, v10
	v_mul_f32_e32 v10, v6, v10
	v_dual_mul_f32 v30, v4, v14 :: v_dual_mul_f32 v15, v6, v15
	v_dual_mul_f32 v13, v6, v13 :: v_dual_mul_f32 v32, v4, v16
	...
	v_fma_f32 v19, v29, v55, v3
	v_fma_f32 v29, v31, v57, v5
	v_fma_f32 v31, v33, v59, v12
	v_fma_f32 v33, v10, v61, v21
	v_fma_f32 v18, v28, v54, v2
	v_fma_f32 v11, v11, v62, v22
	v_fma_f32 v28, v30, v56, v8
	v_fma_f32 v13, v13, v63, v23
	v_fma_f32 v30, v32, v58, v7
	v_fma_f32 v34, v14, v64, v24
	v_fma_f32 v32, v4, v60, v9
	v_fma_f32 v15, v15, v65, v25
	v_fma_f32 v16, v16, v66, v26
	v_fma_f32 v17, v17, v67, v27
	v_fma_f32 v35, v6, v68, v20
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v0, v0, v1, s2
	v_cndmask_b32_e64 v1, v21, v33, s2
	v_cndmask_b32_e64 v2, v2, v18, s2
	v_cndmask_b32_e64 v4, v3, v19, s2
	v_cndmask_b32_e64 v3, v22, v11, s2
	...
	v_cndmask_b32_e64 v7, v24, v34, s2
	...
	v_cndmask_b32_e64 v15, v20, v35, s2
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
