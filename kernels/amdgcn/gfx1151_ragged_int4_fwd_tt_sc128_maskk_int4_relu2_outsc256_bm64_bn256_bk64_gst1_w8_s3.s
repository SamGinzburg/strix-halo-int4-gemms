...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v195, v123, s14, 1
	.loc	1 1204 40                       ; ragged.py:1204:40
	...
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v195, v196, v99 :: v_dual_mul_f32 v18, v18, v100
	.loc	1 1216 21                       ; ragged.py:1216:21
	...
	v_dual_mul_f32 v201, v202, v99 :: v_dual_mul_f32 v24, v24, v100
	...
	v_dual_mul_f32 v205, v206, v99 :: v_dual_mul_f32 v28, v28, v100
	...
	v_dual_mul_f32 v209, v210, v99 :: v_dual_mul_f32 v32, v32, v100
	v_dual_mul_f32 v99, v211, v99 :: v_dual_mul_f32 v34, v34, v193
	v_dual_mul_f32 v29, v29, v100 :: v_dual_mul_f32 v36, v36, v193
	v_dual_mul_f32 v31, v31, v100 :: v_dual_mul_f32 v38, v38, v193
	...
	v_dual_mul_f32 v40, v40, v193 :: v_dual_mul_f32 v49, v49, v194
	v_dual_mul_f32 v41, v41, v193 :: v_dual_mul_f32 v58, v58, v194
	v_dual_mul_f32 v42, v42, v193 :: v_dual_mul_f32 v51, v51, v194
	v_dual_mul_f32 v43, v43, v193 :: v_dual_mul_f32 v60, v60, v194
	v_dual_mul_f32 v44, v44, v193 :: v_dual_mul_f32 v53, v53, v194
	v_dual_mul_f32 v45, v45, v193 :: v_dual_mul_f32 v62, v62, v194
	v_dual_mul_f32 v46, v46, v193 :: v_dual_mul_f32 v55, v55, v194
	...
	v_dual_mul_f32 v61, v61, v194 :: v_dual_fmac_f32 v192, v195, v1
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v63, v63, v194 :: v_dual_fmac_f32 v186, v201, v7
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v191, v196, v2 :: v_dual_fmac_f32 v188, v199, v5
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v189, v198, v4 :: v_dual_fmac_f32 v184, v203, v9
	v_dual_fmac_f32 v187, v200, v6 :: v_dual_fmac_f32 v178, v205, v11
	v_dual_fmac_f32 v185, v202, v8 :: v_dual_fmac_f32 v180, v204, v10
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v176, v206, v12 :: v_dual_fmac_f32 v143, v31, v15
	v_dual_fmac_f32 v174, v207, v13 :: v_dual_fmac_f32 v155, v20, v4
	v_dual_fmac_f32 v172, v208, v14 :: v_dual_fmac_f32 v141, v33, v1
	v_dual_fmac_f32 v166, v209, v15 :: v_dual_fmac_f32 v153, v22, v6
	v_dual_fmac_f32 v164, v99, v16 :: v_dual_fmac_f32 v149, v26, v10
	v_dual_fmac_f32 v162, v17, v1 :: v_dual_fmac_f32 v151, v24, v8
	v_dual_fmac_f32 v160, v18, v2 :: v_dual_fmac_f32 v147, v28, v12
	v_dual_fmac_f32 v158, v19, v3 :: v_dual_fmac_f32 v137, v37, v5
	v_dual_fmac_f32 v154, v21, v5 :: v_dual_fmac_f32 v139, v35, v3
	v_dual_fmac_f32 v152, v23, v7 :: v_dual_fmac_f32 v133, v41, v9
	v_dual_fmac_f32 v150, v25, v9 :: v_dual_fmac_f32 v135, v39, v7
	v_dual_fmac_f32 v148, v27, v11 :: v_dual_fmac_f32 v129, v45, v13
	v_dual_fmac_f32 v146, v29, v13 :: v_dual_fmac_f32 v131, v43, v11
	v_dual_fmac_f32 v144, v30, v14 :: v_dual_fmac_f32 v127, v47, v15
	v_dual_fmac_f32 v142, v32, v16 :: v_dual_fmac_f32 v125, v49, v1
	v_dual_fmac_f32 v140, v34, v2 :: v_dual_fmac_f32 v121, v52, v4
	v_dual_fmac_f32 v138, v36, v4 :: v_dual_fmac_f32 v119, v54, v6
	v_dual_fmac_f32 v136, v38, v6 :: v_dual_fmac_f32 v117, v56, v8
	v_dual_fmac_f32 v134, v40, v8 :: v_dual_fmac_f32 v115, v58, v10
	v_dual_fmac_f32 v132, v42, v10 :: v_dual_fmac_f32 v113, v60, v12
	v_dual_fmac_f32 v130, v44, v12 :: v_dual_fmac_f32 v111, v62, v14
	v_fmac_f32_e32 v128, v46, v14
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
