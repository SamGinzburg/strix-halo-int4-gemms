...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v128, s13, v5
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v5, 6, v111
	v_subrev_nc_u32_e32 v127, s12, v4
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v129, s13, v4
	v_mov_b32_e32 v28, v25
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v4, v3, v5, v6
	...
	v_xad_u32 v5, 0x50, v4, 0
	v_xad_u32 v7, v4, 64, 0
	v_xad_u32 v8, v4, 48, 0
	v_xad_u32 v9, v4, 32, 0
	v_xad_u32 v10, v4, 16, 0
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v4, 0, v4
	...
	v_or_b32_e32 v130, v6, v3
	v_lshlrev_b32_e32 v16, 8, v12
	v_and_b32_e32 v13, 0x260, v13
	...
	v_dual_mov_b32 v24, v25 :: v_dual_and_b32 v9, 0x80, v67
	v_dual_mov_b32 v15, 0x5410 :: v_dual_lshlrev_b32 v6, 3, v111
	v_dual_mov_b32 v23, v25 :: v_dual_lshlrev_b32 v2, 5, v2
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_dual_mov_b32 v13, v25 :: v_dual_and_b32 v146, 0x7060706, v15
	v_add_nc_u32_e32 v147, 0, v3
	v_add_nc_u32_e32 v149, 0, v5
	v_add_nc_u32_e32 v150, 0, v7
	v_add_nc_u32_e32 v153, 0, v11
	v_add_nc_u32_e32 v157, 0, v20
	v_add_nc_u32_e32 v159, 0, v18
	v_dual_mov_b32 v107, v25 :: v_dual_add_nc_u32 v160, 0, v6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s1, s65, s64
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v74, s65, v124
	.loc	1 853 32                        ; attention.py:853:32
	s_mul_i32 s4, s1, s51
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v78, s65, v120
	.loc	1 854 32                        ; attention.py:854:32
	v_add_lshl_u32 v84, s4, v105, 1
	v_add_lshl_u32 v85, s4, v112, 1
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v77, s65, v122
	v_or_b32_e32 v75, s65, v118
	v_or_b32_e32 v76, s65, v125
	v_or_b32_e32 v79, s65, v123
	v_or_b32_e32 v80, s65, v121
	v_or_b32_e32 v81, s65, v119
	.loc	1 818 13                        ; attention.py:818:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 71
