...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
	v_cmp_gt_i64_e64 s0, s[74:75], v[0:1]
	...
	.loc	1 1046 21                       ; ragged.py:1046:21
	v_cmp_le_i64_e64 s1, s[72:73], v[2:3]
	v_cmp_le_i64_e64 s4, s[72:73], v[4:5]
	.loc	1 1046 48 is_stmt 0             ; ragged.py:1046:48
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	scratch_load_b32 v192, off, off offset:1152 ; 4-byte Folded Reload
	...
	.loc	1 1209 21                       ; ragged.py:1209:21
	v_dual_mul_f32 v16, v1, v99 :: v_dual_mul_f32 v13, v143, v1
	...
	v_dual_mul_f32 v92, v1, v141 :: v_dual_mul_f32 v35, v28, v175
	...
	v_dual_mul_f32 v48, v1, v167 :: v_dual_mul_f32 v89, v28, v162
	.loc	1 1209 21                       ; ragged.py:1209:21
	...
	v_dual_fmac_f32 v180, v0, v130 :: v_dual_fmac_f32 v181, v127, v131
	v_add_nc_u32_e32 v0, s76, v192
	s_waitcnt vmcnt(21) lgkmcnt(0)
	v_fmac_f32_e32 v172, v125, v134
	s_waitcnt vmcnt(19)
	...
	scratch_load_b32 v116, off, off offset:724
	...
	s_waitcnt vmcnt(22)
	v_dual_fmac_f32 v165, v124, v140 :: v_dual_fmac_f32 v146, v115, v139
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v115, off, off offset:720
	...
	v_dual_fmac_f32 v207, v120, v138 :: v_dual_fmac_f32 v156, v114, v131
	v_dual_fmac_f32 v167, v121, v17 :: v_dual_fmac_f32 v150, v112, v134
	v_fmac_f32_e32 v151, v110, v135
	s_waitcnt vmcnt(23)
	v_fmac_f32_e32 v153, v106, v137
	s_waitcnt vmcnt(21)
	v_dual_fmac_f32 v147, v113, v140 :: v_dual_fmac_f32 v148, v111, v141
	s_waitcnt vmcnt(20)
	v_fmac_f32_e32 v149, v109, v17
	v_dual_fmac_f32 v203, v104, v138 :: v_dual_fmac_f32 v166, v122, v141
	v_fmac_f32_e32 v204, v119, v20
	.loc	1 1218 45                       ; ragged.py:1218:45
	s_waitcnt vmcnt(19)
	...
	s_waitcnt vmcnt(59)
	v_dual_fmac_f32 v202, v101, v18 :: v_dual_fmac_f32 v125, v92, v136
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v101, off, off offset:668
	...
	s_clause 0x1                            ; 8-byte Folded Reload
	scratch_load_b32 v94, off, off offset:640
	...
	v_dual_fmac_f32 v187, v84, v13 :: v_dual_fmac_f32 v186, v82, v14
	s_waitcnt vmcnt(52)
	v_dual_fmac_f32 v185, v75, v15 :: v_dual_fmac_f32 v184, v73, v16
	v_dual_fmac_f32 v114, v36, v13 :: v_dual_fmac_f32 v111, v35, v14
	s_waitcnt vmcnt(49) lgkmcnt(0)
	v_dual_fmac_f32 v179, v80, v9 :: v_dual_fmac_f32 v178, v78, v10
	s_waitcnt vmcnt(47)
	v_dual_fmac_f32 v177, v76, v11 :: v_dual_fmac_f32 v176, v74, v12
	v_fmac_f32_e32 v112, v34, v15
	s_waitcnt vmcnt(36)
	v_fmac_f32_e32 v162, v68, v13
	s_waitcnt vmcnt(33)
	...
	.loc	1 1228 21                       ; ragged.py:1228:21
	v_dual_fmac_f32 v161, v66, v14 :: v_dual_fmac_f32 v154, v64, v9
	v_dual_fmac_f32 v113, v33, v16 :: v_dual_fmac_f32 v104, v31, v10
	s_waitcnt vmcnt(12)
	v_dual_fmac_f32 v102, v32, v9 :: v_dual_fmac_f32 v93, v90, v140
	scratch_load_b32 v90, off, off offset:624 ; 4-byte Folded Reload
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v101, v6, v137 :: v_dual_fmac_f32 v0, v91, v139
	v_fmac_f32_e32 v99, v1, v135
	.loc	1 1225 25                       ; ragged.py:1225:25
	...
	scratch_load_b32 v135, off, off offset:832
	scratch_load_b32 v128, off, off offset:772
	.loc	1 1228 21                       ; ragged.py:1228:21
	v_fmac_f32_e32 v159, v59, v15
	v_fmac_f32_e32 v129, v46, v10
	v_fmac_f32_e32 v127, v42, v12
	v_fmac_f32_e32 v103, v29, v12
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v217, v72, v1 :: v_dual_fmac_f32 v170, v81, v3
	v_fmac_f32_e32 v171, v83, v2
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v168, v79, v4 :: v_dual_fmac_f32 v169, v77, v5
	v_dual_fmac_f32 v215, v69, v6 :: v_dual_fmac_f32 v214, v71, v8
	v_dual_fmac_f32 v213, v53, v6 :: v_dual_fmac_f32 v212, v54, v7
	v_dual_fmac_f32 v211, v55, v8 :: v_dual_fmac_f32 v210, v40, v1
	...
	v_dual_fmac_f32 v95, v28, v2 :: v_dual_fmac_f32 v98, v26, v4
	v_dual_fmac_f32 v97, v27, v3 :: v_dual_fmac_f32 v96, v24, v5
	v_dual_fmac_f32 v201, v23, v6 :: v_dual_fmac_f32 v200, v22, v7
	s_waitcnt vmcnt(16)
	v_dual_fmac_f32 v132, v43, v15 :: v_dual_fmac_f32 v131, v41, v16
	s_waitcnt vmcnt(15)
	v_dual_fmac_f32 v130, v48, v9 :: v_dual_fmac_f32 v199, v21, v8
	s_waitcnt vmcnt(14)
	v_fmac_f32_e32 v133, v50, v14
	s_waitcnt vmcnt(12)
	v_dual_fmac_f32 v85, v70, v7 :: v_dual_fmac_f32 v86, v56, v1
	s_waitcnt vmcnt(11)
	v_fmac_f32_e32 v138, v67, v2
	s_waitcnt vmcnt(8)
	v_dual_fmac_f32 v136, v63, v4 :: v_dual_fmac_f32 v89, v30, v11
	s_waitcnt vmcnt(6)
	v_dual_fmac_f32 v141, v62, v10 :: v_dual_fmac_f32 v134, v52, v13
	.loc	1 1226 17                       ; ragged.py:1226:17
	s_waitcnt vmcnt(5)
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v135, v61, v5 :: v_dual_fmac_f32 v128, v44, v11
	s_waitcnt vmcnt(0)
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 78
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_evenk_int4_swiglu_outsc256_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 1184
