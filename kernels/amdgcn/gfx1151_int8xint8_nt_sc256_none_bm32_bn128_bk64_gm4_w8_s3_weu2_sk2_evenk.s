...
.Ltmp11:
	...
	v_mad_u64_u32 v[5:6], null, s14, v4, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
	.loc	1 297 13                        ; generate_amdgcn.py:297:13
...
.Ltmp21:
	...
	s_clause 0x1
	buffer_load_b128 v[18:21], v10, s[24:27], 0 offen
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v53, s15, v40
	v_add_nc_u32_e32 v54, s15, v41
	v_add_nc_u32_e32 v55, s15, v42
	v_add_nc_u32_e32 v56, s15, v43
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	...
	v_dual_mul_f32 v75, v74, v75 :: v_dual_add_nc_u32 v130, s42, v45
...
; %bb.9:
	...
	s_mov_b32 s31, s24
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v54, s31 :: v_dual_add_nc_u32 v1, s12, v43
	v_dual_mov_b32 v53, s30 :: v_dual_add_nc_u32 v2, s12, v42
	v_dual_mov_b32 v51, s28 :: v_dual_add_nc_u32 v8, s12, v41
	.loc	1 350 22 is_stmt 1              ; generate_amdgcn.py:350:22
	ds_load_b128 v[4:7], v1
	ds_load_b128 v[63:66], v2
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v52, s29 :: v_dual_add_nc_u32 v1, s10, v36
	v_dual_mov_b32 v49, s26 :: v_dual_add_nc_u32 v44, s12, v40
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	...
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v47, s24 :: v_dual_add_nc_u32 v2, s10, v39
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	ds_load_b128 v[87:90], v8 offset:1024
	ds_load_b128 v[91:94], v8
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	v_dual_mov_b32 v50, s27 :: v_dual_add_nc_u32 v1, s10, v38
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk2_evenk.numbered_sgpr, 43
