...
.Ltmp13:
	...
	buffer_load_b128 v[15:18], v12, s[24:27], 0 offen
	...
	buffer_load_b128 v[31:34], v12, s[24:27], 0 offen
	.loc	1 408 30 is_stmt 0              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v2, s4, v9
	s_mov_b32 s4, 0
	...
	s_clause 0x1
	buffer_load_b128 v[35:38], v2, s[24:27], 0 offen
	buffer_load_b128 v[39:42], v12, s[24:27], 0 offen
	.loc	1 402 22 is_stmt 1              ; generate_amdgcn.py:402:22
...
.Ltmp14:
	...
	v_bfe_i32 v4, v0, 5, 1
	v_dual_mov_b32 v16, 0 :: v_dual_add_nc_u32 v49, s19, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s0, s7, s19
	.loc	1 402 30 is_stmt 1              ; generate_amdgcn.py:402:30
	v_mad_u64_u32 v[67:68], null, s7, s18, v[11:12]
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_add_i32 s0, s0, s28
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[127:130], v68, s[24:27], 0 offen
	buffer_load_b128 v[131:134], v76, s[24:27], 0 offen
	buffer_load_b128 v[135:138], v77, s[24:27], 0 offen
	buffer_load_b128 v[139:142], v78, s[24:27], 0 offen
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	...
	s_add_i32 s30, s7, 0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v41, v41, v73 :: v_dual_add_f32 v40, v40, v74
	v_dual_add_f32 v38, v38, v76 :: v_dual_add_nc_u32 v245, s8, v47
	v_dual_add_f32 v39, v39, v75 :: v_dual_add_nc_u32 v246, s30, v56
	v_add_f32_e32 v37, v37, v77
	v_dual_add_f32 v34, v34, v80 :: v_dual_add_nc_u32 v247, s30, v58
	v_dual_add_f32 v33, v33, v81 :: v_dual_add_nc_u32 v248, s30, v59
	v_dual_add_f32 v36, v36, v78 :: v_dual_add_nc_u32 v249, s30, v60
	v_dual_add_f32 v27, v27, v87 :: v_dual_add_nc_u32 v250, s30, v61
	v_dual_add_f32 v30, v30, v84 :: v_dual_add_nc_u32 v251, s30, v62
	v_dual_add_f32 v29, v29, v85 :: v_dual_add_nc_u32 v252, s30, v63
	v_dual_add_f32 v35, v35, v79 :: v_dual_add_f32 v32, v32, v82
	v_add_f32_e32 v25, v25, v89
	v_dual_add_f32 v31, v31, v83 :: v_dual_add_f32 v28, v28, v86
	v_dual_add_f32 v23, v23, v91 :: v_dual_add_f32 v26, v26, v88
	v_dual_add_f32 v21, v21, v93 :: v_dual_add_f32 v24, v24, v90
	v_dual_add_f32 v19, v19, v95 :: v_dual_add_f32 v22, v22, v92
	v_dual_add_f32 v17, v17, v97 :: v_dual_add_f32 v20, v20, v94
	v_dual_add_f32 v18, v18, v96 :: v_dual_add_f32 v15, v15, v98
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s6, s5, 1
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
...
; %bb.8:
	...
	v_dual_add_f32 v15, v15, v4 :: v_dual_add_f32 v20, v20, v10
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
; %bb.10:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v76, s11 :: v_dual_add_nc_u32 v11, s30, v7
	v_dual_mov_b32 v71, s6 :: v_dual_add_nc_u32 v52, s30, v6
	v_dual_mov_b32 v74, s9 :: v_dual_add_nc_u32 v53, s30, v5
	...
	ds_load_u8 v67, v10 offset:464
	ds_load_u8 v68, v10 offset:432
	ds_load_u8 v109, v10 offset:400
	ds_load_u8 v110, v10 offset:368
	ds_load_u8 v47, v10 offset:416
	ds_load_u8 v48, v10 offset:384
	ds_load_u8 v50, v10 offset:480
	ds_load_u8 v51, v10 offset:448
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[89:92], v53 offset:8192
	ds_load_b128 v[93:96], v53
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v72, s7 :: v_dual_add_nc_u32 v53, s0, v57
	...
	v_perm_b32 v68, v109, v68, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v61, v81, v62, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v81, v105, v84, 0xc0c0004
	v_perm_b32 v57, v58, v57, 0xc0c0004
	ds_load_u8 v58, v10 offset:608
	ds_load_u8 v107, v10 offset:576
	ds_load_u8 v127, v10 offset:848
	ds_load_u8 v128, v10 offset:816
	ds_load_u8 v129, v10 offset:784
	ds_load_u8 v130, v10 offset:752
	v_lshl_or_b32 v83, v61, 16, v60
	v_lshl_or_b32 v77, v47, 16, v48
	v_lshl_or_b32 v82, v81, 16, v62
	v_lshl_or_b32 v84, v57, 16, v55
	s_delay_alu instid0(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu8 v[47:54], v[93:96], v[77:80], v[69:76] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v58, v107, v58, 0xc0c0004
	v_perm_b32 v56, v106, v56, 0xc0c0004
	ds_load_u8 v105, v10 offset:1440
	ds_load_u8 v106, v10 offset:1408
	ds_load_u8 v107, v10 offset:1504
	ds_load_u8 v108, v10 offset:1472
	v_lshl_or_b32 v81, v58, 16, v56
	...
	ds_load_u8 v112, v10 offset:1216
	...
	v_wmma_i32_16x16x16_iu8 v[47:54], v[101:104], v[81:84], v[47:54] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v55, v56, v55, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v58, v112, v62, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v144, v144, v108, 0xc0c0004
	v_lshl_or_b32 v108, v107, 16, v105
	v_perm_b32 v60, v143, v106, 0xc0c0004
	ds_load_u8 v61, v10 offset:1952
	ds_load_u8 v62, v10 offset:1920
	ds_load_u8 v112, v10 offset:2016
	ds_load_u8 v143, v10 offset:1984
	v_lshl_or_b32 v107, v56, 16, v55
	v_lshl_or_b32 v106, v58, 16, v57
	v_lshl_or_b32 v105, v144, 16, v60
	...
	v_wmma_i32_16x16x16_iu8 v[47:54], v[85:88], v[105:108], v[47:54] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	...
	v_perm_b32 v61, v143, v112, 0xc0c0004
	...
	ds_load_u8 v10, v10 offset:1552
	v_lshl_or_b32 v112, v61, 16, v59
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v143, v143, v62, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[55:62], v[89:92], v[77:80], v[69:76] neg_lo:[1,1,0]
	v_perm_b32 v77, v114, v113, 0xc0c0004
	v_perm_b32 v78, v111, v110, 0xc0c0004
	v_perm_b32 v79, v118, v117, 0xc0c0004
	v_perm_b32 v80, v116, v115, 0xc0c0004
	v_lshl_or_b32 v116, v67, 16, v68
	v_lshl_or_b32 v113, v11, 16, v109
	v_lshl_or_b32 v115, v78, 16, v77
	v_perm_b32 v11, v125, v124, 0xc0c0004
	v_lshl_or_b32 v114, v80, 16, v79
	v_perm_b32 v67, v123, v159, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[55:62], v[97:100], v[81:84], v[55:62] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[77:84], v[93:96], v[113:116], v[69:76] neg_lo:[1,1,0]
	v_lshl_or_b32 v96, v67, 16, v11
	v_lshl_or_b32 v95, v109, 16, v68
	...
	v_wmma_i32_16x16x16_iu8 v[77:84], v[101:104], v[93:96], v[77:84] neg_lo:[1,1,0]
	v_lshl_or_b32 v104, v67, 16, v11
	v_lshl_or_b32 v103, v109, 16, v68
	v_lshl_or_b32 v102, v111, 16, v110
	v_lshl_or_b32 v101, v118, 16, v117
	v_wmma_i32_16x16x16_iu8 v[69:76], v[89:92], v[113:116], v[69:76] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v163, v164, v163, 0xc0c0004
	v_perm_b32 v11, v162, v161, 0xc0c0004
	v_perm_b32 v67, v160, v122, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[77:84], v[85:88], v[101:104], v[77:84] neg_lo:[1,1,0]
	v_perm_b32 v68, v168, v167, 0xc0c0004
	v_perm_b32 v85, v166, v165, 0xc0c0004
	v_perm_b32 v86, v174, v173, 0xc0c0004
	v_perm_b32 v89, v172, v171, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v10, v176, 0xc0c0004
	v_perm_b32 v90, v175, v158, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[69:76], v[97:100], v[93:96], v[69:76] neg_lo:[1,1,0]
	v_lshl_or_b32 v111, v170, 16, v169
	v_lshl_or_b32 v110, v157, 16, v144
	v_lshl_or_b32 v109, v163, 16, v143
	v_wmma_i32_16x16x16_iu8 v[55:62], v[63:66], v[105:108], v[55:62] neg_lo:[1,1,0]
	v_lshl_or_b32 v88, v67, 16, v11
	v_lshl_or_b32 v87, v85, 16, v68
	v_lshl_or_b32 v86, v89, 16, v86
	v_lshl_or_b32 v85, v90, 16, v10
	v_wmma_i32_16x16x16_iu8 v[69:76], v[63:66], v[101:104], v[69:76] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[47:54], v[5:8], v[109:112], v[47:54] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[55:62], v[1:4], v[109:112], v[55:62] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[77:84], v[5:8], v[85:88], v[77:84] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[69:76], v[1:4], v[85:88], v[69:76] neg_lo:[1,1,0]
...
.LBB0_11:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v8, v45, v10 :: v_dual_add_f32 v49, v40, v51
	v_dual_add_f32 v10, v44, v11 :: v_dual_add_f32 v51, v38, v53
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	s_clause 0x1
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v48, v41, v50 :: v_dual_add_f32 v53, v36, v55
	v_dual_add_f32 v50, v39, v52 :: v_dual_add_f32 v55, v34, v58
	v_dual_add_f32 v52, v37, v54 :: v_dual_add_f32 v57, v32, v60
	v_add_f32_e32 v54, v35, v56
	v_add_f32_e32 v56, v33, v59
	v_dual_add_f32 v58, v31, v61 :: v_dual_add_f32 v59, v30, v62
	v_dual_add_f32 v60, v29, v63 :: v_dual_add_f32 v61, v28, v64
	v_dual_add_f32 v62, v27, v65 :: v_dual_add_f32 v63, v26, v66
	v_dual_add_f32 v64, v25, v67 :: v_dual_add_f32 v65, v24, v68
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 253
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 35
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
