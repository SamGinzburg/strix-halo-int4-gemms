...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	v_cndmask_b32_e64 v17, 0x1054, v17, s7
	v_cndmask_b32_e64 v18, 0x3276, v18, s7
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; %bb.4:                                ; %.lr.ph
	...
	v_cndmask_b32_e64 v48, v7, v10, s7
	v_cndmask_b32_e64 v50, v13, v9, s7
	v_cndmask_b32_e64 v52, v10, v7, s7
	v_dual_mov_b32 v9, 0x5410 :: v_dual_and_b32 v6, 24, v6
	v_or_b32_e32 v64, s6, v4
	v_mov_b32_e32 v4, 0x7531
	v_dual_mov_b32 v10, 0x7632 :: v_dual_add_nc_u32 v15, s22, v15
	v_mov_b32_e32 v32, 0
	...
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v49, v8, v12, s7
	v_cndmask_b32_e64 v53, v12, v8, s7
	v_lshrrev_b32_e32 v5, 2, v5
	v_dual_mov_b32 v105, 0xff800000 :: v_dual_lshlrev_b32 v12, 5, v0
	v_dual_mov_b32 v8, 0 :: v_dual_cndmask_b32 v39, 0x6420, v4
	v_dual_cndmask_b32 v38, 0x7531, v17 :: v_dual_mov_b32 v31, v32
	v_cndmask_b32_e64 v40, 0x1054, v9, s7
	v_cndmask_b32_e64 v41, 0x3276, v10, s7
	v_dual_mov_b32 v25, v32 :: v_dual_and_b32 v18, 0x70, v0
	.loc	1 974 51                        ; attention.py:974:51
	v_lshrrev_b32_e32 v19, 4, v0
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v47, v11, v14, s7
	v_cndmask_b32_e64 v51, v14, v11, s7
	.loc	1 760 21                        ; attention.py:760:21
	v_lshrrev_b32_e32 v7, 3, v0
	v_dual_mov_b32 v24, 0 :: v_dual_lshlrev_b32 v11, 7, v0
	v_bfe_i32 v35, v0, 2, 1
	v_dual_mov_b32 v0, 0 :: v_dual_and_b32 v55, 0x160, v12
	...
	s_lshr_b32 s0, s0, 29
	v_and_b32_e32 v42, 0x700, v11
	v_lshrrev_b32_e32 v43, 2, v18
	v_cndmask_b32_e64 v44, 0x90, 0, vcc_lo
	v_dual_mov_b32 v26, v32 :: v_dual_add_nc_u32 v87, 0, v37
	v_mov_b32_e32 v28, v32
	v_mov_b32_e32 v30, v32
	v_dual_mov_b32 v23, v32 :: v_dual_add_nc_u32 v86, 0, v36
	v_dual_mov_b32 v9, v32 :: v_dual_and_b32 v36, 0x750031, v39
	...
	v_dual_mov_b32 v29, v32 :: v_dual_and_b32 v54, 28, v3
	v_dual_mov_b32 v17, v32 :: v_dual_lshlrev_b32 v76, 2, v1
	v_lshl_or_b32 v77, s3, 8, v19
	v_mov_b32_e32 v19, v32
	v_dual_mov_b32 v21, v32 :: v_dual_add_nc_u32 v42, 0, v42
	...
	v_dual_mov_b32 v16, 0 :: v_dual_add_nc_u32 v73, s21, v15
	v_dual_mov_b32 v78, 0 :: v_dual_mov_b32 v27, v32
	.loc	1 951 47                        ; attention.py:951:47
	v_subrev_nc_u32_e32 v72, s20, v15
	.loc	1 981 24                        ; attention.py:981:24
	v_cmp_gt_i32_e64 s0, s23, v45
	v_or_b32_e32 v75, 2, v64
	v_dual_mov_b32 v18, v32 :: v_dual_add_nc_u32 v89, 0, v56
	v_dual_mov_b32 v20, v32 :: v_dual_add_nc_u32 v91, 0, v58
	v_dual_mov_b32 v22, v32 :: v_dual_add_nc_u32 v93, 0, v39
	v_dual_mov_b32 v10, v32 :: v_dual_and_b32 v95, 0x7050301, v36
	v_mov_b32_e32 v12, v32
	v_dual_mov_b32 v13, v32 :: v_dual_add_nc_u32 v90, 0, v57
	v_dual_mov_b32 v14, v32 :: v_dual_add_nc_u32 v97, v33, v66
	v_dual_mov_b32 v15, v32 :: v_dual_add_nc_u32 v92, v42, v43
	v_dual_mov_b32 v1, v32 :: v_dual_and_b32 v94, 0x7050301, v35
	v_dual_mov_b32 v2, v32 :: v_dual_add_nc_u32 v99, v33, v68
	v_dual_mov_b32 v3, v32 :: v_dual_and_b32 v58, 0x7060706, v38
	v_dual_mov_b32 v4, v32 :: v_dual_add_nc_u32 v101, v33, v70
	v_dual_mov_b32 v5, v32 :: v_dual_add_nc_u32 v96, v33, v65
	v_dual_mov_b32 v6, v32 :: v_dual_add_nc_u32 v103, v33, v63
	v_dual_mov_b32 v7, v32 :: v_dual_add_nc_u32 v98, v33, v67
	...
	v_and_b32_e32 v57, 0x5040504, v37
	.loc	1 903 13                        ; attention.py:903:13
	v_add_nc_u32_e32 v100, v33, v69
	v_add_nc_u32_e32 v102, v33, v71
	.loc	1 955 25                        ; attention.py:955:25
	s_mul_i32 s5, s19, s5
	s_and_b32 s9, s9, 0xffff
	s_and_b32 s15, s15, 0xffff
	s_add_i32 s50, s3, s12
	...
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v107, 0xff800000 :: v_dual_lshlrev_b32 v34, 16, v34
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 928 41                        ; attention.py:928:41
	v_mul_f32_e32 v104, s6, v34
	s_branch .LBB0_6
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_max_f32 v106, v106, v106 :: v_dual_add_nc_u32 v55, s5, v77
	...
	.loc	1 962 25                        ; attention.py:962:25
	v_perm_b32 v116, v114, v115, v94
	v_perm_b32 v114, v114, v115, v95
	.loc	1 932 25                        ; attention.py:932:25
...
.Ltmp8:
	.loc	1 967 26                        ; attention.py:967:26
	ds_bpermute_b32 v112, v76, v34
	ds_bpermute_b32 v113, v76, v114
	ds_bpermute_b32 v114, v88, v115
	ds_bpermute_b32 v115, v76, v123
.Ltmp9:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:968:29 ]
	v_permlanex16_b32 v34, v111, s49, 0xfedcba98 op_sel:[1,0]
.Ltmp10:
	.loc	1 967 26                        ; attention.py:967:26
	ds_bpermute_b32 v123, v88, v124
	.loc	1 1017 30                       ; attention.py:1017:30
...
.Ltmp36:
	...
	ds_store_2addr_b32 v92, v35, v37 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[35:38], v119
	ds_load_b128 v[107:110], v119 offset:512
	ds_load_b128 v[39:42], v93
	ds_load_b128 v[111:114], v93 offset:512
	ds_load_b128 v[115:118], v119 offset:1024
	ds_load_b128 v[123:126], v119 offset:1536
	ds_load_b128 v[119:122], v93 offset:1024
	ds_load_b128 v[127:130], v93 offset:1536
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v55.h, 0x7fff, v55.h, s8
	v_permlanex16_b32 v132, v43, s49, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v135, v134, s49, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v136, v56, s49, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_permlanex16_b32 v138, v55, s49, 0xfedcba98 op_sel:[1,0]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_bool_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 140
