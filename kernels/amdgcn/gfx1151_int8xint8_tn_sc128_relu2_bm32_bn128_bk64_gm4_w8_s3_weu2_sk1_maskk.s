	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	v_mad_u64_u32 v[6:7], null, s27, v3, v[1:2]
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[19:22], v7, s[36:39], 0 offen
	...
	s_clause 0x1
	buffer_load_b128 v[27:30], v6, s[36:39], 0 offen
	buffer_load_b128 v[31:34], v9, s[36:39], 0 offen
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_cndmask_b32_e32 v6, 0x80000000, v8, vcc_lo
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_and_b32_e32 v9, 15, v0
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b64 v[56:57], v6, s[8:11], 0 offen
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	...
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v11, v7, 1, v13
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v13, v14, v3
	v_lshlrev_b32_e32 v42, 6, v5
	v_lshlrev_b32_e32 v7, 3, v12
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b64 v[58:59], v6, s[8:11], 0 offen
	v_lshlrev_b32_e32 v6, 5, v0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshl_or_b32 v43, v12, 10, v13
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_or_b32_e32 v15, 2, v11
	v_or_b32_e32 v16, 4, v11
	...
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_or_b32_e32 v12, 10, v11
	v_or_b32_e32 v13, 12, v11
	...
	v_and_b16 v25.l, 0xff, v51.l
	v_and_b16 v25.h, 0xff, v51.h
	v_and_b16 v26.l, 0xff, v52.l
	v_and_b16 v26.h, 0xff, v52.h
	...
	v_and_b16 v20.l, 0xff, v27.l
	v_lshlrev_b16 v27.l, 8, v34.l
	v_and_b16 v20.h, 0xff, v27.h
	v_lshlrev_b16 v27.h, 8, v36.l
	v_and_b16 v22.l, 0xff, v28.l
	v_lshlrev_b16 v28.l, 8, v35.l
	v_and_b16 v22.h, 0xff, v28.h
	v_lshlrev_b16 v28.h, 8, v50.l
	v_and_b16 v24.l, 0xff, v29.l
	v_and_b16 v24.h, 0xff, v29.h
	...
	v_lshlrev_b16 v30.l, 8, v31.l
	v_lshlrev_b16 v30.h, 8, v53.l
...
.LBB0_3:                                ; %Flow31
	...
	v_or_b32_e32 v19, s34, v9
	v_or_b32_e32 v8, s34, v8
	s_ashr_i32 s0, s6, 7
	v_or_b32_e32 v34, s33, v11
	v_or_b32_e32 v33, s33, v15
	v_mul_lo_u32 v35, v19, s0
	v_mul_lo_u32 v36, v8, s0
	v_or_b32_e32 v32, s33, v16
	v_or_b32_e32 v30, s33, v17
	v_or_b32_e32 v28, s33, v18
...
; %bb.4:                                ; %.lr.ph
	...
	v_or_b32_e32 v51, v5, v42
	v_mul_lo_u32 v5, s26, v8
	v_add3_u32 v6, v6, s14, v1
	v_add3_u32 v1, v7, s14, v1
	v_mov_b32_e32 v12, 0
	v_xor_b32_e32 v52, 16, v51
	v_xor_b32_e32 v53, 32, v51
	v_subrev_nc_u32_e32 v55, s15, v6
	v_subrev_nc_u32_e32 v56, s15, v1
	v_add3_u32 v57, v5, s34, v4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v122, v70, v74 :: v_dual_add_nc_u32 v55, s35, v55
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v121, v70, v73 :: v_dual_add_nc_u32 v56, s35, v56
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v123, v70, v75 :: v_dual_add_nc_u32 v224, s18, v37
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.6:                                ; %Flow
	...
	v_dual_mov_b32 v53, v42 :: v_dual_mov_b32 v54, v41
...
; %bb.9:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v3, v6 offset:416
	ds_load_u8 v4, v6 offset:384
	ds_load_u8 v5, v6 offset:480
	ds_load_u8 v37, v6 offset:448
	ds_load_u8 v40, v6 offset:288
	ds_load_u8 v41, v6 offset:256
	ds_load_u8 v42, v6 offset:352
	ds_load_u8 v43, v6 offset:320
	ds_load_u8 v44, v6 offset:160
	ds_load_u8 v45, v6 offset:128
	ds_load_u8 v46, v6 offset:224
	ds_load_u8 v47, v6 offset:192
	ds_load_u8 v48, v6 offset:96
	ds_load_u8 v49, v6 offset:64
	ds_load_u8 v50, v6
	ds_load_u8 v53, v6 offset:32
	ds_load_u8 v57, v6 offset:464
	ds_load_u8 v78, v6 offset:432
	ds_load_u8 v79, v6 offset:400
	ds_load_u8 v80, v6 offset:368
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v39, s1, v52
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s16, v59
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v91, v6 offset:16
	ds_load_u8 v92, v39
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v40, v41, v40, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v38, s16, v58
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v41, v43, v42, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v8, s16, v60
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v42, v45, v44, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v7, s16, v61
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v39, v50, v53, 0xc0c0004
	v_perm_b32 v54, v4, v3, 0xc0c0004
	v_perm_b32 v37, v37, v5, 0xc0c0004
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[2:5], v2
	ds_load_b128 v[46:49], v38
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_lshl_or_b32 v53, v44, 16, v39
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v78, v79, v78, 0xc0c0004
	v_lshl_or_b32 v56, v37, 16, v54
	v_lshl_or_b32 v54, v43, 16, v42
	v_mov_b32_e32 v45, s11
	ds_load_u8 v37, v6 offset:928
	ds_load_u8 v50, v6 offset:896
	v_mov_b32_e32 v43, s9
	ds_load_u8 v74, v6 offset:992
	ds_load_u8 v75, v6 offset:960
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[70:73], v8
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_mov_b32_e32 v44, s10
	v_dual_mov_b32 v42, s8 :: v_dual_mov_b32 v41, s7
	v_dual_mov_b32 v40, s6 :: v_dual_mov_b32 v39, s5
	v_mov_b32_e32 v38, s4
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v8, s1, v51
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	ds_load_u8 v81, v6 offset:336
	ds_load_u8 v82, v6 offset:304
	ds_load_u8 v83, v6 offset:272
	ds_load_u8 v84, v6 offset:240
	ds_load_u8 v85, v6 offset:208
	ds_load_u8 v86, v6 offset:176
	ds_load_u8 v87, v6 offset:144
	ds_load_u8 v88, v6 offset:112
	ds_load_u8 v89, v6 offset:80
	ds_load_u8 v90, v6 offset:48
	s_waitcnt lgkmcnt(15)
	v_wmma_i32_16x16x16_iu8 v[62:69], v[46:49], v[53:56], v[38:45] neg_lo:[1,1,0]
	ds_load_u8 v53, v6 offset:800
	ds_load_u8 v54, v6 offset:768
	ds_load_u8 v55, v6 offset:864
	ds_load_u8 v56, v6 offset:832
	ds_load_u8 v76, v6 offset:672
	ds_load_u8 v77, v6 offset:640
	ds_load_u8 v93, v6 offset:736
	ds_load_u8 v94, v6 offset:704
	ds_load_u8 v95, v6 offset:976
	ds_load_u8 v96, v6 offset:944
	ds_load_u8 v97, v6 offset:912
	ds_load_u8 v98, v6 offset:880
	ds_load_u8 v105, v6 offset:720
	ds_load_u8 v106, v6 offset:688
	ds_load_u8 v107, v6 offset:656
	ds_load_u8 v108, v6 offset:624
	ds_load_u8 v125, v6 offset:1264
	ds_load_u8 v126, v6 offset:1232
	ds_load_u8 v127, v6 offset:1200
	ds_load_u8 v128, v6 offset:1168
	ds_load_u8 v141, v6 offset:1776
	ds_load_u8 v142, v6 offset:1744
	ds_load_u8 v143, v6 offset:1712
	ds_load_u8 v144, v6 offset:1680
	s_waitcnt lgkmcnt(37)
	v_perm_b32 v37, v50, v37, 0xc0c0004
	ds_load_u8 v50, v6 offset:544
	ds_load_u8 v99, v6 offset:512
	s_waitcnt lgkmcnt(37)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v6 offset:608
	ds_load_u8 v100, v6 offset:576
	ds_load_u8 v101, v6 offset:848
	ds_load_u8 v102, v6 offset:816
	ds_load_u8 v103, v6 offset:784
	ds_load_u8 v104, v6 offset:752
	s_waitcnt lgkmcnt(30)
	v_perm_b32 v53, v54, v53, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v54, v56, v55, 0xc0c0004
	v_lshl_or_b32 v56, v74, 16, v37
	...
	ds_load_u8 v93, v6 offset:592
	ds_load_u8 v94, v6 offset:560
	ds_load_u8 v109, v6 offset:528
	ds_load_u8 v110, v6 offset:496
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v75, v100, v75, 0xc0c0004
	ds_load_u8 v100, v6 offset:1504
	ds_load_u8 v112, v6 offset:1472
	v_perm_b32 v50, v99, v50, 0xc0c0004
	ds_load_u8 v99, v6 offset:1440
	ds_load_u8 v111, v6 offset:1408
	v_perm_b32 v85, v91, v90, 0xc0c0004
	v_lshl_or_b32 v80, v80, 16, v79
	v_lshl_or_b32 v79, v83, 16, v82
	v_lshl_or_b32 v53, v75, 16, v50
	ds_load_u8 v37, v6 offset:1312
	ds_load_u8 v50, v6 offset:1280
	ds_load_u8 v74, v6 offset:1376
	ds_load_u8 v75, v6 offset:1344
	ds_load_u8 v76, v6 offset:1184
	ds_load_u8 v77, v6 offset:1152
	ds_load_u8 v113, v6 offset:1248
	ds_load_u8 v114, v6 offset:1216
	ds_load_u8 v115, v6 offset:1520
	ds_load_u8 v116, v6 offset:1488
	ds_load_u8 v117, v6 offset:1456
	ds_load_u8 v118, v6 offset:1424
	s_waitcnt lgkmcnt(21)
	v_perm_b32 v82, v103, v102, 0xc0c0004
	v_perm_b32 v83, v101, v98, 0xc0c0004
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v87, v93, v108, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[62:69], v[2:5], v[53:56], v[62:69] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v86, v109, v94, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v57, v57, v110, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v37, v50, v37, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v81, v57, 16, v78
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v50, v75, v74, 0xc0c0004
	v_perm_b32 v100, v112, v100, 0xc0c0004
	ds_load_u8 v112, v6 offset:1120
	ds_load_u8 v120, v6 offset:1088
	ds_load_u8 v121, v6 offset:1392
	ds_load_u8 v122, v6 offset:1360
	ds_load_u8 v123, v6 offset:1328
	ds_load_u8 v124, v6 offset:1296
	v_perm_b32 v99, v111, v99, 0xc0c0004
	ds_load_u8 v111, v6 offset:1056
	ds_load_u8 v119, v6 offset:1024
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v74, v77, v76, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v75, v114, v113, 0xc0c0004
	v_lshl_or_b32 v55, v50, 16, v37
	v_lshl_or_b32 v56, v100, 16, v99
	ds_load_u8 v113, v6 offset:1136
	ds_load_u8 v114, v6 offset:1104
	ds_load_u8 v129, v6 offset:1072
	ds_load_u8 v130, v6 offset:1040
	v_lshl_or_b32 v78, v84, 16, v85
	v_lshl_or_b32 v54, v75, 16, v74
	v_perm_b32 v57, v97, v96, 0xc0c0004
	v_perm_b32 v84, v107, v106, 0xc0c0004
	v_perm_b32 v85, v105, v104, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[38:45], v[46:49], v[78:81], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v48, v83, 16, v82
	v_lshl_or_b32 v46, v87, 16, v86
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v112, v120, v112, 0xc0c0004
	v_lshl_or_b32 v47, v85, 16, v84
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v79, v122, v121, 0xc0c0004
	v_perm_b32 v80, v128, v127, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v78, v124, v123, 0xc0c0004
	v_perm_b32 v81, v126, v125, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v76, v119, v111, 0xc0c0004
	ds_load_u8 v77, v6 offset:1952
	ds_load_u8 v111, v6 offset:1920
	ds_load_u8 v119, v6 offset:2016
	ds_load_u8 v131, v6 offset:1984
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v83, v114, v113, 0xc0c0004
	v_lshl_or_b32 v53, v112, 16, v76
	ds_load_u8 v37, v6 offset:1824
	ds_load_u8 v50, v6 offset:1792
	ds_load_u8 v74, v6 offset:1888
	ds_load_u8 v75, v6 offset:1856
	ds_load_u8 v76, v6 offset:1696
	ds_load_u8 v99, v6 offset:1664
	ds_load_u8 v100, v6 offset:1760
	ds_load_u8 v112, v6 offset:1728
	ds_load_u8 v8, v8
	ds_load_u8 v120, v6 offset:2000
	ds_load_u8 v132, v6 offset:1968
	ds_load_u8 v133, v6 offset:1936
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v82, v130, v129, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[62:69], v[70:73], v[53:56], v[62:69] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v37, v50, v37, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v50, v75, v74, 0xc0c0004
	v_perm_b32 v111, v111, v77, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v99, v99, v76, 0xc0c0004
	v_perm_b32 v119, v131, v119, 0xc0c0004
	ds_load_u8 v131, v6 offset:1568
	ds_load_u8 v134, v6 offset:1536
	ds_load_u8 v135, v6 offset:1632
	ds_load_u8 v136, v6 offset:1600
	ds_load_u8 v137, v6 offset:1904
	ds_load_u8 v138, v6 offset:1872
	ds_load_u8 v139, v6 offset:1840
	ds_load_u8 v140, v6 offset:1808
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[74:77], v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_lshl_or_b32 v55, v50, 16, v37
	ds_load_u8 v7, v6 offset:1648
	ds_load_u8 v37, v6 offset:1616
	ds_load_u8 v50, v6 offset:1584
	ds_load_u8 v6, v6 offset:1552
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v8, v95, v8, 0xc0c0004
	v_perm_b32 v100, v112, v100, 0xc0c0004
	v_lshl_or_b32 v56, v119, 16, v111
	s_delay_alu instid0(VALU_DEP_3)
	v_lshl_or_b32 v49, v8, 16, v57
	v_perm_b32 v8, v118, v117, 0xc0c0004
	v_perm_b32 v57, v116, v115, 0xc0c0004
	v_lshl_or_b32 v54, v100, 16, v99
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v53, v134, v131, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[38:45], v[2:5], v[46:49], v[38:45] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v99, v136, v135, 0xc0c0004
	v_lshl_or_b32 v5, v57, 16, v8
	v_lshl_or_b32 v4, v79, 16, v78
	v_lshl_or_b32 v3, v81, 16, v80
	v_lshl_or_b32 v2, v83, 16, v82
	v_perm_b32 v8, v133, v132, 0xc0c0004
	v_perm_b32 v46, v120, v92, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v47, v140, v139, 0xc0c0004
	v_perm_b32 v48, v138, v137, 0xc0c0004
	v_perm_b32 v49, v144, v143, 0xc0c0004
	v_perm_b32 v57, v142, v141, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v6, v6, v50, 0xc0c0004
	v_perm_b32 v7, v37, v7, 0xc0c0004
	v_lshl_or_b32 v53, v99, 16, v53
	v_wmma_i32_16x16x16_iu8 v[38:45], v[70:73], v[2:5], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v5, v46, 16, v8
	v_lshl_or_b32 v4, v48, 16, v47
	v_lshl_or_b32 v3, v57, 16, v49
	v_lshl_or_b32 v2, v7, 16, v6
	v_wmma_i32_16x16x16_iu8 v[62:69], v[74:77], v[53:56], v[62:69] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[74:77], v[2:5], v[38:45] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	s_cmp_lt_i32 s1, s0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v46, v35, s1, 1
	v_add_lshl_u32 v47, v36, s1, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s1, s1, s27
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s4, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v48, v34, s1, 1
	v_add_lshl_u32 v49, v33, s1, 1
	v_add_lshl_u32 v50, v32, s1, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s4
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v53, v30, s1, 1
	v_add_lshl_u32 v54, v28, s1, 1
	v_add_lshl_u32 v55, v31, s1, 1
	v_add_lshl_u32 v56, v29, s1, 1
	v_add_lshl_u32 v57, v27, s1, 1
...
; %bb.11:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v51, v114, v51, 0xc0c0004
	...
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v52, v139, v52, 0xc0c0004
	v_lshl_or_b32 v88, v138, 16, v130
	v_lshl_or_b32 v84, v51, 16, v101
	v_perm_b32 v51, v137, v136, 0xc0c0004
	...
	v_perm_b32 v51, v152, v151, 0xc0c0004
	s_waitcnt lgkmcnt(5)
...
.LBB0_12:
	...
	v_dual_mov_b32 v56, 0x5410 :: v_dual_mul_f32 v91, v51, v50
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	s_add_i32 s1, s1, s33
	.loc	1 424 24 is_stmt 1              ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v88, v51, v47
	v_mul_f32_e32 v89, v51, v48
	v_mul_f32_e32 v90, v51, v49
	v_mul_f32_e32 v92, v51, v52
	v_mul_f32_e32 v93, v51, v53
	v_mul_f32_e32 v94, v51, v54
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	v_add3_u32 v9, s1, v10, v9
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v95, v51, v55
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e32 v51.h, v46.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v10, v88, v45, v19
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_mul_f32_e32 v47, v51, v48
	v_mul_f32_e32 v48, v51, v49
	v_mul_f32_e32 v49, v51, v50
	v_mul_f32_e32 v50, v51, v52
	v_mul_f32_e32 v52, v51, v53
	v_mul_f32_e32 v53, v51, v54
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v7, v48, v7, v16
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v60.h, v51.l
	v_mov_b16_e32 v61.h, v51.l
	v_mov_b16_e32 v77.h, v51.l
	v_mov_b16_e32 v78.h, v51.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v16, v7, s2
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v79.h, v51.l
	v_mov_b16_e32 v80.h, v51.l
	v_mov_b16_e32 v81.h, v51.l
	v_mov_b16_e32 v82.h, v51.l
	v_mov_b16_e32 v83.h, v51.l
	v_mov_b16_e32 v84.h, v51.l
	v_mov_b16_e32 v85.h, v51.l
	v_mov_b16_e32 v86.h, v51.l
	v_mov_b16_e32 v87.h, v51.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v3, v52, v3, v13
	v_fma_f32 v44, v89, v44, v26
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v10, v19, v10, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v42, v91, v42, v24
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_lshlrev_b32_e32 v54, 1, v9
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v3, v13, v3, s2
	v_cndmask_b32_e64 v19, v26, v44, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v8, v47, v8, v17
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v27, 16, v27
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v41, v92, v41, v23
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v2, v53, v2, v12
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v23, v41, s2
	v_cndmask_b32_e64 v2, v12, v2, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v51, v51, v55 :: v_dual_lshlrev_b32 v12, 16, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v40, v93, v40, v22
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_fma_f32 v6, v51, v6, v11
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v14, v14, v70, v21
	v_fma_f32 v15, v15, v71, v22
	v_fma_f32 v16, v16, v72, v23
	v_fma_f32 v26, v26, v74, v25
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v11, v11, v68, v18
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v5, v5, v5
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v32, v34, v66, v7
	v_fma_f32 v12, v12, v76, v10
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v8, 0, v8 :: v_dual_and_b32 v29, 1, v83
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v4, v4, v4 :: v_dual_and_b32 v27, 1, v81
	...
	v_dual_cndmask_b32 v5, 0x3276, v57 :: v_dual_and_b32 v20, 1, v59
	s_delay_alu instid0(VALU_DEP_1)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 232
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
