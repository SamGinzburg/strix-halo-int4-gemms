...
.LBB0_8:
	...
	v_add_nc_u32_e32 v35, 8, v18
	v_add_nc_u32_e32 v43, 12, v18
	v_add_nc_u32_e32 v44, 16, v18
	v_add_nc_u32_e32 v45, 20, v18
	v_add_nc_u32_e32 v46, 24, v18
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	...
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v50, v33, s[12:15], 0 offen
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v37, v37, v50 :: v_dual_lshlrev_b32 v36, 16, v36
	...
	v_dual_mul_f32 v8, v8, v48 :: v_dual_lshlrev_b32 v53, 11, v42
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
	v_add_nc_u32_e32 v17, v16, v34
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v38, v38, v50 :: v_dual_lshlrev_b32 v47, 16, v47
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	v_dual_mul_f32 v11, v11, v50 :: v_dual_add_nc_u32 v52, 0, v51
	.loc	1 192 9                         ; generate_amdgcn.py:192:9
	v_lshlrev_b64 v[17:18], 2, v[17:18]
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v40, v40, v50 :: v_dual_lshlrev_b32 v35, 16, v35
	v_mul_f32_e32 v3, v3, v48
	v_mul_f32_e32 v6, v6, v48
	v_dual_mul_f32 v39, v39, v50 :: v_dual_lshlrev_b32 v44, 16, v44
	v_mul_f32_e32 v5, v5, v48
	v_mul_f32_e32 v7, v7, v48
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v1, v1, v36, v14
	v_fma_f32 v2, v2, v47, v32
	v_fma_f32 v36, v9, v36, v25
	v_fma_f32 v4, v4, v43, v30
	v_fma_f32 v10, v10, v47, v24
	v_fma_f32 v48, v3, v35, v31
	v_fma_f32 v6, v6, v45, v28
	v_fma_f32 v11, v11, v35, v23
	.loc	1 192 9 is_stmt 1               ; generate_amdgcn.py:192:9
	v_add_co_u32 v17, vcc_lo, s40, v17
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v8, v8, v49, v26
	v_fma_f32 v35, v37, v43, v22
	...
	v_cndmask_b32_e64 v31, v19, v39, s2
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.numbered_sgpr, 45
