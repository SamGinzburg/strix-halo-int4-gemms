...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_cmp_gt_i32_e32 vcc_lo, s41, v192
	...
	v_cndmask_b32_e32 v194, 0x80000000, v192, vcc_lo
	...
	s_and_b32 vcc_lo, s63, vcc_lo
	.loc	1 943 34                        ; ragged.py:943:34
	v_cndmask_b32_e32 v195, 0x80000000, v192, vcc_lo
	.loc	1 933 26 is_stmt 1              ; ragged.py:933:26
	...
	s_and_b32 vcc_lo, s63, vcc_lo
	.loc	1 943 34                        ; ragged.py:943:34
	v_cndmask_b32_e32 v197, 0x80000000, v192, vcc_lo
	.loc	1 933 26 is_stmt 1              ; ragged.py:933:26
	...
	s_and_b32 vcc_lo, s63, vcc_lo
	.loc	1 943 34                        ; ragged.py:943:34
	v_cndmask_b32_e32 v198, 0x80000000, v192, vcc_lo
	.loc	1 933 26 is_stmt 1              ; ragged.py:933:26
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 934 31                        ; ragged.py:934:31
	v_cmp_gt_i32_e32 vcc_lo, s41, v194
	.loc	1 943 42                        ; ragged.py:943:42
	...
	v_cmp_gt_i32_e32 vcc_lo, s41, v196
	.loc	1 943 66                        ; ragged.py:943:66
	s_and_b32 vcc_lo, s63, vcc_lo
	.loc	1 943 34 is_stmt 0              ; ragged.py:943:34
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	.loc	1 965 40                        ; ragged.py:965:40
	s_mov_b32 s59, s55
	v_add_lshl_u32 v195, v168, s38, 1
	...
	v_dual_mul_f32 v17, v17, v192 :: v_dual_lshlrev_b32 v142, 16, v142
	.loc	1 965 40                        ; ragged.py:965:40
	...
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v196, v197, v142 :: v_dual_lshlrev_b32 v193, 16, v193
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v202, v203, v142 :: v_dual_mul_f32 v21, v21, v192
	...
	v_dual_mul_f32 v206, v207, v142 :: v_dual_mul_f32 v25, v25, v192
	...
	v_dual_mul_f32 v142, v211, v142 :: v_dual_mul_f32 v29, v29, v192
	v_dual_mul_f32 v30, v30, v192 :: v_dual_mul_f32 v33, v33, v193
	v_dual_mul_f32 v34, v34, v193 :: v_dual_mul_f32 v49, v49, v194
	v_dual_mul_f32 v35, v35, v193 :: v_dual_mul_f32 v50, v50, v194
	v_dual_mul_f32 v36, v36, v193 :: v_dual_mul_f32 v51, v51, v194
	v_dual_mul_f32 v37, v37, v193 :: v_dual_mul_f32 v52, v52, v194
	v_dual_mul_f32 v38, v38, v193 :: v_dual_mul_f32 v53, v53, v194
	v_dual_mul_f32 v39, v39, v193 :: v_dual_mul_f32 v54, v54, v194
	v_dual_mul_f32 v40, v40, v193 :: v_dual_mul_f32 v55, v55, v194
	v_dual_mul_f32 v41, v41, v193 :: v_dual_mul_f32 v56, v56, v194
	v_dual_mul_f32 v42, v42, v193 :: v_dual_mul_f32 v57, v57, v194
	v_dual_mul_f32 v43, v43, v193 :: v_dual_mul_f32 v58, v58, v194
	v_dual_mul_f32 v44, v44, v193 :: v_dual_mul_f32 v59, v59, v194
	v_dual_mul_f32 v45, v45, v193 :: v_dual_mul_f32 v60, v60, v194
	v_dual_mul_f32 v46, v46, v193 :: v_dual_mul_f32 v61, v61, v194
	v_dual_mul_f32 v47, v47, v193 :: v_dual_mul_f32 v62, v62, v194
	...
	v_dual_fmac_f32 v150, v17, v1 :: v_dual_fmac_f32 v147, v20, v4
	v_dual_fmac_f32 v148, v19, v3 :: v_dual_fmac_f32 v145, v22, v6
	v_dual_fmac_f32 v146, v21, v5 :: v_dual_fmac_f32 v143, v24, v8
	v_dual_fmac_f32 v144, v23, v7 :: v_dual_fmac_f32 v141, v25, v9
	v_dual_fmac_f32 v140, v26, v10 :: v_dual_fmac_f32 v139, v27, v11
	v_dual_fmac_f32 v138, v28, v12 :: v_dual_fmac_f32 v137, v29, v13
	v_dual_fmac_f32 v136, v30, v14 :: v_dual_fmac_f32 v135, v31, v15
	v_dual_fmac_f32 v134, v32, v16 :: v_dual_fmac_f32 v133, v33, v1
	v_dual_fmac_f32 v132, v34, v2 :: v_dual_fmac_f32 v131, v35, v3
	v_dual_fmac_f32 v130, v36, v4 :: v_dual_fmac_f32 v129, v37, v5
	v_dual_fmac_f32 v128, v38, v6 :: v_dual_fmac_f32 v127, v39, v7
	v_dual_fmac_f32 v122, v40, v8 :: v_dual_fmac_f32 v121, v41, v9
	v_dual_fmac_f32 v120, v42, v10 :: v_dual_fmac_f32 v119, v43, v11
	v_dual_fmac_f32 v118, v44, v12 :: v_dual_fmac_f32 v117, v45, v13
	v_dual_fmac_f32 v116, v46, v14 :: v_dual_fmac_f32 v115, v47, v15
	v_dual_fmac_f32 v114, v48, v16 :: v_dual_fmac_f32 v113, v49, v1
	v_dual_fmac_f32 v112, v50, v2 :: v_dual_fmac_f32 v111, v51, v3
	v_dual_fmac_f32 v110, v52, v4 :: v_dual_fmac_f32 v109, v53, v5
	...
	v_dual_fmac_f32 v102, v60, v12 :: v_dual_fmac_f32 v101, v61, v13
	v_dual_fmac_f32 v100, v62, v14 :: v_dual_fmac_f32 v99, v63, v15
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tt_sc128_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
