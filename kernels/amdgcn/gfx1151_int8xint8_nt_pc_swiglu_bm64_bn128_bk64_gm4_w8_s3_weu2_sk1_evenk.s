	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[13:14], null, s10, v2, v[1:2]
	s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_cvt_u32_f32 s9, s9
	s_mul_i32 s11, s11, s9
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_lshl_add_u32 v16, s10, 6, v13
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp13:
	...
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_mad_u64_u32 v[14:15], null, s29, s10, v[13:14]
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_mul_i32 s33, s28, s10
	...
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_cndmask_b32_e64 v15, 0x80000000, v30, s2
	v_cndmask_b32_e64 v45, 0x80000000, v31, s2
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	buffer_load_b128 v[41:44], v15, s[24:27], 0 offen
	...
	s_waitcnt vmcnt(9)
	ds_store_b128 v12, v[4:7] offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(8)
	ds_store_b128 v12, v[8:11]
	s_waitcnt vmcnt(7)
	ds_store_b128 v12, v[17:20] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(6)
	ds_store_b128 v12, v[21:24] offset:16384
	s_waitcnt vmcnt(5)
	ds_store_b128 v12, v[25:28] offset:20480
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b128 v12, v[29:32] offset:36864
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_and_or_b32 v107, 0x430, v2, v1
	s_mov_b32 s4, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_or3_b32 v99, v3, v4, v1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_or_b32_e32 v103, 0x1000, v99
	v_or_b32_e32 v102, 0x1000, v100
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_or_b32_e32 v104, 0x1000, v101
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v85, 0 :: v_dual_and_b32 v4, 48, v2
	v_and_or_b32 v107, 0x430, v2, v1
.Ltmp14:
	...
	v_dual_mov_b32 v34, 0 :: v_dual_mov_b32 v93, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s4, s0, s6
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v25, s38, v107
	.loc	1 374 30 is_stmt 0              ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v9, s4, v14
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v26, s38, v108
	.loc	1 376 22 is_stmt 1              ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v119, s7, v99
	v_add_nc_u32_e32 v120, s7, v100
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v135, s35, v99
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b128 v[9:12], v9, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[159:162], v25 offset:2048
	ds_load_b128 v[163:166], v26 offset:2048
	ds_load_b128 v[143:146], v25
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	ds_load_b128 v[127:130], v119 offset:4096
	ds_load_b128 v[131:134], v120 offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v136, s35, v100
	ds_load_b128 v[151:154], v135
	ds_load_b128 v[155:158], v136
	ds_load_b128 v[167:170], v135 offset:4096
	ds_load_b128 v[171:174], v136 offset:4096
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	s_add_i32 s6, s4, s33
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	s_add_i32 s4, s4, s34
	...
	s_waitcnt lgkmcnt(8)
	v_wmma_i32_16x16x16_iu8 v[17:24], v[111:114], v[143:146], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[25:32], v[111:114], v[159:162], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(5)
	v_wmma_i32_16x16x16_iu8 v[119:126], v[127:130], v[159:162], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_wmma_i32_16x16x16_iu8 v[17:24], v[115:118], v[147:150], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[25:32], v[115:118], v[163:166], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[111:118], v[127:130], v[143:146], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[119:126], v[131:134], v[163:166], v[119:126] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[135:142], v[167:170], v[143:146], v[1:8] neg_lo:[1,1,0]
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[111:118], v[131:134], v[147:150], v[111:118] neg_lo:[1,1,0]
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	...
	v_wmma_i32_16x16x16_iu8 v[143:150], v[151:154], v[159:162], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[143:150], v[155:158], v[163:166], v[143:150] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[151:158], v[167:170], v[159:162], v[1:8] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v167, s38, v109
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[151:158], v[171:174], v[163:166], v[151:158] neg_lo:[1,1,0]
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v171, s7, v101
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[159:162], v167
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[163:166], v171
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[167:170], v167 offset:2048
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[17:24], v[163:166], v[159:162], v[17:24] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[25:32], v[163:166], v[167:170], v[25:32] neg_lo:[1,1,0]
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	ds_load_b128 v[163:166], v171 offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v171, s35, v101
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[111:118], v[163:166], v[159:162], v[111:118] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[119:126], v[163:166], v[167:170], v[119:126] neg_lo:[1,1,0]
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	ds_load_b128 v[163:166], v171
	ds_load_b128 v[171:174], v171 offset:4096
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[143:150], v[163:166], v[167:170], v[143:150] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[151:158], v[171:174], v[167:170], v[151:158] neg_lo:[1,1,0]
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v167, s38, v110
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_wmma_i32_16x16x16_iu8 v[135:142], v[171:174], v[159:162], v[135:142] neg_lo:[1,1,0]
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v171, s7, v105
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	...
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	v_add_nc_u32_e32 v171, s35, v105
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v21, s6, v16
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v75, v75, v29 :: v_dual_add_f32 v82, v82, v130
	.loc	1 382 39                        ; generate_amdgcn.py:382:39
	v_add_nc_u32_e32 v29, s4, v16
	...
	s_add_i32 s30, s7, s1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v50, v50, v114 :: v_dual_add_f32 v49, v49, v113
	v_add_f32_e32 v60, v60, v120
	v_dual_add_f32 v42, v42, v116 :: v_dual_add_f32 v41, v41, v115
	v_add_f32_e32 v52, v52, v122
	v_dual_add_f32 v34, v34, v118 :: v_dual_add_f32 v33, v33, v117
	v_dual_add_f32 v44, v44, v124 :: v_dual_add_f32 v59, v59, v119
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_dual_add_f32 v70, v70, v134 :: v_dual_add_f32 v51, v51, v121
	v_dual_add_f32 v62, v62, v136 :: v_dual_add_f32 v43, v43, v123
	v_add_f32_e32 v54, v54, v138
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v36, v36, v126 :: v_dual_add_f32 v35, v35, v125
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_add_f32_e32 v46, v46, v140
	v_dual_add_f32 v86, v86, v128 :: v_dual_add_f32 v85, v85, v127
	v_dual_add_f32 v38, v38, v142 :: v_dual_add_f32 v81, v81, v129
	v_add_f32_e32 v94, v94, v144
	v_dual_add_f32 v78, v78, v132 :: v_dual_add_f32 v77, v77, v131
	v_dual_add_f32 v90, v90, v146 :: v_dual_add_f32 v69, v69, v133
	v_dual_add_f32 v80, v80, v148 :: v_dual_add_f32 v61, v61, v135
	v_dual_add_f32 v72, v72, v150 :: v_dual_add_f32 v53, v53, v137
	v_dual_add_f32 v64, v64, v152 :: v_dual_add_f32 v45, v45, v139
	v_dual_add_f32 v56, v56, v154 :: v_dual_add_f32 v37, v37, v141
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v112, s30, v15
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_add_f32_e32 v93, v93, v143
	v_add_f32_e32 v89, v89, v145
	v_add_f32_e32 v79, v79, v147
	v_add_f32_e32 v71, v71, v149
	v_add_f32_e32 v63, v63, v151
	v_add_f32_e32 v55, v55, v153
	v_add_f32_e32 v47, v47, v155
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v111, s7, v15
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v112, v[17:20]
	s_waitcnt vmcnt(2)
	ds_store_b128 v112, v[21:24] offset:4096
	.loc	1 382 31                        ; generate_amdgcn.py:382:31
	s_waitcnt vmcnt(1)
	ds_store_b128 v112, v[25:28] offset:16384
	s_waitcnt vmcnt(0)
	ds_store_b128 v112, v[29:32] offset:20480
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.LBB0_8:                                ; %._crit_edge
	...
	v_add_nc_u32_e32 v2, s38, v108
	v_add_nc_u32_e32 v3, s38, v109
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[29:32], v1
	ds_load_b128 v[17:20], v1 offset:2048
	v_add_nc_u32_e32 v1, s38, v110
...
; %bb.11:
	...
	v_add_nc_u32_e32 v111, s35, v103
	v_add_nc_u32_e32 v112, s35, v99
	v_add_nc_u32_e32 v115, s35, v102
	ds_load_b128 v[143:146], v111
	ds_load_b128 v[147:150], v112
	v_add_nc_u32_e32 v111, s35, v100
	v_add_nc_u32_e32 v113, s35, v104
	ds_load_b128 v[159:162], v115
	ds_load_b128 v[163:166], v111
	v_add_nc_u32_e32 v114, s35, v101
	ds_load_b128 v[151:154], v113
	ds_load_b128 v[155:158], v114
	v_add_nc_u32_e32 v120, s35, v105
	.loc	1 385 28                        ; generate_amdgcn.py:385:28
	v_dual_mov_b32 v118, s11 :: v_dual_add_nc_u32 v119, s35, v106
...
.LBB0_12:
	...
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v1, s31, v107
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v3, s31, v109
	v_dual_mov_b32 v111, 0 :: v_dual_add_nc_u32 v2, s31, v108
	v_dual_mov_b32 v115, 0 :: v_dual_add_nc_u32 v4, s31, v110
	ds_load_b128 v[29:32], v1
...
; %bb.13:
	...
	s_mov_b32 s11, s4
	.loc	1 376 22 is_stmt 1              ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v118, s30, v104
	v_add_nc_u32_e32 v120, s30, v102
	v_add_nc_u32_e32 v107, s30, v103
	v_add_nc_u32_e32 v119, s30, v101
	v_add_nc_u32_e32 v121, s30, v100
	v_add_nc_u32_e32 v112, s30, v99
	v_add_nc_u32_e32 v117, s30, v105
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v125, s10 :: v_dual_add_nc_u32 v116, s30, v106
...
.LBB0_16:
	...
	.loc	1 408 23                        ; generate_amdgcn.py:408:23
	v_add_lshl_u32 v1, s14, v1, 1
	s_clause 0x1
	buffer_load_u16 v121, v6, s[8:11], 0 offen
	buffer_load_u16 v122, v4, s[8:11], 0 offen
	v_add_lshl_u32 v4, s14, v5, 1
	v_add_lshl_u32 v6, s14, v25, 1
	v_add_lshl_u32 v5, s14, v26, 1
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_clause 0x5
	...
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or_b32_e32 v26, s28, v26
	v_or_b32_e32 v25, s28, v25
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_add_i32 s0, s0, s28
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or_b32_e32 v88, s28, v87
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v142, v89, v142, s2
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or_b32_e32 v89, s28, v86
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or_b32_e32 v90, s28, v85
	v_or_b32_e32 v91, s28, v84
	v_or_b32_e32 v92, s28, v83
	v_or_b32_e32 v93, s28, v82
	v_or_b32_e32 v94, s28, v80
	v_or_b32_e32 v95, s28, v78
	v_or_b32_e32 v144, s28, v77
	v_or_b32_e32 v145, s28, v28
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	...
	.loc	1 408 23                        ; generate_amdgcn.py:408:23
	v_add_lshl_u32 v156, s14, v28, 1
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v28, 1, v88
	.loc	1 401 17                        ; generate_amdgcn.py:401:17
	v_add_f32_e32 v9, v40, v180
	.loc	1 408 23                        ; generate_amdgcn.py:408:23
	v_add_lshl_u32 v155, s14, v82, 1
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	...
	.loc	1 408 23                        ; generate_amdgcn.py:408:23
	v_add_lshl_u32 v152, s14, v87, 1
	v_add_lshl_u32 v153, s14, v86, 1
	v_add_lshl_u32 v85, s14, v85, 1
	v_add_lshl_u32 v84, s14, v84, 1
	v_add_lshl_u32 v154, s14, v83, 1
	v_add_lshl_u32 v80, s14, v80, 1
	v_add_lshl_u32 v77, s14, v77, 1
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 200
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 39
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     41
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
