	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_mad_u64_u32 v[59:60], null, s35, v70, v[58:59]
	...
	.loc	1 759 31                        ; attention.py:759:31
	v_or_b32_e32 v1, s34, v70
	.loc	1 787 26                        ; attention.py:787:26
	v_mad_u64_u32 v[63:64], null, s35, 14, v[59:60]
	v_lshl_add_u32 v80, s35, 3, v59
	.loc	1 755 23                        ; attention.py:755:23
	...
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v2, s34, v71
	.loc	1 787 26                        ; attention.py:787:26
	s_mul_i32 s31, s35, 22
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, s34, v72
	.loc	1 757 22                        ; attention.py:757:22
	v_readfirstlane_b32 s8, v10
	.loc	1 787 26                        ; attention.py:787:26
	v_lshl_add_u32 v78, s35, 1, v59
	s_mul_i32 s38, s35, 28
	s_mul_i32 s39, s35, 30
	v_lshl_add_u32 v79, s35, 2, v59
	.loc	1 757 22                        ; attention.py:757:22
	...
	.loc	1 787 26                        ; attention.py:787:26
	s_mul_i32 s43, s33, s35
	s_lshl_b32 s42, s35, 4
	v_add_nc_u32_e32 v1, s43, v59
	.loc	1 788 26                        ; attention.py:788:26
	v_add_lshl_u32 v7, s43, v61, 1
	v_add_lshl_u32 v4, s43, v60, 1
	v_add_lshl_u32 v5, s43, v80, 1
	v_add_lshl_u32 v9, s43, v63, 1
	v_lshlrev_b32_e32 v6, 1, v1
	v_add_lshl_u32 v11, v1, s29, 1
	v_add_lshl_u32 v8, s43, v62, 1
	v_add_lshl_u32 v10, v1, s42, 1
...
.LBB0_4:
	...
	s_add_i32 s7, s34, s50
	.loc	1 802 39                        ; attention.py:802:39
	s_sub_i32 s9, s34, s49
	.loc	1 805 17                        ; attention.py:805:17
	s_add_i32 s7, s7, s51
	.loc	1 802 39                        ; attention.py:802:39
	s_add_i32 s9, s9, s51
...
; %bb.8:                                ; %.lr.ph
	...
	v_mul_u32_u24_e32 v16, 0x48, v13
	v_lshlrev_b32_e32 v56, 2, v0
	v_lshrrev_b32_e32 v50, 2, v90
	v_xor_b32_e32 v14, v15, v14
	v_lshrrev_b32_e32 v15, 1, v90
	v_lshrrev_b32_e32 v51, 4, v2
	v_lshl_or_b32 v16, v3, 2, v16
	v_xor_b32_e32 v10, v49, v10
	v_dual_mov_b32 v156, 0xff800000 :: v_dual_lshlrev_b32 v49, 5, v0
	v_and_b32_e32 v56, 52, v56
	v_and_b32_e32 v66, 2, v0
	v_lshrrev_b32_e32 v67, 5, v2
	v_or3_b32 v98, v16, v15, v51
	v_or3_b32 v99, v51, v10, v50
	v_dual_mov_b32 v152, 0 :: v_dual_and_b32 v49, 0x180, v49
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_or3_b32 v51, v67, v66, v56
	v_dual_mov_b32 v149, 0xff800000 :: v_dual_lshlrev_b32 v10, 1, v0
	v_or_b32_e32 v97, v14, v50
	v_dual_mov_b32 v151, 0xff800000 :: v_dual_lshlrev_b32 v50, 2, v89
	v_or3_b32 v100, v51, v49, v15
	v_lshl_add_u32 v103, v83, 2, 0
	v_xor_b32_e32 v16, 32, v98
	v_dual_mov_b32 v155, 0 :: v_dual_and_b32 v10, 60, v10
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v49, 32, v100
	v_dual_mov_b32 v157, 0xff800000 :: v_dual_lshlrev_b32 v66, 5, v3
	v_dual_mov_b32 v159, 0xff800000 :: v_dual_add_nc_u32 v114, 0, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_add_nc_u32_e32 v122, 0, v49
	v_dual_mov_b32 v49, 0 :: v_dual_add_nc_u32 v96, 0, v2
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v153, 0 :: v_dual_add_nc_u32 v132, v103, v2
	v_mov_b32_e32 v2, v49
	v_lshlrev_b32_e32 v56, 1, v13
	v_lshl_or_b32 v13, v13, 7, v50
	...
	v_or3_b32 v101, v13, v66, v56
	v_xor_b32_e32 v8, 64, v91
	v_xor_b32_e32 v13, 16, v100
	v_xor_b32_e32 v9, v9, v15
	v_lshlrev_b32_e32 v135, 2, v87
	v_xor_b32_e32 v65, 0x70, v98
	v_xor_b32_e32 v66, 24, v101
	v_add_nc_u32_e32 v108, 0, v8
	v_add_nc_u32_e32 v121, 0, v13
	v_mov_b32_e32 v13, v49
	v_dual_mov_b32 v8, v49 :: v_dual_add_nc_u32 v135, v4, v135
	v_mov_b32_e32 v4, v49
	v_lshl_or_b32 v102, v3, 6, v9
	v_lshrrev_b32_e32 v69, 1, v87
	v_add_nc_u32_e32 v119, 0, v65
	v_add_nc_u32_e32 v129, 0, v66
	v_mad_u64_u32 v[65:66], null, s22, v70, v[58:59]
	v_xor_b32_e32 v15, 48, v100
	v_xor_b32_e32 v67, 28, v101
	v_xor_b32_e32 v68, 0x410, v102
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v95, s51, v6
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s6, s26, v6
	v_xor_b32_e32 v6, 32, v91
	v_lshlrev_b32_e32 v104, 1, v83
	...
	v_xor_b32_e32 v11, 0x50, v91
	v_xor_b32_e32 v12, 0x60, v91
	v_xor_b32_e32 v52, 0x70, v91
	v_xor_b32_e32 v1, 0x240, v97
	v_xor_b32_e32 v14, 16, v98
	v_xor_b32_e32 v53, 48, v98
	v_xor_b32_e32 v54, 64, v98
	v_xor_b32_e32 v55, 0x50, v98
	v_xor_b32_e32 v57, 0x60, v98
	v_xor_b32_e32 v10, 0x120, v99
	v_xor_b32_e32 v50, 4, v101
	v_xor_b32_e32 v51, 8, v101
	v_xor_b32_e32 v56, 12, v101
	v_xor_b32_e32 v3, 16, v101
	v_xor_b32_e32 v9, 20, v101
	v_add_nc_u32_e32 v123, 0, v15
	...
	v_add_nc_u32_e32 v134, v69, v104
	...
	v_dual_mov_b32 v148, 0xff800000 :: v_dual_add_nc_u32 v105, 0, v5
	v_dual_mov_b32 v150, 0xff800000 :: v_dual_add_nc_u32 v107, 0, v7
	v_dual_mov_b32 v154, 0 :: v_dual_add_nc_u32 v109, 0, v11
	v_add_nc_u32_e32 v110, 0, v12
	v_dual_mov_b32 v158, 0xff800000 :: v_dual_add_nc_u32 v111, 0, v52
	v_add_nc_u32_e32 v112, 0, v1
	v_dual_mov_b32 v160, 0xff800000 :: v_dual_add_nc_u32 v113, 0, v14
	v_add_nc_u32_e32 v115, 0, v53
	v_add_nc_u32_e32 v116, 0, v54
	v_add_nc_u32_e32 v117, 0, v55
	v_add_nc_u32_e32 v118, 0, v57
	v_add_nc_u32_e32 v120, 0, v10
	v_add_nc_u32_e32 v124, 0, v50
	v_add_nc_u32_e32 v125, 0, v51
	v_add_nc_u32_e32 v126, 0, v56
	v_add_nc_u32_e32 v127, 0, v3
	v_add_nc_u32_e32 v128, 0, v9
	v_add_nc_u32_e32 v133, v133, v104
	v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v10, v49
	v_mov_b32_e32 v11, v49
	v_mov_b32_e32 v12, v49
	v_dual_mov_b32 v14, v49 :: v_dual_mov_b32 v1, 0
	...
	v_lshl_add_u32 v146, s22, 1, v65
	v_lshl_add_u32 v147, s22, 2, v65
...
.Ltmp83:
	...
	v_add_nc_u32_e32 v168, v103, v87
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp84:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.num_vgpr, 193
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.numbered_sgpr, 58
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     60
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_runtime_bfloat16_d64_dv64_shaperuntime_bm32_bn16_w4_s1_ds1.kd
