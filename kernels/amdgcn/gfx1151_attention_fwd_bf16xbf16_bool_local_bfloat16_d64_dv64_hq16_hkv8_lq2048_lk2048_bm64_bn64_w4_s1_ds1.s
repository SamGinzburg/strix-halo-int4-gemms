...
; %bb.4:                                ; %.lr.ph
	...
	v_subrev_nc_u32_e32 v166, s6, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v43, v41 :: v_dual_add_nc_u32 v170, s7, v4
	v_dual_mov_b32 v45, v41 :: v_dual_lshlrev_b32 v4, 7, v28
	v_dual_mov_b32 v44, v41 :: v_dual_lshlrev_b32 v5, 6, v72
	v_dual_mov_b32 v47, v41 :: v_dual_lshlrev_b32 v6, 4, v69
	v_subrev_nc_u32_e32 v167, s6, v1
	v_dual_mov_b32 v46, v41 :: v_dual_add_nc_u32 v171, s7, v1
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v4, v5, v6
	v_dual_mov_b32 v42, v41 :: v_dual_add_nc_u32 v3, s12, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v168, s6, v2
	v_dual_mov_b32 v17, v41 :: v_dual_add_nc_u32 v172, s7, v2
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v2, 0x70, v1, 0
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v169, s6, v3
	v_dual_mov_b32 v48, v41 :: v_dual_add_nc_u32 v173, s7, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_lshlrev_b32_e32 v11, 6, v71
	v_and_b32_e32 v9, 0x310, v9
	v_lshlrev_b32_e32 v8, 5, v0
	v_dual_mov_b32 v13, v41 :: v_dual_lshlrev_b32 v12, 2, v72
	...
	v_dual_mov_b32 v15, v41 :: v_dual_and_b32 v8, 0x60, v8
	...
	v_xor_b32_e32 v4, v6, v73
	v_and_b32_e32 v6, 0x410, v11
	v_cndmask_b32_e64 v2, 0x3276, v8, s4
	v_dual_mov_b32 v11, v41 :: v_dual_add_nc_u32 v232, v3, v71
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v203, v69, 10, v4
	v_add_nc_u32_e32 v4, v5, v159
	scratch_store_b32 off, v1, off offset:96 ; 4-byte Folded Spill
	v_cndmask_b32_e64 v1, 0x1054, v7, s4
...
.LBB0_71:                               ; %._crit_edge
	...
	v_cndmask_b16 v31.l, 0x7fff, v37.h, s4
	...
	v_cndmask_b16 v19.h, 0x7fff, v34.h, s5
	...
	v_cndmask_b32_e64 v6, v31, v30, s4
	v_cndmask_b32_e64 v8, v29, v33, s4
	...
	v_cndmask_b32_e64 v5, v30, v31, s4
	v_cndmask_b32_e64 v7, v33, v29, s4
	...
	v_cmp_gt_i32_e64 s2, s89, v26
	v_cmp_gt_i32_e64 s1, s89, v25
	.loc	1 1049 36                       ; attention.py:1049:36
	...
	.loc	1 1047 63 is_stmt 1             ; attention.py:1047:63
	v_cmp_gt_i32_e32 vcc_lo, s89, v0
	.loc	1 1049 36                       ; attention.py:1049:36
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 112
