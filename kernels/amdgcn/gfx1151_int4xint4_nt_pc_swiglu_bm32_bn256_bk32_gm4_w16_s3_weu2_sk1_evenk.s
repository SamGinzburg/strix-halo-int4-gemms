	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s24, v3, v[1:2]
	...
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add3_u32 v6, v6, v74, s4
	.loc	1 136 25                        ; generate_amdgcn.py:136:25
	s_mul_i32 s2, s22, s24
	.loc	1 129 30                        ; generate_amdgcn.py:129:30
	v_add3_u32 v5, s14, s3, v4
	.loc	1 136 25                        ; generate_amdgcn.py:136:25
	v_add3_u32 v4, s14, s2, v4
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v14, v10, s[8:11], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[5:6], v5, s[16:19], 0 offen
	buffer_load_b64 v[7:8], v4, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v15, v11, s[8:11], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[10:11], v12, s[16:19], 0 offen
	...
	v_xor_b32_e32 v36, v4, v17
	v_lshlrev_b32_e32 v4, 4, v0
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v17, 0, v37
	...
	s_waitcnt vmcnt(3)
	ds_store_2addr_stride64_b64 v17, v[5:6], v[7:8] offset1:16
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
...
.Ltmp14:
	...
	s_lshr_b32 s1, s1, 4
	v_dual_mov_b32 v13, v10 :: v_dual_and_b32 v4, 0x88, v5
.Ltmp15:
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	v_add3_u32 v5, s15, s18, v3
	v_mov_b32_e32 v11, v10
	v_lshl_or_b32 v35, v75, 3, v34
	v_or_b32_e32 v3, s18, v3
	v_sub_nc_u32_e64 v6, s1, 3 clamp
	s_lshl_b32 s1, s23, 8
	v_or_b32_e32 v38, v4, v34
	v_or_b32_e32 v39, v35, v4
	v_subrev_nc_u32_e32 v4, s1, v5
	v_subrev_nc_u32_e32 v5, s1, v3
	v_readfirstlane_b32 s18, v6
	v_dual_mov_b32 v15, v10 :: v_dual_add_nc_u32 v6, s21, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[2:3], null, s24, v4, s[14:15]
	v_mad_u64_u32 v[3:4], null, s24, v5, s[14:15]
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u64_u32 v[4:5], null, s24, v6, s[14:15]
	v_xor_b32_e32 v40, 8, v38
	v_xor_b32_e32 v41, 8, v39
	v_add3_u32 v42, v2, v1, 32
	v_mov_b32_e32 v12, v10
	v_add3_u32 v43, v3, v1, 32
	v_mov_b32_e32 v14, v10
	v_add3_u32 v44, v4, v74, 32
	...
	s_add_i32 s14, 0, 0x3000
	s_mov_b32 s18, s10
	s_mov_b32 s19, s11
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v65, v44, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[53:54], v43, s[16:19], 0 offen
	buffer_load_b64 v[55:56], v42, s[16:19], 0 offen
	s_mov_b32 s29, s1
	s_mov_b32 s1, s23
	s_mov_b32 s23, s26
	s_mov_b32 s26, s24
	s_mov_b32 s24, s25
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v45, s29, v38
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v50, s23, v39
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v51, s24, v39
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v49, s29, v40
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v61, s23, v41
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	v_add_nc_u32_e32 v63, s24, v41
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	s_cselect_b32 s28, s14, 0
	v_add_nc_u32_e32 v44, 16, v44
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_lshl_b32 s14, s28, 9
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	...
	s_add_i32 s24, s23, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v66, s14, v36
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s27, s27, -1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_add_i32 s23, s14, 0x4000
	.loc	1 135 31                        ; generate_amdgcn.py:135:31
	s_add_i32 s14, s24, 0x2000
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[18:25], v[57:58], v[45:46], v[18:25] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[26:33], v[57:58], v[47:48], v[26:33] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[59:60], v[45:46], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[59:60], v[47:48], v[1:8] neg_lo:[1,1,0]
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v45, s24, v37
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[63:64], v[49:50], v[10:17] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[63:64], v[51:52], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmp_lg_u32 s27, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v66, v65 offset:16384
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
...
.LBB0_8:                                ; %Flow186
	...
	v_dual_mov_b32 v48, v32 :: v_dual_mov_b32 v43, v27
	v_dual_mov_b32 v42, v26 :: v_dual_mov_b32 v39, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_or_b32_e32 v58, v9, v34
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_or_b32_e32 v9, v35, v9
	v_mov_b32_e32 v38, v22
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_and_not1_b32 vcc_lo, exec_lo, s3
	v_dual_mov_b32 v45, v29 :: v_dual_add_nc_u32 v34, s1, v58
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_xor_b32_e32 v59, 8, v58
	v_dual_mov_b32 v44, v28 :: v_dual_mov_b32 v41, v25
	v_dual_mov_b32 v40, v24 :: v_dual_mov_b32 v47, v31
	s_delay_alu instid0(VALU_DEP_3)
	v_add_nc_u32_e32 v36, s1, v59
	...
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	ds_load_2addr_b64 v[50:53], v36 offset1:32
...
; %bb.13:
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v58, s24, v9
	v_add_nc_u32_e32 v60, s24, v77
	...
	v_dual_mov_b32 v61, v45 :: v_dual_mov_b32 v58, v48
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v63, v47 :: v_dual_mov_b32 v60, v44
	v_dual_mov_b32 v65, v43 :: v_dual_mov_b32 v62, v46
	v_dual_mov_b32 v67, v41 :: v_dual_mov_b32 v64, v42
	v_dual_mov_b32 v69, v37 :: v_dual_mov_b32 v66, v40
	v_dual_mov_b32 v71, v39 :: v_dual_mov_b32 v68, v36
	v_dual_mov_b32 v73, v35 :: v_dual_mov_b32 v70, v38
...
.LBB0_17:
	...
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v25, s20, v21
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v28, s22, v21, 1
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	v_cvt_f32_i32_e32 v21, v4
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v4, s20, v2
	v_or_b32_e32 v9, s20, v23
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v23, s22, v23, 1
	v_add_lshl_u32 v1, s22, v1, 1
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v29, s20, v20
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v20, s22, v20, 1
	v_add_lshl_u32 v2, s22, v2, 1
	.loc	1 143 22                        ; generate_amdgcn.py:143:22
	v_or_b32_e32 v27, s20, v22
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v22, s22, v22, 1
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v3, 1, v3
	s_and_b32 s17, s7, 0xffff
	s_mov_b32 s16, s6
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v30, s22, v18, 1
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	v_lshlrev_b32_e32 v4, 1, v4
	.loc	1 147 23                        ; generate_amdgcn.py:147:23
	v_add_lshl_u32 v31, s22, v19, 1
	.loc	1 146 24                        ; generate_amdgcn.py:146:24
	...
	v_dual_mul_f32 v54, v1, v22 :: v_dual_lshlrev_b32 v25, 1, v25
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v56, v1, v30
	v_mul_f32_e32 v30, v2, v30
	v_dual_mul_f32 v31, v1, v24 :: v_dual_lshlrev_b32 v20, 1, v29
	v_mul_f32_e32 v53, v1, v23
	...
	v_mul_f32_e32 v31, v1, v32
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v28, v2, v28 :: v_dual_lshlrev_b32 v9, 1, v18
	...
	v_dual_mul_f32 v33, v1, v25 :: v_dual_lshlrev_b32 v18, 1, v19
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_clause 0x1
	...
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_dual_mul_f32 v24, v2, v24 :: v_dual_mul_f32 v33, v33, v43
	v_mul_f32_e32 v22, v2, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v32, v2, v32 :: v_dual_mul_f32 v25, v25, v37
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v24, v24, v49 :: v_dual_mul_f32 v23, v2, v23
	v_mul_f32_e32 v13, v26, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v12, v22, v12
	v_dual_mul_f32 v49, v57, v52 :: v_dual_mul_f32 v14, v30, v14
	...
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v43, v1, v29
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v29, v2, v29 :: v_dual_lshlrev_b32 v34, 16, v34
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v35, 16, v35
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v23, v23, v48 :: v_dual_mul_f32 v48, v54, v50
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v37, v1, v27
	v_mul_f32_e32 v27, v2, v27
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_dual_mul_f32 v15, v28, v15 :: v_dual_mul_f32 v28, 0xbfb8aa3b, v17
	v_dual_mul_f32 v21, v55, v21 :: v_dual_mul_f32 v26, v1, v34
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v22, v1, v35
	.loc	1 148 13                        ; generate_amdgcn.py:148:13
	v_mul_f32_e32 v50, v56, v51
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v35, v2, v35
	v_mul_f32_e32 v34, v2, v34
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v31, v31, v42 :: v_dual_mul_f32 v36, 0xbfb8aa3b, v23
	.loc	1 149 44 is_stmt 1              ; generate_amdgcn.py:149:44
	v_mul_f32_e32 v42, 0xbfb8aa3b, v16
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v37, v37, v44 :: v_dual_mul_f32 v26, v26, v47
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v44, 0xbfb8aa3b, v48 :: v_dual_mul_f32 v29, v29, v39
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v27, v27, v38 :: v_dual_mul_f32 v34, v34, v41
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_dual_mul_f32 v38, 0xbfb8aa3b, v12 :: v_dual_mul_f32 v47, 0xbfb8aa3b, v49
	...
	v_cmp_gt_f32_e64 s8, 0xc2fc0000, v47
	v_fmac_f32_e32 v44, 0xbfb8aa3b, v48
	v_exp_f32_e32 v28, v28
	v_fmac_f32_e32 v39, 0xbfb8aa3b, v13
	v_dual_mul_f32 v45, 0xbfb8aa3b, v21 :: v_dual_mul_f32 v22, v22, v46
	v_cmp_gt_f32_e64 s2, 0xc2fc0000, v42
	v_cmp_gt_f32_e64 s3, 0xc2fc0000, v36
	v_cndmask_b32_e64 v38, 0, 0x42800000, s7
	v_cndmask_b32_e64 v47, 0, 0x42800000, s8
	...
	v_dual_fmac_f32 v38, 0xbfb8aa3b, v12 :: v_dual_fmac_f32 v47, 0xbfb8aa3b, v49
	v_ldexp_f32 v28, v28, v51
	v_dual_mul_f32 v41, 0xbfb8aa3b, v15 :: v_dual_fmac_f32 v42, 0xbfb8aa3b, v16
	...
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_mul_f32 v46, 0xbfb8aa3b, v50 :: v_dual_fmac_f32 v45, 0xbfb8aa3b, v21
	...
	v_div_scale_f32 v51, null, v28, v28, v17
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v53, null, v30, v30, v24
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v56, 0, 0xffffffc0, s5
	v_dual_fmac_f32 v46, 0xbfb8aa3b, v50 :: v_dual_fmac_f32 v41, 0xbfb8aa3b, v15
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v75, v53
	v_fma_f32 v86, -v51, v73, 1.0
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	...
	v_div_scale_f32 v57, null, v36, v36, v23
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	v_div_scale_f32 v61, null, v44, v44, v48
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v79, v61
	v_fma_f32 v89, -v57, v77, 1.0
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v38, 1.0, v38
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v46, v46, v60
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v42, 1.0, v42 :: v_dual_add_f32 v41, 1.0, v41
	v_add_f32_e32 v45, 1.0, v45
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_exp_f32_e32 v40, v40
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v77, v89, v77
	v_div_scale_f32 v65, null, v38, v38, v12
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_cndmask_b32_e64 v62, 0, 0xffffffc0, s11
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v55, null, v42, v42, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(TRANS32_DEP_2)
	v_rcp_f32_e32 v81, v65
	v_fma_f32 v91, -v61, v79, 1.0
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v46, 1.0, v46
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v40, v40, v62
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v59, null, v45, v45, v21
	v_rcp_f32_e32 v76, v55
	v_fmac_f32_e32 v79, v91, v79
	v_div_scale_f32 v69, null, v46, v46, v50
	v_div_scale_f32 v63, null, v39, v39, v13
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v67, null, v47, v47, v49
	v_rcp_f32_e32 v80, v63
	v_fma_f32 v88, -v55, v76, 1.0
	v_fmac_f32_e32 v81, v87, v81
	v_div_scale_f32 v72, null, v40, v40, v14
	v_div_scale_f32 v56, s2, v16, v42, v16
	v_rcp_f32_e32 v82, v67
	s_delay_alu instid0(VALU_DEP_2)
	v_rcp_f32_e32 v85, v72
	v_fma_f32 v90, -v59, v78, 1.0
	v_fma_f32 v89, -v69, v83, 1.0
	v_fmac_f32_e32 v76, v88, v76
	v_div_scale_f32 v52, vcc_lo, v17, v28, v17
	v_fma_f32 v86, -v63, v80, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v83, v89, v83 :: v_dual_fmac_f32 v78, v90, v78
	v_mul_f32_e32 v87, v56, v76
	v_div_scale_f32 v71, null, v41, v41, v15
	v_fma_f32 v88, -v67, v82, 1.0
	v_fma_f32 v91, -v72, v85, 1.0
	v_fmac_f32_e32 v80, v86, v80
	v_fma_f32 v89, -v55, v87, v56
	v_mul_f32_e32 v86, v52, v73
	v_rcp_f32_e32 v84, v71
	v_div_scale_f32 v62, s5, v48, v44, v48
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v82, v88, v82 :: v_dual_fmac_f32 v87, v89, v76
	v_fma_f32 v88, -v51, v86, v52
	v_div_scale_f32 v70, s9, v50, v46, v50
	v_div_scale_f32 v60, s4, v21, v45, v21
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_fmac_f32_e32 v86, v88, v73
	v_fma_f32 v90, -v71, v84, 1.0
	v_div_scale_f32 v54, s1, v24, v30, v24
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v89, v60, v78
	v_fma_f32 v51, -v51, v86, v52
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v84, v90, v84
	v_fma_f32 v55, -v55, v87, v56
	v_div_scale_f32 v66, s7, v12, v38, v12
	v_div_fmas_f32 v51, v51, v73, v86
	s_mov_b32 vcc_lo, s2
	v_fmac_f32_e32 v85, v91, v85
	v_div_fmas_f32 v55, v55, v76, v87
	v_fma_f32 v87, -v59, v89, v60
	v_mul_f32_e32 v90, v54, v75
	v_mul_f32_e32 v91, v62, v79
	v_div_scale_f32 v58, s3, v23, v36, v23
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fmac_f32_e32 v89, v87, v78
	v_fma_f32 v73, -v53, v90, v54
	v_mul_f32_e32 v56, v66, v81
	v_div_scale_f32 v64, s6, v13, v39, v13
	v_mul_f32_e32 v87, v70, v83
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v90, v73, v75
	v_fma_f32 v73, -v61, v91, v62
	v_mul_f32_e32 v88, v58, v77
	v_div_scale_f32 v68, s8, v49, v47, v49
	v_dual_fmac_f32 v91, v73, v79 :: v_dual_lshlrev_b32 v8, 16, v8
	v_fma_f32 v73, -v65, v56, v66
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_fma_f32 v86, -v57, v88, v58
	v_mul_f32_e32 v76, v68, v82
	v_div_fixup_f32 v17, v51, v28, v17
	s_mov_b32 vcc_lo, s1
	v_fmac_f32_e32 v56, v73, v81
	v_fma_f32 v73, -v69, v87, v70
	v_mul_f32_e32 v52, v64, v80
	v_fmac_f32_e32 v88, v86, v77
	v_div_fixup_f32 v16, v55, v42, v16
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v17, v33, v17
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v87, v73, v83
	v_fma_f32 v86, -v63, v52, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v52, v86, v80
	v_fma_f32 v86, -v67, v76, v68
	v_fmac_f32_e32 v76, v86, v82
	v_div_scale_f32 v86, s2, v15, v41, v15
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v73, v86, v84
	v_fma_f32 v92, -v71, v73, v86
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v73, v92, v84
	v_div_scale_f32 v92, s10, v14, v40, v14
	v_mul_f32_e32 v93, v92, v85
	v_fma_f32 v53, -v53, v90, v54
	v_fma_f32 v54, -v57, v88, v58
	v_fma_f32 v57, -v59, v89, v60
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_add3_u32 v60, s21, s20, v0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v94, -v72, v93, v92
	v_div_fmas_f32 v28, v53, v75, v90
	s_mov_b32 vcc_lo, s3
	v_fma_f32 v0, -v61, v91, v62
	v_fma_f32 v62, -v63, v52, v64
	v_fma_f32 v64, -v65, v56, v66
	v_fma_f32 v66, -v67, v76, v68
	v_fma_f32 v68, -v69, v87, v70
	v_fma_f32 v70, -v71, v73, v86
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	v_mul_f32_e32 v71, v1, v8
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v51, v54, v77, v88
	s_mov_b32 vcc_lo, s4
	v_fmac_f32_e32 v93, v94, v85
	v_div_fmas_f32 v42, v57, v78, v89
	s_mov_b32 vcc_lo, s5
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v58.h, 0
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v24, v28, v30, v24
	v_div_fixup_f32 v23, v51, v36, v23
	v_div_fmas_f32 v0, v0, v79, v91
	s_mov_b32 vcc_lo, s6
	v_div_fixup_f32 v21, v42, v45, v21
	v_div_fmas_f32 v28, v62, v80, v52
	s_mov_b32 vcc_lo, s7
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_div_fmas_f32 v25, v64, v81, v56
	s_mov_b32 vcc_lo, s8
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v21, v43, v21
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fmas_f32 v30, v66, v82, v76
	s_mov_b32 vcc_lo, s9
	v_div_fixup_f32 v13, v28, v39, v13
	v_div_fmas_f32 v28, v68, v83, v87
	s_mov_b32 vcc_lo, s2
	v_div_fixup_f32 v12, v25, v38, v12
	v_div_fmas_f32 v25, v70, v84, v73
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_and_b32_e32 v31, 1, v63
	v_mov_b16_e32 v58.l, v24.h
	v_mov_b16_e32 v61.h, v58.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v0, v0, v44, v48
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v61.l, v23.h
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v13, v29, v13
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v15, v25, v41, v15
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_and_b32_e32 v32, 1, v58
	v_mov_b16_e32 v58.l, v17.h
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v0, v37, v0 :: v_dual_and_b32 v25, 1, v61
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v28, v28, v46, v50
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v12, v27, v12 :: v_dual_and_b32 v27, 1, v58
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	v_mov_b16_e32 v58.l, v21.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v72, -v72, v93, v92
	v_div_fixup_f32 v30, v30, v47, v49
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v17, v21, v27, 0x7fff
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_mul_f32_e32 v21, v26, v30
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v0, v0, v28, 0x7fff
	.loc	1 148 25                        ; generate_amdgcn.py:148:25
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v0.l, 0x7fff, v0.h, s5
	v_cndmask_b16 v0.h, 0x7fff, v17.h, vcc_lo
	v_and_b32_e32 v17, 1, v58
	v_cmp_o_f32_e32 vcc_lo, v15, v15
	v_add3_u32 v13, v13, v25, 0x7fff
	v_cndmask_b16 v13.l, 0x7fff, v12.h, s7
	v_mov_b16_e32 v12.h, v58.h
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v24, null, v11, v11, v7
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_ldexp_f32 v12, v12, v15
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v15.l, v22.h
	v_mov_b16_e32 v15.h, v58.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_rcp_f32_e32 v26, v24
	.loc	1 149 44 is_stmt 0              ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v14, 0xbfb8aa3b, v6 :: v_dual_and_b32 v15, 1, v15
	...
	v_dual_mul_f32 v10, 0xbfb8aa3b, v8 :: v_dual_and_b32 v27, 1, v58
	.loc	1 216 9 is_stmt 1               ; generate_amdgcn.py:216:9
	...
	.loc	1 149 26 is_stmt 0              ; generate_amdgcn.py:149:26
	v_div_scale_f32 v32, vcc_lo, v7, v11, v7
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_dual_fmac_f32 v10, 0xbfb8aa3b, v8 :: v_dual_mul_f32 v35, v32, v26
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_exp_f32_e32 v10, v10
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v21, -v24, v35, v32
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_dual_add_f32 v12, 1.0, v12 :: v_dual_fmac_f32 v35, v21, v26
	.loc	1 149 44                        ; generate_amdgcn.py:149:44
	v_ldexp_f32 v10, v10, v25
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_scale_f32 v25, null, v12, v12, v5
	...
	v_div_scale_f32 v30, null, v10, v10, v8
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v7, v24, v11, v7
	v_rcp_f32_e32 v31, v30
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v33, -v25, v29, 1.0
	v_fmac_f32_e32 v29, v33, v29
	v_div_scale_f32 v33, s1, v5, v12, v5
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v36, -v30, v31, 1.0
	v_dual_mul_f32 v38, v33, v29 :: v_dual_fmac_f32 v31, v36, v31
	v_div_scale_f32 v36, s3, v8, v10, v8
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v21, -v25, v38, v33
	v_dual_mul_f32 v39, v36, v31 :: v_dual_fmac_f32 v38, v21, v29
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v21, -v30, v39, v36
	.loc	1 149 38                        ; generate_amdgcn.py:149:38
	v_add_f32_e32 v14, 1.0, v14
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v25, -v25, v38, v33
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v39, v21, v31
	v_div_scale_f32 v28, null, v14, v14, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v21, v25, v29, v38
	s_mov_b32 vcc_lo, s3
	v_fma_f32 v26, -v30, v39, v36
	s_delay_alu instid0(VALU_DEP_3)
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v5, v21, v12, v5
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_mul_f32_e32 v18, v25, v18
	v_mul_f32_e32 v4, v4, v20
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v8, v26, v10, v8
	v_fma_f32 v37, -v28, v34, 1.0
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v1, v1, v9 :: v_dual_mul_f32 v2, v2, v19
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_dual_mov_b32 v9, 0x7632 :: v_dual_mul_f32 v4, v4, v7
	v_cndmask_b16 v3.h, 0x7fff, v27.h, s2
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	v_dual_mul_f32 v1, v1, v5 :: v_dual_mul_f32 v2, v2, v8
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_mov_b16_e32 v8.h, v58.h
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v34, v37, v34
	v_div_scale_f32 v37, s4, v6, v14, v6
	s_mov_b32 vcc_lo, s4
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v32, -v28, v40, v37
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add3_u32 v5, v2, v5, 0x7fff
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fmac_f32_e32 v40, v32, v34
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v5.h, 0x7fff, v5.h, s1
	v_cmp_o_f32_e64 s1, v4, v4
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_fma_f32 v28, -v28, v40, v37
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fmas_f32 v28, v28, v34, v40
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cmp_o_f32_e32 vcc_lo, v22, v22
	.loc	1 149 26                        ; generate_amdgcn.py:149:26
	v_div_fixup_f32 v6, v28, v14, v6
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v3.l, 0x7fff, v15.h, vcc_lo
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 149 19                        ; generate_amdgcn.py:149:19
	...
	v_permlanex16_b32 v6, v7, s1, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v12, v0, s1, 0xfedcba98 op_sel:[1,0]
	v_and_b32_e32 v7, 0x5040504, v1
	v_perm_b32 v1, v6, v2, v11
	v_perm_b32 v3, v4, v8, v11
	s_delay_alu instid0(VALU_DEP_3)
	v_perm_b32 v0, v6, v2, v7
	v_perm_b32 v2, v4, v8, v7
	v_add_lshl_u32 v8, v60, v59, 1
	v_perm_b32 v4, v5, v9, v7
	v_perm_b32 v5, v5, v9, v11
	v_perm_b32 v6, v12, v10, v7
	v_perm_b32 v7, v12, v10, v11
	v_add_lshl_u32 v9, v60, v69, 1
	s_clause 0x1
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_vgpr, 95
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_swiglu_bm32_bn256_bk32_gm4_w16_s3_weu2_sk1_evenk.kd
