...
.Ltmp0:
	...
	v_dual_mov_b32 v12, v25 :: v_dual_and_b32 v39, 0x540054, v39
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_dual_mov_b32 v9, v25 :: v_dual_and_b32 v38, 0x760076, v40
	.loc	1 788 26                        ; attention.py:788:26
	v_add_nc_u32_e32 v98, 0, v41
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v41, 0, v42
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v65, s35, v136 :: v_dual_mul_f32 v66, s35, v137
	v_dual_mul_f32 v68, s35, v139 :: v_dual_mul_f32 v69, s35, v140
	v_dual_mul_f32 v70, s35, v141 :: v_dual_mul_f32 v71, s35, v142
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v74, s35, v74 :: v_dual_mul_f32 v75, s35, v75
	v_dual_mul_f32 v76, s35, v76 :: v_dual_mul_f32 v77, s35, v77
	v_dual_mul_f32 v78, s35, v78 :: v_dual_mul_f32 v79, s35, v79
	v_dual_mul_f32 v67, s35, v138 :: v_dual_mul_f32 v72, s35, v143
...
.Ltmp4:
	...
	v_permlanex16_b32 v128, v121, s34, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp5:
...
.Ltmp19:
	...
	v_dual_mul_f32 v15, v15, v127 :: v_dual_add_f32 v122, v78, v80
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp21:
	...
	v_permlanex16_b32 v76, v65, s34, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v74, v66, s34, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v66, v67, s34, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v70, v69, s34, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v70, v123, s34, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v71, v124, s34, 0xfedcba98 op_sel:[1,0]
	.loc	1 818 13                        ; attention.py:818:13
	s_add_i32 s3, s44, 32
	s_cmpk_lt_u32 s44, 0x1e0
	s_mov_b32 s44, s3
...
.Ltmp23:
	...
	v_permlanex16_b32 v119, v118, s34, 0xfedcba98 op_sel:[1,0]
.Ltmp24:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
	v_add_f32_e32 v95, v118, v119
.Ltmp25:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v72, v125, s34, 0xfedcba98 op_sel:[1,0]
...
; %bb.2:
	...
	v_div_scale_f32 v47, null, v95, v95, v9
	s_mov_b32 vcc_lo, s4
	s_delay_alu instid0(TRANS32_DEP_1)
	...
	s_mov_b32 vcc_lo, s3
	v_div_scale_f32 v49, null, v95, v95, v12
	...
	v_div_scale_f32 v44, s5, v10, v95, v10
	...
	v_div_scale_f32 v46, s3, v11, v95, v11
	...
	v_div_fixup_f32 v11, v24, v95, v11
	v_fmac_f32_e32 v46, v42, v51
	v_fma_f32 v42, -v48, v38, 1.0
	v_div_scale_f32 v24, s3, v14, v95, v14
	v_fmac_f32_e32 v45, v47, v45
	v_div_scale_f32 v49, null, v95, v95, v1
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_div_scale_f32 v41, null, v95, v95, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v39, v39, v51, v46
	s_mov_b32 vcc_lo, s3
	...
	v_div_scale_f32 v42, s4, v15, v95, v15
	v_div_fixup_f32 v13, v39, v95, v13
	v_rcp_f32_e32 v39, v49
	v_fmac_f32_e32 v40, v46, v45
	v_div_fixup_f32 v12, v23, v95, v12
	v_div_scale_f32 v51, null, v95, v95, v3
	.loc	1 1044 19                       ; attention.py:1044:19
	...
	v_div_fixup_f32 v14, v24, v95, v14
	...
	v_div_scale_f32 v23, s5, v16, v95, v16
	...
	v_div_scale_f32 v24, s4, v3, v95, v3
	...
	s_mov_b32 vcc_lo, s6
	v_div_scale_f32 v38, null, v95, v95, v4
	v_div_fmas_f32 v42, v42, v46, v47
	v_mul_f32_e32 v40, v24, v53
	v_div_scale_f32 v43, null, v95, v95, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_rcp_f32_e32 v41, v38
	v_div_fixup_f32 v2, v42, v95, v2
	v_div_scale_f32 v42, null, v95, v95, v6
	v_fma_f32 v44, -v51, v40, v24
	v_rcp_f32_e32 v45, v43
	v_div_fixup_f32 v16, v23, v95, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(TRANS32_DEP_3)
	v_rcp_f32_e32 v46, v42
	s_mov_b32 vcc_lo, s4
	v_fmac_f32_e32 v40, v44, v53
	v_fma_f32 v44, -v38, v41, 1.0
	v_div_fixup_f32 v1, v39, v95, v1
	v_div_scale_f32 v47, s4, v5, v95, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(TRANS32_DEP_1)
	v_fma_f32 v23, -v51, v40, v24
	v_div_scale_f32 v24, s3, v4, v95, v4
	v_fma_f32 v50, -v42, v46, 1.0
	v_fmac_f32_e32 v41, v44, v41
	s_delay_alu instid0(VALU_DEP_4)
	v_div_fmas_f32 v23, v23, v53, v40
	v_fma_f32 v39, -v43, v45, 1.0
	v_div_scale_f32 v44, null, v95, v95, v7
	v_fmac_f32_e32 v46, v50, v46
	v_mul_f32_e32 v40, v24, v41
	v_div_scale_f32 v50, s5, v6, v95, v6
	v_fmac_f32_e32 v45, v39, v45
	v_rcp_f32_e32 v39, v44
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_fma_f32 v49, -v38, v40, v24
	v_div_scale_f32 v48, null, v95, v95, v8
	v_div_fixup_f32 v3, v23, v95, v3
	s_mov_b32 vcc_lo, s3
	...
	v_div_scale_f32 v49, s6, v7, v95, v7
	...
	v_div_scale_f32 v53, s7, v8, v95, v8
	...
	.loc	1 1044 48                       ; attention.py:1044:48
	v_div_fixup_f32 v6, v23, v95, v6
	v_div_fmas_f32 v38, v38, v51, v47
	v_div_fixup_f32 v7, v24, v95, v7
	.loc	1 1044 19 is_stmt 0             ; attention.py:1044:19
	...
	.loc	1 1049 36                       ; attention.py:1049:36
	v_perm_b32 v1, v3, v4, v91
	v_perm_b32 v2, v3, v4, v92
	v_perm_b32 v3, v5, v6, v91
	v_perm_b32 v4, v5, v6, v92
	v_perm_b32 v5, v7, v8, v91
	v_perm_b32 v6, v7, v8, v92
	...
	v_perm_b32 v11, v12, v17, v91
	v_perm_b32 v12, v12, v17, v92
	.loc	1 1049 17                       ; attention.py:1049:17
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 144
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 45
