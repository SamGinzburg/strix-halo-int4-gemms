...
.LBB0_3:                                ; %Flow94
	...
	s_ashr_i32 s42, s13, 6
	v_and_b32_e32 v10, 1, v0
	v_mul_lo_u32 v153, v11, s42
	v_mul_lo_u32 v139, v7, s42
	v_mul_lo_u32 v140, v8, s42
	v_mul_lo_u32 v141, v9, s42
	v_or_b32_e32 v150, s33, v0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_fmac_f32_e32 v138, v216, v36
	v_dual_fmac_f32 v142, v225, v37 :: v_dual_fmac_f32 v143, v226, v38
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_store_2addr_b32 v118, v115, v116 offset1:16
	v_perm_b32 v115, v206, v198, 0x7060302
	v_perm_b32 v116, v206, v198, 0x5040100
	v_add_nc_u32_e32 v118, s43, v107
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v144, v227, v39 :: v_dual_fmac_f32 v145, v228, v40
	v_dual_fmac_f32 v146, v237, v25 :: v_dual_fmac_f32 v147, v238, v26
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_fmac_f32 v151, v248, v29 :: v_dual_fmac_f32 v152, v249, v30
	v_dual_fmac_f32 v154, v250, v31 :: v_dual_fmac_f32 v159, v220, v52
	...
	v_dual_fmac_f32 v187, v194, v63 :: v_dual_fmac_f32 v180, v76, v64
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_10:
	...
	s_cmp_lt_i32 s4, s42
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v1, v153, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v2, v150, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v3, v139, s4, 1
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v2, 0x80000000, v2
	v_add_lshl_u32 v4, v140, s4, 1
	v_add_lshl_u32 v5, v141, s4, 1
	s_delay_alu instid0(VALU_DEP_4)
...
.LBB0_12:
	...
	s_cmp_lt_i32 s4, s42
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v4, v153, s4, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v81, v150, s5, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 s5, -1, 0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v83, v140, s4, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s2, s5
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v84, v141, s4, 1
	...
	v_mul_f32_e32 v139, v66, v4
	v_mul_f32_e32 v140, v65, v4
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v141, v80, v4
	v_mul_f32_e32 v150, v79, v4
	v_mul_f32_e32 v153, v78, v4
	...
	ds_load_b128 v[77:80], v255 offset:41488
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v139, v157, v139, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v141, v155, v141, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_fma_f32 v140, v140, v220, v156
	v_fma_f32 v153, v153, v217, v152
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v72, v72, v4
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v150, v150, v218, v154
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v140, v156, v140, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v152, v152, v153, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v150, v154, v150, s3
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v157, v70, v85 :: v_dual_mul_f32 v188, v71, v83
	...
	v_dual_max_f32 v11, v13, v13 :: v_dual_mul_f32 v66, v66, v84
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v69, v69, v84 :: v_dual_max_f32 v72, 0, v14
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_max_f32 v12, v19, v19 :: v_dual_mul_f32 v179, v77, v86
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v9, v22, v22 :: v_dual_max_f32 v74, 0, v12
	v_max_f32_e32 v12, v24, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v31, v174, v31, v145
	v_fma_f32 v39, v86, v39, v141
	...
	v_dual_mul_f32 v75, v75, v84 :: v_dual_max_f32 v82, 0, v14
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v27, v170, v27, v138
	v_fma_f32 v36, v179, v36, v151
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v31, v145, v31, s2
	v_cndmask_b32_e64 v39, v141, v39, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v13, v20, v20
	v_dual_max_f32 v85, 0, v12 :: v_dual_max_f32 v12, v34, v34
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v80, v80, v84
	v_dual_mul_f32 v77, v77, v84 :: v_dual_max_f32 v14, v31, v31
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v41, v183, v41, v139
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v41, v139, v41, s2
	...
	v_dual_max_f32 v83, 0, v9 :: v_dual_max_f32 v92, 0, v14
	v_max_f32_e32 v14, v41, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v84, v134, v105, v119
	v_fma_f32 v40, v182, v40, v140
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v80, 0, v13 :: v_dual_max_f32 v13, v30, v30
	v_max_f32_e32 v9, v32, v32
	v_max_f32_e32 v93, 0, v14
	v_dual_max_f32 v14, v46, v46 :: v_dual_max_f32 v11, v28, v28
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_cndmask_b32_e64 v40, v140, v40, s2
	...
	v_max_f32_e32 v90, 0, v12
	v_max_f32_e32 v86, 0, v13
	v_dual_max_f32 v9, v37, v37 :: v_dual_max_f32 v46, 0, v14
	v_max_f32_e32 v13, v35, v35
	v_dual_max_f32 v12, v39, v39 :: v_dual_max_f32 v11, v33, v33
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v38, v181, v38, v150
	...
	v_dual_max_f32 v13, v50, v50 :: v_dual_max_f32 v14, v51, v51
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_max_f32_e32 v35, 0, v14
	v_dual_max_f32 v13, v55, v55 :: v_dual_max_f32 v14, v56, v56
	v_dual_max_f32 v42, 0, v9 :: v_dual_max_f32 v39, 0, v11
	v_dual_max_f32 v11, v43, v43 :: v_dual_max_f32 v30, 0, v13
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_max_f32 v11, v48, v48 :: v_dual_max_f32 v2, v2, v2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v65, v65, v65 :: v_dual_max_f32 v48, 0, v11
	...
	v_dual_max_f32 v5, v6, v6 :: v_dual_max_f32 v6, v7, v7
	v_max_f32_e32 v7, v8, v8
	v_max_f32_e32 v11, v53, v53
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_max_f32 v31, 0, v12 :: v_dual_max_f32 v12, v59, v59
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v25, 0, v12 :: v_dual_max_f32 v22, 0, v13
	v_max_f32_e32 v12, 0, v5
	s_delay_alu instid0(VALU_DEP_4)
	v_max_f32_e32 v26, 0, v11
	v_max_f32_e32 v11, v63, v63
	v_max_f32_e32 v47, 0, v9
	v_max_f32_e32 v9, v52, v52
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	v_add3_u32 v5, s40, s33, v81
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v27, 0, v14 :: v_dual_max_f32 v14, v61, v61
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, 0, v14 :: v_dual_mul_f32 v50, v68, v68
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v3, v3, v3 :: v_dual_mul_f32 v28, v70, v70
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v14.l, v18.h
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v19, 0, v9 :: v_dual_and_b32 v18, 1, v32
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v20, 0, v11 :: v_dual_max_f32 v9, 0, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v11, 0, v2 :: v_dual_and_b32 v28, 1, v28
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v54, v80, v80 :: v_dual_mul_f32 v55, v79, v79
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v41, v41, v41 :: v_dual_and_b32 v54, 1, v54
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v31, v31, v31 :: v_dual_and_b32 v56, 1, v56
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v60, v92, v92 :: v_dual_mul_f32 v35, v35, v35
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v8, v8, v8 :: v_dual_mul_f32 v33, v33, v33
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_dual_mul_f32 v27, v27, v27 :: v_dual_add_nc_u32 v2, 0x80, v5
	...
	v_cndmask_b32_e32 v31, v44, v41, vcc_lo
	v_dual_cndmask_b32 v26, v56, v38 :: v_dual_and_b32 v13, 1, v13
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v19, v52, v54 :: v_dual_and_b32 v16, 1, v16
	v_add3_u32 v4, v9, v4, 0x7fff
	v_add3_u32 v9, v12, v13, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_add3_u32 v11, v11, v16, 0x7fff
	v_dual_cndmask_b32 v13, v32, v24 :: v_dual_and_b32 v16, 1, v22
	v_cndmask_b32_e32 v12, v24, v32, vcc_lo
	v_cndmask_b32_e32 v32, v41, v44, vcc_lo
	...
	v_dual_cndmask_b32 v41, v0, v15 :: v_dual_cndmask_b32 v0, v15, v0
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_cndmask_b32 v35, v23, v29 :: v_dual_and_b32 v8, 0x540054, v8
	v_dual_cndmask_b32 v23, v29, v23 :: v_dual_and_b32 v10, 0x760076, v10
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_relu2_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 52
