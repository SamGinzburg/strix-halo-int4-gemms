...
; %bb.4:                                ; %.lr.ph
	...
	v_cndmask_b32_e64 v36, 0x1054, v5, s3
	...
	v_dual_mov_b32 v18, v25 :: v_dual_add_nc_u32 v115, 0, v35
	...
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[74:75], null, s37, v37, v[33:34]
	...
	v_subrev_nc_u32_e32 v98, s6, v1
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v99, s7, v1
	v_or_b32_e32 v100, s39, v81
	v_or_b32_e32 v101, s39, v82
	v_or_b32_e32 v102, s39, v83
	v_or_b32_e32 v103, s39, v84
	v_or_b32_e32 v104, s39, v85
	v_or_b32_e32 v105, s39, v86
	v_or_b32_e32 v106, s39, v87
	v_or_b32_e32 v107, s39, v88
	v_or_b32_e32 v108, s39, v89
	v_or_b32_e32 v109, s39, v90
	v_or_b32_e32 v110, s39, v91
	v_or_b32_e32 v111, s39, v92
	v_or_b32_e32 v112, s39, v93
	v_or_b32_e32 v113, s39, v94
	v_or_b32_e32 v114, s39, v95
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v118, 0, v40
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v120, 0, v42
	v_mov_b32_e32 v19, v25
	v_mov_b32_e32 v21, v25
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v117, 0, v39
	v_mov_b32_e32 v23, v25
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v119, 0, v41
	v_mov_b32_e32 v9, v25
	v_mov_b32_e32 v11, v25
	v_mov_b32_e32 v13, v25
	v_dual_mov_b32 v14, v25 :: v_dual_and_b32 v75, 0x5040504, v33
	v_mov_b32_e32 v15, v25
	v_dual_mov_b32 v16, v25 :: v_dual_and_b32 v77, 0x7060706, v34
	...
	s_mov_b32 s57, s15
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v12, v25 :: v_dual_lshlrev_b32 v35, 16, v46
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v64, v100, s50, 1
	v_add_lshl_u32 v126, v101, s50, 1
	v_add_lshl_u32 v127, v102, s50, 1
	.loc	1 823 32                        ; attention.py:823:32
	buffer_load_b128 v[41:44], v41, s[52:55], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v128, v103, s50, 1
	v_add_lshl_u32 v129, v104, s50, 1
	v_add_lshl_u32 v130, v105, s50, 1
	v_add_lshl_u32 v133, v106, s50, 1
	v_add_lshl_u32 v134, v107, s50, 1
	v_add_lshl_u32 v135, v108, s50, 1
	v_add_lshl_u32 v136, v109, s50, 1
	v_add_lshl_u32 v137, v110, s50, 1
	v_add_lshl_u32 v138, v111, s50, 1
	v_add_lshl_u32 v139, v112, s50, 1
	v_add_lshl_u32 v140, v113, s50, 1
	v_add_lshl_u32 v141, v114, s50, 1
	.loc	1 823 32                        ; attention.py:823:32
	s_waitcnt vmcnt(0)
	ds_store_b64 v115, v[41:42]
	ds_store_b64 v117, v[43:44]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[49:52], v116 offset1:1
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(0)
	...
	v_cmp_le_i32_e64 s5, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s50, v93
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s6, v51, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s7, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s9, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s50, v91
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s10, v51, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s11, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s13, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s50, v89
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v51, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s15, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s17, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s50, v87
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s18, v51, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s19, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s21, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v49, s50, v85
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s22, v51, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s23, v51, v99
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s27, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v51, s50, v82
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v49, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s29, v49, v99
	.loc	1 819 31                        ; attention.py:819:31
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s31, v51, v99
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v51, s50, v79
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s33, v49, v98
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s34, v49, v99
	...
	s_and_b32 s24, s18, s19
	s_and_b32 s18, s20, s21
	s_and_b32 s19, s22, s23
	s_and_b32 s1, s2, s1
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.num_vgpr, 145
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn32_w2_s1_ds1.numbered_sgpr, 68
