	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[10:11], null, s15, v2, v[9:10]
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[11:12], null, s15, v5, v[9:10]
	v_lshl_add_u32 v39, s15, 6, v10
	v_lshl_add_u32 v40, s15, 7, v10
...
.Ltmp13:
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_dual_cndmask_b32 v1, 0x80000000, v1 :: v_dual_cndmask_b32 v42, 0x80000000, v26
	v_cndmask_b32_e32 v12, 0x80000000, v29, vcc_lo
	v_cndmask_b32_e32 v34, 0x80000000, v30, vcc_lo
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v49, v2, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[26:29], v1, s[24:27], 0 offen
	buffer_load_b128 v[30:33], v12, s[24:27], 0 offen
	buffer_load_b128 v[34:37], v34, s[24:27], 0 offen
	buffer_load_b128 v[45:48], v42, s[24:27], 0 offen
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v50, v8 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v50, v49 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v1, v[26:29] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v1, v[30:33] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v1, v[34:37] offset:24576
	s_waitcnt vmcnt(0)
...
.LBB0_3:
	...
	s_load_b64 s[12:13], s[0:1], 0x20
.LBB0_4:                                ; %.lr.ph
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v1, 48, v3
.Ltmp14:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v14, v14, v45 :: v_dual_add_f32 v29, v29, v46
	v_dual_add_f32 v28, v28, v47 :: v_dual_add_f32 v27, v27, v48
	v_dual_add_f32 v26, v26, v49 :: v_dual_add_f32 v25, v25, v50
	v_dual_add_f32 v24, v24, v51 :: v_dual_add_f32 v23, v23, v52
	v_dual_add_f32 v22, v22, v53 :: v_dual_add_f32 v21, v21, v54
	v_dual_add_f32 v20, v20, v55 :: v_dual_add_f32 v19, v19, v56
	v_dual_add_f32 v18, v18, v57 :: v_dual_add_f32 v17, v17, v58
	v_dual_add_f32 v16, v16, v59 :: v_dual_add_f32 v15, v15, v60
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(4)
...
; %bb.8:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v27, v27, v40 :: v_dual_add_f32 v18, v18, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_f32 v25, v25, v42 :: v_dual_add_f32 v16, v16, v5
	v_dual_add_f32 v23, v23, v44 :: v_dual_add_f32 v14, v14, v7
...
.LBB0_11:
	...
	v_dual_add_f32 v3, v14, v3 :: v_dual_lshlrev_b32 v30, 1, v30
	.loc	1 326 14                        ; generate_amdgcn.py:326:14
	v_or_b32_e32 v13, s14, v0
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v29, v4 :: v_dual_add_f32 v7, v26, v7
	...
	s_mov_b32 s4, s18
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v33, v20, v39 :: v_dual_add_f32 v34, v19, v40
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v31, v31, s[4:7], 0 offen
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v35, v18, v41 :: v_dual_add_f32 v36, v17, v42
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v41, v14, v3, s2
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v11, v22, v11 :: v_dual_add_f32 v32, v21, v38
	v_dual_add_f32 v37, v16, v43 :: v_dual_add_f32 v38, v15, v44
	v_dual_add_f32 v5, v28, v5 :: v_dual_add_f32 v6, v27, v6
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v21, v21, v32, s2
	v_cndmask_b32_e64 v20, v20, v33, s2
	v_cndmask_b32_e64 v32, v17, v36, s2
	v_cndmask_b32_e64 v33, v16, v37, s2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	v_mad_u64_u32 v[16:17], null, s28, s29, v[13:14]
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_cndmask_b32_e64 v34, v15, v38, s2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	s_mov_b32 s14, s6
	s_mov_b32 s15, s7
	v_add_lshl_u32 v54, v16, s1, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s10, s29, 11
	s_mul_i32 s11, s29, 12
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v55, v16, s4, 2
	v_add_lshl_u32 v56, v16, s5, 2
	v_add_lshl_u32 v57, v16, s8, 2
	v_add_lshl_u32 v58, v16, s9, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s16, s29, 13
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v59, v16, s10, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s17, s29, 14
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v60, v16, s11, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s0, s29, 15
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v61, v16, s16, 2
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_or3_b32 v1, v39, v1, v12
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v3, v40, 2, v2
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xad_u32 v36, 0x808, v1, 0
	v_xad_u32 v37, 0xc0c, v1, 0
	v_xad_u32 v38, 0x1010, v1, 0
	v_xad_u32 v39, 0x1414, v1, 0
	v_xad_u32 v42, 0x1818, v1, 0
	v_xad_u32 v43, 0x1c1c, v1, 0
	v_xad_u32 v44, 0x2040, v1, 0
	v_xad_u32 v45, 0x2444, v1, 0
	v_xad_u32 v46, 0x2848, v1, 0
	v_xad_u32 v47, 0x2c4c, v1, 0
	v_xad_u32 v48, 0x3050, v1, 0
	v_xad_u32 v49, 0x3454, v1, 0
	v_xad_u32 v50, 0x3858, v1, 0
	v_xad_u32 v51, 0x3c5c, v1, 0
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	ds_store_b32 v17, v0
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_lshl_or_b32 v40, v40, 10, v4
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	ds_load_b128 v[4:7], v12 offset:16
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v31, v16, s3, 2
	v_xad_u32 v63, v40, 4, 0
	v_xad_u32 v64, v40, 8, 0
	v_xad_u32 v65, v40, 12, 0
	v_xad_u32 v66, v40, 16, 0
	v_xad_u32 v67, v40, 20, 0
	v_xad_u32 v68, v40, 24, 0
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v3, v3, v30 :: v_dual_lshlrev_b32 v52, 2, v16
	v_mul_f32_e32 v7, v7, v30
	v_mul_f32_e32 v4, v4, v30
	v_dual_mul_f32 v0, v0, v30 :: v_dual_mul_f32 v3, v27, v3
	ds_load_b128 v[8:11], v12 offset:512
	ds_load_b128 v[12:15], v12 offset:528
	v_dual_mul_f32 v1, v1, v30 :: v_dual_add_nc_u32 v62, 0, v40
	v_dual_mul_f32 v2, v2, v30 :: v_dual_mul_f32 v7, v23, v7
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v4, v26, v4
	v_mul_f32_e32 v0, v41, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v1, v29, v1 :: v_dual_mul_f32 v2, v28, v2
	...
	v_dual_mul_f32 v6, v6, v30 :: v_dual_mul_f32 v11, v19, v11
	v_dual_mul_f32 v15, v15, v30 :: v_dual_mul_f32 v8, v22, v8
	v_mul_f32_e32 v12, v12, v30
	v_dual_mul_f32 v14, v14, v30 :: v_dual_mul_f32 v9, v21, v9
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v13, v32, v13
	v_mul_f32_e32 v10, v20, v10
	v_dual_mul_f32 v6, v24, v6 :: v_dual_mul_f32 v15, v34, v15
	v_mul_f32_e32 v12, v18, v12
	v_mul_f32_e32 v14, v33, v14
	.loc	1 418 9 is_stmt 1               ; generate_amdgcn.py:418:9
	ds_store_2addr_stride64_b32 v62, v0, v8 offset1:2
	ds_store_2addr_stride64_b32 v63, v1, v9 offset1:2
	ds_store_2addr_stride64_b32 v64, v2, v10 offset1:2
	ds_store_2addr_stride64_b32 v65, v3, v11 offset1:2
	ds_store_2addr_stride64_b32 v66, v4, v12 offset1:2
	ds_store_2addr_stride64_b32 v67, v5, v13 offset1:2
	ds_store_2addr_stride64_b32 v68, v6, v14 offset1:2
	...
	ds_load_b32 v15, v50
	ds_load_b32 v17, v51
	v_lshl_add_u32 v18, s29, 3, v52
	v_lshl_add_u32 v19, s29, 4, v52
	v_lshl_add_u32 v20, s29, 5, v52
	s_waitcnt lgkmcnt(15)
	buffer_atomic_add_f32 v0, v52, s[12:15], 0 offen
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v1, v53, s[12:15], 0 offen
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v2, v18, s[12:15], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v3, v54, s[12:15], 0 offen
	s_waitcnt lgkmcnt(11)
	buffer_atomic_add_f32 v4, v19, s[12:15], 0 offen
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v5, v31, s[12:15], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v6, v55, s[12:15], 0 offen
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v7, v56, s[12:15], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v8, v20, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v9, v57, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v10, v58, s[12:15], 0 offen
	v_add_lshl_u32 v11, v16, s17, 2
	v_add_lshl_u32 v0, v16, s0, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v12, v59, s[12:15], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v13, v60, s[12:15], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v14, v61, s[12:15], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v15, v11, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_vgpr, 124
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk4_maskk.kd
