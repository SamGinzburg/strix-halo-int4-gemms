	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp24:
	...
	v_dual_mov_b32 v22, 0 :: v_dual_lshlrev_b32 v3, 4, v3
	.loc	1 299 32                        ; generate_amdgcn.py:299:32
	v_lshrrev_b32_e32 v5, 3, v0
	v_and_or_b32 v12, v0, 15, s24
	.loc	1 300 32                        ; generate_amdgcn.py:300:32
	v_bfe_u32 v2, v0, 4, 1
	.loc	1 299 32                        ; generate_amdgcn.py:299:32
	v_and_b32_e32 v26, 28, v1
	v_and_b32_e32 v1, 0x37c, v1
	v_and_b32_e32 v7, 0x90, v7
	v_and_b32_e32 v10, 0xf70, v10
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v11, 0x90, v11
	v_or3_b32 v3, v8, v3, v9
	v_or_b32_e32 v13, v9, v8
	v_dual_mov_b32 v18, 0 :: v_dual_add_nc_u32 v5, s24, v5
	...
	v_or3_b32 v32, v2, v6, s2
	v_xor_b32_e32 v2, 16, v3
	v_xor_b32_e32 v10, 16, v13
	v_mov_b32_e32 v9, 0
	v_mad_u64_u32 v[27:28], null, s28, v5, v[26:27]
	v_mul_lo_u32 v33, v12, s29
	v_mul_lo_u32 v34, v8, s29
	v_mad_u64_u32 v[28:29], null, s28, v4, v[25:26]
	v_dual_mov_b32 v16, 0 :: v_dual_add_nc_u32 v29, 0, v1
	v_dual_mov_b32 v23, 0 :: v_dual_add_nc_u32 v42, 0, v7
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v45, 0, v3
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v46, 0, v2
	v_mov_b32_e32 v1, s12
	v_or_b32_e32 v35, 2, v32
	v_or_b32_e32 v36, 4, v32
	v_or_b32_e32 v37, 6, v32
	v_or_b32_e32 v38, 8, v32
	v_or_b32_e32 v39, 10, v32
	v_or_b32_e32 v40, 12, v32
	v_or_b32_e32 v41, 14, v32
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v43, 0, v13
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v44, 0, v10
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v47, s1, v26
	.loc	1 318 26                        ; generate_amdgcn.py:318:26
	v_add_nc_u32_e32 v48, s1, v27
	...
	buffer_load_b32 v55, v51, s[20:23], 0 offen
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_b32 v56, v51, s[20:23], 0 offen
	.loc	1 320 26                        ; generate_amdgcn.py:320:26
	...
	.loc	1 332 22                        ; generate_amdgcn.py:332:22
	v_add_lshl_u32 v67, v33, s16, 1
	v_add_lshl_u32 v68, v34, s16, 1
	.loc	1 334 40                        ; generate_amdgcn.py:334:40
	...
	v_add_lshl_u32 v70, v35, s16, 1
	v_add_lshl_u32 v71, v36, s16, 1
	v_add_lshl_u32 v72, v37, s16, 1
	v_add_lshl_u32 v73, v38, s16, 1
	v_add_lshl_u32 v74, v39, s16, 1
	v_add_lshl_u32 v75, v40, s16, 1
	v_add_lshl_u32 v76, v41, s16, 1
	...
	.loc	1 318 26                        ; generate_amdgcn.py:318:26
	s_waitcnt vmcnt(3)
	ds_store_b32 v29, v55 offset:8192
	.loc	1 320 26                        ; generate_amdgcn.py:320:26
	s_waitcnt vmcnt(2)
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v29, v56 offset:9216
	.loc	1 320 26                        ; generate_amdgcn.py:320:26
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v75, v75, v90 :: v_dual_fmac_f32 v22, v57, v83
	v_dual_mul_f32 v77, v77, v90 :: v_dual_fmac_f32 v10, v55, v81
	.loc	1 336 17 is_stmt 0              ; generate_amdgcn.py:336:17
	v_dual_fmac_f32 v9, v47, v81 :: v_dual_fmac_f32 v24, v56, v82
	v_dual_fmac_f32 v23, v48, v82 :: v_dual_fmac_f32 v20, v58, v84
	v_dual_fmac_f32 v21, v49, v83 :: v_dual_fmac_f32 v18, v59, v85
	v_dual_fmac_f32 v19, v50, v84 :: v_dual_fmac_f32 v16, v60, v86
	v_dual_fmac_f32 v17, v51, v85 :: v_dual_fmac_f32 v14, v61, v87
	v_dual_fmac_f32 v15, v52, v86 :: v_dual_fmac_f32 v12, v62, v88
	v_dual_fmac_f32 v13, v53, v87 :: v_dual_fmac_f32 v24, v72, v92
	v_dual_fmac_f32 v11, v54, v88 :: v_dual_fmac_f32 v10, v71, v91
	v_dual_fmac_f32 v9, v63, v91 :: v_dual_fmac_f32 v22, v73, v93
	v_dual_fmac_f32 v23, v64, v92 :: v_dual_fmac_f32 v20, v74, v94
	v_dual_fmac_f32 v21, v65, v93 :: v_dual_fmac_f32 v18, v75, v95
	v_dual_fmac_f32 v19, v66, v94 :: v_dual_fmac_f32 v16, v76, v96
	v_dual_fmac_f32 v17, v67, v95 :: v_dual_fmac_f32 v14, v77, v97
	v_dual_fmac_f32 v15, v68, v96 :: v_dual_fmac_f32 v12, v78, v98
	v_fmac_f32_e32 v13, v69, v97
	v_fmac_f32_e32 v11, v70, v98
	.loc	1 307 5 is_stmt 1               ; generate_amdgcn.py:307:5
...
.LBB0_3:                                ; %._crit_edge
	...
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_cndmask_b32_e64 v2, 0x440, 0, vcc_lo
	...
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_lshl_or_b32 v5, v4, 10, v1
	v_lshlrev_b32_e32 v4, 2, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 392 23 is_stmt 0              ; generate_amdgcn.py:392:23
	v_add3_u32 v1, s0, v3, v2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	...
	v_xad_u32 v9, v5, 40, 0
	ds_store_b64 v7, v[21:22]
...
.Ltmp25:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
