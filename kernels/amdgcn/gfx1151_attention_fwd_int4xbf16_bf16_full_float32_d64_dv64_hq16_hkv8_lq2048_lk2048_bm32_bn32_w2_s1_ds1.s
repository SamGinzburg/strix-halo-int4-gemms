...
.Ltmp0:
	...
	s_add_i32 s8, s1, s8
	.loc	1 774 26                        ; attention.py:774:26
	v_xor_b32_e32 v107, 4, v104
	v_lshl_or_b32 v108, v53, 9, v39
	...
	v_xor_b32_e32 v109, v47, v56
	s_sext_i32_i16 s8, s8
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v21, v24 :: v_dual_add_nc_u32 v110, 0, v58
	.loc	1 821 32                        ; attention.py:821:32
	s_lshl_b32 s8, s8, 10
	.loc	1 759 31                        ; attention.py:759:31
	...
	v_xor_b32_e32 v46, 0x1b0, v108
	v_xor_b32_e32 v47, 16, v109
	v_xor_b32_e32 v53, 32, v109
	v_xor_b32_e32 v54, 48, v109
	v_xor_b32_e32 v56, 0x420, v109
	v_xor_b32_e32 v57, 0x430, v109
	v_xor_b32_e32 v58, 0x410, v109
	.loc	1 821 32                        ; attention.py:821:32
	...
	.loc	1 821 32                        ; attention.py:821:32
	s_add_i32 s54, s8, s3
	v_dual_mov_b32 v8, v24 :: v_dual_add_nc_u32 v113, 0, v51
	v_dual_mov_b32 v9, v24 :: v_dual_add_nc_u32 v112, 0, v49
	v_dual_mov_b32 v11, v24 :: v_dual_add_nc_u32 v114, 0, v55
	...
	v_xor_b32_e32 v111, 64, v106
	v_or_b32_e32 v115, s54, v90
	v_or_b32_e32 v116, s54, v89
	v_or_b32_e32 v117, s54, v88
	v_or_b32_e32 v118, s54, v87
	v_or_b32_e32 v119, s54, v86
	v_or_b32_e32 v120, s54, v101
	v_or_b32_e32 v121, s54, v100
	v_or_b32_e32 v122, s54, v99
	.loc	1 818 13                        ; attention.py:818:13
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_max_f32 v145, v50, v50 :: v_dual_add_nc_u32 v62, 0, v108
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v50, v133, s5, 1
	v_or_b32_e32 v61, s54, v92
	.loc	1 838 37                        ; attention.py:838:37
	v_add_lshl_u32 v45, s74, v115, 1
	v_add_lshl_u32 v46, s74, v116, 1
	v_add_lshl_u32 v47, s74, v117, 1
	v_add_lshl_u32 v51, s74, v118, 1
	v_add_lshl_u32 v52, s74, v119, 1
	v_add_lshl_u32 v53, s74, v120, 1
	v_add_lshl_u32 v54, s74, v121, 1
	v_add_lshl_u32 v55, s74, v122, 1
	v_add_lshl_u32 v61, s74, v61, 1
	.loc	1 890 30                        ; attention.py:890:30
	...
	ds_load_2addr_stride64_b64 v[166:169], v112 offset1:1
	.loc	1 828 33                        ; attention.py:828:33
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 823 32                        ; attention.py:823:32
	ds_load_2addr_stride64_b64 v[32:35], v113 offset1:1
	...
	ds_bpermute_b32 v170, v107, v156
	ds_bpermute_b32 v154, v104, v70
	ds_bpermute_b32 v156, v107, v71
	ds_bpermute_b32 v155, v104, v153
	ds_bpermute_b32 v157, v107, v161
	.loc	1 881 34                        ; attention.py:881:34
...
.Ltmp5:
	...
	v_permlanex16_b32 v45, v38, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	...
	v_permlanex16_b32 v38, v47, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v35, v33, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v11, v11, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v34, v32, s73, 0xfedcba98 op_sel:[1,0]
	...
	ds_bpermute_b32 v69, v111, v151
	ds_bpermute_b32 v66, v106, v148
	ds_bpermute_b32 v152, v106, v152
	ds_bpermute_b32 v156, v111, v156
...
.Ltmp7:
	...
	ds_bpermute_b32 v147, v111, v147
	ds_bpermute_b32 v148, v106, v148
	ds_bpermute_b32 v151, v111, v151
	ds_bpermute_b32 v64, v106, v64
	ds_bpermute_b32 v65, v111, v65
	.loc	1 886 62                        ; attention.py:886:62
...
.Ltmp45:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v55, v170, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 884 24                        ; attention.py:884:24
...
.Ltmp47:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v144, v49, s73, 0xfedcba98 op_sel:[1,0]
.Ltmp48:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:887:24 ] ]
...
.Ltmp51:
	...
	v_permlanex16_b32 v54, v51, s73, 0xfedcba98 op_sel:[1,0]
	.loc	1 885 61                        ; attention.py:885:61
	v_exp_f32_e32 v49, v55
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v53, v146, s73, 0xfedcba98 op_sel:[1,0]
.Ltmp52:
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_bf16_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn32_w2_s1_ds1.num_vgpr, 186
