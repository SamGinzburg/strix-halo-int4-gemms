...
.LBB0_3:                                ; %Flow240
	...
	v_dual_mov_b32 v84, 0 :: v_dual_and_b32 v137, 0x70, v1
	v_dual_mov_b32 v83, 0 :: v_dual_and_b32 v138, 16, v0
...
; %bb.4:                                ; %.preheader.lr.ph
	...
	v_or_b32_e32 v80, s18, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v146, 0 :: v_dual_and_b32 v3, 12, v2
	.loc	1 1309 18                       ; ragged.py:1309:18
	...
	v_mad_u64_u32 v[81:82], null, s34, v3, v[1:2]
	...
	s_cmp_lt_i32 s3, 16
	v_dual_mov_b32 v132, 0 :: v_dual_lshlrev_b32 v13, 5, v0
	v_mad_u64_u32 v[1:2], null, s35, s6, v[80:81]
	v_bfe_i32 v2, v0, 3, 1
	...
	v_mov_b32_e32 v147, 0
	v_dual_mov_b32 v128, 0 :: v_dual_and_b32 v13, 32, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_mul_lo_u32 v152, v1, s16
	v_dual_mov_b32 v144, 0 :: v_dual_lshlrev_b32 v1, 4, v0
	v_and_b32_e32 v2, 0x88, v2
	s_add_i32 s16, s7, s28
	v_dual_mov_b32 v142, 0 :: v_dual_and_b32 v5, 0x270, v1
	v_or_b32_e32 v6, 0x300, v0
	s_delay_alu instid0(VALU_DEP_3)
	v_and_or_b32 v153, 0x70, v1, v2
	v_xor3_b32 v1, v4, v3, v2
	v_mov_b32_e32 v140, 0
	v_dual_mov_b32 v145, 0 :: v_dual_add_nc_u32 v2, 0, v5
	v_add_nc_u32_e32 v5, s16, v108
	v_mov_b32_e32 v143, 0
	v_dual_mov_b32 v141, 0 :: v_dual_mov_b32 v134, 0
	v_xor_b32_e32 v3, 8, v153
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v10, 16, v5
	v_mul_lo_u32 v154, v5, s17
	v_add_nc_u32_e32 v12, 32, v5
	v_add_nc_u32_e32 v5, 48, v5
	v_mov_b32_e32 v139, 0
	v_mul_lo_u32 v155, v10, s17
	v_and_b32_e32 v10, 0xf0, v0
	v_mul_lo_u32 v156, v12, s17
	v_mul_lo_u32 v157, v5, s17
	v_dual_mov_b32 v130, 0 :: v_dual_lshlrev_b32 v5, 1, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v135, 0 :: v_dual_lshlrev_b32 v12, 2, v10
	v_xor_b32_e32 v4, 0x108, v153
	v_or_b32_e32 v7, 0x700, v0
	v_or_b32_e32 v8, 0xb00, v0
	v_or_b32_e32 v9, 0xf00, v0
	v_dual_mov_b32 v136, 0 :: v_dual_add_nc_u32 v11, 0, v137
	v_dual_mov_b32 v126, 0 :: v_dual_and_b32 v5, 28, v5
	v_cndmask_b32_e64 v14, 0, 1, s30
	v_add3_u32 v12, 0, v12, v13
	v_dual_mov_b32 v133, 0 :: v_dual_lshlrev_b32 v10, 1, v10
	v_mad_u64_u32 v[82:83], null, s34, 3, v[81:82]
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s0, s35, v80
	v_dual_mov_b32 v149, 0 :: v_dual_add_nc_u32 v150, s34, v81
	v_lshl_add_u32 v151, s34, 1, v81
	.loc	1 1520 37                       ; ragged.py:1520:37
	s_mul_i32 s23, s6, s17
	v_cmp_ne_u32_e64 s6, 1, v14
	v_dual_mov_b32 v131, 0 :: v_dual_add_nc_u32 v158, v2, v1
	v_dual_mov_b32 v124, 0 :: v_dual_add_nc_u32 v159, 0, v3
	v_dual_mov_b32 v129, 0 :: v_dual_add_nc_u32 v160, 0, v4
	v_dual_mov_b32 v122, 0 :: v_dual_add_nc_u32 v161, 0, v0
	v_dual_mov_b32 v127, 0 :: v_dual_add_nc_u32 v162, 0, v6
	v_dual_mov_b32 v120, 0 :: v_dual_add_nc_u32 v163, 0, v7
	v_dual_mov_b32 v125, 0 :: v_dual_add_nc_u32 v164, 0, v8
	v_dual_mov_b32 v118, 0 :: v_dual_add_nc_u32 v165, 0, v9
	v_dual_mov_b32 v123, 0 :: v_dual_add_nc_u32 v166, v11, v108
	v_dual_mov_b32 v116, 0 :: v_dual_add_nc_u32 v167, v12, v5
	v_dual_mov_b32 v121, 0 :: v_dual_add_nc_u32 v168, 0, v10
...
.LBB0_5:                                ; %._crit_edge
	...
	v_add_lshl_u32 v32, v154, s33, 1
	.loc	1 1520 25                       ; ragged.py:1520:25
	s_add_i32 s10, s33, s23
	.loc	1 1512 40                       ; ragged.py:1512:40
	v_add_lshl_u32 v33, v155, s33, 1
	v_add_lshl_u32 v34, v156, s33, 1
	.loc	1 1520 25                       ; ragged.py:1520:25
	s_mul_i32 s10, s10, s35
	.loc	1 1512 40                       ; ragged.py:1512:40
	v_add_lshl_u32 v35, v157, s33, 1
	.loc	1 1519 40                       ; ragged.py:1519:40
	v_add_lshl_u32 v36, v80, s10, 1
	.loc	1 1512 40                       ; ragged.py:1512:40
	...
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v0, v0, v35 :: v_dual_fmac_f32 v147, v39, v18
	.loc	1 1525 17                       ; ragged.py:1525:17
	v_dual_fmac_f32 v149, v37, v16 :: v_dual_fmac_f32 v148, v38, v17
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v146, v40, v19 :: v_dual_fmac_f32 v145, v41, v20
	v_dual_fmac_f32 v144, v42, v21 :: v_dual_fmac_f32 v143, v43, v22
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v142, v44, v23 :: v_dual_fmac_f32 v141, v45, v10
	v_dual_fmac_f32 v140, v46, v11 :: v_dual_fmac_f32 v139, v47, v12
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v136, v48, v13 :: v_dual_fmac_f32 v135, v49, v24
	v_dual_fmac_f32 v134, v50, v25 :: v_dual_fmac_f32 v133, v51, v26
	v_dual_fmac_f32 v132, v32, v27 :: v_dual_fmac_f32 v129, v54, v18
	v_dual_fmac_f32 v131, v52, v16 :: v_dual_fmac_f32 v130, v53, v17
	v_dual_fmac_f32 v128, v55, v19 :: v_dual_fmac_f32 v127, v56, v20
	v_dual_fmac_f32 v126, v57, v21 :: v_dual_fmac_f32 v125, v58, v22
	v_dual_fmac_f32 v124, v59, v23 :: v_dual_fmac_f32 v123, v60, v10
	v_dual_fmac_f32 v122, v61, v11 :: v_dual_fmac_f32 v121, v62, v12
	v_dual_fmac_f32 v120, v63, v13 :: v_dual_fmac_f32 v117, v65, v26
	v_dual_fmac_f32 v119, v67, v24 :: v_dual_fmac_f32 v118, v66, v25
	v_dual_fmac_f32 v116, v33, v27 :: v_dual_fmac_f32 v115, v31, v16
	v_dual_fmac_f32 v114, v30, v17 :: v_dual_fmac_f32 v113, v29, v18
	v_dual_fmac_f32 v112, v28, v19 :: v_dual_fmac_f32 v109, v69, v22
	v_dual_fmac_f32 v111, v64, v20 :: v_dual_fmac_f32 v106, v71, v10
	v_dual_fmac_f32 v110, v68, v21 :: v_dual_fmac_f32 v107, v70, v23
	v_dual_fmac_f32 v105, v72, v11 :: v_dual_fmac_f32 v104, v73, v12
	v_dual_fmac_f32 v103, v74, v13 :: v_dual_fmac_f32 v102, v75, v24
	v_dual_fmac_f32 v101, v76, v25 :: v_dual_fmac_f32 v100, v77, v26
	v_dual_fmac_f32 v99, v34, v27 :: v_dual_fmac_f32 v98, v15, v16
	v_dual_fmac_f32 v97, v14, v17 :: v_dual_fmac_f32 v96, v36, v18
	v_dual_fmac_f32 v95, v78, v19 :: v_dual_fmac_f32 v94, v79, v20
	v_dual_fmac_f32 v93, v169, v21 :: v_dual_fmac_f32 v90, v7, v10
	v_dual_fmac_f32 v92, v9, v22 :: v_dual_fmac_f32 v91, v8, v23
	v_dual_fmac_f32 v89, v6, v11 :: v_dual_fmac_f32 v88, v5, v12
	v_dual_fmac_f32 v87, v4, v13 :: v_dual_fmac_f32 v86, v3, v24
	v_dual_fmac_f32 v85, v2, v25 :: v_dual_fmac_f32 v84, v1, v26
	v_fmac_f32_e32 v83, v0, v27
	.loc	1 1421 19                       ; ragged.py:1421:19
...
.LBB0_8:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v64, s11, v81
	v_add_nc_u32_e32 v65, s11, v150
	v_add_nc_u32_e32 v66, s11, v151
	v_add_nc_u32_e32 v67, s11, v82
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_mov_b32 s11, s27
	.loc	1 1436 38                       ; ragged.py:1436:38
	v_cndmask_b32_e64 v64, 0x80000000, v64, s1
	buffer_load_u8 v68, v64, s[24:27], 0 offen
	v_cndmask_b32_e64 v64, 0x80000000, v65, s1
	buffer_load_u8 v65, v64, s[24:27], 0 offen
	v_cndmask_b32_e64 v64, 0x80000000, v66, s1
	buffer_load_u8 v66, v64, s[24:27], 0 offen
	v_cndmask_b32_e64 v64, 0x80000000, v67, s1
	.loc	1 1437 46                       ; ragged.py:1437:46
	v_add_nc_u32_e32 v67, s10, v152
	...
	buffer_load_b128 v[169:172], v67, s[8:11], 0 offen
	.loc	1 1436 38                       ; ragged.py:1436:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_or_b16 v64.h, v66.l, v64.l
	v_lshlrev_b16 v64.l, 8, v65.l
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_waitcnt vmcnt(0)
	v_lshrrev_b32_e32 v173, 8, v169
	.loc	1 1436 38                       ; ragged.py:1436:38
	v_or_b16 v64.l, v68.l, v64.l
	ds_store_b32 v158, v64
	v_add_nc_u32_e32 v64, 0, v153
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[76:79], v64 offset1:32
	ds_load_2addr_b64 v[64:67], v64 offset0:64 offset1:96
	ds_load_2addr_stride64_b64 v[72:75], v159 offset1:1
	ds_load_2addr_stride64_b64 v[68:71], v160 offset1:1
	.loc	1 1437 38                       ; ragged.py:1437:38
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v161, v169
	ds_store_b8 v161, v173 offset:256
	ds_store_b8_d16_hi v161, v169 offset:512
	v_lshrrev_b32_e32 v169, 24, v169
	ds_store_b8 v162, v169
	ds_store_b8 v161, v170 offset:1024
	v_lshrrev_b32_e32 v169, 8, v170
	ds_store_b8 v161, v169 offset:1280
	ds_store_b8_d16_hi v161, v170 offset:1536
	v_lshrrev_b32_e32 v169, 24, v170
	ds_store_b8 v163, v169
	ds_store_b8 v161, v171 offset:2048
	v_lshrrev_b32_e32 v169, 8, v171
	ds_store_b8 v161, v169 offset:2304
	ds_store_b8_d16_hi v161, v171 offset:2560
	v_lshrrev_b32_e32 v169, 24, v171
	ds_store_b8 v164, v169
	ds_store_b8 v161, v172 offset:3072
	v_lshrrev_b32_e32 v169, 8, v172
	ds_store_b8 v161, v169 offset:3328
	ds_store_b8_d16_hi v161, v172 offset:3584
	v_lshrrev_b32_e32 v169, 24, v172
	ds_store_b8 v165, v169
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[169:170], v[76:77], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[169:170], v[68:69], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[169:170], v[64:65], v[32:39] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[171:172], v[72:73], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[16:23], v[171:172], v[78:79], v[16:23] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[171:172], v[74:75], v[32:39] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[8:15], v[173:174], v[76:77], v[8:15] neg_lo:[1,1,0]
	ds_load_u8 v76, v166 offset:3456
	ds_load_u8 v77, v166 offset:3200
	v_wmma_i32_16x16x16_iu4 v[24:31], v[173:174], v[68:69], v[24:31] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[40:47], v[173:174], v[64:65], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[56:63], v[173:174], v[70:71], v[56:63] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	ds_load_u8 v77, v166 offset:3968
	ds_load_u8 v175, v166 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v77, v175, v77, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v77, v77, 16, v76
	ds_load_u8 v76, v166 offset:2432
	ds_load_u8 v175, v166 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v175, v76, 0xc0c0004
	ds_load_u8 v175, v166 offset:2944
	ds_load_u8 v176, v166 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v175, v176, v175, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v76, v175, 16, v76
	v_wmma_i32_16x16x16_iu4 v[8:15], v[76:77], v[72:73], v[8:15] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[24:31], v[76:77], v[78:79], v[24:31] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[40:47], v[76:77], v[74:75], v[40:47] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[56:63], v[76:77], v[66:67], v[56:63] neg_lo:[1,1,0]
	.loc	1 1426 27                       ; ragged.py:1426:27
...
.LBB0_10:                               ; %._crit_edge8
	...
	buffer_store_b32 v96, v17, s[20:23], 0 offen
	...
	buffer_store_b32 v92, v13, s[20:23], 0 offen
	...
	buffer_store_b32 v88, v9, s[20:23], 0 offen
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s3, s2, s7
	.loc	1 1545 17                       ; ragged.py:1545:17
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.num_vgpr, 185
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_tt_sc32_evenk_float32_bm64_bn256_bk64_w8_s3_sk1.numbered_sgpr, 38
