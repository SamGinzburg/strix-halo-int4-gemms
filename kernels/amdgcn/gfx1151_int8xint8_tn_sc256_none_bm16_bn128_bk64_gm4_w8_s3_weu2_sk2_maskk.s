...
; %bb.4:                                ; %.lr.ph
	...
	v_or_b32_e32 v48, 0x100, v3
	v_add_nc_u32_e32 v5, 0x101, v11
	v_or_b32_e32 v49, 0x100, v2
	v_mov_b32_e32 v13, 0
	v_and_or_b32 v6, 0x210, v8, v7
	v_add_nc_u32_e32 v7, 0x100, v11
	v_mul_lo_u32 v5, s35, v5
	v_add3_u32 v8, s18, v2, 0x100
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk2_maskk.num_vgpr, 156
