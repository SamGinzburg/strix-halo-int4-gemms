...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v27, v25 :: v_dual_and_b32 v6, 16, v0
	...
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v99, 0, v6
	v_lshl_or_b32 v3, v3, 4, v3
	v_lshl_or_b32 v5, v5, 4, v5
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v101, 0, v8
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v102, 0, v9
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v92, 0x5040504, v3
	v_dual_mov_b32 v18, v25 :: v_dual_and_b32 v93, 0x7060706, v5
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v103, 0, v10
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v104, 0, v11
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v105, 0, v13
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 123
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 45
