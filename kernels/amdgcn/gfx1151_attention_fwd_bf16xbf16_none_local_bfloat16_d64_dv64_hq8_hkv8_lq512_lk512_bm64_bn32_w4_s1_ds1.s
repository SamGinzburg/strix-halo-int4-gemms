	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v13, v7 :: v_dual_and_b32 v52, 0x70, v24
	s_delay_alu instid0(VALU_DEP_3)
	...
	.loc	1 599 26                        ; attention.py:599:26
	s_clause 0x3
	buffer_load_b128 v[36:39], v2, s[48:51], 0 offen
	buffer_load_b128 v[40:43], v3, s[48:51], 0 offen
	buffer_load_b128 v[44:47], v4, s[48:51], 0 offen
	buffer_load_b128 v[48:51], v1, s[48:51], 0 offen
	v_mov_b32_e32 v4, v7
	.loc	1 570 31                        ; attention.py:570:31
	v_or_b32_e32 v80, v35, v65
	v_dual_mov_b32 v1, v7 :: v_dual_and_b32 v82, 16, v0
	v_mov_b32_e32 v2, v7
	.loc	1 599 26                        ; attention.py:599:26
	v_xor_b32_e32 v52, v83, v52
	...
	s_waitcnt vmcnt(2)
	ds_store_b128 v84, v[40:43] offset:2048
	s_waitcnt vmcnt(1)
	ds_store_b128 v84, v[44:47] offset:4096
	s_waitcnt vmcnt(0)
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v72, 0xff800000 :: v_dual_add_nc_u32 v3, s4, v35
	...
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v87, s9, v3
	...
	v_or_b32_e32 v88, v2, v0
	v_mov_b32_e32 v0, 0x5410
	ds_load_b128 v[52:55], v7
	ds_load_b128 v[48:51], v8
	.loc	1 629 13                        ; attention.py:629:13
	v_add3_u32 v7, s10, s57, v64
	v_cndmask_b32_e64 v1, 0x3276, v1, s3
	.loc	1 599 26                        ; attention.py:599:26
	ds_load_b128 v[44:47], v5
	ds_load_b128 v[40:43], v6
	v_cndmask_b32_e64 v0, 0x1054, v0, s3
	v_dual_mov_b32 v27, v24 :: v_dual_add_nc_u32 v10, 16, v7
	v_mov_b32_e32 v29, v24
	v_lshl_or_b32 v1, v1, 8, v1
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v0, v0, 8, v0
	.loc	1 629 13                        ; attention.py:629:13
	v_mul_lo_u32 v13, s47, v7
	v_mul_lo_u32 v12, s47, v10
	v_mul_lo_u32 v10, s46, v10
	v_dual_mov_b32 v28, v24 :: v_dual_and_b32 v1, 0x760076, v1
	v_and_b32_e32 v0, 0x540054, v0
	v_xor_b32_e32 v3, 16, v88
	v_xor_b32_e32 v4, 32, v88
	v_xor_b32_e32 v5, 48, v88
	v_xor_b32_e32 v6, 64, v88
	v_lshl_or_b32 v0, v0, 4, v0
	v_xor_b32_e32 v8, 0x50, v88
	v_xor_b32_e32 v9, 0x60, v88
	v_xor_b32_e32 v11, 0x70, v88
	v_lshl_or_b32 v1, v1, 4, v1
	v_dual_mov_b32 v30, v24 :: v_dual_and_b32 v89, 0x5040504, v0
	v_mul_lo_u32 v0, s46, v7
	v_lshl_add_u32 v92, v12, 1, v2
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v31, v24 :: v_dual_and_b32 v90, 0x7060706, v1
	v_lshl_add_u32 v93, v13, 1, v2
	v_lshl_add_u32 v94, v10, 1, v2
	v_dual_mov_b32 v17, v24 :: v_dual_add_nc_u32 v96, 0, v3
	v_lshl_add_u32 v95, v0, 1, v2
	v_dual_mov_b32 v16, v24 :: v_dual_add_nc_u32 v97, 0, v4
	v_dual_mov_b32 v19, v24 :: v_dual_add_nc_u32 v98, 0, v5
	v_dual_mov_b32 v18, v24 :: v_dual_add_nc_u32 v99, 0, v6
	v_dual_mov_b32 v21, v24 :: v_dual_add_nc_u32 v100, 0, v8
	v_dual_mov_b32 v20, v24 :: v_dual_add_nc_u32 v101, 0, v9
	v_dual_mov_b32 v23, v24 :: v_dual_add_nc_u32 v102, 0, v11
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_cndmask_b32 v64, 0x80000000, v95 :: v_dual_add_nc_u32 v73, 0, v88
	v_dual_cndmask_b32 v68, 0x80000000, v94 :: v_dual_add_nc_u32 v79, 0, v83
	...
	.loc	1 629 13                        ; attention.py:629:13
	v_add_nc_u32_e32 v95, s46, v95
	.loc	1 658 32                        ; attention.py:658:32
	s_waitcnt vmcnt(1)
	ds_store_b128 v84, v[64:67]
	s_waitcnt vmcnt(0)
	ds_store_b128 v84, v[68:71] offset:2048
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[68:71], v96
	...
	v_cmp_le_i32_e64 s33, v109, v87
	.loc	1 671 21 is_stmt 0              ; attention.py:671:21
	s_and_b32 s31, s31, s33
	s_and_b32 s31, s2, s31
	.loc	1 663 30 is_stmt 1              ; attention.py:663:30
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[119:126], v[64:71], v[48:55], v[119:126]
	.loc	1 658 32                        ; attention.py:658:32
	ds_load_b128 v[64:67], v97 offset:2048
	ds_load_b128 v[68:71], v98 offset:2048
	.loc	1 663 30                        ; attention.py:663:30
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 658 32                        ; attention.py:658:32
	ds_load_b128 v[64:67], v99 offset:2048
	ds_load_b128 v[68:71], v100 offset:2048
	.loc	1 663 30                        ; attention.py:663:30
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[127:134], v[64:71], v[40:47], v[127:134]
	.loc	1 658 32                        ; attention.py:658:32
	ds_load_b128 v[68:71], v102
	ds_load_b128 v[64:67], v101
	.loc	1 663 30                        ; attention.py:663:30
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[119:126], v[64:71], v[32:39], v[119:126]
	.loc	1 658 32                        ; attention.py:658:32
	ds_load_b128 v[64:67], v101 offset:2048
	ds_load_b128 v[68:71], v102 offset:2048
	...
	v_cndmask_b32_e64 v64, 0x80000000, v93, s0
	v_cndmask_b32_e64 v65, 0x80000000, v92, s0
	s_clause 0x1
...
.Ltmp2:
	...
	.loc	1 671 30                        ; attention.py:671:30
	v_cmp_le_i32_e64 s30, v105, v87
	.loc	1 670 30                        ; attention.py:670:30
	v_cmp_ge_i32_e64 s34, v109, v86
	.loc	1 671 30                        ; attention.py:671:30
	v_cmp_le_i32_e64 s35, v109, v87
	.loc	1 671 21 is_stmt 0              ; attention.py:671:21
...
.Ltmp7:
	...
	v_dual_sub_f32 v64, v74, v103 :: v_dual_add_nc_u32 v93, s60, v93
	...
	v_mov_b16_e32 v70.h, v105.h
	v_mov_b16_e32 v70.l, v120.h
	v_add3_u32 v64, v107, v64, 0x7fff
	...
	v_add3_u32 v67, v117, v67, 0x7fff
	v_and_b32_e32 v70, 1, v70
	v_cmp_o_f32_e64 s12, v120, v120
	v_permlanex16_b32 v65, v66, s61, 0xfedcba98 op_sel:[1,0]
	v_cmp_o_f32_e64 s11, v121, v121
	v_cndmask_b16 v67.h, 0x7fff, v67.h, s15
	v_add3_u32 v70, v120, v70, 0x7fff
	v_cmp_o_f32_e64 s13, v119, v119
	v_perm_b32 v64, v65, v66, v89
	v_perm_b32 v65, v65, v66, v90
	.loc	1 690 62                        ; attention.py:690:62
	...
	v_cmp_o_f32_e64 s16, v116, v116
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v66, 1, v66
	v_add3_u32 v66, v116, v66, 0x7fff
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_cndmask_b16 v67.l, 0x7fff, v66.h, s16
	v_permlanex16_b32 v68, v67, s61, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_perm_b32 v66, v68, v67, v89
	v_perm_b32 v67, v68, v67, v90
	.loc	1 690 62                        ; attention.py:690:62
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add3_u32 v68, v118, v68, 0x7fff
	v_cndmask_b16 v69.l, 0x7fff, v68.h, s14
	v_and_b32_e32 v68, 1, v105
	v_mov_b16_e32 v105.l, v121.h
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v70, 1, v105
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_perm_b32 v68, v73, v69, v89
	v_perm_b32 v69, v73, v69, v90
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_perm_b32 v70, v73, v71, v89
	v_perm_b32 v71, v73, v71, v90
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v72, v91
	ds_load_u16_d16 v75, v91 offset:768
	ds_load_u16_d16 v76, v91 offset:1024
	ds_load_u16_d16 v77, v91 offset:1280
	ds_load_u16_d16 v78, v91 offset:1536
	ds_load_u16_d16 v79, v91 offset:1792
	ds_load_u16_d16 v74, v91 offset:512
	ds_load_u16_d16 v73, v91 offset:256
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v72, v91 offset:128
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v75, v91 offset:896
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v76, v91 offset:1152
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v77, v91 offset:1408
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v78, v91 offset:1664
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v79, v91 offset:1920
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v74, v91 offset:640
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v73, v91 offset:384
	.loc	1 699 23                        ; attention.py:699:23
	...
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v72, v91 offset:32
	ds_load_u16_d16 v73, v91 offset:288
	ds_load_u16_d16 v74, v91 offset:544
	ds_load_u16_d16 v75, v91 offset:800
	ds_load_u16_d16 v76, v91 offset:1056
	ds_load_u16_d16 v77, v91 offset:1312
	ds_load_u16_d16 v78, v91 offset:1568
	ds_load_u16_d16 v79, v91 offset:1824
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v72, v91 offset:160
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v73, v91 offset:416
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v74, v91 offset:672
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v75, v91 offset:928
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v76, v91 offset:1184
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v77, v91 offset:1440
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v78, v91 offset:1696
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v79, v91 offset:1952
	.loc	1 700 23                        ; attention.py:700:23
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[16:23], v[72:79], v[64:71], v[16:23]
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v74, v91 offset:576
	ds_load_u16_d16 v75, v91 offset:832
	ds_load_u16_d16 v76, v91 offset:1088
	ds_load_u16_d16 v77, v91 offset:1344
	ds_load_u16_d16 v78, v91 offset:1600
	ds_load_u16_d16 v79, v91 offset:1856
	ds_load_u16_d16 v72, v91 offset:64
	ds_load_u16_d16 v73, v91 offset:320
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v74, v91 offset:704
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v75, v91 offset:960
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v76, v91 offset:1216
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v77, v91 offset:1472
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v78, v91 offset:1728
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v79, v91 offset:1984
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v72, v91 offset:192
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v73, v91 offset:448
	.loc	1 700 23                        ; attention.py:700:23
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[8:15], v[72:79], v[64:71], v[8:15]
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v73, v91 offset:352
	ds_load_u16_d16 v72, v91 offset:96
	ds_load_u16_d16 v74, v91 offset:608
	ds_load_u16_d16 v75, v91 offset:864
	ds_load_u16_d16 v76, v91 offset:1120
	ds_load_u16_d16 v77, v91 offset:1376
	ds_load_u16_d16 v78, v91 offset:1632
	ds_load_u16_d16 v79, v91 offset:1888
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v73, v91 offset:480
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v72, v91 offset:224
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v74, v91 offset:736
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v75, v91 offset:992
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v76, v91 offset:1248
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v77, v91 offset:1504
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v78, v91 offset:1760
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v79, v91 offset:2016
	.loc	1 700 23                        ; attention.py:700:23
	s_waitcnt lgkmcnt(0)
...
.Ltmp19:
	...
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v105, v91 offset:2048
	ds_load_u16_d16 v107, v91 offset:2560
	ds_load_u16_d16 v108, v91 offset:2816
	ds_load_u16_d16 v109, v91 offset:3072
	ds_load_u16_d16 v110, v91 offset:3328
	ds_load_u16_d16 v111, v91 offset:3584
	ds_load_u16_d16 v112, v91 offset:3840
	ds_load_u16_d16 v106, v91 offset:2304
	.loc	1 700 30                        ; attention.py:700:30
	...
	.loc	1 694 30                        ; attention.py:694:30
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v105, v91 offset:2176
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v107, v91 offset:2688
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v108, v91 offset:2944
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v109, v91 offset:3200
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v110, v91 offset:3456
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v111, v91 offset:3712
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v112, v91 offset:3968
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v106, v91 offset:2432
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp21:
	.loc	1 700 30                        ; attention.py:700:30
	v_perm_b32 v64, v69, v65, v89
	v_perm_b32 v65, v69, v65, v90
	v_perm_b32 v66, v71, v67, v89
	v_permlanex16_b32 v69, v70, s61, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v67, v71, v67, v90
...
.Ltmp23:
	.loc	1 700 30                        ; attention.py:700:30
	v_perm_b32 v68, v69, v70, v89
	v_perm_b32 v69, v69, v70, v90
	v_perm_b32 v70, v71, v78, v89
	v_perm_b32 v71, v71, v78, v90
.Ltmp24:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
...
.Ltmp25:
	...
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v105, v91 offset:2080
	ds_load_u16_d16 v106, v91 offset:2336
	ds_load_u16_d16 v107, v91 offset:2592
	ds_load_u16_d16 v108, v91 offset:2848
	ds_load_u16_d16 v109, v91 offset:3104
	ds_load_u16_d16 v110, v91 offset:3360
	ds_load_u16_d16 v111, v91 offset:3616
	ds_load_u16_d16 v112, v91 offset:3872
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v105, v91 offset:2208
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v106, v91 offset:2464
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v107, v91 offset:2720
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v108, v91 offset:2976
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v109, v91 offset:3232
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v110, v91 offset:3488
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v111, v91 offset:3744
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v112, v91 offset:4000
	...
	.loc	1 694 30                        ; attention.py:694:30
	ds_load_u16_d16 v105, v91 offset:2112
	ds_load_u16_d16 v106, v91 offset:2368
	ds_load_u16_d16 v107, v91 offset:2624
	ds_load_u16_d16 v108, v91 offset:2880
	ds_load_u16_d16 v109, v91 offset:3136
	ds_load_u16_d16 v110, v91 offset:3392
	ds_load_u16_d16 v111, v91 offset:3648
	ds_load_u16_d16 v112, v91 offset:3904
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v105, v91 offset:2240
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v106, v91 offset:2496
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v107, v91 offset:2752
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v108, v91 offset:3008
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v109, v91 offset:3264
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v110, v91 offset:3520
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v111, v91 offset:3776
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v112, v91 offset:4032
	.loc	1 700 23                        ; attention.py:700:23
	s_waitcnt lgkmcnt(0)
...
.LBB0_3:                                ; %._crit_edge
	...
	v_div_scale_f32 v40, null, v81, v81, v28
	...
	v_div_scale_f32 v39, s5, v28, v81, v28
	v_fma_f32 v43, -v43, v47, v48
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_mul_f32_e32 v44, v39, v38
	v_div_scale_f32 v48, null, v81, v81, v31
	...
	v_div_fixup_f32 v27, v43, v81, v27
	v_fma_f32 v36, -v51, v47, v45
	v_fmac_f32_e32 v44, v46, v38
	v_div_scale_f32 v46, null, v81, v81, v16
	v_div_scale_f32 v43, s4, v30, v81, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v49, s6, v31, v81, v31
	v_div_scale_f32 v43, null, v81, v81, v18
	...
	v_div_scale_f32 v44, s4, v17, v81, v17
	v_fma_f32 v36, -v46, v38, v47
	v_div_scale_f32 v46, s5, v18, v81, v18
	...
	v_div_scale_f32 v49, null, v81, v81, v20
	s_mov_b32 vcc_lo, s1
	v_div_fixup_f32 v31, v37, v81, v31
	v_fma_f32 v37, -v52, v45, v44
	v_div_fmas_f32 v36, v36, v40, v38
	v_rcp_f32_e32 v38, v49
	s_delay_alu instid0(TRANS32_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fma_f32 v47, -v48, v41, 1.0
	v_div_scale_f32 v40, s1, v19, v81, v19
	v_div_fixup_f32 v16, v36, v81, v16
	s_mov_b32 vcc_lo, s4
	...
	s_mov_b32 vcc_lo, s5
	v_div_fixup_f32 v17, v36, v81, v17
	...
	v_div_scale_f32 v44, s4, v20, v81, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fma_f32 v36, -v43, v37, v46
	v_div_scale_f32 v43, s6, v21, v81, v21
	...
	s_mov_b32 vcc_lo, s1
	v_div_scale_f32 v48, null, v81, v81, v23
	v_div_fixup_f32 v18, v36, v81, v18
	...
	v_div_scale_f32 v49, null, v81, v81, v9
	v_div_scale_f32 v41, null, v81, v81, v8
	v_div_fmas_f32 v36, v36, v38, v39
	v_fma_f32 v38, -v47, v46, v43
	s_mov_b32 vcc_lo, s6
	v_div_scale_f32 v43, s4, v23, v81, v23
	v_rcp_f32_e32 v44, v41
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_div_fmas_f32 v38, v38, v51, v46
	v_mul_f32_e32 v39, v37, v42
	v_div_fixup_f32 v20, v36, v81, v20
	v_div_scale_f32 v51, null, v81, v81, v11
	v_div_fixup_f32 v21, v38, v81, v21
	v_rcp_f32_e32 v38, v49
	...
	s_mov_b32 vcc_lo, s6
	v_div_fixup_f32 v8, v36, v81, v8
	v_rcp_f32_e32 v45, v43
	v_div_fixup_f32 v9, v38, v81, v9
	...
	v_div_scale_f32 v41, null, v81, v81, v14
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v38, s5, v13, v81, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v44, null, v81, v81, v1
	v_div_scale_f32 v37, null, v81, v81, v0
	v_div_fixup_f32 v12, v36, v81, v12
	v_fma_f32 v36, -v46, v48, 1.0
	s_delay_alu instid0(VALU_DEP_4)
	v_rcp_f32_e32 v50, v44
	v_div_scale_f32 v39, s1, v14, v81, v14
	s_mov_b32 vcc_lo, s5
	v_fmac_f32_e32 v48, v36, v48
	v_div_scale_f32 v36, s4, v15, v81, v15
	...
	v_div_scale_f32 v52, s6, v1, v81, v1
	...
	s_mov_b32 vcc_lo, s1
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v13, v38, v81, v13
	...
	v_div_scale_f32 v43, null, v81, v81, v3
	v_fmac_f32_e32 v53, v42, v53
	v_fma_f32 v39, -v37, v54, v51
	v_div_scale_f32 v42, s1, v2, v81, v2
	...
	v_rcp_f32_e32 v45, v43
	v_div_fixup_f32 v15, v36, v81, v15
	v_div_fixup_f32 v14, v38, v81, v14
	v_div_scale_f32 v47, null, v81, v81, v7
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_div_fixup_f32 v0, v37, v81, v0
	v_div_fmas_f32 v40, v40, v50, v41
	v_div_scale_f32 v37, null, v81, v81, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	...
	v_div_scale_f32 v51, s5, v6, v81, v6
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_div_fmas_f32 v36, v36, v53, v39
	v_rcp_f32_e32 v39, v37
	v_div_scale_f32 v41, vcc_lo, v3, v81, v3
	...
	v_div_scale_f32 v53, s6, v7, v81, v7
	v_fmac_f32_e32 v39, v36, v39
	v_div_scale_f32 v36, s1, v4, v81, v4
	v_fmac_f32_e32 v45, v38, v45
	v_div_scale_f32 v38, null, v81, v81, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v48, s4, v5, v81, v5
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 135
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 62
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     64
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.kd
