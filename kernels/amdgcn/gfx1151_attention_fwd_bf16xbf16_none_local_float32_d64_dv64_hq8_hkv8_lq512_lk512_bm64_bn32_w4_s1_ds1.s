...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v5, 16, v0
	v_dual_mov_b32 v18, v25 :: v_dual_add_nc_u32 v11, 16, v8
	...
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v97, 0, v5
	v_and_b32_e32 v1, 0x540054, v1
	v_and_b32_e32 v2, 0x760076, v2
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v98, 0, v6
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v99, 0, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v1, v1, 4, v1
	v_lshl_or_b32 v2, v2, 4, v2
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v100, 0, v9
	v_add_nc_u32_e32 v101, 0, v10
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v10, v25 :: v_dual_and_b32 v89, 0x5040504, v1
	v_mov_b32_e32 v20, v25
	v_mul_lo_u32 v1, s34, v8
	v_dual_mov_b32 v31, v25 :: v_dual_and_b32 v90, 0x7060706, v2
	v_dual_mov_b32 v21, v25 :: v_dual_add_nc_u32 v102, 0, v12
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 135
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.numbered_sgpr, 61
