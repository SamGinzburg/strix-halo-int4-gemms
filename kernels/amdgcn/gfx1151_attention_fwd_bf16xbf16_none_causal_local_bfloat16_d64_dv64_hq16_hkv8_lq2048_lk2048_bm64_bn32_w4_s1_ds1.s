...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 758 19                        ; attention.py:758:19
	s_add_i32 s1, s1, s3
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v5, s10, v36
	.loc	1 852 32                        ; attention.py:852:32
	...
	v_dual_mov_b32 v28, v25 :: v_dual_lshlrev_b32 v15, 3, v0
	v_xad_u32 v7, v2, 64, 0
	v_xad_u32 v9, v2, 48, 0
	v_xad_u32 v10, v2, 32, 0
	v_xad_u32 v11, v2, 16, 0
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v2, 0, v2
	...
	v_bfe_i32 v0, v0, 3, 1
	v_dual_mov_b32 v30, v25 :: v_dual_and_b32 v15, 48, v15
	...
	v_cndmask_b32_e64 v6, 0x3276, v6, s20
	...
	v_dual_mov_b32 v73, 0xff800000 :: v_dual_add_nc_u32 v112, 0, v17
	v_mov_b32_e32 v17, v25
	v_lshl_or_b32 v2, v2, 4, v2
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v1, s1, v1
	...
	v_lshl_or_b32 v94, v66, 9, v4
	v_add_nc_u32_e32 v16, 16, v2
	v_dual_mov_b32 v77, v25 :: v_dual_add_nc_u32 v114, 0, v19
	...
	v_dual_mov_b32 v29, v25 :: v_dual_add_nc_u32 v8, s9, v5
	...
	v_and_b32_e32 v95, 0x7060706, v6
	v_xor_b32_e32 v4, 0x90, v94
	v_xor_b32_e32 v6, 0x120, v94
	...
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v102, 0, v9
	v_add_nc_u32_e32 v103, 0, v10
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v105, 0, v12
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v107, 0, v14
	v_min_i32_e32 v108, v5, v8
	v_dual_mov_b32 v12, v25 :: v_dual_add_nc_u32 v109, 0, v4
	v_dual_mov_b32 v7, v25 :: v_dual_add_nc_u32 v110, 0, v6
	v_dual_mov_b32 v14, v25 :: v_dual_add_nc_u32 v111, 0, v15
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v113, 0, v18
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v115, 0, v21
	v_add_nc_u32_e32 v116, 0, v22
	v_dual_mov_b32 v4, v25 :: v_dual_add_nc_u32 v117, 0, v23
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_ge_i32_e64 s10, v108, v81
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s11, v86, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s12, v108, v86
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s13, v87, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s14, v108, v87
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s15, v88, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s16, v108, v88
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v126, v92
	.loc	1 866 21                        ; attention.py:866:21
	v_cmp_ge_i32_e64 s18, v108, v126
	.loc	1 866 30                        ; attention.py:866:30
	...
	s_and_b32 s13, s21, s19
	s_and_b32 s14, s23, s22
	s_and_b32 s15, s25, s24
	s_and_b32 s16, s27, s26
	s_and_b32 s17, s29, s28
	s_and_b32 s18, s34, s31
	s_and_b32 s12, s2, s5
	s_and_b32 s5, s2, s6
	s_and_b32 s6, s2, s7
	s_and_b32 s7, s2, s8
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 149
