	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	s_waitcnt vmcnt(1)
	ds_store_b16 v23, v6 offset:4096
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	s_waitcnt vmcnt(0)
...
.LBB0_3:                                ; %Flow89
	...
	v_dual_mov_b32 v13, 0 :: v_dual_and_b32 v20, 0x70, v11
...
; %bb.4:                                ; %.lr.ph
	...
	v_and_b32_e32 v4, 0x218, v22
	v_sub_nc_u32_e32 v27, s31, v3
	v_lshl_or_b32 v10, s34, 8, v10
	v_mul_lo_u32 v9, s19, v9
	v_add_nc_u32_e32 v3, s33, v3
	v_add3_u32 v12, s33, v25, v19
	s_lshl_b32 s0, s30, 8
	...
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v32, 0, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v33, 0, v6
	v_mov_b32_e32 v6, v1
	v_dual_mov_b32 v15, 0 :: v_dual_add_nc_u32 v34, 0, v7
	v_add_nc_u32_e32 v35, 0, v8
	v_mov_b32_e32 v8, v1
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v36, v5, v20
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_add_nc_u32_e32 v37, s5, v9
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e64 s0, s5, v27
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	buffer_load_u16 v63, v30, s[36:39], 0 offen
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_add_i32 s7, s7, -1
	.loc	1 198 26                        ; generate_amdgcn.py:198:26
	...
	s_add_i32 s5, s5, 32
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_dual_cndmask_b32 v37, 0x80000000, v37 :: v_dual_add_nc_u32 v30, 2, v30
	.loc	1 198 26                        ; generate_amdgcn.py:198:26
	...
	s_cmp_lg_u32 s7, 0
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	buffer_load_u16 v64, v37, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	...
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_clause 0x7
	buffer_load_u16 v65, v38, s[28:31], 0 offen
	buffer_load_u16 v66, v38, s[28:31], 0 offen offset:4
	buffer_load_u16 v67, v38, s[28:31], 0 offen offset:8
	buffer_load_u16 v68, v38, s[28:31], 0 offen offset:12
	buffer_load_u16 v69, v38, s[28:31], 0 offen offset:16
	buffer_load_u16 v70, v38, s[28:31], 0 offen offset:20
	buffer_load_u16 v71, v38, s[28:31], 0 offen offset:24
	buffer_load_u16 v72, v38, s[28:31], 0 offen offset:28
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	...
	ds_load_u8 v86, v36 offset:3328
	ds_load_u8 v87, v36 offset:3072
	ds_load_u8 v88, v36 offset:3456
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	...
	v_perm_b32 v75, v87, v85, 0xc0c0004
	v_perm_b32 v76, v86, v88, 0xc0c0004
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	s_waitcnt vmcnt(9)
	ds_store_b16 v23, v64 offset:4096
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	s_waitcnt vmcnt(0)
	ds_store_b64 v24, v[45:46]
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	...
	v_dual_fmac_f32 v18, v38, v48 :: v_dual_add_nc_u32 v29, s34, v29
	.loc	1 233 20 is_stmt 0              ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v40, v47, v40 :: v_dual_add_nc_u32 v31, s35, v31
	v_mul_f32_e32 v42, v47, v42
	v_mul_f32_e32 v37, v47, v37
	v_mul_f32_e32 v39, v47, v39
	v_mul_f32_e32 v41, v47, v41
	v_dual_mul_f32 v43, v47, v43 :: v_dual_fmac_f32 v16, v40, v50
	v_dual_mul_f32 v44, v47, v44 :: v_dual_lshlrev_b32 v47, 16, v65
	.loc	1 232 18 is_stmt 1              ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v51, 16, v69
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v14, v42, v52 :: v_dual_lshlrev_b32 v53, 16, v71
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v17, v39, v49 :: v_dual_fmac_f32 v10, v37, v47
	v_dual_fmac_f32 v15, v41, v51 :: v_dual_fmac_f32 v12, v44, v54
	s_delay_alu instid0(VALU_DEP_3)
	v_fmac_f32_e32 v13, v43, v53
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_cbranch_scc1 .LBB0_5
.LBB0_6:                                ; %._crit_edge
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v1, v25, v19
...
; %bb.7:
	...
	ds_load_u8 v27, v9
	ds_load_u8 v28, v9 offset:384
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_lshl_or_b32 v19, v19, 5, v23
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_mov_b32_e32 v23, v22
	ds_load_u8 v30, v9 offset:1664
	ds_load_u8 v31, v9 offset:1792
	ds_load_u8 v32, v9 offset:1536
	ds_load_u8 v39, v9 offset:2688
	ds_load_u8 v40, v9 offset:2944
	ds_load_u8 v41, v9 offset:2816
	ds_load_u8 v42, v9 offset:2560
	ds_load_u8 v43, v9 offset:2176
	ds_load_u8 v44, v9 offset:2432
	ds_load_u8 v45, v9 offset:2304
	ds_load_u8 v46, v9 offset:2048
	v_mov_b32_e32 v24, v22
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_xad_u32 v29, v19, 8, 0
	v_add_nc_u32_e32 v34, 0, v19
	v_xad_u32 v33, v19, 24, 0
	v_xad_u32 v19, v19, 16, 0
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_mov_b32_e32 v25, v22
	v_mov_b32_e32 v26, v22
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v36, v5, v4, 0xc0c0004
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v35, v6, v3, 0xc0c0004
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[3:4], v29 offset:4096
	ds_load_b64 v[5:6], v34 offset:4096
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_mov_b32_e32 v29, v22
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v7, v27, v7, 0xc0c0004
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v27, v8, v28, 0xc0c0004
	v_lshl_or_b32 v8, v36, 16, v35
	ds_load_u8 v34, v9 offset:1920
	ds_load_u8 v35, v9 offset:1152
	ds_load_u8 v36, v9 offset:1408
	ds_load_u8 v37, v9 offset:1280
	ds_load_u8 v38, v9 offset:1024
	ds_load_u8 v48, v9 offset:3712
	ds_load_u8 v49, v9 offset:3968
	ds_load_u8 v50, v9 offset:3840
	ds_load_u8 v51, v9 offset:3584
	ds_load_u8 v52, v9 offset:3200
	ds_load_u8 v53, v9 offset:3456
	ds_load_u8 v54, v9 offset:3328
	ds_load_u8 v9, v9 offset:3072
	s_waitcnt lgkmcnt(23)
	v_perm_b32 v47, v32, v30, 0xc0c0004
	v_lshl_or_b32 v7, v27, 16, v7
	v_mov_b32_e32 v27, v22
	v_mov_b32_e32 v28, v22
	s_waitcnt lgkmcnt(13)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[22:29], v[7:8], v[5:6], v[22:29] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v34, v31, v34, 0xc0c0004
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[30:31], v19 offset:4096
	ds_load_b64 v[32:33], v33 offset:4096
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_perm_b32 v7, v42, v39, 0xc0c0004
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v35, v38, v35, 0xc0c0004
	v_lshl_or_b32 v6, v34, 16, v47
	v_perm_b32 v8, v41, v40, 0xc0c0004
	v_perm_b32 v19, v46, v43, 0xc0c0004
	v_perm_b32 v34, v45, v44, 0xc0c0004
	v_lshl_or_b32 v5, v36, 16, v35
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[22:29], v[5:6], v[3:4], v[22:29] neg_lo:[1,1,0]
	v_lshl_or_b32 v4, v8, 16, v7
	v_lshl_or_b32 v3, v34, 16, v19
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v5, v51, v48, 0xc0c0004
	v_perm_b32 v6, v50, v49, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v7, v9, v52, 0xc0c0004
	v_perm_b32 v8, v54, v53, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[22:29], v[3:4], v[30:31], v[22:29] neg_lo:[1,1,0]
	v_lshl_or_b32 v4, v6, 16, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v3, v8, 16, v7
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[22:29], v[3:4], v[32:33], v[22:29] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	v_dual_mov_b32 v2, 0x5410 :: v_dual_add_nc_u32 v21, 4, v19
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v4, v4, v21, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fma_f32 v5, v5, v22, v17
	v_fma_f32 v3, v3, v20, v10
	...
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_dual_max_f32 v8, v8, v8 :: v_dual_lshlrev_b32 v25, 16, v25
	...
	v_fma_f32 v7, v7, v25, v15
	.loc	1 240 19 is_stmt 1              ; generate_amdgcn.py:240:19
	v_dual_max_f32 v3, v3, v3 :: v_dual_and_b32 v0, 16, v0
	v_max_f32_e32 v6, v6, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v10, v23, v19, v12
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v7, v15, v7, s2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	v_dual_mul_f32 v4, v4, v4 :: v_dual_max_f32 v3, 0, v3
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v9, v9, v27, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_dual_max_f32 v8, 0, v8 :: v_dual_max_f32 v7, 0, v7
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	v_dual_mul_f32 v7, v7, v7 :: v_dual_and_b32 v12, 1, v28
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	...
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_dual_max_f32 v5, 0, v5 :: v_dual_and_b32 v14, 1, v30
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 89
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 40
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     42
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc64_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.kd
