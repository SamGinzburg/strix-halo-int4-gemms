	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[1:2], null, s23, v20, v[9:10]
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[1:2], v2, s[16:19], 0 offen
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cmpk_gt_i32 s11, 0x101
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(1)
	ds_store_b8 v18, v3 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
...
.LBB0_3:                                ; %Flow24
	...
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v14, 0xe0, v0
	v_cmp_eq_u32_e64 s0, 0, v13
	v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v4, 0
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v2, 0 :: v_dual_lshlrev_b32 v15, 3, v14
...
.Ltmp13:
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v35, v1, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[25:26], v21, s[16:19], 0 offen offset:128
...
.Ltmp15:
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v4, v1 :: v_dual_add_nc_u32 v23, 0, v2
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[27:28], v21 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_b64 v[29:30], v22
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_mov_b32_e32 v5, v1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[31:32], v23 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_b64 v[33:34], v24
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v8, v1
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b8 v18, v35 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
...
; %bb.5:                                ; %.peel.next
	v_lshl_or_b32 v20, s24, 7, v20
	s_lshl_b32 s3, s22, 7
	v_add_nc_u32_e32 v17, s20, v17
	s_add_i32 s1, s1, -2
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_subrev_nc_u32_e32 v20, s3, v20
	v_mad_u64_u32 v[25:26], null, s23, v20, s[6:7]
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_mad_u64_u32 v[26:27], null, s23, v17, s[6:7]
	v_add3_u32 v9, v25, v9, 0x100
	s_delay_alu instid0(VALU_DEP_2)
	v_add3_u32 v17, v26, v12, 0x100
	.loc	1 0 9 is_stmt 0                 ; :0:9
.Ltmp16:
	.p2align	6
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	buffer_load_u8 v20, v17, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	buffer_load_b64 v[25:26], v9, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	ds_load_b64 v[27:28], v21 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	ds_load_b64 v[29:30], v22
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b8 v18, v20 offset:2048
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
	ds_store_b64 v19, v[25:26]
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
...
; %bb.9:
	...
	v_cndmask_b32_e64 v19, 0x88, 0, s1
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_or3_b32 v15, v18, v15, v19
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_or_b32_e32 v18, v19, v18
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v19, 0, v15
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[18:19], v[20:21], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[22:23], v[24:25], v[1:8] neg_lo:[1,1,0]
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	v_or_b32_e32 v18, 12, v14
	v_or_b32_e32 v19, 16, v14
	v_or_b32_e32 v20, 20, v14
	v_or_b32_e32 v21, 24, v14
	v_or_b32_e32 v22, 28, v14
	s_clause 0x7
	...
	v_dual_mul_f32 v19, v12, v19 :: v_dual_lshlrev_b32 v20, 16, v20
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v5, v19, v5 :: v_dual_lshlrev_b32 v0, 1, v0
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	...
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v20, v12, v20 :: v_dual_lshlrev_b32 v15, 16, v15
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v17, v12, v17 :: v_dual_and_b32 v0, 28, v0
	.loc	1 144 9 is_stmt 0               ; generate_amdgcn.py:144:9
	v_lshl_or_b32 v16, v9, 2, v16
	...
	v_lshl_or_b32 v9, v9, 9, v16
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_mul_f32_e32 v18, v12, v18
	v_dual_mul_f32 v12, v12, v22 :: v_dual_mul_f32 v1, v14, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_lshl_or_b32 v0, v10, 5, v0
	v_add_nc_u32_e32 v13, 0, v9
	v_xad_u32 v16, v9, 4, 0
	v_xad_u32 v23, v9, 8, 0
	v_xad_u32 v24, v9, 12, 0
	...
	v_add_lshl_u32 v12, v11, s3, 2
	v_add_lshl_u32 v10, v11, s2, 2
	v_add_lshl_u32 v13, v11, s8, 2
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 36
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 25
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     27
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.kd
