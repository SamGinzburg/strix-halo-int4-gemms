...
.Ltmp11:
	...
	s_cvt_f32_u32 s5, s4
	s_sub_i32 s8, 0, s4
	v_dual_mov_b32 v47, 0 :: v_dual_add_nc_u32 v68, v67, v12
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v20, v20, v32 :: v_dual_add_nc_u32 v33, v70, v71
	...
	v_dual_mul_f32 v14, v14, v31 :: v_dual_mul_f32 v17, v17, v32
	v_mul_f32_e32 v15, v15, v31
	v_dual_mul_f32 v16, v16, v31 :: v_dual_mul_f32 v19, v19, v32
	v_mul_f32_e32 v22, v22, v32
	v_dual_mul_f32 v24, v24, v32 :: v_dual_add_nc_u32 v71, s41, v71
	.loc	1 160 26                        ; generate_amdgcn.py:160:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v21, v21, v32 :: v_dual_fmac_f32 v60, v10, v35
	v_dual_mul_f32 v23, v23, v32 :: v_dual_fmac_f32 v46, v9, v34
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_dual_fmac_f32 v59, v11, v36 :: v_dual_fmac_f32 v58, v12, v37
	v_dual_fmac_f32 v57, v13, v38 :: v_dual_fmac_f32 v56, v14, v39
	v_dual_fmac_f32 v55, v15, v40 :: v_dual_fmac_f32 v54, v16, v33
	v_dual_fmac_f32 v53, v17, v34 :: v_dual_fmac_f32 v52, v18, v35
	v_dual_fmac_f32 v51, v19, v36 :: v_dual_fmac_f32 v50, v20, v37
	v_dual_fmac_f32 v49, v21, v38 :: v_dual_fmac_f32 v48, v22, v39
	v_fmac_f32_e32 v47, v23, v40
...
.LBB0_5:
	...
	v_add_nc_u32_e32 v22, 8, v18
	v_cndmask_b32_e64 v23, 0x80000000, v18, s2
	...
	v_dual_mul_f32 v9, v9, v19 :: v_dual_add_nc_u32 v24, 12, v18
	v_dual_mul_f32 v10, v10, v19 :: v_dual_add_nc_u32 v25, 16, v18
	v_dual_mul_f32 v11, v11, v19 :: v_dual_add_nc_u32 v26, 20, v18
	v_dual_mul_f32 v12, v12, v19 :: v_dual_add_nc_u32 v27, 24, v18
	v_dual_mul_f32 v13, v13, v19 :: v_dual_add_nc_u32 v18, 28, v18
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v15, v15, v19 :: v_dual_and_b32 v28, 0x78, v62
	...
	v_fma_f32 v10, v10, v21, v60
	v_fma_f32 v11, v11, v22, v59
	v_fma_f32 v2, v2, v21, v52
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v10, v60, v10, s2
	v_cndmask_b32_e64 v11, v59, v11, s2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b32_e64 v2, v52, v2, s2
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_max_f32_e32 v11, v11, v11
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v4, v4, v20 :: v_dual_lshlrev_b32 v19, 16, v23
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(4)
	v_lshlrev_b32_e32 v23, 16, v24
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v3, v3, v20 :: v_dual_lshlrev_b32 v24, 16, v25
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v6, v6, v20 :: v_dual_lshlrev_b32 v25, 16, v26
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v5, v5, v20 :: v_dual_lshlrev_b32 v26, 16, v27
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v9, v9, v19, v46
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v1, v1, v20
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v12, v12, v23, v58
	s_delay_alu instid0(VALU_DEP_4)
	v_fma_f32 v15, v15, v26, v55
	v_fma_f32 v4, v4, v23, v50
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v9, v46, v9, s2
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	v_and_b32_e32 v0, 16, v0
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v1, v1, v19, v53
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v12, v58, v12, s2
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v7, v7, v20 :: v_dual_lshlrev_b32 v18, 16, v18
	.loc	1 180 13 is_stmt 0              ; generate_amdgcn.py:180:13
	v_fma_f32 v14, v14, v25, v56
	v_fma_f32 v6, v6, v25, v48
	.loc	1 147 9 is_stmt 1               ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v13, v13, v24, v57
	v_fma_f32 v16, v16, v18, v54
	v_fma_f32 v3, v3, v22, v51
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v14, v56, v14, s2
	v_cndmask_b32_e64 v6, v48, v6, s2
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v12, 0, v12
	...
	v_dual_max_f32 v6, v6, v6 :: v_dual_max_f32 v11, 0, v11
	v_dual_max_f32 v1, 0, v1 :: v_dual_mul_f32 v12, v12, v12
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v7, v7, v26, v47
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v5, v5, v5 :: v_dual_max_f32 v16, 0, v16
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v14, v14, v14
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v2, v2, v2 :: v_dual_max_f32 v5, 0, v5
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v16, v16, v16 :: v_dual_mul_f32 v3, v3, v3
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	.loc	1 187 19                        ; generate_amdgcn.py:187:19
	v_dual_max_f32 v8, v8, v8 :: v_dual_max_f32 v13, 0, v13
	...
	v_add3_u32 v12, v14, v19, 0x7fff
	v_cndmask_b32_e32 v14, 0x3276, v32, vcc_lo
	v_add3_u32 v0, v16, v11, 0x7fff
	v_and_b32_e32 v11, 1, v30
	.loc	1 188 19                        ; generate_amdgcn.py:188:19
	v_dual_mul_f32 v6, v6, v6 :: v_dual_and_b32 v21, 1, v35
	v_dual_mul_f32 v8, v8, v8 :: v_dual_and_b32 v23, 1, v37
	.loc	1 190 9                         ; generate_amdgcn.py:190:9
	...
	v_add3_u32 v1, v4, v11, 0x7fff
	v_and_b32_e32 v4, 1, v30
	v_mov_b16_e32 v30.l, v8.h
	v_dual_cndmask_b32 v13, v12, v10 :: v_dual_and_b32 v26, 1, v40
	...
	v_permlanex16_b32 v9, v10, s0, 0xfedcba98 op_sel:[1,0]
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_cndmask_b32 v11, v6, v1 :: v_dual_and_b32 v0, 0x540054, v10
	v_and_b32_e32 v10, 0x760076, v12
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_perm_b32 v0, v9, v13, v8
	v_perm_b32 v1, v9, v13, v10
	v_permlanex16_b32 v9, v4, s0, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v2, v3, v15, v8
	v_perm_b32 v3, v3, v15, v10
	v_perm_b32 v4, v5, v7, v8
	v_perm_b32 v5, v5, v7, v10
	v_perm_b32 v6, v9, v11, v8
	v_perm_b32 v7, v9, v11, v10
	v_add_lshl_u32 v8, v28, v17, 1
	s_clause 0x1
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 80
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_relu2_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 43
