	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s35, v29, v[1:2]
...
.Ltmp19:
	...
	v_or_b32_e32 v8, s19, v2
	v_or_b32_e32 v11, s19, v29
	v_or_b32_e32 v12, s19, v6
	.loc	1 352 13                        ; generate_amdgcn.py:352:13
	s_add_i32 s3, s3, s6
.Ltmp20:
	.loc	2 43 13                         ; standard.py:43:13 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s24, s18, 0x1ff
.Ltmp21:
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s7, s19, 0x200
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	s_lshl_b32 s37, s34, 9
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v13, s7, v2
	v_or_b32_e32 v22, s7, v29
	.loc	1 355 32                        ; generate_amdgcn.py:355:32
	v_and_b32_e32 v3, 12, v10
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	...
	v_cmp_gt_i32_e64 s4, s18, v22
	.loc	1 402 30                        ; generate_amdgcn.py:402:30
	v_add3_u32 v7, v7, v3, s6
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
...
; %bb.4:                                ; %.lr.ph
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	v_add_nc_u32_e32 v4, s19, v29
	v_add3_u32 v6, s19, v2, 0x400
	s_lshl_b32 s7, s31, 7
...
.Ltmp23:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_add3_u32 v33, v6, s6, v3
	s_mov_b32 s24, s12
	v_add3_u32 v5, v5, s7, v1
	v_add3_u32 v1, v4, s7, v1
	s_and_b32 s29, s17, 0xffff
	s_mov_b32 s28, s16
	s_add_i32 s14, 0, 0x4000
	v_subrev_nc_u32_e32 v34, s15, v5
	v_subrev_nc_u32_e32 v35, s15, v1
	v_mov_b32_e32 v1, 0
	s_add_i32 s7, s1, -2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
	s_ashr_i32 s19, s19, 8
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_cmp_gt_i32_e32 vcc_lo, s18, v37
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cmp_lt_i32 s19, s0
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_add_lshl_u32 v39, v27, s19, 1
	.loc	1 422 40                        ; generate_amdgcn.py:422:40
	s_mul_i32 s19, s19, s35
	.loc	1 422 22 is_stmt 0              ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v40, v25, s19, 1
	.loc	1 402 22 is_stmt 1              ; generate_amdgcn.py:402:22
	v_cndmask_b32_e32 v37, 0x80000000, v33, vcc_lo
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v41, v24, s19, 1
	v_add_lshl_u32 v42, v22, s19, 1
	v_cndmask_b32_e32 v40, 0x80000000, v40, vcc_lo
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	buffer_load_b32 v85, v37, s[8:11], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v37, v26, s19, 1
	v_add_lshl_u32 v43, v20, s19, 1
	v_add_lshl_u32 v44, v23, s19, 1
	v_add_lshl_u32 v45, v21, s19, 1
	v_add_lshl_u32 v46, v19, s19, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v86, v39, s[24:27], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v87, v37, s[28:31], 0 offen
	...
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	v_add_nc_u32_e32 v38, 0x420, v38
	s_mov_b32 s19, s14
	s_mov_b32 s14, s34
	s_mov_b32 s34, s36
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	...
	.loc	1 400 23                        ; generate_amdgcn.py:400:23
	v_cmp_gt_i32_e32 vcc_lo, s18, v38
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lt_i32 s1, 2
	...
	s_clause 0x1
	buffer_load_b128 v[45:48], v37, s[20:23], 0 offen
	buffer_load_b128 v[49:52], v38, s[20:23], 0 offen
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v37, s19, v28
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v59, v53, v59 :: v_dual_add_nc_u32 v34, s38, v34
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_add_nc_u32_e32 v35, s38, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v14, v56, v39 :: v_dual_add_nc_u32 v183, s40, v10
	v_dual_fmac_f32 v11, v54, v37 :: v_dual_add_nc_u32 v184, s1, v32
...
; %bb.11:
	.loc	1 402 22                        ; generate_amdgcn.py:402:22
	v_add_nc_u32_e32 v1, s34, v28
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v56, s1, v40
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 185
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 41
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     43
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
