	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	buffer_load_b128 v[25:28], v8, s[24:27], 0 offen
	buffer_load_b128 v[30:33], v16, s[24:27], 0 offen
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v8, v[51:54] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	v_dual_mov_b32 v198, s11 :: v_dual_mov_b32 v191, s4
	v_mov_b32_e32 v197, s10
	v_dual_mov_b32 v3, v11 :: v_dual_mov_b32 v4, v12
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v229, v227, 6, v2
	v_dual_mov_b32 v195, s8 :: v_dual_and_b32 v0, 0x70, v1
	v_dual_mov_b32 v88, 0 :: v_dual_mov_b32 v193, s6
	v_xor_b32_e32 v230, 16, v229
	v_xor_b32_e32 v231, 32, v229
	v_xor_b32_e32 v232, 48, v229
	v_dual_mov_b32 v196, s9 :: v_dual_mov_b32 v93, 0
	v_dual_mov_b32 v194, s7 :: v_dual_mov_b32 v91, 0
	v_dual_mov_b32 v192, s5 :: v_dual_mov_b32 v89, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v23, s0, v10
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v18, s6, v230
	v_add_nc_u32_e32 v19, s6, v231
	v_dual_mov_b32 v11, v0 :: v_dual_add_nc_u32 v24, s0, v13
	v_add_nc_u32_e32 v20, s6, v232
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v99, s0, v14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s7, s36, 1
	...
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	buffer_load_b128 v[25:28], v23, s[24:27], 0 offen
	...
	v_perm_b32 v50, v210, v209, 0xc0c0004
	...
	s_clause 0x2
	buffer_load_b128 v[25:28], v24, s[24:27], 0 offen
	buffer_load_b128 v[199:202], v99, s[24:27], 0 offen
	buffer_load_b128 v[203:206], v100, s[24:27], 0 offen
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_lshl_or_b32 v148, v50, 16, v255
	...
	v_dual_mov_b32 v14, v7 :: v_dual_add_f32 v93, v93, v17
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v88, v88, v0 :: v_dual_add_f32 v91, v91, v19
	v_dual_mov_b32 v0, v11 :: v_dual_add_f32 v89, v89, v21
	v_dual_add_f32 v94, v94, v10 :: v_dual_add_f32 v85, v85, v24
	v_dual_mov_b32 v10, v2 :: v_dual_add_f32 v87, v87, v22
	v_dual_add_f32 v90, v90, v20 :: v_dual_add_f32 v83, v83, v50
	v_dual_add_f32 v86, v86, v23 :: v_dual_add_f32 v79, v79, v98
	v_dual_add_f32 v84, v84, v29 :: v_dual_add_f32 v77, v77, v100
	v_dual_add_f32 v82, v82, v95 :: v_dual_add_f32 v75, v75, v102
	v_dual_add_f32 v81, v81, v96 :: v_dual_add_f32 v80, v80, v97
	v_dual_add_f32 v73, v73, v104 :: v_dual_add_f32 v78, v78, v99
	v_dual_add_f32 v71, v71, v106 :: v_dual_add_f32 v76, v76, v101
	v_dual_add_f32 v69, v69, v108 :: v_dual_add_f32 v74, v74, v103
	v_dual_add_f32 v67, v67, v110 :: v_dual_add_f32 v72, v72, v105
	v_dual_add_f32 v65, v65, v112 :: v_dual_add_f32 v70, v70, v107
	v_dual_add_f32 v63, v63, v114 :: v_dual_add_f32 v68, v68, v109
	v_dual_add_f32 v61, v61, v116 :: v_dual_add_f32 v66, v66, v111
	v_dual_add_f32 v59, v59, v118 :: v_dual_add_f32 v64, v64, v113
	v_dual_add_f32 v57, v57, v120 :: v_dual_add_f32 v62, v62, v115
	v_dual_add_f32 v55, v55, v122 :: v_dual_add_f32 v60, v60, v117
	v_dual_add_f32 v53, v53, v124 :: v_dual_add_f32 v58, v58, v119
	v_dual_add_f32 v51, v51, v126 :: v_dual_add_f32 v56, v56, v121
	v_add_f32_e32 v49, v49, v127
	v_dual_add_f32 v54, v54, v123 :: v_dual_add_f32 v47, v47, v129
	v_dual_add_f32 v52, v52, v125 :: v_dual_add_f32 v45, v45, v131
...
; %bb.8:
	...
	v_mov_b32_e32 v3, s6
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[134:137], v50 offset:1024
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[178:181], v50 offset:3072
	ds_load_b128 v[150:153], v50 offset:2048
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v50, v0 offset:13568
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v50, v209, v50, 0xc0c0004
	...
	v_lshl_or_b32 v195, v209, 16, v50
	s_waitcnt lgkmcnt(8)
	...
	v_perm_b32 v50, v213, v212, 0xc0c0004
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v93, v93, v9 :: v_dual_add_f32 v92, v92, v10
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v87, v87, v10 :: v_dual_add_f32 v86, v86, v11
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v82, v82, v10 :: v_dual_add_f32 v81, v81, v11
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v79, v79, v0 :: v_dual_add_f32 v78, v78, v9
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cvt_f32_i32_e32 v0, v122
	v_cvt_f32_i32_e32 v9, v123
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v77, v77, v10 :: v_dual_add_f32 v76, v76, v11
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v74, v74, v0 :: v_dual_add_f32 v73, v73, v9
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v72, v72, v10 :: v_dual_add_f32 v71, v71, v11
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v67, v67, v10 :: v_dual_add_f32 v64, v64, v0
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v62, v62, v10 :: v_dual_add_f32 v61, v61, v11
	s_delay_alu instid0(VALU_DEP_4)
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v57, v57, v10 :: v_dual_add_f32 v54, v54, v0
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v51, v51, v11 :: v_dual_add_f32 v46, v46, v10
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v45, v45, v11 :: v_dual_add_f32 v38, v38, v0
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_cvt_f32_i32_e32 v11, v155
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v41, v41, v10 :: v_dual_add_f32 v34, v34, v4
...
; %bb.10:
	...
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v136, s11 :: v_dual_add_nc_u32 v21, s0, v232
	v_dual_mov_b32 v135, s10 :: v_dual_add_nc_u32 v0, s1, v100
	v_dual_mov_b32 v134, s9 :: v_dual_add_nc_u32 v17, s0, v231
	v_dual_mov_b32 v133, s8 :: v_dual_add_nc_u32 v26, s0, v230
	.loc	1 374 22 is_stmt 1              ; generate_amdgcn.py:374:22
	...
	v_dual_mov_b32 v131, s6 :: v_dual_add_nc_u32 v108, s0, v229
	...
	v_perm_b32 v28, v50, v29, 0xc0c0004
	...
	ds_load_u8 v50, v0 offset:10240
	...
	v_perm_b32 v29, v50, v29, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v50, v149, v143, 0xc0c0004
	...
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v50, v143, v50, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	...
	v_perm_b32 v50, v222, v221, 0xc0c0004
	...
	v_lshl_or_b32 v206, v128, 16, v50
...
.LBB0_11:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v93, v3 :: v_dual_lshlrev_b32 v0, 1, v0
	v_dual_add_f32 v2, v94, v2 :: v_dual_lshlrev_b32 v29, 1, v29
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s24, s12
	s_delay_alu instid0(VALU_DEP_2)
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v100, v66, v101 :: v_dual_add_f32 v101, v65, v102
	v_dual_add_f32 v102, v64, v103 :: v_dual_add_f32 v103, v63, v104
	v_dual_add_f32 v104, v62, v105 :: v_dual_add_f32 v105, v61, v106
	v_dual_add_f32 v106, v60, v107 :: v_dual_add_f32 v107, v59, v108
	v_dual_add_f32 v108, v58, v109 :: v_dual_add_f32 v109, v57, v110
	v_dual_add_f32 v110, v56, v111 :: v_dual_add_f32 v111, v55, v112
	v_dual_add_f32 v112, v54, v113 :: v_dual_add_f32 v113, v53, v114
	v_dual_add_f32 v114, v52, v115 :: v_dual_add_f32 v115, v51, v116
	v_dual_add_f32 v116, v49, v117 :: v_dual_add_f32 v117, v48, v118
	v_dual_add_f32 v118, v47, v119 :: v_dual_add_f32 v119, v46, v120
	v_dual_add_f32 v120, v45, v121 :: v_dual_add_f32 v121, v44, v122
	v_dual_add_f32 v122, v43, v123 :: v_dual_add_f32 v123, v42, v124
	v_dual_add_f32 v124, v41, v125 :: v_dual_add_f32 v125, v40, v126
	v_dual_add_f32 v126, v39, v127 :: v_dual_add_f32 v127, v38, v128
	v_dual_add_f32 v128, v37, v129 :: v_dual_add_f32 v129, v36, v130
	v_dual_add_f32 v130, v35, v131 :: v_dual_add_f32 v131, v34, v132
	v_dual_add_f32 v132, v33, v133 :: v_dual_lshlrev_b32 v137, 5, v226
	v_dual_add_f32 v133, v32, v134 :: v_dual_add_f32 v134, v31, v135
	v_add_f32_e32 v135, v30, v136
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_lshl_add_u32 v138, v99, 2, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v94, v94, v2, s2
	v_cndmask_b32_e64 v93, v93, v3, s2
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
	v_lshrrev_b32_e32 v97, 1, v99
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v98, v88, v1 :: v_dual_add_f32 v7, v89, v7
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v88, v88, v98, s2
	s_delay_alu instid0(VALU_DEP_3)
	...
	v_cndmask_b32_e64 v49, v49, v116, s2
	v_cndmask_b32_e64 v48, v48, v117, s2
	v_cndmask_b32_e64 v47, v47, v118, s2
	v_cndmask_b32_e64 v46, v46, v119, s2
	v_cndmask_b32_e64 v45, v45, v120, s2
	v_cndmask_b32_e64 v44, v44, v121, s2
	v_cndmask_b32_e64 v43, v43, v122, s2
	v_cndmask_b32_e64 v42, v42, v123, s2
	v_cndmask_b32_e64 v41, v41, v124, s2
	v_cndmask_b32_e64 v40, v40, v125, s2
	v_cndmask_b32_e64 v39, v39, v126, s2
	v_cndmask_b32_e64 v37, v37, v128, s2
	v_cndmask_b32_e64 v36, v36, v129, s2
	v_cndmask_b32_e64 v35, v35, v130, s2
	v_cndmask_b32_e64 v34, v34, v131, s2
	v_cndmask_b32_e64 v33, v33, v132, s2
	v_cndmask_b32_e64 v32, v32, v133, s2
	v_cndmask_b32_e64 v30, v30, v135, s2
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v29, v38, v127, s2
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_lshlrev_b32_e32 v38, 16, v50
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_and_b32_e32 v136, 28, v228
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	v_lshlrev_b32_e32 v0, 16, v0
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_and_b32_e32 v2, 32, v137
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v31, v31, v134, s2
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v3, s31, s28, v97
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v107, v9, v38 :: v_dual_add_nc_u32 v6, s30, v1
	v_mul_f32_e32 v71, v10, v0
	v_dual_mul_f32 v68, v7, v0 :: v_dual_add_nc_u32 v5, s29, v1
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v101, v18, v0 :: v_dual_lshlrev_b32 v50, 16, v95
	v_mul_f32_e32 v69, v8, v0
	v_mul_f32_e32 v99, v16, v0
	v_dual_mul_f32 v106, v8, v38 :: v_dual_lshlrev_b32 v67, 16, v96
	v_dual_mul_f32 v70, v9, v0 :: v_dual_mul_f32 v109, v11, v38
	v_dual_mul_f32 v72, v11, v0 :: v_dual_mul_f32 v111, v13, v38
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v100, v17, v0 :: v_dual_mul_f32 v117, v19, v38
	v_dual_mul_f32 v95, v12, v0 :: v_dual_add_nc_u32 v2, s22, v1
	v_dual_mul_f32 v102, v19, v0 :: v_dual_mul_f32 v119, v21, v38
	v_dual_mul_f32 v97, v14, v0 :: v_dual_add_nc_u32 v4, 0x80, v3
	v_dual_mul_f32 v96, v13, v0 :: v_dual_mul_f32 v113, v15, v38
	v_dual_mul_f32 v98, v15, v0 :: v_dual_mul_f32 v115, v17, v38
	v_dual_mul_f32 v103, v20, v0 :: v_dual_mul_f32 v108, v10, v38
	v_dual_mul_f32 v104, v21, v0 :: v_dual_mul_f32 v121, v8, v50
	v_dual_mul_f32 v0, v22, v0 :: v_dual_mul_f32 v125, v12, v50
	v_mul_f32_e32 v105, v7, v38
	v_mul_f32_e32 v110, v12, v38
	v_mul_f32_e32 v112, v14, v38
	v_mul_f32_e32 v114, v16, v38
	v_mul_f32_e32 v116, v18, v38
	v_mul_f32_e32 v118, v20, v38
	v_mul_f32_e32 v38, v22, v38
	v_mul_f32_e32 v120, v7, v50
	v_mul_f32_e32 v122, v9, v50
	v_dual_mul_f32 v123, v10, v50 :: v_dual_mul_f32 v8, v8, v67
	v_mul_f32_e32 v124, v11, v50
	v_mul_f32_e32 v126, v13, v50
	v_dual_mul_f32 v127, v14, v50 :: v_dual_mul_f32 v12, v12, v67
	v_dual_mul_f32 v128, v15, v50 :: v_dual_mul_f32 v85, v85, v99
	v_dual_mul_f32 v129, v16, v50 :: v_dual_mul_f32 v10, v10, v67
	v_dual_mul_f32 v130, v17, v50 :: v_dual_mul_f32 v87, v87, v97
	v_dual_mul_f32 v131, v18, v50 :: v_dual_mul_f32 v16, v16, v67
	v_dual_mul_f32 v132, v19, v50 :: v_dual_mul_f32 v81, v81, v103
	v_dual_mul_f32 v133, v20, v50 :: v_dual_mul_f32 v14, v14, v67
	v_dual_mul_f32 v134, v21, v50 :: v_dual_mul_f32 v83, v83, v101
	v_dual_mul_f32 v50, v22, v50 :: v_dual_mul_f32 v75, v75, v108
	...
	v_dual_mul_f32 v20, v20, v67 :: v_dual_mul_f32 v77, v77, v106
	v_mul_f32_e32 v21, v21, v67
	v_dual_mul_f32 v22, v22, v67 :: v_dual_mul_f32 v73, v73, v110
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v67, v88, v68 :: v_dual_mul_f32 v68, v94, v69
	v_mul_f32_e32 v23, v23, v111
	v_dual_mul_f32 v69, v93, v70 :: v_dual_mul_f32 v70, v92, v71
	v_mul_f32_e32 v25, v25, v113
	v_mul_f32_e32 v71, v91, v72
	v_dual_mul_f32 v84, v84, v100 :: v_dual_mul_f32 v59, v59, v123
	v_dual_mul_f32 v72, v90, v95 :: v_dual_mul_f32 v65, v65, v118
	v_dual_mul_f32 v82, v82, v102 :: v_dual_mul_f32 v57, v57, v125
	v_dual_mul_f32 v64, v64, v119 :: v_dual_mul_f32 v13, v39, v13
	v_dual_mul_f32 v38, v63, v38 :: v_dual_mul_f32 v19, v33, v19
	...
	v_dual_mul_f32 v88, v89, v96 :: v_dual_mul_f32 v27, v27, v115
	v_dual_mul_f32 v60, v60, v122 :: v_dual_mul_f32 v21, v31, v21
	...
	v_add3_u32 v40, v84, v40, 0x7fff
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v62, v62, v120 :: v_dual_mul_f32 v17, v35, v17
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_bfe_u32 v35, v88, 16, 1
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v24, v24, v112 :: v_dual_mul_f32 v7, v45, v7
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_cmp_o_f32_e64 s11, v82, v82
	v_add3_u32 v31, v69, v31, 0x7fff
	v_add3_u32 v34, v72, v34, 0x7fff
	v_add3_u32 v42, v82, v42, 0x7fff
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v28, v28, v116 :: v_dual_mul_f32 v11, v41, v11
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b16 v34.h, 0x7fff, v41.h, s10
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v66, v66, v117 :: v_dual_mul_f32 v15, v37, v15
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v86, v86, v98 :: v_dual_mul_f32 v61, v61, v121
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v74, v74, v109 :: v_dual_mul_f32 v47, v47, v134
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v80, v80, v104 :: v_dual_mul_f32 v55, v55, v127
	v_mul_f32_e32 v58, v58, v124
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v0, v79, v0 :: v_dual_mul_f32 v53, v53, v129
	v_dual_mul_f32 v78, v78, v105 :: v_dual_mul_f32 v51, v51, v131
	v_mul_f32_e32 v56, v56, v126
	...
	v_add3_u32 v43, v81, v43, 0x7fff
	v_add3_u32 v68, v74, v90, 0x7fff
	...
	v_cndmask_b16 v28.h, 0x7fff, v38.h, vcc_lo
	...
	v_add3_u32 v44, v80, v44, 0x7fff
	v_cndmask_b16 v30.h, 0x7fff, v32.h, s2
	v_cndmask_b16 v32.l, 0x7fff, v35.h, s5
	v_cndmask_b16 v32.h, 0x7fff, v36.h, s6
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v54, v54, v128
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_cndmask_b16 v35.h, 0x7fff, v43.h, s12
	v_cndmask_b16 v41.l, 0x7fff, v68.h, s19
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	...
	v_add3_u32 v50, v77, v63, 0x7fff
	v_add3_u32 v63, v76, v79, 0x7fff
	v_add3_u32 v67, v75, v89, 0x7fff
	v_cndmask_b16 v42.l, 0x7fff, v42.h, s0
	v_cndmask_b16 v42.h, 0x7fff, v44.h, s1
	v_bfe_u32 v44, v49, 16, 1
	v_add3_u32 v43, v52, v43, 0x7fff
	v_cmp_o_f32_e32 vcc_lo, v52, v52
	v_add3_u32 v45, v51, v45, 0x7fff
	v_cmp_o_f32_e64 s0, v51, v51
	v_cndmask_b16 v36.h, 0x7fff, v50.h, s16
	v_cndmask_b16 v37.l, 0x7fff, v63.h, s17
	v_cndmask_b16 v37.h, 0x7fff, v67.h, s18
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	...
	v_cndmask_b16 v43.h, 0x7fff, v45.h, s0
	v_bfe_u32 v45, v47, 16, 1
	v_bfe_u32 v50, v46, 16, 1
	v_bfe_u32 v49, v48, 16, 1
	v_cndmask_b16 v44.l, 0x7fff, v44.h, s1
	...
	v_cndmask_b16 v45.l, 0x7fff, v45.h, s0
	v_bfe_u32 v48, v8, 16, 1
	v_cndmask_b16 v45.h, 0x7fff, v47.h, s1
	v_bfe_u32 v47, v9, 16, 1
	v_cndmask_b16 v44.h, 0x7fff, v49.h, vcc_lo
	v_add3_u32 v46, v7, v46, 0x7fff
	v_cmp_o_f32_e32 vcc_lo, v7, v7
	v_add3_u32 v7, v8, v48, 0x7fff
	v_cmp_o_f32_e64 s0, v8, v8
	v_add3_u32 v8, v9, v47, 0x7fff
	...
	v_cndmask_b16 v0.h, 0x7fff, v0.h, s14
	v_dual_cndmask_b32 v17, v32, v30 :: v_dual_cndmask_b32 v18, v30, v32
	v_dual_cndmask_b32 v19, v35, v33 :: v_dual_cndmask_b32 v20, v33, v35
	v_dual_cndmask_b32 v35, v42, v44 :: v_dual_cndmask_b32 v32, v40, v39
	...
	v_cndmask_b32_e32 v21, v0, v34, vcc_lo
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_dual_cndmask_b32 v27, v38, v28 :: v_dual_cndmask_b32 v28, v28, v38
	v_dual_cndmask_b32 v38, v10, v7 :: v_dual_cndmask_b32 v7, v7, v10
	v_mov_b32_e32 v10, 0x5410
	v_dual_cndmask_b32 v0, v34, v0 :: v_dual_cndmask_b32 v11, 0x3276, v11
	v_dual_cndmask_b32 v30, v23, v37 :: v_dual_cndmask_b32 v23, v37, v23
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v10, 0x1054, v10 :: v_dual_cndmask_b32 v37, v43, v45
	v_lshl_or_b32 v11, v11, 8, v11
	v_dual_cndmask_b32 v22, v41, v36 :: v_dual_cndmask_b32 v29, v36, v41
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_lshl_or_b32 v10, v10, 8, v10
	s_mov_b32 s0, 0x76543210
	v_dual_cndmask_b32 v34, v44, v42 :: v_dual_and_b32 v11, 0x760076, v11
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v41, v14, v12 :: v_dual_and_b32 v10, 0x540054, v10
	...
	v_permlanex16_b32 v18, v29, s0, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b32_e32 v36, v45, v43, vcc_lo
	...
	v_perm_b32 v7, v13, v15, v37
	v_perm_b32 v8, v13, v15, v42
	v_perm_b32 v9, v14, v17, v37
	v_perm_b32 v10, v14, v17, v42
	v_perm_b32 v13, v0, v21, v37
	v_perm_b32 v14, v0, v21, v42
	.loc	1 416 18 is_stmt 0              ; generate_amdgcn.py:416:18
	v_add_lshl_u32 v0, v3, v1, 1
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_permlanex16_b32 v45, v12, s0, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v11, v16, v19, v37
	v_perm_b32 v12, v16, v19, v42
	v_perm_b32 v15, v18, v22, v37
	v_perm_b32 v16, v18, v22, v42
	v_perm_b32 v17, v20, v30, v37
	v_perm_b32 v18, v20, v30, v42
	v_add_lshl_u32 v1, v3, v6, 1
	s_mov_b32 s22, s26
	...
	buffer_store_b128 v[11:14], v0, s[20:23], 0 offen offset:256
	buffer_store_b128 v[15:18], v1, s[20:23], 0 offen
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 44
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 44
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
