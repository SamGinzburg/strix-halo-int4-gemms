	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	s_mul_i32 s5, s8, s29
	v_mad_u64_u32 v[3:4], null, s8, v1, v[2:3]
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	...
	v_or_b32_e32 v6, s29, v1
	v_or_b32_e32 v7, s29, v26
	.loc	1 93 28                         ; generate_amdgcn.py:93:28
	s_sub_i32 s4, s2, s4
	...
	v_mad_u64_u32 v[4:5], null, s28, v40, v[26:27]
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v3, v3, s[16:19], 0 offen
	buffer_load_b32 v5, v5, s[16:19], 0 offen
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v7, v10, s[12:15], 0 offen
	...
	v_add_nc_u32_e32 v10, 0, v18
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v9, 0, v20
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(3)
	ds_store_b8 v9, v7 offset:8192
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	ds_store_2addr_stride64_b32 v10, v3, v5 offset1:16
	v_and_b32_e32 v3, 0x108, v0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v9, v4 offset:8704
	.loc	1 0 0                           ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v10, v6, v8 offset0:8 offset1:24
...
.Ltmp15:
	...
	v_sub_nc_u32_e32 v21, s28, v26
	v_add_nc_u32_e32 v3, 0x41, v1
	...
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v4, s20, v40
	s_lshl_b32 s26, s11, 5
	s_add_i32 s24, 0, 0x2000
	s_add_i32 s23, 0, 0x2200
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mov_b32_e32 v6, v1
	v_add3_u32 v3, v3, s1, v2
	s_delay_alu instid0(VALU_DEP_4)
	v_add3_u32 v2, v5, s1, v2
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v7, v1
	v_mov_b32_e32 v8, v1
	v_subrev_nc_u32_e32 v23, s2, v3
	v_mov_b32_e32 v3, v1
	v_mad_u64_u32 v[9:10], null, s28, v4, v[26:27]
	v_subrev_nc_u32_e32 v24, s2, v2
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v4, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v25, s29, v9
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e32 vcc_lo, s29, v22
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s0, s29, v21
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_dual_cndmask_b32 v27, 0x80000000, v24 :: v_dual_cndmask_b32 v28, 0x80000000, v23
	...
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	s_clause 0x1
	buffer_load_b32 v44, v27, s[16:19], 0 offen
	buffer_load_b32 v45, v28, s[16:19], 0 offen
	v_add_nc_u32_e32 v28, s23, v19
	s_mov_b32 s2, s3
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v27, s0, v31
	v_add_nc_u32_e32 v29, s0, v32
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v30, s2, v19
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v33, v28 offset:640
	ds_load_u8 v34, v28 offset:896
	ds_load_u8 v35, v28 offset:768
	ds_load_u8 v36, v28 offset:512
	ds_load_u8 v37, v28 offset:128
	ds_load_u8 v38, v28 offset:384
	ds_load_u8 v42, v28 offset:256
	ds_load_u8 v43, v28
	ds_load_u8 v46, v28 offset:1664
	ds_load_u8 v47, v28 offset:1920
	ds_load_u8 v48, v28 offset:1792
	ds_load_u8 v49, v28 offset:1536
	ds_load_u8 v50, v28 offset:1152
	ds_load_u8 v51, v28 offset:1408
	ds_load_u8 v52, v28 offset:1280
	ds_load_u8 v53, v28 offset:1024
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	ds_load_u8 v54, v30 offset:640
	ds_load_u8 v55, v30 offset:896
	ds_load_u8 v56, v30 offset:768
	ds_load_u8 v57, v30 offset:512
	ds_load_u8 v58, v30 offset:128
	ds_load_u8 v59, v30 offset:384
	ds_load_u8 v60, v30 offset:256
	ds_load_u8 v61, v30
	ds_load_u8 v62, v30 offset:1664
	ds_load_u8 v63, v30 offset:1920
	ds_load_u8 v64, v30 offset:1792
	ds_load_u8 v65, v30 offset:1536
	ds_load_u8 v66, v30 offset:1152
	ds_load_u8 v67, v30 offset:1280
	ds_load_u8 v68, v30 offset:1024
	ds_load_u8 v69, v30 offset:1408
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	v_perm_b32 v35, v43, v37, 0xc0c0004
	v_perm_b32 v36, v42, v38, 0xc0c0004
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v37, v49, v46, 0xc0c0004
	...
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v52, v68, v66, 0xc0c0004
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v53, v67, v69, 0xc0c0004
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_lshl_or_b32 v34, v34, 16, v33
	v_lshl_or_b32 v33, v36, 16, v35
	v_lshl_or_b32 v36, v38, 16, v37
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	...
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v27, s0, v20
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[10:17], v[35:36], v[29:30], v[10:17] neg_lo:[1,1,0]
	.loc	1 140 32                        ; generate_amdgcn.py:140:32
	v_wmma_i32_16x16x16_iu4 v[1:8], v[42:43], v[29:30], v[1:8] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s28, s28, -1
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v28, s2, v18
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b8 v27, v25 offset:8192
	.loc	1 0 0 is_stmt 0                 ; generate_amdgcn.py:0
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b32 v28, v44, v45 offset1:16
	.loc	1 106 9 is_stmt 1               ; generate_amdgcn.py:106:9
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %._crit_edge.loopexit
	.loc	1 0 9 is_stmt 0                 ; generate_amdgcn.py:0:9
	v_or_b32_e32 v43, 0x80, v19
	v_or_b32_e32 v45, 0x100, v19
	v_or_b32_e32 v46, 0x180, v19
	v_or_b32_e32 v47, 0x200, v19
	v_or_b32_e32 v48, 0x280, v19
	v_or_b32_e32 v49, 0x300, v19
	v_or_b32_e32 v50, 0x380, v19
	v_or_b32_e32 v42, 0x400, v19
	v_or_b32_e32 v44, 0x480, v19
	v_or_b32_e32 v51, 0x500, v19
	v_or_b32_e32 v52, 0x580, v19
	v_or_b32_e32 v53, 0x600, v19
	v_or_b32_e32 v54, 0x680, v19
	v_or_b32_e32 v56, 0x700, v19
	v_or_b32_e32 v57, 0x780, v19
...
.LBB0_8:                                ; %._crit_edge
	...
	v_add_nc_u32_e32 v9, s24, v31
	v_dual_mov_b32 v25, v17 :: v_dual_add_nc_u32 v18, s24, v32
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.9:
	...
	v_add_nc_u32_e32 v25, s18, v47
	v_add_nc_u32_e32 v22, s18, v50
	v_add_nc_u32_e32 v35, s18, v43
	v_add_nc_u32_e32 v23, s18, v49
	v_add_nc_u32_e32 v33, s18, v46
	v_add_nc_u32_e32 v34, s18, v45
	v_add_nc_u32_e32 v36, s18, v55
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v24, v24
	ds_load_u8 v25, v25
	ds_load_u8 v22, v22
	...
	v_add_nc_u32_e32 v20, s18, v53
	v_add_nc_u32_e32 v9, s18, v57
	v_add_nc_u32_e32 v38, s18, v42
	v_add_nc_u32_e32 v21, s18, v52
	v_add_nc_u32_e32 v37, s18, v51
	v_add_nc_u32_e32 v58, s18, v44
	v_add_nc_u32_e32 v18, s18, v56
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v59, v19
	ds_load_u8 v60, v20
	ds_load_u8 v9, v9
...
; %bb.11:
	.loc	1 139 31                        ; generate_amdgcn.py:139:31
	v_add_nc_u32_e32 v17, s3, v48
	v_add_nc_u32_e32 v33, s3, v47
	v_add_nc_u32_e32 v15, s3, v50
	v_add_nc_u32_e32 v36, s3, v43
	v_add_nc_u32_e32 v16, s3, v49
	v_add_nc_u32_e32 v34, s3, v46
	v_add_nc_u32_e32 v35, s3, v45
	v_add_nc_u32_e32 v37, s3, v55
...
.LBB0_12:                               ; %._crit_edge55
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	v_add_nc_u32_e32 v9, s23, v31
	s_waitcnt lgkmcnt(0)
	v_dual_mov_b32 v30, v13 :: v_dual_add_nc_u32 v27, s23, v32
	s_delay_alu instid0(VALU_DEP_3)
...
; %bb.13:
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v34, s2, v48
	v_add_nc_u32_e32 v58, s2, v47
	v_add_nc_u32_e32 v32, s2, v50
	v_add_nc_u32_e32 v61, s2, v43
	v_add_nc_u32_e32 v33, s2, v49
	v_add_nc_u32_e32 v59, s2, v46
	v_add_nc_u32_e32 v60, s2, v45
	v_add_nc_u32_e32 v62, s2, v55
	v_add_nc_u32_e32 v28, s2, v54
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v34, v34
	ds_load_u8 v58, v58
	ds_load_u8 v32, v32
	...
	ds_load_u8 v33, v33
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
	v_add_nc_u32_e32 v29, s2, v53
	v_add_nc_u32_e32 v9, s2, v57
	v_add_nc_u32_e32 v63, s2, v42
	v_add_nc_u32_e32 v30, s2, v52
	v_add_nc_u32_e32 v31, s2, v51
	v_add_nc_u32_e32 v64, s2, v44
	v_add_nc_u32_e32 v27, s2, v56
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	ds_load_u8 v65, v28
	ds_load_u8 v29, v29
	ds_load_u8 v9, v9
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_vgpr, 74
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.numbered_sgpr, 30
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     32
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_swiglu_bm32_bn128_bk32_gm4_w16_s3_weu2_sk1_maskk.kd
