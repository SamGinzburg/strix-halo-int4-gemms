...
.LBB0_5:
	...
	s_mov_b32 s23, s11
	.loc	1 178 18                        ; generate_amdgcn.py:178:18
	buffer_load_u16 v20, v16, s[8:11], 0 offen
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v12, v12, v20 :: v_dual_add_nc_u32 v25, 20, v18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v11, v11, v20 :: v_dual_add_nc_u32 v22, 12, v18
	v_dual_mul_f32 v15, v15, v20 :: v_dual_add_nc_u32 v26, 24, v18
	v_dual_mul_f32 v19, v19, v20 :: v_dual_add_nc_u32 v18, 28, v18
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v28, v21, s[20:23], 0 offen
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v5, v5, v31 :: v_dual_and_b32 v18, 0x840, v18
	v_mul_f32_e32 v1, v1, v31
	v_dual_mul_f32 v4, v4, v31 :: v_dual_and_b32 v33, 0x78, v16
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v6, v6, v31 :: v_dual_lshlrev_b32 v35, 11, v32
	.loc	1 192 23                        ; generate_amdgcn.py:192:23
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_vgpr, 81
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.numbered_sgpr, 43
