...
; %bb.4:                                ; %.lr.ph
	...
	v_mad_u64_u32 v[64:65], null, v9, s34, s[28:29]
	.loc	1 799 25                        ; ragged.py:799:25
	v_mul_lo_u32 v138, v91, s10
	v_mul_lo_u32 v139, v97, s10
	v_mul_lo_u32 v140, v98, s10
	v_mul_lo_u32 v141, v99, s10
	v_mul_lo_u32 v147, v4, s34
	v_mad_u64_u32 v[65:66], null, s34, v11, s[28:29]
	.loc	1 721 20                        ; ragged.py:721:20
	v_cmp_gt_i32_e64 s0, s33, v137
	v_cmp_gt_i32_e64 s1, s33, v9
	v_cmp_gt_i32_e64 s6, s33, v11
	.loc	1 806 25                        ; ragged.py:806:25
	s_mul_i32 s11, s10, s8
	v_xor_b32_e32 v146, 4, v145
	v_cmp_eq_u32_e64 s8, 0, v125
...
.LBB0_6:                                ;   Parent Loop BB0_5 Depth=1
	...
	v_cndmask_b32_e64 v158, 0x80000000, v154, s6
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 783 34                        ; ragged.py:783:34
	v_cndmask_b32_e64 v162, 0x80000000, v155, s7
	.loc	1 784 34                        ; ragged.py:784:34
	s_clause 0x1
	buffer_load_b128 v[154:157], v156, s[12:15], 0 offen
...
; %bb.7:                                ;   in Loop: Header=BB0_5 Depth=1
	...
	v_add_lshl_u32 v154, s26, v138, 1
	.loc	1 806 25                        ; ragged.py:806:25
	s_add_i32 s27, s26, s11
	.loc	1 798 40                        ; ragged.py:798:40
	v_add_lshl_u32 v155, s26, v139, 1
	v_add_lshl_u32 v156, s26, v140, 1
	.loc	1 806 25                        ; ragged.py:806:25
	s_mul_i32 s27, s27, s33
	.loc	1 798 40                        ; ragged.py:798:40
	v_add_lshl_u32 v157, s26, v141, 1
	.loc	1 805 40                        ; ragged.py:805:40
	v_add_lshl_u32 v158, v137, s27, 1
	.loc	1 798 40                        ; ragged.py:798:40
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_mul_f32_e32 v160, v1, v154
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v19, v19, v155 :: v_dual_lshlrev_b32 v158, 16, v158
	v_dual_mul_f32 v159, v0, v154 :: v_dual_lshlrev_b32 v156, 16, v156
	v_dual_mul_f32 v162, v3, v154 :: v_dual_lshlrev_b32 v157, 16, v157
	...
	v_dual_mul_f32 v166, v7, v154 :: v_dual_mul_f32 v21, v21, v155
	...
	v_dual_mul_f32 v170, v11, v154 :: v_dual_mul_f32 v25, v25, v155
	...
	v_dual_mul_f32 v154, v15, v154 :: v_dual_mul_f32 v29, v29, v155
	.loc	1 810 21                        ; ragged.py:810:21
	...
	.loc	1 803 21                        ; ragged.py:803:21
	v_dual_mul_f32 v30, v30, v155 :: v_dual_mul_f32 v33, v33, v156
	v_dual_mul_f32 v32, v32, v156 :: v_dual_mul_f32 v49, v49, v157
	v_dual_mul_f32 v34, v34, v156 :: v_dual_mul_f32 v51, v51, v157
	v_dual_mul_f32 v35, v35, v156 :: v_dual_mul_f32 v48, v48, v157
	v_dual_mul_f32 v36, v36, v156 :: v_dual_mul_f32 v53, v53, v157
	v_dual_mul_f32 v37, v37, v156 :: v_dual_mul_f32 v50, v50, v157
	v_dual_mul_f32 v38, v38, v156 :: v_dual_mul_f32 v55, v55, v157
	v_dual_mul_f32 v39, v39, v156 :: v_dual_mul_f32 v52, v52, v157
	v_dual_mul_f32 v40, v40, v156 :: v_dual_mul_f32 v57, v57, v157
	v_dual_mul_f32 v41, v41, v156 :: v_dual_mul_f32 v54, v54, v157
	v_dual_mul_f32 v42, v42, v156 :: v_dual_mul_f32 v59, v59, v157
	v_dual_mul_f32 v43, v43, v156 :: v_dual_mul_f32 v56, v56, v157
	v_dual_mul_f32 v44, v44, v156 :: v_dual_mul_f32 v61, v61, v157
	v_dual_mul_f32 v45, v45, v156 :: v_dual_mul_f32 v58, v58, v157
	v_dual_mul_f32 v46, v46, v156 :: v_dual_mul_f32 v63, v63, v157
	v_dual_mul_f32 v47, v47, v156 :: v_dual_mul_f32 v60, v60, v157
	s_waitcnt lgkmcnt(3)
	v_dual_mul_f32 v62, v62, v157 :: v_dual_fmac_f32 v135, v159, v0
	.loc	1 811 17                        ; ragged.py:811:17
	v_dual_fmac_f32 v134, v160, v1 :: v_dual_fmac_f32 v133, v161, v2
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v132, v162, v3 :: v_dual_fmac_f32 v131, v163, v4
	v_dual_fmac_f32 v130, v164, v5 :: v_dual_fmac_f32 v129, v165, v6
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v128, v166, v7 :: v_dual_fmac_f32 v127, v167, v8
	v_dual_fmac_f32 v126, v168, v9 :: v_dual_fmac_f32 v123, v170, v11
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v124, v169, v10 :: v_dual_fmac_f32 v121, v172, v13
	v_dual_fmac_f32 v122, v171, v12 :: v_dual_fmac_f32 v119, v154, v15
	v_dual_fmac_f32 v120, v173, v14 :: v_dual_fmac_f32 v117, v16, v0
	v_dual_fmac_f32 v116, v17, v1 :: v_dual_fmac_f32 v115, v18, v2
	v_dual_fmac_f32 v114, v19, v3 :: v_dual_fmac_f32 v113, v20, v4
	...
	v_dual_fmac_f32 v102, v31, v15 :: v_dual_fmac_f32 v101, v32, v0
	v_dual_fmac_f32 v100, v33, v1 :: v_dual_fmac_f32 v95, v35, v3
	v_dual_fmac_f32 v96, v34, v2 :: v_dual_fmac_f32 v93, v37, v5
	v_dual_fmac_f32 v94, v36, v4 :: v_dual_fmac_f32 v87, v42, v10
	v_dual_fmac_f32 v92, v38, v6 :: v_dual_fmac_f32 v89, v40, v8
	v_dual_fmac_f32 v90, v39, v7 :: v_dual_fmac_f32 v85, v44, v12
	v_dual_fmac_f32 v88, v41, v9 :: v_dual_fmac_f32 v83, v46, v14
	v_dual_fmac_f32 v86, v43, v11 :: v_dual_fmac_f32 v81, v48, v0
	v_dual_fmac_f32 v84, v45, v13 :: v_dual_fmac_f32 v79, v50, v2
	v_dual_fmac_f32 v82, v47, v15 :: v_dual_fmac_f32 v77, v52, v4
	v_dual_fmac_f32 v80, v49, v1 :: v_dual_fmac_f32 v75, v54, v6
	v_dual_fmac_f32 v78, v51, v3 :: v_dual_fmac_f32 v73, v56, v8
	v_dual_fmac_f32 v76, v53, v5 :: v_dual_fmac_f32 v71, v58, v10
	v_dual_fmac_f32 v74, v55, v7 :: v_dual_fmac_f32 v69, v60, v12
	v_dual_fmac_f32 v72, v57, v9 :: v_dual_fmac_f32 v67, v62, v14
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_sc128_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 203
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_sc128_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nt_sc128_evenk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 36
