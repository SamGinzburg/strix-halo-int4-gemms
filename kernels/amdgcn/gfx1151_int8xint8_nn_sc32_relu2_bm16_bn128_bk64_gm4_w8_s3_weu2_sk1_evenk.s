	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v10, 0xf0, v0
...
.Ltmp22:
	...
	v_dual_mov_b32 v23, 0 :: v_dual_lshlrev_b32 v6, 5, v0
	s_waitcnt lgkmcnt(0)
...
.Ltmp23:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
	s_ashr_i32 s24, s18, 6
	s_delay_alu instid0(VALU_DEP_3)
	v_xor_b32_e32 v8, v11, v8
	v_or3_b32 v11, v5, v2, s14
.Ltmp24:
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_add_nc_u32_e32 v5, s20, v17
	s_mov_b32 s20, s6
	s_mov_b32 s6, s0
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v25, 0, v8
	...
	v_xor_b32_e32 v28, 16, v6
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_add_u32 v21, v1, 1, v5
	v_mul_lo_u32 v2, s15, v2
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v26, 0, v3
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v27, 0, v6
	v_add3_u32 v4, v4, s1, v7
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v12, 0, v12
	v_add3_u32 v2, v2, s1, v7
	s_lshl_b32 s1, s2, 7
	s_mov_b32 s2, s0
	v_subrev_nc_u32_e32 v24, s1, v4
	v_or_b32_e32 v17, 8, v11
	v_subrev_nc_u32_e32 v22, s1, v2
	s_mov_b32 s1, s0
	v_mov_b32_e32 v8, s7
	v_or_b32_e32 v18, 10, v11
	v_or_b32_e32 v19, 12, v11
	v_or_b32_e32 v20, 14, v11
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v28, 0, v28
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[36:39], v24, s[20:23], 0 offen
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	...
	v_add_lshl_u32 v46, v13, s0, 1
	.loc	1 360 40                        ; generate_amdgcn.py:360:40
	s_mul_i32 s0, s0, s15
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v47, v11, s0, 1
	.loc	1 356 29                        ; generate_amdgcn.py:356:29
	s_ashr_i32 s1, s1, 5
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v48, v14, s0, 1
	v_add_lshl_u32 v49, v15, s0, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cmp_lt_i32 s1, s25
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v55, v13, s1, 1
	.loc	1 360 40                        ; generate_amdgcn.py:360:40
	s_mul_i32 s1, s1, s15
	.loc	1 360 22 is_stmt 0              ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v50, v16, s0, 1
	v_add_lshl_u32 v51, v17, s0, 1
	v_add_lshl_u32 v52, v18, s0, 1
	v_add_lshl_u32 v53, v19, s0, 1
	v_add_lshl_u32 v54, v20, s0, 1
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v56, v11, s1, 1
	v_add_lshl_u32 v57, v14, s1, 1
	v_add_lshl_u32 v58, v15, s1, 1
	v_add_lshl_u32 v59, v16, s1, 1
	v_add_lshl_u32 v60, v17, s1, 1
	v_add_lshl_u32 v61, v18, s1, 1
	v_add_lshl_u32 v62, v19, s1, 1
	v_add_lshl_u32 v63, v20, s1, 1
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(2)
	ds_store_b16 v25, v44 offset:8192
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v25, v45 offset:8704
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v26, v[40:43] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	ds_load_u8 v36, v12 offset:1664
	ds_load_u8 v37, v12 offset:1920
	ds_load_u8 v38, v12 offset:1792
	ds_load_u8 v39, v12 offset:1536
	ds_load_u8 v40, v12 offset:1152
	ds_load_u8 v41, v12 offset:1408
	ds_load_u8 v42, v12 offset:1280
	ds_load_u8 v43, v12 offset:1024
	ds_load_u8 v48, v12 offset:640
	ds_load_u8 v49, v12 offset:896
	ds_load_u8 v50, v12 offset:768
	ds_load_u8 v51, v12 offset:512
	ds_load_u8 v64, v12 offset:128
	ds_load_u8 v65, v12 offset:384
	ds_load_u8 v66, v12 offset:256
	ds_load_u8 v67, v12
	ds_load_u8 v68, v12 offset:3712
	ds_load_u8 v69, v12 offset:3968
	ds_load_u8 v70, v12 offset:3840
	ds_load_u8 v71, v12 offset:3584
	ds_load_u8 v72, v12 offset:3200
	ds_load_u8 v73, v12 offset:3456
	ds_load_u8 v74, v12 offset:3328
	ds_load_u8 v75, v12 offset:3072
	ds_load_u8 v94, v12 offset:2688
	ds_load_u8 v95, v12 offset:2944
	ds_load_u8 v96, v12 offset:2816
	ds_load_u8 v97, v12 offset:2560
	ds_load_u8 v98, v12 offset:2176
	ds_load_u8 v99, v12 offset:2432
	ds_load_u8 v100, v12 offset:2304
	ds_load_u8 v101, v12 offset:2048
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[44:47], v27 offset:8192
	ds_load_b128 v[52:55], v27 offset:8704
	ds_load_b128 v[56:59], v28 offset:8192
	ds_load_b128 v[60:63], v28 offset:8704
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v102, v12 offset:5760
	ds_load_u8 v103, v12 offset:6016
	ds_load_u8 v104, v12 offset:5888
	ds_load_u8 v105, v12 offset:5632
	ds_load_u8 v106, v12 offset:5248
	ds_load_u8 v107, v12 offset:5504
	ds_load_u8 v108, v12 offset:5376
	ds_load_u8 v109, v12 offset:5120
	ds_load_u8 v110, v12 offset:4736
	ds_load_u8 v111, v12 offset:4992
	ds_load_u8 v112, v12 offset:4864
	ds_load_u8 v113, v12 offset:4608
	ds_load_u8 v114, v12 offset:4224
	ds_load_u8 v115, v12 offset:4480
	ds_load_u8 v116, v12 offset:4352
	ds_load_u8 v117, v12 offset:4096
	ds_load_u8 v118, v12 offset:7808
	ds_load_u8 v119, v12 offset:8064
	ds_load_u8 v120, v12 offset:7936
	ds_load_u8 v121, v12 offset:7680
	ds_load_u8 v122, v12 offset:7296
	ds_load_u8 v123, v12 offset:7552
	ds_load_u8 v124, v12 offset:7424
	ds_load_u8 v125, v12 offset:7168
	ds_load_u8 v126, v12 offset:6784
	ds_load_u8 v127, v12 offset:7040
	ds_load_u8 v128, v12 offset:6912
	ds_load_u8 v129, v12 offset:6656
	ds_load_u8 v130, v12 offset:6272
	ds_load_u8 v131, v12 offset:6528
	ds_load_u8 v132, v12 offset:6400
	ds_load_u8 v133, v12 offset:6144
	...
	v_perm_b32 v40, v51, v48, 0xc0c0004
	...
	v_perm_b32 v94, v108, v107, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v95, v113, v110, 0xc0c0004
	v_perm_b32 v96, v112, v111, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v97, v117, v114, 0xc0c0004
	v_perm_b32 v98, v116, v115, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v99, v121, v118, 0xc0c0004
	v_perm_b32 v100, v120, v119, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v101, v125, v122, 0xc0c0004
	v_perm_b32 v102, v124, v123, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v103, v129, v126, 0xc0c0004
	v_perm_b32 v104, v128, v127, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v133, v130, 0xc0c0004
	v_perm_b32 v106, v132, v131, 0xc0c0004
	v_lshl_or_b32 v51, v37, 16, v36
	...
	v_wmma_i32_16x16x16_iu8 v[44:51], v[68:71], v[52:55], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[36:43], v[64:67], v[56:59], v[36:43] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[44:51], v[72:75], v[60:63], v[44:51] neg_lo:[1,1,0]
	...
	v_dual_mul_f32 v39, v39, v52 :: v_dual_add_nc_u32 v22, s27, v22
	v_dual_mul_f32 v41, v41, v52 :: v_dual_lshlrev_b32 v54, 16, v78
	v_dual_mul_f32 v36, v36, v52 :: v_dual_lshlrev_b32 v55, 16, v79
	v_dual_mul_f32 v38, v38, v52 :: v_dual_lshlrev_b32 v57, 16, v81
	v_dual_mul_f32 v43, v43, v52 :: v_dual_lshlrev_b32 v58, 16, v82
	v_dual_mul_f32 v40, v40, v52 :: v_dual_lshlrev_b32 v59, 16, v83
	...
	v_dual_mul_f32 v45, v45, v61 :: v_dual_add_nc_u32 v24, s27, v24
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(7)
	v_dual_fmac_f32 v23, v36, v53 :: v_dual_lshlrev_b32 v62, 16, v86
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	s_waitcnt vmcnt(6)
	...
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v34, v38, v55 :: v_dual_lshlrev_b32 v65, 16, v89
	s_waitcnt vmcnt(3)
	...
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v30, v42, v59 :: v_dual_lshlrev_b32 v69, 16, v93
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v48, v48, v61 :: v_dual_fmac_f32 v29, v43, v60
	v_dual_mul_f32 v50, v50, v61 :: v_dual_fmac_f32 v23, v44, v62
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	...
	v_dual_fmac_f32 v31, v49, v67 :: v_dual_fmac_f32 v32, v48, v66
	v_dual_fmac_f32 v30, v50, v68 :: v_dual_fmac_f32 v29, v51, v69
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_max_f32 v2, v35, v35 :: v_dual_max_f32 v3, v34, v34
	v_max_f32_e32 v1, v23, v23
	v_dual_max_f32 v5, v32, v32 :: v_dual_max_f32 v8, v29, v29
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_max_f32 v2, 0, v2 :: v_dual_max_f32 v3, 0, v3
	v_max_f32_e32 v4, v33, v33
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v6, v31, v31
	v_max_f32_e32 v7, v30, v30
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_max_f32 v13, 0, v5 :: v_dual_max_f32 v4, 0, v4
	v_dual_max_f32 v15, 0, v8 :: v_dual_max_f32 v6, 0, v6
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_max_f32_e32 v14, 0, v7
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v12, v1, v1 :: v_dual_mul_f32 v11, v2, v2
	v_dual_mul_f32 v7, v3, v3 :: v_dual_mul_f32 v8, v13, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v5, v4, v4 :: v_dual_mul_f32 v6, v6, v6
	v_dual_mul_f32 v4, v14, v14 :: v_dual_mul_f32 v3, v15, v15
	v_mov_b32_e32 v2, v9
.LBB0_7:                                ; %._crit_edge
	...
	v_dual_cndmask_b32 v10, 0x3276, v10 :: v_dual_and_b32 v1, 1, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_cndmask_b32_e32 v2, v11, v6, vcc_lo
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_perm_b32 v2, v6, v5, v2
	v_perm_b32 v3, v6, v5, v3
...
.Ltmp25:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 134
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 28
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     30
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
