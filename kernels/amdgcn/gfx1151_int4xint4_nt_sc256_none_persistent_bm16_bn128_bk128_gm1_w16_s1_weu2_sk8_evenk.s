...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_cvt_f32_u32 s6, s3
	s_sub_i32 s11, 0, s3
	v_dual_mov_b32 v83, 0 :: v_dual_mov_b32 v60, 0
	...
	v_dual_mov_b32 v70, 0 :: v_dual_mov_b32 v111, 0
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v111, 0 :: v_dual_mov_b32 v70, 0
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v195, v212, v196 :: v_dual_lshlrev_b32 v190, 16, v190
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v109, v195, v185
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	s_waitcnt vmcnt(15)
	v_dual_fmac_f32 v112, v194, v190 :: v_dual_lshlrev_b32 v187, 16, v187
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v103, v198, v187 :: v_dual_lshlrev_b32 v178, 16, v180
	.loc	1 274 24 is_stmt 0              ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(14)
	v_dual_mul_f32 v180, v209, v196 :: v_dual_lshlrev_b32 v177, 16, v177
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v99, v200, v191 :: v_dual_lshlrev_b32 v176, 16, v176
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v77, v204, v177
	.loc	1 274 24 is_stmt 0              ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v201, v217, v196 :: v_dual_fmac_f32 v82, v202, v179
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	...
	s_waitcnt vmcnt(35)
	v_dual_mul_f32 v160, v160, v196 :: v_dual_lshlrev_b32 v127, 16, v127
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(34)
	v_lshlrev_b32_e32 v125, 16, v125
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(32)
	v_dual_fmac_f32 v75, v205, v175 :: v_dual_lshlrev_b32 v126, 16, v126
	v_dual_fmac_f32 v73, v189, v127 :: v_dual_lshlrev_b32 v128, 16, v128
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v71, v184, v125
	...
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(41)
	v_dual_fmac_f32 v111, v130, v123 :: v_dual_lshlrev_b32 v168, 16, v168
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(40)
	...
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(37)
	v_dual_fmac_f32 v105, v132, v169 :: v_dual_lshlrev_b32 v172, 16, v172
	s_waitcnt vmcnt(36)
	v_dual_fmac_f32 v100, v134, v171 :: v_dual_lshlrev_b32 v173, 16, v173
	s_waitcnt vmcnt(35)
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_fmac_f32 v95, v136, v173 :: v_dual_lshlrev_b32 v188, 16, v188
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(34)
	v_lshlrev_b32_e32 v194, 16, v194
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(33)
	v_dual_mul_f32 v147, v147, v196 :: v_dual_lshlrev_b32 v190, 16, v190
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v102, v133, v170
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v153, v153, v196 :: v_dual_fmac_f32 v70, v142, v194
	v_dual_mul_f32 v157, v157, v196 :: v_dual_fmac_f32 v110, v144, v190
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(30)
	v_dual_fmac_f32 v108, v131, v168 :: v_dual_lshlrev_b32 v193, 16, v193
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(29)
	v_dual_mul_f32 v161, v161, v196 :: v_dual_lshlrev_b32 v186, 16, v186
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(28)
	...
	v_lshlrev_b32_e32 v185, 16, v185
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v165, v165, v196 :: v_dual_fmac_f32 v86, v150, v198
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(19)
	v_lshlrev_b32_e32 v191, 16, v191
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(15)
	v_dual_mul_f32 v7, v7, v196 :: v_dual_lshlrev_b32 v182, 16, v182
	v_dual_mul_f32 v155, v155, v196 :: v_dual_fmac_f32 v72, v141, v193
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	s_waitcnt vmcnt(11)
	v_dual_fmac_f32 v98, v135, v172 :: v_dual_lshlrev_b32 v177, 16, v177
	v_dual_fmac_f32 v97, v146, v195 :: v_dual_fmac_f32 v90, v148, v197
	v_fmac_f32_e32 v67, v152, v199
	v_fmac_f32_e32 v74, v140, v176
	v_fmac_f32_e32 v66, v153, v191
	v_dual_fmac_f32 v113, v129, v122 :: v_dual_add_nc_u32 v116, s45, v116
	v_dual_fmac_f32 v81, v137, v188 :: v_dual_fmac_f32 v56, v158, v202
	v_fmac_f32_e32 v78, v138, v178
	v_fmac_f32_e32 v76, v139, v180
	v_fmac_f32_e32 v94, v147, v186
	v_fmac_f32_e32 v88, v149, v187
	v_fmac_f32_e32 v62, v155, v183
	v_fmac_f32_e32 v60, v156, v201
	v_fmac_f32_e32 v58, v157, v179
	s_waitcnt vmcnt(9)
	v_dual_fmac_f32 v93, v160, v203 :: v_dual_lshlrev_b32 v126, 16, v126
	.loc	1 274 24 is_stmt 0              ; generate_amdgcn.py:274:24
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v159, v159, v196 :: v_dual_lshlrev_b32 v174, 16, v174
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v104, v145, v185
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_clause 0x2
	...
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_fmac_f32_e32 v55, v159, v182
	v_dual_fmac_f32 v84, v151, v192 :: v_dual_fmac_f32 v57, v4, v174
	v_dual_fmac_f32 v89, v163, v175 :: v_dual_fmac_f32 v64, v154, v200
	v_fmac_f32_e32 v87, v164, v205
	v_dual_fmac_f32 v92, v161, v177 :: v_dual_fmac_f32 v91, v162, v204
	v_fmac_f32_e32 v85, v165, v127
	v_fmac_f32_e32 v83, v166, v189
	v_dual_fmac_f32 v80, v167, v125 :: v_dual_fmac_f32 v65, v0, v184
	v_fmac_f32_e32 v61, v2, v181
	v_fmac_f32_e32 v59, v3, v126
	v_fmac_f32_e32 v68, v143, v124
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(2)
...
.LBB0_5:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v0, v110, v93 offset0:64 offset1:96
	ds_store_2addr_b32 v35, v114, v113 offset1:32
	ds_store_2addr_b32 v35, v104, v92 offset0:64 offset1:96
	ds_store_2addr_b32 v36, v112, v111 offset1:32
	ds_store_2addr_b32 v36, v97, v91 offset0:64 offset1:96
	ds_store_2addr_b32 v37, v109, v108 offset1:32
	ds_store_2addr_b32 v37, v94, v89 offset0:64 offset1:96
	ds_store_2addr_b32 v38, v106, v105 offset1:32
	ds_store_2addr_b32 v38, v90, v87 offset0:64 offset1:96
	ds_store_2addr_b32 v39, v103, v102 offset1:32
	ds_store_2addr_b32 v39, v88, v85 offset0:64 offset1:96
	ds_store_2addr_b32 v40, v101, v100 offset1:32
	ds_store_2addr_b32 v40, v86, v83 offset0:64 offset1:96
	ds_store_2addr_b32 v41, v99, v98 offset1:32
	ds_store_2addr_b32 v41, v84, v80 offset0:64 offset1:96
	ds_store_2addr_b32 v42, v96, v95 offset1:32
	...
	ds_store_2addr_b32 v44, v79, v78 offset1:32
	ds_store_2addr_b32 v44, v64, v61 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v46, v60, v57 offset0:64 offset1:96
	ds_store_2addr_b32 v47, v73, v72 offset1:32
	ds_store_2addr_b32 v47, v58, v54 offset0:64 offset1:96
	ds_store_2addr_b32 v48, v71, v70 offset1:32
	ds_store_2addr_b32 v48, v56, v53 offset0:64 offset1:96
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk8_evenk.numbered_sgpr, 52
