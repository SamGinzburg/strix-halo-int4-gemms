...
.LBB0_2:                                ;   in Loop: Header=BB0_3 Depth=1
	...
	v_dual_mul_f32 v27, v179, v27 :: v_dual_add_nc_u32 v34, 64, v34
	.loc	1 1213 40                       ; ragged.py:1213:40
	s_waitcnt vmcnt(3)
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v1, v1, v180 :: v_dual_add_nc_u32 v50, 64, v50
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v16, v180, v16 :: v_dual_lshlrev_b32 v195, 16, v195
	v_dual_mul_f32 v23, v179, v23 :: v_dual_add_nc_u32 v46, 64, v46
	v_dual_mul_f32 v30, v179, v30 :: v_dual_add_nc_u32 v39, 64, v39
	v_dual_mul_f32 v17, v179, v17 :: v_dual_add_nc_u32 v40, 64, v40
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v26, v179, v26 :: v_dual_add_nc_u32 v35, 64, v35
	v_dual_mul_f32 v29, v179, v29 :: v_dual_add_nc_u32 v36, 64, v36
	.loc	1 1219 17                       ; ragged.py:1219:17
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v28, v179, v28 :: v_dual_add_nc_u32 v37, 64, v37
	v_dual_mul_f32 v31, v179, v31 :: v_dual_add_nc_u32 v38, 64, v38
	v_dual_mul_f32 v32, v179, v32 :: v_dual_add_nc_u32 v41, 64, v41
	v_dual_mul_f32 v19, v179, v19 :: v_dual_add_nc_u32 v42, 64, v42
	v_dual_mul_f32 v18, v179, v18 :: v_dual_add_nc_u32 v43, 64, v43
	v_dual_mul_f32 v21, v179, v21 :: v_dual_add_nc_u32 v44, 64, v44
	v_dual_mul_f32 v20, v179, v20 :: v_dual_add_nc_u32 v45, 64, v45
	v_dual_mul_f32 v22, v179, v22 :: v_dual_add_nc_u32 v47, 64, v47
	v_dual_mul_f32 v25, v25, v179 :: v_dual_add_nc_u32 v48, 64, v48
	v_dual_mul_f32 v24, v179, v24 :: v_dual_add_nc_u32 v49, 64, v49
	v_dual_mul_f32 v2, v180, v2 :: v_dual_add_nc_u32 v51, 64, v51
	v_dual_mul_f32 v3, v180, v3 :: v_dual_add_nc_u32 v52, 64, v52
	v_dual_mul_f32 v4, v180, v4 :: v_dual_add_nc_u32 v53, 64, v53
	v_dual_mul_f32 v5, v180, v5 :: v_dual_add_nc_u32 v54, 64, v54
	v_dual_mul_f32 v6, v180, v6 :: v_dual_add_nc_u32 v55, 64, v55
	v_dual_mul_f32 v7, v180, v7 :: v_dual_add_nc_u32 v56, 64, v56
	v_dual_mul_f32 v8, v180, v8 :: v_dual_add_nc_u32 v57, 64, v57
	v_dual_mul_f32 v9, v180, v9 :: v_dual_add_nc_u32 v58, 64, v58
	v_dual_mul_f32 v10, v180, v10 :: v_dual_add_nc_u32 v59, 64, v59
	v_dual_mul_f32 v11, v180, v11 :: v_dual_add_nc_u32 v60, 64, v60
	v_dual_mul_f32 v12, v180, v12 :: v_dual_add_nc_u32 v61, 64, v61
	v_dual_mul_f32 v13, v180, v13 :: v_dual_add_nc_u32 v62, 64, v62
	v_dual_mul_f32 v14, v180, v14 :: v_dual_add_nc_u32 v63, 64, v63
	v_dual_mul_f32 v15, v180, v15 :: v_dual_add_nc_u32 v64, 64, v64
	.loc	1 1213 40                       ; ragged.py:1213:40
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 219
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc128_maskk_bfloat16_paired_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 97
