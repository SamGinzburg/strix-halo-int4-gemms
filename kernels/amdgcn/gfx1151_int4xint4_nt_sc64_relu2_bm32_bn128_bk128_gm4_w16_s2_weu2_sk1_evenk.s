	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	buffer_load_u16 v32, v3, s[12:15], 0 offen
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	buffer_load_u16 v70, v2, s[8:11], 0 offen
	...
	s_clause 0x7
	buffer_load_u16 v26, v2, s[28:31], 0 offen
	...
	buffer_load_u16 v76, v24, s[28:31], 0 offen
	...
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	buffer_load_b64 v[58:59], v1, s[24:27], 0 offen
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[24:25], v41 offset:4096
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	ds_load_b64 v[28:29], v43
	v_add_nc_u32_e32 v47, 0, v30
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[30:31], v44 offset:4096
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	ds_load_b64 v[60:61], v45
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[62:63], v46 offset:4096
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	...
	v_mov_b32_e32 v7, v1
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_b64 v[66:67], v48 offset:4096
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	ds_load_b64 v[68:69], v49
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(9)
	ds_store_b16 v36, v70 offset:4096
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	s_waitcnt vmcnt(0)
	ds_store_b64 v37, v[58:59]
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_wmma_i32_16x16x16_iu4 v[50:57], v[28:29], v[24:25], v[1:8] neg_lo:[1,1,0]
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v26, 16, v26
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_wmma_i32_16x16x16_iu4 v[50:57], v[60:61], v[30:31], v[50:57] neg_lo:[1,1,0]
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_lshlrev_b32_e32 v60, 16, v77
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_wmma_i32_16x16x16_iu4 v[50:57], v[64:65], v[62:63], v[50:57] neg_lo:[1,1,0]
	...
	v_fma_f32 v25, v25, v52, 0
	v_fma_f32 v26, v28, v53, 0
	v_fma_f32 v28, v29, v54, 0
	v_fma_f32 v29, v30, v55, 0
	v_fma_f32 v30, v31, v56, 0
	v_fma_f32 v31, v50, v57, 0
	v_fma_f32 v32, v32, v60, 0
	.loc	1 188 9 is_stmt 1               ; generate_amdgcn.py:188:9
	s_cbranch_scc1 .LBB0_7
; %bb.5:                                ; %.peel.next
	v_add3_u32 v12, s18, v42, v12
	v_lshl_or_b32 v42, s33, 7, v38
	s_lshl_b32 s0, s33, 8
	s_lshl_b32 s5, s7, 1
	...
	v_mad_u64_u32 v[11:12], null, s23, v42, v[9:10]
	v_lshl_add_u32 v9, v40, 1, 2
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	buffer_load_u16 v12, v9, s[12:15], 0 offen
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e32 vcc_lo, s19, v50
	v_cmp_lt_i32_e64 s0, s19, v51
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_add_i32 s22, s22, -1
	...
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_add_nc_u32_e32 v40, s19, v11
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	v_add_nc_u32_e32 v52, v38, v39
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	v_add_nc_u32_e32 v42, s19, v10
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	buffer_load_u16 v79, v52, s[28:31], 0 offen offset:4
	buffer_load_u16 v80, v52, s[28:31], 0 offen offset:8
	buffer_load_u16 v81, v52, s[28:31], 0 offen offset:12
	buffer_load_u16 v82, v52, s[28:31], 0 offen offset:16
	buffer_load_u16 v83, v52, s[28:31], 0 offen offset:20
	buffer_load_u16 v84, v52, s[28:31], 0 offen offset:24
	buffer_load_u16 v85, v52, s[28:31], 0 offen offset:28
	.loc	1 218 26                        ; generate_amdgcn.py:218:26
	...
	buffer_load_b64 v[60:61], v42, s[24:27], 0 offen
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(9)
	...
	v_dual_mul_f32 v52, v12, v52 :: v_dual_lshlrev_b32 v59, 16, v79
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 233 13 is_stmt 0              ; generate_amdgcn.py:233:13
	v_fmac_f32_e32 v25, v52, v59
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v42, v12, v42 :: v_dual_add_nc_u32 v39, s5, v39
	...
	v_dual_fmac_f32 v28, v54, v63 :: v_dual_fmac_f32 v29, v55, v64
	v_fmac_f32_e32 v30, v56, v65
	s_delay_alu instid0(VALU_DEP_4)
	v_fmac_f32_e32 v24, v42, v58
	v_fmac_f32_e32 v31, v57, v66
	v_fmac_f32_e32 v26, v53, v62
	v_fmac_f32_e32 v32, v12, v67
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
...
.LBB0_10:
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v5, v5, v17, v30
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_max_f32_e32 v2, 0, v2
	v_max_f32_e32 v4, v4, v4
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v6, v6, v19, v31
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v7, v7, v18, v32
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_mov_b16_e32 v27.l, v2.h
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	v_dual_mul_f32 v4, v4, v4 :: v_dual_mul_f32 v1, v1, v1
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	...
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	v_dual_mul_f32 v6, v6, v6 :: v_dual_max_f32 v7, v7, v7
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_dual_max_f32 v5, 0, v5 :: v_dual_and_b32 v10, 1, v22
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	...
	.loc	1 240 19                        ; generate_amdgcn.py:240:19
	v_dual_max_f32 v7, 0, v7 :: v_dual_and_b32 v14, 1, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 241 19                        ; generate_amdgcn.py:241:19
	v_dual_mul_f32 v7, v7, v7 :: v_dual_cndmask_b32 v12, 0x3276, v21
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_vgpr, 86
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.numbered_sgpr, 35
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     37
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc64_relu2_bm32_bn128_bk128_gm4_w16_s2_weu2_sk1_evenk.kd
