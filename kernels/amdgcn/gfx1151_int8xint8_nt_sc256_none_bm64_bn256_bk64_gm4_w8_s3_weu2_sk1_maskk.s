	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_12:
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v90, v16, v88 :: v_dual_cndmask_b32 v39, 0x80000000, v39
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_dual_cndmask_b32 v38, 0x80000000, v38 :: v_dual_mul_f32 v91, v15, v88
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v16, v16, v88 :: v_dual_lshlrev_b32 v35, 16, v35
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v126, v10, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v17, v119, v230, v43
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v125, v9, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v103, v130, v233, v41
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v130, v14, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v110, v9, v34
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v26, v26, v43, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v111, v10, v34
	v_mul_f32_e32 v116, v15, v34
	v_mul_f32_e32 v131, v15, v35
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v122, v6, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v99, v115, v162, v47
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v123, v7, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v98, v114, v191, v48
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v124, v8, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_mul_f32_e32 v107, v6, v34
	v_mul_f32_e32 v108, v7, v34
	v_mul_f32_e32 v109, v8, v34
	v_mul_f32_e32 v114, v13, v34
	v_mul_f32_e32 v115, v14, v34
	v_dual_mul_f32 v121, v5, v35 :: v_dual_mul_f32 v6, v6, v36
	...
	v_dual_mul_f32 v46, v3, v38 :: v_dual_mul_f32 v117, v1, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v120, v4, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v97, v113, v127, v49
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v127, v11, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fma_f32 v101, v118, v235, v44
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_mul_f32_e32 v128, v12, v35
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_mul_f32_e32 v102, v1, v34
	v_mul_f32_e32 v103, v2, v34
	v_mul_f32_e32 v104, v3, v34
	v_mul_f32_e32 v105, v4, v34
	v_mul_f32_e32 v106, v5, v34
	v_mul_f32_e32 v113, v12, v34
	v_mul_f32_e32 v34, v16, v34
	v_mul_f32_e32 v118, v2, v35
	v_mul_f32_e32 v119, v3, v35
	v_mul_f32_e32 v129, v13, v35
	...
	v_cndmask_b32_e64 v35, v71, v35, s2
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v34, v55, v34, s2
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b16 v32.h, 0x7fff, v36.h, s0
	...
	v_cndmask_b16 v36.h, 0x7fff, v37.h, s1
	...
	v_cndmask_b16 v34.h, 0x7fff, v38.h, s0
	...
	v_cndmask_b16 v35.h, 0x7fff, v42.h, s0
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_dual_cndmask_b32 v21, v17, v27 :: v_dual_add_nc_u32 v2, 0x80, v4
	v_cndmask_b32_e32 v17, v27, v17, vcc_lo
	v_dual_cndmask_b32 v22, v19, v28 :: v_dual_cndmask_b32 v19, v28, v19
	v_dual_cndmask_b32 v27, v34, v33 :: v_dual_cndmask_b32 v28, v33, v34
	...
	v_dual_cndmask_b32 v12, 0x3276, v40 :: v_dual_cndmask_b32 v23, v30, v29
	...
	v_dual_cndmask_b32 v36, v42, v35 :: v_dual_cndmask_b32 v35, v35, v42
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_and_b32_e32 v10, 0x540054, v10
	v_dual_cndmask_b32 v37, v7, v43 :: v_dual_and_b32 v12, 0x760076, v12
	...
	v_perm_b32 v31, v35, v36, v40
	v_perm_b32 v32, v35, v36, v41
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 72
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 72
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
