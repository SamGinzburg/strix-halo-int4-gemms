...
.Ltmp15:
	...
	v_or_b32_e32 v2, s6, v41
	v_or_b32_e32 v3, s6, v40
	v_or_b32_e32 v4, s6, v42
.Ltmp16:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:307:28 ]
	s_lshr_b32 s4, s4, 25
.Ltmp17:
...
.Ltmp19:
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v3, s6, v47
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v4, s42, v41
	v_or_b32_e32 v5, s42, v40
	v_or_b32_e32 v6, s42, v42
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v50, s42, v41
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_lshr_b32 s18, s18, 25
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v51, s42, v47
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_add_i32 s0, s0, s18
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	s_mul_i32 s19, s42, s35
	.loc	1 343 23                        ; generate_amdgcn.py:343:23
	...
	buffer_load_u16 v129, v59, s[36:39], 0 offen
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v51, s42, v40
	v_or_b32_e32 v50, s42, v42
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	...
	buffer_load_b128 v[70:73], v51, s[24:27], 0 offen
	s_mov_b32 s0, s14
	s_mov_b32 s14, s43
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
...
; %bb.8:
	...
	v_dual_mov_b32 v50, s23 :: v_dual_mov_b32 v49, s22
	...
	v_dual_mov_b32 v47, s20 :: v_dual_add_nc_u32 v72, s14, v39
...
; %bb.10:
	...
	ds_load_u8 v78, v3
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v98, s43, v38
	v_add_nc_u32_e32 v80, s43, v36
	v_add_nc_u32_e32 v79, s43, v37
	v_add_nc_u32_e32 v106, s43, v39
	.loc	1 353 19                        ; generate_amdgcn.py:353:19
	s_waitcnt lgkmcnt(13)
	...
	v_dual_mov_b32 v73, s23 :: v_dual_mov_b32 v72, s22
	...
	v_dual_mov_b32 v71, s21 :: v_dual_mov_b32 v68, s18
...
.LBB0_11:
	...
	s_cmp_lt_i32 s8, s1
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	v_add_lshl_u32 v34, v34, s8, 1
	v_add_lshl_u32 v35, v35, s8, 1
	.loc	1 366 40                        ; generate_amdgcn.py:366:40
	s_mul_i32 s8, s8, s35
	.loc	1 363 34                        ; generate_amdgcn.py:363:34
	...
	v_add_lshl_u32 v31, v31, s8, 1
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_and_b32 vcc_lo, s2, s1
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	v_add_lshl_u32 v29, v29, s8, 1
	v_add_lshl_u32 v27, v27, s8, 1
	v_add_lshl_u32 v30, v30, s8, 1
	v_add_lshl_u32 v28, v28, s8, 1
