	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	v_and_b32_e32 v19, 0x78, v4
	v_and_b32_e32 v16, 0x218, v16
	v_and_b32_e32 v21, 1, v0
	v_bfe_i32 v22, v0, 7, 1
	v_xor_b32_e32 v28, v4, v17
...
.Ltmp20:
	...
	v_mul_lo_u32 v1, s29, v35
	.loc	1 222 36                        ; generate_amdgcn.py:222:36
	v_lshrrev_b32_e32 v8, 1, v32
	v_xor_b32_e32 v29, 8, v27
	v_xor_b32_e32 v30, 16, v27
	v_xor_b32_e32 v44, 24, v27
	v_add_nc_u32_e32 v46, 0, v2
	v_xor_b32_e32 v7, 8, v33
	v_xor_b32_e32 v48, 16, v33
	v_xor_b32_e32 v49, 24, v33
	v_xor_b32_e32 v0, 32, v33
	v_xor_b32_e32 v6, 40, v33
	v_xor_b32_e32 v52, 48, v33
	v_xor_b32_e32 v53, 56, v33
	v_xor_b32_e32 v54, 0x2010, v34
	v_xor_b32_e32 v55, 0x4020, v34
	v_xor_b32_e32 v56, 0x6030, v34
	s_cvt_u32_f32 s0, s0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_or_b32_e32 v36, v26, v2
	s_sub_i32 s3, 0, s43
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_and_b32_e32 v37, 2, v31
	s_mul_i32 s3, s3, s0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_and_or_b32 v25, v4, 28, s1
	v_or_b32_e32 v38, 32, v36
	v_lshl_add_u32 v39, v2, 3, v1
	v_add_nc_u32_e32 v40, 0, v28
	v_add_nc_u32_e32 v41, 0, v27
	v_add_nc_u32_e32 v42, 0, v29
	v_add_nc_u32_e32 v43, 0, v30
	v_add_nc_u32_e32 v44, 0, v44
	v_add_nc_u32_e32 v45, 0, v45
	v_add_nc_u32_e32 v46, v46, v8
...
; %bb.3:                                ; %.lr.ph
	...
	v_lshl_or_b32 v0, s1, 8, v32
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v1, s50, v38
	s_lshl_b32 s3, s0, 8
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v2, s50, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v28, s3, v0
	v_dual_mov_b32 v15, 0 :: v_dual_add_nc_u32 v0, s50, v31
	v_mul_lo_u32 v29, s49, v1
	v_lshl_add_u32 v1, s1, 7, v39
	v_mul_lo_u32 v30, s49, v2
	v_mad_u64_u32 v[26:27], null, s35, v0, v[25:26]
	s_lshl_b32 s0, s0, 7
	v_dual_mov_b32 v14, 0 :: v_dual_mov_b32 v11, 0
	v_subrev_nc_u32_e32 v27, s0, v1
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_nc_u32_e32 v57, s52, v25
	.loc	1 259 31                        ; generate_amdgcn.py:259:31
	v_add_nc_u32_e32 v58, s52, v35
	...
	s_add_i32 s53, s53, -1
	.loc	1 265 30                        ; generate_amdgcn.py:265:30
	buffer_load_b32 v59, v57, s[20:23], 0 offen
	.loc	1 270 30                        ; generate_amdgcn.py:270:30
	v_cndmask_b32_e64 v57, 0x80000000, v27, s0
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v40, v59
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[73:76], v41 offset1:2
	ds_load_2addr_stride64_b64 v[77:80], v42 offset1:2
	ds_load_2addr_stride64_b64 v[81:84], v43 offset1:2
	ds_load_2addr_stride64_b64 v[85:88], v44 offset1:2
	.loc	1 270 30                        ; generate_amdgcn.py:270:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	s_barrier
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	ds_load_u8 v57, v46 offset:640
	ds_load_u8 v58, v46 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	ds_load_u8 v58, v46 offset:896
	ds_load_u8 v59, v46 offset:768
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v90, v58, 16, v57
	ds_load_u8 v57, v46 offset:128
	ds_load_u8 v58, v46
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	ds_load_u8 v58, v46 offset:384
	ds_load_u8 v59, v46 offset:256
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	...
	.loc	1 272 22                        ; generate_amdgcn.py:272:22
	s_clause 0x1
	buffer_load_u16 v73, v30, s[8:11], 0 offen
	buffer_load_u16 v74, v29, s[8:11], 0 offen
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	ds_load_u8 v77, v46 offset:2688
	ds_load_u8 v78, v46 offset:2560
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	ds_load_u8 v78, v46 offset:2944
	ds_load_u8 v91, v46 offset:2816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v78, v91, v78, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v78, v78, 16, v77
	ds_load_u8 v77, v46 offset:2176
	ds_load_u8 v91, v46 offset:2048
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v77, v91, v77, 0xc0c0004
	ds_load_u8 v91, v46 offset:2432
	ds_load_u8 v92, v46 offset:2304
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v91, v92, v91, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v77, v91, 16, v77
	v_wmma_i32_16x16x16_iu4 v[65:72], v[77:78], v[81:82], v[65:72] neg_lo:[1,1,0]
	ds_load_u8 v81, v46 offset:3712
	ds_load_u8 v82, v46 offset:3584
	v_wmma_i32_16x16x16_iu4 v[57:64], v[77:78], v[83:84], v[57:64] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	ds_load_u8 v82, v46 offset:3968
	ds_load_u8 v91, v46 offset:3840
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v82, v91, v82, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v82, v82, 16, v81
	ds_load_u8 v81, v46 offset:3200
	ds_load_u8 v91, v46 offset:3072
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v81, v91, v81, 0xc0c0004
	ds_load_u8 v91, v46 offset:3456
	ds_load_u8 v92, v46 offset:3328
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v91, v92, v91, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_dual_mul_f32 v66, v66, v73 :: v_dual_add_nc_u32 v75, v37, v28
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	buffer_load_u16 v76, v75, s[24:27], 0 offen
	buffer_load_u16 v77, v75, s[24:27], 0 offen offset:4
	buffer_load_u16 v78, v75, s[24:27], 0 offen offset:8
	buffer_load_u16 v79, v75, s[24:27], 0 offen offset:12
	buffer_load_u16 v80, v75, s[24:27], 0 offen offset:16
	buffer_load_u16 v81, v75, s[24:27], 0 offen offset:20
	buffer_load_u16 v82, v75, s[24:27], 0 offen offset:24
	buffer_load_u16 v75, v75, s[24:27], 0 offen offset:28
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	...
	.loc	1 274 24                        ; generate_amdgcn.py:274:24
	v_dual_mul_f32 v59, v59, v74 :: v_dual_fmac_f32 v12, v65, v76
	v_dual_mul_f32 v61, v61, v74 :: v_dual_fmac_f32 v14, v66, v77
	v_dual_mul_f32 v63, v63, v74 :: v_dual_fmac_f32 v8, v68, v79
	.loc	1 274 17 is_stmt 0              ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v10, v67, v78 :: v_dual_fmac_f32 v13, v57, v76
	v_dual_fmac_f32 v6, v69, v80 :: v_dual_fmac_f32 v15, v58, v77
	v_dual_fmac_f32 v4, v70, v81 :: v_dual_fmac_f32 v11, v59, v78
	v_dual_fmac_f32 v2, v71, v82 :: v_dual_fmac_f32 v9, v60, v79
	v_dual_fmac_f32 v0, v72, v75 :: v_dual_fmac_f32 v7, v61, v80
	v_fmac_f32_e32 v5, v62, v81
	v_fmac_f32_e32 v3, v63, v82
	v_fmac_f32_e32 v1, v64, v75
...
.LBB0_5:                                ; %._crit_edge
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add_co_u32 v27, vcc_lo, s30, v12
	v_add_co_ci_u32_e64 v28, null, s31, v13, vcc_lo
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	ds_load_2addr_b64 v[12:15], v0 offset1:16
	ds_load_2addr_b64 v[8:11], v54 offset1:16
	ds_load_2addr_b64 v[4:7], v55 offset1:16
	ds_load_2addr_b64 v[0:3], v56 offset1:16
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
...
.LBB0_8:                                ; %atomicrmw.start80
	...
	global_atomic_cmpswap_b32 v12, v[27:28], v[29:30], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_10:                               ; %atomicrmw.start74
	...
	v_add_f32_e32 v29, v30, v4
	global_atomic_cmpswap_b32 v8, v[27:28], v[29:30], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_12:                               ; %atomicrmw.start68
	...
	global_atomic_cmpswap_b32 v4, v[27:28], v[29:30], off glc
	s_waitcnt vmcnt(0)
...
.LBB0_14:                               ; %atomicrmw.start62
	...
	global_atomic_cmpswap_b32 v0, v[27:28], v[29:30], off glc
	s_waitcnt vmcnt(0)
	v_cmp_eq_u32_e32 vcc_lo, v0, v30
...
.LBB0_24:                               ; %atomicrmw.start32
                                        ...
                                        ; =>  This Inner Loop Header: Depth=2
	s_waitcnt vmcnt(0)
	v_add_f32_e32 v27, v28, v9
	global_atomic_cmpswap_b32 v0, v[12:13], v[27:28], off glc
	s_waitcnt vmcnt(0)
	v_cmp_eq_u32_e32 vcc_lo, v0, v28
...
.Ltmp21:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.num_vgpr, 93
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.numbered_sgpr, 54
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     56
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_persistent_bm64_bn128_bk128_gm1_w16_s1_weu2_sk4_maskk.kd
