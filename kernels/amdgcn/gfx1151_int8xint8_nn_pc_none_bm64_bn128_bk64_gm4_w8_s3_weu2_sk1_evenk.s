...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s25, v54, v[1:2]
...
.Ltmp13:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b128 v[5:8], v7, s[16:19], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b128 v[9:12], v63, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[13:16], v65, s[20:23], 0 offen
	buffer_load_b128 v[17:20], v64, s[20:23], 0 offen
	s_mov_b32 s6, s27
	s_mov_b32 s27, s0
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v49, v49, v70 :: v_dual_add_nc_u32 v64, s28, v64
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_add_i32 s1, s6, s1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v42, v42, v66 :: v_dual_add_nc_u32 v65, s28, v65
	...
	v_dual_add_f32 v37, v37, v81 :: v_dual_add_f32 v22, v22, v83
	v_dual_add_f32 v21, v21, v82 :: v_dual_add_f32 v34, v34, v85
	v_dual_add_f32 v33, v33, v84 :: v_dual_add_f32 v26, v26, v87
	v_dual_add_f32 v25, v25, v86 :: v_dual_add_f32 v30, v30, v89
	v_dual_add_f32 v29, v29, v88 :: v_dual_add_f32 v32, v32, v91
	v_dual_add_f32 v31, v31, v90 :: v_dual_add_f32 v36, v36, v93
	v_dual_add_f32 v35, v35, v92 :: v_dual_add_f32 v24, v24, v95
	v_dual_add_f32 v23, v23, v94 :: v_dual_add_f32 v28, v28, v97
...
; %bb.9:
	...
	s_mov_b32 s11, s4
	.loc	1 378 22 is_stmt 1              ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v19, s8, v1
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_mov_b32 s8, s4
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v18, s27, v60
	v_add_nc_u32_e32 v2, s27, v57
	ds_load_b128 v[69:72], v18
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v3, v19 offset:1664
	ds_load_u8 v4, v19 offset:1536
	ds_load_u8 v5, v19 offset:1920
	ds_load_u8 v6, v19 offset:1792
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[77:80], v2 offset:2048
	ds_load_b128 v[73:76], v2
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v2, v19 offset:1152
	ds_load_u8 v7, v19 offset:1024
	ds_load_u8 v8, v19 offset:1408
	ds_load_u8 v9, v19 offset:1280
	ds_load_u8 v11, v19 offset:640
	ds_load_u8 v12, v19 offset:512
	ds_load_u8 v13, v19 offset:896
	ds_load_u8 v14, v19 offset:768
	ds_load_u8 v15, v19 offset:128
	ds_load_u8 v16, v19
	ds_load_u8 v17, v19 offset:384
	ds_load_u8 v61, v19 offset:256
	ds_load_u8 v62, v19 offset:1984
	ds_load_u8 v63, v19 offset:1856
	ds_load_u8 v64, v19 offset:1728
	ds_load_u8 v65, v19 offset:1600
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v3, v4, v3, 0xc0c0004
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v4, v6, v5, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v10, s27, v59
	v_add_nc_u32_e32 v20, s27, v58
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	v_lshl_or_b32 v83, v5, 16, v2
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v8, v16, v15, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v9, v61, v17, 0xc0c0004
	v_lshl_or_b32 v82, v7, 16, v6
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v65, v64, 0xc0c0004
	v_lshl_or_b32 v81, v9, 16, v8
	v_mov_b32_e32 v2, s4
	ds_load_u8 v61, v19 offset:3712
	ds_load_u8 v93, v19 offset:3584
	v_mov_b32_e32 v7, s9
	ds_load_u8 v94, v19 offset:3968
	ds_load_u8 v95, v19 offset:3840
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[85:88], v10 offset:2048
	ds_load_b128 v[89:92], v10
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v96, v19 offset:3200
	ds_load_u8 v97, v19 offset:3072
	ds_load_u8 v98, v19 offset:3456
	ds_load_u8 v99, v19 offset:3328
	ds_load_u8 v100, v19 offset:2688
	ds_load_u8 v101, v19 offset:2560
	ds_load_u8 v102, v19 offset:2944
	ds_load_u8 v103, v19 offset:2816
	ds_load_u8 v117, v19 offset:4032
	ds_load_u8 v118, v19 offset:3904
	ds_load_u8 v119, v19 offset:3776
	ds_load_u8 v120, v19 offset:3648
	ds_load_u8 v66, v19 offset:1472
	ds_load_u8 v67, v19 offset:1344
	ds_load_u8 v68, v19 offset:1216
	ds_load_u8 v105, v19 offset:1088
	...
	ds_load_u8 v109, v19 offset:960
	ds_load_u8 v110, v19 offset:832
	ds_load_u8 v111, v19 offset:704
	ds_load_u8 v112, v19 offset:576
	ds_load_u8 v113, v19 offset:448
	ds_load_u8 v114, v19 offset:320
	ds_load_u8 v115, v19 offset:192
	ds_load_u8 v116, v19 offset:64
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v97, v97, v96, 0xc0c0004
	ds_load_u8 v125, v19 offset:3008
	ds_load_u8 v126, v19 offset:2880
	ds_load_u8 v127, v19 offset:2752
	ds_load_u8 v128, v19 offset:2624
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v98, v99, v98, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[10:17], v[81:84], v[73:76], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v99, v101, v100, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v100, v103, v102, 0xc0c0004
	v_perm_b32 v61, v93, v61, 0xc0c0004
	ds_load_u8 v93, v19 offset:2176
	ds_load_u8 v104, v19 offset:2048
	v_perm_b32 v94, v95, v94, 0xc0c0004
	ds_load_u8 v95, v19 offset:2432
	ds_load_u8 v106, v19 offset:2304
	ds_load_u8 v121, v19 offset:3520
	ds_load_u8 v122, v19 offset:3392
	ds_load_u8 v123, v19 offset:3264
	ds_load_u8 v124, v19 offset:3136
	ds_load_u8 v101, v19 offset:5760
	ds_load_u8 v102, v19 offset:5632
	ds_load_u8 v129, v19 offset:2496
	ds_load_u8 v130, v19 offset:2368
	ds_load_u8 v131, v19 offset:2240
	ds_load_u8 v132, v19 offset:2112
	ds_load_u8 v143, v19 offset:5056
	ds_load_u8 v144, v19 offset:4928
	ds_load_u8 v145, v19 offset:4800
	ds_load_u8 v146, v19 offset:4672
	v_lshl_or_b32 v96, v94, 16, v61
	v_lshl_or_b32 v94, v100, 16, v99
	ds_load_u8 v147, v19 offset:4544
	ds_load_u8 v148, v19 offset:4416
	ds_load_u8 v149, v19 offset:4288
	ds_load_u8 v150, v19 offset:4160
	s_waitcnt lgkmcnt(34)
	v_perm_b32 v63, v105, v68, 0xc0c0004
	ds_load_u8 v164, v19 offset:7104
	ds_load_u8 v165, v19 offset:6976
	ds_load_u8 v166, v19 offset:6848
	ds_load_u8 v167, v19 offset:6720
	...
	v_lshl_or_b32 v112, v62, 16, v64
	v_lshl_or_b32 v111, v65, 16, v63
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v103, v106, v95, 0xc0c0004
	v_lshl_or_b32 v95, v98, 16, v97
	v_perm_b32 v93, v104, v93, 0xc0c0004
	ds_load_u8 v104, v19 offset:6016
	ds_load_u8 v106, v19 offset:5888
	v_lshl_or_b32 v110, v67, 16, v66
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v101, v102, v101, 0xc0c0004
	ds_load_u8 v102, v19 offset:4224
	ds_load_u8 v137, v19 offset:4096
	v_lshl_or_b32 v93, v103, 16, v93
	ds_load_u8 v61, v19 offset:5248
	ds_load_u8 v97, v19 offset:5120
	ds_load_u8 v98, v19 offset:5504
	ds_load_u8 v99, v19 offset:5376
	ds_load_u8 v100, v19 offset:4736
	ds_load_u8 v103, v19 offset:4608
	ds_load_u8 v107, v19 offset:4992
	ds_load_u8 v108, v19 offset:4864
	ds_load_u8 v133, v19 offset:6080
	ds_load_u8 v134, v19 offset:5952
	ds_load_u8 v135, v19 offset:5824
	ds_load_u8 v136, v19 offset:5696
	v_lshl_or_b32 v109, v109, 16, v68
	v_perm_b32 v113, v120, v119, 0xc0c0004
	v_perm_b32 v114, v118, v117, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[10:17], v[93:96], v[89:92], v[10:17] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v61, v97, v61, 0xc0c0004
	v_perm_b32 v121, v130, v129, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v97, v99, v98, 0xc0c0004
	v_lshl_or_b32 v116, v114, 16, v113
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v98, v103, v100, 0xc0c0004
	v_perm_b32 v104, v106, v104, 0xc0c0004
	ds_load_u8 v106, v19 offset:4480
	ds_load_u8 v138, v19 offset:4352
	ds_load_u8 v139, v19 offset:5568
	ds_load_u8 v140, v19 offset:5440
	ds_load_u8 v141, v19 offset:5312
	ds_load_u8 v142, v19 offset:5184
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v103, v108, v107, 0xc0c0004
	v_perm_b32 v102, v137, v102, 0xc0c0004
	ds_load_u8 v107, v19 offset:7808
	ds_load_u8 v108, v19 offset:7680
	ds_load_u8 v137, v19 offset:8064
	ds_load_u8 v151, v19 offset:7936
	v_lshl_or_b32 v100, v104, 16, v101
	v_lshl_or_b32 v99, v97, 16, v61
	v_lshl_or_b32 v98, v103, 16, v98
	v_lshl_or_b32 v115, v117, 16, v115
	v_lshl_or_b32 v114, v119, 16, v118
	v_lshl_or_b32 v113, v121, 16, v120
	v_perm_b32 v117, v146, v145, 0xc0c0004
	v_perm_b32 v118, v144, v143, 0xc0c0004
	v_perm_b32 v119, v150, v149, 0xc0c0004
	v_perm_b32 v120, v148, v147, 0xc0c0004
	v_perm_b32 v125, v167, v166, 0xc0c0004
	v_perm_b32 v126, v165, v164, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v106, v138, v106, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v126, v126, 16, v125
	v_lshl_or_b32 v97, v106, 16, v102
	ds_load_u8 v61, v19 offset:7296
	ds_load_u8 v101, v19 offset:7168
	ds_load_u8 v102, v19 offset:7552
	ds_load_u8 v103, v19 offset:7424
	ds_load_u8 v104, v19 offset:6784
	ds_load_u8 v106, v19 offset:6656
	ds_load_u8 v138, v19 offset:7040
	ds_load_u8 v152, v19 offset:6912
	ds_load_u8 v153, v19 offset:8128
	ds_load_u8 v154, v19 offset:8000
	ds_load_u8 v155, v19 offset:7872
	ds_load_u8 v156, v19 offset:7744
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v108, v151, v137, 0xc0c0004
	ds_load_u8 v137, v19 offset:6272
	ds_load_u8 v151, v19 offset:6144
	ds_load_u8 v157, v19 offset:6528
	ds_load_u8 v158, v19 offset:6400
	ds_load_u8 v159, v19 offset:7616
	ds_load_u8 v160, v19 offset:7488
	ds_load_u8 v161, v19 offset:7360
	ds_load_u8 v162, v19 offset:7232
	v_wmma_i32_16x16x16_iu8 v[10:17], v[97:100], v[69:72], v[10:17] neg_lo:[1,1,0]
	v_lshl_or_b32 v108, v108, 16, v107
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v61, v101, v61, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v163, v103, v102, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v106, v106, v104, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[101:104], v20
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v138, v152, v138, 0xc0c0004
	v_lshl_or_b32 v107, v163, 16, v61
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v61, v151, v137, 0xc0c0004
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v137, v158, v157, 0xc0c0004
	v_lshl_or_b32 v106, v138, 16, v106
	ds_load_u8 v138, v19 offset:6592
	ds_load_u8 v152, v19 offset:6464
	ds_load_u8 v163, v19 offset:6336
	ds_load_u8 v19, v19 offset:6208
	v_lshl_or_b32 v105, v137, 16, v61
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[10:17], v[105:108], v[101:104], v[10:17] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v12, v12
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_cvt_f32_i32_e32 v11, v11
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v19, v19, v163, 0xc0c0004
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[61:68], v[109:112], v[73:76], v[2:9] neg_lo:[1,1,0]
	v_perm_b32 v73, v136, v135, 0xc0c0004
	v_perm_b32 v74, v134, v133, 0xc0c0004
	v_perm_b32 v75, v142, v141, 0xc0c0004
	v_perm_b32 v76, v140, v139, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[61:68], v[113:116], v[89:92], v[61:68] neg_lo:[1,1,0]
	v_lshl_or_b32 v90, v118, 16, v117
	v_lshl_or_b32 v92, v74, 16, v73
	v_lshl_or_b32 v89, v120, 16, v119
	v_lshl_or_b32 v91, v76, 16, v75
	v_perm_b32 v73, v156, v155, 0xc0c0004
	v_perm_b32 v74, v154, v153, 0xc0c0004
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[117:120], v18 offset:2048
	ds_load_b128 v[121:124], v20 offset:2048
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_perm_b32 v18, v162, v161, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[61:68], v[89:92], v[69:72], v[61:68] neg_lo:[1,1,0]
	v_perm_b32 v20, v160, v159, 0xc0c0004
	v_lshl_or_b32 v128, v74, 16, v73
	v_wmma_i32_16x16x16_iu8 v[69:76], v[81:84], v[77:80], v[2:9] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[109:112], v[77:80], v[2:9] neg_lo:[1,1,0]
	v_perm_b32 v77, v152, v138, 0xc0c0004
	v_lshl_or_b32 v127, v20, 16, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[69:76], v[93:96], v[85:88], v[69:76] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[113:116], v[85:88], v[2:9] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v125, v77, 16, v19
	v_wmma_i32_16x16x16_iu8 v[61:68], v[125:128], v[101:104], v[61:68] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[69:76], v[97:100], v[117:120], v[69:76] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[89:92], v[117:120], v[2:9] neg_lo:[1,1,0]
	...
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[69:76], v[105:108], v[121:124], v[69:76] neg_lo:[1,1,0]
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v37, v13 :: v_dual_add_f32 v44, v44, v11
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v26, v26, v13 :: v_dual_add_f32 v31, v31, v2
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v36, v36, v5 :: v_dual_add_f32 v35, v35, v4
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v25, v25, v14 :: v_dual_add_f32 v30, v30, v12
...
; %bb.11:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v77, s11 :: v_dual_add_nc_u32 v2, s0, v60
	...
	v_dual_mov_b32 v74, s8 :: v_dual_add_nc_u32 v3, s0, v59
	v_dual_mov_b32 v75, s9 :: v_dual_add_nc_u32 v12, s0, v58
	v_dual_mov_b32 v73, s7 :: v_dual_add_nc_u32 v8, s0, v57
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[57:60], v2 offset:2048
	ds_load_b128 v[61:64], v2
	ds_load_b128 v[78:81], v3 offset:2048
	ds_load_b128 v[65:68], v3
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v2, v1 offset:1152
	ds_load_u8 v3, v1 offset:1024
	ds_load_u8 v9, v1 offset:1408
	ds_load_u8 v10, v1 offset:1280
	ds_load_u8 v11, v1 offset:640
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v103, v1 offset:5760
	ds_load_u8 v104, v1 offset:5632
	ds_load_u8 v105, v1 offset:6016
	ds_load_u8 v106, v1 offset:5888
	ds_load_u8 v115, v1 offset:960
	ds_load_u8 v116, v1 offset:832
	ds_load_u8 v117, v1 offset:704
	ds_load_u8 v118, v1 offset:576
	ds_load_u8 v123, v1 offset:3520
	ds_load_u8 v124, v1 offset:3392
	ds_load_u8 v125, v1 offset:3264
	ds_load_u8 v126, v1 offset:3136
	ds_load_u8 v127, v1 offset:3008
	ds_load_u8 v128, v1 offset:2880
	ds_load_u8 v129, v1 offset:2752
	ds_load_u8 v130, v1 offset:2624
	...
	ds_load_u8 v2, v1 offset:448
	ds_load_u8 v3, v1 offset:320
	ds_load_u8 v13, v1 offset:192
	...
	ds_load_u8 v6, v1 offset:3712
	ds_load_u8 v7, v1 offset:3584
	ds_load_u8 v8, v1 offset:3968
	ds_load_u8 v9, v1 offset:3840
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v5, v69, v20, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v17, v114, v112, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_2)
	v_lshl_or_b32 v90, v5, 16, v4
	ds_load_u8 v4, v1 offset:3200
	ds_load_u8 v5, v1 offset:3072
	ds_load_u8 v10, v1 offset:3456
	ds_load_u8 v11, v1 offset:3328
	ds_load_u8 v15, v1 offset:2688
	ds_load_u8 v20, v1 offset:2560
	ds_load_u8 v69, v1 offset:2944
	ds_load_u8 v94, v1 offset:2816
	ds_load_u8 v95, v1 offset:2176
	ds_load_u8 v96, v1 offset:2048
	ds_load_u8 v97, v1 offset:2432
	ds_load_u8 v98, v1 offset:2304
	ds_load_u8 v119, v1 offset:4032
	ds_load_u8 v120, v1 offset:3904
	ds_load_u8 v121, v1 offset:3776
	ds_load_u8 v122, v1 offset:3648
	...
	v_wmma_i32_16x16x16_iu8 v[4:11], v[90:93], v[86:89], v[70:77] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[94:97], v[65:68], v[4:11] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v15, v20, v15, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v20, v99, v98, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v98, v101, v100, 0xc0c0004
	v_lshl_or_b32 v101, v104, 16, v103
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v99, v107, v102, 0xc0c0004
	ds_load_u8 v102, v1 offset:7808
	...
	v_lshl_or_b32 v100, v20, 16, v15
	ds_load_u8 v15, v1 offset:7296
	ds_load_u8 v20, v1 offset:7168
	...
	v_perm_b32 v69, v131, v69, 0xc0c0004
	v_lshl_or_b32 v99, v99, 16, v98
	v_lshl_or_b32 v98, v106, 16, v105
	s_delay_alu instid0(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[4:11], v[98:101], v[61:64], v[4:11] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v157, v107, v102, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[102:105], v12 offset:2048
	ds_load_b128 v[106:109], v12
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v12, v1 offset:6272
	ds_load_u8 v161, v1 offset:6144
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v20, v20, v15, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v151, v152, v151, 0xc0c0004
	ds_load_u8 v15, v1 offset:6528
	...
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v3, v152, v15, 0xc0c0004
	v_perm_b32 v161, v161, v12, 0xc0c0004
	...
	v_lshl_or_b32 v117, v16, 16, v12
	v_lshl_or_b32 v116, v18, 16, v17
	v_perm_b32 v118, v130, v129, 0xc0c0004
	v_lshl_or_b32 v115, v110, 16, v19
	v_perm_b32 v110, v120, v119, 0xc0c0004
	v_perm_b32 v119, v128, v127, 0xc0c0004
	v_perm_b32 v120, v133, v132, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[12:19], v[114:117], v[86:89], v[70:77] neg_lo:[1,1,0]
	v_lshl_or_b32 v89, v110, 16, v2
	v_lshl_or_b32 v88, v112, 16, v111
	v_lshl_or_b32 v87, v119, 16, v118
	v_lshl_or_b32 v86, v69, 16, v120
	...
	v_wmma_i32_16x16x16_iu8 v[12:19], v[86:89], v[65:68], v[12:19] neg_lo:[1,1,0]
	v_lshl_or_b32 v121, v69, 16, v2
	v_lshl_or_b32 v120, v111, 16, v110
	v_perm_b32 v2, v156, v155, 0xc0c0004
	v_lshl_or_b32 v119, v118, 16, v112
	v_lshl_or_b32 v118, v123, 16, v122
	v_perm_b32 v65, v154, v153, 0xc0c0004
	v_lshl_or_b32 v112, v151, 16, v20
	v_lshl_or_b32 v110, v3, 16, v161
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v3, v162, v157, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[12:19], v[118:121], v[61:64], v[12:19] neg_lo:[1,1,0]
	v_lshl_or_b32 v125, v65, 16, v2
	v_wmma_i32_16x16x16_iu8 v[62:69], v[90:93], v[82:85], v[70:77] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[70:77], v[114:117], v[82:85], v[70:77] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v2, v164, v163, 0xc0c0004
	...
	v_lshl_or_b32 v124, v3, 16, v2
	v_lshl_or_b32 v123, v61, 16, v20
	v_lshl_or_b32 v122, v82, 16, v1
	v_wmma_i32_16x16x16_iu8 v[62:69], v[98:101], v[57:60], v[62:69] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[70:77], v[118:121], v[57:60], v[70:77] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[4:11], v[110:113], v[106:109], v[4:11] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[12:19], v[122:125], v[106:109], v[12:19] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[62:69], v[110:113], v[102:105], v[62:69] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.LBB0_12:
	...
	v_or_b32_e32 v54, s26, v3
	.loc	1 405 22                        ; generate_amdgcn.py:405:22
	v_or3_b32 v1, v1, v55, s24
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_mov_b32 s4, s12
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v8, v49, v8 :: v_dual_and_b32 v53, 56, v53
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_or_b32_e32 v55, s26, v2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v5, v52, v5 :: v_dual_lshlrev_b32 v54, 1, v54
	v_dual_add_f32 v4, v42, v4 :: v_dual_lshlrev_b32 v1, 1, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_add_f32 v6, v51, v6 :: v_dual_lshlrev_b32 v55, 1, v55
	v_dual_add_f32 v13, v44, v13 :: v_dual_add_f32 v18, v38, v18
	.loc	1 404 14                        ; generate_amdgcn.py:404:14
	s_clause 0x1
	buffer_load_u16 v54, v54, s[4:7], 0 offen
	buffer_load_u16 v55, v55, s[4:7], 0 offen
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_or_b32_e32 v56, 4, v1
	v_or_b32_e32 v57, 8, v1
	v_or_b32_e32 v58, 12, v1
	s_and_b32 s5, s15, 0xffff
	s_mov_b32 s4, s14
	v_or_b32_e32 v59, 16, v1
	v_or_b32_e32 v60, 20, v1
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v19, v37, v19 :: v_dual_add_f32 v68, v31, v68
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_mul_i32 s0, s26, s25
	v_mul_lo_u32 v3, s25, v3
	s_add_i32 s0, s0, s24
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v50, v7 :: v_dual_add_f32 v10, v47, v10
	v_dual_add_f32 v9, v48, v9 :: v_dual_add_f32 v12, v45, v12
	v_dual_add_f32 v11, v46, v11 :: v_dual_add_f32 v14, v43, v14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v18, v38, v18, s2
	v_cndmask_b32_e64 v19, v37, v19, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_or_b32_e32 v37, s0, v53
	v_add3_u32 v38, s0, v53, 64
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v65, v34, v65 :: v_dual_add_f32 v62, v25, v62
	v_dual_add_f32 v67, v30, v67 :: v_dual_add_f32 v72, v35, v72
	...
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_add_lshl_u32 v46, v37, v3, 1
	v_add_lshl_u32 v47, v38, v3, 1
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v63, v26, v63 :: v_dual_add_f32 v66, v29, v66
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v17, v39, v17 :: v_dual_add_f32 v20, v21, v20
	v_dual_add_f32 v61, v22, v61 :: v_dual_add_f32 v64, v33, v64
	v_dual_add_f32 v69, v32, v69 :: v_dual_add_f32 v70, v23, v70
	v_dual_add_f32 v71, v24, v71 :: v_dual_and_b32 v0, 16, v0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v29, v29, v66, s2
	v_cndmask_b32_e64 v31, v31, v68, s2
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v73, v36, v73 :: v_dual_add_f32 v74, v27, v74
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v13, v44, v13, s2
	v_cndmask_b32_e64 v22, v22, v61, s2
	v_cndmask_b32_e64 v20, v21, v20, s2
	v_cndmask_b32_e64 v33, v33, v64, s2
	v_cndmask_b32_e64 v32, v32, v69, s2
	v_cndmask_b32_e64 v35, v35, v72, s2
	v_cndmask_b32_e64 v24, v24, v71, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_mul_lo_u32 v44, s25, v2
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v2, v23, v70, s2
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v15, v41, v15 :: v_dual_add_f32 v16, v40, v16
	v_dual_add_f32 v75, v28, v75 :: v_dual_mov_b32 v88, 0x7632
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	s_waitcnt vmcnt(9)
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mul_f32 v67, v52, v3 :: v_dual_lshlrev_b32 v56, 16, v76
	v_dual_mul_f32 v52, v48, v52 :: v_dual_mul_f32 v65, v50, v3
	v_mul_f32_e32 v50, v48, v50
	v_dual_mul_f32 v66, v49, v3 :: v_dual_lshlrev_b32 v51, 16, v58
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v53, 16, v60
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v49, v48, v49
	v_mul_f32_e32 v71, v56, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v68, v51, v3
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v54, 16, v59
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v70, v53, v3 :: v_dual_lshlrev_b32 v55, 16, v77
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(5)
	...
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v57, 16, v80
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v69, v54, v3 :: v_dual_lshlrev_b32 v64, 16, v85
	v_mul_f32_e32 v54, v48, v54
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v58, 16, v79
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v74, v57, v3 :: v_dual_lshlrev_b32 v61, 16, v84
	v_dual_mul_f32 v72, v55, v3 :: v_dual_mul_f32 v57, v48, v57
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v73, v58, v3 :: v_dual_mul_f32 v58, v48, v58
	v_dual_mul_f32 v78, v61, v3 :: v_dual_mul_f32 v7, v7, v68
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v20, v20, v50 :: v_dual_mul_f32 v11, v11, v72
	v_mul_f32_e32 v22, v22, v49
	v_dual_mul_f32 v6, v6, v67 :: v_dual_mul_f32 v25, v25, v54
	v_dual_mul_f32 v10, v10, v71 :: v_dual_mul_f32 v31, v31, v58
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v51, v48, v51 :: v_dual_lshlrev_b32 v60, 16, v81
	v_dual_mul_f32 v61, v48, v61 :: v_dual_lshlrev_b32 v62, 16, v83
	v_dual_mul_f32 v56, v48, v56 :: v_dual_lshlrev_b32 v63, 16, v86
	v_dual_mul_f32 v55, v48, v55 :: v_dual_mul_f32 v26, v26, v53
	...
	v_dual_mul_f32 v77, v62, v3 :: v_dual_mul_f32 v62, v48, v62
	v_mul_f32_e32 v75, v60, v3
	v_mul_f32_e32 v60, v48, v60
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v4, v4, v65 :: v_dual_mul_f32 v33, v33, v52
	.loc	1 416 9 is_stmt 1               ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v48, v48, v64 :: v_dual_mul_f32 v9, v9, v70
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v34, v34, v51 :: v_dual_mul_f32 v29, v29, v56
	v_dual_mul_f32 v8, v8, v69 :: v_dual_mul_f32 v13, v13, v74
	v_dual_mul_f32 v12, v12, v73 :: v_dual_mul_f32 v35, v35, v60
	v_dual_mul_f32 v32, v32, v57 :: v_dual_mul_f32 v17, v17, v78
	v_dual_mul_f32 v16, v16, v77 :: v_dual_mul_f32 v3, v19, v3
	v_mul_f32_e32 v2, v2, v62
	v_dual_mul_f32 v14, v14, v75 :: v_dual_mul_f32 v19, v27, v48
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v30, v30, v55 :: v_dual_mul_f32 v15, v15, v76
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v36, v36, v59 :: v_dual_and_b32 v21, 1, v21
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_bfe_u32 v59, v16, 16, 1
	v_and_b32_e32 v40, 1, v40
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v18, v18, v79 :: v_dual_and_b32 v41, 1, v41
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_cndmask_b16 v16.h, 0x7fff, v17.h, s24
	...
	v_cmp_o_f32_e64 s30, v19, v19
	v_add3_u32 v21, v33, v39, 0x7fff
	v_add3_u32 v2, v2, v23, 0x7fff
	v_add3_u32 v17, v19, v45, 0x7fff
	v_cndmask_b16 v0.h, 0x7fff, v20.h, s1
	v_dual_cndmask_b32 v16, v3, v14 :: v_dual_cndmask_b32 v3, v14, v3
	v_dual_cndmask_b32 v19, 0x3276, v88 :: v_dual_and_b32 v20, 1, v1
	v_add3_u32 v7, v26, v7, 0x7fff
	v_mov_b16_e32 v1.l, v32.h
	v_cndmask_b32_e32 v14, 0x1054, v87, vcc_lo
	v_add3_u32 v15, v35, v43, 0x7fff
	v_cmp_o_f32_e64 s10, v25, v25
	v_cmp_o_f32_e64 s13, v30, v30
	v_add3_u32 v9, v25, v40, 0x7fff
	v_cndmask_b16 v2.l, 0x7fff, v21.h, s6
	v_cndmask_b16 v15.l, 0x7fff, v2.h, s26
	v_cndmask_b16 v2.h, 0x7fff, v5.h, s5
	v_permlanex16_b32 v21, v3, s31, 0xfedcba98 op_sel:[1,0]
	v_lshl_or_b32 v3, v14, 8, v14
	v_lshl_or_b32 v14, v19, 8, v19
	v_cndmask_b16 v5.h, 0x7fff, v7.h, s9
	v_add3_u32 v7, v30, v20, 0x7fff
	v_and_b32_e32 v19, 1, v1
	v_cmp_o_f32_e64 s14, v29, v29
	v_cmp_o_f32_e64 s17, v32, v32
	v_cmp_o_f32_e64 s18, v31, v31
	v_add3_u32 v11, v29, v41, 0x7fff
	v_add3_u32 v13, v31, v42, 0x7fff
	v_cndmask_b16 v5.l, 0x7fff, v9.h, s10
	v_mov_b16_e32 v1.l, v36.h
	v_cndmask_b16 v9.h, 0x7fff, v7.h, s13
	v_add3_u32 v7, v32, v19, 0x7fff
	v_cndmask_b16 v9.l, 0x7fff, v11.h, s14
	v_cndmask_b16 v11.l, 0x7fff, v13.h, s18
	v_dual_cndmask_b32 v20, v5, v0 :: v_dual_and_b32 v3, 0x540054, v3
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b16 v11.h, 0x7fff, v7.h, s17
	...
	v_perm_b32 v0, v4, v18, v22
	v_perm_b32 v1, v4, v18, v23
	v_perm_b32 v4, v12, v10, v22
	v_perm_b32 v5, v12, v10, v23
	v_cndmask_b32_e32 v10, v11, v15, vcc_lo
	v_cndmask_b32_e32 v12, v13, v17, vcc_lo
	v_permlanex16_b32 v14, v2, s31, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v3, v6, v8, v23
	v_perm_b32 v7, v21, v16, v23
	v_cndmask_b32_e32 v15, v15, v11, vcc_lo
	v_cndmask_b32_e32 v17, v17, v13, vcc_lo
	v_perm_b32 v2, v6, v8, v22
	v_perm_b32 v6, v21, v16, v22
	v_permlanex16_b32 v16, v10, s31, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v18, v12, s31, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v8, v9, v20, v22
	v_perm_b32 v9, v9, v20, v23
	v_perm_b32 v10, v14, v19, v22
	v_perm_b32 v11, v14, v19, v23
	v_perm_b32 v12, v16, v15, v22
	v_perm_b32 v13, v16, v15, v23
	v_perm_b32 v14, v18, v17, v22
	v_perm_b32 v15, v18, v17, v23
	v_add_lshl_u32 v16, v38, v44, 1
	s_clause 0x3
	buffer_store_b128 v[0:3], v46, s[36:39], 0 offen
	buffer_store_b128 v[4:7], v47, s[36:39], 0 offen
	buffer_store_b128 v[8:11], v37, s[36:39], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 228
