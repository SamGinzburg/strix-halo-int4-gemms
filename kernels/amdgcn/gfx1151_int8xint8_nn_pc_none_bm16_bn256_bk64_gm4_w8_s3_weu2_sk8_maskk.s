	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v1, s4, v31
	v_add_nc_u32_e32 v2, s4, v32
	v_add_nc_u32_e32 v24, s29, v11
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_dual_cndmask_b32 v11, 0x80000000, v11 :: v_dual_cndmask_b32 v34, 0x80000000, v24
	...
	s_waitcnt vmcnt(8)
	v_perm_b32 v71, v12, v3, 0x4000501
	...
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(7)
	ds_store_b32 v56, v7 offset:32768
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v5, v14, v5, 0x6020703
	s_waitcnt vmcnt(5)
	v_perm_b32 v7, v20, v16, 0x4000501
	...
	v_perm_b32 v20, v22, v18, 0x4000501
	v_perm_b32 v18, v22, v18, 0x6020703
	v_perm_b32 v21, v23, v19, 0x4000501
	v_perm_b32 v19, v23, v19, 0x6020703
	v_perm_b32 v22, v71, v7, 0x7060302
	v_perm_b32 v7, v71, v7, 0x5040100
	v_perm_b32 v23, v3, v15, 0x7060302
	v_perm_b32 v3, v3, v15, 0x5040100
	v_perm_b32 v15, v12, v16, 0x7060302
	v_perm_b32 v12, v12, v16, 0x5040100
	v_perm_b32 v16, v4, v17, 0x7060302
	v_perm_b32 v4, v4, v17, 0x5040100
	v_perm_b32 v17, v13, v20, 0x7060302
	v_perm_b32 v13, v13, v20, 0x5040100
	v_perm_b32 v20, v5, v18, 0x7060302
	v_perm_b32 v5, v5, v18, 0x5040100
	v_perm_b32 v18, v14, v21, 0x7060302
	v_perm_b32 v14, v14, v21, 0x5040100
	v_perm_b32 v21, v6, v19, 0x7060302
	v_perm_b32 v6, v6, v19, 0x5040100
	ds_store_2addr_b32 v57, v22, v7 offset1:16
	ds_store_2addr_b32 v58, v23, v3 offset1:16
	ds_store_2addr_b32 v59, v15, v12 offset1:16
	ds_store_2addr_b32 v60, v16, v4 offset1:16
	ds_store_2addr_b32 v61, v17, v13 offset1:16
	ds_store_2addr_b32 v57, v20, v5 offset0:160 offset1:176
	ds_store_2addr_b32 v62, v18, v14 offset1:16
	ds_store_2addr_b32 v63, v21, v6 offset1:16
	s_waitcnt vmcnt(2)
	v_perm_b32 v3, v34, v24, 0x4000501
	s_waitcnt vmcnt(0)
	v_perm_b32 v4, v52, v48, 0x4000501
	v_perm_b32 v5, v34, v24, 0x6020703
	v_perm_b32 v6, v52, v48, 0x6020703
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b32 v56, v8 offset:33792
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_perm_b32 v7, v35, v25, 0x4000501
	v_perm_b32 v8, v53, v49, 0x4000501
	v_perm_b32 v12, v35, v25, 0x6020703
	v_perm_b32 v13, v53, v49, 0x6020703
	v_perm_b32 v14, v36, v26, 0x4000501
	v_perm_b32 v15, v54, v50, 0x4000501
	v_perm_b32 v16, v36, v26, 0x6020703
	v_perm_b32 v17, v54, v50, 0x6020703
	v_perm_b32 v18, v37, v27, 0x4000501
	v_perm_b32 v19, v55, v51, 0x4000501
	v_perm_b32 v20, v37, v27, 0x6020703
	v_perm_b32 v21, v55, v51, 0x6020703
	v_perm_b32 v22, v4, v3, 0x7060302
	...
	v_perm_b32 v8, v13, v12, 0x7060302
	...
	ds_store_2addr_b32 v64, v22, v3 offset1:16
	ds_store_2addr_b32 v65, v4, v5 offset1:16
	ds_store_2addr_b32 v66, v6, v7 offset1:16
	ds_store_2addr_b32 v67, v8, v12 offset1:16
	ds_store_2addr_b32 v68, v13, v14 offset1:16
	ds_store_2addr_b32 v64, v15, v16 offset0:160 offset1:176
...
.Ltmp15:
	...
	v_or3_b32 v2, v2, v3, v49
	v_dual_mov_b32 v25, 0 :: v_dual_mov_b32 v24, 0
	v_dual_mov_b32 v21, 0 :: v_dual_mov_b32 v22, 0
	v_mov_b32_e32 v19, 0
	v_xor_b32_e32 v51, v2, v1
	v_mov_b32_e32 v1, s4
	v_lshl_or_b32 v34, v10, 6, v48
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s6, s0, s6
	v_or_b32_e32 v55, s6, v28
	v_or_b32_e32 v56, s6, v29
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v60, s7, v31
	v_add_nc_u32_e32 v61, s7, v32
	s_mov_b32 s1, s4
	s_mov_b32 s4, s3
	...
	v_add_nc_u32_e32 v61, s1, v53
	v_add_nc_u32_e32 v62, s1, v54
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v137, s3, v45
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[63:70], v[119:122], v[95:98], v[63:70] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v138, s3, v46
	v_add_nc_u32_e32 v139, s3, v47
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	v_dual_add_f32 v12, v12, v55 :: v_dual_add_f32 v27, v27, v56
	v_dual_add_f32 v26, v26, v57 :: v_dual_add_f32 v25, v25, v58
	v_dual_add_f32 v24, v24, v59 :: v_dual_add_f32 v23, v23, v60
	v_dual_add_f32 v22, v22, v61 :: v_dual_add_f32 v21, v21, v62
	v_dual_add_f32 v20, v20, v63 :: v_dual_add_f32 v19, v19, v64
	v_dual_add_f32 v13, v13, v70 :: v_dual_add_nc_u32 v132, s7, v40
	v_dual_add_f32 v15, v15, v68 :: v_dual_add_nc_u32 v134, s3, v42
	v_dual_add_f32 v18, v18, v65 :: v_dual_add_f32 v17, v17, v66
...
; %bb.8:
	...
	v_add_nc_u32_e32 v39, s33, v34
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v32, s4, v5
	v_add_nc_u32_e32 v33, s4, v4
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[58:61], v38
	ds_load_b128 v[62:65], v39
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[66:69], v32 offset:8192
	ds_load_b128 v[70:73], v32
	ds_load_b128 v[74:77], v33 offset:8192
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v39, s9 :: v_dual_add_nc_u32 v8, s33, v36
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v32, s33, v35
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v44, s14 :: v_dual_add_nc_u32 v7, s4, v6
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[82:85], v8
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_mov_b32_e32 v43, s13
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[86:89], v32
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v42, s12 :: v_dual_mov_b32 v41, s11
	v_mov_b32_e32 v40, s10
	v_mov_b32_e32 v38, s8
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[90:93], v7
	ds_load_b128 v[94:97], v7 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[54:57], v[62:65], v[38:45] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[78:81], v[58:61], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[70:73], v[82:85], v[46:53] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[90:93], v[86:89], v[46:53] neg_lo:[1,1,0]
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[38:45], v[28:31], v[62:65], v[38:45] neg_lo:[1,1,0]
	...
	v_dual_add_f32 v25, v25, v28 :: v_dual_add_f32 v24, v24, v29
	...
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[94:97], v[86:89], v[38:45] neg_lo:[1,1,0]
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_add_f32 v20, v20, v33 :: v_dual_add_f32 v19, v19, v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_add_f32 v14, v14, v28 :: v_dual_add_f32 v13, v13, v29
...
; %bb.10:
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v45, s11 :: v_dual_add_nc_u32 v8, s3, v6
	v_dual_mov_b32 v43, s9 :: v_dual_add_nc_u32 v28, s3, v4
	v_mov_b32_e32 v44, s10
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[3:6], v7 offset:8192
	ds_load_b128 v[46:49], v7
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v40, s6 :: v_dual_add_nc_u32 v7, s1, v37
	v_dual_mov_b32 v41, s7 :: v_dual_add_nc_u32 v30, s1, v34
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v38, s4 :: v_dual_add_nc_u32 v29, s1, v36
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v7, s1, v35
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
...
.LBB0_11:
	...
	v_dual_add_f32 v28, v22, v32 :: v_dual_add_f32 v31, v19, v39
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	buffer_load_u16 v34, v3, s[4:7], 0 offen
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v4, v12, v7 :: v_dual_add_f32 v7, v25, v29
	v_dual_add_f32 v29, v21, v33 :: v_dual_add_f32 v30, v20, v38
	v_add_f32_e32 v37, v14, v44
	v_dual_add_f32 v33, v17, v41 :: v_dual_add_f32 v36, v15, v43
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v32, v18, v40 :: v_dual_add_f32 v35, v16, v42
	...
	v_cndmask_b32_e64 v29, v18, v32, s2
	...
	v_cndmask_b32_e64 v30, v17, v33, s2
	v_cndmask_b32_e64 v31, v16, v35, s2
	v_cndmask_b32_e64 v32, v15, v36, s2
	v_cndmask_b32_e64 v33, v14, v37, s2
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v15, v15, v34 :: v_dual_mul_f32 v16, v33, v16
	v_dual_mul_f32 v10, v10, v34 :: v_dual_mul_f32 v17, v35, v17
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v11, v11, v34 :: v_dual_mul_f32 v12, v29, v12
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v13, v30, v13
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v9, v9, v34 :: v_dual_mul_f32 v8, v22, v8
	v_mul_f32_e32 v4, v4, v34
	v_dual_mul_f32 v6, v6, v34 :: v_dual_mul_f32 v11, v28, v11
	v_dual_mul_f32 v14, v14, v34 :: v_dual_mul_f32 v15, v32, v15
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v10, v20, v10 :: v_dual_mul_f32 v9, v21, v9
	v_dual_mul_f32 v4, v26, v4 :: v_dual_lshlrev_b32 v51, 2, v18
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 140
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
