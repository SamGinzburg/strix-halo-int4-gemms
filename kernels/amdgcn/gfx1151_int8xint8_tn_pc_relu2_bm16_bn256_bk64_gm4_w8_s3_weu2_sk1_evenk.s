	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_lshl_add_u32 v30, s25, 4, v9
	v_lshl_add_u32 v31, s25, 5, v9
...
.Ltmp13:
	...
	buffer_load_b32 v32, v1, s[16:19], 0 offen
	v_cndmask_b32_e64 v1, 0x80000000, v6, s2
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_cndmask_b32_e64 v6, 0x80000000, v25, s2
	s_clause 0x3
	...
	v_cndmask_b32_e64 v33, 0x80000000, v28, s2
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v47, v1, s[16:19], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[25:28], v6, s[20:23], 0 offen
	buffer_load_b128 v[35:38], v7, s[20:23], 0 offen
	buffer_load_b128 v[39:42], v8, s[20:23], 0 offen
	buffer_load_b128 v[43:46], v33, s[20:23], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	s_waitcnt vmcnt(9)
	ds_store_b32 v6, v32 offset:32768
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(8)
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v6, v47 offset:33792
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v7, v[25:28] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v7, v[35:38] offset:20480
	s_waitcnt vmcnt(1)
	ds_store_b128 v7, v[39:42] offset:24576
	s_waitcnt vmcnt(0)
	ds_store_b128 v7, v[43:46] offset:28672
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	s_mov_b32 s11, s4
	v_and_b32_e32 v32, 0x70, v1
	v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v24, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s8, s31, s8
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v37, s6, v12
	v_add_nc_u32_e32 v38, s6, v33
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_mul_i32 s6, s8, s25
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[35:36], null, s8, s24, v[11:12]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s6, s6, s26
	s_mov_b32 s7, s4
	v_add_nc_u32_e32 v36, s6, v9
	v_add_nc_u32_e32 v40, s6, v30
	v_add_nc_u32_e32 v41, s6, v31
	v_add_nc_u32_e32 v42, s6, v10
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v111, v35, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[51:54], v36, s[20:23], 0 offen
	buffer_load_b128 v[55:58], v40, s[20:23], 0 offen
	buffer_load_b128 v[59:62], v41, s[20:23], 0 offen
	buffer_load_b128 v[63:66], v42, s[20:23], 0 offen
	v_add3_u32 v39, s7, v32, v12
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	ds_load_u8 v35, v37 offset:208
	ds_load_u8 v43, v37 offset:240
	ds_load_u8 v44, v37 offset:224
	ds_load_u8 v45, v37 offset:192
	ds_load_u8 v46, v37 offset:144
	ds_load_u8 v47, v37 offset:176
	ds_load_u8 v48, v37 offset:160
	ds_load_u8 v49, v37 offset:128
	ds_load_u8 v50, v37 offset:80
	ds_load_u8 v67, v37 offset:112
	ds_load_u8 v68, v37 offset:96
	ds_load_u8 v69, v37 offset:64
	ds_load_u8 v70, v37
	ds_load_u8 v71, v37 offset:16
	ds_load_u8 v72, v37 offset:32
	ds_load_u8 v73, v37 offset:48
	ds_load_u8 v74, v39 offset:1280
	ds_load_u8 v75, v39 offset:1024
	ds_load_u8 v76, v39 offset:1792
	ds_load_u8 v77, v37 offset:464
	ds_load_u8 v78, v37 offset:496
	ds_load_u8 v79, v37 offset:480
	ds_load_u8 v80, v37 offset:448
	ds_load_u8 v81, v37 offset:400
	ds_load_u8 v82, v37 offset:432
	ds_load_u8 v83, v37 offset:416
	ds_load_u8 v84, v37 offset:384
	ds_load_u8 v85, v37 offset:336
	ds_load_u8 v86, v37 offset:368
	ds_load_u8 v87, v37 offset:352
	ds_load_u8 v88, v37 offset:320
	ds_load_u8 v89, v37 offset:272
	ds_load_u8 v90, v37 offset:304
	ds_load_u8 v91, v37 offset:288
	ds_load_u8 v92, v37 offset:256
	ds_load_u8 v93, v37 offset:720
	ds_load_u8 v94, v37 offset:752
	ds_load_u8 v95, v37 offset:736
	ds_load_u8 v96, v37 offset:704
	ds_load_u8 v97, v37 offset:656
	ds_load_u8 v98, v37 offset:688
	ds_load_u8 v99, v37 offset:672
	ds_load_u8 v100, v37 offset:640
	ds_load_u8 v101, v37 offset:592
	ds_load_u8 v102, v37 offset:624
	ds_load_u8 v103, v37 offset:608
	ds_load_u8 v104, v37 offset:576
	ds_load_u8 v105, v37 offset:528
	ds_load_u8 v106, v37 offset:560
	ds_load_u8 v107, v37 offset:544
	ds_load_u8 v108, v37 offset:512
	ds_load_u8 v109, v37 offset:976
	ds_load_u8 v38, v38
	ds_load_u8 v110, v37 offset:992
	ds_load_u8 v112, v37 offset:960
	ds_load_u8 v113, v37 offset:912
	ds_load_u8 v114, v37 offset:944
	ds_load_u8 v115, v37 offset:928
	ds_load_u8 v116, v37 offset:896
	ds_load_u8 v117, v37 offset:848
	ds_load_u8 v118, v37 offset:880
	ds_load_u8 v119, v37 offset:864
	...
	ds_load_u8 v124, v39 offset:3328
	ds_load_u8 v125, v39 offset:3072
	ds_load_u8 v126, v39 offset:3840
	ds_load_u8 v127, v39 offset:3584
	ds_load_u8 v128, v39 offset:3968
	ds_load_u8 v129, v39 offset:3712
	ds_load_u8 v130, v39 offset:3456
	ds_load_u8 v131, v39 offset:3200
	ds_load_u8 v132, v39 offset:2304
	ds_load_u8 v133, v39 offset:2048
	ds_load_u8 v134, v39 offset:2816
	ds_load_u8 v135, v39 offset:2560
	ds_load_u8 v136, v39 offset:2944
	ds_load_u8 v137, v39 offset:2688
	ds_load_u8 v138, v39 offset:2432
	ds_load_u8 v139, v39 offset:2176
	ds_load_u8 v36, v39 offset:1536
	ds_load_u8 v40, v39 offset:1920
	ds_load_u8 v41, v39 offset:1664
	ds_load_u8 v42, v39 offset:1408
	ds_load_u8 v140, v39 offset:1152
	ds_load_u8 v141, v39 offset:256
	ds_load_u8 v142, v39
	ds_load_u8 v143, v39 offset:768
	ds_load_u8 v144, v39 offset:512
	ds_load_u8 v145, v39 offset:896
	ds_load_u8 v146, v39 offset:640
	ds_load_u8 v147, v39 offset:384
	ds_load_u8 v148, v39 offset:128
	ds_load_u8 v149, v39 offset:7424
	ds_load_u8 v150, v39 offset:7168
	ds_load_u8 v151, v39 offset:7936
	ds_load_u8 v152, v39 offset:7680
	ds_load_u8 v153, v39 offset:8064
	ds_load_u8 v154, v39 offset:7808
	ds_load_u8 v155, v39 offset:7552
	ds_load_u8 v156, v39 offset:7296
	ds_load_u8 v157, v39 offset:6400
	ds_load_u8 v158, v39 offset:6144
	ds_load_u8 v159, v39 offset:6912
	ds_load_u8 v160, v39 offset:6656
	ds_load_u8 v161, v39 offset:7040
	ds_load_u8 v162, v39 offset:6784
	ds_load_u8 v163, v39 offset:6528
	ds_load_u8 v164, v39 offset:6272
	ds_load_u8 v165, v39 offset:5376
	ds_load_u8 v166, v39 offset:5120
	ds_load_u8 v167, v39 offset:5888
	ds_load_u8 v168, v39 offset:5632
	ds_load_u8 v169, v39 offset:6016
	ds_load_u8 v170, v39 offset:5760
	ds_load_u8 v171, v39 offset:5504
	ds_load_u8 v172, v39 offset:5248
	ds_load_u8 v173, v39 offset:4352
	ds_load_u8 v174, v39 offset:4096
	ds_load_u8 v175, v39 offset:4864
	ds_load_u8 v176, v39 offset:4608
	ds_load_u8 v177, v39 offset:4992
	ds_load_u8 v178, v39 offset:4736
	ds_load_u8 v179, v39 offset:4480
	ds_load_u8 v180, v39 offset:4224
	ds_load_u8 v181, v39 offset:11520
	ds_load_u8 v182, v39 offset:11264
	ds_load_u8 v183, v39 offset:12032
	ds_load_u8 v184, v39 offset:11776
	ds_load_u8 v185, v39 offset:12160
	ds_load_u8 v186, v39 offset:11904
	ds_load_u8 v187, v39 offset:11648
	ds_load_u8 v188, v39 offset:11392
	ds_load_u8 v189, v39 offset:10496
	ds_load_u8 v190, v39 offset:10240
	ds_load_u8 v191, v39 offset:11008
	ds_load_u8 v192, v39 offset:10752
	ds_load_u8 v193, v39 offset:11136
	ds_load_u8 v194, v39 offset:10880
	ds_load_u8 v195, v39 offset:10624
	ds_load_u8 v196, v39 offset:10368
	ds_load_u8 v197, v39 offset:9472
	ds_load_u8 v198, v39 offset:9216
	ds_load_u8 v199, v39 offset:9984
	ds_load_u8 v200, v39 offset:9728
	ds_load_u8 v201, v39 offset:10112
	ds_load_u8 v202, v39 offset:9856
	ds_load_u8 v203, v39 offset:9600
	ds_load_u8 v204, v39 offset:9344
	ds_load_u8 v205, v39 offset:8448
	ds_load_u8 v206, v39 offset:8192
	ds_load_u8 v207, v39 offset:8960
	ds_load_u8 v208, v39 offset:8704
	ds_load_u8 v209, v39 offset:9088
	ds_load_u8 v210, v39 offset:8832
	ds_load_u8 v211, v39 offset:8576
	ds_load_u8 v212, v39 offset:8320
	ds_load_u8 v213, v39 offset:15616
	ds_load_u8 v214, v39 offset:15360
	ds_load_u8 v215, v39 offset:16128
	ds_load_u8 v216, v39 offset:15872
	ds_load_u8 v217, v39 offset:16256
	ds_load_u8 v218, v39 offset:16000
	ds_load_u8 v219, v39 offset:15744
	ds_load_u8 v220, v39 offset:15488
	ds_load_u8 v221, v39 offset:14592
	ds_load_u8 v222, v39 offset:14336
	ds_load_u8 v223, v39 offset:15104
	ds_load_u8 v224, v39 offset:14848
	ds_load_u8 v225, v39 offset:15232
	ds_load_u8 v226, v39 offset:14976
	ds_load_u8 v227, v39 offset:14720
	ds_load_u8 v228, v39 offset:14464
	ds_load_u8 v229, v39 offset:13568
	ds_load_u8 v230, v39 offset:13312
	ds_load_u8 v231, v39 offset:14080
	ds_load_u8 v232, v39 offset:13824
	ds_load_u8 v233, v39 offset:14208
	ds_load_u8 v234, v39 offset:13952
	ds_load_u8 v235, v39 offset:13696
	ds_load_u8 v236, v39 offset:13440
	ds_load_u8 v237, v39 offset:12544
	ds_load_u8 v238, v39 offset:12288
	ds_load_u8 v239, v39 offset:13056
	ds_load_u8 v240, v39 offset:12800
	ds_load_u8 v241, v39 offset:13184
	ds_load_u8 v242, v39 offset:12928
	ds_load_u8 v243, v39 offset:12672
	ds_load_u8 v39, v39 offset:12416
	s_waitcnt lgkmcnt(62)
	v_perm_b32 v35, v45, v35, 0xc0c0004
	v_perm_b32 v43, v44, v43, 0xc0c0004
	v_perm_b32 v44, v49, v46, 0xc0c0004
	v_perm_b32 v45, v48, v47, 0xc0c0004
	v_perm_b32 v46, v69, v50, 0xc0c0004
	v_perm_b32 v47, v68, v67, 0xc0c0004
	v_perm_b32 v48, v70, v71, 0xc0c0004
	v_perm_b32 v49, v72, v73, 0xc0c0004
	v_perm_b32 v50, v125, v124, 0xc0c0004
	v_perm_b32 v71, v127, v126, 0xc0c0004
	v_perm_b32 v72, v133, v132, 0xc0c0004
	...
	v_perm_b32 v42, v140, v42, 0xc0c0004
	v_perm_b32 v40, v41, v40, 0xc0c0004
	v_perm_b32 v41, v148, v147, 0xc0c0004
	...
	v_perm_b32 v86, v152, v151, 0xc0c0004
	v_perm_b32 v87, v158, v157, 0xc0c0004
	v_perm_b32 v88, v160, v159, 0xc0c0004
	v_perm_b32 v89, v166, v165, 0xc0c0004
	v_perm_b32 v90, v168, v167, 0xc0c0004
	v_perm_b32 v91, v174, v173, 0xc0c0004
	v_perm_b32 v92, v176, v175, 0xc0c0004
	v_perm_b32 v99, v108, v105, 0xc0c0004
	v_perm_b32 v100, v107, v106, 0xc0c0004
	v_perm_b32 v101, v182, v181, 0xc0c0004
	s_waitcnt lgkmcnt(60)
	v_perm_b32 v102, v184, v183, 0xc0c0004
	s_waitcnt lgkmcnt(38)
	v_perm_b32 v107, v206, v205, 0xc0c0004
	s_waitcnt lgkmcnt(36)
	v_perm_b32 v108, v208, v207, 0xc0c0004
	v_perm_b32 v109, v112, v109, 0xc0c0004
	v_perm_b32 v38, v110, v38, 0xc0c0004
	v_perm_b32 v112, v115, v114, 0xc0c0004
	v_perm_b32 v37, v37, v121, 0xc0c0004
	v_perm_b32 v115, v123, v122, 0xc0c0004
	v_perm_b32 v129, v156, v155, 0xc0c0004
	...
	v_perm_b32 v135, v180, v179, 0xc0c0004
	v_perm_b32 v136, v178, v177, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v39, v39, v243, 0xc0c0004
	v_perm_b32 v151, v242, v241, 0xc0c0004
	v_lshl_or_b32 v70, v43, 16, v35
	v_lshl_or_b32 v69, v45, 16, v44
	v_lshl_or_b32 v68, v47, 16, v46
	v_lshl_or_b32 v67, v49, 16, v48
	v_lshl_or_b32 v46, v71, 16, v50
	v_lshl_or_b32 v45, v73, 16, v72
	v_lshl_or_b32 v44, v36, 16, v74
	v_lshl_or_b32 v43, v76, 16, v75
	v_lshl_or_b32 v73, v80, 16, v79
	v_lshl_or_b32 v72, v82, 16, v81
	v_lshl_or_b32 v81, v96, 16, v95
	v_lshl_or_b32 v80, v98, 16, v97
	v_lshl_or_b32 v98, v125, 16, v124
	v_lshl_or_b32 v97, v127, 16, v126
	v_lshl_or_b32 v96, v40, 16, v42
	v_lshl_or_b32 v95, v128, 16, v41
	v_perm_b32 v103, v190, v189, 0xc0c0004
	v_perm_b32 v104, v192, v191, 0xc0c0004
	v_perm_b32 v105, v198, v197, 0xc0c0004
	v_perm_b32 v106, v200, v199, 0xc0c0004
	...
	v_perm_b32 v143, v212, v211, 0xc0c0004
	...
	v_lshl_or_b32 v83, v108, 16, v107
	v_lshl_or_b32 v90, v38, 16, v109
	v_lshl_or_b32 v87, v115, 16, v37
	v_lshl_or_b32 v102, v130, 16, v129
	v_lshl_or_b32 v101, v132, 16, v131
	v_lshl_or_b32 v100, v134, 16, v133
	v_lshl_or_b32 v99, v136, 16, v135
	v_lshl_or_b32 v107, v151, 16, v39
	v_wmma_i32_16x16x16_iu8 v[35:42], v[43:46], v[67:70], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[43:50], v[95:98], v[67:70], v[1:8] neg_lo:[1,1,0]
	v_perm_b32 v110, v116, v113, 0xc0c0004
	v_perm_b32 v113, v120, v117, 0xc0c0004
	v_perm_b32 v114, v119, v118, 0xc0c0004
	v_perm_b32 v116, v214, v213, 0xc0c0004
	v_perm_b32 v117, v216, v215, 0xc0c0004
	v_perm_b32 v118, v222, v221, 0xc0c0004
	v_perm_b32 v119, v224, v223, 0xc0c0004
	v_perm_b32 v120, v230, v229, 0xc0c0004
	v_perm_b32 v121, v232, v231, 0xc0c0004
	v_perm_b32 v122, v238, v237, 0xc0c0004
	v_perm_b32 v123, v240, v239, 0xc0c0004
	v_perm_b32 v145, v220, v219, 0xc0c0004
	v_perm_b32 v146, v218, v217, 0xc0c0004
	v_perm_b32 v147, v228, v227, 0xc0c0004
	v_perm_b32 v148, v226, v225, 0xc0c0004
	v_perm_b32 v149, v236, v235, 0xc0c0004
	v_perm_b32 v150, v234, v233, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu8 v[35:42], v[75:78], v[71:74], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[43:50], v[99:102], v[71:74], v[43:50] neg_lo:[1,1,0]
	v_lshl_or_b32 v89, v112, 16, v110
	v_lshl_or_b32 v88, v114, 16, v113
	v_lshl_or_b32 v94, v117, 16, v116
	v_lshl_or_b32 v93, v119, 16, v118
	...
	v_wmma_i32_16x16x16_iu8 v[35:42], v[83:86], v[79:82], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[43:50], v[103:106], v[79:82], v[43:50] neg_lo:[1,1,0]
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_add_i32 s9, s34, 1
	s_mov_b32 s4, s28
	s_cmp_lt_i32 s9, 2
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[35:42], v[91:94], v[87:90], v[35:42] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[43:50], v[107:110], v[87:90], v[43:50] neg_lo:[1,1,0]
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_dual_add_f32 v21, v21, v42 :: v_dual_add_nc_u32 v244, s7, v29
	v_dual_add_f32 v22, v22, v41 :: v_dual_add_nc_u32 v245, s28, v34
	v_add_f32_e32 v24, v24, v35
	v_dual_add_f32 v28, v28, v36 :: v_dual_add_f32 v27, v27, v37
	v_dual_add_f32 v26, v26, v38 :: v_dual_add_f32 v15, v15, v48
	v_add_f32_e32 v25, v25, v39
	v_dual_add_f32 v23, v23, v40 :: v_dual_add_f32 v20, v20, v43
	v_add_f32_e32 v17, v17, v46
	v_dual_add_f32 v19, v19, v44 :: v_dual_add_f32 v18, v18, v45
	v_dual_add_f32 v13, v13, v50 :: v_dual_add_f32 v16, v16, v47
	...
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v244, v111 offset:32768
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v245, v[51:54]
	s_waitcnt vmcnt(2)
	ds_store_b128 v245, v[55:58] offset:4096
	s_waitcnt vmcnt(1)
	ds_store_b128 v245, v[59:62] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v245, v[63:66] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.10:
	...
	v_dual_mov_b32 v34, s9 :: v_dual_mov_b32 v31, s6
	...
	v_dual_mov_b32 v29, s4 :: v_dual_mov_b32 v30, s5
...
.LBB0_11:
	...
	v_dual_mov_b32 v45, 0x5410 :: v_dual_and_b32 v44, 16, v0
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v6, v7, s[4:7], 0 offen
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v7, v25, v8 :: v_dual_add_f32 v8, v23, v9
	v_dual_add_f32 v9, v22, v10 :: v_dual_add_f32 v10, v21, v11
	v_add_f32_e32 v11, v20, v29
	v_dual_add_f32 v29, v19, v30 :: v_dual_add_f32 v30, v18, v31
	v_dual_add_f32 v31, v17, v32 :: v_dual_add_f32 v32, v16, v33
	v_dual_add_f32 v33, v15, v34 :: v_dual_add_f32 v34, v14, v35
	v_dual_add_f32 v35, v13, v36 :: v_dual_mov_b32 v46, 0x7632
	v_dual_add_f32 v3, v27, v3 :: v_dual_lshlrev_b32 v36, 1, v0
	v_add_f32_e32 v4, v26, v4
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_lshl_add_u32 v41, v5, 1, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_mul_lo_u32 v42, s25, v12
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v19, v19, v29, s2
	v_cndmask_b32_e64 v18, v18, v30, s2
	v_cndmask_b32_e64 v17, v17, v31, s2
	v_cndmask_b32_e64 v29, v15, v33, s2
	v_cndmask_b32_e64 v30, v14, v34, s2
	v_cndmask_b32_e64 v31, v13, v35, s2
	...
	v_mov_b16_e32 v32.h, v43.h
	v_mov_b16_e32 v33.h, v43.h
	v_mov_b16_e32 v35.h, v43.h
	v_mov_b16_e32 v34.h, v43.h
	s_mov_b32 s2, s6
	...
	ds_load_b128 v[12:15], v41 offset:528
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v8, v8, v37 :: v_dual_mul_f32 v3, v26, v3
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v14, v14, v37
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v1, v28, v1 :: v_dual_max_f32 v0, 0, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v2, v2, v37 :: v_dual_max_f32 v3, 0, v3
	v_dual_mul_f32 v15, v15, v37 :: v_dual_mul_f32 v14, v30, v14
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v5, v5, v37 :: v_dual_mul_f32 v2, v27, v2
	v_dual_mul_f32 v9, v9, v37 :: v_dual_mul_f32 v8, v20, v8
	v_mul_f32_e32 v11, v11, v37
	v_dual_mul_f32 v12, v12, v37 :: v_dual_mul_f32 v15, v31, v15
	v_mul_f32_e32 v13, v13, v37
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v7, v21, v7 :: v_dual_mul_f32 v6, v22, v6
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v8, 0, v8
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v10, v10, v37 :: v_dual_mul_f32 v11, v17, v11
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v5, v23, v5 :: v_dual_max_f32 v2, 0, v2
	v_dual_mul_f32 v12, v16, v12 :: v_dual_mul_f32 v13, v29, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 413 15 is_stmt 1              ; generate_amdgcn.py:413:15
	v_dual_max_f32 v6, 0, v6 :: v_dual_mul_f32 v1, v1, v1
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v10, v18, v10 :: v_dual_max_f32 v5, 0, v5
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v11, 0, v11 :: v_dual_mul_f32 v0, v0, v0
	s_delay_alu instid0(VALU_DEP_4)
	...
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	v_dual_mul_f32 v10, v10, v10 :: v_dual_and_b32 v17, 1, v32
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	v_dual_mul_f32 v11, v11, v11 :: v_dual_and_b32 v18, 1, v33
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v9, v19, v9 :: v_dual_max_f32 v4, 0, v4
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v9, 0, v9 :: v_dual_and_b32 v2, 1, v43
	...
	v_dual_cndmask_b32 v6, 0x3276, v46 :: v_dual_and_b32 v21, 1, v36
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_cndmask_b32 v5, v3, v1 :: v_dual_and_b32 v22, 1, v40
	v_cndmask_b32_e32 v1, v1, v3, vcc_lo
	v_cndmask_b32_e32 v3, 0x1054, v45, vcc_lo
	v_and_b32_e32 v7, 1, v43
	v_mov_b16_e32 v43.l, v13.h
	...
	v_permlanex16_b32 v9, v0, s3, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v13, v2, s3, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v3, v9, v8, v11
	v_permlanex16_b32 v6, v4, s3, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4)
	...
	s_clause 0x1
	buffer_store_b128 v[0:3], v38, s[0:3], 0 offen
	buffer_store_b128 v[4:7], v38, s[0:3], 0 offen offset:256
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 246
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 35
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     37
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
