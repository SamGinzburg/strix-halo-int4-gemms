	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3,@function
amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3:                                 ; @amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[42:43], null, s13, s38, v[41:42]
	...
	v_mul_lo_u32 v108, v16, s35
	v_mul_lo_u32 v109, v18, s35
	v_mul_lo_u32 v110, v19, s35
	...
	v_mul_lo_u32 v121, v17, s35
	v_mul_lo_u32 v122, v18, s35
	v_mul_lo_u32 v123, v19, s35
	v_mul_lo_u32 v124, v20, s35
	v_mul_lo_u32 v126, v16, s35
	.loc	1 1135 19 is_stmt 1             ; ragged.py:1135:19
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u8 v174, v35, s[24:27], 0 offen
	v_add_nc_u32_e32 v9, v108, v3
	v_add_nc_u32_e32 v4, s31, v4
	v_add_nc_u32_e32 v29, v110, v3
	v_add_nc_u32_e32 v5, s31, v5
	v_add_nc_u32_e32 v31, v122, v3
	v_add_nc_u32_e32 v10, s31, v43
	v_add_nc_u32_e32 v33, v124, v3
	v_add_nc_u32_e32 v6, s31, v6
	v_add_nc_u32_e32 v28, v109, v3
	v_add_nc_u32_e32 v30, v121, v3
	v_add_nc_u32_e32 v32, v123, v3
	v_add_nc_u32_e32 v3, v126, v3
	v_dual_cndmask_b32 v9, 0x80000000, v9 :: v_dual_add_nc_u32 v2, 0, v86
	...
	buffer_load_u8 v175, v10, s[24:27], 0 offen
	buffer_load_u8 v6, v6, s[24:27], 0 offen
	buffer_load_u8 v176, v11, s[24:27], 0 offen
	buffer_load_u8 v177, v12, s[24:27], 0 offen
	buffer_load_u8 v178, v13, s[24:27], 0 offen
	buffer_load_u8 v7, v7, s[24:27], 0 offen
	buffer_load_u8 v179, v14, s[24:27], 0 offen
	buffer_load_u8 v180, v15, s[24:27], 0 offen
	buffer_load_u8 v181, v16, s[24:27], 0 offen
	buffer_load_u8 v182, v17, s[24:27], 0 offen
	buffer_load_u8 v183, v18, s[24:27], 0 offen
	buffer_load_u8 v184, v19, s[24:27], 0 offen
	buffer_load_u8 v185, v20, s[24:27], 0 offen
	buffer_load_u8 v8, v8, s[24:27], 0 offen
	buffer_load_u8 v186, v21, s[24:27], 0 offen
	buffer_load_u8 v187, v22, s[24:27], 0 offen
	buffer_load_u8 v188, v23, s[24:27], 0 offen
	buffer_load_u8 v189, v24, s[24:27], 0 offen
	buffer_load_u8 v190, v25, s[24:27], 0 offen
	buffer_load_u8 v191, v26, s[24:27], 0 offen
	buffer_load_u8 v192, v27, s[24:27], 0 offen
	v_cndmask_b32_e64 v11, 0x80000000, v29, s1
	v_cndmask_b32_e64 v13, 0x80000000, v31, s4
	v_cndmask_b32_e64 v15, 0x80000000, v33, s6
	v_cndmask_b32_e64 v10, 0x80000000, v28, s0
	v_cndmask_b32_e64 v12, 0x80000000, v30, s3
	v_cndmask_b32_e64 v14, 0x80000000, v32, s5
	...
	s_waitcnt vmcnt(0)
	ds_store_b8 v146, v10
	ds_store_b8 v146, v12 offset:512
	ds_store_b8 v146, v14 offset:1024
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_store_b8 v152, v69
	ds_store_b8 v152, v4 offset:256
	ds_store_b8 v152, v5 offset:512
	ds_store_b8 v152, v6 offset:1024
	ds_store_b8 v152, v176 offset:1280
	ds_store_b8 v152, v177 offset:1536
	ds_store_b8 v152, v7 offset:2048
	ds_store_b8 v152, v179 offset:2304
	ds_store_b8 v152, v180 offset:2560
	ds_store_b8 v152, v182 offset:3072
	ds_store_b8 v152, v183 offset:3328
	ds_store_b8 v152, v184 offset:3584
	ds_store_b8 v152, v8 offset:4096
	ds_store_b8 v152, v186 offset:4352
	ds_store_b8 v152, v187 offset:4608
	ds_store_b8 v152, v189 offset:5120
	ds_store_b8 v152, v190 offset:5376
	ds_store_b8 v152, v191 offset:5632
	ds_store_b8 v152, v70 offset:6144
	ds_store_b8 v152, v71 offset:6400
	ds_store_b8 v152, v72 offset:6656
	ds_store_b8 v152, v74 offset:7168
	ds_store_b8 v152, v75 offset:7424
	ds_store_b8 v152, v76 offset:7680
	ds_store_b8 v154, v175
	ds_store_b8 v156, v178
	ds_store_b8 v158, v181
	ds_store_b8 v159, v185
	ds_store_b8 v160, v188
	ds_store_b8 v161, v192
	ds_store_b8 v162, v73
	ds_store_b8 v164, v174
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v11, s35, v81, 1
	v_add_lshl_u32 v12, s35, v82, 1
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 1161 31                       ; ragged.py:1161:31
	v_wmma_i32_16x16x16_iu4 v[25:32], v[182:183], v[15:16], v[25:32] neg_lo:[1,1,0]
	.loc	1 1204 40                       ; ragged.py:1204:40
	v_add_lshl_u32 v15, s35, v83, 1
	v_add_lshl_u32 v16, s35, v84, 1
	...
	v_dual_mul_f32 v190, v212, v11 :: v_dual_mul_f32 v71, v74, v9
	...
	v_fmac_f32_e32 v119, v180, v4
	v_dual_fmac_f32 v125, v178, v2 :: v_dual_fmac_f32 v98, v16, v3
	.loc	1 1216 21                       ; ragged.py:1216:21
	ds_load_b128 v[9:12], v173 offset:512
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v97, v69, v4 :: v_dual_fmac_f32 v138, v186, v6
	...
	.loc	1 1226 17                       ; ragged.py:1226:17
	v_dual_fmac_f32 v168, v25, v5 :: v_dual_fmac_f32 v167, v26, v6
	...
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v94, v72, v7 :: v_dual_fmac_f32 v135, v35, v9
	v_fmac_f32_e32 v163, v29, v9
	v_fmac_f32_e32 v157, v30, v10
	v_dual_fmac_f32 v155, v31, v11 :: v_dual_fmac_f32 v134, v36, v10
	v_dual_fmac_f32 v133, v39, v11 :: v_dual_fmac_f32 v132, v40, v12
	v_dual_fmac_f32 v117, v189, v6 :: v_dual_fmac_f32 v114, v192, v9
	v_dual_fmac_f32 v115, v191, v8 :: v_dual_fmac_f32 v92, v74, v9
	v_dual_fmac_f32 v153, v32, v12 :: v_dual_fmac_f32 v112, v13, v11
	v_dual_fmac_f32 v91, v75, v10 :: v_dual_fmac_f32 v90, v76, v11
	v_dual_fmac_f32 v88, v194, v12 :: v_dual_fmac_f32 v137, v187, v7
	s_waitcnt lgkmcnt(0)
	v_fmac_f32_e32 v106, v17, v1
	v_fmac_f32_e32 v151, v33, v1
	v_fmac_f32_e32 v149, v34, v2
	v_dual_fmac_f32 v145, v37, v3 :: v_dual_fmac_f32 v144, v38, v4
	v_dual_fmac_f32 v111, v14, v12 :: v_dual_fmac_f32 v102, v21, v3
	v_dual_fmac_f32 v131, v174, v1 :: v_dual_fmac_f32 v130, v175, v2
	v_fmac_f32_e32 v113, v193, v10
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 214
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.numbered_sgpr, 80
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3.has_recursion, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_fwd_nn_sc64_evenk_int4_relu2_outsc256_bm64_bn256_bk64_gst1_w8_s3
