...
.Ltmp11:
	...
	v_mad_u64_u32 v[3:4], null, s29, v2, v[1:2]
	.loc	1 297 13                        ; generate_amdgcn.py:297:13
	s_cvt_u32_f32 s7, s7
	s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(SALU_CYCLE_1)
...
.Ltmp13:
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_mad_u64_u32 v[4:5], null, s26, s29, v[3:4]
...
.Ltmp15:
	...
	v_mul_lo_u32 v53, s29, v3
	v_mul_lo_u32 v55, s29, v6
	v_xor_b32_e32 v45, 16, v44
	v_xor_b32_e32 v46, 32, v44
	v_mul_lo_u32 v56, s29, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_b128 v[89:92], v57, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	s_clause 0x1
	buffer_load_b128 v[93:96], v58, s[20:23], 0 offen
	buffer_load_b128 v[97:100], v59, s[20:23], 0 offen
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v57, s6, v44
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v61, s3, v48
	.loc	1 348 22                        ; generate_amdgcn.py:348:22
	v_add_nc_u32_e32 v58, s6, v45
	v_add_nc_u32_e32 v59, s6, v46
	.loc	1 350 22                        ; generate_amdgcn.py:350:22
	v_add_nc_u32_e32 v62, s3, v49
	...
	v_dual_add_f32 v32, v32, v67 :: v_dual_add_nc_u32 v157, s7, v52
	v_dual_add_f32 v29, v29, v70 :: v_dual_add_nc_u32 v158, s28, v52
...
.LBB0_10:
	...
	v_or3_b32 v45, v45, v46, s24
	.loc	1 378 14                        ; generate_amdgcn.py:378:14
	s_mov_b32 s4, s12
	.loc	1 378 22 is_stmt 0              ; generate_amdgcn.py:378:22
	v_or3_b32 v43, v47, v43, s26
	...
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v91, v34, v1, s2
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	...
	v_cndmask_b32_e64 v38, v32, v54, s2
	...
	v_cndmask_b32_e64 v36, v33, v53, s2
	...
	v_cndmask_b32_e64 v40, v28, v58, s2
	...
	v_dual_mul_f32 v94, v2, v26 :: v_dual_mul_f32 v5, v41, v45
	...
	v_mul_f32_e32 v10, v39, v47
	v_mul_f32_e32 v14, v37, v49
	v_mul_f32_e32 v18, v35, v51
	v_dual_mul_f32 v28, v29, v75 :: v_dual_mul_f32 v17, v19, v84
	v_dual_mul_f32 v2, v52, v78 :: v_dual_mul_f32 v11, v54, v11
	v_dual_mul_f32 v4, v25, v79 :: v_dual_mul_f32 v19, v56, v85
	v_dual_mul_f32 v3, v42, v43 :: v_dual_mul_f32 v8, v23, v81
	v_mul_f32_e32 v13, v21, v82
	v_dual_mul_f32 v21, v57, v86 :: v_dual_mul_f32 v22, v38, v72
	v_dual_mul_f32 v35, v27, v77 :: v_dual_mul_f32 v6, v53, v80
	v_mul_f32_e32 v23, v58, v87
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm64_bn128_bk64_gm4_w8_s3_weu2_sk4_maskk.numbered_sgpr, 32
