...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v28, v25 :: v_dual_lshlrev_b32 v7, 6, v103
	v_dual_mov_b32 v31, v25 :: v_dual_lshlrev_b32 v8, 4, v66
	.loc	1 759 21 is_stmt 0              ; attention.py:759:21
	v_or_b32_e32 v5, 32, v4
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v6, s14, v4
	.loc	1 790 23 is_stmt 1              ; attention.py:790:23
	v_cmp_gt_i32_e32 vcc_lo, 0x800, v4
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v4, 7, v101
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v5, s14, v5
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v117, s12, v6
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v119, s13, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v123, v11, v109
	.loc	1 818 13                        ; attention.py:818:13
	...
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v147, 0, v13
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v12, v25 :: v_dual_lshlrev_b32 v17, 8, v11
	...
	v_dual_mov_b32 v6, v25 :: v_dual_lshlrev_b32 v17, 4, v17
	.loc	1 760 21                        ; attention.py:760:21
	...
	v_dual_mov_b32 v176, 0xff800000 :: v_dual_add_nc_u32 v143, 0, v7
	...
	v_dual_mov_b32 v175, 0xff800000 :: v_dual_lshlrev_b32 v2, 4, v2
	v_lshrrev_b32_e32 v3, 1, v3
	v_dual_mov_b32 v173, 0xff800000 :: v_dual_lshlrev_b32 v24, 3, v103
	...
	v_dual_mov_b32 v14, 0x5410 :: v_dual_and_b32 v3, 48, v18
	...
	v_dual_mov_b32 v174, 0xff800000 :: v_dual_add_nc_u32 v141, 0, v4
	v_xor_b32_e32 v137, v3, v16
	...
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v166, 0, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_or_b32_e32 v94, s51, v115
	v_or_b32_e32 v90, s51, v110
	v_or_b32_e32 v92, s51, v111
	v_or_b32_e32 v93, s51, v113
	.loc	1 818 13                        ; attention.py:818:13
	v_add_nc_u32_e32 v183, 1, v122
	v_add_nc_u32_e32 v184, 2, v122
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v91, s51, v109
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s11, s67, s51
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v90, v117
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s18, v90, v119
	.loc	1 866 30                        ; attention.py:866:30
	...
	.loc	1 819 31                        ; attention.py:819:31
	v_or_b32_e32 v178, s51, v116
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v95, v117
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s29, v95, v119
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s31, v95, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s33, v95, v120
	...
	v_cndmask_b32_e64 v84, 0x80000000, v195, s19
	...
	s_barrier
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s6, 0xff800000, v91
	.loc	1 879 36                        ; attention.py:879:36
	...
	v_cmp_neq_f32_e64 s15, 0xff800000, v92
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b16 v87.h, 0xff80, v191.l, s21
	v_cndmask_b16 v87.l, 0xff80, v88.l, s20
	...
	v_cndmask_b16 v84.l, 0xff80, v84.l, s19
	...
	v_cndmask_b16 v82.l, 0xff80, v178.l, s16
	.loc	1 881 34                        ; attention.py:881:34
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 69
