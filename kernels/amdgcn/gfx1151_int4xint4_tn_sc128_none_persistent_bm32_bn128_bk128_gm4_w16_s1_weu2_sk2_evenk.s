	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph8
	...
	v_and_b32_e32 v3, 0x2040, v12
	v_and_b32_e32 v8, 0x180, v0
	v_lshlrev_b32_e32 v12, 10, v2
	v_and_or_b32 v5, 0x31c, v10, v13
.Ltmp11:
...
.Ltmp17:
	...
	v_and_b32_e32 v8, 32, v13
	v_rcp_iflag_f32_e32 v13, s0
.Ltmp18:
	.loc	1 222 36                        ; generate_amdgcn.py:222:36
	v_and_b32_e32 v6, 16, v0
	v_and_or_b32 v5, 0xf00, v5, v11
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s18, s18, s42
	s_add_i32 s42, s11, 1
	s_sub_i32 s43, s18, s6
	s_cmp_ge_u32 s18, s6
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v51, 0 :: v_dual_add_nc_u32 v2, s42, v23
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_lshl_or_b32 v1, s6, 8, v28
	v_lshl_add_u32 v3, s6, 7, v29
	s_lshl_b32 s6, s0, 8
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_lo_u32 v54, s40, v2
	s_lshl_b32 s0, s0, 7
	v_subrev_nc_u32_e32 v53, s6, v1
	v_subrev_nc_u32_e32 v55, s0, v3
	v_dual_mov_b32 v49, 0 :: v_dual_add_nc_u32 v56, s42, v30
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_dual_mov_b32 v6, v0 :: v_dual_add_nc_u32 v53, s39, v53
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	...
	.loc	1 273 22                        ; generate_amdgcn.py:273:22
	s_clause 0x7
	buffer_load_u16 v91, v1, s[16:19], 0 offen
	buffer_load_u16 v101, v1, s[16:19], 0 offen offset:4
	buffer_load_u16 v104, v1, s[16:19], 0 offen offset:8
	buffer_load_u16 v106, v1, s[16:19], 0 offen offset:12
	buffer_load_u16 v108, v1, s[16:19], 0 offen offset:16
	buffer_load_u16 v110, v1, s[16:19], 0 offen offset:20
	buffer_load_u16 v112, v1, s[16:19], 0 offen offset:24
	buffer_load_u16 v113, v1, s[16:19], 0 offen offset:28
	.loc	1 271 31                        ; generate_amdgcn.py:271:31
	s_waitcnt lgkmcnt(4)
	...
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v50, v1, v11 :: v_dual_lshlrev_b32 v15, 16, v108
	.loc	1 273 22 is_stmt 1              ; generate_amdgcn.py:273:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v18, 16, v113
	v_lshlrev_b32_e32 v16, 16, v110
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 274 17                        ; generate_amdgcn.py:274:17
	v_dual_fmac_f32 v48, v5, v15 :: v_dual_lshlrev_b32 v17, 16, v112
...
.Ltmp19:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_vgpr, 114
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.kd
