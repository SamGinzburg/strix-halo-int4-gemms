...
; %bb.5:                                ; %.lr.ph
	...
	v_dual_mov_b32 v45, 0x7632 :: v_dual_lshlrev_b32 v42, 5, v33
	v_lshl_add_u32 v83, v33, 1, 0
	s_delay_alu instid0(VALU_DEP_3)
	...
	s_cvt_u32_f32 s9, s9
	s_sub_i32 s11, 0, s6
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v82, s47, v35
	...
	v_dual_mov_b32 v40, v33 :: v_dual_and_b32 v3, 16, v0
	v_dual_mov_b32 v38, v33 :: v_dual_and_b32 v51, 63, v0
	...
	v_dual_cndmask_b32 v47, 0x1054, v4 :: v_dual_lshlrev_b32 v48, 1, v51
	...
	v_dual_mov_b32 v26, v25 :: v_dual_cndmask_b32 v45, 0x3276, v45
	...
	v_dual_mov_b32 v37, v33 :: v_dual_and_b32 v46, 0x540054, v46
	...
	v_dual_mov_b32 v39, v33 :: v_dual_add_nc_u32 v92, 0, v42
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v43, 0x760076, v45
	...
	s_add_i32 s10, s9, 1
	s_cmp_ge_u32 s7, s6
	v_dual_mov_b32 v29, v25 :: v_dual_and_b32 v96, 0x5040504, v42
	...
	v_or_b32_e32 v84, 2, v81
	.loc	1 758 19                        ; attention.py:758:19
	s_sub_i32 s3, s6, s3
	.loc	1 974 51                        ; attention.py:974:51
	v_or_b32_e32 v85, 4, v81
	v_or_b32_e32 v86, 6, v81
	.loc	1 981 24                        ; attention.py:981:24
	v_cmp_gt_i32_e64 s0, s33, v51
	v_subrev_nc_u32_e32 v87, s45, v82
	v_dual_mov_b32 v35, v33 :: v_dual_add_nc_u32 v88, s46, v82
	...
	v_dual_mov_b32 v22, v25 :: v_dual_and_b32 v97, 0x7060706, v42
	...
	.loc	1 903 13                        ; attention.py:903:13
	v_lshl_add_u32 v90, s33, 1, v52
	v_lshl_add_u32 v91, s33, 2, v52
	...
	s_mul_i32 s29, s39, s31
	.loc	1 976 30 is_stmt 1              ; attention.py:976:30
	s_mul_i32 s30, s39, s28
	...
	v_dual_mov_b32 v31, v25 :: v_dual_mul_f32 v98, s12, v44
...
.LBB0_6:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	.loc	1 978 32                        ; attention.py:978:32
	s_clause 0x3
	buffer_load_u8 v108, v105, s[40:43], 0 offen
	buffer_load_u8 v105, v106, s[40:43], 0 offen
	buffer_load_u8 v106, v107, s[40:43], 0 offen
	buffer_load_u8 v107, v118, s[40:43], 0 offen
	...
	v_cndmask_b32_e64 v44, 0xff800000, v44, s49
	v_cndmask_b32_e64 v43, 0xff800000, v43, s54
	v_cndmask_b32_e64 v110, 0xff800000, v42, s50
	v_cndmask_b32_e64 v41, 0xff800000, v41, s52
	v_cndmask_b32_e64 v48, 0xff800000, v48, s55
	v_cndmask_b32_e64 v46, 0xff800000, v46, s51
	v_cndmask_b32_e64 v45, 0xff800000, v45, s53
	v_cndmask_b32_e64 v47, 0xff800000, v47, s56
.Ltmp1:
...
.Ltmp7:
	...
	v_permlanex16_b32 v124, v42, s48, 0xfedcba98 op_sel:[1,0]
.Ltmp8:
	.loc	1 974 36                        ; attention.py:974:36
	v_or_b32_e32 v120, s1, v86
	.loc	1 988 30                        ; attention.py:988:30
	...
	.loc	1 971 33                        ; attention.py:971:33
	v_cndmask_b32_e64 v103, 0, v110, s50
	v_cndmask_b32_e64 v110, 0, v127, s54
	s_delay_alu instid0(TRANS32_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
	v_cndmask_b32_e64 v44, 0, v44, s49
	.loc	1 1018 23                       ; attention.py:1018:23
...
.Ltmp14:
	...
	v_cndmask_b32_e64 v48, 0, v48, s55
	.loc	1 1018 23                       ; attention.py:1018:23
...
.Ltmp18:
	...
	v_cndmask_b32_e64 v104, 0, v111, s11
	.loc	1 985 30                        ; attention.py:985:30
	v_cmp_gt_i32_e64 s11, s31, v117
	.loc	1 986 76                        ; attention.py:986:76
	...
	.loc	1 986 32                        ; attention.py:986:32
	v_cndmask_b32_e64 v106, 0, v112, s11
	.loc	1 985 30                        ; attention.py:985:30
	...
	.loc	1 986 32                        ; attention.py:986:32
	v_cndmask_b32_e64 v107, 0, v115, s11
	.loc	1 985 30                        ; attention.py:985:30
	...
	v_cndmask_b32_e64 v46, v46, v105, s11
	.loc	1 989 38                        ; attention.py:989:38
	...
	v_cvt_f32_i32_e32 v46, v46
	.loc	1 989 29                        ; attention.py:989:29
	v_cndmask_b32_e64 v41, v108, v112, s11
	...
	.loc	1 989 29                        ; attention.py:989:29
	v_cndmask_b32_e64 v108, v109, v115, s11
	.loc	1 989 38 is_stmt 0              ; attention.py:989:38
	...
	v_cndmask_b32_e64 v104, v104, v105, s11
	.loc	1 990 39 is_stmt 0              ; attention.py:990:39
	v_cmp_lt_u32_e64 s11, 7, v106
	.loc	1 1018 23 is_stmt 1             ; attention.py:1018:23
	...
	v_cndmask_b32_e64 v105, v106, v109, s11
	.loc	1 990 39 is_stmt 0              ; attention.py:990:39
	...
	.loc	1 990 30 is_stmt 1              ; attention.py:990:30
	v_cndmask_b32_e64 v106, v107, v112, s11
	.loc	1 990 39 is_stmt 0              ; attention.py:990:39
	...
	.loc	1 990 30 is_stmt 1              ; attention.py:990:30
	v_cndmask_b32_e64 v107, v111, v115, s11
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	v_cndmask_b16 v45.h, 0x7fff, v104.h, s16
	v_cndmask_b16 v44.l, 0x7fff, v108.h, s13
	v_cndmask_b16 v44.h, 0x7fff, v44.h, s14
	v_cndmask_b16 v46.l, 0x7fff, v105.h, s17
	v_cndmask_b16 v46.h, 0x7fff, v106.h, s18
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u16_d16 v105, v83 offset:512
	ds_load_u16_d16 v112, v83 offset:288
	ds_load_u16_d16 v121, v83 offset:608
	ds_load_u16_d16 v120, v83 offset:352
	ds_load_u16_d16 v129, v83 offset:576
	ds_load_u16_d16 v130, v83 offset:832
.Ltmp19:
...
.Ltmp21:
	...
	v_permlanex16_b32 v103, v41, s48, 0xfedcba98 op_sel:[1,0]
.Ltmp22:
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v47.h, 0x7fff, v113.h, s3
	v_cndmask_b16 v48.l, 0x7fff, v114.h, s7
	v_cndmask_b16 v47.l, 0x7fff, v110.h, s6
	v_cndmask_b16 v48.h, 0x7fff, v118.h, s10
.Ltmp23:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:972:24 ] ]
	v_add_f32_e32 v41, v41, v103
.Ltmp24:
	.loc	1 1017 30                       ; attention.py:1017:30
	ds_load_u16_d16 v131, v83 offset:1088
	ds_load_u16_d16 v132, v83 offset:1344
	ds_load_u16_d16 v133, v83 offset:1600
	ds_load_u16_d16 v134, v83 offset:1856
	s_waitcnt lgkmcnt(6)
	ds_load_u16_d16_hi v120, v83 offset:480
	ds_load_u16_d16 v106, v83 offset:768
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v129, v83 offset:704
	ds_load_u16_d16 v113, v83 offset:544
	ds_load_u16_d16 v104, v83 offset:256
	ds_load_u16_d16 v128, v83 offset:320
	ds_load_u16_d16 v103, v83
	ds_load_u16_d16 v111, v83 offset:32
	ds_load_u16_d16 v127, v83 offset:64
	ds_load_u16_d16 v119, v83 offset:96
	ds_load_u16_d16 v107, v83 offset:1024
	ds_load_u16_d16 v114, v83 offset:800
	s_waitcnt lgkmcnt(16)
	ds_load_u16_d16_hi v130, v83 offset:960
	ds_load_u16_d16 v122, v83 offset:864
	ds_load_u16_d16 v108, v83 offset:1280
	ds_load_u16_d16 v115, v83 offset:1056
	s_waitcnt lgkmcnt(19)
	ds_load_u16_d16_hi v131, v83 offset:1216
	ds_load_u16_d16 v123, v83 offset:1120
	ds_load_u16_d16 v109, v83 offset:1536
	ds_load_u16_d16 v116, v83 offset:1312
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v132, v83 offset:1472
	ds_load_u16_d16 v124, v83 offset:1376
	ds_load_u16_d16 v110, v83 offset:1792
	ds_load_u16_d16 v117, v83 offset:1568
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v133, v83 offset:1728
	ds_load_u16_d16 v125, v83 offset:1632
	ds_load_u16_d16 v118, v83 offset:1824
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v134, v83 offset:1984
	ds_load_u16_d16 v126, v83 offset:1888
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v103, v83 offset:128
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v111, v83 offset:160
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v127, v83 offset:192
	s_waitcnt lgkmcnt(22)
	ds_load_u16_d16_hi v119, v83 offset:224
	ds_load_u16_d16_hi v105, v83 offset:640
	ds_load_u16_d16_hi v104, v83 offset:384
	ds_load_u16_d16_hi v112, v83 offset:416
	ds_load_u16_d16_hi v128, v83 offset:448
	ds_load_u16_d16_hi v106, v83 offset:896
	ds_load_u16_d16_hi v113, v83 offset:672
	ds_load_u16_d16_hi v121, v83 offset:736
	s_waitcnt lgkmcnt(29)
	ds_load_u16_d16_hi v107, v83 offset:1152
	s_waitcnt lgkmcnt(29)
	ds_load_u16_d16_hi v114, v83 offset:928
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v122, v83 offset:992
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v108, v83 offset:1408
	s_waitcnt lgkmcnt(28)
	ds_load_u16_d16_hi v115, v83 offset:1184
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v123, v83 offset:1248
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v109, v83 offset:1664
	s_waitcnt lgkmcnt(27)
	ds_load_u16_d16_hi v116, v83 offset:1440
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v124, v83 offset:1504
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v110, v83 offset:1920
	s_waitcnt lgkmcnt(26)
	ds_load_u16_d16_hi v117, v83 offset:1696
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v125, v83 offset:1760
	s_waitcnt lgkmcnt(25)
	ds_load_u16_d16_hi v118, v83 offset:1952
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v45.h, 0x7fff, v45.h, s8
	.loc	1 1017 30                       ; attention.py:1017:30
	s_waitcnt lgkmcnt(24)
	ds_load_u16_d16_hi v126, v83 offset:2016
	.loc	1 1019 30                       ; attention.py:1019:30
	v_cndmask_b16 v45.l, 0x7fff, v44.h, s9
	v_permlanex16_b32 v44, v46, s48, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v138, v47, s48, 0xfedcba98 op_sel:[1,0]
	v_permlanex16_b32 v140, v48, s48, 0xfedcba98 op_sel:[1,0]
	.loc	1 1020 23                       ; attention.py:1020:23
	v_fmac_f32_e32 v41, v102, v43
	.loc	1 1019 30                       ; attention.py:1019:30
	v_permlanex16_b32 v142, v45, s48, 0xfedcba98 op_sel:[1,0]
...
.LBB0_7:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v107, s35, v65
	v_or_b32_e32 v108, s35, v66
	v_or_b32_e32 v109, s35, v64
	v_or_b32_e32 v118, s35, v63
	v_or_b32_e32 v119, s35, v62
	.loc	1 910 73                        ; attention.py:910:73
	v_cmp_gt_i32_e64 s3, s31, v107
	v_cmp_gt_i32_e64 s7, s31, v106
	v_cmp_gt_i32_e64 s9, s31, v105
	v_cmp_gt_i32_e64 s11, s31, v104
	v_cmp_gt_i32_e64 s1, s31, v119
	v_cmp_gt_i32_e64 s6, s31, v118
	v_cmp_gt_i32_e64 s8, s31, v109
	v_cmp_gt_i32_e64 s10, s31, v108
	.loc	1 946 25                        ; attention.py:946:25
	s_and_b32 s52, s2, s11
	s_and_b32 s50, s2, s9
	s_and_b32 s54, s2, s7
	s_and_b32 s49, s2, s3
	s_and_b32 s53, s2, s10
	s_and_b32 s51, s2, s8
	s_and_b32 s56, s2, s6
...
; %bb.8:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cmp_le_i32_e32 vcc_lo, v104, v82
	v_cmp_le_i32_e64 s12, v105, v82
	v_cmp_le_i32_e64 s13, v106, v82
	v_cmp_le_i32_e64 s14, v107, v82
	v_cmp_le_i32_e64 s15, v108, v82
	v_cmp_le_i32_e64 s16, v109, v82
	.loc	1 949 21 is_stmt 0              ; attention.py:949:21
	s_and_b32 s27, vcc_lo, s52
	s_and_b32 s12, s12, s50
	.loc	1 949 30                        ; attention.py:949:30
	v_cmp_le_i32_e64 s17, v118, v82
...
.LBB0_9:                                ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cndmask_b32_e64 v120, 0x80000000, v112, s7
	v_cndmask_b32_e64 v113, 0x80000000, v113, s3
	v_cndmask_b32_e64 v121, 0x80000000, v114, s10
	v_cndmask_b32_e64 v115, 0x80000000, v115, s8
	v_cndmask_b32_e64 v122, 0x80000000, v116, s6
	v_cndmask_b32_e64 v123, 0x80000000, v117, s1
	s_clause 0x7
...
; %bb.10:                               ;   in Loop: Header=BB0_7 Depth=1
	...
	v_cmp_le_i32_e64 s11, v104, v88
	v_cmp_le_i32_e64 s12, v105, v88
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s3, v106, v87
	v_cmp_ge_i32_e64 s6, v107, v87
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s13, v106, v88
	v_cmp_le_i32_e64 s14, v107, v88
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s7, v108, v87
	v_cmp_ge_i32_e64 s8, v109, v87
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s15, v108, v88
	v_cmp_le_i32_e64 s16, v109, v88
	.loc	1 952 21 is_stmt 0              ; attention.py:952:21
	s_and_b32 s11, vcc_lo, s11
	s_and_b32 s1, s1, s12
	.loc	1 951 30 is_stmt 1              ; attention.py:951:30
	v_cmp_ge_i32_e64 s9, v118, v87
	v_cmp_ge_i32_e64 s10, v119, v87
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s17, v118, v88
	v_cmp_le_i32_e64 s18, v119, v88
	.loc	1 952 21 is_stmt 0              ; attention.py:952:21
	s_and_b32 s6, s6, s14
	s_and_b32 s3, s3, s13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_runtime_float32_d64_dv64_shaperuntime_bm64_bn16_w4_s1_ds1.numbered_sgpr, 57
