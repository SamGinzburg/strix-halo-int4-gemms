	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp23:
	...
	v_mov_b32_e32 v17, 0
	v_or3_b32 v18, v5, v1, s14
	v_add_nc_u32_e32 v5, s20, v13
	v_mov_b32_e32 v13, 0
	s_mov_b32 s20, s6
	s_mov_b32 s6, s0
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_lshl_add_u32 v29, v2, 1, v5
	v_dual_mov_b32 v16, 0 :: v_dual_add_nc_u32 v33, 0, v3
	v_mul_lo_u32 v1, s15, v1
	v_dual_mov_b32 v15, 0 :: v_dual_add_nc_u32 v34, 0, v6
	v_add3_u32 v4, v4, s1, v7
	v_dual_mov_b32 v24, 0 :: v_dual_add_nc_u32 v19, 0, v12
	v_or_b32_e32 v26, 10, v18
	v_or_b32_e32 v27, 12, v18
	v_add3_u32 v1, v1, s1, v7
	s_lshl_b32 s1, s2, 7
	s_mov_b32 s2, s0
	v_subrev_nc_u32_e32 v31, s1, v4
	v_or_b32_e32 v28, 14, v18
	v_subrev_nc_u32_e32 v30, s1, v1
	s_mov_b32 s1, s0
	v_lshlrev_b32_e32 v8, 1, v0
	v_dual_mov_b32 v12, 0 :: v_dual_and_b32 v11, 0x90, v11
.Ltmp24:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:333:28 ]
...
.Ltmp25:
	...
	v_dual_mov_b32 v8, s7 :: v_dual_add_nc_u32 v35, 0, v11
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s0, s0, s15
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v55, v20, s1, 1
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v47, v18, s0, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cmp_lt_i32 s1, s25
	.loc	1 360 40                        ; generate_amdgcn.py:360:40
	s_mul_i32 s1, s1, s15
	...
	v_add_lshl_u32 v49, v22, s0, 1
	v_add_lshl_u32 v50, v23, s0, 1
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v57, v21, s1, 1
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_dual_cndmask_b32 v46, 0x80000000, v46 :: v_dual_cndmask_b32 v47, 0x80000000, v47
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v56, v18, s1, 1
	v_add_lshl_u32 v58, v22, s1, 1
	v_add_lshl_u32 v59, v23, s1, 1
	v_add_lshl_u32 v60, v25, s1, 1
	v_add_lshl_u32 v61, v26, s1, 1
	v_add_lshl_u32 v62, v27, s1, 1
	v_add_lshl_u32 v63, v28, s1, 1
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt vmcnt(2)
	ds_store_b16 v32, v44 offset:8192
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	ds_store_b128 v33, v[36:39]
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v32, v45 offset:8704
	.loc	1 348 26                        ; generate_amdgcn.py:348:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v33, v[40:43] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	ds_load_u8 v36, v19 offset:1664
	ds_load_u8 v37, v19 offset:1920
	ds_load_u8 v38, v19 offset:1792
	ds_load_u8 v39, v19 offset:1536
	ds_load_u8 v40, v19 offset:1152
	ds_load_u8 v41, v19 offset:1408
	ds_load_u8 v42, v19 offset:1280
	ds_load_u8 v43, v19 offset:1024
	ds_load_u8 v48, v19 offset:640
	ds_load_u8 v49, v19 offset:896
	ds_load_u8 v50, v19 offset:768
	ds_load_u8 v51, v19 offset:512
	ds_load_u8 v64, v19 offset:128
	ds_load_u8 v65, v19 offset:384
	ds_load_u8 v66, v19 offset:256
	ds_load_u8 v67, v19
	ds_load_u8 v68, v19 offset:3712
	ds_load_u8 v69, v19 offset:3968
	ds_load_u8 v70, v19 offset:3840
	ds_load_u8 v71, v19 offset:3584
	ds_load_u8 v72, v19 offset:3200
	ds_load_u8 v73, v19 offset:3456
	ds_load_u8 v74, v19 offset:3328
	ds_load_u8 v75, v19 offset:3072
	ds_load_u8 v94, v19 offset:2688
	ds_load_u8 v95, v19 offset:2944
	ds_load_u8 v96, v19 offset:2816
	ds_load_u8 v97, v19 offset:2560
	ds_load_u8 v98, v19 offset:2176
	ds_load_u8 v99, v19 offset:2432
	ds_load_u8 v100, v19 offset:2304
	ds_load_u8 v101, v19 offset:2048
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[44:47], v34 offset:8192
	ds_load_b128 v[52:55], v34 offset:8704
	ds_load_b128 v[56:59], v35 offset:8192
	ds_load_b128 v[60:63], v35 offset:8704
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v102, v19 offset:5760
	ds_load_u8 v103, v19 offset:6016
	ds_load_u8 v104, v19 offset:5888
	ds_load_u8 v105, v19 offset:5632
	ds_load_u8 v106, v19 offset:5248
	ds_load_u8 v107, v19 offset:5504
	ds_load_u8 v108, v19 offset:5376
	ds_load_u8 v109, v19 offset:5120
	ds_load_u8 v110, v19 offset:4736
	ds_load_u8 v111, v19 offset:4992
	ds_load_u8 v112, v19 offset:4864
	ds_load_u8 v113, v19 offset:4608
	ds_load_u8 v114, v19 offset:4224
	ds_load_u8 v115, v19 offset:4480
	ds_load_u8 v116, v19 offset:4352
	ds_load_u8 v117, v19 offset:4096
	ds_load_u8 v118, v19 offset:7808
	ds_load_u8 v119, v19 offset:8064
	ds_load_u8 v120, v19 offset:7936
	ds_load_u8 v121, v19 offset:7680
	ds_load_u8 v122, v19 offset:7296
	ds_load_u8 v123, v19 offset:7552
	ds_load_u8 v124, v19 offset:7424
	ds_load_u8 v125, v19 offset:7168
	ds_load_u8 v126, v19 offset:6784
	ds_load_u8 v127, v19 offset:7040
	ds_load_u8 v128, v19 offset:6912
	ds_load_u8 v129, v19 offset:6656
	ds_load_u8 v130, v19 offset:6272
	ds_load_u8 v131, v19 offset:6528
	ds_load_u8 v132, v19 offset:6400
	ds_load_u8 v133, v19 offset:6144
	...
	s_waitcnt vmcnt(14)
	v_dual_mul_f32 v44, v53, v44 :: v_dual_lshlrev_b32 v55, 16, v79
	s_waitcnt vmcnt(11)
	...
	v_dual_mul_f32 v36, v52, v36 :: v_dual_add_nc_u32 v31, s27, v31
	v_dual_mul_f32 v37, v52, v37 :: v_dual_add_nc_u32 v30, s27, v30
	...
	v_dual_mul_f32 v39, v52, v39 :: v_dual_lshlrev_b32 v66, 16, v90
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v15, v41, v63 :: v_dual_lshlrev_b32 v68, 16, v92
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v24, v37, v55 :: v_dual_lshlrev_b32 v69, 16, v93
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v47, v53, v47 :: v_dual_lshlrev_b32 v64, 16, v88
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v13, v36, v54
	v_dual_fmac_f32 v17, v39, v59 :: v_dual_fmac_f32 v16, v38, v58
	v_dual_fmac_f32 v11, v43, v67 :: v_dual_fmac_f32 v14, v40, v62
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v12, v42, v66 :: v_dual_fmac_f32 v13, v44, v57
	v_fmac_f32_e32 v24, v45, v56
	v_dual_fmac_f32 v16, v46, v61 :: v_dual_fmac_f32 v15, v49, v64
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v17, v47, v60 :: v_dual_fmac_f32 v14, v48, v65
	v_dual_fmac_f32 v11, v51, v68 :: v_dual_fmac_f32 v12, v50, v69
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 134
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 28
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     30
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
