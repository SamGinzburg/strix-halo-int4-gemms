...
.Ltmp13:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[4:7], v3, s[20:23], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[26:29], v11, s[20:23], 0 offen
	buffer_load_b128 v[34:37], v34, s[20:23], 0 offen
	buffer_load_b128 v[48:51], v1, s[20:23], 0 offen
	buffer_load_b128 v[52:55], v2, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[71:74], v56, s[20:23], 0 offen
	buffer_load_b128 v[75:78], v55, s[20:23], 0 offen
	buffer_load_b128 v[79:82], v57, s[20:23], 0 offen
	buffer_load_b128 v[83:86], v58, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v59, s3, v51
	v_add_nc_u32_e32 v60, s3, v52
	v_add_nc_u32_e32 v61, s3, v53
	v_add_nc_u32_e32 v62, s3, v54
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v133, s29, v41
	v_add_nc_u32_e32 v135, s29, v43
	v_add_nc_u32_e32 v136, s29, v44
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v137, s29, v45
	v_add_nc_u32_e32 v138, s29, v46
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[55:62], v[115:118], v[95:98], v[55:62] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v139, s29, v47
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(2)
	...
	v_dual_add_f32 v14, v14, v55 :: v_dual_add_f32 v29, v29, v56
	v_dual_add_f32 v28, v28, v57 :: v_dual_add_f32 v27, v27, v58
	v_dual_add_f32 v26, v26, v59 :: v_dual_add_f32 v25, v25, v60
	v_dual_add_f32 v24, v24, v61 :: v_dual_add_f32 v23, v23, v62
	v_dual_add_f32 v22, v22, v63 :: v_dual_add_f32 v21, v21, v64
	v_dual_add_f32 v15, v15, v70 :: v_dual_add_nc_u32 v132, s8, v40
	v_dual_add_f32 v17, v17, v68 :: v_dual_add_nc_u32 v134, s29, v42
	v_dual_add_f32 v20, v20, v65 :: v_dual_add_f32 v19, v19, v66
...
; %bb.8:
	...
	v_add_nc_u32_e32 v41, s30, v34
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v38, s4, v4
	v_add_nc_u32_e32 v39, s4, v3
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v42, s30, v36
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_f32 v16, v16, v8 :: v_dual_add_f32 v15, v15, v9
.LBB0_9:
...
; %bb.10:
	...
	s_mov_b32 s11, s4
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v39, s29, v2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v37, s3, v37
	v_add_nc_u32_e32 v34, s3, v34
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v38, s29, v3
	...
	v_dual_mov_b32 v41, s8 :: v_dual_add_nc_u32 v10, s29, v5
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v34, s3, v35
...
.LBB0_11:
	...
	s_mov_b32 s4, s16
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v8, v25, v30 :: v_dual_lshlrev_b32 v3, 1, v3
	.loc	1 434 14                        ; generate_amdgcn.py:434:14
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_add_f32 v6, v27, v9 :: v_dual_add_f32 v9, v24, v31
	v_dual_add_f32 v31, v21, v38 :: v_dual_add_f32 v38, v16, v43
	v_dual_add_f32 v39, v15, v44 :: v_dual_mov_b32 v44, 0x5410
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_mov_b16_e32 v33.h, v42.h
	v_mov_b16_e32 v32.h, v42.h
	...
	v_dual_mul_f32 v14, v14, v34 :: v_dual_max_f32 v1, 0, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v13, v17, v13
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v5, v5, v34 :: v_dual_mul_f32 v12, v18, v12
	v_mul_f32_e32 v4, v4, v34
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v0, v46, v0 :: v_dual_mul_f32 v7, v7, v34
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mul_f32_e32 v5, v25, v5
	.loc	1 448 9 is_stmt 1               ; generate_amdgcn.py:448:9
	v_cmp_eq_u32_e32 vcc_lo, 0, v43
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v4, v26, v4 :: v_dual_mul_f32 v9, v9, v34
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v0, 0, v0
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v6, v6, v34 :: v_dual_mul_f32 v7, v23, v7
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v4, 0, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v8, v8, v34 :: v_dual_mul_f32 v9, v21, v9
	v_mul_f32_e32 v3, v3, v34
	v_dual_mul_f32 v15, v15, v34 :: v_dual_mul_f32 v0, v0, v0
	.loc	1 436 9 is_stmt 0               ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v8, v22, v8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v2, v2, v34 :: v_dual_mul_f32 v3, v27, v3
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_mul_f32_e32 v6, v24, v6
	v_dual_mul_f32 v14, v16, v14 :: v_dual_max_f32 v7, 0, v7
	v_dual_mul_f32 v2, v28, v2 :: v_dual_mul_f32 v15, v30, v15
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 443 15 is_stmt 1              ; generate_amdgcn.py:443:15
	v_max_f32_e32 v3, 0, v3
	v_max_f32_e32 v9, 0, v9
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v11, v11, v34 :: v_dual_max_f32 v8, 0, v8
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v2, 0, v2 :: v_dual_mul_f32 v1, v1, v1
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 436 16                        ; generate_amdgcn.py:436:16
	v_dual_mul_f32 v10, v10, v34 :: v_dual_mul_f32 v11, v19, v11
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 436 9                         ; generate_amdgcn.py:436:9
	v_dual_mul_f32 v10, v20, v10 :: v_dual_max_f32 v5, 0, v5
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v15, v15, v15 :: v_dual_and_b32 v16, 1, v42
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_dual_cndmask_b32 v5, v3, v1 :: v_dual_and_b32 v20, 1, v36
	...
	v_dual_cndmask_b32 v3, 0x1054, v44 :: v_dual_and_b32 v22, 1, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	buffer_store_b128 v[4:7], v35, s[0:3], 0 offen offset:256
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 140
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 35
