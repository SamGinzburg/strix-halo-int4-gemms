...
.Ltmp11:
	...
	v_mov_b32_e32 v5, v8
	v_mov_b32_e32 v3, v8
	.loc	1 111 30 is_stmt 1              ; generate_amdgcn.py:111:30
...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v10, v9 :: v_dual_add_nc_u32 v23, v19, v2
...
.Ltmp13:
	.loc	1 105 9                         ; generate_amdgcn.py:105:9
	v_add3_u32 v2, v3, s11, v18
	v_add3_u32 v18, v1, s20, v17
	v_mov_b32_e32 v13, v9
	v_mov_b32_e32 v14, v9
	v_mov_b32_e32 v15, v9
	v_subrev_nc_u32_e32 v24, s14, v2
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[37:38], v[29:30], v[1:8] neg_lo:[1,1,0]
	.loc	1 105 9                         ; generate_amdgcn.py:105:9
