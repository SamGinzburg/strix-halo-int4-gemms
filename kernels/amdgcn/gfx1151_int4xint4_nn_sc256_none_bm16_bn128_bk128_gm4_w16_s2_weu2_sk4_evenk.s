...
.LBB0_5:
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v13, v26, v13, v52
	v_fma_f32 v9, v27, v9, v100
	v_fma_f32 v14, v30, v14, v97
	v_fma_f32 v15, v31, v15, v96
	v_fma_f32 v16, v32, v16, v95
	v_fma_f32 v17, v33, v17, v94
	v_fma_f32 v18, v114, v18, v93
	v_fma_f32 v19, v115, v19, v92
	v_fma_f32 v20, v116, v20, v91
	v_fma_f32 v21, v117, v21, v90
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(47)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v22, v118, v22, v89
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(23)
	v_lshlrev_b32_e32 v112, 16, v113
	s_waitcnt vmcnt(22)
	v_lshlrev_b32_e32 v113, 16, v162
	s_waitcnt vmcnt(21)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v23, v119, v23, v88
	v_fma_f32 v24, v120, v24, v87
	v_fma_f32 v26, v121, v103, v86
	v_fma_f32 v27, v122, v104, v85
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(5)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v32, v127, v109, v80
	v_fma_f32 v103, v129, v111, v78
	v_fma_f32 v111, v138, v167, v69
	v_fma_f32 v127, v154, v183, v53
	v_fma_f32 v11, v28, v11, v99
	v_fma_f32 v28, v123, v105, v84
	v_fma_f32 v33, v128, v110, v79
	v_fma_f32 v104, v130, v112, v77
	v_fma_f32 v112, v139, v168, v68
	v_fma_f32 v128, v155, v184, v51
	v_fma_f32 v8, v8, v101, v37
	v_fma_f32 v12, v29, v12, v98
	v_fma_f32 v29, v124, v106, v83
	v_fma_f32 v7, v7, v10, v38
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v10, v52, v13, s0
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v105, v131, v113, v76
	v_fma_f32 v113, v140, v169, v67
	v_fma_f32 v129, v156, v185, v50
	v_fma_f32 v30, v125, v107, v82
	v_fma_f32 v114, v141, v170, v66
	v_fma_f32 v130, v157, v186, v49
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v69, v69, v111, s0
	v_cndmask_b32_e64 v53, v53, v127, s0
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v31, v126, v108, v81
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v9, v100, v9, s0
	...
	v_cndmask_b32_e64 v11, v99, v11, s0
	v_cndmask_b32_e64 v28, v83, v29, s0
	ds_store_2addr_b32 v36, v10, v26 offset1:32
	v_xad_u32 v10, v34, 8, 0
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(1)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v106, v132, v162, v75
	v_fma_f32 v115, v142, v171, v65
	v_fma_f32 v116, v143, v172, v64
	v_fma_f32 v131, v158, v187, v48
	v_fma_f32 v132, v159, v188, v47
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v67, v67, v113, s0
	v_cndmask_b32_e64 v50, v50, v129, s0
	v_cndmask_b32_e64 v12, v98, v12, s0
	...
	ds_store_2addr_b32 v37, v9, v27 offset1:32
	v_xad_u32 v9, v34, 12, 0
	v_cndmask_b32_e64 v30, v81, v31, s0
	ds_store_2addr_b32 v37, v68, v51 offset0:64 offset1:96
	ds_store_2addr_b32 v10, v11, v28 offset1:32
	v_xad_u32 v11, v34, 16, 0
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v107, v133, v163, v74
	v_fma_f32 v117, v144, v173, v63
	v_fma_f32 v119, v146, v175, v61
	v_fma_f32 v133, v160, v189, v46
	v_fma_f32 v1, v1, v191, v44
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	ds_store_2addr_b32 v10, v67, v50 offset0:64 offset1:96
	ds_store_2addr_b32 v9, v12, v29 offset1:32
	v_xad_u32 v10, v34, 20, 0
	v_cndmask_b32_e64 v31, v80, v32, s0
	v_cndmask_b32_e64 v32, v79, v33, s0
	ds_store_2addr_b32 v9, v66, v49 offset0:64 offset1:96
	ds_store_2addr_b32 v11, v13, v30 offset1:32
	v_xad_u32 v9, v34, 24, 0
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v108, v134, v164, v73
	v_fma_f32 v118, v145, v174, v62
	v_fma_f32 v134, v161, v190, v45
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	ds_store_2addr_b32 v10, v14, v31 offset1:32
	ds_store_2addr_b32 v10, v64, v47 offset0:64 offset1:96
	ds_store_2addr_b32 v9, v15, v32 offset1:32
	v_xad_u32 v10, v34, 32, 0
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v109, v135, v165, v72
	v_fma_f32 v110, v136, v166, v71
	v_fma_f32 v102, v137, v102, v70
	v_fma_f32 v120, v147, v176, v60
	v_fma_f32 v121, v148, v177, v59
	v_fma_f32 v122, v149, v178, v58
	v_fma_f32 v123, v150, v179, v57
	v_fma_f32 v124, v151, v180, v56
	v_fma_f32 v125, v152, v181, v55
	v_fma_f32 v126, v153, v182, v54
	v_fma_f32 v2, v2, v192, v43
	v_fma_f32 v3, v3, v193, v42
	v_fma_f32 v4, v4, v194, v41
	v_fma_f32 v5, v5, v195, v40
	v_fma_f32 v6, v6, v196, v39
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	ds_store_2addr_b32 v9, v63, v46 offset0:64 offset1:96
	ds_store_2addr_b32 v11, v16, v33 offset1:32
	ds_store_2addr_b32 v11, v62, v45 offset0:64 offset1:96
	ds_store_2addr_b32 v10, v61, v1 offset0:64 offset1:96
	...
	s_add_i32 s0, s0, s33
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	ds_store_2addr_b32 v10, v17, v52 offset1:32
	ds_store_2addr_b32 v9, v18, v76 offset1:32
	ds_store_2addr_b32 v9, v60, v2 offset0:64 offset1:96
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk4_evenk.numbered_sgpr, 44
