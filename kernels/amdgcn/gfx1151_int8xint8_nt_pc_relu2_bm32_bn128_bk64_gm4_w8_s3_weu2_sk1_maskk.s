	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_add_nc_u32_e32 v14, s34, v39
	.loc	1 376 30 is_stmt 1              ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v12, 64, v2
	.loc	1 369 23                        ; generate_amdgcn.py:369:23
	v_cmp_gt_i32_e32 vcc_lo, s29, v1
	.loc	1 370 23                        ; generate_amdgcn.py:370:23
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[19:20], v13, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_dual_cndmask_b32 v13, 0x80000000, v14 :: v_dual_add_nc_u32 v24, 0, v40
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v25, v[11:14] offset:8192
	s_waitcnt vmcnt(0)
	ds_store_b128 v25, v[15:18] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp14:
	...
	v_xor_b32_e32 v35, 32, v33
	v_xor_b32_e32 v36, 48, v33
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v2, s5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_add_f32 v15, v15, v54 :: v_dual_add_nc_u32 v112, s6, v40
	v_dual_add_f32 v14, v14, v55 :: v_dual_add_nc_u32 v113, s3, v41
	v_dual_add_f32 v11, v11, v42 :: v_dual_add_f32 v26, v26, v43
	...
	v_dual_add_f32 v19, v19, v50 :: v_dual_add_f32 v18, v18, v51
	v_dual_add_f32 v17, v17, v52 :: v_dual_add_f32 v16, v16, v53
	v_dual_add_f32 v13, v13, v56 :: v_dual_add_f32 v12, v12, v57
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(2)
...
; %bb.7:
	...
	v_add_nc_u32_e32 v9, s33, v31
	ds_load_b128 v[85:88], v9
	ds_load_b128 v[89:92], v9 offset:1024
...
.LBB0_10:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 399 13 is_stmt 1              ; generate_amdgcn.py:399:13
	v_dual_add_f32 v1, v11, v1 :: v_dual_lshlrev_b32 v28, 1, v28
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v37, v17, v37 :: v_dual_add_f32 v38, v16, v38
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_add_i32 s3, s3, s14
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v41, v13, v41 :: v_dual_add_f32 v42, v12, v42
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	v_mov_b32_e32 v46, 0x5410
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v7, v21, v7, s2
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_add3_u32 v21, s3, v44, v27
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v3, v25, v3 :: v_dual_add_f32 v4, v24, v4
	v_dual_add_f32 v5, v23, v5 :: v_dual_add_f32 v6, v22, v6
	v_dual_add_f32 v9, v19, v9 :: v_dual_add_f32 v10, v18, v10
	v_dual_add_f32 v39, v15, v39 :: v_dual_add_f32 v40, v14, v40
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v1, v11, v1, s2
	v_cndmask_b32_e64 v2, v26, v2, s2
	v_cndmask_b32_e64 v11, v17, v37, s2
	...
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v38, v27, v30 :: v_dual_lshlrev_b32 v35, 16, v36
	v_mul_f32_e32 v41, v27, v33
	v_dual_mul_f32 v37, v27, v28 :: v_dual_lshlrev_b32 v26, 1, v21
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(0)
	...
	v_dual_mul_f32 v31, v29, v31 :: v_dual_mul_f32 v2, v2, v38
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v32, v29, v32 :: v_dual_mul_f32 v7, v7, v43
	v_dual_mul_f32 v33, v29, v33 :: v_dual_mul_f32 v42, v27, v34
	v_dual_mul_f32 v34, v29, v34 :: v_dual_mul_f32 v11, v11, v31
	v_dual_mul_f32 v35, v29, v35 :: v_dual_mul_f32 v4, v4, v40
	.loc	1 406 9 is_stmt 0               ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v1, v1, v37
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v27, v27, v36 :: v_dual_mul_f32 v30, v29, v30
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_mul_f32_e32 v3, v3, v39
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v29, v29, v36 :: v_dual_mul_f32 v6, v6, v42
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v9, v9, v28 :: v_dual_mul_f32 v8, v8, v27
	v_dual_mul_f32 v5, v5, v41 :: v_dual_mul_f32 v10, v10, v30
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v12, v12, v29 :: v_dual_max_f32 v3, 0, v3
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v16, v16, v32 :: v_dual_mul_f32 v15, v15, v33
	v_dual_mul_f32 v14, v14, v34 :: v_dual_mul_f32 v13, v13, v35
	.loc	1 414 15                        ; generate_amdgcn.py:414:15
	...
	.loc	1 413 15                        ; generate_amdgcn.py:413:15
	v_dual_max_f32 v16, 0, v16 :: v_dual_and_b32 v17, 1, v45
	...
	v_dual_cndmask_b32 v6, 0x3276, v47 :: v_dual_and_b32 v25, 1, v25
	v_cndmask_b32_e32 v2, v2, v4, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_mov_b16_e32 v0.l, v7.h
	v_dual_cndmask_b32 v4, 0x1054, v46 :: v_dual_and_b32 v7, 1, v45
	v_mov_b16_e32 v45.l, v14.h
	v_mov_b16_e32 v24.l, v15.h
	v_dual_cndmask_b32 v8, v0, v1 :: v_dual_and_b32 v23, 1, v23
	...
	v_add_lshl_u32 v8, v21, s0, 1
	s_clause 0x1
	buffer_store_b128 v[0:3], v26, s[12:15], 0 offen
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 114
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
