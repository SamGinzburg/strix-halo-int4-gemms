	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 788 26                        ; attention.py:788:26
	v_lshl_or_b32 v4, v1, 6, v69
	.loc	1 903 13                        ; attention.py:903:13
	v_add_nc_u32_e32 v6, 0, v1
	v_lshlrev_b32_e32 v52, 2, v1
	v_lshl_or_b32 v74, s14, 10, v8
	v_dual_mov_b32 v105, 0xff800000 :: v_dual_lshlrev_b32 v8, 1, v1
	v_and_b32_e32 v49, 0x160, v49
	v_and_b32_e32 v56, 0x90, v56
	v_lshlrev_b32_e32 v1, 4, v1
	v_xor_b32_e32 v14, 0x70, v69
	...
	v_xor_b32_e32 v13, 0x60, v69
	v_lshrrev_b32_e32 v54, 5, v64
	v_lshrrev_b32_e32 v61, 1, v64
	v_xor_b32_e32 v4, 16, v69
	v_xor_b32_e32 v9, 32, v69
	v_add_nc_u32_e32 v82, 0, v13
	v_mov_b32_e32 v13, v49
	v_lshl_add_u32 v1, v66, 2, v6
	v_or_b32_e32 v72, v3, v54
	v_add_nc_u32_e32 v6, 0, v61
	v_xor_b32_e32 v10, 48, v69
	v_xor_b32_e32 v11, 64, v69
	v_add_nc_u32_e32 v93, v1, v57
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v12, 0x50, v69
	...
	v_add_nc_u32_e32 v92, v75, v8
	v_add_nc_u32_e32 v94, v6, v57
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s1, s1, s33
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v56, s34, v97
	.loc	1 939 32                        ; attention.py:939:32
	v_add_lshl_u32 v50, s1, v58, 1
	.loc	1 904 31                        ; attention.py:904:31
	v_or_b32_e32 v55, s34, v61
	v_or_b32_e32 v57, s34, v98
	.loc	1 955 25                        ; attention.py:955:25
	...
	v_cmp_ge_i32_e64 s1, v54, v68
	v_cmp_ge_i32_e64 s6, v56, v68
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s7, v56, v70
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s4, v55, v68
	.loc	1 952 30                        ; attention.py:952:30
	v_cmp_le_i32_e64 s5, v55, v70
	.loc	1 951 30                        ; attention.py:951:30
	v_cmp_ge_i32_e64 s8, v57, v68
	.loc	1 952 30                        ; attention.py:952:30
	...
	.loc	1 944 30                        ; attention.py:944:30
	v_dual_mov_b32 v129, v54 :: v_dual_mov_b32 v126, v51
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v130, v55 :: v_dual_mov_b32 v127, v52
	...
	v_dual_mul_f32 v110, 0x3fb8aa3b, v110 :: v_dual_mul_f32 v113, 0x3fb8aa3b, v113
	v_dual_mul_f32 v132, 0x3fb8aa3b, v116 :: v_dual_mul_f32 v111, 0x3fb8aa3b, v111
	v_dual_mul_f32 v112, 0x3fb8aa3b, v112 :: v_dual_mul_f32 v133, 0x3fb8aa3b, v117
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 965 25 is_stmt 0              ; attention.py:965:25
	v_dual_fmac_f32 v54, s40, v124 :: v_dual_fmac_f32 v113, s40, v129
	v_fmac_f32_e32 v132, s40, v130
	...
	v_dual_fmac_f32 v55, s40, v125 :: v_dual_fmac_f32 v110, s40, v126
	.loc	1 966 25                        ; attention.py:966:25
	v_cmp_eq_u16_e64 s4, 1, v52.l
	v_cmp_eq_u16_e64 s10, 1, v50.l
	.loc	1 965 25                        ; attention.py:965:25
	v_dual_fmac_f32 v111, s40, v127 :: v_dual_fmac_f32 v112, s40, v128
	.loc	1 966 25                        ; attention.py:966:25
...
.Ltmp28:
	...
	.loc	1 969 24                        ; attention.py:969:24
	v_dual_max_f32 v114, v107, v105 :: v_dual_sub_f32 v105, v110, v108
	.loc	1 971 62                        ; attention.py:971:62
...
.Ltmp35:
	...
	.loc	1 1018 23                       ; attention.py:1018:23
	v_dual_mul_f32 v5, v5, v134 :: v_dual_mul_f32 v124, v106, v124
	.loc	1 1017 31                       ; attention.py:1017:31
	...
	v_dual_mul_f32 v107, v123, v107 :: v_dual_mul_f32 v106, v106, v125
	.loc	1 970 74                        ; attention.py:970:74
	...
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v105, v117, v105 :: v_dual_mul_f32 v112, v116, v112
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v111, v116, v111 :: v_dual_and_b32 v116, 1, v122
	.loc	1 1017 30                       ; attention.py:1017:30
	v_and_b32_e32 v117, 1, v121
	v_mov_b16_e32 v119.l, v112.h
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 1017 31                       ; attention.py:1017:31
	v_dual_mul_f32 v125, v123, v126 :: v_dual_and_b32 v122, 1, v129
	.loc	1 1017 30                       ; attention.py:1017:30
...
.Ltmp42:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_vgpr, 141
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm32_bn16_w4_s1_ds1.kd
