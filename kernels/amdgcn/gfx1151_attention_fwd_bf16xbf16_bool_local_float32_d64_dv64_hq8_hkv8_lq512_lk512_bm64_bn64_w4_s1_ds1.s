...
.Ltmp0:
	...
	v_dual_cndmask_b32 v5, 0x80000000, v2 :: v_dual_add_nc_u32 v18, 0, v17
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v4, s10, v33
	s_clause 0x2
	...
	v_subrev_nc_u32_e32 v169, s8, v4
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v171, s9, v4
	v_dual_mov_b32 v27, v25 :: v_dual_lshlrev_b32 v4, 7, v70
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v5, 6, v72
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v2, 4, v2
	v_mov_b32_e32 v26, v25
	v_subrev_nc_u32_e32 v170, s8, v3
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v172, s9, v3
	...
	v_dual_mov_b32 v231, v25 :: v_dual_lshlrev_b32 v12, 6, v71
	v_and_or_b32 v6, v69, 16, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_lshlrev_b32_e32 v7, 8, v4
	v_lshl_or_b32 v10, v4, 1, v5
	v_and_b32_e32 v3, 0x80, v3
	v_add_nc_u32_e32 v251, v8, v254
	v_add_nc_u32_e32 v147, v8, v255
	...
	v_add_nc_u32_e32 v9, 0, v71
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v3, 0x1054, v5, s1
	v_dual_mov_b32 v7, v25 :: v_dual_add_nc_u32 v184, v2, v254
	v_cndmask_b32_e64 v5, 0x3276, v6, s1
	...
	v_add_nc_u32_e32 v150, v2, v167
	v_add_nc_u32_e32 v148, v2, v168
...
.LBB0_71:                               ; %Flow381
	...
	v_cmp_gt_i32_e64 s2, s88, v33
	.loc	1 1044 48                       ; attention.py:1044:48
	v_div_fmas_f32 v41, v41, v51, v58
	.loc	1 1047 63                       ; attention.py:1047:63
	v_cmp_gt_i32_e32 vcc_lo, s88, v35
	.loc	1 1044 48                       ; attention.py:1044:48
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v35, 0x80000000, v35 :: v_dual_add_nc_u32 v26, 32, v37
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 44
