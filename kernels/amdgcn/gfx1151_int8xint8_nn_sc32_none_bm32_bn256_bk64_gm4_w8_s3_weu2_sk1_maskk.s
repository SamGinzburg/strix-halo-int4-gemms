	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp19:
	...
	v_mul_lo_u32 v3, s5, v36
	v_and_or_b32 v7, 0x70, v7, v14
.Ltmp20:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:336:26 ]
	s_add_i32 s1, s1, s0
	v_and_b32_e32 v6, 0x37c, v1
	v_add3_u32 v46, v2, v41, s4
	v_lshlrev_b32_e32 v2, 5, v0
	s_ashr_i32 s34, s1, 5
	v_add_nc_u32_e32 v49, 0, v7
	v_lshl_add_u32 v47, v14, 4, v3
	v_bfe_i32 v3, v0, 5, 1
	v_and_b32_e32 v4, 0x160, v2
	v_dual_mov_b32 v44, 0 :: v_dual_lshlrev_b32 v7, 1, v13
	v_dual_mov_b32 v42, 0 :: v_dual_and_b32 v1, 0x1c0, v1
	...
	v_dual_mov_b32 v37, 0 :: v_dual_add_nc_u32 v52, 0, v7
	v_or_b32_e32 v9, 16, v5
	v_mul_lo_u32 v50, v5, s34
	v_and_b32_e32 v5, 2, v10
	v_xor_b32_e32 v3, v3, v6
	v_dual_mov_b32 v45, 0 :: v_dual_lshlrev_b32 v6, 4, v0
	v_mul_lo_u32 v51, v9, s34
	v_dual_mov_b32 v38, 0 :: v_dual_lshlrev_b32 v9, 1, v0
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v5, 0, v5
	v_xor_b32_e32 v8, 16, v4
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v32, 0 :: v_dual_and_b32 v9, 28, v9
	v_add3_u32 v10, v5, v1, v2
	v_add3_u32 v11, v52, v7, v2
	s_lshl_b32 s22, s5, 4
	v_dual_mov_b32 v35, 0 :: v_dual_add_nc_u32 v54, 0, v3
	v_add_nc_u32_e32 v48, s22, v47
	v_dual_mov_b32 v30, 0 :: v_dual_add_nc_u32 v55, 0, v6
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v56, 0, v4
	v_dual_mov_b32 v28, 0 :: v_dual_add_nc_u32 v57, 0, v8
	v_mov_b32_e32 v1, s8
.Ltmp21:
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_or_b32_e32 v43, 16, v36
	v_or_b32_e32 v53, s7, v0
	...
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v58, v10, v9
	v_dual_mov_b32 v26, 0 :: v_dual_add_nc_u32 v59, v11, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_lshl_b32 s10, s0, 6
	v_or_b32_e32 v60, s10, v41
	v_or_b32_e32 v62, s10, v43
	s_or_b32 s9, s10, 32
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	s_mul_i32 s0, s10, s5
	.loc	1 338 21                        ; generate_amdgcn.py:338:21
	v_or_b32_e32 v61, s10, v36
	.loc	1 344 34                        ; generate_amdgcn.py:344:34
	v_add_nc_u32_e32 v63, s10, v46
	.loc	1 338 21                        ; generate_amdgcn.py:338:21
	v_or_b32_e32 v65, s9, v36
	.loc	1 339 27                        ; generate_amdgcn.py:339:27
	v_cmp_gt_i32_e64 s1, s6, v60
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	s_add_i32 s0, s0, s7
	.loc	1 338 21                        ; generate_amdgcn.py:338:21
	v_or_b32_e32 v64, s9, v41
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	v_add_nc_u32_e32 v68, s0, v47
	v_add_nc_u32_e32 v69, s0, v48
	s_add_i32 s2, s0, s35
	.loc	1 340 27                        ; generate_amdgcn.py:340:27
	v_cmp_gt_i32_e64 s0, s6, v62
	v_cmp_gt_i32_e32 vcc_lo, s6, v61
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	v_cndmask_b32_e64 v60, 0x80000000, v63, s1
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	v_add_nc_u32_e32 v61, s2, v47
	.loc	1 340 27                        ; generate_amdgcn.py:340:27
	v_cmp_gt_i32_e64 s1, s6, v65
	.loc	1 338 21                        ; generate_amdgcn.py:338:21
	v_or_b32_e32 v66, s9, v43
	.loc	1 344 34                        ; generate_amdgcn.py:344:34
	v_add_nc_u32_e32 v67, s9, v46
	.loc	1 339 27                        ; generate_amdgcn.py:339:27
	v_cmp_gt_i32_e64 s4, s6, v64
	...
	s_mul_i32 s1, s0, s5
	.loc	1 348 34                        ; generate_amdgcn.py:348:34
	v_add_nc_u32_e32 v62, s2, v48
	.loc	1 340 27                        ; generate_amdgcn.py:340:27
	v_cmp_gt_i32_e64 s2, s6, v66
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	v_cndmask_b32_e64 v63, 0x80000000, v67, s4
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v79, v53, s1, 1
	...
	s_mul_i32 s1, s0, s5
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v62, v50, s0, 1
	v_add_lshl_u32 v63, v51, s0, 1
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v64, v53, s1, 1
	.loc	1 357 34                        ; generate_amdgcn.py:357:34
	s_cmp_lt_i32 s0, s34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	ds_load_u8 v61, v49 offset:3328
	ds_load_u8 v62, v49 offset:3072
	ds_load_u8 v63, v49 offset:3840
	ds_load_u8 v64, v49 offset:3584
	ds_load_u8 v65, v49 offset:3968
	ds_load_u8 v66, v49 offset:3712
	ds_load_u8 v67, v49 offset:3456
	ds_load_u8 v68, v49 offset:3200
	ds_load_u8 v69, v49 offset:2304
	ds_load_u8 v70, v49 offset:2048
	ds_load_u8 v71, v49 offset:2816
	ds_load_u8 v72, v49 offset:2560
	ds_load_u8 v73, v49 offset:2944
	ds_load_u8 v74, v49 offset:2688
	ds_load_u8 v75, v49 offset:2432
	ds_load_u8 v76, v49 offset:2176
	ds_load_u8 v81, v49 offset:1280
	ds_load_u8 v82, v49 offset:1024
	ds_load_u8 v83, v49 offset:1792
	ds_load_u8 v84, v49 offset:1536
	ds_load_u8 v85, v49 offset:1920
	ds_load_u8 v86, v49 offset:1664
	ds_load_u8 v87, v49 offset:1408
	ds_load_u8 v88, v49 offset:1152
	ds_load_u8 v89, v49 offset:256
	ds_load_u8 v90, v49
	ds_load_u8 v91, v49 offset:768
	ds_load_u8 v92, v49 offset:512
	ds_load_u8 v105, v49 offset:896
	ds_load_u8 v106, v49 offset:640
	ds_load_u8 v107, v49 offset:384
	ds_load_u8 v108, v49 offset:128
	ds_load_u8 v109, v49 offset:7424
	ds_load_u8 v110, v49 offset:7168
	ds_load_u8 v111, v49 offset:7936
	ds_load_u8 v112, v49 offset:7680
	ds_load_u8 v113, v49 offset:8064
	ds_load_u8 v114, v49 offset:7808
	ds_load_u8 v115, v49 offset:7552
	ds_load_u8 v116, v49 offset:7296
	ds_load_u8 v122, v49 offset:6400
	ds_load_u8 v123, v49 offset:6144
	ds_load_u8 v124, v49 offset:6912
	ds_load_u8 v125, v49 offset:6656
	ds_load_u8 v126, v49 offset:7040
	ds_load_u8 v127, v49 offset:6784
	ds_load_u8 v128, v49 offset:6528
	ds_load_u8 v129, v49 offset:6272
	ds_load_u8 v130, v49 offset:5376
	ds_load_u8 v131, v49 offset:5120
	ds_load_u8 v132, v49 offset:5888
	ds_load_u8 v133, v49 offset:5632
	ds_load_u8 v134, v49 offset:6016
	ds_load_u8 v135, v49 offset:5760
	ds_load_u8 v136, v49 offset:5504
	ds_load_u8 v137, v49 offset:5248
	ds_load_u8 v138, v49 offset:4352
	ds_load_u8 v139, v49 offset:4096
	ds_load_u8 v140, v49 offset:4864
	ds_load_u8 v141, v49 offset:4608
	ds_load_u8 v142, v49 offset:4992
	ds_load_u8 v143, v49 offset:4736
	ds_load_u8 v144, v49 offset:4480
	ds_load_u8 v145, v49 offset:4224
	...
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v81, v121, v81 :: v_dual_mul_f32 v70, v120, v70
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	buffer_load_u16 v116, v119, s[16:19], 0 offen
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	s_clause 0x1
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	ds_load_b128 v[60:63], v52 offset:18432
	ds_load_b128 v[64:67], v52 offset:18448
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	...
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	ds_load_u8 v119, v49 offset:11520
	ds_load_u8 v122, v49 offset:11264
	ds_load_u8 v123, v49 offset:12032
	ds_load_u8 v124, v49 offset:11776
	ds_load_u8 v125, v49 offset:12160
	ds_load_u8 v126, v49 offset:11904
	ds_load_u8 v127, v49 offset:11648
	ds_load_u8 v128, v49 offset:11392
	ds_load_u8 v129, v49 offset:10496
	ds_load_u8 v130, v49 offset:10240
	ds_load_u8 v131, v49 offset:11008
	ds_load_u8 v132, v49 offset:10752
	ds_load_u8 v133, v49 offset:11136
	ds_load_u8 v134, v49 offset:10880
	ds_load_u8 v135, v49 offset:10624
	ds_load_u8 v136, v49 offset:10368
	ds_load_u8 v137, v49 offset:9472
	ds_load_u8 v138, v49 offset:9216
	ds_load_u8 v139, v49 offset:9984
	ds_load_u8 v140, v49 offset:9728
	ds_load_u8 v141, v49 offset:10112
	ds_load_u8 v142, v49 offset:9856
	ds_load_u8 v143, v49 offset:9600
	ds_load_u8 v144, v49 offset:9344
	ds_load_u8 v145, v49 offset:8448
	ds_load_u8 v146, v49 offset:8192
	ds_load_u8 v147, v49 offset:8960
	ds_load_u8 v148, v49 offset:8704
	ds_load_u8 v149, v49 offset:9088
	ds_load_u8 v150, v49 offset:8832
	ds_load_u8 v151, v49 offset:8576
	ds_load_u8 v152, v49 offset:8320
	ds_load_u8 v153, v49 offset:15616
	ds_load_u8 v154, v49 offset:15360
	ds_load_u8 v155, v49 offset:16128
	ds_load_u8 v156, v49 offset:15872
	ds_load_u8 v157, v49 offset:16256
	ds_load_u8 v158, v49 offset:16000
	ds_load_u8 v159, v49 offset:15744
	ds_load_u8 v160, v49 offset:15488
	ds_load_u8 v161, v49 offset:14592
	ds_load_u8 v162, v49 offset:14336
	ds_load_u8 v163, v49 offset:15104
	ds_load_u8 v164, v49 offset:14848
	ds_load_u8 v165, v49 offset:15232
	ds_load_u8 v166, v49 offset:14976
	ds_load_u8 v167, v49 offset:14720
	ds_load_u8 v168, v49 offset:14464
	ds_load_u8 v169, v49 offset:13568
	ds_load_u8 v170, v49 offset:13312
	ds_load_u8 v171, v49 offset:14080
	ds_load_u8 v172, v49 offset:13824
	ds_load_u8 v173, v49 offset:14208
	ds_load_u8 v174, v49 offset:13952
	ds_load_u8 v175, v49 offset:13696
	ds_load_u8 v176, v49 offset:13440
	ds_load_u8 v177, v49 offset:12544
	ds_load_u8 v178, v49 offset:12288
	ds_load_u8 v179, v49 offset:13056
	ds_load_u8 v180, v49 offset:12800
	ds_load_u8 v181, v49 offset:13184
	ds_load_u8 v182, v49 offset:12928
	ds_load_u8 v183, v49 offset:12672
	ds_load_u8 v184, v49 offset:12416
	...
	v_dual_mul_f32 v74, v120, v74 :: v_dual_mul_f32 v193, v121, v112
	v_dual_mul_f32 v75, v120, v75 :: v_dual_mul_f32 v194, v121, v84
	v_dual_mul_f32 v191, v120, v110 :: v_dual_mul_f32 v88, v121, v88
	v_dual_mul_f32 v120, v114, v120 :: v_dual_mul_f32 v83, v121, v83
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_waitcnt lgkmcnt(62)
	...
	v_dual_fmac_f32 v40, v120, v199 :: v_dual_lshlrev_b32 v203, 16, v64
	v_dual_fmac_f32 v44, v186, v201 :: v_dual_lshlrev_b32 v205, 16, v66
	v_dual_fmac_f32 v42, v187, v202 :: v_dual_and_b32 v61, 0xffff0000, v61
	v_dual_fmac_f32 v45, v185, v200 :: v_dual_and_b32 v62, 0xffff0000, v62
	v_dual_fmac_f32 v38, v189, v204 :: v_dual_and_b32 v63, 0xffff0000, v63
	v_dual_fmac_f32 v39, v188, v203 :: v_dual_and_b32 v64, 0xffff0000, v64
	v_dual_fmac_f32 v34, v69, v60 :: v_dual_and_b32 v65, 0xffff0000, v65
	v_dual_fmac_f32 v37, v190, v205 :: v_dual_and_b32 v66, 0xffff0000, v66
	v_dual_fmac_f32 v32, v71, v62 :: v_dual_and_b32 v67, 0xffff0000, v67
	...
	v_dual_fmac_f32 v35, v68, v206 :: v_dual_fmac_f32 v30, v73, v64
	v_dual_fmac_f32 v33, v70, v61 :: v_dual_fmac_f32 v28, v75, v66
	v_dual_fmac_f32 v31, v72, v63 :: v_dual_fmac_f32 v24, v193, v201
	v_dual_fmac_f32 v29, v74, v65 :: v_dual_fmac_f32 v26, v121, v199
	v_dual_fmac_f32 v27, v191, v67 :: v_dual_fmac_f32 v16, v197, v62
	v_dual_fmac_f32 v21, v82, v204 :: v_dual_fmac_f32 v10, v91, v66
	v_dual_fmac_f32 v19, v194, v206 :: v_dual_fmac_f32 v18, v195, v60
	v_dual_fmac_f32 v17, v196, v61 :: v_dual_fmac_f32 v12, v89, v64
	v_fmac_f32_e32 v15, v88, v63
	v_fmac_f32_e32 v11, v90, v65
	v_fmac_f32_e32 v9, v198, v67
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v25, v192, v200 :: v_dual_fmac_f32 v22, v81, v203
	v_dual_fmac_f32 v23, v80, v202 :: v_dual_fmac_f32 v20, v83, v205
	.loc	1 349 23                        ; generate_amdgcn.py:349:23
	...
	ds_load_b128 v[60:63], v52 offset:18432
	ds_load_b128 v[64:67], v52 offset:18448
	ds_load_b128 v[68:71], v52 offset:18944
	ds_load_b128 v[72:75], v52 offset:18960
	...
	s_waitcnt lgkmcnt(2)
	v_dual_mul_f32 v91, v109, v91 :: v_dual_fmac_f32 v38, v96, v65
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v45, v92, v61 :: v_dual_fmac_f32 v44, v93, v62
	v_dual_fmac_f32 v42, v94, v63 :: v_dual_fmac_f32 v39, v95, v64
	s_waitcnt lgkmcnt(1)
	v_dual_fmac_f32 v37, v97, v66 :: v_dual_fmac_f32 v34, v99, v68
	v_dual_fmac_f32 v35, v98, v67 :: v_dual_fmac_f32 v32, v101, v70
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v33, v100, v69 :: v_dual_fmac_f32 v30, v103, v72
	v_dual_fmac_f32 v31, v102, v71 :: v_dual_fmac_f32 v28, v105, v74
	v_dual_fmac_f32 v29, v104, v73 :: v_dual_fmac_f32 v24, v78, v62
	v_dual_fmac_f32 v27, v106, v75 :: v_dual_fmac_f32 v26, v76, v60
	v_dual_fmac_f32 v25, v77, v61 :: v_dual_fmac_f32 v22, v80, v64
	v_dual_fmac_f32 v23, v79, v63 :: v_dual_fmac_f32 v20, v82, v66
	v_dual_fmac_f32 v21, v81, v65 :: v_dual_fmac_f32 v18, v84, v68
	v_dual_fmac_f32 v19, v83, v67 :: v_dual_fmac_f32 v16, v86, v70
	v_dual_fmac_f32 v17, v85, v69 :: v_dual_fmac_f32 v12, v88, v72
	v_dual_fmac_f32 v15, v87, v71 :: v_dual_fmac_f32 v10, v90, v74
	v_fmac_f32_e32 v11, v89, v73
	v_fmac_f32_e32 v9, v91, v75
...
.LBB0_6:                                ; %._crit_edge
	...
	v_dual_cndmask_b32 v7, v8, v6 :: v_dual_mov_b32 v12, 0x7632
	v_dual_mov_b32 v11, 0x5410 :: v_dual_cndmask_b32 v6, v6, v8
	v_dual_cndmask_b32 v15, v22, v13 :: v_dual_cndmask_b32 v8, v13, v22
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v12, 0x3276, v12 :: v_dual_cndmask_b32 v13, v18, v14
	v_dual_cndmask_b32 v11, 0x1054, v11 :: v_dual_cndmask_b32 v14, v14, v18
	v_dual_cndmask_b32 v17, v9, v19 :: v_dual_cndmask_b32 v18, v0, v16
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 207
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 36
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     38
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc32_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
