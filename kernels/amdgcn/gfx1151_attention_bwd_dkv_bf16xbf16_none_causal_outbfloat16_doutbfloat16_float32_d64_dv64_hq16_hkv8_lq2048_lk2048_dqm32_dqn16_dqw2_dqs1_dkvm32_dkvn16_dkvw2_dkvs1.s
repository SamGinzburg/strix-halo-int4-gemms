...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_add_lshl_u32 v99, s3, v173, 1
	v_add_lshl_u32 v97, s3, v169, 1
	v_add_lshl_u32 v98, s3, v213, 1
	...
	.loc	1 663 37                        ; attention_backward.py:663:37
	s_clause 0x3
	buffer_load_b128 v[234:237], v99, s[44:47], 0 offen
	buffer_load_b128 v[238:241], v97, s[44:47], 0 offen
	buffer_load_b128 v[225:228], v98, s[44:47], 0 offen
	buffer_load_b128 v[230:233], v100, s[44:47], 0 offen
	.loc	1 671 30                        ; attention_backward.py:671:30
	s_mov_b32 s25, s20
	s_mov_b32 s26, s20
	s_mov_b32 s27, s20
	...
	v_cndmask_b32_e64 v219, 0, v105, s3
	.loc	1 720 47                        ; attention_backward.py:720:47
	...
	.loc	1 721 37                        ; attention_backward.py:721:37
	v_cndmask_b16 v97.l, 0x7fff, v97.h, s3
	.loc	1 663 37                        ; attention_backward.py:663:37
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 701 33                        ; attention_backward.py:701:33
	v_cndmask_b32_e64 v217, 0, v105, s5
	.loc	1 720 30                        ; attention_backward.py:720:30
	v_mul_f32_e32 v100, v217, v100
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 720 47 is_stmt 0              ; attention_backward.py:720:47
	v_dual_sub_f32 v101, v117, v218 :: v_dual_mul_f32 v100, s31, v100
	.loc	1 721 37 is_stmt 1              ; attention_backward.py:721:37
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_bwd_dkv_bf16xbf16_none_causal_outbfloat16_doutbfloat16_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_vgpr, 244
