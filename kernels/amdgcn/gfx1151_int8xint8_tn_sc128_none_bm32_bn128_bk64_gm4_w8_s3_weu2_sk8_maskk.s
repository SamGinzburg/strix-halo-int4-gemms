	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp21:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[15:18], v8, s[36:39], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	v_mov_b32_e32 v10, 0
	v_add3_u32 v6, s30, v3, 0x400
	v_or_b32_e32 v45, 0x400, v3
	v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v15, 0
	v_add_nc_u32_e32 v5, 0x420, v2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add3_u32 v51, s1, v39, v36
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s1, s18, 25
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	v_add_lshl_u32 v62, v33, s1, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_cndmask_b32_e32 v50, 0x80000000, v43, vcc_lo
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v63, v32, s1, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	...
	v_add_lshl_u32 v68, v28, s1, 1
	v_add_lshl_u32 v69, v26, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v169, v62, s[40:43], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[62:65], v49, s[36:39], 0 offen
	...
	v_dual_mul_f32 v86, v70, v78 :: v_dual_add_nc_u32 v253, s34, v37
	...
	v_dual_fmac_f32 v19, v72, v54 :: v_dual_add_nc_u32 v44, s44, v44
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v76, v71, v76
	v_dual_mul_f32 v77, v71, v77 :: v_dual_add_nc_u32 v42, s31, v42
	v_dual_mul_f32 v71, v71, v79 :: v_dual_add_nc_u32 v162, s19, v9
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
...
.LBB0_10:
	...
	v_add_lshl_u32 v52, v31, s4, 1
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_and_b32 vcc_lo, s3, s5
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v53, v29, s4, 1
	v_add_lshl_u32 v54, v27, s4, 1
	v_add_lshl_u32 v55, v30, s4, 1
	v_add_lshl_u32 v56, v28, s4, 1
	v_add_lshl_u32 v57, v26, s4, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
...
.LBB0_12:
	...
	v_dual_cndmask_b32 v26, 0x80000000, v26 :: v_dual_and_b32 v75, 1, v0
	...
	v_dual_cndmask_b32 v28, 0x80000000, v28 :: v_dual_lshlrev_b32 v75, 6, v75
	s_clause 0x7
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v49.l, v35.l
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_and_b32_e32 v58, 14, v0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v50.l, v35.l
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_b32_e32 v55, 0x7f, v0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v51.l, v35.l
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshlrev_b32_e32 v74, 2, v0
	v_bfe_i32 v0, v0, 0, 1
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_mov_b16_e32 v36.l, v35.l
	v_mov_b16_e32 v53.l, v35.l
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v81, v35, v51 :: v_dual_and_b32 v74, 0x3f8, v74
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	...
	v_mov_b16_e32 v48.l, v35.l
	v_mov_b16_e32 v52.l, v35.l
	v_mov_b16_e32 v54.l, v35.l
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v77, v35, v36
	v_mul_f32_e32 v83, v35, v53
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xor_b32_e32 v0, v0, v74
	.loc	1 450 23 is_stmt 0              ; generate_amdgcn.py:450:23
	s_mul_i32 s13, s26, s35
	.loc	1 424 24 is_stmt 1              ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v78, v35, v48 :: v_dual_and_b32 v9, 0x380, v9
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	s_add_i32 s13, s13, s33
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v79, v35, v49
	v_mul_f32_e32 v80, v35, v50
	.loc	1 450 23                        ; generate_amdgcn.py:450:23
	v_add3_u32 v55, s13, v55, v57
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v82, v35, v52
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshl_or_b32 v0, v58, 10, v0
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v84, v35, v54
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v45, v78, v45, v25
	v_fma_f32 v44, v79, v44, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_or3_b32 v9, v9, v76, v47
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v36, v35, v36
	v_mul_f32_e32 v35, v35, v54
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v5, v51, v5, v13
	v_fma_f32 v43, v80, v43, v23
	v_fma_f32 v42, v81, v42, v22
	v_fma_f32 v40, v83, v40, v20
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_lshlrev_b32_e32 v47, 2, v55
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v41, v82, v41, v21
	v_fma_f32 v7, v35, v7, v10
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v35, 0, v0
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v39, v84, v39, v19
	v_fma_f32 v8, v49, v8, v15
	v_fma_f32 v46, v77, v46, v18
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v25, v25, v45, s3
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_add_nc_u32_e32 v45, 0, v9
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v36, v36, v38, v17
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v5, v13, v5, s3
	v_cndmask_b32_e64 v24, v24, v44, s3
	v_cndmask_b32_e64 v23, v23, v43, s3
	v_cndmask_b32_e64 v22, v22, v42, s3
	v_cndmask_b32_e64 v21, v21, v41, s3
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v0, v10, v7, s3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v6, v50, v6, v14
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v13, 16, v27
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v52, v4, v12
	v_fma_f32 v37, v48, v37, v16
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v48, 0x1010, v9, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v8, v14, v6, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v27, v2, v7 :: v_dual_lshlrev_b32 v6, 16, v34
	.loc	1 450 9                         ; generate_amdgcn.py:450:9
	v_xad_u32 v50, 0x2020, v9, 0
	v_xad_u32 v52, 0x3030, v9, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v9, v17, v36, s3
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(1)
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v29, v2, v11 :: v_dual_lshlrev_b32 v14, 16, v30
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v31, v2, v13 :: v_dual_lshlrev_b32 v26, 16, v26
	...
	v_fma_f32 v26, v28, v59, v3
	v_fma_f32 v27, v29, v60, v4
	v_fma_f32 v29, v31, v62, v8
	v_fma_f32 v31, v33, v64, v16
	v_fma_f32 v33, v10, v67, v20
	v_fma_f32 v28, v30, v61, v5
	v_fma_f32 v11, v11, v68, v21
	v_fma_f32 v34, v12, v69, v22
	v_fma_f32 v30, v32, v63, v15
	v_fma_f32 v32, v2, v65, v9
	v_fma_f32 v13, v13, v70, v23
	v_fma_f32 v36, v14, v71, v24
	v_fma_f32 v17, v17, v72, v25
	v_fma_f32 v37, v6, v73, v18
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v0, v0, v1, s2
	v_cndmask_b32_e64 v1, v19, v7, s2
	v_cndmask_b32_e64 v2, v3, v26, s2
	v_cndmask_b32_e64 v3, v20, v33, s2
	v_cndmask_b32_e64 v4, v4, v27, s2
	v_cndmask_b32_e64 v6, v5, v28, s2
	v_cndmask_b32_e64 v5, v21, v11, s2
	v_cndmask_b32_e64 v7, v22, v34, s2
	v_cndmask_b32_e64 v8, v8, v29, s2
	v_cndmask_b32_e64 v10, v15, v30, s2
	v_cndmask_b32_e64 v12, v16, v31, s2
	v_cndmask_b32_e64 v14, v9, v32, s2
	v_cndmask_b32_e64 v9, v23, v13, s2
	v_cndmask_b32_e64 v11, v24, v36, s2
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_vgpr, 254
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_sc128_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk8_maskk.kd
