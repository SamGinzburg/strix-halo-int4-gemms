	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[10:11], null, s31, v3, v[9:10]
...
.Ltmp19:
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v7, s30, v44
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v13, s27, v14
	v_or_b32_e32 v25, s27, v9
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v33, s27, v44
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	s_addk_i32 s7, 0x80
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_add_nc_u32_e32 v34, s7, v15
	v_add_nc_u32_e32 v35, s7, v16
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	buffer_load_b128 v[29:32], v12, s[36:39], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	buffer_load_b128 v[37:40], v5, s[36:39], 0 offen
	buffer_load_b128 v[48:51], v8, s[36:39], 0 offen
	buffer_load_b128 v[52:55], v6, s[36:39], 0 offen
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v22, 0 :: v_dual_add_nc_u32 v49, 0, v19
	v_mov_b32_e32 v23, 0
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_dual_mov_b32 v21, 0 :: v_dual_add_nc_u32 v48, v20, v13
	v_mov_b32_e32 v20, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v50, s27, v14
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_lshr_b32 s19, s19, 25
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v52, s27, v44
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_add_i32 s18, s18, s19
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	s_add_i32 s20, s27, s33
	.loc	1 399 23                        ; generate_amdgcn.py:399:23
	...
	buffer_load_u16 v127, v52, s[40:43], 0 offen
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v128, v50, s[4:7], 0 offen
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
	...
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v60, v60, v98 :: v_dual_add_nc_u32 v129, s20, v47
	...
	v_dual_mul_f32 v65, v65, v98 :: v_dual_fmac_f32 v24, v55, v87
	v_mul_f32_e32 v62, v62, v98
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v33, v63, v95 :: v_dual_add_nc_u32 v130, s34, v46
	v_fmac_f32_e32 v18, v50, v82
	v_dual_fmac_f32 v20, v51, v83 :: v_dual_fmac_f32 v21, v52, v84
	v_dual_fmac_f32 v22, v53, v85 :: v_dual_fmac_f32 v25, v56, v88
	v_fmac_f32_e32 v26, v57, v89
...
; %bb.9:
	...
	ds_load_b128 v[45:48], v2 offset:8192
	...
	ds_load_b128 v[61:64], v4 offset:8192
	...
	ds_load_b128 v[97:100], v10 offset:8192
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_waitcnt lgkmcnt(6)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[65:68], v[73:76], v[2:9] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[61:64], v[73:76], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[81:84], v[69:72], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[77:80], v[69:72], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[57:60], v[85:88], v[49:56] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[2:9], v[45:48], v[85:88], v[2:9] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[49:56], v[93:96], v[89:92], v[49:56] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[2:9], v[97:100], v[89:92], v[2:9] neg_lo:[1,1,0]
...
.Ltmp20:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk2_maskk.kd
