	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_dual_mov_b32 v11, 0x7632 :: v_dual_lshlrev_b32 v14, 1, v0
...
.Ltmp14:
	...
	v_add3_u32 v40, v16, s61, v10
	v_lshl_or_b32 v13, v13, 4, v13
	v_lshl_or_b32 v11, v11, 4, v11
	s_cvt_u32_f32 s1, s5
	s_sub_i32 s5, 0, s60
	v_add_nc_u32_e32 v41, v10, v16
	v_cndmask_b32_e64 v10, 0, 1, s4
	s_mul_i32 s5, s5, s1
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_mad_u64_u32 v[33:34], null, s35, v3, v[1:2]
	...
	v_and_b32_e32 v43, 0x5040504, v13
	v_and_b32_e32 v44, 0x7060706, v11
	s_add_i32 s64, s1, s5
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_or_b32_e32 v34, s3, v37
	...
	v_add_nc_u32_e32 v49, v9, v2
	v_add_nc_u32_e32 v50, v12, v14
...
.LBB0_2:                                ; %._crit_edge
	...
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_add_i32 s2, s2, 20
	v_add_lshl_u32 v68, s3, v41, 1
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	s_clause 0x1
	buffer_load_u16 v66, v18, s[48:51], 0 offen
	buffer_load_u16 v67, v19, s[48:51], 0 offen
	.loc	1 303 13                        ; generate_amdgcn.py:303:13
	v_add_lshl_u32 v69, s3, v40, 1
	v_add_lshl_u32 v70, s3, v42, 1
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	s_cmp_lt_i32 s2, s57
	.loc	1 268 18                        ; generate_amdgcn.py:268:18
	s_waitcnt vmcnt(0)
	...
	ds_load_b128 v[21:24], v51 offset:16
	ds_load_b128 v[25:28], v51 offset:1024
	ds_load_b128 v[29:32], v51 offset:1040
	s_waitcnt lgkmcnt(3)
	v_mul_f32_e32 v73, v19, v66
	v_dual_mul_f32 v19, v19, v67 :: v_dual_mul_f32 v72, v18, v66
	v_mul_f32_e32 v74, v20, v66
	s_waitcnt lgkmcnt(2)
	v_mul_f32_e32 v76, v22, v66
	v_mul_f32_e32 v77, v23, v66
	v_mul_f32_e32 v78, v24, v66
	v_dual_mul_f32 v71, v17, v66 :: v_dual_mul_f32 v18, v18, v67
	v_dual_mul_f32 v75, v21, v66 :: v_dual_mul_f32 v22, v22, v67
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v79, v25, v66
	v_dual_mul_f32 v80, v26, v66 :: v_dual_mul_f32 v21, v21, v67
	v_mul_f32_e32 v81, v27, v66
	v_dual_mul_f32 v82, v28, v66 :: v_dual_mul_f32 v23, v23, v67
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v83, v29, v66
	v_dual_mul_f32 v84, v30, v66 :: v_dual_mul_f32 v25, v25, v67
	v_mul_f32_e32 v85, v31, v66
	v_dual_mul_f32 v66, v32, v66 :: v_dual_mul_f32 v27, v27, v67
	...
	v_dual_mul_f32 v29, v29, v67 :: v_dual_mul_f32 v64, v72, v64
	v_mul_f32_e32 v30, v30, v67
	v_dual_mul_f32 v31, v31, v67 :: v_dual_mul_f32 v62, v74, v62
	v_dual_mul_f32 v32, v32, v67 :: v_dual_mul_f32 v65, v71, v65
	.loc	1 270 13 is_stmt 0              ; generate_amdgcn.py:270:13
	v_dual_mul_f32 v60, v76, v60 :: v_dual_mul_f32 v63, v73, v63
	v_dual_mul_f32 v58, v78, v58 :: v_dual_mul_f32 v61, v75, v61
	v_dual_mul_f32 v56, v80, v56 :: v_dual_mul_f32 v59, v77, v59
	v_dual_mul_f32 v54, v82, v54 :: v_dual_mul_f32 v57, v79, v57
	v_dual_mul_f32 v52, v84, v52 :: v_dual_mul_f32 v55, v81, v55
	v_mul_f32_e32 v14, v19, v14
	v_dual_mul_f32 v53, v83, v53 :: v_dual_mul_f32 v36, v85, v36
	v_dual_mul_f32 v35, v66, v35 :: v_dual_mul_f32 v16, v17, v16
	...
	v_add3_u32 v14, v14, v71, 0x7fff
	v_add3_u32 v13, v13, v72, 0x7fff
	v_add3_u32 v12, v12, v73, 0x7fff
	v_add3_u32 v11, v11, v74, 0x7fff
	v_add3_u32 v10, v10, v75, 0x7fff
	v_add3_u32 v9, v9, v76, 0x7fff
	...
	v_add3_u32 v8, v8, v77, 0x7fff
	v_add3_u32 v7, v7, v78, 0x7fff
	v_add3_u32 v6, v6, v79, 0x7fff
	...
	s_clause 0x3
	buffer_store_b128 v[1:4], v68, s[36:39], 0 offen
	buffer_store_b128 v[5:8], v68, s[36:39], 0 offen offset:512
	buffer_store_b128 v[9:12], v69, s[36:39], 0 offen
	buffer_store_b128 v[13:16], v70, s[36:39], 0 offen
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_add_u32 v2, s6, 9, v33
	v_mov_b32_e32 v1, 0
	v_add_nc_u32_e32 v3, s3, v38
	s_lshl_b32 s5, s5, 9
	s_delay_alu instid0(VALU_DEP_3) | instid1(SALU_CYCLE_1)
	v_subrev_nc_u32_e32 v52, s5, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[35:36], null, s59, v3, v[34:35]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	buffer_load_u8 v36, v35, s[40:43], 0 offen
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	buffer_load_b128 v[53:56], v52, s[44:47], 0 offen
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 252 13                        ; generate_amdgcn.py:252:13
	v_add_nc_u32_e32 v35, 16, v35
	v_add_nc_u32_e32 v52, s61, v52
	s_add_i32 s5, s5, -1
	s_delay_alu instid0(SALU_CYCLE_1)
	s_cmp_lg_u32 s5, 0
	.loc	1 260 26                        ; generate_amdgcn.py:260:26
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b64 v[57:60], v46 offset1:32
	ds_load_2addr_b64 v[61:64], v47 offset1:32
	.loc	1 265 26                        ; generate_amdgcn.py:265:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	ds_load_u8 v36, v49 offset:6656
	ds_load_u8 v53, v49 offset:6144
	ds_load_u8 v54, v49 offset:7680
	ds_load_u8 v55, v49 offset:7168
	ds_load_u8 v56, v49 offset:4608
	ds_load_u8 v65, v49 offset:4096
	ds_load_u8 v66, v49 offset:5632
	ds_load_u8 v67, v49 offset:5120
	ds_load_u8 v68, v49 offset:2560
	ds_load_u8 v69, v49 offset:2048
	ds_load_u8 v70, v49 offset:3584
	ds_load_u8 v71, v49 offset:3072
	ds_load_u8 v72, v49 offset:3840
	ds_load_u8 v73, v49 offset:3328
	ds_load_u8 v74, v49 offset:2816
	ds_load_u8 v75, v49 offset:2304
	ds_load_u8 v76, v49 offset:512
	ds_load_u8 v77, v49
	ds_load_u8 v78, v49 offset:1536
	ds_load_u8 v79, v49 offset:1024
	ds_load_u8 v80, v49 offset:1792
	ds_load_u8 v81, v49 offset:1280
	ds_load_u8 v82, v49 offset:768
	ds_load_u8 v83, v49 offset:256
	ds_load_u8 v84, v49 offset:7936
	ds_load_u8 v85, v49 offset:7424
	ds_load_u8 v86, v49 offset:6912
	ds_load_u8 v87, v49 offset:6400
	ds_load_u8 v88, v49 offset:5888
	ds_load_u8 v89, v49 offset:5376
	ds_load_u8 v90, v49 offset:4864
	ds_load_u8 v91, v49 offset:4352
	...
	v_lshl_or_b32 v56, v55, 16, v36
	v_lshl_or_b32 v55, v67, 16, v76
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[53:54], v[59:60], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[65:66], v[59:60], v[25:32] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[55:56], v[61:62], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu4 v[9:16], v[67:68], v[61:62], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[55:56], v[63:64], v[17:24] neg_lo:[1,1,0]
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_vgpr, 92
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.numbered_sgpr, 66
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     68
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm32_bn512_bk32_gm4_w16_s1_weu2_sk1_evenk.kd
