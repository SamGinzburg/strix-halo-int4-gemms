	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v26, 0 :: v_dual_lshlrev_b32 v5, 4, v0
...
.Ltmp19:
	...
	v_dual_mov_b32 v40, 0 :: v_dual_add_nc_u32 v29, 0, v5
	v_sub_nc_u32_e32 v21, s21, v2
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_mov_b32_e32 v5, v1
	v_dual_mov_b32 v2, v1 :: v_dual_and_b32 v9, 0x438, v8
.Ltmp20:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:154:22 ]
	s_ashr_i32 s28, s2, 8
...
.Ltmp21:
	...
	v_dual_mov_b32 v43, 0 :: v_dual_add_nc_u32 v28, 0, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u16 v9, v25, s[16:19], 0 offen
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[50:51], v30 offset:8192
	ds_load_b64 v[52:53], v31 offset:8192
	ds_load_b64 v[54:55], v32 offset:8192
	ds_load_b64 v[56:57], v33 offset:8192
	ds_load_b64 v[58:59], v34 offset:8192
	ds_load_b64 v[60:61], v35 offset:8192
	ds_load_b64 v[62:63], v36 offset:8192
	ds_load_b64 v[64:65], v37 offset:8192
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	ds_load_u8 v50, v20 offset:1664
	ds_load_u8 v51, v20 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:1920
	ds_load_u8 v66, v20 offset:1792
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v66, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:1152
	ds_load_u8 v66, v20 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v66, v50, 0xc0c0004
	ds_load_u8 v66, v20 offset:1408
	ds_load_u8 v67, v20 offset:1280
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v66, v67, v66, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v50, v66, 16, v50
	v_wmma_i32_16x16x16_iu4 v[9:16], v[50:51], v[52:53], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v50, v20 offset:2688
	ds_load_u8 v51, v20 offset:2560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:2944
	ds_load_u8 v52, v20 offset:2816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:2176
	ds_load_u8 v52, v20 offset:2048
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:2432
	ds_load_u8 v53, v20 offset:2304
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v50, v20 offset:3712
	ds_load_u8 v51, v20 offset:3584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:3968
	ds_load_u8 v52, v20 offset:3840
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:3200
	ds_load_u8 v52, v20 offset:3072
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:3456
	ds_load_u8 v53, v20 offset:3328
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v50, v52, 16, v50
	v_wmma_i32_16x16x16_iu4 v[9:16], v[50:51], v[56:57], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v50, v20 offset:4736
	ds_load_u8 v51, v20 offset:4608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:4992
	ds_load_u8 v52, v20 offset:4864
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:4224
	ds_load_u8 v52, v20 offset:4096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:4480
	ds_load_u8 v53, v20 offset:4352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v50, v52, 16, v50
	v_wmma_i32_16x16x16_iu4 v[9:16], v[50:51], v[58:59], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v50, v20 offset:5760
	ds_load_u8 v51, v20 offset:5632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:6016
	ds_load_u8 v52, v20 offset:5888
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:5248
	ds_load_u8 v52, v20 offset:5120
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:5504
	ds_load_u8 v53, v20 offset:5376
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v50, v52, 16, v50
	v_wmma_i32_16x16x16_iu4 v[9:16], v[50:51], v[60:61], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v50, v20 offset:6784
	ds_load_u8 v51, v20 offset:6656
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:7040
	ds_load_u8 v52, v20 offset:6912
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:6272
	ds_load_u8 v52, v20 offset:6144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:6528
	ds_load_u8 v53, v20 offset:6400
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v50, v52, 16, v50
	v_wmma_i32_16x16x16_iu4 v[9:16], v[50:51], v[62:63], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v50, v20 offset:7808
	ds_load_u8 v51, v20 offset:7680
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v20 offset:8064
	ds_load_u8 v52, v20 offset:7936
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v20 offset:7296
	ds_load_u8 v52, v20 offset:7168
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v20 offset:7552
	ds_load_u8 v53, v20 offset:7424
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v28, v68 offset:8192
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	s_waitcnt vmcnt(0)
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	ds_load_b64 v[46:47], v30 offset:8192
	ds_load_b64 v[48:49], v31 offset:8192
	ds_load_b64 v[50:51], v32 offset:8192
	ds_load_b64 v[52:53], v33 offset:8192
	...
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	ds_load_u8 v62, v20 offset:640
	ds_load_u8 v63, v20 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	ds_load_u8 v63, v20 offset:896
	ds_load_u8 v64, v20 offset:768
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v63, v64, v63, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v63, v63, 16, v62
	ds_load_u8 v62, v20 offset:128
	ds_load_u8 v64, v20
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v64, v62, 0xc0c0004
	ds_load_u8 v64, v20 offset:384
	ds_load_u8 v65, v20 offset:256
	s_waitcnt lgkmcnt(0)
	...
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v11, v45, v11 :: v_dual_lshlrev_b32 v48, 16, v48
	s_waitcnt vmcnt(5)
	v_dual_mul_f32 v14, v45, v14 :: v_dual_lshlrev_b32 v49, 16, v49
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v13, v45, v13 :: v_dual_lshlrev_b32 v50, 16, v50
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v16, v45, v16 :: v_dual_lshlrev_b32 v51, 16, v51
	s_waitcnt vmcnt(2)
	v_dual_mul_f32 v15, v45, v15 :: v_dual_lshlrev_b32 v52, 16, v52
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	s_waitcnt vmcnt(0)
	v_dual_fmac_f32 v43, v11, v49 :: v_dual_lshlrev_b32 v46, 16, v46
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v10, v45, v10 :: v_dual_lshlrev_b32 v53, 16, v53
	v_mul_f32_e32 v12, v45, v12
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v41, v13, v51 :: v_dual_fmac_f32 v38, v16, v46
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 69
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 32
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     34
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc256_relu2_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
