	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[4:5], null, s26, v2, v[252:253]
...
.Ltmp21:
	...
	v_add3_u32 v1, v1, v252, s12
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v10, s27, v5
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	v_or_b32_e32 v13, s36, v252
	.loc	1 406 30                        ; generate_amdgcn.py:406:30
...
.Ltmp23:
	...
	v_add3_u32 v102, v3, v252, 0x80
	v_mul_lo_u32 v5, s26, v5
	v_mul_lo_u32 v6, s26, v6
	v_add3_u32 v106, v2, v252, 0x80
	v_xor_b32_e32 v99, 16, v95
	v_xor_b32_e32 v100, 32, v95
	v_add3_u32 v105, v1, v252, 0x80
	v_xor_b32_e32 v101, 48, v95
	v_or_b32_e32 v107, 0x80, v252
	v_add3_u32 v103, v5, v252, 0x80
	v_add3_u32 v104, v6, v252, 0x80
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v231, 0 :: v_dual_mov_b32 v120, 0
	v_dual_mov_b32 v119, 0 :: v_dual_mov_b32 v122, 0
	v_dual_mov_b32 v121, 0 :: v_dual_mov_b32 v124, 0
	v_dual_mov_b32 v123, 0 :: v_dual_mov_b32 v250, 0
	...
	v_dual_mov_b32 v115, 0 :: v_dual_mov_b32 v228, 0
	v_dual_mov_b32 v125, 0 :: v_dual_mov_b32 v130, 0
	v_dual_mov_b32 v127, 0 :: v_dual_mov_b32 v132, 0
	v_dual_mov_b32 v233, 0 :: v_dual_mov_b32 v134, 0
	...
	v_dual_mov_b32 v137, 0 :: v_dual_mov_b32 v110, 0
	v_dual_mov_b32 v167, 0 :: v_dual_mov_b32 v218, 0
	v_dual_mov_b32 v139, 0 :: v_dual_mov_b32 v112, 0
	v_dual_mov_b32 v107, 0 :: v_dual_mov_b32 v114, 0
	v_dual_mov_b32 v109, 0 :: v_dual_mov_b32 v128, 0
	v_dual_mov_b32 v111, 0 :: v_dual_mov_b32 v142, 0
	v_dual_mov_b32 v185, 0 :: v_dual_mov_b32 v144, 0
...
; %bb.9:
	...
	v_cvt_f32_i32_e32 v250, v126
	v_cvt_f32_i32_e32 v251, v127
	v_cvt_f32_i32_e32 v156, v128
...
.LBB0_10:
	...
	buffer_load_u16 v126, v4, s[8:11], 0 offen
	buffer_load_u16 v18, v5, s[8:11], 0 offen
	...
	v_dual_mov_b32 v151, 0 :: v_dual_mov_b32 v226, 0
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_store_b32 v153, v1 offset:40960
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.11:
	...
	v_dual_mov_b32 v149, v133 :: v_dual_add_nc_u32 v166, s45, v20
	.loc	1 406 22 is_stmt 1              ; generate_amdgcn.py:406:22
	v_add_nc_u32_e32 v19, s45, v19
	v_dual_mov_b32 v133, v123 :: v_dual_add_nc_u32 v20, s45, v230
	v_dual_mov_b32 v123, v243 :: v_dual_add_nc_u32 v96, s44, v229
	v_dual_mov_b32 v150, v134 :: v_dual_add_nc_u32 v165, s45, v21
	s_clause 0x2                            ; 12-byte Folded Spill
	scratch_store_b32 off, v246, off offset:12
	scratch_store_b32 off, v247, off offset:8
	scratch_store_b32 off, v158, off offset:56
	v_mov_b32_e32 v134, v124
	ds_load_b128 v[243:246], v19 offset:8192
	v_dual_mov_b32 v124, v248 :: v_dual_mov_b32 v141, v125
	v_dual_mov_b32 v125, v249 :: v_dual_mov_b32 v152, v250
	ds_load_b128 v[247:250], v19
	v_mov_b32_e32 v138, v156
	s_waitcnt vmcnt(2)
	v_mov_b16_e64 v216.l, v126.l
	v_dual_mov_b32 v126, v114 :: v_dual_mov_b32 v117, v112
	v_dual_mov_b32 v118, v113 :: v_dual_mov_b32 v113, v251
	v_dual_mov_b32 v116, v137 :: v_dual_mov_b32 v155, v140
	v_dual_mov_b32 v137, v252 :: v_dual_mov_b32 v114, v139
	...
	scratch_store_b32 off, v168, off offset:28
	scratch_store_b32 off, v186, off offset:32
	scratch_store_b32 off, v232, off offset:40
	scratch_store_b32 off, v17, off offset:60
	scratch_store_b32 off, v228, off offset:20
	scratch_store_b32 off, v160, off offset:48
	scratch_store_b32 off, v236, off offset:52
	scratch_store_b32 off, v233, off offset:24
	scratch_store_b32 off, v231, off offset:36
	scratch_store_b32 off, v237, off offset:44
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	s_mov_b32 s13, s12
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	...
	v_dual_mov_b32 v135, v159 :: v_dual_mov_b32 v146, v130
	v_dual_mov_b32 v159, v119 :: v_dual_mov_b32 v130, v120
	v_dual_mov_b32 v119, v239 :: v_dual_mov_b32 v120, v240
	v_dual_mov_b32 v147, v131 :: v_dual_mov_b32 v148, v132
	v_mov_b32_e32 v131, v121
	v_dual_mov_b32 v121, v241 :: v_dual_mov_b32 v132, v122
	...
	scratch_load_b32 v168, off, off offset:28
	scratch_load_b32 v218, off, off offset:16
	v_mov_b32_e32 v111, v160
	v_dual_mov_b32 v243, v123 :: v_dual_and_b32 v244, 15, v0
	v_dual_mov_b32 v123, v133 :: v_dual_mov_b32 v250, v152
	...
	scratch_load_b32 v236, off, off offset:52
	scratch_load_b32 v160, off, off offset:48
	scratch_load_b32 v228, off, off offset:20
	v_cvt_f32_i32_e32 v213, v237
	s_clause 0x2                            ; 12-byte Folded Reload
	scratch_load_b32 v237, off, off offset:44
	scratch_load_b32 v231, off, off offset:36
	scratch_load_b32 v233, off, off offset:24
	v_dual_mov_b32 v110, v158 :: v_dual_mov_b32 v109, v207
	s_clause 0x2                            ; 12-byte Folded Reload
	scratch_load_b32 v246, off, off offset:12
	scratch_load_b32 v158, off, off offset:56
	scratch_load_b32 v247, off, off offset:8
	v_mov_b16_e32 v93.l, v112.l
	v_dual_mov_b32 v133, v149 :: v_dual_mov_b32 v248, v124
	v_dual_mov_b32 v249, v125 :: v_dual_mov_b32 v124, v134
	v_dual_mov_b32 v125, v141 :: v_dual_mov_b32 v134, v150
	v_dual_mov_b32 v254, v140 :: v_dual_mov_b32 v253, v139
	v_dual_mov_b32 v140, v155 :: v_dual_mov_b32 v139, v114
	v_dual_mov_b32 v252, v137 :: v_dual_mov_b32 v137, v116
	v_dual_mov_b32 v251, v113 :: v_dual_mov_b32 v114, v126
	v_dual_mov_b32 v112, v117 :: v_dual_mov_b32 v113, v118
	v_mov_b16_e64 v126.l, v216.l
...
.Ltmp25:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v36, v36, v145, v84
	v_fma_f32 v94, v94, v128, v88
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_mov_b32 s0, 0x76543210
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v84, v84, v36, s3
...
.Ltmp27:
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v37, v37, v144, v91
	v_fma_f32 v43, v43, v142, v90
	v_fma_f32 v93, v93, v129, v89
	v_fma_f32 v95, v95, v114, v87
	v_fma_f32 v96, v96, v113, v86
	v_fma_f32 v97, v97, v112, v85
	v_fma_f32 v98, v98, v143, v83
	v_fma_f32 v99, v99, v218, v82
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_mov_b16_e32 v42.h, v126.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v91, v91, v37, s3
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v36, v106, v140, v75
	v_fma_f32 v37, v107, v139, v74
	v_fma_f32 v43, v108, v167, v73
	v_fma_f32 v76, v109, v137, v72
	v_fma_f32 v77, v110, v136, v71
	...
	ds_load_b128 v[13:16], v157 offset:41488
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v139, v70, v79, s3
	v_cndmask_b32_e64 v140, v68, v81, s3
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v135, v75, v36, s3
	v_cndmask_b32_e64 v136, v74, v37, s3
	v_cndmask_b32_e64 v36, v71, v77, s3
	v_cndmask_b32_e64 v37, v69, v80, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v69, v127, v123, v51
	v_fma_f32 v71, v129, v121, v49
	v_fma_f32 v74, v132, v231, v46
	v_fma_f32 v75, v133, v234, v45
	v_fma_f32 v18, v134, v227, v44
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v8, v8, v42
	v_mul_f32_e32 v7, v7, v42
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v81, v9, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v65, v110, v251, v55
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v109, v13, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v70, v128, v122, v50
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_mul_f32_e32 v107, v11, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v68, v126, v124, v52
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v111, v15, v21
	v_mul_f32_e32 v126, v15, v22
	...
	v_cndmask_b32_e64 v71, v45, v75, s3
	v_cndmask_b32_e64 v18, v44, v18, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v45, v7, v232, v29
	v_fma_f32 v49, v5, v17, v27
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v62, v11, v19
	v_mul_f32_e32 v66, v13, v19
	v_mul_f32_e32 v122, v11, v22
	v_dual_mul_f32 v124, v13, v22 :: v_dual_mul_f32 v11, v11, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v72, v130, v120, v48
	v_fma_f32 v73, v131, v119, v47
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v30, v30, v44, s3
	v_cndmask_b32_e64 v23, v23, v57, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v63, v12, v19
	v_mul_f32_e32 v108, v12, v21
	v_mul_f32_e32 v123, v12, v22
	v_mul_f32_e32 v12, v12, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v67, v125, v159, v53
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_mul_f32_e32 v106, v10, v21
	v_mul_f32_e32 v110, v14, v21
	v_mul_f32_e32 v120, v9, v22
	v_mul_f32_e32 v121, v10, v22
	v_mul_f32_e32 v125, v14, v22
	v_mul_f32_e32 v9, v9, v35
	v_mul_f32_e32 v10, v10, v35
	v_mul_f32_e32 v14, v14, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v130, v81, v152, v52
	v_fma_f32 v106, v106, v187, v53
	v_fma_f32 v107, v107, v188, v64
	v_fma_f32 v108, v108, v189, v58
	v_fma_f32 v109, v109, v190, v56
	v_fma_f32 v110, v110, v191, v59
	v_fma_f32 v111, v111, v192, v105
	v_fma_f32 v121, v121, v203, v37
	v_fma_f32 v122, v122, v204, v139
	v_fma_f32 v123, v123, v205, v36
	v_fma_f32 v124, v124, v206, v138
	v_fma_f32 v125, v125, v208, v137
	v_fma_f32 v126, v126, v209, v136
	v_fma_f32 v120, v120, v202, v140
	v_fma_f32 v10, v10, v220, v86
	v_fma_f32 v13, v13, v223, v89
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v64, v64, v107, s2
	v_cndmask_b32_e64 v59, v59, v110, s2
	v_cndmask_b32_e64 v37, v37, v121, s2
	v_cndmask_b32_e64 v36, v36, v123, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v9, v9, v219, v85
	v_fma_f32 v11, v11, v221, v87
	v_fma_f32 v12, v12, v222, v88
	v_fma_f32 v131, v14, v224, v90
	v_fma_f32 v132, v15, v225, v91
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[5:8], v157 offset:40976
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v14, v87, v11, s2
	v_cndmask_b32_e64 v11, v90, v131, s2
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v49, v5, v19
	v_mul_f32_e32 v50, v6, v19
	v_mul_f32_e32 v54, v7, v19
	v_mul_f32_e32 v76, v5, v21
	v_mul_f32_e32 v77, v6, v21
	v_mul_f32_e32 v79, v7, v21
	v_mul_f32_e32 v80, v8, v21
	v_mul_f32_e32 v116, v5, v22
	v_mul_f32_e32 v117, v6, v22
	v_mul_f32_e32 v118, v7, v22
	v_mul_f32_e32 v119, v8, v22
	v_mul_f32_e32 v5, v5, v35
	v_mul_f32_e32 v6, v6, v35
	v_mul_f32_e32 v7, v7, v35
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v129, v80, v184, v51
	v_fma_f32 v128, v79, v183, v65
	v_fma_f32 v5, v5, v215, v94
	v_fma_f32 v6, v6, v216, v93
	v_fma_f32 v127, v77, v182, v68
	v_fma_f32 v92, v76, v181, v48
	v_fma_f32 v116, v116, v198, v43
	v_fma_f32 v117, v117, v199, v100
	v_fma_f32 v118, v118, v200, v99
	v_fma_f32 v119, v119, v201, v98
	v_fma_f32 v7, v7, v217, v82
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v77, v48, v92, s2
	v_cndmask_b32_e64 v43, v43, v116, s2
	s_delay_alu instid0(VALU_DEP_3)
	v_cndmask_b32_e64 v15, v82, v7, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	s_waitcnt vmcnt(0)
	v_fma_f32 v55, v2, v3, v24
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	ds_load_b128 v[1:4], v157 offset:40960
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_mul_f32 v19, v16, v19 :: v_dual_mul_f32 v72, v1, v21
	v_mul_f32_e32 v73, v2, v21
	v_mul_f32_e32 v74, v3, v21
	v_mul_f32_e32 v75, v4, v21
	v_dual_mul_f32 v21, v16, v21 :: v_dual_mul_f32 v112, v1, v22
	v_mul_f32_e32 v113, v2, v22
	v_mul_f32_e32 v114, v3, v22
	v_mul_f32_e32 v115, v4, v22
...
.Ltmp31:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v73, v74, v179, v69
	v_fma_f32 v74, v75, v180, v47
	v_fma_f32 v113, v113, v195, v61
.Ltmp32:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp33:
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v112, v112, v194, v103
	v_fma_f32 v115, v115, v197, v101
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v75, v69, v73, s2
	v_cndmask_b32_e64 v76, v47, v74, s2
	v_cndmask_b32_e64 v74, v68, v127, s2
	v_cndmask_b32_e64 v73, v51, v129, s2
	v_cndmask_b32_e64 v68, v52, v130, s2
	v_cndmask_b32_e64 v51, v103, v112, s2
	v_cndmask_b32_e64 v52, v61, v113, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v21, v21, v193, v104
	v_fma_f32 v114, v114, v196, v102
	v_fma_f32 v22, v22, v210, v135
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v72, v65, v128, s2
	v_cndmask_b32_e64 v69, v53, v106, s2
	v_cndmask_b32_e64 v65, v58, v108, s2
	v_cndmask_b32_e64 v58, v56, v109, s2
	v_cndmask_b32_e64 v56, v105, v111, s2
	v_cndmask_b32_e64 v48, v101, v115, s2
	v_cndmask_b32_e64 v44, v100, v117, s2
	v_cndmask_b32_e64 v35, v139, v122, s2
	v_cndmask_b32_e64 v34, v138, v124, s2
	v_cndmask_b32_e64 v33, v137, v125, s2
	v_cndmask_b32_e64 v31, v136, v126, s2
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp35:
	...
	v_cndmask_b32_e64 v47, v102, v114, s2
	v_cndmask_b32_e64 v39, v99, v118, s2
	v_cndmask_b32_e64 v40, v98, v119, s2
	v_cndmask_b32_e64 v38, v140, v120, s2
...
.Ltmp39:
	...
	v_cndmask_b32_e64 v12, v91, v132, s2
.Ltmp40:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp41:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v13, v84, v133, s2
.Ltmp42:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp51:
	...
	v_and_or_b32 v22, 0x680, v247, v4
.Ltmp52:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
...
.Ltmp66:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v20, v20, v20 :: v_dual_mov_b32 v21, v1
...
.Ltmp68:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v3, v3, v22 :: v_dual_mov_b32 v78, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.Ltmp72:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v18, v22, v22 :: v_dual_mov_b32 v61, v19
.Ltmp73:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp76:
	...
	v_dual_max_f32 v20, v20, v1 :: v_dual_mov_b32 v61, v3
.Ltmp77:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp78:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ] ]
	v_dual_max_f32 v21, v19, v21 :: v_dual_add_nc_u32 v2, 0, v252
.Ltmp79:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp84:
	...
	v_max_f32_e32 v17, 0x2b8cbccc, v8
	...
	v_dual_mul_f32 v83, v84, v5 :: v_dual_and_b32 v82, 0xffff0000, v3
	s_mov_b32 vcc_lo, s0
	...
	.loc	1 78 29                         ; generate_amdgcn.py:78:29 @[ generate_amdgcn.py:446:9 ]
	v_div_scale_f32 v92, s2, v79, v82, v79
	...
	v_mul_f32_e32 v42, v84, v22
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fma_f32 v17, -v19, v83, 1.0
	v_dual_fmac_f32 v86, v20, v86 :: v_dual_and_b32 v5, 1, v61
	...
	v_dual_fmac_f32 v83, v17, v83 :: v_dual_mul_f32 v42, v90, v86
	s_mov_b32 vcc_lo, s0
	v_fmac_f32_e32 v18, v20, v18
	v_div_fixup_f32 v20, v21, v82, v81
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_fma_f32 v21, -v85, v42, v90
	v_mul_f32_e32 v89, v88, v83
	v_mul_f32_e32 v81, v92, v18
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v42, v21, v86
	...
	v_div_scale_f32 v21, s2, v54, v82, v54
	v_fma_f32 v91, -v86, v92, 1.0
	v_fma_f32 v19, -v85, v80, v19
	v_rcp_f32_e32 v85, v88
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v89, v18, v81 :: v_dual_mul_f32 v18, v21, v79
...
.Ltmp86:
	...
	v_div_fmas_f32 v18, v18, v87, v21
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v90, v81, v80 :: v_dual_mul_f32 v81, v84, v21
...
.Ltmp88:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.private_seg_size, 68
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk
    .private_segment_fixed_size: 68
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_maskk.kd
