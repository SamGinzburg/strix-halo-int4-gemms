	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	v_and_b32_e32 v21, 56, v10
	v_lshlrev_b32_e32 v22, 3, v0
	v_and_b32_e32 v19, 56, v19
	v_and_or_b32 v14, 0x438, v10, v11
	v_lshrrev_b32_e32 v13, 2, v17
	v_or3_b32 v32, v20, v21, v11
	...
	v_and_b32_e32 v20, 0x60, v11
	v_xor_b32_e32 v13, v10, v13
	v_and_b32_e32 v19, 0x2040, v19
.Ltmp11:
...
.Ltmp12:
	...
	v_and_or_b32 v10, 0x31c, v10, v20
...
.Ltmp20:
	...
	v_or3_b32 v0, v0, v10, v5
	v_rcp_iflag_f32_e32 v10, s0
	v_xor_b32_e32 v25, 16, v14
	v_xor_b32_e32 v26, 24, v14
	v_xor_b32_e32 v27, 32, v14
	v_xor_b32_e32 v28, 40, v14
	v_xor_b32_e32 v29, 48, v14
	v_xor_b32_e32 v30, 56, v14
	v_xor_b32_e32 v33, 8, v32
	v_xor_b32_e32 v34, 16, v32
	v_xor_b32_e32 v35, 24, v32
	v_readfirstlane_b32 s0, v10
	.loc	1 241 5                         ; generate_amdgcn.py:241:5
	v_mad_u64_u32 v[10:11], null, s29, v7, v[1:2]
	v_or_b32_e32 v1, s33, v8
	v_xor_b32_e32 v36, 32, v32
	s_delay_alu instid0(VALU_DEP_4)
	s_mul_f32 s0, s0, 0x4f7ffffe
	v_xor_b32_e32 v37, 40, v32
	v_xor_b32_e32 v38, 48, v32
	v_xor_b32_e32 v39, 56, v32
	v_xor_b32_e32 v41, 4, v3
	v_xor_b32_e32 v6, 8, v3
	v_xor_b32_e32 v43, 12, v3
	v_xor_b32_e32 v44, 16, v3
	v_xor_b32_e32 v5, 20, v3
	v_xor_b32_e32 v46, 24, v3
	v_xor_b32_e32 v47, 28, v3
	v_xor_b32_e32 v49, 0x1010, v0
	v_xor_b32_e32 v50, 0x2040, v0
	v_xor_b32_e32 v51, 0x3050, v0
	...
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v51, 0, v51
...
.LBB0_2:                                ; %._crit_edge
	...
	ds_store_b32 v43, v55
	ds_store_b32 v44, v54
	ds_store_b32 v45, v53
	ds_store_b32 v46, v52
	ds_store_b32 v47, v14
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_b32 v[1:2], v48 offset1:32
	ds_load_2addr_b32 v[3:4], v49 offset1:32
	ds_load_2addr_b32 v[5:6], v50 offset1:32
	ds_load_2addr_b32 v[11:12], v51 offset1:32
...
; %bb.4:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_3 Depth=1
	v_lshl_or_b32 v1, s10, 8, v17
	s_lshl_b32 s10, s10, 7
	s_lshl_b32 s11, s4, 8
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v2, s46, v21
	v_or_b32_e32 v3, s10, v18
	v_subrev_nc_u32_e32 v59, s11, v1
	v_or_b32_e32 v1, s10, v16
	s_lshl_b32 s4, s4, 7
	v_dual_mov_b32 v55, 0 :: v_dual_add_nc_u32 v4, s46, v15
	v_mul_lo_u32 v60, s44, v2
	v_subrev_nc_u32_e32 v2, s4, v3
	v_subrev_nc_u32_e32 v1, s4, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mad_u64_u32 v[11:12], null, s34, v4, v[8:9]
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v53, 0
	v_mad_u64_u32 v[12:13], null, s34, v2, v[9:10]
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[13:14], null, s34, v1, v[9:10]
	v_mov_b32_e32 v58, 0
	v_mov_b32_e32 v54, 0
	v_mov_b32_e32 v52, 0
	v_mov_b32_e32 v14, 0
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s47, v19
	.loc	1 291 30                        ; generate_amdgcn.py:291:30
	v_add_nc_u32_e32 v2, s47, v11
	.loc	1 294 38                        ; generate_amdgcn.py:294:38
	v_add_nc_u32_e32 v3, s47, v13
	.loc	1 294 30 is_stmt 0              ; generate_amdgcn.py:294:30
	v_add_nc_u32_e32 v4, s47, v12
	.loc	1 285 31 is_stmt 1              ; generate_amdgcn.py:285:31
	v_cmp_gt_i32_e64 s4, s34, v1
	.loc	1 285 30 is_stmt 0              ; generate_amdgcn.py:285:30
	s_and_b32 vcc_lo, vcc_lo, s0
	.loc	1 291 30 is_stmt 1              ; generate_amdgcn.py:291:30
	v_dual_cndmask_b32 v1, 0x80000000, v2 :: v_dual_add_nc_u32 v6, v20, v59
	...
	buffer_load_b64 v[3:4], v3, s[20:23], 0 offen
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[69:70], v23
	ds_load_b64 v[71:72], v24
	ds_load_b64 v[73:74], v25
	ds_load_b64 v[75:76], v26
	ds_load_b64 v[77:78], v27
	ds_load_b64 v[79:80], v28
	ds_load_b64 v[81:82], v29
	ds_load_b64 v[83:84], v30
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	...
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x7
	buffer_load_u16 v86, v6, s[24:27], 0 offen
	buffer_load_u16 v87, v6, s[24:27], 0 offen offset:4
	buffer_load_u16 v88, v6, s[24:27], 0 offen offset:8
	buffer_load_u16 v89, v6, s[24:27], 0 offen offset:12
	buffer_load_u16 v90, v6, s[24:27], 0 offen offset:16
	buffer_load_u16 v91, v6, s[24:27], 0 offen offset:20
	buffer_load_u16 v92, v6, s[24:27], 0 offen offset:24
	buffer_load_u16 v93, v6, s[24:27], 0 offen offset:28
	...
	v_mov_b32_e32 v3, v0
	v_mov_b32_e32 v4, v0
	v_dual_mov_b32 v5, v0 :: v_dual_add_nc_u32 v60, 2, v60
	v_dual_mov_b32 v6, v0 :: v_dual_add_nc_u32 v59, s43, v59
	v_mov_b32_e32 v68, v7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v66, v5 :: v_dual_mov_b32 v65, v4
	v_dual_mov_b32 v64, v3 :: v_dual_mov_b32 v67, v6
	...
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[1:2], v[69:70], v[61:68] neg_lo:[1,1,0]
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	ds_load_b64 v[1:2], v35
	ds_load_b64 v[69:70], v36
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[3:4], v[71:72], v[61:68] neg_lo:[1,1,0]
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	ds_load_b64 v[3:4], v37
	ds_load_b64 v[71:72], v38
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[5:6], v[73:74], v[61:68] neg_lo:[1,1,0]
	.loc	1 294 30                        ; generate_amdgcn.py:294:30
	ds_load_b64 v[5:6], v39
	.loc	1 297 31                        ; generate_amdgcn.py:297:31
	s_waitcnt lgkmcnt(4)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[1:2], v[75:76], v[61:68] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(3)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[69:70], v[77:78], v[61:68] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[3:4], v[79:80], v[61:68] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[71:72], v[81:82], v[61:68] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[61:68], v[5:6], v[83:84], v[61:68] neg_lo:[1,1,0]
	...
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v1, v1, v62 :: v_dual_lshlrev_b32 v66, 16, v89
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(2)
	...
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v4, v4, v62 :: v_dual_lshlrev_b32 v69, 16, v92
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v3, v3, v62 :: v_dual_lshlrev_b32 v70, 16, v93
	v_mul_f32_e32 v6, v6, v62
	v_dual_mul_f32 v61, v61, v62 :: v_dual_fmac_f32 v58, v2, v64
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v56, v1, v63 :: v_dual_lshlrev_b32 v67, 16, v90
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_mul_f32_e32 v7, v7, v62
	v_mul_f32_e32 v5, v5, v62
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_fmac_f32_e32 v57, v3, v65
	v_fmac_f32_e32 v55, v4, v66
	v_dual_fmac_f32 v53, v6, v68 :: v_dual_fmac_f32 v14, v61, v70
	v_fmac_f32_e32 v52, v7, v69
	v_fmac_f32_e32 v54, v5, v67
...
.Ltmp21:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_vgpr, 94
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.numbered_sgpr, 49
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     51
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm32_bn128_bk128_gm4_w16_s1_weu2_sk2_evenk.kd
