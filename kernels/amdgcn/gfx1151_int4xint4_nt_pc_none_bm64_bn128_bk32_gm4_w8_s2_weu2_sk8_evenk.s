...
.Ltmp11:
	...
	v_dual_cndmask_b32 v1, 0x80000000, v47 :: v_dual_cndmask_b32 v2, 0x80000000, v46
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	s_mov_b32 s11, s7
...
.LBB0_3:                                ; %Flow244
	v_bfe_i32 v1, v0, 3, 1
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v37, 0x80, v0
	v_dual_mov_b32 v9, 0 :: v_dual_lshlrev_b32 v38, 4, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v11, 0 :: v_dual_and_b32 v40, 0x88, v1
	v_dual_mov_b32 v12, 0 :: v_dual_lshlrev_b32 v41, 1, v37
...
.Ltmp15:
	...
	v_or3_b32 v2, v40, v41, v1
	v_or3_b32 v1, v1, v43, v40
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	...
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	ds_load_2addr_stride64_b64 v[51:54], v42 offset0:4 offset1:5
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	...
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	v_wmma_i32_16x16x16_iu4 v[9:16], v[55:56], v[51:52], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[17:24], v[57:58], v[51:52], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[25:32], v[55:56], v[53:54], v[1:8] neg_lo:[1,1,0]
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	ds_load_2addr_stride64_b64 v[49:52], v42 offset0:4 offset1:5
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
...
.LBB0_12:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	v_or3_b32 v43, v42, v34, v40
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_or3_b32 v34, v40, v41, v34
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	v_add_nc_u32_e32 v40, 0, v43
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_add_nc_u32_e32 v41, 0, v34
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	v_xad_u32 v51, v43, 8, 0
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	v_xad_u32 v34, v34, 8, 0
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	ds_load_2addr_stride64_b64 v[43:46], v40 offset1:2
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	ds_load_2addr_stride64_b64 v[47:50], v41 offset0:4 offset1:5
	.loc	1 115 22                        ; generate_amdgcn.py:115:22
	ds_load_2addr_stride64_b64 v[51:54], v51 offset1:2
	.loc	1 113 22                        ; generate_amdgcn.py:113:22
	ds_load_2addr_stride64_b64 v[55:58], v34 offset0:4 offset1:5
	.loc	1 118 23                        ; generate_amdgcn.py:118:23
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[51:52], v[57:58], v[25:32] neg_lo:[1,1,0]
...
.LBB0_13:
	...
	v_or_b32_e32 v40, 4, v33
	v_or_b32_e32 v41, 8, v33
	...
	v_dual_mul_f32 v81, v1, v2 :: v_dual_mul_f32 v50, v0, v20
	v_dual_mul_f32 v52, v0, v24 :: v_dual_mul_f32 v83, v1, v5
	v_dual_mul_f32 v87, v1, v20 :: v_dual_lshlrev_b32 v26, 16, v51
	v_dual_mul_f32 v89, v1, v24 :: v_dual_lshlrev_b32 v4, 16, v41
	...
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_mul_f32_e32 v45, v0, v4
	v_mul_f32_e32 v80, v0, v41
	v_mul_f32_e32 v56, v0, v39
	v_dual_mul_f32 v39, v1, v39 :: v_dual_mul_f32 v54, v0, v28
	v_mul_f32_e32 v48, v0, v7
	v_mul_f32_e32 v44, v0, v3
	v_mul_f32_e32 v3, v1, v3
	v_mul_f32_e32 v82, v1, v4
	v_mul_f32_e32 v85, v1, v7
	v_mul_f32_e32 v51, v0, v22
	v_mul_f32_e32 v43, v0, v2
	v_mul_f32_e32 v91, v1, v28
	v_mul_f32_e32 v55, v0, v30
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_dual_mul_f32 v3, v3, v61 :: v_dual_mul_f32 v84, v1, v6
	v_dual_mul_f32 v5, v82, v27 :: v_dual_mul_f32 v88, v1, v22
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_dual_mul_f32 v47, v0, v6 :: v_dual_mul_f32 v86, v1, v8
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_mul_f32_e32 v7, v83, v62
	.loc	1 130 16                        ; generate_amdgcn.py:130:16
	v_mul_f32_e32 v90, v1, v26
	v_mul_f32_e32 v41, v1, v41
	v_mul_f32_e32 v57, v0, v40
	v_dual_mul_f32 v49, v0, v8 :: v_dual_mul_f32 v92, v1, v30
	.loc	1 130 9                         ; generate_amdgcn.py:130:9
	v_mul_f32_e32 v0, v43, v9
	v_mul_f32_e32 v2, v44, v10
	v_dual_mul_f32 v10, v48, v14 :: v_dual_mul_f32 v27, v39, v69
	v_dual_mul_f32 v9, v84, v29 :: v_dual_mul_f32 v40, v1, v40
	v_mul_f32_e32 v14, v50, v16
	v_mul_f32_e32 v16, v51, v17
	v_mul_f32_e32 v1, v81, v25
	v_mul_f32_e32 v17, v88, v65
	v_mul_f32_e32 v8, v47, v13
	v_mul_f32_e32 v20, v53, v19
	v_dual_mul_f32 v19, v89, v36 :: v_dual_mul_f32 v24, v55, v21
	v_mul_f32_e32 v13, v86, v31
	v_dual_mul_f32 v4, v45, v11 :: v_dual_mul_f32 v21, v90, v42
	v_mul_f32_e32 v6, v46, v12
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_vgpr, 93
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm64_bn128_bk32_gm4_w8_s2_weu2_sk8_evenk.numbered_sgpr, 28
