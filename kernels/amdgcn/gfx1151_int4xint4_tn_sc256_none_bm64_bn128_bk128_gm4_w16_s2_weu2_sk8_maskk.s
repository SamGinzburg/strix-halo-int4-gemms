...
.LBB0_5:
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	buffer_load_u16 v25, v19, s[20:23], 0 offen
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v6, v6, v24 :: v_dual_lshlrev_b32 v25, 16, v25
	...
	v_dual_mul_f32 v12, v12, v23 :: v_dual_add_nc_u32 v19, 12, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v16, 0x80000000, v21, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v14, v14, v23 :: v_dual_add_nc_u32 v21, 16, v17
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v18, 0x80000000, v22, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v11, v11, v23 :: v_dual_add_nc_u32 v22, 20, v17
	v_dual_mul_f32 v13, v13, v23 :: v_dual_add_nc_u32 v26, 24, v17
	v_dual_mul_f32 v20, v20, v23 :: v_dual_add_nc_u32 v17, 28, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	buffer_load_u16 v29, v19, s[20:23], 0 offen
	...
	v_cndmask_b32_e64 v12, v50, v28, s2
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.num_vgpr, 81
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm4_w16_s2_weu2_sk8_maskk.numbered_sgpr, 43
