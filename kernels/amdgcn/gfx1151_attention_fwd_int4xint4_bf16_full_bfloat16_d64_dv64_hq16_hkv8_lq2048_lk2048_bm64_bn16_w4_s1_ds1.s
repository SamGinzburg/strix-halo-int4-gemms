...
.Ltmp0:
	...
	v_dual_mov_b32 v13, v24 :: v_dual_and_b32 v40, 0x760032, v64
	...
	v_lshl_or_b32 v38, v43, 4, v43
	v_lshl_or_b32 v40, v44, 4, v44
	v_and_b32_e32 v80, 0x7060302, v37
	.loc	1 774 26                        ; attention.py:774:26
	v_cmp_eq_u32_e64 s0, 0, v55
	.loc	1 760 21                        ; attention.py:760:21
	v_lshrrev_b32_e32 v50, 3, v0
	v_lshrrev_b32_e32 v52, 4, v0
	v_dual_mov_b32 v0, v24 :: v_dual_and_b32 v81, 0x7050301, v38
	...
	v_mul_f32_e32 v83, s8, v45
	.loc	1 774 26                        ; attention.py:774:26
	v_cndmask_b32_e64 v45, v39, v33, s0
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mov_b32 v33, v32 :: v_dual_add_nc_u32 v88, s33, v69
	...
	s_lshr_b32 s6, s33, 1
	.loc	1 913 33                        ; attention.py:913:33
	v_dual_mov_b32 v35, v32 :: v_dual_add_nc_u32 v40, s6, v63
	...
	v_add_lshl_u32 v102, s33, v70, 1
	v_add_lshl_u32 v103, s33, v73, 1
	v_add_lshl_u32 v105, s33, v74, 1
	.loc	1 908 32                        ; attention.py:908:32
	buffer_load_b32 v34, v34, s[40:43], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 923 37                        ; attention.py:923:37
	v_add_lshl_u32 v110, s33, v75, 1
	v_add_lshl_u32 v111, s33, v76, 1
	v_add_lshl_u32 v112, s33, v77, 1
	v_add_lshl_u32 v113, s33, v78, 1
	v_add_lshl_u32 v114, s33, v79, 1
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b64 v[37:38], v60
	ds_load_b64 v[96:97], v65
	ds_load_b64 v[98:99], v66
	ds_load_b64 v[100:101], v67
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	ds_bpermute_b32 v106, v57, v106
	.loc	1 966 34                        ; attention.py:966:34
	v_cmp_neq_f32_e64 s5, 0xff800000, v38
	.loc	1 965 35                        ; attention.py:965:35
	v_perm_b32 v38, v39, v37, v72
	...
	.loc	1 965 35 is_stmt 1              ; attention.py:965:35
	ds_bpermute_b32 v102, v56, v38
	ds_bpermute_b32 v103, v57, v37
	.loc	1 966 25                        ; attention.py:966:25
	...
	.loc	1 966 25 is_stmt 1              ; attention.py:966:25
	ds_bpermute_b32 v91, v56, v91
	ds_bpermute_b32 v38, v57, v38
	.loc	1 1017 30                       ; attention.py:1017:30
	...
	ds_store_2addr_b32 v61, v35, v88 offset1:8
	ds_store_2addr_b32 v61, v33, v34 offset0:16 offset1:24
	.loc	1 966 25                        ; attention.py:966:25
	s_waitcnt lgkmcnt(2)
