...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v28, v24 :: v_dual_add_nc_u32 v5, 0, v5
	...
	v_dual_mov_b32 v25, v24 :: v_dual_and_b32 v8, 0x78, v0
	v_dual_mov_b32 v27, v24 :: v_dual_lshlrev_b32 v16, 3, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v5, 0x1054, v5, s20
	...
	v_bfe_i32 v0, v0, 3, 1
	v_dual_mov_b32 v31, v24 :: v_dual_and_b32 v16, 48, v16
	v_cndmask_b32_e64 v6, 0x3276, v6, s20
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v30, v24 :: v_dual_and_b32 v5, 0x540054, v5
	v_xor_b32_e32 v3, v3, v8
	v_and_b32_e32 v0, 0x210, v0
	v_lshl_or_b32 v8, v2, 6, v16
	v_lshl_or_b32 v6, v6, 8, v6
	.loc	1 818 13                        ; attention.py:818:13
	s_add_i32 s3, s3, s1
	v_lshl_or_b32 v5, v5, 4, v5
	v_or_b32_e32 v4, s3, v4
	v_xor_b32_e32 v97, v8, v0
	v_or_b32_e32 v0, s3, v1
	v_dual_mov_b32 v29, v24 :: v_dual_and_b32 v6, 0x760076, v6
	v_and_b32_e32 v94, 0x5040504, v5
	v_mul_lo_u32 v1, s23, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_or_b32_e32 v5, 16, v0
	v_or_b32_e32 v93, v9, v7
	...
	.loc	1 818 13                        ; attention.py:818:13
	v_lshl_add_u32 v99, v1, 1, v9
	v_lshl_add_u32 v100, v5, 1, v9
	v_lshl_add_u32 v101, v0, 1, v9
	v_dual_mov_b32 v23, v24 :: v_dual_add_nc_u32 v102, 0, v7
	v_add_nc_u32_e32 v103, 0, v10
	v_add_nc_u32_e32 v104, 0, v11
	v_dual_mov_b32 v22, v24 :: v_dual_add_nc_u32 v105, 0, v12
	v_dual_mov_b32 v11, v24 :: v_dual_add_nc_u32 v106, 0, v13
	v_add_nc_u32_e32 v107, 0, v14
	v_dual_mov_b32 v13, v24 :: v_dual_add_nc_u32 v108, 0, v15
	v_dual_mov_b32 v10, v24 :: v_dual_add_nc_u32 v109, 0, v2
	v_dual_mov_b32 v15, v24 :: v_dual_add_nc_u32 v110, 0, v3
	v_dual_mov_b32 v12, v24 :: v_dual_add_nc_u32 v111, 0, v4
	v_dual_mov_b32 v1, v24 :: v_dual_add_nc_u32 v112, 0, v6
	v_dual_mov_b32 v14, v24 :: v_dual_add_nc_u32 v113, 0, v8
	v_dual_mov_b32 v3, v24 :: v_dual_add_nc_u32 v114, 0, v16
	v_dual_mov_b32 v0, v24 :: v_dual_add_nc_u32 v115, 0, v18
	v_dual_mov_b32 v5, v24 :: v_dual_add_nc_u32 v116, 0, v19
	v_dual_mov_b32 v2, v24 :: v_dual_add_nc_u32 v117, 0, v20
	v_mov_b32_e32 v16, v24
	v_mov_b32_e32 v18, v24
	v_lshl_add_u32 v98, v17, 1, v9
	v_mov_b32_e32 v17, v24
	v_mov_b32_e32 v19, v24
	v_mov_b32_e32 v20, v24
	v_mov_b32_e32 v8, v24
	v_mov_b32_e32 v9, v24
	v_dual_mov_b32 v4, v24 :: v_dual_mov_b32 v121, 0xff800000
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 864 30                        ; attention.py:864:30
	v_cmp_le_i32_e64 s6, v123, v92
	v_cmp_le_i32_e64 s8, v124, v92
	v_cmp_le_i32_e64 s9, v125, v92
	v_cmp_le_i32_e64 s10, v126, v92
	v_cmp_le_i32_e64 s15, v127, v92
	v_cmp_le_i32_e64 s13, v128, v92
	v_cmp_le_i32_e64 s17, v129, v92
...
.Ltmp23:
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v64.l, 0x7fff, v66.h, s5
	v_cndmask_b16 v66.h, 0x7fff, v67.h, s6
	...
	v_cndmask_b16 v66.l, 0x7fff, v68.h, s7
	v_cndmask_b16 v130.l, 0x7fff, v73.h, s13
	v_permlanex16_b32 v73, v65, s39, 0xfedcba98 op_sel:[1,0]
	v_cndmask_b16 v64.h, 0x7fff, v64.h, s1
	v_cndmask_b16 v68.h, 0x7fff, v67.h, s8
	v_and_b32_e32 v67, 1, v122
	v_mov_b16_e64 v122.l, v128.h
	v_cmp_o_f32_e64 s15, v74, v74
	v_add3_u32 v74, v74, v125, 0x7fff
	v_cndmask_b16 v68.l, 0x7fff, v70.h, s9
	v_cndmask_b16 v70.l, 0x7fff, v72.h, s11
	v_cndmask_b16 v132.l, 0x7fff, v75.h, s17
...
.Ltmp25:
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v131.l, 0x7fff, v74.h, s15
	...
	v_cndmask_b16 v70.h, 0x7fff, v64.h, s10
	...
	v_cndmask_b16 v130.h, 0x7fff, v64.h, s12
	v_cndmask_b16 v131.h, 0x7fff, v67.h, s14
	.loc	1 895 23                        ; attention.py:895:23
	v_mul_f32_e32 v24, v24, v124
	.loc	1 896 30                        ; attention.py:896:30
	v_cndmask_b16 v132.h, 0x7fff, v68.h, s16
...
.LBB0_4:                                ; %._crit_edge
	...
	v_div_scale_f32 v48, s3, v27, v82, v27
	...
	v_div_scale_f32 v39, s4, v28, v82, v28
	...
	v_div_scale_f32 v43, s3, v30, v82, v30
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v49, s5, v31, v82, v31
	...
	v_div_scale_f32 v44, s3, v17, v82, v17
	v_fma_f32 v36, -v46, v38, v47
	v_div_scale_f32 v46, s4, v18, v82, v18
	...
	v_div_scale_f32 v44, s3, v20, v82, v20
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fma_f32 v36, -v43, v37, v46
	v_div_scale_f32 v43, s5, v21, v82, v21
	...
	s_mov_b32 vcc_lo, s5
	v_div_scale_f32 v43, s3, v23, v82, v23
	v_rcp_f32_e32 v44, v41
	...
	v_div_scale_f32 v36, s4, v8, v82, v8
	...
	v_div_scale_f32 v48, s5, v10, v82, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	v_div_scale_f32 v39, s3, v11, v82, v11
	...
	v_div_scale_f32 v38, s4, v13, v82, v13
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_div_scale_f32 v36, s3, v15, v82, v15
	v_mul_f32_e32 v42, v38, v45
	v_div_scale_f32 v51, s4, v0, v82, v0
	...
	v_div_scale_f32 v52, s5, v1, v82, v1
	...
	v_div_scale_f32 v51, s4, v6, v82, v6
	...
	v_div_scale_f32 v53, s5, v7, v82, v7
	...
	v_div_scale_f32 v48, s3, v5, v82, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 145
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_causal_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.numbered_sgpr, 49
