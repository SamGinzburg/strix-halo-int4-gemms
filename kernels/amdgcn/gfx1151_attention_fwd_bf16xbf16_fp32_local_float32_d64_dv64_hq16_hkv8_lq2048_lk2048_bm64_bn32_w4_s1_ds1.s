...
.Ltmp0:
	...
	v_or_b32_e32 v33, s46, v69
	.loc	1 787 26                        ; attention.py:787:26
	s_add_i32 s35, s46, s2
	s_mov_b32 s7, 0x31027000
	s_mov_b32 s6, 0x7ffffffe
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v68, 1, v0
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s2, 0x800, v33
	.loc	1 788 26                        ; attention.py:788:26
	...
	.loc	1 787 26                        ; attention.py:787:26
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[89:90], null, s47, v69, v[65:66]
	s_mul_i32 s8, s47, s35
	.loc	1 790 61                        ; attention.py:790:61
	v_cmp_gt_i32_e64 s34, s47, v65
	.loc	1 787 26                        ; attention.py:787:26
	s_lshl_b32 s9, s47, 5
	s_mul_i32 s10, s47, 48
	.loc	1 788 26                        ; attention.py:788:26
	s_and_b32 s5, s5, 0xffff
	v_xor_b32_e32 v17, v67, v17
	.loc	1 787 26                        ; attention.py:787:26
	v_add_nc_u32_e32 v1, s8, v89
	v_lshl_add_u32 v106, s47, 4, v89
	...
	s_add_i32 s5, s46, s13
	.loc	1 802 39                        ; attention.py:802:39
	s_sub_i32 s6, s46, s12
	.loc	1 805 17                        ; attention.py:805:17
	s_add_i32 s5, s5, s14
	.loc	1 802 39                        ; attention.py:802:39
	s_add_i32 s6, s6, s14
...
.LBB0_3:                                ; %Flow136
	...
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v107, 0x78, v0
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 755 23                        ; attention.py:755:23
	s_lshr_b32 s8, s4, 28
	v_dual_mov_b32 v25, 0 :: v_dual_add_nc_u32 v4, s14, v33
	s_add_i32 s15, s3, s8
	s_load_b128 s[8:11], s[0:1], 0x64
	.loc	1 762 27                        ; attention.py:762:27
	v_add_nc_u32_e32 v1, s14, v1
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v28, v25 :: v_dual_lshlrev_b32 v5, 7, v103
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v6, 6, v105
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v7, 4, v66
	.loc	1 759 21                        ; attention.py:759:21
	v_or_b32_e32 v3, 48, v33
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v2, s14, v2
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v117, s12, v1
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v121, s13, v1
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v5, v6, v7
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v3, s14, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v118, s12, v2
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v122, s13, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v2, 0x70, v1, 0
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v119, s12, v3
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v123, s13, v3
	.loc	1 788 26                        ; attention.py:788:26
	...
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v116, s12, v4
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v120, s13, v4
	.loc	1 788 26                        ; attention.py:788:26
	...
	s_waitcnt lgkmcnt(0)
	v_mul_lo_u32 v1, s11, v69
	.loc	1 760 21                        ; attention.py:760:21
	v_lshlrev_b32_e32 v112, 2, v66
	v_or_b32_e32 v124, v7, v5
	s_clause 0x1
	...
	v_lshl_add_u32 v13, s11, 4, v1
	v_lshl_add_u32 v14, s11, 5, v1
	v_mad_u64_u32 v[2:3], null, s11, 48, v[1:2]
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v125, v112, v1
	...
	v_add_nc_u32_e32 v128, v114, v13
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v129, v115, v13
	v_dual_mov_b32 v23, v25 :: v_dual_add_nc_u32 v130, v112, v14
	...
	v_dual_mov_b32 v10, v25 :: v_dual_and_b32 v13, 64, v1
	...
	v_dual_mov_b32 v186, 0xff800000 :: v_dual_add_nc_u32 v145, 0, v6
	...
	s_mul_i32 s0, s10, s0
	.loc	1 852 32                        ; attention.py:852:32
	s_and_b32 s63, s1, 0xfffff800
	.loc	1 871 27                        ; attention.py:871:27
	s_mul_i32 s1, s9, s3
	v_lshrrev_b32_e32 v19, 1, v107
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s65, s0, s1
	v_lshl_or_b32 v7, v105, 3, v7
	...
	v_xor_b32_e32 v140, v7, v19
	.loc	1 760 21                        ; attention.py:760:21
	v_lshrrev_b32_e32 v4, 2, v107
	v_dual_mov_b32 v94, v25 :: v_dual_mov_b32 v1, 0x5410
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_cndmask_b32_e64 v7, 0x3276, v16, s0
	v_xor_b32_e32 v5, 16, v124
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[90:91], null, s60, v4, v[65:66]
	v_lshlrev_b32_e32 v4, 3, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v7, v7, 8, v7
	v_bfe_i32 v0, v0, 3, 1
	v_cndmask_b32_e64 v1, 0x1054, v1, s0
	v_dual_mov_b32 v91, v25 :: v_dual_add_nc_u32 v144, 0, v5
	...
	v_dual_mov_b32 v92, v25 :: v_dual_and_b32 v1, 0x540054, v1
	v_add_nc_u32_e32 v166, 0, v5
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_and_b32_e32 v143, 0x7060706, v7
	v_dual_mov_b32 v7, v25 :: v_dual_and_b32 v4, 48, v4
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_xor_b32_e32 v141, v4, v21
	v_xor_b32_e32 v4, 32, v139
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 854 32                        ; attention.py:854:32
	v_cndmask_b32_e64 v65, 0x80000000, v65, s34
	v_cndmask_b32_e64 v69, 0x80000000, v66, s34
	s_clause 0x1
	...
	v_or_b32_e32 v188, s61, v112
	v_or_b32_e32 v189, s61, v113
	v_or_b32_e32 v190, s61, v114
	v_or_b32_e32 v191, s61, v115
	.loc	1 870 25                        ; attention.py:870:25
	s_add_i32 s68, s65, s61
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s0, v188, v116
	v_cmp_ge_i32_e64 s1, v188, v117
	v_cmp_ge_i32_e64 s3, v188, v118
	v_cmp_ge_i32_e64 s8, v188, v119
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s4, v188, v120
	v_cmp_le_i32_e64 s5, v188, v121
	v_cmp_le_i32_e64 s6, v188, v122
	v_cmp_le_i32_e64 s13, v188, v123
	.loc	1 880 35                        ; attention.py:880:35
	v_add_nc_u32_e32 v188, 0, v136
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s7, v189, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s11, v189, v120
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v190, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s21, v190, v120
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s25, v191, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s29, v191, v120
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v192, s68, v125, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s9, v189, v117
	v_cmp_ge_i32_e64 s10, v189, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s12, v189, v121
	v_cmp_le_i32_e64 s15, v189, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v190, v117
	v_cmp_ge_i32_e64 s18, v190, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v190, v121
	v_cmp_le_i32_e64 s23, v190, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s26, v191, v117
	v_cmp_ge_i32_e64 s27, v191, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v191, v121
	v_cmp_le_i32_e64 s31, v191, v122
	.loc	1 867 21 is_stmt 0              ; attention.py:867:21
	s_and_b32 s0, s0, s4
	.loc	1 879 36 is_stmt 1              ; attention.py:879:36
	v_add_lshl_u32 v193, s68, v176, 2
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s4, s7, s11
	s_and_b32 s7, s16, s21
	s_and_b32 s16, s1, s5
	s_and_b32 s5, s2, s0
	s_and_b32 s11, s25, s29
	s_and_b32 s3, s3, s6
	s_and_b32 s6, s2, s7
	s_and_b32 s9, s9, s12
	...
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s20, v190, v119
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s24, v190, v123
	.loc	1 867 21 is_stmt 0              ; attention.py:867:21
	s_and_b32 s3, s8, s13
	.loc	1 866 30 is_stmt 1              ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v189, v119
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s16, s2, s3
	.loc	1 867 30 is_stmt 0              ; attention.py:867:30
	v_cmp_le_i32_e64 s19, v189, v123
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s8, s20, s24
	.loc	1 866 30 is_stmt 1              ; attention.py:866:30
	v_cmp_ge_i32_e64 s28, v191, v119
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s18, s2, s8
	.loc	1 867 30 is_stmt 0              ; attention.py:867:30
	v_cmp_le_i32_e64 s33, v191, v123
	.loc	1 867 21                        ; attention.py:867:21
	s_and_b32 s3, s14, s19
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v95, s68, v132, 2
	v_add_lshl_u32 v96, s68, v133, 2
	v_cndmask_b32_e64 v97, 0x80000000, v192, s5
	v_cndmask_b32_e64 v98, 0x80000000, v193, s0
	v_add_lshl_u32 v99, s68, v134, 2
	...
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v81, s68, v177, 2
	v_add_lshl_u32 v82, s68, v178, 2
	v_add_lshl_u32 v83, s68, v126, 2
	v_add_lshl_u32 v84, s68, v127, 2
	v_add_lshl_u32 v85, s68, v128, 2
	v_add_lshl_u32 v86, s68, v129, 2
	v_add_lshl_u32 v87, s68, v130, 2
	v_add_lshl_u32 v88, s68, v131, 2
	v_cndmask_b32_e64 v81, 0x80000000, v81, s6
	v_cndmask_b32_e64 v82, 0x80000000, v82, s1
	v_cndmask_b32_e64 v83, 0x80000000, v83, s7
	v_cndmask_b32_e64 v84, 0x80000000, v84, s11
	v_cndmask_b32_e64 v85, 0x80000000, v85, s10
	v_cndmask_b32_e64 v86, 0x80000000, v86, s12
	v_cndmask_b32_e64 v87, 0x80000000, v87, s9
	...
	s_waitcnt vmcnt(11)
	v_cndmask_b32_e64 v193, 0xff800000, v97, s5
	s_waitcnt vmcnt(10)
	v_cndmask_b32_e64 v194, 0xff800000, v81, s6
	s_waitcnt vmcnt(9)
	v_cndmask_b32_e64 v81, 0xff800000, v98, s0
	s_waitcnt vmcnt(8)
	v_cndmask_b32_e64 v82, 0xff800000, v82, s1
	s_waitcnt vmcnt(7)
	v_cndmask_b32_e64 v195, 0xff800000, v83, s7
	s_waitcnt vmcnt(6)
	v_cndmask_b32_e64 v196, 0xff800000, v85, s10
	s_waitcnt vmcnt(5)
	v_cndmask_b32_e64 v83, 0xff800000, v84, s11
	s_waitcnt vmcnt(4)
	v_cndmask_b32_e64 v84, 0xff800000, v86, s12
	s_waitcnt vmcnt(3)
	v_cndmask_b32_e64 v97, 0xff800000, v87, s9
	v_add_lshl_u32 v87, s68, v137, 2
	s_waitcnt vmcnt(1)
	v_cndmask_b32_e64 v85, 0xff800000, v88, s4
	v_cndmask_b32_e64 v88, 0x80000000, v99, s16
	s_waitcnt vmcnt(0)
	v_cndmask_b32_e64 v86, 0xff800000, v96, s17
	v_cndmask_b32_e64 v98, 0xff800000, v95, s15
	...
	v_cmp_neq_f32_e64 s25, 0xff800000, v81
	v_cmp_neq_f32_e64 s8, 0xff800000, v195
	v_cmp_neq_f32_e64 s14, 0xff800000, v196
	v_cmp_neq_f32_e64 s20, 0xff800000, v97
	v_cmp_neq_f32_e64 s26, 0xff800000, v82
	v_cmp_neq_f32_e64 s23, 0xff800000, v98
	.loc	1 881 25 is_stmt 0              ; attention.py:881:25
	s_and_b32 s8, s7, s8
	s_and_b32 s7, s10, s14
	s_and_b32 s14, s5, s13
	s_and_b32 s13, s6, s19
	s_and_b32 s10, s9, s20
	s_and_b32 s9, s15, s23
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s28, 0xff800000, v84
	v_cmp_neq_f32_e64 s29, 0xff800000, v85
	v_cmp_neq_f32_e64 s27, 0xff800000, v83
	v_cmp_neq_f32_e64 s30, 0xff800000, v86
	.loc	1 881 25                        ; attention.py:881:25
	s_and_b32 s20, s0, s25
	s_and_b32 s15, s12, s28
	s_and_b32 s19, s1, s26
	s_and_b32 s17, s17, s30
	.loc	1 879 36 is_stmt 1              ; attention.py:879:36
	s_waitcnt vmcnt(1)
	v_cndmask_b32_e64 v95, 0xff800000, v88, s16
	s_waitcnt vmcnt(0)
	v_cndmask_b32_e64 v96, 0xff800000, v87, s18
	v_add_lshl_u32 v87, s68, v135, 2
	v_add_lshl_u32 v88, s68, v138, 2
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s3, 0xff800000, v95
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cmp_neq_f32_e64 s24, 0xff800000, v96
	.loc	1 879 36                        ; attention.py:879:36
	v_cndmask_b32_e64 v87, 0x80000000, v87, s21
	s_delay_alu instid0(VALU_DEP_4)
	v_cndmask_b32_e64 v88, 0x80000000, v88, s22
	s_clause 0x1
	buffer_load_b32 v87, v87, s[48:51], 0 offen
	buffer_load_b32 v88, v88, s[48:51], 0 offen
	.loc	1 880 35                        ; attention.py:880:35
	...
	s_barrier
	.loc	1 881 25                        ; attention.py:881:25
	s_and_b32 s5, s18, s24
	s_and_b32 s6, s16, s3
	s_and_b32 s16, s11, s27
	s_and_b32 s18, s4, s29
	.loc	1 879 36                        ; attention.py:879:36
	s_waitcnt vmcnt(1)
	v_cndmask_b32_e64 v87, 0xff800000, v87, s21
	s_waitcnt vmcnt(0)
	v_cndmask_b32_e64 v88, 0xff800000, v88, s22
	.loc	1 880 35                        ; attention.py:880:35
	...
	v_cmp_neq_f32_e64 s33, 0xff800000, v88
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v84, 0, 1, s16
	.loc	1 881 34                        ; attention.py:881:34
	v_cmp_neq_f32_e64 s31, 0xff800000, v87
	.loc	1 890 30 is_stmt 1              ; attention.py:890:30
	v_add_nc_u32_e32 v196, 0, v0
	.loc	1 881 25                        ; attention.py:881:25
	s_and_b32 s11, s22, s33
	s_and_b32 s12, s21, s31
	.loc	1 818 13                        ; attention.py:818:13
	s_cmp_lt_i32 s61, s62
	.loc	1 880 35                        ; attention.py:880:35
	s_waitcnt lgkmcnt(3)
	...
	v_dual_fmac_f32 v99, s64, v73 :: v_dual_fmac_f32 v100, s64, v74
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v101, s64, v75 :: v_dual_fmac_f32 v102, s64, v76
	v_mad_u64_u32 v[74:75], null, s67, s60, v[90:91]
	.loc	1 880 35                        ; attention.py:880:35
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v189, 0x3fb8aa3b, v190 :: v_dual_mul_f32 v192, 0x3fb8aa3b, v197
	v_dual_mul_f32 v190, 0x3fb8aa3b, v198 :: v_dual_fmac_f32 v191, s64, v77
	ds_load_b64 v[76:77], v156
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v189, s64, v78
	.loc	1 890 30 is_stmt 1              ; attention.py:890:30
	v_lshlrev_b32_e32 v75, 1, v74
	v_add_lshl_u32 v74, v74, s60, 1
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v192, s64, v79 :: v_dual_add_nc_u32 v73, 0, v140
	...
	.loc	1 880 25 is_stmt 0              ; attention.py:880:25
	v_fmac_f32_e32 v74, s64, v65
	.loc	1 881 25 is_stmt 1              ; attention.py:881:25
	v_mov_b16_e32 v65.l, v82.l
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v75, s64, v66 :: v_dual_fmac_f32 v78, s64, v69
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v66, 0, 1, s8
	.loc	1 880 25                        ; attention.py:880:25
	v_dual_fmac_f32 v77, s64, v68 :: v_dual_fmac_f32 v80, s64, v71
	.loc	1 881 25                        ; attention.py:881:25
	v_lshlrev_b16 v65.l, 8, v65.l
	v_cndmask_b32_e64 v68, 0, 1, s14
	v_cndmask_b32_e64 v69, 0, 1, s5
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v79, s64, v70
	.loc	1 881 25                        ; attention.py:881:25
	...
	.loc	1 880 25                        ; attention.py:880:25
	v_fmac_f32_e32 v81, s64, v72
	.loc	1 881 25                        ; attention.py:881:25
	v_cndmask_b32_e64 v72, 0, 1, s10
	v_lshlrev_b16 v65.l, 8, v65.l
	...
	v_cmp_eq_u16_e64 s28, 1, v66.l
	v_cmp_eq_u16_e64 s26, 1, v66.h
	v_cmp_eq_u16_e64 s25, 1, v67.l
	v_cmp_eq_u16_e64 s22, 1, v70.l
	v_cmp_eq_u16_e64 s4, 1, v69.l
	v_cmp_eq_u16_e64 s0, 1, v69.h
	v_cmp_eq_u16_e64 s23, 1, v67.h
	v_cmp_eq_u16_e64 s21, 1, v68.l
	v_cmp_eq_u16_e64 s1, 1, v68.h
	.loc	1 882 26                        ; attention.py:882:26
	v_cndmask_b32_e64 v65, 0xff800000, v99, s33
	v_cndmask_b32_e64 v66, 0xff800000, v100, s3
	v_cndmask_b32_e64 v67, 0xff800000, v101, s31
	v_cndmask_b32_e64 v68, 0xff800000, v102, s30
	v_cndmask_b32_e64 v69, 0xff800000, v191, s29
	v_cndmask_b32_e64 v70, 0xff800000, v189, s28
	v_cndmask_b32_e64 v71, 0xff800000, v192, s27
	v_cndmask_b32_e64 v72, 0xff800000, v190, s26
	v_cndmask_b32_e64 v101, 0xff800000, v74, s24
	v_cndmask_b32_e64 v102, 0xff800000, v75, s25
	v_cndmask_b32_e64 v99, 0xff800000, v76, s22
	v_cndmask_b32_e64 v97, 0xff800000, v78, s4
	v_cndmask_b32_e64 v95, 0xff800000, v80, s0
	v_cndmask_b32_e64 v100, 0xff800000, v77, s23
	v_cndmask_b32_e64 v98, 0xff800000, v79, s21
...
.Ltmp4:
	...
	v_permlanex16_b32 v189, v188, s66, 0xfedcba98 op_sel:[1,0]
...
.Ltmp5:
	...
	v_cndmask_b16 v66.l, 0x7fff, v65.h, s33
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v190, v66, s66, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v190, v68, s66, 0xfedcba98 op_sel:[1,0]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v190, v70, s66, 0xfedcba98 op_sel:[1,0]
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 896 30 is_stmt 1              ; attention.py:896:30
	v_cndmask_b16 v72.h, 0x7fff, v72.h, s26
	...
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v190, v72, s66, 0xfedcba98 op_sel:[1,0]
...
.Ltmp53:
	...
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 886 33 is_stmt 0              ; attention.py:886:33
	v_cndmask_b32_e64 v87, 0, v87, s8
.Ltmp54:
	.loc	2 170 12 is_stmt 1              ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:883:29 ] ]
...
.Ltmp66:
	...
	.loc	1 885 25                        ; attention.py:885:25
	v_cmp_neq_f32_e64 s4, 0xff800000, v186
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	.loc	1 896 30                        ; attention.py:896:30
...
.Ltmp77:
	.loc	1 896 30                        ; attention.py:896:30
	v_permlanex16_b32 v95, v72, s66, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp78:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:887:24 ]
	v_mov_b32_e32 v80, v74
...
.Ltmp85:
	...
	v_cndmask_b32_e64 v100, 0, v190, s4
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 199
