	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
.Lfunc_begin0:
...
; %bb.1:                                ; %.lr.ph6
	...
	.loc	1 284 43                        ; generate_amdgcn.py:284:43
	s_lshl_b32 s41, s3, 6
...
.LBB0_2:                                ; %._crit_edge
	...
	ds_store_2addr_b32 v0, v108, v83 offset0:64 offset1:96
	ds_store_2addr_b32 v35, v114, v113 offset1:32
	ds_store_2addr_b32 v35, v100, v82 offset0:64 offset1:96
	ds_store_2addr_b32 v36, v112, v111 offset1:32
	ds_store_2addr_b32 v36, v89, v79 offset0:64 offset1:96
	ds_store_2addr_b32 v37, v110, v109 offset1:32
	ds_store_2addr_b32 v37, v80, v77 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v39, v75, v71 offset0:64 offset1:96
	...
	ds_store_2addr_b32 v41, v70, v67 offset0:64 offset1:96
	ds_store_2addr_b32 v42, v97, v96 offset1:32
	ds_store_2addr_b32 v42, v68, v64 offset0:64 offset1:96
	ds_store_2addr_b32 v43, v95, v94 offset1:32
	ds_store_2addr_b32 v43, v66, v62 offset0:64 offset1:96
	ds_store_2addr_b32 v44, v93, v92 offset1:32
	ds_store_2addr_b32 v44, v65, v60 offset0:64 offset1:96
	ds_store_2addr_b32 v45, v91, v90 offset1:32
	ds_store_2addr_b32 v45, v63, v57 offset0:64 offset1:96
	ds_store_2addr_b32 v46, v88, v87 offset1:32
	ds_store_2addr_b32 v46, v61, v56 offset0:64 offset1:96
	ds_store_2addr_b32 v47, v86, v84 offset1:32
	ds_store_2addr_b32 v47, v59, v55 offset0:64 offset1:96
	ds_store_2addr_b32 v48, v85, v81 offset1:32
	ds_store_2addr_b32 v48, v58, v53 offset0:64 offset1:96
	v_add_nc_u32_e32 v0, 0, v20
	ds_store_2addr_b32 v49, v76, v72 offset1:32
	ds_store_2addr_b32 v49, v54, v14 offset0:64 offset1:96
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v0, v0
	ds_load_b32 v1, v50
...
.LBB0_3:                                ; =>This Loop Header: Depth=1
	...
	s_xor_b32 s4, s4, s10
	v_dual_mov_b32 v115, 0 :: v_dual_mov_b32 v86, 0
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v114, 0 :: v_dual_add_nc_u32 v3, s50, v15
...
.LBB0_5:                                ;   Parent Loop BB0_3 Depth=1
	...
	v_dual_fmac_f32 v99, v200, v191 :: v_dual_mul_f32 v194, v211, v196
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	...
	s_waitcnt vmcnt(21)
	v_dual_mul_f32 v4, v4, v196 :: v_dual_lshlrev_b32 v175, 16, v175
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(19)
	...
	s_waitcnt vmcnt(21)
	v_dual_mul_f32 v140, v140, v196 :: v_dual_lshlrev_b32 v187, 16, v187
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(20)
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v198, v214, v196 :: v_dual_fmac_f32 v93, v203, v182
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(17)
	...
	s_waitcnt vmcnt(27)
	v_dual_mul_f32 v156, v156, v196 :: v_dual_lshlrev_b32 v127, 16, v127
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v95, v202, v179 :: v_dual_lshlrev_b32 v176, 16, v176
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(26)
	v_lshlrev_b32_e32 v125, 16, v125
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v91, v204, v177 :: v_dual_lshlrev_b32 v192, 16, v192
	s_delay_alu instid0(VALU_DEP_3)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v88, v205, v175 :: v_dual_fmac_f32 v85, v184, v125
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x1
	buffer_load_u16 v175, v120, s[36:39], 0 offen offset:204
	buffer_load_u16 v205, v120, s[36:39], 0 offen offset:208
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v86, v189, v127 :: v_dual_fmac_f32 v115, v174, v126
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_clause 0x5
	...
	s_waitcnt vmcnt(38)
	v_dual_mul_f32 v0, v0, v196 :: v_dual_lshlrev_b32 v169, 16, v169
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(37)
	v_lshlrev_b32_e32 v170, 16, v170
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v113, v129, v122 :: v_dual_lshlrev_b32 v128, 16, v128
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(36)
	v_dual_mul_f32 v6, v6, v196 :: v_dual_lshlrev_b32 v171, 16, v171
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v105, v132, v169 :: v_dual_fmac_f32 v76, v181, v128
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	s_clause 0x1
	...
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(36)
	v_dual_mul_f32 v2, v2, v196 :: v_dual_lshlrev_b32 v173, 16, v173
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v101, v134, v171 :: v_dual_lshlrev_b32 v172, 16, v172
	...
	s_waitcnt vmcnt(29)
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_fmac_f32 v78, v148, v197 :: v_dual_lshlrev_b32 v195, 16, v195
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(28)
	...
	v_lshlrev_b32_e32 v190, 16, v190
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v103, v133, v170 :: v_dual_lshlrev_b32 v168, 16, v168
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v81, v142, v194 :: v_dual_lshlrev_b32 v188, 16, v188
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(23)
	v_dual_mul_f32 v151, v151, v196 :: v_dual_lshlrev_b32 v178, 16, v178
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v61, v156, v201 :: v_dual_lshlrev_b32 v200, 16, v200
	v_fmac_f32_e32 v98, v135, v172
	v_dual_fmac_f32 v92, v138, v178 :: v_dual_lshlrev_b32 v187, 16, v187
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v153, v153, v196 :: v_dual_fmac_f32 v108, v144, v190
	v_dual_mul_f32 v167, v167, v196 :: v_dual_lshlrev_b32 v198, 16, v198
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	v_lshlrev_b32_e32 v124, 16, v124
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v66, v153, v191 :: v_dual_fmac_f32 v73, v150, v198
	s_waitcnt vmcnt(16)
	v_dual_fmac_f32 v72, v143, v124 :: v_dual_lshlrev_b32 v193, 16, v193
	.loc	1 300 24 is_stmt 0              ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v149, v149, v196 :: v_dual_fmac_f32 v96, v136, v173
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(14)
	v_lshlrev_b32_e32 v199, 16, v199
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v163, v163, v196 :: v_dual_lshlrev_b32 v202, 16, v202
	v_dual_mul_f32 v155, v155, v196 :: v_dual_fmac_f32 v84, v141, v193
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(10)
	...
	v_lshlrev_b32_e32 v177, 16, v177
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v165, v165, v196 :: v_dual_fmac_f32 v58, v158, v202
	v_mul_f32_e32 v3, v3, v196
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(5)
	v_lshlrev_b32_e32 v127, 16, v127
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v5, v5, v196 :: v_dual_fmac_f32 v74, v164, v205
	v_dual_mul_f32 v159, v159, v196 :: v_dual_lshlrev_b32 v126, 16, v126
	.loc	1 300 17 is_stmt 0              ; generate_amdgcn.py:300:17
	v_fmac_f32_e32 v100, v145, v185
	.loc	1 300 24                        ; generate_amdgcn.py:300:24
	v_dual_mul_f32 v1, v1, v196 :: v_dual_lshlrev_b32 v174, 16, v174
	v_dual_mul_f32 v157, v157, v196 :: v_dual_fmac_f32 v80, v147, v186
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v89, v146, v195 :: v_dual_lshlrev_b32 v180, 16, v180
	v_dual_fmac_f32 v75, v149, v187 :: v_dual_lshlrev_b32 v176, 16, v176
	v_dual_fmac_f32 v63, v155, v183 :: v_dual_lshlrev_b32 v192, 16, v192
	.loc	1 299 22 is_stmt 1              ; generate_amdgcn.py:299:22
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	s_waitcnt vmcnt(2)
	v_dual_fmac_f32 v83, v160, v203 :: v_dual_lshlrev_b32 v184, 16, v184
	v_fmac_f32_e32 v68, v152, v199
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_fmac_f32 v94, v137, v188 :: v_dual_fmac_f32 v67, v167, v125
	v_fmac_f32_e32 v90, v139, v180
	v_fmac_f32_e32 v70, v151, v192
	v_fmac_f32_e32 v65, v154, v200
	v_dual_fmac_f32 v59, v157, v179 :: v_dual_fmac_f32 v54, v159, v182
	v_dual_fmac_f32 v82, v161, v177 :: v_dual_fmac_f32 v79, v162, v204
	v_dual_fmac_f32 v64, v0, v184 :: v_dual_fmac_f32 v57, v3, v126
	v_fmac_f32_e32 v77, v163, v175
	v_fmac_f32_e32 v71, v165, v127
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v69, v166, v189 :: v_dual_lshlrev_b32 v128, 16, v128
	.loc	1 299 22                        ; generate_amdgcn.py:299:22
	s_waitcnt vmcnt(0)
	...
	.loc	1 300 17                        ; generate_amdgcn.py:300:17
	v_dual_fmac_f32 v109, v131, v168 :: v_dual_fmac_f32 v56, v4, v174
	v_fmac_f32_e32 v87, v140, v176
	v_fmac_f32_e32 v55, v5, v196
	s_delay_alu instid0(VALU_DEP_4)
...
.Ltmp21:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_vgpr, 222
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.numbered_sgpr, 54
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     56
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc256_none_persistent_bm16_bn128_bk128_gm1_w16_s1_weu2_sk2_maskk.kd
