...
; %bb.4:                                ; %.lr.ph
	...
	v_lshl_or_b32 v37, v25, 6, v3
	v_add_nc_u32_e32 v3, 0xa0, v4
	v_dual_mov_b32 v15, 0 :: v_dual_add_nc_u32 v4, 0x80, v4
	v_mov_b32_e32 v18, 0
	v_xor_b32_e32 v38, 16, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_fmac_f32_e32 v10, v84, v50
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v86, v73, v78 :: v_dual_lshlrev_b32 v75, 16, v121
	v_dual_mul_f32 v88, v73, v80 :: v_dual_lshlrev_b32 v77, 16, v123
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	v_add_nc_u32_e32 v166, s34, v43
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_fmac_f32_e32 v12, v86, v52
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v83, v73, v75 :: v_dual_add_nc_u32 v46, s35, v46
	v_mul_f32_e32 v75, v74, v75
	.loc	1 392 22                        ; generate_amdgcn.py:392:22
	v_lshlrev_b32_e32 v81, 16, v127
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v87, v73, v79 :: v_dual_fmac_f32 v14, v88, v54
	...
	v_dual_mul_f32 v80, v74, v80 :: v_dual_add_nc_u32 v45, s35, v45
	v_mul_f32_e32 v78, v74, v78
	v_dual_mul_f32 v81, v74, v81 :: v_dual_fmac_f32 v20, v77, v59
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v16, v73, v56 :: v_dual_mul_f32 v79, v74, v79
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	v_dual_mul_f32 v74, v74, v82 :: v_dual_add_nc_u32 v165, s19, v44
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v9, v83, v49 :: v_dual_fmac_f32 v24, v81, v63
	v_dual_fmac_f32 v11, v85, v51 :: v_dual_fmac_f32 v22, v79, v61
	v_fmac_f32_e32 v13, v87, v53
	v_fmac_f32_e32 v15, v89, v55
	v_fmac_f32_e32 v19, v76, v58
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 167
