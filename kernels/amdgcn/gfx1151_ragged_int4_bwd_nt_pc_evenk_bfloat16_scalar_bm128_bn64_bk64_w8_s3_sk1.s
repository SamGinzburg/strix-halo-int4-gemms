...
; %bb.1:                                ; %.._crit_edge_crit_edge
	...
	s_add_i32 s3, s19, s10
	.loc	1 1411 21                       ; ragged.py:1411:21
	s_add_i32 s9, s18, s20
	s_branch .LBB0_3
.LBB0_2:
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v59, 0xc0, v0
	v_dual_mov_b32 v19, 0 :: v_dual_and_b32 v60, 32, v0
	v_dual_mov_b32 v21, 0 :: v_dual_and_b32 v36, 24, v1
...
; %bb.4:                                ; %.lr.ph
	...
	.loc	1 1324 23                       ; ragged.py:1324:23
	s_waitcnt lgkmcnt(0)
	v_mad_u64_u32 v[33:34], null, s1, v3, v[2:3]
	v_mad_u64_u32 v[34:35], null, v8, s1, v[1:2]
	...
	v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v6, 24, v6
	v_xor_b32_e32 v4, v4, v7
	v_mov_b32_e32 v18, v1
	v_add_nc_u32_e32 v42, 0, v5
	v_mov_b32_e32 v5, v1
	v_lshl_or_b32 v6, v58, 5, v6
	v_xor_b32_e32 v9, 8, v4
	v_add_nc_u32_e32 v35, 0, v4
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v8, v1
	v_lshl_or_b32 v7, v59, 3, v6
	...
	v_dual_mov_b32 v12, v1 :: v_dual_add_nc_u32 v43, 0, v6
	v_dual_mov_b32 v17, v1 :: v_dual_add_nc_u32 v44, 0, v13
	v_add_nc_u32_e32 v45, 0, v14
	v_dual_mov_b32 v19, v1 :: v_dual_add_nc_u32 v46, 0, v15
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v47, s22, v34
	.loc	1 1335 34                       ; ragged.py:1335:34
	v_add_nc_u32_e32 v48, s22, v33
	...
	.loc	1 1335 34                       ; ragged.py:1335:34
	v_cndmask_b32_e64 v51, 0x80000000, v48, s0
	.loc	1 1334 34                       ; ragged.py:1334:34
	buffer_load_b128 v[47:50], v47, s[8:11], 0 offen
	.loc	1 1335 34                       ; ragged.py:1335:34
	buffer_load_b64 v[55:56], v51, s[12:15], 0 offen
	.loc	1 1334 34                       ; ragged.py:1334:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[47:50], v38 offset1:4
	ds_load_2addr_stride64_b64 v[51:54], v39 offset1:4
	ds_load_2addr_stride64_b64 v[61:64], v40 offset1:4
	ds_load_2addr_stride64_b64 v[65:68], v41 offset1:4
	.loc	1 1335 34                       ; ragged.py:1335:34
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v42, v[55:56]
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_2addr_stride64_b64 v[69:72], v43 offset1:2
	ds_load_2addr_stride64_b64 v[73:76], v44 offset1:2
	ds_load_2addr_stride64_b64 v[77:80], v45 offset1:2
	ds_load_2addr_stride64_b64 v[81:84], v46 offset1:2
	.loc	1 1336 31                       ; ragged.py:1336:31
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[69:70], v[47:48], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[75:76], v[51:52], v[9:16] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[79:80], v[63:64], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[81:82], v[65:66], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[83:84], v[67:68], v[25:32] neg_lo:[1,1,0]
	.loc	1 1324 23                       ; ragged.py:1324:23
...
.LBB0_7:                                ; %._crit_edge
	...
	v_add_lshl_u32 v62, s9, v62, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v65, s18, v61
	v_or_b32_e32 v64, s18, v60
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v61, s9, v61, 1
	v_cndmask_b32_e64 v2, 0x80000000, v2, s1
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s1, s17, v66
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v63, s18, v58
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v60, s9, v60, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v59, s18, v29
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v58, s9, v58, 1
	...
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v32, s18, v28
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v29, s9, v29, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v31, s18, v27
	.loc	1 1410 36                       ; ragged.py:1410:36
	...
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v28, s9, v28, 1
	.loc	1 1403 36                       ; ragged.py:1403:36
	v_add_lshl_u32 v70, s3, v26, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v30, s18, v25
	.loc	1 1410 36                       ; ragged.py:1410:36
	...
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v27, s9, v27, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v16, s18, v9
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v25, s9, v25, 1
	...
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v8, s9, v8, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v13, s18, v6
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v7, s9, v7, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	...
	v_add_lshl_u32 v2, s9, v9, 1
	v_add_lshl_u32 v6, s9, v6, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	...
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v5, s9, v5, 1
	.loc	1 1310 18                       ; ragged.py:1310:18
	v_or_b32_e32 v10, s18, v3
	.loc	1 1410 36                       ; ragged.py:1410:36
	v_add_lshl_u32 v4, s9, v4, 1
	v_add_lshl_u32 v3, s9, v3, 1
	v_cndmask_b32_e64 v2, 0x80000000, v2, s1
	.loc	1 1312 20                       ; ragged.py:1312:20
	...
	.loc	1 1310 36 is_stmt 0             ; ragged.py:1310:36
	v_or_b32_e32 v15, 2, v36
	v_or_b32_e32 v16, 1, v36
	...
	v_or_b32_e32 v84, s18, v15
	v_or_b32_e32 v85, s18, v16
	.loc	1 1410 36 is_stmt 1             ; ragged.py:1410:36
	v_cndmask_b32_e64 v7, 0x80000000, v7, s1
	.loc	1 1312 20                       ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s1, s17, v13
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v13, 4, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v83, s18, v14
	.loc	1 1545 17 is_stmt 1             ; ragged.py:1545:17
	...
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v12, 5, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v82, s18, v13
	...
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v11, 6, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v81, s18, v12
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	...
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v10, 7, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v80, s18, v11
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	...
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v2, 39, v36
	v_or_b32_e32 v3, 38, v36
	...
	v_or_b32_e32 v28, s18, v3
	.loc	1 1310 36 is_stmt 0             ; ragged.py:1310:36
	v_or_b32_e32 v5, 36, v36
	v_or_b32_e32 v6, 35, v36
	v_or_b32_e32 v7, 34, v36
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	v_cmp_gt_i32_e64 s1, s17, v0
	v_cmp_gt_i32_e64 s2, s17, v28
	.loc	1 1545 26                       ; ragged.py:1545:26
	v_mad_u64_u32 v[27:28], null, s17, v1, s[20:21]
	v_mad_u64_u32 v[0:1], null, s17, v26, s[20:21]
	.loc	1 1310 36                       ; ragged.py:1310:36
	v_or_b32_e32 v8, 33, v36
	v_or_b32_e32 v9, 32, v36
	.loc	1 1310 18 is_stmt 0             ; ragged.py:1310:18
	v_or_b32_e32 v73, s18, v4
	v_or_b32_e32 v74, s18, v5
	v_or_b32_e32 v75, s18, v6
	v_or_b32_e32 v76, s18, v7
	v_or_b32_e32 v77, s18, v8
	v_or_b32_e32 v78, s18, v9
	v_or_b32_e32 v79, s18, v10
	.loc	1 1312 20 is_stmt 1             ; ragged.py:1312:20
	...
	v_mul_f32_e32 v26, v57, v68
	s_waitcnt vmcnt(15)
	v_dual_mul_f32 v28, v56, v68 :: v_dual_lshlrev_b32 v31, 16, v31
	s_waitcnt vmcnt(13)
	v_dual_mul_f32 v54, v54, v68 :: v_dual_lshlrev_b32 v57, 16, v59
	v_mul_f32_e32 v53, v53, v68
	v_mul_f32_e32 v51, v51, v68
	v_dual_mul_f32 v43, v43, v68 :: v_dual_mul_f32 v38, v38, v1
	v_mul_f32_e32 v42, v42, v68
	v_dual_mul_f32 v37, v37, v1 :: v_dual_lshlrev_b32 v32, 16, v32
	s_waitcnt vmcnt(12)
	v_dual_mul_f32 v35, v35, v1 :: v_dual_lshlrev_b32 v56, 16, v60
	s_waitcnt vmcnt(9)
	...
	.loc	1 1408 17                       ; ragged.py:1408:17
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v50, v50, v68 :: v_dual_lshlrev_b32 v59, 16, v62
	v_mul_f32_e32 v49, v49, v68
	v_mul_f32_e32 v48, v48, v68
	v_mul_f32_e32 v47, v47, v68
	v_mul_f32_e32 v46, v46, v68
	v_dual_mul_f32 v45, v45, v68 :: v_dual_mul_f32 v40, v40, v1
	v_mul_f32_e32 v44, v44, v68
	v_dual_mul_f32 v52, v52, v68 :: v_dual_lshlrev_b32 v29, 16, v29
	v_dual_mul_f32 v34, v34, v1 :: v_dual_mul_f32 v53, v53, v58
	v_mul_f32_e32 v39, v39, v1
	v_mul_f32_e32 v33, v33, v1
	v_mul_f32_e32 v23, v23, v1
	v_dual_mul_f32 v19, v19, v1 :: v_dual_mul_f32 v54, v54, v56
	v_dual_mul_f32 v21, v21, v1 :: v_dual_mul_f32 v50, v50, v59
	.loc	1 1415 17                       ; ragged.py:1415:17
	v_mul_f32_e32 v38, v38, v58
	v_dual_mul_f32 v52, v52, v29 :: v_dual_mul_f32 v37, v37, v56
	...
	.loc	1 1408 17                       ; ragged.py:1408:17
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v24, v24, v1 :: v_dual_lshlrev_b32 v67, 16, v71
	.loc	1 1415 17                       ; ragged.py:1415:17
	v_dual_mul_f32 v51, v51, v60 :: v_dual_mul_f32 v20, v20, v1
	v_dual_mul_f32 v47, v47, v63 :: v_dual_mul_f32 v22, v22, v1
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v43, v43, v67
	.loc	1 1408 17                       ; ragged.py:1408:17
	v_dual_mul_f32 v17, v17, v1 :: v_dual_mul_f32 v48, v48, v30
	v_dual_mul_f32 v1, v18, v1 :: v_dual_mul_f32 v44, v44, v64
	.loc	1 1415 17                       ; ragged.py:1415:17
	v_mul_f32_e32 v18, v26, v31
	v_mul_f32_e32 v26, v28, v32
	v_mul_f32_e32 v32, v41, v32
	v_dual_mul_f32 v45, v45, v65 :: v_dual_mul_f32 v42, v42, v66
	v_dual_mul_f32 v28, v55, v57 :: v_dual_mul_f32 v31, v40, v31
	v_dual_mul_f32 v23, v23, v61 :: v_dual_mul_f32 v24, v24, v30
	v_dual_mul_f32 v21, v21, v65 :: v_dual_mul_f32 v22, v22, v64
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	.loc	1 1415 17                       ; ragged.py:1415:17
	v_dual_mul_f32 v49, v49, v61 :: v_dual_mul_f32 v46, v46, v62
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	v_dual_mul_f32 v19, v19, v63 :: v_dual_mul_f32 v20, v20, v62
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	v_cndmask_b32_e64 v45, v28, v18, s17
	v_cndmask_b32_e64 v18, v18, v28, s17
	v_cndmask_b32_e64 v28, v30, v26, s17
	v_cndmask_b32_e64 v26, v26, v30, s17
	v_cndmask_b16 v30.h, 0x7fff, v32.h, s34
	...
	v_cndmask_b16 v1.l, 0x7fff, v35.h, s37
	...
	v_cndmask_b32_e64 v24, 0x1054, v24, s17
	...
	v_cndmask_b32_e64 v34, v19, v30, s17
	v_cndmask_b32_e64 v19, v30, v19, s17
	...
	v_cndmask_b32_e64 v20, v39, v41, s17
	...
	v_add_lshl_u32 v50, v27, v36, 1
	v_cndmask_b32_e64 v17, v41, v39, s17
	v_cndmask_b32_e64 v22, v42, v40, s17
	...
	.loc	1 1545 17                       ; ragged.py:1545:17
	v_perm_b32 v18, v18, v45, v30
	v_perm_b32 v37, v26, v28, v24
	v_perm_b32 v26, v26, v28, v30
	v_perm_b32 v28, v20, v17, v24
	v_perm_b32 v17, v20, v17, v30
	v_perm_b32 v20, v33, v22, v24
	v_perm_b32 v22, v33, v22, v30
	v_perm_b32 v33, v19, v34, v24
	v_perm_b32 v19, v19, v34, v30
	v_perm_b32 v34, v1, v32, v24
	v_perm_b32 v1, v1, v32, v30
	v_perm_b32 v32, v23, v21, v24
	v_perm_b32 v21, v23, v21, v30
	v_perm_b32 v23, v31, v29, v24
	v_perm_b32 v24, v31, v29, v30
	v_mov_b16_e32 v29.l, v35.h
	buffer_store_b16 v35, v50, s[52:55], 0 offen
	v_add_lshl_u32 v35, v27, v14, 1
	...
	buffer_store_b16 v25, v35, s[52:55], 0 offen
	...
	s_and_b32 s17, s0, s9
	.loc	1 1545 17                       ; ragged.py:1545:17
	buffer_store_b16 v26, v25, s[52:55], 0 offen
	v_add_lshl_u32 v25, v27, v8, 1
	v_cndmask_b32_e64 v29, 0x80000000, v29, s17
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s17, s0, s8
	.loc	1 1545 17                       ; ragged.py:1545:17
	v_mov_b16_e32 v30.l, v26.h
	v_add_lshl_u32 v26, v27, v7, 1
	v_cndmask_b32_e64 v18, 0x80000000, v18, s17
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s17, s0, s7
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	buffer_store_b16 v28, v18, s[52:55], 0 offen
	v_add_lshl_u32 v18, v27, v6, 1
	buffer_store_b16 v39, v25, s[52:55], 0 offen
	v_add_lshl_u32 v25, v27, v5, 1
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s17, s0, s5
	.loc	1 1545 17                       ; ragged.py:1545:17
	v_mov_b16_e32 v38.l, v17.h
	buffer_store_b16 v17, v26, s[52:55], 0 offen
	v_add_lshl_u32 v17, v27, v4, 1
	v_cndmask_b32_e64 v18, 0x80000000, v18, s17
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s17, s0, s4
	.loc	1 1545 17                       ; ragged.py:1545:17
	...
	s_and_b32 s17, s0, s2
	.loc	1 1545 17                       ; ragged.py:1545:17
	buffer_store_b16 v20, v25, s[52:55], 0 offen
	v_add_lshl_u32 v20, v27, v2, 1
	.loc	1 1529 20                       ; ragged.py:1529:20
	s_and_b32 s0, s0, s1
	.loc	1 1545 17                       ; ragged.py:1545:17
	buffer_store_b16 v41, v17, s[52:55], 0 offen
	v_add_lshl_u32 v17, v0, v36, 1
	...
	s_clause 0x8
	buffer_store_b16 v22, v18, s[52:55], 0 offen
	buffer_store_b16 v40, v20, s[52:55], 0 offen
	buffer_store_b16 v33, v17, s[52:55], 0 offen
	...
	buffer_store_b16 v24, v3, s[52:55], 0 offen
