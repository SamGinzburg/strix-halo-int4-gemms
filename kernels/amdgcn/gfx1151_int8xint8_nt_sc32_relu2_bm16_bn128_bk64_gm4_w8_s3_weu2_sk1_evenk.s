	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow
	...
	v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v12, 0xf0, v0
...
.Ltmp19:
	...
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v7, s21, v7
	s_mov_b32 s21, s20
	s_mov_b32 s22, s20
	s_mov_b32 s23, s20
	s_mov_b32 s24, s20
...
.Ltmp20:
	...
	v_dual_mov_b32 v35, 0 :: v_dual_and_b32 v10, 0x160, v10
	v_and_b32_e32 v13, 0x90, v13
	v_lshlrev_b32_e32 v5, 4, v5
	.loc	1 328 19                        ; generate_amdgcn.py:328:19
	v_and_b32_e32 v2, 16, v3
	v_and_b32_e32 v3, 0xf70, v3
	v_dual_mov_b32 v34, 0 :: v_dual_and_b32 v15, 0x90, v15
.Ltmp21:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:336:26 ]
	s_add_i32 s0, s1, s0
.Ltmp22:
	...
	v_dual_mov_b32 v33, 0 :: v_dual_and_b32 v14, 0x90, v14
...
.Ltmp25:
	...
	v_or3_b32 v13, v4, v9, s2
	v_xor_b32_e32 v4, 16, v5
	v_xor_b32_e32 v26, 16, v25
	v_mul_lo_u32 v14, v11, s14
	v_mad_u64_u32 v[9:10], null, s16, v6, v[2:3]
	v_lshl_add_u32 v22, v1, 1, v7
	v_dual_mov_b32 v30, 0 :: v_dual_add_nc_u32 v23, 0, v8
	v_dual_mov_b32 v31, 0 :: v_dual_add_nc_u32 v24, 0, v3
	...
	v_or_b32_e32 v18, 8, v13
	v_or_b32_e32 v19, 10, v13
	v_or_b32_e32 v20, 12, v13
	v_or_b32_e32 v21, 14, v13
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v25, 0, v25
	v_dual_mov_b32 v29, 0 :: v_dual_add_nc_u32 v26, 0, v26
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v56, v13, s24, 1
	v_add_lshl_u32 v57, v15, s24, 1
	v_add_lshl_u32 v58, v16, s24, 1
	v_add_lshl_u32 v59, v17, s24, 1
	v_add_lshl_u32 v60, v18, s24, 1
	v_add_lshl_u32 v61, v19, s24, 1
	v_add_lshl_u32 v62, v20, s24, 1
	v_add_lshl_u32 v63, v21, s24, 1
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b16 v23, v45 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	s_waitcnt vmcnt(0)
	ds_store_b128 v24, v[40:43] offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	buffer_load_u16 v85, v55, s[20:23], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0x7
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[44:47], v25 offset:8192
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[48:51], v27
	ds_load_b128 v[52:55], v28
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[56:59], v25 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[60:63], v27 offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[64:67], v26 offset:8192
	...
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[44:51], v[60:63], v[56:59], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[36:43], v[52:55], v[64:67], v[36:43] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mul_f32 v45, v45, v61 :: v_dual_lshlrev_b32 v52, 16, v76
	...
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v35, v37, v54 :: v_dual_lshlrev_b32 v68, 16, v92
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_mul_f32_e32 v36, v36, v52
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v34, v38, v55
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v47, v47, v61 :: v_dual_lshlrev_b32 v56, 16, v80
	v_dual_mul_f32 v49, v49, v61 :: v_dual_lshlrev_b32 v60, 16, v84
	v_dual_mul_f32 v44, v44, v61 :: v_dual_lshlrev_b32 v63, 16, v87
	v_dual_mul_f32 v51, v51, v61 :: v_dual_lshlrev_b32 v64, 16, v88
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	...
	v_dual_mul_f32 v48, v48, v61 :: v_dual_fmac_f32 v31, v41, v58
	v_dual_mul_f32 v50, v50, v61 :: v_dual_fmac_f32 v29, v43, v60
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v10, v36, v53 :: v_dual_fmac_f32 v35, v45, v63
	.loc	1 360 22 is_stmt 1              ; generate_amdgcn.py:360:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v69, 16, v93
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v32, v40, v57 :: v_dual_fmac_f32 v31, v49, v67
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v10, v44, v62
	v_dual_fmac_f32 v34, v46, v64 :: v_dual_fmac_f32 v33, v47, v65
	v_dual_fmac_f32 v32, v48, v66 :: v_dual_fmac_f32 v29, v51, v69
	v_fmac_f32_e32 v30, v50, v68
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
; %bb.6:                                ; %._crit_edge.loopexit
	...
	v_dual_max_f32 v1, v10, v10 :: v_dual_max_f32 v2, v35, v35
	...
	v_dual_max_f32 v13, 0, v5 :: v_dual_max_f32 v6, 0, v6
	v_dual_max_f32 v14, 0, v7 :: v_dual_max_f32 v15, 0, v8
...
.Ltmp26:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 94
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 28
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     30
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
