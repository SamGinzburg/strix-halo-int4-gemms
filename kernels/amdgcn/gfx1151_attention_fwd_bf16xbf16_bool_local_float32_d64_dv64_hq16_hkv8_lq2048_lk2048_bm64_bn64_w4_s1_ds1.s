...
; %bb.4:                                ; %.lr.ph
	...
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mov_b32 v28, v25 :: v_dual_lshlrev_b32 v5, 7, v70
	v_dual_mov_b32 v27, v25 :: v_dual_lshlrev_b32 v6, 6, v72
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v2, 4, v2
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v3, s10, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v169, s8, v4
	v_dual_mov_b32 v30, v25 :: v_dual_add_nc_u32 v171, s9, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_add_nc_u32_e32 v149, v8, v152
	v_xor_b32_e32 v4, v4, v5
	v_dual_mov_b32 v5, 0x5410 :: v_dual_add_nc_u32 v252, v8, v153
	...
	v_dual_mov_b32 v8, v25 :: v_dual_add_nc_u32 v3, 0, v3
	v_mov_b32_e32 v232, 0xff800000
	v_or3_b32 v192, v6, v11, v9
	v_dual_mov_b32 v6, 0x7632 :: v_dual_add_nc_u32 v9, 0, v71
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v193, v3, v7
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 48
