...
.Ltmp17:
	...
	s_ashr_i32 s6, s5, 31
	v_dual_mov_b32 v197, 0 :: v_dual_lshlrev_b32 v2, 3, v0
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_lshr_b32 s1, s1, 26
.Ltmp19:
...
.Ltmp24:
	...
	v_mad_u64_u32 v[138:139], null, s29, v140, v[137:138]
	s_delay_alu instid0(VALU_DEP_4)
	v_add3_u32 v206, v1, v3, s31
	v_lshrrev_b32_e32 v1, 1, v0
	v_or_b32_e32 v3, s31, v141
	v_add_nc_u32_e32 v208, 0, v2
	v_or_b32_e32 v4, 0x3f0, v0
	v_or_b32_e32 v5, 0x7f0, v0
	v_and_or_b32 v1, 0x70, v1, v141
	v_or_b32_e32 v6, 16, v3
	v_or_b32_e32 v7, 32, v3
	v_mul_lo_u32 v211, v3, s2
	v_dual_mov_b32 v146, 0 :: v_dual_and_b32 v9, 28, v8
	v_add_nc_u32_e32 v210, 0, v1
	v_or_b32_e32 v1, 48, v3
	v_lshrrev_b32_e32 v3, 6, v0
	v_mul_lo_u32 v212, v6, s2
	v_mul_lo_u32 v213, v7, s2
	v_lshlrev_b32_e32 v6, 5, v0
	v_mul_lo_u32 v214, v1, s2
	v_lshlrev_b32_e32 v1, 2, v0
	v_and_b32_e32 v3, 2, v3
	v_lshlrev_b32_e32 v7, 1, v142
	v_dual_mov_b32 v193, 0 :: v_dual_and_b32 v6, 32, v6
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v174, 0 :: v_dual_and_b32 v1, 0x1c0, v1
	v_dual_mov_b32 v158, 0 :: v_dual_add_nc_u32 v3, 0, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v152, 0 :: v_dual_add_nc_u32 v215, 0, v7
	.loc	1 356 14                        ; generate_amdgcn.py:356:14
	s_lshl_b32 s0, s30, 8
	v_add3_u32 v10, v3, v1, v6
	v_dual_mov_b32 v191, 0 :: v_dual_add_nc_u32 v218, v208, v2
	s_delay_alu instid0(VALU_DEP_3)
	v_add3_u32 v11, v215, v7, v6
	v_dual_mov_b32 v144, 0 :: v_dual_add_nc_u32 v219, 0, v4
	v_dual_mov_b32 v181, 0 :: v_dual_add_nc_u32 v220, 0, v5
	v_mov_b32_e32 v1, s4
	v_lshl_add_u32 v207, s29, 4, v138
	v_dual_mov_b32 v4, s7 :: v_dual_add_nc_u32 v209, 0, v141
	v_or_b32_e32 v216, s0, v0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_lshl_add_u32 v217, s28, 5, v206
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_dual_mov_b32 v5, s8 :: v_dual_mov_b32 v6, s9
	v_dual_mov_b32 v7, s10 :: v_dual_mov_b32 v8, s11
	v_dual_mov_b32 v196, 0 :: v_dual_add_nc_u32 v221, v10, v9
	v_dual_mov_b32 v177, 0 :: v_dual_add_nc_u32 v222, v11, v9
	v_dual_mov_b32 v175, 0 :: v_dual_mov_b32 v194, 0
	v_dual_mov_b32 v165, 0 :: v_dual_mov_b32 v192, 0
	v_dual_mov_b32 v161, 0 :: v_dual_mov_b32 v204, 0
	v_dual_mov_b32 v159, 0 :: v_dual_mov_b32 v202, 0
	...
	v_dual_mov_b32 v203, 0 :: v_dual_mov_b32 v178, 0
	v_dual_mov_b32 v201, 0 :: v_dual_mov_b32 v176, 0
	v_dual_mov_b32 v199, 0 :: v_dual_mov_b32 v188, 0
	...
	v_dual_mov_b32 v139, 0 :: v_dual_mov_b32 v154, 0
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s7, s5, s29
	.loc	1 372 34                        ; generate_amdgcn.py:372:34
	v_add_nc_u32_e32 v9, s6, v206
	.loc	1 378 34                        ; generate_amdgcn.py:378:34
	s_add_i32 s7, s7, s0
	v_add_nc_u32_e32 v10, s6, v217
	v_add_nc_u32_e32 v11, s7, v138
	s_add_i32 s6, s7, s33
	v_add_nc_u32_e32 v13, s7, v207
	v_add_nc_u32_e32 v17, s6, v138
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_clause 0x1
	buffer_load_b64 v[21:22], v9, s[24:27], 0 offen
	buffer_load_b64 v[25:26], v10, s[24:27], 0 offen
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	s_clause 0x2
	buffer_load_b128 v[9:12], v11, s[8:11], 0 offen
	...
	s_waitcnt vmcnt(1)
	ds_store_b128 v218, v[13:16] offset:4096
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	ds_store_b64 v208, v[21:22] offset:16384
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	buffer_load_b128 v[21:24], v23, s[8:11], 0 offen
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v218, v[21:24] offset:12288
	.loc	1 372 26                        ; generate_amdgcn.py:372:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_load_u8 v14, v210 offset:2816
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v13, v16, v15, 0xc0c0004
	v_lshl_or_b32 v12, v10, 16, v9
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v10, v18, v17, 0xc0c0004
	ds_load_u8 v16, v210 offset:2560
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v15, v20, v19, 0xc0c0004
	v_lshl_or_b32 v11, v13, 16, v11
	ds_load_u8 v9, v210 offset:2304
	ds_load_u8 v13, v210 offset:2048
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v18, v22, v21, 0xc0c0004
	ds_load_u8 v19, v210 offset:1792
	ds_load_u8 v21, v210 offset:1536
	v_lshl_or_b32 v10, v15, 16, v10
	ds_load_u8 v15, v210 offset:1280
	ds_load_u8 v17, v210 offset:1024
	...
	ds_load_u8 v25, v210
	ds_load_u8 v23, v210 offset:256
	ds_load_u8 v26, v210 offset:768
	v_lshl_or_b32 v68, v24, 16, v22
	ds_load_u8 v22, v209 offset:18048
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v14, v16, v14, 0xc0c0004
	ds_load_u8 v16, v210 offset:512
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v13, v13, v9, 0xc0c0004
	v_lshl_or_b32 v9, v20, 16, v18
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v18, v21, v19, 0xc0c0004
	ds_load_u8 v19, v209 offset:18304
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v15, v17, v15, 0xc0c0004
	v_lshl_or_b32 v67, v14, 16, v13
	ds_load_u8 v13, v209 offset:18240
	ds_load_u8 v14, v209 offset:18176
	ds_load_u8 v17, v209 offset:18368
	ds_load_u8 v21, v209 offset:18112
	v_lshl_or_b32 v66, v18, 16, v15
	ds_load_u8 v15, v209 offset:17984
	ds_load_u8 v18, v209 offset:17920
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v20, v25, v23, 0xc0c0004
	s_waitcnt lgkmcnt(7)
	v_perm_b32 v16, v16, v26, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v65, v16, 16, v20
	ds_load_u8 v20, v209 offset:17536
	s_waitcnt lgkmcnt(5)
	v_perm_b32 v13, v14, v13, 0xc0c0004
	ds_load_u8 v14, v209 offset:17728
	...
	ds_load_u8 v22, v209 offset:17792
	v_perm_b32 v17, v19, v17, 0xc0c0004
	ds_load_u8 v19, v209 offset:17664
	v_lshl_or_b32 v15, v21, 16, v15
	v_lshl_or_b32 v16, v17, 16, v13
	ds_load_u8 v13, v209 offset:17472
	ds_load_u8 v17, v209 offset:17408
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v14, v19, v14, 0xc0c0004
	ds_load_u8 v19, v209 offset:17600
	v_perm_b32 v18, v22, v18, 0xc0c0004
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v13, v17, v13, 0xc0c0004
	ds_load_u8 v17, v210 offset:7936
	v_lshl_or_b32 v14, v18, 16, v14
	ds_load_u8 v18, v210 offset:7424
	ds_load_u8 v21, v210 offset:7168
	s_waitcnt lgkmcnt(3)
	v_perm_b32 v19, v20, v19, 0xc0c0004
	ds_load_u8 v20, v210 offset:7680
	v_lshl_or_b32 v13, v19, 16, v13
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v18, v21, v18, 0xc0c0004
	ds_load_u8 v21, v210 offset:6400
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v17, v20, v17, 0xc0c0004
	ds_load_u8 v20, v210 offset:6144
	v_lshl_or_b32 v72, v17, 16, v18
	ds_load_u8 v17, v210 offset:5376
	ds_load_u8 v18, v210 offset:5120
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v20, v20, v21, 0xc0c0004
	ds_load_u8 v21, v210 offset:6912
	ds_load_u8 v22, v210 offset:6656
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v17, v210 offset:4352
	ds_load_u8 v18, v210 offset:4096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v17, v18, v17, 0xc0c0004
	...
	ds_load_u8 v17, v210 offset:3456
	ds_load_u8 v18, v210 offset:3200
	...
	v_cvt_f32_i32_e32 v250, v20
	s_delay_alu instid0(VALU_DEP_3)
	v_cvt_f32_i32_e32 v248, v19
	...
	ds_load_u8 v11, v209 offset:16800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v11, v10, 0xc0c0004
	v_lshl_or_b32 v34, v10, 16, v9
	ds_load_u8 v9, v209 offset:16416
	ds_load_u8 v10, v209 offset:16480
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v9, v10, 0xc0c0004
	ds_load_u8 v10, v209 offset:16608
	ds_load_u8 v11, v209 offset:16544
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v11, v10, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v33, v10, 16, v9
	ds_load_u8 v9, v209 offset:18272
	ds_load_u8 v10, v209 offset:18208
	v_wmma_i32_16x16x16_iu8 v[57:64], v[73:76], v[33:36], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	ds_load_u8 v10, v209 offset:18400
	ds_load_u8 v11, v209 offset:18336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v11, v10, 0xc0c0004
	ds_load_u8 v11, v209 offset:18016
	ds_load_u8 v12, v209 offset:17952
	v_lshl_or_b32 v40, v10, 16, v9
	ds_load_u8 v9, v209 offset:17760
	ds_load_u8 v10, v209 offset:17696
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v11, v12, v11, 0xc0c0004
	ds_load_u8 v12, v209 offset:18144
	ds_load_u8 v13, v209 offset:18080
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v12, v13, v12, 0xc0c0004
	...
	ds_load_u8 v10, v209 offset:17888
	ds_load_u8 v11, v209 offset:17824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v11, v10, 0xc0c0004
	v_lshl_or_b32 v38, v10, 16, v9
	ds_load_u8 v9, v209 offset:17504
	ds_load_u8 v10, v209 offset:17440
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v9, v10, v9, 0xc0c0004
	ds_load_u8 v10, v209 offset:17632
	ds_load_u8 v11, v209 offset:17568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v10, v11, v10, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v37, v10, 16, v9
	v_wmma_i32_16x16x16_iu8 v[9:16], v[65:68], v[33:36], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v33, v209 offset:17008
	ds_load_u8 v34, v209 offset:16944
	...
	v_cvt_f32_i32_e32 v247, v10
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cvt_f32_i32_e32 v246, v9
	v_cvt_f32_i32_e32 v251, v12
	v_cvt_f32_i32_e32 v252, v11
	v_cvt_f32_i32_e32 v245, v16
	v_cvt_f32_i32_e32 v60, v60
	v_cvt_f32_i32_e32 v59, v59
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v209 offset:17136
	ds_load_u8 v35, v209 offset:17072
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	ds_load_u8 v35, v209 offset:16752
	ds_load_u8 v36, v209 offset:16688
	v_lshl_or_b32 v83, v34, 16, v33
	ds_load_u8 v33, v209 offset:16432
	ds_load_u8 v34, v209 offset:16496
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v209 offset:16880
	ds_load_u8 v37, v209 offset:16816
	s_waitcnt lgkmcnt(2)
	...
	ds_load_u8 v34, v209 offset:16624
	ds_load_u8 v35, v209 offset:16560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	v_lshl_or_b32 v81, v34, 16, v33
	ds_load_u8 v33, v209 offset:17264
	ds_load_u8 v34, v209 offset:17200
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v219 offset:16384
	ds_load_u8 v35, v209 offset:17328
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v84, v34, 16, v33
	ds_load_u8 v33, v209 offset:18032
	ds_load_u8 v34, v209 offset:17968
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v209 offset:18160
	ds_load_u8 v35, v209 offset:18096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	ds_load_u8 v35, v209 offset:17776
	ds_load_u8 v36, v209 offset:17712
	v_lshl_or_b32 v87, v34, 16, v33
	ds_load_u8 v33, v209 offset:17520
	ds_load_u8 v34, v209 offset:17456
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v209 offset:17904
	ds_load_u8 v37, v209 offset:17840
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	...
	ds_load_u8 v34, v209 offset:17648
	ds_load_u8 v35, v209 offset:17584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	v_lshl_or_b32 v85, v34, 16, v33
	ds_load_u8 v33, v209 offset:18288
	ds_load_u8 v34, v209 offset:18224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v220 offset:16384
	ds_load_u8 v35, v209 offset:18352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	...
	v_add_lshl_u32 v74, v212, s5, 1
	v_add_lshl_u32 v75, v213, s5, 1
	v_add_lshl_u32 v76, v214, s5, 1
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v225, v65
	v_cvt_f32_i32_e32 v224, v70
	...
	s_waitcnt vmcnt(0)
	ds_store_b16 v221, v73 offset:20480
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v73, v211, s5, 1
	...
	s_clause 0x3
	buffer_load_u16 v228, v73, s[12:15], 0 offen
	buffer_load_u16 v227, v74, s[12:15], 0 offen
	buffer_load_u16 v226, v75, s[12:15], 0 offen
	buffer_load_u16 v223, v76, s[12:15], 0 offen
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	ds_load_u8 v73, v209 offset:19264
	ds_load_u8 v74, v209 offset:19200
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	ds_load_u8 v74, v209 offset:19392
	ds_load_u8 v75, v209 offset:19328
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v209 offset:19008
	ds_load_u8 v76, v209 offset:18944
	v_lshl_or_b32 v92, v74, 16, v73
	ds_load_u8 v73, v209 offset:18752
	ds_load_u8 v74, v209 offset:18688
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v209 offset:19136
	ds_load_u8 v77, v209 offset:19072
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v74, v209 offset:18880
	ds_load_u8 v75, v209 offset:18816
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v90, v74, 16, v73
	ds_load_u8 v73, v209 offset:18496
	ds_load_u8 v74, v209 offset:18432
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v209 offset:18624
	ds_load_u8 v75, v209 offset:18560
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v89, v74, 16, v73
	ds_load_u8 v73, v210 offset:11520
	ds_load_u8 v74, v210 offset:11264
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:12032
	ds_load_u8 v75, v210 offset:11776
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v210 offset:10496
	ds_load_u8 v76, v210 offset:10240
	v_lshl_or_b32 v132, v74, 16, v73
	ds_load_u8 v73, v210 offset:9472
	ds_load_u8 v74, v210 offset:9216
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v210 offset:11008
	ds_load_u8 v77, v210 offset:10752
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	...
	ds_load_u8 v74, v210 offset:9984
	ds_load_u8 v75, v210 offset:9728
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v130, v74, 16, v73
	ds_load_u8 v73, v210 offset:8448
	ds_load_u8 v74, v210 offset:8192
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:8960
	ds_load_u8 v75, v210 offset:8704
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v129, v74, 16, v73
	ds_load_u8 v73, v209 offset:20288
	ds_load_u8 v74, v209 offset:20224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v209 offset:20416
	ds_load_u8 v75, v209 offset:20352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v209 offset:20032
	ds_load_u8 v76, v209 offset:19968
	v_lshl_or_b32 v96, v74, 16, v73
	ds_load_u8 v73, v209 offset:19776
	ds_load_u8 v74, v209 offset:19712
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v209 offset:20160
	ds_load_u8 v77, v209 offset:20096
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	...
	ds_load_u8 v74, v209 offset:19904
	ds_load_u8 v75, v209 offset:19840
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v94, v74, 16, v73
	ds_load_u8 v73, v209 offset:19520
	ds_load_u8 v74, v209 offset:19456
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v209 offset:19648
	ds_load_u8 v75, v209 offset:19584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v93, v74, 16, v73
	ds_load_u8 v73, v210 offset:15616
	ds_load_u8 v74, v210 offset:15360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:16128
	ds_load_u8 v75, v210 offset:15872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v210 offset:14592
	ds_load_u8 v76, v210 offset:14336
	v_lshl_or_b32 v136, v74, 16, v73
	ds_load_u8 v73, v210 offset:13568
	ds_load_u8 v74, v210 offset:13312
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v210 offset:15104
	ds_load_u8 v77, v210 offset:14848
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	...
	ds_load_u8 v74, v210 offset:14080
	ds_load_u8 v75, v210 offset:13824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v134, v74, 16, v73
	ds_load_u8 v73, v210 offset:12544
	ds_load_u8 v74, v210 offset:12288
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:13056
	ds_load_u8 v75, v210 offset:12800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v133, v74, 16, v73
	ds_load_u8 v73, v210 offset:11648
	ds_load_u8 v74, v210 offset:11392
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:12160
	ds_load_u8 v75, v210 offset:11904
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v210 offset:10624
	ds_load_u8 v76, v210 offset:10368
	v_lshl_or_b32 v232, v74, 16, v73
	ds_load_u8 v73, v210 offset:9600
	ds_load_u8 v74, v210 offset:9344
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v210 offset:11136
	ds_load_u8 v77, v210 offset:10880
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v231, v76, 16, v75
	ds_load_u8 v74, v210 offset:10112
	ds_load_u8 v75, v210 offset:9856
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v230, v74, 16, v73
	ds_load_u8 v73, v210 offset:8576
	ds_load_u8 v74, v210 offset:8320
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:9088
	ds_load_u8 v75, v210 offset:8832
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v229, v74, 16, v73
	ds_load_u8 v73, v210 offset:15744
	ds_load_u8 v74, v210 offset:15488
	v_wmma_i32_16x16x16_iu8 v[81:88], v[229:232], v[89:92], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:16256
	ds_load_u8 v75, v210 offset:16000
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	ds_load_u8 v75, v210 offset:14720
	ds_load_u8 v76, v210 offset:14464
	v_lshl_or_b32 v236, v74, 16, v73
	ds_load_u8 v73, v210 offset:13696
	ds_load_u8 v74, v210 offset:13440
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v75, v76, v75, 0xc0c0004
	ds_load_u8 v76, v210 offset:15232
	ds_load_u8 v77, v210 offset:14976
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v76, v77, v76, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v235, v76, 16, v75
	ds_load_u8 v74, v210 offset:14208
	ds_load_u8 v75, v210 offset:13952
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	v_lshl_or_b32 v234, v74, 16, v73
	ds_load_u8 v73, v210 offset:12672
	ds_load_u8 v74, v210 offset:12416
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v73, v74, v73, 0xc0c0004
	ds_load_u8 v74, v210 offset:13184
	ds_load_u8 v75, v210 offset:12928
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v233, v74, 16, v73
	v_wmma_i32_16x16x16_iu8 v[73:80], v[129:132], v[89:92], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v89, v209 offset:19280
	ds_load_u8 v90, v209 offset:19216
	v_wmma_i32_16x16x16_iu8 v[81:88], v[233:236], v[93:96], v[81:88] neg_lo:[1,1,0]
	...
	ds_load_u8 v90, v209 offset:19408
	ds_load_u8 v91, v209 offset:19344
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	ds_load_u8 v91, v209 offset:19024
	ds_load_u8 v92, v209 offset:18960
	v_lshl_or_b32 v108, v90, 16, v89
	ds_load_u8 v89, v209 offset:18768
	ds_load_u8 v90, v209 offset:18704
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v91, v92, v91, 0xc0c0004
	ds_load_u8 v92, v209 offset:19152
	ds_load_u8 v93, v209 offset:19088
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v90, v209 offset:18896
	ds_load_u8 v91, v209 offset:18832
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	v_lshl_or_b32 v106, v90, 16, v89
	ds_load_u8 v89, v209 offset:18448
	ds_load_u8 v90, v209 offset:18512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v89, v90, 0xc0c0004
	ds_load_u8 v90, v209 offset:18640
	ds_load_u8 v91, v209 offset:18576
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v105, v90, 16, v89
	ds_load_u8 v89, v209 offset:20304
	ds_load_u8 v90, v209 offset:20240
	v_wmma_i32_16x16x16_iu8 v[97:104], v[229:232], v[105:108], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	ds_load_u8 v90, v209 offset:20432
	ds_load_u8 v91, v209 offset:20368
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	ds_load_u8 v91, v209 offset:20048
	ds_load_u8 v92, v209 offset:19984
	v_lshl_or_b32 v112, v90, 16, v89
	ds_load_u8 v89, v209 offset:19792
	ds_load_u8 v90, v209 offset:19728
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v91, v92, v91, 0xc0c0004
	ds_load_u8 v92, v209 offset:20176
	ds_load_u8 v93, v209 offset:20112
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v92, v93, v92, 0xc0c0004
	...
	ds_load_u8 v90, v209 offset:19920
	ds_load_u8 v91, v209 offset:19856
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	v_lshl_or_b32 v110, v90, 16, v89
	ds_load_u8 v89, v209 offset:19536
	ds_load_u8 v90, v209 offset:19472
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v89, v90, v89, 0xc0c0004
	ds_load_u8 v90, v209 offset:19664
	ds_load_u8 v91, v209 offset:19600
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v90, v91, v90, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v109, v90, 16, v89
	v_wmma_i32_16x16x16_iu8 v[89:96], v[129:132], v[105:108], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v105, v209 offset:19296
	ds_load_u8 v106, v209 offset:19232
	v_wmma_i32_16x16x16_iu8 v[97:104], v[233:236], v[109:112], v[97:104] neg_lo:[1,1,0]
	...
	ds_load_u8 v106, v209 offset:19424
	ds_load_u8 v107, v209 offset:19360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	ds_load_u8 v107, v209 offset:19040
	ds_load_u8 v108, v209 offset:18976
	v_lshl_or_b32 v124, v106, 16, v105
	ds_load_u8 v105, v209 offset:18784
	ds_load_u8 v106, v209 offset:18720
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	ds_load_u8 v108, v209 offset:19168
	ds_load_u8 v109, v209 offset:19104
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v106, v209 offset:18912
	ds_load_u8 v107, v209 offset:18848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	v_lshl_or_b32 v122, v106, 16, v105
	ds_load_u8 v105, v209 offset:18464
	ds_load_u8 v106, v209 offset:18528
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v105, v106, 0xc0c0004
	ds_load_u8 v106, v209 offset:18656
	ds_load_u8 v107, v209 offset:18592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v121, v106, 16, v105
	ds_load_u8 v105, v209 offset:20320
	ds_load_u8 v106, v209 offset:20256
	v_wmma_i32_16x16x16_iu8 v[113:120], v[229:232], v[121:124], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	ds_load_u8 v106, v209 offset:20448
	ds_load_u8 v107, v209 offset:20384
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	ds_load_u8 v107, v209 offset:20064
	ds_load_u8 v108, v209 offset:20000
	v_lshl_or_b32 v128, v106, 16, v105
	ds_load_u8 v105, v209 offset:19808
	ds_load_u8 v106, v209 offset:19744
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v107, v108, v107, 0xc0c0004
	ds_load_u8 v108, v209 offset:20192
	ds_load_u8 v109, v209 offset:20128
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v108, v109, v108, 0xc0c0004
	...
	ds_load_u8 v106, v209 offset:19936
	ds_load_u8 v107, v209 offset:19872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	v_lshl_or_b32 v126, v106, 16, v105
	ds_load_u8 v105, v209 offset:19552
	ds_load_u8 v106, v209 offset:19488
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v105, v106, v105, 0xc0c0004
	ds_load_u8 v106, v209 offset:19680
	ds_load_u8 v107, v209 offset:19616
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v106, v107, v106, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v125, v106, 16, v105
	v_wmma_i32_16x16x16_iu8 v[105:112], v[129:132], v[121:124], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v121, v209 offset:19056
	ds_load_u8 v122, v209 offset:18992
	v_wmma_i32_16x16x16_iu8 v[113:120], v[233:236], v[125:128], v[113:120] neg_lo:[1,1,0]
	...
	ds_load_u8 v122, v209 offset:19184
	ds_load_u8 v123, v209 offset:19120
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	ds_load_u8 v123, v209 offset:18800
	ds_load_u8 v124, v209 offset:18736
	v_lshl_or_b32 v239, v122, 16, v121
	ds_load_u8 v121, v209 offset:18480
	ds_load_u8 v122, v209 offset:18544
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v123, v124, v123, 0xc0c0004
	ds_load_u8 v124, v209 offset:18928
	ds_load_u8 v125, v209 offset:18864
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v121, v121, v122, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v124, v125, v124, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v238, v124, 16, v123
	ds_load_u8 v122, v209 offset:18672
	ds_load_u8 v123, v209 offset:18608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	v_lshl_or_b32 v237, v122, 16, v121
	ds_load_u8 v121, v209 offset:19312
	ds_load_u8 v122, v209 offset:19248
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v121, v122, v121, 0xc0c0004
	ds_load_u8 v122, v219 offset:18432
	ds_load_u8 v123, v209 offset:19376
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v240, v122, 16, v121
	ds_load_u8 v121, v209 offset:20080
	ds_load_u8 v122, v209 offset:20016
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v121, v122, v121, 0xc0c0004
	ds_load_u8 v122, v209 offset:20208
	ds_load_u8 v123, v209 offset:20144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	ds_load_u8 v123, v209 offset:19824
	ds_load_u8 v124, v209 offset:19760
	v_lshl_or_b32 v243, v122, 16, v121
	ds_load_u8 v121, v209 offset:19568
	ds_load_u8 v122, v209 offset:19504
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v123, v124, v123, 0xc0c0004
	ds_load_u8 v124, v209 offset:19952
	ds_load_u8 v125, v209 offset:19888
	s_waitcnt lgkmcnt(2)
	v_perm_b32 v121, v122, v121, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v124, v125, v124, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v242, v124, 16, v123
	ds_load_u8 v122, v209 offset:19696
	ds_load_u8 v123, v209 offset:19632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	v_lshl_or_b32 v241, v122, 16, v121
	ds_load_u8 v121, v209 offset:20336
	ds_load_u8 v122, v209 offset:20272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v121, v122, v121, 0xc0c0004
	ds_load_u8 v122, v220 offset:18432
	ds_load_u8 v123, v209 offset:20400
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v122, v123, v122, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v244, v122, 16, v121
	v_wmma_i32_16x16x16_iu8 v[121:128], v[129:132], v[237:240], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[121:128], v[133:136], v[241:244], v[121:128] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[129:136], v[229:232], v[237:240], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v238, v36
	v_cvt_f32_i32_e32 v36, v38
	v_cvt_f32_i32_e32 v231, v21
	s_delay_alu instid0(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[129:136], v[233:236], v[241:244], v[129:136] neg_lo:[1,1,0]
	...
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v127, 16, v223
	v_lshlrev_b32_e32 v73, 16, v228
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v229, v49
	v_cvt_f32_i32_e32 v49, v50
	v_cvt_f32_i32_e32 v50, v64
	v_cvt_f32_i32_e32 v232, v22
	...
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v186, v75, v105 :: v_dual_lshlrev_b32 v75, 16, v226
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v62, v102
	v_cvt_f32_i32_e32 v102, v125
	v_cvt_f32_i32_e32 v125, v107
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v107, v216, s6, 1
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v106, v251, v75
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v105, v236, v73 :: v_dual_lshlrev_b32 v106, 16, v10
	.loc	1 379 23 is_stmt 1              ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v243, v14
	v_cvt_f32_i32_e32 v242, v13
	v_cvt_f32_i32_e32 v16, v134
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v156, v34, v106
	v_fmac_f32_e32 v204, v105, v106
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v105, v240, v74 :: v_dual_mul_f32 v34, v233, v73
	v_mul_f32_e32 v33, v33, v127
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	v_cndmask_b32_e32 v107, 0x80000000, v107, vcc_lo
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v27, v27, v73 :: v_dual_fmac_f32 v188, v105, v106
	v_mul_f32_e32 v105, v247, v75
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	...
	v_dual_fmac_f32 v205, v34, v105 :: v_dual_mul_f32 v34, v239, v74
	v_fmac_f32_e32 v157, v33, v105
	.loc	1 388 22 is_stmt 1              ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v33, v211, s5, 1
	v_cndmask_b32_e32 v106, 0x80000000, v106, vcc_lo
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v26, v26, v73
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v189, v34, v105
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v34, v246, v75 :: v_dual_cndmask_b32 v33, 0x80000000, v33
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	v_and_b32_e32 v10, 0xffff0000, v10
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v173, v34, v105 :: v_dual_and_b32 v12, 0xffff0000, v12
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v34, v212, s5, 1
	v_add_lshl_u32 v105, v213, s5, 1
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_cndmask_b32 v34, 0x80000000, v34 :: v_dual_cndmask_b32 v105, 0x80000000, v105
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v109, v107, s[16:19], 0 offen
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_clause 0x3
	buffer_load_u16 v33, v33, s[12:15], 0 offen
	buffer_load_u16 v34, v34, s[12:15], 0 offen
	buffer_load_u16 v128, v105, s[12:15], 0 offen
	buffer_load_u16 v129, v106, s[12:15], 0 offen
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	ds_load_b128 v[105:108], v215 offset:20496
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_store_b32 v222, v109 offset:20480
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[109:112], v215 offset:20480
	...
	s_waitcnt vmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_fmac_f32 v170, v95, v112 :: v_dual_lshlrev_b32 v95, 16, v129
	v_dual_fmac_f32 v205, v118, v109 :: v_dual_mul_f32 v96, v116, v95
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v157, v96, v109 :: v_dual_mul_f32 v96, v114, v95
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v24, v33, v24
	v_dual_mul_f32 v21, v33, v21 :: v_dual_fmac_f32 v156, v96, v110
	...
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v28, v237, v74 :: v_dual_and_b32 v9, 0xffff0000, v9
	v_mul_f32_e32 v30, v117, v30
	v_dual_mul_f32 v23, v117, v23 :: v_dual_fmac_f32 v182, v28, v96
	v_mul_f32_e32 v28, v245, v75
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v27, v235, v74
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v183, v27, v28
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v27, v244, v75
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	.loc	1 392 24 is_stmt 0              ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v26, v232, v74
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v184, v26, v27
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v26, v243, v75
	v_dual_mul_f32 v18, v95, v18 :: v_dual_and_b32 v11, 0xffff0000, v11
	v_mul_f32_e32 v17, v95, v17
	v_mul_f32_e32 v20, v95, v20
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v168, v26, v27 :: v_dual_mul_f32 v25, v25, v73
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v26, v36, v127
	v_mul_f32_e32 v36, v34, v63
	v_mul_f32_e32 v19, v95, v19
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v201, v25, v94
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v25, v231, v74
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_fmac_f32_e32 v151, v26, v27
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v185, v25, v94
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v25, v242, v75
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	ds_load_b128 v[25:28], v215 offset:20496
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	s_waitcnt lgkmcnt(0)
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v35, v127, v225 :: v_dual_fmac_f32 v148, v25, v28
	.loc	1 390 22 is_stmt 1              ; generate_amdgcn.py:390:22
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v9, v74, v48 :: v_dual_fmac_f32 v150, v25, v10
	...
	v_dual_mul_f32 v48, v95, v13 :: v_dual_fmac_f32 v159, v9, v26
	...
	v_dual_fmac_f32 v161, v40, v14 :: v_dual_fmac_f32 v158, v42, v16
	...
	v_dual_fmac_f32 v196, v21, v10 :: v_dual_fmac_f32 v195, v24, v11
	v_dual_fmac_f32 v194, v32, v12 :: v_dual_fmac_f32 v181, v33, v9
	v_dual_fmac_f32 v180, v22, v10 :: v_dual_fmac_f32 v179, v29, v11
	v_fmac_f32_e32 v178, v39, v12
	v_dual_fmac_f32 v164, v23, v10 :: v_dual_fmac_f32 v163, v30, v11
	v_dual_fmac_f32 v162, v44, v12 :: v_dual_fmac_f32 v165, v34, v9
	v_fmac_f32_e32 v152, v45, v9
	v_fmac_f32_e32 v150, v48, v10
	v_fmac_f32_e32 v193, v26, v14
	v_fmac_f32_e32 v147, v47, v11
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 253
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc32_none_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 34
...
.Ldebug_info_start0:
	...
	.long	.Ltmp66-.Ltmp25                 ; DW_AT_high_pc
	.byte	1                               ; DW_AT_call_file
