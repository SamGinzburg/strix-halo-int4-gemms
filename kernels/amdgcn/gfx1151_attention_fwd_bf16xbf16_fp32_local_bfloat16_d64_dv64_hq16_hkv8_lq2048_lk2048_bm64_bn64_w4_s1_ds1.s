...
.Ltmp0:
	...
	s_add_i32 s12, s83, s2
	s_mov_b32 s10, 0x7ffffffe
	.loc	1 601 23                        ; attention.py:601:23
	v_cmp_gt_i32_e64 s68, 0x800, v34
...
; %bb.4:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v197, s7, v4
	v_dual_mov_b32 v27, v25 :: v_dual_lshlrev_b32 v4, 7, v68
	v_dual_mov_b32 v29, v25 :: v_dual_lshlrev_b32 v6, 4, v33
	.loc	1 570 21                        ; attention.py:570:21
	v_or_b32_e32 v3, 48, v34
	.loc	1 670 47                        ; attention.py:670:47
	v_subrev_nc_u32_e32 v194, s6, v1
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v198, s7, v1
	...
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v199, s7, v2
	...
	v_dual_mov_b32 v17, v25 :: v_dual_add_nc_u32 v200, s7, v3
	.loc	1 599 26                        ; attention.py:599:26
	...
	v_dual_mov_b32 v20, v25 :: v_dual_add_nc_u32 v1, v7, v169
	v_dual_mov_b32 v174, v25 :: v_dual_add_nc_u32 v3, v8, v11
	...
	v_dual_mov_b32 v188, 0xff800000 :: v_dual_add_nc_u32 v3, v8, v12
	...
	v_dual_mov_b32 v172, v25 :: v_dual_add_nc_u32 v217, v2, v9
	s_clause 0x1                            ; 8-byte Folded Spill
	...
	v_dual_mov_b32 v19, v25 :: v_dual_add_nc_u32 v216, v2, v169
	...
	v_dual_mov_b32 v15, v25 :: v_dual_lshlrev_b32 v2, 2, v69
	...
	v_dual_mov_b32 v173, v25 :: v_dual_add_nc_u32 v234, 0, v4
	v_and_b32_e32 v1, 0x180, v1
	v_xor_b32_e32 v4, 0x60, v201
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v191, 0xff800000 :: v_dual_add_nc_u32 v240, 0, v5
	...
	v_dual_mov_b32 v203, 0xff800000 :: v_dual_add_nc_u32 v242, 0, v2
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 671 21                        ; attention.py:671:21
	s_and_b32 s21, s54, s55
	s_and_b32 s25, s48, s49
	s_and_b32 s5, s68, s21
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.private_seg_size, 76
