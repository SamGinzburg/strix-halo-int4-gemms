	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 327 14                        ; generate_amdgcn.py:327:14
	v_and_b32_e32 v3, 56, v24
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v35, v24, v26
	.loc	1 326 32                        ; generate_amdgcn.py:326:32
...
.Ltmp13:
	...
	buffer_load_b64 v[22:23], v7, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e64 v15, 0x80000000, v6, s2
	v_cndmask_b32_e64 v18, 0x80000000, v9, s2
	s_clause 0x1
	buffer_load_b128 v[6:9], v8, s[24:27], 0 offen
	buffer_load_b128 v[10:13], v5, s[24:27], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[27:28], v14, s[20:23], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	...
	v_xor_b32_e32 v36, v25, v5
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_and_b32_e32 v25, 15, v0
	v_and_b32_e32 v5, 48, v24
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v30, 0, v36
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b64 v29, v[22:23] offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(4)
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v30, v[18:21] offset:12288
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cbranch_scc1 .LBB0_2
; %bb.1:                                ; %.._crit_edge_crit_edge
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_lshl_or_b32 v27, v25, 6, v5
	s_mov_b32 s4, 0
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s0, s7, 7
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v2, s28, v2
	v_lshl_or_b32 v27, v25, 6, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b64 v[108:109], v37, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[56:59], v38, s[24:27], 0 offen
	buffer_load_b128 v[60:63], v39, s[24:27], 0 offen
	s_mov_b32 s6, s29
	s_mov_b32 s29, s0
	s_mov_b32 s0, s4
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v24, v24, v41 :: v_dual_add_nc_u32 v39, 64, v39
	v_dual_add_f32 v17, v17, v40 :: v_dual_add_nc_u32 v38, 64, v38
	v_dual_add_f32 v22, v22, v43 :: v_dual_add_nc_u32 v37, 64, v37
	v_dual_add_f32 v15, v15, v50 :: v_dual_add_nc_u32 v110, s6, v35
	v_dual_add_f32 v12, v12, v53 :: v_dual_add_nc_u32 v111, s1, v36
	...
	v_dual_add_f32 v10, v10, v49 :: v_dual_add_f32 v9, v9, v48
	v_dual_add_f32 v16, v16, v51 :: v_dual_add_f32 v11, v11, v52
	v_dual_add_f32 v14, v14, v55 :: v_dual_add_f32 v13, v13, v54
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(2)
...
; %bb.9:
	...
	s_mov_b32 s11, s4
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v1, s9, v34
	v_add_nc_u32_e32 v2, s9, v33
	v_add_nc_u32_e32 v3, s9, v32
	v_add_nc_u32_e32 v4, s9, v31
	...
	v_cvt_f32_i32_e32 v42, v42
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v24, v24, v36 :: v_dual_add_f32 v23, v23, v37
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_wmma_i32_16x16x16_iu8 v[1:8], v[51:54], v[71:74], v[1:8] neg_lo:[1,1,0]
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v21, v21, v39 :: v_dual_add_f32 v18, v18, v42
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v19, v19, v41 :: v_dual_add_f32 v10, v10, v2
...
.LBB0_12:
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 399 13 is_stmt 1              ; generate_amdgcn.py:399:13
	v_dual_add_f32 v1, v17, v1 :: v_dual_lshlrev_b32 v26, 1, v26
	...
	v_dual_add_f32 v36, v10, v36 :: v_dual_add_f32 v35, v9, v35
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v28, v24, v28 :: v_dual_lshlrev_b32 v31, 16, v43
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v32, 16, v34
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_mul_f32_e32 v36, v27, v23
	...
	v_dual_mul_f32 v38, v29, v23 :: v_dual_mul_f32 v15, v15, v28
	v_mul_f32_e32 v29, v24, v29
	v_dual_mul_f32 v30, v24, v30 :: v_dual_mul_f32 v1, v1, v33
	v_dual_mul_f32 v39, v32, v23 :: v_dual_mul_f32 v2, v2, v34
	v_mul_f32_e32 v23, v31, v23
	v_dual_mul_f32 v31, v24, v31 :: v_dual_mul_f32 v10, v10, v26
	v_dual_mul_f32 v24, v24, v32 :: v_dual_mul_f32 v9, v9, v25
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v6, v6, v38 :: v_dual_mul_f32 v7, v7, v39
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 112
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 31
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     33
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
