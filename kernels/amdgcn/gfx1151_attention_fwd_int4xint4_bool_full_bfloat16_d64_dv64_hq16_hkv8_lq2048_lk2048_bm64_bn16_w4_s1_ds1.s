...
.Ltmp0:
	...
	s_add_i32 s3, s6, s3
	v_dual_mov_b32 v18, v33 :: v_dual_and_b32 v39, 0x750031, v39
	...
	v_dual_mov_b32 v24, v33 :: v_dual_and_b32 v41, 0x750031, v47
	...
	v_dual_mov_b32 v4, v33 :: v_dual_mov_b32 v87, 0xff800000
	...
	v_or_b32_e32 v74, s5, v50
	v_or_b32_e32 v77, 2, v73
	v_or_b32_e32 v78, 4, v73
	v_or_b32_e32 v79, 6, v73
	v_or_b32_e32 v80, 8, v73
	v_or_b32_e32 v81, 10, v73
	v_or_b32_e32 v82, 12, v73
	v_or_b32_e32 v83, 14, v73
	...
	ds_bpermute_b32 v40, v60, v35
	ds_bpermute_b32 v35, v62, v35
	ds_bpermute_b32 v41, v60, v36
	ds_bpermute_b32 v36, v62, v36
	ds_bpermute_b32 v39, v60, v37
	ds_bpermute_b32 v37, v62, v37
	s_waitcnt lgkmcnt(6)
	v_cndmask_b32_e64 v43, v34, v38, s0
	s_waitcnt lgkmcnt(2)
	v_cndmask_b32_e64 v47, v36, v41, s0
	v_cndmask_b32_e64 v49, v41, v36, s0
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v48, v37, v39, s0
	v_cndmask_b32_e64 v50, v39, v37, s0
	.loc	1 590 31                        ; attention.py:590:31
	s_waitcnt vmcnt(0)
	...
	v_cndmask_b32_e64 v44, v35, v40, s0
	v_cndmask_b32_e64 v46, v40, v35, s0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v34, v34, 4, v34
	v_lshl_or_b32 v35, v38, 4, v38
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_mov_b32 v2, v33 :: v_dual_and_b32 v53, 0x5040504, v34
...
.LBB0_1:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	v_dual_mul_f32 v36, v85, v36 :: v_dual_mul_f32 v39, v39, v91
	...
	v_dual_mul_f32 v41, v85, v41 :: v_dual_mul_f32 v36, v36, v94
	v_dual_mul_f32 v34, v85, v34 :: v_dual_mul_f32 v35, v35, v95
	v_mul_f32_e32 v37, v85, v37
	v_mul_f32_e32 v38, v85, v38
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v41, v41, v89 :: v_dual_mul_f32 v34, v34, v55
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v89, s30, v35
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v37, v37, v93 :: v_dual_mul_f32 v38, v38, v92
	v_mul_f32_e32 v40, v85, v40
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v88, s30, v34 :: v_dual_mul_f32 v93, s30, v36
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v94, s30, v37 :: v_dual_mul_f32 v37, s30, v38
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v40, v40, v90
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v38, s30, v39
	...
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v39, s30, v40 :: v_dual_mul_f32 v40, s30, v41
	.loc	1 759 34                        ; attention.py:759:34
	...
	v_or_b16 v92.l, v35.l, v34.l
	v_mov_b16_e32 v34.l, v91.l
	v_mov_b16_e32 v35.l, v90.l
	...
	v_perm_b32 v35, v34, v92, v75
	v_perm_b32 v34, v34, v92, v84
	ds_bpermute_b32 v35, v60, v35
	ds_bpermute_b32 v34, v62, v34
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e64 v95, v34, v35, s0
	v_cndmask_b32_e64 v96, v35, v34, s0
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_and_b32_e32 v34, 1, v95
	v_cmp_eq_u32_e64 s7, 1, v34
	v_and_b32_e32 v34, 0x100, v95
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v88, v89, 0xff800000, s8
	.loc	1 759 25                        ; attention.py:759:25
...
.Ltmp2:
	...
	.loc	1 814 31                        ; attention.py:814:31
	v_dual_mul_f32 v34, v55, v34 :: v_dual_and_b32 v105, 1, v105
	...
	v_and_b32_e32 v38, 0x1000000, v96
	v_and_b32_e32 v96, 0x10000, v96
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 814 30                        ; attention.py:814:30
	...
	v_cndmask_b32_e64 v96, v39, 0xff800000, s18
	.loc	1 759 25                        ; attention.py:759:25
	v_and_b32_e32 v39, 0x1000000, v95
	v_and_b32_e32 v40, 0x10000, v95
	.loc	1 814 30                        ; attention.py:814:30
	s_barrier
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max_f32_e32 v38, v96, v98
.Ltmp4:
	.loc	1 759 25                        ; attention.py:759:25
	...
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v94, v94, 0xff800000, s19
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b32_e64 v93, v93, 0xff800000, s20
	v_cndmask_b32_e64 v100, v98, v94, s0
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v95, v96, v93, s0
	v_cndmask_b32_e64 v99, v93, v96, s0
	v_cndmask_b32_e64 v101, v94, v98, s0
.Ltmp5:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v39, v52, v88, v93
.Ltmp6:
	.loc	1 764 26                        ; attention.py:764:26
	ds_bpermute_b32 v100, v63, v100
	ds_bpermute_b32 v95, v63, v95
	ds_bpermute_b32 v99, v68, v99
	ds_bpermute_b32 v101, v68, v101
.Ltmp7:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v40, v94, v41, v51
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
.Ltmp10:
	...
	.loc	1 764 26                        ; attention.py:764:26
	s_waitcnt lgkmcnt(1)
	v_cndmask_b32_e64 v102, v99, v95, s1
	v_cndmask_b32_e64 v95, v95, v99, s1
	s_waitcnt lgkmcnt(0)
...
.Ltmp11:
	...
	v_max3_f32 v104, v92, v102, v95
.Ltmp12:
	.loc	1 768 62                        ; attention.py:768:62
	v_sub_f32_e32 v41, v41, v39
	v_sub_f32_e32 v93, v93, v39
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_sub_f32 v51, v51, v39 :: v_dual_max_f32 v100, v100, v101
.Ltmp13:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v97, v97, v104, v100
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp14:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
...
.Ltmp16:
	.loc	1 766 24                        ; attention.py:766:24
	v_dual_max_f32 v57, v40, v97 :: v_dual_sub_f32 v40, v86, v39
	...
	v_dual_mul_f32 v25, v25, v100 :: v_dual_max_f32 v38, v38, v97
	v_mul_f32_e32 v29, v29, v100
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v91, v102, v57 :: v_dual_sub_f32 v96, v96, v39
	.loc	1 815 23                        ; attention.py:815:23
	v_mul_f32_e32 v13, v13, v100
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	.loc	1 767 74                        ; attention.py:767:74
	v_sub_f32_e32 v97, v87, v38
	.loc	1 768 62                        ; attention.py:768:62
	v_sub_f32_e32 v87, v90, v57
	v_dual_sub_f32 v90, v92, v57 :: v_dual_mul_f32 v17, v17, v100
	v_dual_sub_f32 v92, v95, v57 :: v_dual_mul_f32 v21, v21, v100
	.loc	1 767 61                        ; attention.py:767:61
	...
	.loc	1 767 25                        ; attention.py:767:25
	v_cndmask_b32_e64 v40, 0, v97, s21
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v97, v103, v57 :: v_dual_sub_f32 v52, v52, v39
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v23, v23, v100 :: v_dual_sub_f32 v94, v94, v39
	v_mul_f32_e32 v11, v11, v100
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 768 49                        ; attention.py:768:49
	v_exp_f32_e32 v97, v97
	.loc	1 768 62 is_stmt 0              ; attention.py:768:62
	v_dual_sub_f32 v98, v98, v39 :: v_dual_mul_f32 v15, v15, v100
	.loc	1 768 49                        ; attention.py:768:49
	v_exp_f32_e32 v86, v41
	v_exp_f32_e32 v41, v96
	v_exp_f32_e32 v102, v52
	v_exp_f32_e32 v52, v93
	v_exp_f32_e32 v93, v94
	v_exp_f32_e32 v94, v98
	.loc	1 768 33                        ; attention.py:768:33
	v_cndmask_b32_e64 v96, 0, v99, s9
...
.Ltmp17:
	...
	v_add_f32_e32 v41, v96, v98
	v_dual_add_f32 v90, v99, v90 :: v_dual_mul_f32 v1, v1, v100
	v_add_f32_e32 v91, v91, v92
	v_dual_add_f32 v92, v95, v97 :: v_dual_mul_f32 v5, v5, v100
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_add_f32 v41, v41, v90 :: v_dual_sub_f32 v88, v88, v39
.Ltmp18:
	.loc	1 815 23                        ; attention.py:815:23
...
.Ltmp28:
	...
	v_and_b32_e32 v92, 1, v92
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v30, v30, v100 :: v_dual_mov_b32 v59, v41
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 816 30                        ; attention.py:816:30
