	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_xor_b32 s24, s4, s20
	.loc	1 108 23                        ; generate_amdgcn.py:108:23
	s_lshl_b32 s22, s3, 4
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_add_i32 s3, s10, s5
	.loc	1 94 13                         ; generate_amdgcn.py:94:13
	s_sub_i32 s4, s24, s20
	.loc	1 96 22                         ; generate_amdgcn.py:96:22
	s_ashr_i32 s23, s3, 1
	...
	.loc	1 129 30                        ; generate_amdgcn.py:129:30
	s_add_i32 s4, s4, s22
	v_mad_u64_u32 v[1:2], null, s23, v20, v[18:19]
	.loc	1 127 30                        ; generate_amdgcn.py:127:30
	v_add_nc_u32_e32 v2, s22, v30
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_and_b32 s17, s17, 0xffff
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 129 30 is_stmt 0              ; generate_amdgcn.py:129:30
	v_add_nc_u32_e32 v22, s4, v1
	v_add3_u32 v21, s4, s5, v1
	.loc	1 127 22 is_stmt 1              ; generate_amdgcn.py:127:22
	v_cndmask_b32_e32 v1, 0x80000000, v2, vcc_lo
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	v_or_b32_e32 v3, s22, v18
	...
	s_mov_b32 s2, 0
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_dual_cndmask_b32 v2, 0x80000000, v22 :: v_dual_cndmask_b32 v5, 0x80000000, v21
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v1, v1, s[12:15], 0 offen
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[3:4], v2, s[16:19], 0 offen
	...
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_and_b32_e32 v10, 0x778, v2
	v_xor_b32_e32 v8, v8, v10
	s_delay_alu instid0(VALU_DEP_1)
	v_add_nc_u32_e32 v27, 0, v8
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	s_waitcnt vmcnt(2)
	ds_store_b8 v26, v1 offset:4096
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_waitcnt vmcnt(0)
	ds_store_2addr_stride64_b64 v27, v[3:4], v[5:6] offset1:4
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
...
.LBB0_3:                                ; %Flow38
	...
	v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v24, 0x700, v2
...
; %bb.4:                                ; %.lr.ph
	...
	v_sub_nc_u32_e32 v28, s23, v18
	v_sub_nc_u32_e32 v29, s23, v17
	.loc	1 108 18                        ; generate_amdgcn.py:108:18
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v9, s36 :: v_dual_add_nc_u32 v2, 0x80, v22
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s0, s0, v29
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v12, s39 :: v_dual_add_nc_u32 v3, 0x80, v21
	...
	s_mov_b32 s19, s15
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v14, s41 :: v_dual_mov_b32 v11, s38
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v48, v1, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[21:22], v2, s[16:19], 0 offen
	buffer_load_b64 v[42:43], v3, s[16:19], 0 offen
	v_lshlrev_b32_e32 v1, 4, v0
	v_bfe_i32 v2, v0, 3, 1
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v16, s43 :: v_dual_mov_b32 v13, s40
.Ltmp12:
...
.Ltmp13:
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_dual_mov_b32 v15, s42 :: v_dual_and_b32 v2, 0x88, v2
.Ltmp14:
...
.Ltmp15:
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[1:8], v[34:35], v[44:45], v[9:16] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[36:37], v[44:45], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[38:39], v[46:47], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[40:41], v[46:47], v[9:16] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_cbranch_scc1 .LBB0_7
; %bb.5:                                ; %.peel.next
	v_lshl_or_b32 v20, s24, 8, v20
	s_lshl_b32 s1, s20, 8
	v_add_nc_u32_e32 v22, s3, v19
	s_add_i32 s2, s22, 0x100
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_subrev_nc_u32_e32 v20, s1, v20
	s_add_i32 s1, s0, -2
	v_or_b32_e32 v21, 0x80, v20
	v_mad_u64_u32 v[19:20], null, s23, v20, v[18:19]
	s_delay_alu instid0(VALU_DEP_1)
	v_mad_u64_u32 v[20:21], null, s23, v21, v[18:19]
	v_mad_u64_u32 v[21:22], null, s23, v22, v[17:18]
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 110 23                        ; generate_amdgcn.py:110:23
	v_cmp_lt_i32_e32 vcc_lo, s2, v28
	.loc	1 109 23                        ; generate_amdgcn.py:109:23
	v_cmp_lt_i32_e64 s0, s2, v29
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	v_add_nc_u32_e32 v34, s2, v20
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
	s_add_i32 s1, s1, -1
	s_addk_i32 s2, 0x80
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	...
	s_cmp_lg_u32 s1, 0
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	buffer_load_u8 v18, v18, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 129 22                        ; generate_amdgcn.py:129:22
	s_clause 0x1
	buffer_load_b64 v[42:43], v22, s[16:19], 0 offen
	buffer_load_b64 v[44:45], v34, s[16:19], 0 offen
	ds_load_2addr_stride64_b64 v[34:37], v31 offset1:4
	.loc	1 127 22                        ; generate_amdgcn.py:127:22
	...
	.loc	1 132 23                        ; generate_amdgcn.py:132:23
	v_wmma_i32_16x16x16_iu4 v[1:8], v[34:35], v[46:47], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[36:37], v[46:47], v[9:16] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[38:39], v[48:49], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[40:41], v[48:49], v[9:16] neg_lo:[1,1,0]
	.loc	1 106 9                         ; generate_amdgcn.py:106:9
...
; %bb.9:
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[26:27], v[20:21], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[28:29], v[32:33], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[9:16], v[30:31], v[32:33], v[9:16] neg_lo:[1,1,0]
.LBB0_10:                               ; %._crit_edge._crit_edge
	.loc	1 142 22                        ; generate_amdgcn.py:142:22
	v_or_b32_e32 v20, s3, v17
	s_delay_alu instid0(VALU_DEP_3)
	...
	s_mul_i32 s8, s21, 7
	s_mul_i32 s9, s21, 9
	s_mul_i32 s10, s21, 10
	.loc	1 218 9 is_stmt 0               ; generate_amdgcn.py:218:9
	s_and_b32 s5, s5, 0xffff
	s_mov_b32 s6, s14
	s_mov_b32 s7, s15
	.loc	1 218 23                        ; generate_amdgcn.py:218:23
	s_mul_i32 s11, s21, 11
	s_mul_i32 s16, s21, 14
	s_mul_i32 s17, s21, 15
	...
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v8, v8, v20 :: v_dual_add_nc_u32 v63, 0, v18
	...
	v_dual_mul_f32 v7, v7, v20 :: v_dual_mul_f32 v2, v2, v25
	v_mul_f32_e32 v12, v12, v20
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v0, v0, v22 :: v_dual_lshlrev_b32 v19, 2, v16
	.loc	1 144 16                        ; generate_amdgcn.py:144:16
	v_dual_mul_f32 v13, v13, v20 :: v_dual_mul_f32 v8, v8, v31
	v_mul_f32_e32 v14, v14, v20
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v1, v1, v24 :: v_dual_mul_f32 v12, v12, v35
	v_dual_mul_f32 v4, v4, v27 :: v_dual_mul_f32 v9, v9, v32
	v_mul_f32_e32 v10, v10, v33
	v_dual_mul_f32 v6, v6, v29 :: v_dual_mul_f32 v11, v11, v34
	v_dual_mul_f32 v5, v5, v28 :: v_dual_mul_f32 v14, v14, v37
	...
	ds_load_b32 v11, v11
	.loc	1 218 9 is_stmt 1               ; generate_amdgcn.py:218:9
	v_lshl_add_u32 v17, s21, 3, v19
	v_lshl_add_u32 v18, s21, 4, v19
	v_lshl_add_u32 v20, s21, 5, v19
	s_waitcnt lgkmcnt(15)
	buffer_atomic_add_f32 v0, v19, s[4:7], 0 offen
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v1, v23, s[4:7], 0 offen
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v2, v17, s[4:7], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v3, v39, s[4:7], 0 offen
	s_waitcnt lgkmcnt(11)
	buffer_atomic_add_f32 v4, v18, s[4:7], 0 offen
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v5, v40, s[4:7], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v6, v41, s[4:7], 0 offen
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v7, v42, s[4:7], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v8, v20, s[4:7], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v9, v43, s[4:7], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v10, v44, s[4:7], 0 offen
	v_add_lshl_u32 v0, v16, s17, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v12, v45, s[4:7], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v13, v46, s[4:7], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v14, v47, s[4:7], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v15, v48, s[4:7], 0 offen
	s_waitcnt lgkmcnt(0)
...
.Ltmp17:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_vgpr, 70
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.kd
