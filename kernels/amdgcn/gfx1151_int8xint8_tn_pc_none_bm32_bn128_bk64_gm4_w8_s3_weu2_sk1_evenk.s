...
.Ltmp13:
	...
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[2:3], v8, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[7:10], v9, s[24:27], 0 offen
	buffer_load_b128 v[11:14], v13, s[24:27], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[23:24], v15, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[15:18], v16, s[24:27], 0 offen
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v2, s8, v6
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	v_add3_u32 v5, s8, v5, 0x80
.Ltmp14:
...
.Ltmp15:
	...
	v_subrev_nc_u32_e32 v43, s11, v3
	v_subrev_nc_u32_e32 v44, s11, v1
	s_mov_b32 s11, s4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b64 v[25:26], v42, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x1
	buffer_load_b128 v[9:12], v44, s[24:27], 0 offen
	buffer_load_b128 v[13:16], v43, s[24:27], 0 offen
	s_mov_b32 s6, s1
	s_mov_b32 s1, s0
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	v_dual_add_f32 v34, v34, v46 :: v_dual_add_nc_u32 v43, s33, v43
	v_dual_add_f32 v27, v27, v45 :: v_dual_add_nc_u32 v44, s33, v44
	v_dual_add_f32 v33, v33, v47 :: v_dual_add_nc_u32 v42, s31, v42
	v_dual_add_f32 v28, v28, v52 :: v_dual_add_nc_u32 v237, s7, v38
	v_dual_add_f32 v17, v17, v53 :: v_dual_add_nc_u32 v238, s30, v39
	v_dual_add_f32 v32, v32, v48 :: v_dual_add_f32 v31, v31, v49
	v_dual_add_f32 v30, v30, v50 :: v_dual_add_f32 v29, v29, v51
	v_add_f32_e32 v18, v18, v54
	v_dual_add_f32 v24, v24, v56 :: v_dual_add_f32 v23, v23, v55
	v_dual_add_f32 v20, v20, v58 :: v_dual_add_f32 v19, v19, v57
	v_dual_add_f32 v22, v22, v60 :: v_dual_add_f32 v21, v21, v59
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v237, v[25:26] offset:16384
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_waitcnt vmcnt(1)
...
; %bb.9:
	...
	ds_load_u8 v38, v5 offset:1664
	ds_load_u8 v39, v5 offset:1920
	ds_load_u8 v40, v5 offset:1792
	ds_load_u8 v41, v5 offset:1536
	ds_load_u8 v42, v5 offset:1152
	ds_load_u8 v43, v5 offset:1408
	ds_load_u8 v44, v5 offset:1280
	ds_load_u8 v45, v5 offset:1024
	ds_load_u8 v46, v5 offset:640
	ds_load_u8 v47, v5 offset:896
	ds_load_u8 v50, v5 offset:768
	ds_load_u8 v51, v5 offset:512
	ds_load_u8 v54, v5 offset:128
	ds_load_u8 v55, v5 offset:384
	ds_load_u8 v56, v5 offset:256
	ds_load_u8 v57, v5
	...
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v39, v50, v47, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v38, v51, v46, 0xc0c0004
	...
	v_lshl_or_b32 v51, v39, 16, v38
	v_lshl_or_b32 v52, v13, 16, v12
	...
	v_mov_b32_e32 v6, s4
	ds_load_u8 v54, v4 offset:800
	ds_load_u8 v55, v4 offset:768
	ds_load_u8 v56, v4 offset:864
	ds_load_u8 v57, v4 offset:832
	ds_load_u8 v77, v4 offset:976
	ds_load_u8 v78, v4 offset:944
	ds_load_u8 v79, v4 offset:912
	ds_load_u8 v80, v4 offset:880
	ds_load_u8 v15, v4 offset:464
	ds_load_u8 v16, v4 offset:432
	ds_load_u8 v25, v4 offset:400
	ds_load_u8 v26, v4 offset:368
	...
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v59, v41, v40, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[38:45], v[50:53], v[46:49], v[6:13] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v54, v55, v54, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v55, v57, v56, 0xc0c0004
	v_lshl_or_b32 v49, v59, 16, v58
	ds_load_u8 v46, v4 offset:672
	ds_load_u8 v47, v4 offset:640
	ds_load_u8 v48, v4 offset:736
	ds_load_u8 v58, v4 offset:704
	ds_load_u8 v81, v4 offset:848
	ds_load_u8 v82, v4 offset:816
	ds_load_u8 v83, v4 offset:784
	ds_load_u8 v84, v4 offset:752
	ds_load_u8 v56, v4 offset:544
	ds_load_u8 v57, v4 offset:512
	ds_load_u8 v59, v4 offset:608
	ds_load_u8 v60, v4 offset:576
	ds_load_u8 v61, v5 offset:3712
	ds_load_u8 v62, v5 offset:3968
	ds_load_u8 v63, v5 offset:3840
	ds_load_u8 v64, v5 offset:3584
	ds_load_u8 v65, v5 offset:3200
	...
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v59, v64, v61, 0xc0c0004
	v_perm_b32 v46, v47, v46, 0xc0c0004
	v_perm_b32 v47, v58, v48, 0xc0c0004
	ds_load_u8 v58, v5 offset:2688
	...
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v61, v87, v65, 0xc0c0004
	v_perm_b32 v62, v86, v85, 0xc0c0004
	...
	ds_load_u8 v64, v4 offset:1312
	ds_load_u8 v65, v4 offset:1280
	ds_load_u8 v85, v4 offset:1376
	ds_load_u8 v86, v4 offset:1344
	s_waitcnt lgkmcnt(13)
	v_perm_b32 v55, v93, v92, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	v_perm_b32 v54, v94, v58, 0xc0c0004
	ds_load_u8 v58, v4 offset:1440
	ds_load_u8 v59, v4 offset:1408
	ds_load_u8 v60, v4 offset:1504
	ds_load_u8 v61, v4 offset:1472
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v93, s1, v2
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	s_waitcnt lgkmcnt(13)
	...
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v15, v15, v102, 0xc0c0004
	v_lshl_or_b32 v54, v63, 16, v62
	ds_load_u8 v62, v4 offset:1184
	ds_load_u8 v63, v4 offset:1152
	...
	v_lshl_or_b32 v48, v58, 16, v48
	v_lshl_or_b32 v49, v47, 16, v46
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v59, v63, v62, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v60, v92, v87, 0xc0c0004
	ds_load_u8 v61, v4 offset:1056
	ds_load_u8 v62, v4 offset:1024
	ds_load_u8 v63, v4 offset:1120
	ds_load_u8 v64, v4 offset:1088
	ds_load_u8 v65, v5 offset:5760
	...
	ds_load_u8 v46, v5 offset:4736
	ds_load_u8 v58, v5 offset:4864
	ds_load_u8 v59, v5 offset:4608
	ds_load_u8 v60, v5 offset:4992
	...
	s_waitcnt lgkmcnt(17)
	v_perm_b32 v64, v92, v87, 0xc0c0004
	s_waitcnt lgkmcnt(16)
	v_perm_b32 v63, v108, v65, 0xc0c0004
	s_waitcnt lgkmcnt(9)
	v_perm_b32 v59, v59, v46, 0xc0c0004
	s_waitcnt lgkmcnt(8)
	...
	v_lshl_or_b32 v60, v110, 16, v65
	v_lshl_or_b32 v59, v58, 16, v59
	v_lshl_or_b32 v58, v114, 16, v113
	ds_load_u8 v93, v93
	...
	s_waitcnt lgkmcnt(6)
	v_perm_b32 v62, v92, v87, 0xc0c0004
	v_perm_b32 v65, v122, v121, 0xc0c0004
	...
	s_waitcnt lgkmcnt(24)
	v_perm_b32 v63, v128, v125, 0xc0c0004
	...
	v_lshl_or_b32 v64, v121, 16, v116
	v_lshl_or_b32 v63, v123, 16, v122
	v_lshl_or_b32 v62, v124, 16, v5
	v_perm_b32 v5, v25, v16, 0xc0c0004
	v_perm_b32 v16, v68, v67, 0xc0c0004
	v_perm_b32 v25, v66, v26, 0xc0c0004
	v_perm_b32 v26, v72, v71, 0xc0c0004
	v_perm_b32 v66, v70, v69, 0xc0c0004
	v_perm_b32 v67, v74, v73, 0xc0c0004
	v_perm_b32 v68, v76, v75, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[38:45], v[62:65], v[46:49], v[38:45] neg_lo:[1,1,0]
	v_lshl_or_b32 v49, v15, 16, v5
	v_lshl_or_b32 v48, v25, 16, v16
	v_lshl_or_b32 v47, v66, 16, v26
	v_lshl_or_b32 v46, v67, 16, v68
	v_perm_b32 v5, v79, v78, 0xc0c0004
	v_perm_b32 v15, v77, v93, 0xc0c0004
	v_perm_b32 v16, v83, v82, 0xc0c0004
	v_perm_b32 v25, v81, v80, 0xc0c0004
	v_perm_b32 v26, v90, v89, 0xc0c0004
	v_perm_b32 v66, v88, v84, 0xc0c0004
	v_perm_b32 v67, v101, v100, 0xc0c0004
	v_perm_b32 v68, v99, v91, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[6:13], v[50:53], v[46:49], v[6:13] neg_lo:[1,1,0]
	v_lshl_or_b32 v49, v15, 16, v5
	v_lshl_or_b32 v48, v25, 16, v16
	v_lshl_or_b32 v47, v66, 16, v26
	...
	v_perm_b32 v25, v103, v98, 0xc0c0004
	v_perm_b32 v26, v107, v106, 0xc0c0004
	v_perm_b32 v50, v86, v85, 0xc0c0004
	v_perm_b32 v51, v120, v119, 0xc0c0004
	v_perm_b32 v52, v118, v117, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[6:13], v[54:57], v[46:49], v[6:13] neg_lo:[1,1,0]
	v_lshl_or_b32 v49, v15, 16, v5
	v_lshl_or_b32 v48, v25, 16, v16
	v_lshl_or_b32 v47, v50, 16, v26
	v_lshl_or_b32 v46, v52, 16, v51
	v_perm_b32 v5, v114, v113, 0xc0c0004
	v_perm_b32 v14, v110, v14, 0xc0c0004
	s_waitcnt lgkmcnt(4)
	v_perm_b32 v15, v109, v108, 0xc0c0004
	v_perm_b32 v16, v92, v87, 0xc0c0004
	v_perm_b32 v25, v143, v142, 0xc0c0004
	v_perm_b32 v26, v141, v140, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v4, v4, v115, 0xc0c0004
	v_perm_b32 v50, v112, v111, 0xc0c0004
	v_wmma_i32_16x16x16_iu8 v[6:13], v[58:61], v[46:49], v[6:13] neg_lo:[1,1,0]
	v_lshl_or_b32 v49, v14, 16, v5
	v_lshl_or_b32 v48, v16, 16, v15
	v_lshl_or_b32 v47, v26, 16, v25
	v_lshl_or_b32 v46, v50, 16, v4
	v_cvt_f32_i32_e32 v4, v39
	v_cvt_f32_i32_e32 v5, v41
	v_cvt_f32_i32_e32 v14, v42
	v_cvt_f32_i32_e32 v15, v43
	v_wmma_i32_16x16x16_iu8 v[6:13], v[62:65], v[46:49], v[6:13] neg_lo:[1,1,0]
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_f32 v20, v20, v4 :: v_dual_add_f32 v21, v21, v7
	v_dual_add_f32 v19, v19, v5 :: v_dual_add_f32 v22, v22, v6
...
; %bb.11:
	...
	ds_load_u8 v25, v4 offset:464
	ds_load_u8 v26, v4 offset:432
	...
	v_perm_b32 v26, v58, v26, 0xc0c0004
	...
	s_waitcnt lgkmcnt(35)
	v_perm_b32 v26, v72, v80, 0xc0c0004
	s_waitcnt lgkmcnt(26)
	...
	v_perm_b32 v25, v94, v93, 0xc0c0004
	v_perm_b32 v26, v92, v91, 0xc0c0004
	s_waitcnt lgkmcnt(12)
	...
	v_perm_b32 v25, v107, v90, 0xc0c0004
	v_perm_b32 v26, v81, v71, 0xc0c0004
...
.LBB0_12:
	...
	v_dual_add_f32 v11, v28, v11 :: v_dual_add_f32 v12, v17, v12
	v_dual_add_f32 v15, v20, v15 :: v_dual_add_f32 v26, v21, v26
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	v_mul_lo_u32 v36, s19, v36
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v6, v33, v6 :: v_dual_and_b32 v35, 0x78, v35
	v_dual_add_f32 v25, v24, v25 :: v_dual_add_f32 v14, v19, v14
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v13, v18, v13 :: v_dual_add_f32 v16, v23, v16
	.loc	1 416 18                        ; generate_amdgcn.py:416:18
	s_add_i32 s0, s0, s28
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v38, v22, v38 :: v_dual_mov_b32 v47, 0x7632
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	...
	v_dual_mov_b32 v46, 0x5410 :: v_dual_lshlrev_b32 v25, 1, v19
	...
	v_dual_mul_f32 v1, v31, v1 :: v_dual_mul_f32 v2, v12, v2
	...
	v_dual_mul_f32 v12, v13, v26 :: v_dual_mul_f32 v7, v7, v36
	v_dual_mul_f32 v10, v10, v39 :: v_dual_mul_f32 v1, v11, v1
	v_dual_mul_f32 v13, v16, v28 :: v_dual_mul_f32 v16, v18, v27
	v_dual_mul_f32 v9, v9, v38 :: v_dual_mul_f32 v8, v8, v37
	v_dual_mul_f32 v3, v21, v3 :: v_dual_mul_f32 v14, v14, v30
	...
	v_cndmask_b16 v1.l, 0x7fff, v10.h, s11
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm32_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 239
