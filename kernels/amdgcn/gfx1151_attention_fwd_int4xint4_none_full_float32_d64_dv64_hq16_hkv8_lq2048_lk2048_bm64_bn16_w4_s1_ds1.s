...
.Ltmp0:
	...
	v_or_b32_e32 v87, s3, v67
	v_or_b32_e32 v88, s3, v75
	v_or_b32_e32 v89, s3, v74
	v_or_b32_e32 v90, s3, v73
	v_or_b32_e32 v91, s3, v72
	v_or_b32_e32 v92, s3, v71
	v_or_b32_e32 v93, s3, v70
	v_or_b32_e32 v94, s3, v69
	v_mov_b32_e32 v76, v24
	.loc	1 742 27                        ; attention.py:742:27
	s_mul_f32 s31, s20, 0x3fb8aa3b
	...
	s_waitcnt vmcnt(0)
	v_dual_mov_b32 v0, v24 :: v_dual_lshlrev_b32 v95, 16, v46
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_mul_f32_e32 v42, v95, v42
	s_waitcnt vmcnt(8)
	v_dual_mul_f32 v44, v95, v44 :: v_dual_lshlrev_b32 v55, 16, v55
	.loc	1 727 37                        ; attention.py:727:37
	s_waitcnt vmcnt(7)
	v_lshlrev_b32_e32 v49, 16, v98
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v98, v95, v46
	.loc	1 727 37                        ; attention.py:727:37
	s_waitcnt vmcnt(6)
	...
	.loc	1 732 30                        ; attention.py:732:30
	s_waitcnt vmcnt(4)
	v_dual_mul_f32 v40, v40, v49 :: v_dual_lshlrev_b32 v51, 16, v52
	.loc	1 727 37                        ; attention.py:727:37
	s_waitcnt vmcnt(3)
	...
	.loc	1 732 30                        ; attention.py:732:30
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v42, v42, v46 :: v_dual_lshlrev_b32 v41, 16, v41
	v_dual_mul_f32 v45, v45, v52 :: v_dual_mul_f32 v44, v44, v51
	.loc	1 797 41                        ; attention.py:797:41
	buffer_load_b64 v[48:49], v48, s[24:27], 0 offen
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v41, v47, v41
	v_dual_mul_f32 v43, v43, v50 :: v_dual_mul_f32 v50, s31, v40
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v45, s31, v45 :: v_dual_mul_f32 v44, s31, v44
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v52, s31, v41 :: v_dual_mul_f32 v43, s31, v43
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v41, 0xff800000, v50, s2
	...
	s_barrier
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v47, s31, v55
	s_delay_alu instid0(VALU_DEP_1)
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v40, 0xff800000, v47, s2
	.loc	1 797 41                        ; attention.py:797:41
	s_waitcnt vmcnt(0)
	v_mov_b16_e32 v46.h, v48.l
	v_and_b32_e32 v51, 0xffff0000, v48
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v48, v98, v53
	.loc	1 775 32                        ; attention.py:775:32
	...
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v47, 0xff800000, v48, s2
	v_cndmask_b32_e64 v48, 0xff800000, v52, s2
	.loc	1 742 17                        ; attention.py:742:17
	v_mul_f32_e32 v42, s31, v42
.Ltmp1:
	.file	2 "<triton>/python/triton/language" "standard.py"
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v52, v43, v44, v45
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_max_f32_e32 v53, v47, v48
.Ltmp2:
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v42, 0xff800000, v42, s2
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v50, v40, v41, v42
	v_max3_f32 v52, v50, v52, v53
.Ltmp4:
	.loc	1 797 41                        ; attention.py:797:41
	...
	v_cndmask_b16 v55.l, v49.l, v46.l, s3
	.loc	1 775 32                        ; attention.py:775:32
...
.Ltmp5:
	...
	v_permlanex16_b32 v98, v52, s30, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp6:
	.loc	1 785 32                        ; attention.py:785:32
	v_and_b16 v46.l, v46.l, 15
	.loc	1 766 24                        ; attention.py:766:24
	v_max3_f32 v98, v99, v52, v98
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 787 56                        ; attention.py:787:56
	...
	.loc	1 787 30                        ; attention.py:787:30
	v_cndmask_b16 v103.l, v46.l, v49.l, s1
	.loc	1 785 32                        ; attention.py:785:32
	...
	.loc	1 786 29                        ; attention.py:786:29
	v_or_b16 v104.l, v46.l, v49.l
	.loc	1 785 32                        ; attention.py:785:32
	v_lshrrev_b16 v46.l, 4, v102.l
	.loc	1 814 31                        ; attention.py:814:31
	v_bfe_i32 v102, v50, 0, 16
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 787 56                        ; attention.py:787:56
	v_or_b16 v49.l, v46.l, -16
	.loc	1 814 31                        ; attention.py:814:31
	...
	v_dual_mul_f32 v50, v50, v100 :: v_dual_mul_f32 v49, v53, v49
	v_bfe_i32 v100, v104, 0, 16
	...
	.loc	1 814 31                        ; attention.py:814:31
	v_dual_mul_f32 v54, v46, v54 :: v_dual_mul_f32 v53, v53, v100
	.loc	1 814 30 is_stmt 0              ; attention.py:814:30
	v_mov_b16_e32 v100.h, v46.l
	.loc	1 768 62 is_stmt 1              ; attention.py:768:62
	v_dual_sub_f32 v40, v40, v98 :: v_dual_and_b32 v45, 1, v45
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 816 30                        ; attention.py:816:30
	...
	v_cndmask_b16 v55.l, 0x7fff, v54.h, s1
	...
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v54.h, v46.l
	v_mov_b16_e32 v54.l, v109.h
	.loc	1 814 30                        ; attention.py:814:30
	v_cndmask_b16 v40.h, 0x7fff, v49.h, s7
	ds_store_2addr_b32 v79, v55, v52 offset1:8
	...
	v_add3_u32 v41, v109, v41, 0x7fff
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
.Ltmp8:
	.loc	1 815 23                        ; attention.py:815:23
	v_dual_mul_f32 v7, v7, v99 :: v_dual_add_f32 v100, v100, v101
.Ltmp9:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xint4_none_full_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn16_w4_s1_ds1.numbered_sgpr, 34
