...
.Ltmp20:
	...
	buffer_load_b128 v[22:25], v3, s[16:19], 0 offen
	.loc	1 357 14                        ; generate_amdgcn.py:357:14
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_xor_b32_e32 v9, v14, v2
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v10, v4, 1, v11
	...
	v_perm_b32 v30, v43, v27, 0x5010400
	v_perm_b32 v27, v43, v27, 0x7030602
	v_perm_b32 v42, v44, v28, 0x5010400
	v_perm_b32 v28, v44, v28, 0x7030602
	v_perm_b32 v43, v45, v29, 0x5010400
	v_perm_b32 v29, v45, v29, 0x7030602
...
.Ltmp22:
	...
	v_subrev_nc_u32_e32 v47, s18, v5
	v_subrev_nc_u32_e32 v48, s18, v1
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v4, s27, v4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	buffer_load_b128 v[60:63], v53, s[16:19], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v55, v24, s7, 1
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	buffer_load_b128 v[64:67], v52, s[16:19], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v101, v54, s[20:23], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v102, v52, s[24:27], 0 offen
	buffer_load_u16 v103, v53, s[24:27], 0 offen
	...
	buffer_load_u16 v108, v59, s[24:27], 0 offen
	buffer_load_u16 v109, v68, s[24:27], 0 offen
	s_mov_b32 s7, s14
	s_mov_b32 s14, s34
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v56, s34, v43
	v_add_nc_u32_e32 v57, s34, v44
	v_add_nc_u32_e32 v58, s34, v45
	v_add_nc_u32_e32 v59, s34, v46
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v112, s35, v36
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s15, 0
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s35, v38
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[52:59], v[84:87], v[68:71], v[1:8] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v115, s35, v39
	v_add_nc_u32_e32 v116, s35, v40
	v_add_nc_u32_e32 v117, s35, v41
	...
	v_dual_fmac_f32 v17, v76, v74 :: v_dual_add_nc_u32 v48, s33, v48
	v_dual_fmac_f32 v12, v95, v69 :: v_dual_add_nc_u32 v47, s33, v47
	v_dual_fmac_f32 v11, v77, v75 :: v_dual_add_nc_u32 v110, s38, v34
	v_dual_fmac_f32 v16, v99, v73 :: v_dual_add_nc_u32 v111, s35, v35
	v_dual_fmac_f32 v14, v97, v71 :: v_dual_add_nc_u32 v113, s35, v37
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v10, v94, v68 :: v_dual_fmac_f32 v13, v96, v70
	v_fmac_f32_e32 v15, v98, v72
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
; %bb.6:                                ; %Flow
	.loc	1 0 5 is_stmt 0                 ; generate_amdgcn.py:0:5
	v_dual_mov_b32 v43, v33 :: v_dual_mov_b32 v44, v32
...
.LBB0_8:                                ; %Flow22
	...
	v_mov_b32_e32 v1, 0
	v_xor_b32_e32 v6, v2, v42
	v_mov_b32_e32 v2, 0
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b32_e32 v51, v6, v43
	v_mov_b32_e32 v6, 0
...
; %bb.9:
	...
	v_dual_mov_b32 v33, 0 :: v_dual_add_nc_u32 v2, s30, v52
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v6, s30, v51
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v7, s14, v29
	v_add_nc_u32_e32 v8, s14, v27
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v36, v33 :: v_dual_add_nc_u32 v31, s30, v50
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v39, v33 :: v_dual_add_nc_u32 v6, s30, v49
	v_dual_mov_b32 v38, v33 :: v_dual_add_nc_u32 v7, s14, v30
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v8, s14, v28
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_10:
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v40, v33, s[12:15], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_maskk.num_vgpr, 118
