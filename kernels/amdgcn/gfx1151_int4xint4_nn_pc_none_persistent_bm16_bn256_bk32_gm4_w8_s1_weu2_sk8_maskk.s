...
.Ltmp12:
	...
	s_max_i32 s44, s0, 1
	s_sub_i32 s0, 0, s28
	v_sub_nc_u32_e32 v22, s26, v17
	s_mul_i32 s0, s0, s6
	v_sub_nc_u32_e32 v23, s26, v20
	...
	s_bfe_i32 s45, s16, 0x1001d
	s_add_i32 s46, s6, s7
	s_lshl_b64 s[0:1], s[0:1], 2
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	s_lshl_b32 s47, s21, 7
	s_mov_b32 s16, s8
	s_mov_b32 s17, s9
	s_mov_b32 s18, s14
	s_mov_b32 s19, s15
...
; %bb.3:                                ; %.lr.ph
	...
	v_mov_b32_e32 v2, v1
	v_mad_u64_u32 v[18:19], null, s26, v3, v[17:18]
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v6, v1
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	buffer_load_u8 v19, v19, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b8 v27, v19
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v2, s48, v17
	.loc	1 222 18                        ; generate_amdgcn.py:222:18
	v_lshl_or_b32 v5, s49, 8, v0
	.loc	1 279 27                        ; generate_amdgcn.py:279:27
	s_mul_i32 s6, s48, s21
	s_mov_b32 s7, 0
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[11:14], v69
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v14, v14, v15
	ds_load_b128 v[61:64], v69 offset:16
	ds_load_b128 v[65:68], v69 offset:512
	ds_load_b128 v[69:72], v69 offset:528
	...
	v_dual_mul_f32 v12, v12, v15 :: v_dual_add_nc_u32 v73, 0, v24
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v11, v11, v60
	v_dual_mul_f32 v13, v13, v58 :: v_dual_mul_f32 v12, v12, v59
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	...
	v_dual_mul_f32 v65, v65, v15 :: v_dual_mul_f32 v54, v63, v54
	v_mul_f32_e32 v67, v67, v15
	v_dual_mul_f32 v69, v69, v15 :: v_dual_mul_f32 v10, v66, v10
	.loc	1 279 13 is_stmt 1              ; generate_amdgcn.py:279:13
	v_add_co_u32 v1, vcc_lo, s22, v1
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v71, v71, v15 :: v_dual_mul_f32 v8, v68, v8
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
	...
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v70, v70, v15 :: v_dual_mul_f32 v9, v67, v9
	v_mul_f32_e32 v15, v72, v15
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v55, v62, v55 :: v_dual_mul_f32 v4, v71, v4
	v_mul_f32_e32 v7, v69, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v19, v64, v19 :: v_dual_mul_f32 v6, v70, v6
	v_mul_f32_e32 v3, v15, v3
	ds_store_2addr_stride64_b32 v73, v11, v18 offset1:2
	ds_store_2addr_stride64_b32 v32, v12, v10 offset1:2
	ds_store_2addr_stride64_b32 v33, v13, v9 offset1:2
	ds_store_2addr_stride64_b32 v34, v14, v8 offset1:2
	ds_store_2addr_stride64_b32 v35, v56, v7 offset1:2
	ds_store_2addr_stride64_b32 v36, v55, v6 offset1:2
	ds_store_2addr_stride64_b32 v37, v54, v4 offset1:2
	ds_store_2addr_stride64_b32 v38, v19, v3 offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 279 13 is_stmt 1              ; generate_amdgcn.py:279:13
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 55
