...
.LBB0_12:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_cndmask_b32_e32 v0, 0x80000000, v0, vcc_lo
	buffer_load_u16 v184, v0, s[24:27], 0 offen
	...
	ds_load_u8_d16 v185, v0 offset:2976
...
; %bb.13:
	...
	v_wmma_i32_16x16x16_iu8 v[25:32], v[44:47], v[35:38], v[25:32] neg_lo:[1,1,0]
	v_perm_b32 v35, v185, v231, 0xc0c0004
...
.LBB0_14:
	...
	scratch_store_b32 off, v185, off offset:1124
	v_mov_b16_e64 v185.l, v225.l
...
; %bb.15:
	...
	s_clause 0x1                            ; 8-byte Folded Spill
	scratch_store_b32 off, v253, off offset:296
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 53
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_swiglu_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 1160
