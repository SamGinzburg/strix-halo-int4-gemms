	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow222
	...
	v_lshrrev_b32_e32 v63, 1, v45
	v_or_b32_e32 v67, v5, v4
	v_bfe_u32 v64, v0, 4, 1
	v_dual_mov_b32 v47, 0 :: v_dual_mov_b32 v48, 0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add3_u32 v66, 0, v4, v63
	v_dual_mov_b32 v52, 0 :: v_dual_add_nc_u32 v65, 0, v67
	...
	v_dual_mov_b32 v59, 0 :: v_dual_mov_b32 v46, 0
	v_mov_b32_e32 v61, 0
...
; %bb.4:                                ; %.lr.ph
	...
	v_add3_u32 v4, s22, v5, v4
	v_dual_mov_b32 v46, 0 :: v_dual_add_nc_u32 v5, s1, v3
	v_sub_nc_u32_e32 v70, s16, v3
	v_lshl_or_b32 v3, s14, 8, v45
	...
	v_subrev_nc_u32_e32 v72, s15, v3
	s_mov_b32 s15, s12
	s_mov_b32 s16, s12
	s_mov_b32 s17, s12
	v_add3_u32 v2, v7, s14, v2
	s_mov_b32 s14, s12
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	v_mul_lo_u32 v3, s34, v5
	v_subrev_nc_u32_e32 v75, s13, v2
	s_mov_b32 s13, s12
	...
	v_add3_u32 v76, v3, s22, v1
	v_dual_mov_b32 v59, 0 :: v_dual_mov_b32 v58, 0
	v_dual_mov_b32 v57, 0 :: v_dual_lshlrev_b32 v74, 1, v4
	v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v55, 0
	v_dual_mov_b32 v62, 0 :: v_dual_lshlrev_b32 v73, 1, v6
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	s_clause 0x1
	buffer_load_u16 v9, v74, s[40:43], 0 offen
	buffer_load_u16 v10, v73, s[40:43], 0 offen
	.loc	1 198 27                        ; generate_amdgcn.py:198:27
	v_cmp_lt_i32_e32 vcc_lo, s1, v70
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	v_cndmask_b32_e32 v9, 0x80000000, v75, vcc_lo
	.loc	1 214 26                        ; generate_amdgcn.py:214:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_add_nc_u32_e32 v75, s46, v75
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[79:80], v[17:18], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[79:80], v[81:82], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v79, v65 offset:9056
	ds_load_u8 v80, v65 offset:8992
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v79, v80, v79, 0xc0c0004
	ds_load_u8 v80, v65 offset:9184
	ds_load_u8 v81, v65 offset:9120
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v80, v81, v80, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v80, v80, 16, v79
	ds_load_u8 v79, v65 offset:8800
	ds_load_u8 v81, v65 offset:8736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v79, v81, v79, 0xc0c0004
	ds_load_u8 v81, v65 offset:8928
	ds_load_u8 v82, v65 offset:8864
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v81, v82, v81, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v79, v81, 16, v79
	v_wmma_i32_16x16x16_iu4 v[17:24], v[43:44], v[79:80], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v43, v65 offset:9568
	ds_load_u8 v44, v65 offset:9504
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v44, v43, 0xc0c0004
	ds_load_u8 v44, v65 offset:9696
	ds_load_u8 v79, v65 offset:9632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v79, v44, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v44, v44, 16, v43
	ds_load_u8 v43, v65 offset:9312
	ds_load_u8 v79, v65 offset:9248
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v43, v79, v43, 0xc0c0004
	ds_load_u8 v79, v65 offset:9440
	ds_load_u8 v80, v65 offset:9376
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v79, v80, v79, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v43, v79, 16, v43
	...
	v_add_nc_u32_e32 v31, v71, v72
	s_clause 0x7
	buffer_load_u16 v32, v31, s[36:39], 0 offen
	buffer_load_u16 v33, v31, s[36:39], 0 offen offset:4
	buffer_load_u16 v34, v31, s[36:39], 0 offen offset:8
	buffer_load_u16 v35, v31, s[36:39], 0 offen offset:12
	buffer_load_u16 v36, v31, s[36:39], 0 offen offset:16
	buffer_load_u16 v37, v31, s[36:39], 0 offen offset:20
	buffer_load_u16 v38, v31, s[36:39], 0 offen offset:24
	buffer_load_u16 v31, v31, s[36:39], 0 offen offset:28
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	...
	v_dual_mul_f32 v15, v78, v15 :: v_dual_mul_f32 v18, v77, v18
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v17, v77, v17 :: v_dual_fmac_f32 v60, v11, v34
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mul_f32 v19, v77, v19 :: v_dual_fmac_f32 v56, v15, v38
	v_dual_mul_f32 v21, v77, v21 :: v_dual_fmac_f32 v52, v20, v35
	v_dual_mul_f32 v23, v77, v23 :: v_dual_fmac_f32 v54, v18, v33
	v_dual_mul_f32 v24, v77, v24 :: v_dual_fmac_f32 v61, v10, v33
	.loc	1 233 13 is_stmt 0              ; generate_amdgcn.py:233:13
	v_dual_fmac_f32 v46, v9, v32 :: v_dual_fmac_f32 v59, v12, v35
	v_dual_fmac_f32 v58, v13, v36 :: v_dual_fmac_f32 v57, v14, v37
	v_dual_fmac_f32 v55, v16, v31 :: v_dual_fmac_f32 v62, v17, v32
	v_fmac_f32_e32 v53, v19, v34
	v_dual_fmac_f32 v51, v21, v36 :: v_dual_fmac_f32 v48, v23, v38
	v_fmac_f32_e32 v49, v22, v37
	v_fmac_f32_e32 v47, v24, v31
	.loc	1 188 9 is_stmt 1               ; generate_amdgcn.py:188:9
	s_cbranch_scc1 .LBB0_5
.LBB0_6:                                ; %._crit_edge
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v1, 32, v67
	.loc	1 195 26                        ; generate_amdgcn.py:195:26
	v_mul_i32_i24_e32 v2, s23, v67
	s_mul_i32 s1, s22, s23
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_max_i32 s0, s0, 0
	v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v10, 0
	.loc	1 195 26                        ; generate_amdgcn.py:195:26
	v_mul_i32_i24_e32 v1, s23, v1
	s_add_i32 s1, s1, s0
	...
	s_clause 0x1
	buffer_load_u16 v31, v2, s[28:31], 0 offen
	buffer_load_u16 v32, v1, s[28:31], 0 offen
...
; %bb.7:
	...
	ds_load_u8 v37, v65 offset:8224
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v1, v2, v1, 0xc0c0004
	...
	v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v6, s17
	v_dual_mov_b32 v7, s18 :: v_dual_mov_b32 v8, s19
	v_wmma_i32_16x16x16_iu4 v[9:16], v[33:34], v[17:18], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v17, v65 offset:9024
	ds_load_u8 v18, v65 offset:8960
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v17, v18, v17, 0xc0c0004
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v20, v35, v20, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v20, v20, 16, v19
	ds_load_u8 v19, v66 offset:6272
	ds_load_u8 v35, v66 offset:6144
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v19, v35, v19, 0xc0c0004
	ds_load_u8 v35, v66 offset:6528
	ds_load_u8 v36, v66 offset:6400
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v19, v35, 16, v19
	...
	v_perm_b32 v17, v18, v17, 0xc0c0004
	ds_load_u8 v18, v65 offset:12224
	ds_load_u8 v35, v65 offset:12160
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v35, v18, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	ds_load_u8 v35, v65 offset:11904
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v35, v18, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	ds_load_u8 v38, v66 offset:7936
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v18, v38, v18, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v18, v18, 16, v17
	ds_load_u8 v17, v66 offset:7296
	ds_load_u8 v38, v66 offset:7168
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v17, v38, v17, 0xc0c0004
	ds_load_u8 v38, v66 offset:7552
	ds_load_u8 v39, v66 offset:7424
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v38, v39, v38, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v17, v38, 16, v17
	v_wmma_i32_16x16x16_iu4 v[9:16], v[17:18], v[35:36], v[9:16] neg_lo:[1,1,0]
	ds_load_u8 v35, v65 offset:8544
	ds_load_u8 v36, v65 offset:8480
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_cvt_f32_i32_e32 v9, v9
	v_cvt_f32_i32_e32 v10, v10
	v_cvt_f32_i32_e32 v11, v11
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v65 offset:8672
	ds_load_u8 v38, v65 offset:8608
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v38, v36, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v36, v36, 16, v35
	ds_load_u8 v35, v65 offset:8288
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v37, v35, 0xc0c0004
	ds_load_u8 v37, v65 offset:8416
	ds_load_u8 v38, v65 offset:8352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v37, v38, v37, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v35, v37, 16, v35
	v_wmma_i32_16x16x16_iu4 v[1:8], v[33:34], v[35:36], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v33, v65 offset:9056
	ds_load_u8 v34, v65 offset:8992
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v65 offset:9184
	ds_load_u8 v35, v65 offset:9120
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v34, v34, 16, v33
	ds_load_u8 v33, v65 offset:8800
	ds_load_u8 v35, v65 offset:8736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v35, v33, 0xc0c0004
	ds_load_u8 v35, v65 offset:8928
	ds_load_u8 v36, v65 offset:8864
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v33, v35, 16, v33
	v_wmma_i32_16x16x16_iu4 v[1:8], v[29:30], v[33:34], v[1:8] neg_lo:[1,1,0]
	ds_load_u8 v29, v65 offset:9568
	ds_load_u8 v30, v65 offset:9504
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v29, v30, v29, 0xc0c0004
	ds_load_u8 v30, v65 offset:9696
	ds_load_u8 v33, v65 offset:9632
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v30, v33, v30, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v30, v30, 16, v29
	ds_load_u8 v29, v65 offset:9312
	ds_load_u8 v33, v65 offset:9248
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v29, v33, v29, 0xc0c0004
	ds_load_u8 v33, v65 offset:9440
	ds_load_u8 v34, v65 offset:9376
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.LBB0_8:
	...
	v_add_nc_u32_e32 v21, 12, v17
	v_add_nc_u32_e32 v22, 16, v17
	v_add_nc_u32_e32 v23, 20, v17
	v_add_nc_u32_e32 v24, 24, v17
	...
	s_clause 0x7
	buffer_load_u16 v25, v18, s[4:7], 0 offen
	buffer_load_u16 v26, v19, s[4:7], 0 offen
	buffer_load_u16 v27, v20, s[4:7], 0 offen
	buffer_load_u16 v28, v21, s[4:7], 0 offen
	buffer_load_u16 v22, v22, s[4:7], 0 offen
	buffer_load_u16 v23, v23, s[4:7], 0 offen
	buffer_load_u16 v24, v24, s[4:7], 0 offen
	buffer_load_u16 v29, v17, s[4:7], 0 offen
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v4, v4, v17 :: v_dual_and_b32 v21, 14, v0
	v_dual_mul_f32 v1, v1, v17 :: v_dual_lshlrev_b32 v30, 2, v0
	v_dual_mul_f32 v6, v6, v17 :: v_dual_and_b32 v31, 1, v0
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_bfe_i32 v32, v0, 0, 1
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v3, v3, v17 :: v_dual_lshlrev_b32 v34, 4, v0
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_bfe_i32 v0, v0, 7, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v8, v8, v17 :: v_dual_lshlrev_b32 v31, 6, v31
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	v_mov_b16_e32 v18.l, v17.l
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_lshlrev_b32_e32 v44, 11, v21
	v_and_b32_e32 v0, 0x840, v0
	v_and_b32_e32 v34, 0x700, v34
	v_lshlrev_b32_e32 v21, 2, v21
	v_cndmask_b32_e64 v35, 0x1008, 0, vcc_lo
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v5, v5, v17 :: v_dual_and_b32 v30, 0x78, v30
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_xor_b32_e32 v0, v0, v31
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_mul_f32_e32 v2, v2, v17
	v_dual_mul_f32 v7, v7, v17 :: v_dual_and_b32 v32, 0x840, v32
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v17, s35, v20
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_or3_b32 v0, v34, v21, v0
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v36, 60, v20
	v_or_b32_e32 v37, 52, v20
	v_or_b32_e32 v38, 44, v20
	v_or_b32_e32 v39, 36, v20
	v_or_b32_e32 v40, 28, v20
	v_or_b32_e32 v41, 20, v20
	v_or_b32_e32 v42, 12, v20
	v_or_b32_e32 v43, 4, v20
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_lshl_or_b32 v20, v45, 3, v30
	v_xor_b32_e32 v0, v0, v35
	v_lshrrev_b32_e32 v33, 1, v50
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_add3_u32 v50, s0, s33, v19
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	...
	v_xad_u32 v66, 0x2010, v0, 0
	v_xad_u32 v67, 0x4020, v0, 0
	v_xad_u32 v68, 0x6030, v0, 0
	v_or3_b32 v32, v44, v33, v32
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[19:20], null, s35, 40, v[17:18]
	v_mad_u64_u32 v[20:21], null, s35, 48, v[17:18]
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_add_nc_u32_e32 v21, 0, v32
	v_xad_u32 v33, v32, 8, 0
	v_xad_u32 v34, v32, 16, 0
	v_xad_u32 v35, v32, 24, 0
	v_xad_u32 v44, v32, 32, 0
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_xad_u32 v63, v32, 40, 0
	v_xad_u32 v64, v32, 48, 0
	v_xad_u32 v32, v32, 56, 0
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v30, s35, v43
	v_mul_lo_u32 v31, s35, v42
	v_mul_lo_u32 v41, s35, v41
	v_mul_lo_u32 v40, s35, v40
	v_mul_lo_u32 v39, s35, v39
	v_lshl_add_u32 v42, s35, 3, v17
	v_mul_lo_u32 v38, s35, v38
	v_lshl_add_u32 v43, s35, 4, v17
	v_mul_lo_u32 v37, s35, v37
	v_lshl_add_u32 v45, s35, 5, v17
	v_mul_lo_u32 v36, s35, v36
	.loc	1 247 9 is_stmt 0               ; generate_amdgcn.py:247:9
	s_and_b32 s21, s21, 0xffff
	s_mov_b32 s22, s6
	s_mov_b32 s23, s7
	v_add_lshl_u32 v19, v50, v19, 2
	v_add_lshl_u32 v20, v50, v20, 2
	...
	v_fma_f32 v9, v9, v0, v46
	v_fma_f32 v1, v1, v0, v62
	v_fma_f32 v10, v10, v25, v61
	v_fma_f32 v25, v2, v25, v54
	v_fma_f32 v11, v11, v26, v60
	v_fma_f32 v26, v3, v26, v53
	v_fma_f32 v12, v12, v27, v59
	v_fma_f32 v27, v4, v27, v52
	v_fma_f32 v13, v13, v22, v58
	v_fma_f32 v14, v14, v23, v57
	v_fma_f32 v15, v15, v24, v56
	v_fma_f32 v16, v16, v28, v55
	v_fma_f32 v22, v5, v22, v51
	v_fma_f32 v23, v6, v23, v49
	v_fma_f32 v24, v7, v24, v48
	v_fma_f32 v28, v8, v28, v47
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_cndmask_b32_e64 v0, v46, v9, s2
	v_cndmask_b32_e64 v1, v62, v1, s2
	v_cndmask_b32_e64 v2, v61, v10, s2
	v_cndmask_b32_e64 v3, v54, v25, s2
	v_cndmask_b32_e64 v4, v60, v11, s2
	v_cndmask_b32_e64 v5, v53, v26, s2
	v_cndmask_b32_e64 v6, v59, v12, s2
	v_cndmask_b32_e64 v7, v52, v27, s2
	v_cndmask_b32_e64 v8, v58, v13, s2
	v_cndmask_b32_e64 v10, v57, v14, s2
	v_cndmask_b32_e64 v12, v56, v15, s2
	v_cndmask_b32_e64 v14, v55, v16, s2
	v_cndmask_b32_e64 v9, v51, v22, s2
	v_cndmask_b32_e64 v11, v49, v23, s2
	v_cndmask_b32_e64 v13, v48, v24, s2
	v_cndmask_b32_e64 v15, v47, v28, s2
	ds_store_b64 v21, v[0:1]
	ds_store_b64 v33, v[2:3]
	ds_store_b64 v34, v[4:5]
	ds_store_b64 v35, v[6:7]
	ds_store_b64 v44, v[8:9]
	ds_store_b64 v63, v[10:11]
	ds_store_b64 v64, v[12:13]
	...
	v_add_lshl_u32 v16, v50, v17, 2
	.loc	1 247 23 is_stmt 0              ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[21:22], null, s35, 56, v[17:18]
	.loc	1 247 9                         ; generate_amdgcn.py:247:9
	v_add_lshl_u32 v17, v50, v30, 2
	v_add_lshl_u32 v22, v50, v42, 2
	v_add_lshl_u32 v23, v50, v31, 2
	v_add_lshl_u32 v24, v50, v43, 2
	v_add_lshl_u32 v25, v50, v41, 2
	v_add_lshl_u32 v26, v50, v40, 2
	v_add_lshl_u32 v27, v50, v45, 2
	v_add_lshl_u32 v28, v50, v39, 2
	v_add_lshl_u32 v18, v50, v18, 2
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v0, v16, s[20:23], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v4, v17, s[20:23], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v8, v22, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_clause 0x7
	buffer_atomic_add_f32 v12, v23, s[20:23], 0 offen
	buffer_atomic_add_f32 v2, v24, s[20:23], 0 offen
	buffer_atomic_add_f32 v6, v25, s[20:23], 0 offen
	buffer_atomic_add_f32 v10, v18, s[20:23], 0 offen
	buffer_atomic_add_f32 v14, v26, s[20:23], 0 offen
	buffer_atomic_add_f32 v1, v27, s[20:23], 0 offen
	buffer_atomic_add_f32 v5, v28, s[20:23], 0 offen
	buffer_atomic_add_f32 v9, v19, s[20:23], 0 offen
	v_add_lshl_u32 v29, v50, v38, 2
	v_add_lshl_u32 v30, v50, v37, 2
	v_add_lshl_u32 v21, v50, v21, 2
	v_add_lshl_u32 v0, v50, v36, 2
	s_clause 0x4
	buffer_atomic_add_f32 v13, v29, s[20:23], 0 offen
	buffer_atomic_add_f32 v3, v20, s[20:23], 0 offen
	buffer_atomic_add_f32 v7, v30, s[20:23], 0 offen
	buffer_atomic_add_f32 v11, v21, s[20:23], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.num_vgpr, 83
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc256_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_evenk.kd
