...
.Ltmp0:
	...
	s_add_i32 s46, s60, s2
	s_mov_b32 s11, 0x31027000
	s_mov_b32 s10, 0x7ffffffe
	.loc	1 788 26                        ; attention.py:788:26
	v_lshlrev_b32_e32 v68, 1, v0
	.loc	1 790 23                        ; attention.py:790:23
	v_cmp_gt_i32_e64 s35, 0x800, v33
	.loc	1 788 26                        ; attention.py:788:26
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v27, v25 :: v_dual_add_nc_u32 v2, s5, v2
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v117, s6, v1
	v_dual_mov_b32 v32, v25 :: v_dual_add_nc_u32 v121, s7, v1
	.loc	1 788 26                        ; attention.py:788:26
	v_or3_b32 v1, v5, v6, v7
	v_dual_mov_b32 v26, v25 :: v_dual_add_nc_u32 v3, s5, v3
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v118, s6, v2
	.loc	1 867 47                        ; attention.py:867:47
	v_add_nc_u32_e32 v122, s7, v2
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 788 26                        ; attention.py:788:26
	v_xad_u32 v2, 0x70, v1, 0
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v119, s6, v3
	.loc	1 867 47                        ; attention.py:867:47
	...
	v_dual_mov_b32 v31, v25 :: v_dual_add_nc_u32 v120, s7, v4
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_cndmask_b32_e64 v7, 0x3276, v16, s2
	v_xor_b32_e32 v5, 16, v124
	.loc	1 818 13                        ; attention.py:818:13
	v_mad_u64_u32 v[90:91], null, s47, v4, v[65:66]
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s12, v189, v120
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s17, v190, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s22, v190, v120
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s26, v191, v116
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s30, v191, v120
	.loc	1 879 36                        ; attention.py:879:36
	v_add_lshl_u32 v192, s69, v125, 2
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s10, v189, v117
	v_cmp_ge_i32_e64 s11, v189, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s13, v189, v121
	v_cmp_le_i32_e64 s16, v189, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s18, v190, v117
	v_cmp_ge_i32_e64 s19, v190, v118
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s23, v190, v121
	v_cmp_le_i32_e64 s24, v190, v122
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s27, v191, v117
	v_cmp_ge_i32_e64 s28, v191, v118
	.loc	1 867 30                        ; attention.py:867:30
	...
	.loc	1 866 30 is_stmt 1              ; attention.py:866:30
	v_cmp_ge_i32_e64 s29, v191, v119
	.loc	1 867 21                        ; attention.py:867:21
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_fp32_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 199
