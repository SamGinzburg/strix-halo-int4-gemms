...
.LBB0_4:                                ; %.lr.ph
	v_bfe_i32 v4, v0, 3, 1
	v_dual_mov_b32 v15, 0 :: v_dual_and_b32 v56, 48, v2
.Ltmp14:
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x3
	buffer_load_b128 v[101:104], v70, s[24:27], 0 offen
	buffer_load_b128 v[105:108], v71, s[24:27], 0 offen
	buffer_load_b128 v[109:112], v72, s[24:27], 0 offen
	buffer_load_b128 v[113:116], v73, s[24:27], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	v_dual_add_f32 v45, v45, v70 :: v_dual_add_f32 v44, v44, v71
	v_dual_add_f32 v43, v43, v72 :: v_dual_add_f32 v42, v42, v73
	v_dual_add_f32 v41, v41, v74 :: v_dual_add_f32 v40, v40, v75
	v_dual_add_f32 v39, v39, v76 :: v_dual_add_f32 v38, v38, v77
	v_add_f32_e32 v37, v37, v78
	v_dual_add_f32 v30, v30, v85 :: v_dual_add_nc_u32 v175, s7, v52
	v_dual_add_f32 v35, v35, v80 :: v_dual_add_nc_u32 v176, s1, v53
	v_dual_add_f32 v28, v28, v87 :: v_dual_add_nc_u32 v177, s1, v58
	v_dual_add_f32 v33, v33, v82 :: v_dual_add_nc_u32 v178, s1, v59
	v_dual_add_f32 v26, v26, v89 :: v_dual_add_nc_u32 v179, s1, v60
	v_dual_add_f32 v31, v31, v84 :: v_dual_add_nc_u32 v180, s1, v61
	v_dual_add_f32 v24, v24, v91 :: v_dual_add_nc_u32 v181, s1, v62
	v_dual_add_f32 v29, v29, v86 :: v_dual_add_nc_u32 v182, s1, v63
	v_add_f32_e32 v36, v36, v79
	v_add_f32_e32 v34, v34, v81
	v_dual_add_f32 v32, v32, v83 :: v_dual_add_f32 v27, v27, v88
	v_dual_add_f32 v22, v22, v93 :: v_dual_add_f32 v25, v25, v90
	v_dual_add_f32 v20, v20, v95 :: v_dual_add_f32 v23, v23, v92
	v_dual_add_f32 v18, v18, v97 :: v_dual_add_f32 v21, v21, v94
	v_dual_add_f32 v16, v16, v99 :: v_dual_add_f32 v19, v19, v96
	v_dual_add_f32 v17, v17, v98 :: v_dual_add_f32 v14, v14, v100
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_waitcnt vmcnt(4)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 183
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_pc_relu2_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 34
