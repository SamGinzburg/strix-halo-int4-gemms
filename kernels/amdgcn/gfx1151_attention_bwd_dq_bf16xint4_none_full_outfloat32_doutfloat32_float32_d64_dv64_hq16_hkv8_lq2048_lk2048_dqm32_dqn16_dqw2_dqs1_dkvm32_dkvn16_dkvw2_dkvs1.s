	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1                          ; -- Begin function amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1,@function
amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1:                                 ; @amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v118, 0 :: v_dual_lshlrev_b32 v189, 3, v105
	...
	v_cndmask_b32_e64 v21, 0x80000000, v23, s4
	v_cndmask_b32_e64 v17, 0x80000000, v17, s4
	v_cndmask_b32_e64 v23, 0x80000000, v24, s4
	v_cndmask_b32_e64 v22, 0x80000000, v22, s4
	s_waitcnt lgkmcnt(0)
	s_and_b32 s37, s9, 0xffff
	s_mov_b32 s36, s8
	v_cndmask_b32_e64 v24, 0x80000000, v25, s4
	...
	.loc	1 166 23                        ; attention_backward.py:166:23
	s_clause 0x7
	buffer_load_b128 v[101:104], v21, s[36:39], 0 offen
	buffer_load_b128 v[97:100], v17, s[36:39], 0 offen
	buffer_load_b128 v[93:96], v23, s[36:39], 0 offen
	buffer_load_b128 v[89:92], v22, s[36:39], 0 offen
	buffer_load_b128 v[85:88], v24, s[36:39], 0 offen
	buffer_load_b128 v[81:84], v19, s[36:39], 0 offen
	buffer_load_b128 v[77:80], v20, s[36:39], 0 offen
	buffer_load_b128 v[73:76], v18, s[36:39], 0 offen
	.loc	1 171 28                        ; attention_backward.py:171:28
	s_and_b32 s37, s11, 0xffff
	s_mov_b32 s36, s10
	s_clause 0x7
	buffer_load_b128 v[69:72], v21, s[36:39], 0 offen
	buffer_load_b128 v[65:68], v17, s[36:39], 0 offen
	buffer_load_b128 v[61:64], v23, s[36:39], 0 offen
	buffer_load_b128 v[57:60], v22, s[36:39], 0 offen
	buffer_load_b128 v[53:56], v24, s[36:39], 0 offen
	buffer_load_b128 v[49:52], v19, s[36:39], 0 offen
	buffer_load_b128 v[45:48], v20, s[36:39], 0 offen
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v211, 0, v119
	.loc	1 230 21                        ; attention_backward.py:230:21
	s_mul_i32 s1, s1, s34
	v_dual_mov_b32 v167, v34 :: v_dual_add_nc_u32 v212, 0, v120
	.loc	1 229 28                        ; attention_backward.py:229:28
	v_add_lshl_u32 v35, s1, v190, 1
	v_add_lshl_u32 v36, s1, v208, 1
	v_add_nc_u32_e32 v213, 0, v121
	v_add_nc_u32_e32 v214, 0, v122
	.loc	1 234 26                        ; attention_backward.py:234:26
	v_dual_mov_b32 v38, v33 :: v_dual_add_nc_u32 v215, 0, v123
	...
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_clause 0x1
	buffer_load_b128 v[135:138], v35, s[36:39], 0 offen
	buffer_load_b128 v[139:142], v36, s[36:39], 0 offen
	.loc	1 234 26                        ; attention_backward.py:234:26
	v_mov_b32_e32 v35, v33
	v_mov_b32_e32 v36, v33
	v_dual_mov_b32 v37, v33 :: v_dual_add_nc_u32 v216, 0, v124
	v_dual_mov_b32 v39, v33 :: v_dual_add_nc_u32 v218, 0, v126
	v_dual_mov_b32 v40, v33 :: v_dual_add_nc_u32 v217, 0, v125
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 234 26                        ; attention_backward.py:234:26
	v_dual_mov_b32 v134, v40 :: v_dual_mov_b32 v133, v39
	v_dual_mov_b32 v132, v38 :: v_dual_mov_b32 v131, v37
	v_dual_mov_b32 v130, v36 :: v_dual_mov_b32 v129, v35
	v_dual_mov_b32 v128, v34 :: v_dual_mov_b32 v127, v33
	.loc	1 229 28                        ; attention_backward.py:229:28
	s_waitcnt vmcnt(1)
	ds_store_b128 v209, v[135:138]
	s_waitcnt vmcnt(0)
	ds_store_b128 v209, v[139:142] offset:1024
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[135:138], v211
	ds_load_b128 v[139:142], v212
	ds_load_b128 v[143:146], v213
	ds_load_b128 v[147:150], v214
	ds_load_b128 v[151:154], v215
	ds_load_b128 v[155:158], v216
	ds_load_b128 v[159:162], v217
	ds_load_b128 v[163:166], v218
	.loc	1 234 26                        ; attention_backward.py:234:26
	s_waitcnt lgkmcnt(6)
	v_wmma_f32_16x16x16_bf16 v[127:134], v[135:142], v[1:8], v[127:134]
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_wmma_f32_16x16x16_bf16 v[127:134], v[143:150], v[9:16], v[127:134]
	s_waitcnt lgkmcnt(2)
	v_wmma_f32_16x16x16_bf16 v[127:134], v[151:158], v[17:24], v[127:134]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_f32_16x16x16_bf16 v[127:134], v[159:166], v[25:32], v[127:134]
	.loc	1 235 17                        ; attention_backward.py:235:17
	v_dual_mul_f32 v34, s31, v127 :: v_dual_mul_f32 v35, s31, v128
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v36, s31, v129 :: v_dual_mul_f32 v37, s31, v130
	v_dual_mul_f32 v38, s31, v131 :: v_dual_mul_f32 v39, s31, v132
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v40, s31, v133 :: v_dual_mul_f32 v127, s31, v134
	.loc	1 257 22                        ; attention_backward.py:257:22
	v_cndmask_b32_e64 v128, 0xff800000, v34, s0
	...
	v_cndmask_b32_e64 v127, 0xff800000, v127, s0
.Ltmp1:
	.file	2 "<triton>/python/triton/language" "standard.py"
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention_backward.py:258:25 ] ]
	v_max3_f32 v34, v128, v35, v36
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_max3_f32 v129, v37, v38, v39
	v_max_f32_e32 v130, v40, v127
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_max3_f32 v34, v34, v129, v130
.Ltmp2:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention_backward.py:258:25 ]
	v_permlanex16_b32 v129, v34, s3, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp3:
	.loc	1 259 20                        ; attention_backward.py:259:20
	v_max3_f32 v34, v167, v34, v129
...
.Ltmp5:
	...
	v_dual_sub_f32 v128, v128, v34 :: v_dual_add_f32 v37, v38, v39
	.loc	1 261 45                        ; attention_backward.py:261:45
	v_exp_f32_e32 v128, v128
.Ltmp6:
	.loc	2 263 12 is_stmt 1              ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:262:33 ] ]
	v_add_f32_e32 v38, v40, v127
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add_f32_e32 v35, v128, v35
	v_dual_add_f32 v35, v35, v36 :: v_dual_add_f32 v36, v37, v38
	v_dual_mov_b32 v38, v118 :: v_dual_sub_f32 v37, v167, v34
...
.Ltmp22:
	...
	v_cmp_gt_f32_e64 s1, 0x800000, v118
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
.Ltmp23:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
	v_dual_add_f32 v35, v35, v36 :: v_dual_fmac_f32 v82, v81, v49
...
.Ltmp38:
	...
	v_dual_fmac_f32 v80, v79, v47 :: v_dual_and_b32 v77, 3, v0
	v_add_f32_e32 v40, v74, v40
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v90, v89, v57 :: v_dual_mov_b32 v39, v35
	v_dual_add_f32 v73, v78, v80 :: v_dual_lshlrev_b32 v80, 9, v77
...
.Ltmp43:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
	v_dual_mov_b32 v73, v40 :: v_dual_add_f32 v38, v90, v92
...
.Ltmp44:
	...
	v_dual_add_f32 v37, v37, v38 :: v_dual_mov_b32 v38, v36
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp45:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
	v_dual_mov_b32 v74, v37 :: v_dual_add_nc_u32 v243, 0, v78
...
.Ltmp56:
	...
	v_cndmask_b32_e64 v219, 0, v34, s3
	.loc	1 266 9                         ; attention_backward.py:266:9
...
.Ltmp67:
	...
	.loc	1 266 9                         ; attention_backward.py:266:9
	s_waitcnt lgkmcnt(0)
	buffer_store_b32 v40, v38, s[12:15], 0 offen
	.loc	1 267 9                         ; attention_backward.py:267:9
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_dual_mov_b32 v33, 0 :: v_dual_lshlrev_b32 v76, 1, v73
	...
	v_cndmask_b16 v70.h, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v67, 16, 1
	v_cndmask_b16 v71.l, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v72.l, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v62, 16, 1
	v_cndmask_b16 v72.h, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v61.h, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v57, 16, 1
	v_cndmask_b16 v62.l, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v63.l, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v60, 16, 1
	v_cndmask_b16 v63.h, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v64.h, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v55, 16, 1
	v_cndmask_b16 v53.l, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v54.l, 0x7fff, v39.h, s1
	v_bfe_u32 v39, v50, 16, 1
	v_cndmask_b16 v54.h, 0x7fff, v38.h, s3
	...
	v_cndmask_b16 v56.l, 0x7fff, v38.h, s3
	...
	v_dual_mov_b32 v91, v33 :: v_dual_lshlrev_b32 v36, 2, v105
	v_lshlrev_b32_e32 v37, 3, v38
	ds_load_b32 v222, v34
	v_lshl_or_b32 v79, v79, 8, v79
	v_lshl_or_b32 v75, v75, 8, v75
	v_dual_mov_b32 v87, v33 :: v_dual_and_b32 v40, 0x420, v40
	...
	v_dual_mov_b32 v75, v33 :: v_dual_add_nc_u32 v228, 0, v34
	v_add_nc_u32_e32 v229, 0, v38
	v_add_nc_u32_e32 v230, 0, v41
	v_add_nc_u32_e32 v231, 0, v35
	v_add_nc_u32_e32 v232, 0, v36
	...
	v_add_nc_u32_e32 v242, v39, v73
	v_add_nc_u32_e32 v244, 0, v76
	v_dual_mov_b32 v34, v33 :: v_dual_add_nc_u32 v245, 0, v77
	v_dual_mov_b32 v35, v33 :: v_dual_add_nc_u32 v246, 0, v79
	v_mov_b32_e32 v36, v33
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	v_mov_b16_e64 v145.h, v220.h
	.loc	1 364 56                        ; attention_backward.py:364:56
	v_or_b32_e32 v45, -16, v220
	.loc	1 362 32                        ; attention_backward.py:362:32
	...
	.loc	1 364 30                        ; attention_backward.py:364:30
	v_cndmask_b32_e64 v45, v220, v45, s1
	.loc	1 364 56 is_stmt 0              ; attention_backward.py:364:56
	...
	v_fma_f32 v43, s31, v131, -v219
	v_fma_f32 v44, s31, v132, -v219
	v_fma_f32 v45, s31, v133, -v219
	.loc	1 382 30                        ; attention_backward.py:382:30
...
.Ltmp68:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_vgpr, 256
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 68
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1"                        ; string offset=97 ; amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
    .private_segment_fixed_size: 68
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_bwd_dq_bf16xint4_none_full_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.kd
