	...
	.text
	.globl	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1                          ; -- Begin function amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	.p2align	8
	.type	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1,@function
amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1:                                 ; @amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
.Lfunc_begin0:
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v24, v24, v161 :: v_dual_add_nc_u32 v63, 0x80, v63
	.loc	1 1213 40                       ; ragged.py:1213:40
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v178, 16, v178
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v29, v29, v161 :: v_dual_add_nc_u32 v38, 0x80, v38
	v_dual_mul_f32 v28, v28, v161 :: v_dual_add_nc_u32 v39, 0x80, v39
	v_dual_mul_f32 v31, v31, v161 :: v_dual_add_nc_u32 v40, 0x80, v40
	v_dual_mul_f32 v19, v19, v161 :: v_dual_add_nc_u32 v44, 0x80, v44
	v_dual_mul_f32 v18, v18, v161 :: v_dual_add_nc_u32 v51, 0x80, v51
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v32, v32, v161 :: v_dual_add_nc_u32 v47, 0x80, v47
	.loc	1 1213 40                       ; ragged.py:1213:40
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v10, v162, v10 :: v_dual_add_nc_u32 v37, 0x80, v37
	.loc	1 1219 17                       ; ragged.py:1219:17
	v_dual_fmac_f32 v121, v19, v173 :: v_dual_lshlrev_b32 v170, 16, v170
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v25, v25, v161 :: v_dual_add_nc_u32 v34, 0x80, v34
	v_dual_mul_f32 v26, v26, v161 :: v_dual_add_nc_u32 v35, 0x80, v35
	v_dual_mul_f32 v30, v30, v161 :: v_dual_add_nc_u32 v43, 0x80, v43
	v_dual_mul_f32 v21, v21, v161 :: v_dual_add_nc_u32 v46, 0x80, v46
	...
	.loc	1 1211 21                       ; ragged.py:1211:21
	v_dual_mul_f32 v27, v27, v161 :: v_dual_add_nc_u32 v36, 0x80, v36
	v_dual_mul_f32 v12, v162, v12 :: v_dual_add_nc_u32 v41, 0x80, v41
	v_dual_mul_f32 v17, v17, v161 :: v_dual_add_nc_u32 v42, 0x80, v42
	v_dual_mul_f32 v14, v162, v14 :: v_dual_add_nc_u32 v45, 0x80, v45
	v_dual_mul_f32 v23, v23, v161 :: v_dual_add_nc_u32 v48, 0x80, v48
	v_dual_mul_f32 v16, v162, v16 :: v_dual_add_nc_u32 v49, 0x80, v49
	v_dual_mul_f32 v9, v162, v9 :: v_dual_add_nc_u32 v50, 0x80, v50
	v_dual_mul_f32 v11, v162, v11 :: v_dual_add_nc_u32 v52, 0x80, v52
	v_dual_mul_f32 v2, v162, v2 :: v_dual_add_nc_u32 v53, 0x80, v53
	v_dual_mul_f32 v13, v162, v13 :: v_dual_add_nc_u32 v54, 0x80, v54
	v_dual_mul_f32 v20, v20, v161 :: v_dual_add_nc_u32 v55, 0x80, v55
	v_dual_mul_f32 v15, v162, v15 :: v_dual_add_nc_u32 v56, 0x80, v56
	v_dual_mul_f32 v4, v162, v4 :: v_dual_add_nc_u32 v57, 0x80, v57
	v_dual_mul_f32 v1, v162, v1 :: v_dual_add_nc_u32 v58, 0x80, v58
	v_dual_mul_f32 v22, v22, v161 :: v_dual_add_nc_u32 v59, 0x80, v59
	v_dual_mul_f32 v3, v162, v3 :: v_dual_add_nc_u32 v60, 0x80, v60
	v_dual_mul_f32 v6, v162, v6 :: v_dual_add_nc_u32 v61, 0x80, v61
	v_dual_mul_f32 v5, v162, v5 :: v_dual_add_nc_u32 v62, 0x80, v62
	v_dual_mul_f32 v7, v162, v7 :: v_dual_add_nc_u32 v64, 0x80, v64
	.loc	1 1219 17                       ; ragged.py:1219:17
...
.Ltmp12:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1, .Lfunc_end0-amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_vgpr, 203
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_agpr, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.numbered_sgpr, 97
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_recursion, 0
	.set amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1"                        ; string offset=85 ; amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1
    .private_segment_fixed_size: 0
    .sgpr_count:     99
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_ragged_int4_bwd_nt_sc256_maskk_bfloat16_scalar_bm64_bn64_bk64_w4_s3_sk1.kd
