...
.Ltmp0:
	...
	v_or_b32_e32 v89, s8, v44
	.loc	1 753 27 is_stmt 1              ; attention.py:753:27
	s_mul_i32 s0, s39, s0
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v109, s24, v97, 1
	v_add_lshl_u32 v110, s24, v98, 1
	v_add_lshl_u32 v111, s24, v99, 1
	v_add_lshl_u32 v112, s24, v100, 1
	v_add_lshl_u32 v113, s24, v101, 1
	v_add_lshl_u32 v114, s24, v102, 1
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s11, 0xff800000, v39
	...
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s4, 0xff800000, v34
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v34, v104, v44
	.loc	1 762 35                        ; attention.py:762:35
	ds_store_2addr_b64 v84, v[38:39], v[42:43] offset0:64 offset1:96
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v41, v104, v48 :: v_dual_lshlrev_b32 v38, 16, v110
	.loc	1 763 34                        ; attention.py:763:34
	v_cmp_neq_f32_e64 s12, 0xff800000, v43
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v43, v104, v107
	.loc	1 762 35                        ; attention.py:762:35
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 763 25                        ; attention.py:763:25
	...
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v36, v104, v47 :: v_dual_lshlrev_b32 v47, 16, v113
	s_delay_alu instid0(VALU_DEP_2)
	v_dual_mul_f32 v39, v34, v35 :: v_dual_mul_f32 v34, v104, v45
	.loc	1 727 37                        ; attention.py:727:37
	v_lshlrev_b32_e32 v45, 16, v111
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v35, 16, v37
	v_lshlrev_b32_e32 v37, 16, v109
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v107, v36, v38
	v_dual_mul_f32 v41, v41, v45 :: v_dual_lshlrev_b32 v48, 16, v114
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mul_f32 v40, v34, v35 :: v_dual_mul_f32 v35, v104, v46
	.loc	1 762 35                        ; attention.py:762:35
	v_add_nc_u32_e32 v34, 0, v75
	.loc	1 732 30                        ; attention.py:732:30
	v_mul_f32_e32 v44, v104, v108
	.loc	1 727 37                        ; attention.py:727:37
	v_lshlrev_b32_e32 v46, 16, v112
	.loc	1 732 30                        ; attention.py:732:30
	v_dual_mul_f32 v42, v104, v49 :: v_dual_mul_f32 v43, v43, v47
	...
	.loc	1 763 25                        ; attention.py:763:25
	v_or_b16 v47.h, v36.l, v35.l
	v_mov_b16_e32 v35.l, v45.l
	v_mov_b16_e32 v36.l, v46.l
	v_lshlrev_b16 v35.l, 8, v35.l
	.loc	1 762 35                        ; attention.py:762:35
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v45, 0x3fb8aa3b, v37 :: v_dual_mul_f32 v44, v44, v48
	.loc	1 763 25                        ; attention.py:763:25
	v_cndmask_b32_e64 v48, 0, 1, s8
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_or_b16 v47.l, v36.l, v35.l
	v_cndmask_b32_e64 v36, 0, 1, s9
	v_cndmask_b32_e64 v37, 0, 1, s11
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v45, s33, v39
	.loc	1 763 25                        ; attention.py:763:25
	v_mov_b16_e32 v35.l, v48.l
	v_lshlrev_b16 v35.l, 8, v35.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_or_b16 v46.h, v36.l, v35.l
	v_mov_b16_e32 v35.l, v37.l
	v_cndmask_b32_e64 v36, 0, 1, s10
	v_lshlrev_b16 v35.l, 8, v35.l
	s_delay_alu instid0(VALU_DEP_1)
	v_or_b16 v46.l, v36.l, v35.l
	.loc	1 762 35                        ; attention.py:762:35
	ds_load_b64 v[35:36], v92
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v38, 0x3fb8aa3b, v38 :: v_dual_mul_f32 v109, 0x3fb8aa3b, v36
	v_mul_f32_e32 v48, 0x3fb8aa3b, v35
	ds_load_b64 v[35:36], v93
	.loc	1 762 25 is_stmt 0              ; attention.py:762:25
	v_dual_fmac_f32 v38, s33, v40 :: v_dual_fmac_f32 v109, s33, v107
	v_fmac_f32_e32 v48, s33, v49
	.loc	1 762 35                        ; attention.py:762:35
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v110, 0x3fb8aa3b, v35 :: v_dual_mul_f32 v111, 0x3fb8aa3b, v36
	ds_load_b64 v[35:36], v94
	.loc	1 763 25 is_stmt 1              ; attention.py:763:25
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 762 25                        ; attention.py:762:25
	v_dual_fmac_f32 v110, s33, v41 :: v_dual_fmac_f32 v111, s33, v42
	.loc	1 762 35 is_stmt 0              ; attention.py:762:35
	v_dual_mul_f32 v112, 0x3fb8aa3b, v35 :: v_dual_mul_f32 v113, 0x3fb8aa3b, v36
	.loc	1 763 25 is_stmt 1              ; attention.py:763:25
	v_add_nc_u32_e32 v35, v71, v72
	v_add_nc_u32_e32 v36, 0, v73
	ds_store_b32 v35, v47
	ds_store_b32 v95, v46
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v113, s33, v44
	.loc	1 763 25                        ; attention.py:763:25
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_u16_d16 v35, v36
	s_waitcnt lgkmcnt(0)
	ds_load_u16_d16_hi v35, v85
	ds_load_u16_d16 v36, v86
	s_waitcnt lgkmcnt(0)
	ds_load_u16_d16_hi v36, v87
	...
	v_cmp_eq_u16_e64 s18, 1, v37.l
	v_and_b16 v37.l, 1, v35.h
	v_and_b16 v35.l, 1, v35.l
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_cmp_eq_u16_e64 s15, 1, v37.l
	v_and_b16 v37.l, 1, v36.l
	v_cmp_eq_u16_e64 s19, 1, v35.l
	v_lshrrev_b16 v35.l, 8, v35.h
	v_lshrrev_b16 v35.h, 8, v36.l
	v_lshrrev_b16 v36.l, 8, v36.h
	v_cmp_eq_u16_e64 s13, 1, v37.l
	v_and_b16 v37.l, 1, v36.h
	v_and_b16 v35.l, 1, v35.l
	v_and_b16 v35.h, 1, v35.h
	v_and_b16 v36.l, 1, v36.l
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v39, 0xff800000, v110, s13
	.loc	1 763 25                        ; attention.py:763:25
	v_cmp_eq_u16_e64 s12, 1, v37.l
	v_cmp_eq_u16_e64 s17, 1, v35.l
	v_cmp_eq_u16_e64 s16, 1, v35.h
	v_cmp_eq_u16_e64 s14, 1, v36.l
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v35, 0xff800000, v45, s18
	v_cndmask_b32_e64 v37, 0xff800000, v48, s15
	v_cndmask_b32_e64 v36, 0xff800000, v38, s19
	v_cndmask_b32_e64 v38, 0xff800000, v109, s17
	v_cndmask_b32_e64 v42, 0xff800000, v113, s14
	.loc	1 762 25                        ; attention.py:762:25
	v_fmac_f32_e32 v112, s33, v43
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v40, 0xff800000, v111, s16
.Ltmp1:
	.file	2 "<triton>/python/triton/language" "standard.py"
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v45, v35, v36, v37
.Ltmp2:
	.loc	1 764 26                        ; attention.py:764:26
	ds_store_b64 v34, v[35:36]
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v43.h, v108.l
	.loc	1 764 26                        ; attention.py:764:26
	v_cndmask_b32_e64 v41, 0xff800000, v112, s12
.Ltmp3:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v46, v38, v39, v40
.Ltmp4:
	.loc	1 764 26                        ; attention.py:764:26
	ds_store_b64 v92, v[37:38]
...
.Ltmp6:
	.loc	1 764 26                        ; attention.py:764:26
	ds_store_b64 v94, v[41:42]
	s_waitcnt lgkmcnt(0)
	s_barrier
.Ltmp7:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_max3_f32 v34, v45, v46, v47
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
.Ltmp8:
	.loc	2 191 16                        ; standard.py:191:16 @[ attention.py:765:29 ]
	v_permlanex16_b32 v45, v34, s25, 0xfedcba98 op_sel:[1,0]
.Ltmp9:
	.loc	1 766 24                        ; attention.py:766:24
	v_max3_f32 v107, v106, v34, v45
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_cndmask_b16 v36.h, 0x7fff, v34.h, s18
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_cndmask_b16 v36.l, 0x7fff, v35.h, s19
	.loc	1 771 36                        ; attention.py:771:36
	s_lshr_b32 s18, s24, 1
	.loc	1 816 30                        ; attention.py:816:30
	v_permlanex16_b32 v35, v36, s25, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
	v_perm_b32 v34, v35, v36, v62
	v_perm_b32 v35, v35, v36, v63
	.loc	1 774 30                        ; attention.py:774:30
	v_add_nc_u32_e32 v36, s18, v80
	v_mad_u64_u32 v[43:44], null, v36, s37, v[0:1]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	.loc	1 775 32                        ; attention.py:775:32
	v_cndmask_b32_e64 v36, 0x80000000, v43, s3
	.loc	1 816 30                        ; attention.py:816:30
	v_mov_b16_e32 v43.h, v108.l
	...
	v_cndmask_b16 v38.h, 0x7fff, v38.h, s17
	v_and_b32_e32 v43, 1, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_add3_u32 v37, v37, v43, 0x7fff
	v_mov_b16_e32 v43.h, v108.l
	v_mov_b16_e32 v43.l, v40.h
	v_cndmask_b16 v38.l, 0x7fff, v37.h, s15
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_and_b32_e32 v43, 1, v43
	v_permlanex16_b32 v37, v38, s25, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_add3_u32 v40, v40, v43, 0x7fff
	v_mov_b16_e32 v43.h, v108.l
	v_mov_b16_e32 v43.l, v39.h
	v_perm_b32 v36, v37, v38, v62
	v_perm_b32 v37, v37, v38, v63
	v_cndmask_b16 v40.h, 0x7fff, v40.h, s16
	...
	v_perm_b32 v38, v39, v40, v62
	v_perm_b32 v39, v39, v40, v63
	v_cndmask_b16 v42.h, 0x7fff, v42.h, s14
	v_and_b32_e32 v43, 1, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_add3_u32 v41, v41, v43, 0x7fff
	v_cndmask_b16 v42.l, 0x7fff, v41.h, s12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v41, v42, s25, 0xfedcba98 op_sel:[1,0]
	v_perm_b32 v40, v41, v42, v62
	v_perm_b32 v41, v41, v42, v63
	...
	s_waitcnt vmcnt(0)
	v_and_b32_e32 v44, 0xffff0000, v109
...
.Ltmp30:
	.loc	1 766 24                        ; attention.py:766:24
	v_dual_max_f32 v38, v79, v79 :: v_dual_max_f32 v39, v105, v105
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
.Ltmp31:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
	v_dual_mov_b32 v41, v35 :: v_dual_max_f32 v36, v38, v36
.Ltmp32:
	.loc	1 766 24                        ; attention.py:766:24
...
.Ltmp34:
	...
	v_dual_sub_f32 v38, v79, v36 :: v_dual_sub_f32 v39, v105, v37
...
.Ltmp39:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:769:24 ] ]
	v_dual_add_f32 v51, v35, v41 :: v_dual_add_f32 v50, v34, v40
	s_mov_b32 s24, s4
	s_delay_alu instid0(VALU_DEP_1)
.Ltmp40:
	.loc	1 817 23                        ; attention.py:817:23
	v_dual_fmac_f32 v51, v43, v39 :: v_dual_fmac_f32 v50, v42, v38
	.loc	1 707 13                        ; attention.py:707:13
