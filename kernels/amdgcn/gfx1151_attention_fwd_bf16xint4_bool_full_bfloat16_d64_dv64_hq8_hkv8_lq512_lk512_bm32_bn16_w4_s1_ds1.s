	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
.Lfunc_begin0:
...
.Ltmp0:
	...
	v_dual_mov_b32 v17, 0 :: v_dual_and_b32 v68, 15, v0
	...
	v_dual_mov_b32 v102, 0xff800000 :: v_dual_lshlrev_b32 v29, 5, v0
	v_bfe_i32 v30, v0, 2, 1
	.loc	1 566 23                        ; attention.py:566:23
	s_add_i32 s0, s3, s0
	.loc	1 599 26                        ; attention.py:599:26
	v_lshl_or_b32 v72, v68, 7, v13
	...
	s_waitcnt vmcnt(0)
	ds_store_b128 v76, v[9:12] offset:2048
	v_mov_b32_e32 v7, v17
	v_lshrrev_b32_e32 v34, 4, v20
	v_dual_mov_b32 v11, v17 :: v_dual_lshlrev_b32 v32, 2, v24
	v_dual_mov_b32 v103, 0xff800000 :: v_dual_lshlrev_b32 v24, 4, v24
	v_dual_mov_b32 v101, 0xff800000 :: v_dual_mov_b32 v8, v17
	v_lshrrev_b32_e32 v33, 5, v69
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_xor_b32_e32 v13, v21, v32
	v_or3_b32 v73, v24, v34, v25
	v_lshlrev_b32_e32 v36, 2, v20
	v_lshlrev_b32_e32 v42, 4, v20
	v_dual_mov_b32 v10, v17 :: v_dual_lshlrev_b32 v31, 2, v15
	v_dual_mov_b32 v100, 0 :: v_dual_lshlrev_b32 v15, 5, v15
	v_or_b32_e32 v77, v13, v33
	v_xor_b32_e32 v13, 4, v73
	v_or3_b32 v75, v30, v42, v29
	v_add3_u32 v95, s3, v31, v14
	v_mov_b32_e32 v14, v17
	v_lshl_or_b32 v19, v67, 4, v36
	...
	v_lshl_add_u32 v38, v69, 1, 0
	v_or3_b32 v78, v15, v19, v35
	v_xor_b32_e32 v15, v16, v66
	v_xor_b32_e32 v16, 16, v75
	v_lshrrev_b32_e32 v41, 1, v69
	v_xor_b32_e32 v22, v28, v22
	v_lshl_or_b32 v18, v20, 6, v72
	v_add3_u32 v21, 0, v40, v20
	v_add_nc_u32_e32 v94, 0, v16
	v_dual_mov_b32 v16, v17 :: v_dual_and_b32 v27, 0x700, v27
	v_lshlrev_b32_e32 v23, 1, v20
	v_add_nc_u32_e32 v93, v38, v15
	v_dual_mov_b32 v15, v17 :: v_dual_add_nc_u32 v74, 0, v0
	s_delay_alu instid0(VALU_DEP_4)
	v_add_nc_u32_e32 v25, 0, v27
	v_add_nc_u32_e32 v24, 0, v41
	v_xor_b32_e32 v26, 32, v72
	v_xor_b32_e32 v27, 48, v72
	v_xor_b32_e32 v28, 64, v72
	v_xor_b32_e32 v29, 0x50, v72
	v_xor_b32_e32 v30, 0x60, v72
	v_xor_b32_e32 v32, 0x70, v72
	v_xor_b32_e32 v33, 8, v73
	v_xor_b32_e32 v34, 12, v73
	v_add_nc_u32_e32 v82, v25, v22
	v_add_nc_u32_e32 v19, 0, v18
	v_xor_b32_e32 v25, 0x108, v77
	v_xor_b32_e32 v35, 8, v78
	v_xor_b32_e32 v36, 16, v78
	v_xor_b32_e32 v37, 24, v78
	v_add_nc_u32_e32 v80, v21, v39
	v_xad_u32 v21, v18, 16, 0
	v_xad_u32 v22, v18, 32, 0
	v_add_nc_u32_e32 v79, v74, v23
	v_xad_u32 v23, v18, 48, 0
	v_add_nc_u32_e32 v81, v24, v39
	v_xad_u32 v24, v18, 64, 0
	...
	v_xor_b32_e32 v20, 16, v72
	.loc	1 778 24                        ; attention.py:778:24
	v_cmp_gt_i32_e64 s1, s17, v0
	v_mov_b32_e32 v5, v17
	v_mov_b32_e32 v6, v17
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v12, v17 :: v_dual_add_nc_u32 v83, 0, v20
	s_branch .LBB0_2
.LBB0_1:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	.loc	1 742 17                        ; attention.py:742:17
	v_dual_mul_f32 v23, s18, v57 :: v_dual_mul_f32 v60, s18, v60
	...
	v_dual_max_f32 v102, v102, v102 :: v_dual_add_nc_u32 v19, s14, v71
	.loc	1 759 25                        ; attention.py:759:25
	...
	.loc	1 766 24                        ; attention.py:766:24
	v_dual_max_f32 v108, v101, v101 :: v_dual_add_nc_u32 v21, 0, v78
...
.Ltmp7:
	...
	v_permlanex16_b32 v113, v106, s40, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
.Ltmp8:
	.loc	1 766 24                        ; attention.py:766:24
	v_max3_f32 v120, v103, v106, v113
	.loc	1 815 23                        ; attention.py:815:23
	v_add_nc_u32_e32 v19, v74, v69
.Ltmp9:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:765:29 ] ]
	v_dual_max_f32 v106, v22, v22 :: v_dual_max_f32 v113, v20, v20
.Ltmp10:
...
.Ltmp14:
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v64, v64, v120 :: v_dual_mov_b32 v117, v106
...
.Ltmp16:
	.loc	1 815 23                        ; attention.py:815:23
	ds_store_b32 v79, v103
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v121, v19
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v58, v58, v120 :: v_dual_max_f32 v103, v117, v117
...
.Ltmp18:
	...
	.loc	1 768 62                        ; attention.py:768:62
	v_dual_sub_f32 v62, v62, v120 :: v_dual_mov_b32 v119, v103
	.loc	1 815 23                        ; attention.py:815:23
...
.Ltmp24:
	...
	v_dual_sub_f32 v23, v23, v102 :: v_dual_mul_f32 v10, v10, v121
	...
	ds_store_b16 v80, v20 offset:128
	ds_store_b16_d16_hi v80, v20 offset:256
	ds_store_b16 v80, v21 offset:384
	ds_store_b16_d16_hi v80, v21 offset:512
	ds_store_b16 v80, v22 offset:640
	ds_store_b16_d16_hi v80, v22 offset:768
	ds_store_b16 v80, v23 offset:896
.Ltmp25:
...
.Ltmp32:
	...
	.loc	1 816 30                        ; attention.py:816:30
	s_barrier
	ds_load_u16_d16 v57, v81
	ds_load_u16_d16 v58, v81 offset:128
	ds_load_u16_d16 v59, v81 offset:256
	ds_load_u16_d16 v60, v81 offset:384
	ds_load_u16_d16 v61, v81 offset:512
	ds_load_u16_d16 v62, v81 offset:640
	ds_load_u16_d16 v63, v81 offset:768
	ds_load_u16_d16 v64, v81 offset:896
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v57, v81 offset:64
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v58, v81 offset:192
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v59, v81 offset:320
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v60, v81 offset:448
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v61, v81 offset:576
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v62, v81 offset:704
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v63, v81 offset:832
	s_waitcnt lgkmcnt(7)
	ds_load_u16_d16_hi v64, v81 offset:960
.Ltmp33:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:769:24 ]
...
.Ltmp36:
	...
	v_dual_mul_f32 v20, v118, v20 :: v_dual_add_nc_u32 v113, 0, v75
...
.Ltmp38:
	.loc	1 814 30                        ; attention.py:814:30
	ds_store_2addr_b32 v82, v104, v20 offset1:8
	ds_store_2addr_b32 v82, v18, v22 offset0:16 offset1:24
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.LBB0_4:
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_or_b32_e32 v18, v0, v68
	.loc	1 598 79                        ; attention.py:598:79
	v_or_b32_e32 v0, 32, v66
	.loc	1 570 21                        ; attention.py:570:21
	v_or_b32_e32 v19, s33, v18
...
.Ltmp41:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_vgpr, 136
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.numbered_sgpr, 42
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     44
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bool_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm32_bn16_w4_s1_ds1.kd
