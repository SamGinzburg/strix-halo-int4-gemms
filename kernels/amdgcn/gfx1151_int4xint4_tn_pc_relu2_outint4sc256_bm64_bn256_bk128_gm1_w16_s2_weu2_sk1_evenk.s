...
.Ltmp0:
	...
	s_abs_i32 s6, s2
	v_dual_mov_b32 v8, 0 :: v_dual_and_b32 v79, 15, v0
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_lshrrev_b32_e32 v34, 3, v0
	v_lshrrev_b32_e32 v78, 4, v0
	v_and_b32_e32 v80, 0x100, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v4, v8 :: v_dual_lshlrev_b32 v41, 4, v79
	v_dual_mov_b32 v5, v8 :: v_dual_and_b32 v82, 0xe0, v0
	v_mov_b32_e32 v7, v8
...
.Ltmp11:
	...
	s_cvt_u32_f32 s5, s5
	v_dual_mov_b32 v6, v8 :: v_dual_add_nc_u32 v85, 0, v84
	...
	.loc	1 158 30                        ; generate_amdgcn.py:158:30
	v_mad_u64_u32 v[2:3], null, s17, v78, v[41:42]
	.loc	1 152 30                        ; generate_amdgcn.py:152:30
	v_add3_u32 v1, s15, s19, v1
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_mov_b32 s15, s7
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	.loc	1 158 30 is_stmt 0              ; generate_amdgcn.py:158:30
	v_add_nc_u32_e32 v3, s2, v2
	v_add3_u32 v2, s2, s3, v2
	...
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	buffer_load_b64 v[39:40], v1, s[4:7], 0 offen
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	buffer_load_b128 v[35:38], v3, s[12:15], 0 offen
	...
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	s_waitcnt vmcnt(2)
	ds_store_b64 v87, v[39:40] offset:16384
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_waitcnt vmcnt(1)
	ds_store_b128 v88, v[35:38]
	s_waitcnt vmcnt(0)
	ds_store_b128 v88, v[42:45] offset:8192
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
; %bb.1:                                ; %.lr.ph
	...
	v_mov_b32_e32 v9, 0
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add_nc_u32_e32 v1, s24, v78
	v_add3_u32 v3, s24, v34, 64
...
.Ltmp13:
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
	v_add3_u32 v89, v3, s19, v33
	v_add3_u32 v2, v2, s15, v41
	v_mov_b32_e32 v16, v9
	v_add3_u32 v1, v1, s15, v41
	v_mov_b32_e32 v25, v9
	v_mov_b32_e32 v26, v9
	v_subrev_nc_u32_e32 v90, s23, v2
	v_mov_b32_e32 v27, v9
	v_subrev_nc_u32_e32 v91, s23, v1
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 158 22                        ; generate_amdgcn.py:158:22
	s_clause 0x1
	buffer_load_b128 v[33:36], v91, s[12:15], 0 offen
	...
	ds_load_u8 v94, v85 offset:16416
	s_waitcnt lgkmcnt(1)
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[60:61], v[44:45], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v46, v47, v46, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[64:65], v[48:49], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[68:69], v[52:53], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v55, v54, 0xc0c0004
	...
	ds_load_u8 v56, v85 offset:18944
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v56, v54, 0xc0c0004
	ds_load_u8 v56, v85 offset:19136
	ds_load_u8 v57, v85 offset:19072
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v54, v56, 16, v54
	ds_load_u8 v56, v86 offset:11520
	ds_load_u8 v57, v86 offset:11264
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:12032
	ds_load_u8 v58, v86 offset:11776
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v71, v57, 16, v56
	ds_load_u8 v56, v86 offset:10496
	ds_load_u8 v57, v86 offset:10240
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:11008
	ds_load_u8 v58, v86 offset:10752
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v70, v57, 16, v56
	ds_load_u8 v56, v85 offset:19776
	ds_load_u8 v57, v85 offset:19712
	v_wmma_i32_16x16x16_iu4 v[9:16], v[70:71], v[54:55], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v85 offset:19904
	ds_load_u8 v58, v85 offset:19840
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v75, v57, 16, v56
	ds_load_u8 v56, v85 offset:19520
	ds_load_u8 v57, v85 offset:19456
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v85 offset:19648
	ds_load_u8 v58, v85 offset:19584
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v74, v57, 16, v56
	ds_load_u8 v56, v86 offset:13568
	ds_load_u8 v57, v86 offset:13312
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:14080
	ds_load_u8 v58, v86 offset:13824
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v73, v57, 16, v56
	ds_load_u8 v56, v86 offset:12544
	ds_load_u8 v57, v86 offset:12288
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:13056
	ds_load_u8 v58, v86 offset:12800
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v72, v57, 16, v56
	ds_load_u8 v56, v85 offset:20288
	ds_load_u8 v57, v85 offset:20224
	v_wmma_i32_16x16x16_iu4 v[9:16], v[72:73], v[74:75], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v85 offset:20416
	ds_load_u8 v58, v85 offset:20352
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v93, v57, 16, v56
	ds_load_u8 v56, v85 offset:20032
	ds_load_u8 v57, v85 offset:19968
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v85 offset:20160
	ds_load_u8 v58, v85 offset:20096
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v92, v57, 16, v56
	ds_load_u8 v56, v86 offset:15616
	ds_load_u8 v57, v86 offset:15360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:16128
	ds_load_u8 v58, v86 offset:15872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v77, v57, 16, v56
	ds_load_u8 v56, v86 offset:14592
	ds_load_u8 v57, v86 offset:14336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:15104
	ds_load_u8 v58, v86 offset:14848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v76, v57, 16, v56
	ds_load_u8 v56, v86 offset:1408
	ds_load_u8 v57, v86 offset:1152
	v_wmma_i32_16x16x16_iu4 v[9:16], v[76:77], v[92:93], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:1920
	ds_load_u8 v58, v86 offset:1664
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v59, v57, 16, v56
	ds_load_u8 v56, v86 offset:384
	ds_load_u8 v57, v86 offset:128
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v56, v57, v56, 0xc0c0004
	ds_load_u8 v57, v86 offset:896
	ds_load_u8 v58, v86 offset:640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v57, v58, v57, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v58, v57, 16, v56
	v_wmma_i32_16x16x16_iu4 v[25:32], v[58:59], v[44:45], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v44, v86 offset:3456
	ds_load_u8 v45, v86 offset:3200
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	ds_load_u8 v45, v86 offset:3968
	ds_load_u8 v56, v86 offset:3712
	s_waitcnt lgkmcnt(0)
	...
	ds_load_u8 v56, v86 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v45, v56, v45, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[56:57], v[46:47], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v45, v44, 0xc0c0004
	...
	ds_load_u8 v46, v86 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v44, v46, v44, 0xc0c0004
	ds_load_u8 v46, v86 offset:4992
	ds_load_u8 v47, v86 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v46, v47, v46, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v44, v46, 16, v44
	ds_load_u8 v46, v86 offset:7552
	ds_load_u8 v47, v86 offset:7296
	v_wmma_i32_16x16x16_iu4 v[25:32], v[44:45], v[48:49], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v46, v47, v46, 0xc0c0004
	ds_load_u8 v47, v86 offset:8064
	ds_load_u8 v48, v86 offset:7808
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v47, v48, v47, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v47, v47, 16, v46
	ds_load_u8 v46, v86 offset:6528
	ds_load_u8 v48, v86 offset:6272
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v46, v48, v46, 0xc0c0004
	ds_load_u8 v48, v86 offset:7040
	ds_load_u8 v49, v86 offset:6784
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v48, v49, v48, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v46, v48, 16, v46
	ds_load_u8 v48, v86 offset:9600
	ds_load_u8 v49, v86 offset:9344
	v_wmma_i32_16x16x16_iu4 v[25:32], v[46:47], v[50:51], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v48, v49, v48, 0xc0c0004
	ds_load_u8 v49, v86 offset:10112
	ds_load_u8 v50, v86 offset:9856
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v49, v50, v49, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v49, v49, 16, v48
	ds_load_u8 v48, v86 offset:8576
	ds_load_u8 v50, v86 offset:8320
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v48, v50, v48, 0xc0c0004
	ds_load_u8 v50, v86 offset:9088
	ds_load_u8 v51, v86 offset:8832
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v48, v50, 16, v48
	ds_load_u8 v50, v86 offset:11648
	ds_load_u8 v51, v86 offset:11392
	v_wmma_i32_16x16x16_iu4 v[25:32], v[48:49], v[52:53], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
	ds_load_u8 v51, v86 offset:12160
	ds_load_u8 v52, v86 offset:11904
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v51, v52, v51, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v51, v51, 16, v50
	ds_load_u8 v50, v86 offset:10624
	ds_load_u8 v52, v86 offset:10368
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v52, v50, 0xc0c0004
	ds_load_u8 v52, v86 offset:11136
	ds_load_u8 v53, v86 offset:10880
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v50, v52, 16, v50
	ds_load_u8 v52, v86 offset:13696
	ds_load_u8 v53, v86 offset:13440
	v_wmma_i32_16x16x16_iu4 v[25:32], v[50:51], v[54:55], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v53, v52, 0xc0c0004
	ds_load_u8 v53, v86 offset:14208
	ds_load_u8 v54, v86 offset:13952
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v53, v54, v53, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v53, v53, 16, v52
	ds_load_u8 v52, v86 offset:12672
	ds_load_u8 v54, v86 offset:12416
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v52, v54, v52, 0xc0c0004
	ds_load_u8 v54, v86 offset:13184
	ds_load_u8 v55, v86 offset:12928
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v55, v54, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v52, v54, 16, v52
	ds_load_u8 v54, v86 offset:15744
	ds_load_u8 v55, v86 offset:15488
	v_wmma_i32_16x16x16_iu4 v[25:32], v[52:53], v[74:75], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v55, v54, 0xc0c0004
	ds_load_u8 v55, v86 offset:16256
	ds_load_u8 v74, v86 offset:16000
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v55, v74, v55, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v55, v55, 16, v54
	ds_load_u8 v54, v86 offset:14720
	ds_load_u8 v74, v86 offset:14464
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v54, v74, v54, 0xc0c0004
	ds_load_u8 v74, v86 offset:15232
	ds_load_u8 v75, v86 offset:14976
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v54, v74, 16, v54
	ds_load_u8 v74, v85 offset:16736
	ds_load_u8 v75, v85 offset:16672
	v_wmma_i32_16x16x16_iu4 v[25:32], v[54:55], v[92:93], v[25:32] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v75, v74, 0xc0c0004
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v74, v94, v74, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v74, v92, 16, v74
	v_wmma_i32_16x16x16_iu4 v[17:24], v[60:61], v[74:75], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[62:63], v[92:93], v[17:24] neg_lo:[1,1,0]
	...
	ds_load_u8 v62, v85 offset:17440
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v60, v62, v60, 0xc0c0004
	ds_load_u8 v62, v85 offset:17632
	ds_load_u8 v63, v85 offset:17568
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v60, v62, 16, v60
	ds_load_u8 v62, v85 offset:18272
	ds_load_u8 v63, v85 offset:18208
	v_wmma_i32_16x16x16_iu4 v[17:24], v[64:65], v[60:61], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[44:45], v[60:61], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v63, v62, 0xc0c0004
	ds_load_u8 v63, v85 offset:18400
	ds_load_u8 v64, v85 offset:18336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v63, v64, v63, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v63, v63, 16, v62
	ds_load_u8 v62, v85 offset:18016
	ds_load_u8 v64, v85 offset:17952
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v62, v64, v62, 0xc0c0004
	ds_load_u8 v64, v85 offset:18144
	ds_load_u8 v65, v85 offset:18080
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v65, v64, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v62, v64, 16, v62
	ds_load_u8 v64, v85 offset:18784
	ds_load_u8 v65, v85 offset:18720
	v_wmma_i32_16x16x16_iu4 v[17:24], v[66:67], v[62:63], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[46:47], v[62:63], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v65, v64, 0xc0c0004
	ds_load_u8 v65, v85 offset:18912
	ds_load_u8 v66, v85 offset:18848
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v65, v66, v65, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v65, v65, 16, v64
	ds_load_u8 v64, v85 offset:18528
	ds_load_u8 v66, v85 offset:18464
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v64, v66, v64, 0xc0c0004
	ds_load_u8 v66, v85 offset:18656
	ds_load_u8 v67, v85 offset:18592
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v66, v67, v66, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v64, v66, 16, v64
	ds_load_u8 v66, v85 offset:19296
	ds_load_u8 v67, v85 offset:19232
	v_wmma_i32_16x16x16_iu4 v[17:24], v[68:69], v[64:65], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[48:49], v[64:65], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v66, v67, v66, 0xc0c0004
	ds_load_u8 v67, v85 offset:19424
	ds_load_u8 v68, v85 offset:19360
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v67, v68, v67, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v67, v67, 16, v66
	ds_load_u8 v66, v85 offset:19040
	ds_load_u8 v68, v85 offset:18976
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v66, v68, v66, 0xc0c0004
	ds_load_u8 v68, v85 offset:19168
	ds_load_u8 v69, v85 offset:19104
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v69, v68, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v66, v68, 16, v66
	ds_load_u8 v68, v85 offset:19808
	ds_load_u8 v69, v85 offset:19744
	v_wmma_i32_16x16x16_iu4 v[17:24], v[70:71], v[66:67], v[17:24] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[1:8], v[50:51], v[66:67], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v69, v68, 0xc0c0004
	ds_load_u8 v69, v85 offset:19936
	ds_load_u8 v70, v85 offset:19872
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v69, v70, v69, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v69, v69, 16, v68
	ds_load_u8 v68, v85 offset:19552
	ds_load_u8 v70, v85 offset:19488
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v68, v70, v68, 0xc0c0004
	ds_load_u8 v70, v85 offset:19680
	ds_load_u8 v71, v85 offset:19616
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v68, v70, 16, v68
	ds_load_u8 v70, v85 offset:20320
	ds_load_u8 v71, v85 offset:20256
	...
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	ds_load_u8 v71, v85 offset:20448
	ds_load_u8 v72, v85 offset:20384
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v71, v72, v71, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v71, v71, 16, v70
	ds_load_u8 v70, v85 offset:20064
	ds_load_u8 v72, v85 offset:20000
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v72, v70, 0xc0c0004
	ds_load_u8 v72, v85 offset:20192
	ds_load_u8 v73, v85 offset:20128
	.loc	1 152 22                        ; generate_amdgcn.py:152:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[54:55], v[70:71], v[1:8] neg_lo:[1,1,0]
	.loc	1 133 9                         ; generate_amdgcn.py:133:9
...
; %bb.4:
	ds_load_u8 v33, v85 offset:16704
	ds_load_u8 v34, v85 offset:16640
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v85 offset:16832
	ds_load_u8 v35, v85 offset:16768
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v35, v34, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v34, v34, 16, v33
	ds_load_u8 v33, v85 offset:16448
	ds_load_u8 v35, v85 offset:16384
	ds_load_u8 v67, v85 offset:16416
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v33, v35, v33, 0xc0c0004
	ds_load_u8 v35, v85 offset:16576
	ds_load_u8 v36, v85 offset:16512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v33, v35, 16, v33
	ds_load_u8 v35, v86 offset:1280
	ds_load_u8 v36, v86 offset:1024
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v86 offset:1792
	ds_load_u8 v37, v86 offset:1536
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v65, v36, 16, v35
	ds_load_u8 v35, v86 offset:256
	ds_load_u8 v36, v86
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v86 offset:768
	ds_load_u8 v37, v86 offset:512
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v64, v36, 16, v35
	ds_load_u8 v35, v85 offset:17216
	ds_load_u8 v36, v85 offset:17152
	v_wmma_i32_16x16x16_iu4 v[9:16], v[64:65], v[33:34], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v85 offset:17344
	ds_load_u8 v37, v85 offset:17280
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v37, v36, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v36, v36, 16, v35
	ds_load_u8 v35, v85 offset:16960
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[58:59], v[37:38], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v39, v40, v39, 0xc0c0004
	...
	v_wmma_i32_16x16x16_iu4 v[9:16], v[60:61], v[68:69], v[9:16] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v48, v49, v48, 0xc0c0004
	...
	ds_load_u8 v33, v86 offset:3456
	ds_load_u8 v34, v86 offset:3200
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v34, v33, 0xc0c0004
	ds_load_u8 v34, v86 offset:3968
	ds_load_u8 v70, v86 offset:3712
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v34, v70, v34, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v34, v34, 16, v33
	ds_load_u8 v33, v86 offset:2432
	ds_load_u8 v70, v86 offset:2176
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v33, v70, v33, 0xc0c0004
	ds_load_u8 v70, v86 offset:2944
	ds_load_u8 v71, v86 offset:2688
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v33, v70, 16, v33
	v_wmma_i32_16x16x16_iu4 v[25:32], v[33:34], v[35:36], v[25:32] neg_lo:[1,1,0]
	ds_load_u8 v35, v86 offset:5504
	ds_load_u8 v36, v86 offset:5248
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v36, v35, 0xc0c0004
	ds_load_u8 v36, v86 offset:6016
	ds_load_u8 v70, v86 offset:5760
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v36, v70, v36, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v36, v36, 16, v35
	ds_load_u8 v35, v86 offset:4480
	ds_load_u8 v70, v86 offset:4224
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v35, v70, v35, 0xc0c0004
	ds_load_u8 v70, v86 offset:4992
	ds_load_u8 v71, v86 offset:4736
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v70, v71, v70, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshl_or_b32 v35, v70, 16, v35
	...
	v_wmma_i32_16x16x16_iu4 v[25:32], v[46:47], v[68:69], v[25:32] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[64:65], v[67:68], v[17:24] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[58:59], v[62:63], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v58, v85 offset:18272
	ds_load_u8 v59, v85 offset:18208
	v_wmma_i32_16x16x16_iu4 v[1:8], v[35:36], v[62:63], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v58, v59, v58, 0xc0c0004
	ds_load_u8 v59, v85 offset:18400
	ds_load_u8 v69, v85 offset:18336
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v59, v69, v59, 0xc0c0004
	s_delay_alu instid0(VALU_DEP_1)
	v_lshl_or_b32 v59, v59, 16, v58
	ds_load_u8 v58, v85 offset:18016
	...
	v_wmma_i32_16x16x16_iu4 v[17:24], v[50:51], v[58:59], v[17:24] neg_lo:[1,1,0]
	ds_load_u8 v50, v85 offset:18784
	ds_load_u8 v51, v85 offset:18720
	v_wmma_i32_16x16x16_iu4 v[1:8], v[37:38], v[58:59], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v50, v51, v50, 0xc0c0004
...
.LBB0_5:                                ; %._crit_edge._crit_edge
	...
	buffer_load_u16 v36, v35, s[4:7], 0 offen
	...
	v_or_b32_e32 v47, 0x104, v34
	.loc	1 169 14                        ; generate_amdgcn.py:169:14
	buffer_load_u16 v35, v35, s[4:7], 0 offen
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_and_b32 s5, s11, 0xffff
	s_mov_b32 s4, s10
	v_or_b32_e32 v49, 0x10c, v34
	s_clause 0x6
	buffer_load_u16 v37, v34, s[4:7], 0 offen
	...
	v_mul_f32_e32 v53, v36, v37
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_or_b32_e32 v39, 8, v34
	v_or_b32_e32 v42, 16, v34
	v_or_b32_e32 v44, 24, v34
	v_or_b32_e32 v46, 0x100, v34
	v_or_b32_e32 v48, 0x108, v34
	v_or_b32_e32 v50, 0x110, v34
	s_clause 0x5
	...
	v_or_b32_e32 v52, 0x118, v34
	v_or_b32_e32 v34, 0x11c, v34
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_dual_mul_f32 v37, v35, v37 :: v_dual_mul_f32 v62, v36, v47
	v_mul_f32_e32 v60, v36, v45
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_clause 0x1
...
.Ltmp18:
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v67, v36, v51
	v_mul_f32_e32 v64, v36, v49
.Ltmp19:
	.loc	1 86 37                         ; generate_amdgcn.py:86:37 @[ generate_amdgcn.py:243:9 ]
	s_add_i32 s5, s17, s5
.Ltmp20:
...
.Ltmp24:
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v9, v53, v9 :: v_dual_mul_f32 v16, v60, v16
	v_dual_mul_f32 v28, v64, v28 :: v_dual_max_f32 v17, 0, v17
	...
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_dual_mul_f32 v55, v36, v39 :: v_dual_lshlrev_b32 v38, 16, v38
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_waitcnt vmcnt(2)
	...
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_dual_mul_f32 v54, v36, v38 :: v_dual_and_b32 v33, 16, v0
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v39, v35, v39 :: v_dual_lshlrev_b32 v52, 16, v52
	v_mul_f32_e32 v65, v36, v50
	v_dual_mul_f32 v63, v36, v48 :: v_dual_lshlrev_b32 v46, 16, v46
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	v_lshlrev_b32_e32 v44, 16, v44
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v68, v36, v52
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v34, 16, v34
	.loc	1 171 16                        ; generate_amdgcn.py:171:16
	v_mul_f32_e32 v61, v36, v46
	v_dual_mul_f32 v59, v36, v44 :: v_dual_lshlrev_b32 v42, 16, v42
	.loc	1 170 14                        ; generate_amdgcn.py:170:14
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v57, v36, v42
	v_mul_f32_e32 v42, v35, v42
	v_mul_f32_e32 v56, v36, v40
	v_mul_f32_e32 v40, v35, v40
	v_dual_mul_f32 v43, v35, v43 :: v_dual_mul_f32 v36, v36, v34
	v_dual_mul_f32 v44, v35, v44 :: v_dual_mul_f32 v13, v57, v13
	v_dual_mul_f32 v45, v35, v45 :: v_dual_mul_f32 v10, v54, v10
	v_dual_mul_f32 v46, v35, v46 :: v_dual_mul_f32 v25, v61, v25
	v_dual_mul_f32 v47, v35, v47 :: v_dual_mul_f32 v12, v56, v12
	v_dual_mul_f32 v48, v35, v48 :: v_dual_mul_f32 v29, v65, v29
	v_dual_mul_f32 v49, v35, v49 :: v_dual_mul_f32 v14, v58, v14
	v_dual_mul_f32 v50, v35, v50 :: v_dual_mul_f32 v31, v68, v31
	v_mul_f32_e32 v51, v35, v51
	v_mul_f32_e32 v52, v35, v52
	v_dual_mul_f32 v34, v35, v34 :: v_dual_mul_f32 v21, v42, v21
	.loc	1 171 9 is_stmt 0               ; generate_amdgcn.py:171:9
	v_mul_f32_e32 v11, v55, v11
	v_mul_f32_e32 v15, v59, v15
	v_dual_mul_f32 v27, v63, v27 :: v_dual_mul_f32 v32, v36, v32
	v_dual_mul_f32 v30, v67, v30 :: v_dual_mul_f32 v23, v44, v23
	v_dual_mul_f32 v18, v38, v18 :: v_dual_mul_f32 v19, v39, v19
	v_dual_mul_f32 v20, v40, v20 :: v_dual_mul_f32 v1, v46, v1
	v_dual_mul_f32 v22, v43, v22 :: v_dual_mul_f32 v3, v48, v3
	v_dual_mul_f32 v24, v45, v24 :: v_dual_mul_f32 v5, v50, v5
	v_dual_mul_f32 v2, v47, v2 :: v_dual_mul_f32 v7, v52, v7
	v_mul_f32_e32 v4, v49, v4
	v_dual_mul_f32 v8, v34, v8 :: v_dual_max_f32 v13, 0, v13
	...
	.loc	1 171 9                         ; generate_amdgcn.py:171:9
	v_dual_mul_f32 v6, v51, v6 :: v_dual_max_f32 v11, 0, v11
	.loc	1 178 19                        ; generate_amdgcn.py:178:19
	v_dual_max_f32 v32, 0, v32 :: v_dual_max_f32 v21, 0, v21
	v_dual_max_f32 v18, 0, v18 :: v_dual_max_f32 v37, 0, v23
	v_dual_max_f32 v20, 0, v20 :: v_dual_max_f32 v1, 0, v1
	v_dual_max_f32 v22, 0, v22 :: v_dual_max_f32 v3, 0, v3
	v_dual_max_f32 v38, 0, v24 :: v_dual_max_f32 v5, 0, v5
	v_dual_max_f32 v2, 0, v2 :: v_dual_mul_f32 v43, v9, v9
	v_dual_max_f32 v40, 0, v7 :: v_dual_mul_f32 v47, v13, v13
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v44, v10, v10 :: v_dual_mul_f32 v49, v15, v15
	v_dual_mul_f32 v46, v12, v12 :: v_dual_mul_f32 v51, v25, v25
	v_dual_mul_f32 v48, v14, v14 :: v_dual_mul_f32 v25, v28, v28
	v_dual_mul_f32 v50, v16, v16 :: v_dual_mul_f32 v23, v26, v26
	v_dual_mul_f32 v24, v27, v27 :: v_dual_mul_f32 v35, v17, v17
	v_mul_f32_e32 v26, v29, v29
	v_dual_mul_f32 v28, v30, v30 :: v_dual_mul_f32 v29, v21, v21
	v_dual_mul_f32 v30, v31, v31 :: v_dual_mul_f32 v27, v22, v22
	.loc	1 178 19                        ; generate_amdgcn.py:178:19
	v_dual_max_f32 v4, 0, v4 :: v_dual_max_f32 v39, 0, v6
	v_dual_max_f32 v42, 0, v8 :: v_dual_mul_f32 v45, v11, v11
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v32, v32, v32 :: v_dual_mul_f32 v21, v37, v37
	v_dual_mul_f32 v31, v20, v20 :: v_dual_mul_f32 v12, v1, v1
	v_dual_mul_f32 v10, v2, v2 :: v_dual_max_f32 v1, v43, v44
.Ltmp25:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max3_f32 v2, v46, v47, v48
	v_max3_f32 v11, v23, v24, v25
	v_max3_f32 v13, v26, v28, v30
.Ltmp26:
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v36, v18, v18 :: v_dual_mul_f32 v7, v4, v4
	v_dual_mul_f32 v8, v3, v3 :: v_dual_mul_f32 v3, v42, v42
	v_dual_mul_f32 v6, v5, v5 :: v_dual_mul_f32 v5, v39, v39
	v_mul_f32_e32 v4, v40, v40
.Ltmp27:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max3_f32 v9, v49, v50, v51
	v_max3_f32 v1, v1, v45, v2
	v_max3_f32 v2, v11, v13, v32
.Ltmp28:
	.loc	1 179 19                        ; generate_amdgcn.py:179:19
	v_dual_mul_f32 v34, v19, v19 :: v_dual_mul_f32 v17, v38, v38
.Ltmp29:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max3_f32 v13, v10, v8, v7
	v_max3_f32 v14, v6, v5, v4
	s_delay_alu instid0(VALU_DEP_4)
	v_max3_f32 v1, v1, v9, v2
	v_max_f32_e32 v2, v35, v36
	v_max3_f32 v9, v31, v29, v27
	v_max3_f32 v11, v21, v17, v12
.Ltmp30:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
	v_lshl_add_u32 v15, v81, 8, 0
.Ltmp31:
...
.Ltmp32:
	...
	v_max3_f32 v9, v13, v14, v3
.Ltmp33:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
	v_and_b32_e32 v13, 8, v0
.Ltmp34:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ] ]
	v_max3_f32 v2, v2, v11, v9
.Ltmp35:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:243:9 ] ]
...
.Ltmp41:
	...
	v_add3_u32 v14, v15, v14, v13
	ds_store_b64 v14, v[1:2]
	v_lshl_or_b32 v1, v82, 3, v9
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_xor_b32_e32 v1, v1, v11
	v_lshrrev_b32_e32 v11, 1, v80
...
.Ltmp58:
	...
	v_div_scale_f32 v14, vcc_lo, v1, 0x40e00000, v1
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v13, v14, v13
	v_div_scale_f32 v14, vcc_lo, v9, 0x40e00000, v9
	v_mul_f32_e32 v15, v14, v13
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v16, -v11, v15, v14
	v_fmac_f32_e32 v15, v16, v13
	...
	v_div_scale_f32 v11, null, v37, v37, v43
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
	v_rcp_f32_e32 v13, v11
	v_fma_f32 v14, -v11, v13, 1.0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v13, v14, v13
	v_div_scale_f32 v14, vcc_lo, v43, v37, v43
	v_mul_f32_e32 v15, v14, v13
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v16, -v11, v15, v14
	v_fmac_f32_e32 v15, v16, v13
	...
	v_fma_f32 v11, -v11, v15, v14
	v_div_fmas_f32 v11, v11, v13, v15
	v_div_scale_f32 v13, null, v37, v37, v44
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v11, v11, v37, v43
	v_rcp_f32_e32 v14, v13
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v15, -v13, v14, 1.0
	v_fmac_f32_e32 v14, v15, v14
	v_div_scale_f32 v15, vcc_lo, v44, v37, v44
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v14, null, v37, v37, v45
	v_rcp_f32_e32 v15, v14
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v16, -v14, v15, 1.0
	v_fmac_f32_e32 v15, v16, v15
	v_div_scale_f32 v16, vcc_lo, v45, v37, v45
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v15, null, v37, v37, v46
	v_rcp_f32_e32 v16, v15
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v18, -v15, v16, 1.0
	v_fmac_f32_e32 v16, v18, v16
	v_div_scale_f32 v18, vcc_lo, v46, v37, v46
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v16, null, v37, v37, v47
	v_rcp_f32_e32 v18, v16
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v19, -v16, v18, 1.0
	v_fmac_f32_e32 v18, v19, v18
	v_div_scale_f32 v19, vcc_lo, v47, v37, v47
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_div_scale_f32 v18, null, v37, v37, v48
	v_rcp_f32_e32 v19, v18
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v20, -v18, v19, 1.0
	v_fmac_f32_e32 v19, v20, v19
	v_div_scale_f32 v20, vcc_lo, v48, v37, v48
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v22, v20, v19
	v_fma_f32 v38, -v18, v22, v20
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v22, v38, v19
	v_fma_f32 v18, -v18, v22, v20
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v18, v18, v19, v22
	v_div_scale_f32 v19, null, v37, v37, v49
	v_rcp_f32_e32 v20, v19
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v22, -v19, v20, 1.0
	v_fmac_f32_e32 v20, v22, v20
	v_div_scale_f32 v22, vcc_lo, v49, v37, v49
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v38, v22, v20
	v_fma_f32 v39, -v19, v38, v22
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v38, v39, v20
	v_fma_f32 v19, -v19, v38, v22
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v19, v19, v20, v38
	v_div_scale_f32 v20, null, v37, v37, v50
	v_rcp_f32_e32 v22, v20
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v38, -v20, v22, 1.0
	v_fmac_f32_e32 v22, v38, v22
	v_div_scale_f32 v38, vcc_lo, v50, v37, v50
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v20, v20, v22, v39
	v_div_scale_f32 v22, null, v37, v37, v51
	v_rcp_f32_e32 v38, v22
	s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v39, -v22, v38, 1.0
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v51, v37, v51
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v40, v39, v38
	v_fma_f32 v42, -v22, v40, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1)
	v_fmac_f32_e32 v42, v43, v39
	v_div_fixup_f32 v13, v13, v37, v44
	v_div_fixup_f32 v14, v14, v37, v45
	v_div_fixup_f32 v15, v15, v37, v46
	v_div_fixup_f32 v16, v16, v37, v47
	v_fma_f32 v38, -v38, v42, v40
	v_div_fixup_f32 v18, v18, v37, v48
	v_div_fixup_f32 v19, v19, v37, v49
	v_div_fixup_f32 v20, v20, v37, v50
	v_div_fixup_f32 v22, v22, v37, v51
	v_div_fmas_f32 v38, v38, v39, v42
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	...
	v_fma_f32 v40, -v38, v39, 1.0
	v_fmac_f32_e32 v39, v40, v39
	v_div_scale_f32 v40, vcc_lo, v30, v37, v30
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v39, v40, v39
	v_div_scale_f32 v40, vcc_lo, v32, v37, v32
	v_mul_f32_e32 v42, v40, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v43, -v38, v42, v40
	v_fmac_f32_e32 v42, v43, v39
	...
	v_div_scale_f32 v37, null, v9, v9, v29
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_fma_f32 v39, -v37, v38, 1.0
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v29, v9, v29
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v40, v39, v38
	v_fma_f32 v42, -v37, v40, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v37, v37, v38, v40
	v_div_fixup_f32 v29, v37, v9, v29
	...
	v_div_scale_f32 v37, null, v9, v9, v21
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_fma_f32 v39, -v37, v38, 1.0
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v21, v9, v21
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v40, v39, v38
	v_fma_f32 v42, -v37, v40, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v37, v37, v38, v40
	v_div_fixup_f32 v21, v37, v9, v21
	v_div_scale_f32 v37, null, v9, v9, v17
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v17, v9, v17
	v_mul_f32_e32 v40, v39, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v42, -v37, v40, v39
	v_fmac_f32_e32 v40, v42, v38
	...
	v_div_fmas_f32 v37, v37, v38, v40
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v17, v37, v9, v17
	v_div_scale_f32 v37, null, v9, v9, v12
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	v_fma_f32 v39, -v37, v38, 1.0
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v12, v9, v12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_mul_f32_e32 v40, v39, v38
	v_fma_f32 v42, -v37, v40, v39
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_div_fmas_f32 v37, v37, v38, v40
	v_div_fixup_f32 v12, v37, v9, v12
	v_div_scale_f32 v37, null, v9, v9, v10
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 78 9 is_stmt 0                ; generate_amdgcn.py:78:9 @[ generate_amdgcn.py:243:9 ]
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
	v_fmac_f32_e32 v38, v39, v38
	v_div_scale_f32 v39, vcc_lo, v10, v9, v10
	v_mul_f32_e32 v40, v39, v38
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_fma_f32 v42, -v37, v40, v39
	v_fmac_f32_e32 v40, v42, v38
	...
	v_div_fmas_f32 v37, v37, v38, v40
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_div_fixup_f32 v10, v37, v9, v10
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 95
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_relu2_outint4sc256_bm64_bn256_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 25
