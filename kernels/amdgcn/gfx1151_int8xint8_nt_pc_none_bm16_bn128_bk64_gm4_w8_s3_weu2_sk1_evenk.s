	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 327 14                        ; generate_amdgcn.py:327:14
	v_and_b32_e32 v1, 48, v14
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_mul_f32 s9, s9, 0x4f7ffffe
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[5:6], null, s23, v4, v[1:2]
...
.Ltmp13:
	...
	buffer_load_b32 v16, v7, s[12:15], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_cndmask_b32_e64 v18, 0x80000000, v6, s2
	v_cndmask_b32_e64 v23, 0x80000000, v9, s2
	s_clause 0x1
	buffer_load_b128 v[6:9], v8, s[16:19], 0 offen
	buffer_load_b128 v[10:13], v5, s[16:19], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v15, v15, s[12:15], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[19:22], v18, s[16:19], 0 offen
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(5)
	ds_store_b32 v14, v16 offset:16384
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(4)
	ds_store_b128 v29, v[6:9]
	s_waitcnt vmcnt(3)
	ds_store_b128 v29, v[10:13] offset:4096
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b32 v14, v15 offset:17408
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	...
	s_lshl_b32 s1, s24, 7
	v_and_b32_e32 v5, 48, v5
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v2, s21, v2
	v_mov_b32_e32 v14, 0
	v_subrev_nc_u32_e32 v6, s1, v4
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v19, v17, 6, v5
...
.Ltmp15:
	...
	v_mad_u64_u32 v[5:6], null, s23, v6, s[10:11]
	v_lshl_or_b32 v23, v18, 5, v19
	v_xor_b32_e32 v22, 16, v19
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_u64_u32 v[6:7], null, s23, v2, s[10:11]
	v_xor_b32_e32 v20, 32, v19
	v_xor_b32_e32 v21, 48, v19
	...
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v6, v1
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v4, v1
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v80, v31, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x1
	buffer_load_b128 v[40:43], v29, s[16:19], 0 offen
	buffer_load_b128 v[44:47], v30, s[16:19], 0 offen
	s_mov_b32 s25, s10
	s_mov_b32 s10, s0
	s_mov_b32 s0, s22
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v9, v9, v32 :: v_dual_add_nc_u32 v30, 64, v30
	v_dual_add_f32 v16, v16, v35 :: v_dual_add_nc_u32 v29, 64, v29
	v_dual_add_f32 v10, v10, v33 :: v_dual_add_nc_u32 v31, 64, v31
	v_dual_add_f32 v15, v15, v34 :: v_dual_add_f32 v12, v12, v37
	v_dual_add_f32 v11, v11, v36 :: v_dual_add_f32 v14, v14, v39
...
; %bb.9:
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v27, 0 :: v_dual_add_nc_u32 v2, s18, v26
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v6, s18, v23
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v7, s10, v22
	v_add_nc_u32_e32 v8, s10, v19
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v33, v27 :: v_dual_add_nc_u32 v28, s18, v25
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v6, s18, v24
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v30, v27 :: v_dual_add_nc_u32 v7, s10, v21
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	v_dual_add_f32 v15, v15, v2 :: v_dual_add_f32 v12, v12, v5
	v_dual_add_f32 v14, v14, v7 :: v_dual_add_f32 v13, v13, v6
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_add_f32 v10, v10, v27 :: v_dual_add_f32 v9, v9, v8
.LBB0_10:
...
; %bb.11:
	...
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v19, 0 :: v_dual_add_nc_u32 v6, s1, v23
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v7, s0, v22
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v22, s1, v25
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v6, s1, v24
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v7, s0, v21
	v_add_nc_u32_e32 v8, s0, v20
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
...
.LBB0_12:
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v4, v11, v4 :: v_dual_add_f32 v5, v12, v5
	...
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_add_f32 v8, v13, v8 :: v_dual_add_f32 v27, v14, v27
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	s_waitcnt vmcnt(5)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_mul_f32 v16, v12, v16 :: v_dual_lshlrev_b32 v19, 16, v22
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v19, v12, v19 :: v_dual_lshlrev_b32 v18, 16, v18
	.loc	1 416 9                         ; generate_amdgcn.py:416:9
	...
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v6, v6, v19 :: v_dual_lshlrev_b32 v23, 16, v26
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 406 16 is_stmt 0              ; generate_amdgcn.py:406:16
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v18, v12, v18 :: v_dual_mul_f32 v5, v5, v20
	v_dual_mul_f32 v12, v12, v23 :: v_dual_and_b32 v9, 1, v9
	...
	v_cndmask_b16 v0.l, 0x7fff, v8.h, s6
	v_dual_cndmask_b32 v5, v3, v2 :: v_dual_cndmask_b32 v2, v2, v3
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	...
	v_dual_cndmask_b32 v4, v0, v4 :: v_dual_and_b32 v3, 0x5040504, v3
	s_mov_b32 s11, s15
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 83
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 27
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     29
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_pc_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
