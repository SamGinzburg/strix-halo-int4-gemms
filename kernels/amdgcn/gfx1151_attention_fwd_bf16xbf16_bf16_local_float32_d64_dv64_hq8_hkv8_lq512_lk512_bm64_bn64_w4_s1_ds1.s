...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v57, 0 :: v_dual_add_nc_u32 v0, s14, v0
	...
	v_dual_mov_b32 v60, v57 :: v_dual_add_nc_u32 v159, s13, v0
	...
	v_dual_mov_b32 v62, v57 :: v_dual_add_nc_u32 v161, s13, v2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 788 26                        ; attention.py:788:26
	...
	v_dual_mov_b32 v141, 0xff800000 :: v_dual_add_nc_u32 v0, v4, v11
	...
	v_dual_mov_b32 v139, 0xff800000 :: v_dual_add_nc_u32 v0, v4, v12
	...
	v_dual_mov_b32 v147, 0xff800000 :: v_dual_add_nc_u32 v0, v4, v13
	...
	v_dual_mov_b32 v140, 0xff800000 :: v_dual_lshlrev_b32 v1, 9, v67
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 103
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 220
