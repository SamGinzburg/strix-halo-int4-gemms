...
.Ltmp17:
	...
	v_or_b32_e32 v1, s6, v53
	v_or_b32_e32 v4, s6, v52
	v_or_b32_e32 v5, s6, v54
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:307:28 ]
	s_add_i32 s3, s19, s3
.Ltmp19:
...
.Ltmp21:
	...
	.loc	1 346 30                        ; generate_amdgcn.py:346:30
	v_mad_u64_u32 v[1:2], null, s34, s6, v[50:51]
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	v_cndmask_b32_e64 v5, 0x80000000, v3, s2
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cselect_b32 s2, -1, 0
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	s_add_i32 s45, s6, 0x100
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	...
	v_or_b32_e32 v119, s42, v25
	v_or_b32_e32 v25, s43, v51
	v_or_b32_e32 v118, s42, v28
	v_or_b32_e32 v117, s42, v29
	v_or_b32_e32 v27, s43, v27
	v_or_b32_e32 v116, s42, v30
	v_mul_lo_u32 v120, v25, s44
	v_or_b32_e32 v115, s42, v31
	v_or_b32_e32 v114, s42, v32
	v_mul_lo_u32 v121, v27, s44
	v_or_b32_e32 v113, s42, v33
	v_or_b32_e32 v112, s42, v34
	v_or_b32_e32 v111, s42, v35
	v_or_b32_e32 v110, s42, v36
	v_or_b32_e32 v109, s42, v37
	v_or_b32_e32 v108, s42, v38
	v_or_b32_e32 v106, s42, v39
	v_or_b32_e32 v107, s42, v40
	v_or_b32_e32 v105, s42, v41
	v_or_b32_e32 v104, s42, v42
	s_mov_b32 s16, 0
	s_mov_b64 s[4:5], s[14:15]
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cmpk_lt_i32 s19, 0x300
	.loc	1 346 22                        ; generate_amdgcn.py:346:22
	s_waitcnt vmcnt(5)
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_dual_fmac_f32 v85, v30, v40 :: v_dual_lshlrev_b32 v40, 16, v31
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	...
	v_dual_mul_f32 v23, v41, v23 :: v_dual_fmac_f32 v88, v30, v42
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fmac_f32_e32 v89, v29, v43
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	buffer_load_b128 v[29:32], v32, s[24:27], 0 offen
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
...
; %bb.5:
	...
	v_dual_mov_b32 v12, s18 :: v_dual_mov_b32 v17, s23
...
.LBB0_8:
	...
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v56, v56, v134, v83
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_waitcnt vmcnt(3)
	v_lshlrev_b32_e32 v44, 16, v44
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v57, v57, v133, v82
	v_fma_f32 v55, v55, v135, v84
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	...
	v_fma_f32 v58, v58, v131, v81
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v45, 16, v45
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v60, v60, v129, v79
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v50, 16, v50
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	v_fma_f32 v59, v59, v130, v80
	v_fma_f32 v104, v34, v137, v86
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	v_cndmask_b32_e64 v68, v71, v68, s3
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_add_nc_u32_e32 v71, 0, v87
	.loc	1 373 13                        ; generate_amdgcn.py:373:13
	...
	.loc	1 392 9                         ; generate_amdgcn.py:392:9
	v_xad_u32 v72, v87, 8, 0
	v_xad_u32 v73, v87, 16, 0
	v_xad_u32 v74, v87, 24, 0
	v_xad_u32 v75, v87, 32, 0
	v_xad_u32 v76, v87, 40, 0
	v_xad_u32 v77, v87, 48, 0
	v_xad_u32 v78, v87, 56, 0
	.loc	1 368 24                        ; generate_amdgcn.py:368:24
	v_mul_f32_e32 v87, v1, v42
	...
	v_cndmask_b32_e64 v35, v86, v24, s2
	...
	ds_store_2addr_stride64_b64 v72, v[3:4], v[19:20] offset1:2
	ds_store_2addr_stride64_b64 v73, v[5:6], v[21:22] offset1:2
	ds_store_2addr_stride64_b64 v74, v[7:8], v[23:24] offset1:2
	ds_store_2addr_stride64_b64 v75, v[9:10], v[25:26] offset1:2
	ds_store_2addr_stride64_b64 v76, v[11:12], v[27:28] offset1:2
	ds_store_2addr_stride64_b64 v77, v[13:14], v[29:30] offset1:2
	ds_store_2addr_stride64_b64 v78, v[15:16], v[35:36] offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
