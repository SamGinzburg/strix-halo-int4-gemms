	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow30
	...
	v_dual_mov_b32 v14, 0 :: v_dual_and_b32 v9, 1, v0
...
.Ltmp22:
	...
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v13, 0x90, v13
	v_dual_mov_b32 v18, 0 :: v_dual_lshlrev_b32 v3, 4, v3
	v_or3_b32 v22, v2, v6, s2
	v_add_nc_u32_e32 v2, s14, v5
	v_subrev_nc_u32_e32 v4, s0, v4
	.loc	1 325 32                        ; generate_amdgcn.py:325:32
	v_and_b32_e32 v1, 15, v0
	v_and_b32_e32 v7, 0x17e, v12
	v_and_b32_e32 v14, 0x90, v14
	v_and_b32_e32 v15, 0xf70, v15
	v_and_b32_e32 v16, 0x90, v16
	v_or_b32_e32 v17, v13, v8
	v_or3_b32 v3, v8, v3, v13
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
...
.Ltmp25:
	.loc	1 333 5 is_stmt 1               ; generate_amdgcn.py:333:5
	v_lshl_add_u32 v30, v1, 1, v2
	v_lshl_add_u32 v31, v9, 4, v4
	...
	v_or_b32_e32 v27, 10, v22
	v_or_b32_e32 v28, 12, v22
	v_or_b32_e32 v29, 14, v22
	v_mov_b32_e32 v13, 0
	...
	v_dual_mov_b32 v2, s37 :: v_dual_add_nc_u32 v37, 0, v16
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	buffer_load_b128 v[42:45], v43, s[4:7], 0 offen offset:32
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	v_add_lshl_u32 v57, v21, s24, 1
	.loc	1 360 40                        ; generate_amdgcn.py:360:40
	s_mul_i32 s24, s24, s25
	.loc	1 360 22 is_stmt 0              ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v52, v25, s0, 1
	v_add_lshl_u32 v53, v26, s0, 1
	v_add_lshl_u32 v54, v27, s0, 1
	...
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	v_add_lshl_u32 v58, v22, s24, 1
	v_add_lshl_u32 v59, v23, s24, 1
	v_add_lshl_u32 v60, v24, s24, 1
	v_add_lshl_u32 v61, v25, s24, 1
	v_add_lshl_u32 v62, v26, s24, 1
	v_add_lshl_u32 v63, v27, s24, 1
	v_add_lshl_u32 v64, v28, s24, 1
	v_add_lshl_u32 v65, v29, s24, 1
	...
	.loc	1 358 22                        ; generate_amdgcn.py:358:22
	buffer_load_u16 v87, v57, s[20:23], 0 offen
	.loc	1 360 22                        ; generate_amdgcn.py:360:22
	s_clause 0x7
	...
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[46:49], v34 offset:8192
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[50:53], v36
	ds_load_b128 v[54:57], v37
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	ds_load_b128 v[58:61], v34 offset:8704
	.loc	1 346 26                        ; generate_amdgcn.py:346:26
	ds_load_b128 v[62:65], v36 offset:4096
	.loc	1 344 26                        ; generate_amdgcn.py:344:26
	...
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[46:53], v[62:65], v[58:61], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu8 v[38:45], v[54:57], v[66:69], v[38:45] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mul_f32 v49, v49, v63 :: v_dual_lshlrev_b32 v54, 16, v78
	v_dual_mul_f32 v39, v39, v54 :: v_dual_lshlrev_b32 v56, 16, v80
	v_dual_mul_f32 v40, v40, v54 :: v_dual_lshlrev_b32 v57, 16, v81
	v_dual_mul_f32 v42, v42, v54 :: v_dual_lshlrev_b32 v59, 16, v83
	v_dual_mul_f32 v41, v41, v54 :: v_dual_lshlrev_b32 v60, 16, v84
	v_dual_mul_f32 v44, v44, v54 :: v_dual_lshlrev_b32 v61, 16, v85
	s_waitcnt vmcnt(7)
	v_dual_mul_f32 v43, v43, v54 :: v_dual_lshlrev_b32 v64, 16, v88
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v45, v45, v54 :: v_dual_lshlrev_b32 v68, 16, v92
	v_mul_f32_e32 v38, v38, v54
	.loc	1 362 17 is_stmt 0              ; generate_amdgcn.py:362:17
	v_fmac_f32_e32 v20, v39, v56
	.loc	1 362 24                        ; generate_amdgcn.py:362:24
	v_dual_mul_f32 v51, v51, v63 :: v_dual_lshlrev_b32 v58, 16, v82
	v_dual_mul_f32 v53, v53, v63 :: v_dual_lshlrev_b32 v62, 16, v86
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v19, v40, v57 :: v_dual_lshlrev_b32 v70, 16, v94
	s_waitcnt vmcnt(0)
	...
	.loc	1 362 17                        ; generate_amdgcn.py:362:17
	v_dual_fmac_f32 v17, v42, v59 :: v_dual_fmac_f32 v14, v45, v62
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_fmac_f32 v20, v47, v65 :: v_dual_fmac_f32 v19, v48, v66
	v_dual_fmac_f32 v18, v49, v67 :: v_dual_fmac_f32 v17, v50, v68
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_fmac_f32 v16, v51, v69 :: v_dual_fmac_f32 v15, v52, v70
...
.LBB0_7:                                ; %._crit_edge
	...
	v_cndmask_b32_e64 v2, 0x1040, 0, vcc_lo
	...
	v_xad_u32 v5, v2, 4, 0
	v_xad_u32 v7, v2, 8, 0
	v_xad_u32 v8, v2, 12, 0
	v_xad_u32 v1, v2, 16, 0
	v_lshl_or_b32 v0, v9, 5, v0
	ds_store_b32 v4, v13
	ds_store_b32 v5, v20
	ds_store_b32 v7, v19
	ds_store_b32 v8, v18
	v_xad_u32 v4, v2, 20, 0
	v_xad_u32 v5, v2, 24, 0
	...
	v_add_lshl_u32 v10, v3, s1, 2
	v_add_lshl_u32 v11, v3, s3, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s4, s25, 6
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	...
	v_add_lshl_u32 v1, v3, s4, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s2, s25, 12
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v2, v3, s5, 2
	.loc	1 418 23                        ; generate_amdgcn.py:418:23
	s_mul_i32 s0, s25, 14
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v4, v3, s6, 2
	v_add_lshl_u32 v9, v3, s2, 2
	...
	s_waitcnt lgkmcnt(0)
	buffer_atomic_add_f32 v0, v3, s[12:15], 0 offen
	.loc	1 309 1 is_stmt 1               ; generate_amdgcn.py:309:1
	s_endpgm
.Ltmp26:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 96
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc32_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
