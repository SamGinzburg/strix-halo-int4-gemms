	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_u8 v45, v29, s[16:19], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 131 22                        ; generate_amdgcn.py:131:22
...
.LBB0_10:                               ; %._crit_edge._crit_edge
	...
	s_mul_i32 s14, s25, 13
	s_mul_i32 s15, s25, 14
	s_mul_i32 s16, s25, 15
	...
	.loc	1 218 23                        ; generate_amdgcn.py:218:23
	v_mad_u64_u32 v[16:17], null, s10, s25, v[17:18]
	.loc	1 143 14                        ; generate_amdgcn.py:143:14
	...
	v_add_lshl_u32 v42, v16, s3, 2
	v_add_lshl_u32 v43, v16, s4, 2
	v_add_lshl_u32 v44, v16, s5, 2
	v_add_lshl_u32 v45, v16, s12, 2
	v_add_lshl_u32 v46, v16, s13, 2
	v_add_lshl_u32 v47, v16, s14, 2
	v_add_lshl_u32 v48, v16, s15, 2
	...
	v_dual_mul_f32 v12, v12, v20 :: v_dual_add_nc_u32 v63, 0, v18
	v_mul_f32_e32 v8, v8, v20
	v_mul_f32_e32 v0, v0, v20
	v_mul_f32_e32 v1, v1, v20
	v_dual_mul_f32 v2, v2, v20 :: v_dual_mul_f32 v13, v13, v35
	v_dual_mul_f32 v11, v11, v20 :: v_dual_mul_f32 v12, v12, v34
	...
	.loc	1 144 9                         ; generate_amdgcn.py:144:9
	v_dual_mul_f32 v8, v8, v30 :: v_dual_mul_f32 v1, v1, v23
	v_dual_mul_f32 v2, v2, v24 :: v_dual_mul_f32 v11, v11, v33
	v_mul_f32_e32 v10, v10, v32
	v_dual_mul_f32 v4, v4, v26 :: v_dual_mul_f32 v5, v5, v27
	v_dual_mul_f32 v6, v6, v28 :: v_dual_mul_f32 v7, v7, v29
	v_xad_u32 v18, v18, 28, 0
	v_dual_mul_f32 v15, v15, v37 :: v_dual_mul_f32 v14, v14, v36
	...
	ds_load_b32 v11, v11
	.loc	1 218 9 is_stmt 1               ; generate_amdgcn.py:218:9
	v_lshl_add_u32 v17, s25, 3, v19
	v_lshl_add_u32 v18, s25, 4, v19
	v_lshl_add_u32 v20, s25, 5, v19
	s_waitcnt lgkmcnt(15)
	buffer_atomic_add_f32 v0, v19, s[8:11], 0 offen
	s_waitcnt lgkmcnt(14)
	buffer_atomic_add_f32 v1, v38, s[8:11], 0 offen
	s_waitcnt lgkmcnt(13)
	buffer_atomic_add_f32 v2, v17, s[8:11], 0 offen
	s_waitcnt lgkmcnt(12)
	buffer_atomic_add_f32 v3, v39, s[8:11], 0 offen
	s_waitcnt lgkmcnt(11)
	buffer_atomic_add_f32 v4, v18, s[8:11], 0 offen
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v5, v40, s[8:11], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v6, v41, s[8:11], 0 offen
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v7, v42, s[8:11], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v8, v20, s[8:11], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v9, v43, s[8:11], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v10, v44, s[8:11], 0 offen
	v_add_lshl_u32 v0, v16, s16, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v12, v45, s[8:11], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v13, v46, s[8:11], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v14, v47, s[8:11], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v15, v48, s[8:11], 0 offen
	s_waitcnt lgkmcnt(0)
	buffer_atomic_add_f32 v11, v0, s[8:11], 0 offen
	.loc	1 80 1                          ; generate_amdgcn.py:80:1
	s_endpgm
.Ltmp16:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_vgpr, 70
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.numbered_sgpr, 32
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     34
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_pc_none_bm16_bn256_bk32_gm4_w8_s2_weu2_sk8_maskk.kd
