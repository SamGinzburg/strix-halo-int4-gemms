	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp14:
	...
	v_sub_nc_u32_e32 v56, s13, v4
	.loc	1 215 5                         ; generate_amdgcn.py:215:5
	v_or_b32_e32 v4, s1, v4
	v_add_nc_u32_e32 v57, 0, v9
	v_or3_b32 v59, v0, v2, v3
	...
	v_xor_b32_e32 v12, 24, v58
	v_xor_b32_e32 v0, 32, v58
	v_xor_b32_e32 v3, 48, v58
	v_xor_b32_e32 v13, 56, v58
	v_xor_b32_e32 v14, 0x1008, v59
	v_xor_b32_e32 v15, 0x2010, v59
	v_xor_b32_e32 v16, 0x3018, v59
	v_xor_b32_e32 v17, 0x4020, v59
	v_xor_b32_e32 v18, 0x5028, v59
	v_xor_b32_e32 v19, 0x6030, v59
	v_xor_b32_e32 v20, 0x7038, v59
	s_cvt_u32_f32 s6, s6
	...
	v_lshl_add_u32 v60, v5, 3, v1
	v_lshl_add_u32 v61, v5, 2, v4
	v_add_nc_u32_e32 v62, 0, v38
	v_add_nc_u32_e32 v63, v57, v9
	v_add_nc_u32_e32 v64, v11, v6
	v_add_nc_u32_e32 v65, 0, v7
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_mul_hi_u32 s6, s18, s64
	s_abs_i32 s64, s65
	s_add_i32 s18, s18, s6
	s_xor_b32 s6, s65, s63
	s_mul_hi_u32 s18, s64, s18
	s_ashr_i32 s6, s6, 31
	s_mul_i32 s66, s18, s7
	s_delay_alu instid0(SALU_CYCLE_1)
	s_sub_i32 s64, s64, s66
	s_add_i32 s66, s18, 1
	s_sub_i32 s67, s64, s7
	s_cmp_ge_u32 s64, s7
	s_cselect_b32 s18, s66, s18
	s_cselect_b32 s64, s67, s64
	s_add_i32 s66, s18, 1
	s_cmp_ge_u32 s64, s7
	s_cselect_b32 s7, s66, s18
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	...
	s_mul_i32 s63, s18, s63
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_sub_i32 s63, s65, s63
	.loc	1 219 17 is_stmt 0              ; generate_amdgcn.py:219:17
	s_add_i32 s63, s63, s19
	s_delay_alu instid0(SALU_CYCLE_1)
...
; %bb.3:                                ; %.lr.ph
	...
	v_dual_mov_b32 v0, 0 :: v_dual_add_nc_u32 v33, s63, v61
	s_lshl_b32 s6, s6, 7
	s_mov_b32 s19, s1
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_cmp_lt_i32_e32 vcc_lo, s19, v56
	...
	s_cmp_lg_u32 s64, 0
	.loc	1 232 26                        ; generate_amdgcn.py:232:26
	buffer_load_b32 v37, v35, s[12:15], 0 offen
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
	v_cndmask_b32_e32 v35, 0x80000000, v34, vcc_lo
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	v_add_nc_u32_e32 v34, s62, v34
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
	buffer_load_b64 v[35:36], v35, s[4:7], 0 offen
	.loc	1 232 26                        ; generate_amdgcn.py:232:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(1)
	ds_store_b32 v57, v37
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 240 27                        ; generate_amdgcn.py:240:27
	ds_load_u8 v37, v62 offset:448
	ds_load_u8 v79, v62 offset:384
	ds_load_u8 v80, v62 offset:320
	ds_load_u8 v81, v62 offset:256
	ds_load_u8 v82, v62 offset:480
	ds_load_u8 v83, v62 offset:416
	ds_load_u8 v84, v62 offset:352
	ds_load_u8 v85, v62 offset:288
	ds_load_u8 v86, v62 offset:192
	ds_load_u8 v87, v62 offset:128
	ds_load_u8 v88, v62 offset:64
	ds_load_u8 v89, v62 offset:224
	ds_load_u8 v90, v62 offset:160
	ds_load_u8 v91, v62 offset:96
	ds_load_u8 v92, v62
	ds_load_u8 v93, v62 offset:32
	ds_load_u8 v94, v62 offset:704
	ds_load_u8 v95, v62 offset:640
	ds_load_u8 v96, v62 offset:576
	ds_load_u8 v97, v62 offset:512
	ds_load_u8 v98, v62 offset:736
	ds_load_u8 v99, v62 offset:672
	ds_load_u8 v100, v62 offset:608
	ds_load_u8 v101, v62 offset:544
	ds_load_u8 v102, v62 offset:960
	ds_load_u8 v103, v62 offset:896
	ds_load_u8 v104, v62 offset:832
	ds_load_u8 v105, v62 offset:768
	ds_load_u8 v106, v62 offset:992
	ds_load_u8 v107, v62 offset:928
	ds_load_u8 v108, v62 offset:864
	ds_load_u8 v109, v62 offset:800
	.loc	1 239 26                        ; generate_amdgcn.py:239:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(0)
	ds_store_b64 v63, v[35:36]
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 240 27                        ; generate_amdgcn.py:240:27
	ds_load_u8 v110, v64 offset:640
	ds_load_u8 v111, v64 offset:512
	ds_load_u8 v112, v64 offset:896
	ds_load_u8 v113, v64 offset:768
	ds_load_u8 v114, v64 offset:960
	ds_load_u8 v115, v64 offset:832
	ds_load_u8 v116, v64 offset:704
	ds_load_u8 v117, v64 offset:576
	ds_load_u8 v118, v64 offset:128
	ds_load_u8 v119, v64
	ds_load_u8 v120, v64 offset:384
	ds_load_u8 v121, v64 offset:256
	ds_load_u8 v122, v64 offset:448
	ds_load_u8 v123, v64 offset:320
	ds_load_u8 v124, v64 offset:192
	ds_load_u8 v125, v64 offset:64
	ds_load_u8 v126, v64 offset:1664
	ds_load_u8 v127, v64 offset:1536
	ds_load_u8 v128, v64 offset:1920
	ds_load_u8 v129, v64 offset:1792
	ds_load_u8 v130, v64 offset:1984
	ds_load_u8 v131, v64 offset:1856
	ds_load_u8 v132, v64 offset:1728
	ds_load_u8 v133, v64 offset:1600
	ds_load_u8 v134, v64 offset:1152
	ds_load_u8 v135, v64 offset:1024
	ds_load_u8 v136, v64 offset:1408
	ds_load_u8 v137, v64 offset:1280
	ds_load_u8 v138, v64 offset:1472
	ds_load_u8 v139, v64 offset:1344
	ds_load_u8 v140, v64 offset:1216
	ds_load_u8 v141, v64 offset:1088
	v_perm_b32 v35, v81, v80, 0xc0c0004
	v_perm_b32 v36, v79, v37, 0xc0c0004
	v_perm_b32 v37, v92, v88, 0xc0c0004
	...
	v_lshl_or_b32 v35, v79, 16, v37
	s_waitcnt lgkmcnt(30)
	v_perm_b32 v37, v111, v110, 0xc0c0004
	s_waitcnt lgkmcnt(28)
	v_perm_b32 v92, v113, v112, 0xc0c0004
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v93, v119, v118, 0xc0c0004
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v94, v121, v120, 0xc0c0004
	...
	v_perm_b32 v95, v129, v128, 0xc0c0004
	s_waitcnt lgkmcnt(6)
	...
	v_lshl_or_b32 v82, v82, 16, v84
	v_lshl_or_b32 v81, v85, 16, v83
	v_lshl_or_b32 v84, v89, 16, v88
	v_lshl_or_b32 v83, v91, 16, v90
	v_lshl_or_b32 v86, v92, 16, v37
	v_lshl_or_b32 v85, v94, 16, v93
	v_lshl_or_b32 v90, v99, 16, v98
	v_lshl_or_b32 v89, v101, 16, v100
	v_lshl_or_b32 v88, v95, 16, v87
	v_lshl_or_b32 v87, v97, 16, v96
	v_lshl_or_b32 v92, v103, 16, v102
	v_lshl_or_b32 v91, v105, 16, v104
	v_wmma_i32_16x16x16_iu4 v[0:7], v[85:86], v[35:36], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[89:90], v[35:36], v[8:15] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu4 v[0:7], v[87:88], v[79:80], v[0:7] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[8:15], v[91:92], v[79:80], v[8:15] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v16, s63, v38
	v_or_b32_e32 v17, s63, v40
	...
	buffer_load_u16 v93, v16, s[16:19], 0 offen
	buffer_load_u16 v94, v17, s[16:19], 0 offen
	...
	s_clause 0x7
	buffer_load_u16 v95, v16, s[16:19], 0 offen
	buffer_load_u16 v96, v17, s[16:19], 0 offen
	...
	.loc	1 243 18                        ; generate_amdgcn.py:243:18
	v_lshlrev_b32_e32 v23, 16, v94
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v117, v17, v24
	v_mul_f32_e32 v99, v16, v21
	s_delay_alu instid0(VALU_DEP_3)
	v_mul_f32_e32 v101, v16, v23
	v_mul_f32_e32 v102, v16, v24
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v103, v16, v25 :: v_dual_lshlrev_b32 v28, 16, v28
	.loc	1 243 18                        ; generate_amdgcn.py:243:18
	...
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v109, v16, v29 :: v_dual_lshlrev_b32 v94, 16, v96
	.loc	1 243 18                        ; generate_amdgcn.py:243:18
	v_lshlrev_b32_e32 v19, 16, v19
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v95, v16, v18
	v_mul_f32_e32 v111, v16, v31
	v_dual_mul_f32 v98, v16, v20 :: v_dual_lshlrev_b32 v27, 16, v27
	v_mul_f32_e32 v96, v16, v19
	v_mul_f32_e32 v100, v16, v22
	v_mul_f32_e32 v104, v16, v93
	v_mul_f32_e32 v105, v16, v94
	v_mul_f32_e32 v106, v16, v26
	v_mul_f32_e32 v107, v16, v27
	v_mul_f32_e32 v108, v16, v28
	v_mul_f32_e32 v110, v16, v30
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v16, v95, v92
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v112, v17, v18
	v_mul_f32_e32 v121, v17, v28
	v_mul_f32_e32 v119, v17, v26
	v_dual_mul_f32 v115, v17, v22 :: v_dual_mul_f32 v22, v99, v89
	v_mul_f32_e32 v124, v17, v31
	v_mul_f32_e32 v122, v17, v29
	v_mul_f32_e32 v93, v17, v93
	v_mul_f32_e32 v19, v17, v19
	v_mul_f32_e32 v123, v17, v30
	v_mul_f32_e32 v94, v17, v94
	v_mul_f32_e32 v113, v17, v20
	v_mul_f32_e32 v114, v17, v21
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v20, v98, v90
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v120, v17, v27
	v_dual_mul_f32 v118, v17, v25 :: v_dual_add_nc_u32 v97, 0, v58
	v_mul_f32_e32 v116, v17, v23
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v30, v103, v85
	v_dual_mul_f32 v84, v104, v84 :: v_dual_mul_f32 v85, v93, v7
	v_mul_f32_e32 v17, v112, v15
	v_dual_mul_f32 v18, v96, v91 :: v_dual_mul_f32 v19, v19, v14
	v_dual_mul_f32 v24, v100, v88 :: v_dual_mul_f32 v25, v115, v11
	v_dual_mul_f32 v26, v101, v87 :: v_dual_mul_f32 v23, v114, v12
	v_dual_mul_f32 v28, v102, v86 :: v_dual_mul_f32 v29, v117, v9
	v_dual_mul_f32 v86, v105, v83 :: v_dual_mul_f32 v31, v118, v8
	v_dual_mul_f32 v88, v107, v81 :: v_dual_mul_f32 v87, v94, v6
	v_dual_mul_f32 v82, v106, v82 :: v_dual_mul_f32 v83, v119, v5
	v_mul_f32_e32 v21, v113, v13
	v_dual_mul_f32 v90, v109, v79 :: v_dual_mul_f32 v89, v120, v4
	v_dual_mul_f32 v80, v108, v80 :: v_dual_mul_f32 v81, v121, v3
	v_dual_mul_f32 v92, v110, v37 :: v_dual_mul_f32 v37, v124, v0
	v_dual_mul_f32 v36, v111, v36 :: v_dual_mul_f32 v91, v122, v2
	v_mul_f32_e32 v27, v116, v10
	v_dual_mul_f32 v93, v123, v1 :: v_dual_add_nc_u32 v0, 0, v59
	ds_store_2addr_stride64_b64 v97, v[16:17], v[84:85] offset1:2
	...
	ds_store_2addr_stride64_b64 v71, v[30:31], v[36:37] offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_load_2addr_b64 v[16:19], v74 offset1:16
	ds_load_2addr_b64 v[12:15], v75 offset1:16
	ds_load_2addr_b64 v[8:11], v76 offset1:16
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 142
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 68
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     70
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_pc_none_persistent_bm64_bn128_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
