	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1                          ; -- Begin function amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1,@function
amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1:                                 ; @amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v65, 0 :: v_dual_and_b32 v4, 1, v0
	.loc	1 599 26                        ; attention.py:599:26
	...
	v_lshl_or_b32 v86, v75, 7, v2
	s_lshr_b32 s0, s0, 29
	.loc	1 573 27                        ; attention.py:573:27
	v_add_nc_u32_e32 v7, s14, v6
	.loc	1 566 23                        ; attention.py:566:23
	s_add_i32 s1, s3, s0
	v_dual_mov_b32 v25, 0 :: v_dual_lshlrev_b32 v80, 3, v4
	.loc	1 599 26                        ; attention.py:599:26
	v_lshl_or_b32 v2, v77, 6, v86
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v14, 0x7632 :: v_dual_add_nc_u32 v85, s13, v7
	...
	s_add_i32 s48, s8, s1
	v_dual_mov_b32 v31, v65 :: v_dual_add_nc_u32 v2, 0, v2
	.loc	1 599 26                        ; attention.py:599:26
	...
	v_dual_mov_b32 v18, 0x7531 :: v_dual_add_nc_u32 v89, v3, v84
	v_lshl_or_b32 v13, v13, 8, v13
	v_lshl_or_b32 v16, v16, 8, v16
	.loc	1 707 13                        ; attention.py:707:13
	v_add_nc_u32_e32 v88, v3, v80
	v_dual_mov_b32 v19, v65 :: v_dual_add_nc_u32 v90, v3, v83
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v28, v65 :: v_dual_and_b32 v13, 0x760032, v13
	v_dual_mov_b32 v26, v65 :: v_dual_add_nc_u32 v91, v3, v82
	v_dual_mov_b32 v21, v65 :: v_dual_add_nc_u32 v92, v3, v81
	v_lshl_or_b32 v3, v13, 4, v13
	...
	v_dual_mov_b32 v32, v65 :: v_dual_and_b32 v93, 0x7060302, v3
	v_lshl_or_b32 v3, v13, 4, v13
	v_lshl_or_b32 v13, v16, 8, v16
	s_delay_alu instid0(VALU_DEP_4)
	v_cmp_eq_u32_e64 s12, 0, v18
	v_xor_b32_e32 v11, 0x50, v86
	v_lshlrev_b32_e32 v4, 6, v4
	v_and_b32_e32 v94, 0x7060302, v3
	v_dual_mov_b32 v18, v65 :: v_dual_and_b32 v3, 0x750031, v13
	v_cndmask_b32_e64 v10, 0x1054, v10, s12
	v_cndmask_b32_e64 v14, 0x3276, v14, s12
	v_lshl_or_b32 v16, v17, 8, v17
	s_delay_alu instid0(VALU_DEP_4)
	v_lshl_or_b32 v3, v3, 4, v3
	.loc	1 749 30                        ; attention.py:749:30
	v_dual_mov_b32 v125, v85 :: v_dual_add_nc_u32 v106, 0, v11
	v_lshl_or_b32 v10, v10, 8, v10
	v_mov_b32_e32 v11, v65
	v_and_or_b32 v98, v1, 60, v4
	v_lshl_or_b32 v1, v14, 8, v14
	.loc	1 571 21                        ; attention.py:571:21
	v_bfe_i32 v5, v0, 0, 1
	.loc	1 601 23                        ; attention.py:601:23
	v_cmp_gt_i32_e64 s0, 0x200, v6
	v_dual_mov_b32 v29, v65 :: v_dual_and_b32 v6, 0x70, v0
	v_xor_b32_e32 v12, 0x60, v86
	v_dual_mov_b32 v20, v65 :: v_dual_and_b32 v13, 0x750031, v16
	v_and_b32_e32 v96, 0x7050301, v3
	v_and_b32_e32 v3, 0x540054, v10
	v_and_b32_e32 v1, 0x760076, v1
	v_lshlrev_b32_e32 v10, 7, v0
	v_xor_b32_e32 v15, 0x70, v86
	...
	v_xor_b32_e32 v7, 32, v86
	v_xor_b32_e32 v8, 48, v86
	v_xor_b32_e32 v9, 64, v86
	v_dual_mov_b32 v22, v65 :: v_dual_lshlrev_b32 v95, 2, v17
	v_xor_b32_e32 v4, 16, v99
	v_add_nc_u32_e32 v103, 0, v7
	v_dual_mov_b32 v123, v85 :: v_dual_add_nc_u32 v104, 0, v8
	v_dual_mov_b32 v6, v65 :: v_dual_add_nc_u32 v105, 0, v9
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v110, 0, v4
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s3, s3, s34
	.loc	1 741 30                        ; attention.py:741:30
	v_dual_mov_b32 v66, v65 :: v_dual_add_nc_u32 v133, 0, v86
	...
	.loc	1 741 30                        ; attention.py:741:30
	v_dual_mov_b32 v71, v65 :: v_dual_add_nc_u32 v158, s5, v119
	...
	v_or_b32_e32 v134, s44, v111
	v_or_b32_e32 v135, s44, v112
	...
	v_add_lshl_u32 v150, s4, v114, 1
	v_add_lshl_u32 v151, s4, v88, 1
	v_add_lshl_u32 v152, s4, v116, 1
	v_add_lshl_u32 v153, s4, v115, 1
...
.Ltmp41:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_vgpr, 168
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.numbered_sgpr, 51
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1"                        ; string offset=88 ; amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1
    .private_segment_fixed_size: 0
    .sgpr_count:     53
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_fwd_bf16xint4_bf16_local_float32_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn16_w4_s1_ds1.kd
