	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
.Lfunc_begin0:
...
; %bb.4:                                ; %.lr.ph
	...
	v_subrev_nc_u32_e32 v5, s1, v26
	v_mul_lo_u32 v26, s34, v4
	...
	v_mad_u64_u32 v[4:5], null, s14, v37, s[12:13]
	...
	v_add3_u32 v40, v2, v1, 64
	v_add3_u32 v41, v3, v1, 64
	...
	v_dual_mov_b32 v4, s15 :: v_dual_lshlrev_b32 v39, 1, v26
	v_mov_b32_e32 v12, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v67, v90, v67 :: v_dual_add_nc_u32 v96, s12, v41
...
.LBB0_11:
	...
	buffer_load_u16 v51, v28, s[4:7], 0 offen
	.loc	1 195 18                        ; generate_amdgcn.py:195:18
	s_waitcnt vmcnt(8)
	...
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_and_b32_e32 v36, 0x78, v44
	v_and_b32_e32 v44, 1, v0
	v_bfe_i32 v0, v0, 7, 1
	v_mov_b16_e32 v28.l, 0
	v_lshlrev_b32_e32 v11, 4, v11
	v_lshl_or_b32 v9, v9, 3, v36
	v_lshlrev_b32_e32 v36, 6, v44
	v_and_b32_e32 v0, 0x840, v0
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_mul_f32_e32 v38, v38, v28
	v_dual_mul_f32 v35, v35, v28 :: v_dual_lshlrev_b32 v2, 11, v2
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_add3_u32 v28, s0, s33, v30
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v55, 52, v34
	v_or_b32_e32 v59, 20, v34
	v_or_b32_e32 v60, 12, v34
	v_or_b32_e32 v61, 4, v34
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v3, v3, v29 :: v_dual_add_nc_u32 v64, 0, v0
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mad_u64_u32 v[29:30], null, s35, v34, v[28:29]
	.loc	1 126 32                        ; generate_amdgcn.py:126:32
	v_or_b32_e32 v54, 60, v34
	v_or_b32_e32 v56, 44, v34
	v_or_b32_e32 v57, 36, v34
	v_or_b32_e32 v58, 28, v34
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v36, s35, v61
	v_mul_lo_u32 v44, s35, v60
	v_mul_lo_u32 v52, s35, v59
	v_mul_lo_u32 v53, s35, v55
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	v_add_nc_u32_e32 v30, 0, v2
	v_xad_u32 v34, v2, 8, 0
	v_xad_u32 v55, v2, 16, 0
	v_xad_u32 v59, v2, 24, 0
	v_xad_u32 v60, v2, 32, 0
	v_xad_u32 v61, v2, 40, 0
	v_xad_u32 v62, v2, 48, 0
	v_xad_u32 v63, v2, 56, 0
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 247 23                        ; generate_amdgcn.py:247:23
	...
	v_fma_f32 v46, v8, v11, v22
	v_fma_f32 v33, v33, v45, v20
	v_fma_f32 v39, v40, v10, v16
	v_fma_f32 v11, v41, v11, v15
	v_fma_f32 v40, v43, v45, v13
	v_fma_f32 v32, v32, v31, v21
	v_fma_f32 v31, v42, v31, v14
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_cndmask_b32_e64 v10, v22, v46, s2
	...
	v_cndmask_b32_e64 v22, v14, v31, s2
	...
	ds_store_b64 v62, v[21:22]
	ds_store_b64 v63, v[12:13]
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	v_add_lshl_u32 v18, v28, v36, 2
	.loc	1 247 23 is_stmt 0              ; generate_amdgcn.py:247:23
	v_mul_lo_u32 v16, s35, v54
	.loc	1 247 9                         ; generate_amdgcn.py:247:9
	v_add_lshl_u32 v19, v29, s1, 2
	v_add_lshl_u32 v20, v28, v44, 2
	v_add_lshl_u32 v21, v29, s3, 2
	v_add_lshl_u32 v22, v28, v52, 2
	v_add_lshl_u32 v23, v29, s4, 2
	v_add_lshl_u32 v24, v28, v58, 2
	v_add_lshl_u32 v25, v29, s5, 2
	v_add_lshl_u32 v26, v28, v57, 2
	v_add_lshl_u32 v27, v29, s8, 2
	s_waitcnt lgkmcnt(3)
	...
	buffer_atomic_add_f32 v9, v27, s[20:23], 0 offen
	v_add_lshl_u32 v30, v28, v56, 2
	v_add_lshl_u32 v31, v29, s9, 2
	v_add_lshl_u32 v32, v28, v53, 2
	v_add_lshl_u32 v29, v29, s10, 2
	v_add_lshl_u32 v0, v28, v16, 2
	s_clause 0x4
	...
	buffer_atomic_add_f32 v11, v29, s[20:23], 0 offen
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_vgpr, 98
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.numbered_sgpr, 46
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     48
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_sc128_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk8_maskk.kd
