	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk,@function
amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
.Lfunc_begin0:
...
.Ltmp13:
	...
	v_cndmask_b32_e64 v27, 0x80000000, v3, s2
	...
	buffer_load_b128 v[21:24], v7, s[24:27], 0 offen
	v_cndmask_b32_e64 v6, 0x80000000, v25, s2
	v_cndmask_b32_e64 v7, 0x80000000, v26, s2
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v47, v1, s[20:23], 0 offen
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[25:28], v27, s[24:27], 0 offen
	buffer_load_b128 v[35:38], v8, s[24:27], 0 offen
	buffer_load_b128 v[39:42], v6, s[24:27], 0 offen
	buffer_load_b128 v[43:46], v7, s[24:27], 0 offen
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
...
.Ltmp14:
	...
	s_mov_b32 s11, s4
	v_and_b32_e32 v30, 0x70, v1
	v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v22, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mul_i32 s1, s0, s29
	.loc	1 372 30                        ; generate_amdgcn.py:372:30
	v_mad_u64_u32 v[35:36], null, s0, s28, v[11:12]
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	s_add_i32 s1, s1, s14
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	v_add_nc_u32_e32 v38, s6, v33
	.loc	1 378 30                        ; generate_amdgcn.py:378:30
	v_add_nc_u32_e32 v36, s1, v9
	v_add_nc_u32_e32 v40, s1, v31
	v_add_nc_u32_e32 v41, s1, v32
	v_add_nc_u32_e32 v42, s1, v10
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	buffer_load_b32 v111, v35, s[20:23], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 378 22                        ; generate_amdgcn.py:378:22
	s_clause 0x3
	buffer_load_b128 v[51:54], v36, s[24:27], 0 offen
	buffer_load_b128 v[55:58], v40, s[24:27], 0 offen
	buffer_load_b128 v[59:62], v41, s[24:27], 0 offen
	buffer_load_b128 v[63:66], v42, s[24:27], 0 offen
	...
	v_dual_add_f32 v19, v19, v44 :: v_dual_add_nc_u32 v244, s7, v29
	v_dual_add_f32 v28, v28, v36 :: v_dual_add_nc_u32 v245, s0, v34
	v_dual_add_f32 v22, v22, v35 :: v_dual_add_f32 v27, v27, v37
	v_dual_add_f32 v26, v26, v38 :: v_dual_add_f32 v25, v25, v39
	v_dual_add_f32 v24, v24, v40 :: v_dual_add_f32 v17, v17, v46
...
.LBB0_11:
	...
	buffer_load_u16 v37, v7, s[4:7], 0 offen
	...
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	buffer_load_u16 v7, v12, s[4:7], 0 offen
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	...
	v_cndmask_b32_e64 v29, v17, v31, s2
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xad_u32 v49, 0x404, v33, 0
	v_lshl_or_b32 v40, v40, 10, v0
	.loc	1 405 14                        ; generate_amdgcn.py:405:14
	v_lshlrev_b32_e32 v0, 16, v7
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xad_u32 v50, 0x808, v33, 0
	v_xad_u32 v51, 0xc0c, v33, 0
	v_xad_u32 v52, 0x1010, v33, 0
	v_xad_u32 v64, v40, 4, 0
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	ds_store_b32 v48, v0
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_xad_u32 v65, v40, 8, 0
	v_xad_u32 v66, v40, 12, 0
	v_xad_u32 v67, v40, 16, 0
	v_xad_u32 v53, 0x1414, v33, 0
	v_xad_u32 v54, 0x1818, v33, 0
	v_xad_u32 v55, 0x1c1c, v33, 0
	v_xad_u32 v56, 0x2040, v33, 0
	v_xad_u32 v57, 0x2444, v33, 0
	v_xad_u32 v58, 0x2848, v33, 0
	v_xad_u32 v68, v40, 20, 0
	v_xad_u32 v69, v40, 24, 0
	v_xad_u32 v59, 0x2c4c, v33, 0
	v_xad_u32 v60, 0x3050, v33, 0
	v_xad_u32 v61, 0x3454, v33, 0
	v_xad_u32 v62, 0x3858, v33, 0
	v_add_lshl_u32 v35, v16, s29, 2
	v_add_lshl_u32 v36, v16, s1, 2
	v_add_lshl_u32 v38, v16, s3, 2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v2, v2, v37
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	v_add_lshl_u32 v39, v16, s4, 2
	v_add_lshl_u32 v41, v16, s5, 2
	v_add_lshl_u32 v42, v16, s8, 2
	v_add_lshl_u32 v43, v16, s9, 2
	...
	v_dual_mul_f32 v4, v4, v37 :: v_dual_add_nc_u32 v63, 0, v40
	...
	v_dual_mul_f32 v3, v3, v37 :: v_dual_lshlrev_b32 v34, 2, v16
	v_dual_mul_f32 v5, v5, v37 :: v_dual_mul_f32 v0, v22, v0
	.loc	1 418 9 is_stmt 1               ; generate_amdgcn.py:418:9
	v_xad_u32 v40, v40, 28, 0
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v3, v26, v3 :: v_dual_mul_f32 v4, v25, v4
	.loc	1 418 9                         ; generate_amdgcn.py:418:9
	s_barrier
	v_add_lshl_u32 v44, v16, s10, 2
	v_add_lshl_u32 v45, v16, s11, 2
	v_add_lshl_u32 v46, v16, s16, 2
	v_add_lshl_u32 v47, v16, s17, 2
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	...
	.loc	1 406 16                        ; generate_amdgcn.py:406:16
	v_dual_mul_f32 v13, v13, v37 :: v_dual_mul_f32 v6, v23, v6
	.loc	1 406 9                         ; generate_amdgcn.py:406:9
	v_dual_mul_f32 v8, v20, v8 :: v_dual_add_nc_u32 v19, s31, v34
	v_dual_mul_f32 v1, v28, v1 :: v_dual_mul_f32 v10, v18, v10
	v_mul_f32_e32 v11, v29, v11
	v_dual_mul_f32 v5, v24, v5 :: v_dual_mul_f32 v12, v30, v12
	v_dual_mul_f32 v13, v31, v13 :: v_dual_mul_f32 v14, v17, v14
	.loc	1 418 9 is_stmt 1               ; generate_amdgcn.py:418:9
	...
	ds_store_2addr_stride64_b32 v40, v7, v15 offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b32 v0, v48
	ds_load_b32 v1, v49
	...
	ds_load_b32 v9, v57
	ds_load_b32 v10, v58
	v_xad_u32 v11, 0x3c5c, v33, 0
	ds_load_b32 v12, v59
	ds_load_b32 v13, v60
	ds_load_b32 v14, v61
	ds_load_b32 v15, v62
	ds_load_b32 v11, v11
	v_lshl_add_u32 v17, s29, 3, v34
	v_add_nc_u32_e32 v18, s30, v34
	s_waitcnt lgkmcnt(15)
	...
	s_waitcnt lgkmcnt(10)
	buffer_atomic_add_f32 v5, v38, s[12:15], 0 offen
	s_waitcnt lgkmcnt(9)
	buffer_atomic_add_f32 v6, v39, s[12:15], 0 offen
	s_waitcnt lgkmcnt(8)
	buffer_atomic_add_f32 v7, v41, s[12:15], 0 offen
	s_waitcnt lgkmcnt(7)
	buffer_atomic_add_f32 v8, v19, s[12:15], 0 offen
	s_waitcnt lgkmcnt(6)
	buffer_atomic_add_f32 v9, v42, s[12:15], 0 offen
	s_waitcnt lgkmcnt(5)
	buffer_atomic_add_f32 v10, v43, s[12:15], 0 offen
	v_add_lshl_u32 v0, v16, s0, 2
	s_waitcnt lgkmcnt(4)
	buffer_atomic_add_f32 v12, v44, s[12:15], 0 offen
	s_waitcnt lgkmcnt(3)
	buffer_atomic_add_f32 v13, v45, s[12:15], 0 offen
	s_waitcnt lgkmcnt(2)
	buffer_atomic_add_f32 v14, v46, s[12:15], 0 offen
	s_waitcnt lgkmcnt(1)
	buffer_atomic_add_f32 v15, v47, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
...
.Ltmp16:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_vgpr, 246
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.numbered_sgpr, 37
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     39
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_tn_pc_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk8_evenk.kd
