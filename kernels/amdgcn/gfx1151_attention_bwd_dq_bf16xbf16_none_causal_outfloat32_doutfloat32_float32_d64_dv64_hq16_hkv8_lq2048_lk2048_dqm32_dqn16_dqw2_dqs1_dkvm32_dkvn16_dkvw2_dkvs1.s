	...
	.text
	.globl	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1                          ; -- Begin function amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.p2align	8
	.type	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1,@function
amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1:                                 ; @amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
.Lfunc_begin0:
...
.Ltmp0:
	...
	.loc	1 166 23                        ; attention_backward.py:166:23
	v_add_lshl_u32 v25, v25, s5, 2
	v_cndmask_b32_e32 v35, 0x80000000, v18, vcc_lo
	v_add_lshl_u32 v24, v23, v24, 2
	v_add_lshl_u32 v18, v21, s5, 2
	v_add_lshl_u32 v19, v23, v19, 2
	v_cndmask_b32_e32 v34, 0x80000000, v25, vcc_lo
	s_and_b32 s21, s9, 0xffff
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_cndmask_b32 v36, 0x80000000, v24 :: v_dual_cndmask_b32 v41, 0x80000000, v18
	.loc	1 124 31                        ; attention_backward.py:124:31
	v_and_b32_e32 v82, 15, v0
	.loc	1 166 23                        ; attention_backward.py:166:23
	s_mov_b32 s20, s8
	v_dual_cndmask_b32 v37, 0x80000000, v26 :: v_dual_cndmask_b32 v38, 0x80000000, v20
	v_dual_cndmask_b32 v39, 0x80000000, v22 :: v_dual_and_b32 v110, 32, v0
	...
	.loc	1 166 23                        ; attention_backward.py:166:23
	s_clause 0x7
	buffer_load_b128 v[2:5], v34, s[20:23], 0 offen
	buffer_load_b128 v[6:9], v35, s[20:23], 0 offen
	buffer_load_b128 v[10:13], v41, s[20:23], 0 offen
	buffer_load_b128 v[14:17], v36, s[20:23], 0 offen
	buffer_load_b128 v[18:21], v37, s[20:23], 0 offen
	buffer_load_b128 v[22:25], v38, s[20:23], 0 offen
	buffer_load_b128 v[26:29], v39, s[20:23], 0 offen
	buffer_load_b128 v[30:33], v40, s[20:23], 0 offen
	.loc	1 171 28                        ; attention_backward.py:171:28
	s_and_b32 s21, s11, 0xffff
	s_mov_b32 s20, s10
	s_clause 0x7
	buffer_load_b128 v[69:72], v34, s[20:23], 0 offen
	buffer_load_b128 v[65:68], v35, s[20:23], 0 offen
	buffer_load_b128 v[61:64], v41, s[20:23], 0 offen
	buffer_load_b128 v[57:60], v36, s[20:23], 0 offen
	buffer_load_b128 v[53:56], v37, s[20:23], 0 offen
	buffer_load_b128 v[49:52], v38, s[20:23], 0 offen
	buffer_load_b128 v[45:48], v39, s[20:23], 0 offen
	buffer_load_b128 v[41:44], v40, s[20:23], 0 offen
	.loc	1 159 29                        ; attention_backward.py:159:29
	v_lshlrev_b32_e32 v102, 4, v101
	.loc	1 123 19                        ; attention_backward.py:123:19
	s_add_i32 s3, s3, s5
	.loc	1 124 31                        ; attention_backward.py:124:31
	v_lshrrev_b32_e32 v34, 1, v110
	.loc	1 123 19                        ; attention_backward.py:123:19
	...
	v_xor_b32_e32 v104, 32, v132
	v_xor_b32_e32 v105, 48, v132
	v_xor_b32_e32 v106, 64, v132
	v_xor_b32_e32 v107, 0x50, v132
	v_xor_b32_e32 v108, 0x60, v132
	v_xor_b32_e32 v109, 0x70, v132
...
.Ltmp3:
	...
	v_fmac_f32_e32 v13, v14, v57
	v_dual_fmac_f32 v15, v16, v59 :: v_dual_add_f32 v12, v7, v8
.Ltmp4:
	.loc	1 159 29                        ; attention_backward.py:159:29
	v_add_nc_u32_e32 v79, 0, v38
.Ltmp5:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
...
.Ltmp6:
	...
	v_dual_mov_b32 v16, v12 :: v_dual_add_nc_u32 v73, 0, v35
.Ltmp7:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
...
.Ltmp15:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
	v_dual_mov_b32 v13, v9 :: v_dual_add_nc_u32 v80, 0, v35
	v_mov_b32_dpp v14, v14 row_xmask:4 row_mask:0xf bank_mask:0xf
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v40, v36 :: v_dual_fmac_f32 v17, v18, v53
	v_mov_b32_dpp v13, v13 row_xmask:4 row_mask:0xf bank_mask:0xf
.Ltmp16:
	.loc	1 159 29                        ; attention_backward.py:159:29
	ds_load_b128 v[25:28], v74
	ds_load_b128 v[29:32], v80
.Ltmp17:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
...
.Ltmp21:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention_backward.py:176:17 ]
	v_dual_mov_b32 v38, v34 :: v_dual_add_f32 v85, v36, v40
.Ltmp22:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention_backward.py:176:17 ] ]
...
; %bb.1:                                ; %.lr.ph
	...
	v_add_nc_u32_e32 v93, 0, v103
	v_dual_mov_b32 v91, 0 :: v_dual_add_nc_u32 v94, 0, v104
	v_add_nc_u32_e32 v95, 0, v105
	v_lshl_add_u32 v96, v35, 1, v102
	v_add_nc_u32_e32 v97, 0, v106
	v_add_nc_u32_e32 v98, 0, v107
	v_add_nc_u32_e32 v99, 0, v108
	v_add_nc_u32_e32 v100, 0, v109
...
.Ltmp67:
	...
	.loc	1 267 9                         ; attention_backward.py:267:9
	v_add_nc_u32_e32 v115, 0, v81
	v_lshrrev_b32_e32 v81, 1, v114
	.loc	1 392 17                        ; attention_backward.py:392:17
	...
	.loc	1 267 9                         ; attention_backward.py:267:9
	s_waitcnt lgkmcnt(0)
	buffer_store_b32 v81, v36, s[36:39], 0 offen
	.loc	1 392 17                        ; attention_backward.py:392:17
	...
	ds_load_b128 v[45:48], v75
	ds_load_b128 v[49:52], v76
...
; %bb.5:                                ; %.lr.ph7
	...
	v_dual_mov_b32 v80, v81 :: v_dual_add_nc_u32 v159, 0, v103
	v_add_nc_u32_e32 v160, 0, v104
	v_dual_mov_b32 v34, v81 :: v_dual_add_nc_u32 v161, 0, v105
	v_add_nc_u32_e32 v162, 0, v106
	v_dual_mov_b32 v36, v81 :: v_dual_add_nc_u32 v163, 0, v107
	v_add_nc_u32_e32 v164, 0, v108
	v_dual_mov_b32 v38, v81 :: v_dual_add_nc_u32 v165, 0, v109
...
.Ltmp68:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1, .Lfunc_end0-amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_vgpr, 218
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_agpr, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.numbered_sgpr, 40
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.private_seg_size, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_vcc, 1
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_recursion, 0
	.set amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1"                        ; string offset=97 ; amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1
    .private_segment_fixed_size: 0
    .sgpr_count:     42
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_attention_bwd_dq_bf16xbf16_none_causal_outfloat32_doutfloat32_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_dqm32_dqn16_dqw2_dqs1_dkvm32_dkvn16_dkvw2_dkvs1.kd
