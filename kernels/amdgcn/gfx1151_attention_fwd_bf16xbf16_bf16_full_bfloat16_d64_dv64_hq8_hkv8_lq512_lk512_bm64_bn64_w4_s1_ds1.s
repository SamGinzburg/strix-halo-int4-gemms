...
.Ltmp0:
	...
	v_dual_mov_b32 v131, v17 :: v_dual_add_nc_u32 v154, 0, v67
	v_dual_mov_b32 v133, v17 :: v_dual_add_nc_u32 v160, 0, v57
...
.Ltmp11:
	...
	v_permlanex16_b32 v98, v89, s99, 0xfedcba98 op_sel:[1,0]
.Ltmp12:
...
.Ltmp20:
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v95, v99, s99, 0xfedcba98 op_sel:[1,0]
...
.Ltmp46:
	...
	v_permlanex16_b32 v69, v66, s99, 0xfedcba98 op_sel:[1,0]
...
.Ltmp48:
	...
	v_permlanex16_b32 v69, v67, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2)
	v_perm_b32 v93, v66, v65, v141
	v_perm_b32 v94, v66, v65, v142
	v_permlanex16_b32 v65, v68, s99, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v69, v65, s99, 0xfedcba98 op_sel:[1,0]
	.loc	1 690 33                        ; attention.py:690:33
	...
	v_permlanex16_b32 v66, v68, s99, 0xfedcba98 op_sel:[1,0]
	v_mov_b16_e32 v69.h, v123.l
	.loc	1 688 24                        ; attention.py:688:24
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_permlanex16_b32 v68, v69, s99, 0xfedcba98 op_sel:[1,0]
	...
	v_permlanex16_b32 v70, v77, s99, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
.Ltmp52:
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v221, v124, s99, 0xfedcba98 op_sel:[1,0]
.Ltmp53:
	.loc	2 170 12                        ; standard.py:170:12 @[ standard.py:191:16 @[ attention.py:687:29 ] ]
...
.Ltmp57:
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v72, v99, s99, 0xfedcba98 op_sel:[1,0]
...
.Ltmp71:
	...
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v76, v77, s99, 0xfedcba98 op_sel:[1,0]
	.loc	1 690 33                        ; attention.py:690:33
...
.Ltmp85:
	...
	v_add_lshl_u32 v134, s77, v188, 1
	.loc	1 700 30                        ; attention.py:700:30
	...
	.loc	1 694 30                        ; attention.py:694:30
	v_add_lshl_u32 v196, s77, v189, 1
	v_add_lshl_u32 v207, s77, v139, 1
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v78, v79, s99, 0xfedcba98 op_sel:[1,0]
	.loc	1 689 25                        ; attention.py:689:25
	...
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 700 30                        ; attention.py:700:30
	v_permlanex16_b32 v80, v124, s99, 0xfedcba98 op_sel:[1,0]
	.loc	1 699 23                        ; attention.py:699:23
	...
	.loc	1 694 30                        ; attention.py:694:30
	v_add_lshl_u32 v131, s77, v136, 1
.Ltmp86:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.num_vgpr, 227
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.numbered_sgpr, 101
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.private_seg_size, 0
	...
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_bf16_full_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn64_w4_s1_ds1.uses_flat_scratch, 0
