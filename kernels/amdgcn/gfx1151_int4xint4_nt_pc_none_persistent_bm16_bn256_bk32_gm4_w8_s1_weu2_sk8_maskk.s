	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk    ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk,@function
amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk:           ; @amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
.Lfunc_begin0:
...
.Ltmp14:
	...
	s_mul_i32 s39, s21, 9
	s_mul_i32 s40, s21, 10
	s_mul_i32 s41, s21, 11
	s_mul_i32 s42, s21, 12
	s_mul_i32 s43, s21, 13
	s_mul_i32 s44, s21, 14
	s_mul_i32 s45, s21, 15
	s_bfe_i32 s47, s16, 0x1001d
	s_add_i32 s48, s17, s1
...
.LBB0_2:                                ; =>This Loop Header: Depth=1
	...
	s_abs_i32 s1, s2
	s_ashr_i32 s7, s2, 31
	s_mul_hi_u32 s6, s1, s48
	s_xor_b32 s7, s7, s47
	s_mul_i32 s49, s6, s30
	v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v4, 0
	s_sub_i32 s1, s1, s49
	s_add_i32 s49, s6, 1
	s_sub_i32 s50, s1, s30
	s_cmp_ge_u32 s1, s30
	...
	s_lshl_b32 s49, s49, 4
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	s_cbranch_vccnz .LBB0_6
; %bb.3:                                ; %.lr.ph
                                        ;   in Loop: Header=BB0_2 Depth=1
	.loc	1 0 13 is_stmt 0                ; generate_amdgcn.py:0:13
	v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v4, s49, v23
	.loc	1 226 13                        ; generate_amdgcn.py:226:13
	s_lshl_b32 s6, s6, 8
	s_lshl_b32 s1, s1, 8
	v_or_b32_e32 v2, s6, v31
	v_or_b32_e32 v3, s6, v24
	v_mad_u64_u32 v[19:20], null, s28, v4, v[17:18]
	v_mov_b32_e32 v4, v1
	...
	v_mov_b32_e32 v6, v1
	v_mov_b32_e32 v7, v1
	v_mad_u64_u32 v[20:21], null, s28, v2, v[18:19]
	v_mad_u64_u32 v[21:22], null, s28, v3, v[18:19]
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v8, v1
	v_mov_b32_e32 v9, v1
...
.LBB0_4:                                ;   Parent Loop BB0_2 Depth=1
	...
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	v_cndmask_b32_e64 v22, 0x80000000, v58, s1
	...
	.loc	1 234 26                        ; generate_amdgcn.py:234:26
	buffer_load_u8 v22, v61, s[12:15], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 237 26                        ; generate_amdgcn.py:237:26
	s_waitcnt vmcnt(2)
...
.LBB0_6:                                ; %._crit_edge
	...
	v_or_b32_e32 v2, s49, v17
	.loc	1 222 18                        ; generate_amdgcn.py:222:18
	v_lshl_or_b32 v5, s50, 8, v0
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[62:65], v70 offset:16
	ds_load_b128 v[66:69], v70 offset:512
	s_waitcnt lgkmcnt(1)
	v_mul_f32_e32 v65, v65, v15
	ds_load_b128 v[11:14], v70
	ds_load_b128 v[70:73], v70 offset:528
	...
	v_dual_mul_f32 v12, v12, v60 :: v_dual_add_nc_u32 v1, s1, v5
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v14, v14, v15
	v_mul_f32_e32 v11, v11, v15
	v_mul_f32_e32 v62, v62, v15
	v_dual_mul_f32 v67, v67, v15 :: v_dual_add_nc_u32 v74, 0, v29
	.loc	1 279 13 is_stmt 1              ; generate_amdgcn.py:279:13
	v_ashrrev_i32_e32 v2, 31, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 244 13                        ; generate_amdgcn.py:244:13
	v_dual_mul_f32 v11, v11, v61 :: v_dual_mul_f32 v64, v64, v15
	...
	v_dual_mul_f32 v69, v69, v15 :: v_dual_mul_f32 v14, v14, v58
	v_mul_f32_e32 v63, v63, v15
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
	v_add_co_u32 v1, vcc_lo, s22, v1
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_dual_mul_f32 v70, v70, v15 :: v_dual_mul_f32 v9, v68, v9
	v_mul_f32_e32 v72, v72, v15
	.loc	1 279 13                        ; generate_amdgcn.py:279:13
	v_add_co_ci_u32_e64 v2, null, s23, v2, vcc_lo
	.loc	1 244 20                        ; generate_amdgcn.py:244:20
	v_mul_f32_e32 v71, v71, v15
	v_dual_mul_f32 v15, v73, v15 :: v_dual_mul_f32 v22, v63, v22
	.loc	1 244 13 is_stmt 0              ; generate_amdgcn.py:244:13
	v_mul_f32_e32 v21, v64, v21
	v_dual_mul_f32 v19, v66, v19 :: v_dual_mul_f32 v8, v69, v8
	v_dual_mul_f32 v13, v13, v59 :: v_dual_mul_f32 v10, v67, v10
	v_dual_mul_f32 v7, v70, v7 :: v_dual_mul_f32 v6, v71, v6
	v_dual_mul_f32 v4, v72, v4 :: v_dual_mul_f32 v3, v15, v3
	ds_store_2addr_stride64_b32 v74, v11, v19 offset1:2
	ds_store_2addr_stride64_b32 v35, v12, v10 offset1:2
	ds_store_2addr_stride64_b32 v36, v13, v9 offset1:2
	ds_store_2addr_stride64_b32 v37, v14, v8 offset1:2
	ds_store_2addr_stride64_b32 v38, v57, v7 offset1:2
	ds_store_2addr_stride64_b32 v39, v22, v6 offset1:2
	ds_store_2addr_stride64_b32 v40, v21, v4 offset1:2
	ds_store_2addr_stride64_b32 v41, v20, v3 offset1:2
	s_waitcnt lgkmcnt(0)
	s_barrier
	.loc	1 279 13 is_stmt 1              ; generate_amdgcn.py:279:13
...
.Ltmp15:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_vgpr, 75
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.numbered_sgpr, 55
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk"  ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     57
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nt_pc_none_persistent_bm16_bn256_bk32_gm4_w8_s1_weu2_sk8_maskk.kd
