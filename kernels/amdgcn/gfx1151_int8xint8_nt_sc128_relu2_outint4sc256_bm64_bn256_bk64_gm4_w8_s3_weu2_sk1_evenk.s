	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_8:                                ; %._crit_edge
	...
	v_dual_mov_b32 v246, 0 :: v_dual_and_b32 v207, 6, v238
	v_dual_mov_b32 v231, 0 :: v_dual_mov_b32 v0, 0
	v_dual_mov_b32 v160, 0 :: v_dual_mov_b32 v217, 0
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	v_lshl_or_b32 v229, v207, 3, v4
	v_dual_mov_b32 v236, 0 :: v_dual_mov_b32 v233, 0
	scratch_store_b32 off, v0, off          ; 4-byte Folded Spill
	v_dual_mov_b32 v158, 0 :: v_dual_mov_b32 v185, 0
	.loc	1 406 22                        ; generate_amdgcn.py:406:22
	...
	v_dual_mov_b32 v239, 0 :: v_dual_mov_b32 v248, 0
	v_dual_mov_b32 v241, 0 :: v_dual_mov_b32 v250, 0
	v_dual_mov_b32 v247, 0 :: v_dual_mov_b32 v218, 0
	v_dual_mov_b32 v249, 0 :: v_dual_mov_b32 v232, 0
...
.LBB0_10:
	...
	buffer_load_u16 v92, v4, s[8:11], 0 offen
	...
	v_dual_mov_b32 v209, 0 :: v_dual_mov_b32 v152, 0
	...
	v_dual_mov_b32 v159, 0 :: v_dual_mov_b32 v226, 0
...
; %bb.11:
	...
	v_dual_mov_b32 v124, v243 :: v_dual_add_nc_u32 v19, s44, v19
	v_dual_mov_b32 v159, v126 :: v_dual_add_nc_u32 v20, s44, v230
	...
	v_dual_mov_b32 v142, v18 :: v_dual_mov_b32 v151, v123
	v_dual_mov_b32 v150, v122 :: v_dual_mov_b32 v129, v249
	v_mov_b32_e32 v134, v248
	v_mov_b32_e32 v122, v0
	v_mov_b32_e32 v126, v250
	ds_load_b128 v[247:250], v19
	v_dual_mov_b32 v152, v153 :: v_dual_mov_b32 v167, v138
	v_mov_b32_e32 v153, v137
	v_dual_mov_b32 v137, v251 :: v_dual_mov_b32 v138, v252
	s_waitcnt vmcnt(2)
	v_mov_b16_e64 v145.l, v92.l
	v_mov_b16_e64 v143.l, v154.l
	...
	v_dual_mov_b32 v123, v112 :: v_dual_mov_b32 v112, v17
	v_dual_mov_b32 v17, v43 :: v_dual_add_nc_u32 v184, s1, v98
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v226, s19 :: v_dual_mov_b32 v207, v109
...
.Ltmp23:
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v37, v84, v37, s3
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v38, v91, v38, s3
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_waitcnt vmcnt(3)
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v89, v106, v255, v59
	v_fma_f32 v90, v107, v254, v58
	v_fma_f32 v98, v127, v18, v51
	v_fma_f32 v17, v133, v227, v45
	v_fma_f32 v18, v134, v243, v44
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v91, v4, v236, v26
	v_fma_f32 v93, v3, v160, v25
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt lgkmcnt(0)
	v_dual_mul_f32 v115, v14, v21 :: v_dual_lshlrev_b32 v22, 16, v22
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_fma_f32 v89, v6, v158, v28
	v_fma_f32 v90, v5, v217, v27
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_cndmask_b32_e64 v25, v25, v93, s3
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v95, v9, v19
	v_mul_f32_e32 v96, v10, v19
	v_mul_f32_e32 v97, v11, v19
	v_dual_mul_f32 v100, v14, v19 :: v_dual_mul_f32 v125, v9, v22
	...
	v_dual_mul_f32 v109, v8, v21 :: v_dual_mul_f32 v90, v5, v19
	v_mul_f32_e32 v91, v6, v19
	v_mul_f32_e32 v93, v7, v19
	v_mul_f32_e32 v121, v5, v22
	v_mul_f32_e32 v122, v6, v22
	v_mul_f32_e32 v123, v7, v22
	v_dual_mul_f32 v124, v8, v22 :: v_dual_mul_f32 v5, v5, v36
...
.Ltmp25:
	...
	ds_load_b128 v[1:4], v157 offset:40960
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v24, v24, v94, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v94, v8, v19
	v_mul_f32_e32 v8, v8, v36
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v92, v94, v155, v30
	v_fma_f32 v94, v96, v170, v32
	v_fma_f32 v96, v98, v172, v34
	v_fma_f32 v98, v100, v174, v39
	v_fma_f32 v8, v8, v152, v83
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_mul_f32 v89, v4, v19 :: v_dual_mul_f32 v102, v1, v21
	v_mul_f32_e32 v105, v4, v21
	v_mul_f32_e32 v117, v1, v22
	v_dual_mul_f32 v120, v4, v22 :: v_dual_mul_f32 v1, v1, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	v_dual_mul_f32 v19, v16, v19 :: v_dual_mul_f32 v2, v2, v36
	v_mul_f32_e32 v3, v3, v36
	v_mul_f32_e32 v14, v14, v36
	v_mul_f32_e32 v15, v15, v36
	v_mul_f32_e32 v16, v16, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v36, v41, v246, v23
	v_fma_f32 v41, v44, v161, v24
	v_fma_f32 v44, v45, v162, v25
	v_fma_f32 v45, v89, v163, v26
	v_fma_f32 v89, v90, v164, v27
	v_fma_f32 v90, v91, v165, v28
	v_fma_f32 v91, v93, v166, v29
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v25, v25, v44, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v93, v95, v167, v31
	v_fma_f32 v95, v97, v171, v33
	v_fma_f32 v97, v99, v173, v35
	v_fma_f32 v19, v19, v176, v20
	v_fma_f32 v100, v102, v177, v18
	v_fma_f32 v102, v104, v179, v46
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v25, v25, v25
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v99, v101, v175, v40
	v_fma_f32 v101, v103, v178, v17
	v_fma_f32 v103, v105, v180, v47
	v_fma_f32 v104, v106, v181, v48
	v_fma_f32 v105, v107, v182, v49
	v_fma_f32 v106, v108, v183, v50
	v_fma_f32 v107, v109, v184, v51
	v_fma_f32 v108, v110, v151, v52
	v_fma_f32 v109, v111, v187, v53
	v_fma_f32 v110, v112, v188, v54
	v_fma_f32 v111, v113, v189, v55
	v_fma_f32 v112, v114, v190, v56
	v_fma_f32 v114, v116, v192, v58
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_cndmask_b32_e64 v20, v46, v102, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_fma_f32 v16, v16, v226, v37
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v23, v36, s2
	v_cndmask_b32_e64 v24, v24, v41, s2
	v_cndmask_b32_e64 v36, v39, v98, s2
	v_cndmask_b32_e64 v39, v40, v99, s2
	v_cndmask_b32_e64 v41, v48, v104, s2
	v_cndmask_b32_e64 v44, v49, v105, s2
	v_cndmask_b32_e64 v45, v50, v106, s2
	v_cndmask_b32_e64 v46, v51, v107, s2
	v_cndmask_b32_e64 v49, v54, v110, s2
	v_cndmask_b32_e64 v50, v55, v111, s2
	v_cndmask_b32_e64 v55, v61, v116, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v113, v115, v191, v57
	v_fma_f32 v3, v3, v213, v78
	v_fma_f32 v15, v15, v225, v38
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v40, v47, v103, s2
	v_cndmask_b32_e64 v48, v53, v109, s2
	v_cndmask_b32_e64 v51, v56, v112, s2
	v_cndmask_b32_e64 v21, v59, v21, s2
	v_cndmask_b32_e64 v59, v65, v120, s2
	v_cndmask_b32_e64 v14, v43, v14, s2
	v_cndmask_b32_e64 v16, v37, v16, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v30, 0, v30 :: v_dual_max_f32 v37, v39, v39
	v_max_f32_e32 v20, 0, v20
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v115, v117, v194, v60
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v43, v46, v46 :: v_dual_max_f32 v46, v49, v49
	v_max_f32_e32 v39, v41, v41
	v_max_f32_e32 v49, v55, v55
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v31, v31, v93, s2
	v_cndmask_b32_e64 v33, v33, v95, s2
	v_cndmask_b32_e64 v54, v60, v115, s2
	v_cndmask_b32_e64 v3, v78, v3, s2
	v_cndmask_b32_e64 v15, v38, v15, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v38, v40, v40
	v_dual_max_f32 v40, v44, v44 :: v_dual_max_f32 v41, v45, v45
	v_dual_max_f32 v78, 0, v46 :: v_dual_max_f32 v39, 0, v39
	v_dual_max_f32 v82, 0, v49 :: v_dual_max_f32 v49, v59, v59
	v_dual_max_f32 v45, v48, v48 :: v_dual_max_f32 v48, v51, v51
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v117, v119, v196, v62
	v_fma_f32 v119, v121, v198, v64
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v53, v58, v114, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_max_f32_e32 v46, v54, v54
	v_max_f32_e32 v44, 0, v41
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v47, v52, v108, s2
	v_cndmask_b32_e64 v52, v57, v113, s2
	v_cndmask_b32_e64 v56, v62, v117, s2
	v_cndmask_b32_e64 v57, v63, v118, s2
	...
	v_max_f32_e32 v69, 0, v45
	v_max_f32_e32 v45, v53, v53
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v60, v66, v121, s2
	v_cndmask_b32_e64 v4, v79, v4, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v41, v47, v47 :: v_dual_max_f32 v22, v22, v22
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_max_f32_e32 v55, 0, v45
	v_dual_max_f32 v45, v57, v57 :: v_dual_max_f32 v4, v4, v4
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v58, v64, v119, s2
	v_cndmask_b32_e64 v64, v70, v125, s2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v47, v50, v50 :: v_dual_max_f32 v84, 0, v45
	v_dual_max_f32 v50, v60, v60 :: v_dual_max_f32 v51, 0, v41
	v_max_f32_e32 v45, v62, v62
	v_max_f32_e32 v41, v52, v52
	v_max_f32_e32 v49, v64, v64
	v_max_f32_e32 v81, 0, v46
	v_max_f32_e32 v46, v58, v58
	v_max_f32_e32 v88, 0, v45
	v_dual_max_f32 v52, 0, v41 :: v_dual_max_f32 v43, 0, v43
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v85, 0, v46 :: v_dual_max_f32 v8, v8, v8
	v_max_f32_e32 v46, v63, v63
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v18, v18, v100, s2
	v_cndmask_b32_e64 v17, v17, v101, s2
	...
	v_dual_max_f32 v34, v34, v34 :: v_dual_max_f32 v19, v19, v19
	v_max_f32_e32 v36, v36, v36
	v_max_f32_e32 v41, v56, v56
	v_dual_max_f32 v89, 0, v46 :: v_dual_max_f32 v16, v16, v16
	v_dual_max_f32 v46, v68, v68 :: v_dual_max_f32 v21, v21, v21
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v66, v72, v127, s2
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, 0, v23 :: v_dual_max_f32 v24, 0, v24
	v_dual_max_f32 v26, 0, v26 :: v_dual_max_f32 v33, 0, v33
	v_max_f32_e32 v28, 0, v28
	v_max_f32_e32 v32, 0, v32
	v_dual_max_f32 v34, 0, v34 :: v_dual_max_f32 v17, v17, v17
	v_max_f32_e32 v36, 0, v36
	v_dual_max_f32 v18, v18, v18 :: v_dual_max_f32 v37, 0, v37
	v_max_f32_e32 v47, 0, v47
	v_dual_max_f32 v83, 0, v41 :: v_dual_max_f32 v4, 0, v4
	v_dual_max_f32 v87, 0, v50 :: v_dual_max_f32 v8, 0, v8
	v_max_f32_e32 v41, v61, v61
	v_dual_max_f32 v50, v65, v65 :: v_dual_max_f32 v45, v67, v67
	v_dual_max_f32 v14, v14, v14 :: v_dual_max_f32 v1, v1, v1
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v98, v23, v23
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v94, 0, v46 :: v_dual_max_f32 v21, 0, v21
	v_dual_max_f32 v2, v2, v2 :: v_dual_max_f32 v3, v3, v3
	v_dual_max_f32 v5, v5, v5 :: v_dual_mul_f32 v54, v32, v32
	v_dual_max_f32 v19, 0, v19 :: v_dual_max_f32 v18, 0, v18
	v_dual_max_f32 v17, 0, v17 :: v_dual_max_f32 v38, 0, v38
	v_max_f32_e32 v61, 0, v41
	v_max_f32_e32 v91, 0, v50
	v_dual_max_f32 v93, 0, v45 :: v_dual_mul_f32 v80, v24, v24
	...
	v_dual_max_f32 v11, v11, v11 :: v_dual_mul_f32 v74, v20, v20
	v_dual_max_f32 v13, v13, v13 :: v_dual_mul_f32 v68, v51, v51
	v_dual_max_f32 v15, v15, v15 :: v_dual_mul_f32 v60, v52, v52
	v_max_f32_e32 v41, v66, v66
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v79, v26, v26
	v_dual_mul_f32 v45, v27, v27 :: v_dual_mul_f32 v50, v30, v30
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v3, 0, v3 :: v_dual_mul_f32 v58, v34, v34
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v57, v33, v33 :: v_dual_mul_f32 v32, v22, v22
	v_dual_mul_f32 v63, v36, v36 :: v_dual_mul_f32 v30, v1, v1
	v_mul_f32_e32 v66, v37, v37
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v90, 0, v49
	v_dual_max_f32 v9, v9, v9 :: v_dual_mul_f32 v70, v18, v18
	v_dual_max_f32 v7, 0, v7 :: v_dual_mul_f32 v76, v40, v40
	v_dual_max_f32 v11, 0, v11 :: v_dual_mul_f32 v64, v78, v78
	v_dual_max_f32 v13, 0, v13 :: v_dual_mul_f32 v56, v55, v55
	v_max_f32_e32 v96, 0, v15
	v_max_f32_e32 v92, 0, v41
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_mul_f32_e32 v41, v25, v25
	v_dual_mul_f32 v49, v29, v29 :: v_dual_mul_f32 v36, v91, v91
	v_dual_mul_f32 v67, v19, v19 :: v_dual_mul_f32 v28, v2, v2
	v_mul_f32_e32 v71, v17, v17
	v_dual_mul_f32 v75, v38, v38 :: v_dual_mul_f32 v26, v5, v5
	v_dual_mul_f32 v77, v39, v39 :: v_dual_mul_f32 v24, v10, v10
	v_mul_f32_e32 v69, v69, v69
	v_mul_f32_e32 v65, v47, v47
	v_dual_mul_f32 v59, v48, v48 :: v_dual_mul_f32 v40, v61, v61
	v_dual_mul_f32 v38, v88, v88 :: v_dual_mul_f32 v29, v3, v3
...
.Ltmp27:
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v9, 0, v9 :: v_dual_mul_f32 v72, v44, v44
	v_dual_max_f32 v95, 0, v14 :: v_dual_mul_f32 v48, v84, v84
	v_dual_max_f32 v97, 0, v16 :: v_dual_mul_f32 v52, v82, v82
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v53, v31, v31 :: v_dual_mul_f32 v34, v92, v92
	v_dual_mul_f32 v73, v43, v43 :: v_dual_mul_f32 v10, v13, v13
	v_mul_f32_e32 v51, v81, v81
	v_dual_mul_f32 v55, v21, v21 :: v_dual_mul_f32 v44, v86, v86
	v_dual_mul_f32 v15, v7, v7 :: v_dual_mul_f32 v16, v8, v8
...
.Ltmp29:
	...
	v_mul_f32_e32 v37, v89, v89
	v_mul_f32_e32 v35, v90, v90
...
.Ltmp35:
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v11, v95, v95 :: v_dual_max_f32 v4, v30, v28
...
.Ltmp44:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_max_f32 v19, v3, v19 :: v_dual_and_b32 v2, 4, v238
.Ltmp45:
	.loc	2 191 16                        ; standard.py:191:16 @[ generate_amdgcn.py:75:16 @[ generate_amdgcn.py:446:9 ] ]
...
.Ltmp72:
	...
	s_delay_alu instid0(VALU_DEP_4)
	v_mul_f32_e32 v42, v88, v85
	v_rcp_f32_e32 v83, v90
	v_fmac_f32_e32 v18, v89, v18
	v_div_scale_f32 v89, s2, v79, v81, v79
	v_fma_f32 v19, -v19, v20, v87
	v_fma_f32 v22, -v84, v42, v88
	s_mov_b32 vcc_lo, s0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_fmac_f32 v86, v19, v83 :: v_dual_mul_f32 v19, v88, v80
...
.Ltmp74:
	...
	v_div_fmas_f32 v18, v18, v20, v82
	s_mov_b32 vcc_lo, s3
	...
	v_div_fmas_f32 v18, v18, v86, v20
	...
	v_dual_fmac_f32 v81, v79, v81 :: v_dual_fmac_f32 v80, v90, v80
	v_fma_f32 v90, -v88, v91, 1.0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_fmac_f32_e32 v83, v87, v83
	v_div_scale_f32 v87, s0, v56, v78, v56
	v_dual_mul_f32 v18, v20, v80 :: v_dual_fmac_f32 v91, v90, v91
	...
	v_fma_f32 v92, -v89, v20, 1.0
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_dual_mul_f32 v19, v86, v79 :: v_dual_mul_f32 v90, v83, v80
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v78, v84, v20 :: v_dual_fmac_f32 v91, v85, v91
	...
	v_dual_mul_f32 v79, v38, v82 :: v_dual_fmac_f32 v36, v89, v36
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_dual_fmac_f32 v91, v80, v91 :: v_dual_mul_f32 v92, v89, v78
	...
	v_dual_fmac_f32 v84, v88, v83 :: v_dual_mul_f32 v93, v89, v82
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
.Ltmp76:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 256
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 45
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 72
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 72
    .sgpr_count:     47
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc128_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
