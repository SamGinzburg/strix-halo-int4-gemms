...
; %bb.1:                                ; %.lr.ph
	...
	v_dual_mov_b32 v30, v25 :: v_dual_lshlrev_b32 v13, 3, v0
	.loc	1 788 26 is_stmt 1              ; attention.py:788:26
	v_or3_b32 v2, v1, v2, v3
	v_mov_b32_e32 v27, v25
	.loc	1 866 47                        ; attention.py:866:47
	v_subrev_nc_u32_e32 v92, s8, v4
	v_dual_mov_b32 v28, v25 :: v_dual_add_nc_u32 v93, s9, v4
	...
	v_dual_mov_b32 v32, v25 :: v_dual_and_b32 v13, 48, v13
	...
	v_dual_mov_b32 v23, v25 :: v_dual_and_b32 v0, 0x5040504, v2
	v_add_nc_u32_e32 v1, s10, v1
	v_lshl_or_b32 v95, v66, 9, v5
	...
	v_dual_mov_b32 v24, v25 :: v_dual_add_nc_u32 v107, 0, v11
	v_dual_mov_b32 v11, v25 :: v_dual_add_nc_u32 v14, 16, v2
	v_add_nc_u32_e32 v114, 0, v17
	...
	v_and_b32_e32 v96, 0x7060706, v4
	...
	v_dual_mov_b32 v1, v25 :: v_dual_add_nc_u32 v102, 0, v6
	v_add_nc_u32_e32 v103, 0, v7
	v_add_nc_u32_e32 v104, 0, v8
	v_dual_mov_b32 v22, v25 :: v_dual_add_nc_u32 v105, 0, v9
	v_add_nc_u32_e32 v106, 0, v10
	v_dual_mov_b32 v7, v25 :: v_dual_add_nc_u32 v108, 0, v12
	v_dual_mov_b32 v10, v25 :: v_dual_add_nc_u32 v109, 0, v4
	v_dual_mov_b32 v73, 0xff800000 :: v_dual_add_nc_u32 v110, 0, v5
	v_dual_mov_b32 v77, v25 :: v_dual_add_nc_u32 v112, 0, v15
	v_dual_mov_b32 v14, v25 :: v_dual_add_nc_u32 v113, 0, v16
	v_dual_mov_b32 v16, v25 :: v_dual_add_nc_u32 v115, 0, v19
	v_add_nc_u32_e32 v116, 0, v20
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v117, 0, v21
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	v_cmp_le_i32_e64 s11, v81, v93
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s12, v86, v92
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s13, v86, v93
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s14, v87, v92
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s15, v87, v93
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s16, v88, v92
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s17, v88, v93
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s18, v126, v92
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s19, v126, v93
	.loc	1 866 30                        ; attention.py:866:30
	...
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s7, v77, v93
	.loc	1 860 21                        ; attention.py:860:21
	v_mul_f32_e32 v70, s59, v135
	.loc	1 866 30                        ; attention.py:866:30
	v_cmp_ge_i32_e64 s8, v79, v92
	.loc	1 867 30                        ; attention.py:867:30
	v_cmp_le_i32_e64 s9, v79, v93
	.loc	1 860 21                        ; attention.py:860:21
	...
	s_and_b32 s13, s18, s19
	s_and_b32 s14, s20, s21
	s_and_b32 s15, s22, s23
	s_and_b32 s16, s24, s25
	s_and_b32 s17, s26, s27
	s_and_b32 s18, s28, s29
	s_and_b32 s19, s5, s30
	s_and_b32 s20, s31, s34
	s_and_b32 s12, s2, s6
	s_and_b32 s5, s2, s7
	s_and_b32 s6, s2, s8
	s_and_b32 s7, s2, s9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq8_hkv8_lq512_lk512_bm64_bn32_w4_s1_ds1.num_vgpr, 149
