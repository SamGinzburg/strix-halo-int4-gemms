...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v67, s14, v99
	.loc	1 378 22 is_stmt 1              ; generate_amdgcn.py:378:22
	v_add3_u32 v68, s15, v59, v99
	.loc	1 372 22                        ; generate_amdgcn.py:372:22
	...
	v_dual_fmac_f32 v85, v39, v33 :: v_dual_fmac_f32 v86, v45, v34
	...
	v_dual_mul_f32 v127, v26, v37 :: v_dual_mul_f32 v132, v27, v38
	...
	v_dual_fmac_f32 v91, v128, v31 :: v_dual_fmac_f32 v106, v130, v82
	v_fmac_f32_e32 v108, v132, v84
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(0)
	v_mul_f32_e32 v134, v25, v37
	v_dual_mul_f32 v135, v26, v37 :: v_dual_mul_f32 v140, v27, v38
	v_mul_f32_e32 v136, v27, v37
	v_dual_mul_f32 v137, v28, v37 :: v_dual_mul_f32 v138, v25, v38
	v_mul_f32_e32 v139, v26, v38
	v_dual_mul_f32 v141, v28, v38 :: v_dual_fmac_f32 v92, v129, v32
	ds_load_b128 v[25:28], v66 offset:37392
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v93, v134, v40 :: v_dual_fmac_f32 v94, v135, v41
	v_dual_fmac_f32 v95, v136, v42 :: v_dual_fmac_f32 v114, v141, v72
	v_fmac_f32_e32 v103, v123, v79
	v_fmac_f32_e32 v105, v125, v81
	v_dual_fmac_f32 v111, v138, v69 :: v_dual_fmac_f32 v112, v139, v70
	s_waitcnt lgkmcnt(0)
	...
	v_dual_mul_f32 v27, v27, v38 :: v_dual_fmac_f32 v96, v137, v43
	v_mul_f32_e32 v28, v28, v38
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v89, v126, v29 :: v_dual_add_nc_u32 v38, s14, v58
	v_dual_fmac_f32 v98, v143, v67 :: v_dual_fmac_f32 v97, v142, v44
	v_dual_fmac_f32 v100, v144, v68 :: v_dual_fmac_f32 v101, v37, v77
	v_dual_fmac_f32 v116, v26, v74 :: v_dual_add_nc_u32 v29, s45, v64
...
.LBB0_12:
	...
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	v_cndmask_b32_e64 v82, v98, v33, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	...
	v_cndmask_b32_e64 v45, v97, v45, s3
	.loc	1 394 24                        ; generate_amdgcn.py:394:24
	s_waitcnt lgkmcnt(3)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 230
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_tn_sc64_none_bm32_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 47
