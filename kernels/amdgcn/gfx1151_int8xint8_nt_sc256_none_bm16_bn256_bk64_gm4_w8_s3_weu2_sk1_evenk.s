	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_mad_u64_u32 v[7:8], null, s18, v5, v[1:2]
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_lshl_add_u32 v8, s18, 6, v7
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
	s_mul_hi_u32 s6, s19, s21
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_lshl_add_u32 v11, s18, 7, v7
	.loc	1 323 13                        ; generate_amdgcn.py:323:13
...
.Ltmp21:
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add3_u32 v10, v10, v1, s16
	.loc	1 374 30                        ; generate_amdgcn.py:374:30
	v_add_nc_u32_e32 v12, s30, v9
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v13, s16, v8
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[18:21], v15, s[4:7], 0 offen
	buffer_load_b128 v[22:25], v13, s[4:7], 0 offen
	buffer_load_b128 v[26:29], v14, s[4:7], 0 offen
	buffer_load_b128 v[30:33], v16, s[4:7], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	buffer_load_b32 v9, v9, s[8:11], 0 offen
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_clause 0x3
	buffer_load_b128 v[34:37], v7, s[4:7], 0 offen
	buffer_load_b128 v[38:41], v8, s[4:7], 0 offen
	buffer_load_b128 v[42:45], v11, s[4:7], 0 offen
	buffer_load_b128 v[46:49], v10, s[4:7], 0 offen
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	...
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_and_b32_e32 v11, 48, v7
	s_mov_b32 s16, 0
	.loc	1 333 5                         ; generate_amdgcn.py:333:5
	s_cmpk_gt_i32 s21, 0xbf
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_xor_b32_e32 v13, v10, v8
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt vmcnt(9)
	ds_store_b32 v3, v50 offset:32768
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(8)
	ds_store_b128 v10, v[18:21]
	s_waitcnt vmcnt(7)
	ds_store_b128 v10, v[22:25] offset:4096
	s_waitcnt vmcnt(6)
	ds_store_b128 v10, v[26:29] offset:8192
	s_waitcnt vmcnt(5)
	ds_store_b128 v10, v[30:33] offset:12288
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(4)
	ds_store_b32 v3, v9 offset:33792
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	s_waitcnt vmcnt(3)
	ds_store_b128 v10, v[34:37] offset:16384
	s_waitcnt vmcnt(2)
	ds_store_b128 v10, v[38:41] offset:20480
	s_waitcnt vmcnt(1)
...
; %bb.4:                                ; %.lr.ph
	v_dual_mov_b32 v18, 0 :: v_dual_and_b32 v3, 48, v15
.Ltmp22:
...
.Ltmp23:
	...
	s_mov_b32 s22, s16
	s_mov_b32 s23, s16
	v_and_b32_e32 v7, 0x1c00, v12
	v_or_b32_e32 v37, v8, v3
	v_add_nc_u32_e32 v4, s26, v4
	v_dual_mov_b32 v20, 0 :: v_dual_mov_b32 v21, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_or3_b32 v41, v3, v7, v8
	v_or_b32_e32 v3, s6, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 376 30                        ; generate_amdgcn.py:376:30
	v_add_nc_u32_e32 v52, s17, v16
	.loc	1 388 29                        ; generate_amdgcn.py:388:29
	s_ashr_i32 s18, s18, 8
	.loc	1 376 22                        ; generate_amdgcn.py:376:22
	v_add_nc_u32_e32 v53, s17, v15
	...
	s_waitcnt lgkmcnt(1)
	v_dual_mul_f32 v58, v58, v98 :: v_dual_add_nc_u32 v129, s19, v13
	...
	v_dual_mul_f32 v60, v60, v98 :: v_dual_fmac_f32 v25, v57, v89
	v_mul_f32_e32 v61, v61, v98
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v62, v62, v98 :: v_dual_fmac_f32 v27, v59, v91
	v_mul_f32_e32 v63, v63, v98
	v_dual_mul_f32 v64, v64, v98 :: v_dual_fmac_f32 v29, v61, v93
	v_dual_mul_f32 v65, v65, v98 :: v_dual_fmac_f32 v28, v60, v92
	.loc	1 399 13                        ; generate_amdgcn.py:399:13
	v_dual_fmac_f32 v21, v53, v85 :: v_dual_add_nc_u32 v130, s34, v14
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_fmac_f32 v18, v50, v82 :: v_dual_fmac_f32 v31, v63, v95
	v_dual_fmac_f32 v19, v51, v83 :: v_dual_fmac_f32 v20, v52, v84
	v_dual_fmac_f32 v22, v54, v86 :: v_dual_fmac_f32 v33, v64, v96
	v_fmac_f32_e32 v24, v56, v88
	v_fmac_f32_e32 v26, v58, v90
	v_fmac_f32_e32 v30, v62, v94
	v_fmac_f32_e32 v32, v65, v97
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
...
; %bb.9:
	...
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	v_add_nc_u32_e32 v16, s14, v39
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v56, s6 :: v_dual_add_nc_u32 v1, s14, v38
	v_dual_mov_b32 v60, s10 :: v_dual_mov_b32 v59, s9
	.loc	1 374 22                        ; generate_amdgcn.py:374:22
	ds_load_b128 v[86:89], v16
	ds_load_b128 v[90:93], v1
	.loc	1 379 19                        ; generate_amdgcn.py:379:19
	v_dual_mov_b32 v58, s8 :: v_dual_mov_b32 v55, s5
...
.Ltmp24:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 131
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nt_sc256_none_bm16_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
