...
.Ltmp18:
	...
	s_add_i32 s1, s4, 31
	v_dual_mov_b32 v66, 0 :: v_dual_lshlrev_b32 v3, 3, v13
...
.Ltmp24:
	...
	v_dual_mov_b32 v94, 0 :: v_dual_and_b32 v7, 32, v7
	s_delay_alu instid0(VALU_DEP_4)
	v_or_b32_e32 v9, 16, v6
	v_or_b32_e32 v22, 32, v6
	v_or_b32_e32 v24, 48, v6
	v_mul_lo_u32 v40, v6, s1
	v_lshrrev_b32_e32 v6, 6, v0
	v_mul_lo_u32 v42, v9, s1
	v_lshlrev_b32_e32 v9, 2, v0
	v_dual_mov_b32 v95, 0 :: v_dual_and_b32 v8, 0xe00, v17
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v97, 0 :: v_dual_and_b32 v6, 2, v6
	v_dual_mov_b32 v96, 0 :: v_dual_and_b32 v9, 0x1c0, v9
	v_mul_lo_u32 v44, v22, s1
	v_or_b32_e32 v56, s5, v0
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v91, 0 :: v_dual_add_nc_u32 v6, 0, v6
	v_lshl_or_b32 v1, v10, 9, v1
	v_or3_b32 v5, v8, v5, v16
	v_mul_lo_u32 v53, v24, s1
	v_add3_u32 v25, v6, v9, v7
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_add3_u32 v9, v4, v12, s5
	s_mov_b32 s5, s4
	v_lshlrev_b32_e32 v22, 1, v11
	v_dual_mov_b32 v93, 0 :: v_dual_lshlrev_b32 v24, 1, v0
	v_xor_b32_e32 v8, 0x110, v1
	v_xor_b32_e32 v20, 0x90, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
	v_dual_mov_b32 v92, 0 :: v_dual_add_nc_u32 v63, 0, v22
	v_xor_b32_e32 v21, 16, v3
	v_xor_b32_e32 v23, 16, v5
	v_dual_mov_b32 v89, 0 :: v_dual_and_b32 v24, 28, v24
	v_add3_u32 v22, v63, v22, v7
	v_dual_mov_b32 v88, 0 :: v_dual_add_nc_u32 v75, 0, v2
	v_dual_mov_b32 v86, 0 :: v_dual_add_nc_u32 v77, 0, v1
	v_dual_mov_b32 v87, 0 :: v_dual_add_nc_u32 v80, 0, v8
	v_dual_mov_b32 v78, 0 :: v_dual_add_nc_u32 v81, 0, v3
	v_dual_mov_b32 v76, 0 :: v_dual_add_nc_u32 v83, 0, v5
	v_mov_b32_e32 v1, s4
	v_dual_mov_b32 v84, 0 :: v_dual_add_nc_u32 v79, 0, v20
	v_dual_mov_b32 v85, 0 :: v_dual_add_nc_u32 v82, 0, v21
	v_dual_mov_b32 v73, 0 :: v_dual_add_nc_u32 v90, 0, v23
	v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, s6
	v_dual_mov_b32 v4, s7 :: v_dual_mov_b32 v5, s8
	v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v7, s10
	v_mov_b32_e32 v8, s11
	v_dual_mov_b32 v71, 0 :: v_dual_add_nc_u32 v98, v25, v24
	v_dual_mov_b32 v74, 0 :: v_dual_add_nc_u32 v99, v22, v24
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_lshl_b32 s6, s5, 6
	v_mad_u64_u32 v[110:111], null, s6, s29, v[9:10]
	.loc	1 374 34                        ; generate_amdgcn.py:374:34
	v_add_nc_u32_e32 v100, s6, v19
	.loc	1 368 21                        ; generate_amdgcn.py:368:21
	s_or_b32 s5, s6, 32
	...
	buffer_load_b64 v[108:109], v100, s[20:23], 0 offen
	.loc	1 378 34                        ; generate_amdgcn.py:378:34
	v_add_nc_u32_e32 v104, s29, v110
	.loc	1 387 34                        ; generate_amdgcn.py:387:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	s_clause 0x1
	buffer_load_b128 v[100:103], v110, s[24:27], 0 offen
	buffer_load_b128 v[104:107], v104, s[24:27], 0 offen
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	s_waitcnt vmcnt(2)
	ds_store_b64 v75, v[108:109] offset:16384
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	s_waitcnt vmcnt(0)
	v_perm_b32 v108, v104, v100, 0x5010400
	v_perm_b32 v109, v105, v101, 0x5010400
	v_perm_b32 v101, v105, v101, 0x7030602
	v_perm_b32 v105, v106, v102, 0x5010400
	...
	v_perm_b32 v104, v104, v100, 0x7030602
	v_and_b16 v100.l, 0xff, v108.l
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_lshlrev_b16 v100.h, 8, v107.l
	v_lshrrev_b32_e32 v107, 8, v104
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100
	...
	v_lshlrev_b16 v100.h, 8, v107.l
	ds_store_b16 v77, v100 offset:32
	v_and_b16 v100.l, 0xff, v104.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:64
	v_lshrrev_b32_e32 v100, 24, v104
	v_and_b16 v100.h, 0xff, v104.h
	v_lshrrev_b32_e32 v104, 8, v109
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.h, 8, v104.l
	v_lshrrev_b32_e32 v104, 8, v101
	ds_store_b16 v77, v100 offset:96
	v_and_b16 v100.l, 0xff, v109.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v79, v100
	v_lshrrev_b32_e32 v100, 24, v109
	v_and_b16 v100.h, 0xff, v109.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v104.l
	ds_store_b16 v79, v100 offset:32
	v_and_b16 v100.l, 0xff, v101.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v79, v100 offset:64
	...
	ds_store_b16 v79, v100 offset:96
	v_and_b16 v100.l, 0xff, v105.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v80, v100
	v_lshrrev_b32_e32 v100, 24, v105
	v_and_b16 v100.h, 0xff, v105.h
	v_lshlrev_b16 v100.l, 8, v100.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v101.l
	v_lshrrev_b32_e32 v101, 8, v106
	ds_store_b16 v80, v100 offset:32
	v_and_b16 v100.l, 0xff, v102.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v80, v100 offset:64
	v_lshrrev_b32_e32 v100, 24, v102
	v_and_b16 v100.h, 0xff, v102.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v101.l
	v_lshrrev_b32_e32 v101, 8, v103
	ds_store_b16 v80, v100 offset:96
	v_and_b16 v100.l, 0xff, v106.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:384
	v_lshrrev_b32_e32 v100, 24, v106
	v_and_b16 v100.h, 0xff, v106.h
	v_lshlrev_b16 v100.l, 8, v100.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v101.l
	ds_store_b16 v77, v100 offset:416
	v_and_b16 v100.l, 0xff, v103.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:448
	v_lshrrev_b32_e32 v100, 24, v103
	v_and_b16 v100.h, 0xff, v103.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	ds_store_b16 v77, v100 offset:480
	.loc	1 374 34                        ; generate_amdgcn.py:374:34
	v_add_nc_u32_e32 v100, s5, v19
	.loc	1 386 29                        ; generate_amdgcn.py:386:29
	s_ashr_i32 s5, s5, 5
	...
	buffer_load_b64 v[108:109], v100, s[20:23], 0 offen
	.loc	1 378 34                        ; generate_amdgcn.py:378:34
	v_add_nc_u32_e32 v100, s2, v110
	v_add_nc_u32_e32 v104, s29, v100
	...
	s_barrier
	s_waitcnt vmcnt(2)
	ds_store_b64 v75, v[108:109] offset:18432
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	s_waitcnt vmcnt(0)
	v_perm_b32 v108, v104, v100, 0x5010400
	v_perm_b32 v109, v105, v101, 0x5010400
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:8192
	v_lshrrev_b32_e32 v100, 24, v108
	v_and_b16 v100.h, 0xff, v108.h
	v_lshlrev_b16 v100.l, 8, v100.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v107.l
	ds_store_b16 v77, v100 offset:8224
	v_and_b16 v100.l, 0xff, v104.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:8256
	v_lshrrev_b32_e32 v100, 24, v104
	v_and_b16 v100.h, 0xff, v104.h
	v_lshrrev_b32_e32 v104, 8, v109
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_lshlrev_b16 v100.h, 8, v104.l
	v_lshrrev_b32_e32 v104, 8, v101
	ds_store_b16 v77, v100 offset:8288
	v_and_b16 v100.l, 0xff, v109.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v79, v100 offset:8192
	v_lshrrev_b32_e32 v100, 24, v109
	v_and_b16 v100.h, 0xff, v109.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v104.l
	ds_store_b16 v79, v100 offset:8224
	v_and_b16 v100.l, 0xff, v101.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_3)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v79, v100 offset:8256
	v_lshrrev_b32_e32 v100, 24, v101
	v_and_b16 v100.h, 0xff, v101.h
	v_lshrrev_b32_e32 v101, 8, v105
	v_lshlrev_b16 v100.l, 8, v100.l
	...
	v_lshlrev_b16 v100.h, 8, v101.l
	v_lshrrev_b32_e32 v101, 8, v102
	ds_store_b16 v79, v100 offset:8288
	v_and_b16 v100.l, 0xff, v105.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v80, v100 offset:8192
	v_lshrrev_b32_e32 v100, 24, v105
	v_and_b16 v100.h, 0xff, v105.h
	v_lshlrev_b16 v100.l, 8, v100.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
	...
	v_lshlrev_b16 v100.h, 8, v101.l
	v_lshrrev_b32_e32 v101, 8, v106
	ds_store_b16 v80, v100 offset:8224
	v_and_b16 v100.l, 0xff, v102.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v80, v100 offset:8256
	v_lshrrev_b32_e32 v100, 24, v102
	v_and_b16 v100.h, 0xff, v102.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	...
	v_lshlrev_b16 v100.h, 8, v101.l
	v_lshrrev_b32_e32 v101, 8, v103
	ds_store_b16 v80, v100 offset:8288
	v_and_b16 v100.l, 0xff, v106.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:8576
	v_lshrrev_b32_e32 v100, 24, v106
	v_and_b16 v100.h, 0xff, v106.h
	v_lshlrev_b16 v100.l, 8, v100.l
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_or_b16 v100.l, v100.h, v100.l
	v_lshlrev_b16 v100.h, 8, v101.l
	ds_store_b16 v77, v100 offset:8608
	v_and_b16 v100.l, 0xff, v103.l
	v_or_b16 v100.l, v100.l, v100.h
	ds_store_b16 v77, v100 offset:8640
	v_lshrrev_b32_e32 v100, 24, v103
	v_and_b16 v100.h, 0xff, v103.h
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b16 v100.l, 8, v100.l
	v_or_b16 v100.l, v100.h, v100.l
	ds_store_b16 v77, v100 offset:8672
	.loc	1 374 26                        ; generate_amdgcn.py:374:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[116:119], v81 offset:16384
	ds_load_b128 v[132:135], v81 offset:16896
	ds_load_b128 v[148:151], v81 offset:17408
	ds_load_b128 v[164:167], v81 offset:17920
	ds_load_b128 v[120:123], v82 offset:16384
	ds_load_b128 v[136:139], v82 offset:16896
	ds_load_b128 v[152:155], v82 offset:17408
	ds_load_b128 v[168:171], v82 offset:17920
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[156:159], v83
	ds_load_b128 v[172:175], v83 offset:4096
	ds_load_b128 v[160:163], v90
	ds_load_b128 v[176:179], v90 offset:4096
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[100:107], v[156:159], v[116:119], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	v_wmma_i32_16x16x16_iu8 v[108:115], v[172:175], v[116:119], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[124:131], v[172:175], v[132:135], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu8 v[100:107], v[160:163], v[120:123], v[100:107] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu8 v[108:115], v[176:179], v[120:123], v[108:115] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[140:147], v[172:175], v[148:151], v[1:8] neg_lo:[1,1,0]
	...
	v_wmma_i32_16x16x16_iu8 v[148:155], v[156:159], v[164:167], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v108, v108
	v_cvt_f32_i32_e32 v110, v110
	v_cvt_f32_i32_e32 v112, v112
	s_delay_alu instid0(VALU_DEP_4)
	v_wmma_i32_16x16x16_iu8 v[148:155], v[160:163], v[168:171], v[148:155] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[156:163], v[172:175], v[164:167], v[1:8] neg_lo:[1,1,0]
	v_cvt_f32_i32_e32 v164, v100
	v_cvt_f32_i32_e32 v165, v101
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v100, v40, s6, 1
	v_add_lshl_u32 v101, v42, s6, 1
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_cvt_f32_i32_e32 v166, v102
	v_cvt_f32_i32_e32 v167, v103
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v102, v44, s6, 1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v100, 0x80000000, v100 :: v_dual_cndmask_b32 v101, 0x80000000, v101
	v_add_lshl_u32 v103, v53, s6, 1
	...
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	v_wmma_i32_16x16x16_iu8 v[156:163], v[176:179], v[168:171], v[156:163] neg_lo:[1,1,0]
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	...
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v173, 16, v101
	v_lshlrev_b32_e32 v172, 16, v100
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	v_add_lshl_u32 v100, v56, s6, 1
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_dual_cndmask_b32 v100, 0x80000000, v100 :: v_dual_mul_f32 v119, v119, v173
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v109, v109, v172 :: v_dual_lshlrev_b32 v174, 16, v102
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v164, v164, v172 :: v_dual_lshlrev_b32 v175, 16, v103
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v100, v100, s[12:15], 0 offen
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v165, v165, v172
	v_mul_f32_e32 v167, v167, v172
	v_mul_f32_e32 v169, v169, v172
	v_mul_f32_e32 v171, v171, v172
	v_mul_f32_e32 v117, v117, v173
	v_dual_mul_f32 v118, v118, v173 :: v_dual_mul_f32 v133, v133, v174
	v_dual_mul_f32 v120, v120, v173 :: v_dual_mul_f32 v135, v135, v174
	v_dual_mul_f32 v122, v122, v173 :: v_dual_mul_f32 v137, v137, v174
	v_dual_mul_f32 v124, v124, v173 :: v_dual_mul_f32 v139, v139, v174
	v_dual_mul_f32 v130, v130, v173 :: v_dual_mul_f32 v145, v145, v174
	v_dual_mul_f32 v131, v131, v173 :: v_dual_mul_f32 v132, v132, v174
	v_dual_mul_f32 v134, v134, v174 :: v_dual_mul_f32 v149, v149, v175
	v_dual_mul_f32 v136, v136, v174 :: v_dual_mul_f32 v151, v151, v175
	v_dual_mul_f32 v138, v138, v174 :: v_dual_mul_f32 v153, v153, v175
	v_dual_mul_f32 v140, v140, v174 :: v_dual_mul_f32 v155, v155, v175
	v_dual_mul_f32 v142, v142, v174 :: v_dual_mul_f32 v157, v157, v175
	v_dual_mul_f32 v144, v144, v174 :: v_dual_mul_f32 v159, v159, v175
	v_dual_mul_f32 v146, v146, v174 :: v_dual_mul_f32 v161, v161, v175
	v_dual_mul_f32 v147, v147, v174 :: v_dual_mul_f32 v148, v148, v175
	v_dual_mul_f32 v126, v126, v173 :: v_dual_mul_f32 v141, v141, v174
	v_dual_mul_f32 v128, v128, v173 :: v_dual_mul_f32 v143, v143, v174
	.loc	1 387 34                        ; generate_amdgcn.py:387:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_add_i32 s4, s4, 1
	...
	v_mul_f32_e32 v168, v168, v172
	v_mul_f32_e32 v110, v110, v172
	v_mul_f32_e32 v112, v112, v172
	v_mul_f32_e32 v115, v115, v172
	v_mul_f32_e32 v121, v121, v173
	v_mul_f32_e32 v125, v125, v173
	v_mul_f32_e32 v111, v111, v172
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s4, s0
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v170, v170, v172
	v_mul_f32_e32 v108, v108, v172
	v_mul_f32_e32 v116, v116, v173
	v_mul_f32_e32 v123, v123, v173
	v_mul_f32_e32 v127, v127, v173
	v_mul_f32_e32 v113, v113, v172
	v_dual_mul_f32 v114, v114, v172 :: v_dual_mul_f32 v129, v129, v173
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(0)
	ds_store_b16 v98, v100 offset:20480
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[100:103], v63 offset:20480
	ds_load_b128 v[104:107], v63 offset:20496
	s_waitcnt lgkmcnt(1)
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v150, v150, v175 :: v_dual_fmac_f32 v97, v165, v177
	v_dual_mul_f32 v152, v152, v175 :: v_dual_fmac_f32 v93, v169, v181
	v_dual_mul_f32 v154, v154, v175 :: v_dual_fmac_f32 v89, v108, v100
	v_dual_mul_f32 v156, v156, v175 :: v_dual_fmac_f32 v87, v110, v102
	v_dual_mul_f32 v158, v158, v175 :: v_dual_fmac_f32 v85, v112, v104
	v_dual_mul_f32 v160, v160, v175 :: v_dual_fmac_f32 v73, v117, v177
	v_dual_mul_f32 v162, v162, v175 :: v_dual_fmac_f32 v69, v121, v181
	v_dual_mul_f32 v163, v163, v175 :: v_dual_fmac_f32 v66, v164, v176
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v96, v166, v178 :: v_dual_fmac_f32 v95, v167, v179
	v_dual_fmac_f32 v94, v168, v180 :: v_dual_fmac_f32 v91, v171, v183
	v_dual_fmac_f32 v92, v170, v182 :: v_dual_fmac_f32 v71, v119, v179
	v_dual_fmac_f32 v88, v109, v101 :: v_dual_fmac_f32 v67, v123, v183
	v_dual_fmac_f32 v76, v115, v107 :: v_dual_fmac_f32 v55, v132, v176
	v_dual_fmac_f32 v74, v116, v176 :: v_dual_fmac_f32 v57, v131, v107
	v_dual_fmac_f32 v72, v118, v178 :: v_dual_fmac_f32 v51, v135, v179
	v_dual_fmac_f32 v70, v120, v180 :: v_dual_fmac_f32 v49, v137, v181
	v_dual_fmac_f32 v68, v122, v182 :: v_dual_fmac_f32 v47, v139, v183
	v_dual_fmac_f32 v54, v133, v177 :: v_dual_fmac_f32 v37, v146, v106
	v_dual_fmac_f32 v52, v134, v178 :: v_dual_fmac_f32 v35, v148, v176
	v_dual_fmac_f32 v50, v136, v180 :: v_dual_fmac_f32 v33, v150, v178
	v_dual_fmac_f32 v48, v138, v182 :: v_dual_fmac_f32 v31, v152, v180
	v_dual_fmac_f32 v46, v140, v100 :: v_dual_fmac_f32 v29, v154, v182
	v_dual_fmac_f32 v38, v145, v105 :: v_dual_fmac_f32 v27, v156, v100
	v_dual_fmac_f32 v36, v147, v107 :: v_dual_fmac_f32 v25, v158, v102
	v_dual_fmac_f32 v34, v149, v177 :: v_dual_fmac_f32 v23, v160, v104
	v_dual_fmac_f32 v32, v151, v179 :: v_dual_fmac_f32 v21, v162, v106
	v_fmac_f32_e32 v30, v153, v181
	v_fmac_f32_e32 v28, v155, v183
	v_fmac_f32_e32 v26, v157, v101
	v_fmac_f32_e32 v24, v159, v103
	v_fmac_f32_e32 v22, v161, v105
	v_fmac_f32_e32 v20, v163, v107
	.loc	1 374 26 is_stmt 1              ; generate_amdgcn.py:374:26
	ds_load_b128 v[116:119], v81 offset:18432
	ds_load_b128 v[132:135], v81 offset:18944
	ds_load_b128 v[148:151], v81 offset:19456
	ds_load_b128 v[164:167], v81 offset:19968
	ds_load_b128 v[120:123], v82 offset:18432
	ds_load_b128 v[136:139], v82 offset:18944
	ds_load_b128 v[152:155], v82 offset:19456
	ds_load_b128 v[168:171], v82 offset:19968
	.loc	1 378 26                        ; generate_amdgcn.py:378:26
	ds_load_b128 v[156:159], v83 offset:8192
	ds_load_b128 v[172:175], v83 offset:12288
	ds_load_b128 v[160:163], v90 offset:8192
	ds_load_b128 v[176:179], v90 offset:12288
	.loc	1 392 17                        ; generate_amdgcn.py:392:17
	v_dual_fmac_f32 v86, v111, v103 :: v_dual_fmac_f32 v65, v124, v100
	v_dual_fmac_f32 v84, v113, v105 :: v_dual_fmac_f32 v61, v127, v103
	v_dual_fmac_f32 v78, v114, v106 :: v_dual_fmac_f32 v59, v129, v105
	v_dual_fmac_f32 v64, v125, v101 :: v_dual_fmac_f32 v43, v142, v102
	v_dual_fmac_f32 v62, v126, v102 :: v_dual_fmac_f32 v45, v141, v101
	v_dual_fmac_f32 v60, v128, v104 :: v_dual_fmac_f32 v41, v143, v103
	v_dual_fmac_f32 v58, v130, v106 :: v_dual_fmac_f32 v39, v144, v104
	.loc	1 379 23                        ; generate_amdgcn.py:379:23
	s_waitcnt lgkmcnt(3)
	v_wmma_i32_16x16x16_iu8 v[100:107], v[156:159], v[116:119], v[1:8] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(2)
	...
	v_wmma_i32_16x16x16_iu8 v[156:163], v[172:175], v[164:167], v[1:8] neg_lo:[1,1,0]
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	v_add_lshl_u32 v164, v40, s5, 1
	v_add_lshl_u32 v165, v42, s5, 1
	v_add_lshl_u32 v166, v44, s5, 1
	v_add_lshl_u32 v167, v53, s5, 1
	.loc	1 390 40                        ; generate_amdgcn.py:390:40
	s_mul_i32 s5, s5, s29
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	...
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	s_waitcnt vmcnt(2)
	v_dual_cndmask_b32 v168, 0x80000000, v168 :: v_dual_lshlrev_b32 v165, 16, v165
	.loc	1 388 22                        ; generate_amdgcn.py:388:22
	...
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_mul_f32_e32 v121, v121, v165
	.loc	1 390 22                        ; generate_amdgcn.py:390:22
	buffer_load_u16 v168, v168, s[12:15], 0 offen
	.loc	1 392 24                        ; generate_amdgcn.py:392:24
	v_dual_mul_f32 v119, v119, v165 :: v_dual_lshlrev_b32 v166, 16, v166
	v_mul_f32_e32 v175, v106, v164
	v_mul_f32_e32 v169, v100, v164
	v_dual_mul_f32 v170, v101, v164 :: v_dual_mul_f32 v127, v127, v165
	v_mul_f32_e32 v171, v102, v164
	v_dual_mul_f32 v172, v103, v164 :: v_dual_mul_f32 v125, v125, v165
	v_mul_f32_e32 v173, v104, v164
	v_dual_mul_f32 v174, v105, v164 :: v_dual_mul_f32 v131, v131, v165
	v_dual_mul_f32 v176, v107, v164 :: v_dual_mul_f32 v129, v129, v165
	v_dual_mul_f32 v177, v108, v164 :: v_dual_mul_f32 v118, v118, v165
	v_dual_mul_f32 v178, v109, v164 :: v_dual_mul_f32 v135, v135, v166
	v_dual_mul_f32 v179, v110, v164 :: v_dual_mul_f32 v116, v116, v165
	v_dual_mul_f32 v180, v111, v164 :: v_dual_mul_f32 v133, v133, v166
	v_dual_mul_f32 v181, v112, v164 :: v_dual_mul_f32 v122, v122, v165
	v_dual_mul_f32 v182, v113, v164 :: v_dual_mul_f32 v139, v139, v166
	v_dual_mul_f32 v183, v114, v164 :: v_dual_mul_f32 v120, v120, v165
	v_dual_mul_f32 v164, v115, v164 :: v_dual_mul_f32 v137, v137, v166
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_mul_f32_e32 v117, v117, v165
	v_dual_mul_f32 v124, v124, v165 :: v_dual_mul_f32 v141, v141, v166
	v_dual_mul_f32 v126, v126, v165 :: v_dual_mul_f32 v143, v143, v166
	v_dual_mul_f32 v128, v128, v165 :: v_dual_mul_f32 v145, v145, v166
	v_dual_mul_f32 v130, v130, v165 :: v_dual_mul_f32 v147, v147, v166
	v_dual_mul_f32 v132, v132, v166 :: v_dual_mul_f32 v149, v149, v167
	v_dual_mul_f32 v134, v134, v166 :: v_dual_mul_f32 v151, v151, v167
	v_dual_mul_f32 v136, v136, v166 :: v_dual_mul_f32 v153, v153, v167
	v_dual_mul_f32 v138, v138, v166 :: v_dual_mul_f32 v155, v155, v167
	v_dual_mul_f32 v140, v140, v166 :: v_dual_mul_f32 v157, v157, v167
	v_dual_mul_f32 v142, v142, v166 :: v_dual_mul_f32 v159, v159, v167
	v_dual_mul_f32 v144, v144, v166 :: v_dual_mul_f32 v161, v161, v167
	v_dual_mul_f32 v146, v146, v166 :: v_dual_mul_f32 v163, v163, v167
	s_waitcnt vmcnt(0)
	v_dual_mul_f32 v123, v123, v165 :: v_dual_lshlrev_b32 v168, 16, v168
	ds_store_b32 v99, v168 offset:20480
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_load_b128 v[100:103], v63 offset:20480
	ds_load_b128 v[104:107], v63 offset:20496
	ds_load_b128 v[108:111], v63 offset:20992
	ds_load_b128 v[112:115], v63 offset:21008
	v_mul_f32_e32 v148, v148, v167
	v_mul_f32_e32 v150, v150, v167
	v_mul_f32_e32 v152, v152, v167
	v_mul_f32_e32 v154, v154, v167
	v_mul_f32_e32 v156, v156, v167
	v_mul_f32_e32 v158, v158, v167
	v_mul_f32_e32 v160, v160, v167
	v_mul_f32_e32 v162, v162, v167
	.loc	1 392 17 is_stmt 0              ; generate_amdgcn.py:392:17
	s_waitcnt lgkmcnt(3)
	v_dual_fmac_f32 v66, v169, v100 :: v_dual_fmac_f32 v95, v172, v103
	v_dual_fmac_f32 v97, v170, v101 :: v_dual_fmac_f32 v96, v171, v102
	s_waitcnt lgkmcnt(2)
	v_dual_fmac_f32 v91, v176, v107 :: v_dual_fmac_f32 v94, v173, v104
	v_fmac_f32_e32 v71, v119, v103
	v_dual_fmac_f32 v93, v174, v105 :: v_dual_fmac_f32 v92, v175, v106
	s_waitcnt lgkmcnt(0)
	v_fmac_f32_e32 v59, v129, v113
	v_dual_fmac_f32 v89, v177, v108 :: v_dual_fmac_f32 v88, v178, v109
	v_fmac_f32_e32 v67, v123, v107
	v_dual_fmac_f32 v87, v179, v110 :: v_dual_fmac_f32 v86, v180, v111
	v_fmac_f32_e32 v49, v137, v105
	v_dual_fmac_f32 v85, v181, v112 :: v_dual_fmac_f32 v84, v182, v113
	v_fmac_f32_e32 v61, v127, v111
	v_dual_fmac_f32 v78, v183, v114 :: v_dual_fmac_f32 v55, v132, v100
	v_dual_fmac_f32 v76, v164, v115 :: v_dual_fmac_f32 v45, v141, v109
	v_dual_fmac_f32 v74, v116, v100 :: v_dual_fmac_f32 v57, v131, v115
	v_dual_fmac_f32 v73, v117, v101 :: v_dual_fmac_f32 v72, v118, v102
	v_dual_fmac_f32 v51, v135, v103 :: v_dual_fmac_f32 v70, v120, v104
	v_fmac_f32_e32 v47, v139, v107
	v_dual_fmac_f32 v69, v121, v105 :: v_dual_fmac_f32 v68, v122, v106
	v_fmac_f32_e32 v41, v143, v111
	v_dual_fmac_f32 v65, v124, v108 :: v_dual_fmac_f32 v64, v125, v109
	v_fmac_f32_e32 v43, v142, v110
	v_dual_fmac_f32 v62, v126, v110 :: v_dual_fmac_f32 v39, v144, v112
	v_dual_fmac_f32 v60, v128, v112 :: v_dual_fmac_f32 v37, v146, v114
	v_dual_fmac_f32 v58, v130, v114 :: v_dual_fmac_f32 v35, v148, v100
	v_dual_fmac_f32 v54, v133, v101 :: v_dual_fmac_f32 v33, v150, v102
	v_dual_fmac_f32 v52, v134, v102 :: v_dual_fmac_f32 v31, v152, v104
	v_dual_fmac_f32 v50, v136, v104 :: v_dual_fmac_f32 v29, v154, v106
	v_dual_fmac_f32 v48, v138, v106 :: v_dual_fmac_f32 v27, v156, v108
	v_dual_fmac_f32 v46, v140, v108 :: v_dual_fmac_f32 v25, v158, v110
	v_dual_fmac_f32 v38, v145, v113 :: v_dual_fmac_f32 v23, v160, v112
	v_dual_fmac_f32 v36, v147, v115 :: v_dual_fmac_f32 v21, v162, v114
	v_fmac_f32_e32 v34, v149, v101
	v_fmac_f32_e32 v32, v151, v103
	v_fmac_f32_e32 v30, v153, v105
	v_fmac_f32_e32 v28, v155, v107
	v_fmac_f32_e32 v26, v157, v109
	v_fmac_f32_e32 v24, v159, v111
	v_fmac_f32_e32 v22, v161, v113
	v_fmac_f32_e32 v20, v163, v115
	.loc	1 363 5 is_stmt 1               ; generate_amdgcn.py:363:5
	s_cbranch_scc1 .LBB0_5
; %bb.6:                                ; %._crit_edge.loopexit
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v7, v92, v92 :: v_dual_max_f32 v8, v91, v91
	v_dual_max_f32 v70, v70, v70 :: v_dual_max_f32 v67, v67, v67
	v_dual_max_f32 v1, v66, v66 :: v_dual_max_f32 v2, v97, v97
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v7, 0, v7 :: v_dual_max_f32 v42, v86, v86
	v_dual_max_f32 v53, v84, v84 :: v_dual_max_f32 v56, v78, v78
	v_dual_max_f32 v63, v76, v76 :: v_dual_max_f32 v66, v74, v74
	v_dual_max_f32 v73, v73, v73 :: v_dual_max_f32 v84, 0, v67
	v_max_f32_e32 v61, v61, v61
	v_dual_max_f32 v19, v88, v88 :: v_dual_max_f32 v44, v85, v85
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v72, v72, v72 :: v_dual_max_f32 v73, 0, v73
	v_max_f32_e32 v56, 0, v56
	v_max_f32_e32 v74, 0, v63
	v_dual_max_f32 v66, 0, v66 :: v_dual_max_f32 v69, v69, v69
	v_dual_max_f32 v63, v71, v71 :: v_dual_max_f32 v88, 0, v61
	v_dual_max_f32 v55, v55, v55 :: v_dual_max_f32 v54, v54, v54
	v_dual_max_f32 v5, v94, v94 :: v_dual_max_f32 v6, v93, v93
	v_dual_max_f32 v9, v89, v89 :: v_dual_max_f32 v68, v68, v68
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_max_f32 v69, 0, v69 :: v_dual_max_f32 v82, 0, v63
	v_dual_max_f32 v70, 0, v70 :: v_dual_max_f32 v63, v65, v65
	v_max_f32_e32 v64, v64, v64
	v_dual_max_f32 v58, v58, v58 :: v_dual_max_f32 v57, v57, v57
	v_dual_max_f32 v93, 0, v55 :: v_dual_max_f32 v94, 0, v54
	...
	v_max_f32_e32 v40, v87, v87
	v_max_f32_e32 v60, v60, v60
	v_dual_max_f32 v62, v62, v62 :: v_dual_max_f32 v85, 0, v63
	v_dual_max_f32 v86, 0, v64 :: v_dual_max_f32 v59, v59, v59
	v_dual_max_f32 v92, 0, v57 :: v_dual_max_f32 v51, v51, v51
	...
	v_dual_max_f32 v41, v41, v41 :: v_dual_max_f32 v100, 0, v47
	v_dual_max_f32 v106, 0, v38 :: v_dual_max_f32 v107, 0, v37
	v_dual_max_f32 v34, v34, v34 :: v_dual_max_f32 v109, 0, v35
	v_dual_max_f32 v32, v32, v32 :: v_dual_max_f32 v33, v33, v33
	v_dual_max_f32 v30, v30, v30 :: v_dual_max_f32 v31, v31, v31
	v_max_f32_e32 v110, 0, v34
	v_dual_max_f32 v116, 0, v28 :: v_dual_max_f32 v117, 0, v27
	v_dual_max_f32 v24, v24, v24 :: v_dual_max_f32 v119, 0, v25
	v_dual_max_f32 v22, v22, v22 :: v_dual_max_f32 v23, v23, v23
	v_dual_max_f32 v20, v20, v20 :: v_dual_max_f32 v21, v21, v21
	s_delay_alu instid0(VALU_DEP_3)
	v_dual_max_f32 v120, 0, v24 :: v_dual_max_f32 v1, 0, v1
	...
	v_dual_max_f32 v44, 0, v44 :: v_dual_max_f32 v53, 0, v53
	v_max_f32_e32 v79, 0, v72
	v_max_f32_e32 v83, 0, v68
	v_max_f32_e32 v89, 0, v60
	v_dual_max_f32 v87, 0, v62 :: v_dual_max_f32 v90, 0, v59
	v_dual_max_f32 v91, 0, v58 :: v_dual_max_f32 v96, 0, v51
	v_max_f32_e32 v99, 0, v48
	v_max_f32_e32 v97, 0, v50
	v_max_f32_e32 v95, 0, v52
	v_dual_max_f32 v101, 0, v46 :: v_dual_max_f32 v102, 0, v45
	v_dual_max_f32 v103, 0, v43 :: v_dual_max_f32 v104, 0, v41
	v_dual_max_f32 v105, 0, v39 :: v_dual_max_f32 v108, 0, v36
	v_dual_max_f32 v111, 0, v33 :: v_dual_max_f32 v112, 0, v32
	v_dual_max_f32 v113, 0, v31 :: v_dual_max_f32 v114, 0, v30
	v_dual_max_f32 v115, 0, v29 :: v_dual_max_f32 v118, 0, v26
	v_dual_max_f32 v121, 0, v23 :: v_dual_max_f32 v122, 0, v22
	v_dual_max_f32 v123, 0, v21 :: v_dual_max_f32 v124, 0, v20
	...
	v_dual_mul_f32 v67, v40, v40 :: v_dual_mul_f32 v68, v42, v42
	v_dual_mul_f32 v71, v44, v44 :: v_dual_mul_f32 v72, v53, v53
	v_dual_mul_f32 v75, v56, v56 :: v_dual_mul_f32 v76, v74, v74
	v_dual_mul_f32 v78, v66, v66 :: v_dual_mul_f32 v77, v73, v73
	v_dual_mul_f32 v74, v79, v79 :: v_dual_mul_f32 v73, v82, v82
	v_dual_mul_f32 v70, v70, v70 :: v_dual_mul_f32 v69, v69, v69
	v_dual_mul_f32 v65, v83, v83 :: v_dual_mul_f32 v64, v84, v84
	v_dual_mul_f32 v61, v85, v85 :: v_dual_mul_f32 v60, v86, v86
	v_dual_mul_f32 v57, v87, v87 :: v_dual_mul_f32 v56, v88, v88
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 184
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc32_relu2_outint4sc256_bm64_bn256_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 31
