...
.Ltmp11:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_lshl_add_u32 v34, v9, 4, v2
	v_lshl_add_u32 v35, s35, 5, v34
...
.Ltmp17:
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v36, v4, v3, s3
.Ltmp18:
	.loc	2 43 12                         ; standard.py:43:12 @[ generate_amdgcn.py:363:28 ]
	s_add_i32 s24, s25, s2
.Ltmp19:
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	s_mul_i32 s12, s35, s18
	...
	v_add_nc_u32_e32 v5, s15, v36
	.loc	1 408 30 is_stmt 1              ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v6, s12, v34
	...
	buffer_load_b128 v[16:19], v4, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	buffer_load_b32 v29, v2, s[4:7], 0 offen
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	...
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_b32_e32 v33, 0x70, v2
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_and_b32_e32 v3, 48, v2
	.loc	1 356 32                        ; generate_amdgcn.py:356:32
	v_and_or_b32 v2, v1, 1, v33
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_xor_b32_e32 v38, v10, v3
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_lshl_u32 v39, v27, s39, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cmp_lt_i32 s39, s0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v40, v26, s40, 1
	v_add_lshl_u32 v41, v25, s40, 1
	v_add_lshl_u32 v42, v24, s40, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v43, v22, s40, 1
	v_add_lshl_u32 v44, v20, s40, 1
	v_add_lshl_u32 v45, v23, s40, 1
	v_add_lshl_u32 v46, v21, s40, 1
	v_add_lshl_u32 v47, v19, s40, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add_nc_u32_e32 v39, s41, v34
	v_add_nc_u32_e32 v40, s41, v35
	.loc	1 408 22 is_stmt 0              ; generate_amdgcn.py:408:22
	s_clause 0x1
	...
	s_mov_b32 s10, s1
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v39, s39, v28
	v_add_nc_u32_e32 v40, s39, v29
	s_mov_b32 s1, s19
	v_add_nc_u32_e32 v41, s39, v30
	v_add_nc_u32_e32 v42, s39, v31
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add3_u32 v43, s1, v33, v32
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v14, v58, v41 :: v_dual_add_nc_u32 v137, s40, v38
...
; %bb.8:
	...
	v_dual_mov_b32 v34, 0 :: v_dual_add_nc_u32 v3, s10, v31
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
...
.LBB0_11:
	...
	v_add_lshl_u32 v13, v38, s4, 2
	v_add_lshl_u32 v14, v38, s5, 2
	s_waitcnt lgkmcnt(7)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc256_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk4_evenk.num_vgpr, 139
