	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow149
	...
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v27, 0x70, v26
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v17, 0 :: v_dual_add_nc_u32 v42, 0, v7
	v_add_nc_u32_e32 v43, 0, v8
	v_dual_mov_b32 v1, s16 :: v_dual_mov_b32 v2, s17
	v_mul_lo_u32 v12, s6, v13
	v_dual_mov_b32 v13, 0 :: v_dual_add_nc_u32 v44, 0, v11
	v_dual_mov_b32 v3, s18 :: v_dual_mov_b32 v4, s19
	v_dual_mov_b32 v5, s20 :: v_dual_mov_b32 v6, s21
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v7, s22 :: v_dual_lshlrev_b32 v38, 1, v12
	v_dual_mov_b32 v21, 0 :: v_dual_mov_b32 v8, s23
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	v_dual_mul_f32 v50, v82, v50 :: v_dual_mul_f32 v57, v83, v57
	v_mul_f32_e32 v52, v82, v52
	v_dual_mul_f32 v53, v82, v53 :: v_dual_mul_f32 v54, v83, v54
	v_mul_f32_e32 v56, v83, v56
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v58, v83, v58 :: v_dual_fmac_f32 v25, v54, v63
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v62, 16, v62
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v60, v83, v60 :: v_dual_lshlrev_b32 v69, 16, v69
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v21, v49, v66 :: v_dual_fmac_f32 v24, v47, v64
	v_dual_fmac_f32 v19, v57, v66 :: v_dual_fmac_f32 v22, v48, v65
	v_dual_fmac_f32 v23, v55, v64 :: v_dual_fmac_f32 v18, v50, v67
	v_fmac_f32_e32 v15, v59, v68
	v_dual_fmac_f32 v17, v51, v68 :: v_dual_fmac_f32 v10, v46, v63
	v_dual_fmac_f32 v13, v53, v62 :: v_dual_fmac_f32 v14, v52, v69
	v_dual_fmac_f32 v11, v61, v62 :: v_dual_fmac_f32 v20, v56, v65
	v_fmac_f32_e32 v16, v58, v67
...
; %bb.7:
	...
	ds_load_u8 v8, v1
	ds_load_u8 v32, v1 offset:384
	s_mov_b32 s9, s4
	s_mov_b32 s10, s4
	s_mov_b32 s11, s4
	s_delay_alu instid0(SALU_CYCLE_1)
	v_dual_mov_b32 v49, s11 :: v_dual_and_b32 v30, 0x218, v30
	...
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v30, v29, 24, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(23)
	v_perm_b32 v2, v5, v2, 0xc0c0004
	v_perm_b32 v3, v4, v3, 0xc0c0004
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v36, v29, 8, 0
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	s_waitcnt lgkmcnt(20)
	v_perm_b32 v4, v8, v6, 0xc0c0004
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v5, v7, v32, 0xc0c0004
	.loc	1 189 26                        ; generate_amdgcn.py:189:26
	v_xad_u32 v57, v29, 16, 0
	v_add_nc_u32_e32 v29, 0, v29
	ds_load_2addr_stride64_b64 v[32:35], v30 offset0:8 offset1:10
	ds_load_2addr_stride64_b64 v[36:39], v36 offset0:8 offset1:10
	ds_load_2addr_stride64_b64 v[50:53], v29 offset0:8 offset1:10
	.loc	1 194 27                        ; generate_amdgcn.py:194:27
	...
	v_wmma_i32_16x16x16_iu4 v[1:8], v[29:30], v[50:51], v[42:49] neg_lo:[1,1,0]
	v_lshl_or_b32 v51, v75, 16, v66
	v_wmma_i32_16x16x16_iu4 v[42:49], v[29:30], v[52:53], v[42:49] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v50, v77, 16, v76
	v_perm_b32 v29, v73, v72, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[1:8], v[50:51], v[36:37], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v37, v59, 16, v58
	v_lshl_or_b32 v36, v61, 16, v60
	v_perm_b32 v58, v70, v67, 0xc0c0004
	v_perm_b32 v59, v69, v68, 0xc0c0004
	v_perm_b32 v60, v74, v71, 0xc0c0004
	v_wmma_i32_16x16x16_iu4 v[42:49], v[50:51], v[38:39], v[42:49] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[36:37], v[54:55], v[1:8] neg_lo:[1,1,0]
	v_lshl_or_b32 v30, v59, 16, v58
	v_lshl_or_b32 v29, v29, 16, v60
	v_wmma_i32_16x16x16_iu4 v[42:49], v[36:37], v[56:57], v[42:49] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[29:30], v[32:33], v[1:8] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[42:49], v[29:30], v[34:35], v[42:49] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v37, v37, v46 :: v_dual_add_nc_u32 v44, 20, v27
	v_dual_mul_f32 v32, v32, v46 :: v_dual_add_nc_u32 v43, 16, v27
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	v_cndmask_b32_e64 v28, 0x80000000, v27, s2
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v38, v38, v46 :: v_dual_add_nc_u32 v29, 4, v27
	v_dual_mul_f32 v34, v34, v46 :: v_dual_add_nc_u32 v45, 24, v27
	v_dual_mul_f32 v36, v36, v46 :: v_dual_add_nc_u32 v27, 28, v27
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v39, v39, v46 :: v_dual_mul_f32 v2, v2, v40
	v_dual_mul_f32 v35, v35, v46 :: v_dual_mul_f32 v4, v4, v40
	...
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add_lshl_u32 v9, v26, v9, 1
	v_add_lshl_u32 v26, v26, v31, 1
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	v_fma_f32 v4, v4, v31, v21
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v42, 16, v45
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v3, v3, v30, v22
	v_fma_f32 v5, v5, v40, v18
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_fma_f32 v28, v33, v28, v25
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v1, v10, v1, s2
	s_delay_alu instid0(VALU_DEP_2)
	v_cndmask_b32_e64 v10, v25, v28, s2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v28, v38, v30, v20
	v_fma_f32 v25, v39, v31, v19
	v_fma_f32 v31, v32, v40, v16
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_mov_b16_e32 v50.l, v19.h
	v_cmp_o_f32_e64 s6, v20, v20
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v8, v8, v27, v13
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v6, v6, v33, v17
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b32_e32 v12, 0x3276, v47, vcc_lo
	v_add3_u32 v2, v23, v13, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	v_dual_cndmask_b32 v3, v3, v7 :: v_dual_and_b32 v14, 1, v50
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v30, v34, v33, v15
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_permlanex16_b32 v1, v1, s15, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_cndmask_b16 v2.l, 0x7fff, v10.h, s0
	v_add3_u32 v10, v19, v14, 0x7fff
	v_permlanex16_b32 v3, v3, s15, 0xfedcba98 op_sel:[1,0]
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v15, v15, v30, s2
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_cndmask_b16 v0.h, 0x7fff, v10.h, s5
	v_cndmask_b32_e32 v10, 0x1054, v41, vcc_lo
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v27, v36, v27, v11
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	...
	v_add3_u32 v13, v15, v18, 0x7fff
	v_cndmask_b16 v13.l, 0x7fff, v6.h, s10
	v_add3_u32 v11, v11, v22, 0x7fff
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_cndmask_b16 v13.h, 0x7fff, v13.h, s9
	v_cndmask_b16 v6.h, 0x7fff, v11.h, s13
	v_lshl_or_b32 v11, v12, 8, v12
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v7, v13, v2 :: v_dual_cndmask_b32 v2, v2, v13
	...
	v_perm_b32 v5, v10, v7, v8
	v_perm_b32 v6, v12, v11, v6
	v_perm_b32 v7, v12, v11, v8
	s_clause 0x1
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 85
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc64_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
