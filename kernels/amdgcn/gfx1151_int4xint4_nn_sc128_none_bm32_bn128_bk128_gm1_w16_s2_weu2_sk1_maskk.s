...
.Ltmp21:
	...
	.loc	1 216 34                        ; generate_amdgcn.py:216:34
	v_add3_u32 v6, s28, s2, v6
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	s_cselect_b32 s2, -1, 0
	.loc	1 198 26                        ; generate_amdgcn.py:198:26
	s_and_b32 s16, s3, vcc_lo
	.loc	1 220 34                        ; generate_amdgcn.py:220:34
	v_add3_u32 v5, s17, s18, v5
	.loc	1 198 26                        ; generate_amdgcn.py:198:26
	s_and_b32 s5, s4, s5
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v14, 0 :: v_dual_add_nc_u32 v39, 0, v15
	v_mov_b32_e32 v2, v1
	v_mov_b32_e32 v3, v1
	v_mov_b32_e32 v5, v1
	v_mov_b32_e32 v7, v1
...
.LBB0_8:
	...
	v_dual_mul_f32 v9, v9, v27 :: v_dual_add_nc_u32 v24, 16, v18
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	s_clause 0x1
	buffer_load_u16 v19, v19, s[8:11], 0 offen
	buffer_load_u16 v20, v20, s[8:11], 0 offen
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v8, v8, v27 :: v_dual_add_nc_u32 v25, 20, v18
	v_dual_mul_f32 v23, v23, v27 :: v_dual_add_nc_u32 v26, 24, v18
	v_dual_mul_f32 v5, v5, v27 :: v_dual_add_nc_u32 v18, 28, v18
	.loc	1 232 18                        ; generate_amdgcn.py:232:18
	...
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
	v_dual_mul_f32 v7, v7, v27 :: v_dual_and_b32 v0, 16, v0
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v5, v5, v24, v13
	v_fma_f32 v6, v6, v25, v12
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v4, v4, v22, v14
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_cndmask_b16 v5.h, 0x7fff, v5.h, s3
	v_lshl_or_b32 v7, v13, 8, v13
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
	...
	v_add3_u32 v8, v9, v12, 0x7fff
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_dual_cndmask_b32 v12, 0x1054, v28 :: v_dual_cndmask_b32 v9, v5, v3
	v_cndmask_b16 v10.l, 0x7fff, v8.h, s2
	s_delay_alu instid0(VALU_DEP_2)
	...
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_cndmask_b32_e32 v7, v0, v10, vcc_lo
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_dual_cndmask_b32 v6, v10, v0 :: v_dual_and_b32 v3, 0x5040504, v3
	v_permlanex16_b32 v6, v6, s8, 0xfedcba98 op_sel:[1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
	v_perm_b32 v0, v1, v9, v3
	v_perm_b32 v1, v1, v9, v5
	v_perm_b32 v2, v6, v7, v3
	v_perm_b32 v3, v6, v7, v5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_vgpr, 72
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc128_none_bm32_bn128_bk128_gm1_w16_s2_weu2_sk1_maskk.numbered_sgpr, 40
