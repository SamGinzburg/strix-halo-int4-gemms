	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk,@function
amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk:                      ; @amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow126
	...
	v_dual_mov_b32 v10, 0 :: v_dual_and_b32 v27, 0x70, v26
	v_bfe_u32 v28, v0, 4, 1
	v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v14, 0
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_mov_b32 v12, 0 :: v_dual_add_nc_u32 v29, 0, v25
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v23, 0 :: v_dual_lshlrev_b32 v34, 1, v28
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mul_lo_u32 v8, s41, v8
	v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v15, 0
	v_add_nc_u32_e32 v40, v5, v27
	v_dual_mov_b32 v16, 0 :: v_dual_lshlrev_b32 v37, 1, v4
	v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v14, 0
	v_dual_mov_b32 v11, 0 :: v_dual_lshlrev_b32 v36, 1, v8
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 168 18                        ; generate_amdgcn.py:168:18
	s_clause 0x1
	buffer_load_u16 v41, v37, s[36:39], 0 offen
	buffer_load_u16 v42, v36, s[36:39], 0 offen
	.loc	1 171 27                        ; generate_amdgcn.py:171:27
	v_cmp_lt_i32_e32 vcc_lo, s43, v33
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	.loc	1 193 26                        ; generate_amdgcn.py:193:26
	buffer_load_b32 v66, v41, s[20:23], 0 offen
	...
	s_clause 0x7
	buffer_load_u16 v58, v57, s[28:31], 0 offen
	buffer_load_u16 v59, v57, s[28:31], 0 offen offset:4
	buffer_load_u16 v60, v57, s[28:31], 0 offen offset:8
	buffer_load_u16 v61, v57, s[28:31], 0 offen offset:12
	buffer_load_u16 v62, v57, s[28:31], 0 offen offset:16
	buffer_load_u16 v67, v57, s[28:31], 0 offen offset:20
	buffer_load_u16 v68, v57, s[28:31], 0 offen offset:24
	buffer_load_u16 v57, v57, s[28:31], 0 offen offset:28
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	v_dual_mul_f32 v47, v63, v47 :: v_dual_mul_f32 v54, v64, v54
	v_mul_f32_e32 v48, v63, v48
	v_dual_mul_f32 v52, v64, v52 :: v_dual_add_nc_u32 v35, s45, v35
	.loc	1 187 26                        ; generate_amdgcn.py:187:26
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt vmcnt(9)
	...
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v49, v64, v49 :: v_dual_fmac_f32 v22, v43, v60
	v_dual_mul_f32 v51, v64, v51 :: v_dual_fmac_f32 v20, v45, v62
	v_dual_mul_f32 v53, v64, v53 :: v_dual_fmac_f32 v18, v47, v68
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
	v_dual_mul_f32 v55, v64, v55 :: v_dual_fmac_f32 v24, v49, v58
	v_dual_mul_f32 v56, v64, v56 :: v_dual_fmac_f32 v9, v41, v58
	.loc	1 206 13 is_stmt 0              ; generate_amdgcn.py:206:13
	v_dual_fmac_f32 v23, v42, v59 :: v_dual_fmac_f32 v14, v52, v61
	v_dual_fmac_f32 v21, v44, v61 :: v_dual_fmac_f32 v16, v50, v59
	v_dual_fmac_f32 v19, v46, v67 :: v_dual_fmac_f32 v10, v56, v57
	v_dual_fmac_f32 v17, v48, v57 :: v_dual_fmac_f32 v12, v54, v67
	v_fmac_f32_e32 v15, v51, v60
	v_fmac_f32_e32 v13, v53, v62
...
.LBB0_6:                                ; %._crit_edge
	...
	s_clause 0x1
	buffer_load_u16 v40, v2, s[24:27], 0 offen
	buffer_load_u16 v41, v3, s[24:27], 0 offen
...
; %bb.7:
	...
	ds_load_u8 v32, v6 offset:640
	ds_load_u8 v33, v6 offset:768
	ds_load_u8 v34, v6 offset:512
	ds_load_u8 v35, v6 offset:896
	ds_load_u8 v36, v6 offset:128
	ds_load_u8 v37, v6 offset:384
	ds_load_u8 v38, v6 offset:256
	ds_load_u8 v39, v6
	ds_load_u8 v50, v29 offset:2528
	ds_load_u8 v51, v29 offset:2464
	ds_load_u8 v52, v29 offset:2400
	ds_load_u8 v53, v29 offset:2336
	ds_load_u8 v54, v29 offset:2272
	ds_load_u8 v55, v29 offset:2208
	ds_load_u8 v56, v29 offset:2144
	ds_load_u8 v57, v29 offset:2080
	s_waitcnt lgkmcnt(22)
	v_perm_b32 v2, v3, v2, 0xc0c0004
	ds_load_u8 v68, v29 offset:2784
	ds_load_u8 v69, v29 offset:2720
	ds_load_u8 v70, v29 offset:2656
	ds_load_u8 v71, v29 offset:2592
	...
	ds_load_u8 v42, v29 offset:2944
	s_waitcnt lgkmcnt(19)
	v_perm_b32 v7, v34, v32, 0xc0c0004
	s_waitcnt lgkmcnt(18)
	v_perm_b32 v8, v33, v35, 0xc0c0004
	v_lshl_or_b32 v2, v5, 16, v4
	s_mov_b32 s14, s12
	s_mov_b32 s15, s12
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v4, v39, v36, 0xc0c0004
	...
	ds_load_u8 v43, v29 offset:2560
	ds_load_u8 v44, v29 offset:2752
	ds_load_u8 v45, v29 offset:2688
	ds_load_u8 v58, v6 offset:1664
	ds_load_u8 v59, v6 offset:1920
	ds_load_u8 v60, v6 offset:1792
	ds_load_u8 v61, v6 offset:1536
	ds_load_u8 v62, v29 offset:3040
	ds_load_u8 v63, v29 offset:2976
	ds_load_u8 v64, v29 offset:2912
	ds_load_u8 v65, v29 offset:2848
	...
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v8, v67, v66, 0xc0c0004
	s_waitcnt lgkmcnt(0)
	...
	v_wmma_i32_16x16x16_iu4 v[32:39], v[4:5], v[29:30], v[32:39] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_lshl_or_b32 v5, v50, 16, v31
	v_lshl_or_b32 v4, v52, 16, v51
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[42:49], v[6:7], v[2:3], v[42:49] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu4 v[32:39], v[6:7], v[4:5], v[32:39] neg_lo:[1,1,0]
...
.LBB0_8:
	...
	.loc	1 216 18                        ; generate_amdgcn.py:216:18
	v_add3_u32 v26, s40, s33, v26
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	v_dual_mul_f32 v37, v37, v46 :: v_dual_mul_f32 v2, v2, v40
	v_dual_mul_f32 v39, v39, v46 :: v_dual_mul_f32 v4, v4, v40
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_add_lshl_u32 v25, v26, v25, 1
	v_add_lshl_u32 v26, v26, v1, 1
	.loc	1 206 20                        ; generate_amdgcn.py:206:20
	...
	v_fma_f32 v2, v2, v1, v9
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	s_waitcnt vmcnt(1)
	v_lshlrev_b32_e32 v43, 16, v45
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v3, v3, v28, v23
	v_fma_f32 v4, v4, v29, v22
	v_fma_f32 v29, v34, v29, v15
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v2, v9, v2, s2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v34, v38, v43, v11
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v3, v23, v3, s2
	v_cndmask_b32_e64 v4, v22, v4, s2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v5, v5, v30, v21
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v32, v36, v40, v13
	v_fma_f32 v30, v35, v30, v14
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_max_f32_e32 v2, 0, v2
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v1, v24, v1, s2
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v31, v31, v27, v17
	v_fma_f32 v27, v39, v27, v10
	.loc	1 205 18                        ; generate_amdgcn.py:205:18
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v28, v33, v28, v16
	v_fma_f32 v33, v37, v42, v12
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	v_dual_max_f32 v13, v13, v13 :: v_dual_max_f32 v10, v10, v10
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v7, v7, v42, v19
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	...
	.loc	1 206 13                        ; generate_amdgcn.py:206:13
	v_fma_f32 v6, v6, v40, v20
	v_fma_f32 v8, v8, v43, v18
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	v_cndmask_b32_e64 v7, v19, v7, s2
	v_cndmask_b32_e64 v9, v17, v31, s2
	...
	.loc	1 214 19                        ; generate_amdgcn.py:214:19
	v_dual_mul_f32 v13, v13, v13 :: v_dual_mul_f32 v10, v10, v10
	.loc	1 161 9                         ; generate_amdgcn.py:161:9
	...
	.loc	1 214 19                        ; generate_amdgcn.py:214:19
	v_dual_mul_f32 v15, v15, v15 :: v_dual_and_b32 v32, 1, v62
	v_dual_mul_f32 v12, v12, v12 :: v_dual_and_b32 v31, 1, v61
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	.loc	1 213 19                        ; generate_amdgcn.py:213:19
	...
	.loc	1 214 19                        ; generate_amdgcn.py:214:19
	v_dual_mul_f32 v3, v3, v3 :: v_dual_and_b32 v30, 1, v60
	v_dual_mul_f32 v6, v6, v6 :: v_dual_and_b32 v29, 1, v59
	.loc	1 216 9                         ; generate_amdgcn.py:216:9
	v_and_b32_e32 v17, 1, v46
	v_mov_b16_e32 v49.l, v5.h
	...
	v_cndmask_b32_e32 v4, 0x3276, v47, vcc_lo
	...
	v_cndmask_b32_e32 v2, 0x1054, v41, vcc_lo
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_permlanex16_b32 v4, v5, s3, 0xfedcba98 op_sel:[1,0]
	v_mov_b16_e32 v16.l, v1.h
	v_dual_cndmask_b32 v1, v7, v3 :: v_dual_and_b32 v18, 1, v57
	v_cndmask_b32_e32 v3, v3, v7, vcc_lo
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_perm_b32 v2, v4, v6, v10
	...
	s_mov_b32 s3, s7
	s_clause 0x1
	buffer_store_b128 v[0:3], v25, s[0:3], 0 offen
	buffer_store_b128 v[4:7], v26, s[0:3], 0 offen
	.loc	1 80 1                          ; generate_amdgcn.py:80:1
	s_endpgm
.Ltmp22:
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_vgpr, 72
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.numbered_sgpr, 47
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk
    .private_segment_fixed_size: 0
    .sgpr_count:     49
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_tn_sc32_relu2_bm64_bn128_bk128_gm4_w16_s2_weu2_sk1_maskk.kd
