	...
	.text
	.globl	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
.Lfunc_begin0:
...
.Ltmp11:
	...
	v_mad_u64_u32 v[6:7], null, s35, v4, v[1:2]
...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v12, 0 :: v_dual_and_b32 v19, 0x420, v19
	v_and_b32_e32 v76, 0x800, v8
	v_lshl_or_b32 v62, v6, 6, v7
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_add_nc_u32_e32 v6, 0x81, v4
	v_and_or_b32 v5, 0x210, v20, v19
...
.Ltmp22:
	...
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_subrev_nc_u32_e32 v82, s12, v5
	v_subrev_nc_u32_e32 v83, s12, v1
	s_mov_b32 s12, 0
	...
	s_mov_b32 s18, s12
	s_mov_b32 s19, s12
	v_dual_mov_b32 v32, 0 :: v_dual_add_nc_u32 v3, s34, v3
	v_mov_b32_e32 v45, 0
	v_mov_b32_e32 v19, 0
	v_mov_b32_e32 v23, 0
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	s_clause 0x1
	buffer_load_b128 v[121:124], v83, s[20:23], 0 offen
	buffer_load_b128 v[125:128], v82, s[20:23], 0 offen
	...
	v_add_lshl_u32 v87, v43, s15, 1
	v_add_lshl_u32 v88, v42, s15, 1
	.loc	1 419 34                        ; generate_amdgcn.py:419:34
	s_cselect_b32 vcc_lo, -1, 0
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v89, v41, s15, 1
	v_add_lshl_u32 v90, v40, s15, 1
	v_add_lshl_u32 v91, v39, s15, 1
	v_add_lshl_u32 v92, v37, s15, 1
	v_add_lshl_u32 v93, v34, s15, 1
	v_add_lshl_u32 v94, v31, s15, 1
	v_add_lshl_u32 v95, v24, s15, 1
	v_add_lshl_u32 v96, v21, s15, 1
	v_add_lshl_u32 v97, v18, s15, 1
	v_add_lshl_u32 v98, v16, s15, 1
	v_add_lshl_u32 v99, v14, s15, 1
	v_add_lshl_u32 v100, v17, s15, 1
	v_add_lshl_u32 v101, v15, s15, 1
	v_add_lshl_u32 v102, v13, s15, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v89, s15, v78
	v_add_nc_u32_e32 v90, s15, v79
	v_add_nc_u32_e32 v91, s15, v80
	v_add_nc_u32_e32 v92, s15, v81
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(12)
	v_lshlrev_b32_e32 v122, 16, v190
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	...
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_lshlrev_b32_e32 v118, 16, v186
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_waitcnt vmcnt(2)
	v_lshlrev_b32_e32 v148, 16, v200
	v_lshlrev_b32_e32 v123, 16, v191
	v_lshlrev_b32_e32 v124, 16, v192
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_lshlrev_b32_e32 v117, 16, v185
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_mul_f32_e32 v98, v117, v124
	v_dual_mul_f32 v124, v118, v124 :: v_dual_mul_f32 v97, v117, v123
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_fmac_f32 v23, v97, v133 :: v_dual_lshlrev_b32 v128, 16, v196
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v119, 16, v187
	v_lshlrev_b32_e32 v146, 16, v198
	v_lshlrev_b32_e32 v121, 16, v189
	s_waitcnt vmcnt(0)
	v_lshlrev_b32_e32 v150, 16, v202
	v_lshlrev_b32_e32 v125, 16, v193
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v154, v117, v146 :: v_dual_add_nc_u32 v83, s27, v83
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v99, v117, v125
	v_dual_mul_f32 v152, v117, v128 :: v_dual_lshlrev_b32 v149, 16, v201
	v_mul_f32_e32 v128, v118, v128
	v_dual_mul_f32 v93, v117, v119 :: v_dual_lshlrev_b32 v120, 16, v188
	v_dual_mul_f32 v146, v118, v146 :: v_dual_lshlrev_b32 v127, 16, v195
	v_mul_f32_e32 v95, v117, v121
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v145, 16, v197
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v121, v118, v121 :: v_dual_mul_f32 v96, v117, v122
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v147, 16, v199
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	v_dual_mul_f32 v94, v117, v120 :: v_dual_add_nc_u32 v209, s42, v74
	v_mul_f32_e32 v120, v118, v120
	v_mul_f32_e32 v122, v118, v122
	v_mul_f32_e32 v125, v118, v125
	v_dual_mul_f32 v100, v117, v126 :: v_dual_add_nc_u32 v207, s42, v72
	v_mul_f32_e32 v126, v118, v126
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v12, v93, v129
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v151, v117, v127 :: v_dual_add_nc_u32 v82, s27, v82
	v_mul_f32_e32 v127, v118, v127
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v20, v95, v131
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v153, v117, v145 :: v_dual_add_nc_u32 v206, s42, v71
	v_dual_mul_f32 v145, v118, v145 :: v_dual_fmac_f32 v22, v96, v132
	v_dual_mul_f32 v155, v117, v147 :: v_dual_add_nc_u32 v204, s42, v69
	v_mul_f32_e32 v147, v118, v147
	v_dual_mul_f32 v156, v117, v148 :: v_dual_add_nc_u32 v205, s42, v70
	v_mul_f32_e32 v148, v118, v148
	v_mul_f32_e32 v123, v118, v123
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fmac_f32_e32 v26, v99, v135
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v157, v117, v149 :: v_dual_add_nc_u32 v210, s42, v75
	v_mul_f32_e32 v149, v118, v149
	v_dual_mul_f32 v117, v117, v150 :: v_dual_add_nc_u32 v208, s42, v73
	v_mul_f32_e32 v118, v118, v150
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v19, v94, v130 :: v_dual_fmac_f32 v28, v151, v137
	v_dual_fmac_f32 v25, v98, v134 :: v_dual_fmac_f32 v30, v153, v139
	v_dual_fmac_f32 v27, v100, v136 :: v_dual_fmac_f32 v36, v157, v143
	v_dual_fmac_f32 v29, v152, v138 :: v_dual_fmac_f32 v32, v154, v140
	v_dual_fmac_f32 v33, v155, v141 :: v_dual_fmac_f32 v38, v117, v144
	v_dual_fmac_f32 v35, v156, v142 :: v_dual_fmac_f32 v44, v119, v101
	v_dual_fmac_f32 v45, v120, v102 :: v_dual_fmac_f32 v46, v121, v103
	v_dual_fmac_f32 v47, v122, v104 :: v_dual_fmac_f32 v48, v123, v105
	v_dual_fmac_f32 v49, v124, v106 :: v_dual_fmac_f32 v50, v125, v107
	v_dual_fmac_f32 v51, v126, v108 :: v_dual_fmac_f32 v54, v128, v110
	v_dual_fmac_f32 v53, v127, v109 :: v_dual_fmac_f32 v56, v146, v112
	v_dual_fmac_f32 v55, v145, v111 :: v_dual_fmac_f32 v58, v148, v114
	v_dual_fmac_f32 v57, v147, v113 :: v_dual_fmac_f32 v52, v118, v116
	v_fmac_f32_e32 v59, v149, v115
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_10:
	...
	v_add_lshl_u32 v97, v39, s4, 1
	v_dual_cndmask_b32 v93, 0x80000000, v93 :: v_dual_cndmask_b32 v94, 0x80000000, v94
	v_add_lshl_u32 v98, v37, s4, 1
	v_add_lshl_u32 v99, v34, s4, 1
	v_add_lshl_u32 v100, v31, s4, 1
	v_dual_cndmask_b32 v95, 0x80000000, v95 :: v_dual_cndmask_b32 v96, 0x80000000, v96
	v_add_lshl_u32 v101, v24, s4, 1
...
; %bb.11:
	...
	s_mov_b32 s23, s16
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s42, v143
	v_add_nc_u32_e32 v93, s42, v141
	v_add_nc_u32_e32 v94, s42, v142
	v_add_nc_u32_e32 v95, s42, v140
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v147, s23 :: v_dual_mov_b32 v146, s22
	v_mov_b32_e32 v144, s20
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v140, s16 :: v_dual_add_nc_u32 v1, s41, v62
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v93, s41, v65
...
.LBB0_12:
	...
	v_dual_cndmask_b32 v37, 0x80000000, v37 :: v_dual_cndmask_b32 v24, 0x80000000, v24
	v_add_lshl_u32 v13, v13, s4, 1
	v_dual_cndmask_b32 v41, 0x80000000, v41 :: v_dual_cndmask_b32 v40, 0x80000000, v40
	v_dual_cndmask_b32 v21, 0x80000000, v21 :: v_dual_cndmask_b32 v16, 0x80000000, v16
	v_dual_cndmask_b32 v31, 0x80000000, v31 :: v_dual_cndmask_b32 v18, 0x80000000, v18
	...
	v_dual_cndmask_b32 v14, 0x80000000, v14 :: v_dual_cndmask_b32 v17, 0x80000000, v17
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v142, v13, v126 :: v_dual_and_b32 v11, 56, v11
	v_mul_f32_e32 v136, v13, v63
	v_mul_f32_e32 v137, v13, v64
	v_mul_f32_e32 v138, v13, v65
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v91, v13, v92 :: v_dual_lshlrev_b32 v34, 16, v34
	v_mul_f32_e32 v92, v13, v119
	v_mul_f32_e32 v119, v13, v122
	s_waitcnt vmcnt(3)
	v_dual_mul_f32 v122, v13, v126 :: v_dual_lshlrev_b32 v15, 16, v15
	v_mul_f32_e32 v126, v13, v127
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v31, 16, v31
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v127, v13, v128 :: v_dual_lshlrev_b32 v18, 16, v18
	v_mul_f32_e32 v128, v13, v129
	v_mul_f32_e32 v129, v13, v130
	v_mul_f32_e32 v130, v13, v131
	v_dual_mul_f32 v131, v13, v132 :: v_dual_lshlrev_b32 v14, 16, v14
	v_mul_f32_e32 v132, v13, v133
	v_mul_f32_e32 v133, v13, v134
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_lshlrev_b32_e32 v17, 16, v17
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v70, v92, v70, v32
	v_fma_f32 v5, v130, v5, v23
	v_fma_f32 v68, v122, v68, v29
	v_fma_f32 v2, v133, v2, v19
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(1)
	v_dual_mul_f32 v134, v13, v135 :: v_dual_lshlrev_b32 v19, 16, v60
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_dual_mul_f32 v70, v19, v15 :: v_dual_lshlrev_b32 v21, 16, v21
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v6, v129, v6, v25
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v68, v19, v14
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v4, v131, v4, v22
	v_fma_f32 v64, v64, v73, v36
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_mul_f32_e32 v42, v19, v25
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v63, v63, v74, v38
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v65, v65, v72, v35
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v64, v19, v24
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v69, v119, v69, v30
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	v_mul_f32_e32 v43, v19, v26
	v_mul_f32_e32 v62, v19, v34
	v_dual_mul_f32 v65, v19, v21 :: v_dual_mul_f32 v22, v20, v22
	v_mul_f32_e32 v66, v19, v18
	v_dual_mul_f32 v67, v19, v16 :: v_dual_mul_f32 v26, v20, v26
	v_dual_mul_f32 v69, v19, v17 :: v_dual_mul_f32 v34, v20, v34
	v_dual_mul_f32 v19, v19, v39 :: v_dual_mul_f32 v18, v20, v18
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_fma_f32 v22, v22, v108, v44
	v_fma_f32 v26, v26, v111, v47
	v_fma_f32 v34, v34, v114, v50
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v34, v50, v34, s3
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	...
	v_dual_mul_f32 v20, v20, v39 :: v_dual_max_f32 v5, v5, v5
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v39, v41, v93, v2
	v_fma_f32 v41, v43, v95, v4
	v_fma_f32 v43, v61, v97, v6
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v26, v26, v26
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v31, v31, v115, v51
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_fma_f32 v63, v65, v101, v29
	v_fma_f32 v64, v66, v102, v30
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v49, v49, v80, s2
	v_cndmask_b32_e64 v33, v33, v71, s2
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v19, v19, v107, v38
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v21, v21, v117, v54
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v31, v31, v31 :: v_dual_max_f32 v2, 0, v2
	s_delay_alu instid0(VALU_DEP_4)
	v_dual_max_f32 v1, 0, v1 :: v_dual_max_f32 v6, 0, v6
	v_dual_max_f32 v15, v15, v15 :: v_dual_max_f32 v14, 0, v14
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v8, v8, v61, s3
	v_cndmask_b32_e64 v12, v28, v62, s3
	v_cndmask_b32_e64 v28, v29, v63, s3
	v_cndmask_b32_e64 v29, v30, v64, s3
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v65, v67, v103, v32
	v_fma_f32 v66, v68, v104, v33
	v_fma_f32 v67, v69, v105, v35
	v_fma_f32 v68, v70, v106, v36
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v7, v7, v60, s3
	v_cndmask_b32_e64 v19, v38, v19, s3
	v_cndmask_b32_e64 v21, v54, v21, s3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v4, v4, v4
	v_max_f32_e32 v22, v22, v22
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v37, v37, v113, v49
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	v_dual_mul_f32 v1, v1, v1 :: v_dual_max_f32 v8, v8, v8
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v30, v32, v65, s3
	v_cndmask_b32_e64 v32, v33, v66, s3
	v_cndmask_b32_e64 v33, v35, v67, s3
	v_cndmask_b32_e64 v35, v36, v68, s3
	v_cndmask_b32_e64 v36, v49, v37, s3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v7, v7, v7
	v_dual_max_f32 v21, v21, v21 :: v_dual_max_f32 v4, 0, v4
	.loc	1 448 18                        ; generate_amdgcn.py:448:18
	...
	s_add_i32 s2, s2, s33
	.loc	1 444 15 is_stmt 1              ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v6, v6, v6 :: v_dual_and_b32 v9, 1, v9
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v12, v12, v12 :: v_dual_max_f32 v33, v33, v33
	...
	.loc	1 443 15 is_stmt 1              ; generate_amdgcn.py:443:15
	v_dual_max_f32 v28, v28, v28 :: v_dual_max_f32 v35, v35, v35
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v5, v5, v5 :: v_dual_and_b32 v10, 1, v11
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v7, 0, v7 :: v_dual_max_f32 v28, 0, v28
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v8, v8, v8 :: v_dual_and_b32 v3, 1, v10
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	...
	s_delay_alu instid0(VALU_DEP_2)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v12, v32, v32 :: v_dual_and_b32 v7, 1, v9
	v_mul_f32_e32 v9, v28, v28
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v5.l, v3.h
	v_and_b32_e32 v3, 1, v6
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v23, v45, v23, s3
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, v23, v23 :: v_dual_max_f32 v36, v36, v36
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v23, 0, v23 :: v_dual_max_f32 v36, 0, v36
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	v_mov_b16_e32 v9.h, v13.l
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v35, 0, v35 :: v_dual_max_f32 v22, 0, v22
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v20, v20, v125, v52
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v4.l, v8.h
	v_and_b32_e32 v8, 1, v10
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v22, v22, v22 :: v_dual_and_b32 v9, 1, v9
	v_mul_f32_e32 v10, v19, v19
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	v_cndmask_b32_e64 v24, v53, v24, s3
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_max_f32_e32 v25, v25, v25
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v19.l, v7.h
	v_mov_b16_e32 v19.h, v13.l
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	v_dual_max_f32 v21, 0, v21 :: v_dual_and_b32 v12, 1, v19
	v_dual_max_f32 v20, v20, v20 :: v_dual_mul_f32 v19, v23, v23
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v9.l, v8.h
	s_delay_alu instid0(VALU_DEP_3)
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v21, v21, v21 :: v_dual_and_b32 v8, 1, v11
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v27, v27, v27 :: v_dual_mul_f32 v10, v25, v25
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_mov_b16_e32 v8.l, v7.h
	v_and_b32_e32 v7, 1, v12
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v12, v26, v26 :: v_dual_and_b32 v11, 1, v11
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v16, v16, v16 :: v_dual_max_f32 v27, 0, v27
	...
	.loc	1 443 15                        ; generate_amdgcn.py:443:15
	v_dual_max_f32 v31, 0, v31 :: v_dual_max_f32 v18, 0, v18
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v7, v24, v24 :: v_dual_and_b32 v22, 1, v25
	v_mul_f32_e32 v15, v15, v15
	v_dual_mul_f32 v14, v14, v14 :: v_dual_and_b32 v19, 1, v28
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	...
	.loc	1 444 15                        ; generate_amdgcn.py:444:15
	v_dual_mul_f32 v20, v20, v20 :: v_dual_and_b32 v25, 1, v25
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_add3_u32 v7, v7, v24, 0x7fff
	v_mov_b16_e32 v22.l, v19.h
	v_add3_u32 v19, v21, v23, 0x7fff
	...
	v_dual_cndmask_b32 v11, v22, v12 :: v_dual_cndmask_b32 v12, v12, v22
	v_cndmask_b32_e32 v10, 0x3276, v15, vcc_lo
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_dual_cndmask_b32 v15, v7, v19 :: v_dual_and_b32 v6, 0x540054, v6
...
.Ltmp23:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 211
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.numbered_sgpr, 44
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     46
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int8xint8_nn_sc128_relu2_bm64_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.kd
