...
.Ltmp11:
	...
	s_delay_alu instid0(SALU_CYCLE_1)
	s_mul_hi_u32 s12, s14, s19
	s_xor_b32 s19, s2, s17
	s_mul_i32 s20, s12, s18
	s_ashr_i32 s19, s19, 31
	s_sub_i32 s14, s14, s20
	s_add_i32 s20, s12, 1
	s_sub_i32 s21, s14, s18
...
.Ltmp19:
	...
	.loc	1 408 30                        ; generate_amdgcn.py:408:30
	v_add3_u32 v3, s14, s2, v9
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add3_u32 v11, v7, v5, s13
	...
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v5, s18, v11
	v_add_nc_u32_e32 v7, s33, v11
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	...
	buffer_load_b128 v[27:30], v8, s[20:23], 0 offen
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_clause 0x1
	...
	v_perm_b32 v46, v22, v18, 0x7030602
	...
	v_lshrrev_b32_e32 v66, 8, v45
	v_lshrrev_b32_e32 v67, 24, v45
	...
	s_waitcnt vmcnt(2)
	v_perm_b32 v46, v27, v23, 0x5010400
	v_perm_b32 v69, v27, v23, 0x7030602
	v_perm_b32 v70, v28, v24, 0x5010400
	v_perm_b32 v71, v28, v24, 0x7030602
	v_perm_b32 v72, v29, v25, 0x5010400
	v_perm_b32 v73, v29, v25, 0x7030602
	v_perm_b32 v74, v30, v26, 0x5010400
	v_perm_b32 v75, v30, v26, 0x7030602
	...
	v_and_b16 v44.l, 0xff, v70.l
	v_lshrrev_b32_e32 v64, 8, v70
	v_lshrrev_b32_e32 v65, 24, v70
	v_and_b16 v44.h, 0xff, v70.h
	v_and_b16 v45.l, 0xff, v71.l
	v_lshrrev_b32_e32 v66, 8, v71
...
.LBB0_3:                                ; %Flow73
	...
	s_ashr_i32 s0, s25, 6
	v_or_b32_e32 v27, s14, v5
	v_or_b32_e32 v26, s14, v10
	v_or_b32_e32 v25, s14, v12
	v_mul_lo_u32 v28, v19, s0
	v_or_b32_e32 v23, s14, v13
	v_or_b32_e32 v21, s14, v14
	v_or_b32_e32 v24, s14, v6
...
; %bb.4:                                ; %.lr.ph
	...
	v_lshl_or_b32 v29, v1, 6, v4
	v_and_or_b32 v44, 0x1800, v3, v4
	v_dual_mov_b32 v10, 0 :: v_dual_add_nc_u32 v45, s15, v9
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 s18, s33
	.loc	1 398 17                        ; generate_amdgcn.py:398:17
	s_add_i32 s33, s10, s39
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	s_ashr_i32 s39, s38, 31
	.loc	1 404 30                        ; generate_amdgcn.py:404:30
	v_add_nc_u32_e32 v50, s33, v11
	.loc	1 418 29                        ; generate_amdgcn.py:418:29
	...
	buffer_load_b128 v[62:65], v52, s[20:23], 0 offen
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	s_clause 0x7
	buffer_load_u16 v100, v51, s[28:31], 0 offen
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v110, s35, v38
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	s_cmp_lg_u32 s37, s11
	s_mov_b32 s37, s38
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	s_barrier
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v112, s35, v40
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_wmma_i32_16x16x16_iu8 v[50:57], v[82:85], v[66:69], v[1:8] neg_lo:[1,1,0]
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v114, s35, v42
	...
	v_mul_f32_e32 v75, v83, v84
	v_mul_f32_e32 v76, v83, v87
	v_mul_f32_e32 v77, v83, v86
	v_mul_f32_e32 v78, v83, v89
	v_mul_f32_e32 v79, v83, v88
	v_mul_f32_e32 v80, v83, v91
	v_dual_mul_f32 v81, v83, v90 :: v_dual_add_nc_u32 v108, s39, v36
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v10, v75, v67 :: v_dual_add_nc_u32 v109, s35, v37
	v_dual_fmac_f32 v16, v76, v68 :: v_dual_add_nc_u32 v111, s35, v39
	v_dual_fmac_f32 v14, v78, v70 :: v_dual_add_nc_u32 v113, s35, v41
	v_dual_fmac_f32 v12, v80, v72 :: v_dual_add_nc_u32 v115, s35, v43
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_lshlrev_b16 v65.h, 8, v82.l
	v_or_b16 v50.l, v50.l, v58.l
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_dual_fmac_f32 v18, v74, v66 :: v_dual_fmac_f32 v17, v77, v69
	v_fmac_f32_e32 v15, v79, v71
	v_fmac_f32_e32 v13, v81, v73
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
...
.LBB0_8:                                ; %Flow74
	...
	v_dual_mov_b32 v6, 0 :: v_dual_and_b32 v11, 0xf0, v0
	v_mov_b32_e32 v5, 0
	v_mov_b32_e32 v9, 0
...
; %bb.9:
	...
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v2, s19, v50
	v_add_nc_u32_e32 v6, s19, v49
	.loc	1 404 22 is_stmt 1              ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v33, s1, v32
	v_add_nc_u32_e32 v34, s1, v29
	...
	v_mov_b32_e32 v33, 0
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v35, s19, v48
	v_add_nc_u32_e32 v34, s19, v46
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v37, s1, v30
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	...
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[33:40], v[6:9], v[51:54], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[33:40], v[2:5], v[41:44], v[33:40] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[33:40], v[59:62], v[67:70], v[33:40] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[33:40], v[55:58], v[63:66], v[33:40] neg_lo:[1,1,0]
...
.LBB0_10:
	...
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v34, v27, s1, 1
	v_add_lshl_u32 v35, v26, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	v_cndmask_b32_e32 v33, 0x80000000, v33, vcc_lo
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v36, v25, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	s_and_b32 s9, s9, 0xffff
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	v_add_lshl_u32 v38, v24, s1, 1
	v_add_lshl_u32 v37, v21, s1, 1
	.loc	1 420 22                        ; generate_amdgcn.py:420:22
	buffer_load_u16 v47, v33, s[8:11], 0 offen
	.loc	1 422 22                        ; generate_amdgcn.py:422:22
	...
	v_add_lshl_u32 v40, v20, s1, 1
	v_add_lshl_u32 v39, v22, s1, 1
	...
	s_clause 0x7
	buffer_load_u16 v51, v33, s[16:19], 0 offen
	buffer_load_u16 v52, v34, s[16:19], 0 offen
	buffer_load_u16 v44, v35, s[16:19], 0 offen
	buffer_load_u16 v45, v36, s[16:19], 0 offen
	buffer_load_u16 v42, v37, s[16:19], 0 offen
	buffer_load_u16 v43, v38, s[16:19], 0 offen
	buffer_load_u16 v40, v39, s[16:19], 0 offen
...
; %bb.11:
	v_dual_mov_b32 v53, 0 :: v_dual_add_nc_u32 v36, s35, v49
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	v_add_nc_u32_e32 v1, s35, v50
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v49, s34, v32
	v_add_nc_u32_e32 v29, s34, v29
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v55, v53 :: v_dual_add_nc_u32 v48, s35, v48
	...
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v60, v53 :: v_dual_add_nc_u32 v1, s35, v46
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	v_add_nc_u32_e32 v29, s34, v31
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_dual_mov_b32 v57, v53 :: v_dual_add_nc_u32 v30, s34, v30
	.loc	1 408 22                        ; generate_amdgcn.py:408:22
	ds_load_b128 v[69:72], v48
	ds_load_b128 v[73:76], v1
	.loc	1 404 22                        ; generate_amdgcn.py:404:22
	ds_load_b128 v[77:80], v29
	ds_load_b128 v[81:84], v30
	.loc	1 409 19                        ; generate_amdgcn.py:409:19
	v_mov_b32_e32 v59, v53
	s_waitcnt lgkmcnt(4)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_wmma_i32_16x16x16_iu8 v[53:60], v[36:39], v[65:68], v[53:60] neg_lo:[1,1,0]
	v_wmma_i32_16x16x16_iu8 v[53:60], v[32:35], v[61:64], v[53:60] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
.LBB0_12:
	...
	.loc	1 424 24                        ; generate_amdgcn.py:424:24
	s_waitcnt vmcnt(6)
	v_dual_mul_f32 v42, v29, v42 :: v_dual_lshlrev_b32 v13, 16, v27
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v12, v12, v34, v8
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
	v_cmp_o_f32_e64 s0, v1, v1
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v13, v14, v38, v7
	v_fma_f32 v14, v15, v35, v4
	.loc	1 363 5                         ; generate_amdgcn.py:363:5
	...
	.loc	1 429 13                        ; generate_amdgcn.py:429:13
	v_fma_f32 v15, v16, v36, v3
	v_fma_f32 v16, v17, v33, v2
	v_fma_f32 v17, v20, v37, v5
	.loc	1 448 9                         ; generate_amdgcn.py:448:9
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int8xint8_nn_sc64_none_bm16_bn128_bk64_gm4_w8_s3_weu2_sk1_evenk.num_vgpr, 116
