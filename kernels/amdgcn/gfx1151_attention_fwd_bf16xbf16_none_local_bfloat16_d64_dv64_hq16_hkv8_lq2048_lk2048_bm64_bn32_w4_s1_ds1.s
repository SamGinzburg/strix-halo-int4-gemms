...
; %bb.1:                                ; %.lr.ph
	...
	v_cndmask_b32_e64 v1, 0x3276, v1, s25
	v_cndmask_b32_e64 v0, 0x1054, v0, s25
	.loc	1 656 32                        ; attention.py:656:32
	s_lshl_b32 s1, s1, 10
...
.Ltmp10:
	...
	v_dual_add_f32 v76, v116, v117 :: v_dual_and_b32 v67, 1, v67
.Ltmp11:
	.loc	1 700 30                        ; attention.py:700:30
	v_cmp_o_f32_e64 s1, v69, v69
.Ltmp12:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_add_f32_e32 v75, v68, v69
.Ltmp13:
	.loc	1 700 30                        ; attention.py:700:30
...
.Ltmp30:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v81, v72, v74 :: v_dual_add_nc_u32 v92, s60, v92
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_mov_b32 v72, v103 :: v_dual_fmac_f32 v81, v73, v104
.Ltmp31:
	.loc	1 700 23                        ; attention.py:700:23
	s_waitcnt lgkmcnt(0)
...
.LBB0_3:                                ; %._crit_edge
	...
	v_cndmask_b32_e64 v6, v16, v25, s25
	v_cndmask_b32_e64 v7, v25, v16, s25
	v_mov_b32_e32 v15, 0x5410
	v_mov_b32_e32 v16, 0x7632
	v_cndmask_b32_e64 v14, v18, v17, s25
	v_cndmask_b32_e64 v17, v17, v18, s25
	v_cndmask_b32_e64 v18, v11, v8, s25
	v_cndmask_b32_e64 v8, v8, v11, s25
	v_cndmask_b32_e64 v11, 0x1054, v15, s25
	v_cndmask_b32_e64 v15, 0x3276, v16, s25
	v_cndmask_b16 v1.h, 0x7fff, v2.h, s3
	v_cndmask_b16 v2.l, 0x7fff, v12.h, s5
	v_cndmask_b16 v2.h, 0x7fff, v3.h, s6
	v_cndmask_b32_e64 v16, v10, v9, s25
	v_cndmask_b32_e64 v9, v9, v10, s25
	v_lshl_or_b32 v10, v11, 8, v11
	v_lshl_or_b32 v11, v15, 8, v15
	v_cndmask_b16 v3.l, 0x7fff, v5.h, s7
	v_cndmask_b16 v3.h, 0x7fff, v4.h, s8
	v_cndmask_b32_e64 v5, v24, v27, s25
	v_cndmask_b32_e64 v12, v19, v28, s25
	v_cndmask_b32_e64 v13, v28, v19, s25
	v_cndmask_b32_e64 v19, v2, v0, s25
	v_cndmask_b32_e64 v0, v0, v2, s25
	v_and_b32_e32 v2, 0x540054, v10
	v_and_b32_e32 v10, 0x760076, v11
	s_mov_b32 s3, 0x76543210
	v_cndmask_b32_e64 v15, v3, v1, s25
	...
	v_cndmask_b32_e64 v4, v27, v24, s25
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_attention_fwd_bf16xbf16_none_local_bfloat16_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn32_w4_s1_ds1.num_vgpr, 135
