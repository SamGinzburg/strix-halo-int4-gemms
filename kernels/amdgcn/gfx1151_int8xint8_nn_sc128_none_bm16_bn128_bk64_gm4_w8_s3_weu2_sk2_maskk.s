...
.Ltmp19:
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	s_mul_i32 s21, s33, s7
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cselect_b32 s3, -1, 0
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	s_add_i32 s5, s28, s5
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add3_u32 v39, v1, v34, s21
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	...
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v4, s6, v39
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v5, s34, v34
	v_or_b32_e32 v6, s34, v33
	v_or_b32_e32 v7, s34, v35
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	...
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[12:15], v1, s[16:19], 0 offen
	buffer_load_b128 v[16:19], v3, s[16:19], 0 offen
	.loc	1 352 30 is_stmt 0              ; generate_amdgcn.py:352:30
	v_add_nc_u32_e32 v1, s5, v36
	v_add_nc_u32_e32 v3, s5, v37
	...
	.loc	1 352 22                        ; generate_amdgcn.py:352:22
	s_clause 0x1
	buffer_load_b128 v[20:23], v1, s[16:19], 0 offen
	buffer_load_b128 v[24:27], v3, s[16:19], 0 offen
	.loc	1 300 32                        ; generate_amdgcn.py:300:32
	v_lshrrev_b32_e32 v1, 1, v0
	.loc	1 307 5                         ; generate_amdgcn.py:307:5
	s_cmpk_gt_i32 s23, 0x17f
...
.LBB0_3:                                ; %Flow57
	...
	s_ashr_i32 s1, s20, 7
	v_or_b32_e32 v26, s28, v2
	v_or_b32_e32 v25, s28, v6
	v_or_b32_e32 v24, s28, v7
	v_mul_lo_u32 v27, v12, s1
	v_or_b32_e32 v22, s28, v8
	v_or_b32_e32 v20, s28, v11
	v_or_b32_e32 v23, s28, v3
	v_or_b32_e32 v21, s28, v4
	v_or_b32_e32 v19, s28, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v42, s34, v34
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_lshr_b32 s41, s41, 25
	.loc	1 348 30                        ; generate_amdgcn.py:348:30
	v_add_nc_u32_e32 v43, s34, v39
	.loc	1 362 29                        ; generate_amdgcn.py:362:29
	s_add_i32 s0, s0, s41
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
	s_mul_i32 s42, s34, s29
	.loc	1 343 23                        ; generate_amdgcn.py:343:23
	...
	.loc	1 364 22                        ; generate_amdgcn.py:364:22
	buffer_load_u16 v91, v42, s[20:23], 0 offen
	.loc	1 366 22                        ; generate_amdgcn.py:366:22
	s_clause 0x7
	...
	buffer_load_u16 v97, v48, s[24:27], 0 offen
	buffer_load_u16 v98, v49, s[24:27], 0 offen
	buffer_load_u16 v99, v50, s[24:27], 0 offen
	.loc	1 342 17                        ; generate_amdgcn.py:342:17
	v_or_b32_e32 v43, s34, v33
	v_or_b32_e32 v42, s34, v35
	.loc	1 352 30                        ; generate_amdgcn.py:352:30
