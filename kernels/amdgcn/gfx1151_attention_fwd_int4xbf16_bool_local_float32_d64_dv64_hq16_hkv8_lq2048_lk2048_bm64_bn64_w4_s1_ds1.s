...
; %bb.4:                                ; %.lr.ph
	...
	v_dual_mov_b32 v140, 0xff800000 :: v_dual_and_b32 v1, 16, v0
	...
	v_dual_mov_b32 v2, v25 :: v_dual_add_nc_u32 v159, 0, v36
	v_mul_lo_u32 v45, s7, v66
	v_mul_lo_u32 v44, s7, v44
	v_add_nc_u32_e32 v34, s3, v34
	v_mul_lo_u32 v36, s69, v40
	...
	v_dual_mov_b32 v4, v25 :: v_dual_add_nc_u32 v161, 0, v41
	...
	v_dual_mov_b32 v83, 0xff800000 :: v_dual_add_nc_u32 v156, 0, v50
	v_add_nc_u32_e32 v160, 0, v37
	v_add_nc_u32_e32 v162, 0, v42
	.loc	1 629 13                        ; attention.py:629:13
	v_add3_u32 v164, s4, v45, v141
	v_add3_u32 v165, s4, v44, v141
	v_and_b32_e32 v166, 0x5040504, v38
	v_lshl_add_u32 v130, v36, 1, v61
	v_lshl_add_u32 v168, v35, 1, v61
	s_mov_b32 s80, 0
...
.LBB0_5:                                ;   in Loop: Header=BB0_6 Depth=1
	...
	v_dual_mul_f32 v61, s100, v61 :: v_dual_mul_f32 v52, v169, v52
	.loc	1 654 30                        ; attention.py:654:30
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v57, v57, v67 :: v_dual_mul_f32 v62, s100, v62
	.loc	1 649 37                        ; attention.py:649:37
	...
	v_dual_mul_f32 v44, v169, v44 :: v_dual_mul_f32 v57, s100, v57
	...
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v103, s100, v64 :: v_dual_mul_f32 v42, v169, v42
	.loc	1 654 30                        ; attention.py:654:30
	...
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v102, s100, v60 :: v_dual_mul_f32 v35, v169, v35
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 654 30                        ; attention.py:654:30
	...
	.loc	1 654 30                        ; attention.py:654:30
	v_dual_mul_f32 v37, v169, v37 :: v_dual_mul_f32 v58, s100, v58
	.loc	1 681 34                        ; attention.py:681:34
	...
	v_dual_mul_f32 v96, v41, v96 :: v_dual_mul_f32 v51, s100, v51
	...
	v_dual_mul_f32 v40, v169, v40 :: v_dual_mul_f32 v105, s100, v50
	...
	.loc	1 664 17                        ; attention.py:664:17
	v_mul_f32_e32 v34, s100, v54
	v_mul_f32_e32 v104, s100, v49
	.loc	1 681 25                        ; attention.py:681:25
	...
	.loc	1 654 30 is_stmt 1              ; attention.py:654:30
	v_dual_mul_f32 v53, v53, v107 :: v_dual_mul_f32 v106, s100, v52
	v_dual_mul_f32 v88, v33, v88 :: v_dual_mul_f32 v33, s100, v55
	.loc	1 681 34                        ; attention.py:681:34
	...
	v_dual_mul_f32 v68, s100, v99 :: v_dual_add_nc_u32 v35, 0, v145
	.loc	1 681 25                        ; attention.py:681:25
	...
	.loc	1 664 17                        ; attention.py:664:17
	v_dual_mul_f32 v66, s100, v100 :: v_dual_mul_f32 v79, s100, v86
	v_dual_mul_f32 v54, s100, v56 :: v_dual_mul_f32 v69, s100, v97
	v_dual_mul_f32 v76, s100, v91 :: v_dual_mul_f32 v65, s100, v98
	v_dual_mul_f32 v74, s100, v95 :: v_dual_mul_f32 v71, s100, v92
	v_dual_mul_f32 v78, s100, v87 :: v_dual_mul_f32 v53, s100, v53
	v_dual_mul_f32 v73, s100, v88 :: v_dual_mul_f32 v80, s100, v101
	v_mul_f32_e32 v75, s100, v93
	v_dual_mul_f32 v55, s100, v96 :: v_dual_mul_f32 v72, s100, v90
	v_dual_mul_f32 v77, s100, v89 :: v_dual_mul_f32 v70, s100, v94
	.loc	1 681 25                        ; attention.py:681:25
	s_waitcnt lgkmcnt(3)
...
.Ltmp20:
	...
	v_dual_sub_f32 v104, v82, v170 :: v_dual_sub_f32 v73, v73, v140
	v_sub_f32_e32 v105, v83, v171
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
	.loc	1 689 61 is_stmt 0              ; attention.py:689:61
	v_exp_f32_e32 v80, v80
	.loc	1 690 62 is_stmt 1              ; attention.py:690:62
	v_dual_sub_f32 v33, v68, v139 :: v_dual_sub_f32 v74, v74, v140
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(TRANS32_DEP_2)
	.loc	1 689 61                        ; attention.py:689:61
	v_exp_f32_e32 v104, v104
	.loc	1 690 62                        ; attention.py:690:62
	v_dual_sub_f32 v68, v69, v139 :: v_dual_sub_f32 v75, v75, v140
	v_dual_sub_f32 v69, v77, v139 :: v_dual_sub_f32 v72, v72, v140
	v_dual_sub_f32 v77, v79, v139 :: v_dual_sub_f32 v86, v86, v140
	.loc	1 689 25                        ; attention.py:689:25
	v_cndmask_b32_e64 v80, 0, v80, s3
	v_cmp_neq_f32_e64 s3, 0xff800000, v82
	.loc	1 690 62                        ; attention.py:690:62
	v_sub_f32_e32 v79, v92, v139
	v_sub_f32_e32 v34, v76, v139
	...
	.loc	1 690 62                        ; attention.py:690:62
	v_dual_sub_f32 v46, v46, v172 :: v_dual_sub_f32 v71, v71, v139
	...
	.loc	1 690 62                        ; attention.py:690:62
	v_dual_sub_f32 v35, v35, v172 :: v_dual_sub_f32 v70, v70, v139
	v_sub_f32_e32 v85, v85, v140
	v_dual_sub_f32 v81, v89, v139 :: v_dual_sub_f32 v92, v100, v140
	.loc	1 690 49                        ; attention.py:690:49
...
.Ltmp37:
	...
	v_add_f32_e32 v68, v69, v70
	v_add_f32_e32 v70, v73, v74
	v_dual_add_f32 v69, v71, v72 :: v_dual_add_nc_u32 v130, s76, v130
.Ltmp38:
	.loc	1 690 62                        ; attention.py:690:62
...
.Ltmp43:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v85, v47, v48 :: v_dual_add_f32 v88, v37, v38
.Ltmp44:
	.loc	1 694 30                        ; attention.py:694:30
...
.Ltmp45:
	.loc	2 263 12                        ; standard.py:263:12 @[ standard.py:293:12 @[ attention.py:691:24 ] ]
	v_dual_add_f32 v49, v49, v51 :: v_dual_add_f32 v84, v84, v85
...
.Ltmp51:
	...
	.loc	1 690 62                        ; attention.py:690:62
	v_dual_sub_f32 v54, v54, v172 :: v_dual_add_f32 v175, v49, v51
.Ltmp52:
	.loc	2 293 12                        ; standard.py:293:12 @[ attention.py:691:24 ]
...
.Ltmp63:
	...
	v_dual_fmac_f32 v57, v153, v174 :: v_dual_mul_f32 v24, v24, v80
	.loc	1 694 30                        ; attention.py:694:30
...
.Ltmp69:
	...
	v_dual_mov_b32 v81, v172 :: v_dual_mov_b32 v150, v58
	v_dual_mov_b32 v82, v170 :: v_dual_mov_b32 v83, v171
	.loc	1 629 13                        ; attention.py:629:13
	s_add_i32 s1, s90, s101
...
.LBB0_6:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_nc_u32_e32 v74, s101, v141
	.loc	1 639 33                        ; attention.py:639:33
	...
	v_add_nc_u32_e32 v73, s101, v164
...
.LBB0_38:                               ;   in Loop: Header=BB0_6 Depth=1
	...
	v_add_nc_u32_e32 v174, s101, v165
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_attention_fwd_int4xbf16_bool_local_float32_d64_dv64_hq16_hkv8_lq2048_lk2048_bm64_bn64_w4_s1_ds1.numbered_sgpr, 102
