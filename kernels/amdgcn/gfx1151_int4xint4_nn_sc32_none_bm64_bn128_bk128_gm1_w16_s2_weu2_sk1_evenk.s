	...
	.text
	.globl	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk               ; -- Begin function amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.p2align	8
	.type	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk,@function
amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk:                      ; @amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
.Lfunc_begin0:
...
.LBB0_3:                                ; %Flow109
	...
	v_dual_mov_b32 v20, 0 :: v_dual_and_b32 v31, 16, v5
...
.LBB0_5:                                ; =>This Inner Loop Header: Depth=1
	...
	s_clause 0x7
	buffer_load_u16 v73, v45, s[40:43], 0 offen offset:4
	buffer_load_u16 v74, v45, s[40:43], 0 offen
	buffer_load_u16 v75, v45, s[40:43], 0 offen offset:12
	buffer_load_u16 v76, v45, s[40:43], 0 offen offset:8
	buffer_load_u16 v77, v45, s[40:43], 0 offen offset:20
	buffer_load_u16 v78, v45, s[40:43], 0 offen offset:16
	buffer_load_u16 v79, v45, s[40:43], 0 offen offset:28
	buffer_load_u16 v80, v45, s[40:43], 0 offen offset:24
	.loc	1 220 26                        ; generate_amdgcn.py:220:26
	...
	v_dual_fmac_f32 v25, v52, v61 :: v_dual_lshlrev_b32 v66, 16, v79
	v_fmac_f32_e32 v10, v44, v61
	v_fmac_f32_e32 v24, v45, v60
	v_dual_fmac_f32 v22, v46, v63 :: v_dual_fmac_f32 v23, v53, v60
	v_fmac_f32_e32 v17, v49, v64
	v_dual_fmac_f32 v21, v47, v62 :: v_dual_fmac_f32 v18, v48, v65
	v_dual_fmac_f32 v19, v55, v62 :: v_dual_fmac_f32 v14, v50, v67
	v_fmac_f32_e32 v15, v57, v64
	v_dual_fmac_f32 v13, v51, v66 :: v_dual_fmac_f32 v20, v54, v63
	v_dual_fmac_f32 v11, v59, v66 :: v_dual_fmac_f32 v16, v56, v65
	v_fmac_f32_e32 v12, v58, v67
	.loc	1 188 9                         ; generate_amdgcn.py:188:9
...
; %bb.7:
	...
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_dual_mov_b32 v49, s11 :: v_dual_mov_b32 v46, s8
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	v_xad_u32 v2, v2, 8, 0
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_mov_b32_e32 v48, s10
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_2addr_stride64_b64 v[29:32], v29 offset0:4 offset1:5
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	v_dual_mov_b32 v47, s9 :: v_dual_mov_b32 v44, s6
	.loc	1 216 26                        ; generate_amdgcn.py:216:26
	ds_load_2addr_stride64_b64 v[33:36], v2 offset0:4 offset1:5
	.loc	1 221 27                        ; generate_amdgcn.py:221:27
	s_waitcnt lgkmcnt(15)
	v_perm_b32 v3, v5, v3, 0xc0c0004
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v4, v4, v6, 0xc0c0004
	v_dual_mov_b32 v45, s7 :: v_dual_mov_b32 v42, s4
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v2, v9, v7, 0xc0c0004
	s_waitcnt lgkmcnt(10)
	v_perm_b32 v5, v8, v37, 0xc0c0004
	...
	s_waitcnt lgkmcnt(1)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[50:51], v[29:30], v[42:49] neg_lo:[1,1,0]
	v_lshl_or_b32 v30, v37, 16, v9
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
	v_lshl_or_b32 v29, v53, 16, v52
	v_wmma_i32_16x16x16_iu4 v[42:49], v[50:51], v[31:32], v[42:49] neg_lo:[1,1,0]
	s_waitcnt lgkmcnt(0)
	v_wmma_i32_16x16x16_iu4 v[1:8], v[29:30], v[33:34], v[1:8] neg_lo:[1,1,0]
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_wmma_i32_16x16x16_iu4 v[42:49], v[29:30], v[35:36], v[42:49] neg_lo:[1,1,0]
	.loc	1 233 20                        ; generate_amdgcn.py:233:20
...
.LBB0_8:
	...
	v_dual_mul_f32 v36, v36, v46 :: v_dual_add_nc_u32 v29, 4, v27
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_dual_mul_f32 v33, v33, v46 :: v_dual_mul_f32 v8, v8, v40
	v_dual_mul_f32 v31, v31, v46 :: v_dual_and_b32 v0, 16, v0
	v_dual_mul_f32 v37, v37, v46 :: v_dual_mul_f32 v4, v4, v40
	v_dual_mul_f32 v9, v9, v46 :: v_dual_mul_f32 v6, v6, v40
	...
	v_fma_f32 v28, v36, v30, v20
	v_fma_f32 v9, v9, v40, v16
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	v_add3_u32 v4, v20, v16, 0x7fff
	v_cmp_o_f32_e64 s0, v10, v10
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v27, v34, v27, v11
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 233 13                        ; generate_amdgcn.py:233:13
	v_fma_f32 v25, v37, v31, v19
	v_fma_f32 v31, v33, v42, v12
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	...
	.loc	1 245 9                         ; generate_amdgcn.py:245:9
	v_dual_cndmask_b32 v3, v3, v7 :: v_dual_and_b32 v18, 1, v53
	s_delay_alu instid0(VALU_DEP_4)
	...
	v_add3_u32 v6, v9, v18, 0x7fff
	v_cmp_o_f32_e64 s10, v9, v9
	v_cmp_o_f32_e64 s13, v11, v11
	v_add3_u32 v8, v12, v22, 0x7fff
	...
	v_dual_cndmask_b32 v7, v9, v2 :: v_dual_and_b32 v10, 0x760076, v11
...
.Ltmp22:
	...
	.p2align	6, 0x0
	.amdhsa_kernel amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	...
	.text
.Lfunc_end0:
	.size	amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk, .Lfunc_end0-amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_vgpr, 82
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_agpr, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.numbered_sgpr, 48
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.num_named_barrier, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.private_seg_size, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_vcc, 1
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.uses_flat_scratch, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_dyn_sized_stack, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_recursion, 0
	.set amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.has_indirect_call, 0
...
.Linfo_string3:
	.asciz	"amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk"             ; string offset=75 ; amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
...
amdhsa.kernels:
  - .args:
    ...
    .name:           amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk
    .private_segment_fixed_size: 0
    .sgpr_count:     50
    .sgpr_spill_count: 0
    .symbol:         amd_strix_halo_gfx1151_int4xint4_nn_sc32_none_bm64_bn128_bk128_gm1_w16_s2_weu2_sk1_evenk.kd
