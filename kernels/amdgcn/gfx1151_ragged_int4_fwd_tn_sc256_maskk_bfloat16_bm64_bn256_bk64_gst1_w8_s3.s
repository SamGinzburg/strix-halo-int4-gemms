...
; %bb.1:                                ; %.lr.ph
	...
	.loc	1 915 39 is_stmt 1              ; ragged.py:915:39
...
.LBB0_3:                                ;   Parent Loop BB0_2 Depth=1
	...
	v_mad_u64_u32 v[68:69], null, s8, s33, v[67:68]
	...
	s_cmp_lt_i32 s7, s35
	.loc	1 917 42                        ; ragged.py:917:42
	v_mad_u64_u32 v[69:70], null, s1, s33, v[67:68]
	.loc	1 907 31                        ; ragged.py:907:31
	...
	.loc	1 917 42                        ; ragged.py:917:42
	v_mad_u64_u32 v[72:73], null, s5, s33, v[67:68]
	...
	.loc	1 916 34 is_stmt 0              ; ragged.py:916:34
	v_cndmask_b32_e64 v65, 0x80000000, v100, s1
	.loc	1 916 66                        ; ragged.py:916:66
	s_and_b32 s1, s37, s5
	.loc	1 916 42                        ; ragged.py:916:42
	...
	.loc	1 916 66                        ; ragged.py:916:66
	s_and_b32 s1, s37, s6
	.loc	1 907 31 is_stmt 1              ; ragged.py:907:31
	...
	.loc	1 916 34                        ; ragged.py:916:34
	v_cndmask_b32_e64 v104, 0x80000000, v155, s1
	.loc	1 916 66                        ; ragged.py:916:66
	s_and_b32 s1, s37, s10
	.loc	1 916 34                        ; ragged.py:916:34
	v_cndmask_b32_e64 v105, 0x80000000, v187, s1
	.loc	1 916 66                        ; ragged.py:916:66
	s_and_b32 s1, s37, s11
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
	.loc	1 916 34                        ; ragged.py:916:34
	v_cndmask_b32_e64 v150, 0x80000000, v188, s1
	.loc	1 917 66 is_stmt 1              ; ragged.py:917:66
	s_and_b32 s1, s0, s66
	.loc	1 917 34 is_stmt 0              ; ragged.py:917:34
...
; %bb.4:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	.loc	1 936 21                        ; ragged.py:936:21
	v_dual_mul_f32 v71, v72, v65 :: v_dual_lshlrev_b32 v70, 16, v70
	v_dual_mul_f32 v20, v20, v68 :: v_dual_lshlrev_b32 v69, 16, v69
	v_dual_mul_f32 v72, v73, v65 :: v_dual_mul_f32 v19, v19, v68
	v_mul_f32_e32 v73, v74, v65
	v_dual_mul_f32 v74, v75, v65 :: v_dual_mul_f32 v17, v17, v68
	v_dual_mul_f32 v75, v76, v65 :: v_dual_mul_f32 v22, v22, v68
	v_dual_mul_f32 v76, v77, v65 :: v_dual_mul_f32 v23, v23, v68
	...
	v_dual_mul_f32 v80, v81, v65 :: v_dual_mul_f32 v27, v27, v68
	...
	v_dual_mul_f32 v84, v85, v65 :: v_dual_mul_f32 v31, v31, v68
	...
	v_dual_mul_f32 v36, v36, v69 :: v_dual_mul_f32 v49, v49, v70
	v_dual_mul_f32 v37, v37, v69 :: v_dual_mul_f32 v56, v56, v70
	v_dual_mul_f32 v38, v38, v69 :: v_dual_mul_f32 v51, v51, v70
	v_dual_mul_f32 v39, v39, v69 :: v_dual_mul_f32 v58, v58, v70
	v_dual_mul_f32 v40, v40, v69 :: v_dual_mul_f32 v53, v53, v70
	v_dual_mul_f32 v41, v41, v69 :: v_dual_mul_f32 v60, v60, v70
	v_dual_mul_f32 v42, v42, v69 :: v_dual_mul_f32 v55, v55, v70
	v_dual_mul_f32 v43, v43, v69 :: v_dual_mul_f32 v62, v62, v70
	v_dual_mul_f32 v44, v44, v69 :: v_dual_mul_f32 v57, v57, v70
	v_dual_mul_f32 v45, v45, v69 :: v_dual_mul_f32 v64, v64, v70
	v_dual_mul_f32 v46, v46, v69 :: v_dual_mul_f32 v59, v59, v70
	v_dual_mul_f32 v48, v48, v69 :: v_dual_mul_f32 v61, v61, v70
	...
	v_dual_fmac_f32 v117, v51, v3 :: v_dual_fmac_f32 v116, v52, v4
	s_waitcnt lgkmcnt(0)
	v_dual_fmac_f32 v121, v47, v15 :: v_dual_fmac_f32 v154, v65, v16
	v_fmac_f32_e32 v151, v18, v2
	s_clause 0x2                            ; 12-byte Folded Reload
	scratch_load_b32 v51, off, off offset:40
	scratch_load_b32 v52, off, off offset:28
	scratch_load_b32 v65, off, off offset:24
	v_dual_fmac_f32 v172, v71, v1 :: v_dual_fmac_f32 v171, v72, v2
	v_dual_fmac_f32 v153, v17, v1 :: v_dual_fmac_f32 v146, v22, v6
	v_dual_fmac_f32 v135, v33, v1 :: v_dual_fmac_f32 v130, v38, v6
	...
	v_dual_fmac_f32 v164, v78, v8 :: v_dual_fmac_f32 v163, v79, v9
	v_dual_fmac_f32 v162, v80, v10 :: v_dual_fmac_f32 v161, v81, v11
	v_dual_fmac_f32 v160, v82, v12 :: v_dual_fmac_f32 v159, v83, v13
	v_dual_fmac_f32 v158, v84, v14 :: v_dual_fmac_f32 v157, v85, v15
	v_dual_fmac_f32 v148, v20, v4 :: v_dual_fmac_f32 v149, v19, v3
	v_dual_fmac_f32 v144, v24, v8 :: v_dual_fmac_f32 v147, v21, v5
	v_dual_fmac_f32 v142, v26, v10 :: v_dual_fmac_f32 v145, v23, v7
	v_dual_fmac_f32 v140, v28, v12 :: v_dual_fmac_f32 v143, v25, v9
	v_dual_fmac_f32 v138, v30, v14 :: v_dual_fmac_f32 v141, v27, v11
	v_dual_fmac_f32 v136, v32, v16 :: v_dual_fmac_f32 v139, v29, v13
	v_dual_fmac_f32 v134, v34, v2 :: v_dual_fmac_f32 v137, v31, v15
	v_dual_fmac_f32 v132, v36, v4 :: v_dual_fmac_f32 v133, v35, v3
	v_fmac_f32_e32 v128, v40, v8
	s_waitcnt vmcnt(5)
	v_fmac_f32_e32 v70, v53, v5
	scratch_load_b32 v53, off, off offset:32 ; 4-byte Folded Reload
	v_dual_fmac_f32 v131, v37, v5 :: v_dual_fmac_f32 v126, v42, v10
	v_dual_fmac_f32 v129, v39, v7 :: v_dual_fmac_f32 v124, v44, v12
	v_dual_fmac_f32 v127, v41, v9 :: v_dual_fmac_f32 v122, v46, v14
	v_dual_fmac_f32 v125, v43, v11 :: v_dual_fmac_f32 v120, v48, v16
	v_dual_fmac_f32 v123, v45, v13 :: v_dual_fmac_f32 v118, v50, v2
	s_waitcnt vmcnt(5)
	v_fmac_f32_e32 v69, v55, v7
	scratch_load_b32 v55, off, off offset:12 ; 4-byte Folded Reload
	s_waitcnt vmcnt(4)
	v_dual_fmac_f32 v51, v54, v6 :: v_dual_fmac_f32 v52, v57, v9
	s_waitcnt vmcnt(3)
	...
	s_waitcnt vmcnt(3)
	v_dual_fmac_f32 v55, v61, v13 :: v_dual_fmac_f32 v54, v60, v12
	s_waitcnt vmcnt(1)
	v_dual_fmac_f32 v58, v62, v14 :: v_dual_fmac_f32 v57, v63, v15
	s_waitcnt vmcnt(0)
...
.LBB0_6:                                ; %._crit_edge
	.loc	1 948 13 is_stmt 1              ; ragged.py:948:13
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.num_vgpr, 256
	...
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.private_seg_size, 84
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_vcc, 1
	.set amd_strix_halo_gfx1151_ragged_int4_fwd_tn_sc256_maskk_bfloat16_bm64_bn256_bk64_gst1_w8_s3.uses_flat_scratch, 1
