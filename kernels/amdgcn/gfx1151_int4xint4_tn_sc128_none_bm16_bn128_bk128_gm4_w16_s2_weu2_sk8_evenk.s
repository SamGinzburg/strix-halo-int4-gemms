...
.LBB0_5:
	...
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_add_nc_u32_e32 v182, 0xc0, v18
	v_add_nc_u32_e32 v183, 0xc4, v18
	v_add_nc_u32_e32 v184, 0xc8, v18
	s_delay_alu instid0(VALU_DEP_4)
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	...
	v_mul_f32_e32 v157, v157, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_cndmask_b32_e64 v182, 0x80000000, v182, s2
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_mul_f32_e32 v158, v158, v17
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v118, v118, v17 :: v_dual_add_nc_u32 v27, 32, v18
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_clause 0x7
	...
	.loc	1 180 20                        ; generate_amdgcn.py:180:20
	v_dual_mul_f32 v126, v126, v17 :: v_dual_add_nc_u32 v103, 64, v18
	...
	v_dual_mul_f32 v141, v141, v17 :: v_dual_add_nc_u32 v166, 0x80, v18
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v17, v111, v21, v57
	v_fma_f32 v21, v114, v22, v96
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	s_waitcnt vmcnt(23)
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v22, v115, v23, v95
	v_fma_f32 v23, v116, v24, v94
	v_fma_f32 v24, v117, v25, v93
	v_fma_f32 v25, v118, v26, v92
	v_fma_f32 v26, v119, v27, v91
	v_fma_f32 v27, v120, v28, v90
	v_fma_f32 v28, v121, v29, v89
	v_fma_f32 v29, v122, v30, v88
	v_fma_f32 v30, v123, v31, v87
	v_fma_f32 v31, v124, v32, v86
	v_fma_f32 v32, v125, v101, v85
	v_fma_f32 v101, v126, v102, v84
	v_fma_f32 v102, v127, v103, v83
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v117, v143, v166, v67
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v107, 16, v107
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v19, v112, v19, v98
	v_fma_f32 v103, v128, v104, v82
	v_fma_f32 v118, v144, v167, v66
	v_fma_f32 v8, v8, v99, v35
	v_fma_f32 v20, v113, v20, v97
	v_fma_f32 v104, v129, v105, v81
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v17, v57, v17, s2
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v119, v145, v168, v65
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v108, 16, v108
	v_lshlrev_b32_e32 v109, 16, v109
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v105, v130, v106, v80
	v_fma_f32 v120, v146, v169, v64
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v67, v67, v117, s2
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v106, v131, v107, v79
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v121, v147, v170, v63
	v_fma_f32 v122, v148, v171, v62
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	v_cndmask_b32_e64 v65, v65, v119, s2
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v110, 16, v110
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v107, v132, v108, v78
	v_fma_f32 v108, v133, v109, v77
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v123, v149, v172, v61
	v_fma_f32 v125, v151, v174, v59
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v110, v135, v159, v75
	v_fma_f32 v111, v136, v160, v74
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v177, 16, v177
	v_lshlrev_b32_e32 v193, 16, v193
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v126, v152, v175, v58
	v_fma_f32 v2, v2, v191, v41
	v_fma_f32 v112, v137, v161, v73
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v113, v138, v162, v72
	v_fma_f32 v127, v153, v176, v56
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v114, v139, v163, v71
	v_fma_f32 v129, v155, v178, v54
	...
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v130, v156, v179, v53
	v_fma_f32 v6, v6, v195, v37
	.loc	1 179 18                        ; generate_amdgcn.py:179:18
	v_lshlrev_b32_e32 v181, 16, v181
	.loc	1 180 13                        ; generate_amdgcn.py:180:13
	v_fma_f32 v116, v141, v165, v69
	v_fma_f32 v131, v157, v180, v52
	.loc	1 147 9                         ; generate_amdgcn.py:147:9
...
.Lfunc_end0:
	...
	.set amd_strix_halo_gfx1151_int4xint4_tn_sc128_none_bm16_bn128_bk128_gm4_w16_s2_weu2_sk8_evenk.numbered_sgpr, 44
